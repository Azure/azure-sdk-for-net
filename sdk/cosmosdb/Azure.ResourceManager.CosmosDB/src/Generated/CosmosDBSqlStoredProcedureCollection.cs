...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class CosmosDBSqlStoredProcedureCollection : ArmCollection, IEnumerable<CosmosDBSqlStoredProcedureResource>, IAsyncEnumerable<CosmosDBSqlStoredProcedureResource>
    {
        ...
        {
            async Task<Page<CosmosDBSqlStoredProcedureResource>> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _cosmosDBSqlStoredProcedureSqlResourcesClientDiagnostics.CreateScope("CosmosDBSqlStoredProcedureCollection.GetAll");
                scope.Start();
                try
                {
                    var response = await _cosmosDBSqlStoredProcedureSqlResourcesRestClient.ListSqlStoredProceduresAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new CosmosDBSqlStoredProcedureResource(Client, value)), null, response.GetRawResponse());
                }
                catch (Exception e)
                {
                    scope.Failed(e);
        ...
        {
            Page<CosmosDBSqlStoredProcedureResource> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _cosmosDBSqlStoredProcedureSqlResourcesClientDiagnostics.CreateScope("CosmosDBSqlStoredProcedureCollection.GetAll");
                scope.Start();
                try
                {
                    var response = _cosmosDBSqlStoredProcedureSqlResourcesRestClient.ListSqlStoredProcedures(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new CosmosDBSqlStoredProcedureResource(Client, value)), null, response.GetRawResponse());
                }
                catch (Exception e)
                {
