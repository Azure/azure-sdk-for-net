...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class CassandraKeyspaceData : ResourceData
    {
        ...
        internal CassandraKeyspaceData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, CassandraKeyspaceProperties properties, IDictionary<string, string> tags, string location, Models.ManagedServiceIdentity identity) : base(id, name, resourceType, systemData)
        {
