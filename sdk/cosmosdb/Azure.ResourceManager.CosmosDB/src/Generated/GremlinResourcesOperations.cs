...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class GremlinResourcesOperations
    {
        ...
        internal GremlinResourcesOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null, string apiVersion = "2021-06-15")
        {
            RestClient = new GremlinResourcesRestOperations(clientDiagnostics, pipeline, subscriptionId, endpoint, apiVersion);
