    ...
    public partial class CosmosDBSqlContainerData : IUtf8JsonSerializable, IJsonModel<CosmosDBSqlContainerData>
    {
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Resource))
            {
                ...
                ((IJsonModel<ExtendedCosmosDBSqlContainerResourceInfo>)Resource).Write(writer, options);
            }
            if (Optional.IsDefined(Options))
            {
                writer.WritePropertyName("options"u8);
                ((IJsonModel<CosmosDBSqlContainerPropertiesConfig>)Options).Write(writer, options);
            }
            writer.WriteEndObject();
        }
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        if (property0.NameEquals("resource"u8))
                        {
                            ...
                            resource = ModelSerializationExtensions.JsonDeserialize<ExtendedCosmosDBSqlContainerResourceInfo>(property0.Value);
                            continue;
                        }
                        if (property0.NameEquals("options"u8))
                        {
                            ...
                            options0 = ModelSerializationExtensions.JsonDeserialize<CosmosDBSqlContainerPropertiesConfig>(property0.Value);
                            continue;
                        }
                    }
                    continue;
