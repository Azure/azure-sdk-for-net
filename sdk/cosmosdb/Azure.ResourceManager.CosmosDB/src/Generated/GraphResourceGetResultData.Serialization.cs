...
namespace Azure.ResourceManager.CosmosDB
{
    public partial class GraphResourceGetResultData : IUtf8JsonSerializable, IJsonModel<GraphResourceGetResultData>
    {
        ...
        void IJsonModel<GraphResourceGetResultData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(GraphResourceGetResultData)} does not support '{format}' format.");
            }
        ...
        internal static GraphResourceGetResultData DeserializeGraphResourceGetResultData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            Optional<GraphResourceGetPropertiesOptions> options0 = default;
            ...
            return new GraphResourceGetResultData(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, resource, options0.Value, identity, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<GraphResourceGetResultData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(GraphResourceGetResultData)} does not support '{options.Format}' format.");
            }
        }
