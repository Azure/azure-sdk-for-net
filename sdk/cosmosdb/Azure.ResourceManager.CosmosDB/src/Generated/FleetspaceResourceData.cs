...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class FleetspaceResourceData : ResourceData
    {
        ...
        internal FleetspaceResourceData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, FleetspaceProperties properties) : base(id, name, resourceType, systemData)
        {
