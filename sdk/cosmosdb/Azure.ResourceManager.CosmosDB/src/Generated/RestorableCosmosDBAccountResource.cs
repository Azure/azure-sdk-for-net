    ...
    public partial class RestorableCosmosDBAccountResource : ArmResource
    {
        ...
        public virtual AsyncPageable<RestorableSqlContainer> GetRestorableSqlContainersAsync(RestorableCosmosDBAccountGetRestorableSqlContainersOptions options, CancellationToken cancellationToken = default)
        {
            ...
            async Task<Page<RestorableSqlContainer>> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _restorableSqlContainersRestClient.ListAsync(Id.SubscriptionId, new AzureLocation(Id.Parent.Name), Guid.Parse(Id.Name), options.RestorableSqlDatabaseRid, options.StartTime, options.EndTime, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value, null, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual Pageable<RestorableSqlContainer> GetRestorableSqlContainers(RestorableCosmosDBAccountGetRestorableSqlContainersOptions options, CancellationToken cancellationToken = default)
        {
            ...
            Page<RestorableSqlContainer> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _restorableSqlContainersRestClient.List(Id.SubscriptionId, new AzureLocation(Id.Parent.Name), Guid.Parse(Id.Name), options.RestorableSqlDatabaseRid, options.StartTime, options.EndTime, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value, null, response.GetRawResponse());
                }
                catch (Exception e)
                {
