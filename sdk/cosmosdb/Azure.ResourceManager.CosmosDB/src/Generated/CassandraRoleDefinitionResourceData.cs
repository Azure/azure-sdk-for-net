...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class CassandraRoleDefinitionResourceData : ResourceData
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="CassandraRoleDefinitionResourceData"/>. </summary>
        public CassandraRoleDefinitionResourceData()
        {
        }
        ...
        internal CassandraRoleDefinitionResourceData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, CassandraRoleDefinitionResourceProperties properties) : base(id, name, resourceType, systemData)
        {
