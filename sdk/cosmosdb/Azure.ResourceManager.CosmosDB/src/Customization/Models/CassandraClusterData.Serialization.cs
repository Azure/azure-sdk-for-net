...
{
    public partial class CassandraClusterData : IUtf8JsonSerializable
    {
        ...
        internal static CassandraClusterData DeserializeCassandraClusterData(JsonElement element)
        {
            ...
            return new CassandraClusterData(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, properties.Value, identity);
        }
    }
}
