...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class CosmosDBSqlDatabaseThroughputSettingResource
    {
        private Task<ArmOperation<CosmosDBSqlDatabaseThroughputSettingResource>> UpdateAsync(WaitUntil waitUntil, ThroughputSettingData data, CancellationToken cancellationToken = default)
            => CreateOrUpdateAsync(waitUntil, ToUpdateData(data), cancellationToken);

        private ArmOperation<CosmosDBSqlDatabaseThroughputSettingResource> Update(WaitUntil waitUntil, ThroughputSettingData data, CancellationToken cancellationToken = default)
