...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class MongoDBResource
    {
        ...
        internal Task<ArmOperation<MongoDBResource>> UpdateAsync(WaitUntil waitUntil, ThroughputSettingsData data, CancellationToken cancellationToken = default) =>
            throw new NotSupportedException(TagFallbackUnsupportedMessage);

        internal ArmOperation<MongoDBResource> Update(WaitUntil waitUntil, ThroughputSettingsData data, CancellationToken cancellationToken = default) =>
            throw new NotSupportedException(TagFallbackUnsupportedMessage);
    }
}
