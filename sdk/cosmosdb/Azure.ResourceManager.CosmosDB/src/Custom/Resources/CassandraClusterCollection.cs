...
// the previously selected canonical Get operation. ClusterResource.tsp declares both
// `get` and `getBackup` as ArmResourceRead<ClusterResource, ...> on the same resource,
// so getBackup wins and the generated CassandraClusterCollection.Get/GetAsync/
// GetIfExists/GetIfExistsAsync/Exists/ExistsAsync are all wired to GetBackup. That
// produces wrong return types and CS1503/CS0029 build errors and also breaks
// MockableCosmosDBResourceGroupResource.GetCassandraCluster(string clusterName) which
// expects the canonical cluster Get. Suppress the broken methods and re-emit the
// canonical Get/Exists/GetIfExists overloads using ClusterResources_Get
// (CreateGetRequest). Tracked as a generator improvement.
...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class CassandraClusterCollection
    {
        /// <summary>
