...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class GremlinGraphResource
    {
        ...
        internal Task<ArmOperation<GremlinGraphResource>> UpdateAsync(WaitUntil waitUntil, GremlinGraphData data, CancellationToken cancellationToken = default) =>
            throw new NotSupportedException(TagFallbackUnsupportedMessage);

        internal ArmOperation<GremlinGraphResource> Update(WaitUntil waitUntil, GremlinGraphData data, CancellationToken cancellationToken = default) =>
            throw new NotSupportedException(TagFallbackUnsupportedMessage);
    }
}
