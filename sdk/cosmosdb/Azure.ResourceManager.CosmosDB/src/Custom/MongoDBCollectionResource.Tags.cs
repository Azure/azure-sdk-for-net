...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class MongoDBCollectionResource
    {
        ...
        internal Task<ArmOperation<MongoDBCollectionResource>> UpdateAsync(WaitUntil waitUntil, MongoDBCollectionData data, CancellationToken cancellationToken = default) =>
            throw new NotSupportedException(TagFallbackUnsupportedMessage);

        internal ArmOperation<MongoDBCollectionResource> Update(WaitUntil waitUntil, MongoDBCollectionData data, CancellationToken cancellationToken = default) =>
            throw new NotSupportedException(TagFallbackUnsupportedMessage);
    }
}
