...
{
    // Back-compat overloads that omit the preview-only x-ms-force-deallocate header.
    public partial class CassandraClusterResource
    {
        ...
        public virtual Task<ArmOperation> DeallocateAsync(WaitUntil waitUntil)
        {
            return DeallocateAsync(waitUntil, default(CancellationToken));
        }
        ...
        {
            return Deallocate(waitUntil, default(CancellationToken));
        }
