...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class CassandraKeyspaceThroughputSettingResource
    {
        ...
        private ArmOperation<CassandraKeyspaceThroughputSettingResource> Update(WaitUntil waitUntil, ThroughputSettingData data, CancellationToken cancellationToken = default)
