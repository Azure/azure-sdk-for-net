...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class MongoDBDatabaseThroughputSettingResource
    {
        private Task<ArmOperation<MongoDBDatabaseThroughputSettingResource>> UpdateAsync(WaitUntil waitUntil, ThroughputSettingData data, CancellationToken cancellationToken = default)
            => CreateOrUpdateAsync(waitUntil, ToUpdateData(data), cancellationToken);

        private ArmOperation<MongoDBDatabaseThroughputSettingResource> Update(WaitUntil waitUntil, ThroughputSettingData data, CancellationToken cancellationToken = default)
