...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class CosmosTableThroughputSettingResource
    {
        private Task<ArmOperation<CosmosTableThroughputSettingResource>> UpdateAsync(WaitUntil waitUntil, ThroughputSettingData data, CancellationToken cancellationToken = default)
            => CreateOrUpdateAsync(waitUntil, ToUpdateData(data), cancellationToken);

        private ArmOperation<CosmosTableThroughputSettingResource> Update(WaitUntil waitUntil, ThroughputSettingData data, CancellationToken cancellationToken = default)
