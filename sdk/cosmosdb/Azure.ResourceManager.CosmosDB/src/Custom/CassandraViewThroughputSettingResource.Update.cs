...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class CassandraViewThroughputSettingResource
    {
        private Task<ArmOperation<CassandraViewThroughputSettingResource>> UpdateAsync(WaitUntil waitUntil, ThroughputSettingData data, CancellationToken cancellationToken = default)
            => CreateOrUpdateAsync(waitUntil, ToUpdateData(data), cancellationToken);

        private ArmOperation<CassandraViewThroughputSettingResource> Update(WaitUntil waitUntil, ThroughputSettingData data, CancellationToken cancellationToken = default)
