...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class CassandraTableThroughputSettingResource
    {
        private Task<ArmOperation<CassandraTableThroughputSettingResource>> UpdateAsync(WaitUntil waitUntil, ThroughputSettingData data, CancellationToken cancellationToken = default)
            => CreateOrUpdateAsync(waitUntil, ToUpdateData(data), cancellationToken);

        private ArmOperation<CassandraTableThroughputSettingResource> Update(WaitUntil waitUntil, ThroughputSettingData data, CancellationToken cancellationToken = default)
