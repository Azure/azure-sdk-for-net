...
["owner"] = "mike",
        ...
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task InvokeCommandAsync_CosmosDBManagedCassandraCommandAsync()
        {
            // Generated from example definition: specification/cosmos-db/resource-manager/Microsoft.DocumentDB/preview/2024-02-15-preview/examples/CosmosDBManagedCassandraCommandAsync.json
            // this example is just showing the usage of "CassandraClusters_InvokeCommandAsync" operation, for the dependent resources, they will have to be created separately.
            ...
            ArmOperation<CommandPublicResource> lro = await cassandraCluster.InvokeCommandAsyncAsync(WaitUntil.Completed, body);
            CommandPublicResource result = lro.Value;
