...
namespace Microsoft.Azure.Management.CosmosDB
{
    ...
    /// </summary>
    internal partial class RestorableMongodbCollectionsOperations : IServiceOperations<CosmosDBManagementClient>, IRestorableMongodbCollectionsOperations
    {
        /// <summary>
        ...
        public async Task<AzureOperationResponse<IEnumerable<RestorableMongodbCollectionGetResult>>> ListWithHttpMessagesAsync(string location, string instanceId, string restorableMongodbDatabaseRid = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Create Result
            var _result = new AzureOperationResponse<IEnumerable<RestorableMongodbCollectionGetResult>>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<Page<RestorableMongodbCollectionGetResult>>(_responseContent, Client.DeserializationSettings);
                }
