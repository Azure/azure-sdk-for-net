...
namespace Microsoft.Azure.Management.CosmosDB.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the RestorableTablePropertiesResource
        /// class.
        /// </summary>
        ...
        /// <param name="eventTimestamp">The time when this table event
        /// happened.</param>
        /// <param name="ownerId">The name of this Table.</param>
        /// <param name="ownerResourceId">The resource ID of this
        /// Table.</param>
        public RestorableTablePropertiesResource(string _rid = default(string), string operationType = default(string), string eventTimestamp = default(string), string ownerId = default(string), string ownerResourceId = default(string))
        {
            this._rid = _rid;
        ...
        /// <summary>
        /// Gets the operation type of this table event. Possible values
