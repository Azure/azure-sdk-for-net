...
namespace Microsoft.Azure.Management.CosmosDB.Models
{
    ...
    public partial class CassandraViewCreateUpdateParameters : ARMResourceProperties
    {
        ...
        /// CassandraViewCreateUpdateParameters class.
        /// </summary>
        ...
        /// request.</param>
        public CassandraViewCreateUpdateParameters(CassandraViewResource resource, string id = default(string), string name = default(string), string type = default(string), string location = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), ManagedServiceIdentity identity = default(ManagedServiceIdentity), CreateUpdateOptions options = default(CreateUpdateOptions))
