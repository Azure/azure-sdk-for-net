...
namespace Microsoft.Azure.Management.CosmosDB.Models
{
    ...
    public partial class GraphResourceGetPropertiesResource
    {
        /// <summary>
        ...
        public GraphResourceGetPropertiesResource(string id, string _rid = default(string), double? _ts = default(double?), string _etag = default(string))
        {
            Id = id;
            this._rid = _rid;
            this._ts = _ts;
