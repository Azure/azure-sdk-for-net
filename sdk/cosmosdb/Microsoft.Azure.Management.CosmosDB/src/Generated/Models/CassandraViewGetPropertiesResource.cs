...
namespace Microsoft.Azure.Management.CosmosDB.Models
{
    ...
    public partial class CassandraViewGetPropertiesResource
    {
        ...
        public CassandraViewGetPropertiesResource(string id, string viewDefinition, string _rid = default(string), double? _ts = default(double?), string _etag = default(string))
        {
            Id = id;
