...
namespace Microsoft.Azure.Management.CosmosDB.Models
{
    ...
    public partial class SqlUserDefinedFunctionCreateUpdateParameters : ARMResourceProperties
    {
        ...
        public SqlUserDefinedFunctionCreateUpdateParameters(SqlUserDefinedFunctionResource resource, CreateUpdateOptions options, string id = default(string), string name = default(string), string type = default(string), string location = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>))
