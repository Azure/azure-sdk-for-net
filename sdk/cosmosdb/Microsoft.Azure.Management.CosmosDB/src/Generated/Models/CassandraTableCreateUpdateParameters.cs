...
namespace Microsoft.Azure.Management.CosmosDB.Models
{
    ...
    public partial class CassandraTableCreateUpdateParameters : ARMResourceProperties
    {
        ...
        /// request.</param>
        public CassandraTableCreateUpdateParameters(CassandraTableResource resource, string id = default(string), string name = default(string), string type = default(string), string location = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), CreateUpdateOptions options = default(CreateUpdateOptions))
