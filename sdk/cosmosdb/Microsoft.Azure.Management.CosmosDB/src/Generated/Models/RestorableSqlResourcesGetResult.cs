...
namespace Microsoft.Azure.Management.CosmosDB.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the RestorableSqlResourcesGetResult
        /// class.
        /// </summary>
        public RestorableSqlResourcesGetResult()
        {
            CustomInit();
        }
        ...
        public RestorableSqlResourcesGetResult(string id = default(string), string name = default(string), string type = default(string), string databaseName = default(string), IList<string> collectionNames = default(IList<string>))
        {
            Id = id;
            Name = name;
            Type = type;
