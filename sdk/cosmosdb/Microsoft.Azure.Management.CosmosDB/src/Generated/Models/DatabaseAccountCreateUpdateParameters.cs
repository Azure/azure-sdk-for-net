...
namespace Microsoft.Azure.Management.CosmosDB.Models
{
    ...
    public partial class DatabaseAccountCreateUpdateParameters : ARMResourceProperties
    {
        ...
        public DatabaseAccountCreateUpdateParameters(DatabaseAccountCreateUpdateProperties properties, string id = default(string), string name = default(string), string type = default(string), string location = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), string kind = default(string), ManagedServiceIdentity identity = default(ManagedServiceIdentity))
