...
namespace Microsoft.Azure.Management.CosmosDB.Models
{
    ...
    public partial class SqlDatabaseGetPropertiesResource
    {
        ...
        public SqlDatabaseGetPropertiesResource(string id, RestoreParameters restoreParameters = default(RestoreParameters), string createMode = default(string), string _rid = default(string), double? _ts = default(double?), string _etag = default(string), string _colls = default(string), string _users = default(string))
        {
            Id = id;
