...
namespace Microsoft.Azure.Management.CosmosDB.Models
{
    ...
    public partial class GraphResourceGetResults : ARMResourceProperties
    {
        ...
        public GraphResourceGetResults(string id = default(string), string name = default(string), string type = default(string), string location = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), ManagedServiceIdentity identity = default(ManagedServiceIdentity), GraphResourceGetPropertiesResource resource = default(GraphResourceGetPropertiesResource), GraphResourceGetPropertiesOptions options = default(GraphResourceGetPropertiesOptions))
