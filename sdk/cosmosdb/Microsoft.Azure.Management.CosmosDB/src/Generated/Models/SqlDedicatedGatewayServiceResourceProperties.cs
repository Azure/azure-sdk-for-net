...
namespace Microsoft.Azure.Management.CosmosDB.Models
{
    ...
    public partial class SqlDedicatedGatewayServiceResourceProperties : ServiceResourceProperties
    {
        ...
        public SqlDedicatedGatewayServiceResourceProperties(IDictionary<string, object> additionalProperties = default(IDictionary<string, object>), System.DateTime? creationTime = default(System.DateTime?), string instanceSize = default(string), int? instanceCount = default(int?), string status = default(string), string sqlDedicatedGatewayEndpoint = default(string), IList<SqlDedicatedGatewayRegionalServiceResource> locations = default(IList<SqlDedicatedGatewayRegionalServiceResource>))
