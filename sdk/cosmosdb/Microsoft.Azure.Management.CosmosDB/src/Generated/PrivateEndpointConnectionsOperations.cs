...
namespace Microsoft.Azure.Management.CosmosDB
{
    ...
    internal partial class PrivateEndpointConnectionsOperations : IServiceOperations<CosmosDBManagementClient>, IPrivateEndpointConnectionsOperations
    {
        ...
        /// </return>
        public async Task<AzureOperationResponse<IEnumerable<PrivateEndpointConnection>>> ListByDatabaseAccountWithHttpMessagesAsync(string resourceGroupName, string accountName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        {
            // Send Request
            AzureOperationResponse<PrivateEndpointConnection> _response = await BeginCreateOrUpdateWithHttpMessagesAsync(resourceGroupName, accountName, privateEndpointConnectionName, parameters, customHeaders, cancellationToken).ConfigureAwait(false);
