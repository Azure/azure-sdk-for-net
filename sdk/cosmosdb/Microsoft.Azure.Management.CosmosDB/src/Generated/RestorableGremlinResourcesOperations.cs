...
namespace Microsoft.Azure.Management.CosmosDB
{
    ...
    /// </summary>
    internal partial class RestorableGremlinResourcesOperations : IServiceOperations<CosmosDBManagementClient>, IRestorableGremlinResourcesOperations
    {
        /// <summary>
        /// Initializes a new instance of the RestorableGremlinResourcesOperations class.
        /// </summary>
        /// <param name='client'>
        ...
        /// </exception>
        internal RestorableGremlinResourcesOperations(CosmosDBManagementClient client)
        {
            if (client == null)
            {
        ...
        /// </return>
        public async Task<AzureOperationResponse<IEnumerable<RestorableGremlinResourcesGetResult>>> ListWithHttpMessagesAsync(string location, string instanceId, string restoreLocation = default(string), string restoreTimestampInUtc = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "subscriptions/{subscriptionId}/providers/Microsoft.DocumentDB/locations/{location}/restorableDatabaseAccounts/{instanceId}/restorableGremlinResources").ToString();
            ...
            // Create Result
            var _result = new AzureOperationResponse<IEnumerable<RestorableGremlinResourcesGetResult>>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<Page<RestorableGremlinResourcesGetResult>>(_responseContent, Client.DeserializationSettings);
                }
