...
namespace Microsoft.Azure.Management.CosmosDB
{
    ...
    public static partial class RestorableGremlinDatabasesOperationsExtensions
    {
            ...
            /// </param>
            public static IEnumerable<RestorableGremlinDatabaseGetResult> List(this IRestorableGremlinDatabasesOperations operations, string location, string instanceId)
            {
            ...
            /// </param>
            public static async Task<IEnumerable<RestorableGremlinDatabaseGetResult>> ListAsync(this IRestorableGremlinDatabasesOperations operations, string location, string instanceId, CancellationToken cancellationToken = default(CancellationToken))
            {
