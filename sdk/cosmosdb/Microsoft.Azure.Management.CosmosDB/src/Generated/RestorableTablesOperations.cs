...
namespace Microsoft.Azure.Management.CosmosDB
{
    ...
    /// </summary>
    internal partial class RestorableTablesOperations : IServiceOperations<CosmosDBManagementClient>, IRestorableTablesOperations
    {
        /// <summary>
        /// Initializes a new instance of the RestorableTablesOperations class.
        /// </summary>
        /// <param name='client'>
        ...
        /// </exception>
        internal RestorableTablesOperations(CosmosDBManagementClient client)
        {
            if (client == null)
            {
        ...
        /// </return>
        public async Task<AzureOperationResponse<IEnumerable<RestorableTableGetResult>>> ListWithHttpMessagesAsync(string location, string instanceId, string startTime = default(string), string endTime = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "subscriptions/{subscriptionId}/providers/Microsoft.DocumentDB/locations/{location}/restorableDatabaseAccounts/{instanceId}/restorableTables").ToString();
            ...
            // Create Result
            var _result = new AzureOperationResponse<IEnumerable<RestorableTableGetResult>>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<Page<RestorableTableGetResult>>(_responseContent, Client.DeserializationSettings);
                }
