...
namespace Microsoft.Azure.Management.CosmosDB
{
    ...
    /// </summary>
    internal partial class RestorableSqlDatabasesOperations : IServiceOperations<CosmosDBManagementClient>, IRestorableSqlDatabasesOperations
    {
        /// <summary>
        ...
        /// </return>
        public async Task<AzureOperationResponse<IEnumerable<RestorableSqlDatabaseGetResult>>> ListWithHttpMessagesAsync(string location, string instanceId, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Create Result
            var _result = new AzureOperationResponse<IEnumerable<RestorableSqlDatabaseGetResult>>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<Page<RestorableSqlDatabaseGetResult>>(_responseContent, Client.DeserializationSettings);
                }
