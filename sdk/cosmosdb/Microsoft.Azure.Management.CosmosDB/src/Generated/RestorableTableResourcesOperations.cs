...
namespace Microsoft.Azure.Management.CosmosDB
{
    ...
    internal partial class RestorableTableResourcesOperations : IServiceOperations<CosmosDBManagementClient>, IRestorableTableResourcesOperations
    {
        ...
        /// </return>
        public async Task<AzureOperationResponse<IList<string>>> ListWithHttpMessagesAsync(string location, string instanceId, string restoreLocation = default(string), string restoreTimestampInUtc = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
