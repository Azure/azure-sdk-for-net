...
namespace Microsoft.Azure.Management.CosmosDB
{
    ...
    /// </summary>
    internal partial class RestorableSqlContainersOperations : IServiceOperations<CosmosDBManagementClient>, IRestorableSqlContainersOperations
    {
        /// <summary>
        ...
        public async Task<AzureOperationResponse<IEnumerable<RestorableSqlContainerGetResult>>> ListWithHttpMessagesAsync(string location, string instanceId, string restorableSqlDatabaseRid = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Create Result
            var _result = new AzureOperationResponse<IEnumerable<RestorableSqlContainerGetResult>>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<Page<RestorableSqlContainerGetResult>>(_responseContent, Client.DeserializationSettings);
                }
