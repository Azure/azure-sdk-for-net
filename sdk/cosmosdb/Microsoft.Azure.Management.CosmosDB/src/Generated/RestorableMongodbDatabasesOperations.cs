...
namespace Microsoft.Azure.Management.CosmosDB
{
    ...
    /// </summary>
    internal partial class RestorableMongodbDatabasesOperations : IServiceOperations<CosmosDBManagementClient>, IRestorableMongodbDatabasesOperations
    {
        /// <summary>
        ...
        /// </return>
        public async Task<AzureOperationResponse<IEnumerable<RestorableMongodbDatabaseGetResult>>> ListWithHttpMessagesAsync(string location, string instanceId, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Create Result
            var _result = new AzureOperationResponse<IEnumerable<RestorableMongodbDatabaseGetResult>>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<Page<RestorableMongodbDatabaseGetResult>>(_responseContent, Client.DeserializationSettings);
                }
