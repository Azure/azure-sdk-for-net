...
namespace Microsoft.Azure.Management.CosmosDB
{
    ...
    /// </summary>
    internal partial class CassandraStatusOperations : IServiceOperations<CosmosDBManagementClient>, ICassandraStatusOperations
    {
        /// <summary>
        /// Initializes a new instance of the CassandraStatusOperations class.
        /// </summary>
        /// <param name='client'>
        ...
        /// </exception>
        internal CassandraStatusOperations(CosmosDBManagementClient client)
        {
            if (client == null)
            {
        ...
        /// </return>
        public async Task<AzureOperationResponse<CassandraClusterPublicStatus>> GetWithHttpMessagesAsync(string resourceGroupName, string clusterName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
