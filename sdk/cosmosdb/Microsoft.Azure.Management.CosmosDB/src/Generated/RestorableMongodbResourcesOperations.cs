...
namespace Microsoft.Azure.Management.CosmosDB
{
    ...
    /// </summary>
    internal partial class RestorableMongodbResourcesOperations : IServiceOperations<CosmosDBManagementClient>, IRestorableMongodbResourcesOperations
    {
        /// <summary>
        ...
        /// </return>
        public async Task<AzureOperationResponse<IEnumerable<RestorableMongodbResourcesGetResult>>> ListWithHttpMessagesAsync(string location, string instanceId, string restoreLocation = default(string), string restoreTimestampInUtc = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Create Result
            var _result = new AzureOperationResponse<IEnumerable<RestorableMongodbResourcesGetResult>>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<Page<RestorableMongodbResourcesGetResult>>(_responseContent, Client.DeserializationSettings);
                }
