...
namespace Microsoft.Azure.Management.LabServices
{
    ...
    public static partial class SkusOperationsExtensions
    {
            ...
            /// </param>
            public static IPage<LabServicesSku> ListNext(this ISkusOperations operations, string nextPageLink)
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<IPage<LabServicesSku>> ListNextAsync(this ISkusOperations operations, string nextPageLink, CancellationToken cancellationToken = default(CancellationToken))
            {
