...
namespace Microsoft.Azure.Management.LabServices
{
    ...
    public partial interface IOperationResultsOperations
    {
        ...
        /// </exception>
        Task<AzureOperationResponse<OperationResult>> GetWithHttpMessagesAsync(string operationResultId, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
    }
}
