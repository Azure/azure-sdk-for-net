...
{
    public partial class LabPlanData : IUtf8JsonSerializable, IJsonModel<LabPlanData>, IPersistableModel<LabPlanData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(DefaultConnectionProfile))
            {
                builder.Append("  defaultConnectionProfile:");
                AppendChildObject(builder, DefaultConnectionProfile, options, 2);
            }

            if (Optional.IsDefined(DefaultAutoShutdownProfile))
            {
                builder.Append("  defaultAutoShutdownProfile:");
                AppendChildObject(builder, DefaultAutoShutdownProfile, options, 2);
            }

            if (Optional.IsDefined(DefaultNetworkProfile))
            {
                builder.Append("  defaultNetworkProfile:");
                AppendChildObject(builder, DefaultNetworkProfile, options, 2);
            }

            if (Optional.IsCollectionDefined(AllowedRegions))
            {
                builder.Append("  allowedRegions:");
                builder.AppendLine(" [");
                foreach (var item in AllowedRegions)
                {
            ...
            if (Optional.IsDefined(SupportInfo))
            {
                builder.Append("  supportInfo:");
                AppendChildObject(builder, SupportInfo, options, 2);
            }

            if (Optional.IsDefined(LinkedLmsInstance))
            {
                builder.Append("  linkedLmsInstance:");
                builder.AppendLine($" '{LinkedLmsInstance.AbsoluteUri}'");
            }
