    ...
    public partial class LabPlanData : IUtf8JsonSerializable, IJsonModel<LabPlanData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(DefaultConnectionProfile))
            {
                ...
                AppendChildObject(builder, DefaultConnectionProfile, options, 4, false);
            }

            if (Optional.IsDefined(DefaultAutoShutdownProfile))
            {
                builder.Append("    defaultAutoShutdownProfile:");
                AppendChildObject(builder, DefaultAutoShutdownProfile, options, 4, false);
            }

            if (Optional.IsDefined(DefaultNetworkProfile))
            {
                builder.Append("    defaultNetworkProfile:");
                AppendChildObject(builder, DefaultNetworkProfile, options, 4, false);
            }

            if (Optional.IsCollectionDefined(AllowedRegions))
            {
                if (AllowedRegions.Any())
                {
            ...
            if (Optional.IsDefined(SupportInfo))
            {
                ...
                AppendChildObject(builder, SupportInfo, options, 4, false);
            }
