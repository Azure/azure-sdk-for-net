...
{
    public partial class LabPlanData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static LabPlanData DeserializeLabPlanData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
