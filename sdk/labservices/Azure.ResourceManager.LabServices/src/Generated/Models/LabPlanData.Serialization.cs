...
namespace Azure.ResourceManager.LabServices
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LabPlanData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<LabPlanData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<LabPlanData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<LabPlanData>)} interface");
            }
        ...
        string IPersistableModel<LabPlanData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
