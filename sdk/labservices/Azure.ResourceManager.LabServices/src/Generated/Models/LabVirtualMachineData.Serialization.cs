...
{
    public partial class LabVirtualMachineData : IUtf8JsonSerializable, IJsonModel<LabVirtualMachineData>, IPersistableModel<LabVirtualMachineData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LabVirtualMachineData>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<LabVirtualMachineData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(LabVirtualMachineData)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  connectionProfile:");
                AppendChildObject(builder, ConnectionProfile, options, 2);
            }

            if (Optional.IsDefined(ClaimedByUserId))
            {
                builder.Append("  claimedByUserId:");
                builder.AppendLine($" '{ClaimedByUserId}'");
            }
