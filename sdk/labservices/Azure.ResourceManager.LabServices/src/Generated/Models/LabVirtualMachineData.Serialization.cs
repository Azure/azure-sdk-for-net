    ...
    public partial class LabVirtualMachineData : IUtf8JsonSerializable, IJsonModel<LabVirtualMachineData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ConnectionProfile))
            {
                ...
                AppendChildObject(builder, ConnectionProfile, options, 4, false);
            }

            if (Optional.IsDefined(ClaimedByUserId))
            {
                builder.Append("    claimedByUserId:");
                if (ClaimedByUserId.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(VmType))
            {
                ...
                builder.AppendLine($" '{VmType.Value.ToSerialString()}'");
            }
