...
namespace Azure.ResourceManager.LabServices
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LabVirtualMachineData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<LabVirtualMachineData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<LabVirtualMachineData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<LabVirtualMachineData>)} interface");
            }
        ...
        string IPersistableModel<LabVirtualMachineData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
