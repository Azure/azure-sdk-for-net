...
namespace Azure.ResourceManager.LabServices
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LabVirtualMachineImageData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<LabVirtualMachineImageData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<LabVirtualMachineImageData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<LabVirtualMachineImageData>)} interface");
            }
        ...
        string IPersistableModel<LabVirtualMachineImageData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
