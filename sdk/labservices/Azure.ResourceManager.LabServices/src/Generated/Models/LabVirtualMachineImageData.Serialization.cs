...
namespace Azure.ResourceManager.LabServices
{
    public partial class LabVirtualMachineImageData : IUtf8JsonSerializable, IModelJsonSerializable<LabVirtualMachineImageData>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<LabVirtualMachineImageData>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="LabVirtualMachineImageData"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="LabVirtualMachineImageData"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="LabVirtualMachineImageData"/>. </summary>
