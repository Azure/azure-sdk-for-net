...
namespace Azure.ResourceManager.LabServices.Models
{
    ...
    public partial class LabServicesRecurrencePattern
    {
        ...
        internal LabServicesRecurrencePattern(LabServicesRecurrenceFrequency frequency, IList<LabServicesDayOfWeek> weekDays, int? interval, DateTimeOffset expireOn, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Frequency = frequency;
            WeekDays = weekDays;
            Interval = interval;
