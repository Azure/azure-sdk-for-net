...
namespace Azure.ResourceManager.LabServices.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LabServicesUsage>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<LabServicesUsage>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<LabServicesUsage>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<LabServicesUsage>)} interface");
            }
        ...
        string IPersistableModel<LabServicesUsage>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
