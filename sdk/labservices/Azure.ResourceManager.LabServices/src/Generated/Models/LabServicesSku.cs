...
namespace Azure.ResourceManager.LabServices.Models
{
    ...
    public partial class LabServicesSku
    {
        ...
        /// <summary> Initializes a new instance of <see cref="LabServicesSku"/>. </summary>
        ...
        internal LabServicesSku(string name, LabServicesSkuTier? tier, string size, string family, int? capacity, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Tier = tier;
            Size = size;
        ...
        /// <summary> Initializes a new instance of <see cref="LabServicesSku"/> for deserialization. </summary>
