...
namespace Azure.ResourceManager.LabServices.Models
{
    ...
    public partial class LabServicesSku
    {
        ...
        internal LabServicesSku(string name, LabServicesSkuTier? tier, string size, string family, int? capacity, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Tier = tier;
            Size = size;
