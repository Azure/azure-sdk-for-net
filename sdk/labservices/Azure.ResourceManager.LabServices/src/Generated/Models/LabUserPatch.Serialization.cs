...
namespace Azure.ResourceManager.LabServices.Models
{
    public partial class LabUserPatch : IUtf8JsonSerializable, IJsonModel<LabUserPatch>
    {
        ...
        void IJsonModel<LabUserPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(LabUserPatch)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<LabUserPatch>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(LabUserPatch)} does not support '{options.Format}' format.");
            }
        }
