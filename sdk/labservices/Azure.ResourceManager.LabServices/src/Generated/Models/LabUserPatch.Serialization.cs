...
namespace Azure.ResourceManager.LabServices.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LabUserPatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<LabUserPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<LabUserPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<LabUserPatch>)} interface");
            }
        ...
        string IPersistableModel<LabUserPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
