...
namespace Azure.ResourceManager.LabServices.Models
{
    ...
    public partial class LabVirtualMachineConnectionProfile
    {
        ...
        internal LabVirtualMachineConnectionProfile(IPAddress privateIPAddress, string sshAuthority, Uri sshInBrowserUri, string rdpAuthority, Uri rdpInBrowserUri, string adminUsername, string nonAdminUsername, Dictionary<string, BinaryData> rawData)
        {
