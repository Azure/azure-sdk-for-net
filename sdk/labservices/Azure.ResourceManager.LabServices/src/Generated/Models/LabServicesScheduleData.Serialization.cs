...
namespace Azure.ResourceManager.LabServices
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LabServicesScheduleData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<LabServicesScheduleData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<LabServicesScheduleData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<LabServicesScheduleData>)} interface");
            }
        ...
        string IPersistableModel<LabServicesScheduleData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
