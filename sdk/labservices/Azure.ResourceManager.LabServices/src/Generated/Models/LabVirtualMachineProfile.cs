...
namespace Azure.ResourceManager.LabServices.Models
{
    ...
    public partial class LabVirtualMachineProfile
    {
        ...
        internal LabVirtualMachineProfile(LabVirtualMachineCreateOption createOption, LabVirtualMachineImageReference imageReference, LabVirtualMachineImageOSType? osType, LabServicesSku sku, LabVirtualMachineAdditionalCapability additionalCapabilities, TimeSpan usageQuota, LabServicesEnableState? useSharedPassword, LabVirtualMachineCredential adminUser, LabVirtualMachineCredential nonAdminUser, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            CreateOption = createOption;
            ImageReference = imageReference;
            OSType = osType;
