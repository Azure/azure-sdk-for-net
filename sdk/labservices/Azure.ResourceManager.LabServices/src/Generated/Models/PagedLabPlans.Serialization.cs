...
namespace Azure.ResourceManager.LabServices.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PagedLabPlans>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(PagedLabPlans)} does not support writing '{format}' format.");
            }
            ...
            if (options.Format != "W" && Optional.IsCollectionDefined(Value))
            {
                ...
                {
                    ((IJsonModel<LabPlanData>)item).Write(writer, options);
                }
        ...
        PagedLabPlans IJsonModel<PagedLabPlans>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(PagedLabPlans)} does not support reading '{format}' format.");
            }
        ...
        internal static PagedLabPlans DeserializePagedLabPlans(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new PagedLabPlans(value ?? new ChangeTrackingList<LabPlanData>(), nextLink, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<PagedLabPlans>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(PagedLabPlans)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        PagedLabPlans IPersistableModel<PagedLabPlans>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(PagedLabPlans)} does not support reading '{options.Format}' format.");
            }
        }
