...
namespace Azure.ResourceManager.LabServices.Models
{
    ...
    public partial class LabRosterProfile
    {
        ...
        internal LabRosterProfile(string activeDirectoryGroupId, string ltiContextId, Uri lmsInstance, string ltiClientId, Uri ltiRosterEndpoint, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
