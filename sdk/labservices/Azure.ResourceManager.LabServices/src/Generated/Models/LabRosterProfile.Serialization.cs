...
{
    public partial class LabRosterProfile : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static LabRosterProfile DeserializeLabRosterProfile(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
