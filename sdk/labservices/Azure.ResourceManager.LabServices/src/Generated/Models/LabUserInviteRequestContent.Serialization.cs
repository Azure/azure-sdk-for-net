...
namespace Azure.ResourceManager.LabServices.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LabUserInviteRequestContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<LabUserInviteRequestContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<LabUserInviteRequestContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<LabUserInviteRequestContent>)} interface");
            }
        ...
        string IPersistableModel<LabUserInviteRequestContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
