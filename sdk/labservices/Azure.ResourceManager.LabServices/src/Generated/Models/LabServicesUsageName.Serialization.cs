...
namespace Azure.ResourceManager.LabServices.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LabServicesUsageName>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<LabServicesUsageName>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<LabServicesUsageName>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<LabServicesUsageName>)} interface");
            }
        ...
        string IPersistableModel<LabServicesUsageName>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
