...
{
    public partial class LabServicesSku : Core.IUtf8JsonSerializable
    {
        ...
        internal static LabServicesSku DeserializeLabServicesSku(JsonElement element)
        {
            ...
            string name = default;
            Core.Optional<LabServicesSkuTier> tier = default;
            ...
            return new LabServicesSku(name, Core.Optional.ToNullable(tier), size.Value, family.Value, Core.Optional.ToNullable(capacity));
        }
    }
}
