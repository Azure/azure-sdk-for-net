...
{
    public partial class LabData : IUtf8JsonSerializable, IJsonModel<LabData>, IPersistableModel<LabData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(AutoShutdownProfile))
            {
                builder.Append("  autoShutdownProfile:");
                AppendChildObject(builder, AutoShutdownProfile, options, 2);
            }
            ...
            if (Optional.IsDefined(RosterProfile))
            {
                builder.Append("  rosterProfile:");
                AppendChildObject(builder, RosterProfile, options, 2);
            }

            if (Optional.IsDefined(LabPlanId))
            {
                builder.Append("  labPlanId:");
                builder.AppendLine($" '{LabPlanId.ToString()}'");
            }
