...
namespace Azure.ResourceManager.LabServices
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LabData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<LabData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<LabData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<LabData>)} interface");
            }
        ...
        string IPersistableModel<LabData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
