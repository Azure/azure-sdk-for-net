...
{
    public partial class LabData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static LabData DeserializeLabData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
