...
namespace Azure.ResourceManager.LabServices.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PagedUsers>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PagedUsers>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PagedUsers>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PagedUsers>)} interface");
            }
        ...
        string IPersistableModel<PagedUsers>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
