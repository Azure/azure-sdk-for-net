...
namespace Azure.ResourceManager.LabServices.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LabVirtualMachineResetPasswordContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<LabVirtualMachineResetPasswordContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<LabVirtualMachineResetPasswordContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<LabVirtualMachineResetPasswordContent>)} interface");
            }
        ...
        string IPersistableModel<LabVirtualMachineResetPasswordContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
