...
{
    internal partial class PagedImages : IUtf8JsonSerializable, IJsonModel<PagedImages>, IPersistableModel<PagedImages>
    {
        ...
        void IJsonModel<PagedImages>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(PagedImages)} does not support '{format}' format.");
            }
