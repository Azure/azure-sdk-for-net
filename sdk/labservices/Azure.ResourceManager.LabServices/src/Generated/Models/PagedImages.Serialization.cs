...
namespace Azure.ResourceManager.LabServices.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PagedImages>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PagedImages>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PagedImages>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PagedImages>)} interface");
            }
        ...
        string IPersistableModel<PagedImages>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
