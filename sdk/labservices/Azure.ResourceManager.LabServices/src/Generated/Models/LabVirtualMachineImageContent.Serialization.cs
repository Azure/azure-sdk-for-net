...
namespace Azure.ResourceManager.LabServices.Models
{
    public partial class LabVirtualMachineImageContent : IUtf8JsonSerializable, IJsonModel<LabVirtualMachineImageContent>
    {
        ...
        void IJsonModel<LabVirtualMachineImageContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(LabVirtualMachineImageContent)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<LabVirtualMachineImageContent>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(LabVirtualMachineImageContent)} does not support '{options.Format}' format.");
            }
        }
