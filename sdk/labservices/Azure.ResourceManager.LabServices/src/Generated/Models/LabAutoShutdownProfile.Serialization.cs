...
{
    public partial class LabAutoShutdownProfile : IUtf8JsonSerializable, IJsonModel<LabAutoShutdownProfile>, IPersistableModel<LabAutoShutdownProfile>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ShutdownOnDisconnect))
            {
                builder.Append("  shutdownOnDisconnect:");
                builder.AppendLine($" '{ShutdownOnDisconnect.ToString()}'");
            }

            if (Optional.IsDefined(ShutdownWhenNotConnected))
            {
                builder.Append("  shutdownWhenNotConnected:");
                builder.AppendLine($" '{ShutdownWhenNotConnected.ToString()}'");
            }

            if (Optional.IsDefined(ShutdownOnIdle))
            {
                builder.Append("  shutdownOnIdle:");
                builder.AppendLine($" '{ShutdownOnIdle.ToString()}'");
            }

            if (Optional.IsDefined(DisconnectDelay))
            {
                builder.Append("  disconnectDelay:");
                var formattedTimeSpan = XmlConvert.ToString(DisconnectDelay.Value);
                builder.AppendLine($" '{formattedTimeSpan}'");
            }

            if (Optional.IsDefined(NoConnectDelay))
            {
                builder.Append("  noConnectDelay:");
                var formattedTimeSpan = XmlConvert.ToString(NoConnectDelay.Value);
                builder.AppendLine($" '{formattedTimeSpan}'");
            }

            if (Optional.IsDefined(IdleDelay))
            {
                builder.Append("  idleDelay:");
                var formattedTimeSpan = XmlConvert.ToString(IdleDelay.Value);
                builder.AppendLine($" '{formattedTimeSpan}'");
            }
