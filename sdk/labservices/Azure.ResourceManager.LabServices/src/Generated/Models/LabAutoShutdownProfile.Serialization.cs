...
namespace Azure.ResourceManager.LabServices.Models
{
    public partial class LabAutoShutdownProfile : IUtf8JsonSerializable, IModelJsonSerializable<LabAutoShutdownProfile>
    {
        ...
        internal static LabAutoShutdownProfile DeserializeLabAutoShutdownProfile(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new LabAutoShutdownProfile(Optional.ToNullable(shutdownOnDisconnect), Optional.ToNullable(shutdownWhenNotConnected), Optional.ToNullable(shutdownOnIdle), Optional.ToNullable(disconnectDelay), Optional.ToNullable(noConnectDelay), Optional.ToNullable(idleDelay), rawData);
        }
