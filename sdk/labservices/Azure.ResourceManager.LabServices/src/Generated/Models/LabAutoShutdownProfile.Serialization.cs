...
namespace Azure.ResourceManager.LabServices.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LabAutoShutdownProfile>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<LabAutoShutdownProfile>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<LabAutoShutdownProfile>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<LabAutoShutdownProfile>)} interface");
            }
        ...
        string IPersistableModel<LabAutoShutdownProfile>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
