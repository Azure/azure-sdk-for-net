...
{
    public partial class LabAutoShutdownProfile : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static LabAutoShutdownProfile DeserializeLabAutoShutdownProfile(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
