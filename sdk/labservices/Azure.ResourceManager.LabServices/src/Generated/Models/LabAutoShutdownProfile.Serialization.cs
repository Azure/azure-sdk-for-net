    ...
    public partial class LabAutoShutdownProfile : IUtf8JsonSerializable, IJsonModel<LabAutoShutdownProfile>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ShutdownOnDisconnect))
            {
                ...
                builder.AppendLine($" '{ShutdownOnDisconnect.Value.ToSerialString()}'");
            }

            if (Optional.IsDefined(ShutdownWhenNotConnected))
            {
                builder.Append("  shutdownWhenNotConnected:");
                builder.AppendLine($" '{ShutdownWhenNotConnected.Value.ToSerialString()}'");
            }

            if (Optional.IsDefined(ShutdownOnIdle))
            {
                builder.Append("  shutdownOnIdle:");
                builder.AppendLine($" '{ShutdownOnIdle.Value.ToSerialString()}'");
            }

            if (Optional.IsDefined(DisconnectDelay))
            {
                builder.Append("  disconnectDelay:");
                var formattedTimeSpan = TypeFormatters.ToString(DisconnectDelay.Value, "P");
            ...
            if (Optional.IsDefined(NoConnectDelay))
            {
                ...
                var formattedTimeSpan = TypeFormatters.ToString(NoConnectDelay.Value, "P");
                builder.AppendLine($" '{formattedTimeSpan}'");
            }
            ...
            if (Optional.IsDefined(IdleDelay))
            {
                ...
                var formattedTimeSpan = TypeFormatters.ToString(IdleDelay.Value, "P");
                builder.AppendLine($" '{formattedTimeSpan}'");
            }
