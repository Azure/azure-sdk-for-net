...
{
    internal partial class PagedVirtualMachines : IUtf8JsonSerializable, IJsonModel<PagedVirtualMachines>, IPersistableModel<PagedVirtualMachines>
    {
        ...
        void IJsonModel<PagedVirtualMachines>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(PagedVirtualMachines)} does not support '{format}' format.");
            }
