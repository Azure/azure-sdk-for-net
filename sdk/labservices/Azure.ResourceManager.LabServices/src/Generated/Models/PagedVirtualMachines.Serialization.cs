...
namespace Azure.ResourceManager.LabServices.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PagedVirtualMachines>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PagedVirtualMachines>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PagedVirtualMachines>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PagedVirtualMachines>)} interface");
            }
        ...
        string IPersistableModel<PagedVirtualMachines>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
