...
namespace Azure.ResourceManager.LabServices.Models
{
    ...
    public partial class LabServicesSchedulePatch
    {
        ...
        internal LabServicesSchedulePatch(DateTimeOffset? startOn, DateTimeOffset? stopOn, LabServicesRecurrencePattern recurrencePattern, string timeZoneId, BinaryData notes, Dictionary<string, BinaryData> rawData)
        {
            StartOn = startOn;
            StopOn = stopOn;
