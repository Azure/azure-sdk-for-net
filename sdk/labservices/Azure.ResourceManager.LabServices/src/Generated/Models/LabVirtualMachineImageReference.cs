...
namespace Azure.ResourceManager.LabServices.Models
{
    ...
    public partial class LabVirtualMachineImageReference
    {
        ...
        internal LabVirtualMachineImageReference(ResourceIdentifier id, string offer, string publisher, string sku, string version, string exactVersion, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Offer = offer;
            Publisher = publisher;
