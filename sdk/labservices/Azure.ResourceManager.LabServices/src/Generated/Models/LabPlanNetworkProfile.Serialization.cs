...
namespace Azure.ResourceManager.LabServices.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LabPlanNetworkProfile>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<LabPlanNetworkProfile>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<LabPlanNetworkProfile>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<LabPlanNetworkProfile>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
