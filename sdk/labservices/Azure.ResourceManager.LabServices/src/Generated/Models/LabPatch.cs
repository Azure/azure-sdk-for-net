...
namespace Azure.ResourceManager.LabServices.Models
{
    ...
    public partial class LabPatch : LabServicesPatchBaseInfo
    {
        ...
        internal LabPatch(IList<string> tags, LabAutoShutdownProfile autoShutdownProfile, LabConnectionProfile connectionProfile, LabVirtualMachineProfile virtualMachineProfile, LabSecurityProfile securityProfile, LabRosterProfile rosterProfile, ResourceIdentifier labPlanId, string title, string description, Dictionary<string, BinaryData> rawData) : base(tags, rawData)
        {
