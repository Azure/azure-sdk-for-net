...
{
    public partial class LabUserData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static LabUserData DeserializeLabUserData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
