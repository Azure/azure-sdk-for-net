...
{
    public partial class LabSecurityProfile : IUtf8JsonSerializable, IJsonModel<LabSecurityProfile>, IPersistableModel<LabSecurityProfile>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(RegistrationCode))
            {
                ...
                builder.AppendLine($" '{RegistrationCode}'");
            }

            if (Optional.IsDefined(OpenAccess))
            {
                builder.Append("  openAccess:");
                builder.AppendLine($" '{OpenAccess.ToString()}'");
            }
