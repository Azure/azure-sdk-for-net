...
namespace Azure.ResourceManager.LabServices.Models
{
    ...
    {
        internal static AvailableLabServicesSkuCost DeserializeAvailableLabServicesSkuCost(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
