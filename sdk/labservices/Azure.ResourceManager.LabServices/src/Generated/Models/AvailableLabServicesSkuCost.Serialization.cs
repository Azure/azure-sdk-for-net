...
namespace Azure.ResourceManager.LabServices.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AvailableLabServicesSkuCost>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AvailableLabServicesSkuCost>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AvailableLabServicesSkuCost>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AvailableLabServicesSkuCost>)} interface");
            }
        ...
        string IPersistableModel<AvailableLabServicesSkuCost>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
