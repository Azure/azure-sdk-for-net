...
namespace Azure.ResourceManager.LabServices.Models
{
    public partial class LabPlanSupportInfo : IUtf8JsonSerializable, IJsonModel<LabPlanSupportInfo>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<LabPlanSupportInfo>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<LabPlanSupportInfo>)} interface");
            }
