...
namespace Azure.ResourceManager.LabServices.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LabServicesUsageListResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(LabServicesUsageListResult)} does not support writing '{format}' format.");
            }
            ...
            if (Optional.IsCollectionDefined(Value))
            {
                ...
                {
                    ((IJsonModel<LabServicesUsage>)item).Write(writer, options);
                }
        ...
        LabServicesUsageListResult IJsonModel<LabServicesUsageListResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(LabServicesUsageListResult)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<LabServicesUsageListResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(LabServicesUsageListResult)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        LabServicesUsageListResult IPersistableModel<LabServicesUsageListResult>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(LabServicesUsageListResult)} does not support reading '{options.Format}' format.");
            }
        }
