...
namespace Azure.ResourceManager.LabServices.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AvailableLabServicesSku>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AvailableLabServicesSku>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AvailableLabServicesSku>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AvailableLabServicesSku>)} interface");
            }
        ...
        string IPersistableModel<AvailableLabServicesSku>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
