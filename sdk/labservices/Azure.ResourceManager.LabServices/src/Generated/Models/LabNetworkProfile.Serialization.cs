...
{
    public partial class LabNetworkProfile : IUtf8JsonSerializable, IJsonModel<LabNetworkProfile>, IPersistableModel<LabNetworkProfile>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(LoadBalancerId))
            {
                ...
                builder.AppendLine($" '{LoadBalancerId.ToString()}'");
            }

            if (Optional.IsDefined(PublicIPId))
            {
                builder.Append("  publicIpId:");
                builder.AppendLine($" '{PublicIPId.ToString()}'");
            }
