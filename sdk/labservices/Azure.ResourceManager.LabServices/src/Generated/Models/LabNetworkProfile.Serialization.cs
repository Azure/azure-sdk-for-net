...
namespace Azure.ResourceManager.LabServices.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LabNetworkProfile>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<LabNetworkProfile>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<LabNetworkProfile>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<LabNetworkProfile>)} interface");
            }
        ...
        string IPersistableModel<LabNetworkProfile>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
