...
namespace Azure.ResourceManager.LabServices.Mocking
{
    ...
    internal partial class LabServicesArmClientMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="LabServicesArmClientMockingExtension"/> class for mocking. </summary>
        protected LabServicesArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="LabServicesArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal LabServicesArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal LabServicesArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
