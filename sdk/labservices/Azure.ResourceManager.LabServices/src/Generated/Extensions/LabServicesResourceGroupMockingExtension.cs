...
namespace Azure.ResourceManager.LabServices.Mocking
{
    ...
    internal partial class LabServicesResourceGroupMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="LabServicesResourceGroupMockingExtension"/> class for mocking. </summary>
        protected LabServicesResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="LabServicesResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal LabServicesResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
