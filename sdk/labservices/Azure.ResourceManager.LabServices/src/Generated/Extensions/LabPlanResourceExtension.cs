...
namespace Azure.ResourceManager.LabServices.Mock
{
    ...
    public partial class LabPlanResourceExtension : ArmResource
    {
        private ClientDiagnostics _labPlanClientDiagnostics;
        private LabPlansRestOperations _labPlanRestClient;

        /// <summary> Initializes a new instance of the <see cref="LabPlanResourceExtension"/> class for mocking. </summary>
        protected LabPlanResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="LabPlanResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal LabPlanResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<LabPlanResource> GetLabPlansAsync(string filter = null, CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new LabPlanResource(Client, LabPlanData.DeserializeLabPlanData(e)), LabPlanClientDiagnostics, Pipeline, "LabPlanResourceExtension.GetLabPlans", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<LabPlanResource> GetLabPlans(string filter = null, CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => LabPlanRestClient.CreateListBySubscriptionRequest(Id.SubscriptionId, filter);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => LabPlanRestClient.CreateListBySubscriptionNextPageRequest(nextLink, Id.SubscriptionId, filter);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new LabPlanResource(Client, LabPlanData.DeserializeLabPlanData(e)), LabPlanClientDiagnostics, Pipeline, "LabPlanResourceExtension.GetLabPlans", "value", "nextLink", cancellationToken);
        }
    }
}
