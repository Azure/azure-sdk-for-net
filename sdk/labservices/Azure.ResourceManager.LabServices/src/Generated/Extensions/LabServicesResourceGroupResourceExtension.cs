...
namespace Azure.ResourceManager.LabServices.Mock
{
    ...
    public partial class LabServicesResourceGroupResourceExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="LabServicesResourceGroupResourceExtension"/> class for mocking. </summary>
        protected LabServicesResourceGroupResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="LabServicesResourceGroupResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal LabServicesResourceGroupResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
