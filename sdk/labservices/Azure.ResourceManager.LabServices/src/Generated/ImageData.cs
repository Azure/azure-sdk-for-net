...
namespace Azure.ResourceManager.LabServices
{
    ...
    public partial class ImageData : ResourceData
    {
        ...
        internal ImageData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, EnableState? enabledState, ProvisioningState? provisioningState, string displayName, string description, Uri iconUri, string author, OSType? osType, string plan, EnableState? termsStatus, string offer, string publisher, string sku, string version, string sharedGalleryId, IList<string> availableRegions, OSState? osState) : base(id, name, resourceType, systemData)
        {
