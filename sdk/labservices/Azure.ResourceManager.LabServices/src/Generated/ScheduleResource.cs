...
namespace Azure.ResourceManager.LabServices
{
    ...
    /// Otherwise you can get one from its parent resource <see cref="LabResource" /> using the GetSchedule method.
    /// </summary>
    public partial class ScheduleResource : ArmResource
    {
        ...
        {
            _scheduleClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.LabServices", ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new LabServicesArmOperation(_scheduleClientDiagnostics, Pipeline, _scheduleRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name).Request, response, OperationFinalStateVia.Location);
