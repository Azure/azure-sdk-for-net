    ...
    public partial class LabServicesScheduleData : IUtf8JsonSerializable, IJsonModel<LabServicesScheduleData>
    {
        ...
        internal static LabServicesScheduleData DeserializeLabServicesScheduleData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
				...
				global::System.ClientModel.Primitives.ModelReaderWriter.Read<global::Azure.ResourceManager.Models.SystemData>(new global::System.BinaryData(global::System.Runtime.InteropServices.JsonMarshal.GetRawUtf8Value(property.Value).ToArray()), global::Azure.ResourceManager.LabServices.ModelSerializationExtensions.WireOptions, AzureResourceManagerLabServicesContext.Default)
#else
                ModelReaderWriter.Read<SystemData>(new BinaryData(Encoding.UTF8.GetBytes(property.Value.GetRawText())), ModelSerializationExtensions.WireOptions, AzureResourceManagerLabServicesContext.Default)
#endif
;
                    continue;
                }
