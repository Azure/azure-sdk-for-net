...
namespace Azure.ResourceManager.LabServices
{
    ...
    public partial class LabUserResource : ArmResource
    {
        ...
        internal LabUserResource(ArmClient client, LabUserData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<LabUserResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new LabUserResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
