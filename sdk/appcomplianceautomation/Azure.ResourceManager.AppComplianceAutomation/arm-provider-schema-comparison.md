# ARM provider schema comparison: Azure.ResourceManager.AppComplianceAutomation
...
| --- | --- | --- |
| `/providers/Microsoft.AppComplianceAutomation/reports/{reportName}` | `AppComplianceReport` | `ReportResource` |
| `/providers/Microsoft.AppComplianceAutomation/reports/{reportName}/evidences/{evidenceName}` | `AppComplianceReportEvidence` | `EvidenceResource` |
| `/providers/Microsoft.AppComplianceAutomation/reports/{reportName}/scopingConfigurations/{scopingConfigurationName}` | `AppComplianceReportScopingConfiguration` | `ScopingConfigurationResource` |
| `/providers/Microsoft.AppComplianceAutomation/reports/{reportName}/snapshots/{snapshotName}` | `AppComplianceReportSnapshot` | `SnapshotResource` |
| `/providers/Microsoft.AppComplianceAutomation/reports/{reportName}/webhooks/{webhookName}` | `AppComplianceReportWebhook` | `WebhookResource` |
