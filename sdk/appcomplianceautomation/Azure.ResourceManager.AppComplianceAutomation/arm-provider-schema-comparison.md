...
| --- | --- | --- |
| `/providers/microsoft.appcomplianceautomation/reports/{}` | `AppComplianceReport` | `ReportResource` |
| `/providers/microsoft.appcomplianceautomation/reports/{}/evidences/{}` | `AppComplianceReportEvidence` | `EvidenceResource` |
| `/providers/microsoft.appcomplianceautomation/reports/{}/scopingconfigurations/{}` | `AppComplianceReportScopingConfiguration` | `ScopingConfigurationResource` |
| `/providers/microsoft.appcomplianceautomation/reports/{}/snapshots/{}` | `AppComplianceReportSnapshot` | `SnapshotResource` |
| `/providers/microsoft.appcomplianceautomation/reports/{}/webhooks/{}` | `AppComplianceReportWebhook` | `WebhookResource` |
