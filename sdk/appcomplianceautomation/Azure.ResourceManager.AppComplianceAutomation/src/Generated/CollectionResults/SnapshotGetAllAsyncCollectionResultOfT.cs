...
{
    internal partial class SnapshotGetAllAsyncCollectionResultOfT : AsyncPageable<AppComplianceReportSnapshotData>
    {
        ...
        public SnapshotGetAllAsyncCollectionResultOfT(Snapshot client, string reportName, string skipToken, int? top, string @select, string filter, string @orderby, string offerGuid, string reportCreatorTenantId, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <returns> The pages of SnapshotGetAllAsyncCollectionResultOfT as an enumerable collection. </returns>
        public override async IAsyncEnumerable<Page<AppComplianceReportSnapshotData>> AsPages(string continuationToken, int? pageSizeHint)
        {
