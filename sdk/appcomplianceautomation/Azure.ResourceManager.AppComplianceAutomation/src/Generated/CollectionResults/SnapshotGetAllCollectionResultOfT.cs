...
namespace Azure.ResourceManager.AppComplianceAutomation
{
    internal partial class SnapshotGetAllCollectionResultOfT : Pageable<AppComplianceReportSnapshotData>
    {
        ...
        public SnapshotGetAllCollectionResultOfT(Snapshot client, string reportName, string skipToken, int? maxCount, string @select, string filter, string @orderby, string offerGuid, string reportCreatorTenantId, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
