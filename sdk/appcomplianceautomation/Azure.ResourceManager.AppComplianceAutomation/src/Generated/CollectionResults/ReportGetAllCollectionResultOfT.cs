...
{
    internal partial class ReportGetAllCollectionResultOfT : Pageable<AppComplianceReportData>
    {
        ...
        public ReportGetAllCollectionResultOfT(Report client, string skipToken, int? top, string @select, string filter, string @orderby, string offerGuid, string reportCreatorTenantId, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <returns> The pages of ReportGetAllCollectionResultOfT as an enumerable collection. </returns>
        public override IEnumerable<Page<AppComplianceReportData>> AsPages(string continuationToken, int? pageSizeHint)
        {
