    ...
    internal partial class ReportGetAllCollectionResultOfT : Pageable<AppComplianceReportData>
    {
        ...
        public override IEnumerable<Page<AppComplianceReportData>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                yield return Page<AppComplianceReportData>.FromValues((IReadOnlyList<AppComplianceReportData>)result.Value, nextPage?.IsAbsoluteUri == true ? nextPage.AbsoluteUri : nextPage?.OriginalString, response);
