...
{
    internal partial class EvidenceGetByReportCollectionResultOfT : Pageable<AppComplianceReportEvidenceData>
    {
        ...
        /// <returns> The pages of EvidenceGetByReportCollectionResultOfT as an enumerable collection. </returns>
        public override IEnumerable<Page<AppComplianceReportEvidenceData>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                yield return Page<AppComplianceReportEvidenceData>.FromValues((IReadOnlyList<AppComplianceReportEvidenceData>)result.Value, nextPage?.AbsoluteUri, response);
