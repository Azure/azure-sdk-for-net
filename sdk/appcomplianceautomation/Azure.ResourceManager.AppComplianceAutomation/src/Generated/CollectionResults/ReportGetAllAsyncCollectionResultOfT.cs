...
namespace Azure.ResourceManager.AppComplianceAutomation
{
    internal partial class ReportGetAllAsyncCollectionResultOfT : AsyncPageable<AppComplianceReportData>
    {
        ...
        public ReportGetAllAsyncCollectionResultOfT(Report client, string skipToken, int? maxCount, string @select, string filter, string @orderby, string offerGuid, string reportCreatorTenantId, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
