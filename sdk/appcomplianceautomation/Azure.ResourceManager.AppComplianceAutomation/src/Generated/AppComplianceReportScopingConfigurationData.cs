...
namespace Azure.ResourceManager.AppComplianceAutomation
{
    ...
    public partial class AppComplianceReportScopingConfigurationData : ResourceData
    {
        ...
        internal AppComplianceReportScopingConfigurationData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, AppComplianceReportScopingConfigurationProperties properties, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, name, resourceType, systemData)
        {
            Properties = properties;
