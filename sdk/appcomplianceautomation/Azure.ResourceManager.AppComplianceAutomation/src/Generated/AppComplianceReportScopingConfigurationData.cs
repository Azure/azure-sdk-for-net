...
namespace Azure.ResourceManager.AppComplianceAutomation
{
    ...
    public partial class AppComplianceReportScopingConfigurationData : ResourceData
    {
        ...
        /// <param name="properties"> ScopingConfiguration property. </param>
        internal AppComplianceReportScopingConfigurationData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, AppComplianceReportScopingConfigurationProperties properties) : base(id, name, resourceType, systemData)
        {
