...
namespace Azure.ResourceManager.AppComplianceAutomation
{
    internal partial class AppComplianceAutomationArmOperation<T> : ArmOperation<T>
    {
        ...
        internal AppComplianceAutomationArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
