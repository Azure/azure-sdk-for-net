...
{
    /// <summary></summary>
    internal partial class AppComplianceReportResourceOperationSource : IOperationSource<AppComplianceReportResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal AppComplianceReportResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
        ...
        AppComplianceReportResource IOperationSource<AppComplianceReportResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            AppComplianceReportData data = AppComplianceReportData.DeserializeAppComplianceReportData(document.RootElement, ModelSerializationExtensions.WireOptions);
