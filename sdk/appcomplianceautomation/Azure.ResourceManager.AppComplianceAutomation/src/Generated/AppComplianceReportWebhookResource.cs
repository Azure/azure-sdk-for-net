...
{
    /// <summary>
    /// A class representing a AppComplianceReportWebhook along with the instance operations that can be performed on it.
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="AppComplianceReportWebhookResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="AppComplianceReportResource"/> using the GetAppComplianceReportWebhooks method.
    /// </summary>
    public partial class AppComplianceReportWebhookResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of AppComplianceReportWebhookResource for mocking. </summary>
        protected AppComplianceReportWebhookResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="AppComplianceReportWebhookResource"/> class. </summary>
        ...
        {
            TryGetApiVersion(ResourceType, out string appComplianceReportWebhookApiVersion);
            _webhookClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.AppComplianceAutomation", ResourceType.Namespace, Diagnostics);
        ...
        {
            string resourceId = $"/providers/Microsoft.AppComplianceAutomation/reports/{reportName}/webhooks/{webhookName}";
        ...
        {
            using DiagnosticScope scope = _webhookClientDiagnostics.CreateScope("AppComplianceReportWebhookResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _webhookRestClient.CreateGetRequest(Id.Parent.Name, Id.Name, context);
        ...
        public virtual async Task<Response<AppComplianceReportWebhookResource>> UpdateAsync(AppComplianceReportWebhookPatch patch, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _webhookClientDiagnostics.CreateScope("AppComplianceReportWebhookResource.Update");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _webhookRestClient.CreateUpdateRequest(Id.Parent.Name, Id.Name, AppComplianceReportWebhookPatch.ToRequestContent(patch), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<AppComplianceReportWebhookData> response = Response.FromValue(AppComplianceReportWebhookData.FromResponse(result), result);
                if (response.Value == null)
                {
        ...
        {
            using DiagnosticScope scope = _webhookClientDiagnostics.CreateScope("AppComplianceReportWebhookResource.Delete");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _webhookRestClient.CreateDeleteRequest(Id.Parent.Name, Id.Name, context);
        ...
        /// <summary>
        /// Updates the AppComplianceReportWebhook.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /providers/Microsoft.AppComplianceAutomation/reports/{reportName}/webhooks/{webhookName}. </description>
        ...
        public virtual async Task<ArmOperation<AppComplianceReportWebhookResource>> UpdateAsync(WaitUntil waitUntil, AppComplianceReportWebhookData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _webhookRestClient.CreateCreateOrUpdateRequest(Id.Parent.Name, Id.Name, AppComplianceReportWebhookData.ToRequestContent(data), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<AppComplianceReportWebhookData> response = Response.FromValue(AppComplianceReportWebhookData.FromResponse(result), result);
                RequestUriBuilder uri = message.Request.Uri;
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<AppComplianceReportWebhookResource> Update(WaitUntil waitUntil, AppComplianceReportWebhookData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
