...
namespace Azure.ResourceManager.AppComplianceAutomation
{
    ...
    public partial class AppComplianceReportSnapshotData : ResourceData
    {
        ...
        internal AppComplianceReportSnapshotData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, AppComplianceReportSnapshotProperties properties) : base(id, name, resourceType, systemData)
        {
