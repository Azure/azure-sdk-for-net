...
namespace Azure.ResourceManager.AppComplianceAutomation
{
    ...
    public partial class AppComplianceReportSnapshotData : ResourceData
    {
        ...
        internal AppComplianceReportSnapshotData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, AppComplianceReportSnapshotProperties properties, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, name, resourceType, systemData)
        {
