...
namespace Azure.ResourceManager.AppComplianceAutomation
{
    ...
    public partial class AppComplianceReportSnapshotData : ResourceData
    {
        ...
        internal AppComplianceReportSnapshotData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string snapshotName, DateTimeOffset? createdOn, AppComplianceProvisioningState? provisioningState, AppComplianceReportProperties reportProperties, SystemData reportSystemData, IReadOnlyList<AppComplianceResult> complianceResults, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
