...
namespace Azure.ResourceManager.AppComplianceAutomation
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SnapshotResourceData>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        void IJsonModel<SnapshotResourceData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SnapshotResourceData)} does not support writing '{format}' format.");
            }
        ...
        SnapshotResourceData IJsonModel<SnapshotResourceData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SnapshotResourceData)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<SnapshotResourceData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SnapshotResourceData)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        SnapshotResourceData IPersistableModel<SnapshotResourceData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SnapshotResourceData)} does not support reading '{options.Format}' format.");
            }
        }
