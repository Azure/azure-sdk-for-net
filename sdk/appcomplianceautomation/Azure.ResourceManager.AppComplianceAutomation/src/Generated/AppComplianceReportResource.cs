...
namespace Azure.ResourceManager.AppComplianceAutomation
{
    ...
    public partial class AppComplianceReportResource : ArmResource
    {
        ...
        /// <summary>
        /// Updates the AppComplianceReport.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /providers/Microsoft.AppComplianceAutomation/reports/{reportName}. </description>
        ...
        public virtual async Task<ArmOperation<AppComplianceReportResource>> UpdateAsync(WaitUntil waitUntil, AppComplianceReportData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _reportRestClient.CreateCreateOrUpdateRequest(Id.Name, AppComplianceReportData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                AppComplianceAutomationArmOperation<AppComplianceReportResource> operation = new AppComplianceAutomationArmOperation<AppComplianceReportResource>(
                    new AppComplianceReportResourceOperationSource(Client),
                    _reportClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<AppComplianceReportResource> Update(WaitUntil waitUntil, AppComplianceReportData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
