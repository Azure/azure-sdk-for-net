...
namespace Azure.ResourceManager.AppComplianceAutomation
{
    internal partial class ProviderActionsRestOperations
    {
        ...
        internal HttpMessage CreateGetCollectionCountRequest(ReportCollectionGetCountContent content)
        {
            ...
            request.Headers.Add("Content-Type", "application/json");
            var content0 = new Utf8JsonRequestContent();
            ((IJsonModel<ReportCollectionGetCountContent>)content).Write(content0.JsonWriter, ModelSerializationExtensions.WireOptions);
            request.Content = content0;
            _userAgent.Apply(message);
            return message;
        }
        ...
        internal HttpMessage CreateGetOverviewStatusRequest(AppComplianceGetOverviewStatusContent content)
        {
            ...
            request.Headers.Add("Content-Type", "application/json");
            var content0 = new Utf8JsonRequestContent();
            ((IJsonModel<AppComplianceGetOverviewStatusContent>)content).Write(content0.JsonWriter, ModelSerializationExtensions.WireOptions);
            request.Content = content0;
            _userAgent.Apply(message);
            return message;
        }
        ...
        internal HttpMessage CreateListInUseStorageAccountsRequest(ReportListInUseStorageAccountsContent content)
        {
            ...
            request.Headers.Add("Content-Type", "application/json");
            var content0 = new Utf8JsonRequestContent();
            ((IJsonModel<ReportListInUseStorageAccountsContent>)content).Write(content0.JsonWriter, ModelSerializationExtensions.WireOptions);
            request.Content = content0;
            _userAgent.Apply(message);
            return message;
        }
        ...
        internal HttpMessage CreateOnboardRequest(AppComplianceOnboardContent content)
        {
            ...
            request.Headers.Add("Content-Type", "application/json");
            var content0 = new Utf8JsonRequestContent();
            ((IJsonModel<AppComplianceOnboardContent>)content).Write(content0.JsonWriter, ModelSerializationExtensions.WireOptions);
            request.Content = content0;
            _userAgent.Apply(message);
            return message;
        }
        ...
        internal HttpMessage CreateTriggerEvaluationRequest(TriggerEvaluationContent content)
        {
            ...
            request.Headers.Add("Content-Type", "application/json");
            var content0 = new Utf8JsonRequestContent();
            ((IJsonModel<TriggerEvaluationContent>)content).Write(content0.JsonWriter, ModelSerializationExtensions.WireOptions);
            request.Content = content0;
            _userAgent.Apply(message);
            return message;
        }
