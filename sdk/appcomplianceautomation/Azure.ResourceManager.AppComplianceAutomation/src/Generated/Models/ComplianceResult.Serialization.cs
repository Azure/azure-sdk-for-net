...
namespace Azure.ResourceManager.AppComplianceAutomation.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ComplianceResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ComplianceResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ComplianceResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ComplianceResult>)} interface");
            }
        ...
        string IPersistableModel<ComplianceResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
