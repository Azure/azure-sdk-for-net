...
namespace Azure.ResourceManager.AppComplianceAutomation.Models
{
    ...
    public partial class RecommendationSolution : IJsonModel<RecommendationSolution>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<RecommendationSolution>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        RecommendationSolution IJsonModel<RecommendationSolution>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual RecommendationSolution JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<RecommendationSolution>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static RecommendationSolution DeserializeRecommendationSolution(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            {
                if (prop.NameEquals("recommendationSolutionIndex"u8))
                {
                    recommendationSolutionIndex = prop.Value.GetString();
                    continue;
                }
                if (prop.NameEquals("recommendationSolutionContent"u8))
                {
                    recommendationSolutionContent = prop.Value.GetString();
                    continue;
                }
                if (prop.NameEquals("isRecommendSolution"u8))
                {
                    if (prop.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
                    }
                    isRecommendSolution = new IsRecommendSolution(prop.Value.GetString());
                    continue;
                }
                if (options.Format != "W")
                {
            ...
            return new RecommendationSolution(recommendationSolutionIndex, recommendationSolutionContent, isRecommendSolution, additionalBinaryDataProperties);
        }

        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<RecommendationSolution>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        RecommendationSolution IPersistableModel<RecommendationSolution>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual RecommendationSolution PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<RecommendationSolution>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
