...
namespace Azure.ResourceManager.AppComplianceAutomation.Models
{
    ...
    public partial class Assessment
    {
        ...
        internal Assessment(string name, AssessmentSeverity? severity, string description, string remediation, IsPass? isPass, string policyId, IReadOnlyList<AssessmentResource> resourceList, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Severity = severity;
