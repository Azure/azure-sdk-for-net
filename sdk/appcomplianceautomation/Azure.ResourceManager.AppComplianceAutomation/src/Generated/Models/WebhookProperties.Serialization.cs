...
{
    public partial class WebhookProperties : IUtf8JsonSerializable, IJsonModel<WebhookProperties>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<WebhookProperties>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<WebhookProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<WebhookProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        WebhookProperties IJsonModel<WebhookProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<WebhookProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static WebhookProperties DeserializeWebhookProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("deliveryStatus"u8))
                {
                    ...
                    deliveryStatus = new DeliveryStatus(property.Value.GetString());
                    continue;
                }
        ...
        BinaryData IPersistableModel<WebhookProperties>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<WebhookProperties>)this).GetFormatFromOptions(options) : options.Format;
        ...
        WebhookProperties IPersistableModel<WebhookProperties>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<WebhookProperties>)this).GetFormatFromOptions(options) : options.Format;
