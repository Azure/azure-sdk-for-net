...
namespace Azure.ResourceManager.AppComplianceAutomation.Models
{
    ...
    public partial class SnapshotProperties
    {
        ...
        internal SnapshotProperties(string id, string snapshotName, DateTimeOffset? createdOn, ProvisioningState? provisioningState, ReportProperties reportProperties, SystemData reportSystemData, IReadOnlyList<ComplianceResult> complianceResults, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
