...
namespace Azure.ResourceManager.AppComplianceAutomation.Models
{
    ...
    public partial class ResourceMetadata
    {
        ...
        internal ResourceMetadata(string resourceId, string resourceType, string resourceKind, string resourceName, IDictionary<string, string> tags, Dictionary<string, BinaryData> rawData)
        {
            ResourceId = resourceId;
