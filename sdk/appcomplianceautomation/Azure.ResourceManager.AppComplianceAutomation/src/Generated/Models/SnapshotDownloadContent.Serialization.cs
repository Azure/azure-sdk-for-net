...
namespace Azure.ResourceManager.AppComplianceAutomation.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SnapshotDownloadContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SnapshotDownloadContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SnapshotDownloadContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SnapshotDownloadContent>)} interface");
            }
        ...
        string IPersistableModel<SnapshotDownloadContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
