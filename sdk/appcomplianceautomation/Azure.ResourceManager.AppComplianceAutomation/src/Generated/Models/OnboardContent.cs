...
namespace Azure.ResourceManager.AppComplianceAutomation.Models
{
    ...
    public partial class OnboardContent
    {
        ...
        /// <summary> Initializes a new instance of <see cref="OnboardContent"/>. </summary>
        ...
        internal OnboardContent(IList<string> subscriptionIds, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            SubscriptionIds = subscriptionIds;
            _serializedAdditionalRawData = serializedAdditionalRawData;
        }

        /// <summary> Initializes a new instance of <see cref="OnboardContent"/> for deserialization. </summary>
        internal OnboardContent()
        {
        }
