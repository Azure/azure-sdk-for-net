...
namespace Azure.ResourceManager.AppComplianceAutomation
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ReportResourceData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ReportResourceData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ReportResourceData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ReportResourceData>)} interface");
            }
        ...
        string IPersistableModel<ReportResourceData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
