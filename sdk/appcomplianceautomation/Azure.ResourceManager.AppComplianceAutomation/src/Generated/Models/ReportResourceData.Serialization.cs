...
{
    public partial class ReportResourceData : IUtf8JsonSerializable, IJsonModel<ReportResourceData>, IPersistableModel<ReportResourceData>
    {
        ...
        void IJsonModel<ReportResourceData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ReportResourceData)} does not support '{format}' format.");
            }
