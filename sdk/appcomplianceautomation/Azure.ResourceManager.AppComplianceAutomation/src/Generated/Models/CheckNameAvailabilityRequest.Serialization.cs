...
namespace Azure.ResourceManager.AppComplianceAutomation.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CheckNameAvailabilityRequest>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        internal static CheckNameAvailabilityRequest DeserializeCheckNameAvailabilityRequest(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new CheckNameAvailabilityRequest(name, type, serializedAdditionalRawData);
        }
