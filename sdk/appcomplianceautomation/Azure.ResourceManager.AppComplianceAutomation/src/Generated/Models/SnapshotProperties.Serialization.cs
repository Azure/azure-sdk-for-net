...
{
    public partial class SnapshotProperties : IUtf8JsonSerializable, IJsonModel<SnapshotProperties>, IPersistableModel<SnapshotProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SnapshotName))
            {
                ...
                builder.AppendLine($" '{SnapshotName}'");
            }
            ...
            {
                builder.Append("  reportProperties:");
                AppendChildObject(builder, ReportProperties, options, 2);
            }

            if (Optional.IsDefined(ReportSystemData))
            {
                builder.Append("  reportSystemData:");
                AppendChildObject(builder, ReportSystemData, options, 2);
            }

            if (Optional.IsCollectionDefined(ComplianceResults))
            {
                builder.Append("  complianceResults:");
                builder.AppendLine(" [");
                foreach (var item in ComplianceResults)
                {
