...
namespace Azure.ResourceManager.AppComplianceAutomation.Models
{
    ...
    public partial class Control
    {
        ...
        internal Control(string controlId, string controlShortName, string controlFullName, ControlType? controlType, string controlDescription, string controlDescriptionHyperLink, ControlStatus? controlStatus, IReadOnlyList<Assessment> assessments, Dictionary<string, BinaryData> rawData)
        {
            ControlId = controlId;
