...
namespace Azure.ResourceManager.AppComplianceAutomation.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ReportComplianceStatus>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ReportComplianceStatus>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ReportComplianceStatus>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<ReportComplianceStatus>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
