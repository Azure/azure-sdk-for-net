...
namespace Azure.ResourceManager.AppComplianceAutomation
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SnapshotResourceData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SnapshotResourceData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SnapshotResourceData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SnapshotResourceData>)} interface");
            }
        ...
        string IPersistableModel<SnapshotResourceData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
