...
namespace Azure.ResourceManager.AppComplianceAutomation.Models
{
    ...
    public partial class ResourceItem
    {
        ...
        internal ResourceItem(string subscriptionId, string resourceGroup, string resourceType, string resourceId, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
