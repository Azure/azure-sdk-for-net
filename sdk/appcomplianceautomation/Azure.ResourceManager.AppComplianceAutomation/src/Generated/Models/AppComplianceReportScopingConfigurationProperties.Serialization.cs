    ...
    public partial class AppComplianceReportScopingConfigurationProperties : IJsonModel<AppComplianceReportScopingConfigurationProperties>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(Answers))
            {
                ...
                foreach (ScopingAnswer item in Answers)
                {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        AppComplianceReportScopingConfigurationProperties IJsonModel<AppComplianceReportScopingConfigurationProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual AppComplianceReportScopingConfigurationProperties JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<AppComplianceReportScopingConfigurationProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static AppComplianceReportScopingConfigurationProperties DeserializeAppComplianceReportScopingConfigurationProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new AppComplianceReportScopingConfigurationProperties(answers ?? new ChangeTrackingList<ScopingAnswer>(), provisioningState, additionalBinaryDataProperties);
        }

        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<AppComplianceReportScopingConfigurationProperties>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
