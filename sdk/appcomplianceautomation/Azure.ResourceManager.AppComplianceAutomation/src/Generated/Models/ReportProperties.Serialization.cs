...
namespace Azure.ResourceManager.AppComplianceAutomation.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ReportProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ReportProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ReportProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ReportProperties>)} interface");
            }
        ...
        string IPersistableModel<ReportProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
