...
namespace Azure.ResourceManager.AppComplianceAutomation.Mocking
{
    ...
    internal partial class AppComplianceAutomationArmClientMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="AppComplianceAutomationArmClientMockingExtension"/> class for mocking. </summary>
        protected AppComplianceAutomationArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="AppComplianceAutomationArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal AppComplianceAutomationArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal AppComplianceAutomationArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
