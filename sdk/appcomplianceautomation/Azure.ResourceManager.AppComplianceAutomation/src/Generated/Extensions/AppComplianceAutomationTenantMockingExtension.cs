...
namespace Azure.ResourceManager.AppComplianceAutomation.Mocking
{
    ...
    internal partial class AppComplianceAutomationTenantMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="AppComplianceAutomationTenantMockingExtension"/> class for mocking. </summary>
        protected AppComplianceAutomationTenantMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="AppComplianceAutomationTenantMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal AppComplianceAutomationTenantMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
