...
namespace Azure.ResourceManager.AppComplianceAutomation.Models
{
    ...
    public static partial class ArmAppComplianceAutomationModelFactory
    {
        ...
        {
            return new ReportResourceData(id, name, resourceType, systemData, properties, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new OverviewStatus(passedCount, failedCount, manualCount, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SnapshotResourceData(id, name, resourceType, systemData, properties, new Dictionary<string, BinaryData>());
        }
        ...
        public static SnapshotProperties SnapshotProperties(string id = null, string snapshotName = null, DateTimeOffset? createdOn = null, ProvisioningState? provisioningState = null, ReportProperties reportProperties = null, SystemData reportSystemData = null, IEnumerable<ComplianceResult> complianceResults = null)
        {
            ...
            return new SnapshotProperties(id, snapshotName, createdOn, provisioningState, reportProperties, reportSystemData, complianceResults?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static ComplianceResult ComplianceResult(string complianceName = null, IEnumerable<Category> categories = null)
        {
            ...
            return new ComplianceResult(complianceName, categories?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static Category Category(string categoryName = null, CategoryType? categoryType = null, CategoryStatus? categoryStatus = null, IEnumerable<ControlFamily> controlFamilies = null)
        {
            ...
            return new Category(categoryName, categoryType, categoryStatus, controlFamilies?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static ControlFamily ControlFamily(string familyName = null, ControlFamilyType? familyType = null, ControlFamilyStatus? familyStatus = null, IEnumerable<Control> controls = null)
        {
            ...
            return new ControlFamily(familyName, familyType, familyStatus, controls?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static Control Control(string controlId = null, string controlShortName = null, string controlFullName = null, ControlType? controlType = null, string controlDescription = null, string controlDescriptionHyperLink = null, ControlStatus? controlStatus = null, IEnumerable<Assessment> assessments = null)
        {
            ...
            return new Control(controlId, controlShortName, controlFullName, controlType, controlDescription, controlDescriptionHyperLink, controlStatus, assessments?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static Assessment Assessment(string name = null, AssessmentSeverity? severity = null, string description = null, string remediation = null, IsPass? isPass = null, string policyId = null, IEnumerable<AssessmentResourceContent> resourceList = null)
        {
            ...
            return new Assessment(name, severity, description, remediation, isPass, policyId, resourceList?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AssessmentResourceContent(resourceId, resourceStatus, reason, statusChangeDate, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SnapshotDownloadContent(reportCreatorTenantId, downloadType, offerGuid, new Dictionary<string, BinaryData>());
        }
        ...
        public static DownloadResponse DownloadResponse(IEnumerable<ResourceItem> resourceList = null, IEnumerable<ComplianceReportItem> complianceReport = null, Uri compliancePdfReportSasUri = null, Uri complianceDetailedPdfReportSasUri = null)
        {
            ...
            return new DownloadResponse(resourceList?.ToList(), complianceReport?.ToList(), compliancePdfReportSasUri != null ? new DownloadResponseCompliancePdfReport(compliancePdfReportSasUri, new Dictionary<string, BinaryData>()) : null, complianceDetailedPdfReportSasUri != null ? new DownloadResponseComplianceDetailedPdfReport(complianceDetailedPdfReportSasUri, new Dictionary<string, BinaryData>()) : null, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ResourceItem(subscriptionId, resourceGroup, resourceType, resourceId, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ComplianceReportItem(categoryName, controlId, controlName, controlType, complianceState, policyId, policyDisplayName, policyDescription, subscriptionId, resourceGroup, resourceType, resourceId, statusChangeDate, new Dictionary<string, BinaryData>());
        }
    }
}
