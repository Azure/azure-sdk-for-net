...
namespace Azure.ResourceManager.AppComplianceAutomation.Samples
{
    public partial class Sample_AppComplianceReportScopingConfigurationResource
    {
        ...
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task Update_ScopingConfigurationCreateOrUpdate()
        {
            // Generated from example definition: specification/appcomplianceautomation/resource-manager/Microsoft.AppComplianceAutomation/stable/2024-06-27/examples/ScopingConfiguration_CreateOrUpdate.json
            // this example is just showing the usage of "ScopingConfiguration_CreateOrUpdate" operation, for the dependent resources, they will have to be created separately.
            ...
            ArmOperation<AppComplianceReportScopingConfigurationResource> lro = await appComplianceReportScopingConfiguration.UpdateAsync(WaitUntil.Completed, data);
            AppComplianceReportScopingConfigurationResource result = lro.Value;
