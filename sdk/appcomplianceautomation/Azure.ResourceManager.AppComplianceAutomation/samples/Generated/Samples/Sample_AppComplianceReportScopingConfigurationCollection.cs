...
namespace Azure.ResourceManager.AppComplianceAutomation.Samples
{
    public partial class Sample_AppComplianceReportScopingConfigurationCollection
    {
        ...
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task CreateOrUpdate_ScopingConfigurationCreateOrUpdate()
        {
            ...
            ArmOperation<AppComplianceReportScopingConfigurationResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, scopingConfigurationName, data);
