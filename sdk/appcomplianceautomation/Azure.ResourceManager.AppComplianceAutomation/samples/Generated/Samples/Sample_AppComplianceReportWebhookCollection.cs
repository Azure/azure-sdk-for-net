...
namespace Azure.ResourceManager.AppComplianceAutomation.Samples
{
    public partial class Sample_AppComplianceReportWebhookCollection
    {
        ...
        {
            // Generated from example definition: specification/appcomplianceautomation/resource-manager/Microsoft.AppComplianceAutomation/stable/2024-06-27/examples/Webhook_CreateOrUpdate.json
            ...
            // invoke the operation
            string webhookName = "testWebhookName";
            AppComplianceReportWebhookData data = new AppComplianceReportWebhookData();
            ArmOperation<AppComplianceReportWebhookResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, webhookName, data);
            AppComplianceReportWebhookResource result = lro.Value;
