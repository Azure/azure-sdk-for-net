...
namespace Microsoft.Azure.Management.ServiceFabricManagedClusters
{
    ...
    public static partial class ManagedClustersOperationsExtensions
    {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<ManagedCluster> UpdateAsync(this IManagedClustersOperations operations, string resourceGroupName, string clusterName, IDictionary<string, string> tags = default(IDictionary<string, string>), CancellationToken cancellationToken = default(CancellationToken))
            {
