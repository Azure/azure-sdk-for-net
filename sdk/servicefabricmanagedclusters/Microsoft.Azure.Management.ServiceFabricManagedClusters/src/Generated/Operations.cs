...
namespace Microsoft.Azure.Management.ServiceFabricManagedClusters
{
    ...
    /// </summary>
    internal partial class Operations : IServiceOperations<ServiceFabricManagedClustersManagementClient>, IOperations
    {
        /// <summary>
        ...
        /// </return>
        public async Task<AzureOperationResponse<IPage<OperationResult>>> ListWithHttpMessagesAsync(string apiVersion, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (apiVersion == null)
            {
