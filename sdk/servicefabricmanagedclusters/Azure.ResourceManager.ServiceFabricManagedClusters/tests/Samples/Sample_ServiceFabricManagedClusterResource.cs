...
["a"] = "b"
        ...
        public async Task GetManagedAzResiliencyStatus_AzResiliencyStatusOfBaseResources()
        {
            ...
            // invoke the operation
            var result = await serviceFabricManagedCluster.GetManagedAzResiliencyStatusAsync();
        ...
        public async Task GetManagedMaintenanceWindowStatu_GetMaintenanceWindowStatus()
        {
            ...
            // invoke the operation
            var result = await serviceFabricManagedCluster.GetManagedMaintenanceWindowStatusAsync();
