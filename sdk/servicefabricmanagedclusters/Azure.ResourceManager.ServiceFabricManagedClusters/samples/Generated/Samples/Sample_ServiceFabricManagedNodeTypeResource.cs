...
namespace Azure.ResourceManager.ServiceFabricManagedClusters.Samples
{
    public partial class Sample_ServiceFabricManagedNodeTypeResource
    {
        ...
        public async Task Delete_DeleteANodeType()
        {
            ...
            // invoke the operation
            await serviceFabricManagedNodeType.DeleteAsync(WaitUntil.Completed).ConfigureAwait(false);
...
["a"] = "b"
        ...
        public async Task Restart_RestartNodes()
        {
            ...
            await serviceFabricManagedNodeType.RestartAsync(WaitUntil.Completed, content).ConfigureAwait(false);
        ...
        public async Task Reimage_ReimageAllNodesByUpgradeDomain()
        {
            ...
            await serviceFabricManagedNodeType.ReimageAsync(WaitUntil.Completed, content).ConfigureAwait(false);
        ...
        public async Task DeleteNode_DeleteNodes()
        {
            ...
            await serviceFabricManagedNodeType.DeleteNodeAsync(WaitUntil.Completed, content).ConfigureAwait(false);
