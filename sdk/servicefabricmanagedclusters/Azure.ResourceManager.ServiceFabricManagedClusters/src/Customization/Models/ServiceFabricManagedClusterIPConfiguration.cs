...
namespace Azure.ResourceManager.ServiceFabricManagedClusters.Models
{
    ...
    ///
    [Obsolete("This class is now deprecated. Please use the new class `IPConfiguration` moving forward.")]
    ...
    public partial class ServiceFabricManagedClusterIPConfiguration
    {
        ...
        internal IPConfiguration ToIPConfiguration()
        {
            PrivateIPAddressVersion privateIPAddressVersion = new PrivateIPAddressVersion(PrivateIPAddressVersion.ToString());
            ...
            IPConfiguration config = new IPConfiguration(
                ...
                PublicIPAddressConfiguration.ToIPConfigurationPublicIPAddressConfiguration(),
                null
                );
