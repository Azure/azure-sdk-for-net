...
namespace Azure.ResourceManager.ServiceFabricManagedClusters.Models
{
    ...
    ///
    [Obsolete("This class is now deprecated. Please use the new class `ServiceFabricManagedClusterPublicIPAddressConfiguration` moving forward.")]
    ...
    public partial class ServiceFabricManagedClusterPublicIPAddressConfiguration
    {
        ...
        internal IPConfigurationPublicIPAddressConfiguration ToIPConfigurationPublicIPAddressConfiguration()
        {
            PublicIPAddressVersion  publicIPAddressVersion = new PublicIPAddressVersion(PublicIPAddressVersion.ToString());
            IPConfigurationPublicIPAddressConfiguration iPConfigurationPublicIPAddressConfiguration = new IPConfigurationPublicIPAddressConfiguration(
                Name,
                IPTags,
