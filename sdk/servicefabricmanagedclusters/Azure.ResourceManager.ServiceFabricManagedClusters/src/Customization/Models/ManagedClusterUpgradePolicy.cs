...
namespace Azure.ResourceManager.ServiceFabricManagedClusters.Models
{
    ...
    [CodeGenModel("ClusterUpgradePolicy")]
    public partial class ManagedClusterUpgradePolicy
    {
        ...
        internal ClusterUpgradePolicy ToClusterUpgradePolicy()
        {
            ClusterUpgradePolicy upgradePolicy = new ClusterUpgradePolicy(
                ForceRestart,
                HealthPolicy.ToClusterHealthPolicy(),
                DeltaHealthPolicy.ToClusterUpgradeDeltaHealthPolicy(),
                MonitoringPolicy.ToClusterMonitoringPolicy(),
