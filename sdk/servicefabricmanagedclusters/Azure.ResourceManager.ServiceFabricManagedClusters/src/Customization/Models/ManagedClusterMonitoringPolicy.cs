...
namespace Azure.ResourceManager.ServiceFabricManagedClusters.Models
{
    ...
    ///
    [CodeGenModel("ClusterMonitoringPolicy")]
    public partial class ManagedClusterMonitoringPolicy
    {
        ...
        internal ClusterMonitoringPolicy ToClusterMonitoringPolicy()
        {
            ClusterMonitoringPolicy monitoringPolicy = new ClusterMonitoringPolicy(
