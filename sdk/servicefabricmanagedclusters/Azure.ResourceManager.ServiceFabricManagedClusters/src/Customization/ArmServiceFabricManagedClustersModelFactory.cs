    ...
    public static partial class ArmServiceFabricManagedClustersModelFactory
    {
            ...
            ServiceFabricManagedClustersSkuName skuName = default)
        {
            ...
            return new ServiceFabricManagedClusterData(
                ...
                tags: tags,
                location: location,
                properties: dnsName is null && fqdn is null && iPv4Address is null && clusterId is null && clusterState is null && clusterCertificateThumbprints is null && clientConnectionPort is null && httpGatewayConnectionPort is null && adminUserName is null && adminPassword is null && loadBalancingRules is null && isRdpAccessAllowed is null && networkSecurityRules is null && clients is null && azureActiveDirectory is null && fabricSettings is null && provisioningState is null && clusterCodeVersion is null && clusterUpgradeMode is null && clusterUpgradeCadence is null && addOnFeatures is null && isAutoOSUpgradeEnabled is null && hasZoneResiliency is null && isIPv6Enabled is null && subnetId is null && ipTags is null && iPv6Address is null && isServicePublicIPEnabled is null && auxiliarySubnets is null && serviceEndpoints is null && zonalUpdateMode is null && useCustomVnet is null && publicIPPrefixId is null && publicIPv6PrefixId is null && ddosProtectionPlanId is null && upgradeDescription is null && httpGatewayTokenAuthConnectionPort is null && isHttpGatewayExclusiveAuthModeEnabled is null && autoGeneratedDomainNameLabelScope is null && allocatedOutboundPorts is null && vmImage is null && enableOutboundOnlyNodeTypes is null && skipManagedNsgAssignment is null && maxUnusedVersionsToKeep is null ? default : new ManagedClusterProperties(
                    dnsName,
                    fqdn,
                    iPv4Address,
                    clusterId,
                    ...
                    null),
                eTag: etag,
                sku: new ServiceFabricManagedClustersSku(skuName, null),
