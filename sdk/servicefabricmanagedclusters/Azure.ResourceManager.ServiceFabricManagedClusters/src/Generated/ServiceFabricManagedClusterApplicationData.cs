...
{
    /// <summary> A class representing the ServiceFabricManagedClusterApplication data model. </summary>
    public partial class ServiceFabricManagedClusterApplicationData : TrackedResourceData
    {
        /// <summary> Initializes a new instance of ServiceFabricManagedClusterApplicationData. </summary>
        /// <param name="location"> The location. </param>
        public ServiceFabricManagedClusterApplicationData(AzureLocation location) : base(location)
        {
