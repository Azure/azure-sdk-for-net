...
namespace Azure.ResourceManager.ServiceFabricManagedClusters.Models
{
    public partial class ApplicationHealthPolicy : IUtf8JsonSerializable
    {
        ...
        internal static ApplicationHealthPolicy DeserializeApplicationHealthPolicy(JsonElement element)
        {
            ...
            return new ApplicationHealthPolicy(considerWarningAsError, maxPercentUnhealthyDeployedApplications, defaultServiceTypeHealthPolicy, serviceTypeHealthPolicyMap ?? new ChangeTrackingDictionary<string, ServiceTypeHealthPolicy>());
        }
    }
}
