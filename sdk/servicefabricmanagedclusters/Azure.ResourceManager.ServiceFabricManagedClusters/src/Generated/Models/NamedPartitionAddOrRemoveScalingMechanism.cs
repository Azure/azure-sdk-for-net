...
namespace Azure.ResourceManager.ServiceFabricManagedClusters.Models
{
    ...
    public partial class NamedPartitionAddOrRemoveScalingMechanism : ManagedServiceScalingMechanism
    {
        ...
        public NamedPartitionAddOrRemoveScalingMechanism(int minPartitionCount, int maxPartitionCount, int scaleIncrement) : base(ServiceScalingMechanismKind.AddRemoveIncrementalNamedPartition)
        {
        ...
        /// <param name="maxPartitionCount"> Maximum number of named partitions of the service. </param>
        /// <param name="scaleIncrement"> The number of instances to add or remove during a scaling operation. </param>
        internal NamedPartitionAddOrRemoveScalingMechanism(ServiceScalingMechanismKind kind, IDictionary<string, BinaryData> additionalBinaryDataProperties, int minPartitionCount, int maxPartitionCount, int scaleIncrement) : base(kind, additionalBinaryDataProperties)
        {
            MinPartitionCount = minPartitionCount;
            MaxPartitionCount = maxPartitionCount;
            ScaleIncrement = scaleIncrement;
