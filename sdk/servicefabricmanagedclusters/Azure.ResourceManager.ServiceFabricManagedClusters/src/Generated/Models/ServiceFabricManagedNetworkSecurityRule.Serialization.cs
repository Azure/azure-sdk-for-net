...
namespace Azure.ResourceManager.ServiceFabricManagedClusters.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ServiceFabricManagedNetworkSecurityRule>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ServiceFabricManagedNetworkSecurityRule>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ServiceFabricManagedNetworkSecurityRule>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ServiceFabricManagedNetworkSecurityRule>)} interface");
            }
        ...
        string IPersistableModel<ServiceFabricManagedNetworkSecurityRule>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
