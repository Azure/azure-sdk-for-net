...
namespace Azure.ResourceManager.ServiceFabricManagedClusters.Models
{
    ...
    public partial class PartitionInstanceCountScalingMechanism : ManagedServiceScalingMechanism
    {
        ...
        internal PartitionInstanceCountScalingMechanism(ServiceScalingMechanismKind kind, int minInstanceCount, int maxInstanceCount, int scaleIncrement, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(kind, serializedAdditionalRawData)
        {
            MinInstanceCount = minInstanceCount;
            MaxInstanceCount = maxInstanceCount;
            ScaleIncrement = scaleIncrement;
