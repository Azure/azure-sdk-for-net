...
namespace Azure.ResourceManager.ServiceFabricManagedClusters.Models
{
    public partial class ClusterUpgradeDeltaHealthPolicy : IUtf8JsonSerializable
    {
        ...
        internal static ClusterUpgradeDeltaHealthPolicy DeserializeClusterUpgradeDeltaHealthPolicy(JsonElement element)
        {
            ...
            return new ClusterUpgradeDeltaHealthPolicy(maxPercentDeltaUnhealthyNodes, Optional.ToNullable(maxPercentUpgradeDomainDeltaUnhealthyNodes), Optional.ToNullable(maxPercentDeltaUnhealthyApplications));
        }
    }
}
