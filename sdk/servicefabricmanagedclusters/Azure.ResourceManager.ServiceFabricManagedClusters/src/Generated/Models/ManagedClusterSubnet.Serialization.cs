...
{
    public partial class ManagedClusterSubnet : IUtf8JsonSerializable, IJsonModel<ManagedClusterSubnet>, IPersistableModel<ManagedClusterSubnet>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(PrivateEndpointNetworkPolicies))
            {
                ...
                builder.AppendLine($" '{PrivateEndpointNetworkPolicies.ToString()}'");
            }

            if (Optional.IsDefined(PrivateLinkServiceNetworkPolicies))
            {
                builder.Append("  privateLinkServiceNetworkPolicies:");
                builder.AppendLine($" '{PrivateLinkServiceNetworkPolicies.ToString()}'");
            }
