...
{
    public partial class NodeTypeVmssDataDisk : IUtf8JsonSerializable, IJsonModel<NodeTypeVmssDataDisk>, IPersistableModel<NodeTypeVmssDataDisk>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(DiskLetter))
            {
                builder.Append("  diskLetter:");
                builder.AppendLine($" '{DiskLetter}'");
            }
