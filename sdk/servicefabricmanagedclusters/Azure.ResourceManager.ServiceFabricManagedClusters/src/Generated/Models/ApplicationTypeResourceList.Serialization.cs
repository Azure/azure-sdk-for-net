...
namespace Azure.ResourceManager.ServiceFabricManagedClusters.Models
{
    internal partial class ApplicationTypeResourceList
    {
        internal static ApplicationTypeResourceList DeserializeApplicationTypeResourceList(JsonElement element)
        {
            ...
            Core.Optional<IReadOnlyList<ServiceFabricManagedApplicationTypeData>> value = default;
            ...
            return new ApplicationTypeResourceList(Core.Optional.ToList(value), nextLink.Value);
        }
    }
}
