...
namespace Azure.ResourceManager.ServiceFabricManagedClusters.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ApplicationTypeResourceList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ApplicationTypeResourceList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ApplicationTypeResourceList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<ApplicationTypeResourceList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
