...
namespace Azure.ResourceManager.ServiceFabricManagedClusters.Models
{
    ...
    internal partial class UnknownScalingTrigger : ManagedServiceScalingTrigger
    {
        ...
        internal UnknownScalingTrigger(ServiceScalingTriggerKind kind, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(kind, serializedAdditionalRawData)
        {
            Kind = kind;
        }
