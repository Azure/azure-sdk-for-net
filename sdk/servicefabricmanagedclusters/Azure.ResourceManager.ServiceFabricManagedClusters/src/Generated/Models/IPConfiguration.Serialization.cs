...
namespace Azure.ResourceManager.ServiceFabricManagedClusters.Models
{
    public partial class IPConfiguration : IUtf8JsonSerializable
    {
        ...
        internal static IPConfiguration DeserializeIPConfiguration(JsonElement element)
        {
            ...
            return new IPConfiguration(name, Optional.ToList(applicationGatewayBackendAddressPools), Optional.ToList(loadBalancerBackendAddressPools), Optional.ToList(loadBalancerInboundNatPools), subnet, Optional.ToNullable(privateIPAddressVersion), publicIPAddressConfiguration.Value);
        }
    }
}
