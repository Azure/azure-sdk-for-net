...
namespace Azure.ResourceManager.ServiceFabricManagedClusters.Models
{
    ...
    public partial class RuntimeResumeApplicationUpgradeContent : IJsonModel<RuntimeResumeApplicationUpgradeContent>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        RuntimeResumeApplicationUpgradeContent IJsonModel<RuntimeResumeApplicationUpgradeContent>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual RuntimeResumeApplicationUpgradeContent JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<RuntimeResumeApplicationUpgradeContent>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static RuntimeResumeApplicationUpgradeContent DeserializeRuntimeResumeApplicationUpgradeContent(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            {
                if (prop.NameEquals("upgradeDomainName"u8))
                {
                    upgradeDomainName = prop.Value.GetString();
                    continue;
                }
                if (options.Format != "W")
                {
            ...
            return new RuntimeResumeApplicationUpgradeContent(upgradeDomainName, additionalBinaryDataProperties);
        }

        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<RuntimeResumeApplicationUpgradeContent>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        /// <param name="runtimeResumeApplicationUpgradeContent"> The <see cref="RuntimeResumeApplicationUpgradeContent"/> to serialize into <see cref="RequestContent"/>. </param>
        internal static RequestContent ToRequestContent(RuntimeResumeApplicationUpgradeContent runtimeResumeApplicationUpgradeContent)
        {
            if (runtimeResumeApplicationUpgradeContent == null)
            {
                return null;
            }
            Utf8JsonRequestContent content = new Utf8JsonRequestContent();
            content.JsonWriter.WriteObjectValue(runtimeResumeApplicationUpgradeContent, ModelSerializationExtensions.WireOptions);
            return content;
        }
    }
}
