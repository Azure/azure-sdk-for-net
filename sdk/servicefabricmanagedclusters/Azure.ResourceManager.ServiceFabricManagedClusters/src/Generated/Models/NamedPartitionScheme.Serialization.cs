...
namespace Azure.ResourceManager.ServiceFabricManagedClusters.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NamedPartitionScheme>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NamedPartitionScheme>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NamedPartitionScheme>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<NamedPartitionScheme>)} interface");
            }
        ...
        string IPersistableModel<NamedPartitionScheme>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
