...
namespace Azure.ResourceManager.ServiceFabricManagedClusters.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ServicePlacementRequiredDomainPolicy>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ServicePlacementRequiredDomainPolicy>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ServicePlacementRequiredDomainPolicy>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<ServicePlacementRequiredDomainPolicy>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
