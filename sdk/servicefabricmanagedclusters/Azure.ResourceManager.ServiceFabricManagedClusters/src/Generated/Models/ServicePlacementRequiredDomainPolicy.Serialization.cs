...
{
    public partial class ServicePlacementRequiredDomainPolicy : IUtf8JsonSerializable, IJsonModel<ServicePlacementRequiredDomainPolicy>, IPersistableModel<ServicePlacementRequiredDomainPolicy>
    {
        ...
        void IJsonModel<ServicePlacementRequiredDomainPolicy>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ServicePlacementRequiredDomainPolicy)} does not support '{format}' format.");
            }
