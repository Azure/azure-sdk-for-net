...
namespace Azure.ResourceManager.ServiceFabricManagedClusters.Models
{
    ...
    public partial class NamedPartitionScheme : ManagedServicePartitionScheme
    {
        ...
        internal NamedPartitionScheme(PartitionScheme partitionScheme, IList<string> names, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(partitionScheme, serializedAdditionalRawData)
        {
            Names = names;
