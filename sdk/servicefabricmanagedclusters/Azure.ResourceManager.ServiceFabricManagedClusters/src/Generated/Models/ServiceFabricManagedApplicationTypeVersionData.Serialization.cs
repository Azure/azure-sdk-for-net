...
namespace Azure.ResourceManager.ServiceFabricManagedClusters
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ServiceFabricManagedApplicationTypeVersionData>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<ServiceFabricManagedApplicationTypeVersionData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ServiceFabricManagedApplicationTypeVersionData>)} interface");
            }
        ...
        string IPersistableModel<ServiceFabricManagedApplicationTypeVersionData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
