...
{
    public partial class ServiceFabricManagedApplicationTypeVersionData : IUtf8JsonSerializable, IJsonModel<ServiceFabricManagedApplicationTypeVersionData>, IPersistableModel<ServiceFabricManagedApplicationTypeVersionData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ServiceFabricManagedApplicationTypeVersionData>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ServiceFabricManagedApplicationTypeVersionData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ServiceFabricManagedApplicationTypeVersionData)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(AppPackageUri))
            {
                builder.Append("  appPackageUrl:");
                builder.AppendLine($" '{AppPackageUri.AbsoluteUri}'");
            }
