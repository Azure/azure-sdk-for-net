...
namespace Azure.ResourceManager.ServiceFabricManagedClusters.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ManagedVmSizesResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ManagedVmSizesResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ManagedVmSizesResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ManagedVmSizesResult>)} interface");
            }
        ...
        string IPersistableModel<ManagedVmSizesResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
