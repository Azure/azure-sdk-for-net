...
namespace Azure.ResourceManager.ServiceFabricManagedClusters.Models
{
    public partial class ClusterUpgradePolicy : IUtf8JsonSerializable
    {
        ...
        internal static ClusterUpgradePolicy DeserializeClusterUpgradePolicy(JsonElement element)
        {
            ...
            return new ClusterUpgradePolicy(Optional.ToNullable(forceRestart), healthPolicy.Value, deltaHealthPolicy.Value, monitoringPolicy.Value, upgradeReplicaSetCheckTimeout.Value);
        }
    }
}
