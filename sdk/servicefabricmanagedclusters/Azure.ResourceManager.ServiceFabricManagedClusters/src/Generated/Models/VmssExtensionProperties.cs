...
namespace Azure.ResourceManager.ServiceFabricManagedClusters.Models
{
    ...
    internal partial class VmssExtensionProperties
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="VmssExtensionProperties"/>. </summary>
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="publisher"/>, <paramref name="vmssExtensionPropertiesType"/> or <paramref name="typeHandlerVersion"/> is null. </exception>
        public VmssExtensionProperties(string publisher, string vmssExtensionPropertiesType, string typeHandlerVersion)
        {
        ...
        public IList<VmssExtensionSetupOrder> SetupOrder { get; } = new ChangeTrackingList<VmssExtensionSetupOrder>();
    }
}
