...
{
    internal partial class UnknownManagedServicePlacementPolicy : ManagedServicePlacementPolicy, IJsonModel<ManagedServicePlacementPolicy>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownManagedServicePlacementPolicy DeserializeUnknownManagedServicePlacementPolicy(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownManagedServicePlacementPolicy(@type, additionalBinaryDataProperties);
        }
    }
}
