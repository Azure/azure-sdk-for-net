...
{
    public partial class ServiceFabricManagedServiceData : IUtf8JsonSerializable, IJsonModel<ServiceFabricManagedServiceData>, IPersistableModel<ServiceFabricManagedServiceData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ServiceFabricManagedServiceData>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ServiceFabricManagedServiceData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ServiceFabricManagedServiceData)} does not support '{format}' format.");
            }
