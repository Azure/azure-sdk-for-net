...
namespace Azure.ResourceManager.ServiceFabricManagedClusters.Models
{
    ...
    internal partial class ServiceFabricManagedNodeTypeProperties
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="ServiceFabricManagedNodeTypeProperties"/>. </summary>
        ...
        public ServiceFabricManagedNodeTypeProperties(bool isPrimary, int vmInstanceCount)
        {
            IsPrimary = isPrimary;
        ...
        internal ServiceFabricManagedNodeTypeProperties(bool isPrimary, int vmInstanceCount, int? dataDiskSizeInGB, ServiceFabricManagedDataDiskType? dataDiskType, string dataDiskLetter, IDictionary<string, string> placementProperties, IDictionary<string, string> capacities, EndpointRangeDescription applicationPorts, EndpointRangeDescription ephemeralPorts, string vmSize, string vmImagePublisher, string vmImageOffer, string vmImageSku, string vmImageVersion, IList<NodeTypeVaultSecretGroup> vmSecrets, IList<NodeTypeVmssExtension> vmExtensions, VmManagedIdentity vmManagedIdentity, bool? isStateless, bool? hasMultiplePlacementGroups, IList<NodeTypeFrontendConfiguration> frontendConfigurations, IList<ServiceFabricManagedNetworkSecurityRule> networkSecurityRules, IList<NodeTypeVmssDataDisk> additionalDataDisks, bool? isEncryptionAtHostEnabled, ServiceFabricManagedResourceProvisioningState? provisioningState, bool? isAcceleratedNetworkingEnabled, bool? useDefaultPublicLoadBalancer, bool? useTempDataDisk, bool? isOverProvisioningEnabled, IList<string> zones, bool? isSpotVm, string hostGroupId, bool? useEphemeralOSDisk, string spotRestoreTimeout, SpotNodeVmEvictionPolicyType? evictionPolicy, ResourceIdentifier vmImageResourceId, ResourceIdentifier subnetId, IList<VmSetupAction> vmSetupActions, ServiceFabricManagedClusterSecurityType? securityType, NodeTypeSecurityEncryptionType? securityEncryptionType, bool? isSecureBootEnabled, bool? isNodePublicIPEnabled, bool? isNodePublicIPv6Enabled, ResourceIdentifier vmSharedGalleryImageId, ResourceIdentifier natGatewayId, IList<NodeTypeNatConfig> natConfigurations, VmImagePlan vmImagePlan, ResourceIdentifier serviceArtifactReferenceId, ResourceIdentifier dscpConfigurationId, IList<AdditionalNetworkInterfaceConfiguration> additionalNetworkInterfaceConfigurations, string computerNamePrefix, IList<ServiceFabricManagedVmApplication> vmApplications, bool? isZoneBalanceEnabled, bool? isOutboundOnly, bool? enableResilientEphemeralOSDisk, ScaleInPolicy scaleInPolicy, ProxyAgentSettings proxyAgentSettings, SkuProfile skuProfile, DiskCachingType? dataDiskCaching, bool? dataDiskWriteAcceleratorEnabled, int? dataDiskIOPSReadWrite, int? dataDiskMBpsReadWrite, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            ...
            DataDiskWriteAcceleratorEnabled = dataDiskWriteAcceleratorEnabled;
        ...
        /// <summary> The number of nodes in the node type. <b>Values:</b> -1 - Use when auto scale rules are configured or sku.capacity is defined 0 - Not supported &gt;0 - Use for manual scale. </summary>
        ...
        public IDictionary<string, string> PlacementProperties { get; } = new ChangeTrackingDictionary<string, string>();
        ...
        public IDictionary<string, string> Capacities { get; } = new ChangeTrackingDictionary<string, string>();
        ...
        public IList<NodeTypeVaultSecretGroup> VmSecrets { get; } = new ChangeTrackingList<NodeTypeVaultSecretGroup>();

        /// <summary> Set of extensions that should be installed onto the virtual machines. </summary>
        public IList<NodeTypeVmssExtension> VmExtensions { get; } = new ChangeTrackingList<NodeTypeVmssExtension>();
        ...
        public IList<NodeTypeFrontendConfiguration> FrontendConfigurations { get; } = new ChangeTrackingList<NodeTypeFrontendConfiguration>();
        ...
        public IList<ServiceFabricManagedNetworkSecurityRule> NetworkSecurityRules { get; } = new ChangeTrackingList<ServiceFabricManagedNetworkSecurityRule>();

        /// <summary> Additional managed data disks. </summary>
        public IList<NodeTypeVmssDataDisk> AdditionalDataDisks { get; } = new ChangeTrackingList<NodeTypeVmssDataDisk>();
        ...
        public IList<VmSetupAction> VmSetupActions { get; } = new ChangeTrackingList<VmSetupAction>();
        ...
        public IList<NodeTypeNatConfig> NatConfigurations { get; } = new ChangeTrackingList<NodeTypeNatConfig>();
        ...
        public IList<AdditionalNetworkInterfaceConfiguration> AdditionalNetworkInterfaceConfigurations { get; } = new ChangeTrackingList<AdditionalNetworkInterfaceConfiguration>();
        ...
        public IList<ServiceFabricManagedVmApplication> VmApplications { get; } = new ChangeTrackingList<ServiceFabricManagedVmApplication>();
        ...
        /// <summary> Specifies the sku profile for the node type. This allows specifying multiple VM sizes and an allocation strategy for Instance Mix scenarios. </summary>
        ...
        public DiskCachingType? DataDiskCaching { get; set; }
        ...
        public bool? DataDiskWriteAcceleratorEnabled { get; set; }
