...
{
    internal partial class UnknownManagedServiceScalingTrigger : ManagedServiceScalingTrigger, IJsonModel<ManagedServiceScalingTrigger>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownManagedServiceScalingTrigger DeserializeUnknownManagedServiceScalingTrigger(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownManagedServiceScalingTrigger(kind, additionalBinaryDataProperties);
        }
    }
}
