...
{
    public partial class ManagedServiceScalingTrigger : IUtf8JsonSerializable, IModelJsonSerializable<ManagedServiceScalingTrigger>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<ManagedServiceScalingTrigger>(this, options.Format);
        ...
        internal static ManagedServiceScalingTrigger DeserializeManagedServiceScalingTrigger(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new UnknownScalingTrigger(kind, rawData);
        }
        ...
        /// <summary> Converts a <see cref="ManagedServiceScalingTrigger"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="ManagedServiceScalingTrigger"/> to convert. </param>
        public static implicit operator RequestContent(ManagedServiceScalingTrigger model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="ManagedServiceScalingTrigger"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator ManagedServiceScalingTrigger(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeManagedServiceScalingTrigger(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
