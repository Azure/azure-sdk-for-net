...
namespace Azure.ResourceManager.ServiceFabricManagedClusters.Models
{
    ...
    public abstract partial class ManagedServiceScalingTrigger : IJsonModel<ManagedServiceScalingTrigger>
    {
        ...
        internal ManagedServiceScalingTrigger()
        {
        }
        ...
        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual ManagedServiceScalingTrigger JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<ManagedServiceScalingTrigger>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static ManagedServiceScalingTrigger DeserializeManagedServiceScalingTrigger(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            if (element.TryGetProperty("kind"u8, out JsonElement discriminator))
            {
                switch (discriminator.GetString())
                {
                    case "AveragePartitionLoadTrigger":
                        return AveragePartitionLoadScalingTrigger.DeserializeAveragePartitionLoadScalingTrigger(element, options);
                    case "AverageServiceLoadTrigger":
                        return AverageServiceLoadScalingTrigger.DeserializeAverageServiceLoadScalingTrigger(element, options);
                }
            }
