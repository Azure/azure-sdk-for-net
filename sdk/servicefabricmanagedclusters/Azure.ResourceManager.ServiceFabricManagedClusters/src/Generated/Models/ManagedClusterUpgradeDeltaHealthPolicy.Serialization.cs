...
{
    public partial class ManagedClusterUpgradeDeltaHealthPolicy : IUtf8JsonSerializable, IJsonModel<ManagedClusterUpgradeDeltaHealthPolicy>, IPersistableModel<ManagedClusterUpgradeDeltaHealthPolicy>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(MaxPercentDeltaUnhealthyNodes))
            {
                builder.Append("  maxPercentDeltaUnhealthyNodes:");
                builder.AppendLine($" '{MaxPercentDeltaUnhealthyNodes.ToString()}'");
            }

            if (Optional.IsDefined(MaxPercentUpgradeDomainDeltaUnhealthyNodes))
            {
                builder.Append("  maxPercentUpgradeDomainDeltaUnhealthyNodes:");
                builder.AppendLine($" '{MaxPercentUpgradeDomainDeltaUnhealthyNodes.Value.ToString()}'");
            }

            if (Optional.IsDefined(MaxPercentDeltaUnhealthyApplications))
            {
                builder.Append("  maxPercentDeltaUnhealthyApplications:");
                builder.AppendLine($" '{MaxPercentDeltaUnhealthyApplications.Value.ToString()}'");
            }
