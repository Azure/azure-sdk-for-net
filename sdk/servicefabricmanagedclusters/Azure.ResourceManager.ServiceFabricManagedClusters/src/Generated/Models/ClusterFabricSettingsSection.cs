...
namespace Azure.ResourceManager.ServiceFabricManagedClusters.Models
{
    ...
    public partial class ClusterFabricSettingsSection
    {
        ...
        internal ClusterFabricSettingsSection(string name, IList<ClusterFabricSettingsParameterDescription> parameters, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
