...
{
    public partial class ManagedClusterClientCertificate : IUtf8JsonSerializable, IJsonModel<ManagedClusterClientCertificate>, IPersistableModel<ManagedClusterClientCertificate>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(IssuerThumbprint))
            {
                builder.Append("  issuerThumbprint:");
                builder.AppendLine($" '{IssuerThumbprint.ToString()}'");
            }
