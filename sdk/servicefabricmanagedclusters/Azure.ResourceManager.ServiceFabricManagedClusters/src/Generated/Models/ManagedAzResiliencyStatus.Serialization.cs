...
{
    public partial class ManagedAzResiliencyStatus : IUtf8JsonSerializable, IJsonModel<ManagedAzResiliencyStatus>, IPersistableModel<ManagedAzResiliencyStatus>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(BaseResourceStatus))
            {
                builder.Append("  baseResourceStatus:");
                builder.AppendLine(" [");
                foreach (var item in BaseResourceStatus)
                {
            ...
            {
                builder.Append("  isClusterZoneResilient:");
                var boolValue = IsClusterZoneResilient.Value == true ? "true" : "false";
