...
namespace Azure.ResourceManager.ServiceFabricManagedClusters.Models
{
    public partial class ManagedAzResiliencyStatus : IUtf8JsonSerializable, IModelJsonSerializable<ManagedAzResiliencyStatus>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<ManagedAzResiliencyStatus>(this, options.Format);
            ...
            if (Optional.IsCollectionDefined(BaseResourceStatus))
            {
                ...
                foreach (var item in BaseResourceStatus)
                {
                    ...
                    {
                        ((IModelJsonSerializable<ResourceAzStatus>)item).Serialize(writer, options);
                    }
                }
        ...
        /// <summary> Converts a <see cref="ManagedAzResiliencyStatus"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="ManagedAzResiliencyStatus"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="ManagedAzResiliencyStatus"/>. </summary>
