...
namespace Azure.ResourceManager.ServiceFabricManagedClusters.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NodeTypeVaultCertificate>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NodeTypeVaultCertificate>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NodeTypeVaultCertificate>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<NodeTypeVaultCertificate>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
