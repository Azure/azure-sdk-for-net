...
{
    public partial class ServiceFabricManagedClustersNetworkSecurityRule : IUtf8JsonSerializable
    {
        ...
        internal static ServiceFabricManagedClustersNetworkSecurityRule DeserializeServiceFabricManagedClustersNetworkSecurityRule(JsonElement element)
        {
            string name = default;
            Optional<string> description = default;
            ServiceFabricManagedClustersNsgProtocol protocol = default;
            ...
            ServiceFabricManagedClustersNetworkTrafficAccess access = default;
            int priority = default;
            ServiceFabricManagedClustersNetworkSecurityRuleDirection direction = default;
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    protocol = new ServiceFabricManagedClustersNsgProtocol(property.Value.GetString());
                    continue;
                }
                ...
                {
                    access = new ServiceFabricManagedClustersNetworkTrafficAccess(property.Value.GetString());
                    continue;
                }
                ...
                {
                    direction = new ServiceFabricManagedClustersNetworkSecurityRuleDirection(property.Value.GetString());
                    continue;
                }
            }
            return new ServiceFabricManagedClustersNetworkSecurityRule(name, description.Value, protocol, Optional.ToList(sourceAddressPrefixes), Optional.ToList(destinationAddressPrefixes), Optional.ToList(sourcePortRanges), Optional.ToList(destinationPortRanges), sourceAddressPrefix.Value, destinationAddressPrefix.Value, sourcePortRange.Value, destinationPortRange.Value, access, priority, direction);
        }
    }
}
