...
{
    public partial class ManagedServiceLoadMetric : IUtf8JsonSerializable, IJsonModel<ManagedServiceLoadMetric>, IPersistableModel<ManagedServiceLoadMetric>
    {
        ...
        void IJsonModel<ManagedServiceLoadMetric>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ManagedServiceLoadMetric)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(PrimaryDefaultLoad))
            {
                ...
                builder.AppendLine($" '{PrimaryDefaultLoad.Value.ToString()}'");
            }

            if (Optional.IsDefined(SecondaryDefaultLoad))
            {
                builder.Append("  secondaryDefaultLoad:");
                builder.AppendLine($" '{SecondaryDefaultLoad.Value.ToString()}'");
            }

            if (Optional.IsDefined(DefaultLoad))
            {
                builder.Append("  defaultLoad:");
                builder.AppendLine($" '{DefaultLoad.Value.ToString()}'");
            }
