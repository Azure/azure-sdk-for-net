...
{
    internal partial class UnknownScalingMechanism : ManagedServiceScalingMechanism, IJsonModel<ManagedServiceScalingMechanism>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownScalingMechanism DeserializeUnknownScalingMechanism(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownScalingMechanism(kind, additionalBinaryDataProperties);
        }
