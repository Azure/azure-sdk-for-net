...
namespace Azure.ResourceManager.ServiceFabricManagedClusters.Models
{
    ...
    public partial class ServiceFabricManagedUnsupportedVmSize : ResourceData
    {
        ...
        internal ServiceFabricManagedUnsupportedVmSize(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, VmSize properties, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData)
        {
