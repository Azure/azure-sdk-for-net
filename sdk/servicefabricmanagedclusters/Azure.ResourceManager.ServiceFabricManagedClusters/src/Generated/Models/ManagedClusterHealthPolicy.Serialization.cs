...
{
    public partial class ManagedClusterHealthPolicy : IUtf8JsonSerializable, IJsonModel<ManagedClusterHealthPolicy>, IPersistableModel<ManagedClusterHealthPolicy>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(MaxPercentUnhealthyNodes))
            {
                ...
                builder.AppendLine($" '{MaxPercentUnhealthyNodes.ToString()}'");
            }

            if (Optional.IsDefined(MaxPercentUnhealthyApplications))
            {
                builder.Append("  maxPercentUnhealthyApplications:");
                builder.AppendLine($" '{MaxPercentUnhealthyApplications.ToString()}'");
            }
