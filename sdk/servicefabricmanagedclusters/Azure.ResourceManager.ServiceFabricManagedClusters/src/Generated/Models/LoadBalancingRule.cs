...
namespace Azure.ResourceManager.ServiceFabricManagedClusters.Models
{
    ...
    public partial class LoadBalancingRule
    {
        ...
        internal LoadBalancingRule(int frontendPort, int backendPort, Protocol protocol, int? probePort, ProbeProtocol probeProtocol, string probeRequestPath, string loadDistribution)
        {
            FrontendPort = frontendPort;
            BackendPort = backendPort;
            Protocol = protocol;
