...
namespace Azure.ResourceManager.ServiceFabricManagedClusters.Models
{
    public partial class NamedPartitionAddOrRemoveScalingMechanism : IUtf8JsonSerializable, IModelJsonSerializable<NamedPartitionAddOrRemoveScalingMechanism>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<NamedPartitionAddOrRemoveScalingMechanism>(this, options.Format);
        ...
        internal static NamedPartitionAddOrRemoveScalingMechanism DeserializeNamedPartitionAddOrRemoveScalingMechanism(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new NamedPartitionAddOrRemoveScalingMechanism(kind, minPartitionCount, maxPartitionCount, scaleIncrement, serializedAdditionalRawData);
        }
        ...
        /// <summary> Converts a <see cref="NamedPartitionAddOrRemoveScalingMechanism"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="NamedPartitionAddOrRemoveScalingMechanism"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="NamedPartitionAddOrRemoveScalingMechanism"/>. </summary>
