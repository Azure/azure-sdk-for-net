...
{
    public partial class NamedPartitionAddOrRemoveScalingMechanism : IUtf8JsonSerializable, IJsonModel<NamedPartitionAddOrRemoveScalingMechanism>, IPersistableModel<NamedPartitionAddOrRemoveScalingMechanism>
    {
        ...
        void IJsonModel<NamedPartitionAddOrRemoveScalingMechanism>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(NamedPartitionAddOrRemoveScalingMechanism)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(MinPartitionCount))
            {
                builder.Append("  minPartitionCount:");
                builder.AppendLine($" '{MinPartitionCount.ToString()}'");
            }

            if (Optional.IsDefined(MaxPartitionCount))
            {
                builder.Append("  maxPartitionCount:");
                builder.AppendLine($" '{MaxPartitionCount.ToString()}'");
            }
