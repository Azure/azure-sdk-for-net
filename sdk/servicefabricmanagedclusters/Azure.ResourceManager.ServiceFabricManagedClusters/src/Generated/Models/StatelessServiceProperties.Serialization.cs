...
{
    public partial class StatelessServiceProperties : IUtf8JsonSerializable, IJsonModel<StatelessServiceProperties>, IPersistableModel<StatelessServiceProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(MinInstancePercentage))
            {
                builder.Append("  minInstancePercentage:");
                builder.AppendLine($" '{MinInstancePercentage.Value.ToString()}'");
            }
