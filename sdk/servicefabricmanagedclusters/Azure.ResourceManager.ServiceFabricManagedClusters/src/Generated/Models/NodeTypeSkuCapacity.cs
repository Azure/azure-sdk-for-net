...
namespace Azure.ResourceManager.ServiceFabricManagedClusters.Models
{
    ...
    public partial class NodeTypeSkuCapacity
    {
        ...
        internal NodeTypeSkuCapacity(int? minimum, int? maximum, int? @default, NodeTypeSkuScaleType? scaleType, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Minimum = minimum;
            Maximum = maximum;
            Default = @default;
