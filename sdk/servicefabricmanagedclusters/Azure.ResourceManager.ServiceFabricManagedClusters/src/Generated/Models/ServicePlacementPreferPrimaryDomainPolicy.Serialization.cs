...
namespace Azure.ResourceManager.ServiceFabricManagedClusters.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ServicePlacementPreferPrimaryDomainPolicy>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ServicePlacementPreferPrimaryDomainPolicy>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ServicePlacementPreferPrimaryDomainPolicy>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ServicePlacementPreferPrimaryDomainPolicy>)} interface");
            }
        ...
        string IPersistableModel<ServicePlacementPreferPrimaryDomainPolicy>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
