...
namespace Azure.ResourceManager.ServiceFabricManagedClusters
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ServiceFabricManagedNodeTypeData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ServiceFabricManagedNodeTypeData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ServiceFabricManagedNodeTypeData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ServiceFabricManagedNodeTypeData>)} interface");
            }
        ...
        string IPersistableModel<ServiceFabricManagedNodeTypeData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
