    ...
    public partial class ServiceFabricManagedNodeTypeData : IUtf8JsonSerializable, IJsonModel<ServiceFabricManagedNodeTypeData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(VmInstanceCount))
            {
                ...
                builder.AppendLine($" {VmInstanceCount.Value}");
            }

            if (Optional.IsDefined(DataDiskSizeInGB))
            {
                builder.Append("    dataDiskSizeGB:");
                builder.AppendLine($" {DataDiskSizeInGB.Value}");
            }

            if (Optional.IsDefined(DataDiskType))
            {
                builder.Append("    dataDiskType:");
                builder.AppendLine($" '{DataDiskType.Value.ToString()}'");
            }

            if (Optional.IsDefined(DataDiskLetter))
            {
                builder.Append("    dataDiskLetter:");
                if (DataDiskLetter.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(ApplicationPorts))
            {
                ...
                AppendChildObject(builder, ApplicationPorts, options, 4, false);
            }

            if (Optional.IsDefined(EphemeralPorts))
            {
                builder.Append("    ephemeralPorts:");
                AppendChildObject(builder, EphemeralPorts, options, 4, false);
            }
            ...
            if (Optional.IsDefined(VmImagePublisher))
            {
                ...
                if (VmImagePublisher.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(VmImageOffer))
            {
                ...
                if (VmImageOffer.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(VmImageSku))
            {
                ...
                if (VmImageSku.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(VmImageVersion))
            {
                ...
                if (VmImageVersion.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(VmManagedIdentity))
            {
                ...
                AppendChildObject(builder, VmManagedIdentity, options, 4, false);
            }
            ...
            if (Optional.IsDefined(HostGroupId))
            {
                ...
                if (HostGroupId.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(SpotRestoreTimeout))
            {
                ...
                if (SpotRestoreTimeout.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(VmImagePlan))
            {
                ...
                AppendChildObject(builder, VmImagePlan, options, 4, false);
            }
            ...
            if (Optional.IsCollectionDefined(AdditionalNetworkInterfaceConfigurations))
            {
                if (AdditionalNetworkInterfaceConfigurations.Any())
                {
