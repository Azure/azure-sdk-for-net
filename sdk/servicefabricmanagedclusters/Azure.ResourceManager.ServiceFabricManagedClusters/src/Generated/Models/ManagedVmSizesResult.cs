...
namespace Azure.ResourceManager.ServiceFabricManagedClusters.Models
{
    ...
    internal partial class ManagedVmSizesResult
    {
        ...
        {
            Value = new ChangeTrackingList<ServiceFabricManagedClustersVmSize>();
        }
        ...
        internal ManagedVmSizesResult(IReadOnlyList<ServiceFabricManagedClustersVmSize> value, string nextLink)
        {
            Value = value;
            NextLink = nextLink;
        }
        ...
        public IReadOnlyList<ServiceFabricManagedClustersVmSize> Value { get; }
