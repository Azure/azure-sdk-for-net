...
namespace Azure.ResourceManager.ServiceFabricManagedClusters.Models
{
    ...
    {
        /// <summary> Initializes a new instance of ManagedClusterServiceLoadMetric. </summary>
        ...
        internal ManagedClusterServiceLoadMetric(string name, ManagedClusterServiceLoadMetricWeight? weight, int? primaryDefaultLoad, int? secondaryDefaultLoad, int? defaultLoad)
        {
            Name = name;
            Weight = weight;
        ...
        public ManagedClusterServiceLoadMetricWeight? Weight { get; set; }
