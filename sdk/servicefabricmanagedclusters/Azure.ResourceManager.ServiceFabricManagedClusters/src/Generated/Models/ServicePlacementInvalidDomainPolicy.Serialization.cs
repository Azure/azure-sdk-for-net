...
namespace Azure.ResourceManager.ServiceFabricManagedClusters.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ServicePlacementInvalidDomainPolicy>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ServicePlacementInvalidDomainPolicy>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ServicePlacementInvalidDomainPolicy>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ServicePlacementInvalidDomainPolicy>)} interface");
            }
        ...
        string IPersistableModel<ServicePlacementInvalidDomainPolicy>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
