...
{
    public partial class ServicePlacementInvalidDomainPolicy : IUtf8JsonSerializable, IJsonModel<ServicePlacementInvalidDomainPolicy>, IPersistableModel<ServicePlacementInvalidDomainPolicy>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ServicePlacementInvalidDomainPolicy>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ServicePlacementInvalidDomainPolicy>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ServicePlacementInvalidDomainPolicy)} does not support '{format}' format.");
            }
