...
namespace Azure.ResourceManager.ServiceFabricManagedClusters.Models
{
    ...
    internal partial class ApplicationResourceList
    {
        ...
        {
            Value = new ChangeTrackingList<ServiceFabricManagedClusterApplicationData>();
        }

        /// <summary> Initializes a new instance of ApplicationResourceList. </summary>
        /// <param name="value"></param>
        /// <param name="nextLink"> URL to get the next set of application list results if there are any. </param>
        internal ApplicationResourceList(IReadOnlyList<ServiceFabricManagedClusterApplicationData> value, string nextLink)
        {
            Value = value;
            NextLink = nextLink;
        }
        ...
        public IReadOnlyList<ServiceFabricManagedClusterApplicationData> Value { get; }
