...
namespace Azure.ResourceManager.ServiceFabricManagedClusters.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SingletonPartitionScheme>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SingletonPartitionScheme>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SingletonPartitionScheme>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SingletonPartitionScheme>)} interface");
            }
        ...
        string IPersistableModel<SingletonPartitionScheme>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
