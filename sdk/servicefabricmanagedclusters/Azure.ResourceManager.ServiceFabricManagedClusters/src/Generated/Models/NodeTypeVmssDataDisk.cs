...
namespace Azure.ResourceManager.ServiceFabricManagedClusters.Models
{
    ...
    public partial class NodeTypeVmssDataDisk
    {
        ...
        internal NodeTypeVmssDataDisk(int lun, int diskSizeInGB, ServiceFabricManagedDataDiskType diskType, string diskLetter, Dictionary<string, BinaryData> rawData)
        {
            Lun = lun;
            DiskSizeInGB = diskSizeInGB;
            DiskType = diskType;
