...
namespace Azure.ResourceManager.ServiceFabricManagedClusters.Models
{
    public partial class NodeTypeSkuCapacity
    {
        internal static NodeTypeSkuCapacity DeserializeNodeTypeSkuCapacity(JsonElement element)
        {
            ...
            Core.Optional<NodeTypeSkuScaleType> scaleType = default;
            ...
            return new NodeTypeSkuCapacity(Core.Optional.ToNullable(minimum), Core.Optional.ToNullable(maximum), Core.Optional.ToNullable(@default), Core.Optional.ToNullable(scaleType));
        }
    }
}
