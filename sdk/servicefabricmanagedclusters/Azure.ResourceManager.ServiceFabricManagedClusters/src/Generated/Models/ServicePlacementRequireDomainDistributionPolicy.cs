...
namespace Azure.ResourceManager.ServiceFabricManagedClusters.Models
{
    ...
    public partial class ServicePlacementRequireDomainDistributionPolicy : ManagedServicePlacementPolicy
    {
        ...
        internal ServicePlacementRequireDomainDistributionPolicy(ServicePlacementPolicyType servicePlacementPolicyType, string domainName, Dictionary<string, BinaryData> rawData) : base(servicePlacementPolicyType, rawData)
        {
            DomainName = domainName;
