...
namespace Azure.ResourceManager.ServiceFabricManagedClusters.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VmImagePlan>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<VmImagePlan>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<VmImagePlan>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<VmImagePlan>)} interface");
            }
        ...
        string IPersistableModel<VmImagePlan>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
