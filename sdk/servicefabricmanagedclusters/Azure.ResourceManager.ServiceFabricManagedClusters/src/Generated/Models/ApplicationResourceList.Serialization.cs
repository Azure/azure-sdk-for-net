...
namespace Azure.ResourceManager.ServiceFabricManagedClusters.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ApplicationResourceList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ApplicationResourceList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ApplicationResourceList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ApplicationResourceList>)} interface");
            }
        ...
        string IPersistableModel<ApplicationResourceList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
