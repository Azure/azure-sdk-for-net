...
namespace Azure.ResourceManager.ServiceFabricManagedClusters.Models
{
    ...
    public partial class ServicePlacementInvalidDomainPolicy : ManagedServicePlacementPolicy
    {
        ...
        internal ServicePlacementInvalidDomainPolicy(ServicePlacementPolicyType servicePlacementPolicyType, string domainName, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(servicePlacementPolicyType, serializedAdditionalRawData)
        {
            DomainName = domainName;
