...
{
    public partial class ServicePlacementNonPartiallyPlaceServicePolicy : IUtf8JsonSerializable, IJsonModel<ServicePlacementNonPartiallyPlaceServicePolicy>, IPersistableModel<ServicePlacementNonPartiallyPlaceServicePolicy>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ServicePlacementNonPartiallyPlaceServicePolicy>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ServicePlacementNonPartiallyPlaceServicePolicy>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ServicePlacementNonPartiallyPlaceServicePolicy)} does not support '{format}' format.");
            }
