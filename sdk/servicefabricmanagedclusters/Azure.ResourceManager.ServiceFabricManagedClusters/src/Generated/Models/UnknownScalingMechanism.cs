...
namespace Azure.ResourceManager.ServiceFabricManagedClusters.Models
{
    ...
    internal partial class UnknownScalingMechanism : ManagedServiceScalingMechanism
    {
        ...
        internal UnknownScalingMechanism(ServiceScalingMechanismKind kind, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(kind, serializedAdditionalRawData)
        {
            Kind = kind;
        }
