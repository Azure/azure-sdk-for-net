...
namespace Azure.ResourceManager.ServiceFabricManagedClusters.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NodeTypeListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NodeTypeListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NodeTypeListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<NodeTypeListResult>)} interface");
            }
        ...
        string IPersistableModel<NodeTypeListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
