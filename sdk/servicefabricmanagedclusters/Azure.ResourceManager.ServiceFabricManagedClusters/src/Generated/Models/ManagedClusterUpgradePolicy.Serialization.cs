...
{
    public partial class ManagedClusterUpgradePolicy : IUtf8JsonSerializable, IJsonModel<ManagedClusterUpgradePolicy>, IPersistableModel<ManagedClusterUpgradePolicy>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(MonitoringPolicy))
            {
                ...
                AppendChildObject(builder, MonitoringPolicy, options, 2);
            }
