...
{
    public partial class ServiceFabricManagedClusterVersion : IUtf8JsonSerializable, IJsonModel<ServiceFabricManagedClusterVersion>, IPersistableModel<ServiceFabricManagedClusterVersion>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(VersionSupportExpireOn))
            {
                ...
                builder.AppendLine($" '{VersionSupportExpireOn.Value.ToString()}'");
            }
