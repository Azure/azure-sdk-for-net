...
namespace Azure.ResourceManager.ServiceFabricManagedClusters.Models
{
    ...
    public partial class UniformInt64RangePartitionScheme : ManagedServicePartitionScheme
    {
        ...
        internal UniformInt64RangePartitionScheme(PartitionScheme partitionScheme, int count, long lowKey, long highKey, Dictionary<string, BinaryData> rawData) : base(partitionScheme, rawData)
        {
            Count = count;
            LowKey = lowKey;
            HighKey = highKey;
