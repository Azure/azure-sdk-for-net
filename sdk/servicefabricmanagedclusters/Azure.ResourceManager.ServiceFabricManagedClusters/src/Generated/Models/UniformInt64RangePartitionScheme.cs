...
namespace Azure.ResourceManager.ServiceFabricManagedClusters.Models
{
    ...
    public partial class UniformInt64RangePartitionScheme : ManagedServicePartitionScheme
    {
        ...
        internal UniformInt64RangePartitionScheme(PartitionScheme partitionScheme, int count, long lowKey, long highKey, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(partitionScheme, serializedAdditionalRawData)
        {
            Count = count;
            LowKey = lowKey;
            HighKey = highKey;
