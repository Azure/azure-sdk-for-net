...
namespace Azure.ResourceManager.ServiceFabricManagedClusters.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NodeTypeActionContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NodeTypeActionContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NodeTypeActionContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<NodeTypeActionContent>)} interface");
            }
        ...
        string IPersistableModel<NodeTypeActionContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
