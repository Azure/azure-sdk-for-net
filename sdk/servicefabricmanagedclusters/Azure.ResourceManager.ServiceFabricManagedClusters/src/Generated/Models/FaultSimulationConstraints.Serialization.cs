...
namespace Azure.ResourceManager.ServiceFabricManagedClusters.Models
{
    ...
    internal partial class FaultSimulationConstraints : IJsonModel<FaultSimulationConstraints>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<FaultSimulationConstraints>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        FaultSimulationConstraints IJsonModel<FaultSimulationConstraints>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<FaultSimulationConstraints>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        FaultSimulationConstraints IPersistableModel<FaultSimulationConstraints>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
