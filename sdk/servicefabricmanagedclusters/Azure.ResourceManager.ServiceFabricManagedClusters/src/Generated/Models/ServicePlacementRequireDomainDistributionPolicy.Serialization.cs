...
namespace Azure.ResourceManager.ServiceFabricManagedClusters.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ServicePlacementRequireDomainDistributionPolicy>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<ServicePlacementRequireDomainDistributionPolicy>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ServicePlacementRequireDomainDistributionPolicy>)} interface");
            }
        ...
        string IPersistableModel<ServicePlacementRequireDomainDistributionPolicy>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
