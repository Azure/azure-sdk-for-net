...
namespace Azure.ResourceManager.ServiceFabricManagedClusters.Models
{
    ...
    public partial class ManagedServiceLoadMetric
    {
        ...
        internal ManagedServiceLoadMetric(string name, ManagedServiceLoadMetricWeight? weight, int? primaryDefaultLoad, int? secondaryDefaultLoad, int? defaultLoad, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Weight = weight;
