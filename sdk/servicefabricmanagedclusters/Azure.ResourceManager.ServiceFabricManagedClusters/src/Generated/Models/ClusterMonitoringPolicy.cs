...
namespace Azure.ResourceManager.ServiceFabricManagedClusters.Models
{
    ...
    public partial class ClusterMonitoringPolicy
    {
        ...
        internal ClusterMonitoringPolicy(TimeSpan healthCheckWaitDuration, TimeSpan healthCheckStableDuration, string healthCheckRetryTimeout, string upgradeTimeout, string upgradeDomainTimeout, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            HealthCheckWaitDuration = healthCheckWaitDuration;
            HealthCheckStableDuration = healthCheckStableDuration;
            HealthCheckRetryTimeout = healthCheckRetryTimeout;
        ...
        /// <summary> Initializes a new instance of <see cref="ClusterMonitoringPolicy"/> for deserialization. </summary>
        internal ClusterMonitoringPolicy()
        {
        }
