...
namespace Azure.ResourceManager.ServiceFabricManagedClusters.Models
{
    ...
    public partial class ManagedClusterLoadBalancingRule
    {
        ...
        internal ManagedClusterLoadBalancingRule(int frontendPort, int backendPort, ManagedClusterLoadBalancingRuleTransportProtocol protocol, int? probePort, ManagedClusterLoadBalanceProbeProtocol probeProtocol, string probeRequestPath, string loadDistribution, Dictionary<string, BinaryData> rawData)
        {
            FrontendPort = frontendPort;
            BackendPort = backendPort;
            Protocol = protocol;
