...
{
    public partial class ManagedServicePlacementPolicy : IUtf8JsonSerializable, IModelJsonSerializable<ManagedServicePlacementPolicy>
    {
        ...
        internal static ManagedServicePlacementPolicy DeserializeManagedServicePlacementPolicy(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new UnknownServicePlacementPolicy(type, rawData);
        }
        ...
        /// <summary> Converts a <see cref="ManagedServicePlacementPolicy"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="ManagedServicePlacementPolicy"/> to convert. </param>
        public static implicit operator RequestContent(ManagedServicePlacementPolicy model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="ManagedServicePlacementPolicy"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator ManagedServicePlacementPolicy(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeManagedServicePlacementPolicy(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
