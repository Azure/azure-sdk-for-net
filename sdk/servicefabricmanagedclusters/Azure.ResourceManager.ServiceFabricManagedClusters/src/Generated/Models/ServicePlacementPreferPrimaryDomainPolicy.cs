...
namespace Azure.ResourceManager.ServiceFabricManagedClusters.Models
{
    ...
    public partial class ServicePlacementPreferPrimaryDomainPolicy : ManagedServicePlacementPolicy
    {
        ...
        internal ServicePlacementPreferPrimaryDomainPolicy(ServicePlacementPolicyType servicePlacementPolicyType, string domainName, Dictionary<string, BinaryData> rawData) : base(servicePlacementPolicyType, rawData)
        {
            DomainName = domainName;
