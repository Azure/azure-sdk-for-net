...
{
    internal partial class UnknownManagedServiceScalingMechanism : ManagedServiceScalingMechanism, IJsonModel<ManagedServiceScalingMechanism>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownManagedServiceScalingMechanism DeserializeUnknownManagedServiceScalingMechanism(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownManagedServiceScalingMechanism(kind, additionalBinaryDataProperties);
        }
    }
}
