...
namespace Azure.ResourceManager.ServiceFabricManagedClusters.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ResourceAzStatus>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ResourceAzStatus>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ResourceAzStatus>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ResourceAzStatus>)} interface");
            }
        ...
        string IPersistableModel<ResourceAzStatus>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
