...
namespace Azure.ResourceManager.ServiceFabricManagedClusters.Models
{
    public partial class ServiceFabricManagedNodeTypePatch : IUtf8JsonSerializable, IJsonModel<ServiceFabricManagedNodeTypePatch>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<ServiceFabricManagedNodeTypePatch>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ServiceFabricManagedNodeTypePatch>)} interface");
            }
