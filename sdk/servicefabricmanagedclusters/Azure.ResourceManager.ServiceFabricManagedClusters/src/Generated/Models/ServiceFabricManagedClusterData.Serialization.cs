...
namespace Azure.ResourceManager.ServiceFabricManagedClusters
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ServiceFabricManagedClusterData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ServiceFabricManagedClusterData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ServiceFabricManagedClusterData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ServiceFabricManagedClusterData>)} interface");
            }
        ...
        string IPersistableModel<ServiceFabricManagedClusterData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
