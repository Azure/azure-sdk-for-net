...
namespace Azure.ResourceManager.ServiceFabricManagedClusters.Models
{
    ...
    {
        /// <summary> Initializes a new instance of ServiceFabricManagedClustersNetworkSecurityRule. </summary>
        ...
        public ServiceFabricManagedClustersNetworkSecurityRule(string name, ServiceFabricManagedClustersNsgProtocol protocol, ServiceFabricManagedClustersNetworkTrafficAccess access, int priority, ServiceFabricManagedClustersNetworkSecurityRuleDirection direction)
        {
            if (name == null)
            {
        ...
        /// <param name="priority"> The priority of the rule. The value can be in the range 1000 to 3000. Values outside this range are reserved for Service Fabric ManagerCluster Resource Provider. The priority number must be unique for each rule in the collection. The lower the priority number, the higher the priority of the rule. </param>
        /// <param name="direction"> Network security rule direction. </param>
        internal ServiceFabricManagedClustersNetworkSecurityRule(string name, string description, ServiceFabricManagedClustersNsgProtocol protocol, IList<string> sourceAddressPrefixes, IList<string> destinationAddressPrefixes, IList<string> sourcePortRanges, IList<string> destinationPortRanges, string sourceAddressPrefix, string destinationAddressPrefix, string sourcePortRange, string destinationPortRange, ServiceFabricManagedClustersNetworkTrafficAccess access, int priority, ServiceFabricManagedClustersNetworkSecurityRuleDirection direction)
        {
            Name = name;
        ...
        public ServiceFabricManagedClustersNsgProtocol Protocol { get; set; }
        ...
        public ServiceFabricManagedClustersNetworkTrafficAccess Access { get; set; }
        ...
        public ServiceFabricManagedClustersNetworkSecurityRuleDirection Direction { get; set; }
    }
}
