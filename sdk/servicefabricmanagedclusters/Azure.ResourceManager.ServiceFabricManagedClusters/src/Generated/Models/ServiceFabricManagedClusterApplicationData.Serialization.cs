...
{
    public partial class ServiceFabricManagedClusterApplicationData : IUtf8JsonSerializable
    {
        ...
        internal static ServiceFabricManagedClusterApplicationData DeserializeServiceFabricManagedClusterApplicationData(JsonElement element)
        {
            ...
            return new ServiceFabricManagedClusterApplicationData(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, identity, provisioningState.Value, version.Value, Optional.ToDictionary(parameters), upgradePolicy.Value, Optional.ToList(managedIdentities));
        }
    }
}
