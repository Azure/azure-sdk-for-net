...
{
    public partial class ApplicationUpgradePolicy : IUtf8JsonSerializable, IJsonModel<ApplicationUpgradePolicy>, IPersistableModel<ApplicationUpgradePolicy>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ApplicationHealthPolicy))
            {
                builder.Append("  applicationHealthPolicy:");
                AppendChildObject(builder, ApplicationHealthPolicy, options, 2);
            }
            ...
            if (Optional.IsDefined(RollingUpgradeMonitoringPolicy))
            {
                builder.Append("  rollingUpgradeMonitoringPolicy:");
                AppendChildObject(builder, RollingUpgradeMonitoringPolicy, options, 2);
            }

            if (Optional.IsDefined(InstanceCloseDelayDurationInSeconds))
            {
                builder.Append("  instanceCloseDelayDuration:");
                builder.AppendLine($" '{InstanceCloseDelayDurationInSeconds.Value.ToString()}'");
            }
            ...
            if (Optional.IsDefined(UpgradeReplicaSetCheckTimeout))
            {
                ...
                builder.AppendLine($" '{UpgradeReplicaSetCheckTimeout.Value.ToString()}'");
            }

            if (Optional.IsDefined(RecreateApplication))
            {
                builder.Append("  recreateApplication:");
                var boolValue = RecreateApplication.Value == true ? "true" : "false";
                builder.AppendLine($" {boolValue}");
            }
