...
{
    public partial class ApplicationUpgradePolicy : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ApplicationUpgradePolicy DeserializeApplicationUpgradePolicy(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
