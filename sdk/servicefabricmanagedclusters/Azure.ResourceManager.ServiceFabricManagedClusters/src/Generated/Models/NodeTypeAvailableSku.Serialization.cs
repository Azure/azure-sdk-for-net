...
namespace Azure.ResourceManager.ServiceFabricManagedClusters.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NodeTypeAvailableSku>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NodeTypeAvailableSku>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NodeTypeAvailableSku>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<NodeTypeAvailableSku>)} interface");
            }
        ...
        string IPersistableModel<NodeTypeAvailableSku>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
