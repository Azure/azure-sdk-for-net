...
namespace Azure.ResourceManager.ServiceFabricManagedClusters.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VmManagedIdentity>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<VmManagedIdentity>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<VmManagedIdentity>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<VmManagedIdentity>)} interface");
            }
        ...
        string IPersistableModel<VmManagedIdentity>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
