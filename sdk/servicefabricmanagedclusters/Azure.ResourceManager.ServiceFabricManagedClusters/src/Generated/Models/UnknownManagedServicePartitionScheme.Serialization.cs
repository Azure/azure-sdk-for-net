...
{
    internal partial class UnknownManagedServicePartitionScheme : ManagedServicePartitionScheme, IJsonModel<ManagedServicePartitionScheme>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownManagedServicePartitionScheme DeserializeUnknownManagedServicePartitionScheme(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownManagedServicePartitionScheme(partitionScheme, additionalBinaryDataProperties);
        }
    }
}
