...
namespace Azure.ResourceManager.ServiceFabricManagedClusters.Mocking
{
    ...
    internal partial class ServiceFabricManagedClustersResourceGroupMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="ServiceFabricManagedClustersResourceGroupMockingExtension"/> class for mocking. </summary>
        protected ServiceFabricManagedClustersResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ServiceFabricManagedClustersResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ServiceFabricManagedClustersResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
