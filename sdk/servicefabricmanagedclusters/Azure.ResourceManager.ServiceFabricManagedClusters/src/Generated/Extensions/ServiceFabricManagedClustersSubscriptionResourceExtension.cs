...
namespace Azure.ResourceManager.ServiceFabricManagedClusters.Testing
{
    /// <summary> A class to add extension methods to SubscriptionResource. </summary>
    public partial class ServiceFabricManagedClustersSubscriptionResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="ServiceFabricManagedClustersSubscriptionResourceExtension"/> class for mocking. </summary>
        protected ServiceFabricManagedClustersSubscriptionResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ServiceFabricManagedClustersSubscriptionResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ServiceFabricManagedClustersSubscriptionResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual async Task<Response<ServiceFabricManagedClusterVersion>> GetManagedClusterVersionAsync(AzureLocation location, string clusterVersion, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = ManagedClusterVersionClientDiagnostics.CreateScope("ServiceFabricManagedClustersSubscriptionResourceExtension.GetManagedClusterVersion");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response<ServiceFabricManagedClusterVersion>> GetManagedClusterVersionByEnvironmentAsync(AzureLocation location, ManagedClusterVersionEnvironment environment, string clusterVersion, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = ManagedClusterVersionClientDiagnostics.CreateScope("ServiceFabricManagedClustersSubscriptionResourceExtension.GetManagedClusterVersionByEnvironment");
            scope.Start();
            try
            {
        ...
        public virtual AsyncPageable<ServiceFabricManagedClusterVersion> GetManagedClusterVersionsAsync(AzureLocation location, CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, null, ServiceFabricManagedClusterVersion.DeserializeServiceFabricManagedClusterVersion, ManagedClusterVersionClientDiagnostics, Pipeline, "ServiceFabricManagedClustersSubscriptionResourceExtension.GetManagedClusterVersions", "", null, cancellationToken);
        }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => ManagedClusterVersionRestClient.CreateListRequest(Id.SubscriptionId, location);
            return PageableHelpers.CreatePageable(FirstPageRequest, null, ServiceFabricManagedClusterVersion.DeserializeServiceFabricManagedClusterVersion, ManagedClusterVersionClientDiagnostics, Pipeline, "ServiceFabricManagedClustersSubscriptionResourceExtension.GetManagedClusterVersions", "", null, cancellationToken);
        }
        ...
        public virtual AsyncPageable<ServiceFabricManagedClusterVersion> GetManagedClusterVersionsByEnvironmentAsync(AzureLocation location, ManagedClusterVersionEnvironment environment, CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, null, ServiceFabricManagedClusterVersion.DeserializeServiceFabricManagedClusterVersion, ManagedClusterVersionClientDiagnostics, Pipeline, "ServiceFabricManagedClustersSubscriptionResourceExtension.GetManagedClusterVersionsByEnvironment", "", null, cancellationToken);
        }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => ManagedClusterVersionRestClient.CreateListByEnvironmentRequest(Id.SubscriptionId, location, environment);
            return PageableHelpers.CreatePageable(FirstPageRequest, null, ServiceFabricManagedClusterVersion.DeserializeServiceFabricManagedClusterVersion, ManagedClusterVersionClientDiagnostics, Pipeline, "ServiceFabricManagedClustersSubscriptionResourceExtension.GetManagedClusterVersionsByEnvironment", "", null, cancellationToken);
        }
        ...
        public virtual async Task<Response<ServiceFabricManagedUnsupportedVmSize>> GetManagedUnsupportedVmSizeAsync(AzureLocation location, string vmSize, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = managedUnsupportedVMSizesClientDiagnostics.CreateScope("ServiceFabricManagedClustersSubscriptionResourceExtension.GetManagedUnsupportedVmSize");
            scope.Start();
            try
            {
