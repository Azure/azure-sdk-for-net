...
namespace Azure.ResourceManager.ServiceFabricManagedClusters.Mocking
{
    ...
    internal partial class ServiceFabricManagedClustersArmClientMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="ServiceFabricManagedClustersArmClientMockingExtension"/> class for mocking. </summary>
        protected ServiceFabricManagedClustersArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ServiceFabricManagedClustersArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ServiceFabricManagedClustersArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal ServiceFabricManagedClustersArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
