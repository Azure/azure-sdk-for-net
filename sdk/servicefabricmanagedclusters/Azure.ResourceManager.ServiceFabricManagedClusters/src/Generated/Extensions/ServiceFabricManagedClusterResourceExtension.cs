...
namespace Azure.ResourceManager.ServiceFabricManagedClusters.Mock
{
    ...
    public partial class ServiceFabricManagedClusterResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="ServiceFabricManagedClusterResourceExtension"/> class for mocking. </summary>
        protected ServiceFabricManagedClusterResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ServiceFabricManagedClusterResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ServiceFabricManagedClusterResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
