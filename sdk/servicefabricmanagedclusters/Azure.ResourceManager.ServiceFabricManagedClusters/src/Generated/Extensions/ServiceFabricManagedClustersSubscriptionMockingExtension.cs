...
namespace Azure.ResourceManager.ServiceFabricManagedClusters.Mocking
{
    ...
    internal partial class ServiceFabricManagedClustersSubscriptionMockingExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="ServiceFabricManagedClustersSubscriptionMockingExtension"/> class for mocking. </summary>
        protected ServiceFabricManagedClustersSubscriptionMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ServiceFabricManagedClustersSubscriptionMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ServiceFabricManagedClustersSubscriptionMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        {
            using var scope = ManagedClusterVersionClientDiagnostics.CreateScope("ServiceFabricManagedClustersSubscriptionMockingExtension.GetManagedClusterVersion");
            scope.Start();
            try
            {
        ...
        {
            using var scope = ManagedClusterVersionClientDiagnostics.CreateScope("ServiceFabricManagedClustersSubscriptionMockingExtension.GetManagedClusterVersionByEnvironment");
            scope.Start();
            try
            {
        ...
        public virtual AsyncPageable<ServiceFabricManagedClusterVersion> GetManagedClusterVersionsAsync(AzureLocation location, CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, null, ServiceFabricManagedClusterVersion.DeserializeServiceFabricManagedClusterVersion, ManagedClusterVersionClientDiagnostics, Pipeline, "ServiceFabricManagedClustersSubscriptionMockingExtension.GetManagedClusterVersions", "", null, cancellationToken);
        }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => ManagedClusterVersionRestClient.CreateListRequest(Id.SubscriptionId, location);
            return PageableHelpers.CreatePageable(FirstPageRequest, null, ServiceFabricManagedClusterVersion.DeserializeServiceFabricManagedClusterVersion, ManagedClusterVersionClientDiagnostics, Pipeline, "ServiceFabricManagedClustersSubscriptionMockingExtension.GetManagedClusterVersions", "", null, cancellationToken);
        }
        ...
        {
            using var scope = managedUnsupportedVMSizesClientDiagnostics.CreateScope("ServiceFabricManagedClustersSubscriptionMockingExtension.GetManagedUnsupportedVmSize");
            scope.Start();
            try
            {
