...
namespace Azure.ResourceManager.ServiceFabricManagedClusters
{
    internal partial class OperationStatusRestOperations
    {
        ...
        internal RequestUriBuilder CreateGetRequestUri(string subscriptionId, AzureLocation location, string operationId)
        {
            ...
            uri.AppendPath("/managedClusterOperations/", false);
        ...
        public async Task<Response<LongRunningOperationResult>> GetAsync(string subscriptionId, AzureLocation location, string operationId, CancellationToken cancellationToken = default)
        {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="subscriptionId"/> or <paramref name="operationId"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="subscriptionId"/> or <paramref name="operationId"/> is an empty string, and was expected to be non-empty. </exception>
        public Response<LongRunningOperationResult> Get(string subscriptionId, AzureLocation location, string operationId, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(subscriptionId, nameof(subscriptionId));
            Argument.AssertNotNullOrEmpty(operationId, nameof(operationId));
