...
namespace Azure.ResourceManager.ServiceFabricManagedClusters
{
    ...
    public partial class ServiceFabricManagedApplicationTypeVersionData : TrackedResourceData, IJsonModel<ServiceFabricManagedApplicationTypeVersionData>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ServiceFabricManagedApplicationTypeVersionData IJsonModel<ServiceFabricManagedApplicationTypeVersionData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (ServiceFabricManagedApplicationTypeVersionData)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static ServiceFabricManagedApplicationTypeVersionData DeserializeServiceFabricManagedApplicationTypeVersionData(JsonElement element, ModelReaderWriterOptions options)
        {
