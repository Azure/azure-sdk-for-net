...
{
    /// <summary>
    /// A Class representing an ApplicationTypeResource along with the instance operations that can be performed on it.
    /// If you have a <see cref="ResourceIdentifier" /> you can construct an <see cref="ApplicationTypeResource" />
    /// from an instance of <see cref="ArmClient" /> using the GetApplicationTypeResource method.
    /// Otherwise you can get one from its parent resource <see cref="ManagedClusterResource" /> using the GetApplicationTypeResource method.
    /// </summary>
    public partial class ApplicationTypeResource : ArmResource
    {
        ...
        internal ApplicationTypeResource(ArmClient client, ApplicationTypeResourceData data) : this(client, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        {
            _applicationTypeResourceApplicationTypesClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.ServiceFabricManagedClusters", ResourceType.Namespace, Diagnostics);
            TryGetApiVersion(ResourceType, out string applicationTypeResourceApplicationTypesApiVersion);
        ...
        {
            return await GetApplicationTypeVersionResources().GetAsync(version, cancellationToken).ConfigureAwait(false);
        }
        ...
        {
            return GetApplicationTypeVersionResources().Get(version, cancellationToken);
        }
        ...
        {
            using var scope = _applicationTypeResourceApplicationTypesClientDiagnostics.CreateScope("ApplicationTypeResource.Get");
            scope.Start();
            try
            {
                var response = await _applicationTypeResourceApplicationTypesRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<ApplicationTypeResource> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _applicationTypeResourceApplicationTypesRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new ApplicationTypeResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        {
            using var scope = _applicationTypeResourceApplicationTypesClientDiagnostics.CreateScope("ApplicationTypeResource.Delete");
            scope.Start();
            try
            {
                var response = await _applicationTypeResourceApplicationTypesRestClient.DeleteAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
                var operation = new ServiceFabricManagedClustersArmOperation(_applicationTypeResourceApplicationTypesClientDiagnostics, Pipeline, _applicationTypeResourceApplicationTypesRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name).Request, response, OperationFinalStateVia.Location);
        ...
        public virtual ArmOperation Delete(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _applicationTypeResourceApplicationTypesRestClient.Delete(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                var operation = new ServiceFabricManagedClustersArmOperation(_applicationTypeResourceApplicationTypesClientDiagnostics, Pipeline, _applicationTypeResourceApplicationTypesRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<Response<ApplicationTypeResource>> UpdateAsync(ApplicationTypeResourcePatch patch, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(patch, nameof(patch));

            using var scope = _applicationTypeResourceApplicationTypesClientDiagnostics.CreateScope("ApplicationTypeResource.Update");
            scope.Start();
            try
            {
                var response = await _applicationTypeResourceApplicationTypesRestClient.UpdateAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, patch, cancellationToken).ConfigureAwait(false);
                return Response.FromValue(new ApplicationTypeResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="patch"/> is null. </exception>
        public virtual Response<ApplicationTypeResource> Update(ApplicationTypeResourcePatch patch, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(patch, nameof(patch));
            ...
            try
            {
                var response = _applicationTypeResourceApplicationTypesRestClient.Update(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, patch, cancellationToken);
                return Response.FromValue(new ApplicationTypeResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        public virtual async Task<Response<ApplicationTypeResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _applicationTypeResourceApplicationTypesClientDiagnostics.CreateScope("ApplicationTypeResource.AddTag");
            scope.Start();
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
                {
                    ...
                    var originalResponse = await _applicationTypeResourceApplicationTypesRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
                    return Response.FromValue(new ApplicationTypeResource(Client, originalResponse.Value), originalResponse.GetRawResponse());
                }
                else
                {
                    var current = (await GetAsync(cancellationToken: cancellationToken).ConfigureAwait(false)).Value.Data;
                    var patch = new ApplicationTypeResourcePatch();
        ...
        public virtual Response<ApplicationTypeResource> AddTag(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                if (CanUseTagResource(cancellationToken: cancellationToken))
                {
                    ...
                    var originalResponse = _applicationTypeResourceApplicationTypesRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                    return Response.FromValue(new ApplicationTypeResource(Client, originalResponse.Value), originalResponse.GetRawResponse());
                }
                else
                {
        ...
        public virtual async Task<Response<ApplicationTypeResource>> SetTagsAsync(IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _applicationTypeResourceApplicationTypesClientDiagnostics.CreateScope("ApplicationTypeResource.SetTags");
            scope.Start();
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
        ...
        public virtual async Task<Response<ApplicationTypeResource>> RemoveTagAsync(string key, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _applicationTypeResourceApplicationTypesClientDiagnostics.CreateScope("ApplicationTypeResource.RemoveTag");
            scope.Start();
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
