...
namespace Azure.ResourceManager.ServiceFabricManagedClusters
{
    ...
    public partial class ServiceFabricManagedApplicationData : TrackedResourceData
    {
        ...
        internal ServiceFabricManagedApplicationData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, ManagedServiceIdentity identity, string provisioningState, string version, IDictionary<string, string> parameters, ApplicationUpgradePolicy upgradePolicy, IList<ApplicationUserAssignedIdentityInfo> managedIdentities, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData, tags, location)
        {
            Identity = identity;
