...
namespace Azure.ResourceManager.ServiceFabricManagedClusters
{
    ...
    public partial class ServiceFabricManagedServiceResource : ArmResource
    {
        ...
        /// <summary>
        /// Updates the ServiceFabricManagedService.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ServiceFabric/managedClusters/{clusterName}/applications/{applicationName}/services/{serviceName}. </description>
        ...
        public virtual async Task<ArmOperation<ServiceFabricManagedServiceResource>> UpdateAsync(WaitUntil waitUntil, ServiceFabricManagedServiceData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _servicesRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, ServiceFabricManagedServiceData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                ServiceFabricManagedClustersArmOperation<ServiceFabricManagedServiceResource> operation = new ServiceFabricManagedClustersArmOperation<ServiceFabricManagedServiceResource>(
                    new ServiceFabricManagedServiceResourceOperationSource(Client),
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<ServiceFabricManagedServiceResource> Update(WaitUntil waitUntil, ServiceFabricManagedServiceData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
