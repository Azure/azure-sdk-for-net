...
{
    /// <summary></summary>
    internal partial class ServiceFabricManagedServiceResourceOperationSource : IOperationSource<ServiceFabricManagedServiceResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal ServiceFabricManagedServiceResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
