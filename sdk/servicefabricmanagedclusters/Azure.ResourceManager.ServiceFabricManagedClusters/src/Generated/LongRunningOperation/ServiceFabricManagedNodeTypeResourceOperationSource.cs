...
{
    /// <summary></summary>
    internal partial class ServiceFabricManagedNodeTypeResourceOperationSource : IOperationSource<ServiceFabricManagedNodeTypeResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal ServiceFabricManagedNodeTypeResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
        ...
        ServiceFabricManagedNodeTypeResource IOperationSource<ServiceFabricManagedNodeTypeResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            ServiceFabricManagedNodeTypeData data = ServiceFabricManagedNodeTypeData.DeserializeServiceFabricManagedNodeTypeData(document.RootElement, ModelSerializationExtensions.WireOptions);
