...
{
    /// <summary></summary>
    internal partial class FaultSimulationOperationSource : IOperationSource<FaultSimulation>
    {
        /// <summary></summary>
        ...
        FaultSimulation IOperationSource<FaultSimulation>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            FaultSimulation result = FaultSimulation.DeserializeFaultSimulation(document.RootElement, ModelSerializationExtensions.WireOptions);
            return result;
        }
