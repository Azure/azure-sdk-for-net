...
{
    /// <summary></summary>
    internal partial class ServiceFabricManagedClusterResourceOperationSource : IOperationSource<ServiceFabricManagedClusterResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal ServiceFabricManagedClusterResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
