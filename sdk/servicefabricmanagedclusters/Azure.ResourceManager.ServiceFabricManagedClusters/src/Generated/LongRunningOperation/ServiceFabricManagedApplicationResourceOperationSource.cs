...
{
    /// <summary></summary>
    internal partial class ServiceFabricManagedApplicationResourceOperationSource : IOperationSource<ServiceFabricManagedApplicationResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal ServiceFabricManagedApplicationResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
