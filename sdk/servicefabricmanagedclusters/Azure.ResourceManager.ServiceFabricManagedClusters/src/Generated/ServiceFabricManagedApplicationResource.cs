...
namespace Azure.ResourceManager.ServiceFabricManagedClusters
{
    ...
    public partial class ServiceFabricManagedApplicationResource : ArmResource
    {
        ...
        /// <summary>
        /// Updates the ServiceFabricManagedApplication.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ServiceFabric/managedClusters/{clusterName}/applications/{applicationName}. </description>
        ...
        public virtual async Task<ArmOperation<ServiceFabricManagedApplicationResource>> UpdateAsync(WaitUntil waitUntil, ServiceFabricManagedApplicationData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _applicationsRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, ServiceFabricManagedApplicationData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                ServiceFabricManagedClustersArmOperation<ServiceFabricManagedApplicationResource> operation = new ServiceFabricManagedClustersArmOperation<ServiceFabricManagedApplicationResource>(
                    new ServiceFabricManagedApplicationResourceOperationSource(Client),
                    _applicationsClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<ServiceFabricManagedApplicationResource> Update(WaitUntil waitUntil, ServiceFabricManagedApplicationData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
