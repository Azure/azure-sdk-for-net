...
namespace Azure.ResourceManager.ServiceFabricManagedClusters
{
    ...
    public partial class ManagedClusterResource : ArmResource
    {
        ...
        {
            return GetCachedClient(Client => new NodeTypeCollection(Client, Id));
        }
        ...
        [ForwardsClientCalls]
        public virtual async Task<Response<NodeTypeResource>> GetNodeTypeAsync(string nodeTypeName, CancellationToken cancellationToken = default)
        {
            return await GetNodeTypes().GetAsync(nodeTypeName, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="nodeTypeName"/> is null. </exception>
        [ForwardsClientCalls]
        public virtual Response<NodeTypeResource> GetNodeType(string nodeTypeName, CancellationToken cancellationToken = default)
        {
            return GetNodeTypes().Get(nodeTypeName, cancellationToken);
        }
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new ServiceFabricManagedClustersArmOperation(_managedClusterClientDiagnostics, Pipeline, _managedClusterRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name).Request, response, OperationFinalStateVia.Location);
        ...
        public virtual async Task<Response<ManagedClusterResource>> UpdateAsync(ManagedClusterPatch patch, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _managedClusterRestClient.UpdateAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, patch, cancellationToken).ConfigureAwait(false);
                return Response.FromValue(new ManagedClusterResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="patch"/> is null. </exception>
        public virtual Response<ManagedClusterResource> Update(ManagedClusterPatch patch, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(patch, nameof(patch));
        ...
        public virtual async Task<Response<ManagedClusterResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    var patch = new ManagedClusterPatch();
