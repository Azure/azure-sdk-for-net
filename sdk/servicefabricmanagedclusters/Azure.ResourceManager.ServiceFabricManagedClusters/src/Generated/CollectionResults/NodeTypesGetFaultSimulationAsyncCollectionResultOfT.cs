...
{
    internal partial class NodeTypesGetFaultSimulationAsyncCollectionResultOfT : AsyncPageable<FaultSimulation>
    {
        ...
        /// <summary> Initializes a new instance of NodeTypesGetFaultSimulationAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public NodeTypesGetFaultSimulationAsyncCollectionResultOfT(NodeTypes client, string subscriptionId, string resourceGroupName, string clusterName, string nodeTypeName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of NodeTypesGetFaultSimulationAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of NodeTypesGetFaultSimulationAsyncCollectionResultOfT as an enumerable collection. </returns>
