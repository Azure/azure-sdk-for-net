...
{
    internal partial class NodeTypeSkusGetAvailableSkusCollectionResultOfT : Pageable<NodeTypeAvailableSku>
    {
        ...
        /// <returns> The pages of NodeTypeSkusGetAvailableSkusCollectionResultOfT as an enumerable collection. </returns>
        public override IEnumerable<Page<NodeTypeAvailableSku>> AsPages(string continuationToken, int? pageSizeHint)
        {
