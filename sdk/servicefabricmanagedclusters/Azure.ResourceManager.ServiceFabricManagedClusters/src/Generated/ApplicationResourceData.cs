...
namespace Azure.ResourceManager.ServiceFabricManagedClusters
{
    ...
    public partial class ApplicationResourceData : TrackedResourceData
    {
        ...
        internal ApplicationResourceData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, ManagedServiceIdentity identity, string provisioningState, string version, IDictionary<string, string> parameters, ApplicationUpgradePolicy upgradePolicy, IList<ApplicationUserAssignedIdentity> managedIdentities) : base(id, name, resourceType, systemData, tags, location)
        {
            Identity = identity;
