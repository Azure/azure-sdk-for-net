...
namespace Azure.Provisioning.ServiceFabricManagedClusters
{
    ...
    public partial class ApplicationResource : ProvisionableResource
    {
        ...
        /// <summary> Creates a new ApplicationResource. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public ApplicationResource(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.ServiceFabric/managedClusters/applications", resourceVersion ?? "2026-02-01")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for ApplicationResource. </summary>
        ...
        /// <summary> Creates a reference to an existing ApplicationResource. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static ApplicationResource FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            ApplicationResource result = new ApplicationResource(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for ApplicationResource that are not part of the generated code. </summary>
