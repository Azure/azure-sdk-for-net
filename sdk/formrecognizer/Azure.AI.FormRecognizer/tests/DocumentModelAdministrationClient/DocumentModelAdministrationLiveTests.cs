...
namespace Azure.AI.FormRecognizer.DocumentAnalysis.Tests
{
    ...
    public class DocumentModelAdministrationLiveTests : DocumentAnalysisLiveTestBase
    {
        ...
        public async Task GetDocumentModels(bool useTokenCredential)
        {
            ...
            await using var disposableModel0 = await BuildDisposableDocumentModelAsync(options: options);
            await using var disposableModel1 = await BuildDisposableDocumentModelAsync(options: options);
        ...
        {
            var client = CreateDocumentModelAdministrationClient(useTokenCredential);
            var disposableModel = await BuildDisposableDocumentModelAsync();
