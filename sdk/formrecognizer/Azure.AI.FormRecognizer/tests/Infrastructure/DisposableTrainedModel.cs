...
namespace Azure.AI.FormRecognizer.Tests
{
    ...
    public class DisposableTrainedModel : IAsyncDisposable
    {
        ...
        public static async Task<DisposableTrainedModel> TrainModelAsync(FormTrainingClient trainingClient, Uri trainingFiles, bool useTrainingLabels)
        {
            TrainingOperation operation = await trainingClient.StartTrainingAsync(trainingFiles, useTrainingLabels);
