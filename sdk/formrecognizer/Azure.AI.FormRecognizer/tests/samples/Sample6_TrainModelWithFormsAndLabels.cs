...
namespace Azure.AI.FormRecognizer.Samples
{
    public partial class FormRecognizerSamples : SamplesBase<FormRecognizerTestEnvironment>
    {
        ...
        public async Task TrainModelWithFormsAndLabels()
        {
            ...
            CustomFormModel model = await client.StartTrainingAsync(new Uri(trainingFileUrl), useTrainingLabels: true, new TrainingOptions() { DisplayName = "My Model with labels" }).WaitForCompletionAsync();
