...
namespace Azure.AI.FormRecognizer.Samples
{
    public partial class FormRecognizerSamples : SamplesBase<FormRecognizerTestEnvironment>
    {
        ...
        public async Task OutputModelsTrainedWithLabels()
        {
            ...
            CustomFormModel modelTrainedWithLabels = await trainingClient.StartTrainingAsync(new Uri(trainingFileUrl), useTrainingLabels: true, new TrainingOptions() { DisplayName = "My Model with labels"} ).WaitForCompletionAsync();
        ...
        public async Task OutputModelsTrainedWithoutLabels()
        {
            ...
            CustomFormModel modelTrainedWithoutLabels = await trainingClient.StartTrainingAsync(new Uri(trainingFileUrl), useTrainingLabels: false, new TrainingOptions() { DisplayName = "My Model" }).WaitForCompletionAsync();
