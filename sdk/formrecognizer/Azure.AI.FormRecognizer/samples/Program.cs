...
namespace Azure.AI.FormRecognizer.Samples
{
    ...
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            await ReproBugLenaReported();
        }

        private static async Task ReproBugLenaReported()
        {
            ...
            string modelId = "c698f3de-9e00-4803-a28d-ab34bbb7c6a2";

            var extractFormOperation = client.StartExtractForm(modelId, new System.Uri("https://uxstudystorage.blob.core.windows.net/testdata/lo1test.jpg?sv=2019-02-02&ss=bqtf&srt=sco&sp=rwdlacup&se=2020-03-12T00:26:59Z&sig=YDsRXRURO3%2BRfmSTKIPhclcV%2BSRbseMe3tWpyktSbbM%3D&_=1583952578979"));
