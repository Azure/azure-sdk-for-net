...
namespace Azure.AI.FormRecognizer
{
    internal partial class FormRecognizerRestClient
    {
        ...
        internal HttpMessage CreateTrainCustomModelAsyncRequest(TrainRequest trainRequest)
        {
            ...
            ((IJsonModel<TrainRequest>)trainRequest).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
        ...
        internal HttpMessage CreateCopyCustomModelRequest(Guid modelId, CopyRequest copyRequest)
        {
            ...
            request.Headers.Add("Content-Type", "application/json");
            var content = new Utf8JsonRequestContent();
            ((IJsonModel<CopyRequest>)copyRequest).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
            request.Content = content;
            return message;
        }
        ...
        internal HttpMessage CreateComposeCustomModelsAsyncRequest(ComposeRequest composeRequest)
        {
            ...
            request.Headers.Add("Content-Type", "application/json");
            var content = new Utf8JsonRequestContent();
            ((IJsonModel<ComposeRequest>)composeRequest).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
            request.Content = content;
            return message;
        }
