...
namespace Azure.AI.FormRecognizer.DocumentAnalysis
{
    ...
    internal partial class BuildDocumentClassifierRequest
    {
        ...
        internal BuildDocumentClassifierRequest(string classifierId, string description, IDictionary<string, ClassifierDocumentTypeDetails> docTypes, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ClassifierId = classifierId;
