...
namespace Azure.AI.FormRecognizer.Training
{
    ...
    public partial class CustomFormModelInfo
    {
        ...
        internal CustomFormModelInfo(string modelId, CustomFormModelStatus status, DateTimeOffset trainingStartedOn, DateTimeOffset trainingCompletedOn, string modelName, CustomFormModelProperties properties, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ModelId = modelId;
            Status = status;
            TrainingStartedOn = trainingStartedOn;
