...
namespace Azure.AI.FormRecognizer.DocumentAnalysis
{
    ...
    internal partial class BuildDocumentModelRequest
    {
        ...
        internal BuildDocumentModelRequest(string modelId, string description, DocumentBuildMode buildMode, AzureBlobContentSource azureBlobSource, AzureBlobFileListSource azureBlobFileListSource, IDictionary<string, string> tags)
        {
            ModelId = modelId;
