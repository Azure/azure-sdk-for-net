...
namespace Azure.AI.FormRecognizer.DocumentAnalysis
{
    ...
    internal partial class BuildDocumentModelRequest
    {
        ...
        internal BuildDocumentModelRequest(string modelId, string description, DocumentBuildMode buildMode, BlobContentSource azureBlobSource, BlobFileListContentSource azureBlobFileListSource, IDictionary<string, string> tags, Dictionary<string, BinaryData> rawData)
        {
            ModelId = modelId;
