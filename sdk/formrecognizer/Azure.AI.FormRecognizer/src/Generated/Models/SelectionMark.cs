...
namespace Azure.AI.FormRecognizer.Models
{
    ...
    internal partial class SelectionMark
    {
        ...
        internal SelectionMark(IReadOnlyList<float> boundingBox, float confidence, SelectionMarkState state, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
