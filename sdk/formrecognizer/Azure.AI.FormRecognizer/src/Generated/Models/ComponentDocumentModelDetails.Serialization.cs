...
namespace Azure.AI.FormRecognizer.DocumentAnalysis
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ComponentDocumentModelDetails>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ComponentDocumentModelDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ComponentDocumentModelDetails>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ComponentDocumentModelDetails>)} interface");
            }
        ...
        string IPersistableModel<ComponentDocumentModelDetails>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
