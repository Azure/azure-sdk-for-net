...
namespace Azure.AI.FormRecognizer.DocumentAnalysis
{
    ...
    public partial class DocumentModelDetails
    {
        ...
        internal DocumentModelDetails(string modelId, string description, DateTimeOffset createdOn, DateTimeOffset? expiresOn, string serviceVersion, IReadOnlyDictionary<string, string> tags, IReadOnlyDictionary<string, DocumentTypeDetails> documentTypes, Dictionary<string, BinaryData> rawData)
        {
            ModelId = modelId;
