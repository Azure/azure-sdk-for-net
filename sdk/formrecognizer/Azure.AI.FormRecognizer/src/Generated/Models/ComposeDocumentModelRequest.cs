...
namespace Azure.AI.FormRecognizer.DocumentAnalysis
{
    ...
    internal partial class ComposeDocumentModelRequest
    {
        ...
        internal ComposeDocumentModelRequest(string modelId, string description, IList<ComponentDocumentModelDetails> componentModels, IDictionary<string, string> tags, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ModelId = modelId;
