...
namespace Azure.AI.FormRecognizer.Models
{
    ...
    internal partial class ReadResult
    {
        ...
        internal ReadResult(int page, float angle, float width, float height, LengthUnit unit, IReadOnlyList<TextLine> lines, IReadOnlyList<SelectionMark> selectionMarks, Dictionary<string, BinaryData> rawData)
        {
            Page = page;
            Angle = angle;
            Width = width;
