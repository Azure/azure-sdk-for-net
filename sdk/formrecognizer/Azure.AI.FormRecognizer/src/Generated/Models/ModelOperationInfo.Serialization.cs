...
namespace Azure.AI.FormRecognizer.DocumentAnalysis
{
    public partial class ModelOperationInfo
    {
        internal static ModelOperationInfo DeserializeModelOperationInfo(JsonElement element)
        {
            ...
            return new ModelOperationInfo(operationId, status, Optional.ToNullable(percentCompleted), createdDateTime, lastUpdatedDateTime, Optional.ToNullable(kind), resourceLocation);
        }
    }
}
