...
namespace Azure.AI.FormRecognizer.DocumentAnalysis
{
    internal partial class AuthorizeCopyRequest : IUtf8JsonSerializable, IJsonModel<AuthorizeCopyRequest>
    {
        ...
        void IJsonModel<AuthorizeCopyRequest>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(AuthorizeCopyRequest)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<AuthorizeCopyRequest>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(AuthorizeCopyRequest)} does not support '{options.Format}' format.");
            }
        }
