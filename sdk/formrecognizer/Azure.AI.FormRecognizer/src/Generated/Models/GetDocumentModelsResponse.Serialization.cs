...
namespace Azure.AI.FormRecognizer.DocumentAnalysis
{
    ...
    {
        internal static GetDocumentModelsResponse DeserializeGetDocumentModelsResponse(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
