...
namespace Azure.AI.FormRecognizer.DocumentAnalysis
{
    public partial class DocumentModelCopyToOperationDetails
    {
        internal static DocumentModelCopyToOperationDetails DeserializeDocumentModelCopyToOperationDetails(JsonElement element)
        {
            ...
            Core.Optional<DocumentModelDetails> result = default;
            ...
            return new DocumentModelCopyToOperationDetails(operationId, status, Core.Optional.ToNullable(percentCompleted), createdDateTime, lastUpdatedDateTime, kind, resourceLocation, apiVersion.Value, Core.Optional.ToDictionary(tags), error, result.Value);
        }
    }
}
