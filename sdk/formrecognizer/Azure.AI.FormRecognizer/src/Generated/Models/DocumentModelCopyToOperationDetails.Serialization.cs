...
namespace Azure.AI.FormRecognizer.DocumentAnalysis
{
    ...
    {
        internal static DocumentModelCopyToOperationDetails DeserializeDocumentModelCopyToOperationDetails(JsonElement element, SerializableOptions options = default)
        {
