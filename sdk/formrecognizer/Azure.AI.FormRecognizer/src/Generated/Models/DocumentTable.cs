...
namespace Azure.AI.FormRecognizer.DocumentAnalysis
{
    ...
    public partial class DocumentTable
    {
        ...
        internal DocumentTable(int rowCount, int columnCount, IReadOnlyList<DocumentTableCell> cells, IReadOnlyList<BoundingRegion> boundingRegions, IReadOnlyList<DocumentSpan> spans, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            RowCount = rowCount;
            ColumnCount = columnCount;
            Cells = cells;
