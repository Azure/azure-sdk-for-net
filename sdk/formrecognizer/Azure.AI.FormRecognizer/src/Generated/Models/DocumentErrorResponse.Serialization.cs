...
namespace Azure.AI.FormRecognizer.DocumentAnalysis
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DocumentErrorResponse>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DocumentErrorResponse>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DocumentErrorResponse>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DocumentErrorResponse>)} interface");
            }
        ...
        string IPersistableModel<DocumentErrorResponse>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
