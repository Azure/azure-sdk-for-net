...
namespace Azure.AI.FormRecognizer.DocumentAnalysis
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DocumentFormula>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DocumentFormula>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DocumentFormula>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DocumentFormula>)} interface");
            }
        ...
        string IPersistableModel<DocumentFormula>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
