...
namespace Azure.AI.FormRecognizer.DocumentAnalysis
{
    public partial class DocumentFormula : IUtf8JsonSerializable, IModelJsonSerializable<DocumentFormula>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<DocumentFormula>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="DocumentFormula"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="DocumentFormula"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="DocumentFormula"/>. </summary>
