...
namespace Azure.AI.FormRecognizer.DocumentAnalysis
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AnalyzeDocumentRequest>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AnalyzeDocumentRequest>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AnalyzeDocumentRequest>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AnalyzeDocumentRequest>)} interface");
            }
        ...
        string IPersistableModel<AnalyzeDocumentRequest>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
