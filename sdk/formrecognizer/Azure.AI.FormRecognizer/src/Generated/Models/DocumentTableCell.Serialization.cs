...
namespace Azure.AI.FormRecognizer.DocumentAnalysis
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DocumentTableCell>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DocumentTableCell>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DocumentTableCell>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DocumentTableCell>)} interface");
            }
        ...
        string IPersistableModel<DocumentTableCell>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
