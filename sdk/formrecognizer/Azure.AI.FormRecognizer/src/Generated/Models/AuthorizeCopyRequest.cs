...
namespace Azure.AI.FormRecognizer.DocumentAnalysis
{
    ...
    internal partial class AuthorizeCopyRequest
    {
        ...
        internal AuthorizeCopyRequest(string modelId, string description, IDictionary<string, string> tags, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ModelId = modelId;
