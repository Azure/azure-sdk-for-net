...
{
    internal partial class SourcePath : IUtf8JsonSerializable, IModelJsonSerializable<SourcePath>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<SourcePath>(this, options.Format);
