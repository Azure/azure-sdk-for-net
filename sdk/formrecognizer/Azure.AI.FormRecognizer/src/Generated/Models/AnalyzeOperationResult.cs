...
namespace Azure.AI.FormRecognizer.Models
{
    ...
    internal partial class AnalyzeOperationResult
    {
        ...
        internal AnalyzeOperationResult(OperationStatus status, DateTimeOffset createdDateTime, DateTimeOffset lastUpdatedDateTime, V2AnalyzeResult analyzeResult, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Status = status;
            CreatedDateTime = createdDateTime;
            LastUpdatedDateTime = lastUpdatedDateTime;
