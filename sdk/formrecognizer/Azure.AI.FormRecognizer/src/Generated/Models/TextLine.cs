...
namespace Azure.AI.FormRecognizer.Models
{
    ...
    internal partial class TextLine
    {
        ...
        internal TextLine(string text, IReadOnlyList<float> boundingBox, IReadOnlyList<TextWord> words, TextAppearance appearance, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Text = text;
