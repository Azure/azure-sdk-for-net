...
namespace Azure.AI.FormRecognizer.DocumentAnalysis
{
    ...
    public partial class DocumentClassifierDetails
    {
        ...
        internal DocumentClassifierDetails(string classifierId, string description, DateTimeOffset createdOn, DateTimeOffset? expiresOn, string serviceVersion, IReadOnlyDictionary<string, ClassifierDocumentTypeDetails> documentTypes, Dictionary<string, BinaryData> rawData)
        {
            ClassifierId = classifierId;
