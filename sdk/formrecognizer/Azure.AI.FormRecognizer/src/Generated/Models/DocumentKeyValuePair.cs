...
namespace Azure.AI.FormRecognizer.DocumentAnalysis
{
    ...
    public partial class DocumentKeyValuePair
    {
        ...
        internal DocumentKeyValuePair(DocumentKeyValueElement key, DocumentKeyValueElement value, float confidence, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Key = key;
            Value = value;
            Confidence = confidence;
