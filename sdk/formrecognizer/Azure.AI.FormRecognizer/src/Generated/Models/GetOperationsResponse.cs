...
namespace Azure.AI.FormRecognizer.DocumentAnalysis
{
    ...
    internal partial class GetOperationsResponse
    {
        ...
        internal GetOperationsResponse(IEnumerable<DocumentModelOperationSummary> value)
        {
            if (value == null)
            {
        ...
        internal GetOperationsResponse(IReadOnlyList<DocumentModelOperationSummary> value, string nextLink)
        {
            Value = value;
            NextLink = nextLink;
        }
        ...
        public IReadOnlyList<DocumentModelOperationSummary> Value { get; }
