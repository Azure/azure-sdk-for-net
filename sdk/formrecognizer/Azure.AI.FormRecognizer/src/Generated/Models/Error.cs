...
namespace Azure.AI.FormRecognizer.DocumentAnalysis
{
    ...
    internal partial class Error
    {
        ...
        internal Error(string code, string message, string target, IReadOnlyList<Error> details, InnerError innererror, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Code = code;
            Message = message;
            Target = target;
