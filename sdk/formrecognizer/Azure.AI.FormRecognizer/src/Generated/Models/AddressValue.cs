...
namespace Azure.AI.FormRecognizer.DocumentAnalysis
{
    ...
    public partial class AddressValue
    {
        ...
        internal AddressValue(string houseNumber, string poBox, string road, string city, string state, string postalCode, string countryRegion, string streetAddress, string unit, string cityDistrict, string stateDistrict, string suburb, string house, string level, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
