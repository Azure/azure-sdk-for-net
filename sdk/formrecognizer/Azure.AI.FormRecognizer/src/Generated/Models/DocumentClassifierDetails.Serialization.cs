...
namespace Azure.AI.FormRecognizer.DocumentAnalysis
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DocumentClassifierDetails>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DocumentClassifierDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DocumentClassifierDetails>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DocumentClassifierDetails>)} interface");
            }
        ...
        string IPersistableModel<DocumentClassifierDetails>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
