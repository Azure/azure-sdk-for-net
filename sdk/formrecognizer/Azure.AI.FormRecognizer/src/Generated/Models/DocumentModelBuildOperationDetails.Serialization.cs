...
namespace Azure.AI.FormRecognizer.DocumentAnalysis
{
    public partial class DocumentModelBuildOperationDetails : IUtf8JsonSerializable, IModelJsonSerializable<DocumentModelBuildOperationDetails>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<DocumentModelBuildOperationDetails>(this, options.Format);
        ...
        internal static DocumentModelBuildOperationDetails DeserializeDocumentModelBuildOperationDetails(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new DocumentModelBuildOperationDetails(operationId, status, Optional.ToNullable(percentCompleted), createdDateTime, lastUpdatedDateTime, kind, resourceLocation, apiVersion.Value, Optional.ToDictionary(tags), error, result.Value, serializedAdditionalRawData);
        }
