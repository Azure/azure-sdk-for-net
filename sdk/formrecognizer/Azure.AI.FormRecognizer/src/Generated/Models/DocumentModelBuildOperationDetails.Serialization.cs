...
namespace Azure.AI.FormRecognizer.DocumentAnalysis
{
    ...
    {
        internal static DocumentModelBuildOperationDetails DeserializeDocumentModelBuildOperationDetails(JsonElement element, SerializableOptions options = default)
        {
