...
namespace Azure.AI.FormRecognizer.DocumentAnalysis
{
    public partial class DocumentModelBuildOperationDetails
    {
        internal static DocumentModelBuildOperationDetails DeserializeDocumentModelBuildOperationDetails(JsonElement element)
        {
            ...
            return new DocumentModelBuildOperationDetails(operationId, status, Core.Optional.ToNullable(percentCompleted), createdDateTime, lastUpdatedDateTime, kind, resourceLocation, apiVersion.Value, Core.Optional.ToDictionary(tags), error, result.Value);
        }
    }
}
