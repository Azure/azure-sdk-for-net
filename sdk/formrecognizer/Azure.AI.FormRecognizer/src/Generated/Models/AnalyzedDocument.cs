...
namespace Azure.AI.FormRecognizer.DocumentAnalysis
{
    ...
    public partial class AnalyzedDocument
    {
        ...
        internal AnalyzedDocument(string documentType, IReadOnlyList<BoundingRegion> boundingRegions, IReadOnlyList<DocumentSpan> spans, IReadOnlyDictionary<string, DocumentField> fields, float confidence, Dictionary<string, BinaryData> rawData)
        {
            DocumentType = documentType;
