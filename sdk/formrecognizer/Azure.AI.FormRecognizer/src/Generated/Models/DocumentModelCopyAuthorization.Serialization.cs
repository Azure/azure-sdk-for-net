...
namespace Azure.AI.FormRecognizer.DocumentAnalysis
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DocumentModelCopyAuthorization>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DocumentModelCopyAuthorization>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DocumentModelCopyAuthorization>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<DocumentModelCopyAuthorization>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
