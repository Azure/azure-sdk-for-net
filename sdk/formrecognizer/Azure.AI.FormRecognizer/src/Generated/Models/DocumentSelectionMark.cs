...
namespace Azure.AI.FormRecognizer.DocumentAnalysis
{
    ...
    public partial class DocumentSelectionMark
    {
        ...
        internal DocumentSelectionMark(V3SelectionMarkState statePrivate, IReadOnlyList<float> polygon, DocumentSpan span, float confidence, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            StatePrivate = statePrivate;
            Polygon = polygon;
            Span = span;
