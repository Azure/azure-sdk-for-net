...
namespace Azure.AI.FormRecognizer.DocumentAnalysis
{
    ...
    public partial class DocumentBarcode
    {
        ...
        internal DocumentBarcode(DocumentBarcodeKind kind, string value, IReadOnlyList<float> polygon, DocumentSpan span, float confidence, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Kind = kind;
            Value = value;
            Polygon = polygon;
