...
namespace Azure.AI.FormRecognizer.DocumentAnalysis
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BlobContentSource>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<BlobContentSource>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BlobContentSource>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<BlobContentSource>)} interface");
            }
        ...
        string IPersistableModel<BlobContentSource>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
