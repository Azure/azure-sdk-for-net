...
namespace Azure.AI.FormRecognizer.Models
{
    internal partial class Model
    {
        internal static Model DeserializeModel(JsonElement element)
        {
            ...
            Core.Optional<KeysResult> keys = default;
            Core.Optional<TrainResult> trainResult = default;
            Core.Optional<IReadOnlyList<TrainResult>> composedTrainResults = default;
            ...
            return new Model(modelInfo, keys.Value, trainResult.Value, Core.Optional.ToList(composedTrainResults));
        }
    }
}
