...
namespace Azure.AI.FormRecognizer.DocumentAnalysis
{
    ...
    public partial class DocumentWord
    {
        ...
        internal DocumentWord(string content, IReadOnlyList<float> polygon, DocumentSpan span, float confidence, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Content = content;
            Polygon = polygon;
            Span = span;
