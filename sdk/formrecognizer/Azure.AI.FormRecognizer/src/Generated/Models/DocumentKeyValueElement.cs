...
namespace Azure.AI.FormRecognizer.DocumentAnalysis
{
    ...
    public partial class DocumentKeyValueElement
    {
        ...
        internal DocumentKeyValueElement(string content, IReadOnlyList<BoundingRegion> boundingRegions, IReadOnlyList<DocumentSpan> spans, Dictionary<string, BinaryData> rawData)
        {
            Content = content;
