...
namespace Azure.AI.FormRecognizer.DocumentAnalysis
{
    ...
    public partial class DocumentTableCell
    {
        ...
        internal DocumentTableCell(DocumentTableCellKind? kindPrivate, int rowIndex, int columnIndex, int? rowSpanPrivate, int? columnSpanPrivate, string content, IReadOnlyList<BoundingRegion> boundingRegions, IReadOnlyList<DocumentSpan> spans, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
