...
namespace Azure.AI.FormRecognizer.Models
{
    ...
    internal partial class V2AnalyzeResult
    {
        ...
        internal V2AnalyzeResult(string version, IReadOnlyList<ReadResult> readResults, IReadOnlyList<PageResult> pageResults, IReadOnlyList<DocumentResult> documentResults, IReadOnlyList<FormRecognizerError> errors, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Version = version;
