...
namespace Azure.AI.FormRecognizer.Models
{
    ...
    internal partial class Models
    {
        ...
        internal Models(ModelsSummary summary, IReadOnlyList<CustomFormModelInfo> modelList, string nextLink, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Summary = summary;
            ModelList = modelList;
            NextLink = nextLink;
