...
namespace Azure.AI.FormRecognizer.Models
{
    ...
    internal partial class KeyValueElement
    {
        ...
        internal KeyValueElement(KeyValueType? type, string text, IReadOnlyList<float> boundingBox, IReadOnlyList<string> elements, Dictionary<string, BinaryData> rawData)
        {
            Type = type;
            Text = text;
