...
namespace Azure.AI.FormRecognizer.DocumentAnalysis
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AnalyzeResultOperation>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AnalyzeResultOperation>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AnalyzeResultOperation>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AnalyzeResultOperation>)} interface");
            }
        ...
        string IPersistableModel<AnalyzeResultOperation>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
