...
namespace Azure.AI.FormRecognizer.Training
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CustomFormModelField>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CustomFormModelField>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CustomFormModelField>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<CustomFormModelField>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
