...
namespace Azure.AI.FormRecognizer.DocumentAnalysis
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BlobFileListContentSource>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<BlobFileListContentSource>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BlobFileListContentSource>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<BlobFileListContentSource>)} interface");
            }
        ...
        string IPersistableModel<BlobFileListContentSource>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
