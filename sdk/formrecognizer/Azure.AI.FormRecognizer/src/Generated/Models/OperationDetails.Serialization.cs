...
{
    public partial class OperationDetails : IUtf8JsonSerializable, IModelJsonSerializable<OperationDetails>
    {
        ...
        internal static OperationDetails DeserializeOperationDetails(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new UnknownOperationDetails(operationId, status, Optional.ToNullable(percentCompleted), createdDateTime, lastUpdatedDateTime, kind, resourceLocation, apiVersion.Value, Optional.ToDictionary(tags), error, rawData);
        }
        ...
        /// <summary> Converts a <see cref="OperationDetails"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="OperationDetails"/> to convert. </param>
        public static implicit operator RequestContent(OperationDetails model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="OperationDetails"/>. </summary>
        ...
        public static explicit operator OperationDetails(Response response)
        {
            ...
            return DeserializeOperationDetails(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
