...
namespace Azure.AI.FormRecognizer.Training
{
    ...
    public partial class TrainingDocumentInfo
    {
        ...
        internal TrainingDocumentInfo(string name, int pageCount, IReadOnlyList<FormRecognizerError> errors, TrainingStatus status, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            PageCount = pageCount;
            Errors = errors;
