...
namespace Azure.AI.FormRecognizer.Training
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CustomFormModelProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CustomFormModelProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CustomFormModelProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CustomFormModelProperties>)} interface");
            }
        ...
        string IPersistableModel<CustomFormModelProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
