...
namespace Azure.AI.FormRecognizer.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FieldValue_internal>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<FieldValue_internal>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<FieldValue_internal>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<FieldValue_internal>)} interface");
            }
        ...
        string IPersistableModel<FieldValue_internal>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
