...
namespace Azure.AI.FormRecognizer
{
    ...
    {
        private static readonly JsonSerializerOptions s_options = new JsonSerializerOptions { Converters = { new JsonModelConverter(WireOptions, AzureAIFormRecognizerContext.Default) } };
