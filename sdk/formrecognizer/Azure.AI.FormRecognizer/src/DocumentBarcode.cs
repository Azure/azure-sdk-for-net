...
namespace Azure.AI.FormRecognizer.DocumentAnalysis
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of DocumentBarcode. Used for the <see cref="DocumentAnalysisModelFactory"/>.
        /// </summary>
        internal DocumentBarcode(DocumentBarcodeKind kind, string value, IReadOnlyList<PointF> boundingPolygon, DocumentSpan span, float confidence)
        {
            Kind = kind;
            Value = value;
        ...
        /// <summary>
        /// The polygon that outlines the content of this barcode. Coordinates are specified relative to the
