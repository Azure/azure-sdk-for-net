...
namespace Azure.AI.FormRecognizer.Training
{
    /// <summary>
    /// </summary>
    public class ComposeModelOperation : Operation<CustomFormModel>
    {
        ...
        public ComposeModelOperation(string operationId, FormRecognizerClient client, CancellationToken cancellationToken = default)
        {
            Id = operationId;
...
#pragma warning disable CA1801 // Remove unused parameter
        private static CustomFormModel ConvertToExtractedReceipts(IList<DocumentResult_internal> documentResults, IList<ReadResult_internal> readResults)
