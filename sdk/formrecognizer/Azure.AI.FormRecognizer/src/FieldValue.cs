...
namespace Azure.AI.FormRecognizer.Models
{
    ...
    public readonly struct FieldValue
    {
        ...
        /// </summary>
        /// <param name="value">The actual field value.</param>
        internal FieldValue(FieldValueSelectionMark value)
            : this()
        {
        ...
        /// <see cref="_fieldValue"/>, so this property is exclusively used for mocking.
        /// </summary>
        private FieldValueSelectionMark ValueSelectionMark { get; }
        ...
        /// <summary>
        /// Gets the value of the field as a <see cref="FieldValueSelectionMark"/>.
        /// </summary>
        /// <returns>The value of the field converted to <see cref="FieldValueSelectionMark"/>.</returns>
