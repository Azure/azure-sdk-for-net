...
namespace Azure.AI.FormRecognizer.Models
{
    /// <summary>
    /// </summary>
    public class RecognizedPageContent
    {
        internal RecognizedPageContent(PageResult_internal pageResult, ReadResult_internal readResult)
        {
            ...
            if (readResult != null)
            {
                ...
                TextElements = new PageTextElements(readResult);
            }
        }
        ...
        /// <summary>
        /// </summary>
        public PageTextElements TextElements { get; }
