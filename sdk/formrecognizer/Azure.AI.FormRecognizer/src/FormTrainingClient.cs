...
namespace Azure.AI.FormRecognizer.Training
{
    ...
    public class FormTrainingClient
    {
        ...
        [ForwardsClientCalls]
        public virtual TrainingOperation StartTraining(Uri trainingFiles, bool useTrainingLabels = false, TrainingFileFilter filter = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(trainingFiles, nameof(trainingFiles));

            var trainRequest = new TrainRequest_internal(trainingFiles.AbsoluteUri, filter, useTrainingLabels);
        ...
        /// completion will contain meta-data about the trained model.</returns>
        [ForwardsClientCalls]
        public virtual async Task<TrainingOperation> StartTrainingAsync(Uri trainingFiles, bool useTrainingLabels = false, TrainingFileFilter filter = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(trainingFiles, nameof(trainingFiles));
