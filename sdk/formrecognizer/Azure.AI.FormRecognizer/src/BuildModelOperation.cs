...
namespace Azure.AI.FormRecognizer.DocumentAnalysis
{
    ...
    /// </summary>
    public class BuildModelOperation : Operation<DocumentModel>, IOperationStatePoller<DocumentModel>
    {
        ...
        public BuildModelOperation(string operationId, DocumentModelAdministrationClient client)
        {
            ...
            _operationImplementation = new(_diagnostics, this, rawResponse: null, nameof(BuildModelOperation));
        }
