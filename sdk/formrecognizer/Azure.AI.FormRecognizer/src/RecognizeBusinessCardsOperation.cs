...
namespace Azure.AI.FormRecognizer.Models
{
    ...
    /// </summary>
    public class RecognizeBusinessCardsOperation : Operation<RecognizedFormCollection>
    {
...
#pragma warning restore CA1065 // Do not raise exceptions in unexpected locations
        ...
        /// An instance of <see cref="RecognizeBusinessCardsOperation"/> sends requests to a server in UpdateStatusAsync, UpdateStatus, and other methods.
        ...
        private async ValueTask<Response> UpdateStatusAsync(bool async, CancellationToken cancellationToken)
        {
            if (!_hasCompleted)
            {
                using DiagnosticScope scope = _diagnostics.CreateScope($"{nameof(RecognizeBusinessCardsOperation)}.{nameof(UpdateStatus)}");
                scope.Start();
