...
Install the Azure.ResourceManager.SreAgent management library for .NET with [NuGet](https://www.nuget.org/):

```dotnetcli
dotnet add package Azure.ResourceManager.SreAgent --prerelease
```
