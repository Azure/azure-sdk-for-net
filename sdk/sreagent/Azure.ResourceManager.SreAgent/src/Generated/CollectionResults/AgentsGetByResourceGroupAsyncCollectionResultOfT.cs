...
namespace Azure.ResourceManager.SreAgent
{
    internal partial class AgentsGetByResourceGroupAsyncCollectionResultOfT : AsyncPageable<SreAgentData>
    {
        ...
        /// <summary> Initializes a new instance of AgentsGetByResourceGroupAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public AgentsGetByResourceGroupAsyncCollectionResultOfT(Agents client, Guid subscriptionId, string resourceGroupName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of AgentsGetByResourceGroupAsyncCollectionResultOfT as an enumerable collection. </summary>
