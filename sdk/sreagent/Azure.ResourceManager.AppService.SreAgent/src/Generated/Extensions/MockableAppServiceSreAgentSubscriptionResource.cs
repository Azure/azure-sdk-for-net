...
namespace Azure.ResourceManager.AppService.SreAgent.Mocking
{
    ...
    public partial class MockableAppServiceSreAgentSubscriptionResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of MockableAppServiceSreAgentSubscriptionResource for mocking. </summary>
        protected MockableAppServiceSreAgentSubscriptionResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="MockableAppServiceSreAgentSubscriptionResource"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MockableAppServiceSreAgentSubscriptionResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        private SupportedAgentModels SupportedAgentModelsRestClient => _supportedAgentModelsRestClient ??= new SupportedAgentModels(SupportedAgentModelsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, "2026-01-01");
