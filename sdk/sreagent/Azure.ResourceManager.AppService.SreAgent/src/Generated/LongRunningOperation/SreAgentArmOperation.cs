...
{
    internal partial class SreAgentArmOperation : ArmOperation
    {
        ...
        /// <summary> Initializes a new instance of SreAgentArmOperation for mocking. </summary>
        protected SreAgentArmOperation()
        {
        }
        ...
        internal SreAgentArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal SreAgentArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
