# ARM provider schema comparison: Azure.ResourceManager.RedHatOpenShift
...
| --- | --- | --- |
| `/subscriptions/{subscriptionId}/providers/Microsoft.RedHatOpenShift/locations/{location}/openShiftVersions/{openShiftVersion}` | `OpenShiftVersion` | `LocationsOpenShiftVersions` |
| `/subscriptions/{subscriptionId}/providers/Microsoft.RedHatOpenShift/locations/{location}/platformWorkloadIdentityRoleSets/{openShiftMinorVersion}` | `OpenShiftPlatformWorkloadIdentityRoleSet` | `LocationsPlatformWorkloadIdentityRoleSets` |
