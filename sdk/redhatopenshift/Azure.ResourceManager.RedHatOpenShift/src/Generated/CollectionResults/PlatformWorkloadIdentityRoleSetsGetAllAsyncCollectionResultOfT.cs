...
namespace Azure.ResourceManager.RedHatOpenShift
{
    internal partial class PlatformWorkloadIdentityRoleSetsGetAllAsyncCollectionResultOfT : AsyncPageable<OpenShiftPlatformWorkloadIdentityRoleSetData>
    {
        ...
        /// <summary> Initializes a new instance of PlatformWorkloadIdentityRoleSetsGetAllAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        /// <param name="client"> The PlatformWorkloadIdentityRoleSets client used to send requests. </param>
        /// <param name="subscriptionId"> The ID of the target subscription. The value must be an UUID. </param>
        /// <param name="location"> The name of the Azure region. </param>
        /// <param name="context"> The request options, which can override default behaviors of the client pipeline on a per-call basis. </param>
        /// <param name="diagnosticScope"> The diagnostic scope name. </param>
        public PlatformWorkloadIdentityRoleSetsGetAllAsyncCollectionResultOfT(PlatformWorkloadIdentityRoleSets client, Guid subscriptionId, AzureLocation location, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of PlatformWorkloadIdentityRoleSetsGetAllAsyncCollectionResultOfT as an enumerable collection. </summary>
