...
namespace Azure.ResourceManager.RedHatOpenShift
{
    internal partial class PlatformWorkloadIdentityRoleSetsGetAllCollectionResultOfT : Pageable<PlatformWorkloadIdentityRoleSetData>
    {
        ...
        /// <summary> Initializes a new instance of PlatformWorkloadIdentityRoleSetsGetAllCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public PlatformWorkloadIdentityRoleSetsGetAllCollectionResultOfT(PlatformWorkloadIdentityRoleSets client, Guid subscriptionId, AzureLocation location, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of PlatformWorkloadIdentityRoleSetsGetAllCollectionResultOfT as an enumerable collection. </summary>
