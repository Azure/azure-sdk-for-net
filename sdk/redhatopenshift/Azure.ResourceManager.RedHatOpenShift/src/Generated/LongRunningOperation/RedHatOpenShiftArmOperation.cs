...
#pragma warning disable SA1649 // File name should match first type name
    internal class RedHatOpenShiftArmOperation : ArmOperation
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        internal RedHatOpenShiftArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal RedHatOpenShiftArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal(nextLinkOperation, clientDiagnostics, response, "RedHatOpenShiftArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
