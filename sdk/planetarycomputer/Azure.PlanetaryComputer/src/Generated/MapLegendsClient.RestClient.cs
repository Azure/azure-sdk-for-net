...
namespace Customizations
{
    ...
    public partial class MapLegendsClient
    {
        ...
        internal HttpMessage CreateGetClassmapLegendRequest(string classmapName, int? trimStart, int? trimEnd, RequestContext context)
        {
            ...
            if (trimStart != null)
            {
                uri.AppendQuery("trim_start", Microsoft.PlanetaryComputer.TypeFormatters.ConvertToString(trimStart, null), true);
            }
            if (trimEnd != null)
            {
                uri.AppendQuery("trim_end", Microsoft.PlanetaryComputer.TypeFormatters.ConvertToString(trimEnd, null), true);
            }
            request.Uri = uri;
