...
namespace Azure.PlanetaryComputer
{
    ...
    public partial class RenderOptionModel
    {
        ...
        internal RenderOptionModel(string id, string name, string description, RenderOptionType? type, string options, RenderOptionVectorOptions vectorOptions, int? minZoom, RenderOptionLegend legend, IList<RenderOptionCondition> conditions, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Name = name;
