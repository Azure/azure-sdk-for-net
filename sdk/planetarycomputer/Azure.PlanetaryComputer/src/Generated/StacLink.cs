...
namespace Azure.PlanetaryComputer
{
    ...
    public partial class StacLink
    {
        ...
        internal StacLink(string rel, string title, LinkType? type, string href, string hreflang, int? length, LinkMethod? method, IDictionary<string, string> headers, IDictionary<string, BinaryData> body, bool? merge, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Rel = rel;
            Title = title;
            Type = type;
