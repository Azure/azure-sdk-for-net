...
namespace Azure.Analytics.PlanetaryComputer
{
    ...
    internal partial class PageIngestionRun : IJsonModel<PageIngestionRun>
    {
        ...
        /// <param name="result"> The <see cref="Response"/> to deserialize the <see cref="PageIngestionRun"/> from. </param>
        public static explicit operator PageIngestionRun(Response result)
        {
