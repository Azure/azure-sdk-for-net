...
namespace Azure.Analytics.PlanetaryComputer
{
    ...
    internal partial class PageIngestionDefinition : IJsonModel<PageIngestionDefinition>
    {
        ...
        /// <param name="result"> The <see cref="Response"/> to deserialize the <see cref="PageIngestionDefinition"/> from. </param>
        public static explicit operator PageIngestionDefinition(Response result)
        {
