...
namespace Azure.Analytics.PlanetaryComputer
{
    ...
    public partial class GetWmtsCapabilitiesOptions
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="GetWmtsCapabilitiesOptions"/>. </summary>
        ...
        internal GetWmtsCapabilitiesOptions(IList<string> assets, string expression, IList<string> assetBandIndices, bool? assetAsBand, float? noData, bool? unscale, TerrainAlgorithm? algorithm, string algorithmParams, TilerImageFormat? tileFormat, int? tileScale, int? minZoom, int? maxZoom, string buffer, string colorFormula, ResamplingMethod? resampling, IList<string> rescale, ColorMapNames? colorMapName, string colorMap, bool? returnMask, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Assets = assets;
