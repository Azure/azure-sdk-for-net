...
namespace Azure.Analytics.PlanetaryComputer
{
    ...
    public partial class GetPartOptions
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="GetPartOptions"/>. </summary>
        ...
        internal GetPartOptions(IList<string> assets, string expression, IList<string> assetBandIndices, bool? assetAsBand, float? noData, bool? unscale, TerrainAlgorithm? algorithm, string algorithmParams, string colorFormula, string coordinateReferenceSystem, string dstCrs, ResamplingMethod? resampling, int? maxSize, IList<string> rescale, ColorMapNames? colorMapName, string colorMap, bool? returnMask, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Assets = assets;
