...
{
    internal partial class IngestionClientGetAllCollectionResultOfT : Pageable<IngestionDefinition>
    {
        ...
        /// <summary> Initializes a new instance of IngestionClientGetAllCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public IngestionClientGetAllCollectionResultOfT(IngestionClient client, string collectionId, int? top, int? skip, RequestContext context) : base(context?.CancellationToken ?? default)
        {
        ...
        /// <summary> Gets the pages of IngestionClientGetAllCollectionResultOfT as an enumerable collection. </summary>
