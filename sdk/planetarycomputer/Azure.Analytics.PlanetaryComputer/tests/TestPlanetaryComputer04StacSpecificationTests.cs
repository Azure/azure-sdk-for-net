...
namespace Azure.Analytics.PlanetaryComputer.Tests
{
    ...
    public class TestPlanetaryComputer04StacSpecificationTests : PlanetaryComputerTestBase
    {
        ...
        /// C# method: GetConformanceClasses()
        /// </summary>
        [Test]
        [Category("STAC")]
        ...
        public async Task Test04_12_GetItem()
        {
            ...
            Response<StacItemCollection> itemsResponse = await stacClient.GetItemCollectionAsync(new GetItemCollectionOptions(collectionId) { Limit = 1 });
