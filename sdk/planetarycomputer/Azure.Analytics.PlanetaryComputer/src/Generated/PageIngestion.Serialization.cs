...
namespace Azure.Analytics.PlanetaryComputer
{
    ...
    public partial class PageIngestion : IJsonModel<PageIngestion>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            foreach (IngestionConfiguration item in Value)
            {
        ...
        internal static PageIngestion DeserializePageIngestion(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            IList<IngestionConfiguration> value = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    List<IngestionConfiguration> array = new List<IngestionConfiguration>();
                    foreach (var item in prop.Value.EnumerateArray())
                    {
                        array.Add(IngestionConfiguration.DeserializeIngestionConfiguration(item, options));
                    }
                    value = array;
                    continue;
                }
