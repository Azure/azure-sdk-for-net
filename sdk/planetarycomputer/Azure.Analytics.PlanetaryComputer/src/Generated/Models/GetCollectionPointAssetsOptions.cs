...
namespace Azure.Analytics.PlanetaryComputer
{
    ...
    public partial class GetCollectionPointAssetsOptions
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="GetCollectionPointAssetsOptions"/>. </summary>
        ...
        internal GetCollectionPointAssetsOptions(int? scanLimit, int? itemsLimit, int? timeLimit, bool? exitWhenFull, bool? skipCovered, string ids, string bbox, string query, string sortBy, string datetime, string subdatasetName, IList<int> subdatasetBands, string crs, IList<string> sel, SelMethod? selMethod, string collectionId, float longitude, float latitude, string coordinateReferenceSystem, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            ScanLimit = scanLimit;
