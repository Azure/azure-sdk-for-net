...
namespace Azure.Analytics.PlanetaryComputer
{
    ...
    public partial class GetItemAvailableAssetsOptions
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="GetItemAvailableAssetsOptions"/>. </summary>
        ...
        internal GetItemAvailableAssetsOptions(string collectionId, string itemId, string subdatasetName, IList<int> subdatasetBands, string crs, string datetime, IList<string> sel, SelMethod? selMethod, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            CollectionId = collectionId;
            ItemId = itemId;
