...
namespace Azure.Analytics.PlanetaryComputer
{
    ...
    public partial class GetItemInfoOptions
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="GetItemInfoOptions"/>. </summary>
        ...
        internal GetItemInfoOptions(string collectionId, string itemId, string subdatasetName, IList<int> subdatasetBands, string crs, string datetime, IList<string> sel, SelMethod? selMethod, IList<string> assets, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            CollectionId = collectionId;
            ItemId = itemId;
