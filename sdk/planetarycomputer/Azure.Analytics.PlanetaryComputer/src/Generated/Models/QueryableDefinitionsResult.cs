...
namespace Azure.Analytics.PlanetaryComputer
{
    ...
    public partial class QueryableDefinitionsResult
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="QueryableDefinitionsResult"/>. </summary>
        ...
        internal QueryableDefinitionsResult(IReadOnlyDictionary<string, BinaryData> additionalProperties)
        {
