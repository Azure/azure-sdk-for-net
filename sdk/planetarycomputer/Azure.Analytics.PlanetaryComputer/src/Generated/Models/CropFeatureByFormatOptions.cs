...
namespace Azure.Analytics.PlanetaryComputer
{
    ...
    public partial class CropFeatureByFormatOptions
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="CropFeatureByFormatOptions"/>. </summary>
        ...
        internal CropFeatureByFormatOptions(IList<int> bidx, IList<string> assets, string expression, IList<string> assetBandIndices, bool? assetAsBand, string noData, bool? unscale, WarpKernelResampling? reproject, TerrainAlgorithm? algorithm, string algorithmParams, string collectionId, string itemId, string format, string colorFormula, string coordinateReferenceSystem, ResamplingMethod? resampling, int? maxSize, int? height, int? width, IList<string> rescale, ColorMapNames? colorMapName, string colorMap, bool? returnMask, string destinationCrs, string subdatasetName, IList<int> subdatasetBands, string crs, string datetime, IList<string> sel, SelMethod? selMethod, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Bidx = bidx;
            Assets = assets;
