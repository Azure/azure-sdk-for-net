...
namespace Azure.Analytics.PlanetaryComputer
{
    ...
    public partial class GetItemWmtsCapabilitiesByTmsOptions
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="GetItemWmtsCapabilitiesByTmsOptions"/>. </summary>
        ...
        internal GetItemWmtsCapabilitiesByTmsOptions(IList<int> bidx, IList<string> assets, string expression, IList<string> assetBandIndices, bool? assetAsBand, string noData, bool? unscale, WarpKernelResampling? reproject, TerrainAlgorithm? algorithm, string algorithmParams, string collectionId, string itemId, string tileMatrixSetId, TilerImageFormat? tileFormat, int? tileScale, int? minZoom, int? maxZoom, float? buffer, string colorFormula, ResamplingMethod? resampling, IList<string> rescale, ColorMapNames? colorMapName, string colorMap, bool? returnMask, int? padding, string subdatasetName, IList<int> subdatasetBands, string crs, string datetime, IList<string> sel, SelMethod? selMethod, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Bidx = bidx;
            Assets = assets;
