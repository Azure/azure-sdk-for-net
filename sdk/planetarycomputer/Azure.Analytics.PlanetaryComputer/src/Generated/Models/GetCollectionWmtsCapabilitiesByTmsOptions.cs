...
namespace Azure.Analytics.PlanetaryComputer
{
    ...
    public partial class GetCollectionWmtsCapabilitiesByTmsOptions
    {
        ...
        /// <summary> Initializes a new instance of <see cref="GetCollectionWmtsCapabilitiesByTmsOptions"/>. </summary>
        ...
        internal GetCollectionWmtsCapabilitiesByTmsOptions(string ids, string bbox, string query, string sortBy, string datetime, string collectionId, string tileMatrixSetId, TilerImageFormat? tileFormat, int? tileScale, int? minZoom, int? maxZoom, IList<int> bidx, IList<string> assets, string expression, IList<string> assetBandIndices, bool? assetAsBand, string noData, bool? unscale, WarpKernelResampling? reproject, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Ids = ids;
            Bbox = bbox;
            Query = query;
