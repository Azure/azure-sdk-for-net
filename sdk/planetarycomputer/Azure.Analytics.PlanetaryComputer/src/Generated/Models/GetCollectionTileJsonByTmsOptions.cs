...
namespace Azure.Analytics.PlanetaryComputer
{
    ...
    public partial class GetCollectionTileJsonByTmsOptions
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="GetCollectionTileJsonByTmsOptions"/>. </summary>
        ...
        internal GetCollectionTileJsonByTmsOptions(string collectionId, string tileMatrixSetId, IList<int> bidx, IList<string> assets, string expression, IList<string> assetBandIndices, bool? assetAsBand, string noData, bool? unscale, WarpKernelResampling? reproject, int? scanLimit, int? itemsLimit, int? timeLimit, bool? exitWhenFull, bool? skipCovered, string ids, string bbox, string query, string sortBy, string datetime, string subdatasetName, IList<int> subdatasetBands, string crs, IList<string> sel, SelMethod? selMethod, TerrainAlgorithm? algorithm, string algorithmParams, TilerImageFormat? tileFormat, int? tileScale, int? minZoom, int? maxZoom, float? buffer, string colorFormula, string collection, ResamplingMethod? resampling, PixelSelection? pixelSelection, IList<string> rescale, ColorMapNames? colorMapName, string colorMap, bool? returnMask, int? padding, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            CollectionId = collectionId;
            TileMatrixSetId = tileMatrixSetId;
            Bidx = bidx;
