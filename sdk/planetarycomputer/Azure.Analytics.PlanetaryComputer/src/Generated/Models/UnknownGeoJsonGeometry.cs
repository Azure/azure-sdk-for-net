...
namespace Azure.Analytics.PlanetaryComputer
{
    internal partial class UnknownGeoJsonGeometry : GeoJsonGeometry
    {
        ...
        internal UnknownGeoJsonGeometry(GeometryKind @type, IList<float> boundingBox, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(@type != default ? @type : "unknown", boundingBox, additionalBinaryDataProperties)
        {
        }
    }
}
