...
namespace Azure.Analytics.PlanetaryComputer
{
    ...
    public partial class GetCollectionTileByScaleAndFormatOptions
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="GetCollectionTileByScaleAndFormatOptions"/>. </summary>
        ...
        internal GetCollectionTileByScaleAndFormatOptions(IList<int> bidx, IList<string> assets, string expression, IList<string> assetBandIndices, bool? assetAsBand, string noData, bool? unscale, WarpKernelResampling? reproject, int? scanLimit, int? itemsLimit, int? timeLimit, bool? exitWhenFull, bool? skipCovered, string ids, string bbox, string query, string sortBy, string datetime, string subdatasetName, IList<int> subdatasetBands, string crs, IList<string> sel, SelMethod? selMethod, TerrainAlgorithm? algorithm, string algorithmParams, string collectionId, string tileMatrixSetId, float z, float x, float y, float scale, string format, float? buffer, string colorFormula, string collection, ResamplingMethod? resampling, PixelSelection? pixelSelection, IList<string> rescale, ColorMapNames? colorMapName, string colorMap, bool? returnMask, int? padding, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Bidx = bidx;
            Assets = assets;
