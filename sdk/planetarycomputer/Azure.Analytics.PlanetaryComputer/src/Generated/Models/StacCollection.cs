...
namespace Azure.Analytics.PlanetaryComputer
{
    ...
    public partial class StacCollection
    {
        ...
        /// <summary> Initializes a new instance of <see cref="StacCollection"/>. </summary>
        ...
        public StacCollection(string id, string description, IEnumerable<StacLink> links, string license, StacExtensionExtent extent)
        {
        ...
        internal StacCollection(DateTimeOffset? createdOn, DateTimeOffset? updatedOn, string shortDescription, IList<string> stacExtensions, string id, string description, string stacVersion, IList<StacLink> links, string title, string kind, IDictionary<string, StacAsset> assets, IDictionary<string, StacItemAsset> itemAssets, string license, StacExtensionExtent extent, IList<string> keywords, IList<StacProvider> providers, IDictionary<string, BinaryData> summaries, IDictionary<string, BinaryData> additionalProperties)
        {
            CreatedOn = createdOn;
            UpdatedOn = updatedOn;
