...
namespace Azure.Analytics.PlanetaryComputer
{
    ...
    public partial class RegisterMosaic
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="RegisterMosaic"/>. </summary>
        ...
        public FilterLanguage? FilterLanguage { get; set; }

        /// <summary> Additional metadata to associate with the mosaic. </summary>
        public MosaicMetadata Metadata { get; set; }
    }
}
