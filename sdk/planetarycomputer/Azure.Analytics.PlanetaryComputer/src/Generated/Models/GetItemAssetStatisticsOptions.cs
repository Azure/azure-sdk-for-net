...
namespace Azure.Analytics.PlanetaryComputer
{
    ...
    public partial class GetItemAssetStatisticsOptions
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="GetItemAssetStatisticsOptions"/>. </summary>
        ...
        internal GetItemAssetStatisticsOptions(string collectionId, string itemId, IList<int> bidx, IList<string> assets, IList<string> assetBandIndices, string noData, bool? unscale, WarpKernelResampling? reproject, ResamplingMethod? resampling, int? maxSize, bool? categorical, IList<int> categoriesPixels, IList<int> percentiles, string histogramBins, string histogramRange, string subdatasetName, IList<int> subdatasetBands, string crs, string datetime, IList<string> sel, SelMethod? selMethod, IList<string> assetExpression, int? height, int? width, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            CollectionId = collectionId;
            ItemId = itemId;
            Bidx = bidx;
        ...
        /// <summary> WarpKernel resampling algorithm (only used when doing re-projection). </summary>
        ...
        /// <summary> Per asset band expression. </summary>
        public IList<string> AssetExpression { get; }
