...
namespace Azure.Analytics.PlanetaryComputer
{
    ...
    public partial class GetSearchTileJsonOptions
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="GetSearchTileJsonOptions"/>. </summary>
        ...
        internal GetSearchTileJsonOptions(string searchId, IList<int> bidx, IList<string> assets, string expression, IList<string> assetBandIndices, bool? assetAsBand, string noData, bool? unscale, WarpKernelResampling? reproject, int? scanLimit, int? itemsLimit, int? timeLimit, bool? exitWhenFull, bool? skipCovered, string subdatasetName, IList<int> subdatasetBands, string crs, string datetime, IList<string> sel, SelMethod? selMethod, TileMatrixSetId? tileMatrixSetId, TilerImageFormat? tileFormat, int? tileScale, int? minZoom, int? maxZoom, int? padding, float? buffer, string colorFormula, string collectionId, ResamplingMethod? resampling, PixelSelection? pixelSelection, TerrainAlgorithm? algorithm, string algorithmParams, IList<string> rescale, ColorMapNames? colormapName, string colormap, bool? returnMask, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            SearchId = searchId;
            Bidx = bidx;
            Assets = assets;
        ...
        /// <summary> Padding to apply to each tile edge. </summary>
        public int? Padding { get; set; }

        /// <summary> Buffer on each side of the given tile. </summary>
