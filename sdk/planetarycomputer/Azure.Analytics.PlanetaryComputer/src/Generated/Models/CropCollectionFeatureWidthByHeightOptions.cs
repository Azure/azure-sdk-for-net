...
namespace Azure.Analytics.PlanetaryComputer
{
    ...
    public partial class CropCollectionFeatureWidthByHeightOptions
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="CropCollectionFeatureWidthByHeightOptions"/>. </summary>
        ...
        internal CropCollectionFeatureWidthByHeightOptions(IList<int> bidx, IList<string> assets, string expression, IList<string> assetBandIndices, bool? assetAsBand, string noData, bool? unscale, WarpKernelResampling? reproject, int? scanLimit, int? itemsLimit, int? timeLimit, bool? exitWhenFull, bool? skipCovered, string ids, string bbox, string query, string sortBy, string datetime, string subdatasetName, IList<int> subdatasetBands, string crs, IList<string> sel, SelMethod? selMethod, TerrainAlgorithm? algorithm, string algorithmParams, string collectionId, int width, int height, string format, string coordinateReferenceSystem, int? maxSize, string colorFormula, string collection, ResamplingMethod? resampling, PixelSelection? pixelSelection, IList<string> rescale, ColorMapNames? colorMapName, string colorMap, bool? returnMask, string destinationCrs, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Bidx = bidx;
            Assets = assets;
