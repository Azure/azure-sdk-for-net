...
namespace Azure.Analytics.PlanetaryComputer
{
    ...
    public partial class GetCollectionBboxCropWithDimensionsOptions
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="GetCollectionBboxCropWithDimensionsOptions"/>. </summary>
        ...
        internal GetCollectionBboxCropWithDimensionsOptions(IList<int> bidx, IList<string> assets, string expression, IList<string> assetBandIndices, bool? assetAsBand, string noData, bool? unscale, WarpKernelResampling? reproject, int? scanLimit, int? itemsLimit, int? timeLimit, bool? exitWhenFull, bool? skipCovered, string ids, string bbox, string query, string sortBy, string datetime, string subdatasetName, IList<int> subdatasetBands, string crs, IList<string> sel, SelMethod? selMethod, TerrainAlgorithm? algorithm, string algorithmParams, string collectionId, float minX, float minY, float maxX, float maxY, int width, int height, string format, string coordinateReferenceSystem, string destinationCrs, int? maxSize, string colorFormula, string collection, ResamplingMethod? resampling, PixelSelection? pixelSelection, IList<string> rescale, ColorMapNames? colorMapName, string colorMap, bool? returnMask, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Bidx = bidx;
            Assets = assets;
