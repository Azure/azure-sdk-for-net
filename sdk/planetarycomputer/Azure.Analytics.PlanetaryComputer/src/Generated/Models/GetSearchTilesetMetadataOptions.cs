...
namespace Azure.Analytics.PlanetaryComputer
{
    ...
    public partial class GetSearchTilesetMetadataOptions
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="GetSearchTilesetMetadataOptions"/>. </summary>
        ...
        internal GetSearchTilesetMetadataOptions(string searchId, string tileMatrixSetId, string subdatasetName, IList<int> subdatasetBands, string crs, string datetime, IList<string> sel, SelMethod? selMethod, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            SearchId = searchId;
            TileMatrixSetId = tileMatrixSetId;
