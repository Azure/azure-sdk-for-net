...
namespace Azure.Analytics.PlanetaryComputer
{
    internal partial class IngestionClientGetAllAsyncCollectionResult : AsyncPageable<BinaryData>
    {
        ...
        public IngestionClientGetAllAsyncCollectionResult(IngestionClient client, string collectionId, int? top, int? skip, RequestContext context) : base(context?.CancellationToken ?? default)
        {
