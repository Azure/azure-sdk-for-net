...
namespace Azure.Analytics.PlanetaryComputer
{
    internal partial class IngestionClientGetRunsAsyncCollectionResult : AsyncPageable<BinaryData>
    {
        ...
        public IngestionClientGetRunsAsyncCollectionResult(IngestionClient client, string collectionId, string ingestionId, int? top, int? skip, RequestContext context) : base(context?.CancellationToken ?? default)
        {
