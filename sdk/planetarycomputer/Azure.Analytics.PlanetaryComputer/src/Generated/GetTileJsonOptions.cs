...
namespace Azure.Analytics.PlanetaryComputer
{
    ...
    public partial class GetTileJsonOptions
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="GetTileJsonOptions"/>. </summary>
        ...
        internal GetTileJsonOptions(IList<string> assets, string expression, IList<string> assetBandIndices, bool? assetAsBand, float? noData, bool? unscale, TerrainAlgorithm? algorithm, string algorithmParams, TilerImageFormat? tileFormat, int? tileScale, int? minZoom, int? maxZoom, string buffer, string colorFormula, ResamplingMethod? resampling, IList<string> rescale, ColorMapNames? colorMapName, string colorMap, bool? returnMask, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Assets = assets;
        ...
        /// <summary> Default will be automatically defined if the output image needs a mask (png) or not (jpeg). </summary>
