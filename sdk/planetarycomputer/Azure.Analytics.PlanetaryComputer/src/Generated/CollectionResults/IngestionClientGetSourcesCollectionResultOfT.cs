...
{
    internal partial class IngestionClientGetSourcesCollectionResultOfT : Pageable<global::Azure.Analytics.PlanetaryComputer.IngestionSourceSummary>
    {
        ...
        public IngestionClientGetSourcesCollectionResultOfT(IngestionClient client, int? maxCount, int? skip, RequestContext context, string diagnosticScope) : base((context?.CancellationToken ?? default))
        {
            _client = client;
            _maxCount = maxCount;
            _skip = skip;
        ...
        public override IEnumerable<global::Azure.Page<global::Azure.Analytics.PlanetaryComputer.IngestionSourceSummary>> AsPages(string continuationToken, int? pageSizeHint)
        {
