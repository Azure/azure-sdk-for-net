...
namespace Azure.Analytics.PlanetaryComputer
{
    internal partial class IngestionClientGetOperationsAsyncCollectionResultOfT : AsyncPageable<LongRunningOperation>
    {
        ...
        public IngestionClientGetOperationsAsyncCollectionResultOfT(IngestionClient client, int? top, int? skip, string collectionId, string status, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _top = top;
            _skip = skip;
