...
{
    internal partial class IngestionClientGetRunsCollectionResult : Pageable<global::System.BinaryData>
    {
        ...
        public IngestionClientGetRunsCollectionResult(IngestionClient client, string collectionId, Guid ingestionId, int? maxCount, int? skip, RequestContext context, string diagnosticScope) : base((context?.CancellationToken ?? default))
        {
            _client = client;
