...
{
    internal partial class IngestionClientGetSourcesAsyncCollectionResult : AsyncPageable<global::System.BinaryData>
    {
        ...
        /// <returns> The pages of IngestionClientGetSourcesAsyncCollectionResult as an enumerable collection. </returns>
        public override async IAsyncEnumerable<global::Azure.Page<global::System.BinaryData>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                {
                    items.Add(global::System.ClientModel.Primitives.ModelReaderWriter.Write(item, global::Azure.Analytics.PlanetaryComputer.ModelSerializationExtensions.WireOptions, global::Azure.Analytics.PlanetaryComputer.AzureAnalyticsPlanetaryComputerContext.Default));
                }
