...
{
    internal partial class IngestionClientGetOperationsAsyncCollectionResult : AsyncPageable<global::System.BinaryData>
    {
        ...
        public IngestionClientGetOperationsAsyncCollectionResult(IngestionClient client, int? maxCount, int? skip, string collectionId, string status, RequestContext context, string diagnosticScope) : base((context?.CancellationToken ?? default))
        {
            _client = client;
            _maxCount = maxCount;
            _skip = skip;
