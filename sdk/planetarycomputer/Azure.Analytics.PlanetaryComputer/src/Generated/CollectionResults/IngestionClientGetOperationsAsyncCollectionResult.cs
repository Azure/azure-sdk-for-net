...
namespace Azure.Analytics.PlanetaryComputer
{
    internal partial class IngestionClientGetOperationsAsyncCollectionResult : AsyncPageable<BinaryData>
    {
        ...
        public IngestionClientGetOperationsAsyncCollectionResult(IngestionClient client, int? maxCount, int? skip, string collectionId, string status, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _maxCount = maxCount;
            _skip = skip;
