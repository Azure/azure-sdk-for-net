...
{
    internal partial class IngestionClientGetAllAsyncCollectionResult : AsyncPageable<global::System.BinaryData>
    {
        ...
        /// <summary> Initializes a new instance of IngestionClientGetAllAsyncCollectionResult, which is used to iterate over the pages of a collection. </summary>
        ...
        public IngestionClientGetAllAsyncCollectionResult(IngestionClient client, string collectionId, int? maxCount, int? skip, RequestContext context, string diagnosticScope) : base((context?.CancellationToken ?? default))
        {
            _client = client;
        ...
        /// <summary> Gets the pages of IngestionClientGetAllAsyncCollectionResult as an enumerable collection. </summary>
