...
namespace Azure.Analytics.PlanetaryComputer
{
    internal partial class IngestionClientGetRunsAsyncCollectionResultOfT : AsyncPageable<IngestionRun>
    {
        ...
        public IngestionClientGetRunsAsyncCollectionResultOfT(IngestionClient client, string collectionId, string ingestionId, int? top, int? skip, RequestContext context) : base(context?.CancellationToken ?? default)
        {
