...
namespace Azure.Analytics.PlanetaryComputer
{
    ...
    public partial class StacCollectionModel
    {
        ...
        public StacCollectionModel(string id, string description, IEnumerable<StacLink> links, string license, StacExtensionExtent extent)
        {
        ...
        internal StacCollectionModel(string createdOn, string updatedOn, string shortDescription, IList<string> stacExtensions, string id, string description, string stacVersion, IList<StacLink> links, string title, string @type, IDictionary<string, StacAsset> assets, string license, StacExtensionExtent extent, IList<string> keywords, IList<StacProvider> providers, IDictionary<string, BinaryData> summaries, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            CreatedOn = createdOn;
            UpdatedOn = updatedOn;
