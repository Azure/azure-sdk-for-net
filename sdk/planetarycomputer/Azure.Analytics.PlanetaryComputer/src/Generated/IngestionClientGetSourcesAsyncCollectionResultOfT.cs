...
namespace Azure.Analytics.PlanetaryComputer
{
    internal partial class IngestionClientGetSourcesAsyncCollectionResultOfT : AsyncPageable<IngestionSourceSummary>
    {
        ...
        public IngestionClientGetSourcesAsyncCollectionResultOfT(IngestionClient client, int? top, int? skip, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _top = top;
            _skip = skip;
