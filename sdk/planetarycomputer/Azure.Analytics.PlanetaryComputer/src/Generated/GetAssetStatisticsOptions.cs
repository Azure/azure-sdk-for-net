...
namespace Azure.Analytics.PlanetaryComputer
{
    ...
    public partial class GetAssetStatisticsOptions
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="GetAssetStatisticsOptions"/>. </summary>
        ...
        internal GetAssetStatisticsOptions(IList<string> assets, string expression, IList<string> assetBandIndices, bool? assetAsBand, float? noData, bool? unscale, ResamplingMethod? resampling, int? maxSize, bool? categorical, IList<string> categoriesPixels, IList<int> percentiles, string histogramBins, string histogramRange, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Assets = assets;
