...
namespace Azure.Analytics.PlanetaryComputer
{
    ...
    public partial class PageManagedIdentityMetadata : IJsonModel<PageManagedIdentityMetadata>
    {
        ...
        /// <param name="result"> The <see cref="Response"/> to deserialize the <see cref="PageManagedIdentityMetadata"/> from. </param>
        public static explicit operator PageManagedIdentityMetadata(Response result)
        {
