...
{
    internal partial class IngestionClientGetAllCollectionResult : Pageable<BinaryData>
    {
        ...
        /// <summary> Initializes a new instance of IngestionClientGetAllCollectionResult, which is used to iterate over the pages of a collection. </summary>
        ...
        public IngestionClientGetAllCollectionResult(IngestionClient client, string collectionId, int? top, int? skip, RequestContext context) : base(context?.CancellationToken ?? default)
        {
        ...
        /// <summary> Gets the pages of IngestionClientGetAllCollectionResult as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of IngestionClientGetAllCollectionResult as an enumerable collection. </returns>
