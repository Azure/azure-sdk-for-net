...
{
    internal partial class IngestionClientGetOperationsAsyncCollectionResult : AsyncPageable<BinaryData>
    {
        ...
        /// <summary> Initializes a new instance of IngestionClientGetOperationsAsyncCollectionResult, which is used to iterate over the pages of a collection. </summary>
        ...
        public IngestionClientGetOperationsAsyncCollectionResult(IngestionClient client, int? top, int? skip, string collectionId, string status, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _top = top;
            _skip = skip;
        ...
        /// <summary> Gets the pages of IngestionClientGetOperationsAsyncCollectionResult as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of IngestionClientGetOperationsAsyncCollectionResult as an enumerable collection. </returns>
