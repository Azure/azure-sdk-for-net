...
namespace Azure.Analytics.PlanetaryComputer
{
    ...
    public partial class ManagedStorageSharedAccessSignatureClient
    {
        ...
        public virtual Response GetUri(Uri href, int? durationInMinutes, RequestContext context)
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("ManagedStorageSharedAccessSignatureClient.GetUri");
            scope.Start();
            try
            {
                Argument.AssertNotNull(href, nameof(href));

                using HttpMessage message = CreateGetUriRequest(href, durationInMinutes, context);
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        public virtual async Task<Response> GetUriAsync(Uri href, int? durationInMinutes, RequestContext context)
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("ManagedStorageSharedAccessSignatureClient.GetUri");
            scope.Start();
            try
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="href"/> is null. </exception>
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        public virtual Response<SharedAccessSignatureSignedLink> GetUri(Uri href, int? durationInMinutes = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(href, nameof(href));

            Response result = GetUri(href, durationInMinutes, cancellationToken.ToRequestContext());
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="href"/> is null. </exception>
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        public virtual async Task<Response<SharedAccessSignatureSignedLink>> GetUriAsync(Uri href, int? durationInMinutes = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(href, nameof(href));

            Response result = await GetUriAsync(href, durationInMinutes, cancellationToken.ToRequestContext()).ConfigureAwait(false);
            return Response.FromValue((SharedAccessSignatureSignedLink)result, result);
        }
