...
namespace Azure.Analytics.PlanetaryComputer
{
    ...
    {
        public static void AppendQueryDelimited<T>(this RawRequestUriBuilder builder, string name, IEnumerable<T> value, string delimiter, SerializationFormat format = global::Azure.Analytics.PlanetaryComputer.SerializationFormat.Default, bool escape = true)
        {
            delimiter ??= ",";
            IEnumerable<string> stringValues = value.Select(v => global::Azure.Analytics.PlanetaryComputer.TypeFormatters.ConvertToString(v, format));
