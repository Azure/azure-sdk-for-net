...
namespace Azure.Analytics.PlanetaryComputer
{
    internal partial class MultiPartFormDataRequestContent : RequestContent
    {
        ...
        {
            _multipartContent = new MultipartFormDataContent(global::Azure.Analytics.PlanetaryComputer.MultiPartFormDataRequestContent.CreateBoundary());
        }
        ...
        public void Add(string content, string name, string filename = default, string contentType = default)
        {
            ...
            global::Azure.Analytics.PlanetaryComputer.Argument.AssertNotNullOrEmpty(name, nameof(name));
        ...
        private void Add(HttpContent content, string name, string filename, string contentType)
        {
            if ((contentType != null))
            {
                global::Azure.Analytics.PlanetaryComputer.Argument.AssertNotNullOrEmpty(contentType, nameof(contentType));
                global::Azure.Analytics.PlanetaryComputer.MultiPartFormDataRequestContent.AddContentTypeHeader(content, contentType);
            }
            if ((filename != null))
            {
                global::Azure.Analytics.PlanetaryComputer.Argument.AssertNotNullOrEmpty(filename, nameof(filename));
