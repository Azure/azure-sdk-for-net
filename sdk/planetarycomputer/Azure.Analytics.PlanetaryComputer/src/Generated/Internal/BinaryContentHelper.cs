...
namespace Azure.Analytics.PlanetaryComputer
{
    internal static partial class BinaryContentHelper
    {
            ...
            where T : notnull
        {
            ...
            {
                content.JsonWriter.WriteObjectValue<T>(item, global::Azure.Analytics.PlanetaryComputer.ModelSerializationExtensions.WireOptions);
            }
            ...
            where T : notnull
        {
            ...
            for (; (i < span.Length); i++)
            {
                content.JsonWriter.WriteObjectValue<T>(span[i], global::Azure.Analytics.PlanetaryComputer.ModelSerializationExtensions.WireOptions);
            }
            content.JsonWriter.WriteEndArray();
            ...
            where TValue : notnull
        {
            ...
            foreach (var item in dictionary)
            {
                ...
                content.JsonWriter.WriteObjectValue<TValue>(item.Value, global::Azure.Analytics.PlanetaryComputer.ModelSerializationExtensions.WireOptions);
            }
        ...
        {
            Utf8JsonRequestContent content = new Utf8JsonRequestContent();
            content.JsonWriter.WriteObjectValue<object>(value, global::Azure.Analytics.PlanetaryComputer.ModelSerializationExtensions.WireOptions);
            return content;
        }
