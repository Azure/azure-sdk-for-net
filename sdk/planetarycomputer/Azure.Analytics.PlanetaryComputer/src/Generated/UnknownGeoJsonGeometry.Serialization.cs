...
{
    internal partial class UnknownGeoJsonGeometry : IJsonModel<GeoJsonGeometry>
    {
        ...
        internal static UnknownGeoJsonGeometry DeserializeUnknownGeoJsonGeometry(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownGeoJsonGeometry(@type, bbox ?? new ChangeTrackingList<double>(), additionalBinaryDataProperties);
        }
