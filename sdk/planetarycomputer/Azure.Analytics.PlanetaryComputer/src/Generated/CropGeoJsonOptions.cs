...
namespace Azure.Analytics.PlanetaryComputer
{
    ...
    public partial class CropGeoJsonOptions
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="CropGeoJsonOptions"/>. </summary>
        ...
        internal CropGeoJsonOptions(IList<string> assets, string expression, IList<string> assetBandIndices, bool? assetAsBand, float? noData, bool? unscale, TerrainAlgorithm? algorithm, string algorithmParams, string colorFormula, string coordinateReferenceSystem, ResamplingMethod? resampling, int? maxSize, IList<string> rescale, ColorMapNames? colorMapName, string colorMap, bool? returnMask, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Assets = assets;
