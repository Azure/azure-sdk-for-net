...
namespace Azure.Analytics.PlanetaryComputer
{
    internal partial class IngestionClientGetRunsCollectionResultOfT : Pageable<IngestionRun>
    {
        ...
        public IngestionClientGetRunsCollectionResultOfT(IngestionClient client, string collectionId, Guid ingestionId, int? top, int? skip, RequestContext context) : base(context?.CancellationToken ?? default)
        {
