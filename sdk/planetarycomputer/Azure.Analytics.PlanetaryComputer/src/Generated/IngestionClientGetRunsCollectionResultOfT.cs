...
{
    internal partial class IngestionClientGetRunsCollectionResultOfT : Pageable<IngestionRun>
    {
        ...
        /// <summary> Initializes a new instance of IngestionClientGetRunsCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public IngestionClientGetRunsCollectionResultOfT(IngestionClient client, string collectionId, string ingestionId, int? top, int? skip, RequestContext context) : base(context?.CancellationToken ?? default)
        {
        ...
        /// <summary> Gets the pages of IngestionClientGetRunsCollectionResultOfT as an enumerable collection. </summary>
