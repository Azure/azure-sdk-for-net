...
namespace Azure.ResourceManager.PlanetaryComputer.Models
{
    ...
    public partial class PlanetaryComputerGeoCatalogPatch : IJsonModel<PlanetaryComputerGeoCatalogPatch>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        PlanetaryComputerGeoCatalogPatch IJsonModel<PlanetaryComputerGeoCatalogPatch>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual PlanetaryComputerGeoCatalogPatch JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<PlanetaryComputerGeoCatalogPatch>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static PlanetaryComputerGeoCatalogPatch DeserializePlanetaryComputerGeoCatalogPatch(JsonElement element, ModelReaderWriterOptions options)
        {
