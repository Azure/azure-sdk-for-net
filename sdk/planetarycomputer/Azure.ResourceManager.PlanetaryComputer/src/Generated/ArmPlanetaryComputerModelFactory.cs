...
namespace Azure.ResourceManager.PlanetaryComputer.Models
{
    ...
    public static partial class ArmPlanetaryComputerModelFactory
    {
        ...
        /// <param name="name0"> The name of the catalog. </param>
        ...
        {
            return new PlanetaryComputerGeoCatalogProperties(tier, catalogUri, provisioningState, autoGeneratedDomainNameLabelScope, default);
        }
        ...
        public static PlanetaryComputerGeoCatalogPatch PlanetaryComputerGeoCatalogPatch(IDictionary<string, string> tags = default, ManagedServiceIdentity identity = default)
        {
            ...
            return new PlanetaryComputerGeoCatalogPatch(tags ?? new ChangeTrackingDictionary<string, string>(), identity, default);
        }
