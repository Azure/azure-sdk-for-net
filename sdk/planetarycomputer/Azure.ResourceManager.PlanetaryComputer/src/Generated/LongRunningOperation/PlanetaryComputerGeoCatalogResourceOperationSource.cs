...
{
    /// <summary></summary>
    internal partial class PlanetaryComputerGeoCatalogResourceOperationSource : IOperationSource<PlanetaryComputerGeoCatalogResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal PlanetaryComputerGeoCatalogResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
