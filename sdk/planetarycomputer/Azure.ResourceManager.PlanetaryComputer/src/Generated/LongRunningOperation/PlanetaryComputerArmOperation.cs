...
namespace Azure.ResourceManager.PlanetaryComputer
{
    internal partial class PlanetaryComputerArmOperation : ArmOperation
    {
        ...
        internal PlanetaryComputerArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
