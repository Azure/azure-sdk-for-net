...
#pragma warning disable SA1649 // File name should match first type name
    internal class PlanetaryComputerArmOperation : ArmOperation
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        internal PlanetaryComputerArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal PlanetaryComputerArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal(nextLinkOperation, clientDiagnostics, response, "PlanetaryComputerArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
