...
namespace Microsoft.Azure.Management.MySQL.FlexibleServers
{
    ...
    /// </summary>
    internal partial class CheckVirtualNetworkSubnetUsageOperations : IServiceOperations<MySQLManagementClient>, ICheckVirtualNetworkSubnetUsageOperations
    {
        /// <summary>
        /// Initializes a new instance of the CheckVirtualNetworkSubnetUsageOperations class.
        /// </summary>
        /// <param name='client'>
        ...
        /// </exception>
        internal CheckVirtualNetworkSubnetUsageOperations(MySQLManagementClient client)
        {
            if (client == null)
            {
        ...
        public async Task<AzureOperationResponse<VirtualNetworkSubnetUsageResult>> ExecuteWithHttpMessagesAsync(string locationName, VirtualNetworkSubnetUsageParameter parameters, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "subscriptions/{subscriptionId}/providers/Microsoft.DBforMySQL/locations/{locationName}/checkVirtualNetworkSubnetUsage").ToString();
