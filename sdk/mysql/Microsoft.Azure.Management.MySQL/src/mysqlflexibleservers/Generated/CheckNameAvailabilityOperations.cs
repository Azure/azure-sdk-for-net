...
namespace Microsoft.Azure.Management.MySQL.FlexibleServers
{
    ...
    /// </summary>
    internal partial class CheckNameAvailabilityOperations : IServiceOperations<MySQLManagementClient>, ICheckNameAvailabilityOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal CheckNameAvailabilityOperations(MySQLManagementClient client)
        {
            if (client == null)
            {
