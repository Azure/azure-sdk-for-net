...
namespace Microsoft.Azure.Management.MySQL
{
    ...
    /// </summary>
    internal partial class Operations : IServiceOperations<MySQLManagementClient>, IOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal Operations(MySQLManagementClient client)
        {
            if (client == null)
            {
        ...
        public async Task<AzureOperationResponse<OperationListResult>> ListWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "providers/Microsoft.DBforMySQL/operations").ToString();
