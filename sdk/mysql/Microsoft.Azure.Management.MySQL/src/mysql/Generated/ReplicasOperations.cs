...
namespace Microsoft.Azure.Management.MySQL
{
    ...
    internal partial class ReplicasOperations : IServiceOperations<MySQLManagementClient>, IReplicasOperations
    {
        ...
        public async Task<AzureOperationResponse<IEnumerable<Server>>> ListByServerWithHttpMessagesAsync(string resourceGroupName, string serverName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBForMySQL/servers/{serverName}/replicas").ToString();
