...
{
    public partial class Sample_MySqlFlexibleServersMySqlFlexibleServerFirewallRuleResource
    {
        ...
        public async Task Update_CreateAFirewallRule()
        {
            ...
            // this example assumes you already have this MySqlFlexibleServersMySqlFlexibleServerFirewallRuleResource created on azure
            // for more information of creating MySqlFlexibleServersMySqlFlexibleServerFirewallRuleResource, please refer to the document of MySqlFlexibleServersMySqlFlexibleServerFirewallRuleResource
            string subscriptionId = "ffffffff-ffff-ffff-ffff-ffffffffffff";
            string resourceGroupName = "TestGroup";
            string serverName = "testserver";
            string firewallRuleName = "rule1";
            ResourceIdentifier mySqlFlexibleServersMySqlFlexibleServerFirewallRuleResourceId = MySqlFlexibleServersMySqlFlexibleServerFirewallRuleResource.CreateResourceIdentifier(subscriptionId, resourceGroupName, serverName, firewallRuleName);
            MySqlFlexibleServersMySqlFlexibleServerFirewallRuleResource mySqlFlexibleServersMySqlFlexibleServerFirewallRule = client.GetMySqlFlexibleServersMySqlFlexibleServerFirewallRuleResource(mySqlFlexibleServersMySqlFlexibleServerFirewallRuleResourceId);
            ...
            ArmOperation<MySqlFlexibleServersMySqlFlexibleServerFirewallRuleResource> lro = await mySqlFlexibleServersMySqlFlexibleServerFirewallRule.UpdateAsync(WaitUntil.Completed, data);
        ...
        public async Task Delete_DeleteAFirewallRule()
        {
            ...
            // invoke the operation
            await mySqlFlexibleServersMySqlFlexibleServerFirewallRule.DeleteAsync(WaitUntil.Completed);
        ...
        public async Task Get_GetAFirewallRule()
        {
            ...
            // invoke the operation
            MySqlFlexibleServersMySqlFlexibleServerFirewallRuleResource result = await mySqlFlexibleServersMySqlFlexibleServerFirewallRule.GetAsync();
