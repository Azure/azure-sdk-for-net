...
namespace Azure.ResourceManager.MySql.FlexibleServers.Samples
{
    public partial class Sample_MySqlFlexibleServerResource
    {
        ...
        public async Task Delete_DeleteAServer()
        {
            ...
            // invoke the operation
            await mySqlFlexibleServer.DeleteAsync(WaitUntil.Completed).ConfigureAwait(false);
...
Value = "8",
        ...
        public async Task Failover_RestartAServer()
        {
            ...
            // invoke the operation
            await mySqlFlexibleServer.FailoverAsync(WaitUntil.Completed).ConfigureAwait(false);
        ...
        public async Task Restart_RestartAServer()
        {
            ...
            await mySqlFlexibleServer.RestartAsync(WaitUntil.Completed, mySqlFlexibleServerRestartParameter).ConfigureAwait(false);
        ...
        public async Task Start_StartAServer()
        {
            ...
            // invoke the operation
            await mySqlFlexibleServer.StartAsync(WaitUntil.Completed).ConfigureAwait(false);
        ...
        public async Task Stop_StopAServer()
        {
            ...
            // invoke the operation
            await mySqlFlexibleServer.StopAsync(WaitUntil.Completed).ConfigureAwait(false);
        ...
        public async Task ResetGtid_ResetGTIDOnAServer()
        {
            ...
            await mySqlFlexibleServer.ResetGtidAsync(WaitUntil.Completed, content).ConfigureAwait(false);
