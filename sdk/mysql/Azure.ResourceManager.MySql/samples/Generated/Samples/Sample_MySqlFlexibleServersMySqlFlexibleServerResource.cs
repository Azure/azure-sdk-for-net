...
{
    public partial class Sample_MySqlFlexibleServersMySqlFlexibleServerResource
    {
...
"sasuri1","sasuri2"
            ...
            ArmOperation<MySqlFlexibleServerBackupAndExportResult> lro = await mySqlFlexibleServersMySqlFlexibleServer.CreateBackupAndExportAsync(WaitUntil.Completed, content);
        ...
        public async Task ValidateBackup_ValidateBackup()
        {
            ...
            // invoke the operation
            MySqlFlexibleServerValidateBackupResult result = await mySqlFlexibleServersMySqlFlexibleServer.ValidateBackupAsync();
...
Value = "8",
            ...
            ArmOperation<MySqlFlexibleServerConfigurations> lro = await mySqlFlexibleServersMySqlFlexibleServer.UpdateConfigurationsAsync(WaitUntil.Completed, mySqlFlexibleServerConfigurationListForBatchUpdate);
        ...
        public async Task Update_UpdateAServer()
        {
            ...
            // invoke the operation
            MySqlFlexibleServersMySqlFlexibleServerPatch patch = new MySqlFlexibleServersMySqlFlexibleServerPatch()
            {
            ...
            ArmOperation<MySqlFlexibleServersMySqlFlexibleServerResource> lro = await mySqlFlexibleServersMySqlFlexibleServer.UpdateAsync(WaitUntil.Completed, patch);
...
[new ResourceIdentifier("/subscriptions/ffffffff-ffff-ffff-ffff-ffffffffffff/resourceGroups/testrg/providers/Microsoft.ManagedIdentity/userAssignedIdentities/test-identity")] = new UserAssignedIdentity(),
        ...
        public async Task Delete_DeleteAServer()
        {
            ...
            // invoke the operation
            await mySqlFlexibleServersMySqlFlexibleServer.DeleteAsync(WaitUntil.Completed);
        ...
        public async Task Get_GetAServer()
        {
            ...
            // invoke the operation
            MySqlFlexibleServersMySqlFlexibleServerResource result = await mySqlFlexibleServersMySqlFlexibleServer.GetAsync();
        ...
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task GetMySqlFlexibleServersMySqlFlexibleServers_ListServersInASubscription()
        {
            ...
            await foreach (MySqlFlexibleServersMySqlFlexibleServerResource item in subscriptionResource.GetMySqlFlexibleServersMySqlFlexibleServersAsync())
            {
        ...
        public async Task Failover_RestartAServer()
        {
            ...
            // invoke the operation
            await mySqlFlexibleServersMySqlFlexibleServer.FailoverAsync(WaitUntil.Completed);
        ...
        public async Task ValidateEstimateHighAvailability_ValidateAValidationAndEstimationOfHighAvailability()
        {
            ...
            HighAvailabilityValidationEstimation result = await mySqlFlexibleServersMySqlFlexibleServer.ValidateEstimateHighAvailabilityAsync(highAvailabilityValidationEstimation);
        ...
        public async Task Restart_RestartAServer()
        {
            ...
            await mySqlFlexibleServersMySqlFlexibleServer.RestartAsync(WaitUntil.Completed, mySqlFlexibleServerRestartParameter);
        ...
        public async Task Start_StartAServer()
        {
            ...
            // invoke the operation
            await mySqlFlexibleServersMySqlFlexibleServer.StartAsync(WaitUntil.Completed);
        ...
        public async Task Stop_StopAServer()
        {
            ...
            // invoke the operation
            await mySqlFlexibleServersMySqlFlexibleServer.StopAsync(WaitUntil.Completed);
        ...
        public async Task ResetGtid_ResetGTIDOnAServer()
        {
            ...
            await mySqlFlexibleServersMySqlFlexibleServer.ResetGtidAsync(WaitUntil.Completed, content);
        ...
        public async Task CutoverMigrationServersMigration_CutoverMigrationForMySQLImport()
        {
            ...
            // invoke the operation
            ArmOperation<MySqlFlexibleServersMySqlFlexibleServerResource> lro = await mySqlFlexibleServersMySqlFlexibleServer.CutoverMigrationServersMigrationAsync(WaitUntil.Completed);
            MySqlFlexibleServersMySqlFlexibleServerResource result = lro.Value;
        ...
        public async Task GetLogFiles_ListAllServerLogFilesForAServer()
        {
            ...
            // invoke the operation and iterate over the result
            await foreach (MySqlFlexibleServersMySqlFlexibleServerLogFile item in mySqlFlexibleServersMySqlFlexibleServer.GetLogFilesAsync())
            {
