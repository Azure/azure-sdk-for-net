...
{
    public partial class Sample_MySqlFlexibleServersMySqlFlexibleServerCollection
    {
        // Create a new server
        ...
        {
            // Generated from example definition: specification/mysql/resource-manager/Microsoft.DBforMySQL/FlexibleServers/preview/2023-12-01-preview/examples/ServerCreate.json
            ...
            // get the collection of this MySqlFlexibleServersMySqlFlexibleServerResource
            MySqlFlexibleServersMySqlFlexibleServerCollection collection = resourceGroupResource.GetMySqlFlexibleServersMySqlFlexibleServers();

            // invoke the operation
            string serverName = "mysqltestserver";
            MySqlFlexibleServersMySqlFlexibleServerData data = new MySqlFlexibleServersMySqlFlexibleServerData(new AzureLocation("southeastasia"))
            {
...
["num"] = "1",
            ...
            ArmOperation<MySqlFlexibleServersMySqlFlexibleServerResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, serverName, data);
            MySqlFlexibleServersMySqlFlexibleServerResource result = lro.Value;

            // the variable result is a resource, you could call other operations on this instance as well
            // but just for demo, we get its data from this resource instance
            MySqlFlexibleServersMySqlFlexibleServerData resourceData = result.Data;
        ...
        {
            // Generated from example definition: specification/mysql/resource-manager/Microsoft.DBforMySQL/FlexibleServers/preview/2023-12-01-preview/examples/ServerCreateReplica.json
            // this example is just showing the usage of "Servers_Create" operation, for the dependent resources, they will have to be created separately.
        ...
        {
            // Generated from example definition: specification/mysql/resource-manager/Microsoft.DBforMySQL/FlexibleServers/preview/2023-12-01-preview/examples/ServerCreateWithPointInTimeRestore.json
            // this example is just showing the usage of "Servers_Create" operation, for the dependent resources, they will have to be created separately.
...
["num"] = "1",
        ...
        {
            // Generated from example definition: specification/mysql/resource-manager/Microsoft.DBforMySQL/FlexibleServers/preview/2023-12-01-preview/examples/ServerCreateWithBYOK.json
            // this example is just showing the usage of "Servers_Create" operation, for the dependent resources, they will have to be created separately.
...
["num"] = "1",
        ...
        public async Task Get_GetAServer()
        {
            ...
            // invoke the operation
            string serverName = "mysqltestserver";
            MySqlFlexibleServersMySqlFlexibleServerResource result = await collection.GetAsync(serverName);
        ...
        public async Task GetIfExists_GetAServer()
        {
            ...
            // invoke the operation
            string serverName = "mysqltestserver";
            NullableResponse<MySqlFlexibleServersMySqlFlexibleServerResource> response = await collection.GetIfExistsAsync(serverName);
            MySqlFlexibleServersMySqlFlexibleServerResource result = response.HasValue ? response.Value : null;
        ...
        {
            // Generated from example definition: specification/mysql/resource-manager/Microsoft.DBforMySQL/FlexibleServers/preview/2023-12-01-preview/examples/ServersListByResourceGroup.json
            ...
            await foreach (MySqlFlexibleServersMySqlFlexibleServerResource item in collection.GetAllAsync())
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                MySqlFlexibleServersMySqlFlexibleServerData resourceData = item.Data;
                // for demo we just print out the id
                Console.WriteLine($"Succeeded on id: {resourceData.Id}");
            }
        ...
        {
            // Generated from example definition: specification/mysql/resource-manager/Microsoft.DBforMySQL/FlexibleServers/preview/2023-12-01-preview/examples/ReplicasListByServer.json
            ...
            // invoke the operation and iterate over the result
            string serverName = "mysqltestserver";
            await foreach (MySqlFlexibleServersMySqlFlexibleServerResource item in collection.GetReplicasAsync(serverName))
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                MySqlFlexibleServersMySqlFlexibleServerData resourceData = item.Data;
