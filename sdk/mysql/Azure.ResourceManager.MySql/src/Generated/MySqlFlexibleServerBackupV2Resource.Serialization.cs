...
namespace Azure.ResourceManager.MySql.FlexibleServers
{
    public partial class MySqlFlexibleServerBackupV2Resource : IJsonModel<MySqlFlexibleServerBackupV2Data>
    {
        ...
        BinaryData IPersistableModel<MySqlFlexibleServerBackupV2Data>.Write(ModelReaderWriterOptions options) => ModelReaderWriter.Write<MySqlFlexibleServerBackupV2Data>(Data, options, AzureResourceManagerMySqlFlexibleServersContext.Default);

        MySqlFlexibleServerBackupV2Data IPersistableModel<MySqlFlexibleServerBackupV2Data>.Create(BinaryData data, ModelReaderWriterOptions options) => ModelReaderWriter.Read<MySqlFlexibleServerBackupV2Data>(data, options, AzureResourceManagerMySqlFlexibleServersContext.Default);
