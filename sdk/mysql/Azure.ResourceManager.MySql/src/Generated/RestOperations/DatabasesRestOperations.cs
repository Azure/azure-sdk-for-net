...
namespace Azure.ResourceManager.MySql
{
    ...
    {
        internal RequestUriBuilder CreateCreateOrUpdateRequestUri(string subscriptionId, string resourceGroupName, string serverName, string databaseName, DatabaseData data)
        {
        ...
        internal HttpMessage CreateCreateOrUpdateRequest(string subscriptionId, string resourceGroupName, string serverName, string databaseName, DatabaseData data)
        {
            ...
            content.JsonWriter.WriteObjectValue<DatabaseData>(data, ModelSerializationExtensions.WireOptions);
