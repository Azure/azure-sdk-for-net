...
namespace Azure.ResourceManager.MySql
{
    ...
    /// Each <see cref="MaintenanceResource"/> in the collection will belong to the same instance of <see cref="ServerResource"/>.
    /// To get a <see cref="MaintenanceCollection"/> instance call the GetMaintenances method from an instance of <see cref="ServerResource"/>.
    /// </summary>
    public partial class MaintenanceCollection : ArmCollection, IEnumerable<MaintenanceResource>, IAsyncEnumerable<MaintenanceResource>
    {
        ...
        {
            _maintenanceClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.MySql", MaintenanceResource.ResourceType.Namespace, Diagnostics);
