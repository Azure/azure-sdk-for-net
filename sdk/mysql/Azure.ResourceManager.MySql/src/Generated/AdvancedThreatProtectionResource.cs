...
{
    /// <summary>
    /// A class representing a AdvancedThreatProtection along with the instance operations that can be performed on it.
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="AdvancedThreatProtectionResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="MySqlFlexibleServerResource"/> using the GetAdvancedThreatProtections method.
    /// </summary>
    public partial class AdvancedThreatProtectionResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of AdvancedThreatProtectionResource for mocking. </summary>
        protected AdvancedThreatProtectionResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="AdvancedThreatProtectionResource"/> class. </summary>
        ...
        {
            TryGetApiVersion(ResourceType, out string advancedThreatProtectionApiVersion);
            _advancedThreatProtectionSettingsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.MySql.FlexibleServers", ResourceType.Namespace, Diagnostics);
        ...
        {
            string resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforMySQL/flexibleServers/{serverName}/advancedThreatProtectionSettings/{advancedThreatProtectionName}";
        ...
        {
            using DiagnosticScope scope = _advancedThreatProtectionSettingsClientDiagnostics.CreateScope("AdvancedThreatProtectionResource.Get");
            scope.Start();
            try
            {
        ...
        /// <summary>
        /// Updates the AdvancedThreatProtection.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforMySQL/flexibleServers/{serverName}/advancedThreatProtectionSettings/{advancedThreatProtectionName}. </description>
        ...
        public virtual async Task<ArmOperation<AdvancedThreatProtectionResource>> UpdateAsync(WaitUntil waitUntil, AdvancedThreatProtectionData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _advancedThreatProtectionSettingsRestClient.CreateUpdatePutRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, AdvancedThreatProtectionData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                FlexibleServersArmOperation<AdvancedThreatProtectionResource> operation = new FlexibleServersArmOperation<AdvancedThreatProtectionResource>(
                    new AdvancedThreatProtectionResourceOperationSource(Client),
                    _advancedThreatProtectionSettingsClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<AdvancedThreatProtectionResource> Update(WaitUntil waitUntil, AdvancedThreatProtectionData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
