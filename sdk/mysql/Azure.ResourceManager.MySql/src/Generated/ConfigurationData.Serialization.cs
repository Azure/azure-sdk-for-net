...
namespace Azure.ResourceManager.MySql
{
    public partial class ConfigurationData : IUtf8JsonSerializable, IJsonModel<ConfigurationData>
    {
        ...
        internal static ConfigurationData DeserializeConfigurationData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            ConfigurationSource? source = default;
            IsReadOnly? isReadOnly = default;
            IsConfigPendingRestart? isConfigPendingRestart = default;
            IsDynamicConfig? isDynamicConfig = default;
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("source"u8))
                        {
                            ...
                            source = new ConfigurationSource(property0.Value.GetString());
                            continue;
                        }
                        if (property0.NameEquals("isReadOnly"u8))
                        {
                            ...
                            isReadOnly = new IsReadOnly(property0.Value.GetString());
                            continue;
                        }
                        if (property0.NameEquals("isConfigPendingRestart"u8))
                        {
                            ...
                            isConfigPendingRestart = new IsConfigPendingRestart(property0.Value.GetString());
                            continue;
                        }
                        if (property0.NameEquals("isDynamicConfig"u8))
                        {
                            ...
                            isDynamicConfig = new IsDynamicConfig(property0.Value.GetString());
                            continue;
                        }
                    }
                    continue;
