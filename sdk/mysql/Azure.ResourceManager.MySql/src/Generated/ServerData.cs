...
namespace Azure.ResourceManager.MySql
{
    ...
    public partial class ServerData : TrackedResourceData
    {
        ...
        internal ServerData(ResourceIdentifier id, string name, ResourceType resourceType, ResourceManager.Models.SystemData systemData, IDictionary<string, string> tags, AzureLocation location, string administratorLogin, string administratorLoginPassword, ServerVersion? version, string fullVersion, string availabilityZone, CreateMode? createMode, string sourceServerResourceId, DateTimeOffset? restorePointInOn, ReplicationRole? replicationRole, int? replicaCapacity, DataEncryption dataEncryption, ServerState? state, string fullyQualifiedDomainName, int? databasePort, Storage storage, Backup backup, HighAvailability highAvailability, Network network, IReadOnlyList<MySqlPrivateEndpointConnectionData> privateEndpointConnections, MaintenancePolicy maintenancePolicy, MaintenanceWindow maintenanceWindow, ImportSourceProperties importSourceProperties, ManagedServiceIdentity identity, MySQLServerSku sku, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData, tags, location)
        {
        ...
        /// <summary> Initializes a new instance of <see cref="ServerData"/> for deserialization. </summary>
        internal ServerData()
        {
        }
        ...
        public IReadOnlyList<MySqlPrivateEndpointConnectionData> PrivateEndpointConnections { get; }
