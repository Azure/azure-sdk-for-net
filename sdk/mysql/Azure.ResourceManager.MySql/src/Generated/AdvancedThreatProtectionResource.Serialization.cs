...
namespace Azure.ResourceManager.MySql.FlexibleServers
{
    public partial class AdvancedThreatProtectionResource : IJsonModel<AdvancedThreatProtectionData>
    {
        ...
        BinaryData IPersistableModel<AdvancedThreatProtectionData>.Write(ModelReaderWriterOptions options) => ModelReaderWriter.Write<AdvancedThreatProtectionData>(Data, options, AzureResourceManagerMySqlFlexibleServersContext.Default);

        AdvancedThreatProtectionData IPersistableModel<AdvancedThreatProtectionData>.Create(BinaryData data, ModelReaderWriterOptions options) => ModelReaderWriter.Read<AdvancedThreatProtectionData>(data, options, AzureResourceManagerMySqlFlexibleServersContext.Default);
