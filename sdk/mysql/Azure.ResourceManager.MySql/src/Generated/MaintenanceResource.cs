...
namespace Azure.ResourceManager.MySql
{
    ...
    /// Otherwise you can get one from its parent resource <see cref="ServerResource"/> using the GetMaintenance method.
    /// </summary>
    public partial class MaintenanceResource : ArmResource
    {
        ...
        {
            _maintenanceClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.MySql", ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<MaintenanceResource>> UpdateAsync(WaitUntil waitUntil, MaintenancePatch patch, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new MySqlArmOperation<MaintenanceResource>(new MaintenanceOperationSource(Client), _maintenanceClientDiagnostics, Pipeline, _maintenanceRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, patch).Request, response, OperationFinalStateVia.Location);
