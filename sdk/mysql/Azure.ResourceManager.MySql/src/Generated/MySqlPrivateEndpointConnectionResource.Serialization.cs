...
namespace Azure.ResourceManager.MySql
{
    ...
    {
        void IJsonModel<MySqlPrivateEndpointConnectionData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options) => ((IJsonModel<MySqlPrivateEndpointConnectionData>)this.Data).Write(writer, options);
        ...
        BinaryData IPersistableModel<MySqlPrivateEndpointConnectionData>.Write(ModelReaderWriterOptions options) => ModelReaderWriter.Write<MySqlPrivateEndpointConnectionData>(this.Data, options, AzureResourceManagerMySqlContext.Default);
