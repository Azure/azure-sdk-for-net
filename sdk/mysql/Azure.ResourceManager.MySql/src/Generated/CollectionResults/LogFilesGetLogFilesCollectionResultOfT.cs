...
namespace Azure.ResourceManager.MySql.FlexibleServers
{
    internal partial class LogFilesGetLogFilesCollectionResultOfT : Pageable<MySqlFlexibleServerLogFile>
    {
        ...
        public LogFilesGetLogFilesCollectionResultOfT(LogFiles client, Guid subscriptionId, string resourceGroupName, string serverName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        public override IEnumerable<Page<MySqlFlexibleServerLogFile>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                yield return Page<MySqlFlexibleServerLogFile>.FromValues((IReadOnlyList<MySqlFlexibleServerLogFile>)result.Value, nextPage?.IsAbsoluteUri == true ? nextPage.AbsoluteUri : nextPage?.OriginalString, response);
