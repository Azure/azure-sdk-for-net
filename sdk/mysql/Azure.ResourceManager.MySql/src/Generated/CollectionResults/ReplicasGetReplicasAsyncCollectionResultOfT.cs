...
namespace Azure.ResourceManager.MySql.FlexibleServers
{
    internal partial class ReplicasGetReplicasAsyncCollectionResultOfT : AsyncPageable<MySqlFlexibleServerData>
    {
        ...
        public ReplicasGetReplicasAsyncCollectionResultOfT(Replicas client, Guid subscriptionId, string resourceGroupName, string serverName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
