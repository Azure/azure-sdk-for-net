    ...
    internal partial class ConfigurationsGetByServerCollectionResultOfT : Pageable<MySqlFlexibleServerConfigurationData>
    {
        ...
        public override IEnumerable<Page<MySqlFlexibleServerConfigurationData>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                yield return Page<MySqlFlexibleServerConfigurationData>.FromValues((IReadOnlyList<MySqlFlexibleServerConfigurationData>)result.Value, nextPage?.IsAbsoluteUri == true ? nextPage.AbsoluteUri : nextPage?.OriginalString, response);
