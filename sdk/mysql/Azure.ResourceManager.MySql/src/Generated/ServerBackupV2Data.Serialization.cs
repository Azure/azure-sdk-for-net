...
namespace Azure.ResourceManager.MySql
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ServerBackupV2Data>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ServerBackupV2Data)} does not support writing '{format}' format.");
            }
        ...
        ServerBackupV2Data IJsonModel<ServerBackupV2Data>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ServerBackupV2Data)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ServerBackupV2Data>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ServerBackupV2Data)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        ServerBackupV2Data IPersistableModel<ServerBackupV2Data>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ServerBackupV2Data)} does not support reading '{options.Format}' format.");
            }
        }
