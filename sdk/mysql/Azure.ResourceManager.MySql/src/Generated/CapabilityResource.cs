...
namespace Azure.ResourceManager.MySql
{
    ...
    public partial class CapabilityResource : ArmResource
    {
        ...
        public static ResourceIdentifier CreateResourceIdentifier(string subscriptionId, string locationName, string capabilitySetName)
        {
        ...
        {
            _capabilityLocationBasedCapabilitySetClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.MySql", ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<Response<CapabilityResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _capabilityLocationBasedCapabilitySetRestClient.GetAsync(Id.SubscriptionId, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<CapabilityResource> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _capabilityLocationBasedCapabilitySetRestClient.Get(Id.SubscriptionId, Id.Parent.Name, Id.Name, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new CapabilityResource(Client, response.Value), response.GetRawResponse());
            }
