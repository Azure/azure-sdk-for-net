...
namespace Azure.ResourceManager.MySql.Models
{
    ...
    public partial class BackupAndExportResponseType : OperationProgressResponseType
    {
        ...
        {
            ObjectType = ObjectType.BackupAndExportResponse;
        }
        ...
        internal BackupAndExportResponseType(ObjectType objectType, IDictionary<string, BinaryData> serializedAdditionalRawData, long? datasourceSizeInBytes, long? dataTransferredInBytes, string backupMetadata) : base(objectType, serializedAdditionalRawData)
        {
