...
namespace Azure.ResourceManager.MySql.Models
{
    ...
    public partial class ConfigurationListForBatchUpdate
    {
        ...
        /// <summary> Initializes a new instance of <see cref="ConfigurationListForBatchUpdate"/>. </summary>
        public ConfigurationListForBatchUpdate()
        {
            Value = new ChangeTrackingList<ConfigurationForBatchUpdate>();
        }
        ...
        internal ConfigurationListForBatchUpdate(IList<ConfigurationForBatchUpdate> value, ResetAllToDefault? resetAllToDefault, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Value = value;
        ...
        public IList<ConfigurationForBatchUpdate> Value { get; }
        /// <summary> Whether to reset all server parameters to default. </summary>
        public ResetAllToDefault? ResetAllToDefault { get; set; }
    }
}
