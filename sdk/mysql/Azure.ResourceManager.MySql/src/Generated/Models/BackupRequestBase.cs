...
namespace Azure.ResourceManager.MySql.Models
{
    ...
    public partial class BackupRequestBase
    {
        ...
        /// <summary> Initializes a new instance of <see cref="BackupRequestBase"/>. </summary>
        ...
        internal BackupRequestBase(BackupSettings backupSettings, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            BackupSettings = backupSettings;
            _serializedAdditionalRawData = serializedAdditionalRawData;
        }

        /// <summary> Initializes a new instance of <see cref="BackupRequestBase"/> for deserialization. </summary>
        internal BackupRequestBase()
        {
        }
