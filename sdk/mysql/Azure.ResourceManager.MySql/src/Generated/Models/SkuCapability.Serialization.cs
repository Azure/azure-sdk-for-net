...
namespace Azure.ResourceManager.MySql.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SkuCapability>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<SkuCapability>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SkuCapability)} does not support writing '{format}' format.");
            }
        ...
        SkuCapability IJsonModel<SkuCapability>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SkuCapability)} does not support reading '{format}' format.");
            }
        ...
        internal static SkuCapability DeserializeSkuCapability(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new SkuCapability(name, vCores, supportedIops, supportedMemoryPerVCoreMB, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<SkuCapability>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SkuCapability)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        SkuCapability IPersistableModel<SkuCapability>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SkuCapability)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<SkuCapability>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
