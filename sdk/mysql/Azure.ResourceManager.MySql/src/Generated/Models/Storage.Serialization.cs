...
{
    public partial class Storage : IUtf8JsonSerializable, IJsonModel<Storage>
    {
        ...
        internal static Storage DeserializeStorage(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            int? iops = default;
            EnableStatusEnum? autoGrow = default;
            EnableStatusEnum? logOnDisk = default;
            string storageSku = default;
            EnableStatusEnum? autoIoScaling = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("logOnDisk"u8))
                {
                    ...
                    logOnDisk = new EnableStatusEnum(property.Value.GetString());
                    continue;
                }
                ...
                if (property.NameEquals("autoIoScaling"u8))
                {
                    ...
                    autoIoScaling = new EnableStatusEnum(property.Value.GetString());
                    continue;
                }
