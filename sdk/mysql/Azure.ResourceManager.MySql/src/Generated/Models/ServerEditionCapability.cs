...
namespace Azure.ResourceManager.MySql.Models
{
    ...
    public partial class ServerEditionCapability
    {
        ...
        /// <summary> Initializes a new instance of <see cref="ServerEditionCapability"/>. </summary>
        ...
        internal ServerEditionCapability(string name, IReadOnlyList<StorageEditionCapability> supportedStorageEditions, IReadOnlyList<ServerVersionCapability> supportedServerVersions, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
