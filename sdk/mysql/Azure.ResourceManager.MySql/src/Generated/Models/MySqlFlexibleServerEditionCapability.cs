...
namespace Azure.ResourceManager.MySql.FlexibleServers.Models
{
    ...
    public partial class MySqlFlexibleServerEditionCapability
    {
        ...
        internal MySqlFlexibleServerEditionCapability(string name, IReadOnlyList<MySqlFlexibleServerStorageEditionCapability> supportedStorageEditions, IReadOnlyList<MySqlFlexibleServerServerVersionCapability> supportedServerVersions, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Name = name;
