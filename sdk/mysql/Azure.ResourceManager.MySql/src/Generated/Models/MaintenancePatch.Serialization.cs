...
namespace Azure.ResourceManager.MySql.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MaintenancePatch>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MaintenancePatch)} does not support writing '{format}' format.");
            }
        ...
        MaintenancePatch IJsonModel<MaintenancePatch>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MaintenancePatch)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<MaintenancePatch>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(MaintenancePatch)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        MaintenancePatch IPersistableModel<MaintenancePatch>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(MaintenancePatch)} does not support reading '{options.Format}' format.");
            }
        }
