...
namespace Azure.ResourceManager.MySql.FlexibleServers.Models
{
    ...
    internal partial class MaintenancePropertiesForUpdate : IJsonModel<MaintenancePropertiesForUpdate>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        MaintenancePropertiesForUpdate IJsonModel<MaintenancePropertiesForUpdate>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual MaintenancePropertiesForUpdate JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<MaintenancePropertiesForUpdate>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MaintenancePropertiesForUpdate)} does not support reading '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static MaintenancePropertiesForUpdate DeserializeMaintenancePropertiesForUpdate(JsonElement element, ModelReaderWriterOptions options)
        {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<MaintenancePropertiesForUpdate>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        protected virtual BinaryData PersistableModelWriteCore(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(MaintenancePropertiesForUpdate)} does not support writing '{options.Format}' format.");
            }
        }
