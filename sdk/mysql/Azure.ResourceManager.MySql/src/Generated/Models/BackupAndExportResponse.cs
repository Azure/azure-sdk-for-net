...
namespace Azure.ResourceManager.MySql.Models
{
    ...
    public partial class BackupAndExportResponse : ResourceData
    {
        ...
        /// <summary> Initializes a new instance of <see cref="BackupAndExportResponse"/>. </summary>
        internal BackupAndExportResponse()
        {
        }
        ...
        internal BackupAndExportResponse(ResourceIdentifier id, string name, ResourceType resourceType, ResourceManager.Models.SystemData systemData, long? datasourceSizeInBytes, long? dataTransferredInBytes, string backupMetadata, ResponseError error, OperationStatus? status, DateTimeOffset? startOn, DateTimeOffset? endOn, double? percentComplete, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
