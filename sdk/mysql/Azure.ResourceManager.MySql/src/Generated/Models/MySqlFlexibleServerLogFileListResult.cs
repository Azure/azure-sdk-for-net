...
namespace Azure.ResourceManager.MySql.FlexibleServers.Models
{
    ...
    internal partial class MySqlFlexibleServerLogFileListResult
    {
        ...
        /// <summary> Initializes a new instance of <see cref="MySqlFlexibleServerLogFileListResult"/>. </summary>
        /// <param name="value"> The LogFile items on this page. </param>
        /// <param name="nextLink"> The link to the next page of items. </param>
        /// <param name="additionalBinaryDataProperties"> Keeps track of any properties unknown to the library. </param>
        internal MySqlFlexibleServerLogFileListResult(IList<MySqlFlexibleServerLogFile> value, Uri nextLink, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            NextLink = nextLink;
        ...
        public IList<MySqlFlexibleServerLogFile> Value { get; }
