...
namespace Azure.ResourceManager.MySql.Models
{
    ...
    public partial class MaintenanceWindow
    {
        ...
        internal MaintenanceWindow(string customWindow, int? startHour, int? startMinute, int? dayOfWeek, BatchOfMaintenance? batchOfMaintenance, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
