    ...
    internal partial class DatabaseListResult : IUtf8JsonSerializable, IJsonModel<DatabaseListResult>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(Value))
            {
                ...
                {
                    writer.WriteObjectValue<DatabaseData>(item, options);
                }
        ...
        internal static DatabaseListResult DeserializeDatabaseListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            IReadOnlyList<DatabaseData> value = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("value"u8))
                {
                    ...
                    {
                        array.Add(DatabaseData.DeserializeDatabaseData(item, options));
                    }
                    value = array;
                    continue;
                }
            ...
            return new DatabaseListResult(value ?? new ChangeTrackingList<DatabaseData>(), nextLink, serializedAdditionalRawData);
        }
