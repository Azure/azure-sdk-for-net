...
namespace Azure.ResourceManager.MySql.Models
{
    ...
    public partial class NameAvailabilityRequest
    {
        ...
        internal NameAvailabilityRequest(string name, string type, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Type = type;
        ...
        /// <summary> Initializes a new instance of <see cref="NameAvailabilityRequest"/> for deserialization. </summary>
        internal NameAvailabilityRequest()
        {
        }
