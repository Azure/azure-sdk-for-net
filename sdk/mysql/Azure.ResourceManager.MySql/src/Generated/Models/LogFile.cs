...
namespace Azure.ResourceManager.MySql.Models
{
    ...
    public partial class LogFile : ResourceData
    {
        ...
        /// <summary> Initializes a new instance of <see cref="LogFile"/>. </summary>
        internal LogFile()
        {
        }
        ...
        internal LogFile(ResourceIdentifier id, string name, ResourceType resourceType, ResourceManager.Models.SystemData systemData, long? sizeInKB, DateTimeOffset? createdOn, DateTimeOffset? lastModifiedOn, string uri, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
            SizeInKB = sizeInKB;
            CreatedOn = createdOn;
