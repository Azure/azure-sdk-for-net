...
namespace Azure.ResourceManager.MySql.FlexibleServers.Models
{
    ...
    public partial class SkuCapabilityV2
    {
        ...
        internal SkuCapabilityV2(string name, long? vCores, long? supportedIops, long? supportedMemoryPerVCoreMB, IReadOnlyList<string> supportedZones, IReadOnlyList<string> supportedHAMode, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Name = name;
            VCores = vCores;
