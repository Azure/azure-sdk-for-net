    ...
    public partial class CapabilityProperties : IUtf8JsonSerializable, IJsonModel<CapabilityProperties>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (options.Format != "W" && Optional.IsCollectionDefined(SupportedFlexibleServerEditions))
            {
                ...
                {
                    writer.WriteObjectValue<ServerEditionCapability>(item, options);
                }
                writer.WriteEndArray();
            }
        ...
        internal static CapabilityProperties DeserializeCapabilityProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            IReadOnlyList<ServerEditionCapability> supportedFlexibleServerEditions = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("supportedFlexibleServerEditions"u8))
                {
                    ...
                    foreach (var item in property.Value.EnumerateArray())
                    {
                        array.Add(ServerEditionCapability.DeserializeServerEditionCapability(item, options));
                    }
            ...
            return new CapabilityProperties(zone, supportedHAMode ?? new ChangeTrackingList<string>(), supportedGeoBackupRegions ?? new ChangeTrackingList<string>(), supportedFlexibleServerEditions ?? new ChangeTrackingList<ServerEditionCapability>(), serializedAdditionalRawData);
        }
