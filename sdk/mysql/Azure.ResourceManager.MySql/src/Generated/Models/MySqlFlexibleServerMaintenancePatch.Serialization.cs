...
namespace Azure.ResourceManager.MySql.FlexibleServers.Models
{
    ...
    public partial class MySqlFlexibleServerMaintenancePatch : IJsonModel<MySqlFlexibleServerMaintenancePatch>
    {
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual MySqlFlexibleServerMaintenancePatch PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
        ...
        internal static RequestContent ToRequestContent(MySqlFlexibleServerMaintenancePatch mySqlFlexibleServerMaintenancePatch)
        {
            ...
            return RequestContent.Create(mySqlFlexibleServerMaintenancePatch, ModelSerializationExtensions.WireOptions);
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        MySqlFlexibleServerMaintenancePatch IJsonModel<MySqlFlexibleServerMaintenancePatch>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual MySqlFlexibleServerMaintenancePatch JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<MySqlFlexibleServerMaintenancePatch>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static MySqlFlexibleServerMaintenancePatch DeserializeMySqlFlexibleServerMaintenancePatch(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            MaintenancePropertiesForUpdate properties = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = MaintenancePropertiesForUpdate.DeserializeMaintenancePropertiesForUpdate(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
