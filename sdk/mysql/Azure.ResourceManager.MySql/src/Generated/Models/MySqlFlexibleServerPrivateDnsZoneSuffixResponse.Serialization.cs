...
namespace Azure.ResourceManager.MySql.FlexibleServers.Models
{
    ...
    public partial class MySqlFlexibleServerPrivateDnsZoneSuffixResponse : IJsonModel<MySqlFlexibleServerPrivateDnsZoneSuffixResponse>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        MySqlFlexibleServerPrivateDnsZoneSuffixResponse IJsonModel<MySqlFlexibleServerPrivateDnsZoneSuffixResponse>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual MySqlFlexibleServerPrivateDnsZoneSuffixResponse JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<MySqlFlexibleServerPrivateDnsZoneSuffixResponse>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static MySqlFlexibleServerPrivateDnsZoneSuffixResponse DeserializeMySqlFlexibleServerPrivateDnsZoneSuffixResponse(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            {
                if (prop.NameEquals("privateDnsZoneSuffix"u8))
                {
                    privateDnsZoneSuffix = prop.Value.GetString();
                    continue;
                }
                if (options.Format != "W")
                {
