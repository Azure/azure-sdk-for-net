...
namespace Azure.ResourceManager.MySql.Models
{
    ...
    public partial class StorageEditionCapability
    {
        ...
        /// <summary> Initializes a new instance of <see cref="StorageEditionCapability"/>. </summary>
        ...
        internal StorageEditionCapability(string name, long? minStorageSize, long? maxStorageSize, long? minBackupRetentionDays, long? maxBackupRetentionDays, long? minBackupIntervalHours, long? maxBackupIntervalHours, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
