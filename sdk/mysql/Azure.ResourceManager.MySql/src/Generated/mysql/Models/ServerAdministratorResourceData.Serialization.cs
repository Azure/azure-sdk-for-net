...
{
    public partial class ServerAdministratorResourceData : IUtf8JsonSerializable
    {
        ...
        internal static ServerAdministratorResourceData DeserializeServerAdministratorResourceData(JsonElement element)
        {
            ...
            return new ServerAdministratorResourceData(id, name, type, systemData.Value, Optional.ToNullable(administratorType), login.Value, Optional.ToNullable(sid), Optional.ToNullable(tenantId));
        }
    }
}
