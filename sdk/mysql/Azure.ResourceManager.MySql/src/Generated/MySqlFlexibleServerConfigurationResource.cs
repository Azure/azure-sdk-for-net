...
namespace Azure.ResourceManager.MySql.FlexibleServers
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="MySqlFlexibleServerConfigurationResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="MySqlFlexibleServerResource"/> using the GetMySqlFlexibleServerConfigurations method.
    /// </summary>
    public partial class MySqlFlexibleServerConfigurationResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of MySqlFlexibleServerConfigurationResource for mocking. </summary>
        protected MySqlFlexibleServerConfigurationResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="MySqlFlexibleServerConfigurationResource"/> class. </summary>
        ...
        {
            string resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforMySQL/flexibleServers/{serverName}/configurations/{configurationName}";
        ...
        {
            using DiagnosticScope scope = _configurationsClientDiagnostics.CreateScope("MySqlFlexibleServerConfigurationResource.Get");
            scope.Start();
            try
            {
        ...
        public virtual async Task<ArmOperation<MySqlFlexibleServerConfigurationResource>> UpdateAsync(WaitUntil waitUntil, MySqlFlexibleServerConfigurationData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _configurationsClientDiagnostics.CreateScope("MySqlFlexibleServerConfigurationResource.Update");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
