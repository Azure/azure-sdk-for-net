...
namespace Azure.ResourceManager.MySql.FlexibleServers
{
    public partial class MySqlFlexibleServerMaintenanceResource : IJsonModel<MySqlFlexibleServerMaintenanceData>
    {
        ...
        BinaryData IPersistableModel<MySqlFlexibleServerMaintenanceData>.Write(ModelReaderWriterOptions options) => ModelReaderWriter.Write<MySqlFlexibleServerMaintenanceData>(Data, options, AzureResourceManagerMySqlFlexibleServersContext.Default);

        MySqlFlexibleServerMaintenanceData IPersistableModel<MySqlFlexibleServerMaintenanceData>.Create(BinaryData data, ModelReaderWriterOptions options) => ModelReaderWriter.Read<MySqlFlexibleServerMaintenanceData>(data, options, AzureResourceManagerMySqlFlexibleServersContext.Default);
