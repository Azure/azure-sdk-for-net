...
namespace Azure.ResourceManager.MySql
{
    ...
    public partial class ConfigurationData : ResourceData
    {
        ...
        internal ConfigurationData(ResourceIdentifier id, string name, ResourceType resourceType, ResourceManager.Models.SystemData systemData, string value, string currentValue, string description, string documentationLink, string defaultValue, string dataType, string allowedValues, ConfigurationSource? source, IsReadOnly? isReadOnly, IsConfigPendingRestart? isConfigPendingRestart, IsDynamicConfig? isDynamicConfig, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
            Value = value;
