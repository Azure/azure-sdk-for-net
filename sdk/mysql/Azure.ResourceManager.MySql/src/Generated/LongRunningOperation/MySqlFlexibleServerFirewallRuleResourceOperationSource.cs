...
{
    /// <summary></summary>
    internal partial class MySqlFlexibleServerFirewallRuleResourceOperationSource : IOperationSource<MySqlFlexibleServerFirewallRuleResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal MySqlFlexibleServerFirewallRuleResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
