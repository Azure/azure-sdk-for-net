...
{
    /// <summary></summary>
    internal partial class MySqlFlexibleServerDatabaseResourceOperationSource : IOperationSource<MySqlFlexibleServerDatabaseResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal MySqlFlexibleServerDatabaseResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
