...
{
    /// <summary></summary>
    internal partial class MySqlFlexibleServerBackupV2ResourceOperationSource : IOperationSource<MySqlFlexibleServerBackupV2Resource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal MySqlFlexibleServerBackupV2ResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
