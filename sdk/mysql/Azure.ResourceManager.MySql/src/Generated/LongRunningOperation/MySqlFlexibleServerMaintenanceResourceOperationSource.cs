...
{
    /// <summary></summary>
    internal partial class MySqlFlexibleServerMaintenanceResourceOperationSource : IOperationSource<MySqlFlexibleServerMaintenanceResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal MySqlFlexibleServerMaintenanceResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
