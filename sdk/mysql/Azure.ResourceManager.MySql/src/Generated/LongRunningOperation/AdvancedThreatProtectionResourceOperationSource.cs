...
{
    /// <summary></summary>
    internal partial class AdvancedThreatProtectionResourceOperationSource : IOperationSource<AdvancedThreatProtectionResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal AdvancedThreatProtectionResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
