...
namespace Azure.ResourceManager.MySql.FlexibleServers
{
    internal class MySqlFlexibleServerOperationSource : IOperationSource<MySqlFlexibleServerResource>
    {
        ...
        {
            var data = ModelReaderWriter.Read<MySqlFlexibleServerData>(response.Content, ModelReaderWriterOptions.Json, AzureResourceManagerMySqlFlexibleServersContext.Default);
