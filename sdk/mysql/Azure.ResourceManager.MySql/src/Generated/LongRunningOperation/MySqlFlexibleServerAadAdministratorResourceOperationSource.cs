...
{
    /// <summary></summary>
    internal partial class MySqlFlexibleServerAadAdministratorResourceOperationSource : IOperationSource<MySqlFlexibleServerAadAdministratorResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal MySqlFlexibleServerAadAdministratorResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
