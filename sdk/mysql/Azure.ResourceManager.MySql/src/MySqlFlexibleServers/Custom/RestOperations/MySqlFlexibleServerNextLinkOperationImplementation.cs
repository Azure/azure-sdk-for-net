...
namespace Azure.Core
{
    internal class MySqlFlexibleServerNextLinkOperationImplementation : IOperation
    {
            ...
            string? apiVersionOverrideValue = null)
        {
            ...
            return new MySqlFlexibleServerNextLinkOperationImplementation(pipeline, requestMethod, startRequestUri, nextRequestUri, headerSource, lastKnownLocation, finalStateVia, apiVersionStr);
        }
            ...
            RehydrationToken rehydrationToken)
        {
            ...
            return new MySqlFlexibleServerNextLinkOperationImplementation(pipeline, requestMethod, startRequestUri, nextRequestUri, headerSource, lastKnownLocation, finalStateVia, null, rehydrationToken.Id);
        }
        ...
        private MySqlFlexibleServerNextLinkOperationImplementation(
            HttpPipeline pipeline,
            RequestMethod requestMethod,
            Uri startRequestUri,
        ...
        {
            // We should have a method on the ArmOperation to add policies, and consume the policies here
