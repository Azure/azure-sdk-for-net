...
namespace Azure.ResourceManager.MySql.FlexibleServers.Models
{
    ...
    internal readonly partial struct ObjectType : IEquatable<ObjectType>
    {
        ...
        private const string MySqlFlexibleServerBackupAndExportResultValue = "BackupAndExportResponse";
        private const string MySqlFlexibleServerImportFromStorageResultValue = "ImportFromStorageResponse";

        /// <summary> BackupAndExportResponse. </summary>
        public static ObjectType MySqlFlexibleServerBackupAndExportResult { get; } = new ObjectType(MySqlFlexibleServerBackupAndExportResultValue);
        /// <summary> ImportFromStorageResponse. </summary>
        public static ObjectType MySqlFlexibleServerImportFromStorageResult { get; } = new ObjectType(MySqlFlexibleServerImportFromStorageResultValue);
