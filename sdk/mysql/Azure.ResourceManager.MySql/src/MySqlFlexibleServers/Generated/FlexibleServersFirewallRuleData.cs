...
{
    /// <summary> A class representing the FlexibleServersFirewallRule data model. </summary>
    public partial class FlexibleServersFirewallRuleData : ResourceData
    {
        /// <summary> Initializes a new instance of FlexibleServersFirewallRuleData. </summary>
        ...
        public FlexibleServersFirewallRuleData(string startIPAddress, string endIPAddress)
        {
        ...
        /// <param name="startIPAddress"> The start IP address of the server firewall rule. Must be IPv4 format. </param>
        /// <param name="endIPAddress"> The end IP address of the server firewall rule. Must be IPv4 format. </param>
        internal FlexibleServersFirewallRuleData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string startIPAddress, string endIPAddress) : base(id, name, resourceType, systemData)
        {
            StartIPAddress = startIPAddress;
            EndIPAddress = endIPAddress;
        }
