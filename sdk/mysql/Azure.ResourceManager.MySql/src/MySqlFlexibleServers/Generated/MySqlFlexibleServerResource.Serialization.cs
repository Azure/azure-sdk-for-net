...
namespace Azure.ResourceManager.MySql.FlexibleServers
{
    public partial class MySqlFlexibleServerResource : IJsonModel<MySqlFlexibleServerData>
    {
        ...
        BinaryData IPersistableModel<MySqlFlexibleServerData>.Write(ModelReaderWriterOptions options) => ModelReaderWriter.Write<MySqlFlexibleServerData>(Data, options, MySql.AzureResourceManagerMySqlContext.Default);

        MySqlFlexibleServerData IPersistableModel<MySqlFlexibleServerData>.Create(BinaryData data, ModelReaderWriterOptions options) => ModelReaderWriter.Read<MySqlFlexibleServerData>(data, options, MySql.AzureResourceManagerMySqlContext.Default);
