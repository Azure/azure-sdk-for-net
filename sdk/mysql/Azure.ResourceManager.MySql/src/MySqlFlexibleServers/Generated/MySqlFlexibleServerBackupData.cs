...
namespace Azure.ResourceManager.MySql.FlexibleServers
{
    ...
    public partial class MySqlFlexibleServerBackupData : ResourceData
    {
        ...
        internal MySqlFlexibleServerBackupData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string backupType, DateTimeOffset? completedOn, string source, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData)
        {
