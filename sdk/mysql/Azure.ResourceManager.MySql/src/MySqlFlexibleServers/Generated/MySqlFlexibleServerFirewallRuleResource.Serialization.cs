...
namespace Azure.ResourceManager.MySql.FlexibleServers
{
    public partial class MySqlFlexibleServerFirewallRuleResource : IJsonModel<MySqlFlexibleServerFirewallRuleData>
    {
        ...
        BinaryData IPersistableModel<MySqlFlexibleServerFirewallRuleData>.Write(ModelReaderWriterOptions options) => ModelReaderWriter.Write<MySqlFlexibleServerFirewallRuleData>(Data, options, MySql.AzureResourceManagerMySqlContext.Default);

        MySqlFlexibleServerFirewallRuleData IPersistableModel<MySqlFlexibleServerFirewallRuleData>.Create(BinaryData data, ModelReaderWriterOptions options) => ModelReaderWriter.Read<MySqlFlexibleServerFirewallRuleData>(data, options, MySql.AzureResourceManagerMySqlContext.Default);
