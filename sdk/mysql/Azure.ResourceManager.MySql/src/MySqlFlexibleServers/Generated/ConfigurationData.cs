...
namespace Azure.ResourceManager.MySql.FlexibleServers
{
    ...
    public partial class ConfigurationData : ResourceData
    {
        ...
        internal ConfigurationData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string value, string description, string defaultValue, string dataType, string allowedValues, ConfigurationSource? source, IsReadOnly? isReadOnly, IsConfigPendingRestart? isConfigPendingRestart, IsDynamicConfig? isDynamicConfig) : base(id, name, resourceType, systemData)
        {
            Value = value;
        ...
        public IsReadOnly? IsReadOnly { get; }
        /// <summary> If is the configuration pending restart or not. </summary>
        public IsConfigPendingRestart? IsConfigPendingRestart { get; }
        /// <summary> If is the configuration dynamic. </summary>
        public IsDynamicConfig? IsDynamicConfig { get; }
    }
}
