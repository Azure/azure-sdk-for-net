...
namespace Azure.ResourceManager.MySql.FlexibleServers
{
    ...
    public partial class ServerResource : ArmResource
    {
        ...
        {
            _serverClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.MySql.FlexibleServers", ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation> FailoverAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new FlexibleServersArmOperation(_serverClientDiagnostics, Pipeline, _serverRestClient.CreateFailoverRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                    await operation.WaitForCompletionResponseAsync(cancellationToken).ConfigureAwait(false);
                return operation;
            }
        ...
        public virtual async Task<ArmOperation> RestartAsync(WaitUntil waitUntil, ServerRestartParameter serverRestartParameter, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new FlexibleServersArmOperation(_serverClientDiagnostics, Pipeline, _serverRestClient.CreateRestartRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, serverRestartParameter).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                    await operation.WaitForCompletionResponseAsync(cancellationToken).ConfigureAwait(false);
                return operation;
            }
        ...
        public virtual async Task<ArmOperation<ConfigurationListResult>> BatchUpdateConfigurationAsync(WaitUntil waitUntil, ConfigurationListForBatchUpdate configurationListForBatchUpdate, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new FlexibleServersArmOperation<ConfigurationListResult>(new ConfigurationListResultOperationSource(), _configurationClientDiagnostics, Pipeline, _configurationRestClient.CreateBatchUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, configurationListForBatchUpdate).Request, response, OperationFinalStateVia.AzureAsyncOperation);
                if (waitUntil == WaitUntil.Completed)
                    await operation.WaitForCompletionAsync(cancellationToken).ConfigureAwait(false);
                return operation;
            }
