...
namespace Azure.ResourceManager.MySql.FlexibleServers.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MySqlFlexibleServerVirtualNetworkSubnetUsageResult>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<MySqlFlexibleServerVirtualNetworkSubnetUsageResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MySqlFlexibleServerVirtualNetworkSubnetUsageResult>)} interface");
            }
        ...
        string IPersistableModel<MySqlFlexibleServerVirtualNetworkSubnetUsageResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
