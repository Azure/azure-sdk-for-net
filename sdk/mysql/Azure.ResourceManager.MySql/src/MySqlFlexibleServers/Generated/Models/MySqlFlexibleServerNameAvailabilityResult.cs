...
namespace Azure.ResourceManager.MySql.FlexibleServers.Models
{
    ...
    public partial class MySqlFlexibleServerNameAvailabilityResult
    {
        ...
        internal MySqlFlexibleServerNameAvailabilityResult(string message, bool? isNameAvailable, string reason, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Message = message;
