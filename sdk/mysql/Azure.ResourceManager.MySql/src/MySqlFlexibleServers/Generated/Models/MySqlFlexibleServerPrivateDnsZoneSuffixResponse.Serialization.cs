...
namespace Azure.ResourceManager.MySql.FlexibleServers.Models
{
    public partial class MySqlFlexibleServerPrivateDnsZoneSuffixResponse : IUtf8JsonSerializable, IJsonModel<MySqlFlexibleServerPrivateDnsZoneSuffixResponse>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(PrivateDnsZoneSuffix), out propertyOverride);
            if (Optional.IsDefined(PrivateDnsZoneSuffix) || hasPropertyOverride)
            {
                builder.Append("  privateDnsZoneSuffix: ");
                ...
                {
                    if (PrivateDnsZoneSuffix.Contains(Environment.NewLine))
                    {
                        builder.AppendLine("'''");
                        builder.AppendLine($"{PrivateDnsZoneSuffix}'''");
                    }
                    else
                    {
                        builder.AppendLine($"'{PrivateDnsZoneSuffix}'");
