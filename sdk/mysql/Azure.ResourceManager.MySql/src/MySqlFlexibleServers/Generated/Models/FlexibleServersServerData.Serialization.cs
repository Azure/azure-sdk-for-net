...
{
    public partial class FlexibleServersServerData : IUtf8JsonSerializable
    {
        ...
        internal static FlexibleServersServerData DeserializeFlexibleServersServerData(JsonElement element)
        {
            Optional<Identity> identity = default;
            Optional<FlexibleServersSku> sku = default;
            ...
            Optional<FlexibleServersServerVersion> version = default;
            Optional<string> availabilityZone = default;
            Optional<FlexibleServersCreateMode> createMode = default;
            Optional<string> sourceServerResourceId = default;
            Optional<DateTimeOffset> restorePointInTime = default;
            Optional<ReplicationRole> replicationRole = default;
            Optional<int> replicaCapacity = default;
            Optional<DataEncryption> dataEncryption = default;
            Optional<FlexibleServersServerState> state = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("sku"))
                {
                    ...
                    sku = FlexibleServersSku.DeserializeFlexibleServersSku(property.Value);
                    continue;
                }
                ...
                if (property.NameEquals("properties"))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("version"))
                        {
                            ...
                            version = new FlexibleServersServerVersion(property0.Value.GetString());
                            continue;
                        }
                        ...
                        if (property0.NameEquals("createMode"))
                        {
                            ...
                            createMode = new FlexibleServersCreateMode(property0.Value.GetString());
                            continue;
                        }
                        ...
                        if (property0.NameEquals("dataEncryption"))
                        {
                            ...
                            dataEncryption = DataEncryption.DeserializeDataEncryption(property0.Value);
                            continue;
                        }
                        if (property0.NameEquals("state"))
                        {
                            ...
                            state = new FlexibleServersServerState(property0.Value.GetString());
                            continue;
                        }
