...
{
    public partial class MySqlFlexibleServerStorage : IUtf8JsonSerializable, IJsonModel<MySqlFlexibleServerStorage>, IPersistableModel<MySqlFlexibleServerStorage>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(LogOnDisk))
            {
                ...
                builder.AppendLine($" '{LogOnDisk.ToString()}'");
            }
            ...
            if (Optional.IsDefined(AutoIoScaling))
            {
                ...
                builder.AppendLine($" '{AutoIoScaling.ToString()}'");
            }
