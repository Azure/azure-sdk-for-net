...
namespace Azure.ResourceManager.MySql.FlexibleServers.Models
{
    public partial class MySqlFlexibleServerNetwork : IUtf8JsonSerializable, IJsonModel<MySqlFlexibleServerNetwork>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(DelegatedSubnetResourceId) || hasPropertyOverride)
            {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(PrivateDnsZoneResourceId), out propertyOverride);
            if (Optional.IsDefined(PrivateDnsZoneResourceId) || hasPropertyOverride)
            {
