...
{
    public partial class ServerBackupData : IUtf8JsonSerializable
    {
        ...
        internal static ServerBackupData DeserializeServerBackupData(JsonElement element)
        {
            ...
            return new ServerBackupData(id, name, type, systemData.Value, backupType.Value, Optional.ToNullable(completedTime), source.Value);
        }
    }
}
