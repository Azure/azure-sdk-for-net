...
{
    public partial class MySqlFlexibleServersPrivateLinkServiceConnectionState : IUtf8JsonSerializable, IJsonModel<MySqlFlexibleServersPrivateLinkServiceConnectionState>, IPersistableModel<MySqlFlexibleServersPrivateLinkServiceConnectionState>
    {
        ...
        void IJsonModel<MySqlFlexibleServersPrivateLinkServiceConnectionState>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MySqlFlexibleServersPrivateLinkServiceConnectionState)} does not support '{format}' format.");
            }
