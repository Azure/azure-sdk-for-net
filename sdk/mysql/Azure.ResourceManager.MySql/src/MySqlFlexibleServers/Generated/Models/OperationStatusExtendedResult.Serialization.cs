...
namespace Azure.ResourceManager.MySql.FlexibleServers.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<OperationStatusExtendedResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<OperationStatusExtendedResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<OperationStatusExtendedResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<OperationStatusExtendedResult>)} interface");
            }
        ...
        string IPersistableModel<OperationStatusExtendedResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
