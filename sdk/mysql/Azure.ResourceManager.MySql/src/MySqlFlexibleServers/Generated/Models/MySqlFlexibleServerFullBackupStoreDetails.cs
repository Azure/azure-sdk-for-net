...
namespace Azure.ResourceManager.MySql.FlexibleServers.Models
{
    ...
    public partial class MySqlFlexibleServerFullBackupStoreDetails : MySqlFlexibleServerBackupStoreDetails
    {
        ...
        internal MySqlFlexibleServerFullBackupStoreDetails(string objectType, IList<string> sasUriList, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(objectType, serializedAdditionalRawData)
        {
