...
namespace Azure.ResourceManager.MySql.FlexibleServers.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<OperationProgressResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<OperationProgressResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(OperationProgressResult)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<OperationProgressResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(OperationProgressResult)} does not support '{options.Format}' format.");
            }
        }
