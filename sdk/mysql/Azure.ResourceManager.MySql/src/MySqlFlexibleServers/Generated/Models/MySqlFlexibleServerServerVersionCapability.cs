...
namespace Azure.ResourceManager.MySql.FlexibleServers.Models
{
    ...
    public partial class MySqlFlexibleServerServerVersionCapability
    {
        ...
        internal MySqlFlexibleServerServerVersionCapability(string name, IReadOnlyList<MySqlFlexibleServerSkuCapability> supportedSkus, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
