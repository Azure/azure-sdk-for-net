...
{
    public partial class MySqlFlexibleServerMaintenanceWindow : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static MySqlFlexibleServerMaintenanceWindow DeserializeMySqlFlexibleServerMaintenanceWindow(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
