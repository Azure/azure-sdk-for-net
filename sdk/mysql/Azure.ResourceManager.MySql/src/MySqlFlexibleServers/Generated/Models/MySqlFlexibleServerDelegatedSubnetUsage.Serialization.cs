...
namespace Azure.ResourceManager.MySql.FlexibleServers.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MySqlFlexibleServerDelegatedSubnetUsage>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        MySqlFlexibleServerDelegatedSubnetUsage IJsonModel<MySqlFlexibleServerDelegatedSubnetUsage>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<MySqlFlexibleServerDelegatedSubnetUsage>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        MySqlFlexibleServerDelegatedSubnetUsage IModel<MySqlFlexibleServerDelegatedSubnetUsage>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<MySqlFlexibleServerDelegatedSubnetUsage>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
