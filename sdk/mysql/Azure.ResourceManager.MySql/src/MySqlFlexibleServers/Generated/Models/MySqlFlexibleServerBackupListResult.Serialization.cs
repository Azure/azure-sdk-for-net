...
namespace Azure.ResourceManager.MySql.FlexibleServers.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MySqlFlexibleServerBackupListResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(Value))
            {
                ...
                {
                    ((IJsonModel<MySqlFlexibleServerBackupData>)item).Write(writer, options);
                }
        ...
        internal static MySqlFlexibleServerBackupListResult DeserializeMySqlFlexibleServerBackupListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new MySqlFlexibleServerBackupListResult(value ?? new ChangeTrackingList<MySqlFlexibleServerBackupData>(), nextLink, serializedAdditionalRawData);
        }
