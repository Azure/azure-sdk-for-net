...
namespace Azure.ResourceManager.MySql.FlexibleServers.Models
{
    ...
    public partial class MySqlFlexibleServerBackupAndExportContent : MySqlFlexibleServerBackupContentBase
    {
        ...
        internal MySqlFlexibleServerBackupAndExportContent(MySqlFlexibleServerBackupSettings backupSettings, MySqlFlexibleServerBackupStoreDetails targetDetails, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(backupSettings, serializedAdditionalRawData)
        {
            TargetDetails = targetDetails;
        }
