...
namespace Azure.ResourceManager.MySql.FlexibleServers.Models
{
    public partial class MySqlFlexibleServerServerVersionCapability : IUtf8JsonSerializable, IJsonModel<MySqlFlexibleServerServerVersionCapability>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(SupportedSkus), out propertyOverride);
            if (Optional.IsCollectionDefined(SupportedSkus) || hasPropertyOverride)
            {
                if (SupportedSkus.Any() || hasPropertyOverride)
                {
                    ...
                    else
                    {
                        ...
                        foreach (var item in SupportedSkus)
                        {
                            AppendChildObject(builder, item, options, 4, true, "  supportedSkus: ");
                        }
                        builder.AppendLine("  ]");
                    }
                }
