...
namespace Azure.ResourceManager.MySql.FlexibleServers.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MySqlFlexibleServerVirtualNetworkSubnetUsageParameter>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<MySqlFlexibleServerVirtualNetworkSubnetUsageParameter>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MySqlFlexibleServerVirtualNetworkSubnetUsageParameter>)} interface");
            }
        ...
        string IPersistableModel<MySqlFlexibleServerVirtualNetworkSubnetUsageParameter>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
