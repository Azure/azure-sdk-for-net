...
namespace Azure.ResourceManager.MySql.FlexibleServers.Models
{
    public partial class MySqlFlexibleServerGtidSetContent : IUtf8JsonSerializable, IJsonModel<MySqlFlexibleServerGtidSetContent>
    {
        ...
        void IJsonModel<MySqlFlexibleServerGtidSetContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(MySqlFlexibleServerGtidSetContent)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<MySqlFlexibleServerGtidSetContent>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(MySqlFlexibleServerGtidSetContent)} does not support '{options.Format}' format.");
            }
        }
