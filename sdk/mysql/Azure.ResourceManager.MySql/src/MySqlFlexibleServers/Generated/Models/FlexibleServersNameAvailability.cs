...
namespace Azure.ResourceManager.MySql.FlexibleServers.Models
{
    ...
    public partial class FlexibleServersNameAvailability
    {
        /// <summary> Initializes a new instance of FlexibleServersNameAvailability. </summary>
        internal FlexibleServersNameAvailability()
        {
        }
        ...
        internal FlexibleServersNameAvailability(string message, bool? nameAvailable, string reason)
        {
            Message = message;
