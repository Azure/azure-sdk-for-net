...
namespace Azure.ResourceManager.MySql.FlexibleServers.Models
{
    ...
    public partial class MySqlFlexibleServerVirtualNetworkSubnetUsageResult
    {
        ...
        internal MySqlFlexibleServerVirtualNetworkSubnetUsageResult(AzureLocation? location, string subscriptionId, IReadOnlyList<MySqlFlexibleServerDelegatedSubnetUsage> delegatedSubnetsUsage, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Location = location;
