...
{
    public partial class MySqlFlexibleServersMySqlFlexibleServerPatch : IUtf8JsonSerializable, IJsonModel<MySqlFlexibleServersMySqlFlexibleServerPatch>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MySqlFlexibleServersMySqlFlexibleServerPatch>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<MySqlFlexibleServersMySqlFlexibleServerPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<MySqlFlexibleServersMySqlFlexibleServerPatch>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MySqlFlexibleServersMySqlFlexibleServerPatch)} does not support writing '{format}' format.");
            }
        ...
        MySqlFlexibleServersMySqlFlexibleServerPatch IJsonModel<MySqlFlexibleServersMySqlFlexibleServerPatch>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<MySqlFlexibleServersMySqlFlexibleServerPatch>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MySqlFlexibleServersMySqlFlexibleServerPatch)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeMySqlFlexibleServersMySqlFlexibleServerPatch(document.RootElement, options);
        }

        internal static MySqlFlexibleServersMySqlFlexibleServerPatch DeserializeMySqlFlexibleServersMySqlFlexibleServerPatch(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new MySqlFlexibleServersMySqlFlexibleServerPatch(
                identity,
                sku,
        ...
        BinaryData IPersistableModel<MySqlFlexibleServersMySqlFlexibleServerPatch>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<MySqlFlexibleServersMySqlFlexibleServerPatch>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(MySqlFlexibleServersMySqlFlexibleServerPatch)} does not support writing '{options.Format}' format.");
            }
        }

        MySqlFlexibleServersMySqlFlexibleServerPatch IPersistableModel<MySqlFlexibleServersMySqlFlexibleServerPatch>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<MySqlFlexibleServersMySqlFlexibleServerPatch>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(MySqlFlexibleServersMySqlFlexibleServerPatch)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<MySqlFlexibleServersMySqlFlexibleServerPatch>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
