...
namespace Azure.ResourceManager.MySql.FlexibleServers
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MySqlFlexibleServerFirewallRuleData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MySqlFlexibleServerFirewallRuleData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MySqlFlexibleServerFirewallRuleData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MySqlFlexibleServerFirewallRuleData>)} interface");
            }
        ...
        string IPersistableModel<MySqlFlexibleServerFirewallRuleData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
