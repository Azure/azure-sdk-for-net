...
namespace Azure.ResourceManager.MySql.FlexibleServers.Models
{
    ...
    public partial class MySqlFlexibleServerConfigurationForBatchUpdate
    {
        ...
        internal MySqlFlexibleServerConfigurationForBatchUpdate(string name, string value, string source, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Value = value;
            Source = source;
