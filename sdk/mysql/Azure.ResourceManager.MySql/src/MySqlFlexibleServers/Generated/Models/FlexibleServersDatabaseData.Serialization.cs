...
{
    public partial class FlexibleServersDatabaseData : IUtf8JsonSerializable
    {
        ...
        internal static FlexibleServersDatabaseData DeserializeFlexibleServersDatabaseData(JsonElement element)
        {
            ...
            return new FlexibleServersDatabaseData(id, name, type, systemData.Value, charset.Value, collation.Value);
        }
    }
}
