...
namespace Azure.ResourceManager.MySql.FlexibleServers.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ServerEditionCapabilityV2>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ServerEditionCapabilityV2>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ServerEditionCapabilityV2>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ServerEditionCapabilityV2>)} interface");
            }
        ...
        string IPersistableModel<ServerEditionCapabilityV2>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
