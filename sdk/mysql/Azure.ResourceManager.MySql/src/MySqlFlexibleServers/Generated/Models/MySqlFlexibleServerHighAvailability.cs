...
namespace Azure.ResourceManager.MySql.FlexibleServers.Models
{
    ...
    public partial class MySqlFlexibleServerHighAvailability
    {
        ...
        internal MySqlFlexibleServerHighAvailability(MySqlFlexibleServerHighAvailabilityMode? mode, MySqlFlexibleServerHighAvailabilityState? state, string standbyAvailabilityZone, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Mode = mode;
            State = state;
