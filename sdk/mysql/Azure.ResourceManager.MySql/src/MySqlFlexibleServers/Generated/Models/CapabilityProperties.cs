...
namespace Azure.ResourceManager.MySql.FlexibleServers.Models
{
    ...
    public partial class CapabilityProperties
    {
        ...
        internal CapabilityProperties(string zone, IReadOnlyList<string> supportedHAMode, IReadOnlyList<string> supportedGeoBackupRegions, IReadOnlyList<ServerEditionCapability> supportedFlexibleServerEditions)
        {
            Zone = zone;
