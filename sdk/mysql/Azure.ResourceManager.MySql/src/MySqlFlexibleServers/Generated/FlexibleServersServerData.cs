...
{
    /// <summary> A class representing the FlexibleServersServer data model. </summary>
    public partial class FlexibleServersServerData : TrackedResourceData
    {
        /// <summary> Initializes a new instance of FlexibleServersServerData. </summary>
        /// <param name="location"> The location. </param>
        public FlexibleServersServerData(AzureLocation location) : base(location)
        {
        }
        ...
        internal FlexibleServersServerData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, Identity identity, FlexibleServersSku sku, string administratorLogin, string administratorLoginPassword, FlexibleServersServerVersion? version, string availabilityZone, FlexibleServersCreateMode? createMode, string sourceServerResourceId, DateTimeOffset? restorePointInOn, ReplicationRole? replicationRole, int? replicaCapacity, DataEncryption dataEncryption, FlexibleServersServerState? state, string fullyQualifiedDomainName, Storage storage, Backup backup, HighAvailability highAvailability, Network network, MaintenanceWindow maintenanceWindow) : base(id, name, resourceType, systemData, tags, location)
        {
            Identity = identity;
            Sku = sku;
        ...
        public FlexibleServersServerState? State { get; }
