...
namespace Azure.ResourceManager.MySql.FlexibleServers
{
    internal class MySqlFlexibleServerMaintenanceOperationSource : IOperationSource<MySqlFlexibleServerMaintenanceResource>
    {
        ...
        {
            var data = ModelReaderWriter.Read<MySqlFlexibleServerMaintenanceData>(response.Content, ModelReaderWriterOptions.Json, MySql.AzureResourceManagerMySqlContext.Default);
