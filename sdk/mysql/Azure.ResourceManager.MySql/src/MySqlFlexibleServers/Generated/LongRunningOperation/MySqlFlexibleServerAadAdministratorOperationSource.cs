...
namespace Azure.ResourceManager.MySql.FlexibleServers
{
    internal class MySqlFlexibleServerAadAdministratorOperationSource : IOperationSource<MySqlFlexibleServerAadAdministratorResource>
    {
        ...
        {
            var data = ModelReaderWriter.Read<MySqlFlexibleServerAadAdministratorData>(response.Content, ModelReaderWriterOptions.Json, MySql.AzureResourceManagerMySqlContext.Default);
