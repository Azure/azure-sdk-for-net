...
namespace Azure.ResourceManager.MySql.FlexibleServers
{
    internal class MySqlFlexibleServerBackupV2OperationSource : IOperationSource<MySqlFlexibleServerBackupV2Resource>
    {
        ...
        {
            var data = ModelReaderWriter.Read<MySqlFlexibleServerBackupV2Data>(response.Content, ModelReaderWriterOptions.Json, MySql.AzureResourceManagerMySqlContext.Default);
