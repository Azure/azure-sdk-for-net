...
namespace Azure.ResourceManager.MySql.FlexibleServers
{
    internal class MySqlFlexibleServerDatabaseOperationSource : IOperationSource<MySqlFlexibleServerDatabaseResource>
    {
        ...
        {
            var data = ModelReaderWriter.Read<MySqlFlexibleServerDatabaseData>(response.Content, ModelReaderWriterOptions.Json, MySql.AzureResourceManagerMySqlContext.Default);
