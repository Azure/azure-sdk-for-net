...
namespace Azure.ResourceManager.MySql.FlexibleServers.Mocking
{
    ...
    public partial class MySqlFlexibleServersArmClientMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="MySqlFlexibleServersArmClientMockingExtension"/> class for mocking. </summary>
        protected MySqlFlexibleServersArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MySqlFlexibleServersArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MySqlFlexibleServersArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal MySqlFlexibleServersArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
