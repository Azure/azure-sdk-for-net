...
namespace Azure.ResourceManager.MySql.FlexibleServers.Mocking
{
    ...
    internal partial class FlexibleServersArmClientMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="FlexibleServersArmClientMockingExtension"/> class for mocking. </summary>
        protected FlexibleServersArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="FlexibleServersArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal FlexibleServersArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal FlexibleServersArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
