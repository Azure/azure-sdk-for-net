...
namespace Azure.ResourceManager.MySql.FlexibleServers.Mocking
{
    ...
    public partial class MySqlFlexibleServersTenantMockingExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="MySqlFlexibleServersTenantMockingExtension"/> class for mocking. </summary>
        protected MySqlFlexibleServersTenantMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MySqlFlexibleServersTenantMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MySqlFlexibleServersTenantMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        {
            using var scope = GetPrivateDnsZoneSuffixClientDiagnostics.CreateScope("MySqlFlexibleServersTenantMockingExtension.ExecuteGetPrivateDnsZoneSuffix");
            scope.Start();
            try
            {
