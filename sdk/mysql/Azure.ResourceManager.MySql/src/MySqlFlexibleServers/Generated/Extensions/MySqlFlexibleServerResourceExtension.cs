...
namespace Azure.ResourceManager.MySql.FlexibleServers.Mock
{
    ...
    public partial class MySqlFlexibleServerResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="MySqlFlexibleServerResourceExtension"/> class for mocking. </summary>
        protected MySqlFlexibleServerResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MySqlFlexibleServerResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MySqlFlexibleServerResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
