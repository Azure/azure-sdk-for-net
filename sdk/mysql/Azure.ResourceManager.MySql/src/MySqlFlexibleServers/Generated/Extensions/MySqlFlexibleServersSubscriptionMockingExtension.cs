...
namespace Azure.ResourceManager.MySql.FlexibleServers.Mocking
{
    ...
    public partial class MySqlFlexibleServersSubscriptionMockingExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="MySqlFlexibleServersSubscriptionMockingExtension"/> class for mocking. </summary>
        protected MySqlFlexibleServersSubscriptionMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MySqlFlexibleServersSubscriptionMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MySqlFlexibleServersSubscriptionMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual async Task<Response<MySqlFlexibleServerVirtualNetworkSubnetUsageResult>> ExecuteCheckVirtualNetworkSubnetUsageAsync(AzureLocation locationName, MySqlFlexibleServerVirtualNetworkSubnetUsageParameter mySqlFlexibleServerVirtualNetworkSubnetUsageParameter, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = CheckVirtualNetworkSubnetUsageClientDiagnostics.CreateScope("MySqlFlexibleServersSubscriptionMockingExtension.ExecuteCheckVirtualNetworkSubnetUsage");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response<MySqlFlexibleServerNameAvailabilityResult>> CheckMySqlFlexibleServerNameAvailabilityAsync(AzureLocation locationName, MySqlFlexibleServerNameAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = CheckNameAvailabilityClientDiagnostics.CreateScope("MySqlFlexibleServersSubscriptionMockingExtension.CheckMySqlFlexibleServerNameAvailability");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response<MySqlFlexibleServerNameAvailabilityResult>> CheckMySqlFlexibleServerNameAvailabilityWithoutLocationAsync(MySqlFlexibleServerNameAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = CheckNameAvailabilityWithoutLocationClientDiagnostics.CreateScope("MySqlFlexibleServersSubscriptionMockingExtension.CheckMySqlFlexibleServerNameAvailabilityWithoutLocation");
            scope.Start();
            try
            {
