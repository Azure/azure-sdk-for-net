...
namespace Azure.ResourceManager.MySql.FlexibleServers.Mocking
{
    ...
    public partial class MySqlFlexibleServersResourceGroupMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="MySqlFlexibleServersResourceGroupMockingExtension"/> class for mocking. </summary>
        protected MySqlFlexibleServersResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MySqlFlexibleServersResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MySqlFlexibleServersResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
