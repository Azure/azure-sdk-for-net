...
namespace Azure.ResourceManager.MySql.FlexibleServers.Models
{
    ...
    public static partial class ArmMySqlFlexibleServersModelFactory
    {
        ...
        {
            return new MySqlFlexibleServerAadAdministratorData(id, name, resourceType, systemData, administratorType, login, sid, tenantId, identityResourceId, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MySqlFlexibleServerBackupData(id, name, resourceType, systemData, backupType, completedOn, source, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MySqlFlexibleServerBackupSettings(backupName, backupFormat, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MySqlFlexibleServerBackupAndExportResult(id, name, resourceType, systemData, status, startOn, endOn, percentComplete, datasourceSizeInBytes, dataTransferredInBytes, backupMetadata, error, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MySqlFlexibleServerValidateBackupResult(numberOfContainers, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MySqlFlexibleServerConfigurationData(id, name, resourceType, systemData, value, currentValue, description, documentationLink, defaultValue, dataType, allowedValues, source, isReadOnly, isConfigPendingRestart, isDynamicConfig, new Dictionary<string, BinaryData>());
        }
        ...
        public static MySqlFlexibleServerConfigurations MySqlFlexibleServerConfigurations(IEnumerable<MySqlFlexibleServerConfigurationData> values = null)
        {
            ...
            return new MySqlFlexibleServerConfigurations(values?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MySqlFlexibleServerDatabaseData(id, name, resourceType, systemData, charset, collation, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MySqlFlexibleServerFirewallRuleData(id, name, resourceType, systemData, startIPAddress, endIPAddress, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MySqlFlexibleServerStorage(storageSizeInGB, iops, autoGrow, logOnDisk, storageSku, autoIoScaling, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MySqlFlexibleServerBackupProperties(backupRetentionDays, geoRedundantBackup, earliestRestoreOn, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MySqlFlexibleServerHighAvailability(mode, state, standbyAvailabilityZone, new Dictionary<string, BinaryData>());
        }
        ...
        public static MySqlFlexibleServersPrivateEndpointConnection MySqlFlexibleServersPrivateEndpointConnection(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IEnumerable<string> groupIds = null, ResourceIdentifier privateEndpointId = null, MySqlFlexibleServersPrivateLinkServiceConnectionState connectionState = null, MySqlFlexibleServersPrivateEndpointConnectionProvisioningState? provisioningState = null)
        {
            ...
            return new MySqlFlexibleServersPrivateEndpointConnection(id, name, resourceType, systemData, groupIds?.ToList(), privateEndpointId != null ? ResourceManagerModelFactory.SubResource(privateEndpointId) : null, connectionState, provisioningState, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MySqlFlexibleServerLogFile(id, name, resourceType, systemData, sizeInKB, createdOn, typePropertiesType, lastModifiedOn, uri, new Dictionary<string, BinaryData>());
        }
        ...
        public static MySqlFlexibleServerCapabilityProperties MySqlFlexibleServerCapabilityProperties(string zone = null, IEnumerable<string> supportedHAMode = null, IEnumerable<string> supportedGeoBackupRegions = null, IEnumerable<MySqlFlexibleServerEditionCapability> supportedFlexibleServerEditions = null)
        {
            ...
            return new MySqlFlexibleServerCapabilityProperties(zone, supportedHAMode?.ToList(), supportedGeoBackupRegions?.ToList(), supportedFlexibleServerEditions?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static MySqlFlexibleServerEditionCapability MySqlFlexibleServerEditionCapability(string name = null, IEnumerable<MySqlFlexibleServerStorageEditionCapability> supportedStorageEditions = null, IEnumerable<MySqlFlexibleServerServerVersionCapability> supportedServerVersions = null)
        {
            ...
            return new MySqlFlexibleServerEditionCapability(name, supportedStorageEditions?.ToList(), supportedServerVersions?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MySqlFlexibleServerStorageEditionCapability(name, minStorageSize, maxStorageSize, minBackupRetentionDays, maxBackupRetentionDays, new Dictionary<string, BinaryData>());
        }
        ...
        public static MySqlFlexibleServerServerVersionCapability MySqlFlexibleServerServerVersionCapability(string name = null, IEnumerable<MySqlFlexibleServerSkuCapability> supportedSkus = null)
        {
            ...
            return new MySqlFlexibleServerServerVersionCapability(name, supportedSkus?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MySqlFlexibleServerSkuCapability(name, vCores, supportedIops, supportedMemoryPerVCoreInMB, new Dictionary<string, BinaryData>());
        }
        ...
        public static MySqlFlexibleServersCapabilityData MySqlFlexibleServersCapabilityData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IEnumerable<string> supportedGeoBackupRegions = null, IEnumerable<ServerEditionCapabilityV2> supportedFlexibleServerEditions = null, IEnumerable<ServerVersionCapabilityV2> supportedServerVersions = null)
        {
            ...
            return new MySqlFlexibleServersCapabilityData(id, name, resourceType, systemData, supportedGeoBackupRegions?.ToList(), supportedFlexibleServerEditions?.ToList(), supportedServerVersions?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static ServerEditionCapabilityV2 ServerEditionCapabilityV2(string name = null, string defaultSku = null, int? defaultStorageSize = null, IEnumerable<MySqlFlexibleServerStorageEditionCapability> supportedStorageEditions = null, IEnumerable<SkuCapabilityV2> supportedSkus = null)
        {
            ...
            return new ServerEditionCapabilityV2(name, defaultSku, defaultStorageSize, supportedStorageEditions?.ToList(), supportedSkus?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static SkuCapabilityV2 SkuCapabilityV2(string name = null, long? vCores = null, long? supportedIops = null, long? supportedMemoryPerVCoreMB = null, IEnumerable<string> supportedZones = null, IEnumerable<string> supportedHAMode = null)
        {
            ...
            return new SkuCapabilityV2(name, vCores, supportedIops, supportedMemoryPerVCoreMB, supportedZones?.ToList(), supportedHAMode?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ServerVersionCapabilityV2(name, new Dictionary<string, BinaryData>());
        }
        ...
        public static MySqlFlexibleServerVirtualNetworkSubnetUsageResult MySqlFlexibleServerVirtualNetworkSubnetUsageResult(AzureLocation? location = null, string subscriptionId = null, IEnumerable<MySqlFlexibleServerDelegatedSubnetUsage> delegatedSubnetsUsage = null)
        {
            ...
            return new MySqlFlexibleServerVirtualNetworkSubnetUsageResult(location, subscriptionId, delegatedSubnetsUsage?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MySqlFlexibleServerDelegatedSubnetUsage(subnetName, usage, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MySqlFlexibleServerNameAvailabilityContent(name, resourceType, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MySqlFlexibleServerNameAvailabilityResult(message, isNameAvailable, reason, new Dictionary<string, BinaryData>());
        }
        ...
        public static OperationStatusExtendedResult OperationStatusExtendedResult(ResourceIdentifier id = null, ResourceIdentifier resourceId = null, string name = null, string status = null, float? percentComplete = null, DateTimeOffset? startOn = null, DateTimeOffset? endOn = null, IEnumerable<OperationStatusResult> operations = null, ResponseError error = null, IReadOnlyDictionary<string, BinaryData> properties = null)
        {
            ...
            return new OperationStatusExtendedResult(id, resourceId, name, status, percentComplete, startOn, endOn, operations?.ToList(), error, new Dictionary<string, BinaryData>(), properties);
        }
        ...
        public static OperationStatusResult OperationStatusResult(ResourceIdentifier id = null, ResourceIdentifier resourceId = null, string name = null, string status = null, float? percentComplete = null, DateTimeOffset? startOn = null, DateTimeOffset? endOn = null, IEnumerable<OperationStatusResult> operations = null, ResponseError error = null)
        {
            ...
            return new OperationStatusResult(id, resourceId, name, status, percentComplete, startOn, endOn, operations?.ToList(), error, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MySqlFlexibleServerPrivateDnsZoneSuffixResponse(privateDnsZoneSuffix, new Dictionary<string, BinaryData>());
        }
    }
}
