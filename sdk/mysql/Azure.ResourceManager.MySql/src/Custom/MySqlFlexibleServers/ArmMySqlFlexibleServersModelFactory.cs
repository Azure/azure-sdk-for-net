...
namespace Azure.ResourceManager.MySql.FlexibleServers.Models
{
    ...
    public static partial class ArmMySqlFlexibleServersModelFactory
    {
        ...
        public static MySqlFlexibleServerBackupAndExportResult MySqlFlexibleServerBackupAndExportResult(ResourceIdentifier id, string name, ResourceType resourceType, Azure.ResourceManager.Models.SystemData systemData, MySqlFlexibleServerBackupAndExportOperationStatus? status, DateTimeOffset? startOn = null, DateTimeOffset? endOn = null, double? percentComplete = null, long? datasourceSizeInBytes = null, long? dataTransferredInBytes = null, string backupMetadata = null, ResponseError error = null)
            => MySqlFlexibleServerBackupAndExportResult(id, name, resourceType, systemData, datasourceSizeInBytes, dataTransferredInBytes, backupMetadata, error, status, startOn, endOn, percentComplete);
        ...
        public static MySqlFlexibleServersPrivateEndpointConnection MySqlFlexibleServersPrivateEndpointConnection(ResourceIdentifier id, string name, ResourceType resourceType, Azure.ResourceManager.Models.SystemData systemData, IEnumerable<string> groupIds, ResourceIdentifier privateEndpointId, MySqlFlexibleServersPrivateLinkServiceConnectionState connectionState, MySqlFlexibleServersPrivateEndpointConnectionProvisioningState? provisioningState)
        {
            ...
            return new MySqlFlexibleServersPrivateEndpointConnection(id, name, resourceType, systemData, groupIds?.ToList(), privateEndpointId, connectionState, provisioningState, null);
        }
        ...
        public static MySqlFlexibleServerData MySqlFlexibleServerData(ResourceIdentifier id, string name, ResourceType resourceType, Azure.ResourceManager.Models.SystemData systemData, IDictionary<string, string> tags, AzureLocation location, Azure.ResourceManager.Models.ManagedServiceIdentity identity, MySqlFlexibleServerSku sku, string administratorLogin, string administratorLoginPassword, MySqlFlexibleServerVersion? version, string availabilityZone, MySqlFlexibleServerCreateMode? createMode, ResourceIdentifier sourceServerResourceId, DateTimeOffset? restorePointInTime, MySqlFlexibleServerReplicationRole? replicationRole, int? replicaCapacity, MySqlFlexibleServerDataEncryption dataEncryption, MySqlFlexibleServerState? state, string fullyQualifiedDomainName, MySqlFlexibleServerStorage storage, MySqlFlexibleServerBackupProperties backup, MySqlFlexibleServerHighAvailability highAvailability, MySqlFlexibleServerNetwork network, IEnumerable<MySqlFlexibleServersPrivateEndpointConnection> privateEndpointConnections, MySqlFlexibleServerMaintenanceWindow maintenanceWindow, ImportSourceProperties importSourceProperties)
        {
            ...
            var serverPrivateEndpointConnections = new ChangeTrackingList<MySqlFlexibleServersPrivateEndpointConnectionData>();
            ...
            return MySqlFlexibleServerData(id, name, resourceType, systemData, tags, location, administratorLogin, administratorLoginPassword, version, null, availabilityZone, createMode, sourceServerResourceId, restorePointInTime, replicationRole, replicaCapacity, dataEncryption, state, fullyQualifiedDomainName, null, storage, backup, highAvailability, network, serverPrivateEndpointConnections, maintenanceWindow, importSourceProperties, null, identity, sku);
        }
        ...
        /// <param name="sku"> The SKU (pricing tier) of the server. </param>
        /// <returns> A new <see cref="FlexibleServers.MySqlFlexibleServerData"/> instance for mocking. </returns>
        public static MySqlFlexibleServerData MySqlFlexibleServerData(ResourceIdentifier id, string name, ResourceType resourceType, Azure.ResourceManager.Models.SystemData systemData, IDictionary<string, string> tags, AzureLocation location, string administratorLogin, string administratorLoginPassword, MySqlFlexibleServerVersion? version, string fullVersion, string availabilityZone, MySqlFlexibleServerCreateMode? createMode, ResourceIdentifier sourceServerResourceId, DateTimeOffset? restorePointInOn, MySqlFlexibleServerReplicationRole? replicationRole, int? replicaCapacity, MySqlFlexibleServerDataEncryption dataEncryption, MySqlFlexibleServerState? state, string fullyQualifiedDomainName, int? databasePort, MySqlFlexibleServerStorage storage, MySqlFlexibleServerBackupProperties backup, MySqlFlexibleServerHighAvailability highAvailability, MySqlFlexibleServerNetwork network, IEnumerable<MySqlFlexibleServersPrivateEndpointConnectionData> serverPrivateEndpointConnections, MySqlFlexibleServerPatchStrategy? maintenancePatchStrategy, MySqlFlexibleServerMaintenanceWindow maintenanceWindow = null, ImportSourceProperties importSourceProperties = null, Azure.ResourceManager.Models.ManagedServiceIdentity identity = null, MySqlFlexibleServerSku sku = null)
            => MySqlFlexibleServerData(id, name, resourceType, systemData, tags, location, administratorLogin, administratorLoginPassword, version, fullVersion, availabilityZone, createMode, sourceServerResourceId, restorePointInOn, replicationRole, replicaCapacity, dataEncryption, state, fullyQualifiedDomainName, databasePort, storage, backup, highAvailability, network, serverPrivateEndpointConnections, maintenanceWindow, importSourceProperties, maintenancePatchStrategy, identity, sku);
        ...
        public static MySqlFlexibleServersCapabilityData MySqlFlexibleServersCapabilityData(ResourceIdentifier id, string name, ResourceType resourceType, Azure.ResourceManager.Models.SystemData systemData, IEnumerable<string> supportedGeoBackupRegions, IEnumerable<ServerEditionCapabilityV2> supportedFlexibleServerEditions, IEnumerable<ServerVersionCapabilityV2> supportedServerVersions)
            => MySqlFlexibleServersCapabilityData(id, name, resourceType, systemData, supportedGeoBackupRegions, supportedFlexibleServerEditions, supportedServerVersions, null);
        ...
        public static MySqlFlexibleServersPrivateEndpointConnectionData MySqlFlexibleServersPrivateEndpointConnectionData(ResourceIdentifier id, string name, ResourceType resourceType, Azure.ResourceManager.Models.SystemData systemData, IEnumerable<string> groupIds, ResourceIdentifier privateEndpointId, MySqlFlexibleServersPrivateLinkServiceConnectionState privateLinkServiceConnectionState = null, MySqlFlexibleServersPrivateEndpointConnectionProvisioningState? provisioningState = null)
            => MySqlFlexibleServersPrivateEndpointConnectionData(id, name, resourceType, systemData, groupIds, privateLinkServiceConnectionState, provisioningState, privateEndpointId);
    }
}
