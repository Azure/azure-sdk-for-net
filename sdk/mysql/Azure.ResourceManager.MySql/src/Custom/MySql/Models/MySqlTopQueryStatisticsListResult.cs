...
namespace Azure.ResourceManager.MySql.Models
{
    ...
    internal partial class MySqlTopQueryStatisticsListResult
    {
        ...
        internal MySqlTopQueryStatisticsListResult(IReadOnlyList<MySqlQueryStatisticData> value, string nextLink, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Value = value;
            NextLink = nextLink;
