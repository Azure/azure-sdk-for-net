...
namespace Azure.ResourceManager.MySql.Models
{
    ...
    internal partial class MySqlPrivateEndpointConnectionListResult
    {
        ...
        internal MySqlPrivateEndpointConnectionListResult(IReadOnlyList<MySqlPrivateEndpointConnectionData> value, string nextLink, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Value = value;
            NextLink = nextLink;
