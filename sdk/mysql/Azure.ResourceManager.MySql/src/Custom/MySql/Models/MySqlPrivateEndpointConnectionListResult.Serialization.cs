...
namespace Azure.ResourceManager.MySql.Models
{
    internal partial class MySqlPrivateEndpointConnectionListResult : IUtf8JsonSerializable, IJsonModel<MySqlPrivateEndpointConnectionListResult>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MySqlPrivateEndpointConnectionListResult)} does not support writing '{format}' format.");
            }
        ...
        internal static MySqlPrivateEndpointConnectionListResult DeserializeMySqlPrivateEndpointConnectionListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            IReadOnlyList<MySqlPrivateEndpointConnectionData> value = default;
            ...
            return new MySqlPrivateEndpointConnectionListResult(value ?? new ChangeTrackingList<MySqlPrivateEndpointConnectionData>(), nextLink, serializedAdditionalRawData);
        }
