    ...
    public partial class MySqlDatabaseCollection : ArmCollection, IEnumerable<MySqlDatabaseResource>, IAsyncEnumerable<MySqlDatabaseResource>
    {
        ...
        public virtual async Task<Response<MySqlDatabaseResource>> GetAsync(string databaseName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new MySqlDatabaseResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual AsyncPageable<MySqlDatabaseResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, null, e => { var data = MySqlDatabaseData.DeserializeMySqlDatabaseData(e); return new MySqlDatabaseResource(Client, data, data.Id); }, _mySqlDatabaseDatabasesClientDiagnostics, Pipeline, "MySqlDatabaseCollection.GetAll", "value", null, cancellationToken);
        }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _mySqlDatabaseDatabasesRestClient.CreateListByServerRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name);
            return PageableHelpers.CreatePageable(FirstPageRequest, null, e => { var data = MySqlDatabaseData.DeserializeMySqlDatabaseData(e); return new MySqlDatabaseResource(Client, data, data.Id); }, _mySqlDatabaseDatabasesClientDiagnostics, Pipeline, "MySqlDatabaseCollection.GetAll", "value", null, cancellationToken);
        }
