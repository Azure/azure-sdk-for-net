...
namespace Azure.ResourceManager.MySql
{
    ...
    public partial class MySqlFirewallRuleResource : ArmResource
    {
        ...
        internal MySqlFirewallRuleResource(ArmClient client, MySqlFirewallRuleData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<MySqlFirewallRuleResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new MySqlFirewallRuleResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
