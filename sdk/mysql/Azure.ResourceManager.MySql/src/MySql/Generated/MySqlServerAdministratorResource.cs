...
namespace Azure.ResourceManager.MySql
{
    ...
    public partial class MySqlServerAdministratorResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                using var message = _mySqlServerAdministratorServerAdministratorsRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name);
                var response = await _mySqlServerAdministratorServerAdministratorsRestClient.DeleteAsync(message, cancellationToken).ConfigureAwait(false);
                var operation = new MySqlArmOperation(_mySqlServerAdministratorServerAdministratorsClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
        ...
        public virtual ArmOperation Delete(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var message = _mySqlServerAdministratorServerAdministratorsRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name);
                var response = _mySqlServerAdministratorServerAdministratorsRestClient.Delete(message, cancellationToken);
                var operation = new MySqlArmOperation(_mySqlServerAdministratorServerAdministratorsClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<ArmOperation<MySqlServerAdministratorResource>> CreateOrUpdateAsync(WaitUntil waitUntil, MySqlServerAdministratorData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                using var message = _mySqlServerAdministratorServerAdministratorsRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, data);
                var response = await _mySqlServerAdministratorServerAdministratorsRestClient.CreateOrUpdateAsync(message, cancellationToken).ConfigureAwait(false);
                var operation = new MySqlArmOperation<MySqlServerAdministratorResource>(new MySqlServerAdministratorOperationSource(Client), _mySqlServerAdministratorServerAdministratorsClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual ArmOperation<MySqlServerAdministratorResource> CreateOrUpdate(WaitUntil waitUntil, MySqlServerAdministratorData data, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var message = _mySqlServerAdministratorServerAdministratorsRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, data);
                var response = _mySqlServerAdministratorServerAdministratorsRestClient.CreateOrUpdate(message, cancellationToken);
                var operation = new MySqlArmOperation<MySqlServerAdministratorResource>(new MySqlServerAdministratorOperationSource(Client), _mySqlServerAdministratorServerAdministratorsClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
