...
namespace Azure.ResourceManager.MySql
{
    ...
    public partial class MySqlServerAdministratorResource : ArmResource
    {
        ...
        internal MySqlServerAdministratorResource(ArmClient client, MySqlServerAdministratorData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<MySqlServerAdministratorResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new MySqlServerAdministratorResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
