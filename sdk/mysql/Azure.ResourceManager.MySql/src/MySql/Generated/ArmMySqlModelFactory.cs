...
namespace Azure.ResourceManager.MySql.Models
{
    ...
    public static partial class ArmMySqlModelFactory
    {
        ...
        public static MySqlServerCreateOrUpdateContent MySqlServerCreateOrUpdateContent(ManagedServiceIdentity identity = null, MySqlSku sku = null, MySqlServerPropertiesForCreate properties = null, AzureLocation location = default, IDictionary<string, string> tags = null)
        {
            ...
            return new MySqlServerCreateOrUpdateContent(identity, sku, properties, location, tags, default);
        }
        ...
        public static MySqlServerData MySqlServerData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, ManagedServiceIdentity identity = null, MySqlSku sku = null, string administratorLogin = null, MySqlServerVersion? version = null, MySqlSslEnforcementEnum? sslEnforcement = null, MySqlMinimalTlsVersionEnum? minimalTlsVersion = null, string byokEnforcement = null, MySqlInfrastructureEncryption? infrastructureEncryption = null, MySqlServerState? userVisibleState = null, string fullyQualifiedDomainName = null, DateTimeOffset? earliestRestoreOn = null, MySqlStorageProfile storageProfile = null, string replicationRole = null, ResourceIdentifier masterServerId = null, int? replicaCapacity = null, MySqlPublicNetworkAccessEnum? publicNetworkAccess = null, IEnumerable<MySqlServerPrivateEndpointConnection> privateEndpointConnections = null)
        {
            ...
            return new MySqlServerData(id, name, resourceType, systemData, tags, location, identity, sku, administratorLogin, version, sslEnforcement, minimalTlsVersion, byokEnforcement, infrastructureEncryption, userVisibleState, fullyQualifiedDomainName, earliestRestoreOn, storageProfile, replicationRole, masterServerId, replicaCapacity, publicNetworkAccess, privateEndpointConnections?.ToList(), default);
        }
        ...
        {
            return new MySqlServerPrivateEndpointConnection(id, properties, default);
        }
        ...
        {
            return new MySqlServerPrivateEndpointConnectionProperties(privateEndpointId != null ? ResourceManagerModelFactory.WritableSubResource(privateEndpointId) : null, privateLinkServiceConnectionState, provisioningState, default);
        }
        ...
        {
            return new MySqlServerPrivateLinkServiceConnectionStateProperty(status, description, actionsRequired, default);
        }
        ...
        {
            return new MySqlFirewallRuleData(id, name, resourceType, systemData, startIPAddress, endIPAddress, default);
        }
        ...
        {
            return new MySqlVirtualNetworkRuleData(id, name, resourceType, systemData, virtualNetworkSubnetId, ignoreMissingVnetServiceEndpoint, state, default);
        }
        ...
        {
            return new MySqlDatabaseData(id, name, resourceType, systemData, charset, collation, default);
        }
        ...
        {
            return new MySqlConfigurationData(id, name, resourceType, systemData, value, description, defaultValue, dataType, allowedValues, source, default);
        }
        ...
        {
            return new MySqlLogFile(id, name, resourceType, systemData, sizeInKB, createdOn, lastModifiedOn, logFileType, uri, default);
        }
        ...
        {
            return new MySqlServerAdministratorData(id, name, resourceType, systemData, administratorType, loginAccountName, secureId, tenantId, default);
        }
        ...
        {
            return new MySqlRecoverableServerResourceData(id, name, resourceType, systemData, lastAvailableBackupOn, serviceLevelObjective, edition, vCores, hardwareGeneration, version, default);
        }
        ...
        public static MySqlPerformanceTier MySqlPerformanceTier(string id = null, int? maxBackupRetentionDays = null, int? minBackupRetentionDays = null, int? maxStorageInMB = null, int? minLargeStorageInMB = null, int? maxLargeStorageInMB = null, int? minStorageInMB = null, IEnumerable<MySqlPerformanceTierServiceLevelObjectives> serviceLevelObjectives = null)
        {
            ...
            return new MySqlPerformanceTier(id, maxBackupRetentionDays, minBackupRetentionDays, maxStorageInMB, minLargeStorageInMB, maxLargeStorageInMB, minStorageInMB, serviceLevelObjectives?.ToList(), default);
        }
        ...
        {
            return new MySqlPerformanceTierServiceLevelObjectives(id, edition, vCores, hardwareGeneration, maxBackupRetentionDays, minBackupRetentionDays, maxStorageInMB, minStorageInMB, default);
        }
        ...
        {
            return new MySqlNameAvailabilityContent(name, resourceType, default);
        }
        ...
        {
            return new MySqlNameAvailabilityResult(message, isNameAvailable, reason, default);
        }
        ...
        public static MySqlServerSecurityAlertPolicyData MySqlServerSecurityAlertPolicyData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, MySqlServerSecurityAlertPolicyState? state = null, IEnumerable<string> disabledAlerts = null, IEnumerable<string> emailAddresses = null, bool? sendToEmailAccountAdmins = null, string storageEndpoint = null, string storageAccountAccessKey = null, int? retentionDays = null)
        {
            ...
            return new MySqlServerSecurityAlertPolicyData(id, name, resourceType, systemData, state, disabledAlerts?.ToList(), emailAddresses?.ToList(), sendToEmailAccountAdmins, storageEndpoint, storageAccountAccessKey, retentionDays, default);
        }
        ...
        {
            return new MySqlQueryTextData(id, name, resourceType, systemData, queryId, queryText, default);
        }
        ...
        public static MySqlQueryStatisticData MySqlQueryStatisticData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string queryId = null, DateTimeOffset? startOn = null, DateTimeOffset? endOn = null, string aggregationFunction = null, IEnumerable<string> databaseNames = null, long? queryExecutionCount = null, string metricName = null, string metricDisplayName = null, double? metricValue = null, string metricValueUnit = null)
        {
            ...
            return new MySqlQueryStatisticData(id, name, resourceType, systemData, queryId, startOn, endOn, aggregationFunction, databaseNames?.ToList(), queryExecutionCount, metricName, metricDisplayName, metricValue, metricValueUnit, default);
        }
        ...
        {
            return new MySqlWaitStatisticData(id, name, resourceType, systemData, startOn, endOn, eventName, eventTypeName, queryId, databaseName, userId, count, totalTimeInMinutes, default);
        }
        ...
        {
            return new MySqlQueryPerformanceInsightResetDataResult(status, message, default);
        }
        ...
        {
            return new MySqlAdvisorData(id, name, resourceType, systemData, properties, default);
        }
        ...
        public static MySqlRecommendationActionData MySqlRecommendationActionData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string advisorName = null, Guid? sessionId = null, int? actionId = null, DateTimeOffset? createdOn = null, DateTimeOffset? expireOn = null, string reason = null, string recommendationType = null, IDictionary<string, string> details = null)
        {
            ...
            return new MySqlRecommendationActionData(id, name, resourceType, systemData, advisorName, sessionId, actionId, createdOn, expireOn, reason, recommendationType, details, default);
        }
        ...
        {
            return new MySqlPrivateEndpointConnectionData(id, name, resourceType, systemData, privateEndpointId != null ? ResourceManagerModelFactory.WritableSubResource(privateEndpointId) : null, connectionState, provisioningState, default);
        }
        ...
        {
            return new MySqlPrivateLinkServiceConnectionStateProperty(status, description, actionsRequired, default);
        }
        ...
        {
            return new MySqlPrivateLinkResourceData(id, name, resourceType, systemData, properties, default);
        }
        ...
        public static MySqlPrivateLinkResourceProperties MySqlPrivateLinkResourceProperties(string groupId = null, IEnumerable<string> requiredMembers = null)
        {
            ...
            return new MySqlPrivateLinkResourceProperties(groupId, requiredMembers?.ToList(), default);
        }
        ...
        {
            return new MySqlServerKeyData(id, name, resourceType, systemData, kind, serverKeyType, uri, createdOn, default);
        }
        ...
        {
            return new MySqlServerPropertiesForDefaultCreate(version, sslEnforcement, minimalTlsVersion, infrastructureEncryption, publicNetworkAccess, storageProfile, MySqlCreateMode.Default, administratorLogin, administratorLoginPassword, default);
        }
        ...
        {
            return new MySqlServerPropertiesForRestore(version, sslEnforcement, minimalTlsVersion, infrastructureEncryption, publicNetworkAccess, storageProfile, MySqlCreateMode.PointInTimeRestore, sourceServerId, restorePointInTime, default);
        }
        ...
        {
            return new MySqlServerPropertiesForGeoRestore(version, sslEnforcement, minimalTlsVersion, infrastructureEncryption, publicNetworkAccess, storageProfile, MySqlCreateMode.GeoRestore, sourceServerId, default);
        }
        ...
        {
            return new MySqlServerPropertiesForReplica(version, sslEnforcement, minimalTlsVersion, infrastructureEncryption, publicNetworkAccess, storageProfile, MySqlCreateMode.Replica, sourceServerId, default);
        }
    }
}
