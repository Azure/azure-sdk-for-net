...
namespace Azure.ResourceManager.MySql
{
    ...
    public partial class MySqlFirewallRuleData : ResourceData
    {
        ...
        internal MySqlFirewallRuleData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IPAddress startIPAddress, IPAddress endIPAddress, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData)
        {
            StartIPAddress = startIPAddress;
            EndIPAddress = endIPAddress;
            _rawData = rawData;
