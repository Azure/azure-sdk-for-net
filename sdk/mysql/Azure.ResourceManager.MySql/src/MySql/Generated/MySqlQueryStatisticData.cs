...
namespace Azure.ResourceManager.MySql
{
    ...
    public partial class MySqlQueryStatisticData : ResourceData
    {
        ...
        internal MySqlQueryStatisticData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string queryId, DateTimeOffset? startOn, DateTimeOffset? endOn, string aggregationFunction, IList<string> databaseNames, long? queryExecutionCount, string metricName, string metricDisplayName, double? metricValue, string metricValueUnit, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData)
        {
            QueryId = queryId;
            StartOn = startOn;
            EndOn = endOn;
