...
{
    public partial class MySqlQueryStatisticData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static MySqlQueryStatisticData DeserializeMySqlQueryStatisticData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
