...
namespace Azure.ResourceManager.MySql
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MySqlQueryStatisticData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MySqlQueryStatisticData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MySqlQueryStatisticData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MySqlQueryStatisticData>)} interface");
            }
        ...
        string IPersistableModel<MySqlQueryStatisticData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
