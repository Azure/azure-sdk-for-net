...
namespace Azure.ResourceManager.MySql.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MySqlQueryTextListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MySqlQueryTextListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MySqlQueryTextListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MySqlQueryTextListResult>)} interface");
            }
        ...
        string IPersistableModel<MySqlQueryTextListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
