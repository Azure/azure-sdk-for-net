...
namespace Azure.ResourceManager.MySql.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MySqlServerSecurityAlertPolicyListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MySqlServerSecurityAlertPolicyListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MySqlServerSecurityAlertPolicyListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MySqlServerSecurityAlertPolicyListResult>)} interface");
            }
        ...
        string IPersistableModel<MySqlServerSecurityAlertPolicyListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
