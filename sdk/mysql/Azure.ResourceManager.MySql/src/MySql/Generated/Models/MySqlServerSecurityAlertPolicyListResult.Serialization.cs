...
{
    internal partial class MySqlServerSecurityAlertPolicyListResult : IUtf8JsonSerializable, IJsonModel<MySqlServerSecurityAlertPolicyListResult>, IPersistableModel<MySqlServerSecurityAlertPolicyListResult>
    {
        ...
        void IJsonModel<MySqlServerSecurityAlertPolicyListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MySqlServerSecurityAlertPolicyListResult)} does not support '{format}' format.");
            }
