...
namespace Azure.ResourceManager.MySql.Models
{
    public partial class MySqlPerformanceTier : IUtf8JsonSerializable, IModelJsonSerializable<MySqlPerformanceTier>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<MySqlPerformanceTier>(this, options.Format);
            ...
            if (Optional.IsCollectionDefined(ServiceLevelObjectives))
            {
                ...
                foreach (var item in ServiceLevelObjectives)
                {
                    ...
                    {
                        ((IModelJsonSerializable<MySqlPerformanceTierServiceLevelObjectives>)item).Serialize(writer, options);
                    }
                }
        ...
        /// <summary> Converts a <see cref="MySqlPerformanceTier"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="MySqlPerformanceTier"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="MySqlPerformanceTier"/>. </summary>
