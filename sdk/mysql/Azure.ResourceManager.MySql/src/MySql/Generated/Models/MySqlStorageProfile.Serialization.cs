...
namespace Azure.ResourceManager.MySql.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MySqlStorageProfile>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MySqlStorageProfile>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MySqlStorageProfile>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MySqlStorageProfile>)} interface");
            }
        ...
        string IPersistableModel<MySqlStorageProfile>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
