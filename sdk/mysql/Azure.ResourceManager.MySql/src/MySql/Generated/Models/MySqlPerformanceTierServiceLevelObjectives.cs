...
namespace Azure.ResourceManager.MySql.Models
{
    ...
    public partial class MySqlPerformanceTierServiceLevelObjectives
    {
        ...
        internal MySqlPerformanceTierServiceLevelObjectives(string id, string edition, int? vCores, string hardwareGeneration, int? maxBackupRetentionDays, int? minBackupRetentionDays, int? maxStorageInMB, int? minStorageInMB, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Edition = edition;
            VCores = vCores;
