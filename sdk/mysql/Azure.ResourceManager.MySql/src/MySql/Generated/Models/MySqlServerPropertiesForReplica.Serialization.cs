...
namespace Azure.ResourceManager.MySql.Models
{
    public partial class MySqlServerPropertiesForReplica : IUtf8JsonSerializable, IModelJsonSerializable<MySqlServerPropertiesForReplica>
    {
        ...
        internal static MySqlServerPropertiesForReplica DeserializeMySqlServerPropertiesForReplica(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new MySqlServerPropertiesForReplica(Optional.ToNullable(version), Optional.ToNullable(sslEnforcement), Optional.ToNullable(minimalTlsVersion), Optional.ToNullable(infrastructureEncryption), Optional.ToNullable(publicNetworkAccess), storageProfile.Value, createMode, sourceServerId, serializedAdditionalRawData);
        }
