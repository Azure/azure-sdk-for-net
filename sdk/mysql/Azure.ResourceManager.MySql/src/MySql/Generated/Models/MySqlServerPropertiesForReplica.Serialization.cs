...
namespace Azure.ResourceManager.MySql.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MySqlServerPropertiesForReplica>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MySqlServerPropertiesForReplica>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MySqlServerPropertiesForReplica>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MySqlServerPropertiesForReplica>)} interface");
            }
        ...
        string IPersistableModel<MySqlServerPropertiesForReplica>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
