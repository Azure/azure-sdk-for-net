...
namespace Azure.ResourceManager.MySql.Models
{
    ...
    public partial class MySqlServerPropertiesForRestore : MySqlServerPropertiesForCreate
    {
        ...
        internal MySqlServerPropertiesForRestore(MySqlServerVersion? version, MySqlSslEnforcementEnum? sslEnforcement, MySqlMinimalTlsVersionEnum? minimalTlsVersion, MySqlInfrastructureEncryption? infrastructureEncryption, MySqlPublicNetworkAccessEnum? publicNetworkAccess, MySqlStorageProfile storageProfile, MySqlCreateMode createMode, ResourceIdentifier sourceServerId, DateTimeOffset restorePointInTime, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(version, sslEnforcement, minimalTlsVersion, infrastructureEncryption, publicNetworkAccess, storageProfile, createMode, serializedAdditionalRawData)
        {
            SourceServerId = sourceServerId;
            RestorePointInTime = restorePointInTime;
