...
{
    public partial class MySqlServerData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static MySqlServerData DeserializeMySqlServerData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
