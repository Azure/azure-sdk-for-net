...
namespace Azure.ResourceManager.MySql.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MySqlTopQueryStatisticsInput>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MySqlTopQueryStatisticsInput>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MySqlTopQueryStatisticsInput>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MySqlTopQueryStatisticsInput>)} interface");
            }
        ...
        string IPersistableModel<MySqlTopQueryStatisticsInput>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
