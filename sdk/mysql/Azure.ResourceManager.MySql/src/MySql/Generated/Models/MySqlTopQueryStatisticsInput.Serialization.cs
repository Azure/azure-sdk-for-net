...
namespace Azure.ResourceManager.MySql.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MySqlTopQueryStatisticsInput>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MySqlTopQueryStatisticsInput)} does not support writing '{format}' format.");
            }
        ...
        MySqlTopQueryStatisticsInput IJsonModel<MySqlTopQueryStatisticsInput>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MySqlTopQueryStatisticsInput)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<MySqlTopQueryStatisticsInput>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(MySqlTopQueryStatisticsInput)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        MySqlTopQueryStatisticsInput IPersistableModel<MySqlTopQueryStatisticsInput>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(MySqlTopQueryStatisticsInput)} does not support reading '{options.Format}' format.");
            }
        }
