...
namespace Azure.ResourceManager.MySql.Models
{
    public partial class MySqlServerPropertiesForCreate : IUtf8JsonSerializable, IModelJsonSerializable<MySqlServerPropertiesForCreate>
    {
        ...
        internal static MySqlServerPropertiesForCreate DeserializeMySqlServerPropertiesForCreate(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new Models.MySqlServerPropertiesForCreate(Optional.ToNullable(version), Optional.ToNullable(sslEnforcement), Optional.ToNullable(minimalTlsVersion), Optional.ToNullable(infrastructureEncryption), Optional.ToNullable(publicNetworkAccess), storageProfile.Value, createMode, rawData);
        }
