...
{
    public partial class MySqlServerPropertiesForCreate : IUtf8JsonSerializable, IModelJsonSerializable<MySqlServerPropertiesForCreate>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IModelJsonSerializable<MySqlServerPropertiesForCreate>)this).Serialize(writer, ModelSerializerOptions.DefaultWireOptions);

        void IModelJsonSerializable<MySqlServerPropertiesForCreate>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<MySqlServerPropertiesForCreate>(this, options.Format);
        ...
        internal static MySqlServerPropertiesForCreate DeserializeMySqlServerPropertiesForCreate(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new Models.MySqlServerPropertiesForCreate(Optional.ToNullable(version), Optional.ToNullable(sslEnforcement), Optional.ToNullable(minimalTlsVersion), Optional.ToNullable(infrastructureEncryption), Optional.ToNullable(publicNetworkAccess), storageProfile.Value, createMode, serializedAdditionalRawData);
        }

        MySqlServerPropertiesForCreate IModelJsonSerializable<MySqlServerPropertiesForCreate>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<MySqlServerPropertiesForCreate>(this, options.Format);

            using var doc = JsonDocument.ParseValue(ref reader);
            return DeserializeMySqlServerPropertiesForCreate(doc.RootElement, options);
        }

        BinaryData IModelSerializable<MySqlServerPropertiesForCreate>.Serialize(ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<MySqlServerPropertiesForCreate>(this, options.Format);
        ...
        MySqlServerPropertiesForCreate IModelSerializable<MySqlServerPropertiesForCreate>.Deserialize(BinaryData data, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<MySqlServerPropertiesForCreate>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="MySqlServerPropertiesForCreate"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="MySqlServerPropertiesForCreate"/> to convert. </param>
        public static implicit operator RequestContent(MySqlServerPropertiesForCreate model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="MySqlServerPropertiesForCreate"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator MySqlServerPropertiesForCreate(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeMySqlServerPropertiesForCreate(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
