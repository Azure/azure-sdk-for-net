...
namespace Azure.ResourceManager.MySql.Models
{
    ...
    {
        internal static ServerPrivateLinkServiceConnectionStateProperty DeserializeServerPrivateLinkServiceConnectionStateProperty(JsonElement element)
        {
            ...
            return new ServerPrivateLinkServiceConnectionStateProperty(status, description, Optional.ToNullable(actionsRequired));
        }
    }
}
