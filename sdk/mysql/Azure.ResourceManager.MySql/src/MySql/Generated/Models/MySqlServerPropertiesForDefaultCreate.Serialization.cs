...
namespace Azure.ResourceManager.MySql.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MySqlServerPropertiesForDefaultCreate>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MySqlServerPropertiesForDefaultCreate>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MySqlServerPropertiesForDefaultCreate>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MySqlServerPropertiesForDefaultCreate>)} interface");
            }
        ...
        string IPersistableModel<MySqlServerPropertiesForDefaultCreate>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
