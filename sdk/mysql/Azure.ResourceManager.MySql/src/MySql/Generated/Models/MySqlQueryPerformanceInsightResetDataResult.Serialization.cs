...
namespace Azure.ResourceManager.MySql.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MySqlQueryPerformanceInsightResetDataResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MySqlQueryPerformanceInsightResetDataResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MySqlQueryPerformanceInsightResetDataResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MySqlQueryPerformanceInsightResetDataResult>)} interface");
            }
        ...
        string IPersistableModel<MySqlQueryPerformanceInsightResetDataResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
