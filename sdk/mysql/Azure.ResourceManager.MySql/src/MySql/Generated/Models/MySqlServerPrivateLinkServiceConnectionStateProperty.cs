...
namespace Azure.ResourceManager.MySql.Models
{
    ...
    public partial class MySqlServerPrivateLinkServiceConnectionStateProperty
    {
        ...
        internal MySqlServerPrivateLinkServiceConnectionStateProperty(MySqlPrivateLinkServiceConnectionStateStatus status, string description, MySqlPrivateLinkServiceConnectionStateRequiredAction? actionsRequired, Dictionary<string, BinaryData> rawData)
        {
            Status = status;
            Description = description;
