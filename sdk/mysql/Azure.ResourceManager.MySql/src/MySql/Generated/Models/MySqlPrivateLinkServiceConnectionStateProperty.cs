...
namespace Azure.ResourceManager.MySql.Models
{
    ...
    public partial class MySqlPrivateLinkServiceConnectionStateProperty
    {
        ...
        internal MySqlPrivateLinkServiceConnectionStateProperty(string status, string description, string actionsRequired, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Status = status;
            Description = description;
