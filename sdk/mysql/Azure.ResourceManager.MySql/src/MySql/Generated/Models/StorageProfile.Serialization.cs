...
namespace Azure.ResourceManager.MySql.Models
{
    public partial class StorageProfile : IUtf8JsonSerializable
    {
        ...
        internal static StorageProfile DeserializeStorageProfile(JsonElement element)
        {
            ...
            Optional<GeoRedundantBackup> geoRedundantBackup = default;
            Optional<int> storageMB = default;
            Optional<StorageAutogrow> storageAutogrow = default;
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("geoRedundantBackup"))
                {
                    ...
                    geoRedundantBackup = new GeoRedundantBackup(property.Value.GetString());
                    continue;
                }
                ...
                if (property.NameEquals("storageAutogrow"))
                {
                    ...
                    storageAutogrow = new StorageAutogrow(property.Value.GetString());
                    continue;
                }
            }
            return new StorageProfile(Optional.ToNullable(backupRetentionDays), Optional.ToNullable(geoRedundantBackup), Optional.ToNullable(storageMB), Optional.ToNullable(storageAutogrow));
        }
    }
}
