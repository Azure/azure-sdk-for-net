...
namespace Azure.ResourceManager.MySql
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MySqlServerKeyData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MySqlServerKeyData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MySqlServerKeyData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MySqlServerKeyData>)} interface");
            }
        ...
        string IPersistableModel<MySqlServerKeyData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
