...
namespace Azure.ResourceManager.MySql.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MySqlSku>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MySqlSku>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MySqlSku>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MySqlSku>)} interface");
            }
        ...
        string IPersistableModel<MySqlSku>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
