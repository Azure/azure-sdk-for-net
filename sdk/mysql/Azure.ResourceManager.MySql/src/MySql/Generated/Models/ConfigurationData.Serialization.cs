...
namespace Azure.ResourceManager.MySql
{
    public partial class ConfigurationData : IUtf8JsonSerializable
    {
        ...
        internal static ConfigurationData DeserializeConfigurationData(JsonElement element)
        {
            ...
            return new ConfigurationData(id, name, type, systemData.Value, value.Value, description.Value, defaultValue.Value, dataType.Value, allowedValues.Value, source.Value);
        }
    }
}
