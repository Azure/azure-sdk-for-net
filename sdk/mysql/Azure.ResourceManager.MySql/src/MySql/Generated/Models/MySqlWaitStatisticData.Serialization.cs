...
{
    public partial class MySqlWaitStatisticData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static MySqlWaitStatisticData DeserializeMySqlWaitStatisticData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
