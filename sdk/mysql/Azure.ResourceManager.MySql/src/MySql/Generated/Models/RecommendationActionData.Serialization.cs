...
{
    public partial class RecommendationActionData : IUtf8JsonSerializable
    {
        ...
        internal static RecommendationActionData DeserializeRecommendationActionData(JsonElement element)
        {
            ...
            return new RecommendationActionData(id, name, type, systemData.Value, advisorName.Value, sessionId.Value, Optional.ToNullable(actionId), Optional.ToNullable(createdTime), Optional.ToNullable(expirationTime), reason.Value, recommendationType.Value, Optional.ToDictionary(details));
        }
    }
}
