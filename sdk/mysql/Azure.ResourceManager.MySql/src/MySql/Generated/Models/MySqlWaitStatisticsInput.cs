...
namespace Azure.ResourceManager.MySql.Models
{
    ...
    public partial class MySqlWaitStatisticsInput
    {
        ...
        internal MySqlWaitStatisticsInput(DateTimeOffset observationStartOn, DateTimeOffset observationEndOn, string aggregationWindow, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ObservationStartOn = observationStartOn;
            ObservationEndOn = observationEndOn;
            AggregationWindow = aggregationWindow;
