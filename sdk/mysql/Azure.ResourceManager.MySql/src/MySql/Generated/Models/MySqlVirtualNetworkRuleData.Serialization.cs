...
namespace Azure.ResourceManager.MySql
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MySqlVirtualNetworkRuleData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MySqlVirtualNetworkRuleData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MySqlVirtualNetworkRuleData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MySqlVirtualNetworkRuleData>)} interface");
            }
        ...
        string IPersistableModel<MySqlVirtualNetworkRuleData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
