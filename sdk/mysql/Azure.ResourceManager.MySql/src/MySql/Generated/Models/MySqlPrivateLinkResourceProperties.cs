...
namespace Azure.ResourceManager.MySql.Models
{
    ...
    public partial class MySqlPrivateLinkResourceProperties
    {
        ...
        internal MySqlPrivateLinkResourceProperties(string groupId, IReadOnlyList<string> requiredMembers, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            GroupId = groupId;
