...
{
    public partial class MySqlFirewallRuleData : IUtf8JsonSerializable
    {
        ...
        internal static MySqlFirewallRuleData DeserializeMySqlFirewallRuleData(JsonElement element)
        {
            ...
            return new MySqlFirewallRuleData(id, name, type, systemData.Value, startIPAddress, endIPAddress);
        }
    }
}
