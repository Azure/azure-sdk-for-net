...
namespace Azure.ResourceManager.MySql.Models
{
    ...
    public partial class MySqlServerPropertiesForReplica : MySqlServerPropertiesForCreate
    {
        ...
        internal MySqlServerPropertiesForReplica(MySqlServerVersion? version, MySqlSslEnforcementEnum? sslEnforcement, MySqlMinimalTlsVersionEnum? minimalTlsVersion, MySqlInfrastructureEncryption? infrastructureEncryption, MySqlPublicNetworkAccessEnum? publicNetworkAccess, MySqlStorageProfile storageProfile, MySqlCreateMode createMode, ResourceIdentifier sourceServerId, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(version, sslEnforcement, minimalTlsVersion, infrastructureEncryption, publicNetworkAccess, storageProfile, createMode, serializedAdditionalRawData)
        {
            SourceServerId = sourceServerId;
