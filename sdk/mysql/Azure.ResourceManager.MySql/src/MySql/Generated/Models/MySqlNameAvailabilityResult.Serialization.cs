...
{
    public partial class MySqlNameAvailabilityResult : IUtf8JsonSerializable, IJsonModel<MySqlNameAvailabilityResult>, IPersistableModel<MySqlNameAvailabilityResult>
    {
        ...
        void IJsonModel<MySqlNameAvailabilityResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MySqlNameAvailabilityResult)} does not support '{format}' format.");
            }
