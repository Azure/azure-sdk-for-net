...
namespace Azure.ResourceManager.MySql.Models
{
    ...
    {
        /// <summary> Initializes a new instance of TopQueryStatisticsInput. </summary>
        ...
        public TopQueryStatisticsInput(int numberOfTopQueries, string aggregationFunction, string observedMetric, DateTimeOffset observationStartOn, DateTimeOffset observationEndOn, string aggregationWindow)
        {
