...
namespace Azure.ResourceManager.MySql
{
    public partial class ServerSecurityAlertPolicyData : IUtf8JsonSerializable
    {
        ...
        internal static ServerSecurityAlertPolicyData DeserializeServerSecurityAlertPolicyData(JsonElement element)
        {
            ...
            Optional<ServerSecurityAlertPolicyState> state = default;
                ...
                if (property.NameEquals("properties"))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        if (property0.NameEquals("state"))
                        {
                            ...
                            state = property0.Value.GetString().ToServerSecurityAlertPolicyState();
                            continue;
                        }
            ...
            return new ServerSecurityAlertPolicyData(id, name, type, systemData.Value, Optional.ToNullable(state), Optional.ToList(disabledAlerts), Optional.ToList(emailAddresses), Optional.ToNullable(emailAccountAdmins), storageEndpoint.Value, storageAccountAccessKey.Value, Optional.ToNullable(retentionDays));
        }
    }
}
