...
namespace Azure.ResourceManager.MySql.Models
{
    ...
    public partial class MySqlServerCreateOrUpdateContent
    {
        ...
        internal MySqlServerCreateOrUpdateContent(ManagedServiceIdentity identity, MySqlSku sku, MySqlServerPropertiesForCreate properties, AzureLocation location, IDictionary<string, string> tags, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Identity = identity;
            Sku = sku;
            Properties = properties;
