...
namespace Azure.ResourceManager.MySql.Models
{
    ...
    {
        internal static MySqlWaitStatisticsListResult DeserializeMySqlWaitStatisticsListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
