...
{
    public partial class MySqlLogFile : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static MySqlLogFile DeserializeMySqlLogFile(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
