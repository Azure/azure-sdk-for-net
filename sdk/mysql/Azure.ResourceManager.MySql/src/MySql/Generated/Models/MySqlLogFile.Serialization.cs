...
namespace Azure.ResourceManager.MySql.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MySqlLogFile>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MySqlLogFile>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MySqlLogFile>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MySqlLogFile>)} interface");
            }
        ...
        string IPersistableModel<MySqlLogFile>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
