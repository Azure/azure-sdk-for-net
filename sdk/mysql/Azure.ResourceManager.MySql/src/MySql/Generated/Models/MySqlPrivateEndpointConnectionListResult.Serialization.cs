...
{
    internal partial class MySqlPrivateEndpointConnectionListResult : IUtf8JsonSerializable, IJsonModel<MySqlPrivateEndpointConnectionListResult>, IPersistableModel<MySqlPrivateEndpointConnectionListResult>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MySqlPrivateEndpointConnectionListResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<MySqlPrivateEndpointConnectionListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MySqlPrivateEndpointConnectionListResult)} does not support '{format}' format.");
            }
