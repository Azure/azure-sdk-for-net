...
namespace Azure.ResourceManager.MySql.Models
{
    ...
    public partial class MySqlQueryPerformanceInsightResetDataResult
    {
        ...
        internal MySqlQueryPerformanceInsightResetDataResult(MySqlQueryPerformanceInsightResetDataResultState? status, string message, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Status = status;
            Message = message;
