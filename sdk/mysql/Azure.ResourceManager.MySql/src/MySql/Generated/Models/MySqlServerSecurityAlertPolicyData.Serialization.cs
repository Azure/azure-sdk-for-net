...
namespace Azure.ResourceManager.MySql
{
    public partial class MySqlServerSecurityAlertPolicyData : IUtf8JsonSerializable, IJsonModel<MySqlServerSecurityAlertPolicyData>
    {
        ...
        void IJsonModel<MySqlServerSecurityAlertPolicyData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(MySqlServerSecurityAlertPolicyData)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<MySqlServerSecurityAlertPolicyData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(MySqlServerSecurityAlertPolicyData)} does not support '{options.Format}' format.");
            }
        }
