...
namespace Azure.ResourceManager.MySql
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MySqlServerSecurityAlertPolicyData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MySqlServerSecurityAlertPolicyData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MySqlServerSecurityAlertPolicyData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MySqlServerSecurityAlertPolicyData>)} interface");
            }
        ...
        string IPersistableModel<MySqlServerSecurityAlertPolicyData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
