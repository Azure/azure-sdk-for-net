...
{
    public partial class QueryTextData : IUtf8JsonSerializable
    {
        ...
        internal static QueryTextData DeserializeQueryTextData(JsonElement element)
        {
            ...
            return new QueryTextData(id, name, type, systemData.Value, queryId.Value, queryText.Value);
        }
    }
}
