...
namespace Azure.ResourceManager.MySql.Models
{
    ...
    public partial class MySqlTopQueryStatisticsInput
    {
        ...
        internal MySqlTopQueryStatisticsInput(int numberOfTopQueries, string aggregationFunction, string observedMetric, DateTimeOffset observationStartOn, DateTimeOffset observationEndOn, string aggregationWindow, Dictionary<string, BinaryData> rawData)
        {
            NumberOfTopQueries = numberOfTopQueries;
            AggregationFunction = aggregationFunction;
            ObservedMetric = observedMetric;
