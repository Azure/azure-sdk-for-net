...
{
    internal partial class MySqlDatabaseListResult : IUtf8JsonSerializable, IJsonModel<MySqlDatabaseListResult>, IPersistableModel<MySqlDatabaseListResult>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MySqlDatabaseListResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<MySqlDatabaseListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MySqlDatabaseListResult)} does not support '{format}' format.");
            }
