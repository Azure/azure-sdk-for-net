...
namespace Azure.ResourceManager.MySql.Models
{
    ...
    public partial class MySqlLogFile : ResourceData
    {
        ...
        internal MySqlLogFile(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, long? sizeInKB, DateTimeOffset? createdOn, DateTimeOffset? lastModifiedOn, string logFileType, Uri uri, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
            SizeInKB = sizeInKB;
            CreatedOn = createdOn;
