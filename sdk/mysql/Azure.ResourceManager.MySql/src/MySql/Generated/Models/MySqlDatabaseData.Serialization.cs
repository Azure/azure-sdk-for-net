...
namespace Azure.ResourceManager.MySql
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MySqlDatabaseData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MySqlDatabaseData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MySqlDatabaseData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MySqlDatabaseData>)} interface");
            }
        ...
        string IPersistableModel<MySqlDatabaseData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
