...
namespace Azure.ResourceManager.MySql
{
    public partial class MySqlDatabaseData : IUtf8JsonSerializable
    {
        ...
        internal static MySqlDatabaseData DeserializeMySqlDatabaseData(JsonElement element)
        {
            ...
            return new MySqlDatabaseData(id, name, type, systemData.Value, charset.Value, collation.Value);
        }
    }
}
