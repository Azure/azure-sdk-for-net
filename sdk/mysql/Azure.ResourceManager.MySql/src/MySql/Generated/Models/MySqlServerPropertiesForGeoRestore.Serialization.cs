...
namespace Azure.ResourceManager.MySql.Models
{
    public partial class MySqlServerPropertiesForGeoRestore : IUtf8JsonSerializable, IModelJsonSerializable<MySqlServerPropertiesForGeoRestore>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<MySqlServerPropertiesForGeoRestore>(this, options.Format);
        ...
        internal static MySqlServerPropertiesForGeoRestore DeserializeMySqlServerPropertiesForGeoRestore(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new MySqlServerPropertiesForGeoRestore(Optional.ToNullable(version), Optional.ToNullable(sslEnforcement), Optional.ToNullable(minimalTlsVersion), Optional.ToNullable(infrastructureEncryption), Optional.ToNullable(publicNetworkAccess), storageProfile.Value, createMode, sourceServerId, serializedAdditionalRawData);
        }
        ...
        /// <summary> Converts a <see cref="MySqlServerPropertiesForGeoRestore"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="MySqlServerPropertiesForGeoRestore"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="MySqlServerPropertiesForGeoRestore"/>. </summary>
