...
namespace Azure.ResourceManager.MySql.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MySqlServerPropertiesForGeoRestore>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MySqlServerPropertiesForGeoRestore>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MySqlServerPropertiesForGeoRestore>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MySqlServerPropertiesForGeoRestore>)} interface");
            }
        ...
        string IPersistableModel<MySqlServerPropertiesForGeoRestore>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
