...
namespace Azure.ResourceManager.MySql
{
    ...
    public partial class MySqlConfigurationData : ResourceData
    {
        ...
        internal MySqlConfigurationData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string value, string description, string defaultValue, string dataType, string allowedValues, string source, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData)
        {
            Value = value;
