...
namespace Azure.ResourceManager.MySql
{
    internal partial class WaitStatisticsRestOperations
    {
        ...
        internal RequestUriBuilder CreateGetRequestUri(string subscriptionId, string resourceGroupName, string serverName, string waitStatisticsId)
        {
        ...
        public async Task<Response<MySqlWaitStatisticData>> GetAsync(string subscriptionId, string resourceGroupName, string serverName, string waitStatisticsId, CancellationToken cancellationToken = default)
        {
            ...
            {
                throw new ArgumentNullException(nameof(waitStatisticsId));
            }
            if (waitStatisticsId.Length == 0)
            {
                throw new ArgumentException("Value cannot be an empty string.", nameof(waitStatisticsId));
            }
        ...
        internal RequestUriBuilder CreateListByServerRequestUri(string subscriptionId, string resourceGroupName, string serverName, MySqlWaitStatisticsInput input)
        {
            var uri = new RawRequestUriBuilder();
            uri.Reset(_endpoint);
            uri.AppendPath("/subscriptions/", false);
        ...
        internal RequestUriBuilder CreateListByServerNextPageRequestUri(string nextLink, string subscriptionId, string resourceGroupName, string serverName, MySqlWaitStatisticsInput input)
        {
            var uri = new RawRequestUriBuilder();
            uri.Reset(_endpoint);
