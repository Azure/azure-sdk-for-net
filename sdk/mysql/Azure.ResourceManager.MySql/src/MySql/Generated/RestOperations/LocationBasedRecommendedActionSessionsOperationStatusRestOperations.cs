...
{
    internal partial class LocationBasedRecommendedActionSessionsOperationStatusRestOperations
    {
        ...
        /// <summary> Initializes a new instance of LocationBasedRecommendedActionSessionsOperationStatusRestOperations. </summary>
        /// <param name="pipeline"> The HTTP pipeline for sending and receiving REST requests and responses. </param>
        /// <param name="applicationId"> The application id to use for user agent. </param>
        /// <param name="endpoint"> server parameter. </param>
        /// <param name="apiVersion"> Api Version. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="pipeline"/> or <paramref name="apiVersion"/> is null. </exception>
        public LocationBasedRecommendedActionSessionsOperationStatusRestOperations(HttpPipeline pipeline, string applicationId, Uri endpoint = null, string apiVersion = default)
        {
        ...
        internal HttpMessage CreateGetRequest(string subscriptionId, string locationName, string operationId)
        {
            ...
            uri.AppendPath("/recommendedActionSessionsAzureAsyncOperation/", false);
