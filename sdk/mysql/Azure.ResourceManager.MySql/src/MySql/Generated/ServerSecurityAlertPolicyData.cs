...
namespace Azure.ResourceManager.MySql
{
    ...
    public partial class ServerSecurityAlertPolicyData : ResourceData
    {
        ...
        internal ServerSecurityAlertPolicyData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, ServerSecurityAlertPolicyState? state, IList<string> disabledAlerts, IList<string> emailAddresses, bool? emailAccountAdmins, string storageEndpoint, string storageAccountAccessKey, int? retentionDays) : base(id, name, resourceType, systemData)
        {
            State = state;
