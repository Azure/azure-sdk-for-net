...
namespace Azure.ResourceManager.MySql
{
    ...
    public partial class MySqlAdvisorData : ResourceData
    {
        ...
        internal MySqlAdvisorData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, BinaryData properties, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
