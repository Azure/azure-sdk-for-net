...
namespace Azure.ResourceManager.MySql
{
    ...
    public partial class MySqlServerResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<MySqlConfigurationListResult>> UpdateConfigurationsAsync(WaitUntil waitUntil, MySqlConfigurationListContent content, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="content"/> is null. </exception>
        public virtual ArmOperation<MySqlConfigurationListResult> UpdateConfigurations(WaitUntil waitUntil, MySqlConfigurationListContent content, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(content, nameof(content));
