...
namespace Azure.ResourceManager.MySql
{
    ...
    public partial class MySqlPrivateEndpointConnectionResource : ArmResource
    {
        ...
        internal MySqlPrivateEndpointConnectionResource(ArmClient client, MySqlPrivateEndpointConnectionData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<MySqlPrivateEndpointConnectionResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new MySqlPrivateEndpointConnectionResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
