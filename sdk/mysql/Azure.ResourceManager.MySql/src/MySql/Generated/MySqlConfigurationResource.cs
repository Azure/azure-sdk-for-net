...
namespace Azure.ResourceManager.MySql
{
    ...
    public partial class MySqlConfigurationResource : ArmResource
    {
        ...
        internal MySqlConfigurationResource(ArmClient client, MySqlConfigurationData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<MySqlConfigurationResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new MySqlConfigurationResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
