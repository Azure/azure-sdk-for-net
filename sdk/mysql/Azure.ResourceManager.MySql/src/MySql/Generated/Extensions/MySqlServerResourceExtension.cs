...
namespace Azure.ResourceManager.MySql.Mock
{
    ...
    public partial class MySqlServerResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="MySqlServerResourceExtension"/> class for mocking. </summary>
        protected MySqlServerResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MySqlServerResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MySqlServerResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<MySqlServerResource> GetMySqlServersAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, null, e => new MySqlServerResource(Client, MySqlServerData.DeserializeMySqlServerData(e)), MySqlServerServersClientDiagnostics, Pipeline, "MySqlServerResourceExtension.GetMySqlServers", "value", null, cancellationToken);
        }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => MySqlServerServersRestClient.CreateListRequest(Id.SubscriptionId);
            return PageableHelpers.CreatePageable(FirstPageRequest, null, e => new MySqlServerResource(Client, MySqlServerData.DeserializeMySqlServerData(e)), MySqlServerServersClientDiagnostics, Pipeline, "MySqlServerResourceExtension.GetMySqlServers", "value", null, cancellationToken);
        }
    }
}
