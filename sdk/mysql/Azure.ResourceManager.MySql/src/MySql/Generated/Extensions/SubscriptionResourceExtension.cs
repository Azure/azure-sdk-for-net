...
namespace Azure.ResourceManager.MySql.Mock
{
    ...
    public partial class SubscriptionResourceExtension : ArmResource
    {
        ...
        private ClientDiagnostics LocationBasedPerformanceTierClientDiagnostics => _locationBasedPerformanceTierClientDiagnostics ??= new ClientDiagnostics("Azure.ResourceManager.MySql.Mock", ProviderConstants.DefaultProviderNamespace, Diagnostics);
        ...
        private ClientDiagnostics CheckNameAvailabilityClientDiagnostics => _checkNameAvailabilityClientDiagnostics ??= new ClientDiagnostics("Azure.ResourceManager.MySql.Mock", ProviderConstants.DefaultProviderNamespace, Diagnostics);
        ...
        public virtual AsyncPageable<MySqlPerformanceTier> GetLocationBasedPerformanceTiersAsync(AzureLocation locationName, CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, null, MySqlPerformanceTier.DeserializeMySqlPerformanceTier, LocationBasedPerformanceTierClientDiagnostics, Pipeline, "SubscriptionResourceExtension.GetLocationBasedPerformanceTiers", "value", null, cancellationToken);
        }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => LocationBasedPerformanceTierRestClient.CreateListRequest(Id.SubscriptionId, locationName);
            return PageableHelpers.CreatePageable(FirstPageRequest, null, MySqlPerformanceTier.DeserializeMySqlPerformanceTier, LocationBasedPerformanceTierClientDiagnostics, Pipeline, "SubscriptionResourceExtension.GetLocationBasedPerformanceTiers", "value", null, cancellationToken);
        }
        ...
        public virtual async Task<Response<MySqlNameAvailabilityResult>> CheckMySqlNameAvailabilityAsync(MySqlNameAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = CheckNameAvailabilityClientDiagnostics.CreateScope("SubscriptionResourceExtension.CheckMySqlNameAvailability");
            scope.Start();
            try
            {
