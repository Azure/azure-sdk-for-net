...
namespace Azure.ResourceManager.MySql.Mocking
{
    ...
    internal partial class MySqlArmClientMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="MySqlArmClientMockingExtension"/> class for mocking. </summary>
        protected MySqlArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MySqlArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MySqlArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal MySqlArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
