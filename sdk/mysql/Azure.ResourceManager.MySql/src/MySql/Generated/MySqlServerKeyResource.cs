...
namespace Azure.ResourceManager.MySql
{
    ...
    public partial class MySqlServerKeyResource : ArmResource
    {
        ...
        internal MySqlServerKeyResource(ArmClient client, MySqlServerKeyData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<MySqlServerKeyResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new MySqlServerKeyResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
