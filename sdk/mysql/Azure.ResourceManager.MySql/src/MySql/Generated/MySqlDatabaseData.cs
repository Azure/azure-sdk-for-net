...
namespace Azure.ResourceManager.MySql
{
    ...
    public partial class MySqlDatabaseData : ResourceData
    {
        ...
        internal MySqlDatabaseData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string charset, string collation, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData)
        {
            Charset = charset;
            Collation = collation;
            _rawData = rawData;
