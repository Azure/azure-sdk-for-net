...
namespace Azure.ResourceManager.MySql
{
    ...
    /// Each <see cref="ServerSecurityAlertPolicyResource" /> in the collection will belong to the same instance of <see cref="ServerResource" />.
    /// To get a <see cref="ServerSecurityAlertPolicyCollection" /> instance call the GetServerSecurityAlertPolicies method from an instance of <see cref="ServerResource" />.
    /// </summary>
    public partial class ServerSecurityAlertPolicyCollection : ArmCollection, IEnumerable<ServerSecurityAlertPolicyResource>, IAsyncEnumerable<ServerSecurityAlertPolicyResource>
    {
        ...
        {
            _serverSecurityAlertPolicyClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.MySql", ServerSecurityAlertPolicyResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<ServerSecurityAlertPolicyResource>> CreateOrUpdateAsync(WaitUntil waitUntil, SecurityAlertPolicyName securityAlertPolicyName, ServerSecurityAlertPolicyData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new MySqlArmOperation<ServerSecurityAlertPolicyResource>(new ServerSecurityAlertPolicyOperationSource(Client), _serverSecurityAlertPolicyClientDiagnostics, Pipeline, _serverSecurityAlertPolicyRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, securityAlertPolicyName, data).Request, response, OperationFinalStateVia.Location);
