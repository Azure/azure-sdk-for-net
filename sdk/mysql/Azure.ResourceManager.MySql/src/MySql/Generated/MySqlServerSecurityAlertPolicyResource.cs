...
namespace Azure.ResourceManager.MySql
{
    ...
    public partial class MySqlServerSecurityAlertPolicyResource : ArmResource
    {
        ...
        internal MySqlServerSecurityAlertPolicyResource(ArmClient client, MySqlServerSecurityAlertPolicyData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<MySqlServerSecurityAlertPolicyResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new MySqlServerSecurityAlertPolicyResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
