...
namespace Azure.ResourceManager.MySql
{
    ...
    public partial class MySqlPrivateEndpointConnectionData : ResourceData
    {
        ...
        internal MySqlPrivateEndpointConnectionData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, WritableSubResource privateEndpoint, MySqlPrivateLinkServiceConnectionStateProperty connectionState, string provisioningState, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData)
        {
