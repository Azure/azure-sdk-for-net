...
namespace Azure.ResourceManager.MySql.Tests
{
    public class MySqlFlexibleServerBackupTests: MySqlManagementTestBase
    {
        ...
        public async Task CreateBackupAndExport()
        {
            ...
            {
                Sku = new MySQLServerSku("Standard_B1ms", ServerSkuTier.Burstable),
            ...
            list1.Add("https://storagesumitkuma.blob.core.windows.net/ltrbackup-container-1?sp=racwdli&st=2023-10-23T06:10:33Z&se=2024-01-31T14:10:33Z&spr=https&sv=2022-11-02&sr=c&sig=7awngKnKyDJaAij8DRuYSTVpqY8Byw07Q5cdbxc2v1A%3D");
