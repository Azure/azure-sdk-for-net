...
namespace Azure.ResourceManager.MySql.Samples
{
    public partial class Sample_FirewallRuleResource
    {
        ...
        public async Task Get_GetAFirewallRule()
        {
            ...
            ResourceIdentifier firewallRuleResourceId = FirewallRuleResource.CreateResourceIdentifier(subscriptionId, resourceGroupName, serverName, firewallRuleName);
        ...
        public async Task Update_CreateAFirewallRule()
        {
            ...
            // invoke the operation
            FirewallRuleData data = new FirewallRuleData(null, null);
