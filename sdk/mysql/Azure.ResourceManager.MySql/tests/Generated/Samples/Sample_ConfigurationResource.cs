...
namespace Azure.ResourceManager.MySql.Samples
{
    public partial class Sample_ConfigurationResource
    {
        ...
        public async Task Get_GetAConfiguration()
        {
            ...
            ResourceIdentifier configurationResourceId = ConfigurationResource.CreateResourceIdentifier(subscriptionId, resourceGroupName, serverName, configurationName);
        ...
        public async Task Update_UpdateAUserConfiguration()
        {
            ...
            ArmOperation<ConfigurationResource> lro = await configuration.UpdateAsync(WaitUntil.Completed, data);
