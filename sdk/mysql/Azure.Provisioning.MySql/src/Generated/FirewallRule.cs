...
namespace Azure.Provisioning.MySql
{
    ...
    public partial class FirewallRule : ProvisionableResource
    {
        ...
        /// <summary> Creates a new FirewallRule. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public FirewallRule(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.DBforMySQL/flexibleServers/firewallRules", resourceVersion ?? "2024-12-30")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for FirewallRule. </summary>
        ...
        /// <summary> Creates a reference to an existing FirewallRule. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static FirewallRule FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            FirewallRule result = new FirewallRule(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for FirewallRule that are not part of the generated code. </summary>
