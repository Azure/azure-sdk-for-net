...
namespace Azure.Provisioning.MySql
{
    ...
    public partial class Server : ProvisionableResource
    {
        ...
        public Server(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.DBforMySQL/flexibleServers", resourceVersion ?? "2024-12-30")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for Server. </summary>
        ...
        /// <summary> Creates a reference to an existing Server. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static Server FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            Server result = new Server(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for Server that are not part of the generated code. </summary>
