...
namespace Azure.Provisioning.MySql
{
    ...
    public partial class Maintenance : ProvisionableResource
    {
        ...
        /// <summary> Creates a new Maintenance. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        internal Maintenance(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.DBforMySQL/flexibleServers/maintenances", resourceVersion ?? "2024-12-30")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for Maintenance. </summary>
        ...
        /// <summary> Creates a reference to an existing Maintenance. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static Maintenance FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            Maintenance result = new Maintenance(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for Maintenance that are not part of the generated code. </summary>
