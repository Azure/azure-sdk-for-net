...
namespace Azure.Provisioning.MySql
{
    ...
    public partial class MySqlFlexibleServerBackup : ProvisionableResource
    {
        ...
        /// <summary> Creates a new MySqlFlexibleServerBackup. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public MySqlFlexibleServerBackup(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.DBforMySQL/flexibleServers/backups", resourceVersion ?? "2024-12-30")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for MySqlFlexibleServerBackup. </summary>
        ...
        /// <summary> Creates a reference to an existing MySqlFlexibleServerBackup. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static MySqlFlexibleServerBackup FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            MySqlFlexibleServerBackup result = new MySqlFlexibleServerBackup(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for MySqlFlexibleServerBackup that are not part of the generated code. </summary>
