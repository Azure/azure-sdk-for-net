...
{
    public partial class Sample_DisconnectedOperationsImageCollection
    {
        [Test]
        ...
        public async Task GetAll_ImagesListByDisconnectedOperation()
        {
            ...
            int? top = 20;
            int? skip = 3;
            await foreach (DisconnectedOperationsImageResource item in collection.GetAllAsync(filter: filter, maxCount: top, skip: skip))
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                DisconnectedOperationsImageData resourceData = item.Data;
                // for demo we just print out the id
                Console.WriteLine($"Succeeded on id: {resourceData.Id}");
            }
