...
{
    public partial class Sample_DisconnectedOperationsArtifactCollection
    {
        [Test]
        ...
        public async Task Get_ArtifactsGet()
        {
            ...
            // get the collection of this DisconnectedOperationsArtifactResource
            DisconnectedOperationsArtifactCollection collection = disconnectedOperationsImage.GetDisconnectedOperationsArtifacts();

            // invoke the operation
            string artifactName = "-8Y-Us1BNNG6-H5w6-2--RP";
            DisconnectedOperationsArtifactResource result = await collection.GetAsync(artifactName);
        ...
        public async Task GetAll_ArtifactsListByParent()
        {
            ...
            await foreach (DisconnectedOperationsArtifactResource item in collection.GetAllAsync())
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                DisconnectedOperationsArtifactData resourceData = item.Data;
                // for demo we just print out the id
                Console.WriteLine($"Succeeded on id: {resourceData.Id}");
            }
        ...
        public async Task GetIfExists_ArtifactsGet()
        {
            ...
            // invoke the operation
            string artifactName = "-8Y-Us1BNNG6-H5w6-2--RP";
            NullableResponse<DisconnectedOperationsArtifactResource> response = await collection.GetIfExistsAsync(artifactName);
            DisconnectedOperationsArtifactResource result = response.HasValue ? response.Value : null;
