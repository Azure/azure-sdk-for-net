...
namespace Azure.ResourceManager.DisconnectedOperations
{
    ...
    public partial class ArtifactData : ResourceData
    {
        ...
        internal ArtifactData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, ArtifactProperties properties, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
        ...
        public ArtifactProperties Properties { get; }
    }
}
