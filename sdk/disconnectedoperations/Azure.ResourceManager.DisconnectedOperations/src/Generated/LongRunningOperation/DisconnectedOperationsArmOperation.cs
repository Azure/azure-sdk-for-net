...
namespace Azure.ResourceManager.DisconnectedOperations
{
    internal partial class DisconnectedOperationsArmOperation : ArmOperation
    {
        ...
        internal DisconnectedOperationsArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
