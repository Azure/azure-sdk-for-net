...
#pragma warning disable SA1649 // File name should match first type name
    internal class DisconnectedOperationsArmOperation : ArmOperation
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        internal DisconnectedOperationsArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal DisconnectedOperationsArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal(nextLinkOperation, clientDiagnostics, response, "DisconnectedOperationsArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
