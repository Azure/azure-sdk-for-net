...
{
    /// <summary></summary>
    internal partial class DisconnectedOperationResourceOperationSource : IOperationSource<DisconnectedOperationResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal DisconnectedOperationResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
