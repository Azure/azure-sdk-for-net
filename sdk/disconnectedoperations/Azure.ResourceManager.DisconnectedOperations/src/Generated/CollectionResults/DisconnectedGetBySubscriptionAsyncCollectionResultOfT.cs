...
namespace Azure.ResourceManager.DisconnectedOperations
{
    internal partial class DisconnectedGetBySubscriptionAsyncCollectionResultOfT : AsyncPageable<DisconnectedOperationData>
    {
        ...
        public DisconnectedGetBySubscriptionAsyncCollectionResultOfT(Disconnected client, Guid subscriptionId, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
