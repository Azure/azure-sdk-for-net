...
namespace Azure.ResourceManager.DisconnectedOperations
{
    internal partial class DisconnectedGetByResourceGroupAsyncCollectionResultOfT : AsyncPageable<DisconnectedOperationData>
    {
        ...
        public DisconnectedGetByResourceGroupAsyncCollectionResultOfT(Disconnected client, Guid subscriptionId, string resourceGroupName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
