...
{
    internal partial class DisconnectedOperationsOprsGetByResourceGroupAsyncCollectionResultOfT : AsyncPageable<DisconnectedOperationData>
    {
        ...
        /// <summary> Initializes a new instance of DisconnectedOperationsOprsGetByResourceGroupAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public DisconnectedOperationsOprsGetByResourceGroupAsyncCollectionResultOfT(DisconnectedOperationsOprs client, Guid subscriptionId, string resourceGroupName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of DisconnectedOperationsOprsGetByResourceGroupAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of DisconnectedOperationsOprsGetByResourceGroupAsyncCollectionResultOfT as an enumerable collection. </returns>
