...
namespace Azure.ResourceManager.DisconnectedOperations
{
    internal partial class DisconnectedGetByResourceGroupCollectionResultOfT : Pageable<DisconnectedOperationData>
    {
        ...
        public DisconnectedGetByResourceGroupCollectionResultOfT(Disconnected client, Guid subscriptionId, string resourceGroupName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
