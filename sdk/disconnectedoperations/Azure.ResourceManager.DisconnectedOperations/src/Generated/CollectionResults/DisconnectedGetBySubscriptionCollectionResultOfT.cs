...
{
    internal partial class DisconnectedGetBySubscriptionCollectionResultOfT : Pageable<DisconnectedOperationData>
    {
        ...
        /// <summary> Initializes a new instance of DisconnectedGetBySubscriptionCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public DisconnectedGetBySubscriptionCollectionResultOfT(Disconnected client, Guid subscriptionId, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of DisconnectedGetBySubscriptionCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of DisconnectedGetBySubscriptionCollectionResultOfT as an enumerable collection. </returns>
