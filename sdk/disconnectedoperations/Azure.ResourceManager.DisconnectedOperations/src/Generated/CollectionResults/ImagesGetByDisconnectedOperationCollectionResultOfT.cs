...
{
    internal partial class ImagesGetByDisconnectedOperationCollectionResultOfT : Pageable<DisconnectedOperationsImageData>
    {
        ...
        public ImagesGetByDisconnectedOperationCollectionResultOfT(Images client, Guid subscriptionId, string resourceGroupName, string name, string filter, int? maxCount, int? skip, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <returns> The pages of ImagesGetByDisconnectedOperationCollectionResultOfT as an enumerable collection. </returns>
        public override IEnumerable<Page<DisconnectedOperationsImageData>> AsPages(string continuationToken, int? pageSizeHint)
        {
