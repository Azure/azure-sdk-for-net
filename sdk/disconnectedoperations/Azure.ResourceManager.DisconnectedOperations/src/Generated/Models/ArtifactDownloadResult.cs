...
namespace Azure.ResourceManager.DisconnectedOperations.Models
{
    ...
    public partial class ArtifactDownloadResult
    {
        ...
        /// <summary> Initializes a new instance of <see cref="ArtifactDownloadResult"/>. </summary>
        ...
        internal ArtifactDownloadResult(int artifactOrder, string title, string description, Uri downloadLink, DateTimeOffset linkExpiry)
        {
        ...
        internal ArtifactDownloadResult(ResourceProvisioningState? provisioningState, int artifactOrder, string title, string description, long? size, Uri downloadLink, DateTimeOffset linkExpiry, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
        ...
        /// <summary> Initializes a new instance of <see cref="ArtifactDownloadResult"/> for deserialization. </summary>
