...
namespace Azure.ResourceManager.DisconnectedOperations.Models
{
    ...
    internal partial class ImageListResult
    {
        ...
        internal ImageListResult(IReadOnlyList<DisconnectedOperationsImageData> value, Uri nextLink, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Value = value;
            NextLink = nextLink;
        ...
        public IReadOnlyList<DisconnectedOperationsImageData> Value { get; }
