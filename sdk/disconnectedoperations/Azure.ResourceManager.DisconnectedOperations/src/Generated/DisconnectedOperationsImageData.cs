...
namespace Azure.ResourceManager.DisconnectedOperations
{
    ...
    public partial class DisconnectedOperationsImageData : ResourceData
    {
        ...
        internal DisconnectedOperationsImageData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, DisconnectedOperationsImageProperties properties) : base(id, name, resourceType, systemData)
        {
