...
namespace Azure.ResourceManager.Graphservicesprod
{
    ...
    public partial class AccountResource : ArmResource
    {
        ...
        {
            _accountResourceAccountsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Graphservicesprod", ResourceType.Namespace, Diagnostics);
            TryGetApiVersion(ResourceType, out string accountResourceAccountsApiVersion);
        ...
        {
            using var scope = _accountResourceAccountsClientDiagnostics.CreateScope("AccountResource.Get");
            scope.Start();
            try
            {
                var response = await _accountResourceAccountsRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<AccountResource> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _accountResourceAccountsRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new AccountResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        {
            using var scope = _accountResourceAccountsClientDiagnostics.CreateScope("AccountResource.Delete");
            scope.Start();
            try
            {
                var response = await _accountResourceAccountsRestClient.DeleteAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken).ConfigureAwait(false);
                var operation = new GraphservicesprodArmOperation(response);
        ...
        public virtual ArmOperation Delete(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _accountResourceAccountsRestClient.Delete(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken);
                var operation = new GraphservicesprodArmOperation(response);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<Response<AccountResource>> UpdateAsync(AccountResourcePatch patch, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _accountResourceAccountsClientDiagnostics.CreateScope("AccountResource.Update");
            scope.Start();
            try
            {
                var response = await _accountResourceAccountsRestClient.UpdateAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, patch, cancellationToken).ConfigureAwait(false);
                return Response.FromValue(new AccountResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        public virtual Response<AccountResource> Update(AccountResourcePatch patch, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _accountResourceAccountsRestClient.Update(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, patch, cancellationToken);
                return Response.FromValue(new AccountResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        public virtual async Task<Response<AccountResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _accountResourceAccountsClientDiagnostics.CreateScope("AccountResource.AddTag");
            scope.Start();
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
                {
                    ...
                    var originalResponse = await _accountResourceAccountsRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<AccountResource> AddTag(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                if (CanUseTagResource(cancellationToken: cancellationToken))
                {
                    ...
                    var originalResponse = _accountResourceAccountsRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken);
                    return Response.FromValue(new AccountResource(Client, originalResponse.Value), originalResponse.GetRawResponse());
                }
                else
                {
        ...
        public virtual async Task<Response<AccountResource>> SetTagsAsync(IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _accountResourceAccountsClientDiagnostics.CreateScope("AccountResource.SetTags");
            scope.Start();
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
        ...
        public virtual async Task<Response<AccountResource>> RemoveTagAsync(string key, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _accountResourceAccountsClientDiagnostics.CreateScope("AccountResource.RemoveTag");
            scope.Start();
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
