...
namespace Azure.ResourceManager.Graphservicesprod
{
    ...
    public partial class AccountResourceCollection : ArmCollection, IEnumerable<AccountResource>, IAsyncEnumerable<AccountResource>
    {
        ...
        {
            _accountResourceAccountsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Graphservicesprod", AccountResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<AccountResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string resourceName, AccountResourceData data, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _accountResourceAccountsClientDiagnostics.CreateScope("AccountResourceCollection.CreateOrUpdate");
            scope.Start();
            try
            {
                var response = await _accountResourceAccountsRestClient.CreateAndUpdateAsync(Id.SubscriptionId, Id.ResourceGroupName, resourceName, data, cancellationToken).ConfigureAwait(false);
                var operation = new GraphservicesprodArmOperation<AccountResource>(new AccountResourceOperationSource(Client), _accountResourceAccountsClientDiagnostics, Pipeline, _accountResourceAccountsRestClient.CreateCreateAndUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, resourceName, data).Request, response, OperationFinalStateVia.AzureAsyncOperation);
        ...
        public virtual ArmOperation<AccountResource> CreateOrUpdate(WaitUntil waitUntil, string resourceName, AccountResourceData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _accountResourceAccountsRestClient.CreateAndUpdate(Id.SubscriptionId, Id.ResourceGroupName, resourceName, data, cancellationToken);
                var operation = new GraphservicesprodArmOperation<AccountResource>(new AccountResourceOperationSource(Client), _accountResourceAccountsClientDiagnostics, Pipeline, _accountResourceAccountsRestClient.CreateCreateAndUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, resourceName, data).Request, response, OperationFinalStateVia.AzureAsyncOperation);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<Response<AccountResource>> GetAsync(string resourceName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _accountResourceAccountsClientDiagnostics.CreateScope("AccountResourceCollection.Get");
            scope.Start();
            try
            {
                var response = await _accountResourceAccountsRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, resourceName, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<AccountResource> Get(string resourceName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _accountResourceAccountsRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, resourceName, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new AccountResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string resourceName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _accountResourceAccountsClientDiagnostics.CreateScope("AccountResourceCollection.Exists");
            scope.Start();
            try
            {
                var response = await _accountResourceAccountsRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, resourceName, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<bool> Exists(string resourceName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _accountResourceAccountsRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, resourceName, cancellationToken: cancellationToken);
                return Response.FromValue(response.Value != null, response.GetRawResponse());
            }
            catch (Exception e)
            {
