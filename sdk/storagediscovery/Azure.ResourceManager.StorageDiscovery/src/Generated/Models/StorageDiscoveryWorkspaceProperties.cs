...
namespace Azure.ResourceManager.StorageDiscovery.Models
{
    ...
    public partial class StorageDiscoveryWorkspaceProperties
    {
        ...
        internal StorageDiscoveryWorkspaceProperties(StorageDiscoverySku? sku, string description, IList<ResourceIdentifier> workspaceRoots, IList<StorageDiscoveryScope> scopes, ResourceProvisioningState? provisioningState, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Sku = sku;
