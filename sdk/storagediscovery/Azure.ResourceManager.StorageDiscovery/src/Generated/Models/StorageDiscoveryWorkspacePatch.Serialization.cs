...
namespace Azure.ResourceManager.StorageDiscovery.Models
{
    ...
    public partial class StorageDiscoveryWorkspacePatch : IJsonModel<StorageDiscoveryWorkspacePatch>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<StorageDiscoveryWorkspacePatch>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        internal static RequestContent ToRequestContent(StorageDiscoveryWorkspacePatch storageDiscoveryWorkspacePatch)
        {
            ...
            return RequestContent.Create(storageDiscoveryWorkspacePatch, ModelSerializationExtensions.WireOptions);
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        StorageDiscoveryWorkspacePatch IJsonModel<StorageDiscoveryWorkspacePatch>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual StorageDiscoveryWorkspacePatch JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<StorageDiscoveryWorkspacePatch>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static StorageDiscoveryWorkspacePatch DeserializeStorageDiscoveryWorkspacePatch(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new StorageDiscoveryWorkspacePatch(tags ?? new ChangeTrackingDictionary<string, string>(), properties, additionalBinaryDataProperties);
        }
    }
}
