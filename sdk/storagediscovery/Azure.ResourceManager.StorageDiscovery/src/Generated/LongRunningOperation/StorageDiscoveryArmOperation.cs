...
namespace Azure.ResourceManager.StorageDiscovery
{
    internal partial class StorageDiscoveryArmOperation : ArmOperation
    {
        ...
        internal StorageDiscoveryArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
