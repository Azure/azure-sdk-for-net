...
#pragma warning disable SA1649 // File name should match first type name
    internal class StorageDiscoveryArmOperation : ArmOperation
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        /// <summary> Initializes a new instance of StorageDiscoveryArmOperation for mocking. </summary>
        protected StorageDiscoveryArmOperation()
        {
        }

        internal StorageDiscoveryArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal StorageDiscoveryArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal(nextLinkOperation, clientDiagnostics, response, "StorageDiscoveryArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
        ...
        private string GetOperationId(RehydrationToken? rehydrationToken)
        {
            ...
            var lroDetails = ModelReaderWriter.Write(rehydrationToken, ModelReaderWriterOptions.Json, AzureResourceManagerStorageDiscoveryContext.Default).ToObjectFromJson<Dictionary<string, string>>();
