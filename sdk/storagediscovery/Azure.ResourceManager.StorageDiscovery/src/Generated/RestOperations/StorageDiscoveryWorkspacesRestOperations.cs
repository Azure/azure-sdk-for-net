...
namespace Azure.ResourceManager.StorageDiscovery
{
    internal partial class StorageDiscoveryWorkspaces
    {
        ...
        internal StorageDiscoveryWorkspaces(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string applicationId, Uri endpoint, string apiVersion)
        {
            ClientDiagnostics = clientDiagnostics;
            _endpoint = endpoint;
            Pipeline = pipeline;
            _apiVersion = apiVersion;
            _userAgent = new TelemetryDetails(typeof(StorageDiscoveryWorkspaces).Assembly, applicationId);
        }
