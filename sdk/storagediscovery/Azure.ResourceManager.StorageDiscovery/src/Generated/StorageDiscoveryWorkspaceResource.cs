...
namespace Azure.ResourceManager.StorageDiscovery
{
    ...
    public partial class StorageDiscoveryWorkspaceResource : ArmResource
    {
        ...
        /// <summary>
        /// Updates the StorageDiscoveryWorkspace.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.StorageDiscovery/storageDiscoveryWorkspaces/{storageDiscoveryWorkspaceName}. </description>
        ...
        public virtual async Task<ArmOperation<StorageDiscoveryWorkspaceResource>> UpdateAsync(WaitUntil waitUntil, StorageDiscoveryWorkspaceData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _storageDiscoveryWorkspacesRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, StorageDiscoveryWorkspaceData.ToRequestContent(data), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<StorageDiscoveryWorkspaceData> response = Response.FromValue(StorageDiscoveryWorkspaceData.FromResponse(result), result);
                RequestUriBuilder uri = message.Request.Uri;
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<StorageDiscoveryWorkspaceResource> Update(WaitUntil waitUntil, StorageDiscoveryWorkspaceData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
