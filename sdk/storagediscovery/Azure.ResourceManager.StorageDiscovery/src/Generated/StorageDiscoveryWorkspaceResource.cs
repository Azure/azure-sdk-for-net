...
namespace Azure.ResourceManager.StorageDiscovery
{
    ...
    public partial class StorageDiscoveryWorkspaceResource : ArmResource
    {
        ...
        public virtual async Task<Response<StorageDiscoveryWorkspaceResource>> UpdateAsync(StorageDiscoveryWorkspaceData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _storageDiscoveryWorkspaceRestClient.UpdateAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, data, cancellationToken).ConfigureAwait(false);
                return Response.FromValue(new StorageDiscoveryWorkspaceResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        public virtual Response<StorageDiscoveryWorkspaceResource> Update(StorageDiscoveryWorkspaceData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
            ...
            try
            {
                var response = _storageDiscoveryWorkspaceRestClient.Update(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, data, cancellationToken);
                return Response.FromValue(new StorageDiscoveryWorkspaceResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        public virtual async Task<Response<StorageDiscoveryWorkspaceResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    var patch = new StorageDiscoveryWorkspaceData(current.Location);
