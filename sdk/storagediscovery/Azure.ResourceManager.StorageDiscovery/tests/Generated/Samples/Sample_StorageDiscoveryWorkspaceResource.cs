...
namespace Azure.ResourceManager.StorageDiscovery.Samples
{
    public partial class Sample_StorageDiscoveryWorkspaceResource
    {
        ...
        public async Task Update_UpdateAStorageDiscoveryWorkspace()
        {
            ...
            // invoke the operation
            StorageDiscoveryWorkspaceData data = new StorageDiscoveryWorkspaceData(default)
            {
            ...
            {
new StorageDiscoveryScope("Updated-Sample-Collection", new StorageDiscoveryResourceType[]{new StorageDiscoveryResourceType("/subscriptions/b79cb3ba-745e-5d9a-8903-4a02327a7e09/resourceGroups/sample-rg/providers/Microsoft.Storage/storageAccounts/updated-sample-storageAccount")})
{
...
["updated-filtertag4"] = "updated-value4"
                ...
                {
                    Sku = StorageDiscoverySku.Premium,
                    Description = "Updated Sample Storage Discovery Workspace",
                },
            };
            StorageDiscoveryWorkspaceResource result = await storageDiscoveryWorkspace.UpdateAsync(data);
