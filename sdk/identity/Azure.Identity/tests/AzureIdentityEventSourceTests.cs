...
namespace Azure.Identity.Tests
{
    ...
    public class AzureIdentityEventSourceTests : ClientTestBase
    {
        ...
        {
            var mockMsalClient = new MockMsalPublicClient() { DeviceCodeAuthFactory = (_,_) => { return AuthenticationResultFactory.Create(accessToken: Guid.NewGuid().ToString(), expiresOn: DateTimeOffset.UtcNow.AddMinutes(10)); } };
        ...
        public async Task ValidateSharedTokenCacheCredentialSucceededEvents()
        {
            var mockMsalClient = new MockMsalPublicClient
            {
                ...
                SilentAuthFactory = (_,_) => { return AuthenticationResultFactory.Create(accessToken: Guid.NewGuid().ToString(), expiresOn: DateTimeOffset.UtcNow.AddMinutes(10)); }
            };
        ...
        public async Task ValidateDeviceCodeCredentialFailedEvents()
        {
            ...
            var mockMsalClient = new MockMsalPublicClient() { DeviceCodeAuthFactory = (_,_) => throw new MockClientException(expExMessage) };
