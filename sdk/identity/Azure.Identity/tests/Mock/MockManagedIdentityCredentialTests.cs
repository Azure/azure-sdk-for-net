...
namespace Azure.Identity.Tests.Mock
{
    public class MockManagedIdentityCredentialTests
    {
        ...
        public async Task CancellationTokenHonoredAsync()
        {
            ...
            Task<AccessToken> getTokenComplete = credential.GetTokenAsync(new TokenOptions(MockScopes.Default), cancellation.Token);
        ...
        public async Task ScopesHonoredAsync()
        {
            ...
            AccessToken defaultScopeToken = await credential.GetTokenAsync(new TokenOptions(MockScopes.Default));
