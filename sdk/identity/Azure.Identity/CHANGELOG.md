...
### Bugs Fixed
- Fixed an issue where Azure CLI credential could hang or delay due to I/O contention when standard input/output was shared with the host process. https://github.com/Azure/azure-sdk-for-net/pull/49582
