...
### Features Added
- Continuous Access Evaluation (CAE) is now configurable per-request by setting the `EnableCae` property of `TokenCredentialOptions` and constructing a `TokenRequestContext` with it.
