...
### Features Added
- Added `TokenCredentialOptions.Diagnostics.IsExtendedUnsafeLoggingEnabled` to enable additional unsafe logging. This replaces `TokenCredentialOptions.IsPIILoggingEnabled` from 1.5.0-beta.4, and has the same impact on logging behavior.
