...
- Added `OpenBrowserAsync` property to `BrowserCustomizationOptions`, allowing users to specify a custom browser when authenticating with `InteractiveBrowserCredential`.
