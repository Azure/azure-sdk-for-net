namespace Azure.Identity
{
    ...
    public partial class AzurePipelinesCredential : Azure.Core.TokenCredential
    {
        ...
        public AzurePipelinesCredential(string systemAccessToken, string clientId, string tenantId, string serviceConnectionId, Azure.Identity.AzurePipelinesCredentialOptions options = null) { }
