...
namespace Azure.Identity
{
    ...
    public class OnBehalfOfCredential : TokenCredential
    {
            ...
            MsalConfidentialClient client)
        {
            ...
            _userAssertion = new UserAssertion(userAssertion);
            _client = client ?? new MsalConfidentialClient(_pipeline, _tenantId, _clientId, _clientSecret, null, options, default, options?.Diagnostics?.IsExtendedUnsafeLoggingEnabled ?? false);
        }
