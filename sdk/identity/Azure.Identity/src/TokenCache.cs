...
#pragma warning restore CA1001 // Types that own disposable fields should be disposable
    {
        ...
        /// </summary>
        internal Func<TokenCacheNotificationDetails, CancellationToken, Task<TokenCacheData>> RefreshCacheFromOptionsAsync;
        ...
        private async Task OnBeforeCacheAccessAsync(TokenCacheNotificationArgs args)
        {
            ...
            try
            {
                ...
                {
                    Data = (await RefreshCacheFromOptionsAsync(new TokenCacheNotificationDetails(args), default).ConfigureAwait(false))
                        .CacheBytes.ToArray();
                }
