...
namespace Azure.Identity
{
    ...
    public class EnvironmentCredential : TokenCredential
    {
        ...
        /// <exception cref="CredentialUnavailableException">Thrown when the credential is unavailable when used as part of a chained credential such as <see cref="DefaultAzureCredential"/> or <see cref="ChainedTokenCredential"/> or the environment is not properly configured.</exception>
