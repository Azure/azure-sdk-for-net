...
namespace Azure.Identity
{
    ...
    /// </summary>
    public class OnBehalfOfManagedIdentityCredential : TokenCredential
    {
        ...
        public OnBehalfOfManagedIdentityCredential(string userJwtBearerToken, string clientId = null, TokenCredentialOptions options = null)
            : this(clientId, CredentialPipeline.GetInstance(options))
        {
            _userAssertion = new UserAssertion(userJwtBearerToken);
        ...
        /// <param name="userJwtBearerToken"></param>
        /// <param name="options">Options to configure the management of the requests sent to the Azure Active Directory service.</param>
        public OnBehalfOfManagedIdentityCredential(
            ResourceIdentifier resourceId, string userJwtBearerToken, TokenCredentialOptions options = null)
            : this(
        ...
        internal OnBehalfOfManagedIdentityCredential(string clientId, CredentialPipeline pipeline, bool preserveTransport = false)
        ...
        internal OnBehalfOfManagedIdentityCredential(ResourceIdentifier resourceId, CredentialPipeline pipeline, bool preserveTransport = false)
        ...
        internal OnBehalfOfManagedIdentityCredential(ManagedIdentityClient client)
        {
        ...
        private async ValueTask<AccessToken> GetTokenImplAsync(bool async, TokenRequestContext requestContext, CancellationToken cancellationToken)
        {
            ...
            try
            {
                AccessToken result = await Client.AuthenticateOnBehalfOfAsync(
                    _userAssertion, async, requestContext, cancellationToken).ConfigureAwait(false);
