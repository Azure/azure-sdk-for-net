...
namespace Azure.Identity
{
    ...
    public class DeviceCodeCredential : TokenCredential
    {
        ...
        {
            AuthenticationResult result = await Client
                .AcquireTokenWithDeviceCodeAsync(context.Scopes, context.Claims, code => DeviceCodeCallbackImpl(code, cancellationToken), context.EnableCae, async, cancellationToken)
                .ConfigureAwait(false);
