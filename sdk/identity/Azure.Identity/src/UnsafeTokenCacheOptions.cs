...
namespace Azure.Identity
{
    ...
    public abstract class UnsafeTokenCacheOptions : TokenCachePersistenceOptions
    {
        ...
        /// This implementation will get called by the default implementation of <see cref="RefreshCacheAsync(TokenCacheNotificationDetails, CancellationToken)"/>.
        /// It is recommended to provide an implementation for <see cref="RefreshCacheAsync(TokenCacheNotificationDetails, CancellationToken)"/> rather than this method.
        /// </summary>
        ...
        /// </summary>
        /// <param name="details">The <see cref="TokenCacheNotificationDetails"/> containing information about the current state of the cache.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> controlling the lifetime of this operation.</param>
        protected internal virtual async Task<TokenCacheData> RefreshCacheAsync(TokenCacheNotificationDetails details, CancellationToken cancellationToken = default) =>
