...
namespace Azure.Identity
{
    ...
    public class ClientSecretCredential : TokenCredential
    {
        ...
        {
            return await _client.AuthenticateAsync(TenantId, ClientId, ClientSecret, options.Scopes, cancellationToken).ConfigureAwait(false);
        }
        ...
        {
            return _client.Authenticate(TenantId, ClientId, ClientSecret, options.Scopes, cancellationToken);
        }
    }
}
