...
namespace Azure.Identity
{
    ...
    /// <item><term>AZURE_USERNAME</term><description>The password of the Azure Active Directory user account. Note this does not support accounts with MFA enabled.</description></item>
    /// </list>
