...
namespace Azure.Identity
{
    internal class ManagedIdentityClient
    {
        ...
        {
            AuthenticationResult result = await _msal.AcquireTokenForClientAsync(context.Scopes, context.TenantId, context.EnableCae, async, cancellationToken).ConfigureAwait(false);
