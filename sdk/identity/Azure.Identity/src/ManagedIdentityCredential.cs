...
namespace Azure.Identity
{
    ...
    public class ManagedIdentityCredential : TokenCredential
    {
        ...
        {
            return await _client.AuthenticateAsync(options.Scopes, _clientId, cancellationToken).ConfigureAwait(false);
        }
        ...
        {
            return _client.Authenticate(options.Scopes, _clientId, cancellationToken);
        }
    }
}
