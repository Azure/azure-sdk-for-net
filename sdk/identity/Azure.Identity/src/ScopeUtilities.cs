...
namespace Azure.Identity
{
    internal static class ScopeUtilities
    {
        ...
        public static string ScopesToResource(string[] scopes)
        {
            ...
            if (!scopes[0].EndsWith(DefaultSuffix, StringComparison.InvariantCulture))
            {
                return scopes[0];
            }

            return scopes[0].Remove(scopes[0].LastIndexOf(DefaultSuffix, StringComparison.InvariantCulture));
        }
