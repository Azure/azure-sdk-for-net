...
namespace Azure.ResourceManager.Monitor.PipelineGroups.Models
{
    ...
    {
        public static Azure.ResourceManager.Monitor.PipelineGroups.Models.AzureMonitorWorkspaceLogsApiConfig AzureMonitorWorkspaceLogsApiConfig(string dataCollectionEndpointUri = null, string stream = null, string dataCollectionRuleId = null, Azure.ResourceManager.Monitor.PipelineGroups.Models.PipelineGroupSchemaMap schema = null) { throw null; }
        public static Azure.ResourceManager.Monitor.PipelineGroups.Models.AzureMonitorWorkspaceLogsExporter AzureMonitorWorkspaceLogsExporter(Azure.ResourceManager.Monitor.PipelineGroups.Models.AzureMonitorWorkspaceLogsApiConfig api = null, Azure.ResourceManager.Monitor.PipelineGroups.Models.PipelineGroupExporterPersistenceConfiguration persistence = null) { throw null; }
        public static Azure.ResourceManager.Monitor.PipelineGroups.Models.PipelineGroupBatchProcessor PipelineGroupBatchProcessor(int? batchSize = default(int?), int? timeoutInMilliseconds = default(int?)) { throw null; }
        public static Azure.ResourceManager.Monitor.PipelineGroups.Models.PipelineGroupCertificateSource PipelineGroupCertificateSource(Azure.ResourceManager.Monitor.PipelineGroups.Models.PipelineGroupCertificateSourceType type = default(Azure.ResourceManager.Monitor.PipelineGroups.Models.PipelineGroupCertificateSourceType), string location = null, string subLocation = null) { throw null; }
        public static Azure.ResourceManager.Monitor.PipelineGroups.Models.PipelineGroupCertificateWithKey PipelineGroupCertificateWithKey(Azure.ResourceManager.Monitor.PipelineGroups.Models.PipelineGroupCertificateSource certificate = null, Azure.ResourceManager.Monitor.PipelineGroups.Models.PipelineGroupPrivateKeySource privateKey = null) { throw null; }
        ...
        public static Azure.ResourceManager.Monitor.PipelineGroups.Models.PipelineGroupExporter PipelineGroupExporter(Azure.ResourceManager.Monitor.PipelineGroups.Models.PipelineGroupExporterType type = default(Azure.ResourceManager.Monitor.PipelineGroups.Models.PipelineGroupExporterType), string name = null, Azure.ResourceManager.Monitor.PipelineGroups.Models.AzureMonitorWorkspaceLogsExporter azureMonitorWorkspaceLogs = null) { throw null; }
        public static Azure.ResourceManager.Monitor.PipelineGroups.Models.PipelineGroupExporterPersistenceConfiguration PipelineGroupExporterPersistenceConfiguration(int? maxStorageUsageInGigabytes = default(int?), int? retentionPeriodInMinutes = default(int?)) { throw null; }
        ...
        public static Azure.ResourceManager.Monitor.PipelineGroups.Models.PipelineGroupPrivateKeySource PipelineGroupPrivateKeySource(Azure.ResourceManager.Monitor.PipelineGroups.Models.PipelineGroupPrivateKeySourceType type = default(Azure.ResourceManager.Monitor.PipelineGroups.Models.PipelineGroupPrivateKeySourceType), string location = null, string subLocation = null) { throw null; }
        public static Azure.ResourceManager.Monitor.PipelineGroups.Models.PipelineGroupProcessor PipelineGroupProcessor(Azure.ResourceManager.Monitor.PipelineGroups.Models.PipelineGroupProcessorType type = default(Azure.ResourceManager.Monitor.PipelineGroups.Models.PipelineGroupProcessorType), string name = null, Azure.ResourceManager.Monitor.PipelineGroups.Models.PipelineGroupBatchProcessor batch = null, string transformStatement = null) { throw null; }
        ...
        public static Azure.ResourceManager.Monitor.PipelineGroups.Models.PipelineGroupReceiver PipelineGroupReceiver(Azure.ResourceManager.Monitor.PipelineGroups.Models.PipelineGroupReceiverType type = default(Azure.ResourceManager.Monitor.PipelineGroups.Models.PipelineGroupReceiverType), string name = null, string tlsConfigurationName = null, Azure.ResourceManager.Monitor.PipelineGroups.Models.PipelineGroupSyslogReceiver syslog = null, string otlpEndpoint = null) { throw null; }
        public static Azure.ResourceManager.Monitor.PipelineGroups.Models.PipelineGroupRecordMap PipelineGroupRecordMap(string from = null, string to = null) { throw null; }
        public static Azure.ResourceManager.Monitor.PipelineGroups.Models.PipelineGroupResourceMap PipelineGroupResourceMap(string from = null, string to = null) { throw null; }
        ...
        public static Azure.ResourceManager.Monitor.PipelineGroups.Models.PipelineGroupScopeMap PipelineGroupScopeMap(string from = null, string to = null) { throw null; }
        ...
        public static Azure.ResourceManager.Monitor.PipelineGroups.Models.PipelineGroupTlsConfiguration PipelineGroupTlsConfiguration(string name = null, Azure.ResourceManager.Monitor.PipelineGroups.Models.PipelineGroupTlsMode? mode = default(Azure.ResourceManager.Monitor.PipelineGroups.Models.PipelineGroupTlsMode?), Azure.ResourceManager.Monitor.PipelineGroups.Models.PipelineGroupCertificateWithKey tlsCertificate = null, Azure.ResourceManager.Monitor.PipelineGroups.Models.PipelineGroupCertificateSource clientCa = null) { throw null; }
    }
