...
namespace Azure.ResourceManager.Monitor.PipelineGroups
{
    ...
    {
        private readonly ClientDiagnostics _pipelineGroupOperationsClientDiagnostics;
        private readonly PipelineGroupOperations _pipelineGroupOperationsRestClient;
        ...
        public virtual async Task<ArmOperation<PipelineGroupResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string pipelineGroupName, PipelineGroupData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _pipelineGroupOperationsClientDiagnostics.CreateScope("PipelineGroupCollection.CreateOrUpdate");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response<PipelineGroupResource>> GetAsync(string pipelineGroupName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _pipelineGroupOperationsClientDiagnostics.CreateScope("PipelineGroupCollection.Get");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _pipelineGroupOperationsRestClient.CreateGetRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, pipelineGroupName, context);
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string pipelineGroupName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _pipelineGroupOperationsClientDiagnostics.CreateScope("PipelineGroupCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual async Task<NullableResponse<PipelineGroupResource>> GetIfExistsAsync(string pipelineGroupName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _pipelineGroupOperationsClientDiagnostics.CreateScope("PipelineGroupCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
