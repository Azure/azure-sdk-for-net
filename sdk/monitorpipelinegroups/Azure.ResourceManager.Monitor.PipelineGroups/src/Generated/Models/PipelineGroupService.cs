...
namespace Azure.ResourceManager.Monitor.PipelineGroups.Models
{
    ...
    public partial class PipelineGroupService
    {
        ...
        public PipelineGroupService(IEnumerable<PipelineGroupPipeline> pipelines)
        {
        ...
        internal PipelineGroupService(IList<PipelineGroupPipeline> pipelines, PersistenceConfigurations persistence, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Pipelines = pipelines;
        ...
        public IList<PipelineGroupPipeline> Pipelines { get; }
