...
namespace Azure.ResourceManager.Monitor.PipelineGroups.Models
{
    ...
    public partial class PipelineGroupResourceMap
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="PipelineGroupResourceMap"/>. </summary>
        ...
        internal PipelineGroupResourceMap(string @from, string to, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            From = @from;
            To = to;
