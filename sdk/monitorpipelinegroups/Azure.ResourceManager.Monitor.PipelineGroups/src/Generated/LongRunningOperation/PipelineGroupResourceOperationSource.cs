...
{
    /// <summary></summary>
    internal partial class PipelineGroupResourceOperationSource : IOperationSource<PipelineGroupResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal PipelineGroupResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
