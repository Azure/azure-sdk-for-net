...
{
    internal partial class PipelineGroupsArmOperation<T> : ArmOperation<T>
    {
        ...
        /// <summary> Initializes a new instance of PipelineGroupsArmOperation for mocking. </summary>
        protected PipelineGroupsArmOperation()
        {
        }
        ...
        internal PipelineGroupsArmOperation(Response<T> response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal PipelineGroupsArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
