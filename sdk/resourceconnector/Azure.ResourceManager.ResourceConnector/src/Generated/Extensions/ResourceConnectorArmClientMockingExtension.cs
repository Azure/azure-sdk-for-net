...
namespace Azure.ResourceManager.ResourceConnector.Mocking
{
    ...
    public partial class ResourceConnectorArmClientMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="ResourceConnectorArmClientMockingExtension"/> class for mocking. </summary>
        protected ResourceConnectorArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ResourceConnectorArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ResourceConnectorArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal ResourceConnectorArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
