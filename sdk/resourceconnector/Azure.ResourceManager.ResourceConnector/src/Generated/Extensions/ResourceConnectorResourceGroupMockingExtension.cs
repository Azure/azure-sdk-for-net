...
namespace Azure.ResourceManager.ResourceConnector.Mocking
{
    ...
    public partial class ResourceConnectorResourceGroupMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="ResourceConnectorResourceGroupMockingExtension"/> class for mocking. </summary>
        protected ResourceConnectorResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ResourceConnectorResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ResourceConnectorResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
