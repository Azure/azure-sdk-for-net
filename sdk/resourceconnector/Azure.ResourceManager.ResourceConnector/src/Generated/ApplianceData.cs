...
{
    /// <summary>
    /// A class representing the Appliance data model.
    /// Appliances definition.
    /// </summary>
    public partial class ApplianceData : TrackedResourceData
    {
        /// <summary> Initializes a new instance of ApplianceData. </summary>
        /// <param name="location"> The location. </param>
        public ApplianceData(AzureLocation location) : base(location)
        {
        }
        ...
        internal ApplianceData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, ManagedServiceIdentity identity, Distro? distro, AppliancePropertiesInfrastructureConfig infrastructureConfig, string provisioningState, string publicKey, Status? status, string version) : base(id, name, resourceType, systemData, tags, location)
        {
            Identity = identity;
            Distro = distro;
