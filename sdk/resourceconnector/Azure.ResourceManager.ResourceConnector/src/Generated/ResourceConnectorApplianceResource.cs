...
namespace Azure.ResourceManager.ResourceConnector
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="ResourceConnectorApplianceResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="ResourceGroupResource"/> using the GetResourceConnectorAppliances method.
    /// </summary>
    public partial class ResourceConnectorApplianceResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of ResourceConnectorApplianceResource for mocking. </summary>
        protected ResourceConnectorApplianceResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="ResourceConnectorApplianceResource"/> class. </summary>
        ...
        {
            using DiagnosticScope scope = _appliancesClientDiagnostics.CreateScope("ResourceConnectorApplianceResource.Get");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response<ResourceConnectorApplianceResource>> UpdateAsync(ResourceConnectorAppliancePatch patch, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _appliancesClientDiagnostics.CreateScope("ResourceConnectorApplianceResource.Update");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _appliancesRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, ResourceConnectorAppliancePatch.ToRequestContent(patch), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<ResourceConnectorApplianceData> response = Response.FromValue(ResourceConnectorApplianceData.FromResponse(result), result);
                if (response.Value == null)
                {
        ...
        {
            using DiagnosticScope scope = _appliancesClientDiagnostics.CreateScope("ResourceConnectorApplianceResource.Delete");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        /// <summary>
        /// Updates the ResourceConnectorAppliance.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ResourceConnector/appliances/{resourceName}. </description>
        ...
        public virtual async Task<ArmOperation<ResourceConnectorApplianceResource>> UpdateAsync(WaitUntil waitUntil, ResourceConnectorApplianceData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _appliancesRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, ResourceConnectorApplianceData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<ResourceConnectorApplianceResource> Update(WaitUntil waitUntil, ResourceConnectorApplianceData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
        ...
        public virtual async Task<Response<ResourceConnectorApplianceResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _appliancesClientDiagnostics.CreateScope("ResourceConnectorApplianceResource.AddTag");
            scope.Start();
            try
            {
                ...
                {
                    ResourceConnectorApplianceData current = (await GetAsync(cancellationToken: cancellationToken).ConfigureAwait(false)).Value.Data;
                    ...
                    Response<ResourceConnectorApplianceResource> result = await UpdateAsync(patch, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<ResourceConnectorApplianceResource> AddTag(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                {
                    ResourceConnectorApplianceData current = Get(cancellationToken: cancellationToken).Value.Data;
                    ResourceConnectorAppliancePatch patch = new ResourceConnectorAppliancePatch();
                    foreach (KeyValuePair<string, string> tag in current.Tags)
                    {
                        patch.Tags.Add(tag);
                    ...
                    patch.Tags[key] = value;
                    Response<ResourceConnectorApplianceResource> result = Update(patch, cancellationToken: cancellationToken);
                    return Response.FromValue(result.Value, result.GetRawResponse());
                }
            }
            catch (Exception e)
        ...
        public virtual async Task<Response<ResourceConnectorApplianceResource>> SetTagsAsync(IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _appliancesClientDiagnostics.CreateScope("ResourceConnectorApplianceResource.SetTags");
            scope.Start();
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken).ConfigureAwait(false))
        ...
        public virtual async Task<Response<ResourceConnectorApplianceResource>> RemoveTagAsync(string key, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _appliancesClientDiagnostics.CreateScope("ResourceConnectorApplianceResource.RemoveTag");
            scope.Start();
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken).ConfigureAwait(false))
