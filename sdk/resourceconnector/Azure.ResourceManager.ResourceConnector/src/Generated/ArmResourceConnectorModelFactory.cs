...
namespace Azure.ResourceManager.ResourceConnector.Models
{
    ...
    public static partial class ArmResourceConnectorModelFactory
    {
        ...
        {
            return new ApplianceTelemetryConfigResult(telemetryInstrumentationKey, new Dictionary<string, BinaryData>());
        }
        ...
        public static ApplianceClusterUserCredentialResult ApplianceClusterUserCredentialResult(HybridConnectionConfig hybridConnectionConfig = null, IEnumerable<ApplianceCredentialKubeconfig> kubeconfigs = null)
        {
            ...
            return new ApplianceClusterUserCredentialResult(hybridConnectionConfig, kubeconfigs?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ApplianceCredentialKubeconfig(name, value, new Dictionary<string, BinaryData>());
        }
        ...
        public static ApplianceClusterUserKeysResult ApplianceClusterUserKeysResult(IReadOnlyDictionary<string, ApplianceArtifactProfile> artifactProfiles = null, IEnumerable<ApplianceCredentialKubeconfig> kubeconfigs = null, IReadOnlyDictionary<string, ApplianceSshKey> sshKeys = null)
        {
            ...
            return new ApplianceClusterUserKeysResult(artifactProfiles, kubeconfigs?.ToList(), sshKeys, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ApplianceArtifactProfile(endpoint, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ApplianceSshKey(certificate, creationTimeStamp, expirationTimeStamp, privateKey, publicKey, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ApplianceUpgradeGraph(id, name, properties, new Dictionary<string, BinaryData>());
        }
        ...
        public static ApplianceUpgradeGraphProperties ApplianceUpgradeGraphProperties(string applianceVersion = null, IEnumerable<ApplianceSupportedVersion> supportedVersions = null)
        {
            ...
            return new ApplianceUpgradeGraphProperties(applianceVersion, supportedVersions?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ApplianceSupportedVersion(metadataCatalogVersion != null ? new ApplianceSupportedVersionMetadata(metadataCatalogVersion, new Dictionary<string, BinaryData>()) : null, version, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ApplianceSupportedVersionCatalogVersion(data, name, @namespace, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ApplianceSupportedVersionCatalogVersionProperties(audience, catalog, offer, version, new Dictionary<string, BinaryData>());
        }
    }
}
