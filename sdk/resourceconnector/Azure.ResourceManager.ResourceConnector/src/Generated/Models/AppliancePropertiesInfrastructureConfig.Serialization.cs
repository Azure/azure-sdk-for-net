...
namespace Azure.ResourceManager.ResourceConnector.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AppliancePropertiesInfrastructureConfig>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AppliancePropertiesInfrastructureConfig>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AppliancePropertiesInfrastructureConfig>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AppliancePropertiesInfrastructureConfig>)} interface");
            }
        ...
        string IPersistableModel<AppliancePropertiesInfrastructureConfig>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
