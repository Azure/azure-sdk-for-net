...
{
    internal partial class ApplianceSupportedVersionMetadata : IUtf8JsonSerializable, IJsonModel<ApplianceSupportedVersionMetadata>, IPersistableModel<ApplianceSupportedVersionMetadata>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(CatalogVersion))
            {
                ...
                AppendChildObject(builder, CatalogVersion, options, 2);
            }
