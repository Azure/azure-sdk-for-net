...
namespace Azure.ResourceManager.ResourceConnector.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ApplianceSupportedVersionCatalogVersionProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<ApplianceSupportedVersionCatalogVersionProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<ApplianceSupportedVersionCatalogVersionProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
