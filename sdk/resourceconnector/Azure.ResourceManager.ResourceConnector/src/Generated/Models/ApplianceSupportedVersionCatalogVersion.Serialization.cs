...
namespace Azure.ResourceManager.ResourceConnector.Models
{
    public partial class ApplianceSupportedVersionCatalogVersion : IUtf8JsonSerializable, IJsonModel<ApplianceSupportedVersionCatalogVersion>
    {
        ...
        void IJsonModel<ApplianceSupportedVersionCatalogVersion>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(ApplianceSupportedVersionCatalogVersion)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ApplianceSupportedVersionCatalogVersion>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(ApplianceSupportedVersionCatalogVersion)} does not support '{options.Format}' format.");
            }
        }
