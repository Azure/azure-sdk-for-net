...
{
    public partial class ApplianceClusterUserCredentialResult : IUtf8JsonSerializable, IJsonModel<ApplianceClusterUserCredentialResult>, IPersistableModel<ApplianceClusterUserCredentialResult>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(HybridConnectionConfig))
            {
                ...
                AppendChildObject(builder, HybridConnectionConfig, options, 2);
            }
