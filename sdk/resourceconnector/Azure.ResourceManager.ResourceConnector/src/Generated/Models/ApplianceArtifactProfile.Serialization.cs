...
namespace Azure.ResourceManager.ResourceConnector.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ApplianceArtifactProfile>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ApplianceArtifactProfile>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ApplianceArtifactProfile>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<ApplianceArtifactProfile>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
