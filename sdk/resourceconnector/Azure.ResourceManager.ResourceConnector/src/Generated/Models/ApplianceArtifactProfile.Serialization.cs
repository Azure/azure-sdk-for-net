...
{
    public partial class ApplianceArtifactProfile : IUtf8JsonSerializable, IJsonModel<ApplianceArtifactProfile>, IPersistableModel<ApplianceArtifactProfile>
    {
        ...
        void IJsonModel<ApplianceArtifactProfile>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ApplianceArtifactProfile)} does not support '{format}' format.");
            }
