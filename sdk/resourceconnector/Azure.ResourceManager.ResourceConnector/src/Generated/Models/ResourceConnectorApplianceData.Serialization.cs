...
namespace Azure.ResourceManager.ResourceConnector
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ResourceConnectorApplianceData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ResourceConnectorApplianceData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ResourceConnectorApplianceData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ResourceConnectorApplianceData>)} interface");
            }
        ...
        string IPersistableModel<ResourceConnectorApplianceData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
