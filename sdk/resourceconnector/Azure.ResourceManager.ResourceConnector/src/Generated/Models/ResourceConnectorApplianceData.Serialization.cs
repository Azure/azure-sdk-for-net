...
{
    public partial class ResourceConnectorApplianceData : IUtf8JsonSerializable, IJsonModel<ResourceConnectorApplianceData>, IPersistableModel<ResourceConnectorApplianceData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Distro))
            {
                ...
                builder.AppendLine($" '{Distro.ToString()}'");
            }

            if (Optional.IsDefined(InfrastructureConfig))
            {
                builder.Append("  infrastructureConfig:");
                AppendChildObject(builder, InfrastructureConfig, options, 2);
            }
