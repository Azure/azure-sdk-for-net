...
namespace Azure.ResourceManager.ResourceConnector.Models
{
    ...
    {
        internal static ApplianceListCredentialResults DeserializeApplianceListCredentialResults(JsonElement element)
        {
            ...
            return new ApplianceListCredentialResults(hybridConnectionConfig.Value, Optional.ToList(kubeconfigs));
        }
    }
}
