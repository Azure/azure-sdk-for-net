...
namespace Azure.ResourceManager.ResourceConnector.Models
{
    ...
    public partial class SupportedVersionCatalogVersionDataField
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="SupportedVersionCatalogVersionDataField"/>. </summary>
        ...
        internal SupportedVersionCatalogVersionDataField(string audience, string catalog, string offer, string version, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Audience = audience;
            Catalog = catalog;
            Offer = offer;
