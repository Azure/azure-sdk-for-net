...
{
    public partial class ApplianceSshKey : IUtf8JsonSerializable, IJsonModel<ApplianceSshKey>, IPersistableModel<ApplianceSshKey>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(CreationTimeStamp))
            {
                ...
                builder.AppendLine($" '{CreationTimeStamp.Value.ToString()}'");
            }

            if (Optional.IsDefined(ExpirationTimeStamp))
            {
                builder.Append("  expirationTimeStamp:");
                builder.AppendLine($" '{ExpirationTimeStamp.Value.ToString()}'");
            }
