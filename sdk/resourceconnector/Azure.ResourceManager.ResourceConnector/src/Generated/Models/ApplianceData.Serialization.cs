...
{
    public partial class ApplianceData : IUtf8JsonSerializable
    {
        ...
        internal static ApplianceData DeserializeApplianceData(JsonElement element)
        {
            ...
            Optional<Distro> distro = default;
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        if (property0.NameEquals("distro"u8))
                        {
                            ...
                            distro = new Distro(property0.Value.GetString());
                            continue;
                        }
            ...
            return new ApplianceData(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, identity, Optional.ToNullable(distro), infrastructureConfig.Value, provisioningState.Value, publicKey.Value, Optional.ToNullable(status), version.Value);
        }
    }
}
