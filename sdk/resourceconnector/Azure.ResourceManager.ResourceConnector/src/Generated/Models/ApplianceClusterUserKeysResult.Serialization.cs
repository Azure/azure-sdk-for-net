...
{
    public partial class ApplianceClusterUserKeysResult : IUtf8JsonSerializable, IJsonModel<ApplianceClusterUserKeysResult>, IPersistableModel<ApplianceClusterUserKeysResult>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  artifactProfiles:");
                builder.AppendLine(" {");
                foreach (var item in ArtifactProfiles)
                {
