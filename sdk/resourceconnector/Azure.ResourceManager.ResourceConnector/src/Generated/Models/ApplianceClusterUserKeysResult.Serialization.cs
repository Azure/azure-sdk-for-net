...
namespace Azure.ResourceManager.ResourceConnector.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ApplianceClusterUserKeysResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ApplianceClusterUserKeysResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ApplianceClusterUserKeysResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ApplianceClusterUserKeysResult>)} interface");
            }
        ...
        string IPersistableModel<ApplianceClusterUserKeysResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
