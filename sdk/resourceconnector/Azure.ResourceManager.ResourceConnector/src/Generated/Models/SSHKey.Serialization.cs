...
namespace Azure.ResourceManager.ResourceConnector.Models
{
    ...
    {
        internal static SSHKey DeserializeSSHKey(JsonElement element)
        {
            ...
            return new SSHKey(certificate.Value, Optional.ToNullable(creationTimeStamp), Optional.ToNullable(expirationTimeStamp), privateKey.Value, publicKey.Value);
        }
    }
}
