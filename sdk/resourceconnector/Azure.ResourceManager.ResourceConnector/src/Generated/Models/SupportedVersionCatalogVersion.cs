...
namespace Azure.ResourceManager.ResourceConnector.Models
{
    ...
    public partial class SupportedVersionCatalogVersion
    {
        ...
        internal SupportedVersionCatalogVersion(SupportedVersionCatalogVersionData data, string name, string @namespace)
        {
            Data = data;
            Name = name;
            Namespace = @namespace;
        ...
        public SupportedVersionCatalogVersionData Data { get; }
