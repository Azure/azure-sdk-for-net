...
{
    /// <summary></summary>
    internal partial class ResourceConnectorApplianceResourceOperationSource : IOperationSource<ResourceConnectorApplianceResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal ResourceConnectorApplianceResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
