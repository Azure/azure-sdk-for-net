...
namespace Azure.ResourceManager.ResourceConnector
{
    internal partial class ResourceConnectorArmOperation : ArmOperation
    {
        ...
        internal ResourceConnectorArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
