...
namespace Azure.ResourceManager.ResourceConnector
{
    internal partial class ResourceConnectorArmOperation<T> : ArmOperation<T>
    {
        ...
        internal ResourceConnectorArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
