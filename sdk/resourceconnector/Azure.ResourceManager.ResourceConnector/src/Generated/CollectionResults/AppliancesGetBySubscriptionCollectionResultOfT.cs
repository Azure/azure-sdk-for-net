...
namespace Azure.ResourceManager.ResourceConnector
{
    internal partial class AppliancesGetBySubscriptionCollectionResultOfT : Pageable<ResourceConnectorApplianceData>
    {
        ...
        public AppliancesGetBySubscriptionCollectionResultOfT(Appliances client, string subscriptionId, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
