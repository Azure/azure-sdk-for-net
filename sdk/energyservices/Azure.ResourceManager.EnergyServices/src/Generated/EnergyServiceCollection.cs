...
namespace Azure.ResourceManager.EnergyServices
{
    ...
    public partial class EnergyServiceCollection : ArmCollection, IEnumerable<EnergyServiceResource>, IAsyncEnumerable<EnergyServiceResource>
    {
        ...
        public virtual async Task<ArmOperation<EnergyServiceResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string resourceName, EnergyServiceData data = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <exception cref="ArgumentException"> <paramref name="resourceName"/> is an empty string, and was expected to be non-empty. </exception>
        /// <exception cref="ArgumentNullException"> <paramref name="resourceName"/> is null. </exception>
        public virtual ArmOperation<EnergyServiceResource> CreateOrUpdate(WaitUntil waitUntil, string resourceName, EnergyServiceData data = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(resourceName, nameof(resourceName));
