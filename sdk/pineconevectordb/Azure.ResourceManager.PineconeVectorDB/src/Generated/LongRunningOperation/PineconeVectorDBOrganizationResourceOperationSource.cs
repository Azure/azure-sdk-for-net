...
{
    /// <summary></summary>
    internal partial class PineconeVectorDBOrganizationResourceOperationSource : IOperationSource<PineconeVectorDBOrganizationResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal PineconeVectorDBOrganizationResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
