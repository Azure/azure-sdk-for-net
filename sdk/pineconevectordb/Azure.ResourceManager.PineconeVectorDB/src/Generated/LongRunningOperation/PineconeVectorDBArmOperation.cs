...
namespace Azure.ResourceManager.PineconeVectorDB
{
    internal partial class PineconeVectorDBArmOperation : ArmOperation
    {
        ...
        internal PineconeVectorDBArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
