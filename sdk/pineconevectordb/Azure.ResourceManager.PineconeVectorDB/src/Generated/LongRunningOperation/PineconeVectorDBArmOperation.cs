...
#pragma warning disable SA1649 // File name should match first type name
    internal class PineconeVectorDBArmOperation : ArmOperation
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        internal PineconeVectorDBArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal PineconeVectorDBArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal(nextLinkOperation, clientDiagnostics, response, "PineconeVectorDBArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
