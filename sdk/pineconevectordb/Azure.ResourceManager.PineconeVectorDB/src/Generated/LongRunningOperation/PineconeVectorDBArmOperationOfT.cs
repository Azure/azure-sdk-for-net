...
namespace Azure.ResourceManager.PineconeVectorDB
{
    internal partial class PineconeVectorDBArmOperation<T> : ArmOperation<T>
    {
        ...
        internal PineconeVectorDBArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
