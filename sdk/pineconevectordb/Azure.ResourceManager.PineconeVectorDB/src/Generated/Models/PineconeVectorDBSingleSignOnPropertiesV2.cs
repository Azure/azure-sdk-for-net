...
namespace Azure.ResourceManager.PineconeVectorDB.Models
{
    ...
    public partial class PineconeVectorDBSingleSignOnPropertiesV2
    {
        ...
        /// <summary> Initializes a new instance of <see cref="PineconeVectorDBSingleSignOnPropertiesV2"/>. </summary>
        /// <param name="type"> Type of Single Sign-On mechanism being used. </param>
        public PineconeVectorDBSingleSignOnPropertiesV2(PineconeVectorDBSingleSignOnType @type)
        {
            Type = @type;
        ...
        internal PineconeVectorDBSingleSignOnPropertiesV2(PineconeVectorDBSingleSignOnType @type, PineconeVectorDBSingleSignOnState? state, string enterpriseAppId, string uri, IList<string> aadDomains, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Type = @type;
            State = state;
        ...
        public PineconeVectorDBSingleSignOnType Type { get; set; }

        /// <summary> State of the Single Sign On for the resource. </summary>
        public PineconeVectorDBSingleSignOnState? State { get; set; }
