...
namespace Azure.ResourceManager.PineconeVectorDB.Models
{
    ...
    public partial class PineconeVectorDBSingleSignOnPropertiesV2
    {
        ...
        internal PineconeVectorDBSingleSignOnPropertiesV2(PineconeVectorDBSingleSignOnType type, PineconeVectorDBSingleSignOnState? state, string enterpriseAppId, string uri, IList<string> aadDomains, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Type = type;
            State = state;
