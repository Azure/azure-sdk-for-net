        ...
        internal static PineconeVectorDBOrganizationPatch DeserializePineconeVectorDBOrganizationPatch(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("identity"u8))
                {
                    ...
                    identity = ModelReaderWriter.Read<ManagedServiceIdentity>(new BinaryData(Encoding.UTF8.GetBytes(prop.Value.GetRawText())), new ModelReaderWriterOptions(options.Format + "|v3"), AzureResourceManagerPineconeVectorDBContext.Default);
                    continue;
                }
                if (options.Format != "W")
                {
