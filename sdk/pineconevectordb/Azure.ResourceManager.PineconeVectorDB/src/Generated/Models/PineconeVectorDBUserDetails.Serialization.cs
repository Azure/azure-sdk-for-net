...
namespace Azure.ResourceManager.PineconeVectorDB.Models
{
    ...
    public partial class PineconeVectorDBUserDetails : IJsonModel<PineconeVectorDBUserDetails>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        PineconeVectorDBUserDetails IJsonModel<PineconeVectorDBUserDetails>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual PineconeVectorDBUserDetails JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<PineconeVectorDBUserDetails>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static PineconeVectorDBUserDetails DeserializePineconeVectorDBUserDetails(JsonElement element, ModelReaderWriterOptions options)
        {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<PineconeVectorDBUserDetails>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
