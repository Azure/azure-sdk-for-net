...
namespace Azure.ResourceManager.PineconeVectorDB.Models
{
    internal partial class OrganizationResourceListResult : IUtf8JsonSerializable, IJsonModel<OrganizationResourceListResult>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            {
                ((IJsonModel<PineconeVectorDBOrganizationData>)item).Write(writer, options);
            }
        ...
        internal static OrganizationResourceListResult DeserializeOrganizationResourceListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            IReadOnlyList<PineconeVectorDBOrganizationData> value = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    List<PineconeVectorDBOrganizationData> array = new List<PineconeVectorDBOrganizationData>();
                    foreach (var item in property.Value.EnumerateArray())
                    {
                        array.Add(PineconeVectorDBOrganizationData.DeserializePineconeVectorDBOrganizationData(item, options));
                    }
                    value = array;
                    continue;
                }
