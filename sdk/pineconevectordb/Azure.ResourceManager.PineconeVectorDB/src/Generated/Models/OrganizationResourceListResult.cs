...
namespace Azure.ResourceManager.PineconeVectorDB.Models
{
    ...
    internal partial class OrganizationResourceListResult
    {
        ...
        internal OrganizationResourceListResult(IList<PineconeVectorDBOrganizationData> value, Uri nextLink, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            NextLink = nextLink;
        ...
        public IList<PineconeVectorDBOrganizationData> Value { get; }
