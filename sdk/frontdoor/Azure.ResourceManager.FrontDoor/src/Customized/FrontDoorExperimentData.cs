...
namespace Azure.ResourceManager.FrontDoor
{
    ...
    public partial class FrontDoorExperimentData : TrackedResourceData
    {
        ...
        // only the return type from FrontDoorExperimentData to ResourceData so it matches TrackedResourceData.
        ...
        internal static FrontDoorExperimentData DeserializeFrontDoorExperimentData(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new FrontDoorExperimentData(id, name, resourceType, systemData, tags ?? new ChangeTrackingDictionary<string, string>(), location, properties, additionalBinaryDataProperties);
        }
    }
}