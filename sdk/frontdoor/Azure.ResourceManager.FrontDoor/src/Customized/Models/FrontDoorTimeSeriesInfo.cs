...
namespace Azure.ResourceManager.FrontDoor.Models
{
    ...
    public partial class FrontDoorTimeSeriesInfo : TrackedResourceData
    {
        ...
        internal static FrontDoorTimeSeriesInfo DeserializeFrontDoorTimeSeriesInfo(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new FrontDoorTimeSeriesInfo(id, name, resourceType, systemData, tags ?? new ChangeTrackingDictionary<string, string>(), location, properties, additionalBinaryDataProperties);
        }
    }
}