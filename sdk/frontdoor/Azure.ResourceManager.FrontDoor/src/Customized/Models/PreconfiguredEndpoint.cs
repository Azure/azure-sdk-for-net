...
namespace Azure.ResourceManager.FrontDoor.Models
{
    ...
    public partial class PreconfiguredEndpoint : TrackedResourceData
    {
        ...
        internal PreconfiguredEndpoint(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, PreconfiguredEndpointProperties properties, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, name, resourceType, systemData, tags, location)
        {
            Properties = properties;
            _additionalBinaryDataProperties = additionalBinaryDataProperties;
        }
        // This method body is copied from the generated PersistableModelCreateCore; the customization changes
        // only the return type from PreconfiguredEndpoint to ResourceData so it matches TrackedResourceData.
        ...
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        PreconfiguredEndpoint IPersistableModel<PreconfiguredEndpoint>.Create(BinaryData data, ModelReaderWriterOptions options) => (PreconfiguredEndpoint)PersistableModelCreateCore(data, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        PreconfiguredEndpoint IJsonModel<PreconfiguredEndpoint>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (PreconfiguredEndpoint)JsonModelCreateCore(ref reader, options);
        internal static PreconfiguredEndpoint DeserializePreconfiguredEndpoint(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new PreconfiguredEndpoint(id, name, resourceType, systemData, tags ?? new ChangeTrackingDictionary<string, string>(), location, properties, additionalBinaryDataProperties);
        }
    }
}