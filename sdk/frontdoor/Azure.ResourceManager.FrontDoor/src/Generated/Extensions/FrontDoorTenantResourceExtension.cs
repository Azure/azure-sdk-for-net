...
namespace Azure.ResourceManager.FrontDoor.Mock
{
    ...
    public partial class FrontDoorTenantResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="FrontDoorTenantResourceExtension"/> class for mocking. </summary>
        protected FrontDoorTenantResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="FrontDoorTenantResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal FrontDoorTenantResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual async Task<Response<FrontDoorNameAvailabilityResult>> CheckFrontDoorNameAvailabilityAsync(FrontDoorNameAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = FrontDoorNameAvailabilityClientDiagnostics.CreateScope("FrontDoorTenantResourceExtension.CheckFrontDoorNameAvailability");
            scope.Start();
            try
            {
