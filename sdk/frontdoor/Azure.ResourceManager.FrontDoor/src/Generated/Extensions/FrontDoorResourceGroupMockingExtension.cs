...
namespace Azure.ResourceManager.FrontDoor.Mocking
{
    ...
    internal partial class FrontDoorResourceGroupMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="FrontDoorResourceGroupMockingExtension"/> class for mocking. </summary>
        protected FrontDoorResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="FrontDoorResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal FrontDoorResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
