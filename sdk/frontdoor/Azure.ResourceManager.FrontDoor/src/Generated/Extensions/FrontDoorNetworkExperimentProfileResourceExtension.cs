...
namespace Azure.ResourceManager.FrontDoor.Mock
{
    ...
    public partial class FrontDoorNetworkExperimentProfileResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="FrontDoorNetworkExperimentProfileResourceExtension"/> class for mocking. </summary>
        protected FrontDoorNetworkExperimentProfileResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="FrontDoorNetworkExperimentProfileResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal FrontDoorNetworkExperimentProfileResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
