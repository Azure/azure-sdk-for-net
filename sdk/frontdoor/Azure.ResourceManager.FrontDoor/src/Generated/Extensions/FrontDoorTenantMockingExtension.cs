...
namespace Azure.ResourceManager.FrontDoor.Mocking
{
    ...
    internal partial class FrontDoorTenantMockingExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="FrontDoorTenantMockingExtension"/> class for mocking. </summary>
        protected FrontDoorTenantMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="FrontDoorTenantMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal FrontDoorTenantMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        {
            using var scope = FrontDoorNameAvailabilityClientDiagnostics.CreateScope("FrontDoorTenantMockingExtension.CheckFrontDoorNameAvailability");
            scope.Start();
            try
            {
