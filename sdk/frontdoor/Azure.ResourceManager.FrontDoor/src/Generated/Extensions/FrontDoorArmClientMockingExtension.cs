...
namespace Azure.ResourceManager.FrontDoor.Mocking
{
    ...
    internal partial class FrontDoorArmClientMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="FrontDoorArmClientMockingExtension"/> class for mocking. </summary>
        protected FrontDoorArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="FrontDoorArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal FrontDoorArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal FrontDoorArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
