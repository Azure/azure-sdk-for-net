...
namespace Azure.ResourceManager.FrontDoor
{
    ...
    {
        private static FrontDoorNetworkExperimentProfileResourceExtensionClient GetFrontDoorNetworkExperimentProfileResourceExtensionClient(ArmResource resource)
        {
            return resource.GetCachedClient(client =>
            {
                return new FrontDoorNetworkExperimentProfileResourceExtensionClient(client, resource.Id);
            });
        }

        private static FrontDoorNetworkExperimentProfileResourceExtensionClient GetFrontDoorNetworkExperimentProfileResourceExtensionClient(ArmClient client, ResourceIdentifier scope)
        {
            return client.GetResourceClient(() =>
            {
                return new FrontDoorNetworkExperimentProfileResourceExtensionClient(client, scope);
            });
        }

        private static FrontDoorResourceExtensionClient GetFrontDoorResourceExtensionClient(ArmResource resource)
        {
            return resource.GetCachedClient(client =>
            {
                return new FrontDoorResourceExtensionClient(client, resource.Id);
            });
        }

        private static FrontDoorResourceExtensionClient GetFrontDoorResourceExtensionClient(ArmClient client, ResourceIdentifier scope)
        {
            return client.GetResourceClient(() =>
            {
                return new FrontDoorResourceExtensionClient(client, scope);
            });
        }
        ...
        {
            return GetFrontDoorResourceExtensionClient(subscriptionResource).GetFrontDoorsAsync(cancellationToken);
        }
        ...
        {
            return GetFrontDoorResourceExtensionClient(subscriptionResource).GetFrontDoors(cancellationToken);
        }
        ...
        {
            return GetFrontDoorNetworkExperimentProfileResourceExtensionClient(subscriptionResource).GetFrontDoorNetworkExperimentProfilesAsync(cancellationToken);
        }
        ...
        {
            return GetFrontDoorNetworkExperimentProfileResourceExtensionClient(subscriptionResource).GetFrontDoorNetworkExperimentProfiles(cancellationToken);
        }
