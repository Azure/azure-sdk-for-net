...
namespace Azure.ResourceManager.FrontDoor
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="FrontendEndpointResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="FrontDoorResource"/> using the GetFrontendEndpoints method.
    /// </summary>
    public partial class FrontendEndpointResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of FrontendEndpointResource for mocking. </summary>
        protected FrontendEndpointResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="FrontendEndpointResource"/> class. </summary>
        ...
        internal FrontendEndpointResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _frontendEndpointsRestClient = new FrontendEndpoints(_frontendEndpointsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, frontendEndpointApiVersion ?? "2026-04-01");
        ...
        {
            string resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/frontDoors/{frontDoorName}/frontendEndpoints/{frontendEndpointName}";
        ...
        {
            using DiagnosticScope scope = _frontendEndpointsClientDiagnostics.CreateScope("FrontendEndpointResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _frontendEndpointsRestClient.CreateGetRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, context);
        ...
        {
            using DiagnosticScope scope = _frontendEndpointsClientDiagnostics.CreateScope("FrontendEndpointResource.DisableHttps");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _frontendEndpointsRestClient.CreateDisableHttpsRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                FrontDoorArmOperation operation = new FrontDoorArmOperation(_frontendEndpointsClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.AzureAsyncOperation);
        ...
        public virtual async Task<ArmOperation> EnableHttpsAsync(WaitUntil waitUntil, CustomHttpsConfiguration customHttpsConfiguration, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _frontendEndpointsClientDiagnostics.CreateScope("FrontendEndpointResource.EnableHttps");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _frontendEndpointsRestClient.CreateEnableHttpsRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, CustomHttpsConfiguration.ToRequestContent(customHttpsConfiguration), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                FrontDoorArmOperation operation = new FrontDoorArmOperation(_frontendEndpointsClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.AzureAsyncOperation);
                if (waitUntil == WaitUntil.Completed)
                {
