...
namespace Azure.ResourceManager.FrontDoor
{
    ...
    public partial class FrontendEndpointResource : ArmResource
    {
        ...
        internal FrontendEndpointResource(ArmClient client, FrontendEndpointData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<FrontendEndpointResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new FrontendEndpointResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
