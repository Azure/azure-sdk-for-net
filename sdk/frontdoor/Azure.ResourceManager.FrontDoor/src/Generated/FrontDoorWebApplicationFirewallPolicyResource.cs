...
namespace Azure.ResourceManager.FrontDoor
{
    ...
    public partial class FrontDoorWebApplicationFirewallPolicyResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                using var message = _frontDoorWebApplicationFirewallPolicyPoliciesRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name);
                var response = await _frontDoorWebApplicationFirewallPolicyPoliciesRestClient.DeleteAsync(message, cancellationToken).ConfigureAwait(false);
                var operation = new FrontDoorArmOperation(_frontDoorWebApplicationFirewallPolicyPoliciesClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
        ...
        public virtual ArmOperation Delete(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var message = _frontDoorWebApplicationFirewallPolicyPoliciesRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name);
                var response = _frontDoorWebApplicationFirewallPolicyPoliciesRestClient.Delete(message, cancellationToken);
                var operation = new FrontDoorArmOperation(_frontDoorWebApplicationFirewallPolicyPoliciesClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<ArmOperation<FrontDoorWebApplicationFirewallPolicyResource>> UpdateAsync(WaitUntil waitUntil, FrontDoorWebApplicationFirewallPolicyPatch patch, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                using var message = _frontDoorWebApplicationFirewallPolicyPoliciesRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, patch);
                var response = await _frontDoorWebApplicationFirewallPolicyPoliciesRestClient.UpdateAsync(message, cancellationToken).ConfigureAwait(false);
                var operation = new FrontDoorArmOperation<FrontDoorWebApplicationFirewallPolicyResource>(new FrontDoorWebApplicationFirewallPolicyOperationSource(Client), _frontDoorWebApplicationFirewallPolicyPoliciesClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual ArmOperation<FrontDoorWebApplicationFirewallPolicyResource> Update(WaitUntil waitUntil, FrontDoorWebApplicationFirewallPolicyPatch patch, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var message = _frontDoorWebApplicationFirewallPolicyPoliciesRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, patch);
                var response = _frontDoorWebApplicationFirewallPolicyPoliciesRestClient.Update(message, cancellationToken);
                var operation = new FrontDoorArmOperation<FrontDoorWebApplicationFirewallPolicyResource>(new FrontDoorWebApplicationFirewallPolicyOperationSource(Client), _frontDoorWebApplicationFirewallPolicyPoliciesClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
