...
namespace Azure.ResourceManager.FrontDoor
{
    ...
    public partial class FrontDoorWebApplicationFirewallPolicyResource : ArmResource
    {
        ...
        /// <summary>
        /// Updates the FrontDoorWebApplicationFirewallPolicy.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/FrontDoorWebApplicationFirewallPolicies/{policyName}. </description>
        ...
        public virtual async Task<ArmOperation<FrontDoorWebApplicationFirewallPolicyResource>> UpdateAsync(WaitUntil waitUntil, FrontDoorWebApplicationFirewallPolicyData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _policiesRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, FrontDoorWebApplicationFirewallPolicyData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                FrontDoorArmOperation<FrontDoorWebApplicationFirewallPolicyResource> operation = new FrontDoorArmOperation<FrontDoorWebApplicationFirewallPolicyResource>(
                    new FrontDoorWebApplicationFirewallPolicyResourceOperationSource(Client),
                    _policiesClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<FrontDoorWebApplicationFirewallPolicyResource> Update(WaitUntil waitUntil, FrontDoorWebApplicationFirewallPolicyData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
