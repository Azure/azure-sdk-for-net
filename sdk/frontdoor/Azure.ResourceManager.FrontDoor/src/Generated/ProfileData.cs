...
namespace Azure.ResourceManager.FrontDoor
{
    ...
    public partial class ProfileData : TrackedResourceData
    {
        ...
        internal ProfileData(ResourceIdentifier id, string name, Core.ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, ETag? etag, NetworkExperimentResourceState? resourceState, State? enabledState) : base(id, name, resourceType, systemData, tags, location)
        {
            ETag = etag;
