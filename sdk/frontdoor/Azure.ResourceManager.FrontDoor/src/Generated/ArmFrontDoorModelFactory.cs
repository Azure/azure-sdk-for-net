...
namespace Azure.ResourceManager.FrontDoor.Models
{
    ...
    public static partial class ArmFrontDoorModelFactory
    {
        ...
        /// <returns> A new <see cref="FrontDoor.FrontDoorWebApplicationFirewallPolicyData"/> instance for mocking. </returns>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public static FrontDoorWebApplicationFirewallPolicyData FrontDoorWebApplicationFirewallPolicyData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, FrontDoorWebApplicationFirewallPolicySettings policySettings, IEnumerable<SubResource> frontendEndpointLinks, IEnumerable<SubResource> routingRuleLinks, IEnumerable<SubResource> securityPolicyLinks, string provisioningState, FrontDoorWebApplicationFirewallPolicyResourceState? resourceState, IEnumerable<WebApplicationCustomRule> rules, IEnumerable<ManagedRuleSet> managedRuleSets, IEnumerable<FrontDoorManagedRuleSetException> exceptions, ETag? eTag, FrontDoorSkuName? skuName)
        {
            tags ??= new ChangeTrackingDictionary<string, string>();
