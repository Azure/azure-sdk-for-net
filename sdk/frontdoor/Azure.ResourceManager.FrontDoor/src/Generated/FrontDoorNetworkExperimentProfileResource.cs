...
namespace Azure.ResourceManager.FrontDoor
{
    ...
    public partial class FrontDoorNetworkExperimentProfileResource : ArmResource
    {
        ...
        /// <summary>
        /// Updates the FrontDoorNetworkExperimentProfile.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/NetworkExperimentProfiles/{profileName}. </description>
        ...
        public virtual async Task<ArmOperation<FrontDoorNetworkExperimentProfileResource>> UpdateAsync(WaitUntil waitUntil, FrontDoorNetworkExperimentProfileData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _networkExperimentProfilesRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, FrontDoorNetworkExperimentProfileData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                FrontDoorArmOperation<FrontDoorNetworkExperimentProfileResource> operation = new FrontDoorArmOperation<FrontDoorNetworkExperimentProfileResource>(
                    new FrontDoorNetworkExperimentProfileResourceOperationSource(Client),
                    _networkExperimentProfilesClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<FrontDoorNetworkExperimentProfileResource> Update(WaitUntil waitUntil, FrontDoorNetworkExperimentProfileData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
