...
namespace Azure.ResourceManager.FrontDoor
{
    ...
    public partial class FrontDoorNetworkExperimentProfileResource : ArmResource
    {
        ...
        internal FrontDoorNetworkExperimentProfileResource(ArmClient client, FrontDoorNetworkExperimentProfileData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<FrontDoorNetworkExperimentProfileResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
                {
                    ...
                    return Response.FromValue(new FrontDoorNetworkExperimentProfileResource(Client, originalResponse.Value, originalResponse.Value.Id), originalResponse.GetRawResponse());
                }
                else
                {
