...
{
    /// <summary></summary>
    internal partial class FrontDoorWebApplicationFirewallPolicyResourceOperationSource : IOperationSource<FrontDoorWebApplicationFirewallPolicyResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal FrontDoorWebApplicationFirewallPolicyResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
