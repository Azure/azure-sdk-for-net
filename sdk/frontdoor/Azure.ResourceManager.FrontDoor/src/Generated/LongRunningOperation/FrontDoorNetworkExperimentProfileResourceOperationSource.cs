...
{
    /// <summary></summary>
    internal partial class FrontDoorNetworkExperimentProfileResourceOperationSource : IOperationSource<FrontDoorNetworkExperimentProfileResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal FrontDoorNetworkExperimentProfileResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
