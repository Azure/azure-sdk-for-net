...
{
    /// <summary></summary>
    internal partial class FrontDoorExperimentResourceOperationSource : IOperationSource<FrontDoorExperimentResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal FrontDoorExperimentResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
