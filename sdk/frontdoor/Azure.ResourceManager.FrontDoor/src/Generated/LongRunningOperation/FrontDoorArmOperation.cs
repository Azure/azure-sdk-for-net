...
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        internal FrontDoorArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia)
        {
            ...
            _operation = new OperationInternal(clientDiagnostics, nextLinkOperation, response, "FrontDoorArmOperation", fallbackStrategy: new ExponentialDelayStrategy());
        }

        internal FrontDoorArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string id)
        {
            var nextLinkOperation = NextLinkOperationImplementation.Create(pipeline, id, out string finalResponse);
            _operation = OperationInternal.Create(clientDiagnostics, nextLinkOperation, finalResponse, "FrontDoorArmOperation", fallbackStrategy: new ExponentialDelayStrategy());
        }
