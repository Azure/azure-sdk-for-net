...
{
    /// <summary></summary>
    internal partial class FrontDoorRulesEngineResourceOperationSource : IOperationSource<FrontDoorRulesEngineResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal FrontDoorRulesEngineResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
