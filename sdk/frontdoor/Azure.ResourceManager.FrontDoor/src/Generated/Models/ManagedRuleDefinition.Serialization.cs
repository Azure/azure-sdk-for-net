    ...
    public partial class ManagedRuleDefinition : IJsonModel<ManagedRuleDefinition>
    {
        ...
        internal static ManagedRuleDefinition DeserializeManagedRuleDefinition(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("defaultState"u8))
                {
                    if (prop.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
                    }
                    defaultState = new ManagedRuleEnabledState(prop.Value.GetString());
                    continue;
                }
                if (prop.NameEquals("defaultAction"u8))
                {
                    ...
                    defaultAction = new RuleMatchActionType(prop.Value.GetString());
                    continue;
                }
                if (prop.NameEquals("defaultSensitivity"u8))
                {
                    if (prop.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
