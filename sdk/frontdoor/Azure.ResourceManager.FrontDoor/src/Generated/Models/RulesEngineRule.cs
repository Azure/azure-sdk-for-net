...
namespace Azure.ResourceManager.FrontDoor.Models
{
    ...
    public partial class RulesEngineRule
    {
        ...
        internal RulesEngineRule(string name, int priority, RulesEngineAction action, IList<RulesEngineMatchCondition> matchConditions, MatchProcessingBehavior? matchProcessingBehavior, Dictionary<string, BinaryData> rawData)
        {
            Name = name;
            Priority = priority;
            Action = action;
