...
{
    public partial class RulesEngineMatchCondition : IUtf8JsonSerializable, IJsonModel<RulesEngineMatchCondition>, IPersistableModel<RulesEngineMatchCondition>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(RulesEngineMatchVariable))
            {
            ...
            if (Optional.IsDefined(RulesEngineOperator))
            {
