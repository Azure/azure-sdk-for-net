...
namespace Azure.ResourceManager.FrontDoor.Models
{
    ...
    public partial class ManagedRuleSet
    {
        ...
        internal ManagedRuleSet(string ruleSetType, string ruleSetVersion, ManagedRuleSetActionType? ruleSetAction, IList<ManagedRuleExclusion> exclusions, IList<ManagedRuleGroupOverride> ruleGroupOverrides, Dictionary<string, BinaryData> rawData)
        {
            RuleSetType = ruleSetType;
            RuleSetVersion = ruleSetVersion;
