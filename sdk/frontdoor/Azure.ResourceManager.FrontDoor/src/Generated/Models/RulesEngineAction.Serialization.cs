...
namespace Azure.ResourceManager.FrontDoor.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RulesEngineAction>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RulesEngineAction>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RulesEngineAction>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RulesEngineAction>)} interface");
            }
        ...
        string IPersistableModel<RulesEngineAction>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
