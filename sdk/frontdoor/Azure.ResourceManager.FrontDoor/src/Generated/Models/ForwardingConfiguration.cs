...
namespace Azure.ResourceManager.FrontDoor.Models
{
    ...
    public partial class ForwardingConfiguration : RouteConfiguration
    {
        ...
        internal ForwardingConfiguration(string odataType, string customForwardingPath, FrontDoorForwardingProtocol? forwardingProtocol, FrontDoorCacheConfiguration cacheConfiguration, WritableSubResource backendPool, Dictionary<string, BinaryData> rawData) : base(odataType, rawData)
        {
