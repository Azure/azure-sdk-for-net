...
namespace Azure.ResourceManager.FrontDoor.Models
{
    internal partial class WebApplicationFirewallPolicyList
    {
        internal static WebApplicationFirewallPolicyList DeserializeWebApplicationFirewallPolicyList(JsonElement element)
        {
            ...
            Core.Optional<IReadOnlyList<FrontDoorWebApplicationFirewallPolicyData>> value = default;
            ...
            return new WebApplicationFirewallPolicyList(Core.Optional.ToList(value), nextLink.Value);
        }
    }
}
