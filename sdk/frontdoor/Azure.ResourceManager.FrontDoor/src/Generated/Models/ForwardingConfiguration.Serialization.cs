...
{
    public partial class ForwardingConfiguration : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ForwardingConfiguration DeserializeForwardingConfiguration(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
