...
{
    public partial class FrontDoorNameAvailabilityResult : IUtf8JsonSerializable, IJsonModel<FrontDoorNameAvailabilityResult>, IPersistableModel<FrontDoorNameAvailabilityResult>
    {
        ...
        void IJsonModel<FrontDoorNameAvailabilityResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(FrontDoorNameAvailabilityResult)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  nameAvailability:");
                builder.AppendLine($" '{NameAvailability.ToString()}'");
            }
