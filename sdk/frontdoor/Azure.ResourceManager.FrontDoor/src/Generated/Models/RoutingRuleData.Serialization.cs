...
{
    public partial class RoutingRuleData : IUtf8JsonSerializable, IJsonModel<RoutingRuleData>, IPersistableModel<RoutingRuleData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(RouteConfiguration))
            {
                ...
                AppendChildObject(builder, RouteConfiguration, options, 2);
            }

            if (Optional.IsDefined(RulesEngine))
            {
                builder.Append("  rulesEngine:");
                AppendChildObject(builder, RulesEngine, options, 2);
            }
