...
{
    public partial class RoutingRuleData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static RoutingRuleData DeserializeRoutingRuleData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
