...
namespace Azure.ResourceManager.FrontDoor.Models
{
    ...
    public partial class WebApplicationRuleMatchCondition
    {
        ...
        internal WebApplicationRuleMatchCondition(WebApplicationRuleMatchVariable matchVariable, string selector, WebApplicationRuleMatchOperator @operator, bool? isNegateCondition, IList<string> matchValue, IList<WebApplicationRuleMatchTransformType> transforms, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            MatchVariable = matchVariable;
            Selector = selector;
            Operator = @operator;
