...
namespace Azure.ResourceManager.FrontDoor.Models
{
    ...
    public abstract partial class RouteConfiguration : IJsonModel<RouteConfiguration>
    {
        ...
        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual RouteConfiguration JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<RouteConfiguration>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static RouteConfiguration DeserializeRouteConfiguration(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            if (element.TryGetProperty("@odata.type"u8, out JsonElement discriminator))
            {
                switch (discriminator.GetString())
                {
                    case "#Microsoft.Azure.FrontDoor.Models.FrontdoorForwardingConfiguration":
                        return ForwardingConfiguration.DeserializeForwardingConfiguration(element, options);
                    case "#Microsoft.Azure.FrontDoor.Models.FrontdoorRedirectConfiguration":
                        return RedirectConfiguration.DeserializeRedirectConfiguration(element, options);
                }
            }
