...
namespace Azure.ResourceManager.FrontDoor.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FrontDoorValidateCustomDomainResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<FrontDoorValidateCustomDomainResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<FrontDoorValidateCustomDomainResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<FrontDoorValidateCustomDomainResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
