...
namespace Azure.ResourceManager.FrontDoor.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PreconfiguredEndpointList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PreconfiguredEndpointList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PreconfiguredEndpointList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PreconfiguredEndpointList>)} interface");
            }
        ...
        string IPersistableModel<PreconfiguredEndpointList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
