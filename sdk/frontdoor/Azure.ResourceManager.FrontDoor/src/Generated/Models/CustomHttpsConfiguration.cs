...
namespace Azure.ResourceManager.FrontDoor.Models
{
    ...
    public partial class CustomHttpsConfiguration
    {
        ...
        internal CustomHttpsConfiguration(FrontDoorCertificateSource certificateSource, FrontDoorTlsProtocolType protocolType, MinimumTlsVersion minimumTlsVersion, FrontDoorEndpointConnectionCertificateType? certificateType, WritableSubResource vault, string secretName, string secretVersion)
        {
            CertificateSource = certificateSource;
            ProtocolType = protocolType;
            MinimumTlsVersion = minimumTlsVersion;
