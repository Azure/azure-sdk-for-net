...
{
    public partial class BackendPoolsSettings : IUtf8JsonSerializable, IJsonModel<BackendPoolsSettings>, IPersistableModel<BackendPoolsSettings>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(EnforceCertificateNameCheck))
            {
                ...
                builder.AppendLine($" '{EnforceCertificateNameCheck.ToString()}'");
            }

            if (Optional.IsDefined(SendRecvTimeoutInSeconds))
            {
                builder.Append("  sendRecvTimeoutSeconds:");
                builder.AppendLine($" '{SendRecvTimeoutInSeconds.Value.ToString()}'");
            }
