...
{
    public partial class FrontDoorWebApplicationFirewallPolicyData : IUtf8JsonSerializable, IJsonModel<FrontDoorWebApplicationFirewallPolicyData>, IPersistableModel<FrontDoorWebApplicationFirewallPolicyData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(PolicySettings))
            {
                ...
                AppendChildObject(builder, PolicySettings, options, 2);
            }

            if (Optional.IsDefined(CustomRuleList))
            {
                builder.Append("  customRules:");
                AppendChildObject(builder, CustomRuleList, options, 2);
            }

            if (Optional.IsDefined(ManagedRules))
            {
                builder.Append("  managedRules:");
                AppendChildObject(builder, ManagedRules, options, 2);
            }
