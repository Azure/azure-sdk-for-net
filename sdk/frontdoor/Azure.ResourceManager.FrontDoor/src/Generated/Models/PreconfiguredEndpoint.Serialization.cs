...
namespace Azure.ResourceManager.FrontDoor.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PreconfiguredEndpoint>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PreconfiguredEndpoint>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PreconfiguredEndpoint>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PreconfiguredEndpoint>)} interface");
            }
        ...
        string IPersistableModel<PreconfiguredEndpoint>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
