...
{
    public partial class LatencyMetric : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static LatencyMetric DeserializeLatencyMetric(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
