...
namespace Azure.ResourceManager.FrontDoor.Models
{
    internal partial class UnknownRouteConfiguration : IUtf8JsonSerializable, IJsonModel<RouteConfiguration>
    {
        ...
        void IJsonModel<RouteConfiguration>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(RouteConfiguration)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<RouteConfiguration>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(RouteConfiguration)} does not support '{options.Format}' format.");
            }
        }
