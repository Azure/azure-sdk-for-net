...
{
    internal partial class UnknownRouteConfiguration : RouteConfiguration, IJsonModel<RouteConfiguration>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<RouteConfiguration>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<RouteConfiguration>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        RouteConfiguration IPersistableModel<RouteConfiguration>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        RouteConfiguration IJsonModel<RouteConfiguration>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownRouteConfiguration DeserializeUnknownRouteConfiguration(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownRouteConfiguration(odataType, additionalBinaryDataProperties);
        }
    }
}
