...
namespace Azure.ResourceManager.FrontDoor.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FrontDoorBackendPool>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<FrontDoorBackendPool>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<FrontDoorBackendPool>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<FrontDoorBackendPool>)} interface");
            }
        ...
        string IPersistableModel<FrontDoorBackendPool>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
