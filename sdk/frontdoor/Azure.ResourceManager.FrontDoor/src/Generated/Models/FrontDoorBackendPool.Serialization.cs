    ...
    public partial class FrontDoorBackendPool : IUtf8JsonSerializable, IJsonModel<FrontDoorBackendPool>
    {
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(Backends))
            {
                ...
                {
                    ((IJsonModel<FrontDoorBackend>)item).Write(writer, options);
                }
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("loadBalancingSettings"u8))
                        {
                            ...
                            loadBalancingSettings = ModelSerializationExtensions.JsonDeserialize<WritableSubResource>(property0.Value);
                            continue;
                        }
                        if (property0.NameEquals("healthProbeSettings"u8))
                        {
                            ...
                            healthProbeSettings = ModelSerializationExtensions.JsonDeserialize<WritableSubResource>(property0.Value);
                            continue;
                        }
