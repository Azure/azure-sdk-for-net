...
{
    internal partial class FrontDoorSku : IUtf8JsonSerializable, IJsonModel<FrontDoorSku>, IPersistableModel<FrontDoorSku>
    {
        ...
        void IJsonModel<FrontDoorSku>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(FrontDoorSku)} does not support '{format}' format.");
            }
