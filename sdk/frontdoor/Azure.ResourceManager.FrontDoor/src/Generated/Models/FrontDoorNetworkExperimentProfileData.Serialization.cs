...
{
    public partial class FrontDoorNetworkExperimentProfileData : Core.IUtf8JsonSerializable
    {
        ...
        internal static FrontDoorNetworkExperimentProfileData DeserializeFrontDoorNetworkExperimentProfileData(JsonElement element)
        {
            ...
            return new FrontDoorNetworkExperimentProfileData(id, name, type, systemData.Value, Core.Optional.ToDictionary(tags), location, Core.Optional.ToNullable(etag), Core.Optional.ToNullable(resourceState), Core.Optional.ToNullable(enabledState));
        }
    }
}
