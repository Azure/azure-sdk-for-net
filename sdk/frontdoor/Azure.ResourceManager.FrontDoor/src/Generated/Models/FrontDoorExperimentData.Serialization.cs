...
{
    public partial class FrontDoorExperimentData : IUtf8JsonSerializable, IJsonModel<FrontDoorExperimentData>, IPersistableModel<FrontDoorExperimentData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ExperimentEndpointA))
            {
                ...
                AppendChildObject(builder, ExperimentEndpointA, options, 2);
            }

            if (Optional.IsDefined(ExperimentEndpointB))
            {
                builder.Append("  endpointB:");
                AppendChildObject(builder, ExperimentEndpointB, options, 2);
            }
