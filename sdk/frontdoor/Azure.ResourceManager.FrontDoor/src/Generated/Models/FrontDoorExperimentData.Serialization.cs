...
namespace Azure.ResourceManager.FrontDoor
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FrontDoorExperimentData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<FrontDoorExperimentData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<FrontDoorExperimentData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<FrontDoorExperimentData>)} interface");
            }
        ...
        string IPersistableModel<FrontDoorExperimentData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
