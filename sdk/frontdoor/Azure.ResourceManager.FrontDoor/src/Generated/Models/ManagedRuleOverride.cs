...
namespace Azure.ResourceManager.FrontDoor.Models
{
    ...
    public partial class ManagedRuleOverride
    {
        ...
        internal ManagedRuleOverride(string ruleId, ManagedRuleEnabledState? enabledState, RuleMatchActionType? action, IList<ManagedRuleExclusion> exclusions, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            RuleId = ruleId;
