...
namespace Azure.ResourceManager.FrontDoor.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RulesEngineRule>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RulesEngineRule>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RulesEngineRule>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RulesEngineRule>)} interface");
            }
        ...
        string IPersistableModel<RulesEngineRule>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
