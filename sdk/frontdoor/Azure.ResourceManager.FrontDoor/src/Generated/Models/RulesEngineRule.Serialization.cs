...
{
    public partial class RulesEngineRule : IUtf8JsonSerializable, IJsonModel<RulesEngineRule>, IPersistableModel<RulesEngineRule>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(MatchProcessingBehavior))
            {
                ...
                builder.AppendLine($" '{MatchProcessingBehavior.ToString()}'");
            }
