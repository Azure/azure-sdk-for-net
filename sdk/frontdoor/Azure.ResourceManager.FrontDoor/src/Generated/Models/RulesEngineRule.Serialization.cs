...
{
    public partial class RulesEngineRule : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static RulesEngineRule DeserializeRulesEngineRule(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
