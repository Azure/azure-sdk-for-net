...
namespace Azure.ResourceManager.FrontDoor.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<WebApplicationRuleMatchCondition>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<WebApplicationRuleMatchCondition>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<WebApplicationRuleMatchCondition>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<WebApplicationRuleMatchCondition>)} interface");
            }
        ...
        string IPersistableModel<WebApplicationRuleMatchCondition>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
