...
{
    public partial class LatencyScorecard : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static LatencyScorecard DeserializeLatencyScorecard(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
