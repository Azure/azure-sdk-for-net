...
namespace Azure.ResourceManager.FrontDoor
{
    public partial class FrontendEndpointData : IUtf8JsonSerializable, IModelJsonSerializable<FrontendEndpointData>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<FrontendEndpointData>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="FrontendEndpointData"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="FrontendEndpointData"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="FrontendEndpointData"/>. </summary>
