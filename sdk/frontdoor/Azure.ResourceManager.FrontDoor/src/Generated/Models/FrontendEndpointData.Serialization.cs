...
namespace Azure.ResourceManager.FrontDoor
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FrontendEndpointData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<FrontendEndpointData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<FrontendEndpointData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<FrontendEndpointData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
