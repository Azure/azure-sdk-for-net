...
namespace Azure.ResourceManager.FrontDoor.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RulesEngineListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RulesEngineListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RulesEngineListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RulesEngineListResult>)} interface");
            }
        ...
        string IPersistableModel<RulesEngineListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
