...
namespace Azure.ResourceManager.FrontDoor.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RulesEngineListResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        internal static RulesEngineListResult DeserializeRulesEngineListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new RulesEngineListResult(value ?? new ChangeTrackingList<FrontDoorRulesEngineData>(), nextLink, serializedAdditionalRawData);
        }
