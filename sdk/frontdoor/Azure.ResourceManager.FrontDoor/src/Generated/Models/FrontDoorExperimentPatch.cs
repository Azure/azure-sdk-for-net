...
namespace Azure.ResourceManager.FrontDoor.Models
{
    ...
    public partial class FrontDoorExperimentPatch
    {
        ...
        internal FrontDoorExperimentPatch(IDictionary<string, string> tags, string description, FrontDoorExperimentState? enabledState, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Tags = tags;
