...
namespace Azure.ResourceManager.FrontDoor
{
    public partial class ExperimentData : IUtf8JsonSerializable
    {
        ...
        internal static ExperimentData DeserializeExperimentData(JsonElement element)
        {
            ...
            return new ExperimentData(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, description.Value, endpointA.Value, endpointB.Value, Optional.ToNullable(enabledState), Optional.ToNullable(resourceState), status.Value, scriptFileUri.Value);
        }
    }
}
