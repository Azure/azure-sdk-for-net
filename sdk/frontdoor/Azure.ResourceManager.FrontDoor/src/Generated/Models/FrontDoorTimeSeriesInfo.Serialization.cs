...
{
    public partial class FrontDoorTimeSeriesInfo : IUtf8JsonSerializable, IJsonModel<FrontDoorTimeSeriesInfo>, IPersistableModel<FrontDoorTimeSeriesInfo>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(AggregationInterval))
            {
                ...
                builder.AppendLine($" '{AggregationInterval.ToString()}'");
            }

            if (Optional.IsDefined(TimeSeriesType))
            {
                builder.Append("  timeseriesType:");
                builder.AppendLine($" '{TimeSeriesType.ToString()}'");
            }
