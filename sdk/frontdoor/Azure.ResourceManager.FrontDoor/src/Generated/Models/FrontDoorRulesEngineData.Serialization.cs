...
{
    public partial class FrontDoorRulesEngineData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static FrontDoorRulesEngineData DeserializeFrontDoorRulesEngineData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
