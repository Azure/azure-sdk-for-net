...
namespace Azure.ResourceManager.FrontDoor
{
    public partial class FrontDoorRulesEngineData : IUtf8JsonSerializable, IJsonModel<FrontDoorRulesEngineData>
    {
        ...
        void IJsonModel<FrontDoorRulesEngineData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(FrontDoorRulesEngineData)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<FrontDoorRulesEngineData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(FrontDoorRulesEngineData)} does not support '{options.Format}' format.");
            }
        }
