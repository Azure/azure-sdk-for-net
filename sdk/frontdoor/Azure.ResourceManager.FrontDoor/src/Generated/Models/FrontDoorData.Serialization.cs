...
{
    public partial class FrontDoorData : IUtf8JsonSerializable, IJsonModel<FrontDoorData>, IPersistableModel<FrontDoorData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(BackendPoolsSettings))
            {
                ...
                AppendChildObject(builder, BackendPoolsSettings, options, 2);
            }
