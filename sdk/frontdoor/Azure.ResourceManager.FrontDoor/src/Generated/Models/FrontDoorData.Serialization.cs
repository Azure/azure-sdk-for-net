...
{
    public partial class FrontDoorData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static FrontDoorData DeserializeFrontDoorData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
