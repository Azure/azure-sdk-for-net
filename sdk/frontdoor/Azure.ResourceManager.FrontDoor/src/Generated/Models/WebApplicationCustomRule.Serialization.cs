...
{
    public partial class WebApplicationCustomRule : IUtf8JsonSerializable, IJsonModel<WebApplicationCustomRule>, IPersistableModel<WebApplicationCustomRule>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(RateLimitDurationInMinutes))
            {
                ...
                builder.AppendLine($" '{RateLimitDurationInMinutes.Value.ToString()}'");
            }
