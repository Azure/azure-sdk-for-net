...
{
    public partial class FrontDoorHealthProbeSettingsData : IUtf8JsonSerializable, IJsonModel<FrontDoorHealthProbeSettingsData>, IPersistableModel<FrontDoorHealthProbeSettingsData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(HealthProbeMethod))
            {
                ...
                builder.AppendLine($" '{HealthProbeMethod.ToString()}'");
            }
