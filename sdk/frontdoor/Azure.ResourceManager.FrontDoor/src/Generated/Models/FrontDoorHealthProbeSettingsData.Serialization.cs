...
namespace Azure.ResourceManager.FrontDoor.Models
{
    public partial class FrontDoorHealthProbeSettingsData : IUtf8JsonSerializable, IModelJsonSerializable<FrontDoorHealthProbeSettingsData>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<FrontDoorHealthProbeSettingsData>(this, options.Format);
        ...
        internal static FrontDoorHealthProbeSettingsData DeserializeFrontDoorHealthProbeSettingsData(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new FrontDoorHealthProbeSettingsData(id.Value, name.Value, Optional.ToNullable(type), path.Value, Optional.ToNullable(protocol), Optional.ToNullable(intervalInSeconds), Optional.ToNullable(healthProbeMethod), Optional.ToNullable(enabledState), Optional.ToNullable(resourceState), serializedAdditionalRawData);
        }
