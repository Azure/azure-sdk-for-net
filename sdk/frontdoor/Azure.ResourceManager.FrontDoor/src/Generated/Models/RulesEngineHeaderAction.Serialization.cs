...
namespace Azure.ResourceManager.FrontDoor.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RulesEngineHeaderAction>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RulesEngineHeaderAction>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RulesEngineHeaderAction>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RulesEngineHeaderAction>)} interface");
            }
        ...
        string IPersistableModel<RulesEngineHeaderAction>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
