...
{
    public partial class FrontDoorLoadBalancingSettingsData : IUtf8JsonSerializable, IJsonModel<FrontDoorLoadBalancingSettingsData>, IPersistableModel<FrontDoorLoadBalancingSettingsData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(AdditionalLatencyMilliseconds))
            {
                ...
                builder.AppendLine($" '{AdditionalLatencyMilliseconds.Value.ToString()}'");
            }
