...
namespace Azure.ResourceManager.FrontDoor.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FrontDoorLoadBalancingSettingsData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<FrontDoorLoadBalancingSettingsData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<FrontDoorLoadBalancingSettingsData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<FrontDoorLoadBalancingSettingsData>)} interface");
            }
        ...
        string IPersistableModel<FrontDoorLoadBalancingSettingsData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
