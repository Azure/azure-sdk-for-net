...
{
    internal partial class FrontendEndpointsListResult : IUtf8JsonSerializable, IJsonModel<FrontendEndpointsListResult>, IPersistableModel<FrontendEndpointsListResult>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FrontendEndpointsListResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<FrontendEndpointsListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(FrontendEndpointsListResult)} does not support '{format}' format.");
            }
