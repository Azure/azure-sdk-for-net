...
namespace Azure.ResourceManager.FrontDoor.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FrontendEndpointsListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<FrontendEndpointsListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<FrontendEndpointsListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<FrontendEndpointsListResult>)} interface");
            }
        ...
        string IPersistableModel<FrontendEndpointsListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
