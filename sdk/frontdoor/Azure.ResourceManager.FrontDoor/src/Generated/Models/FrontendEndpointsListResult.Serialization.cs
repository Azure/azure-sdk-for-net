...
namespace Azure.ResourceManager.FrontDoor.Models
{
    ...
    {
        internal static FrontendEndpointsListResult DeserializeFrontendEndpointsListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
