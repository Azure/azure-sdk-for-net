...
{
    public partial class RedirectConfiguration : IUtf8JsonSerializable, IJsonModel<RedirectConfiguration>, IPersistableModel<RedirectConfiguration>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(RedirectProtocol))
            {
                ...
                builder.AppendLine($" '{RedirectProtocol.ToString()}'");
            }
