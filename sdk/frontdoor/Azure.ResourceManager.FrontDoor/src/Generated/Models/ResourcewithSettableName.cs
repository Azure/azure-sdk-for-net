...
namespace Azure.ResourceManager.FrontDoor.Models
{
    ...
    public partial class ResourcewithSettableName
    {
        ...
        internal ResourcewithSettableName(string id, string name, string @type, string location, IDictionary<string, string> tags, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Id = id;
            Name = name;
            Type = @type;
