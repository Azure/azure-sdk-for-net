...
namespace Azure.ResourceManager.FrontDoor
{
    public partial class FrontDoorExperimentResource : IJsonModel<FrontDoorExperimentData>
    {
        ...
        {
            return ModelReaderWriter.Read<FrontDoorExperimentData>(new BinaryData(reader.ValueSequence), options);
        }
        ...
        {
            return ModelReaderWriter.Read<FrontDoorExperimentData>(data, options);
        }
