...
namespace Azure.ResourceManager.FrontDoor.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ManagedRuleExclusion>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ManagedRuleExclusion>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ManagedRuleExclusion>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ManagedRuleExclusion>)} interface");
            }
        ...
        string IPersistableModel<ManagedRuleExclusion>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
