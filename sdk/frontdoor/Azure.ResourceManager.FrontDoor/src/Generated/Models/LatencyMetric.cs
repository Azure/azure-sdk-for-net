...
namespace Azure.ResourceManager.FrontDoor.Models
{
    ...
    public partial class LatencyMetric
    {
        ...
        internal LatencyMetric(string name, DateTimeOffset? endOn, float? aValue, float? bValue, float? delta, float? deltaPercent, float? acLower95CI, float? ahUpper95CI, float? bcLower95CI, float? bUpper95CI, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            EndOn = endOn;
            AValue = aValue;
