...
namespace Azure.ResourceManager.FrontDoor.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FrontDoorBackend>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<FrontDoorBackend>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<FrontDoorBackend>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<FrontDoorBackend>)} interface");
            }
        ...
        string IPersistableModel<FrontDoorBackend>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
