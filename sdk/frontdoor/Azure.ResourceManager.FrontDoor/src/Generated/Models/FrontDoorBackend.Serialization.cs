...
{
    public partial class FrontDoorBackend : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static FrontDoorBackend DeserializeFrontDoorBackend(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
