...
namespace Azure.ResourceManager.FrontDoor.Models
{
    ...
    public partial class RulesEngineHeaderAction
    {
        ...
        internal RulesEngineHeaderAction(RulesEngineHeaderActionType headerActionType, string headerName, string value, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            HeaderActionType = headerActionType;
            HeaderName = headerName;
            Value = value;
