...
namespace Azure.ResourceManager.FrontDoor.Models
{
    ...
    public partial class ManagedRuleDefinition
    {
        ...
        internal ManagedRuleDefinition(string ruleId, ManagedRuleEnabledState? defaultState, RuleMatchActionType? defaultAction, string description, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            RuleId = ruleId;
