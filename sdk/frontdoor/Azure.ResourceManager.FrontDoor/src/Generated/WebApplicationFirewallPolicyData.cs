...
namespace Azure.ResourceManager.FrontDoor
{
    ...
    public partial class WebApplicationFirewallPolicyData : TrackedResourceData
    {
        ...
        internal WebApplicationFirewallPolicyData(ResourceIdentifier id, string name, Core.ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, ETag? etag, FrontDoorSku sku, PolicySettings policySettings, CustomRuleList customRuleList, ManagedRuleSetList managedRules, IReadOnlyList<Resources.Models.SubResource> frontendEndpointLinks, IReadOnlyList<Resources.Models.SubResource> routingRuleLinks, IReadOnlyList<Resources.Models.SubResource> securityPolicyLinks, string provisioningState, PolicyResourceState? resourceState) : base(id, name, resourceType, systemData, tags, location)
        {
            ETag = etag;
            Sku = sku;
