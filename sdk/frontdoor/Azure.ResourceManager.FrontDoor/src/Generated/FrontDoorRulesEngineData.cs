...
namespace Azure.ResourceManager.FrontDoor
{
    ...
    public partial class FrontDoorRulesEngineData : ResourceData
    {
        ...
        internal FrontDoorRulesEngineData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IList<RulesEngineRule> rules, FrontDoorResourceState? resourceState, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
            Rules = rules;
