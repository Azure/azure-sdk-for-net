...
namespace Azure.Provisioning.FrontDoor
{
    ...
    internal partial class FrontDoorResourceData : ProvisionableConstruct
    {
        private BicepValue<ResourceIdentifier> _id;
        private BicepValue<string> _name;
        private BicepValue<ResourceType> _resourceType;

        /// <summary> Creates a new FrontDoorResourceData. </summary>
        ...
        /// <summary> Define all the provisionable properties for FrontDoorResourceData. </summary>
        ...
        /// <summary> Define additional provisionable properties for FrontDoorResourceData that are not part of the generated code. </summary>
