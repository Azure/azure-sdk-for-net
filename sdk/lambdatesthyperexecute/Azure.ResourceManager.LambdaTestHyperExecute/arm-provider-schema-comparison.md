# ARM provider schema comparison: Azure.ResourceManager.LambdaTestHyperExecute
...
| --- | --- | --- |
| `/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/LambdaTest.HyperExecute/organizations/{organizationname}` | `LambdaTestHyperExecuteOrganization` | `OrganizationResource` |
