...
#pragma warning disable SA1649 // File name should match first type name
    internal class LambdaTestHyperExecuteArmOperation : ArmOperation
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        internal LambdaTestHyperExecuteArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal LambdaTestHyperExecuteArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal(nextLinkOperation, clientDiagnostics, response, "LambdaTestHyperExecuteArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
