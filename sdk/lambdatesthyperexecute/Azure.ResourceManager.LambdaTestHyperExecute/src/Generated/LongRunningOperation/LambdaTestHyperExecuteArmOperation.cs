...
namespace Azure.ResourceManager.LambdaTestHyperExecute
{
    internal partial class LambdaTestHyperExecuteArmOperation : ArmOperation
    {
        ...
        internal LambdaTestHyperExecuteArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
