...
{
    /// <summary></summary>
    internal partial class LambdaTestHyperExecuteOrganizationResourceOperationSource : IOperationSource<LambdaTestHyperExecuteOrganizationResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal LambdaTestHyperExecuteOrganizationResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
