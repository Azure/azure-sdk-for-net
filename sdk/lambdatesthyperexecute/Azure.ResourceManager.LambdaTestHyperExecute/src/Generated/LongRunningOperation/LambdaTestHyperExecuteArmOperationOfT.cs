...
namespace Azure.ResourceManager.LambdaTestHyperExecute
{
    internal partial class LambdaTestHyperExecuteArmOperation<T> : ArmOperation<T>
    {
        ...
        internal LambdaTestHyperExecuteArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
