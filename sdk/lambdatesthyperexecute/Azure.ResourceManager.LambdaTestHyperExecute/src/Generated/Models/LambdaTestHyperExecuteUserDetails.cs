...
namespace Azure.ResourceManager.LambdaTestHyperExecute.Models
{
    ...
    public partial class LambdaTestHyperExecuteUserDetails
    {
        ...
        internal LambdaTestHyperExecuteUserDetails(string firstName, string lastName, string emailAddress, string upn, string phoneNumber, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            FirstName = firstName;
            LastName = lastName;
