...
namespace Azure.ResourceManager.LambdaTestHyperExecute.Models
{
    ...
    public partial class LambdaTestHyperExecuteOrganizationPatch : IJsonModel<LambdaTestHyperExecuteOrganizationPatch>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<LambdaTestHyperExecuteOrganizationPatch>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        internal static RequestContent ToRequestContent(LambdaTestHyperExecuteOrganizationPatch lambdaTestHyperExecuteOrganizationPatch)
        {
            ...
            return RequestContent.Create(lambdaTestHyperExecuteOrganizationPatch, ModelSerializationExtensions.WireOptions);
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        LambdaTestHyperExecuteOrganizationPatch IJsonModel<LambdaTestHyperExecuteOrganizationPatch>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual LambdaTestHyperExecuteOrganizationPatch JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<LambdaTestHyperExecuteOrganizationPatch>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static LambdaTestHyperExecuteOrganizationPatch DeserializeLambdaTestHyperExecuteOrganizationPatch(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("identity"u8))
                {
                    ...
                    identity = ModelReaderWriter.Read<ManagedServiceIdentity>(new BinaryData(Encoding.UTF8.GetBytes(prop.Value.GetRawText())), new ModelReaderWriterOptions(options.Format + "|v3"), AzureResourceManagerLambdaTestHyperExecuteContext.Default);
                    continue;
                }
                if (options.Format != "W")
                {
            ...
            return new LambdaTestHyperExecuteOrganizationPatch(tags ?? new ChangeTrackingDictionary<string, string>(), identity, additionalBinaryDataProperties);
        }
    }
}
