...
namespace Azure.ResourceManager.LambdaTestHyperExecute.Models
{
    ...
    internal partial class OrganizationResourceListResult
    {
        ...
        internal OrganizationResourceListResult(IList<LambdaTestHyperExecuteOrganizationData> value, Uri nextLink, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            NextLink = nextLink;
        ...
        public IList<LambdaTestHyperExecuteOrganizationData> Value { get; }
