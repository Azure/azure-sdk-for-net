...
namespace Azure.ResourceManager.LambdaTestHyperExecute.Models
{
    ...
    public partial class LambdaTestHyperExecuteSingleSignOnPropertiesV2
    {
        ...
        internal LambdaTestHyperExecuteSingleSignOnPropertiesV2(LambdaTestHyperExecuteSingleSignOnType @type, LambdaTestHyperExecuteSingleSignOnState? state, string enterpriseAppId, string uri, IList<string> aadDomains, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Type = @type;
            State = state;
