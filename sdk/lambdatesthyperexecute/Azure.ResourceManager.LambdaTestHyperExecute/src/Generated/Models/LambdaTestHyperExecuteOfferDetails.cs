...
namespace Azure.ResourceManager.LambdaTestHyperExecute.Models
{
    ...
    public partial class LambdaTestHyperExecuteOfferDetails
    {
        ...
        internal LambdaTestHyperExecuteOfferDetails(string publisherId, string offerId, string planId, string planName, string termUnit, string termId, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            PublisherId = publisherId;
            OfferId = offerId;
            PlanId = planId;
