...
namespace Azure.ResourceManager.LambdaTestHyperExecute.Models
{
    ...
    public partial class LambdaTestHyperExecuteOfferPartnerProperties : IJsonModel<LambdaTestHyperExecuteOfferPartnerProperties>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        LambdaTestHyperExecuteOfferPartnerProperties IJsonModel<LambdaTestHyperExecuteOfferPartnerProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual LambdaTestHyperExecuteOfferPartnerProperties JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<LambdaTestHyperExecuteOfferPartnerProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static LambdaTestHyperExecuteOfferPartnerProperties DeserializeLambdaTestHyperExecuteOfferPartnerProperties(JsonElement element, ModelReaderWriterOptions options)
        {
