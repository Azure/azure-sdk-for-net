...
{
    internal partial class OrganizationsGetBySubscriptionCollectionResultOfT : Pageable<LambdaTestHyperExecuteOrganizationData>
    {
        ...
        public override IEnumerable<Page<LambdaTestHyperExecuteOrganizationData>> AsPages(string continuationToken, int? pageSizeHint)
        {
        ...
        private Response GetNextResponse(int? pageSizeHint, Uri nextLink)
        {
            ...
            using DiagnosticScope scope = _client.ClientDiagnostics.CreateScope("MockableLambdaTestHyperExecuteSubscriptionResource.GetLambdaTestHyperExecuteOrganizations");
            scope.Start();
            try
            {
