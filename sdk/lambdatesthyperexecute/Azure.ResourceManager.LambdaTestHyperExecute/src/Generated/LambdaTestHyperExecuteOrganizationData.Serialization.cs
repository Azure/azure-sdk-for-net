...
namespace Azure.ResourceManager.LambdaTestHyperExecute
{
    ...
    public partial class LambdaTestHyperExecuteOrganizationData : TrackedResourceData, IJsonModel<LambdaTestHyperExecuteOrganizationData>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        LambdaTestHyperExecuteOrganizationData IJsonModel<LambdaTestHyperExecuteOrganizationData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (LambdaTestHyperExecuteOrganizationData)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static LambdaTestHyperExecuteOrganizationData DeserializeLambdaTestHyperExecuteOrganizationData(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("systemData"u8))
                {
                    ...
                    systemData = ModelReaderWriter.Read<SystemData>(new BinaryData(Encoding.UTF8.GetBytes(prop.Value.GetRawText())), ModelSerializationExtensions.WireOptions, AzureResourceManagerLambdaTestHyperExecuteContext.Default);
                    continue;
                }
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = LambdaTestHyperExecuteOrganizationProperties.DeserializeLambdaTestHyperExecuteOrganizationProperties(prop.Value, options);
                    continue;
                }
