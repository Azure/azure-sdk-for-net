...
{
    public partial class Sample_CustomAssessmentAutomationCollection
    {
        [Test]
        ...
        public async Task Get_GetACustomAssessmentAutomation()
        {
            ...
            // invoke the operation
            string customAssessmentAutomationName = "MyCustomAssessmentAutomation";
            CustomAssessmentAutomationResource result = await collection.GetAsync(customAssessmentAutomationName);
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task Exists_GetACustomAssessmentAutomation()
        {
            // Generated from example definition: specification/security/resource-manager/Microsoft.Security/preview/2021-07-01-preview/examples/CustomAssessmentAutomations/customAssessmentAutomationGet_example.json
            // this example is just showing the usage of "CustomAssessmentAutomations_Get" operation, for the dependent resources, they will have to be created separately.
        ...
        public async Task GetIfExists_GetACustomAssessmentAutomation()
        {
            ...
            // invoke the operation
            string customAssessmentAutomationName = "MyCustomAssessmentAutomation";
            NullableResponse<CustomAssessmentAutomationResource> response = await collection.GetIfExistsAsync(customAssessmentAutomationName);
            CustomAssessmentAutomationResource result = response.HasValue ? response.Value : null;
