...
namespace Azure.ResourceManager.SecurityCenter.Samples
{
    public partial class Sample_SecurityConnectorGovernanceRuleCollection
    {
        ...
        public async Task CreateOrUpdate_CreateOrUpdateGovernanceRuleOverManagementGroupScope()
        {
            ...
            SecurityConnectorGovernanceRuleCollection collection = client.GetSecurityConnectorGovernanceRules(new ResourceIdentifier(scope));
...
["value"] = "[\"b1cd27e0-4ecc-4246-939f-49c426d9d72f\", \"fe83f80b-073d-4ccf-93d9-6797eb870201\"]"
        ...
        public async Task GetIfExists_GetAGovernanceRuleOverManagementGroupScope()
        {
            ...
            // invoke the operation
            string ruleId = "ad9a8e26-29d9-4829-bb30-e597a58cdbb8";
            NullableResponse<SecurityConnectorGovernanceRuleResource> response = await collection.GetIfExistsAsync(ruleId);
            SecurityConnectorGovernanceRuleResource result = response.HasValue ? response.Value : null;
