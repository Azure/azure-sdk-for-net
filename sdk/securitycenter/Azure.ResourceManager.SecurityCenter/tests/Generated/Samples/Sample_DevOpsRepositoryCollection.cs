...
{
    public partial class Sample_AzureDevOpsRepositoryCollection
    {
        [Test]
        ...
        public async Task CreateOrUpdate_CreateOrUpdateAzureDevOpsRepos()
        {
            ...
            ResourceIdentifier devOpsProjectResourceId = AzureDevOpsProjectResource.CreateResourceIdentifier(subscriptionId, resourceGroupName, securityConnectorName, orgName, projectName);
            AzureDevOpsProjectResource AzureDevOpsProject = client.GetAzureDevOpsProjectResource(devOpsProjectResourceId);

            // get the collection of this AzureDevOpsRepositoryResource
            AzureDevOpsRepositoryCollection collection = AzureDevOpsProject.GetAzureDevOpsRepositories();
            ...
            ArmOperation<AzureDevOpsRepositoryResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, repoName, data);
        ...
        public async Task Get_GetAzureDevOpsRepos()
        {
            ...
            // invoke the operation
            string repoName = "myAzDevOpsRepo";
            AzureDevOpsRepositoryResource result = await collection.GetAsync(repoName);
        ...
        public async Task GetAll_ListAzureDevOpsRepos()
        {
            ...
            await foreach (AzureDevOpsRepositoryResource item in collection.GetAllAsync())
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                AzureDevOpsRepositoryData resourceData = item.Data;
                // for demo we just print out the id
                Console.WriteLine($"Succeeded on id: {resourceData.Id}");
            }
        ...
        public async Task GetIfExists_GetAzureDevOpsRepos()
        {
            ...
            // invoke the operation
            string repoName = "myAzDevOpsRepo";
            NullableResponse<AzureDevOpsRepositoryResource> response = await collection.GetIfExistsAsync(repoName);
            AzureDevOpsRepositoryResource result = response.HasValue ? response.Value : null;
