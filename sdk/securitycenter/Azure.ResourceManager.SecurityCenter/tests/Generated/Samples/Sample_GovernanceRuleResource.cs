...
namespace Azure.ResourceManager.SecurityCenter.Samples
{
    public partial class Sample_SecurityConnectorGovernanceRuleResource
    {
        ...
        public async Task Get_GetAGovernanceRuleOverManagementGroupScope()
        {
            ...
            ResourceIdentifier governanceRuleResourceId = SecurityConnectorGovernanceRuleResource.CreateResourceIdentifier(scope, ruleId);
            SecurityConnectorGovernanceRuleResource governanceRule = client.GetSecurityConnectorGovernanceRuleResource(governanceRuleResourceId);

            // invoke the operation
            SecurityConnectorGovernanceRuleResource result = await governanceRule.GetAsync();
...
["value"] = "[\"b1cd27e0-4ecc-4246-939f-49c426d9d72f\", \"fe83f80b-073d-4ccf-93d9-6797eb870201\"]"
            ...
            ArmOperation<SecurityConnectorGovernanceRuleResource> lro = await governanceRule.UpdateAsync(WaitUntil.Completed, data);
