...
{
    public partial class Sample_HealthReportCollection
    {
        // List health reports
        ...
        public async Task GetAll_ListHealthReports()
        {
            ...
            // get the collection of this HealthReportResource
            string scope = "subscriptions/a1efb6ca-fbc5-4782-9aaa-5c7daded1ce2";
            ResourceIdentifier scopeId = new ResourceIdentifier(string.Format("/{0}", scope));
            HealthReportCollection collection = client.GetHealthReports(scopeId);

            // invoke the operation and iterate over the result
            await foreach (HealthReportResource item in collection.GetAllAsync())
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                HealthReportData resourceData = item.Data;
        ...
        public async Task Get_GetHealthReportOfResource()
        {
            ...
            HealthReportResource result = await collection.GetAsync(healthReportName);

            // the variable result is a resource, you could call other operations on this instance as well
            // but just for demo, we get its data from this resource instance
            HealthReportData resourceData = result.Data;
            // for demo we just print out the id
            Console.WriteLine($"Succeeded on id: {resourceData.Id}");
        }
        ...
        public async Task GetIfExists_GetHealthReportOfResource()
        {
            ...
            // invoke the operation
            string healthReportName = "909c629a-bf39-4521-8e4f-10b443a0bc02";
            NullableResponse<HealthReportResource> response = await collection.GetIfExistsAsync(healthReportName);
            HealthReportResource result = response.HasValue ? response.Value : null;
