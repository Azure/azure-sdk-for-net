...
{
    public partial class Sample_GitLabGroupCollection
    {
        // List_GitLabGroups
        ...
        public async Task GetAll_ListGitLabGroups()
        {
            ...
            // get the collection of this GitLabGroupResource
            GitLabGroupCollection collection = devOpsConfiguration.GetGitLabGroups();

            // invoke the operation and iterate over the result
            await foreach (GitLabGroupResource item in collection.GetAllAsync())
            {
        ...
        public async Task Get_GetGitLabGroups()
        {
            ...
            GitLabGroupResource result = await collection.GetAsync(groupFQName);
        ...
        public async Task GetIfExists_GetGitLabGroups()
        {
            ...
            // invoke the operation
            string groupFQName = "myGitLabGroup$mySubGroup";
            NullableResponse<GitLabGroupResource> response = await collection.GetIfExistsAsync(groupFQName);
            GitLabGroupResource result = response.HasValue ? response.Value : null;
        ...
        public async Task GetGitLabSubgroups_ListGitLabSubgroups()
        {
            ...
            await foreach (GitLabGroupResource item in collection.GetGitLabSubgroupsAsync(groupFQName))
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                GitLabGroupData resourceData = item.Data;
