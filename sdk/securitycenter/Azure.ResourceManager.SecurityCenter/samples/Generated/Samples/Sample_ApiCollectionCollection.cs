...
{
    public partial class Sample_ApiCollectionCollection
    {
        ...
        public async Task GetAll_GetsAListOfAzureAPIManagementAPIsThatHaveBeenOnboardedToMicrosoftDefenderForAPIs()
        {
            ...
            // get the collection of this ApiCollectionResource
            string serviceName = "apimService1";
            ApiCollectionCollection collection = resourceGroupResource.GetApiCollections(serviceName);

            // invoke the operation and iterate over the result
            await foreach (ApiCollectionResource item in collection.GetAllAsync())
            {
        ...
        public async Task Get_GetsAnAzureAPIManagementAPIIfItHasBeenOnboardedToMicrosoftDefenderForAPIs()
        {
            ...
            ApiCollectionResource result = await collection.GetAsync(apiId);
        ...
        public async Task GetIfExists_GetsAnAzureAPIManagementAPIIfItHasBeenOnboardedToMicrosoftDefenderForAPIs()
        {
            ...
            // invoke the operation
            string apiId = "echo-api";
            NullableResponse<ApiCollectionResource> response = await collection.GetIfExistsAsync(apiId);
            ApiCollectionResource result = response.HasValue ? response.Value : null;
        ...
        public async Task CreateOrUpdate_OnboardAnAzureAPIManagementAPIToMicrosoftDefenderForAPIs()
        {
            ...
            // invoke the operation
            string apiId = "echo-api";
            ArmOperation<ApiCollectionResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, apiId);
