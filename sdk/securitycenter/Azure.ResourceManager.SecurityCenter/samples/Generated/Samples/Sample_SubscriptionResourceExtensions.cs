...
namespace Azure.ResourceManager.SecurityCenter.Samples
{
    public partial class Sample_SubscriptionResourceExtensions
    {
        ...
        public async Task GetIotSecuritySolutions_ListIoTSecuritySolutionsByIoTHub()
        {
            ...
            await foreach (IotSecuritySolutionResource item in subscriptionResource.GetIotSecuritySolutionsAsync(filter))
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
        ...
        public async Task GetAdaptiveApplicationControlGroups_GetsAListOfApplicationControlGroupsOfMachinesForTheSubscription()
        {
            ...
            bool? summary = false;
            await foreach (AdaptiveApplicationControlGroupResource item in subscriptionResource.GetAdaptiveApplicationControlGroupsAsync(includePathRecommendations, summary))
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
