...
{
    public partial class Sample_HealthReportResource
    {
        ...
        public async Task Get_GetHealthReportOfResource()
        {
            ...
            // this example assumes you already have this HealthReportResource created on azure
            // for more information of creating HealthReportResource, please refer to the document of HealthReportResource
            ...
            ResourceIdentifier healthReportResourceId = HealthReportResource.CreateResourceIdentifier(resourceId, healthReportName);
            HealthReportResource healthReport = client.GetHealthReportResource(healthReportResourceId);

            // invoke the operation
            HealthReportResource result = await healthReport.GetAsync();
