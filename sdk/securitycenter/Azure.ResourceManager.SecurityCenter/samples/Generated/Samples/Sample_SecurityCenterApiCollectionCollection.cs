...
namespace Azure.ResourceManager.SecurityCenter.Samples
{
    public partial class Sample_SecurityCenterApiCollectionCollection
    {
        ...
        public async Task GetAll_GetsAListOfAzureAPIManagementAPIsThatHaveBeenOnboardedToMicrosoftDefenderForAPIs()
        {
            ...
            // this example is just showing the usage of "APICollections_ListByAzureApiManagementService" operation, for the dependent resources, they will have to be created separately.
            ...
            // get the collection of this SecurityCenterApiCollectionResource
            string serviceName = "apimService1";
            SecurityCenterApiCollectionCollection collection = resourceGroupResource.GetSecurityCenterApiCollections(serviceName);

            // invoke the operation and iterate over the result
            await foreach (SecurityCenterApiCollectionResource item in collection.GetAllAsync())
            {
        ...
        public async Task Get_GetsAnAzureAPIManagementAPIIfItHasBeenOnboardedToMicrosoftDefenderForAPIs()
        {
            ...
            SecurityCenterApiCollectionResource result = await collection.GetAsync(apiId);
        ...
        public async Task GetIfExists_GetsAnAzureAPIManagementAPIIfItHasBeenOnboardedToMicrosoftDefenderForAPIs()
        {
            ...
            // invoke the operation
            string apiId = "echo-api";
            NullableResponse<SecurityCenterApiCollectionResource> response = await collection.GetIfExistsAsync(apiId);
            SecurityCenterApiCollectionResource result = response.HasValue ? response.Value : null;
        ...
        public async Task CreateOrUpdate_OnboardAnAzureAPIManagementAPIToMicrosoftDefenderForAPIs()
        {
            ...
            // invoke the operation
            string apiId = "echo-api";
            ArmOperation<SecurityCenterApiCollectionResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, apiId);
