...
{
    public partial class Sample_SecurityConnectorGitLabProjectCollection
    {
        // List_GitLabProjects
        ...
        public async Task GetAll_ListGitLabProjects()
        {
            ...
            // get the collection of this SecurityConnectorGitLabProjectResource
            SecurityConnectorGitLabProjectCollection collection = securityConnectorGitLabGroup.GetSecurityConnectorGitLabProjects();

            // invoke the operation and iterate over the result
            await foreach (SecurityConnectorGitLabProjectResource item in collection.GetAllAsync())
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                SecurityConnectorGitLabProjectData resourceData = item.Data;
        ...
        public async Task Get_GetGitLabProjects()
        {
            ...
            SecurityConnectorGitLabProjectResource result = await collection.GetAsync(projectName);
        ...
        public async Task GetIfExists_GetGitLabProjects()
        {
            ...
            // invoke the operation
            string projectName = "myGitLabProject";
            NullableResponse<SecurityConnectorGitLabProjectResource> response = await collection.GetIfExistsAsync(projectName);
            SecurityConnectorGitLabProjectResource result = response.HasValue ? response.Value : null;
