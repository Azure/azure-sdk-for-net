...
namespace Azure.ResourceManager.SecurityCenter
{
    ...
    public partial class SubscriptionAssessmentMetadataCollection : ArmCollection, IEnumerable<SubscriptionAssessmentMetadataResource>, IAsyncEnumerable<SubscriptionAssessmentMetadataResource>
    {
        ...
        public virtual AsyncPageable<SubscriptionAssessmentMetadataResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => { var data = SecurityAssessmentMetadataData.DeserializeSecurityAssessmentMetadataData(e); return new SubscriptionAssessmentMetadataResource(Client, data, data.Id); }, _subscriptionAssessmentMetadataAssessmentsMetadataClientDiagnostics, Pipeline, "SubscriptionAssessmentMetadataCollection.GetAll", "value", "nextLink", cancellationToken);
        }
