...
namespace Azure.ResourceManager.SecurityCenter
{
    ...
    public partial class DiscoveredSecuritySolutionResource : ArmResource
    {
        ...
        public static ResourceIdentifier CreateResourceIdentifier(string subscriptionId, string resourceGroupName, AzureLocation ascLocation, string discoveredSecuritySolutionName)
        {
        ...
        public virtual async Task<Response<DiscoveredSecuritySolutionResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _discoveredSecuritySolutionRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, new AzureLocation(Id.Parent.Name), Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<DiscoveredSecuritySolutionResource> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _discoveredSecuritySolutionRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, new AzureLocation(Id.Parent.Name), Id.Name, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new DiscoveredSecuritySolutionResource(Client, response.Value), response.GetRawResponse());
            }
