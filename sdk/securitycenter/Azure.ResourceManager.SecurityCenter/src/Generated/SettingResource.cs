...
namespace Azure.ResourceManager.SecurityCenter
{
    ...
    /// Otherwise you can get one from its parent resource <see cref="SubscriptionResource" /> using the GetSetting method.
    /// </summary>
    public partial class SettingResource : ArmResource
    {
        ...
        {
            _settingClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.SecurityCenter", ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<Response<SettingResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _settingRestClient.GetAsync(Id.SubscriptionId, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<SettingResource> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _settingRestClient.Get(Id.SubscriptionId, Id.Name, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new SettingResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        public virtual async Task<ArmOperation<SettingResource>> UpdateAsync(WaitUntil waitUntil, SettingData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _settingRestClient.UpdateAsync(Id.SubscriptionId, Id.Name, data, cancellationToken).ConfigureAwait(false);
        ...
        public virtual ArmOperation<SettingResource> Update(WaitUntil waitUntil, SettingData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _settingRestClient.Update(Id.SubscriptionId, Id.Name, data, cancellationToken);
                var operation = new SecurityCenterArmOperation<SettingResource>(Response.FromValue(new SettingResource(Client, response), response.GetRawResponse()));
                if (waitUntil == WaitUntil.Completed)
