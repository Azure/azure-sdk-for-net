...
namespace Azure.ResourceManager.SecurityCenter
{
    ...
    /// </summary>
    public partial class SubscriptionGovernanceRuleResource : GovernanceRuleResource
    {
        ...
        internal SubscriptionGovernanceRuleResource(ArmClient client, GovernanceRuleData data) : base(client, data)
        {
        ...
        protected override async Task<Response<GovernanceRuleResource>> GetCoreAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue((GovernanceRuleResource)new SubscriptionGovernanceRuleResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public new async Task<Response<SubscriptionGovernanceRuleResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            var result = await GetCoreAsync(cancellationToken).ConfigureAwait(false);
            return Response.FromValue((SubscriptionGovernanceRuleResource)result.Value, result.GetRawResponse());
        }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public new Response<SubscriptionGovernanceRuleResource> Get(CancellationToken cancellationToken = default)
        {
        ...
        protected override async Task<ArmOperation<GovernanceRuleResource>> UpdateCoreAsync(WaitUntil waitUntil, GovernanceRuleData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new SecurityCenterArmOperation<GovernanceRuleResource>(Response.FromValue((GovernanceRuleResource)new SubscriptionGovernanceRuleResource(Client, response), response.GetRawResponse()));
                if (waitUntil == WaitUntil.Completed)
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        protected override ArmOperation<GovernanceRuleResource> UpdateCore(WaitUntil waitUntil, GovernanceRuleData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<ArmOperation> RuleIdExecuteSingleSubscriptionAsync(WaitUntil waitUntil, ExecuteGovernanceRuleParams executeGovernanceRuleParams = null, CancellationToken cancellationToken = default)
        {
            using var scope = _subscriptionGovernanceRuleGovernanceRulesClientDiagnostics.CreateScope("SubscriptionGovernanceRuleResource.RuleIdExecuteSingleSubscription");
            scope.Start();
            try
            {
        ...
        /// <param name="executeGovernanceRuleParams"> GovernanceRule over a subscription scope. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual ArmOperation RuleIdExecuteSingleSubscription(WaitUntil waitUntil, ExecuteGovernanceRuleParams executeGovernanceRuleParams = null, CancellationToken cancellationToken = default)
        {
            using var scope = _subscriptionGovernanceRuleGovernanceRulesClientDiagnostics.CreateScope("SubscriptionGovernanceRuleResource.RuleIdExecuteSingleSubscription");
            scope.Start();
            try
        ...
        public virtual async Task<ArmOperation<ExecuteRuleStatus>> GetSubscriptionGovernanceRulesExecuteStatuAsync(WaitUntil waitUntil, string operationId, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(operationId, nameof(operationId));

            using var scope = _subscriptionGovernanceRulesExecuteStatusClientDiagnostics.CreateScope("SubscriptionGovernanceRuleResource.GetSubscriptionGovernanceRulesExecuteStatu");
            scope.Start();
            try
            {
        ...
        /// <exception cref="ArgumentException"> <paramref name="operationId"/> is an empty string, and was expected to be non-empty. </exception>
        /// <exception cref="ArgumentNullException"> <paramref name="operationId"/> is null. </exception>
        public virtual ArmOperation<ExecuteRuleStatus> GetSubscriptionGovernanceRulesExecuteStatu(WaitUntil waitUntil, string operationId, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(operationId, nameof(operationId));
