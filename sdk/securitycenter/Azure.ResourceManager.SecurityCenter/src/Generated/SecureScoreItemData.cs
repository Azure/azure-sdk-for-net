...
{
    /// <summary> A class representing the SecureScoreItem data model. </summary>
    public partial class SecureScoreItemData : ResourceData
    {
        /// <summary> Initializes a new instance of SecureScoreItemData. </summary>
        ...
        internal SecureScoreItemData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string displayName, long? weight, int? max, double? current, double? percentage) : base(id, name, resourceType, systemData)
        {
