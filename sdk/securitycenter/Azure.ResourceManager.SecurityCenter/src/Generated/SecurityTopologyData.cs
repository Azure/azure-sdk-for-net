...
namespace Azure.ResourceManager.SecurityCenter
{
    ...
    public partial class SecurityTopologyData : ResourceData
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="SecurityTopologyData"/>. </summary>
        internal SecurityTopologyData()
        {
        }
        ...
        internal SecurityTopologyData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, TopologyResourceProperties properties, AzureLocation location, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, name, resourceType, systemData)
        {
