...
namespace Azure.ResourceManager.SecurityCenter
{
    ...
    public partial class AzureDevOpsOrgData : ResourceData
    {
        ...
        internal AzureDevOpsOrgData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, AzureDevOpsOrgProperties properties) : base(id, name, resourceType, systemData)
        {
