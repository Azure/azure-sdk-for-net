...
namespace Azure.ResourceManager.SecurityCenter
{
    ...
    public partial class AdaptiveNetworkHardeningData : ResourceData
    {
        ...
        internal AdaptiveNetworkHardeningData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IList<RecommendedSecurityRule> rules, DateTimeOffset? rulesCalculatedOn, IList<EffectiveNetworkSecurityGroups> effectiveNetworkSecurityGroups, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData)
        {
            Rules = rules;
