...
namespace Azure.ResourceManager.SecurityCenter
{
    ...
    public partial class AzureDevOpsProjectData : ResourceData
    {
        ...
        internal AzureDevOpsProjectData(Core.ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, AzureDevOpsProjectProperties properties) : base(id, name, resourceType, systemData)
        {
