...
namespace Azure.ResourceManager.SecurityCenter
{
    ...
    public partial class SubscriptionSecurityAlertResource : ArmResource
    {
        ...
        internal SubscriptionSecurityAlertResource(ArmClient client, SecurityAlertData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<SubscriptionSecurityAlertResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new SubscriptionSecurityAlertResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
