...
namespace Azure.ResourceManager.SecurityCenter
{
    ...
    {
        private static IJsonModel<SecurityAutomationData> s_dataDeserializationInstance;

        private static IJsonModel<SecurityAutomationData> DataDeserializationInstance => s_dataDeserializationInstance ??= new SecurityAutomationData();
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        SecurityAutomationData IJsonModel<SecurityAutomationData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => DataDeserializationInstance.Create(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<SecurityAutomationData>.GetFormatFromOptions(ModelReaderWriterOptions options) => DataDeserializationInstance.GetFormatFromOptions(options);
    }
}
