...
namespace Azure.ResourceManager.SecurityCenter
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="ResourceGroupSecurityTaskResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="ResourceGroupResource"/> using the GetResourceGroupSecurityTasks method.
    /// </summary>
    public partial class ResourceGroupSecurityTaskResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of ResourceGroupSecurityTaskResource for mocking. </summary>
        ...
        {
            TryGetApiVersion(ResourceType, out string resourceGroupSecurityTaskApiVersion);
        ...
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Security/locations/{ascLocation}/tasks/{taskName}/{taskUpdateActionType}. </description>
        /// </item>
        /// <item>
        /// <term> Operation Id. </term>
        /// <description> Tasks_UpdateResourceGroupLevelTaskState. </description>
        /// </item>
        /// <item>
        /// <term> Default Api Version. </term>
        /// <description> 2015-06-01-preview. </description>
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response> UpdateResourceGroupLevelTaskStateAsync(TaskUpdateActionType taskUpdateActionType, CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _tasksClientDiagnostics.CreateScope("ResourceGroupSecurityTaskResource.UpdateResourceGroupLevelTaskState");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _tasksRestClient.CreateUpdateResourceGroupLevelTaskStateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, taskUpdateActionType.ToString(), context);
        ...
        /// <param name="taskUpdateActionType"> Type of the action to do on the task. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response UpdateResourceGroupLevelTaskState(TaskUpdateActionType taskUpdateActionType, CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _tasksClientDiagnostics.CreateScope("ResourceGroupSecurityTaskResource.UpdateResourceGroupLevelTaskState");
            scope.Start();
            try
