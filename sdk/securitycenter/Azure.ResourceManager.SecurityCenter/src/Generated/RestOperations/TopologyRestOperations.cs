...
namespace Azure.ResourceManager.SecurityCenter
{
    internal partial class Topology
    {
        ...
        internal Topology(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Uri endpoint, string apiVersion)
        {
        ...
        internal HttpMessage CreateGetTopologyResourcesRequest(Guid subscriptionId, RequestContext context)
        {
            RawRequestUriBuilder uri = new RawRequestUriBuilder();
            uri.Reset(_endpoint);
            uri.AppendPath("/subscriptions/", false);
        ...
        internal HttpMessage CreateNextGetTopologyResourcesRequest(Uri nextPage, Guid subscriptionId, RequestContext context)
        {
            RawRequestUriBuilder uri = new RawRequestUriBuilder();
            if (nextPage.IsAbsoluteUri)
            {
