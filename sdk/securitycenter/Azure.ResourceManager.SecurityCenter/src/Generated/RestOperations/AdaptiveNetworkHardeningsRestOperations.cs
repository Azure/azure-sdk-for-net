...
namespace Azure.ResourceManager.SecurityCenter
{
    internal partial class AdaptiveNetworkHardeningsRestOperations
    {
        ...
        public async Task<Response> EnforceAsync(HttpMessage message, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="message"/> is null. </exception>
        public Response Enforce(HttpMessage message, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(message, nameof(message));
