...
namespace Azure.ResourceManager.SecurityCenter
{
    internal partial class ComplianceResults
    {
        ...
        internal ComplianceResults(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string applicationId, Uri endpoint, string apiVersion)
        {
            ClientDiagnostics = clientDiagnostics;
            _endpoint = endpoint;
            Pipeline = pipeline;
            _apiVersion = apiVersion;
            _userAgent = new TelemetryDetails(typeof(ComplianceResults).Assembly, applicationId);
        }
