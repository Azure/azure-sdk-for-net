...
namespace Azure.ResourceManager.SecurityCenter
{
    ...
    public partial class SubscriptionSecurityApplicationResource : ArmResource
    {
        ...
        internal SubscriptionSecurityApplicationResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _applicationRestClient = new Application(_applicationClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, subscriptionSecurityApplicationApiVersion ?? "2022-07-01-preview");
        ...
        public virtual async Task<ArmOperation<SubscriptionSecurityApplicationResource>> UpdateAsync(WaitUntil waitUntil, SecurityApplicationData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _applicationRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.Name, SecurityApplicationData.ToRequestContent(data), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<SecurityApplicationData> response = Response.FromValue(SecurityApplicationData.FromResponse(result), result);
                RequestUriBuilder uri = message.Request.Uri;
