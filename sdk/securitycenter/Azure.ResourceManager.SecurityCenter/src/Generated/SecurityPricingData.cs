...
{
    /// <summary> A class representing the SecurityPricing data model. </summary>
    public partial class SecurityPricingData : ResourceData
    {
        /// <summary> Initializes a new instance of SecurityPricingData. </summary>
        ...
        internal SecurityPricingData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, SecurityPricingTier? pricingTier, string subPlan, TimeSpan? freeTrialRemainingTime, bool? isDeprecated, IReadOnlyList<string> replacedBy) : base(id, name, resourceType, systemData)
        {
        ...
        public SecurityPricingTier? PricingTier { get; set; }
