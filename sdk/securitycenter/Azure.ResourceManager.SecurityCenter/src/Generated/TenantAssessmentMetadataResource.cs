...
namespace Azure.ResourceManager.SecurityCenter
{
    ...
    public partial class TenantAssessmentMetadataResource : SecurityAssessmentMetadataResponseResource
    {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public new virtual async Task<Response<TenantAssessmentMetadataResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            var value = await GetCoreAsync(cancellationToken).ConfigureAwait(false);
            return Response.FromValue((TenantAssessmentMetadataResource)value.Value, value.GetRawResponse());
        }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public new virtual Response<TenantAssessmentMetadataResource> Get(CancellationToken cancellationToken = default)
        {
