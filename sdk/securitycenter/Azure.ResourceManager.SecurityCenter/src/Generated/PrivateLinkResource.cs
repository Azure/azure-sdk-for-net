...
namespace Azure.ResourceManager.SecurityCenter
{
    ...
    public partial class PrivateLinkResource : ArmResource
    {
        ...
        /// <summary>
        /// Updates the PrivateLinkResource.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Security/privateLinks/{privateLinkName}. </description>
        ...
        public virtual async Task<ArmOperation<PrivateLinkResource>> UpdateAsync(WaitUntil waitUntil, SecurityCenterPrivateLinkResourceData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _privateLinksRestClient.CreateCreateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, SecurityCenterPrivateLinkResourceData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<PrivateLinkResource> Update(WaitUntil waitUntil, SecurityCenterPrivateLinkResourceData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
