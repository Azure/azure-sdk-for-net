...
namespace Azure.ResourceManager.SecurityCenter
{
    ...
    public partial class SecurityTaskData : ResourceData
    {
        ...
        internal SecurityTaskData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, SecurityTaskPropertiesInfo properties) : base(id, name, resourceType, systemData)
        {
        ...
        internal SecurityTaskPropertiesInfo Properties { get; set; }
