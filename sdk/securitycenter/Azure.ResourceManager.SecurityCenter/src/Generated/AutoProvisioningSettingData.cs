...
namespace Azure.ResourceManager.SecurityCenter
{
    ...
    public partial class AutoProvisioningSettingData : ResourceData
    {
        ...
        internal AutoProvisioningSettingData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, AutoProvisioningSettingProperties properties, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, name, resourceType, systemData)
        {
