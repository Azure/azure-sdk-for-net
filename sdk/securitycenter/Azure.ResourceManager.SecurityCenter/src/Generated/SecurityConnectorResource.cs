...
namespace Azure.ResourceManager.SecurityCenter
{
    ...
    public partial class SecurityConnectorResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<SecurityConnectorResource>> UpdateAsync(WaitUntil waitUntil, SecurityConnectorData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
            ...
            try
            {
                ...
                HttpMessage message = _securityConnectorsRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, SecurityConnectorData.ToRequestContent(data), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<SecurityConnectorData> response = Response.FromValue(SecurityConnectorData.FromResponse(result), result);
                RequestUriBuilder uri = message.Request.Uri;
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<SecurityConnectorResource> Update(WaitUntil waitUntil, SecurityConnectorData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
