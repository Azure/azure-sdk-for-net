...
namespace Azure.ResourceManager.SecurityCenter
{
    ...
    public partial class IotSecuritySolutionData : TrackedResourceData, IJsonModel<IotSecuritySolutionData>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<IotSecuritySolutionData>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<IotSecuritySolutionData>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        IotSecuritySolutionData IPersistableModel<IotSecuritySolutionData>.Create(BinaryData data, ModelReaderWriterOptions options) => (IotSecuritySolutionData)PersistableModelCreateCore(data, options);

        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<IotSecuritySolutionData>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";

        /// <param name="iotSecuritySolutionData"> The <see cref="IotSecuritySolutionData"/> to serialize into <see cref="RequestContent"/>. </param>
        internal static RequestContent ToRequestContent(IotSecuritySolutionData iotSecuritySolutionData)
        {
            if (iotSecuritySolutionData == null)
            {
                return null;
            }
            return RequestContent.Create(iotSecuritySolutionData, ModelSerializationExtensions.WireOptions);
        }

        /// <param name="response"> The <see cref="Response"/> to deserialize the <see cref="IotSecuritySolutionData"/> from. </param>
        internal static IotSecuritySolutionData FromResponse(Response response)
        {
            using JsonDocument document = JsonDocument.Parse(response.Content, ModelSerializationExtensions.JsonDocumentOptions);
            return DeserializeIotSecuritySolutionData(document.RootElement, ModelSerializationExtensions.WireOptions);
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        IotSecuritySolutionData IJsonModel<IotSecuritySolutionData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (IotSecuritySolutionData)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static IotSecuritySolutionData DeserializeIotSecuritySolutionData(JsonElement element, ModelReaderWriterOptions options)
        {
