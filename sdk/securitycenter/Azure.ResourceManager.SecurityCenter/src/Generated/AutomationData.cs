...
{
    /// <summary> A class representing the Automation data model. </summary>
    public partial class AutomationData : TrackedResourceData
    {
        /// <summary> Initializes a new instance of AutomationData. </summary>
        /// <param name="location"> The location. </param>
        public AutomationData(AzureLocation location) : base(location)
        {
        ...
        internal AutomationData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, string description, bool? isEnabled, IList<AutomationScope> scopes, IList<AutomationSource> sources, IList<AutomationAction> actions, string kind, ETag? eTag) : base(id, name, resourceType, systemData, tags, location)
        {
        ...
        public IList<AutomationSource> Sources { get; }
        /// <summary>
        /// A collection of the actions which are triggered if all the configured rules evaluations, within at least one rule set, are true.
        /// Please note <see cref="AutomationAction"/> is the base class. According to the scenario, a derived class of the base class might need to be assigned here, or this property needs to be casted to one of the possible derived classes.
        /// The available derived classes include <see cref="AutomationActionEventHub"/>, <see cref="AutomationActionLogicApp"/> and <see cref="AutomationActionWorkspace"/>.
