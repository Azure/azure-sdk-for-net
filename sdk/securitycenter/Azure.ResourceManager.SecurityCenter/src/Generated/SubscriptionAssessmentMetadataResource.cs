...
namespace Azure.ResourceManager.SecurityCenter
{
    ...
    public partial class SubscriptionAssessmentMetadataResource : SecurityAssessmentMetadataResponseResource
    {
        ...
        {
            using var scope = _subscriptionAssessmentMetadataAssessmentsMetadataClientDiagnostics.CreateScope("SubscriptionAssessmentMetadataResource.GetCore");
            scope.Start();
            try
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public new async Task<Response<SubscriptionAssessmentMetadataResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            var result = await GetCoreAsync(cancellationToken).ConfigureAwait(false);
            return Response.FromValue((SubscriptionAssessmentMetadataResource)result.Value, result.GetRawResponse());
        }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public new Response<SubscriptionAssessmentMetadataResource> Get(CancellationToken cancellationToken = default)
        {
