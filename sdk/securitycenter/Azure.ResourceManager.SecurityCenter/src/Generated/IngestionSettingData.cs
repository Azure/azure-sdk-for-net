...
namespace Azure.ResourceManager.SecurityCenter
{
    ...
    public partial class IngestionSettingData : ResourceData
    {
        ...
        internal IngestionSettingData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, BinaryData properties, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
