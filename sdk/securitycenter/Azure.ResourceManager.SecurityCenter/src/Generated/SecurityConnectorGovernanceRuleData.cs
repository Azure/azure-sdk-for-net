...
namespace Azure.ResourceManager.SecurityCenter
{
    ...
    public partial class SecurityConnectorGovernanceRuleData : ResourceData
    {
        ...
        internal SecurityConnectorGovernanceRuleData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, GovernanceRuleProperties properties) : base(id, name, resourceType, systemData)
        {
