...
namespace Azure.ResourceManager.SecurityCenter
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="SecurityCenterPricingResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="ArmResource"/> using the GetSecurityCenterPricings method.
    /// </summary>
    public partial class SecurityCenterPricingResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of SecurityCenterPricingResource for mocking. </summary>
        protected SecurityCenterPricingResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="SecurityCenterPricingResource"/> class. </summary>
        ...
        {
            using DiagnosticScope scope = _pricingsClientDiagnostics.CreateScope("SecurityCenterPricingResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _pricingsRestClient.CreateGetRequest(Id.Parent.ToString(), Id.Name, context);
        ...
        /// <item>
        /// <term> Operation Id. </term>
        /// <description> Pricings_Delete. </description>
        /// </item>
        /// <item>
        /// <term> Default Api Version. </term>
        /// <description> 2024-01-01. </description>
        ...
        {
            using DiagnosticScope scope = _pricingsClientDiagnostics.CreateScope("SecurityCenterPricingResource.Delete");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _pricingsRestClient.CreateDeleteRequest(Id.Parent.ToString(), Id.Name, context);
        ...
        /// <summary>
        /// Update a SecurityCenterPricing.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /{scopeId}/providers/Microsoft.Security/pricings/{pricingName}. </description>
        ...
        public virtual async Task<ArmOperation<SecurityCenterPricingResource>> UpdateAsync(WaitUntil waitUntil, SecurityCenterPricingData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _pricingsClientDiagnostics.CreateScope("SecurityCenterPricingResource.Update");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _pricingsRestClient.CreateUpdateRequest(Id.Parent.ToString(), Id.Name, SecurityCenterPricingData.ToRequestContent(data), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<SecurityCenterPricingData> response = Response.FromValue(SecurityCenterPricingData.FromResponse(result), result);
                RequestUriBuilder uri = message.Request.Uri;
