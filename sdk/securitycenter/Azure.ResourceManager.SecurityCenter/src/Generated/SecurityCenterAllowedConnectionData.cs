...
namespace Azure.ResourceManager.SecurityCenter
{
    ...
    public partial class SecurityCenterAllowedConnectionData : ResourceData
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="SecurityCenterAllowedConnectionData"/>. </summary>
        internal SecurityCenterAllowedConnectionData()
        {
        }
        ...
        internal SecurityCenterAllowedConnectionData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, AllowedConnectionsResourceProperties properties, AzureLocation location, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, name, resourceType, systemData)
        {
