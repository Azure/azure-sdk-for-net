...
namespace Azure.ResourceManager.SecurityCenter
{
    ...
    public partial class SecurityCenterAllowedConnectionData : ResourceData
    {
        ...
        internal SecurityCenterAllowedConnectionData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, AllowedConnectionsResourceProperties properties, string location, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, name, resourceType, systemData)
        {
