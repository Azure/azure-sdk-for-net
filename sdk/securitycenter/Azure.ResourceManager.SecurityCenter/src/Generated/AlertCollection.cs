...
namespace Azure.ResourceManager.SecurityCenter
{
    ...
    public partial class AlertCollection : ArmCollection, IEnumerable<AlertResource>, IAsyncEnumerable<AlertResource>
    {
        ...
        internal AlertCollection(ArmClient client, ResourceIdentifier id, string ascLocation) : base(client, id)
        {
            this.TryGetApiVersion(AlertResource.ResourceType, out string alertApiVersion);
            _ascLocation = ascLocation;
            _alertsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.SecurityCenter", AlertResource.ResourceType.Namespace, Diagnostics);
            _alertsRestClient = new Alerts(_alertsClientDiagnostics, Pipeline, Endpoint, alertApiVersion ?? "2022-01-01");
            AlertCollection.ValidateResourceId(id);
        }
        ...
        internal virtual async Task<Response<AlertResource>> GetAsync(string alertName, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="alertName"> Name of the alert object. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        internal virtual Response<AlertResource> Get(string alertName, CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _alertsClientDiagnostics.CreateScope("AlertCollection.Get");
            scope.Start();
            try
        ...
        public virtual AsyncPageable<AlertResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<ResourceGroupSecurityAlertData, AlertResource>(new AlertsGetResourceGroupLevelByRegionAsyncCollectionResultOfT(
                _alertsRestClient,
                Guid.Parse(Id.SubscriptionId),
                Id.ResourceGroupName,
                _ascLocation,
                context,
                "AlertCollection.GetAll"), data => new AlertResource(Client, data));
        }
        ...
        public virtual Pageable<AlertResource> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            return new PageableWrapper<ResourceGroupSecurityAlertData, AlertResource>(new AlertsGetResourceGroupLevelByRegionCollectionResultOfT(
                _alertsRestClient,
                Guid.Parse(Id.SubscriptionId),
                Id.ResourceGroupName,
                _ascLocation,
        ...
        /// <param name="alertName"> Name of the alert object. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        internal virtual async Task<NullableResponse<AlertResource>> GetIfExistsAsync(string alertName, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="alertName"> Name of the alert object. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        internal virtual NullableResponse<AlertResource> GetIfExists(string alertName, CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _alertsClientDiagnostics.CreateScope("AlertCollection.GetIfExists");
            scope.Start();
            try
