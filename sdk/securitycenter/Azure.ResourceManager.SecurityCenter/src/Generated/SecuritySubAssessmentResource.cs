...
namespace Azure.ResourceManager.SecurityCenter
{
    ...
    /// Otherwise you can get one from its parent resource <see cref="SecurityAssessmentResource"/> using the GetSecuritySubAssessments method.
    /// </summary>
    public partial class SecuritySubAssessmentResource : ArmResource
    {
        ...
        internal SecuritySubAssessmentResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _subAssessmentsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.SecurityCenter", ResourceType.Namespace, Diagnostics);
