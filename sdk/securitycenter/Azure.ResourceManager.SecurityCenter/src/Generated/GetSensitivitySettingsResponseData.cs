...
namespace Azure.ResourceManager.SecurityCenter
{
    ...
    public partial class GetSensitivitySettingsResponseData : ResourceData
    {
        ...
        internal GetSensitivitySettingsResponseData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, GetSensitivitySettingsResponseProperties properties) : base(id, name, resourceType, systemData)
        {
