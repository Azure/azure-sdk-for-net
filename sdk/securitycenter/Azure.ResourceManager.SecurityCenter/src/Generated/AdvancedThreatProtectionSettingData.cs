...
namespace Azure.ResourceManager.SecurityCenter
{
    ...
    public partial class AdvancedThreatProtectionSettingData : ResourceData
    {
        ...
        internal AdvancedThreatProtectionSettingData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, AdvancedThreatProtectionProperties properties, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, name, resourceType, systemData)
        {
