...
namespace Azure.ResourceManager.SecurityCenter.Testing
{
    /// <summary> A class to add extension methods to ResourceGroupResource. </summary>
    public partial class SecurityCenterResourceGroupResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="SecurityCenterResourceGroupResourceExtension"/> class for mocking. </summary>
        protected SecurityCenterResourceGroupResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="SecurityCenterResourceGroupResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal SecurityCenterResourceGroupResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        {
            using var scope = AllowedConnectionsClientDiagnostics.CreateScope("SecurityCenterResourceGroupResourceExtension.GetAllowedConnection");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response<SecurityTopologyResource>> GetTopologyAsync(AzureLocation ascLocation, string topologyResourceName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = TopologyClientDiagnostics.CreateScope("SecurityCenterResourceGroupResourceExtension.GetTopology");
            scope.Start();
            try
            {
        ...
        public virtual AsyncPageable<JitNetworkAccessPolicyResource> GetJitNetworkAccessPoliciesAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new JitNetworkAccessPolicyResource(Client, JitNetworkAccessPolicyData.DeserializeJitNetworkAccessPolicyData(e)), JitNetworkAccessPolicyClientDiagnostics, Pipeline, "SecurityCenterResourceGroupResourceExtension.GetJitNetworkAccessPolicies", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<JitNetworkAccessPolicyResource> GetJitNetworkAccessPolicies(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => JitNetworkAccessPolicyRestClient.CreateListByResourceGroupRequest(Id.SubscriptionId, Id.ResourceGroupName);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => JitNetworkAccessPolicyRestClient.CreateListByResourceGroupNextPageRequest(nextLink, Id.SubscriptionId, Id.ResourceGroupName);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new JitNetworkAccessPolicyResource(Client, JitNetworkAccessPolicyData.DeserializeJitNetworkAccessPolicyData(e)), JitNetworkAccessPolicyClientDiagnostics, Pipeline, "SecurityCenterResourceGroupResourceExtension.GetJitNetworkAccessPolicies", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual async Task<Response<DiscoveredSecuritySolution>> GetDiscoveredSecuritySolutionAsync(AzureLocation ascLocation, string discoveredSecuritySolutionName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = DiscoveredSecuritySolutionsClientDiagnostics.CreateScope("SecurityCenterResourceGroupResourceExtension.GetDiscoveredSecuritySolution");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response<ExternalSecuritySolution>> GetExternalSecuritySolutionAsync(AzureLocation ascLocation, string externalSecuritySolutionsName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = ExternalSecuritySolutionsClientDiagnostics.CreateScope("SecurityCenterResourceGroupResourceExtension.GetExternalSecuritySolution");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response<SecuritySolution>> GetSecuritySolutionAsync(AzureLocation ascLocation, string securitySolutionName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = SecuritySolutionsClientDiagnostics.CreateScope("SecurityCenterResourceGroupResourceExtension.GetSecuritySolution");
            scope.Start();
            try
            {
        ...
        public virtual AsyncPageable<SecurityAlertData> GetAlertsByResourceGroupAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, SecurityAlertData.DeserializeSecurityAlertData, AlertsClientDiagnostics, Pipeline, "SecurityCenterResourceGroupResourceExtension.GetAlertsByResourceGroup", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<SecurityAlertData> GetAlertsByResourceGroup(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => AlertsRestClient.CreateListByResourceGroupRequest(Id.SubscriptionId, Id.ResourceGroupName);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => AlertsRestClient.CreateListByResourceGroupNextPageRequest(nextLink, Id.SubscriptionId, Id.ResourceGroupName);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, SecurityAlertData.DeserializeSecurityAlertData, AlertsClientDiagnostics, Pipeline, "SecurityCenterResourceGroupResourceExtension.GetAlertsByResourceGroup", "value", "nextLink", cancellationToken);
        }
    }
}
