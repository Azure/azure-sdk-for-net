...
namespace Azure.ResourceManager.SecurityCenter.Mock
{
    ...
    public partial class CustomEntityStoreAssignmentResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="CustomEntityStoreAssignmentResourceExtension"/> class for mocking. </summary>
        protected CustomEntityStoreAssignmentResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="CustomEntityStoreAssignmentResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal CustomEntityStoreAssignmentResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<CustomEntityStoreAssignmentResource> GetCustomEntityStoreAssignmentsAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new CustomEntityStoreAssignmentResource(Client, CustomEntityStoreAssignmentData.DeserializeCustomEntityStoreAssignmentData(e)), CustomEntityStoreAssignmentClientDiagnostics, Pipeline, "CustomEntityStoreAssignmentResourceExtension.GetCustomEntityStoreAssignments", "value", "nextLink", cancellationToken);
        }
