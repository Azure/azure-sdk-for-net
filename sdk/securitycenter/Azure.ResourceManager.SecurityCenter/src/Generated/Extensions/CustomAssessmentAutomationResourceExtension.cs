...
namespace Azure.ResourceManager.SecurityCenter.Mock
{
    ...
    public partial class CustomAssessmentAutomationResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="CustomAssessmentAutomationResourceExtension"/> class for mocking. </summary>
        protected CustomAssessmentAutomationResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="CustomAssessmentAutomationResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal CustomAssessmentAutomationResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
