...
namespace Azure.ResourceManager.SecurityCenter.Mocking
{
    ...
    internal partial class SecurityCenterArmClientMockingExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="SecurityCenterArmClientMockingExtension"/> class for mocking. </summary>
        protected SecurityCenterArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="SecurityCenterArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal SecurityCenterArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal SecurityCenterArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
        ...
        {
            using var scope0 = InformationProtectionPoliciesClientDiagnostics.CreateScope("SecurityCenterArmClientMockingExtension.CreateOrUpdateInformationProtectionPolicy");
            scope0.Start();
            try
            {
        ...
        public virtual Pageable<InformationProtectionPolicy> GetInformationProtectionPolicies(ResourceIdentifier scope, CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => InformationProtectionPoliciesRestClient.CreateListRequest(scope);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => InformationProtectionPoliciesRestClient.CreateListNextPageRequest(nextLink, scope);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, InformationProtectionPolicy.DeserializeInformationProtectionPolicy, InformationProtectionPoliciesClientDiagnostics, Pipeline, "SecurityCenterArmClientMockingExtension.GetInformationProtectionPolicies", "value", "nextLink", cancellationToken);
        }
