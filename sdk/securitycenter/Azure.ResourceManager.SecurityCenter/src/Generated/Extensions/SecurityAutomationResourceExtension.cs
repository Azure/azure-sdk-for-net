...
namespace Azure.ResourceManager.SecurityCenter.Mock
{
    ...
    public partial class SecurityAutomationResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="SecurityAutomationResourceExtension"/> class for mocking. </summary>
        protected SecurityAutomationResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="SecurityAutomationResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal SecurityAutomationResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<SecurityAutomationResource> GetSecurityAutomationsAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new SecurityAutomationResource(Client, SecurityAutomationData.DeserializeSecurityAutomationData(e)), SecurityAutomationAutomationsClientDiagnostics, Pipeline, "SecurityAutomationResourceExtension.GetSecurityAutomations", "value", "nextLink", cancellationToken);
        }
