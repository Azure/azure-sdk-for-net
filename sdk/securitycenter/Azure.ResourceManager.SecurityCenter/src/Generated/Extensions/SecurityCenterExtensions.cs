...
namespace Azure.ResourceManager.SecurityCenter
{
    ...
    public static partial class SecurityCenterExtensions
    {
        ...
        private static SecurityAssessmentResourceExtension GetSecurityAssessmentResourceExtension(ArmResource resource)
        {
            return resource.GetCachedClient(client =>
            {
                return new SecurityAssessmentResourceExtension(client, resource.Id);
            });
        }

        private static SecurityAssessmentResourceExtension GetSecurityAssessmentResourceExtension(ArmClient client, ResourceIdentifier scope)
        {
            return client.GetResourceClient(() =>
            {
                return new SecurityAssessmentResourceExtension(client, scope);
            });
        }
        ...
        private static SecuritySubAssessmentResourceExtension GetSecuritySubAssessmentResourceExtension(ArmResource resource)
        {
            return resource.GetCachedClient(client =>
            {
                return new SecuritySubAssessmentResourceExtension(client, resource.Id);
            });
        }

        private static SecuritySubAssessmentResourceExtension GetSecuritySubAssessmentResourceExtension(ArmClient client, ResourceIdentifier scope)
        {
            return client.GetResourceClient(() =>
            {
                return new SecuritySubAssessmentResourceExtension(client, scope);
            });
        }
        ...
        {
            return GetSecuritySubAssessmentResourceExtension(client, scope).GetSecuritySubAssessmentsAsync(cancellationToken);
        }
        ...
        {
            return GetSecuritySubAssessmentResourceExtension(client, scope).GetSecuritySubAssessments(cancellationToken);
        }
        ...
        {
            return GetSecurityAssessmentResourceExtension(client, scope).GetSecurityAssessmentsAsync(cancellationToken);
        }
        ...
        {
            return GetSecurityAssessmentResourceExtension(client, scope).GetSecurityAssessments(cancellationToken);
        }
        ...
        {
            return GetSecurityCenterSubscriptionResourceExtension(subscriptionResource).GetSubscriptionGovernanceRules();
        }
