...
namespace Azure.ResourceManager.SecurityCenter.Mocking
{
    ...
    internal partial class SecurityCenterResourceGroupMockingExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="SecurityCenterResourceGroupMockingExtension"/> class for mocking. </summary>
        protected SecurityCenterResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="SecurityCenterResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal SecurityCenterResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        {
            using var scope = AllowedConnectionsClientDiagnostics.CreateScope("SecurityCenterResourceGroupMockingExtension.GetAllowedConnection");
            scope.Start();
            try
            {
        ...
        {
            using var scope = TopologyClientDiagnostics.CreateScope("SecurityCenterResourceGroupMockingExtension.GetTopology");
            scope.Start();
            try
            {
        ...
        public virtual AsyncPageable<JitNetworkAccessPolicyResource> GetJitNetworkAccessPoliciesAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new JitNetworkAccessPolicyResource(Client, JitNetworkAccessPolicyData.DeserializeJitNetworkAccessPolicyData(e)), JitNetworkAccessPolicyClientDiagnostics, Pipeline, "SecurityCenterResourceGroupMockingExtension.GetJitNetworkAccessPolicies", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<JitNetworkAccessPolicyResource> GetJitNetworkAccessPolicies(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => JitNetworkAccessPolicyRestClient.CreateListByResourceGroupRequest(Id.SubscriptionId, Id.ResourceGroupName);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => JitNetworkAccessPolicyRestClient.CreateListByResourceGroupNextPageRequest(nextLink, Id.SubscriptionId, Id.ResourceGroupName);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new JitNetworkAccessPolicyResource(Client, JitNetworkAccessPolicyData.DeserializeJitNetworkAccessPolicyData(e)), JitNetworkAccessPolicyClientDiagnostics, Pipeline, "SecurityCenterResourceGroupMockingExtension.GetJitNetworkAccessPolicies", "value", "nextLink", cancellationToken);
        }
        ...
        {
            using var scope = DiscoveredSecuritySolutionsClientDiagnostics.CreateScope("SecurityCenterResourceGroupMockingExtension.GetDiscoveredSecuritySolution");
            scope.Start();
            try
            {
        ...
        {
            using var scope = ExternalSecuritySolutionsClientDiagnostics.CreateScope("SecurityCenterResourceGroupMockingExtension.GetExternalSecuritySolution");
            scope.Start();
            try
            {
        ...
        {
            using var scope = SecuritySolutionsClientDiagnostics.CreateScope("SecurityCenterResourceGroupMockingExtension.GetSecuritySolution");
            scope.Start();
            try
            {
        ...
        public virtual AsyncPageable<SecurityAlertData> GetAlertsByResourceGroupAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, SecurityAlertData.DeserializeSecurityAlertData, AlertsClientDiagnostics, Pipeline, "SecurityCenterResourceGroupMockingExtension.GetAlertsByResourceGroup", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<SecurityAlertData> GetAlertsByResourceGroup(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => AlertsRestClient.CreateListByResourceGroupRequest(Id.SubscriptionId, Id.ResourceGroupName);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => AlertsRestClient.CreateListByResourceGroupNextPageRequest(nextLink, Id.SubscriptionId, Id.ResourceGroupName);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, SecurityAlertData.DeserializeSecurityAlertData, AlertsClientDiagnostics, Pipeline, "SecurityCenterResourceGroupMockingExtension.GetAlertsByResourceGroup", "value", "nextLink", cancellationToken);
        }
    }
}
