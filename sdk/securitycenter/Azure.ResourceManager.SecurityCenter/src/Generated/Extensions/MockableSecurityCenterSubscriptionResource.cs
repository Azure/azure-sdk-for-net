...
namespace Azure.ResourceManager.SecurityCenter.Mocking
{
    ...
    public partial class MockableSecurityCenterSubscriptionResource : ArmResource
    {
        ...
        private ClientDiagnostics _topologyResourcesClientDiagnostics;
        private TopologyResources _topologyResourcesRestClient;
        ...
        public virtual AsyncPageable<SecurityTopologyResource> GetSecurityTopologiesAsync(AzureLocation ascLocation, CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> A collection of <see cref="SecurityTopologyResource"/> that may take multiple service requests to iterate over. </returns>
        public virtual Pageable<SecurityTopologyResource> GetSecurityTopologies(AzureLocation ascLocation, CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<SecuritySolutionsReferenceInfoList>> GetAllSecuritySolutionsReferenceDataAsync(CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = SecuritySolutionsReferenceDataOperationGroupClientDiagnostics.CreateScope("MockableSecurityCenterSubscriptionResource.GetAllSecuritySolutionsReferenceData");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = SecuritySolutionsReferenceDataOperationGroupRestClient.CreateGetAllSecuritySolutionsReferenceDataRequest(Guid.Parse(Id.SubscriptionId), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<SecuritySolutionsReferenceInfoList> GetAllSecuritySolutionsReferenceData(CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = SecuritySolutionsReferenceDataOperationGroupClientDiagnostics.CreateScope("MockableSecurityCenterSubscriptionResource.GetAllSecuritySolutionsReferenceData");
            scope.Start();
            try
        ...
        public virtual AsyncPageable<ApiCollectionResource> GetSecurityCenterApiCollectionsAsync(CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> A collection of <see cref="ApiCollectionResource"/> that may take multiple service requests to iterate over. </returns>
        public virtual Pageable<ApiCollectionResource> GetSecurityCenterApiCollections(CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
