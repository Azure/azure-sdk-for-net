...
namespace Azure.ResourceManager.SecurityCenter.Mock
{
    ...
    public partial class AdaptiveApplicationControlGroupResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="AdaptiveApplicationControlGroupResourceExtension"/> class for mocking. </summary>
        protected AdaptiveApplicationControlGroupResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="AdaptiveApplicationControlGroupResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal AdaptiveApplicationControlGroupResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<AdaptiveApplicationControlGroupResource> GetAdaptiveApplicationControlGroupsAsync(bool? includePathRecommendations = null, bool? summary = null, CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, null, e => new AdaptiveApplicationControlGroupResource(Client, AdaptiveApplicationControlGroupData.DeserializeAdaptiveApplicationControlGroupData(e)), AdaptiveApplicationControlGroupAdaptiveApplicationControlsClientDiagnostics, Pipeline, "AdaptiveApplicationControlGroupResourceExtension.GetAdaptiveApplicationControlGroups", "value", null, cancellationToken);
        }
