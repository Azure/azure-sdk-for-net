...
namespace Azure.ResourceManager.SecurityCenter.Mocking
{
    ...
    public partial class MockableSecurityCenterArmClient : ArmResource
    {
        ...
        /// <summary> Gets an object representing a <see cref="SensitivitySettingResource"/> along with the instance operations that can be performed on it but with no data. </summary>
        /// <param name="id"> The resource ID of the resource to get. </param>
