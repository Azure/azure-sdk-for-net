    ...
    public partial class SubscriptionSecurityApplicationCollection : ArmCollection, IEnumerable<SubscriptionSecurityApplicationResource>, IAsyncEnumerable<SubscriptionSecurityApplicationResource>
    {
        ...
        public virtual async Task<ArmOperation<SubscriptionSecurityApplicationResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string applicationId, SecurityConnectorApplicationData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _applicationRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), applicationId, SecurityConnectorApplicationData.ToRequestContent(data), context);
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string applicationId, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                Response<SecurityConnectorApplicationData> response = default;
                switch (result.Status)
                {
                    case 200:
                        response = Response.FromValue(SecurityConnectorApplicationData.FromResponse(result), result);
                        break;
                    case 404:
                        response = Response.FromValue((SecurityConnectorApplicationData)null, result);
                        break;
                    default:
