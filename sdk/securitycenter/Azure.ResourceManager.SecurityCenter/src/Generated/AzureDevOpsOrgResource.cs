...
namespace Azure.ResourceManager.SecurityCenter
{
    ...
    public partial class AzureDevOpsOrgResource : ArmResource
    {
        ...
        internal AzureDevOpsOrgResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _azureDevOpsOrgsRestClient = new AzureDevOpsOrgs(_azureDevOpsOrgsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, azureDevOpsOrgApiVersion ?? "2025-11-01-preview");
        ...
        public virtual async Task<ArmOperation<AzureDevOpsOrgResource>> UpdateAsync(WaitUntil waitUntil, AzureDevOpsOrgData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                SecurityCenterArmOperation<AzureDevOpsOrgResource> operation = new SecurityCenterArmOperation<AzureDevOpsOrgResource>(
                    new AzureDevOpsOrgResourceOperationSource(Client),
