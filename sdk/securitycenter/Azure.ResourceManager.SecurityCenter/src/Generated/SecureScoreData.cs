...
namespace Azure.ResourceManager.SecurityCenter
{
    ...
    public partial class SecureScoreData : ResourceData
    {
        ...
        internal SecureScoreData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string displayName, long? weight, int? max, double? current, double? percentage, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData)
        {
