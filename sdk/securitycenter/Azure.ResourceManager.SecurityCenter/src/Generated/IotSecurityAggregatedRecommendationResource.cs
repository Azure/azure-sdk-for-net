...
namespace Azure.ResourceManager.SecurityCenter
{
    ...
    public partial class IotSecurityAggregatedRecommendationResource : ArmResource
    {
        ...
        internal IotSecurityAggregatedRecommendationResource(ArmClient client, IotSecurityAggregatedRecommendationData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
