...
namespace Azure.ResourceManager.SecurityCenter
{
    ...
    public partial class SecurityAutomationResource : ArmResource
    {
        ...
        internal SecurityAutomationResource(ArmClient client, SecurityAutomationData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<SecurityAutomationResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
                {
                    ...
                    return Response.FromValue(new SecurityAutomationResource(Client, originalResponse.Value, originalResponse.Value.Id), originalResponse.GetRawResponse());
                }
                else
                {
