...
{
    public partial class HttpC2DRejectedMessagesNotInAllowedRange : IUtf8JsonSerializable, IJsonModel<HttpC2DRejectedMessagesNotInAllowedRange>, IPersistableModel<HttpC2DRejectedMessagesNotInAllowedRange>
    {
        ...
        void IJsonModel<HttpC2DRejectedMessagesNotInAllowedRange>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(HttpC2DRejectedMessagesNotInAllowedRange)} does not support '{format}' format.");
            }
