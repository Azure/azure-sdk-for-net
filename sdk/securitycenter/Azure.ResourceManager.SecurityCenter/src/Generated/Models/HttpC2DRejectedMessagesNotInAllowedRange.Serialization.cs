...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HttpC2DRejectedMessagesNotInAllowedRange>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<HttpC2DRejectedMessagesNotInAllowedRange>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<HttpC2DRejectedMessagesNotInAllowedRange>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<HttpC2DRejectedMessagesNotInAllowedRange>)} interface");
            }
        ...
        string IPersistableModel<HttpC2DRejectedMessagesNotInAllowedRange>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
