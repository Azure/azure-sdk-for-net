...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public partial class HttpC2DRejectedMessagesNotInAllowedRange : TimeWindowCustomAlertRule, IJsonModel<HttpC2DRejectedMessagesNotInAllowedRange>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<HttpC2DRejectedMessagesNotInAllowedRange>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static HttpC2DRejectedMessagesNotInAllowedRange DeserializeHttpC2DRejectedMessagesNotInAllowedRange(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            string ruleType = "HttpC2DRejectedMessagesNotInAllowedRange";
