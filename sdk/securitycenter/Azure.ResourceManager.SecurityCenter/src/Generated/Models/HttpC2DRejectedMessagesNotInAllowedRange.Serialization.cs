...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HttpC2DRejectedMessagesNotInAllowedRange>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        HttpC2DRejectedMessagesNotInAllowedRange IJsonModel<HttpC2DRejectedMessagesNotInAllowedRange>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
                throw new FormatException($"The model {nameof(HttpC2DRejectedMessagesNotInAllowedRange)} does not support '{options.Format}' format.");
            }
        ...
        internal static HttpC2DRejectedMessagesNotInAllowedRange DeserializeHttpC2DRejectedMessagesNotInAllowedRange(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new HttpC2DRejectedMessagesNotInAllowedRange(displayName.Value, description.Value, isEnabled, ruleType, serializedAdditionalRawData, minThreshold, maxThreshold, timeWindowSize);
        }

        BinaryData IModel<HttpC2DRejectedMessagesNotInAllowedRange>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        HttpC2DRejectedMessagesNotInAllowedRange IModel<HttpC2DRejectedMessagesNotInAllowedRange>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<HttpC2DRejectedMessagesNotInAllowedRange>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
