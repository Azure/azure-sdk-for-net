...
{
    public partial class DefenderForDevOpsGitLabOffering : IUtf8JsonSerializable, IJsonModel<DefenderForDevOpsGitLabOffering>, IPersistableModel<DefenderForDevOpsGitLabOffering>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DefenderForDevOpsGitLabOffering>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static DefenderForDevOpsGitLabOffering DeserializeDefenderForDevOpsGitLabOffering(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new DefenderForDevOpsGitLabOffering(offeringType, description.Value, serializedAdditionalRawData);
        }
