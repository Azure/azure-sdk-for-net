...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    public partial class HttpC2DMessagesNotInAllowedRange : IUtf8JsonSerializable, IJsonModel<HttpC2DMessagesNotInAllowedRange>
    {
        ...
        void IJsonModel<HttpC2DMessagesNotInAllowedRange>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(HttpC2DMessagesNotInAllowedRange)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<HttpC2DMessagesNotInAllowedRange>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(HttpC2DMessagesNotInAllowedRange)} does not support '{options.Format}' format.");
            }
        }
