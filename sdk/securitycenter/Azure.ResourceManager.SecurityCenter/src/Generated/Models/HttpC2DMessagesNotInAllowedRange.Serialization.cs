...
{
    public partial class HttpC2DMessagesNotInAllowedRange : IUtf8JsonSerializable
    {
        ...
        internal static HttpC2DMessagesNotInAllowedRange DeserializeHttpC2DMessagesNotInAllowedRange(JsonElement element)
        {
            ...
            return new HttpC2DMessagesNotInAllowedRange(displayName.Value, description.Value, isEnabled, ruleType, minThreshold, maxThreshold, timeWindowSize);
        }
    }
}
