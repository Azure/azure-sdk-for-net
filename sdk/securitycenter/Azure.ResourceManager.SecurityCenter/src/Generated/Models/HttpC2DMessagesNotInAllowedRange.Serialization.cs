...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public partial class HttpC2DMessagesNotInAllowedRange : TimeWindowCustomAlertRule, IJsonModel<HttpC2DMessagesNotInAllowedRange>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<HttpC2DMessagesNotInAllowedRange>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static HttpC2DMessagesNotInAllowedRange DeserializeHttpC2DMessagesNotInAllowedRange(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            string ruleType = "HttpC2DMessagesNotInAllowedRange";
