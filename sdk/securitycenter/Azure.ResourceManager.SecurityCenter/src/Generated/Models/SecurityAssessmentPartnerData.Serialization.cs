...
{
    public partial class SecurityAssessmentPartnerData : IUtf8JsonSerializable
    {
        ...
        internal static SecurityAssessmentPartnerData DeserializeSecurityAssessmentPartnerData(JsonElement element)
        {
            ...
            return new SecurityAssessmentPartnerData(partnerName, secret);
        }
    }
}
