...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IotSeverityMetrics>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<IotSeverityMetrics>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<IotSeverityMetrics>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<IotSeverityMetrics>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
