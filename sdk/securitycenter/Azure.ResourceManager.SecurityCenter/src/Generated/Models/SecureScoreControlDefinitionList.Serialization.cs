...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SecureScoreControlDefinitionList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SecureScoreControlDefinitionList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SecureScoreControlDefinitionList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SecureScoreControlDefinitionList>)} interface");
            }
        ...
        string IPersistableModel<SecureScoreControlDefinitionList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
