...
namespace Azure.ResourceManager.SecurityCenter
{
    public partial class ApplicationData : IUtf8JsonSerializable
    {
        ...
        internal static ApplicationData DeserializeApplicationData(JsonElement element)
        {
            ...
            return new ApplicationData(id, name, type, systemData.Value, displayName.Value, description.Value, Optional.ToNullable(sourceResourceType), Optional.ToList(conditionSets));
        }
    }
}
