...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    {
        internal static AutoProvisioningSettingList DeserializeAutoProvisioningSettingList(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
