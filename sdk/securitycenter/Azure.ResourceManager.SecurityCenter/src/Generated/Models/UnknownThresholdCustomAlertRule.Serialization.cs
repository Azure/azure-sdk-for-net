...
{
    internal partial class UnknownThresholdCustomAlertRule : ThresholdCustomAlertRule, IJsonModel<ThresholdCustomAlertRule>
    {
        /// <summary> Initializes a new instance of <see cref="UnknownThresholdCustomAlertRule"/> for deserialization. </summary>
        internal UnknownThresholdCustomAlertRule()
        {
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownThresholdCustomAlertRule DeserializeUnknownThresholdCustomAlertRule(JsonElement element, ModelReaderWriterOptions options)
        {
