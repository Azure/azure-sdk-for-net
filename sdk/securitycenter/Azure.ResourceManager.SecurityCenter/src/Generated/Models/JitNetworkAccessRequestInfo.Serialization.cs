...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<JitNetworkAccessRequestInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<JitNetworkAccessRequestInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<JitNetworkAccessRequestInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<JitNetworkAccessRequestInfo>)} interface");
            }
        ...
        string IPersistableModel<JitNetworkAccessRequestInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
