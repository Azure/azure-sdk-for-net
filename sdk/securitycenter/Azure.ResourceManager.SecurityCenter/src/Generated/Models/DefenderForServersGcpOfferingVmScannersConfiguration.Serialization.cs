...
{
    public partial class DefenderForServersGcpOfferingVmScannersConfiguration : IUtf8JsonSerializable
    {
        ...
        internal static DefenderForServersGcpOfferingVmScannersConfiguration DeserializeDefenderForServersGcpOfferingVmScannersConfiguration(JsonElement element)
        {
            ...
            return new DefenderForServersGcpOfferingVmScannersConfiguration(Optional.ToNullable(scanningMode), Optional.ToDictionary(exclusionTags));
        }
    }
}
