...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RecommendationConfigurationProperties>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<RecommendationConfigurationProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(RecommendationConfigurationProperties)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<RecommendationConfigurationProperties>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(RecommendationConfigurationProperties)} does not support '{options.Format}' format.");
            }
        }
