...
{
    public partial class RecommendationConfigurationProperties : IUtf8JsonSerializable, IJsonModel<RecommendationConfigurationProperties>, IPersistableModel<RecommendationConfigurationProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(RecommendationType))
            {
                ...
                builder.AppendLine($" '{RecommendationType.ToString()}'");
            }
