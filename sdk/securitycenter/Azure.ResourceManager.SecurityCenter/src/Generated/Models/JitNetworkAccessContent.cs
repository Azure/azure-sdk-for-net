...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public partial class JitNetworkAccessContent
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="JitNetworkAccessContent"/>. </summary>
        ...
        public JitNetworkAccessContent(IEnumerable<JitNetworkAccessRequestVirtualMachine> virtualMachines, DateTimeOffset startTimeUtc, string requestor)
        {
        ...
        internal JitNetworkAccessContent(IList<JitNetworkAccessRequestVirtualMachine> virtualMachines, DateTimeOffset startTimeUtc, string requestor, string justification, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
