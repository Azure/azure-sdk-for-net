...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public partial class ListCustomAlertRule : CustomAlertRule
    {
        ...
        internal ListCustomAlertRule(string displayName, string description, bool isEnabled, string ruleType, SecurityValueType? valueType, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(displayName, description, isEnabled, ruleType, serializedAdditionalRawData)
        {
            ValueType = valueType;
