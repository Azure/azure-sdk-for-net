...
{
    public partial class ApiCollectionData : IUtf8JsonSerializable, IJsonModel<ApiCollectionData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ApiCollectionData>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<ApiCollectionData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ApiCollectionData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ApiCollectionData)} does not support '{format}' format.");
            }
        ...
        ApiCollectionData IJsonModel<ApiCollectionData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ApiCollectionData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
            ...
            return DeserializeApiCollectionData(document.RootElement, options);
        }

        internal static ApiCollectionData DeserializeApiCollectionData(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<ApiCollectionData>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ApiCollectionData>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ApiCollectionData)} does not support '{options.Format}' format.");
            }
        }

        ApiCollectionData IPersistableModel<ApiCollectionData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ApiCollectionData>)this).GetFormatFromOptions(options) : options.Format;
        ...
        string IPersistableModel<ApiCollectionData>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
