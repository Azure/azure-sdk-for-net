...
namespace Azure.ResourceManager.SecurityCenter
{
    public partial class SecurityAutomationResource : IJsonModel<SecurityAutomationData>
    {
        ...
        {
            return ModelReaderWriter.Read<SecurityAutomationData>(new BinaryData(reader.ValueSequence), options);
        }
        ...
        {
            return ModelReaderWriter.Read<SecurityAutomationData>(data, options);
        }
