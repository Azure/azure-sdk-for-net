...
{
    public partial class SecurityAssessmentResponseData : IUtf8JsonSerializable
    {
        ...
        internal static SecurityAssessmentResponseData DeserializeSecurityAssessmentResponseData(JsonElement element)
        {
            ...
            return new SecurityAssessmentResponseData(id, name, type, systemData.Value, resourceDetails.Value, displayName.Value, Optional.ToDictionary(additionalData), links.Value, metadata.Value, partnersData.Value, status.Value);
        }
    }
}
