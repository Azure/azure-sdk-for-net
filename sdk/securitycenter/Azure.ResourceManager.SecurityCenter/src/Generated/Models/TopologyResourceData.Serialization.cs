...
{
    public partial class TopologyResourceData : IUtf8JsonSerializable
    {
        ...
        internal static TopologyResourceData DeserializeTopologyResourceData(JsonElement element)
        {
            ...
            return new TopologyResourceData(id, name, type, systemData.Value, Optional.ToNullable(calculatedDateTime), Optional.ToList(topologyResources), Optional.ToNullable(location));
        }
    }
}
