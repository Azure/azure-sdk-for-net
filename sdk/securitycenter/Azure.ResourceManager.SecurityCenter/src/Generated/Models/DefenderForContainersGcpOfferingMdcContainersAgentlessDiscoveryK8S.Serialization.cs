...
{
    public partial class DefenderForContainersGcpOfferingMdcContainersAgentlessDiscoveryK8S : IUtf8JsonSerializable
    {
        ...
        internal static DefenderForContainersGcpOfferingMdcContainersAgentlessDiscoveryK8S DeserializeDefenderForContainersGcpOfferingMdcContainersAgentlessDiscoveryK8S(JsonElement element)
        {
            ...
            return new DefenderForContainersGcpOfferingMdcContainersAgentlessDiscoveryK8S(Optional.ToNullable(enabled), workloadIdentityProviderId.Value, serviceAccountEmailAddress.Value);
        }
    }
}
