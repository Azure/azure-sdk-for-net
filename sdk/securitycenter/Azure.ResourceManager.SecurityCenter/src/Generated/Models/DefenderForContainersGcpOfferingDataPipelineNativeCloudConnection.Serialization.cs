...
{
    public partial class DefenderForContainersGcpOfferingDataPipelineNativeCloudConnection : IUtf8JsonSerializable, IJsonModel<DefenderForContainersGcpOfferingDataPipelineNativeCloudConnection>, IPersistableModel<DefenderForContainersGcpOfferingDataPipelineNativeCloudConnection>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DefenderForContainersGcpOfferingDataPipelineNativeCloudConnection>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<DefenderForContainersGcpOfferingDataPipelineNativeCloudConnection>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DefenderForContainersGcpOfferingDataPipelineNativeCloudConnection)} does not support '{format}' format.");
            }
