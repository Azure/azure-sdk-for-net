...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GithubScopeEnvironment>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<GithubScopeEnvironment>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<GithubScopeEnvironment>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<GithubScopeEnvironment>)} interface");
            }
        ...
        string IPersistableModel<GithubScopeEnvironment>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
