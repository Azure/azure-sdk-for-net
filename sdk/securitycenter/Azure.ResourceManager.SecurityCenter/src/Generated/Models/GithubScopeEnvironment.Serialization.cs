...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public partial class GithubScopeEnvironment : SecurityConnectorEnvironment, IJsonModel<GithubScopeEnvironment>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<GithubScopeEnvironment>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static GithubScopeEnvironment DeserializeGithubScopeEnvironment(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new GithubScopeEnvironment(environmentType, additionalBinaryDataProperties);
        }
    }
}
