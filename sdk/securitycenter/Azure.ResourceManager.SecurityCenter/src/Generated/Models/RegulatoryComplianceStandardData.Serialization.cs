...
namespace Azure.ResourceManager.SecurityCenter
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RegulatoryComplianceStandardData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RegulatoryComplianceStandardData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RegulatoryComplianceStandardData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RegulatoryComplianceStandardData>)} interface");
            }
        ...
        string IPersistableModel<RegulatoryComplianceStandardData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
