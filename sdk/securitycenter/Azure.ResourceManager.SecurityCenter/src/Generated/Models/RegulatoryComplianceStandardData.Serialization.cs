...
{
    public partial class RegulatoryComplianceStandardData : IUtf8JsonSerializable, IJsonModel<RegulatoryComplianceStandardData>, IPersistableModel<RegulatoryComplianceStandardData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  passedControls:");
                builder.AppendLine($" '{PassedControls.Value.ToString()}'");
            }

            if (Optional.IsDefined(FailedControls))
            {
                builder.Append("  failedControls:");
                builder.AppendLine($" '{FailedControls.Value.ToString()}'");
            }

            if (Optional.IsDefined(SkippedControls))
            {
                builder.Append("  skippedControls:");
                builder.AppendLine($" '{SkippedControls.Value.ToString()}'");
            }

            if (Optional.IsDefined(UnsupportedControls))
            {
                builder.Append("  unsupportedControls:");
                builder.AppendLine($" '{UnsupportedControls.Value.ToString()}'");
            }
