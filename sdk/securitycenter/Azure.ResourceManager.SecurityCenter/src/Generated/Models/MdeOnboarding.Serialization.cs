...
{
    public partial class MdeOnboarding : IUtf8JsonSerializable, IJsonModel<MdeOnboarding>, IPersistableModel<MdeOnboarding>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MdeOnboarding>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<MdeOnboarding>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MdeOnboarding)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(OnboardingPackageWindows))
            {
                builder.Append("  onboardingPackageWindows:");
                builder.AppendLine($" '{OnboardingPackageWindows.ToString()}'");
            }

            if (Optional.IsDefined(OnboardingPackageLinux))
            {
                builder.Append("  onboardingPackageLinux:");
                builder.AppendLine($" '{OnboardingPackageLinux.ToString()}'");
            }
