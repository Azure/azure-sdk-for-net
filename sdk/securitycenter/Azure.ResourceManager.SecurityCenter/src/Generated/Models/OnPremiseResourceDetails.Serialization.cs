...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<OnPremiseResourceDetails>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<OnPremiseResourceDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<OnPremiseResourceDetails>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<OnPremiseResourceDetails>)} interface");
            }
        ...
        string IPersistableModel<OnPremiseResourceDetails>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
