...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public partial class TwinUpdatesNotInAllowedRange : TimeWindowCustomAlertRule, IJsonModel<TwinUpdatesNotInAllowedRange>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<TwinUpdatesNotInAllowedRange>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static TwinUpdatesNotInAllowedRange DeserializeTwinUpdatesNotInAllowedRange(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            string ruleType = "TwinUpdatesNotInAllowedRange";
