...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public partial class LogAnalyticsIdentifier : SecurityAlertResourceIdentifier
    {
        ...
        internal LogAnalyticsIdentifier(ResourceIdentifierType @type, IDictionary<string, BinaryData> additionalBinaryDataProperties, Guid? workspaceId, string workspaceSubscriptionId, string workspaceResourceGroup, Guid? agentId) : base(@type, additionalBinaryDataProperties)
        {
