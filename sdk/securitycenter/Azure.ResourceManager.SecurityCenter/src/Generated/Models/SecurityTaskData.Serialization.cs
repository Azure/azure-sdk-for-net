...
namespace Azure.ResourceManager.SecurityCenter
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SecurityTaskData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SecurityTaskData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SecurityTaskData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SecurityTaskData>)} interface");
            }
        ...
        string IPersistableModel<SecurityTaskData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
