...
{
    public partial class SecurityTaskData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static SecurityTaskData DeserializeSecurityTaskData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
