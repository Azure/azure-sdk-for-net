...
{
    public partial class SecurityTaskData : IUtf8JsonSerializable, IJsonModel<SecurityTaskData>, IPersistableModel<SecurityTaskData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SecurityTaskParameters))
            {
                builder.Append("  securityTaskParameters:");
                AppendChildObject(builder, SecurityTaskParameters, options, 2);
            }

            if (Optional.IsDefined(LastStateChangedOn))
            {
                builder.Append("  lastStateChangeTimeUtc:");
                builder.AppendLine($" '{LastStateChangedOn.Value.ToString()}'");
            }
