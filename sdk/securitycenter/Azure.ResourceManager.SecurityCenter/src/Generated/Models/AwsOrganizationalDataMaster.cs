...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public partial class AwsOrganizationalDataMaster : AwsOrganizationalInfo
    {
        ...
        internal AwsOrganizationalDataMaster(OrganizationMembershipType organizationMembershipType, string stacksetName, IList<string> excludedAccountIds, Dictionary<string, BinaryData> rawData) : base(organizationMembershipType, rawData)
        {
