...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public partial class GovernanceRuleMetadata
    {
        ...
        internal GovernanceRuleMetadata(string createdBy, DateTimeOffset? createdOn, string updatedBy, DateTimeOffset? updatedOn, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            CreatedBy = createdBy;
            CreatedOn = createdOn;
            UpdatedBy = updatedBy;
