...
{
    public partial class InformationProtectionAwsOffering : IUtf8JsonSerializable, IJsonModel<InformationProtectionAwsOffering>, IPersistableModel<InformationProtectionAwsOffering>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(InformationProtection))
            {
                builder.Append("  informationProtection:");
                AppendChildObject(builder, InformationProtection, options, 2);
            }
