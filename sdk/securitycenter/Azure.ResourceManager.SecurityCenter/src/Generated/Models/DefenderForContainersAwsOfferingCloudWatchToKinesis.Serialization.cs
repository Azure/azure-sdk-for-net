...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DefenderForContainersAwsOfferingCloudWatchToKinesis>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        DefenderForContainersAwsOfferingCloudWatchToKinesis IJsonModel<DefenderForContainersAwsOfferingCloudWatchToKinesis>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<DefenderForContainersAwsOfferingCloudWatchToKinesis>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        DefenderForContainersAwsOfferingCloudWatchToKinesis IModel<DefenderForContainersAwsOfferingCloudWatchToKinesis>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<DefenderForContainersAwsOfferingCloudWatchToKinesis>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
