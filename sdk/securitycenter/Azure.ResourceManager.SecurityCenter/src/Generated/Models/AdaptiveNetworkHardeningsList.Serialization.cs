...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AdaptiveNetworkHardeningsList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AdaptiveNetworkHardeningsList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AdaptiveNetworkHardeningsList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AdaptiveNetworkHardeningsList>)} interface");
            }
        ...
        string IPersistableModel<AdaptiveNetworkHardeningsList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
