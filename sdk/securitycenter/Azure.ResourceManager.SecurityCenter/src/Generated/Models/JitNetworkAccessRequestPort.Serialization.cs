...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<JitNetworkAccessRequestPort>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<JitNetworkAccessRequestPort>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<JitNetworkAccessRequestPort>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<JitNetworkAccessRequestPort>)} interface");
            }
        ...
        string IPersistableModel<JitNetworkAccessRequestPort>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
