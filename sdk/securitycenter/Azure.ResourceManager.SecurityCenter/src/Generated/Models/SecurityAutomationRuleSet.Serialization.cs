...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SecurityAutomationRuleSet>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SecurityAutomationRuleSet>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SecurityAutomationRuleSet>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SecurityAutomationRuleSet>)} interface");
            }
        ...
        string IPersistableModel<SecurityAutomationRuleSet>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
