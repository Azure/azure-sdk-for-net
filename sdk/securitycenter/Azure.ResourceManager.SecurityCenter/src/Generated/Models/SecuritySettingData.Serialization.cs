...
namespace Azure.ResourceManager.SecurityCenter
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SecuritySettingData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SecuritySettingData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SecuritySettingData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SecuritySettingData>)} interface");
            }
        ...
        string IPersistableModel<SecuritySettingData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
