...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<UnauthorizedOperationsNotInAllowedRange>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<UnauthorizedOperationsNotInAllowedRange>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<UnauthorizedOperationsNotInAllowedRange>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<UnauthorizedOperationsNotInAllowedRange>)} interface");
            }
        ...
        string IPersistableModel<UnauthorizedOperationsNotInAllowedRange>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
