...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    public partial class UnauthorizedOperationsNotInAllowedRange : IUtf8JsonSerializable, IJsonModel<UnauthorizedOperationsNotInAllowedRange>
    {
        ...
        void IJsonModel<UnauthorizedOperationsNotInAllowedRange>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(UnauthorizedOperationsNotInAllowedRange)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<UnauthorizedOperationsNotInAllowedRange>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(UnauthorizedOperationsNotInAllowedRange)} does not support '{options.Format}' format.");
            }
        }
