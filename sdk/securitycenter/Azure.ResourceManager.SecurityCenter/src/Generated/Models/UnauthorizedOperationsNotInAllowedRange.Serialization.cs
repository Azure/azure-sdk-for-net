...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<UnauthorizedOperationsNotInAllowedRange>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<UnauthorizedOperationsNotInAllowedRange>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        UnauthorizedOperationsNotInAllowedRange IJsonModel<UnauthorizedOperationsNotInAllowedRange>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<UnauthorizedOperationsNotInAllowedRange>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        UnauthorizedOperationsNotInAllowedRange IPersistableModel<UnauthorizedOperationsNotInAllowedRange>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<UnauthorizedOperationsNotInAllowedRange>)this).GetFormatFromOptions(options) : options.Format;
