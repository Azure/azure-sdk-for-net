...
{
    public partial class UnauthorizedOperationsNotInAllowedRange : IUtf8JsonSerializable, IJsonModel<UnauthorizedOperationsNotInAllowedRange>, IPersistableModel<UnauthorizedOperationsNotInAllowedRange>
    {
        ...
        void IJsonModel<UnauthorizedOperationsNotInAllowedRange>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(UnauthorizedOperationsNotInAllowedRange)} does not support '{format}' format.");
            }
