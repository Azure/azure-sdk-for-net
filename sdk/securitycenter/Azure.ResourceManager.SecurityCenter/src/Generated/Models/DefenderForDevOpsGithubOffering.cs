...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public partial class DefenderForDevOpsGithubOffering : SecurityCenterCloudOffering
    {
        ...
        internal DefenderForDevOpsGithubOffering(OfferingType offeringType, string description, Dictionary<string, BinaryData> rawData) : base(offeringType, description, rawData)
        {
