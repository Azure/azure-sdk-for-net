...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SecuritySolutionList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SecuritySolutionList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SecuritySolutionList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SecuritySolutionList>)} interface");
            }
        ...
        string IPersistableModel<SecuritySolutionList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
