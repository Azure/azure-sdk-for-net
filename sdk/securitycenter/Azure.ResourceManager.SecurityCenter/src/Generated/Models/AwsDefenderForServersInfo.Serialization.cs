...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AwsDefenderForServersInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AwsDefenderForServersInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AwsDefenderForServersInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AwsDefenderForServersInfo>)} interface");
            }
        ...
        string IPersistableModel<AwsDefenderForServersInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
