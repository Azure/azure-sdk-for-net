...
{
    public partial class MdeOnboardingDataData : IUtf8JsonSerializable
    {
        ...
        internal static MdeOnboardingDataData DeserializeMdeOnboardingDataData(JsonElement element)
        {
            ...
            return new MdeOnboardingDataData(id, name, type, systemData.Value, onboardingPackageWindows.Value, onboardingPackageLinux.Value);
        }
    }
}
