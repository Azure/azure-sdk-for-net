...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public partial class SecurityContactPropertiesAlertNotifications
    {
        ...
        internal SecurityContactPropertiesAlertNotifications(SecurityAlertNotificationState? state, SecurityAlertMinimalSeverity? minimalSeverity, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            State = state;
