...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public partial class DefenderForDatabasesAwsOffering : SecurityCenterCloudOffering
    {
        ...
        internal DefenderForDatabasesAwsOffering(OfferingType offeringType, string description, DefenderForDatabasesAwsOfferingArcAutoProvisioning arcAutoProvisioning, DefenderForDatabasesAwsOfferingRds rds, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(offeringType, description, serializedAdditionalRawData)
        {
