...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public partial class JitNetworkAccessPolicyVirtualMachine
    {
        ...
        internal JitNetworkAccessPolicyVirtualMachine(ResourceIdentifier id, IList<JitNetworkAccessPortRule> ports, string publicIPAddress, Dictionary<string, BinaryData> rawData)
        {
            Id = id;
            Ports = ports;
