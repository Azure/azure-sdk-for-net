...
{
    public partial class SecurityTopologyResource : IUtf8JsonSerializable, IJsonModel<SecurityTopologyResource>, IPersistableModel<SecurityTopologyResource>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  topologyResources:");
                builder.AppendLine(" [");
                foreach (var item in TopologyResources)
                {
