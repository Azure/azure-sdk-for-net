...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SecurityTopologyResource>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SecurityTopologyResource>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SecurityTopologyResource>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SecurityTopologyResource>)} interface");
            }
        ...
        string IPersistableModel<SecurityTopologyResource>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
