...
{
    public partial class SecurityTopologyResource : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static SecurityTopologyResource DeserializeSecurityTopologyResource(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
