...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    internal partial class PricingList : IUtf8JsonSerializable, IJsonModel<PricingList>
    {
        ...
        void IJsonModel<PricingList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(PricingList)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<PricingList>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(PricingList)} does not support '{options.Format}' format.");
            }
        }
