...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    public partial class AzureDevOpsOrgProperties : IUtf8JsonSerializable
    {
        ...
        internal static AzureDevOpsOrgProperties DeserializeAzureDevOpsOrgProperties(JsonElement element)
        {
            ...
            return new AzureDevOpsOrgProperties(provisioningStatusMessage.Value, Optional.ToNullable(provisioningStatusUpdateTimeUtc), Optional.ToNullable(provisioningState), Optional.ToNullable(onboardingState), actionableRemediation.Value);
        }
    }
}
