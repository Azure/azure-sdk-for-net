...
{
    public partial class GovernanceAssignmentData : IUtf8JsonSerializable, IJsonModel<GovernanceAssignmentData>, IPersistableModel<GovernanceAssignmentData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(RemediationDueOn))
            {
                ...
                builder.AppendLine($" '{RemediationDueOn.Value.ToString()}'");
            }

            if (Optional.IsDefined(RemediationEta))
            {
                builder.Append("  remediationEta:");
                AppendChildObject(builder, RemediationEta, options, 2);
            }
            ...
            if (Optional.IsDefined(GovernanceEmailNotification))
            {
                ...
                AppendChildObject(builder, GovernanceEmailNotification, options, 2);
            }

            if (Optional.IsDefined(AdditionalData))
            {
                builder.Append("  additionalData:");
                AppendChildObject(builder, AdditionalData, options, 2);
            }
