...
{
    public partial class DefenderForServersGcpOfferingMdeAutoProvisioning : Core.IUtf8JsonSerializable
    {
        ...
        internal static DefenderForServersGcpOfferingMdeAutoProvisioning DeserializeDefenderForServersGcpOfferingMdeAutoProvisioning(JsonElement element)
        {
            ...
            return new DefenderForServersGcpOfferingMdeAutoProvisioning(Core.Optional.ToNullable(enabled), configuration.Value);
        }
    }
}
