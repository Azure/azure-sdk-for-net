...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DefenderForServersGcpOfferingMdeAutoProvisioning>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<DefenderForServersGcpOfferingMdeAutoProvisioning>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DefenderForServersGcpOfferingMdeAutoProvisioning>)} interface");
            }
        ...
        string IPersistableModel<DefenderForServersGcpOfferingMdeAutoProvisioning>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
