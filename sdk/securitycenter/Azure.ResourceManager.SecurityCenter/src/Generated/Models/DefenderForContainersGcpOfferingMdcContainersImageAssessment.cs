...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public partial class DefenderForContainersGcpOfferingMdcContainersImageAssessment
    {
        ...
        internal DefenderForContainersGcpOfferingMdcContainersImageAssessment(bool? enabled, string workloadIdentityProviderId, string serviceAccountEmailAddress, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Enabled = enabled;
