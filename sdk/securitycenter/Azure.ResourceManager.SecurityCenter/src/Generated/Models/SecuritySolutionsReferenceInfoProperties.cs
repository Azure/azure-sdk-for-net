...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public partial class SecuritySolutionsReferenceInfoProperties
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="SecuritySolutionsReferenceInfoProperties"/>. </summary>
        ...
        internal SecuritySolutionsReferenceInfoProperties(SecurityFamily securityFamily, string alertVendorName, string packageInfoUri, string productName, string publisher, string publisherDisplayName, string template)
        {
        ...
        internal SecuritySolutionsReferenceInfoProperties(SecurityFamily securityFamily, string alertVendorName, string packageInfoUri, string productName, string publisher, string publisherDisplayName, string template, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            SecurityFamily = securityFamily;
            AlertVendorName = alertVendorName;
            PackageInfoUri = packageInfoUri;
