...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public partial class DefenderForServersAwsOfferingArcAutoProvisioning : ArcAutoProvisioningAws
    {
        ...
        internal DefenderForServersAwsOfferingArcAutoProvisioning(bool? enabled, DefenderForDatabasesAwsOfferingArcAutoProvisioningConfiguration configuration, IDictionary<string, BinaryData> additionalBinaryDataProperties, string cloudRoleArn) : base(enabled, configuration, additionalBinaryDataProperties, cloudRoleArn)
        {
        }
    }
}
