...
{
    public partial class CspmMonitorGitLabOffering : IUtf8JsonSerializable, IJsonModel<CspmMonitorGitLabOffering>, IPersistableModel<CspmMonitorGitLabOffering>
    {
        ...
        void IJsonModel<CspmMonitorGitLabOffering>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CspmMonitorGitLabOffering)} does not support '{format}' format.");
            }
        ...
        internal static CspmMonitorGitLabOffering DeserializeCspmMonitorGitLabOffering(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new CspmMonitorGitLabOffering(offeringType, description.Value, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<CspmMonitorGitLabOffering>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CspmMonitorGitLabOffering)} does not support '{options.Format}' format.");
            }
        }
