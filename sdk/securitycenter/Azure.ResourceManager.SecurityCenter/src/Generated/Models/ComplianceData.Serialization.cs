...
{
    public partial class ComplianceData : IUtf8JsonSerializable
    {
        ...
        internal static ComplianceData DeserializeComplianceData(JsonElement element)
        {
            ...
            return new ComplianceData(id, name, type, systemData.Value, Optional.ToNullable(assessmentTimestampUtcDate), Optional.ToNullable(resourceCount), Optional.ToList(assessmentResult));
        }
    }
}
