...
{
    public partial class AwsEnvironment : IUtf8JsonSerializable, IJsonModel<AwsEnvironment>, IPersistableModel<AwsEnvironment>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(OrganizationalData))
            {
                ...
                AppendChildObject(builder, OrganizationalData, options, 2);
            }
