...
{
    public partial class AwsEnvironment : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static AwsEnvironment DeserializeAwsEnvironment(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
