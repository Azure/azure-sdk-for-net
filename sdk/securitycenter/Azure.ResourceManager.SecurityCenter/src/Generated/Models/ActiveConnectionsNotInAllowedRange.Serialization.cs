...
{
    public partial class ActiveConnectionsNotInAllowedRange : IUtf8JsonSerializable, IJsonModel<ActiveConnectionsNotInAllowedRange>, IPersistableModel<ActiveConnectionsNotInAllowedRange>
    {
        ...
        void IJsonModel<ActiveConnectionsNotInAllowedRange>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ActiveConnectionsNotInAllowedRange)} does not support '{format}' format.");
            }
