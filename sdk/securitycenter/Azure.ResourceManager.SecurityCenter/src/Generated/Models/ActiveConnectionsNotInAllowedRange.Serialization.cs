...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public partial class ActiveConnectionsNotInAllowedRange : TimeWindowCustomAlertRule, IJsonModel<ActiveConnectionsNotInAllowedRange>
    {
        /// <summary> Initializes a new instance of <see cref="ActiveConnectionsNotInAllowedRange"/> for deserialization. </summary>
        internal ActiveConnectionsNotInAllowedRange()
        {
        }
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<ActiveConnectionsNotInAllowedRange>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ActiveConnectionsNotInAllowedRange>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        ActiveConnectionsNotInAllowedRange IPersistableModel<ActiveConnectionsNotInAllowedRange>.Create(BinaryData data, ModelReaderWriterOptions options) => (ActiveConnectionsNotInAllowedRange)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ActiveConnectionsNotInAllowedRange IJsonModel<ActiveConnectionsNotInAllowedRange>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (ActiveConnectionsNotInAllowedRange)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static ActiveConnectionsNotInAllowedRange DeserializeActiveConnectionsNotInAllowedRange(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            string ruleType = "ActiveConnectionsNotInAllowedRange";
