...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RuleResultsProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RuleResultsProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RuleResultsProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RuleResultsProperties>)} interface");
            }
        ...
        string IPersistableModel<RuleResultsProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
