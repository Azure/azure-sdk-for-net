...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AllowedConnectionsList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AllowedConnectionsList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AllowedConnectionsList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AllowedConnectionsList>)} interface");
            }
        ...
        string IPersistableModel<AllowedConnectionsList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
