...
{
    public partial class QueuePurgesNotInAllowedRange : IUtf8JsonSerializable, IJsonModel<QueuePurgesNotInAllowedRange>, IPersistableModel<QueuePurgesNotInAllowedRange>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<QueuePurgesNotInAllowedRange>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<QueuePurgesNotInAllowedRange>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(QueuePurgesNotInAllowedRange)} does not support '{format}' format.");
            }
