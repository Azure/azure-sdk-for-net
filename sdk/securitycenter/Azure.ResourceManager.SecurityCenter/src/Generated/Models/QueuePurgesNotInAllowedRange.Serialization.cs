...
{
    public partial class QueuePurgesNotInAllowedRange : IUtf8JsonSerializable
    {
        ...
        internal static QueuePurgesNotInAllowedRange DeserializeQueuePurgesNotInAllowedRange(JsonElement element)
        {
            ...
            return new QueuePurgesNotInAllowedRange(displayName.Value, description.Value, isEnabled, ruleType, minThreshold, maxThreshold, timeWindowSize);
        }
    }
}
