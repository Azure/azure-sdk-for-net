...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<QueuePurgesNotInAllowedRange>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<QueuePurgesNotInAllowedRange>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<QueuePurgesNotInAllowedRange>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<QueuePurgesNotInAllowedRange>)} interface");
            }
        ...
        string IPersistableModel<QueuePurgesNotInAllowedRange>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
