...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<QueuePurgesNotInAllowedRange>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        QueuePurgesNotInAllowedRange IJsonModel<QueuePurgesNotInAllowedRange>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
                throw new FormatException($"The model {nameof(QueuePurgesNotInAllowedRange)} does not support '{options.Format}' format.");
            }
        ...
        internal static QueuePurgesNotInAllowedRange DeserializeQueuePurgesNotInAllowedRange(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new QueuePurgesNotInAllowedRange(displayName.Value, description.Value, isEnabled, ruleType, serializedAdditionalRawData, minThreshold, maxThreshold, timeWindowSize);
        }

        BinaryData IModel<QueuePurgesNotInAllowedRange>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        QueuePurgesNotInAllowedRange IModel<QueuePurgesNotInAllowedRange>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<QueuePurgesNotInAllowedRange>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
