...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public partial class ScanResultProperties
    {
        ...
        internal ScanResultProperties(string ruleId, SqlVulnerabilityAssessmentScanResultRuleStatus? status, bool? isTrimmed, IList<IList<string>> queryResults, Remediation remediation, BaselineAdjustedResult baselineAdjustedResult, VaRule ruleMetadata, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            RuleId = ruleId;
            Status = status;
            IsTrimmed = isTrimmed;
