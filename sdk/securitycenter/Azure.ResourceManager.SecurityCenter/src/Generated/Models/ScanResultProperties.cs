...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    {
        /// <summary> Initializes a new instance of ScanResultProperties. </summary>
        ...
        internal ScanResultProperties(string ruleId, RuleStatus? status, bool? isTrimmed, IList<IList<string>> queryResults, Remediation remediation, BaselineAdjustedResult baselineAdjustedResult, VaRule ruleMetadata)
        {
            RuleId = ruleId;
            Status = status;
            IsTrimmed = isTrimmed;
