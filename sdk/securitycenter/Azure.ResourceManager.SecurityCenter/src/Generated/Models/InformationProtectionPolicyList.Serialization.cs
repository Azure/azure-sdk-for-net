...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<InformationProtectionPolicyList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<InformationProtectionPolicyList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<InformationProtectionPolicyList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<InformationProtectionPolicyList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
