...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public partial class SubAssessmentStatus
    {
        ...
        internal SubAssessmentStatus(SubAssessmentStatusCode? code, string cause, string description, SecurityAssessmentSeverity? severity, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Code = code;
            Cause = cause;
