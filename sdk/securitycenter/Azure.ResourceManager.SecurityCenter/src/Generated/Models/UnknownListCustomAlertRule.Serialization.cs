...
{
    internal partial class UnknownListCustomAlertRule : ListCustomAlertRule, IJsonModel<ListCustomAlertRule>
    {
        /// <summary> Initializes a new instance of <see cref="UnknownListCustomAlertRule"/> for deserialization. </summary>
        internal UnknownListCustomAlertRule()
        {
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownListCustomAlertRule DeserializeUnknownListCustomAlertRule(JsonElement element, ModelReaderWriterOptions options)
        {
