...
{
    internal partial class UnknownGcpOrganizationalData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static UnknownGcpOrganizationalData DeserializeUnknownGcpOrganizationalData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
