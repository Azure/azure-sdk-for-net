...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ExtensionOperationStatus>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ExtensionOperationStatus>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ExtensionOperationStatus>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ExtensionOperationStatus>)} interface");
            }
        ...
        string IPersistableModel<ExtensionOperationStatus>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
