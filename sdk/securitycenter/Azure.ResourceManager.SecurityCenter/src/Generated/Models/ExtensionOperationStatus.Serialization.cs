...
{
    public partial class ExtensionOperationStatus : IUtf8JsonSerializable, IJsonModel<ExtensionOperationStatus>, IPersistableModel<ExtensionOperationStatus>
    {
        ...
        internal static ExtensionOperationStatus DeserializeExtensionOperationStatus(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new ExtensionOperationStatus(code.Value, message.Value, serializedAdditionalRawData);
        }
