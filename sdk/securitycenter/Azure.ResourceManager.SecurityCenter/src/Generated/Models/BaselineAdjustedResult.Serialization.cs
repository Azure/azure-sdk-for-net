...
{
    public partial class BaselineAdjustedResult : IUtf8JsonSerializable, IJsonModel<BaselineAdjustedResult>, IPersistableModel<BaselineAdjustedResult>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Baseline))
            {
                ...
                AppendChildObject(builder, Baseline, options, 2);
            }
