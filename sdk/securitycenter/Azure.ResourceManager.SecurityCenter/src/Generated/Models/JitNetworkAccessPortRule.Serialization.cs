...
{
    public partial class JitNetworkAccessPortRule : IUtf8JsonSerializable, IJsonModel<JitNetworkAccessPortRule>, IPersistableModel<JitNetworkAccessPortRule>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(MaxRequestAccessDuration))
            {
                ...
                var formattedTimeSpan = XmlConvert.ToString(MaxRequestAccessDuration);
