...
{
    public partial class SecurityAssessmentStatusResult : IUtf8JsonSerializable, IJsonModel<SecurityAssessmentStatusResult>, IPersistableModel<SecurityAssessmentStatusResult>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(FirstEvaluatedOn))
            {
                ...
                builder.AppendLine($" '{FirstEvaluatedOn.Value.ToString()}'");
            }
