...
{
    public partial class CustomEntityStoreAssignmentData : IUtf8JsonSerializable, IJsonModel<CustomEntityStoreAssignmentData>, IPersistableModel<CustomEntityStoreAssignmentData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(EntityStoreDatabaseLink))
            {
                builder.Append("  entityStoreDatabaseLink:");
                builder.AppendLine($" '{EntityStoreDatabaseLink}'");
            }
