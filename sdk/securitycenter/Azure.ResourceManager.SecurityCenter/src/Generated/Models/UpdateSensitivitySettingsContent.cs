...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public partial class UpdateSensitivitySettingsContent
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="UpdateSensitivitySettingsContent"/>. </summary>
        ...
        public UpdateSensitivitySettingsContent(IEnumerable<Guid> sensitiveInfoTypesIds)
        {
        ...
        internal UpdateSensitivitySettingsContent(IList<Guid> sensitiveInfoTypesIds, float? sensitivityThresholdLabelOrder, string sensitivityThresholdLabelId, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
