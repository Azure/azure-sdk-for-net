...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IotSecuritySolutionAnalyticsModelDevicesMetrics>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<IotSecuritySolutionAnalyticsModelDevicesMetrics>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<IotSecuritySolutionAnalyticsModelDevicesMetrics>)} interface");
            }
        ...
        string IPersistableModel<IotSecuritySolutionAnalyticsModelDevicesMetrics>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
