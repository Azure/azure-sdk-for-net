...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RulesResultsContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RulesResultsContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RulesResultsContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RulesResultsContent>)} interface");
            }
        ...
        string IPersistableModel<RulesResultsContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
