...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public partial class ExternalSecuritySolutionProperties : IJsonModel<ExternalSecuritySolutionProperties>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ExternalSecuritySolutionProperties>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        ExternalSecuritySolutionProperties IPersistableModel<ExternalSecuritySolutionProperties>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ExternalSecuritySolutionProperties IJsonModel<ExternalSecuritySolutionProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);
