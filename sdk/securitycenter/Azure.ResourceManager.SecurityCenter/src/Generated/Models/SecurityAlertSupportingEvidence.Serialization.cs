...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SecurityAlertSupportingEvidence>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SecurityAlertSupportingEvidence>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SecurityAlertSupportingEvidence>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<SecurityAlertSupportingEvidence>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
