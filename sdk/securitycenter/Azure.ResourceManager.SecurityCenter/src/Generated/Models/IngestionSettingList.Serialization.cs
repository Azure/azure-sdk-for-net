...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IngestionSettingList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<IngestionSettingList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<IngestionSettingList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<IngestionSettingList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
