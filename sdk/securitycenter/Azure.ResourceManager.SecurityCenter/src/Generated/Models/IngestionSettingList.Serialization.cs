...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    internal partial class IngestionSettingList : IUtf8JsonSerializable, IJsonModel<IngestionSettingList>
    {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<IngestionSettingList>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(IngestionSettingList)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<IngestionSettingList>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(IngestionSettingList)} does not support '{options.Format}' format.");
            }
        }
