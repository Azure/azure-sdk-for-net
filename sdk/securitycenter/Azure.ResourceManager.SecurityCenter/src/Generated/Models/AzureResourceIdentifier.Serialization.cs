...
{
    public partial class AzureResourceIdentifier : IUtf8JsonSerializable, IJsonModel<AzureResourceIdentifier>, IPersistableModel<AzureResourceIdentifier>
    {
        ...
        void IJsonModel<AzureResourceIdentifier>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AzureResourceIdentifier)} does not support '{format}' format.");
            }
