    ...
    public partial class SecurityConnectorData : IUtf8JsonSerializable, IJsonModel<SecurityConnectorData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(HierarchyIdentifier))
            {
                ...
                if (HierarchyIdentifier.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(HierarchyIdentifierTrialEndOn))
            {
                ...
                var formattedDateTimeString = TypeFormatters.ToString(HierarchyIdentifierTrialEndOn.Value, "o");
            ...
            if (Optional.IsDefined(EnvironmentName))
            {
                ...
                builder.AppendLine($" '{EnvironmentName.Value.ToString()}'");
            }
            ...
            if (Optional.IsDefined(EnvironmentData))
            {
                ...
                AppendChildObject(builder, EnvironmentData, options, 4, false);
            }
