...
{
    public partial class DefenderForServersAwsOfferingMdeAutoProvisioning : IUtf8JsonSerializable, IJsonModel<DefenderForServersAwsOfferingMdeAutoProvisioning>, IPersistableModel<DefenderForServersAwsOfferingMdeAutoProvisioning>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Configuration))
            {
                ...
                builder.AppendLine($" '{Configuration.ToString()}'");
            }
