...
{
    internal partial class UnknownSecurityAlertResourceIdentifier : SecurityAlertResourceIdentifier, IJsonModel<SecurityAlertResourceIdentifier>
    {
        /// <summary> Initializes a new instance of <see cref="UnknownSecurityAlertResourceIdentifier"/> for deserialization. </summary>
        internal UnknownSecurityAlertResourceIdentifier()
        {
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownSecurityAlertResourceIdentifier DeserializeUnknownSecurityAlertResourceIdentifier(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownSecurityAlertResourceIdentifier(@type, additionalBinaryDataProperties);
        }
    }
}
