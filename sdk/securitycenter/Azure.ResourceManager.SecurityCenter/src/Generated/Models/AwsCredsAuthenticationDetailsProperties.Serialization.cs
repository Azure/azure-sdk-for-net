...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AwsCredsAuthenticationDetailsProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AwsCredsAuthenticationDetailsProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AwsCredsAuthenticationDetailsProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<AwsCredsAuthenticationDetailsProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
