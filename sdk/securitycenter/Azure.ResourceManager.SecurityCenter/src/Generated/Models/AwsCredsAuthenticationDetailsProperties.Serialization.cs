...
{
    public partial class AwsCredsAuthenticationDetailsProperties : IUtf8JsonSerializable, IJsonModel<AwsCredsAuthenticationDetailsProperties>, IPersistableModel<AwsCredsAuthenticationDetailsProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(AwsAccessKeyId))
            {
                builder.Append("  awsAccessKeyId:");
                builder.AppendLine($" '{AwsAccessKeyId}'");
            }

            if (Optional.IsDefined(AwsSecretAccessKey))
            {
                builder.Append("  awsSecretAccessKey:");
                builder.AppendLine($" '{AwsSecretAccessKey}'");
            }
