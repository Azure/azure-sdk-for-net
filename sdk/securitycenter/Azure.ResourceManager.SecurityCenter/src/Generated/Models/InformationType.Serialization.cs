...
{
    public partial class InformationType : IUtf8JsonSerializable
    {
        ...
        internal static InformationType DeserializeInformationType(JsonElement element)
        {
            ...
            return new InformationType(displayName.Value, description.Value, Optional.ToNullable(order), Optional.ToNullable(recommendedLabelId), Optional.ToNullable(enabled), Optional.ToNullable(custom), Optional.ToList(keywords));
        }
    }
}
