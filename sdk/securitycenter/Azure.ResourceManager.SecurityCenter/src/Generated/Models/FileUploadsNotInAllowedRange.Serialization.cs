...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public partial class FileUploadsNotInAllowedRange : TimeWindowCustomAlertRule, IJsonModel<FileUploadsNotInAllowedRange>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<FileUploadsNotInAllowedRange>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
                ...
                default:
                    throw new FormatException($"The model {nameof(FileUploadsNotInAllowedRange)} does not support reading '{options.Format}' format.");
            }
        }
        ...
        protected override BinaryData PersistableModelWriteCore(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(FileUploadsNotInAllowedRange)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        protected override CustomAlertRule JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(FileUploadsNotInAllowedRange)} does not support reading '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static FileUploadsNotInAllowedRange DeserializeFileUploadsNotInAllowedRange(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            string ruleType = "FileUploadsNotInAllowedRange";
