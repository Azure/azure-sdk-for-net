...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SecurityAutomationActionWorkspace>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SecurityAutomationActionWorkspace>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SecurityAutomationActionWorkspace>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<SecurityAutomationActionWorkspace>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
