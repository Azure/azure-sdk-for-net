...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public partial class SecurityAssessmentStatus
    {
        ...
        internal SecurityAssessmentStatus(SecurityAssessmentStatusCode code, string cause, string description, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Code = code;
            Cause = cause;
