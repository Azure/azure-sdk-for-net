...
{
    public partial class SecurityCloudConnectorData : IUtf8JsonSerializable, IJsonModel<SecurityCloudConnectorData>, IPersistableModel<SecurityCloudConnectorData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(HybridComputeSettings))
            {
                builder.Append("  hybridComputeSettings:");
                AppendChildObject(builder, HybridComputeSettings, options, 2);
            }

            if (Optional.IsDefined(AuthenticationDetails))
            {
                builder.Append("  authenticationDetails:");
                AppendChildObject(builder, AuthenticationDetails, options, 2);
            }
