...
namespace Azure.ResourceManager.SecurityCenter
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SecurityCloudConnectorData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SecurityCloudConnectorData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SecurityCloudConnectorData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SecurityCloudConnectorData>)} interface");
            }
        ...
        string IPersistableModel<SecurityCloudConnectorData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
