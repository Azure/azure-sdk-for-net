...
namespace Azure.ResourceManager.SecurityCenter
{
    public partial class SecurityCloudConnectorData : IUtf8JsonSerializable, IJsonModel<SecurityCloudConnectorData>
    {
        ...
        void IJsonModel<SecurityCloudConnectorData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(SecurityCloudConnectorData)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<SecurityCloudConnectorData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(SecurityCloudConnectorData)} does not support '{options.Format}' format.");
            }
        }
