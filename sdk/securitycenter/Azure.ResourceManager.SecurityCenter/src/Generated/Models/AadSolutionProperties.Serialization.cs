...
{
    public partial class AadSolutionProperties : IUtf8JsonSerializable, IJsonModel<AadSolutionProperties>, IPersistableModel<AadSolutionProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ConnectivityState))
            {
                builder.Append("  connectivityState:");
                builder.AppendLine($" '{ConnectivityState.ToString()}'");
            }
