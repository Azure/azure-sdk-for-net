...
{
    internal partial class UnknownSecuritySubAssessmentAdditionalInfo : SecuritySubAssessmentAdditionalInfo, IJsonModel<SecuritySubAssessmentAdditionalInfo>
    {
        /// <summary> Initializes a new instance of <see cref="UnknownSecuritySubAssessmentAdditionalInfo"/> for deserialization. </summary>
        internal UnknownSecuritySubAssessmentAdditionalInfo()
        {
        }

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected override SecuritySubAssessmentAdditionalInfo PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
        ...
        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected override SecuritySubAssessmentAdditionalInfo JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<SecuritySubAssessmentAdditionalInfo>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownSecuritySubAssessmentAdditionalInfo DeserializeUnknownSecuritySubAssessmentAdditionalInfo(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownSecuritySubAssessmentAdditionalInfo(assessedResourceType, additionalBinaryDataProperties);
        }
    }
}
