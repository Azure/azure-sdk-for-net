...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    internal partial class RegulatoryComplianceAssessmentProperties
    {
        ...
        internal RegulatoryComplianceAssessmentProperties(string description, string assessmentType, string assessmentDetailsLink, SecurityAlertNotificationByRoleState? state, int? passedResources, int? failedResources, int? skippedResources, int? unsupportedResources, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
