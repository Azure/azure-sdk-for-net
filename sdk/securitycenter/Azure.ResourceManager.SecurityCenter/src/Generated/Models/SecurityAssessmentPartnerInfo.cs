...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public partial class SecurityAssessmentPartnerInfo
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="SecurityAssessmentPartnerInfo"/>. </summary>
        ...
        public SecurityAssessmentPartnerInfo(string partnerName, string secret)
        {
        ...
        internal SecurityAssessmentPartnerInfo(string partnerName, string secret, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            PartnerName = partnerName;
            Secret = secret;
