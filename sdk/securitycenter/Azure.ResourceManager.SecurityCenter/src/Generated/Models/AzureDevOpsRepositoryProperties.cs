...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public partial class AzureDevOpsRepositoryProperties
    {
        ...
        internal AzureDevOpsRepositoryProperties(string provisioningStatusMessage, DateTimeOffset? provisioningStatusUpdatedOn, DevOpsProvisioningState? provisioningState, string parentOrgName, string parentProjectName, string repoId, string repoUri, string visibility, OnboardingState? onboardingState, ActionableRemediation actionableRemediation, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
