...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DefenderForServersAwsOfferingVmScannersConfiguration>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<DefenderForServersAwsOfferingVmScannersConfiguration>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DefenderForServersAwsOfferingVmScannersConfiguration>)} interface");
            }
        ...
        string IPersistableModel<DefenderForServersAwsOfferingVmScannersConfiguration>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
