...
{
    public partial class DefenderForServersAwsOfferingVmScannersConfiguration : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static DefenderForServersAwsOfferingVmScannersConfiguration DeserializeDefenderForServersAwsOfferingVmScannersConfiguration(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
