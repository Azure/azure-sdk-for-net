...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public abstract partial class SecurityAutomationAction : IJsonModel<SecurityAutomationAction>
    {
        ...
        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual SecurityAutomationAction JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<SecurityAutomationAction>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static SecurityAutomationAction DeserializeSecurityAutomationAction(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return UnknownSecurityAutomationAction.DeserializeUnknownSecurityAutomationAction(element, options);
        }
    }
}
