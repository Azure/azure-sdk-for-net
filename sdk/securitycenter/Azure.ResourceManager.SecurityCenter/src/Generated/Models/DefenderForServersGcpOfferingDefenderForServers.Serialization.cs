...
{
    public partial class DefenderForServersGcpOfferingDefenderForServers : IUtf8JsonSerializable
    {
        ...
        internal static DefenderForServersGcpOfferingDefenderForServers DeserializeDefenderForServersGcpOfferingDefenderForServers(JsonElement element)
        {
            ...
            return new DefenderForServersGcpOfferingDefenderForServers(workloadIdentityProviderId.Value, serviceAccountEmailAddress.Value);
        }
    }
}
