...
namespace Azure.ResourceManager.SecurityCenter
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DeviceSecurityGroupData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DeviceSecurityGroupData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DeviceSecurityGroupData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DeviceSecurityGroupData>)} interface");
            }
        ...
        string IPersistableModel<DeviceSecurityGroupData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
