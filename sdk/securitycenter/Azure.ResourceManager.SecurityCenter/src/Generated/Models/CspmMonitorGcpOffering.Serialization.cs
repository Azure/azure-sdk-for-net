...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public partial class CspmMonitorGcpOffering : SecurityCenterCloudOffering, IJsonModel<CspmMonitorGcpOffering>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<CspmMonitorGcpOffering>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<CspmMonitorGcpOffering>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        CspmMonitorGcpOffering IPersistableModel<CspmMonitorGcpOffering>.Create(BinaryData data, ModelReaderWriterOptions options) => (CspmMonitorGcpOffering)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        CspmMonitorGcpOffering IJsonModel<CspmMonitorGcpOffering>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (CspmMonitorGcpOffering)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static CspmMonitorGcpOffering DeserializeCspmMonitorGcpOffering(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("nativeCloudConnection"u8))
                {
                    ...
                    nativeCloudConnection = CspmMonitorGcpOfferingNativeCloudConnection.DeserializeCspmMonitorGcpOfferingNativeCloudConnection(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
            ...
            return new CspmMonitorGcpOffering(offeringType, description, additionalBinaryDataProperties, nativeCloudConnection);
        }
    }
}
