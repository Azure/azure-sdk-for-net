...
{
    public partial class CspmMonitorGcpOffering : IUtf8JsonSerializable, IJsonModel<CspmMonitorGcpOffering>, IPersistableModel<CspmMonitorGcpOffering>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(NativeCloudConnection))
            {
                builder.Append("  nativeCloudConnection:");
                AppendChildObject(builder, NativeCloudConnection, options, 2);
            }
