...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    internal partial class UnknownCustomAlertRule : CustomAlertRule
    {
        ...
        internal UnknownCustomAlertRule(string displayName, string description, bool isEnabled, string ruleType, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(displayName, description, isEnabled, ruleType, serializedAdditionalRawData)
        {
