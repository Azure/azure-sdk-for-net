...
namespace Azure.ResourceManager.SecurityCenter
{
    public partial class AlertData : IUtf8JsonSerializable
    {
        ...
        internal static AlertData DeserializeAlertData(JsonElement element)
        {
            ...
            Optional<Intent> intent = default;
            ...
            Optional<AlertPropertiesSupportingEvidence> supportingEvidence = default;
                ...
                if (property.NameEquals("properties"))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("supportingEvidence"))
                        {
                            ...
                            supportingEvidence = AlertPropertiesSupportingEvidence.DeserializeAlertPropertiesSupportingEvidence(property0.Value);
                            continue;
                        }
                    }
                    continue;
