...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    public partial class DefenderForServersAwsOffering : IUtf8JsonSerializable, IModelJsonSerializable<DefenderForServersAwsOffering>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<DefenderForServersAwsOffering>(this, options.Format);
        ...
        internal static DefenderForServersAwsOffering DeserializeDefenderForServersAwsOffering(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new DefenderForServersAwsOffering(offeringType, description.Value, defenderForServers.Value, arcAutoProvisioning.Value, vaAutoProvisioning.Value, mdeAutoProvisioning.Value, subPlan.Value, vmScanners.Value, serializedAdditionalRawData);
        }
