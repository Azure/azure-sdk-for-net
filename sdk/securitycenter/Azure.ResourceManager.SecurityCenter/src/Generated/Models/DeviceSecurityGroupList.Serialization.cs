...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DeviceSecurityGroupList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DeviceSecurityGroupList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DeviceSecurityGroupList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DeviceSecurityGroupList>)} interface");
            }
        ...
        string IPersistableModel<DeviceSecurityGroupList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
