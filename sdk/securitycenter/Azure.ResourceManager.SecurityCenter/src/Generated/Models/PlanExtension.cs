...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public partial class PlanExtension
    {
        ...
        internal PlanExtension(string name, IsExtensionEnabled isEnabled, IDictionary<string, BinaryData> additionalExtensionProperties, OperationStatusAutoGenerated operationStatus)
        {
            Name = name;
            IsEnabled = isEnabled;
