...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public partial class DataExportSettings : SecuritySettingData
    {
        ...
        internal DataExportSettings(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, SettingKind kind, bool? isEnabled, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData, kind, rawData)
        {
            IsEnabled = isEnabled;
            Kind = kind;
        }
