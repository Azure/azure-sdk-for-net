...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="AutomationActionWorkspace"/>. </summary>
        public AutomationActionWorkspace() : base(ActionType.Workspace)
        {
        }
        ...
        internal AutomationActionWorkspace(ActionType actionType, IDictionary<string, BinaryData> additionalBinaryDataProperties, string workspaceResourceId) : base(actionType, additionalBinaryDataProperties)
        {
