...
{
    public partial class ConnectionFromIPNotAllowed : Core.IUtf8JsonSerializable
    {
        ...
        internal static ConnectionFromIPNotAllowed DeserializeConnectionFromIPNotAllowed(JsonElement element)
        {
            ...
            return new ConnectionFromIPNotAllowed(displayName.Value, description.Value, isEnabled, ruleType, Core.Optional.ToNullable(valueType), allowlistValues);
        }
    }
}
