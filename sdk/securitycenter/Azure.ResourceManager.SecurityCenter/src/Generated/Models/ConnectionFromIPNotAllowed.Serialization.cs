...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ConnectionFromIPNotAllowed>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ConnectionFromIPNotAllowed>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ConnectionFromIPNotAllowed>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ConnectionFromIPNotAllowed>)} interface");
            }
        ...
        string IPersistableModel<ConnectionFromIPNotAllowed>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
