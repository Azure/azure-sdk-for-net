...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public partial class ConnectionFromIPNotAllowed : AllowlistCustomAlertRule, IJsonModel<ConnectionFromIPNotAllowed>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<ConnectionFromIPNotAllowed>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
                ...
                default:
                    throw new FormatException($"The model {nameof(ConnectionFromIPNotAllowed)} does not support reading '{options.Format}' format.");
            }
        }
        ...
        protected override BinaryData PersistableModelWriteCore(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ConnectionFromIPNotAllowed)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        protected override CustomAlertRule JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ConnectionFromIPNotAllowed)} does not support reading '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static ConnectionFromIPNotAllowed DeserializeConnectionFromIPNotAllowed(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            string ruleType = "ConnectionFromIpNotAllowed";
