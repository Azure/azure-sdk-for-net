...
{
    public partial class DefenderForServersGcpOffering : IUtf8JsonSerializable, IJsonModel<DefenderForServersGcpOffering>, IPersistableModel<DefenderForServersGcpOffering>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(VulnerabilityAssessmentAutoProvisioning))
            {
                ...
                AppendChildObject(builder, VulnerabilityAssessmentAutoProvisioning, options, 2);
            }
