...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DefenderForServersGcpOffering>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DefenderForServersGcpOffering>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DefenderForServersGcpOffering>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DefenderForServersGcpOffering>)} interface");
            }
        ...
        string IPersistableModel<DefenderForServersGcpOffering>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
