...
{
    internal partial class AwsInformationProtection : IUtf8JsonSerializable, IJsonModel<AwsInformationProtection>, IPersistableModel<AwsInformationProtection>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AwsInformationProtection>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<AwsInformationProtection>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AwsInformationProtection)} does not support '{format}' format.");
            }
