...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AwsInformationProtection>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AwsInformationProtection>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AwsInformationProtection>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AwsInformationProtection>)} interface");
            }
        ...
        string IPersistableModel<AwsInformationProtection>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
