...
{
    internal partial class AwsInformationProtection : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static AwsInformationProtection DeserializeAwsInformationProtection(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
