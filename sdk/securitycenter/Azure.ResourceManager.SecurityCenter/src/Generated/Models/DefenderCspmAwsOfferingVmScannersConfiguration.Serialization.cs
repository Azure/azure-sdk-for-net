...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DefenderCspmAwsOfferingVmScannersConfiguration>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<DefenderCspmAwsOfferingVmScannersConfiguration>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DefenderCspmAwsOfferingVmScannersConfiguration>)} interface");
            }
        ...
        string IPersistableModel<DefenderCspmAwsOfferingVmScannersConfiguration>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
