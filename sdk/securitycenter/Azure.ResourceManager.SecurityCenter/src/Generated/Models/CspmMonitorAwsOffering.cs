...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public partial class CspmMonitorAwsOffering : SecurityCenterCloudOffering
    {
        ...
        internal CspmMonitorAwsOffering(OfferingType offeringType, string description, CspmMonitorAwsOfferingNativeCloudConnection nativeCloudConnection, Dictionary<string, BinaryData> rawData) : base(offeringType, description, rawData)
        {
