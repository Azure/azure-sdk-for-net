...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public partial class SecurityCenterFileProtectionMode
    {
        ...
        internal SecurityCenterFileProtectionMode(AdaptiveApplicationControlEnforcementMode? exe, AdaptiveApplicationControlEnforcementMode? msi, AdaptiveApplicationControlEnforcementMode? script, AdaptiveApplicationControlEnforcementMode? executable, Dictionary<string, BinaryData> rawData)
        {
            Exe = exe;
            Msi = msi;
            Script = script;
