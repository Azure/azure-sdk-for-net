...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GcpParentOrganizationalInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<GcpParentOrganizationalInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<GcpParentOrganizationalInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<GcpParentOrganizationalInfo>)} interface");
            }
        ...
        string IPersistableModel<GcpParentOrganizationalInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
