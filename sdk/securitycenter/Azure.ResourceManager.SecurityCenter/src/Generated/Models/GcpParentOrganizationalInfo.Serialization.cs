...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GcpParentOrganizationalInfo>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        GcpParentOrganizationalInfo IJsonModel<GcpParentOrganizationalInfo>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        internal static GcpParentOrganizationalInfo DeserializeGcpParentOrganizationalInfo(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new GcpParentOrganizationalInfo(organizationMembershipType, serializedAdditionalRawData, Optional.ToList(excludedProjectNumbers), serviceAccountEmailAddress.Value, workloadIdentityProviderId.Value);
        }

        BinaryData IModel<GcpParentOrganizationalInfo>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        GcpParentOrganizationalInfo IModel<GcpParentOrganizationalInfo>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<GcpParentOrganizationalInfo>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
