...
{
    public partial class AzureDevOpsScopeEnvironment : IUtf8JsonSerializable, IJsonModel<AzureDevOpsScopeEnvironment>, IPersistableModel<AzureDevOpsScopeEnvironment>
    {
        ...
        void IJsonModel<AzureDevOpsScopeEnvironment>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AzureDevOpsScopeEnvironment)} does not support '{format}' format.");
            }
