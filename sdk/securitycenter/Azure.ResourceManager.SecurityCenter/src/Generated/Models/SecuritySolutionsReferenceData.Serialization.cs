...
{
    public partial class SecuritySolutionsReferenceData : IUtf8JsonSerializable, IJsonModel<SecuritySolutionsReferenceData>, IPersistableModel<SecuritySolutionsReferenceData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  securityFamily:");
                builder.AppendLine($" '{SecurityFamily.ToString()}'");
            }

            if (Optional.IsDefined(AlertVendorName))
            {
                builder.Append("  alertVendorName:");
                builder.AppendLine($" '{AlertVendorName}'");
            }

            if (Optional.IsDefined(PackageInfoUri))
            {
                builder.Append("  packageInfoUrl:");
                builder.AppendLine($" '{PackageInfoUri.AbsoluteUri}'");
            }
