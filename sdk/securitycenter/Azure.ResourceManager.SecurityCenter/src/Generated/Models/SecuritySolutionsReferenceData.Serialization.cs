...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SecuritySolutionsReferenceData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SecuritySolutionsReferenceData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SecuritySolutionsReferenceData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SecuritySolutionsReferenceData>)} interface");
            }
        ...
        string IPersistableModel<SecuritySolutionsReferenceData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
