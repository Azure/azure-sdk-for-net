...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SecurityAutomationValidationStatus>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SecurityAutomationValidationStatus>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SecurityAutomationValidationStatus>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SecurityAutomationValidationStatus>)} interface");
            }
        ...
        string IPersistableModel<SecurityAutomationValidationStatus>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
