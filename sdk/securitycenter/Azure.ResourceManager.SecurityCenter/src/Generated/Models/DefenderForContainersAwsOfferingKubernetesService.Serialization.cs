...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DefenderForContainersAwsOfferingKubernetesService>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        DefenderForContainersAwsOfferingKubernetesService IJsonModel<DefenderForContainersAwsOfferingKubernetesService>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<DefenderForContainersAwsOfferingKubernetesService>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        DefenderForContainersAwsOfferingKubernetesService IModel<DefenderForContainersAwsOfferingKubernetesService>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<DefenderForContainersAwsOfferingKubernetesService>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
