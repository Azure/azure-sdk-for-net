...
{
    public partial class BuiltInInfoType : IUtf8JsonSerializable, IJsonModel<BuiltInInfoType>, IPersistableModel<BuiltInInfoType>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  type:");
                builder.AppendLine($" '{BuiltInInfoTypeValue}'");
            }
