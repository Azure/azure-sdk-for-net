...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public partial class AdaptiveNetworkHardeningEnforceContent
    {
        ...
        internal AdaptiveNetworkHardeningEnforceContent(IList<RecommendedSecurityRule> rules, IList<string> networkSecurityGroups, Dictionary<string, BinaryData> rawData)
        {
            Rules = rules;
