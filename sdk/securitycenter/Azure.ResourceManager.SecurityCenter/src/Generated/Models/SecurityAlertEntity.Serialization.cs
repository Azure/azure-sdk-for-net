...
{
    public partial class SecurityAlertEntity : IUtf8JsonSerializable, IJsonModel<SecurityAlertEntity>, IPersistableModel<SecurityAlertEntity>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  type:");
                builder.AppendLine($" '{AlertEntityType}'");
            }
