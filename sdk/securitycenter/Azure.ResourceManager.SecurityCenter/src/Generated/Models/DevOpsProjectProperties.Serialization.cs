...
{
    public partial class DevOpsProjectProperties : IUtf8JsonSerializable, IJsonModel<DevOpsProjectProperties>, IPersistableModel<DevOpsProjectProperties>
    {
        ...
        internal static DevOpsProjectProperties DeserializeDevOpsProjectProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new DevOpsProjectProperties(provisioningStatusMessage.Value, Optional.ToNullable(provisioningStatusUpdateTimeUtc), Optional.ToNullable(provisioningState), parentOrgName.Value, projectId.Value, Optional.ToNullable(onboardingState), actionableRemediation.Value, serializedAdditionalRawData);
        }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ProvisioningStatusUpdatedOn))
            {
                ...
                builder.AppendLine($" '{ProvisioningStatusUpdatedOn.Value.ToString()}'");
            }
