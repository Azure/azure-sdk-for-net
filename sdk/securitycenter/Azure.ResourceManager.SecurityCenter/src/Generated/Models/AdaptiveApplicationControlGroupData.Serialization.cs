...
namespace Azure.ResourceManager.SecurityCenter
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AdaptiveApplicationControlGroupData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AdaptiveApplicationControlGroupData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AdaptiveApplicationControlGroupData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AdaptiveApplicationControlGroupData>)} interface");
            }
        ...
        string IPersistableModel<AdaptiveApplicationControlGroupData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
