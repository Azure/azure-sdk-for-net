...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    public partial class SecurityCenterFileProtectionMode : IUtf8JsonSerializable, IJsonModel<SecurityCenterFileProtectionMode>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  exe:");
                builder.AppendLine($" '{Exe.Value.ToString()}'");
            }

            if (Optional.IsDefined(Msi))
            {
                builder.Append("  msi:");
                builder.AppendLine($" '{Msi.Value.ToString()}'");
            }

            if (Optional.IsDefined(Script))
            {
                builder.Append("  script:");
                builder.AppendLine($" '{Script.Value.ToString()}'");
            }

            if (Optional.IsDefined(Executable))
            {
                builder.Append("  executable:");
                builder.AppendLine($" '{Executable.Value.ToString()}'");
            }
