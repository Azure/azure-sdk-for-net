...
{
    public partial class SecurityCenterFileProtectionMode : IUtf8JsonSerializable, IJsonModel<SecurityCenterFileProtectionMode>, IPersistableModel<SecurityCenterFileProtectionMode>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  exe:");
                builder.AppendLine($" '{Exe.ToString()}'");
            }

            if (Optional.IsDefined(Msi))
            {
                builder.Append("  msi:");
                builder.AppendLine($" '{Msi.ToString()}'");
            }
            ...
            if (Optional.IsDefined(Executable))
            {
                ...
                builder.AppendLine($" '{Executable.ToString()}'");
            }
