...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AllowlistCustomAlertRule>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AllowlistCustomAlertRule>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AllowlistCustomAlertRule>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AllowlistCustomAlertRule>)} interface");
            }
        ...
        string IPersistableModel<AllowlistCustomAlertRule>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
