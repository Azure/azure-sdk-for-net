...
{
    public partial class DefenderForStorageSettingData : IUtf8JsonSerializable, IJsonModel<DefenderForStorageSettingData>, IPersistableModel<DefenderForStorageSettingData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SensitiveDataDiscoveryOperationStatus))
            {
                ...
                AppendChildObject(builder, SensitiveDataDiscoveryOperationStatus, options, 2);
            }
            ...
            {
                builder.Append("  operationStatus:");
                AppendChildObject(builder, MalwareScanningOperationStatus, options, 2);
            }
            ...
            if (Optional.IsDefined(CapGBPerMonth))
            {
                ...
                builder.AppendLine($" '{CapGBPerMonth.Value.ToString()}'");
            }
