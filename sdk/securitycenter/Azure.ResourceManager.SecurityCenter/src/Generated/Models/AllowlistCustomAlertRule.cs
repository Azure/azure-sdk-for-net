...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public partial class AllowlistCustomAlertRule : ListCustomAlertRule
    {
        ...
        internal AllowlistCustomAlertRule(string displayName, string description, bool isEnabled, string ruleType, SecurityValueType? valueType, IList<string> allowlistValues, Dictionary<string, BinaryData> rawData) : base(displayName, description, isEnabled, ruleType, valueType, rawData)
        {
