...
{
    public partial class DefenderCspmAwsOfferingDataSensitivityDiscovery : IUtf8JsonSerializable, IJsonModel<DefenderCspmAwsOfferingDataSensitivityDiscovery>, IPersistableModel<DefenderCspmAwsOfferingDataSensitivityDiscovery>
    {
        ...
        void IJsonModel<DefenderCspmAwsOfferingDataSensitivityDiscovery>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DefenderCspmAwsOfferingDataSensitivityDiscovery)} does not support '{format}' format.");
            }
        ...
        internal static DefenderCspmAwsOfferingDataSensitivityDiscovery DeserializeDefenderCspmAwsOfferingDataSensitivityDiscovery(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new DefenderCspmAwsOfferingDataSensitivityDiscovery(Optional.ToNullable(enabled), cloudRoleArn.Value, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<DefenderCspmAwsOfferingDataSensitivityDiscovery>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(DefenderCspmAwsOfferingDataSensitivityDiscovery)} does not support '{options.Format}' format.");
            }
        }
