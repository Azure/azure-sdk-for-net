...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public partial class SecurityContactPropertiesNotificationsByRole
    {
        ...
        internal SecurityContactPropertiesNotificationsByRole(SecurityAlertNotificationByRoleState? state, IList<SecurityAlertReceivingRole> roles, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            State = state;
            Roles = roles;
