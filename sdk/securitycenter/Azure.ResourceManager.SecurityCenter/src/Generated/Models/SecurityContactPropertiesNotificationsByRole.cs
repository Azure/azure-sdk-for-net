...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public partial class SecurityContactPropertiesNotificationsByRole
    {
        ...
        internal SecurityContactPropertiesNotificationsByRole(SecurityAlertNotificationByRoleState? state, IList<SecurityAlertReceivingRole> roles, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            State = state;
            Roles = roles;
