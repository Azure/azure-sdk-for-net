...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public partial class OnPremiseResourceDetails : SecurityCenterResourceDetails
    {
        ...
        internal OnPremiseResourceDetails(Source source, ResourceIdentifier workspaceId, Guid vmUuid, string sourceComputerId, string machineName, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(source, serializedAdditionalRawData)
        {
            WorkspaceId = workspaceId;
            VmUuid = vmUuid;
            SourceComputerId = sourceComputerId;
