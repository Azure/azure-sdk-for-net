...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SecurityAssessmentStatus>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SecurityAssessmentStatus>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SecurityAssessmentStatus>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SecurityAssessmentStatus>)} interface");
            }
        ...
        string IPersistableModel<SecurityAssessmentStatus>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
