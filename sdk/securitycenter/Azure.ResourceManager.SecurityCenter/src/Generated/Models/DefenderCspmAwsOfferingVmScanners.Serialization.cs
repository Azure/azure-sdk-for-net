...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DefenderCspmAwsOfferingVmScanners>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DefenderCspmAwsOfferingVmScanners>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DefenderCspmAwsOfferingVmScanners>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DefenderCspmAwsOfferingVmScanners>)} interface");
            }
        ...
        string IPersistableModel<DefenderCspmAwsOfferingVmScanners>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
