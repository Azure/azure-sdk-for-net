...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DefenderCspmAwsOfferingVmScanners>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Configuration))
            {
                ...
                ((IJsonModel<DefenderCspmAwsOfferingVmScannersConfiguration>)Configuration).Write(writer, options);
            }
        ...
        internal static DefenderCspmAwsOfferingVmScanners DeserializeDefenderCspmAwsOfferingVmScanners(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("configuration"u8))
                {
                    ...
                    configuration = ModelSerializationExtensions.JsonDeserialize<DefenderCspmAwsOfferingVmScannersConfiguration>(property.Value);
                    continue;
                }
                if (options.Format != "W")
                {
