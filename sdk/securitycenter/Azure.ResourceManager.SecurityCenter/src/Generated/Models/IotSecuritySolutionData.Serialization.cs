...
namespace Azure.ResourceManager.SecurityCenter
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IotSecuritySolutionData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<IotSecuritySolutionData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<IotSecuritySolutionData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<IotSecuritySolutionData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
