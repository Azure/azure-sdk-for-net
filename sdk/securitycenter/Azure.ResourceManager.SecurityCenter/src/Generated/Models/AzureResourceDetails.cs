...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public partial class AzureResourceDetails : SecurityCenterResourceDetails
    {
        ...
        internal AzureResourceDetails(Source source, string id, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(source, serializedAdditionalRawData)
        {
            Id = id;
            Source = source;
        }
