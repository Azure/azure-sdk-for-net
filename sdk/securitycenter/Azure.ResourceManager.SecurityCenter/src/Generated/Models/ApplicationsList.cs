...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    internal partial class ApplicationsList
    {
        ...
        {
            Value = new ChangeTrackingList<SecurityConnectorApplicationData>();
        }
        ...
        internal ApplicationsList(IReadOnlyList<SecurityConnectorApplicationData> value, string nextLink, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            NextLink = nextLink;
        ...
        public IReadOnlyList<SecurityConnectorApplicationData> Value { get; }
