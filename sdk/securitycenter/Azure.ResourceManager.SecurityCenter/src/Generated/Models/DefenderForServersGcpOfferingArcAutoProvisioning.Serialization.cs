...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DefenderForServersGcpOfferingArcAutoProvisioning>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<DefenderForServersGcpOfferingArcAutoProvisioning>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<DefenderForServersGcpOfferingArcAutoProvisioning>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
