...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public partial class MqttC2DMessagesNotInAllowedRange : TimeWindowCustomAlertRule
    {
        ...
        /// <param name="maxThreshold"> The maximum threshold. </param>
        /// <param name="timeWindowSize"> The time window size in iso8601 format. </param>
        internal MqttC2DMessagesNotInAllowedRange(string displayName, string description, bool isEnabled, string ruleType, int minThreshold, int maxThreshold, TimeSpan timeWindowSize) : base(displayName, description, isEnabled, ruleType, minThreshold, maxThreshold, timeWindowSize)
        {
            RuleType = ruleType ?? "MqttC2DMessagesNotInAllowedRange";
        }
    }
}
