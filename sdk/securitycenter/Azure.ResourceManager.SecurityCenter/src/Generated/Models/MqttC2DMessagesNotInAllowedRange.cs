...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public partial class MqttC2DMessagesNotInAllowedRange : TimeWindowCustomAlertRule
    {
        ...
        internal MqttC2DMessagesNotInAllowedRange(string displayName, string description, bool isEnabled, string ruleType, int minThreshold, int maxThreshold, TimeSpan timeWindowSize, Dictionary<string, BinaryData> rawData) : base(displayName, description, isEnabled, ruleType, minThreshold, maxThreshold, timeWindowSize, rawData)
        {
            RuleType = ruleType ?? "MqttC2DMessagesNotInAllowedRange";
        }

        /// <summary> Initializes a new instance of <see cref="MqttC2DMessagesNotInAllowedRange"/> for deserialization. </summary>
        internal MqttC2DMessagesNotInAllowedRange()
        {
        }
    }
