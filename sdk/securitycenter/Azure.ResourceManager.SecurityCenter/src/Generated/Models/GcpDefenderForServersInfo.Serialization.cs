...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public partial class GcpDefenderForServersInfo : IJsonModel<GcpDefenderForServersInfo>
    {
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual GcpDefenderForServersInfo PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<GcpDefenderForServersInfo>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<GcpDefenderForServersInfo>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        GcpDefenderForServersInfo IPersistableModel<GcpDefenderForServersInfo>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        GcpDefenderForServersInfo IJsonModel<GcpDefenderForServersInfo>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual GcpDefenderForServersInfo JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<GcpDefenderForServersInfo>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static GcpDefenderForServersInfo DeserializeGcpDefenderForServersInfo(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new GcpDefenderForServersInfo(workloadIdentityProviderId, serviceAccountEmailAddress, additionalBinaryDataProperties);
        }
    }
}
