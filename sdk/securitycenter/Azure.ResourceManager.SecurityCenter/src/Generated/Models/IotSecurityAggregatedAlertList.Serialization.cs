...
{
    internal partial class IotSecurityAggregatedAlertList : IUtf8JsonSerializable, IJsonModel<IotSecurityAggregatedAlertList>, IPersistableModel<IotSecurityAggregatedAlertList>
    {
        ...
        void IJsonModel<IotSecurityAggregatedAlertList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(IotSecurityAggregatedAlertList)} does not support '{format}' format.");
            }
