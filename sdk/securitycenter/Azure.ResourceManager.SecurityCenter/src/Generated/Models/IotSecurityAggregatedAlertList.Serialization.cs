...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IotSecurityAggregatedAlertList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<IotSecurityAggregatedAlertList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<IotSecurityAggregatedAlertList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<IotSecurityAggregatedAlertList>)} interface");
            }
        ...
        string IPersistableModel<IotSecurityAggregatedAlertList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
