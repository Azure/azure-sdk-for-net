...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public partial class JitNetworkAccessPortRule
    {
        ...
        internal JitNetworkAccessPortRule(int number, JitNetworkAccessPortProtocol protocol, string allowedSourceAddressPrefix, IList<string> allowedSourceAddressPrefixes, TimeSpan maxRequestAccessDuration, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Number = number;
            Protocol = protocol;
