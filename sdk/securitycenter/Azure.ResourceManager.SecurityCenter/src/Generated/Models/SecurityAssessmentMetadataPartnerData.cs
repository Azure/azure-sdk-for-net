...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    {
        /// <summary> Initializes a new instance of SecurityAssessmentMetadataPartnerData. </summary>
        ...
        /// <param name="secret"> Secret to authenticate the partner and verify it created the assessment - write only. </param>
        internal SecurityAssessmentMetadataPartnerData(string partnerName, string productName, string secret)
        {
            PartnerName = partnerName;
