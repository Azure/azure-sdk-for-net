...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public partial class SecurityAutomationActionEventHub : SecurityAutomationAction
    {
        ...
        internal SecurityAutomationActionEventHub(ActionType actionType, ResourceIdentifier eventHubResourceId, string sasPolicyName, string connectionString, Dictionary<string, BinaryData> rawData) : base(actionType, rawData)
        {
