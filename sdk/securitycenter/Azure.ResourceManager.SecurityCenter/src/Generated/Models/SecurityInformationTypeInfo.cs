...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public partial class SecurityInformationTypeInfo
    {
        ...
        internal SecurityInformationTypeInfo(string displayName, string description, int? order, Guid? recommendedLabelId, bool? isEnabled, bool? custom, IList<InformationProtectionKeyword> keywords, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
