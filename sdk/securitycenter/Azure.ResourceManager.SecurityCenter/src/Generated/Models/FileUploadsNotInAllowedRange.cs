...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public partial class FileUploadsNotInAllowedRange : TimeWindowCustomAlertRule
    {
        ...
        internal FileUploadsNotInAllowedRange(string displayName, string description, bool isEnabled, string ruleType, int minThreshold, int maxThreshold, TimeSpan timeWindowSize, Dictionary<string, BinaryData> rawData) : base(displayName, description, isEnabled, ruleType, minThreshold, maxThreshold, timeWindowSize, rawData)
        {
            RuleType = ruleType ?? "FileUploadsNotInAllowedRange";
        }

        /// <summary> Initializes a new instance of <see cref="FileUploadsNotInAllowedRange"/> for deserialization. </summary>
        internal FileUploadsNotInAllowedRange()
        {
        }
    }
}
