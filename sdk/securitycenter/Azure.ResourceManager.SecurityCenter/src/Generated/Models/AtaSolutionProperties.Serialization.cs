...
{
    public partial class AtaSolutionProperties : IUtf8JsonSerializable, IJsonModel<AtaSolutionProperties>, IPersistableModel<AtaSolutionProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(LastEventReceived))
            {
                builder.Append("  lastEventReceived:");
                builder.AppendLine($" '{LastEventReceived}'");
            }
            ...
            if (Optional.IsDefined(Workspace))
            {
                ...
                AppendChildObject(builder, Workspace, options, 2);
            }
