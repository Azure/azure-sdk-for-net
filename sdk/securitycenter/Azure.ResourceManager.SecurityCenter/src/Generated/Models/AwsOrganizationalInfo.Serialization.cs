...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AwsOrganizationalInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AwsOrganizationalInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AwsOrganizationalInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AwsOrganizationalInfo>)} interface");
            }
        ...
        string IPersistableModel<AwsOrganizationalInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
