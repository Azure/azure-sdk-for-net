...
{
    public partial class SecuritySubAssessmentAdditionalInfo : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static SecuritySubAssessmentAdditionalInfo DeserializeSecuritySubAssessmentAdditionalInfo(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
