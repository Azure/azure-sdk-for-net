...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public partial class SecuritySubAssessmentAdditionalInfo : IUtf8JsonSerializable, IJsonModel<SecuritySubAssessmentAdditionalInfo>, IPersistableModel<SecuritySubAssessmentAdditionalInfo>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(AssessedResourceType))
            {
                builder.Append("  assessedResourceType:");
                builder.AppendLine($" '{AssessedResourceType.ToString()}'");
            }
