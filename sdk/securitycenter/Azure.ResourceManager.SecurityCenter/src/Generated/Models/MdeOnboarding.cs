...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public partial class MdeOnboarding : ResourceData
    {
        ...
        internal MdeOnboarding(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, byte[] onboardingPackageWindows, byte[] onboardingPackageLinux, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData)
        {
