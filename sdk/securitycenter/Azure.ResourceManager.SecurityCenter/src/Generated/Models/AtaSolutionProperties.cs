...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public partial class AtaSolutionProperties : ExternalSecuritySolutionProperties
    {
        ...
        internal AtaSolutionProperties(string deviceVendor, string deviceType, ConnectedWorkspace workspace, IReadOnlyDictionary<string, BinaryData> additionalProperties, string lastEventReceived) : base(deviceVendor, deviceType, workspace, additionalProperties)
        {
