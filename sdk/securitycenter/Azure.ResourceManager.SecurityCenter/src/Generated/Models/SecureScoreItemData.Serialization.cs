...
{
    public partial class SecureScoreItemData : IUtf8JsonSerializable
    {
        ...
        internal static SecureScoreItemData DeserializeSecureScoreItemData(JsonElement element)
        {
            ...
            return new SecureScoreItemData(id, name, type, systemData.Value, displayName.Value, Optional.ToNullable(weight), Optional.ToNullable(max), Optional.ToNullable(current), Optional.ToNullable(percentage));
        }
    }
}
