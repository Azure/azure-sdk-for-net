...
namespace Azure.ResourceManager.SecurityCenter
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SecurityCenterLocationData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SecurityCenterLocationData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SecurityCenterLocationData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SecurityCenterLocationData>)} interface");
            }
        ...
        string IPersistableModel<SecurityCenterLocationData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
