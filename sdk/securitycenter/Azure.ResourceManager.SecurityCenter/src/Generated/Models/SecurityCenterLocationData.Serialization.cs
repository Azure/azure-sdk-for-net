...
{
    public partial class SecurityCenterLocationData : IUtf8JsonSerializable
    {
        ...
        internal static SecurityCenterLocationData DeserializeSecurityCenterLocationData(JsonElement element)
        {
            ...
            return new SecurityCenterLocationData(id, name, type, systemData.Value, properties.Value);
        }
    }
}
