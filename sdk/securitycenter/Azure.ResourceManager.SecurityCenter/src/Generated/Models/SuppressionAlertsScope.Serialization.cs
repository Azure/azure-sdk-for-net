...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    internal partial class SuppressionAlertsScope : IUtf8JsonSerializable, IJsonModel<SuppressionAlertsScope>
    {
        ...
        void IJsonModel<SuppressionAlertsScope>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(SuppressionAlertsScope)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<SuppressionAlertsScope>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(SuppressionAlertsScope)} does not support '{options.Format}' format.");
            }
        }
