...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    internal partial class SuppressionAlertsScope : IUtf8JsonSerializable, IJsonModel<SuppressionAlertsScope>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<SuppressionAlertsScope>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SuppressionAlertsScope>)} interface");
            }
