...
{
    public partial class AutomationData : IUtf8JsonSerializable
    {
        ...
        internal static AutomationData DeserializeAutomationData(JsonElement element)
        {
            ...
            Optional<IList<AutomationSource>> sources = default;
                ...
                if (property.NameEquals("properties"))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("sources"))
                        {
                            ...
                            foreach (var item in property0.Value.EnumerateArray())
                            {
                                array.Add(AutomationSource.DeserializeAutomationSource(item));
                            }
                            sources = array;
                            continue;
                        }
            ...
            return new AutomationData(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, description.Value, Optional.ToNullable(isEnabled), Optional.ToList(scopes), Optional.ToList(sources), Optional.ToList(actions), kind.Value, Optional.ToNullable(etag));
        }
    }
}
