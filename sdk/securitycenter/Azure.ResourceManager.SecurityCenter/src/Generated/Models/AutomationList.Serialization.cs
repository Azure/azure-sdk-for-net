...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AutomationList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AutomationList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AutomationList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AutomationList>)} interface");
            }
        ...
        string IPersistableModel<AutomationList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
