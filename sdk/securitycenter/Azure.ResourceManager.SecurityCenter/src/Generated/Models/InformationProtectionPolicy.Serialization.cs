...
{
    public partial class InformationProtectionPolicy : IUtf8JsonSerializable, IJsonModel<InformationProtectionPolicy>, IPersistableModel<InformationProtectionPolicy>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(LastModifiedUtc))
            {
                ...
                builder.AppendLine($" '{LastModifiedUtc.Value.ToString()}'");
            }
            ...
            if (Optional.IsCollectionDefined(InformationTypes))
            {
                builder.Append("  informationTypes:");
                builder.AppendLine(" {");
                foreach (var item in InformationTypes)
                {
                    builder.Append($"    {item.Key}: ");
