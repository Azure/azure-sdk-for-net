...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataExportSettings>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DataExportSettings>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DataExportSettings>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DataExportSettings>)} interface");
            }
        ...
        string IPersistableModel<DataExportSettings>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
