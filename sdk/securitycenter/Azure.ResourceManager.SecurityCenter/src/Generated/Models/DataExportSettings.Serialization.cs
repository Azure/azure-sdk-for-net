...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public partial class DataExportSettings : SecuritySettingData, IJsonModel<DataExportSettings>
    {
        ...
        internal static DataExportSettings DeserializeDataExportSettings(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = DataExportSettingProperties.DeserializeDataExportSettingProperties(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
