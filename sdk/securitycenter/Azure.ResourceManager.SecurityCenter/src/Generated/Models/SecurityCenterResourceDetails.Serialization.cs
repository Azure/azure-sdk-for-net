...
{
    public partial class SecurityCenterResourceDetails : IUtf8JsonSerializable, IModelJsonSerializable<SecurityCenterResourceDetails>
    {
        ...
        internal static SecurityCenterResourceDetails DeserializeSecurityCenterResourceDetails(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new UnknownResourceDetails(source, rawData);
        }
        ...
        /// <summary> Converts a <see cref="SecurityCenterResourceDetails"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="SecurityCenterResourceDetails"/> to convert. </param>
        public static implicit operator RequestContent(SecurityCenterResourceDetails model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="SecurityCenterResourceDetails"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator SecurityCenterResourceDetails(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeSecurityCenterResourceDetails(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
