...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public partial class Rule
    {
        ...
        public Rule()
        {
            Protocols = new ChangeTrackingList<TransportProtocol>();
        ...
        internal Rule(string name, Direction? direction, int? destinationPort, IList<TransportProtocol> protocols, IList<string> ipAddresses)
        {
            Name = name;
            Direction = direction;
        ...
        public IList<TransportProtocol> Protocols { get; }
