...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public partial class CspmMonitorGithubOffering : SecurityCenterCloudOffering
    {
        ...
        internal CspmMonitorGithubOffering(OfferingType offeringType, string description, Dictionary<string, BinaryData> rawData) : base(offeringType, description, rawData)
        {
