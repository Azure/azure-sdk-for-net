...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public partial class JitNetworkAccessRequestPort
    {
        ...
        internal JitNetworkAccessRequestPort(int number, string allowedSourceAddressPrefix, IList<string> allowedSourceAddressPrefixes, DateTimeOffset endOn, JitNetworkAccessPortStatus status, JitNetworkAccessPortStatusReason statusReason, int? mappedPort, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Number = number;
