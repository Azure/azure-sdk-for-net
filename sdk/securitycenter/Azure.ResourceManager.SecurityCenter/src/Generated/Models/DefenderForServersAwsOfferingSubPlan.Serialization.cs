...
{
    internal partial class DefenderForServersAwsOfferingSubPlan : IUtf8JsonSerializable, IJsonModel<DefenderForServersAwsOfferingSubPlan>, IPersistableModel<DefenderForServersAwsOfferingSubPlan>
    {
        ...
        void IJsonModel<DefenderForServersAwsOfferingSubPlan>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DefenderForServersAwsOfferingSubPlan)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  type:");
                builder.AppendLine($" '{AvailableSubPlanType.ToString()}'");
            }
