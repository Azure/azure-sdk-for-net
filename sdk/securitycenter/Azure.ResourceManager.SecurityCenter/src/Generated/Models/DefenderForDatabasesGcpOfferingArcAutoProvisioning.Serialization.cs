...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    internal partial class DefenderForDatabasesGcpOfferingArcAutoProvisioning : IUtf8JsonSerializable, IJsonModel<DefenderForDatabasesGcpOfferingArcAutoProvisioning>
    {
        ...
        void IJsonModel<DefenderForDatabasesGcpOfferingArcAutoProvisioning>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(DefenderForDatabasesGcpOfferingArcAutoProvisioning)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<DefenderForDatabasesGcpOfferingArcAutoProvisioning>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(DefenderForDatabasesGcpOfferingArcAutoProvisioning)} does not support '{options.Format}' format.");
            }
        }
