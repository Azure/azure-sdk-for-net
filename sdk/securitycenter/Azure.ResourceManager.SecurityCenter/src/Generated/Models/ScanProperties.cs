...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public partial class ScanProperties
    {
        ...
        internal ScanProperties(ScanTriggerType? triggerType, ScanState? state, string server, string database, string sqlVersion, DateTimeOffset? startOn, DateTimeOffset? endOn, int? highSeverityFailedRulesCount, int? mediumSeverityFailedRulesCount, int? lowSeverityFailedRulesCount, int? totalPassedRulesCount, int? totalFailedRulesCount, int? totalRulesCount, bool? isBaselineApplied)
        {
