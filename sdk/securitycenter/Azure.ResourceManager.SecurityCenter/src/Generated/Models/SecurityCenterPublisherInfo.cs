...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public partial class SecurityCenterPublisherInfo
    {
        ...
        internal SecurityCenterPublisherInfo(string publisherName, string productName, string binaryName, string version, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
