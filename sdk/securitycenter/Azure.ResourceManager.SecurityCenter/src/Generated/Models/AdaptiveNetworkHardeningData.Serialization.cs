...
namespace Azure.ResourceManager.SecurityCenter
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AdaptiveNetworkHardeningData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AdaptiveNetworkHardeningData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AdaptiveNetworkHardeningData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AdaptiveNetworkHardeningData>)} interface");
            }
        ...
        string IPersistableModel<AdaptiveNetworkHardeningData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
