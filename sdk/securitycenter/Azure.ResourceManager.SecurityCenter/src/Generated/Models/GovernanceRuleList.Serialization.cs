...
{
    internal partial class GovernanceRuleList : IUtf8JsonSerializable, IJsonModel<GovernanceRuleList>, IPersistableModel<GovernanceRuleList>
    {
        ...
        void IJsonModel<GovernanceRuleList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(GovernanceRuleList)} does not support '{format}' format.");
            }
