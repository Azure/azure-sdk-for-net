...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GovernanceRuleList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<GovernanceRuleList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<GovernanceRuleList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<GovernanceRuleList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
