...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public partial class SecureScoreControlDetails : ResourceData, IJsonModel<SecureScoreControlDetails>
    {
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual ResourceData PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<SecureScoreControlDetails>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<SecureScoreControlDetails>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        SecureScoreControlDetails IPersistableModel<SecureScoreControlDetails>.Create(BinaryData data, ModelReaderWriterOptions options) => (SecureScoreControlDetails)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        SecureScoreControlDetails IJsonModel<SecureScoreControlDetails>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (SecureScoreControlDetails)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static SecureScoreControlDetails DeserializeSecureScoreControlDetails(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            SecureScoreControlScoreDetails properties = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = SecureScoreControlScoreDetails.DeserializeSecureScoreControlScoreDetails(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
