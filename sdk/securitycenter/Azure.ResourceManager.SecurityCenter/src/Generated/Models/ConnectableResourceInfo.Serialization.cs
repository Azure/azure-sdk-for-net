...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ConnectableResourceInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ConnectableResourceInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ConnectableResourceInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ConnectableResourceInfo>)} interface");
            }
        ...
        string IPersistableModel<ConnectableResourceInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
