...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public partial class GcpMemberOrganizationalInfo : GcpOrganizationalInfo
    {
        ...
        internal GcpMemberOrganizationalInfo(OrganizationMembershipType organizationMembershipType, string parentHierarchyId, string managementProjectNumber, Dictionary<string, BinaryData> rawData) : base(organizationMembershipType, rawData)
        {
