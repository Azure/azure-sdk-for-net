...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    {
        internal static AlertsSuppressionRulesList DeserializeAlertsSuppressionRulesList(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
