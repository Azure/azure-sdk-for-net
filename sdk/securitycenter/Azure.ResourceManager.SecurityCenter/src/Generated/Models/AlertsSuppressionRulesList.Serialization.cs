...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AlertsSuppressionRulesList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AlertsSuppressionRulesList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AlertsSuppressionRulesList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<AlertsSuppressionRulesList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
