...
{
    internal partial class AlertsSuppressionRulesList : IUtf8JsonSerializable, IJsonModel<AlertsSuppressionRulesList>, IPersistableModel<AlertsSuppressionRulesList>
    {
        ...
        void IJsonModel<AlertsSuppressionRulesList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AlertsSuppressionRulesList)} does not support '{format}' format.");
            }
