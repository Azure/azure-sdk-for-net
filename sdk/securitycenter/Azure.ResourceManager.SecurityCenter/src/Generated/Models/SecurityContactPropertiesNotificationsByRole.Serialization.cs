...
{
    public partial class SecurityContactPropertiesNotificationsByRole : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static SecurityContactPropertiesNotificationsByRole DeserializeSecurityContactPropertiesNotificationsByRole(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
