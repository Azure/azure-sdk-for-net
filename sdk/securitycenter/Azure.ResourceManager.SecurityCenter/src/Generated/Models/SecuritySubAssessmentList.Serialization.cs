...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    {
        internal static SecuritySubAssessmentList DeserializeSecuritySubAssessmentList(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
