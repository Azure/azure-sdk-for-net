...
{
    public partial class DefenderForServersAwsOfferingArcAutoProvisioning : IUtf8JsonSerializable, IJsonModel<DefenderForServersAwsOfferingArcAutoProvisioning>, IPersistableModel<DefenderForServersAwsOfferingArcAutoProvisioning>
    {
        ...
        void IJsonModel<DefenderForServersAwsOfferingArcAutoProvisioning>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DefenderForServersAwsOfferingArcAutoProvisioning)} does not support '{format}' format.");
            }
