...
{
    public partial class EffectiveNetworkSecurityGroups : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static EffectiveNetworkSecurityGroups DeserializeEffectiveNetworkSecurityGroups(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
