...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    {
        internal static IotSecuritySolutionsList DeserializeIotSecuritySolutionsList(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
