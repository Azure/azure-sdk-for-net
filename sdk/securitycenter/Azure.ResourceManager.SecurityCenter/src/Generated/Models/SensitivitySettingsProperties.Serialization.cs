...
{
    public partial class SensitivitySettingsProperties : IUtf8JsonSerializable, IJsonModel<SensitivitySettingsProperties>, IPersistableModel<SensitivitySettingsProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(MipInformation))
            {
                ...
                AppendChildObject(builder, MipInformation, options, 2);
            }
