...
{
    public partial class PublisherInfo : IUtf8JsonSerializable
    {
        ...
        internal static PublisherInfo DeserializePublisherInfo(JsonElement element)
        {
            ...
            return new PublisherInfo(publisherName.Value, productName.Value, binaryName.Value, version.Value);
        }
    }
}
