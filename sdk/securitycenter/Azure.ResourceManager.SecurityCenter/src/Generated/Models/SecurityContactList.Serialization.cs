...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SecurityContactList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SecurityContactList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SecurityContactList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SecurityContactList>)} interface");
            }
        ...
        string IPersistableModel<SecurityContactList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
