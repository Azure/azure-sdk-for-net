...
{
    internal partial class SecurityAssessmentList : IUtf8JsonSerializable, IJsonModel<SecurityAssessmentList>, IPersistableModel<SecurityAssessmentList>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SecurityAssessmentList>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<SecurityAssessmentList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SecurityAssessmentList)} does not support '{format}' format.");
            }
