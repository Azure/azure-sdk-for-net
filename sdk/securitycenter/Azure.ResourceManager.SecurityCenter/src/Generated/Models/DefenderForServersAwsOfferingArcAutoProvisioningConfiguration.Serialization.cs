...
{
    public partial class DefenderForServersAwsOfferingArcAutoProvisioningConfiguration : IUtf8JsonSerializable, IJsonModel<DefenderForServersAwsOfferingArcAutoProvisioningConfiguration>, IPersistableModel<DefenderForServersAwsOfferingArcAutoProvisioningConfiguration>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(PrivateLinkScope))
            {
                builder.Append("  privateLinkScope:");
                builder.AppendLine($" '{PrivateLinkScope}'");
            }
