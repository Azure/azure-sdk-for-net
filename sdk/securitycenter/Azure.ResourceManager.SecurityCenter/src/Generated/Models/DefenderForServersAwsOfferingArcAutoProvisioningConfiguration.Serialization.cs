...
{
    public partial class DefenderForServersAwsOfferingArcAutoProvisioningConfiguration : IUtf8JsonSerializable
    {
        ...
        internal static DefenderForServersAwsOfferingArcAutoProvisioningConfiguration DeserializeDefenderForServersAwsOfferingArcAutoProvisioningConfiguration(JsonElement element)
        {
            ...
            return new DefenderForServersAwsOfferingArcAutoProvisioningConfiguration(proxy.Value, privateLinkScope.Value);
        }
    }
}
