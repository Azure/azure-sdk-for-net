...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    public partial class GovernanceRuleEmailNotification : IUtf8JsonSerializable, IModelJsonSerializable<GovernanceRuleEmailNotification>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<GovernanceRuleEmailNotification>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="GovernanceRuleEmailNotification"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="GovernanceRuleEmailNotification"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="GovernanceRuleEmailNotification"/>. </summary>
