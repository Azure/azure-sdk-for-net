...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public partial class DenylistCustomAlertRule : ListCustomAlertRule
    {
        ...
        internal DenylistCustomAlertRule(string displayName, string description, bool isEnabled, string ruleType, SecurityValueType? valueType, IList<string> denylistValues, Dictionary<string, BinaryData> rawData) : base(displayName, description, isEnabled, ruleType, valueType, rawData)
        {
