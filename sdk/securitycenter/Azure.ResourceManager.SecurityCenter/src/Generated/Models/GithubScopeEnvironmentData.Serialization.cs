...
{
    public partial class GithubScopeEnvironmentData : IUtf8JsonSerializable
    {
        ...
        internal static GithubScopeEnvironmentData DeserializeGithubScopeEnvironmentData(JsonElement element)
        {
            ...
            return new GithubScopeEnvironmentData(environmentType);
        }
    }
}
