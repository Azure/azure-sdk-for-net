...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<JitNetworkAccessPolicyInitiateVirtualMachine>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<JitNetworkAccessPolicyInitiateVirtualMachine>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<JitNetworkAccessPolicyInitiateVirtualMachine>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
