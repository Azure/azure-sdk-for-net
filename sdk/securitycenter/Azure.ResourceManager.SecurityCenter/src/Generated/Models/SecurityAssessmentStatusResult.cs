...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public partial class SecurityAssessmentStatusResult : SecurityAssessmentStatus
    {
        ...
        internal SecurityAssessmentStatusResult(SecurityAssessmentStatusCode code, string cause, string description, DateTimeOffset? firstEvaluatedOn, DateTimeOffset? statusChangeOn, Dictionary<string, BinaryData> rawData) : base(code, cause, description, rawData)
        {
