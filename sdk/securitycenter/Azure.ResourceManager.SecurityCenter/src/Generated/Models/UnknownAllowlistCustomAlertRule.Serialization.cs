...
{
    internal partial class UnknownAllowlistCustomAlertRule : AllowlistCustomAlertRule, IJsonModel<AllowlistCustomAlertRule>
    {
        /// <summary> Initializes a new instance of <see cref="UnknownAllowlistCustomAlertRule"/> for deserialization. </summary>
        internal UnknownAllowlistCustomAlertRule()
        {
        }
        ...
        {
            return (AllowlistCustomAlertRule)PersistableModelCreateCore(data, options);
        }
        ...
        {
            return (AllowlistCustomAlertRule)JsonModelCreateCore(ref reader, options);
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownAllowlistCustomAlertRule DeserializeUnknownAllowlistCustomAlertRule(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownAllowlistCustomAlertRule(
                displayName,
                description,
                isEnabled,
                ruleType,
