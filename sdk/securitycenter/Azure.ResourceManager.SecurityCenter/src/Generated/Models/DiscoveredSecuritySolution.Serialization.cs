...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DiscoveredSecuritySolution>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DiscoveredSecuritySolution>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DiscoveredSecuritySolution>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DiscoveredSecuritySolution>)} interface");
            }
        ...
        string IPersistableModel<DiscoveredSecuritySolution>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
