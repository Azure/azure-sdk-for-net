...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public partial class ConnectionToIPNotAllowed : AllowlistCustomAlertRule
    {
        ...
        internal ConnectionToIPNotAllowed(string displayName, string description, bool isEnabled, string ruleType, SecurityValueType? valueType, IList<string> allowlistValues, Dictionary<string, BinaryData> rawData) : base(displayName, description, isEnabled, ruleType, valueType, allowlistValues, rawData)
        {
