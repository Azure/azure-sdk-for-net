...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    internal partial class DevOpsConfigurationListResponse
    {
        ...
        internal DevOpsConfigurationListResponse()
        {
            Value = new ChangeTrackingList<DevOpsConfigurationData>();
        }
        ...
        internal DevOpsConfigurationListResponse(IReadOnlyList<DevOpsConfigurationData> value, string nextLink)
        {
            Value = value;
            NextLink = nextLink;
        }
