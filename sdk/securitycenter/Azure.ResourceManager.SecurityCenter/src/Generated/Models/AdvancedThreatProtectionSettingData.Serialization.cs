...
namespace Azure.ResourceManager.SecurityCenter
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AdvancedThreatProtectionSettingData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AdvancedThreatProtectionSettingData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AdvancedThreatProtectionSettingData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AdvancedThreatProtectionSettingData>)} interface");
            }
        ...
        string IPersistableModel<AdvancedThreatProtectionSettingData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
