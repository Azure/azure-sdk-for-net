...
namespace Azure.ResourceManager.SecurityCenter
{
    public partial class AdvancedThreatProtectionSettingData : IUtf8JsonSerializable, IJsonModel<AdvancedThreatProtectionSettingData>
    {
        ...
        void IJsonModel<AdvancedThreatProtectionSettingData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(AdvancedThreatProtectionSettingData)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<AdvancedThreatProtectionSettingData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(AdvancedThreatProtectionSettingData)} does not support '{options.Format}' format.");
            }
        }
