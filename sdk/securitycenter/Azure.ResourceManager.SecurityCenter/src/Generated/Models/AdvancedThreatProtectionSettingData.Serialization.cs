...
{
    public partial class AdvancedThreatProtectionSettingData : IUtf8JsonSerializable, IJsonModel<AdvancedThreatProtectionSettingData>, IPersistableModel<AdvancedThreatProtectionSettingData>
    {
        ...
        void IJsonModel<AdvancedThreatProtectionSettingData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AdvancedThreatProtectionSettingData)} does not support '{format}' format.");
            }
