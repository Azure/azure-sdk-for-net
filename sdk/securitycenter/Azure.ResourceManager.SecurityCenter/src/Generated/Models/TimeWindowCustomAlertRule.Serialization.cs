...
{
    public partial class TimeWindowCustomAlertRule : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static TimeWindowCustomAlertRule DeserializeTimeWindowCustomAlertRule(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
