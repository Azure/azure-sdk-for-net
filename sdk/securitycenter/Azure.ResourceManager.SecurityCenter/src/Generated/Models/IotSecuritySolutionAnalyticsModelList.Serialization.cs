...
{
    internal partial class IotSecuritySolutionAnalyticsModelList : IUtf8JsonSerializable, IJsonModel<IotSecuritySolutionAnalyticsModelList>, IPersistableModel<IotSecuritySolutionAnalyticsModelList>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IotSecuritySolutionAnalyticsModelList>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<IotSecuritySolutionAnalyticsModelList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(IotSecuritySolutionAnalyticsModelList)} does not support '{format}' format.");
            }
