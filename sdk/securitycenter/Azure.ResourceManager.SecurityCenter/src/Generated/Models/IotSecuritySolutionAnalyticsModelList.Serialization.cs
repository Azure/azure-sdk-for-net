...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IotSecuritySolutionAnalyticsModelList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<IotSecuritySolutionAnalyticsModelList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<IotSecuritySolutionAnalyticsModelList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<IotSecuritySolutionAnalyticsModelList>)} interface");
            }
        ...
        string IPersistableModel<IotSecuritySolutionAnalyticsModelList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
