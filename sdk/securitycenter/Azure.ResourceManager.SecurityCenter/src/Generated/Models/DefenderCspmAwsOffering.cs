...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public partial class DefenderCspmAwsOffering : SecurityCenterCloudOffering
    {
        ...
        internal DefenderCspmAwsOffering(OfferingType offeringType, string description, DefenderCspmAwsOfferingVmScanners vmScanners, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(offeringType, description, serializedAdditionalRawData)
        {
