...
{
    public partial class EnvironmentDetails : IUtf8JsonSerializable, IJsonModel<EnvironmentDetails>, IPersistableModel<EnvironmentDetails>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(NativeResourceId))
            {
                builder.Append("  nativeResourceId:");
                builder.AppendLine($" '{NativeResourceId.ToString()}'");
            }

            if (Optional.IsDefined(EnvironmentHierarchyId))
            {
                builder.Append("  environmentHierarchyId:");
                builder.AppendLine($" '{EnvironmentHierarchyId}'");
            }

            if (Optional.IsDefined(OrganizationalHierarchyId))
            {
                builder.Append("  organizationalHierarchyId:");
                builder.AppendLine($" '{OrganizationalHierarchyId}'");
            }
