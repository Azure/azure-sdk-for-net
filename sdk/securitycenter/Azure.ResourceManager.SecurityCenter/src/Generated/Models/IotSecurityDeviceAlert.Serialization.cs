...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IotSecurityDeviceAlert>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<IotSecurityDeviceAlert>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<IotSecurityDeviceAlert>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<IotSecurityDeviceAlert>)} interface");
            }
        ...
        string IPersistableModel<IotSecurityDeviceAlert>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
