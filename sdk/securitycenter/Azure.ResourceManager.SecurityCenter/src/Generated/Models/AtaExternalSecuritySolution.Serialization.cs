...
{
    public partial class AtaExternalSecuritySolution : Core.IUtf8JsonSerializable
    {
        ...
        internal static AtaExternalSecuritySolution DeserializeAtaExternalSecuritySolution(JsonElement element)
        {
            ...
            Core.Optional<AtaSolutionProperties> properties = default;
            ...
            return new AtaExternalSecuritySolution(id, name, type, systemData.Value, kind, Core.Optional.ToNullable(location), properties.Value);
        }
    }
}
