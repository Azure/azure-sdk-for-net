...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AssessmentLinks>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AssessmentLinks>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AssessmentLinks>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AssessmentLinks>)} interface");
            }
        ...
        string IPersistableModel<AssessmentLinks>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
