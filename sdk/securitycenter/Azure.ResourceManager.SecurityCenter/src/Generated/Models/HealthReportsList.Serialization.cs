...
{
    internal partial class HealthReportsList : IUtf8JsonSerializable, IJsonModel<HealthReportsList>, IPersistableModel<HealthReportsList>
    {
        ...
        internal static HealthReportsList DeserializeHealthReportsList(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new HealthReportsList(Optional.ToList(value), nextLink.Value, serializedAdditionalRawData);
        }
