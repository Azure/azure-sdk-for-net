...
{
    public partial class SoftwareInventoryData : IUtf8JsonSerializable, IJsonModel<SoftwareInventoryData>, IPersistableModel<SoftwareInventoryData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(EndOfSupportStatus))
            {
                ...
                builder.AppendLine($" '{EndOfSupportStatus.ToString()}'");
            }
            ...
            if (Optional.IsDefined(NumberOfKnownVulnerabilities))
            {
                ...
                builder.AppendLine($" '{NumberOfKnownVulnerabilities.Value.ToString()}'");
            }

            if (Optional.IsDefined(FirstSeenOn))
            {
                builder.Append("  firstSeenAt:");
                builder.AppendLine($" '{FirstSeenOn.Value.ToString()}'");
            }
