...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    public partial class GitHubOwnerProperties : IUtf8JsonSerializable, IJsonModel<GitHubOwnerProperties>
    {
        ...
        internal static GitHubOwnerProperties DeserializeGitHubOwnerProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new GitHubOwnerProperties(provisioningStatusMessage.Value, Optional.ToNullable(provisioningStatusUpdateTimeUtc), Optional.ToNullable(provisioningState), ownerUrl.Value, gitHubInternalId.Value, Optional.ToNullable(onboardingState), serializedAdditionalRawData);
        }
