...
namespace Azure.ResourceManager.SecurityCenter
{
    public partial class SecurityAutomationData : IUtf8JsonSerializable, IModelJsonSerializable<SecurityAutomationData>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<SecurityAutomationData>(this, options.Format);
            ...
            if (Optional.IsCollectionDefined(Scopes))
            {
                ...
                foreach (var item in Scopes)
                {
                    ...
                    {
                        ((IModelJsonSerializable<SecurityAutomationScope>)item).Serialize(writer, options);
                    }
                }
            ...
            if (Optional.IsCollectionDefined(Sources))
            {
                ...
                foreach (var item in Sources)
                {
                    ...
                    {
                        ((IModelJsonSerializable<SecurityAutomationSource>)item).Serialize(writer, options);
                    }
                }
                writer.WriteEndArray();
            }
            if (Optional.IsCollectionDefined(Actions))
            {
                ...
                foreach (var item in Actions)
                {
                    ...
                    {
                        ((IModelJsonSerializable<SecurityAutomationAction>)item).Serialize(writer, options);
                    }
                }
                writer.WriteEndArray();
            }
        ...
        /// <summary> Converts a <see cref="SecurityAutomationData"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="SecurityAutomationData"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="SecurityAutomationData"/>. </summary>
