...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SecurityAutomationTriggeringRule>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SecurityAutomationTriggeringRule>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SecurityAutomationTriggeringRule>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SecurityAutomationTriggeringRule>)} interface");
            }
        ...
        string IPersistableModel<SecurityAutomationTriggeringRule>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
