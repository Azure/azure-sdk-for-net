...
{
    public partial class SecurityAutomationTriggeringRule : IUtf8JsonSerializable, IJsonModel<SecurityAutomationTriggeringRule>, IPersistableModel<SecurityAutomationTriggeringRule>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SecurityAutomationTriggeringRule>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(PropertyJPath))
            {
                builder.Append("  propertyJPath:");
                builder.AppendLine($" '{PropertyJPath}'");
            }

            if (Optional.IsDefined(PropertyType))
            {
                builder.Append("  propertyType:");
                builder.AppendLine($" '{PropertyType.ToString()}'");
            }

            if (Optional.IsDefined(ExpectedValue))
            {
                builder.Append("  expectedValue:");
                builder.AppendLine($" '{ExpectedValue}'");
            }
