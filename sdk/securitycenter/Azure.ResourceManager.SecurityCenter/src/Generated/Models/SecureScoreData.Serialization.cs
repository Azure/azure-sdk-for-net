...
{
    public partial class SecureScoreData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static SecureScoreData DeserializeSecureScoreData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
