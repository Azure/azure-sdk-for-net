...
namespace Azure.ResourceManager.SecurityCenter
{
    public partial class SecureScoreData : IUtf8JsonSerializable, IModelJsonSerializable<SecureScoreData>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<SecureScoreData>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="SecureScoreData"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="SecureScoreData"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="SecureScoreData"/>. </summary>
