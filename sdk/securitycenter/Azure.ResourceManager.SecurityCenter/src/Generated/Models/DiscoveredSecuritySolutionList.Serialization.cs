...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DiscoveredSecuritySolutionList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DiscoveredSecuritySolutionList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DiscoveredSecuritySolutionList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DiscoveredSecuritySolutionList>)} interface");
            }
        ...
        string IPersistableModel<DiscoveredSecuritySolutionList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
