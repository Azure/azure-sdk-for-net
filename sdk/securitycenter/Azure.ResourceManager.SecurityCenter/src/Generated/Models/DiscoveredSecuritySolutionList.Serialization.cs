...
{
    internal partial class DiscoveredSecuritySolutionList : IUtf8JsonSerializable, IJsonModel<DiscoveredSecuritySolutionList>, IPersistableModel<DiscoveredSecuritySolutionList>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DiscoveredSecuritySolutionList>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<DiscoveredSecuritySolutionList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DiscoveredSecuritySolutionList)} does not support '{format}' format.");
            }
