...
{
    public partial class SecurityAssessmentMetadataData : IUtf8JsonSerializable, IModelJsonSerializable<SecurityAssessmentMetadataData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IModelJsonSerializable<SecurityAssessmentMetadataData>)this).Serialize(writer, ModelSerializerOptions.DefaultWireOptions);

        void IModelJsonSerializable<SecurityAssessmentMetadataData>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<SecurityAssessmentMetadataData>(this, options.Format);
            ...
            if (Optional.IsDefined(PublishDates))
            {
                ...
                if (PublishDates is null)
                {
                    writer.WriteNullValue();
                }
                else
                {
                    ((IModelJsonSerializable<SecurityAssessmentPublishDates>)PublishDates).Serialize(writer, options);
                }
            }
        ...
        internal static SecurityAssessmentMetadataData DeserializeSecurityAssessmentMetadataData(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new SecurityAssessmentMetadataData(id, name, type, systemData.Value, displayName.Value, policyDefinitionId.Value, description.Value, remediationDescription.Value, Optional.ToList(categories), Optional.ToNullable(severity), Optional.ToNullable(userImpact), Optional.ToNullable(implementationEffort), Optional.ToList(threats), Optional.ToNullable(preview), Optional.ToNullable(assessmentType), partnerData.Value, publishDates.Value, plannedDeprecationDate.Value, Optional.ToList(tactics), Optional.ToList(techniques), rawData);
        }

        SecurityAssessmentMetadataData IModelJsonSerializable<SecurityAssessmentMetadataData>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<SecurityAssessmentMetadataData>(this, options.Format);

            using var doc = JsonDocument.ParseValue(ref reader);
            return DeserializeSecurityAssessmentMetadataData(doc.RootElement, options);
        }

        BinaryData IModelSerializable<SecurityAssessmentMetadataData>.Serialize(ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<SecurityAssessmentMetadataData>(this, options.Format);
        ...
        SecurityAssessmentMetadataData IModelSerializable<SecurityAssessmentMetadataData>.Deserialize(BinaryData data, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<SecurityAssessmentMetadataData>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="SecurityAssessmentMetadataData"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="SecurityAssessmentMetadataData"/> to convert. </param>
        public static implicit operator RequestContent(SecurityAssessmentMetadataData model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="SecurityAssessmentMetadataData"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator SecurityAssessmentMetadataData(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeSecurityAssessmentMetadataData(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
