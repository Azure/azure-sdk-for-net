...
namespace Azure.ResourceManager.SecurityCenter
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SecurityAssessmentMetadataData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SecurityAssessmentMetadataData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SecurityAssessmentMetadataData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SecurityAssessmentMetadataData>)} interface");
            }
        ...
        string IPersistableModel<SecurityAssessmentMetadataData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
