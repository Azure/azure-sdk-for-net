...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LocalUserNotAllowed>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<LocalUserNotAllowed>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<LocalUserNotAllowed>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<LocalUserNotAllowed>)} interface");
            }
        ...
        string IPersistableModel<LocalUserNotAllowed>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
