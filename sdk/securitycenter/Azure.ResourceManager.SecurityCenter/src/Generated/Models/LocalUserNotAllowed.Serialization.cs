...
{
    public partial class LocalUserNotAllowed : Core.IUtf8JsonSerializable
    {
        ...
        internal static LocalUserNotAllowed DeserializeLocalUserNotAllowed(JsonElement element)
        {
            ...
            return new LocalUserNotAllowed(displayName.Value, description.Value, isEnabled, ruleType, Core.Optional.ToNullable(valueType), allowlistValues);
        }
    }
}
