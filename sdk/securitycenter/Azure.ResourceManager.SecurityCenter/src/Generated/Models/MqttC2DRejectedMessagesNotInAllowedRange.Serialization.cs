...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public partial class MqttC2DRejectedMessagesNotInAllowedRange : TimeWindowCustomAlertRule, IJsonModel<MqttC2DRejectedMessagesNotInAllowedRange>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<MqttC2DRejectedMessagesNotInAllowedRange>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static MqttC2DRejectedMessagesNotInAllowedRange DeserializeMqttC2DRejectedMessagesNotInAllowedRange(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            string ruleType = "MqttC2DRejectedMessagesNotInAllowedRange";
