...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MqttC2DRejectedMessagesNotInAllowedRange>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MqttC2DRejectedMessagesNotInAllowedRange>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MqttC2DRejectedMessagesNotInAllowedRange>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MqttC2DRejectedMessagesNotInAllowedRange>)} interface");
            }
        ...
        string IPersistableModel<MqttC2DRejectedMessagesNotInAllowedRange>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
