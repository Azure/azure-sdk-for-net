...
{
    public partial class DefenderCspmAwsOfferingMdcContainersImageAssessment : IUtf8JsonSerializable, IJsonModel<DefenderCspmAwsOfferingMdcContainersImageAssessment>, IPersistableModel<DefenderCspmAwsOfferingMdcContainersImageAssessment>
    {
        ...
        internal static DefenderCspmAwsOfferingMdcContainersImageAssessment DeserializeDefenderCspmAwsOfferingMdcContainersImageAssessment(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new DefenderCspmAwsOfferingMdcContainersImageAssessment(Optional.ToNullable(enabled), cloudRoleArn.Value, serializedAdditionalRawData);
        }
