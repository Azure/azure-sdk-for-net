...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public partial class ThresholdCustomAlertRule : CustomAlertRule
    {
        ...
        internal ThresholdCustomAlertRule(string displayName, string description, bool isEnabled, string ruleType, int minThreshold, int maxThreshold, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(displayName, description, isEnabled, ruleType, serializedAdditionalRawData)
        {
            MinThreshold = minThreshold;
            MaxThreshold = maxThreshold;
