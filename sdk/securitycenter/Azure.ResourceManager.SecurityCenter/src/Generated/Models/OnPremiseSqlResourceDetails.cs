...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public partial class OnPremiseSqlResourceDetails : OnPremiseResourceDetails
    {
        ...
        internal OnPremiseSqlResourceDetails(Source source, ResourceIdentifier workspaceId, Guid vmUuid, string sourceComputerId, string machineName, string serverName, string databaseName, Dictionary<string, BinaryData> rawData) : base(source, workspaceId, vmUuid, sourceComputerId, machineName, rawData)
        {
            ServerName = serverName;
            DatabaseName = databaseName;
            Source = source;
