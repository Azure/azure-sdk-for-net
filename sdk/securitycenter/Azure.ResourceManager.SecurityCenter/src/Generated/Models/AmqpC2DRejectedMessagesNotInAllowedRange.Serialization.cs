...
{
    public partial class AmqpC2DRejectedMessagesNotInAllowedRange : IUtf8JsonSerializable, IJsonModel<AmqpC2DRejectedMessagesNotInAllowedRange>, IPersistableModel<AmqpC2DRejectedMessagesNotInAllowedRange>
    {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<AmqpC2DRejectedMessagesNotInAllowedRange>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AmqpC2DRejectedMessagesNotInAllowedRange)} does not support '{format}' format.");
            }
