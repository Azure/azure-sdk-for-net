...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    public partial class AmqpC2DRejectedMessagesNotInAllowedRange : IUtf8JsonSerializable, IJsonModel<AmqpC2DRejectedMessagesNotInAllowedRange>
    {
        ...
        void IJsonModel<AmqpC2DRejectedMessagesNotInAllowedRange>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(AmqpC2DRejectedMessagesNotInAllowedRange)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<AmqpC2DRejectedMessagesNotInAllowedRange>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(AmqpC2DRejectedMessagesNotInAllowedRange)} does not support '{options.Format}' format.");
            }
        }
