...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FailedLocalLoginsNotInAllowedRange>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<FailedLocalLoginsNotInAllowedRange>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<FailedLocalLoginsNotInAllowedRange>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<FailedLocalLoginsNotInAllowedRange>)} interface");
            }
        ...
        string IPersistableModel<FailedLocalLoginsNotInAllowedRange>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
