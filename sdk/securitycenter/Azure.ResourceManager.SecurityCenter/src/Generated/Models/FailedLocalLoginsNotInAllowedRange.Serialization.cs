...
{
    public partial class FailedLocalLoginsNotInAllowedRange : IUtf8JsonSerializable, IJsonModel<FailedLocalLoginsNotInAllowedRange>, IPersistableModel<FailedLocalLoginsNotInAllowedRange>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FailedLocalLoginsNotInAllowedRange>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<FailedLocalLoginsNotInAllowedRange>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(FailedLocalLoginsNotInAllowedRange)} does not support '{format}' format.");
            }
