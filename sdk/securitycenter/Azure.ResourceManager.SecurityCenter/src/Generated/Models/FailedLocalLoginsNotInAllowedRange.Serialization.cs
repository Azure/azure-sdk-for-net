...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public partial class FailedLocalLoginsNotInAllowedRange : TimeWindowCustomAlertRule, IJsonModel<FailedLocalLoginsNotInAllowedRange>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<FailedLocalLoginsNotInAllowedRange>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static FailedLocalLoginsNotInAllowedRange DeserializeFailedLocalLoginsNotInAllowedRange(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            string ruleType = "FailedLocalLoginsNotInAllowedRange";
