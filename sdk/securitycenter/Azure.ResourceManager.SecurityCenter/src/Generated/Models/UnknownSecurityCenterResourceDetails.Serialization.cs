...
{
    internal partial class UnknownSecurityCenterResourceDetails : SecurityCenterResourceDetails, IJsonModel<SecurityCenterResourceDetails>
    {
        /// <summary> Initializes a new instance of <see cref="UnknownSecurityCenterResourceDetails"/> for deserialization. </summary>
        internal UnknownSecurityCenterResourceDetails()
        {
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownSecurityCenterResourceDetails DeserializeUnknownSecurityCenterResourceDetails(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownSecurityCenterResourceDetails(source, additionalBinaryDataProperties);
        }
    }
}
