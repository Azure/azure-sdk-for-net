...
{
    public partial class DefenderForContainersGcpOfferingMdcContainersImageAssessment : IUtf8JsonSerializable
    {
        ...
        internal static DefenderForContainersGcpOfferingMdcContainersImageAssessment DeserializeDefenderForContainersGcpOfferingMdcContainersImageAssessment(JsonElement element)
        {
            ...
            return new DefenderForContainersGcpOfferingMdcContainersImageAssessment(Optional.ToNullable(enabled), workloadIdentityProviderId.Value, serviceAccountEmailAddress.Value);
        }
    }
}
