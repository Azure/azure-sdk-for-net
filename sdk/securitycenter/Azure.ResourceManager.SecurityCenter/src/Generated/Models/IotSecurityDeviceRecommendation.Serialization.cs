...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    public partial class IotSecurityDeviceRecommendation : IUtf8JsonSerializable, IJsonModel<IotSecurityDeviceRecommendation>
    {
        ...
        void IJsonModel<IotSecurityDeviceRecommendation>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(IotSecurityDeviceRecommendation)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<IotSecurityDeviceRecommendation>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(IotSecurityDeviceRecommendation)} does not support '{options.Format}' format.");
            }
        }
