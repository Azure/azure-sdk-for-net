...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IotSecurityDeviceRecommendation>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<IotSecurityDeviceRecommendation>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(IotSecurityDeviceRecommendation)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(RecommendationDisplayName))
            {
                ...
                if (RecommendationDisplayName.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            {
                builder.Append("  devicesCount:");
                builder.AppendLine($" '{DevicesCount.Value.ToString()}'");
            }
