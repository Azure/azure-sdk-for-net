...
{
    public partial class CustomAlertRule : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static CustomAlertRule DeserializeCustomAlertRule(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
