...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    {
        /// <summary> Initializes a new instance of InformationType. </summary>
        ...
        internal InformationType(string displayName, string description, int? order, Guid? recommendedLabelId, bool? enabled, bool? custom, IList<InformationProtectionKeyword> keywords)
        {
