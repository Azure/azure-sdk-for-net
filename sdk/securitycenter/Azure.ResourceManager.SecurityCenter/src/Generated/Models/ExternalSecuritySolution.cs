...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public partial class ExternalSecuritySolution : ResourceData
    {
        ...
        internal ExternalSecuritySolution(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, ExternalSecuritySolutionKind? kind, AzureLocation? location, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
            Kind = kind;
            Location = location;
