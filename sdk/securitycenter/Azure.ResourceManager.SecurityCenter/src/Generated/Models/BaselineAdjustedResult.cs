...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public partial class BaselineAdjustedResult
    {
        ...
        internal BaselineAdjustedResult(SqlVulnerabilityAssessmentBaseline baseline, SqlVulnerabilityAssessmentScanResultRuleStatus? status, IList<IList<string>> resultsNotInBaseline, IList<IList<string>> resultsOnlyInBaseline, Dictionary<string, BinaryData> rawData)
        {
            Baseline = baseline;
            Status = status;
