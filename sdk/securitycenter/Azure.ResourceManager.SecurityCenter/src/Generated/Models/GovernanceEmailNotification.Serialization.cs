...
{
    public partial class GovernanceEmailNotification : Core.IUtf8JsonSerializable
    {
        ...
        internal static GovernanceEmailNotification DeserializeGovernanceEmailNotification(JsonElement element)
        {
            ...
            return new GovernanceEmailNotification(Core.Optional.ToNullable(disableManagerEmailNotification), Core.Optional.ToNullable(disableOwnerEmailNotification));
        }
    }
}
