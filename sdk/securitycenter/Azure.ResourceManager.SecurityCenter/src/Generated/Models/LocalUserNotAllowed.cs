...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public partial class LocalUserNotAllowed : AllowlistCustomAlertRule
    {
        ...
        internal LocalUserNotAllowed(string displayName, string description, bool isEnabled, string ruleType, SecurityValueType? valueType, IList<string> allowlistValues, Dictionary<string, BinaryData> rawData) : base(displayName, description, isEnabled, ruleType, valueType, allowlistValues, rawData)
        {
