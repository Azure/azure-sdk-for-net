...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public partial class InformationProtectionAwsOffering : SecurityCenterCloudOffering
    {
        ...
        internal InformationProtectionAwsOffering(OfferingType offeringType, string description, AwsInformationProtection informationProtection, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(offeringType, description, serializedAdditionalRawData)
        {
