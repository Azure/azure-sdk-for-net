...
{
    public partial class HealthReportData : IUtf8JsonSerializable, IJsonModel<HealthReportData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HealthReportData>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<HealthReportData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<HealthReportData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(HealthReportData)} does not support '{format}' format.");
            }
        ...
        HealthReportData IJsonModel<HealthReportData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<HealthReportData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
            ...
            return DeserializeHealthReportData(document.RootElement, options);
        }

        internal static HealthReportData DeserializeHealthReportData(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<HealthReportData>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<HealthReportData>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(HealthReportData)} does not support '{options.Format}' format.");
            }
        }

        HealthReportData IPersistableModel<HealthReportData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<HealthReportData>)this).GetFormatFromOptions(options) : options.Format;
        ...
        string IPersistableModel<HealthReportData>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
