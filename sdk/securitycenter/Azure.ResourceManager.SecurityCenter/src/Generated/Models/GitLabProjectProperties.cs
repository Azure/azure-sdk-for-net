...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public partial class GitLabProjectProperties
    {
        ...
        internal GitLabProjectProperties(string provisioningStatusMessage, DateTimeOffset? provisioningStatusUpdatedOn, DevOpsProvisioningState? provisioningState, string fullyQualifiedName, string fullyQualifiedFriendlyName, string fullyQualifiedParentGroupName, string uri, OnboardingState? onboardingState, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
