...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public partial class GitLabProjectProperties
    {
        ...
        internal GitLabProjectProperties()
        {
        }
        ...
        internal GitLabProjectProperties(string provisioningStatusMessage, DateTimeOffset? provisioningStatusUpdateTimeUtc, DevOpsProvisioningState? provisioningState, string fullyQualifiedName, string fullyQualifiedFriendlyName, string fullyQualifiedParentGroupName, string uri, OnboardingState? onboardingState, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
