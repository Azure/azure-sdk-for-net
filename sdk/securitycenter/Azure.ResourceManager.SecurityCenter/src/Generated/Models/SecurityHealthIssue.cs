...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public partial class SecurityHealthIssue
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="SecurityHealthIssue"/>. </summary>
        /// <param name="issueKey"> The unique issue key. </param>
        internal SecurityHealthIssue(string issueKey)
        {
            IssueKey = issueKey;
        ...
        internal SecurityHealthIssue(string issueKey, string issueName, IList<string> securityValues, string issueDescription, string remediationSteps, string remediationScript, IDictionary<string, string> issueAdditionalData, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            IssueKey = issueKey;
            IssueName = issueName;
