...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public partial class JitNetworkAccessPolicyInitiatePort
    {
        ...
        internal JitNetworkAccessPolicyInitiatePort(int number, string allowedSourceAddressPrefix, DateTimeOffset endOn, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Number = number;
