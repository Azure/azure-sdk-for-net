...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public partial class ExternalSecuritySolution : ResourceData, IJsonModel<ExternalSecuritySolution>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<ExternalSecuritySolution>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ExternalSecuritySolution>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        ExternalSecuritySolution IPersistableModel<ExternalSecuritySolution>.Create(BinaryData data, ModelReaderWriterOptions options) => (ExternalSecuritySolution)PersistableModelCreateCore(data, options);

        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<ExternalSecuritySolution>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";

        /// <param name="response"> The <see cref="Response"/> to deserialize the <see cref="ExternalSecuritySolution"/> from. </param>
        internal static ExternalSecuritySolution FromResponse(Response response)
        {
            using JsonDocument document = JsonDocument.Parse(response.Content, ModelSerializationExtensions.JsonDocumentOptions);
            return DeserializeExternalSecuritySolution(document.RootElement, ModelSerializationExtensions.WireOptions);
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ExternalSecuritySolution IJsonModel<ExternalSecuritySolution>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (ExternalSecuritySolution)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static ExternalSecuritySolution DeserializeExternalSecuritySolution(JsonElement element, ModelReaderWriterOptions options)
        {
