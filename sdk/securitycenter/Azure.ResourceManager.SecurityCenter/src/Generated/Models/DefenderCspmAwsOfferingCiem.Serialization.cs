...
{
    public partial class DefenderCspmAwsOfferingCiem : IUtf8JsonSerializable, IJsonModel<DefenderCspmAwsOfferingCiem>, IPersistableModel<DefenderCspmAwsOfferingCiem>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(CiemOidc))
            {
                ...
                AppendChildObject(builder, CiemOidc, options, 2);
            }
