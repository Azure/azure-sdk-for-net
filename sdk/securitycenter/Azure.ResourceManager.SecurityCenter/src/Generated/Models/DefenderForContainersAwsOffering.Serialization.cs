...
{
    public partial class DefenderForContainersAwsOffering : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static DefenderForContainersAwsOffering DeserializeDefenderForContainersAwsOffering(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
