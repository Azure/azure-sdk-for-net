...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    public partial class IotSecuritySolutionPatch : IUtf8JsonSerializable, IModelJsonSerializable<IotSecuritySolutionPatch>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<IotSecuritySolutionPatch>(this, options.Format);
        ...
        internal static IotSecuritySolutionPatch DeserializeIotSecuritySolutionPatch(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new IotSecuritySolutionPatch(Optional.ToDictionary(tags), userDefinedResources.Value, Optional.ToList(recommendationsConfiguration), serializedAdditionalRawData);
        }
        ...
        /// <summary> Converts a <see cref="IotSecuritySolutionPatch"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="IotSecuritySolutionPatch"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="IotSecuritySolutionPatch"/>. </summary>
