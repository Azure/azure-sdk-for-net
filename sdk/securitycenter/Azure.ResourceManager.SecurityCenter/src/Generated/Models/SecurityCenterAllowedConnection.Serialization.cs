...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SecurityCenterAllowedConnection>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SecurityCenterAllowedConnection>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SecurityCenterAllowedConnection>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SecurityCenterAllowedConnection>)} interface");
            }
        ...
        string IPersistableModel<SecurityCenterAllowedConnection>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
