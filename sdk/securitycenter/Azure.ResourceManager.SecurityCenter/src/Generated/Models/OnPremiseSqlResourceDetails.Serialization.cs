...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<OnPremiseSqlResourceDetails>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<OnPremiseSqlResourceDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<OnPremiseSqlResourceDetails>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<OnPremiseSqlResourceDetails>)} interface");
            }
        ...
        string IPersistableModel<OnPremiseSqlResourceDetails>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
