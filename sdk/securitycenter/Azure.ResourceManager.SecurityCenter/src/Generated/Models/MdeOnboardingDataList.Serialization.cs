...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MdeOnboardingDataList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MdeOnboardingDataList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MdeOnboardingDataList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MdeOnboardingDataList>)} interface");
            }
        ...
        string IPersistableModel<MdeOnboardingDataList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
