...
{
    public partial class RegulatoryComplianceControlData : IUtf8JsonSerializable, IJsonModel<RegulatoryComplianceControlData>, IPersistableModel<RegulatoryComplianceControlData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(PassedAssessments))
            {
                ...
                builder.AppendLine($" '{PassedAssessments.Value.ToString()}'");
            }

            if (Optional.IsDefined(FailedAssessments))
            {
                builder.Append("  failedAssessments:");
                builder.AppendLine($" '{FailedAssessments.Value.ToString()}'");
            }

            if (Optional.IsDefined(SkippedAssessments))
            {
                builder.Append("  skippedAssessments:");
                builder.AppendLine($" '{SkippedAssessments.Value.ToString()}'");
            }
