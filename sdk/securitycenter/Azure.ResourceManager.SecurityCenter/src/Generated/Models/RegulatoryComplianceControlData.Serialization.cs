...
namespace Azure.ResourceManager.SecurityCenter
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RegulatoryComplianceControlData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RegulatoryComplianceControlData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RegulatoryComplianceControlData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RegulatoryComplianceControlData>)} interface");
            }
        ...
        string IPersistableModel<RegulatoryComplianceControlData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
