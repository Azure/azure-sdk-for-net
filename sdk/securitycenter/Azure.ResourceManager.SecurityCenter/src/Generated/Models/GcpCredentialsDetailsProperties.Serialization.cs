...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    public partial class GcpCredentialsDetailsProperties : IUtf8JsonSerializable, IModelJsonSerializable<GcpCredentialsDetailsProperties>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<GcpCredentialsDetailsProperties>(this, options.Format);
        ...
        internal static GcpCredentialsDetailsProperties DeserializeGcpCredentialsDetailsProperties(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new GcpCredentialsDetailsProperties(Optional.ToNullable(authenticationProvisioningState), Optional.ToList(grantedPermissions), authenticationType, organizationId, type, projectId, privateKeyId, privateKey, clientEmail, clientId, authUri, tokenUri, authProviderX509CertUrl, clientX509CertUrl, serializedAdditionalRawData);
        }
