...
{
    public partial class SecurityAutomationActionEventHub : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static SecurityAutomationActionEventHub DeserializeSecurityAutomationActionEventHub(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
