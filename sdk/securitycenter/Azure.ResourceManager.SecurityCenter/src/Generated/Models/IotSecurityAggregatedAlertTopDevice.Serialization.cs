...
{
    public partial class IotSecurityAggregatedAlertTopDevice : IUtf8JsonSerializable, IJsonModel<IotSecurityAggregatedAlertTopDevice>, IPersistableModel<IotSecurityAggregatedAlertTopDevice>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  lastOccurrence:");
                builder.AppendLine($" '{LastOccurrence}'");
            }
