...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<UserRecommendation>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<UserRecommendation>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<UserRecommendation>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<UserRecommendation>)} interface");
            }
        ...
        string IPersistableModel<UserRecommendation>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
