...
{
    public partial class HttpD2CMessagesNotInAllowedRange : IUtf8JsonSerializable, IJsonModel<HttpD2CMessagesNotInAllowedRange>, IPersistableModel<HttpD2CMessagesNotInAllowedRange>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(TimeWindowSize))
            {
                ...
                var formattedTimeSpan = XmlConvert.ToString(TimeWindowSize);
            ...
            if (Optional.IsDefined(MinThreshold))
            {
                ...
                builder.AppendLine($" '{MinThreshold.ToString()}'");
            }

            if (Optional.IsDefined(MaxThreshold))
            {
                builder.Append("  maxThreshold:");
                builder.AppendLine($" '{MaxThreshold.ToString()}'");
            }
