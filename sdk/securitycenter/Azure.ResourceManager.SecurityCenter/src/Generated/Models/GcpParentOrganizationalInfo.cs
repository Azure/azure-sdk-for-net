...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public partial class GcpParentOrganizationalInfo : GcpOrganizationalInfo
    {
        ...
        internal GcpParentOrganizationalInfo(OrganizationMembershipType organizationMembershipType, IList<string> excludedProjectNumbers, string serviceAccountEmailAddress, string workloadIdentityProviderId, Dictionary<string, BinaryData> rawData) : base(organizationMembershipType, rawData)
        {
