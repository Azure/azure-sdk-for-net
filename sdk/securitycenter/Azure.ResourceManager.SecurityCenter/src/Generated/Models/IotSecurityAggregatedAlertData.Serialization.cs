...
namespace Azure.ResourceManager.SecurityCenter
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IotSecurityAggregatedAlertData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<IotSecurityAggregatedAlertData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<IotSecurityAggregatedAlertData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<IotSecurityAggregatedAlertData>)} interface");
            }
        ...
        string IPersistableModel<IotSecurityAggregatedAlertData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
