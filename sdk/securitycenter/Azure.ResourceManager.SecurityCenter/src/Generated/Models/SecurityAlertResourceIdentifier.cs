...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public abstract partial class SecurityAlertResourceIdentifier
    {
        ...
        private protected SecurityAlertResourceIdentifier(ResourceIdentifierType @type)
        {
            Type = @type;
        }
        ...
        internal SecurityAlertResourceIdentifier(ResourceIdentifierType @type, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Type = @type;
