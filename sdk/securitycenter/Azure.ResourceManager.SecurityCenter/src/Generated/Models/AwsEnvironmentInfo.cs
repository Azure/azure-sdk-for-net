...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public partial class AwsEnvironmentInfo : SecurityConnectorEnvironmentInfo
    {
        ...
        internal AwsEnvironmentInfo(EnvironmentType environmentType, IDictionary<string, BinaryData> additionalBinaryDataProperties, AwsOrganizationalInfo organizationalData, IList<string> regions, string accountName, long? scanInterval) : base(environmentType, additionalBinaryDataProperties)
        {
