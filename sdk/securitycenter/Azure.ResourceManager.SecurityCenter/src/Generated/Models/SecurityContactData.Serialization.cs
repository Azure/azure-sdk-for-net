...
namespace Azure.ResourceManager.SecurityCenter
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SecurityContactData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SecurityContactData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SecurityContactData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SecurityContactData>)} interface");
            }
        ...
        string IPersistableModel<SecurityContactData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
