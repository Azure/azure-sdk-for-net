...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public partial class AwsCredsAuthenticationDetailsProperties : AuthenticationDetailsProperties
    {
        ...
        internal AwsCredsAuthenticationDetailsProperties(AuthenticationProvisioningState? authenticationProvisioningState, IReadOnlyList<SecurityCenterCloudPermission> grantedPermissions, AuthenticationType authenticationType, string accountId, string awsAccessKeyId, string awsSecretAccessKey, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(authenticationProvisioningState, grantedPermissions, authenticationType, serializedAdditionalRawData)
        {
            AccountId = accountId;
            AwsAccessKeyId = awsAccessKeyId;
            AwsSecretAccessKey = awsSecretAccessKey;
