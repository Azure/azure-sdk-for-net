...
{
    public partial class DefenderCspmGcpOfferingDataSensitivityDiscovery : IUtf8JsonSerializable
    {
        ...
        internal static DefenderCspmGcpOfferingDataSensitivityDiscovery DeserializeDefenderCspmGcpOfferingDataSensitivityDiscovery(JsonElement element)
        {
            ...
            return new DefenderCspmGcpOfferingDataSensitivityDiscovery(Optional.ToNullable(enabled), workloadIdentityProviderId.Value, serviceAccountEmailAddress.Value);
        }
    }
}
