...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public partial class CspmMonitorAzureDevOpsOffering : SecurityCenterCloudOffering, IJsonModel<CspmMonitorAzureDevOpsOffering>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<CspmMonitorAzureDevOpsOffering>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<CspmMonitorAzureDevOpsOffering>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        CspmMonitorAzureDevOpsOffering IPersistableModel<CspmMonitorAzureDevOpsOffering>.Create(BinaryData data, ModelReaderWriterOptions options) => (CspmMonitorAzureDevOpsOffering)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        CspmMonitorAzureDevOpsOffering IJsonModel<CspmMonitorAzureDevOpsOffering>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (CspmMonitorAzureDevOpsOffering)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static CspmMonitorAzureDevOpsOffering DeserializeCspmMonitorAzureDevOpsOffering(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new CspmMonitorAzureDevOpsOffering(offeringType, description, additionalBinaryDataProperties);
        }
    }
}
