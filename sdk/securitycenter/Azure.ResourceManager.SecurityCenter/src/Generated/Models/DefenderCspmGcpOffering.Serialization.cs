...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DefenderCspmGcpOffering>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DefenderCspmGcpOffering>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DefenderCspmGcpOffering>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DefenderCspmGcpOffering>)} interface");
            }
        ...
        string IPersistableModel<DefenderCspmGcpOffering>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
