...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public partial class FailedLocalLoginsNotInAllowedRange : TimeWindowCustomAlertRule
    {
        ...
        /// <param name="maxThreshold"> The maximum threshold. </param>
        /// <param name="timeWindowSize"> The time window size in iso8601 format. </param>
        internal FailedLocalLoginsNotInAllowedRange(string displayName, string description, bool isEnabled, string ruleType, int minThreshold, int maxThreshold, TimeSpan timeWindowSize) : base(displayName, description, isEnabled, ruleType, minThreshold, maxThreshold, timeWindowSize)
        {
