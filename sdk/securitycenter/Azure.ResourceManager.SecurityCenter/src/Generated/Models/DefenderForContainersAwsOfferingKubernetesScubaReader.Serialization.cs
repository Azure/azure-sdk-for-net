...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DefenderForContainersAwsOfferingKubernetesScubaReader>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<DefenderForContainersAwsOfferingKubernetesScubaReader>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<DefenderForContainersAwsOfferingKubernetesScubaReader>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
