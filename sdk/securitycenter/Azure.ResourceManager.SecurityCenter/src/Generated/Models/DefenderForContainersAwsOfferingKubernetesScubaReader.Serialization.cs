...
{
    internal partial class DefenderForContainersAwsOfferingKubernetesScubaReader : IUtf8JsonSerializable, IJsonModel<DefenderForContainersAwsOfferingKubernetesScubaReader>, IPersistableModel<DefenderForContainersAwsOfferingKubernetesScubaReader>
    {
        ...
        void IJsonModel<DefenderForContainersAwsOfferingKubernetesScubaReader>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DefenderForContainersAwsOfferingKubernetesScubaReader)} does not support '{format}' format.");
            }
