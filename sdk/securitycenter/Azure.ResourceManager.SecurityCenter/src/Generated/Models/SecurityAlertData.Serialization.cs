...
namespace Azure.ResourceManager.SecurityCenter
{
    public partial class SecurityAlertData : IUtf8JsonSerializable, IModelJsonSerializable<SecurityAlertData>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<SecurityAlertData>(this, options.Format);
            ...
            if (Optional.IsDefined(SupportingEvidence))
            {
                ...
                if (SupportingEvidence is null)
                {
                    writer.WriteNullValue();
                }
                else
                {
                    ((IModelJsonSerializable<SecurityAlertSupportingEvidence>)SupportingEvidence).Serialize(writer, options);
                }
            }
            writer.WriteEndObject();
        ...
        /// <summary> Converts a <see cref="SecurityAlertData"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="SecurityAlertData"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="SecurityAlertData"/>. </summary>
