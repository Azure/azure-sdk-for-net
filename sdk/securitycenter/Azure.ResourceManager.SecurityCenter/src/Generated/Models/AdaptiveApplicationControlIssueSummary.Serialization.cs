...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AdaptiveApplicationControlIssueSummary>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AdaptiveApplicationControlIssueSummary>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AdaptiveApplicationControlIssueSummary>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AdaptiveApplicationControlIssueSummary>)} interface");
            }
        ...
        string IPersistableModel<AdaptiveApplicationControlIssueSummary>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
