...
{
    public partial class AdaptiveApplicationControlIssueSummary : IUtf8JsonSerializable, IJsonModel<AdaptiveApplicationControlIssueSummary>, IPersistableModel<AdaptiveApplicationControlIssueSummary>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(NumberOfVms))
            {
                builder.Append("  numberOfVms:");
                builder.AppendLine($" '{NumberOfVms.Value.ToString()}'");
            }
