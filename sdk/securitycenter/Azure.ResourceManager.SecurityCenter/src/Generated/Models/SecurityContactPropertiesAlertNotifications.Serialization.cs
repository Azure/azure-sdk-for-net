...
{
    public partial class SecurityContactPropertiesAlertNotifications : IUtf8JsonSerializable, IJsonModel<SecurityContactPropertiesAlertNotifications>, IPersistableModel<SecurityContactPropertiesAlertNotifications>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(MinimalSeverity))
            {
                builder.Append("  minimalSeverity:");
                builder.AppendLine($" '{MinimalSeverity.ToString()}'");
            }
