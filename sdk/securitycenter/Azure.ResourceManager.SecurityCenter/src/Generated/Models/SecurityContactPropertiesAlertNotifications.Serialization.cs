...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    public partial class SecurityContactPropertiesAlertNotifications : IUtf8JsonSerializable, IJsonModel<SecurityContactPropertiesAlertNotifications>
    {
        ...
        void IJsonModel<SecurityContactPropertiesAlertNotifications>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(SecurityContactPropertiesAlertNotifications)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<SecurityContactPropertiesAlertNotifications>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(SecurityContactPropertiesAlertNotifications)} does not support '{options.Format}' format.");
            }
        }
