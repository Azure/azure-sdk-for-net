...
{
    public partial class DevOpsOrgProperties : IUtf8JsonSerializable, IJsonModel<DevOpsOrgProperties>, IPersistableModel<DevOpsOrgProperties>
    {
        ...
        void IJsonModel<DevOpsOrgProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DevOpsOrgProperties)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<DevOpsOrgProperties>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(DevOpsOrgProperties)} does not support '{options.Format}' format.");
            }
        }
