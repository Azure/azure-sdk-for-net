...
{
    public partial class DefenderCspmGcpOfferingVmScanners : IUtf8JsonSerializable, IJsonModel<DefenderCspmGcpOfferingVmScanners>, IPersistableModel<DefenderCspmGcpOfferingVmScanners>
    {
        ...
        internal static DefenderCspmGcpOfferingVmScanners DeserializeDefenderCspmGcpOfferingVmScanners(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("configuration"u8))
                {
                    ...
                    configuration = DefenderCspmGcpOfferingVmScannersConfiguration.DeserializeDefenderCspmGcpOfferingVmScannersConfiguration(property.Value);
                    continue;
                }
                if (options.Format != "W")
                {
