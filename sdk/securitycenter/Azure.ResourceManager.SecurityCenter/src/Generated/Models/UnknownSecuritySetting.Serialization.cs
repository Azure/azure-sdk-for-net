...
{
    internal partial class UnknownSecuritySetting : SecuritySettingData, IJsonModel<SecuritySettingData>
    {
        /// <summary> Initializes a new instance of <see cref="UnknownSecuritySetting"/> for deserialization. </summary>
        internal UnknownSecuritySetting()
        {
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownSecuritySetting DeserializeUnknownSecuritySetting(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownSecuritySetting(
                id,
                name,
                resourceType,
                systemData,
