...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public partial class RecommendationConfigurationProperties
    {
        ...
        internal RecommendationConfigurationProperties(IotSecurityRecommendationType recommendationType, string name, RecommendationConfigStatus status, Dictionary<string, BinaryData> rawData)
        {
            RecommendationType = recommendationType;
            Name = name;
            Status = status;
