...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public partial class RecommendationConfigurationProperties
    {
        ...
        internal RecommendationConfigurationProperties(IotSecurityRecommendationType recommendationType, string name, RecommendationConfigStatus status, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            RecommendationType = recommendationType;
            Name = name;
            Status = status;
