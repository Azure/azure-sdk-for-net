...
namespace Azure.ResourceManager.SecurityCenter
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ComplianceResultData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ComplianceResultData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ComplianceResultData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ComplianceResultData>)} interface");
            }
        ...
        string IPersistableModel<ComplianceResultData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
