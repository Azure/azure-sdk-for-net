...
{
    public partial class ComplianceResultData : IUtf8JsonSerializable, IJsonModel<ComplianceResultData>, IPersistableModel<ComplianceResultData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ComplianceResultData>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ComplianceResultData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ComplianceResultData)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ResourceStatus))
            {
                ...
                builder.AppendLine($" '{ResourceStatus.ToString()}'");
            }
