...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CefExternalSecuritySolution>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CefExternalSecuritySolution>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CefExternalSecuritySolution>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CefExternalSecuritySolution>)} interface");
            }
        ...
        CefExternalSecuritySolution IJsonModel<CefExternalSecuritySolution>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        CefExternalSecuritySolution IPersistableModel<CefExternalSecuritySolution>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == "J" || options.Format == "W";
            if (!isValid)
            {
        ...
        string IPersistableModel<CefExternalSecuritySolution>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
