...
{
    public partial class DefenderFoDatabasesAwsOfferingArcAutoProvisioningConfiguration : IUtf8JsonSerializable, IJsonModel<DefenderFoDatabasesAwsOfferingArcAutoProvisioningConfiguration>, IPersistableModel<DefenderFoDatabasesAwsOfferingArcAutoProvisioningConfiguration>
    {
        ...
        void IJsonModel<DefenderFoDatabasesAwsOfferingArcAutoProvisioningConfiguration>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DefenderFoDatabasesAwsOfferingArcAutoProvisioningConfiguration)} does not support '{format}' format.");
            }
        ...
        internal static DefenderFoDatabasesAwsOfferingArcAutoProvisioningConfiguration DeserializeDefenderFoDatabasesAwsOfferingArcAutoProvisioningConfiguration(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new DefenderFoDatabasesAwsOfferingArcAutoProvisioningConfiguration(proxy.Value, privateLinkScope.Value, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<DefenderFoDatabasesAwsOfferingArcAutoProvisioningConfiguration>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(DefenderFoDatabasesAwsOfferingArcAutoProvisioningConfiguration)} does not support '{options.Format}' format.");
            }
        }
