...
{
    public partial class CustomAssessmentAutomationData : IUtf8JsonSerializable, IJsonModel<CustomAssessmentAutomationData>, IPersistableModel<CustomAssessmentAutomationData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(AssessmentKey))
            {
                builder.Append("  assessmentKey:");
                builder.AppendLine($" '{AssessmentKey}'");
            }
