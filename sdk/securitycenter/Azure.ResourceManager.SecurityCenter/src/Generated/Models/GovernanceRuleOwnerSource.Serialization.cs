...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GovernanceRuleOwnerSource>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<GovernanceRuleOwnerSource>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<GovernanceRuleOwnerSource>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<GovernanceRuleOwnerSource>)} interface");
            }
        ...
        string IPersistableModel<GovernanceRuleOwnerSource>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
