...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DenylistCustomAlertRule>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DenylistCustomAlertRule>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DenylistCustomAlertRule>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DenylistCustomAlertRule>)} interface");
            }
        ...
        string IPersistableModel<DenylistCustomAlertRule>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
