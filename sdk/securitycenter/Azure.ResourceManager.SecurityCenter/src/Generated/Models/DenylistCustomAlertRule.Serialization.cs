...
{
    public partial class DenylistCustomAlertRule : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static DenylistCustomAlertRule DeserializeDenylistCustomAlertRule(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
