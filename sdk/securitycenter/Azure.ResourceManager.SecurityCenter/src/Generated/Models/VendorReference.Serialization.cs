...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VendorReference>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<VendorReference>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<VendorReference>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<VendorReference>)} interface");
            }
        ...
        string IPersistableModel<VendorReference>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
