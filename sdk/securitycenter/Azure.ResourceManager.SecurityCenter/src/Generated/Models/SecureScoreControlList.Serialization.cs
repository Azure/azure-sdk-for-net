...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SecureScoreControlList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SecureScoreControlList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SecureScoreControlList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SecureScoreControlList>)} interface");
            }
        ...
        string IPersistableModel<SecureScoreControlList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
