...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    public partial class GcpMemberOrganizationalInfo : IUtf8JsonSerializable, IJsonModel<GcpMemberOrganizationalInfo>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<GcpMemberOrganizationalInfo>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<GcpMemberOrganizationalInfo>)} interface");
            }
