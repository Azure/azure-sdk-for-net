...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public partial class GcpMemberOrganizationalInfo : GcpOrganizationalInfo, IJsonModel<GcpMemberOrganizationalInfo>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<GcpMemberOrganizationalInfo>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<GcpMemberOrganizationalInfo>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        GcpMemberOrganizationalInfo IPersistableModel<GcpMemberOrganizationalInfo>.Create(BinaryData data, ModelReaderWriterOptions options) => (GcpMemberOrganizationalInfo)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        GcpMemberOrganizationalInfo IJsonModel<GcpMemberOrganizationalInfo>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (GcpMemberOrganizationalInfo)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static GcpMemberOrganizationalInfo DeserializeGcpMemberOrganizationalInfo(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("parentHierarchyId"u8))
                {
                    parentHierarchyId = prop.Value.GetString();
                    continue;
                }
            ...
            return new GcpMemberOrganizationalInfo(organizationMembershipType, additionalBinaryDataProperties, parentHierarchyId, managementProjectNumber);
        }
    }
}
