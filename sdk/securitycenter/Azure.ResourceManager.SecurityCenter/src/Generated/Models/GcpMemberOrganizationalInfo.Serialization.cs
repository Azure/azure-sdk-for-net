...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GcpMemberOrganizationalInfo>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ParentHierarchyId))
            {
                builder.Append("  parentHierarchyId:");
                if (ParentHierarchyId.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
                    builder.AppendLine($"{ParentHierarchyId}'''");
                }
                else
                {
                    builder.AppendLine($" '{ParentHierarchyId}'");
            ...
            if (Optional.IsDefined(ManagementProjectNumber))
            {
                builder.Append("  managementProjectNumber:");
                if (ManagementProjectNumber.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
                    builder.AppendLine($"{ManagementProjectNumber}'''");
                }
                else
                {
                    builder.AppendLine($" '{ManagementProjectNumber}'");
