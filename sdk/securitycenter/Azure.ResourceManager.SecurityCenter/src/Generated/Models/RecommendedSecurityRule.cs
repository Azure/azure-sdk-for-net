...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public partial class RecommendedSecurityRule
    {
        ...
        internal RecommendedSecurityRule(string name, SecurityTrafficDirection? direction, int? destinationPort, IList<SecurityTransportProtocol> protocols, IList<string> ipAddresses, Dictionary<string, BinaryData> rawData)
        {
            Name = name;
            Direction = direction;
