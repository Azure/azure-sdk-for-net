...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MqttC2DMessagesNotInAllowedRange>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MqttC2DMessagesNotInAllowedRange>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MqttC2DMessagesNotInAllowedRange>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MqttC2DMessagesNotInAllowedRange>)} interface");
            }
        ...
        string IPersistableModel<MqttC2DMessagesNotInAllowedRange>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
