...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public partial class MqttC2DMessagesNotInAllowedRange : TimeWindowCustomAlertRule, IJsonModel<MqttC2DMessagesNotInAllowedRange>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<MqttC2DMessagesNotInAllowedRange>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
                ...
                default:
                    throw new FormatException($"The model {nameof(MqttC2DMessagesNotInAllowedRange)} does not support reading '{options.Format}' format.");
            }
        }
        ...
        protected override BinaryData PersistableModelWriteCore(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(MqttC2DMessagesNotInAllowedRange)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        protected override CustomAlertRule JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MqttC2DMessagesNotInAllowedRange)} does not support reading '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static MqttC2DMessagesNotInAllowedRange DeserializeMqttC2DMessagesNotInAllowedRange(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            string ruleType = "MqttC2DMessagesNotInAllowedRange";
