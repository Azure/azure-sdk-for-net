...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public partial class ProcessNotAllowed : AllowlistCustomAlertRule, IJsonModel<ProcessNotAllowed>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<ProcessNotAllowed>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ProcessNotAllowed>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        ProcessNotAllowed IPersistableModel<ProcessNotAllowed>.Create(BinaryData data, ModelReaderWriterOptions options) => (ProcessNotAllowed)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ProcessNotAllowed IJsonModel<ProcessNotAllowed>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (ProcessNotAllowed)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static ProcessNotAllowed DeserializeProcessNotAllowed(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            string ruleType = "ProcessNotAllowed";
