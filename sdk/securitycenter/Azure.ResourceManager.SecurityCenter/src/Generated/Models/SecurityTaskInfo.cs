...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public partial class SecurityTaskInfo
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="SecurityTaskInfo"/>. </summary>
        internal SecurityTaskInfo()
        {
        ...
        internal SecurityTaskInfo(string taskName, IReadOnlyDictionary<string, BinaryData> additionalProperties)
        {
            TaskName = taskName;
