...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AadExternalSecuritySolution>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AadExternalSecuritySolution>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AadExternalSecuritySolution>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AadExternalSecuritySolution>)} interface");
            }
        ...
        string IPersistableModel<AadExternalSecuritySolution>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
