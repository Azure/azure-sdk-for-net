...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    public partial class AadExternalSecuritySolution : IUtf8JsonSerializable, IModelJsonSerializable<AadExternalSecuritySolution>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<AadExternalSecuritySolution>(this, options.Format);
            ...
            if (Optional.IsDefined(Properties))
            {
                ...
                {
                    ((IModelJsonSerializable<AadSolutionProperties>)Properties).Serialize(writer, options);
                }
            }
            if (Kind != null)
            {
        ...
        internal static AadExternalSecuritySolution DeserializeAadExternalSecuritySolution(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new AadExternalSecuritySolution(id, name, type, systemData.Value, kind, Optional.ToNullable(location), properties.Value, serializedAdditionalRawData);
        }
        ...
        /// <summary> Converts a <see cref="AadExternalSecuritySolution"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="AadExternalSecuritySolution"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="AadExternalSecuritySolution"/>. </summary>
