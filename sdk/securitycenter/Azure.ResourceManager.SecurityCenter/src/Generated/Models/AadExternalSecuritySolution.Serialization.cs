...
{
    /// <summary> The AadExternalSecuritySolution. </summary>
    public partial class AadExternalSecuritySolution : ExternalSecuritySolution, IJsonModel<AadExternalSecuritySolution>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<AadExternalSecuritySolution>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<AadExternalSecuritySolution>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        AadExternalSecuritySolution IPersistableModel<AadExternalSecuritySolution>.Create(BinaryData data, ModelReaderWriterOptions options) => (AadExternalSecuritySolution)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        AadExternalSecuritySolution IJsonModel<AadExternalSecuritySolution>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (AadExternalSecuritySolution)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static AadExternalSecuritySolution DeserializeAadExternalSecuritySolution(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = AadSolutionProperties.DeserializeAadSolutionProperties(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
