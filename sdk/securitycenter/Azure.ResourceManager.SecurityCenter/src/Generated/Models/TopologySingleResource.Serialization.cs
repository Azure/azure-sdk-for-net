...
{
    public partial class TopologySingleResource : IUtf8JsonSerializable, IJsonModel<TopologySingleResource>, IPersistableModel<TopologySingleResource>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(TopologyScore))
            {
                ...
                builder.AppendLine($" '{TopologyScore.Value.ToString()}'");
            }
