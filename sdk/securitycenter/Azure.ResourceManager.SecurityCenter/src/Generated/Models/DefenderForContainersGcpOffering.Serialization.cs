...
{
    public partial class DefenderForContainersGcpOffering : IUtf8JsonSerializable, IJsonModel<DefenderForContainersGcpOffering>, IPersistableModel<DefenderForContainersGcpOffering>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(DataPipelineNativeCloudConnection))
            {
                builder.Append("  dataPipelineNativeCloudConnection:");
                AppendChildObject(builder, DataPipelineNativeCloudConnection, options, 2);
            }

            if (Optional.IsDefined(IsAuditLogsAutoProvisioningEnabled))
            {
                builder.Append("  auditLogsAutoProvisioningFlag:");
                var boolValue = IsAuditLogsAutoProvisioningEnabled.Value == true ? "true" : "false";
                builder.AppendLine($" {boolValue}");
            }

            if (Optional.IsDefined(IsDefenderAgentAutoProvisioningEnabled))
            {
                builder.Append("  defenderAgentAutoProvisioningFlag:");
                var boolValue = IsDefenderAgentAutoProvisioningEnabled.Value == true ? "true" : "false";
                builder.AppendLine($" {boolValue}");
            }

            if (Optional.IsDefined(IsPolicyAgentAutoProvisioningEnabled))
            {
                builder.Append("  policyAgentAutoProvisioningFlag:");
                var boolValue = IsPolicyAgentAutoProvisioningEnabled.Value == true ? "true" : "false";
                builder.AppendLine($" {boolValue}");
            }
            ...
            if (Optional.IsDefined(MdcContainersImageAssessment))
            {
                ...
                AppendChildObject(builder, MdcContainersImageAssessment, options, 2);
            }

            if (Optional.IsDefined(MdcContainersAgentlessDiscoveryK8S))
            {
                builder.Append("  mdcContainersAgentlessDiscoveryK8s:");
                AppendChildObject(builder, MdcContainersAgentlessDiscoveryK8S, options, 2);
            }
