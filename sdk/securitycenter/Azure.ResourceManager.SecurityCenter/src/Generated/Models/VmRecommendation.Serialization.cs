...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    public partial class VmRecommendation : IUtf8JsonSerializable, IModelJsonSerializable<VmRecommendation>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<VmRecommendation>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="VmRecommendation"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="VmRecommendation"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="VmRecommendation"/>. </summary>
