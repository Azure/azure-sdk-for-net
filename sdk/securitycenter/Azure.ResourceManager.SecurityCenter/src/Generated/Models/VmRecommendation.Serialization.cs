...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VmRecommendation>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<VmRecommendation>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<VmRecommendation>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<VmRecommendation>)} interface");
            }
        ...
        string IPersistableModel<VmRecommendation>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
