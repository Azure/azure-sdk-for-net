...
{
    public partial class VmRecommendation : IUtf8JsonSerializable, IJsonModel<VmRecommendation>, IPersistableModel<VmRecommendation>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VmRecommendation>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(RecommendationAction))
            {
                builder.Append("  recommendationAction:");
                builder.AppendLine($" '{RecommendationAction.ToString()}'");
            }
            ...
            if (Optional.IsDefined(EnforcementSupport))
            {
                builder.Append("  enforcementSupport:");
                builder.AppendLine($" '{EnforcementSupport.ToString()}'");
            }
