...
{
    public partial class DefenderForDatabasesAwsOfferingRds : Core.IUtf8JsonSerializable
    {
        ...
        internal static DefenderForDatabasesAwsOfferingRds DeserializeDefenderForDatabasesAwsOfferingRds(JsonElement element)
        {
            ...
            return new DefenderForDatabasesAwsOfferingRds(Core.Optional.ToNullable(enabled), cloudRoleArn.Value);
        }
    }
}
