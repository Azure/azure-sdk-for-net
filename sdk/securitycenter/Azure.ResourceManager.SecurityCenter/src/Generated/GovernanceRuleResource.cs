...
namespace Azure.ResourceManager.SecurityCenter
{
    ...
    public partial class GovernanceRuleResource : ArmResource
    {
        ...
        public virtual async Task<Response<OperationResultAutoGenerated>> OperationResultsAsync(string ruleId, string operationId, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(ruleId, nameof(ruleId));
            Argument.AssertNotNullOrEmpty(operationId, nameof(operationId));

            using var scope = _governanceRuleClientDiagnostics.CreateScope("GovernanceRuleResource.OperationResults");
            scope.Start();
            try
            {
                var response = await _governanceRuleRestClient.OperationResultsAsync(Id.Parent.ResourceType.GetLastType(), ruleId, operationId, cancellationToken).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
            {
        ...
        /// <exception cref="ArgumentException"> <paramref name="ruleId"/> or <paramref name="operationId"/> is an empty string, and was expected to be non-empty. </exception>
        /// <exception cref="ArgumentNullException"> <paramref name="ruleId"/> or <paramref name="operationId"/> is null. </exception>
        public virtual Response<OperationResultAutoGenerated> OperationResults(string ruleId, string operationId, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(ruleId, nameof(ruleId));
            Argument.AssertNotNullOrEmpty(operationId, nameof(operationId));
            ...
            try
            {
                var response = _governanceRuleRestClient.OperationResults(Id.Parent.ResourceType.GetLastType(), ruleId, operationId, cancellationToken);
                return response;
            }
            catch (Exception e)
            {
