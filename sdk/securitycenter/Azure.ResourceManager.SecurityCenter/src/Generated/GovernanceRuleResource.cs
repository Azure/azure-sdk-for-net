...
namespace Azure.ResourceManager.SecurityCenter
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="GovernanceRuleResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    ...
    public partial class GovernanceRuleResource : ArmResource
    {
        ...
        public virtual async Task<Response<SecurityCenterOperationResult>> OperationResultsAsync(string operationId, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<SecurityCenterOperationResult> response = Response.FromValue(SecurityCenterOperationResult.FromResponse(result), result);
                if (response.Value == null)
                {
                    throw new RequestFailedException(response.GetRawResponse());
                }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="operationId"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="operationId"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual Response<SecurityCenterOperationResult> OperationResults(string operationId, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(operationId, nameof(operationId));
