...
namespace Azure.ResourceManager.SecurityCenter
{
    ...
    public partial class SecurityComplianceData : ResourceData
    {
        ...
        internal SecurityComplianceData(Core.ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, ComplianceProperties properties) : base(id, name, resourceType, systemData)
        {
