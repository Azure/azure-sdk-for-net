...
{
    internal partial class AllowedConnectionsGetByHomeRegionCollectionResultOfT : Pageable<AllowedConnectionsResourceData>
    {
        ...
        public AllowedConnectionsGetByHomeRegionCollectionResultOfT(AllowedConnections client, Guid subscriptionId, string ascLocation, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        public override IEnumerable<Page<AllowedConnectionsResourceData>> AsPages(string continuationToken, int? pageSizeHint)
        {
