...
{
    internal partial class AlertsGetSubscriptionLevelByRegionAsyncCollectionResultOfT : AsyncPageable<SecurityAlertData>
    {
        ...
        public AlertsGetSubscriptionLevelByRegionAsyncCollectionResultOfT(Alerts client, Guid subscriptionId, AzureLocation ascLocation, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
