...
{
    internal partial class AllowedConnectionsGetAllowedConnectionsCollectionResultOfT : Pageable<SecurityCenterAllowedConnection>
    {
        ...
        public override IEnumerable<Page<SecurityCenterAllowedConnection>> AsPages(string continuationToken, int? pageSizeHint)
        {
