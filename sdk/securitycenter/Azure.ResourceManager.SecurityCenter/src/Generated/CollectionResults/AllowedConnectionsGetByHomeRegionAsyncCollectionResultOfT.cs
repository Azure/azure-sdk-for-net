...
{
    internal partial class AllowedConnectionsGetByHomeRegionAsyncCollectionResultOfT : AsyncPageable<SecurityCenterAllowedConnectionData>
    {
        ...
        public AllowedConnectionsGetByHomeRegionAsyncCollectionResultOfT(AllowedConnections client, Guid subscriptionId, AzureLocation ascLocation, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
