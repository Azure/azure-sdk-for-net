...
{
    internal partial class TasksGetByHomeRegionAsyncCollectionResultOfT : AsyncPageable<ResourceGroupSecurityTaskData>
    {
        ...
        /// <summary> Gets the pages of TasksGetByHomeRegionAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of TasksGetByHomeRegionAsyncCollectionResultOfT as an enumerable collection. </returns>
