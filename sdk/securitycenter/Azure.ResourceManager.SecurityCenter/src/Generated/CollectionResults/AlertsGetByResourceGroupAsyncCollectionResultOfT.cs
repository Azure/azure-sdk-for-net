...
namespace Azure.ResourceManager.SecurityCenter
{
    internal partial class AlertsGetByResourceGroupAsyncCollectionResultOfT : AsyncPageable<ResourceGroupSecurityAlertData>
    {
        ...
        /// <summary> Initializes a new instance of AlertsGetByResourceGroupAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public AlertsGetByResourceGroupAsyncCollectionResultOfT(Alerts client, Guid subscriptionId, string resourceGroupName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of AlertsGetByResourceGroupAsyncCollectionResultOfT as an enumerable collection. </summary>
