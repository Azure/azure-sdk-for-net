...
namespace Azure.ResourceManager.SecurityCenter
{
    internal partial class GovernanceRulesGetAllAsyncCollectionResultOfT : AsyncPageable<SecurityConnectorGovernanceRuleData>
    {
        ...
        /// <summary> Initializes a new instance of GovernanceRulesGetAllAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        /// <param name="client"> The GovernanceRules client used to send requests. </param>
        ...
        public GovernanceRulesGetAllAsyncCollectionResultOfT(GovernanceRules client, string scope, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _scope = scope;
            _context = context;
        ...
        /// <summary> Gets the pages of GovernanceRulesGetAllAsyncCollectionResultOfT as an enumerable collection. </summary>
