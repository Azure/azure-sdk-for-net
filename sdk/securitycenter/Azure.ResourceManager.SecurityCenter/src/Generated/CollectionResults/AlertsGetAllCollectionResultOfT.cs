...
{
    internal partial class AlertsGetAllCollectionResultOfT : Pageable<ResourceGroupSecurityAlertData>
    {
        ...
        public AlertsGetAllCollectionResultOfT(Alerts client, Guid subscriptionId, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
