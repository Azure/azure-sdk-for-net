...
namespace Azure.ResourceManager.SecurityCenter
{
    internal partial class TasksGetByHomeRegionCollectionResultOfT : Pageable<SecurityTaskData>
    {
        ...
        public TasksGetByHomeRegionCollectionResultOfT(Tasks client, Guid subscriptionId, AzureLocation ascLocation, string filter, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
