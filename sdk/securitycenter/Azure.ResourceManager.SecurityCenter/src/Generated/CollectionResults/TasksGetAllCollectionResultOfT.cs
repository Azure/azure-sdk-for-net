...
namespace Azure.ResourceManager.SecurityCenter
{
    internal partial class TasksGetAllCollectionResultOfT : Pageable<SecurityTaskData>
    {
        ...
        /// <summary> Initializes a new instance of TasksGetAllCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public TasksGetAllCollectionResultOfT(Tasks client, Guid subscriptionId, string filter, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of TasksGetAllCollectionResultOfT as an enumerable collection. </summary>
