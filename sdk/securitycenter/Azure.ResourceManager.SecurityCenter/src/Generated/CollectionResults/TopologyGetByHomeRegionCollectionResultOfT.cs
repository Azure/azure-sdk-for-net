...
{
    internal partial class TopologyGetByHomeRegionCollectionResultOfT : Pageable<SecurityTopologyResourceData>
    {
        ...
        public TopologyGetByHomeRegionCollectionResultOfT(Topology client, Guid subscriptionId, AzureLocation ascLocation, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
