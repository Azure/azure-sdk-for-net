...
namespace Azure.ResourceManager.SecurityCenter
{
    internal partial class DiscoveredSecuritySolutionsGetByHomeRegionCollectionResultOfT : Pageable<DiscoveredSecuritySolutionData>
    {
        ...
        public DiscoveredSecuritySolutionsGetByHomeRegionCollectionResultOfT(DiscoveredSecuritySolutions client, Guid subscriptionId, AzureLocation ascLocation, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
