...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public static partial class ArmSecurityCenterModelFactory
    {
        ...
        {
            return new MdeOnboarding(id, name, resourceType, systemData, onboardingPackageWindows, onboardingPackageLinux, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new CustomAssessmentAutomationData(id, name, resourceType, systemData, compressedQuery, supportedCloud, severity, displayName, description, remediationDescription, assessmentKey, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new CustomAssessmentAutomationCreateOrUpdateContent(id, name, resourceType, systemData, compressedQuery, supportedCloud, severity, displayName, description, remediationDescription, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new CustomEntityStoreAssignmentData(id, name, resourceType, systemData, principal, entityStoreDatabaseLink, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ComplianceResultData(id, name, resourceType, systemData, resourceStatus, new Dictionary<string, BinaryData>());
        }
        ...
        public static SecurityCenterPricingData SecurityCenterPricingData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, SecurityCenterPricingTier? pricingTier = null, string subPlan = null, TimeSpan? freeTrialRemainingTime = null, DateTimeOffset? enabledOn = null, bool? isDeprecated = null, IEnumerable<string> replacedBy = null, IEnumerable<PlanExtension> extensions = null)
        {
            ...
            return new SecurityCenterPricingData(id, name, resourceType, systemData, pricingTier, subPlan, freeTrialRemainingTime, enabledOn, isDeprecated, replacedBy?.ToList(), extensions?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static PlanExtension PlanExtension(string name = null, IsExtensionEnabled isEnabled = default, IDictionary<string, BinaryData> additionalExtensionProperties = null, ExtensionOperationStatus operationStatus = null)
        {
            ...
            return new PlanExtension(name, isEnabled, additionalExtensionProperties, operationStatus, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ExtensionOperationStatus(code, message, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AdvancedThreatProtectionSettingData(id, name, resourceType, systemData, isEnabled, new Dictionary<string, BinaryData>());
        }
        ...
        public static DeviceSecurityGroupData DeviceSecurityGroupData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IEnumerable<ThresholdCustomAlertRule> thresholdRules = null, IEnumerable<TimeWindowCustomAlertRule> timeWindowRules = null, IEnumerable<AllowlistCustomAlertRule> allowlistRules = null, IEnumerable<DenylistCustomAlertRule> denylistRules = null)
        {
            ...
            return new DeviceSecurityGroupData(id, name, resourceType, systemData, thresholdRules?.ToList(), timeWindowRules?.ToList(), allowlistRules?.ToList(), denylistRules?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ThresholdCustomAlertRule(displayName, description, isEnabled, "ThresholdCustomAlertRule", new Dictionary<string, BinaryData>(), minThreshold, maxThreshold);
        }
        ...
        {
            return new UnknownCustomAlertRule(displayName, description, isEnabled, ruleType, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new TimeWindowCustomAlertRule(displayName, description, isEnabled, "TimeWindowCustomAlertRule", new Dictionary<string, BinaryData>(), minThreshold, maxThreshold, timeWindowSize);
        }
        ...
        public static AllowlistCustomAlertRule AllowlistCustomAlertRule(string displayName = null, string description = null, bool isEnabled = default, SecurityValueType? valueType = null, IEnumerable<string> allowlistValues = null)
        {
            ...
            return new AllowlistCustomAlertRule(displayName, description, isEnabled, "AllowlistCustomAlertRule", new Dictionary<string, BinaryData>(), valueType, allowlistValues?.ToList());
        }
        ...
        {
            return new ListCustomAlertRule(displayName, description, isEnabled, "ListCustomAlertRule", new Dictionary<string, BinaryData>(), valueType);
        }
        ...
        public static DenylistCustomAlertRule DenylistCustomAlertRule(string displayName = null, string description = null, bool isEnabled = default, SecurityValueType? valueType = null, IEnumerable<string> denylistValues = null)
        {
            ...
            return new DenylistCustomAlertRule(displayName, description, isEnabled, "DenylistCustomAlertRule", new Dictionary<string, BinaryData>(), valueType, denylistValues?.ToList());
        }
        ...
        public static IotSecuritySolutionData IotSecuritySolutionData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, string workspace = null, string displayName = null, SecuritySolutionStatus? status = null, IEnumerable<IotSecuritySolutionExportOption> export = null, IEnumerable<IotSecuritySolutionDataSource> disabledDataSources = null, IEnumerable<string> iotHubs = null, UserDefinedResourcesProperties userDefinedResources = null, IEnumerable<string> autoDiscoveredResources = null, IEnumerable<RecommendationConfigurationProperties> recommendationsConfiguration = null, UnmaskedIPLoggingStatus? unmaskedIPLoggingStatus = null, IEnumerable<AdditionalWorkspacesProperties> additionalWorkspaces = null)
        {
            ...
            return new IotSecuritySolutionData(id, name, resourceType, systemData, tags, location, workspace, displayName, status, export?.ToList(), disabledDataSources?.ToList(), iotHubs?.ToList(), userDefinedResources, autoDiscoveredResources?.ToList(), recommendationsConfiguration?.ToList(), unmaskedIPLoggingStatus, additionalWorkspaces?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new RecommendationConfigurationProperties(recommendationType, name, status, new Dictionary<string, BinaryData>());
        }
        ...
        public static IotSecuritySolutionAnalyticsModelData IotSecuritySolutionAnalyticsModelData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IotSeverityMetrics metrics = null, long? unhealthyDeviceCount = null, IEnumerable<IotSecuritySolutionAnalyticsModelDevicesMetrics> devicesMetrics = null, IEnumerable<IotSecurityAlertedDevice> topAlertedDevices = null, IEnumerable<IotSecurityDeviceAlert> mostPrevalentDeviceAlerts = null, IEnumerable<IotSecurityDeviceRecommendation> mostPrevalentDeviceRecommendations = null)
        {
            ...
            return new IotSecuritySolutionAnalyticsModelData(id, name, resourceType, systemData, metrics, unhealthyDeviceCount, devicesMetrics?.ToList(), topAlertedDevices?.ToList(), mostPrevalentDeviceAlerts?.ToList(), mostPrevalentDeviceRecommendations?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new IotSeverityMetrics(high, medium, low, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new IotSecuritySolutionAnalyticsModelDevicesMetrics(date, devicesMetrics, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new IotSecurityAlertedDevice(deviceId, alertsCount, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new IotSecurityDeviceAlert(alertDisplayName, reportedSeverity, alertsCount, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new IotSecurityDeviceRecommendation(recommendationDisplayName, reportedSeverity, devicesCount, new Dictionary<string, BinaryData>());
        }
        ...
        public static IotSecurityAggregatedAlertData IotSecurityAggregatedAlertData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string alertType = null, string alertDisplayName = null, DateTimeOffset? aggregatedOn = null, string vendorName = null, ReportedSeverity? reportedSeverity = null, string remediationSteps = null, string description = null, long? count = null, string effectedResourceType = null, string systemSource = null, string actionTaken = null, string logAnalyticsQuery = null, IEnumerable<IotSecurityAggregatedAlertTopDevice> topDevicesList = null, IDictionary<string, string> tags = null)
        {
            ...
            return new IotSecurityAggregatedAlertData(id, name, resourceType, systemData, alertType, alertDisplayName, aggregatedOn, vendorName, reportedSeverity, remediationSteps, description, count, effectedResourceType, systemSource, actionTaken, logAnalyticsQuery, topDevicesList?.ToList(), tags, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new IotSecurityAggregatedAlertTopDevice(deviceId, alertsCount, lastOccurrence, new Dictionary<string, BinaryData>());
        }
        ...
        public static IotSecurityAggregatedRecommendationData IotSecurityAggregatedRecommendationData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string recommendationName = null, string recommendationDisplayName = null, string description = null, string recommendationTypeId = null, string detectedBy = null, string remediationSteps = null, ReportedSeverity? reportedSeverity = null, long? healthyDevices = null, long? unhealthyDeviceCount = null, string logAnalyticsQuery = null, IDictionary<string, string> tags = null)
        {
            ...
            return new IotSecurityAggregatedRecommendationData(id, name, resourceType, systemData, recommendationName, recommendationDisplayName, description, recommendationTypeId, detectedBy, remediationSteps, reportedSeverity, healthyDevices, unhealthyDeviceCount, logAnalyticsQuery, tags, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SecurityCenterLocationData(id, name, resourceType, systemData, properties, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SecurityTaskData(id, name, resourceType, systemData, state, createdOn, securityTaskParameters, lastStateChangedOn, subState, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AutoProvisioningSettingData(id, name, resourceType, systemData, autoProvision, new Dictionary<string, BinaryData>());
        }
        ...
        public static SecurityComplianceData SecurityComplianceData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, DateTimeOffset? assessedOn = null, int? resourceCount = null, IEnumerable<ComplianceSegment> assessmentResult = null)
        {
            ...
            return new SecurityComplianceData(id, name, resourceType, systemData, assessedOn, resourceCount, assessmentResult?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ComplianceSegment(segmentType, percentage, new Dictionary<string, BinaryData>());
        }
        ...
        public static InformationProtectionPolicy InformationProtectionPolicy(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, DateTimeOffset? lastModifiedUtc = null, string version = null, IDictionary<string, SensitivityLabel> labels = null, IDictionary<string, SecurityInformationTypeInfo> informationTypes = null)
        {
            ...
            return new InformationProtectionPolicy(id, name, resourceType, systemData, lastModifiedUtc, version, labels, informationTypes, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SecurityContactData(id, name, resourceType, systemData, emails, phone, alertNotifications, notificationsByRole, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SecurityWorkspaceSettingData(id, name, resourceType, systemData, workspaceId, scope, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new RegulatoryComplianceStandardData(id, name, resourceType, systemData, state, passedControls, failedControls, skippedControls, unsupportedControls, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new RegulatoryComplianceControlData(id, name, resourceType, systemData, description, state, passedAssessments, failedAssessments, skippedAssessments, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new RegulatoryComplianceAssessmentData(id, name, resourceType, systemData, description, assessmentType, assessmentDetailsLink, state, passedResources, failedResources, skippedResources, unsupportedResources, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SecuritySubAssessmentData(id, name, resourceType, systemData, vulnerabilityId, displayName, status, remediation, impact, category, description, generatedOn, resourceDetails, additionalData, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SubAssessmentStatus(code, cause, description, severity, new Dictionary<string, BinaryData>());
        }
        ...
        public static SecurityAutomationData SecurityAutomationData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, string description = null, bool? isEnabled = null, IEnumerable<SecurityAutomationScope> scopes = null, IEnumerable<SecurityAutomationSource> sources = null, IEnumerable<SecurityAutomationAction> actions = null, string kind = null, ETag? eTag = null)
        {
            ...
            return new SecurityAutomationData(id, name, resourceType, systemData, tags, location, description, isEnabled, scopes?.ToList(), sources?.ToList(), actions?.ToList(), kind, eTag, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SecurityAutomationValidationStatus(isValid, message, new Dictionary<string, BinaryData>());
        }
        ...
        public static SecurityAlertsSuppressionRuleData SecurityAlertsSuppressionRuleData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string alertType = null, DateTimeOffset? lastModifiedOn = null, DateTimeOffset? expireOn = null, string reason = null, SecurityAlertsSuppressionRuleState? state = null, string comment = null, IEnumerable<SuppressionAlertsScopeElement> suppressionAlertsScopeAllOf = null)
        {
            ...
            return new SecurityAlertsSuppressionRuleData(id, name, resourceType, systemData, alertType, lastModifiedOn, expireOn, reason, state, comment, suppressionAlertsScopeAllOf != null ? new SuppressionAlertsScope(suppressionAlertsScopeAllOf?.ToList(), new Dictionary<string, BinaryData>()) : null, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ServerVulnerabilityAssessmentData(id, name, resourceType, systemData, provisioningState, new Dictionary<string, BinaryData>());
        }
        ...
        public static SecurityAssessmentMetadataProperties SecurityAssessmentMetadataProperties(string displayName = null, ResourceIdentifier policyDefinitionId = null, string description = null, string remediationDescription = null, IEnumerable<SecurityAssessmentResourceCategory> categories = null, SecurityAssessmentSeverity severity = default, SecurityAssessmentUserImpact? userImpact = null, ImplementationEffort? implementationEffort = null, IEnumerable<SecurityThreat> threats = null, bool? isPreview = null, SecurityAssessmentType assessmentType = default, SecurityAssessmentMetadataPartner partnerData = null)
        {
            ...
            return new SecurityAssessmentMetadataProperties(displayName, policyDefinitionId, description, remediationDescription, categories?.ToList(), severity, userImpact, implementationEffort, threats?.ToList(), isPreview, assessmentType, partnerData, new Dictionary<string, BinaryData>());
        }
        ...
        public static SecurityAssessmentData SecurityAssessmentData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, SecurityCenterResourceDetails resourceDetails = null, string displayName = null, IDictionary<string, string> additionalData = null, Uri linksAzurePortalUri = null, SecurityAssessmentMetadataProperties metadata = null, SecurityAssessmentPartner partnersData = null, SecurityAssessmentStatusResult status = null)
        {
            ...
            return new SecurityAssessmentData(id, name, resourceType, systemData, resourceDetails, displayName, additionalData, linksAzurePortalUri != null ? new AssessmentLinks(linksAzurePortalUri, new Dictionary<string, BinaryData>()) : null, metadata, partnersData, status, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SecurityAssessmentStatusResult(code, cause, description, new Dictionary<string, BinaryData>(), firstEvaluatedOn, statusChangeOn);
        }
        ...
        public static SecurityAssessmentCreateOrUpdateContent SecurityAssessmentCreateOrUpdateContent(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, SecurityCenterResourceDetails resourceDetails = null, string displayName = null, IDictionary<string, string> additionalData = null, Uri linksAzurePortalUri = null, SecurityAssessmentMetadataProperties metadata = null, SecurityAssessmentPartner partnersData = null, SecurityAssessmentStatus status = null)
        {
            ...
            return new SecurityAssessmentCreateOrUpdateContent(id, name, resourceType, systemData, resourceDetails, displayName, additionalData, linksAzurePortalUri != null ? new AssessmentLinks(linksAzurePortalUri, new Dictionary<string, BinaryData>()) : null, metadata, partnersData, status, new Dictionary<string, BinaryData>());
        }
        ...
        public static AdaptiveApplicationControlGroupData AdaptiveApplicationControlGroupData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, AdaptiveApplicationControlEnforcementMode? enforcementMode = null, SecurityCenterFileProtectionMode protectionMode = null, SecurityCenterConfigurationStatus? configurationStatus = null, RecommendationStatus? recommendationStatus = null, IEnumerable<AdaptiveApplicationControlIssueSummary> issues = null, AdaptiveApplicationControlGroupSourceSystem? sourceSystem = null, IEnumerable<VmRecommendation> vmRecommendations = null, IEnumerable<PathRecommendation> pathRecommendations = null, AzureLocation? location = null)
        {
            ...
            return new AdaptiveApplicationControlGroupData(id, name, resourceType, systemData, enforcementMode, protectionMode, configurationStatus, recommendationStatus, issues?.ToList(), sourceSystem, vmRecommendations?.ToList(), pathRecommendations?.ToList(), location, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AdaptiveApplicationControlIssueSummary(issue, numberOfVms, new Dictionary<string, BinaryData>());
        }
        ...
        public static AdaptiveNetworkHardeningData AdaptiveNetworkHardeningData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IEnumerable<RecommendedSecurityRule> rules = null, DateTimeOffset? rulesCalculatedOn = null, IEnumerable<EffectiveNetworkSecurityGroups> effectiveNetworkSecurityGroups = null)
        {
            ...
            return new AdaptiveNetworkHardeningData(id, name, resourceType, systemData, rules?.ToList(), rulesCalculatedOn, effectiveNetworkSecurityGroups?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static SecurityCenterAllowedConnection SecurityCenterAllowedConnection(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, DateTimeOffset? calculatedOn = null, IEnumerable<ConnectableResourceInfo> connectableResources = null, AzureLocation? location = null)
        {
            ...
            return new SecurityCenterAllowedConnection(id, name, resourceType, systemData, calculatedOn, connectableResources?.ToList(), location, new Dictionary<string, BinaryData>());
        }
        ...
        public static ConnectableResourceInfo ConnectableResourceInfo(ResourceIdentifier id = null, IEnumerable<ConnectedResourceInfo> inboundConnectedResources = null, IEnumerable<ConnectedResourceInfo> outboundConnectedResources = null)
        {
            ...
            return new ConnectableResourceInfo(id, inboundConnectedResources?.ToList(), outboundConnectedResources?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ConnectedResourceInfo(connectedResourceId, tcpPorts, udpPorts, new Dictionary<string, BinaryData>());
        }
        ...
        public static SecurityTopologyResource SecurityTopologyResource(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, DateTimeOffset? calculatedOn = null, IEnumerable<TopologySingleResource> topologyResources = null, AzureLocation? location = null)
        {
            ...
            return new SecurityTopologyResource(id, name, resourceType, systemData, calculatedOn, topologyResources?.ToList(), location, new Dictionary<string, BinaryData>());
        }
        ...
        public static TopologySingleResource TopologySingleResource(ResourceIdentifier resourceId = null, string severity = null, bool? recommendationsExist = null, string networkZones = null, int? topologyScore = null, AzureLocation? location = null, IEnumerable<TopologySingleResourceParent> parents = null, IEnumerable<TopologySingleResourceChild> children = null)
        {
            ...
            return new TopologySingleResource(resourceId, severity, recommendationsExist, networkZones, topologyScore, location, parents?.ToList(), children?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new TopologySingleResourceParent(resourceId, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new TopologySingleResourceChild(resourceId, new Dictionary<string, BinaryData>());
        }
        ...
        public static JitNetworkAccessPolicyData JitNetworkAccessPolicyData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IEnumerable<JitNetworkAccessPolicyVirtualMachine> virtualMachines = null, IEnumerable<JitNetworkAccessRequestInfo> requests = null, string provisioningState = null, string kind = null, AzureLocation? location = null)
        {
            ...
            return new JitNetworkAccessPolicyData(id, name, resourceType, systemData, virtualMachines?.ToList(), requests?.ToList(), provisioningState, kind, location, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new JitNetworkAccessPolicyInitiatePort(number, allowedSourceAddressPrefix, endOn, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DiscoveredSecuritySolution(id, name, resourceType, systemData, securityFamily, offer, publisher, sku, location, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SecuritySolutionsReferenceData(id, name, resourceType, systemData, securityFamily, alertVendorName, packageInfoUri, productName, publisher, publisherDisplayName, template, location, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ExternalSecuritySolution(id, name, resourceType, systemData, kind, location, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SecureScoreData(id, name, resourceType, systemData, displayName, weight, max, current, percentage, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SecureScoreControlDetails(id, name, resourceType, systemData, displayName, healthyResourceCount, unhealthyResourceCount, notApplicableResourceCount, weight, definition, max, current, percentage, new Dictionary<string, BinaryData>());
        }
        ...
        public static SecureScoreControlDefinitionItem SecureScoreControlDefinitionItem(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string displayName = null, string description = null, int? maxScore = null, SecurityControlType? sourceType = null, IEnumerable<SubResource> assessmentDefinitions = null)
        {
            ...
            return new SecureScoreControlDefinitionItem(id, name, resourceType, systemData, displayName, description, maxScore, sourceType != null ? new SecureScoreControlDefinitionSource(sourceType, new Dictionary<string, BinaryData>()) : null, assessmentDefinitions?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SecuritySolution(id, name, resourceType, systemData, securityFamily, provisioningState, template, protectionStatus, location, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SecurityCloudConnectorData(id, name, resourceType, systemData, hybridComputeSettings, authenticationDetails, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new HybridComputeSettingsProperties(hybridComputeProvisioningState, autoProvision, resourceGroupName, region, proxyServer, servicePrincipal, new Dictionary<string, BinaryData>());
        }
        ...
        public static AuthenticationDetailsProperties AuthenticationDetailsProperties(AuthenticationProvisioningState? authenticationProvisioningState = null, IEnumerable<SecurityCenterCloudPermission> grantedPermissions = null, string authenticationType = "Unknown")
        {
            ...
            return new UnknownAuthenticationDetailsProperties(authenticationProvisioningState, grantedPermissions?.ToList(), authenticationType, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SecuritySettingData(id, name, resourceType, systemData, kind, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new IngestionSettingData(id, name, resourceType, systemData, properties, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new IngestionSettingToken(token, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new IngestionConnectionString(location, value, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SoftwareInventoryData(id, name, resourceType, systemData, deviceId, osPlatform, vendor, softwareName, version, endOfSupportStatus, endOfSupportDate, numberOfKnownVulnerabilities, firstSeenOn, new Dictionary<string, BinaryData>());
        }
        ...
        public static SecurityConnectorData SecurityConnectorData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, string hierarchyIdentifier = null, DateTimeOffset? hierarchyIdentifierTrialEndOn = null, SecurityCenterCloudName? environmentName = null, IEnumerable<SecurityCenterCloudOffering> offerings = null, SecurityConnectorEnvironment environmentData = null, string kind = null, ETag? eTag = null)
        {
            ...
            return new SecurityConnectorData(id, name, resourceType, systemData, tags, location, hierarchyIdentifier, hierarchyIdentifierTrialEndOn, environmentName, offerings?.ToList(), environmentData, kind, eTag, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new UnknownCloudOffering(offeringType, description, new Dictionary<string, BinaryData>());
        }
        ...
        public static GovernanceRuleData GovernanceRuleData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, Guid? tenantId = null, string displayName = null, string description = null, string remediationTimeframe = null, bool? isGracePeriod = null, int? rulePriority = null, bool? isDisabled = null, GovernanceRuleType? ruleType = null, GovernanceRuleSourceResourceType? sourceResourceType = null, IEnumerable<string> excludedScopes = null, IEnumerable<BinaryData> conditionSets = null, bool? includeMemberScopes = null, GovernanceRuleOwnerSource ownerSource = null, GovernanceRuleEmailNotification governanceEmailNotification = null, GovernanceRuleMetadata metadata = null)
        {
            ...
            return new GovernanceRuleData(id, name, resourceType, systemData, tenantId, displayName, description, remediationTimeframe, isGracePeriod, rulePriority, isDisabled, ruleType, sourceResourceType, excludedScopes?.ToList(), conditionSets?.ToList(), includeMemberScopes, ownerSource, governanceEmailNotification, metadata, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new GovernanceRuleMetadata(createdBy, createdOn, updatedBy, updatedOn, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new GovernanceAssignmentData(id, name, resourceType, systemData, owner, remediationDueOn, remediationEta, isGracePeriod, governanceEmailNotification, additionalData, new Dictionary<string, BinaryData>());
        }
        ...
        public static SecurityApplicationData SecurityApplicationData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string displayName = null, string description = null, ApplicationSourceResourceType? sourceResourceType = null, IEnumerable<BinaryData> conditionSets = null)
        {
            ...
            return new SecurityApplicationData(id, name, resourceType, systemData, displayName, description, sourceResourceType, conditionSets?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SqlVulnerabilityAssessmentScanData(id, name, resourceType, systemData, properties, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SqlVulnerabilityAssessmentScanResult(id, name, resourceType, systemData, properties, new Dictionary<string, BinaryData>());
        }
        ...
        public static SqlVulnerabilityAssessmentBaselineRuleData SqlVulnerabilityAssessmentBaselineRuleData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IEnumerable<IList<string>> ruleResults = null)
        {
            ...
            return new SqlVulnerabilityAssessmentBaselineRuleData(id, name, resourceType, systemData, ruleResults != null ? new RuleResultsProperties(ruleResults?.ToList(), new Dictionary<string, BinaryData>()) : null, new Dictionary<string, BinaryData>());
        }
        ...
        public static ConnectionToIPNotAllowed ConnectionToIPNotAllowed(string displayName = null, string description = null, bool isEnabled = default, SecurityValueType? valueType = null, IEnumerable<string> allowlistValues = null)
        {
            ...
            return new ConnectionToIPNotAllowed(displayName, description, isEnabled, "ConnectionToIpNotAllowed", new Dictionary<string, BinaryData>(), valueType, allowlistValues?.ToList());
        }
        ...
        public static ConnectionFromIPNotAllowed ConnectionFromIPNotAllowed(string displayName = null, string description = null, bool isEnabled = default, SecurityValueType? valueType = null, IEnumerable<string> allowlistValues = null)
        {
            ...
            return new ConnectionFromIPNotAllowed(displayName, description, isEnabled, "ConnectionFromIpNotAllowed", new Dictionary<string, BinaryData>(), valueType, allowlistValues?.ToList());
        }
        ...
        public static LocalUserNotAllowed LocalUserNotAllowed(string displayName = null, string description = null, bool isEnabled = default, SecurityValueType? valueType = null, IEnumerable<string> allowlistValues = null)
        {
            ...
            return new LocalUserNotAllowed(displayName, description, isEnabled, "LocalUserNotAllowed", new Dictionary<string, BinaryData>(), valueType, allowlistValues?.ToList());
        }
        ...
        public static ProcessNotAllowed ProcessNotAllowed(string displayName = null, string description = null, bool isEnabled = default, SecurityValueType? valueType = null, IEnumerable<string> allowlistValues = null)
        {
            ...
            return new ProcessNotAllowed(displayName, description, isEnabled, "ProcessNotAllowed", new Dictionary<string, BinaryData>(), valueType, allowlistValues?.ToList());
        }
        ...
        {
            return new ActiveConnectionsNotInAllowedRange(displayName, description, isEnabled, "ActiveConnectionsNotInAllowedRange", new Dictionary<string, BinaryData>(), minThreshold, maxThreshold, timeWindowSize);
        }
        ...
        {
            return new AmqpC2DMessagesNotInAllowedRange(displayName, description, isEnabled, "AmqpC2DMessagesNotInAllowedRange", new Dictionary<string, BinaryData>(), minThreshold, maxThreshold, timeWindowSize);
        }
        ...
        {
            return new MqttC2DMessagesNotInAllowedRange(displayName, description, isEnabled, "MqttC2DMessagesNotInAllowedRange", new Dictionary<string, BinaryData>(), minThreshold, maxThreshold, timeWindowSize);
        }
        ...
        {
            return new HttpC2DMessagesNotInAllowedRange(displayName, description, isEnabled, "HttpC2DMessagesNotInAllowedRange", new Dictionary<string, BinaryData>(), minThreshold, maxThreshold, timeWindowSize);
        }
        ...
        {
            return new AmqpC2DRejectedMessagesNotInAllowedRange(displayName, description, isEnabled, "AmqpC2DRejectedMessagesNotInAllowedRange", new Dictionary<string, BinaryData>(), minThreshold, maxThreshold, timeWindowSize);
        }
        ...
        {
            return new MqttC2DRejectedMessagesNotInAllowedRange(displayName, description, isEnabled, "MqttC2DRejectedMessagesNotInAllowedRange", new Dictionary<string, BinaryData>(), minThreshold, maxThreshold, timeWindowSize);
        }
        ...
        {
            return new HttpC2DRejectedMessagesNotInAllowedRange(displayName, description, isEnabled, "HttpC2DRejectedMessagesNotInAllowedRange", new Dictionary<string, BinaryData>(), minThreshold, maxThreshold, timeWindowSize);
        }
        ...
        {
            return new AmqpD2CMessagesNotInAllowedRange(displayName, description, isEnabled, "AmqpD2CMessagesNotInAllowedRange", new Dictionary<string, BinaryData>(), minThreshold, maxThreshold, timeWindowSize);
        }
        ...
        {
            return new MqttD2CMessagesNotInAllowedRange(displayName, description, isEnabled, "MqttD2CMessagesNotInAllowedRange", new Dictionary<string, BinaryData>(), minThreshold, maxThreshold, timeWindowSize);
        }
        ...
        {
            return new HttpD2CMessagesNotInAllowedRange(displayName, description, isEnabled, "HttpD2CMessagesNotInAllowedRange", new Dictionary<string, BinaryData>(), minThreshold, maxThreshold, timeWindowSize);
        }
        ...
        {
            return new DirectMethodInvokesNotInAllowedRange(displayName, description, isEnabled, "DirectMethodInvokesNotInAllowedRange", new Dictionary<string, BinaryData>(), minThreshold, maxThreshold, timeWindowSize);
        }
        ...
        {
            return new FailedLocalLoginsNotInAllowedRange(displayName, description, isEnabled, "FailedLocalLoginsNotInAllowedRange", new Dictionary<string, BinaryData>(), minThreshold, maxThreshold, timeWindowSize);
        }
        ...
        {
            return new FileUploadsNotInAllowedRange(displayName, description, isEnabled, "FileUploadsNotInAllowedRange", new Dictionary<string, BinaryData>(), minThreshold, maxThreshold, timeWindowSize);
        }
        ...
        {
            return new QueuePurgesNotInAllowedRange(displayName, description, isEnabled, "QueuePurgesNotInAllowedRange", new Dictionary<string, BinaryData>(), minThreshold, maxThreshold, timeWindowSize);
        }
        ...
        {
            return new TwinUpdatesNotInAllowedRange(displayName, description, isEnabled, "TwinUpdatesNotInAllowedRange", new Dictionary<string, BinaryData>(), minThreshold, maxThreshold, timeWindowSize);
        }
        ...
        {
            return new UnauthorizedOperationsNotInAllowedRange(displayName, description, isEnabled, "UnauthorizedOperationsNotInAllowedRange", new Dictionary<string, BinaryData>(), minThreshold, maxThreshold, timeWindowSize);
        }
        ...
        {
            return new SqlServerVulnerabilityProperties(AssessedResourceType.SqlServerVulnerability, new Dictionary<string, BinaryData>(), sqlServerVulnerabilityType, query);
        }
        ...
        public static ContainerRegistryVulnerabilityProperties ContainerRegistryVulnerabilityProperties(string containerRegistryVulnerabilityPropertiesType = null, IReadOnlyDictionary<string, SecurityCvss> cvss = null, bool? isPatchable = null, IEnumerable<SecurityCve> cve = null, DateTimeOffset? publishedOn = null, IEnumerable<VendorReference> vendorReferences = null, string repositoryName = null, string imageDigest = null)
        {
            ...
            return new ContainerRegistryVulnerabilityProperties(AssessedResourceType.ContainerRegistryVulnerability, new Dictionary<string, BinaryData>(), containerRegistryVulnerabilityPropertiesType, cvss, isPatchable, cve?.ToList(), publishedOn, vendorReferences?.ToList(), repositoryName, imageDigest);
        }
        ...
        {
            return new SecurityCvss(@base, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SecurityCve(title, link, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new VendorReference(title, link, new Dictionary<string, BinaryData>());
        }
        ...
        public static ServerVulnerabilityProperties ServerVulnerabilityProperties(string serverVulnerabilityType = null, IReadOnlyDictionary<string, SecurityCvss> cvss = null, bool? isPatchable = null, IEnumerable<SecurityCve> cve = null, string threat = null, DateTimeOffset? publishedOn = null, IEnumerable<VendorReference> vendorReferences = null)
        {
            ...
            return new ServerVulnerabilityProperties(new AssessedResourceType("ServerVulnerabilityAssessment"), new Dictionary<string, BinaryData>(), serverVulnerabilityType, cvss, isPatchable, cve?.ToList(), threat, publishedOn, vendorReferences?.ToList());
        }
        ...
        {
            return new SecurityAutomationActionEventHub(ActionType.EventHub, new Dictionary<string, BinaryData>(), eventHubResourceId, sasPolicyName, connectionString);
        }
        ...
        {
            return new CefExternalSecuritySolution(id, name, resourceType, systemData, ExternalSecuritySolutionKind.Cef, location, new Dictionary<string, BinaryData>(), properties);
        }
        ...
        {
            return new AtaExternalSecuritySolution(id, name, resourceType, systemData, ExternalSecuritySolutionKind.Ata, location, new Dictionary<string, BinaryData>(), properties);
        }
        ...
        {
            return new AadExternalSecuritySolution(id, name, resourceType, systemData, ExternalSecuritySolutionKind.Aad, location, new Dictionary<string, BinaryData>(), properties);
        }
        ...
        public static AwsCredsAuthenticationDetailsProperties AwsCredsAuthenticationDetailsProperties(AuthenticationProvisioningState? authenticationProvisioningState = null, IEnumerable<SecurityCenterCloudPermission> grantedPermissions = null, string accountId = null, string awsAccessKeyId = null, string awsSecretAccessKey = null)
        {
            ...
            return new AwsCredsAuthenticationDetailsProperties(authenticationProvisioningState, grantedPermissions?.ToList(), AuthenticationType.AwsCreds, new Dictionary<string, BinaryData>(), accountId, awsAccessKeyId, awsSecretAccessKey);
        }
        ...
        public static AwsAssumeRoleAuthenticationDetailsProperties AwsAssumeRoleAuthenticationDetailsProperties(AuthenticationProvisioningState? authenticationProvisioningState = null, IEnumerable<SecurityCenterCloudPermission> grantedPermissions = null, string accountId = null, string awsAssumeRoleArn = null, Guid awsExternalId = default)
        {
            ...
            return new AwsAssumeRoleAuthenticationDetailsProperties(authenticationProvisioningState, grantedPermissions?.ToList(), AuthenticationType.AwsAssumeRole, new Dictionary<string, BinaryData>(), accountId, awsAssumeRoleArn, awsExternalId);
        }
        ...
        public static GcpCredentialsDetailsProperties GcpCredentialsDetailsProperties(AuthenticationProvisioningState? authenticationProvisioningState = null, IEnumerable<SecurityCenterCloudPermission> grantedPermissions = null, string organizationId = null, string gcpCredentialType = null, string projectId = null, string privateKeyId = null, string privateKey = null, string clientEmail = null, string clientId = null, Uri authUri = null, Uri tokenUri = null, Uri authProviderX509CertUri = null, Uri clientX509CertUri = null)
        {
            ...
            return new GcpCredentialsDetailsProperties(authenticationProvisioningState, grantedPermissions?.ToList(), AuthenticationType.GcpCredentials, new Dictionary<string, BinaryData>(), organizationId, gcpCredentialType, projectId, privateKeyId, privateKey, clientEmail, clientId, authUri, tokenUri, authProviderX509CertUri, clientX509CertUri);
        }
        ...
        {
            return new AzureResourceIdentifier(ResourceIdentifierType.AzureResource, new Dictionary<string, BinaryData>(), azureResourceId);
        }
        ...
        {
            return new LogAnalyticsIdentifier(ResourceIdentifierType.LogAnalytics, new Dictionary<string, BinaryData>(), workspaceId, workspaceSubscriptionId, workspaceResourceGroup, agentId);
        }
        ...
        {
            return new DataExportSettings(id, name, resourceType, systemData, SettingKind.DataExportSettings, new Dictionary<string, BinaryData>(), isEnabled);
        }
        ...
        {
            return new SecurityAlertSyncSettings(id, name, resourceType, systemData, SettingKind.AlertSyncSettings, new Dictionary<string, BinaryData>(), isEnabled);
        }
        ...
        {
            return new GcpProjectDetails(projectNumber, projectId, workloadIdentityPoolId, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new CspmMonitorAwsOffering(OfferingType.CspmMonitorAws, description, new Dictionary<string, BinaryData>(), cloudRoleArn != null ? new CspmMonitorAwsOfferingNativeCloudConnection(cloudRoleArn, new Dictionary<string, BinaryData>()) : null);
        }
        ...
        {
            return new DefenderForContainersAwsOffering(OfferingType.DefenderForContainersAws, description, new Dictionary<string, BinaryData>(), kubernetesServiceCloudRoleArn != null ? new DefenderForContainersAwsOfferingKubernetesService(kubernetesServiceCloudRoleArn, new Dictionary<string, BinaryData>()) : null, kubernetesScubaReaderCloudRoleArn != null ? new DefenderForContainersAwsOfferingKubernetesScubaReader(kubernetesScubaReaderCloudRoleArn, new Dictionary<string, BinaryData>()) : null, cloudRoleArn != null ? new DefenderForContainersAwsOfferingCloudWatchToKinesis(cloudRoleArn, new Dictionary<string, BinaryData>()) : null, kinesisToS3CloudRoleArn != null ? new DefenderForContainersAwsOfferingKinesisToS3(kinesisToS3CloudRoleArn, new Dictionary<string, BinaryData>()) : null, containerVulnerabilityAssessmentCloudRoleArn != null ? new DefenderForContainersAwsOfferingContainerVulnerabilityAssessment(containerVulnerabilityAssessmentCloudRoleArn, new Dictionary<string, BinaryData>()) : null, containerVulnerabilityAssessmentTaskCloudRoleArn != null ? new DefenderForContainersAwsOfferingContainerVulnerabilityAssessmentTask(containerVulnerabilityAssessmentTaskCloudRoleArn, new Dictionary<string, BinaryData>()) : null, isContainerVulnerabilityAssessmentEnabled, isAutoProvisioningEnabled, kubeAuditRetentionTime, scubaExternalId);
        }
        ...
        {
            return new DefenderForServersAwsOffering(OfferingType.DefenderForServersAws, description, new Dictionary<string, BinaryData>(), defenderForServersCloudRoleArn != null ? new AwsDefenderForServersInfo(defenderForServersCloudRoleArn, new Dictionary<string, BinaryData>()) : null, arcAutoProvisioning, vaAutoProvisioning, mdeAutoProvisioning, availableSubPlanType != null ? new DefenderForServersAwsOfferingSubPlan(availableSubPlanType, new Dictionary<string, BinaryData>()) : null, vmScanners);
        }
        ...
        {
            return new DefenderForDatabasesAwsOffering(OfferingType.DefenderForDatabasesAws, description, new Dictionary<string, BinaryData>(), arcAutoProvisioning, rds);
        }
        ...
        {
            return new InformationProtectionAwsOffering(OfferingType.InformationProtectionAws, description, new Dictionary<string, BinaryData>(), informationProtectionCloudRoleArn != null ? new AwsInformationProtection(informationProtectionCloudRoleArn, new Dictionary<string, BinaryData>()) : null);
        }
        ...
        {
            return new CspmMonitorGcpOffering(OfferingType.CspmMonitorGcp, description, new Dictionary<string, BinaryData>(), nativeCloudConnection);
        }
        ...
        {
            return new DefenderForServersGcpOffering(OfferingType.DefenderForServersGcp, description, new Dictionary<string, BinaryData>(), defenderForServers, isEnabled != null ? new DefenderForServersGcpOfferingArcAutoProvisioning(isEnabled, new Dictionary<string, BinaryData>()) : null, vulnerabilityAssessmentAutoProvisioning, mdeAutoProvisioning, availableSubPlanType != null ? new DefenderForServersGcpOfferingSubPlan(availableSubPlanType, new Dictionary<string, BinaryData>()) : null);
        }
        ...
        {
            return new DefenderForDatabasesGcpOffering(OfferingType.DefenderForDatabasesGcp, description, new Dictionary<string, BinaryData>(), isEnabled != null ? new DefenderForDatabasesGcpOfferingArcAutoProvisioning(isEnabled, new Dictionary<string, BinaryData>()) : null, defenderForDatabasesArcAutoProvisioning);
        }
        ...
        {
            return new DefenderForContainersGcpOffering(OfferingType.DefenderForContainersGcp, description, new Dictionary<string, BinaryData>(), nativeCloudConnection, dataPipelineNativeCloudConnection, isAuditLogsAutoProvisioningEnabled, isDefenderAgentAutoProvisioningEnabled, isPolicyAgentAutoProvisioningEnabled);
        }
        ...
        {
            return new CspmMonitorGithubOffering(OfferingType.CspmMonitorGithub, description, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new CspmMonitorAzureDevOpsOffering(OfferingType.CspmMonitorAzureDevOps, description, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DefenderCspmAwsOffering(OfferingType.DefenderCspmAws, description, new Dictionary<string, BinaryData>(), vmScanners);
        }
        ...
        {
            return new DefenderCspmGcpOffering(OfferingType.DefenderCspmGcp, description, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DefenderForDevOpsGithubOffering(OfferingType.DefenderForDevOpsGithub, description, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DefenderForDevOpsAzureDevOpsOffering(OfferingType.DefenderForDevOpsAzureDevOps, description, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AzureResourceDetails(Source.Azure, new Dictionary<string, BinaryData>(), id);
        }
    }
}
