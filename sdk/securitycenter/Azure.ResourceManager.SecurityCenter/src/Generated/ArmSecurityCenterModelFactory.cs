...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public static partial class ArmSecurityCenterModelFactory
    {
        ...
        public static SecurityAlertsSuppressionRuleData SecurityAlertsSuppressionRuleData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string alertType = null, DateTimeOffset? lastModifiedOn = null, DateTimeOffset? expireOn = null, string reason = null, SecurityAlertsSuppressionRuleState? state = null, string comment = null, IEnumerable<SuppressionAlertsScopeElement> suppressionAlertsScopeAllOf = null)
        {
            ...
            return new SecurityAlertsSuppressionRuleData(id, name, resourceType, systemData, alertType, lastModifiedOn, expireOn, reason, state, comment, suppressionAlertsScopeAllOf != null ? new SuppressionAlertsScope(suppressionAlertsScopeAllOf?.ToList(), new Dictionary<string, BinaryData>()) : null, serializedAdditionalRawData: null);
        }
        ...
        public static SecurityAssessmentData SecurityAssessmentData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, SecurityCenterResourceDetails resourceDetails = null, string displayName = null, IDictionary<string, string> additionalData = null, Uri linksAzurePortalUri = null, SecurityAssessmentMetadataProperties metadata = null, SecurityAssessmentPartner partnersData = null, SecurityAssessmentStatusResult status = null)
        {
            ...
            return new SecurityAssessmentData(id, name, resourceType, systemData, resourceDetails, displayName, additionalData, linksAzurePortalUri != null ? new AssessmentLinks(linksAzurePortalUri, new Dictionary<string, BinaryData>()) : null, metadata, partnersData, status, serializedAdditionalRawData: null);
        }
        ...
        public static SecurityAssessmentCreateOrUpdateContent SecurityAssessmentCreateOrUpdateContent(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, SecurityCenterResourceDetails resourceDetails = null, string displayName = null, IDictionary<string, string> additionalData = null, Uri linksAzurePortalUri = null, SecurityAssessmentMetadataProperties metadata = null, SecurityAssessmentPartner partnersData = null, SecurityAssessmentStatus status = null)
        {
            ...
            return new SecurityAssessmentCreateOrUpdateContent(id, name, resourceType, systemData, resourceDetails, displayName, additionalData, linksAzurePortalUri != null ? new AssessmentLinks(linksAzurePortalUri, new Dictionary<string, BinaryData>()) : null, metadata, partnersData, status, serializedAdditionalRawData: null);
        }
        ...
        public static SecureScoreControlDefinitionItem SecureScoreControlDefinitionItem(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string displayName = null, string description = null, int? maxScore = null, SecurityControlType? sourceType = null, IEnumerable<SubResource> assessmentDefinitions = null)
        {
            ...
            return new SecureScoreControlDefinitionItem(id, name, resourceType, systemData, displayName, description, maxScore, sourceType != null ? new SecureScoreControlDefinitionSource(sourceType, new Dictionary<string, BinaryData>()) : null, assessmentDefinitions?.ToList(), serializedAdditionalRawData: null);
        }
        ...
        {
            return new IngestionSettingData(id, name, resourceType, systemData, properties, serializedAdditionalRawData: null);
        }
        ...
        {
            return new IngestionSettingToken(token, serializedAdditionalRawData: null);
        }
        ...
        {
            return new IngestionConnectionString(location, value, serializedAdditionalRawData: null);
        }
        ...
        public static SqlVulnerabilityAssessmentBaselineRuleData SqlVulnerabilityAssessmentBaselineRuleData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IEnumerable<IList<string>> ruleResults = null)
        {
            ...
            return new SqlVulnerabilityAssessmentBaselineRuleData(id, name, resourceType, systemData, ruleResults != null ? new RuleResultsProperties(ruleResults?.ToList(), new Dictionary<string, BinaryData>()) : null, serializedAdditionalRawData: null);
        }
        ...
        {
            return new GcpProjectDetails(projectNumber, projectId, workloadIdentityPoolId, serializedAdditionalRawData: null);
        }
        ...
        {
            return new CspmMonitorAwsOffering(OfferingType.CspmMonitorAws, description, serializedAdditionalRawData: null, cloudRoleArn != null ? new CspmMonitorAwsOfferingNativeCloudConnection(cloudRoleArn, new Dictionary<string, BinaryData>()) : null);
        }
        ...
        {
            return new DefenderForDatabasesAwsOffering(OfferingType.DefenderForDatabasesAws, description, serializedAdditionalRawData: null, arcAutoProvisioning, rds);
        }
        ...
        {
            return new InformationProtectionAwsOffering(OfferingType.InformationProtectionAws, description, serializedAdditionalRawData: null, informationProtectionCloudRoleArn != null ? new AwsInformationProtection(informationProtectionCloudRoleArn, new Dictionary<string, BinaryData>()) : null);
        }
        ...
        {
            return new DefenderForDatabasesGcpOffering(OfferingType.DefenderForDatabasesGcp, description, serializedAdditionalRawData: null, isEnabled != null ? new DefenderForDatabasesGcpOfferingArcAutoProvisioning(isEnabled, new Dictionary<string, BinaryData>()) : null, defenderForDatabasesArcAutoProvisioning);
        }
        ...
        {
            return new DefenderCspmAwsOffering(OfferingType.DefenderCspmAws, description, serializedAdditionalRawData: null, vmScanners);
        }
        ...
        {
            return new DefenderCspmGcpOffering(OfferingType.DefenderCspmGcp, description, serializedAdditionalRawData: null);
        }
