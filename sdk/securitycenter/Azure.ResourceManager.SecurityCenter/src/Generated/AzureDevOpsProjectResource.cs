...
namespace Azure.ResourceManager.SecurityCenter
{
    ...
    public partial class AzureDevOpsProjectResource : ArmResource
    {
        ...
        {
            _azureDevOpsProjectClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.SecurityCenter", ResourceType.Namespace, Diagnostics);
        ...
        /// <summary> Gets a collection of AzureDevOpsRepositoryResources in the AzureDevOpsProject. </summary>
        /// <returns> An object representing collection of AzureDevOpsRepositoryResources and their operations over a AzureDevOpsRepositoryResource. </returns>
        ...
        public virtual async Task<Response<AzureDevOpsProjectResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _azureDevOpsProjectRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<AzureDevOpsProjectResource> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _azureDevOpsProjectRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new AzureDevOpsProjectResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        public virtual async Task<ArmOperation<AzureDevOpsProjectResource>> UpdateAsync(WaitUntil waitUntil, AzureDevOpsProjectData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _azureDevOpsProjectRestClient.UpdateAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Parent.Name, Id.Parent.Name, Id.Name, data, cancellationToken).ConfigureAwait(false);
                var operation = new SecurityCenterArmOperation<AzureDevOpsProjectResource>(new AzureDevOpsProjectOperationSource(Client), _azureDevOpsProjectClientDiagnostics, Pipeline, _azureDevOpsProjectRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Parent.Name, Id.Parent.Name, Id.Name, data).Request, response, OperationFinalStateVia.AzureAsyncOperation);
        ...
        public virtual ArmOperation<AzureDevOpsProjectResource> Update(WaitUntil waitUntil, AzureDevOpsProjectData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _azureDevOpsProjectRestClient.Update(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Parent.Name, Id.Parent.Name, Id.Name, data, cancellationToken);
                var operation = new SecurityCenterArmOperation<AzureDevOpsProjectResource>(new AzureDevOpsProjectOperationSource(Client), _azureDevOpsProjectClientDiagnostics, Pipeline, _azureDevOpsProjectRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Parent.Name, Id.Parent.Name, Id.Name, data).Request, response, OperationFinalStateVia.AzureAsyncOperation);
                if (waitUntil == WaitUntil.Completed)
