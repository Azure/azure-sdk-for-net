...
namespace Azure.ResourceManager.SecurityCenter
{
    ...
    public partial class SecurityWorkspaceSettingData : ResourceData
    {
        ...
        internal SecurityWorkspaceSettingData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, ResourceIdentifier workspaceId, string scope, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData)
        {
