...
namespace Azure.ResourceManager.SecurityCenter
{
    ...
    public partial class TopologyResourceData : ResourceData
    {
        ...
        internal TopologyResourceData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, TopologyResourceProperties properties, string location, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, name, resourceType, systemData)
        {
