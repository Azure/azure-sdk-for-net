...
{
    /// <summary> A class representing the TopologyResource data model. </summary>
    public partial class TopologyResourceData : ResourceData
    {
        /// <summary> Initializes a new instance of TopologyResourceData. </summary>
        ...
        internal TopologyResourceData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, DateTimeOffset? calculatedOn, IReadOnlyList<TopologySingleResource> topologyResources, AzureLocation? location) : base(id, name, resourceType, systemData)
        {
