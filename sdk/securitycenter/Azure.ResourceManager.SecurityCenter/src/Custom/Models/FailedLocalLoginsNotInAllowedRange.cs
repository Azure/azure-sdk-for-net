...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    /// <summary>
    /// Provides a compatibility shim for the FailedLocalLoginsNotInAllowedRange class.
    /// </summary>
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FailedLocalLoginsNotInAllowedRange"/> type for compatibility with the previous public API surface.
        /// </summary>
        ...
        FailedLocalLoginsNotInAllowedRange IPersistableModel<FailedLocalLoginsNotInAllowedRange>.Create(System.BinaryData data, ModelReaderWriterOptions options) { throw new NotSupportedException("This API is no longer supported by the service."); }
        ...
        System.BinaryData IPersistableModel<FailedLocalLoginsNotInAllowedRange>.Write(ModelReaderWriterOptions options) { throw new NotSupportedException("This API is no longer supported by the service."); }
    }
}
