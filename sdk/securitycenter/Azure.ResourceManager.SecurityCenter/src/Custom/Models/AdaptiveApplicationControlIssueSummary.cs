...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public partial class AdaptiveApplicationControlIssueSummary : IJsonModel<AdaptiveApplicationControlIssueSummary>, IPersistableModel<AdaptiveApplicationControlIssueSummary>
    {
        ...
        public AdaptiveApplicationControlIssue? Issue { get { throw new NotSupportedException("This API is no longer supported by the service."); } }
        public float? NumberOfVms { get { throw new NotSupportedException("This API is no longer supported by the service."); } }
        ...
        AdaptiveApplicationControlIssueSummary IPersistableModel<AdaptiveApplicationControlIssueSummary>.Create(BinaryData data, ModelReaderWriterOptions options) { throw new NotSupportedException("This API is no longer supported by the service."); }
        ...
        BinaryData IPersistableModel<AdaptiveApplicationControlIssueSummary>.Write(ModelReaderWriterOptions options) { throw new NotSupportedException("This API is no longer supported by the service."); }
    }
}
