...
[Obsolete("This API is no longer supported by the service.", false)]
    ...
    public partial class DefenderForDevOpsAzureDevOpsOffering : SecurityCenterCloudOffering, IJsonModel<DefenderForDevOpsAzureDevOpsOffering>, IPersistableModel<DefenderForDevOpsAzureDevOpsOffering>
    {
        ...
        DefenderForDevOpsAzureDevOpsOffering IPersistableModel<DefenderForDevOpsAzureDevOpsOffering>.Create(BinaryData data, ModelReaderWriterOptions options) { throw new NotSupportedException("This API is no longer supported by the service."); }
        ...
        BinaryData IPersistableModel<DefenderForDevOpsAzureDevOpsOffering>.Write(ModelReaderWriterOptions options) { throw new NotSupportedException("This API is no longer supported by the service."); }
    }
}
