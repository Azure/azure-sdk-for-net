...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    /// <summary>
    /// Provides a compatibility shim for the SecurityCenterVmEnforcementSupportState structure.
    /// </summary>
    ...
    public readonly partial struct SecurityCenterVmEnforcementSupportState : IEquatable<SecurityCenterVmEnforcementSupportState>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SecurityCenterVmEnforcementSupportState"/> type for compatibility with the previous public API surface.
        /// </summary>
        /// <param name="value">The value preserved for API compatibility.</param>
        public SecurityCenterVmEnforcementSupportState(string value) => _value = value ?? throw new ArgumentNullException(nameof(value));
        /// <summary>
        /// Gets the NotSupported value preserved from the previous public API surface.
        /// </summary>
        public static SecurityCenterVmEnforcementSupportState NotSupported { get; } = new SecurityCenterVmEnforcementSupportState("NotSupported");
        /// <summary>
        /// Gets the Supported value preserved from the previous public API surface.
        /// </summary>
        public static SecurityCenterVmEnforcementSupportState Supported { get; } = new SecurityCenterVmEnforcementSupportState("Supported");
        /// <summary>
        /// Gets the Unknown value preserved from the previous public API surface.
        /// </summary>
        public static SecurityCenterVmEnforcementSupportState Unknown { get; } = new SecurityCenterVmEnforcementSupportState("Unknown");
        /// <summary>
