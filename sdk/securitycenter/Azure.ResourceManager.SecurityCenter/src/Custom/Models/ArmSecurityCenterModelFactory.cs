...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public static partial class ArmSecurityCenterModelFactory
    {
        ...
        /// <summary> Initializes a new instance of <see cref="Models.RulesResultsInput"/>. </summary>
        /// <param name="isLatestScan"> Take results from latest scan. </param>
        /// <param name="results">
        /// Expected results to be inserted into the baseline.
        /// Leave this field empty if latestScan == true.
        ...
        public static RulesResultsInput RulesResultsInput(bool? isLatestScan = default, IDictionary<string, IEnumerable<IEnumerable<string>>> results = default)
        {
