...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public partial class UserRecommendation : IJsonModel<UserRecommendation>, IPersistableModel<UserRecommendation>
    {
        ...
        public string Username { get { throw new NotSupportedException("This API is no longer supported by the service."); } set { throw new NotSupportedException("This API is no longer supported by the service."); } }
        ...
        UserRecommendation IPersistableModel<UserRecommendation>.Create(BinaryData data, ModelReaderWriterOptions options) { throw new NotSupportedException("This API is no longer supported by the service."); }
        ...
        BinaryData IPersistableModel<UserRecommendation>.Write(ModelReaderWriterOptions options) { throw new NotSupportedException("This API is no longer supported by the service."); }
    }
}
