...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public readonly partial struct CustomAssessmentSeverity : IEquatable<CustomAssessmentSeverity>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomAssessmentSeverity"/> type for compatibility with the previous public API surface.
        /// </summary>
        /// <param name="value">The value preserved for API compatibility.</param>
        public CustomAssessmentSeverity(string value) => _value = value ?? throw new ArgumentNullException(nameof(value));
        /// <summary>
        /// Gets the High value preserved from the previous public API surface.
        /// </summary>
        public static CustomAssessmentSeverity High { get; } = new CustomAssessmentSeverity("High");
        /// <summary>
        /// Gets the Low value preserved from the previous public API surface.
        /// </summary>
        public static CustomAssessmentSeverity Low { get; } = new CustomAssessmentSeverity("Low");
        /// <summary>
        /// Gets the Medium value preserved from the previous public API surface.
        /// </summary>
        public static CustomAssessmentSeverity Medium { get; } = new CustomAssessmentSeverity("Medium");
        /// <summary>
