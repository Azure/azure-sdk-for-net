...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    /// <summary>
    /// Provides a compatibility shim for the SecurityTrafficDirection structure.
    /// </summary>
    ...
    public readonly partial struct SecurityTrafficDirection : IEquatable<SecurityTrafficDirection>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SecurityTrafficDirection"/> type for compatibility with the previous public API surface.
        /// </summary>
        /// <param name="value">The value preserved for API compatibility.</param>
        public SecurityTrafficDirection(string value) => _value = value ?? throw new ArgumentNullException(nameof(value));
        /// <summary>
        /// Gets the Inbound value preserved from the previous public API surface.
        /// </summary>
        public static SecurityTrafficDirection Inbound { get; } = new SecurityTrafficDirection("Inbound");
        /// <summary>
        /// Gets the Outbound value preserved from the previous public API surface.
        /// </summary>
        public static SecurityTrafficDirection Outbound { get; } = new SecurityTrafficDirection("Outbound");
        /// <summary>
