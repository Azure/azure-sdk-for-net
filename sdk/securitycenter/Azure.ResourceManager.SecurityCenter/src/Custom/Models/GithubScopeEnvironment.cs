...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public partial class GithubScopeEnvironment : SecurityConnectorEnvironment, IJsonModel<GithubScopeEnvironment>, IPersistableModel<GithubScopeEnvironment>
    {
        ...
        GithubScopeEnvironment IPersistableModel<GithubScopeEnvironment>.Create(BinaryData data, ModelReaderWriterOptions options) { throw new NotSupportedException("This API is no longer supported by the service."); }
        ...
        BinaryData IPersistableModel<GithubScopeEnvironment>.Write(ModelReaderWriterOptions options) { throw new NotSupportedException("This API is no longer supported by the service."); }
    }
}
