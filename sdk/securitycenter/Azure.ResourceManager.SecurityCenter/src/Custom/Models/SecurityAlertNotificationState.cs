...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public readonly partial struct SecurityAlertNotificationState : IEquatable<SecurityAlertNotificationState>
    {
        ...
        public SecurityAlertNotificationState(string value) => _value = value ?? throw new ArgumentNullException(nameof(value));
        /// <summary>
        /// Gets the Off value preserved from the previous public API surface.
        /// </summary>
        public static SecurityAlertNotificationState Off { get; } = new SecurityAlertNotificationState("Off");
        /// <summary>
        /// Gets the On value preserved from the previous public API surface.
        /// </summary>
        public static SecurityAlertNotificationState On { get; } = new SecurityAlertNotificationState("On");
        /// <summary>
