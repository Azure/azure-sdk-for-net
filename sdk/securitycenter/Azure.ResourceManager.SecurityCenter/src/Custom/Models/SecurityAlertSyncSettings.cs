...
[Obsolete("This API is no longer supported by the service.", false)]
    ...
    public partial class SecurityAlertSyncSettings : SecuritySettingData, IJsonModel<SecurityAlertSyncSettings>, IPersistableModel<SecurityAlertSyncSettings>
    {
        ...
        SecurityAlertSyncSettings IPersistableModel<SecurityAlertSyncSettings>.Create(BinaryData data, ModelReaderWriterOptions options) { throw new NotSupportedException("This API is no longer supported by the service."); }
        ...
        BinaryData IPersistableModel<SecurityAlertSyncSettings>.Write(ModelReaderWriterOptions options) { throw new NotSupportedException("This API is no longer supported by the service."); }
    }
}
