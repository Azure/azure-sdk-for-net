...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public partial class MqttC2DRejectedMessagesNotInAllowedRange : TimeWindowCustomAlertRule, IJsonModel<MqttC2DRejectedMessagesNotInAllowedRange>, IPersistableModel<MqttC2DRejectedMessagesNotInAllowedRange>
    {
        ...
        MqttC2DRejectedMessagesNotInAllowedRange IPersistableModel<MqttC2DRejectedMessagesNotInAllowedRange>.Create(BinaryData data, ModelReaderWriterOptions options) { throw new NotSupportedException("This API is no longer supported by the service."); }
        ...
        BinaryData IPersistableModel<MqttC2DRejectedMessagesNotInAllowedRange>.Write(ModelReaderWriterOptions options) { throw new NotSupportedException("This API is no longer supported by the service."); }
    }
}
