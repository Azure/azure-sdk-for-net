...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public partial class AmqpD2CMessagesNotInAllowedRange : TimeWindowCustomAlertRule, IJsonModel<AmqpD2CMessagesNotInAllowedRange>, IPersistableModel<AmqpD2CMessagesNotInAllowedRange>
    {
        ...
        AmqpD2CMessagesNotInAllowedRange IPersistableModel<AmqpD2CMessagesNotInAllowedRange>.Create(BinaryData data, ModelReaderWriterOptions options) { throw new NotSupportedException("This API is no longer supported by the service."); }
        ...
        BinaryData IPersistableModel<AmqpD2CMessagesNotInAllowedRange>.Write(ModelReaderWriterOptions options) { throw new NotSupportedException("This API is no longer supported by the service."); }
    }
}
