...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public partial class UnauthorizedOperationsNotInAllowedRange : TimeWindowCustomAlertRule, IJsonModel<UnauthorizedOperationsNotInAllowedRange>, IPersistableModel<UnauthorizedOperationsNotInAllowedRange>
    {
        ...
        UnauthorizedOperationsNotInAllowedRange IPersistableModel<UnauthorizedOperationsNotInAllowedRange>.Create(BinaryData data, ModelReaderWriterOptions options) { throw new NotSupportedException("This API is no longer supported by the service."); }
        ...
        BinaryData IPersistableModel<UnauthorizedOperationsNotInAllowedRange>.Write(ModelReaderWriterOptions options) { throw new NotSupportedException("This API is no longer supported by the service."); }
    }
}
