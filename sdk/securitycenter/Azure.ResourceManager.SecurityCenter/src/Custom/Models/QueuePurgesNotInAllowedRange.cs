...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public partial class QueuePurgesNotInAllowedRange : TimeWindowCustomAlertRule, IJsonModel<QueuePurgesNotInAllowedRange>, IPersistableModel<QueuePurgesNotInAllowedRange>
    {
        ...
        QueuePurgesNotInAllowedRange IPersistableModel<QueuePurgesNotInAllowedRange>.Create(BinaryData data, ModelReaderWriterOptions options) { throw new NotSupportedException("This API is no longer supported by the service."); }
        ...
        BinaryData IPersistableModel<QueuePurgesNotInAllowedRange>.Write(ModelReaderWriterOptions options) { throw new NotSupportedException("This API is no longer supported by the service."); }
    }
}
