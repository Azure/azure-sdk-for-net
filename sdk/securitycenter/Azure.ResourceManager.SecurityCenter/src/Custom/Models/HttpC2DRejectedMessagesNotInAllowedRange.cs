...
[Obsolete("This API is no longer supported by the service.", false)]
    ...
    public partial class HttpC2DRejectedMessagesNotInAllowedRange : TimeWindowCustomAlertRule, IJsonModel<HttpC2DRejectedMessagesNotInAllowedRange>, IPersistableModel<HttpC2DRejectedMessagesNotInAllowedRange>
    {
        ...
        HttpC2DRejectedMessagesNotInAllowedRange IPersistableModel<HttpC2DRejectedMessagesNotInAllowedRange>.Create(BinaryData data, ModelReaderWriterOptions options) { throw new NotSupportedException("This API is no longer supported by the service."); }
        ...
        BinaryData IPersistableModel<HttpC2DRejectedMessagesNotInAllowedRange>.Write(ModelReaderWriterOptions options) { throw new NotSupportedException("This API is no longer supported by the service."); }
    }
}
