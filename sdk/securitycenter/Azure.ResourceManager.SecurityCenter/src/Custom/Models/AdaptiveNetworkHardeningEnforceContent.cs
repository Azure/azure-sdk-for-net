...
[Obsolete("This API is no longer supported by the service.", false)]
    ...
    public partial class AdaptiveNetworkHardeningEnforceContent : IJsonModel<AdaptiveNetworkHardeningEnforceContent>, IPersistableModel<AdaptiveNetworkHardeningEnforceContent>
    {
        ...
        public IList<string> NetworkSecurityGroups { get { throw new NotSupportedException("This API is no longer supported by the service."); } }
        ...
        AdaptiveNetworkHardeningEnforceContent IPersistableModel<AdaptiveNetworkHardeningEnforceContent>.Create(BinaryData data, ModelReaderWriterOptions options) { throw new NotSupportedException("This API is no longer supported by the service."); }
        ...
        BinaryData IPersistableModel<AdaptiveNetworkHardeningEnforceContent>.Write(ModelReaderWriterOptions options) { throw new NotSupportedException("This API is no longer supported by the service."); }
    }
}
