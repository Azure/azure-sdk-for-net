...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    /// <summary>
    /// Provides a compatibility shim for the TwinUpdatesNotInAllowedRange class.
    /// </summary>
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TwinUpdatesNotInAllowedRange"/> type for compatibility with the previous public API surface.
        /// </summary>
        ...
        TwinUpdatesNotInAllowedRange IPersistableModel<TwinUpdatesNotInAllowedRange>.Create(System.BinaryData data, ModelReaderWriterOptions options) { throw new NotSupportedException("This API is no longer supported by the service."); }
        ...
        System.BinaryData IPersistableModel<TwinUpdatesNotInAllowedRange>.Write(ModelReaderWriterOptions options) { throw new NotSupportedException("This API is no longer supported by the service."); }
    }
}
