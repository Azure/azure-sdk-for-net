...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public partial class AmqpC2DMessagesNotInAllowedRange : TimeWindowCustomAlertRule, IJsonModel<AmqpC2DMessagesNotInAllowedRange>, IPersistableModel<AmqpC2DMessagesNotInAllowedRange>
    {
        ...
        AmqpC2DMessagesNotInAllowedRange IPersistableModel<AmqpC2DMessagesNotInAllowedRange>.Create(BinaryData data, ModelReaderWriterOptions options) { throw new NotSupportedException("This API is no longer supported by the service."); }
        ...
        BinaryData IPersistableModel<AmqpC2DMessagesNotInAllowedRange>.Write(ModelReaderWriterOptions options) { throw new NotSupportedException("This API is no longer supported by the service."); }
    }
}
