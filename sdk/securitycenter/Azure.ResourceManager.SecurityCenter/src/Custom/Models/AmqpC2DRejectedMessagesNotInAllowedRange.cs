...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    /// <summary>
    /// Provides a compatibility shim for the AmqpC2DRejectedMessagesNotInAllowedRange class.
    /// </summary>
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AmqpC2DRejectedMessagesNotInAllowedRange"/> type for compatibility with the previous public API surface.
        /// </summary>
        ...
        AmqpC2DRejectedMessagesNotInAllowedRange IPersistableModel<AmqpC2DRejectedMessagesNotInAllowedRange>.Create(System.BinaryData data, ModelReaderWriterOptions options) { throw new NotSupportedException("This API is no longer supported by the service."); }
        ...
        System.BinaryData IPersistableModel<AmqpC2DRejectedMessagesNotInAllowedRange>.Write(ModelReaderWriterOptions options) { throw new NotSupportedException("This API is no longer supported by the service."); }
    }
}
