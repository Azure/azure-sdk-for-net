...
namespace Azure.ResourceManager.SecurityCenter.Models
{
    ...
    public partial class ConnectionToIPNotAllowed : AllowlistCustomAlertRule, IJsonModel<ConnectionToIPNotAllowed>, IPersistableModel<ConnectionToIPNotAllowed>
    {
        ...
        ConnectionToIPNotAllowed IPersistableModel<ConnectionToIPNotAllowed>.Create(BinaryData data, ModelReaderWriterOptions options) { throw new NotSupportedException("This API is no longer supported by the service."); }
        ...
        BinaryData IPersistableModel<ConnectionToIPNotAllowed>.Write(ModelReaderWriterOptions options) { throw new NotSupportedException("This API is no longer supported by the service."); }
    }
}
