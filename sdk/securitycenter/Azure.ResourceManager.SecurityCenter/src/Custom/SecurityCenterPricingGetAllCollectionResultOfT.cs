...
{
    internal partial class SecurityCenterPricingGetAllCollectionResultOfT : Pageable<SecurityCenterPricingData>
    {
        ...
        public SecurityCenterPricingGetAllCollectionResultOfT(Pricings client, string scopeId, string filter, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _scopeId = scopeId;
            _filter = filter;
