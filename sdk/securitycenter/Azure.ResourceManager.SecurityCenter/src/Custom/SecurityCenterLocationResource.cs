...
namespace Azure.ResourceManager.SecurityCenter
{
    ...
    public partial class SecurityCenterLocationResource
    {
        ...
        private static System.Collections.Generic.IReadOnlyList<Models.SecurityTopologyResource> ToLegacyList(System.Collections.Generic.IEnumerable<SecurityTopologyData> values)
        {
            var legacyValues = new System.Collections.Generic.List<Models.SecurityTopologyResource>();
            foreach (SecurityTopologyData value in values)
            {
