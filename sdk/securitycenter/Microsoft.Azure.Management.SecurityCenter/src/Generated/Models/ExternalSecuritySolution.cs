...
namespace Microsoft.Azure.Management.Security.Models
{
    ...
    public partial class ExternalSecuritySolution
    {
        ...
        /// stored</param>
        public ExternalSecuritySolution(string id = default(string), string name = default(string), string type = default(string), SystemData systemData = default(SystemData), string location = default(string))
        {
            Id = id;
            Name = name;
            Type = type;
