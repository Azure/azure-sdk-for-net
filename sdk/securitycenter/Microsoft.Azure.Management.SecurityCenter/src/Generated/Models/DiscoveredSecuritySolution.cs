...
namespace Microsoft.Azure.Management.Security.Models
{
    ...
    public partial class DiscoveredSecuritySolution
    {
        ...
        /// stored</param>
        public DiscoveredSecuritySolution(string securityFamily, string offer, string publisher, string sku, string id = default(string), string name = default(string), string type = default(string), SystemData systemData = default(SystemData), string location = default(string))
        {
            Id = id;
            Name = name;
            Type = type;
