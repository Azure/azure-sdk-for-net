...
namespace Microsoft.Azure.Management.Security.Models
{
    ...
    public partial class SecurityAssessmentMetadataPartnerData
    {
        ...
        public SecurityAssessmentMetadataPartnerData(string partnerName = default(string), string productName = default(string), string secret = default(string))
        {
        ...
        /// <summary>
        /// Gets name of the company of the partner
        /// </summary>
