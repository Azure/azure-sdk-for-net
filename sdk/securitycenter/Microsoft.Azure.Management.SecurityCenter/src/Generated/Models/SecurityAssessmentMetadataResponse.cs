...
namespace Microsoft.Azure.Management.Security.Models
{
    ...
    public partial class SecurityAssessmentMetadataResponse : Resource
    {
        ...
        /// status</param>
        public SecurityAssessmentMetadataResponse(string displayName, string severity, string assessmentType, string id = default(string), string name = default(string), string type = default(string), string policyDefinitionId = default(string), string description = default(string), string remediationDescription = default(string), IList<string> categories = default(IList<string>), string userImpact = default(string), string implementationEffort = default(string), IList<string> threats = default(IList<string>), bool? preview = default(bool?), SecurityAssessmentMetadataPartnerData partnerData = default(SecurityAssessmentMetadataPartnerData), SecurityAssessmentMetadataPropertiesResponsePublishDates publishDates = default(SecurityAssessmentMetadataPropertiesResponsePublishDates), string plannedDeprecationDate = default(string), IList<string> tactics = default(IList<string>), IList<string> techniques = default(IList<string>))
            : base(id, name, type)
        {
        ...
        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "properties.publishDates")]
        public SecurityAssessmentMetadataPropertiesResponsePublishDates PublishDates { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "properties.plannedDeprecationDate")]
        ...
        public virtual void Validate()
        {
            ...
            {
                if (!System.Text.RegularExpressions.Regex.IsMatch(PlannedDeprecationDate, "^[0-9]{2}/[0-9]{4}$"))
                {
                    throw new ValidationException(ValidationRules.Pattern, "PlannedDeprecationDate", "^[0-9]{2}/[0-9]{4}$");
                }
            }
        }
    }
