...
namespace Microsoft.Azure.Management.Security.Models
{
    ...
    public partial class DefenderForServersAwsOfferingVmScannersConfiguration
    {
        ...
        public DefenderForServersAwsOfferingVmScannersConfiguration(string cloudRoleArn = default(string), string scanningMode = default(string), IDictionary<string, string> exclusionTags = default(IDictionary<string, string>))
        {
