...
namespace Microsoft.Azure.Management.Security
{
    ...
    /// </summary>
    internal partial class GovernanceRuleOperations : IServiceOperations<SecurityCenterClient>, IGovernanceRuleOperations
    {
        /// <summary>
        /// Initializes a new instance of the GovernanceRuleOperations class.
        /// </summary>
        /// <param name='client'>
        ...
        /// </exception>
        internal GovernanceRuleOperations(SecurityCenterClient client)
        {
            if (client == null)
            {
        ...
        /// </return>
        public async Task<AzureOperationResponse<IPage<GovernanceRule>>> ListWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "subscriptions/{subscriptionId}/providers/Microsoft.Security/governanceRules").ToString();
