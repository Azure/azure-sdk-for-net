...
namespace Microsoft.Azure.Management.Security
{
    ...
    public static partial class IotRecommendationsOperationsExtensions
    {
            ...
            /// </param>
            public static IPage<IotRecommendation> List(this IIotRecommendationsOperations operations, string resourceGroupName, string solutionName, string recommendationType = default(string), int? limit = default(int?), string skipToken = default(string))
            {
                return operations.ListAsync(resourceGroupName, solutionName, recommendationType, limit, skipToken).GetAwaiter().GetResult();
            }
            ...
            /// </param>
            public static async Task<IPage<IotRecommendation>> ListAsync(this IIotRecommendationsOperations operations, string resourceGroupName, string solutionName, string recommendationType = default(string), int? limit = default(int?), string skipToken = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.ListWithHttpMessagesAsync(resourceGroupName, solutionName, recommendationType, limit, skipToken, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
