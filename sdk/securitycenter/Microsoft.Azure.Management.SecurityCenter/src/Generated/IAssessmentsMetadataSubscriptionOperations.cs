...
namespace Microsoft.Azure.Management.Security
{
    ...
    public partial interface IAssessmentsMetadataSubscriptionOperations
    {
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationResponse<SecurityAssessmentMetadata>> CreateWithHttpMessagesAsync(string assessmentMetadataName, SecurityAssessmentMetadata assessmentMetadata, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
