...
namespace Microsoft.Azure.Management.Security
{
    ...
    public partial interface IIotAlertsOperations
    {
        ...
        /// </exception>
        Task<AzureOperationResponse<IPage<IotAlert>>> ListWithHttpMessagesAsync(string resourceGroupName, string solutionName, string minStartTimeUtc = default(string), string maxStartTimeUtc = default(string), string alertType = default(string), int? limit = default(int?), string skipToken = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Get IoT alert
        /// </summary>
        /// <param name='resourceGroupName'>
