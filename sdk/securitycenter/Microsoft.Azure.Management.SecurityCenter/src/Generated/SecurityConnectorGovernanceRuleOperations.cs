...
namespace Microsoft.Azure.Management.Security
{
    ...
    /// </summary>
    internal partial class SecurityConnectorGovernanceRuleOperations : IServiceOperations<SecurityCenterClient>, ISecurityConnectorGovernanceRuleOperations
    {
        /// <summary>
        /// Initializes a new instance of the SecurityConnectorGovernanceRuleOperations class.
        /// </summary>
        /// <param name='client'>
        ...
        /// </exception>
        internal SecurityConnectorGovernanceRuleOperations(SecurityCenterClient client)
        {
            if (client == null)
            {
        ...
        /// </return>
        public async Task<AzureOperationResponse<IPage<GovernanceRule>>> ListWithHttpMessagesAsync(string resourceGroupName, string securityConnectorName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Security/securityConnectors/{securityConnectorName}/providers/Microsoft.Security/governanceRules").ToString();
