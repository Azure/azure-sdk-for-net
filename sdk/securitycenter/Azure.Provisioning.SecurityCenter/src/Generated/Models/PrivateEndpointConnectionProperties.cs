...
namespace Azure.Provisioning.SecurityCenter
{
    ...
    internal partial class PrivateEndpointConnectionProperties : ProvisionableConstruct
    {
        ...
        private SecurityCenterPrivateLinkServiceConnectionState _privateLinkServiceConnectionState;
        private BicepValue<SecurityCenterPrivateEndpointConnectionProvisioningState> _provisioningState;
        ...
        protected override void DefineProvisionableProperties()
        {
            ...
            _privateLinkServiceConnectionState = DefineModelProperty<SecurityCenterPrivateLinkServiceConnectionState>(nameof(PrivateLinkServiceConnectionState), new string[] { "privateLinkServiceConnectionState" }, isRequired: true);
            _provisioningState = DefineProperty<SecurityCenterPrivateEndpointConnectionProvisioningState>(nameof(ProvisioningState), new string[] { "provisioningState" }, isOutput: true);
