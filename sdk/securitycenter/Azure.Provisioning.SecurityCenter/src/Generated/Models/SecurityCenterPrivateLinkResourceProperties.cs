...
namespace Azure.Provisioning.SecurityCenter
{
    ...
    internal partial class SecurityCenterPrivateLinkResourceProperties : ProvisionableConstruct
    {
        private BicepValue<string> _groupId;
        private BicepList<string> _requiredMembers;
        private BicepList<string> _requiredZoneNames;

        /// <summary> Creates a new SecurityCenterPrivateLinkResourceProperties. </summary>
        public SecurityCenterPrivateLinkResourceProperties()
        {
        }
        ...
        /// <summary> Define all the provisionable properties for SecurityCenterPrivateLinkResourceProperties. </summary>
        ...
        /// <summary> Define additional provisionable properties for SecurityCenterPrivateLinkResourceProperties that are not part of the generated code. </summary>
