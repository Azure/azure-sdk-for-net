# Azure Programmable Connectivity management client library for .NET
...
Install the Azure.ResourceManager.ProgrammableConnectivity management library for .NET with [NuGet](https://www.nuget.org/):
