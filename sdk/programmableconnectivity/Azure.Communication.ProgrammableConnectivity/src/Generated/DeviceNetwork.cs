...
namespace Azure.Communication.ProgrammableConnectivity
{
    ...
    public partial class DeviceNetwork
    {
        ...
        /// <include file="Docs/DeviceNetwork.xml" path="doc/members/member[@name='RetrieveAsync(string,RequestContent,RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/DeviceNetwork.xml" path="doc/members/member[@name='Retrieve(string,RequestContent,RequestContext)']/*" />
