...
#pragma warning disable SA1649 // File name should match first type name
    internal class ExtendedLocationArmOperation<T> : ArmOperation<T>
#pragma warning restore SA1649 // File name should match first type name
    {
        private readonly OperationInternal<T> _operation;

        /// <summary> Initializes a new instance of <see cref="ExtendedLocationArmOperation{T}" /> for mocking. </summary>
        ...
        internal ExtendedLocationArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia)
        {
            ...
            _operation = new OperationInternal<T>(clientDiagnostics, nextLinkOperation, response, "ExtendedLocationArmOperation", fallbackStrategy: new ExponentialDelayStrategy());
        }
