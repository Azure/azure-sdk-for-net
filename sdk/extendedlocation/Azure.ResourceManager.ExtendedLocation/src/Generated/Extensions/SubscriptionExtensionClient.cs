...
namespace Azure.ResourceManager.ExtendedLocation
{
    ...
    internal partial class SubscriptionExtensionClient : ArmResource
    {
        ...
        public AsyncPageable<GenericResource> GetCustomLocationsAsGenericResourcesAsync(string filter, string expand, int? top, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> A collection of resource operations that may take multiple service requests to iterate over. </returns>
        public Pageable<GenericResource> GetCustomLocationsAsGenericResources(string filter, string expand, int? top, CancellationToken cancellationToken = default)
        {
            ResourceFilterCollection filters = new(CustomLocation.ResourceType);
            filters.SubstringFilter = filter;
