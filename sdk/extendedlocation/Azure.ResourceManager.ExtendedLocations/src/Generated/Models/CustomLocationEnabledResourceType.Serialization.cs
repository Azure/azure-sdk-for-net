...
namespace Azure.ResourceManager.ExtendedLocations.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CustomLocationEnabledResourceType>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CustomLocationEnabledResourceType>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CustomLocationEnabledResourceType>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<CustomLocationEnabledResourceType>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
