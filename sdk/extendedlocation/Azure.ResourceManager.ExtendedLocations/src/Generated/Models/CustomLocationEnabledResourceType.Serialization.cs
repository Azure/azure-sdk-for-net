...
{
    public partial class CustomLocationEnabledResourceType : IUtf8JsonSerializable, IJsonModel<CustomLocationEnabledResourceType>, IPersistableModel<CustomLocationEnabledResourceType>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ClusterExtensionId))
            {
                builder.Append("  clusterExtensionId:");
                builder.AppendLine($" '{ClusterExtensionId.ToString()}'");
            }
