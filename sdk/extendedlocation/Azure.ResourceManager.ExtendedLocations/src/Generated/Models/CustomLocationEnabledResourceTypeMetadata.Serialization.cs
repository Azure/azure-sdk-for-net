...
namespace Azure.ResourceManager.ExtendedLocations.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CustomLocationEnabledResourceTypeMetadata>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CustomLocationEnabledResourceTypeMetadata>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CustomLocationEnabledResourceTypeMetadata>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CustomLocationEnabledResourceTypeMetadata>)} interface");
            }
        ...
        string IPersistableModel<CustomLocationEnabledResourceTypeMetadata>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
