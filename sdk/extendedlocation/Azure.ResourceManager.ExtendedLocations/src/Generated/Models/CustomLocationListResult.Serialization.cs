...
namespace Azure.ResourceManager.ExtendedLocations.Models
{
    ...
    {
        internal static CustomLocationListResult DeserializeCustomLocationListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
