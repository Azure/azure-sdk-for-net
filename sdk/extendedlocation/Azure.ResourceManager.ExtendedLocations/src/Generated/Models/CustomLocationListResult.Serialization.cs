...
{
    internal partial class CustomLocationListResult : IUtf8JsonSerializable, IJsonModel<CustomLocationListResult>, IPersistableModel<CustomLocationListResult>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CustomLocationListResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<CustomLocationListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CustomLocationListResult)} does not support '{format}' format.");
            }
