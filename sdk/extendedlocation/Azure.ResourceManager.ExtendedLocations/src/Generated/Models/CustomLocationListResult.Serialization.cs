...
namespace Azure.ResourceManager.ExtendedLocations.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CustomLocationListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CustomLocationListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CustomLocationListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CustomLocationListResult>)} interface");
            }
        ...
        string IPersistableModel<CustomLocationListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
