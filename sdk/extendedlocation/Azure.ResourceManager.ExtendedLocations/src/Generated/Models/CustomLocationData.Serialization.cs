...
namespace Azure.ResourceManager.ExtendedLocations
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CustomLocationData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CustomLocationData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CustomLocationData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CustomLocationData>)} interface");
            }
        ...
        string IPersistableModel<CustomLocationData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
