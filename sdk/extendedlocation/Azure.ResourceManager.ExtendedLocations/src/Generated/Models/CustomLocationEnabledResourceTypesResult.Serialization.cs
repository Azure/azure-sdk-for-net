...
namespace Azure.ResourceManager.ExtendedLocations.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CustomLocationEnabledResourceTypesResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CustomLocationEnabledResourceTypesResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CustomLocationEnabledResourceTypesResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CustomLocationEnabledResourceTypesResult>)} interface");
            }
        ...
        string IPersistableModel<CustomLocationEnabledResourceTypesResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
