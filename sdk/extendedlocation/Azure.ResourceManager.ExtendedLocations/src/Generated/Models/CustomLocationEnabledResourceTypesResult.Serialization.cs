...
{
    internal partial class CustomLocationEnabledResourceTypesResult : IUtf8JsonSerializable, IJsonModel<CustomLocationEnabledResourceTypesResult>, IPersistableModel<CustomLocationEnabledResourceTypesResult>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CustomLocationEnabledResourceTypesResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<CustomLocationEnabledResourceTypesResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CustomLocationEnabledResourceTypesResult)} does not support '{format}' format.");
            }
