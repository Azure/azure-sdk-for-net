...
namespace Azure.ResourceManager.ExtendedLocations.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CustomLocationEnabledResourceTypesResult>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        CustomLocationEnabledResourceTypesResult IJsonModel<CustomLocationEnabledResourceTypesResult>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
                throw new FormatException($"The model {nameof(CustomLocationEnabledResourceTypesResult)} does not support '{options.Format}' format.");
            }
        ...
        BinaryData IModel<CustomLocationEnabledResourceTypesResult>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        CustomLocationEnabledResourceTypesResult IModel<CustomLocationEnabledResourceTypesResult>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<CustomLocationEnabledResourceTypesResult>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
