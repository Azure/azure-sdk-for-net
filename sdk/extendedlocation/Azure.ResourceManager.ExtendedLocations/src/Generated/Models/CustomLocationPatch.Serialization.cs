...
namespace Azure.ResourceManager.ExtendedLocations.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CustomLocationPatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CustomLocationPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CustomLocationPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CustomLocationPatch>)} interface");
            }
        ...
        string IPersistableModel<CustomLocationPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
