...
using Azure.ResourceManager.ExtendedLocations.Testing;
...
namespace Azure.ResourceManager.ExtendedLocations
{
    ...
    public static partial class ExtendedLocationsExtensions
    {
        ...
        private static ExtendedLocationsSubscriptionResourceExtension GetExtendedLocationsSubscriptionResourceExtension(ArmResource resource)
        {
            return resource.GetCachedClient(client =>
            {
                return new ExtendedLocationsSubscriptionResourceExtension(client, resource.Id);
            });
        }

        private static ExtendedLocationsSubscriptionResourceExtension GetExtendedLocationsSubscriptionResourceExtension(ArmClient client, ResourceIdentifier scope)
        {
            return client.GetResourceClient(() =>
            {
                return new ExtendedLocationsSubscriptionResourceExtension(client, scope);
            });
        }
        ...
        {
            return GetExtendedLocationsSubscriptionResourceExtension(subscriptionResource).GetCustomLocationsAsync(cancellationToken);
        }
        ...
        {
            return GetExtendedLocationsSubscriptionResourceExtension(subscriptionResource).GetCustomLocations(cancellationToken);
        }
    }
}
