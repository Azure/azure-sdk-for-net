...
namespace Azure.ResourceManager.ExtendedLocations.Mocking
{
    ...
    internal partial class ExtendedLocationsResourceGroupMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="ExtendedLocationsResourceGroupMockingExtension"/> class for mocking. </summary>
        protected ExtendedLocationsResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ExtendedLocationsResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ExtendedLocationsResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
