...
namespace Azure.ResourceManager.ExtendedLocations.Mocking
{
    ...
    internal partial class ExtendedLocationsSubscriptionMockingExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="ExtendedLocationsSubscriptionMockingExtension"/> class for mocking. </summary>
        protected ExtendedLocationsSubscriptionMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ExtendedLocationsSubscriptionMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ExtendedLocationsSubscriptionMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<CustomLocationResource> GetCustomLocationsAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new CustomLocationResource(Client, CustomLocationData.DeserializeCustomLocationData(e)), CustomLocationClientDiagnostics, Pipeline, "ExtendedLocationsSubscriptionMockingExtension.GetCustomLocations", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<CustomLocationResource> GetCustomLocations(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => CustomLocationRestClient.CreateListBySubscriptionRequest(Id.SubscriptionId);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CustomLocationRestClient.CreateListBySubscriptionNextPageRequest(nextLink, Id.SubscriptionId);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new CustomLocationResource(Client, CustomLocationData.DeserializeCustomLocationData(e)), CustomLocationClientDiagnostics, Pipeline, "ExtendedLocationsSubscriptionMockingExtension.GetCustomLocations", "value", "nextLink", cancellationToken);
        }
    }
}
