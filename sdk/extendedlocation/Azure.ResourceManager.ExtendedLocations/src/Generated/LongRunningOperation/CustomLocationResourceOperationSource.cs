...
{
    /// <summary></summary>
    internal partial class CustomLocationResourceOperationSource : IOperationSource<CustomLocationResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal CustomLocationResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
