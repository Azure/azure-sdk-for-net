...
namespace Azure.ResourceManager.ExtendedLocations
{
    ...
    public partial class CustomLocationResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<CustomLocationResource>> UpdateAsync(WaitUntil waitUntil, CustomLocationData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _customLocationsRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, CustomLocationData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<CustomLocationResource> Update(WaitUntil waitUntil, CustomLocationData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
