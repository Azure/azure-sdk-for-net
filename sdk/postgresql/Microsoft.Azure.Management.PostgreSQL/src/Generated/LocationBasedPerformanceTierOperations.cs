...
namespace Microsoft.Azure.Management.PostgreSQL
{
    ...
    /// </summary>
    internal partial class LocationBasedPerformanceTierOperations : IServiceOperations<PostgreSQLManagementClient>, ILocationBasedPerformanceTierOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal LocationBasedPerformanceTierOperations(PostgreSQLManagementClient client)
        {
            if (client == null)
            {
