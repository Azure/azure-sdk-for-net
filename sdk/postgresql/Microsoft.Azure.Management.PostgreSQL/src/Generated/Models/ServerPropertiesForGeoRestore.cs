...
namespace Microsoft.Azure.Management.PostgreSQL.Models
{
    ...
    public partial class ServerPropertiesForGeoRestore : ServerPropertiesForCreate
    {
        ...
        public ServerPropertiesForGeoRestore(string sourceServerId, string version = default(string), SslEnforcementEnum? sslEnforcement = default(SslEnforcementEnum?), string minimalTlsVersion = default(string), StorageProfile storageProfile = default(StorageProfile))
