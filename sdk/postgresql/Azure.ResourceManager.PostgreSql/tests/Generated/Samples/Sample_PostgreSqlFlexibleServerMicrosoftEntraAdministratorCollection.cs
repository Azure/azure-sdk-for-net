...
{
    public partial class Sample_PostgreSqlFlexibleServerMicrosoftEntraAdministratorCollection
    {
        [Test]
        ...
        public async Task Get_GetInformationAboutAServerAdministratorAssociatedToAMicrosoftEntraPrincipal()
        {
            ...
            // invoke the operation
            string objectId = "oooooooo-oooo-oooo-oooo-oooooooooooo";
            PostgreSqlFlexibleServerMicrosoftEntraAdministratorResource result = await collection.GetAsync(objectId);
        ...
        public async Task GetAll_ListInformationAboutAllServerAdministratorsAssociatedToMicrosoftEntraPrincipals()
        {
            ...
            await foreach (PostgreSqlFlexibleServerMicrosoftEntraAdministratorResource item in collection.GetAllAsync())
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                PostgreSqlFlexibleServerMicrosoftEntraAdministratorData resourceData = item.Data;
                // for demo we just print out the id
                Console.WriteLine($"Succeeded on id: {resourceData.Id}");
            }
        ...
        public async Task GetIfExists_GetInformationAboutAServerAdministratorAssociatedToAMicrosoftEntraPrincipal()
        {
            ...
            // invoke the operation
            string objectId = "oooooooo-oooo-oooo-oooo-oooooooooooo";
            NullableResponse<PostgreSqlFlexibleServerMicrosoftEntraAdministratorResource> response = await collection.GetIfExistsAsync(objectId);
            PostgreSqlFlexibleServerMicrosoftEntraAdministratorResource result = response.HasValue ? response.Value : null;
