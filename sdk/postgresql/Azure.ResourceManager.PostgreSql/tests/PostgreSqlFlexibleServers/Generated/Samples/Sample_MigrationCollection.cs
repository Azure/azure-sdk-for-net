...
{
    public partial class Sample_MigrationCollection
    {
        [Test]
        ...
        public async Task CreateOrUpdate_CreateAMigrationForValidatingOnly()
        {
            ...
            // get the collection of this MigrationResource
            MigrationCollection collection = postgreSqlFlexibleServer.GetMigrations();

            // invoke the operation
            string migrationName = "examplemigration";
            MigrationData data = new MigrationData(new AzureLocation("eastus"))
            {
            ...
            ArmOperation<MigrationResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, migrationName, data);
        ...
        public async Task Get_GetInformationAboutAMigrationWithSuccessfulValidationAndSuccessfulMigration()
        {
            ...
            // invoke the operation
            string migrationName = "examplemigration";
            MigrationResource result = await collection.GetAsync(migrationName);
        ...
        public async Task GetAll_ListAllMigrationsOfATargetFlexibleServer()
        {
            ...
            await foreach (MigrationResource item in collection.GetAllAsync(migrationListFilter: migrationListFilter))
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                MigrationData resourceData = item.Data;
                // for demo we just print out the id
                Console.WriteLine($"Succeeded on id: {resourceData.Id}");
            }
        ...
        public async Task GetIfExists_GetInformationAboutAMigrationWithSuccessfulValidationAndSuccessfulMigration()
        {
            ...
            // invoke the operation
            string migrationName = "examplemigration";
            NullableResponse<MigrationResource> response = await collection.GetIfExistsAsync(migrationName);
            MigrationResource result = response.HasValue ? response.Value : null;
