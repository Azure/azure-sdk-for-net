...
{
    public partial class Sample_AdministratorMicrosoftEntraCollection
    {
        [Test]
        ...
        public async Task CreateOrUpdate_AddAServerAdministratorAssociatedToAMicrosoftEntraPrincipal()
        {
            ...
            // get the collection of this AdministratorMicrosoftEntraResource
            AdministratorMicrosoftEntraCollection collection = postgreSqlFlexibleServer.GetAdministratorMicrosoftEntras();
            ...
            ArmOperation<AdministratorMicrosoftEntraResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, objectId, content);
        ...
        public async Task Get_GetInformationAboutAServerAdministratorAssociatedToAMicrosoftEntraPrincipal()
        {
            ...
            // invoke the operation
            string objectId = "oooooooo-oooo-oooo-oooo-oooooooooooo";
            AdministratorMicrosoftEntraResource result = await collection.GetAsync(objectId);
        ...
        public async Task GetAll_ListInformationAboutAllServerAdministratorsAssociatedToMicrosoftEntraPrincipals()
        {
            ...
            await foreach (AdministratorMicrosoftEntraResource item in collection.GetAllAsync())
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                AdministratorMicrosoftEntraData resourceData = item.Data;
                // for demo we just print out the id
                Console.WriteLine($"Succeeded on id: {resourceData.Id}");
            }
        ...
        public async Task GetIfExists_GetInformationAboutAServerAdministratorAssociatedToAMicrosoftEntraPrincipal()
        {
            ...
            // invoke the operation
            string objectId = "oooooooo-oooo-oooo-oooo-oooooooooooo";
            NullableResponse<AdministratorMicrosoftEntraResource> response = await collection.GetIfExistsAsync(objectId);
            AdministratorMicrosoftEntraResource result = response.HasValue ? response.Value : null;
