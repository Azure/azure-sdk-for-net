...
{
    public partial class Sample_PostgreSqlLtrServerBackupOperationResourceCollection
    {
        [Test]
        ...
        public async Task Get_GetTheResultsOfALongRetentionBackupOperationForAServer()
        {
            ...
            PostgreSqlLtrServerBackupOperationResourceCollection collection = postgreSqlFlexibleServer.GetPostgreSqlLtrServerBackupOperationResources();
        ...
        public async Task GetAll_ListTheResultsOfTheLongTermRetentionBackupOperationsForAServer()
        {
            ...
            await foreach (PostgreSqlLtrServerBackupOperationResource item in collection.GetAllAsync())
            {
                ...
                // but just for demo, we get its data from this resource instance
                PostgreSqlLtrServerBackupOperationResourceData resourceData = item.Data;
                // for demo we just print out the id
                Console.WriteLine($"Succeeded on id: {resourceData.Id}");
            }
