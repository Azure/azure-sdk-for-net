...
{
    public partial class Sample_VirtualEndpointCollection
    {
        [Test]
        ...
        public async Task CreateOrUpdate_CreateAPairOfVirtualEndpointsForAServer()
        {
            ...
            VirtualEndpointCollection collection = postgreSqlFlexibleServer.GetVirtualEndpoints();

            // invoke the operation
            string virtualEndpointName = "examplebasename";
            VirtualEndpointData data = new VirtualEndpointData
            {
        ...
        public async Task GetAll_ListPairOfVirtualEndpointsAssociatedToAServer()
        {
            ...
            await foreach (VirtualEndpointResource item in collection.GetAllAsync())
            {
                ...
                // but just for demo, we get its data from this resource instance
                VirtualEndpointData resourceData = item.Data;
                // for demo we just print out the id
                Console.WriteLine($"Succeeded on id: {resourceData.Id}");
            }
