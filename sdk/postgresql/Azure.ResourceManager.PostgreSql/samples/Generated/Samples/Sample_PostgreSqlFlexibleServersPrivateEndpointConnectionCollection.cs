...
{
    public partial class Sample_PostgreSqlFlexibleServersPrivateEndpointConnectionCollection
    {
        [Test]
        ...
        public async Task Get_GetsPrivateEndpointConnection()
        {
            ...
            PostgreSqlFlexibleServersPrivateEndpointConnectionResource result = await collection.GetAsync(privateEndpointConnectionName);
        ...
        public async Task GetIfExists_GetsPrivateEndpointConnection()
        {
            ...
            // invoke the operation
            string privateEndpointConnectionName = "private-endpoint-connection-name.1fa229cd-bf3f-47f0-8c49-afb36723997e";
            NullableResponse<PostgreSqlFlexibleServersPrivateEndpointConnectionResource> response = await collection.GetIfExistsAsync(privateEndpointConnectionName);
            PostgreSqlFlexibleServersPrivateEndpointConnectionResource result = response.HasValue ? response.Value : null;
        ...
        {
            // Generated from example definition: specification/postgresql/resource-manager/Microsoft.DBforPostgreSQL/stable/2024-08-01/examples/PrivateEndpointConnectionList.json
            ...
            await foreach (PostgreSqlFlexibleServersPrivateEndpointConnectionResource item in collection.GetAllAsync())
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                PostgreSqlFlexibleServersPrivateEndpointConnectionData resourceData = item.Data;
                // for demo we just print out the id
                Console.WriteLine($"Succeeded on id: {resourceData.Id}");
            }
