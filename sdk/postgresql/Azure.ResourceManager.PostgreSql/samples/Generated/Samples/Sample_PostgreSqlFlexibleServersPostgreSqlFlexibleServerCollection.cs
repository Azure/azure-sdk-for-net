...
{
    public partial class Sample_PostgreSqlFlexibleServersPostgreSqlFlexibleServerCollection
    {
        ...
        public async Task CreateOrUpdate_CreateADatabaseAsAGeoRestoreInGeoPairedLocation()
        {
            ...
            // get the collection of this PostgreSqlFlexibleServersPostgreSqlFlexibleServerResource
            PostgreSqlFlexibleServersPostgreSqlFlexibleServerCollection collection = resourceGroupResource.GetPostgreSqlFlexibleServersPostgreSqlFlexibleServers();

            // invoke the operation
            string serverName = "pgtestsvc5geo";
            PostgreSqlFlexibleServersPostgreSqlFlexibleServerData data = new PostgreSqlFlexibleServersPostgreSqlFlexibleServerData(new AzureLocation("eastus"))
            {
...
["/subscriptions/ffffffff-ffff-ffff-ffff-ffffffffffff/resourceGroups/testresourcegroup/providers/Microsoft.ManagedIdentity/userAssignedIdentities/test-usermanagedidentity"] = new UserAssignedIdentity(),
            ...
            ArmOperation<PostgreSqlFlexibleServersPostgreSqlFlexibleServerResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, serverName, data);
        ...
        public async Task CreateOrUpdate_CreateADatabaseAsAPointInTimeRestore()
        {
            ...
            PostgreSqlFlexibleServersPostgreSqlFlexibleServerData data = new PostgreSqlFlexibleServersPostgreSqlFlexibleServerData(new AzureLocation("westus"))
            {
                SourceServerResourceId = new ResourceIdentifier("/subscriptions/ffffffff-ffff-ffff-ffff-ffffffffffff/resourceGroups/testrg/providers/Microsoft.DBforPostgreSQL/flexibleServers/sourcepgservername"),
                PointInTimeUtc = DateTimeOffset.Parse("2021-06-27T00:04:59.4078005+00:00"),
        ...
        public async Task CreateOrUpdate_CreateANewServer()
        {
            ...
            PostgreSqlFlexibleServersPostgreSqlFlexibleServerData data = new PostgreSqlFlexibleServersPostgreSqlFlexibleServerData(new AzureLocation("westus"))
            {
                Sku = new PostgreSqlFlexibleServersPostgreSqlFlexibleServerSku("Standard_D4s_v3", PostgreSqlFlexibleServerSkuTier.GeneralPurpose),
...
["ElasticServer"] = "1",
        ...
        public async Task Get_ServerGet()
        {
            ...
            PostgreSqlFlexibleServersPostgreSqlFlexibleServerResource result = await collection.GetAsync(serverName);
        ...
        public async Task GetIfExists_ServerGet()
        {
            ...
            // invoke the operation
            string serverName = "pgtestsvc1";
            NullableResponse<PostgreSqlFlexibleServersPostgreSqlFlexibleServerResource> response = await collection.GetIfExistsAsync(serverName);
            PostgreSqlFlexibleServersPostgreSqlFlexibleServerResource result = response.HasValue ? response.Value : null;
        ...
        public async Task GetAll_ServerListByResourceGroup()
        {
            ...
            await foreach (PostgreSqlFlexibleServersPostgreSqlFlexibleServerResource item in collection.GetAllAsync())
            {
        ...
        public async Task GetReplicas_ReplicasListByServer()
        {
            ...
            await foreach (PostgreSqlFlexibleServersPostgreSqlFlexibleServerResource item in collection.GetReplicasAsync(serverName))
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                PostgreSqlFlexibleServersPostgreSqlFlexibleServerData resourceData = item.Data;
