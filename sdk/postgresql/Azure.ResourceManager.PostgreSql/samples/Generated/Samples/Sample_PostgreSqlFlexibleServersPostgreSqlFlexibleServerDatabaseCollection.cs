...
{
    public partial class Sample_PostgreSqlFlexibleServersPostgreSqlFlexibleServerDatabaseCollection
    {
        // Create a database
        ...
        public async Task CreateOrUpdate_CreateADatabase()
        {
            ...
            // get the collection of this PostgreSqlFlexibleServersPostgreSqlFlexibleServerDatabaseResource
            PostgreSqlFlexibleServersPostgreSqlFlexibleServerDatabaseCollection collection = postgreSqlFlexibleServersPostgreSqlFlexibleServer.GetPostgreSqlFlexibleServersPostgreSqlFlexibleServerDatabases();

            // invoke the operation
            string databaseName = "db1";
            PostgreSqlFlexibleServersPostgreSqlFlexibleServerDatabaseData data = new PostgreSqlFlexibleServersPostgreSqlFlexibleServerDatabaseData()
            {
                Charset = "utf8",
                Collation = "en_US.utf8",
            };
            ArmOperation<PostgreSqlFlexibleServersPostgreSqlFlexibleServerDatabaseResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, databaseName, data);
            PostgreSqlFlexibleServersPostgreSqlFlexibleServerDatabaseResource result = lro.Value;

            // the variable result is a resource, you could call other operations on this instance as well
            // but just for demo, we get its data from this resource instance
            PostgreSqlFlexibleServersPostgreSqlFlexibleServerDatabaseData resourceData = result.Data;
        ...
        public async Task Get_GetADatabase()
        {
            ...
            // invoke the operation
            string databaseName = "db1";
            PostgreSqlFlexibleServersPostgreSqlFlexibleServerDatabaseResource result = await collection.GetAsync(databaseName);
        ...
        public async Task GetIfExists_GetADatabase()
        {
            ...
            // invoke the operation
            string databaseName = "db1";
            NullableResponse<PostgreSqlFlexibleServersPostgreSqlFlexibleServerDatabaseResource> response = await collection.GetIfExistsAsync(databaseName);
            PostgreSqlFlexibleServersPostgreSqlFlexibleServerDatabaseResource result = response.HasValue ? response.Value : null;
        ...
        public async Task GetAll_ListDatabasesInAServer()
        {
            ...
            await foreach (PostgreSqlFlexibleServersPostgreSqlFlexibleServerDatabaseResource item in collection.GetAllAsync())
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                PostgreSqlFlexibleServersPostgreSqlFlexibleServerDatabaseData resourceData = item.Data;
                // for demo we just print out the id
                Console.WriteLine($"Succeeded on id: {resourceData.Id}");
            }
