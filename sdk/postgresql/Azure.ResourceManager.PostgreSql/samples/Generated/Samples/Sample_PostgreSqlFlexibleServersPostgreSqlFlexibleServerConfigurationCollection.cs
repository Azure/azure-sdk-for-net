...
{
    public partial class Sample_PostgreSqlFlexibleServersPostgreSqlFlexibleServerConfigurationCollection
    {
        // ConfigurationList
        ...
        public async Task GetAll_ConfigurationList()
        {
            ...
            // get the collection of this PostgreSqlFlexibleServersPostgreSqlFlexibleServerConfigurationResource
            PostgreSqlFlexibleServersPostgreSqlFlexibleServerConfigurationCollection collection = postgreSqlFlexibleServersPostgreSqlFlexibleServer.GetPostgreSqlFlexibleServersPostgreSqlFlexibleServerConfigurations();

            // invoke the operation and iterate over the result
            await foreach (PostgreSqlFlexibleServersPostgreSqlFlexibleServerConfigurationResource item in collection.GetAllAsync())
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                PostgreSqlFlexibleServersPostgreSqlFlexibleServerConfigurationData resourceData = item.Data;
        ...
        public async Task Get_ConfigurationGet()
        {
            ...
            PostgreSqlFlexibleServersPostgreSqlFlexibleServerConfigurationResource result = await collection.GetAsync(configurationName);
        ...
        public async Task GetIfExists_ConfigurationGet()
        {
            ...
            // invoke the operation
            string configurationName = "array_nulls";
            NullableResponse<PostgreSqlFlexibleServersPostgreSqlFlexibleServerConfigurationResource> response = await collection.GetIfExistsAsync(configurationName);
            PostgreSqlFlexibleServersPostgreSqlFlexibleServerConfigurationResource result = response.HasValue ? response.Value : null;
        ...
        public async Task CreateOrUpdate_UpdateAUserConfiguration()
        {
            ...
            ArmOperation<PostgreSqlFlexibleServersPostgreSqlFlexibleServerConfigurationResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, configurationName, data);
