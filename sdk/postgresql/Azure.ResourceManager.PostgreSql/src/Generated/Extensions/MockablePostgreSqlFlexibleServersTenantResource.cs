...
namespace Azure.ResourceManager.PostgreSql.FlexibleServers.Mocking
{
    ...
    public partial class MockablePostgreSqlFlexibleServersTenantResource : ArmResource
    {
        ...
        private PrivateDnsZoneSuffix PrivateDnsZoneSuffixRestClient => _privateDnsZoneSuffixRestClient ??= new PrivateDnsZoneSuffix(PrivateDnsZoneSuffixClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, "2026-04-01-preview");
    }
}
