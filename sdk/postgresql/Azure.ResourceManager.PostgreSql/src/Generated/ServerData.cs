...
namespace Azure.ResourceManager.PostgreSql
{
    ...
    public partial class ServerData : TrackedResourceData
    {
        ...
        internal ServerData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, PostgreSqlSku sku, string administratorLogin, string administratorLoginPassword, ServerVersion? version, string minorVersion, ServerState? state, string fullyQualifiedDomainName, Storage storage, Backup backup, Network network, HighAvailability highAvailability, MaintenanceWindow maintenanceWindow, string sourceServerResourceId, DateTimeOffset? pointInTimeUTC, string availabilityZone, CreateMode? createMode) : base(id, name, resourceType, systemData, tags, location)
        {
            Sku = sku;
