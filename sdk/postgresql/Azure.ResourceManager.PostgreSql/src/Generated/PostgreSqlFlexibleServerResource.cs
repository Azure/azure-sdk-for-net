    ...
    public partial class PostgreSqlFlexibleServerResource : ArmResource
    {
        ...
        public virtual AsyncPageable<PostgreSqlFlexibleServerCapabilityProperties> GetServerCapabilitiesAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new CapabilitiesByServerGetServerCapabilitiesAsyncCollectionResultOfT(
                ...
                Id.Name,
                context,
                "PostgreSqlFlexibleServerResource.GetServerCapabilities");
        }
        ...
        public virtual AsyncPageable<PostgreSqlFlexibleServerLogFile> GetPostgreSqlFlexibleServerLogFilesAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new CapturedLogsGetPostgreSqlFlexibleServerLogFilesAsyncCollectionResultOfT(
                ...
                Id.Name,
                context,
                "PostgreSqlFlexibleServerResource.GetPostgreSqlFlexibleServerLogFiles");
        }
        ...
        public virtual AsyncPageable<PostgreSqlFlexibleServerResource> GetReplicasAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<PostgreSqlFlexibleServerData, PostgreSqlFlexibleServerResource>(new ReplicasGetReplicasAsyncCollectionResultOfT(
                ...
                Id.Name,
                context,
                "PostgreSqlFlexibleServerResource.GetReplicas"), data => new PostgreSqlFlexibleServerResource(Client, data));
        }
        ...
        /// <summary>
        /// Updates the PostgreSqlFlexibleServer.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforPostgreSQL/flexibleServers/{serverName}. </description>
        ...
        public virtual async Task<ArmOperation<PostgreSqlFlexibleServerResource>> UpdateAsync(WaitUntil waitUntil, PostgreSqlFlexibleServerData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _serversRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, PostgreSqlFlexibleServerData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                FlexibleServersArmOperation<PostgreSqlFlexibleServerResource> operation = new FlexibleServersArmOperation<PostgreSqlFlexibleServerResource>(
                    new PostgreSqlFlexibleServerResourceOperationSource(Client),
                    _serversClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<PostgreSqlFlexibleServerResource> Update(WaitUntil waitUntil, PostgreSqlFlexibleServerData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
