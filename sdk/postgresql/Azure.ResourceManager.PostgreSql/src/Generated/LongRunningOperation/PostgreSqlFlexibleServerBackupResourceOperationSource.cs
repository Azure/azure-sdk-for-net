...
{
    /// <summary></summary>
    internal partial class PostgreSqlFlexibleServerBackupResourceOperationSource : IOperationSource<PostgreSqlFlexibleServerBackupResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal PostgreSqlFlexibleServerBackupResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
