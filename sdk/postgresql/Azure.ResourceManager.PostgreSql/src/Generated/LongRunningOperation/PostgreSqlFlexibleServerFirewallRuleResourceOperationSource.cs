...
{
    /// <summary></summary>
    internal partial class PostgreSqlFlexibleServerFirewallRuleResourceOperationSource : IOperationSource<PostgreSqlFlexibleServerFirewallRuleResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal PostgreSqlFlexibleServerFirewallRuleResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
