...
{
    /// <summary></summary>
    internal partial class PostgreSqlFlexibleServerResourceOperationSource : IOperationSource<PostgreSqlFlexibleServerResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal PostgreSqlFlexibleServerResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
