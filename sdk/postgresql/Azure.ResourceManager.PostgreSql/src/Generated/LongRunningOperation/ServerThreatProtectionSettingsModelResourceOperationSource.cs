...
{
    /// <summary></summary>
    internal partial class ServerThreatProtectionSettingsModelResourceOperationSource : IOperationSource<ServerThreatProtectionSettingsModelResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal ServerThreatProtectionSettingsModelResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
