...
{
    /// <summary></summary>
    internal partial class PostgreSqlFlexibleServerConfigurationResourceOperationSource : IOperationSource<PostgreSqlFlexibleServerConfigurationResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal PostgreSqlFlexibleServerConfigurationResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
