...
{
    /// <summary></summary>
    internal partial class PostgreSqlFlexibleServerDatabaseResourceOperationSource : IOperationSource<PostgreSqlFlexibleServerDatabaseResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal PostgreSqlFlexibleServerDatabaseResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
        ...
        PostgreSqlFlexibleServerDatabaseResource IOperationSource<PostgreSqlFlexibleServerDatabaseResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            PostgreSqlFlexibleServerDatabaseData data = PostgreSqlFlexibleServerDatabaseData.DeserializePostgreSqlFlexibleServerDatabaseData(document.RootElement, ModelSerializationExtensions.WireOptions);
