...
namespace Azure.ResourceManager.PostgreSql
{
    ...
    public partial class ConfigurationCollection : ArmCollection, IEnumerable<ConfigurationResource>, IAsyncEnumerable<ConfigurationResource>
    {
        ...
        public virtual async Task<ArmOperation<ConfigurationResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string configurationName, ConfigurationData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _configurationRestClient.PutAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, configurationName, data, cancellationToken).ConfigureAwait(false);
                var operation = new PostgreSqlArmOperation<ConfigurationResource>(new ConfigurationOperationSource(Client), _configurationClientDiagnostics, Pipeline, _configurationRestClient.CreatePutRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, configurationName, data).Request, response, OperationFinalStateVia.Location);
        ...
        public virtual ArmOperation<ConfigurationResource> CreateOrUpdate(WaitUntil waitUntil, string configurationName, ConfigurationData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _configurationRestClient.Put(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, configurationName, data, cancellationToken);
                var operation = new PostgreSqlArmOperation<ConfigurationResource>(new ConfigurationOperationSource(Client), _configurationClientDiagnostics, Pipeline, _configurationRestClient.CreatePutRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, configurationName, data).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
