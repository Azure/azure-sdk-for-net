...
namespace Azure.ResourceManager.PostgreSql.FlexibleServers.Models
{
    ...
    public static partial class ArmPostgreSqlFlexibleServersModelFactory
    {
        ...
        /// <summary> Initializes a new instance of <see cref="Models.ConfigurationForUpdate"/>. </summary>
        /// <param name="value"> Value of the configuration (also known as server parameter). Required to update the value assigned to a specific modifiable configuration. </param>
        /// <param name="description"> Description of the configuration (also known as server parameter). </param>
        /// <param name="defaultValue"> Value assigned by default to the configuration (also known as server parameter). </param>
        /// <param name="dataType"> Data type of the configuration (also known as server parameter). </param>
        ...
        /// <param name="unit"> Units in which the configuration (also known as server parameter) value is expressed. </param>
        /// <param name="documentationLink"> Link pointing to the documentation of the configuration (also known as server parameter). </param>
        /// <returns> A new <see cref="Models.ConfigurationForUpdate"/> instance for mocking. </returns>
        public static ConfigurationForUpdate ConfigurationForUpdate(string value = null, string description = null, string defaultValue = null, PostgreSqlFlexibleServerConfigurationDataType? dataType = null, string allowedValues = null, string source = null, bool? isDynamicConfig = null, bool? isReadOnly = null, bool? isConfigPendingRestart = null, string unit = null, string documentationLink = null)
        {
            return new ConfigurationForUpdate(
                value,
                description,
                defaultValue,
                dataType,
        ...
        public static PostgreSqlFlexibleServerHighAvailability PostgreSqlFlexibleServerHighAvailability(HighAvailabilityMode? mode = null, PostgreSqlFlexibleServerHAState? state = null, string standbyAvailabilityZone = null)
        {
        ...
        public static HighAvailabilityForPatch HighAvailabilityForPatch(HighAvailabilityMode? mode = null, PostgreSqlFlexibleServerHAState? state = null, string standbyAvailabilityZone = null)
        {
