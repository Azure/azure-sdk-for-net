...
namespace Azure.ResourceManager.PostgreSql.FlexibleServers
{
    ...
    public partial class VirtualEndpointResource : ArmResource
    {
        ...
        /// <summary>
        /// Updates the VirtualEndpointResource.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforPostgreSQL/flexibleServers/{serverName}/virtualendpoints/{virtualEndpointName}. </description>
        ...
        public virtual async Task<ArmOperation<VirtualEndpointResource>> UpdateAsync(WaitUntil waitUntil, VirtualEndpointResourceData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _virtualEndpointsRestClient.CreateCreateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, VirtualEndpointResourceData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                FlexibleServersArmOperation<VirtualEndpointResource> operation = new FlexibleServersArmOperation<VirtualEndpointResource>(
                    new VirtualEndpointResourceOperationSource(Client),
                    _virtualEndpointsClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<VirtualEndpointResource> Update(WaitUntil waitUntil, VirtualEndpointResourceData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
