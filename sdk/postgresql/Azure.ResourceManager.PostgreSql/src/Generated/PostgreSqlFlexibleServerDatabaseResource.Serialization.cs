...
namespace Azure.ResourceManager.PostgreSql.FlexibleServers
{
    ...
    {
        private static IJsonModel<PostgreSqlFlexibleServerDatabaseData> s_dataDeserializationInstance;

        private static IJsonModel<PostgreSqlFlexibleServerDatabaseData> DataDeserializationInstance => s_dataDeserializationInstance ??= new PostgreSqlFlexibleServerDatabaseData();
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        PostgreSqlFlexibleServerDatabaseData IJsonModel<PostgreSqlFlexibleServerDatabaseData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => DataDeserializationInstance.Create(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<PostgreSqlFlexibleServerDatabaseData>.GetFormatFromOptions(ModelReaderWriterOptions options) => DataDeserializationInstance.GetFormatFromOptions(options);
    }
}
