...
namespace Azure.ResourceManager.PostgreSql.FlexibleServers
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="PostgreSqlLtrServerBackupOperationResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="PostgreSqlFlexibleServerResource"/> using the GetPostgreSqlLtrServerBackupOperations method.
    /// </summary>
    public partial class PostgreSqlLtrServerBackupOperationResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of PostgreSqlLtrServerBackupOperationResource for mocking. </summary>
        protected PostgreSqlLtrServerBackupOperationResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="PostgreSqlLtrServerBackupOperationResource"/> class. </summary>
        ...
        {
            TryGetApiVersion(ResourceType, out string postgreSqlLtrServerBackupOperationApiVersion);
        ...
        {
            string resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforPostgreSQL/flexibleServers/{serverName}/ltrBackupOperations/{backupName}";
        ...
        {
            using DiagnosticScope scope = _backupsLongTermRetentionClientDiagnostics.CreateScope("PostgreSqlLtrServerBackupOperationResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _backupsLongTermRetentionRestClient.CreateGetRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, context);
