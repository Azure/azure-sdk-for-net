...
namespace Azure.ResourceManager.PostgreSql.FlexibleServers.Models
{
    ...
    internal partial class PostgreSqlFlexibleServerBackupStoreDetails : IJsonModel<PostgreSqlFlexibleServerBackupStoreDetails>
    {
        ...
        protected virtual PostgreSqlFlexibleServerBackupStoreDetails PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<PostgreSqlFlexibleServerBackupStoreDetails>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<PostgreSqlFlexibleServerBackupStoreDetails>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        PostgreSqlFlexibleServerBackupStoreDetails IPersistableModel<PostgreSqlFlexibleServerBackupStoreDetails>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        PostgreSqlFlexibleServerBackupStoreDetails IJsonModel<PostgreSqlFlexibleServerBackupStoreDetails>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual PostgreSqlFlexibleServerBackupStoreDetails JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<PostgreSqlFlexibleServerBackupStoreDetails>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static PostgreSqlFlexibleServerBackupStoreDetails DeserializePostgreSqlFlexibleServerBackupStoreDetails(JsonElement element, ModelReaderWriterOptions options)
        {
