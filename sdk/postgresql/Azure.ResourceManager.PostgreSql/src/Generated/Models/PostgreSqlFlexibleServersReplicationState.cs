...
namespace Azure.ResourceManager.PostgreSql.FlexibleServers.Models
{
    ...
    public readonly partial struct PostgreSqlFlexibleServersReplicationState : IEquatable<PostgreSqlFlexibleServersReplicationState>
    {
        ...
        /// <summary> Read replica is fully synchronized and actively replicating data from the primary server. </summary>
        ...
        /// <summary> Read replica is behind the primary server and is currently catching up with pending changes. </summary>
        ...
        /// <summary> Read replica is being created and is in process of getting initialized. </summary>
        ...
        /// <summary> Read replica is undergoing some changes it can be changing compute size of promoting it to primary server. </summary>
        ...
        /// <summary> Read replica is being reconfigured, possibly due to changes in source or settings. </summary>
