...
namespace Azure.ResourceManager.PostgreSql.FlexibleServers.Models
{
    ...
    public partial class PostgreSqlFlexibleServerStorage : IJsonModel<PostgreSqlFlexibleServerStorage>
    {
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual PostgreSqlFlexibleServerStorage PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<PostgreSqlFlexibleServerStorage>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<PostgreSqlFlexibleServerStorage>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        PostgreSqlFlexibleServerStorage IPersistableModel<PostgreSqlFlexibleServerStorage>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        PostgreSqlFlexibleServerStorage IJsonModel<PostgreSqlFlexibleServerStorage>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual PostgreSqlFlexibleServerStorage JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<PostgreSqlFlexibleServerStorage>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static PostgreSqlFlexibleServerStorage DeserializePostgreSqlFlexibleServerStorage(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            PostgreSqlFlexibleServersStorageType? storageType = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("tier"u8))
                {
                    ...
                    tier = new PostgreSqlManagedDiskPerformanceTier(prop.Value.GetString());
                    continue;
                }
                ...
                if (prop.NameEquals("type"u8))
                {
                    ...
                    storageType = new PostgreSqlFlexibleServersStorageType(prop.Value.GetString());
                    continue;
                }
                if (options.Format != "W")
                {
