...
namespace Azure.ResourceManager.PostgreSql
{
    ...
    public partial class PostgreSqlDatabaseData : ResourceData
    {
        ...
        internal PostgreSqlDatabaseData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string charset, string collation, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
            Charset = charset;
            Collation = collation;
