...
using Azure.ResourceManager.PostgreSql.Testing;
...
namespace Azure.ResourceManager.PostgreSql
{
    ...
    public static partial class PostgreSqlExtensions
    {
        ...
        {
            return GetPostgreSqlSubscriptionResourceExtension(subscriptionResource).GetPostgreSqlServersAsync(cancellationToken);
        }
        ...
        {
            return GetPostgreSqlSubscriptionResourceExtension(subscriptionResource).GetPostgreSqlServers(cancellationToken);
        }
