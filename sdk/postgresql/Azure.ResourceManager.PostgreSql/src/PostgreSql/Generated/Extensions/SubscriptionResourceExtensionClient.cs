...
namespace Azure.ResourceManager.PostgreSql
{
    ...
    internal partial class SubscriptionResourceExtensionClient : ArmResource
    {
        ...
        public virtual AsyncPageable<PostgreSqlServerResource> GetPostgreSqlServersAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, null, e => { var data = PostgreSqlServerData.DeserializePostgreSqlServerData(e); return new PostgreSqlServerResource(Client, data, data.Id); }, PostgreSqlServerServersClientDiagnostics, Pipeline, "SubscriptionResourceExtensionClient.GetPostgreSqlServers", "value", null, cancellationToken);
        }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => PostgreSqlServerServersRestClient.CreateListRequest(Id.SubscriptionId);
            return PageableHelpers.CreatePageable(FirstPageRequest, null, e => { var data = PostgreSqlServerData.DeserializePostgreSqlServerData(e); return new PostgreSqlServerResource(Client, data, data.Id); }, PostgreSqlServerServersClientDiagnostics, Pipeline, "SubscriptionResourceExtensionClient.GetPostgreSqlServers", "value", null, cancellationToken);
        }
