...
namespace Azure.ResourceManager.PostgreSql.Mocking
{
    ...
    internal partial class PostgreSqlResourceGroupMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="PostgreSqlResourceGroupMockingExtension"/> class for mocking. </summary>
        protected PostgreSqlResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="PostgreSqlResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal PostgreSqlResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
