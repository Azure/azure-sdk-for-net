...
namespace Azure.ResourceManager.PostgreSql.Testing
{
    /// <summary> A class to add extension methods to SubscriptionResource. </summary>
    public partial class PostgreSqlSubscriptionResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="PostgreSqlSubscriptionResourceExtension"/> class for mocking. </summary>
        protected PostgreSqlSubscriptionResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="PostgreSqlSubscriptionResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal PostgreSqlSubscriptionResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<PostgreSqlServerResource> GetPostgreSqlServersAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, null, e => new PostgreSqlServerResource(Client, PostgreSqlServerData.DeserializePostgreSqlServerData(e)), PostgreSqlServerServersClientDiagnostics, Pipeline, "PostgreSqlSubscriptionResourceExtension.GetPostgreSqlServers", "value", null, cancellationToken);
        }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => PostgreSqlServerServersRestClient.CreateListRequest(Id.SubscriptionId);
            return PageableHelpers.CreatePageable(FirstPageRequest, null, e => new PostgreSqlServerResource(Client, PostgreSqlServerData.DeserializePostgreSqlServerData(e)), PostgreSqlServerServersClientDiagnostics, Pipeline, "PostgreSqlSubscriptionResourceExtension.GetPostgreSqlServers", "value", null, cancellationToken);
        }
        ...
        public virtual AsyncPageable<PostgreSqlPerformanceTierProperties> GetLocationBasedPerformanceTiersAsync(AzureLocation locationName, CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, null, PostgreSqlPerformanceTierProperties.DeserializePostgreSqlPerformanceTierProperties, LocationBasedPerformanceTierClientDiagnostics, Pipeline, "PostgreSqlSubscriptionResourceExtension.GetLocationBasedPerformanceTiers", "value", null, cancellationToken);
        }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => LocationBasedPerformanceTierRestClient.CreateListRequest(Id.SubscriptionId, locationName);
            return PageableHelpers.CreatePageable(FirstPageRequest, null, PostgreSqlPerformanceTierProperties.DeserializePostgreSqlPerformanceTierProperties, LocationBasedPerformanceTierClientDiagnostics, Pipeline, "PostgreSqlSubscriptionResourceExtension.GetLocationBasedPerformanceTiers", "value", null, cancellationToken);
        }
        ...
        public virtual async Task<Response<PostgreSqlNameAvailabilityResult>> CheckPostgreSqlNameAvailabilityAsync(PostgreSqlNameAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = CheckNameAvailabilityClientDiagnostics.CreateScope("PostgreSqlSubscriptionResourceExtension.CheckPostgreSqlNameAvailability");
            scope.Start();
            try
            {
