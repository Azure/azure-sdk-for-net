...
namespace Azure.ResourceManager.PostgreSql.Mocking
{
    ...
    internal partial class PostgreSqlArmClientMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="PostgreSqlArmClientMockingExtension"/> class for mocking. </summary>
        protected PostgreSqlArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="PostgreSqlArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal PostgreSqlArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal PostgreSqlArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
