...
namespace Azure.ResourceManager.PostgreSql.Models
{
    ...
    public static partial class ArmPostgreSqlModelFactory
    {
        ...
        public static PostgreSqlServerCreateOrUpdateContent PostgreSqlServerCreateOrUpdateContent(ManagedServiceIdentity identity = null, PostgreSqlSku sku = null, PostgreSqlServerPropertiesForCreate properties = null, AzureLocation location = default, IDictionary<string, string> tags = null)
        {
            ...
            return new PostgreSqlServerCreateOrUpdateContent(identity, sku, properties, location, tags, default);
        }
        ...
        public static PostgreSqlServerData PostgreSqlServerData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, ManagedServiceIdentity identity = null, PostgreSqlSku sku = null, string administratorLogin = null, PostgreSqlServerVersion? version = null, PostgreSqlSslEnforcementEnum? sslEnforcement = null, PostgreSqlMinimalTlsVersionEnum? minimalTlsVersion = null, string byokEnforcement = null, PostgreSqlInfrastructureEncryption? infrastructureEncryption = null, PostgreSqlServerState? userVisibleState = null, string fullyQualifiedDomainName = null, DateTimeOffset? earliestRestoreOn = null, PostgreSqlStorageProfile storageProfile = null, string replicationRole = null, ResourceIdentifier masterServerId = null, int? replicaCapacity = null, PostgreSqlPublicNetworkAccessEnum? publicNetworkAccess = null, IEnumerable<PostgreSqlServerPrivateEndpointConnection> privateEndpointConnections = null)
        {
            ...
            return new PostgreSqlServerData(id, name, resourceType, systemData, tags, location, identity, sku, administratorLogin, version, sslEnforcement, minimalTlsVersion, byokEnforcement, infrastructureEncryption, userVisibleState, fullyQualifiedDomainName, earliestRestoreOn, storageProfile, replicationRole, masterServerId, replicaCapacity, publicNetworkAccess, privateEndpointConnections?.ToList(), default);
        }
        ...
        {
            return new PostgreSqlServerPrivateEndpointConnection(id, properties, default);
        }
        ...
        {
            return new PostgreSqlServerPrivateEndpointConnectionProperties(privateEndpointId != null ? ResourceManagerModelFactory.WritableSubResource(privateEndpointId) : null, privateLinkServiceConnectionState, provisioningState, default);
        }
        ...
        {
            return new PostgreSqlServerPrivateLinkServiceConnectionStateProperty(status, description, actionsRequired, default);
        }
        ...
        {
            return new PostgreSqlFirewallRuleData(id, name, resourceType, systemData, startIPAddress, endIPAddress, default);
        }
        ...
        {
            return new PostgreSqlVirtualNetworkRuleData(id, name, resourceType, systemData, virtualNetworkSubnetId, ignoreMissingVnetServiceEndpoint, state, default);
        }
        ...
        {
            return new PostgreSqlDatabaseData(id, name, resourceType, systemData, charset, collation, default);
        }
        ...
        {
            return new PostgreSqlConfigurationData(id, name, resourceType, systemData, value, description, defaultValue, dataType, allowedValues, source, default);
        }
        ...
        {
            return new PostgreSqlLogFile(id, name, resourceType, systemData, sizeInKB, createdOn, lastModifiedOn, logFileType, uri, default);
        }
        ...
        {
            return new PostgreSqlServerAdministratorData(id, name, resourceType, systemData, administratorType, loginAccountName, secureId, tenantId, default);
        }
        ...
        {
            return new PostgreSqlRecoverableServerResourceData(id, name, resourceType, systemData, lastAvailableBackupOn, serviceLevelObjective, edition, vCores, hardwareGeneration, version, default);
        }
        ...
        public static PostgreSqlPerformanceTierProperties PostgreSqlPerformanceTierProperties(string id = null, int? maxBackupRetentionDays = null, int? minBackupRetentionDays = null, int? maxStorageInMB = null, int? minLargeStorageInMB = null, int? maxLargeStorageInMB = null, int? minStorageInMB = null, IEnumerable<PostgreSqlPerformanceTierServiceLevelObjectives> serviceLevelObjectives = null)
        {
            ...
            return new PostgreSqlPerformanceTierProperties(id, maxBackupRetentionDays, minBackupRetentionDays, maxStorageInMB, minLargeStorageInMB, maxLargeStorageInMB, minStorageInMB, serviceLevelObjectives?.ToList(), default);
        }
        ...
        {
            return new PostgreSqlPerformanceTierServiceLevelObjectives(id, edition, vCores, hardwareGeneration, maxBackupRetentionDays, minBackupRetentionDays, maxStorageInMB, minStorageInMB, default);
        }
        ...
        {
            return new PostgreSqlNameAvailabilityContent(name, resourceType, default);
        }
        ...
        {
            return new PostgreSqlNameAvailabilityResult(message, isNameAvailable, reason, default);
        }
        ...
        public static PostgreSqlServerSecurityAlertPolicyData PostgreSqlServerSecurityAlertPolicyData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, PostgreSqlServerSecurityAlertPolicyState? state = null, IEnumerable<string> disabledAlerts = null, IEnumerable<string> emailAddresses = null, bool? sendToEmailAccountAdmins = null, string storageEndpoint = null, string storageAccountAccessKey = null, int? retentionDays = null)
        {
            ...
            return new PostgreSqlServerSecurityAlertPolicyData(id, name, resourceType, systemData, state, disabledAlerts?.ToList(), emailAddresses?.ToList(), sendToEmailAccountAdmins, storageEndpoint, storageAccountAccessKey, retentionDays, default);
        }
        ...
        {
            return new PostgreSqlPrivateEndpointConnectionData(id, name, resourceType, systemData, privateEndpointId != null ? ResourceManagerModelFactory.WritableSubResource(privateEndpointId) : null, connectionState, provisioningState, default);
        }
        ...
        {
            return new PostgreSqlPrivateLinkServiceConnectionStateProperty(status, description, actionsRequired, default);
        }
        ...
        {
            return new PostgreSqlPrivateLinkResourceData(id, name, resourceType, systemData, properties, default);
        }
        ...
        public static PostgreSqlPrivateLinkResourceProperties PostgreSqlPrivateLinkResourceProperties(string groupId = null, IEnumerable<string> requiredMembers = null)
        {
            ...
            return new PostgreSqlPrivateLinkResourceProperties(groupId, requiredMembers?.ToList(), default);
        }
        ...
        {
            return new PostgreSqlServerKeyData(id, name, resourceType, systemData, kind, serverKeyType, uri, createdOn, default);
        }
        ...
        {
            return new PostgreSqlServerPropertiesForDefaultCreate(version, sslEnforcement, minimalTlsVersion, infrastructureEncryption, publicNetworkAccess, storageProfile, PostgreSqlCreateMode.Default, administratorLogin, administratorLoginPassword, default);
        }
        ...
        {
            return new PostgreSqlServerPropertiesForRestore(version, sslEnforcement, minimalTlsVersion, infrastructureEncryption, publicNetworkAccess, storageProfile, PostgreSqlCreateMode.PointInTimeRestore, sourceServerId, restorePointInTime, default);
        }
        ...
        {
            return new PostgreSqlServerPropertiesForGeoRestore(version, sslEnforcement, minimalTlsVersion, infrastructureEncryption, publicNetworkAccess, storageProfile, PostgreSqlCreateMode.GeoRestore, sourceServerId, default);
        }
        ...
        {
            return new PostgreSqlServerPropertiesForReplica(version, sslEnforcement, minimalTlsVersion, infrastructureEncryption, publicNetworkAccess, storageProfile, PostgreSqlCreateMode.Replica, sourceServerId, default);
        }
    }
}
