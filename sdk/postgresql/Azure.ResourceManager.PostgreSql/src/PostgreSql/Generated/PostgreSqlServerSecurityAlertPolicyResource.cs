...
namespace Azure.ResourceManager.PostgreSql
{
    ...
    public partial class PostgreSqlServerSecurityAlertPolicyResource : ArmResource
    {
        ...
        internal PostgreSqlServerSecurityAlertPolicyResource(ArmClient client, PostgreSqlServerSecurityAlertPolicyData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
