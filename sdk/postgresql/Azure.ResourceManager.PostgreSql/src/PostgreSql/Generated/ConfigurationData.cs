...
namespace Azure.ResourceManager.PostgreSql
{
    ...
    public partial class ConfigurationData : ResourceData
    {
        ...
        internal ConfigurationData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string value, string description, string defaultValue, string dataType, string allowedValues, string source) : base(id, name, resourceType, systemData)
        {
            Value = value;
