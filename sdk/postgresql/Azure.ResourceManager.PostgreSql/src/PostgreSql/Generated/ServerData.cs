...
namespace Azure.ResourceManager.PostgreSql
{
    ...
    public partial class ServerData : TrackedResourceData
    {
        ...
        internal ServerData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, ManagedServiceIdentity identity, PostgreSqlSku sku, string administratorLogin, ServerVersion? version, SslEnforcementEnum? sslEnforcement, MinimalTlsVersionEnum? minimalTlsVersion, string byokEnforcement, InfrastructureEncryption? infrastructureEncryption, ServerState? userVisibleState, string fullyQualifiedDomainName, DateTimeOffset? earliestRestoreOn, StorageProfile storageProfile, string replicationRole, string masterServerId, int? replicaCapacity, PublicNetworkAccessEnum? publicNetworkAccess, IReadOnlyList<ServerPrivateEndpointConnection> privateEndpointConnections) : base(id, name, resourceType, systemData, tags, location)
        {
            Identity = identity;
            Sku = sku;
        ...
        public ServerState? UserVisibleState { get; set; }
