...
namespace Azure.ResourceManager.PostgreSql
{
    ...
    public partial class PostgreSqlPrivateEndpointConnectionResource : ArmResource
    {
        ...
        internal PostgreSqlPrivateEndpointConnectionResource(ArmClient client, PostgreSqlPrivateEndpointConnectionData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
