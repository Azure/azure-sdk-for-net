    ...
    public partial class PostgreSqlServerResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new PostgreSqlArmOperation(_postgreSqlServerServersClientDiagnostics, Pipeline, _postgreSqlServerServersRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name).Request, response, OperationFinalStateVia.NotSpecified);
        ...
        public virtual async Task<ArmOperation> RestartAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new PostgreSqlArmOperation(_postgreSqlServerServersClientDiagnostics, Pipeline, _postgreSqlServerServersRestClient.CreateRestartRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name).Request, response, OperationFinalStateVia.NotSpecified);
                if (waitUntil == WaitUntil.Completed)
                    await operation.WaitForCompletionResponseAsync(cancellationToken).ConfigureAwait(false);
                return operation;
            }
        ...
        {
            async Task<Page<PostgreSqlLogFile>> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _logFilesClientDiagnostics.CreateScope("PostgreSqlServerResource.GetLogFiles");
                scope.Start();
                try
                {
        ...
        {
            Page<PostgreSqlLogFile> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _logFilesClientDiagnostics.CreateScope("PostgreSqlServerResource.GetLogFiles");
                scope.Start();
                try
        ...
        public virtual AsyncPageable<PostgreSqlPerformanceTierProperties> GetServerBasedPerformanceTiersAsync(CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _serverBasedPerformanceTierClientDiagnostics.CreateScope("PostgreSqlServerResource.GetServerBasedPerformanceTiers");
                scope.Start();
                try
                {
