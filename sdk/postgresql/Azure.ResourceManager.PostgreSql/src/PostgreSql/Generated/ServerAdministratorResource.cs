...
namespace Azure.ResourceManager.PostgreSql
{
    ...
    public partial class ServerAdministratorResource : ArmResource
    {
        ...
        {
            _serverAdministratorResourceServerAdministratorsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.PostgreSql", ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new PostgreSqlArmOperation(_serverAdministratorResourceServerAdministratorsClientDiagnostics, Pipeline, _serverAdministratorResourceServerAdministratorsRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name).Request, response, OperationFinalStateVia.Location);
