...
namespace Azure.ResourceManager.PostgreSql
{
    ...
    public partial class ServerKeyCollection : ArmCollection, IEnumerable<ServerKeyResource>, IAsyncEnumerable<ServerKeyResource>
    {
        ...
        {
            _serverKeyClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.PostgreSql", ServerKeyResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<ServerKeyResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string keyName, ServerKeyData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new PostgreSqlArmOperation<ServerKeyResource>(new ServerKeyOperationSource(Client), _serverKeyClientDiagnostics, Pipeline, _serverKeyRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, keyName, data).Request, response, OperationFinalStateVia.Location);
