...
namespace Azure.ResourceManager.PostgreSql.Models
{
    internal partial class PostgreSqlPrivateLinkResourceListResult
    {
        internal static PostgreSqlPrivateLinkResourceListResult DeserializePostgreSqlPrivateLinkResourceListResult(JsonElement element)
        {
            ...
            Core.Optional<IReadOnlyList<PostgreSqlPrivateLinkResourceData>> value = default;
            ...
            return new PostgreSqlPrivateLinkResourceListResult(Core.Optional.ToList(value), nextLink.Value);
        }
    }
}
