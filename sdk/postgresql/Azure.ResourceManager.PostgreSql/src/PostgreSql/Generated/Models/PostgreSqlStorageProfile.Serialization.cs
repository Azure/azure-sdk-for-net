...
{
    public partial class PostgreSqlStorageProfile : Core.IUtf8JsonSerializable
    {
        ...
        internal static PostgreSqlStorageProfile DeserializePostgreSqlStorageProfile(JsonElement element)
        {
            ...
            Core.Optional<PostgreSqlGeoRedundantBackup> geoRedundantBackup = default;
            Core.Optional<int> storageMB = default;
            Core.Optional<PostgreSqlStorageAutogrow> storageAutogrow = default;
            ...
            return new PostgreSqlStorageProfile(Core.Optional.ToNullable(backupRetentionDays), Core.Optional.ToNullable(geoRedundantBackup), Core.Optional.ToNullable(storageMB), Core.Optional.ToNullable(storageAutogrow));
        }
    }
}
