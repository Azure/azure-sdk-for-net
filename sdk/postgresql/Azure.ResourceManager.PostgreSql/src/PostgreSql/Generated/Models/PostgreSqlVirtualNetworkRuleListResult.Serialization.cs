...
namespace Azure.ResourceManager.PostgreSql.Models
{
    internal partial class PostgreSqlVirtualNetworkRuleListResult : IUtf8JsonSerializable, IJsonModel<PostgreSqlVirtualNetworkRuleListResult>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(PostgreSqlVirtualNetworkRuleListResult)} does not support writing '{format}' format.");
            }
            ...
            if (options.Format != "W" && Optional.IsCollectionDefined(Value))
            {
                ...
                {
                    ((IJsonModel<PostgreSqlVirtualNetworkRuleData>)item).Write(writer, options);
                }
        ...
        PostgreSqlVirtualNetworkRuleListResult IJsonModel<PostgreSqlVirtualNetworkRuleListResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(PostgreSqlVirtualNetworkRuleListResult)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<PostgreSqlVirtualNetworkRuleListResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(PostgreSqlVirtualNetworkRuleListResult)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        PostgreSqlVirtualNetworkRuleListResult IPersistableModel<PostgreSqlVirtualNetworkRuleListResult>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(PostgreSqlVirtualNetworkRuleListResult)} does not support reading '{options.Format}' format.");
            }
        }
