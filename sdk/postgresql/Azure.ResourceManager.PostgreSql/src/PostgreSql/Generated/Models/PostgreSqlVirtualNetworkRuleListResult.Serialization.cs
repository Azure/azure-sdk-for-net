...
namespace Azure.ResourceManager.PostgreSql.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PostgreSqlVirtualNetworkRuleListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PostgreSqlVirtualNetworkRuleListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PostgreSqlVirtualNetworkRuleListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PostgreSqlVirtualNetworkRuleListResult>)} interface");
            }
        ...
        string IPersistableModel<PostgreSqlVirtualNetworkRuleListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
