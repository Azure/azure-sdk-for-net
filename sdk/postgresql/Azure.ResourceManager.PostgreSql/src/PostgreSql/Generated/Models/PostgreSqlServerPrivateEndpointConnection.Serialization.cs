...
namespace Azure.ResourceManager.PostgreSql.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PostgreSqlServerPrivateEndpointConnection>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PostgreSqlServerPrivateEndpointConnection>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PostgreSqlServerPrivateEndpointConnection>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PostgreSqlServerPrivateEndpointConnection>)} interface");
            }
        ...
        string IPersistableModel<PostgreSqlServerPrivateEndpointConnection>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
