...
namespace Azure.ResourceManager.PostgreSql.Models
{
    ...
    public partial class PostgreSqlPrivateLinkServiceConnectionStateProperty
    {
        ...
        internal PostgreSqlPrivateLinkServiceConnectionStateProperty(string status, string description, string actionsRequired, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Status = status;
            Description = description;
