...
namespace Azure.ResourceManager.PostgreSql.Models
{
    ...
    public partial class PostgreSqlPerformanceTierServiceLevelObjectives
    {
        ...
        internal PostgreSqlPerformanceTierServiceLevelObjectives(string id, string edition, int? vCore, string hardwareGeneration, int? maxBackupRetentionDays, int? minBackupRetentionDays, int? maxStorageInMB, int? minStorageInMB)
        {
            Id = id;
            Edition = edition;
            VCore = vCore;
