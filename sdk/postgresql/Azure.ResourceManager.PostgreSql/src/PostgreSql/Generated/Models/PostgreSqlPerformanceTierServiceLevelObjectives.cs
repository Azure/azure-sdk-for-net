...
namespace Azure.ResourceManager.PostgreSql.Models
{
    ...
    public partial class PostgreSqlPerformanceTierServiceLevelObjectives
    {
        ...
        internal PostgreSqlPerformanceTierServiceLevelObjectives(string id, string edition, int? vCores, string hardwareGeneration, int? maxBackupRetentionDays, int? minBackupRetentionDays, int? maxStorageInMB, int? minStorageInMB, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Edition = edition;
            VCores = vCores;
