...
namespace Azure.ResourceManager.PostgreSql
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PostgreSqlConfigurationData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PostgreSqlConfigurationData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PostgreSqlConfigurationData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PostgreSqlConfigurationData>)} interface");
            }
        ...
        string IPersistableModel<PostgreSqlConfigurationData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
