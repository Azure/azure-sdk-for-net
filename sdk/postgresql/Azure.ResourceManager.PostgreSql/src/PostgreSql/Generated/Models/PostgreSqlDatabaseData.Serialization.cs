...
{
    public partial class PostgreSqlDatabaseData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static PostgreSqlDatabaseData DeserializePostgreSqlDatabaseData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
