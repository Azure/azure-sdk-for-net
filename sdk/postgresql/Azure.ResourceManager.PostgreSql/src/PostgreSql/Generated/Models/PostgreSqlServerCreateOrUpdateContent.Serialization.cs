    ...
    public partial class PostgreSqlServerCreateOrUpdateContent : IUtf8JsonSerializable, IJsonModel<PostgreSqlServerCreateOrUpdateContent>
    {
        ...
        internal static PostgreSqlServerCreateOrUpdateContent DeserializePostgreSqlServerCreateOrUpdateContent(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
				...
				global::System.ClientModel.Primitives.ModelReaderWriter.Read<global::Azure.ResourceManager.Models.ManagedServiceIdentity>(new global::System.BinaryData(global::System.Runtime.InteropServices.JsonMarshal.GetRawUtf8Value(property.Value).ToArray()), options, AzureResourceManagerPostgreSqlContext.Default)
#else
                ModelReaderWriter.Read<ManagedServiceIdentity>(new BinaryData(Encoding.UTF8.GetBytes(property.Value.GetRawText())), options, AzureResourceManagerPostgreSqlContext.Default)
#endif
;
                    continue;
                }
