...
namespace Azure.ResourceManager.PostgreSql.Models
{
    public partial class ServerPrivateEndpointConnectionProperties
    {
        internal static ServerPrivateEndpointConnectionProperties DeserializeServerPrivateEndpointConnectionProperties(JsonElement element)
        {
            ...
            Optional<ServerPrivateLinkServiceConnectionStateProperty> privateLinkServiceConnectionState = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("privateLinkServiceConnectionState"))
                {
                    ...
                    privateLinkServiceConnectionState = ServerPrivateLinkServiceConnectionStateProperty.DeserializeServerPrivateLinkServiceConnectionStateProperty(property.Value);
                    continue;
                }
