...
namespace Azure.ResourceManager.PostgreSql.Models
{
    ...
    public partial class PostgreSqlSku
    {
        ...
        internal PostgreSqlSku(string name, PostgreSqlSkuTier? tier, int? capacity, string size, string family, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Tier = tier;
            Capacity = capacity;
