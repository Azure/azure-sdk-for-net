...
namespace Azure.ResourceManager.PostgreSql.Models
{
    ...
    public partial class PostgreSqlServerCreateOrUpdateContent
    {
        ...
        internal PostgreSqlServerCreateOrUpdateContent(ManagedServiceIdentity identity, PostgreSqlSku sku, PostgreSqlServerPropertiesForCreate properties, AzureLocation location, IDictionary<string, string> tags, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Identity = identity;
            Sku = sku;
            Properties = properties;
