...
namespace Azure.ResourceManager.PostgreSql.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PostgreSqlServerPatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PostgreSqlServerPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PostgreSqlServerPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PostgreSqlServerPatch>)} interface");
            }
        ...
        string IPersistableModel<PostgreSqlServerPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
