...
namespace Azure.ResourceManager.PostgreSql.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PostgreSqlPerformanceTierServiceLevelObjectives>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<PostgreSqlPerformanceTierServiceLevelObjectives>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PostgreSqlPerformanceTierServiceLevelObjectives>)} interface");
            }
        ...
        string IPersistableModel<PostgreSqlPerformanceTierServiceLevelObjectives>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
