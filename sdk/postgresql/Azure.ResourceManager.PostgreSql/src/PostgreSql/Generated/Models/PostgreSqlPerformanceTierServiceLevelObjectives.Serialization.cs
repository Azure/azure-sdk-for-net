...
{
    public partial class PostgreSqlPerformanceTierServiceLevelObjectives : IUtf8JsonSerializable, IJsonModel<PostgreSqlPerformanceTierServiceLevelObjectives>, IPersistableModel<PostgreSqlPerformanceTierServiceLevelObjectives>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(MaxStorageInMB))
            {
                ...
                builder.AppendLine($" '{MaxStorageInMB.Value.ToString()}'");
            }

            if (Optional.IsDefined(MinStorageInMB))
            {
                builder.Append("  minStorageMB:");
                builder.AppendLine($" '{MinStorageInMB.Value.ToString()}'");
            }
