...
namespace Azure.ResourceManager.PostgreSql.Models
{
    ...
    {
        internal static PostgreSqlServerListResult DeserializePostgreSqlServerListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
