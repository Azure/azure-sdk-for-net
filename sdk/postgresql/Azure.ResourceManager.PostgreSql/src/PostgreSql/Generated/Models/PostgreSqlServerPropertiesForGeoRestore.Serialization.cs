...
namespace Azure.ResourceManager.PostgreSql.Models
{
    public partial class PostgreSqlServerPropertiesForGeoRestore : IUtf8JsonSerializable, IModelJsonSerializable<PostgreSqlServerPropertiesForGeoRestore>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<PostgreSqlServerPropertiesForGeoRestore>(this, options.Format);
        ...
        internal static PostgreSqlServerPropertiesForGeoRestore DeserializePostgreSqlServerPropertiesForGeoRestore(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new PostgreSqlServerPropertiesForGeoRestore(Optional.ToNullable(version), Optional.ToNullable(sslEnforcement), Optional.ToNullable(minimalTlsVersion), Optional.ToNullable(infrastructureEncryption), Optional.ToNullable(publicNetworkAccess), storageProfile.Value, createMode, sourceServerId, serializedAdditionalRawData);
        }
        ...
        /// <summary> Converts a <see cref="PostgreSqlServerPropertiesForGeoRestore"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="PostgreSqlServerPropertiesForGeoRestore"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="PostgreSqlServerPropertiesForGeoRestore"/>. </summary>
