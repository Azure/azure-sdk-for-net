...
{
    public partial class PostgreSqlPerformanceTierProperties : IUtf8JsonSerializable, IJsonModel<PostgreSqlPerformanceTierProperties>, IPersistableModel<PostgreSqlPerformanceTierProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(MinLargeStorageInMB))
            {
                ...
                builder.AppendLine($" '{MinLargeStorageInMB.Value.ToString()}'");
            }

            if (Optional.IsDefined(MaxLargeStorageInMB))
            {
                builder.Append("  maxLargeStorageMB:");
                builder.AppendLine($" '{MaxLargeStorageInMB.Value.ToString()}'");
            }
