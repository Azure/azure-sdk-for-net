...
namespace Azure.ResourceManager.PostgreSql.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PostgreSqlPerformanceTierProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PostgreSqlPerformanceTierProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PostgreSqlPerformanceTierProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PostgreSqlPerformanceTierProperties>)} interface");
            }
        ...
        string IPersistableModel<PostgreSqlPerformanceTierProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
