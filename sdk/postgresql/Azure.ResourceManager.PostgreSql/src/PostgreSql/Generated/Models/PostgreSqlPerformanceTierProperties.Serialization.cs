...
namespace Azure.ResourceManager.PostgreSql.Models
{
    ...
    {
        internal static PostgreSqlPerformanceTierProperties DeserializePostgreSqlPerformanceTierProperties(JsonElement element, SerializableOptions options = default)
        {
