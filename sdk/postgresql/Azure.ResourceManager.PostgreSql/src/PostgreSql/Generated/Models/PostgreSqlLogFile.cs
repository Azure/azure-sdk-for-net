...
namespace Azure.ResourceManager.PostgreSql.Models
{
    ...
    public partial class PostgreSqlLogFile : ResourceData
    {
        ...
        internal PostgreSqlLogFile(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, long? sizeInKB, DateTimeOffset? createdOn, DateTimeOffset? lastModifiedOn, string logFileType, Uri uri, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData)
        {
            SizeInKB = sizeInKB;
            CreatedOn = createdOn;
