...
namespace Azure.ResourceManager.PostgreSql.Models
{
    internal partial class PostgreSqlDatabaseListResult : IUtf8JsonSerializable, IModelJsonSerializable<PostgreSqlDatabaseListResult>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<PostgreSqlDatabaseListResult>(this, options.Format);
            ...
            if (Optional.IsCollectionDefined(Value))
            {
                ...
                foreach (var item in Value)
                {
                    ...
                    {
                        ((IModelJsonSerializable<PostgreSqlDatabaseData>)item).Serialize(writer, options);
                    }
                }
        ...
        /// <summary> Converts a <see cref="PostgreSqlDatabaseListResult"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="PostgreSqlDatabaseListResult"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="PostgreSqlDatabaseListResult"/>. </summary>
