...
namespace Azure.ResourceManager.PostgreSql
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PostgreSqlServerAdministratorData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PostgreSqlServerAdministratorData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PostgreSqlServerAdministratorData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PostgreSqlServerAdministratorData>)} interface");
            }
        ...
        string IPersistableModel<PostgreSqlServerAdministratorData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
