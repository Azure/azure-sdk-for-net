    ...
    public partial class PostgreSqlServerPrivateEndpointConnectionProperties : IUtf8JsonSerializable, IJsonModel<PostgreSqlServerPrivateEndpointConnectionProperties>
    {
        ...
        internal static PostgreSqlServerPrivateEndpointConnectionProperties DeserializePostgreSqlServerPrivateEndpointConnectionProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
				...
				global::System.ClientModel.Primitives.ModelReaderWriter.Read<global::Azure.ResourceManager.Resources.Models.WritableSubResource>(new global::System.BinaryData(global::System.Runtime.InteropServices.JsonMarshal.GetRawUtf8Value(property.Value).ToArray()), options, AzureResourceManagerPostgreSqlContext.Default)
#else
                ModelReaderWriter.Read<WritableSubResource>(new BinaryData(Encoding.UTF8.GetBytes(property.Value.GetRawText())), options, AzureResourceManagerPostgreSqlContext.Default)
#endif
;
                    continue;
                }
