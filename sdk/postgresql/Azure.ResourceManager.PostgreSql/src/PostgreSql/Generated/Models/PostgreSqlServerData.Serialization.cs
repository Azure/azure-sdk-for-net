...
{
    public partial class PostgreSqlServerData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static PostgreSqlServerData DeserializePostgreSqlServerData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
