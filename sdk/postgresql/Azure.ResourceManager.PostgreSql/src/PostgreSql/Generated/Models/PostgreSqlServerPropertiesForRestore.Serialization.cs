...
namespace Azure.ResourceManager.PostgreSql.Models
{
    public partial class PostgreSqlServerPropertiesForRestore : IUtf8JsonSerializable, IModelJsonSerializable<PostgreSqlServerPropertiesForRestore>
    {
        ...
        internal static PostgreSqlServerPropertiesForRestore DeserializePostgreSqlServerPropertiesForRestore(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new PostgreSqlServerPropertiesForRestore(Optional.ToNullable(version), Optional.ToNullable(sslEnforcement), Optional.ToNullable(minimalTlsVersion), Optional.ToNullable(infrastructureEncryption), Optional.ToNullable(publicNetworkAccess), storageProfile.Value, createMode, sourceServerId, restorePointInTime, serializedAdditionalRawData);
        }
