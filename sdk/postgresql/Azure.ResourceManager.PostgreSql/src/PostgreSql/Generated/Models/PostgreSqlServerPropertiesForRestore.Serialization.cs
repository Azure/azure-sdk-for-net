...
namespace Azure.ResourceManager.PostgreSql.Models
{
    public partial class PostgreSqlServerPropertiesForRestore : IUtf8JsonSerializable, IJsonModel<PostgreSqlServerPropertiesForRestore>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(SourceServerId), out propertyOverride);
            ...
            {
                if (Optional.IsDefined(SourceServerId))
                {
                    builder.Append("  sourceServerId: ");
                    builder.AppendLine($"'{SourceServerId.ToString()}'");
                }
            }
            ...
            {
                builder.Append("  restorePointInTime: ");
                var formattedDateTimeString = TypeFormatters.ToString(RestorePointInTime, "o");
