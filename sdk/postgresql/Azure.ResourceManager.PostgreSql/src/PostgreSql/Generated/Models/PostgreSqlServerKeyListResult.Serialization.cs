...
namespace Azure.ResourceManager.PostgreSql.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PostgreSqlServerKeyListResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(PostgreSqlServerKeyListResult)} does not support writing '{format}' format.");
            }
            ...
            if (options.Format != "W" && Optional.IsCollectionDefined(Value))
            {
                ...
                {
                    ((IJsonModel<PostgreSqlServerKeyData>)item).Write(writer, options);
                }
        ...
        PostgreSqlServerKeyListResult IJsonModel<PostgreSqlServerKeyListResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(PostgreSqlServerKeyListResult)} does not support reading '{format}' format.");
            }
        ...
        internal static PostgreSqlServerKeyListResult DeserializePostgreSqlServerKeyListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new PostgreSqlServerKeyListResult(value ?? new ChangeTrackingList<PostgreSqlServerKeyData>(), nextLink, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<PostgreSqlServerKeyListResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(PostgreSqlServerKeyListResult)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        PostgreSqlServerKeyListResult IPersistableModel<PostgreSqlServerKeyListResult>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(PostgreSqlServerKeyListResult)} does not support reading '{options.Format}' format.");
            }
        }
