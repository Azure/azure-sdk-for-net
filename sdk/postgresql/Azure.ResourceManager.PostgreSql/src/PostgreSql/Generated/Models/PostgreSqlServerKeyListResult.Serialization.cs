...
namespace Azure.ResourceManager.PostgreSql.Models
{
    ...
    {
        internal static PostgreSqlServerKeyListResult DeserializePostgreSqlServerKeyListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
