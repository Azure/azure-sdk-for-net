...
namespace Azure.ResourceManager.PostgreSql.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PostgreSqlLogFile>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PostgreSqlLogFile>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PostgreSqlLogFile>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PostgreSqlLogFile>)} interface");
            }
        ...
        string IPersistableModel<PostgreSqlLogFile>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
