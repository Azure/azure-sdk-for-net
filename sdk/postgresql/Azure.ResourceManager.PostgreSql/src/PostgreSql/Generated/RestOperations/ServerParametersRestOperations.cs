...
namespace Azure.ResourceManager.PostgreSql
{
    internal partial class ServerParametersRestOperations
    {
        ...
        internal HttpMessage CreateListUpdateConfigurationsRequest(string subscriptionId, string resourceGroupName, string serverName, PostgreSqlConfigurationListContent content)
        {
        ...
        public async Task<Response> ListUpdateConfigurationsAsync(string subscriptionId, string resourceGroupName, string serverName, PostgreSqlConfigurationListContent content, CancellationToken cancellationToken = default)
        {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="subscriptionId"/>, <paramref name="resourceGroupName"/>, <paramref name="serverName"/> or <paramref name="content"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="subscriptionId"/>, <paramref name="resourceGroupName"/> or <paramref name="serverName"/> is an empty string, and was expected to be non-empty. </exception>
        public Response ListUpdateConfigurations(string subscriptionId, string resourceGroupName, string serverName, PostgreSqlConfigurationListContent content, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(subscriptionId, nameof(subscriptionId));
            Argument.AssertNotNullOrEmpty(resourceGroupName, nameof(resourceGroupName));
            Argument.AssertNotNullOrEmpty(serverName, nameof(serverName));
