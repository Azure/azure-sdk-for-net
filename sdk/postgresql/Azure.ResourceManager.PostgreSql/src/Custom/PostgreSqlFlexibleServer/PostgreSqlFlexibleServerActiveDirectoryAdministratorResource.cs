...
namespace Azure.ResourceManager.PostgreSql.FlexibleServers
{
    ...
    public partial class PostgreSqlFlexibleServerActiveDirectoryAdministratorResource : ArmResource
    {
        ...
        private readonly AdministratorsMicrosoftEntra _postgreSqlFlexibleServerActiveDirectoryAdministratorAdministratorsRestClient;
        ...
        internal PostgreSqlFlexibleServerActiveDirectoryAdministratorResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _postgreSqlFlexibleServerActiveDirectoryAdministratorAdministratorsRestClient = new AdministratorsMicrosoftEntra(_postgreSqlFlexibleServerActiveDirectoryAdministratorAdministratorsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, postgreSqlFlexibleServerActiveDirectoryAdministratorAdministratorsApiVersion);
#if DEBUG
