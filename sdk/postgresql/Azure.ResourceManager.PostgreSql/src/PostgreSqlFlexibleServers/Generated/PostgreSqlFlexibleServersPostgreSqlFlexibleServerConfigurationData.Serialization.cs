...
{
    public partial class PostgreSqlFlexibleServersPostgreSqlFlexibleServerConfigurationData : IUtf8JsonSerializable, IJsonModel<PostgreSqlFlexibleServersPostgreSqlFlexibleServerConfigurationData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PostgreSqlFlexibleServersPostgreSqlFlexibleServerConfigurationData>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<PostgreSqlFlexibleServersPostgreSqlFlexibleServerConfigurationData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<PostgreSqlFlexibleServersPostgreSqlFlexibleServerConfigurationData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(PostgreSqlFlexibleServersPostgreSqlFlexibleServerConfigurationData)} does not support writing '{format}' format.");
            }
        ...
        PostgreSqlFlexibleServersPostgreSqlFlexibleServerConfigurationData IJsonModel<PostgreSqlFlexibleServersPostgreSqlFlexibleServerConfigurationData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<PostgreSqlFlexibleServersPostgreSqlFlexibleServerConfigurationData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(PostgreSqlFlexibleServersPostgreSqlFlexibleServerConfigurationData)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializePostgreSqlFlexibleServersPostgreSqlFlexibleServerConfigurationData(document.RootElement, options);
        }

        internal static PostgreSqlFlexibleServersPostgreSqlFlexibleServerConfigurationData DeserializePostgreSqlFlexibleServersPostgreSqlFlexibleServerConfigurationData(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<PostgreSqlFlexibleServersPostgreSqlFlexibleServerConfigurationData>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<PostgreSqlFlexibleServersPostgreSqlFlexibleServerConfigurationData>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(PostgreSqlFlexibleServersPostgreSqlFlexibleServerConfigurationData)} does not support writing '{options.Format}' format.");
            }
        }

        PostgreSqlFlexibleServersPostgreSqlFlexibleServerConfigurationData IPersistableModel<PostgreSqlFlexibleServersPostgreSqlFlexibleServerConfigurationData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<PostgreSqlFlexibleServersPostgreSqlFlexibleServerConfigurationData>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(PostgreSqlFlexibleServersPostgreSqlFlexibleServerConfigurationData)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<PostgreSqlFlexibleServersPostgreSqlFlexibleServerConfigurationData>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
