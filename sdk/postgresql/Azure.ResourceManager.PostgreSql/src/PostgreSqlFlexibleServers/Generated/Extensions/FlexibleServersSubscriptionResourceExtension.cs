...
namespace Azure.ResourceManager.PostgreSql.FlexibleServers.Testing
{
    ...
    public partial class FlexibleServersSubscriptionResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="FlexibleServersSubscriptionResourceExtension"/> class for mocking. </summary>
        protected FlexibleServersSubscriptionResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="FlexibleServersSubscriptionResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal FlexibleServersSubscriptionResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<PostgreSqlFlexibleServerCapabilityProperties> ExecuteLocationBasedCapabilitiesAsync(AzureLocation locationName, CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, PostgreSqlFlexibleServerCapabilityProperties.DeserializePostgreSqlFlexibleServerCapabilityProperties, LocationBasedCapabilitiesClientDiagnostics, Pipeline, "FlexibleServersSubscriptionResourceExtension.ExecuteLocationBasedCapabilities", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual async Task<Response<PostgreSqlFlexibleServerNameAvailabilityResult>> CheckPostgreSqlFlexibleServerNameAvailabilityAsync(PostgreSqlFlexibleServerNameAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = CheckNameAvailabilityClientDiagnostics.CreateScope("FlexibleServersSubscriptionResourceExtension.CheckPostgreSqlFlexibleServerNameAvailability");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response<PostgreSqlFlexibleServerNameAvailabilityResult>> CheckPostgreSqlFlexibleServerNameAvailabilityWithLocationAsync(AzureLocation locationName, PostgreSqlFlexibleServerNameAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = CheckNameAvailabilityWithLocationClientDiagnostics.CreateScope("FlexibleServersSubscriptionResourceExtension.CheckPostgreSqlFlexibleServerNameAvailabilityWithLocation");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response<PostgreSqlFlexibleServerVirtualNetworkSubnetUsageResult>> ExecuteVirtualNetworkSubnetUsageAsync(AzureLocation locationName, PostgreSqlFlexibleServerVirtualNetworkSubnetUsageParameter postgreSqlFlexibleServerVirtualNetworkSubnetUsageParameter, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = VirtualNetworkSubnetUsageClientDiagnostics.CreateScope("FlexibleServersSubscriptionResourceExtension.ExecuteVirtualNetworkSubnetUsage");
            scope.Start();
            try
            {
