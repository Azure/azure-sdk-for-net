...
namespace Azure.ResourceManager.PostgreSql.FlexibleServers.Mocking
{
    ...
    public partial class PostgreSqlFlexibleServersSubscriptionMockingExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="PostgreSqlFlexibleServersSubscriptionMockingExtension"/> class for mocking. </summary>
        protected PostgreSqlFlexibleServersSubscriptionMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="PostgreSqlFlexibleServersSubscriptionMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal PostgreSqlFlexibleServersSubscriptionMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual async Task<Response<PostgreSqlFlexibleServerNameAvailabilityResult>> CheckPostgreSqlFlexibleServerNameAvailabilityAsync(PostgreSqlFlexibleServerNameAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = CheckNameAvailabilityClientDiagnostics.CreateScope("PostgreSqlFlexibleServersSubscriptionMockingExtension.CheckPostgreSqlFlexibleServerNameAvailability");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response<PostgreSqlFlexibleServerNameAvailabilityResult>> CheckPostgreSqlFlexibleServerNameAvailabilityWithLocationAsync(AzureLocation locationName, PostgreSqlFlexibleServerNameAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = CheckNameAvailabilityWithLocationClientDiagnostics.CreateScope("PostgreSqlFlexibleServersSubscriptionMockingExtension.CheckPostgreSqlFlexibleServerNameAvailabilityWithLocation");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response<PostgreSqlFlexibleServerVirtualNetworkSubnetUsageResult>> ExecuteVirtualNetworkSubnetUsageAsync(AzureLocation locationName, PostgreSqlFlexibleServerVirtualNetworkSubnetUsageParameter postgreSqlFlexibleServerVirtualNetworkSubnetUsageParameter, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = VirtualNetworkSubnetUsageClientDiagnostics.CreateScope("PostgreSqlFlexibleServersSubscriptionMockingExtension.ExecuteVirtualNetworkSubnetUsage");
            scope.Start();
            try
            {
