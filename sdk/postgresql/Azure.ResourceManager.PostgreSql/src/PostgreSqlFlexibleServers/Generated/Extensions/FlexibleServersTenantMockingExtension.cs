...
namespace Azure.ResourceManager.PostgreSql.FlexibleServers.Mocking
{
    ...
    internal partial class FlexibleServersTenantMockingExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="FlexibleServersTenantMockingExtension"/> class for mocking. </summary>
        protected FlexibleServersTenantMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="FlexibleServersTenantMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal FlexibleServersTenantMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        {
            using var scope = GetPrivateDnsZoneSuffixClientDiagnostics.CreateScope("FlexibleServersTenantMockingExtension.ExecuteGetPrivateDnsZoneSuffix");
            scope.Start();
            try
            {
