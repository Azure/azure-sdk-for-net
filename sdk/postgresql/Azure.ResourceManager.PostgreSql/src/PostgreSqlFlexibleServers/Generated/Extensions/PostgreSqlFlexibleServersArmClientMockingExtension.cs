...
namespace Azure.ResourceManager.PostgreSql.FlexibleServers.Mocking
{
    ...
    public partial class PostgreSqlFlexibleServersArmClientMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="PostgreSqlFlexibleServersArmClientMockingExtension"/> class for mocking. </summary>
        protected PostgreSqlFlexibleServersArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="PostgreSqlFlexibleServersArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal PostgreSqlFlexibleServersArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal PostgreSqlFlexibleServersArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
