...
namespace Azure.ResourceManager.PostgreSql.FlexibleServers.Testing
{
    /// <summary> A class to add extension methods to TenantResource. </summary>
    public partial class FlexibleServersTenantResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="FlexibleServersTenantResourceExtension"/> class for mocking. </summary>
        protected FlexibleServersTenantResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="FlexibleServersTenantResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal FlexibleServersTenantResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        {
            using var scope = GetPrivateDnsZoneSuffixClientDiagnostics.CreateScope("FlexibleServersTenantResourceExtension.ExecuteGetPrivateDnsZoneSuffix");
            scope.Start();
            try
            {
