...
namespace Azure.ResourceManager.PostgreSql.FlexibleServers.Mock
{
    ...
    public partial class PostgreSqlFlexibleServerResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="PostgreSqlFlexibleServerResourceExtension"/> class for mocking. </summary>
        protected PostgreSqlFlexibleServerResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="PostgreSqlFlexibleServerResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal PostgreSqlFlexibleServerResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
