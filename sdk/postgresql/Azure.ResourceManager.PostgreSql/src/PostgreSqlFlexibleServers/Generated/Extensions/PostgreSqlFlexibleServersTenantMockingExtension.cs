...
namespace Azure.ResourceManager.PostgreSql.FlexibleServers.Mocking
{
    ...
    public partial class PostgreSqlFlexibleServersTenantMockingExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="PostgreSqlFlexibleServersTenantMockingExtension"/> class for mocking. </summary>
        protected PostgreSqlFlexibleServersTenantMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="PostgreSqlFlexibleServersTenantMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal PostgreSqlFlexibleServersTenantMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        {
            using var scope = GetPrivateDnsZoneSuffixClientDiagnostics.CreateScope("PostgreSqlFlexibleServersTenantMockingExtension.ExecuteGetPrivateDnsZoneSuffix");
            scope.Start();
            try
            {
