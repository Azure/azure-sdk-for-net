...
namespace Azure.ResourceManager.PostgreSql.FlexibleServers.Mocking
{
    ...
    public partial class PostgreSqlFlexibleServersResourceGroupMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="PostgreSqlFlexibleServersResourceGroupMockingExtension"/> class for mocking. </summary>
        protected PostgreSqlFlexibleServersResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="PostgreSqlFlexibleServersResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal PostgreSqlFlexibleServersResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
