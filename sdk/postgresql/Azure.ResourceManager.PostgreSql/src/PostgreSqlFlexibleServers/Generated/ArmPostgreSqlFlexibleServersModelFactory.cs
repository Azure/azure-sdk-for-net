...
namespace Azure.ResourceManager.PostgreSql.FlexibleServers.Models
{
    ...
    public static partial class ArmPostgreSqlFlexibleServersModelFactory
    {
        ...
        {
            return new PostgreSqlFlexibleServerActiveDirectoryAdministratorData(id, name, resourceType, systemData, principalType, principalName, objectId, tenantId, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new PostgreSqlFlexibleServerBackupData(id, name, resourceType, systemData, backupType, completedOn, source, new Dictionary<string, BinaryData>());
        }
        ...
        public static PostgreSqlFlexibleServerEditionCapability PostgreSqlFlexibleServerEditionCapability(PostgreSqlFlexbileServerCapabilityStatus? capabilityStatus = null, string reason = null, string name = null, string defaultSkuName = null, IEnumerable<PostgreSqlFlexibleServerStorageEditionCapability> supportedStorageEditions = null, IEnumerable<PostgreSqlFlexibleServerSkuCapability> supportedServerSkus = null)
        {
            ...
            return new PostgreSqlFlexibleServerEditionCapability(capabilityStatus, reason, new Dictionary<string, BinaryData>(), name, defaultSkuName, supportedStorageEditions?.ToList(), supportedServerSkus?.ToList());
        }
        ...
        public static PostgreSqlFlexibleServerStorageEditionCapability PostgreSqlFlexibleServerStorageEditionCapability(PostgreSqlFlexbileServerCapabilityStatus? capabilityStatus = null, string reason = null, string name = null, long? defaultStorageSizeMb = null, IEnumerable<PostgreSqlFlexibleServerStorageCapability> supportedStorageCapabilities = null)
        {
            ...
            return new PostgreSqlFlexibleServerStorageEditionCapability(capabilityStatus, reason, new Dictionary<string, BinaryData>(), name, defaultStorageSizeMb, supportedStorageCapabilities?.ToList());
        }
        ...
        public static PostgreSqlFlexibleServerStorageCapability PostgreSqlFlexibleServerStorageCapability(PostgreSqlFlexbileServerCapabilityStatus? capabilityStatus = null, string reason = null, long? supportedIops = null, long? storageSizeInMB = null, string defaultIopsTier = null, IEnumerable<PostgreSqlFlexibleServerStorageTierCapability> supportedIopsTiers = null)
        {
            ...
            return new PostgreSqlFlexibleServerStorageCapability(capabilityStatus, reason, new Dictionary<string, BinaryData>(), supportedIops, storageSizeInMB, defaultIopsTier, supportedIopsTiers?.ToList());
        }
        ...
        {
            return new PostgreSqlFlexibleServerStorageTierCapability(capabilityStatus, reason, new Dictionary<string, BinaryData>(), name, iops);
        }
        ...
        {
            return new PostgreSqlBaseCapability(capabilityStatus, reason, new Dictionary<string, BinaryData>());
        }
        ...
        public static PostgreSqlFlexibleServerSkuCapability PostgreSqlFlexibleServerSkuCapability(PostgreSqlFlexbileServerCapabilityStatus? capabilityStatus = null, string reason = null, string name = null, int? vCores = null, int? supportedIops = null, long? supportedMemoryPerVcoreMb = null, IEnumerable<string> supportedZones = null, IEnumerable<PostgreSqlFlexibleServerHAMode> supportedHaMode = null)
        {
            ...
            return new PostgreSqlFlexibleServerSkuCapability(capabilityStatus, reason, new Dictionary<string, BinaryData>(), name, vCores, supportedIops, supportedMemoryPerVcoreMb, supportedZones?.ToList(), supportedHaMode?.ToList());
        }
        ...
        public static PostgreSqlFlexibleServerServerVersionCapability PostgreSqlFlexibleServerServerVersionCapability(PostgreSqlFlexbileServerCapabilityStatus? capabilityStatus = null, string reason = null, string name = null, IEnumerable<string> supportedVersionsToUpgrade = null)
        {
            ...
            return new PostgreSqlFlexibleServerServerVersionCapability(capabilityStatus, reason, new Dictionary<string, BinaryData>(), name, supportedVersionsToUpgrade?.ToList());
        }
        ...
        {
            return new PostgreSqlFlexibleServerFastProvisioningEditionCapability(capabilityStatus, reason, new Dictionary<string, BinaryData>(), supportedTier, supportedSku, supportedStorageGb, supportedServerVersions, serverCount);
        }
        ...
        {
            return new PostgreSqlFlexibleServerNameAvailabilityContent(name, resourceType, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new PostgreSqlFlexibleServerNameAvailabilityResult(isNameAvailable, reason, message, new Dictionary<string, BinaryData>(), name, resourceType);
        }
        ...
        {
            return new PostgreSqlFlexibleServerNameAvailabilityResponse(isNameAvailable, reason, message, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new PostgreSqlFlexibleServerConfigurationData(id, name, resourceType, systemData, value, description, defaultValue, dataType, allowedValues, source, isDynamicConfig, isReadOnly, isConfigPendingRestart, unit, documentationLink, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new PostgreSqlFlexibleServerDatabaseData(id, name, resourceType, systemData, charset, collation, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new PostgreSqlFlexibleServerFirewallRuleData(id, name, resourceType, systemData, startIPAddress, endIPAddress, new Dictionary<string, BinaryData>());
        }
        ...
        public static PostgreSqlFlexibleServerUserAssignedIdentity PostgreSqlFlexibleServerUserAssignedIdentity(IDictionary<string, UserAssignedIdentity> userAssignedIdentities = null, PostgreSqlFlexibleServerIdentityType identityType = default, Guid? tenantId = null)
        {
            ...
            return new PostgreSqlFlexibleServerUserAssignedIdentity(userAssignedIdentities, identityType, tenantId, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new PostgreSqlFlexibleServerStorage(storageSizeInGB, autoGrow, tier, iops, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new PostgreSqlFlexibleServerBackupProperties(backupRetentionDays, geoRedundantBackup, earliestRestoreOn, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new PostgreSqlFlexibleServerNetwork(publicNetworkAccess, delegatedSubnetResourceId, privateDnsZoneArmResourceId, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new PostgreSqlFlexibleServerHighAvailability(mode, state, standbyAvailabilityZone, new Dictionary<string, BinaryData>());
        }
        ...
        public static PostgreSqlMigrationData PostgreSqlMigrationData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, string migrationId = null, PostgreSqlMigrationStatus currentStatus = null, PostgreSqlMigrationMode? migrationMode = null, PostgreSqlServerMetadata sourceDbServerMetadata = null, PostgreSqlServerMetadata targetDbServerMetadata = null, ResourceIdentifier sourceDbServerResourceId = null, string sourceDbServerFullyQualifiedDomainName = null, ResourceIdentifier targetDbServerResourceId = null, string targetDbServerFullyQualifiedDomainName = null, PostgreSqlMigrationSecretParameters secretParameters = null, IEnumerable<string> dbsToMigrate = null, PostgreSqlMigrationLogicalReplicationOnSourceDb? setupLogicalReplicationOnSourceDbIfNeeded = null, PostgreSqlMigrationOverwriteDbsInTarget? overwriteDbsInTarget = null, DateTimeOffset? migrationWindowStartTimeInUtc = null, DateTimeOffset? migrationWindowEndTimeInUtc = null, PostgreSqlMigrationStartDataMigration? startDataMigration = null, PostgreSqlMigrationTriggerCutover? triggerCutover = null, IEnumerable<string> dbsToTriggerCutoverOn = null, PostgreSqlMigrationCancel? cancel = null, IEnumerable<string> dbsToCancelMigrationOn = null)
        {
            ...
            return new PostgreSqlMigrationData(id, name, resourceType, systemData, tags, location, migrationId, currentStatus, migrationMode, sourceDbServerMetadata, targetDbServerMetadata, sourceDbServerResourceId, sourceDbServerFullyQualifiedDomainName, targetDbServerResourceId, targetDbServerFullyQualifiedDomainName, secretParameters, dbsToMigrate?.ToList(), setupLogicalReplicationOnSourceDbIfNeeded, overwriteDbsInTarget, migrationWindowStartTimeInUtc, migrationWindowEndTimeInUtc, startDataMigration, triggerCutover, dbsToTriggerCutoverOn?.ToList(), cancel, dbsToCancelMigrationOn?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new PostgreSqlMigrationStatus(state, error, currentSubState != null ? new PostgreSqlMigrationSubStateDetails(currentSubState, new Dictionary<string, BinaryData>()) : null, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new PostgreSqlServerMetadata(location, version, storageMb, sku, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ServerSku(name, tier, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new PostgreSqlCheckMigrationNameAvailabilityContent(name, resourceType, isNameAvailable, reason, message, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new PostgreSqlFlexibleServerLogFile(id, name, resourceType, systemData, createdOn, lastModifiedOn, sizeInKb, typePropertiesType, uri, new Dictionary<string, BinaryData>());
        }
        ...
        public static PostgreSqlFlexibleServerVirtualNetworkSubnetUsageResult PostgreSqlFlexibleServerVirtualNetworkSubnetUsageResult(IEnumerable<PostgreSqlFlexibleServerDelegatedSubnetUsage> delegatedSubnetsUsage = null, AzureLocation? location = null, string subscriptionId = null)
        {
            ...
            return new PostgreSqlFlexibleServerVirtualNetworkSubnetUsageResult(delegatedSubnetsUsage?.ToList(), location, subscriptionId, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new PostgreSqlFlexibleServerDelegatedSubnetUsage(subnetName, usage, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new PostgreSqlFlexibleServerLtrPreBackupResult(numberOfContainers, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new PostgreSqlFlexibleServerLtrBackupResult(datasourceSizeInBytes, dataTransferredInBytes, backupName, backupMetadata, status, startOn, endOn, percentComplete, errorCode, errorMessage, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new PostgreSqlLtrServerBackupOperationData(id, name, resourceType, systemData, datasourceSizeInBytes, dataTransferredInBytes, backupName, backupMetadata, status, startOn, endOn, percentComplete, errorCode, errorMessage, new Dictionary<string, BinaryData>());
        }
    }
}
