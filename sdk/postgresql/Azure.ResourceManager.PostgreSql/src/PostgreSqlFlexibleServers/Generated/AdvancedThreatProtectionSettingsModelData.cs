...
{
    /// <summary>
    /// A class representing the AdvancedThreatProtectionSettingsModel data model.
    /// Advanced threat protection settings of the server.
    /// </summary>
    public partial class AdvancedThreatProtectionSettingsModelData : ResourceData
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="AdvancedThreatProtectionSettingsModelData"/>. </summary>
        ...
        internal AdvancedThreatProtectionSettingsModelData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, ThreatProtectionState? state, DateTimeOffset? createdOn, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
            State = state;
            CreatedOn = createdOn;
