...
{
    public partial class PostgreSqlFlexibleServersPostgreSqlFlexibleServerData : IUtf8JsonSerializable, IJsonModel<PostgreSqlFlexibleServersPostgreSqlFlexibleServerData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PostgreSqlFlexibleServersPostgreSqlFlexibleServerData>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<PostgreSqlFlexibleServersPostgreSqlFlexibleServerData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<PostgreSqlFlexibleServersPostgreSqlFlexibleServerData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(PostgreSqlFlexibleServersPostgreSqlFlexibleServerData)} does not support writing '{format}' format.");
            }
        ...
        PostgreSqlFlexibleServersPostgreSqlFlexibleServerData IJsonModel<PostgreSqlFlexibleServersPostgreSqlFlexibleServerData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<PostgreSqlFlexibleServersPostgreSqlFlexibleServerData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(PostgreSqlFlexibleServersPostgreSqlFlexibleServerData)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializePostgreSqlFlexibleServersPostgreSqlFlexibleServerData(document.RootElement, options);
        }

        internal static PostgreSqlFlexibleServersPostgreSqlFlexibleServerData DeserializePostgreSqlFlexibleServersPostgreSqlFlexibleServerData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            PostgreSqlFlexibleServersPostgreSqlFlexibleServerSku sku = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("sku"u8))
                {
                    ...
                    sku = PostgreSqlFlexibleServersPostgreSqlFlexibleServerSku.DeserializePostgreSqlFlexibleServersPostgreSqlFlexibleServerSku(property.Value, options);
                    continue;
                }
            ...
            return new PostgreSqlFlexibleServersPostgreSqlFlexibleServerData(
                id,
                name,
                type,
                systemData,
        ...
        BinaryData IPersistableModel<PostgreSqlFlexibleServersPostgreSqlFlexibleServerData>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<PostgreSqlFlexibleServersPostgreSqlFlexibleServerData>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(PostgreSqlFlexibleServersPostgreSqlFlexibleServerData)} does not support writing '{options.Format}' format.");
            }
        }

        PostgreSqlFlexibleServersPostgreSqlFlexibleServerData IPersistableModel<PostgreSqlFlexibleServersPostgreSqlFlexibleServerData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<PostgreSqlFlexibleServersPostgreSqlFlexibleServerData>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(PostgreSqlFlexibleServersPostgreSqlFlexibleServerData)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<PostgreSqlFlexibleServersPostgreSqlFlexibleServerData>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
