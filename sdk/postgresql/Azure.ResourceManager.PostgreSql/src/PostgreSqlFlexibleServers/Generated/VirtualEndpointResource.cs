...
namespace Azure.ResourceManager.PostgreSql.FlexibleServers
{
    ...
    public partial class VirtualEndpointResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<VirtualEndpointResource>> UpdateAsync(WaitUntil waitUntil, VirtualEndpointPatch patch, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new FlexibleServersArmOperation<VirtualEndpointResource>(new VirtualEndpointOperationSource(Client), _virtualEndpointClientDiagnostics, Pipeline, _virtualEndpointRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, patch).Request, response, OperationFinalStateVia.AzureAsyncOperation);
                if (waitUntil == WaitUntil.Completed)
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="patch"/> is null. </exception>
        public virtual ArmOperation<VirtualEndpointResource> Update(WaitUntil waitUntil, VirtualEndpointPatch patch, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(patch, nameof(patch));
