...
namespace Azure.ResourceManager.PostgreSql.FlexibleServers
{
    internal partial class PostgreSQLServerManagementRestOperations
    {
        ...
        /// <summary> Initializes a new instance of PostgreSQLServerManagementRestOperations. </summary>
        ...
        internal HttpMessage CreateCheckMigrationNameAvailabilityRequest(string subscriptionId, string resourceGroupName, string targetDbServerName, PostgreSqlCheckMigrationNameAvailabilityContent content)
        {
            ...
            ((IJsonModel<PostgreSqlCheckMigrationNameAvailabilityContent>)content).Write(content0.JsonWriter, ModelSerializationExtensions.WireOptions);
