...
namespace Azure.ResourceManager.PostgreSql.FlexibleServers
{
    internal partial class CheckNameAvailabilityRestOperations
    {
        ...
        public async Task<Response<PostgreSqlFlexibleServerNameAvailability>> ExecuteAsync(string subscriptionId, PostgreSqlFlexibleServerNameAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            ...
            switch (message.Response.Status)
            {
                case 200:
                    {
                        PostgreSqlFlexibleServerNameAvailability value = default;
                        using var document = await JsonDocument.ParseAsync(message.Response.ContentStream, default, cancellationToken).ConfigureAwait(false);
                        value = PostgreSqlFlexibleServerNameAvailability.DeserializePostgreSqlFlexibleServerNameAvailability(document.RootElement);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="subscriptionId"/> or <paramref name="content"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="subscriptionId"/> is an empty string, and was expected to be non-empty. </exception>
        public Response<PostgreSqlFlexibleServerNameAvailability> Execute(string subscriptionId, PostgreSqlFlexibleServerNameAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(subscriptionId, nameof(subscriptionId));
            Argument.AssertNotNull(content, nameof(content));
