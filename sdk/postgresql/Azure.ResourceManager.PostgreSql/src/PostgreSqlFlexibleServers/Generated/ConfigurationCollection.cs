...
namespace Azure.ResourceManager.PostgreSql.FlexibleServers
{
    ...
    public partial class ConfigurationCollection : ArmCollection, IEnumerable<ConfigurationResource>, IAsyncEnumerable<ConfigurationResource>
    {
        ...
        {
            _configurationClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.PostgreSql.FlexibleServers", ConfigurationResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<ConfigurationResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string configurationName, ConfigurationData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new FlexibleServersArmOperation<ConfigurationResource>(new ConfigurationOperationSource(Client), _configurationClientDiagnostics, Pipeline, _configurationRestClient.CreatePutRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, configurationName, data).Request, response, OperationFinalStateVia.Location);
