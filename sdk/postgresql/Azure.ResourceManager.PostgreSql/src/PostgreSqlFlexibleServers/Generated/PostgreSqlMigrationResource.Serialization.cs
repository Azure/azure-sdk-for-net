...
namespace Azure.ResourceManager.PostgreSql.FlexibleServers
{
    public partial class PostgreSqlMigrationResource : IJsonModel<PostgreSqlMigrationData>
    {
        ...
        BinaryData IPersistableModel<PostgreSqlMigrationData>.Write(ModelReaderWriterOptions options) => ModelReaderWriter.Write<PostgreSqlMigrationData>(Data, options, PostgreSql.AzureResourceManagerPostgreSqlContext.Default);

        PostgreSqlMigrationData IPersistableModel<PostgreSqlMigrationData>.Create(BinaryData data, ModelReaderWriterOptions options) => ModelReaderWriter.Read<PostgreSqlMigrationData>(data, options, PostgreSql.AzureResourceManagerPostgreSqlContext.Default);
