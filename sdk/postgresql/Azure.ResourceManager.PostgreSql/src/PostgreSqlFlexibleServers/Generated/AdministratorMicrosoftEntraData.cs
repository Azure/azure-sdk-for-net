...
{
    /// <summary>
    /// A class representing the AdministratorMicrosoftEntra data model.
    /// Server administrator associated to a Microsoft Entra principal.
    /// </summary>
    public partial class AdministratorMicrosoftEntraData : ResourceData
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="AdministratorMicrosoftEntraData"/>. </summary>
        ...
        internal AdministratorMicrosoftEntraData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, PostgreSqlFlexibleServerPrincipalType? principalType, string principalName, string objectId, Guid? tenantId, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
