...
namespace Azure.ResourceManager.PostgreSql.FlexibleServers
{
    ...
    public partial class DatabaseCollection : ArmCollection, IEnumerable<DatabaseResource>, IAsyncEnumerable<DatabaseResource>
    {
        ...
        {
            _databaseClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.PostgreSql.FlexibleServers", DatabaseResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<DatabaseResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string databaseName, DatabaseData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _databaseRestClient.CreateAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, databaseName, data, cancellationToken).ConfigureAwait(false);
                var operation = new FlexibleServersArmOperation<DatabaseResource>(new DatabaseOperationSource(Client), _databaseClientDiagnostics, Pipeline, _databaseRestClient.CreateCreateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, databaseName, data).Request, response, OperationFinalStateVia.Location);
        ...
        public virtual ArmOperation<DatabaseResource> CreateOrUpdate(WaitUntil waitUntil, string databaseName, DatabaseData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _databaseRestClient.Create(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, databaseName, data, cancellationToken);
                var operation = new FlexibleServersArmOperation<DatabaseResource>(new DatabaseOperationSource(Client), _databaseClientDiagnostics, Pipeline, _databaseRestClient.CreateCreateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, databaseName, data).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
