...
namespace Azure.ResourceManager.PostgreSql.FlexibleServers.Models
{
    ...
    public partial class PostgreSqlMigrationStatus
    {
        ...
        internal PostgreSqlMigrationStatus(PostgreSqlMigrationState? state, string error, PostgreSqlMigrationSubStateDetails currentSubStateDetails, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            State = state;
            Error = error;
