...
namespace Azure.ResourceManager.PostgreSql.FlexibleServers.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PostgreSqlMigrationSecretParameters>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PostgreSqlMigrationSecretParameters>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PostgreSqlMigrationSecretParameters>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PostgreSqlMigrationSecretParameters>)} interface");
            }
        ...
        string IPersistableModel<PostgreSqlMigrationSecretParameters>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
