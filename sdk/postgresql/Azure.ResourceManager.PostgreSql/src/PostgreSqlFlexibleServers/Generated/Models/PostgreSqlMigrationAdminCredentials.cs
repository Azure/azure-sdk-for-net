...
namespace Azure.ResourceManager.PostgreSql.FlexibleServers.Models
{
    ...
    public partial class PostgreSqlMigrationAdminCredentials
    {
        ...
        internal PostgreSqlMigrationAdminCredentials(string sourceServerPassword, string targetServerPassword, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            SourceServerPassword = sourceServerPassword;
            TargetServerPassword = targetServerPassword;
