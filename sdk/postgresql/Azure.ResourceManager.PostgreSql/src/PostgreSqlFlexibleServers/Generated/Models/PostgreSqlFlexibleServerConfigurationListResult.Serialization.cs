...
namespace Azure.ResourceManager.PostgreSql.FlexibleServers.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PostgreSqlFlexibleServerConfigurationListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<PostgreSqlFlexibleServerConfigurationListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PostgreSqlFlexibleServerConfigurationListResult>)} interface");
            }
        ...
        string IPersistableModel<PostgreSqlFlexibleServerConfigurationListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
