...
{
    public partial class PostgreSqlFlexibleServerLtrPreBackupResult : IUtf8JsonSerializable, IJsonModel<PostgreSqlFlexibleServerLtrPreBackupResult>, IPersistableModel<PostgreSqlFlexibleServerLtrPreBackupResult>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(NumberOfContainers))
            {
                ...
                builder.AppendLine($" '{NumberOfContainers.ToString()}'");
            }
