...
namespace Azure.ResourceManager.PostgreSql.FlexibleServers.Models
{
    ...
    public partial class PostgreSqlServerMetadata
    {
        ...
        internal PostgreSqlServerMetadata(AzureLocation? location, string version, int? storageMb, ServerSku sku, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Location = location;
            Version = version;
            StorageMb = storageMb;
