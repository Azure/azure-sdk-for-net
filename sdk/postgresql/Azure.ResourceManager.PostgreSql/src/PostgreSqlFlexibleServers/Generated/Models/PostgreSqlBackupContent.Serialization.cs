...
namespace Azure.ResourceManager.PostgreSql.FlexibleServers.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PostgreSqlBackupContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PostgreSqlBackupContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PostgreSqlBackupContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PostgreSqlBackupContent>)} interface");
            }
        ...
        string IPersistableModel<PostgreSqlBackupContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
