...
{
    public partial class PostgreSqlFlexibleServersPostgreSqlFlexibleServerPatch : IUtf8JsonSerializable, IJsonModel<PostgreSqlFlexibleServersPostgreSqlFlexibleServerPatch>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PostgreSqlFlexibleServersPostgreSqlFlexibleServerPatch>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<PostgreSqlFlexibleServersPostgreSqlFlexibleServerPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<PostgreSqlFlexibleServersPostgreSqlFlexibleServerPatch>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(PostgreSqlFlexibleServersPostgreSqlFlexibleServerPatch)} does not support writing '{format}' format.");
            }
        ...
        PostgreSqlFlexibleServersPostgreSqlFlexibleServerPatch IJsonModel<PostgreSqlFlexibleServersPostgreSqlFlexibleServerPatch>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<PostgreSqlFlexibleServersPostgreSqlFlexibleServerPatch>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(PostgreSqlFlexibleServersPostgreSqlFlexibleServerPatch)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializePostgreSqlFlexibleServersPostgreSqlFlexibleServerPatch(document.RootElement, options);
        }

        internal static PostgreSqlFlexibleServersPostgreSqlFlexibleServerPatch DeserializePostgreSqlFlexibleServersPostgreSqlFlexibleServerPatch(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new PostgreSqlFlexibleServersPostgreSqlFlexibleServerPatch(
                sku,
                identity,
        ...
        BinaryData IPersistableModel<PostgreSqlFlexibleServersPostgreSqlFlexibleServerPatch>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<PostgreSqlFlexibleServersPostgreSqlFlexibleServerPatch>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(PostgreSqlFlexibleServersPostgreSqlFlexibleServerPatch)} does not support writing '{options.Format}' format.");
            }
        }

        PostgreSqlFlexibleServersPostgreSqlFlexibleServerPatch IPersistableModel<PostgreSqlFlexibleServersPostgreSqlFlexibleServerPatch>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<PostgreSqlFlexibleServersPostgreSqlFlexibleServerPatch>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(PostgreSqlFlexibleServersPostgreSqlFlexibleServerPatch)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<PostgreSqlFlexibleServersPostgreSqlFlexibleServerPatch>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
