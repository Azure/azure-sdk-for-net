...
{
    public partial class PostgreSqlFlexibleServerCapabilityProperties : IUtf8JsonSerializable, IJsonModel<PostgreSqlFlexibleServerCapabilityProperties>, IPersistableModel<PostgreSqlFlexibleServerCapabilityProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SupportFastProvisioning))
            {
                ...
                builder.AppendLine($" '{SupportFastProvisioning.ToString()}'");
            }
