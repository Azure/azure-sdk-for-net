...
{
    public partial class PostgreSqlMigrationData : IUtf8JsonSerializable, IModelJsonSerializable<PostgreSqlMigrationData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IModelJsonSerializable<PostgreSqlMigrationData>)this).Serialize(writer, ModelSerializerOptions.DefaultWireOptions);

        void IModelJsonSerializable<PostgreSqlMigrationData>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<PostgreSqlMigrationData>(this, options.Format);
        ...
        internal static PostgreSqlMigrationData DeserializePostgreSqlMigrationData(JsonElement element, ModelSerializerOptions options = default)
        {
        ...
        PostgreSqlMigrationData IModelSerializable<PostgreSqlMigrationData>.Deserialize(BinaryData data, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<PostgreSqlMigrationData>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="PostgreSqlMigrationData"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="PostgreSqlMigrationData"/> to convert. </param>
        public static implicit operator RequestContent(PostgreSqlMigrationData model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="PostgreSqlMigrationData"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator PostgreSqlMigrationData(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializePostgreSqlMigrationData(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
