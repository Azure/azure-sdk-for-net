...
{
    public partial class PostgreSqlMigrationData : IUtf8JsonSerializable, IJsonModel<PostgreSqlMigrationData>, IPersistableModel<PostgreSqlMigrationData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SecretParameters))
            {
                ...
                AppendChildObject(builder, SecretParameters, options, 2);
            }
            ...
            if (Optional.IsDefined(SetupLogicalReplicationOnSourceDbIfNeeded))
            {
                ...
                builder.AppendLine($" '{SetupLogicalReplicationOnSourceDbIfNeeded.ToString()}'");
            }

            if (Optional.IsDefined(OverwriteDbsInTarget))
            {
                builder.Append("  overwriteDbsInTarget:");
                builder.AppendLine($" '{OverwriteDbsInTarget.ToString()}'");
            }

            if (Optional.IsDefined(MigrationWindowStartTimeInUtc))
            {
                builder.Append("  migrationWindowStartTimeInUtc:");
                builder.AppendLine($" '{MigrationWindowStartTimeInUtc.Value.ToString()}'");
            }

            if (Optional.IsDefined(MigrationWindowEndTimeInUtc))
            {
                builder.Append("  migrationWindowEndTimeInUtc:");
                builder.AppendLine($" '{MigrationWindowEndTimeInUtc.Value.ToString()}'");
            }

            if (Optional.IsDefined(StartDataMigration))
            {
                builder.Append("  startDataMigration:");
                builder.AppendLine($" '{StartDataMigration.ToString()}'");
            }

            if (Optional.IsDefined(TriggerCutover))
            {
                builder.Append("  triggerCutover:");
                builder.AppendLine($" '{TriggerCutover.ToString()}'");
            }
            ...
            if (Optional.IsDefined(Cancel))
            {
                ...
                builder.AppendLine($" '{Cancel.ToString()}'");
            }
