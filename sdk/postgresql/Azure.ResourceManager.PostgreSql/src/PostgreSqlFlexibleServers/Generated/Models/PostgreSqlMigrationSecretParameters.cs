...
namespace Azure.ResourceManager.PostgreSql.FlexibleServers.Models
{
    ...
    public partial class PostgreSqlMigrationSecretParameters
    {
        ...
        internal PostgreSqlMigrationSecretParameters(PostgreSqlMigrationAdminCredentials adminCredentials, string sourceServerUsername, string targetServerUsername, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            AdminCredentials = adminCredentials;
