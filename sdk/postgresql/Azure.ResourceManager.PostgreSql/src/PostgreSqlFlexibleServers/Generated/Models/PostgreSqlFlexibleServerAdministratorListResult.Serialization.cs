...
namespace Azure.ResourceManager.PostgreSql.FlexibleServers.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PostgreSqlFlexibleServerAdministratorListResult>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        PostgreSqlFlexibleServerAdministratorListResult IJsonModel<PostgreSqlFlexibleServerAdministratorListResult>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<PostgreSqlFlexibleServerAdministratorListResult>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        PostgreSqlFlexibleServerAdministratorListResult IModel<PostgreSqlFlexibleServerAdministratorListResult>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<PostgreSqlFlexibleServerAdministratorListResult>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
