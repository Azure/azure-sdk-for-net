...
namespace Azure.ResourceManager.PostgreSql.FlexibleServers.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PostgreSqlMigrationSubStateDetails>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PostgreSqlMigrationSubStateDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PostgreSqlMigrationSubStateDetails>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<PostgreSqlMigrationSubStateDetails>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
