...
namespace Azure.ResourceManager.PostgreSql.FlexibleServers.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PostgreSqlMigrationSubStateDetails>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        PostgreSqlMigrationSubStateDetails IJsonModel<PostgreSqlMigrationSubStateDetails>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<PostgreSqlMigrationSubStateDetails>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        PostgreSqlMigrationSubStateDetails IModel<PostgreSqlMigrationSubStateDetails>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<PostgreSqlMigrationSubStateDetails>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
