...
{
    internal partial class PostgreSqlMigrationSubStateDetails : IUtf8JsonSerializable, IJsonModel<PostgreSqlMigrationSubStateDetails>, IPersistableModel<PostgreSqlMigrationSubStateDetails>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(CurrentSubState))
            {
                ...
                builder.AppendLine($" '{CurrentSubState.ToString()}'");
            }
