...
namespace Azure.ResourceManager.PostgreSql.FlexibleServers.Models
{
    public partial class PostgreSqlFlexibleServerFastProvisioningEditionCapability : IUtf8JsonSerializable, IModelJsonSerializable<PostgreSqlFlexibleServerFastProvisioningEditionCapability>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<PostgreSqlFlexibleServerFastProvisioningEditionCapability>(this, options.Format);
        ...
        internal static PostgreSqlFlexibleServerFastProvisioningEditionCapability DeserializePostgreSqlFlexibleServerFastProvisioningEditionCapability(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new PostgreSqlFlexibleServerFastProvisioningEditionCapability(Optional.ToNullable(status), reason.Value, supportedTier.Value, supportedSku.Value, Optional.ToNullable(supportedStorageGb), supportedServerVersions.Value, Optional.ToNullable(serverCount), serializedAdditionalRawData);
        }
        ...
        /// <summary> Converts a <see cref="PostgreSqlFlexibleServerFastProvisioningEditionCapability"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="PostgreSqlFlexibleServerFastProvisioningEditionCapability"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="PostgreSqlFlexibleServerFastProvisioningEditionCapability"/>. </summary>
