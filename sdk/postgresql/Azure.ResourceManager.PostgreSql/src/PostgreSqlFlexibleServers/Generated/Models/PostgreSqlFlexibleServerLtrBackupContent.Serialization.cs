...
namespace Azure.ResourceManager.PostgreSql.FlexibleServers.Models
{
    public partial class PostgreSqlFlexibleServerLtrBackupContent : IUtf8JsonSerializable, IModelJsonSerializable<PostgreSqlFlexibleServerLtrBackupContent>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<PostgreSqlFlexibleServerLtrBackupContent>(this, options.Format);
            ...
            {
                ((IModelJsonSerializable<PostgreSqlFlexibleServerBackupStoreDetails>)TargetDetails).Serialize(writer, options);
            }
        ...
        internal static PostgreSqlFlexibleServerLtrBackupContent DeserializePostgreSqlFlexibleServerLtrBackupContent(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new PostgreSqlFlexibleServerLtrBackupContent(backupSettings, targetDetails, serializedAdditionalRawData);
        }
        ...
        /// <summary> Converts a <see cref="PostgreSqlFlexibleServerLtrBackupContent"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="PostgreSqlFlexibleServerLtrBackupContent"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="PostgreSqlFlexibleServerLtrBackupContent"/>. </summary>
