...
{
    internal partial class PostgreSqlMigrationResourceListResult : IUtf8JsonSerializable, IJsonModel<PostgreSqlMigrationResourceListResult>, IPersistableModel<PostgreSqlMigrationResourceListResult>
    {
        ...
        void IJsonModel<PostgreSqlMigrationResourceListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(PostgreSqlMigrationResourceListResult)} does not support '{format}' format.");
            }
