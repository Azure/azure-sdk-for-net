...
namespace Azure.ResourceManager.PostgreSql.FlexibleServers.Models
{
    public partial class PostgreSqlMigrationPatch : IUtf8JsonSerializable, IModelJsonSerializable<PostgreSqlMigrationPatch>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<PostgreSqlMigrationPatch>(this, options.Format);
            ...
            if (Optional.IsDefined(SecretParameters))
            {
                ...
                {
                    ((IModelJsonSerializable<PostgreSqlMigrationSecretParameters>)SecretParameters).Serialize(writer, options);
                }
            }
        ...
        /// <summary> Converts a <see cref="PostgreSqlMigrationPatch"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="PostgreSqlMigrationPatch"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="PostgreSqlMigrationPatch"/>. </summary>
