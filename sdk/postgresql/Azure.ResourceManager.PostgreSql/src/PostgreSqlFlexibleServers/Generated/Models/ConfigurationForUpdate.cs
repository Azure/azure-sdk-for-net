...
namespace Azure.ResourceManager.PostgreSql.FlexibleServers.Models
{
    ...
    public partial class ConfigurationForUpdate
    {
        ...
        /// <summary> Initializes a new instance of <see cref="ConfigurationForUpdate"/>. </summary>
        ...
        internal ConfigurationForUpdate(string value, string description, string defaultValue, PostgreSqlFlexibleServerConfigurationDataType? dataType, string allowedValues, string source, bool? isDynamicConfig, bool? isReadOnly, bool? isConfigPendingRestart, string unit, string documentationLink, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Value = value;
