...
namespace Azure.ResourceManager.PostgreSql.FlexibleServers
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PostgreSqlFlexibleServerActiveDirectoryAdministratorData>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<PostgreSqlFlexibleServerActiveDirectoryAdministratorData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PostgreSqlFlexibleServerActiveDirectoryAdministratorData>)} interface");
            }
        ...
        string IPersistableModel<PostgreSqlFlexibleServerActiveDirectoryAdministratorData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
