...
namespace Azure.ResourceManager.PostgreSql.FlexibleServers.Models
{
    public partial class PostgreSqlFlexibleServerVirtualNetworkSubnetUsageParameter : IUtf8JsonSerializable, IJsonModel<PostgreSqlFlexibleServerVirtualNetworkSubnetUsageParameter>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(VirtualNetworkArmResourceId), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("  virtualNetworkArmResourceId: ");
            ...
            else
            {
                ...
                {
                    builder.Append("  virtualNetworkArmResourceId: ");
                    builder.AppendLine($"'{VirtualNetworkArmResourceId.ToString()}'");
                }
            }
