...
namespace Azure.ResourceManager.PostgreSql.FlexibleServers.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PostgreSqlFlexibleServerDatabaseListResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(PostgreSqlFlexibleServerDatabaseListResult)} does not support writing '{format}' format.");
            }
            ...
            if (Optional.IsCollectionDefined(Value))
            {
                ...
                {
                    ((IJsonModel<PostgreSqlFlexibleServerDatabaseData>)item).Write(writer, options);
                }
        ...
        PostgreSqlFlexibleServerDatabaseListResult IJsonModel<PostgreSqlFlexibleServerDatabaseListResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(PostgreSqlFlexibleServerDatabaseListResult)} does not support reading '{format}' format.");
            }
        ...
        internal static PostgreSqlFlexibleServerDatabaseListResult DeserializePostgreSqlFlexibleServerDatabaseListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new PostgreSqlFlexibleServerDatabaseListResult(value ?? new ChangeTrackingList<PostgreSqlFlexibleServerDatabaseData>(), nextLink, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<PostgreSqlFlexibleServerDatabaseListResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(PostgreSqlFlexibleServerDatabaseListResult)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        PostgreSqlFlexibleServerDatabaseListResult IPersistableModel<PostgreSqlFlexibleServerDatabaseListResult>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(PostgreSqlFlexibleServerDatabaseListResult)} does not support reading '{options.Format}' format.");
            }
        }
