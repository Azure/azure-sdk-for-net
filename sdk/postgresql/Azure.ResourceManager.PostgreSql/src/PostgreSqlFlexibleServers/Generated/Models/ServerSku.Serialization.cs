...
namespace Azure.ResourceManager.PostgreSql.FlexibleServers.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ServerSku>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ServerSku>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ServerSku>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ServerSku>)} interface");
            }
        ...
        string IPersistableModel<ServerSku>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
