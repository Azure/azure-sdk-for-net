...
namespace Azure.ResourceManager.PostgreSql.FlexibleServers.Models
{
    ...
    public partial class PostgreSqlFlexibleServerStorageEditionCapability : PostgreSqlBaseCapability
    {
        ...
        internal PostgreSqlFlexibleServerStorageEditionCapability(PostgreSqlFlexbileServerCapabilityStatus? capabilityStatus, string reason, string name, long? defaultStorageSizeMb, IReadOnlyList<PostgreSqlFlexibleServerStorageCapability> supportedStorageCapabilities, Dictionary<string, BinaryData> rawData) : base(capabilityStatus, reason, rawData)
        {
            Name = name;
