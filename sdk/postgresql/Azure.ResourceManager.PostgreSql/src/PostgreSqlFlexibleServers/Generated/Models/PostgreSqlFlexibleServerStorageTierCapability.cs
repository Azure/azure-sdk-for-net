...
namespace Azure.ResourceManager.PostgreSql.FlexibleServers.Models
{
    ...
    public partial class PostgreSqlFlexibleServerStorageTierCapability : PostgreSqlBaseCapability
    {
        ...
        internal PostgreSqlFlexibleServerStorageTierCapability(PostgreSqlFlexbileServerCapabilityStatus? capabilityStatus, string reason, string name, long? iops, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(capabilityStatus, reason, serializedAdditionalRawData)
        {
            Name = name;
            Iops = iops;
        }
