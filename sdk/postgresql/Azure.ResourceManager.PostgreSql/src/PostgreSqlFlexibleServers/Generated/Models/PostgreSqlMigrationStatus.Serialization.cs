...
namespace Azure.ResourceManager.PostgreSql.FlexibleServers.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PostgreSqlMigrationStatus>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PostgreSqlMigrationStatus>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PostgreSqlMigrationStatus>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PostgreSqlMigrationStatus>)} interface");
            }
        ...
        string IPersistableModel<PostgreSqlMigrationStatus>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
