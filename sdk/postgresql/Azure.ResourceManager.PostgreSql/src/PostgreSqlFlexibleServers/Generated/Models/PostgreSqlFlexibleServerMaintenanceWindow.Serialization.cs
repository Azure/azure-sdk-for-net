...
{
    public partial class PostgreSqlFlexibleServerMaintenanceWindow : Core.IUtf8JsonSerializable
    {
        ...
        internal static PostgreSqlFlexibleServerMaintenanceWindow DeserializePostgreSqlFlexibleServerMaintenanceWindow(JsonElement element)
        {
            ...
            return new PostgreSqlFlexibleServerMaintenanceWindow(customWindow.Value, Core.Optional.ToNullable(startHour), Core.Optional.ToNullable(startMinute), Core.Optional.ToNullable(dayOfWeek));
        }
    }
}
