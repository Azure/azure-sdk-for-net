...
{
    public partial class PostgreSqlFlexibleServerMaintenanceWindow : IUtf8JsonSerializable, IJsonModel<PostgreSqlFlexibleServerMaintenanceWindow>, IPersistableModel<PostgreSqlFlexibleServerMaintenanceWindow>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(StartHour))
            {
                ...
                builder.AppendLine($" '{StartHour.Value.ToString()}'");
            }

            if (Optional.IsDefined(StartMinute))
            {
                builder.Append("  startMinute:");
                builder.AppendLine($" '{StartMinute.Value.ToString()}'");
            }
