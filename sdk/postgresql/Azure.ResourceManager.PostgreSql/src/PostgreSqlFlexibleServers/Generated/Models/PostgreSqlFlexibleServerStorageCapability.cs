...
namespace Azure.ResourceManager.PostgreSql.FlexibleServers.Models
{
    ...
    public partial class PostgreSqlFlexibleServerStorageCapability : PostgreSqlBaseCapability
    {
        ...
        internal PostgreSqlFlexibleServerStorageCapability(PostgreSqlFlexbileServerCapabilityStatus? capabilityStatus, string reason, long? supportedIops, long? storageSizeInMB, string defaultIopsTier, IReadOnlyList<PostgreSqlFlexibleServerStorageTierCapability> supportedIopsTiers, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(capabilityStatus, reason, serializedAdditionalRawData)
        {
