...
namespace Azure.ResourceManager.PostgreSql.FlexibleServers.Models
{
    ...
    public partial class PostgreSqlFlexibleServerSkuCapability : PostgreSqlBaseCapability
    {
        ...
        internal PostgreSqlFlexibleServerSkuCapability(PostgreSqlFlexbileServerCapabilityStatus? capabilityStatus, string reason, string name, int? vCores, int? supportedIops, long? supportedMemoryPerVcoreMb, IReadOnlyList<string> supportedZones, IReadOnlyList<PostgreSqlFlexibleServerHAMode> supportedHaMode, Dictionary<string, BinaryData> rawData) : base(capabilityStatus, reason, rawData)
        {
            Name = name;
            VCores = vCores;
