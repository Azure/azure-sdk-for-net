...
namespace Azure.ResourceManager.PostgreSql.FlexibleServers.Models
{
    ...
    public readonly partial struct MigrationState : IEquatable<MigrationState>
    {
        ...
        public static MigrationState WaitingForUserAction { get; } = new MigrationState(WaitingForUserActionValue);
        /// <summary> Canceled. </summary>
        public static MigrationState Canceled { get; } = new MigrationState(CanceledValue);
        /// <summary> Failed. </summary>
        public static MigrationState Failed { get; } = new MigrationState(FailedValue);
        /// <summary> Succeeded. </summary>
        public static MigrationState Succeeded { get; } = new MigrationState(SucceededValue);
