...
namespace Azure.ResourceManager.PostgreSql.FlexibleServers.Models
{
    ...
    public partial class BackupsLongTermRetentionContent : PostgreSqlBackupContent
    {
        /// <summary> Initializes a new instance of <see cref="BackupsLongTermRetentionContent"/>. </summary>
        ...
        public BackupsLongTermRetentionContent(PostgreSqlFlexibleServerBackupSettings backupSettings, PostgreSqlFlexibleServerBackupStoreDetails targetDetails) : base(backupSettings)
        {
        ...
        /// <param name="targetDetails"> Backup store detail for target server. </param>
        internal BackupsLongTermRetentionContent(PostgreSqlFlexibleServerBackupSettings backupSettings, IDictionary<string, BinaryData> serializedAdditionalRawData, PostgreSqlFlexibleServerBackupStoreDetails targetDetails) : base(backupSettings, serializedAdditionalRawData)
        {
            TargetDetails = targetDetails;
        }

        /// <summary> Initializes a new instance of <see cref="BackupsLongTermRetentionContent"/> for deserialization. </summary>
        internal BackupsLongTermRetentionContent()
        {
        }
