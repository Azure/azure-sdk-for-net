...
namespace Azure.ResourceManager.PostgreSql.FlexibleServers
{
    internal class PostgreSqlFlexibleServerActiveDirectoryAdministratorOperationSource : IOperationSource<PostgreSqlFlexibleServerActiveDirectoryAdministratorResource>
    {
        ...
        {
            var data = ModelReaderWriter.Read<PostgreSqlFlexibleServerActiveDirectoryAdministratorData>(response.Content, ModelReaderWriterOptions.Json, PostgreSql.AzureResourceManagerPostgreSqlContext.Default);
