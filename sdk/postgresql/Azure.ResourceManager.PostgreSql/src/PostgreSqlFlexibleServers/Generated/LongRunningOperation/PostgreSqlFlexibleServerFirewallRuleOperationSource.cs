...
namespace Azure.ResourceManager.PostgreSql.FlexibleServers
{
    internal class PostgreSqlFlexibleServerFirewallRuleOperationSource : IOperationSource<PostgreSqlFlexibleServerFirewallRuleResource>
    {
        ...
        {
            var data = ModelReaderWriter.Read<PostgreSqlFlexibleServerFirewallRuleData>(response.Content, ModelReaderWriterOptions.Json, PostgreSql.AzureResourceManagerPostgreSqlContext.Default);
