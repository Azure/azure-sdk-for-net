...
namespace Azure.ResourceManager.PostgreSql.FlexibleServers
{
    internal class PostgreSqlFlexibleServerConfigurationOperationSource : IOperationSource<PostgreSqlFlexibleServerConfigurationResource>
    {
        ...
        {
            var data = ModelReaderWriter.Read<PostgreSqlFlexibleServerConfigurationData>(response.Content, ModelReaderWriterOptions.Json, PostgreSql.AzureResourceManagerPostgreSqlContext.Default);
