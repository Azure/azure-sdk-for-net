...
namespace Azure.ResourceManager.PostgreSql.FlexibleServers
{
    internal class PostgreSqlFlexibleServersPrivateEndpointConnectionOperationSource : IOperationSource<PostgreSqlFlexibleServersPrivateEndpointConnectionResource>
    {
        ...
        {
            var data = ModelReaderWriter.Read<PostgreSqlFlexibleServersPrivateEndpointConnectionData>(response.Content, ModelReaderWriterOptions.Json, PostgreSql.AzureResourceManagerPostgreSqlContext.Default);
