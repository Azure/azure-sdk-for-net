...
namespace Azure.ResourceManager.PostgreSql.FlexibleServers
{
    internal class PostgreSqlFlexibleServerBackupOperationSource : IOperationSource<PostgreSqlFlexibleServerBackupResource>
    {
        ...
        {
            var data = ModelReaderWriter.Read<PostgreSqlFlexibleServerBackupData>(response.Content, ModelReaderWriterOptions.Json, PostgreSql.AzureResourceManagerPostgreSqlContext.Default);
