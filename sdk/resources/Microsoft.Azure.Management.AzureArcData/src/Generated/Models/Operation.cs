...
namespace Microsoft.Azure.Management.AzureArcData.Models
{
    ...
    public partial class Operation
    {
        ...
        /// operation.</param>
        public Operation(string name, OperationDisplay display, bool isDataAction, string origin = default(string), IDictionary<string, object> properties = default(IDictionary<string, object>))
        {
            Name = name;
            Display = display;
            Origin = origin;
