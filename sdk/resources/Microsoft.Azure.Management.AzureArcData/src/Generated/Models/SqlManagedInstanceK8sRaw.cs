...
namespace Microsoft.Azure.Management.AzureArcData.Models
{
    ...
    public partial class SqlManagedInstanceK8sRaw
    {
        ...
        public SqlManagedInstanceK8sRaw(IDictionary<string, object> additionalProperties = default(IDictionary<string, object>), SqlManagedInstanceK8sSpec spec = default(SqlManagedInstanceK8sSpec))
        {
