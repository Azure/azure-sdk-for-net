...
namespace Microsoft.Azure.Management.AzureArcData.Models
{
    ...
    public partial class SqlServerInstance : TrackedResource
    {
        ...
        public SqlServerInstance(string location, string id = default(string), string name = default(string), string type = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), SystemData systemData = default(SystemData), SqlServerInstanceProperties properties = default(SqlServerInstanceProperties))
