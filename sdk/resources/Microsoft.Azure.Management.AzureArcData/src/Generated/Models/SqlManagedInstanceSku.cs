...
namespace Microsoft.Azure.Management.AzureArcData.Models
{
    ...
    /// Instance - Azure Arc
    /// </summary>
    public partial class SqlManagedInstanceSku : CommonSku
    {
        /// <summary>
        ...
        public SqlManagedInstanceSku(string name, bool? dev = default(bool?), string size = default(string), string family = default(string), int? capacity = default(int?), SqlManagedInstanceSkuTier? tier = default(SqlManagedInstanceSkuTier?))
