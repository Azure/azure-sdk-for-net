...
namespace Microsoft.Azure.Management.AzureArcData
{
    ...
    public static partial class DataControllersOperationsExtensions
    {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<DataControllerResource> BeginPutDataControllerAsync(this IDataControllersOperations operations, string resourceGroupName, DataControllerResource dataControllerResource, string dataControllerName, CancellationToken cancellationToken = default(CancellationToken))
            {
