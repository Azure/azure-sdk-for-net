...
namespace Azure.ResourceManager.Resources.Policy
{
    ...
    public partial class PolicyDefinitionVersionData : ResourceData, IJsonModel<PolicyDefinitionVersionData>
    {
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(PolicyDefinitionVersionData)} does not support writing '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        PolicyDefinitionVersionData IJsonModel<PolicyDefinitionVersionData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (PolicyDefinitionVersionData)JsonModelCreateCore(ref reader, options);
        ...
        protected virtual ResourceData JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(PolicyDefinitionVersionData)} does not support reading '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static PolicyDefinitionVersionData DeserializePolicyDefinitionVersionData(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            PolicyDefinitionVersionProperties properties = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = PolicyDefinitionVersionProperties.DeserializePolicyDefinitionVersionProperties(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
