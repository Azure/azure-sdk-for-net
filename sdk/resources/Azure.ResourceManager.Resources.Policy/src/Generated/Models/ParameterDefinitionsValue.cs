...
namespace Azure.ResourceManager.Resources.Policy.Models
{
    ...
    public partial class ParameterDefinitionsValue
    {
        ...
        internal ParameterDefinitionsValue(ParameterType? @type, IList<BinaryData> allowedValues, BinaryData defaultValue, BinaryData schema, ParameterDefinitionsValueMetadata metadata, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Type = @type;
