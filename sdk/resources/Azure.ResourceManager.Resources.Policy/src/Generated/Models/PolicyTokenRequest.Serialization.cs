...
namespace Azure.ResourceManager.Resources.Policy.Models
{
    ...
    public partial class PolicyTokenRequest : IJsonModel<PolicyTokenRequest>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<PolicyTokenRequest>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        PolicyTokenRequest IJsonModel<PolicyTokenRequest>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual PolicyTokenRequest JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<PolicyTokenRequest>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static PolicyTokenRequest DeserializePolicyTokenRequest(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    operation = PolicyTokenOperation.DeserializePolicyTokenOperation(prop.Value, options);
                    continue;
                }
            ...
            return new PolicyTokenRequest(operation, changeReference, additionalBinaryDataProperties);
        }

        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<PolicyTokenRequest>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        PolicyTokenRequest IPersistableModel<PolicyTokenRequest>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual PolicyTokenRequest PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<PolicyTokenRequest>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
        ...
        /// <param name="policyTokenRequest"> The <see cref="PolicyTokenRequest"/> to serialize into <see cref="RequestContent"/>. </param>
        internal static RequestContent ToRequestContent(PolicyTokenRequest policyTokenRequest)
        {
            if (policyTokenRequest == null)
            {
                return null;
            }
