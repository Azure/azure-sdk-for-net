...
namespace Azure.ResourceManager.Resources.Policy.Models
{
    ...
    internal partial class PolicyDefinitionListResult
    {
        ...
        internal PolicyDefinitionListResult(IList<PolicyDefinitionData> value, Uri nextLink, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            NextLink = nextLink;
        ...
        public IList<PolicyDefinitionData> Value { get; }
