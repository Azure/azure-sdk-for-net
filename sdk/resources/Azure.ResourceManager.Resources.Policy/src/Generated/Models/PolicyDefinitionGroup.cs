...
namespace Azure.ResourceManager.Resources.Policy.Models
{
    ...
    public partial class PolicyDefinitionGroup
    {
        ...
        internal PolicyDefinitionGroup(string name, string displayName, string category, string description, string additionalMetadataId, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Name = name;
