    ...
    public partial class MockableResourcesPolicySubscriptionResource : ArmResource
    {
        ...
        public virtual AsyncPageable<PolicyAssignmentResource> GetPolicyAssignmentsAsync(string filter = default, string expand = default, int? top = default, CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<PolicyAssignmentData, PolicyAssignmentResource>(new PolicyAssignmentsGetAllAsyncCollectionResultOfT(
                ...
                top,
                context,
                "MockableResourcesPolicySubscriptionResource.GetPolicyAssignments"), data => new PolicyAssignmentResource(Client, data));
        }
        ...
        {
            using DiagnosticScope scope = PolicyDefinitionVersionsClientDiagnostics.CreateScope("MockableResourcesPolicySubscriptionResource.GetAll");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = PolicyDefinitionVersionsRestClient.CreateGetAllRequest(Guid.Parse(Id.SubscriptionId), context);
        ...
        {
            using DiagnosticScope scope = PolicySetDefinitionVersionsClientDiagnostics.CreateScope("MockableResourcesPolicySubscriptionResource.GetAll");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = PolicySetDefinitionVersionsRestClient.CreateGetAllRequest(Guid.Parse(Id.SubscriptionId), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
