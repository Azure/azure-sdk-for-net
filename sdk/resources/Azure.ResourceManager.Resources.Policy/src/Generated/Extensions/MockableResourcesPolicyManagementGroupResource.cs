...
namespace Azure.ResourceManager.Resources.Policy.Mocking
{
    ...
    public partial class MockableResourcesPolicyManagementGroupResource : ArmResource
    {
        ...
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /providers/Microsoft.Management/managementGroups/{managementGroupId}/providers/Microsoft.Authorization/policyEnrollments. </description>
        /// </item>
        /// <item>
        /// <term> Operation Id. </term>
        /// <description> PolicyEnrollments_ListForManagementGroup. </description>
        /// </item>
        /// <item>
        /// <term> Default Api Version. </term>
        /// <description> 2026-01-01-preview. </description>
        ...
        public virtual AsyncPageable<PolicyEnrollmentResource> GetPolicyEnrollmentsAsync(string filter = default, CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<PolicyEnrollmentData, PolicyEnrollmentResource>(new PolicyEnrollmentsGetForManagementGroupAsyncCollectionResultOfT(PolicyEnrollmentsRestClient, Id.Name, filter, context, "MockableResourcesPolicyManagementGroupResource.GetPolicyEnrollments"), data => new PolicyEnrollmentResource(Client, data));
        }
        ...
        public virtual Pageable<PolicyEnrollmentResource> GetPolicyEnrollments(string filter = default, CancellationToken cancellationToken = default)
        {
            ...
            return new PageableWrapper<PolicyEnrollmentData, PolicyEnrollmentResource>(new PolicyEnrollmentsGetForManagementGroupCollectionResultOfT(PolicyEnrollmentsRestClient, Id.Name, filter, context, "MockableResourcesPolicyManagementGroupResource.GetPolicyEnrollments"), data => new PolicyEnrollmentResource(Client, data));
        }
