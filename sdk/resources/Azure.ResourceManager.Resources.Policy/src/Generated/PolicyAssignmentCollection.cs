...
namespace Azure.ResourceManager.Resources.Policy
{
    ...
    public partial class PolicyAssignmentCollection : ArmCollection
    {
        ...
        internal PolicyAssignmentCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _policyAssignmentsRestClient = new PolicyAssignments(_policyAssignmentsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, policyAssignmentApiVersion ?? "2026-07-01");
        }
