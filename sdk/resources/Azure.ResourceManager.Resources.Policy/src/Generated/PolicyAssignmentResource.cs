    ...
    public partial class PolicyAssignmentResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<PolicyAssignmentResource>> UpdateAsync(WaitUntil waitUntil, PolicyAssignmentData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _policyAssignmentsRestClient.CreateCreateRequest(Id.Parent.ToString(), Id.Name, PolicyAssignmentData.ToRequestContent(data), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<PolicyAssignmentData> response = Response.FromValue(PolicyAssignmentData.FromResponse(result), result);
                RequestUriBuilder uri = message.Request.Uri;
