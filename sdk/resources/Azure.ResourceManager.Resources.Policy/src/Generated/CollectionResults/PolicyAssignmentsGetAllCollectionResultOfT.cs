...
namespace Azure.ResourceManager.Resources.Policy
{
    internal partial class PolicyAssignmentsGetAllCollectionResultOfT : Pageable<PolicyAssignmentData>
    {
        ...
        public PolicyAssignmentsGetAllCollectionResultOfT(PolicyAssignments client, Guid subscriptionId, string filter, string expand, int? top, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
