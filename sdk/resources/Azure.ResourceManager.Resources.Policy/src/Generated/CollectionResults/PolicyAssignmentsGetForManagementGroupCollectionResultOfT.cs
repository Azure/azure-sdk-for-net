...
namespace Azure.ResourceManager.Resources.Policy
{
    internal partial class PolicyAssignmentsGetForManagementGroupCollectionResultOfT : Pageable<PolicyAssignmentData>
    {
        ...
        public PolicyAssignmentsGetForManagementGroupCollectionResultOfT(PolicyAssignments client, string managementGroupId, string filter, string expand, int? top, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
