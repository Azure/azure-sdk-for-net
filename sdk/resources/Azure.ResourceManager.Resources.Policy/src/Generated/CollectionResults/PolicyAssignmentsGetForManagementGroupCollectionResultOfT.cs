...
{
    internal partial class PolicyAssignmentsGetForManagementGroupCollectionResultOfT : Pageable<PolicyAssignmentData>
    {
        ...
        /// <summary> Initializes a new instance of PolicyAssignmentsGetForManagementGroupCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public PolicyAssignmentsGetForManagementGroupCollectionResultOfT(PolicyAssignments client, string managementGroupId, string filter, string expand, int? top, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of PolicyAssignmentsGetForManagementGroupCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of PolicyAssignmentsGetForManagementGroupCollectionResultOfT as an enumerable collection. </returns>
