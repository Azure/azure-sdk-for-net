...
{
    internal partial class PolicyAssignmentsGetAllAsyncCollectionResultOfT : AsyncPageable<PolicyAssignmentData>
    {
        ...
        /// <summary> Initializes a new instance of PolicyAssignmentsGetAllAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public PolicyAssignmentsGetAllAsyncCollectionResultOfT(PolicyAssignments client, Guid subscriptionId, string filter, string expand, int? top, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of PolicyAssignmentsGetAllAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of PolicyAssignmentsGetAllAsyncCollectionResultOfT as an enumerable collection. </returns>
