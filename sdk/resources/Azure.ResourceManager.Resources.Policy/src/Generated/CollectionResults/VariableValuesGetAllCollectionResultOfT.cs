...
{
    internal partial class VariableValuesGetAllCollectionResultOfT : Pageable<VariableValueData>
    {
        private readonly VariableValues _client;
        ...
        /// <returns> The pages of VariableValuesGetAllCollectionResultOfT as an enumerable collection. </returns>
        public override IEnumerable<Page<VariableValueData>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                VariableValueListResult result = VariableValueListResult.FromResponse(response);
                yield return Page<VariableValueData>.FromValues((IReadOnlyList<VariableValueData>)result.Value, nextPage?.IsAbsoluteUri == true ? nextPage.AbsoluteUri : nextPage?.OriginalString, response);
