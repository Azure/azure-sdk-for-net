...
namespace Azure.ResourceManager.Resources.Policy
{
    internal partial class PolicyExemptionsGetForResourceCollectionResultOfT : Pageable<PolicyExemptionData>
    {
        ...
        public PolicyExemptionsGetForResourceCollectionResultOfT(PolicyExemptions client, Guid subscriptionId, string resourceGroupName, string resourceProviderNamespace, string parentResourcePath, string resourceType, string resourceName, string filter, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
