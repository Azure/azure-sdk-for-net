...
{
    internal partial class PolicyArmOperation<T> : ArmOperation<T>
    {
        ...
        internal PolicyArmOperation(Response<T> response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal PolicyArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
