...
{
    internal partial class PolicyArmOperation : ArmOperation
    {
        ...
        /// <summary> Initializes a new instance of PolicyArmOperation for mocking. </summary>
        protected PolicyArmOperation()
        {
        }
        ...
        internal PolicyArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal PolicyArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
