...
namespace Azure.ResourceManager.Resources.Policy
{
    internal partial class PolicyArmOperation : ArmOperation
    {
        ...
        internal PolicyArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
