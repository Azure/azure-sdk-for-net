...
namespace Azure.ResourceManager.Resources.Policy
{
    ...
    public partial class PolicySetDefinitionVersionCollection : ArmCollection, IEnumerable<PolicySetDefinitionVersionResource>, IAsyncEnumerable<PolicySetDefinitionVersionResource>
    {
        ...
        internal PolicySetDefinitionVersionCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _policySetDefinitionVersionsRestClient = new PolicySetDefinitionVersions(_policySetDefinitionVersionsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, policySetDefinitionVersionApiVersion ?? "2026-01-01-preview");
        ...
        internal static void ValidateResourceId(ResourceIdentifier id)
        {
            ...
            {
                throw new ArgumentException(string.Format("Invalid resource type {0} expected {1}", id.ResourceType, PolicySetDefinitionResource.ResourceType), nameof(id));
            }
        }
