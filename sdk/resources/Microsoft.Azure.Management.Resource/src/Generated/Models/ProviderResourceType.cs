...
namespace Microsoft.Azure.Management.ResourceManager.Models
{
    ...
    public partial class ProviderResourceType
    {
        ...
        public ProviderResourceType(string resourceType = default(string), IList<string> locations = default(IList<string>), IList<AliasType1> aliases = default(IList<AliasType1>), IList<string> apiVersions = default(IList<string>), string capabilities = default(string), IDictionary<string, string> properties = default(IDictionary<string, string>))
        {
        ...
        public IList<AliasType1> Aliases { get; set; }
