...
namespace Microsoft.Azure.Management.ResourceManager.Models
{
    ...
    public partial class DeploymentScript : AzureResourceBase
    {
        ...
        /// resource.</param>
        public DeploymentScript(ManagedServiceIdentity identity, string location, string id = default(string), string name = default(string), string type = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), SystemData systemData = default(SystemData))
            : base(id, name, type)
        {
            Identity = identity;
            Location = location;
