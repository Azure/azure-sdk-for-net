...
namespace Microsoft.Azure.Management.ResourceManager
{
    ...
    public static partial class PolicyDefinitionsOperationsExtensions
    {
            ...
            /// </param>
            public static PolicyDefinition CreateOrUpdate(this IPolicyDefinitionsOperations operations, string policyDefinitionName, PolicyDefinition parameters, string subscriptionId)
            {
                return operations.CreateOrUpdateAsync(policyDefinitionName, parameters, subscriptionId).GetAwaiter().GetResult();
            }
            ...
            /// </param>
            public static async Task<PolicyDefinition> CreateOrUpdateAsync(this IPolicyDefinitionsOperations operations, string policyDefinitionName, PolicyDefinition parameters, string subscriptionId, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.CreateOrUpdateWithHttpMessagesAsync(policyDefinitionName, parameters, subscriptionId, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
            ...
            /// The ID of the target subscription.
            /// </param>
            public static void Delete(this IPolicyDefinitionsOperations operations, string policyDefinitionName, string subscriptionId)
            {
                operations.DeleteAsync(policyDefinitionName, subscriptionId).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task DeleteAsync(this IPolicyDefinitionsOperations operations, string policyDefinitionName, string subscriptionId, CancellationToken cancellationToken = default(CancellationToken))
            {
                (await operations.DeleteWithHttpMessagesAsync(policyDefinitionName, subscriptionId, null, cancellationToken).ConfigureAwait(false)).Dispose();
            }
            ...
            /// The ID of the target subscription.
            /// </param>
            public static PolicyDefinition Get(this IPolicyDefinitionsOperations operations, string policyDefinitionName, string subscriptionId)
            {
                return operations.GetAsync(policyDefinitionName, subscriptionId).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<PolicyDefinition> GetAsync(this IPolicyDefinitionsOperations operations, string policyDefinitionName, string subscriptionId, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.GetWithHttpMessagesAsync(policyDefinitionName, subscriptionId, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
            ...
            /// </param>
            public static IPage<PolicyDefinition> List(this IPolicyDefinitionsOperations operations, string subscriptionId, string filter = default(string), int? top = default(int?))
            {
                return operations.ListAsync(subscriptionId, filter, top).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<IPage<PolicyDefinition>> ListAsync(this IPolicyDefinitionsOperations operations, string subscriptionId, string filter = default(string), int? top = default(int?), CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.ListWithHttpMessagesAsync(subscriptionId, filter, top, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<IPage<PolicyDefinition>> ListByManagementGroupAsync(this IPolicyDefinitionsOperations operations, string managementGroupId, string filter = default(string), int? top = default(int?), CancellationToken cancellationToken = default(CancellationToken))
            {
