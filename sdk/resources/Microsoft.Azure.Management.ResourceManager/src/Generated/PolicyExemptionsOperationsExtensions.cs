...
namespace Microsoft.Azure.Management.ResourceManager
{
    ...
    public static partial class PolicyExemptionsOperationsExtensions
    {
            ...
            /// The name of the policy exemption to delete.
            /// </param>
            public static PolicyExemption CreateOrUpdate(this IPolicyExemptionsOperations operations, PolicyExemption parameters, string scope, string policyExemptionName)
            {
                return operations.CreateOrUpdateAsync(parameters, scope, policyExemptionName).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<PolicyExemption> CreateOrUpdateAsync(this IPolicyExemptionsOperations operations, PolicyExemption parameters, string scope, string policyExemptionName, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.CreateOrUpdateWithHttpMessagesAsync(parameters, scope, policyExemptionName, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
            ...
            /// </param>
            public static IPage<PolicyExemption> List(this IPolicyExemptionsOperations operations, string subscriptionId, string filter = default(string))
            {
                return operations.ListAsync(subscriptionId, filter).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<IPage<PolicyExemption>> ListAsync(this IPolicyExemptionsOperations operations, string subscriptionId, string filter = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.ListWithHttpMessagesAsync(subscriptionId, filter, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
            ...
            /// with the give policyAssignmentId.
            /// </param>
            public static IPage<PolicyExemption> ListForResourceGroup(this IPolicyExemptionsOperations operations, string subscriptionId, string resourceGroupName, string filter = default(string))
            {
                return operations.ListForResourceGroupAsync(subscriptionId, resourceGroupName, filter).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<IPage<PolicyExemption>> ListForResourceGroupAsync(this IPolicyExemptionsOperations operations, string subscriptionId, string resourceGroupName, string filter = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.ListForResourceGroupWithHttpMessagesAsync(subscriptionId, resourceGroupName, filter, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
            ...
            /// with the give policyAssignmentId.
            /// </param>
            public static IPage<PolicyExemption> ListForResource(this IPolicyExemptionsOperations operations, string subscriptionId, string resourceGroupName, string resourceProviderNamespace, string parentResourcePath, string resourceType, string resourceName, string filter = default(string))
            {
                return operations.ListForResourceAsync(subscriptionId, resourceGroupName, resourceProviderNamespace, parentResourcePath, resourceType, resourceName, filter).GetAwaiter().GetResult();
            }
            ...
            {
                using (var _result = await operations.ListForResourceWithHttpMessagesAsync(subscriptionId, resourceGroupName, resourceProviderNamespace, parentResourcePath, resourceType, resourceName, filter, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
