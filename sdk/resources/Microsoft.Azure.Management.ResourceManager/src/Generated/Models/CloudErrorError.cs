...
namespace Microsoft.Azure.Management.ResourceManager.Models
{
    ...
    public partial class CloudErrorError
    {
        ...
        public CloudErrorError(string code = default(string), string message = default(string), string target = default(string), IList<CloudError> details = default(IList<CloudError>), IList<ErrorAdditionalInfo> additionalInfo = default(IList<ErrorAdditionalInfo>))
        {
            Code = code;
            Message = message;
            Target = target;
