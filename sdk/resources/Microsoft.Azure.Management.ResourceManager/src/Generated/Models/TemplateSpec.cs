...
namespace Microsoft.Azure.Management.ResourceManager.Models
{
    ...
    public partial class TemplateSpec : AzureResourceBase
    {
        ...
        public TemplateSpec(string location, string id = default(string), string name = default(string), string type = default(string), SystemData systemData = default(SystemData), string description = default(string), string displayName = default(string), IDictionary<string, TemplateSpecVersionInfo> versions = default(IDictionary<string, TemplateSpecVersionInfo>), IDictionary<string, string> tags = default(IDictionary<string, string>))
