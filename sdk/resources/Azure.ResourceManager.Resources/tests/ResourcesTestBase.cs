...
namespace Azure.ResourceManager.Resources.Tests
{
    public class ResourcesTestBase : ManagementRecordedTestBase<ResourcesTestEnvironment>
    {
        ...
        protected async Task<DeploymentScriptData> GetDeploymentScriptDataAsync()
        {
            ...
            var lro = await subscription.GetResourceGroups().CreateOrUpdateAsync(rgName4Identities, rgData);
            ...
            var lro2 = await subscription.GetGenericResources().CreateOrUpdateAsync(userAssignedIdentitiesId, userAssignedIdentitiesData);
