...
namespace Azure.ResourceManager.Resources
{
    ...
    public partial class JitRequestDefinition : ArmResource
    {
        ...
        public async virtual Task<Response<JitRequestDefinition>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _jitRequestsRestClient.GetAsync(Id.ResourceGroupName, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<JitRequestDefinition> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _jitRequestsRestClient.Get(Id.ResourceGroupName, Id.Name, cancellationToken);
                if (response.Value == null)
        ...
        public async virtual Task<JitRequestDeleteOperation> DeleteAsync(bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _jitRequestsRestClient.DeleteAsync(Id.ResourceGroupName, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual JitRequestDeleteOperation Delete(bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _jitRequestsRestClient.Delete(Id.ResourceGroupName, Id.Name, cancellationToken);
                var operation = new JitRequestDeleteOperation(response);
                if (waitForCompletion)
        ...
        public async virtual Task<Response<JitRequestDefinition>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var originalResponse = await _jitRequestsRestClient.GetAsync(Id.ResourceGroupName, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<JitRequestDefinition> AddTag(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var originalResponse = _jitRequestsRestClient.Get(Id.ResourceGroupName, Id.Name, cancellationToken);
                return Response.FromValue(new JitRequestDefinition(this, originalResponse.Value), originalResponse.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        public async virtual Task<Response<JitRequestDefinition>> UpdateAsync(IDictionary<string, string> tags = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _jitRequestsRestClient.UpdateAsync(Id.ResourceGroupName, Id.Name, tags, cancellationToken).ConfigureAwait(false);
                return Response.FromValue(new JitRequestDefinition(this, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        public virtual Response<JitRequestDefinition> Update(IDictionary<string, string> tags = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _jitRequestsRestClient.Update(Id.ResourceGroupName, Id.Name, tags, cancellationToken);
                return Response.FromValue(new JitRequestDefinition(this, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
