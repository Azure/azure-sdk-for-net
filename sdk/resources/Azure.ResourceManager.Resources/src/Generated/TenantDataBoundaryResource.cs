...
namespace Azure.ResourceManager.Resources
{
    ...
    public partial class TenantDataBoundaryResource : ArmResource
    {
        ...
        public static ResourceIdentifier CreateResourceIdentifier(DefaultName @default)
        {
            var resourceId = $"/providers/Microsoft.Resources/dataBoundaries/{@default}";
        ...
        internal TenantDataBoundaryResource(ArmClient client, DataBoundaryDefinitionData data) : this(client, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<ArmOperation<TenantDataBoundaryResource>> UpdateAsync(WaitUntil waitUntil, DataBoundaryDefinitionData data, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        public virtual ArmOperation<TenantDataBoundaryResource> Update(WaitUntil waitUntil, DataBoundaryDefinitionData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
