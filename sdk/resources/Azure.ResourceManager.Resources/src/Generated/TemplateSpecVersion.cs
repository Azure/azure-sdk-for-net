...
namespace Azure.ResourceManager.Resources
{
    ...
    public partial class TemplateSpecVersion : ArmResource
    {
        ...
        internal TemplateSpecVersion(ArmResource options, TemplateSpecVersionData resource) : base(options, resource.Id)
        {
            HasData = true;
            _data = resource;
        ...
        public async virtual Task<Response<TemplateSpecVersion>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _templateSpecVersionsRestClient.GetAsync(Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<TemplateSpecVersion> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _templateSpecVersionsRestClient.Get(Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                if (response.Value == null)
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async virtual Task<TemplateSpecVersionDeleteOperation> DeleteAsync(bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("TemplateSpecVersion.Delete");
            scope.Start();
            try
            {
                var response = await _templateSpecVersionsRestClient.DeleteAsync(Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="waitForCompletion"> Waits for the completion of the long running operations. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual TemplateSpecVersionDeleteOperation Delete(bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("TemplateSpecVersion.Delete");
            scope.Start();
            try
            {
                var response = _templateSpecVersionsRestClient.Delete(Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                var operation = new TemplateSpecVersionDeleteOperation(response);
                if (waitForCompletion)
        ...
        public async virtual Task<Response<TemplateSpecVersion>> UpdateAsync(IDictionary<string, string> tags = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _templateSpecVersionsRestClient.UpdateAsync(Id.ResourceGroupName, Id.Parent.Name, Id.Name, tags, cancellationToken).ConfigureAwait(false);
                return Response.FromValue(new TemplateSpecVersion(this, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        public virtual Response<TemplateSpecVersion> Update(IDictionary<string, string> tags = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _templateSpecVersionsRestClient.Update(Id.ResourceGroupName, Id.Parent.Name, Id.Name, tags, cancellationToken);
                return Response.FromValue(new TemplateSpecVersion(this, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
