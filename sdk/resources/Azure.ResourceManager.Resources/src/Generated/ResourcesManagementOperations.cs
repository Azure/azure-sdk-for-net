...
{
    /// <summary> The ResourcesManagement service client. </summary>
    public partial class ResourcesManagementOperations
    {
        private readonly ClientDiagnostics _clientDiagnostics;
        private readonly HttpPipeline _pipeline;
        internal ResourcesManagementRestOperations RestClient { get; }
        /// <summary> Initializes a new instance of ResourcesManagementOperations for mocking. </summary>
        protected ResourcesManagementOperations()
        {
        }
        /// <summary> Initializes a new instance of ResourcesManagementOperations. </summary>
        /// <param name="clientDiagnostics"> The handler for diagnostic messaging in the client. </param>
        /// <param name="pipeline"> The HTTP pipeline for sending and receiving REST requests and responses. </param>
        /// <param name="endpoint"> server parameter. </param>
        internal ResourcesManagementOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Uri endpoint = null)
        {
            RestClient = new ResourcesManagementRestOperations(clientDiagnostics, pipeline, endpoint);
        ...
        public virtual AsyncPageable<OperationAutoGenerated> ListOperationsAsync(CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("ResourcesManagementOperations.ListOperations");
                scope.Start();
                try
                {
