...
namespace Azure.ResourceManager.Resources.Models
{
    ...
    public partial class DeploymentsWhatIfAtTenantScopeOperation : Operation<WhatIfOperationResult>, IOperationSource<WhatIfOperationResult>
    {
        private readonly OperationInternals<WhatIfOperationResult> _operation;

        /// <summary> Initializes a new instance of DeploymentsWhatIfAtTenantScopeOperation for mocking. </summary>
        protected DeploymentsWhatIfAtTenantScopeOperation()
        {
        }

        internal DeploymentsWhatIfAtTenantScopeOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<WhatIfOperationResult>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "DeploymentsWhatIfAtTenantScopeOperation");
        }
