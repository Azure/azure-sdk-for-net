...
namespace Azure.ResourceManager.Resources.Models
{
    ...
    public partial class DeploymentWhatIfOperation : Operation<WhatIfOperationResult>, IOperationSource<WhatIfOperationResult>
    {
        ...
        /// <summary> Initializes a new instance of DeploymentWhatIfOperation for mocking. </summary>
        protected DeploymentWhatIfOperation()
        {
        }

        internal DeploymentWhatIfOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<WhatIfOperationResult>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "DeploymentWhatIfOperation");
        }
