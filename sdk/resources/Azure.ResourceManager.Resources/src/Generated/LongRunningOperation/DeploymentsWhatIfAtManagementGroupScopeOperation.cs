...
namespace Azure.ResourceManager.Resources.Models
{
    ...
    public partial class DeploymentsWhatIfAtManagementGroupScopeOperation : Operation<WhatIfOperationResult>, IOperationSource<WhatIfOperationResult>
    {
        private readonly OperationInternals<WhatIfOperationResult> _operation;

        /// <summary> Initializes a new instance of DeploymentsWhatIfAtManagementGroupScopeOperation for mocking. </summary>
        protected DeploymentsWhatIfAtManagementGroupScopeOperation()
        {
        }

        internal DeploymentsWhatIfAtManagementGroupScopeOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<WhatIfOperationResult>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "DeploymentsWhatIfAtManagementGroupScopeOperation");
        }
