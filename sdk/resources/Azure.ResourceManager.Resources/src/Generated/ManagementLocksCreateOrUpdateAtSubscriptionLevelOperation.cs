...
namespace Azure.ResourceManager.Resources
{
    ...
    public partial class ManagementLocksCreateOrUpdateAtSubscriptionLevelOperation : Operation<ManagementLockObject>
    {
        private readonly OperationOrResponseInternals<ManagementLockObject> _operation;

        /// <summary> Initializes a new instance of ManagementLocksCreateOrUpdateAtSubscriptionLevelOperation for mocking. </summary>
        protected ManagementLocksCreateOrUpdateAtSubscriptionLevelOperation()
        {
        }

        internal ManagementLocksCreateOrUpdateAtSubscriptionLevelOperation(ResourceOperationsBase operationsBase, Response<ManagementLockObjectData> response)
        {
