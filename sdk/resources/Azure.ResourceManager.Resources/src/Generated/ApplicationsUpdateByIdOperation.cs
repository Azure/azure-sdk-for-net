...
namespace Azure.ResourceManager.Resources
{
    ...
    public partial class ApplicationsUpdateByIdOperation : Operation<Application>
    {
        private readonly OperationOrResponseInternals<Application> _operation;

        /// <summary> Initializes a new instance of ApplicationsUpdateByIdOperation for mocking. </summary>
        protected ApplicationsUpdateByIdOperation()
        {
        }

        internal ApplicationsUpdateByIdOperation(ResourceOperationsBase operationsBase, Response<ApplicationData> response)
        {
