...
namespace Azure.ResourceManager.Resources
{
    ...
    public partial class ScriptLogResource : ArmResource
    {
        ...
        internal ScriptLogResource(ArmClient client, ScriptLogData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<ScriptLogResource>> GetAsync(int? tail = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new ScriptLogResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
