...
namespace Azure.ResourceManager.Resources.Testing
{
    ...
    public partial class ResourcesTenantResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="ResourcesTenantResourceExtension"/> class for mocking. </summary>
        protected ResourcesTenantResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ResourcesTenantResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ResourcesTenantResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual async Task<Response<TemplateHashResult>> CalculateDeploymentTemplateHashAsync(BinaryData template, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = ArmDeploymentDeploymentsClientDiagnostics.CreateScope("ResourcesTenantResourceExtension.CalculateDeploymentTemplateHash");
            scope.Start();
            try
            {
