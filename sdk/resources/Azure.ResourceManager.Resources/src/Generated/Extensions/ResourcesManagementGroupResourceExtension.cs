...
namespace Azure.ResourceManager.Resources.Mock
{
    ...
    public partial class ResourcesManagementGroupResourceExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="ResourcesManagementGroupResourceExtension"/> class for mocking. </summary>
        protected ResourcesManagementGroupResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ResourcesManagementGroupResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ResourcesManagementGroupResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
