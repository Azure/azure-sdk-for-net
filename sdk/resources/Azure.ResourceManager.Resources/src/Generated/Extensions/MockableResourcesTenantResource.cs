...
namespace Azure.ResourceManager.Resources.Mocking
{
    ...
    public partial class MockableResourcesTenantResource : ArmResource
    {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public virtual async Task<Response<TenantDataBoundaryResource>> GetTenantDataBoundaryAsync(DefaultName @default, CancellationToken cancellationToken = default)
        {
            return await GetTenantDataBoundaries().GetAsync(@default, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public virtual Response<TenantDataBoundaryResource> GetTenantDataBoundary(DefaultName @default, CancellationToken cancellationToken = default)
        {
            return GetTenantDataBoundaries().Get(@default, cancellationToken);
        }
