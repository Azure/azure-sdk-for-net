...
namespace Azure.ResourceManager.Resources.Mocking
{
    ...
    internal partial class ResourcesResourceGroupMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="ResourcesResourceGroupMockingExtension"/> class for mocking. </summary>
        protected ResourcesResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ResourcesResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ResourcesResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
