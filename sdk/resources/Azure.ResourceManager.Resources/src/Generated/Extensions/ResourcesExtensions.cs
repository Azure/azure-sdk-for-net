...
namespace Azure.ResourceManager.Resources
{
    ...
    public static partial class ResourcesExtensions
    {
        ...
        {
            return GetResourcesSubscriptionResourceExtension(subscriptionResource).GetArmApplicationsAsync(cancellationToken);
        }
        ...
        {
            return GetResourcesSubscriptionResourceExtension(subscriptionResource).GetArmApplications(cancellationToken);
        }
        ...
        {
            return GetResourcesSubscriptionResourceExtension(subscriptionResource).GetJitRequestDefinitionsAsync(cancellationToken);
        }
        ...
        {
            return GetResourcesSubscriptionResourceExtension(subscriptionResource).GetJitRequestDefinitions(cancellationToken);
        }
        ...
        {
            return GetResourcesSubscriptionResourceExtension(subscriptionResource).GetArmDeploymentScriptsAsync(cancellationToken);
        }
        ...
        {
            return GetResourcesSubscriptionResourceExtension(subscriptionResource).GetArmDeploymentScripts(cancellationToken);
        }
        ...
        {
            return GetResourcesSubscriptionResourceExtension(subscriptionResource).GetTemplateSpecsAsync(expand, cancellationToken);
        }
        ...
        {
            return GetResourcesSubscriptionResourceExtension(subscriptionResource).GetTemplateSpecs(expand, cancellationToken);
        }
        ...
        public static async Task<Response<TemplateHashResult>> CalculateDeploymentTemplateHashAsync(this TenantResource tenantResource, BinaryData template, CancellationToken cancellationToken = default)
        {
            ...
            return await GetResourcesTenantResourceExtension(tenantResource).CalculateDeploymentTemplateHashAsync(template, cancellationToken).ConfigureAwait(false);
        }
        ...
        public static Response<TemplateHashResult> CalculateDeploymentTemplateHash(this TenantResource tenantResource, BinaryData template, CancellationToken cancellationToken = default)
        {
            ...
            return GetResourcesTenantResourceExtension(tenantResource).CalculateDeploymentTemplateHash(template, cancellationToken);
        }
    }
}
