...
namespace Azure.ResourceManager.Resources.Mocking
{
    ...
    internal partial class ResourcesArmClientMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="ResourcesArmClientMockingExtension"/> class for mocking. </summary>
        protected ResourcesArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ResourcesArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ResourcesArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal ResourcesArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
