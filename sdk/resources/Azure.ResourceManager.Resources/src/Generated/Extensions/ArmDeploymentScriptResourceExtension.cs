...
namespace Azure.ResourceManager.Resources.Mock
{
    ...
    public partial class ArmDeploymentScriptResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="ArmDeploymentScriptResourceExtension"/> class for mocking. </summary>
        protected ArmDeploymentScriptResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ArmDeploymentScriptResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ArmDeploymentScriptResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<ArmDeploymentScriptResource> GetArmDeploymentScriptsAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new ArmDeploymentScriptResource(Client, ArmDeploymentScriptData.DeserializeArmDeploymentScriptData(e)), ArmDeploymentScriptDeploymentScriptsClientDiagnostics, Pipeline, "ArmDeploymentScriptResourceExtension.GetArmDeploymentScripts", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<ArmDeploymentScriptResource> GetArmDeploymentScripts(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => ArmDeploymentScriptDeploymentScriptsRestClient.CreateListBySubscriptionRequest(Id.SubscriptionId);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => ArmDeploymentScriptDeploymentScriptsRestClient.CreateListBySubscriptionNextPageRequest(nextLink, Id.SubscriptionId);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new ArmDeploymentScriptResource(Client, ArmDeploymentScriptData.DeserializeArmDeploymentScriptData(e)), ArmDeploymentScriptDeploymentScriptsClientDiagnostics, Pipeline, "ArmDeploymentScriptResourceExtension.GetArmDeploymentScripts", "value", "nextLink", cancellationToken);
        }
    }
}
