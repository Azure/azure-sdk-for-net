...
namespace Azure.ResourceManager.Resources.Mock
{
    ...
    public partial class JitRequestResourceExtension : ArmResource
    {
        private ClientDiagnostics _jitRequestClientDiagnostics;
        private JitRequestsRestOperations _jitRequestRestClient;

        /// <summary> Initializes a new instance of the <see cref="JitRequestResourceExtension"/> class for mocking. </summary>
        protected JitRequestResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="JitRequestResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal JitRequestResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<JitRequestResource> GetJitRequestDefinitionsAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, null, e => new JitRequestResource(Client, JitRequestData.DeserializeJitRequestData(e)), JitRequestClientDiagnostics, Pipeline, "JitRequestResourceExtension.GetJitRequestDefinitions", "value", null, cancellationToken);
        }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => JitRequestRestClient.CreateListBySubscriptionRequest(Id.SubscriptionId);
            return PageableHelpers.CreatePageable(FirstPageRequest, null, e => new JitRequestResource(Client, JitRequestData.DeserializeJitRequestData(e)), JitRequestClientDiagnostics, Pipeline, "JitRequestResourceExtension.GetJitRequestDefinitions", "value", null, cancellationToken);
        }
    }
}
