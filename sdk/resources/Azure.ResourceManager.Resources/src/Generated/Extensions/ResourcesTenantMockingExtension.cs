...
namespace Azure.ResourceManager.Resources.Mocking
{
    ...
    internal partial class ResourcesTenantMockingExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="ResourcesTenantMockingExtension"/> class for mocking. </summary>
        protected ResourcesTenantMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ResourcesTenantMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ResourcesTenantMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        {
            using var scope = ArmDeploymentDeploymentsClientDiagnostics.CreateScope("ResourcesTenantMockingExtension.CalculateDeploymentTemplateHash");
            scope.Start();
            try
            {
