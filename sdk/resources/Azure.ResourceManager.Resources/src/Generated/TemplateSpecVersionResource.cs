...
namespace Azure.ResourceManager.Resources
{
    ...
    public partial class TemplateSpecVersionResource : ArmResource
    {
        ...
        internal TemplateSpecVersionResource(ArmClient client, TemplateSpecVersionData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<TemplateSpecVersionResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
                {
                    ...
                    return Response.FromValue(new TemplateSpecVersionResource(Client, originalResponse.Value, originalResponse.Value.Id), originalResponse.GetRawResponse());
                }
                else
                {
