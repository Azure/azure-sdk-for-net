...
namespace Azure.ResourceManager.Resources
{
    ...
    public partial class TagsClient
    {
        ...
        internal TagsClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null)
        {
            RestClient = new TagsRestClient(clientDiagnostics, pipeline, subscriptionId, endpoint);
