...
namespace Azure.ResourceManager.Resources
{
    public partial class ArmApplicationDefinitionResource : IJsonModel<ArmApplicationDefinitionData>
    {
        ...
        {
            return ModelReaderWriter.Read<ArmApplicationDefinitionData>(new BinaryData(reader.ValueSequence), options);
        }
        ...
        {
            return ModelReaderWriter.Read<ArmApplicationDefinitionData>(data, options);
        }
