...
namespace Azure.ResourceManager.Resources
{
    ...
    public partial class ApplicationDefinitionCollection : ArmCollection, IEnumerable<ApplicationDefinition>, IAsyncEnumerable<ApplicationDefinition>
    {
        ...
        /// <exception cref="ArgumentException"> <paramref name="applicationDefinitionName"/> is null or empty. </exception>
        ...
        {
            if (string.IsNullOrEmpty(applicationDefinitionName))
            {
                throw new ArgumentException($"Parameter {nameof(applicationDefinitionName)} cannot be null or empty", nameof(applicationDefinitionName));
            }
            if (parameters == null)
            {
