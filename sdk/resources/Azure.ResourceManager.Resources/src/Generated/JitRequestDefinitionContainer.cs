...
namespace Azure.ResourceManager.Resources
{
    ...
    public partial class JitRequestDefinitionContainer : ArmContainer
    {
        ...
        internal JitRequestDefinitionContainer(ArmResource parent) : base(parent)
        {
        ...
        public async virtual Task<Response<JitRequestDefinition>> GetIfExistsAsync(string jitRequestName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("JitRequestDefinitionContainer.GetIfExistsAsync");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<bool>> CheckIfExistsAsync(string jitRequestName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("JitRequestDefinitionContainer.CheckIfExistsAsync");
            scope.Start();
            try
            {
        ...
        public virtual Response<IReadOnlyList<JitRequestDefinition>> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _jitRequestsRestClient.GetAllByResourceGroup(Id.ResourceGroupName, cancellationToken);
        ...
        public async virtual Task<Response<IReadOnlyList<JitRequestDefinition>>> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _jitRequestsRestClient.GetAllByResourceGroupAsync(Id.ResourceGroupName, cancellationToken).ConfigureAwait(false);
                return Response.FromValue(response.Value.Value.Select(value => new JitRequestDefinition(Parent, value)).ToArray() as IReadOnlyList<JitRequestDefinition>, response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("JitRequestDefinitionContainer.GetAllAsGenericResources");
            scope.Start();
            try
            {
