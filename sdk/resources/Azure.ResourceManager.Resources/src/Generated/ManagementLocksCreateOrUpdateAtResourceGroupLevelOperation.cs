...
namespace Azure.ResourceManager.Resources
{
    ...
    public partial class ManagementLocksCreateOrUpdateAtResourceGroupLevelOperation : Operation<ManagementLockObject>
    {
        private readonly OperationOrResponseInternals<ManagementLockObject> _operation;

        /// <summary> Initializes a new instance of ManagementLocksCreateOrUpdateAtResourceGroupLevelOperation for mocking. </summary>
        protected ManagementLocksCreateOrUpdateAtResourceGroupLevelOperation()
        {
        }

        internal ManagementLocksCreateOrUpdateAtResourceGroupLevelOperation(ResourceOperationsBase operationsBase, Response<ManagementLockObjectData> response)
        {
