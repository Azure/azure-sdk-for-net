...
namespace Azure.ResourceManager.Resources
{
    ...
    public partial class JitRequestDefinitionCollection : ArmCollection, IEnumerable<JitRequestDefinition>, IAsyncEnumerable<JitRequestDefinition>
    {
        ...
        /// <exception cref="ArgumentException"> <paramref name="jitRequestName"/> is null or empty. </exception>
        ...
        {
            if (string.IsNullOrEmpty(jitRequestName))
            {
                throw new ArgumentException($"Parameter {nameof(jitRequestName)} cannot be null or empty", nameof(jitRequestName));
            }
            if (parameters == null)
            {
