...
namespace Azure.ResourceManager.Resources
{
    ...
    public partial class TemplateSpecVersionContainer : ArmContainer
    {
        private readonly ClientDiagnostics _clientDiagnostics;
        private readonly TemplateSpecVersionsRestOperations _templateSpecVersionsRestClient;

        /// <summary> Initializes a new instance of the <see cref="TemplateSpecVersionContainer"/> class for mocking. </summary>
        protected TemplateSpecVersionContainer()
        {
        }

        /// <summary> Initializes a new instance of TemplateSpecVersionContainer class. </summary>
        /// <param name="parent"> The resource representing the parent resource. </param>
        internal TemplateSpecVersionContainer(ArmResource parent) : base(parent)
        {
        ...
        protected override ResourceType ValidResourceType => "Microsoft.Resources/templateSpecs";
        ...
        public virtual TemplateSpecVersionCreateOrUpdateOperation CreateOrUpdate(string templateSpecVersion, TemplateSpecVersionData templateSpecVersionModel, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("TemplateSpecVersionContainer.CreateOrUpdate");
            scope.Start();
            try
            {
        ...
        public virtual Response<TemplateSpecVersion> Get(string templateSpecVersion, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("TemplateSpecVersionContainer.Get");
            scope.Start();
            try
            {
        ...
        public virtual Response<TemplateSpecVersion> GetIfExists(string templateSpecVersion, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("TemplateSpecVersionContainer.GetIfExists");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<TemplateSpecVersion>> GetIfExistsAsync(string templateSpecVersion, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("TemplateSpecVersionContainer.GetIfExistsAsync");
            scope.Start();
            try
            {
        ...
        public virtual Response<bool> CheckIfExists(string templateSpecVersion, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("TemplateSpecVersionContainer.CheckIfExists");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<bool>> CheckIfExistsAsync(string templateSpecVersion, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("TemplateSpecVersionContainer.CheckIfExistsAsync");
            scope.Start();
            try
            {
        ...
        public virtual Pageable<TemplateSpecVersion> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("TemplateSpecVersionContainer.GetAll");
                scope.Start();
                try
                {
                    var response = _templateSpecVersionsRestClient.GetAll(Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken);
            ...
            Page<TemplateSpecVersion> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _templateSpecVersionsRestClient.GetAllNextPage(nextLink, Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new TemplateSpecVersion(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual AsyncPageable<TemplateSpecVersion> GetAllAsync(CancellationToken cancellationToken = default)
        {
            async Task<Page<TemplateSpecVersion>> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _templateSpecVersionsRestClient.GetAllAsync(Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new TemplateSpecVersion(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            async Task<Page<TemplateSpecVersion>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _templateSpecVersionsRestClient.GetAllNextPageAsync(nextLink, Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new TemplateSpecVersion(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
