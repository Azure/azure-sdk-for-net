...
namespace Azure.ResourceManager.Resources
{
    ...
    public partial class TenantDataBoundaryCollection : ArmCollection
    {
        ...
        public virtual async Task<ArmOperation<TenantDataBoundaryResource>> CreateOrUpdateAsync(WaitUntil waitUntil, DefaultName @default, DataBoundaryDefinitionData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _tenantDataBoundaryDataBoundariesRestClient.PutAsync(default, data, cancellationToken).ConfigureAwait(false);
                var uri = _tenantDataBoundaryDataBoundariesRestClient.CreatePutRequestUri(default, data);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        public virtual ArmOperation<TenantDataBoundaryResource> CreateOrUpdate(WaitUntil waitUntil, DefaultName @default, DataBoundaryDefinitionData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
            ...
            try
            {
                var response = _tenantDataBoundaryDataBoundariesRestClient.Put(default, data, cancellationToken);
                var uri = _tenantDataBoundaryDataBoundariesRestClient.CreatePutRequestUri(default, data);
                var rehydrationToken = NextLinkOperationImplementation.GetRehydrationToken(RequestMethod.Put, uri.ToUri(), uri.ToString(), "None", null, OperationFinalStateVia.OriginalUri.ToString());
                var operation = new ResourcesArmOperation<TenantDataBoundaryResource>(Response.FromValue(new TenantDataBoundaryResource(Client, response), response.GetRawResponse()), rehydrationToken);
                if (waitUntil == WaitUntil.Completed)
        ...
        /// <param name="default"> Default string modeled as parameter for auto generation to work correctly. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<TenantDataBoundaryResource>> GetAsync(DefaultName @default, CancellationToken cancellationToken = default)
        {
            using var scope = _tenantDataBoundaryDataBoundariesClientDiagnostics.CreateScope("TenantDataBoundaryCollection.Get");
            scope.Start();
            try
            {
                var response = await _tenantDataBoundaryDataBoundariesRestClient.GetTenantAsync(default, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="default"> Default string modeled as parameter for auto generation to work correctly. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<TenantDataBoundaryResource> Get(DefaultName @default, CancellationToken cancellationToken = default)
        {
            using var scope = _tenantDataBoundaryDataBoundariesClientDiagnostics.CreateScope("TenantDataBoundaryCollection.Get");
            scope.Start();
            try
            {
                var response = _tenantDataBoundaryDataBoundariesRestClient.GetTenant(default, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new TenantDataBoundaryResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        public virtual async Task<Response<bool>> ExistsAsync(DefaultName @default, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _tenantDataBoundaryDataBoundariesRestClient.GetTenantAsync(default, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<bool> Exists(DefaultName @default, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _tenantDataBoundaryDataBoundariesRestClient.GetTenant(default, cancellationToken: cancellationToken);
                return Response.FromValue(response.Value != null, response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        /// <param name="default"> Default string modeled as parameter for auto generation to work correctly. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<NullableResponse<TenantDataBoundaryResource>> GetIfExistsAsync(DefaultName @default, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="default"> Default string modeled as parameter for auto generation to work correctly. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual NullableResponse<TenantDataBoundaryResource> GetIfExists(DefaultName @default, CancellationToken cancellationToken = default)
        {
            using var scope = _tenantDataBoundaryDataBoundariesClientDiagnostics.CreateScope("TenantDataBoundaryCollection.GetIfExists");
            scope.Start();
            try
