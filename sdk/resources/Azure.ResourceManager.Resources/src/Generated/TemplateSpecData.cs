...
namespace Azure.ResourceManager.Resources
{
    ...
    public partial class TemplateSpecData : ResourceData
    {
        ...
        internal TemplateSpecData(ResourceIdentifier id, string name, ResourceType type, SystemData systemData, string location, IDictionary<string, string> tags, string description, string displayName, BinaryData metadata, IReadOnlyDictionary<string, TemplateSpecVersionInfo> versions) : base(id, name, type, systemData)
        {
            Location = location;
            Tags = tags;
