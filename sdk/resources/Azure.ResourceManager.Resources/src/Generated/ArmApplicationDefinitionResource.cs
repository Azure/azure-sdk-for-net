...
namespace Azure.ResourceManager.Resources
{
    ...
    public partial class ArmApplicationDefinitionResource : ArmResource
    {
        ...
        internal ArmApplicationDefinitionResource(ArmClient client, ArmApplicationDefinitionData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<ArmApplicationDefinitionResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
                {
                    ...
                    return Response.FromValue(new ArmApplicationDefinitionResource(Client, originalResponse.Value, originalResponse.Value.Id), originalResponse.GetRawResponse());
                }
                else
                {
