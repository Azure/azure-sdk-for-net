...
{
    /// <summary> A Class representing a DeploymentScriptResource along with the instance operations that can be performed on it. </summary>
    public partial class DeploymentScriptResource : ArmResource
    {
        ...
        internal DeploymentScriptResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _scriptLogDeploymentScriptsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Resources", ScriptLogResource.ResourceType.Namespace, DiagnosticOptions);
