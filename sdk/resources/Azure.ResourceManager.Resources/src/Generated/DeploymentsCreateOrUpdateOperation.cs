...
namespace Azure.ResourceManager.Resources
{
    ...
    public partial class DeploymentsCreateOrUpdateOperation : Operation<DeploymentExtended>, IOperationSource<DeploymentExtended>
    {
        ...
        /// <summary> Initializes a new instance of DeploymentsCreateOrUpdateOperation for mocking. </summary>
        protected DeploymentsCreateOrUpdateOperation()
        {
        }

        internal DeploymentsCreateOrUpdateOperation(ResourceOperationsBase operationsBase, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<DeploymentExtended>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "DeploymentsCreateOrUpdateOperation");
