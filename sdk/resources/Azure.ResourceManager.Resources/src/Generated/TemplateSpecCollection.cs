...
namespace Azure.ResourceManager.Resources
{
    ...
    public partial class TemplateSpecCollection : ArmCollection, IEnumerable<TemplateSpec>, IAsyncEnumerable<TemplateSpec>
    {
        ...
        /// <exception cref="ArgumentException"> <paramref name="templateSpecName"/> is null or empty. </exception>
        /// <exception cref="ArgumentNullException"> <paramref name="templateSpec"/> is null. </exception>
        ...
        {
            if (string.IsNullOrEmpty(templateSpecName))
            {
                throw new ArgumentException($"Parameter {nameof(templateSpecName)} cannot be null or empty", nameof(templateSpecName));
            }
            ...
            try
            {
                ...
                var operation = new TemplateSpecCreateOrUpdateOperation(this, response);
        ...
        public virtual Pageable<TemplateSpec> GetAll(TemplateSpecExpandKind? expand = null, CancellationToken cancellationToken = default)
        {
            Page<TemplateSpec> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    ...
                    return Page.FromValues(response.Value.Value.Select(value => new TemplateSpec(this, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
                    scope.Failed(e);
