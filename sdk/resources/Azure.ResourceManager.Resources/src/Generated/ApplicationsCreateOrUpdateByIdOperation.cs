...
namespace Azure.ResourceManager.Resources
{
    ...
    public partial class ApplicationsCreateOrUpdateByIdOperation : Operation<Application>, IOperationSource<Application>
    {
        ...
        internal ApplicationsCreateOrUpdateByIdOperation(ResourceOperationsBase operationsBase, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<Application>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "ApplicationsCreateOrUpdateByIdOperation");
