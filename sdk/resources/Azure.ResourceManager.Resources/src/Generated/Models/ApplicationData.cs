...
namespace Azure.ResourceManager.Resources
{
    ...
    public partial class ApplicationData : GenericResource
    {
        ...
        public ApplicationData(LocationData location, string kind) : base(location)
        {
            if (kind == null)
            {
