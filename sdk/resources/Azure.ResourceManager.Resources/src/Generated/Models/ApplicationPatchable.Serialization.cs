...
namespace Azure.ResourceManager.Resources.Models
{
    public partial class ApplicationPatchable : IUtf8JsonSerializable
    {
        ...
        internal static ApplicationPatchable DeserializeApplicationPatchable(JsonElement element)
        {
            ...
            return new ApplicationPatchable(id.HasValue ? id.Value : null, name.HasValue ? name.Value : null, type.HasValue ? type.Value : null, location.HasValue ? location.Value : null, new ChangeTrackingDictionary<string, string>(tags), managedBy.HasValue ? managedBy.Value : null, sku.HasValue ? sku.Value : null, identity.HasValue ? identity.Value : null, plan.HasValue ? plan.Value : null, kind.HasValue ? kind.Value : null, managedResourceGroupId.HasValue ? managedResourceGroupId.Value : null, applicationDefinitionId.HasValue ? applicationDefinitionId.Value : null, parameters.HasValue ? parameters.Value : null, outputs.HasValue ? outputs.Value : null, provisioningState.HasValue ? provisioningState.Value : (ProvisioningState?)null);
        }
    }
}
