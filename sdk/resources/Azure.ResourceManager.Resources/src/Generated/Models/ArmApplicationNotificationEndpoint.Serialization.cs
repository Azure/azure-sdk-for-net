...
{
    public partial class ArmApplicationNotificationEndpoint : IUtf8JsonSerializable, IJsonModel<ArmApplicationNotificationEndpoint>, IPersistableModel<ArmApplicationNotificationEndpoint>
    {
        ...
        void IJsonModel<ArmApplicationNotificationEndpoint>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ArmApplicationNotificationEndpoint)} does not support '{format}' format.");
            }
