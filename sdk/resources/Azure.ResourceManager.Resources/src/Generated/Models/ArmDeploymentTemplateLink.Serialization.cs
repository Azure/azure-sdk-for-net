...
{
    public partial class ArmDeploymentTemplateLink : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ArmDeploymentTemplateLink DeserializeArmDeploymentTemplateLink(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
