...
{
    public partial class ApplicationPolicy : IUtf8JsonSerializable
    {
        ...
        internal static ApplicationPolicy DeserializeApplicationPolicy(JsonElement element)
        {
            ...
            return new ApplicationPolicy(name.Value, policyDefinitionId.Value, parameters.Value);
        }
    }
}
