...
namespace Azure.ResourceManager.Resources.Models
{
    public partial class ScriptStatus : IUtf8JsonSerializable
    {
        ...
        internal static ScriptStatus DeserializeScriptStatus(JsonElement element)
        {
            ...
            return new ScriptStatus(containerInstanceId.HasValue ? containerInstanceId.Value : null, storageAccountId.HasValue ? storageAccountId.Value : null, startTime.HasValue ? startTime.Value : (DateTimeOffset?)null, endTime.HasValue ? endTime.Value : (DateTimeOffset?)null, expirationTime.HasValue ? expirationTime.Value : (DateTimeOffset?)null, error.HasValue ? error.Value : null);
        }
    }
}
