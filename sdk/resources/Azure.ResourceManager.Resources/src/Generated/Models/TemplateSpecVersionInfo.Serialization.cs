...
{
    public partial class TemplateSpecVersionInfo : IUtf8JsonSerializable, IJsonModel<TemplateSpecVersionInfo>, IPersistableModel<TemplateSpecVersionInfo>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(TimeModified))
            {
                ...
                builder.AppendLine($" '{TimeModified.Value.ToString()}'");
            }
