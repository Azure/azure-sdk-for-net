...
namespace Azure.ResourceManager.Resources.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BasicArmDependency>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<BasicArmDependency>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BasicArmDependency>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<BasicArmDependency>)} interface");
            }
        ...
        string IPersistableModel<BasicArmDependency>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
