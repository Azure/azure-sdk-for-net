...
{
    public partial class ArmDeploymentScriptData : Core.IUtf8JsonSerializable
    {
        ...
        internal static ArmDeploymentScriptData DeserializeArmDeploymentScriptData(JsonElement element)
        {
            ...
            return new ArmDeploymentScriptData(id, name, type, systemData.Value, identity.Value, location, Core.Optional.ToDictionary(tags), kind);
        }
    }
}
