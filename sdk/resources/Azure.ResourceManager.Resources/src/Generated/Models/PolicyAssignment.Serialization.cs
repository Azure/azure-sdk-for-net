...
namespace Azure.ResourceManager.Resources.Models
{
    public partial class PolicyAssignment : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            if (Optional.IsDefined(NotScopes))
            {
        ...
        internal static PolicyAssignment DeserializePolicyAssignment(JsonElement element)
        {
            ...
            return new PolicyAssignment(id.HasValue ? id.Value : null, type.HasValue ? type.Value : null, name.HasValue ? name.Value : null, sku.HasValue ? sku.Value : null, location.HasValue ? location.Value : null, identity.HasValue ? identity.Value : null, displayName.HasValue ? displayName.Value : null, policyDefinitionId.HasValue ? policyDefinitionId.Value : null, scope.HasValue ? scope.Value : null, new ChangeTrackingList<string>(notScopes), new ChangeTrackingDictionary<string, ParameterValuesValue>(parameters), description.HasValue ? description.Value : null, metadata.HasValue ? metadata.Value : null, enforcementMode.HasValue ? enforcementMode.Value : (EnforcementMode?)null);
        }
    }
}
