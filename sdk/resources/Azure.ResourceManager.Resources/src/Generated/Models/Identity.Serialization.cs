...
namespace Azure.ResourceManager.Resources.Models
{
    public partial class Identity : IUtf8JsonSerializable
    {
        ...
        internal static Identity DeserializeIdentity(JsonElement element)
        {
            ...
            return new Identity(principalId.HasValue ? principalId.Value : null, tenantId.HasValue ? tenantId.Value : null, type.HasValue ? type.Value : (ResourceIdentityType?)null, new ChangeTrackingDictionary<string, IdentityUserAssignedIdentitiesValue>(userAssignedIdentities));
        }
    }
}
