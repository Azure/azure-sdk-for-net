...
{
    public partial class ArmApplicationJitAccessPolicy : IUtf8JsonSerializable, IJsonModel<ArmApplicationJitAccessPolicy>, IPersistableModel<ArmApplicationJitAccessPolicy>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(JitApprovalMode))
            {
                ...
                builder.AppendLine($" '{JitApprovalMode.ToString()}'");
            }
            ...
            if (Optional.IsDefined(MaximumJitAccessDuration))
            {
                ...
                var formattedTimeSpan = XmlConvert.ToString(MaximumJitAccessDuration.Value);
