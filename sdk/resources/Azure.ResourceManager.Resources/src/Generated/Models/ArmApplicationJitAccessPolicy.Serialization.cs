...
namespace Azure.ResourceManager.Resources.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ArmApplicationJitAccessPolicy>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ArmApplicationJitAccessPolicy>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ArmApplicationJitAccessPolicy>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ArmApplicationJitAccessPolicy>)} interface");
            }
        ...
        string IPersistableModel<ArmApplicationJitAccessPolicy>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
