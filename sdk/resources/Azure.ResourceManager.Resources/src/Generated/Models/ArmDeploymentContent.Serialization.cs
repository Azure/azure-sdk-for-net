...
namespace Azure.ResourceManager.Resources.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ArmDeploymentContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ArmDeploymentContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ArmDeploymentContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ArmDeploymentContent>)} interface");
            }
        ...
        string IPersistableModel<ArmDeploymentContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
