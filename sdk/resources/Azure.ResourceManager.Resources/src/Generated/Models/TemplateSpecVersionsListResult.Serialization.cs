...
namespace Azure.ResourceManager.Resources.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TemplateSpecVersionsListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<TemplateSpecVersionsListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<TemplateSpecVersionsListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<TemplateSpecVersionsListResult>)} interface");
            }
        ...
        string IPersistableModel<TemplateSpecVersionsListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
