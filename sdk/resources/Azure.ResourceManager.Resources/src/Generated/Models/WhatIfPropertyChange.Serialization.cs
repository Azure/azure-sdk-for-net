...
{
    public partial class WhatIfPropertyChange : IUtf8JsonSerializable, IJsonModel<WhatIfPropertyChange>, IPersistableModel<WhatIfPropertyChange>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(PropertyChangeType))
            {
                builder.Append("  propertyChangeType:");
                builder.AppendLine($" '{PropertyChangeType.ToString()}'");
            }
