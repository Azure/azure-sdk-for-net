...
namespace Azure.ResourceManager.Resources.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<WhatIfPropertyChange>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<WhatIfPropertyChange>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<WhatIfPropertyChange>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<WhatIfPropertyChange>)} interface");
            }
        ...
        string IPersistableModel<WhatIfPropertyChange>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
