...
namespace Azure.ResourceManager.Resources.Models
{
    ...
    {
        internal static SystemDataAutoGenerated DeserializeSystemDataAutoGenerated(JsonElement element)
        {
            ...
            return new SystemDataAutoGenerated(createdBy.Value, Optional.ToNullable(createdByType), Optional.ToNullable(createdAt), lastModifiedBy.Value, Optional.ToNullable(lastModifiedByType), Optional.ToNullable(lastModifiedAt));
        }
    }
}
