...
namespace Azure.ResourceManager.Resources.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DebugSetting>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DebugSetting>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DebugSetting>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<DebugSetting>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
