...
namespace Azure.ResourceManager.Resources
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TemplateSpecData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<TemplateSpecData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<TemplateSpecData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<TemplateSpecData>)} interface");
            }
        ...
        string IPersistableModel<TemplateSpecData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
