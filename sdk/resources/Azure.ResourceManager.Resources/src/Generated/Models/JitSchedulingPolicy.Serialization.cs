...
{
    public partial class JitSchedulingPolicy : IUtf8JsonSerializable, IJsonModel<JitSchedulingPolicy>, IPersistableModel<JitSchedulingPolicy>
    {
        ...
        void IJsonModel<JitSchedulingPolicy>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(JitSchedulingPolicy)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SchedulingType))
            {
                builder.Append("  type:");
