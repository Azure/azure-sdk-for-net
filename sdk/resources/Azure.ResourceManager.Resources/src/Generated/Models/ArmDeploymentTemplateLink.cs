...
namespace Azure.ResourceManager.Resources.Models
{
    ...
    public partial class ArmDeploymentTemplateLink
    {
        ...
        internal ArmDeploymentTemplateLink(Uri uri, string id, string relativePath, string contentVersion, string queryString, Dictionary<string, BinaryData> rawData)
        {
            Uri = uri;
            Id = id;
