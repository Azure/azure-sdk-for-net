...
namespace Azure.ResourceManager.Resources.Models
{
    ...
    internal partial class TemplateSpecVersionsListResult
    {
        ...
        {
            Value = new ChangeTrackingList<TemplateSpecVersion>();
        }

        /// <summary> Initializes a new instance of TemplateSpecVersionsListResult. </summary>
        /// <param name="value"> An array of Template Spec versions. </param>
        /// <param name="nextLink"> The URL to use for getting the next set of results. </param>
        internal TemplateSpecVersionsListResult(IReadOnlyList<TemplateSpecVersion> value, string nextLink)
        {
            Value = value;
            NextLink = nextLink;
        }
        ...
        public IReadOnlyList<TemplateSpecVersion> Value { get; }
