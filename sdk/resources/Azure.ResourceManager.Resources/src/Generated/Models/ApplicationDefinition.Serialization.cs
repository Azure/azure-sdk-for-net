...
namespace Azure.ResourceManager.Resources.Models
{
    public partial class ApplicationDefinition : IUtf8JsonSerializable
    {
        ...
        internal static ApplicationDefinition DeserializeApplicationDefinition(JsonElement element)
        {
            ...
            return new ApplicationDefinition(id.HasValue ? id.Value : null, name.HasValue ? name.Value : null, type.HasValue ? type.Value : null, location.HasValue ? location.Value : null, new ChangeTrackingDictionary<string, string>(tags), managedBy.HasValue ? managedBy.Value : null, sku.HasValue ? sku.Value : null, identity.HasValue ? identity.Value : null, lockLevel, displayName.HasValue ? displayName.Value : null, isEnabled.HasValue ? isEnabled.Value : null, authorizations, new ChangeTrackingList<ApplicationArtifact>(artifacts), description.HasValue ? description.Value : null, packageFileUri.HasValue ? packageFileUri.Value : null, mainTemplate.HasValue ? mainTemplate.Value : null, createUiDefinition.HasValue ? createUiDefinition.Value : null);
        }
    }
}
