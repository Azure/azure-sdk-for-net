...
namespace Azure.ResourceManager.Resources.Models
{
    public partial class OnErrorDeploymentExtended
    {
        internal static OnErrorDeploymentExtended DeserializeOnErrorDeploymentExtended(JsonElement element)
        {
            ...
            return new OnErrorDeploymentExtended(provisioningState.HasValue ? provisioningState.Value : null, type.HasValue ? type.Value : (OnErrorDeploymentType?)null, deploymentName.HasValue ? deploymentName.Value : null);
        }
    }
}
