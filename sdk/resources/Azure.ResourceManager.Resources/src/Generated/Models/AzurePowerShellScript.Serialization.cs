...
{
    public partial class AzurePowerShellScript : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static AzurePowerShellScript DeserializeAzurePowerShellScript(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
