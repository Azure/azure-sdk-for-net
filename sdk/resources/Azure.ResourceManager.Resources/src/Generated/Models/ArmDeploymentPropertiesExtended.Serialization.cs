...
{
    public partial class ArmDeploymentPropertiesExtended : IUtf8JsonSerializable, IJsonModel<ArmDeploymentPropertiesExtended>, IPersistableModel<ArmDeploymentPropertiesExtended>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(TemplateLink))
            {
                ...
                AppendChildObject(builder, TemplateLink, options, 2);
            }
            ...
            if (Optional.IsDefined(ParametersLink))
            {
                ...
                AppendChildObject(builder, ParametersLink, options, 2);
            }
            ...
            if (Optional.IsDefined(DebugSetting))
            {
                ...
                AppendChildObject(builder, DebugSetting, options, 2);
            }

            if (Optional.IsDefined(ErrorDeployment))
            {
                builder.Append("  onErrorDeployment:");
                AppendChildObject(builder, ErrorDeployment, options, 2);
            }
