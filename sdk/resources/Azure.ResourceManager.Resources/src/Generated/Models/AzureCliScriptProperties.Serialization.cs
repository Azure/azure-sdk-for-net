...
namespace Azure.ResourceManager.Resources.Models
{
    public partial class AzureCliScriptProperties : IUtf8JsonSerializable
    {
        ...
        internal static AzureCliScriptProperties DeserializeAzureCliScriptProperties(JsonElement element)
        {
            ...
            return new AzureCliScriptProperties(containerSettings.HasValue ? containerSettings.Value : null, storageAccountSettings.HasValue ? storageAccountSettings.Value : null, cleanupPreference.HasValue ? cleanupPreference.Value : (CleanupOptions?)null, provisioningState.HasValue ? provisioningState.Value : (ScriptProvisioningState?)null, status.HasValue ? status.Value : null, new ChangeTrackingDictionary<string, object>(outputs), azCliVersion, primaryScriptUri.HasValue ? primaryScriptUri.Value : null, new ChangeTrackingList<string>(supportingScriptUris), scriptContent.HasValue ? scriptContent.Value : null, arguments.HasValue ? arguments.Value : null, new ChangeTrackingList<EnvironmentVariable>(environmentVariables), forceUpdateTag.HasValue ? forceUpdateTag.Value : null, retentionInterval, timeout.HasValue ? timeout.Value : (TimeSpan?)null);
        }
    }
}
