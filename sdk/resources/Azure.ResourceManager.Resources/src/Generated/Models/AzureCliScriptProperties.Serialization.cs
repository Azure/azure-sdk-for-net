...
namespace Azure.ResourceManager.Resources.Models
{
    public partial class AzureCliScriptProperties : IUtf8JsonSerializable
    {
        ...
        internal static AzureCliScriptProperties DeserializeAzureCliScriptProperties(JsonElement element)
        {
            ...
            return new AzureCliScriptProperties(containerSettings.Value, storageAccountSettings.Value, Optional.ToNullable(cleanupPreference), Optional.ToNullable(provisioningState), status.Value, Optional.ToDictionary(outputs), azCliVersion, primaryScriptUri.Value, Optional.ToList(supportingScriptUris), scriptContent.Value, arguments.Value, Optional.ToList(environmentVariables), forceUpdateTag.Value, retentionInterval, Optional.ToNullable(timeout));
        }
    }
}
