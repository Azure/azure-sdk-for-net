...
namespace Azure.ResourceManager.Resources.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ScriptLogsList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ScriptLogsList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ScriptLogsList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ScriptLogsList>)} interface");
            }
        ...
        string IPersistableModel<ScriptLogsList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
