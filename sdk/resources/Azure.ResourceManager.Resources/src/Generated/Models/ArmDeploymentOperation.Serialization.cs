...
{
    public partial class ArmDeploymentOperation : IUtf8JsonSerializable, IJsonModel<ArmDeploymentOperation>, IPersistableModel<ArmDeploymentOperation>
    {
        ...
        void IJsonModel<ArmDeploymentOperation>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ArmDeploymentOperation)} does not support '{format}' format.");
            }
