...
{
    public partial class ScriptStorageConfiguration : IUtf8JsonSerializable, IJsonModel<ScriptStorageConfiguration>, IPersistableModel<ScriptStorageConfiguration>
    {
        ...
        void IJsonModel<ScriptStorageConfiguration>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ScriptStorageConfiguration)} does not support '{format}' format.");
            }
