...
{
    public partial class ScriptStorageConfiguration : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ScriptStorageConfiguration DeserializeScriptStorageConfiguration(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
