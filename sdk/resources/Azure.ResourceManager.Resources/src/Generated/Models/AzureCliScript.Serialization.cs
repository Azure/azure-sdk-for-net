...
{
    public partial class AzureCliScript : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static AzureCliScript DeserializeAzureCliScript(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
