...
namespace Azure.ResourceManager.Resources.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ArmDeploymentWhatIfContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ArmDeploymentWhatIfContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ArmDeploymentWhatIfContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ArmDeploymentWhatIfContent>)} interface");
            }
        ...
        string IPersistableModel<ArmDeploymentWhatIfContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
