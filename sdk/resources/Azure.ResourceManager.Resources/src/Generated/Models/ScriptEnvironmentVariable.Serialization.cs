...
{
    public partial class ScriptEnvironmentVariable : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ScriptEnvironmentVariable DeserializeScriptEnvironmentVariable(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
