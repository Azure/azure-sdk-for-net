...
namespace Azure.ResourceManager.Resources.Models
{
    public partial class ScriptEnvironmentVariable : IUtf8JsonSerializable, IJsonModel<ScriptEnvironmentVariable>
    {
        ...
        void IJsonModel<ScriptEnvironmentVariable>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(ScriptEnvironmentVariable)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ScriptEnvironmentVariable>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(ScriptEnvironmentVariable)} does not support '{options.Format}' format.");
            }
        }
