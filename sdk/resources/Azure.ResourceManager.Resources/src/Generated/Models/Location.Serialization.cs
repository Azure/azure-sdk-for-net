...
namespace Azure.ResourceManager.Resources.Models
{
    public partial class Location
    {
        internal static Location DeserializeLocation(JsonElement element)
        {
            ...
            return new Location(id.HasValue ? id.Value : null, subscriptionId.HasValue ? subscriptionId.Value : null, name.HasValue ? name.Value : null, displayName.HasValue ? displayName.Value : null, regionalDisplayName.HasValue ? regionalDisplayName.Value : null, metadata.HasValue ? metadata.Value : null);
        }
    }
}
