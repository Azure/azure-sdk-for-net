...
namespace Azure.ResourceManager.Resources.Models
{
    public partial class Application : IUtf8JsonSerializable
    {
        ...
        internal static Application DeserializeApplication(JsonElement element)
        {
            ...
            return new Application(id.HasValue ? id.Value : null, name.HasValue ? name.Value : null, type.HasValue ? type.Value : null, location.HasValue ? location.Value : null, new ChangeTrackingDictionary<string, string>(tags), managedBy.HasValue ? managedBy.Value : null, sku.HasValue ? sku.Value : null, identity.HasValue ? identity.Value : null, plan.HasValue ? plan.Value : null, kind, managedResourceGroupId, applicationDefinitionId.HasValue ? applicationDefinitionId.Value : null, parameters.HasValue ? parameters.Value : null, outputs.HasValue ? outputs.Value : null, provisioningState.HasValue ? provisioningState.Value : (ProvisioningState?)null);
        }
    }
}
