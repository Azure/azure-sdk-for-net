...
namespace Azure.ResourceManager.Resources.Models
{
    ...
    public partial class TemplateSpecVersion : AzureResourceBaseAutoGenerated
    {
        ...
        internal TemplateSpecVersion(string id, string name, string type, SystemDataAutoGenerated systemData, string location, IDictionary<string, string> tags, string description, IList<LinkedTemplateArtifact> linkedTemplates, object metadata, object mainTemplate, object uiFormDefinition) : base(id, name, type, systemData)
        {
            Location = location;
            Tags = tags;
