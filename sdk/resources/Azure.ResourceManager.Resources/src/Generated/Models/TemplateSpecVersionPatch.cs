...
namespace Azure.ResourceManager.Resources.Models
{
    ...
    public partial class TemplateSpecVersionPatch : ResourceData
    {
        ...
        internal TemplateSpecVersionPatch(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
            Tags = tags;
