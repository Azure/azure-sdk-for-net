...
namespace Azure.ResourceManager.Resources.Models
{
    ...
    public partial class TemplateSpecVersionPatch : ResourceData
    {
        ...
        internal TemplateSpecVersionPatch(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData)
        {
            Tags = tags;
            _rawData = rawData;
        }
