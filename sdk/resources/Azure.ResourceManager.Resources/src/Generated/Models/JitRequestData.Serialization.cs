...
namespace Azure.ResourceManager.Resources
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<JitRequestData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<JitRequestData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<JitRequestData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<JitRequestData>)} interface");
            }
        ...
        string IPersistableModel<JitRequestData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
