...
namespace Azure.ResourceManager.Resources.Models
{
    ...
    public partial class ArmApplicationResourceData : TrackedResourceData
    {
        ...
        internal ArmApplicationResourceData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, string managedBy, ArmApplicationSku sku, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData, tags, location)
        {
            ManagedBy = managedBy;
            Sku = sku;
            _rawData = rawData;
        ...
        /// <summary> Initializes a new instance of <see cref="ArmApplicationResourceData"/> for deserialization. </summary>
        internal ArmApplicationResourceData()
        {
        }
