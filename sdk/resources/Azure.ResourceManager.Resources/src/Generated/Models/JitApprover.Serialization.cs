...
namespace Azure.ResourceManager.Resources.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<JitApprover>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<JitApprover>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<JitApprover>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<JitApprover>)} interface");
            }
        ...
        string IPersistableModel<JitApprover>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
