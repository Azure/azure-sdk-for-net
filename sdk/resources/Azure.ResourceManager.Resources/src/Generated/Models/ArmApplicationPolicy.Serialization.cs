...
namespace Azure.ResourceManager.Resources.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ArmApplicationPolicy>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ArmApplicationPolicy>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ArmApplicationPolicy>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ArmApplicationPolicy>)} interface");
            }
        ...
        string IPersistableModel<ArmApplicationPolicy>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
