...
namespace Azure.ResourceManager.Resources.Models
{
    public partial class ScriptConfigurationBase : IUtf8JsonSerializable
    {
        ...
        internal static ScriptConfigurationBase DeserializeScriptConfigurationBase(JsonElement element)
        {
            ...
            return new ScriptConfigurationBase(primaryScriptUri.Value, Optional.ToList(supportingScriptUris), scriptContent.Value, arguments.Value, Optional.ToList(environmentVariables), forceUpdateTag.Value, retentionInterval, Optional.ToNullable(timeout));
        }
    }
}
