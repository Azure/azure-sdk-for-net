...
namespace Azure.ResourceManager.Resources.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ArmDeploymentParametersLink>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ArmDeploymentParametersLink>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ArmDeploymentParametersLink>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ArmDeploymentParametersLink>)} interface");
            }
        ...
        string IPersistableModel<ArmDeploymentParametersLink>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
