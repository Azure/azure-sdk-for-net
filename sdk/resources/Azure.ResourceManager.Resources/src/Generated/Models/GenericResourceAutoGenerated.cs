...
namespace Azure.ResourceManager.Resources.Models
{
    ...
    public partial class GenericResourceAutoGenerated : TrackedResource
    {
        ...
        internal GenericResourceAutoGenerated(ResourceIdentifier id, string name, ResourceType type, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, string managedBy, SkuAutoGenerated sku) : base(id, name, type, systemData, tags, location)
        {
            ManagedBy = managedBy;
            Sku = sku;
        }
