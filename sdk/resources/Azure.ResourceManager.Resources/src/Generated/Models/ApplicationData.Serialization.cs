...
namespace Azure.ResourceManager.Resources
{
    public partial class ApplicationData : IUtf8JsonSerializable
    {
        ...
        {
            Optional<PlanAutoGenerated> plan = default;
            string kind = default;
            ...
            return new ApplicationData(id, name, type, location, tags, managedBy.Value, sku.Value, plan.Value, kind, identity.Value, managedResourceGroupId.Value, applicationDefinitionId.Value, parameters.Value, outputs.Value, Optional.ToNullable(provisioningState), billingDetails.Value, jitAccessPolicy.Value, publisherTenantId.Value, Optional.ToList(authorizations), Optional.ToNullable(managementMode), customerSupport.Value, supportUrls.Value, Optional.ToList(artifacts), createdBy.Value, updatedBy.Value);
        }
    }
}
