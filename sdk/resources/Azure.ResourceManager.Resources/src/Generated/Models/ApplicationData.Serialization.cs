...
namespace Azure.ResourceManager.Resources
{
    public partial class ApplicationData : IUtf8JsonSerializable
    {
        ...
        internal static ApplicationData DeserializeApplicationData(JsonElement element)
        {
            ...
            return new ApplicationData(id, name, type, location, tags, managedBy.Value, sku.Value, identity.Value, plan.Value, kind, managedResourceGroupId, applicationDefinitionId.Value, parameters.Value, outputs.Value, Optional.ToNullable(provisioningState));
        }
    }
}
