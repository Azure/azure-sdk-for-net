...
namespace Azure.ResourceManager.Resources.Models
{
    ...
    public partial class WhatIfPropertyChange
    {
        ...
        internal WhatIfPropertyChange(string path, WhatIfPropertyChangeType propertyChangeType, BinaryData before, BinaryData after, IReadOnlyList<WhatIfPropertyChange> children, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Path = path;
            PropertyChangeType = propertyChangeType;
            Before = before;
