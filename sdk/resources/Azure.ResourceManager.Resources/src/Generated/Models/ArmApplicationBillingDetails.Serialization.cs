...
{
    internal partial class ArmApplicationBillingDetails : IUtf8JsonSerializable, IJsonModel<ArmApplicationBillingDetails>, IPersistableModel<ArmApplicationBillingDetails>
    {
        ...
        void IJsonModel<ArmApplicationBillingDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ArmApplicationBillingDetails)} does not support '{format}' format.");
            }
