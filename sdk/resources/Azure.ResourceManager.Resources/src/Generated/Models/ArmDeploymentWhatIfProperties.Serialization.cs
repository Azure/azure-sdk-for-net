...
namespace Azure.ResourceManager.Resources.Models
{
    public partial class ArmDeploymentWhatIfProperties : IUtf8JsonSerializable, IModelJsonSerializable<ArmDeploymentWhatIfProperties>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<ArmDeploymentWhatIfProperties>(this, options.Format);
        ...
        internal static ArmDeploymentWhatIfProperties DeserializeArmDeploymentWhatIfProperties(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new ArmDeploymentWhatIfProperties(template.Value, templateLink.Value, parameters.Value, parametersLink.Value, mode, debugSetting.Value, onErrorDeployment.Value, expressionEvaluationOptions.Value, whatIfSettings.Value, serializedAdditionalRawData);
        }
