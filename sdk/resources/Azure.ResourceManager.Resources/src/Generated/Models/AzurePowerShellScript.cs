...
namespace Azure.ResourceManager.Resources.Models
{
    ...
    public partial class AzurePowerShellScript : ArmDeploymentScriptData
    {
        ...
        /// <param name="azPowerShellVersion"> Azure PowerShell module version to be used. </param>
        internal AzurePowerShellScript(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, ArmDeploymentScriptManagedIdentity identity, ScriptType kind, ContainerConfiguration containerSettings, ScriptStorageConfiguration storageAccountSettings, ScriptCleanupOption? cleanupPreference, ScriptProvisioningState? provisioningState, ScriptStatus status, BinaryData outputs, string primaryScriptUri, IList<string> supportingScriptUris, string scriptContent, string arguments, IList<ScriptEnvironmentVariable> environmentVariables, string forceUpdateTag, TimeSpan retentionInterval, TimeSpan? timeout, string azPowerShellVersion) : base(id, name, resourceType, systemData, tags, location, identity, kind)
        {
        ...
        public ScriptCleanupOption? CleanupPreference { get; set; }
