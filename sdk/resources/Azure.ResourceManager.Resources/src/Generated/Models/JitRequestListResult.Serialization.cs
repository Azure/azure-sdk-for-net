...
namespace Azure.ResourceManager.Resources.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<JitRequestListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<JitRequestListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<JitRequestListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<JitRequestListResult>)} interface");
            }
        ...
        string IPersistableModel<JitRequestListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
