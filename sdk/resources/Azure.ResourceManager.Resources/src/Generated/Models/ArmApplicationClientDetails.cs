...
namespace Azure.ResourceManager.Resources.Models
{
    ...
    {
        /// <summary> Initializes a new instance of ArmApplicationClientDetails. </summary>
        internal ArmApplicationClientDetails()
        {
        }
        ...
        internal ArmApplicationClientDetails(string oid, string puid, string applicationId)
        {
            Oid = oid;
            Puid = puid;
