...
namespace Azure.ResourceManager.Resources.Models
{
    public partial class PolicyDefinition : IUtf8JsonSerializable
    {
        ...
        internal static PolicyDefinition DeserializePolicyDefinition(JsonElement element)
        {
            ...
            return new PolicyDefinition(id.HasValue ? id.Value : null, name.HasValue ? name.Value : null, type.HasValue ? type.Value : null, policyType.HasValue ? policyType.Value : (PolicyType?)null, mode.HasValue ? mode.Value : null, displayName.HasValue ? displayName.Value : null, description.HasValue ? description.Value : null, policyRule.HasValue ? policyRule.Value : null, metadata.HasValue ? metadata.Value : null, new ChangeTrackingDictionary<string, ParameterDefinitionsValue>(parameters));
        }
    }
}
