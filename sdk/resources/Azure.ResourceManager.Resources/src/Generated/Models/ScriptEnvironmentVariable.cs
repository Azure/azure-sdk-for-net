...
namespace Azure.ResourceManager.Resources.Models
{
    ...
    public partial class ScriptEnvironmentVariable
    {
        ...
        internal ScriptEnvironmentVariable(string name, string value, string secureValue, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Value = value;
        ...
        /// <summary> Initializes a new instance of <see cref="ScriptEnvironmentVariable"/> for deserialization. </summary>
        internal ScriptEnvironmentVariable()
        {
        }
