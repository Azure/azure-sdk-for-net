...
namespace Azure.ResourceManager.Resources.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ArmApplicationPackageSupportUris>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ArmApplicationPackageSupportUris>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ArmApplicationPackageSupportUris>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ArmApplicationPackageSupportUris>)} interface");
            }
        ...
        string IPersistableModel<ArmApplicationPackageSupportUris>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
