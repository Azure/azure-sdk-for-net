...
namespace Azure.ResourceManager.Resources.Models
{
    ...
    public partial class ArmDeploymentScriptPatch : ResourceData
    {
        ...
        internal ArmDeploymentScriptPatch(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
            Tags = tags;
