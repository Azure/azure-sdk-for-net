...
namespace Azure.ResourceManager.Resources.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ArmDeploymentOperationsListResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ArmDeploymentOperationsListResult)} does not support writing '{format}' format.");
            }
            ...
            if (Optional.IsCollectionDefined(Value))
            {
                ...
                {
                    ((IJsonModel<ArmDeploymentOperation>)item).Write(writer, options);
                }
        ...
        ArmDeploymentOperationsListResult IJsonModel<ArmDeploymentOperationsListResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ArmDeploymentOperationsListResult)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ArmDeploymentOperationsListResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ArmDeploymentOperationsListResult)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        ArmDeploymentOperationsListResult IPersistableModel<ArmDeploymentOperationsListResult>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ArmDeploymentOperationsListResult)} does not support reading '{options.Format}' format.");
            }
        }
