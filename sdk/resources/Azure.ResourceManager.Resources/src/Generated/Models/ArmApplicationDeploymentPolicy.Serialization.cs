...
namespace Azure.ResourceManager.Resources.Models
{
    internal partial class ArmApplicationDeploymentPolicy : IUtf8JsonSerializable, IJsonModel<ArmApplicationDeploymentPolicy>
    {
        ...
        ArmApplicationDeploymentPolicy IJsonModel<ArmApplicationDeploymentPolicy>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ArmApplicationDeploymentPolicy)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ArmApplicationDeploymentPolicy>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ArmApplicationDeploymentPolicy)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        ArmApplicationDeploymentPolicy IPersistableModel<ArmApplicationDeploymentPolicy>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ArmApplicationDeploymentPolicy)} does not support reading '{options.Format}' format.");
            }
        }
