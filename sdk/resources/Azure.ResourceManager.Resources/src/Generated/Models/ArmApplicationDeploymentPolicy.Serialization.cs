...
namespace Azure.ResourceManager.Resources.Models
{
    internal partial class ArmApplicationDeploymentPolicy : IUtf8JsonSerializable, IJsonModel<ArmApplicationDeploymentPolicy>
    {
        ...
        void IJsonModel<ArmApplicationDeploymentPolicy>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(ArmApplicationDeploymentPolicy)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ArmApplicationDeploymentPolicy>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(ArmApplicationDeploymentPolicy)} does not support '{options.Format}' format.");
            }
        }
