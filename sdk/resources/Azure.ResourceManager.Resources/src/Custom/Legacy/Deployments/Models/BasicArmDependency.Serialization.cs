...
namespace Azure.ResourceManager.Resources.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BasicArmDependency>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(BasicArmDependency)} does not support writing '{format}' format.");
            }
        ...
        BasicArmDependency IJsonModel<BasicArmDependency>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(BasicArmDependency)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<BasicArmDependency>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(BasicArmDependency)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        BasicArmDependency IPersistableModel<BasicArmDependency>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(BasicArmDependency)} does not support reading '{options.Format}' format.");
            }
        }
