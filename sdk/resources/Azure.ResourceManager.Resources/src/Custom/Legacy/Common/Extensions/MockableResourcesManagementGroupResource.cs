...
namespace Azure.ResourceManager.Resources.Mocking
{
    ...
    public partial class MockableResourcesManagementGroupResource : ArmResource
    {
        ...
        [Obsolete("Use MockableResourcesDeploymentsManagementGroupResource.GetArmDeployments instead.", false)]
        ...
        [ForwardsClientCalls]
        [Obsolete("Use MockableResourcesDeploymentsManagementGroupResource.GetArmDeploymentAsync instead.", false)]
        [EditorBrowsable(EditorBrowsableState.Never)]
        ...
        /// <exception cref="ArgumentException"> <paramref name="deploymentName"/> is an empty string, and was expected to be non-empty. </exception>
        [ForwardsClientCalls]
        [Obsolete("Use MockableResourcesDeploymentsManagementGroupResource.GetArmDeployment instead.", false)]
        [EditorBrowsable(EditorBrowsableState.Never)]
