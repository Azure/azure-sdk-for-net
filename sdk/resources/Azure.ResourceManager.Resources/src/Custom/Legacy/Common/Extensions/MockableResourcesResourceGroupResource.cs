...
namespace Azure.ResourceManager.Resources.Mocking
{
    ...
    public partial class MockableResourcesResourceGroupResource : ArmResource
    {
        ...
        [Obsolete("Use MockableResourcesDeploymentsResourceGroupResource.GetArmDeployments instead.", false)]
        ...
        [ForwardsClientCalls]
        [Obsolete("Use MockableResourcesDeploymentsResourceGroupResource.GetArmDeploymentAsync instead.", false)]
        [EditorBrowsable(EditorBrowsableState.Never)]
        ...
        /// <exception cref="ArgumentException"> <paramref name="deploymentName"/> is an empty string, and was expected to be non-empty. </exception>
        [ForwardsClientCalls]
        [Obsolete("Use MockableResourcesDeploymentsResourceGroupResource.GetArmDeployment instead.", false)]
        [EditorBrowsable(EditorBrowsableState.Never)]
