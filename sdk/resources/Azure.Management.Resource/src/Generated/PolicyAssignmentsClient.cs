...
namespace Azure.Management.Resource
{
    ...
    public partial class PolicyAssignmentsClient
    {
        ...
        public PolicyAssignmentsClient(string subscriptionId, TokenCredential tokenCredential, ResourceManagementClientOptions options = null) : this(subscriptionId, "https://management.azure.com", tokenCredential, options)
        {
        }

        /// <summary> Initializes a new instance of PolicyAssignmentsClient. </summary>
        public PolicyAssignmentsClient(string subscriptionId, string host, TokenCredential tokenCredential, ResourceManagementClientOptions options = null)
        {
