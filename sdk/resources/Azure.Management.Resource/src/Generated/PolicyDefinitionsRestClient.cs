...
namespace Azure.Management.Resource
{
    internal partial class PolicyDefinitionsRestClient
    {
        ...
        public PolicyDefinitionsRestClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, string host = "https://management.azure.com")
        {
