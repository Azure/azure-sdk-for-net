...
namespace Azure.Management.Resource
{
    ...
    public partial class DeploymentScriptsClient
    {
        ...
        public DeploymentScriptsClient(string subscriptionId, TokenCredential tokenCredential, ResourceManagementClientOptions options = null) : this(subscriptionId, "https://management.azure.com", tokenCredential, options)
        {
        }

        /// <summary> Initializes a new instance of DeploymentScriptsClient. </summary>
        public DeploymentScriptsClient(string subscriptionId, string host, TokenCredential tokenCredential, ResourceManagementClientOptions options = null)
        {
