...
namespace Azure.Management.Resource
{
    ...
    public partial class SubscriptionsClient
    {
        ...
        public SubscriptionsClient(TokenCredential tokenCredential, ResourceManagementClientOptions options = null) : this("https://management.azure.com", tokenCredential, options)
        {
        }

        /// <summary> Initializes a new instance of SubscriptionsClient. </summary>
        public SubscriptionsClient(string host, TokenCredential tokenCredential, ResourceManagementClientOptions options = null)
        {
