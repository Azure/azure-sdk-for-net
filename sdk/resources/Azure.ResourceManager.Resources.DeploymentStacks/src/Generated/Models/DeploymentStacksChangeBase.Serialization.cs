...
namespace Azure.ResourceManager.Resources.DeploymentStacks.Models
{
    ...
    public partial class DeploymentStacksChangeBase : IJsonModel<DeploymentStacksChangeBase>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<DeploymentStacksChangeBase>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        DeploymentStacksChangeBase IJsonModel<DeploymentStacksChangeBase>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual DeploymentStacksChangeBase JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<DeploymentStacksChangeBase>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static DeploymentStacksChangeBase DeserializeDeploymentStacksChangeBase(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new DeploymentStacksChangeBase(before, after, additionalBinaryDataProperties);
        }
    }
}
