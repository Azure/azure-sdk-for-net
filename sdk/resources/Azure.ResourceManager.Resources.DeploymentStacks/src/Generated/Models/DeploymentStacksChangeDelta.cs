...
namespace Azure.ResourceManager.Resources.DeploymentStacks.Models
{
    ...
    public partial class DeploymentStacksChangeDelta
    {
        ...
        /// <summary> Initializes a new instance of <see cref="DeploymentStacksChangeDelta"/>. </summary>
        ...
        internal DeploymentStacksChangeDelta(BinaryData before, BinaryData after, IList<DeploymentStacksWhatIfPropertyChange> delta, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Before = before;
            After = after;
            Delta = delta;
