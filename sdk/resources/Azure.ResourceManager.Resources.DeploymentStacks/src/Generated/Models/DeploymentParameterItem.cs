...
namespace Azure.ResourceManager.Resources.DeploymentStacks.Models
{
    ...
    public partial class DeploymentParameterItem
    {
        ...
        internal DeploymentParameterItem(BinaryData value, string type, KeyVaultParameterReference reference, string expression, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Value = value;
            Type = type;
            Reference = reference;
