...
namespace Azure.ResourceManager.Resources.DeploymentStacks.Models
{
    ...
    public partial class DeploymentParameterItem
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="DeploymentParameterItem"/>. </summary>
        ...
        internal DeploymentParameterItem(BinaryData value, string @type, KeyVaultParameterReference reference, string expression, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            Type = @type;
            Reference = reference;
