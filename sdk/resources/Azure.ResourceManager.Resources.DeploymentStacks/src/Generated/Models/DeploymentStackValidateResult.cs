...
namespace Azure.ResourceManager.Resources.DeploymentStacks.Models
{
    ...
    public partial class DeploymentStackValidateResult : ResourceData
    {
        ...
        internal DeploymentStackValidateResult(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, ResponseError error, DeploymentStackValidateProperties properties) : base(id, name, resourceType, systemData)
        {
