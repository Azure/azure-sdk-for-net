...
namespace Azure.ResourceManager.Resources.DeploymentStacks
{
    internal partial class DeploymentStacksArmOperation : ArmOperation
    {
        ...
        internal DeploymentStacksArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
