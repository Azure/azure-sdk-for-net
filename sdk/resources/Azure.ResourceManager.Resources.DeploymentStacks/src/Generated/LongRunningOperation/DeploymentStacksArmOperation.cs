...
#pragma warning disable SA1649 // File name should match first type name
    internal class DeploymentStacksArmOperation : ArmOperation
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        /// <summary> Initializes a new instance of DeploymentStacksArmOperation for mocking. </summary>
        protected DeploymentStacksArmOperation()
        {
        }

        internal DeploymentStacksArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal DeploymentStacksArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal(nextLinkOperation, clientDiagnostics, response, "DeploymentStacksArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
        ...
        private string GetOperationId(RehydrationToken? rehydrationToken)
        {
            ...
            var lroDetails = ModelReaderWriter.Write(rehydrationToken, ModelReaderWriterOptions.Json, AzureResourceManagerResourcesDeploymentStacksContext.Default).ToObjectFromJson<Dictionary<string, string>>();
