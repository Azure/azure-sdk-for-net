...
{
    /// <summary></summary>
    internal partial class DeploymentStackResourceOperationSource : IOperationSource<DeploymentStackResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal DeploymentStackResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
