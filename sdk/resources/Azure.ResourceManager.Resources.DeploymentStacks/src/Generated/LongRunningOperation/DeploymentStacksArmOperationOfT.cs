...
namespace Azure.ResourceManager.Resources.DeploymentStacks
{
    internal partial class DeploymentStacksArmOperation<T> : ArmOperation<T>
    {
        ...
        internal DeploymentStacksArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
