...
namespace Azure.Management.Resources
{
    ...
    public partial class ProvidersClient
    {
        ...
        internal ProvidersClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null)
        {
            RestClient = new ProvidersRestClient(clientDiagnostics, pipeline, subscriptionId, endpoint);
