...
namespace Azure.Management.Resources
{
    ...
    public partial class ResourceGroupsClient
    {
        ...
        internal ResourceGroupsClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null)
        {
            RestClient = new ResourceGroupsRestClient(clientDiagnostics, pipeline, subscriptionId, endpoint);
