...
namespace Azure.Management.Resources
{
    ...
    public partial class DeploymentsClient
    {
        ...
        internal DeploymentsClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null)
        {
            RestClient = new DeploymentsRestClient(clientDiagnostics, pipeline, subscriptionId, endpoint);
