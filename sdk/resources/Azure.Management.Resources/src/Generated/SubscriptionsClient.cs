...
namespace Azure.Management.Resources
{
    ...
    public partial class SubscriptionsClient
    {
        ...
        internal SubscriptionsClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Uri endpoint = null)
        {
            RestClient = new SubscriptionsRestClient(clientDiagnostics, pipeline, endpoint);
