...
namespace Azure.Management.Resources
{
    ...
    public partial class ResourceLinksClient
    {
        ...
        internal ResourceLinksClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null)
        {
            RestClient = new ResourceLinksRestClient(clientDiagnostics, pipeline, subscriptionId, endpoint);
