...
namespace Azure.Management.Resources
{
    ...
    public partial class PolicyDefinitionsClient
    {
        ...
        public PolicyDefinitionsClient(string subscriptionId, TokenCredential tokenCredential, ResourcesManagementClientOptions options = null) : this(subscriptionId, "https://management.azure.com", tokenCredential, options)
        {
        }

        /// <summary> Initializes a new instance of PolicyDefinitionsClient. </summary>
        public PolicyDefinitionsClient(string subscriptionId, string host, TokenCredential tokenCredential, ResourcesManagementClientOptions options = null)
        {
