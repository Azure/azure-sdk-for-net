...
namespace Azure.Management.Resources
{
    ...
    public partial class PolicyDefinitionsClient
    {
        ...
        internal PolicyDefinitionsClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null)
        {
            RestClient = new PolicyDefinitionsRestClient(clientDiagnostics, pipeline, subscriptionId, endpoint);
