...
namespace Azure.Management.Resources
{
    ...
    public partial class PolicyAssignmentsClient
    {
        ...
        internal PolicyAssignmentsClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null)
        {
            RestClient = new PolicyAssignmentsRestClient(clientDiagnostics, pipeline, subscriptionId, endpoint);
        ...
        {
            using var scope0 = _clientDiagnostics.CreateScope("PolicyAssignmentsClient.DeleteById");
            scope0.Start();
            try
            {
        ...
        {
            using var scope0 = _clientDiagnostics.CreateScope("PolicyAssignmentsClient.CreateById");
            scope0.Start();
            try
            {
        ...
        {
            using var scope0 = _clientDiagnostics.CreateScope("PolicyAssignmentsClient.GetById");
            scope0.Start();
            try
            {
        ...
        public virtual AsyncPageable<PolicyAssignment> ListForResourceGroupAsync(string resourceGroupName, string filter = null, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope0 = _clientDiagnostics.CreateScope("PolicyAssignmentsClient.ListForResourceGroup");
                scope0.Start();
                try
                {
        ...
        public virtual AsyncPageable<PolicyAssignment> ListForResourceAsync(string resourceGroupName, string resourceProviderNamespace, string parentResourcePath, string resourceType, string resourceName, string filter = null, CancellationToken cancellationToken = default)
        {
            ...
            async Task<Page<PolicyAssignment>> FirstPageFunc(int? pageSizeHint)
            {
                using var scope0 = _clientDiagnostics.CreateScope("PolicyAssignmentsClient.ListForResource");
                scope0.Start();
                try
                {
        ...
        public virtual AsyncPageable<PolicyAssignment> ListForManagementGroupAsync(string managementGroupId, string filter, CancellationToken cancellationToken = default)
        {
            ...
            async Task<Page<PolicyAssignment>> FirstPageFunc(int? pageSizeHint)
            {
                using var scope0 = _clientDiagnostics.CreateScope("PolicyAssignmentsClient.ListForManagementGroup");
                scope0.Start();
                try
                {
        ...
        public virtual AsyncPageable<PolicyAssignment> ListAsync(string filter = null, CancellationToken cancellationToken = default)
        {
            async Task<Page<PolicyAssignment>> FirstPageFunc(int? pageSizeHint)
            {
                using var scope0 = _clientDiagnostics.CreateScope("PolicyAssignmentsClient.List");
                scope0.Start();
                try
                {
