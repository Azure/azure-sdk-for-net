...
namespace Azure.Management.Resources
{
    ...
    public partial class DeploymentScriptsClient
    {
        ...
        internal DeploymentScriptsClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null)
        {
            RestClient = new DeploymentScriptsRestClient(clientDiagnostics, pipeline, subscriptionId, endpoint);
