...
namespace Azure.Management.Resources
{
    ...
    public partial class FeaturesClient
    {
        ...
        internal FeaturesClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null)
        {
            RestClient = new FeaturesRestClient(clientDiagnostics, pipeline, subscriptionId, endpoint);
