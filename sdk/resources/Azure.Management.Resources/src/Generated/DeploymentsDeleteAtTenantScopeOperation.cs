...
namespace Azure.Management.Resources
{
    ...
    public partial class DeploymentsDeleteAtTenantScopeOperation : Operation<Response>, IOperationSource<Response>
    {
        ...
        {
            _operation = new ArmOperationHelpers<Response>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "DeploymentsDeleteAtTenantScopeOperation");
        }
        /// <inheritdoc />
