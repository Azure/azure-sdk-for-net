...
namespace Azure.ResourceManager.Resources.Deployments.Tests
{
    public class DeploymentCollectionTests : DeploymentsTestBase
    {
        ...
        public async Task CreateOrUpdate()
        {
            ...
            ArmDeploymentResource deployment = (await rg.GetDeployments().CreateOrUpdateAsync(WaitUntil.Completed, deployName, deploymentData)).Value;
        ...
        public async Task CreateOrUpdateWithLocation()
        {
            ...
            ArmDeploymentResource deployment = (await subscription.GetDeployments().CreateOrUpdateAsync(WaitUntil.Completed, deployName, deploymentData)).Value;
            Assert.AreEqual(deployName, deployment.Data.Name);
        ...
        public async Task CreateOrUpdateUsingString()
        {
            ...
            ArmDeploymentResource deployment = (await rg.GetDeployments().CreateOrUpdateAsync(WaitUntil.Completed, deployExName, deploymentData)).Value;
        ...
        public async Task Get()
        {
            ...
            var deploymentData = CreateDeploymentData(CreateDeploymentProperties());
            ArmDeploymentResource deployment = (await rg.GetDeployments().CreateOrUpdateAsync(WaitUntil.Completed, deployName, deploymentData)).Value;
            ArmDeploymentResource getDeployment = await rg.GetDeployments().GetAsync(deployName);
