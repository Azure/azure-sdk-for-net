...
namespace Microsoft.Resources.Models
{
    ...
    public partial class DeploymentPropertiesExtended
    {
        ...
        internal DeploymentPropertiesExtended(ProvisioningState? provisioningState, string correlationId, DateTimeOffset? timestamp, string duration, BinaryData outputs, IReadOnlyList<Provider> providers, IReadOnlyList<Dependency> dependencies, TemplateLink templateLink, BinaryData parameters, ParametersLink parametersLink, IReadOnlyList<DeploymentExtensionDefinition> extensions, DeploymentMode? mode, DebugSetting debugSetting, OnErrorDeploymentExtended onErrorDeployment, string templateHash, IReadOnlyList<ResourceReference> outputResources, IReadOnlyList<ResourceReference> validatedResources, ErrorResponse error, IReadOnlyList<DeploymentDiagnosticsDefinition> diagnostics, ValidationLevel? validationLevel, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
