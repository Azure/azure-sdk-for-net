...
namespace Azure.ResourceManager.Resources.Models
{
    ...
    public partial class Provider
    {
        ...
        internal Provider(string id, string @namespace, string registrationState, string registrationPolicy, IReadOnlyList<ProviderResourceType> resourceTypes, ProviderAuthorizationConsentState? providerAuthorizationConsentState, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Id = id;
            Namespace = @namespace;
