...
namespace Azure.ResourceManager.Resources.Deployments.Models
{
    ...
    public partial class Provider
    {
        ...
        internal Provider(string id, string @namespace, string registrationState, string registrationPolicy, IReadOnlyList<ProviderResourceType> resourceTypes, ProviderAuthorizationConsentState? providerAuthorizationConsentState, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Namespace = @namespace;
