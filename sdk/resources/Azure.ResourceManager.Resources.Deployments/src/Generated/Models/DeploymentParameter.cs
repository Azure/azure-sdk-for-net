...
namespace Microsoft.Resources.Models
{
    ...
    public partial class DeploymentParameter
    {
        ...
        internal DeploymentParameter(BinaryData value, KeyVaultParameterReference reference, string expression, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            Reference = reference;
