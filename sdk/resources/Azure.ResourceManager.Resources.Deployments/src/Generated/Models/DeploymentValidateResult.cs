...
namespace Azure.ResourceManager.Resources._Deployments.Models
{
    ...
    public partial class DeploymentValidateResult
    {
        ...
        internal DeploymentValidateResult(ErrorResponse error, string id, string name, string @type, DeploymentPropertiesExtended properties, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Error = error;
            Id = id;
            Name = name;
