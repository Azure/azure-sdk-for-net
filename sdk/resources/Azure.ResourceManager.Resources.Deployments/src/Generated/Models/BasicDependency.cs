...
namespace Azure.ResourceManager.Resources._Deployments.Models
{
    ...
    public partial class BasicDependency
    {
        ...
        /// <summary> Initializes a new instance of <see cref="BasicDependency"/>. </summary>
        ...
        internal BasicDependency(string id, string resourceType, string resourceName, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Id = id;
