...
namespace Azure.ResourceManager.Resources._Deployments.Models
{
    ...
    public partial class TemplateLink
    {
        ...
        /// <summary> Initializes a new instance of <see cref="TemplateLink"/>. </summary>
        public TemplateLink()
        {
        }
        ...
        internal TemplateLink(string uri, string id, string relativePath, string contentVersion, string queryString, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Uri = uri;
            Id = id;
