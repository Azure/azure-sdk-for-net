...
namespace Azure.ResourceManager.Resources._Deployments.Models
{
    ...
    public partial class Deployment : IJsonModel<Deployment>
    {
        ...
        internal static RequestContent ToRequestContent(Deployment deployment)
        {
            if (deployment == null)
            {
                return null;
        ...
        internal static Deployment DeserializeDeployment(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new Deployment(location, properties, tags ?? new ChangeTrackingDictionary<string, string>(), identity, additionalBinaryDataProperties);
        }
    }
}
