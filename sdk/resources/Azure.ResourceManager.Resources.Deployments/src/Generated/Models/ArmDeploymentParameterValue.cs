...
namespace Azure.ResourceManager.Resources.Models
{
    ...
    public partial class ArmDeploymentParameterValue
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="ArmDeploymentParameterValue"/>. </summary>
        ...
        internal ArmDeploymentParameterValue(BinaryData value, KeyVaultParameterReference reference, string expression, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            Reference = reference;
