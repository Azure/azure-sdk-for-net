...
namespace Microsoft.Resources.Models
{
    ...
    public partial class DeploymentExtensionDefinition
    {
        ...
        internal DeploymentExtensionDefinition(string @alias, string name, string version, string configId, IReadOnlyDictionary<string, DeploymentExtensionConfigItem> config, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Alias = @alias;
            Name = name;
            Version = version;
