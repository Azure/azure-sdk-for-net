    ...
    public partial class DeploymentPropertiesExtended : IJsonModel<DeploymentPropertiesExtended>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (options.Format != "W" && Optional.IsCollectionDefined(Extensions))
            {
                ...
                writer.WriteStartArray();
                foreach (DeploymentExtensionDefinition item in Extensions)
                {
                    writer.WriteObjectValue(item, options);
                }
                writer.WriteEndArray();
        ...
        internal static DeploymentPropertiesExtended DeserializeDeploymentPropertiesExtended(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            IReadOnlyList<DeploymentExtensionDefinition> extensions = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("extensions"u8))
                {
                    ...
                    List<DeploymentExtensionDefinition> array = new List<DeploymentExtensionDefinition>();
                    foreach (var item in prop.Value.EnumerateArray())
                    {
                        array.Add(DeploymentExtensionDefinition.DeserializeDeploymentExtensionDefinition(item, options));
                    }
                    extensions = array;
                    continue;
                }
