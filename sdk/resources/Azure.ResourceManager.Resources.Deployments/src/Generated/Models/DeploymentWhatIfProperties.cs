...
namespace Azure.ResourceManager.Resources._Deployments.Models
{
    ...
    public partial class DeploymentWhatIfProperties : DeploymentProperties
    {
        ...
        internal DeploymentWhatIfProperties(BinaryData template, TemplateLink templateLink, IDictionary<string, DeploymentParameterValue> parameters, IDictionary<string, DeploymentExternalInput> externalInputs, IDictionary<string, DeploymentExternalInputDefinition> externalInputDefinitions, ParametersLink parametersLink, IDictionary<string, IDictionary<string, DeploymentExtensionConfigItem>> extensionConfigs, DeploymentMode mode, DebugSetting debugSetting, OnErrorDeployment onErrorDeployment, ExpressionEvaluationOptions expressionEvaluationOptions, ValidationLevel? validationLevel, IDictionary<string, BinaryData> additionalBinaryDataProperties, DeploymentWhatIfSettings whatIfSettings) : base(template, templateLink, parameters, externalInputs, externalInputDefinitions, parametersLink, extensionConfigs, mode, debugSetting, onErrorDeployment, expressionEvaluationOptions, validationLevel, additionalBinaryDataProperties)
        {
        ...
        public WhatIfResultFormat? WhatIfResultFormat
        {
            get
            {
                return WhatIfSettings is null ? default : WhatIfSettings.ResultFormat;
            }
            set
            {
