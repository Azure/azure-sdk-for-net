...
namespace Microsoft.Resources.Models
{
    ...
    public partial class DeploymentWhatIfProperties : DeploymentProperties
    {
        ...
        internal DeploymentWhatIfProperties(BinaryData template, TemplateLink templateLink, IDictionary<string, DeploymentParameter> parameters, IDictionary<string, DeploymentExternalInput> externalInputs, IDictionary<string, DeploymentExternalInputDefinition> externalInputDefinitions, ParametersLink parametersLink, IDictionary<string, IDictionary<string, DeploymentExtensionConfigItem>> extensionConfigs, DeploymentMode mode, DebugSetting debugSetting, OnErrorDeployment onErrorDeployment, ExpressionEvaluationOptions expressionEvaluationOptions, ValidationLevel? validationLevel, IDictionary<string, BinaryData> additionalBinaryDataProperties, DeploymentWhatIfSettings whatIfSettings) : base(template, templateLink, parameters, externalInputs, externalInputDefinitions, parametersLink, extensionConfigs, mode, debugSetting, onErrorDeployment, expressionEvaluationOptions, validationLevel, additionalBinaryDataProperties)
        {
