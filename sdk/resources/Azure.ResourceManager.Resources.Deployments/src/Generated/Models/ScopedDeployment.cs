...
namespace Azure.ResourceManager.Resources._Deployments.Models
{
    ...
    public partial class ScopedDeployment
    {
        ...
        /// <summary> Initializes a new instance of <see cref="ScopedDeployment"/>. </summary>
        ...
        internal ScopedDeployment(string location, DeploymentProperties properties, IDictionary<string, string> tags, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Location = location;
            Properties = properties;
            Tags = tags;
