...
namespace Microsoft.Resources.Models
{
    ...
    public partial class DeploymentProperties
    {
        ...
        internal DeploymentProperties(BinaryData template, TemplateLink templateLink, IDictionary<string, DeploymentParameter> parameters, IDictionary<string, DeploymentExternalInput> externalInputs, IDictionary<string, DeploymentExternalInputDefinition> externalInputDefinitions, ParametersLink parametersLink, IDictionary<string, IDictionary<string, DeploymentExtensionConfigItem>> extensionConfigs, DeploymentMode mode, DebugSetting debugSetting, OnErrorDeployment onErrorDeployment, ExpressionEvaluationOptions expressionEvaluationOptions, ValidationLevel? validationLevel, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Template = template;
