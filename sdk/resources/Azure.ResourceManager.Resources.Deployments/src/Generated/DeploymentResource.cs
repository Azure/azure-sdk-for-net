...
namespace Microsoft.Resources
{
    ...
    public partial class DeploymentResource : ArmResource
    {
        ...
        internal DeploymentResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _deploymentsClientDiagnostics = new ClientDiagnostics("Microsoft.Resources", ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<Response<DeploymentResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                Azure.Core.HttpMessage message = _deploymentsRestClient.CreateGetRequest(Id.SubscriptionId, Id.Parent.Name, Id.Name, context);
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                Azure.Core.HttpMessage message = _deploymentsRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.Parent.Name, Id.Name, context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                ResourcesArmOperation operation = new ResourcesArmOperation(_deploymentsClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
        ...
        public virtual async Task<Response> CancelAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                Azure.Core.HttpMessage message = _deploymentsRestClient.CreateCancelRequest(Id.SubscriptionId, Id.Parent.Name, Id.Name, context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
        ...
        public virtual async Task<Response<DeploymentExportResult>> ExportTemplateAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                Azure.Core.HttpMessage message = _deploymentsRestClient.CreateExportTemplateRequest(Id.SubscriptionId, Id.Parent.Name, Id.Name, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        public virtual async Task<ArmOperation<DeploymentValidateResult>> ValidateAsync(WaitUntil waitUntil, Deployment deployment, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                Azure.Core.HttpMessage message = _deploymentsRestClient.CreateValidateRequest(Id.SubscriptionId, Id.Parent.Name, Id.Name, Deployment.ToRequestContent(deployment), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                ResourcesArmOperation<DeploymentValidateResult> operation = new ResourcesArmOperation<DeploymentValidateResult>(
        ...
        public virtual async Task<ArmOperation<WhatIfOperationResult>> WhatIfAsync(WaitUntil waitUntil, DeploymentWhatIf deploymentWhatIf, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                Azure.Core.HttpMessage message = _deploymentsRestClient.CreateWhatIfRequest(Id.SubscriptionId, Id.Parent.Name, Id.Name, DeploymentWhatIf.ToRequestContent(deploymentWhatIf), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        public virtual async Task<ArmOperation<DeploymentResource>> UpdateAsync(WaitUntil waitUntil, Deployment deployment, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                Azure.Core.HttpMessage message = _deploymentsRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.Parent.Name, Id.Name, Deployment.ToRequestContent(deployment), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                ResourcesArmOperation<DeploymentResource> operation = new ResourcesArmOperation<DeploymentResource>(
        ...
        public virtual async Task<Response<DeploymentResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    ArmOperation<DeploymentResource> result = await this.UpdateAsync(WaitUntil.Completed, current, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<DeploymentResource> AddTag(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    current.Tags[key] = value;
                    ArmOperation<DeploymentResource> result = this.Update(WaitUntil.Completed, current, cancellationToken: cancellationToken);
                    return Response.FromValue(result.Value, result.GetRawResponse());
                }
            }
            catch (Exception e)
