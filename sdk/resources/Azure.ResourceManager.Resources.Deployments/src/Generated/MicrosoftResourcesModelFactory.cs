...
namespace Microsoft.Resources.Models
{
    ...
    public static partial class MicrosoftResourcesModelFactory
    {
        ...
        /// <returns> A new <see cref="Resources.DeploymentExtendedData"/> instance for mocking. </returns>
        ...
        public static DeploymentExtensionDefinition DeploymentExtensionDefinition(string @alias = default, string name = default, string version = default, string configId = default, IReadOnlyDictionary<string, DeploymentExtensionConfigItem> config = default)
        {
        ...
        public static ResourceReference ResourceReference(string id = default, DeploymentExtensionDefinition extension = default, string resourceType = default, BinaryData identifiers = default, string apiVersion = default)
        {
        ...
        /// <returns> A new <see cref="Azure.ResourceManager.CommonTypes.Models.ErrorAdditionalInfo"/> instance for mocking. </returns>
        ...
        public static WhatIfChange WhatIfChange(string resourceId = default, string deploymentId = default, string symbolicName = default, BinaryData identifiers = default, DeploymentExtensionDefinition extension = default, ChangeType changeType = default, string unsupportedReason = default, BinaryData before = default, BinaryData after = default, IEnumerable<WhatIfPropertyChange> delta = default)
        {
        ...
        {
            return new DeploymentOperation(id, operationId, properties, additionalBinaryDataProperties: null);
        }
        ...
        public static TargetResource TargetResource(string id = default, string resourceName = default, string resourceType = default, DeploymentExtensionDefinition extension = default, BinaryData identifiers = default, string apiVersion = default, string symbolicName = default)
        {
