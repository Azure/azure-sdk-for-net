...
{
    /// <summary></summary>
    internal partial class DeploymentValidateResultOperationSource : IOperationSource<DeploymentValidateResult>
    {
        /// <summary></summary>
        internal DeploymentValidateResultOperationSource()
        {
        }
        ...
        DeploymentValidateResult IOperationSource<DeploymentValidateResult>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            DeploymentValidateResult result = DeploymentValidateResult.DeserializeDeploymentValidateResult(document.RootElement, ModelSerializationExtensions.WireOptions);
            return result;
        }
