...
namespace Azure.ResourceManager.Resources._Deployments.Mocking
{
    ...
    public partial class MockableResourcesDeploymentsTenantResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of MockableResourcesDeploymentsTenantResource for mocking. </summary>
        protected MockableResourcesDeploymentsTenantResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="MockableResourcesDeploymentsTenantResource"/> class. </summary>
        ...
        private ClientDiagnostics DeploymentOperationsClientDiagnostics => _deploymentOperationsClientDiagnostics ??= new ClientDiagnostics("Azure.ResourceManager.Resources._Deployments.Mocking", ProviderConstants.DefaultProviderNamespace, Diagnostics);
        ...
        public virtual async Task<Response> CheckExistenceAtTenantScopeAsync(string deploymentName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = DeploymentsClientDiagnostics.CreateScope("MockableResourcesDeploymentsTenantResource.CheckExistenceAtTenantScope");
            scope.Start();
            try
            {
                ...
                Core.HttpMessage message = DeploymentsRestClient.CreateCheckExistenceAtTenantScopeRequest(deploymentName, context);
        ...
        public virtual async Task<Response<TemplateHashResult>> CalculateTemplateHashAsync(BinaryData template, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = DeploymentsClientDiagnostics.CreateScope("MockableResourcesDeploymentsTenantResource.CalculateTemplateHash");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                Core.HttpMessage message = DeploymentsRestClient.CreateCalculateTemplateHashRequest(RequestContent.Create(template), context);
        ...
        public virtual async Task<Response<ArmDeploymentOperation>> GetAsync(string resourceGroupName, string deploymentName, string operationId, string subscriptionId, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = DeploymentOperationsClientDiagnostics.CreateScope("MockableResourcesDeploymentsTenantResource.Get");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                Core.HttpMessage message = DeploymentOperationsRestClient.CreateGetRequest(resourceGroupName, deploymentName, operationId, subscriptionId, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        public virtual AsyncPageable<ArmDeploymentOperation> GetAllAsync(string resourceGroupName, string deploymentName, string subscriptionId, int? top = default, CancellationToken cancellationToken = default)
        {
            ...
            return new DeploymentOperationsGetAllAsyncCollectionResultOfT(
                ...
                top,
                context,
                "MockableResourcesDeploymentsTenantResource.GetAll");
        }
