...
namespace Azure.ResourceManager.Resources._Deployments
{
    internal partial class DeploymentsGetAtScopeCollectionResultOfT : Pageable<DeploymentData>
    {
        ...
        /// <summary> Initializes a new instance of DeploymentsGetAtScopeCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public DeploymentsGetAtScopeCollectionResultOfT(Deployments client, string scope, string filter, int? top, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _scope = scope;
            _filter = filter;
        ...
        /// <summary> Gets the pages of DeploymentsGetAtScopeCollectionResultOfT as an enumerable collection. </summary>
