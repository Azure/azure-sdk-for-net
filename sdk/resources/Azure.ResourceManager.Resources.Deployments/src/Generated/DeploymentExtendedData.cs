...
namespace Microsoft.Resources
{
    ...
    public partial class DeploymentExtendedData : ResourceData
    {
        ...
        internal DeploymentExtendedData(string id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, DeploymentPropertiesExtended properties, string location, IDictionary<string, string> tags) : base(id, name, resourceType, systemData)
        {
