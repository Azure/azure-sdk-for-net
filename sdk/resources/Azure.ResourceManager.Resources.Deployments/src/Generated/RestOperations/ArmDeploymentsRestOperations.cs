...
namespace Azure.ResourceManager.Resources
{
    internal partial class ArmDeployments
    {
        ...
        internal ArmDeployments(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string applicationId, Uri endpoint, string apiVersion)
        {
            ClientDiagnostics = clientDiagnostics;
            _endpoint = endpoint;
            Pipeline = pipeline;
            _apiVersion = apiVersion;
            _userAgent = new TelemetryDetails(typeof(ArmDeployments).Assembly, applicationId);
        }
