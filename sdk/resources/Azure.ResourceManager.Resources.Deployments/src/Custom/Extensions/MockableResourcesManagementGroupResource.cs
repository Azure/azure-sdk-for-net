...
namespace Azure.ResourceManager.Resources.Mocking
{
    ...
    [CodeGenSuppress("GetArmDeployments")]
    [CodeGenSuppress("GetArmDeploymentAsync", typeof(string), typeof(CancellationToken))]
    [CodeGenSuppress("GetArmDeployment", typeof(string), typeof(CancellationToken))]
