...
namespace Azure.ResourceManager.NewResources
{
    ...
    public partial class DeploymentsCreateOrUpdateAtManagementGroupScopeOperation : Operation<DeploymentExtended>, IOperationSource<DeploymentExtended>
    {
        ...
        internal DeploymentsCreateOrUpdateAtManagementGroupScopeOperation(ResourceOperationsBase operationsBase, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<DeploymentExtended>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "DeploymentsCreateOrUpdateAtManagementGroupScopeOperation");
