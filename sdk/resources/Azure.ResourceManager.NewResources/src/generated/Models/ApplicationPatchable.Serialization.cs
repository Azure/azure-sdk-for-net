...
namespace Azure.ResourceManager.NewResources
{
    public partial class ApplicationPatchable : IUtf8JsonSerializable
    {
        ...
        internal static ApplicationPatchable DeserializeApplicationPatchable(JsonElement element)
        {
            ...
            return new ApplicationPatchable(id, name, type, location, tags, managedBy.Value, sku.Value, identity.Value, plan.Value, kind.Value, managedResourceGroupId.Value, applicationDefinitionId.Value, parameters.Value, outputs.Value, Optional.ToNullable(provisioningState));
        }
    }
}
