...
namespace Azure.ResourceManager.NewResources
{
    ...
    public partial class DeploymentExtendedData : Resource<ResourceGroupResourceIdentifier>
    {
        ...
        internal DeploymentExtendedData(ResourceGroupResourceIdentifier id, string name, ResourceType type, string location, DeploymentPropertiesExtended properties, IReadOnlyDictionary<string, string> tags) : base(id, name, type)
        {
            Location = location;
