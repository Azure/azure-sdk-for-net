...
namespace Microsoft.Azure.Management.StorSimple1200Series
{
    ...
    /// </summary>
    internal partial class AvailableProviderOperationsOperations : IServiceOperations<StorSimpleManagementClient>, IAvailableProviderOperationsOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal AvailableProviderOperationsOperations(StorSimpleManagementClient client)
        {
            if (client == null)
            {
        ...
        public async Task<AzureOperationResponse<IPage<AvailableProviderOperation>>> ListWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<Page1<AvailableProviderOperation>>(_responseContent, Client.DeserializationSettings);
                }
