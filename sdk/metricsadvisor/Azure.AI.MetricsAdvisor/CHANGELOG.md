...
- In `MetricsAdvisorAdministrationClient`, changed return types of sync and async `CreateDataFeed` methods to a `Response<string>` containing the ID of the created data feed.
