...
namespace Azure.AI.MetricsAdvisor
{
    ...
    public class MetricsAdvisorClient
    {
        ...
        /// </summary>
        /// <param name="metricFeedback">The <see cref="MetricFeedback"/> to be created.</param>
        /// <param name="cancellationToken">A <see cref="CancellationToken"/> controlling the request lifetime.</param>
        /// <returns>
        /// A <see cref="Response{T}"/> containing the created <see cref="MetricFeedback"/>s.
        /// </returns>
        /// <exception cref="ArgumentNullException"><paramref name="metricFeedback"/> is null.</exception>
