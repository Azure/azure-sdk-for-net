...
namespace Azure.AI.MetricsAdvisor
{
    ...
    public class MetricsAdvisorClient
    {
        ...
        public virtual async Task<Response<MetricFeedback>> AddMetricFeedbackAsync(MetricFeedback feedback, CancellationToken cancellationToken = default)
        {
        ...
        /// </returns>
        /// <exception cref="ArgumentNullException"><paramref name="feedback"/> is null.</exception>
        public virtual Response<MetricFeedback> AddMetricFeedback(MetricFeedback feedback, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(feedback, nameof(feedback));
