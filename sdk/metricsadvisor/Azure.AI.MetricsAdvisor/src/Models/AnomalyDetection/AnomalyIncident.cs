...
namespace Azure.AI.MetricsAdvisor.Models
{
    ...
    public partial class AnomalyIncident
    {
        ...
        /// "MetricsAdvisorClient.GetIncidentsForAlert(string, string, GetIncidentsForAlertOptions, CancellationToken)"/> or
        /// "MetricsAdvisorClient.GetIncidentsForAlertAsync(string, string, GetIncidentsForAlertOptions, CancellationToken)"/>.
