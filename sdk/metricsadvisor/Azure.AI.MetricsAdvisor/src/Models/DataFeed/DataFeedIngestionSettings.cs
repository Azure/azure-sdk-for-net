...
namespace Azure.AI.MetricsAdvisor.Models
{
    ...
    public class DataFeedIngestionSettings
    {
        ...
        /// </summary>
        /// <param name="ingestionStartOn">The starting point in time from which data will be ingested from the data source. Subsequent ingestions happen periodically according to the data feed's granularity.</param>
        public DataFeedIngestionSettings(DateTimeOffset ingestionStartOn)
        {
            IngestionStartOn = ingestionStartOn;
        }

        internal DataFeedIngestionSettings(DataFeedDetail dataFeedDetail)
        {
            IngestionStartOn = dataFeedDetail.DataStartFrom;
        ...
        /// </summary>
        public DateTimeOffset IngestionStartOn { get; set; }
