...
namespace Azure.AI.MetricsAdvisor.Models
{
    ...
    public class DataFeedIngestionSettings
    {
        ...
        /// </summary>
        /// <param name="ingestionStartTime">The starting point in time from which data will be ingested from the data source. Subsequent ingestions happen periodically according to the specified granularity.</param>
