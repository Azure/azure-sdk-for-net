...
namespace Azure.AI.MetricsAdvisor.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataFeedIngestionStatus>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DataFeedIngestionStatus>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DataFeedIngestionStatus>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DataFeedIngestionStatus>)} interface");
            }
        ...
        string IPersistableModel<DataFeedIngestionStatus>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
