...
namespace Azure.AI.MetricsAdvisor.Models
{
    internal partial class HardThresholdConditionPatch : IUtf8JsonSerializable, IJsonModel<HardThresholdConditionPatch>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<HardThresholdConditionPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<HardThresholdConditionPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
