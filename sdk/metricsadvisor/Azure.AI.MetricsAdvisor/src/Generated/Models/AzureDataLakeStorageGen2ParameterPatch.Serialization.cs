...
namespace Azure.AI.MetricsAdvisor.Models
{
    internal partial class AzureDataLakeStorageGen2ParameterPatch : IUtf8JsonSerializable, IModelJsonSerializable<AzureDataLakeStorageGen2ParameterPatch>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<AzureDataLakeStorageGen2ParameterPatch>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="AzureDataLakeStorageGen2ParameterPatch"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="AzureDataLakeStorageGen2ParameterPatch"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="AzureDataLakeStorageGen2ParameterPatch"/>. </summary>
