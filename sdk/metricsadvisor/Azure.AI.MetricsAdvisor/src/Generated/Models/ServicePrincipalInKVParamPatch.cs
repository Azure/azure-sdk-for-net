...
namespace Azure.AI.MetricsAdvisor.Models
{
    ...
    internal partial class ServicePrincipalInKVParamPatch
    {
        ...
        internal ServicePrincipalInKVParamPatch(string keyVaultEndpoint, string keyVaultClientId, string keyVaultClientSecret, string servicePrincipalIdNameInKV, string servicePrincipalSecretNameInKV, string tenantId, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
