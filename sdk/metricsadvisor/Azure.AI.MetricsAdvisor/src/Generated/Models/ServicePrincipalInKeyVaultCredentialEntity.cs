...
namespace Azure.AI.MetricsAdvisor.Administration
{
    ...
    public partial class ServicePrincipalInKeyVaultCredentialEntity : DataSourceCredentialEntity
    {
        ...
        internal ServicePrincipalInKeyVaultCredentialEntity(DataSourceCredentialKind credentialKind, string id, string name, string description, IDictionary<string, BinaryData> serializedAdditionalRawData, ServicePrincipalInKVParam parameters) : base(credentialKind, id, name, description, serializedAdditionalRawData)
        {
