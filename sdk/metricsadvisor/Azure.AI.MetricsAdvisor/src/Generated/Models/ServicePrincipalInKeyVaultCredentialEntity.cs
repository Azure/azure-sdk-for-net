...
namespace Azure.AI.MetricsAdvisor.Administration
{
    ...
    public partial class ServicePrincipalInKeyVaultCredentialEntity : DataSourceCredentialEntity
    {
        ...
        internal ServicePrincipalInKeyVaultCredentialEntity(DataSourceCredentialKind credentialKind, string id, string name, string description, ServicePrincipalInKVParam parameters, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(credentialKind, id, name, description, serializedAdditionalRawData)
        {
