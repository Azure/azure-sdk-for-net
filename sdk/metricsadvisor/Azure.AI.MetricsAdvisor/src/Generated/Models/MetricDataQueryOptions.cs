...
namespace Azure.AI.MetricsAdvisor.Models
{
    ...
    internal partial class MetricDataQueryOptions
    {
        ...
        internal MetricDataQueryOptions(DateTimeOffset startTime, DateTimeOffset endTime, IList<IDictionary<string, string>> series, Dictionary<string, BinaryData> rawData)
        {
            StartTime = startTime;
            EndTime = endTime;
            Series = series;
