...
{
    internal partial class AzureDataExplorerDataFeed : IUtf8JsonSerializable, IJsonModel<AzureDataExplorerDataFeed>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureDataExplorerDataFeed>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<AzureDataExplorerDataFeed>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AzureDataExplorerDataFeed>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AzureDataExplorerDataFeed>)} interface");
            }
        ...
        AzureDataExplorerDataFeed IJsonModel<AzureDataExplorerDataFeed>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == "J" || options.Format == "W";
            if (!isValid)
            {
                throw new FormatException($"The model {nameof(AzureDataExplorerDataFeed)} does not support '{options.Format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeAzureDataExplorerDataFeed(document.RootElement, options);
        }

        internal static AzureDataExplorerDataFeed DeserializeAzureDataExplorerDataFeed(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<AzureDataExplorerDataFeed>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == "J" || options.Format == "W";
            if (!isValid)
            {
        ...
        AzureDataExplorerDataFeed IPersistableModel<AzureDataExplorerDataFeed>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == "J" || options.Format == "W";
            if (!isValid)
            {
        ...
        string IPersistableModel<AzureDataExplorerDataFeed>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
