...
namespace Azure.AI.MetricsAdvisor.Models
{
    internal partial class AzureDataExplorerDataFeed : IUtf8JsonSerializable
    {
        ...
        internal static AzureDataExplorerDataFeed DeserializeAzureDataExplorerDataFeed(JsonElement element)
        {
            ...
            return new AzureDataExplorerDataFeed(
                dataSourceType,
                dataFeedId,
                dataFeedName,
                dataFeedDescription,
        ...
        internal static new AzureDataExplorerDataFeed FromResponse(Response response)
        {
            using var document = JsonDocument.Parse(response.Content);
            return DeserializeAzureDataExplorerDataFeed(document.RootElement);
        }
        ...
        internal override RequestContent ToRequestContent()
        {
            ...
            content.JsonWriter.WriteObjectValue<AzureDataExplorerDataFeed>(this);
            return content;
        }
    }
}
