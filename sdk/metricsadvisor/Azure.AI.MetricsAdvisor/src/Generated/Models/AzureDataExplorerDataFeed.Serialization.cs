...
namespace Azure.AI.MetricsAdvisor.Models
{
    internal partial class AzureDataExplorerDataFeed : IUtf8JsonSerializable, IJsonModel<AzureDataExplorerDataFeed>
    {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureDataExplorerDataFeed>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(AzureDataExplorerDataFeed)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<AzureDataExplorerDataFeed>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(AzureDataExplorerDataFeed)} does not support '{options.Format}' format.");
            }
        }
