...
{
    internal partial class AzureDataExplorerDataFeed : IUtf8JsonSerializable, IModelJsonSerializable<AzureDataExplorerDataFeed>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IModelJsonSerializable<AzureDataExplorerDataFeed>)this).Serialize(writer, ModelSerializerOptions.DefaultWireOptions);

        void IModelJsonSerializable<AzureDataExplorerDataFeed>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<AzureDataExplorerDataFeed>(this, options.Format);
        ...
        internal static AzureDataExplorerDataFeed DeserializeAzureDataExplorerDataFeed(JsonElement element, ModelSerializerOptions options = default)
        {
        ...
        AzureDataExplorerDataFeed IModelJsonSerializable<AzureDataExplorerDataFeed>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<AzureDataExplorerDataFeed>(this, options.Format);

            using var doc = JsonDocument.ParseValue(ref reader);
            return DeserializeAzureDataExplorerDataFeed(doc.RootElement, options);
        }

        BinaryData IModelSerializable<AzureDataExplorerDataFeed>.Serialize(ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<AzureDataExplorerDataFeed>(this, options.Format);
        ...
        AzureDataExplorerDataFeed IModelSerializable<AzureDataExplorerDataFeed>.Deserialize(BinaryData data, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<AzureDataExplorerDataFeed>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="AzureDataExplorerDataFeed"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="AzureDataExplorerDataFeed"/> to convert. </param>
        public static implicit operator RequestContent(AzureDataExplorerDataFeed model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="AzureDataExplorerDataFeed"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator AzureDataExplorerDataFeed(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeAzureDataExplorerDataFeed(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
