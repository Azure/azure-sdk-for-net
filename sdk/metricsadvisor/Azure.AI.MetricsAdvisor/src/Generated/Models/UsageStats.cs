...
namespace Azure.AI.MetricsAdvisor.Models
{
    ...
    internal partial class UsageStats
    {
        ...
        internal UsageStats(DateTimeOffset? timestamp, int? activeSeriesCount, int? allSeriesCount, int? metricsCount, int? dataFeedCount, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Timestamp = timestamp;
