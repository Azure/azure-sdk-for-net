...
namespace Azure.AI.MetricsAdvisor.Models
{
    ...
    internal partial class EmailHookInfoPatch : HookInfoPatch
    {
        ...
        internal EmailHookInfoPatch(NotificationHookKind hookType, string hookName, string description, string externalLink, IList<string> admins, EmailHookParameterPatch hookParameter, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(hookType, hookName, description, externalLink, admins, serializedAdditionalRawData)
        {
