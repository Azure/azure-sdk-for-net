...
namespace Azure.AI.MetricsAdvisor.Models
{
    internal partial class AzureApplicationInsightsDataFeedPatch : IUtf8JsonSerializable, IJsonModel<AzureApplicationInsightsDataFeedPatch>
    {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureApplicationInsightsDataFeedPatch>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(AzureApplicationInsightsDataFeedPatch)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<AzureApplicationInsightsDataFeedPatch>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(AzureApplicationInsightsDataFeedPatch)} does not support '{options.Format}' format.");
            }
        }
