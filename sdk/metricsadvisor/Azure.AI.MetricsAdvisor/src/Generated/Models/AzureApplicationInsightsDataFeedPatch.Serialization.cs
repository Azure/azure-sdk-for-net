...
{
    internal partial class AzureApplicationInsightsDataFeedPatch : IUtf8JsonSerializable, IModelJsonSerializable<AzureApplicationInsightsDataFeedPatch>
    {
        void IModelJsonSerializable<AzureApplicationInsightsDataFeedPatch>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<AzureApplicationInsightsDataFeedPatch>(this, options.Format);
            ...
            if (Optional.IsDefined(DataSourceParameter))
            {
                ...
                {
                    ((IModelJsonSerializable<AzureApplicationInsightsParameterPatch>)DataSourceParameter).Serialize(writer, options);
                }
            }
        ...
        internal static AzureApplicationInsightsDataFeedPatch DeserializeAzureApplicationInsightsDataFeedPatch(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            Optional<AzureApplicationInsightsParameterPatch> dataSourceParameter = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("dataSourceParameter"u8))
                {
                    ...
                    dataSourceParameter = AzureApplicationInsightsParameterPatch.DeserializeAzureApplicationInsightsParameterPatch(property.Value);
                    continue;
                }
        ...
        AzureApplicationInsightsDataFeedPatch IModelJsonSerializable<AzureApplicationInsightsDataFeedPatch>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<AzureApplicationInsightsDataFeedPatch>(this, options.Format);

            using var doc = JsonDocument.ParseValue(ref reader);
            return DeserializeAzureApplicationInsightsDataFeedPatch(doc.RootElement, options);
        }

        BinaryData IModelSerializable<AzureApplicationInsightsDataFeedPatch>.Serialize(ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<AzureApplicationInsightsDataFeedPatch>(this, options.Format);
        ...
        AzureApplicationInsightsDataFeedPatch IModelSerializable<AzureApplicationInsightsDataFeedPatch>.Deserialize(BinaryData data, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<AzureApplicationInsightsDataFeedPatch>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="AzureApplicationInsightsDataFeedPatch"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="AzureApplicationInsightsDataFeedPatch"/> to convert. </param>
        public static implicit operator RequestContent(AzureApplicationInsightsDataFeedPatch model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="AzureApplicationInsightsDataFeedPatch"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator AzureApplicationInsightsDataFeedPatch(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeAzureApplicationInsightsDataFeedPatch(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
