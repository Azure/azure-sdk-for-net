...
{
    internal partial class AzureApplicationInsightsDataFeedPatch : IUtf8JsonSerializable, IJsonModel<AzureApplicationInsightsDataFeedPatch>
    {
        void IJsonModel<AzureApplicationInsightsDataFeedPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AzureApplicationInsightsDataFeedPatch>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AzureApplicationInsightsDataFeedPatch>)} interface");
            }
        ...
        AzureApplicationInsightsDataFeedPatch IJsonModel<AzureApplicationInsightsDataFeedPatch>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == "J" || options.Format == "W";
            if (!isValid)
            {
                throw new FormatException($"The model {nameof(AzureApplicationInsightsDataFeedPatch)} does not support '{options.Format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeAzureApplicationInsightsDataFeedPatch(document.RootElement, options);
        }

        internal static AzureApplicationInsightsDataFeedPatch DeserializeAzureApplicationInsightsDataFeedPatch(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<AzureApplicationInsightsDataFeedPatch>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == "J" || options.Format == "W";
            if (!isValid)
            {
        ...
        AzureApplicationInsightsDataFeedPatch IPersistableModel<AzureApplicationInsightsDataFeedPatch>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == "J" || options.Format == "W";
            if (!isValid)
            {
        ...
        string IPersistableModel<AzureApplicationInsightsDataFeedPatch>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
