...
namespace Azure.AI.MetricsAdvisor.Models
{
    internal partial class AzureApplicationInsightsDataFeedPatch : IUtf8JsonSerializable, IJsonModel<AzureApplicationInsightsDataFeedPatch>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<AzureApplicationInsightsDataFeedPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<AzureApplicationInsightsDataFeedPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
