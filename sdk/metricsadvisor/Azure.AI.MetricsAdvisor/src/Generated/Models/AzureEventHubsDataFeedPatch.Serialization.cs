...
namespace Azure.AI.MetricsAdvisor.Models
{
    internal partial class AzureEventHubsDataFeedPatch : IUtf8JsonSerializable, IJsonModel<AzureEventHubsDataFeedPatch>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<AzureEventHubsDataFeedPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<AzureEventHubsDataFeedPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
