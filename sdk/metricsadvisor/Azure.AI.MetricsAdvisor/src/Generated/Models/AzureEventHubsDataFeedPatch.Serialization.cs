...
namespace Azure.AI.MetricsAdvisor.Models
{
    internal partial class AzureEventHubsDataFeedPatch : IUtf8JsonSerializable, IJsonModel<AzureEventHubsDataFeedPatch>
    {
        ...
        AzureEventHubsDataFeedPatch IJsonModel<AzureEventHubsDataFeedPatch>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<AzureEventHubsDataFeedPatch>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        AzureEventHubsDataFeedPatch IModel<AzureEventHubsDataFeedPatch>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<AzureEventHubsDataFeedPatch>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
