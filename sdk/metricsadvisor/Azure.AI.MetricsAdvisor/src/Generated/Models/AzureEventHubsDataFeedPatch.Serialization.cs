...
{
    internal partial class AzureEventHubsDataFeedPatch : IUtf8JsonSerializable, IJsonModel<AzureEventHubsDataFeedPatch>
    {
        void IJsonModel<AzureEventHubsDataFeedPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AzureEventHubsDataFeedPatch>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AzureEventHubsDataFeedPatch>)} interface");
            }
        ...
        AzureEventHubsDataFeedPatch IJsonModel<AzureEventHubsDataFeedPatch>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == "J" || options.Format == "W";
            if (!isValid)
            {
                throw new FormatException($"The model {nameof(AzureEventHubsDataFeedPatch)} does not support '{options.Format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeAzureEventHubsDataFeedPatch(document.RootElement, options);
        }

        internal static AzureEventHubsDataFeedPatch DeserializeAzureEventHubsDataFeedPatch(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<AzureEventHubsDataFeedPatch>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == "J" || options.Format == "W";
            if (!isValid)
            {
        ...
        AzureEventHubsDataFeedPatch IPersistableModel<AzureEventHubsDataFeedPatch>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == "J" || options.Format == "W";
            if (!isValid)
            {
        ...
        string IPersistableModel<AzureEventHubsDataFeedPatch>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
