...
namespace Azure.AI.MetricsAdvisor.Models
{
    internal partial class AzureEventHubsDataFeedPatch : IUtf8JsonSerializable, IJsonModel<AzureEventHubsDataFeedPatch>
    {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureEventHubsDataFeedPatch>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(AzureEventHubsDataFeedPatch)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<AzureEventHubsDataFeedPatch>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(AzureEventHubsDataFeedPatch)} does not support '{options.Format}' format.");
            }
        }
