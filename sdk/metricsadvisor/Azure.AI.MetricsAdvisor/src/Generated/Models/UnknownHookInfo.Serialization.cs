...
namespace Azure.AI.MetricsAdvisor.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NotificationHook>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NotificationHook>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NotificationHook>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<NotificationHook>)} interface");
            }
        ...
        string IPersistableModel<NotificationHook>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
