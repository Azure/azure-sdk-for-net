...
namespace Azure.AI.MetricsAdvisor.Models
{
    ...
    internal partial class InfluxDBParameterPatch
    {
        ...
        internal InfluxDBParameterPatch(string connectionString, string database, string userName, string password, string query, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
