...
namespace Azure.AI.MetricsAdvisor.Models
{
    internal partial class AzureApplicationInsightsParameterPatch : IUtf8JsonSerializable, IJsonModel<AzureApplicationInsightsParameterPatch>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<AzureApplicationInsightsParameterPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<AzureApplicationInsightsParameterPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
