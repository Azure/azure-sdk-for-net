...
namespace Azure.AI.MetricsAdvisor.Models
{
    internal partial class AzureApplicationInsightsParameterPatch : IUtf8JsonSerializable, IJsonModel<AzureApplicationInsightsParameterPatch>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<AzureApplicationInsightsParameterPatch>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AzureApplicationInsightsParameterPatch>)} interface");
            }
