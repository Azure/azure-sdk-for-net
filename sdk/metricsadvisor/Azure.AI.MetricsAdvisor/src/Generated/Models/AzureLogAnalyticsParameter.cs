...
namespace Azure.AI.MetricsAdvisor.Models
{
    ...
    internal partial class AzureLogAnalyticsParameter
    {
        ...
        internal AzureLogAnalyticsParameter(string tenantId, string clientId, string clientSecret, string workspaceId, string query, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            TenantId = tenantId;
            ClientId = clientId;
