...
namespace Azure.AI.MetricsAdvisor.Models
{
    ...
    internal partial class MetricSeriesQueryOptions
    {
        ...
        internal MetricSeriesQueryOptions(DateTimeOffset activeSince, IDictionary<string, IList<string>> dimensionFilter, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ActiveSince = activeSince;
