...
namespace Azure.AI.MetricsAdvisor.Models
{
    internal partial class ServicePrincipalParamPatch : IUtf8JsonSerializable, IJsonModel<ServicePrincipalParamPatch>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<ServicePrincipalParamPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<ServicePrincipalParamPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
