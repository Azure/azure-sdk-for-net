...
{
    internal partial class AzureBlobDataFeedPatch : IUtf8JsonSerializable, IModelJsonSerializable<AzureBlobDataFeedPatch>
    {
        void IModelJsonSerializable<AzureBlobDataFeedPatch>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<AzureBlobDataFeedPatch>(this, options.Format);
            ...
            if (Optional.IsDefined(DataSourceParameter))
            {
                ...
                {
                    ((IModelJsonSerializable<AzureBlobParameterPatch>)DataSourceParameter).Serialize(writer, options);
                }
            }
        ...
        internal static AzureBlobDataFeedPatch DeserializeAzureBlobDataFeedPatch(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            Optional<AzureBlobParameterPatch> dataSourceParameter = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("dataSourceParameter"u8))
                {
                    ...
                    dataSourceParameter = AzureBlobParameterPatch.DeserializeAzureBlobParameterPatch(property.Value);
                    continue;
                }
            ...
            return new AzureBlobDataFeedPatch(dataSourceType, dataFeedName.Value, dataFeedDescription.Value, timestampColumn.Value, Optional.ToNullable(dataStartFrom), Optional.ToNullable(startOffsetInSeconds), Optional.ToNullable(maxConcurrency), Optional.ToNullable(minRetryIntervalInSeconds), Optional.ToNullable(stopRetryAfterInSeconds), Optional.ToNullable(needRollup), Optional.ToNullable(rollUpMethod), Optional.ToList(rollUpColumns), allUpIdentification.Value, Optional.ToNullable(fillMissingPointType), Optional.ToNullable(fillMissingPointValue), Optional.ToNullable(viewMode), Optional.ToList(admins), Optional.ToList(viewers), Optional.ToNullable(status), actionLinkTemplate.Value, Optional.ToNullable(authenticationType), credentialId.Value, dataSourceParameter.Value, rawData);
        }

        AzureBlobDataFeedPatch IModelJsonSerializable<AzureBlobDataFeedPatch>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<AzureBlobDataFeedPatch>(this, options.Format);

            using var doc = JsonDocument.ParseValue(ref reader);
            return DeserializeAzureBlobDataFeedPatch(doc.RootElement, options);
        }

        BinaryData IModelSerializable<AzureBlobDataFeedPatch>.Serialize(ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<AzureBlobDataFeedPatch>(this, options.Format);
        ...
        AzureBlobDataFeedPatch IModelSerializable<AzureBlobDataFeedPatch>.Deserialize(BinaryData data, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<AzureBlobDataFeedPatch>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="AzureBlobDataFeedPatch"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="AzureBlobDataFeedPatch"/> to convert. </param>
        public static implicit operator RequestContent(AzureBlobDataFeedPatch model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="AzureBlobDataFeedPatch"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator AzureBlobDataFeedPatch(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeAzureBlobDataFeedPatch(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
