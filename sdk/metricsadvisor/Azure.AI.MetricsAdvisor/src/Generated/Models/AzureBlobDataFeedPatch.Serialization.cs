...
namespace Azure.AI.MetricsAdvisor.Models
{
    internal partial class AzureBlobDataFeedPatch : IUtf8JsonSerializable, IJsonModel<AzureBlobDataFeedPatch>
    {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureBlobDataFeedPatch>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(AzureBlobDataFeedPatch)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<AzureBlobDataFeedPatch>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(AzureBlobDataFeedPatch)} does not support '{options.Format}' format.");
            }
        }
