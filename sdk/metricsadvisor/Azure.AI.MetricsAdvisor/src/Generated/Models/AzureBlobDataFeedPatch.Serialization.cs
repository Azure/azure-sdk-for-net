...
namespace Azure.AI.MetricsAdvisor.Models
{
    internal partial class AzureBlobDataFeedPatch : IUtf8JsonSerializable, IJsonModel<AzureBlobDataFeedPatch>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<AzureBlobDataFeedPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<AzureBlobDataFeedPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
