...
namespace Azure.AI.MetricsAdvisor.Models
{
    ...
    internal partial class DetectionSeriesQuery
    {
        ...
        internal DetectionSeriesQuery(DateTimeOffset startTime, DateTimeOffset endTime, IList<SeriesIdentity> series, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            StartTime = startTime;
            EndTime = endTime;
            Series = series;
