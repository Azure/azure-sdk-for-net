...
namespace Azure.AI.MetricsAdvisor.Models
{
    internal partial class InfluxDBParameterPatch : IUtf8JsonSerializable, IJsonModel<InfluxDBParameterPatch>
    {
        ...
        InfluxDBParameterPatch IJsonModel<InfluxDBParameterPatch>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<InfluxDBParameterPatch>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        InfluxDBParameterPatch IModel<InfluxDBParameterPatch>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<InfluxDBParameterPatch>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
