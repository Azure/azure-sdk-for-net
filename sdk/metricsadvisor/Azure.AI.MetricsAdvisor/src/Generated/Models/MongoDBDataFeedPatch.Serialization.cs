...
{
    internal partial class MongoDBDataFeedPatch : IUtf8JsonSerializable, IJsonModel<MongoDBDataFeedPatch>
    {
        void IJsonModel<MongoDBDataFeedPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MongoDBDataFeedPatch>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MongoDBDataFeedPatch>)} interface");
            }
        ...
        MongoDBDataFeedPatch IJsonModel<MongoDBDataFeedPatch>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == "J" || options.Format == "W";
            if (!isValid)
            {
                throw new FormatException($"The model {nameof(MongoDBDataFeedPatch)} does not support '{options.Format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeMongoDBDataFeedPatch(document.RootElement, options);
        }

        internal static MongoDBDataFeedPatch DeserializeMongoDBDataFeedPatch(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<MongoDBDataFeedPatch>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == "J" || options.Format == "W";
            if (!isValid)
            {
        ...
        MongoDBDataFeedPatch IPersistableModel<MongoDBDataFeedPatch>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == "J" || options.Format == "W";
            if (!isValid)
            {
        ...
        string IPersistableModel<MongoDBDataFeedPatch>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
