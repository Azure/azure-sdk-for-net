...
namespace Azure.AI.MetricsAdvisor.Models
{
    internal partial class MongoDBDataFeedPatch : IUtf8JsonSerializable, IJsonModel<MongoDBDataFeedPatch>
    {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<MongoDBDataFeedPatch>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(MongoDBDataFeedPatch)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<MongoDBDataFeedPatch>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(MongoDBDataFeedPatch)} does not support '{options.Format}' format.");
            }
        }
