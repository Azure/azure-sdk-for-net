...
namespace Azure.AI.MetricsAdvisor.Models
{
    internal partial class MongoDBDataFeedPatch : IUtf8JsonSerializable, IJsonModel<MongoDBDataFeedPatch>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<MongoDBDataFeedPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<MongoDBDataFeedPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
