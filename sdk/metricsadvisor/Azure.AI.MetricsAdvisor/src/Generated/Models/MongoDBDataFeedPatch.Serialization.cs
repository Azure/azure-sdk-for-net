...
namespace Azure.AI.MetricsAdvisor.Models
{
    internal partial class MongoDBDataFeedPatch : IUtf8JsonSerializable, IJsonModel<MongoDBDataFeedPatch>
    {
        ...
        MongoDBDataFeedPatch IJsonModel<MongoDBDataFeedPatch>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<MongoDBDataFeedPatch>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        MongoDBDataFeedPatch IModel<MongoDBDataFeedPatch>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<MongoDBDataFeedPatch>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
