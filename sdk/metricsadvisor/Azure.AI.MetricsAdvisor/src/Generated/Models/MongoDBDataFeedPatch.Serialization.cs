...
{
    internal partial class MongoDBDataFeedPatch : IUtf8JsonSerializable, IModelJsonSerializable<MongoDBDataFeedPatch>
    {
        void IModelJsonSerializable<MongoDBDataFeedPatch>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<MongoDBDataFeedPatch>(this, options.Format);
            ...
            if (Optional.IsDefined(DataSourceParameter))
            {
                ...
                {
                    ((IModelJsonSerializable<MongoDBParameterPatch>)DataSourceParameter).Serialize(writer, options);
                }
            }
        ...
        internal static MongoDBDataFeedPatch DeserializeMongoDBDataFeedPatch(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            Optional<MongoDBParameterPatch> dataSourceParameter = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("dataSourceParameter"u8))
                {
                    ...
                    dataSourceParameter = MongoDBParameterPatch.DeserializeMongoDBParameterPatch(property.Value);
                    continue;
                }
            ...
            return new MongoDBDataFeedPatch(dataSourceType, dataFeedName.Value, dataFeedDescription.Value, timestampColumn.Value, Optional.ToNullable(dataStartFrom), Optional.ToNullable(startOffsetInSeconds), Optional.ToNullable(maxConcurrency), Optional.ToNullable(minRetryIntervalInSeconds), Optional.ToNullable(stopRetryAfterInSeconds), Optional.ToNullable(needRollup), Optional.ToNullable(rollUpMethod), Optional.ToList(rollUpColumns), allUpIdentification.Value, Optional.ToNullable(fillMissingPointType), Optional.ToNullable(fillMissingPointValue), Optional.ToNullable(viewMode), Optional.ToList(admins), Optional.ToList(viewers), Optional.ToNullable(status), actionLinkTemplate.Value, Optional.ToNullable(authenticationType), credentialId.Value, dataSourceParameter.Value, rawData);
        }

        MongoDBDataFeedPatch IModelJsonSerializable<MongoDBDataFeedPatch>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<MongoDBDataFeedPatch>(this, options.Format);

            using var doc = JsonDocument.ParseValue(ref reader);
            return DeserializeMongoDBDataFeedPatch(doc.RootElement, options);
        }

        BinaryData IModelSerializable<MongoDBDataFeedPatch>.Serialize(ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<MongoDBDataFeedPatch>(this, options.Format);
        ...
        MongoDBDataFeedPatch IModelSerializable<MongoDBDataFeedPatch>.Deserialize(BinaryData data, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<MongoDBDataFeedPatch>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="MongoDBDataFeedPatch"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="MongoDBDataFeedPatch"/> to convert. </param>
        public static implicit operator RequestContent(MongoDBDataFeedPatch model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="MongoDBDataFeedPatch"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator MongoDBDataFeedPatch(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeMongoDBDataFeedPatch(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
