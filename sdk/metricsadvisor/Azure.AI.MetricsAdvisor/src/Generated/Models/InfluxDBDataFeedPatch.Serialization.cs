...
{
    internal partial class InfluxDBDataFeedPatch : IUtf8JsonSerializable, IModelJsonSerializable<InfluxDBDataFeedPatch>
    {
        void IModelJsonSerializable<InfluxDBDataFeedPatch>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<InfluxDBDataFeedPatch>(this, options.Format);
            ...
            if (Optional.IsDefined(DataSourceParameter))
            {
                ...
                {
                    ((IModelJsonSerializable<InfluxDBParameterPatch>)DataSourceParameter).Serialize(writer, options);
                }
            }
        ...
        internal static InfluxDBDataFeedPatch DeserializeInfluxDBDataFeedPatch(JsonElement element, ModelSerializerOptions options = default)
        {
        ...
        InfluxDBDataFeedPatch IModelJsonSerializable<InfluxDBDataFeedPatch>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<InfluxDBDataFeedPatch>(this, options.Format);

            using var doc = JsonDocument.ParseValue(ref reader);
            return DeserializeInfluxDBDataFeedPatch(doc.RootElement, options);
        }

        BinaryData IModelSerializable<InfluxDBDataFeedPatch>.Serialize(ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<InfluxDBDataFeedPatch>(this, options.Format);
        ...
        InfluxDBDataFeedPatch IModelSerializable<InfluxDBDataFeedPatch>.Deserialize(BinaryData data, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<InfluxDBDataFeedPatch>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="InfluxDBDataFeedPatch"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="InfluxDBDataFeedPatch"/> to convert. </param>
        public static implicit operator RequestContent(InfluxDBDataFeedPatch model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="InfluxDBDataFeedPatch"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator InfluxDBDataFeedPatch(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeInfluxDBDataFeedPatch(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
