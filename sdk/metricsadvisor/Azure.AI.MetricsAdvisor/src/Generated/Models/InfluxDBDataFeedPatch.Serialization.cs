...
namespace Azure.AI.MetricsAdvisor.Models
{
    internal partial class InfluxDBDataFeedPatch : IUtf8JsonSerializable, IJsonModel<InfluxDBDataFeedPatch>
    {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<InfluxDBDataFeedPatch>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(InfluxDBDataFeedPatch)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<InfluxDBDataFeedPatch>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(InfluxDBDataFeedPatch)} does not support '{options.Format}' format.");
            }
        }
        ...
        string IPersistableModel<InfluxDBDataFeedPatch>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
