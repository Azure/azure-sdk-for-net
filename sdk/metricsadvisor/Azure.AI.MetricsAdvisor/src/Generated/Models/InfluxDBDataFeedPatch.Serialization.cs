...
namespace Azure.AI.MetricsAdvisor.Models
{
    internal partial class InfluxDBDataFeedPatch : IUtf8JsonSerializable, IJsonModel<InfluxDBDataFeedPatch>
    {
        ...
        InfluxDBDataFeedPatch IJsonModel<InfluxDBDataFeedPatch>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<InfluxDBDataFeedPatch>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        InfluxDBDataFeedPatch IModel<InfluxDBDataFeedPatch>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<InfluxDBDataFeedPatch>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
