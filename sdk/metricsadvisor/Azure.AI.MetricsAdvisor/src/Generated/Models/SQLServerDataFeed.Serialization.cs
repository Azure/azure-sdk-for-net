...
{
    internal partial class SQLServerDataFeed : IUtf8JsonSerializable, IJsonModel<SQLServerDataFeed>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SQLServerDataFeed>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<SQLServerDataFeed>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SQLServerDataFeed>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SQLServerDataFeed>)} interface");
            }
        ...
        SQLServerDataFeed IJsonModel<SQLServerDataFeed>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == "J" || options.Format == "W";
            if (!isValid)
            {
                throw new FormatException($"The model {nameof(SQLServerDataFeed)} does not support '{options.Format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeSQLServerDataFeed(document.RootElement, options);
        }

        internal static SQLServerDataFeed DeserializeSQLServerDataFeed(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<SQLServerDataFeed>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == "J" || options.Format == "W";
            if (!isValid)
            {
        ...
        SQLServerDataFeed IPersistableModel<SQLServerDataFeed>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == "J" || options.Format == "W";
            if (!isValid)
            {
        ...
        string IPersistableModel<SQLServerDataFeed>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
