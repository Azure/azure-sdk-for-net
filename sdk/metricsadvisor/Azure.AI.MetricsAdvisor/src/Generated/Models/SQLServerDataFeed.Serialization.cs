...
namespace Azure.AI.MetricsAdvisor.Models
{
    internal partial class SQLServerDataFeed : IUtf8JsonSerializable, IJsonModel<SQLServerDataFeed>
    {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<SQLServerDataFeed>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(SQLServerDataFeed)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<SQLServerDataFeed>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(SQLServerDataFeed)} does not support '{options.Format}' format.");
            }
        }
