...
namespace Azure.AI.MetricsAdvisor.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SQLServerDataFeed>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SQLServerDataFeed>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SQLServerDataFeed>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<SQLServerDataFeed>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
