...
{
    internal partial class SQLServerDataFeed : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static SQLServerDataFeed DeserializeSQLServerDataFeed(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
