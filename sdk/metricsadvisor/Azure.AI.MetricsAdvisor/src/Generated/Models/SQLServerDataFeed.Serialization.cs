...
{
    internal partial class SQLServerDataFeed : IUtf8JsonSerializable, IModelJsonSerializable<SQLServerDataFeed>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IModelJsonSerializable<SQLServerDataFeed>)this).Serialize(writer, ModelSerializerOptions.DefaultWireOptions);

        void IModelJsonSerializable<SQLServerDataFeed>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<SQLServerDataFeed>(this, options.Format);
        ...
        internal static SQLServerDataFeed DeserializeSQLServerDataFeed(JsonElement element, ModelSerializerOptions options = default)
        {
        ...
        SQLServerDataFeed IModelJsonSerializable<SQLServerDataFeed>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<SQLServerDataFeed>(this, options.Format);

            using var doc = JsonDocument.ParseValue(ref reader);
            return DeserializeSQLServerDataFeed(doc.RootElement, options);
        }

        BinaryData IModelSerializable<SQLServerDataFeed>.Serialize(ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<SQLServerDataFeed>(this, options.Format);
        ...
        SQLServerDataFeed IModelSerializable<SQLServerDataFeed>.Deserialize(BinaryData data, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<SQLServerDataFeed>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="SQLServerDataFeed"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="SQLServerDataFeed"/> to convert. </param>
        public static implicit operator RequestContent(SQLServerDataFeed model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="SQLServerDataFeed"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator SQLServerDataFeed(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeSQLServerDataFeed(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
