...
namespace Azure.AI.MetricsAdvisor.Models
{
    internal partial class DetectionAnomalyResultQuery : IUtf8JsonSerializable, IJsonModel<DetectionAnomalyResultQuery>
    {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<DetectionAnomalyResultQuery>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(DetectionAnomalyResultQuery)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<DetectionAnomalyResultQuery>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(DetectionAnomalyResultQuery)} does not support '{options.Format}' format.");
            }
        }
