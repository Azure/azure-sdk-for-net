...
namespace Azure.AI.MetricsAdvisor.Models
{
    ...
    internal partial class MySqlDataFeed : DataFeedDetail
    {
        ...
        public MySqlDataFeed(string dataFeedName, DataFeedGranularityType granularityName, IEnumerable<DataFeedMetric> metrics, DateTimeOffset dataStartFrom, SqlSourceParameter dataSourceParameter) : base(dataFeedName, granularityName, metrics, dataStartFrom)
        {
