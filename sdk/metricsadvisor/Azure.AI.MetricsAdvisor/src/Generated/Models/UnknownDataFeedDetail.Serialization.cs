...
{
    internal partial class UnknownDataFeedDetail : IUtf8JsonSerializable, IJsonModel<DataFeedDetail>
    {
        ...
        DataFeedDetail IJsonModel<DataFeedDetail>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            return DeserializeUnknownDataFeedDetail(document.RootElement, options);
        }

        internal static UnknownDataFeedDetail DeserializeUnknownDataFeedDetail(JsonElement element, ModelReaderWriterOptions options = null)
        {
