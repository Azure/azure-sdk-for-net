...
{
    internal partial class AzureLogAnalyticsDataFeedPatch : IUtf8JsonSerializable, IJsonModel<AzureLogAnalyticsDataFeedPatch>
    {
        void IJsonModel<AzureLogAnalyticsDataFeedPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AzureLogAnalyticsDataFeedPatch>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AzureLogAnalyticsDataFeedPatch>)} interface");
            }
        ...
        AzureLogAnalyticsDataFeedPatch IJsonModel<AzureLogAnalyticsDataFeedPatch>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == "J" || options.Format == "W";
            if (!isValid)
            {
                throw new FormatException($"The model {nameof(AzureLogAnalyticsDataFeedPatch)} does not support '{options.Format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeAzureLogAnalyticsDataFeedPatch(document.RootElement, options);
        }

        internal static AzureLogAnalyticsDataFeedPatch DeserializeAzureLogAnalyticsDataFeedPatch(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<AzureLogAnalyticsDataFeedPatch>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == "J" || options.Format == "W";
            if (!isValid)
            {
        ...
        AzureLogAnalyticsDataFeedPatch IPersistableModel<AzureLogAnalyticsDataFeedPatch>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == "J" || options.Format == "W";
            if (!isValid)
            {
        ...
        string IPersistableModel<AzureLogAnalyticsDataFeedPatch>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
