...
namespace Azure.AI.MetricsAdvisor.Models
{
    internal partial class AzureLogAnalyticsDataFeedPatch : IUtf8JsonSerializable, IJsonModel<AzureLogAnalyticsDataFeedPatch>
    {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureLogAnalyticsDataFeedPatch>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(AzureLogAnalyticsDataFeedPatch)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<AzureLogAnalyticsDataFeedPatch>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(AzureLogAnalyticsDataFeedPatch)} does not support '{options.Format}' format.");
            }
        }
