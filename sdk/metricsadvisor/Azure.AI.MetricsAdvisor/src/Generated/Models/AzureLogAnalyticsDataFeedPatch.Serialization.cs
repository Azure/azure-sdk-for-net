...
namespace Azure.AI.MetricsAdvisor.Models
{
    internal partial class AzureLogAnalyticsDataFeedPatch : IUtf8JsonSerializable, IJsonModel<AzureLogAnalyticsDataFeedPatch>
    {
        ...
        AzureLogAnalyticsDataFeedPatch IJsonModel<AzureLogAnalyticsDataFeedPatch>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<AzureLogAnalyticsDataFeedPatch>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        AzureLogAnalyticsDataFeedPatch IModel<AzureLogAnalyticsDataFeedPatch>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<AzureLogAnalyticsDataFeedPatch>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
