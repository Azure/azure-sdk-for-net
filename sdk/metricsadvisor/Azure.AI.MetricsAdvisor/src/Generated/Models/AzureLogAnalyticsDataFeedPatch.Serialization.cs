...
{
    internal partial class AzureLogAnalyticsDataFeedPatch : IUtf8JsonSerializable, IModelJsonSerializable<AzureLogAnalyticsDataFeedPatch>
    {
        void IModelJsonSerializable<AzureLogAnalyticsDataFeedPatch>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<AzureLogAnalyticsDataFeedPatch>(this, options.Format);
            ...
            if (Optional.IsDefined(DataSourceParameter))
            {
                ...
                {
                    ((IModelJsonSerializable<AzureLogAnalyticsParameterPatch>)DataSourceParameter).Serialize(writer, options);
                }
            }
        ...
        internal static AzureLogAnalyticsDataFeedPatch DeserializeAzureLogAnalyticsDataFeedPatch(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            Optional<AzureLogAnalyticsParameterPatch> dataSourceParameter = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("dataSourceParameter"u8))
                {
                    ...
                    dataSourceParameter = AzureLogAnalyticsParameterPatch.DeserializeAzureLogAnalyticsParameterPatch(property.Value);
                    continue;
                }
            ...
            return new AzureLogAnalyticsDataFeedPatch(dataSourceType, dataFeedName.Value, dataFeedDescription.Value, timestampColumn.Value, Optional.ToNullable(dataStartFrom), Optional.ToNullable(startOffsetInSeconds), Optional.ToNullable(maxConcurrency), Optional.ToNullable(minRetryIntervalInSeconds), Optional.ToNullable(stopRetryAfterInSeconds), Optional.ToNullable(needRollup), Optional.ToNullable(rollUpMethod), Optional.ToList(rollUpColumns), allUpIdentification.Value, Optional.ToNullable(fillMissingPointType), Optional.ToNullable(fillMissingPointValue), Optional.ToNullable(viewMode), Optional.ToList(admins), Optional.ToList(viewers), Optional.ToNullable(status), actionLinkTemplate.Value, Optional.ToNullable(authenticationType), credentialId.Value, dataSourceParameter.Value, serializedAdditionalRawData);
        }

        AzureLogAnalyticsDataFeedPatch IModelJsonSerializable<AzureLogAnalyticsDataFeedPatch>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<AzureLogAnalyticsDataFeedPatch>(this, options.Format);

            using var doc = JsonDocument.ParseValue(ref reader);
            return DeserializeAzureLogAnalyticsDataFeedPatch(doc.RootElement, options);
        }

        BinaryData IModelSerializable<AzureLogAnalyticsDataFeedPatch>.Serialize(ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<AzureLogAnalyticsDataFeedPatch>(this, options.Format);
        ...
        AzureLogAnalyticsDataFeedPatch IModelSerializable<AzureLogAnalyticsDataFeedPatch>.Deserialize(BinaryData data, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<AzureLogAnalyticsDataFeedPatch>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="AzureLogAnalyticsDataFeedPatch"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="AzureLogAnalyticsDataFeedPatch"/> to convert. </param>
        public static implicit operator RequestContent(AzureLogAnalyticsDataFeedPatch model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="AzureLogAnalyticsDataFeedPatch"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator AzureLogAnalyticsDataFeedPatch(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeAzureLogAnalyticsDataFeedPatch(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
