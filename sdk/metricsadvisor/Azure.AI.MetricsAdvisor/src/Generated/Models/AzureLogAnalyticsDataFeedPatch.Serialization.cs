...
namespace Azure.AI.MetricsAdvisor.Models
{
    internal partial class AzureLogAnalyticsDataFeedPatch : IUtf8JsonSerializable, IJsonModel<AzureLogAnalyticsDataFeedPatch>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<AzureLogAnalyticsDataFeedPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<AzureLogAnalyticsDataFeedPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
