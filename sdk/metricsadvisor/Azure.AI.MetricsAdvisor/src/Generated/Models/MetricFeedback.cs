...
namespace Azure.AI.MetricsAdvisor
{
    ...
    public abstract partial class MetricFeedback
    {
        ...
        internal MetricFeedback(MetricFeedbackKind feedbackKind, string id, DateTimeOffset? createdOn, string userPrincipal, string metricId, FeedbackFilter dimensionFilter, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
