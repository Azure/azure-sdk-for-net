...
namespace Azure.AI.MetricsAdvisor.Models
{
    ...
    internal partial class AnomalyProperty
    {
        ...
        internal AnomalyProperty(AnomalySeverity anomalySeverity, AnomalyStatus? anomalyStatus, double value, double? expectedValue, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            AnomalySeverity = anomalySeverity;
