...
{
    public partial class MetricWholeSeriesDetectionCondition : Core.IUtf8JsonSerializable
    {
        ...
        internal static MetricWholeSeriesDetectionCondition DeserializeMetricWholeSeriesDetectionCondition(JsonElement element)
        {
            ...
            return new MetricWholeSeriesDetectionCondition(Core.Optional.ToNullable(conditionOperator), smartDetectionCondition.Value, hardThresholdCondition.Value, changeThresholdCondition.Value);
        }
    }
}
