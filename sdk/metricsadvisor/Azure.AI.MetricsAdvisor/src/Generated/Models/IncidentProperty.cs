...
namespace Azure.AI.MetricsAdvisor.Models
{
    ...
    internal partial class IncidentProperty
    {
        ...
        internal IncidentProperty(AnomalySeverity maxSeverity, AnomalyIncidentStatus incidentStatus, double valueOfRootNode, double? expectedValueOfRootNode, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            MaxSeverity = maxSeverity;
            IncidentStatus = incidentStatus;
            ValueOfRootNode = valueOfRootNode;
