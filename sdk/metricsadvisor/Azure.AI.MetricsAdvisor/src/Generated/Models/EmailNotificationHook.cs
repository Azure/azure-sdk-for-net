...
namespace Azure.AI.MetricsAdvisor.Administration
{
    ...
    public partial class EmailNotificationHook : NotificationHook
    {
        ...
        internal EmailNotificationHook(NotificationHookKind hookKind, string id, string name, string description, string internalExternalLink, IList<string> administrators, EmailHookParameter hookParameter, Dictionary<string, BinaryData> rawData) : base(hookKind, id, name, description, internalExternalLink, administrators, rawData)
        {
