...
namespace Azure.AI.MetricsAdvisor.Models
{
    public partial class DatasourceCredential : IUtf8JsonSerializable
    {
        ...
        internal static DatasourceCredential DeserializeDataSourceCredentialEntity(JsonElement element)
        {
            if (element.TryGetProperty("dataSourceCredentialType", out JsonElement discriminator))
            {
                switch (discriminator.GetString())
                {
                    ...
                    case "ServicePrincipal": return ServicePrincipalDatasourceCredential.DeserializeServicePrincipalCredentialEntity(element);
