...
namespace Azure.AI.MetricsAdvisor.Models
{
    ...
    public partial class IncidentRootCause
    {
        ...
        internal IncidentRootCause(DimensionKey seriesKey, IReadOnlyList<string> paths, double contributionScore, string description, Dictionary<string, BinaryData> rawData)
        {
            SeriesKey = seriesKey;
            Paths = paths;
            ContributionScore = contributionScore;
