...
namespace Azure.AI.MetricsAdvisor.Models
{
    ...
    internal partial class UnknownDataSourceCredential : DataSourceCredentialEntity
    {
        ...
        internal UnknownDataSourceCredential(DataSourceCredentialKind credentialKind, string id, string name, string description, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(credentialKind, id, name, description, serializedAdditionalRawData)
        {
