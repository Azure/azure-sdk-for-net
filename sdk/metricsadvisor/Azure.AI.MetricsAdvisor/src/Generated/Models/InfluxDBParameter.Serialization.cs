...
{
    internal partial class InfluxDBParameter : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static InfluxDBParameter DeserializeInfluxDBParameter(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
