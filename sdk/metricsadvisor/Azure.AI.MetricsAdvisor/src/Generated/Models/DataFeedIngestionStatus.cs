...
namespace Azure.AI.MetricsAdvisor.Models
{
    ...
    public partial class DataFeedIngestionStatus
    {
        ...
        internal DataFeedIngestionStatus(DateTimeOffset timestamp, IngestionStatusType status, string message, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Timestamp = timestamp;
            Status = status;
            Message = message;
