...
namespace Azure.AI.MetricsAdvisor.Models
{
    ...
    public partial class AnomalyAlert
    {
        ...
        internal AnomalyAlert(string id, DateTimeOffset timestamp, DateTimeOffset createdOn, DateTimeOffset lastModified, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Timestamp = timestamp;
            CreatedOn = createdOn;
