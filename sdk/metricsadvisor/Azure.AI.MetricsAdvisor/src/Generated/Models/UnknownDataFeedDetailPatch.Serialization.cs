...
{
    internal partial class UnknownDataFeedDetailPatch : IUtf8JsonSerializable, IJsonModel<DataFeedDetailPatch>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataFeedDetailPatch>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        DataFeedDetailPatch IJsonModel<DataFeedDetailPatch>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            return DeserializeUnknownDataFeedDetailPatch(document.RootElement, options);
        }

        internal static UnknownDataFeedDetailPatch DeserializeUnknownDataFeedDetailPatch(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new UnknownDataFeedDetailPatch(dataSourceType, dataFeedName.Value, dataFeedDescription.Value, timestampColumn.Value, Optional.ToNullable(dataStartFrom), Optional.ToNullable(startOffsetInSeconds), Optional.ToNullable(maxConcurrency), Optional.ToNullable(minRetryIntervalInSeconds), Optional.ToNullable(stopRetryAfterInSeconds), Optional.ToNullable(needRollup), Optional.ToNullable(rollUpMethod), Optional.ToList(rollUpColumns), allUpIdentification.Value, Optional.ToNullable(fillMissingPointType), Optional.ToNullable(fillMissingPointValue), Optional.ToNullable(viewMode), Optional.ToList(admins), Optional.ToList(viewers), Optional.ToNullable(status), actionLinkTemplate.Value, Optional.ToNullable(authenticationType), credentialId.Value, serializedAdditionalRawData);
        }
