...
namespace Azure.AI.MetricsAdvisor.Models
{
    internal partial class AzureDataExplorerDataFeedPatch : IUtf8JsonSerializable, IJsonModel<AzureDataExplorerDataFeedPatch>
    {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureDataExplorerDataFeedPatch>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(AzureDataExplorerDataFeedPatch)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<AzureDataExplorerDataFeedPatch>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(AzureDataExplorerDataFeedPatch)} does not support '{options.Format}' format.");
            }
        }
