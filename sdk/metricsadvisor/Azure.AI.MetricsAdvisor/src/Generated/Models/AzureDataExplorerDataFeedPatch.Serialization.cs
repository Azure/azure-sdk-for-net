...
{
    internal partial class AzureDataExplorerDataFeedPatch : IUtf8JsonSerializable, IJsonModel<AzureDataExplorerDataFeedPatch>
    {
        void IJsonModel<AzureDataExplorerDataFeedPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AzureDataExplorerDataFeedPatch>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AzureDataExplorerDataFeedPatch>)} interface");
            }
        ...
        AzureDataExplorerDataFeedPatch IJsonModel<AzureDataExplorerDataFeedPatch>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == "J" || options.Format == "W";
            if (!isValid)
            {
                throw new FormatException($"The model {nameof(AzureDataExplorerDataFeedPatch)} does not support '{options.Format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeAzureDataExplorerDataFeedPatch(document.RootElement, options);
        }

        internal static AzureDataExplorerDataFeedPatch DeserializeAzureDataExplorerDataFeedPatch(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<AzureDataExplorerDataFeedPatch>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == "J" || options.Format == "W";
            if (!isValid)
            {
        ...
        AzureDataExplorerDataFeedPatch IPersistableModel<AzureDataExplorerDataFeedPatch>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == "J" || options.Format == "W";
            if (!isValid)
            {
        ...
        string IPersistableModel<AzureDataExplorerDataFeedPatch>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
