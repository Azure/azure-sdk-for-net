...
namespace Azure.AI.MetricsAdvisor.Models
{
    internal partial class AzureDataExplorerDataFeedPatch : IUtf8JsonSerializable, IJsonModel<AzureDataExplorerDataFeedPatch>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<AzureDataExplorerDataFeedPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<AzureDataExplorerDataFeedPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
