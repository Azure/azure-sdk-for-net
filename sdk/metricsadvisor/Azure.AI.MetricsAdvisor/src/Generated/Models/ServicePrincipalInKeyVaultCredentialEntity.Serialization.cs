...
namespace Azure.AI.MetricsAdvisor.Administration
{
    public partial class ServicePrincipalInKeyVaultCredentialEntity : IUtf8JsonSerializable, IModelJsonSerializable<ServicePrincipalInKeyVaultCredentialEntity>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<ServicePrincipalInKeyVaultCredentialEntity>(this, options.Format);
            ...
            {
                ((IModelJsonSerializable<ServicePrincipalInKVParam>)Parameters).Serialize(writer, options);
            }
        ...
        internal static ServicePrincipalInKeyVaultCredentialEntity DeserializeServicePrincipalInKeyVaultCredentialEntity(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new ServicePrincipalInKeyVaultCredentialEntity(dataSourceCredentialType, dataSourceCredentialId.Value, dataSourceCredentialName, dataSourceCredentialDescription.Value, parameters, serializedAdditionalRawData);
        }
        ...
        /// <summary> Converts a <see cref="ServicePrincipalInKeyVaultCredentialEntity"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="ServicePrincipalInKeyVaultCredentialEntity"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="ServicePrincipalInKeyVaultCredentialEntity"/>. </summary>
