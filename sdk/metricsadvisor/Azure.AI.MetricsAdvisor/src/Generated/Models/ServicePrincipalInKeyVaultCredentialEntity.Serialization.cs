...
{
    public partial class ServicePrincipalInKeyVaultCredentialEntity : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ServicePrincipalInKeyVaultCredentialEntity DeserializeServicePrincipalInKeyVaultCredentialEntity(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
