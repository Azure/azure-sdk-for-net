...
{
    internal partial class MongoDBDataFeed : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static MongoDBDataFeed DeserializeMongoDBDataFeed(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
