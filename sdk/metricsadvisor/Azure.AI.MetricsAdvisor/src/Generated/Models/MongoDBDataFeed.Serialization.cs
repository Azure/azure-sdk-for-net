...
{
    internal partial class MongoDBDataFeed : IUtf8JsonSerializable, IModelJsonSerializable<MongoDBDataFeed>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IModelJsonSerializable<MongoDBDataFeed>)this).Serialize(writer, ModelSerializerOptions.DefaultWireOptions);

        void IModelJsonSerializable<MongoDBDataFeed>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<MongoDBDataFeed>(this, options.Format);
            ...
            {
                ((IModelJsonSerializable<MongoDBParameter>)DataSourceParameter).Serialize(writer, options);
            }
        ...
        internal static MongoDBDataFeed DeserializeMongoDBDataFeed(JsonElement element, ModelSerializerOptions options = default)
        {
        ...
        MongoDBDataFeed IModelJsonSerializable<MongoDBDataFeed>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<MongoDBDataFeed>(this, options.Format);

            using var doc = JsonDocument.ParseValue(ref reader);
            return DeserializeMongoDBDataFeed(doc.RootElement, options);
        }

        BinaryData IModelSerializable<MongoDBDataFeed>.Serialize(ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<MongoDBDataFeed>(this, options.Format);
        ...
        MongoDBDataFeed IModelSerializable<MongoDBDataFeed>.Deserialize(BinaryData data, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<MongoDBDataFeed>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="MongoDBDataFeed"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="MongoDBDataFeed"/> to convert. </param>
        public static implicit operator RequestContent(MongoDBDataFeed model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="MongoDBDataFeed"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator MongoDBDataFeed(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeMongoDBDataFeed(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
