...
namespace Azure.AI.MetricsAdvisor.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MongoDBDataFeed>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MongoDBDataFeed>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MongoDBDataFeed>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<MongoDBDataFeed>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
