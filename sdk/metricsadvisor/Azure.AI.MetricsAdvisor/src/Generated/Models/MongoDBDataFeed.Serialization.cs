...
namespace Azure.AI.MetricsAdvisor.Models
{
    internal partial class MongoDBDataFeed : IUtf8JsonSerializable, IJsonModel<MongoDBDataFeed>
    {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<MongoDBDataFeed>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(MongoDBDataFeed)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<MongoDBDataFeed>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(MongoDBDataFeed)} does not support '{options.Format}' format.");
            }
        }
