...
{
    internal partial class MongoDBDataFeed : IUtf8JsonSerializable, IJsonModel<MongoDBDataFeed>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MongoDBDataFeed>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<MongoDBDataFeed>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MongoDBDataFeed>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MongoDBDataFeed>)} interface");
            }
        ...
        MongoDBDataFeed IJsonModel<MongoDBDataFeed>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == "J" || options.Format == "W";
            if (!isValid)
            {
                throw new FormatException($"The model {nameof(MongoDBDataFeed)} does not support '{options.Format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeMongoDBDataFeed(document.RootElement, options);
        }

        internal static MongoDBDataFeed DeserializeMongoDBDataFeed(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<MongoDBDataFeed>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == "J" || options.Format == "W";
            if (!isValid)
            {
        ...
        MongoDBDataFeed IPersistableModel<MongoDBDataFeed>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == "J" || options.Format == "W";
            if (!isValid)
            {
        ...
        string IPersistableModel<MongoDBDataFeed>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
