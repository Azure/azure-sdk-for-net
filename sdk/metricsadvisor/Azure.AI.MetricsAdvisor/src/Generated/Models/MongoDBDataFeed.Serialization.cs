...
namespace Azure.AI.MetricsAdvisor.Models
{
    internal partial class MongoDBDataFeed : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            writer.WriteObjectValue<MongoDBParameter>(DataSourceParameter);
        ...
        internal static new MongoDBDataFeed FromResponse(Response response)
        {
            using var document = JsonDocument.Parse(response.Content);
            return DeserializeMongoDBDataFeed(document.RootElement);
        }
        ...
        internal override RequestContent ToRequestContent()
        {
            ...
            content.JsonWriter.WriteObjectValue<MongoDBDataFeed>(this);
            return content;
        }
    }
}
