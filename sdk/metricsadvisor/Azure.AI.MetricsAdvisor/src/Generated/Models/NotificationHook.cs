...
namespace Azure.AI.MetricsAdvisor.Administration
{
    ...
    /// </summary>
    [DeserializationProxy(typeof(UnknownHookInfo))]
    public abstract partial class NotificationHook
    {
        ...
        internal NotificationHook(NotificationHookKind hookKind, string id, string name, string description, string internalExternalLink, IList<string> administrators, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            HookKind = hookKind;
            Id = id;
            Name = name;
