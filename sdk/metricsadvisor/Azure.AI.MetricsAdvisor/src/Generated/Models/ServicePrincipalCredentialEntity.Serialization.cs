...
namespace Azure.AI.MetricsAdvisor.Administration
{
    public partial class ServicePrincipalCredentialEntity : IUtf8JsonSerializable
    {
        ...
        internal static ServicePrincipalCredentialEntity DeserializeServicePrincipalCredentialEntity(JsonElement element)
        {
            ...
            return new ServicePrincipalCredentialEntity(dataSourceCredentialType, dataSourceCredentialId, dataSourceCredentialName, dataSourceCredentialDescription, parameters);
        }

        /// <summary> Deserializes the model from a raw response. </summary>
        /// <param name="response"> The response to deserialize the model from. </param>
        internal static new ServicePrincipalCredentialEntity FromResponse(Response response)
        {
            using var document = JsonDocument.Parse(response.Content, ModelSerializationExtensions.JsonDocumentOptions);
            return DeserializeServicePrincipalCredentialEntity(document.RootElement);
        }
