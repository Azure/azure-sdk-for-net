...
{
    internal partial class AzureTableDataFeedPatch : IUtf8JsonSerializable, IModelJsonSerializable<AzureTableDataFeedPatch>
    {
        void IModelJsonSerializable<AzureTableDataFeedPatch>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<AzureTableDataFeedPatch>(this, options.Format);
            ...
            if (Optional.IsDefined(DataSourceParameter))
            {
                ...
                {
                    ((IModelJsonSerializable<AzureTableParameterPatch>)DataSourceParameter).Serialize(writer, options);
                }
            }
        ...
        internal static AzureTableDataFeedPatch DeserializeAzureTableDataFeedPatch(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            Optional<AzureTableParameterPatch> dataSourceParameter = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("dataSourceParameter"u8))
                {
                    ...
                    dataSourceParameter = AzureTableParameterPatch.DeserializeAzureTableParameterPatch(property.Value);
                    continue;
                }
            ...
            return new AzureTableDataFeedPatch(dataSourceType, dataFeedName.Value, dataFeedDescription.Value, timestampColumn.Value, Optional.ToNullable(dataStartFrom), Optional.ToNullable(startOffsetInSeconds), Optional.ToNullable(maxConcurrency), Optional.ToNullable(minRetryIntervalInSeconds), Optional.ToNullable(stopRetryAfterInSeconds), Optional.ToNullable(needRollup), Optional.ToNullable(rollUpMethod), Optional.ToList(rollUpColumns), allUpIdentification.Value, Optional.ToNullable(fillMissingPointType), Optional.ToNullable(fillMissingPointValue), Optional.ToNullable(viewMode), Optional.ToList(admins), Optional.ToList(viewers), Optional.ToNullable(status), actionLinkTemplate.Value, Optional.ToNullable(authenticationType), credentialId.Value, dataSourceParameter.Value, serializedAdditionalRawData);
        }

        AzureTableDataFeedPatch IModelJsonSerializable<AzureTableDataFeedPatch>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<AzureTableDataFeedPatch>(this, options.Format);

            using var doc = JsonDocument.ParseValue(ref reader);
            return DeserializeAzureTableDataFeedPatch(doc.RootElement, options);
        }

        BinaryData IModelSerializable<AzureTableDataFeedPatch>.Serialize(ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<AzureTableDataFeedPatch>(this, options.Format);
        ...
        AzureTableDataFeedPatch IModelSerializable<AzureTableDataFeedPatch>.Deserialize(BinaryData data, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<AzureTableDataFeedPatch>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="AzureTableDataFeedPatch"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="AzureTableDataFeedPatch"/> to convert. </param>
        public static implicit operator RequestContent(AzureTableDataFeedPatch model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="AzureTableDataFeedPatch"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator AzureTableDataFeedPatch(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeAzureTableDataFeedPatch(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
