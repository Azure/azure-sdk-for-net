...
namespace Azure.AI.MetricsAdvisor.Models
{
    internal partial class AzureTableDataFeedPatch : IUtf8JsonSerializable, IJsonModel<AzureTableDataFeedPatch>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<AzureTableDataFeedPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<AzureTableDataFeedPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
