...
namespace Azure.AI.MetricsAdvisor.Models
{
    internal partial class AzureTableDataFeedPatch : IUtf8JsonSerializable, IJsonModel<AzureTableDataFeedPatch>
    {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureTableDataFeedPatch>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(AzureTableDataFeedPatch)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<AzureTableDataFeedPatch>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(AzureTableDataFeedPatch)} does not support '{options.Format}' format.");
            }
        }
