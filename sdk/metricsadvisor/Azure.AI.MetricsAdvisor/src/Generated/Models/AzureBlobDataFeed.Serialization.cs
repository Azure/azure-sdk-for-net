...
namespace Azure.AI.MetricsAdvisor.Models
{
    internal partial class AzureBlobDataFeed : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            writer.WriteObjectValue<AzureBlobParameter>(DataSourceParameter);
        ...
        internal static new AzureBlobDataFeed FromResponse(Response response)
        {
            using var document = JsonDocument.Parse(response.Content);
            return DeserializeAzureBlobDataFeed(document.RootElement);
        }
        ...
        internal override RequestContent ToRequestContent()
        {
            ...
            content.JsonWriter.WriteObjectValue<AzureBlobDataFeed>(this);
            return content;
        }
    }
}
