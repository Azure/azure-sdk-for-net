...
namespace Azure.AI.MetricsAdvisor.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureBlobDataFeed>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AzureBlobDataFeed>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AzureBlobDataFeed>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<AzureBlobDataFeed>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
