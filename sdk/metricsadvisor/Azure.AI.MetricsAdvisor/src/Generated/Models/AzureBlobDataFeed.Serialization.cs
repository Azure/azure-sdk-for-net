...
{
    internal partial class AzureBlobDataFeed : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static AzureBlobDataFeed DeserializeAzureBlobDataFeed(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
