...
{
    internal partial class AzureBlobDataFeed : IUtf8JsonSerializable, IModelJsonSerializable<AzureBlobDataFeed>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IModelJsonSerializable<AzureBlobDataFeed>)this).Serialize(writer, ModelSerializerOptions.DefaultWireOptions);

        void IModelJsonSerializable<AzureBlobDataFeed>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<AzureBlobDataFeed>(this, options.Format);
            ...
            {
                ((IModelJsonSerializable<AzureBlobParameter>)DataSourceParameter).Serialize(writer, options);
            }
        ...
        internal static AzureBlobDataFeed DeserializeAzureBlobDataFeed(JsonElement element, ModelSerializerOptions options = default)
        {
        ...
        AzureBlobDataFeed IModelJsonSerializable<AzureBlobDataFeed>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<AzureBlobDataFeed>(this, options.Format);

            using var doc = JsonDocument.ParseValue(ref reader);
            return DeserializeAzureBlobDataFeed(doc.RootElement, options);
        }

        BinaryData IModelSerializable<AzureBlobDataFeed>.Serialize(ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<AzureBlobDataFeed>(this, options.Format);
        ...
        AzureBlobDataFeed IModelSerializable<AzureBlobDataFeed>.Deserialize(BinaryData data, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<AzureBlobDataFeed>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="AzureBlobDataFeed"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="AzureBlobDataFeed"/> to convert. </param>
        public static implicit operator RequestContent(AzureBlobDataFeed model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="AzureBlobDataFeed"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator AzureBlobDataFeed(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeAzureBlobDataFeed(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
