...
{
    internal partial class AzureBlobDataFeed : IUtf8JsonSerializable, IJsonModel<AzureBlobDataFeed>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureBlobDataFeed>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<AzureBlobDataFeed>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AzureBlobDataFeed>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AzureBlobDataFeed>)} interface");
            }
        ...
        AzureBlobDataFeed IJsonModel<AzureBlobDataFeed>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == "J" || options.Format == "W";
            if (!isValid)
            {
                throw new FormatException($"The model {nameof(AzureBlobDataFeed)} does not support '{options.Format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeAzureBlobDataFeed(document.RootElement, options);
        }

        internal static AzureBlobDataFeed DeserializeAzureBlobDataFeed(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<AzureBlobDataFeed>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == "J" || options.Format == "W";
            if (!isValid)
            {
        ...
        AzureBlobDataFeed IPersistableModel<AzureBlobDataFeed>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == "J" || options.Format == "W";
            if (!isValid)
            {
        ...
        string IPersistableModel<AzureBlobDataFeed>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
