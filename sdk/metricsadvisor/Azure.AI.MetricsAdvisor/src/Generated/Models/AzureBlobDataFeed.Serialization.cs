...
namespace Azure.AI.MetricsAdvisor.Models
{
    internal partial class AzureBlobDataFeed : IUtf8JsonSerializable, IJsonModel<AzureBlobDataFeed>
    {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureBlobDataFeed>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(AzureBlobDataFeed)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<AzureBlobDataFeed>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(AzureBlobDataFeed)} does not support '{options.Format}' format.");
            }
        }
