...
namespace Azure.AI.MetricsAdvisor
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MetricFeedback>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MetricFeedback>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MetricFeedback>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<MetricFeedback>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
