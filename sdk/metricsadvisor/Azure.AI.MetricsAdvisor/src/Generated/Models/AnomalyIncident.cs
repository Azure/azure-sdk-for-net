...
namespace Azure.AI.MetricsAdvisor.Models
{
    ...
    public partial class AnomalyIncident
    {
        ...
        internal AnomalyIncident(string dataFeedId, string metricId, string detectionConfigurationId, string id, DateTimeOffset startedOn, DateTimeOffset lastDetectedOn, SeriesIdentity rootNode, IncidentProperty property, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
