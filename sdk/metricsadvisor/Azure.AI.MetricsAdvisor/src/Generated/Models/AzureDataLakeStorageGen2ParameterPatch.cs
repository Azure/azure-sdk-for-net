...
namespace Azure.AI.MetricsAdvisor.Models
{
    ...
    internal partial class AzureDataLakeStorageGen2ParameterPatch
    {
        ...
        internal AzureDataLakeStorageGen2ParameterPatch(string accountName, string accountKey, string fileSystemName, string directoryTemplate, string fileTemplate, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
