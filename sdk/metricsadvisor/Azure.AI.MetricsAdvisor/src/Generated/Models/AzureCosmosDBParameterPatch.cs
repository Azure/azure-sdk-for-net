...
namespace Azure.AI.MetricsAdvisor.Models
{
    ...
    internal partial class AzureCosmosDBParameterPatch
    {
        ...
        internal AzureCosmosDBParameterPatch(string connectionString, string sqlQuery, string database, string collectionId, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
