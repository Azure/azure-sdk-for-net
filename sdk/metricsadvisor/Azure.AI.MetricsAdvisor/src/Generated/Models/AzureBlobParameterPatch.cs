...
namespace Azure.AI.MetricsAdvisor.Models
{
    ...
    internal partial class AzureBlobParameterPatch
    {
        ...
        internal AzureBlobParameterPatch(string connectionString, string container, string blobTemplate, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
