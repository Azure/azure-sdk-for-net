...
{
    public partial class TopNGroupScope : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static TopNGroupScope DeserializeTopNGroupScope(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
