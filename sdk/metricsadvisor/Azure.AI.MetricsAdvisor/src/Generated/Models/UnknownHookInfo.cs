...
namespace Azure.AI.MetricsAdvisor.Models
{
    ...
    internal partial class UnknownHookInfo : NotificationHook
    {
        ...
        internal UnknownHookInfo(NotificationHookKind hookKind, string id, string name, string description, string internalExternalLink, IList<string> administrators, Dictionary<string, BinaryData> rawData) : base(hookKind, id, name, description, internalExternalLink, administrators, rawData)
        {
            HookKind = hookKind;
        }
