...
namespace Azure.AI.MetricsAdvisor.Models
{
    internal partial class EmailHookInfoPatch : IUtf8JsonSerializable, IJsonModel<EmailHookInfoPatch>
    {
        ...
        EmailHookInfoPatch IJsonModel<EmailHookInfoPatch>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<EmailHookInfoPatch>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        EmailHookInfoPatch IModel<EmailHookInfoPatch>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<EmailHookInfoPatch>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
