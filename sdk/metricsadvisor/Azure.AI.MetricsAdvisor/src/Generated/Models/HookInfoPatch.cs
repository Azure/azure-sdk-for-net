...
namespace Azure.AI.MetricsAdvisor.Models
{
    ...
    internal partial class HookInfoPatch
    {
        ...
        internal HookInfoPatch(NotificationHookKind hookType, string hookName, string description, string externalLink, IList<string> admins, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            HookType = hookType;
            HookName = hookName;
