...
namespace Azure.AI.MetricsAdvisor.Models
{
    internal partial class ChangeThresholdConditionPatch : IUtf8JsonSerializable, IJsonModel<ChangeThresholdConditionPatch>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<ChangeThresholdConditionPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<ChangeThresholdConditionPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
