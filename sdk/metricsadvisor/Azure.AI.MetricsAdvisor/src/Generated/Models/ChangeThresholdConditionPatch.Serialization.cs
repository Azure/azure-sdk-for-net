...
namespace Azure.AI.MetricsAdvisor.Models
{
    internal partial class ChangeThresholdConditionPatch : IUtf8JsonSerializable, IJsonModel<ChangeThresholdConditionPatch>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<ChangeThresholdConditionPatch>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ChangeThresholdConditionPatch>)} interface");
            }
