...
{
    internal partial class AzureLogAnalyticsDataFeed : IUtf8JsonSerializable, IModelJsonSerializable<AzureLogAnalyticsDataFeed>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IModelJsonSerializable<AzureLogAnalyticsDataFeed>)this).Serialize(writer, ModelSerializerOptions.DefaultWireOptions);

        void IModelJsonSerializable<AzureLogAnalyticsDataFeed>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<AzureLogAnalyticsDataFeed>(this, options.Format);
            ...
            {
                ((IModelJsonSerializable<AzureLogAnalyticsParameter>)DataSourceParameter).Serialize(writer, options);
            }
        ...
        internal static AzureLogAnalyticsDataFeed DeserializeAzureLogAnalyticsDataFeed(JsonElement element, ModelSerializerOptions options = default)
        {
        ...
        AzureLogAnalyticsDataFeed IModelJsonSerializable<AzureLogAnalyticsDataFeed>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<AzureLogAnalyticsDataFeed>(this, options.Format);

            using var doc = JsonDocument.ParseValue(ref reader);
            return DeserializeAzureLogAnalyticsDataFeed(doc.RootElement, options);
        }

        BinaryData IModelSerializable<AzureLogAnalyticsDataFeed>.Serialize(ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<AzureLogAnalyticsDataFeed>(this, options.Format);
        ...
        AzureLogAnalyticsDataFeed IModelSerializable<AzureLogAnalyticsDataFeed>.Deserialize(BinaryData data, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<AzureLogAnalyticsDataFeed>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="AzureLogAnalyticsDataFeed"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="AzureLogAnalyticsDataFeed"/> to convert. </param>
        public static implicit operator RequestContent(AzureLogAnalyticsDataFeed model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="AzureLogAnalyticsDataFeed"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator AzureLogAnalyticsDataFeed(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeAzureLogAnalyticsDataFeed(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
