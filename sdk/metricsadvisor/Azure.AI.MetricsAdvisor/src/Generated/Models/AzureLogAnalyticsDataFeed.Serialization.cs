...
{
    internal partial class AzureLogAnalyticsDataFeed : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static AzureLogAnalyticsDataFeed DeserializeAzureLogAnalyticsDataFeed(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
