...
namespace Azure.AI.MetricsAdvisor.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureLogAnalyticsDataFeed>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AzureLogAnalyticsDataFeed>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AzureLogAnalyticsDataFeed>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<AzureLogAnalyticsDataFeed>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
