...
{
    internal partial class AzureLogAnalyticsDataFeed : IUtf8JsonSerializable, IJsonModel<AzureLogAnalyticsDataFeed>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureLogAnalyticsDataFeed>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<AzureLogAnalyticsDataFeed>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AzureLogAnalyticsDataFeed>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AzureLogAnalyticsDataFeed>)} interface");
            }
        ...
        AzureLogAnalyticsDataFeed IJsonModel<AzureLogAnalyticsDataFeed>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == "J" || options.Format == "W";
            if (!isValid)
            {
                throw new FormatException($"The model {nameof(AzureLogAnalyticsDataFeed)} does not support '{options.Format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeAzureLogAnalyticsDataFeed(document.RootElement, options);
        }

        internal static AzureLogAnalyticsDataFeed DeserializeAzureLogAnalyticsDataFeed(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<AzureLogAnalyticsDataFeed>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == "J" || options.Format == "W";
            if (!isValid)
            {
        ...
        AzureLogAnalyticsDataFeed IPersistableModel<AzureLogAnalyticsDataFeed>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == "J" || options.Format == "W";
            if (!isValid)
            {
        ...
        string IPersistableModel<AzureLogAnalyticsDataFeed>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
