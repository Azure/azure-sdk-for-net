...
namespace Azure.AI.MetricsAdvisor.Models
{
    internal partial class AzureLogAnalyticsDataFeed : IUtf8JsonSerializable, IJsonModel<AzureLogAnalyticsDataFeed>
    {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureLogAnalyticsDataFeed>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(AzureLogAnalyticsDataFeed)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<AzureLogAnalyticsDataFeed>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(AzureLogAnalyticsDataFeed)} does not support '{options.Format}' format.");
            }
        }
