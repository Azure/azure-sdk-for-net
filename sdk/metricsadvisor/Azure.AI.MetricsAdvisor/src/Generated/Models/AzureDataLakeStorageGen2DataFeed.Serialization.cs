...
namespace Azure.AI.MetricsAdvisor.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureDataLakeStorageGen2DataFeed>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        AzureDataLakeStorageGen2DataFeed IJsonModel<AzureDataLakeStorageGen2DataFeed>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<AzureDataLakeStorageGen2DataFeed>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        AzureDataLakeStorageGen2DataFeed IModel<AzureDataLakeStorageGen2DataFeed>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<AzureDataLakeStorageGen2DataFeed>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
