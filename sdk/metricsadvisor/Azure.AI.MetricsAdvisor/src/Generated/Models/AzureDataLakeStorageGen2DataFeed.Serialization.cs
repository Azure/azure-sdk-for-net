...
{
    internal partial class AzureDataLakeStorageGen2DataFeed : IUtf8JsonSerializable, IJsonModel<AzureDataLakeStorageGen2DataFeed>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureDataLakeStorageGen2DataFeed>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<AzureDataLakeStorageGen2DataFeed>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AzureDataLakeStorageGen2DataFeed>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AzureDataLakeStorageGen2DataFeed>)} interface");
            }
        ...
        AzureDataLakeStorageGen2DataFeed IJsonModel<AzureDataLakeStorageGen2DataFeed>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == "J" || options.Format == "W";
            if (!isValid)
            {
                throw new FormatException($"The model {nameof(AzureDataLakeStorageGen2DataFeed)} does not support '{options.Format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeAzureDataLakeStorageGen2DataFeed(document.RootElement, options);
        }

        internal static AzureDataLakeStorageGen2DataFeed DeserializeAzureDataLakeStorageGen2DataFeed(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<AzureDataLakeStorageGen2DataFeed>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == "J" || options.Format == "W";
            if (!isValid)
            {
        ...
        AzureDataLakeStorageGen2DataFeed IPersistableModel<AzureDataLakeStorageGen2DataFeed>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == "J" || options.Format == "W";
            if (!isValid)
            {
        ...
        string IPersistableModel<AzureDataLakeStorageGen2DataFeed>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
