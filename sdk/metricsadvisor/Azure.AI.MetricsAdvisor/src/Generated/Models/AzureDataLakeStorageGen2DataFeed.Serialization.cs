...
namespace Azure.AI.MetricsAdvisor.Models
{
    internal partial class AzureDataLakeStorageGen2DataFeed : IUtf8JsonSerializable, IJsonModel<AzureDataLakeStorageGen2DataFeed>
    {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureDataLakeStorageGen2DataFeed>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(AzureDataLakeStorageGen2DataFeed)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<AzureDataLakeStorageGen2DataFeed>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(AzureDataLakeStorageGen2DataFeed)} does not support '{options.Format}' format.");
            }
        }
