...
namespace Azure.AI.MetricsAdvisor.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureDataLakeStorageGen2DataFeed>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AzureDataLakeStorageGen2DataFeed>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AzureDataLakeStorageGen2DataFeed>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<AzureDataLakeStorageGen2DataFeed>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
