...
namespace Azure.AI.MetricsAdvisor.Administration
{
    ...
    /// </summary>
    [AbstractTypeDeserializer(typeof(UnknownDataSourceCredential))]
    public abstract partial class DataSourceCredentialEntity
    {
        ...
        internal DataSourceCredentialEntity(DataSourceCredentialKind credentialKind, string id, string name, string description, Dictionary<string, BinaryData> rawData)
        {
