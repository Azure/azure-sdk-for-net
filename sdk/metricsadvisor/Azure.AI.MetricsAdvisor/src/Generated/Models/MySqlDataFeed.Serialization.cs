...
{
    internal partial class MySqlDataFeed : IUtf8JsonSerializable, IModelJsonSerializable<MySqlDataFeed>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IModelJsonSerializable<MySqlDataFeed>)this).Serialize(writer, ModelSerializerOptions.DefaultWireOptions);

        void IModelJsonSerializable<MySqlDataFeed>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<MySqlDataFeed>(this, options.Format);
        ...
        internal static MySqlDataFeed DeserializeMySqlDataFeed(JsonElement element, ModelSerializerOptions options = default)
        {
        ...
        MySqlDataFeed IModelJsonSerializable<MySqlDataFeed>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<MySqlDataFeed>(this, options.Format);

            using var doc = JsonDocument.ParseValue(ref reader);
            return DeserializeMySqlDataFeed(doc.RootElement, options);
        }

        BinaryData IModelSerializable<MySqlDataFeed>.Serialize(ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<MySqlDataFeed>(this, options.Format);
        ...
        MySqlDataFeed IModelSerializable<MySqlDataFeed>.Deserialize(BinaryData data, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<MySqlDataFeed>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="MySqlDataFeed"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="MySqlDataFeed"/> to convert. </param>
        public static implicit operator RequestContent(MySqlDataFeed model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="MySqlDataFeed"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator MySqlDataFeed(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeMySqlDataFeed(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
