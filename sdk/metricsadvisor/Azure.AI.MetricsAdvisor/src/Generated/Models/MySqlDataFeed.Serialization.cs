...
namespace Azure.AI.MetricsAdvisor.Models
{
    internal partial class MySqlDataFeed : IUtf8JsonSerializable
    {
        ...
        internal static new MySqlDataFeed FromResponse(Response response)
        {
            using var document = JsonDocument.Parse(response.Content);
            return DeserializeMySqlDataFeed(document.RootElement);
        }
        ...
        internal override RequestContent ToRequestContent()
        {
            ...
            content.JsonWriter.WriteObjectValue<MySqlDataFeed>(this);
            return content;
        }
    }
}
