...
namespace Azure.AI.MetricsAdvisor.Models
{
    internal partial class MySqlDataFeed : IUtf8JsonSerializable, IJsonModel<MySqlDataFeed>
    {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<MySqlDataFeed>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(MySqlDataFeed)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<MySqlDataFeed>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(MySqlDataFeed)} does not support '{options.Format}' format.");
            }
        }
