...
{
    internal partial class AzureCosmosDBDataFeed : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static AzureCosmosDBDataFeed DeserializeAzureCosmosDBDataFeed(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
