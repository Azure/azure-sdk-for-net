...
{
    internal partial class AzureCosmosDBDataFeed : IUtf8JsonSerializable, IModelJsonSerializable<AzureCosmosDBDataFeed>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IModelJsonSerializable<AzureCosmosDBDataFeed>)this).Serialize(writer, ModelSerializerOptions.DefaultWireOptions);

        void IModelJsonSerializable<AzureCosmosDBDataFeed>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<AzureCosmosDBDataFeed>(this, options.Format);
            ...
            {
                ((IModelJsonSerializable<AzureCosmosDBParameter>)DataSourceParameter).Serialize(writer, options);
            }
        ...
        internal static AzureCosmosDBDataFeed DeserializeAzureCosmosDBDataFeed(JsonElement element, ModelSerializerOptions options = default)
        {
        ...
        AzureCosmosDBDataFeed IModelJsonSerializable<AzureCosmosDBDataFeed>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<AzureCosmosDBDataFeed>(this, options.Format);

            using var doc = JsonDocument.ParseValue(ref reader);
            return DeserializeAzureCosmosDBDataFeed(doc.RootElement, options);
        }

        BinaryData IModelSerializable<AzureCosmosDBDataFeed>.Serialize(ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<AzureCosmosDBDataFeed>(this, options.Format);
        ...
        AzureCosmosDBDataFeed IModelSerializable<AzureCosmosDBDataFeed>.Deserialize(BinaryData data, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<AzureCosmosDBDataFeed>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="AzureCosmosDBDataFeed"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="AzureCosmosDBDataFeed"/> to convert. </param>
        public static implicit operator RequestContent(AzureCosmosDBDataFeed model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="AzureCosmosDBDataFeed"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator AzureCosmosDBDataFeed(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeAzureCosmosDBDataFeed(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
