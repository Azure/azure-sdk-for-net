...
namespace Azure.AI.MetricsAdvisor.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureCosmosDBDataFeed>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AzureCosmosDBDataFeed>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AzureCosmosDBDataFeed>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<AzureCosmosDBDataFeed>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
