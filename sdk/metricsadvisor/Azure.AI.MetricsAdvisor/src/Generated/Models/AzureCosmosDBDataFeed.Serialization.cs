...
namespace Azure.AI.MetricsAdvisor.Models
{
    internal partial class AzureCosmosDBDataFeed : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            writer.WriteObjectValue<AzureCosmosDBParameter>(DataSourceParameter);
        ...
        internal static new AzureCosmosDBDataFeed FromResponse(Response response)
        {
            using var document = JsonDocument.Parse(response.Content);
            return DeserializeAzureCosmosDBDataFeed(document.RootElement);
        }
        ...
        internal override RequestContent ToRequestContent()
        {
            ...
            content.JsonWriter.WriteObjectValue<AzureCosmosDBDataFeed>(this);
            return content;
        }
    }
}
