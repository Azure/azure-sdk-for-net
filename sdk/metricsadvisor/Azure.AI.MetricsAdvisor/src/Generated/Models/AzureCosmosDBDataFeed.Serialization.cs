...
namespace Azure.AI.MetricsAdvisor.Models
{
    internal partial class AzureCosmosDBDataFeed : IUtf8JsonSerializable, IJsonModel<AzureCosmosDBDataFeed>
    {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureCosmosDBDataFeed>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(AzureCosmosDBDataFeed)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<AzureCosmosDBDataFeed>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(AzureCosmosDBDataFeed)} does not support '{options.Format}' format.");
            }
        }
