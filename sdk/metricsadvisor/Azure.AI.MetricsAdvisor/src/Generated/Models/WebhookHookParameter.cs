...
namespace Azure.AI.MetricsAdvisor.Models
{
    ...
    internal partial class WebhookHookParameter
    {
        ...
        internal WebhookHookParameter(string endpoint, string username, string password, IDictionary<string, string> headers, string certificateKey, string certificatePassword, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Endpoint = endpoint;
            Username = username;
            Password = password;
