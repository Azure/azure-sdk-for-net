...
namespace Azure.AI.MetricsAdvisor.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureTableDataFeed>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AzureTableDataFeed>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AzureTableDataFeed>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<AzureTableDataFeed>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
