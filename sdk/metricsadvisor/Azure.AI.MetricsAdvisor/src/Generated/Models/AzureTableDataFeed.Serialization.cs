...
{
    internal partial class AzureTableDataFeed : IUtf8JsonSerializable, IModelJsonSerializable<AzureTableDataFeed>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IModelJsonSerializable<AzureTableDataFeed>)this).Serialize(writer, ModelSerializerOptions.DefaultWireOptions);

        void IModelJsonSerializable<AzureTableDataFeed>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<AzureTableDataFeed>(this, options.Format);
            ...
            {
                ((IModelJsonSerializable<AzureTableParameter>)DataSourceParameter).Serialize(writer, options);
            }
        ...
        internal static AzureTableDataFeed DeserializeAzureTableDataFeed(JsonElement element, ModelSerializerOptions options = default)
        {
        ...
        AzureTableDataFeed IModelJsonSerializable<AzureTableDataFeed>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<AzureTableDataFeed>(this, options.Format);

            using var doc = JsonDocument.ParseValue(ref reader);
            return DeserializeAzureTableDataFeed(doc.RootElement, options);
        }

        BinaryData IModelSerializable<AzureTableDataFeed>.Serialize(ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<AzureTableDataFeed>(this, options.Format);
        ...
        AzureTableDataFeed IModelSerializable<AzureTableDataFeed>.Deserialize(BinaryData data, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<AzureTableDataFeed>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="AzureTableDataFeed"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="AzureTableDataFeed"/> to convert. </param>
        public static implicit operator RequestContent(AzureTableDataFeed model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="AzureTableDataFeed"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator AzureTableDataFeed(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeAzureTableDataFeed(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
