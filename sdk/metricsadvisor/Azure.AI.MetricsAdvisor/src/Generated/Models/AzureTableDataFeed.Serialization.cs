...
namespace Azure.AI.MetricsAdvisor.Models
{
    internal partial class AzureTableDataFeed : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            writer.WriteObjectValue<AzureTableParameter>(DataSourceParameter);
        ...
        internal static new AzureTableDataFeed FromResponse(Response response)
        {
            using var document = JsonDocument.Parse(response.Content);
            return DeserializeAzureTableDataFeed(document.RootElement);
        }
        ...
        internal override RequestContent ToRequestContent()
        {
            ...
            content.JsonWriter.WriteObjectValue<AzureTableDataFeed>(this);
            return content;
        }
    }
}
