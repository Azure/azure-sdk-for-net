...
{
    internal partial class AzureTableDataFeed : IUtf8JsonSerializable, IJsonModel<AzureTableDataFeed>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureTableDataFeed>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<AzureTableDataFeed>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AzureTableDataFeed>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AzureTableDataFeed>)} interface");
            }
        ...
        AzureTableDataFeed IJsonModel<AzureTableDataFeed>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == "J" || options.Format == "W";
            if (!isValid)
            {
                throw new FormatException($"The model {nameof(AzureTableDataFeed)} does not support '{options.Format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeAzureTableDataFeed(document.RootElement, options);
        }

        internal static AzureTableDataFeed DeserializeAzureTableDataFeed(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<AzureTableDataFeed>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == "J" || options.Format == "W";
            if (!isValid)
            {
        ...
        AzureTableDataFeed IPersistableModel<AzureTableDataFeed>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == "J" || options.Format == "W";
            if (!isValid)
            {
        ...
        string IPersistableModel<AzureTableDataFeed>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
