...
namespace Azure.AI.MetricsAdvisor.Models
{
    internal partial class AzureTableDataFeed : IUtf8JsonSerializable, IJsonModel<AzureTableDataFeed>
    {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureTableDataFeed>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(AzureTableDataFeed)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<AzureTableDataFeed>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(AzureTableDataFeed)} does not support '{options.Format}' format.");
            }
        }
