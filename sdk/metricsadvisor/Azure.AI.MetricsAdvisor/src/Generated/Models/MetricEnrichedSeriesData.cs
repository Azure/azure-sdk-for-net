...
namespace Azure.AI.MetricsAdvisor.Models
{
    ...
    public partial class MetricEnrichedSeriesData
    {
        ...
        internal MetricEnrichedSeriesData(SeriesIdentity series, IReadOnlyList<DateTimeOffset> timestamps, IReadOnlyList<double> metricValues, IReadOnlyList<bool?> isAnomaly, IReadOnlyList<int?> periods, IReadOnlyList<double?> expectedMetricValues, IReadOnlyList<double?> lowerBoundaryValues, IReadOnlyList<double?> upperBoundaryValues, Dictionary<string, BinaryData> rawData)
        {
            Series = series;
