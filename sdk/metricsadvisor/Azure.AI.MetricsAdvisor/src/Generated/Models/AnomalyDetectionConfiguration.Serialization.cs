...
{
    public partial class AnomalyDetectionConfiguration : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static AnomalyDetectionConfiguration DeserializeAnomalyDetectionConfiguration(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
