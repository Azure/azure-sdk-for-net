...
namespace Azure.AI.MetricsAdvisor.Models
{
    internal partial class DataFeedDetailPatch : IUtf8JsonSerializable, IJsonModel<DataFeedDetailPatch>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<DataFeedDetailPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<DataFeedDetailPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
