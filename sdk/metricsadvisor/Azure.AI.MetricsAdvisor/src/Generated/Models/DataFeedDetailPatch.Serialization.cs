...
{
    internal partial class DataFeedDetailPatch : IUtf8JsonSerializable, IModelJsonSerializable<DataFeedDetailPatch>
    {
        void IModelJsonSerializable<DataFeedDetailPatch>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<DataFeedDetailPatch>(this, options.Format);
        ...
        internal static DataFeedDetailPatch DeserializeDataFeedDetailPatch(JsonElement element, ModelSerializerOptions options = default)
        {
        ...
        DataFeedDetailPatch IModelSerializable<DataFeedDetailPatch>.Deserialize(BinaryData data, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<DataFeedDetailPatch>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="DataFeedDetailPatch"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="DataFeedDetailPatch"/> to convert. </param>
        public static implicit operator RequestContent(DataFeedDetailPatch model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="DataFeedDetailPatch"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator DataFeedDetailPatch(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeDataFeedDetailPatch(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
