...
namespace Azure.AI.MetricsAdvisor.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MetricEnrichedSeriesData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MetricEnrichedSeriesData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MetricEnrichedSeriesData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MetricEnrichedSeriesData>)} interface");
            }
        ...
        string IPersistableModel<MetricEnrichedSeriesData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
