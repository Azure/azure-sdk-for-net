...
namespace Azure.AI.MetricsAdvisor.Models
{
    ...
    {
        internal static MetricEnrichedSeriesData DeserializeMetricEnrichedSeriesData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
