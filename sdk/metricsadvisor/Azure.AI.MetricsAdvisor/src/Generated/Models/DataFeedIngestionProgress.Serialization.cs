...
namespace Azure.AI.MetricsAdvisor.Models
{
    ...
    {
        internal static DataFeedIngestionProgress DeserializeDataFeedIngestionProgress(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
