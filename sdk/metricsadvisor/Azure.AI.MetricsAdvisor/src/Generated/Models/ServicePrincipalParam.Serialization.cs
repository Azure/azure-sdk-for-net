...
namespace Azure.AI.MetricsAdvisor.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ServicePrincipalParam>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<ServicePrincipalParam>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ServicePrincipalParam>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(ServicePrincipalParam)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ServicePrincipalParam>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(ServicePrincipalParam)} does not support '{options.Format}' format.");
            }
        }
        ...
        string IPersistableModel<ServicePrincipalParam>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
