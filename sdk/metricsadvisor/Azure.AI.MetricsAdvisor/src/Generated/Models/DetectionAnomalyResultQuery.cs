...
namespace Azure.AI.MetricsAdvisor.Models
{
    ...
    internal partial class DetectionAnomalyResultQuery
    {
        ...
        internal DetectionAnomalyResultQuery(DateTimeOffset startTime, DateTimeOffset endTime, DetectionAnomalyFilterCondition filter, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            StartTime = startTime;
            EndTime = endTime;
            Filter = filter;
