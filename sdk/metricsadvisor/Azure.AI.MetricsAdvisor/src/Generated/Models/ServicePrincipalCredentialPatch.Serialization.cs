...
namespace Azure.AI.MetricsAdvisor.Models
{
    internal partial class ServicePrincipalCredentialPatch : IUtf8JsonSerializable, IJsonModel<ServicePrincipalCredentialPatch>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<ServicePrincipalCredentialPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<ServicePrincipalCredentialPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
