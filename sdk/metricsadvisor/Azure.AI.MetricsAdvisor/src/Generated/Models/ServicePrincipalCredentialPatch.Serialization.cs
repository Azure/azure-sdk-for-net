...
namespace Azure.AI.MetricsAdvisor.Models
{
    internal partial class ServicePrincipalCredentialPatch : IUtf8JsonSerializable, IJsonModel<ServicePrincipalCredentialPatch>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<ServicePrincipalCredentialPatch>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ServicePrincipalCredentialPatch>)} interface");
            }
