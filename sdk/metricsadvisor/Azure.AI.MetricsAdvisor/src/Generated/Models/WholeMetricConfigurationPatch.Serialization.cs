...
namespace Azure.AI.MetricsAdvisor.Models
{
    internal partial class WholeMetricConfigurationPatch : IUtf8JsonSerializable, IJsonModel<WholeMetricConfigurationPatch>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<WholeMetricConfigurationPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<WholeMetricConfigurationPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
