...
namespace Azure.AI.MetricsAdvisor.Administration
{
    ...
    public partial class SqlConnectionStringCredentialEntity : DataSourceCredentialEntity
    {
        ...
        internal SqlConnectionStringCredentialEntity(DataSourceCredentialKind credentialKind, string id, string name, string description, AzureSQLConnectionStringParam parameters, Dictionary<string, BinaryData> rawData) : base(credentialKind, id, name, description, rawData)
        {
