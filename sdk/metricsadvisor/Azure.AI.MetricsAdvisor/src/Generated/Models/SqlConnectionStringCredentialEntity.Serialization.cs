...
namespace Azure.AI.MetricsAdvisor.Administration
{
    public partial class SqlConnectionStringCredentialEntity : IUtf8JsonSerializable, IModelJsonSerializable<SqlConnectionStringCredentialEntity>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<SqlConnectionStringCredentialEntity>(this, options.Format);
        ...
        internal static SqlConnectionStringCredentialEntity DeserializeSqlConnectionStringCredentialEntity(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new SqlConnectionStringCredentialEntity(dataSourceCredentialType, dataSourceCredentialId.Value, dataSourceCredentialName, dataSourceCredentialDescription.Value, parameters, serializedAdditionalRawData);
        }
