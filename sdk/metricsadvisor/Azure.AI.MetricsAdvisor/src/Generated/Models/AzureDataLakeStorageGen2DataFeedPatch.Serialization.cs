...
{
    internal partial class AzureDataLakeStorageGen2DataFeedPatch : IUtf8JsonSerializable, IModelJsonSerializable<AzureDataLakeStorageGen2DataFeedPatch>
    {
        void IModelJsonSerializable<AzureDataLakeStorageGen2DataFeedPatch>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<AzureDataLakeStorageGen2DataFeedPatch>(this, options.Format);
            ...
            if (Optional.IsDefined(DataSourceParameter))
            {
                ...
                {
                    ((IModelJsonSerializable<AzureDataLakeStorageGen2ParameterPatch>)DataSourceParameter).Serialize(writer, options);
                }
            }
        ...
        internal static AzureDataLakeStorageGen2DataFeedPatch DeserializeAzureDataLakeStorageGen2DataFeedPatch(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            Optional<AzureDataLakeStorageGen2ParameterPatch> dataSourceParameter = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("dataSourceParameter"u8))
                {
                    ...
                    dataSourceParameter = AzureDataLakeStorageGen2ParameterPatch.DeserializeAzureDataLakeStorageGen2ParameterPatch(property.Value);
                    continue;
                }
            ...
            return new AzureDataLakeStorageGen2DataFeedPatch(dataSourceType, dataFeedName.Value, dataFeedDescription.Value, timestampColumn.Value, Optional.ToNullable(dataStartFrom), Optional.ToNullable(startOffsetInSeconds), Optional.ToNullable(maxConcurrency), Optional.ToNullable(minRetryIntervalInSeconds), Optional.ToNullable(stopRetryAfterInSeconds), Optional.ToNullable(needRollup), Optional.ToNullable(rollUpMethod), Optional.ToList(rollUpColumns), allUpIdentification.Value, Optional.ToNullable(fillMissingPointType), Optional.ToNullable(fillMissingPointValue), Optional.ToNullable(viewMode), Optional.ToList(admins), Optional.ToList(viewers), Optional.ToNullable(status), actionLinkTemplate.Value, Optional.ToNullable(authenticationType), credentialId.Value, dataSourceParameter.Value, rawData);
        }

        AzureDataLakeStorageGen2DataFeedPatch IModelJsonSerializable<AzureDataLakeStorageGen2DataFeedPatch>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<AzureDataLakeStorageGen2DataFeedPatch>(this, options.Format);

            using var doc = JsonDocument.ParseValue(ref reader);
            return DeserializeAzureDataLakeStorageGen2DataFeedPatch(doc.RootElement, options);
        }

        BinaryData IModelSerializable<AzureDataLakeStorageGen2DataFeedPatch>.Serialize(ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<AzureDataLakeStorageGen2DataFeedPatch>(this, options.Format);
        ...
        AzureDataLakeStorageGen2DataFeedPatch IModelSerializable<AzureDataLakeStorageGen2DataFeedPatch>.Deserialize(BinaryData data, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<AzureDataLakeStorageGen2DataFeedPatch>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="AzureDataLakeStorageGen2DataFeedPatch"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="AzureDataLakeStorageGen2DataFeedPatch"/> to convert. </param>
        public static implicit operator RequestContent(AzureDataLakeStorageGen2DataFeedPatch model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="AzureDataLakeStorageGen2DataFeedPatch"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator AzureDataLakeStorageGen2DataFeedPatch(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeAzureDataLakeStorageGen2DataFeedPatch(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
