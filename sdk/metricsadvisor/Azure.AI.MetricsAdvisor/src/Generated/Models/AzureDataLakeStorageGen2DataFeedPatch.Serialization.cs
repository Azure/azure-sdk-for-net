...
namespace Azure.AI.MetricsAdvisor.Models
{
    internal partial class AzureDataLakeStorageGen2DataFeedPatch : IUtf8JsonSerializable, IJsonModel<AzureDataLakeStorageGen2DataFeedPatch>
    {
        ...
        AzureDataLakeStorageGen2DataFeedPatch IJsonModel<AzureDataLakeStorageGen2DataFeedPatch>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<AzureDataLakeStorageGen2DataFeedPatch>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        AzureDataLakeStorageGen2DataFeedPatch IModel<AzureDataLakeStorageGen2DataFeedPatch>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<AzureDataLakeStorageGen2DataFeedPatch>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
