...
{
    internal partial class AzureDataLakeStorageGen2DataFeedPatch : IUtf8JsonSerializable, IJsonModel<AzureDataLakeStorageGen2DataFeedPatch>
    {
        void IJsonModel<AzureDataLakeStorageGen2DataFeedPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AzureDataLakeStorageGen2DataFeedPatch>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AzureDataLakeStorageGen2DataFeedPatch>)} interface");
            }
        ...
        AzureDataLakeStorageGen2DataFeedPatch IJsonModel<AzureDataLakeStorageGen2DataFeedPatch>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == "J" || options.Format == "W";
            if (!isValid)
            {
                throw new FormatException($"The model {nameof(AzureDataLakeStorageGen2DataFeedPatch)} does not support '{options.Format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeAzureDataLakeStorageGen2DataFeedPatch(document.RootElement, options);
        }

        internal static AzureDataLakeStorageGen2DataFeedPatch DeserializeAzureDataLakeStorageGen2DataFeedPatch(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<AzureDataLakeStorageGen2DataFeedPatch>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == "J" || options.Format == "W";
            if (!isValid)
            {
        ...
        AzureDataLakeStorageGen2DataFeedPatch IPersistableModel<AzureDataLakeStorageGen2DataFeedPatch>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == "J" || options.Format == "W";
            if (!isValid)
            {
        ...
        string IPersistableModel<AzureDataLakeStorageGen2DataFeedPatch>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
