...
namespace Azure.AI.MetricsAdvisor.Models
{
    internal partial class AzureDataLakeStorageGen2DataFeedPatch : IUtf8JsonSerializable, IJsonModel<AzureDataLakeStorageGen2DataFeedPatch>
    {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureDataLakeStorageGen2DataFeedPatch>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(AzureDataLakeStorageGen2DataFeedPatch)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<AzureDataLakeStorageGen2DataFeedPatch>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(AzureDataLakeStorageGen2DataFeedPatch)} does not support '{options.Format}' format.");
            }
        }
