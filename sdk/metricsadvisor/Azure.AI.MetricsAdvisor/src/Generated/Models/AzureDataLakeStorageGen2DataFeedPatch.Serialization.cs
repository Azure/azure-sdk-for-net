...
namespace Azure.AI.MetricsAdvisor.Models
{
    internal partial class AzureDataLakeStorageGen2DataFeedPatch : IUtf8JsonSerializable, IJsonModel<AzureDataLakeStorageGen2DataFeedPatch>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<AzureDataLakeStorageGen2DataFeedPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<AzureDataLakeStorageGen2DataFeedPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
