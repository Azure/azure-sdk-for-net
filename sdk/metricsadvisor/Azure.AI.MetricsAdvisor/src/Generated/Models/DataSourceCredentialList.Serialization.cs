...
namespace Azure.AI.MetricsAdvisor.Models
{
    ...
    {
        internal static DataSourceCredentialList DeserializeDataSourceCredentialList(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
