...
namespace Azure.AI.MetricsAdvisor.Models
{
    internal partial class SQLServerDataFeedPatch : IUtf8JsonSerializable, IJsonModel<SQLServerDataFeedPatch>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<SQLServerDataFeedPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<SQLServerDataFeedPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
