...
namespace Azure.AI.MetricsAdvisor.Models
{
    internal partial class SQLServerDataFeedPatch : IUtf8JsonSerializable, IJsonModel<SQLServerDataFeedPatch>
    {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<SQLServerDataFeedPatch>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(SQLServerDataFeedPatch)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<SQLServerDataFeedPatch>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(SQLServerDataFeedPatch)} does not support '{options.Format}' format.");
            }
        }
