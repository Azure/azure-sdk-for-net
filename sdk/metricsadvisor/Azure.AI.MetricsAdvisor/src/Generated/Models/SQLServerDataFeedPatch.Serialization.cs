...
namespace Azure.AI.MetricsAdvisor.Models
{
    internal partial class SQLServerDataFeedPatch : IUtf8JsonSerializable, IJsonModel<SQLServerDataFeedPatch>
    {
        ...
        SQLServerDataFeedPatch IJsonModel<SQLServerDataFeedPatch>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<SQLServerDataFeedPatch>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        SQLServerDataFeedPatch IModel<SQLServerDataFeedPatch>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<SQLServerDataFeedPatch>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
