...
{
    internal partial class SQLServerDataFeedPatch : IUtf8JsonSerializable, IModelJsonSerializable<SQLServerDataFeedPatch>
    {
        void IModelJsonSerializable<SQLServerDataFeedPatch>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<SQLServerDataFeedPatch>(this, options.Format);
        ...
        internal static SQLServerDataFeedPatch DeserializeSQLServerDataFeedPatch(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new SQLServerDataFeedPatch(dataSourceType, dataFeedName.Value, dataFeedDescription.Value, timestampColumn.Value, Optional.ToNullable(dataStartFrom), Optional.ToNullable(startOffsetInSeconds), Optional.ToNullable(maxConcurrency), Optional.ToNullable(minRetryIntervalInSeconds), Optional.ToNullable(stopRetryAfterInSeconds), Optional.ToNullable(needRollup), Optional.ToNullable(rollUpMethod), Optional.ToList(rollUpColumns), allUpIdentification.Value, Optional.ToNullable(fillMissingPointType), Optional.ToNullable(fillMissingPointValue), Optional.ToNullable(viewMode), Optional.ToList(admins), Optional.ToList(viewers), Optional.ToNullable(status), actionLinkTemplate.Value, Optional.ToNullable(authenticationType), credentialId.Value, dataSourceParameter.Value, serializedAdditionalRawData);
        }

        SQLServerDataFeedPatch IModelJsonSerializable<SQLServerDataFeedPatch>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<SQLServerDataFeedPatch>(this, options.Format);

            using var doc = JsonDocument.ParseValue(ref reader);
            return DeserializeSQLServerDataFeedPatch(doc.RootElement, options);
        }

        BinaryData IModelSerializable<SQLServerDataFeedPatch>.Serialize(ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<SQLServerDataFeedPatch>(this, options.Format);
        ...
        SQLServerDataFeedPatch IModelSerializable<SQLServerDataFeedPatch>.Deserialize(BinaryData data, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<SQLServerDataFeedPatch>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="SQLServerDataFeedPatch"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="SQLServerDataFeedPatch"/> to convert. </param>
        public static implicit operator RequestContent(SQLServerDataFeedPatch model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="SQLServerDataFeedPatch"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator SQLServerDataFeedPatch(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeSQLServerDataFeedPatch(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
