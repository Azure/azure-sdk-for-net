...
namespace Azure.AI.MetricsAdvisor.Models
{
    public partial class MetricAlertConfiguration : IUtf8JsonSerializable, IJsonModel<MetricAlertConfiguration>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<MetricAlertConfiguration>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MetricAlertConfiguration>)} interface");
            }
