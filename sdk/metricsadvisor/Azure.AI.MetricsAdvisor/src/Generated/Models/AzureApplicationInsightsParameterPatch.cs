...
namespace Azure.AI.MetricsAdvisor.Models
{
    ...
    internal partial class AzureApplicationInsightsParameterPatch
    {
        ...
        internal AzureApplicationInsightsParameterPatch(string azureCloud, string applicationId, string apiKey, string query, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
