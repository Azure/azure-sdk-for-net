...
namespace Azure.AI.MetricsAdvisor.Models
{
    internal partial class DataFeedDetail : IUtf8JsonSerializable, IModelJsonSerializable<DataFeedDetail>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<DataFeedDetail>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="DataFeedDetail"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="DataFeedDetail"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="DataFeedDetail"/>. </summary>
