...
namespace Azure.AI.MetricsAdvisor.Administration
{
    ...
    public partial class DataLakeSharedKeyCredentialEntity : DataSourceCredentialEntity
    {
        ...
        internal DataLakeSharedKeyCredentialEntity(DataSourceCredentialKind credentialKind, string id, string name, string description, DataLakeGen2SharedKeyParam parameters, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(credentialKind, id, name, description, serializedAdditionalRawData)
        {
