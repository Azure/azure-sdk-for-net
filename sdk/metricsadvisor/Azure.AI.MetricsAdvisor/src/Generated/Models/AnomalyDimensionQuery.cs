...
namespace Azure.AI.MetricsAdvisor.Models
{
    ...
    internal partial class AnomalyDimensionQuery
    {
        ...
        internal AnomalyDimensionQuery(DateTimeOffset startTime, DateTimeOffset endTime, string dimensionName, DimensionKey dimensionFilter, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            StartTime = startTime;
            EndTime = endTime;
            DimensionName = dimensionName;
