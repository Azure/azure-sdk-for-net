...
{
    internal partial class AzureApplicationInsightsDataFeed : IUtf8JsonSerializable, IModelJsonSerializable<AzureApplicationInsightsDataFeed>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IModelJsonSerializable<AzureApplicationInsightsDataFeed>)this).Serialize(writer, ModelSerializerOptions.DefaultWireOptions);

        void IModelJsonSerializable<AzureApplicationInsightsDataFeed>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<AzureApplicationInsightsDataFeed>(this, options.Format);
            ...
            {
                ((IModelJsonSerializable<AzureApplicationInsightsParameter>)DataSourceParameter).Serialize(writer, options);
            }
        ...
        internal static AzureApplicationInsightsDataFeed DeserializeAzureApplicationInsightsDataFeed(JsonElement element, ModelSerializerOptions options = default)
        {
        ...
        AzureApplicationInsightsDataFeed IModelJsonSerializable<AzureApplicationInsightsDataFeed>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<AzureApplicationInsightsDataFeed>(this, options.Format);

            using var doc = JsonDocument.ParseValue(ref reader);
            return DeserializeAzureApplicationInsightsDataFeed(doc.RootElement, options);
        }

        BinaryData IModelSerializable<AzureApplicationInsightsDataFeed>.Serialize(ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<AzureApplicationInsightsDataFeed>(this, options.Format);
        ...
        AzureApplicationInsightsDataFeed IModelSerializable<AzureApplicationInsightsDataFeed>.Deserialize(BinaryData data, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<AzureApplicationInsightsDataFeed>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="AzureApplicationInsightsDataFeed"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="AzureApplicationInsightsDataFeed"/> to convert. </param>
        public static implicit operator RequestContent(AzureApplicationInsightsDataFeed model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="AzureApplicationInsightsDataFeed"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator AzureApplicationInsightsDataFeed(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeAzureApplicationInsightsDataFeed(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
