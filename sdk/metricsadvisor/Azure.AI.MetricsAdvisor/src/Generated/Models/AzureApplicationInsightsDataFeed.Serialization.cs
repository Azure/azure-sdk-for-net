...
{
    internal partial class AzureApplicationInsightsDataFeed : IUtf8JsonSerializable
    {
        ...
        internal static AzureApplicationInsightsDataFeed DeserializeAzureApplicationInsightsDataFeed(JsonElement element)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    dataSourceParameter = AzureApplicationInsightsParameter.DeserializeAzureApplicationInsightsParameter(property.Value);
                    continue;
                }
