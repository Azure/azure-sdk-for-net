...
namespace Azure.AI.MetricsAdvisor.Models
{
    internal partial class AzureApplicationInsightsDataFeed : IUtf8JsonSerializable, IJsonModel<AzureApplicationInsightsDataFeed>
    {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureApplicationInsightsDataFeed>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(AzureApplicationInsightsDataFeed)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<AzureApplicationInsightsDataFeed>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(AzureApplicationInsightsDataFeed)} does not support '{options.Format}' format.");
            }
        }
