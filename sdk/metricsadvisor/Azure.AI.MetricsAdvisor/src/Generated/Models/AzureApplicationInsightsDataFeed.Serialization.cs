...
{
    internal partial class AzureApplicationInsightsDataFeed : IUtf8JsonSerializable, IJsonModel<AzureApplicationInsightsDataFeed>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureApplicationInsightsDataFeed>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<AzureApplicationInsightsDataFeed>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AzureApplicationInsightsDataFeed>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AzureApplicationInsightsDataFeed>)} interface");
            }
        ...
        AzureApplicationInsightsDataFeed IJsonModel<AzureApplicationInsightsDataFeed>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == "J" || options.Format == "W";
            if (!isValid)
            {
                throw new FormatException($"The model {nameof(AzureApplicationInsightsDataFeed)} does not support '{options.Format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeAzureApplicationInsightsDataFeed(document.RootElement, options);
        }

        internal static AzureApplicationInsightsDataFeed DeserializeAzureApplicationInsightsDataFeed(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<AzureApplicationInsightsDataFeed>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == "J" || options.Format == "W";
            if (!isValid)
            {
        ...
        AzureApplicationInsightsDataFeed IPersistableModel<AzureApplicationInsightsDataFeed>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == "J" || options.Format == "W";
            if (!isValid)
            {
        ...
        string IPersistableModel<AzureApplicationInsightsDataFeed>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
