    ...
    internal partial class AzureEventHubsDataFeed : IUtf8JsonSerializable
    {
        ...
        internal static AzureEventHubsDataFeed DeserializeAzureEventHubsDataFeed(JsonElement element)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    dataSourceParameter = ModelSerializationExtensions.JsonDeserialize<AzureEventHubsParameter>(property.Value);
                    continue;
                }
            ...
            return new AzureEventHubsDataFeed(
                dataSourceType,
                dataFeedId,
                dataFeedName,
                dataFeedDescription,
        ...
        internal static new AzureEventHubsDataFeed FromResponse(Response response)
        {
