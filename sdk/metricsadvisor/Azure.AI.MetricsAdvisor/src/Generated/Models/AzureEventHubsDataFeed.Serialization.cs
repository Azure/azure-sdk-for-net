...
namespace Azure.AI.MetricsAdvisor.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureEventHubsDataFeed>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AzureEventHubsDataFeed>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AzureEventHubsDataFeed>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AzureEventHubsDataFeed>)} interface");
            }
        ...
        string IPersistableModel<AzureEventHubsDataFeed>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
