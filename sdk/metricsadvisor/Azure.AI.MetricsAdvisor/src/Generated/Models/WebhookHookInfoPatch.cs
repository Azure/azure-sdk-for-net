...
namespace Azure.AI.MetricsAdvisor.Models
{
    ...
    internal partial class WebhookHookInfoPatch : HookInfoPatch
    {
        ...
        internal WebhookHookInfoPatch(NotificationHookKind hookType, string hookName, string description, string externalLink, IList<string> admins, WebhookHookParameterPatch hookParameter, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(hookType, hookName, description, externalLink, admins, serializedAdditionalRawData)
        {
