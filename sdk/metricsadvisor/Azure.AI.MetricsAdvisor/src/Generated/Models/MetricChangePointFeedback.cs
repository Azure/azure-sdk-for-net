...
namespace Azure.AI.MetricsAdvisor
{
    ...
    public partial class MetricChangePointFeedback : MetricFeedback
    {
        ...
        internal MetricChangePointFeedback(MetricFeedbackKind kind, string id, DateTimeOffset? createdOn, string userPrincipal, string metricId, FeedbackDimensionFilter dimensionFilter, DateTimeOffset startOn, DateTimeOffset endOn, ChangePointFeedbackValue valueInternal) : base(kind, id, createdOn, userPrincipal, metricId, dimensionFilter)
        {
            StartOn = startOn;
            EndOn = endOn;
