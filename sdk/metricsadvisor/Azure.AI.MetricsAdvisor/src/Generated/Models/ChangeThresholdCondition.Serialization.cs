...
{
    public partial class ChangeThresholdCondition : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ChangeThresholdCondition DeserializeChangeThresholdCondition(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
