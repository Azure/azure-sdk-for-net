...
namespace Azure.AI.MetricsAdvisor.Models
{
    internal partial class AzureCosmosDBDataFeedPatch : IUtf8JsonSerializable, IModelJsonSerializable<AzureCosmosDBDataFeedPatch>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<AzureCosmosDBDataFeedPatch>(this, options.Format);
            ...
            if (Optional.IsDefined(DataSourceParameter))
            {
                ...
                {
                    ((IModelJsonSerializable<AzureCosmosDBParameterPatch>)DataSourceParameter).Serialize(writer, options);
                }
            }
        ...
        /// <summary> Converts a <see cref="AzureCosmosDBDataFeedPatch"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="AzureCosmosDBDataFeedPatch"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="AzureCosmosDBDataFeedPatch"/>. </summary>
