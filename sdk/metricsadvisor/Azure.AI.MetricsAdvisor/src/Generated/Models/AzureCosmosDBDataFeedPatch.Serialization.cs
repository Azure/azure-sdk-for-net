...
namespace Azure.AI.MetricsAdvisor.Models
{
    internal partial class AzureCosmosDBDataFeedPatch : IUtf8JsonSerializable, IJsonModel<AzureCosmosDBDataFeedPatch>
    {
        ...
        AzureCosmosDBDataFeedPatch IJsonModel<AzureCosmosDBDataFeedPatch>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
                throw new FormatException($"The model {nameof(AzureCosmosDBDataFeedPatch)} does not support '{options.Format}' format.");
            }
        ...
        BinaryData IModel<AzureCosmosDBDataFeedPatch>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        AzureCosmosDBDataFeedPatch IModel<AzureCosmosDBDataFeedPatch>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<AzureCosmosDBDataFeedPatch>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
