...
namespace Azure.AI.MetricsAdvisor.Models
{
    internal partial class AzureCosmosDBDataFeedPatch : IUtf8JsonSerializable, IJsonModel<AzureCosmosDBDataFeedPatch>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<AzureCosmosDBDataFeedPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AzureCosmosDBDataFeedPatch>)} interface");
            }
        ...
        string IPersistableModel<AzureCosmosDBDataFeedPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
