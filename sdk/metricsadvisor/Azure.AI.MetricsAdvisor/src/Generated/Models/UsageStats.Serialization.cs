...
namespace Azure.AI.MetricsAdvisor.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<UsageStats>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<UsageStats>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<UsageStats>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<UsageStats>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
