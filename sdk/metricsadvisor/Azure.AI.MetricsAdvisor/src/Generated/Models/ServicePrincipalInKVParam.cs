...
namespace Azure.AI.MetricsAdvisor.Models
{
    ...
    internal partial class ServicePrincipalInKVParam
    {
        ...
        internal ServicePrincipalInKVParam(string keyVaultEndpoint, string keyVaultClientId, string keyVaultClientSecret, string servicePrincipalIdNameInKV, string servicePrincipalSecretNameInKV, string tenantId, Dictionary<string, BinaryData> rawData)
        {
            KeyVaultEndpoint = keyVaultEndpoint;
            KeyVaultClientId = keyVaultClientId;
