...
namespace Azure.AI.MetricsAdvisor.Models
{
    internal partial class InfluxDBDataFeed : IUtf8JsonSerializable, IJsonModel<InfluxDBDataFeed>
    {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<InfluxDBDataFeed>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(InfluxDBDataFeed)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<InfluxDBDataFeed>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(InfluxDBDataFeed)} does not support '{options.Format}' format.");
            }
        }
