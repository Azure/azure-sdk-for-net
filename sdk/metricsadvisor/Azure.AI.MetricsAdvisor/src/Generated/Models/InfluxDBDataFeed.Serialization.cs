...
{
    internal partial class InfluxDBDataFeed : IUtf8JsonSerializable, IModelJsonSerializable<InfluxDBDataFeed>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IModelJsonSerializable<InfluxDBDataFeed>)this).Serialize(writer, ModelSerializerOptions.DefaultWireOptions);

        void IModelJsonSerializable<InfluxDBDataFeed>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<InfluxDBDataFeed>(this, options.Format);
            ...
            {
                ((IModelJsonSerializable<InfluxDBParameter>)DataSourceParameter).Serialize(writer, options);
            }
        ...
        internal static InfluxDBDataFeed DeserializeInfluxDBDataFeed(JsonElement element, ModelSerializerOptions options = default)
        {
        ...
        InfluxDBDataFeed IModelJsonSerializable<InfluxDBDataFeed>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<InfluxDBDataFeed>(this, options.Format);

            using var doc = JsonDocument.ParseValue(ref reader);
            return DeserializeInfluxDBDataFeed(doc.RootElement, options);
        }

        BinaryData IModelSerializable<InfluxDBDataFeed>.Serialize(ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<InfluxDBDataFeed>(this, options.Format);
        ...
        InfluxDBDataFeed IModelSerializable<InfluxDBDataFeed>.Deserialize(BinaryData data, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<InfluxDBDataFeed>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="InfluxDBDataFeed"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="InfluxDBDataFeed"/> to convert. </param>
        public static implicit operator RequestContent(InfluxDBDataFeed model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="InfluxDBDataFeed"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator InfluxDBDataFeed(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeInfluxDBDataFeed(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
