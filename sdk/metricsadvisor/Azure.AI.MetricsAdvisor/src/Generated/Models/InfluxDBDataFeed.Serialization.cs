...
{
    internal partial class InfluxDBDataFeed : IUtf8JsonSerializable, IJsonModel<InfluxDBDataFeed>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<InfluxDBDataFeed>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<InfluxDBDataFeed>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<InfluxDBDataFeed>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<InfluxDBDataFeed>)} interface");
            }
        ...
        InfluxDBDataFeed IJsonModel<InfluxDBDataFeed>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == "J" || options.Format == "W";
            if (!isValid)
            {
                throw new FormatException($"The model {nameof(InfluxDBDataFeed)} does not support '{options.Format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeInfluxDBDataFeed(document.RootElement, options);
        }

        internal static InfluxDBDataFeed DeserializeInfluxDBDataFeed(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<InfluxDBDataFeed>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == "J" || options.Format == "W";
            if (!isValid)
            {
        ...
        InfluxDBDataFeed IPersistableModel<InfluxDBDataFeed>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == "J" || options.Format == "W";
            if (!isValid)
            {
        ...
        string IPersistableModel<InfluxDBDataFeed>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
