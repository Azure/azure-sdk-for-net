...
namespace Azure.AI.MetricsAdvisor.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<InfluxDBDataFeed>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<InfluxDBDataFeed>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<InfluxDBDataFeed>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<InfluxDBDataFeed>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
