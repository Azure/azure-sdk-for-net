...
namespace Azure.AI.MetricsAdvisor.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SuppressCondition>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SuppressCondition>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SuppressCondition>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SuppressCondition>)} interface");
            }
        ...
        string IPersistableModel<SuppressCondition>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
