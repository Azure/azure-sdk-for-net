...
namespace Azure.AI.MetricsAdvisor.Models
{
    internal partial class MySqlDataFeedPatch : IUtf8JsonSerializable, IJsonModel<MySqlDataFeedPatch>
    {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<MySqlDataFeedPatch>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(MySqlDataFeedPatch)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<MySqlDataFeedPatch>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(MySqlDataFeedPatch)} does not support '{options.Format}' format.");
            }
        }
