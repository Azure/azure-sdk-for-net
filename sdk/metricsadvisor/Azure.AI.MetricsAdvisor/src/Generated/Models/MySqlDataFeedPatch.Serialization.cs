...
namespace Azure.AI.MetricsAdvisor.Models
{
    internal partial class MySqlDataFeedPatch : IUtf8JsonSerializable, IJsonModel<MySqlDataFeedPatch>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<MySqlDataFeedPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<MySqlDataFeedPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
