...
{
    internal partial class MySqlDataFeedPatch : IUtf8JsonSerializable, IModelJsonSerializable<MySqlDataFeedPatch>
    {
        void IModelJsonSerializable<MySqlDataFeedPatch>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<MySqlDataFeedPatch>(this, options.Format);
        ...
        internal static MySqlDataFeedPatch DeserializeMySqlDataFeedPatch(JsonElement element, ModelSerializerOptions options = default)
        {
        ...
        MySqlDataFeedPatch IModelJsonSerializable<MySqlDataFeedPatch>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<MySqlDataFeedPatch>(this, options.Format);

            using var doc = JsonDocument.ParseValue(ref reader);
            return DeserializeMySqlDataFeedPatch(doc.RootElement, options);
        }

        BinaryData IModelSerializable<MySqlDataFeedPatch>.Serialize(ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<MySqlDataFeedPatch>(this, options.Format);
        ...
        MySqlDataFeedPatch IModelSerializable<MySqlDataFeedPatch>.Deserialize(BinaryData data, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<MySqlDataFeedPatch>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="MySqlDataFeedPatch"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="MySqlDataFeedPatch"/> to convert. </param>
        public static implicit operator RequestContent(MySqlDataFeedPatch model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="MySqlDataFeedPatch"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator MySqlDataFeedPatch(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeMySqlDataFeedPatch(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
