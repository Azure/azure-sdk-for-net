...
namespace Azure.AI.MetricsAdvisor.Models
{
    internal partial class MySqlDataFeedPatch : IUtf8JsonSerializable, IJsonModel<MySqlDataFeedPatch>
    {
        ...
        MySqlDataFeedPatch IJsonModel<MySqlDataFeedPatch>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<MySqlDataFeedPatch>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        MySqlDataFeedPatch IModel<MySqlDataFeedPatch>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<MySqlDataFeedPatch>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
