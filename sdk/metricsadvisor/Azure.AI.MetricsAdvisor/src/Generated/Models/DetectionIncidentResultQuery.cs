...
namespace Azure.AI.MetricsAdvisor.Models
{
    ...
    internal partial class DetectionIncidentResultQuery
    {
        ...
        internal DetectionIncidentResultQuery(DateTimeOffset startTime, DateTimeOffset endTime, DetectionIncidentFilterCondition filter, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            StartTime = startTime;
            EndTime = endTime;
            Filter = filter;
