...
namespace Azure.AI.MetricsAdvisor.Administration
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<WebNotificationHook>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<WebNotificationHook>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<WebNotificationHook>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<WebNotificationHook>)} interface");
            }
        ...
        string IPersistableModel<WebNotificationHook>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
