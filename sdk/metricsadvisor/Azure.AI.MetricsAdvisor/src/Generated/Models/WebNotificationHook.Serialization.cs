...
{
    public partial class WebNotificationHook : Core.IUtf8JsonSerializable
    {
        ...
        internal static WebNotificationHook DeserializeWebNotificationHook(JsonElement element)
        {
            ...
            return new WebNotificationHook(hookType, hookId.Value, hookName, description.Value, externalLink.Value, Core.Optional.ToList(admins), hookParameter);
        }
    }
}
