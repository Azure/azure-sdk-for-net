...
{
    internal partial class PostgreSqlDataFeed : IUtf8JsonSerializable, IModelJsonSerializable<PostgreSqlDataFeed>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IModelJsonSerializable<PostgreSqlDataFeed>)this).Serialize(writer, ModelSerializerOptions.DefaultWireOptions);

        void IModelJsonSerializable<PostgreSqlDataFeed>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<PostgreSqlDataFeed>(this, options.Format);
            ...
            {
                ((IModelJsonSerializable<SqlSourceParameter>)DataSourceParameter).Serialize(writer, options);
            }
        ...
        internal static PostgreSqlDataFeed DeserializePostgreSqlDataFeed(JsonElement element, ModelSerializerOptions options = default)
        {
        ...
        PostgreSqlDataFeed IModelJsonSerializable<PostgreSqlDataFeed>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<PostgreSqlDataFeed>(this, options.Format);

            using var doc = JsonDocument.ParseValue(ref reader);
            return DeserializePostgreSqlDataFeed(doc.RootElement, options);
        }

        BinaryData IModelSerializable<PostgreSqlDataFeed>.Serialize(ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<PostgreSqlDataFeed>(this, options.Format);
        ...
        PostgreSqlDataFeed IModelSerializable<PostgreSqlDataFeed>.Deserialize(BinaryData data, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<PostgreSqlDataFeed>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="PostgreSqlDataFeed"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="PostgreSqlDataFeed"/> to convert. </param>
        public static implicit operator RequestContent(PostgreSqlDataFeed model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="PostgreSqlDataFeed"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator PostgreSqlDataFeed(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializePostgreSqlDataFeed(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
