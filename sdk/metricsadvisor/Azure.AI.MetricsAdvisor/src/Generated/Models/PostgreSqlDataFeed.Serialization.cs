...
namespace Azure.AI.MetricsAdvisor.Models
{
    internal partial class PostgreSqlDataFeed : IUtf8JsonSerializable, IJsonModel<PostgreSqlDataFeed>
    {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<PostgreSqlDataFeed>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(PostgreSqlDataFeed)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<PostgreSqlDataFeed>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(PostgreSqlDataFeed)} does not support '{options.Format}' format.");
            }
        }
