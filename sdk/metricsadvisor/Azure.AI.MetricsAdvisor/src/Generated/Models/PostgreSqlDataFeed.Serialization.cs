...
{
    internal partial class PostgreSqlDataFeed : IUtf8JsonSerializable, IJsonModel<PostgreSqlDataFeed>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PostgreSqlDataFeed>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<PostgreSqlDataFeed>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PostgreSqlDataFeed>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PostgreSqlDataFeed>)} interface");
            }
        ...
        PostgreSqlDataFeed IJsonModel<PostgreSqlDataFeed>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == "J" || options.Format == "W";
            if (!isValid)
            {
                throw new FormatException($"The model {nameof(PostgreSqlDataFeed)} does not support '{options.Format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializePostgreSqlDataFeed(document.RootElement, options);
        }

        internal static PostgreSqlDataFeed DeserializePostgreSqlDataFeed(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<PostgreSqlDataFeed>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == "J" || options.Format == "W";
            if (!isValid)
            {
        ...
        PostgreSqlDataFeed IPersistableModel<PostgreSqlDataFeed>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == "J" || options.Format == "W";
            if (!isValid)
            {
        ...
        string IPersistableModel<PostgreSqlDataFeed>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
