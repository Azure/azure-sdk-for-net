...
{
    internal partial class PostgreSqlDataFeed : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static PostgreSqlDataFeed DeserializePostgreSqlDataFeed(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
