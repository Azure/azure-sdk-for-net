...
namespace Azure.AI.MetricsAdvisor.Models
{
    internal partial class ServicePrincipalInKVCredentialPatch : IUtf8JsonSerializable, IJsonModel<ServicePrincipalInKVCredentialPatch>
    {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<ServicePrincipalInKVCredentialPatch>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(ServicePrincipalInKVCredentialPatch)} does not support '{format}' format.");
            }
        ...
        ServicePrincipalInKVCredentialPatch IJsonModel<ServicePrincipalInKVCredentialPatch>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ServicePrincipalInKVCredentialPatch>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        BinaryData IPersistableModel<ServicePrincipalInKVCredentialPatch>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ServicePrincipalInKVCredentialPatch>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(ServicePrincipalInKVCredentialPatch)} does not support '{options.Format}' format.");
            }
        }

        ServicePrincipalInKVCredentialPatch IPersistableModel<ServicePrincipalInKVCredentialPatch>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ServicePrincipalInKVCredentialPatch>)this).GetFormatFromOptions(options) : options.Format;
        ...
        string IPersistableModel<ServicePrincipalInKVCredentialPatch>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
