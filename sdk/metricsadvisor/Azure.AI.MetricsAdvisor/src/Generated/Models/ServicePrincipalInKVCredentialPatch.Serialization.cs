...
namespace Azure.AI.MetricsAdvisor.Models
{
    internal partial class ServicePrincipalInKVCredentialPatch : IUtf8JsonSerializable, IJsonModel<ServicePrincipalInKVCredentialPatch>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<ServicePrincipalInKVCredentialPatch>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ServicePrincipalInKVCredentialPatch>)} interface");
            }
