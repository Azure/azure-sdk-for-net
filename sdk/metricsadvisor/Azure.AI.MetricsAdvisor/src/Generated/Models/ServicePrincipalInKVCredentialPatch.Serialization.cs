...
namespace Azure.AI.MetricsAdvisor.Models
{
    internal partial class ServicePrincipalInKVCredentialPatch : IUtf8JsonSerializable, IModelJsonSerializable<ServicePrincipalInKVCredentialPatch>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<ServicePrincipalInKVCredentialPatch>(this, options.Format);
            ...
            if (Optional.IsDefined(Parameters))
            {
                ...
                {
                    ((IModelJsonSerializable<ServicePrincipalInKVParamPatch>)Parameters).Serialize(writer, options);
                }
            }
        ...
        internal static ServicePrincipalInKVCredentialPatch DeserializeServicePrincipalInKVCredentialPatch(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new ServicePrincipalInKVCredentialPatch(dataSourceCredentialType, dataSourceCredentialName.Value, dataSourceCredentialDescription.Value, parameters.Value, serializedAdditionalRawData);
        }
        ...
        /// <summary> Converts a <see cref="ServicePrincipalInKVCredentialPatch"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="ServicePrincipalInKVCredentialPatch"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="ServicePrincipalInKVCredentialPatch"/>. </summary>
