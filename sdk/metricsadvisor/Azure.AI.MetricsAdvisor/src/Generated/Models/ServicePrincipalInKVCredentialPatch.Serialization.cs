...
namespace Azure.AI.MetricsAdvisor.Models
{
    internal partial class ServicePrincipalInKVCredentialPatch : IUtf8JsonSerializable, IJsonModel<ServicePrincipalInKVCredentialPatch>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<ServicePrincipalInKVCredentialPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<ServicePrincipalInKVCredentialPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
