...
namespace Azure.AI.MetricsAdvisor.Models
{
    ...
    internal partial class AzureCosmosDBParameter
    {
        ...
        internal AzureCosmosDBParameter(string connectionString, string sqlQuery, string database, string collectionId, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
