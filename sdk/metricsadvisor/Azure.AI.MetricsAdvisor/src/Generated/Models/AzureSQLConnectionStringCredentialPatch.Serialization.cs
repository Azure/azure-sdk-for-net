...
namespace Azure.AI.MetricsAdvisor.Models
{
    internal partial class AzureSQLConnectionStringCredentialPatch : IUtf8JsonSerializable, IJsonModel<AzureSQLConnectionStringCredentialPatch>
    {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureSQLConnectionStringCredentialPatch>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(AzureSQLConnectionStringCredentialPatch)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<AzureSQLConnectionStringCredentialPatch>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(AzureSQLConnectionStringCredentialPatch)} does not support '{options.Format}' format.");
            }
        }
        ...
        string IPersistableModel<AzureSQLConnectionStringCredentialPatch>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
