...
namespace Azure.AI.MetricsAdvisor.Models
{
    ...
    internal partial class AzureApplicationInsightsParameter
    {
        ...
        internal AzureApplicationInsightsParameter(string azureCloud, string applicationId, string apiKey, string query, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
