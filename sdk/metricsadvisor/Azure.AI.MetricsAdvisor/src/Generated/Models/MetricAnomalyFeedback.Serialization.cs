...
namespace Azure.AI.MetricsAdvisor
{
    public partial class MetricAnomalyFeedback : IUtf8JsonSerializable, IJsonModel<MetricAnomalyFeedback>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<MetricAnomalyFeedback>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MetricAnomalyFeedback>)} interface");
            }
