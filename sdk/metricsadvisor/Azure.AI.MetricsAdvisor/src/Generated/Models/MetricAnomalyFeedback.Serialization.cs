...
namespace Azure.AI.MetricsAdvisor
{
    public partial class MetricAnomalyFeedback : IUtf8JsonSerializable, IModelJsonSerializable<MetricAnomalyFeedback>
    {
        ...
        internal static MetricAnomalyFeedback DeserializeMetricAnomalyFeedback(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new MetricAnomalyFeedback(feedbackType, feedbackId.Value, Optional.ToNullable(createdTime), userPrincipal.Value, metricId, dimensionFilter, startTime, endTime, value, anomalyDetectionConfigurationId.Value, anomalyDetectionConfigurationSnapshot.Value, serializedAdditionalRawData);
        }
