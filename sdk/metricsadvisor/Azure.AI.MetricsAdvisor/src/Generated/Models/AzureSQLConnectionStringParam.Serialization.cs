...
namespace Azure.AI.MetricsAdvisor.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureSQLConnectionStringParam>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AzureSQLConnectionStringParam>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AzureSQLConnectionStringParam>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AzureSQLConnectionStringParam>)} interface");
            }
        ...
        string IPersistableModel<AzureSQLConnectionStringParam>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
