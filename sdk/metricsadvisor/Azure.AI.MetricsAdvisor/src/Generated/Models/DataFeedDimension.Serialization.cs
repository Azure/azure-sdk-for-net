...
namespace Azure.AI.MetricsAdvisor.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataFeedDimension>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DataFeedDimension>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DataFeedDimension>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<DataFeedDimension>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
