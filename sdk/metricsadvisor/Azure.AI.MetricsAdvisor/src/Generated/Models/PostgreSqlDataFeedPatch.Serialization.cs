...
namespace Azure.AI.MetricsAdvisor.Models
{
    internal partial class PostgreSqlDataFeedPatch : IUtf8JsonSerializable, IJsonModel<PostgreSqlDataFeedPatch>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<PostgreSqlDataFeedPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<PostgreSqlDataFeedPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
