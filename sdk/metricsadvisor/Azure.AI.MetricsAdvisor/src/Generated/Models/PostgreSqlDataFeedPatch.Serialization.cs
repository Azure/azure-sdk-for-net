...
{
    internal partial class PostgreSqlDataFeedPatch : IUtf8JsonSerializable, IJsonModel<PostgreSqlDataFeedPatch>
    {
        void IJsonModel<PostgreSqlDataFeedPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PostgreSqlDataFeedPatch>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PostgreSqlDataFeedPatch>)} interface");
            }
        ...
        PostgreSqlDataFeedPatch IJsonModel<PostgreSqlDataFeedPatch>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == "J" || options.Format == "W";
            if (!isValid)
            {
                throw new FormatException($"The model {nameof(PostgreSqlDataFeedPatch)} does not support '{options.Format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializePostgreSqlDataFeedPatch(document.RootElement, options);
        }

        internal static PostgreSqlDataFeedPatch DeserializePostgreSqlDataFeedPatch(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<PostgreSqlDataFeedPatch>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == "J" || options.Format == "W";
            if (!isValid)
            {
        ...
        PostgreSqlDataFeedPatch IPersistableModel<PostgreSqlDataFeedPatch>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == "J" || options.Format == "W";
            if (!isValid)
            {
        ...
        string IPersistableModel<PostgreSqlDataFeedPatch>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
