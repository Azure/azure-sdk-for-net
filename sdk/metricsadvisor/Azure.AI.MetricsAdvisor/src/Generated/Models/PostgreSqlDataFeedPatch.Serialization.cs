...
{
    internal partial class PostgreSqlDataFeedPatch : IUtf8JsonSerializable, IModelJsonSerializable<PostgreSqlDataFeedPatch>
    {
        void IModelJsonSerializable<PostgreSqlDataFeedPatch>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<PostgreSqlDataFeedPatch>(this, options.Format);
        ...
        internal static PostgreSqlDataFeedPatch DeserializePostgreSqlDataFeedPatch(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new PostgreSqlDataFeedPatch(dataSourceType, dataFeedName.Value, dataFeedDescription.Value, timestampColumn.Value, Optional.ToNullable(dataStartFrom), Optional.ToNullable(startOffsetInSeconds), Optional.ToNullable(maxConcurrency), Optional.ToNullable(minRetryIntervalInSeconds), Optional.ToNullable(stopRetryAfterInSeconds), Optional.ToNullable(needRollup), Optional.ToNullable(rollUpMethod), Optional.ToList(rollUpColumns), allUpIdentification.Value, Optional.ToNullable(fillMissingPointType), Optional.ToNullable(fillMissingPointValue), Optional.ToNullable(viewMode), Optional.ToList(admins), Optional.ToList(viewers), Optional.ToNullable(status), actionLinkTemplate.Value, Optional.ToNullable(authenticationType), credentialId.Value, dataSourceParameter.Value, rawData);
        }

        PostgreSqlDataFeedPatch IModelJsonSerializable<PostgreSqlDataFeedPatch>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<PostgreSqlDataFeedPatch>(this, options.Format);

            using var doc = JsonDocument.ParseValue(ref reader);
            return DeserializePostgreSqlDataFeedPatch(doc.RootElement, options);
        }

        BinaryData IModelSerializable<PostgreSqlDataFeedPatch>.Serialize(ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<PostgreSqlDataFeedPatch>(this, options.Format);
        ...
        PostgreSqlDataFeedPatch IModelSerializable<PostgreSqlDataFeedPatch>.Deserialize(BinaryData data, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<PostgreSqlDataFeedPatch>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="PostgreSqlDataFeedPatch"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="PostgreSqlDataFeedPatch"/> to convert. </param>
        public static implicit operator RequestContent(PostgreSqlDataFeedPatch model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="PostgreSqlDataFeedPatch"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator PostgreSqlDataFeedPatch(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializePostgreSqlDataFeedPatch(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
