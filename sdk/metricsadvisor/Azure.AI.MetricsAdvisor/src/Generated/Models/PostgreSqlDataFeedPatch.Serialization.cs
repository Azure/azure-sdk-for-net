...
namespace Azure.AI.MetricsAdvisor.Models
{
    internal partial class PostgreSqlDataFeedPatch : IUtf8JsonSerializable, IJsonModel<PostgreSqlDataFeedPatch>
    {
        ...
        PostgreSqlDataFeedPatch IJsonModel<PostgreSqlDataFeedPatch>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<PostgreSqlDataFeedPatch>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        PostgreSqlDataFeedPatch IModel<PostgreSqlDataFeedPatch>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<PostgreSqlDataFeedPatch>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
