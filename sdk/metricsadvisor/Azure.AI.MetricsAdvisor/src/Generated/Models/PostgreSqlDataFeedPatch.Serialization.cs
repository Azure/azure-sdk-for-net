...
namespace Azure.AI.MetricsAdvisor.Models
{
    internal partial class PostgreSqlDataFeedPatch : IUtf8JsonSerializable, IJsonModel<PostgreSqlDataFeedPatch>
    {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<PostgreSqlDataFeedPatch>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(PostgreSqlDataFeedPatch)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<PostgreSqlDataFeedPatch>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(PostgreSqlDataFeedPatch)} does not support '{options.Format}' format.");
            }
        }
