...
namespace Azure.AI.MetricsAdvisor.Models
{
    ...
    public partial class MetricSeriesData
    {
        ...
        internal MetricSeriesData(MetricSeriesDefinition definition, IReadOnlyList<DateTimeOffset> timestamps, IReadOnlyList<double> metricValues, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Definition = definition;
