...
namespace Azure.AI.MetricsAdvisor
{
    internal partial class MicrosoftAzureMetricsAdvisorRestAPIOpenAPIV2RestClient
    {
        ...
        internal HttpMessage CreateUpdateAnomalyAlertingConfigurationRequest(Guid configurationId, AnomalyAlertingConfigurationPatch body)
        {
            ...
            ((IJsonModel<AnomalyAlertingConfigurationPatch>)body).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
        ...
        internal HttpMessage CreateCreateAnomalyAlertingConfigurationRequest(AnomalyAlertConfiguration body)
        {
            ...
            var content = new Utf8JsonRequestContent();
            ((IJsonModel<AnomalyAlertConfiguration>)body).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
            request.Content = content;
            return message;
        }
        ...
        internal HttpMessage CreateGetAlertsByAnomalyAlertingConfigurationRequest(Guid configurationId, AlertingResultQuery body, int? skip, int? maxpagesize)
        {
            ...
            request.Headers.Add("Content-Type", "application/json");
            var content = new Utf8JsonRequestContent();
            ((IJsonModel<AlertingResultQuery>)body).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
            request.Content = content;
            return message;
        }
        ...
        internal HttpMessage CreateUpdateAnomalyDetectionConfigurationRequest(Guid configurationId, AnomalyDetectionConfigurationPatch body)
        {
            ...
            request.Headers.Add("Content-Type", "application/merge-patch+json");
            var content = new Utf8JsonRequestContent();
            ((IJsonModel<AnomalyDetectionConfigurationPatch>)body).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
            request.Content = content;
            return message;
        }
        ...
        internal HttpMessage CreateCreateAnomalyDetectionConfigurationRequest(AnomalyDetectionConfiguration body)
        {
            ...
            request.Headers.Add("Content-Type", "application/json");
            var content = new Utf8JsonRequestContent();
            ((IJsonModel<AnomalyDetectionConfiguration>)body).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
            request.Content = content;
            return message;
        }
        ...
        internal HttpMessage CreateGetSeriesByAnomalyDetectionConfigurationRequest(Guid configurationId, DetectionSeriesQuery body)
        {
            ...
            request.Headers.Add("Content-Type", "application/json");
            var content = new Utf8JsonRequestContent();
            ((IJsonModel<DetectionSeriesQuery>)body).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
            request.Content = content;
            return message;
        }
        ...
        internal HttpMessage CreateGetAnomaliesByAnomalyDetectionConfigurationRequest(Guid configurationId, DetectionAnomalyResultQuery body, int? skip, int? maxpagesize)
        {
            ...
            request.Headers.Add("Content-Type", "application/json");
            var content = new Utf8JsonRequestContent();
            ((IJsonModel<DetectionAnomalyResultQuery>)body).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
            request.Content = content;
            return message;
        }
        ...
        internal HttpMessage CreateGetDimensionOfAnomaliesByAnomalyDetectionConfigurationRequest(Guid configurationId, AnomalyDimensionQuery body, int? skip, int? maxpagesize)
        {
            ...
            request.Headers.Add("Content-Type", "application/json");
            var content = new Utf8JsonRequestContent();
            ((IJsonModel<AnomalyDimensionQuery>)body).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
            request.Content = content;
            return message;
        }
        ...
        internal HttpMessage CreateGetIncidentsByAnomalyDetectionConfigurationRequest(Guid configurationId, DetectionIncidentResultQuery body, int? maxpagesize)
        {
            ...
            request.Headers.Add("Content-Type", "application/json");
            var content = new Utf8JsonRequestContent();
            ((IJsonModel<DetectionIncidentResultQuery>)body).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
            request.Content = content;
            return message;
        }
        ...
        internal HttpMessage CreateCreateCredentialRequest(DataSourceCredentialEntity body)
        {
            ...
            request.Headers.Add("Content-Type", "application/json");
            var content = new Utf8JsonRequestContent();
            ((IJsonModel<DataSourceCredentialEntity>)body).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
            request.Content = content;
            return message;
        }
        ...
        internal HttpMessage CreateUpdateCredentialRequest(Guid credentialId, DataSourceCredentialPatch body)
        {
            ...
            request.Headers.Add("Content-Type", "application/merge-patch+json");
            var content = new Utf8JsonRequestContent();
            ((IJsonModel<DataSourceCredentialPatch>)body).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
            request.Content = content;
            return message;
        }
        ...
        internal HttpMessage CreateCreateDataFeedRequest(DataFeedDetail body)
        {
            ...
            request.Headers.Add("Content-Type", "application/json");
            var content = new Utf8JsonRequestContent();
            ((IJsonModel<DataFeedDetail>)body).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
            request.Content = content;
            return message;
        }
        ...
        internal HttpMessage CreateUpdateDataFeedRequest(Guid dataFeedId, DataFeedDetailPatch body)
        {
            ...
            request.Headers.Add("Content-Type", "application/merge-patch+json");
            var content = new Utf8JsonRequestContent();
            ((IJsonModel<DataFeedDetailPatch>)body).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
            request.Content = content;
            return message;
        }
        ...
        internal HttpMessage CreateListMetricFeedbacksRequest(MetricFeedbackFilter body, int? skip, int? maxpagesize)
        {
            ...
            request.Headers.Add("Content-Type", "application/json");
            var content = new Utf8JsonRequestContent();
            ((IJsonModel<MetricFeedbackFilter>)body).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
            request.Content = content;
            return message;
        }
        ...
        internal HttpMessage CreateCreateMetricFeedbackRequest(MetricFeedback body)
        {
            ...
            request.Headers.Add("Content-Type", "application/json");
            var content = new Utf8JsonRequestContent();
            ((IJsonModel<MetricFeedback>)body).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
            request.Content = content;
            return message;
        }
        ...
        internal HttpMessage CreateCreateHookRequest(NotificationHook body)
        {
            ...
            request.Headers.Add("Content-Type", "application/json");
            var content = new Utf8JsonRequestContent();
            ((IJsonModel<NotificationHook>)body).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
            request.Content = content;
            return message;
        }
        ...
        internal HttpMessage CreateUpdateHookRequest(Guid hookId, HookInfoPatch body)
        {
            ...
            request.Headers.Add("Content-Type", "application/merge-patch+json");
            var content = new Utf8JsonRequestContent();
            ((IJsonModel<HookInfoPatch>)body).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
            request.Content = content;
            return message;
        }
        ...
        internal HttpMessage CreateGetDataFeedIngestionStatusRequest(Guid dataFeedId, IngestionStatusQueryOptions body, int? skip, int? maxpagesize)
        {
            ...
            request.Headers.Add("Content-Type", "application/json");
            var content = new Utf8JsonRequestContent();
            ((IJsonModel<IngestionStatusQueryOptions>)body).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
            request.Content = content;
            return message;
        }
        ...
        internal HttpMessage CreateResetDataFeedIngestionStatusRequest(Guid dataFeedId, IngestionProgressResetOptions body)
        {
            ...
            request.Headers.Add("Content-Type", "application/json");
            var content = new Utf8JsonRequestContent();
            ((IJsonModel<IngestionProgressResetOptions>)body).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
            request.Content = content;
            return message;
        }
        ...
        internal HttpMessage CreateGetMetricDataRequest(Guid metricId, MetricDataQueryOptions body)
        {
            ...
            request.Headers.Add("Content-Type", "application/json");
            var content = new Utf8JsonRequestContent();
            ((IJsonModel<MetricDataQueryOptions>)body).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
            request.Content = content;
            return message;
        }
        ...
        internal HttpMessage CreateGetMetricSeriesRequest(Guid metricId, MetricSeriesQueryOptions body, int? skip, int? maxpagesize)
        {
            ...
            request.Headers.Add("Content-Type", "application/json");
            var content = new Utf8JsonRequestContent();
            ((IJsonModel<MetricSeriesQueryOptions>)body).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
            request.Content = content;
            return message;
        }
        ...
        internal HttpMessage CreateGetMetricDimensionRequest(Guid metricId, MetricDimensionQueryOptions body, int? skip, int? maxpagesize)
        {
            ...
            request.Headers.Add("Content-Type", "application/json");
            var content = new Utf8JsonRequestContent();
            ((IJsonModel<MetricDimensionQueryOptions>)body).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
            request.Content = content;
            return message;
        }
        ...
        internal HttpMessage CreateGetEnrichmentStatusByMetricRequest(Guid metricId, EnrichmentStatusQueryOption body, int? skip, int? maxpagesize)
        {
            ...
            request.Headers.Add("Content-Type", "application/json");
            var content = new Utf8JsonRequestContent();
            ((IJsonModel<EnrichmentStatusQueryOption>)body).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
            request.Content = content;
            return message;
        }
