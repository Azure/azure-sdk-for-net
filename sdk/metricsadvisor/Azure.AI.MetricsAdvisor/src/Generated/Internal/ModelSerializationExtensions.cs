...
namespace Azure.AI.MetricsAdvisor
{
    ...
    {
        private static readonly JsonSerializerOptions s_options = new JsonSerializerOptions { Converters = { new JsonModelConverter(WireOptions, AzureAIMetricsAdvisorContext.Default) } };
