...
{
    /// <summary>
    /// The set of options that can be specified when calling MetricsAdvisorClient.GetMetricDimensionValues"/>
    /// or MetricsAdvisorClient.GetMetricDimensionValuesAsync"/> to configure the behavior of the request.
    /// </summary>
