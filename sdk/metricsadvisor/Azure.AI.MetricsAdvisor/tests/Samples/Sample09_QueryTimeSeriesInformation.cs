...
namespace Azure.AI.MetricsAdvisor.Samples
{
    public partial class MetricsAdvisorSamples : MetricsAdvisorTestEnvironment
    {
        ...
        public async Task GetDimensionValuesAsync()
        {
            ...
            var options = new GetDimensionValuesOptions() { MaximumPageSize = 10 };
        ...
        public async Task GetMetricEnrichmentStatusesAsync()
        {
            ...
            var startTime = DateTimeOffset.Parse("2020-01-01T00:00:00Z");
            var endTime = DateTimeOffset.UtcNow;
            var options = new GetMetricEnrichmentStatusesOptions(startTime, endTime) { MaximumPageSize = 5 };
        ...
        public async Task GetMetricSeriesDefinitionsAsync()
        {
            ...
            var options = new GetMetricSeriesDefinitionsOptions(activeSince) { MaximumPageSize = 5 };
