...
namespace Azure.AI.MetricsAdvisor.Administration
{
    ...
    public partial class MetricsAdvisorAdministrationClient
    {
        ...
        public virtual Azure.Pageable<System.BinaryData> GetDataFeedsRaws(string dataFeedName = null, string dataSourceType = null, string granularityName = null, string status = null, string creator = null, int? skip = default(int?), int? maxpagesize = default(int?), Azure.RequestContext context = null) { throw null; }
        public virtual Azure.AsyncPageable<System.BinaryData> GetDataFeedsRawsAsync(string dataFeedName = null, string dataSourceType = null, string granularityName = null, string status = null, string creator = null, int? skip = default(int?), int? maxpagesize = default(int?), Azure.RequestContext context = null) { throw null; }
