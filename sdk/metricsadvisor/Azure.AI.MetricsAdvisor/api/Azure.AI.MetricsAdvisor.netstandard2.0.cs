...
namespace Azure.AI.MetricsAdvisor.Models
{
    ...
    public static partial class MetricsAdvisorModelFactory
    {
        ...
        public static Azure.AI.MetricsAdvisor.Administration.DataSourceCredentialEntity DataSourceCredentialEntity(string credentialKind = "Unknown", string id = null, string name = null, string description = null) { throw null; }
