...
namespace SignalRServiceExtension.Tests.Config
{
    public class IConfigurationExtensionsFacts
    {
        ...
        public void TestGetNamedEndpointFromIdentityWithOnlyUri()
        {
            ...
            Assert.Equal(new Uri(uri), endpoint.ServerEndpoint);
            Assert.Equal(new Uri(uri), endpoint.ClientEndpoint);
        }
        ...
        public void TestGetNamedEndpointFromIdentityWithAllEndpointField()
        {
            ...
            config["eastus:serverEndpoint"] = "https://serverEndpoint:440";
            config["eastus:clientEndpoint"] = "https://clientEndpoint1:441";
            ...
            Assert.Equal(new Uri("https://serverEndpoint:440"), endpoint.ServerEndpoint);
            Assert.Equal(new Uri("https://clientEndpoint1:441"), endpoint.ClientEndpoint);
        }
