...
namespace Microsoft.Azure.Management.SignalR
{
    ...
    internal partial class SignalRPrivateEndpointConnectionsOperations : IServiceOperations<SignalRManagementClient>, ISignalRPrivateEndpointConnectionsOperations
    {
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<PrivateEndpointConnection>> UpdateWithHttpMessagesAsync(string privateEndpointConnectionName, string resourceGroupName, string resourceName, PrivateEndpointConnection parameters = default(PrivateEndpointConnection), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (privateEndpointConnectionName == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "privateEndpointConnectionName");
