...
{
    /// <summary>
    /// Copied from https://github.com/dotnet/aspnetcore/blob/v2.1.30/src/SignalR/common/Shared/MemoryBufferWriter.cs
    /// </summary>
    internal sealed class MemoryBufferWriter : Stream, IBufferWriter<byte>
    {
        ...
        public override Task CopyToAsync(Stream destination, int bufferSize, CancellationToken cancellationToken)
        {
            if (_completedSegments == null)
            {
                ...
                return destination.WriteAsync(_currentSegment, 0, _position, CancellationToken.None);
            }
        ...
        private async Task CopyToSlowAsync(Stream destination)
        {
            if (_completedSegments != null)
            {
                ...
                for (var i = 0; i < count; i++)
                {
                    ...
                    await destination.WriteAsync(segment.Buffer, 0, segment.Length).ConfigureAwait(false);
                }
            }
