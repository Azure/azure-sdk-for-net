...
namespace Azure.ResourceManager.SignalR.Samples
{
    public partial class Sample_ReplicaCollection
    {
        ...
        public async Task GetAll_SignalRReplicasList()
        {
            // Generated from example definition: 2025-01-01-preview/SignalRReplicas_List.json
            // this example is just showing the usage of "Replica_List" operation, for the dependent resources, they will have to be created separately.
            ...
            ReplicaCollection collection = signalR.GetReplicas();
