...
namespace Azure.ResourceManager.SignalR
{
    public partial class SignalRSharedPrivateLinkResourceCollection : ArmCollection
    {
        ...
        public virtual async Task<ArmOperation<SignalRSharedPrivateLinkResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string sharedPrivateLinkResourceName, SignalRSharedPrivateLinkResourceData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _signalRSharedPrivateLinkResourcesClientDiagnostics.CreateScope("SignalRSharedPrivateLinkResourceCollection.CreateOrUpdate");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _signalRSharedPrivateLinkResourcesRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, sharedPrivateLinkResourceName, SignalRSharedPrivateLinkResourceData.ToRequestContent(data), context);
