...
namespace Azure.ResourceManager.SignalR
{
    ...
    public partial class ReplicaCollection : ArmCollection, IEnumerable<ReplicaResource>, IAsyncEnumerable<ReplicaResource>
    {
        ...
        {
            _replicaClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.SignalR", ReplicaResource.ResourceType.Namespace, Diagnostics);
        ...
        /// <description>Replica_CreateOrUpdate</description>
        /// </item>
        /// <item>
        ...
        public virtual async Task<ArmOperation<ReplicaResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string replicaName, ReplicaData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _replicaRestClient.CreateOrUpdateAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, replicaName, data, cancellationToken).ConfigureAwait(false);
                var operation = new SignalRArmOperation<ReplicaResource>(new ReplicaOperationSource(Client), _replicaClientDiagnostics, Pipeline, _replicaRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, replicaName, data).Request, response, OperationFinalStateVia.AzureAsyncOperation);
        ...
        public virtual ArmOperation<ReplicaResource> CreateOrUpdate(WaitUntil waitUntil, string replicaName, ReplicaData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _replicaRestClient.CreateOrUpdate(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, replicaName, data, cancellationToken);
                var operation = new SignalRArmOperation<ReplicaResource>(new ReplicaOperationSource(Client), _replicaClientDiagnostics, Pipeline, _replicaRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, replicaName, data).Request, response, OperationFinalStateVia.AzureAsyncOperation);
                if (waitUntil == WaitUntil.Completed)
        ...
        /// <item>
        /// <term>Operation Id</term>
        /// <description>Replica_List</description>
        /// </item>
        /// <item>
        /// <term>Default Api Version</term>
        /// <description>2025-01-01-preview</description>
