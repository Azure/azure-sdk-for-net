...
namespace Azure.ResourceManager.SignalR
{
    ...
    public partial class SignalRReplicaSharedPrivateLinkResourceCollection : ArmCollection, IEnumerable<SignalRReplicaSharedPrivateLinkResource>, IAsyncEnumerable<SignalRReplicaSharedPrivateLinkResource>
    {
        ...
        {
            _signalRReplicaSharedPrivateLinkResourceSharedPrivateLinkResourcesClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.SignalR", SignalRReplicaSharedPrivateLinkResource.ResourceType.Namespace, Diagnostics);
            TryGetApiVersion(SignalRReplicaSharedPrivateLinkResource.ResourceType, out string signalRReplicaSharedPrivateLinkResourceSharedPrivateLinkResourcesApiVersion);
        ...
        public virtual async Task<ArmOperation<SignalRReplicaSharedPrivateLinkResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string sharedPrivateLinkResourceName, SignalRSharedPrivateLinkResourceData data, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _signalRReplicaSharedPrivateLinkResourceSharedPrivateLinkResourcesClientDiagnostics.CreateScope("SignalRReplicaSharedPrivateLinkResourceCollection.CreateOrUpdate");
            scope.Start();
            try
            {
                var response = await _signalRReplicaSharedPrivateLinkResourceSharedPrivateLinkResourcesRestClient.CreateOrUpdateAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, sharedPrivateLinkResourceName, data, cancellationToken).ConfigureAwait(false);
                var operation = new SignalRArmOperation<SignalRReplicaSharedPrivateLinkResource>(new SignalRReplicaSharedPrivateLinkResourceOperationSource(Client), _signalRReplicaSharedPrivateLinkResourceSharedPrivateLinkResourcesClientDiagnostics, Pipeline, _signalRReplicaSharedPrivateLinkResourceSharedPrivateLinkResourcesRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, sharedPrivateLinkResourceName, data).Request, response, OperationFinalStateVia.AzureAsyncOperation);
        ...
        public virtual ArmOperation<SignalRReplicaSharedPrivateLinkResource> CreateOrUpdate(WaitUntil waitUntil, string sharedPrivateLinkResourceName, SignalRSharedPrivateLinkResourceData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _signalRReplicaSharedPrivateLinkResourceSharedPrivateLinkResourcesRestClient.CreateOrUpdate(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, sharedPrivateLinkResourceName, data, cancellationToken);
                var operation = new SignalRArmOperation<SignalRReplicaSharedPrivateLinkResource>(new SignalRReplicaSharedPrivateLinkResourceOperationSource(Client), _signalRReplicaSharedPrivateLinkResourceSharedPrivateLinkResourcesClientDiagnostics, Pipeline, _signalRReplicaSharedPrivateLinkResourceSharedPrivateLinkResourcesRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, sharedPrivateLinkResourceName, data).Request, response, OperationFinalStateVia.AzureAsyncOperation);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<Response<SignalRReplicaSharedPrivateLinkResource>> GetAsync(string sharedPrivateLinkResourceName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _signalRReplicaSharedPrivateLinkResourceSharedPrivateLinkResourcesClientDiagnostics.CreateScope("SignalRReplicaSharedPrivateLinkResourceCollection.Get");
            scope.Start();
            try
            {
                var response = await _signalRReplicaSharedPrivateLinkResourceSharedPrivateLinkResourcesRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, sharedPrivateLinkResourceName, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<SignalRReplicaSharedPrivateLinkResource> Get(string sharedPrivateLinkResourceName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _signalRReplicaSharedPrivateLinkResourceSharedPrivateLinkResourcesRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, sharedPrivateLinkResourceName, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new SignalRReplicaSharedPrivateLinkResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        /// <item>
        /// <term>Operation Id</term>
        /// <description>SharedPrivateLinkResource_List</description>
        /// </item>
        /// <item>
        /// <term>Default Api Version</term>
        /// <description>2025-01-01-preview</description>
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _signalRReplicaSharedPrivateLinkResourceSharedPrivateLinkResourcesRestClient.CreateListRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _signalRReplicaSharedPrivateLinkResourceSharedPrivateLinkResourcesRestClient.CreateListNextPageRequest(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name);
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new SignalRReplicaSharedPrivateLinkResource(Client, SignalRSharedPrivateLinkResourceData.DeserializeSignalRSharedPrivateLinkResourceData(e)), _signalRReplicaSharedPrivateLinkResourceSharedPrivateLinkResourcesClientDiagnostics, Pipeline, "SignalRReplicaSharedPrivateLinkResourceCollection.GetAll", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string sharedPrivateLinkResourceName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _signalRReplicaSharedPrivateLinkResourceSharedPrivateLinkResourcesClientDiagnostics.CreateScope("SignalRReplicaSharedPrivateLinkResourceCollection.Exists");
            scope.Start();
            try
            {
                var response = await _signalRReplicaSharedPrivateLinkResourceSharedPrivateLinkResourcesRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, sharedPrivateLinkResourceName, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<bool> Exists(string sharedPrivateLinkResourceName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _signalRReplicaSharedPrivateLinkResourceSharedPrivateLinkResourcesRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, sharedPrivateLinkResourceName, cancellationToken: cancellationToken);
                return Response.FromValue(response.Value != null, response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        public virtual async Task<NullableResponse<SignalRReplicaSharedPrivateLinkResource>> GetIfExistsAsync(string sharedPrivateLinkResourceName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _signalRReplicaSharedPrivateLinkResourceSharedPrivateLinkResourcesClientDiagnostics.CreateScope("SignalRReplicaSharedPrivateLinkResourceCollection.GetIfExists");
            scope.Start();
            try
            {
                var response = await _signalRReplicaSharedPrivateLinkResourceSharedPrivateLinkResourcesRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, sharedPrivateLinkResourceName, cancellationToken: cancellationToken).ConfigureAwait(false);
