...
{
    /// <summary></summary>
    internal partial class SignalRCustomDomainResourceOperationSource : IOperationSource<SignalRCustomDomainResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal SignalRCustomDomainResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
