...
namespace Azure.ResourceManager.SignalR
{
    internal partial class SignalRArmOperation<T> : ArmOperation<T>
    {
        ...
        internal SignalRArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
