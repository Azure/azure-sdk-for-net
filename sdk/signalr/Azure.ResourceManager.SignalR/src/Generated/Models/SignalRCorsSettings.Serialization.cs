...
{
    internal partial class SignalRCorsSettings : IUtf8JsonSerializable, IJsonModel<SignalRCorsSettings>, IPersistableModel<SignalRCorsSettings>
    {
        ...
        void IJsonModel<SignalRCorsSettings>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SignalRCorsSettings)} does not support '{format}' format.");
            }
