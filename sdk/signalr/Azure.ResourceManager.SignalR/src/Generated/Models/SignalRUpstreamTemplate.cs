...
namespace Azure.ResourceManager.SignalR.Models
{
    ...
    public partial class SignalRUpstreamTemplate
    {
        ...
        internal SignalRUpstreamTemplate(string hubPattern, string eventPattern, string categoryPattern, string urlTemplate, SignalRUpstreamAuthSettings auth, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
