...
namespace Azure.ResourceManager.SignalR.Models
{
    ...
    internal partial class ReplicaList
    {
        ...
        internal ReplicaList(IEnumerable<SignalRReplicaData> value)
        {
            Value = value.ToList();
        }
        ...
        internal ReplicaList(IList<SignalRReplicaData> value, Uri nextLink, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            NextLink = nextLink;
        ...
        public IList<SignalRReplicaData> Value { get; }
