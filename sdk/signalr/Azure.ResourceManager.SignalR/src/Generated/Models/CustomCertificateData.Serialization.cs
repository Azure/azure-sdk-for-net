...
{
    public partial class CustomCertificateData : IUtf8JsonSerializable
    {
        ...
        internal static CustomCertificateData DeserializeCustomCertificateData(JsonElement element)
        {
            ...
            return new CustomCertificateData(id, name, type, systemData.Value, Optional.ToNullable(provisioningState), keyVaultBaseUri, keyVaultSecretName, keyVaultSecretVersion.Value);
        }
    }
}
