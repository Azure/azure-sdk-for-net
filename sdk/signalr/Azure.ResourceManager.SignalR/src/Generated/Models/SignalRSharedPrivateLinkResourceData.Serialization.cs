...
namespace Azure.ResourceManager.SignalR
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SignalRSharedPrivateLinkResourceData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SignalRSharedPrivateLinkResourceData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SignalRSharedPrivateLinkResourceData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SignalRSharedPrivateLinkResourceData>)} interface");
            }
        ...
        string IPersistableModel<SignalRSharedPrivateLinkResourceData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
