...
{
    public partial class SignalRSharedPrivateLinkResourceData : IUtf8JsonSerializable, IJsonModel<SignalRSharedPrivateLinkResourceData>, IPersistableModel<SignalRSharedPrivateLinkResourceData>
    {
        ...
        void IJsonModel<SignalRSharedPrivateLinkResourceData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SignalRSharedPrivateLinkResourceData)} does not support '{format}' format.");
            }
