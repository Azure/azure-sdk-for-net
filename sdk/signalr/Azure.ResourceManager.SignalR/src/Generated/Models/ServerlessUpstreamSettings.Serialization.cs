...
namespace Azure.ResourceManager.SignalR.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ServerlessUpstreamSettings>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ServerlessUpstreamSettings>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ServerlessUpstreamSettings>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ServerlessUpstreamSettings>)} interface");
            }
        ...
        string IPersistableModel<ServerlessUpstreamSettings>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
