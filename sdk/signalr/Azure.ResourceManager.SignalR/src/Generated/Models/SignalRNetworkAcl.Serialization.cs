...
namespace Azure.ResourceManager.SignalR.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SignalRNetworkAcl>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SignalRNetworkAcl>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SignalRNetworkAcl>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SignalRNetworkAcl>)} interface");
            }
        ...
        string IPersistableModel<SignalRNetworkAcl>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
