...
namespace Azure.ResourceManager.SignalR.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SignalRKeys>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SignalRKeys>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SignalRKeys>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SignalRKeys>)} interface");
            }
        ...
        string IPersistableModel<SignalRKeys>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
