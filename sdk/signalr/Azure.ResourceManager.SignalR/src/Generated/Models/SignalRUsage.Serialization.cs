...
namespace Azure.ResourceManager.SignalR.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SignalRUsage>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SignalRUsage>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SignalRUsage>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SignalRUsage>)} interface");
            }
        ...
        string IPersistableModel<SignalRUsage>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
