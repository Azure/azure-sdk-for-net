...
namespace Azure.ResourceManager.SignalR.Models
{
    ...
    public partial class SignalRKeys
    {
        ...
        internal SignalRKeys(string primaryKey, string secondaryKey, string primaryConnectionString, string secondaryConnectionString, Dictionary<string, BinaryData> rawData)
        {
