...
namespace Azure.ResourceManager.SignalR.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SignalRPrivateLinkServiceConnectionState>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SignalRPrivateLinkServiceConnectionState>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SignalRPrivateLinkServiceConnectionState>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SignalRPrivateLinkServiceConnectionState>)} interface");
            }
        ...
        string IPersistableModel<SignalRPrivateLinkServiceConnectionState>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
