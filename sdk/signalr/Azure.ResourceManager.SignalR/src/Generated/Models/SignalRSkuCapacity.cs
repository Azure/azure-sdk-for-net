...
namespace Azure.ResourceManager.SignalR.Models
{
    ...
    public partial class SignalRSkuCapacity
    {
        ...
        internal SignalRSkuCapacity(int? minimum, int? maximum, int? @default, IReadOnlyList<int> allowedValues, SignalRScaleType? scaleType, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Minimum = minimum;
            Maximum = maximum;
            Default = @default;
