...
namespace Azure.ResourceManager.SignalR.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SignalRPrivateLinkResource>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SignalRPrivateLinkResource>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SignalRPrivateLinkResource>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SignalRPrivateLinkResource>)} interface");
            }
        ...
        SignalRPrivateLinkResource IJsonModel<SignalRPrivateLinkResource>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        SignalRPrivateLinkResource IPersistableModel<SignalRPrivateLinkResource>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == "J" || options.Format == "W";
            if (!isValid)
            {
        ...
        string IPersistableModel<SignalRPrivateLinkResource>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
