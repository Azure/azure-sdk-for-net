...
namespace Azure.ResourceManager.SignalR.Models
{
    ...
    public partial class SignalRLiveTraceConfiguration
    {
        ...
        internal SignalRLiveTraceConfiguration(string enabled, IList<SignalRLiveTraceCategory> categories, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Enabled = enabled;
