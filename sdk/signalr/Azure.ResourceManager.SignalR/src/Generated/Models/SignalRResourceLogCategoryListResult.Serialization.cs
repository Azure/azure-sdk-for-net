...
namespace Azure.ResourceManager.SignalR.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SignalRResourceLogCategoryListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SignalRResourceLogCategoryListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SignalRResourceLogCategoryListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SignalRResourceLogCategoryListResult>)} interface");
            }
        ...
        string IPersistableModel<SignalRResourceLogCategoryListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
