...
namespace Azure.ResourceManager.SignalR.Models
{
    ...
    public partial class SignalRNameAvailabilityResult : IJsonModel<SignalRNameAvailabilityResult>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        SignalRNameAvailabilityResult IJsonModel<SignalRNameAvailabilityResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual SignalRNameAvailabilityResult JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<SignalRNameAvailabilityResult>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static SignalRNameAvailabilityResult DeserializeSignalRNameAvailabilityResult(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new SignalRNameAvailabilityResult(isNameAvailable, reason, message, additionalBinaryDataProperties);
        }

        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<SignalRNameAvailabilityResult>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
