...
namespace Azure.ResourceManager.SignalR.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SignalRResourceSku>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SignalRResourceSku>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SignalRResourceSku>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SignalRResourceSku>)} interface");
            }
        ...
        string IPersistableModel<SignalRResourceSku>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
