...
namespace Azure.ResourceManager.SignalR.Models
{
    ...
    public partial class SignalRResourceSku
    {
        ...
        internal SignalRResourceSku(string name, SignalRSkuTier? tier, string size, string family, int? capacity, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Tier = tier;
            Size = size;
