...
namespace Azure.ResourceManager.SignalR.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SignalRTlsSettings>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SignalRTlsSettings>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SignalRTlsSettings>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SignalRTlsSettings>)} interface");
            }
        ...
        string IPersistableModel<SignalRTlsSettings>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
