...
namespace Azure.ResourceManager.SignalR.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SignalRCustomCertificateListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SignalRCustomCertificateListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SignalRCustomCertificateListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SignalRCustomCertificateListResult>)} interface");
            }
        ...
        string IPersistableModel<SignalRCustomCertificateListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
