...
namespace Azure.ResourceManager.SignalR
{
    public partial class SharedPrivateLinkResourceData : IUtf8JsonSerializable
    {
        ...
        internal static SharedPrivateLinkResourceData DeserializeSharedPrivateLinkResourceData(JsonElement element)
        {
            ...
            return new SharedPrivateLinkResourceData(id, name, type, systemData.Value, groupId.Value, privateLinkResourceId.Value, Optional.ToNullable(provisioningState), requestMessage.Value, Optional.ToNullable(status));
        }
    }
}
