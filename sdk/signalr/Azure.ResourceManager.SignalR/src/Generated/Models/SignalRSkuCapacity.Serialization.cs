...
namespace Azure.ResourceManager.SignalR.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SignalRSkuCapacity>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SignalRSkuCapacity>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SignalRSkuCapacity>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SignalRSkuCapacity>)} interface");
            }
        ...
        string IPersistableModel<SignalRSkuCapacity>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
