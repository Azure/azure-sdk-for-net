...
{
    public partial class SignalRUsageName : IUtf8JsonSerializable, IJsonModel<SignalRUsageName>, IPersistableModel<SignalRUsageName>
    {
        ...
        void IJsonModel<SignalRUsageName>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SignalRUsageName)} does not support '{format}' format.");
            }
