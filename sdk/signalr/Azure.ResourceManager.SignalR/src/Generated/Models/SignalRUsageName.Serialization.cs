...
namespace Azure.ResourceManager.SignalR.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SignalRUsageName>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SignalRUsageName>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SignalRUsageName>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SignalRUsageName>)} interface");
            }
        ...
        string IPersistableModel<SignalRUsageName>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
