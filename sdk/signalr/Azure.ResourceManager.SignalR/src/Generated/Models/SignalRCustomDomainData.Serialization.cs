...
{
    public partial class SignalRCustomDomainData : IUtf8JsonSerializable, IJsonModel<SignalRCustomDomainData>, IPersistableModel<SignalRCustomDomainData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(CustomCertificate))
            {
                ...
                AppendChildObject(builder, CustomCertificate, options, 2);
            }
