...
namespace Azure.ResourceManager.SignalR
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SignalRCustomDomainData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SignalRCustomDomainData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SignalRCustomDomainData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SignalRCustomDomainData>)} interface");
            }
        ...
        string IPersistableModel<SignalRCustomDomainData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
