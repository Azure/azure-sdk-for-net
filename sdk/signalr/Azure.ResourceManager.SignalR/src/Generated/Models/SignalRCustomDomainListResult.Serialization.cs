...
namespace Azure.ResourceManager.SignalR.Models
{
    ...
    {
        internal static SignalRCustomDomainListResult DeserializeSignalRCustomDomainListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
