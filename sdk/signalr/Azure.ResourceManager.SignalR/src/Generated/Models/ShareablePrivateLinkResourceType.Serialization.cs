...
namespace Azure.ResourceManager.SignalR.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ShareablePrivateLinkResourceType>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ShareablePrivateLinkResourceType>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ShareablePrivateLinkResourceType>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ShareablePrivateLinkResourceType>)} interface");
            }
        ...
        string IPersistableModel<ShareablePrivateLinkResourceType>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
