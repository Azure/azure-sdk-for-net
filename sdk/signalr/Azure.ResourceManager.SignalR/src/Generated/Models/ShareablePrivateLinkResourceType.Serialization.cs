...
namespace Azure.ResourceManager.SignalR.Models
{
    ...
    public partial class ShareablePrivateLinkResourceType : IJsonModel<ShareablePrivateLinkResourceType>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ShareablePrivateLinkResourceType IJsonModel<ShareablePrivateLinkResourceType>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual ShareablePrivateLinkResourceType JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<ShareablePrivateLinkResourceType>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static ShareablePrivateLinkResourceType DeserializeShareablePrivateLinkResourceType(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = ShareablePrivateLinkResourceProperties.DeserializeShareablePrivateLinkResourceProperties(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
            ...
            return new ShareablePrivateLinkResourceType(name, properties, additionalBinaryDataProperties);
        }

        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ShareablePrivateLinkResourceType>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
