...
namespace Azure.ResourceManager.SignalR
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SignalRCustomCertificateData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SignalRCustomCertificateData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SignalRCustomCertificateData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SignalRCustomCertificateData>)} interface");
            }
        ...
        string IPersistableModel<SignalRCustomCertificateData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
