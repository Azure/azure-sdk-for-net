...
namespace Azure.ResourceManager.SignalR.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SignalRUpstreamTemplate>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SignalRUpstreamTemplate>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SignalRUpstreamTemplate>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<SignalRUpstreamTemplate>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
