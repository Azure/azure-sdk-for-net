...
{
    public partial class SignalRData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static SignalRData DeserializeSignalRData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
