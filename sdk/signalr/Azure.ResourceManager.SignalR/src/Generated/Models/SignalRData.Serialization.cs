...
{
    public partial class SignalRData : IUtf8JsonSerializable, IJsonModel<SignalRData>, IPersistableModel<SignalRData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Upstream))
            {
                ...
                AppendChildObject(builder, Upstream, options, 2);
            }
