...
namespace Azure.ResourceManager.SignalR.Models
{
    ...
    public partial class SignalRPrivateEndpointAcl : SignalRNetworkAcl
    {
        ...
        internal SignalRPrivateEndpointAcl(IList<SignalRRequestType> allow, IList<SignalRRequestType> deny, string name, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(allow, deny, serializedAdditionalRawData)
        {
            Name = name;
        }
