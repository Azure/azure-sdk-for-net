...
namespace Azure.ResourceManager.SignalR.Models
{
    ...
    public partial class SignalRPrivateEndpointAcl : SignalRNetworkAcl
    {
        ...
        internal SignalRPrivateEndpointAcl(IList<SignalRRequestType> allow, IList<SignalRRequestType> deny, string name, Dictionary<string, BinaryData> rawData) : base(allow, deny, rawData)
        {
            Name = name;
        }
