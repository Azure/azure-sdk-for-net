...
namespace Azure.ResourceManager.SignalR.Models
{
    ...
    public partial class TrafficThrottleByJwtCustomClaimRule : ClientTrafficControlRule
    {
        ...
        public TrafficThrottleByJwtCustomClaimRule(string claimName)
        {
            ...
            ClaimName = claimName;
            Type = ClientTrafficControlRuleDiscriminator.TrafficThrottleByJwtCustomClaimRule;
        }
        ...
        internal TrafficThrottleByJwtCustomClaimRule(ClientTrafficControlRuleDiscriminator type, IDictionary<string, BinaryData> serializedAdditionalRawData, string claimName, long? maxInboundMessageBytes, int? aggregationWindowInSeconds) : base(type, serializedAdditionalRawData)
        {
            ClaimName = claimName;
