...
namespace Azure.ResourceManager.SignalR.Models
{
    ...
    public partial class ShareablePrivateLinkResourceProperties
    {
        ...
        internal ShareablePrivateLinkResourceProperties(string description, string groupId, string shareablePrivateLinkResourcePropertiesType, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
