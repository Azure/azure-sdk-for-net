...
namespace Azure.ResourceManager.SignalR
{
    ...
    /// Otherwise you can get one from its parent resource <see cref="SignalRResource" /> using the GetCustomDomain method.
    /// </summary>
    public partial class CustomDomainResource : ArmResource
    {
        ...
        {
            _customDomainSignalRCustomDomainsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.SignalR", ResourceType.Namespace, Diagnostics);
            TryGetApiVersion(ResourceType, out string customDomainSignalRCustomDomainsApiVersion);
        ...
        {
            using var scope = _customDomainSignalRCustomDomainsClientDiagnostics.CreateScope("CustomDomainResource.Get");
            scope.Start();
            try
            {
                var response = await _customDomainSignalRCustomDomainsRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<CustomDomainResource> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _customDomainSignalRCustomDomainsRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new CustomDomainResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        /// Request Path: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.SignalRService/signalR/{resourceName}/customDomains/{name}
        /// Operation Id: SignalRCustomDomains_Delete
        /// </summary>
        /// <param name="waitUntil"> <see cref="WaitUntil.Completed"/> if the method should wait to return until the long-running operation has completed on the service; <see cref="WaitUntil.Started"/> if it should return after starting the operation. For more information on long-running operations, please see <see href="https://github.com/Azure/azure-sdk-for-net/blob/main/sdk/core/Azure.Core/samples/LongRunningOperations.md"> Azure.Core Long-Running Operation samples</see>. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            using var scope = _customDomainSignalRCustomDomainsClientDiagnostics.CreateScope("CustomDomainResource.Delete");
            scope.Start();
            try
            {
                var response = await _customDomainSignalRCustomDomainsRestClient.DeleteAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
                var operation = new SignalRArmOperation(_customDomainSignalRCustomDomainsClientDiagnostics, Pipeline, _customDomainSignalRCustomDomainsRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name).Request, response, OperationFinalStateVia.NotSpecified);
        ...
        public virtual ArmOperation Delete(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _customDomainSignalRCustomDomainsRestClient.Delete(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                var operation = new SignalRArmOperation(_customDomainSignalRCustomDomainsClientDiagnostics, Pipeline, _customDomainSignalRCustomDomainsRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name).Request, response, OperationFinalStateVia.NotSpecified);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<ArmOperation<CustomDomainResource>> UpdateAsync(WaitUntil waitUntil, CustomDomainData data, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _customDomainSignalRCustomDomainsClientDiagnostics.CreateScope("CustomDomainResource.Update");
            scope.Start();
            try
            {
                var response = await _customDomainSignalRCustomDomainsRestClient.CreateOrUpdateAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, data, cancellationToken).ConfigureAwait(false);
        ...
        public virtual ArmOperation<CustomDomainResource> Update(WaitUntil waitUntil, CustomDomainData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _customDomainSignalRCustomDomainsRestClient.CreateOrUpdate(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, data, cancellationToken);
                var operation = new SignalRArmOperation<CustomDomainResource>(new CustomDomainOperationSource(Client), _customDomainSignalRCustomDomainsClientDiagnostics, Pipeline, _customDomainSignalRCustomDomainsRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, data).Request, response, OperationFinalStateVia.NotSpecified);
                if (waitUntil == WaitUntil.Completed)
