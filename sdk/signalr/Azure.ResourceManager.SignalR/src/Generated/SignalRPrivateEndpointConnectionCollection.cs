...
namespace Azure.ResourceManager.SignalR
{
    ...
    public partial class SignalRPrivateEndpointConnectionCollection : ArmCollection, IEnumerable<SignalRPrivateEndpointConnectionResource>, IAsyncEnumerable<SignalRPrivateEndpointConnectionResource>
    {
        ...
        public virtual AsyncPageable<SignalRPrivateEndpointConnectionResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => { var data = SignalRPrivateEndpointConnectionData.DeserializeSignalRPrivateEndpointConnectionData(e); return new SignalRPrivateEndpointConnectionResource(Client, data, data.Id); }, _signalRPrivateEndpointConnectionClientDiagnostics, Pipeline, "SignalRPrivateEndpointConnectionCollection.GetAll", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<SignalRPrivateEndpointConnectionResource> GetAll(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _signalRPrivateEndpointConnectionRestClient.CreateListRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _signalRPrivateEndpointConnectionRestClient.CreateListNextPageRequest(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Name);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => { var data = SignalRPrivateEndpointConnectionData.DeserializeSignalRPrivateEndpointConnectionData(e); return new SignalRPrivateEndpointConnectionResource(Client, data, data.Id); }, _signalRPrivateEndpointConnectionClientDiagnostics, Pipeline, "SignalRPrivateEndpointConnectionCollection.GetAll", "value", "nextLink", cancellationToken);
        }
