...
namespace Azure.ResourceManager.SignalR.Models
{
    ...
    public static partial class ArmSignalRModelFactory
    {
        ...
        {
            return new SignalRNameAvailabilityResult(isNameAvailable, reason, message, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SignalRUsage(id, currentValue, limit, name, unit, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SignalRUsageName(value, localizedValue, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SignalRResourceSku(name, tier, size, family, capacity, new Dictionary<string, BinaryData>());
        }
        ...
        public static SignalRPrivateEndpointConnectionData SignalRPrivateEndpointConnectionData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, SignalRProvisioningState? provisioningState = null, ResourceIdentifier privateEndpointId = null, IEnumerable<string> groupIds = null, SignalRPrivateLinkServiceConnectionState connectionState = null)
        {
            ...
            return new SignalRPrivateEndpointConnectionData(id, name, resourceType, systemData, provisioningState, privateEndpointId != null ? ResourceManagerModelFactory.WritableSubResource(privateEndpointId) : null, groupIds?.ToList(), connectionState, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SignalRSharedPrivateLinkResourceData(id, name, resourceType, systemData, groupId, privateLinkResourceId, provisioningState, requestMessage, status, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SignalRCustomCertificateData(id, name, resourceType, systemData, provisioningState, keyVaultBaseUri, keyVaultSecretName, keyVaultSecretVersion, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SignalRCustomDomainData(id, name, resourceType, systemData, provisioningState, domainName, customCertificateId != null ? ResourceManagerModelFactory.WritableSubResource(customCertificateId) : null, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SignalRKeys(primaryKey, secondaryKey, primaryConnectionString, secondaryConnectionString, new Dictionary<string, BinaryData>());
        }
        ...
        public static SignalRPrivateLinkResource SignalRPrivateLinkResource(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string groupId = null, IEnumerable<string> requiredMembers = null, IEnumerable<string> requiredZoneNames = null, IEnumerable<ShareablePrivateLinkResourceType> shareablePrivateLinkResourceTypes = null)
        {
            ...
            return new SignalRPrivateLinkResource(id, name, resourceType, systemData, groupId, requiredMembers?.ToList(), requiredZoneNames?.ToList(), shareablePrivateLinkResourceTypes?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SignalRSku(resourceType, sku, capacity, new Dictionary<string, BinaryData>());
        }
        ...
        public static SignalRSkuCapacity SignalRSkuCapacity(int? minimum = null, int? maximum = null, int? @default = null, IEnumerable<int> allowedValues = null, SignalRScaleType? scaleType = null)
        {
            ...
            return new SignalRSkuCapacity(minimum, maximum, @default, allowedValues?.ToList(), scaleType, new Dictionary<string, BinaryData>());
        }
    }
}
