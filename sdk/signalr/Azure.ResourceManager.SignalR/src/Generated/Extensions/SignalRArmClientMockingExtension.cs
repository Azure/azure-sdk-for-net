...
namespace Azure.ResourceManager.SignalR.Mocking
{
    ...
    internal partial class SignalRArmClientMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="SignalRArmClientMockingExtension"/> class for mocking. </summary>
        protected SignalRArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="SignalRArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal SignalRArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal SignalRArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
