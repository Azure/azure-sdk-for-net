...
namespace Azure.ResourceManager.SignalR.Mocking
{
    ...
    internal partial class SignalRResourceGroupMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="SignalRResourceGroupMockingExtension"/> class for mocking. </summary>
        protected SignalRResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="SignalRResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal SignalRResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
