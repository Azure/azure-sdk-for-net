...
namespace Azure.ResourceManager.SignalR
{
    ...
    public partial class SignalRPrivateEndpointConnectionResource : ArmResource
    {
        ...
        internal SignalRPrivateEndpointConnectionResource(ArmClient client, SignalRPrivateEndpointConnectionData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<SignalRPrivateEndpointConnectionResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new SignalRPrivateEndpointConnectionResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual async Task<ArmOperation<SignalRPrivateEndpointConnectionResource>> UpdateAsync(WaitUntil waitUntil, SignalRPrivateEndpointConnectionData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new SignalRArmOperation<SignalRPrivateEndpointConnectionResource>(Response.FromValue(new SignalRPrivateEndpointConnectionResource(Client, response.Value, response.Value.Id), response.GetRawResponse()));
                if (waitUntil == WaitUntil.Completed)
