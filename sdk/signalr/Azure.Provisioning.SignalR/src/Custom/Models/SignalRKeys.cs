...
// Preserve the access-key result type and secure Bicep mappings used by the custom GetKeys() API.
/// <summary> The access keys of a SignalR resource. </summary>
public partial class SignalRKeys : ProvisionableConstruct
{
    ...
    /// <summary> Creates a new instance of <see cref="SignalRKeys"/>. </summary>
    public SignalRKeys()
    {
    }
