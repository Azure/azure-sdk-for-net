...
namespace Azure.Provisioning.SignalR
{
    ...
    public partial class SignalRReplica : ProvisionableResource
    {
        ...
        /// <summary> Creates a new SignalRReplica. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public SignalRReplica(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.SignalRService/signalR/replicas", resourceVersion ?? "2025-01-01-preview")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for SignalRReplica. </summary>
        ...
        /// <summary> Creates a reference to an existing SignalRReplica. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static SignalRReplica FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            SignalRReplica result = new SignalRReplica(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for SignalRReplica that are not part of the generated code. </summary>
