...
namespace Azure.ResourceManager.ChangeAnalysis.Models
{
    ...
    public partial class ChangeProperties
    {
        ...
        internal ChangeProperties(ResourceIdentifier resourceId, DateTimeOffset? changeDetectedOn, IReadOnlyList<string> initiatedByList, ChangeType? changeType, IReadOnlyList<PropertyChange> propertyChanges, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
