...
namespace Azure.ResourceManager.ChangeAnalysis.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PropertyChange>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PropertyChange>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PropertyChange>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PropertyChange>)} interface");
            }
        ...
        string IPersistableModel<PropertyChange>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
