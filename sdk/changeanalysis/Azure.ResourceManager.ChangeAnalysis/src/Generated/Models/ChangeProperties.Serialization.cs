...
{
    public partial class ChangeProperties : IUtf8JsonSerializable, IJsonModel<ChangeProperties>, IPersistableModel<ChangeProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ChangeDetectedOn))
            {
                ...
                builder.AppendLine($" '{ChangeDetectedOn.Value.ToString()}'");
            }

            if (Optional.IsCollectionDefined(InitiatedByList))
            {
                builder.Append("  initiatedByList:");
                builder.AppendLine(" [");
                foreach (var item in InitiatedByList)
                {
                    if (item == null)
            ...
            if (Optional.IsCollectionDefined(PropertyChanges))
            {
                builder.Append("  propertyChanges:");
                builder.AppendLine(" [");
                foreach (var item in PropertyChanges)
                {
