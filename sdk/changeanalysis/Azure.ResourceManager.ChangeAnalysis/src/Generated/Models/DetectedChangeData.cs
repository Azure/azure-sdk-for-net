...
namespace Azure.ResourceManager.ChangeAnalysis.Models
{
    ...
    public partial class DetectedChangeData : ResourceData
    {
        ...
        internal DetectedChangeData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, ChangeProperties properties, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
