...
namespace Azure.ResourceManager.ChangeAnalysis.Mocking
{
    ...
    public partial class ChangeAnalysisSubscriptionMockingExtension : ArmResource
    {
        private ClientDiagnostics _changesClientDiagnostics;
        private ChangesRestOperations _changesRestClient;

        /// <summary> Initializes a new instance of the <see cref="ChangeAnalysisSubscriptionMockingExtension"/> class for mocking. </summary>
        protected ChangeAnalysisSubscriptionMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ChangeAnalysisSubscriptionMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ChangeAnalysisSubscriptionMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<DetectedChangeData> GetChangesBySubscriptionAsync(DateTimeOffset startTime, DateTimeOffset endTime, string skipToken = null, CancellationToken cancellationToken = default)
        {
            ...
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, DetectedChangeData.DeserializeDetectedChangeData, ChangesClientDiagnostics, Pipeline, "ChangeAnalysisSubscriptionMockingExtension.GetChangesBySubscription", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<DetectedChangeData> GetChangesBySubscription(DateTimeOffset startTime, DateTimeOffset endTime, string skipToken = null, CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => ChangesRestClient.CreateListChangesBySubscriptionRequest(Id.SubscriptionId, startTime, endTime, skipToken);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => ChangesRestClient.CreateListChangesBySubscriptionNextPageRequest(nextLink, Id.SubscriptionId, startTime, endTime, skipToken);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, DetectedChangeData.DeserializeDetectedChangeData, ChangesClientDiagnostics, Pipeline, "ChangeAnalysisSubscriptionMockingExtension.GetChangesBySubscription", "value", "nextLink", cancellationToken);
        }
    }
}
