...
namespace Azure.ResourceManager.ChangeAnalysis.Mock
{
    ...
    public partial class ChangeAnalysisTenantResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="ChangeAnalysisTenantResourceExtension"/> class for mocking. </summary>
        protected ChangeAnalysisTenantResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ChangeAnalysisTenantResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ChangeAnalysisTenantResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<DetectedChangeData> GetResourceChangesAsync(string resourceId, DateTimeOffset startTime, DateTimeOffset endTime, string skipToken = null, CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, DetectedChangeData.DeserializeDetectedChangeData, ResourceChangesClientDiagnostics, Pipeline, "ChangeAnalysisTenantResourceExtension.GetResourceChanges", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<DetectedChangeData> GetResourceChanges(string resourceId, DateTimeOffset startTime, DateTimeOffset endTime, string skipToken = null, CancellationToken cancellationToken = default)
        {
            ...
            HttpMessage FirstPageRequest(int? pageSizeHint) => ResourceChangesRestClient.CreateListRequest(resourceId, startTime, endTime, skipToken);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => ResourceChangesRestClient.CreateListNextPageRequest(nextLink, resourceId, startTime, endTime, skipToken);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, DetectedChangeData.DeserializeDetectedChangeData, ResourceChangesClientDiagnostics, Pipeline, "ChangeAnalysisTenantResourceExtension.GetResourceChanges", "value", "nextLink", cancellationToken);
        }
    }
}
