...
namespace Azure.ResourceManager.ChangeAnalysis.Mocking
{
    ...
    public partial class ChangeAnalysisTenantMockingExtension : ArmResource
    {
        ...
        public virtual AsyncPageable<DetectedChangeData> GetResourceChangesAsync(string resourceId, DateTimeOffset startTime, DateTimeOffset endTime, string skipToken = null, CancellationToken cancellationToken = default)
        {
            ...
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, DetectedChangeData.DeserializeDetectedChangeData, ResourceChangesClientDiagnostics, Pipeline, "ChangeAnalysisTenantMockingExtension.GetResourceChanges", "value", "nextLink", cancellationToken);
        }
