...
namespace Azure.ResourceManager.ChangeAnalysis.Mocking
{
    ...
    public partial class MockableChangeAnalysisSubscriptionResource : ArmResource
    {
        private ClientDiagnostics _changesClientDiagnostics;
        private ChangesRestOperations _changesRestClient;

        /// <summary> Initializes a new instance of the <see cref="MockableChangeAnalysisSubscriptionResource"/> class for mocking. </summary>
        protected MockableChangeAnalysisSubscriptionResource()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MockableChangeAnalysisSubscriptionResource"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MockableChangeAnalysisSubscriptionResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
