...
{
    public partial class EventHubsNamespaceAuthorizationRule
    {
        ...
        /// <summary> Get access keys for this EventHubsNamespaceAuthorizationRule resource. </summary>
        /// <returns>The keys for this EventHubsNamespaceAuthorizationRule resource.</returns>
        public EventHubsAccessKeys GetKeys()
        {
            EventHubsAccessKeys keys = new();
