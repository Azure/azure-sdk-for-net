...
- Added the `IPAddressType` property (`EventHubIPAddressType.IPv4` / `EventHubIPAddressType.DualStack`) to the Event Hubs namespace, enabling IPv4-only or dual-stack (IPv4 and IPv6) namespaces.
### Breaking Changes
