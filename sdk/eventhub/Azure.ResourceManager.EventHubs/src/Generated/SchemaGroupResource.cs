...
{
    /// <summary>
    /// A Class representing a SchemaGroup along with the instance operations that can be performed on it.
    /// If you have a <see cref="ResourceIdentifier" /> you can construct a <see cref="SchemaGroupResource" />
    /// from an instance of <see cref="ArmClient" /> using the GetSchemaGroupResource method.
    /// Otherwise you can get one from its parent resource <see cref="EventHubNamespaceResource" /> using the GetSchemaGroup method.
    /// </summary>
    public partial class SchemaGroupResource : ArmResource
    {
        /// <summary> Generate the resource identifier of a <see cref="SchemaGroupResource"/> instance. </summary>
        ...
        /// <summary> Initializes a new instance of the <see cref="SchemaGroupResource"/> class for mocking. </summary>
        protected SchemaGroupResource()
        {
        }

        /// <summary> Initializes a new instance of the <see cref = "SchemaGroupResource"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="data"> The resource that is the target of operations. </param>
        internal SchemaGroupResource(ArmClient client, SchemaGroupData data) : this(client, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal SchemaGroupResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        ...
        public virtual async Task<Response<SchemaGroupResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            using var scope = _schemaGroupSchemaRegistryClientDiagnostics.CreateScope("SchemaGroupResource.Get");
            scope.Start();
            try
            {
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<SchemaGroupResource> Get(CancellationToken cancellationToken = default)
        {
            using var scope = _schemaGroupSchemaRegistryClientDiagnostics.CreateScope("SchemaGroupResource.Get");
            scope.Start();
            try
        ...
        {
            using var scope = _schemaGroupSchemaRegistryClientDiagnostics.CreateScope("SchemaGroupResource.Delete");
            scope.Start();
            try
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        public virtual ArmOperation<SchemaGroupResource> Update(WaitUntil waitUntil, SchemaGroupData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
            ...
            try
            {
                var response = _schemaGroupSchemaRegistryRestClient.CreateOrUpdate(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, data, cancellationToken);
                var operation = new EventHubsArmOperation<SchemaGroupResource>(Response.FromValue(new SchemaGroupResource(Client, response), response.GetRawResponse()));
                if (waitUntil == WaitUntil.Completed)
