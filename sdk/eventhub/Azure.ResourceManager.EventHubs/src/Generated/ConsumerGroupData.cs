...
namespace Azure.ResourceManager.EventHubs
{
    ...
    public partial class ConsumerGroupData : ResourceData
    {
        ...
        internal ConsumerGroupData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, DateTimeOffset? createdOn, DateTimeOffset? updatedOn, string userMetadata, string location) : base(id, name, resourceType, systemData)
        {
            CreatedOn = createdOn;
            UpdatedOn = updatedOn;
