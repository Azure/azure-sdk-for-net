...
namespace Azure.ResourceManager._EventHubs
{
    ...
    public partial class EventHubsNamespaceResource : IJsonModel<EventHubsNamespaceData>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<EventHubsNamespaceData>.Write(ModelReaderWriterOptions options) => ModelReaderWriter.Write<EventHubsNamespaceData>(Data, options, AzureResourceManager_EventHubsContext.Default);

        /// <param name="data"> The binary data to be processed. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        EventHubsNamespaceData IPersistableModel<EventHubsNamespaceData>.Create(BinaryData data, ModelReaderWriterOptions options) => ModelReaderWriter.Read<EventHubsNamespaceData>(data, options, AzureResourceManager_EventHubsContext.Default);
