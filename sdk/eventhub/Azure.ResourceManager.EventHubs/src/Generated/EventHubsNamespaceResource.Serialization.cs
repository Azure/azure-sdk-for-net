...
namespace Azure.ResourceManager.EventHubs
{
    public partial class EventHubsNamespaceResource : IJsonModel<EventHubsNamespaceData>
    {
        ...
        {
            return ModelReaderWriter.Read<EventHubsNamespaceData>(new BinaryData(reader.ValueSequence), options);
        }
        ...
        {
            return ModelReaderWriter.Read<EventHubsNamespaceData>(data, options);
        }
