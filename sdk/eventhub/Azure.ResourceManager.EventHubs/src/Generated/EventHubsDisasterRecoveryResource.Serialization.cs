...
namespace Azure.ResourceManager._EventHubs
{
    ...
    public partial class EventHubsDisasterRecoveryResource : IJsonModel<EventHubsDisasterRecoveryData>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<EventHubsDisasterRecoveryData>.Write(ModelReaderWriterOptions options) => ModelReaderWriter.Write<EventHubsDisasterRecoveryData>(Data, options, AzureResourceManager_EventHubsContext.Default);

        /// <param name="data"> The binary data to be processed. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        EventHubsDisasterRecoveryData IPersistableModel<EventHubsDisasterRecoveryData>.Create(BinaryData data, ModelReaderWriterOptions options) => ModelReaderWriter.Read<EventHubsDisasterRecoveryData>(data, options, AzureResourceManager_EventHubsContext.Default);
