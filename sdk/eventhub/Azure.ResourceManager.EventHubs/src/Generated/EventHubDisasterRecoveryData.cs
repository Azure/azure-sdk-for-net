...
{
    /// <summary> A class representing the EventHubDisasterRecovery data model. </summary>
    public partial class EventHubDisasterRecoveryData : ProxyResource
    {
        /// <summary> Initializes a new instance of EventHubDisasterRecoveryData. </summary>
        public EventHubDisasterRecoveryData()
        {
        }
        ...
        internal EventHubDisasterRecoveryData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string location, EventHubDisasterRecoveryProvisioningState? provisioningState, string partnerNamespace, string alternateName, EventHubDisasterRecoveryRole? role, long? pendingReplicationOperationsCount) : base(id, name, resourceType, systemData, location)
        {
        ...
        public EventHubDisasterRecoveryProvisioningState? ProvisioningState { get; }
        ...
        public EventHubDisasterRecoveryRole? Role { get; }
