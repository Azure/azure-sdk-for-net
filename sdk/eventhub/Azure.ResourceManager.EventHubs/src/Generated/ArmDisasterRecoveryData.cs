...
namespace Azure.ResourceManager.EventHub
{
    ...
    public partial class ArmDisasterRecoveryData : Resource
    {
        ...
        internal ArmDisasterRecoveryData(ResourceIdentifier id, string name, ResourceType type, ProvisioningStateDR? provisioningState, string partnerNamespace, string alternateName, RoleDisasterRecovery? role, long? pendingReplicationOperationsCount) : base(id, name, type)
        {
