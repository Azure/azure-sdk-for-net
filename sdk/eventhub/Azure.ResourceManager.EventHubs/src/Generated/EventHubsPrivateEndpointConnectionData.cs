...
namespace Azure.ResourceManager._EventHubs
{
    ...
    public partial class EventHubsPrivateEndpointConnectionData : ResourceData
    {
        ...
        internal EventHubsPrivateEndpointConnectionData(string id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, PrivateEndpointConnectionProperties properties, string location) : base(id, name, resourceType, systemData)
        {
        ...
        public EventHubsPrivateLinkServiceConnectionState PrivateLinkServiceConnectionState
        {
            get
            {
