...
namespace Azure.ResourceManager._EventHubs
{
    ...
    public partial class EventHubsDisasterRecoveryCollection : ArmCollection, IEnumerable<EventHubsDisasterRecoveryResource>, IAsyncEnumerable<EventHubsDisasterRecoveryResource>
    {
        ...
        internal EventHubsDisasterRecoveryCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _disasterRecoveryConfigsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager._EventHubs", EventHubsDisasterRecoveryResource.ResourceType.Namespace, Diagnostics);
            _disasterRecoveryConfigsRestClient = new DisasterRecoveryConfigs(_disasterRecoveryConfigsClientDiagnostics, Pipeline, Endpoint, eventHubsDisasterRecoveryApiVersion ?? "2025-05-01-preview");
        ...
        public virtual async Task<ArmOperation<EventHubsDisasterRecoveryResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string @alias, EventHubsDisasterRecoveryData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _disasterRecoveryConfigsClientDiagnostics.CreateScope("EventHubsDisasterRecoveryCollection.CreateOrUpdate");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _disasterRecoveryConfigsRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, @alias, EventHubsDisasterRecoveryData.ToRequestContent(data), context);
        ...
        public virtual async Task<Response<EventHubsDisasterRecoveryResource>> GetAsync(string @alias, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _disasterRecoveryConfigsClientDiagnostics.CreateScope("EventHubsDisasterRecoveryCollection.Get");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _disasterRecoveryConfigsRestClient.CreateGetRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, @alias, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<EventHubsDisasterRecoveryData> response = Response.FromValue(EventHubsDisasterRecoveryData.FromResponse(result), result);
        ...
        public virtual AsyncPageable<EventHubsDisasterRecoveryResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<EventHubsDisasterRecoveryData, EventHubsDisasterRecoveryResource>(new DisasterRecoveryConfigsGetAllAsyncCollectionResultOfT(_disasterRecoveryConfigsRestClient, Id.SubscriptionId, Id.ResourceGroupName, Id.Name, context), data => new EventHubsDisasterRecoveryResource(Client, data));
        }
        ...
        public virtual Pageable<EventHubsDisasterRecoveryResource> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            return new PageableWrapper<EventHubsDisasterRecoveryData, EventHubsDisasterRecoveryResource>(new DisasterRecoveryConfigsGetAllCollectionResultOfT(_disasterRecoveryConfigsRestClient, Id.SubscriptionId, Id.ResourceGroupName, Id.Name, context), data => new EventHubsDisasterRecoveryResource(Client, data));
        }
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string @alias, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _disasterRecoveryConfigsClientDiagnostics.CreateScope("EventHubsDisasterRecoveryCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual async Task<NullableResponse<EventHubsDisasterRecoveryResource>> GetIfExistsAsync(string @alias, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _disasterRecoveryConfigsClientDiagnostics.CreateScope("EventHubsDisasterRecoveryCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
