...
{
    /// <summary> A class representing the EventHubConsumerGroup data model. </summary>
    public partial class EventHubConsumerGroupData : ProxyResource
    {
        /// <summary> Initializes a new instance of EventHubConsumerGroupData. </summary>
        public EventHubConsumerGroupData()
        {
        }
        ...
        internal EventHubConsumerGroupData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string location, DateTimeOffset? createdOn, DateTimeOffset? updatedOn, string userMetadata) : base(id, name, resourceType, systemData, location)
        {
            CreatedOn = createdOn;
            UpdatedOn = updatedOn;
