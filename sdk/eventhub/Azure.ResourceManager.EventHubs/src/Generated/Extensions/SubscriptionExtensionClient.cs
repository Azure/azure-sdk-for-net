...
namespace Azure.ResourceManager.EventHubs
{
    ...
    internal partial class SubscriptionExtensionClient : ArmResource
    {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async virtual Task<Response<CheckNameAvailabilityResult>> CheckEventHubNameAvailabilityAsync(CheckNameAvailabilityOptions parameters, CancellationToken cancellationToken = default)
        {
