...
namespace Azure.ResourceManager.EventHubs.Mocking
{
    ...
    internal partial class EventHubsResourceGroupMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="EventHubsResourceGroupMockingExtension"/> class for mocking. </summary>
        protected EventHubsResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="EventHubsResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal EventHubsResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
