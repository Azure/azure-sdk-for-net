...
namespace Azure.ResourceManager.EventHubs.Testing
{
    ...
    public partial class EventHubsSubscriptionResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="EventHubsSubscriptionResourceExtension"/> class for mocking. </summary>
        protected EventHubsSubscriptionResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="EventHubsSubscriptionResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal EventHubsSubscriptionResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<AvailableCluster> GetAvailableClusterRegionClustersAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, null, AvailableCluster.DeserializeAvailableCluster, EventHubsClusterClustersClientDiagnostics, Pipeline, "EventHubsSubscriptionResourceExtension.GetAvailableClusterRegionClusters", "value", null, cancellationToken);
        }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => EventHubsClusterClustersRestClient.CreateListAvailableClusterRegionRequest(Id.SubscriptionId);
            return PageableHelpers.CreatePageable(FirstPageRequest, null, AvailableCluster.DeserializeAvailableCluster, EventHubsClusterClustersClientDiagnostics, Pipeline, "EventHubsSubscriptionResourceExtension.GetAvailableClusterRegionClusters", "value", null, cancellationToken);
        }
        ...
        public virtual async Task<Response<EventHubsNameAvailabilityResult>> CheckEventHubsNamespaceNameAvailabilityAsync(EventHubsNameAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = EventHubsNamespaceNamespacesClientDiagnostics.CreateScope("EventHubsSubscriptionResourceExtension.CheckEventHubsNamespaceNameAvailability");
            scope.Start();
            try
            {
