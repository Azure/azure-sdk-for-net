...
namespace Azure.ResourceManager.EventHubs.Mocking
{
    ...
    internal partial class EventHubsArmClientMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="EventHubsArmClientMockingExtension"/> class for mocking. </summary>
        protected EventHubsArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="EventHubsArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal EventHubsArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal EventHubsArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
