...
namespace Azure.ResourceManager.EventHubs.Mock
{
    ...
    public partial class EventHubsNamespaceResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="EventHubsNamespaceResourceExtension"/> class for mocking. </summary>
        protected EventHubsNamespaceResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="EventHubsNamespaceResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal EventHubsNamespaceResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual async Task<Response<EventHubsNameAvailabilityResult>> CheckEventHubsNamespaceNameAvailabilityAsync(EventHubsNameAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = EventHubsNamespaceNamespacesClientDiagnostics.CreateScope("EventHubsNamespaceResourceExtension.CheckEventHubsNamespaceNameAvailability");
            scope.Start();
            try
            {
