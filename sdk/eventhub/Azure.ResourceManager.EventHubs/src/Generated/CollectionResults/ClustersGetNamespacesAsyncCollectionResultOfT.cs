...
namespace Azure.ResourceManager.EventHubs
{
    internal partial class ClustersGetNamespacesAsyncCollectionResultOfT : AsyncPageable<SubResource>
    {
        ...
        public ClustersGetNamespacesAsyncCollectionResultOfT(Clusters client, string subscriptionId, string resourceGroupName, string clusterName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
