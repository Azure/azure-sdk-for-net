...
namespace Azure.ResourceManager.EventHubs
{
    internal partial class ClustersGetNamespacesAsyncCollectionResultOfT : AsyncPageable<SubResource>
    {
        ...
        /// <summary> Initializes a new instance of ClustersGetNamespacesAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public ClustersGetNamespacesAsyncCollectionResultOfT(Clusters client, string subscriptionId, string resourceGroupName, string clusterName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of ClustersGetNamespacesAsyncCollectionResultOfT as an enumerable collection. </summary>
        ...
        {
            HttpMessage message = _client.CreateGetNamespacesRequest(_subscriptionId, _resourceGroupName, _clusterName, _context);
            using DiagnosticScope scope = _client.ClientDiagnostics.CreateScope("EventHubsClusterResource.GetNamespaces");
            scope.Start();
            try
            {
