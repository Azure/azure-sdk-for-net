...
namespace Azure.ResourceManager.EventHubs
{
    internal partial class EventHubsNamespaceAuthorizationRuleGetAuthorizationRulesAsyncCollectionResultOfT : AsyncPageable<EventHubsAuthorizationRuleData>
    {
        ...
        public EventHubsNamespaceAuthorizationRuleGetAuthorizationRulesAsyncCollectionResultOfT(EventHubsNamespaceAuthorizationRule client, string subscriptionId, string resourceGroupName, string namespaceName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
