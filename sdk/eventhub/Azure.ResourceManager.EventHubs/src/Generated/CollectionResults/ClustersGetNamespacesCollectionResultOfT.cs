...
namespace Azure.ResourceManager.EventHubs
{
    internal partial class ClustersGetNamespacesCollectionResultOfT : Pageable<SubResource>
    {
        ...
        public ClustersGetNamespacesCollectionResultOfT(Clusters client, string subscriptionId, string resourceGroupName, string clusterName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
