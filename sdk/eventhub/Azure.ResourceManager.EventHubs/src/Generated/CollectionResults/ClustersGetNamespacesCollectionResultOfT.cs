...
namespace Azure.ResourceManager.EventHubs
{
    internal partial class ClustersGetNamespacesCollectionResultOfT : Pageable<SubResource>
    {
        ...
        /// <summary> Initializes a new instance of ClustersGetNamespacesCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public ClustersGetNamespacesCollectionResultOfT(Clusters client, string subscriptionId, string resourceGroupName, string clusterName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of ClustersGetNamespacesCollectionResultOfT as an enumerable collection. </summary>
