...
namespace Azure.ResourceManager.EventHubs
{
    internal partial class PrivateLinkResourcesGetPrivateLinkResourcesAsyncCollectionResultOfT : AsyncPageable<EventHubsPrivateLinkResourceData>
    {
        ...
        public PrivateLinkResourcesGetPrivateLinkResourcesAsyncCollectionResultOfT(PrivateLinkResources client, string subscriptionId, string resourceGroupName, string namespaceName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        private async ValueTask<Response> GetNextResponseAsync(int? pageSizeHint, string continuationToken)
        {
            ...
            using DiagnosticScope scope = _client.ClientDiagnostics.CreateScope("EventHubsNamespaceResource.GetPrivateLinkResources");
            scope.Start();
            try
            {
