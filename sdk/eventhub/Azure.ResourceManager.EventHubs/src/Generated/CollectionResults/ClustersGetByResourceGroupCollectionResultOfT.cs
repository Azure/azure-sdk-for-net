...
{
    internal partial class ClustersGetByResourceGroupCollectionResultOfT : Pageable<EventHubsClusterData>
    {
        ...
        public override IEnumerable<Page<EventHubsClusterData>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                yield return Page<EventHubsClusterData>.FromValues((IReadOnlyList<EventHubsClusterData>)result.Value, nextPage?.IsAbsoluteUri == true ? nextPage.AbsoluteUri : nextPage?.OriginalString, response);
        ...
        private Response GetNextResponse(int? pageSizeHint, Uri nextLink)
        {
            ...
            using DiagnosticScope scope = _client.ClientDiagnostics.CreateScope("EventHubsClusterCollection.GetAll");
            scope.Start();
            try
            {
