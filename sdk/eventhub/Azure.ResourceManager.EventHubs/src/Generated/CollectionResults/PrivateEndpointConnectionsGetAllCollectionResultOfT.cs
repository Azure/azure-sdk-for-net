    ...
    internal partial class PrivateEndpointConnectionsGetAllCollectionResultOfT : Pageable<EventHubsPrivateEndpointConnectionData>
    {
        ...
        public override IEnumerable<Page<EventHubsPrivateEndpointConnectionData>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                yield return Page<EventHubsPrivateEndpointConnectionData>.FromValues((IReadOnlyList<EventHubsPrivateEndpointConnectionData>)result.Value, nextPage?.AbsoluteUri, response);
