...
namespace Azure.ResourceManager.EventHubs
{
    ...
    /// To get a <see cref="EventHubsPrivateEndpointConnectionCollection"/> instance call the GetEventHubsPrivateEndpointConnections method from an instance of <see cref="EventHubsNamespaceResource"/>.
    /// </summary>
    public partial class EventHubsPrivateEndpointConnectionCollection : ArmCollection, IEnumerable<EventHubsPrivateEndpointConnectionResource>, IAsyncEnumerable<EventHubsPrivateEndpointConnectionResource>
    {
        ...
        /// <summary> Initializes a new instance of EventHubsPrivateEndpointConnectionCollection for mocking. </summary>
        protected EventHubsPrivateEndpointConnectionCollection()
        {
        }

        /// <summary> Initializes a new instance of <see cref="EventHubsPrivateEndpointConnectionCollection"/> class. </summary>
        ...
        {
            TryGetApiVersion(EventHubsPrivateEndpointConnectionResource.ResourceType, out string eventHubsPrivateEndpointConnectionApiVersion);
            _privateEndpointConnectionsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.EventHubs", EventHubsPrivateEndpointConnectionResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<EventHubsPrivateEndpointConnectionResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string privateEndpointConnectionName, EventHubsPrivateEndpointConnectionData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _privateEndpointConnectionsClientDiagnostics.CreateScope("EventHubsPrivateEndpointConnectionCollection.CreateOrUpdate");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _privateEndpointConnectionsRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, privateEndpointConnectionName, EventHubsPrivateEndpointConnectionData.ToRequestContent(data), context);
        ...
        public virtual async Task<Response<EventHubsPrivateEndpointConnectionResource>> GetAsync(string privateEndpointConnectionName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _privateEndpointConnectionsClientDiagnostics.CreateScope("EventHubsPrivateEndpointConnectionCollection.Get");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string privateEndpointConnectionName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _privateEndpointConnectionsClientDiagnostics.CreateScope("EventHubsPrivateEndpointConnectionCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                Response<EventHubsPrivateEndpointConnectionData> response = default;
                switch (result.Status)
                {
                    case 200:
                        response = Response.FromValue(EventHubsPrivateEndpointConnectionData.FromResponse(result), result);
                        break;
                    case 404:
                        response = Response.FromValue((EventHubsPrivateEndpointConnectionData)null, result);
                        break;
                    default:
        ...
        public virtual async Task<NullableResponse<EventHubsPrivateEndpointConnectionResource>> GetIfExistsAsync(string privateEndpointConnectionName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _privateEndpointConnectionsClientDiagnostics.CreateScope("EventHubsPrivateEndpointConnectionCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
