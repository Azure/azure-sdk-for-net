...
{
    /// <summary></summary>
    public partial class PrivateEndpointConnectionResource : IJsonModel<EventHubsPrivateEndpointConnectionData>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<EventHubsPrivateEndpointConnectionData>.Write(ModelReaderWriterOptions options) => ModelReaderWriter.Write<EventHubsPrivateEndpointConnectionData>(Data, options, AzureResourceManager_EventHubsContext.Default);

        /// <param name="data"> The binary data to be processed. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        EventHubsPrivateEndpointConnectionData IPersistableModel<EventHubsPrivateEndpointConnectionData>.Create(BinaryData data, ModelReaderWriterOptions options) => ModelReaderWriter.Read<EventHubsPrivateEndpointConnectionData>(data, options, AzureResourceManager_EventHubsContext.Default);
