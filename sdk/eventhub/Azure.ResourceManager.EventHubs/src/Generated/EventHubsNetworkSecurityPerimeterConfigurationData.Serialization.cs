...
namespace Azure.ResourceManager.EventHubs
{
    ...
    public partial class EventHubsNetworkSecurityPerimeterConfigurationData : ResourceData, IJsonModel<EventHubsNetworkSecurityPerimeterConfigurationData>
    {
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual ResourceData PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<EventHubsNetworkSecurityPerimeterConfigurationData>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<EventHubsNetworkSecurityPerimeterConfigurationData>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        EventHubsNetworkSecurityPerimeterConfigurationData IPersistableModel<EventHubsNetworkSecurityPerimeterConfigurationData>.Create(BinaryData data, ModelReaderWriterOptions options) => (EventHubsNetworkSecurityPerimeterConfigurationData)PersistableModelCreateCore(data, options);
        ...
        /// <param name="response"> The <see cref="Response"/> to deserialize the <see cref="EventHubsNetworkSecurityPerimeterConfigurationData"/> from. </param>
        internal static EventHubsNetworkSecurityPerimeterConfigurationData FromResponse(Response response)
        {
            using JsonDocument document = JsonDocument.Parse(response.Content, ModelSerializationExtensions.JsonDocumentOptions);
            return DeserializeEventHubsNetworkSecurityPerimeterConfigurationData(document.RootElement, ModelSerializationExtensions.WireOptions);
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        EventHubsNetworkSecurityPerimeterConfigurationData IJsonModel<EventHubsNetworkSecurityPerimeterConfigurationData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (EventHubsNetworkSecurityPerimeterConfigurationData)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static EventHubsNetworkSecurityPerimeterConfigurationData DeserializeEventHubsNetworkSecurityPerimeterConfigurationData(JsonElement element, ModelReaderWriterOptions options)
        {
