...
namespace Azure.ResourceManager.EventHubs
{
    ...
    public partial class DisasterRecoveryData : ProxyResource
    {
        ...
        internal DisasterRecoveryData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string location, ProvisioningStateDR? provisioningState, string partnerNamespace, string alternateName, RoleDisasterRecovery? role, long? pendingReplicationOperationsCount) : base(id, name, resourceType, systemData, location)
        {
