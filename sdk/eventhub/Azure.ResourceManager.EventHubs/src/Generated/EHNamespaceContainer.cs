...
namespace Azure.ResourceManager.EventHub
{
    ...
    public partial class EHNamespaceContainer : ArmContainer
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="EHNamespaceContainer"/> class for mocking. </summary>
        protected EHNamespaceContainer()
        {
        }

        /// <summary> Initializes a new instance of EHNamespaceContainer class. </summary>
        /// <param name="parent"> The resource representing the parent resource. </param>
        internal EHNamespaceContainer(ArmResource parent) : base(parent)
        {
        ...
        public virtual NamespaceCreateOrUpdateOperation CreateOrUpdate(string namespaceName, EHNamespaceData parameters, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("EHNamespaceContainer.CreateOrUpdate");
            scope.Start();
            try
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="namespaceName"/> or <paramref name="parameters"/> is null. </exception>
        public async virtual Task<NamespaceCreateOrUpdateOperation> CreateOrUpdateAsync(string namespaceName, EHNamespaceData parameters, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            if (namespaceName == null)
            {
                throw new ArgumentNullException(nameof(namespaceName));
        ...
        public virtual Response<EHNamespace> Get(string namespaceName, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("EHNamespaceContainer.Get");
            scope.Start();
            try
            {
                if (namespaceName == null)
                ...
                return Response.FromValue(new EHNamespace(Parent, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="namespaceName"> The Namespace name. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="CancellationToken.None" />. </param>
        public async virtual Task<Response<EHNamespace>> GetAsync(string namespaceName, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("EHNamespaceContainer.Get");
            scope.Start();
            try
        ...
        /// <param name="namespaceName"> The Namespace name. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="CancellationToken.None" />. </param>
        public virtual Response<EHNamespace> GetIfExists(string namespaceName, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("EHNamespaceContainer.GetIfExists");
            scope.Start();
            try
            {
                if (namespaceName == null)
                ...
                return response.Value == null
                    ? Response.FromValue<EHNamespace>(null, response.GetRawResponse())
                    : Response.FromValue(new EHNamespace(this, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="namespaceName"> The Namespace name. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="CancellationToken.None" />. </param>
        public async virtual Task<Response<EHNamespace>> GetIfExistsAsync(string namespaceName, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("EHNamespaceContainer.GetIfExists");
            scope.Start();
            try
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("EHNamespaceContainer.CheckIfExists");
            scope.Start();
            try
            {
                if (namespaceName == null)
        ...
        public virtual Pageable<EHNamespace> GetAll(CancellationToken cancellationToken = default)
        {
            Page<EHNamespace> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _clientDiagnostics.CreateScope("EHNamespaceContainer.GetAll");
                scope.Start();
                try
                {
                    var response = _restClient.GetAllByResourceGroup(Id.ResourceGroupName, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new EHNamespace(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
                    scope.Failed(e);
        ...
        public virtual AsyncPageable<EHNamespace> GetAllAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <summary> Filters the list of <see cref="EHNamespace" /> for this resource group represented as generic resources. </summary>
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("EHNamespaceContainer.GetAllAsGenericResources");
            scope.Start();
            try
            {
                var filters = new ResourceFilterCollection(EHNamespace.ResourceType);
        ...
        // Builders.
        // public ArmBuilder<ResourceIdentifier, EHNamespace, EHNamespaceData> Construct() { }
    }
}
