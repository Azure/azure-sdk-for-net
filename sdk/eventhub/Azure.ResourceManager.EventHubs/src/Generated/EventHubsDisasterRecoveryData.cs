...
namespace Azure.ResourceManager._EventHubs
{
    ...
    public partial class EventHubsDisasterRecoveryData : ResourceData
    {
        ...
        internal EventHubsDisasterRecoveryData(string id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, ArmDisasterRecoveryProperties properties, string location) : base(id, name, resourceType, systemData)
        {
