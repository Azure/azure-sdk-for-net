...
namespace Azure.ResourceManager.EventHubs
{
    ...
    public partial class EventHubsDisasterRecoveryData : ProxyResource
    {
        ...
        internal EventHubsDisasterRecoveryData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string location, EventHubsDisasterRecoveryProvisioningState? provisioningState, string partnerNamespace, string alternateName, EventHubsDisasterRecoveryRole? role, long? pendingReplicationOperationsCount) : base(id, name, resourceType, systemData, location)
        {
