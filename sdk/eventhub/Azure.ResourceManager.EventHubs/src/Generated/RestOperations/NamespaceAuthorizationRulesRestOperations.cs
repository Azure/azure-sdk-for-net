...
namespace Azure.ResourceManager.EventHubs
{
    internal partial class NamespaceAuthorizationRulesRestOperations
    {
        ...
        public NamespaceAuthorizationRulesRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ClientOptions options, string subscriptionId, Uri endpoint = null, string apiVersion = "2017-04-01")
        {
