...
namespace Azure.ResourceManager.EventHubs
{
    internal partial class ConsumerGroupsRestOperations
    {
        ...
        public ConsumerGroupsRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ClientOptions options, string subscriptionId, Uri endpoint = null, string apiVersion = "2021-11-01")
        {
