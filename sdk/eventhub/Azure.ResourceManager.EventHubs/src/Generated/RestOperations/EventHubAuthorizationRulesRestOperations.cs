...
namespace Azure.ResourceManager.EventHub
{
    internal partial class EventHubAuthorizationRulesRestOperations
    {
        ...
        public EventHubAuthorizationRulesRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ClientOptions options, string subscriptionId, Uri endpoint = null, string apiVersion = "2018-01-01-preview")
        {
