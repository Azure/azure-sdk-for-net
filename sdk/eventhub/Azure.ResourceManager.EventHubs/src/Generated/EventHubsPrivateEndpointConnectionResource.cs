...
namespace Azure.ResourceManager.EventHubs
{
    ...
    public partial class EventHubsPrivateEndpointConnectionResource : ArmResource
    {
        ...
        internal EventHubsPrivateEndpointConnectionResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _privateEndpointConnectionsRestClient = new PrivateEndpointConnections(_privateEndpointConnectionsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, eventHubsPrivateEndpointConnectionApiVersion ?? "2026-07-01-preview");
