...
namespace Azure.ResourceManager.EventHubs
{
    ...
    public partial class EventHubData : ResourceData
    {
        ...
        internal EventHubData(string id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, EventhubProperties properties, AzureLocation? location) : base(id == null ? null : new ResourceIdentifier(id), name, resourceType, systemData)
        {
