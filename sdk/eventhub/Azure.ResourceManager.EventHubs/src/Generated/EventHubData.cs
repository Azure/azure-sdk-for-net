...
namespace Azure.ResourceManager._EventHubs
{
    ...
    public partial class EventHubData : ResourceData
    {
        ...
        internal EventHubData(string id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, EventhubProperties properties, string location) : base(id, name, resourceType, systemData)
        {
