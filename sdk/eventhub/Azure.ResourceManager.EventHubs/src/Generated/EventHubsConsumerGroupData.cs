...
namespace Azure.ResourceManager.EventHubs
{
    ...
    public partial class EventHubsConsumerGroupData : ProxyResource
    {
        ...
        internal EventHubsConsumerGroupData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string location, DateTimeOffset? createdOn, DateTimeOffset? updatedOn, string userMetadata) : base(id, name, resourceType, systemData, location)
        {
            CreatedOn = createdOn;
            UpdatedOn = updatedOn;
