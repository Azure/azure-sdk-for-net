...
namespace Azure.ResourceManager._EventHubs
{
    ...
    public partial class EventHubsConsumerGroupData : ResourceData
    {
        ...
        internal EventHubsConsumerGroupData(string id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, ConsumerGroupProperties properties, string location) : base(id, name, resourceType, systemData)
        {
