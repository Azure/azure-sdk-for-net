...
namespace Azure.ResourceManager._EventHubs
{
    ...
    /// Otherwise you can get one from its parent resource <see cref="EventHubsNamespaceResource"/> using the GetPrivateEndpointConnections method.
    /// </summary>
    public partial class PrivateEndpointConnectionResource : ArmResource
    {
        ...
        internal PrivateEndpointConnectionResource(ArmClient client, EventHubsPrivateEndpointConnectionData data) : this(client, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal PrivateEndpointConnectionResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _privateEndpointConnectionsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager._EventHubs", ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<PrivateEndpointConnectionResource>> UpdateAsync(WaitUntil waitUntil, EventHubsPrivateEndpointConnectionData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                EventHubsArmOperation<PrivateEndpointConnectionResource> operation = new EventHubsArmOperation<PrivateEndpointConnectionResource>(Response.FromValue(new PrivateEndpointConnectionResource(Client, response.Value), response.GetRawResponse()), rehydrationToken);
                if (waitUntil == WaitUntil.Completed)
                {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        public virtual ArmOperation<PrivateEndpointConnectionResource> Update(WaitUntil waitUntil, EventHubsPrivateEndpointConnectionData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
