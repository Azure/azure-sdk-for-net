...
namespace Azure.ResourceManager.EventHubs
{
    ...
    /// Otherwise you can get one from its parent resource <see cref="EventHubNamespaceResource" /> using the GetPrivateEndpointConnection method.
    /// </summary>
    public partial class PrivateEndpointConnectionResource : ArmResource
    {
        ...
        {
            _privateEndpointConnectionClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.EventHubs", ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new EventHubsArmOperation(_privateEndpointConnectionClientDiagnostics, Pipeline, _privateEndpointConnectionRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name).Request, response, OperationFinalStateVia.Location);
