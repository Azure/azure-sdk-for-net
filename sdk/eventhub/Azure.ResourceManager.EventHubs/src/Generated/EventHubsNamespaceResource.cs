...
namespace Azure.ResourceManager._EventHubs
{
    ...
    public partial class EventHubsNamespaceResource : ArmResource
    {
        ...
        internal EventHubsNamespaceResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _disasterRecoveryConfigsRestClient = new DisasterRecoveryConfigs(_disasterRecoveryConfigsClientDiagnostics, Pipeline, Endpoint, eventHubsNamespaceApiVersion ?? "2025-05-01-preview");
            _privateLinkResourcesClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager._EventHubs", ResourceType.Namespace, Diagnostics);
            ...
            _networkSecurityPerimeterConfigurationsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager._EventHubs", ResourceType.Namespace, Diagnostics);
            _networkSecurityPerimeterConfigurationsRestClient = new NetworkSecurityPerimeterConfigurations(_networkSecurityPerimeterConfigurationsClientDiagnostics, Pipeline, Endpoint, eventHubsNamespaceApiVersion ?? "2025-05-01-preview");
        ...
        /// </list>
        /// </summary>
        /// <param name="eventHubsNameAvailabilityContent"> Parameters to check availability of the given Alias name. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        ...
        public virtual async Task<Response<EventHubsNameAvailabilityResult>> CheckNameAvailabilityAsync(EventHubsNameAvailabilityContent eventHubsNameAvailabilityContent, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _disasterRecoveryConfigsClientDiagnostics.CreateScope("EventHubsNamespaceResource.CheckNameAvailability");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _disasterRecoveryConfigsRestClient.CreateCheckNameAvailabilityRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, EventHubsNameAvailabilityContent.ToRequestContent(eventHubsNameAvailabilityContent), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<PrivateLinkResourcesListResult>> GetAsync(CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _privateLinkResourcesClientDiagnostics.CreateScope("EventHubsNamespaceResource.Get");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _privateLinkResourcesRestClient.CreateGetRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<PrivateLinkResourcesListResult> Get(CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _privateLinkResourcesClientDiagnostics.CreateScope("EventHubsNamespaceResource.Get");
            scope.Start();
            try
        ...
        public virtual async Task<ArmOperation<EventHubsNetworkSecurityPerimeterConfigurationResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string resourceAssociationName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(resourceAssociationName, nameof(resourceAssociationName));

            using DiagnosticScope scope = _networkSecurityPerimeterConfigurationsClientDiagnostics.CreateScope("EventHubsNamespaceResource.CreateOrUpdate");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _networkSecurityPerimeterConfigurationsRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, resourceAssociationName, context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="resourceAssociationName"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="resourceAssociationName"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual ArmOperation<EventHubsNetworkSecurityPerimeterConfigurationResource> CreateOrUpdate(WaitUntil waitUntil, string resourceAssociationName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(resourceAssociationName, nameof(resourceAssociationName));
        ...
        public virtual async Task<Response<EventHubsNamespaceResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                {
                    EventHubsNamespaceData current = (await this.GetAsync(cancellationToken: cancellationToken).ConfigureAwait(false)).Value.Data;
        ...
        public virtual Response<EventHubsNamespaceResource> AddTag(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                {
                    EventHubsNamespaceData current = this.Get(cancellationToken: cancellationToken).Value.Data;
                    EventHubsNamespaceData patch = new EventHubsNamespaceData();
                    foreach (KeyValuePair<string, string> tag in current.Tags)
                    {
                        patch.Tags.Add(tag);
        ...
        /// <summary> Gets a collection of DisasterRecoveryConfigs in the <see cref="EventHubsNamespaceResource"/>. </summary>
        ...
        [ForwardsClientCalls]
        public virtual async Task<Response<DisasterRecoveryConfigResource>> GetDisasterRecoveryConfigAsync(string @alias, string authorizationRuleName, CancellationToken cancellationToken = default)
        {
            ...
            return await GetDisasterRecoveryConfigs().GetAsync(@alias, authorizationRuleName, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <exception cref="ArgumentException"> <paramref name="alias"/> or <paramref name="authorizationRuleName"/> is an empty string, and was expected to be non-empty. </exception>
        [ForwardsClientCalls]
        public virtual Response<DisasterRecoveryConfigResource> GetDisasterRecoveryConfig(string @alias, string authorizationRuleName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(@alias, nameof(@alias));
            Argument.AssertNotNullOrEmpty(authorizationRuleName, nameof(authorizationRuleName));

            return GetDisasterRecoveryConfigs().Get(@alias, authorizationRuleName, cancellationToken);
        }
        ...
        /// <summary> Gets a collection of AuthorizationRules in the <see cref="EventHubsNamespaceResource"/>. </summary>
        /// <returns> An object representing collection of AuthorizationRules and their operations over a AuthorizationRuleResource. </returns>
        public virtual AuthorizationRuleCollection GetAuthorizationRules()
        {
            return GetCachedClient(client => new AuthorizationRuleCollection(client, Id));
        }
        ...
        [ForwardsClientCalls]
        public virtual async Task<Response<AuthorizationRuleResource>> GetAuthorizationRuleAsync(string authorizationRuleName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(authorizationRuleName, nameof(authorizationRuleName));

            return await GetAuthorizationRules().GetAsync(authorizationRuleName, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <exception cref="ArgumentException"> <paramref name="authorizationRuleName"/> is an empty string, and was expected to be non-empty. </exception>
        [ForwardsClientCalls]
        public virtual Response<AuthorizationRuleResource> GetAuthorizationRule(string authorizationRuleName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(authorizationRuleName, nameof(authorizationRuleName));

            return GetAuthorizationRules().Get(authorizationRuleName, cancellationToken);
        }
        ...
        {
            return this.GetCachedClient(client => new EventHubCollection(client, Id));
        }
        ...
        [ForwardsClientCalls]
        public virtual async Task<Response<EventHubResource>> GetEventHubAsync(string eventHubName, string authorizationRuleName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(eventHubName, nameof(eventHubName));
            Argument.AssertNotNullOrEmpty(authorizationRuleName, nameof(authorizationRuleName));

            return await this.GetEventHubs().GetAsync(eventHubName, authorizationRuleName, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <exception cref="ArgumentException"> <paramref name="eventHubName"/> or <paramref name="authorizationRuleName"/> is an empty string, and was expected to be non-empty. </exception>
        [ForwardsClientCalls]
        public virtual Response<EventHubResource> GetEventHub(string eventHubName, string authorizationRuleName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(eventHubName, nameof(eventHubName));
            Argument.AssertNotNullOrEmpty(authorizationRuleName, nameof(authorizationRuleName));

            return this.GetEventHubs().Get(eventHubName, authorizationRuleName, cancellationToken);
        }
        ...
        public virtual async Task<Response<EventHubResource>> GetEventHubAsync(string eventHubName, CancellationToken cancellationToken = default)
        {
            ...
            return await this.GetEventHubs().GetAsync(eventHubName, cancellationToken).ConfigureAwait(false);
        }
        ...
        public virtual Response<EventHubResource> GetEventHub(string eventHubName, CancellationToken cancellationToken = default)
        {
            ...
            return this.GetEventHubs().Get(eventHubName, cancellationToken);
        }

        /// <summary> Gets a collection of PrivateEndpointConnections in the <see cref="EventHubsNamespaceResource"/>. </summary>
