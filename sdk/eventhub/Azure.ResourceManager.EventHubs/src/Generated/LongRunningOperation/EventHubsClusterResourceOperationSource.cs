...
{
    /// <summary></summary>
    internal partial class EventHubsClusterResourceOperationSource : IOperationSource<EventHubsClusterResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal EventHubsClusterResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
        ...
        EventHubsClusterResource IOperationSource<EventHubsClusterResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            EventHubsClusterData data = EventHubsClusterData.DeserializeEventHubsClusterData(document.RootElement, ModelSerializationExtensions.WireOptions);
