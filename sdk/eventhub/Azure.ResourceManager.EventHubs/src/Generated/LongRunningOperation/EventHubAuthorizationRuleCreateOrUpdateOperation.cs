...
namespace Azure.ResourceManager.EventHubs.Models
{
    ...
    public partial class EventHubAuthorizationRuleCreateOrUpdateOperation : Operation<EventHubAuthorizationRule>
    {
        ...
        internal EventHubAuthorizationRuleCreateOrUpdateOperation(ArmClient armClient, Response<AuthorizationRuleData> response)
        {
            _operation = new OperationOrResponseInternals<EventHubAuthorizationRule>(Response.FromValue(new EventHubAuthorizationRule(armClient, response.Value), response.GetRawResponse()));
        }
