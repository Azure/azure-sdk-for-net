...
{
    /// <summary></summary>
    internal partial class EventHubsNamespaceResourceOperationSource : IOperationSource<EventHubsNamespaceResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal EventHubsNamespaceResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
