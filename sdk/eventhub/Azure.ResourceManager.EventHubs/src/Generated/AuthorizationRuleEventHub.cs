...
{
    /// <summary> A Class representing a AuthorizationRuleEventHub along with the instance operations that can be performed on it. </summary>
    public partial class AuthorizationRuleEventHub : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="AuthorizationRuleEventHub"/> class for mocking. </summary>
        protected AuthorizationRuleEventHub()
        {
        }

        /// <summary> Initializes a new instance of the <see cref = "AuthorizationRuleEventHub"/> class. </summary>
        /// <param name="options"> The client parameters to use in these operations. </param>
        /// <param name="resource"> The resource that is the target of operations. </param>
        internal AuthorizationRuleEventHub(ArmResource options, AuthorizationRuleData resource) : base(options, resource.Id)
        {
            HasData = true;
            _data = resource;
        ...
        internal AuthorizationRuleEventHub(ArmResource options, ResourceIdentifier id) : base(options, id)
        {
            _clientDiagnostics = new ClientDiagnostics(ClientOptions);
            _restClient = new EventHubAuthorizationRulesRestOperations(_clientDiagnostics, Pipeline, ClientOptions, Id.SubscriptionId, BaseUri);
        }
        ...
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal AuthorizationRuleEventHub(ArmClientOptions clientOptions, TokenCredential credential, Uri uri, HttpPipeline pipeline, ResourceIdentifier id) : base(clientOptions, credential, uri, pipeline, id)
        {
            _clientDiagnostics = new ClientDiagnostics(ClientOptions);
            _restClient = new EventHubAuthorizationRulesRestOperations(_clientDiagnostics, Pipeline, ClientOptions, Id.SubscriptionId, BaseUri);
        }
        ...
        public async virtual Task<Response<AuthorizationRuleEventHub>> GetAsync(CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("AuthorizationRuleEventHub.Get");
            scope.Start();
            try
            {
                ...
                return Response.FromValue(new AuthorizationRuleEventHub(this, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <summary> Gets an AuthorizationRule for an Event Hub by rule name. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<AuthorizationRuleEventHub> Get(CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("AuthorizationRuleEventHub.Get");
            scope.Start();
            try
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("AuthorizationRuleEventHub.Delete");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("AuthorizationRuleEventHub.GetKeys");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response<AccessKeys>> RegenerateKeysAsync(RegenerateAccessKeyParameters parameters, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("AuthorizationRuleEventHub.RegenerateKeys");
            scope.Start();
            try
            {
