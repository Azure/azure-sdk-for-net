...
namespace Azure.ResourceManager._EventHubs
{
    ...
    {
        private readonly ClientDiagnostics _eventHubsClientDiagnostics;
        private readonly EventHubs _eventHubsRestClient;
        ...
        {
            this.TryGetApiVersion(EventHubResource.ResourceType, out string eventHubApiVersion);
            _eventHubsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager._EventHubs", EventHubResource.ResourceType.Namespace, Diagnostics);
            _eventHubsRestClient = new EventHubs(_eventHubsClientDiagnostics, Pipeline, Endpoint, eventHubApiVersion ?? "2025-05-01-preview");
            EventHubCollection.ValidateResourceId(id);
        }
        ...
        public virtual async Task<ArmOperation<EventHubResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string eventHubName, EventHubData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _eventHubsClientDiagnostics.CreateScope("EventHubCollection.CreateOrUpdate");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _eventHubsRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, eventHubName, EventHubData.ToRequestContent(data), context);
        ...
        public virtual async Task<Response<EventHubResource>> GetAsync(string eventHubName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _eventHubsClientDiagnostics.CreateScope("EventHubCollection.Get");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _eventHubsRestClient.CreateGetRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, eventHubName, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<EventHubData> response = Response.FromValue(EventHubData.FromResponse(result), result);
        ...
        public virtual AsyncPageable<EventHubResource> GetAllAsync(int? skip = default, int? top = default, CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<EventHubData, EventHubResource>(new EventHubsGetByNamespaceAsyncCollectionResultOfT(
                _eventHubsRestClient,
                Id.SubscriptionId,
        ...
        public virtual Pageable<EventHubResource> GetAll(int? skip = default, int? top = default, CancellationToken cancellationToken = default)
        {
            ...
            return new PageableWrapper<EventHubData, EventHubResource>(new EventHubsGetByNamespaceCollectionResultOfT(
                _eventHubsRestClient,
                Id.SubscriptionId,
                Id.ResourceGroupName,
                Id.Name,
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string eventHubName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _eventHubsClientDiagnostics.CreateScope("EventHubCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual async Task<NullableResponse<EventHubResource>> GetIfExistsAsync(string eventHubName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _eventHubsClientDiagnostics.CreateScope("EventHubCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
