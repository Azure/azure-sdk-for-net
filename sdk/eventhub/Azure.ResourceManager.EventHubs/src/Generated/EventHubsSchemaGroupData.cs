...
namespace Azure.ResourceManager._EventHubs
{
    ...
    public partial class EventHubsSchemaGroupData : ResourceData
    {
        ...
        internal EventHubsSchemaGroupData(string id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, SchemaGroupProperties properties, string location) : base(id, name, resourceType, systemData)
        {
