...
namespace Azure.ResourceManager.EventHubs.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EventHubsProvisioningIssue>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (options.Format != "W" && Optional.IsDefined(Properties))
            {
                ...
                ((IJsonModel<EventHubsProvisioningIssueProperties>)Properties).Write(writer, options);
            }
        ...
        internal static EventHubsProvisioningIssue DeserializeEventHubsProvisioningIssue(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    properties = ModelSerializationExtensions.JsonDeserialize<EventHubsProvisioningIssueProperties>(property.Value);
                    continue;
                }
                if (options.Format != "W")
                {
