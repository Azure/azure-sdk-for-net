...
namespace Azure.ResourceManager.EventHubs
{
    public partial class EventHubsNetworkRuleSetData : IUtf8JsonSerializable
    {
        ...
        internal static EventHubsNetworkRuleSetData DeserializeEventHubsNetworkRuleSetData(JsonElement element)
        {
            ...
            return new EventHubsNetworkRuleSetData(id, name, type, systemData, location.Value, Optional.ToNullable(trustedServiceAccessEnabled), Optional.ToNullable(defaultAction), Optional.ToList(virtualNetworkRules), Optional.ToList(ipRules), Optional.ToNullable(publicNetworkAccess));
        }
    }
}
