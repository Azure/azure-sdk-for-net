...
namespace Azure.ResourceManager.EventHubs.Models
{
    ...
    {
        /// <summary> Initializes a new instance of EventHubNameAvailabilityResult. </summary>
        internal EventHubNameAvailabilityResult()
        {
        }
        ...
        internal EventHubNameAvailabilityResult(string message, bool? nameAvailable, UnavailableReason? reason)
        {
            Message = message;
