...
namespace Azure.ResourceManager.EventHubs.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ClusterQuotaConfigurationProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ClusterQuotaConfigurationProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ClusterQuotaConfigurationProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ClusterQuotaConfigurationProperties>)} interface");
            }
        ...
        string IPersistableModel<ClusterQuotaConfigurationProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
