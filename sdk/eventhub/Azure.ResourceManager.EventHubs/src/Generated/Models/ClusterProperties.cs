...
namespace Azure.ResourceManager._EventHubs.Models
{
    ...
    internal partial class ClusterProperties
    {
        ...
        internal ClusterProperties(string createdAt, EventHubsClusterProvisioningState? provisioningState, string updatedAt, string metricId, string status, bool? supportsScaling, PlatformCapabilities platformCapabilities, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            CreatedAt = createdAt;
