...
namespace Azure.ResourceManager._EventHubs.Models
{
    ...
    internal partial class DestinationProperties
    {
        ...
        internal DestinationProperties(string storageAccountResourceId, string blobContainer, string archiveNameFormat, string dataLakeSubscriptionId, string dataLakeAccountName, string dataLakeFolderPath, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
