...
namespace Azure.ResourceManager.EventHubs.Models
{
    ...
    internal partial class PrivateLinkResourcesListResult
    {
        ...
        {
            Value = new ChangeTrackingList<EventHubPrivateLinkResourceData>();
        }
        ...
        internal PrivateLinkResourcesListResult(IReadOnlyList<EventHubPrivateLinkResourceData> value, string nextLink)
        {
            Value = value;
            NextLink = nextLink;
        }
        ...
        public IReadOnlyList<EventHubPrivateLinkResourceData> Value { get; }
