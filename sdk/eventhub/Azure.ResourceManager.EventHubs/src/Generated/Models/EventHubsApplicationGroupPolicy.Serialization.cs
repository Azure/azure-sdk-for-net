...
namespace Azure.ResourceManager.EventHubs.Models
{
    ...
    public abstract partial class EventHubsApplicationGroupPolicy : IJsonModel<EventHubsApplicationGroupPolicy>
    {
        ...
        protected virtual EventHubsApplicationGroupPolicy PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
        ...
        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual EventHubsApplicationGroupPolicy JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<EventHubsApplicationGroupPolicy>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
