...
namespace Azure.ResourceManager.EventHubs.Models
{
    public partial class AccessKeys
    {
        internal static AccessKeys DeserializeAccessKeys(JsonElement element)
        {
            ...
            return new AccessKeys(primaryConnectionString.HasValue ? primaryConnectionString.Value : null, secondaryConnectionString.HasValue ? secondaryConnectionString.Value : null, aliasPrimaryConnectionString.HasValue ? aliasPrimaryConnectionString.Value : null, aliasSecondaryConnectionString.HasValue ? aliasSecondaryConnectionString.Value : null, primaryKey.HasValue ? primaryKey.Value : null, secondaryKey.HasValue ? secondaryKey.Value : null, keyName.HasValue ? keyName.Value : null);
        }
    }
}
