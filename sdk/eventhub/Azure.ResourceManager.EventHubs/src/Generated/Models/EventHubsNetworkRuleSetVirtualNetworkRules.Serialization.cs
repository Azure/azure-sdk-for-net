...
namespace Azure.ResourceManager.EventHubs.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EventHubsNetworkRuleSetVirtualNetworkRules>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<EventHubsNetworkRuleSetVirtualNetworkRules>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<EventHubsNetworkRuleSetVirtualNetworkRules>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<EventHubsNetworkRuleSetVirtualNetworkRules>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
