...
namespace Azure.ResourceManager.EventHubs.Models
{
    ...
    public partial class EventHubsSku : IJsonModel<EventHubsSku>
    {
        ...
        protected virtual EventHubsSku PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<EventHubsSku>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<EventHubsSku>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        EventHubsSku IPersistableModel<EventHubsSku>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        EventHubsSku IJsonModel<EventHubsSku>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual EventHubsSku JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<EventHubsSku>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static EventHubsSku DeserializeEventHubsSku(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    name = new EventHubsSkuName(prop.Value.GetString());
                    continue;
                }
                if (prop.NameEquals("tier"u8))
                {
                    ...
                    tier = new EventHubsSkuTier(prop.Value.GetString());
                    continue;
                }
            ...
            return new EventHubsSku(name, tier, capacity, additionalBinaryDataProperties);
        }
    }
}
