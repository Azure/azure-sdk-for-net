...
namespace Azure.ResourceManager.EventHubs.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EventHubsSku>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<EventHubsSku>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<EventHubsSku>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<EventHubsSku>)} interface");
            }
        ...
        string IPersistableModel<EventHubsSku>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
