...
namespace Azure.ResourceManager.EventHubs.Models
{
    public partial class Destination : IUtf8JsonSerializable
    {
        ...
        internal static Destination DeserializeDestination(JsonElement element)
        {
            ...
            return new Destination(name.HasValue ? name.Value : null, storageAccountResourceId.HasValue ? storageAccountResourceId.Value : null, blobContainer.HasValue ? blobContainer.Value : null, archiveNameFormat.HasValue ? archiveNameFormat.Value : null);
        }
    }
}
