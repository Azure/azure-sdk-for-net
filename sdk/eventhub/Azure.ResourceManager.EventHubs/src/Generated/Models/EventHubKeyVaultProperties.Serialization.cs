...
{
    public partial class EventHubKeyVaultProperties : IUtf8JsonSerializable
    {
        ...
        internal static EventHubKeyVaultProperties DeserializeEventHubKeyVaultProperties(JsonElement element)
        {
            ...
            return new EventHubKeyVaultProperties(keyName.Value, keyVaultUri.Value, keyVersion.Value, identity.Value);
        }
    }
}
