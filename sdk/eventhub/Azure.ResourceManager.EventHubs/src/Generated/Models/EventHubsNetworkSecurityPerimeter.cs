...
namespace Azure.ResourceManager._EventHubs.Models
{
    ...
    public partial class EventHubsNetworkSecurityPerimeter
    {
        ...
        internal EventHubsNetworkSecurityPerimeter(string id, string perimeterGuid, string location, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Id = id;
