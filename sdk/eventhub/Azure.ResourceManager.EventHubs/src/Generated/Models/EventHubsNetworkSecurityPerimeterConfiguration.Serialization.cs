...
{
    public partial class EventHubsNetworkSecurityPerimeterConfiguration : IUtf8JsonSerializable, IJsonModel<EventHubsNetworkSecurityPerimeterConfiguration>, IPersistableModel<EventHubsNetworkSecurityPerimeterConfiguration>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(NetworkSecurityPerimeter))
            {
                ...
                AppendChildObject(builder, NetworkSecurityPerimeter, options, 2);
            }

            if (Optional.IsDefined(ResourceAssociation))
            {
                builder.Append("  resourceAssociation:");
                AppendChildObject(builder, ResourceAssociation, options, 2);
            }

            if (Optional.IsDefined(Profile))
            {
                builder.Append("  profile:");
                AppendChildObject(builder, Profile, options, 2);
            }
