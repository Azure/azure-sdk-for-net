...
namespace Azure.ResourceManager.EventHubs.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EventHubsNetworkSecurityPerimeterConfiguration>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<EventHubsNetworkSecurityPerimeterConfiguration>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<EventHubsNetworkSecurityPerimeterConfiguration>)} interface");
            }
        ...
        string IPersistableModel<EventHubsNetworkSecurityPerimeterConfiguration>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
