...
namespace Azure.ResourceManager.EventHubs
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EventHubsApplicationGroupData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<EventHubsApplicationGroupData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<EventHubsApplicationGroupData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<EventHubsApplicationGroupData>)} interface");
            }
        ...
        string IPersistableModel<EventHubsApplicationGroupData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
