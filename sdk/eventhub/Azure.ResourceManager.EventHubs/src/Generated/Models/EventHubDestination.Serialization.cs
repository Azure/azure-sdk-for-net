...
{
    public partial class EventHubDestination : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static EventHubDestination DeserializeEventHubDestination(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
