...
namespace Azure.ResourceManager.EventHubs
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EventHubsSchemaGroupData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<EventHubsSchemaGroupData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<EventHubsSchemaGroupData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<EventHubsSchemaGroupData>)} interface");
            }
        ...
        string IPersistableModel<EventHubsSchemaGroupData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
