...
{
    public partial class EventHubsSchemaGroupData : IUtf8JsonSerializable, IJsonModel<EventHubsSchemaGroupData>, IPersistableModel<EventHubsSchemaGroupData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(UpdatedAtUtc))
            {
                ...
                builder.AppendLine($" '{UpdatedAtUtc.Value.ToString()}'");
            }
            ...
            if (Optional.IsDefined(SchemaCompatibility))
            {
                ...
                builder.AppendLine($" '{SchemaCompatibility.ToString()}'");
            }
