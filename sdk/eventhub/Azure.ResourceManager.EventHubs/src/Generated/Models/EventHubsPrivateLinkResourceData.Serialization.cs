...
namespace Azure.ResourceManager.EventHubs.Models
{
    ...
    public partial class EventHubsPrivateLinkResourceData : ResourceData, IJsonModel<EventHubsPrivateLinkResourceData>
    {
        ...
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        EventHubsPrivateLinkResourceData IPersistableModel<EventHubsPrivateLinkResourceData>.Create(BinaryData data, ModelReaderWriterOptions options) => (EventHubsPrivateLinkResourceData)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        EventHubsPrivateLinkResourceData IJsonModel<EventHubsPrivateLinkResourceData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (EventHubsPrivateLinkResourceData)JsonModelCreateCore(ref reader, options);
