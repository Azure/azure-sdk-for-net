...
namespace Azure.ResourceManager.EventHubs.Models
{
    ...
    internal partial class ArmDisasterRecoveryListResult
    {
        ...
        {
            Value = new ChangeTrackingList<EventHubDisasterRecoveryData>();
        }
        ...
        internal ArmDisasterRecoveryListResult(IReadOnlyList<EventHubDisasterRecoveryData> value, string nextLink)
        {
            Value = value;
            NextLink = nextLink;
        }
        ...
        public IReadOnlyList<EventHubDisasterRecoveryData> Value { get; }
