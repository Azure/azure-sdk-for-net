...
namespace Azure.ResourceManager.EventHubs.Models
{
    ...
    public partial class EventHubsAccessKeys
    {
        ...
        internal EventHubsAccessKeys(string primaryConnectionString, string secondaryConnectionString, string aliasPrimaryConnectionString, string aliasSecondaryConnectionString, string primaryKey, string secondaryKey, string keyName, Dictionary<string, BinaryData> rawData)
        {
