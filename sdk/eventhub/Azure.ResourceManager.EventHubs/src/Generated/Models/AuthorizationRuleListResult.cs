...
namespace Azure.ResourceManager.EventHubs.Models
{
    ...
    internal partial class AuthorizationRuleListResult
    {
        ...
        {
            Value = new ChangeTrackingList<EventHubAuthorizationRuleData>();
        }
        ...
        internal AuthorizationRuleListResult(IReadOnlyList<EventHubAuthorizationRuleData> value, string nextLink)
        {
            Value = value;
            NextLink = nextLink;
        }
        ...
        public IReadOnlyList<EventHubAuthorizationRuleData> Value { get; }
