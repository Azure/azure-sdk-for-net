...
namespace Azure.ResourceManager.EventHubs.Models
{
    ...
    public partial class EventHubsThrottlingPolicy : EventHubsApplicationGroupPolicy
    {
        ...
        internal EventHubsThrottlingPolicy(string name, ApplicationGroupPolicyType applicationGroupPolicyType, long rateLimitThreshold, EventHubsMetricId metricId, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(name, applicationGroupPolicyType, serializedAdditionalRawData)
        {
            RateLimitThreshold = rateLimitThreshold;
            MetricId = metricId;
