...
namespace Azure.ResourceManager.EventHubs.Models
{
    ...
    public partial class EventHubsThrottlingPolicy : EventHubsApplicationGroupPolicy
    {
        ...
        internal EventHubsThrottlingPolicy(string name, ApplicationGroupPolicyType applicationGroupPolicyType, long rateLimitThreshold, EventHubsMetricId metricId, Dictionary<string, BinaryData> rawData) : base(name, applicationGroupPolicyType, rawData)
        {
            RateLimitThreshold = rateLimitThreshold;
            MetricId = metricId;
