...
{
    public partial class EventHubsThrottlingPolicy : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static EventHubsThrottlingPolicy DeserializeEventHubsThrottlingPolicy(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
