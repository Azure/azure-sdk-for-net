...
{
    public partial class EventHubNetworkRuleSetData : IUtf8JsonSerializable
    {
        ...
        internal static EventHubNetworkRuleSetData DeserializeEventHubNetworkRuleSetData(JsonElement element)
        {
            ...
            Optional<EventHubNetworkRuleSetDefaultAction> defaultAction = default;
            ...
            Optional<EventHubPublicNetworkAccessFlag> publicNetworkAccess = default;
                ...
                if (property.NameEquals("properties"))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("defaultAction"))
                        {
                            ...
                            defaultAction = new EventHubNetworkRuleSetDefaultAction(property0.Value.GetString());
                            continue;
                        }
                        ...
                        if (property0.NameEquals("publicNetworkAccess"))
                        {
                            ...
                            publicNetworkAccess = new EventHubPublicNetworkAccessFlag(property0.Value.GetString());
                            continue;
                        }
                    }
                    continue;
            ...
            return new EventHubNetworkRuleSetData(id, name, type, systemData, location.Value, Optional.ToNullable(trustedServiceAccessEnabled), Optional.ToNullable(defaultAction), Optional.ToList(virtualNetworkRules), Optional.ToList(ipRules), Optional.ToNullable(publicNetworkAccess));
        }
    }
}
