...
{
    public partial class EventHubData : IUtf8JsonSerializable, IJsonModel<EventHubData>, IPersistableModel<EventHubData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(CaptureDescription))
            {
                ...
                AppendChildObject(builder, CaptureDescription, options, 2);
            }

            if (Optional.IsDefined(RetentionDescription))
            {
                builder.Append("  retentionDescription:");
                AppendChildObject(builder, RetentionDescription, options, 2);
            }
