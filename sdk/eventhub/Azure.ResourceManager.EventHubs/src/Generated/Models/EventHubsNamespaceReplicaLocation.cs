...
namespace Azure.ResourceManager._EventHubs.Models
{
    ...
    public partial class EventHubsNamespaceReplicaLocation
    {
        ...
        internal EventHubsNamespaceReplicaLocation(string locationName, EventHubsNamespaceGeoDRRoleType? roleType, string replicaState, string clusterArmId, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
