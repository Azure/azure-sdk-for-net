...
namespace Azure.ResourceManager.EventHubs.Models
{
    public partial class IpFilterRule : IUtf8JsonSerializable
    {
        ...
        internal static IpFilterRule DeserializeIpFilterRule(JsonElement element)
        {
            ...
            return new IpFilterRule(id.HasValue ? id.Value : null, name.HasValue ? name.Value : null, type.HasValue ? type.Value : null, ipMask.HasValue ? ipMask.Value : null, action.HasValue ? action.Value : (IPAction?)null, filterName.HasValue ? filterName.Value : null);
        }
    }
}
