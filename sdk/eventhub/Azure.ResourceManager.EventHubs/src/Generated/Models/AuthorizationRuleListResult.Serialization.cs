...
namespace Azure.ResourceManager.EventHubs.Models
{
    ...
    {
        internal static AuthorizationRuleListResult DeserializeAuthorizationRuleListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
