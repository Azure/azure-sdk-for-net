...
namespace Azure.ResourceManager.EventHubs.Models
{
    internal partial class UnknownEventHubsApplicationGroupPolicy : IUtf8JsonSerializable, IJsonModel<EventHubsApplicationGroupPolicy>
    {
        ...
        void IJsonModel<EventHubsApplicationGroupPolicy>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(EventHubsApplicationGroupPolicy)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<EventHubsApplicationGroupPolicy>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(EventHubsApplicationGroupPolicy)} does not support '{options.Format}' format.");
            }
        }
