...
namespace Azure.ResourceManager.EventHubs
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EventHubsConsumerGroupData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<EventHubsConsumerGroupData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<EventHubsConsumerGroupData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<EventHubsConsumerGroupData>)} interface");
            }
        ...
        string IPersistableModel<EventHubsConsumerGroupData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
