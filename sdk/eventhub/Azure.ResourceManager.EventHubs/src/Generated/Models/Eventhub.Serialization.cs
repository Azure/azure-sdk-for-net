...
namespace Azure.ResourceManager.EventHubs.Models
{
    public partial class Eventhub : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            writer.WriteStartObject();
            if (Optional.IsDefined(PartitionIds))
            {
        ...
        internal static Eventhub DeserializeEventhub(JsonElement element)
        {
            ...
            return new Eventhub(id.HasValue ? id.Value : null, name.HasValue ? name.Value : null, type.HasValue ? type.Value : null, new ChangeTrackingList<string>(partitionIds), createdAt.HasValue ? createdAt.Value : (DateTimeOffset?)null, updatedAt.HasValue ? updatedAt.Value : (DateTimeOffset?)null, messageRetentionInDays.HasValue ? messageRetentionInDays.Value : (long?)null, partitionCount.HasValue ? partitionCount.Value : (long?)null, status.HasValue ? status.Value : (EntityStatus?)null, captureDescription.HasValue ? captureDescription.Value : null);
        }
    }
}
