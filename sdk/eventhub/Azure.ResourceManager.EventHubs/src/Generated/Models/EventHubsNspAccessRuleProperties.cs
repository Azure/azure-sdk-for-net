...
namespace Azure.ResourceManager._EventHubs.Models
{
    ...
    public partial class EventHubsNspAccessRuleProperties
    {
        ...
        internal EventHubsNspAccessRuleProperties(EventHubsNspAccessRuleDirection? direction, IList<string> addressPrefixes, IList<NspAccessRulePropertiesSubscriptionsItem> subscriptions, IReadOnlyList<EventHubsNetworkSecurityPerimeter> networkSecurityPerimeters, IReadOnlyList<string> fullyQualifiedDomainNames, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Direction = direction;
