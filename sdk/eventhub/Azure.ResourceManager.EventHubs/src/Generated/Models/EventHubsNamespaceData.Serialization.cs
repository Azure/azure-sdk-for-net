...
namespace Azure.ResourceManager.EventHubs
{
    public partial class EventHubsNamespaceData : IUtf8JsonSerializable, IModelJsonSerializable<EventHubsNamespaceData>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<EventHubsNamespaceData>(this, options.Format);
            ...
            if (Optional.IsDefined(Sku))
            {
                ...
                {
                    ((IModelJsonSerializable<EventHubsSku>)Sku).Serialize(writer, options);
                }
            }
            ...
            if (Optional.IsDefined(Encryption))
            {
                ...
                {
                    ((IModelJsonSerializable<EventHubsEncryption>)Encryption).Serialize(writer, options);
                }
            }
            if (Optional.IsCollectionDefined(PrivateEndpointConnections))
            {
                ...
                foreach (var item in PrivateEndpointConnections)
                {
                    ...
                    {
                        ((IModelJsonSerializable<EventHubsPrivateEndpointConnectionData>)item).Serialize(writer, options);
                    }
                }
        ...
        /// <summary> Converts a <see cref="EventHubsNamespaceData"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="EventHubsNamespaceData"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="EventHubsNamespaceData"/>. </summary>
