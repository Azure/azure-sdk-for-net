...
namespace Azure.ResourceManager.EventHubs.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EventHubsNetworkSecurityPerimeterConfigurationPropertiesProfile>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        EventHubsNetworkSecurityPerimeterConfigurationPropertiesProfile IJsonModel<EventHubsNetworkSecurityPerimeterConfigurationPropertiesProfile>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<EventHubsNetworkSecurityPerimeterConfigurationPropertiesProfile>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        EventHubsNetworkSecurityPerimeterConfigurationPropertiesProfile IModel<EventHubsNetworkSecurityPerimeterConfigurationPropertiesProfile>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<EventHubsNetworkSecurityPerimeterConfigurationPropertiesProfile>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
