...
namespace Azure.ResourceManager.EventHubs
{
    public partial class EventHubsDisasterRecoveryData : IUtf8JsonSerializable, IJsonModel<EventHubsDisasterRecoveryData>
    {
        ...
        void IJsonModel<EventHubsDisasterRecoveryData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(EventHubsDisasterRecoveryData)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<EventHubsDisasterRecoveryData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(EventHubsDisasterRecoveryData)} does not support '{options.Format}' format.");
            }
        }
