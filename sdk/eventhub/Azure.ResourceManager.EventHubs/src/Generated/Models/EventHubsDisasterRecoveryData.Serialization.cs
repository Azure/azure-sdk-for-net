...
namespace Azure.ResourceManager.EventHubs
{
    public partial class EventHubsDisasterRecoveryData : IUtf8JsonSerializable
    {
        ...
        internal static EventHubsDisasterRecoveryData DeserializeEventHubsDisasterRecoveryData(JsonElement element)
        {
            ...
            return new EventHubsDisasterRecoveryData(id, name, type, systemData.Value, Optional.ToNullable(location), Optional.ToNullable(provisioningState), partnerNamespace.Value, alternateName.Value, Optional.ToNullable(role), Optional.ToNullable(pendingReplicationOperationsCount));
        }
    }
}
