...
namespace Azure.ResourceManager.EventHubs
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EventHubsDisasterRecoveryData>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        EventHubsDisasterRecoveryData IJsonModel<EventHubsDisasterRecoveryData>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<EventHubsDisasterRecoveryData>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        EventHubsDisasterRecoveryData IModel<EventHubsDisasterRecoveryData>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<EventHubsDisasterRecoveryData>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
