...
namespace Azure.ResourceManager.EventHubs.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EventHubsNspAccessRule>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<EventHubsNspAccessRule>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<EventHubsNspAccessRule>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<EventHubsNspAccessRule>)} interface");
            }
        ...
        string IPersistableModel<EventHubsNspAccessRule>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
