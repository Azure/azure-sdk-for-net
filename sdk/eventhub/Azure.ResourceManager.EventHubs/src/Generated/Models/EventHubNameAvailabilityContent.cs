...
namespace Azure.ResourceManager.EventHubs.Models
{
    ...
    public partial class EventHubNameAvailabilityContent
    {
        /// <summary> Initializes a new instance of EventHubNameAvailabilityContent. </summary>
        /// <param name="name"> Name to check the namespace name availability. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="name"/> is null. </exception>
        public EventHubNameAvailabilityContent(string name)
        {
            if (name == null)
            {
