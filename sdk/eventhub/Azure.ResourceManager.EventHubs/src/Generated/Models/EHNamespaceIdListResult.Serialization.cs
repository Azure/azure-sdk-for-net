...
namespace Azure.ResourceManager.EventHubs.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EHNamespaceIdListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<EHNamespaceIdListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<EHNamespaceIdListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<EHNamespaceIdListResult>)} interface");
            }
        ...
        string IPersistableModel<EHNamespaceIdListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
