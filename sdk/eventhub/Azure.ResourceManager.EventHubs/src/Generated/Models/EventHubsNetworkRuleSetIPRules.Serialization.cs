...
namespace Azure.ResourceManager.EventHubs.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EventHubsNetworkRuleSetIPRules>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<EventHubsNetworkRuleSetIPRules>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<EventHubsNetworkRuleSetIPRules>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<EventHubsNetworkRuleSetIPRules>)} interface");
            }
        ...
        string IPersistableModel<EventHubsNetworkRuleSetIPRules>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
