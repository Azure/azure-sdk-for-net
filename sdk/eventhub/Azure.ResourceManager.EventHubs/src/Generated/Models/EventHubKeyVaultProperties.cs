...
namespace Azure.ResourceManager.EventHubs.Models
{
    ...
    public partial class EventHubKeyVaultProperties
    {
        /// <summary> Initializes a new instance of EventHubKeyVaultProperties. </summary>
        public EventHubKeyVaultProperties()
        {
        }
        ...
        internal EventHubKeyVaultProperties(string keyName, Uri keyVaultUri, string keyVersion, UserAssignedIdentityProperties identity)
        {
            KeyName = keyName;
