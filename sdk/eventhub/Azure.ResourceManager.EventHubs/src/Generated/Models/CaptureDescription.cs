...
namespace Azure.ResourceManager.EventHubs.Models
{
    ...
    public partial class CaptureDescription
    {
        ...
        internal CaptureDescription(bool? enabled, EncodingCaptureDescription? encoding, int? intervalInSeconds, int? sizeLimitInBytes, EventHubDestination destination, bool? skipEmptyArchives, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Enabled = enabled;
            Encoding = encoding;
