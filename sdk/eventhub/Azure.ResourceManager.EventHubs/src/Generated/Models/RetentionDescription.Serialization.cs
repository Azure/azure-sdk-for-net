...
{
    public partial class RetentionDescription : IUtf8JsonSerializable, IJsonModel<RetentionDescription>, IPersistableModel<RetentionDescription>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(CleanupPolicy))
            {
                ...
                builder.AppendLine($" '{CleanupPolicy.ToString()}'");
            }
            ...
            if (Optional.IsDefined(TombstoneRetentionTimeInHours))
            {
                ...
                builder.AppendLine($" '{TombstoneRetentionTimeInHours.Value.ToString()}'");
            }
