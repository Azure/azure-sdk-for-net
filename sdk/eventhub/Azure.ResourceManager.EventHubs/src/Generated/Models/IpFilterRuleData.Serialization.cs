...
{
    public partial class IpFilterRuleData : IUtf8JsonSerializable
    {
        ...
        internal static IpFilterRuleData DeserializeIpFilterRuleData(JsonElement element)
        {
            ...
            return new IpFilterRuleData(id, name, type, ipMask.Value, Optional.ToNullable(action), filterName.Value);
        }
    }
}
