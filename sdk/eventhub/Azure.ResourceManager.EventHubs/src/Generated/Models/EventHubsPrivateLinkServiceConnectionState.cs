...
namespace Azure.ResourceManager.EventHubs.Models
{
    ...
    public partial class EventHubsPrivateLinkServiceConnectionState
    {
        ...
        internal EventHubsPrivateLinkServiceConnectionState(EventHubsPrivateLinkConnectionStatus? status, string description, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Status = status;
