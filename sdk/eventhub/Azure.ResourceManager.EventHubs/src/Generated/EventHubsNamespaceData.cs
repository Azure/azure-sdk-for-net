...
namespace Azure.ResourceManager._EventHubs
{
    ...
    public partial class EventHubsNamespaceData : ResourceData
    {
        ...
        internal EventHubsNamespaceData(string id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, EHNamespaceProperties properties, IDictionary<string, string> tags, string location, EventHubsSku sku, Identity identity) : base(id, name, resourceType, systemData)
        {
