...
namespace Azure.ResourceManager._EventHubs
{
    ...
    public partial class EventHubsNetworkRuleSetData : ResourceData
    {
        ...
        internal EventHubsNetworkRuleSetData(string id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, NetworkRuleSetProperties properties, string location) : base(id, name, resourceType, systemData)
        {
