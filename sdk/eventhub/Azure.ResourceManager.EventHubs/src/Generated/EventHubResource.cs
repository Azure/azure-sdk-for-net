...
namespace Azure.ResourceManager._EventHubs
{
    ...
    public partial class EventHubResource : ArmResource
    {
        ...
        {
            this.TryGetApiVersion(ResourceType, out string eventHubApiVersion);
            _eventHubsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager._EventHubs", ResourceType.Namespace, Diagnostics);
        ...
        {
            using DiagnosticScope scope = _eventHubsClientDiagnostics.CreateScope("EventHubResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _eventHubsRestClient.CreateGetRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, context);
        ...
        {
            using DiagnosticScope scope = _eventHubsClientDiagnostics.CreateScope("EventHubResource.Delete");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _eventHubsRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, context);
        ...
        public virtual async Task<ArmOperation<EventHubResource>> UpdateAsync(WaitUntil waitUntil, EventHubData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _eventHubsClientDiagnostics.CreateScope("EventHubResource.Update");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _eventHubsRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, EventHubData.ToRequestContent(data), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<EventHubData> response = Response.FromValue(EventHubData.FromResponse(result), result);
                RequestUriBuilder uri = message.Request.Uri;
