...
namespace Azure.ResourceManager._EventHubs
{
    ...
    public partial class EventHubsAuthorizationRuleData : ResourceData
    {
        ...
        internal EventHubsAuthorizationRuleData(string id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, AuthorizationRuleProperties properties, string location) : base(id, name, resourceType, systemData)
        {
