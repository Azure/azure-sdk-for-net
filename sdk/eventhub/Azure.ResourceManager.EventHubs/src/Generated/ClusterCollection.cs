...
namespace Azure.ResourceManager._EventHubs
{
    ...
    public partial class ClusterCollection : ArmCollection, IEnumerable<ClusterResource>, IAsyncEnumerable<ClusterResource>
    {
        ...
        internal ClusterCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _clustersClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager._EventHubs", ClusterResource.ResourceType.Namespace, Diagnostics);
            _clustersRestClient = new Clusters(_clustersClientDiagnostics, Pipeline, Endpoint, clusterApiVersion ?? "2025-05-01-preview");
            _configurationClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager._EventHubs", ClusterResource.ResourceType.Namespace, Diagnostics);
