    ...
    public partial class ScenarioTests : EventHubsManagementClientBase
    {
        ...
        public async Task EventHubskiptop()
        {
            ...
            for (int ehCount = 0; ehCount < 10; ehCount++)
            {
                ...
                var createEventHubResponseForLoop =await EventHubsOperations.CreateOrUpdateAsync(resourceGroupName, namespaceName, eventhubNameLoop, new Eventhub());
            ...
            var createEventHubResponseList = EventHubsOperations.ListByNamespaceAsync(resourceGroupName, namespaceName);
            ...
            var gettop10EventHub = EventHubsOperations.ListByNamespaceAsync(resourceGroupName, namespaceName, skip: 5, top: 5);
            ...
            for (int consumergroupCount = 0; consumergroupCount < 10; consumergroupCount++)
            {
                ...
                var createConsumerGroupResponseForLoop =await ConsumerGroupsOperations.CreateOrUpdateAsync(resourceGroupName, namespaceName, createEHResplist.ElementAt<Eventhub>(0).Name, consumergroupNameLoop, new ConsumerGroup());
            ...
            var createConsumerGroupResponseList = ConsumerGroupsOperations.ListByEventHubAsync(resourceGroupName, namespaceName, createEHResplist.ElementAt<Eventhub>(0).Name);
            ...
            var gettop10ConsumerGroup = ConsumerGroupsOperations.ListByEventHubAsync(resourceGroupName, namespaceName, createEHResplist.ElementAt<Eventhub>(0).Name, skip: 5, top: 4);
