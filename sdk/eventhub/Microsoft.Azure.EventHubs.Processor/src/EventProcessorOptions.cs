...
namespace Microsoft.Azure.EventHubs.Processor
{
    ...
    public sealed class EventProcessorOptions
    {
        ...
        /// <summary>
        /// Returns whether the EventProcessorHost will call IEventProcessor.ProcessEventsAsync(PartitionContext context, Enumerable.Empty&lt;EventData&gt;()) when a receive
