...
{
    internal class EventHubsMetricsProvider
    {
            ...
            ILoggerFactory loggerFactory)
        {
            ...
            _client = client;
            _logger = loggerFactory.CreateLogger<EventHubsMetricsProvider>();
        ...
        internal EventHubsTriggerMetrics CreateTriggerMetrics(List<PartitionProperties> partitionRuntimeInfo, EventProcessorCheckpoint[] checkpoints, bool alwaysLog = false)
        {
