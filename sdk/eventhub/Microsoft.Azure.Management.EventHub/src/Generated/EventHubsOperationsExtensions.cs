...
namespace Microsoft.Azure.Management.EventHub
{
    ...
    public static partial class EventHubsOperationsExtensions
    {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<AccessKeys> RegenerateKeysAsync(this IEventHubsOperations operations, string resourceGroupName, string namespaceName, string eventHubName, string authorizationRuleName, KeyType keyType, string key = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
