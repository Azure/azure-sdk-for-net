...
{
    /// <summary>
    ///   The set of options that can be specified for an <see cref="IdempotentProducer" />
    ...
    public class PartitionPublishingOptions
    {
        ...
        /// </remarks>
        ///
        /// <seealso cref="IdempotentProducerOptions.EnableIdempotentPartitions" />
        ///
        ...
        ///   Occurs when the owner level is set and the <see cref="IdempotentProducer"/> is unable to publish to the requested Event Hub partition due to being denied
        ...
        /// <summary>
        ///   Creates a new copy of the current <see cref="PartitionPublishingOptions" /> for use with the
        ///   core Event Hubs types.
        /// </summary>
        ///
        /// <returns>A new copy of <see cref="PartitionPublishingOptions" />.</returns>
        ///
        internal PartitionPublishingOptionsInternal ToCoreOptions() =>
            new EventHubs.Producer.PartitionPublishingOptionsInternal
            {
