...
- **C# 8.0:** The Azure Event Hubs client library makes use of new features that were introduced in C# 8.0.  You can still use the library with older versions of C#, but some of its functionalities won't be available.  In order to enable these features, you need to [target .NET Core 3.0](https://docs.microsoft.com/en-us/dotnet/standard/frameworks#how-to-specify-target-frameworks) or [specify the language version](https://docs.microsoft.com/en-gb/dotnet/csharp/language-reference/configure-language-version#override-a-default) you want to use ('8.0', 'preview' or 'latest').  If you are using Visual Studio, it's worth mentioning that older versions don't provide the necessary tools to build C# 8.0 projects, so you'll need [Visual Studio 2019](https://visualstudio.microsoft.com/vs/) to do so.
