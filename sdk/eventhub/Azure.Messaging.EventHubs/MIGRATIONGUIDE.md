...
In v4, an event could be published using `EventHubClient`.

In v5, an event is published using `EventHubProducerClient`.
...
In v4, events could be published using `EventHubClient`.

In v5, events are published using `EventHubProducerClient`.
