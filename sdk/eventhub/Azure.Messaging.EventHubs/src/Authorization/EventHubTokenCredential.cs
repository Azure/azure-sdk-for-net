...
namespace Azure.Messaging.EventHubs.Authorization
{
    ...
    internal class EventHubTokenCredential : TokenCredential
    {
        ...
        public override AccessToken GetToken(TokenOptions options,
                                             CancellationToken cancellationToken) => Credential.GetToken(options, cancellationToken);
        ...
        public override Task<AccessToken> GetTokenAsync(TokenOptions options,
                                                        CancellationToken cancellationToken) => Credential.GetTokenAsync(options, cancellationToken);
    }
}
