...
namespace Azure.Messaging.EventHubs.Authorization
{
    ...
    public sealed class EventHubSharedKeyCredential : TokenCredential
    {
        ...
        ///
        public override AccessToken GetToken(TokenOptions options, CancellationToken cancellationToken) => throw new InvalidOperationException(Resources.SharedKeyCredentialCannotGenerateTokens);
        ...
        /// <returns>The token representing the shared access signature for this credential.</returns>
        ///
        public override Task<AccessToken> GetTokenAsync(TokenOptions options, CancellationToken cancellationToken) => throw new InvalidOperationException(Resources.SharedKeyCredentialCannotGenerateTokens);
