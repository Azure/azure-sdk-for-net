...
namespace Azure.Messaging.EventHubs.Amqp
{
    ...
    internal static class TypeExtensions
    {
        ...
        private static readonly Dictionary<Type, AmqpProperty.Type> s_amqpPropertyTypeMap = new Dictionary<Type, AmqpProperty.Type>
        {
        ...
        public static AmqpProperty.Type ToAmqpPropertyType(this Type instance)
        {
            ...
            if (s_amqpPropertyTypeMap.TryGetValue(instance, out var amqpType))
            {
                return amqpType;
            }
