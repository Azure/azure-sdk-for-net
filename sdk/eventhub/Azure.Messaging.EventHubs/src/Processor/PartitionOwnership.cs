...
namespace Azure.Messaging.EventHubs.Processor
{
    ...
    public class PartitionOwnership
    {
        ...
        /// <summary>
        ///   The offset of the last <see cref="EventData" /> received by the associated <see cref="EventProcessor" />
        ...
        /// <summary>
        ///   The sequence number of the last <see cref="EventData" /> received by the associated <see cref="EventProcessor" />
        ///   upon ownership update.
        /// </summary>
        ///
        ...
        /// <param name="offset">The offset of the last <see cref="EventData" /> received by the associated <see cref="EventProcessor" />.</param>
        /// <param name="sequenceNumber">The sequence number of the last <see cref="EventData" /> received by the associated <see cref="EventProcessor" />.</param>
