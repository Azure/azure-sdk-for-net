...
namespace Azure.Messaging.EventHubs.Processor
{
    ...
    ///
    /// <remarks>
    ///   An instance of a concrete subclass is provided by the user in the <see cref="EventProcessor{T}" />
    ///   constructor.
    /// </remarks>
    ///
    public abstract class PartitionManager
    {
        ...
        ///
        public abstract Task<IEnumerable<PartitionOwnership>> ListOwnershipAsync(string eventHubsHostName,
                                                                                 string eventHubName,
