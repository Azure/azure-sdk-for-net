...
namespace Azure.Messaging.EventHubs.Processor
{
    ...
    ///   where the associated <see cref="EventProcessor" /> should begin reading events in case
    ...
    public class InitializePartitionProcessingContext
    {
        ...
        /// <summary>
        ///   The position within a partition where the associated <see cref="EventProcessor" /> should
        ///   begin reading events when no checkpoint can be found.
        /// </summary>
        ///
        public EventPosition DefaultStartingPosition { internal get; set; }
