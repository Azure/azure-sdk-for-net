...
namespace Azure.Messaging.EventHubs
{
    ...
    public class EventProcessorClient : EventProcessorBase<PartitionContext>, IAsyncDisposable
    {
                                    ...
                                    EventProcessorClientOptions clientOptions)
        {
            ...
            OwnsConnection = true;
            ConnectionFactory = new EventHubConnectionFactory(connectionString, eventHubName, clientOptions.ConnectionOptions);
                                    ...
                                    EventProcessorClientOptions clientOptions = default)
        {
            ...
            OwnsConnection = true;
            ConnectionFactory = new EventHubConnectionFactory(fullyQualifiedNamespace, eventHubName, credential, clientOptions.ConnectionOptions);
