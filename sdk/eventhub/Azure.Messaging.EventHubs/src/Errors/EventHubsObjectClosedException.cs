...
namespace Azure.Messaging.EventHubs.Errors
{
    ...
    ///   object which has already been closed.
    /// </summary>
    ///
    public sealed class EventHubsObjectClosedException : EventHubsException
    {
        /// <summary>
        ///   Initializes a new instance of the <see cref="EventHubsObjectClosedException"/> class.
        /// </summary>
        ///
        ...
        ///
        internal EventHubsObjectClosedException(string resourceName,
