...
namespace Azure.Messaging.EventHubs.Primitives
{
    ...
    public abstract class EventProcessor<TPartition> where TPartition : EventProcessorPartition, new()
    {
        ...
        ///
        ///   No time limit is imposed on an invocation; the processor will wait indefinitely for execution to complete.  It is recommended for implementations to avoid
