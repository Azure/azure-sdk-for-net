...
#pragma warning restore CA2214 // Do not call overridable methods in constructors.
        ...
        internal virtual TransportConsumer CreateTransportConsumer(string consumerGroup,
            ...
            Connection.CreateTransportConsumer(consumerGroup, partitionId, eventPosition, retryPolicy, options.TrackLastEnqueuedEventProperties, options.OwnerLevel, (uint?)options.PrefetchCount, options.PrefetchSize);
