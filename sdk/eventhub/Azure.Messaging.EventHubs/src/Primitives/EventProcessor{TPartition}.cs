...
#pragma warning restore CA2214 // Do not call overridable methods in constructors
        ...
        internal virtual TransportConsumer CreateConsumer(string consumerGroup,
            ...
            connection.CreateTransportConsumer(consumerGroup, partitionId, eventPosition, options.RetryOptions.ToRetryPolicy(), options.TrackLastEnqueuedEventProperties, prefetchCount: (uint?)options.PrefetchCount, prefetchSize: options.PrefetchSize, ownerLevel: 0);
