...
namespace Azure.Messaging.EventHubs.Tests
{
    ...
    public class CheckpointPositionTests
    {
        ...
        {
            var first = new CheckpointPosition(121, 1);
            var second = new CheckpointPosition(121, 1);
        ...
        {
            var first = new CheckpointPosition(10, 1);
            var second = new CheckpointPosition(121, 4);
        ...
        public void ToStringReflectsTheState()
        {
            ...
            var checkpoint = new CheckpointPosition(sequence, offset);
