...
namespace Azure.Messaging.EventHubs.Tests
{
    ...
    public class EventProcessorOptionsTests
    {
        ...
        {
            Assert.That(() => new EventProcessorOptions { PrefetchSize = count }, Throws.InstanceOf<ArgumentOutOfRangeException>());
        }
        ...
        {
            Assert.That(() => new EventProcessorOptions { PrefetchSize = 0 }, Throws.Nothing);
        }
