...
namespace Azure.Messaging.EventHubs.Tests
{
    ...
    public partial class EventProcessorTests
    {
        ...
        public void ProcessorCheckpointStoreDoesNotAllowCheckpointUpdate()
        {
            ...
            Assert.That(checkpointStore, Is.Not.Null, "The storage manager should have been created.");
            Assert.That(() => checkpointStore.UpdateCheckpointAsync(fqNamespace, eventHub, consumerGroup, partitionId, 0, 0, "", "Id", CancellationToken.None), Throws.InstanceOf<NotImplementedException>(), "Calling to update checkpoints should not be implemented.");
        }
