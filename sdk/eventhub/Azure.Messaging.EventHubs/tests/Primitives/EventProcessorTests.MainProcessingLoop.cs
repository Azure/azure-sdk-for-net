...
namespace Azure.Messaging.EventHubs.Tests
{
    ...
    public partial class EventProcessorTests
    {
        ...
        public async Task BackgroundProcessingToleratesAnOwnershipClaimFailureWhenThePartitionIsNotSet()
        {
            ...
            mockConnection
                .Setup(conn => conn.GetPropertiesAsync(It.IsAny<EventHubsRetryPolicy>(), It.IsAny<CancellationToken>()))
                .ReturnsAsync(new EventHubProperties(mockProcessor.Object.EventHubName, new DateTimeOffset(2015, 10, 27, 12, 0, 0, 0, TimeSpan.Zero), partitionIds, false));
        ...
        public async Task BackgroundProcessingUsesCheckpointsWhenProcessingPartitions()
        {
            ...
            var expectedStartingPosition = EventPosition.FromGlobalOffset("775", true);
            var partitionId = "27";
        ...
        public async Task LoadBalancingAppliesTheGreedyStrategy()
        {
            ...
            mockConnection
                ...
                {
                    await Task.Yield();
                    return new EventHubProperties("", DateTime.Now, partitionIds, false);
                });
