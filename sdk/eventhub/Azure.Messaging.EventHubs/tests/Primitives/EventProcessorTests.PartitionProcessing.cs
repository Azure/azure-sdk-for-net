...
namespace Azure.Messaging.EventHubs.Tests
{
    ...
    public partial class EventProcessorTests
    {
        ...
        public async Task CreatePartitionProcessorProcessingTaskLogsTheStartingPosition()
        {
            ...
            mockLogger
                .Setup(log => log.EventProcessorPartitionProcessingEventPositionDetermined(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<bool>(), It.IsAny<string>()))
                .Callback(() => completionSource.TrySetResult(true));
        ...
        ///
        [Test]
        public async Task CreatePartitionProcessorProcessingTaskLogsTheLastModifiedTimeWhenUsingCheckpoint()
        {
            using var cancellationSource = new CancellationTokenSource();
            cancellationSource.CancelAfter(EventHubsTestEnvironment.Instance.TestExecutionTimeLimit);
