        ...
        public async Task OpenConsumerLinkAsyncRequestsTheLink()
        {
            ...
            mockScope
                ...
                .Setup<Task<ReceivingAmqpLink>>("CreateReceivingLinkAsync",
                    ...
                    ItExpr.Is<long?>(value => value == prefetchSize),
            ...
            var link = await mockScope.Object.OpenConsumerLinkAsync(consumerGroup, partitionId, position, TimeSpan.FromDays(1), prefetchCount, prefetchSize, ownerLevel, trackLastEvent, cancellationSource.Token);
            Assert.That(link, Is.EqualTo(mockLink), "The mock return was incorrect");
