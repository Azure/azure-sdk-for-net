...
namespace Azure.Messaging.EventHubs.Tests
{
    ...
    public class EventHubConsumerClientTests
    {
        ...
        public async Task ReadEventsFromPartitionAsyncWithNoOptionsReturnsAnEnumerable()
        {
            ...
            IAsyncEnumerable<PartitionEvent> enumerable = consumer.ReadEventsFromPartitionAsync("0", EventPosition.FromGlobalOffset("12"));
        ...
        public async Task ReadEventsFromPartitionAsyncWithOptionsReturnsAnEnumerable()
        {
            ...
            var options = new ReadEventOptions { MaximumWaitTime = TimeSpan.FromMilliseconds(25) };
            var enumerable = consumer.ReadEventsFromPartitionAsync("0", EventPosition.FromGlobalOffset("12"), options);
        ...
        public async Task ReadEventsFromPartitionAsyncRespectsTheCacheEventCount()
        {
            ...
            await using var enumerator = consumer.ReadEventsFromPartitionAsync("0", EventPosition.FromGlobalOffset("12"), options).GetAsyncEnumerator();
        ...
        public void ReadEventsFromPartitionAsyncThrowsIfConsumerClosedBeforeRead()
        {
            ...
            Assert.That(async () =>
            {
                ...
                await foreach (PartitionEvent partitionEvent in consumer.ReadEventsFromPartitionAsync("0", EventPosition.FromGlobalOffset("12"), cancellationSource.Token))
                {
                    receivedEvents = true;
                    break;
                }
        ...
        public void ReadEventsFromPartitionAsyncThrowsIfCanceledBeforeRead()
        {
            ...
            Assert.That(async () =>
            {
                await foreach (PartitionEvent partitionEvent in consumer.ReadEventsFromPartitionAsync("0", EventPosition.FromGlobalOffset("12"), cancellation.Token))
                {
        ...
        public async Task ReadEventsFromPartitionAsyncEmitsEventsWithMultipleIteratorsAndSingleBatch()
        {
            ...
            var partition = "0";
            var position = EventPosition.FromGlobalOffset("22");
        ...
        public async Task ReadEventsFromPartitionAsyncRespectsWaitTimeWhenEmittingEvents()
        {
            ...
            await foreach (PartitionEvent partitionEvent in consumer.ReadEventsFromPartitionAsync("0", EventPosition.FromGlobalOffset("12"), options, cancellation.Token))
            {
                receivedEvents.Add(partitionEvent.Data);
        ...
        public void ReadEventsFromPartitionAsyncPropagatesExceptions(Type exceptionType)
        {
            ...
            Assert.That(async () =>
            {
                await foreach (PartitionEvent partitionEvent in consumer.ReadEventsFromPartitionAsync("0", EventPosition.FromGlobalOffset("2"), cancellation.Token))
                {
                    ++receivedEvents;
                    break;
                }
        ...
        public async Task ReadEventsFromPartitionAsyncSetsThePartitionContext()
        {
            ...
            await foreach (PartitionEvent partitionEvent in consumer.ReadEventsFromPartitionAsync(expectedPartition, EventPosition.FromGlobalOffset("12"), cancellation.Token))
            {
