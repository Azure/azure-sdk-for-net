...
namespace Azure.Messaging.EventHubs.Tests
{
    ...
    public class EventHubsModelFactoryTests
    {
        ...
        /// <summary>
        ///   Verifies functionality of the <see cref="EventHubsModelFactory.PartitionProperties(string, string, bool, long, string, long, long, string, DateTimeOffset)" />
        ///   method.
        /// </summary>
        ///
        [Test]
        public void PartitionPropertiesInitializesProperties()
        {
            ...
            var beginningReplicationSegment = "5";
            ...
            var properties = EventHubsModelFactory.PartitionProperties(eventHubName, partitionId, isEmpty, beginningSequenceNumber, beginningReplicationSegment, lastSequenceNumber, lastOffset, lastReplicationSegment, lastEnqueuedTime);
            ...
            Assert.That(properties.BeginningReplicationSegment, Is.EqualTo(beginningReplicationSegment), "The beginning replication segment should have been set.");
            ...
            Assert.That(properties.LastEnqueuedReplicationSegment, Is.EqualTo(lastReplicationSegment), "The last replication segment should have been set.");
            Assert.That(properties.LastEnqueuedTime, Is.EqualTo(lastEnqueuedTime), "The last enqueue date/time should have been set.");
        }

        /// <summary>
        ///   Verifies functionality of the <see cref="EventHubsModelFactory.PartitionProperties(string, string, bool, long, long, long, DateTimeOffset)" />
        ///   method.
        /// </summary>
        ///
        [Test]
        public void PartitionPropertiesInitializesPropertiesOld()
        {
            var eventHubName = "eventHubName";
            var partitionId = "0";
            var isEmpty = false;
        ...
        /// <summary>
        ///   Verifies functionality of the <see cref="EventHubsModelFactory.PartitionPublishingProperties(bool, long?, short?, int?)" />
        ///   method.
        /// </summary>
        ///
        [Test]
        ...
        ///   method and the <see cref="EventHubsModelFactory.LastEnqueuedEventProperties(long?, long?, string, DateTimeOffset?, DateTimeOffset?)"/> method.
        /// </summary>
        ///
        [Test]
        ...
        public void EventDataInitializesProperties()
        {
            ...
            var eventDataOld = EventHubsModelFactory.EventData(body, properties, systemProperties, partitionKey, sequenceNumber, offset, enqueueTime);
            ...
            Assert.That(eventData.ReplicationSegment, Is.EqualTo(replicationSegment), "The replication segment should have been set.");
            ...
            Assert.That(eventDataOld, Is.Not.Null, "The event should have been created.");
            Assert.That(eventDataOld.EventBody.ToString(), Is.EqualTo(body.ToString()), "The event body should have been set.");
            Assert.That(eventDataOld.Properties, Is.EquivalentTo(properties), "The properties should have been set.");
            Assert.That(eventDataOld.SystemProperties, Is.EquivalentTo(systemProperties), "The system properties should have been set.");
            Assert.That(eventDataOld.PartitionKey, Is.EqualTo(partitionKey), "The partition key should have been set.");
            Assert.That(eventDataOld.SequenceNumber, Is.EqualTo(sequenceNumber), "The sequence number should have been set.");
            Assert.That(eventDataOld.Offset, Is.EqualTo(offset), "The offset should have been set.");
            Assert.That(eventDataOld.EnqueuedTime, Is.EqualTo(enqueueTime), "The sequence number should have been set.");
        }
