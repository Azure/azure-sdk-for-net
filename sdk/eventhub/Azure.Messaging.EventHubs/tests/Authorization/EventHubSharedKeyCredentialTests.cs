...
namespace Azure.Messaging.EventHubs.Tests
{
    ...
    public class EventHubSharedKeyCredentialTests
    {
        ...
        {
            Assert.That(() => new EventHubSharedKeyCredential("key", "value").GetToken(new TokenOptions(new[] { "test" }), default), Throws.InvalidOperationException);
        }
        ...
        {
            Assert.That(async () => await (new EventHubSharedKeyCredential("key", "value").GetTokenAsync(new TokenOptions(new[] { "thing" }), default)), Throws.InvalidOperationException);
        }
