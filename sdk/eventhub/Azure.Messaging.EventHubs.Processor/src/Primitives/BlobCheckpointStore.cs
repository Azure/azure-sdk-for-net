...
namespace Azure.Messaging.EventHubs.Primitives
{
    ...
    public class BlobCheckpointStore : CheckpointStore
    {
        ...
        public override Task UpdateCheckpointAsync(string fullyQualifiedNamespace,
                                                   ...
                                                   CancellationToken cancellationToken) => _checkpointStoreImplementation.UpdateCheckpointAsync(fullyQualifiedNamespace, eventHubName, consumerGroup, partitionId, offset, sequenceNumber, replicationSegment, clientIdentifier, cancellationToken);
    }
}
