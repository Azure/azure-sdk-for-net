...
#pragma warning restore CA1810
        ...
        /// <param name="globalOffset">The global offset associated with the checkpoint.</param>
        ...
        partial void UpdateCheckpointError(string partitionId,
                                           ...
                                           string offset,
                                           Exception exception) =>
            Logger.UpdateCheckpointError(partitionId, fullyQualifiedNamespace, eventHubName, consumerGroup, clientIdentifier, exception.Message, sequenceNumber, globalOffset, offset);
