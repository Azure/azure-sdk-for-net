...
- [Using the `EventProcessorClient` with an ASP.NET hosted service](https://github.com/Azure/azure-sdk-for-net/blob/main/sdk/eventhub/Azure.Messaging.EventHubs.Processor/samples/aspnethostedservice/sample_AspNetCore.md)  
