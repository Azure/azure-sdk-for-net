...
namespace Azure.Management.EventHub
{
    ...
    public partial class NamespacesClient
    {
        ...
        public NamespacesClient(string subscriptionId, TokenCredential tokenCredential, EventHubManagementClientOptions options = null) : this(subscriptionId, "https://management.azure.com", tokenCredential, options)
        {
        }

        /// <summary> Initializes a new instance of NamespacesClient. </summary>
        public NamespacesClient(string subscriptionId, string host, TokenCredential tokenCredential, EventHubManagementClientOptions options = null)
        {
            options ??= new EventHubManagementClientOptions();
            _clientDiagnostics = new ClientDiagnostics(options);
            _pipeline = ManagementPipelineBuilder.Build(tokenCredential, host, options);
            RestClient = new NamespacesRestClient(_clientDiagnostics, _pipeline, subscriptionId: subscriptionId, host: host);
        }
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("NamespacesClient.CreateOrUpdateIpFilterRule");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("NamespacesClient.DeleteIpFilterRule");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("NamespacesClient.GetIpFilterRule");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("NamespacesClient.CreateOrUpdateVirtualNetworkRule");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("NamespacesClient.DeleteVirtualNetworkRule");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("NamespacesClient.GetVirtualNetworkRule");
            scope.Start();
            try
            {
        ...
        public virtual AsyncPageable<IpFilterRule> ListIPFilterRulesAsync(string resourceGroupName, string namespaceName, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("NamespacesClient.ListIPFilterRules");
                scope.Start();
                try
                {
        ...
        public virtual AsyncPageable<VirtualNetworkRule> ListVirtualNetworkRulesAsync(string resourceGroupName, string namespaceName, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("NamespacesClient.ListVirtualNetworkRules");
                scope.Start();
                try
                {
        ...
        public virtual async ValueTask<NamespacesCreateOrUpdateOperation> StartCreateOrUpdateAsync(string resourceGroupName, string namespaceName, EHNamespace parameters, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("NamespacesClient.StartCreateOrUpdate");
            scope.Start();
            try
            {
        ...
        public virtual async ValueTask<NamespacesDeleteOperation> StartDeleteAsync(string resourceGroupName, string namespaceName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("NamespacesClient.StartDelete");
            scope.Start();
            try
            {
