...
namespace Azure.Management.EventHub
{
    ...
    public partial class ConsumerGroupsClient
    {
        ...
        internal ConsumerGroupsClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null)
        {
            RestClient = new ConsumerGroupsRestClient(clientDiagnostics, pipeline, subscriptionId, endpoint);
