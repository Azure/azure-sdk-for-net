...
namespace Azure.Management.EventHub
{
    ...
    public partial class ClustersClient
    {
        ...
        internal ClustersRestClient RestClient { get; }
        ...
        public ClustersClient(string subscriptionId, TokenCredential tokenCredential, EventHubManagementClientOptions options = null) : this(subscriptionId, "https://management.azure.com", tokenCredential, options)
        {
        }

        /// <summary> Initializes a new instance of ClustersClient. </summary>
        public ClustersClient(string subscriptionId, string host, TokenCredential tokenCredential, EventHubManagementClientOptions options = null)
        {
            options ??= new EventHubManagementClientOptions();
            _clientDiagnostics = new ClientDiagnostics(options);
            _pipeline = ManagementPipelineBuilder.Build(tokenCredential, host, options);
            RestClient = new ClustersRestClient(_clientDiagnostics, _pipeline, subscriptionId: subscriptionId, host: host);
        }
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("ClustersClient.ListAvailableClusters");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("ClustersClient.Get");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("ClustersClient.ListNamespaces");
            scope.Start();
            try
            {
        ...
        public virtual AsyncPageable<Cluster> ListByResourceGroupAsync(string resourceGroupName, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("ClustersClient.ListByResourceGroup");
                scope.Start();
                try
                {
        ...
        public virtual async ValueTask<ClustersPutOperation> StartPutAsync(string resourceGroupName, string clusterName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("ClustersClient.StartPut");
            scope.Start();
            try
            {
        ...
        public virtual async ValueTask<ClustersPatchOperation> StartPatchAsync(string resourceGroupName, string clusterName, Cluster parameters, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("ClustersClient.StartPatch");
            scope.Start();
            try
            {
        ...
        public virtual async ValueTask<ClustersDeleteOperation> StartDeleteAsync(string resourceGroupName, string clusterName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("ClustersClient.StartDelete");
            scope.Start();
            try
            {
