...
namespace Azure.Messaging.EventHubs
{
    ...
    internal class Resources
    {
        ...
        /// <summary>
        ///   Looks up a localized string similar to WARNING: A processor for a geo-replication-enabled Event Hub is trying to write a checkpoint without a global offset.  Readers of geo-replicated Event Hubs cannot be positioned without a global offset..
        /// </summary>
        internal static string ProcessorAttemptingToWriteCheckpointWithoutGlobalOffset
        {
            get
            {
                return ResourceManager.GetString("ProcessorLoadBalancingCycleSlowMask", resourceCulture);
