...
namespace Azure.Messaging.EventHubs.Primitives
{
    ...
    internal sealed partial class BlobCheckpointStoreInternal
    {
        ...
        /// <param name="globalOffset">The global offset associated with this checkpoint.</param>
        ...
        partial void UpdateCheckpointError(string partitionId,
                                           ...
                                           string offset,
                                           Exception exception) =>
            Logger.UpdateCheckpointError(partitionId, fullyQualifiedNamespace, eventHubName, consumerGroup, clientIdentifier, sequenceNumber, globalOffset, offset, exception.Message);
        ...
        partial void UpdateCheckpointComplete(string partitionId,
                                              ...
                                              string globalOffset,
                                              string offset) =>
            Logger.UpdateCheckpointComplete(partitionId, fullyQualifiedNamespace, eventHubName, consumerGroup, clientIdentifier, sequenceNumber, globalOffset, offset);
        ...
        partial void UpdateCheckpointStart(string partitionId,
                                           ...
                                           string globalOffset,
                                           string offset) =>
            Logger.UpdateCheckpointStart(partitionId, fullyQualifiedNamespace, eventHubName, consumerGroup, clientIdentifier, sequenceNumber, globalOffset, offset);
        ...
        /// <summary>
        ///   Indicates that a <see cref="BlobCheckpointStore" /> was created.
        /// </summary>
        ///
        ...
        /// <param name="consumerGroup">The name of the consumer group the checkpoint is associated with.</param>
        /// <param name="partitionId">The partition id the specific checkpoint is associated with.</param>
        /// <param name="clientIdentifier">The unique identifier of the Event Hub client that wrote this checkpoint.</param>
