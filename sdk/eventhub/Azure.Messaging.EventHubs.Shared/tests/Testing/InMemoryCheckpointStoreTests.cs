...
namespace Azure.Messaging.EventHubs.Tests
{
    ...
    public class InMemoryCheckpointStoreTests
    {
        ...
        public async Task CheckpointUpdateDoesNotInterfereWithOtherConsumerGroups()
        {
            ...
            await storageManager.UpdateCheckpointAsync(new EventProcessorCheckpoint("namespace", "eventHubName", "consumerGroup1", "partitionId", "Id", EventPosition.FromOffset(10, 20)));
            await storageManager.UpdateCheckpointAsync(new EventProcessorCheckpoint("namespace", "eventHubName", "consumerGroup2", "partitionId", "Id", EventPosition.FromOffset(10, 20)));
        ...
        public async Task CheckpointUpdateDoesNotInterfereWithOtherEventHubs()
        {
            ...
            await storageManager.UpdateCheckpointAsync(new EventProcessorCheckpoint("namespace", "eventHubName1", "consumerGroup", "partitionId", "Id", EventPosition.FromOffset(10, 20)));
            await storageManager.UpdateCheckpointAsync(new EventProcessorCheckpoint("namespace", "eventHubName2", "consumerGroup", "partitionId", "Id", EventPosition.FromOffset(10, 20)));
        ...
        public async Task CheckpointUpdateDoesNotInterfereWithOtherNamespaces()
        {
            ...
            await storageManager.UpdateCheckpointAsync(new EventProcessorCheckpoint("namespace1", "eventHubName", "consumerGroup", "partitionId", "Id", EventPosition.FromOffset(10, 20)));
            await storageManager.UpdateCheckpointAsync(new EventProcessorCheckpoint("namespace2", "eventHubName", "consumerGroup", "partitionId", "Id", EventPosition.FromOffset(10, 20)));
        ...
        public async Task CheckpointUpdateDoesNotInterfereWithOtherPartitions()
        {
            ...
            await storageManager.UpdateCheckpointAsync(new EventProcessorCheckpoint("namespace", "eventHubName", "consumerGroup", "partitionId1", "Id", EventPosition.FromOffset(10, 20)));
            await storageManager.UpdateCheckpointAsync(new EventProcessorCheckpoint("namespace", "eventHubName", "consumerGroup", "partitionId2", "Id", EventPosition.FromOffset(10, 20)));
