...
namespace Azure.Messaging.EventHubs.Tests
{
    ...
    public class InMemoryCheckpointStoreTests
    {
        ...
        public async Task CheckpointUpdateDoesNotInterfereWithOtherConsumerGroups()
        {
            ...
            await storageManager.UpdateCheckpointAsync("namespace", "eventHubName", "consumerGroup1", "partitionId", "Id", new CheckpointStartingPosition(10, 20));
            await storageManager.UpdateCheckpointAsync("namespace", "eventHubName", "consumerGroup2", "partitionId", "Id", new CheckpointStartingPosition(10, 20));
        ...
        public async Task CheckpointUpdateDoesNotInterfereWithOtherEventHubs()
        {
            ...
            await storageManager.UpdateCheckpointAsync("namespace", "eventHubName1", "consumerGroup", "partitionId", "Id", new CheckpointStartingPosition(10, 20));
            await storageManager.UpdateCheckpointAsync("namespace", "eventHubName2", "consumerGroup", "partitionId", "Id", new CheckpointStartingPosition(10, 20));
        ...
        public async Task CheckpointUpdateDoesNotInterfereWithOtherNamespaces()
        {
            ...
            await storageManager.UpdateCheckpointAsync("namespace1", "eventHubName", "consumerGroup", "partitionId", "Id", new CheckpointStartingPosition(10, 20));
            await storageManager.UpdateCheckpointAsync("namespace2", "eventHubName", "consumerGroup", "partitionId", "Id", new CheckpointStartingPosition(10, 20));
        ...
        public async Task CheckpointUpdateDoesNotInterfereWithOtherPartitions()
        {
            ...
            await storageManager.UpdateCheckpointAsync("namespace", "eventHubName", "consumerGroup", "partitionId1", "Id", new CheckpointStartingPosition(10, 20));
            await storageManager.UpdateCheckpointAsync("namespace", "eventHubName", "consumerGroup", "partitionId2", "Id", new CheckpointStartingPosition(10, 20));
