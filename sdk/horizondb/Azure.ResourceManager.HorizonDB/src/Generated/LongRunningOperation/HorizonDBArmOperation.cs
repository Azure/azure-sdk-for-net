...
{
    internal partial class HorizonDBArmOperation : ArmOperation
    {
        ...
        internal HorizonDBArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal HorizonDBArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
