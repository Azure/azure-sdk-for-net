...
{
    /// <summary></summary>
    internal partial class HorizonDBReplicaResourceOperationSource : IOperationSource<HorizonDBReplicaResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal HorizonDBReplicaResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
