...
{
    internal partial class HorizonDBArmOperation<T> : ArmOperation<T>
    {
        ...
        /// <summary> Initializes a new instance of HorizonDBArmOperation for mocking. </summary>
        protected HorizonDBArmOperation()
        {
        }
        ...
        internal HorizonDBArmOperation(Response<T> response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal HorizonDBArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
