...
namespace Azure.ResourceManager.HorizonDB
{
    ...
    public partial class HorizonDBFirewallRuleData : ResourceData
    {
        ...
        internal HorizonDBFirewallRuleData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, HorizonDBFirewallRuleProperties properties, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, name, resourceType, systemData)
        {
