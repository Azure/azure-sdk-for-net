...
namespace Azure.ResourceManager.HorizonDB
{
    ...
    public partial class HorizonDBReplicaResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<HorizonDBReplicaResource>> UpdateAsync(WaitUntil waitUntil, HorizonDBReplicaData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _horizonDBReplicasRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, HorizonDBReplicaData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                HorizonDBArmOperation<HorizonDBReplicaResource> operation = new HorizonDBArmOperation<HorizonDBReplicaResource>(
                    new HorizonDBReplicaResourceOperationSource(Client),
                    _horizonDBReplicasClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<HorizonDBReplicaResource> Update(WaitUntil waitUntil, HorizonDBReplicaData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
