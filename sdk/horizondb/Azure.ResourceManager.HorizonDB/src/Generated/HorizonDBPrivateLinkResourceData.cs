...
namespace Azure.ResourceManager.HorizonDB
{
    ...
    public partial class HorizonDBPrivateLinkResourceData : ResourceData
    {
        ...
        internal HorizonDBPrivateLinkResourceData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, HorizonDBPrivateLinkResourceProperties properties, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, name, resourceType, systemData)
        {
        ...
        public HorizonDBPrivateLinkResourceProperties Properties { get; }
    }
}
