...
namespace Azure.ResourceManager.HorizonDB
{
    ...
    public partial class HorizonDBClusterData : TrackedResourceData
    {
        ...
        /// <summary> Initializes a new instance of <see cref="HorizonDBClusterData"/>. </summary>
        ...
        internal HorizonDBClusterData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, HorizonDBClusterProperties properties, string name0, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, name, resourceType, systemData, tags, location)
        {
        ...
        /// <summary> The name of the HorizonDB cluster. </summary>
