...
namespace Azure.ResourceManager.HorizonDB.Models
{
    ...
    internal partial class PrivateEndpointConnectionResourceListResult
    {
        ...
        internal PrivateEndpointConnectionResourceListResult(IEnumerable<PrivateEndpointConnectionResourceData> value)
        {
            Value = value.ToList();
        }
        ...
        internal PrivateEndpointConnectionResourceListResult(IList<PrivateEndpointConnectionResourceData> value, Uri nextLink, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            NextLink = nextLink;
        ...
        public IList<PrivateEndpointConnectionResourceData> Value { get; }
