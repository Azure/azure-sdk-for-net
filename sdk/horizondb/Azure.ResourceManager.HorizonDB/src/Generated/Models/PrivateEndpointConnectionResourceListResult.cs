...
namespace Azure.ResourceManager.HorizonDB.Models
{
    ...
    internal partial class PrivateEndpointConnectionResourceListResult
    {
        ...
        internal PrivateEndpointConnectionResourceListResult(IEnumerable<HorizonDbPrivateEndpointConnectionData> value)
        {
            Value = value.ToList();
        }
        ...
        internal PrivateEndpointConnectionResourceListResult(IList<HorizonDbPrivateEndpointConnectionData> value, Uri nextLink, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            NextLink = nextLink;
        ...
        public IList<HorizonDbPrivateEndpointConnectionData> Value { get; }
