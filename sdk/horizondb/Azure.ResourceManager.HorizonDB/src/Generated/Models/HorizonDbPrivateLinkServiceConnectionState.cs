...
namespace Azure.ResourceManager.HorizonDb.Models
{
    ...
    public partial class HorizonDbPrivateLinkServiceConnectionState
    {
        ...
        /// <summary> Initializes a new instance of <see cref="HorizonDbPrivateLinkServiceConnectionState"/>. </summary>
        ...
        internal HorizonDbPrivateLinkServiceConnectionState(HorizonDbPrivateEndpointServiceConnectionStatus? status, string description, string actionsRequired, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Status = status;
        ...
        public HorizonDbPrivateEndpointServiceConnectionStatus? Status { get; set; }
