...
namespace Azure.ResourceManager.HorizonDB
{
    internal partial class HorizonDBPrivateEndpointConnectionsGetAllAsyncCollectionResultOfT : AsyncPageable<HorizonDBPrivateEndpointConnectionData>
    {
        ...
        public HorizonDBPrivateEndpointConnectionsGetAllAsyncCollectionResultOfT(HorizonDBPrivateEndpointConnections client, Guid subscriptionId, string resourceGroupName, string clusterName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
