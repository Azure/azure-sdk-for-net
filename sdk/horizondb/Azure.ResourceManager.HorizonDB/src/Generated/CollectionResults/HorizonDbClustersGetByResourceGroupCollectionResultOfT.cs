...
namespace Azure.ResourceManager.HorizonDB
{
    internal partial class HorizonDBClustersGetByResourceGroupCollectionResultOfT : Pageable<HorizonDBClusterData>
    {
        ...
        public HorizonDBClustersGetByResourceGroupCollectionResultOfT(HorizonDBClusters client, Guid subscriptionId, string resourceGroupName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
