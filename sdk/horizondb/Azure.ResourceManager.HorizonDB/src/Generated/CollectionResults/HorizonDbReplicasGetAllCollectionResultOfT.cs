...
{
    internal partial class HorizonDbReplicasGetAllCollectionResultOfT : Pageable<HorizonDbReplicaData>
    {
        ...
        /// <returns> The pages of HorizonDbReplicasGetAllCollectionResultOfT as an enumerable collection. </returns>
        public override IEnumerable<Page<HorizonDbReplicaData>> AsPages(string continuationToken, int? pageSizeHint)
        {
