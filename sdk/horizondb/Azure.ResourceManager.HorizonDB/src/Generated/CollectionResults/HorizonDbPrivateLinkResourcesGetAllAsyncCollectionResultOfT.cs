...
{
    internal partial class HorizonDbPrivateLinkResourcesGetAllAsyncCollectionResultOfT : AsyncPageable<HorizonDbPrivateLinkResourceData>
    {
        ...
        /// <summary> Initializes a new instance of HorizonDbPrivateLinkResourcesGetAllAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        /// <summary> Gets the pages of HorizonDbPrivateLinkResourcesGetAllAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of HorizonDbPrivateLinkResourcesGetAllAsyncCollectionResultOfT as an enumerable collection. </returns>
        public override async IAsyncEnumerable<Page<HorizonDbPrivateLinkResourceData>> AsPages(string continuationToken, int? pageSizeHint)
        {
