...
namespace Azure.ResourceManager.HorizonDB
{
    internal partial class HorizonDBReplicasGetAllAsyncCollectionResultOfT : AsyncPageable<HorizonDBReplicaData>
    {
        ...
        public HorizonDBReplicasGetAllAsyncCollectionResultOfT(HorizonDBReplicas client, Guid subscriptionId, string resourceGroupName, string clusterName, string poolName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
