...
namespace Azure.ResourceManager.HorizonDB
{
    internal partial class HorizonDBClustersGetBySubscriptionCollectionResultOfT : Pageable<HorizonDBClusterData>
    {
        ...
        public HorizonDBClustersGetBySubscriptionCollectionResultOfT(HorizonDBClusters client, Guid subscriptionId, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
