...
namespace Azure.ResourceManager.HorizonDB
{
    internal partial class HorizonDBPrivateLinkResourcesGetAllCollectionResultOfT : Pageable<HorizonDBPrivateLinkResourceData>
    {
        ...
        public HorizonDBPrivateLinkResourcesGetAllCollectionResultOfT(HorizonDBPrivateLinkResources client, Guid subscriptionId, string resourceGroupName, string clusterName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
