...
namespace Azure.ResourceManager.HorizonDB
{
    internal partial class HorizonDBParameterGroupsGetBySubscriptionAsyncCollectionResultOfT : AsyncPageable<HorizonDBParameterGroupData>
    {
        ...
        public HorizonDBParameterGroupsGetBySubscriptionAsyncCollectionResultOfT(HorizonDBParameterGroups client, Guid subscriptionId, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
