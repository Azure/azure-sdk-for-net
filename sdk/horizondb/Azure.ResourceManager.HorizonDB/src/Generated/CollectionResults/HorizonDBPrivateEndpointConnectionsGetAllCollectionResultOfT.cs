...
namespace Azure.ResourceManager.HorizonDB
{
    internal partial class HorizonDBPrivateEndpointConnectionsGetAllCollectionResultOfT : Pageable<HorizonDBPrivateEndpointConnectionData>
    {
        ...
        /// <summary> Initializes a new instance of HorizonDBPrivateEndpointConnectionsGetAllCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public HorizonDBPrivateEndpointConnectionsGetAllCollectionResultOfT(HorizonDBPrivateEndpointConnections client, Guid subscriptionId, string resourceGroupName, string clusterName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of HorizonDBPrivateEndpointConnectionsGetAllCollectionResultOfT as an enumerable collection. </summary>
