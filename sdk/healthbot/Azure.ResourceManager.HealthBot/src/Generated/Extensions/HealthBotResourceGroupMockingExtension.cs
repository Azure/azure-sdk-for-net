...
namespace Azure.ResourceManager.HealthBot.Mocking
{
    ...
    internal partial class HealthBotResourceGroupMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="HealthBotResourceGroupMockingExtension"/> class for mocking. </summary>
        protected HealthBotResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="HealthBotResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal HealthBotResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
