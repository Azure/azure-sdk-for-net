...
namespace Azure.ResourceManager.HealthBot.Mocking
{
    ...
    public partial class HealthBotSubscriptionMockingExtension : ArmResource
    {
        private ClientDiagnostics _healthBotBotsClientDiagnostics;
        private BotsRestOperations _healthBotBotsRestClient;

        /// <summary> Initializes a new instance of the <see cref="HealthBotSubscriptionMockingExtension"/> class for mocking. </summary>
        protected HealthBotSubscriptionMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="HealthBotSubscriptionMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal HealthBotSubscriptionMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<HealthBotResource> GetHealthBotsAsync(CancellationToken cancellationToken = default)
        {
            ...
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new HealthBotResource(Client, HealthBotData.DeserializeHealthBotData(e)), HealthBotBotsClientDiagnostics, Pipeline, "HealthBotSubscriptionMockingExtension.GetHealthBots", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<HealthBotResource> GetHealthBots(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => HealthBotBotsRestClient.CreateListRequest(Id.SubscriptionId);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => HealthBotBotsRestClient.CreateListNextPageRequest(nextLink, Id.SubscriptionId);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new HealthBotResource(Client, HealthBotData.DeserializeHealthBotData(e)), HealthBotBotsClientDiagnostics, Pipeline, "HealthBotSubscriptionMockingExtension.GetHealthBots", "value", "nextLink", cancellationToken);
        }
    }
}
