...
using Azure.ResourceManager.HealthBot.Testing;
...
namespace Azure.ResourceManager.HealthBot
{
    ...
    {
        private static HealthBotResourceGroupResourceExtension GetHealthBotResourceGroupResourceExtension(ArmResource resource)
        {
            return resource.GetCachedClient(client =>
            {
                return new HealthBotResourceGroupResourceExtension(client, resource.Id);
            });
        }

        private static HealthBotResourceGroupResourceExtension GetHealthBotResourceGroupResourceExtension(ArmClient client, ResourceIdentifier scope)
        {
            return client.GetResourceClient(() =>
            {
                return new HealthBotResourceGroupResourceExtension(client, scope);
            });
        }

        private static HealthBotSubscriptionResourceExtension GetHealthBotSubscriptionResourceExtension(ArmResource resource)
        {
            return resource.GetCachedClient(client =>
            {
                return new HealthBotSubscriptionResourceExtension(client, resource.Id);
            });
        }

        private static HealthBotSubscriptionResourceExtension GetHealthBotSubscriptionResourceExtension(ArmClient client, ResourceIdentifier scope)
        {
            return client.GetResourceClient(() =>
            {
                return new HealthBotSubscriptionResourceExtension(client, scope);
            });
        }
        ...
        {
            return GetHealthBotResourceGroupResourceExtension(resourceGroupResource).GetHealthBots();
        }
        ...
        {
            return GetHealthBotSubscriptionResourceExtension(subscriptionResource).GetHealthBotsAsync(cancellationToken);
        }
        ...
        {
            return GetHealthBotSubscriptionResourceExtension(subscriptionResource).GetHealthBots(cancellationToken);
        }
    }
}
