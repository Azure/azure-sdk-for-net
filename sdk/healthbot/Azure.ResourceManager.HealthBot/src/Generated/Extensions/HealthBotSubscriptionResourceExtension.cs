...
namespace Azure.ResourceManager.HealthBot.Testing
{
    /// <summary> A class to add extension methods to SubscriptionResource. </summary>
    public partial class HealthBotSubscriptionResourceExtension : ArmResource
    {
        private ClientDiagnostics _healthBotBotsClientDiagnostics;
        private BotsRestOperations _healthBotBotsRestClient;

        /// <summary> Initializes a new instance of the <see cref="HealthBotSubscriptionResourceExtension"/> class for mocking. </summary>
        protected HealthBotSubscriptionResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="HealthBotSubscriptionResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal HealthBotSubscriptionResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<HealthBotResource> GetHealthBotsAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new HealthBotResource(Client, HealthBotData.DeserializeHealthBotData(e)), HealthBotBotsClientDiagnostics, Pipeline, "HealthBotSubscriptionResourceExtension.GetHealthBots", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<HealthBotResource> GetHealthBots(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => HealthBotBotsRestClient.CreateListRequest(Id.SubscriptionId);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => HealthBotBotsRestClient.CreateListNextPageRequest(nextLink, Id.SubscriptionId);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new HealthBotResource(Client, HealthBotData.DeserializeHealthBotData(e)), HealthBotBotsClientDiagnostics, Pipeline, "HealthBotSubscriptionResourceExtension.GetHealthBots", "value", "nextLink", cancellationToken);
        }
    }
}
