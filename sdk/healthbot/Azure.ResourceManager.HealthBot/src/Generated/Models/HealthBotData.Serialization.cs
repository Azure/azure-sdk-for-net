...
namespace Azure.ResourceManager.HealthBot
{
    public partial class HealthBotData : IUtf8JsonSerializable, IJsonModel<HealthBotData>
    {
        ...
        void IJsonModel<HealthBotData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(HealthBotData)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<HealthBotData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(HealthBotData)} does not support '{options.Format}' format.");
            }
        }
