...
namespace Azure.ResourceManager.HealthBot.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HealthBotPatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<HealthBotPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<HealthBotPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<HealthBotPatch>)} interface");
            }
        ...
        string IPersistableModel<HealthBotPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
