...
namespace Azure.ResourceManager.HealthBot.Models
{
    ...
    public partial class HealthBotKeyVaultProperties
    {
        ...
        internal HealthBotKeyVaultProperties(string keyName, string keyVersion, Uri keyVaultUri, string userIdentity, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            KeyName = keyName;
