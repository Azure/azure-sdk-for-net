...
namespace Azure.ResourceManager.HealthBot
{
    internal partial class HealthBotArmOperation<T> : ArmOperation<T>
    {
        ...
        internal HealthBotArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
