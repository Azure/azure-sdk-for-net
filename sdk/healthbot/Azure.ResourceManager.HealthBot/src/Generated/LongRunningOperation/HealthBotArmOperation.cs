...
namespace Azure.ResourceManager.HealthBot
{
    internal partial class HealthBotArmOperation : ArmOperation
    {
        ...
        internal HealthBotArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
