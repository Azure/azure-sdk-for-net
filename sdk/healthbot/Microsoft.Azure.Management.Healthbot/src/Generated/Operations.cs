...
namespace Microsoft.Azure.Management.Healthbot
{
    ...
    /// </summary>
    internal partial class Operations : IServiceOperations<healthbotClient>, IOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal Operations(healthbotClient client)
        {
            if (client == null)
            {
        ...
        /// <summary>
        /// Gets a reference to the healthbotClient
        /// </summary>
        public healthbotClient Client { get; private set; }
        ...
        public async Task<AzureOperationResponse<IPage<OperationDetail>>> ListWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "providers/Microsoft.HealthBot/operations").ToString();
