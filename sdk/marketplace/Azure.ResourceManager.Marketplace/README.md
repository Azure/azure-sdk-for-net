# Azure Marketplace Management client library for .NET
...
Install the Azure Marketplace management library for .NET with [NuGet](https://www.nuget.org/):

```dotnetcli
dotnet add package Azure.ResourceManager.Marketplace --prerelease
```
