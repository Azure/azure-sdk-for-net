...
namespace Azure.ResourceManager.Marketplace.Samples
{
    public partial class Sample_PrivateStoreOfferResource
    {
        ...
        public async Task Delete_DeletePrivateStoreOffer()
        {
            ...
            // invoke the operation
            await privateStoreOffer.DeleteAsync(WaitUntil.Completed).ConfigureAwait(false);
...
PlanIds = {"log4web"},
            ...
            PrivateStoreOfferResource result = await privateStoreOffer.UpsertOfferWithMultiContextAsync(content);
        ...
        public async Task Delete_PostPrivateStoreCollectionOffer()
        {
            ...
            // invoke the operation
            await privateStoreOffer.DeleteAsync().ConfigureAwait(false);
