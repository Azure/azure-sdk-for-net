...
namespace Azure.ResourceManager.Marketplace.Samples
{
    public partial class Sample_PrivateStoreResource
    {
        ...
        public async Task Delete_DeletePrivateStores()
        {
            ...
            // invoke the operation
            await privateStore.DeleteAsync(WaitUntil.Completed).ConfigureAwait(false);
        ...
        public async Task Update_PrivateStoresUpdate()
        {
            ...
            await privateStore.UpdateAsync(WaitUntil.Completed, data).ConfigureAwait(false);
        ...
        public async Task QueryUserOffers_QueryUserOffers()
        {
            ...
            await foreach (PrivateStoreOfferResult item in privateStore.QueryUserOffersAsync(content))
            {
                Console.WriteLine($"Succeeded: {item}");
            }
        ...
        public async Task FetchCollectionsToSubscriptionsMapping_CollectionsToSubscriptionsMapping()
        {
            ...
            CollectionsToSubscriptionsMappingResult result = await privateStore.FetchCollectionsToSubscriptionsMappingAsync(content);
        ...
        public async Task QueryApprovedPlans_QueryApprovedPlans()
        {
            ...
            QueryApprovedPlansResult result = await privateStore.QueryApprovedPlansAsync(content);
        ...
        public async Task PerformActionOnBulkCollections_BulkCollectionsAction()
        {
            ...
            BulkCollectionsActionResult result = await privateStore.PerformActionOnBulkCollectionsAsync(content);
        ...
        public async Task AcknowledgeOfferNotification_AcknowledgeNotification()
        {
            ...
            await privateStore.AcknowledgeOfferNotificationAsync(offerId, content).ConfigureAwait(false);
        ...
        public async Task QueryUserRules_QueryUserRules()
        {
            ...
            await foreach (MarketplaceRule item in privateStore.QueryUserRulesAsync(content))
            {
                Console.WriteLine($"Succeeded: {item}");
            }
