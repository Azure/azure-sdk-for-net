...
This release is the first stable release of the Marketplace Management client library.

### Breaking Changes

Polishing since last public beta release:
- Prepended `PrivateStore` / `Marketplace` prefix to all single / simple model names.
...
The package name has been changed from `Microsoft.Azure.Management.Marketplace` to `Azure.ResourceManager.Marketplace`.
