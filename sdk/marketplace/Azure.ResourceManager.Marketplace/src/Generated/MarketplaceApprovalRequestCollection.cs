...
namespace Azure.ResourceManager.Marketplace
{
    ...
    public partial class MarketplaceApprovalRequestCollection : ArmCollection, IEnumerable<MarketplaceApprovalRequestResource>, IAsyncEnumerable<MarketplaceApprovalRequestResource>
    {
        ...
        public virtual AsyncPageable<MarketplaceApprovalRequestResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, null, e => { var data = MarketplaceApprovalRequestData.DeserializeMarketplaceApprovalRequestData(e); return new MarketplaceApprovalRequestResource(Client, data, data.Id); }, _marketplaceApprovalRequestPrivateStoreClientDiagnostics, Pipeline, "MarketplaceApprovalRequestCollection.GetAll", "value", null, cancellationToken);
        }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _marketplaceApprovalRequestPrivateStoreRestClient.CreateGetApprovalRequestsListRequest(Guid.Parse(Id.Name));
            return PageableHelpers.CreatePageable(FirstPageRequest, null, e => { var data = MarketplaceApprovalRequestData.DeserializeMarketplaceApprovalRequestData(e); return new MarketplaceApprovalRequestResource(Client, data, data.Id); }, _marketplaceApprovalRequestPrivateStoreClientDiagnostics, Pipeline, "MarketplaceApprovalRequestCollection.GetAll", "value", null, cancellationToken);
        }
