    ...
    public partial class PrivateStoreOfferResource : ArmResource
    {
        ...
        public virtual async Task<Response> DeleteAsync(PrivateStoreOperation? payload = default, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _privateStoreCollectionOfferRestClient.CreateDeleteRequest(Guid.Parse(Id.Parent.Parent.Name), Guid.Parse(Id.Parent.Name), Id.Name, payload != null ? RequestContent.Create(payload?.ToString()) : null, context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
