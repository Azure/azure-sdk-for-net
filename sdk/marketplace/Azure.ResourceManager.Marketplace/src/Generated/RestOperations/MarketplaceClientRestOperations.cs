...
namespace Azure.ResourceManager.Marketplace
{
    internal partial class MarketplaceClient
    {
        ...
        public MarketplaceClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string applicationId, Uri endpoint, string apiVersion)
        {
            ClientDiagnostics = clientDiagnostics;
            _endpoint = endpoint;
            Pipeline = pipeline;
            _apiVersion = apiVersion;
            _userAgent = new TelemetryDetails(typeof(MarketplaceClient).Assembly, applicationId);
        }
