...
namespace Azure.ResourceManager.Marketplace.Mocking
{
    ...
    internal partial class MarketplaceTenantMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="MarketplaceTenantMockingExtension"/> class for mocking. </summary>
        protected MarketplaceTenantMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MarketplaceTenantMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MarketplaceTenantMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
