...
namespace Azure.ResourceManager.Marketplace
{
    ...
    public partial class MarketplaceApprovalRequestData : ResourceData
    {
        ...
        internal MarketplaceApprovalRequestData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string offerId, string offerDisplayName, string publisherId, IList<PrivateStorePlanDetails> plansDetails, bool? isClosed, long? messageCode, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
            OfferId = offerId;
