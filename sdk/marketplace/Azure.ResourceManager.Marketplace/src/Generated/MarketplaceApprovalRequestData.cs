...
namespace Azure.ResourceManager.Marketplace
{
    ...
    public partial class MarketplaceApprovalRequestData : ResourceData
    {
        ...
        /// </param>
        internal MarketplaceApprovalRequestData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string offerId, string offerDisplayName, string publisherId, IList<PlanDetails> plansDetails, bool? isClosed, long? messageCode) : base(id, name, resourceType, systemData)
        {
            OfferId = offerId;
