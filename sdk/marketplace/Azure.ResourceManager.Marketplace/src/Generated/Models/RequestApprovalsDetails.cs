...
namespace Azure.ResourceManager.Marketplace.Models
{
    ...
    public partial class RequestApprovalsDetails
    {
        ...
        internal RequestApprovalsDetails(string offerId, string displayName, string publisherId, long? messageCode, Uri iconUri, IReadOnlyList<PlanNotificationDetails> plans, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            OfferId = offerId;
