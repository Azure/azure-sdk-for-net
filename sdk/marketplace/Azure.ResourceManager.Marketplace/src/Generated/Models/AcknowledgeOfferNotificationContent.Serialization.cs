...
namespace Azure.ResourceManager.Marketplace.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AcknowledgeOfferNotificationContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AcknowledgeOfferNotificationContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AcknowledgeOfferNotificationContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AcknowledgeOfferNotificationContent>)} interface");
            }
        ...
        string IPersistableModel<AcknowledgeOfferNotificationContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
