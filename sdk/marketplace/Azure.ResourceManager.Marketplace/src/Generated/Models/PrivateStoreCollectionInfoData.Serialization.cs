...
namespace Azure.ResourceManager.Marketplace
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PrivateStoreCollectionInfoData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PrivateStoreCollectionInfoData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PrivateStoreCollectionInfoData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PrivateStoreCollectionInfoData>)} interface");
            }
        ...
        string IPersistableModel<PrivateStoreCollectionInfoData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
