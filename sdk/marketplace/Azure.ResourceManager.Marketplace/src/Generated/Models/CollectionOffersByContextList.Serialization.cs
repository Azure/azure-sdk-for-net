...
namespace Azure.ResourceManager.Marketplace.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CollectionOffersByContextList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CollectionOffersByContextList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CollectionOffersByContextList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CollectionOffersByContextList>)} interface");
            }
        ...
        string IPersistableModel<CollectionOffersByContextList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
