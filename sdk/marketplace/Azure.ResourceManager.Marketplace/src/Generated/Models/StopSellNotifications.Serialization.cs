...
namespace Azure.ResourceManager.Marketplace.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StopSellNotifications>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<StopSellNotifications>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<StopSellNotifications>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<StopSellNotifications>)} interface");
            }
        ...
        string IPersistableModel<StopSellNotifications>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
