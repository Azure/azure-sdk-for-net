...
namespace Azure.ResourceManager.Marketplace.Models
{
    ...
    public partial class PrivateStorePlanDetails
    {
        ...
        internal PrivateStorePlanDetails(string planId, PrivateStorePlanStatus? status, BinaryData requestDate, string justification, string subscriptionId, string subscriptionName, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            PlanId = planId;
            Status = status;
