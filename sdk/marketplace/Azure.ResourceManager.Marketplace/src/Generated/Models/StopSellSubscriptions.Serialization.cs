...
namespace Azure.ResourceManager.Marketplace.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StopSellSubscriptions>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<StopSellSubscriptions>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<StopSellSubscriptions>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<StopSellSubscriptions>)} interface");
            }
        ...
        string IPersistableModel<StopSellSubscriptions>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
