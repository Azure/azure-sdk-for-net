...
namespace Azure.ResourceManager.Marketplace.Models
{
    ...
    public partial class QueryApprovedPlansContent
    {
        ...
        internal QueryApprovedPlansContent(string offerId, IList<string> planIds, IList<string> subscriptionIds, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            OfferId = offerId;
            PlanIds = planIds;
