...
namespace Azure.ResourceManager.Marketplace.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TransferOffersContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<TransferOffersContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<TransferOffersContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<TransferOffersContent>)} interface");
            }
        ...
        string IPersistableModel<TransferOffersContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
