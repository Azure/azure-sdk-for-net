...
namespace Azure.ResourceManager.Marketplace.Models
{
    ...
    public partial class TransferOffersContent
    {
        ...
        internal TransferOffersContent(IList<string> targetCollections, string operation, IList<string> offerIdsList, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
