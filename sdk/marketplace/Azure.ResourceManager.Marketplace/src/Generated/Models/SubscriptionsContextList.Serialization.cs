...
namespace Azure.ResourceManager.Marketplace.Models
{
    ...
    {
        internal static SubscriptionsContextList DeserializeSubscriptionsContextList(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
