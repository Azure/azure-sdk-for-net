...
namespace Azure.ResourceManager.Marketplace.Models
{
    ...
    public partial class QueryApprovedPlansDetails
    {
        ...
        internal QueryApprovedPlansDetails(string planId, IReadOnlyList<string> subscriptionIds, bool? allSubscriptions, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            PlanId = planId;
