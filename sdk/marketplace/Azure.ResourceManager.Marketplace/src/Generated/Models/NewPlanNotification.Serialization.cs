...
namespace Azure.ResourceManager.Marketplace.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NewPlanNotification>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NewPlanNotification>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NewPlanNotification>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<NewPlanNotification>)} interface");
            }
        ...
        string IPersistableModel<NewPlanNotification>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
