...
namespace Azure.ResourceManager.Marketplace
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MarketplaceApprovalRequestData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MarketplaceApprovalRequestData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MarketplaceApprovalRequestData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<MarketplaceApprovalRequestData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
