...
namespace Azure.ResourceManager.Marketplace.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TransferOffersResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<TransferOffersResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<TransferOffersResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<TransferOffersResult>)} interface");
            }
        ...
        string IPersistableModel<TransferOffersResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
