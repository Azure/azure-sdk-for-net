...
namespace Azure.ResourceManager.Marketplace.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<QueryApprovalRequestResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<QueryApprovalRequestResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<QueryApprovalRequestResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<QueryApprovalRequestResult>)} interface");
            }
        ...
        string IPersistableModel<QueryApprovalRequestResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
