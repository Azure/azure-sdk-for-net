...
namespace Azure.ResourceManager.Marketplace.Models
{
    ...
    {
        internal static QueryApprovalRequestResult DeserializeQueryApprovalRequestResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
