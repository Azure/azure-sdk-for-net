...
namespace Azure.ResourceManager.Marketplace.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PrivateStoreList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PrivateStoreList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PrivateStoreList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PrivateStoreList>)} interface");
            }
        ...
        string IPersistableModel<PrivateStoreList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
