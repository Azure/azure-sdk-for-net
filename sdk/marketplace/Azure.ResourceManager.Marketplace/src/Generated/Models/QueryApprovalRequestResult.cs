...
namespace Azure.ResourceManager.Marketplace.Models
{
    ...
    public partial class QueryApprovalRequestResult
    {
        ...
        internal QueryApprovalRequestResult(string uniqueOfferId, IReadOnlyDictionary<string, PrivateStorePlanDetails> plansDetails, ETag? eTag, long? messageCode, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
