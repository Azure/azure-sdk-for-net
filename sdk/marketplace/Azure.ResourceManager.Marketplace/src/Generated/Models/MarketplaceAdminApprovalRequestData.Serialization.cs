...
namespace Azure.ResourceManager.Marketplace
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MarketplaceAdminApprovalRequestData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MarketplaceAdminApprovalRequestData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MarketplaceAdminApprovalRequestData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MarketplaceAdminApprovalRequestData>)} interface");
            }
        ...
        string IPersistableModel<MarketplaceAdminApprovalRequestData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
