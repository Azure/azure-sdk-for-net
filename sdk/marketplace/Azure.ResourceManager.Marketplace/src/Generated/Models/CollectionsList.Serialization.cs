...
namespace Azure.ResourceManager.Marketplace.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CollectionsList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CollectionsList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CollectionsList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CollectionsList>)} interface");
            }
        ...
        string IPersistableModel<CollectionsList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
