...
{
    public partial class StopSellOffersPlansNotificationsList : IUtf8JsonSerializable, IJsonModel<StopSellOffersPlansNotificationsList>, IPersistableModel<StopSellOffersPlansNotificationsList>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(StopSellNotifications))
            {
                builder.Append("  stopSellNotifications:");
                builder.AppendLine(" [");
                foreach (var item in StopSellNotifications)
                {
