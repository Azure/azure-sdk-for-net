...
namespace Azure.ResourceManager.Marketplace.Models
{
    ...
    public partial class NewPlanNotification
    {
        ...
        internal NewPlanNotification(string offerId, string displayName, bool? isFuturePlansEnabled, long? messageCode, string icon, IReadOnlyList<PlanNotificationDetails> plans, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            OfferId = offerId;
