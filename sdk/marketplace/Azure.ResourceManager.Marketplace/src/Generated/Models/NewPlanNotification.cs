...
namespace Azure.ResourceManager.Marketplace.Models
{
    ...
    public partial class NewPlanNotification
    {
        ...
        internal NewPlanNotification(string offerId, string displayName, bool? isFuturePlansEnabled, long? messageCode, Uri iconUri, IReadOnlyList<PlanNotificationDetails> plans, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            OfferId = offerId;
