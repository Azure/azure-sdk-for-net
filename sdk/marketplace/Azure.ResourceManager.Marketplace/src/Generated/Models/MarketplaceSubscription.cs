...
namespace Azure.ResourceManager.Marketplace.Models
{
    ...
    public partial class MarketplaceSubscription
    {
        ...
        internal MarketplaceSubscription(string id, string subscriptionId, string displayName, MarketplaceSubscriptionState? state, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
