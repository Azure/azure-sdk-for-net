...
namespace Azure.ResourceManager.Marketplace.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NotificationRecipient>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NotificationRecipient>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NotificationRecipient>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<NotificationRecipient>)} interface");
            }
        ...
        string IPersistableModel<NotificationRecipient>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
