...
namespace Azure.ResourceManager.Marketplace.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CollectionsToSubscriptionsMappingContent>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Properties))
            {
                ...
                ((IJsonModel<CollectionsToSubscriptionsMappingProperties>)Properties).Write(writer, options);
            }
        ...
        internal static CollectionsToSubscriptionsMappingContent DeserializeCollectionsToSubscriptionsMappingContent(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("properties"u8))
                {
                    ...
                    properties = ModelSerializationExtensions.JsonDeserialize<CollectionsToSubscriptionsMappingProperties>(property.Value);
                    continue;
                }
                if (options.Format != "W")
                {
            ...
            return new CollectionsToSubscriptionsMappingContent(properties, serializedAdditionalRawData);
        }
