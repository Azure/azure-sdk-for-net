...
namespace Azure.ResourceManager.Marketplace.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CollectionsToSubscriptionsMappingResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CollectionsToSubscriptionsMappingResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CollectionsToSubscriptionsMappingResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CollectionsToSubscriptionsMappingResult>)} interface");
            }
        ...
        string IPersistableModel<CollectionsToSubscriptionsMappingResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
