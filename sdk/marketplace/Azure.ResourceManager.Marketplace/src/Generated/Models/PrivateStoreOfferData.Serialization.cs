...
namespace Azure.ResourceManager.Marketplace
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PrivateStoreOfferData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PrivateStoreOfferData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PrivateStoreOfferData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PrivateStoreOfferData>)} interface");
            }
        ...
        string IPersistableModel<PrivateStoreOfferData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
