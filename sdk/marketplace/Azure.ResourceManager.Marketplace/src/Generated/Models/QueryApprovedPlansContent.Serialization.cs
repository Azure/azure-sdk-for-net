...
namespace Azure.ResourceManager.Marketplace.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<QueryApprovedPlansContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<QueryApprovedPlansContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<QueryApprovedPlansContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<QueryApprovedPlansContent>)} interface");
            }
        ...
        string IPersistableModel<QueryApprovedPlansContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
