...
namespace Azure.ResourceManager.Marketplace.Models
{
    ...
    public partial class StopSellNotifications
    {
        ...
        internal StopSellNotifications(string offerId, string displayName, bool? isEntire, long? messageCode, Uri iconUri, IReadOnlyList<PlanNotificationDetails> plans, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            OfferId = offerId;
