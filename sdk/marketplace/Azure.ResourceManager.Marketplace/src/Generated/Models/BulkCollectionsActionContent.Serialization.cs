...
namespace Azure.ResourceManager.Marketplace.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BulkCollectionsActionContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<BulkCollectionsActionContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BulkCollectionsActionContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<BulkCollectionsActionContent>)} interface");
            }
        ...
        string IPersistableModel<BulkCollectionsActionContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
