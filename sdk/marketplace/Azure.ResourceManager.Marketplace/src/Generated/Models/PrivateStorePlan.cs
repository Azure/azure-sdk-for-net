...
namespace Azure.ResourceManager.Marketplace.Models
{
    ...
    public partial class PrivateStorePlan
    {
        ...
        internal PrivateStorePlan(string skuId, string planId, string planDisplayName, PrivateStorePlanAccessibility? accessibility, string altStackReference, string stackType, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            SkuId = skuId;
            PlanId = planId;
