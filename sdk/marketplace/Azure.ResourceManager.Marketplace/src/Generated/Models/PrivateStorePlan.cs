...
namespace Azure.ResourceManager.Marketplace.Models
{
    ...
    public partial class PrivateStorePlan
    {
        ...
        internal PrivateStorePlan(string skuId, string planId, string planDisplayName, PrivateStorePlanAccessibility? accessibility, string altStackReference, string stackType, bool? isStopSell, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            SkuId = skuId;
            PlanId = planId;
