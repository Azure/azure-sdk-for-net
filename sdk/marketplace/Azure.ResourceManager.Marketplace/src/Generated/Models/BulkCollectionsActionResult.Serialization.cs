...
namespace Azure.ResourceManager.Marketplace.Models
{
    ...
    {
        internal static BulkCollectionsActionResult DeserializeBulkCollectionsActionResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
