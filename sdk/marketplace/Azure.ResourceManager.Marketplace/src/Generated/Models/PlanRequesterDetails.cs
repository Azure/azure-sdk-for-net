...
namespace Azure.ResourceManager.Marketplace.Models
{
    ...
    public partial class PlanRequesterDetails
    {
        ...
        internal PlanRequesterDetails(string planId, string planDisplayName, IReadOnlyList<PlanRequesterInfo> requesters, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            PlanId = planId;
