...
{
    public partial class PrivateStoreBillingAccountsResult : IUtf8JsonSerializable, IJsonModel<PrivateStoreBillingAccountsResult>, IPersistableModel<PrivateStoreBillingAccountsResult>
    {
        ...
        void IJsonModel<PrivateStoreBillingAccountsResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(PrivateStoreBillingAccountsResult)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(BillingAccounts))
            {
                builder.Append("  billingAccounts:");
                builder.AppendLine(" [");
                foreach (var item in BillingAccounts)
                {
                    if (item == null)
