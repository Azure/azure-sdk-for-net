...
namespace Azure.ResourceManager.Marketplace.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PrivateStoreBillingAccountsResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PrivateStoreBillingAccountsResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PrivateStoreBillingAccountsResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PrivateStoreBillingAccountsResult>)} interface");
            }
        ...
        string IPersistableModel<PrivateStoreBillingAccountsResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
