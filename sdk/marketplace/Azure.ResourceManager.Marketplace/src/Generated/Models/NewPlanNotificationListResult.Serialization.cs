...
{
    public partial class NewPlanNotificationListResult : IUtf8JsonSerializable, IJsonModel<NewPlanNotificationListResult>, IPersistableModel<NewPlanNotificationListResult>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(NewPlansNotifications))
            {
                builder.Append("  newPlansNotifications:");
                builder.AppendLine(" [");
                foreach (var item in NewPlansNotifications)
                {
