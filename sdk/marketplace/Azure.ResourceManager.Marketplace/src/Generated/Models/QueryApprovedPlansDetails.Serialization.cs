...
namespace Azure.ResourceManager.Marketplace.Models
{
    ...
    {
        internal static QueryApprovedPlansDetails DeserializeQueryApprovedPlansDetails(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
