...
namespace Azure.ResourceManager.Marketplace.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<QueryApprovedPlansDetails>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<QueryApprovedPlansDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<QueryApprovedPlansDetails>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<QueryApprovedPlansDetails>)} interface");
            }
        ...
        string IPersistableModel<QueryApprovedPlansDetails>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
