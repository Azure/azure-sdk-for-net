...
namespace Azure.ResourceManager.Marketplace.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<QueryUserOffersContent>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<QueryUserOffersContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<QueryUserOffersContent>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
