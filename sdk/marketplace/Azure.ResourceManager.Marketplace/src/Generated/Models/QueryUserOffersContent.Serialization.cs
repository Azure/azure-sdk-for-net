...
namespace Azure.ResourceManager.Marketplace.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<QueryUserOffersContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<QueryUserOffersContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<QueryUserOffersContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<QueryUserOffersContent>)} interface");
            }
        ...
        string IPersistableModel<QueryUserOffersContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
