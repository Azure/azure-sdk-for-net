...
namespace Microsoft.Azure.Management.Marketplace.Models
{
    ...
    public partial class SingleOperation
    {
        ...
        public SingleOperation(string name = default(string), bool? isDataAction = default(bool?), SingleOperationDisplay display = default(SingleOperationDisplay), string origin = default(string), object properties = default(object))
        {
            Name = name;
