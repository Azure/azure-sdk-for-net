...
{
PassName = AdditionalInformationPassName.OobeSystem,
ComponentName = AdditionalInformationComponentName.MicrosoftWindowsShellSetup,
...
AuxiliarySku = ComputeFleetNetworkInterfaceAuxiliarySku.None,
                    ...
                    NetworkApiVersion = ComputeFleetNetworkApiVersion.TwoThousandTwenty1101,
                },
...
ProtectedSettingsFromKeyVault = new ComputeFleetKeyVaultSecretReference(new Uri("vyhzfkqsqanacgzjthpjoe"),new WritableSubResource()
{
...
"{securityPostureVMExtensionName}"
        ...
        public async Task GetVirtualMachineScaleSets_FleetsListVirtualMachineScaleSets()
        {
            ...
            // invoke the operation and iterate over the result
            await foreach (ComputeFleetVmssData item in computeFleet.GetVirtualMachineScaleSetsAsync())
            {
