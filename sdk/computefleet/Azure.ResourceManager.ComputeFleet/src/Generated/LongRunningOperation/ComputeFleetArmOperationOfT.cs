...
namespace Azure.ResourceManager.ComputeFleet
{
    internal partial class ComputeFleetArmOperation<T> : ArmOperation<T>
    {
        ...
        internal ComputeFleetArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
