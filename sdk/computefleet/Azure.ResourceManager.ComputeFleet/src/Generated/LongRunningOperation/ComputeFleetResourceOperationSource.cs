...
{
    /// <summary></summary>
    internal partial class ComputeFleetResourceOperationSource : IOperationSource<ComputeFleetResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal ComputeFleetResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
