...
namespace Azure.ResourceManager.ComputeFleet
{
    internal partial class ComputeFleetArmOperation : ArmOperation
    {
        ...
        internal ComputeFleetArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
