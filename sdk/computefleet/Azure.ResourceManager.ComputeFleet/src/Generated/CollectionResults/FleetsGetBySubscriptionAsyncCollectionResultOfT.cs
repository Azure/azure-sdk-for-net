...
namespace Azure.ResourceManager.ComputeFleet
{
    internal partial class FleetsGetBySubscriptionAsyncCollectionResultOfT : AsyncPageable<ComputeFleetData>
    {
        ...
        public FleetsGetBySubscriptionAsyncCollectionResultOfT(Fleets client, Guid subscriptionId, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
