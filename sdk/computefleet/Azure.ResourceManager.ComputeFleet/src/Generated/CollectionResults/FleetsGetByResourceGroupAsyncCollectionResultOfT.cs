...
{
    internal partial class FleetsGetByResourceGroupAsyncCollectionResultOfT : AsyncPageable<ComputeFleetData>
    {
        ...
        public override async IAsyncEnumerable<Page<ComputeFleetData>> AsPages(string continuationToken, int? pageSizeHint)
        {
