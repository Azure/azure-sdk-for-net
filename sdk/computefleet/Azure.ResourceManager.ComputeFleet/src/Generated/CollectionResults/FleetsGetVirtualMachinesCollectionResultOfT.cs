...
{
    internal partial class FleetsGetVirtualMachinesCollectionResultOfT : Pageable<ComputeFleetVirtualMachine>
    {
        ...
        /// <summary> Initializes a new instance of FleetsGetVirtualMachinesCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public FleetsGetVirtualMachinesCollectionResultOfT(Fleets client, Guid subscriptionId, string resourceGroupName, string name, string filter, string skipToken, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of FleetsGetVirtualMachinesCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of FleetsGetVirtualMachinesCollectionResultOfT as an enumerable collection. </returns>
        public override IEnumerable<Page<ComputeFleetVirtualMachine>> AsPages(string continuationToken, int? pageSizeHint)
        {
        ...
        private Response GetNextResponse(int? pageSizeHint, Uri nextLink)
        {
            ...
            using DiagnosticScope scope = _client.ClientDiagnostics.CreateScope("MockableComputeFleetResourceGroupResource.GetVirtualMachines");
            scope.Start();
            try
            {
