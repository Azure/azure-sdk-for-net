...
namespace Azure.ResourceManager.ComputeFleet.Models
{
    ...
    public partial class VirtualMachineExtensionProperties
    {
        ...
        internal VirtualMachineExtensionProperties(string forceUpdateTag, string publisher, string virtualMachineExtensionPropertiesType, string typeHandlerVersion, bool? autoUpgradeMinorVersion, bool? enableAutomaticUpgrade, BinaryData settings, BinaryData protectedSettings, string provisioningState, VirtualMachineExtensionInstanceView instanceView, bool? suppressFailures, KeyVaultSecretReference protectedSettingsFromKeyVault, IList<string> provisionAfterExtensions, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
