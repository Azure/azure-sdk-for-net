...
namespace Azure.ResourceManager.ComputeFleet.Models
{
    ...
    public partial class VirtualMachineScaleSetExtensionProperties
    {
        ...
        /// <summary> Initializes a new instance of <see cref="VirtualMachineScaleSetExtensionProperties"/>. </summary>
        ...
        internal VirtualMachineScaleSetExtensionProperties(string forceUpdateTag, string publisher, string virtualMachineScaleSetExtensionPropertiesType, string typeHandlerVersion, bool? autoUpgradeMinorVersion, bool? enableAutomaticUpgrade, BinaryData settings, BinaryData protectedSettings, string provisioningState, IList<string> provisionAfterExtensions, bool? suppressFailures, KeyVaultSecretReference protectedSettingsFromKeyVault, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
