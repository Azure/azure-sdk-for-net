...
namespace Azure.ResourceManager.ComputeFleet.Models
{
    ...
    public partial class VirtualMachineScaleSetExtensionProperties
    {
        ...
        internal VirtualMachineScaleSetExtensionProperties(string forceUpdateTag, string publisher, string virtualMachineScaleSetExtensionPropertiesType, string typeHandlerVersion, bool? autoUpgradeMinorVersion, bool? enableAutomaticUpgrade, IDictionary<string, BinaryData> settings, IDictionary<string, BinaryData> protectedSettings, string provisioningState, IList<string> provisionAfterExtensions, bool? suppressFailures, KeyVaultSecretReference protectedSettingsFromKeyVault, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
