...
namespace Azure.ResourceManager.ComputeFleet.Models
{
    ...
    public partial class ComputeFleetVmssDataDisk : IJsonModel<ComputeFleetVmssDataDisk>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<ComputeFleetVmssDataDisk>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ComputeFleetVmssDataDisk IJsonModel<ComputeFleetVmssDataDisk>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual ComputeFleetVmssDataDisk JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<ComputeFleetVmssDataDisk>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static ComputeFleetVmssDataDisk DeserializeComputeFleetVmssDataDisk(JsonElement element, ModelReaderWriterOptions options)
        {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ComputeFleetVmssDataDisk>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ComputeFleetVmssDataDisk IPersistableModel<ComputeFleetVmssDataDisk>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual ComputeFleetVmssDataDisk PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<ComputeFleetVmssDataDisk>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
