...
namespace Azure.ResourceManager.ComputeFleet.Models
{
    ...
    public partial class VirtualMachineScaleSetExtension
    {
        ...
        internal VirtualMachineScaleSetExtension(ResourceIdentifier id, string name, string virtualMachineScaleSetExtensionType, VirtualMachineScaleSetExtensionProperties properties, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Name = name;
