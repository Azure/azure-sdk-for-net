...
namespace Azure.ResourceManager.ComputeFleet.Models
{
    ...
    /// </summary>
    public partial class ComputeFleetUefiSettings : IJsonModel<ComputeFleetUefiSettings>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<ComputeFleetUefiSettings>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ComputeFleetUefiSettings IJsonModel<ComputeFleetUefiSettings>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual ComputeFleetUefiSettings JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<ComputeFleetUefiSettings>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static ComputeFleetUefiSettings DeserializeComputeFleetUefiSettings(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new ComputeFleetUefiSettings(isSecureBootEnabled, isVTpmEnabled, additionalBinaryDataProperties);
        }

        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ComputeFleetUefiSettings>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ComputeFleetUefiSettings IPersistableModel<ComputeFleetUefiSettings>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual ComputeFleetUefiSettings PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<ComputeFleetUefiSettings>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
