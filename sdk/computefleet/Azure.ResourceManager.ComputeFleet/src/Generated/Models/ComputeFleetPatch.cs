...
namespace Azure.ResourceManager.ComputeFleet.Models
{
    ...
    public partial class ComputeFleetPatch
    {
        ...
        internal ComputeFleetPatch(IDictionary<string, string> tags, ManagedServiceIdentity identity, ResourcePlanUpdate plan, ComputeFleetProperties properties, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Tags = tags;
            Identity = identity;
            Plan = plan;
        ...
        public ResourcePlanUpdate Plan { get; set; }
