...
namespace Azure.ResourceManager.ComputeFleet.Models
{
    ...
    public partial class ComputeFleetVmssExtension
    {
        ...
        internal ComputeFleetVmssExtension(ResourceIdentifier id, string name, string extensionType, ComputeFleetVmssExtensionProperties properties, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Id = id;
            Name = name;
