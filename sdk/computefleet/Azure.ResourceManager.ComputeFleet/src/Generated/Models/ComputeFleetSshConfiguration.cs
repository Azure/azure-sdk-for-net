...
namespace Azure.ResourceManager.ComputeFleet.Models
{
    ...
    internal partial class ComputeFleetSshConfiguration
    {
        ...
        public ComputeFleetSshConfiguration()
        {
            PublicKeys = new ChangeTrackingList<ComputeFleetSshPublicKey>();
        }

        /// <summary> Initializes a new instance of <see cref="ComputeFleetSshConfiguration"/>. </summary>
        /// <param name="publicKeys"> The list of SSH public keys used to authenticate with linux based VMs. </param>
        /// <param name="additionalBinaryDataProperties"> Keeps track of any properties unknown to the library. </param>
        internal ComputeFleetSshConfiguration(IList<ComputeFleetSshPublicKey> publicKeys, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
