...
namespace Azure.ResourceManager.ComputeFleet.Models
{
    ...
    public partial class ComputeFleetVmss : ResourceData
    {
        ...
        internal ComputeFleetVmss(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, ComputeFleetProvisioningState operationStatus, ComputeFleetApiError error, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, name, resourceType, systemData)
        {
