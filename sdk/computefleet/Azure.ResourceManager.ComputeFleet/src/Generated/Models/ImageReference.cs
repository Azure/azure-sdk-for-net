...
namespace Azure.ResourceManager.ComputeFleet.Models
{
    ...
    public partial class ImageReference : SubResource
    {
        ...
        internal ImageReference(string id, IDictionary<string, BinaryData> serializedAdditionalRawData, string publisher, string offer, string sku, string version, string exactVersion, string sharedGalleryImageId, string communityGalleryImageId) : base(id, serializedAdditionalRawData)
        {
            Publisher = publisher;
            Offer = offer;
            Sku = sku;
