...
namespace Azure.ResourceManager.ComputeFleet.Models
{
    ...
    public partial class ImageReference
    {
        ...
        internal ImageReference(ResourceIdentifier id, string publisher, string offer, string sku, string version, string exactVersion, string sharedGalleryImageId, string communityGalleryImageId, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Publisher = publisher;
            Offer = offer;
