...
namespace Azure.ResourceManager.ComputeFleet.Models
{
    ...
    public partial class ComputeFleetVmssManagedDisk : IJsonModel<ComputeFleetVmssManagedDisk>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<ComputeFleetVmssManagedDisk>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ComputeFleetVmssManagedDisk IJsonModel<ComputeFleetVmssManagedDisk>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual ComputeFleetVmssManagedDisk JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<ComputeFleetVmssManagedDisk>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static ComputeFleetVmssManagedDisk DeserializeComputeFleetVmssManagedDisk(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new ComputeFleetVmssManagedDisk(storageAccountType, diskEncryptionSet, securityProfile, additionalBinaryDataProperties);
        }

        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ComputeFleetVmssManagedDisk>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ComputeFleetVmssManagedDisk IPersistableModel<ComputeFleetVmssManagedDisk>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual ComputeFleetVmssManagedDisk PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<ComputeFleetVmssManagedDisk>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
