...
namespace Azure.ResourceManager.ComputeFleet
{
    ...
    public partial class ComputeFleetResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<ComputeFleetResource>> UpdateAsync(WaitUntil waitUntil, ComputeFleetData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _fleetsRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, ComputeFleetData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                ComputeFleetArmOperation<ComputeFleetResource> operation = new ComputeFleetArmOperation<ComputeFleetResource>(
                    new ComputeFleetResourceOperationSource(Client),
                    _fleetsClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<ComputeFleetResource> Update(WaitUntil waitUntil, ComputeFleetData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
