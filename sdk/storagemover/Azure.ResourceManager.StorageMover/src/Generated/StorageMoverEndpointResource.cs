...
namespace Azure.ResourceManager.StorageMover
{
    ...
    public partial class StorageMoverEndpointResource : ArmResource
    {
        ...
        internal StorageMoverEndpointResource(ArmClient client, StorageMoverEndpointData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<StorageMoverEndpointResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new StorageMoverEndpointResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
