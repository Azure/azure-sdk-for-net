...
namespace Azure.ResourceManager.StorageMover.Models
{
    ...
    public partial class StorageMoverResourceData
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="StorageMoverResourceData"/>. </summary>
        public StorageMoverResourceData()
        {
        }
        ...
        internal StorageMoverResourceData(string id, string name, ResourceType? type, SystemData systemData, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Name = name;
            Type = type;
