...
namespace Azure.ResourceManager.StorageMover.Models
{
    ...
    public partial class SmbMountEndpointProperties : EndpointBaseProperties
    {
        ...
        internal SmbMountEndpointProperties(EndpointType endpointType, string description, StorageMoverProvisioningState? provisioningState, string host, string shareName, AzureKeyVaultSmbCredentials credentials, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(endpointType, description, provisioningState, serializedAdditionalRawData)
        {
            Host = host;
            ShareName = shareName;
