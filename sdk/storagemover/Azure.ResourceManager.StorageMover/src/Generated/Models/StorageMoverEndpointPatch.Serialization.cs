...
namespace Azure.ResourceManager.StorageMover.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StorageMoverEndpointPatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<StorageMoverEndpointPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<StorageMoverEndpointPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<StorageMoverEndpointPatch>)} interface");
            }
        ...
        string IPersistableModel<StorageMoverEndpointPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
