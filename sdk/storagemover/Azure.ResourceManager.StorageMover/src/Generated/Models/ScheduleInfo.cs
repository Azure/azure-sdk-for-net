...
namespace Azure.ResourceManager.StorageMover.Models
{
    ...
    public partial class ScheduleInfo
    {
        ...
        internal ScheduleInfo(Frequency? frequency, bool? isActive, SchedulerTime executionTime, DateTimeOffset? startOn, IList<string> daysOfWeek, IList<int> daysOfMonth, string cronExpression, DateTimeOffset? endOn, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Frequency = frequency;
            IsActive = isActive;
