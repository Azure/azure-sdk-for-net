...
{
    internal partial class UnknownEndpointBaseUpdateProperties : EndpointBaseUpdateProperties, IJsonModel<EndpointBaseUpdateProperties>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownEndpointBaseUpdateProperties DeserializeUnknownEndpointBaseUpdateProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownEndpointBaseUpdateProperties(endpointType, description, additionalBinaryDataProperties);
        }
