...
namespace Azure.ResourceManager.StorageMover.Models
{
    ...
    public partial class AzureStorageBlobContainerEndpointUpdateProperties : EndpointBaseUpdateProperties
    {
        ...
        public AzureStorageBlobContainerEndpointUpdateProperties() : base(EndpointType.AzureStorageBlobContainer)
        {
        ...
        /// </param>
        internal AzureStorageBlobContainerEndpointUpdateProperties(EndpointType endpointType, string description, IDictionary<string, BinaryData> additionalBinaryDataProperties, bool? enableCrossTenantTransfer, IList<string> allowedStorageAccounts) : base(endpointType, description, additionalBinaryDataProperties)
        {
