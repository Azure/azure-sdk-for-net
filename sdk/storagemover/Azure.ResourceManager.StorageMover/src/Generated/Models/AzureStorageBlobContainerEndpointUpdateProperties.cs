...
namespace Azure.ResourceManager.StorageMover.Models
{
    ...
    public partial class AzureStorageBlobContainerEndpointUpdateProperties : EndpointBaseUpdateProperties
    {
        ...
        internal AzureStorageBlobContainerEndpointUpdateProperties(EndpointType endpointType, string description, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(endpointType, description, serializedAdditionalRawData)
        {
