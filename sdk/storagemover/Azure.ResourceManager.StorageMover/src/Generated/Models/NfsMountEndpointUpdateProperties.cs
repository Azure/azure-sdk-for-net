...
namespace Azure.ResourceManager.StorageMover.Models
{
    ...
    public partial class NfsMountEndpointUpdateProperties : EndpointBaseUpdateProperties
    {
        ...
        internal NfsMountEndpointUpdateProperties(EndpointType endpointType, string description, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(endpointType, description, serializedAdditionalRawData)
        {
