...
namespace Azure.ResourceManager.StorageMover.Models
{
    ...
    public partial class NfsMountEndpointUpdateProperties : EndpointBaseUpdateProperties
    {
        ...
        internal NfsMountEndpointUpdateProperties(EndpointType endpointType, string description, Dictionary<string, BinaryData> rawData) : base(endpointType, description, rawData)
        {
