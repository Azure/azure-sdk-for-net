...
{
    public partial class JobRunResourceId : IUtf8JsonSerializable, IJsonModel<JobRunResourceId>, IPersistableModel<JobRunResourceId>
    {
        ...
        void IJsonModel<JobRunResourceId>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(JobRunResourceId)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  jobRunResourceId:");
                builder.AppendLine($" '{JobRunResourceIdValue.ToString()}'");
            }
