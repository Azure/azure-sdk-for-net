...
namespace Azure.ResourceManager.StorageMover.Models
{
    ...
    public partial class NfsMountEndpointUpdateProperties : EndpointBaseUpdateProperties, IJsonModel<NfsMountEndpointUpdateProperties>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<NfsMountEndpointUpdateProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        NfsMountEndpointUpdateProperties IJsonModel<NfsMountEndpointUpdateProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (NfsMountEndpointUpdateProperties)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static NfsMountEndpointUpdateProperties DeserializeNfsMountEndpointUpdateProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new NfsMountEndpointUpdateProperties(endpointType, description, additionalBinaryDataProperties);
        }

        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<NfsMountEndpointUpdateProperties>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        NfsMountEndpointUpdateProperties IPersistableModel<NfsMountEndpointUpdateProperties>.Create(BinaryData data, ModelReaderWriterOptions options) => (NfsMountEndpointUpdateProperties)PersistableModelCreateCore(data, options);
