...
namespace Azure.ResourceManager.StorageMover.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NfsMountEndpointUpdateProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NfsMountEndpointUpdateProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NfsMountEndpointUpdateProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<NfsMountEndpointUpdateProperties>)} interface");
            }
        ...
        string IPersistableModel<NfsMountEndpointUpdateProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
