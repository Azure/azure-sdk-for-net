...
namespace Azure.ResourceManager.StorageMover.Models
{
    ...
    public partial class SmbMountEndpointUpdateProperties : EndpointBaseUpdateProperties
    {
        ...
        internal SmbMountEndpointUpdateProperties(EndpointType endpointType, string description, AzureKeyVaultSmbCredentials credentials, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(endpointType, description, serializedAdditionalRawData)
        {
