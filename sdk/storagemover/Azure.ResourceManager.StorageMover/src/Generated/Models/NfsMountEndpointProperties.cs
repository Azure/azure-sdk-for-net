...
namespace Azure.ResourceManager.StorageMover.Models
{
    ...
    public partial class NfsMountEndpointProperties : EndpointBaseProperties
    {
        ...
        internal NfsMountEndpointProperties(EndpointType endpointType, string description, StorageMoverProvisioningState? provisioningState, string host, NfsVersion? nfsVersion, string export, Dictionary<string, BinaryData> rawData) : base(endpointType, description, provisioningState, rawData)
        {
            Host = host;
