...
{
    public partial class AzureKeyVaultSmbCredentials : IUtf8JsonSerializable, IJsonModel<AzureKeyVaultSmbCredentials>, IPersistableModel<AzureKeyVaultSmbCredentials>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureKeyVaultSmbCredentials>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(UsernameUriString))
            {
                builder.Append("  usernameUri:");
                builder.AppendLine($" '{UsernameUriString}'");
            }

            if (Optional.IsDefined(PasswordUriString))
            {
                builder.Append("  passwordUri:");
                builder.AppendLine($" '{PasswordUriString}'");
            }
