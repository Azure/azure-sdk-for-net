...
namespace Azure.ResourceManager.StorageMover.Models
{
    ...
    public partial class AzureStorageSmbFileShareEndpointProperties : EndpointBaseProperties
    {
        ...
        internal AzureStorageSmbFileShareEndpointProperties(EndpointType endpointType, string description, StorageMoverProvisioningState? provisioningState, ResourceIdentifier storageAccountResourceId, string fileShareName, Dictionary<string, BinaryData> rawData) : base(endpointType, description, provisioningState, rawData)
        {
            StorageAccountResourceId = storageAccountResourceId;
            FileShareName = fileShareName;
