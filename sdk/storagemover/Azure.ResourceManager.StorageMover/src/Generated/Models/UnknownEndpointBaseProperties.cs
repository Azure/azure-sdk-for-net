...
namespace Azure.ResourceManager.StorageMover.Models
{
    ...
    internal partial class UnknownEndpointBaseProperties : EndpointBaseProperties
    {
        ...
        internal UnknownEndpointBaseProperties(EndpointType endpointType, string description, StorageMoverProvisioningState? provisioningState, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(endpointType, description, provisioningState, serializedAdditionalRawData)
        {
