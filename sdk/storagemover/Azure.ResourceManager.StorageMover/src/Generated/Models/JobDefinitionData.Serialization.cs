    ...
    public partial class JobDefinitionData : IUtf8JsonSerializable, IJsonModel<JobDefinitionData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SourceSubpath))
            {
                ...
                if (SourceSubpath.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(TargetSubpath))
            {
                ...
                if (TargetSubpath.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(LatestJobRunName))
            {
                ...
                if (LatestJobRunName.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(LatestJobRunStatus))
            {
                ...
                builder.AppendLine($" '{LatestJobRunStatus.Value.ToString()}'");
            }
