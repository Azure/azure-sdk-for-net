...
namespace Azure.ResourceManager.StorageMover.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StorageMoverAgentPatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<StorageMoverAgentPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<StorageMoverAgentPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<StorageMoverAgentPatch>)} interface");
            }
        ...
        string IPersistableModel<StorageMoverAgentPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
