...
namespace Azure.ResourceManager.StorageMover.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureStorageSmbFileShareEndpointProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AzureStorageSmbFileShareEndpointProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AzureStorageSmbFileShareEndpointProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AzureStorageSmbFileShareEndpointProperties>)} interface");
            }
        ...
        string IPersistableModel<AzureStorageSmbFileShareEndpointProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
