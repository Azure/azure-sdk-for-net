...
namespace Azure.ResourceManager.StorageMover.Models
{
    ...
    public partial class AzureStorageBlobContainerEndpointUpdateProperties : EndpointBaseUpdateProperties, IJsonModel<AzureStorageBlobContainerEndpointUpdateProperties>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<AzureStorageBlobContainerEndpointUpdateProperties>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        AzureStorageBlobContainerEndpointUpdateProperties IJsonModel<AzureStorageBlobContainerEndpointUpdateProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (AzureStorageBlobContainerEndpointUpdateProperties)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static AzureStorageBlobContainerEndpointUpdateProperties DeserializeAzureStorageBlobContainerEndpointUpdateProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new AzureStorageBlobContainerEndpointUpdateProperties(endpointType, description, additionalBinaryDataProperties, enableCrossTenantTransfer, allowedStorageAccounts ?? new ChangeTrackingList<string>());
        }
    }
}
