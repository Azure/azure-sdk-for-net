...
namespace Azure.ResourceManager.StorageMover.Models
{
    ...
    public partial class AzureStorageBlobContainerEndpointProperties : EndpointBaseProperties
    {
        ...
        internal AzureStorageBlobContainerEndpointProperties(EndpointType endpointType, string description, StorageMoverProvisioningState? provisioningState, string storageAccountResourceId, string blobContainerName, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(endpointType, description, provisioningState, serializedAdditionalRawData)
        {
            StorageAccountResourceId = storageAccountResourceId;
            BlobContainerName = blobContainerName;
