...
{
    internal partial class UnknownCredentials : StorageMoverCredentials, IJsonModel<StorageMoverCredentials>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownCredentials DeserializeUnknownCredentials(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownCredentials(@type, additionalBinaryDataProperties);
        }
