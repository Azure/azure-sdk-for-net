...
namespace Azure.ResourceManager.StorageMover.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StorageMoverProjectPatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<StorageMoverProjectPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<StorageMoverProjectPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<StorageMoverProjectPatch>)} interface");
            }
        ...
        string IPersistableModel<StorageMoverProjectPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
