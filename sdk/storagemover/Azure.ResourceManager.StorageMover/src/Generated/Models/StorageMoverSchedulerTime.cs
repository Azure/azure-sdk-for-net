...
namespace Azure.ResourceManager.StorageMover.Models
{
    ...
    public partial class StorageMoverSchedulerTime
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="StorageMoverSchedulerTime"/>. </summary>
        ...
        internal StorageMoverSchedulerTime(int? hour, ScheduleMinute? minute, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Hour = hour;
            Minute = minute;
