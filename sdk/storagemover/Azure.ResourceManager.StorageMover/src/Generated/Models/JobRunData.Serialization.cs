    ...
    public partial class JobRunData : IUtf8JsonSerializable, IJsonModel<JobRunData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ScanStatus))
            {
                ...
                builder.AppendLine($" '{ScanStatus.Value.ToString()}'");
            }
            ...
            if (Optional.IsDefined(ExecutionEndOn))
            {
                ...
                var formattedDateTimeString = TypeFormatters.ToString(ExecutionEndOn.Value, "o");
                builder.AppendLine($" '{formattedDateTimeString}'");
            }
            ...
            if (Optional.IsDefined(TargetName))
            {
                ...
                if (TargetName.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
