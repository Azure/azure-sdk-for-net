...
{
    public partial class JobRunData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static JobRunData DeserializeJobRunData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
