...
namespace Azure.ResourceManager.StorageMover.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AgentList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AgentList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AgentList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AgentList>)} interface");
            }
        ...
        string IPersistableModel<AgentList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
