...
namespace Azure.ResourceManager.StorageMover.Models
{
    internal partial class AgentList : IUtf8JsonSerializable, IJsonModel<AgentList>
    {
        ...
        void IJsonModel<AgentList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(AgentList)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<AgentList>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(AgentList)} does not support '{options.Format}' format.");
            }
        }
