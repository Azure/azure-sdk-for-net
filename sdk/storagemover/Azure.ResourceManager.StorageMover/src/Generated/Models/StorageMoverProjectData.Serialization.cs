...
namespace Azure.ResourceManager.StorageMover
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StorageMoverProjectData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<StorageMoverProjectData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<StorageMoverProjectData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<StorageMoverProjectData>)} interface");
            }
        ...
        string IPersistableModel<StorageMoverProjectData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
