...
namespace Azure.ResourceManager.StorageMover.Models
{
    public partial class StorageMoverAgentPropertiesErrorDetails : IUtf8JsonSerializable, IJsonModel<StorageMoverAgentPropertiesErrorDetails>
    {
        ...
        void IJsonModel<StorageMoverAgentPropertiesErrorDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(StorageMoverAgentPropertiesErrorDetails)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<StorageMoverAgentPropertiesErrorDetails>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(StorageMoverAgentPropertiesErrorDetails)} does not support '{options.Format}' format.");
            }
        }
