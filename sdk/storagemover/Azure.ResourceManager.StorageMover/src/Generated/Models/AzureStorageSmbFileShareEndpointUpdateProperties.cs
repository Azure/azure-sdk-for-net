...
namespace Azure.ResourceManager.StorageMover.Models
{
    ...
    public partial class AzureStorageSmbFileShareEndpointUpdateProperties : EndpointBaseUpdateProperties
    {
        ...
        internal AzureStorageSmbFileShareEndpointUpdateProperties(EndpointType endpointType, string description, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(endpointType, description, serializedAdditionalRawData)
        {
