    ...
    public partial class JobRunData : IUtf8JsonSerializable, IJsonModel<JobRunData>
    {
        ...
        internal static JobRunData DeserializeJobRunData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
				...
				global::System.ClientModel.Primitives.ModelReaderWriter.Read<global::Azure.ResourceManager.Models.SystemData>(new global::System.BinaryData(global::System.Runtime.InteropServices.JsonMarshal.GetRawUtf8Value(property.Value).ToArray()), global::Azure.ResourceManager.StorageMover.ModelSerializationExtensions.WireOptions, AzureResourceManagerStorageMoverContext.Default)
#else
                ModelReaderWriter.Read<SystemData>(new BinaryData(Encoding.UTF8.GetBytes(property.Value.GetRawText())), ModelSerializationExtensions.WireOptions, AzureResourceManagerStorageMoverContext.Default)
#endif
;
                    continue;
                }
