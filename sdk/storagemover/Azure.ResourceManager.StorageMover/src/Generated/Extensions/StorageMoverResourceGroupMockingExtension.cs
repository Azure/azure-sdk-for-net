...
namespace Azure.ResourceManager.StorageMover.Mocking
{
    ...
    internal partial class StorageMoverResourceGroupMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="StorageMoverResourceGroupMockingExtension"/> class for mocking. </summary>
        protected StorageMoverResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="StorageMoverResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal StorageMoverResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
