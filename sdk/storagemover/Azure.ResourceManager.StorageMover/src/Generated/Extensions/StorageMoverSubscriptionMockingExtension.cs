...
namespace Azure.ResourceManager.StorageMover.Mocking
{
    ...
    public partial class StorageMoverSubscriptionMockingExtension : ArmResource
    {
        private ClientDiagnostics _storageMoverClientDiagnostics;
        private StorageMoversRestOperations _storageMoverRestClient;

        /// <summary> Initializes a new instance of the <see cref="StorageMoverSubscriptionMockingExtension"/> class for mocking. </summary>
        protected StorageMoverSubscriptionMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="StorageMoverSubscriptionMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal StorageMoverSubscriptionMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<StorageMoverResource> GetStorageMoversAsync(CancellationToken cancellationToken = default)
        {
            ...
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new StorageMoverResource(Client, StorageMoverData.DeserializeStorageMoverData(e)), StorageMoverClientDiagnostics, Pipeline, "StorageMoverSubscriptionMockingExtension.GetStorageMovers", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<StorageMoverResource> GetStorageMovers(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => StorageMoverRestClient.CreateListBySubscriptionRequest(Id.SubscriptionId);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => StorageMoverRestClient.CreateListBySubscriptionNextPageRequest(nextLink, Id.SubscriptionId);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new StorageMoverResource(Client, StorageMoverData.DeserializeStorageMoverData(e)), StorageMoverClientDiagnostics, Pipeline, "StorageMoverSubscriptionMockingExtension.GetStorageMovers", "value", "nextLink", cancellationToken);
        }
    }
}
