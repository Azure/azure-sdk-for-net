...
using Azure.ResourceManager.StorageMover.Testing;
...
namespace Azure.ResourceManager.StorageMover
{
    ...
    public static partial class StorageMoverExtensions
    {
        ...
        private static StorageMoverSubscriptionResourceExtension GetStorageMoverSubscriptionResourceExtension(ArmResource resource)
        {
            return resource.GetCachedClient(client =>
            {
                return new StorageMoverSubscriptionResourceExtension(client, resource.Id);
            });
        }

        private static StorageMoverSubscriptionResourceExtension GetStorageMoverSubscriptionResourceExtension(ArmClient client, ResourceIdentifier scope)
        {
            return client.GetResourceClient(() =>
            {
                return new StorageMoverSubscriptionResourceExtension(client, scope);
            });
        }
        ...
        {
            return GetStorageMoverSubscriptionResourceExtension(subscriptionResource).GetStorageMoversAsync(cancellationToken);
        }
        ...
        {
            return GetStorageMoverSubscriptionResourceExtension(subscriptionResource).GetStorageMovers(cancellationToken);
        }
    }
}
