...
namespace Azure.ResourceManager.StorageMover
{
    internal partial class StorageMoverArmOperation<T> : ArmOperation<T>
    {
        ...
        internal StorageMoverArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
