...
namespace Azure.ResourceManager.StorageMover
{
    ...
    public partial class StorageMoverEndpointData : ResourceData, IJsonModel<StorageMoverEndpointData>
    {
        ...
        internal static RequestContent ToRequestContent(StorageMoverEndpointData storageMoverEndpointData)
        {
            ...
            return RequestContent.Create(storageMoverEndpointData, ModelSerializationExtensions.WireOptions);
        }
        ...
        internal static StorageMoverEndpointData DeserializeStorageMoverEndpointData(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("identity"u8))
                {
                    ...
                    identity = ModelReaderWriter.Read<ManagedServiceIdentity>(new BinaryData(Encoding.UTF8.GetBytes(prop.Value.GetRawText())), new ModelReaderWriterOptions(options.Format + "|v3"), AzureResourceManagerStorageMoverContext.Default);
                    continue;
                }
                if (options.Format != "W")
                {
