...
namespace Azure.ResourceManager.StorageMover
{
    ...
    public partial class StorageMoverProjectData : ResourceData
    {
        ...
        internal StorageMoverProjectData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, ProjectProperties properties, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, name, resourceType, systemData)
        {
