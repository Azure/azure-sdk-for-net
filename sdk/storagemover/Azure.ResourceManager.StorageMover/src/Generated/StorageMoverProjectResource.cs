...
namespace Azure.ResourceManager.StorageMover
{
    ...
    public partial class StorageMoverProjectResource : ArmResource
    {
        ...
        internal StorageMoverProjectResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _projectsRestClient = new Projects(_projectsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, storageMoverProjectApiVersion ?? "2025-12-01");
        ...
        /// <summary>
        /// Updates the StorageMoverProject.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.StorageMover/storageMovers/{storageMoverName}/projects/{projectName}. </description>
        ...
        public virtual async Task<ArmOperation<StorageMoverProjectResource>> UpdateAsync(WaitUntil waitUntil, StorageMoverProjectData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _projectsRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, StorageMoverProjectData.ToRequestContent(data), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<StorageMoverProjectData> response = Response.FromValue(StorageMoverProjectData.FromResponse(result), result);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<StorageMoverProjectResource> Update(WaitUntil waitUntil, StorageMoverProjectData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
