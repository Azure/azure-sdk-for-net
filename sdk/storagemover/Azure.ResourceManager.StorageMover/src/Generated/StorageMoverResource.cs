...
namespace Azure.ResourceManager.StorageMover
{
    ...
    public partial class StorageMoverResource : ArmResource
    {
        ...
        internal StorageMoverResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _storageMoversRestClient = new StorageMovers(_storageMoversClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, storageMoverApiVersion ?? "2025-12-01");
        ...
        public virtual async Task<ArmOperation<StorageMoverResource>> UpdateAsync(WaitUntil waitUntil, StorageMoverData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _storageMoversRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, StorageMoverData.ToRequestContent(data), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<StorageMoverData> response = Response.FromValue(StorageMoverData.FromResponse(result), result);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<StorageMoverResource> Update(WaitUntil waitUntil, StorageMoverData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
