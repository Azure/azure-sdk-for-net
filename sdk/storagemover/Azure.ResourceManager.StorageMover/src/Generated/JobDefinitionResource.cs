...
namespace Azure.ResourceManager.StorageMover
{
    ...
    public partial class JobDefinitionResource : ArmResource
    {
        ...
        internal JobDefinitionResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _jobDefinitionsRestClient = new JobDefinitions(_jobDefinitionsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, jobDefinitionApiVersion ?? "2025-12-01");
        ...
        public virtual async Task<ArmOperation<JobDefinitionResource>> UpdateAsync(WaitUntil waitUntil, JobDefinitionData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _jobDefinitionsRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, JobDefinitionData.ToRequestContent(data), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<JobDefinitionData> response = Response.FromValue(JobDefinitionData.FromResponse(result), result);
