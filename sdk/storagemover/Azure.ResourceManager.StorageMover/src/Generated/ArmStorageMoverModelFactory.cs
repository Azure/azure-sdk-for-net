...
namespace Azure.ResourceManager.StorageMover.Models
{
    ...
    public static partial class ArmStorageMoverModelFactory
    {
        ...
        public static StorageMoverData StorageMoverData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, string description = null, StorageMoverProvisioningState? provisioningState = null)
        {
            ...
            return new StorageMoverData(id, name, resourceType, systemData, tags, location, description, provisioningState, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new StorageMoverAgentData(id, name, resourceType, systemData, description, agentVersion, arcResourceId, arcVmUuid, agentStatus, lastStatusUpdate, localIPAddress, memoryInMB, numberOfCores, uptimeInSeconds, errorDetails, provisioningState, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new StorageMoverAgentPropertiesErrorDetails(code, message, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new StorageMoverEndpointData(id, name, resourceType, systemData, properties, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new UnknownEndpointBaseProperties(endpointType, description, provisioningState, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new StorageMoverProjectData(id, name, resourceType, systemData, description, provisioningState, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new JobDefinitionData(id, name, resourceType, systemData, description, copyMode, sourceName, sourceResourceId, sourceSubpath, targetName, targetResourceId, targetSubpath, latestJobRunName, latestJobRunResourceId, latestJobRunStatus, agentName, agentResourceId, provisioningState, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new JobRunResourceId(jobRunResourceIdValue, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new JobRunData(id, name, resourceType, systemData, status, scanStatus, agentName, agentResourceId, executionStartOn, executionEndOn, lastStatusUpdate, itemsScanned, itemsExcluded, itemsUnsupported, itemsNoTransferNeeded, itemsFailed, itemsTransferred, bytesScanned, bytesExcluded, bytesUnsupported, bytesNoTransferNeeded, bytesFailed, bytesTransferred, sourceName, sourceResourceId, sourceProperties, targetName, targetResourceId, targetProperties, jobDefinitionProperties, error, provisioningState, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new JobRunError(code, message, target, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AzureStorageBlobContainerEndpointProperties(EndpointType.AzureStorageBlobContainer, description, provisioningState, new Dictionary<string, BinaryData>(), storageAccountResourceId, blobContainerName);
        }
        ...
        {
            return new NfsMountEndpointProperties(EndpointType.NfsMount, description, provisioningState, new Dictionary<string, BinaryData>(), host, nfsVersion, export);
        }
        ...
        {
            return new AzureStorageSmbFileShareEndpointProperties(EndpointType.AzureStorageSmbFileShare, description, provisioningState, new Dictionary<string, BinaryData>(), storageAccountResourceId, fileShareName);
        }
        ...
        {
            return new SmbMountEndpointProperties(EndpointType.SmbMount, description, provisioningState, new Dictionary<string, BinaryData>(), host, shareName, credentials);
        }
    }
}
