...
namespace Azure.ResourceManager.StorageMover.Models
{
    ...
    public static partial class ArmStorageMoverModelFactory
    {
        ...
        public static StorageMoverData StorageMoverData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, string description = null, StorageMoverProvisioningState? provisioningState = null)
        {
            ...
            return new StorageMoverData(id, name, resourceType, systemData, tags, location, description, provisioningState, default);
        }
        ...
        {
            return new StorageMoverAgentData(id, name, resourceType, systemData, description, agentVersion, arcResourceId, arcVmUuid, agentStatus, lastStatusUpdate, localIPAddress, memoryInMB, numberOfCores, uptimeInSeconds, errorDetails, provisioningState, default);
        }
        ...
        {
            return new StorageMoverEndpointData(id, name, resourceType, systemData, properties, default);
        }
        ...
        {
            return new UnknownEndpointBaseProperties(endpointType, description, provisioningState, default);
        }
        ...
        {
            return new StorageMoverProjectData(id, name, resourceType, systemData, description, provisioningState, default);
        }
        ...
        {
            return new JobDefinitionData(id, name, resourceType, systemData, description, copyMode, sourceName, sourceResourceId, sourceSubpath, targetName, targetResourceId, targetSubpath, latestJobRunName, latestJobRunResourceId, latestJobRunStatus, agentName, agentResourceId, provisioningState, default);
        }
        ...
        {
            return new JobRunData(id, name, resourceType, systemData, status, scanStatus, agentName, agentResourceId, executionStartOn, executionEndOn, lastStatusUpdate, itemsScanned, itemsExcluded, itemsUnsupported, itemsNoTransferNeeded, itemsFailed, itemsTransferred, bytesScanned, bytesExcluded, bytesUnsupported, bytesNoTransferNeeded, bytesFailed, bytesTransferred, sourceName, sourceResourceId, sourceProperties, targetName, targetResourceId, targetProperties, jobDefinitionProperties, error, provisioningState, default);
        }
        ...
        {
            return new AzureStorageBlobContainerEndpointProperties(EndpointType.AzureStorageBlobContainer, description, provisioningState, storageAccountResourceId, blobContainerName, default);
        }
        ...
        {
            return new NfsMountEndpointProperties(EndpointType.NfsMount, description, provisioningState, host, nfsVersion, export, default);
        }
        ...
        {
            return new AzureStorageSmbFileShareEndpointProperties(EndpointType.AzureStorageSmbFileShare, description, provisioningState, storageAccountResourceId, fileShareName, default);
        }
        ...
        {
            return new SmbMountEndpointProperties(EndpointType.SmbMount, description, provisioningState, host, shareName, credentials, default);
        }
    }
}
