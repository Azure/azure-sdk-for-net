...
namespace Azure.ResourceManager.EnergyServices.Mocking
{
    ...
    internal partial class EnergyServicesResourceGroupMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="EnergyServicesResourceGroupMockingExtension"/> class for mocking. </summary>
        protected EnergyServicesResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="EnergyServicesResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal EnergyServicesResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
