...
namespace Azure.ResourceManager.EnergyServices.Models
{
    public partial class EnergyServiceProperties : IUtf8JsonSerializable, IJsonModel<EnergyServiceProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(AuthAppId))
            {
                builder.Append("  authAppId:");
                if (AuthAppId.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
                    builder.AppendLine($"{AuthAppId}'''");
                }
                else
                {
                    builder.AppendLine($" '{AuthAppId}'");
            ...
            if (Optional.IsCollectionDefined(DataPartitionNames))
            {
                if (DataPartitionNames.Any())
                {
                    builder.Append("  dataPartitionNames:");
                    builder.AppendLine(" [");
                    foreach (var item in DataPartitionNames)
                    {
