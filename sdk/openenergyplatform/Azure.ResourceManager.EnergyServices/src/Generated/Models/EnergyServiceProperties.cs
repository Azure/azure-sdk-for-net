...
namespace Azure.ResourceManager.EnergyServices.Models
{
    ...
    public partial class EnergyServiceProperties
    {
        ...
        internal EnergyServiceProperties(string dnsName, ProvisioningState? provisioningState, string authAppId, IList<DataPartitionName> dataPartitionNames, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            DnsName = dnsName;
