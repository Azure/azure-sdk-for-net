...
namespace Azure.ResourceManager.EnergyServices.Models
{
    ...
    {
        internal static EnergyServiceNameAvailabilityResult DeserializeEnergyServiceNameAvailabilityResult(JsonElement element, SerializableOptions options = default)
        {
