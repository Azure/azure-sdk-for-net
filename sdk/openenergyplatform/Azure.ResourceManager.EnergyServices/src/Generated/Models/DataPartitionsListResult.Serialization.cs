...
namespace Azure.ResourceManager.EnergyServices.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataPartitionsListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DataPartitionsListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DataPartitionsListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<DataPartitionsListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
