...
namespace Azure.ResourceManager.EnergyServices.Models
{
    ...
    {
        internal static DataPartitionsListResult DeserializeDataPartitionsListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
