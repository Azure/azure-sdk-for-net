...
{
    public partial class DataPartitionsListResult : IUtf8JsonSerializable, IJsonModel<DataPartitionsListResult>, IPersistableModel<DataPartitionsListResult>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(DataPartitionInfo))
            {
                builder.Append("  dataPartitionInfo:");
                builder.AppendLine(" [");
                foreach (var item in DataPartitionInfo)
                {
