...
namespace Azure.ResourceManager.EnergyServices.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataPartitionAddOrRemoveContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DataPartitionAddOrRemoveContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DataPartitionAddOrRemoveContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DataPartitionAddOrRemoveContent>)} interface");
            }
        ...
        string IPersistableModel<DataPartitionAddOrRemoveContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
