...
namespace Azure.ResourceManager.EnergyServices
{
    ...
    public partial class EnergyServiceResource : ArmResource
    {
        ...
        /// <item>
        /// <term>Request Path</term>
        /// <description>/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OpenEnergyPlatform/energyServices/{resourceName}/addPartition</description>
        /// </item>
        /// <item>
        /// <term>Operation Id</term>
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<ArmOperation<DataPartitionAddOrRemoveContent>> AddPartitionAsync(WaitUntil waitUntil, DataPartitionAddOrRemoveContent content = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="content"> add partition action payload. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual ArmOperation<DataPartitionAddOrRemoveContent> AddPartition(WaitUntil waitUntil, DataPartitionAddOrRemoveContent content = null, CancellationToken cancellationToken = default)
        {
            using var scope = _energyServiceClientDiagnostics.CreateScope("EnergyServiceResource.AddPartition");
            scope.Start();
            try
        ...
        /// <item>
        /// <term>Request Path</term>
        /// <description>/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OpenEnergyPlatform/energyServices/{resourceName}/removePartition</description>
        /// </item>
        /// <item>
        /// <term>Operation Id</term>
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<ArmOperation<DataPartitionAddOrRemoveContent>> RemovePartitionAsync(WaitUntil waitUntil, DataPartitionAddOrRemoveContent content = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="content"> remove partition action payload. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual ArmOperation<DataPartitionAddOrRemoveContent> RemovePartition(WaitUntil waitUntil, DataPartitionAddOrRemoveContent content = null, CancellationToken cancellationToken = default)
        {
            using var scope = _energyServiceClientDiagnostics.CreateScope("EnergyServiceResource.RemovePartition");
            scope.Start();
            try
        ...
        /// <item>
        /// <term>Request Path</term>
        /// <description>/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OpenEnergyPlatform/energyServices/{resourceName}/listPartitions</description>
        /// </item>
        /// <item>
        /// <term>Operation Id</term>
        ...
        public virtual async Task<Response<EnergyServiceResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    var patch = new EnergyServicePatch();
