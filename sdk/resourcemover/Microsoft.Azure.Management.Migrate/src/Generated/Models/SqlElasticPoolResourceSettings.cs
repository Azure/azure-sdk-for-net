...
namespace Microsoft.Azure.Management.Migrate.ResourceMover.Models
{
    ...
    public partial class SqlElasticPoolResourceSettings : ResourceSettings
    {
        ...
        /// 'Disable'</param>
        public SqlElasticPoolResourceSettings(string targetResourceName, IDictionary<string, string> tags = default(IDictionary<string, string>), string zoneRedundant = default(string))
