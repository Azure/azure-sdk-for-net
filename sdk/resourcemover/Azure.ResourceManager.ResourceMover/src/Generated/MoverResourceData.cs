...
namespace Azure.ResourceManager.ResourceMover
{
    ...
    public partial class MoverResourceData : ResourceData
    {
        ...
        internal MoverResourceData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, MoverResourceProperties properties, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
