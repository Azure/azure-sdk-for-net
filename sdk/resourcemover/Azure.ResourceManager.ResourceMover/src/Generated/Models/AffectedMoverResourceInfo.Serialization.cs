...
namespace Azure.ResourceManager.ResourceMover.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AffectedMoverResourceInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AffectedMoverResourceInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AffectedMoverResourceInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AffectedMoverResourceInfo>)} interface");
            }
        ...
        string IPersistableModel<AffectedMoverResourceInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
