...
namespace Azure.ResourceManager.ResourceMover.Models
{
    ...
    /// </summary>
    [AbstractTypeDeserializer(typeof(UnknownResourceSettings))]
    public abstract partial class MoverResourceSettings
    {
        ...
        internal MoverResourceSettings(string resourceType, string targetResourceName, Dictionary<string, BinaryData> rawData)
        {
