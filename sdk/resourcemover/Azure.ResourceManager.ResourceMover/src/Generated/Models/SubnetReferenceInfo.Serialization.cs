...
namespace Azure.ResourceManager.ResourceMover.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SubnetReferenceInfo>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        SubnetReferenceInfo IJsonModel<SubnetReferenceInfo>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        internal static SubnetReferenceInfo DeserializeSubnetReferenceInfo(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new SubnetReferenceInfo(sourceArmResourceId, serializedAdditionalRawData, name.Value);
        }

        BinaryData IModel<SubnetReferenceInfo>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        SubnetReferenceInfo IModel<SubnetReferenceInfo>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<SubnetReferenceInfo>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
