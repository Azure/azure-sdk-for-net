...
namespace Azure.ResourceManager.ResourceMover.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SubnetReferenceInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SubnetReferenceInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SubnetReferenceInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SubnetReferenceInfo>)} interface");
            }
        ...
        string IPersistableModel<SubnetReferenceInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
