...
{
    public partial class MoverResourceData : IUtf8JsonSerializable, IJsonModel<MoverResourceData>, IPersistableModel<MoverResourceData>
    {
        ...
        void IJsonModel<MoverResourceData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MoverResourceData)} does not support '{format}' format.");
            }
