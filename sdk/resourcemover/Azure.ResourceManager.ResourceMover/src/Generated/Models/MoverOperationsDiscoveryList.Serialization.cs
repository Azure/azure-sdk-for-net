...
namespace Azure.ResourceManager.ResourceMover.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MoverOperationsDiscoveryList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MoverOperationsDiscoveryList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MoverOperationsDiscoveryList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MoverOperationsDiscoveryList>)} interface");
            }
        ...
        string IPersistableModel<MoverOperationsDiscoveryList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
