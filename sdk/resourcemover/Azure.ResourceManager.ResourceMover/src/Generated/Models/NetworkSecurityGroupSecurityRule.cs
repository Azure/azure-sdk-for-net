...
namespace Azure.ResourceManager.ResourceMover.Models
{
    ...
    public partial class NetworkSecurityGroupSecurityRule
    {
        ...
        internal NetworkSecurityGroupSecurityRule(string name, string access, string description, string destinationAddressPrefix, string destinationPortRange, string direction, int? priority, string protocol, string sourceAddressPrefix, string sourcePortRange, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Access = access;
