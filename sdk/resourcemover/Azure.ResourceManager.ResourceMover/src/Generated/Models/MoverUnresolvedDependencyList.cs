...
namespace Azure.ResourceManager.ResourceMover.Models
{
    ...
    internal partial class MoverUnresolvedDependencyList
    {
        ...
        internal MoverUnresolvedDependencyList(IReadOnlyList<MoverUnresolvedDependency> value, string nextLink, MoverSummaryList summaryCollection, long? totalCount, Dictionary<string, BinaryData> rawData)
        {
            Value = value;
            NextLink = nextLink;
