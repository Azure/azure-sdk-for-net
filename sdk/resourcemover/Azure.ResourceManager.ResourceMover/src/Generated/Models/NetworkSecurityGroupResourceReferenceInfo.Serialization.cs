...
{
    internal partial class NetworkSecurityGroupResourceReferenceInfo : IUtf8JsonSerializable, IJsonModel<NetworkSecurityGroupResourceReferenceInfo>, IPersistableModel<NetworkSecurityGroupResourceReferenceInfo>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NetworkSecurityGroupResourceReferenceInfo>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<NetworkSecurityGroupResourceReferenceInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(NetworkSecurityGroupResourceReferenceInfo)} does not support '{format}' format.");
            }
