...
namespace Azure.ResourceManager.ResourceMover.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NetworkSecurityGroupResourceReferenceInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NetworkSecurityGroupResourceReferenceInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NetworkSecurityGroupResourceReferenceInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<NetworkSecurityGroupResourceReferenceInfo>)} interface");
            }
        ...
        string IPersistableModel<NetworkSecurityGroupResourceReferenceInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
