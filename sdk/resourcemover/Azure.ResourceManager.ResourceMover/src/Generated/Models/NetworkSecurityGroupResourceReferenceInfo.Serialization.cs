...
namespace Azure.ResourceManager.ResourceMover.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NetworkSecurityGroupResourceReferenceInfo>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        NetworkSecurityGroupResourceReferenceInfo IJsonModel<NetworkSecurityGroupResourceReferenceInfo>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
                throw new FormatException($"The model {nameof(NetworkSecurityGroupResourceReferenceInfo)} does not support '{options.Format}' format.");
            }
        ...
        BinaryData IModel<NetworkSecurityGroupResourceReferenceInfo>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        NetworkSecurityGroupResourceReferenceInfo IModel<NetworkSecurityGroupResourceReferenceInfo>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<NetworkSecurityGroupResourceReferenceInfo>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
