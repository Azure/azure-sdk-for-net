...
namespace Azure.ResourceManager.ResourceMover.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MoverSummaryItemInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MoverSummaryItemInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MoverSummaryItemInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<MoverSummaryItemInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
