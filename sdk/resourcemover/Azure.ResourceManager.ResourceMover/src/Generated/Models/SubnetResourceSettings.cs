...
namespace Azure.ResourceManager.ResourceMover.Models
{
    ...
    public partial class SubnetResourceSettings
    {
        ...
        internal SubnetResourceSettings(string name, string addressPrefix, NetworkSecurityGroupResourceReferenceInfo networkSecurityGroup, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
