...
{
    public partial class SqlElasticPoolResourceSettings : Core.IUtf8JsonSerializable
    {
        ...
        internal static SqlElasticPoolResourceSettings DeserializeSqlElasticPoolResourceSettings(JsonElement element)
        {
            ...
            return new SqlElasticPoolResourceSettings(resourceType, targetResourceName, Core.Optional.ToDictionary(tags), Core.Optional.ToNullable(zoneRedundant));
        }
    }
}
