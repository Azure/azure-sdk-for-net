...
namespace Azure.ResourceManager.ResourceMover.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PublicIPAddressResourceSettings>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PublicIPAddressResourceSettings>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PublicIPAddressResourceSettings>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<PublicIPAddressResourceSettings>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
