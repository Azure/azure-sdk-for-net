...
namespace Azure.ResourceManager.ResourceMover.Models
{
    ...
    public partial class NetworkSecurityGroupResourceSettings : MoverResourceSettings
    {
        ...
        internal NetworkSecurityGroupResourceSettings(string resourceType, string targetResourceName, IDictionary<string, string> tags, IList<NetworkSecurityGroupSecurityRule> securityRules, Dictionary<string, BinaryData> rawData) : base(resourceType, targetResourceName, rawData)
        {
            Tags = tags;
