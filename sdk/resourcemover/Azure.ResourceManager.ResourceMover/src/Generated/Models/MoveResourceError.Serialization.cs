...
namespace Azure.ResourceManager.ResourceMover.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MoveResourceError>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MoveResourceError>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MoveResourceError>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MoveResourceError>)} interface");
            }
        ...
        string IPersistableModel<MoveResourceError>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
