...
namespace Azure.ResourceManager.ResourceMover.Models
{
    ...
    public partial class MoverOperationStatusError
    {
        ...
        internal MoverOperationStatusError(string code, string message, IReadOnlyList<MoverOperationStatusError> details, IReadOnlyList<MoverOperationErrorAdditionalInfo> additionalInfo, Dictionary<string, BinaryData> rawData)
        {
            Code = code;
            Message = message;
            Details = details;
