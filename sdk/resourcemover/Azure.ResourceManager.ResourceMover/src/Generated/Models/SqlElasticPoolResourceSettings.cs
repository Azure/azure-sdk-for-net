...
namespace Azure.ResourceManager.ResourceMover.Models
{
    ...
    public partial class SqlElasticPoolResourceSettings : MoverResourceSettings
    {
        ...
        internal SqlElasticPoolResourceSettings(string resourceType, string targetResourceName, IDictionary<string, string> tags, ResourceZoneRedundantSetting? zoneRedundant, Dictionary<string, BinaryData> rawData) : base(resourceType, targetResourceName, rawData)
        {
            Tags = tags;
