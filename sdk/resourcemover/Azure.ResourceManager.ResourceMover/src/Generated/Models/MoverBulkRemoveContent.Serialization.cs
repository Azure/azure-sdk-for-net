...
namespace Azure.ResourceManager.ResourceMover.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MoverBulkRemoveContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MoverBulkRemoveContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MoverBulkRemoveContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MoverBulkRemoveContent>)} interface");
            }
        ...
        string IPersistableModel<MoverBulkRemoveContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
