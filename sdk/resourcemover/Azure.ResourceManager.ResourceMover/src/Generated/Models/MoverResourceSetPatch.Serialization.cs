...
namespace Azure.ResourceManager.ResourceMover.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MoverResourceSetPatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MoverResourceSetPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MoverResourceSetPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MoverResourceSetPatch>)} interface");
            }
        ...
        string IPersistableModel<MoverResourceSetPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
