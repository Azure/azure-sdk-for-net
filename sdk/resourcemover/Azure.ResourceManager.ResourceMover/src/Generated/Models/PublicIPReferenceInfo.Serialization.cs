...
namespace Azure.ResourceManager.ResourceMover.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PublicIPReferenceInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PublicIPReferenceInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PublicIPReferenceInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PublicIPReferenceInfo>)} interface");
            }
        ...
        string IPersistableModel<PublicIPReferenceInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
