...
{
    public partial class NicIPConfigurationResourceSettings : IUtf8JsonSerializable, IJsonModel<NicIPConfigurationResourceSettings>, IPersistableModel<NicIPConfigurationResourceSettings>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(PublicIP))
            {
                ...
                AppendChildObject(builder, PublicIP, options, 2);
            }
