...
{
    public partial class MoverOperationErrorAdditionalInfo : IUtf8JsonSerializable, IJsonModel<MoverOperationErrorAdditionalInfo>, IPersistableModel<MoverOperationErrorAdditionalInfo>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  type:");
                builder.AppendLine($" '{OperationErrorAdditionalInfoType}'");
            }

            if (Optional.IsDefined(Info))
            {
                builder.Append("  info:");
                AppendChildObject(builder, Info, options, 2);
            }
