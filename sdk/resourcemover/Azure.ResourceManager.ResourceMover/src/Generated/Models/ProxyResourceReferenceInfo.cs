...
namespace Azure.ResourceManager.ResourceMover.Models
{
    ...
    public partial class ProxyResourceReferenceInfo : MoverResourceReferenceInfo
    {
        ...
        internal ProxyResourceReferenceInfo(ResourceIdentifier sourceArmResourceId, string name, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(sourceArmResourceId, serializedAdditionalRawData)
        {
            Name = name;
        }
