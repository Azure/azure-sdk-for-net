...
namespace Azure.ResourceManager.ResourceMover.Models
{
    ...
    public partial class ProxyResourceReferenceInfo : MoverResourceReferenceInfo
    {
        ...
        internal ProxyResourceReferenceInfo(ResourceIdentifier sourceArmResourceId, string name, Dictionary<string, BinaryData> rawData) : base(sourceArmResourceId, rawData)
        {
            Name = name;
        }
