...
namespace Azure.ResourceManager.ResourceMover.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LoadBalancerFrontendIPConfigurationResourceSettings>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<LoadBalancerFrontendIPConfigurationResourceSettings>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<LoadBalancerFrontendIPConfigurationResourceSettings>)} interface");
            }
        ...
        string IPersistableModel<LoadBalancerFrontendIPConfigurationResourceSettings>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
