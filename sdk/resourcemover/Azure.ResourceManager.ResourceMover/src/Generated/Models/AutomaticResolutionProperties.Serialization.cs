...
namespace Azure.ResourceManager.ResourceMover.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AutomaticResolutionProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AutomaticResolutionProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AutomaticResolutionProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<AutomaticResolutionProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
