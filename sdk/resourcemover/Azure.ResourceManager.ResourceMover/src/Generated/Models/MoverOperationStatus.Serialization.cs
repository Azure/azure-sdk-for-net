...
namespace Azure.ResourceManager.ResourceMover.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MoverOperationStatus>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MoverOperationStatus>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MoverOperationStatus>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MoverOperationStatus>)} interface");
            }
        ...
        string IPersistableModel<MoverOperationStatus>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
