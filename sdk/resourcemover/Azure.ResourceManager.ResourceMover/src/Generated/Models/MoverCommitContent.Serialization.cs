...
namespace Azure.ResourceManager.ResourceMover.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MoverCommitContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MoverCommitContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MoverCommitContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<MoverCommitContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
