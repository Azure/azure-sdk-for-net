...
namespace Azure.ResourceManager.ResourceMover.Models
{
    ...
    public partial class MoverOperationsDiscovery
    {
        ...
        internal MoverOperationsDiscovery(string name, bool? isDataAction, MoverDisplayInfo display, string origin, BinaryData properties, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
