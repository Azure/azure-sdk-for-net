...
namespace Azure.ResourceManager.ResourceMover.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MoverOperationsDiscovery>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MoverOperationsDiscovery>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MoverOperationsDiscovery>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MoverOperationsDiscovery>)} interface");
            }
        ...
        string IPersistableModel<MoverOperationsDiscovery>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
