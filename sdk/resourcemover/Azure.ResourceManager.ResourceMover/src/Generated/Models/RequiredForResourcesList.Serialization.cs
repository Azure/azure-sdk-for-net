...
namespace Azure.ResourceManager.ResourceMover.Models
{
    ...
    {
        internal static RequiredForResourcesList DeserializeRequiredForResourcesList(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
