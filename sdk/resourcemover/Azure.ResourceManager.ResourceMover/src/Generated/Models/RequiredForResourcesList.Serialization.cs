...
namespace Azure.ResourceManager.ResourceMover.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RequiredForResourcesList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RequiredForResourcesList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RequiredForResourcesList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<RequiredForResourcesList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
