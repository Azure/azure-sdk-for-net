...
namespace Azure.ResourceManager.ResourceMover.Models
{
    ...
    public partial class LoadBalancerNatRuleReferenceInfo : ProxyResourceReferenceInfo
    {
        ...
        internal LoadBalancerNatRuleReferenceInfo(ResourceIdentifier sourceArmResourceId, string name, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(sourceArmResourceId, name, serializedAdditionalRawData)
        {
        }
