...
namespace Azure.ResourceManager.ResourceMover.Models
{
    ...
    public partial class LoadBalancerNatRuleReferenceInfo : ProxyResourceReferenceInfo
    {
        ...
        internal LoadBalancerNatRuleReferenceInfo(ResourceIdentifier sourceArmResourceId, string name, Dictionary<string, BinaryData> rawData) : base(sourceArmResourceId, name, rawData)
        {
        }
