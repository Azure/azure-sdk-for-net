...
namespace Azure.ResourceManager.ResourceMover.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ProxyResourceReferenceInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ProxyResourceReferenceInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ProxyResourceReferenceInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<ProxyResourceReferenceInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
