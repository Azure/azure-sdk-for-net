...
{
    public partial class MoverResourceSetData : Core.IUtf8JsonSerializable
    {
        ...
        internal static MoverResourceSetData DeserializeMoverResourceSetData(JsonElement element)
        {
            ...
            Core.Optional<MoverResourceSetProperties> properties = default;
            ...
            return new MoverResourceSetData(id, name, type, systemData.Value, Core.Optional.ToDictionary(tags), location, Core.Optional.ToNullable(etag), identity, properties.Value);
        }
    }
}
