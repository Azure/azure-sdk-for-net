...
namespace Azure.ResourceManager.ResourceMover
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MoverResourceSetData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MoverResourceSetData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MoverResourceSetData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MoverResourceSetData>)} interface");
            }
        ...
        string IPersistableModel<MoverResourceSetData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
