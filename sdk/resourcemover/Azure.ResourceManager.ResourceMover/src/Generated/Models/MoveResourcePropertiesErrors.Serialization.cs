...
namespace Azure.ResourceManager.ResourceMover.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MoveResourcePropertiesErrors>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MoveResourcePropertiesErrors>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MoveResourcePropertiesErrors>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MoveResourcePropertiesErrors>)} interface");
            }
        ...
        string IPersistableModel<MoveResourcePropertiesErrors>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
