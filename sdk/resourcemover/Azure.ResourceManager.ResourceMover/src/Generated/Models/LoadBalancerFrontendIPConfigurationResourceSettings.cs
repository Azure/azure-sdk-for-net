...
namespace Azure.ResourceManager.ResourceMover.Models
{
    ...
    public partial class LoadBalancerFrontendIPConfigurationResourceSettings
    {
        ...
        internal LoadBalancerFrontendIPConfigurationResourceSettings(string name, IPAddress privateIPAddress, string privateIPAllocationMethod, SubnetReferenceInfo subnet, string zones, Dictionary<string, BinaryData> rawData)
        {
            Name = name;
