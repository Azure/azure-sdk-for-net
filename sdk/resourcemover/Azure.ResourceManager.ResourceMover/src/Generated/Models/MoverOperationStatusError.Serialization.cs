...
namespace Azure.ResourceManager.ResourceMover.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MoverOperationStatusError>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MoverOperationStatusError>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MoverOperationStatusError>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MoverOperationStatusError>)} interface");
            }
        ...
        string IPersistableModel<MoverOperationStatusError>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
