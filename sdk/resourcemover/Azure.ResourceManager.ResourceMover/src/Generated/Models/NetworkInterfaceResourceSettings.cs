...
namespace Azure.ResourceManager.ResourceMover.Models
{
    ...
    public partial class NetworkInterfaceResourceSettings : MoverResourceSettings
    {
        ...
        internal NetworkInterfaceResourceSettings(string resourceType, string targetResourceName, IDictionary<string, string> tags, IList<NicIPConfigurationResourceSettings> ipConfigurations, bool? enableAcceleratedNetworking, Dictionary<string, BinaryData> rawData) : base(resourceType, targetResourceName, rawData)
        {
            Tags = tags;
        ...
        /// <summary> Initializes a new instance of <see cref="NetworkInterfaceResourceSettings"/> for deserialization. </summary>
        internal NetworkInterfaceResourceSettings()
        {
        }
