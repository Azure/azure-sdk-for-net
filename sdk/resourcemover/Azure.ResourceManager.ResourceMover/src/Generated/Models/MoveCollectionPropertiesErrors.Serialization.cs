...
namespace Azure.ResourceManager.ResourceMover.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MoveCollectionPropertiesErrors>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MoveCollectionPropertiesErrors>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MoveCollectionPropertiesErrors>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MoveCollectionPropertiesErrors>)} interface");
            }
        ...
        string IPersistableModel<MoveCollectionPropertiesErrors>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
