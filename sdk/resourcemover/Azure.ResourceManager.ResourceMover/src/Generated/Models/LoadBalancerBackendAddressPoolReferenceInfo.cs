...
namespace Azure.ResourceManager.ResourceMover.Models
{
    ...
    public partial class LoadBalancerBackendAddressPoolReferenceInfo : ProxyResourceReferenceInfo
    {
        ...
        internal LoadBalancerBackendAddressPoolReferenceInfo(ResourceIdentifier sourceArmResourceId, string name, Dictionary<string, BinaryData> rawData) : base(sourceArmResourceId, name, rawData)
        {
        }
