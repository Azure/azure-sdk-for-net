...
namespace Azure.ResourceManager.ResourceMover.Models
{
    ...
    public partial class LoadBalancerBackendAddressPoolReferenceInfo : ProxyResourceReferenceInfo
    {
        ...
        internal LoadBalancerBackendAddressPoolReferenceInfo(ResourceIdentifier sourceArmResourceId, string name, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(sourceArmResourceId, name, serializedAdditionalRawData)
        {
        }
