...
{
    public partial class LoadBalancerNatRuleReferenceInfo : IUtf8JsonSerializable, IJsonModel<LoadBalancerNatRuleReferenceInfo>, IPersistableModel<LoadBalancerNatRuleReferenceInfo>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LoadBalancerNatRuleReferenceInfo>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<LoadBalancerNatRuleReferenceInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(LoadBalancerNatRuleReferenceInfo)} does not support '{format}' format.");
            }
