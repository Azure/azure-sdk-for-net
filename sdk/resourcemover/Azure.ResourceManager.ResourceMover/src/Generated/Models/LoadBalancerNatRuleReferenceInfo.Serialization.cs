...
namespace Azure.ResourceManager.ResourceMover.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LoadBalancerNatRuleReferenceInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<LoadBalancerNatRuleReferenceInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<LoadBalancerNatRuleReferenceInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<LoadBalancerNatRuleReferenceInfo>)} interface");
            }
        ...
        string IPersistableModel<LoadBalancerNatRuleReferenceInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
