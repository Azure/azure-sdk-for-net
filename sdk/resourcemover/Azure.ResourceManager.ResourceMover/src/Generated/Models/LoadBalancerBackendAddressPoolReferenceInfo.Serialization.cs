...
namespace Azure.ResourceManager.ResourceMover.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LoadBalancerBackendAddressPoolReferenceInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<LoadBalancerBackendAddressPoolReferenceInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<LoadBalancerBackendAddressPoolReferenceInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<LoadBalancerBackendAddressPoolReferenceInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
