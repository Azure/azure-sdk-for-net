...
namespace Azure.ResourceManager.ResourceMover.Models
{
    ...
    internal partial class MoverResourceList
    {
        ...
        internal MoverResourceList(IReadOnlyList<MoverResourceData> value, string nextLink, MoverSummaryList summaryCollection, long? totalCount, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Value = value;
            NextLink = nextLink;
