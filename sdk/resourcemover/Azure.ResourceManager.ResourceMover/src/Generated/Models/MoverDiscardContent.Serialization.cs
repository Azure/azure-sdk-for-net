...
namespace Azure.ResourceManager.ResourceMover.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MoverDiscardContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MoverDiscardContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MoverDiscardContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MoverDiscardContent>)} interface");
            }
        ...
        string IPersistableModel<MoverDiscardContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
