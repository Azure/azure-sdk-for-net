...
namespace Azure.ResourceManager.ResourceMover.Models
{
    public partial class NetworkSecurityGroupSecurityRule : IUtf8JsonSerializable, IJsonModel<NetworkSecurityGroupSecurityRule>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<NetworkSecurityGroupSecurityRule>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<NetworkSecurityGroupSecurityRule>)} interface");
            }
