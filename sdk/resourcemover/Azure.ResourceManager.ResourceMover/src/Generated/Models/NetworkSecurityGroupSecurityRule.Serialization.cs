...
namespace Azure.ResourceManager.ResourceMover.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NetworkSecurityGroupSecurityRule>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NetworkSecurityGroupSecurityRule>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NetworkSecurityGroupSecurityRule>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<NetworkSecurityGroupSecurityRule>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
