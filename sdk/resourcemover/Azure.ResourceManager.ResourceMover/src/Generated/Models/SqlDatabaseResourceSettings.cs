...
namespace Azure.ResourceManager.ResourceMover.Models
{
    ...
    public partial class SqlDatabaseResourceSettings : MoverResourceSettings
    {
        ...
        internal SqlDatabaseResourceSettings(string resourceType, string targetResourceName, IDictionary<string, string> tags, ResourceZoneRedundantSetting? zoneRedundant, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(resourceType, targetResourceName, serializedAdditionalRawData)
        {
            Tags = tags;
