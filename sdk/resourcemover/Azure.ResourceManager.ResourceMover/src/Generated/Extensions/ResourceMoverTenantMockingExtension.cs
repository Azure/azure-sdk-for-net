...
namespace Azure.ResourceManager.ResourceMover.Mocking
{
    ...
    internal partial class ResourceMoverTenantMockingExtension : ArmResource
    {
        ...
        public virtual AsyncPageable<MoverOperationsDiscovery> GetOperationsDiscoveriesAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, null, MoverOperationsDiscovery.DeserializeMoverOperationsDiscovery, OperationsDiscoveryClientDiagnostics, Pipeline, "ResourceMoverTenantMockingExtension.GetOperationsDiscoveries", "value", null, cancellationToken);
        }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => OperationsDiscoveryRestClient.CreateGetRequest();
            return PageableHelpers.CreatePageable(FirstPageRequest, null, MoverOperationsDiscovery.DeserializeMoverOperationsDiscovery, OperationsDiscoveryClientDiagnostics, Pipeline, "ResourceMoverTenantMockingExtension.GetOperationsDiscoveries", "value", null, cancellationToken);
        }
    }
}
