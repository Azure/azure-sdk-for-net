...
namespace Azure.ResourceManager.ResourceMover.Mocking
{
    ...
    public partial class ResourceMoverTenantMockingExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="ResourceMoverTenantMockingExtension"/> class for mocking. </summary>
        protected ResourceMoverTenantMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ResourceMoverTenantMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ResourceMoverTenantMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<MoverOperationsDiscovery> GetOperationsDiscoveriesAsync(CancellationToken cancellationToken = default)
        {
            ...
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, null, MoverOperationsDiscovery.DeserializeMoverOperationsDiscovery, OperationsDiscoveryClientDiagnostics, Pipeline, "ResourceMoverTenantMockingExtension.GetOperationsDiscoveries", "value", null, cancellationToken);
        }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => OperationsDiscoveryRestClient.CreateGetRequest();
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, null, MoverOperationsDiscovery.DeserializeMoverOperationsDiscovery, OperationsDiscoveryClientDiagnostics, Pipeline, "ResourceMoverTenantMockingExtension.GetOperationsDiscoveries", "value", null, cancellationToken);
        }
    }
}
