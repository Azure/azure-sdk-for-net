...
namespace Azure.ResourceManager.ResourceMover.Testing
{
    /// <summary> A class to add extension methods to TenantResource. </summary>
    public partial class ResourceMoverTenantResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="ResourceMoverTenantResourceExtension"/> class for mocking. </summary>
        protected ResourceMoverTenantResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ResourceMoverTenantResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ResourceMoverTenantResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<MoverOperationsDiscovery> GetOperationsDiscoveriesAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, null, MoverOperationsDiscovery.DeserializeMoverOperationsDiscovery, OperationsDiscoveryClientDiagnostics, Pipeline, "ResourceMoverTenantResourceExtension.GetOperationsDiscoveries", "value", null, cancellationToken);
        }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => OperationsDiscoveryRestClient.CreateGetRequest();
            return PageableHelpers.CreatePageable(FirstPageRequest, null, MoverOperationsDiscovery.DeserializeMoverOperationsDiscovery, OperationsDiscoveryClientDiagnostics, Pipeline, "ResourceMoverTenantResourceExtension.GetOperationsDiscoveries", "value", null, cancellationToken);
        }
    }
}
