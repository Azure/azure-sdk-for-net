...
namespace Azure.ResourceManager.ResourceMover
{
    ...
    public static partial class ResourceMoverExtensions
    {
        ...
        {
            return GetResourceGroupResourceExtension(resourceGroupResource).GetMoverResourceSets();
        }
        ...
        {
            return GetTenantResourceExtension(tenantResource).GetOperationsDiscoveriesAsync(cancellationToken);
        }
        ...
        {
            return GetTenantResourceExtension(tenantResource).GetOperationsDiscoveries(cancellationToken);
        }
    }
}
