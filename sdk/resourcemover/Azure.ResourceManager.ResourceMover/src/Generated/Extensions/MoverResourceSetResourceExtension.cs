...
namespace Azure.ResourceManager.ResourceMover.Mock
{
    ...
    public partial class MoverResourceSetResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="MoverResourceSetResourceExtension"/> class for mocking. </summary>
        protected MoverResourceSetResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MoverResourceSetResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MoverResourceSetResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<MoverResourceSetResource> GetMoverResourceSetsAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new MoverResourceSetResource(Client, MoverResourceSetData.DeserializeMoverResourceSetData(e)), MoverResourceSetMoveCollectionsClientDiagnostics, Pipeline, "MoverResourceSetResourceExtension.GetMoverResourceSets", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<MoverResourceSetResource> GetMoverResourceSets(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => MoverResourceSetMoveCollectionsRestClient.CreateListMoveCollectionsBySubscriptionRequest(Id.SubscriptionId);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => MoverResourceSetMoveCollectionsRestClient.CreateListMoveCollectionsBySubscriptionNextPageRequest(nextLink, Id.SubscriptionId);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new MoverResourceSetResource(Client, MoverResourceSetData.DeserializeMoverResourceSetData(e)), MoverResourceSetMoveCollectionsClientDiagnostics, Pipeline, "MoverResourceSetResourceExtension.GetMoverResourceSets", "value", "nextLink", cancellationToken);
        }
    }
}
