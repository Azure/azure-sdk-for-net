...
namespace Azure.ResourceManager.ResourceMover.Models
{
    ...
    public static partial class ArmResourceMoverModelFactory
    {
        ...
        public static MoverResourceSetData MoverResourceSetData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, ETag? etag = null, ManagedServiceIdentity identity = null, MoverResourceSetProperties properties = null)
        {
            ...
            return new MoverResourceSetData(id, name, resourceType, systemData, tags, location, etag, identity, properties, default);
        }
        ...
        {
            return new MoverResourceSetProperties(sourceRegion, targetRegion, provisioningState, errorsProperties != null ? new MoveCollectionPropertiesErrors(errorsProperties, new Dictionary<string, BinaryData>()) : null, default);
        }
        ...
        {
            return new MoverOperationStatus(id, name, status, startOn, endOn, error, properties, default);
        }
        ...
        public static MoverOperationStatusError MoverOperationStatusError(string code = null, string message = null, IEnumerable<MoverOperationStatusError> details = null, IEnumerable<MoverOperationErrorAdditionalInfo> additionalInfo = null)
        {
            ...
            return new MoverOperationStatusError(code, message, details?.ToList(), additionalInfo?.ToList(), default);
        }
        ...
        public static MoverOperationErrorAdditionalInfo MoverOperationErrorAdditionalInfo(string operationErrorAdditionalInfoType = null, IEnumerable<AffectedMoverResourceInfo> infoMoverResources = null)
        {
            ...
            return new MoverOperationErrorAdditionalInfo(operationErrorAdditionalInfoType, infoMoverResources != null ? new MoveErrorInfo(infoMoverResources?.ToList(), new Dictionary<string, BinaryData>()) : null, default);
        }
        ...
        public static AffectedMoverResourceInfo AffectedMoverResourceInfo(ResourceIdentifier id = null, ResourceIdentifier sourceId = null, IEnumerable<AffectedMoverResourceInfo> moverResources = null)
        {
            ...
            return new AffectedMoverResourceInfo(id, sourceId, moverResources?.ToList(), default);
        }
        ...
        {
            return new MoverResourceData(id, name, resourceType, systemData, properties, default);
        }
        ...
        {
            return new MoverResourcePropertiesMoveStatus(moveState, jobStatus, errorsProperties != null ? new MoveResourceError(errorsProperties, new Dictionary<string, BinaryData>()) : null, default);
        }
        ...
        {
            return new MoverResourceStatus(moveState, jobStatus, errorsProperties != null ? new MoveResourceError(errorsProperties, new Dictionary<string, BinaryData>()) : null, default);
        }
        ...
        {
            return new MoverResourceJobStatus(jobName, jobProgress, default);
        }
        ...
        {
            return new MoverUnresolvedDependency(count, id, default);
        }
        ...
        {
            return new MoverOperationsDiscovery(name, isDataAction, display, origin, properties, default);
        }
        ...
        {
            return new MoverDisplayInfo(provider, resource, operation, description, default);
        }
        ...
        public static RequiredForResourcesList RequiredForResourcesList(IEnumerable<string> sourceIds = null)
        {
            ...
            return new RequiredForResourcesList(sourceIds?.ToList(), default);
        }
    }
}
