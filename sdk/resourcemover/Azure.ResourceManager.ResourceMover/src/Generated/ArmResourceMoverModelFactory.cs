...
namespace Azure.ResourceManager.ResourceMover.Models
{
    ...
    public static partial class ArmResourceMoverModelFactory
    {
        ...
        public static MoverResourceSetData MoverResourceSetData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, ETag? etag = null, ManagedServiceIdentity identity = null, MoverResourceSetProperties properties = null)
        {
            ...
            return new MoverResourceSetData(id, name, resourceType, systemData, tags, location, etag, identity, properties, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MoverResourceSetProperties(sourceLocation, targetLocation, moveLocation, provisioningState, version, moveType, errorsProperties != null ? new MoveCollectionPropertiesErrors(errorsProperties, new Dictionary<string, BinaryData>()) : null, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MoverOperationStatus(id, name, status, startOn, endOn, error, properties, new Dictionary<string, BinaryData>());
        }
        ...
        public static MoverOperationStatusError MoverOperationStatusError(string code = null, string message = null, IEnumerable<MoverOperationStatusError> details = null, IEnumerable<MoverOperationErrorAdditionalInfo> additionalInfo = null)
        {
            ...
            return new MoverOperationStatusError(code, message, details?.ToList(), additionalInfo?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static MoverOperationErrorAdditionalInfo MoverOperationErrorAdditionalInfo(string operationErrorAdditionalInfoType = null, IEnumerable<AffectedMoverResourceInfo> infoMoverResources = null)
        {
            ...
            return new MoverOperationErrorAdditionalInfo(operationErrorAdditionalInfoType, infoMoverResources != null ? new MoveErrorInfo(infoMoverResources?.ToList(), new Dictionary<string, BinaryData>()) : null, new Dictionary<string, BinaryData>());
        }
        ...
        public static AffectedMoverResourceInfo AffectedMoverResourceInfo(ResourceIdentifier id = null, ResourceIdentifier sourceId = null, IEnumerable<AffectedMoverResourceInfo> moverResources = null)
        {
            ...
            return new AffectedMoverResourceInfo(id, sourceId, moverResources?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MoverResourceData(id, name, resourceType, systemData, properties, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MoverResourcePropertiesMoveStatus(moveState, jobStatus, errorsProperties != null ? new MoveResourceError(errorsProperties, new Dictionary<string, BinaryData>()) : null, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MoverResourceStatus(moveState, jobStatus, errorsProperties != null ? new MoveResourceError(errorsProperties, new Dictionary<string, BinaryData>()) : null, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MoverResourceJobStatus(jobName, jobProgress, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MoverResourceDependency(id, resolutionStatus, resolutionType, dependencyType, manualResolutionTargetId != null ? new ManualResolutionProperties(manualResolutionTargetId, new Dictionary<string, BinaryData>()) : null, automaticResolutionResourceId != null ? new AutomaticResolutionProperties(automaticResolutionResourceId, new Dictionary<string, BinaryData>()) : null, isOptional, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MoverUnresolvedDependency(count, id, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MoverOperationsDiscovery(name, isDataAction, display, origin, properties, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MoverDisplayInfo(provider, resource, operation, description, new Dictionary<string, BinaryData>());
        }
        ...
        public static RequiredForResourcesList RequiredForResourcesList(IEnumerable<string> sourceIds = null)
        {
            ...
            return new RequiredForResourcesList(sourceIds?.ToList(), new Dictionary<string, BinaryData>());
        }
    }
}
