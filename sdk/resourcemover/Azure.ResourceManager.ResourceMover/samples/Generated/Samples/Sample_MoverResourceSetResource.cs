...
["key1"] = "mc1"
        ...
        public async Task Prepare_MoveCollectionsPrepare()
        {
            ...
            ArmOperation<MoverOperationStatus> lro = await moverResourceSet.PrepareAsync(WaitUntil.Completed, content);
            MoverOperationStatus result = lro.Value;
        ...
        public async Task InitiateMove_MoveCollectionsInitiateMove()
        {
            ...
            ArmOperation<MoverOperationStatus> lro = await moverResourceSet.InitiateMoveAsync(WaitUntil.Completed, content);
            MoverOperationStatus result = lro.Value;
        ...
        public async Task Commit_MoveCollectionsCommit()
        {
            ...
            ArmOperation<MoverOperationStatus> lro = await moverResourceSet.CommitAsync(WaitUntil.Completed, content);
            MoverOperationStatus result = lro.Value;
        ...
        public async Task Discard_MoveCollectionsDiscard()
        {
            ...
            ArmOperation<MoverOperationStatus> lro = await moverResourceSet.DiscardAsync(WaitUntil.Completed, content);
            MoverOperationStatus result = lro.Value;
        ...
        public async Task BulkRemove_MoveCollectionsBulkRemove()
        {
            ...
            ArmOperation<MoverOperationStatus> lro = await moverResourceSet.BulkRemoveAsync(WaitUntil.Completed, content);
            MoverOperationStatus result = lro.Value;
