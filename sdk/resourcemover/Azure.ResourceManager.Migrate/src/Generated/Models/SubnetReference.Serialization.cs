...
{
    public partial class SubnetReference : IUtf8JsonSerializable
    {
        ...
        internal static SubnetReference DeserializeSubnetReference(JsonElement element)
        {
            ...
            return new SubnetReference(sourceArmResourceId, name.Value);
        }
    }
}
