...
namespace Azure.ResourceManager.Migrate.Models
{
    ...
    {
        /// <summary> Initializes a new instance of ProxyResourceReference. </summary>
        ...
        public ProxyResourceReference(string sourceArmResourceId) : base(sourceArmResourceId)
        {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="sourceArmResourceId"/> is null. </exception>
        internal ProxyResourceReference(string sourceArmResourceId, string name) : base(sourceArmResourceId)
        {
            if (sourceArmResourceId == null)
            {
                throw new ArgumentNullException(nameof(sourceArmResourceId));
