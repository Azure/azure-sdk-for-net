...
namespace Azure.ResourceManager.Migrate.Models
{
    ...
    public partial class SqlDatabaseResourceSettings : ResourceSettings
    {
        ...
        internal SqlDatabaseResourceSettings(string resourceType, string targetResourceName, IDictionary<string, string> tags, ZoneRedundant? zoneRedundant) : base(resourceType, targetResourceName)
        {
            Tags = tags;
