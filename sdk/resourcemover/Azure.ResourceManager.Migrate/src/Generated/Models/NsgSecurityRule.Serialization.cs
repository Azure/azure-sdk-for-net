...
{
    public partial class NsgSecurityRule : IUtf8JsonSerializable
    {
        ...
        internal static NsgSecurityRule DeserializeNsgSecurityRule(JsonElement element)
        {
            ...
            return new NsgSecurityRule(name.Value, access.Value, description.Value, destinationAddressPrefix.Value, destinationPortRange.Value, direction.Value, Optional.ToNullable(priority), protocol.Value, sourceAddressPrefix.Value, sourcePortRange.Value);
        }
    }
}
