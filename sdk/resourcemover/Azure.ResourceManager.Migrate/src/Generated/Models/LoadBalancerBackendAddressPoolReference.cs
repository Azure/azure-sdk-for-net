...
namespace Azure.ResourceManager.Migrate.Models
{
    ...
    public partial class LoadBalancerBackendAddressPoolReference : ProxyResourceReference
    {
        /// <summary> Initializes a new instance of LoadBalancerBackendAddressPoolReference. </summary>
        ...
        public LoadBalancerBackendAddressPoolReference(string sourceArmResourceId) : base(sourceArmResourceId)
        {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="sourceArmResourceId"/> is null. </exception>
        internal LoadBalancerBackendAddressPoolReference(string sourceArmResourceId, string name) : base(sourceArmResourceId, name)
        {
            if (sourceArmResourceId == null)
            {
                throw new ArgumentNullException(nameof(sourceArmResourceId));
