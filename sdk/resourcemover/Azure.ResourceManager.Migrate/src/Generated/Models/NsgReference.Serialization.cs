...
{
    internal partial class NsgReference : IUtf8JsonSerializable
    {
        ...
        internal static NsgReference DeserializeNsgReference(JsonElement element)
        {
            ...
            return new NsgReference(sourceArmResourceId);
        }
    }
}
