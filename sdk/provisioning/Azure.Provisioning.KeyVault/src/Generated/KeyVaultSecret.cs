...
public partial class KeyVaultSecret : Resource
{
    ...
    /// </summary>
    public BicepValue<SecretProperties> Properties { get => _properties; set => _properties.Assign(value); }
    private readonly BicepValue<SecretProperties> _properties;
    ...
    public KeyVaultSecret(string resourceName, string? resourceVersion = default, ProvisioningContext? context = default)
        : base(resourceName, "Microsoft.KeyVault/vaults/secrets", resourceVersion ?? "2019-09-01", context)
    {
