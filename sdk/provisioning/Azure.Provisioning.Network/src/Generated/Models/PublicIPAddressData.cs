...
public partial class PublicIPAddressData : ProvisionableConstruct
{
    ...
    protected override void DefineProvisionableProperties()
    {
        ...
        _publicIPAllocationMethod = DefineProperty<NetworkIPAllocationMethod>("PublicIPAllocationMethod", ["PublicIPAllocationMethod"]);
        _publicIPAddressVersion = DefineProperty<NetworkIPVersion>("PublicIPAddressVersion", ["PublicIPAddressVersion"]);
        _iPConfiguration = DefineModelProperty<NetworkIPConfiguration>("IPConfiguration", ["IPConfiguration"], isOutput: true);
        _dnsSettings = DefineModelProperty<PublicIPAddressDnsSettings>("DnsSettings", ["DnsSettings"]);
        _ddosSettings = DefineModelProperty<DdosSettings>("DdosSettings", ["DdosSettings"]);
        _iPTags = DefineListProperty<IPTag>("IPTags", ["IPTags"]);
        ...
        _servicePublicIPAddress = DefineModelProperty<PublicIPAddressData>("ServicePublicIPAddress", ["ServicePublicIPAddress"]);
        _natGateway = DefineModelProperty<NatGatewayData>("NatGateway", ["NatGateway"]);
        _migrationPhase = DefineProperty<PublicIPAddressMigrationPhase>("MigrationPhase", ["MigrationPhase"]);
        _linkedPublicIPAddress = DefineModelProperty<PublicIPAddressData>("LinkedPublicIPAddress", ["LinkedPublicIPAddress"]);
        _deleteOption = DefineProperty<IPAddressDeleteOption>("DeleteOption", ["DeleteOption"]);
