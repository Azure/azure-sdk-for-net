...
public partial class VirtualNetworkPeeringData : ProvisionableConstruct
{
    ...
    protected override void DefineProvisionableProperties()
    {
        ...
        _allowVirtualNetworkAccess = DefineProperty<bool>("AllowVirtualNetworkAccess", ["AllowVirtualNetworkAccess"]);
        _allowForwardedTraffic = DefineProperty<bool>("AllowForwardedTraffic", ["AllowForwardedTraffic"]);
        _allowGatewayTransit = DefineProperty<bool>("AllowGatewayTransit", ["AllowGatewayTransit"]);
        _useRemoteGateways = DefineProperty<bool>("UseRemoteGateways", ["UseRemoteGateways"]);
        _remoteVirtualNetworkId = DefineProperty<ResourceIdentifier>("RemoteVirtualNetworkId", ["RemoteVirtualNetworkId"]);
        _localAddressSpace = DefineModelProperty<VirtualNetworkAddressSpace>("LocalAddressSpace", ["LocalAddressSpace"]);
        _localVirtualNetworkAddressSpace = DefineModelProperty<VirtualNetworkAddressSpace>("LocalVirtualNetworkAddressSpace", ["LocalVirtualNetworkAddressSpace"]);
        _remoteAddressSpace = DefineModelProperty<VirtualNetworkAddressSpace>("RemoteAddressSpace", ["RemoteAddressSpace"]);
        _remoteVirtualNetworkAddressSpace = DefineModelProperty<VirtualNetworkAddressSpace>("RemoteVirtualNetworkAddressSpace", ["RemoteVirtualNetworkAddressSpace"]);
        _remoteBgpCommunities = DefineModelProperty<VirtualNetworkBgpCommunities>("RemoteBgpCommunities", ["RemoteBgpCommunities"]);
        _remoteVirtualNetworkEncryption = DefineModelProperty<VirtualNetworkEncryption>("RemoteVirtualNetworkEncryption", ["RemoteVirtualNetworkEncryption"], isOutput: true);
        _peeringState = DefineProperty<VirtualNetworkPeeringState>("PeeringState", ["PeeringState"]);
        _peeringSyncLevel = DefineProperty<VirtualNetworkPeeringLevel>("PeeringSyncLevel", ["PeeringSyncLevel"]);
        _provisioningState = DefineProperty<NetworkProvisioningState>("ProvisioningState", ["ProvisioningState"], isOutput: true);
        _doNotVerifyRemoteGateways = DefineProperty<bool>("DoNotVerifyRemoteGateways", ["DoNotVerifyRemoteGateways"]);
        _resourceGuid = DefineProperty<Guid>("ResourceGuid", ["ResourceGuid"], isOutput: true);
        _areCompleteVnetsPeered = DefineProperty<bool>("AreCompleteVnetsPeered", ["AreCompleteVnetsPeered"]);
        _enableOnlyIPv6Peering = DefineProperty<bool>("EnableOnlyIPv6Peering", ["EnableOnlyIPv6Peering"]);
        _localSubnetNames = DefineListProperty<string>("LocalSubnetNames", ["LocalSubnetNames"]);
        _remoteSubnetNames = DefineListProperty<string>("RemoteSubnetNames", ["RemoteSubnetNames"]);
