...
public partial class RedisPrivateLinkServiceConnectionState : ProvisionableConstruct
{
    ...
    /// </summary>
    public BicepValue<RedisPrivateEndpointServiceConnectionStatus> Status { get => _status; set => _status.Assign(value); }
    private readonly BicepValue<RedisPrivateEndpointServiceConnectionStatus> _status;
    ...
    /// <summary>
    /// Creates a new RedisPrivateLinkServiceConnectionState.
    /// </summary>
    public RedisPrivateLinkServiceConnectionState()
    {
        _status = BicepValue<RedisPrivateEndpointServiceConnectionStatus>.DefineProperty(this, "Status", ["status"]);
