...
public partial class GeoReplicationStatistics : ProvisionableConstruct
{
    ...
    /// </summary>
    public BicepValue<GeoReplicationStatus> Status { get => _status; }
    private readonly BicepValue<GeoReplicationStatus> _status;
    ...
    /// </summary>
    public BicepValue<bool> CanFailover { get => _canFailover; }
    private readonly BicepValue<bool> _canFailover;
    ...
    {
        _status = BicepValue<GeoReplicationStatus>.DefineProperty(this, "Status", ["status"], isOutput: true);
        _lastSyncOn = BicepValue<DateTimeOffset>.DefineProperty(this, "LastSyncOn", ["lastSyncTime"], isOutput: true);
        _canFailover = BicepValue<bool>.DefineProperty(this, "CanFailover", ["canFailover"], isOutput: true);
    }
}
