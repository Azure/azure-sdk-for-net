namespace Azure.Provisioning.Storage
{
    ...
    public partial class FileService : Azure.Provisioning.Resource<Azure.ResourceManager.Storage.FileServiceData>
    {
        public FileService(Azure.Provisioning.IConstruct scope, Azure.Provisioning.Storage.StorageAccount? parent = null, string version = "2022-09-01") : base (default(Azure.Provisioning.IConstruct), default(Azure.Provisioning.Resource), default(string), default(Azure.Core.ResourceType), default(string), default(System.Func<string, Azure.ResourceManager.Storage.FileServiceData>), default(bool)) { }
        protected override Azure.Provisioning.Resource? FindParentInScope(Azure.Provisioning.IConstruct scope) { throw null; }
        public static Azure.Provisioning.Storage.FileService FromExisting(Azure.Provisioning.IConstruct scope, string name, Azure.Provisioning.Storage.StorageAccount parent) { throw null; }
    }
    ...
    public static partial class StorageExtensions
    {
        ...
        public static Azure.Provisioning.Storage.FileService AddFileService(this Azure.Provisioning.IConstruct scope) { throw null; }
