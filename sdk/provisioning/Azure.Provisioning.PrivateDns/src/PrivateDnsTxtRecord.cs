...
/// PrivateDnsTxtRecord.
/// </summary>
public partial class PrivateDnsTxtRecord : ProvisionableResource
{
    /// <summary>
    ...
    {
        get { Initialize(); return _privateDnsTxtRecords!; }
        set { Initialize(); _privateDnsTxtRecords!.Assign(value); }
    }
    ...
    /// <summary>
    /// Creates a new PrivateDnsTxtRecord.
    /// </summary>
    /// <param name="bicepIdentifier">
    /// The the Bicep identifier name of the PrivateDnsTxtRecord resource.
    /// This can be used to refer to the resource in expressions, but is not
    /// the Azure name of the resource.  This value can contain letters,
    /// numbers, and underscores.
    /// </param>
    /// <param name="resourceVersion">Version of the PrivateDnsTxtRecord.</param>
    public PrivateDnsTxtRecord(string bicepIdentifier, string? resourceVersion = default)
        : base(bicepIdentifier, "Microsoft.Network/privateDnsZones/TXT", resourceVersion ?? "2024-06-01")
    {
    }

    /// <summary>
    /// Define all the provisionable properties of PrivateDnsTxtRecord.
    /// </summary>
    protected override void DefineProvisionableProperties()
    {
        ...
        _privateDnsTxtRecords = DefineListProperty<PrivateDnsTxtRecordInfo>("PrivateDnsTxtRecords", ["properties", "txtRecords"]);
    ...
    /// <summary>
    /// Supported PrivateDnsTxtRecord resource versions.
    /// </summary>
    ...
    /// <summary>
    /// Creates a reference to an existing PrivateDnsTxtRecord.
    /// </summary>
    /// <param name="bicepIdentifier">
    /// The the Bicep identifier name of the PrivateDnsTxtRecord resource.
    /// This can be used to refer to the resource in expressions, but is not
    ...
    /// </param>
    /// <param name="resourceVersion">Version of the PrivateDnsTxtRecord.</param>
    /// <returns>The existing PrivateDnsTxtRecord resource.</returns>
    public static PrivateDnsTxtRecord FromExisting(string bicepIdentifier, string? resourceVersion = default) =>
