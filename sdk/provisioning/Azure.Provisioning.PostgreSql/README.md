...
### Create a basic PostgreSql resource
...
// Refer to the Azure.Provisioning.PostgreSql API documentation for detailed resource configuration

infrastructure.Add(/* Add your PostgreSql resources here */);
