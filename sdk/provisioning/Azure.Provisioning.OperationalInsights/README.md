...
### Create a basic OperationalInsights resource
...
// Create a OperationalInsights resource
// Note: Specific resource types and properties vary by service
// Refer to the Azure.Provisioning.OperationalInsights API documentation for detailed resource configuration

infrastructure.Add(/* Add your OperationalInsights resources here */);
