...
### Create a basic Search resource
...
// Refer to the Azure.Provisioning.Search API documentation for detailed resource configuration

infrastructure.Add(/* Add your Search resources here */);
