...
public partial class SignalRUpstreamTemplate : ProvisioningConstruct
{
    ...
    /// </summary>
    public BicepValue<string> HubPattern { get => _hubPattern; set => _hubPattern.Assign(value); }
    private readonly BicepValue<string> _hubPattern;
    ...
    /// &quot;connect&quot;.
    /// </summary>
    public BicepValue<string> EventPattern { get => _eventPattern; set => _eventPattern.Assign(value); }
    private readonly BicepValue<string> _eventPattern;
    ...
    /// &quot;connections&quot;.
    /// </summary>
    public BicepValue<string> CategoryPattern { get => _categoryPattern; set => _categoryPattern.Assign(value); }
    private readonly BicepValue<string> _categoryPattern;
    ...
    /// messages.
    /// </summary>
    public BicepValue<SignalRUpstreamAuthSettings> Auth { get => _auth; set => _auth.Assign(value); }
    private readonly BicepValue<SignalRUpstreamAuthSettings> _auth;
    ...
    {
        _hubPattern = BicepValue<string>.DefineProperty(this, "HubPattern", ["hubPattern"]);
        _eventPattern = BicepValue<string>.DefineProperty(this, "EventPattern", ["eventPattern"]);
        _categoryPattern = BicepValue<string>.DefineProperty(this, "CategoryPattern", ["categoryPattern"]);
        _urlTemplate = BicepValue<string>.DefineProperty(this, "UrlTemplate", ["urlTemplate"]);
        _auth = BicepValue<SignalRUpstreamAuthSettings>.DefineProperty(this, "Auth", ["auth"]);
    }
}
