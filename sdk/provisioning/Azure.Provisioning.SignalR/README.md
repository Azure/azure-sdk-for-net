...
### Create a basic SignalR resource
...
// Refer to the Azure.Provisioning.SignalR API documentation for detailed resource configuration

infrastructure.Add(/* Add your SignalR resources here */);
