...
public partial class AppServiceDomain : Resource
{
    ...
    public AppServiceDomain(string resourceName, string? resourceVersion = default, ProvisioningContext? context = default)
        : base(resourceName, "Microsoft.DomainRegistration/domains", resourceVersion, context)
    {
