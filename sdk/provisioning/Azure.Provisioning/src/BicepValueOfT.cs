...
public class BicepValue<T> : BicepValue
{
    ...
    private protected override BicepExpression CompileLiteralValue() => Value switch
    {
        null => BicepSyntax.Null(),
        IBicepValue v => v.Compile(),
        bool b => BicepSyntax.Value(b),
        int i when Format == "S" => BicepSyntax.Value(BicepTypeMapping.ToLiteralString(i, Format)),
        int i => BicepSyntax.Value(i),
        long l when Format == "S" => BicepSyntax.Value(BicepTypeMapping.ToLiteralString(l, Format)),
        ...
        byte[] b => BicepSyntax.Value(BicepTypeMapping.ToLiteralString(b, Format)),
        BinaryData b => BicepSyntax.Value(BicepTypeMapping.ToLiteralString(b, Format)),
