...
public partial class InstanceFunctionCallExpression : IJsonModel<BicepExpression>
{
    void IJsonModel<BicepExpression>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
    {
        writer.WriteStartObject();
        writer.WriteString("kind", "instance-function-call");
        writer.WritePropertyName("base");
        ((IJsonModel<BicepExpression>)Base).Write(writer, options);
    ...
    BicepExpression IJsonModel<BicepExpression>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
    {
        ...
        return DeserializeInstanceFunctionCallExpression(doc.RootElement);
    }
    ...
    BinaryData IPersistableModel<BicepExpression>.Write(ModelReaderWriterOptions options)
    {
        ...
        switch (format)
        {
            ...
            default:
                throw new FormatException($"The model {nameof(InstanceFunctionCallExpression)} does not support writing '{format}' format.");
        }
    }
    ...
    internal static InstanceFunctionCallExpression DeserializeInstanceFunctionCallExpression(JsonElement element)
    {
        BicepExpression baseExpr = UnknownBicepExpression.DeserializeBicepExpression(element.GetProperty("base"));
        ...
        return new InstanceFunctionCallExpression(baseExpr, name, [.. args]);
    }
}
