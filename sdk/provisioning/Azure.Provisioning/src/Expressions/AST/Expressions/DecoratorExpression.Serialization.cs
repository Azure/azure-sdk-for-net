...
public partial class DecoratorExpression : IJsonModel<BicepExpression>
{
    ...
    BicepExpression IJsonModel<BicepExpression>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
    {
        ...
        return DeserializeDecoratorExpression(doc.RootElement);
    }
    ...
    BinaryData IPersistableModel<BicepExpression>.Write(ModelReaderWriterOptions options)
    {
        ...
        switch (format)
        {
            ...
            default:
                throw new FormatException($"The model {nameof(DecoratorExpression)} does not support writing '{format}' format.");
        }
    }
    ...
    {
        return new DecoratorExpression(UnknownBicepExpression.DeserializeBicepExpression(element.GetProperty("value")));
    }
}
