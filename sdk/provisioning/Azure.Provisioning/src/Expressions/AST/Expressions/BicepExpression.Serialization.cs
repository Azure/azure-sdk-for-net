...
public abstract partial class BicepExpression : IJsonModel<BicepExpression>
{
    void IJsonModel<BicepExpression>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
    {
        ...
        throw new InvalidOperationException($"IJsonModel<BicepExpression>.Write must be implemented by {GetType().Name}");
    }
