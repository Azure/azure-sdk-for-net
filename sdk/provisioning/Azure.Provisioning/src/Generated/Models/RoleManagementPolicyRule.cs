...
public partial class RoleManagementPolicyRule : ProvisionableConstruct
{
    ...
    /// </summary>
    public BicepValue<RoleManagementPolicyRuleTarget> Target { get => _target; set => _target.Assign(value); }
    private readonly BicepValue<RoleManagementPolicyRuleTarget> _target;
    ...
    public RoleManagementPolicyRule()
    {
        ...
        _target = BicepValue<RoleManagementPolicyRuleTarget>.DefineProperty(this, "Target", ["target"]);
    }
}
