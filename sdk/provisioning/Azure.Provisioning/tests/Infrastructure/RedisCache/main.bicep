...
resource keyVaultSecret_R6AWfDGcA 'Microsoft.KeyVault/vaults/secrets@2023-02-01' = {
  ...
  location: location
  properties: {
    value: '${redisCache_YE3v6ym48.properties.hostName},ssl=true,password=${redisCache_YE3v6ym48.properties.accessKeys.primaryKey}'
  }
}

output primaryKey string = redisCache_YE3v6ym48.properties.accessKeys.primaryKey
