...
resource appConfigurationStore_OcIExgz1d 'Microsoft.AppConfiguration/configurationStores@2023-03-01' existing = {
...
resource webSiteConfigLogs_7A7a8DHfx 'Microsoft.Web/sites/config@2021-02-01' existing = {
  name: 'existingWebSiteConfigLogs'
}
...
resource webSitePublishingCredentialPolicy_thziHKVBm 'Microsoft.Web/sites/basicPublishingCredentialsPolicies@2021-02-01' existing = {
  name: 'existingWebSitePublishingCredentialPolicy'
}
...
resource sqlDatabase_m9ZmzLlHS 'Microsoft.Sql/servers/databases@2022-08-01-preview' existing = {
  name: 'existingSqlDatabase'
}

resource sqlFirewallRule_SFMW2DxVf 'Microsoft.Sql/servers/firewallRules@2020-11-01-preview' existing = {
  name: 'existingSqlFirewallRule'
}
