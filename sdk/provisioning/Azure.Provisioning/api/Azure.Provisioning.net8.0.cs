...
namespace Azure.Provisioning.Primitives
{
    ...
    public abstract partial class ProvisionableConstruct : Azure.Provisioning.Primitives.Provisionable, Azure.Provisioning.IBicepValue
    {
        ...
        protected Azure.Provisioning.BicepDictionary<T> DefineDictionaryProperty<T>(string propertyName, string[]? bicepPath, bool isOutput, bool isRequired, string? format) { throw null; }
        ...
        protected Azure.Provisioning.BicepList<T> DefineListProperty<T>(string propertyName, string[]? bicepPath, bool isOutput, bool isRequired, string? format) { throw null; }
