...
namespace Azure.Provisioning.Primitives
{
    ...
    public abstract partial class ProvisionableConstruct : Azure.Provisioning.Primitives.Provisionable, Azure.Provisioning.IBicepValue
    {
        ...
        protected Azure.Provisioning.BicepDictionary<T> DefineDictionaryProperty<T>(string propertyName, string[]? bicepPath, string? format, bool isOutput = false, bool isRequired = false) { throw null; }
        ...
        protected Azure.Provisioning.BicepList<T> DefineListProperty<T>(string propertyName, string[]? bicepPath, string? format, bool isOutput = false, bool isRequired = false) { throw null; }
