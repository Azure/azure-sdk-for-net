...
public partial class ElasticPool : Resource
{
    ...
    public ElasticPool(string resourceName, string? resourceVersion = default, ProvisioningContext? context = default)
        : base(resourceName, "Microsoft.Sql/servers/elasticPools", resourceVersion, context)
    {
