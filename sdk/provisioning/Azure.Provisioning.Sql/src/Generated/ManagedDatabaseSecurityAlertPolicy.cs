...
/// </summary>
public partial class ManagedDatabaseSecurityAlertPolicy : Resource
{
    /// <summary>
    /// Gets the Name.
    /// </summary>
    ...
    /// </summary>
    public BicepValue<SecurityAlertPolicyState> State { get => _state; set => _state.Assign(value); }
    private readonly BicepValue<SecurityAlertPolicyState> _state;
        ...
        : base(bicepIdentifier, "Microsoft.Sql/managedInstances/databases/securityAlertPolicies", resourceVersion ?? "2021-11-01")
    {
        ...
        _state = BicepValue<SecurityAlertPolicyState>.DefineProperty(this, "State", ["properties", "state"]);
