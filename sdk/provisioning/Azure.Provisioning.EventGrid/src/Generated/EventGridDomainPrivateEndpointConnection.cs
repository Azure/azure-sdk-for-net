...
public partial class EventGridDomainPrivateEndpointConnection : Resource
{
    ...
    public EventGridDomainPrivateEndpointConnection(string resourceName, string? resourceVersion = default, ProvisioningContext? context = default)
        : base(resourceName, "Microsoft.EventGrid/domains/privateEndpointConnections", resourceVersion, context)
    {
