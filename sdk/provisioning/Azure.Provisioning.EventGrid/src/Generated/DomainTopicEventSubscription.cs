...
public partial class DomainTopicEventSubscription : Resource
{
    ...
    /// <summary>
    /// Gets or sets a reference to the parent DomainTopic.
    /// </summary>
    public DomainTopic? Parent { get => _parent!.Value; set => _parent!.Value = value; }
    private readonly ResourceReference<DomainTopic> _parent;
    ...
    public DomainTopicEventSubscription(string resourceName, string? resourceVersion = default)
        : base(resourceName, "Microsoft.EventGrid/domains/topics/eventSubscriptions", resourceVersion)
    {
        ...
        _parent = ResourceReference<DomainTopic>.DefineResource(this, "Parent", ["parent"], isRequired: true);
    }
