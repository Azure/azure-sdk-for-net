...
public partial class PartnerTopicEventSubscription : Resource
{
    ...
    /// </summary>
    public PartnerTopic? Parent { get => _parent!.Value; set => _parent!.Value = value; }
    private readonly ResourceReference<PartnerTopic> _parent;
        ...
        : base(resourceName, "Microsoft.EventGrid/partnerTopics/eventSubscriptions", resourceVersion ?? "2022-06-15", context)
    {
        ...
        _parent = ResourceReference<PartnerTopic>.DefineResource(this, "Parent", ["parent"], isRequired: true);
    }
