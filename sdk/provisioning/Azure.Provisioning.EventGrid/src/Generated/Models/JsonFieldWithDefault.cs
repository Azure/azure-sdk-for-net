...
public partial class JsonFieldWithDefault : ProvisionableConstruct
{
    ...
    /// </summary>
    public BicepValue<string> DefaultValue { get => _defaultValue; set => _defaultValue.Assign(value); }
    ...
    {
        _sourceField = BicepValue<string>.DefineProperty(this, "SourceField", ["sourceField"]);
        _defaultValue = BicepValue<string>.DefineProperty(this, "DefaultValue", ["defaultValue"]);
    }
}
