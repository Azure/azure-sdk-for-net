...
/// </summary>
public partial class FiltersConfiguration : ProvisioningConstruct
{
    /// <summary>
    ...
    /// </summary>
    public BicepList<EventGridFilter> Filters { get => _filters; set => _filters.Assign(value); }
    private readonly BicepList<EventGridFilter> _filters;
    ...
    public FiltersConfiguration()
    {
        ...
        _filters = BicepList<EventGridFilter>.DefineProperty(this, "Filters", ["filters"]);
    }
}
