...
### Create a basic CognitiveServices resource
...
// Create a CognitiveServices resource
// Note: Specific resource types and properties vary by service
// Refer to the Azure.Provisioning.CognitiveServices API documentation for detailed resource configuration

infrastructure.Add(/* Add your CognitiveServices resources here */);
