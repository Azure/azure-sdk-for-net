...
### Create a basic ContainerRegistry resource
...
// Refer to the Azure.Provisioning.ContainerRegistry API documentation for detailed resource configuration

infrastructure.Add(/* Add your ContainerRegistry resources here */);
