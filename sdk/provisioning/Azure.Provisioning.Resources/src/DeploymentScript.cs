...
namespace Azure.Provisioning.Resources
{
    ...
    public class DeploymentScript : Resource<AzureCliScript>
    {
        ...
        public DeploymentScript(IConstruct scope, IEnumerable<ScriptEnvironmentVariable> scriptEnvironmentVariables, string scriptContent, string name = "script", string version = DefaultVersion, AzureLocation? location = default)
            : this(scope, null, name, version, (name) => ArmResourcesModelFactory.AzureCliScript(
                name: name,
        ...
        /// <param name="version">The resource version.</param>
        /// <param name="location">The resource location.</param>
        public DeploymentScript(IConstruct scope, string name, Resource database, Parameter databaseServerName, Parameter appUserPasswordSecret, Parameter sqlAdminPasswordSecret, string version = DefaultVersion, AzureLocation? location = default)
            : this(scope, null, name, version, (name) => ArmResourcesModelFactory.AzureCliScript(
                name: name,
                resourceType: ResourceTypeName,
                location: location ?? Environment.GetEnvironmentVariable("AZURE_LOCATION") ?? AzureLocation.WestUS,
