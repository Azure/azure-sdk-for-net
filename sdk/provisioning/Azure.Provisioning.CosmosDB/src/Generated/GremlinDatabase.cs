...
public partial class GremlinDatabase : ProvisionableResource
{
    ...
    public GremlinDatabase(string bicepIdentifier, string? resourceVersion = default)
        : base(bicepIdentifier, "Microsoft.DocumentDB/databaseAccounts/gremlinDatabases", resourceVersion ?? "2024-11-15")
    {
    }

    /// <summary>
    /// Define all the provisionable properties of GremlinDatabase.
    /// </summary>
    protected override void DefineProvisionableProperties()
    {
        _name = DefineProperty<string>("Name", ["name"], isRequired: true);
        _location = DefineProperty<AzureLocation>("Location", ["location"], isRequired: true);
        _resource = DefineModelProperty<GremlinDatabaseResourceInfo>("Resource", ["properties", "resource"], isRequired: true);
