...
public partial class CosmosDBTable : Resource
{
    ...
    public CosmosDBTable(string resourceName, string? resourceVersion = default, ProvisioningContext? context = default)
        : base(resourceName, "Microsoft.DocumentDB/databaseAccounts/tables", resourceVersion, context)
    {
