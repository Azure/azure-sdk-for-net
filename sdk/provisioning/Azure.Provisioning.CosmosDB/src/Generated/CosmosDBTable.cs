...
public partial class CosmosDBTable : Resource
{
    ...
    /// </summary>
    public BicepValue<CosmosDBTableResourceInfo> Resource { get => _resource; set => _resource.Assign(value); }
    private readonly BicepValue<CosmosDBTableResourceInfo> _resource;
    ...
    public CosmosDBTable(string bicepIdentifier, string? resourceVersion = default)
        : base(bicepIdentifier, "Microsoft.DocumentDB/databaseAccounts/tables", resourceVersion ?? "2024-08-15")
    {
        _name = BicepValue<string>.DefineProperty(this, "Name", ["name"], isRequired: true);
        _location = BicepValue<AzureLocation>.DefineProperty(this, "Location", ["location"], isRequired: true);
        _resource = BicepValue<CosmosDBTableResourceInfo>.DefineProperty(this, "Resource", ["properties", "resource"], isRequired: true);
    ...
    public static CosmosDBTable FromExisting(string bicepIdentifier, string? resourceVersion = default) =>
