...
public partial class CosmosTableThroughputSetting : Resource
{
    ...
    /// <summary>
    /// Gets or sets a reference to the parent CosmosDBTable.
    /// </summary>
    public CosmosDBTable? Parent { get => _parent!.Value; set => _parent!.Value = value; }
    private readonly ResourceReference<CosmosDBTable> _parent;
    ...
    public CosmosTableThroughputSetting(string resourceName, string? resourceVersion = default, ProvisioningContext? context = default)
        : base(resourceName, "Microsoft.DocumentDB/databaseAccounts/tables/throughputSettings", resourceVersion, context)
    {
        ...
        _parent = ResourceReference<CosmosDBTable>.DefineResource(this, "Parent", ["parent"], isRequired: true);
    }
