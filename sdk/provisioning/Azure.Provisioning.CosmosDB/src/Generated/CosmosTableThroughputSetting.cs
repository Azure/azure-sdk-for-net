...
public partial class CosmosTableThroughputSetting : ProvisionableResource
{
    ...
    /// </summary>
    public CosmosDBTable? Parent
    {
        get { Initialize(); return _parent!.Value; }
        set { Initialize(); _parent!.Value = value; }
    }
    private ResourceReference<CosmosDBTable>? _parent;
    ...
    public CosmosTableThroughputSetting(string bicepIdentifier, string? resourceVersion = default)
        : base(bicepIdentifier, "Microsoft.DocumentDB/databaseAccounts/tables/throughputSettings", resourceVersion ?? "2024-11-15")
    {
    }

    /// <summary>
    /// Define all the provisionable properties of CosmosTableThroughputSetting.
    /// </summary>
    protected override void DefineProvisionableProperties()
    {
        ...
        _parent = DefineResource<CosmosDBTable>("Parent", ["parent"], isRequired: true);
    }
