...
public partial class CosmosDBSqlTrigger : ProvisionableResource
{
    ...
    private CosmosDBSqlTriggerResourceInfo? _resource;
    ...
    public CosmosDBSqlTrigger(string bicepIdentifier, string? resourceVersion = default)
        : base(bicepIdentifier, "Microsoft.DocumentDB/databaseAccounts/sqlDatabases/containers/triggers", resourceVersion ?? "2025-04-15")
    {
    }

    /// <summary>
    /// Define all the provisionable properties of CosmosDBSqlTrigger.
    /// </summary>
    protected override void DefineProvisionableProperties()
    {
        _name = DefineProperty<string>("Name", ["name"], isRequired: true);
        _location = DefineProperty<AzureLocation>("Location", ["location"], isRequired: true);
        _resource = DefineModelProperty<CosmosDBSqlTriggerResourceInfo>("Resource", ["properties", "resource"], isRequired: true);
