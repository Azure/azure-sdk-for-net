...
/// </summary>
public partial class CassandraViewThroughputSetting : Resource
{
    /// <summary>
    /// Gets the Name.
    /// </summary>
    ...
    /// </summary>
    public CassandraViewGetResult? Parent { get => _parent!.Value; set => _parent!.Value = value; }
    private readonly ResourceReference<CassandraViewGetResult> _parent;
    ...
    public CassandraViewThroughputSetting(string bicepIdentifier, string? resourceVersion = default)
        : base(bicepIdentifier, "Microsoft.DocumentDB/databaseAccounts/cassandraKeyspaces/views/throughputSettings", resourceVersion ?? "2024-08-15")
    {
        ...
        _parent = ResourceReference<CassandraViewGetResult>.DefineResource(this, "Parent", ["parent"], isRequired: true);
    }
