...
public partial class CassandraTable : Resource
{
    ...
    public CassandraTable(string resourceName, string? resourceVersion = default, ProvisioningContext? context = default)
        : base(resourceName, "Microsoft.DocumentDB/databaseAccounts/cassandraKeyspaces/tables", resourceVersion, context)
    {
