...
public partial class GremlinGraphThroughputSetting : ProvisionableResource
{
    ...
    /// <summary>
    /// Gets or sets a reference to the parent GremlinGraph.
    /// </summary>
    public GremlinGraph? Parent { get => _parent!.Value; set => _parent!.Value = value; }
    private readonly ResourceReference<GremlinGraph> _parent;
    ...
    public GremlinGraphThroughputSetting(string bicepIdentifier, string? resourceVersion = default)
        : base(bicepIdentifier, "Microsoft.DocumentDB/databaseAccounts/gremlinDatabases/graphs/throughputSettings", resourceVersion ?? "2024-08-15")
    {
        ...
        _parent = ResourceReference<GremlinGraph>.DefineResource(this, "Parent", ["parent"], isRequired: true);
    }
    ...
    public static GremlinGraphThroughputSetting FromExisting(string bicepIdentifier, string? resourceVersion = default) =>
