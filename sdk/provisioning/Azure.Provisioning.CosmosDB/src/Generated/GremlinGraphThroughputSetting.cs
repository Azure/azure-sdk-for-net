...
public partial class GremlinGraphThroughputSetting : ProvisionableResource
{
    ...
    /// </summary>
    public GremlinGraph? Parent
    {
        get { Initialize(); return _parent!.Value; }
        set { Initialize(); _parent!.Value = value; }
    }
    private ResourceReference<GremlinGraph>? _parent;
    ...
    public GremlinGraphThroughputSetting(string bicepIdentifier, string? resourceVersion = default)
        : base(bicepIdentifier, "Microsoft.DocumentDB/databaseAccounts/gremlinDatabases/graphs/throughputSettings", resourceVersion ?? "2025-04-15")
    {
    }
    ...
    protected override void DefineProvisionableProperties()
    {
        ...
        _parent = DefineResource<GremlinGraph>("Parent", ["parent"], isRequired: true);
    }
