...
/// <summary>
/// CosmosDBTableRoleDefinition.
/// </summary>
public partial class CosmosDBTableRoleDefinition : ProvisionableResource
{
    /// <summary>
    /// Gets the Name.
    /// </summary>
    ...
    /// <summary>
    /// A set of fully qualified Scopes at or below which Table Role
    ...
    /// any underlying Database / Collection. Must have at least one element.
    /// Scopes higher than Database account are not enforceable as assignable
    /// Scopes. Note that resources referenced in assignable Scopes need not
    /// exist.
    /// </summary>
    ...
    {
        get { Initialize(); return _pathId!; }
        set { Initialize(); _pathId!.Assign(value); }
    }
    ...
    /// </summary>
    public BicepList<CosmosDBTableRolePermission> Permissions 
    {
        get { Initialize(); return _permissions!; }
        set { Initialize(); _permissions!.Assign(value); }
    }
    private BicepList<CosmosDBTableRolePermission>? _permissions;
    ...
    /// <summary>
    /// Creates a new CosmosDBTableRoleDefinition.
    /// </summary>
    /// <param name="bicepIdentifier">
    /// The the Bicep identifier name of the CosmosDBTableRoleDefinition
    /// resource.  This can be used to refer to the resource in expressions,
    /// but is not the Azure name of the resource.  This value can contain
    /// letters, numbers, and underscores.
    /// </param>
    /// <param name="resourceVersion">Version of the CosmosDBTableRoleDefinition.</param>
    public CosmosDBTableRoleDefinition(string bicepIdentifier, string? resourceVersion = default)
        : base(bicepIdentifier, "Microsoft.DocumentDB/databaseAccounts/tableRoleDefinitions", resourceVersion ?? "2025-04-15")
    {
    }

    /// <summary>
    /// Define all the provisionable properties of CosmosDBTableRoleDefinition.
    /// </summary>
    protected override void DefineProvisionableProperties()
    {
        _name = DefineProperty<string>("Name", ["name"], isOutput: true);
        _roleDefinitionId = DefineProperty<string>("RoleDefinitionId", ["RoleDefinitionId"], isRequired: true);
        _assignableScopes = DefineListProperty<string>("AssignableScopes", ["properties", "assignableScopes"]);
        _pathId = DefineProperty<string>("PathId", ["properties", "id"]);
        _permissions = DefineListProperty<CosmosDBTableRolePermission>("Permissions", ["properties", "permissions"]);
    ...
    /// <summary>
    /// Supported CosmosDBTableRoleDefinition resource versions.
    /// </summary>
    ...
    /// <summary>
    /// Creates a reference to an existing CosmosDBTableRoleDefinition.
    /// </summary>
    /// <param name="bicepIdentifier">
    /// The the Bicep identifier name of the CosmosDBTableRoleDefinition
    /// resource.  This can be used to refer to the resource in expressions,
    ...
    /// </param>
    /// <param name="resourceVersion">Version of the CosmosDBTableRoleDefinition.</param>
    /// <returns>The existing CosmosDBTableRoleDefinition resource.</returns>
    public static CosmosDBTableRoleDefinition FromExisting(string bicepIdentifier, string? resourceVersion = default) =>
