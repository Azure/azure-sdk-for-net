...
public partial class MongoDBCollection : ProvisionableResource
{
    ...
    public MongoDBCollection(string bicepIdentifier, string? resourceVersion = default)
        : base(bicepIdentifier, "Microsoft.DocumentDB/databaseAccounts/mongodbDatabases/collections", resourceVersion ?? "2025-04-15")
    {
    }

    /// <summary>
    /// Define all the provisionable properties of MongoDBCollection.
    /// </summary>
    protected override void DefineProvisionableProperties()
    {
        _name = DefineProperty<string>("Name", ["name"], isRequired: true);
        _location = DefineProperty<AzureLocation>("Location", ["location"], isRequired: true);
        _resource = DefineModelProperty<MongoDBCollectionResourceInfo>("Resource", ["properties", "resource"], isRequired: true);
