...
public partial class MongoDBDatabase : Resource
{
    ...
    /// </summary>
    public BicepValue<MongoDBDatabaseResourceInfo> Resource { get => _resource; set => _resource.Assign(value); }
    private readonly BicepValue<MongoDBDatabaseResourceInfo> _resource;
        ...
        : base(bicepIdentifier, "Microsoft.DocumentDB/databaseAccounts/mongodbDatabases", resourceVersion ?? "2024-08-15")
    {
        ...
        _resource = BicepValue<MongoDBDatabaseResourceInfo>.DefineProperty(this, "Resource", ["properties", "resource"], isRequired: true);
