...
public partial class CosmosDBSqlStoredProcedure : ProvisionableResource
{
    ...
    public CosmosDBSqlStoredProcedure(string bicepIdentifier, string? resourceVersion = default)
        : base(bicepIdentifier, "Microsoft.DocumentDB/databaseAccounts/sqlDatabases/containers/storedProcedures", resourceVersion ?? "2025-04-15")
    {
    }

    /// <summary>
    /// Define all the provisionable properties of CosmosDBSqlStoredProcedure.
    /// </summary>
    protected override void DefineProvisionableProperties()
    {
        _name = DefineProperty<string>("Name", ["name"], isRequired: true);
        _location = DefineProperty<AzureLocation>("Location", ["location"], isRequired: true);
        _resource = DefineModelProperty<CosmosDBSqlStoredProcedureResourceInfo>("Resource", ["properties", "resource"], isRequired: true);
