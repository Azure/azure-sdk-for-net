...
### Create a basic CosmosDB resource
...
// Refer to the Azure.Provisioning.CosmosDB API documentation for detailed resource configuration

infrastructure.Add(/* Add your CosmosDB resources here */);
