...
### Create a basic Communication resource
...
// Refer to the Azure.Provisioning.Communication API documentation for detailed resource configuration

infrastructure.Add(/* Add your Communication resources here */);
