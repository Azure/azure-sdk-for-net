...
public partial class AgentPoolUpgradeSettings : ProvisionableConstruct
{
    ...
    /// </summary>
    public BicepValue<string> MaxSurge { get => _maxSurge; set => _maxSurge.Assign(value); }
    private readonly BicepValue<string> _maxSurge;
    ...
    /// </summary>
    public BicepValue<int> DrainTimeoutInMinutes { get => _drainTimeoutInMinutes; set => _drainTimeoutInMinutes.Assign(value); }
    private readonly BicepValue<int> _drainTimeoutInMinutes;
    ...
    {
        _maxSurge = BicepValue<string>.DefineProperty(this, "MaxSurge", ["maxSurge"]);
        _drainTimeoutInMinutes = BicepValue<int>.DefineProperty(this, "DrainTimeoutInMinutes", ["drainTimeoutInMinutes"]);
    }
}
