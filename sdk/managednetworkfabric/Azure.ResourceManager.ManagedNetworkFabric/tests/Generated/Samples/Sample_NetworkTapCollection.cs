...
namespace Azure.ResourceManager.ManagedNetworkFabric.Samples
{
    public partial class Sample_NetworkTapCollection
    {
        ...
        {
            // Generated from example definition: 2025-07-15/NetworkTaps_Create.json
            // this example is just showing the usage of "NetworkTap_Create" operation, for the dependent resources, they will have to be created separately.
            ...
            NetworkTapData data = new NetworkTapData(new AzureLocation("eastuseuap"), null, null)
            {
...
["keyId"] = "keyValue"
        ...
        {
            // Generated from example definition: 2025-07-15/NetworkTaps_Get.json
            // this example is just showing the usage of "NetworkTap_Get" operation, for the dependent resources, they will have to be created separately.
        ...
        {
            // Generated from example definition: 2025-07-15/NetworkTaps_ListByResourceGroup.json
            // this example is just showing the usage of "NetworkTap_ListByResourceGroup" operation, for the dependent resources, they will have to be created separately.
