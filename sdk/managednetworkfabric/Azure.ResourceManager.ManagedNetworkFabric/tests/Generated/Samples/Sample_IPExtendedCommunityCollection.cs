...
namespace Azure.ResourceManager.ManagedNetworkFabric.Samples
{
    public partial class Sample_IPExtendedCommunityCollection
    {
        ...
        public async Task CreateOrUpdate_IpExtendedCommunitiesCreateMaximumSetGen()
        {
            ...
            // this example is just showing the usage of "IpExtendedCommunity_Create" operation, for the dependent resources, they will have to be created separately.
            ...
            IPExtendedCommunityData data = new IPExtendedCommunityData(new AzureLocation("eastus"), null)
            {
                Tags =
{
["KeyId"] = "KeyValue"
        ...
        public async Task GetAll_IpExtendedCommunitiesListByResourceGroupMaximumSetGen()
        {
            ...
            // this example is just showing the usage of "IpExtendedCommunity_ListByResourceGroup" operation, for the dependent resources, they will have to be created separately.
        ...
        public async Task GetIfExists_IpExtendedCommunitiesGetMaximumSetGen()
        {
            ...
            // invoke the operation
            string ipExtendedCommunityName = "example-ipExtendedCommunity";
            NullableResponse<IPExtendedCommunityResource> response = await collection.GetIfExistsAsync(ipExtendedCommunityName);
            IPExtendedCommunityResource result = response.HasValue ? response.Value : null;
