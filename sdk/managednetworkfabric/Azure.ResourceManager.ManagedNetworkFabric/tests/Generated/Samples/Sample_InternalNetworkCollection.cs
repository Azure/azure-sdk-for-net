...
namespace Azure.ResourceManager.ManagedNetworkFabric.Samples
{
    public partial class Sample_InternalNetworkCollection
    {
        ...
        {
            // Generated from example definition: 2025-07-15/InternalNetworks_Create.json
            // this example is just showing the usage of "InternalNetwork_Create" operation, for the dependent resources, they will have to be created separately.
            ...
            InternalNetworkData data = new InternalNetworkData(default);
        ...
        public async Task GetAll_InternalNetworksListByL3IsolationDomainMaximumSetGen()
        {
            ...
            // this example is just showing the usage of "InternalNetwork_ListByL3IsolationDomain" operation, for the dependent resources, they will have to be created separately.
        ...
        public async Task GetIfExists_InternalNetworksGetMaximumSetGen()
        {
            ...
            // invoke the operation
            string internalNetworkName = "example-internalnetwork";
            NullableResponse<InternalNetworkResource> response = await collection.GetIfExistsAsync(internalNetworkName);
            InternalNetworkResource result = response.HasValue ? response.Value : null;
