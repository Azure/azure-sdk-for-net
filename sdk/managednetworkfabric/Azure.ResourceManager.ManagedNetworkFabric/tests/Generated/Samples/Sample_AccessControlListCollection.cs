...
namespace Azure.ResourceManager.ManagedNetworkFabric.Samples
{
    public partial class Sample_AccessControlListCollection
    {
        ...
        public async Task CreateOrUpdate_AccessControlListsCreateMaximumSetGen()
        {
            ...
            // this example is just showing the usage of "AccessControlList_Create" operation, for the dependent resources, they will have to be created separately.
            ...
            AccessControlListData data = new AccessControlListData(new AzureLocation("eastUs"), default)
            {
                Tags =
{
["keyID"] = "keyValue"
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task CreateOrUpdate_AccessControlListsCreateMaximumSetGenGeneratedByMaximumSetRule()
        {
            ...
            string resourceGroupName = "example-resource-group";
            ResourceIdentifier resourceGroupResourceId = ResourceGroupResource.CreateResourceIdentifier(subscriptionId, resourceGroupName);
            ResourceGroupResource resourceGroupResource = client.GetResourceGroupResource(resourceGroupResourceId);
...
["key5032"] = "example-tag-value"
        ...
        public async Task GetAll_AccessControlListsListByResourceGroupMaximumSetGen()
        {
            ...
            // this example is just showing the usage of "AccessControlList_ListByResourceGroup" operation, for the dependent resources, they will have to be created separately.
        ...
        public async Task GetIfExists_AccessControlListsGetMaximumSetGen()
        {
            ...
            // invoke the operation
            string accessControlListName = "example-acl";
            NullableResponse<AccessControlListResource> response = await collection.GetIfExistsAsync(accessControlListName);
            AccessControlListResource result = response.HasValue ? response.Value : null;
