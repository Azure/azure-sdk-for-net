...
namespace Azure.ResourceManager.ManagedNetworkFabric.Samples
{
    public partial class Sample_NetworkFabricInternetGatewayRuleCollection
    {
        ...
        {
            // Generated from example definition: specification/managednetworkfabric/resource-manager/Microsoft.ManagedNetworkFabric/preview/2024-06-15-preview/examples/InternetGatewayRules_Create.json
            ...
            NetworkFabricInternetGatewayRuleData data = new NetworkFabricInternetGatewayRuleData(new AzureLocation("eastus"), new InternetGatewayRuleProperties(new InternetGatewayRules(InternetGatewayRuleAction.Allow)
            {
                AddressList = { "10.10.10.10" },
                Condition = RuleCondition.Or,
                DestinationAddressList = { "11.11.10.11" },
                SourceAddressList = { "10.10.10.10" },
                HeaderAddressList = {new HeaderAddressProperties
{
...
["KeyID"] = "KeyValue"
        ...
        {
            // Generated from example definition: specification/managednetworkfabric/resource-manager/Microsoft.ManagedNetworkFabric/preview/2024-06-15-preview/examples/InternetGatewayRules_Get.json
            ...
            // invoke the operation
            string internetGatewayRuleName = "example-internetGatewayRule";
            NetworkFabricInternetGatewayRuleResource result = await collection.GetAsync(internetGatewayRuleName);
        ...
        {
            // Generated from example definition: specification/managednetworkfabric/resource-manager/Microsoft.ManagedNetworkFabric/preview/2024-06-15-preview/examples/InternetGatewayRules_ListByResourceGroup.json
        ...
        public async Task GetIfExists_InternetGatewayRulesGetMaximumSetGen()
        {
            ...
            // invoke the operation
            string internetGatewayRuleName = "example-internetGatewayRule";
            NullableResponse<NetworkFabricInternetGatewayRuleResource> response = await collection.GetIfExistsAsync(internetGatewayRuleName);
            NetworkFabricInternetGatewayRuleResource result = response.HasValue ? response.Value : null;
