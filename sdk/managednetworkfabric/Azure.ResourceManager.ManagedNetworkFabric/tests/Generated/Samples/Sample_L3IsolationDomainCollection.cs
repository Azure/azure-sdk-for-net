...
namespace Azure.ResourceManager.ManagedNetworkFabric.Samples
{
    public partial class Sample_L3IsolationDomainCollection
    {
        ...
        public async Task CreateOrUpdate_L3IsolationDomainsCreateMaximumSetGen()
        {
            ...
            // this example is just showing the usage of "L3IsolationDomain_Create" operation, for the dependent resources, they will have to be created separately.
            ...
            L3IsolationDomainData data = new L3IsolationDomainData(new AzureLocation("eastus"), null)
            {
...
["KeyId"] = "KeyValue"
        ...
        public async Task GetAll_L3IsolationDomainsListByResourceGroupMaximumSetGen()
        {
            ...
            // this example is just showing the usage of "L3IsolationDomain_ListByResourceGroup" operation, for the dependent resources, they will have to be created separately.
        ...
        public async Task GetIfExists_L3IsolationDomainsGetMaximumSetGen()
        {
            ...
            // invoke the operation
            string l3IsolationDomainName = "example-l3domain";
            NullableResponse<L3IsolationDomainResource> response = await collection.GetIfExistsAsync(l3IsolationDomainName);
            L3IsolationDomainResource result = response.HasValue ? response.Value : null;
