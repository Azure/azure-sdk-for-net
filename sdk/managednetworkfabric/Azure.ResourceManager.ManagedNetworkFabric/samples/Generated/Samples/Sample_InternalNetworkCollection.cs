...
namespace Azure.ResourceManager.Azure.ResourceManager.ManagedNetworkFabric.Samples
{
    public partial class Sample_InternalNetworkCollection
    {
        ...
        public async Task CreateOrUpdate_InternalNetworksCreateMaximumSetGen()
        {
            ...
            ManagedNetworkFabric.InternalNetworkCollection collection = l3IsolationDomain.GetInternalNetworks();

            // invoke the operation
            string internalNetworkName = "example-internalnetwork";
            ManagedNetworkFabric.InternalNetworkData data = new ManagedNetworkFabric.InternalNetworkData(501)
            {
                Mtu = 1500,
...
Address = "2fff::",
            ...
            ArmOperation<ManagedNetworkFabric.InternalNetworkResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, internalNetworkName, data);
        ...
        public async Task Get_InternalNetworksGetMaximumSetGen()
        {
            ...
            // invoke the operation
            string internalNetworkName = "example-internalnetwork";
            ManagedNetworkFabric.InternalNetworkResource result = await collection.GetAsync(internalNetworkName);
        ...
        public async Task GetAll_InternalNetworksListMaximumSetGen()
        {
            ...
            await foreach (ManagedNetworkFabric.InternalNetworkResource item in collection.GetAllAsync())
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                ManagedNetworkFabric.InternalNetworkData resourceData = item.Data;
                // for demo we just print out the id
                Console.WriteLine($"Succeeded on id: {resourceData.Id}");
            }
