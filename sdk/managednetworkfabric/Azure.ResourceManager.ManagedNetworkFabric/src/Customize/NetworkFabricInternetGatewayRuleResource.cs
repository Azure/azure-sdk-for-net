...
namespace Azure.ResourceManager.ManagedNetworkFabric
{
    public partial class NetworkFabricInternetGatewayRuleResource
    {
        ...
        public virtual Task<ArmOperation<NetworkFabricInternetGatewayRuleResource>> UpdateAsync(WaitUntil waitUntil, NetworkFabricInternetGatewayRulePatch patch, CancellationToken cancellationToken = default)
        {
            throw new NotSupportedException("This compatibility method is obsolete and will be removed in a future version. Use UpdateAsync(WaitUntil, NetworkFabricInternetGatewayRulePatchContent, CancellationToken) instead.");
        }
        ...
        {
            throw new NotSupportedException("This compatibility method is obsolete and will be removed in a future version. Use Update(WaitUntil, NetworkFabricInternetGatewayRulePatchContent, CancellationToken) instead.");
        }
    }
}
