...
namespace Azure.ResourceManager.ManagedNetworkFabric
{
    public partial class NetworkPacketBrokerResource
    {
        ...
        public virtual Task<ArmOperation<NetworkPacketBrokerResource>> UpdateAsync(WaitUntil waitUntil, NetworkPacketBrokerPatch patch, CancellationToken cancellationToken = default)
        {
            throw new NotSupportedException("This compatibility method is obsolete and will be removed in a future version. Use UpdateAsync(WaitUntil, NetworkPacketBrokerPatchContent, CancellationToken) instead.");
        }
        ...
        {
            throw new NotSupportedException("This compatibility method is obsolete and will be removed in a future version. Use Update(WaitUntil, NetworkPacketBrokerPatchContent, CancellationToken) instead.");
        }
    }
}
