...
namespace Azure.ResourceManager.ManagedNetworkFabric
{
    ...
    public partial class NetworkDeviceResource
    {
        ...
        {
            var operation = await UpgradeAsync(waitUntil, new NetworkDeviceUpgradeContent(content?.Version ?? string.Empty), cancellationToken).ConfigureAwait(false);
            return new CompatArmOperation<NetworkDeviceUpgradeResult, StateUpdateCommonPostActionResult>(operation, r => new StateUpdateCommonPostActionResult(r.Error, null, null));
        }
        ...
        {
            var operation = Upgrade(waitUntil, new NetworkDeviceUpgradeContent(content?.Version ?? string.Empty), cancellationToken);
            return new CompatArmOperation<NetworkDeviceUpgradeResult, StateUpdateCommonPostActionResult>(operation, r => new StateUpdateCommonPostActionResult(r.Error, null, null));
        }
    }
}
