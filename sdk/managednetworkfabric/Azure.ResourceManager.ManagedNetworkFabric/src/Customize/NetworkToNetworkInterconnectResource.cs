...
namespace Azure.ResourceManager.ManagedNetworkFabric
{
    public partial class NetworkToNetworkInterconnectResource
    {
        ...
        /// <summary> Backward-compatible shim for UpdateNpbStaticRouteBfdAdministrativeState. Use UpdateNpbStaticRouteBfdAdministrativeStateWithTypedResult instead for richer result type. </summary>
        [EditorBrowsable(EditorBrowsableState.Never)]
        ...
        {
            var operation = await UpdateNpbStaticRouteBfdAdministrativeStateWithTypedResultAsync(waitUntil, content, cancellationToken).ConfigureAwait(false);
            return new CompatArmOperation<UpdateAdministrativeStateResult, StateUpdateCommonPostActionResult>(operation, r => new StateUpdateCommonPostActionResult(r.Error, null, null));
        }
        ...
        {
            var operation = UpdateNpbStaticRouteBfdAdministrativeStateWithTypedResult(waitUntil, content, cancellationToken);
            return new CompatArmOperation<UpdateAdministrativeStateResult, StateUpdateCommonPostActionResult>(operation, r => new StateUpdateCommonPostActionResult(r.Error, null, null));
        }
    }
}
