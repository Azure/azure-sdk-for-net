...
namespace Azure.ResourceManager.ManagedNetworkFabric
{
    ...
    public partial class NetworkFabricInternalNetworkResource
    {
        ...
        {
            throw new NotSupportedException("This overload is no longer supported. Use SetBgpAdministrativeStateAsync with InternalNetworkUpdateBgpAdministrativeStateContent instead.");
        }
        ...
        {
            throw new NotSupportedException("This overload is no longer supported. Use SetBgpAdministrativeState with InternalNetworkUpdateBgpAdministrativeStateContent instead.");
        }

        /// <summary> Backward-compatible shim for UpdateStaticRouteBfdAdministrativeState. Preserves the previous SDK signature while calling the current REST action. </summary>
        [EditorBrowsable(EditorBrowsableState.Never)]
