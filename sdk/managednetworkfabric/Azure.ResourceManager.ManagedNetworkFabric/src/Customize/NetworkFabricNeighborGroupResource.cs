...
namespace Azure.ResourceManager.ManagedNetworkFabric
{
    public partial class NetworkFabricNeighborGroupResource
    {
        ...
        public virtual Task<ArmOperation<NetworkFabricNeighborGroupResource>> UpdateAsync(WaitUntil waitUntil, NetworkFabricNeighborGroupPatch patch, CancellationToken cancellationToken = default)
        {
            throw new NotSupportedException("This compatibility method is obsolete and will be removed in a future version. Use UpdateAsync(WaitUntil, NetworkFabricNeighborGroupPatchContent, CancellationToken) instead.");
        }
        ...
        {
            throw new NotSupportedException("This compatibility method is obsolete and will be removed in a future version. Use Update(WaitUntil, NetworkFabricNeighborGroupPatchContent, CancellationToken) instead.");
        }
    }
}
