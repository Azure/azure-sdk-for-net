...
namespace Azure.ResourceManager.ManagedNetworkFabric
{
    public partial class NetworkFabricIPCommunityResource
    {
        ...
        public virtual Task<ArmOperation<NetworkFabricIPCommunityResource>> UpdateAsync(WaitUntil waitUntil, NetworkFabricIPCommunityPatch patch, CancellationToken cancellationToken = default)
        {
            throw new NotSupportedException("This compatibility method is obsolete and will be removed in a future version. Use UpdateAsync(WaitUntil, NetworkFabricIPCommunityPatchContent, CancellationToken) instead.");
        }
        ...
        {
            throw new NotSupportedException("This compatibility method is obsolete and will be removed in a future version. Use Update(WaitUntil, NetworkFabricIPCommunityPatchContent, CancellationToken) instead.");
        }
    }
}
