...
namespace Azure.ResourceManager.ManagedNetworkFabric
{
    public partial class NetworkFabricIPPrefixResource
    {
        ...
        public virtual Task<ArmOperation<NetworkFabricIPPrefixResource>> UpdateAsync(WaitUntil waitUntil, NetworkFabricIPPrefixPatch patch, CancellationToken cancellationToken = default)
        {
            throw new NotSupportedException("This compatibility method is obsolete and will be removed in a future version. Use UpdateAsync(WaitUntil, NetworkFabricIPPrefixPatchContent, CancellationToken) instead.");
        }
        ...
        {
            throw new NotSupportedException("This compatibility method is obsolete and will be removed in a future version. Use Update(WaitUntil, NetworkFabricIPPrefixPatchContent, CancellationToken) instead.");
        }
    }
}
