...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    public partial class NetworkFabricL2IsolationDomainPatch
    {
        ...
        private static NetworkFabricL2IsolationDomainPatch Deserialize(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<NetworkFabricL2IsolationDomainPatch>)new NetworkFabricL2IsolationDomainPatch()).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        private static NetworkFabricL2IsolationDomainPatch Deserialize(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<NetworkFabricL2IsolationDomainPatch>)new NetworkFabricL2IsolationDomainPatch()).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
