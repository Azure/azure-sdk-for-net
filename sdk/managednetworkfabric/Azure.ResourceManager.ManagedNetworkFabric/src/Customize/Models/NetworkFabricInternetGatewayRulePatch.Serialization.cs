...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    public partial class NetworkFabricInternetGatewayRulePatch
    {
        ...
        private static NetworkFabricInternetGatewayRulePatch Deserialize(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<NetworkFabricInternetGatewayRulePatch>)new NetworkFabricInternetGatewayRulePatch()).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        private static NetworkFabricInternetGatewayRulePatch Deserialize(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<NetworkFabricInternetGatewayRulePatch>)new NetworkFabricInternetGatewayRulePatch()).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
