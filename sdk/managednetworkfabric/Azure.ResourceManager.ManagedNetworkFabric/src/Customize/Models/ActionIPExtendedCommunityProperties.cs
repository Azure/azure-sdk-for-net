...
{
    // The shipped SDK exposed flat Add/Delete/Set IP extended community ID lists while the generated model
    // now represents them as nested add/delete/set objects. These suppressions keep the custom flattened
    ...
    [CodeGenSuppress("AddIPExtendedCommunityIds")]
