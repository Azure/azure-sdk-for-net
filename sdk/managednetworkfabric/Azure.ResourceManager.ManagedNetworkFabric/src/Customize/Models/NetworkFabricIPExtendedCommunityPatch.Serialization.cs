...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    public partial class NetworkFabricIPExtendedCommunityPatch
    {
        ...
        private static NetworkFabricIPExtendedCommunityPatch Deserialize(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<NetworkFabricIPExtendedCommunityPatch>)new NetworkFabricIPExtendedCommunityPatch()).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        private static NetworkFabricIPExtendedCommunityPatch Deserialize(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<NetworkFabricIPExtendedCommunityPatch>)new NetworkFabricIPExtendedCommunityPatch()).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
