...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    public partial class NetworkFabricNeighborGroupPatch
    {
        ...
        private static NetworkFabricNeighborGroupPatch Deserialize(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<NetworkFabricNeighborGroupPatch>)new NetworkFabricNeighborGroupPatch()).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        private static NetworkFabricNeighborGroupPatch Deserialize(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<NetworkFabricNeighborGroupPatch>)new NetworkFabricNeighborGroupPatch()).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
