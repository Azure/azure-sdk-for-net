...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    public partial class NetworkFabricL3IsolationDomainPatch
    {
        ...
        private static NetworkFabricL3IsolationDomainPatch Deserialize(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<NetworkFabricL3IsolationDomainPatch>)new NetworkFabricL3IsolationDomainPatch()).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        private static NetworkFabricL3IsolationDomainPatch Deserialize(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<NetworkFabricL3IsolationDomainPatch>)new NetworkFabricL3IsolationDomainPatch()).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
