...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    public partial class NetworkFabricIPCommunityPatch
    {
        ...
        private static NetworkFabricIPCommunityPatch Deserialize(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<NetworkFabricIPCommunityPatch>)new NetworkFabricIPCommunityPatch()).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        private static NetworkFabricIPCommunityPatch Deserialize(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<NetworkFabricIPCommunityPatch>)new NetworkFabricIPCommunityPatch()).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
