...
namespace Azure.ResourceManager.ManagedNetworkFabric
{
    public partial class NetworkFabricL3IsolationDomainResource
    {
        ...
        public virtual Task<ArmOperation<NetworkFabricL3IsolationDomainResource>> UpdateAsync(WaitUntil waitUntil, NetworkFabricL3IsolationDomainPatch patch, CancellationToken cancellationToken = default)
        {
            throw new NotSupportedException("This compatibility method is obsolete and will be removed in a future version. Use UpdateAsync(WaitUntil, NetworkFabricL3IsolationDomainPatchContent, CancellationToken) instead.");
        }
        ...
        {
            throw new NotSupportedException("This compatibility method is obsolete and will be removed in a future version. Use Update(WaitUntil, NetworkFabricL3IsolationDomainPatchContent, CancellationToken) instead.");
        }
