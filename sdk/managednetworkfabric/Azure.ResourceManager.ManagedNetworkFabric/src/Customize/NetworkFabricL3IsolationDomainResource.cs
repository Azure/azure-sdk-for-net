...
namespace Azure.ResourceManager.ManagedNetworkFabric
{
    ...
    public partial class NetworkFabricL3IsolationDomainResource
    {
        ...
        public virtual async Task<ArmOperation<DeviceUpdateCommonPostActionResult>> UpdateAdministrativeStateAsync(WaitUntil waitUntil, UpdateAdministrativeStateContent content, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _l3IsolationDomainsClientDiagnostics.CreateScope("NetworkFabricL3IsolationDomainResource.UpdateAdministrativeState");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _l3IsolationDomainsRestClient.CreateUpdateAdministrativeStateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, UpdateAdministrativeStateContent.ToRequestContent(content), context);
