...
namespace Azure.ResourceManager.ManagedNetworkFabric
{
    ...
    // This preserves the old constructor signature from v1.1.2 that only required location; removing it
    // would break callers using the shipped constructor.
    public partial class NetworkFabricNeighborGroupData
    {
        ...
        public NetworkFabricNeighborGroupData(AzureLocation location)
        {
