...
namespace Azure.ResourceManager.ManagedNetworkFabric
{
    public partial class NetworkFabricL2IsolationDomainResource
    {
        ...
        public virtual Task<ArmOperation<NetworkFabricL2IsolationDomainResource>> UpdateAsync(WaitUntil waitUntil, NetworkFabricL2IsolationDomainPatch patch, CancellationToken cancellationToken = default)
        {
            throw new NotSupportedException("This compatibility method is obsolete and will be removed in a future version. Use UpdateAsync(WaitUntil, NetworkFabricL2IsolationDomainPatchContent, CancellationToken) instead.");
        }
        ...
        {
            throw new NotSupportedException("This compatibility method is obsolete and will be removed in a future version. Use Update(WaitUntil, NetworkFabricL2IsolationDomainPatchContent, CancellationToken) instead.");
        }
