...
namespace Azure.ResourceManager.ManagedNetworkFabric
{
    public partial class NetworkFabricIPPrefixData : IUtf8JsonSerializable, IJsonModel<NetworkFabricIPPrefixData>
    {
        ...
        void IJsonModel<NetworkFabricIPPrefixData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (!(IPPrefixRules is ChangeTrackingList<IPPrefixRule> collection0 && collection0.IsUndefined))
            {
        ...
        internal static NetworkFabricIPPrefixData DeserializeNetworkFabricIPPrefixData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new NetworkFabricIPPrefixData(id, name, type, systemData.Value, tags ?? new ChangeTrackingDictionary<string, string>(), location, annotation.Value, ipPrefixRules ?? new ChangeTrackingList<IPPrefixRule>(), Optional.ToNullable(configurationState), Optional.ToNullable(provisioningState), Optional.ToNullable(administrativeState), serializedAdditionalRawData);
        }
