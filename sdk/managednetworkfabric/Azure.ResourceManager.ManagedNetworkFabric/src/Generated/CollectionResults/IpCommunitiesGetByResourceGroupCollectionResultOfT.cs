...
{
    internal partial class IpCommunitiesGetByResourceGroupCollectionResultOfT : Pageable<NetworkFabricIPCommunityData>
    {
        ...
        /// <summary> Initializes a new instance of IpCommunitiesGetByResourceGroupCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public IpCommunitiesGetByResourceGroupCollectionResultOfT(IpCommunities client, Guid subscriptionId, string resourceGroupName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of IpCommunitiesGetByResourceGroupCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of IpCommunitiesGetByResourceGroupCollectionResultOfT as an enumerable collection. </returns>
