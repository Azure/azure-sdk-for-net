...
{
    internal partial class IpCommunitiesGetBySubscriptionCollectionResultOfT : Pageable<NetworkFabricIPCommunityData>
    {
        ...
        public IpCommunitiesGetBySubscriptionCollectionResultOfT(IpCommunities client, Guid subscriptionId, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
