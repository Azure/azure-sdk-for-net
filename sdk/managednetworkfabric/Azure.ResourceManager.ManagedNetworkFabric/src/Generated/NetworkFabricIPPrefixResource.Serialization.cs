...
namespace Azure.ResourceManager.ManagedNetworkFabric
{
    ...
    {
        private static IJsonModel<NetworkFabricIPPrefixData> s_dataDeserializationInstance;

        private static IJsonModel<NetworkFabricIPPrefixData> DataDeserializationInstance => s_dataDeserializationInstance ??= new NetworkFabricIPPrefixData();
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        NetworkFabricIPPrefixData IJsonModel<NetworkFabricIPPrefixData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => DataDeserializationInstance.Create(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<NetworkFabricIPPrefixData>.GetFormatFromOptions(ModelReaderWriterOptions options) => DataDeserializationInstance.GetFormatFromOptions(options);
    }
}
