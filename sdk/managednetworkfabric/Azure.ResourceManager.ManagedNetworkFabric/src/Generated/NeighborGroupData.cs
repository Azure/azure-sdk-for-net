...
namespace Azure.ResourceManager.ManagedNetworkFabric
{
    ...
    public partial class NeighborGroupData : TrackedResourceData
    {
        ...
        public NeighborGroupData(AzureLocation location) : base(location)
        {
        ...
        internal NeighborGroupData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, string annotation, NeighborGroupDestination destination, IReadOnlyList<ResourceIdentifier> networkTapIds, IReadOnlyList<ResourceIdentifier> networkTapRuleIds, ProvisioningState? provisioningState) : base(id, name, resourceType, systemData, tags, location)
        {
