...
{
    public partial class NetworkFabricL2IsolationDomainData : IUtf8JsonSerializable, IJsonModel<NetworkFabricL2IsolationDomainData>, IPersistableModel<NetworkFabricL2IsolationDomainData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(VlanId))
            {
                ...
                builder.AppendLine($" '{VlanId.ToString()}'");
            }
