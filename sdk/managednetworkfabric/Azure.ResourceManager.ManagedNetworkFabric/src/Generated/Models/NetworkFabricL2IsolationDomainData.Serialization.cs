...
namespace Azure.ResourceManager.ManagedNetworkFabric
{
    public partial class NetworkFabricL2IsolationDomainData : IUtf8JsonSerializable, IJsonModel<NetworkFabricL2IsolationDomainData>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<NetworkFabricL2IsolationDomainData>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<NetworkFabricL2IsolationDomainData>)} interface");
            }
