...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    public partial class TerminalServerPatchableProperties
    {
        ...
        internal TerminalServerPatchableProperties(string username, string password, string serialNumber, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Username = username;
            Password = password;
