...
{
    public partial class PortCondition : IUtf8JsonSerializable
    {
        ...
        internal static PortCondition DeserializePortCondition(JsonElement element)
        {
            ...
            return new PortCondition(Optional.ToNullable(portType), layer4Protocol, Optional.ToList(ports), Optional.ToList(portGroupNames));
        }
    }
}
