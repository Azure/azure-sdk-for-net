...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    public partial class ActionIPCommunityProperties : IPCommunityAddOperationProperties
    {
        ...
        internal ActionIPCommunityProperties(IPCommunityIdList @add, IPCommunityIdList delete, IPCommunityIdList @set, Dictionary<string, BinaryData> rawData) : base(@add, rawData)
        {
            Delete = delete;
            Set = @set;
        }
