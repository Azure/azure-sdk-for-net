...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    public partial class ActionIPCommunityProperties
    {
        ...
        internal ActionIPCommunityProperties(IPCommunityIdList @add, IPCommunityIdList delete, IPCommunityIdList @set, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Add = @add;
            Delete = delete;
            Set = @set;
