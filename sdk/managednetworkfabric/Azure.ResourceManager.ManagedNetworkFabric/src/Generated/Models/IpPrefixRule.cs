...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    public partial class IpPrefixRule
    {
        ...
        public IpPrefixRule(CommunityActionTypes action, long sequenceNumber, string networkPrefix)
        {
        ...
        internal IpPrefixRule(CommunityActionTypes action, long sequenceNumber, string networkPrefix, Condition? condition, string subnetMaskLength, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Action = action;
            SequenceNumber = sequenceNumber;
            NetworkPrefix = networkPrefix;
