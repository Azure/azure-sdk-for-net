...
{
    public partial class InternetGateway : IUtf8JsonSerializable
    {
        ...
        internal static InternetGateway DeserializeInternetGateway(JsonElement element)
        {
            ...
            return new InternetGateway(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, annotation.Value, internetGatewayRuleId.Value, ipv4Address.Value, Optional.ToNullable(port), type0, networkFabricControllerId, Optional.ToNullable(provisioningState));
        }
    }
}
