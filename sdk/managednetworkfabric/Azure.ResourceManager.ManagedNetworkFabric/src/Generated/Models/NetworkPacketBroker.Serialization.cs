...
{
    public partial class NetworkPacketBroker : IUtf8JsonSerializable
    {
        ...
        internal static NetworkPacketBroker DeserializeNetworkPacketBroker(JsonElement element)
        {
            ...
            return new NetworkPacketBroker(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, networkFabricId, Optional.ToList(networkDeviceIds), Optional.ToList(sourceInterfaceIds), Optional.ToList(networkTapIds), Optional.ToList(neighborGroupIds), Optional.ToNullable(provisioningState));
        }
    }
}
