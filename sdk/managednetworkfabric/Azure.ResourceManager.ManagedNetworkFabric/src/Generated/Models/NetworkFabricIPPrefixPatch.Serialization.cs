...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NetworkFabricIPPrefixPatch>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        internal static NetworkFabricIPPrefixPatch DeserializeNetworkFabricIPPrefixPatch(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    properties = IPPrefixPatchProperties.DeserializeIPPrefixPatchProperties(property.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
            ...
            return new NetworkFabricIPPrefixPatch(tags ?? new ChangeTrackingDictionary<string, string>(), properties, serializedAdditionalRawData);
        }
