...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    public partial class RoutePolicyStatementProperties : AnnotationResourceProperties
    {
        ...
        internal RoutePolicyStatementProperties(string annotation, long sequenceNumber, StatementConditionProperties condition, StatementActionProperties action, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(annotation, serializedAdditionalRawData)
        {
            SequenceNumber = sequenceNumber;
            Condition = condition;
            Action = action;
