...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ValidateConfigurationContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ValidateConfigurationContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ValidateConfigurationContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ValidateConfigurationContent>)} interface");
            }
        ...
        string IPersistableModel<ValidateConfigurationContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
