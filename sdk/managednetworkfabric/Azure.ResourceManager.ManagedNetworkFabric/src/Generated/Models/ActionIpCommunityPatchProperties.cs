...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    public partial class ActionIpCommunityPatchProperties
    {
        ...
        internal ActionIpCommunityPatchProperties(IpCommunityIdList @add, IpCommunityIdList delete, IpCommunityIdList @set, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Add = @add;
            Delete = delete;
            Set = @set;
