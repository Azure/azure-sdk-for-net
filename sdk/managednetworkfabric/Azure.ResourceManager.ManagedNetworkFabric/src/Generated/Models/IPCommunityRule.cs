...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    public partial class IPCommunityRule
    {
        ...
        internal IPCommunityRule(CommunityActionType action, long sequenceNumber, IList<WellKnownCommunity> wellKnownCommunities, IList<string> communityMembers, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Action = action;
            SequenceNumber = sequenceNumber;
