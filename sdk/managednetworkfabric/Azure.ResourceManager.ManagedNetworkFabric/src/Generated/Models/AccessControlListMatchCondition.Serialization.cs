...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    public partial class AccessControlListMatchCondition : IUtf8JsonSerializable, IModelJsonSerializable<AccessControlListMatchCondition>
    {
        ...
        internal static AccessControlListMatchCondition DeserializeAccessControlListMatchCondition(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new AccessControlListMatchCondition(Optional.ToList(protocolTypes), vlanMatchCondition.Value, ipCondition.Value, Optional.ToList(etherTypes), Optional.ToList(fragments), Optional.ToList(ipLengths), Optional.ToList(ttlValues), Optional.ToList(dscpMarkings), portCondition.Value, serializedAdditionalRawData);
        }
