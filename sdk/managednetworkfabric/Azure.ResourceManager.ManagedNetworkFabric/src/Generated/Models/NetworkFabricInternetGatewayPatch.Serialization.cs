        ...
        internal static NetworkFabricInternetGatewayPatch DeserializeNetworkFabricInternetGatewayPatch(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    properties = InternetGatewayPatchProperties.DeserializeInternetGatewayPatchProperties(property.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
            ...
            return new NetworkFabricInternetGatewayPatch(tags ?? new ChangeTrackingDictionary<string, string>(), properties, serializedAdditionalRawData);
        }
