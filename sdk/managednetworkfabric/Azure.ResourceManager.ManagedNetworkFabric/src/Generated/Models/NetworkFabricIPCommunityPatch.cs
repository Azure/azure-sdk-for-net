...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    public partial class NetworkFabricIPCommunityPatch : NetworkRackPatch
    {
        ...
        internal NetworkFabricIPCommunityPatch(IDictionary<string, string> tags, IList<IPCommunityRule> ipCommunityRules, Dictionary<string, BinaryData> rawData) : base(tags, rawData)
        {
