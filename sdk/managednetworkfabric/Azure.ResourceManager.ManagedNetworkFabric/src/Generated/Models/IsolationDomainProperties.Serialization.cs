...
{
    public partial class IsolationDomainProperties : IUtf8JsonSerializable, IJsonModel<IsolationDomainProperties>, IPersistableModel<IsolationDomainProperties>
    {
        ...
        void IJsonModel<IsolationDomainProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(IsolationDomainProperties)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Encapsulation))
            {
                ...
                builder.AppendLine($" '{Encapsulation.ToString()}'");
            }
