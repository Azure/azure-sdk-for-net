...
{
    public partial class NetworkFabricOperationStatusResult : IUtf8JsonSerializable, IJsonModel<NetworkFabricOperationStatusResult>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NetworkFabricOperationStatusResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<NetworkFabricOperationStatusResult>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(NetworkFabricOperationStatusResult)} does not support writing '{format}' format.");
            }
        ...
        NetworkFabricOperationStatusResult IJsonModel<NetworkFabricOperationStatusResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(NetworkFabricOperationStatusResult)} does not support reading '{format}' format.");
            }
        ...
        internal static NetworkFabricOperationStatusResult DeserializeNetworkFabricOperationStatusResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("operations"u8))
                {
                    ...
                    {
                        array.Add(DeserializeNetworkFabricOperationStatusResult(item, options));
                    }
                    operations = array;
                    continue;
                }
            ...
            return new NetworkFabricOperationStatusResult(
                id,
                resourceId,
                name,
                status,
        ...
        BinaryData IPersistableModel<NetworkFabricOperationStatusResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(NetworkFabricOperationStatusResult)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        NetworkFabricOperationStatusResult IPersistableModel<NetworkFabricOperationStatusResult>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(NetworkFabricOperationStatusResult)} does not support reading '{options.Format}' format.");
            }
        }
