...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    public partial class MatchConfigurationIPGroupProperties
    {
        ...
        internal MatchConfigurationIPGroupProperties(string name, NetworkFabricIPAddressType? ipAddressType, IList<string> ipPrefixes, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
