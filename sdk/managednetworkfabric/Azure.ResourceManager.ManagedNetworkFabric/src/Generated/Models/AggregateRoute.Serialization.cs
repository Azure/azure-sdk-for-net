...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AggregateRoute>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AggregateRoute>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AggregateRoute>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AggregateRoute>)} interface");
            }
        ...
        string IPersistableModel<AggregateRoute>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
