...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    public partial class AccessControlListPortCondition : NetworkFabricPortCondition
    {
        ...
        internal AccessControlListPortCondition(NetworkFabricPortType? portType, Layer4Protocol layer4Protocol, IList<string> ports, IList<string> portGroupNames, IList<string> flags, Dictionary<string, BinaryData> rawData) : base(portType, layer4Protocol, ports, portGroupNames, rawData)
        {
            Flags = flags;
        }
        ...
        /// <summary> List of protocol flags that needs to be matched. </summary>
