...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    public partial class NetworkMonitorPatch : IJsonModel<NetworkMonitorPatch>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        NetworkMonitorPatch IJsonModel<NetworkMonitorPatch>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual NetworkMonitorPatch JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<NetworkMonitorPatch>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static NetworkMonitorPatch DeserializeNetworkMonitorPatch(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new NetworkMonitorPatch(tags ?? new ChangeTrackingDictionary<string, string>(), properties, additionalBinaryDataProperties);
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        NetworkMonitorPatch IPersistableModel<NetworkMonitorPatch>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual NetworkMonitorPatch PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<NetworkMonitorPatch>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
        ...
        internal static RequestContent ToRequestContent(NetworkMonitorPatch networkMonitorPatch)
        {
            ...
            content.JsonWriter.WriteObjectValue(networkMonitorPatch, ModelSerializationExtensions.WireOptions);
            return content;
        }
    }
}
