        ...
        internal static NetworkFabricExternalNetworkPatch DeserializeNetworkFabricExternalNetworkPatch(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("properties"u8))
                {
                    ...
                    properties = ExternalNetworkPatchProperties.DeserializeExternalNetworkPatchProperties(property.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
            ...
            return new NetworkFabricExternalNetworkPatch(properties, serializedAdditionalRawData);
        }
