...
{
    public partial class VpnConfigurationPropertiesOptionAProperties : IUtf8JsonSerializable
    {
        ...
        internal static VpnConfigurationPropertiesOptionAProperties DeserializeVpnConfigurationPropertiesOptionAProperties(JsonElement element)
        {
            ...
            return new VpnConfigurationPropertiesOptionAProperties(Optional.ToNullable(mtu), Optional.ToNullable(vlanId), Optional.ToNullable(peerASN), bfdConfiguration.Value, primaryIPv4Prefix.Value, primaryIPv6Prefix.Value, secondaryIPv4Prefix.Value, secondaryIPv6Prefix.Value);
        }
    }
}
