...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    internal partial class NetworkFabricsListResult
    {
        ...
        {
            Value = new ChangeTrackingList<NetworkFabric>();
        }

        /// <summary> Initializes a new instance of NetworkFabricsListResult. </summary>
        /// <param name="value"> List of Network Fabric resources. </param>
        /// <param name="nextLink"> Url to follow for getting next page of resources. </param>
        internal NetworkFabricsListResult(IReadOnlyList<NetworkFabric> value, string nextLink)
        {
            Value = value;
            NextLink = nextLink;
        }
        ...
        public IReadOnlyList<NetworkFabric> Value { get; }
