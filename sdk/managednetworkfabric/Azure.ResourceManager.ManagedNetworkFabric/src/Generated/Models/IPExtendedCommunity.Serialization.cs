...
{
    public partial class IPExtendedCommunity : IUtf8JsonSerializable
    {
        ...
        internal static IPExtendedCommunity DeserializeIPExtendedCommunity(JsonElement element)
        {
            ...
            return new IPExtendedCommunity(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, annotation.Value, ipExtendedCommunityRules, Optional.ToNullable(configurationState), Optional.ToNullable(provisioningState), Optional.ToNullable(administrativeState));
        }
    }
}
