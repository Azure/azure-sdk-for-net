...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    public partial class NetworkBootstrapDevicePatch : TagsUpdate
    {
        ...
        internal NetworkBootstrapDevicePatch(IDictionary<string, string> tags, IDictionary<string, BinaryData> serializedAdditionalRawData, string annotation, string hostName, string serialNumber, ManagedServiceIdentityPatch identity) : base(tags, serializedAdditionalRawData)
        {
