...
{
    public partial class InternalNetworkPatchablePropertiesBgpConfiguration : IUtf8JsonSerializable
    {
        ...
        internal static InternalNetworkPatchablePropertiesBgpConfiguration DeserializeInternalNetworkPatchablePropertiesBgpConfiguration(JsonElement element)
        {
            ...
            Optional<IList<InternalNetworkPatchablePropertiesBgpConfigurationIPv4NeighborAddressItem>> ipv4NeighborAddress = default;
            Optional<IList<InternalNetworkPatchablePropertiesBgpConfigurationIPv6NeighborAddressItem>> ipv6NeighborAddress = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("ipv4NeighborAddress"u8))
                {
                    ...
                    List<InternalNetworkPatchablePropertiesBgpConfigurationIPv4NeighborAddressItem> array = new List<InternalNetworkPatchablePropertiesBgpConfigurationIPv4NeighborAddressItem>();
                    foreach (var item in property.Value.EnumerateArray())
                    {
                        array.Add(InternalNetworkPatchablePropertiesBgpConfigurationIPv4NeighborAddressItem.DeserializeInternalNetworkPatchablePropertiesBgpConfigurationIPv4NeighborAddressItem(item));
                    }
                ...
                if (property.NameEquals("ipv6NeighborAddress"u8))
                {
                    ...
                    List<InternalNetworkPatchablePropertiesBgpConfigurationIPv6NeighborAddressItem> array = new List<InternalNetworkPatchablePropertiesBgpConfigurationIPv6NeighborAddressItem>();
                    foreach (var item in property.Value.EnumerateArray())
                    {
                        array.Add(InternalNetworkPatchablePropertiesBgpConfigurationIPv6NeighborAddressItem.DeserializeInternalNetworkPatchablePropertiesBgpConfigurationIPv6NeighborAddressItem(item));
                    }
