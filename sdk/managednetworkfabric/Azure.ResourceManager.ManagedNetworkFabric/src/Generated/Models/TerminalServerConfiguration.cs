...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    public partial class TerminalServerConfiguration : TerminalServerPatchableProperties
    {
        ...
        internal TerminalServerConfiguration(string username, string password, string serialNumber, ResourceIdentifier networkDeviceId, string primaryIPv4Prefix, string primaryIPv6Prefix, string secondaryIPv4Prefix, string secondaryIPv6Prefix, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(username, password, serialNumber, serializedAdditionalRawData)
        {
