...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    public partial class VlanMatchCondition
    {
        ...
        internal VlanMatchCondition(IList<string> vlans, IList<string> innerVlans, IList<string> vlanGroupNames, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Vlans = vlans;
