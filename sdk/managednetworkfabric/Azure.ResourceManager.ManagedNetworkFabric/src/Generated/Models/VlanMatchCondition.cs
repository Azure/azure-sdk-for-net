...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    public partial class VlanMatchCondition
    {
        ...
        internal VlanMatchCondition(IList<string> vlans, IList<string> innerVlans, IList<string> vlanGroupNames, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Vlans = vlans;
