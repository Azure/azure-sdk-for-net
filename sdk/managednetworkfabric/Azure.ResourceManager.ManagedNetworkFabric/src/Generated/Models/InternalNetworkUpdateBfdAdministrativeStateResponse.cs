...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    public partial class InternalNetworkUpdateBfdAdministrativeStateResponse
    {
        ...
        /// <summary> Initializes a new instance of <see cref="InternalNetworkUpdateBfdAdministrativeStateResponse"/>. </summary>
        /// <param name="status"> Operation status. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="status"/> is null. </exception>
        internal InternalNetworkUpdateBfdAdministrativeStateResponse(string status)
        {
        ...
        internal InternalNetworkUpdateBfdAdministrativeStateResponse(ResourceIdentifier id, string name, string status, double? percentComplete, DateTimeOffset? startOn, DateTimeOffset? endOn, IReadOnlyList<OperationStatusResult> operations, ResponseError error, ResourceIdentifier resourceId, InternalNetworkUpdateBfdAdministrativeStateResponseProperties properties, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Name = name;
            Status = status;
        ...
        /// <summary> Initializes a new instance of <see cref="InternalNetworkUpdateBfdAdministrativeStateResponse"/> for deserialization. </summary>
        internal InternalNetworkUpdateBfdAdministrativeStateResponse()
        {
        }
