...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    public partial class IpExtendedCommunityRule
    {
        ...
        public IpExtendedCommunityRule(CommunityActionTypes action, long sequenceNumber, IEnumerable<string> routeTargets)
        {
        ...
        internal IpExtendedCommunityRule(CommunityActionTypes action, long sequenceNumber, IList<string> routeTargets, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Action = action;
            SequenceNumber = sequenceNumber;
