...
namespace Azure.ResourceManager.ManagedNetworkFabric
{
    public partial class NetworkFabricL3IsolationDomainData : IUtf8JsonSerializable, IJsonModel<NetworkFabricL3IsolationDomainData>
    {
        ...
        void IJsonModel<NetworkFabricL3IsolationDomainData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(NetworkFabricL3IsolationDomainData)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(RedistributeConnectedSubnets))
            {
                ...
                builder.AppendLine($" '{RedistributeConnectedSubnets.Value.ToString()}'");
            }

            if (Optional.IsDefined(RedistributeStaticRoutes))
            {
                builder.Append("    redistributeStaticRoutes:");
                builder.AppendLine($" '{RedistributeStaticRoutes.Value.ToString()}'");
            }

            if (Optional.IsDefined(AggregateRouteConfiguration))
            {
                builder.Append("    aggregateRouteConfiguration:");
                AppendChildObject(builder, AggregateRouteConfiguration, options, 4, false);
            }

            if (Optional.IsDefined(ConnectedSubnetRoutePolicy))
            {
                builder.Append("    connectedSubnetRoutePolicy:");
                AppendChildObject(builder, ConnectedSubnetRoutePolicy, options, 4, false);
            }
