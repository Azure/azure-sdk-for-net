...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    public partial class ManagementNetworkConfigurationPatchableProperties : IJsonModel<ManagementNetworkConfigurationPatchableProperties>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<ManagementNetworkConfigurationPatchableProperties>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ManagementNetworkConfigurationPatchableProperties>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        ManagementNetworkConfigurationPatchableProperties IPersistableModel<ManagementNetworkConfigurationPatchableProperties>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ManagementNetworkConfigurationPatchableProperties IJsonModel<ManagementNetworkConfigurationPatchableProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual ManagementNetworkConfigurationPatchableProperties JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<ManagementNetworkConfigurationPatchableProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static ManagementNetworkConfigurationPatchableProperties DeserializeManagementNetworkConfigurationPatchableProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new ManagementNetworkConfigurationPatchableProperties(infrastructureVpnConfiguration, workloadVpnConfiguration, additionalBinaryDataProperties);
        }
    }
}
