...
{
    public partial class ManagementNetworkConfigurationPatchableProperties : IUtf8JsonSerializable, IJsonModel<ManagementNetworkConfigurationPatchableProperties>, IPersistableModel<ManagementNetworkConfigurationPatchableProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(InfrastructureVpnConfiguration))
            {
                ...
                AppendChildObject(builder, InfrastructureVpnConfiguration, options, 2);
            }

            if (Optional.IsDefined(WorkloadVpnConfiguration))
            {
                builder.Append("  workloadVpnConfiguration:");
                AppendChildObject(builder, WorkloadVpnConfiguration, options, 2);
            }
