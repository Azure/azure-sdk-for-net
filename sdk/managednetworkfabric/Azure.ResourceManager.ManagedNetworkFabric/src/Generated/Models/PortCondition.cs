...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    public partial class PortCondition
    {
        ...
        internal PortCondition(PortType? portType, Layer4Protocol layer4Protocol, IList<string> ports, IList<string> portGroupNames, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            PortType = portType;
            Layer4Protocol = layer4Protocol;
            Ports = ports;
        ...
        /// <summary> Initializes a new instance of <see cref="PortCondition"/> for deserialization. </summary>
        internal PortCondition()
        {
        }
