...
{
    internal partial class IPExtendedCommunityListResult : IUtf8JsonSerializable, IJsonModel<IPExtendedCommunityListResult>, IPersistableModel<IPExtendedCommunityListResult>
    {
        ...
        void IJsonModel<IPExtendedCommunityListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(IPExtendedCommunityListResult)} does not support '{format}' format.");
            }
