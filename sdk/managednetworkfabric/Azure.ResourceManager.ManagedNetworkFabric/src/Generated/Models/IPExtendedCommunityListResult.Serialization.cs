...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IPExtendedCommunityListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<IPExtendedCommunityListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<IPExtendedCommunityListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<IPExtendedCommunityListResult>)} interface");
            }
        ...
        string IPersistableModel<IPExtendedCommunityListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
