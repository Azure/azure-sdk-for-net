...
{
    public partial class InternalNetworkPatch : IUtf8JsonSerializable, IJsonModel<InternalNetworkPatch>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<InternalNetworkPatch>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<InternalNetworkPatch>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        InternalNetworkPatch IJsonModel<InternalNetworkPatch>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<InternalNetworkPatch>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static InternalNetworkPatch DeserializeInternalNetworkPatch(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new InternalNetworkPatch(
                annotation,
                mtu,
        ...
        BinaryData IPersistableModel<InternalNetworkPatch>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<InternalNetworkPatch>)this).GetFormatFromOptions(options) : options.Format;
        ...
        InternalNetworkPatch IPersistableModel<InternalNetworkPatch>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<InternalNetworkPatch>)this).GetFormatFromOptions(options) : options.Format;
