...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DeviceUpdateCommonPostActionResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DeviceUpdateCommonPostActionResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DeviceUpdateCommonPostActionResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DeviceUpdateCommonPostActionResult>)} interface");
            }
        ...
        string IPersistableModel<DeviceUpdateCommonPostActionResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
