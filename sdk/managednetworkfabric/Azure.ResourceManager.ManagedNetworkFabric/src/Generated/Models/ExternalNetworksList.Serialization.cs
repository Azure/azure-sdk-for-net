...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ExternalNetworksList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ExternalNetworksList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ExternalNetworksList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ExternalNetworksList>)} interface");
            }
        ...
        string IPersistableModel<ExternalNetworksList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
