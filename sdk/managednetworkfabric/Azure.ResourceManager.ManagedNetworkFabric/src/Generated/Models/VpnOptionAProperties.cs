...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    public partial class VpnOptionAProperties
    {
        ...
        internal VpnOptionAProperties(int? mtu, int vlanId, long peerASN, BfdConfiguration bfdConfiguration, string primaryIpv4Prefix, string primaryIpv6Prefix, string secondaryIpv4Prefix, string secondaryIpv6Prefix, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Mtu = mtu;
            VlanId = vlanId;
            PeerASN = peerASN;
