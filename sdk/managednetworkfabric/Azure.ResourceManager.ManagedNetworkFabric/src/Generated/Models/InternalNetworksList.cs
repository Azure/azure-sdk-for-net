...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    internal partial class InternalNetworksList
    {
        ...
        {
            Value = new ChangeTrackingList<InternalNetwork>();
        }

        /// <summary> Initializes a new instance of InternalNetworksList. </summary>
        /// <param name="value"> List of Internal Network resources. </param>
        /// <param name="nextLink"> Url to follow for getting next page of resources. </param>
        internal InternalNetworksList(IReadOnlyList<InternalNetwork> value, string nextLink)
        {
            Value = value;
            NextLink = nextLink;
        }
        ...
        public IReadOnlyList<InternalNetwork> Value { get; }
