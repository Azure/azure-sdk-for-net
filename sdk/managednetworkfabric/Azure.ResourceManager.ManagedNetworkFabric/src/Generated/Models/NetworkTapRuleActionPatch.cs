...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    public partial class NetworkTapRuleActionPatch
    {
        ...
        internal NetworkTapRuleActionPatch(TapRuleActionType? type, string truncate, BooleanEnumProperty? isTimestampEnabled, ResourceIdentifier destinationId, string matchConfigurationName, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Type = type;
            Truncate = truncate;
