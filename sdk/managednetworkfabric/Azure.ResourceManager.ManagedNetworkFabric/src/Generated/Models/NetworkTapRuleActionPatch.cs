...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    public partial class NetworkTapRuleActionPatch
    {
        ...
        internal NetworkTapRuleActionPatch(TapRuleActionType? @type, string truncate, NetworkFabricBooleanValue? isTimestampEnabled, ResourceIdentifier destinationId, string matchConfigurationName, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Type = @type;
            Truncate = truncate;
