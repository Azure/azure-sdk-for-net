...
{
    public partial class AccessControlListAction : IUtf8JsonSerializable, IJsonModel<AccessControlListAction>, IPersistableModel<AccessControlListAction>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  type:");
                builder.AppendLine($" '{AclActionType.ToString()}'");
            }
