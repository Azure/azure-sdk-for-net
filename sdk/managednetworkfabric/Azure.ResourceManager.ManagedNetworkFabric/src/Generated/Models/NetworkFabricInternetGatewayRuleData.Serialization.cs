...
{
    public partial class NetworkFabricInternetGatewayRuleData : IUtf8JsonSerializable, IJsonModel<NetworkFabricInternetGatewayRuleData>, IPersistableModel<NetworkFabricInternetGatewayRuleData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(RuleProperties))
            {
                builder.Append("  ruleProperties:");
                AppendChildObject(builder, RuleProperties, options, 2);
            }
            ...
            {
                builder.Append("  internetGatewayIds:");
                builder.AppendLine(" [");
                foreach (var item in InternetGatewayIds)
                {
                    if (item == null)
