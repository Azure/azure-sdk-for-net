...
{
    public partial class IPCommunityAddOperationProperties : IUtf8JsonSerializable, IJsonModel<IPCommunityAddOperationProperties>, IPersistableModel<IPCommunityAddOperationProperties>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IPCommunityAddOperationProperties>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<IPCommunityAddOperationProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<IPCommunityAddOperationProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(IPCommunityAddOperationProperties)} does not support '{format}' format.");
            }
