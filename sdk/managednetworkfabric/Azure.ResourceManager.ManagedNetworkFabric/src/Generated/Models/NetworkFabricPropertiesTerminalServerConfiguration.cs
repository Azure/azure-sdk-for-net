...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    public partial class NetworkFabricPropertiesTerminalServerConfiguration : NetworkFabricLayer3IPPrefixProperties
    {
        ...
        internal NetworkFabricPropertiesTerminalServerConfiguration(string primaryIPv4Prefix, string primaryIPv6Prefix, string secondaryIPv4Prefix, string secondaryIPv6Prefix, string networkDeviceId, string username, string password, string serialNumber) : base(primaryIPv4Prefix, primaryIPv6Prefix, secondaryIPv4Prefix, secondaryIPv6Prefix)
        {
