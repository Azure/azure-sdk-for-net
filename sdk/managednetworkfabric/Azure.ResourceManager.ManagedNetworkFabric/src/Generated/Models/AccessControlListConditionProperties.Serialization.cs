...
{
    public partial class AccessControlListConditionProperties : IUtf8JsonSerializable
    {
        ...
        internal static AccessControlListConditionProperties DeserializeAccessControlListConditionProperties(JsonElement element)
        {
            ...
            return new AccessControlListConditionProperties(annotation.Value, sequenceNumber, action, destinationAddress, destinationPort, sourceAddress, sourcePort, protocol);
        }
    }
}
