...
namespace Azure.ResourceManager.ManagedNetworkFabric
{
    public partial class NetworkFabricIPExtendedCommunityData : IUtf8JsonSerializable, IJsonModel<NetworkFabricIPExtendedCommunityData>
    {
        ...
        void IJsonModel<NetworkFabricIPExtendedCommunityData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(NetworkFabricIPExtendedCommunityData)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<NetworkFabricIPExtendedCommunityData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(NetworkFabricIPExtendedCommunityData)} does not support '{options.Format}' format.");
            }
        }
