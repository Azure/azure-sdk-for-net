...
namespace Azure.ResourceManager.ManagedNetworkFabric
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NetworkFabricIPExtendedCommunityData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NetworkFabricIPExtendedCommunityData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NetworkFabricIPExtendedCommunityData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<NetworkFabricIPExtendedCommunityData>)} interface");
            }
        ...
        string IPersistableModel<NetworkFabricIPExtendedCommunityData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
