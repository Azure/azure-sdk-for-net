...
{
    public partial class NetworkFabricIPExtendedCommunityData : IUtf8JsonSerializable, IJsonModel<NetworkFabricIPExtendedCommunityData>, IPersistableModel<NetworkFabricIPExtendedCommunityData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  ipExtendedCommunityRules:");
                builder.AppendLine(" [");
                foreach (var item in IPExtendedCommunityRules)
                {
