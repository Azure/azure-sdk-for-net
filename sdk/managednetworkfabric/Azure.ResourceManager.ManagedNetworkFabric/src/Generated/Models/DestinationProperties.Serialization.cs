...
{
    public partial class DestinationProperties : IUtf8JsonSerializable
    {
        ...
        internal static DestinationProperties DeserializeDestinationProperties(JsonElement element)
        {
            ...
            return new DestinationProperties(name.Value, Optional.ToNullable(destinationType), destinationId.Value, isolationDomainProperties.Value, destinationTapRuleId.Value);
        }
    }
}
