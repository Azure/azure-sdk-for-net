...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NetworkDeviceInterfaceProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NetworkDeviceInterfaceProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NetworkDeviceInterfaceProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<NetworkDeviceInterfaceProperties>)} interface");
            }
        ...
        string IPersistableModel<NetworkDeviceInterfaceProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
