...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    public partial class VlanGroupProperties : IUtf8JsonSerializable, IJsonModel<VlanGroupProperties>
    {
        ...
        void IJsonModel<VlanGroupProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(VlanGroupProperties)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<VlanGroupProperties>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(VlanGroupProperties)} does not support '{options.Format}' format.");
            }
        }
