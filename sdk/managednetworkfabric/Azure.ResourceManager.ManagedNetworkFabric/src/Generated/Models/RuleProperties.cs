...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    public partial class RuleProperties
    {
        ...
        internal RuleProperties(Action action, IList<string> addressList, RuleCondition? condition, IList<string> destinationAddressList, IList<string> sourceAddressList, IList<HeaderAddressProperties> headerAddressList, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Action = action;
