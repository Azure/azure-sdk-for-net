...
namespace Azure.ResourceManager.ManagedNetworkFabric
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NetworkFabricExternalNetworkData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NetworkFabricExternalNetworkData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NetworkFabricExternalNetworkData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<NetworkFabricExternalNetworkData>)} interface");
            }
        ...
        string IPersistableModel<NetworkFabricExternalNetworkData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
