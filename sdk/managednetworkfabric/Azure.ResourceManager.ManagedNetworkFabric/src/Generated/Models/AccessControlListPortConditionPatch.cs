...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    public partial class AccessControlListPortConditionPatch
    {
        ...
        internal AccessControlListPortConditionPatch(PortType? portType, Layer4Protocol? layer4Protocol, IList<string> ports, IList<string> portGroupNames, IList<string> flags, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            PortType = portType;
