...
{
    public partial class DeviceLimits : IUtf8JsonSerializable
    {
        ...
        internal static DeviceLimits DeserializeDeviceLimits(JsonElement element)
        {
            ...
            return new DeviceLimits(Optional.ToNullable(physicalInterfaceCount), Optional.ToNullable(maxSubInterfaces), Optional.ToNullable(maxTunnelInterfaces), Optional.ToNullable(maxVirtualRouterFunctions), Optional.ToNullable(maxBorderGatewayProtocolPeers), Optional.ToNullable(maxBidirectionalForwardingDetectionPeers));
        }
    }
}
