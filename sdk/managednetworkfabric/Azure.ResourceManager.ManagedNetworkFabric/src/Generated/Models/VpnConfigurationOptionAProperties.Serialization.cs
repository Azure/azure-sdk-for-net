...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VpnConfigurationOptionAProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<VpnConfigurationOptionAProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<VpnConfigurationOptionAProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<VpnConfigurationOptionAProperties>)} interface");
            }
        ...
        string IPersistableModel<VpnConfigurationOptionAProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
