...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ActionIPExtendedCommunityProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ActionIPExtendedCommunityProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ActionIPExtendedCommunityProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ActionIPExtendedCommunityProperties>)} interface");
            }
        ...
        string IPersistableModel<ActionIPExtendedCommunityProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
