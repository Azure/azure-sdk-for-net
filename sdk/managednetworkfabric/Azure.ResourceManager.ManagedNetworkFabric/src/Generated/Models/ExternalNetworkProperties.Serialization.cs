...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    internal partial class ExternalNetworkProperties : IJsonModel<ExternalNetworkProperties>
    {
        ...
        internal static ExternalNetworkProperties DeserializeExternalNetworkProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("optionAProperties"u8))
                {
                    ...
                    optionAProperties = ExternalNetworkOptionAProperties.DeserializeExternalNetworkOptionAProperties(prop.Value, options);
                    continue;
                }
