...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    public partial class PortConditionPatch
    {
        ...
        internal PortConditionPatch(PortType? portType, Layer4Protocol? layer4Protocol, IList<string> ports, IList<string> portGroupNames, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            PortType = portType;
