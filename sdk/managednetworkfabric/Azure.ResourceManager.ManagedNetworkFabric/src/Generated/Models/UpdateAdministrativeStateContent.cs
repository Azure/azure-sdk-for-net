...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    public partial class UpdateAdministrativeStateContent : UpdateAdministrativeStateOnResources
    {
        ...
        internal UpdateAdministrativeStateContent(IList<ResourceIdentifier> resourceIds, AdministrativeEnableState? state, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(resourceIds, serializedAdditionalRawData)
        {
            State = state;
        }
