...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    public partial class UpdateAdministrativeStateContent : UpdateAdministrativeStateOnResources
    {
        ...
        internal UpdateAdministrativeStateContent(IList<ResourceIdentifier> resourceIds, IDictionary<string, BinaryData> additionalBinaryDataProperties, AdministrativeEnableState? state) : base(resourceIds, additionalBinaryDataProperties)
        {
            State = state;
        }
