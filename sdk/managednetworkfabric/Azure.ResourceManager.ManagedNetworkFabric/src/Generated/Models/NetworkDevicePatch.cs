...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    public partial class NetworkDevicePatch : NetworkRackPatch
    {
        ...
        internal NetworkDevicePatch(IDictionary<string, string> tags, string annotation, string hostName, string serialNumber, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(tags, serializedAdditionalRawData)
        {
