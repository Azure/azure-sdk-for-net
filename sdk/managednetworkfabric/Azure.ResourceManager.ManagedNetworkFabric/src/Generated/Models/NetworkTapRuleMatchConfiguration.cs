...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    public partial class NetworkTapRuleMatchConfiguration
    {
        ...
        internal NetworkTapRuleMatchConfiguration(string matchConfigurationName, long? sequenceNumber, NetworkFabricIPAddressType? ipAddressType, IList<NetworkTapRuleMatchCondition> matchConditions, IList<NetworkTapRuleAction> actions, Dictionary<string, BinaryData> rawData)
        {
