...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    public partial class NetworkFabricL2IsolationDomainPatch : NetworkRackPatch
    {
        ...
        internal NetworkFabricL2IsolationDomainPatch(IDictionary<string, string> tags, string annotation, int? mtu, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(tags, serializedAdditionalRawData)
        {
