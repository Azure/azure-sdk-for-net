...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IPCommunityRule>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<IPCommunityRule>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<IPCommunityRule>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<IPCommunityRule>)} interface");
            }
        ...
        string IPersistableModel<IPCommunityRule>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
