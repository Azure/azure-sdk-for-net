...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RouteTargetInformation>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RouteTargetInformation>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RouteTargetInformation>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RouteTargetInformation>)} interface");
            }
        ...
        string IPersistableModel<RouteTargetInformation>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
