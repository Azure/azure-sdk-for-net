...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    public partial class AccessControlListPortCondition : IUtf8JsonSerializable, IModelJsonSerializable<AccessControlListPortCondition>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<AccessControlListPortCondition>(this, options.Format);
        ...
        internal static AccessControlListPortCondition DeserializeAccessControlListPortCondition(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new AccessControlListPortCondition(Optional.ToNullable(portType), layer4Protocol, Optional.ToList(ports), Optional.ToList(portGroupNames), Optional.ToList(flags), serializedAdditionalRawData);
        }
        ...
        /// <summary> Converts a <see cref="AccessControlListPortCondition"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="AccessControlListPortCondition"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="AccessControlListPortCondition"/>. </summary>
