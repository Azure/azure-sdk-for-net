...
{
    public partial class NetworkRackData : IUtf8JsonSerializable, IJsonModel<NetworkRackData>, IPersistableModel<NetworkRackData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(NetworkRackType))
            {
                builder.Append("  networkRackType:");
                builder.AppendLine($" '{NetworkRackType.ToString()}'");
            }
