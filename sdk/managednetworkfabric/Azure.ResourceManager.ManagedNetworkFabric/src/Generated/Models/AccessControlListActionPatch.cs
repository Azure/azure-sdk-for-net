...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    public partial class AccessControlListActionPatch
    {
        ...
        internal AccessControlListActionPatch(AclActionType? @type, string counterName, string remarkComment, PoliceRateConfigurationProperties policeRateConfiguration, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Type = @type;
