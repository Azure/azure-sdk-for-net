...
{
    public partial class AccessControlListPatchPropertiesConditionsItem : IUtf8JsonSerializable
    {
        ...
        internal static AccessControlListPatchPropertiesConditionsItem DeserializeAccessControlListPatchPropertiesConditionsItem(JsonElement element)
        {
            ...
            return new AccessControlListPatchPropertiesConditionsItem(annotation.Value, sequenceNumber, action, destinationAddress, destinationPort, sourceAddress, sourcePort, protocol);
        }
    }
}
