...
{
    public partial class IPMatchCondition : IUtf8JsonSerializable, IJsonModel<IPMatchCondition>, IPersistableModel<IPMatchCondition>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  type:");
                builder.AppendLine($" '{SourceDestinationType.ToString()}'");
            }

            if (Optional.IsDefined(PrefixType))
            {
                builder.Append("  prefixType:");
                builder.AppendLine($" '{PrefixType.ToString()}'");
            }
