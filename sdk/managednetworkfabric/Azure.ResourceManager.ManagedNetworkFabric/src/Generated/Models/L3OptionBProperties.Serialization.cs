...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<L3OptionBProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<L3OptionBProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<L3OptionBProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<L3OptionBProperties>)} interface");
            }
        ...
        string IPersistableModel<L3OptionBProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
