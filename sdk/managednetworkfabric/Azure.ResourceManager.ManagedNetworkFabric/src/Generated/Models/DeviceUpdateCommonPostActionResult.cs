...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    public partial class DeviceUpdateCommonPostActionResult : NetworkFabricErrorResult
    {
        ...
        internal DeviceUpdateCommonPostActionResult(ResponseError error, NetworkFabricConfigurationState? configurationState, IReadOnlyList<string> successfulDevices, IReadOnlyList<string> failedDevices, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(error, serializedAdditionalRawData)
        {
