...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    public partial class ActionIPExtendedCommunityProperties : IPExtendedCommunityAddOperationProperties
    {
        ...
        internal ActionIPExtendedCommunityProperties(IPExtendedCommunityIdList @add, IPExtendedCommunityIdList delete, IPExtendedCommunityIdList @set, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(@add, serializedAdditionalRawData)
        {
            Delete = delete;
            Set = @set;
        }
