...
{
    internal partial class RoutePoliciesListResult : IUtf8JsonSerializable, IJsonModel<RoutePoliciesListResult>, IPersistableModel<RoutePoliciesListResult>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RoutePoliciesListResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<RoutePoliciesListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(RoutePoliciesListResult)} does not support '{format}' format.");
            }
