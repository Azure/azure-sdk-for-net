...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RoutePoliciesListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RoutePoliciesListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RoutePoliciesListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RoutePoliciesListResult>)} interface");
            }
        ...
        string IPersistableModel<RoutePoliciesListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
