...
{
    public partial class InternalNetworkPropertiesStaticRouteConfiguration : IUtf8JsonSerializable
    {
        ...
        internal static InternalNetworkPropertiesStaticRouteConfiguration DeserializeInternalNetworkPropertiesStaticRouteConfiguration(JsonElement element)
        {
            ...
            return new InternalNetworkPropertiesStaticRouteConfiguration(bfdConfiguration.Value, Optional.ToList(ipv4Routes), Optional.ToList(ipv6Routes), Optional.ToNullable(extension));
        }
    }
}
