...
{
    public partial class NetworkFabricOptionAProperties : IUtf8JsonSerializable
    {
        ...
        internal static NetworkFabricOptionAProperties DeserializeNetworkFabricOptionAProperties(JsonElement element)
        {
            ...
            return new NetworkFabricOptionAProperties(primaryIPv4Prefix.Value, primaryIPv6Prefix.Value, secondaryIPv4Prefix.Value, secondaryIPv6Prefix.Value, Optional.ToNullable(mtu), Optional.ToNullable(vlanId), Optional.ToNullable(peerASN), bfdConfiguration.Value);
        }
    }
}
