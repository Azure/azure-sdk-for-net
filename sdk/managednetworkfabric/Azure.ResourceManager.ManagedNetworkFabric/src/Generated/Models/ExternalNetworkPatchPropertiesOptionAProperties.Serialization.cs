...
{
    public partial class ExternalNetworkPatchPropertiesOptionAProperties : IUtf8JsonSerializable, IJsonModel<ExternalNetworkPatchPropertiesOptionAProperties>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ExternalNetworkPatchPropertiesOptionAProperties>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<ExternalNetworkPatchPropertiesOptionAProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        ExternalNetworkPatchPropertiesOptionAProperties IJsonModel<ExternalNetworkPatchPropertiesOptionAProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ExternalNetworkPatchPropertiesOptionAProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static ExternalNetworkPatchPropertiesOptionAProperties DeserializeExternalNetworkPatchPropertiesOptionAProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<ExternalNetworkPatchPropertiesOptionAProperties>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ExternalNetworkPatchPropertiesOptionAProperties>)this).GetFormatFromOptions(options) : options.Format;
        ...
        ExternalNetworkPatchPropertiesOptionAProperties IPersistableModel<ExternalNetworkPatchPropertiesOptionAProperties>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ExternalNetworkPatchPropertiesOptionAProperties>)this).GetFormatFromOptions(options) : options.Format;
