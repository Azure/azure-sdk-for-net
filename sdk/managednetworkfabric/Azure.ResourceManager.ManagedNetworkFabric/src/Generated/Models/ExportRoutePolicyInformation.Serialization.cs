...
{
    public partial class ExportRoutePolicyInformation : IUtf8JsonSerializable, IJsonModel<ExportRoutePolicyInformation>, IPersistableModel<ExportRoutePolicyInformation>
    {
        ...
        void IJsonModel<ExportRoutePolicyInformation>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ExportRoutePolicyInformation)} does not support '{format}' format.");
            }
