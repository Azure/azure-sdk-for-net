...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    public partial class ExternalNetworkUpdateBfdAdministrativeStateResult
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="ExternalNetworkUpdateBfdAdministrativeStateResult"/>. </summary>
        /// <param name="status"> Operation status. </param>
        internal ExternalNetworkUpdateBfdAdministrativeStateResult(string status)
        {
            Status = status;
        ...
        internal ExternalNetworkUpdateBfdAdministrativeStateResult(ResourceIdentifier id, string name, string status, double? percentComplete, DateTimeOffset? startsOn, DateTimeOffset? endsOn, IReadOnlyList<NetworkFabricOperationStatusResult> operations, ResponseError error, ResourceIdentifier resourceId, ExternalNetworkUpdateBfdAdministrativeStateResponseProperties properties, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Id = id;
            Name = name;
            Status = status;
