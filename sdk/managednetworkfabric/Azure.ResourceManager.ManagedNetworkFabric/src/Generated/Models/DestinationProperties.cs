...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    public partial class DestinationProperties
    {
        ...
        internal DestinationProperties(string name, DestinationType destinationType, ResourceIdentifier destinationId, IsolationDomainProperties isolationDomainProperties, ResourceIdentifier destinationTapRuleId, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            DestinationType = destinationType;
            DestinationId = destinationId;
