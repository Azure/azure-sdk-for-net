...
{
    public partial class NetworkFabricAccessControlListData : Core.IUtf8JsonSerializable
    {
        void Core.IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            if (Core.Optional.IsDefined(AclsUri))
            {
        ...
        internal static NetworkFabricAccessControlListData DeserializeNetworkFabricAccessControlListData(JsonElement element)
        {
            ...
            Core.Optional<Uri> aclsUrl = default;
            Core.Optional<IList<AccessControlListMatchConfiguration>> matchConfigurations = default;
            ...
            return new NetworkFabricAccessControlListData(id, name, type, systemData.Value, Core.Optional.ToDictionary(tags), location, annotation.Value, Core.Optional.ToNullable(configurationType), aclsUrl.Value, Core.Optional.ToList(matchConfigurations), Core.Optional.ToList(dynamicMatchConfigurations), Core.Optional.ToNullable(lastSyncedTime), Core.Optional.ToNullable(configurationState), Core.Optional.ToNullable(provisioningState), Core.Optional.ToNullable(administrativeState));
        }
    }
}
