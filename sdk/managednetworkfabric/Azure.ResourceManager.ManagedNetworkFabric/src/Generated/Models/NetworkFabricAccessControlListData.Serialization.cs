...
namespace Azure.ResourceManager.ManagedNetworkFabric
{
    public partial class NetworkFabricAccessControlListData : IUtf8JsonSerializable, IJsonModel<NetworkFabricAccessControlListData>
    {
        ...
        void IJsonModel<NetworkFabricAccessControlListData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(NetworkFabricAccessControlListData)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<NetworkFabricAccessControlListData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(NetworkFabricAccessControlListData)} does not support '{options.Format}' format.");
            }
        }
