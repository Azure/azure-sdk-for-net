...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    internal partial class L2IsolationDomainsListResult
    {
        ...
        {
            Value = new ChangeTrackingList<L2IsolationDomain>();
        }

        /// <summary> Initializes a new instance of L2IsolationDomainsListResult. </summary>
        /// <param name="value"> Displays list of L2 Isolation Domain resources. </param>
        /// <param name="nextLink"> Url to follow for getting next page of resources. </param>
        internal L2IsolationDomainsListResult(IReadOnlyList<L2IsolationDomain> value, string nextLink)
        {
            Value = value;
            NextLink = nextLink;
        }
        ...
        public IReadOnlyList<L2IsolationDomain> Value { get; }
