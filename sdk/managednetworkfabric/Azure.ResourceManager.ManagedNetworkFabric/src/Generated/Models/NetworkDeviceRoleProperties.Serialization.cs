...
{
    public partial class NetworkDeviceRoleProperties : IUtf8JsonSerializable
    {
        ...
        internal static NetworkDeviceRoleProperties DeserializeNetworkDeviceRoleProperties(JsonElement element)
        {
            ...
            return new NetworkDeviceRoleProperties(networkDeviceSkuName.Value, Optional.ToNullable(roleType), Optional.ToNullable(rackSlot));
        }
    }
}
