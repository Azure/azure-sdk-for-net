...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    public partial class NetworkFabricPropertiesManagementNetworkConfigurationInfrastructureVpnConfiguration
    {
        ...
        public NetworkFabricPropertiesManagementNetworkConfigurationInfrastructureVpnConfiguration(NetworkFabricOptionBProperties optionBProperties)
        {
        ...
        internal NetworkFabricPropertiesManagementNetworkConfigurationInfrastructureVpnConfiguration(EnabledDisabledState? administrativeState, string networkToNetworkInterconnectId, PeeringOption? peeringOption, NetworkFabricOptionBProperties optionBProperties, NetworkFabricOptionAProperties optionAProperties)
        {
