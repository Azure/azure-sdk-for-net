...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IPCommunitiesListResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        internal static IPCommunitiesListResult DeserializeIPCommunitiesListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            IReadOnlyList<IPCommunityData> value = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    List<IPCommunityData> array = new List<IPCommunityData>();
                    foreach (var item in property.Value.EnumerateArray())
                    {
                        array.Add(IPCommunityData.DeserializeIPCommunityData(item, options));
                    }
                    value = array;
                    continue;
                }
            ...
            return new IPCommunitiesListResult(value, nextLink, serializedAdditionalRawData);
        }
