...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    public partial class NetworkTapRuleAction
    {
        ...
        internal NetworkTapRuleAction(TapRuleActionType? type, string truncate, BooleanEnumProperty? isTimestampEnabled, ResourceIdentifier destinationId, string matchConfigurationName, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Type = type;
            Truncate = truncate;
