...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    {
        /// <summary> Initializes a new instance of NetworkFabricControllerPropertiesManagedResourceGroupConfiguration. </summary>
        ...
        internal NetworkFabricControllerPropertiesManagedResourceGroupConfiguration(string name, AzureLocation? location)
        {
            Name = name;
            Location = location;
        }
