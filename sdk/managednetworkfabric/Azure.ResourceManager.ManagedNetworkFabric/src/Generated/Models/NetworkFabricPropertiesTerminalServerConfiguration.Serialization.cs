...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    public partial class NetworkFabricPropertiesTerminalServerConfiguration : IUtf8JsonSerializable
    {
        ...
        internal static NetworkFabricPropertiesTerminalServerConfiguration DeserializeNetworkFabricPropertiesTerminalServerConfiguration(JsonElement element)
        {
            ...
            Optional<string> networkDeviceId = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    networkDeviceId = property.Value.GetString();
                    continue;
                }
            ...
            return new NetworkFabricPropertiesTerminalServerConfiguration(primaryIPv4Prefix.Value, primaryIPv6Prefix.Value, secondaryIPv4Prefix.Value, secondaryIPv6Prefix.Value, networkDeviceId.Value, username.Value, password.Value, serialNumber.Value);
        }
    }
}
