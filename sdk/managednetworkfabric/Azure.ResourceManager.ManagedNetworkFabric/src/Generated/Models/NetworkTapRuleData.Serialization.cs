...
namespace Azure.ResourceManager.ManagedNetworkFabric
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NetworkTapRuleData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NetworkTapRuleData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NetworkTapRuleData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<NetworkTapRuleData>)} interface");
            }
        ...
        string IPersistableModel<NetworkTapRuleData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
