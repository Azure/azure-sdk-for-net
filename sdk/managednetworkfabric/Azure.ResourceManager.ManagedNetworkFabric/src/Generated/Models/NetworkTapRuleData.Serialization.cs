...
{
    public partial class NetworkTapRuleData : IUtf8JsonSerializable, IJsonModel<NetworkTapRuleData>, IPersistableModel<NetworkTapRuleData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(TapRulesUri))
            {
                builder.Append("  tapRulesUrl:");
                builder.AppendLine($" '{TapRulesUri.AbsoluteUri}'");
            }
            ...
            {
                builder.Append("  networkTapId:");
                builder.AppendLine($" '{NetworkTapId.ToString()}'");
            }

            if (Optional.IsDefined(PollingIntervalInSeconds))
            {
                builder.Append("  pollingIntervalInSeconds:");
                builder.AppendLine($" '{PollingIntervalInSeconds.ToString()}'");
            }
