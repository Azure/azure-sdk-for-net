...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    public partial class CommonPostActionResponseForDeviceUpdate : CommonErrorResponse
    {
        ...
        internal CommonPostActionResponseForDeviceUpdate(ResponseError error, IDictionary<string, BinaryData> serializedAdditionalRawData, ConfigurationState? configurationState, IReadOnlyList<string> successfulDevices, IReadOnlyList<string> failedDevices) : base(error, serializedAdditionalRawData)
        {
