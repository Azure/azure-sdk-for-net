...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    public partial class NetworkFabricNeighborGroupPatch : NetworkRackPatch
    {
        ...
        internal NetworkFabricNeighborGroupPatch(IDictionary<string, string> tags, string annotation, NeighborGroupDestination destination, Dictionary<string, BinaryData> rawData) : base(tags, rawData)
        {
