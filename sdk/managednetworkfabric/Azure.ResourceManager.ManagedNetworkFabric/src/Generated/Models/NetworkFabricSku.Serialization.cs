...
{
    public partial class NetworkFabricSku : IUtf8JsonSerializable
    {
        ...
        internal static NetworkFabricSku DeserializeNetworkFabricSku(JsonElement element)
        {
            ...
            return new NetworkFabricSku(id, name, type, systemData.Value, Optional.ToNullable(type0), Optional.ToNullable(maxComputeRacks), Optional.ToNullable(maximumServerCount), Optional.ToList(supportedVersions), details.Value, Optional.ToNullable(provisioningState));
        }
    }
}
