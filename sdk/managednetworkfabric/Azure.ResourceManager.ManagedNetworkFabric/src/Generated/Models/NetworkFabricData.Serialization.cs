...
namespace Azure.ResourceManager.ManagedNetworkFabric
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NetworkFabricData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NetworkFabricData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NetworkFabricData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<NetworkFabricData>)} interface");
            }
        ...
        string IPersistableModel<NetworkFabricData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
