...
{
    public partial class NetworkFabricData : IUtf8JsonSerializable, IModelJsonSerializable<NetworkFabricData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IModelJsonSerializable<NetworkFabricData>)this).Serialize(writer, ModelSerializerOptions.DefaultWireOptions);

        void IModelJsonSerializable<NetworkFabricData>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<NetworkFabricData>(this, options.Format);
            ...
            {
                ((IModelJsonSerializable<TerminalServerConfiguration>)TerminalServerConfiguration).Serialize(writer, options);
            }
            ...
            {
                ((IModelJsonSerializable<ManagementNetworkConfigurationProperties>)ManagementNetworkConfiguration).Serialize(writer, options);
            }
            writer.WriteEndObject();
        ...
        internal static NetworkFabricData DeserializeNetworkFabricData(JsonElement element, ModelSerializerOptions options = default)
        {
        ...
        NetworkFabricData IModelJsonSerializable<NetworkFabricData>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<NetworkFabricData>(this, options.Format);

            using var doc = JsonDocument.ParseValue(ref reader);
            return DeserializeNetworkFabricData(doc.RootElement, options);
        }

        BinaryData IModelSerializable<NetworkFabricData>.Serialize(ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<NetworkFabricData>(this, options.Format);
        ...
        NetworkFabricData IModelSerializable<NetworkFabricData>.Deserialize(BinaryData data, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<NetworkFabricData>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="NetworkFabricData"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="NetworkFabricData"/> to convert. </param>
        public static implicit operator RequestContent(NetworkFabricData model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="NetworkFabricData"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator NetworkFabricData(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeNetworkFabricData(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
