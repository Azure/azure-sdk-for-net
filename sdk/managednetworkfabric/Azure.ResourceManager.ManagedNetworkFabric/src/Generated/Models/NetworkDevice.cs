...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    public partial class NetworkDevice : TrackedResourceData
    {
        /// <summary> Initializes a new instance of NetworkDevice. </summary>
        /// <param name="location"> The location. </param>
        public NetworkDevice(AzureLocation location) : base(location)
        {
        }
