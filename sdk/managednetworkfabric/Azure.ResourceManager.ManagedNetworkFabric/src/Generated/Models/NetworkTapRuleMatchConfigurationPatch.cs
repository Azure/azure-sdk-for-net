...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    public partial class NetworkTapRuleMatchConfigurationPatch
    {
        ...
        /// <summary> Initializes a new instance of <see cref="NetworkTapRuleMatchConfigurationPatch"/>. </summary>
        ...
        internal NetworkTapRuleMatchConfigurationPatch(string matchConfigurationName, long? sequenceNumber, NetworkFabricIPAddressType? ipAddressType, IList<NetworkTapRuleMatchConditionPatch> matchConditions, IList<NetworkTapRuleActionPatch> actions, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
        ...
        public IList<NetworkTapRuleMatchConditionPatch> MatchConditions { get; }

        /// <summary> List of actions that need to be performed for the matched conditions. </summary>
        public IList<NetworkTapRuleActionPatch> Actions { get; }
    }
}
