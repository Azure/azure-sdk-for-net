...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    public partial class UpdateAdministrativeStateResult
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="UpdateAdministrativeStateResult"/>. </summary>
        /// <param name="status"> Operation status. </param>
        internal UpdateAdministrativeStateResult(string status)
        {
            Status = status;
        ...
        internal UpdateAdministrativeStateResult(ResourceIdentifier id, string name, string status, double? percentComplete, DateTimeOffset? startsOn, DateTimeOffset? endsOn, IReadOnlyList<NetworkFabricOperationStatusResult> operations, ResponseError error, ResourceIdentifier resourceId, UpdateAdministrativeStateResponseProperties properties, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Id = id;
            Name = name;
            Status = status;
