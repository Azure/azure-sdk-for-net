...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    public partial class RouteTargetPatchInformation
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="RouteTargetPatchInformation"/>. </summary>
        ...
        internal RouteTargetPatchInformation(IList<string> importIpv4RouteTargets, IList<string> importIpv6RouteTargets, IList<string> exportIpv4RouteTargets, IList<string> exportIpv6RouteTargets, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
