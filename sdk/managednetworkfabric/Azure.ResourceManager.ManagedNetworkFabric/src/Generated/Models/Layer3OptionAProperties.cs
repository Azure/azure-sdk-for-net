...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    public partial class Layer3OptionAProperties : Layer3IPPrefixProperties
    {
        ...
        internal Layer3OptionAProperties(string primaryIPv4Prefix, string primaryIPv6Prefix, string secondaryIPv4Prefix, string secondaryIPv6Prefix, int? mtu, int? vlanId, int? fabricASN, int? peerASN, BfdConfiguration bfdConfiguration) : base(primaryIPv4Prefix, primaryIPv6Prefix, secondaryIPv4Prefix, secondaryIPv6Prefix)
        {
            Mtu = mtu;
            VlanId = vlanId;
            FabricASN = fabricASN;
