...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    public partial class NetworkFabricIPExtendedCommunityPatch : NetworkRackPatch
    {
        ...
        internal NetworkFabricIPExtendedCommunityPatch(IDictionary<string, string> tags, IList<IPExtendedCommunityRule> ipExtendedCommunityRules, string annotation, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(tags, serializedAdditionalRawData)
        {
