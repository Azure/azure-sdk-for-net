...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IPExtendedCommunityRule>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<IPExtendedCommunityRule>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<IPExtendedCommunityRule>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<IPExtendedCommunityRule>)} interface");
            }
        ...
        string IPersistableModel<IPExtendedCommunityRule>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
