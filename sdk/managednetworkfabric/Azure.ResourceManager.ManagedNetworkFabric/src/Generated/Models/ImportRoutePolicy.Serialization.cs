...
{
    public partial class ImportRoutePolicy : Core.IUtf8JsonSerializable
    {
        ...
        internal static ImportRoutePolicy DeserializeImportRoutePolicy(JsonElement element)
        {
            ...
            return new ImportRoutePolicy(importIPv4RoutePolicyId.Value, importIPv6RoutePolicyId.Value);
        }
    }
}
