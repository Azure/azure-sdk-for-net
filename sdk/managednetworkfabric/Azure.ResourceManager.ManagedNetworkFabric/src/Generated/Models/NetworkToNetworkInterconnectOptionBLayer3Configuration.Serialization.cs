...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NetworkToNetworkInterconnectOptionBLayer3Configuration>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<NetworkToNetworkInterconnectOptionBLayer3Configuration>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<NetworkToNetworkInterconnectOptionBLayer3Configuration>)} interface");
            }
        ...
        string IPersistableModel<NetworkToNetworkInterconnectOptionBLayer3Configuration>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
