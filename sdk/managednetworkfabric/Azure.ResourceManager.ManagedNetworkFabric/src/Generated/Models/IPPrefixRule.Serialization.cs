...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IPPrefixRule>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<IPPrefixRule>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<IPPrefixRule>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<IPPrefixRule>)} interface");
            }
        ...
        string IPersistableModel<IPPrefixRule>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
