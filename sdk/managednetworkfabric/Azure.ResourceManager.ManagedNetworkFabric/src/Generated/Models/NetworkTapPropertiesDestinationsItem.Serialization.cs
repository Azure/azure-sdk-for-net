...
{
    public partial class NetworkTapPropertiesDestinationsItem : IUtf8JsonSerializable, IJsonModel<NetworkTapPropertiesDestinationsItem>, IPersistableModel<NetworkTapPropertiesDestinationsItem>
    {
        ...
        void IJsonModel<NetworkTapPropertiesDestinationsItem>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(NetworkTapPropertiesDestinationsItem)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(IsolationDomainProperties))
            {
                ...
                AppendChildObject(builder, IsolationDomainProperties, options, 2);
            }
