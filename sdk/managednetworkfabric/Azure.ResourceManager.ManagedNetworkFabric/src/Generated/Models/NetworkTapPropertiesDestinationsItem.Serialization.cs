...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NetworkTapPropertiesDestinationsItem>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        NetworkTapPropertiesDestinationsItem IJsonModel<NetworkTapPropertiesDestinationsItem>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
                throw new FormatException($"The model {nameof(NetworkTapPropertiesDestinationsItem)} does not support '{options.Format}' format.");
            }
        ...
        BinaryData IModel<NetworkTapPropertiesDestinationsItem>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        NetworkTapPropertiesDestinationsItem IModel<NetworkTapPropertiesDestinationsItem>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<NetworkTapPropertiesDestinationsItem>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
