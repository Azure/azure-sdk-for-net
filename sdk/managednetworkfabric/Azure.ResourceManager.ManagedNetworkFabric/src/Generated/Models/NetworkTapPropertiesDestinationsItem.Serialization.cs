...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NetworkTapPropertiesDestinationsItem>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NetworkTapPropertiesDestinationsItem>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NetworkTapPropertiesDestinationsItem>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<NetworkTapPropertiesDestinationsItem>)} interface");
            }
        ...
        string IPersistableModel<NetworkTapPropertiesDestinationsItem>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
