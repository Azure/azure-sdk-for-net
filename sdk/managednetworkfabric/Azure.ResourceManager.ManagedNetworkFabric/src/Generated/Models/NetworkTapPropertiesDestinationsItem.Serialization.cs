...
{
    public partial class NetworkTapPropertiesDestinationsItem : Core.IUtf8JsonSerializable
    {
        ...
        internal static NetworkTapPropertiesDestinationsItem DeserializeNetworkTapPropertiesDestinationsItem(JsonElement element)
        {
            ...
            return new NetworkTapPropertiesDestinationsItem(name.Value, Core.Optional.ToNullable(destinationType), destinationId.Value, isolationDomainProperties.Value, destinationTapRuleId.Value);
        }
    }
}
