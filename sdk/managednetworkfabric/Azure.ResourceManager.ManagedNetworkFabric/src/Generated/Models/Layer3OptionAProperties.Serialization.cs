...
{
    public partial class Layer3OptionAProperties : IUtf8JsonSerializable
    {
        ...
        internal static Layer3OptionAProperties DeserializeLayer3OptionAProperties(JsonElement element)
        {
            ...
            return new Layer3OptionAProperties(primaryIPv4Prefix.Value, primaryIPv6Prefix.Value, secondaryIPv4Prefix.Value, secondaryIPv6Prefix.Value, Optional.ToNullable(mtu), Optional.ToNullable(vlanId), Optional.ToNullable(fabricASN), Optional.ToNullable(peerASN), bfdConfiguration.Value);
        }
    }
}
