...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    public partial class L2IsolationDomainProperties : AnnotationResourceProperties, IJsonModel<L2IsolationDomainProperties>
    {
        ...
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        L2IsolationDomainProperties IPersistableModel<L2IsolationDomainProperties>.Create(BinaryData data, ModelReaderWriterOptions options) => (L2IsolationDomainProperties)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        L2IsolationDomainProperties IJsonModel<L2IsolationDomainProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (L2IsolationDomainProperties)JsonModelCreateCore(ref reader, options);
