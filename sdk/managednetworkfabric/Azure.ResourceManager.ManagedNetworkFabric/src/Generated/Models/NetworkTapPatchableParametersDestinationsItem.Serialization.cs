...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NetworkTapPatchableParametersDestinationsItem>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<NetworkTapPatchableParametersDestinationsItem>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<NetworkTapPatchableParametersDestinationsItem>)} interface");
            }
        ...
        string IPersistableModel<NetworkTapPatchableParametersDestinationsItem>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
