...
{
    public partial class IPPrefixPropertiesIPPrefixRulesItem : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            if (Optional.IsDefined(SubnetMaskLength))
            {
                ...
                writer.WriteNumberValue(SubnetMaskLength.Value);
            }
            writer.WriteEndObject();
        }

        internal static IPPrefixPropertiesIPPrefixRulesItem DeserializeIPPrefixPropertiesIPPrefixRulesItem(JsonElement element)
        {
            ...
            Optional<int> subnetMaskLength = default;
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("subnetMaskLength"u8))
                {
                    ...
                    subnetMaskLength = property.Value.GetInt32();
                    continue;
                }
            }
            return new IPPrefixPropertiesIPPrefixRulesItem(action, sequenceNumber, networkPrefix, Optional.ToNullable(condition), Optional.ToNullable(subnetMaskLength));
        }
    }
}
