...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SupportedVersionProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SupportedVersionProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SupportedVersionProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SupportedVersionProperties>)} interface");
            }
        ...
        string IPersistableModel<SupportedVersionProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
