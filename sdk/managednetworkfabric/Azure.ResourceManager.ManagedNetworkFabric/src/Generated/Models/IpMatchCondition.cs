...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    public partial class IpMatchCondition
    {
        ...
        internal IpMatchCondition(SourceDestinationType? @type, PrefixType? prefixType, IList<string> ipPrefixValues, IList<string> ipGroupNames, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Type = @type;
