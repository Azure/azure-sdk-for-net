...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NetworkToNetworkInterconnectsList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NetworkToNetworkInterconnectsList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NetworkToNetworkInterconnectsList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<NetworkToNetworkInterconnectsList>)} interface");
            }
        ...
        string IPersistableModel<NetworkToNetworkInterconnectsList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
