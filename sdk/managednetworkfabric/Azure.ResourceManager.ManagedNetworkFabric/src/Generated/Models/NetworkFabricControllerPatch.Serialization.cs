...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    public partial class NetworkFabricControllerPatch : IUtf8JsonSerializable, IModelJsonSerializable<NetworkFabricControllerPatch>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<NetworkFabricControllerPatch>(this, options.Format);
        ...
        internal static NetworkFabricControllerPatch DeserializeNetworkFabricControllerPatch(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new NetworkFabricControllerPatch(Optional.ToDictionary(tags), Optional.ToList(infrastructureExpressRouteConnections), Optional.ToList(workloadExpressRouteConnections), serializedAdditionalRawData);
        }
