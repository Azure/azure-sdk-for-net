...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    public partial class NetworkFabricControllerPatch : IJsonModel<NetworkFabricControllerPatch>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        NetworkFabricControllerPatch IJsonModel<NetworkFabricControllerPatch>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual NetworkFabricControllerPatch JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<NetworkFabricControllerPatch>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static NetworkFabricControllerPatch DeserializeNetworkFabricControllerPatch(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new NetworkFabricControllerPatch(tags ?? new ChangeTrackingDictionary<string, string>(), properties, additionalBinaryDataProperties);
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        NetworkFabricControllerPatch IPersistableModel<NetworkFabricControllerPatch>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual NetworkFabricControllerPatch PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<NetworkFabricControllerPatch>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
        ...
        internal static RequestContent ToRequestContent(NetworkFabricControllerPatch networkFabricControllerPatch)
        {
            ...
            content.JsonWriter.WriteObjectValue(networkFabricControllerPatch, ModelSerializationExtensions.WireOptions);
            return content;
        }
    }
}
