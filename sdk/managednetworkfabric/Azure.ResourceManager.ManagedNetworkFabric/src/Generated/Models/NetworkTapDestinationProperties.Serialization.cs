...
{
    public partial class NetworkTapDestinationProperties : Core.IUtf8JsonSerializable
    {
        ...
        internal static NetworkTapDestinationProperties DeserializeNetworkTapDestinationProperties(JsonElement element)
        {
            ...
            return new NetworkTapDestinationProperties(name.Value, Core.Optional.ToNullable(destinationType), destinationId.Value, isolationDomainProperties.Value, destinationTapRuleId.Value);
        }
    }
}
