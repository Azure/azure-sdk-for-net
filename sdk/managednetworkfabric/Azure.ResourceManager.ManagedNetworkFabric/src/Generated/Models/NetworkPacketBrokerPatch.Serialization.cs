...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    public partial class NetworkPacketBrokerPatch : IJsonModel<NetworkPacketBrokerPatch>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        NetworkPacketBrokerPatch IJsonModel<NetworkPacketBrokerPatch>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual NetworkPacketBrokerPatch JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<NetworkPacketBrokerPatch>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static NetworkPacketBrokerPatch DeserializeNetworkPacketBrokerPatch(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new NetworkPacketBrokerPatch(tags ?? new ChangeTrackingDictionary<string, string>(), additionalBinaryDataProperties);
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        NetworkPacketBrokerPatch IPersistableModel<NetworkPacketBrokerPatch>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual NetworkPacketBrokerPatch PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<NetworkPacketBrokerPatch>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
        ...
        internal static RequestContent ToRequestContent(NetworkPacketBrokerPatch networkPacketBrokerPatch)
        {
            ...
            content.JsonWriter.WriteObjectValue(networkPacketBrokerPatch, ModelSerializationExtensions.WireOptions);
            return content;
        }
    }
}
