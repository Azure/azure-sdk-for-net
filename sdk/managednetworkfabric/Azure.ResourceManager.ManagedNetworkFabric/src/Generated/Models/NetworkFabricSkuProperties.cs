...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    public partial class NetworkFabricSkuProperties
    {
        ...
        internal NetworkFabricSkuProperties(NetworkFabricSkuType? skuType, int? maxComputeRacks, int? maximumServerCount, IReadOnlyList<string> supportedVersions, string details, NetworkFabricProvisioningState? provisioningState, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            SkuType = skuType;
        ...
        public NetworkFabricSkuType? SkuType { get; }
