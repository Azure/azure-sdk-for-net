...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    public partial class NetworkFabricL3IsolationDomainPatch : IUtf8JsonSerializable, IModelJsonSerializable<NetworkFabricL3IsolationDomainPatch>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<NetworkFabricL3IsolationDomainPatch>(this, options.Format);
        ...
        internal static NetworkFabricL3IsolationDomainPatch DeserializeNetworkFabricL3IsolationDomainPatch(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new NetworkFabricL3IsolationDomainPatch(Optional.ToDictionary(tags), annotation.Value, Optional.ToNullable(redistributeConnectedSubnets), Optional.ToNullable(redistributeStaticRoutes), aggregateRouteConfiguration.Value, connectedSubnetRoutePolicy.Value, serializedAdditionalRawData);
        }
        ...
        /// <summary> Converts a <see cref="NetworkFabricL3IsolationDomainPatch"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="NetworkFabricL3IsolationDomainPatch"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="NetworkFabricL3IsolationDomainPatch"/>. </summary>
