...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ActionIPCommunityProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ActionIPCommunityProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ActionIPCommunityProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ActionIPCommunityProperties>)} interface");
            }
        ...
        string IPersistableModel<ActionIPCommunityProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
