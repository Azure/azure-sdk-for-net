...
{
    public partial class NetworkDeviceData : IUtf8JsonSerializable, IModelJsonSerializable<NetworkDeviceData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IModelJsonSerializable<NetworkDeviceData>)this).Serialize(writer, ModelSerializerOptions.DefaultWireOptions);

        void IModelJsonSerializable<NetworkDeviceData>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<NetworkDeviceData>(this, options.Format);
        ...
        internal static NetworkDeviceData DeserializeNetworkDeviceData(JsonElement element, ModelSerializerOptions options = default)
        {
        ...
        NetworkDeviceData IModelJsonSerializable<NetworkDeviceData>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<NetworkDeviceData>(this, options.Format);

            using var doc = JsonDocument.ParseValue(ref reader);
            return DeserializeNetworkDeviceData(doc.RootElement, options);
        }

        BinaryData IModelSerializable<NetworkDeviceData>.Serialize(ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<NetworkDeviceData>(this, options.Format);
        ...
        NetworkDeviceData IModelSerializable<NetworkDeviceData>.Deserialize(BinaryData data, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<NetworkDeviceData>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="NetworkDeviceData"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="NetworkDeviceData"/> to convert. </param>
        public static implicit operator RequestContent(NetworkDeviceData model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="NetworkDeviceData"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator NetworkDeviceData(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeNetworkDeviceData(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
