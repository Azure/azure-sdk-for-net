...
namespace Azure.ResourceManager.ManagedNetworkFabric
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NetworkDeviceData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NetworkDeviceData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NetworkDeviceData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<NetworkDeviceData>)} interface");
            }
        ...
        string IPersistableModel<NetworkDeviceData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
