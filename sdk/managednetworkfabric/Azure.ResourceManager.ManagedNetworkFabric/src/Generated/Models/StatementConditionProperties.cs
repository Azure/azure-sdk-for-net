...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    public partial class StatementConditionProperties : IPCommunityIdList
    {
        ...
        internal StatementConditionProperties(IList<ResourceIdentifier> ipCommunityIds, RoutePolicyConditionType? routePolicyConditionType, ResourceIdentifier ipPrefixId, IList<ResourceIdentifier> ipExtendedCommunityIds, Dictionary<string, BinaryData> rawData) : base(ipCommunityIds, rawData)
        {
