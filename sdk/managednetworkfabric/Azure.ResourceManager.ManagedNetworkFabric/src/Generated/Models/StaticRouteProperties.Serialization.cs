...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StaticRouteProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<StaticRouteProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<StaticRouteProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<StaticRouteProperties>)} interface");
            }
        ...
        string IPersistableModel<StaticRouteProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
