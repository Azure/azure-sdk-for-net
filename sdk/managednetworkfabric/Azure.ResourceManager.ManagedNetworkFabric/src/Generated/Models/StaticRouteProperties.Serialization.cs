...
{
    public partial class StaticRouteProperties : IUtf8JsonSerializable, IJsonModel<StaticRouteProperties>, IPersistableModel<StaticRouteProperties>
    {
        ...
        void IJsonModel<StaticRouteProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(StaticRouteProperties)} does not support '{format}' format.");
            }
