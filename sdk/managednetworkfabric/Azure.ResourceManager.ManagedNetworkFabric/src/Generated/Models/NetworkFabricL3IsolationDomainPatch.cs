...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    public partial class NetworkFabricL3IsolationDomainPatch : NetworkRackPatch
    {
        ...
        internal NetworkFabricL3IsolationDomainPatch(IDictionary<string, string> tags, string annotation, RedistributeConnectedSubnet? redistributeConnectedSubnets, RedistributeStaticRoute? redistributeStaticRoutes, AggregateRouteConfiguration aggregateRouteConfiguration, ConnectedSubnetRoutePolicy connectedSubnetRoutePolicy, Dictionary<string, BinaryData> rawData) : base(tags, rawData)
        {
