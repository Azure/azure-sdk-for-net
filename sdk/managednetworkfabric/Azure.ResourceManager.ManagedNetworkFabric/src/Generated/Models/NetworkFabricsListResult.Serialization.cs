...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    internal partial class NetworkFabricsListResult
    {
        internal static NetworkFabricsListResult DeserializeNetworkFabricsListResult(JsonElement element)
        {
            ...
            Optional<IReadOnlyList<NetworkFabric>> value = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("value"u8))
                {
                    ...
                    List<NetworkFabric> array = new List<NetworkFabric>();
                    foreach (var item in property.Value.EnumerateArray())
                    {
                        array.Add(NetworkFabric.DeserializeNetworkFabric(item));
                    }
                    value = array;
                    continue;
                }
