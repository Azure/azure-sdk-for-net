...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    {
        internal static NetworkFabricsListResult DeserializeNetworkFabricsListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
