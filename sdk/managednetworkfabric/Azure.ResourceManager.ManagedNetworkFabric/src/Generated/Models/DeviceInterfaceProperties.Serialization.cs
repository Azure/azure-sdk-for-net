...
{
    public partial class DeviceInterfaceProperties : IUtf8JsonSerializable
    {
        ...
        internal static DeviceInterfaceProperties DeserializeDeviceInterfaceProperties(JsonElement element)
        {
            ...
            return new DeviceInterfaceProperties(identifier.Value, interfaceType.Value, Optional.ToList(supportedConnectorTypes));
        }
    }
}
