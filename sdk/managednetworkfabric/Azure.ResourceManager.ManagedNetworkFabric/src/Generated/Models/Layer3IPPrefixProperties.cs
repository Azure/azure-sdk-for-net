...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    public partial class Layer3IPPrefixProperties
    {
        ...
        internal Layer3IPPrefixProperties(string primaryIPv4Prefix, string primaryIPv6Prefix, string secondaryIPv4Prefix, string secondaryIPv6Prefix, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
