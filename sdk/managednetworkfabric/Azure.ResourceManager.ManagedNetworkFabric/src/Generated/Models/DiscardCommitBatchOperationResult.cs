...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    public partial class DiscardCommitBatchOperationResult
    {
        ...
        internal DiscardCommitBatchOperationResult(ResourceIdentifier id, string name, string status, double? percentComplete, DateTimeOffset? startsOn, DateTimeOffset? endsOn, IReadOnlyList<NetworkFabricOperationStatusResult> operations, ResponseError error, ResourceIdentifier resourceId, DiscardCommitBatchResponseProperties properties, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Id = id;
            Name = name;
            Status = status;
        ...
        public string CommitBatchId
        {
            get
            {
                return Properties is null ? default : Properties.CommitBatchId;
            }
        }
    }
}
