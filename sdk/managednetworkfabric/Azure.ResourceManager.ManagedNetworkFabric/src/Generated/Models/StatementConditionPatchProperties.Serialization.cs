...
{
    public partial class StatementConditionPatchProperties : IUtf8JsonSerializable, IJsonModel<StatementConditionPatchProperties>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StatementConditionPatchProperties>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<StatementConditionPatchProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        StatementConditionPatchProperties IJsonModel<StatementConditionPatchProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<StatementConditionPatchProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static StatementConditionPatchProperties DeserializeStatementConditionPatchProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new StatementConditionPatchProperties(ipCommunityIds ?? new ChangeTrackingList<string>(), ipExtendedCommunityIds ?? new ChangeTrackingList<string>(), type, ipPrefixId, serializedAdditionalRawData);
        }

        BinaryData IPersistableModel<StatementConditionPatchProperties>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<StatementConditionPatchProperties>)this).GetFormatFromOptions(options) : options.Format;
        ...
        StatementConditionPatchProperties IPersistableModel<StatementConditionPatchProperties>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<StatementConditionPatchProperties>)this).GetFormatFromOptions(options) : options.Format;
