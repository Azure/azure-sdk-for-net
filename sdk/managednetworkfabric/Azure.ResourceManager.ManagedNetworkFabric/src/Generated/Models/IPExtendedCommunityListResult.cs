...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    internal partial class IPExtendedCommunityListResult
    {
        ...
        {
            Value = new ChangeTrackingList<IPExtendedCommunity>();
        }

        /// <summary> Initializes a new instance of IPExtendedCommunityListResult. </summary>
        /// <param name="value"> List of IP Extended Communities resources. </param>
        /// <param name="nextLink"> Url to follow for getting next page of resources. </param>
        internal IPExtendedCommunityListResult(IReadOnlyList<IPExtendedCommunity> value, string nextLink)
        {
            Value = value;
            NextLink = nextLink;
        }
        ...
        public IReadOnlyList<IPExtendedCommunity> Value { get; }
