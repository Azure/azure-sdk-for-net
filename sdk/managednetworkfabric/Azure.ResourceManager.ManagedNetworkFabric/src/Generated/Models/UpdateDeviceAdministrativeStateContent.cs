...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    public partial class UpdateDeviceAdministrativeStateContent : UpdateAdministrativeStateOnResources
    {
        ...
        internal UpdateDeviceAdministrativeStateContent(IList<ResourceIdentifier> resourceIds, NetworkDeviceAdministrativeState? state, Dictionary<string, BinaryData> rawData) : base(resourceIds, rawData)
        {
            State = state;
        }
