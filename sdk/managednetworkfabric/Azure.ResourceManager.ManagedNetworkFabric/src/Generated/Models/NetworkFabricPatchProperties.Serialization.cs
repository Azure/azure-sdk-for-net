...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    internal partial class NetworkFabricPatchProperties : IJsonModel<NetworkFabricPatchProperties>
    {
        ...
        internal static NetworkFabricPatchProperties DeserializeNetworkFabricPatchProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("qosConfiguration"u8))
                {
                    ...
                    qosConfiguration = QosPatchProperties.DeserializeQosPatchProperties(prop.Value, options);
                    continue;
                }
                ...
                if (prop.NameEquals("authorizedTransceiver"u8))
                {
                    ...
                    authorizedTransceiver = AuthorizedTransceiverPatchProperties.DeserializeAuthorizedTransceiverPatchProperties(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
