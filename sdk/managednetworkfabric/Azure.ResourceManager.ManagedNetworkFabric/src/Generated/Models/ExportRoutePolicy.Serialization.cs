...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ExportRoutePolicy>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ExportRoutePolicy>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ExportRoutePolicy>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ExportRoutePolicy>)} interface");
            }
        ...
        string IPersistableModel<ExportRoutePolicy>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
