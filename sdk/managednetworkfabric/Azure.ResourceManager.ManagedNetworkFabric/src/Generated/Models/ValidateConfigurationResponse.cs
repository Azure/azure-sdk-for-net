...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    public partial class ValidateConfigurationResponse : CommonErrorResponse
    {
        ...
        internal ValidateConfigurationResponse(ResponseError error, IDictionary<string, BinaryData> serializedAdditionalRawData, ConfigurationState? configurationState, string uri) : base(error, serializedAdditionalRawData)
        {
