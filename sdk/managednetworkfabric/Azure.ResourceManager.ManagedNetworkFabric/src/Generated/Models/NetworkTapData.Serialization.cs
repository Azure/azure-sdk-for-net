...
namespace Azure.ResourceManager.ManagedNetworkFabric
{
    public partial class NetworkTapData : IUtf8JsonSerializable, IJsonModel<NetworkTapData>
    {
        ...
        void IJsonModel<NetworkTapData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(NetworkTapData)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<NetworkTapData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(NetworkTapData)} does not support '{options.Format}' format.");
            }
        }
