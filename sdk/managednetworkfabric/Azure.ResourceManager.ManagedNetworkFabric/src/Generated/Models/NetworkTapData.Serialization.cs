...
{
    public partial class NetworkTapData : IUtf8JsonSerializable, IJsonModel<NetworkTapData>, IPersistableModel<NetworkTapData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(NetworkPacketBrokerId))
            {
                builder.Append("  networkPacketBrokerId:");
                builder.AppendLine($" '{NetworkPacketBrokerId.ToString()}'");
            }

            if (Optional.IsDefined(SourceTapRuleId))
            {
                builder.Append("  sourceTapRuleId:");
                builder.AppendLine($" '{SourceTapRuleId.ToString()}'");
            }
            ...
            if (Optional.IsDefined(PollingType))
            {
                builder.Append("  pollingType:");
                builder.AppendLine($" '{PollingType.ToString()}'");
            }
