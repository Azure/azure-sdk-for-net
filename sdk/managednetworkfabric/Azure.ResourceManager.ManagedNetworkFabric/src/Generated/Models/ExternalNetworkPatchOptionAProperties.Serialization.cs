...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ExternalNetworkPatchOptionAProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ExternalNetworkPatchOptionAProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ExternalNetworkPatchOptionAProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ExternalNetworkPatchOptionAProperties>)} interface");
            }
        ...
        string IPersistableModel<ExternalNetworkPatchOptionAProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
