...
{
    public partial class VpnConfigurationPatchablePropertiesOptionAProperties : IUtf8JsonSerializable
    {
        ...
        internal static VpnConfigurationPatchablePropertiesOptionAProperties DeserializeVpnConfigurationPatchablePropertiesOptionAProperties(JsonElement element)
        {
            ...
            return new VpnConfigurationPatchablePropertiesOptionAProperties(Optional.ToNullable(mtu), Optional.ToNullable(vlanId), Optional.ToNullable(peerASN), bfdConfiguration.Value, primaryIPv4Prefix.Value, primaryIPv6Prefix.Value, secondaryIPv4Prefix.Value, secondaryIPv6Prefix.Value);
        }
    }
}
