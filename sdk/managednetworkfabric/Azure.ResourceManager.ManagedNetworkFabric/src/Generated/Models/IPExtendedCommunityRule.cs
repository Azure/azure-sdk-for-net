...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    public partial class IPExtendedCommunityRule
    {
        ...
        internal IPExtendedCommunityRule(CommunityActionType action, long sequenceNumber, IList<string> routeTargets, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Action = action;
            SequenceNumber = sequenceNumber;
