...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    public partial class IPExtendedCommunityRule
    {
        ...
        internal IPExtendedCommunityRule(CommunityActionType action, long sequenceNumber, IList<string> routeTargets, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Action = action;
            SequenceNumber = sequenceNumber;
