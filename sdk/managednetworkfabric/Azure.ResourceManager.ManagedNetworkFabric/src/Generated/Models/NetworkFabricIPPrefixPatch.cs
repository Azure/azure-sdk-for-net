...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    public partial class NetworkFabricIPPrefixPatch : NetworkRackPatch
    {
        ...
        internal NetworkFabricIPPrefixPatch(IDictionary<string, string> tags, string annotation, IList<IPPrefixRule> ipPrefixRules, Dictionary<string, BinaryData> rawData) : base(tags, rawData)
        {
