...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    public readonly partial struct BurstSizeUnit : IEquatable<BurstSizeUnit>
    {
        ...
        /// <summary> Burst size unit in packets. </summary>
        public static BurstSizeUnit Packets { get; } = new BurstSizeUnit(PacketsValue);
        ...
        /// <summary> Converts a string to a <see cref="BurstSizeUnit"/>. </summary>
        /// <param name="value"> The value. </param>
        public static implicit operator BurstSizeUnit(string value) => new BurstSizeUnit(value);

        /// <summary> Converts a string to a <see cref="BurstSizeUnit"/>. </summary>
        /// <param name="value"> The value. </param>
        public static implicit operator BurstSizeUnit?(string value) => value == null ? null : new BurstSizeUnit(value);
