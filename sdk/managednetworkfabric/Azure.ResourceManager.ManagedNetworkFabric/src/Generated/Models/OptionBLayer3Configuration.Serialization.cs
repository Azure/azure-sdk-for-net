...
{
    public partial class OptionBLayer3Configuration : Core.IUtf8JsonSerializable
    {
        ...
        internal static OptionBLayer3Configuration DeserializeOptionBLayer3Configuration(JsonElement element)
        {
            ...
            return new OptionBLayer3Configuration(primaryIPv4Prefix.Value, primaryIPv6Prefix.Value, secondaryIPv4Prefix.Value, secondaryIPv6Prefix.Value, Core.Optional.ToNullable(peerAsn), Core.Optional.ToNullable(vlanId), Core.Optional.ToNullable(fabricAsn));
        }
    }
}
