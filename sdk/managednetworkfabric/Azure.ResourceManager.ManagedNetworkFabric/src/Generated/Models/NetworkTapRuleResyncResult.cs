...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    public partial class NetworkTapRuleResyncResult
    {
        ...
        /// <summary> Initializes a new instance of <see cref="NetworkTapRuleResyncResult"/>. </summary>
        /// <param name="status"> Operation status. </param>
        internal NetworkTapRuleResyncResult(string status)
        {
            Status = status;
        ...
        internal NetworkTapRuleResyncResult(ResourceIdentifier id, string name, string status, double? percentComplete, DateTimeOffset? startOn, DateTimeOffset? endOn, IList<OperationStatusResult> operations, ResponseError error, ResourceIdentifier resourceId, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Id = id;
            Name = name;
            Status = status;
