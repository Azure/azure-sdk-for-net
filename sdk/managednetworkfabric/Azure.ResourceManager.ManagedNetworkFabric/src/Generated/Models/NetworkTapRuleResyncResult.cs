...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    public partial class NetworkTapRuleResyncResult
    {
        ...
        internal NetworkTapRuleResyncResult(ResourceIdentifier id, string name, string status, double? percentComplete, DateTimeOffset? startsOn, DateTimeOffset? endsOn, IReadOnlyList<NetworkFabricOperationStatusResult> operations, ResponseError error, ResourceIdentifier resourceId, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Id = id;
            Name = name;
            Status = status;
