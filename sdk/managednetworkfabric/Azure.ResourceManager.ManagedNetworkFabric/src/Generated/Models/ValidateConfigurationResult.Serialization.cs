...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    public partial class ValidateConfigurationResult : NetworkFabricErrorResult, IJsonModel<ValidateConfigurationResult>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<ValidateConfigurationResult>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ValidateConfigurationResult>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        ValidateConfigurationResult IPersistableModel<ValidateConfigurationResult>.Create(BinaryData data, ModelReaderWriterOptions options) => (ValidateConfigurationResult)PersistableModelCreateCore(data, options);

        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<ValidateConfigurationResult>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";

        /// <param name="response"> The <see cref="Response"/> to deserialize the <see cref="ValidateConfigurationResult"/> from. </param>
        internal static ValidateConfigurationResult FromResponse(Response response)
        {
            using JsonDocument document = JsonDocument.Parse(response.Content, ModelSerializationExtensions.JsonDocumentOptions);
            return DeserializeValidateConfigurationResult(document.RootElement, ModelSerializationExtensions.WireOptions);
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ValidateConfigurationResult IJsonModel<ValidateConfigurationResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (ValidateConfigurationResult)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static ValidateConfigurationResult DeserializeValidateConfigurationResult(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new ValidateConfigurationResult(error, additionalBinaryDataProperties, configurationState, uri);
        }
    }
}
