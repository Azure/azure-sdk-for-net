...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ValidateConfigurationResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ValidateConfigurationResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ValidateConfigurationResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ValidateConfigurationResult>)} interface");
            }
        ...
        string IPersistableModel<ValidateConfigurationResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
