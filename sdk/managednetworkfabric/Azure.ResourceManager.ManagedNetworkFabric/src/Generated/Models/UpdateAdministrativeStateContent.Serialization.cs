...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<UpdateAdministrativeStateContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<UpdateAdministrativeStateContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<UpdateAdministrativeStateContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<UpdateAdministrativeStateContent>)} interface");
            }
        ...
        string IPersistableModel<UpdateAdministrativeStateContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
