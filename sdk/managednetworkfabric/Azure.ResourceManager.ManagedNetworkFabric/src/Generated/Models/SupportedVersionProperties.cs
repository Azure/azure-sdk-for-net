...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    public partial class SupportedVersionProperties
    {
        ...
        internal SupportedVersionProperties(string version, string vendorOSVersion, string vendorFirmwareVersion, NetworkFabricBooleanValue? isDefault, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Version = version;
