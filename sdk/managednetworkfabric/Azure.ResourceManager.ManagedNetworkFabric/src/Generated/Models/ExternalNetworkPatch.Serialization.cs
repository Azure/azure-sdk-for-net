...
{
    public partial class ExternalNetworkPatch : IUtf8JsonSerializable, IJsonModel<ExternalNetworkPatch>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ExternalNetworkPatch>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<ExternalNetworkPatch>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        ExternalNetworkPatch IJsonModel<ExternalNetworkPatch>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ExternalNetworkPatch>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static ExternalNetworkPatch DeserializeExternalNetworkPatch(JsonElement element, ModelReaderWriterOptions options = null)
        {
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("optionAProperties"u8))
                        {
                            ...
                            optionAProperties = ExternalNetworkPatchPropertiesOptionAProperties.DeserializeExternalNetworkPatchPropertiesOptionAProperties(property0.Value, options);
                            continue;
                        }
            ...
            return new ExternalNetworkPatch(
                annotation,
        ...
        BinaryData IPersistableModel<ExternalNetworkPatch>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ExternalNetworkPatch>)this).GetFormatFromOptions(options) : options.Format;
        ...
        ExternalNetworkPatch IPersistableModel<ExternalNetworkPatch>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ExternalNetworkPatch>)this).GetFormatFromOptions(options) : options.Format;
