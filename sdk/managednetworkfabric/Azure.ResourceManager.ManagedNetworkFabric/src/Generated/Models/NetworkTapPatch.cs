...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    public partial class NetworkTapPatch : NetworkRackPatch
    {
        ...
        internal NetworkTapPatch(IDictionary<string, string> tags, string annotation, NetworkTapPollingType? pollingType, IList<NetworkTapPatchableParametersDestinationsItem> destinations, Dictionary<string, BinaryData> rawData) : base(tags, rawData)
        {
