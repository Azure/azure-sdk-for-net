...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    public partial class IPExtendedCommunityAddOperationProperties : IJsonModel<IPExtendedCommunityAddOperationProperties>
    {
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual IPExtendedCommunityAddOperationProperties PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<IPExtendedCommunityAddOperationProperties>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        IPExtendedCommunityAddOperationProperties IPersistableModel<IPExtendedCommunityAddOperationProperties>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        IPExtendedCommunityAddOperationProperties IJsonModel<IPExtendedCommunityAddOperationProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual IPExtendedCommunityAddOperationProperties JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<IPExtendedCommunityAddOperationProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static IPExtendedCommunityAddOperationProperties DeserializeIPExtendedCommunityAddOperationProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new IPExtendedCommunityAddOperationProperties(@add, additionalBinaryDataProperties);
        }
    }
}
