...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    public partial class IPExtendedCommunityAddOperationProperties : IUtf8JsonSerializable, IJsonModel<IPExtendedCommunityAddOperationProperties>
    {
        ...
        void IJsonModel<IPExtendedCommunityAddOperationProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(IPExtendedCommunityAddOperationProperties)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<IPExtendedCommunityAddOperationProperties>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(IPExtendedCommunityAddOperationProperties)} does not support '{options.Format}' format.");
            }
        }
