...
{
    public partial class OptionBProperties : Core.IUtf8JsonSerializable
    {
        ...
        internal static OptionBProperties DeserializeOptionBProperties(JsonElement element)
        {
            ...
            return new OptionBProperties(Core.Optional.ToList(importRouteTargets), Core.Optional.ToList(exportRouteTargets), routeTargets.Value);
        }
    }
}
