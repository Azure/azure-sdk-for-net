...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<OptionBProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<OptionBProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<OptionBProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<OptionBProperties>)} interface");
            }
        ...
        string IPersistableModel<OptionBProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
