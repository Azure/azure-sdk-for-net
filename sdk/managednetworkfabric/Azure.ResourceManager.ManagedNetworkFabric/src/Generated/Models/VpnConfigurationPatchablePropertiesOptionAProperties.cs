...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    public partial class VpnConfigurationPatchablePropertiesOptionAProperties : OptionAProperties
    {
        /// <summary> Initializes a new instance of VpnConfigurationPatchablePropertiesOptionAProperties. </summary>
        ...
        internal VpnConfigurationPatchablePropertiesOptionAProperties(int? mtu, int? vlanId, long? peerASN, BfdConfiguration bfdConfiguration, string primaryIPv4Prefix, string primaryIPv6Prefix, string secondaryIPv4Prefix, string secondaryIPv6Prefix) : base(mtu, vlanId, peerASN, bfdConfiguration)
        {
