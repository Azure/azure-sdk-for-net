...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<L2IsolationDomainsListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<L2IsolationDomainsListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<L2IsolationDomainsListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<L2IsolationDomainsListResult>)} interface");
            }
        ...
        string IPersistableModel<L2IsolationDomainsListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
