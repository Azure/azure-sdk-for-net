...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    public partial class NetworkFabricOptionAProperties : NetworkFabricLayer3IPPrefixProperties
    {
        ...
        internal NetworkFabricOptionAProperties(string primaryIPv4Prefix, string primaryIPv6Prefix, string secondaryIPv4Prefix, string secondaryIPv6Prefix, int? mtu, int? vlanId, int? peerASN, OptionAPropertiesBfdConfiguration bfdConfiguration) : base(primaryIPv4Prefix, primaryIPv6Prefix, secondaryIPv4Prefix, secondaryIPv6Prefix)
        {
            Mtu = mtu;
            VlanId = vlanId;
            PeerASN = peerASN;
        ...
        public OptionAPropertiesBfdConfiguration BfdConfiguration { get; set; }
    }
}
