...
{
    internal partial class NetworkDeviceSkusListResult : IUtf8JsonSerializable, IJsonModel<NetworkDeviceSkusListResult>, IPersistableModel<NetworkDeviceSkusListResult>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NetworkDeviceSkusListResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<NetworkDeviceSkusListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(NetworkDeviceSkusListResult)} does not support '{format}' format.");
            }
