...
{
    public partial class NetworkFabricInternetGatewayData : IUtf8JsonSerializable, IJsonModel<NetworkFabricInternetGatewayData>, IPersistableModel<NetworkFabricInternetGatewayData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(InternetGatewayRuleId))
            {
                builder.Append("  internetGatewayRuleId:");
                builder.AppendLine($" '{InternetGatewayRuleId.ToString()}'");
            }
