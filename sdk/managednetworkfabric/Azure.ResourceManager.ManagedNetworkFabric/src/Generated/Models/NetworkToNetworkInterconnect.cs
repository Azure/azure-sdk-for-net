...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    public partial class NetworkToNetworkInterconnect : ResourceData
    {
        /// <summary> Initializes a new instance of NetworkToNetworkInterconnect. </summary>
        /// <param name="useOptionB"> Based on this option layer3 parameters are mandatory. Example: True/False. </param>
        public NetworkToNetworkInterconnect(BooleanEnumProperty useOptionB)
        {
        ...
        internal NetworkToNetworkInterconnect(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, NniType? nniType, IsManagementType? isManagementType, BooleanEnumProperty useOptionB, Layer2Configuration layer2Configuration, NetworkToNetworkInterconnectPropertiesOptionBLayer3Configuration optionBLayer3Configuration, NpbStaticRouteConfiguration npbStaticRouteConfiguration, ImportRoutePolicyInformation importRoutePolicy, ExportRoutePolicyInformation exportRoutePolicy, ResourceIdentifier egressAclId, ResourceIdentifier ingressAclId, ConfigurationState? configurationState, ProvisioningState? provisioningState, AdministrativeState? administrativeState) : base(id, name, resourceType, systemData)
        {
            NniType = nniType;
        ...
        public NetworkToNetworkInterconnectPropertiesOptionBLayer3Configuration OptionBLayer3Configuration { get; set; }
