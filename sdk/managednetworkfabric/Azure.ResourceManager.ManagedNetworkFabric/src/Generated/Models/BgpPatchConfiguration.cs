...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    public partial class BgpPatchConfiguration : AnnotationResource
    {
        ...
        internal BgpPatchConfiguration(string annotation, IDictionary<string, BinaryData> serializedAdditionalRawData, BfdPatchConfiguration bfdConfiguration, BooleanEnumProperty? defaultRouteOriginate, int? allowAS, AllowASOverride? allowASOverride, long? fabricASN, long? peerASN, IList<string> ipv4ListenRangePrefixes, IList<string> ipv6ListenRangePrefixes, IList<NeighborAddressPatch> ipv4NeighborAddress, IList<NeighborAddressPatch> ipv6NeighborAddress, InternalNetworkBmpPatchProperties bmpConfiguration, V4OverV6BgpSessionState? v4OverV6BgpSession, V6OverV4BgpSessionState? v6OverV4BgpSession) : base(annotation, serializedAdditionalRawData)
        {
