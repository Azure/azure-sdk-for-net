...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    public partial class OptionBLayer3ConfigurationPatchProperties : Layer3IPPrefixPatchProperties
    {
        ...
        internal OptionBLayer3ConfigurationPatchProperties(string primaryIpv4Prefix, string primaryIpv6Prefix, string secondaryIpv4Prefix, string secondaryIpv6Prefix, IDictionary<string, BinaryData> additionalBinaryDataProperties, long? peerASN, int? vlanId, long? fabricASN, IList<string> peLoopbackIpAddress, NniBmpPatchProperties bmpConfiguration, IList<OptionBLayer3PrefixLimitPatchProperties> prefixLimits) : base(primaryIpv4Prefix, primaryIpv6Prefix, secondaryIpv4Prefix, secondaryIpv6Prefix, additionalBinaryDataProperties)
        {
            PeerASN = peerASN;
            VlanId = vlanId;
            FabricASN = fabricASN;
