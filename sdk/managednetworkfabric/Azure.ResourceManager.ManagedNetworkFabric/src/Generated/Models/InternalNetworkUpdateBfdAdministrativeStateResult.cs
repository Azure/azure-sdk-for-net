...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    public partial class InternalNetworkUpdateBfdAdministrativeStateResult
    {
        ...
        internal InternalNetworkUpdateBfdAdministrativeStateResult(ResourceIdentifier id, string name, string status, double? percentComplete, DateTimeOffset? startsOn, DateTimeOffset? endsOn, IReadOnlyList<NetworkFabricOperationStatusResult> operations, ResponseError error, ResourceIdentifier resourceId, InternalNetworkUpdateBfdAdministrativeStateResponseProperties properties, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Id = id;
            Name = name;
            Status = status;
