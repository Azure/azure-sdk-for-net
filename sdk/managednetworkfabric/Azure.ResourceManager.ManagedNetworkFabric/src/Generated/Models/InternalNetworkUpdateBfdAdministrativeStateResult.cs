...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    public partial class InternalNetworkUpdateBfdAdministrativeStateResult
    {
        ...
        internal InternalNetworkUpdateBfdAdministrativeStateResult(ResourceIdentifier id, string name, string status, double? percentComplete, DateTimeOffset? startOn, DateTimeOffset? endOn, IReadOnlyList<OperationStatusResult> operations, ResponseError error, ResourceIdentifier resourceId, InternalNetworkUpdateBfdAdministrativeStateResponseProperties properties, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Name = name;
            Status = status;
        ...
        /// <summary> Initializes a new instance of <see cref="InternalNetworkUpdateBfdAdministrativeStateResult"/> for deserialization. </summary>
        internal InternalNetworkUpdateBfdAdministrativeStateResult()
        {
        }
