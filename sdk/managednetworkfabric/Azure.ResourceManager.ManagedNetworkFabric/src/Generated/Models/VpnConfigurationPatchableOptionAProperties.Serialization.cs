...
{
    public partial class VpnConfigurationPatchableOptionAProperties : Core.IUtf8JsonSerializable
    {
        ...
        internal static VpnConfigurationPatchableOptionAProperties DeserializeVpnConfigurationPatchableOptionAProperties(JsonElement element)
        {
            ...
            return new VpnConfigurationPatchableOptionAProperties(Core.Optional.ToNullable(mtu), Core.Optional.ToNullable(vlanId), Core.Optional.ToNullable(peerAsn), bfdConfiguration.Value, primaryIPv4Prefix.Value, primaryIPv6Prefix.Value, secondaryIPv4Prefix.Value, secondaryIPv6Prefix.Value);
        }
    }
}
