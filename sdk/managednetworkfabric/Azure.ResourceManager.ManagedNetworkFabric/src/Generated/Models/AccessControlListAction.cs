...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    ...
    public partial class AccessControlListAction
    {
        ...
        internal AccessControlListAction(AclActionType? type, string counterName, string remarkComment, PoliceRateConfigurationProperties policeRateConfiguration, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Type = type;
