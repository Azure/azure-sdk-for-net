...
{
    public partial class InternalNetworkPropertiesBgpConfiguration : IUtf8JsonSerializable
    {
        ...
        internal static InternalNetworkPropertiesBgpConfiguration DeserializeInternalNetworkPropertiesBgpConfiguration(JsonElement element)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("defaultRouteOriginate"u8))
                {
                    ...
                    defaultRouteOriginate = new BooleanEnumProperty(property.Value.GetString());
                    continue;
                }
            ...
            return new InternalNetworkPropertiesBgpConfiguration(annotation.Value, bfdConfiguration.Value, Optional.ToNullable(defaultRouteOriginate), Optional.ToNullable(allowAS), Optional.ToNullable(allowASOverride), Optional.ToNullable(fabricASN), Optional.ToNullable(peerASN), Optional.ToList(ipv4ListenRangePrefixes), Optional.ToList(ipv6ListenRangePrefixes), Optional.ToList(ipv4NeighborAddress), Optional.ToList(ipv6NeighborAddress));
        }
    }
}
