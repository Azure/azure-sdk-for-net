...
{
    public partial class InternetGatewayData : IUtf8JsonSerializable
    {
        ...
        internal static InternetGatewayData DeserializeInternetGatewayData(JsonElement element)
        {
            ...
            return new InternetGatewayData(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, annotation.Value, internetGatewayRuleId.Value, ipv4Address.Value, Optional.ToNullable(port), type0, networkFabricControllerId, Optional.ToNullable(provisioningState));
        }
    }
}
