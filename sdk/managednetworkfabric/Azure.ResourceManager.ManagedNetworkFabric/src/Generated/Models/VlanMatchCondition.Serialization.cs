...
namespace Azure.ResourceManager.ManagedNetworkFabric.Models
{
    public partial class VlanMatchCondition : IUtf8JsonSerializable, IModelJsonSerializable<VlanMatchCondition>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<VlanMatchCondition>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="VlanMatchCondition"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="VlanMatchCondition"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="VlanMatchCondition"/>. </summary>
