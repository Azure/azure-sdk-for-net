        ...
        internal static NetworkTapPatch DeserializeNetworkTapPatch(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    properties = NetworkTapPatchProperties.DeserializeNetworkTapPatchProperties(property.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
            ...
            return new NetworkTapPatch(tags ?? new ChangeTrackingDictionary<string, string>(), properties, serializedAdditionalRawData);
        }
