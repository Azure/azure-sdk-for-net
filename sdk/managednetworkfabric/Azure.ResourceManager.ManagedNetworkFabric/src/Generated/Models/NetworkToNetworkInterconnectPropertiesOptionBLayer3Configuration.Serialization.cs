...
{
    public partial class NetworkToNetworkInterconnectPropertiesOptionBLayer3Configuration : IUtf8JsonSerializable
    {
        ...
        internal static NetworkToNetworkInterconnectPropertiesOptionBLayer3Configuration DeserializeNetworkToNetworkInterconnectPropertiesOptionBLayer3Configuration(JsonElement element)
        {
            ...
            return new NetworkToNetworkInterconnectPropertiesOptionBLayer3Configuration(primaryIPv4Prefix.Value, primaryIPv6Prefix.Value, secondaryIPv4Prefix.Value, secondaryIPv6Prefix.Value, Optional.ToNullable(peerASN), Optional.ToNullable(vlanId), Optional.ToNullable(fabricASN));
        }
    }
}
