...
{
    public partial class ExpressRouteConnectionInformation : IUtf8JsonSerializable, IJsonModel<ExpressRouteConnectionInformation>, IPersistableModel<ExpressRouteConnectionInformation>
    {
        ...
        void IJsonModel<ExpressRouteConnectionInformation>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ExpressRouteConnectionInformation)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  expressRouteCircuitId:");
                builder.AppendLine($" '{ExpressRouteCircuitId.ToString()}'");
            }
