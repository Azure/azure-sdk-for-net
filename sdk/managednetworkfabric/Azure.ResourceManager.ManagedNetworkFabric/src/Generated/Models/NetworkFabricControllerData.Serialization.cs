...
namespace Azure.ResourceManager.ManagedNetworkFabric
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NetworkFabricControllerData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NetworkFabricControllerData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NetworkFabricControllerData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<NetworkFabricControllerData>)} interface");
            }
        ...
        string IPersistableModel<NetworkFabricControllerData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
