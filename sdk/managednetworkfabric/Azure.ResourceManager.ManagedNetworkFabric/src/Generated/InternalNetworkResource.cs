...
namespace Azure.ResourceManager.ManagedNetworkFabric
{
    ...
    public partial class InternalNetworkResource : ArmResource
    {
        ...
        /// <item>
        /// <term>Operation Id</term>
        /// <description>InternalNetwork_Delete</description>
        /// </item>
        /// <item>
        /// <term>Default Api Version</term>
        /// <description>2025-07-15</description>
        ...
        /// <item>
        /// <term>Operation Id</term>
        /// <description>InternalNetwork_Update</description>
        /// </item>
        /// <item>
        /// <term>Default Api Version</term>
        /// <description>2025-07-15</description>
        ...
        public virtual async Task<ArmOperation<InternalNetworkUpdateBgpAdministrativeStateResponse>> UpdateBgpAdministrativeStateAsync(WaitUntil waitUntil, InternalNetworkUpdateBgpAdministrativeStateContent content, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _internalNetworkRestClient.UpdateBgpAdministrativeStateAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, content, cancellationToken).ConfigureAwait(false);
                var operation = new ManagedNetworkFabricArmOperation<InternalNetworkUpdateBgpAdministrativeStateResponse>(new InternalNetworkUpdateBgpAdministrativeStateResponseOperationSource(), _internalNetworkClientDiagnostics, Pipeline, _internalNetworkRestClient.CreateUpdateBgpAdministrativeStateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, content).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                    await operation.WaitForCompletionAsync(cancellationToken).ConfigureAwait(false);
                return operation;
            }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="content"/> is null. </exception>
        public virtual ArmOperation<InternalNetworkUpdateBgpAdministrativeStateResponse> UpdateBgpAdministrativeState(WaitUntil waitUntil, InternalNetworkUpdateBgpAdministrativeStateContent content, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(content, nameof(content));
            ...
            try
            {
                var response = _internalNetworkRestClient.UpdateBgpAdministrativeState(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, content, cancellationToken);
                var operation = new ManagedNetworkFabricArmOperation<InternalNetworkUpdateBgpAdministrativeStateResponse>(new InternalNetworkUpdateBgpAdministrativeStateResponseOperationSource(), _internalNetworkClientDiagnostics, Pipeline, _internalNetworkRestClient.CreateUpdateBgpAdministrativeStateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, content).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                    operation.WaitForCompletion(cancellationToken);
                return operation;
        ...
        public virtual async Task<ArmOperation<UpdateAdministrativeStateResponse>> UpdateStaticRouteBfdAdministrativeStateAsync(WaitUntil waitUntil, UpdateAdministrativeState body, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _internalNetworkClientDiagnostics.CreateScope("InternalNetworkResource.UpdateStaticRouteBfdAdministrativeState");
            scope.Start();
            try
            {
                var response = await _internalNetworkRestClient.UpdateStaticRouteBfdAdministrativeStateAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, body, cancellationToken).ConfigureAwait(false);
        ...
        public virtual ArmOperation<UpdateAdministrativeStateResponse> UpdateStaticRouteBfdAdministrativeState(WaitUntil waitUntil, UpdateAdministrativeState body, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _internalNetworkRestClient.UpdateStaticRouteBfdAdministrativeState(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, body, cancellationToken);
                var operation = new ManagedNetworkFabricArmOperation<UpdateAdministrativeStateResponse>(new UpdateAdministrativeStateResponseOperationSource(), _internalNetworkClientDiagnostics, Pipeline, _internalNetworkRestClient.CreateUpdateStaticRouteBfdAdministrativeStateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, body).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                    operation.WaitForCompletion(cancellationToken);
                return operation;
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="content"/> is null. </exception>
        public virtual async Task<ArmOperation<InternalNetworkUpdateBfdAdministrativeStateResponse>> UpdateBfdAdministrativeStateAsync(WaitUntil waitUntil, InternalNetworkUpdateBfdAdministrativeStateContent content, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(content, nameof(content));

            using var scope = _internalNetworkClientDiagnostics.CreateScope("InternalNetworkResource.UpdateBfdAdministrativeState");
            scope.Start();
            try
            {
                var response = await _internalNetworkRestClient.UpdateBfdAdministrativeStateAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, content, cancellationToken).ConfigureAwait(false);
                var operation = new ManagedNetworkFabricArmOperation<InternalNetworkUpdateBfdAdministrativeStateResponse>(new InternalNetworkUpdateBfdAdministrativeStateResponseOperationSource(), _internalNetworkClientDiagnostics, Pipeline, _internalNetworkRestClient.CreateUpdateBfdAdministrativeStateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, content).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                    await operation.WaitForCompletionAsync(cancellationToken).ConfigureAwait(false);
                return operation;
            }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="content"/> is null. </exception>
        public virtual ArmOperation<InternalNetworkUpdateBfdAdministrativeStateResponse> UpdateBfdAdministrativeState(WaitUntil waitUntil, InternalNetworkUpdateBfdAdministrativeStateContent content, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(content, nameof(content));
            ...
            try
            {
                var response = _internalNetworkRestClient.UpdateBfdAdministrativeState(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, content, cancellationToken);
                var operation = new ManagedNetworkFabricArmOperation<InternalNetworkUpdateBfdAdministrativeStateResponse>(new InternalNetworkUpdateBfdAdministrativeStateResponseOperationSource(), _internalNetworkClientDiagnostics, Pipeline, _internalNetworkRestClient.CreateUpdateBfdAdministrativeStateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, content).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                    operation.WaitForCompletion(cancellationToken);
                return operation;
