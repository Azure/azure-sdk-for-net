...
namespace Azure.ResourceManager.ManagedNetworkFabric
{
    ...
    public partial class NetworkFabricInternalNetworkResource : ArmResource
    {
        ...
        /// <summary>
        /// Updates the NetworkFabricInternalNetwork.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedNetworkFabric/l3IsolationDomains/{l3IsolationDomainName}/internalNetworks/{internalNetworkName}. </description>
        ...
        public virtual async Task<ArmOperation<NetworkFabricInternalNetworkResource>> UpdateAsync(WaitUntil waitUntil, NetworkFabricInternalNetworkData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _internalNetworksRestClient.CreateCreateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, NetworkFabricInternalNetworkData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                ManagedNetworkFabricArmOperation<NetworkFabricInternalNetworkResource> operation = new ManagedNetworkFabricArmOperation<NetworkFabricInternalNetworkResource>(
                    new NetworkFabricInternalNetworkResourceOperationSource(Client),
                    _internalNetworksClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<NetworkFabricInternalNetworkResource> Update(WaitUntil waitUntil, NetworkFabricInternalNetworkData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
