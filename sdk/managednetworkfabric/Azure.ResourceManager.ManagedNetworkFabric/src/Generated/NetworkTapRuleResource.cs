...
namespace Azure.ResourceManager.ManagedNetworkFabric
{
    ...
    public partial class NetworkTapRuleResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<NetworkTapRuleResource>> UpdateAsync(WaitUntil waitUntil, NetworkTapRuleData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _networkTapRulesRestClient.CreateCreateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, NetworkTapRuleData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                ManagedNetworkFabricArmOperation<NetworkTapRuleResource> operation = new ManagedNetworkFabricArmOperation<NetworkTapRuleResource>(
                    new NetworkTapRuleResourceOperationSource(Client),
                    _networkTapRulesClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<NetworkTapRuleResource> Update(WaitUntil waitUntil, NetworkTapRuleData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
