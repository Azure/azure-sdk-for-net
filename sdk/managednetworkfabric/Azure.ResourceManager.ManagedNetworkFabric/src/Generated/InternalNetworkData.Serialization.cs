...
{
    public partial class InternalNetworkData : IUtf8JsonSerializable, IJsonModel<InternalNetworkData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<InternalNetworkData>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<InternalNetworkData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        InternalNetworkData IJsonModel<InternalNetworkData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<InternalNetworkData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static InternalNetworkData DeserializeInternalNetworkData(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<InternalNetworkData>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<InternalNetworkData>)this).GetFormatFromOptions(options) : options.Format;
        ...
        InternalNetworkData IPersistableModel<InternalNetworkData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<InternalNetworkData>)this).GetFormatFromOptions(options) : options.Format;
