...
namespace Azure.ResourceManager.ManagedNetworkFabric
{
    ...
    public partial class L3IsolationDomainCollection : ArmCollection, IEnumerable<L3IsolationDomainResource>, IAsyncEnumerable<L3IsolationDomainResource>
    {
        ...
        /// <description>L3IsolationDomain_Create</description>
        /// </item>
        /// <item>
        ...
        /// <item>
        /// <term>Operation Id</term>
        /// <description>L3IsolationDomain_ListByResourceGroup</description>
        /// </item>
        /// <item>
        /// <term>Default Api Version</term>
        /// <description>2025-07-15</description>
        ...
        public virtual AsyncPageable<L3IsolationDomainResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new L3IsolationDomainResource(Client, L3IsolationDomainData.DeserializeL3IsolationDomainData(e)), _l3IsolationDomainClientDiagnostics, Pipeline, "L3IsolationDomainCollection.GetAll", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<L3IsolationDomainResource> GetAll(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _l3IsolationDomainRestClient.CreateListByResourceGroupRequest(Id.SubscriptionId, Id.ResourceGroupName);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _l3IsolationDomainRestClient.CreateListByResourceGroupNextPageRequest(nextLink, Id.SubscriptionId, Id.ResourceGroupName);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new L3IsolationDomainResource(Client, L3IsolationDomainData.DeserializeL3IsolationDomainData(e)), _l3IsolationDomainClientDiagnostics, Pipeline, "L3IsolationDomainCollection.GetAll", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual async Task<NullableResponse<L3IsolationDomainResource>> GetIfExistsAsync(string l3IsolationDomainName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _l3IsolationDomainClientDiagnostics.CreateScope("L3IsolationDomainCollection.GetIfExists");
            scope.Start();
            try
            {
                var response = await _l3IsolationDomainRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, l3IsolationDomainName, cancellationToken: cancellationToken).ConfigureAwait(false);
