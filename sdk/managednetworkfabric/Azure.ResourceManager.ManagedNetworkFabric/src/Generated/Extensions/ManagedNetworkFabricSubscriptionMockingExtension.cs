...
namespace Azure.ResourceManager.ManagedNetworkFabric.Mocking
{
    ...
    public partial class ManagedNetworkFabricSubscriptionMockingExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="ManagedNetworkFabricSubscriptionMockingExtension"/> class for mocking. </summary>
        protected ManagedNetworkFabricSubscriptionMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ManagedNetworkFabricSubscriptionMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ManagedNetworkFabricSubscriptionMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        [ForwardsClientCalls]
        public virtual async Task<Response<NetworkRackSkuResource>> GetNetworkRackSkuAsync(string networkRackSkuName, CancellationToken cancellationToken = default)
        {
            return await GetNetworkRackSkus().GetAsync(networkRackSkuName, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="networkRackSkuName"/> is null. </exception>
        [ForwardsClientCalls]
        public virtual Response<NetworkRackSkuResource> GetNetworkRackSku(string networkRackSkuName, CancellationToken cancellationToken = default)
        {
            return GetNetworkRackSkus().Get(networkRackSkuName, cancellationToken);
        }
        ...
        public virtual AsyncPageable<IPCommunityResource> GetIPCommunitiesAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new IPCommunityResource(Client, IPCommunityData.DeserializeIPCommunityData(e)), IPCommunityIpCommunitiesClientDiagnostics, Pipeline, "ManagedNetworkFabricSubscriptionMockingExtension.GetIPCommunities", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<IPCommunityResource> GetIPCommunities(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => IPCommunityIpCommunitiesRestClient.CreateListBySubscriptionRequest(Id.SubscriptionId);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => IPCommunityIpCommunitiesRestClient.CreateListBySubscriptionNextPageRequest(nextLink, Id.SubscriptionId);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new IPCommunityResource(Client, IPCommunityData.DeserializeIPCommunityData(e)), IPCommunityIpCommunitiesClientDiagnostics, Pipeline, "ManagedNetworkFabricSubscriptionMockingExtension.GetIPCommunities", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual AsyncPageable<IPPrefixResource> GetIPPrefixesAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new IPPrefixResource(Client, IPPrefixData.DeserializeIPPrefixData(e)), IPPrefixIpPrefixesClientDiagnostics, Pipeline, "ManagedNetworkFabricSubscriptionMockingExtension.GetIPPrefixes", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<IPPrefixResource> GetIPPrefixes(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => IPPrefixIpPrefixesRestClient.CreateListBySubscriptionRequest(Id.SubscriptionId);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => IPPrefixIpPrefixesRestClient.CreateListBySubscriptionNextPageRequest(nextLink, Id.SubscriptionId);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new IPPrefixResource(Client, IPPrefixData.DeserializeIPPrefixData(e)), IPPrefixIpPrefixesClientDiagnostics, Pipeline, "ManagedNetworkFabricSubscriptionMockingExtension.GetIPPrefixes", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual AsyncPageable<NetworkDeviceResource> GetNetworkDevicesAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new NetworkDeviceResource(Client, NetworkDeviceData.DeserializeNetworkDeviceData(e)), NetworkDeviceClientDiagnostics, Pipeline, "ManagedNetworkFabricSubscriptionMockingExtension.GetNetworkDevices", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<NetworkDeviceResource> GetNetworkDevices(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => NetworkDeviceRestClient.CreateListBySubscriptionRequest(Id.SubscriptionId);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => NetworkDeviceRestClient.CreateListBySubscriptionNextPageRequest(nextLink, Id.SubscriptionId);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new NetworkDeviceResource(Client, NetworkDeviceData.DeserializeNetworkDeviceData(e)), NetworkDeviceClientDiagnostics, Pipeline, "ManagedNetworkFabricSubscriptionMockingExtension.GetNetworkDevices", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual AsyncPageable<NetworkFabricResource> GetNetworkFabricsAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new NetworkFabricResource(Client, NetworkFabricData.DeserializeNetworkFabricData(e)), NetworkFabricClientDiagnostics, Pipeline, "ManagedNetworkFabricSubscriptionMockingExtension.GetNetworkFabrics", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<NetworkFabricResource> GetNetworkFabrics(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => NetworkFabricRestClient.CreateListBySubscriptionRequest(Id.SubscriptionId);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => NetworkFabricRestClient.CreateListBySubscriptionNextPageRequest(nextLink, Id.SubscriptionId);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new NetworkFabricResource(Client, NetworkFabricData.DeserializeNetworkFabricData(e)), NetworkFabricClientDiagnostics, Pipeline, "ManagedNetworkFabricSubscriptionMockingExtension.GetNetworkFabrics", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual AsyncPageable<NetworkRackResource> GetNetworkRacksAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new NetworkRackResource(Client, NetworkRackData.DeserializeNetworkRackData(e)), NetworkRackClientDiagnostics, Pipeline, "ManagedNetworkFabricSubscriptionMockingExtension.GetNetworkRacks", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<NetworkRackResource> GetNetworkRacks(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => NetworkRackRestClient.CreateListBySubscriptionRequest(Id.SubscriptionId);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => NetworkRackRestClient.CreateListBySubscriptionNextPageRequest(nextLink, Id.SubscriptionId);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new NetworkRackResource(Client, NetworkRackData.DeserializeNetworkRackData(e)), NetworkRackClientDiagnostics, Pipeline, "ManagedNetworkFabricSubscriptionMockingExtension.GetNetworkRacks", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual AsyncPageable<RoutePolicyResource> GetRoutePoliciesAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new RoutePolicyResource(Client, RoutePolicyData.DeserializeRoutePolicyData(e)), RoutePolicyClientDiagnostics, Pipeline, "ManagedNetworkFabricSubscriptionMockingExtension.GetRoutePolicies", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<RoutePolicyResource> GetRoutePolicies(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => RoutePolicyRestClient.CreateListBySubscriptionRequest(Id.SubscriptionId);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => RoutePolicyRestClient.CreateListBySubscriptionNextPageRequest(nextLink, Id.SubscriptionId);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new RoutePolicyResource(Client, RoutePolicyData.DeserializeRoutePolicyData(e)), RoutePolicyClientDiagnostics, Pipeline, "ManagedNetworkFabricSubscriptionMockingExtension.GetRoutePolicies", "value", "nextLink", cancellationToken);
        }
    }
}
