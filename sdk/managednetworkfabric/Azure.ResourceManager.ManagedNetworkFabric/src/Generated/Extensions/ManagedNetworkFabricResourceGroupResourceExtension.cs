...
namespace Azure.ResourceManager.ManagedNetworkFabric.Testing
{
    /// <summary> A class to add extension methods to ResourceGroupResource. </summary>
    public partial class ManagedNetworkFabricResourceGroupResourceExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="ManagedNetworkFabricResourceGroupResourceExtension"/> class for mocking. </summary>
        protected ManagedNetworkFabricResourceGroupResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ManagedNetworkFabricResourceGroupResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ManagedNetworkFabricResourceGroupResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
