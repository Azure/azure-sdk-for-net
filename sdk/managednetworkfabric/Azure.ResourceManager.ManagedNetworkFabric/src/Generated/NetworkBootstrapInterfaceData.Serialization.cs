...
{
    public partial class NetworkBootstrapInterfaceData : IUtf8JsonSerializable, IJsonModel<NetworkBootstrapInterfaceData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NetworkBootstrapInterfaceData>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<NetworkBootstrapInterfaceData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        NetworkBootstrapInterfaceData IJsonModel<NetworkBootstrapInterfaceData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<NetworkBootstrapInterfaceData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static NetworkBootstrapInterfaceData DeserializeNetworkBootstrapInterfaceData(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<NetworkBootstrapInterfaceData>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<NetworkBootstrapInterfaceData>)this).GetFormatFromOptions(options) : options.Format;
        ...
        NetworkBootstrapInterfaceData IPersistableModel<NetworkBootstrapInterfaceData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<NetworkBootstrapInterfaceData>)this).GetFormatFromOptions(options) : options.Format;
