...
namespace Azure.ResourceManager.ManagedNetworkFabric
{
    ...
    public partial class NetworkFabricAccessControlListCollection : ArmCollection, IEnumerable<NetworkFabricAccessControlListResource>, IAsyncEnumerable<NetworkFabricAccessControlListResource>
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="NetworkFabricAccessControlListCollection"/> class for mocking. </summary>
        protected NetworkFabricAccessControlListCollection()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="NetworkFabricAccessControlListCollection"/> class. </summary>
        ...
        {
            _networkFabricAccessControlListAccessControlListsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.ManagedNetworkFabric", NetworkFabricAccessControlListResource.ResourceType.Namespace, Diagnostics);
            TryGetApiVersion(NetworkFabricAccessControlListResource.ResourceType, out string networkFabricAccessControlListAccessControlListsApiVersion);
        ...
        public virtual async Task<ArmOperation<NetworkFabricAccessControlListResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string accessControlListName, NetworkFabricAccessControlListData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _networkFabricAccessControlListAccessControlListsRestClient.CreateAsync(Id.SubscriptionId, Id.ResourceGroupName, accessControlListName, data, cancellationToken).ConfigureAwait(false);
                var operation = new ManagedNetworkFabricArmOperation<NetworkFabricAccessControlListResource>(new NetworkFabricAccessControlListOperationSource(Client), _networkFabricAccessControlListAccessControlListsClientDiagnostics, Pipeline, _networkFabricAccessControlListAccessControlListsRestClient.CreateCreateRequest(Id.SubscriptionId, Id.ResourceGroupName, accessControlListName, data).Request, response, Core.OperationFinalStateVia.AzureAsyncOperation);
        ...
        public virtual ArmOperation<NetworkFabricAccessControlListResource> CreateOrUpdate(WaitUntil waitUntil, string accessControlListName, NetworkFabricAccessControlListData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _networkFabricAccessControlListAccessControlListsRestClient.Create(Id.SubscriptionId, Id.ResourceGroupName, accessControlListName, data, cancellationToken);
                var operation = new ManagedNetworkFabricArmOperation<NetworkFabricAccessControlListResource>(new NetworkFabricAccessControlListOperationSource(Client), _networkFabricAccessControlListAccessControlListsClientDiagnostics, Pipeline, _networkFabricAccessControlListAccessControlListsRestClient.CreateCreateRequest(Id.SubscriptionId, Id.ResourceGroupName, accessControlListName, data).Request, response, Core.OperationFinalStateVia.AzureAsyncOperation);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<Response<NetworkFabricAccessControlListResource>> GetAsync(string accessControlListName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _networkFabricAccessControlListAccessControlListsRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, accessControlListName, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<NetworkFabricAccessControlListResource> Get(string accessControlListName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _networkFabricAccessControlListAccessControlListsRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, accessControlListName, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new NetworkFabricAccessControlListResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        public virtual Pageable<NetworkFabricAccessControlListResource> GetAll(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _networkFabricAccessControlListAccessControlListsRestClient.CreateListByResourceGroupRequest(Id.SubscriptionId, Id.ResourceGroupName);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _networkFabricAccessControlListAccessControlListsRestClient.CreateListByResourceGroupNextPageRequest(nextLink, Id.SubscriptionId, Id.ResourceGroupName);
            return Core.PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new NetworkFabricAccessControlListResource(Client, NetworkFabricAccessControlListData.DeserializeNetworkFabricAccessControlListData(e)), _networkFabricAccessControlListAccessControlListsClientDiagnostics, Pipeline, "NetworkFabricAccessControlListCollection.GetAll", "value", "nextLink", cancellationToken);
        }
