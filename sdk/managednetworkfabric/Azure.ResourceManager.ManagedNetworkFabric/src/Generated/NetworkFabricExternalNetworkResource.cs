...
namespace Azure.ResourceManager.ManagedNetworkFabric
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="NetworkFabricExternalNetworkResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="NetworkFabricL3IsolationDomainResource"/> using the GetNetworkFabricExternalNetworks method.
    /// </summary>
    public partial class NetworkFabricExternalNetworkResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of NetworkFabricExternalNetworkResource for mocking. </summary>
        protected NetworkFabricExternalNetworkResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="NetworkFabricExternalNetworkResource"/> class. </summary>
        ...
        {
            TryGetApiVersion(ResourceType, out string networkFabricExternalNetworkApiVersion);
        ...
        {
            using DiagnosticScope scope = _externalNetworksClientDiagnostics.CreateScope("NetworkFabricExternalNetworkResource.Get");
            scope.Start();
            try
            {
        ...
        public virtual async Task<ArmOperation<NetworkFabricExternalNetworkResource>> UpdateAsync(WaitUntil waitUntil, NetworkFabricExternalNetworkPatch patch, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _externalNetworksClientDiagnostics.CreateScope("NetworkFabricExternalNetworkResource.Update");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _externalNetworksRestClient.CreateUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, NetworkFabricExternalNetworkPatch.ToRequestContent(patch), context);
        ...
        {
            using DiagnosticScope scope = _externalNetworksClientDiagnostics.CreateScope("NetworkFabricExternalNetworkResource.Delete");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="content"/> is null. </exception>
        public virtual async Task<ArmOperation<ExternalNetworkUpdateBfdAdministrativeStateResult>> UpdateBfdAdministrativeStateAsync(WaitUntil waitUntil, ExternalNetworkUpdateBfdAdministrativeStateContent content, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(content, nameof(content));

            using DiagnosticScope scope = _externalNetworksClientDiagnostics.CreateScope("NetworkFabricExternalNetworkResource.UpdateBfdAdministrativeState");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _externalNetworksRestClient.CreateUpdateBfdAdministrativeStateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, ExternalNetworkUpdateBfdAdministrativeStateContent.ToRequestContent(content), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                ManagedNetworkFabricArmOperation<ExternalNetworkUpdateBfdAdministrativeStateResult> operation = new ManagedNetworkFabricArmOperation<ExternalNetworkUpdateBfdAdministrativeStateResult>(
                    new ExternalNetworkUpdateBfdAdministrativeStateResultOperationSource(),
                    _externalNetworksClientDiagnostics,
                    Pipeline,
                    message.Request,
                    response,
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="content"/> is null. </exception>
        public virtual ArmOperation<ExternalNetworkUpdateBfdAdministrativeStateResult> UpdateBfdAdministrativeState(WaitUntil waitUntil, ExternalNetworkUpdateBfdAdministrativeStateContent content, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(content, nameof(content));
        ...
        /// <summary>
        /// Updates the NetworkFabricExternalNetwork.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedNetworkFabric/l3IsolationDomains/{l3IsolationDomainName}/externalNetworks/{externalNetworkName}. </description>
        ...
        public virtual async Task<ArmOperation<NetworkFabricExternalNetworkResource>> UpdateAsync(WaitUntil waitUntil, NetworkFabricExternalNetworkData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _externalNetworksRestClient.CreateCreateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, NetworkFabricExternalNetworkData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                ManagedNetworkFabricArmOperation<NetworkFabricExternalNetworkResource> operation = new ManagedNetworkFabricArmOperation<NetworkFabricExternalNetworkResource>(
                    new NetworkFabricExternalNetworkResourceOperationSource(Client),
                    _externalNetworksClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<NetworkFabricExternalNetworkResource> Update(WaitUntil waitUntil, NetworkFabricExternalNetworkData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
