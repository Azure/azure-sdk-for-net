...
namespace Azure.ResourceManager.ManagedNetworkFabric
{
    ...
    public partial class NetworkDeviceInterfaceResource : ArmResource
    {
        ...
        /// <summary>
        /// Updates the NetworkDeviceInterface.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedNetworkFabric/networkDevices/{networkDeviceName}/networkInterfaces/{networkInterfaceName}. </description>
        ...
        public virtual async Task<ArmOperation<NetworkDeviceInterfaceResource>> UpdateAsync(WaitUntil waitUntil, NetworkDeviceInterfaceData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _networkInterfacesRestClient.CreateCreateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, NetworkDeviceInterfaceData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                ManagedNetworkFabricArmOperation<NetworkDeviceInterfaceResource> operation = new ManagedNetworkFabricArmOperation<NetworkDeviceInterfaceResource>(
                    new NetworkDeviceInterfaceResourceOperationSource(Client),
                    _networkInterfacesClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<NetworkDeviceInterfaceResource> Update(WaitUntil waitUntil, NetworkDeviceInterfaceData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
