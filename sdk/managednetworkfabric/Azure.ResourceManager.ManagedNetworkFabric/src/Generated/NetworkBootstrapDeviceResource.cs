...
namespace Azure.ResourceManager.ManagedNetworkFabric
{
    ...
    public partial class NetworkBootstrapDeviceResource : ArmResource
    {
        ...
        /// <summary>
        /// Updates the NetworkBootstrapDevice.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedNetworkFabric/networkBootstrapDevices/{networkBootstrapDeviceName}. </description>
        ...
        public virtual async Task<ArmOperation<NetworkBootstrapDeviceResource>> UpdateAsync(WaitUntil waitUntil, NetworkBootstrapDeviceData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _networkBootstrapDevicesRestClient.CreateCreateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, NetworkBootstrapDeviceData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                ManagedNetworkFabricArmOperation<NetworkBootstrapDeviceResource> operation = new ManagedNetworkFabricArmOperation<NetworkBootstrapDeviceResource>(
                    new NetworkBootstrapDeviceResourceOperationSource(Client),
                    _networkBootstrapDevicesClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<NetworkBootstrapDeviceResource> Update(WaitUntil waitUntil, NetworkBootstrapDeviceData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
