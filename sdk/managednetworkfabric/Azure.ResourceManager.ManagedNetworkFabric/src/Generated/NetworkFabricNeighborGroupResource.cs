...
namespace Azure.ResourceManager.ManagedNetworkFabric
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="NetworkFabricNeighborGroupResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="ResourceGroupResource"/> using the GetNetworkFabricNeighborGroups method.
    /// </summary>
    public partial class NetworkFabricNeighborGroupResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of NetworkFabricNeighborGroupResource for mocking. </summary>
        protected NetworkFabricNeighborGroupResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="NetworkFabricNeighborGroupResource"/> class. </summary>
        ...
        {
            TryGetApiVersion(ResourceType, out string networkFabricNeighborGroupApiVersion);
            _neighborGroupsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.ManagedNetworkFabric", ResourceType.Namespace, Diagnostics);
        ...
        {
            string resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedNetworkFabric/neighborGroups/{neighborGroupName}";
        ...
        {
            using DiagnosticScope scope = _neighborGroupsClientDiagnostics.CreateScope("NetworkFabricNeighborGroupResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _neighborGroupsRestClient.CreateGetRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context);
        ...
        {
            using DiagnosticScope scope = _neighborGroupsClientDiagnostics.CreateScope("NetworkFabricNeighborGroupResource.Delete");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _neighborGroupsRestClient.CreateDeleteRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                ManagedNetworkFabricArmOperation operation = new ManagedNetworkFabricArmOperation(_neighborGroupsClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                {
        ...
        /// <param name="waitUntil"> <see cref="WaitUntil.Completed"/> if the method should wait to return until the long-running operation has completed on the service; <see cref="WaitUntil.Started"/> if it should return after starting the operation. For more information on long-running operations, please see <see href="https://github.com/Azure/azure-sdk-for-net/blob/main/sdk/core/Azure.Core/samples/LongRunningOperations.md"> Azure.Core Long-Running Operation samples</see>. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<ArmOperation<NeighborGroupResyncResult>> ResyncAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _neighborGroupsClientDiagnostics.CreateScope("NetworkFabricNeighborGroupResource.Resync");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _neighborGroupsRestClient.CreateResyncRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                ManagedNetworkFabricArmOperation<NeighborGroupResyncResult> operation = new ManagedNetworkFabricArmOperation<NeighborGroupResyncResult>(
                    new NeighborGroupResyncResultOperationSource(),
                    _neighborGroupsClientDiagnostics,
                    Pipeline,
                    message.Request,
                    response,
        ...
        /// <param name="waitUntil"> <see cref="WaitUntil.Completed"/> if the method should wait to return until the long-running operation has completed on the service; <see cref="WaitUntil.Started"/> if it should return after starting the operation. For more information on long-running operations, please see <see href="https://github.com/Azure/azure-sdk-for-net/blob/main/sdk/core/Azure.Core/samples/LongRunningOperations.md"> Azure.Core Long-Running Operation samples</see>. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual ArmOperation<NeighborGroupResyncResult> Resync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _neighborGroupsClientDiagnostics.CreateScope("NetworkFabricNeighborGroupResource.Resync");
            scope.Start();
            try
        ...
        /// <summary>
        /// Updates the NetworkFabricNeighborGroup.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedNetworkFabric/neighborGroups/{neighborGroupName}. </description>
        ...
        public virtual async Task<ArmOperation<NetworkFabricNeighborGroupResource>> UpdateAsync(WaitUntil waitUntil, NetworkFabricNeighborGroupData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _neighborGroupsRestClient.CreateCreateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, NetworkFabricNeighborGroupData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                ManagedNetworkFabricArmOperation<NetworkFabricNeighborGroupResource> operation = new ManagedNetworkFabricArmOperation<NetworkFabricNeighborGroupResource>(
                    new NetworkFabricNeighborGroupResourceOperationSource(Client),
                    _neighborGroupsClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<NetworkFabricNeighborGroupResource> Update(WaitUntil waitUntil, NetworkFabricNeighborGroupData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
        ...
        public virtual async Task<Response<NetworkFabricNeighborGroupResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _neighborGroupsClientDiagnostics.CreateScope("NetworkFabricNeighborGroupResource.AddTag");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response<NetworkFabricNeighborGroupResource>> SetTagsAsync(IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _neighborGroupsClientDiagnostics.CreateScope("NetworkFabricNeighborGroupResource.SetTags");
            scope.Start();
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken).ConfigureAwait(false))
        ...
        public virtual async Task<Response<NetworkFabricNeighborGroupResource>> RemoveTagAsync(string key, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _neighborGroupsClientDiagnostics.CreateScope("NetworkFabricNeighborGroupResource.RemoveTag");
            scope.Start();
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken).ConfigureAwait(false))
