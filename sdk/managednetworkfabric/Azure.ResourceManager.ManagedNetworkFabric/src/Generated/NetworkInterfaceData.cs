...
namespace Azure.ResourceManager.ManagedNetworkFabric
{
    ...
    public partial class NetworkInterfaceData : ResourceData
    {
        ...
        public NetworkInterfaceData(NetworkInterfaceProperties properties)
        {
        ...
        /// <param name="properties"> The NetworkInterface properties. </param>
        internal NetworkInterfaceData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, NetworkInterfaceProperties properties) : base(id, name, resourceType, systemData)
        {
