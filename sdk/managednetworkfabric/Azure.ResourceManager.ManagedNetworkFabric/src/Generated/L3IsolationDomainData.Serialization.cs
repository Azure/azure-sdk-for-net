...
{
    public partial class L3IsolationDomainData : IUtf8JsonSerializable, IJsonModel<L3IsolationDomainData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<L3IsolationDomainData>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<L3IsolationDomainData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        L3IsolationDomainData IJsonModel<L3IsolationDomainData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<L3IsolationDomainData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static L3IsolationDomainData DeserializeL3IsolationDomainData(JsonElement element, ModelReaderWriterOptions options = null)
        {
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("staticRouteRoutePolicy"u8))
                        {
                            ...
                            staticRouteRoutePolicy = StaticRouteRoutePolicy.DeserializeStaticRouteRoutePolicy(property0.Value, options);
                            continue;
                        }
        ...
        BinaryData IPersistableModel<L3IsolationDomainData>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<L3IsolationDomainData>)this).GetFormatFromOptions(options) : options.Format;
        ...
        L3IsolationDomainData IPersistableModel<L3IsolationDomainData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<L3IsolationDomainData>)this).GetFormatFromOptions(options) : options.Format;
