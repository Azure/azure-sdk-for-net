...
namespace Azure.ResourceManager.ManagedNetworkFabric
{
    public partial class NetworkFabricAccessControlListResource : IJsonModel<NetworkFabricAccessControlListData>
    {
        ...
        BinaryData IPersistableModel<NetworkFabricAccessControlListData>.Write(ModelReaderWriterOptions options) => ModelReaderWriter.Write(Data, options);

        NetworkFabricAccessControlListData IPersistableModel<NetworkFabricAccessControlListData>.Create(BinaryData data, ModelReaderWriterOptions options) => ModelReaderWriter.Read<NetworkFabricAccessControlListData>(data, options);
