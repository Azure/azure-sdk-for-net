...
{
    /// <summary></summary>
    internal partial class ExternalNetworkOperationSource : IOperationSource<ExternalNetworkResource>
    {
        ...
        ExternalNetworkResource IOperationSource<ExternalNetworkResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            ExternalNetworkData data = ExternalNetworkData.DeserializeExternalNetworkData(document.RootElement, ModelSerializationExtensions.WireOptions);
