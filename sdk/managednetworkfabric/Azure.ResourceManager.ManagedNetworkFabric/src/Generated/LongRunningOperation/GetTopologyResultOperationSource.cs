...
{
    /// <summary></summary>
    internal partial class GetTopologyResultOperationSource : IOperationSource<GetTopologyResult>
    {
        /// <summary></summary>
        internal GetTopologyResultOperationSource()
        {
        }
        ...
        GetTopologyResult IOperationSource<GetTopologyResult>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            return GetTopologyResult.DeserializeGetTopologyResult(document.RootElement, ModelSerializationExtensions.WireOptions);
        }
