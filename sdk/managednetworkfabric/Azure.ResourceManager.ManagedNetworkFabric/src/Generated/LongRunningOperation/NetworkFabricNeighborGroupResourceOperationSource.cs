...
namespace Azure.ResourceManager.ManagedNetworkFabric
{
    ...
    internal partial class NetworkFabricNeighborGroupResourceOperationSource : IOperationSource<NetworkFabricNeighborGroupResource>
    {
        ...
        NetworkFabricNeighborGroupResource IOperationSource<NetworkFabricNeighborGroupResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            NetworkFabricNeighborGroupData data = NetworkFabricNeighborGroupData.DeserializeNetworkFabricNeighborGroupData(document.RootElement, ModelSerializationExtensions.WireOptions);
