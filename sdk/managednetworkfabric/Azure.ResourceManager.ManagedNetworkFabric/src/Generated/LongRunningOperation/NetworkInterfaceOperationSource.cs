...
namespace Azure.ResourceManager.ManagedNetworkFabric
{
    internal class NetworkInterfaceOperationSource : IOperationSource<NetworkInterfaceResource>
    {
        ...
        {
            var data = ModelReaderWriter.Read<NetworkInterfaceData>(response.Content, ModelReaderWriterOptions.Json, AzureResourceManagerManagedNetworkFabricContext.Default);
