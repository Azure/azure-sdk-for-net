...
{
    /// <summary></summary>
    internal partial class IpCommunityOperationSource : IOperationSource<IpCommunity>
    {
        /// <summary></summary>
        internal IpCommunityOperationSource()
        {
        }
        ...
        IpCommunity IOperationSource<IpCommunity>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            IpCommunity result = IpCommunity.DeserializeIpCommunity(document.RootElement, ModelSerializationExtensions.WireOptions);
            return result;
        }
