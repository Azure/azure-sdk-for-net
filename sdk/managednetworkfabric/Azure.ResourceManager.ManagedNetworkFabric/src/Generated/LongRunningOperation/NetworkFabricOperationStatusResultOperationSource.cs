...
{
    internal class NetworkFabricOperationStatusResultOperationSource : IOperationSource<NetworkFabricOperationStatusResult>
    {
        NetworkFabricOperationStatusResult IOperationSource<NetworkFabricOperationStatusResult>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            return NetworkFabricOperationStatusResult.DeserializeNetworkFabricOperationStatusResult(document.RootElement);
        }
