...
namespace Azure.ResourceManager.ManagedNetworkFabric
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="NetworkFabricControllerResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="ResourceGroupResource"/> using the GetNetworkFabricControllers method.
    /// </summary>
    public partial class NetworkFabricControllerResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of NetworkFabricControllerResource for mocking. </summary>
        protected NetworkFabricControllerResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="NetworkFabricControllerResource"/> class. </summary>
        ...
        {
            string resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedNetworkFabric/networkFabricControllers/{networkFabricControllerName}";
        ...
        {
            using DiagnosticScope scope = _networkFabricControllersClientDiagnostics.CreateScope("NetworkFabricControllerResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _networkFabricControllersRestClient.CreateGetRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context);
        ...
        {
            using DiagnosticScope scope = _networkFabricControllersClientDiagnostics.CreateScope("NetworkFabricControllerResource.Delete");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _networkFabricControllersRestClient.CreateDeleteRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                ManagedNetworkFabricArmOperation operation = new ManagedNetworkFabricArmOperation(_networkFabricControllersClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                {
        ...
        /// <summary>
        /// Updates the NetworkFabricController.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedNetworkFabric/networkFabricControllers/{networkFabricControllerName}. </description>
        ...
        public virtual async Task<ArmOperation<NetworkFabricControllerResource>> UpdateAsync(WaitUntil waitUntil, NetworkFabricControllerData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _networkFabricControllersRestClient.CreateCreateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, NetworkFabricControllerData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                ManagedNetworkFabricArmOperation<NetworkFabricControllerResource> operation = new ManagedNetworkFabricArmOperation<NetworkFabricControllerResource>(
                    new NetworkFabricControllerResourceOperationSource(Client),
                    _networkFabricControllersClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<NetworkFabricControllerResource> Update(WaitUntil waitUntil, NetworkFabricControllerData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
        ...
        public virtual async Task<Response<NetworkFabricControllerResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _networkFabricControllersClientDiagnostics.CreateScope("NetworkFabricControllerResource.AddTag");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response<NetworkFabricControllerResource>> SetTagsAsync(IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _networkFabricControllersClientDiagnostics.CreateScope("NetworkFabricControllerResource.SetTags");
            scope.Start();
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken).ConfigureAwait(false))
        ...
        public virtual async Task<Response<NetworkFabricControllerResource>> RemoveTagAsync(string key, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _networkFabricControllersClientDiagnostics.CreateScope("NetworkFabricControllerResource.RemoveTag");
            scope.Start();
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken).ConfigureAwait(false))
