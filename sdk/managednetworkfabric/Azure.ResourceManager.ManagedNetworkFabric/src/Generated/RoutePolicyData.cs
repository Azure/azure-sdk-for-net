...
namespace Azure.ResourceManager.ManagedNetworkFabric
{
    ...
    public partial class RoutePolicyData : TrackedResourceData
    {
        ...
        /// <summary> Initializes a new instance of <see cref="RoutePolicyData"/>. </summary>
        ...
        public RoutePolicyData(AzureLocation location, IEnumerable<RoutePolicyStatementProperties> statements, ResourceIdentifier networkFabricId) : base(location)
        {
        ...
        internal RoutePolicyData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, string annotation, CommunityActionType? defaultAction, IList<RoutePolicyStatementProperties> statements, ResourceIdentifier networkFabricId, AddressFamilyType? addressFamilyType, LastOperationProperties lastOperation, ConfigurationState? configurationState, ProvisioningState? provisioningState, AdministrativeState? administrativeState, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData, tags, location)
        {
        ...
        /// <summary> Initializes a new instance of <see cref="RoutePolicyData"/> for deserialization. </summary>
        internal RoutePolicyData()
        {
        }
