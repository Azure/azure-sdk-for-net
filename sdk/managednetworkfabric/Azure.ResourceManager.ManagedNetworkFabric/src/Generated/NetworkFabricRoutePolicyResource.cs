...
namespace Azure.ResourceManager.ManagedNetworkFabric
{
    ...
    public partial class NetworkFabricRoutePolicyResource : ArmResource
    {
        ...
        /// <param name="content"> Route Policy properties to update. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="content"/> is null. </exception>
        public virtual async Task<ArmOperation<NetworkFabricRoutePolicyResource>> UpdateAsync(WaitUntil waitUntil, NetworkFabricRoutePolicyPatchContent content, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="content"/> is null. </exception>
        public virtual ArmOperation<NetworkFabricRoutePolicyResource> Update(WaitUntil waitUntil, NetworkFabricRoutePolicyPatchContent content, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(content, nameof(content));
        ...
        public virtual async Task<ArmOperation<UpdateAdministrativeStateResult>> SetAdministrativeStateAsync(WaitUntil waitUntil, UpdateAdministrativeStateContent content, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _routePoliciesClientDiagnostics.CreateScope("NetworkFabricRoutePolicyResource.SetAdministrativeState");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _routePoliciesRestClient.CreateSetAdministrativeStateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, UpdateAdministrativeStateContent.ToRequestContent(content), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        /// <summary>
        /// Updates the NetworkFabricRoutePolicy.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedNetworkFabric/routePolicies/{routePolicyName}. </description>
        ...
        public virtual async Task<ArmOperation<NetworkFabricRoutePolicyResource>> UpdateAsync(WaitUntil waitUntil, NetworkFabricRoutePolicyData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _routePoliciesRestClient.CreateCreateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, NetworkFabricRoutePolicyData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                ManagedNetworkFabricArmOperation<NetworkFabricRoutePolicyResource> operation = new ManagedNetworkFabricArmOperation<NetworkFabricRoutePolicyResource>(
                    new NetworkFabricRoutePolicyResourceOperationSource(Client),
                    _routePoliciesClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<NetworkFabricRoutePolicyResource> Update(WaitUntil waitUntil, NetworkFabricRoutePolicyData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
        ...
        public virtual async Task<Response<NetworkFabricRoutePolicyResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    NetworkFabricRoutePolicyPatchContent patch = new NetworkFabricRoutePolicyPatchContent();
