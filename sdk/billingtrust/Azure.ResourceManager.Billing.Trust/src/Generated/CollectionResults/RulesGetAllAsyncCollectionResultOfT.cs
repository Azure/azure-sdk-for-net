...
namespace Azure.ResourceManager.Billing.Trust
{
    internal partial class RulesGetAllAsyncCollectionResultOfT : AsyncPageable<RuleData>
    {
        ...
        /// <summary> Initializes a new instance of RulesGetAllAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public RulesGetAllAsyncCollectionResultOfT(Rules client, string resourceUri, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of RulesGetAllAsyncCollectionResultOfT as an enumerable collection. </summary>
