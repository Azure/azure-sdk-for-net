...
{
    internal partial class UnknownBillingTrustInitialRuleValueBase : BillingTrustInitialRuleValueBase, IJsonModel<BillingTrustInitialRuleValueBase>
    {
        /// <summary> Initializes a new instance of <see cref="UnknownBillingTrustInitialRuleValueBase"/> for deserialization. </summary>
        internal UnknownBillingTrustInitialRuleValueBase()
        {
        }
        ...
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        BillingTrustInitialRuleValueBase IPersistableModel<BillingTrustInitialRuleValueBase>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BillingTrustInitialRuleValueBase IJsonModel<BillingTrustInitialRuleValueBase>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownBillingTrustInitialRuleValueBase DeserializeUnknownBillingTrustInitialRuleValueBase(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownBillingTrustInitialRuleValueBase(kind, additionalBinaryDataProperties);
        }
    }
}
