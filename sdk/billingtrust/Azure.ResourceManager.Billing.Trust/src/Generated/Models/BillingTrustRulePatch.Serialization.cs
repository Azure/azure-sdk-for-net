...
namespace Azure.ResourceManager.Billing.Trust.Models
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="BillingTrustRulePatch"/> for deserialization. </summary>
        ...
        protected virtual BillingTrustRulePatch PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
        ...
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        BillingTrustRulePatch IPersistableModel<BillingTrustRulePatch>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);

        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<BillingTrustRulePatch>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";

        /// <param name="billingTrustRulePatch"> The <see cref="BillingTrustRulePatch"/> to serialize into <see cref="RequestContent"/>. </param>
        internal static RequestContent ToRequestContent(BillingTrustRulePatch billingTrustRulePatch)
        {
            if (billingTrustRulePatch == null)
            {
                return null;
            }
            return RequestContent.Create(billingTrustRulePatch, ModelSerializationExtensions.WireOptions);
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BillingTrustRulePatch IJsonModel<BillingTrustRulePatch>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual BillingTrustRulePatch JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<BillingTrustRulePatch>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static BillingTrustRulePatch DeserializeBillingTrustRulePatch(JsonElement element, ModelReaderWriterOptions options)
        {
