...
{
    internal partial class UnknownInitialRuleValueBase : InitialRuleValueBase, IJsonModel<InitialRuleValueBase>
    {
        /// <summary> Initializes a new instance of <see cref="UnknownInitialRuleValueBase"/> for deserialization. </summary>
        internal UnknownInitialRuleValueBase()
        {
        }
        ...
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        InitialRuleValueBase IPersistableModel<InitialRuleValueBase>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        InitialRuleValueBase IJsonModel<InitialRuleValueBase>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownInitialRuleValueBase DeserializeUnknownInitialRuleValueBase(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownInitialRuleValueBase(kind, additionalBinaryDataProperties);
        }
    }
}
