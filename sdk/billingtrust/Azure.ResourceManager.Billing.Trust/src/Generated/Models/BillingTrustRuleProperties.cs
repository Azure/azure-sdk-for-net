...
namespace Azure.ResourceManager.Billing.Trust.Models
{
    ...
    public abstract partial class BillingTrustRuleProperties
    {
        ...
        /// <summary> Initializes a new instance of <see cref="BillingTrustRuleProperties"/>. </summary>
        private protected BillingTrustRuleProperties()
        {
        }
        ...
        internal BillingTrustRuleProperties(RuleKind kind, BillingTrustRuleState? evaluationState, ResponseError error, BillingTrustProvisioningState? provisioningState, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Kind = kind;
        ...
        public BillingTrustRuleState? EvaluationState { get; }
