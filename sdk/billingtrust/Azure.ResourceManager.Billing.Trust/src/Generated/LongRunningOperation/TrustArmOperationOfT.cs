...
{
    internal partial class TrustArmOperation<T> : ArmOperation<T>
    {
        ...
        /// <summary> Initializes a new instance of TrustArmOperation for mocking. </summary>
        protected TrustArmOperation()
        {
        }
        ...
        internal TrustArmOperation(Response<T> response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal TrustArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
