...
namespace Azure.ResourceManager.ResourceGraph
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="ResourceGraphQueryResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="ResourceGroupResource"/> using the GetResourceGraphQueries method.
    /// </summary>
    public partial class ResourceGraphQueryResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of ResourceGraphQueryResource for mocking. </summary>
        protected ResourceGraphQueryResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="ResourceGraphQueryResource"/> class. </summary>
        ...
        {
            string resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ResourceGraph/queries/{resourceName}";
        ...
        /// <item>
        /// <term> Operation Id. </term>
        /// <description> GraphQueryResources_Update. </description>
        /// </item>
        /// <item>
        /// <term> Default Api Version. </term>
        /// <description> 2024-04-01. </description>
        ...
        /// <item>
        /// <term> Operation Id. </term>
        /// <description> GraphQueryResources_Delete. </description>
        /// </item>
        /// <item>
        /// <term> Default Api Version. </term>
        /// <description> 2024-04-01. </description>
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                ResourceGraphArmOperation operation = new ResourceGraphArmOperation(response, rehydrationToken);
        ...
        /// <summary>
        /// Updates the ResourceGraphQuery.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ResourceGraph/queries/{resourceName}. </description>
        ...
        public virtual async Task<ArmOperation<ResourceGraphQueryResource>> UpdateAsync(WaitUntil waitUntil, ResourceGraphQueryData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _graphQueryRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, ResourceGraphQueryData.ToRequestContent(data), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<ResourceGraphQueryData> response = Response.FromValue(ResourceGraphQueryData.FromResponse(result), result);
                RequestUriBuilder uri = message.Request.Uri;
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<ResourceGraphQueryResource> Update(WaitUntil waitUntil, ResourceGraphQueryData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
        ...
        public virtual async Task<Response<ResourceGraphQueryResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                {
                    ResourceGraphQueryData current = (await GetAsync(cancellationToken: cancellationToken).ConfigureAwait(false)).Value.Data;
                    ...
                    Response<ResourceGraphQueryResource> result = await UpdateAsync(patch, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<ResourceGraphQueryResource> AddTag(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                {
                    ResourceGraphQueryData current = Get(cancellationToken: cancellationToken).Value.Data;
                    ResourceGraphQueryPatch patch = new ResourceGraphQueryPatch();
                    foreach (KeyValuePair<string, string> tag in current.Tags)
                    {
                        patch.Tags.Add(tag);
                    ...
                    patch.Tags[key] = value;
                    Response<ResourceGraphQueryResource> result = Update(patch, cancellationToken: cancellationToken);
                    return Response.FromValue(result.Value, result.GetRawResponse());
                }
            }
            catch (Exception e)
