...
namespace Azure.ResourceManager.ResourceGraph.Mocking
{
    ...
    internal partial class ResourceGraphTenantMockingExtension : ArmResource
    {
        private ClientDiagnostics _defaultClientDiagnostics;
        private ResourceGraphRestOperations _defaultRestClient;

        /// <summary> Initializes a new instance of the <see cref="ResourceGraphTenantMockingExtension"/> class for mocking. </summary>
        protected ResourceGraphTenantMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ResourceGraphTenantMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ResourceGraphTenantMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        {
            using var scope = DefaultClientDiagnostics.CreateScope("ResourceGraphTenantMockingExtension.GetResources");
            scope.Start();
            try
            {
        ...
        {
            using var scope = DefaultClientDiagnostics.CreateScope("ResourceGraphTenantMockingExtension.GetResourceHistory");
            scope.Start();
            try
            {
