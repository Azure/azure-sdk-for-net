...
namespace Azure.ResourceManager.ResourceGraph.Testing
{
    /// <summary> A class to add extension methods to TenantResource. </summary>
    public partial class ResourceGraphTenantResourceExtension : ArmResource
    {
        private ClientDiagnostics _defaultClientDiagnostics;
        private ResourceGraphRestOperations _defaultRestClient;

        /// <summary> Initializes a new instance of the <see cref="ResourceGraphTenantResourceExtension"/> class for mocking. </summary>
        protected ResourceGraphTenantResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ResourceGraphTenantResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ResourceGraphTenantResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual async Task<Response<ResourceQueryResult>> GetResourcesAsync(ResourceQueryContent content, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = DefaultClientDiagnostics.CreateScope("ResourceGraphTenantResourceExtension.GetResources");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response<BinaryData>> GetResourceHistoryAsync(ResourcesHistoryContent content, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = DefaultClientDiagnostics.CreateScope("ResourceGraphTenantResourceExtension.GetResourceHistory");
            scope.Start();
            try
            {
