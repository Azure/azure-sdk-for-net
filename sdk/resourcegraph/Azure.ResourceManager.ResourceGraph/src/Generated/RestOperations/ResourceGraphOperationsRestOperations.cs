...
namespace Azure.ResourceManager.ResourceGraph
{
    internal partial class ResourceGraphOperations
    {
        ...
        internal ResourceGraphOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string applicationId, Uri endpoint, string apiVersion)
        {
            ClientDiagnostics = clientDiagnostics;
            _endpoint = endpoint;
            Pipeline = pipeline;
            _apiVersion = apiVersion;
            _userAgent = new TelemetryDetails(typeof(ResourceGraphOperations).Assembly, applicationId);
        }
        ...
        internal HttpMessage CreateGetResourcesRequest(RequestContent content, RequestContext context)
        {
