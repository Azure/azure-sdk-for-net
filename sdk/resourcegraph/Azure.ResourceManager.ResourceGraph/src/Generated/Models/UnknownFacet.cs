...
namespace Azure.ResourceManager.ResourceGraph.Models
{
    ...
    internal partial class UnknownFacet : Facet
    {
        ...
        internal UnknownFacet(string expression, string resultType, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(expression, resultType, serializedAdditionalRawData)
        {
