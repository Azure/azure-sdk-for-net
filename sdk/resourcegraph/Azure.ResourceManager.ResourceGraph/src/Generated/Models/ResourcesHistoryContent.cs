...
namespace Azure.ResourceManager.ResourceGraph.Models
{
    ...
    public partial class ResourcesHistoryContent
    {
        ...
        internal ResourcesHistoryContent(IList<string> subscriptions, string query, ResourcesHistoryRequestOptions options, IList<string> managementGroups, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
