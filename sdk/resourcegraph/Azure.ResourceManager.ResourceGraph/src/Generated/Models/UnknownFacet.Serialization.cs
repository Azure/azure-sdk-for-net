...
{
    internal partial class UnknownFacet : Facet, IJsonModel<Facet>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownFacet DeserializeUnknownFacet(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownFacet(expression, resultType, additionalBinaryDataProperties);
        }
    }
}
