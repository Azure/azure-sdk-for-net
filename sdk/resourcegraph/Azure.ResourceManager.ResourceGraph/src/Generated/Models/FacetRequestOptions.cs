...
namespace Azure.ResourceManager.ResourceGraph.Models
{
    ...
    public partial class FacetRequestOptions
    {
        ...
        internal FacetRequestOptions(string sortBy, FacetSortOrder? sortOrder, string filter, int? top, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            SortBy = sortBy;
            SortOrder = sortOrder;
            Filter = filter;
