...
namespace Azure.ResourceManager.ResourceGraph.Models
{
    ...
    public partial class FacetResult : Facet
    {
        ...
        internal FacetResult(string expression, string resultType, long totalRecords, int count, BinaryData data, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(expression, resultType, serializedAdditionalRawData)
        {
            TotalRecords = totalRecords;
            Count = count;
            Data = data;
