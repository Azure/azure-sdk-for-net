...
namespace Azure.ResourceManager.ResourceGraph.Models
{
    ...
    public partial class FacetResult : Facet
    {
        ...
        internal FacetResult(string expression, long totalRecords, int count, BinaryData data) : base(expression, "FacetResult")
        {
        ...
        /// <param name="count"> Number of records returned in the facet response. </param>
        /// <param name="data"> A JObject array or Table containing the desired facets. Only present if the facet is valid. </param>
        internal FacetResult(string expression, string resultType, IDictionary<string, BinaryData> additionalBinaryDataProperties, long totalRecords, int count, BinaryData data) : base(expression, resultType, additionalBinaryDataProperties)
        {
            TotalRecords = totalRecords;
            Count = count;
            Data = data;
