...
namespace Azure.ResourceManager.ResourceGraph.Models
{
    ...
    public partial class ResourceQueryRequestOptions
    {
        ...
        internal ResourceQueryRequestOptions(string skipToken, int? top, int? skip, ResultFormat? resultFormat, bool? allowPartialScopes, AuthorizationScopeFilter? authorizationScopeFilter, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            SkipToken = skipToken;
            Top = top;
            Skip = skip;
