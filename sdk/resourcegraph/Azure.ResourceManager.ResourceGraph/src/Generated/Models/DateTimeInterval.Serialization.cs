...
namespace Azure.ResourceManager.ResourceGraph.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DateTimeInterval>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DateTimeInterval>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DateTimeInterval>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DateTimeInterval>)} interface");
            }
        ...
        string IPersistableModel<DateTimeInterval>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
