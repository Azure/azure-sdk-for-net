...
{
    public partial class FacetError : IUtf8JsonSerializable, IJsonModel<FacetError>, IPersistableModel<FacetError>
    {
        ...
        void IJsonModel<FacetError>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(FacetError)} does not support '{format}' format.");
            }
