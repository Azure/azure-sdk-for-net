...
namespace Azure.ResourceManager.ResourceGraph.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FacetError>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<FacetError>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<FacetError>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<FacetError>)} interface");
            }
        ...
        string IPersistableModel<FacetError>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
