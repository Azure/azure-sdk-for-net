...
namespace Azure.ResourceManager.ResourceGraph.Models
{
    ...
    public partial class ResourceQueryContent
    {
        ...
        internal ResourceQueryContent(IList<string> subscriptions, IList<string> managementGroups, string query, ResourceQueryRequestOptions options, IList<FacetRequest> facets, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
