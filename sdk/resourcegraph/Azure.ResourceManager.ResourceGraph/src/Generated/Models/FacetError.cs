...
namespace Azure.ResourceManager.ResourceGraph.Models
{
    ...
    public partial class FacetError : Facet
    {
        ...
        internal FacetError(string expression, string resultType, IReadOnlyList<FacetErrorDetails> errors, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(expression, resultType, serializedAdditionalRawData)
        {
            Errors = errors;
