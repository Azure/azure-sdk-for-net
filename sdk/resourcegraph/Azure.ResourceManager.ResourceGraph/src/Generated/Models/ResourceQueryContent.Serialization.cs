...
namespace Azure.ResourceManager.ResourceGraph.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ResourceQueryContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ResourceQueryContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ResourceQueryContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ResourceQueryContent>)} interface");
            }
        ...
        string IPersistableModel<ResourceQueryContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
