...
namespace Azure.ResourceManager.ResourceGraph.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ResourcesHistoryContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ResourcesHistoryContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ResourcesHistoryContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ResourcesHistoryContent>)} interface");
            }
        ...
        string IPersistableModel<ResourcesHistoryContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
