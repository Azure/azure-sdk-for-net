...
namespace Azure.ResourceManager.ResourceGraph.Models
{
    ...
    public partial class ResourceQueryResult
    {
        ...
        internal ResourceQueryResult(long totalRecords, long count, ResultTruncated resultTruncated, string skipToken, BinaryData data, IReadOnlyList<Facet> facets, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            TotalRecords = totalRecords;
            Count = count;
            ResultTruncated = resultTruncated;
