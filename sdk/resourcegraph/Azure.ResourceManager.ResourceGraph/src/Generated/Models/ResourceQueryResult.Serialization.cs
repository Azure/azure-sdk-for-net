...
{
    public partial class ResourceQueryResult : IUtf8JsonSerializable, IJsonModel<ResourceQueryResult>, IPersistableModel<ResourceQueryResult>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ResultTruncated))
            {
                builder.Append("  resultTruncated:");
                builder.AppendLine($" '{ResultTruncated.ToString()}'");
            }
