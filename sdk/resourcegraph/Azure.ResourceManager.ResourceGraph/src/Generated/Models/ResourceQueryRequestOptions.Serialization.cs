...
namespace Azure.ResourceManager.ResourceGraph.Models
{
    ...
    public partial class ResourceQueryRequestOptions : IJsonModel<ResourceQueryRequestOptions>
    {
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual ResourceQueryRequestOptions PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<ResourceQueryRequestOptions>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ResourceQueryRequestOptions>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        ResourceQueryRequestOptions IPersistableModel<ResourceQueryRequestOptions>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ResourceQueryRequestOptions IJsonModel<ResourceQueryRequestOptions>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual ResourceQueryRequestOptions JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<ResourceQueryRequestOptions>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static ResourceQueryRequestOptions DeserializeResourceQueryRequestOptions(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("allowPartialScopes"u8))
                {
                    if (prop.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
                    }
                    allowPartialScopes = prop.Value.GetBoolean();
                    continue;
                }
                if (prop.NameEquals("authorizationScopeFilter"u8))
                {
                    ...
                    authorizationScopeFilter = prop.Value.GetString().ToAuthorizationScopeFilter();
                    continue;
                }
                if (options.Format != "W")
                {
