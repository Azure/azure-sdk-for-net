...
namespace Azure.ResourceManager.ResourceGraph.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FacetRequest>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<FacetRequest>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<FacetRequest>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<FacetRequest>)} interface");
            }
        ...
        string IPersistableModel<FacetRequest>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
