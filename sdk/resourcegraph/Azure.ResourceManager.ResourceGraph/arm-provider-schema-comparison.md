# ARM provider schema comparison: Azure.ResourceManager.ResourceGraph
...
| --- | --- | --- |
| `/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ResourceGraph/queries/{resourceName}` | `ResourceGraphQuery` | `GraphQueryResource` |
