...
namespace Azure.Data.Tables.Models
{
    ...
    internal partial class TableResponse : TableItem
    {
        ...
        internal TableResponse(string name, string odataType, string odataId, string odataEditLink, string odataMetadata, Dictionary<string, BinaryData> rawData) : base(name, odataType, odataId, odataEditLink, rawData)
        {
