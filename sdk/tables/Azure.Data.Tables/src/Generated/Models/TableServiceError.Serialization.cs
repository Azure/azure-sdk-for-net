...
namespace Azure.Data.Tables.Models
{
    internal partial class TableServiceError : IUtf8JsonSerializable, IJsonModel<TableServiceError>, IXmlSerializable, IPersistableModel<TableServiceError>
    {
        ...
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TableServiceError>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<TableServiceError>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<TableServiceError>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<TableServiceError>.GetWireFormat(ModelReaderWriterOptions options) => "X";
    }
}
