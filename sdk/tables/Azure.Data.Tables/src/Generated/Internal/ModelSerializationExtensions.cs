...
namespace Azure.Data.Tables
{
    ...
    {
        private static readonly JsonSerializerOptions s_options = new JsonSerializerOptions { Converters = { new JsonModelConverter(WireOptions, AzureDataTablesContext.Default) } };
