...
namespace Azure.Data.Tables.Models
{
    ...
    public static partial class TableModelFactory
    {
        ...
        {
            return new TableServiceStatistics(geoReplication, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new TableGeoReplicationInfo(status, lastSyncedOn, new Dictionary<string, BinaryData>());
        }
    }
}
