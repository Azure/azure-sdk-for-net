            ...
            foreach (KeyValuePair<string, string> kv in kvps)
            {
                ...
                switch (kv.Key.ToUpperInvariant())
                {
                    ...
                    case TableConstants.Sas.Parameters.ServicesUpper:
                        _services = AccountSasServices.Tables;
                        break;
                    ...
                    case TableConstants.Sas.Parameters.SignatureUpper:
                        _signature = kv.Value;
                        break;
                    case TableConstants.Sas.Parameters.CacheControlUpper:
                        _cacheControl = kv.Value;
                        break;
                    case TableConstants.Sas.Parameters.ContentDispositionUpper:
                        _contentDisposition = kv.Value;
                        break;
                    case TableConstants.Sas.Parameters.ContentEncodingUpper:
                        _contentEncoding = kv.Value;
                        break;
                    case TableConstants.Sas.Parameters.ContentLanguageUpper:
                        _contentLanguage = kv.Value;
                        break;
                    case TableConstants.Sas.Parameters.ContentTypeUpper:
