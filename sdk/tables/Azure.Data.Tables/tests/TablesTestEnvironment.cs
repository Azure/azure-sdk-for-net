...
namespace Azure.Data.Tables.Tests
{
    public class TablesTestEnvironment : TestEnvironment
    {
        ...
        private const string UriFormat = "https://{0}.{1}";
        ...
        public string StorageUri => string.Format(UriFormat, StorageAccountName, TablesStorageEndpointSuffix);
        ...
        public string CosmosUri => string.Format(UriFormat, CosmosAccountName, TablesCosmosEndpointSuffix);
    }
}
