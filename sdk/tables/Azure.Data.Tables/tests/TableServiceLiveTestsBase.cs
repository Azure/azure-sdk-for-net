...
namespace Azure.Data.Tables.Tests
{
    ...
    public class TableServiceLiveTestsBase : RecordedTestBase<TablesTestEnvironment>
    {
        ...
        public class ComplexEntity : ITableEntity
        {
            ...
            {
                Assert.That(b.String, Is.EqualTo(a.String));
                Assert.That(b.Int64, Is.EqualTo(a.Int64));
                Assert.That(b.Int64N, Is.EqualTo(a.Int64N));
                Assert.That(b.Int64Null, Is.EqualTo(a.Int64Null));
                Assert.That(b.LongPrimitive, Is.EqualTo(a.LongPrimitive));
                Assert.That(b.LongPrimitiveN, Is.EqualTo(a.LongPrimitiveN));
                Assert.That(b.LongPrimitiveNull, Is.EqualTo(a.LongPrimitiveNull));
                Assert.That(b.Int32, Is.EqualTo(a.Int32));
                Assert.That(b.Int32N, Is.EqualTo(a.Int32N));
                Assert.That(b.Int32Null, Is.EqualTo(a.Int32Null));
                Assert.That(b.IntegerPrimitive, Is.EqualTo(a.IntegerPrimitive));
                Assert.That(b.IntegerPrimitiveN, Is.EqualTo(a.IntegerPrimitiveN));
                Assert.That(b.IntegerPrimitiveNull, Is.EqualTo(a.IntegerPrimitiveNull));
                Assert.That(b.Guid, Is.EqualTo(a.Guid));
                Assert.That(b.GuidN, Is.EqualTo(a.GuidN));
                Assert.That(b.GuidNull, Is.EqualTo(a.GuidNull));
                Assert.That(b.Double, Is.EqualTo(a.Double));
                Assert.That(b.DoubleN, Is.EqualTo(a.DoubleN));
                Assert.That(b.DoubleNull, Is.EqualTo(a.DoubleNull));
                Assert.That(b.DoublePrimitive, Is.EqualTo(a.DoublePrimitive));
                Assert.That(b.DoublePrimitiveN, Is.EqualTo(a.DoublePrimitiveN));
                Assert.That(b.DoublePrimitiveNull, Is.EqualTo(a.DoublePrimitiveNull));
                Assert.That(b.BinaryPrimitive.GetValue(0), Is.EqualTo(a.BinaryPrimitive.GetValue(0)));
                Assert.That(b.BinaryPrimitive.GetValue(1), Is.EqualTo(a.BinaryPrimitive.GetValue(1)));
                Assert.That(b.BinaryPrimitive.GetValue(2), Is.EqualTo(a.BinaryPrimitive.GetValue(2)));
                Assert.That(b.Binary.ToArray().GetValue(0), Is.EqualTo(a.Binary.ToArray().GetValue(0)));
                Assert.That(b.Binary.ToArray().GetValue(1), Is.EqualTo(a.Binary.ToArray().GetValue(1)));
                Assert.That(b.Binary.ToArray().GetValue(2), Is.EqualTo(a.Binary.ToArray().GetValue(2)));
                Assert.That(b.BoolPrimitive, Is.EqualTo(a.BoolPrimitive));
                Assert.That(b.BoolPrimitiveN, Is.EqualTo(a.BoolPrimitiveN));
                Assert.That(b.BoolPrimitiveNull, Is.EqualTo(a.BoolPrimitiveNull));
                Assert.That(b.Bool, Is.EqualTo(a.Bool));
                Assert.That(b.BoolN, Is.EqualTo(a.BoolN));
                Assert.That(b.BoolNull, Is.EqualTo(a.BoolNull));
                Assert.That(b.DateTimeOffsetN, Is.EqualTo(a.DateTimeOffsetN));
                Assert.That(b.DateTimeOffset, Is.EqualTo(a.DateTimeOffset));
                Assert.That(b.DateTimeOffsetNull, Is.EqualTo(a.DateTimeOffsetNull));
                Assert.That(b.DateTime, Is.EqualTo(a.DateTime));
                Assert.That(b.DateTimeN, Is.EqualTo(a.DateTimeN));
                Assert.That(b.DateTimeNull, Is.EqualTo(a.DateTimeNull));
            }
        }
