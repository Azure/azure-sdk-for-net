...
namespace Microsoft.Azure.WebJobs.Extensions.Tables.Tests
{
    public class TableFilterFormatterTests
    {
        ...
        public void Format_InvalidFilter_ThrowsExpectedException()
        {
            ...
            Assert.That(ex.Message, Is.EqualTo($"An invalid parameter value was specified for filter parameter 'Age'."));
            ...
            ex = Assert.Throws<InvalidOperationException>(() => TableFilterFormatter.Format(template, (IReadOnlyDictionary<string, object>)bindingData));
            Assert.That(ex.Message, Is.EqualTo($"An invalid parameter value was specified for filter parameter 'BirthDate'."));
        ...
        public void Format_StringLiteral_ReturnsExpectedValue()
        {
            ...
            Assert.That(result, Is.EqualTo("Name eq 'x'' or ''x'' eq ''x'"));
            // verify the same template reversed
            bindingData = new Dictionary<string, object>
            {
                { "Name", "x' or 'x' eq 'x" }
            ...
            Assert.That(result, Is.EqualTo("'x'' or ''x'' eq ''x' eq Name"));
            ...
            Assert.That(result, Is.EqualTo("(Age gt 35) and (Name eq 'O''Malley')"));
            ...
            Assert.That(result, Is.EqualTo("(BirthDate gt datetime'2000-01-10') and (BirthDate lt datetime'2017-01-10')"));
            // guid filter
            bindingData = new Dictionary<string, object>
            {
            ...
            Assert.That(result, Is.EqualTo("Category eq 'Electronics' and ID eq guid'110C91D4-5412-4DAC-A960-EF0BCB8BAFEB'"));
            ...
            Assert.That(result, Is.EqualTo("ID eq guid'invalid''value'"));
            // binary filter
            bindingData = new Dictionary<string, object>
            {
            ...
            Assert.That(result, Is.EqualTo("Binary eq X'TWFyeSBoYWQgYSBsaXR0bGUgbGFtYiE='"));
            ...
            Assert.That(result, Is.EqualTo("Name eq 'Curly'"));
        }
        ...
        public void Format_MissingParameter_ThrowsExpectedException()
        {
            ...
            Assert.That(ex.Message, Is.EqualTo("No value for named parameter 'ID'."));
        }
        ...
        public void Format_SpecialTypes_ReturnsExpectedResult()
        {
            ...
            Assert.That(result, Is.EqualTo("DateTime eq datetime'2017-01-26T19:30:00.0000000Z' and DateTimeOffset eq datetime'2017-01-26T19:30:00.0000000Z' and ID eq guid'110c91d4-5412-4dac-a960-ef0bcb8bafeb'"));
        }
