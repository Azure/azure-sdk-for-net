...
{
    internal partial class BulkActionsGetVirtualMachinesCollectionResultOfT : Pageable<BulkActionVirtualMachineResult>
    {
        ...
        public BulkActionsGetVirtualMachinesCollectionResultOfT(BulkActions client, Guid subscriptionId, string resourceGroupName, AzureLocation location, string name, string filter, string skiptoken, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        public override IEnumerable<Page<BulkActionVirtualMachineResult>> AsPages(string continuationToken, int? pageSizeHint)
        {
