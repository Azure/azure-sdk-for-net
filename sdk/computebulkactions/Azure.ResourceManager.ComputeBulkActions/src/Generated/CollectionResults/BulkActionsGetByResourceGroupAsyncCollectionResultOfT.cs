...
namespace Azure.ResourceManager.ComputeBulkActions
{
    internal partial class BulkActionsGetByResourceGroupAsyncCollectionResultOfT : AsyncPageable<BulkActionData>
    {
        ...
        /// <summary> Initializes a new instance of BulkActionsGetByResourceGroupAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public BulkActionsGetByResourceGroupAsyncCollectionResultOfT(BulkActions client, Guid subscriptionId, string resourceGroupName, AzureLocation location, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of BulkActionsGetByResourceGroupAsyncCollectionResultOfT as an enumerable collection. </summary>
