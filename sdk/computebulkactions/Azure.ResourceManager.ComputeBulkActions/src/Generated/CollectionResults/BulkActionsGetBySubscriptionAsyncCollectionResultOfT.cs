...
{
    internal partial class BulkActionsGetBySubscriptionAsyncCollectionResultOfT : AsyncPageable<BulkActionData>
    {
        ...
        /// <summary> Initializes a new instance of BulkActionsGetBySubscriptionAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        /// <param name="client"> The BulkActions client used to send requests. </param>
        /// <param name="subscriptionId"> The ID of the target subscription. The value must be an UUID. </param>
        /// <param name="location"> The location name. </param>
        /// <param name="context"> The request options, which can override default behaviors of the client pipeline on a per-call basis. </param>
        public BulkActionsGetBySubscriptionAsyncCollectionResultOfT(BulkActions client, Guid subscriptionId, AzureLocation location, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of BulkActionsGetBySubscriptionAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of BulkActionsGetBySubscriptionAsyncCollectionResultOfT as an enumerable collection. </returns>
        ...
        private async ValueTask<Response> GetNextResponseAsync(int? pageSizeHint, Uri nextLink)
        {
            ...
            using DiagnosticScope scope = _client.ClientDiagnostics.CreateScope("MockableComputeBulkActionsSubscriptionResource.GetBulkActions");
            scope.Start();
            try
            {
