...
{
    internal partial class ComputeBulkActionsArmOperation<T> : ArmOperation<T>
    {
        ...
        /// <summary> Initializes a new instance of ComputeBulkActionsArmOperation for mocking. </summary>
        protected ComputeBulkActionsArmOperation()
        {
        }
        ...
        internal ComputeBulkActionsArmOperation(Response<T> response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal ComputeBulkActionsArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal<T>(
                ...
                clientDiagnostics,
                response,
                "ComputeBulkActionsArmOperation",
                null,
