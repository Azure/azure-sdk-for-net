...
namespace Azure.ResourceManager.ComputeBulkActions.Models
{
    ...
    public partial class ComputeBulkActionsHostEndpointSettings
    {
        ...
        /// <summary> Initializes a new instance of <see cref="ComputeBulkActionsHostEndpointSettings"/>. </summary>
        ...
        internal ComputeBulkActionsHostEndpointSettings(ComputeBulkActionsHostEndpointMode? mode, ResourceIdentifier inVMAccessControlProfileReferenceId, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Mode = mode;
        ...
        public ComputeBulkActionsHostEndpointMode? Mode { get; set; }
