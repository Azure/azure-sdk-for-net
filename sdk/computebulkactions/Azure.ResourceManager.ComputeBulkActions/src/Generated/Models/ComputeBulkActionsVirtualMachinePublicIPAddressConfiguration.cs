...
namespace Azure.ResourceManager.ComputeBulkActions.Models
{
    ...
    public partial class ComputeBulkActionsVirtualMachinePublicIPAddressConfiguration
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="ComputeBulkActionsVirtualMachinePublicIPAddressConfiguration"/>. </summary>
        ...
        internal ComputeBulkActionsVirtualMachinePublicIPAddressConfiguration(string name, ComputeBulkActionsVirtualMachinePublicIPAddressConfigurationProperties properties, ComputeBulkActionsPublicIPAddressSku sku, IDictionary<string, string> tags, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Name = name;
        ...
        /// <summary> Describes a virtual machines IP Configuration's PublicIPAddress configuration. </summary>
        public ComputeBulkActionsVirtualMachinePublicIPAddressConfigurationProperties Properties { get; set; }

        /// <summary> Describes the public IP Sku. It can only be set with OrchestrationMode as Flexible. </summary>
        public ComputeBulkActionsPublicIPAddressSku Sku { get; set; }
