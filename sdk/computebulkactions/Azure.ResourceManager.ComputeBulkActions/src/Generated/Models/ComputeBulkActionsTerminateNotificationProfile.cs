...
namespace Azure.ResourceManager.ComputeBulkActions.Models
{
    ...
    public partial class ComputeBulkActionsTerminateNotificationProfile
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="ComputeBulkActionsTerminateNotificationProfile"/>. </summary>
        ...
        internal ComputeBulkActionsTerminateNotificationProfile(string notBeforeTimeout, bool? isEnabled, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
