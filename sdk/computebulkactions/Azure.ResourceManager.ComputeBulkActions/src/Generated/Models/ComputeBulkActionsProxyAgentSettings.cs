...
namespace Azure.ResourceManager.ComputeBulkActions.Models
{
    ...
    public partial class ComputeBulkActionsProxyAgentSettings
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="ComputeBulkActionsProxyAgentSettings"/>. </summary>
        ...
        internal ComputeBulkActionsProxyAgentSettings(bool? isEnabled, ComputeBulkActionsProxyAgentMode? mode, int? keyIncarnationId, ComputeBulkActionsHostEndpointSettings wireServer, ComputeBulkActionsHostEndpointSettings imds, bool? shouldAddProxyAgentExtension, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            IsEnabled = isEnabled;
            Mode = mode;
        ...
        public ComputeBulkActionsProxyAgentMode? Mode { get; set; }
        ...
        public ComputeBulkActionsHostEndpointSettings WireServer { get; set; }
        ...
        public ComputeBulkActionsHostEndpointSettings Imds { get; set; }
