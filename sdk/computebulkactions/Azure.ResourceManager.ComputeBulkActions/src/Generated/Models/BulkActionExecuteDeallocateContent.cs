...
namespace Azure.ResourceManager.ComputeBulkActions.Models
{
    ...
    public partial class BulkActionExecuteDeallocateContent
    {
        ...
        /// <summary> Initializes a new instance of <see cref="BulkActionExecuteDeallocateContent"/>. </summary>
        ...
        public BulkActionExecuteDeallocateContent(BulkActionExecutionConfig executionParameters, string correlationId)
        {
        ...
        internal BulkActionExecuteDeallocateContent(BulkActionExecutionConfig executionParameters, Resources resources, string correlationId, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            ExecutionParameters = executionParameters;
            Resources = resources;
            CorrelationId = correlationId;
