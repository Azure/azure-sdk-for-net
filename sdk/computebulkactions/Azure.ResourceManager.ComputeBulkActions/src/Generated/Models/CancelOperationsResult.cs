...
namespace Azure.ResourceManager.ComputeBulkActions.Models
{
    ...
    public partial class CancelOperationsResult
    {
        ...
        internal CancelOperationsResult(IEnumerable<BulkActionResourceOperationInfo> results)
        {
        ...
        internal CancelOperationsResult(IList<BulkActionResourceOperationInfo> results, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Results = results;
