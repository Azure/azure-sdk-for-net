...
namespace Azure.ResourceManager.ComputeBulkActions.Models
{
    ...
    public partial class BulkActionResourceProvisionPayload
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="BulkActionResourceProvisionPayload"/>. </summary>
        ...
        internal BulkActionResourceProvisionPayload(IDictionary<string, BinaryData> baseProfile, IList<IDictionary<string, BinaryData>> resourceOverrides, int resourceCount, string resourcePrefix, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
