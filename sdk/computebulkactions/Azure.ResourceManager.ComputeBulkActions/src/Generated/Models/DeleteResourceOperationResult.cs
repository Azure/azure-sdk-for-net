...
namespace Azure.ResourceManager.ComputeBulkActions.Models
{
    ...
    public partial class DeleteResourceOperationResult
    {
        ...
        internal DeleteResourceOperationResult(string description, string @type, AzureLocation location, IList<BulkActionResourceOperationInfo> results, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Description = description;
            Type = @type;
            Location = location;
