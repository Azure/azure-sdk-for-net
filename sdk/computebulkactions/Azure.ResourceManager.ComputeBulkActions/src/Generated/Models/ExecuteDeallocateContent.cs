...
namespace Azure.ResourceManager.ComputeBulkActions.Models
{
    ...
    public partial class ExecuteDeallocateContent
    {
        ...
        public ExecuteDeallocateContent(BulkActionExecutionConfig executionParameters, string correlationId)
        {
        ...
        internal ExecuteDeallocateContent(BulkActionExecutionConfig executionParameters, Resources resources, string correlationId, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            ExecutionParameters = executionParameters;
            Resources = resources;
            CorrelationId = correlationId;
