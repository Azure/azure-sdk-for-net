...
namespace Azure.ResourceManager.ComputeBulkActions.Models
{
    ...
    public partial class ExecuteHibernateContent
    {
        ...
        public ExecuteHibernateContent(BulkActionExecutionConfig executionParameters, string correlationId)
        {
        ...
        internal ExecuteHibernateContent(BulkActionExecutionConfig executionParameters, Resources resources, string correlationId, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            ExecutionParameters = executionParameters;
            Resources = resources;
            CorrelationId = correlationId;
