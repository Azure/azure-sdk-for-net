...
namespace Azure.ResourceManager.ComputeBulkActions.Models
{
    ...
    public partial class ComputeBulkActionsVMAttributeMinMaxInteger
    {
        ...
        /// <summary> Initializes a new instance of <see cref="ComputeBulkActionsVMAttributeMinMaxInteger"/>. </summary>
        ...
        internal ComputeBulkActionsVMAttributeMinMaxInteger(int? min, int? max, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Min = min;
            Max = max;
