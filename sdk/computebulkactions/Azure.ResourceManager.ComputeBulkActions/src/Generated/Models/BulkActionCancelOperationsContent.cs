...
namespace Azure.ResourceManager.ComputeBulkActions.Models
{
    ...
    public partial class BulkActionCancelOperationsContent
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="BulkActionCancelOperationsContent"/>. </summary>
        ...
        public BulkActionCancelOperationsContent(IEnumerable<string> operationIds, string correlationId)
        {
        ...
        internal BulkActionCancelOperationsContent(IList<string> operationIds, string correlationId, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
