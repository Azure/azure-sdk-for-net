...
namespace Azure.ResourceManager.ComputeBulkActions.Models
{
    ...
    public partial class BulkActionComputeProfile
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="BulkActionComputeProfile"/>. </summary>
        ...
        public BulkActionComputeProfile(ComputeBulkActionsVirtualMachineProfile virtualMachineProfile)
        {
        ...
        internal BulkActionComputeProfile(ComputeBulkActionsVirtualMachineProfile virtualMachineProfile, IList<ComputeBulkActionsVirtualMachineExtension> extensions, string computeApiVersion, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            VirtualMachineProfile = virtualMachineProfile;
