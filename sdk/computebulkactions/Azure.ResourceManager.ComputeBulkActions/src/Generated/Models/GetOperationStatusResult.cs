...
namespace Azure.ResourceManager.ComputeBulkActions.Models
{
    ...
    public partial class GetOperationStatusResult
    {
        ...
        internal GetOperationStatusResult(IEnumerable<BulkActionResourceOperationInfo> results)
        {
        ...
        internal GetOperationStatusResult(IList<BulkActionResourceOperationInfo> results, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Results = results;
