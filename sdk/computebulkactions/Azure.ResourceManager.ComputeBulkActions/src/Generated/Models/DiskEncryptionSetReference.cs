...
namespace Azure.ResourceManager.ComputeBulkActions.Models
{
    ...
    public partial class DiskEncryptionSetReference : ComputeBulkActionsSubResource
    {
        /// <summary> Initializes a new instance of <see cref="DiskEncryptionSetReference"/>. </summary>
        ...
        internal DiskEncryptionSetReference(ResourceIdentifier id, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, additionalBinaryDataProperties)
        {
        }
    }
}
