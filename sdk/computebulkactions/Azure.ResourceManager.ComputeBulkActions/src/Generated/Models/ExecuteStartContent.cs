...
namespace Azure.ResourceManager.ComputeBulkActions.Models
{
    ...
    public partial class ExecuteStartContent
    {
        ...
        public ExecuteStartContent(BulkActionExecutionConfig executionParameters, string correlationId)
        {
        ...
        internal ExecuteStartContent(BulkActionExecutionConfig executionParameters, Resources resources, string correlationId, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            ExecutionParameters = executionParameters;
            Resources = resources;
            CorrelationId = correlationId;
