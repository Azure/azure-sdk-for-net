...
namespace Azure.ResourceManager.ComputeBulkActions.Models
{
    ...
    public partial class ComputeBulkActionsWinRMListener
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="ComputeBulkActionsWinRMListener"/>. </summary>
        ...
        internal ComputeBulkActionsWinRMListener(ComputeBulkActionsProtocolType? protocol, string certificateUri, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Protocol = protocol;
