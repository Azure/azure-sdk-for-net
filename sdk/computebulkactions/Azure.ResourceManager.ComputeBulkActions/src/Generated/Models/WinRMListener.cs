...
namespace Azure.ResourceManager.ComputeBulkActions.Models
{
    ...
    public partial class WinRMListener
    {
        ...
        internal WinRMListener(ComputeBulkActionsProtocolType? protocol, string certificateUri, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Protocol = protocol;
        ...
        public ComputeBulkActionsProtocolType? Protocol { get; set; }
