...
namespace Azure.ResourceManager.ComputeBulkActions.Models
{
    ...
    public partial class ComputeBulkActionsSshPublicKey
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="ComputeBulkActionsSshPublicKey"/>. </summary>
        ...
        internal ComputeBulkActionsSshPublicKey(string path, string keyData, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Path = path;
            KeyData = keyData;
