...
namespace Azure.ResourceManager.ComputeBulkActions.Models
{
    ...
    public partial class ComputeBulkActionsAdditionalUnattendContent
    {
        ...
        /// <summary> Initializes a new instance of <see cref="ComputeBulkActionsAdditionalUnattendContent"/>. </summary>
        ...
        internal ComputeBulkActionsAdditionalUnattendContent(ComputeBulkActionsAdditionalUnattendContentPassName? passName, ComputeBulkActionsAdditionalUnattendContentComponentName? componentName, ComputeBulkActionsAdditionalUnattendContentSettingName? settingName, string content, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            PassName = passName;
        ...
        public ComputeBulkActionsAdditionalUnattendContentPassName? PassName { get; set; }

        /// <summary> The component name. Currently, the only allowable value is Microsoft-Windows-Shell-Setup. </summary>
        public ComputeBulkActionsAdditionalUnattendContentComponentName? ComponentName { get; set; }
        ...
        public ComputeBulkActionsAdditionalUnattendContentSettingName? SettingName { get; set; }
