...
namespace Azure.ResourceManager.ComputeBulkActions.Models
{
    ...
    public partial class ComputeBulkActionsDiskEncryptionSetReference : ComputeBulkActionsSubResource
    {
        ...
        internal ComputeBulkActionsDiskEncryptionSetReference(ResourceIdentifier id, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, additionalBinaryDataProperties)
        {
        }
    }
}
