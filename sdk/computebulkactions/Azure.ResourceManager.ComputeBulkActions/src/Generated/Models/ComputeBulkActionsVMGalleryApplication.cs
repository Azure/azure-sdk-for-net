...
namespace Azure.ResourceManager.ComputeBulkActions.Models
{
    ...
    public partial class ComputeBulkActionsVMGalleryApplication
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="ComputeBulkActionsVMGalleryApplication"/>. </summary>
        ...
        public ComputeBulkActionsVMGalleryApplication(ResourceIdentifier packageReferenceId)
        {
        ...
        internal ComputeBulkActionsVMGalleryApplication(string tags, int? order, ResourceIdentifier packageReferenceId, string configurationReference, bool? shouldTreatFailureAsDeploymentFailure, bool? isAutomaticUpgradeEnabled, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Tags = tags;
            Order = order;
            PackageReferenceId = packageReferenceId;
