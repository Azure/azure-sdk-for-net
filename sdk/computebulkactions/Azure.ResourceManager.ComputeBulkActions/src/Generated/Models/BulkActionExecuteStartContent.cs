...
namespace Azure.ResourceManager.ComputeBulkActions.Models
{
    ...
    public partial class BulkActionExecuteStartContent
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="BulkActionExecuteStartContent"/>. </summary>
        ...
        public BulkActionExecuteStartContent(BulkActionExecutionConfig executionParameters, string correlationId)
        {
        ...
        internal BulkActionExecuteStartContent(BulkActionExecutionConfig executionParameters, Resources resources, string correlationId, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            ExecutionParameters = executionParameters;
            Resources = resources;
            CorrelationId = correlationId;
