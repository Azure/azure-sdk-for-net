...
namespace Azure.ResourceManager.ComputeBulkActions.Models
{
    ...
    public partial class ExecuteCreateContent
    {
        ...
        public ExecuteCreateContent(ResourceProvisionPayload resourceConfigParameters, BulkActionExecutionConfig executionParameters)
        {
        ...
        internal ExecuteCreateContent(ResourceProvisionPayload resourceConfigParameters, BulkActionExecutionConfig executionParameters, string correlationId, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            ResourceConfigParameters = resourceConfigParameters;
            ExecutionParameters = executionParameters;
