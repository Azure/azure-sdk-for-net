...
namespace Azure.ResourceManager.ComputeBulkActions.Models
{
    ...
    public partial class ComputeBulkActionsVirtualMachineNetworkInterfaceIPConfiguration
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="ComputeBulkActionsVirtualMachineNetworkInterfaceIPConfiguration"/>. </summary>
        ...
        internal ComputeBulkActionsVirtualMachineNetworkInterfaceIPConfiguration(string name, ComputeBulkActionsVirtualMachineNetworkInterfaceIPConfigurationProperties properties, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Name = name;
        ...
        public ComputeBulkActionsVirtualMachineNetworkInterfaceIPConfigurationProperties Properties { get; set; }
    }
}
