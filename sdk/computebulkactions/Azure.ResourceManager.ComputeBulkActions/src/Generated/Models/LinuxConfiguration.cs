...
namespace Azure.ResourceManager.ComputeBulkActions.Models
{
    ...
    public partial class LinuxConfiguration
    {
        ...
        internal LinuxConfiguration(bool? isPasswordAuthenticationDisabled, SshConfiguration ssh, bool? isVMAgentProvisioned, LinuxPatchSettings patchSettings, bool? isVMAgentPlatformUpdatesEnabled, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
