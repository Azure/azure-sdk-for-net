...
namespace Azure.ResourceManager.Compute.BulkActions.Models
{
    ...
    public partial class ImageReference
    {
        ...
        internal ImageReference(string publisher, string offer, string sku, string version, string sharedGalleryImageId, string communityGalleryImageId, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Publisher = publisher;
            Offer = offer;
            Sku = sku;
