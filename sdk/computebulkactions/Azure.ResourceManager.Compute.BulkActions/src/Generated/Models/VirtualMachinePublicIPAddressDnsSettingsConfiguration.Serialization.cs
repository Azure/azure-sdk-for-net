...
namespace Azure.ResourceManager.Compute.BulkActions.Models
{
    ...
    public partial class VirtualMachinePublicIPAddressDnsSettingsConfiguration : IJsonModel<VirtualMachinePublicIPAddressDnsSettingsConfiguration>
    {
        ...
        protected virtual VirtualMachinePublicIPAddressDnsSettingsConfiguration PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<VirtualMachinePublicIPAddressDnsSettingsConfiguration>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<VirtualMachinePublicIPAddressDnsSettingsConfiguration>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        VirtualMachinePublicIPAddressDnsSettingsConfiguration IPersistableModel<VirtualMachinePublicIPAddressDnsSettingsConfiguration>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        VirtualMachinePublicIPAddressDnsSettingsConfiguration IJsonModel<VirtualMachinePublicIPAddressDnsSettingsConfiguration>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual VirtualMachinePublicIPAddressDnsSettingsConfiguration JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<VirtualMachinePublicIPAddressDnsSettingsConfiguration>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static VirtualMachinePublicIPAddressDnsSettingsConfiguration DeserializeVirtualMachinePublicIPAddressDnsSettingsConfiguration(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            DomainNameLabelScopeTypes? domainNameLabelScope = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("domainNameLabelScope"u8))
                {
                    ...
                    domainNameLabelScope = new DomainNameLabelScopeTypes(prop.Value.GetString());
                    continue;
                }
                if (options.Format != "W")
                {
            ...
            return new VirtualMachinePublicIPAddressDnsSettingsConfiguration(domainNameLabel, domainNameLabelScope, additionalBinaryDataProperties);
        }
    }
}
