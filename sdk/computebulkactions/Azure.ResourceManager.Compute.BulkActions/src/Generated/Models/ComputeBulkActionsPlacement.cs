...
namespace Azure.ResourceManager.Compute.BulkActions.Models
{
    ...
    public partial class ComputeBulkActionsPlacement
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="ComputeBulkActionsPlacement"/>. </summary>
        ...
        internal ComputeBulkActionsPlacement(ZonePlacementPolicyType? zonePlacementPolicy, IList<string> includeZones, IList<string> excludeZones, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
