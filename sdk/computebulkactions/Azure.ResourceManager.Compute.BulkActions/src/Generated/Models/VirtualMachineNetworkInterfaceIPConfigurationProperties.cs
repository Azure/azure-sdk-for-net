...
namespace Azure.ResourceManager.Compute.BulkActions.Models
{
    ...
    public partial class VirtualMachineNetworkInterfaceIPConfigurationProperties
    {
        ...
        internal VirtualMachineNetworkInterfaceIPConfigurationProperties(WritableSubResource subnet, bool? isPrimary, VirtualMachinePublicIPAddressConfiguration publicIPAddressConfiguration, IPVersions? privateIPAddressVersion, IList<WritableSubResource> applicationSecurityGroups, IList<WritableSubResource> applicationGatewayBackendAddressPools, IList<WritableSubResource> loadBalancerBackendAddressPools, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Subnet = subnet;
            IsPrimary = isPrimary;
