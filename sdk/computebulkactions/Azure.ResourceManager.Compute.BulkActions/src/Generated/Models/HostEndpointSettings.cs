...
namespace Azure.ResourceManager.Compute.BulkActions.Models
{
    ...
    public partial class HostEndpointSettings
    {
        ...
        internal HostEndpointSettings(HostEndpointMode? mode, string inVMAccessControlProfileReferenceId, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Mode = mode;
