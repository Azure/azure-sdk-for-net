...
{
    internal partial class BulkActionsArmOperation : ArmOperation
    {
        ...
        /// <summary> Initializes a new instance of BulkActionsArmOperation for mocking. </summary>
        protected BulkActionsArmOperation()
        {
        }
        ...
        internal BulkActionsArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal BulkActionsArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
