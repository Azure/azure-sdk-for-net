...
namespace Azure.ResourceManager.Compute.BulkActions
{
    internal partial class LaunchBulkInstancesOperationGetVirtualMachinesCollectionResultOfT : Pageable<BulkActionsVirtualMachineInfo>
    {
        ...
        /// <summary> Initializes a new instance of LaunchBulkInstancesOperationGetVirtualMachinesCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        /// <param name="client"> The LaunchBulkInstancesOperation client used to send requests. </param>
        ...
        public LaunchBulkInstancesOperationGetVirtualMachinesCollectionResultOfT(LaunchBulkInstancesOperation client, Guid subscriptionId, string resourceGroupName, AzureLocation location, string name, string filter, string skiptoken, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of LaunchBulkInstancesOperationGetVirtualMachinesCollectionResultOfT as an enumerable collection. </summary>
