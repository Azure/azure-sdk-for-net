...
namespace Microsoft.Azure.Management.Billing.Models
{
    ...
    public partial class Instruction : Resource
    {
        ...
        public Instruction(double amount, System.DateTime startDate, System.DateTime endDate, string id = default(string), string name = default(string), string type = default(string))
            : base(id, name, type)
        {
            Amount = amount;
            StartDate = startDate;
