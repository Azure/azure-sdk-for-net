...
namespace Microsoft.Azure.Management.Billing.Models
{
    ...
    /// </summary>
    public partial class InvoicesDownloadMultipleModernInvoiceHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// InvoicesDownloadMultipleModernInvoiceHeaders class.
        /// </summary>
        public InvoicesDownloadMultipleModernInvoiceHeaders()
        {
            CustomInit();
        }
        ...
        /// seconds.</param>
        public InvoicesDownloadMultipleModernInvoiceHeaders(string location = default(string), string retryAfter = default(string))
        {
            Location = location;
