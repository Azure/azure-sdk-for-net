...
namespace Microsoft.Azure.Management.Billing.Models
{
    ...
    /// </summary>
    public partial class InvoicesDownloadMultipleBillingProfileInvoicesHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// InvoicesDownloadMultipleBillingProfileInvoicesHeaders class.
        /// </summary>
        public InvoicesDownloadMultipleBillingProfileInvoicesHeaders()
        {
            CustomInit();
        }
        ...
        /// seconds.</param>
        public InvoicesDownloadMultipleBillingProfileInvoicesHeaders(string location = default(string), string retryAfter = default(string))
        {
            Location = location;
