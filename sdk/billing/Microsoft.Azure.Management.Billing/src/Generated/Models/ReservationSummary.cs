...
namespace Microsoft.Azure.Management.Billing.Models
{
    ...
    public partial class ReservationSummary
    {
        ...
        /// state</param>
        public ReservationSummary(double? succeededCount = default(double?), double? failedCount = default(double?), double? expiringCount = default(double?), double? expiredCount = default(double?), double? pendingCount = default(double?), double? cancelledCount = default(double?))
        {
