...
namespace Microsoft.Azure.Management.Billing
{
    ...
    internal partial class Operations : IServiceOperations<BillingManagementClient>, IOperations
    {
        ...
        public async Task<AzureOperationResponse<IPage<Operation>>> ListWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            {
                var ex = new OperationsErrorResponseException(string.Format("Operation returned an invalid status code '{0}'", _statusCode));
                try
                {
                    _responseContent = await _httpResponse.Content.ReadAsStringAsync().ConfigureAwait(false);
                    OperationsErrorResponse _errorBody =  Rest.Serialization.SafeJsonConvert.DeserializeObject<OperationsErrorResponse>(_responseContent, Client.DeserializationSettings);
                    if (_errorBody != null)
                    {
                        ex.Body = _errorBody;
                    }
