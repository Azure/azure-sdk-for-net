...
namespace Microsoft.Azure.Management.Billing
{
    ...
    public static partial class InvoicesOperationsExtensions
    {
            ...
            /// </param>
            public static DownloadUrl DownloadMultipleModernInvoice(this IInvoicesOperations operations, string billingAccountName, IList<string> downloadUrls)
            {
                return operations.DownloadMultipleModernInvoiceAsync(billingAccountName, downloadUrls).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<DownloadUrl> DownloadMultipleModernInvoiceAsync(this IInvoicesOperations operations, string billingAccountName, IList<string> downloadUrls, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.DownloadMultipleModernInvoiceWithHttpMessagesAsync(billingAccountName, downloadUrls, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
            ...
            /// An array of download urls for individual documents
            /// </param>
            public static DownloadUrl DownloadMultipleBillingSubscriptionInvoice(this IInvoicesOperations operations, IList<string> downloadUrls)
            {
                return operations.DownloadMultipleBillingSubscriptionInvoiceAsync(downloadUrls).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<DownloadUrl> DownloadMultipleBillingSubscriptionInvoiceAsync(this IInvoicesOperations operations, IList<string> downloadUrls, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.DownloadMultipleBillingSubscriptionInvoiceWithHttpMessagesAsync(downloadUrls, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
            ...
            /// An array of download urls for individual documents
            /// </param>
            public static DownloadUrl BeginDownloadMultipleModernInvoice(this IInvoicesOperations operations, string billingAccountName, IList<string> downloadUrls)
            {
                return operations.BeginDownloadMultipleModernInvoiceAsync(billingAccountName, downloadUrls).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<DownloadUrl> BeginDownloadMultipleModernInvoiceAsync(this IInvoicesOperations operations, string billingAccountName, IList<string> downloadUrls, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.BeginDownloadMultipleModernInvoiceWithHttpMessagesAsync(billingAccountName, downloadUrls, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
            ...
            /// An array of download urls for individual documents
            /// </param>
            public static DownloadUrl BeginDownloadMultipleBillingSubscriptionInvoice(this IInvoicesOperations operations, IList<string> downloadUrls)
            {
                return operations.BeginDownloadMultipleBillingSubscriptionInvoiceAsync(downloadUrls).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<DownloadUrl> BeginDownloadMultipleBillingSubscriptionInvoiceAsync(this IInvoicesOperations operations, IList<string> downloadUrls, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.BeginDownloadMultipleBillingSubscriptionInvoiceWithHttpMessagesAsync(downloadUrls, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
