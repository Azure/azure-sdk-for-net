...
{
    // Back-compat overloads for GA 1.2.2 callers: the MPG generator emits GetAll with individual query
    // parameters (includeDeleted, filter, orderBy, top, skip, count, search); these shims forward the GA
    // Options aggregate to the generated method.
