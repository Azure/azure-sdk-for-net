...
namespace Azure.ResourceManager.Billing
{
    ...
    public partial class BillingPaymentMethodData : ResourceData
    {
        ...
        /// <param name="properties"> Payment method properties. </param>
        ...
        internal BillingPaymentMethodData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, PaymentMethodProjectionProperties properties, IDictionary<string, string> tags) : base(id, name, resourceType, systemData)
        {
