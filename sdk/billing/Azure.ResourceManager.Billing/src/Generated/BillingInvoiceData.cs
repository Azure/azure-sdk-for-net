...
{
    /// <summary>
    /// A class representing the BillingInvoice data model.
    /// An invoice.
    /// </summary>
    public partial class BillingInvoiceData : ResourceData
    {
        ...
        internal BillingInvoiceData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, BillingInvoiceProperties properties, IDictionary<string, string> tags, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
