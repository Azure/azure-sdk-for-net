...
namespace Azure.ResourceManager.Billing
{
    ...
    public partial class BillingInvoiceData : ResourceData
    {
        ...
        internal BillingInvoiceData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, BillingInvoiceProperties properties, IDictionary<string, string> tags) : base(id, name, resourceType, systemData)
        {
