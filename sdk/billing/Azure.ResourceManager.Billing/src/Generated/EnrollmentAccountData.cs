...
{
    /// <summary>
    /// A class representing the EnrollmentAccount data model.
    /// It is an organizational hierarchy within a billing account to administer and manage azure costs.
    /// </summary>
    public partial class EnrollmentAccountData : ResourceData
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="EnrollmentAccountData"/>. </summary>
        ...
        internal EnrollmentAccountData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, EnrollmentAccountProperties properties, IDictionary<string, string> tags, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
        ...
        public EnrollmentAccountProperties Properties { get; set; }
