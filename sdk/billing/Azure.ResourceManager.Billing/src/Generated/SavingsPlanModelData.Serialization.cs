...
{
    public partial class SavingsPlanModelData : IUtf8JsonSerializable, IJsonModel<SavingsPlanModelData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SavingsPlanModelData>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<SavingsPlanModelData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<SavingsPlanModelData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SavingsPlanModelData)} does not support writing '{format}' format.");
            }
        ...
        SavingsPlanModelData IJsonModel<SavingsPlanModelData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<SavingsPlanModelData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SavingsPlanModelData)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeSavingsPlanModelData(document.RootElement, options);
        }

        internal static SavingsPlanModelData DeserializeSavingsPlanModelData(JsonElement element, ModelReaderWriterOptions options = null)
        {
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("utilization"u8))
                        {
                            ...
                            utilization = Utilization.DeserializeUtilization(property0.Value, options);
                            continue;
                        }
        ...
        BinaryData IPersistableModel<SavingsPlanModelData>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<SavingsPlanModelData>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SavingsPlanModelData)} does not support writing '{options.Format}' format.");
            }
        }

        SavingsPlanModelData IPersistableModel<SavingsPlanModelData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<SavingsPlanModelData>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SavingsPlanModelData)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<SavingsPlanModelData>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
