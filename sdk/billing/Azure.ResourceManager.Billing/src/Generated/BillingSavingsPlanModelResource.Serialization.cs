...
namespace Azure.ResourceManager.Billing
{
    ...
    {
        private static IJsonModel<BillingSavingsPlanModelData> s_dataDeserializationInstance;

        private static IJsonModel<BillingSavingsPlanModelData> DataDeserializationInstance => s_dataDeserializationInstance ??= new BillingSavingsPlanModelData();
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BillingSavingsPlanModelData IJsonModel<BillingSavingsPlanModelData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => DataDeserializationInstance.Create(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<BillingSavingsPlanModelData>.GetFormatFromOptions(ModelReaderWriterOptions options) => DataDeserializationInstance.GetFormatFromOptions(options);
    }
}
