...
{
    /// <summary>
    /// A class representing the AssociatedTenant data model.
    /// An associated tenant.
    /// </summary>
    public partial class AssociatedTenantData : ResourceData
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="AssociatedTenantData"/>. </summary>
        ...
        internal AssociatedTenantData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, AssociatedTenantProperties properties, IDictionary<string, string> tags, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
        ...
        public AssociatedTenantProperties Properties { get; set; }
