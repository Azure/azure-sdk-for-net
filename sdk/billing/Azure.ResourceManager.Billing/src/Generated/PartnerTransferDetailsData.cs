...
namespace Azure.ResourceManager.Billing
{
    ...
    public partial class PartnerTransferDetailsData : ResourceData
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="PartnerTransferDetailsData"/>. </summary>
        internal PartnerTransferDetailsData()
        {
        ...
        internal PartnerTransferDetailsData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, PartnerTransferProperties properties, IDictionary<string, string> tags) : base(id, name, resourceType, systemData)
        {
        ...
        /// <summary> Details of the transfer. </summary>
        internal PartnerTransferProperties Properties { get; }
