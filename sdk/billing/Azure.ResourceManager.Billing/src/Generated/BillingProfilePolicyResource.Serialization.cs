...
namespace Azure.ResourceManager.Billing
{
    public partial class BillingProfilePolicyResource : IJsonModel<BillingProfilePolicyData>
    {
        ...
        BinaryData IPersistableModel<BillingProfilePolicyData>.Write(ModelReaderWriterOptions options) => ModelReaderWriter.Write(Data, options);

        BillingProfilePolicyData IPersistableModel<BillingProfilePolicyData>.Create(BinaryData data, ModelReaderWriterOptions options) => ModelReaderWriter.Read<BillingProfilePolicyData>(data, options);
