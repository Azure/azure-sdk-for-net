...
{
    /// <summary>
    /// A class representing a EnrollmentAccount along with the instance operations that can be performed on it.
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="EnrollmentAccountResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="BillingAccountResource"/> using the GetEnrollmentAccounts method.
    /// </summary>
    public partial class EnrollmentAccountResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of EnrollmentAccountResource for mocking. </summary>
        protected EnrollmentAccountResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="EnrollmentAccountResource"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="data"> The resource that is the target of operations. </param>
        internal EnrollmentAccountResource(ArmClient client, BillingEnrollmentAccountData data) : this(client, data.Id)
        {
            this.HasData = true;
            _data = data;
        }
        ...
        internal EnrollmentAccountResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            this.TryGetApiVersion(ResourceType, out string enrollmentAccountApiVersion);
            ...
            _enrollmentAccountsRestClient = new EnrollmentAccounts(_enrollmentAccountsClientDiagnostics, Pipeline, Endpoint, enrollmentAccountApiVersion ?? "2024-04-01");
            ...
            _billingSubscriptionsRestClient = new BillingSubscriptions(_billingSubscriptionsClientDiagnostics, Pipeline, Endpoint, enrollmentAccountApiVersion ?? "2024-04-01");
            ...
            _billingPermissionsRestClient = new BillingPermissions(_billingPermissionsClientDiagnostics, Pipeline, Endpoint, enrollmentAccountApiVersion ?? "2024-04-01");
        ...
        /// <item>
        /// <term> Resource. </term>
        /// <description> <see cref="EnrollmentAccountResource"/>. </description>
        /// </item>
        /// </list>
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<EnrollmentAccountResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _enrollmentAccountsClientDiagnostics.CreateScope("EnrollmentAccountResource.Get");
            scope.Start();
            try
            {
                ...
                return Response.FromValue(new EnrollmentAccountResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<EnrollmentAccountResource> Get(CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _enrollmentAccountsClientDiagnostics.CreateScope("EnrollmentAccountResource.Get");
            scope.Start();
            try
        ...
        public virtual AsyncPageable<BillingSubscriptionData> GetByEnrollmentAccountAsync(string filter = default, string orderBy = default, long? maxCount = default, long? skip = default, bool? count = default, string search = default, CancellationToken cancellationToken = default)
        {
            ...
            return new BillingSubscriptionsGetByEnrollmentAccountAsyncCollectionResultOfT(
                ...
                search,
                context,
                "EnrollmentAccountResource.GetByEnrollmentAccount");
        }
        ...
        public virtual AsyncPageable<BillingCheckAccessResult> CheckAccessByEnrollmentAccountAsync(BillingCheckAccessContent content, CancellationToken cancellationToken = default)
        {
            ...
            return new MicrosoftBillingEnrollmentAccountOperationGroupCheckAccessByEnrollmentAccountAsyncCollectionResultOfT(
                ...
                context,
                "EnrollmentAccountResource.CheckAccessByEnrollmentAccount");
        }
        ...
        public virtual AsyncPageable<BillingPermission> GetByEnrollmentAccountAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new BillingPermissionsGetByEnrollmentAccountAsyncCollectionResultOfT(_billingPermissionsRestClient, Id.Parent.Name, Id.Name, context, "EnrollmentAccountResource.GetByEnrollmentAccount");
        }
        ...
        public virtual Pageable<BillingPermission> GetByEnrollmentAccount(CancellationToken cancellationToken = default)
        {
            ...
            return new BillingPermissionsGetByEnrollmentAccountCollectionResultOfT(_billingPermissionsRestClient, Id.Parent.Name, Id.Name, context, "EnrollmentAccountResource.GetByEnrollmentAccount");
        }

        /// <summary> Gets a collection of BillingRoleAssignments in the <see cref="EnrollmentAccountResource"/>. </summary>
        ...
        /// <summary> Gets a collection of BillingRoleDefinitions in the <see cref="EnrollmentAccountResource"/>. </summary>
