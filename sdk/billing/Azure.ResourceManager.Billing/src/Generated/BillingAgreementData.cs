...
{
    /// <summary>
    /// A class representing the BillingAgreement data model.
    /// An agreement.
    /// </summary>
    public partial class BillingAgreementData : ResourceData
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="BillingAgreementData"/>. </summary>
        ...
        internal BillingAgreementData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, BillingAgreementProperties properties, IDictionary<string, string> tags, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
        ...
        [WirePath("properties")]
        public BillingAgreementProperties Properties { get; set; }
