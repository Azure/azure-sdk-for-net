...
namespace Azure.ResourceManager.Billing
{
    ...
    public partial class BillingAgreementData : ResourceData
    {
        ...
        internal BillingAgreementData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, BillingAgreementProperties properties, IDictionary<string, string> tags) : base(id, name, resourceType, systemData)
        {
        ...
        /// <summary> An agreement. </summary>
        public BillingAgreementProperties Properties { get; }
