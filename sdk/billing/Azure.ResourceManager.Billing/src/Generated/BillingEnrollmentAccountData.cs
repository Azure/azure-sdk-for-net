...
namespace Azure.ResourceManager.Billing
{
    ...
    public partial class BillingEnrollmentAccountData : ResourceData
    {
        ...
        internal BillingEnrollmentAccountData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, BillingEnrollmentAccountProperties properties, IDictionary<string, string> tags, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, name, resourceType, systemData)
        {
