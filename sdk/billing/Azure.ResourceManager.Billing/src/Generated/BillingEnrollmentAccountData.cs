...
namespace Azure.ResourceManager.Billing
{
    ...
    public partial class BillingEnrollmentAccountData : ResourceData
    {
        ...
        internal BillingEnrollmentAccountData()
        {
        ...
        internal BillingEnrollmentAccountData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, BillingEnrollmentAccountProperties properties, IDictionary<string, string> tags) : base(id, name, resourceType, systemData)
        {
