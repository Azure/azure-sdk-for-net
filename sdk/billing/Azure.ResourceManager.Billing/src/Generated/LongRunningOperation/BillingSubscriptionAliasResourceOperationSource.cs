...
{
    /// <summary></summary>
    internal partial class BillingSubscriptionAliasResourceOperationSource : IOperationSource<BillingSubscriptionAliasResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal BillingSubscriptionAliasResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
        ...
        BillingSubscriptionAliasResource IOperationSource<BillingSubscriptionAliasResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            BillingSubscriptionAliasData data = BillingSubscriptionAliasData.DeserializeBillingSubscriptionAliasData(document.RootElement, ModelSerializationExtensions.WireOptions);
