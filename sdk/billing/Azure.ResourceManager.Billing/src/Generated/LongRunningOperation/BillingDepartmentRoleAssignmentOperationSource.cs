...
{
    /// <summary></summary>
    internal partial class BillingDepartmentRoleAssignmentOperationSource : IOperationSource<BillingDepartmentRoleAssignmentResource>
    {
        ...
        BillingDepartmentRoleAssignmentResource IOperationSource<BillingDepartmentRoleAssignmentResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            BillingDepartmentRoleAssignmentData data = BillingDepartmentRoleAssignmentData.DeserializeBillingDepartmentRoleAssignmentData(document.RootElement, ModelSerializationExtensions.WireOptions);
