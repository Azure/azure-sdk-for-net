...
{
    /// <summary></summary>
    internal partial class BillingProfileResourceOperationSource : IOperationSource<BillingProfileResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal BillingProfileResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
