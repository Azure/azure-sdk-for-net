...
{
    /// <summary></summary>
    internal partial class BillingAccountPolicyResourceOperationSource : IOperationSource<BillingAccountPolicyResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal BillingAccountPolicyResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
