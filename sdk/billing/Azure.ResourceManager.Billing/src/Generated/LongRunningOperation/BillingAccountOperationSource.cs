...
{
    /// <summary></summary>
    internal partial class BillingAccountOperationSource : IOperationSource<BillingAccountResource>
    {
        ...
        BillingAccountResource IOperationSource<BillingAccountResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            BillingAccountData data = BillingAccountData.DeserializeBillingAccountData(document.RootElement, ModelSerializationExtensions.WireOptions);
