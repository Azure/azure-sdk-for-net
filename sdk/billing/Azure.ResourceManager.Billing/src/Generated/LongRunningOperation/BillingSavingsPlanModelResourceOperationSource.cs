...
{
    /// <summary></summary>
    internal partial class BillingSavingsPlanModelResourceOperationSource : IOperationSource<BillingSavingsPlanModelResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal BillingSavingsPlanModelResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
