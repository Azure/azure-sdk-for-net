...
{
    /// <summary></summary>
    internal partial class BillingRequestResourceOperationSource : IOperationSource<BillingRequestResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal BillingRequestResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
