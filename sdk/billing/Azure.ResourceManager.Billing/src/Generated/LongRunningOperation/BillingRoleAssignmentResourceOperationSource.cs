...
{
    /// <summary></summary>
    internal partial class BillingRoleAssignmentResourceOperationSource : IOperationSource<BillingRoleAssignmentResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal BillingRoleAssignmentResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
