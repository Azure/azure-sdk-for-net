...
{
    /// <summary></summary>
    internal partial class BillingAssociatedTenantResourceOperationSource : IOperationSource<BillingAssociatedTenantResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal BillingAssociatedTenantResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
