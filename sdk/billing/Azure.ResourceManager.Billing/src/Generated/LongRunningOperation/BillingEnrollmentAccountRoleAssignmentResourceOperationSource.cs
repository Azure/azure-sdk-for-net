...
{
    /// <summary></summary>
    internal partial class BillingEnrollmentAccountRoleAssignmentResourceOperationSource : IOperationSource<BillingEnrollmentAccountRoleAssignmentResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal BillingEnrollmentAccountRoleAssignmentResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
