...
namespace Azure.ResourceManager.Billing
{
    ...
    public partial class BillingReservationData : TrackedResourceData, IJsonModel<BillingReservationData>
    {
        ...
        /// <param name="response"> The <see cref="Response"/> to deserialize the <see cref="BillingReservationData"/> from. </param>
        internal static BillingReservationData FromResponse(Response response)
        {
            using JsonDocument document = JsonDocument.Parse(response.Content, ModelSerializationExtensions.JsonDocumentOptions);
            return DeserializeBillingReservationData(document.RootElement, ModelSerializationExtensions.WireOptions);
        }
