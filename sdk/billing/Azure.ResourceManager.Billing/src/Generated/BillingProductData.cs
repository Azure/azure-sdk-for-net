...
namespace Azure.ResourceManager.Billing
{
    ...
    public partial class BillingProductData : ResourceData
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="BillingProductData"/>. </summary>
        internal BillingProductData()
        {
        ...
        internal BillingProductData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, BillingProductProperties properties, IDictionary<string, string> tags) : base(id, name, resourceType, systemData)
        {
        ...
        /// <summary> A product. </summary>
        public BillingProductProperties Properties { get; }
