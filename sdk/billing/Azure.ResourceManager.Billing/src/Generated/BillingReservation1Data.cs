...
namespace Azure.ResourceManager.Billing.Models
{
    ...
    public partial class BillingReservation1Data : TrackedResourceData
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="BillingReservation1Data"/>. </summary>
        /// <param name="location"> The geo-location where the resource lives. </param>
        public BillingReservation1Data(AzureLocation location) : base(location)
        {
        }
        ...
        internal BillingReservation1Data(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, ReservationProperty properties, int? eTag, ReservationSkuProperty sku, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, name, resourceType, systemData, tags, location)
        {
        ...
        public DateTimeOffset? ReservationExpiresOn
        {
            get
            {
