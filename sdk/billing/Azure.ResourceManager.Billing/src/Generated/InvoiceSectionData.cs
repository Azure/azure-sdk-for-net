...
{
    /// <summary>
    /// A class representing the InvoiceSection data model.
    /// An invoice section.
    /// </summary>
    public partial class InvoiceSectionData : ResourceData
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="InvoiceSectionData"/>. </summary>
        public InvoiceSectionData()
        {
        ...
        internal InvoiceSectionData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, InvoiceSectionProperties properties, IDictionary<string, string> tags, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
        ...
        public InvoiceSectionProperties Properties { get; set; }
