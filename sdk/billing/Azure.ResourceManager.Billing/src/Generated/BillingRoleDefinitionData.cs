...
namespace Azure.ResourceManager.Billing
{
    ...
    public partial class BillingRoleDefinitionData : ResourceData
    {
        ...
        internal BillingRoleDefinitionData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, BillingRoleDefinitionProperties properties, IDictionary<string, string> tags) : base(id, name, resourceType, systemData)
        {
