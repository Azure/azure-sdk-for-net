...
namespace Azure.ResourceManager.Billing
{
    ...
    public partial class ReservationOrderData : ResourceData
    {
        ...
        internal ReservationOrderData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, int? etag, IDictionary<string, string> tags, string displayName, string enrollmentId, string customerId, string billingProfileId, string billingAccountId, DateTimeOffset? requestOn, DateTimeOffset? createdOn, DateTimeOffset? expireOn, DateTimeOffset? reservationExpireOn, DateTimeOffset? benefitStartOn, int? originalQuantity, string term, string provisioningState, ReservationBillingPlan? billingPlan, ReservationOrderBillingPlanInformation planInformation, IList<ReservationData> reservations, DateTimeOffset? reviewOn, ReservationExtendedStatusInfo extendedStatusInfo, string productCode, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
            ETag = etag;
            Tags = tags;
        ...
        public IList<ReservationData> Reservations { get; }
