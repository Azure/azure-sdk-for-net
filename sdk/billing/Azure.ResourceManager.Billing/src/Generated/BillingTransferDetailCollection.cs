...
namespace Azure.ResourceManager.Billing
{
    ...
    public partial class BillingTransferDetailCollection : ArmCollection, IEnumerable<BillingTransferDetailResource>, IAsyncEnumerable<BillingTransferDetailResource>
    {
        ...
        /// <summary> Initializes a new instance of BillingTransferDetailCollection for mocking. </summary>
        protected BillingTransferDetailCollection()
        {
        }

        /// <summary> Initializes a new instance of <see cref="BillingTransferDetailCollection"/> class. </summary>
        ...
        {
            TryGetApiVersion(BillingTransferDetailResource.ResourceType, out string billingTransferDetailApiVersion);
            _transfersClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Billing", BillingTransferDetailResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<BillingTransferDetailResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string transferName, BillingTransferDetailCreateOrUpdateContent content, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _transfersClientDiagnostics.CreateScope("BillingTransferDetailCollection.CreateOrUpdate");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response<BillingTransferDetailResource>> GetAsync(string transferName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _transfersClientDiagnostics.CreateScope("BillingTransferDetailCollection.Get");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual AsyncPageable<BillingTransferDetailResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<BillingTransferDetailData, BillingTransferDetailResource>(new TransfersGetAllAsyncCollectionResultOfT(
                ...
                Id.Name,
                context,
                "BillingTransferDetailCollection.GetAll"), data => new BillingTransferDetailResource(Client, data));
        }
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string transferName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _transfersClientDiagnostics.CreateScope("BillingTransferDetailCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                Response<BillingTransferDetailData> response = default;
                switch (result.Status)
                {
                    case 200:
                        response = Response.FromValue(BillingTransferDetailData.FromResponse(result), result);
                        break;
                    case 404:
                        response = Response.FromValue((BillingTransferDetailData)null, result);
                        break;
                    default:
        ...
        public virtual async Task<NullableResponse<BillingTransferDetailResource>> GetIfExistsAsync(string transferName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _transfersClientDiagnostics.CreateScope("BillingTransferDetailCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
