...
{
    /// <summary>
    /// A class representing the Reservation data model.
    /// The definition of the reservation.
    /// </summary>
    public partial class ReservationData : TrackedResourceData
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="ReservationData"/>. </summary>
        /// <param name="location"> The location. </param>
        public ReservationData(AzureLocation location) : base(location)
        {
        ...
        internal ReservationData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, int? etag, ReservationSkuProperty sku, string reservedResourceType, InstanceFlexibility? instanceFlexibility, string displayName, IList<string> appliedScopes, string appliedScopeType, bool? archived, string capabilities, float? quantity, string provisioningState, DateTimeOffset? effectiveOn, DateTimeOffset? benefitStartOn, DateTimeOffset? lastUpdatedOn, string expireOn, DateTimeOffset? reservationExpireOn, DateTimeOffset? reviewOn, string skuDescription, ReservationExtendedStatusInfo extendedStatusInfo, ReservationBillingPlan? billingPlan, string displayProvisioningState, string provisioningSubState, DateTimeOffset? purchaseOn, DateTimeOffset? reservationPurchaseOn, ReservationSplitProperties splitProperties, ReservationMergeProperties mergeProperties, ReservationSwapProperties swapProperties, ReservationAppliedScopeProperties appliedScopeProperties, string billingScopeId, bool? renew, string renewSource, string renewDestination, RenewPropertiesResponse renewProperties, string term, string userFriendlyAppliedScopeType, string userFriendlyRenewState, string productCode, string trend, IList<ReservationUtilizationAggregates> aggregates, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData, tags, location)
        {
            ETag = etag;
            Sku = sku;
        ...
        /// <summary> Initializes a new instance of <see cref="ReservationData"/> for deserialization. </summary>
