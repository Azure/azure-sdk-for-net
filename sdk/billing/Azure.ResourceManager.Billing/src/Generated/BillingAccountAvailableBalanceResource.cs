...
namespace Azure.ResourceManager.Billing
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="BillingAccountAvailableBalanceResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    ...
    public partial class BillingAccountAvailableBalanceResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of BillingAccountAvailableBalanceResource for mocking. </summary>
        protected BillingAccountAvailableBalanceResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="BillingAccountAvailableBalanceResource"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="data"> The resource that is the target of operations. </param>
        internal BillingAccountAvailableBalanceResource(ArmClient client, BillingAvailableBalanceData data) : this(client, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        {
            TryGetApiVersion(ResourceType, out string billingAccountAvailableBalanceApiVersion);
            ...
            _availableBalancesRestClient = new AvailableBalances(_availableBalancesClientDiagnostics, Pipeline, Endpoint, billingAccountAvailableBalanceApiVersion ?? "2024-04-01");
        ...
        {
            using DiagnosticScope scope = _availableBalancesClientDiagnostics.CreateScope("BillingAccountAvailableBalanceResource.Get");
            scope.Start();
            try
            {
