...
namespace Azure.ResourceManager.Billing.Mocking
{
    ...
    internal partial class BillingTenantMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="BillingTenantMockingExtension"/> class for mocking. </summary>
        protected BillingTenantMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="BillingTenantMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal BillingTenantMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
