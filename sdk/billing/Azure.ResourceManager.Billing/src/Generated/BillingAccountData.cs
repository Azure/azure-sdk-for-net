...
namespace Azure.ResourceManager.Billing
{
    ...
    public partial class BillingAccountData : ResourceData
    {
        ...
        internal BillingAccountData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, BillingAccountProperties properties, IDictionary<string, string> tags) : base(id, name, resourceType, systemData)
        {
        ...
        /// <summary> A billing account. </summary>
        public BillingAccountProperties Properties { get; }
