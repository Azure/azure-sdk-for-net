...
namespace Azure.ResourceManager.Billing
{
    ...
    public partial class BillingAccountData : ResourceData
    {
        ...
        internal BillingAccountData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, BillingAccountProperties properties, IDictionary<string, string> tags, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
