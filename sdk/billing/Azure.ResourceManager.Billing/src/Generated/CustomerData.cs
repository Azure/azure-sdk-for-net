...
{
    /// <summary>
    /// A class representing the Customer data model.
    /// A partner's customer.
    /// </summary>
    public partial class CustomerData : ResourceData
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="CustomerData"/>. </summary>
        public CustomerData()
        {
        ...
        internal CustomerData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, CustomerProperties properties, IDictionary<string, string> tags, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
