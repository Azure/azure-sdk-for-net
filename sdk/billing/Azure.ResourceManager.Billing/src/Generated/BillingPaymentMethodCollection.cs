...
namespace Azure.ResourceManager.Billing
{
    ...
    /// Each <see cref="BillingPaymentMethodResource"/> in the collection will belong to the same instance of <see cref="BillingAccountResource"/>.
    /// To get a <see cref="BillingPaymentMethodCollection"/> instance call the GetBillingPaymentMethods method from an instance of <see cref="BillingAccountResource"/>.
    /// </summary>
    public partial class BillingPaymentMethodCollection : ArmCollection, IEnumerable<BillingPaymentMethodResource>, IAsyncEnumerable<BillingPaymentMethodResource>
    {
        ...
        public virtual AsyncPageable<BillingPaymentMethodResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<BillingPaymentMethodData, BillingPaymentMethodResource>(new PaymentMethodsGetByBillingAccountAsyncCollectionResultOfT(_paymentMethodsRestClient, Id.Name, context, "BillingPaymentMethodCollection.GetAll"), data => new BillingPaymentMethodResource(Client, data));
        }
        ...
        public virtual Pageable<BillingPaymentMethodResource> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            return new PageableWrapper<BillingPaymentMethodData, BillingPaymentMethodResource>(new PaymentMethodsGetByBillingAccountCollectionResultOfT(_paymentMethodsRestClient, Id.Name, context, "BillingPaymentMethodCollection.GetAll"), data => new BillingPaymentMethodResource(Client, data));
        }
