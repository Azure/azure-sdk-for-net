...
namespace Azure.ResourceManager.Billing
{
    ...
    public partial class BillingProfileData : ResourceData
    {
        ...
        internal BillingProfileData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, BillingProfileProperties properties, IDictionary<string, string> tags) : base(id, name, resourceType, systemData)
        {
