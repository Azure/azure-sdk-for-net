...
namespace Azure.ResourceManager.Billing
{
    ...
    public partial class BillingProfileRoleDefinitionCollection : ArmCollection, IEnumerable<BillingProfileRoleDefinitionResource>, IAsyncEnumerable<BillingProfileRoleDefinitionResource>
    {
        ...
        /// <summary> Initializes a new instance of BillingProfileRoleDefinitionCollection for mocking. </summary>
        protected BillingProfileRoleDefinitionCollection()
        {
        }

        /// <summary> Initializes a new instance of <see cref="BillingProfileRoleDefinitionCollection"/> class. </summary>
        ...
        {
            TryGetApiVersion(BillingProfileRoleDefinitionResource.ResourceType, out string billingProfileRoleDefinitionApiVersion);
            _billingRoleDefinitionClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Billing", BillingProfileRoleDefinitionResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<Response<BillingProfileRoleDefinitionResource>> GetAsync(string roleDefinitionName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _billingRoleDefinitionClientDiagnostics.CreateScope("BillingProfileRoleDefinitionCollection.Get");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string roleDefinitionName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _billingRoleDefinitionClientDiagnostics.CreateScope("BillingProfileRoleDefinitionCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual async Task<NullableResponse<BillingProfileRoleDefinitionResource>> GetIfExistsAsync(string roleDefinitionName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _billingRoleDefinitionClientDiagnostics.CreateScope("BillingProfileRoleDefinitionCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
