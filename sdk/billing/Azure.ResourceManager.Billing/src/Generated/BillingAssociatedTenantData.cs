...
{
    /// <summary>
    /// A class representing the BillingAssociatedTenant data model.
    /// An associated tenant.
    /// </summary>
    public partial class BillingAssociatedTenantData : ResourceData
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="BillingAssociatedTenantData"/>. </summary>
        ...
        internal BillingAssociatedTenantData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, BillingAssociatedTenantProperties properties, IDictionary<string, string> tags, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
        ...
        [WirePath("properties")]
        public BillingAssociatedTenantProperties Properties { get; set; }
