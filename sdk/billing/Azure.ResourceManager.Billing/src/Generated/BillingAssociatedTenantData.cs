...
namespace Azure.ResourceManager.Billing
{
    ...
    public partial class BillingAssociatedTenantData : ResourceData
    {
        ...
        internal BillingAssociatedTenantData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, BillingAssociatedTenantProperties properties, IDictionary<string, string> tags) : base(id, name, resourceType, systemData)
        {
