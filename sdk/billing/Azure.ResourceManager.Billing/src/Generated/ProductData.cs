...
namespace Azure.ResourceManager.Billing
{
    ...
    public partial class ProductData : ResourceData
    {
        ...
        internal ProductData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, ProductProperties properties, IDictionary<string, string> tags, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
