...
{
    /// <summary>
    /// A class representing the Invoice data model.
    /// An invoice.
    /// </summary>
    public partial class InvoiceData : ResourceData
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="InvoiceData"/>. </summary>
        public InvoiceData()
        {
        ...
        internal InvoiceData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, InvoiceProperties properties, IDictionary<string, string> tags, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
