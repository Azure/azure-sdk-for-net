...
namespace Azure.ResourceManager.Billing
{
    ...
    /// Otherwise you can get one from its parent resource <see cref="BillingAccountResource"/> using the GetBillingSubscriptionAlias method.
    /// </summary>
    public partial class BillingSubscriptionAliasResource : ArmResource
    {
        ...
        public virtual async Task<Response<BillingSubscriptionAliasResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _billingSubscriptionAliasBillingSubscriptionsAliasesClientDiagnostics.CreateScope("BillingSubscriptionAliasResource.AddTag");
            scope.Start();
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
                {
                    ...
                    var originalResponse = await _billingSubscriptionAliasBillingSubscriptionsAliasesRestClient.GetAsync(Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
                    return Response.FromValue(new BillingSubscriptionAliasResource(Client, originalResponse.Value), originalResponse.GetRawResponse());
                }
                else
                {
        ...
        public virtual Response<BillingSubscriptionAliasResource> AddTag(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                if (CanUseTagResource(cancellationToken: cancellationToken))
                {
                    ...
                    var originalResponse = _billingSubscriptionAliasBillingSubscriptionsAliasesRestClient.Get(Id.Parent.Name, Id.Name, cancellationToken);
                    return Response.FromValue(new BillingSubscriptionAliasResource(Client, originalResponse.Value), originalResponse.GetRawResponse());
                }
                else
                {
        ...
        public virtual async Task<Response<BillingSubscriptionAliasResource>> SetTagsAsync(IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _billingSubscriptionAliasBillingSubscriptionsAliasesClientDiagnostics.CreateScope("BillingSubscriptionAliasResource.SetTags");
            scope.Start();
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
        ...
        public virtual async Task<Response<BillingSubscriptionAliasResource>> RemoveTagAsync(string key, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _billingSubscriptionAliasBillingSubscriptionsAliasesClientDiagnostics.CreateScope("BillingSubscriptionAliasResource.RemoveTag");
            scope.Start();
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
