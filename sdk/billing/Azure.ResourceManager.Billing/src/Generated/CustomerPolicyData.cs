...
{
    /// <summary>
    /// A class representing the CustomerPolicy data model.
    /// A policy at customer scope.
    /// </summary>
    public partial class CustomerPolicyData : ResourceData
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="CustomerPolicyData"/>. </summary>
        ...
        internal CustomerPolicyData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, CustomerPolicyProperties properties, IDictionary<string, string> tags, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
        ...
        public CustomerPolicyProperties Properties { get; set; }
