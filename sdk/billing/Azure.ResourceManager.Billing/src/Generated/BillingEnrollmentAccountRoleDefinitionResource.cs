...
namespace Azure.ResourceManager.Billing
{
    ...
    /// Otherwise you can get one from its parent resource <see cref="BillingEnrollmentAccountResource"/> using the GetBillingEnrollmentAccountRoleDefinitions method.
    /// </summary>
    public partial class BillingEnrollmentAccountRoleDefinitionResource : ArmResource
    {
        ...
        internal BillingEnrollmentAccountRoleDefinitionResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _billingRoleDefinitionRestClient = new BillingRoleDefinition(_billingRoleDefinitionClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, billingEnrollmentAccountRoleDefinitionApiVersion ?? "2024-04-01");
