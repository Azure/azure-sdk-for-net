...
namespace Azure.ResourceManager.Billing
{
    ...
    public partial class BillingProfileResource : ArmResource
    {
        ...
        internal BillingProfileResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _billingProfilesRestClient = new BillingProfiles(_billingProfilesClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, billingProfileApiVersion ?? "2024-04-01");
            ...
            _availableBalancesRestClient = new AvailableBalances(_availableBalancesClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, billingProfileApiVersion ?? "2024-04-01");
            _billingRequestsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Billing", ResourceType.Namespace, Diagnostics);
            _billingRequestsRestClient = new BillingRequests(_billingRequestsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, billingProfileApiVersion ?? "2024-04-01");
            ...
            _billingRoleAssignmentsRestClient = new BillingRoleAssignments(_billingRoleAssignmentsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, billingProfileApiVersion ?? "2024-04-01");
            _invoicesClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Billing", ResourceType.Namespace, Diagnostics);
            _invoicesRestClient = new Invoices(_invoicesClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, billingProfileApiVersion ?? "2024-04-01");
            _productsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Billing", ResourceType.Namespace, Diagnostics);
            _productsRestClient = new Products(_productsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, billingProfileApiVersion ?? "2024-04-01");
            _reservationsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Billing", ResourceType.Namespace, Diagnostics);
            _reservationsRestClient = new Reservations(_reservationsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, billingProfileApiVersion ?? "2024-04-01");
            _transactionsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Billing", ResourceType.Namespace, Diagnostics);
            _transactionsRestClient = new Transactions(_transactionsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, billingProfileApiVersion ?? "2024-04-01");
        ...
        public virtual AsyncPageable<BillingCheckAccessResult> CheckAccessBillingPermissionsAsync(BillingCheckAccessContent content, CancellationToken cancellationToken = default)
        {
            ...
            return new MicrosoftBillingBillingProfilesCheckAccessByBillingProfileAsyncCollectionResultOfT(
                ...
                context,
                "BillingProfileResource.CheckAccessBillingPermissions");
        }
        ...
        public virtual async Task<ArmOperation<BillingRoleAssignmentData>> CreateByBillingProfileBillingRoleAssignmentAsync(WaitUntil waitUntil, BillingRoleAssignmentProperties billingRoleAssignmentProperties, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _billingRoleAssignmentsClientDiagnostics.CreateScope("BillingProfileResource.CreateByBillingProfileBillingRoleAssignment");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _billingRoleAssignmentsRestClient.CreateCreateByBillingProfileBillingRoleAssignmentRequest(Id.Parent.Name, Id.Name, BillingRoleAssignmentProperties.ToRequestContent(billingRoleAssignmentProperties), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        public virtual AsyncPageable<BillingInvoiceData> GetByBillingProfileAsync(DateTimeOffset? periodStartOn = default, DateTimeOffset? periodEndOn = default, string filter = default, string orderBy = default, long? maxCount = default, long? skip = default, bool? count = default, string search = default, CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> A collection of <see cref="BillingInvoiceData"/> that may take multiple service requests to iterate over. </returns>
        public virtual Pageable<BillingInvoiceData> GetByBillingProfile(DateTimeOffset? periodStartOn = default, DateTimeOffset? periodEndOn = default, string filter = default, string orderBy = default, long? maxCount = default, long? skip = default, bool? count = default, string search = default, CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
        ...
        /// <param name="filter"> The filter query option allows clients to filter a collection of resources that are addressed by a request URL. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<ArmOperation<BillingRoleAssignmentListResult>> ResolveByBillingProfileBillingRoleAssignmentAsync(WaitUntil waitUntil, bool? resolveScopeDisplayNames = default, string filter = default, CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _billingRoleAssignmentsClientDiagnostics.CreateScope("BillingProfileResource.ResolveByBillingProfileBillingRoleAssignment");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _billingRoleAssignmentsRestClient.CreateResolveByBillingProfileBillingRoleAssignmentRequest(Id.Parent.Name, Id.Name, resolveScopeDisplayNames, filter, context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        /// <param name="filter"> The filter query option allows clients to filter a collection of resources that are addressed by a request URL. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual ArmOperation<BillingRoleAssignmentListResult> ResolveByBillingProfileBillingRoleAssignment(WaitUntil waitUntil, bool? resolveScopeDisplayNames = default, string filter = default, CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _billingRoleAssignmentsClientDiagnostics.CreateScope("BillingProfileResource.ResolveByBillingProfileBillingRoleAssignment");
            scope.Start();
            try
        ...
        public virtual AsyncPageable<BillingTransactionData> GetByBillingProfileAsync(DateTimeOffset periodStartOn, DateTimeOffset periodEndOn, TransactionType @type, string filter = default, string orderBy = default, long? maxCount = default, long? skip = default, bool? count = default, string search = default, CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> A collection of <see cref="BillingTransactionData"/> that may take multiple service requests to iterate over. </returns>
        public virtual Pageable<BillingTransactionData> GetByBillingProfile(DateTimeOffset periodStartOn, DateTimeOffset periodEndOn, TransactionType @type, string filter = default, string orderBy = default, long? maxCount = default, long? skip = default, bool? count = default, string search = default, CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
