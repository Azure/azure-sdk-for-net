...
namespace Azure.ResourceManager.Billing
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BillingPaymentMethodLinkData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<BillingPaymentMethodLinkData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BillingPaymentMethodLinkData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<BillingPaymentMethodLinkData>)} interface");
            }
        ...
        string IPersistableModel<BillingPaymentMethodLinkData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
