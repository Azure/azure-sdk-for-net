...
{
    public partial class EnrollmentDetails : IUtf8JsonSerializable, IJsonModel<EnrollmentDetails>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EnrollmentDetails>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<EnrollmentDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<EnrollmentDetails>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(EnrollmentDetails)} does not support writing '{format}' format.");
            }
        ...
        EnrollmentDetails IJsonModel<EnrollmentDetails>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<EnrollmentDetails>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(EnrollmentDetails)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeEnrollmentDetails(document.RootElement, options);
        }

        internal static EnrollmentDetails DeserializeEnrollmentDetails(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            SupportLevel? supportLevel = default;
            string supportCoverage = default;
            string cloud = default;
            string poNumber = default;
            MarkupStatus? markupStatus = default;
            EnrollmentDetailsIndirectRelationshipInfo indirectRelationshipInfo = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("supportLevel"u8))
                {
                    ...
                    supportLevel = new SupportLevel(property.Value.GetString());
                    continue;
                }
                ...
                if (property.NameEquals("markupStatus"u8))
                {
                    ...
                    markupStatus = new MarkupStatus(property.Value.GetString());
                    continue;
                }
                if (property.NameEquals("indirectRelationshipInfo"u8))
                {
                    ...
                    indirectRelationshipInfo = EnrollmentDetailsIndirectRelationshipInfo.DeserializeEnrollmentDetailsIndirectRelationshipInfo(property.Value, options);
                    continue;
                }
        ...
        BinaryData IPersistableModel<EnrollmentDetails>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<EnrollmentDetails>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(EnrollmentDetails)} does not support writing '{options.Format}' format.");
            }
        }

        EnrollmentDetails IPersistableModel<EnrollmentDetails>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<EnrollmentDetails>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(EnrollmentDetails)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<EnrollmentDetails>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
