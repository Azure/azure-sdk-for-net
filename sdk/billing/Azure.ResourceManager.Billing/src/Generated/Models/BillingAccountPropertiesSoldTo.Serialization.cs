...
{
    public partial class BillingAccountPropertiesSoldTo : IUtf8JsonSerializable, IJsonModel<BillingAccountPropertiesSoldTo>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BillingAccountPropertiesSoldTo>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<BillingAccountPropertiesSoldTo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<BillingAccountPropertiesSoldTo>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(BillingAccountPropertiesSoldTo)} does not support writing '{format}' format.");
            }
        ...
        BillingAccountPropertiesSoldTo IJsonModel<BillingAccountPropertiesSoldTo>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<BillingAccountPropertiesSoldTo>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(BillingAccountPropertiesSoldTo)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeBillingAccountPropertiesSoldTo(document.RootElement, options);
        }

        internal static BillingAccountPropertiesSoldTo DeserializeBillingAccountPropertiesSoldTo(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<BillingAccountPropertiesSoldTo>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<BillingAccountPropertiesSoldTo>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(BillingAccountPropertiesSoldTo)} does not support writing '{options.Format}' format.");
            }
        }

        BillingAccountPropertiesSoldTo IPersistableModel<BillingAccountPropertiesSoldTo>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<BillingAccountPropertiesSoldTo>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(BillingAccountPropertiesSoldTo)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<BillingAccountPropertiesSoldTo>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
