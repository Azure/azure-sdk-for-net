...
namespace Azure.ResourceManager.Billing.Models
{
    ...
    public partial class BillingProfilePropertiesShipTo : BillingAddressDetails, IJsonModel<BillingProfilePropertiesShipTo>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<BillingProfilePropertiesShipTo>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<BillingProfilePropertiesShipTo>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        BillingProfilePropertiesShipTo IPersistableModel<BillingProfilePropertiesShipTo>.Create(BinaryData data, ModelReaderWriterOptions options) => (BillingProfilePropertiesShipTo)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BillingProfilePropertiesShipTo IJsonModel<BillingProfilePropertiesShipTo>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (BillingProfilePropertiesShipTo)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static BillingProfilePropertiesShipTo DeserializeBillingProfilePropertiesShipTo(JsonElement element, ModelReaderWriterOptions options)
        {
