...
namespace Azure.ResourceManager.Billing.Models
{
    ...
    public partial class ValidateTransferResponse
    {
        ...
        /// <summary> Initializes a new instance of <see cref="ValidateTransferResponse"/>. </summary>
        internal ValidateTransferResponse()
        {
            Results = new ChangeTrackingList<ValidationResultProperties>();
        }
        ...
        internal ValidateTransferResponse(string status, string productId, IReadOnlyList<ValidationResultProperties> results, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Status = status;
            ProductId = productId;
            Results = results;
        ...
        public IReadOnlyList<ValidationResultProperties> Results { get; }
    }
}
