...
namespace Azure.ResourceManager.Billing.Models
{
    ...
    public partial class BillingSubscriptionSplitContent
    {
        ...
        internal BillingSubscriptionSplitContent(string billingFrequency, int? quantity, string targetProductTypeId, string targetSkuId, TimeSpan? termDuration, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
