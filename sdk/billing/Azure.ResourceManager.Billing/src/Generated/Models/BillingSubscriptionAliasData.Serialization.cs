...
namespace Azure.ResourceManager.Billing
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BillingSubscriptionAliasData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<BillingSubscriptionAliasData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BillingSubscriptionAliasData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<BillingSubscriptionAliasData>)} interface");
            }
        ...
        string IPersistableModel<BillingSubscriptionAliasData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
