...
namespace Azure.ResourceManager.Billing.Models
{
    ...
    public partial class SavingsPlanSummaryCount
    {
        ...
        internal SavingsPlanSummaryCount(float? succeededCount, float? failedCount, float? expiringCount, float? expiredCount, float? pendingCount, float? cancelledCount, float? processingCount, float? noBenefitCount, float? warningCount, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
