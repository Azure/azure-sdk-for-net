...
namespace Azure.ResourceManager.Billing.Models
{
    ...
    public partial class BillingSubscriptionValidateMoveEligibilityError
    {
        ...
        internal BillingSubscriptionValidateMoveEligibilityError(SubscriptionTransferValidationErrorCode? code, string message, string details, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Code = code;
            Message = message;
            Details = details;
