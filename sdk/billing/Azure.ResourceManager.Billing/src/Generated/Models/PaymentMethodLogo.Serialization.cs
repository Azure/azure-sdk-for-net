...
namespace Azure.ResourceManager.Billing.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PaymentMethodLogo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PaymentMethodLogo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PaymentMethodLogo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<PaymentMethodLogo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
