...
namespace Azure.ResourceManager.Billing.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PaymentMethodLogo>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(MimeType), out propertyOverride);
            ...
            else
            {
                ...
                {
                    builder.Append("  mimeType: ");
                    if (MimeType.Contains(Environment.NewLine))
                    {
                        builder.AppendLine("'''");
                        builder.AppendLine($"{MimeType}'''");
                    }
                    else
                    {
                        builder.AppendLine($"'{MimeType}'");
