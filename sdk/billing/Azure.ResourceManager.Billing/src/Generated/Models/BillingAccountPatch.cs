...
namespace Azure.ResourceManager.Billing.Models
{
    ...
    public partial class BillingAccountPatch : ProxyResourceWithTags
    {
        ...
        internal BillingAccountPatch(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, IDictionary<string, string> tags, BillingAccountProperties properties) : base(id, name, resourceType, systemData, additionalBinaryDataProperties, tags)
        {
