...
namespace Azure.ResourceManager.Billing.Models
{
    ...
    public partial class BillingAccountPatch : ResourceData
    {
        ...
        internal BillingAccountPatch(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, BillingAccountProperties properties, IDictionary<string, string> tags, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
