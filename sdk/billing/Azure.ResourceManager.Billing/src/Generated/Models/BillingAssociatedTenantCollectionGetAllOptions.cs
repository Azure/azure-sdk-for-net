...
{
    /// <summary> The BillingAssociatedTenantCollectionGetAllOptions. </summary>
    public partial class BillingAssociatedTenantCollectionGetAllOptions
    {
        /// <summary> Initializes a new instance of <see cref="BillingAssociatedTenantCollectionGetAllOptions"/>. </summary>
        public BillingAssociatedTenantCollectionGetAllOptions()
        {
        }

        /// <summary> Can be used to get revoked associated tenants. </summary>
        [WirePath("includeRevoked")]
