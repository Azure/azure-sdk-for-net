...
{
    /// <summary> The BillingAccountCustomerCollectionGetAllOptions. </summary>
    public partial class BillingAccountCustomerCollectionGetAllOptions
    {
        /// <summary> Initializes a new instance of <see cref="BillingAccountCustomerCollectionGetAllOptions"/>. </summary>
        public BillingAccountCustomerCollectionGetAllOptions()
        {
        }

        /// <summary> May be used to expand enabledAzurePlans and resellers. </summary>
