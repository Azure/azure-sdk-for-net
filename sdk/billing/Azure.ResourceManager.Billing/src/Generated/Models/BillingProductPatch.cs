...
namespace Azure.ResourceManager.Billing.Models
{
    ...
    public partial class BillingProductPatch : ProxyResourceWithTags
    {
        ...
        internal BillingProductPatch(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, IDictionary<string, string> tags, BillingProductProperties properties) : base(id, name, resourceType, systemData, additionalBinaryDataProperties, tags)
        {
