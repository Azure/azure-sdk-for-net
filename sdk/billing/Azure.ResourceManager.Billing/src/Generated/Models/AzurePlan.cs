...
namespace Azure.ResourceManager.Billing.Models
{
    ...
    public partial class AzurePlan
    {
        ...
        /// <summary> Initializes a new instance of <see cref="AzurePlan"/>. </summary>
        public AzurePlan()
        {
        }
        ...
        internal AzurePlan(string productId, string skuId, string skuDescription, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ProductId = productId;
            SkuId = skuId;
