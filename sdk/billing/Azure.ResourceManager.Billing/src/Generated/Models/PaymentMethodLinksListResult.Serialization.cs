...
namespace Azure.ResourceManager.Billing.Models
{
    ...
    {
        internal static PaymentMethodLinksListResult DeserializePaymentMethodLinksListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
