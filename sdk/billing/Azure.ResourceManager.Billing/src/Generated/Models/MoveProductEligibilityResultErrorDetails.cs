...
namespace Azure.ResourceManager.Billing.Models
{
    ...
    public partial class MoveProductEligibilityResultErrorDetails : MoveProductErrorDetails
    {
        ...
        internal MoveProductEligibilityResultErrorDetails(MoveValidationErrorCode? code, string message, string details, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(code, message, details, additionalBinaryDataProperties)
        {
        }
    }
}
