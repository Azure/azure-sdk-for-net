...
namespace Azure.ResourceManager.Billing.Models
{
    ...
    public partial class BillingSubscriptionPatch : ResourceData, IJsonModel<BillingSubscriptionPatch>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<BillingSubscriptionPatch>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        BillingSubscriptionPatch IPersistableModel<BillingSubscriptionPatch>.Create(BinaryData data, ModelReaderWriterOptions options) => (BillingSubscriptionPatch)PersistableModelCreateCore(data, options);

        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<BillingSubscriptionPatch>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";

        /// <param name="billingSubscriptionPatch"> The <see cref="BillingSubscriptionPatch"/> to serialize into <see cref="RequestContent"/>. </param>
        internal static RequestContent ToRequestContent(BillingSubscriptionPatch billingSubscriptionPatch)
        {
            if (billingSubscriptionPatch == null)
            {
                return null;
            }
            return RequestContent.Create(billingSubscriptionPatch, ModelSerializationExtensions.WireOptions);
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BillingSubscriptionPatch IJsonModel<BillingSubscriptionPatch>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (BillingSubscriptionPatch)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static BillingSubscriptionPatch DeserializeBillingSubscriptionPatch(JsonElement element, ModelReaderWriterOptions options)
        {
