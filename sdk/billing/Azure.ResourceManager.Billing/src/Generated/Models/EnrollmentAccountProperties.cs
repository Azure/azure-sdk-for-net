...
namespace Azure.ResourceManager.Billing.Models
{
    ...
    public partial class EnrollmentAccountProperties
    {
        ...
        /// <summary> Initializes a new instance of <see cref="EnrollmentAccountProperties"/>. </summary>
        ...
        internal EnrollmentAccountProperties(string costCenter, string displayName, string departmentDisplayName, string departmentId, bool? isDevTestEnabled, string accountOwner, string authType, string status, DateTimeOffset? startOn, DateTimeOffset? endOn, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
