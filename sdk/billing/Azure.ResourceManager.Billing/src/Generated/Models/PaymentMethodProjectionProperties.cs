...
namespace Azure.ResourceManager.Billing.Models
{
    ...
    public partial class PaymentMethodProjectionProperties
    {
        ...
        internal PaymentMethodProjectionProperties(ResourceIdentifier paymentMethodId, PaymentMethodFamily? family, string paymentMethodProjectionPropertiesType, string accountHolderName, string expiration, string lastFourDigits, string displayName, IList<PaymentMethodLogo> logos, PaymentMethodStatus? status, Dictionary<string, BinaryData> rawData)
        {
