        ...
        internal static SavingsPlanModelProperties DeserializeSavingsPlanModelProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("term"u8))
                {
                    ...
                    term = new BillingSavingsPlanTerm(prop.Value.GetString());
                    continue;
                }
                ...
                if (prop.NameEquals("renewProperties"u8))
                {
                    ...
                    renewProperties = BillingRenewProperties.DeserializeBillingRenewProperties(prop.Value, options);
                    continue;
                }
                ...
                if (prop.NameEquals("appliedScopeProperties"u8))
                {
                    ...
                    appliedScopeProperties = BillingAppliedScopeProperties.DeserializeBillingAppliedScopeProperties(prop.Value, options);
                    continue;
                }
                if (prop.NameEquals("commitment"u8))
                {
                    ...
                    commitment = BillingBenefitCommitment.DeserializeBillingBenefitCommitment(prop.Value, options);
                    continue;
                }
                ...
                if (prop.NameEquals("utilization"u8))
                {
                    ...
                    utilization = SavingsPlanUtilization.DeserializeSavingsPlanUtilization(prop.Value, options);
                    continue;
                }
