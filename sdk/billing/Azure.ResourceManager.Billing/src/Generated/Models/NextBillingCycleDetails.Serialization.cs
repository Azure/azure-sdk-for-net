...
namespace Azure.ResourceManager.Billing.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NextBillingCycleDetails>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NextBillingCycleDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NextBillingCycleDetails>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<NextBillingCycleDetails>)} interface");
            }
        ...
        string IPersistableModel<NextBillingCycleDetails>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
