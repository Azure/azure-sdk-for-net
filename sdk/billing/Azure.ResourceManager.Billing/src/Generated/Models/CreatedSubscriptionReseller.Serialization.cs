...
namespace Azure.ResourceManager.Billing.Models
{
    ...
    {
        internal static CreatedSubscriptionReseller DeserializeCreatedSubscriptionReseller(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
