...
namespace Azure.ResourceManager.Billing.Models
{
    ...
    public partial class BillingProfilePropertiesIndirectRelationshipInfo : IndirectRelationshipInfo
    {
        ...
        internal BillingProfilePropertiesIndirectRelationshipInfo(string billingAccountName, string billingProfileName, string displayName, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(billingAccountName, billingProfileName, displayName, additionalBinaryDataProperties)
        {
        }
    }
}
