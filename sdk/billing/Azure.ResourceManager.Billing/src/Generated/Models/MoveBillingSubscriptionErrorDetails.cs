...
namespace Azure.ResourceManager.Billing.Models
{
    ...
    public partial class MoveBillingSubscriptionErrorDetails
    {
        ...
        /// <summary> Initializes a new instance of <see cref="MoveBillingSubscriptionErrorDetails"/>. </summary>
        ...
        internal MoveBillingSubscriptionErrorDetails(SubscriptionTransferValidationErrorCode? code, string message, string details, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Code = code;
            Message = message;
            Details = details;
