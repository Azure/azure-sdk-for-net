...
namespace Azure.ResourceManager.Billing
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BillingPaymentMethodData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<BillingPaymentMethodData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BillingPaymentMethodData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<BillingPaymentMethodData>)} interface");
            }
        ...
        string IPersistableModel<BillingPaymentMethodData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
