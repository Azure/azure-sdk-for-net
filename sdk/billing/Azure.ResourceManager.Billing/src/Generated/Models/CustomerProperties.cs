...
namespace Azure.ResourceManager.Billing.Models
{
    ...
    public partial class CustomerProperties
    {
        ...
        /// <summary> Initializes a new instance of <see cref="CustomerProperties"/>. </summary>
        ...
        internal CustomerProperties(string billingProfileDisplayName, string billingProfileId, string displayName, string systemId, CustomerStatus? status, IList<AzurePlan> enabledAzurePlans, IList<CreatedSubscriptionReseller> resellers, IDictionary<string, string> tags, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
