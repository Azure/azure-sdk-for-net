...
namespace Azure.ResourceManager.Billing.Models
{
    ...
    public partial class Transaction : ResourceData
    {
        /// <summary>
        ...
        internal Transaction(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, TransactionProperties properties, IDictionary<string, string> tags, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
        ...
        /// <summary> A transaction. </summary>
        public TransactionProperties Properties { get; set; }
