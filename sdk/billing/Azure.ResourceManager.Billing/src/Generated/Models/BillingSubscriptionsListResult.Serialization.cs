...
namespace Azure.ResourceManager.Billing.Models
{
    ...
    {
        internal static BillingSubscriptionsListResult DeserializeBillingSubscriptionsListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
