...
{
    public partial class SavingsPlanValidateResponse : IUtf8JsonSerializable, IJsonModel<SavingsPlanValidateResponse>
    {
        ...
        internal static SavingsPlanValidateResponse DeserializeSavingsPlanValidateResponse(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new SavingsPlanValidateResponse(benefits ?? new ChangeTrackingList<SavingsPlanValidResponseProperty>(), nextLink, serializedAdditionalRawData);
        }
