...
namespace Azure.ResourceManager.Billing.Models
{
    ...
    {
        internal static PaymentMethodsListResult DeserializePaymentMethodsListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
