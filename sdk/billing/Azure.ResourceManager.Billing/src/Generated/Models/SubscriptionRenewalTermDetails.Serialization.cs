...
namespace Azure.ResourceManager.Billing.Models
{
    ...
    {
        internal static SubscriptionRenewalTermDetails DeserializeSubscriptionRenewalTermDetails(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
