...
namespace Azure.ResourceManager.Billing
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BillingSubscriptionData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<BillingSubscriptionData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BillingSubscriptionData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<BillingSubscriptionData>)} interface");
            }
        ...
        string IPersistableModel<BillingSubscriptionData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
