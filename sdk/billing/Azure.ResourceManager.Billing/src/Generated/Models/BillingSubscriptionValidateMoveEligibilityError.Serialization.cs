...
namespace Azure.ResourceManager.Billing.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BillingSubscriptionValidateMoveEligibilityError>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<BillingSubscriptionValidateMoveEligibilityError>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<BillingSubscriptionValidateMoveEligibilityError>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
