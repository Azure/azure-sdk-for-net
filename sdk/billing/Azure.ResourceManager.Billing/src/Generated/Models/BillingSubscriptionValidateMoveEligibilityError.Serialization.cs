...
namespace Azure.ResourceManager.Billing.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BillingSubscriptionValidateMoveEligibilityError>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        BillingSubscriptionValidateMoveEligibilityError IJsonModel<BillingSubscriptionValidateMoveEligibilityError>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<BillingSubscriptionValidateMoveEligibilityError>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        BillingSubscriptionValidateMoveEligibilityError IModel<BillingSubscriptionValidateMoveEligibilityError>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<BillingSubscriptionValidateMoveEligibilityError>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
