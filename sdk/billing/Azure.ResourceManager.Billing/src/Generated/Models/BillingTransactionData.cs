...
namespace Azure.ResourceManager.Billing.Models
{
    ...
    public partial class BillingTransactionData : ResourceData
    {
        ...
        internal BillingTransactionData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, BillingTransactionProperties properties, IDictionary<string, string> tags, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, name, resourceType, systemData)
        {
