...
namespace Azure.ResourceManager.Billing.Models
{
    ...
    public partial class BillingTransactionData : ResourceData
    {
        ...
        internal BillingTransactionData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, BillingTransactionProperties properties, IDictionary<string, string> tags) : base(id, name, resourceType, systemData)
        {
