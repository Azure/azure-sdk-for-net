...
namespace Azure.ResourceManager.Billing.Models
{
    ...
    public partial class AppliedScopeProperties
    {
        ...
        internal AppliedScopeProperties(Guid? tenantId, string managementGroupId, string subscriptionId, string resourceGroupId, string displayName, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            TenantId = tenantId;
