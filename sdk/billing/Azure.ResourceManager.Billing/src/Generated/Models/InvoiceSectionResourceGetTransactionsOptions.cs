...
{
    /// <summary> The InvoiceSectionResourceGetTransactionsOptions. </summary>
    public partial class InvoiceSectionResourceGetTransactionsOptions
    {
        /// <summary> Initializes a new instance of <see cref="InvoiceSectionResourceGetTransactionsOptions"/>. </summary>
        ...
        public InvoiceSectionResourceGetTransactionsOptions(DateTimeOffset periodStartDate, DateTimeOffset periodEndDate, TransactionType type)
        {
        ...
        /// <summary> Initializes a new instance of <see cref="InvoiceSectionResourceGetTransactionsOptions"/> for deserialization. </summary>
        internal InvoiceSectionResourceGetTransactionsOptions()
        {
        }
