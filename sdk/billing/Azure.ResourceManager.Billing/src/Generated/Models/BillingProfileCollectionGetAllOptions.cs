...
{
    /// <summary> The BillingProfileCollectionGetAllOptions. </summary>
    public partial class BillingProfileCollectionGetAllOptions
    {
        /// <summary> Initializes a new instance of <see cref="BillingProfileCollectionGetAllOptions"/>. </summary>
        public BillingProfileCollectionGetAllOptions()
        {
        }

        /// <summary> Can be used to get deleted billing profiles. </summary>
