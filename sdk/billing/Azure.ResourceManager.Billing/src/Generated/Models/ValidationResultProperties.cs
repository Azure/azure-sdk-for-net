...
namespace Azure.ResourceManager.Billing.Models
{
    ...
    public partial class ValidationResultProperties
    {
        ...
        /// <summary> Initializes a new instance of <see cref="ValidationResultProperties"/>. </summary>
        internal ValidationResultProperties()
        {
        }
        ...
        internal ValidationResultProperties(string level, string code, string message, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Level = level;
            Code = code;
            Message = message;
