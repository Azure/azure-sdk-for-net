...
{
    public partial class BillingProfilePropertiesBillTo : IUtf8JsonSerializable, IJsonModel<BillingProfilePropertiesBillTo>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BillingProfilePropertiesBillTo>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<BillingProfilePropertiesBillTo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<BillingProfilePropertiesBillTo>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        BillingProfilePropertiesBillTo IJsonModel<BillingProfilePropertiesBillTo>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<BillingProfilePropertiesBillTo>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static BillingProfilePropertiesBillTo DeserializeBillingProfilePropertiesBillTo(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<BillingProfilePropertiesBillTo>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<BillingProfilePropertiesBillTo>)this).GetFormatFromOptions(options) : options.Format;
        ...
        BillingProfilePropertiesBillTo IPersistableModel<BillingProfilePropertiesBillTo>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<BillingProfilePropertiesBillTo>)this).GetFormatFromOptions(options) : options.Format;
