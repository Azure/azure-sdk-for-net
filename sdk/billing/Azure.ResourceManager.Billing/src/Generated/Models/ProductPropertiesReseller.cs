...
namespace Azure.ResourceManager.Billing.Models
{
    ...
    public partial class ProductPropertiesReseller : CreatedSubscriptionReseller
    {
        ...
        internal ProductPropertiesReseller(string resellerId, string description, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(resellerId, description, additionalBinaryDataProperties)
        {
        }
    }
}
