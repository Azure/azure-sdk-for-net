...
namespace Azure.ResourceManager.Billing.Models
{
    ...
    public partial class BillingAvailableBalanceData : ResourceData
    {
        ...
        internal BillingAvailableBalanceData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, BillingAvailableBalanceProperties properties, IDictionary<string, string> tags, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
