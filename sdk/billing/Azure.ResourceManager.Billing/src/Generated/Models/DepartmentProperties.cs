...
namespace Azure.ResourceManager.Billing.Models
{
    ...
    public partial class DepartmentProperties
    {
        ...
        /// <summary> Initializes a new instance of <see cref="DepartmentProperties"/>. </summary>
        ...
        internal DepartmentProperties(string costCenter, string displayName, string id, string status, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
