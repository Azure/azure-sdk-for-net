...
namespace Azure.ResourceManager.Billing.Models
{
    ...
    public partial class ReservationPatch
    {
        ...
        internal ReservationPatch(ReservationSkuProperty sku, IDictionary<string, string> tags, AppliedScopeType? appliedScopeType, ReservationAppliedScopeProperties appliedScopeProperties, InstanceFlexibility? instanceFlexibility, string displayName, bool? renew, DateTimeOffset? reviewOn, ReservationPurchaseRequest purchaseProperties, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Sku = sku;
            Tags = tags;
