...
namespace Azure.ResourceManager.Billing.Models
{
    ...
    public partial class ReservationAppliedScopeProperties
    {
        ...
        internal ReservationAppliedScopeProperties(Guid? tenantId, ResourceIdentifier managementGroupId, string subscriptionId, ResourceIdentifier resourceGroupId, string displayName, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            TenantId = tenantId;
