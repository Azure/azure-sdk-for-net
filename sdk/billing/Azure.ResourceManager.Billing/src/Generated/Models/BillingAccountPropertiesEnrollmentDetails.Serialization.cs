...
{
    public partial class BillingAccountPropertiesEnrollmentDetails : IUtf8JsonSerializable, IJsonModel<BillingAccountPropertiesEnrollmentDetails>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BillingAccountPropertiesEnrollmentDetails>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<BillingAccountPropertiesEnrollmentDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<BillingAccountPropertiesEnrollmentDetails>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        BillingAccountPropertiesEnrollmentDetails IJsonModel<BillingAccountPropertiesEnrollmentDetails>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<BillingAccountPropertiesEnrollmentDetails>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static BillingAccountPropertiesEnrollmentDetails DeserializeBillingAccountPropertiesEnrollmentDetails(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<BillingAccountPropertiesEnrollmentDetails>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<BillingAccountPropertiesEnrollmentDetails>)this).GetFormatFromOptions(options) : options.Format;
        ...
        BillingAccountPropertiesEnrollmentDetails IPersistableModel<BillingAccountPropertiesEnrollmentDetails>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<BillingAccountPropertiesEnrollmentDetails>)this).GetFormatFromOptions(options) : options.Format;
