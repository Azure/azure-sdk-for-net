...
namespace Azure.ResourceManager.Billing.Models
{
    ...
    public partial class ProductPatch : ResourceData
    {
        /// <summary>
        ...
        internal ProductPatch(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, ProductProperties properties, IDictionary<string, string> tags, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
