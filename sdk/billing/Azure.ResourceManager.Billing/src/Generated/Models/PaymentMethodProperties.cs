...
namespace Azure.ResourceManager.Billing.Models
{
    ...
    public partial class PaymentMethodProperties
    {
        ...
        /// <summary> Initializes a new instance of <see cref="PaymentMethodProperties"/>. </summary>
        ...
        internal PaymentMethodProperties(string id, string accountHolderName, string displayName, string expiration, PaymentMethodFamily? family, string lastFourDigits, IList<PaymentMethodLogo> logos, string paymentMethodType, PaymentMethodStatus? status, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
