...
namespace Azure.ResourceManager.Billing.Models
{
    ...
    public partial class ProxyResourceWithTags : ResourceData
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="ProxyResourceWithTags"/>. </summary>
        ...
        internal ProxyResourceWithTags(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, IDictionary<string, string> tags) : base(id, name, resourceType, systemData)
        {
