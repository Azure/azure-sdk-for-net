...
namespace Azure.ResourceManager.Billing.Models
{
    ...
    public partial class EnrollmentDetailsIndirectRelationshipInfo : IndirectRelationshipInfo
    {
        ...
        internal EnrollmentDetailsIndirectRelationshipInfo(string billingAccountName, string billingProfileName, string displayName, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(billingAccountName, billingProfileName, displayName, additionalBinaryDataProperties)
        {
        }
    }
}
