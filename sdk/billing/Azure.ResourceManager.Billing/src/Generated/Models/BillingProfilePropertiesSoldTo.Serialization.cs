...
{
    public partial class BillingProfilePropertiesSoldTo : IUtf8JsonSerializable, IJsonModel<BillingProfilePropertiesSoldTo>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BillingProfilePropertiesSoldTo>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<BillingProfilePropertiesSoldTo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<BillingProfilePropertiesSoldTo>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        BillingProfilePropertiesSoldTo IJsonModel<BillingProfilePropertiesSoldTo>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<BillingProfilePropertiesSoldTo>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static BillingProfilePropertiesSoldTo DeserializeBillingProfilePropertiesSoldTo(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<BillingProfilePropertiesSoldTo>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<BillingProfilePropertiesSoldTo>)this).GetFormatFromOptions(options) : options.Format;
        ...
        BillingProfilePropertiesSoldTo IPersistableModel<BillingProfilePropertiesSoldTo>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<BillingProfilePropertiesSoldTo>)this).GetFormatFromOptions(options) : options.Format;
