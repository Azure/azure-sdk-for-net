...
{
    public partial class BillingAccountBillingSubscriptionPatch : IUtf8JsonSerializable, IJsonModel<BillingAccountBillingSubscriptionPatch>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BillingAccountBillingSubscriptionPatch>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<BillingAccountBillingSubscriptionPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<BillingAccountBillingSubscriptionPatch>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        BillingAccountBillingSubscriptionPatch IJsonModel<BillingAccountBillingSubscriptionPatch>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<BillingAccountBillingSubscriptionPatch>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static BillingAccountBillingSubscriptionPatch DeserializeBillingAccountBillingSubscriptionPatch(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<BillingAccountBillingSubscriptionPatch>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<BillingAccountBillingSubscriptionPatch>)this).GetFormatFromOptions(options) : options.Format;
        ...
        BillingAccountBillingSubscriptionPatch IPersistableModel<BillingAccountBillingSubscriptionPatch>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<BillingAccountBillingSubscriptionPatch>)this).GetFormatFromOptions(options) : options.Format;
