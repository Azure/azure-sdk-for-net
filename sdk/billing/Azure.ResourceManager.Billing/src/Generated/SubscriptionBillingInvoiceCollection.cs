...
namespace Azure.ResourceManager.Billing
{
    ...
    public partial class SubscriptionBillingInvoiceCollection : ArmCollection, IEnumerable<SubscriptionBillingInvoiceResource>, IAsyncEnumerable<SubscriptionBillingInvoiceResource>
    {
        ...
        internal SubscriptionBillingInvoiceCollection(ArmClient client, ResourceIdentifier id, string subscriptionId) : base(client, id)
        {
            ...
            _invoicesRestClient = new Invoices(_invoicesClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, subscriptionBillingInvoiceApiVersion ?? "2024-04-01");
        ...
        /// </list>
        /// </summary>
        /// <param name="periodStartOn"> The start date of the billing period for which the invoice is generated. The date is in MM-DD-YYYY format. </param>
        /// <param name="periodEndOn"> The end date of the billing period for which the invoice is generated. The date is in MM-DD-YYYY format. </param>
        ...
        public virtual AsyncPageable<SubscriptionBillingInvoiceResource> GetAllAsync(DateTimeOffset? periodStartOn = default, DateTimeOffset? periodEndOn = default, string filter = default, string orderBy = default, long? maxCount = default, long? skip = default, bool? count = default, string search = default, CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> A collection of <see cref="SubscriptionBillingInvoiceResource"/> that may take multiple service requests to iterate over. </returns>
        public virtual Pageable<SubscriptionBillingInvoiceResource> GetAll(DateTimeOffset? periodStartOn = default, DateTimeOffset? periodEndOn = default, string filter = default, string orderBy = default, long? maxCount = default, long? skip = default, bool? count = default, string search = default, CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
