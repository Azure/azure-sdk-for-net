...
{
    /// <summary>
    /// A class representing the SavingsPlanModel data model.
    /// Savings plan
    /// </summary>
    public partial class SavingsPlanModelData : ResourceData
    {
        ...
        public SavingsPlanModelData(BillingSku sku)
        {
        ...
        internal SavingsPlanModelData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, BillingSku sku, string displayName, ProvisioningState? provisioningState, string displayProvisioningState, string userFriendlyAppliedScopeType, string billingScopeId, string billingProfileId, string customerId, string billingAccountId, SavingsPlanTerm? term, bool? renew, string renewSource, string renewDestination, RenewProperties renewProperties, BillingPlan? billingPlan, AppliedScopeType? appliedScopeType, AppliedScopeProperties appliedScopeProperties, Commitment commitment, DateTimeOffset? effectiveOn, DateTimeOffset? benefitStartOn, DateTimeOffset? expiryOn, DateTimeOffset? purchaseOn, Utilization utilization, ExtendedStatusInfo extendedStatusInfo, string productCode, IDictionary<string, string> tags, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
            Sku = sku;
        ...
        /// <summary> Initializes a new instance of <see cref="SavingsPlanModelData"/> for deserialization. </summary>
