...
namespace Azure.ResourceManager.Billing
{
    ...
    public partial class BillingInvoiceCollection : ArmCollection, IEnumerable<BillingInvoiceResource>, IAsyncEnumerable<BillingInvoiceResource>
    {
        ...
        public virtual AsyncPageable<BillingInvoiceResource> GetAllAsync(DateTimeOffset? periodStartOn = default, DateTimeOffset? periodEndOn = default, string filter = default, string orderBy = default, long? maxCount = default, long? skip = default, bool? count = default, string search = default, CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> A collection of <see cref="BillingInvoiceResource"/> that may take multiple service requests to iterate over. </returns>
        public virtual Pageable<BillingInvoiceResource> GetAll(DateTimeOffset? periodStartOn = default, DateTimeOffset? periodEndOn = default, string filter = default, string orderBy = default, long? maxCount = default, long? skip = default, bool? count = default, string search = default, CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
