...
namespace Azure.ResourceManager.Billing
{
    ...
    public partial class PaymentMethodResource : BasePaymentMethodResource
    {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public new async Task<Response<PaymentMethodResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            var result = await GetCoreAsync(cancellationToken).ConfigureAwait(false);
            return Response.FromValue((PaymentMethodResource)result.Value, result.GetRawResponse());
        }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public new Response<PaymentMethodResource> Get(CancellationToken cancellationToken = default)
        {
