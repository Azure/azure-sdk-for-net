...
{
    /// <summary>
    /// A class representing the BillingProfilePolicy data model.
    /// A policy at billing profile scope.
    /// </summary>
    public partial class BillingProfilePolicyData : ResourceData
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="BillingProfilePolicyData"/>. </summary>
        ...
        internal BillingProfilePolicyData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, BillingProfilePolicyProperties properties, IDictionary<string, string> tags, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
        ...
        [WirePath("properties")]
        public BillingProfilePolicyProperties Properties { get; set; }
