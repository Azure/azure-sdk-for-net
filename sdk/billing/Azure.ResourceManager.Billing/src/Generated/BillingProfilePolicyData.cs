...
namespace Azure.ResourceManager.Billing
{
    ...
    public partial class BillingProfilePolicyData : ResourceData
    {
        ...
        internal BillingProfilePolicyData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, BillingProfilePolicyProperties properties, IDictionary<string, string> tags) : base(id, name, resourceType, systemData)
        {
