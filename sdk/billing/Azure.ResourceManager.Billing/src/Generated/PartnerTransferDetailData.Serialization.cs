...
{
    public partial class PartnerTransferDetailData : IUtf8JsonSerializable, IJsonModel<PartnerTransferDetailData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PartnerTransferDetailData>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<PartnerTransferDetailData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        PartnerTransferDetailData IJsonModel<PartnerTransferDetailData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<PartnerTransferDetailData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static PartnerTransferDetailData DeserializePartnerTransferDetailData(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<PartnerTransferDetailData>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<PartnerTransferDetailData>)this).GetFormatFromOptions(options) : options.Format;
        ...
        PartnerTransferDetailData IPersistableModel<PartnerTransferDetailData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<PartnerTransferDetailData>)this).GetFormatFromOptions(options) : options.Format;
