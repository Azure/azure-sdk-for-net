...
namespace Azure.ResourceManager.Billing
{
    internal partial class ProductsRestOperations
    {
        ...
        internal HttpMessage CreateMoveRequest(string billingAccountName, string productName, MoveProductContent content)
        {
            ...
            ((IJsonModel<MoveProductContent>)content).Write(content0.JsonWriter, ModelSerializationExtensions.WireOptions);
        ...
        internal HttpMessage CreateUpdateRequest(string billingAccountName, string productName, BillingProductPatch patch)
        {
            ...
            ((IJsonModel<BillingProductPatch>)patch).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
