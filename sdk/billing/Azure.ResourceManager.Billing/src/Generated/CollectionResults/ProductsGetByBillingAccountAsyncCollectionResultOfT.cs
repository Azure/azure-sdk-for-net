...
{
    internal partial class ProductsGetByBillingAccountAsyncCollectionResultOfT : AsyncPageable<BillingProductData>
    {
        ...
        /// <summary> Initializes a new instance of ProductsGetByBillingAccountAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public ProductsGetByBillingAccountAsyncCollectionResultOfT(Products client, string billingAccountName, string filter, string orderBy, long? maxCount, long? skip, bool? count, string search, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of ProductsGetByBillingAccountAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of ProductsGetByBillingAccountAsyncCollectionResultOfT as an enumerable collection. </returns>
