...
namespace Azure.ResourceManager.Billing
{
    internal partial class InvoicesGetByBillingProfileCollectionResultOfT : Pageable<BillingInvoiceData>
    {
        ...
        public InvoicesGetByBillingProfileCollectionResultOfT(Invoices client, string billingAccountName, string billingProfileName, DateTimeOffset? periodStartsOn, DateTimeOffset? periodEndsOn, string filter, string orderBy, long? maxCount, long? skip, bool? count, string search, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        {
            HttpMessage message = nextLink != null ? _client.CreateNextGetByBillingProfileRequest(nextLink, _billingAccountName, _billingProfileName, _periodStartsOn, _periodEndsOn, _filter, _orderBy, _maxCount, _skip, _count, _search, _context) : _client.CreateGetByBillingProfileRequest(_billingAccountName, _billingProfileName, _periodStartsOn, _periodEndsOn, _filter, _orderBy, _maxCount, _skip, _count, _search, _context);
