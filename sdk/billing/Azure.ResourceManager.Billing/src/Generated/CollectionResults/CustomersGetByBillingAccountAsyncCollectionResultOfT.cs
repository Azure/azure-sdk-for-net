...
namespace Azure.ResourceManager.Billing
{
    internal partial class CustomersGetByBillingAccountAsyncCollectionResultOfT : AsyncPageable<BillingCustomerData>
    {
        ...
        /// <summary> Initializes a new instance of CustomersGetByBillingAccountAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public CustomersGetByBillingAccountAsyncCollectionResultOfT(Customers client, string billingAccountName, string expand, string filter, string orderBy, long? maxCount, long? skip, bool? count, string search, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of CustomersGetByBillingAccountAsyncCollectionResultOfT as an enumerable collection. </summary>
