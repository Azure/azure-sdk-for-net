...
{
    internal partial class BillingSubscriptionsGetByEnrollmentAccountAsyncCollectionResultOfT : AsyncPageable<BillingSubscriptionData>
    {
        ...
        /// <summary> Initializes a new instance of BillingSubscriptionsGetByEnrollmentAccountAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public BillingSubscriptionsGetByEnrollmentAccountAsyncCollectionResultOfT(BillingSubscriptions client, string billingAccountName, string enrollmentAccountName, string filter, string orderBy, long? maxCount, long? skip, bool? count, string search, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of BillingSubscriptionsGetByEnrollmentAccountAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of BillingSubscriptionsGetByEnrollmentAccountAsyncCollectionResultOfT as an enumerable collection. </returns>
        ...
        {
            HttpMessage message = nextLink != null ? _client.CreateNextGetByEnrollmentAccountRequest(nextLink, _billingAccountName, _enrollmentAccountName, _filter, _orderBy, _maxCount, _skip, _count, _search, _context) : _client.CreateGetByEnrollmentAccountRequest(_billingAccountName, _enrollmentAccountName, _filter, _orderBy, _maxCount, _skip, _count, _search, _context);
