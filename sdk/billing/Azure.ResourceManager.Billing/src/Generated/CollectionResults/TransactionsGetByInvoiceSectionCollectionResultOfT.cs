...
{
    internal partial class TransactionsGetByInvoiceSectionCollectionResultOfT : Pageable<BillingTransactionData>
    {
        ...
        /// <summary> Initializes a new instance of TransactionsGetByInvoiceSectionCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        /// <summary> Gets the pages of TransactionsGetByInvoiceSectionCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of TransactionsGetByInvoiceSectionCollectionResultOfT as an enumerable collection. </returns>
        ...
        {
            HttpMessage message = nextLink != null ? _client.CreateNextGetByInvoiceSectionRequest(nextLink, _billingAccountName, _billingProfileName, _invoiceSectionName, _periodStartDate, _periodEndDate, _type, _filter, _orderBy, _maxCount, _skip, _count, _search, _context) : _client.CreateGetByInvoiceSectionRequest(_billingAccountName, _billingProfileName, _invoiceSectionName, _periodStartDate, _periodEndDate, _type, _filter, _orderBy, _maxCount, _skip, _count, _search, _context);
