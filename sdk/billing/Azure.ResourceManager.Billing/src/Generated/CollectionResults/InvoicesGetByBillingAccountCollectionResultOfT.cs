...
{
    internal partial class InvoicesGetByBillingAccountCollectionResultOfT : Pageable<BillingInvoiceData>
    {
        ...
        /// <summary> Gets the pages of InvoicesGetByBillingAccountCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of InvoicesGetByBillingAccountCollectionResultOfT as an enumerable collection. </returns>
        ...
        {
            HttpMessage message = nextLink != null ? _client.CreateNextGetByBillingAccountRequest(nextLink, _billingAccountName, _periodStartOn, _periodEndOn, _filter, _orderBy, _maxCount, _skip, _count, _search, _context) : _client.CreateGetByBillingAccountRequest(_billingAccountName, _periodStartOn, _periodEndOn, _filter, _orderBy, _maxCount, _skip, _count, _search, _context);
