...
{
    internal partial class ProductsGetByCustomerAsyncCollectionResultOfT : AsyncPageable<BillingProductData>
    {
        ...
        /// <summary> Initializes a new instance of ProductsGetByCustomerAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public ProductsGetByCustomerAsyncCollectionResultOfT(Products client, string billingAccountName, string customerName, string filter, string orderBy, long? maxCount, long? skip, bool? count, string search, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of ProductsGetByCustomerAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of ProductsGetByCustomerAsyncCollectionResultOfT as an enumerable collection. </returns>
        ...
        {
            HttpMessage message = nextLink != null ? _client.CreateNextGetByCustomerRequest(nextLink, _billingAccountName, _customerName, _filter, _orderBy, _maxCount, _skip, _count, _search, _context) : _client.CreateGetByCustomerRequest(_billingAccountName, _customerName, _filter, _orderBy, _maxCount, _skip, _count, _search, _context);
