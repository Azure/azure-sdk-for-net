...
namespace Azure.ResourceManager.Billing
{
    internal partial class SavingsPlansGetByBillingAccountAsyncCollectionResultOfT : AsyncPageable<BillingSavingsPlanModelData>
    {
        ...
        /// <summary> Initializes a new instance of SavingsPlansGetByBillingAccountAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        /// <summary> Gets the pages of SavingsPlansGetByBillingAccountAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of SavingsPlansGetByBillingAccountAsyncCollectionResultOfT as an enumerable collection. </returns>
        ...
        {
            HttpMessage message = nextLink != null ? _client.CreateNextGetByBillingAccountRequest(nextLink, _billingAccountName, _filter, _orderBy, _skiptoken, _take, _selectedState, _refreshSummary, _context) : _client.CreateGetByBillingAccountRequest(_billingAccountName, _filter, _orderBy, _skiptoken, _take, _selectedState, _refreshSummary, _context);
