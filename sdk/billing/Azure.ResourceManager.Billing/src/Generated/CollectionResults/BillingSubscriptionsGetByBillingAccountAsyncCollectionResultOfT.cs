...
{
    internal partial class BillingSubscriptionsGetByBillingAccountAsyncCollectionResultOfT : AsyncPageable<BillingAccountBillingSubscriptionData>
    {
        ...
        private readonly bool? _includeTenantSubscriptions;
        private readonly bool? _includeFailed;
        ...
        /// <summary> Initializes a new instance of BillingSubscriptionsGetByBillingAccountAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public BillingSubscriptionsGetByBillingAccountAsyncCollectionResultOfT(BillingSubscriptions client, string billingAccountName, bool? includeDeleted, bool? includeTenantSubscriptions, bool? includeFailed, string expand, string filter, string orderBy, long? maxCount, long? skip, bool? count, string search, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _billingAccountName = billingAccountName;
            _includeDeleted = includeDeleted;
            _includeTenantSubscriptions = includeTenantSubscriptions;
            _includeFailed = includeFailed;
            _expand = expand;
            _filter = filter;
            _orderBy = orderBy;
            _maxCount = maxCount;
        ...
        /// <summary> Gets the pages of BillingSubscriptionsGetByBillingAccountAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of BillingSubscriptionsGetByBillingAccountAsyncCollectionResultOfT as an enumerable collection. </returns>
        public override async IAsyncEnumerable<Page<BillingAccountBillingSubscriptionData>> AsPages(string continuationToken, int? pageSizeHint)
        {
        ...
        {
            HttpMessage message = nextLink != null ? _client.CreateNextGetByBillingAccountRequest(nextLink, _billingAccountName, _includeDeleted, _includeTenantSubscriptions, _includeFailed, _expand, _filter, _orderBy, _maxCount, _skip, _count, _search, _context) : _client.CreateGetByBillingAccountRequest(_billingAccountName, _includeDeleted, _includeTenantSubscriptions, _includeFailed, _expand, _filter, _orderBy, _maxCount, _skip, _count, _search, _context);
