...
{
    internal partial class CustomersGetByBillingProfileCollectionResultOfT : Pageable<BillingCustomerData>
    {
        ...
        /// <summary> Initializes a new instance of CustomersGetByBillingProfileCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public CustomersGetByBillingProfileCollectionResultOfT(Customers client, string billingAccountName, string billingProfileName, string expand, string filter, string orderBy, long? maxCount, long? skip, bool? count, string search, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of CustomersGetByBillingProfileCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of CustomersGetByBillingProfileCollectionResultOfT as an enumerable collection. </returns>
