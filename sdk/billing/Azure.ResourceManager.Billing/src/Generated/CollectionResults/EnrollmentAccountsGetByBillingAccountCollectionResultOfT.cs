...
{
    internal partial class EnrollmentAccountsGetByBillingAccountCollectionResultOfT : Pageable<BillingAccountEnrollmentAccountData>
    {
        ...
        /// <summary> Initializes a new instance of EnrollmentAccountsGetByBillingAccountCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public EnrollmentAccountsGetByBillingAccountCollectionResultOfT(EnrollmentAccounts client, string billingAccountName, string filter, string orderBy, long? maxCount, long? skip, bool? count, string search, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of EnrollmentAccountsGetByBillingAccountCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of EnrollmentAccountsGetByBillingAccountCollectionResultOfT as an enumerable collection. </returns>
        public override IEnumerable<Page<BillingAccountEnrollmentAccountData>> AsPages(string continuationToken, int? pageSizeHint)
        {
