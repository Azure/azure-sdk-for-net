...
{
    internal partial class BillingSubscriptionsAliasesGetByBillingAccountAsyncCollectionResultOfT : AsyncPageable<BillingSubscriptionAliasData>
    {
        ...
        /// <summary> Initializes a new instance of BillingSubscriptionsAliasesGetByBillingAccountAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        /// <summary> Gets the pages of BillingSubscriptionsAliasesGetByBillingAccountAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of BillingSubscriptionsAliasesGetByBillingAccountAsyncCollectionResultOfT as an enumerable collection. </returns>
        public override async IAsyncEnumerable<Page<BillingSubscriptionAliasData>> AsPages(string continuationToken, int? pageSizeHint)
        {
