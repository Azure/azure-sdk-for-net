...
{
    internal partial class BillingSubscriptionsAliasesGetByBillingAccountCollectionResultOfT : Pageable<BillingSubscriptionAliasData>
    {
        private readonly BillingSubscriptionsAliases _client;
        ...
        /// <summary> Initializes a new instance of BillingSubscriptionsAliasesGetByBillingAccountCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        /// <param name="client"> The BillingSubscriptionsAliases client used to send requests. </param>
        ...
        public BillingSubscriptionsAliasesGetByBillingAccountCollectionResultOfT(BillingSubscriptionsAliases client, string billingAccountName, bool? includeDeleted, string filter, string orderBy, long? maxCount, long? skip, bool? count, string search, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of BillingSubscriptionsAliasesGetByBillingAccountCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of BillingSubscriptionsAliasesGetByBillingAccountCollectionResultOfT as an enumerable collection. </returns>
        public override IEnumerable<Page<BillingSubscriptionAliasData>> AsPages(string continuationToken, int? pageSizeHint)
        {
