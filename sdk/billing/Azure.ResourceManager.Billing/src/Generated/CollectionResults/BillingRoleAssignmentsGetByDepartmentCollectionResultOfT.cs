...
namespace Azure.ResourceManager.Billing
{
    internal partial class BillingRoleAssignmentsGetByDepartmentCollectionResultOfT : Pageable<BillingRoleAssignmentData>
    {
        ...
        /// <summary> Initializes a new instance of BillingRoleAssignmentsGetByDepartmentCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public BillingRoleAssignmentsGetByDepartmentCollectionResultOfT(BillingRoleAssignments client, string billingAccountName, string departmentName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of BillingRoleAssignmentsGetByDepartmentCollectionResultOfT as an enumerable collection. </summary>
