...
namespace Azure.ResourceManager.Billing
{
    internal partial class MicrosoftBillingBillingProfilesCheckAccessByBillingProfileAsyncCollectionResultOfT : AsyncPageable<BillingCheckAccessResult>
    {
        ...
        public MicrosoftBillingBillingProfilesCheckAccessByBillingProfileAsyncCollectionResultOfT(BillingPermissions client, string billingAccountName, string billingProfileName, RequestContent content, RequestContext context, string diagnosticScope)
        {
            _client = client;
