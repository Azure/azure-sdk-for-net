...
namespace Azure.ResourceManager.Billing
{
    internal partial class SavingsPlansGetByBillingAccountCollectionResultOfT : Pageable<BillingSavingsPlanModelData>
    {
        ...
        /// <summary> Initializes a new instance of SavingsPlansGetByBillingAccountCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        /// <summary> Gets the pages of SavingsPlansGetByBillingAccountCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of SavingsPlansGetByBillingAccountCollectionResultOfT as an enumerable collection. </returns>
