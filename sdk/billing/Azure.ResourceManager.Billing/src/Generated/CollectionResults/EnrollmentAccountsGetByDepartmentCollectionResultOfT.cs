...
{
    internal partial class EnrollmentAccountsGetByDepartmentCollectionResultOfT : Pageable<BillingEnrollmentAccountData>
    {
        ...
        /// <summary> Initializes a new instance of EnrollmentAccountsGetByDepartmentCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public EnrollmentAccountsGetByDepartmentCollectionResultOfT(EnrollmentAccounts client, string billingAccountName, string departmentName, string filter, string orderBy, long? maxCount, long? skip, bool? count, string search, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of EnrollmentAccountsGetByDepartmentCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of EnrollmentAccountsGetByDepartmentCollectionResultOfT as an enumerable collection. </returns>
        public override IEnumerable<Page<BillingEnrollmentAccountData>> AsPages(string continuationToken, int? pageSizeHint)
        {
