...
{
    internal partial class TransactionsGetByInvoiceCollectionResultOfT : Pageable<BillingTransactionData>
    {
        ...
        /// <summary> Initializes a new instance of TransactionsGetByInvoiceCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public TransactionsGetByInvoiceCollectionResultOfT(Transactions client, string billingAccountName, string invoiceName, string filter, string orderBy, long? maxCount, long? skip, bool? count, string search, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of TransactionsGetByInvoiceCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of TransactionsGetByInvoiceCollectionResultOfT as an enumerable collection. </returns>
