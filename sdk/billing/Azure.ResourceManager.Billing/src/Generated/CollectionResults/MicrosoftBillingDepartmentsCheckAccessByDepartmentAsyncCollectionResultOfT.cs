...
namespace Azure.ResourceManager.Billing
{
    internal partial class MicrosoftBillingDepartmentsCheckAccessByDepartmentAsyncCollectionResultOfT : AsyncPageable<BillingCheckAccessResult>
    {
        ...
        public MicrosoftBillingDepartmentsCheckAccessByDepartmentAsyncCollectionResultOfT(BillingPermissions client, string billingAccountName, string departmentName, RequestContent content, RequestContext context, string diagnosticScope)
        {
            _client = client;
