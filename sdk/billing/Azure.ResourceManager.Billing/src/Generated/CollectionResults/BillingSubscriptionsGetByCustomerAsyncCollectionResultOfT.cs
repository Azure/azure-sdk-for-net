...
{
    internal partial class BillingSubscriptionsGetByCustomerAsyncCollectionResultOfT : AsyncPageable<BillingSubscriptionData>
    {
        ...
        /// <summary> Initializes a new instance of BillingSubscriptionsGetByCustomerAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        /// <summary> Gets the pages of BillingSubscriptionsGetByCustomerAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of BillingSubscriptionsGetByCustomerAsyncCollectionResultOfT as an enumerable collection. </returns>
        ...
        {
            HttpMessage message = nextLink != null ? _client.CreateNextGetByCustomerRequest(nextLink, _billingAccountName, _billingProfileName, _customerName, _includeDeleted, _expand, _filter, _orderBy, _maxCount, _skip, _count, _search, _context) : _client.CreateGetByCustomerRequest(_billingAccountName, _billingProfileName, _customerName, _includeDeleted, _expand, _filter, _orderBy, _maxCount, _skip, _count, _search, _context);
