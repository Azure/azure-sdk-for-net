...
namespace Azure.ResourceManager.Billing
{
    internal partial class TransfersGetAllCollectionResultOfT : Pageable<BillingTransferDetailData>
    {
        ...
        /// <summary> Initializes a new instance of TransfersGetAllCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public TransfersGetAllCollectionResultOfT(Transfers client, string billingAccountName, string billingProfileName, string invoiceSectionName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of TransfersGetAllCollectionResultOfT as an enumerable collection. </summary>
