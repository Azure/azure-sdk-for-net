...
namespace Azure.ResourceManager.Billing
{
    internal partial class PartnerTransfersGetAllAsyncCollectionResultOfT : AsyncPageable<PartnerTransferDetailData>
    {
        ...
        /// <summary> Initializes a new instance of PartnerTransfersGetAllAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public PartnerTransfersGetAllAsyncCollectionResultOfT(PartnerTransfers client, string billingAccountName, string billingProfileName, string customerName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of PartnerTransfersGetAllAsyncCollectionResultOfT as an enumerable collection. </summary>
