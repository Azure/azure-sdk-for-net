...
{
    internal partial class CustomersGetByBillingAccountCollectionResultOfT : Pageable<BillingAccountCustomerData>
    {
        ...
        /// <summary> Initializes a new instance of CustomersGetByBillingAccountCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public CustomersGetByBillingAccountCollectionResultOfT(Customers client, string billingAccountName, string expand, string filter, string orderBy, long? maxCount, long? skip, bool? count, string search, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of CustomersGetByBillingAccountCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of CustomersGetByBillingAccountCollectionResultOfT as an enumerable collection. </returns>
        public override IEnumerable<Page<BillingAccountCustomerData>> AsPages(string continuationToken, int? pageSizeHint)
        {
        ...
        {
            HttpMessage message = nextLink != null ? _client.CreateNextGetByBillingAccountRequest(nextLink, _billingAccountName, _expand, _filter, _orderBy, _maxCount, _skip, _count, _search, _context) : _client.CreateGetByBillingAccountRequest(_billingAccountName, _expand, _filter, _orderBy, _maxCount, _skip, _count, _search, _context);
