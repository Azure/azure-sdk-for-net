...
namespace Azure.ResourceManager.Billing
{
    internal partial class MicrosoftBillingBillingAccountsCheckAccessByBillingAccountCollectionResultOfT : Pageable<BillingCheckAccessResult>
    {
        ...
        public MicrosoftBillingBillingAccountsCheckAccessByBillingAccountCollectionResultOfT(BillingPermissions client, string billingAccountName, RequestContent content, RequestContext context, string diagnosticScope)
        {
            _client = client;
        ...
        {
            HttpMessage message = _client.CreateCheckAccessByBillingAccountRequest(_billingAccountName, _content, _context);
