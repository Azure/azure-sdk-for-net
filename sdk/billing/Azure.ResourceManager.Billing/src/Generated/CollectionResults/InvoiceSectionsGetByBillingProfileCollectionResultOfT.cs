...
{
    internal partial class InvoiceSectionsGetByBillingProfileCollectionResultOfT : Pageable<BillingInvoiceSectionData>
    {
        ...
        /// <summary> Initializes a new instance of InvoiceSectionsGetByBillingProfileCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public InvoiceSectionsGetByBillingProfileCollectionResultOfT(InvoiceSections client, string billingAccountName, string billingProfileName, bool? includeDeleted, string filter, string orderBy, long? maxCount, long? skip, bool? count, string search, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of InvoiceSectionsGetByBillingProfileCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of InvoiceSectionsGetByBillingProfileCollectionResultOfT as an enumerable collection. </returns>
        public override IEnumerable<Page<BillingInvoiceSectionData>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                InvoiceSectionListResult result = InvoiceSectionListResult.FromResponse(response);
                nextPage = result.NextLink;
                yield return Page<BillingInvoiceSectionData>.FromValues(result.Value, nextPage?.IsAbsoluteUri == true ? nextPage.AbsoluteUri : nextPage?.OriginalString, response);
                if (nextPage == null)
                {
                    yield break;
                }
        ...
        {
            HttpMessage message = nextLink != null ? _client.CreateNextGetByBillingProfileRequest(nextLink, _billingAccountName, _billingProfileName, _includeDeleted, _filter, _orderBy, _maxCount, _skip, _count, _search, _context) : _client.CreateGetByBillingProfileRequest(_billingAccountName, _billingProfileName, _includeDeleted, _filter, _orderBy, _maxCount, _skip, _count, _search, _context);
