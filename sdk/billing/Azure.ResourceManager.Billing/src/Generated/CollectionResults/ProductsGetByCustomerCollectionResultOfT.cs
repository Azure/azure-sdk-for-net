...
{
    internal partial class ProductsGetByCustomerCollectionResultOfT : Pageable<BillingProductData>
    {
        ...
        /// <summary> Initializes a new instance of ProductsGetByCustomerCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public ProductsGetByCustomerCollectionResultOfT(Products client, string billingAccountName, string customerName, string filter, string orderBy, long? maxCount, long? skip, bool? count, string search, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of ProductsGetByCustomerCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of ProductsGetByCustomerCollectionResultOfT as an enumerable collection. </returns>
