...
{
    internal partial class TransactionsGetByInvoiceAsyncCollectionResultOfT : AsyncPageable<BillingTransactionData>
    {
        ...
        /// <summary> Initializes a new instance of TransactionsGetByInvoiceAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public TransactionsGetByInvoiceAsyncCollectionResultOfT(Transactions client, string billingAccountName, string invoiceName, string filter, string orderBy, long? maxCount, long? skip, bool? count, string search, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of TransactionsGetByInvoiceAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of TransactionsGetByInvoiceAsyncCollectionResultOfT as an enumerable collection. </returns>
        ...
        {
            HttpMessage message = nextLink != null ? _client.CreateNextGetByInvoiceRequest(nextLink, _billingAccountName, _invoiceName, _filter, _orderBy, _maxCount, _skip, _count, _search, _context) : _client.CreateGetByInvoiceRequest(_billingAccountName, _invoiceName, _filter, _orderBy, _maxCount, _skip, _count, _search, _context);
