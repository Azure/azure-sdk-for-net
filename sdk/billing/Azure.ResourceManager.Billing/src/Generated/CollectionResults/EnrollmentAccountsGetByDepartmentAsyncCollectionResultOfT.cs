...
{
    internal partial class EnrollmentAccountsGetByDepartmentAsyncCollectionResultOfT : AsyncPageable<BillingEnrollmentAccountData>
    {
        ...
        /// <summary> Initializes a new instance of EnrollmentAccountsGetByDepartmentAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public EnrollmentAccountsGetByDepartmentAsyncCollectionResultOfT(EnrollmentAccounts client, string billingAccountName, string departmentName, string filter, string orderBy, long? maxCount, long? skip, bool? count, string search, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of EnrollmentAccountsGetByDepartmentAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of EnrollmentAccountsGetByDepartmentAsyncCollectionResultOfT as an enumerable collection. </returns>
        ...
        {
            HttpMessage message = nextLink != null ? _client.CreateNextGetByDepartmentRequest(nextLink, _billingAccountName, _departmentName, _filter, _orderBy, _maxCount, _skip, _count, _search, _context) : _client.CreateGetByDepartmentRequest(_billingAccountName, _departmentName, _filter, _orderBy, _maxCount, _skip, _count, _search, _context);
