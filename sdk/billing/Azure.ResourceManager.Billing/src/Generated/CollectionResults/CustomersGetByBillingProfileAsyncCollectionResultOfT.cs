...
{
    internal partial class CustomersGetByBillingProfileAsyncCollectionResultOfT : AsyncPageable<BillingCustomerData>
    {
        ...
        /// <summary> Initializes a new instance of CustomersGetByBillingProfileAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public CustomersGetByBillingProfileAsyncCollectionResultOfT(Customers client, string billingAccountName, string billingProfileName, string expand, string filter, string orderBy, long? maxCount, long? skip, bool? count, string search, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of CustomersGetByBillingProfileAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of CustomersGetByBillingProfileAsyncCollectionResultOfT as an enumerable collection. </returns>
        ...
        {
            HttpMessage message = nextLink != null ? _client.CreateNextGetByBillingProfileRequest(nextLink, _billingAccountName, _billingProfileName, _expand, _filter, _orderBy, _maxCount, _skip, _count, _search, _context) : _client.CreateGetByBillingProfileRequest(_billingAccountName, _billingProfileName, _expand, _filter, _orderBy, _maxCount, _skip, _count, _search, _context);
