...
namespace Azure.ResourceManager.Billing
{
    internal partial class MicrosoftBillingInvoiceSectionsCheckAccessByInvoiceSectionAsyncCollectionResultOfT : AsyncPageable<BillingCheckAccessResult>
    {
        ...
        public MicrosoftBillingInvoiceSectionsCheckAccessByInvoiceSectionAsyncCollectionResultOfT(BillingPermissions client, string billingAccountName, string billingProfileName, string invoiceSectionName, RequestContent content, RequestContext context, string diagnosticScope)
        {
            _client = client;
