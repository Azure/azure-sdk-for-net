...
{
    internal partial class BillingSubscriptionsGetByInvoiceSectionAsyncCollectionResultOfT : AsyncPageable<BillingSubscriptionData>
    {
        ...
        /// <summary> Initializes a new instance of BillingSubscriptionsGetByInvoiceSectionAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        /// <param name="client"> The BillingSubscriptions client used to send requests. </param>
        ...
        public BillingSubscriptionsGetByInvoiceSectionAsyncCollectionResultOfT(BillingSubscriptions client, string billingAccountName, string billingProfileName, string invoiceSectionName, bool? includeDeleted, string expand, string filter, string orderBy, long? maxCount, long? skip, bool? count, string search, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of BillingSubscriptionsGetByInvoiceSectionAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of BillingSubscriptionsGetByInvoiceSectionAsyncCollectionResultOfT as an enumerable collection. </returns>
        public override async IAsyncEnumerable<Page<BillingSubscriptionData>> AsPages(string continuationToken, int? pageSizeHint)
        {
        ...
        {
            HttpMessage message = nextLink != null ? _client.CreateNextGetByInvoiceSectionRequest(nextLink, _billingAccountName, _billingProfileName, _invoiceSectionName, _includeDeleted, _expand, _filter, _orderBy, _maxCount, _skip, _count, _search, _context) : _client.CreateGetByInvoiceSectionRequest(_billingAccountName, _billingProfileName, _invoiceSectionName, _includeDeleted, _expand, _filter, _orderBy, _maxCount, _skip, _count, _search, _context);
