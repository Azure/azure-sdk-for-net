...
namespace Azure.ResourceManager.Billing
{
    internal partial class BillingRoleDefinitionGetByInvoiceSectionAsyncCollectionResultOfT : AsyncPageable<BillingRoleDefinitionData>
    {
        ...
        /// <summary> Initializes a new instance of BillingRoleDefinitionGetByInvoiceSectionAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public BillingRoleDefinitionGetByInvoiceSectionAsyncCollectionResultOfT(BillingRoleDefinition client, string billingAccountName, string billingProfileName, string invoiceSectionName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of BillingRoleDefinitionGetByInvoiceSectionAsyncCollectionResultOfT as an enumerable collection. </summary>
