...
{
    /// <summary>
    /// A class representing the BillingTransferDetail data model.
    ...
    public partial class BillingTransferDetailData : ResourceData
    {
        ...
        internal BillingTransferDetailData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, DateTimeOffset? expireOn, PartnerTransferStatus? transferStatus, string recipientEmailId, string initiatorEmailId, string canceledBy, IReadOnlyList<DetailedTransferStatus> detailedTransferStatus, IDictionary<string, string> tags, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
            ExpireOn = expireOn;
