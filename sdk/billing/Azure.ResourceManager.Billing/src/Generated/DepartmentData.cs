...
namespace Azure.ResourceManager.Billing
{
    ...
    public partial class DepartmentData : ResourceData
    {
        ...
        /// <summary> Initializes a new instance of <see cref="DepartmentData"/>. </summary>
        ...
        internal DepartmentData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, DepartmentProperties properties, IDictionary<string, string> tags, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
