...
namespace Azure.ResourceManager.Billing
{
    ...
    public partial class BillingPaymentMethodLinkData : ResourceData
    {
        ...
        internal BillingPaymentMethodLinkData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, PaymentMethodLinkProperties properties, IDictionary<string, string> tags) : base(id, name, resourceType, systemData)
        {
        ...
        internal PaymentMethodLinkProperties Properties { get; }
