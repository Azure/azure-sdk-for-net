...
namespace Azure.ResourceManager.Billing
{
    ...
    public partial class BillingInvoiceSectionData : ResourceData
    {
        ...
        internal BillingInvoiceSectionData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, BillingInvoiceSectionProperties properties, IDictionary<string, string> tags) : base(id, name, resourceType, systemData)
        {
