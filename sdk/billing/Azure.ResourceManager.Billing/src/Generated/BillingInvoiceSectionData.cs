...
namespace Azure.ResourceManager.Billing
{
    ...
    public partial class BillingInvoiceSectionData : ResourceData
    {
        ...
        internal BillingInvoiceSectionData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, BillingInvoiceSectionProperties properties, IDictionary<string, string> tags, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, name, resourceType, systemData)
        {
