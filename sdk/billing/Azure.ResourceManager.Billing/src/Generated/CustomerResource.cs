...
{
    /// <summary>
    /// A class representing a Customer along with the instance operations that can be performed on it.
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="CustomerResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="BillingAccountResource"/> using the GetCustomers method.
    /// </summary>
    public partial class CustomerResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of CustomerResource for mocking. </summary>
        protected CustomerResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="CustomerResource"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="data"> The resource that is the target of operations. </param>
        internal CustomerResource(ArmClient client, BillingCustomerData data) : this(client, data.Id)
        {
            this.HasData = true;
            _data = data;
        }
        ...
        internal CustomerResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            this.TryGetApiVersion(ResourceType, out string customerApiVersion);
            ...
            _billingSubscriptionsRestClient = new BillingSubscriptions(_billingSubscriptionsClientDiagnostics, Pipeline, Endpoint, customerApiVersion ?? "2024-04-01");
            _productsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Billing", ResourceType.Namespace, Diagnostics);
            _productsRestClient = new Products(_productsClientDiagnostics, Pipeline, Endpoint, customerApiVersion ?? "2024-04-01");
            ...
            _billingPermissionsRestClient = new BillingPermissions(_billingPermissionsClientDiagnostics, Pipeline, Endpoint, customerApiVersion ?? "2024-04-01");
        ...
        /// <item>
        /// <term> Resource. </term>
        /// <description> <see cref="CustomerResource"/>. </description>
        /// </item>
        /// </list>
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<CustomerResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _customersClientDiagnostics.CreateScope("CustomerResource.Get");
            scope.Start();
            try
            {
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<CustomerResource> Get(CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _customersClientDiagnostics.CreateScope("CustomerResource.Get");
            scope.Start();
            try
        ...
        public virtual AsyncPageable<BillingSubscriptionData> GetByCustomerAtBillingAccountAsync(bool? includeDeleted = default, string expand = default, string filter = default, string orderBy = default, long? maxCount = default, long? skip = default, bool? count = default, string search = default, CancellationToken cancellationToken = default)
        {
            ...
            return new BillingSubscriptionsGetByCustomerAtBillingAccountAsyncCollectionResultOfT(
                ...
                search,
                context,
                "CustomerResource.GetByCustomerAtBillingAccount");
        }
        ...
        public virtual AsyncPageable<BillingProductResource> GetByCustomerAsync(string filter = default, string orderBy = default, long? maxCount = default, long? skip = default, bool? count = default, string search = default, CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<BillingProductData, BillingProductResource>(new ProductsGetByCustomerAsyncCollectionResultOfT(
                ...
                search,
                context,
                "CustomerResource.GetByCustomer"), data => new BillingProductResource(Client, data));
        }
        ...
        public virtual AsyncPageable<BillingPermission> GetByCustomerAtBillingAccountAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new BillingPermissionsGetByCustomerAtBillingAccountAsyncCollectionResultOfT(_billingPermissionsRestClient, Id.Parent.Name, Id.Name, context, "CustomerResource.GetByCustomerAtBillingAccount");
        }
        ...
        public virtual Pageable<BillingPermission> GetByCustomerAtBillingAccount(CancellationToken cancellationToken = default)
        {
            ...
            return new BillingPermissionsGetByCustomerAtBillingAccountCollectionResultOfT(_billingPermissionsRestClient, Id.Parent.Name, Id.Name, context, "CustomerResource.GetByCustomerAtBillingAccount");
        }

        /// <summary> Gets an object representing a <see cref="PolicyResource"/> along with the instance operations that can be performed on it in the <see cref="CustomerResource"/>. </summary>
        /// <returns> Returns a <see cref="PolicyResource"/> object. </returns>
        public virtual PolicyResource GetPolicy()
        {
            return new PolicyResource(Client, Id.AppendChildResource("policies", "default"));
        }
    }
}
