...
{
    /// <summary>
    /// A class representing the BillingCustomer data model.
    /// A partner's customer.
    /// </summary>
    public partial class BillingCustomerData : ResourceData
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="BillingCustomerData"/>. </summary>
        ...
        internal BillingCustomerData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, BillingCustomerProperties properties, IDictionary<string, string> tags, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
        ...
        [WirePath("properties")]
        public BillingCustomerProperties Properties { get; set; }
