...
namespace Azure.ResourceManager.Billing
{
    ...
    public partial class BillingCustomerData : ResourceData
    {
        ...
        internal BillingCustomerData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, BillingCustomerProperties properties, IDictionary<string, string> tags) : base(id, name, resourceType, systemData)
        {
