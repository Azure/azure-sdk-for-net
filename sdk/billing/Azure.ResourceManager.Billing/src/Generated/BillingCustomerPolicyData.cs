...
namespace Azure.ResourceManager.Billing
{
    ...
    public partial class BillingCustomerPolicyData : ResourceData
    {
        ...
        internal BillingCustomerPolicyData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, BillingCustomerPolicyProperties properties, IDictionary<string, string> tags) : base(id, name, resourceType, systemData)
        {
