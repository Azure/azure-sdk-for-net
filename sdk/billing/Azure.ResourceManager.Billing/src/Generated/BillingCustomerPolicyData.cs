...
{
    /// <summary>
    /// A class representing the BillingCustomerPolicy data model.
    /// A policy at customer scope.
    /// </summary>
    public partial class BillingCustomerPolicyData : ResourceData
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="BillingCustomerPolicyData"/>. </summary>
        ...
        internal BillingCustomerPolicyData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, BillingCustomerPolicyProperties properties, IDictionary<string, string> tags, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
