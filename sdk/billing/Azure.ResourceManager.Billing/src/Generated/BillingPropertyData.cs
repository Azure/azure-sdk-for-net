...
{
    /// <summary>
    /// A class representing the BillingProperty data model.
    /// A billing property.
    /// </summary>
    public partial class BillingPropertyData : ResourceData
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="BillingPropertyData"/>. </summary>
        public BillingPropertyData()
        {
        ...
        internal BillingPropertyData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, BillingPropertyProperties properties, IDictionary<string, string> tags, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
        ...
        [WirePath("properties")]
        public BillingPropertyProperties Properties { get; set; }
