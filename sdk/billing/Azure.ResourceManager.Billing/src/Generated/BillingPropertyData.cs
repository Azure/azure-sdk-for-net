...
namespace Azure.ResourceManager.Billing
{
    ...
    public partial class BillingPropertyData : ResourceData
    {
        ...
        internal BillingPropertyData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, BillingPropertyProperties properties, IDictionary<string, string> tags) : base(id, name, resourceType, systemData)
        {
