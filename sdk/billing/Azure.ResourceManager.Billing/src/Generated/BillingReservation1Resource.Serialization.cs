...
namespace Azure.ResourceManager.Billing
{
    ...
    public partial class BillingReservation1Resource : IJsonModel<BillingReservationData>
    {
        ...
        private static IJsonModel<BillingReservationData> DataDeserializationInstance => s_dataDeserializationInstance ??= new BillingReservationData();
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BillingReservationData IJsonModel<BillingReservationData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => DataDeserializationInstance.Create(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<BillingReservationData>.GetFormatFromOptions(ModelReaderWriterOptions options) => DataDeserializationInstance.GetFormatFromOptions(options);
    }
}
