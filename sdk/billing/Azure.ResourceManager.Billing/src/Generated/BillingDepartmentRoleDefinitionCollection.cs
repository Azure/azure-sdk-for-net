...
namespace Azure.ResourceManager.Billing
{
    ...
    public partial class BillingDepartmentRoleDefinitionCollection : ArmCollection, IEnumerable<BillingDepartmentRoleDefinitionResource>, IAsyncEnumerable<BillingDepartmentRoleDefinitionResource>
    {
        ...
        /// <summary> Initializes a new instance of BillingDepartmentRoleDefinitionCollection for mocking. </summary>
        protected BillingDepartmentRoleDefinitionCollection()
        {
        }

        /// <summary> Initializes a new instance of <see cref="BillingDepartmentRoleDefinitionCollection"/> class. </summary>
        ...
        {
            TryGetApiVersion(BillingDepartmentRoleDefinitionResource.ResourceType, out string billingDepartmentRoleDefinitionApiVersion);
            _billingRoleDefinitionClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Billing", BillingDepartmentRoleDefinitionResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<Response<BillingDepartmentRoleDefinitionResource>> GetAsync(string roleDefinitionName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _billingRoleDefinitionClientDiagnostics.CreateScope("BillingDepartmentRoleDefinitionCollection.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _billingRoleDefinitionRestClient.CreateGetByDepartmentRequest(Id.Parent.Name, Id.Name, roleDefinitionName, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<BillingDepartmentRoleDefinitionData> response = Response.FromValue(BillingDepartmentRoleDefinitionData.FromResponse(result), result);
        ...
        /// <item>
        /// <term> Operation Id. </term>
        /// <description> BillingRoleDefinitionByDepartment_ListByDepartment. </description>
        /// </item>
        /// <item>
        /// <term> Default Api Version. </term>
        /// <description> 2024-04-01. </description>
        ...
        public virtual Pageable<BillingDepartmentRoleDefinitionResource> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            return new PageableWrapper<BillingDepartmentRoleDefinitionData, BillingDepartmentRoleDefinitionResource>(new BillingRoleDefinitionGetByDepartmentCollectionResultOfT(_billingRoleDefinitionRestClient, Id.Parent.Name, Id.Name, context, "BillingDepartmentRoleDefinitionCollection.GetAll"), data => new BillingDepartmentRoleDefinitionResource(Client, data));
        }
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string roleDefinitionName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _billingRoleDefinitionClientDiagnostics.CreateScope("BillingDepartmentRoleDefinitionCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                Response<BillingDepartmentRoleDefinitionData> response = default;
                switch (result.Status)
                {
                    case 200:
                        response = Response.FromValue(BillingDepartmentRoleDefinitionData.FromResponse(result), result);
                        break;
                    case 404:
                        response = Response.FromValue((BillingDepartmentRoleDefinitionData)null, result);
                        break;
                    default:
        ...
        public virtual async Task<NullableResponse<BillingDepartmentRoleDefinitionResource>> GetIfExistsAsync(string roleDefinitionName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _billingRoleDefinitionClientDiagnostics.CreateScope("BillingDepartmentRoleDefinitionCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
