...
{
    /// <summary>
    /// A class representing the TransferDetail data model.
    /// Details of the transfer.
    /// </summary>
    public partial class TransferDetailData : ResourceData
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="TransferDetailData"/>. </summary>
        ...
        internal TransferDetailData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, DateTimeOffset? expireOn, TransferStatus? transferStatus, string recipientEmailId, string initiatorEmailId, string canceledBy, IReadOnlyList<DetailedTransferStatus> detailedTransferStatus, IDictionary<string, string> tags, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
            ExpireOn = expireOn;
