...
namespace Azure.ResourceManager.Billing
{
    ...
    public partial class BillingAccountPolicyData : ResourceData
    {
        ...
        internal BillingAccountPolicyData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, BillingAccountPolicyProperties properties, IDictionary<string, string> tags) : base(id, name, resourceType, systemData)
        {
        ...
        /// <summary> A policy at billing account scope. </summary>
        public BillingAccountPolicyProperties Properties { get; set; }
