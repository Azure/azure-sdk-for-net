...
namespace Azure.ResourceManager.Billing
{
    ...
    public partial class RecipientTransferDetailsData : ResourceData
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="RecipientTransferDetailsData"/>. </summary>
        internal RecipientTransferDetailsData()
        {
        ...
        internal RecipientTransferDetailsData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, RecipientTransferProperties properties, IDictionary<string, string> tags) : base(id, name, resourceType, systemData)
        {
        ...
        /// <summary> Details of the transfer. </summary>
        internal RecipientTransferProperties Properties { get; }
