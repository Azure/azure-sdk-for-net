...
{
    /// <summary>
    /// A class representing the BillingDepartment data model.
    /// Optional grouping of enrollment accounts to segment costs into logical groupings and set budgets.
    /// </summary>
    public partial class BillingDepartmentData : ResourceData
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="BillingDepartmentData"/>. </summary>
        ...
        internal BillingDepartmentData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, BillingDepartmentProperties properties, IDictionary<string, string> tags, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
        ...
        [WirePath("properties")]
        public BillingDepartmentProperties Properties { get; set; }
