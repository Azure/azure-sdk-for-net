...
namespace Azure.ResourceManager.Billing
{
    ...
    public partial class BillingDepartmentData : ResourceData
    {
        ...
        internal BillingDepartmentData()
        {
        ...
        internal BillingDepartmentData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, BillingDepartmentProperties properties, IDictionary<string, string> tags) : base(id, name, resourceType, systemData)
        {
        ...
        /// <summary> Optional grouping of enrollment accounts to segment costs into logical groupings and set budgets. </summary>
        public BillingDepartmentProperties Properties { get; }
