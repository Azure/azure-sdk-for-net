...
namespace Azure.ResourceManager.Billing
{
    ...
    /// Each <see cref="BillingEnrollmentAccountRoleDefinitionResource"/> in the collection will belong to the same instance of <see cref="BillingAccountEnrollmentAccountResource"/>.
    /// To get a <see cref="BillingEnrollmentAccountRoleDefinitionCollection"/> instance call the GetBillingEnrollmentAccountRoleDefinitions method from an instance of <see cref="BillingAccountEnrollmentAccountResource"/>.
    /// </summary>
    public partial class BillingEnrollmentAccountRoleDefinitionCollection : ArmCollection, IEnumerable<BillingEnrollmentAccountRoleDefinitionResource>, IAsyncEnumerable<BillingEnrollmentAccountRoleDefinitionResource>
    {
        ...
        public virtual AsyncPageable<BillingEnrollmentAccountRoleDefinitionResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<BillingEnrollmentAccountRoleDefinitionData, BillingEnrollmentAccountRoleDefinitionResource>(new BillingRoleDefinitionGetByEnrollmentAccountAsyncCollectionResultOfT(_billingRoleDefinitionRestClient, Id.Parent.Name, Id.Name, context, "BillingEnrollmentAccountRoleDefinitionCollection.GetAll"), data => new BillingEnrollmentAccountRoleDefinitionResource(Client, data));
        }
        ...
        public virtual Pageable<BillingEnrollmentAccountRoleDefinitionResource> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            return new PageableWrapper<BillingEnrollmentAccountRoleDefinitionData, BillingEnrollmentAccountRoleDefinitionResource>(new BillingRoleDefinitionGetByEnrollmentAccountCollectionResultOfT(_billingRoleDefinitionRestClient, Id.Parent.Name, Id.Name, context, "BillingEnrollmentAccountRoleDefinitionCollection.GetAll"), data => new BillingEnrollmentAccountRoleDefinitionResource(Client, data));
        }
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string roleDefinitionName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                Response<BillingEnrollmentAccountRoleDefinitionData> response = default;
                switch (result.Status)
                {
                    case 200:
                        response = Response.FromValue(BillingEnrollmentAccountRoleDefinitionData.FromResponse(result), result);
                        break;
                    case 404:
                        response = Response.FromValue((BillingEnrollmentAccountRoleDefinitionData)null, result);
                        break;
                    default:
