...
namespace Azure.ResourceManager.Billing
{
    ...
    public partial class BillingRoleAssignmentData : ResourceData
    {
        ...
        internal BillingRoleAssignmentData()
        {
        ...
        internal BillingRoleAssignmentData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, BillingRoleAssignmentProperties properties, IDictionary<string, string> tags) : base(id, name, resourceType, systemData)
        {
        ...
        /// <summary> The properties of the billing role assignment. </summary>
        public BillingRoleAssignmentProperties Properties { get; }
