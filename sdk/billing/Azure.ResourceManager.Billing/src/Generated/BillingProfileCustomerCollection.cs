...
namespace Azure.ResourceManager.Billing
{
    ...
    public partial class BillingProfileCustomerCollection : ArmCollection, IEnumerable<BillingProfileCustomerResource>, IAsyncEnumerable<BillingProfileCustomerResource>
    {
        ...
        /// <summary> Initializes a new instance of BillingProfileCustomerCollection for mocking. </summary>
        protected BillingProfileCustomerCollection()
        {
        }

        /// <summary> Initializes a new instance of <see cref="BillingProfileCustomerCollection"/> class. </summary>
        ...
        {
            TryGetApiVersion(BillingProfileCustomerResource.ResourceType, out string billingProfileCustomerApiVersion);
            _customersClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Billing", BillingProfileCustomerResource.ResourceType.Namespace, Diagnostics);
            _customersRestClient = new Customers(_customersClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, billingProfileCustomerApiVersion ?? "2024-04-01");
        ...
        public virtual async Task<Response<BillingProfileCustomerResource>> GetAsync(string customerName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _customersClientDiagnostics.CreateScope("BillingProfileCustomerCollection.Get");
            scope.Start();
            try
            {
        ...
        public virtual AsyncPageable<BillingProfileCustomerResource> GetAllAsync(string expand = default, string filter = default, string orderBy = default, long? maxCount = default, long? skip = default, bool? count = default, string search = default, CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
            ...
            return new AsyncPageableWrapper<BillingCustomerData, BillingProfileCustomerResource>(new CustomersGetByBillingProfileAsyncCollectionResultOfT(
                ...
                search,
                context,
                "BillingProfileCustomerCollection.GetAll"), data => new BillingProfileCustomerResource(Client, data));
        }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> A collection of <see cref="BillingProfileCustomerResource"/> that may take multiple service requests to iterate over. </returns>
        public virtual Pageable<BillingProfileCustomerResource> GetAll(string expand = default, string filter = default, string orderBy = default, long? maxCount = default, long? skip = default, bool? count = default, string search = default, CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string customerName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _customersClientDiagnostics.CreateScope("BillingProfileCustomerCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual async Task<NullableResponse<BillingProfileCustomerResource>> GetIfExistsAsync(string customerName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _customersClientDiagnostics.CreateScope("BillingProfileCustomerCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
