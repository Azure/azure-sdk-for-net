...
namespace Azure.ResourceManager.Billing
{
    ...
    public partial class SubscriptionPolicyData : ResourceData
    {
        ...
        internal SubscriptionPolicyData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, SubscriptionPolicyProperties properties, IDictionary<string, string> tags, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, name, resourceType, systemData)
        {
