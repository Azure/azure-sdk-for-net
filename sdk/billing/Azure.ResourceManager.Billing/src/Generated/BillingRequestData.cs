...
namespace Azure.ResourceManager.Billing
{
    ...
    public partial class BillingRequestData : ResourceData
    {
        ...
        internal BillingRequestData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, BillingRequestProperties properties, IDictionary<string, string> tags) : base(id, name, resourceType, systemData)
        {
