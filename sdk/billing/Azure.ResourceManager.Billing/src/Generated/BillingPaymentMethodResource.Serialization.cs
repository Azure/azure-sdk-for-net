...
namespace Azure.ResourceManager.Billing
{
    public partial class BillingPaymentMethodResource : IJsonModel<BillingPaymentMethodData>
    {
        ...
        {
            return ModelReaderWriter.Read<BillingPaymentMethodData>(new BinaryData(reader.ValueSequence), options);
        }
        ...
        {
            return ModelReaderWriter.Read<BillingPaymentMethodData>(data, options);
        }
