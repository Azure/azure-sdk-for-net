...
namespace Azure.ResourceManager.Billing
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="BillingCustomerRoleDefinitionResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="BillingCustomerResource"/> using the GetBillingCustomerRoleDefinitions method.
    /// </summary>
    public partial class BillingCustomerRoleDefinitionResource : ArmResource
    {
        ...
        private readonly BillingCustomerRoleDefinitionData _data;
        ...
        /// <summary> Initializes a new instance of BillingCustomerRoleDefinitionResource for mocking. </summary>
        protected BillingCustomerRoleDefinitionResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="BillingCustomerRoleDefinitionResource"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="data"> The resource that is the target of operations. </param>
        internal BillingCustomerRoleDefinitionResource(ArmClient client, BillingCustomerRoleDefinitionData data) : this(client, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        {
            TryGetApiVersion(ResourceType, out string billingCustomerRoleDefinitionApiVersion);
        ...
        public virtual BillingCustomerRoleDefinitionData Data
        {
            get
            {
                if (!HasData)
        ...
        {
            string resourceId = $"/providers/Microsoft.Billing/billingAccounts/{billingAccountName}/billingProfiles/{billingProfileName}/customers/{customerName}/billingRoleDefinitions/{roleDefinitionName}";
        ...
        {
            using DiagnosticScope scope = _billingRoleDefinitionClientDiagnostics.CreateScope("BillingCustomerRoleDefinitionResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _billingRoleDefinitionRestClient.CreateGetByCustomerRequest(Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<BillingCustomerRoleDefinitionData> response = Response.FromValue(BillingCustomerRoleDefinitionData.FromResponse(result), result);
