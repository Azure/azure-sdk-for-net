...
namespace Azure.ResourceManager.Billing
{
    ...
    /// Otherwise you can get one from its parent resource <see cref="BillingProfileCustomerResource"/> using the GetBillingCustomerRoleDefinitions method.
    /// </summary>
    public partial class BillingCustomerRoleDefinitionResource : ArmResource
    {
        ...
        internal BillingCustomerRoleDefinitionResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _billingRoleDefinitionRestClient = new BillingRoleDefinition(_billingRoleDefinitionClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, billingCustomerRoleDefinitionApiVersion ?? "2024-04-01");
