...
{
    public partial class TransferDetailData : IUtf8JsonSerializable, IJsonModel<TransferDetailData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TransferDetailData>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<TransferDetailData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<TransferDetailData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(TransferDetailData)} does not support writing '{format}' format.");
            }
        ...
        TransferDetailData IJsonModel<TransferDetailData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<TransferDetailData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(TransferDetailData)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeTransferDetailData(document.RootElement, options);
        }

        internal static TransferDetailData DeserializeTransferDetailData(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<TransferDetailData>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<TransferDetailData>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(TransferDetailData)} does not support writing '{options.Format}' format.");
            }
        }

        TransferDetailData IPersistableModel<TransferDetailData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<TransferDetailData>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(TransferDetailData)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<TransferDetailData>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
