...
{
    public partial class Sample_InvoiceSectionCollection
    {
        // InvoiceSectionsGet
        ...
        public async Task Get_InvoiceSectionsGet()
        {
            ...
            // get the collection of this InvoiceSectionResource
            InvoiceSectionCollection collection = billingProfile.GetInvoiceSections();

            // invoke the operation
            string invoiceSectionName = "yyyy-yyyy-yyy-yyy";
            InvoiceSectionResource result = await collection.GetAsync(invoiceSectionName);
        ...
        public async Task GetIfExists_InvoiceSectionsGet()
        {
            ...
            // invoke the operation
            string invoiceSectionName = "yyyy-yyyy-yyy-yyy";
            NullableResponse<InvoiceSectionResource> response = await collection.GetIfExistsAsync(invoiceSectionName);
            InvoiceSectionResource result = response.HasValue ? response.Value : null;
...
["pcCode"] = "A123456",
            ...
            ArmOperation<InvoiceSectionResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, invoiceSectionName, data);
        ...
        public async Task GetAll_InvoiceSectionsListByBillingProfile()
        {
            ...
            InvoiceSectionCollectionGetAllOptions options = new InvoiceSectionCollectionGetAllOptions() { IncludeDeleted = true };
            await foreach (InvoiceSectionResource item in collection.GetAllAsync(options))
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                InvoiceSectionData resourceData = item.Data;
                // for demo we just print out the id
                Console.WriteLine($"Succeeded on id: {resourceData.Id}");
            }
