...
{
    public partial class Sample_BillingAccountBillingRoleAssignmentCollection
    {
        ...
        public async Task Get_BillingRoleAssignmentGetByBillingAccount()
        {
            ...
            // get the collection of this BillingAccountBillingRoleAssignmentResource
            BillingAccountBillingRoleAssignmentCollection collection = billingAccount.GetBillingAccountBillingRoleAssignments();

            // invoke the operation
            string billingRoleAssignmentName = "10000000-aaaa-bbbb-cccc-100000000000_6fd330f6-7d26-4aff-b9cf-7bd699f965b9";
            BillingAccountBillingRoleAssignmentResource result = await collection.GetAsync(billingRoleAssignmentName);
        ...
        public async Task GetIfExists_BillingRoleAssignmentGetByBillingAccount()
        {
            ...
            // invoke the operation
            string billingRoleAssignmentName = "10000000-aaaa-bbbb-cccc-100000000000_6fd330f6-7d26-4aff-b9cf-7bd699f965b9";
            NullableResponse<BillingAccountBillingRoleAssignmentResource> response = await collection.GetIfExistsAsync(billingRoleAssignmentName);
            BillingAccountBillingRoleAssignmentResource result = response.HasValue ? response.Value : null;
        ...
        public async Task CreateOrUpdate_BillingRoleAssignmentCreateOrUpdateByBillingAccount()
        {
            ...
            ArmOperation<BillingAccountBillingRoleAssignmentResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, billingRoleAssignmentName, data);
        ...
        public async Task GetAll_BillingRoleAssignmentListByBillingAccount()
        {
            ...
            await foreach (BillingAccountBillingRoleAssignmentResource item in collection.GetAllAsync())
            {
