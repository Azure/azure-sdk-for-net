...
namespace Azure.ResourceManager.Billing.Samples
{
    public partial class Sample_BillingInvoiceResource
    {
        ...
        public async Task Amend_InvoicesAmend()
        {
            ...
            // invoke the operation
            await billingInvoice.AmendAsync(WaitUntil.Completed).ConfigureAwait(false);
        ...
        public async Task DownloadByBillingAccount_InvoicesDownloadByBillingAccount()
        {
            ...
            ArmOperation<BillingDocumentDownloadResult> lro = await billingInvoice.DownloadByBillingAccountAsync(WaitUntil.Completed, documentName);
