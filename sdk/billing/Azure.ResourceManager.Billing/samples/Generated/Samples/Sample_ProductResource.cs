...
namespace Azure.ResourceManager.Billing.Samples
{
    public partial class Sample_ProductResource
    {
        ...
        public async Task Move_ProductMove()
        {
            ...
            ResourceIdentifier productResourceId = ProductResource.CreateResourceIdentifier(billingAccountName, productName);
            ...
            ArmOperation<ProductResource> lro = await product.MoveAsync(WaitUntil.Completed, moveProductRequest);
        ...
        public async Task ValidateMoveEligibility_ProductValidateMoveFailure()
        {
            ...
            // invoke the operation
            MoveProductRequest moveProductRequest = new MoveProductRequest("/providers/Microsoft.Billing/billingAccounts/a1a9c77e-4cec-4a6c-a089-867d973a6074:a80d3b1f-c626-4e5e-82ed-1173bd91c838_2019-05-31/billingProfiles/ea36e548-1505-41db-bebc-46fff3d37998/invoiceSections/Q7GV-UUVA-PJA-TGB");
            MoveProductEligibilityResult result = await product.ValidateMoveEligibilityAsync(moveProductRequest);
        ...
        public async Task Update_ProductsUpdate()
        {
            ...
            ProductResource result = await product.UpdateAsync(patch);
