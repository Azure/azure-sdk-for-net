...
{
    public partial class Sample_ReservationCollection
    {
        ...
        public async Task Get_ReservationGetByBillingAccount()
        {
            ...
            // get the collection of this ReservationResource
            ReservationCollection collection = reservationOrder.GetReservations();

            // invoke the operation
            string reservationId = "30000000-0000-0000-0000-000000000000";
            ReservationResource result = await collection.GetAsync(reservationId);
        ...
        public async Task GetIfExists_ReservationGetByBillingAccount()
        {
            ...
            // invoke the operation
            string reservationId = "30000000-0000-0000-0000-000000000000";
            NullableResponse<ReservationResource> response = await collection.GetIfExistsAsync(reservationId);
            ReservationResource result = response.HasValue ? response.Value : null;
        ...
        public async Task GetAll_ReservationsGetFromOrderByBillingAccount()
        {
            ...
            await foreach (ReservationResource item in collection.GetAllAsync())
            {
