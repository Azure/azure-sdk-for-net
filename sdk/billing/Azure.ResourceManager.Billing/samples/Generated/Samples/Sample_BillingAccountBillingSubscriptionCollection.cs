...
{
    public partial class Sample_BillingAccountBillingSubscriptionCollection
    {
        ...
        public async Task Get_BillingSubscriptionsGet()
        {
            ...
            // get the collection of this BillingAccountBillingSubscriptionResource
            BillingAccountBillingSubscriptionCollection collection = billingAccount.GetBillingAccountBillingSubscriptions();

            // invoke the operation
            string billingSubscriptionName = "11111111-1111-1111-1111-111111111111";
            BillingAccountBillingSubscriptionResource result = await collection.GetAsync(billingSubscriptionName);
        ...
        public async Task GetIfExists_BillingSubscriptionsGet()
        {
            ...
            // invoke the operation
            string billingSubscriptionName = "11111111-1111-1111-1111-111111111111";
            NullableResponse<BillingAccountBillingSubscriptionResource> response = await collection.GetIfExistsAsync(billingSubscriptionName);
            BillingAccountBillingSubscriptionResource result = response.HasValue ? response.Value : null;
        ...
        public async Task GetAll_BillingSubscriptionsListByBillingAccount()
        {
            ...
            BillingAccountBillingSubscriptionCollectionGetAllOptions options = new BillingAccountBillingSubscriptionCollectionGetAllOptions() { IncludeDeleted = false, IncludeTenantSubscriptions = false };
            await foreach (BillingAccountBillingSubscriptionResource item in collection.GetAllAsync(options))
            {
