...
{
    public partial class Sample_BillingAccountBillingProfileBillingSubscriptionCollection
    {
        ...
        public async Task Get_BillingSubscriptionGetByBillingProfile()
        {
            ...
            // get the collection of this BillingAccountBillingProfileBillingSubscriptionResource
            BillingAccountBillingProfileBillingSubscriptionCollection collection = billingProfile.GetBillingAccountBillingProfileBillingSubscriptions();

            // invoke the operation
            string billingSubscriptionName = "6b96d3f2-9008-4a9d-912f-f87744185aa3";
            BillingAccountBillingProfileBillingSubscriptionResource result = await collection.GetAsync(billingSubscriptionName);
        ...
        public async Task GetIfExists_BillingSubscriptionGetByBillingProfile()
        {
            ...
            // invoke the operation
            string billingSubscriptionName = "6b96d3f2-9008-4a9d-912f-f87744185aa3";
            NullableResponse<BillingAccountBillingProfileBillingSubscriptionResource> response = await collection.GetIfExistsAsync(billingSubscriptionName);
            BillingAccountBillingProfileBillingSubscriptionResource result = response.HasValue ? response.Value : null;
        ...
        public async Task GetAll_BillingSubscriptionsListByBillingProfileEA()
        {
            ...
            BillingAccountBillingProfileBillingSubscriptionCollectionGetAllOptions options = new BillingAccountBillingProfileBillingSubscriptionCollectionGetAllOptions() { };
            await foreach (BillingAccountBillingProfileBillingSubscriptionResource item in collection.GetAllAsync(options))
            {
