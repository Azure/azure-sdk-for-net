...
{
    public partial class Sample_BillingAccountEnrollmentAccountBillingRoleAssignmentResource
    {
        ...
        public async Task Delete_BillingRoleAssignmentDeleteByEnrollmentAccount()
        {
            ...
            // this example assumes you already have this BillingAccountEnrollmentAccountBillingRoleAssignmentResource created on azure
            // for more information of creating BillingAccountEnrollmentAccountBillingRoleAssignmentResource, please refer to the document of BillingAccountEnrollmentAccountBillingRoleAssignmentResource
            ...
            ResourceIdentifier billingAccountEnrollmentAccountBillingRoleAssignmentResourceId = BillingAccountEnrollmentAccountBillingRoleAssignmentResource.CreateResourceIdentifier(billingAccountName, enrollmentAccountName, billingRoleAssignmentName);
            BillingAccountEnrollmentAccountBillingRoleAssignmentResource billingAccountEnrollmentAccountBillingRoleAssignment = client.GetBillingAccountEnrollmentAccountBillingRoleAssignmentResource(billingAccountEnrollmentAccountBillingRoleAssignmentResourceId);

            // invoke the operation
            await billingAccountEnrollmentAccountBillingRoleAssignment.DeleteAsync(WaitUntil.Completed);
        ...
        public async Task Get_BillingRoleAssignmentGetByEnrollmentAccount()
        {
            ...
            // invoke the operation
            BillingAccountEnrollmentAccountBillingRoleAssignmentResource result = await billingAccountEnrollmentAccountBillingRoleAssignment.GetAsync();
        ...
        public async Task Update_BillingRoleAssignmentCreateOrUpdateByEnrollmentAccount()
        {
            ...
            ArmOperation<BillingAccountEnrollmentAccountBillingRoleAssignmentResource> lro = await billingAccountEnrollmentAccountBillingRoleAssignment.UpdateAsync(WaitUntil.Completed, data);
            BillingAccountEnrollmentAccountBillingRoleAssignmentResource result = lro.Value;
