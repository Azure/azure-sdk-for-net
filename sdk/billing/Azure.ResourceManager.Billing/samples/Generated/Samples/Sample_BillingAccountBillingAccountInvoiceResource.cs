...
{
    public partial class Sample_BillingAccountBillingAccountInvoiceResource
    {
        // InvoicesAmend
        ...
        public async Task Amend_InvoicesAmend()
        {
            ...
            // this example assumes you already have this BillingAccountBillingAccountInvoiceResource created on azure
            // for more information of creating BillingAccountBillingAccountInvoiceResource, please refer to the document of BillingAccountBillingAccountInvoiceResource
            string billingAccountName = "00000000-0000-0000-0000-000000000000:00000000-0000-0000-0000-000000000000_2019-05-31";
            string invoiceName = "G123456789";
            ResourceIdentifier billingAccountBillingAccountInvoiceResourceId = BillingAccountBillingAccountInvoiceResource.CreateResourceIdentifier(billingAccountName, invoiceName);
            BillingAccountBillingAccountInvoiceResource billingAccountBillingAccountInvoice = client.GetBillingAccountBillingAccountInvoiceResource(billingAccountBillingAccountInvoiceResourceId);

            // invoke the operation
            await billingAccountBillingAccountInvoice.AmendAsync(WaitUntil.Completed);
        ...
        public async Task DownloadByBillingAccount_InvoicesDownloadByBillingAccount()
        {
            ...
            ArmOperation<DocumentDownloadResult> lro = await billingAccountBillingAccountInvoice.DownloadByBillingAccountAsync(WaitUntil.Completed, documentName: documentName);
        ...
        public async Task DownloadSummaryByBillingAccount_InvoicesDownloadSummaryByBillingAccount()
        {
            ...
            // invoke the operation
            ArmOperation<DocumentDownloadResult> lro = await billingAccountBillingAccountInvoice.DownloadSummaryByBillingAccountAsync(WaitUntil.Completed);
            DocumentDownloadResult result = lro.Value;
        ...
        public async Task Get_InvoicesGetByBillingAccount()
        {
            ...
            // invoke the operation
            BillingAccountBillingAccountInvoiceResource result = await billingAccountBillingAccountInvoice.GetAsync();
        ...
        public async Task GetTransactions_TransactionsListByInvoice()
        {
            ...
            BillingAccountBillingAccountInvoiceResourceGetTransactionsOptions options = new BillingAccountBillingAccountInvoiceResourceGetTransactionsOptions() { };
            await foreach (Transaction item in billingAccountBillingAccountInvoice.GetTransactionsAsync(options))
            {
        ...
        public async Task TransactionsDownloadByInvoiceTransaction_TransactionsDownloadByInvoice()
        {
            ...
            // invoke the operation
            ArmOperation<DocumentDownloadResult> lro = await billingAccountBillingAccountInvoice.TransactionsDownloadByInvoiceTransactionAsync(WaitUntil.Completed);
            DocumentDownloadResult result = lro.Value;
        ...
        public async Task GetTransactionSummaryByInvoiceTransaction_TransactionSummaryGetByInvoice()
        {
            ...
            // invoke the operation
            TransactionSummary result = await billingAccountBillingAccountInvoice.GetTransactionSummaryByInvoiceTransactionAsync();
