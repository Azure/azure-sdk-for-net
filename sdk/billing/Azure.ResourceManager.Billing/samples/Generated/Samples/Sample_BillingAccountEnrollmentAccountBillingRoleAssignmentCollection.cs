...
{
    public partial class Sample_BillingAccountEnrollmentAccountBillingRoleAssignmentCollection
    {
        ...
        public async Task Get_BillingRoleAssignmentGetByEnrollmentAccount()
        {
            ...
            // get the collection of this BillingAccountEnrollmentAccountBillingRoleAssignmentResource
            BillingAccountEnrollmentAccountBillingRoleAssignmentCollection collection = billingAccountEnrollmentAccount.GetBillingAccountEnrollmentAccountBillingRoleAssignments();

            // invoke the operation
            string billingRoleAssignmentName = "9dfd08c2-62a3-4d47-85bd-1cdba1408402";
            BillingAccountEnrollmentAccountBillingRoleAssignmentResource result = await collection.GetAsync(billingRoleAssignmentName);
        ...
        public async Task GetIfExists_BillingRoleAssignmentGetByEnrollmentAccount()
        {
            ...
            // invoke the operation
            string billingRoleAssignmentName = "9dfd08c2-62a3-4d47-85bd-1cdba1408402";
            NullableResponse<BillingAccountEnrollmentAccountBillingRoleAssignmentResource> response = await collection.GetIfExistsAsync(billingRoleAssignmentName);
            BillingAccountEnrollmentAccountBillingRoleAssignmentResource result = response.HasValue ? response.Value : null;
        ...
        public async Task CreateOrUpdate_BillingRoleAssignmentCreateOrUpdateByEnrollmentAccount()
        {
            ...
            ArmOperation<BillingAccountEnrollmentAccountBillingRoleAssignmentResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, billingRoleAssignmentName, data);
        ...
        public async Task GetAll_BillingRoleAssignmentListByEnrollmentAccount()
        {
            ...
            await foreach (BillingAccountEnrollmentAccountBillingRoleAssignmentResource item in collection.GetAllAsync())
            {
