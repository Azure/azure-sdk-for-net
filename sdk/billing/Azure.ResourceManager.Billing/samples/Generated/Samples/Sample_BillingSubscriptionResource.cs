...
namespace Azure.ResourceManager.Billing.Samples
{
    public partial class Sample_BillingSubscriptionResource
    {
        ...
        public async Task Delete_BillingSubscriptionsDelete()
        {
            ...
            // invoke the operation
            await billingSubscription.DeleteAsync(WaitUntil.Completed).ConfigureAwait(false);
        ...
        public async Task Cancel_BillingSubscriptionsCancel()
        {
            ...
            await billingSubscription.CancelAsync(WaitUntil.Completed, content).ConfigureAwait(false);
