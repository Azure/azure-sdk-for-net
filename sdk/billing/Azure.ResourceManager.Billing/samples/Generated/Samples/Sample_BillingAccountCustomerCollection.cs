...
{
    public partial class Sample_BillingAccountCustomerCollection
    {
        ...
        public async Task Get_CustomersGetByBillingAccount()
        {
            ...
            // get the collection of this BillingAccountCustomerResource
            BillingAccountCustomerCollection collection = billingAccount.GetBillingAccountCustomers();

            // invoke the operation
            string customerName = "11111111-1111-1111-1111-111111111111";
            BillingAccountCustomerResource result = await collection.GetAsync(customerName);
        ...
        public async Task GetIfExists_CustomersGetByBillingAccount()
        {
            ...
            // invoke the operation
            string customerName = "11111111-1111-1111-1111-111111111111";
            NullableResponse<BillingAccountCustomerResource> response = await collection.GetIfExistsAsync(customerName);
            BillingAccountCustomerResource result = response.HasValue ? response.Value : null;
        ...
        public async Task GetAll_CustomersListByBillingAccount()
        {
            ...
            BillingAccountCustomerCollectionGetAllOptions options = new BillingAccountCustomerCollectionGetAllOptions() { };
            await foreach (BillingAccountCustomerResource item in collection.GetAllAsync(options))
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                CustomerData resourceData = item.Data;
                // for demo we just print out the id
                Console.WriteLine($"Succeeded on id: {resourceData.Id}");
            }
        ...
        public async Task GetAll_CustomersListByBillingAccountWithExpand()
        {
            ...
            // invoke the operation and iterate over the result
            BillingAccountCustomerCollectionGetAllOptions options = new BillingAccountCustomerCollectionGetAllOptions() { Expand = "enabledAzurePlans,resellers" };
            await foreach (BillingAccountCustomerResource item in collection.GetAllAsync(options))
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
