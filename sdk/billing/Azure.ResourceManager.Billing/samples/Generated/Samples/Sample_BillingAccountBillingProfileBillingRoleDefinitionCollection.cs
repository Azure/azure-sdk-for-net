...
{
    public partial class Sample_BillingAccountBillingProfileBillingRoleDefinitionCollection
    {
        ...
        public async Task Get_BillingRoleDefinitionGetByBillingProfile()
        {
            ...
            // get the collection of this BillingAccountBillingProfileBillingRoleDefinitionResource
            BillingAccountBillingProfileBillingRoleDefinitionCollection collection = billingProfile.GetBillingAccountBillingProfileBillingRoleDefinitions();

            // invoke the operation
            string roleDefinitionName = "40000000-aaaa-bbbb-cccc-100000000000";
            BillingAccountBillingProfileBillingRoleDefinitionResource result = await collection.GetAsync(roleDefinitionName);
        ...
        public async Task GetIfExists_BillingRoleDefinitionGetByBillingProfile()
        {
            ...
            // invoke the operation
            string roleDefinitionName = "40000000-aaaa-bbbb-cccc-100000000000";
            NullableResponse<BillingAccountBillingProfileBillingRoleDefinitionResource> response = await collection.GetIfExistsAsync(roleDefinitionName);
            BillingAccountBillingProfileBillingRoleDefinitionResource result = response.HasValue ? response.Value : null;
        ...
        public async Task GetAll_BillingRoleDefinitionListByBillingProfile()
        {
            ...
            await foreach (BillingAccountBillingProfileBillingRoleDefinitionResource item in collection.GetAllAsync())
            {
