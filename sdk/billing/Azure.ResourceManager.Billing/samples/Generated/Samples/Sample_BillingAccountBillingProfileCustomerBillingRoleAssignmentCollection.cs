...
{
    public partial class Sample_BillingAccountBillingProfileCustomerBillingRoleAssignmentCollection
    {
        ...
        public async Task Get_BillingRoleAssignmentGetByCustomer()
        {
            ...
            // get the collection of this BillingAccountBillingProfileCustomerBillingRoleAssignmentResource
            BillingAccountBillingProfileCustomerBillingRoleAssignmentCollection collection = billingAccountBillingProfileCustomer.GetBillingAccountBillingProfileCustomerBillingRoleAssignments();

            // invoke the operation
            string billingRoleAssignmentName = "30000000-aaaa-bbbb-cccc-100000000000_6fd330f6-7d26-4aff-b9cf-7bd699f965b9";
            BillingAccountBillingProfileCustomerBillingRoleAssignmentResource result = await collection.GetAsync(billingRoleAssignmentName);
        ...
        public async Task GetIfExists_BillingRoleAssignmentGetByCustomer()
        {
            ...
            // invoke the operation
            string billingRoleAssignmentName = "30000000-aaaa-bbbb-cccc-100000000000_6fd330f6-7d26-4aff-b9cf-7bd699f965b9";
            NullableResponse<BillingAccountBillingProfileCustomerBillingRoleAssignmentResource> response = await collection.GetIfExistsAsync(billingRoleAssignmentName);
            BillingAccountBillingProfileCustomerBillingRoleAssignmentResource result = response.HasValue ? response.Value : null;
        ...
        public async Task GetAll_BillingRoleAssignmentListByCustomer()
        {
            ...
            await foreach (BillingAccountBillingProfileCustomerBillingRoleAssignmentResource item in collection.GetAllAsync())
            {
