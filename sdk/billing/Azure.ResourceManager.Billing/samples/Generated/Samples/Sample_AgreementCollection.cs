...
{
    public partial class Sample_AgreementCollection
    {
        // AgreementByName
        ...
        public async Task Get_AgreementByName()
        {
            ...
            // get the collection of this AgreementResource
            AgreementCollection collection = billingAccount.GetAgreements();

            // invoke the operation
            string agreementName = "ABC123";
            AgreementResource result = await collection.GetAsync(agreementName);
        ...
        public async Task GetIfExists_AgreementByName()
        {
            ...
            // invoke the operation
            string agreementName = "ABC123";
            NullableResponse<AgreementResource> response = await collection.GetIfExistsAsync(agreementName);
            AgreementResource result = response.HasValue ? response.Value : null;
        ...
        public async Task GetAll_AgreementsListByBillingAccount()
        {
            ...
            await foreach (AgreementResource item in collection.GetAllAsync(expand: expand))
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                AgreementData resourceData = item.Data;
                // for demo we just print out the id
                Console.WriteLine($"Succeeded on id: {resourceData.Id}");
            }
