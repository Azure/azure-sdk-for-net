...
{
    public partial class Sample_BillingAccountBillingSubscriptionResource
    {
        ...
        public async Task Cancel_BillingSubscriptionsCancel()
        {
            ...
            // this example assumes you already have this BillingAccountBillingSubscriptionResource created on azure
            // for more information of creating BillingAccountBillingSubscriptionResource, please refer to the document of BillingAccountBillingSubscriptionResource
            string billingAccountName = "00000000-0000-0000-0000-000000000000:00000000-0000-0000-0000-000000000000_2019-05-31";
            string billingSubscriptionName = "11111111-1111-1111-1111-111111111111";
            ResourceIdentifier billingAccountBillingSubscriptionResourceId = BillingAccountBillingSubscriptionResource.CreateResourceIdentifier(billingAccountName, billingSubscriptionName);
            BillingAccountBillingSubscriptionResource billingAccountBillingSubscription = client.GetBillingAccountBillingSubscriptionResource(billingAccountBillingSubscriptionResourceId);
            ...
            await billingAccountBillingSubscription.CancelAsync(WaitUntil.Completed, content);
        ...
        public async Task Merge_BillingSubscriptionsMerge()
        {
            ...
            ArmOperation<BillingAccountBillingSubscriptionResource> lro = await billingAccountBillingSubscription.MergeAsync(WaitUntil.Completed, content);
            BillingAccountBillingSubscriptionResource result = lro.Value;
        ...
        public async Task Move_BillingSubscriptionMove()
        {
            ...
            ArmOperation<BillingAccountBillingSubscriptionResource> lro = await billingAccountBillingSubscription.MoveAsync(WaitUntil.Completed, content);
            BillingAccountBillingSubscriptionResource result = lro.Value;
        ...
        public async Task Split_BillingSubscriptionsSplit()
        {
            ...
            ArmOperation<BillingAccountBillingSubscriptionResource> lro = await billingAccountBillingSubscription.SplitAsync(WaitUntil.Completed, content);
            BillingAccountBillingSubscriptionResource result = lro.Value;
        ...
        public async Task ValidateMoveEligibility_BillingSubscriptionValidateMoveFailure()
        {
            ...
            MoveBillingSubscriptionEligibilityResult result = await billingAccountBillingSubscription.ValidateMoveEligibilityAsync(content);
        ...
        public async Task Delete_BillingSubscriptionsDelete()
        {
            ...
            // invoke the operation
            await billingAccountBillingSubscription.DeleteAsync(WaitUntil.Completed);
        ...
        public async Task Get_BillingSubscriptionsGet()
        {
            ...
            // invoke the operation
            BillingAccountBillingSubscriptionResource result = await billingAccountBillingSubscription.GetAsync();
        ...
        public async Task Update_BillingSubscriptionsUpdate()
        {
            ...
            ArmOperation<BillingAccountBillingSubscriptionResource> lro = await billingAccountBillingSubscription.UpdateAsync(WaitUntil.Completed, patch);
            BillingAccountBillingSubscriptionResource result = lro.Value;
