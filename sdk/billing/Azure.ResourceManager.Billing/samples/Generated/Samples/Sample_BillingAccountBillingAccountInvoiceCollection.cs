...
{
    public partial class Sample_BillingAccountBillingAccountInvoiceCollection
    {
        ...
        public async Task Get_InvoicesGetByBillingAccount()
        {
            ...
            // get the collection of this BillingAccountBillingAccountInvoiceResource
            BillingAccountBillingAccountInvoiceCollection collection = billingAccount.GetBillingAccountBillingAccountInvoices();

            // invoke the operation
            string invoiceName = "G123456789";
            BillingAccountBillingAccountInvoiceResource result = await collection.GetAsync(invoiceName);
        ...
        public async Task GetIfExists_InvoicesGetByBillingAccount()
        {
            ...
            // invoke the operation
            string invoiceName = "G123456789";
            NullableResponse<BillingAccountBillingAccountInvoiceResource> response = await collection.GetIfExistsAsync(invoiceName);
            BillingAccountBillingAccountInvoiceResource result = response.HasValue ? response.Value : null;
        ...
        public async Task GetAll_InvoicesListByBillingAccount()
        {
            ...
            BillingAccountBillingAccountInvoiceCollectionGetAllOptions options = new BillingAccountBillingAccountInvoiceCollectionGetAllOptions() { PeriodStartDate = DateTimeOffset.Parse("2023-01-01"), PeriodEndDate = DateTimeOffset.Parse("2023-06-30") };
            await foreach (BillingAccountBillingAccountInvoiceResource item in collection.GetAllAsync(options))
            {
