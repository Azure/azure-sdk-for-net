...
{
    public partial class Sample_BillingAccountBillingProfileCustomerResource
    {
        ...
        public async Task GetBillingPermissions_BillingPermissionsListByCustomer()
        {
            ...
            await foreach (BillingPermission item in billingAccountBillingProfileCustomer.GetBillingPermissionsAsync())
            {
...
"Microsoft.Billing/billingAccounts/read","Microsoft.Subscription/subscriptions/write"
            ...
            await foreach (CheckAccessResponse item in billingAccountBillingProfileCustomer.CheckAccessBillingPermissionsAsync(checkAccessRequest))
            {
                Console.WriteLine($"Succeeded: {item}");
            }
        ...
        public async Task GetBillingRequests_BillingRequestsListByCustomer()
        {
            ...
            // invoke the operation and iterate over the result
            BillingAccountBillingProfileCustomerResourceGetBillingRequestsOptions options = new BillingAccountBillingProfileCustomerResourceGetBillingRequestsOptions() { };
            await foreach (BillingRequestResource item in billingAccountBillingProfileCustomer.GetBillingRequestsAsync(options))
            {
        ...
        public async Task CreateByCustomerBillingRoleAssignment_BillingRoleAssignmentCreateByCustomer()
        {
            ...
            ArmOperation<BillingRoleAssignmentData> lro = await billingAccountBillingProfileCustomer.CreateByCustomerBillingRoleAssignmentAsync(WaitUntil.Completed, billingRoleAssignmentProperties);
        ...
        public async Task ResolveByCustomerBillingRoleAssignment_ResolveBillingRoleAssignmentByCustomer()
        {
            ...
            // invoke the operation
            ArmOperation<BillingRoleAssignmentListResult> lro = await billingAccountBillingProfileCustomer.ResolveByCustomerBillingRoleAssignmentAsync(WaitUntil.Completed);
        ...
        public async Task GetBillingSubscriptions_BillingSubscriptionsListByCustomer()
        {
            ...
            // invoke the operation and iterate over the result
            BillingAccountBillingProfileCustomerResourceGetBillingSubscriptionsOptions options = new BillingAccountBillingProfileCustomerResourceGetBillingSubscriptionsOptions() { };
            await foreach (BillingSubscriptionData item in billingAccountBillingProfileCustomer.GetBillingSubscriptionsAsync(options))
            {
                // for demo we just print out the id
        ...
        public async Task Get_CustomersGet()
        {
            ...
            // invoke the operation
            BillingAccountBillingProfileCustomerResource result = await billingAccountBillingProfileCustomer.GetAsync();
        ...
        public async Task CreateOrUpdateByCustomerPolicy_PoliciesPutByCustomer()
        {
            ...
            ArmOperation<CustomerPolicyData> lro = await billingAccountBillingProfileCustomer.CreateOrUpdateByCustomerPolicyAsync(WaitUntil.Completed, data);
            CustomerPolicyData result = lro.Value;
        ...
        public async Task GetTransactions_TransactionsListByCustomer()
        {
            ...
            // invoke the operation and iterate over the result
            BillingAccountBillingProfileCustomerResourceGetTransactionsOptions options = new BillingAccountBillingProfileCustomerResourceGetTransactionsOptions(periodStartDate: DateTimeOffset.Parse("2024-04-01"), periodEndDate: DateTimeOffset.Parse("2023-05-30"), type: TransactionType.Billed) { Filter = "properties/date gt '2020-10-01'", Search = "storage" };
            await foreach (Transaction item in billingAccountBillingProfileCustomer.GetTransactionsAsync(options))
            {
                Console.WriteLine($"Succeeded: {item}");
            }
