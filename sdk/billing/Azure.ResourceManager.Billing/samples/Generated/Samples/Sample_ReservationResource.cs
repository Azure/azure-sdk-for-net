...
namespace Azure.ResourceManager.Billing.Samples
{
    public partial class Sample_ReservationResource
    {
        ...
        public async Task Get_ReservationGetByBillingAccount()
        {
            ...
            ResourceIdentifier reservationResourceId = ReservationResource.CreateResourceIdentifier(billingAccountName, reservationOrderId, reservationId);
            ReservationResource reservation = client.GetReservationResource(reservationResourceId);

            // invoke the operation
            ReservationResource result = await reservation.GetAsync();

            // the variable result is a resource, you could call other operations on this instance as well
            // but just for demo, we get its data from this resource instance
            ReservationData resourceData = result.Data;
        ...
        public async Task Update_ReservationUpdate()
        {
            ...
            // invoke the operation
            ReservationPatch patch = new ReservationPatch()
            {
                DisplayName = "NewName",
            };
            ArmOperation<ReservationResource> lro = await reservation.UpdateAsync(WaitUntil.Completed, patch);
            ReservationResource result = lro.Value;
