...
{
    public partial class Sample_AssociatedTenantCollection
    {
        ...
        public async Task Get_AssociatedTenantsGet()
        {
            ...
            // get the collection of this AssociatedTenantResource
            AssociatedTenantCollection collection = billingAccount.GetAssociatedTenants();

            // invoke the operation
            string associatedTenantName = "11111111-1111-1111-1111-111111111111";
            AssociatedTenantResource result = await collection.GetAsync(associatedTenantName);
        ...
        public async Task GetIfExists_AssociatedTenantsGet()
        {
            ...
            // invoke the operation
            string associatedTenantName = "11111111-1111-1111-1111-111111111111";
            NullableResponse<AssociatedTenantResource> response = await collection.GetIfExistsAsync(associatedTenantName);
            AssociatedTenantResource result = response.HasValue ? response.Value : null;
        ...
        public async Task CreateOrUpdate_AssociatedTenantsCreateOrUpdate()
        {
            ...
            ArmOperation<AssociatedTenantResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, associatedTenantName, data);
        ...
        public async Task GetAll_AssociatedTenantsListByBillingAccount()
        {
            ...
            AssociatedTenantCollectionGetAllOptions options = new AssociatedTenantCollectionGetAllOptions() { };
            await foreach (AssociatedTenantResource item in collection.GetAllAsync(options))
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                AssociatedTenantData resourceData = item.Data;
                // for demo we just print out the id
                Console.WriteLine($"Succeeded on id: {resourceData.Id}");
            }
