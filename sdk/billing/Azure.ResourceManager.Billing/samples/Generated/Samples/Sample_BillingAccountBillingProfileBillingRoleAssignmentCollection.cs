...
{
    public partial class Sample_BillingAccountBillingProfileBillingRoleAssignmentCollection
    {
        ...
        public async Task Get_BillingRoleAssignmentGetByBillingProfile()
        {
            ...
            // get the collection of this BillingAccountBillingProfileBillingRoleAssignmentResource
            BillingAccountBillingProfileBillingRoleAssignmentCollection collection = billingProfile.GetBillingAccountBillingProfileBillingRoleAssignments();

            // invoke the operation
            string billingRoleAssignmentName = "10000000-aaaa-bbbb-cccc-100000000000_6fd330f6-7d26-4aff-b9cf-7bd699f965b9";
            BillingAccountBillingProfileBillingRoleAssignmentResource result = await collection.GetAsync(billingRoleAssignmentName);
        ...
        public async Task GetIfExists_BillingRoleAssignmentGetByBillingProfile()
        {
            ...
            // invoke the operation
            string billingRoleAssignmentName = "10000000-aaaa-bbbb-cccc-100000000000_6fd330f6-7d26-4aff-b9cf-7bd699f965b9";
            NullableResponse<BillingAccountBillingProfileBillingRoleAssignmentResource> response = await collection.GetIfExistsAsync(billingRoleAssignmentName);
            BillingAccountBillingProfileBillingRoleAssignmentResource result = response.HasValue ? response.Value : null;
        ...
        public async Task GetAll_BillingRoleAssignmentListByBillingProfile()
        {
            ...
            await foreach (BillingAccountBillingProfileBillingRoleAssignmentResource item in collection.GetAllAsync())
            {
