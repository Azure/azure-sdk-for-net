...
{
    public partial class Sample_DepartmentResource
    {
        ...
        public async Task GetBillingPermissions_BillingPermissionsListByDepartment()
        {
            ...
            await foreach (BillingPermission item in department.GetBillingPermissionsAsync())
            {
...
"Microsoft.Billing/billingAccounts/read","Microsoft.Subscription/subscriptions/write"
            ...
            await foreach (CheckAccessResponse item in department.CheckAccessBillingPermissionsAsync(checkAccessRequest))
            {
                Console.WriteLine($"Succeeded: {item}");
            }
        ...
        public async Task Get_DepartmentGet()
        {
            ...
            DepartmentResource result = await department.GetAsync();
