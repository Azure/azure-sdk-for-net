...
namespace Azure.Provisioning.Billing
{
    ...
    public partial class BillingTransferError : ProvisionableConstruct
    {
        private BicepValue<string> _code;
        private BicepValue<string> _message;

        /// <summary> Creates a new BillingTransferError. </summary>
        ...
        /// <summary> Define all the provisionable properties for BillingTransferError. </summary>
        ...
        /// <summary> Define additional provisionable properties for BillingTransferError that are not part of the generated code. </summary>
