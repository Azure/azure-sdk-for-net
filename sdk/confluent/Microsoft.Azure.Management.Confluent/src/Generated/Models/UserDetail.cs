...
namespace Microsoft.Azure.Management.Confluent.Models
{
    ...
    public partial class UserDetail
    {
        ...
        public virtual void Validate()
        {
            ...
            {
                if (!System.Text.RegularExpressions.Regex.IsMatch(EmailAddress, "^[\\w\\.\\-+!%\"\\s]+@[a-zA-Z0-9_\\-]+?\\.[a-zA-Z0-9]{2,7}$"))
                {
                    throw new ValidationException(ValidationRules.Pattern, "EmailAddress", "^[\\w\\.\\-+!%\"\\s]+@[a-zA-Z0-9_\\-]+?\\.[a-zA-Z0-9]{2,7}$");
                }
            }
        }
    }
