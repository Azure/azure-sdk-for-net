...
namespace Microsoft.Azure.Management.Confluent
{
    ...
    /// </summary>
    internal partial class ValidationsOperations : IServiceOperations<ConfluentManagementClient>, IValidationsOperations
    {
        /// <summary>
        /// Initializes a new instance of the ValidationsOperations class.
        /// </summary>
        /// <param name='client'>
        ...
        /// </exception>
        internal ValidationsOperations(ConfluentManagementClient client)
        {
            if (client == null)
            {
