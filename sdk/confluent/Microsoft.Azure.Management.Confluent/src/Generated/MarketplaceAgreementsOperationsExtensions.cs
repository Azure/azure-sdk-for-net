...
namespace Microsoft.Azure.Management.Confluent
{
    ...
    public static partial class MarketplaceAgreementsOperationsExtensions
    {
            ...
            /// </param>
            public static ConfluentAgreementResource Create(this IMarketplaceAgreementsOperations operations, ConfluentAgreementProperties properties = default(ConfluentAgreementProperties))
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<ConfluentAgreementResource> CreateAsync(this IMarketplaceAgreementsOperations operations, ConfluentAgreementProperties properties = default(ConfluentAgreementProperties), CancellationToken cancellationToken = default(CancellationToken))
            {
