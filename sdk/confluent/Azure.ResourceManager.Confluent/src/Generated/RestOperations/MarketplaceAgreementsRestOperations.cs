...
namespace Azure.ResourceManager.Confluent
{
    internal partial class MarketplaceAgreementsRestOperations
    {
        ...
        internal RequestUriBuilder CreateCreateRequestUri(string subscriptionId, ConfluentAgreement body)
        {
            var uri = new RawRequestUriBuilder();
            uri.Reset(_endpoint);
            uri.AppendPath("/subscriptions/", false);
        ...
        internal HttpMessage CreateCreateRequest(string subscriptionId, ConfluentAgreement body)
        {
            ...
            if (body != null)
            {
                ...
                ((IJsonModel<ConfluentAgreement>)body).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
