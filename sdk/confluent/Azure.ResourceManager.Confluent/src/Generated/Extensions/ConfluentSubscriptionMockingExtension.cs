...
namespace Azure.ResourceManager.Confluent.Mocking
{
    ...
    internal partial class ConfluentSubscriptionMockingExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="ConfluentSubscriptionMockingExtension"/> class for mocking. </summary>
        protected ConfluentSubscriptionMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ConfluentSubscriptionMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ConfluentSubscriptionMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<ConfluentAgreement> GetMarketplaceAgreementsAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, ConfluentAgreement.DeserializeConfluentAgreement, MarketplaceAgreementsClientDiagnostics, Pipeline, "ConfluentSubscriptionMockingExtension.GetMarketplaceAgreements", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<ConfluentAgreement> GetMarketplaceAgreements(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => MarketplaceAgreementsRestClient.CreateListRequest(Id.SubscriptionId);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => MarketplaceAgreementsRestClient.CreateListNextPageRequest(nextLink, Id.SubscriptionId);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, ConfluentAgreement.DeserializeConfluentAgreement, MarketplaceAgreementsClientDiagnostics, Pipeline, "ConfluentSubscriptionMockingExtension.GetMarketplaceAgreements", "value", "nextLink", cancellationToken);
        }
        ...
        {
            using var scope = MarketplaceAgreementsClientDiagnostics.CreateScope("ConfluentSubscriptionMockingExtension.CreateMarketplaceAgreement");
            scope.Start();
            try
            {
