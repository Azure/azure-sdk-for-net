...
namespace Azure.ResourceManager.Confluent.Mock
{
    ...
    public partial class SubscriptionResourceExtension : ArmResource
    {
        ...
        private ClientDiagnostics MarketplaceAgreementsClientDiagnostics => _marketplaceAgreementsClientDiagnostics ??= new ClientDiagnostics("Azure.ResourceManager.Confluent.Mock", ProviderConstants.DefaultProviderNamespace, Diagnostics);
        ...
        public virtual AsyncPageable<ConfluentAgreement> GetMarketplaceAgreementsAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, ConfluentAgreement.DeserializeConfluentAgreement, MarketplaceAgreementsClientDiagnostics, Pipeline, "SubscriptionResourceExtension.GetMarketplaceAgreements", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<ConfluentAgreement> GetMarketplaceAgreements(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => MarketplaceAgreementsRestClient.CreateListRequest(Id.SubscriptionId);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => MarketplaceAgreementsRestClient.CreateListNextPageRequest(nextLink, Id.SubscriptionId);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, ConfluentAgreement.DeserializeConfluentAgreement, MarketplaceAgreementsClientDiagnostics, Pipeline, "SubscriptionResourceExtension.GetMarketplaceAgreements", "value", "nextLink", cancellationToken);
        }
        ...
        {
            using var scope = MarketplaceAgreementsClientDiagnostics.CreateScope("SubscriptionResourceExtension.CreateMarketplaceAgreement");
            scope.Start();
            try
            {
