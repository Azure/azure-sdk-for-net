...
namespace Azure.ResourceManager.Confluent.Testing
{
    /// <summary> A class to add extension methods to ResourceGroupResource. </summary>
    public partial class ConfluentResourceGroupResourceExtension : ArmResource
    {
        private ClientDiagnostics _validationsClientDiagnostics;
        private ValidationsRestOperations _validationsRestClient;

        /// <summary> Initializes a new instance of the <see cref="ConfluentResourceGroupResourceExtension"/> class for mocking. </summary>
        protected ConfluentResourceGroupResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ConfluentResourceGroupResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ConfluentResourceGroupResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual async Task<Response<ConfluentOrganizationResource>> ValidateOrganizationAsync(string organizationName, ConfluentOrganizationData data, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = ValidationsClientDiagnostics.CreateScope("ConfluentResourceGroupResourceExtension.ValidateOrganization");
            scope.Start();
            try
            {
