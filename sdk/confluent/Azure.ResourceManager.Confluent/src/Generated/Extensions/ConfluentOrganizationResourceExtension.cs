...
namespace Azure.ResourceManager.Confluent.Mock
{
    ...
    public partial class ConfluentOrganizationResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="ConfluentOrganizationResourceExtension"/> class for mocking. </summary>
        protected ConfluentOrganizationResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ConfluentOrganizationResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ConfluentOrganizationResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
