...
namespace Azure.ResourceManager.Confluent
{
    ...
    internal partial class SubscriptionResourceExtensionClient : ArmResource
    {
        ...
        public virtual AsyncPageable<ConfluentOrganizationResource> GetConfluentOrganizationsAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => { var data = ConfluentOrganizationData.DeserializeConfluentOrganizationData(e); return new ConfluentOrganizationResource(Client, data, data.Id); }, ConfluentOrganizationOrganizationClientDiagnostics, Pipeline, "SubscriptionResourceExtensionClient.GetConfluentOrganizations", "value", "nextLink", cancellationToken);
        }
