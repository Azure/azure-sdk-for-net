...
namespace Azure.ResourceManager.Confluent.Mocking
{
    ...
    internal partial class ConfluentResourceGroupMockingExtension : ArmResource
    {
        private ClientDiagnostics _validationsClientDiagnostics;
        private ValidationsRestOperations _validationsRestClient;

        /// <summary> Initializes a new instance of the <see cref="ConfluentResourceGroupMockingExtension"/> class for mocking. </summary>
        protected ConfluentResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ConfluentResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ConfluentResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        {
            using var scope = ValidationsClientDiagnostics.CreateScope("ConfluentResourceGroupMockingExtension.ValidateOrganization");
            scope.Start();
            try
            {
