...
namespace Azure.ResourceManager.Confluent.Testing
{
    ...
    public partial class ConfluentSubscriptionResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="ConfluentSubscriptionResourceExtension"/> class for mocking. </summary>
        protected ConfluentSubscriptionResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ConfluentSubscriptionResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ConfluentSubscriptionResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<ConfluentAgreement> GetMarketplaceAgreementsAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, ConfluentAgreement.DeserializeConfluentAgreement, MarketplaceAgreementsClientDiagnostics, Pipeline, "ConfluentSubscriptionResourceExtension.GetMarketplaceAgreements", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<ConfluentAgreement> GetMarketplaceAgreements(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => MarketplaceAgreementsRestClient.CreateListRequest(Id.SubscriptionId);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => MarketplaceAgreementsRestClient.CreateListNextPageRequest(nextLink, Id.SubscriptionId);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, ConfluentAgreement.DeserializeConfluentAgreement, MarketplaceAgreementsClientDiagnostics, Pipeline, "ConfluentSubscriptionResourceExtension.GetMarketplaceAgreements", "value", "nextLink", cancellationToken);
        }
        ...
        {
            using var scope = MarketplaceAgreementsClientDiagnostics.CreateScope("ConfluentSubscriptionResourceExtension.CreateMarketplaceAgreement");
            scope.Start();
            try
            {
