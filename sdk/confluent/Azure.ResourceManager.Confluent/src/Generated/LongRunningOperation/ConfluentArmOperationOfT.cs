...
namespace Azure.ResourceManager.Confluent
{
    internal partial class ConfluentArmOperation<T> : ArmOperation<T>
    {
        ...
        internal ConfluentArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
