...
{
    /// <summary></summary>
    internal partial class ConfluentOrganizationResourceOperationSource : IOperationSource<ConfluentOrganizationResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal ConfluentOrganizationResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
        ...
        ConfluentOrganizationResource IOperationSource<ConfluentOrganizationResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            ConfluentOrganizationData data = ConfluentOrganizationData.DeserializeConfluentOrganizationData(document.RootElement, ModelSerializationExtensions.WireOptions);
