...
namespace Azure.ResourceManager.Confluent.Models
{
    ...
    public static partial class ArmConfluentModelFactory
    {
        ...
        {
            return new ConfluentAgreement(id, name, resourceType, systemData, publisher, product, plan, licenseTextLink, privacyPolicyLink, retrieveOn, signature, isAccepted, new Dictionary<string, BinaryData>());
        }
        ...
        public static ConfluentOrganizationData ConfluentOrganizationData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, DateTimeOffset? createdOn = null, ConfluentProvisionState? provisioningState = null, Guid? organizationId = null, Uri ssoUri = null, ConfluentOfferDetail offerDetail = null, ConfluentUserDetail userDetail = null)
        {
            ...
            return new ConfluentOrganizationData(id, name, resourceType, systemData, tags, location, createdOn, provisioningState, organizationId, ssoUri, offerDetail, userDetail, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ConfluentOfferDetail(publisherId, id, planId, planName, termUnit, status, new Dictionary<string, BinaryData>());
        }
    }
}
