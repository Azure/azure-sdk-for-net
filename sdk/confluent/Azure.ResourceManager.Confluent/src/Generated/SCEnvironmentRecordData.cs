...
namespace Azure.ResourceManager.Confluent
{
    ...
    public partial class SCEnvironmentRecordData : ResourceData
    {
        ...
        internal SCEnvironmentRecordData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string kind, StreamGovernanceConfig streamGovernanceConfig, SCMetadataEntity metadata, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
            Kind = kind;
