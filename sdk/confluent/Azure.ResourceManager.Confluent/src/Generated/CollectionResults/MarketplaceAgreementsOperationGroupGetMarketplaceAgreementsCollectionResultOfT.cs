...
{
    internal partial class MarketplaceAgreementsOperationGroupGetMarketplaceAgreementsCollectionResultOfT : Pageable<ConfluentAgreement>
    {
        ...
        /// <returns> The pages of MarketplaceAgreementsOperationGroupGetMarketplaceAgreementsCollectionResultOfT as an enumerable collection. </returns>
        public override IEnumerable<Page<ConfluentAgreement>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                ConfluentAgreementListResult result = ConfluentAgreementListResult.FromResponse(response);
                yield return Page<ConfluentAgreement>.FromValues((IReadOnlyList<ConfluentAgreement>)result.Value, nextPage?.IsAbsoluteUri == true ? nextPage.AbsoluteUri : nextPage?.OriginalString, response);
