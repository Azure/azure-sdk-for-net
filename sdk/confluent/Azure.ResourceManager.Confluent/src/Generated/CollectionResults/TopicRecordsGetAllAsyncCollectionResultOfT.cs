...
{
    internal partial class TopicRecordsGetAllAsyncCollectionResultOfT : AsyncPageable<TopicRecordData>
    {
        ...
        /// <returns> The pages of TopicRecordsGetAllAsyncCollectionResultOfT as an enumerable collection. </returns>
        public override async IAsyncEnumerable<Page<TopicRecordData>> AsPages(string continuationToken, int? pageSizeHint)
        {
