...
{
    internal partial class ConnectorResourcesGetAllAsyncCollectionResultOfT : AsyncPageable<ConfluentConnectorData>
    {
        ...
        public ConnectorResourcesGetAllAsyncCollectionResultOfT(ConnectorResources client, Guid subscriptionId, string resourceGroupName, string organizationName, string environmentId, string clusterId, int? pageSize, string pageToken, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
