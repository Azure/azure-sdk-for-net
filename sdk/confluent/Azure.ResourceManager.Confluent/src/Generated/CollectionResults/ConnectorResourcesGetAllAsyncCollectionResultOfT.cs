...
{
    internal partial class ConnectorResourcesGetAllAsyncCollectionResultOfT : AsyncPageable<ConnectorResourceData>
    {
        ...
        public ConnectorResourcesGetAllAsyncCollectionResultOfT(ConnectorResources client, Guid subscriptionId, string resourceGroupName, string organizationName, string environmentId, string clusterId, int? pageSize, string pageToken, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        public override async IAsyncEnumerable<Page<ConnectorResourceData>> AsPages(string continuationToken, int? pageSizeHint)
        {
