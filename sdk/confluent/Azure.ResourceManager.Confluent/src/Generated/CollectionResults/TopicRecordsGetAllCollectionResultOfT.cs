...
{
    internal partial class TopicRecordsGetAllCollectionResultOfT : Pageable<TopicRecordData>
    {
        private readonly TopicRecords _client;
        ...
        /// <summary> Initializes a new instance of TopicRecordsGetAllCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public TopicRecordsGetAllCollectionResultOfT(TopicRecords client, Guid subscriptionId, string resourceGroupName, string organizationName, string environmentId, string clusterId, int? pageSize, string pageToken, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of TopicRecordsGetAllCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of TopicRecordsGetAllCollectionResultOfT as an enumerable collection. </returns>
        public override IEnumerable<Page<TopicRecordData>> AsPages(string continuationToken, int? pageSizeHint)
        {
