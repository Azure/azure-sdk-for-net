...
namespace Azure.ResourceManager.Confluent
{
    ...
    public partial class ConfluentOrganizationResource : ArmResource
    {
        ...
        /// <summary>
        /// Updates the ConfluentOrganization.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Confluent/organizations/{organizationName}. </description>
        ...
        public virtual async Task<ArmOperation<ConfluentOrganizationResource>> UpdateAsync(WaitUntil waitUntil, ConfluentOrganizationData data, CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _confluentOrganizationClientDiagnostics.CreateScope("ConfluentOrganizationResource.Update");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _confluentOrganizationRestClient.CreateCreateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, ConfluentOrganizationData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                ConfluentArmOperation<ConfluentOrganizationResource> operation = new ConfluentArmOperation<ConfluentOrganizationResource>(
                    new ConfluentOrganizationResourceOperationSource(Client),
                    _confluentOrganizationClientDiagnostics,
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<ConfluentOrganizationResource> Update(WaitUntil waitUntil, ConfluentOrganizationData data, CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _confluentOrganizationClientDiagnostics.CreateScope("ConfluentOrganizationResource.Update");
            scope.Start();
            try
