...
namespace Azure.ResourceManager.Confluent
{
    ...
    public partial class ConfluentOrganizationResource : ArmResource
    {
        ...
        /// <item>
        /// <term>Operation Id</term>
        /// <description>OrganizationResources_GetAccessEnvironments</description>
        /// </item>
        /// <item>
        /// <term>Default Api Version</term>
        /// <description>2025-07-17-preview</description>
        ...
        public virtual async Task<Response<AccessEnvironmentListResult>> GetAccessEnvironmentsAsync(AccessListContent content, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _confluentOrganizationOrganizationResourcesClientDiagnostics.CreateScope("ConfluentOrganizationResource.GetAccessEnvironments");
            scope.Start();
            try
            {
                var response = await _confluentOrganizationOrganizationResourcesRestClient.GetAccessEnvironmentsAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, content, cancellationToken).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
            {
        ...
        public virtual Response<AccessEnvironmentListResult> GetAccessEnvironments(AccessListContent content, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _confluentOrganizationOrganizationResourcesRestClient.GetAccessEnvironments(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, content, cancellationToken);
                return response;
            }
            catch (Exception e)
            {
