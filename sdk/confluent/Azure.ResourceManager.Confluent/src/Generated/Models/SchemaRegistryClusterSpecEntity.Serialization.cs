...
namespace Azure.ResourceManager.Confluent.Models
{
    ...
    public partial class SchemaRegistryClusterSpecEntity : IJsonModel<SchemaRegistryClusterSpecEntity>
    {
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual SchemaRegistryClusterSpecEntity PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<SchemaRegistryClusterSpecEntity>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<SchemaRegistryClusterSpecEntity>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        SchemaRegistryClusterSpecEntity IPersistableModel<SchemaRegistryClusterSpecEntity>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        SchemaRegistryClusterSpecEntity IJsonModel<SchemaRegistryClusterSpecEntity>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual SchemaRegistryClusterSpecEntity JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<SchemaRegistryClusterSpecEntity>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static SchemaRegistryClusterSpecEntity DeserializeSchemaRegistryClusterSpecEntity(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("region"u8))
                {
                    ...
                    region = SchemaRegistryClusterEnvironmentRegionEntity.DeserializeSchemaRegistryClusterEnvironmentRegionEntity(prop.Value, options);
                    continue;
                }
                if (prop.NameEquals("environment"u8))
                {
                    ...
                    environment = SchemaRegistryClusterEnvironmentRegionEntity.DeserializeSchemaRegistryClusterEnvironmentRegionEntity(prop.Value, options);
                    continue;
                }
