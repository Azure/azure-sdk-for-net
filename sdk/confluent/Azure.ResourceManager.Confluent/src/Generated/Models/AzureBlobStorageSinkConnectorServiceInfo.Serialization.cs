...
{
    public partial class AzureBlobStorageSinkConnectorServiceInfo : IUtf8JsonSerializable, IJsonModel<AzureBlobStorageSinkConnectorServiceInfo>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureBlobStorageSinkConnectorServiceInfo>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureBlobStorageSinkConnectorServiceInfo>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        AzureBlobStorageSinkConnectorServiceInfo IJsonModel<AzureBlobStorageSinkConnectorServiceInfo>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureBlobStorageSinkConnectorServiceInfo>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        BinaryData IPersistableModel<AzureBlobStorageSinkConnectorServiceInfo>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureBlobStorageSinkConnectorServiceInfo>)this).GetFormatFromOptions(options) : options.Format;
        ...
        AzureBlobStorageSinkConnectorServiceInfo IPersistableModel<AzureBlobStorageSinkConnectorServiceInfo>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureBlobStorageSinkConnectorServiceInfo>)this).GetFormatFromOptions(options) : options.Format;
