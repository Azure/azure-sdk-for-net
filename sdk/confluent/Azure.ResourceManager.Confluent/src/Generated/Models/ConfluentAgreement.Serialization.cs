...
namespace Azure.ResourceManager.Confluent.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ConfluentAgreement>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ConfluentAgreement>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ConfluentAgreement>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ConfluentAgreement>)} interface");
            }
        ...
        string IPersistableModel<ConfluentAgreement>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
