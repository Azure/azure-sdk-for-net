...
{
    public partial class ConfluentAgreement : IUtf8JsonSerializable, IJsonModel<ConfluentAgreement>, IPersistableModel<ConfluentAgreement>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(RetrieveOn))
            {
                ...
                builder.AppendLine($" '{RetrieveOn.Value.ToString()}'");
            }
