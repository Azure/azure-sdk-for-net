...
namespace Azure.ResourceManager.Confluent.Models
{
    ...
    public partial class AccessListUsersSuccessResponse
    {
        ...
        /// <summary> Initializes a new instance of <see cref="AccessListUsersSuccessResponse"/>. </summary>
        ...
        internal AccessListUsersSuccessResponse(string kind, ConfluentListMetadata metadata, IReadOnlyList<UserRecord> data, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Kind = kind;
            Metadata = metadata;
            Data = data;
