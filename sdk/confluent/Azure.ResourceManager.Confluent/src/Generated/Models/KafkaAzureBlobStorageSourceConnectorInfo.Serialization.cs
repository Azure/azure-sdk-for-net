...
{
    public partial class KafkaAzureBlobStorageSourceConnectorInfo : IUtf8JsonSerializable, IJsonModel<KafkaAzureBlobStorageSourceConnectorInfo>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<KafkaAzureBlobStorageSourceConnectorInfo>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<KafkaAzureBlobStorageSourceConnectorInfo>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        KafkaAzureBlobStorageSourceConnectorInfo IJsonModel<KafkaAzureBlobStorageSourceConnectorInfo>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<KafkaAzureBlobStorageSourceConnectorInfo>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        BinaryData IPersistableModel<KafkaAzureBlobStorageSourceConnectorInfo>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<KafkaAzureBlobStorageSourceConnectorInfo>)this).GetFormatFromOptions(options) : options.Format;
        ...
        KafkaAzureBlobStorageSourceConnectorInfo IPersistableModel<KafkaAzureBlobStorageSourceConnectorInfo>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<KafkaAzureBlobStorageSourceConnectorInfo>)this).GetFormatFromOptions(options) : options.Format;
