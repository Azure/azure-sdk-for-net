...
namespace Azure.ResourceManager.Confluent.Models
{
    ...
    public partial class AccessClusterListResult
    {
        ...
        internal AccessClusterListResult(string kind, ConfluentListMetadata metadata, IReadOnlyList<AccessClusterRecord> data, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Kind = kind;
            Metadata = metadata;
            Data = data;
