...
namespace Azure.ResourceManager.Confluent.Models
{
    ...
    public partial class UserRecord
    {
        ...
        /// <summary> Initializes a new instance of <see cref="UserRecord"/>. </summary>
        internal UserRecord()
        {
        }
        ...
        internal UserRecord(string kind, string id, MetadataEntity metadata, string email, string fullName, string authType, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Kind = kind;
            Id = id;
            Metadata = metadata;
