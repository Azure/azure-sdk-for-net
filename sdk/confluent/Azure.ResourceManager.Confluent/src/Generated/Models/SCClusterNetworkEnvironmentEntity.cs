...
namespace Azure.ResourceManager.Confluent.Models
{
    ...
    public partial class SCClusterNetworkEnvironmentEntity
    {
        ...
        internal SCClusterNetworkEnvironmentEntity(string id, string environment, string related, string resourceName, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
