...
namespace Azure.ResourceManager.Confluent.Models
{
    ...
    public partial class ClusterRecord
    {
        ...
        /// <summary> Initializes a new instance of <see cref="ClusterRecord"/>. </summary>
        ...
        internal ClusterRecord(string kind, string id, MetadataEntity metadata, string displayName, ClusterSpecEntity spec, ClusterStatusEntity status, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Kind = kind;
            Id = id;
            Metadata = metadata;
