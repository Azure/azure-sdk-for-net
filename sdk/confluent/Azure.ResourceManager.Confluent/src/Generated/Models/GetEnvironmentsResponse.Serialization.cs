...
namespace Azure.ResourceManager.Confluent.Models
{
    internal partial class GetEnvironmentsResponse : IUtf8JsonSerializable, IJsonModel<GetEnvironmentsResponse>
    {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<GetEnvironmentsResponse>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(GetEnvironmentsResponse)} does not support '{format}' format.");
            }

            writer.WriteStartObject();
            if (!(Value is ChangeTrackingList<SCEnvironmentRecord> collection && collection.IsUndefined))
            {
        ...
        GetEnvironmentsResponse IJsonModel<GetEnvironmentsResponse>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<GetEnvironmentsResponse>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static GetEnvironmentsResponse DeserializeGetEnvironmentsResponse(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            Optional<IReadOnlyList<SCEnvironmentRecord>> value = default;
            ...
            return new GetEnvironmentsResponse(Optional.ToList(value), nextLink.Value, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<GetEnvironmentsResponse>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(GetEnvironmentsResponse)} does not support '{options.Format}' format.");
            }
        }

        GetEnvironmentsResponse IPersistableModel<GetEnvironmentsResponse>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<GetEnvironmentsResponse>)this).GetFormatFromOptions(options) : options.Format;
