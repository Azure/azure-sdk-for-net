...
{
    public partial class KafkaAzureBlobStorageSinkConnectorInfo : IUtf8JsonSerializable, IJsonModel<KafkaAzureBlobStorageSinkConnectorInfo>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<KafkaAzureBlobStorageSinkConnectorInfo>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<KafkaAzureBlobStorageSinkConnectorInfo>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        KafkaAzureBlobStorageSinkConnectorInfo IJsonModel<KafkaAzureBlobStorageSinkConnectorInfo>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<KafkaAzureBlobStorageSinkConnectorInfo>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        BinaryData IPersistableModel<KafkaAzureBlobStorageSinkConnectorInfo>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<KafkaAzureBlobStorageSinkConnectorInfo>)this).GetFormatFromOptions(options) : options.Format;
        ...
        KafkaAzureBlobStorageSinkConnectorInfo IPersistableModel<KafkaAzureBlobStorageSinkConnectorInfo>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<KafkaAzureBlobStorageSinkConnectorInfo>)this).GetFormatFromOptions(options) : options.Format;
