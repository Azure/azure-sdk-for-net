...
namespace Azure.ResourceManager.Confluent.Models
{
    ...
    public partial class KafkaAzureBlobStorageSinkConnectorInfo : PartnerInfoBase, IJsonModel<KafkaAzureBlobStorageSinkConnectorInfo>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<KafkaAzureBlobStorageSinkConnectorInfo>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<KafkaAzureBlobStorageSinkConnectorInfo>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        KafkaAzureBlobStorageSinkConnectorInfo IPersistableModel<KafkaAzureBlobStorageSinkConnectorInfo>.Create(BinaryData data, ModelReaderWriterOptions options) => (KafkaAzureBlobStorageSinkConnectorInfo)PersistableModelCreateCore(data, options);

        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<KafkaAzureBlobStorageSinkConnectorInfo>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";

        /// <param name="writer"> The JSON writer. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        void IJsonModel<KafkaAzureBlobStorageSinkConnectorInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        KafkaAzureBlobStorageSinkConnectorInfo IJsonModel<KafkaAzureBlobStorageSinkConnectorInfo>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (KafkaAzureBlobStorageSinkConnectorInfo)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static KafkaAzureBlobStorageSinkConnectorInfo DeserializeKafkaAzureBlobStorageSinkConnectorInfo(JsonElement element, ModelReaderWriterOptions options)
        {
