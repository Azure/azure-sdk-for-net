...
namespace Azure.ResourceManager.Confluent.Models
{
    ...
    public partial class AccessRoleBindingNameListSuccessResponse
    {
        ...
        /// <summary> Initializes a new instance of <see cref="AccessRoleBindingNameListSuccessResponse"/>. </summary>
        ...
        internal AccessRoleBindingNameListSuccessResponse(string kind, ConfluentListMetadata metadata, IReadOnlyList<string> data, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Kind = kind;
            Metadata = metadata;
            Data = data;
