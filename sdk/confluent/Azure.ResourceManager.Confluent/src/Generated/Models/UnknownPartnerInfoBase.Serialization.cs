...
{
    internal partial class UnknownPartnerInfoBase : PartnerInfoBase, IJsonModel<PartnerInfoBase>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownPartnerInfoBase DeserializeUnknownPartnerInfoBase(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownPartnerInfoBase(partnerConnectorType, additionalBinaryDataProperties);
        }
    }
}
