...
namespace Azure.ResourceManager.Confluent.Models
{
    ...
    public partial class RegionRecord
    {
        ...
        /// <summary> Initializes a new instance of <see cref="RegionRecord"/>. </summary>
        ...
        internal RegionRecord(string kind, string id, SCMetadataEntity metadata, RegionSpecEntity spec, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Kind = kind;
            Id = id;
            Metadata = metadata;
