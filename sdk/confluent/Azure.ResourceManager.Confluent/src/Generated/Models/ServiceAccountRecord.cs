...
namespace Azure.ResourceManager.Confluent.Models
{
    ...
    public partial class ServiceAccountRecord
    {
        ...
        /// <summary> Initializes a new instance of <see cref="ServiceAccountRecord"/>. </summary>
        ...
        internal ServiceAccountRecord(string kind, string id, MetadataEntity metadata, string displayName, string description, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Kind = kind;
            Id = id;
            Metadata = metadata;
