...
namespace Azure.ResourceManager.Confluent.Models
{
    ...
    public partial class RoleBindingRecord
    {
        ...
        /// <summary> Initializes a new instance of <see cref="RoleBindingRecord"/>. </summary>
        ...
        internal RoleBindingRecord(string kind, string id, MetadataEntity metadata, string principal, string roleName, string crnPattern, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Kind = kind;
            Id = id;
            Metadata = metadata;
