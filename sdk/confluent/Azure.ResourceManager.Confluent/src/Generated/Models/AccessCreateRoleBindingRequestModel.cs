...
namespace Azure.ResourceManager.Confluent.Models
{
    ...
    public partial class AccessCreateRoleBindingRequestModel
    {
        ...
        /// <summary> Initializes a new instance of <see cref="AccessCreateRoleBindingRequestModel"/>. </summary>
        ...
        internal AccessCreateRoleBindingRequestModel(string principal, string roleName, string crnPattern, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Principal = principal;
            RoleName = roleName;
