...
namespace Azure.ResourceManager.Confluent.Models
{
    ...
    public partial class AccessListRoleBindingsSuccessResponse
    {
        ...
        internal AccessListRoleBindingsSuccessResponse(string kind, ConfluentListMetadata metadata, IReadOnlyList<RoleBindingRecord> data, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Kind = kind;
            Metadata = metadata;
            Data = data;
