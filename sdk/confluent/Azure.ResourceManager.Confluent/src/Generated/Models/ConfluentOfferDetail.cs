...
namespace Azure.ResourceManager.Confluent.Models
{
    ...
    public partial class ConfluentOfferDetail
    {
        ...
        internal ConfluentOfferDetail(string publisherId, string id, string planId, string planName, string termUnit, ConfluentSaaSOfferStatus? status, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            PublisherId = publisherId;
            Id = id;
            PlanId = planId;
