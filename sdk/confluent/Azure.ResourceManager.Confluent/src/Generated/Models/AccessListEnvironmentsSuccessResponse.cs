...
namespace Azure.ResourceManager.Confluent.Models
{
    ...
    public partial class AccessListEnvironmentsSuccessResponse
    {
        ...
        /// <summary> Initializes a new instance of <see cref="AccessListEnvironmentsSuccessResponse"/>. </summary>
        ...
        internal AccessListEnvironmentsSuccessResponse(string kind, ConfluentListMetadata metadata, IReadOnlyList<EnvironmentRecord> data, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Kind = kind;
            Metadata = metadata;
            Data = data;
