...
namespace Azure.ResourceManager.Confluent.Models
{
    ...
    public partial class AccessListInvitationsSuccessResponse
    {
        ...
        /// <summary> Initializes a new instance of <see cref="AccessListInvitationsSuccessResponse"/>. </summary>
        ...
        internal AccessListInvitationsSuccessResponse(string kind, ConfluentListMetadata metadata, IReadOnlyList<InvitationRecord> data, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Kind = kind;
            Metadata = metadata;
            Data = data;
