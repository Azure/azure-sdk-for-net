...
{
    public partial class ConfluentOrganizationData : IUtf8JsonSerializable, IJsonModel<ConfluentOrganizationData>, IPersistableModel<ConfluentOrganizationData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(OrganizationId))
            {
                ...
                builder.AppendLine($" '{OrganizationId.Value.ToString()}'");
            }

            if (Optional.IsDefined(SsoUri))
            {
                builder.Append("  ssoUrl:");
                builder.AppendLine($" '{SsoUri.AbsoluteUri}'");
            }

            if (Optional.IsDefined(OfferDetail))
            {
                builder.Append("  offerDetail:");
                AppendChildObject(builder, OfferDetail, options, 2);
            }

            if (Optional.IsDefined(UserDetail))
            {
                builder.Append("  userDetail:");
                AppendChildObject(builder, UserDetail, options, 2);
            }
