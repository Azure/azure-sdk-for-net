...
namespace Azure.ResourceManager.Confluent.Models
{
    ...
    public partial class APIKeyRecord
    {
        ...
        /// <summary> Initializes a new instance of <see cref="APIKeyRecord"/>. </summary>
        ...
        internal APIKeyRecord(string kind, string id, SCMetadataEntity metadata, APIKeySpecEntity spec, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Kind = kind;
            Id = id;
            Metadata = metadata;
