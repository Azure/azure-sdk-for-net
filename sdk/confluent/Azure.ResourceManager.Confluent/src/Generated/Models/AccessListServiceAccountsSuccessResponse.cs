...
namespace Azure.ResourceManager.Confluent.Models
{
    ...
    public partial class AccessListServiceAccountsSuccessResponse
    {
        ...
        /// <summary> Initializes a new instance of <see cref="AccessListServiceAccountsSuccessResponse"/>. </summary>
        ...
        internal AccessListServiceAccountsSuccessResponse(string kind, ConfluentListMetadata metadata, IReadOnlyList<ServiceAccountRecord> data, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Kind = kind;
            Metadata = metadata;
            Data = data;
