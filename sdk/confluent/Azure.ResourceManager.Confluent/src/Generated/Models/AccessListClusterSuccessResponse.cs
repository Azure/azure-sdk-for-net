...
namespace Azure.ResourceManager.Confluent.Models
{
    ...
    public partial class AccessListClusterSuccessResponse
    {
        ...
        /// <summary> Initializes a new instance of <see cref="AccessListClusterSuccessResponse"/>. </summary>
        ...
        internal AccessListClusterSuccessResponse(string kind, ConfluentListMetadata metadata, IReadOnlyList<ClusterRecord> data, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Kind = kind;
            Metadata = metadata;
            Data = data;
