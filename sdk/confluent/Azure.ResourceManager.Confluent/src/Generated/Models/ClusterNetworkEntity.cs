...
namespace Azure.ResourceManager.Confluent.Models
{
    ...
    public partial class ClusterNetworkEntity
    {
        ...
        internal ClusterNetworkEntity(string id, string environment, string related, string resourceName, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
