...
namespace Azure.ResourceManager.Confluent.Models
{
    ...
    public partial class ClusterNetworkEntity
    {
        ...
        /// <summary> Initializes a new instance of <see cref="ClusterNetworkEntity"/>. </summary>
        ...
        internal ClusterNetworkEntity(string id, string environment, string related, string resourceName, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Id = id;
