...
namespace Azure.ResourceManager.Confluent.Models
{
    ...
    public partial class SchemaRegistryClusterEnvironmentRegionEntity
    {
        ...
        internal SchemaRegistryClusterEnvironmentRegionEntity(string id, string related, string resourceName, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Related = related;
