...
namespace Azure.ResourceManager.Confluent.Models
{
    ...
    public partial class EnvironmentRecord
    {
        ...
        /// <summary> Initializes a new instance of <see cref="EnvironmentRecord"/>. </summary>
        ...
        internal EnvironmentRecord(string kind, string id, MetadataEntity metadata, string displayName, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Kind = kind;
            Id = id;
            Metadata = metadata;
