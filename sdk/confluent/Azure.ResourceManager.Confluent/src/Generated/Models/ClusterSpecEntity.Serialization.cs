...
namespace Azure.ResourceManager.Confluent.Models
{
    public partial class ClusterSpecEntity : IUtf8JsonSerializable, IJsonModel<ClusterSpecEntity>
    {
        ...
        void IJsonModel<ClusterSpecEntity>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ClusterSpecEntity)} does not support '{format}' format.");
            }
        ...
        internal static ClusterSpecEntity DeserializeClusterSpecEntity(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new ClusterSpecEntity(displayName.Value, availability.Value, cloud.Value, zone.Value, region.Value, kafkaBootstrapEndpoint.Value, httpEndpoint.Value, apiEndpoint.Value, config.Value, environment.Value, network.Value, byok.Value, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<ClusterSpecEntity>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ClusterSpecEntity)} does not support '{options.Format}' format.");
            }
        }
