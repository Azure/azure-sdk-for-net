        ...
        internal static ClusterProperties DeserializeClusterProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("spec"u8))
                {
                    ...
                    spec = SCClusterSpecEntity.DeserializeSCClusterSpecEntity(prop.Value, options);
                    continue;
                }
            ...
            return new ClusterProperties(metadata, spec, status, additionalBinaryDataProperties);
        }
    }
}
