...
namespace Azure.ResourceManager.Maintenance
{
    ...
    public partial class MaintenanceConfigurationResource : ArmResource
    {
        ...
        /// <summary>
        /// Updates the MaintenanceConfiguration.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Maintenance/maintenanceConfigurations/{resourceName}. </description>
        ...
        public virtual async Task<ArmOperation<MaintenanceConfigurationResource>> UpdateAsync(WaitUntil waitUntil, MaintenanceConfigurationData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _maintenanceConfigurationsRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, MaintenanceConfigurationData.ToRequestContent(data), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<MaintenanceConfigurationData> response = Response.FromValue(MaintenanceConfigurationData.FromResponse(result), result);
