...
{
    public partial class MaintenanceWindowsPatchSettings : IUtf8JsonSerializable, IJsonModel<MaintenanceWindowsPatchSettings>, IPersistableModel<MaintenanceWindowsPatchSettings>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(KbNumbersToExclude))
            {
                builder.Append("  kbNumbersToExclude:");
                builder.AppendLine(" [");
                foreach (var item in KbNumbersToExclude)
                {
                    if (item == null)
            ...
            if (Optional.IsCollectionDefined(KbNumbersToInclude))
            {
                builder.Append("  kbNumbersToInclude:");
                builder.AppendLine(" [");
                foreach (var item in KbNumbersToInclude)
                {
                    if (item == null)
            ...
            if (Optional.IsDefined(IsExcludeKbsRebootRequired))
            {
                builder.Append("  excludeKbsRequiringReboot:");
                var boolValue = IsExcludeKbsRebootRequired.Value == true ? "true" : "false";
