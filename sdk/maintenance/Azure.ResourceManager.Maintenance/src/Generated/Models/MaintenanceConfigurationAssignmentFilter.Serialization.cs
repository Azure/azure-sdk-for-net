...
namespace Azure.ResourceManager.Maintenance.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MaintenanceConfigurationAssignmentFilter>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MaintenanceConfigurationAssignmentFilter>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MaintenanceConfigurationAssignmentFilter>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MaintenanceConfigurationAssignmentFilter>)} interface");
            }
        ...
        string IPersistableModel<MaintenanceConfigurationAssignmentFilter>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
