...
namespace Azure.ResourceManager.Maintenance.Models
{
    ...
    {
        internal static MaintenanceUpdateListResult DeserializeMaintenanceUpdateListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
