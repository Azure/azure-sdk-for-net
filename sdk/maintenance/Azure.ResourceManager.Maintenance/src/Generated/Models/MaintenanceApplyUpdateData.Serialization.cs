...
namespace Azure.ResourceManager.Maintenance
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MaintenanceApplyUpdateData>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        MaintenanceApplyUpdateData IJsonModel<MaintenanceApplyUpdateData>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
                throw new FormatException($"The model {nameof(MaintenanceApplyUpdateData)} does not support '{options.Format}' format.");
            }
        ...
        BinaryData IModel<MaintenanceApplyUpdateData>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        MaintenanceApplyUpdateData IModel<MaintenanceApplyUpdateData>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<MaintenanceApplyUpdateData>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
