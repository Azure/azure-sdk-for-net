...
namespace Azure.ResourceManager.Maintenance
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MaintenanceApplyUpdateData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MaintenanceApplyUpdateData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MaintenanceApplyUpdateData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MaintenanceApplyUpdateData>)} interface");
            }
        ...
        string IPersistableModel<MaintenanceApplyUpdateData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
