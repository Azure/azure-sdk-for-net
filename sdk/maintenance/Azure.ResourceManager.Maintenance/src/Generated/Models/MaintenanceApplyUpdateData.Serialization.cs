...
{
    public partial class MaintenanceApplyUpdateData : IUtf8JsonSerializable, IJsonModel<MaintenanceApplyUpdateData>, IPersistableModel<MaintenanceApplyUpdateData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MaintenanceApplyUpdateData>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<MaintenanceApplyUpdateData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MaintenanceApplyUpdateData)} does not support '{format}' format.");
            }
