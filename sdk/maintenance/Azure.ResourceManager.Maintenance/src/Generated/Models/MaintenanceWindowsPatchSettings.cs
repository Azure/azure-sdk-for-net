...
namespace Azure.ResourceManager.Maintenance.Models
{
    ...
    public partial class MaintenanceWindowsPatchSettings
    {
        ...
        internal MaintenanceWindowsPatchSettings(IList<string> kbNumbersToExclude, IList<string> kbNumbersToInclude, IList<string> classificationsToInclude, bool? isExcludeKbsRebootRequired, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
