...
namespace Azure.ResourceManager.Maintenance.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VmTagSettings>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<VmTagSettings>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<VmTagSettings>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<VmTagSettings>)} interface");
            }
        ...
        string IPersistableModel<VmTagSettings>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
