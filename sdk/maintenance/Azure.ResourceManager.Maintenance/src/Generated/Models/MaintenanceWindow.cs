...
namespace Azure.ResourceManager.Maintenance.Models
{
    ...
    internal partial class MaintenanceWindow
    {
        ...
        internal MaintenanceWindow(DateTimeOffset? startsOn, DateTimeOffset? expireOn, TimeSpan? duration, string timeZone, string recurEvery, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            StartsOn = startsOn;
            ExpireOn = expireOn;
            Duration = duration;
