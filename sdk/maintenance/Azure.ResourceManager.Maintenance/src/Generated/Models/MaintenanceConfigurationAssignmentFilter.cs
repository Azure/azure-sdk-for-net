...
namespace Azure.ResourceManager.Maintenance.Models
{
    ...
    public partial class MaintenanceConfigurationAssignmentFilter
    {
        ...
        internal MaintenanceConfigurationAssignmentFilter(IList<ResourceType> resourceTypes, IList<string> resourceGroups, IList<string> osTypes, IList<AzureLocation> locations, VmTagSettings tagSettings, Dictionary<string, BinaryData> rawData)
        {
