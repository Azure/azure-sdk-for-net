...
namespace Azure.ResourceManager.Maintenance
{
    ...
    public partial class MaintenanceConfigurationData : TrackedResourceData
    {
        ...
        internal MaintenanceConfigurationData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, string @namespace, IDictionary<string, string> extensionProperties, MaintenanceScope? maintenanceScope, Visibility? visibility, InputPatchConfiguration installPatches, string startDateTime, string expirationDateTime, TimeSpan? duration, string timeZone, string recurEvery) : base(id, name, resourceType, systemData, tags, location)
        {
            Namespace = @namespace;
