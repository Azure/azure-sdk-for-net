...
namespace Azure.ResourceManager.Maintenance
{
    ...
    public partial class ConfigurationAssignmentResource : ArmResource
    {
        ...
        /// <summary>
        /// Update a ConfigurationAssignment.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        ...
        public virtual async Task<ArmOperation<ConfigurationAssignmentResource>> UpdateAsync(WaitUntil waitUntil, string configurationAssignmentName, MaintenanceConfigurationAssignmentData data, CancellationToken cancellationToken = default)
        {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="configurationAssignmentName"/> or <paramref name="data"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="configurationAssignmentName"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual ArmOperation<ConfigurationAssignmentResource> Update(WaitUntil waitUntil, string configurationAssignmentName, MaintenanceConfigurationAssignmentData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(configurationAssignmentName, nameof(configurationAssignmentName));
            Argument.AssertNotNull(data, nameof(data));
