...
{
    internal partial class MaintenanceApplyUpdateGetAllAsyncCollectionResultOfT : AsyncPageable<MaintenanceApplyUpdateData>
    {
        ...
        public MaintenanceApplyUpdateGetAllAsyncCollectionResultOfT(MaintenanceApplyUpdate client, Guid subscriptionId, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
