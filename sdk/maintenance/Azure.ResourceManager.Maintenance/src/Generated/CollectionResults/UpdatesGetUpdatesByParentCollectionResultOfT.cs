...
namespace Azure.ResourceManager.Maintenance
{
    internal partial class UpdatesGetUpdatesByParentCollectionResultOfT : Pageable<MaintenanceUpdate>
    {
        ...
        public UpdatesGetUpdatesByParentCollectionResultOfT(Updates client, Guid subscriptionId, string resourceGroupName, string providerName, string resourceParentType, string resourceParentName, string resourceType, string resourceName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
