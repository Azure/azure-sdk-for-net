...
namespace Azure.ResourceManager.Maintenance
{
    internal partial class MaintenanceApplyUpdateGetAllCollectionResultOfT : Pageable<MaintenanceApplyUpdateData>
    {
        ...
        /// <summary> Initializes a new instance of MaintenanceApplyUpdateGetAllCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public MaintenanceApplyUpdateGetAllCollectionResultOfT(MaintenanceApplyUpdate client, Guid subscriptionId, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of MaintenanceApplyUpdateGetAllCollectionResultOfT as an enumerable collection. </summary>
