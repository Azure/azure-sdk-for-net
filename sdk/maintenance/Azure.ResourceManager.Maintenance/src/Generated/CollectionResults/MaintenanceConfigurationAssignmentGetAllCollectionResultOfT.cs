...
{
    internal partial class MaintenanceConfigurationAssignmentGetAllCollectionResultOfT : Pageable<MaintenanceConfigurationAssignmentData>
    {
        ...
        /// <summary> Initializes a new instance of MaintenanceConfigurationAssignmentGetAllCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public MaintenanceConfigurationAssignmentGetAllCollectionResultOfT(MaintenanceConfigurationAssignment client, Guid subscriptionId, string resourceGroupName, string providerName, string resourceType, string resourceName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of MaintenanceConfigurationAssignmentGetAllCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of MaintenanceConfigurationAssignmentGetAllCollectionResultOfT as an enumerable collection. </returns>
