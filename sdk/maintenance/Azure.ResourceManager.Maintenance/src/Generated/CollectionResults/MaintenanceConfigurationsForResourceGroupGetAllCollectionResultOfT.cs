...
namespace Azure.ResourceManager.Maintenance
{
    internal partial class MaintenanceConfigurationsForResourceGroupGetAllCollectionResultOfT : Pageable<MaintenancePublicConfigurationData>
    {
        ...
        /// <summary> Initializes a new instance of MaintenanceConfigurationsForResourceGroupGetAllCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        /// <param name="client"> The MaintenanceConfigurationsForResourceGroup client used to send requests. </param>
        /// <param name="subscriptionId"> The ID of the target subscription. The value must be an UUID. </param>
        /// <param name="resourceGroupName"> The name of the resource group. The name is case insensitive. </param>
        /// <param name="context"> The request options, which can override default behaviors of the client pipeline on a per-call basis. </param>
        public MaintenanceConfigurationsForResourceGroupGetAllCollectionResultOfT(MaintenanceConfigurationsForResourceGroup client, Guid subscriptionId, string resourceGroupName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of MaintenanceConfigurationsForResourceGroupGetAllCollectionResultOfT as an enumerable collection. </summary>
        ...
        private Response GetNextResponse(int? pageSizeHint, Uri nextLink)
        {
            ...
            using DiagnosticScope scope = _client.ClientDiagnostics.CreateScope("MockableMaintenanceResourceGroupResource.GetMaintenanceConfigurations");
            scope.Start();
            try
            {
