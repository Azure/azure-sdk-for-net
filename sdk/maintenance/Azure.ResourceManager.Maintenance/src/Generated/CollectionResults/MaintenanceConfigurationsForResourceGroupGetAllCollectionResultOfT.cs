...
namespace Azure.ResourceManager.Maintenance
{
    internal partial class MaintenanceConfigurationsForResourceGroupGetAllCollectionResultOfT : Pageable<MaintenanceConfigurationData>
    {
        ...
        public MaintenanceConfigurationsForResourceGroupGetAllCollectionResultOfT(MaintenanceConfigurationsForResourceGroup client, Guid subscriptionId, string resourceGroupName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
