...
namespace Azure.ResourceManager.Maintenance.Mocking
{
    ...
    internal partial class MaintenanceResourceGroupMockingExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="MaintenanceResourceGroupMockingExtension"/> class for mocking. </summary>
        protected MaintenanceResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MaintenanceResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MaintenanceResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        {
            using var scope = MaintenanceApplyUpdateApplyUpdatesClientDiagnostics.CreateScope("MaintenanceResourceGroupMockingExtension.GetApplyUpdatesByParent");
            scope.Start();
            try
            {
        ...
        {
            using var scope = MaintenanceApplyUpdateApplyUpdatesClientDiagnostics.CreateScope("MaintenanceResourceGroupMockingExtension.CreateOrUpdateApplyUpdateByParent");
            scope.Start();
            try
            {
        ...
        {
            using var scope = MaintenanceApplyUpdateApplyUpdatesClientDiagnostics.CreateScope("MaintenanceResourceGroupMockingExtension.CreateOrUpdateApplyUpdate");
            scope.Start();
            try
            {
        ...
        {
            using var scope = ConfigurationAssignmentsClientDiagnostics.CreateScope("MaintenanceResourceGroupMockingExtension.GetConfigurationAssignmentByParent");
            scope.Start();
            try
            {
        ...
        {
            using var scope = ConfigurationAssignmentsClientDiagnostics.CreateScope("MaintenanceResourceGroupMockingExtension.CreateOrUpdateConfigurationAssignmentByParent");
            scope.Start();
            try
            {
        ...
        {
            using var scope = ConfigurationAssignmentsClientDiagnostics.CreateScope("MaintenanceResourceGroupMockingExtension.DeleteConfigurationAssignmentByParent");
            scope.Start();
            try
            {
        ...
        {
            using var scope = ConfigurationAssignmentsClientDiagnostics.CreateScope("MaintenanceResourceGroupMockingExtension.GetConfigurationAssignment");
            scope.Start();
            try
            {
        ...
        {
            using var scope = ConfigurationAssignmentsClientDiagnostics.CreateScope("MaintenanceResourceGroupMockingExtension.CreateOrUpdateConfigurationAssignment");
            scope.Start();
            try
            {
        ...
        {
            using var scope = ConfigurationAssignmentsClientDiagnostics.CreateScope("MaintenanceResourceGroupMockingExtension.DeleteConfigurationAssignment");
            scope.Start();
            try
            {
        ...
        public virtual AsyncPageable<MaintenanceConfigurationAssignmentData> GetConfigurationAssignmentsAsync(string providerName, string resourceType, string resourceName, CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, null, MaintenanceConfigurationAssignmentData.DeserializeMaintenanceConfigurationAssignmentData, ConfigurationAssignmentsClientDiagnostics, Pipeline, "MaintenanceResourceGroupMockingExtension.GetConfigurationAssignments", "value", null, cancellationToken);
        }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => ConfigurationAssignmentsRestClient.CreateListRequest(Id.SubscriptionId, Id.ResourceGroupName, providerName, resourceType, resourceName);
            return PageableHelpers.CreatePageable(FirstPageRequest, null, MaintenanceConfigurationAssignmentData.DeserializeMaintenanceConfigurationAssignmentData, ConfigurationAssignmentsClientDiagnostics, Pipeline, "MaintenanceResourceGroupMockingExtension.GetConfigurationAssignments", "value", null, cancellationToken);
        }
        ...
        public virtual AsyncPageable<MaintenanceApplyUpdateResource> GetMaintenanceApplyUpdatesAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, null, e => new MaintenanceApplyUpdateResource(Client, MaintenanceApplyUpdateData.DeserializeMaintenanceApplyUpdateData(e)), ApplyUpdateForResourceGroupClientDiagnostics, Pipeline, "MaintenanceResourceGroupMockingExtension.GetMaintenanceApplyUpdates", "value", null, cancellationToken);
        }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => ApplyUpdateForResourceGroupRestClient.CreateListRequest(Id.SubscriptionId, Id.ResourceGroupName);
            return PageableHelpers.CreatePageable(FirstPageRequest, null, e => new MaintenanceApplyUpdateResource(Client, MaintenanceApplyUpdateData.DeserializeMaintenanceApplyUpdateData(e)), ApplyUpdateForResourceGroupClientDiagnostics, Pipeline, "MaintenanceResourceGroupMockingExtension.GetMaintenanceApplyUpdates", "value", null, cancellationToken);
        }
        ...
        {
            using var scope = ConfigurationAssignmentsForResourceGroupClientDiagnostics.CreateScope("MaintenanceResourceGroupMockingExtension.GetConfigurationAssignmentByResourceGroup");
            scope.Start();
            try
            {
        ...
        {
            using var scope = ConfigurationAssignmentsForResourceGroupClientDiagnostics.CreateScope("MaintenanceResourceGroupMockingExtension.CreateOrUpdateConfigurationAssignmentByResourceGroup");
            scope.Start();
            try
            {
        ...
        {
            using var scope = ConfigurationAssignmentsForResourceGroupClientDiagnostics.CreateScope("MaintenanceResourceGroupMockingExtension.UpdateConfigurationAssignmentByResourceGroup");
            scope.Start();
            try
            {
        ...
        {
            using var scope = ConfigurationAssignmentsForResourceGroupClientDiagnostics.CreateScope("MaintenanceResourceGroupMockingExtension.DeleteConfigurationAssignmentByResourceGroup");
            scope.Start();
            try
            {
        ...
        public virtual AsyncPageable<MaintenanceUpdate> GetUpdatesByParentAsync(string providerName, string resourceParentType, string resourceParentName, string resourceType, string resourceName, CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, null, MaintenanceUpdate.DeserializeMaintenanceUpdate, UpdatesClientDiagnostics, Pipeline, "MaintenanceResourceGroupMockingExtension.GetUpdatesByParent", "value", null, cancellationToken);
        }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => UpdatesRestClient.CreateListParentRequest(Id.SubscriptionId, Id.ResourceGroupName, providerName, resourceParentType, resourceParentName, resourceType, resourceName);
            return PageableHelpers.CreatePageable(FirstPageRequest, null, MaintenanceUpdate.DeserializeMaintenanceUpdate, UpdatesClientDiagnostics, Pipeline, "MaintenanceResourceGroupMockingExtension.GetUpdatesByParent", "value", null, cancellationToken);
        }
        ...
        public virtual AsyncPageable<MaintenanceUpdate> GetUpdatesAsync(string providerName, string resourceType, string resourceName, CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, null, MaintenanceUpdate.DeserializeMaintenanceUpdate, UpdatesClientDiagnostics, Pipeline, "MaintenanceResourceGroupMockingExtension.GetUpdates", "value", null, cancellationToken);
        }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => UpdatesRestClient.CreateListRequest(Id.SubscriptionId, Id.ResourceGroupName, providerName, resourceType, resourceName);
            return PageableHelpers.CreatePageable(FirstPageRequest, null, MaintenanceUpdate.DeserializeMaintenanceUpdate, UpdatesClientDiagnostics, Pipeline, "MaintenanceResourceGroupMockingExtension.GetUpdates", "value", null, cancellationToken);
        }
    }
}
