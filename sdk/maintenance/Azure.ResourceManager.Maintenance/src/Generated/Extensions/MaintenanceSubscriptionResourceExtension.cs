...
namespace Azure.ResourceManager.Maintenance.Testing
{
    /// <summary> A class to add extension methods to SubscriptionResource. </summary>
    public partial class MaintenanceSubscriptionResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="MaintenanceSubscriptionResourceExtension"/> class for mocking. </summary>
        protected MaintenanceSubscriptionResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MaintenanceSubscriptionResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MaintenanceSubscriptionResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
