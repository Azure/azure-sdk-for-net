...
namespace Azure.ResourceManager.Maintenance.Mocking
{
    ...
    internal partial class MaintenanceSubscriptionMockingExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="MaintenanceSubscriptionMockingExtension"/> class for mocking. </summary>
        protected MaintenanceSubscriptionMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MaintenanceSubscriptionMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MaintenanceSubscriptionMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<MaintenanceConfigurationAssignmentData> GetConfigurationAssignmentsBySubscriptionAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, null, MaintenanceConfigurationAssignmentData.DeserializeMaintenanceConfigurationAssignmentData, ConfigurationAssignmentsWithinSubscriptionClientDiagnostics, Pipeline, "MaintenanceSubscriptionMockingExtension.GetConfigurationAssignmentsBySubscription", "value", null, cancellationToken);
        }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => ConfigurationAssignmentsWithinSubscriptionRestClient.CreateListRequest(Id.SubscriptionId);
            return PageableHelpers.CreatePageable(FirstPageRequest, null, MaintenanceConfigurationAssignmentData.DeserializeMaintenanceConfigurationAssignmentData, ConfigurationAssignmentsWithinSubscriptionClientDiagnostics, Pipeline, "MaintenanceSubscriptionMockingExtension.GetConfigurationAssignmentsBySubscription", "value", null, cancellationToken);
        }
        ...
        {
            using var scope = ConfigurationAssignmentsForSubscriptionsClientDiagnostics.CreateScope("MaintenanceSubscriptionMockingExtension.GetConfigurationAssignmentBySubscription");
            scope.Start();
            try
            {
        ...
        {
            using var scope = ConfigurationAssignmentsForSubscriptionsClientDiagnostics.CreateScope("MaintenanceSubscriptionMockingExtension.CreateOrUpdateConfigurationAssignmentBySubscription");
            scope.Start();
            try
            {
        ...
        {
            using var scope = ConfigurationAssignmentsForSubscriptionsClientDiagnostics.CreateScope("MaintenanceSubscriptionMockingExtension.UpdateConfigurationAssignmentBySubscription");
            scope.Start();
            try
            {
        ...
        {
            using var scope = ConfigurationAssignmentsForSubscriptionsClientDiagnostics.CreateScope("MaintenanceSubscriptionMockingExtension.DeleteConfigurationAssignmentBySubscription");
            scope.Start();
            try
            {
