...
namespace Azure.ResourceManager.Maintenance.Mocking
{
    ...
    public partial class MockableMaintenanceArmClient : ArmResource
    {
        ...
        public virtual async Task<Response<MaintenanceScheduledEventApproveResult>> AcknowledgeListAsync(ResourceIdentifier scope, ScheduledEventsIdList scheduledEventsIdList, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(scope, nameof(scope));
            ...
            try
            {
                ...
                HttpMessage message = ScheduledEventsRestClient.CreateAcknowledgeListRequest(Guid.Parse(scope.SubscriptionId), scope.ResourceGroupName, scope.ResourceType.Type, scope.Name, ScheduledEventsIdList.ToRequestContent(scheduledEventsIdList), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<MaintenanceScheduledEventApproveResult> response = Response.FromValue(MaintenanceScheduledEventApproveResult.FromResponse(result), result);
                if (response.Value == null)
                {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="scope"/> or <paramref name="scheduledEventsIdList"/> is null. </exception>
        public virtual Response<MaintenanceScheduledEventApproveResult> AcknowledgeList(ResourceIdentifier scope, ScheduledEventsIdList scheduledEventsIdList, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(scope, nameof(scope));
            Argument.AssertNotNull(scheduledEventsIdList, nameof(scheduledEventsIdList));
