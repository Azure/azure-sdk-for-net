...
namespace Azure.ResourceManager.Maintenance
{
    ...
    public partial class MaintenanceSubscriptionConfigurationAssignmentResource : ArmResource
    {
        ...
        /// <summary>
        /// Updates the MaintenanceSubscriptionConfigurationAssignment.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/providers/Microsoft.Maintenance/configurationAssignments/{configurationAssignmentName}. </description>
        ...
        public virtual async Task<ArmOperation<MaintenanceSubscriptionConfigurationAssignmentResource>> UpdateAsync(WaitUntil waitUntil, MaintenanceConfigurationAssignmentData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
            ...
            try
            {
                ...
                HttpMessage message = _configurationAssignmentsForSubscriptionsRestClient.CreateCreateOrUpdateConfigurationAssignmentBySubscriptionRequest(Guid.Parse(Id.SubscriptionId), Id.Name, MaintenanceConfigurationAssignmentData.ToRequestContent(data), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<MaintenanceConfigurationAssignmentData> response = Response.FromValue(MaintenanceConfigurationAssignmentData.FromResponse(result), result);
                RequestUriBuilder uri = message.Request.Uri;
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<MaintenanceSubscriptionConfigurationAssignmentResource> Update(WaitUntil waitUntil, MaintenanceConfigurationAssignmentData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
