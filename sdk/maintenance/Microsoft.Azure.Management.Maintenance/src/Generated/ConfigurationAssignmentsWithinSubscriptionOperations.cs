...
namespace Microsoft.Azure.Management.Maintenance
{
    ...
    /// </summary>
    internal partial class ConfigurationAssignmentsWithinSubscriptionOperations : IServiceOperations<MaintenanceManagementClient>, IConfigurationAssignmentsWithinSubscriptionOperations
    {
        /// <summary>
        ...
        /// </return>
        public async Task<AzureOperationResponse<IEnumerable<ConfigurationAssignment>>> ListWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Create Result
            var _result = new AzureOperationResponse<IEnumerable<ConfigurationAssignment>>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<Page<ConfigurationAssignment>>(_responseContent, Client.DeserializationSettings);
                }
