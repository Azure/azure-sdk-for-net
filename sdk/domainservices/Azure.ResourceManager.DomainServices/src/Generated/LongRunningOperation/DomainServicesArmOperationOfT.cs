...
{
    internal partial class DomainServicesArmOperation<T> : ArmOperation<T>
    {
        ...
        /// <summary> Initializes a new instance of DomainServicesArmOperation for mocking. </summary>
        protected DomainServicesArmOperation()
        {
        }
        ...
        internal DomainServicesArmOperation(Response<T> response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal DomainServicesArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
