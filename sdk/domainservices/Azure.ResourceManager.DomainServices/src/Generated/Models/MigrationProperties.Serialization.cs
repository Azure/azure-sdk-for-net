...
namespace Azure.ResourceManager.DomainServices.Models
{
    ...
    public partial class MigrationProperties : IJsonModel<MigrationProperties>
    {
        ...
        internal static MigrationProperties DeserializeMigrationProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            string oldSubnetId = default;
            string oldVnetSiteId = default;
            MigrationProgress migrationProgress = default;
            IDictionary<string, BinaryData> additionalBinaryDataProperties = new ChangeTrackingDictionary<string, BinaryData>();
            foreach (var prop in element.EnumerateObject())
            {
                if (prop.NameEquals("oldSubnetId"u8))
                {
                    oldSubnetId = prop.Value.GetString();
                    continue;
                }
                ...
                if (prop.NameEquals("migrationProgress"u8))
                {
                    ...
                    migrationProgress = MigrationProgress.DeserializeMigrationProgress(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
            ...
            return new MigrationProperties(oldSubnetId, oldVnetSiteId, migrationProgress, additionalBinaryDataProperties);
        }
    }
}
