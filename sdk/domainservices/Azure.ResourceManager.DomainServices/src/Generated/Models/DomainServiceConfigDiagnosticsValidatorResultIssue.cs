...
namespace Azure.ResourceManager.DomainServices.Models
{
    ...
    public partial class DomainServiceConfigDiagnosticsValidatorResultIssue
    {
        ...
        /// <summary> Initializes a new instance of <see cref="DomainServiceConfigDiagnosticsValidatorResultIssue"/>. </summary>
        ...
        internal DomainServiceConfigDiagnosticsValidatorResultIssue(string id, IList<string> descriptionParams, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Id = id;
