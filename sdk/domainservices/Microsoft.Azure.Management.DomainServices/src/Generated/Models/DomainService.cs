...
namespace Microsoft.Azure.Management.DomainServices.Models
{
    ...
    public partial class DomainService : Resource
    {
        ...
        /// 'Disabled'</param>
        /// <param name="syncScope">All or CloudOnly, All users in AAD are
        /// synced to AAD DS domain or only users actively syncing in the
        /// cloud. Possible values include: 'All', 'CloudOnly'</param>
        ...
        /// <summary>
        /// Gets or sets all or CloudOnly, All users in AAD are synced to AAD
        /// DS domain or only users actively syncing in the cloud. Possible
        /// values include: 'All', 'CloudOnly'
        /// </summary>
        [JsonProperty(PropertyName = "properties.syncScope")]
