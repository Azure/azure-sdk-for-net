...
namespace Microsoft.Azure.Management.DomainServices.Models
{
    ...
    public partial class MigrationProperties
    {
        ...
        /// <summary>
        /// Gets or sets old Subnet Id
        /// </summary>
        [JsonProperty(PropertyName = "oldSubnetId")]
        public string OldSubnetId { get; set; }

        /// <summary>
        /// Gets or sets old Vnet Site Id
        /// </summary>
        [JsonProperty(PropertyName = "oldVnetSiteId")]
        public string OldVnetSiteId { get; set; }

        /// <summary>
        /// Gets or sets migration Progress
        /// </summary>
