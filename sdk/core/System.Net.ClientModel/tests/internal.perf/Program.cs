...
public class Program
{
    public static async Task Main(string[] args)
    {
        ...
        // dotnet run -c Release --framework net6.0 --bm --filter System.Net.ClientModel.Tests.Internal.Perf.ResourceProviderDataModel*
        ...
        // or
        // dotnet run -c Release --framework net6.0 --bm --filter System.Net.ClientModel.Tests.Internal.Perf.ResourceProviderDataModel.Read_PublicInterface

        // To run a specific benchmark class and category
        // dotnet run -c Release --framework net6.0 --bm --anyCategories PublicInterface --filter System.Net.ClientModel.Tests.Internal.Perf.ResourceProviderDataModel*
