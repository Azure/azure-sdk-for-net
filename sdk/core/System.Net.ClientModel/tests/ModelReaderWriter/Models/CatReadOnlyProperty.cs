...
{
    public class CatReadOnlyProperty : Animal, IJsonModel<CatReadOnlyProperty>, IUtf8JsonContentWriteable
    {
        ...
        void IUtf8JsonContentWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<CatReadOnlyProperty>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
