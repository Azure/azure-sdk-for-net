...
{
    public class Animal : IUtf8JsonContentWriteable, IJsonModel<Animal>
    {
        ...
        void IUtf8JsonContentWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<Animal>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
