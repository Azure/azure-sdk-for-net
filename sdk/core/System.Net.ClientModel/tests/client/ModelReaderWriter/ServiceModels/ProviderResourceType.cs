...
namespace System.Net.ClientModel.Tests.Client.Models.ResourceManager.Resources
{
    ...
    public partial class ProviderResourceType
    {
        ...
        {
            Locations = new OptionalList<string>();
            LocationMappings = new OptionalList<ProviderExtendedLocation>();
            Aliases = new OptionalList<ResourceTypeAlias>();
            ApiVersions = new OptionalList<string>();
            ZoneMappings = new OptionalList<ZoneMapping>();
            ApiProfiles = new OptionalList<ApiProfile>();
            Properties = new OptionalDictionary<string, string>();
        }
