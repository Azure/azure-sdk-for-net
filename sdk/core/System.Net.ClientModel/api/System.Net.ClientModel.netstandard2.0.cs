namespace System.Net.ClientModel
{
    ...
    public partial class RequestOptions
    {
        ...
        public static System.Net.ClientModel.Core.Pipeline.IPipelinePolicy<System.Net.ClientModel.Core.PipelineMessage>? DefaultLoggingPolicy { get { throw null; } set { } }
        public static System.Net.ClientModel.Core.Pipeline.IPipelinePolicy<System.Net.ClientModel.Core.PipelineMessage>? DefaultRetryPolicy { get { throw null; } set { } }
        ...
        public System.Net.ClientModel.ErrorBehavior ErrorBehavior { get { throw null; } set { } }
        public System.Net.ClientModel.Core.Pipeline.IPipelinePolicy<System.Net.ClientModel.Core.PipelineMessage>? LoggingPolicy { get { throw null; } set { } }
        public System.Net.ClientModel.Core.Pipeline.IPipelinePolicy<System.Net.ClientModel.Core.PipelineMessage>[]? PerCallPolicies { get { throw null; } set { } }
        public System.Net.ClientModel.Core.Pipeline.IPipelinePolicy<System.Net.ClientModel.Core.PipelineMessage>[]? PerTryPolicies { get { throw null; } set { } }
        public System.Net.ClientModel.Core.Pipeline.IPipelinePolicy<System.Net.ClientModel.Core.PipelineMessage>? RetryPolicy { get { throw null; } set { } }
...
namespace System.Net.ClientModel.Core
{
    ...
    {
        protected internal PipelineMessage(System.Net.ClientModel.Core.PipelineRequest request, System.Net.ClientModel.Core.ResponseErrorClassifier classifier) { }
        public System.Threading.CancellationToken CancellationToken { get { throw null; } set { } }
        public bool HasResponse { get { throw null; } }
        public virtual System.Net.ClientModel.Core.PipelineRequest Request { get { throw null; } }
        public virtual System.Net.ClientModel.Core.PipelineResponse Response { get { throw null; } set { } }
    ...
    public abstract partial class PipelineRequest
    {
        ...
        public abstract System.Net.ClientModel.Core.RequestBody? Content { get; set; }
    ...
    public abstract partial class RequestBody : System.IDisposable
    {
        ...
        public static System.Net.ClientModel.Core.RequestBody CreateFromStream(System.IO.Stream stream) { throw null; }
        public abstract void Dispose();
    ...
    {
        public TelemetrySource(System.Net.ClientModel.RequestOptions options, bool suppressNestedClientActivities = true) { }
...
namespace System.Net.ClientModel.Core.Pipeline
{
    public partial class HttpPipelineMessageTransport : System.Net.ClientModel.Core.Pipeline.PipelineTransport<System.Net.ClientModel.Core.PipelineMessage>, System.IDisposable
    {
        ...
        public override System.Net.ClientModel.Core.PipelineMessage CreateMessage(System.Net.ClientModel.RequestOptions options, System.Net.ClientModel.Core.ResponseErrorClassifier classifier) { throw null; }
        public virtual void Dispose() { }
        protected virtual void Dispose(bool disposing) { }
        protected virtual void OnReceivedResponse(System.Net.ClientModel.Core.PipelineMessage message, System.Net.Http.HttpResponseMessage httpResponse, System.IO.Stream? contentStream) { }
        protected virtual void OnSendingRequest(System.Net.ClientModel.Core.PipelineMessage message) { }
    ...
    public partial class HttpPipelineRequest : System.Net.ClientModel.Core.PipelineRequest, System.IDisposable
    {
        ...
        public override System.Net.ClientModel.Core.RequestBody? Content { get { throw null; } set { } }
        ...
        public virtual void Dispose() { }
        protected virtual void OnSending(System.Net.ClientModel.Core.PipelineMessage message, System.Net.Http.HttpRequestMessage httpRequest) { }
    ...
    {
        void Process(TMessage message, System.Net.ClientModel.Core.Pipeline.IPipelineEnumerator pipeline);
        System.Threading.Tasks.ValueTask ProcessAsync(TMessage message, System.Net.ClientModel.Core.Pipeline.IPipelineEnumerator pipeline);
    }
    public partial class KeyCredentialPolicy : System.Net.ClientModel.Core.Pipeline.IPipelinePolicy<System.Net.ClientModel.Core.PipelineMessage>
    {
        public KeyCredentialPolicy(System.Net.ClientModel.KeyCredential credential, string name, string? prefix = null) { }
        public void Process(System.Net.ClientModel.Core.PipelineMessage message, System.Net.ClientModel.Core.Pipeline.IPipelineEnumerator pipeline) { }
        public System.Threading.Tasks.ValueTask ProcessAsync(System.Net.ClientModel.Core.PipelineMessage message, System.Net.ClientModel.Core.Pipeline.IPipelineEnumerator pipeline) { throw null; }
    }
    ...
    {
        public MessagePipeline(System.Net.ClientModel.Core.Pipeline.PipelineTransport<System.Net.ClientModel.Core.PipelineMessage> transport, System.ReadOnlyMemory<System.Net.ClientModel.Core.Pipeline.IPipelinePolicy<System.Net.ClientModel.Core.PipelineMessage>> policies) { }
        public static System.Net.ClientModel.Core.Pipeline.MessagePipeline Create(System.Net.ClientModel.RequestOptions options, params System.Net.ClientModel.Core.Pipeline.IPipelinePolicy<System.Net.ClientModel.Core.PipelineMessage>[] perTryPolicies) { throw null; }
        public static System.Net.ClientModel.Core.Pipeline.MessagePipeline Create(System.Net.ClientModel.RequestOptions options, System.ReadOnlySpan<System.Net.ClientModel.Core.Pipeline.IPipelinePolicy<System.Net.ClientModel.Core.PipelineMessage>> perCallPolicies, System.ReadOnlySpan<System.Net.ClientModel.Core.Pipeline.IPipelinePolicy<System.Net.ClientModel.Core.PipelineMessage>> perTryPolicies) { throw null; }
        public override System.Net.ClientModel.Core.PipelineMessage CreateMessage(System.Net.ClientModel.RequestOptions options, System.Net.ClientModel.Core.ResponseErrorClassifier classifier) { throw null; }
    ...
    public abstract partial class PipelineTransport<TMessage> : System.Net.ClientModel.Core.Pipeline.IPipelinePolicy<TMessage>
    {
        protected PipelineTransport() { }
        public abstract TMessage CreateMessage(System.Net.ClientModel.RequestOptions options, System.Net.ClientModel.Core.ResponseErrorClassifier classifier);
        public abstract void Process(TMessage message);
        public void Process(TMessage message, System.Net.ClientModel.Core.Pipeline.IPipelineEnumerator pipeline) { }
        public abstract System.Threading.Tasks.ValueTask ProcessAsync(TMessage message);
        public System.Threading.Tasks.ValueTask ProcessAsync(TMessage message, System.Net.ClientModel.Core.Pipeline.IPipelineEnumerator pipeline) { throw null; }
    }
    ...
    public partial class ResponseBufferingPolicy : System.Net.ClientModel.Core.Pipeline.IPipelinePolicy<System.Net.ClientModel.Core.PipelineMessage>
    {
        public ResponseBufferingPolicy(System.TimeSpan networkTimeout, bool bufferResponse) { }
        protected virtual bool BufferResponse(System.Net.ClientModel.Core.PipelineMessage message) { throw null; }
        public void Process(System.Net.ClientModel.Core.PipelineMessage message, System.Net.ClientModel.Core.Pipeline.IPipelineEnumerator pipeline) { }
        public System.Threading.Tasks.ValueTask ProcessAsync(System.Net.ClientModel.Core.PipelineMessage message, System.Net.ClientModel.Core.Pipeline.IPipelineEnumerator pipeline) { throw null; }
        protected virtual void SetReadTimeoutStream(System.Net.ClientModel.Core.PipelineMessage message, System.IO.Stream responseContentStream, System.TimeSpan networkTimeout) { }
        protected virtual bool TryGetNetworkTimeoutOverride(System.Net.ClientModel.Core.PipelineMessage message, out System.TimeSpan timeout) { throw null; }
    }
}
namespace System.Net.ClientModel.Internal
{
    ...
    {
        public static System.Net.ClientModel.NullableResult<bool> ProcessHeadAsBoolMessage(this System.Net.ClientModel.Core.Pipeline.Pipeline<System.Net.ClientModel.Core.PipelineMessage> pipeline, System.Net.ClientModel.Core.PipelineMessage message, System.Net.ClientModel.Core.TelemetrySource clientDiagnostics, System.Net.ClientModel.RequestOptions? requestContext) { throw null; }
        public static System.Threading.Tasks.ValueTask<System.Net.ClientModel.NullableResult<bool>> ProcessHeadAsBoolMessageAsync(this System.Net.ClientModel.Core.Pipeline.Pipeline<System.Net.ClientModel.Core.PipelineMessage> pipeline, System.Net.ClientModel.Core.PipelineMessage message, System.Net.ClientModel.Core.TelemetrySource clientDiagnostics, System.Net.ClientModel.RequestOptions? requestContext) { throw null; }
        public static System.Net.ClientModel.Core.PipelineResponse ProcessMessage(this System.Net.ClientModel.Core.Pipeline.Pipeline<System.Net.ClientModel.Core.PipelineMessage> pipeline, System.Net.ClientModel.Core.PipelineMessage message, System.Net.ClientModel.RequestOptions? requestContext, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken)) { throw null; }
        public static System.Threading.Tasks.ValueTask<System.Net.ClientModel.Core.PipelineResponse> ProcessMessageAsync(this System.Net.ClientModel.Core.Pipeline.Pipeline<System.Net.ClientModel.Core.PipelineMessage> pipeline, System.Net.ClientModel.Core.PipelineMessage message, System.Net.ClientModel.RequestOptions? requestContext, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken)) { throw null; }
    }
    ...
    public partial class Utf8JsonRequestBody : System.Net.ClientModel.Core.RequestBody
    {
