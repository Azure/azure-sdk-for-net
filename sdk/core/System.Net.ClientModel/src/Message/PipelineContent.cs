...
namespace System.Net.ClientModel.Core
{
    ...
    public abstract class PipelineContent : IDisposable
    {
        ...
        /// <summary>
        /// Creates an instance of <see cref="PipelineContent"/> that wraps a serialized version of an object.
        /// </summary>
        /// <param name="model">The <see cref="IModel{T}"/> to serialize.</param>
        /// <param name="options">The <see cref="ModelReaderWriterOptions"/> to use.</param>
        /// <returns>An instance of <see cref="PipelineContent"/> that wraps a serialized version of the object.</returns>
        public static PipelineContent CreateContent(IModel<object> model, ModelReaderWriterOptions? options = default) => new ModelWriterContent(model, options ?? ModelReaderWriterOptions.DefaultWireOptions);

        /// <summary>
        /// Creates an instance of <see cref="PipelineContent"/> that wraps a serialized version of an object.
        /// </summary>
        /// <param name="model">The <see cref="IJsonModel{T}"/> to serialize.</param>
        /// <param name="options">The <see cref="ModelReaderWriterOptions"/> to use.</param>
        /// <returns>An instance of <see cref="PipelineContent"/> that wraps a serialized version of the object.</returns>
        public static PipelineContent CreateContent(IJsonModel<object> model, ModelReaderWriterOptions? options = default) => new JsonModelWriterContent(model, options ?? ModelReaderWriterOptions.DefaultWireOptions);
