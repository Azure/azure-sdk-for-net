...
namespace Azure.Core.Expressions.DataFactory
{
    ...
    /// Please note <see cref="DataFactorySecretDefinition"/> is the base class. According to the scenario, a derived class of the base class might need to be assigned here, or this property needs to be casted to one of the possible derived classes.
    ...
    public abstract partial class DataFactorySecretDefinition
    {
        ...
        internal DataFactorySecretDefinition(string? secretBaseType)
        {
