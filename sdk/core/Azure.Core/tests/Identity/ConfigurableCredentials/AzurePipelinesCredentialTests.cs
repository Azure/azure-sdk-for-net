...
namespace Azure.Core.Tests.Identity.ConfigurableCredentials.AzurePipelines
{
    internal class AzurePipelinesCredentialTests : Azure.Core.Tests.Identity.AzurePipelinesCredentialTests
    {
