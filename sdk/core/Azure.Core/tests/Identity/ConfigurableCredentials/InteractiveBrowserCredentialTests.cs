...
namespace Azure.Core.Tests.Identity.ConfigurableCredentials.InteractiveBrowser
{
    /// <summary>
    ...
    /// </summary>
    internal class InteractiveBrowserCredentialTests : Azure.Core.Tests.Identity.InteractiveBrowserCredentialTests
    {
