    ...
    public class AzureSasCredentialSynchronousPolicyTests : PolicyTestBase
    {
        ...
        public async Task VerifyRetryAfterMultipleSasCredentialUpdate()
        {
            ...
            using (Request request = transport.CreateRequest())
            {
                ...
                var pipeline = new HttpPipeline(transport, new HttpPipelinePolicy[] { new RetryPolicy(delay: Delay.CreateExponentialDelay(TimeSpan.FromMilliseconds(100))), sasPolicy });
