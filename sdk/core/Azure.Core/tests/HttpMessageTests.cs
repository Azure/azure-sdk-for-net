...
namespace Azure.Core.Tests
{
    public class HttpMessageTests
    {
        ...
        public void AppliesResponseClassifierErrors()
        {
            ...
            context.AddClassificationHandler(204, isError: true);
        ...
        {
            RequestContext context = new RequestContext();
            context.AddClassificationHandler(301, isError: true);
            context.AddClassificationHandler(304, isError: true);
            context.AddClassificationHandler(404, isError: false);
        ...
        public void SettingResponseClassifierReplacesBaseClassifier_PerCallCustomization()
        {
            ...
            RequestContext context = new RequestContext();
            context.AddClassificationHandler(new StatusCodeHandler(304, true));
        ...
        public void AppliesHandlerBeforeResponseClassifier()
        {
            ...
            context.AddClassificationHandler(204, isError: false);
