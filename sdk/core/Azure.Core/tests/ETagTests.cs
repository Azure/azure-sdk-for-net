...
namespace Azure.Core.Tests
{
    public class ETagTests
    {
        ...
        public void EqualityMembersNonDefault()
        {
            ...
            Assert.That(eTag.Equals(new ETag("a")), Is.True);
            Assert.That(eTag.Equals(new ETag("A")), Is.False);

            Assert.That(eTag.Equals((object)new ETag("a")), Is.True);
        ...
        public void EqualityMembersDefault()
        {
            ...
            Assert.That(eTag.Equals(new ETag(null)), Is.True);

            Assert.That(eTag.Equals((object)new ETag(null)), Is.True);
        }
