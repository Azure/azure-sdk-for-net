...
namespace Azure.Core.Tests
{
    public class DisposableHttpPipelineTests
    {
        ...
        public void DisposeWithDisposableTransport([Values(true, false)] bool isOwned)
        {
            ...
            var target = new DisposableHttpPipeline(transport, 0, 0, new[] { new MockPolicy(transport, HttpMessageSanitizer.Default) }, ResponseClassifier.Shared, isOwned, ErrorResponseFormatter.Default);
