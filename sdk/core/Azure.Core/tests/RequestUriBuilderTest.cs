...
namespace Azure.Core.Tests
{
    public class RequestUriBuilderTest
    {
        ...
        [TestCase(null, new[] {""}, "http://localhost/?q")]
        [TestCase("/", new[] {"/"}, "http://localhost/?q")]
        [TestCase(null, new[] {"p"}, "http://localhost/p?q")]
        [TestCase("/", new[] {"p"}, "http://localhost/p?q")]
        [TestCase("/", new[] {"ā","p"}, "http://localhost/%C4%81p?q", true)]
        [TestCase("/", new[] {"ā","p"}, "http://localhost/āp?q", false)]
        [TestCase("/", new[] {"/p"}, "http://localhost/p?q")]
        [TestCase("", new[] {"\u1234"}, "http://localhost/\u1234?q", false)]
        [TestCase("", new[] {"%E1%88%B4"}, "http://localhost/%E1%88%B4?q", false)]
        [TestCase("", new[] {"\u1234"}, "http://localhost/%E1%88%B4?q", true)]
        [TestCase("", new[] {"%E1%88%B4"}, "http://localhost/%25E1%2588%25B4?q", true)]
        public void AppendPathWorks(string initialPath, string[] appends, string expectedResult, bool escape = false)
        {
            var uriBuilder = new RequestUriBuilder
            {
                Scheme = "http",
