...
{
    public class ModelY : BaseModel, IUtf8JsonSerializable, IJsonModel<ModelY>
    {
        public ModelY()
            : base(null)
        {
        ...
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ModelY>)this).Write(writer, ModelReaderWriterOptions.GetWireOptions());
