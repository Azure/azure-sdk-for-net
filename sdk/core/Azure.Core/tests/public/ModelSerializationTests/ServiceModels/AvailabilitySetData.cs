...
namespace Azure.Core.Tests.Public.ResourceManager.Compute
{
    ...
    public partial class AvailabilitySetData : TrackedResourceData
    {
        ...
        {
            return RequestContent.Create(availabilitySetData, ModelSerializerOptions.DefaultServiceOptions);
        }

        public static explicit operator AvailabilitySetData(Response response)
        {
            using JsonDocument jsonDocument = JsonDocument.Parse(response.ContentStream);
            return DeserializeAvailabilitySetData(jsonDocument.RootElement, ModelSerializerOptions.DefaultServiceOptions);
        }
