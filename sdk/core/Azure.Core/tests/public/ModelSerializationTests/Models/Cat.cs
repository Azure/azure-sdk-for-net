...
{
    public class Cat : Animal, IModelJsonSerializable<Cat>, IUtf8JsonSerializable
    {
        private Dictionary<string, BinaryData> RawData { get; set; } = new Dictionary<string, BinaryData>();

        public Cat(double weight, string latinName, string name, bool isHungry, bool hasWhiskers) : base(weight, "Felis catus", name, isHungry)
        {
            HasWhiskers = hasWhiskers;
        }

        internal Cat(double weight, string latinName, string name, bool isHungry, bool hasWhiskers, Dictionary<string, BinaryData> rawData) : this(weight, latinName, name, isHungry, hasWhiskers)
        {
            RawData = rawData;
        }
        ...
        void IModelJsonSerializable<Cat>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options) => Serialize(writer, options);
        ...
        internal static Cat DeserializeCatReadOnlyProperty(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new Cat(weight, latinName, name, isHungry, hasWhiskers, rawData);
        }
        ...
        BinaryData IModelSerializable<Cat>.Serialize(ModelSerializerOptions options) => ModelSerializer.ConvertToBinaryData(this, options);
