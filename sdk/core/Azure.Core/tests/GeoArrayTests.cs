...
namespace Azure.Core.Tests
{
    public class GeoArrayTests
    {
        ...
        public void PointCollectionCoordinatesWork()
        {
            ...
            Assert.That(pointCollection.Coordinates, Has.Count.EqualTo(2));
            Assert.Multiple(() =>
            {
        ...
        public void LineCoordinatesWork()
        {
            ...
            Assert.That(line.Coordinates, Has.Count.EqualTo(3));
            Assert.Multiple(() =>
            {
        ...
        public void LineCollectionCoordinatesWork()
        {
            ...
            Assert.That(lineCollection.Coordinates, Has.Count.EqualTo(2));
            Assert.Multiple(() =>
            {
        ...
        public void PolygonCoordinatesWork()
        {
            ...
            Assert.That(polygon.Coordinates, Has.Count.EqualTo(2));
            Assert.Multiple(() =>
            {
        ...
        public void PolygonCollectionCoordinatesWork()
        {
            ...
            Assert.That(polygonCollection.Coordinates, Has.Count.EqualTo(2));
