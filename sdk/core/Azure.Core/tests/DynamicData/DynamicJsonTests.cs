...
namespace Azure.Core.Tests
{
    public class DynamicJsonTests
    {
        ...
        {
            dynamic value = BinaryData.FromString("""{"foo": [1, 2]}""").ToDynamicFromJson(PropertyNamingConvention.CamelCase);
        ...
        {
            dynamic value = BinaryData.FromString("""{"foo": 1}""").ToDynamicFromJson(PropertyNamingConvention.CamelCase);
