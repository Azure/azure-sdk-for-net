...
namespace Azure.Core.Perf
{
    ...
    public class FastPropertyBagBenchmark
    {
        ...
        [Arguments(10)]
        [Arguments(30)]
        public void DictionaryPropertyBag(int items)
        {
            object val1;
            object val2;
            object val3;
            ...
            {
                case 1:
                    message.SetProperty("T1", new T1() { Value = 1234 });
                    message.TryGetProperty("T1", out val1);
                    break;
                case 2:
                    message.SetProperty("T1", new T1() { Value = 1234 });
                    message.TryGetProperty("T1", out val1);
                    message.SetProperty("T2", new T2() { Value = 1234 });
                    message.TryGetProperty("T2", out val2);
                    break;
                case 3:
                    message.SetProperty("T1", new T1() { Value = 1234 });
                    message.TryGetProperty("T1", out val1);
                    message.SetProperty("T2", new T2() { Value = 1234 });
                    message.TryGetProperty("T2", out val2);
                    message.SetProperty("T3", new T3() { Value = 1234 });
                    message.TryGetProperty("T3", out val3);
                    break;
                case 5:
                    message.SetProperty("T1", new T1() { Value = 1234 });
                    message.SetProperty("T2", new T2() { Value = 1234 });
                    message.SetProperty("T3", new T3() { Value = 1234 });
                    message.SetProperty("T4", new T4() { Value = 1234 });
                    message.SetProperty("T5", new T5() { Value = 1234 });
                    message.TryGetProperty("T1", out val1);
                    message.TryGetProperty("T2", out val2);
                    message.TryGetProperty("T3", out val3);
                    message.TryGetProperty("T4", out val4);
                    message.TryGetProperty("T5", out val5);
                    break;
                case 10:
                    message.SetProperty("T1", new T1() { Value = 1234 });
                    message.SetProperty("T2", new T2() { Value = 1234 });
                    ...
                    message.SetProperty("T4", new T4() { Value = 1234 });
                    message.SetProperty("T5", new T5() { Value = 1234 });
                    message.SetProperty("T6", new T6() { Value = 1234 });
                    message.SetProperty("T7", new T7() { Value = 1234 });
                    message.SetProperty("T8", new T8() { Value = 1234 });
                    message.SetProperty("T9", new T9() { Value = 1234 });
                    message.SetProperty("T10", new T10() { Value = 1234 });
                    message.TryGetProperty("T1", out val1);
                    message.TryGetProperty("T2", out val2);
                    message.TryGetProperty("T3", out val3);
                    message.TryGetProperty("T4", out val4);
                    message.TryGetProperty("T5", out val5);
                    message.TryGetProperty("T6", out val6);
                    message.TryGetProperty("T7", out val7);
                    message.TryGetProperty("T8", out val8);
                    message.TryGetProperty("T9", out val9);
                    message.TryGetProperty("T10", out val10);
                    break;
                case 20:
                    message.SetProperty("T1", new T1() { Value = 1234 });
                    message.SetProperty("T2", new T2() { Value = 1234 });
                    ...
                    message.SetProperty("T9", new T9() { Value = 1234 });
                    message.SetProperty("T10", new T10() { Value = 1234 });
                    message.SetProperty("T11", new T11() { Value = 1234 });
                    message.SetProperty("T12", new T12() { Value = 1234 });
                    message.SetProperty("T13", new T13() { Value = 1234 });
                    message.SetProperty("T14", new T14() { Value = 1234 });
                    message.SetProperty("T15", new T15() { Value = 1234 });
                    message.SetProperty("T16", new T16() { Value = 1234 });
                    message.SetProperty("T17", new T17() { Value = 1234 });
                    message.SetProperty("T18", new T18() { Value = 1234 });
                    message.SetProperty("T19", new T19() { Value = 1234 });
                    message.SetProperty("T20", new T20() { Value = 1234 });
                    message.TryGetProperty("T1", out val1);
                    message.TryGetProperty("T2", out val2);
                    message.TryGetProperty("T3", out val3);
                    message.TryGetProperty("T4", out val4);
                    ...
                    message.TryGetProperty("T9", out val9);
                    message.TryGetProperty("T10", out val10);
                    message.TryGetProperty("T11", out val11);
                    message.TryGetProperty("T12", out val12);
                    message.TryGetProperty("T13", out val13);
                    message.TryGetProperty("T14", out val14);
                    message.TryGetProperty("T15", out val15);
                    message.TryGetProperty("T16", out val16);
                    message.TryGetProperty("T17", out val17);
                    message.TryGetProperty("T18", out val18);
                    message.TryGetProperty("T19", out val19);
                    message.TryGetProperty("T20", out val20);
                    break;
                case 30:
                    message.SetProperty("T1", new T1() { Value = 1234 });
                    message.SetProperty("T2", new T2() { Value = 1234 });
                    ...
                    message.SetProperty("T19", new T19() { Value = 1234 });
                    message.SetProperty("T20", new T20() { Value = 1234 });
                    message.SetProperty("T21", new T21() { Value = 1234 });
                    message.SetProperty("T22", new T22() { Value = 1234 });
                    message.SetProperty("T23", new T23() { Value = 1234 });
                    message.SetProperty("T24", new T24() { Value = 1234 });
                    message.SetProperty("T25", new T25() { Value = 1234 });
                    message.SetProperty("T26", new T26() { Value = 1234 });
                    message.SetProperty("T27", new T27() { Value = 1234 });
                    message.SetProperty("T28", new T28() { Value = 1234 });
                    message.SetProperty("T29", new T29() { Value = 1234 });
                    message.SetProperty("T30", new T30() { Value = 1234 });
                    message.TryGetProperty("T1", out val1);
                    message.TryGetProperty("T2", out val2);
                    message.TryGetProperty("T3", out val3);
                    message.TryGetProperty("T4", out val4);
                    ...
                    message.TryGetProperty("T19", out val19);
                    message.TryGetProperty("T20", out val20);
                    message.TryGetProperty("T21", out val21);
                    message.TryGetProperty("T22", out val22);
                    message.TryGetProperty("T23", out val23);
                    message.TryGetProperty("T24", out val24);
                    message.TryGetProperty("T25", out val25);
                    message.TryGetProperty("T26", out val26);
                    message.TryGetProperty("T27", out val27);
                    message.TryGetProperty("T28", out val28);
                    message.TryGetProperty("T29", out val29);
                    message.TryGetProperty("T30", out val30);
                    break;
            }
        }
