...
options.TypeResolver = type => type.Equals(typeof(DogListProperty)) ? new NewtonsoftJsonObjectSerializer() : null;
...
ModelSerializerOptions options = new ModelSerializerOptions();
options.TypeResolver = type => type.Equals(typeof(ModelT)) ? new NewtonsoftJsonObjectSerializer() : null;
