...
// Copied from https://github.com/dotnet/runtime/tree/master/src/libraries/Microsoft.Extensions.Primitives/src
...
namespace Azure.Core
{
    ...
    internal readonly struct StringValues : IList<string>, IReadOnlyList<string>, IEquatable<StringValues>, IEquatable<string>, IEquatable<string[]>
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            {
                return Equals(this, stringArray);
            }

            if (obj is StringValues values)
            {
                return Equals(this, values);
            }
