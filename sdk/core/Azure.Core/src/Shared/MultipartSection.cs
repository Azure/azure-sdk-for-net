...
namespace Azure.Core
{
    internal class MultipartSection
    {
        public string ContentType
        {
            get
            {
                if (Headers != null && Headers.TryGetValue(HttpHeader.Names.ContentType, out StringValues values))
                {
                    return values;
                }
                return null;
        ...
        public string ContentDisposition
        {
            get
            {
                if (Headers != null && Headers.TryGetValue(HttpHeader.Names.ContentDisposition, out StringValues values))
                {
                    return values;
                }
                return null;
