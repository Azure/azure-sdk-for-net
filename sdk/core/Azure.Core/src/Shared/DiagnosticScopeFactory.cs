...
#pragma warning restore CA1001 // Types that own disposable fields should be disposable
    {
        ...
        public DiagnosticScopeFactory(string clientNamespace, string? resourceProviderNamespace, bool isActivityEnabled, bool enableNestedClientScopes = false)
        {
            _resourceProviderNamespace = resourceProviderNamespace;
            IsActivityEnabled = isActivityEnabled;
            _enableNestedClientScopes = enableNestedClientScopes;
        ...
        public DiagnosticScope CreateScope(string name, DiagnosticScope.ActivityKind kind = DiagnosticScope.ActivityKind.Client)
        {
            ...
            var scope = new DiagnosticScope(_source.Name, name, _source, kind, _enableNestedClientScopes);
