...
namespace Azure.Core.Serialization
{
    ...
    public abstract class ObjectSerializer
    {
        ...
        public BinaryData SerializeToBinaryData(object? value, Type? inputType = default, CancellationToken cancellationToken = default) =>
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> to use during serialization.</param>
        /// <returns>The object's binary representation as <see cref="BinaryData"/>.</returns>
        public async ValueTask<BinaryData> SerializeToBinaryDataAsync(object? value, Type? inputType = default, CancellationToken cancellationToken = default) =>
