...
namespace Azure.Core.Json
{
    internal partial class MutableJsonDocument
    {
        internal class ChangeTracker
        {
            ...
            internal int AddChange(string path, object? value, JsonValueKind? kind, bool isAddition, string? addedPropertyName = null, MutableJsonChangeKind changeKind = MutableJsonChangeKind.PropertyValue)
            {
                if (_changes == null)
                {
                ...
                _changes.Add(new MutableJsonChange(path, index, value, kind, _options, changeKind, addedPropertyName));
