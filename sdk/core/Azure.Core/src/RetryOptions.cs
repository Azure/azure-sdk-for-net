...
namespace Azure.Core
{
    ...
    public class RetryOptions
    {
        ...
        /// If the service provides provide a Retry-After response header, the next retry will be delayed by the duration specified by the header value.
        /// </summary>
        ...
        /// If the service does provide a Retry-After response header, the next retry will be delayed by the duration specified by the header value.
        /// </summary>
