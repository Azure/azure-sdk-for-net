...
{
    private ClientEventSource(string eventSourceName, string[]? traits = default) : base(eventSourceName, EventSourceSettings.Default, traits) { }

    public static ClientEventSource Log = new("System-ClientModel");
