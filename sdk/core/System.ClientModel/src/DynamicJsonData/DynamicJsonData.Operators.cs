...
public partial class DynamicJsonData
{
    ...
    private static readonly Dictionary<Type, MethodInfo> CastFromOperators = typeof(DynamicJsonData)
    ...
    public static implicit operator bool(DynamicJsonData value)
    {
        try
        {
    ...
    /// </summary>
    /// <param name="value">The value to convert.</param>
    public static implicit operator string?(DynamicJsonData value)
    {
        try
        {
    ...
    /// </summary>
    /// <param name="value">The value to convert.</param>
    public static implicit operator byte(DynamicJsonData value)
    {
        try
        {
    ...
    /// </summary>
    /// <param name="value">The value to convert.</param>
    public static implicit operator sbyte(DynamicJsonData value)
    {
        try
        {
    ...
    /// </summary>
    /// <param name="value">The value to convert.</param>
    public static implicit operator short(DynamicJsonData value)
    {
        try
        {
    ...
    /// </summary>
    /// <param name="value">The value to convert.</param>
    public static implicit operator ushort(DynamicJsonData value)
    {
        try
        {
    ...
    /// </summary>
    /// <param name="value">The value to convert.</param>
    public static implicit operator int(DynamicJsonData value)
    {
        try
        {
    ...
    /// </summary>
    /// <param name="value">The value to convert.</param>
    public static implicit operator uint(DynamicJsonData value)
    {
        try
        {
    ...
    /// </summary>
    /// <param name="value">The value to convert.</param>
    public static implicit operator long(DynamicJsonData value)
    {
        try
        {
    ...
    /// </summary>
    /// <param name="value">The value to convert.</param>
    public static implicit operator ulong(DynamicJsonData value)
    {
        try
        {
    ...
    /// </summary>
    /// <param name="value">The value to convert.</param>
    public static implicit operator float(DynamicJsonData value)
    {
        try
        {
    ...
    /// </summary>
    /// <param name="value">The value to convert.</param>
    public static implicit operator double(DynamicJsonData value)
    {
        try
        {
    ...
    /// </summary>
    /// <param name="value">The value to convert.</param>
    public static implicit operator decimal(DynamicJsonData value)
    {
        try
        {
    ...
    /// </summary>
    /// <param name="value">The value to convert.</param>
    public static explicit operator DateTime(DynamicJsonData value)
    {
        try
        {
    ...
    /// </summary>
    /// <param name="value">The value to convert.</param>
    public static explicit operator DateTimeOffset(DynamicJsonData value)
    {
        try
        {
            if (value._options.DateTimeFormat.Equals(UnixFormat, StringComparison.InvariantCultureIgnoreCase))
    ...
    /// </summary>
    /// <param name="value">The value to convert.</param>
    public static explicit operator Guid(DynamicJsonData value)
    {
        try
        {
    ...
    /// <summary>
    /// Determines whether the specified <see cref="DynamicJsonData"/> and <see cref="object"/> have the same value.
    /// </summary>
    /// <remarks>
    /// This operator calls through to <see cref="DynamicJsonData.Equals(object?)"/> when DynamicData is on the left-hand
    /// side of the operation.  <see cref="DynamicJsonData.Equals(object?)"/> has value semantics when the DynamicData represents
    ...
    /// </remarks>
    /// <param name="left">The <see cref="DynamicJsonData"/> to compare.</param>
    ...
    public static bool operator ==(DynamicJsonData? left, object? right)
    {
        if (left is null)
        {
    ...
    /// <summary>
    /// Determines whether the specified <see cref="DynamicJsonData"/> and <see cref="object"/> have different values.
    /// </summary>
    /// <remarks>
    /// This operator calls through to <see cref="DynamicJsonData.Equals(object?)"/> when DynamicData is on the left-hand
    /// side of the operation.  <see cref="DynamicJsonData.Equals(object?)"/> has value semantics when the DynamicData represents
    ...
    public static bool operator !=(DynamicJsonData? left, object? right) => !(left == right);
