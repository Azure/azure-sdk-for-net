...
public partial class DynamicJsonData
{
    ...
    internal struct ObjectEnumerator : IEnumerable<DynamicJsonDataProperty>, IEnumerator<DynamicJsonDataProperty>
    {
        private MutableJsonElement.ObjectEnumerator _enumerator;
        private readonly DynamicJsonDataOptions _options;

        internal ObjectEnumerator(MutableJsonElement.ObjectEnumerator enumerator, DynamicJsonDataOptions options)
        {
        ...
        /// <inheritdoc />
        public DynamicJsonDataProperty Current => new(_enumerator.Current.Name, new(_enumerator.Current.Value, _options));

        /// <inheritdoc />
        IEnumerator IEnumerable.GetEnumerator() => GetEnumerator();

        /// <inheritdoc />
        IEnumerator<DynamicJsonDataProperty> IEnumerable<DynamicJsonDataProperty>.GetEnumerator() => GetEnumerator();
