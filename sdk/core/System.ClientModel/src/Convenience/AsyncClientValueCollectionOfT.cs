...
/// </summary>
public abstract class AsyncClientValueCollection<T> : ClientResult, IAsyncEnumerable<T>
{
    /// <summary>
    /// Create a new instance of <see cref="AsyncClientValueCollection{T}"/>.
    /// </summary>
    ...
    protected internal AsyncClientValueCollection() : base()
    {
    }
    ...
    /// </param>
    protected internal AsyncClientValueCollection(PipelineResponse response) : base(response)
    {
    }
