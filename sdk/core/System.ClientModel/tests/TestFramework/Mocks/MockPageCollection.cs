...
//    public override ClientToken FirstPageToken
...
//        ClientToken? nextPageToken = (_current >= _values.Count) ?
//            null :
//            new MockPageToken(_current).ToBytes();

//        PipelineResponse response = _results[_currentPage++].GetRawResponse();

//        return PageResult<T>.Create(values, pageToken, nextPageToken, response);
//    }
