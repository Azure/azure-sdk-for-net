...
{
    internal class ModelWithPersistableStreamTests : StreamableModelTests<ModelWithPersistableStream>
    {
        ...
        protected override void CompareModels(ModelWithPersistableStream model, ModelWithPersistableStream model2, string format)
        {
        ...
        protected override void VerifyModel(ModelWithPersistableStream model, string format)
        {
