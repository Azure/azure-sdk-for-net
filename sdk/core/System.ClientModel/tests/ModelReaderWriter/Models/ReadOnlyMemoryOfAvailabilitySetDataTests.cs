...
{
    public class ReadOnlyMemoryOfAvailabilitySetDataTests : CollectionTests<ReadOnlyMemory<AvailabilitySetData>, AvailabilitySetData>
    {
        ...
        protected override ReadOnlyMemory<AvailabilitySetData> GetModelInstance()
            => new ReadOnlyMemory<AvailabilitySetData>([ListOfAvailabilitySetDataTests.s_testAs_3375, ListOfAvailabilitySetDataTests.s_testAs_3376]);
