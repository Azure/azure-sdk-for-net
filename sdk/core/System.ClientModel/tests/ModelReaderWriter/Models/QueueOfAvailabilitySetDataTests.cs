...
{
    public class QueueOfAvailabilitySetDataTests : CollectionTests<Queue<AvailabilitySetData>, AvailabilitySetData>
    {
        ...
        protected override Queue<AvailabilitySetData> GetModelInstance()
            => new Queue<AvailabilitySetData>([ListOfAvailabilitySetDataTests.s_testAs_3375, ListOfAvailabilitySetDataTests.s_testAs_3376]);
