...
{
    public class LinkedListOfAvailabilitySetDataTests : CollectionTests<LinkedList<AvailabilitySetData>, AvailabilitySetData>
    {
        ...
        protected override LinkedList<AvailabilitySetData> GetModelInstance()
            => new LinkedList<AvailabilitySetData>([ListOfAvailabilitySetDataTests.s_testAs_3375, ListOfAvailabilitySetDataTests.s_testAs_3376]);
        ...
        private class LocalContext : ModelReaderWriterContext
        {
            ...
            private class LinkedList_AvailabilitySetData_Info : ModelInfo
            {
                ...
                {
                    private readonly Lazy<LinkedList<AvailabilitySetData>> _instance = new(() => new());
