...
public class MockSseClient
{
    ...
    public virtual AsyncClientValueCollection<MockJsonModel> GetModelsStreamingAsync(string content = DefaultMockContent)
    {
    ...
    private class AsyncMockJsonModelCollection : AsyncClientValueCollection<MockJsonModel>
    {
