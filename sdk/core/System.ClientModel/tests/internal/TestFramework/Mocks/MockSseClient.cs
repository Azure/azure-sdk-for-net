...
public class MockSseClient
{
    ...
    public virtual AsyncClientCollection<MockJsonModel> GetModelsStreamingAsync(string content = DefaultMockContent)
    {
    ...
    private class AsyncMockJsonModelCollection : AsyncClientCollection<MockJsonModel>
    {
