...
public class MockSseClient
{
    ...
    public virtual AsyncResultValueCollection<MockJsonModel> GetModelsStreamingAsync(string content = DefaultMockContent)
    {
    ...
    private class AsyncMockJsonModelCollection : AsyncResultValueCollection<MockJsonModel>
    {
