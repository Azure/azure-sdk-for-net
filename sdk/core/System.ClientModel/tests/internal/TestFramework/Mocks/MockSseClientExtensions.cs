...
{
    public static AsyncClientValueCollection<BinaryData> EnumerateDataEvents(this PipelineResponse response)
    {
    ...
    private class AsyncSseDataEventCollection : AsyncClientValueCollection<BinaryData>
    {
