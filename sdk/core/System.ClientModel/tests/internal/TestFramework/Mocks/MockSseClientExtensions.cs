...
{
    public static AsyncResultValueCollection<BinaryData> EnumerateDataEvents(this PipelineResponse response)
    {
    ...
    private class AsyncSseDataEventCollection : AsyncResultValueCollection<BinaryData>
    {
