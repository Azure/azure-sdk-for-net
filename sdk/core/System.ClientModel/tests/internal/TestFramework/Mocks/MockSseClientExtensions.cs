...
{
    public static AsyncClientResultCollection<BinaryData> EnumerateDataEvents(this PipelineResponse response)
    {
    ...
    private class AsyncSseDataEventCollection : AsyncClientResultCollection<BinaryData>
    {
