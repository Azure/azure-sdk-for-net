...
public class ClientResultCollectionTests : SyncAsyncTestBase
{
    ...
    public async Task EnumeratesModelValues()
    {
        ...
        AsyncResultValueCollection<MockJsonModel> models = client.GetModelsStreamingAsync();
    ...
    {
        MockSseClient client = new();
        AsyncResultValueCollection<MockJsonModel> models = client.GetModelsStreamingAsync("[DONE]");
