...
public class ClientResultCollectionTests : SyncAsyncTestBase
{
    ...
    public async Task EnumeratesModelValues()
    {
        ...
        AsyncClientValueCollection<MockJsonModel> models = client.GetModelsStreamingAsync();
    ...
    {
        MockSseClient client = new();
        AsyncClientValueCollection<MockJsonModel> models = client.GetModelsStreamingAsync("[DONE]");
