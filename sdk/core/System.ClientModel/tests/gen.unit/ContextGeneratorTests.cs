...
""";
            ...
            Assert.That(errors, Is.Empty, "Compilation should not have errors");
            ...
            Assert.That(experimentalWarnings, Is.Empty, "Generated code should not produce experimental warnings");
            ...
            Assert.That(startIndex, Is.GreaterThanOrEqualTo(0), "Could not find #pragma warning disable TEST001");
            ...
            Assert.That(startIndex, Is.GreaterThanOrEqualTo(0), "Could not find #pragma warning disable TEST002");
