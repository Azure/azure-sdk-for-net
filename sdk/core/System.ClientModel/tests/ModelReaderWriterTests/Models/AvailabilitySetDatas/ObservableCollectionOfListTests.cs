...
namespace System.ClientModel.Tests.ModelReaderWriterTests.Models.AvailabilitySetDatas
{
    public class ObservableCollectionOfListTests : MrwCollectionTests<ObservableCollection<List<AvailabilitySetData>>, AvailabilitySetData>
    {
        ...
        protected override string CollectionTypeName => "ObservableCollection<List<AvailabilitySetData>>";
...
#nullable disable
        public class LocalContext : ModelReaderWriterContext
        {
            ...
            private class ObservableCollection_List_AvailabilitySetData_Builder : ModelReaderWriterTypeBuilder
            {
                protected override Type BuilderType => typeof(ObservableCollection<List<AvailabilitySetData>>);

                protected override Type ItemType => typeof(List<AvailabilitySetData>);

                protected override object CreateInstance() => new ObservableCollection<List<AvailabilitySetData>>();

                protected override void AddItem(object collection, object item)
                    => ((ObservableCollection<List<AvailabilitySetData>>)collection).Add((List<AvailabilitySetData>)item);
            }
        }
#nullable enable
    }
