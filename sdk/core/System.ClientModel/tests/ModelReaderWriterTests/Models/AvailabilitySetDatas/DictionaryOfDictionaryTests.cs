    ...
    public class DictionaryOfDictionaryTests : MrwCollectionTests<Dictionary<string, Dictionary<string, AvailabilitySetData>>, AvailabilitySetData>
    {
        ...
        private class LocalContext : ModelReaderWriterContext
        {
            ...
            private class Dictionary_String_Dictionary_String_AvailabilitySetData_Builder : ModelBuilder
            {
                ...
                protected override Func<object> CreateInstance => _createInstance ??= () => new Dictionary<string, Dictionary<string, AvailabilitySetData>>();

                private Action<object, object, string?>? _addItem;
                protected override Action<object, object, string?>? AddItem
                    => _addItem ??= (collection, item, key) => AssertCollection<Dictionary<string, Dictionary<string, AvailabilitySetData>>>(collection).Add(AssertKey(key), AssertItem<Dictionary<string, AvailabilitySetData>>(item));
