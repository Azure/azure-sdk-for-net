...
namespace System.ClientModel.Tests.ModelReaderWriterTests.Models.AvailabilitySetDatas
{
    public class CollectionOfListTests : MrwCollectionTests<Collection<List<AvailabilitySetData>>, AvailabilitySetData>
    {
        ...
        protected override string CollectionTypeName => "Collection<List<AvailabilitySetData>>";
...
#nullable disable
        public class LocalContext : ModelReaderWriterContext
        {
            ...
            private Collection_List_AvailabilitySetData_Builder _collection_List_AvailabilitySetData_Builder;

            protected override bool TryGetTypeBuilderCore(Type type, out ModelReaderWriterTypeBuilder builder)
            {
                builder = type switch
                {
                    Type t when t == typeof(Collection<List<AvailabilitySetData>>) => _collection_List_AvailabilitySetData_Builder ??= new(),
            ...
            private class Collection_List_AvailabilitySetData_Builder : ModelReaderWriterTypeBuilder
            {
                protected override Type BuilderType => typeof(Collection<List<AvailabilitySetData>>);

                protected override Type ItemType => typeof(List<AvailabilitySetData>);

                protected override object CreateInstance() => new Collection<List<AvailabilitySetData>>();

                protected override void AddItem(object collection, object item)
                    => ((Collection<List<AvailabilitySetData>>)collection).Add((List<AvailabilitySetData>)item);
            }
        }
#nullable enable
    }
