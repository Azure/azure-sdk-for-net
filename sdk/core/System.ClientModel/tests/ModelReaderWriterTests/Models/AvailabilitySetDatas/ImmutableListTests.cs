        ...
        private class LocalContext : ModelReaderWriterContext
        {
            ...
            private class ImmutableList_AvailabilitySetData_Builder : ModelBuilder
            {
                ...
                protected override void AddItem(object collection, object item)
                    => AssertCollection<ImmutableList<AvailabilitySetData>.Builder>(collection).Add(AssertItem<AvailabilitySetData>(item));
                ...
                protected override object ToCollection(object builder)
                    => AssertCollection<ImmutableList<AvailabilitySetData>.Builder>(builder).ToImmutable();
            }
        }
    }
}
