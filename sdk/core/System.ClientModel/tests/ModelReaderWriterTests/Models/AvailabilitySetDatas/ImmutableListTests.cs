...
namespace System.ClientModel.Tests.ModelReaderWriterTests.Models.AvailabilitySetDatas
{
    public class ImmutableListTests : MrwCollectionTests<ImmutableList<AvailabilitySetData>, AvailabilitySetData>
    {
        ...
        private class LocalContext : ModelReaderWriterContext
        {
            ...
            private class ImmutableList_AvailabilitySetData_Builder : ModelBuilder
            {
                private Func<object>? _createInstance;
                protected override Func<object> CreateInstance => _createInstance ??= ImmutableList<AvailabilitySetData>.Empty.ToBuilder;

                private Action<object, object, string?>? _addItem;
                protected override Action<object, object, string?>? AddItem
                    => _addItem ??= (collection, item, _) => AssertCollection<ImmutableList<AvailabilitySetData>.Builder>(collection).Add(AssertItem<AvailabilitySetData>(item));
                ...
                protected override Func<object, object> ToCollection
                    => _toCollection ??= collection => AssertCollection<ImmutableList<AvailabilitySetData>.Builder>(collection).ToImmutable();
            }
        }
    }
}
