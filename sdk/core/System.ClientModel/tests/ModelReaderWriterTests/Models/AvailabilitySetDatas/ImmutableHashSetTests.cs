...
namespace System.ClientModel.Tests.ModelReaderWriterTests.Models.AvailabilitySetDatas
{
    public class ImmutableHashSetTests : MrwCollectionTests<ImmutableHashSet<AvailabilitySetData>, AvailabilitySetData>
    {
        ...
        public class LocalContext : ModelReaderWriterContext
        {
            ...
            private ImmutableHashSet_AvailabilitySetData_Info? _immutableHashSet_AvailabilitySetData_Info;

            public override ModelInfo? GetModelInfo(Type type)
            {
                return type switch
                {
                    Type t when t == typeof(ImmutableHashSet<AvailabilitySetData>) => _immutableHashSet_AvailabilitySetData_Info ??= new(),
                    _ => s_libraryContext.Value.GetModelInfo(type)
                };
            }

            private class ImmutableHashSet_AvailabilitySetData_Info : ModelInfo
            {
                public override object CreateObject() => new ImmutableHashSet_AvailabilitySetData_Builder();

                private class ImmutableHashSet_AvailabilitySetData_Builder : CollectionBuilder
                {
                    private readonly Lazy<ImmutableHashSet<AvailabilitySetData>.Builder> _instance = new(() => ImmutableHashSet<AvailabilitySetData>.Empty.ToBuilder());
