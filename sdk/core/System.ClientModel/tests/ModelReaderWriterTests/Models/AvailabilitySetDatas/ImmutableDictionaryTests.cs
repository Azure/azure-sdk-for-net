...
namespace System.ClientModel.Tests.ModelReaderWriterTests.Models.AvailabilitySetDatas
{
    public class ImmutableDictionaryTests : MrwCollectionTests<ImmutableDictionary<string, AvailabilitySetData>, AvailabilitySetData>
    {
        ...
        public class LocalContext : ModelReaderWriterContext
        {
            ...
            private ImmutableDictionary_AvailabilitySetData_Info? _immutable_dictionary_AvailabilitySetData_Info;

            public override ModelInfo? GetModelInfo(Type type)
            {
                return type switch
                {
                    Type t when t == typeof(ImmutableDictionary<string, AvailabilitySetData>) => _immutable_dictionary_AvailabilitySetData_Info ??= new(),
                    _ => s_libraryContext.Value.GetModelInfo(type)
                };
            }

            private class ImmutableDictionary_AvailabilitySetData_Info : ModelInfo
            {
                public override object CreateObject() => new ImmutableDictionary_AvailabilitySetData_Builder();

                private class ImmutableDictionary_AvailabilitySetData_Builder : CollectionBuilder
                {
                    private readonly Lazy<ImmutableDictionary<string, AvailabilitySetData>.Builder> _instance = new(() => ImmutableDictionary<string, AvailabilitySetData>.Empty.ToBuilder());
