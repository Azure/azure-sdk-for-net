    ...
    public class LinkedListOfListTests : MrwCollectionTests<LinkedList<List<AvailabilitySetData>>, AvailabilitySetData>
    {
        ...
        public class LocalContext : ModelReaderWriterContext
        {
            ...
            private class LinkedList_List_AvailabilitySetData_Builder : ModelBuilder
            {
                ...
                protected override Func<object> CreateInstance => _createInstance ??= () => new LinkedList<List<AvailabilitySetData>>();

                private Action<object, object, string?>? _addItem;
                protected override Action<object, object, string?>? AddItem
                    => _addItem ??= (collection, item, key) => AssertCollection<LinkedList<List<AvailabilitySetData>>>(collection).AddLast(AssertItem<List<AvailabilitySetData>>(item));
