...
namespace System.ClientModel.Tests.ModelReaderWriterTests.Models.AvailabilitySetDatas
{
    public class CollectionTests : MrwCollectionTests<Collection<AvailabilitySetData>, AvailabilitySetData>
    {
        ...
        public class LocalContext : ModelReaderWriterContext
        {
            ...
            private class Collection_AvailabilitySetData_Builder : ModelBuilder
            {
                private Func<object>? _createInstance;
                protected override Func<object> CreateInstance => _createInstance ??= () => new Collection<AvailabilitySetData>();

                private Action<object, object, string?>? _addItem;
                protected override Action<object, object, string?>? AddItem
                    => _addItem ??= (collection, item, key) => AssertCollection<Collection<AvailabilitySetData>>(collection).Add(AssertItem<AvailabilitySetData>(item));
