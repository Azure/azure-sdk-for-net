        ...
        public class LocalContext : ModelReaderWriterContext
        {
            ...
            private class ImmutableSortedSet_AvailabilitySetData_Builder : ModelBuilder
            {
                ...
                protected override void AddItem(object collection, object item)
                    => AssertCollection<ImmutableSortedSet<AvailabilitySetData>.Builder>(collection).Add(AssertItem<AvailabilitySetData>(item));
                ...
                protected override object ToCollection(object builder)
                    => AssertCollection<ImmutableSortedSet<AvailabilitySetData>.Builder>(builder).ToImmutable();
            }
        }
    }
}
