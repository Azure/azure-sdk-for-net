...
namespace System.ClientModel.Tests.ModelReaderWriterTests.Models.AvailabilitySetDatas
{
    public class ImmutableSortedSetTests : MrwCollectionTests<ImmutableSortedSet<AvailabilitySetData>, AvailabilitySetData>
    {
        ...
        public class LocalContext : ModelReaderWriterContext
        {
            ...
            private class ImmutableSortedSet_AvailabilitySetData_Builder : ModelBuilder
            {
                private Func<object>? _createInstance;
                protected override Func<object> CreateInstance => _createInstance ??= ImmutableSortedSet<AvailabilitySetData>.Empty.WithComparer(new AvailabilitySetDataComparer()).ToBuilder;

                private Action<object, object, string?>? _addItem;
                protected override Action<object, object, string?>? AddItem
                    => _addItem ??= (collection, item, _) => AssertCollection<ImmutableSortedSet<AvailabilitySetData>.Builder>(collection).Add(AssertItem<AvailabilitySetData>(item));
                ...
                protected override Func<object, object> ToCollection
                    => _toCollection ??= collection => AssertCollection<ImmutableSortedSet<AvailabilitySetData>.Builder>(collection).ToImmutable();
            }
        }
    }
}
