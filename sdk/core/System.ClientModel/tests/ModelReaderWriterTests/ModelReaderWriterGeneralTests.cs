...
namespace System.ClientModel.Tests.ModelReaderWriterTests
{
    public class ModelReaderWriterGeneralTests
    {
        ...
        public void ReadDictionaryWithNoPropertyNames()
        {
            ...
            catch (Exception ex)
            {
                ...
                Assert.Multiple(() =>
                {
                    ...
                    Assert.That(ex.Message, Does.StartWith("'{' is an invalid start of a property name."));
                });
            }
        ...
        public void ReadBadAbstractType()
        {
            ...
            Assert.That(ex, Is.Not.Null);
            Assert.That(ex!.Message, Does.Contain("must be decorated with PersistableModelProxyAttribute"));
        }
        ...
        public void ReadBadValueType()
        {
            ...
            Assert.That(ex, Is.Not.Null);
            Assert.That(ex!.Message, Does.Contain("does not implement IPersistableModel"));
        }
