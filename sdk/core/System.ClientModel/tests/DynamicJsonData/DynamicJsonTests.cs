...
public class DynamicJsonTests
{
    ...
    public void CanAddPocoProperty()
    {
        ...
        BinaryContent content = BinaryContent.Create(value);
    ...
    public void ThrowsInvalidCastForOriginalJsonValue()
    {
        ...
        Assert.That(e?.Message.Contains(JsonValueKind.Number.ToString()), Is.True);
    }
    ...
    public void ThrowsInvalidCastForChangedJsonValue()
    {
        ...
        Assert.That(e?.Message.Contains(JsonValueKind.True.ToString()), Is.True);
    }
    ...
    {
        DynamicJsonDataOptions options = new()
        {
            DateTimeFormat = "x"
        };
    ...
    public void CanRoundTripSerialize()
    {
        ...
        dynamic roundTrip = JsonSerializer.Deserialize<DynamicJsonData>(JsonSerializer.Serialize(orig, orig.GetType()));
...
#pragma warning disable CS0659 // Type overrides Object.Equals(object o) but does not override Object.GetHashCode()
    {
        ...
        public override bool Equals(object? obj)
        {
            return obj switch
            {
                ParentModel other => Equals(other),
                _ => false,
            };
        }
        ...
        public bool Equals(ParentModel? obj)
        {
            return obj switch
            {
                ParentModel other => Name == other.Name && (Value == null ? other.Value == null : Value.Equals(other)),
                _ => false,
            };
        }
    }
    ...
    internal class ChildModel : IEquatable<ChildModel>
    {
        ...
        public override bool Equals(object? obj)
        {
            return obj switch
            {
                ChildModel other => Equals(other),
                _ => false,
            };
        }

        public bool Equals(ChildModel? obj) => Message == obj?.Message && Number == obj?.Number;
    }
...
#pragma warning restore CS0659 // Type overrides Object.Equals(object o) but does not override Object.GetHashCode()
    {
        ...
        public override bool Equals(object? obj)
        {
            return obj switch
            {
                SampleModel other => Equals(other),
                _ => false,
            };
        }

        public bool Equals(SampleModel? obj) => Message == obj?.Message && Number == obj?.Number;
    }
    #endregion
}
