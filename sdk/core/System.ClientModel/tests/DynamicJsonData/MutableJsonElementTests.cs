...
internal class MutableJsonElementTests
{
    ...
    public void StaticMethodsAreSameAsExpected()
    {
        ...
        var actualMethods = Type.GetType("System.ClientModel.Json.MutableJsonElement, System.ClientModel")?.GetMethods(BindingFlags.Static | BindingFlags.NonPublic | BindingFlags.Public);
    ...
    public void NestedTypesAreSameAsExpected()
    {
        ...
        var actualNestedTypes = Type.GetType("System.ClientModel.Json.MutableJsonElement, System.ClientModel")?.GetNestedTypes(BindingFlags.NonPublic | BindingFlags.Public | BindingFlags.Instance);
