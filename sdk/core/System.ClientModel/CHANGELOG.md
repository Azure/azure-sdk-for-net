...
- Added `PipelineMessageClassifier.Create(ReadOnlySpan<(ushort MinInclusive, ushort MaxInclusive)>)` factory method overload for creating classifiers based on status code ranges. 
