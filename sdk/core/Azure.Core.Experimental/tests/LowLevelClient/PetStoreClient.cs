...
namespace Azure.Core.Experimental.Tests
{
    ...
    public partial class PetStoreClient
    {
        ...
        public PetStoreClient(Uri endpoint, TokenCredential credential, PetStoreClientOptions options = null)
        {
            ...
            Pipeline = HttpPipelineBuilder.Build(options, new HttpPipelinePolicy[] { new LowLevelCallbackPolicy() }, new HttpPipelinePolicy[] { authPolicy, new ResponsePropertiesPolicy(_clientDiagnostics) }, new ResponseClassifier());
