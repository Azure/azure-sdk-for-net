...
namespace Azure.Core.Dynamic
{
    ...
    public partial class JsonData : System.Dynamic.IDynamicMetaObjectProvider, System.IEquatable<Azure.Core.Dynamic.JsonData>
    {
        ...
        public static explicit operator int (Azure.Core.Dynamic.JsonData json) { throw null; }
        public static explicit operator long (Azure.Core.Dynamic.JsonData json) { throw null; }
        public static explicit operator bool? (Azure.Core.Dynamic.JsonData json) { throw null; }
        public static explicit operator double? (Azure.Core.Dynamic.JsonData json) { throw null; }
        public static explicit operator int? (Azure.Core.Dynamic.JsonData json) { throw null; }
        public static explicit operator long? (Azure.Core.Dynamic.JsonData json) { throw null; }
