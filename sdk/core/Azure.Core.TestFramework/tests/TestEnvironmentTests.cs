...
namespace Azure.Core.TestFramework.Tests
{
    public class TestEnvironmentTests
    {
        ...
        public async Task RecordedVariableSanitized()
        {
            ...
            var testRecording = await TestRecording.CreateAsync(RecordedTestMode.Record, tempFile, proxy, new RecordedTestBaseTests(true), assetsJson: null);
            ...
            testRecording = await TestRecording.CreateAsync(RecordedTestMode.Playback, tempFile, proxy, new RecordedTestBaseTests(true), assetsJson: null);
