...
namespace Azure.Core.TestFramework.Models
{
    ...
    public static partial class CoreTestFrameworkModelFactory
    {
        ...
        {
            return new StartInformation(xRecordingFile, xRecordingAssetsFile);
        }
        ...
        {
            return new BodyKeySanitizer(jsonPath, value, regex, groupForReplace);
        }
        ...
        {
            return new HeaderRegexSanitizer(key, value, regex, groupForReplace);
        }
        ...
        {
            return new UriRegexSanitizer(regex, value, groupForReplace);
        }
        ...
        {
            return new BodyRegexSanitizer(regex, value, groupForReplace, condition);
        }
        ...
        {
            return new HeaderTransform(key, value, condition);
        }
    }
}
