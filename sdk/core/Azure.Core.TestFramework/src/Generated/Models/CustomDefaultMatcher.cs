...
namespace Azure.Core.TestFramework.Models
{
    ...
    public partial class CustomDefaultMatcher
    {
        ...
        internal CustomDefaultMatcher(string excludedHeaders, bool? compareBodies, string ignoredHeaders, string ignoredQueryParameters, Dictionary<string, BinaryData> rawData)
        {
