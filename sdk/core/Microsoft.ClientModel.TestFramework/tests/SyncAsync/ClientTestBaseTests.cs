...
public class ClientTestBaseTests
{
    ...
    {
        var client = _testBase.CreateProxiedClient<MockClient>();
    ...
    public void CreateProxiedClient_WithConstructorArgs_PassesArgsToConstructor()
    {
        ...
        var client = _testBase.CreateProxiedClient<MockClientWithArgs>(expectedValue);
    ...
    public void CreateProxiedClient_WithInvalidConstructorArgs_ThrowsException()
    {
        Assert.Throws<MissingMethodException>(() =>
            _testBase.CreateProxiedClient<MockClient>("unexpected-arg"));
    }
    ...
    public void GetOriginal_WithProxiedClient_ReturnsOriginalInstance()
    {
        var originalClient = new MockClient();
        var proxiedClient = _testBase.CreateProxyFromClient(originalClient);
        var retrievedOriginal = _testBase.GetOriginal(proxiedClient);
    ...
    public void GetOriginal_WithNullClient_ThrowsArgumentNullException()
    {
        ...
        Assert.Throws<ArgumentNullException>(() => _testBase.GetOriginal(nullClient));
    }
    ...
    public void GetOriginal_WithNonProxiedClient_ThrowsInvalidOperationException()
    {
        ...
        Assert.Throws<InvalidOperationException>(() => _testBase.GetOriginal(nonProxiedClient));
    }

    [Test]
    public void CreateProxyFromOperationResult_WithValidOperation_ReturnsProxiedInstance()
    {
        var operation = new MockOperationResult();
    ...
    [Test]
    public void TestStartTime_Property_ReturnsValidDateTime()
    {
        var startTime = _testBase.TestStartTime;
        
        Assert.Greater(startTime, DateTime.MinValue);
        Assert.LessOrEqual(startTime, DateTime.UtcNow);
    }
