...
public class SyncAsyncIntegrationTests
{
    ...
    public void ClientTestBase_WithProxiedClient_WorksEndToEnd()
    {
        ...
        var client = testBase.CreateProxiedClient<MockClientForIntegration>();
        
        Assert.IsNotNull(client);
        Assert.IsInstanceOf<IProxiedClient>(client);
        
        var original = testBase.GetOriginal(client);
    ...
    {
        public override PipelineResponse GetRawResponse() => new MockPipelineResponse();
        public override ValueTask<PipelineResponse> GetRawResponseAsync() => new ValueTask<PipelineResponse>(new MockPipelineResponse());
