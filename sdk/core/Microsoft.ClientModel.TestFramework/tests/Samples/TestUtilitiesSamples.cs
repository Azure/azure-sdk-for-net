...
public class TestUtilitiesSamples
{
    ...
    #region Snippet:CustomAssertions
    [TestFixture]
    ...
    #region Snippet:PerformanceTestingUtilities
    [TestFixture]
    ...
    #region Snippet:TestConfigurationManagement
    [TestFixture]
    ...
    #region Snippet:DebuggingHelpers
    [TestFixture]
    ...
    #region Snippet:TestDataManagement
    [TestFixture]
    ...
    #region Snippet:UtilityOrganization
    [TestFixture]
...
// Helper classes for test samples - these demonstrate patterns but aren't part of the framework

public static class AsyncAssert
{
    public static async Task DoesNotThrowAsync(Func<Task> operation)
    {
        try
        {
            await operation();
    ...
    public static async Task<T> ThrowsAsync<T>(Func<Task> operation) where T : Exception
    {
        try
        {
            await operation();
