...
public class RecordedTestModeTests
{
    ...
    [Test]
    public void RecordedTestMode_CanParseFromString()
    {
        Assert.AreEqual(RecordedTestMode.Live, Enum.Parse<RecordedTestMode>("Live"));
        Assert.AreEqual(RecordedTestMode.Record, Enum.Parse<RecordedTestMode>("Record"));
        Assert.AreEqual(RecordedTestMode.Playback, Enum.Parse<RecordedTestMode>("Playback"));
    }

    [Test]
    public void RecordedTestMode_ParseIsCaseInsensitive()
    {
        Assert.AreEqual(RecordedTestMode.Live, Enum.Parse<RecordedTestMode>("live", ignoreCase: true));
        Assert.AreEqual(RecordedTestMode.Record, Enum.Parse<RecordedTestMode>("RECORD", ignoreCase: true));
        Assert.AreEqual(RecordedTestMode.Playback, Enum.Parse<RecordedTestMode>("playback", ignoreCase: true));
    }
