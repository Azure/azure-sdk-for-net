...
public class PlaybackOnlyAttributeTests
{
    ...
    [Test]
    public void Attribute_AllowsMultiple_CanHaveMultipleAttributes()
    {
        var method = typeof(TestClassWithPlaybackOnlyMethod).GetMethod(nameof(TestClassWithPlaybackOnlyMethod.MultiplePlaybackOnlyMethod));
        var attributes = method.GetCustomAttributes<PlaybackOnlyAttribute>();
