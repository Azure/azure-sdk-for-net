...
public class TestRecordingTests
{
    ...
    {
        public MockRecordedTestBase(RecordedTestMode mode = RecordedTestMode.Live)
        {
            Mode = mode;
        }
        ...
        {
            // Mock implementation - no sanitizers added
        }
    }

    private class MockTestProxyProcess : TestProxyProcess
    {
        public MockTestProxyProcess() : base(null, null, null)
        {
            // Mock implementation
        }

        public override PipelineTransport CreateHttpTransport()
        {
