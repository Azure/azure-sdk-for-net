...
public class TestEnvironmentTests
{
    ...
    [Test]
    public void RepositoryRoot_WhenSet_IsValidPath()
    {
        var repositoryRoot = TestEnvironment.RepositoryRoot;
        
        if (repositoryRoot != null)
        {
            Assert.IsTrue(System.IO.Path.IsPathFullyQualified(repositoryRoot), "Repository root should be a fully qualified path");
        }
    }

    [Test]
    public void DevCertPath_WhenSet_IsValidPath()
    {
        var devCertPath = TestEnvironment.DevCertPath;
        
        if (devCertPath != null)
        {
            Assert.IsTrue(System.IO.Path.IsPathFullyQualified(devCertPath), "Dev cert path should be a fully qualified path");
        }
    }
