# ARM provider schema comparison: Azure.ResourceManager.DependencyMap
...
| --- | --- | --- |
| `/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DependencyMap/maps/{mapName}` | `DependencyMap` | `MapsResource` |
| `/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DependencyMap/maps/{mapName}/discoverySources/{sourceName}` | `DependencyMapDiscoverySource` | `DiscoverySourceResource` |
