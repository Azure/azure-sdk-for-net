...
namespace Azure.ResourceManager.DependencyMap
{
    ...
    public partial class DependencyMapResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<DependencyMapResource>> UpdateAsync(WaitUntil waitUntil, DependencyMapData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _mapsRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, DependencyMapData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                DependencyMapArmOperation<DependencyMapResource> operation = new DependencyMapArmOperation<DependencyMapResource>(
                    new DependencyMapResourceOperationSource(Client),
                    _mapsClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<DependencyMapResource> Update(WaitUntil waitUntil, DependencyMapData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
