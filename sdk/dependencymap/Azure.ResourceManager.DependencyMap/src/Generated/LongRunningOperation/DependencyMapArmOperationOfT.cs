...
namespace Azure.ResourceManager.DependencyMap
{
    internal partial class DependencyMapArmOperation<T> : ArmOperation<T>
    {
        ...
        internal DependencyMapArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
