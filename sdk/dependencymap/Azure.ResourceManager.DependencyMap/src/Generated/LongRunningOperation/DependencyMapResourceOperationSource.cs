...
{
    /// <summary></summary>
    internal partial class DependencyMapResourceOperationSource : IOperationSource<DependencyMapResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal DependencyMapResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
