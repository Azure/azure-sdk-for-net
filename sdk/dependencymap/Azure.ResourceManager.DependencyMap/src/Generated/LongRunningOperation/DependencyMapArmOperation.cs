...
#pragma warning disable SA1649 // File name should match first type name
    internal class DependencyMapArmOperation : ArmOperation
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        /// <summary> Initializes a new instance of DependencyMapArmOperation for mocking. </summary>
        protected DependencyMapArmOperation()
        {
        }

        internal DependencyMapArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal DependencyMapArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal(nextLinkOperation, clientDiagnostics, response, "DependencyMapArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
        ...
        private string GetOperationId(RehydrationToken? rehydrationToken)
        {
            ...
            var lroDetails = ModelReaderWriter.Write(rehydrationToken, ModelReaderWriterOptions.Json, AzureResourceManagerDependencyMapContext.Default).ToObjectFromJson<Dictionary<string, string>>();
