...
namespace Azure.ResourceManager.DependencyMap
{
    internal partial class DependencyMapArmOperation : ArmOperation
    {
        ...
        internal DependencyMapArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
