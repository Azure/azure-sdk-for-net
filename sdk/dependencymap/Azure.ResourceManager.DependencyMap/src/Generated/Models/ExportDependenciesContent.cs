...
namespace Azure.ResourceManager.DependencyMap.Models
{
    ...
    public partial class ExportDependenciesContent
    {
        ...
        internal ExportDependenciesContent(string focusedMachineId, DependencyMapVisualizationFilter filters, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            FocusedMachineId = focusedMachineId;
            Filters = filters;
