...
namespace Azure.ResourceManager.DependencyMap
{
    ...
    public partial class DependencyMapDiscoverySourceData : TrackedResourceData, IJsonModel<DependencyMapDiscoverySourceData>
    {
        /// <summary> Initializes a new instance of <see cref="DependencyMapDiscoverySourceData"/> for deserialization. </summary>
        internal DependencyMapDiscoverySourceData()
        {
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        DependencyMapDiscoverySourceData IJsonModel<DependencyMapDiscoverySourceData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (DependencyMapDiscoverySourceData)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static DependencyMapDiscoverySourceData DeserializeDependencyMapDiscoverySourceData(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = DependencyMapDiscoverySourceProperties.DeserializeDependencyMapDiscoverySourceProperties(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
