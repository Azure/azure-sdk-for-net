...
{
    internal partial class PrivateLinkResourcesGetAllCollectionResultOfT : Pageable<OnlineExperimentationPrivateLinkResourceData>
    {
        ...
        public PrivateLinkResourcesGetAllCollectionResultOfT(PrivateLinkResources client, Guid subscriptionId, string resourceGroupName, string workspaceName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        public override IEnumerable<Page<OnlineExperimentationPrivateLinkResourceData>> AsPages(string continuationToken, int? pageSizeHint)
        {
