...
{
    internal partial class PrivateEndpointConnectionsGetAllAsyncCollectionResultOfT : AsyncPageable<OnlineExperimentationPrivateEndpointConnectionData>
    {
        ...
        public PrivateEndpointConnectionsGetAllAsyncCollectionResultOfT(PrivateEndpointConnections client, Guid subscriptionId, string resourceGroupName, string workspaceName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        public override async IAsyncEnumerable<Page<OnlineExperimentationPrivateEndpointConnectionData>> AsPages(string continuationToken, int? pageSizeHint)
        {
