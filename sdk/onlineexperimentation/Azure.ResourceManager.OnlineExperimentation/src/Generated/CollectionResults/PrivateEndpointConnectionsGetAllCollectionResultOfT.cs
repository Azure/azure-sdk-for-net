...
{
    internal partial class PrivateEndpointConnectionsGetAllCollectionResultOfT : Pageable<OnlineExperimentationPrivateEndpointConnectionData>
    {
        ...
        public PrivateEndpointConnectionsGetAllCollectionResultOfT(PrivateEndpointConnections client, Guid subscriptionId, string resourceGroupName, string workspaceName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        public override IEnumerable<Page<OnlineExperimentationPrivateEndpointConnectionData>> AsPages(string continuationToken, int? pageSizeHint)
        {
        ...
        private Response GetNextResponse(int? pageSizeHint, Uri nextLink)
        {
            ...
            using DiagnosticScope scope = _client.ClientDiagnostics.CreateScope("OnlineExperimentationPrivateEndpointConnectionCollection.GetAll");
            scope.Start();
            try
            {
