...
namespace Azure.ResourceManager.OnlineExperimentation.Models
{
    ...
    public partial class PrivateEndpointConnectionProperties : IJsonModel<PrivateEndpointConnectionProperties>
    {
        ...
        internal static PrivateEndpointConnectionProperties DeserializePrivateEndpointConnectionProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            OnlineExperimentationPrivateLinkServiceConnectionState privateLinkServiceConnectionState = default;
            OnlineExperimentationPrivateEndpointConnectionProvisioningState? provisioningState = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("privateEndpoint"u8))
                {
                    ...
                    privateEndpoint = ModelReaderWriter.Read<SubResource>(new BinaryData(Encoding.UTF8.GetBytes(prop.Value.GetRawText())), ModelSerializationExtensions.WireOptions, AzureResourceManagerOnlineExperimentationContext.Default);
                    continue;
                }
                if (prop.NameEquals("privateLinkServiceConnectionState"u8))
                {
                    privateLinkServiceConnectionState = OnlineExperimentationPrivateLinkServiceConnectionState.DeserializeOnlineExperimentationPrivateLinkServiceConnectionState(prop.Value, options);
                    continue;
                }
                if (prop.NameEquals("provisioningState"u8))
                {
                    ...
                    provisioningState = new OnlineExperimentationPrivateEndpointConnectionProvisioningState(prop.Value.GetString());
                    continue;
                }
                if (options.Format != "W")
                {
