...
namespace Azure.ResourceManager.OnlineExperimentation
{
    ...
    /// Each <see cref="PrivateLinkResource"/> in the collection will belong to the same instance of <see cref="OnlineExperimentationWorkspaceResource"/>.
    /// To get a <see cref="PrivateLinkResourceCollection"/> instance call the GetPrivateLinkResources method from an instance of <see cref="OnlineExperimentationWorkspaceResource"/>.
    /// </summary>
    public partial class PrivateLinkResourceCollection : ArmCollection, IEnumerable<PrivateLinkResource>, IAsyncEnumerable<PrivateLinkResource>
    {
        ...
        internal PrivateLinkResourceCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _privateLinkResourcesClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.OnlineExperimentation", PrivateLinkResource.ResourceType.Namespace, Diagnostics);
            _privateLinkResourcesRestClient = new PrivateLinkResources(_privateLinkResourcesClientDiagnostics, Pipeline, Endpoint, privateLinkResourceApiVersion ?? "2025-08-01-preview");
        ...
        public virtual async Task<Response<PrivateLinkResource>> GetAsync(string privateLinkResourceName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                Response<OnlineExperimentationPrivateLinkResourceData> response = Response.FromValue(OnlineExperimentationPrivateLinkResourceData.FromResponse(result), result);
        ...
        public virtual AsyncPageable<PrivateLinkResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<OnlineExperimentationPrivateLinkResourceData, PrivateLinkResource>(new PrivateLinkResourcesGetAllAsyncCollectionResultOfT(_privateLinkResourcesRestClient, Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context), data => new PrivateLinkResource(Client, data));
        }
        ...
        public virtual Pageable<PrivateLinkResource> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            return new PageableWrapper<OnlineExperimentationPrivateLinkResourceData, PrivateLinkResource>(new PrivateLinkResourcesGetAllCollectionResultOfT(_privateLinkResourcesRestClient, Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context), data => new PrivateLinkResource(Client, data));
        }
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string privateLinkResourceName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                Response<OnlineExperimentationPrivateLinkResourceData> response = default;
                switch (result.Status)
                {
                    case 200:
                        response = Response.FromValue(OnlineExperimentationPrivateLinkResourceData.FromResponse(result), result);
                        break;
                    case 404:
                        response = Response.FromValue((OnlineExperimentationPrivateLinkResourceData)null, result);
                        break;
                    default:
