...
namespace Azure.ResourceManager.OnlineExperimentation
{
    ...
    public partial class OnlineExperimentationWorkspaceResource : ArmResource
    {
        ...
        /// <summary>
        /// Updates the OnlineExperimentationWorkspace.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OnlineExperimentation/workspaces/{workspaceName}. </description>
        ...
        public virtual async Task<ArmOperation<OnlineExperimentationWorkspaceResource>> UpdateAsync(WaitUntil waitUntil, OnlineExperimentationWorkspaceData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _onlineExperimentationWorkspacesRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, OnlineExperimentationWorkspaceData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                OnlineExperimentationArmOperation<OnlineExperimentationWorkspaceResource> operation = new OnlineExperimentationArmOperation<OnlineExperimentationWorkspaceResource>(
                    new OnlineExperimentationWorkspaceResourceOperationSource(Client),
                    _onlineExperimentationWorkspacesClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<OnlineExperimentationWorkspaceResource> Update(WaitUntil waitUntil, OnlineExperimentationWorkspaceData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
