...
{
    internal partial class OnlineExperimentationWorkspaces
    {
        private readonly Uri _endpoint;
        private readonly string _apiVersion;
        private readonly TelemetryDetails _userAgent;

        /// <summary> Initializes a new instance of OnlineExperimentationWorkspaces for mocking. </summary>
        protected OnlineExperimentationWorkspaces()
        {
        }

        /// <summary> Initializes a new instance of OnlineExperimentationWorkspaces. </summary>
        /// <param name="clientDiagnostics"> The ClientDiagnostics is used to provide tracing support for the client library. </param>
        /// <param name="pipeline"> The HTTP pipeline for sending and receiving REST requests and responses. </param>
        /// <param name="applicationId"> The application id to use for user agent. </param>
        /// <param name="endpoint"> Service endpoint. </param>
        /// <param name="apiVersion"></param>
        internal OnlineExperimentationWorkspaces(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string applicationId, Uri endpoint, string apiVersion)
        {
            ClientDiagnostics = clientDiagnostics;
            _endpoint = endpoint;
            Pipeline = pipeline;
            _apiVersion = apiVersion;
            _userAgent = new TelemetryDetails(typeof(OnlineExperimentationWorkspaces).Assembly, applicationId);
        }
        ...
        internal HttpMessage CreateGetRequest(Guid subscriptionId, string resourceGroupName, string workspaceName, RequestContext context)
        {
            ...
            uri.AppendPath("/providers/Microsoft.OnlineExperimentation/workspaces/", false);
