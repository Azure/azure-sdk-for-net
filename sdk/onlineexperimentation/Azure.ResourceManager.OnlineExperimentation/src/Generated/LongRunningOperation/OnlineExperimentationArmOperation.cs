...
#pragma warning disable SA1649 // File name should match first type name
    internal class OnlineExperimentationArmOperation : ArmOperation
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        /// <summary> Initializes a new instance of OnlineExperimentationArmOperation for mocking. </summary>
        protected OnlineExperimentationArmOperation()
        {
        }

        internal OnlineExperimentationArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal OnlineExperimentationArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal(nextLinkOperation, clientDiagnostics, response, "OnlineExperimentationArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
        ...
        private string GetOperationId(RehydrationToken? rehydrationToken)
        {
            ...
            var lroDetails = ModelReaderWriter.Write(rehydrationToken, ModelReaderWriterOptions.Json, AzureResourceManagerOnlineExperimentationContext.Default).ToObjectFromJson<Dictionary<string, string>>();
