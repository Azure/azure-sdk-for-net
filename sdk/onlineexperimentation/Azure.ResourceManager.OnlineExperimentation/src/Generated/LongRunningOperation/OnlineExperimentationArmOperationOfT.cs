...
namespace Azure.ResourceManager.OnlineExperimentation
{
    internal partial class OnlineExperimentationArmOperation<T> : ArmOperation<T>
    {
        ...
        internal OnlineExperimentationArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
