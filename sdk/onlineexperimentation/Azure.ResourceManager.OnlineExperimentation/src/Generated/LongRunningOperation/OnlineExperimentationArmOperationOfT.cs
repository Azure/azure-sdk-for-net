...
#pragma warning disable SA1649 // File name should match first type name
    internal class OnlineExperimentationArmOperation<T> : ArmOperation<T>
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        internal OnlineExperimentationArmOperation(Response<T> response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal OnlineExperimentationArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal<T>(NextLinkOperationImplementation.Create(source, nextLinkOperation), clientDiagnostics, response, "OnlineExperimentationArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
