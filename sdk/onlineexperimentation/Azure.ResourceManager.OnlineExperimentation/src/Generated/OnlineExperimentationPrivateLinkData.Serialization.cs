...
namespace Azure.ResourceManager.OnlineExperimentation
{
    ...
    public partial class OnlineExperimentationPrivateLinkData : ResourceData, IJsonModel<OnlineExperimentationPrivateLinkData>
    {
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(OnlineExperimentationPrivateLinkData)} does not support writing '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        OnlineExperimentationPrivateLinkData IJsonModel<OnlineExperimentationPrivateLinkData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (OnlineExperimentationPrivateLinkData)JsonModelCreateCore(ref reader, options);
        ...
        protected virtual ResourceData JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(OnlineExperimentationPrivateLinkData)} does not support reading '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static OnlineExperimentationPrivateLinkData DeserializeOnlineExperimentationPrivateLinkData(JsonElement element, ModelReaderWriterOptions options)
        {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<OnlineExperimentationPrivateLinkData>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        protected virtual BinaryData PersistableModelWriteCore(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(OnlineExperimentationPrivateLinkData)} does not support writing '{options.Format}' format.");
            }
        }
