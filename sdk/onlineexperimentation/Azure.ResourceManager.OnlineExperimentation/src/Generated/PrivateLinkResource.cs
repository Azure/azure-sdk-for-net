...
namespace Azure.ResourceManager.OnlineExperimentation
{
    ...
    /// Otherwise you can get one from its parent resource <see cref="OnlineExperimentationWorkspaceResource"/> using the GetPrivateLinkResources method.
    /// </summary>
    public partial class PrivateLinkResource : ArmResource
    {
        ...
        private readonly OnlineExperimentationPrivateLinkResourceData _data;
        ...
        internal PrivateLinkResource(ArmClient client, OnlineExperimentationPrivateLinkResourceData data) : this(client, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual OnlineExperimentationPrivateLinkResourceData Data
        {
            get
            {
                if (!HasData)
