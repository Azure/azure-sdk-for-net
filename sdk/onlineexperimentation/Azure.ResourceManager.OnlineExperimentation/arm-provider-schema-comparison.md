# ARM provider schema comparison: Azure.ResourceManager.OnlineExperimentation
...
| --- | --- | --- |
| `/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OnlineExperimentation/workspaces/{workspaceName}/privateEndpointConnections/{privateEndpointConnectionName}` | `OnlineExperimentationPrivateEndpointConnection` | `PrivateEndpointConnection` |
| `/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OnlineExperimentation/workspaces/{workspaceName}/privateLinkResources/{privateLinkResourceName}` | `OnlineExperimentationPrivateLink` | `PrivateLinkResource` |
