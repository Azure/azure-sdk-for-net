...
namespace Azure.Analytics.OnlineExperimentation.Tests
{
    public class OnlineExperimentationClientTests : RecordedTestBase<OnlineExperimentationClientTestEnvironment>
    {
        ...
        public void Setup()
        {
            var testEndpoint = new Uri(TestEnvironment.ExperimentWorkspaceEndpoint);
        ...
        public async Task CreateExperimentMetricOnlyIfNotExists()
        {
            ...
            var requestConditions = new RequestConditions { IfNoneMatch = ETag.All };
            Response<ExperimentMetric> response = await _client.CreateOrUpdateMetricAsync(metricId, metricDefinition, requestConditions);
            ...
            {
                await _client.CreateOrUpdateMetricAsync(metricId, metricDefinition, requestConditions);
            });
        ...
        {
            string metricId = "test_metric_validate_valid";
            ...
            Response<ExperimentMetricValidationResult> response = await _client.ValidateMetricAsync(metricId, validDefinition);
        ...
        {
            string metricId = "test_metric_validate_invalid";
            ...
            Response<ExperimentMetricValidationResult> response = await _client.ValidateMetricAsync(metricId, invalidDefinition);
            ExperimentMetricValidationResult result = response.Value;
        ...
        private async Task<ExperimentMetric> SetupTestMetricAsync(
            string metricId,
