...
namespace Azure.Analytics.OnlineExperimentation
{
    ...
    {
        public static void AppendQueryDelimited<T>(this RawRequestUriBuilder builder, string name, IEnumerable<T> value, string delimiter, SerializationFormat format = global::Azure.Analytics.OnlineExperimentation.SerializationFormat.Default, bool escape = true)
        {
            delimiter ??= ",";
            IEnumerable<string> stringValues = value.Select(v => global::Azure.Analytics.OnlineExperimentation.TypeFormatters.ConvertToString(v, format));
