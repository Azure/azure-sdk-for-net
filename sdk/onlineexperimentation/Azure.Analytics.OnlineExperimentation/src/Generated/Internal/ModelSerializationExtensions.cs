...
namespace Azure.Analytics.OnlineExperimentation
{
    internal static class ModelSerializationExtensions
    {
        ...
        internal static readonly JsonSerializerOptions Options = new JsonSerializerOptions { Converters = { new JsonModelConverter(WireOptions, AzureAnalyticsOnlineExperimentationContext.Default) } };
