...
{
    public partial class ExperimentMetricValidationResult : IUtf8JsonSerializable, IJsonModel<ExperimentMetricValidationResult>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ExperimentMetricValidationResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<ExperimentMetricValidationResult>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        ExperimentMetricValidationResult IJsonModel<ExperimentMetricValidationResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ExperimentMetricValidationResult>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        ExperimentMetricValidationResult IPersistableModel<ExperimentMetricValidationResult>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ExperimentMetricValidationResult>)this).GetFormatFromOptions(options) : options.Format;
