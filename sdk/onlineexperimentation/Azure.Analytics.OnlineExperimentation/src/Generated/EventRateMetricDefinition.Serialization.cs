...
{
    public partial class EventRateMetricDefinition : IUtf8JsonSerializable, IJsonModel<EventRateMetricDefinition>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EventRateMetricDefinition>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<EventRateMetricDefinition>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        EventRateMetricDefinition IJsonModel<EventRateMetricDefinition>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<EventRateMetricDefinition>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        BinaryData IPersistableModel<EventRateMetricDefinition>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<EventRateMetricDefinition>)this).GetFormatFromOptions(options) : options.Format;
        ...
        EventRateMetricDefinition IPersistableModel<EventRateMetricDefinition>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<EventRateMetricDefinition>)this).GetFormatFromOptions(options) : options.Format;
