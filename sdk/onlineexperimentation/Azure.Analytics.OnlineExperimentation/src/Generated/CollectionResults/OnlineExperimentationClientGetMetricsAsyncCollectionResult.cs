...
{
    internal partial class OnlineExperimentationClientGetMetricsAsyncCollectionResult : AsyncPageable<global::System.BinaryData>
    {
        ...
        public OnlineExperimentationClientGetMetricsAsyncCollectionResult(OnlineExperimentationClient client, int? maxCount, int? skip, int? maxPageSize, RequestContext context, string diagnosticScope) : base((context?.CancellationToken ?? default))
        {
            _client = client;
            _maxCount = maxCount;
            _skip = skip;
        ...
        public override async IAsyncEnumerable<global::Azure.Page<global::System.BinaryData>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                {
                    items.Add(global::System.ClientModel.Primitives.ModelReaderWriter.Write(item, global::Azure.Analytics.OnlineExperimentation.ModelSerializationExtensions.WireOptions, global::Azure.Analytics.OnlineExperimentation.AzureAnalyticsOnlineExperimentationContext.Default));
                }
