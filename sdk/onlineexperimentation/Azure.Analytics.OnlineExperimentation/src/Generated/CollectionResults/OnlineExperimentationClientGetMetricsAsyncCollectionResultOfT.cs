...
{
    internal partial class OnlineExperimentationClientGetMetricsAsyncCollectionResultOfT : AsyncPageable<global::Azure.Analytics.OnlineExperimentation.ExperimentMetric>
    {
        ...
        /// <returns> The pages of OnlineExperimentationClientGetMetricsAsyncCollectionResultOfT as an enumerable collection. </returns>
        public override async IAsyncEnumerable<global::Azure.Page<global::Azure.Analytics.OnlineExperimentation.ExperimentMetric>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                yield return global::Azure.Page<ExperimentMetric>.FromValues(((IReadOnlyList<global::Azure.Analytics.OnlineExperimentation.ExperimentMetric>)result.Value), (nextPage?.IsAbsoluteUri == true) ? nextPage.AbsoluteUri : nextPage?.OriginalString, response);
