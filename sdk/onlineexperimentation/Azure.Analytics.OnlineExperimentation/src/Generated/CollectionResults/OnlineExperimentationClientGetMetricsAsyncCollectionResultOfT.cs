...
{
    internal partial class OnlineExperimentationClientGetMetricsAsyncCollectionResultOfT : AsyncPageable<ExperimentMetric>
    {
        ...
        public OnlineExperimentationClientGetMetricsAsyncCollectionResultOfT(OnlineExperimentationClient client, int? top, int? skip, int? maxpagesize, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _top = top;
            _skip = skip;
        ...
        public override async IAsyncEnumerable<Page<ExperimentMetric>> AsPages(string continuationToken, int? pageSizeHint)
        {
