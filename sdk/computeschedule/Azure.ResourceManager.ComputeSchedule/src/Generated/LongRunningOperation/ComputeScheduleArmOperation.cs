...
namespace Azure.ResourceManager.ComputeSchedule
{
    internal partial class ComputeScheduleArmOperation : ArmOperation
    {
        ...
        internal ComputeScheduleArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
