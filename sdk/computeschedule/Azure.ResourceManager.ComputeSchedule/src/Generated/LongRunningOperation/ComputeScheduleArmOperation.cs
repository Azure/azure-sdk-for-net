...
#pragma warning disable SA1649 // File name should match first type name
    internal class ComputeScheduleArmOperation : ArmOperation
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        /// <summary> Initializes a new instance of ComputeScheduleArmOperation for mocking. </summary>
        protected ComputeScheduleArmOperation()
        {
        }

        internal ComputeScheduleArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal ComputeScheduleArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal(nextLinkOperation, clientDiagnostics, response, "ComputeScheduleArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
        ...
        private string GetOperationId(RehydrationToken? rehydrationToken)
        {
            ...
            var lroDetails = ModelReaderWriter.Write(rehydrationToken, ModelReaderWriterOptions.Json, AzureResourceManagerComputeScheduleContext.Default).ToObjectFromJson<Dictionary<string, string>>();
