...
{
    /// <summary></summary>
    internal partial class ScheduledActionResourceOperationSource : IOperationSource<ScheduledActionResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal ScheduledActionResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
