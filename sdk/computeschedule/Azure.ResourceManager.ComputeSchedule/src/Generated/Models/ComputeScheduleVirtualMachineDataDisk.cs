...
namespace Azure.ResourceManager.ComputeSchedule.Models
{
    ...
    public partial class ComputeScheduleVirtualMachineDataDisk
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="ComputeScheduleVirtualMachineDataDisk"/>. </summary>
        ...
        public ComputeScheduleVirtualMachineDataDisk(int lun, ComputeScheduleDiskCreateOptionType createOption)
        {
            Lun = lun;
