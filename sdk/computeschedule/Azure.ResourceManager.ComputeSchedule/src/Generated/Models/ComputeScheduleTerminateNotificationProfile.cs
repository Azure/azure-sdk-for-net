...
namespace Azure.ResourceManager.ComputeSchedule.Models
{
    ...
    public partial class ComputeScheduleTerminateNotificationProfile
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="ComputeScheduleTerminateNotificationProfile"/>. </summary>
        ...
        internal ComputeScheduleTerminateNotificationProfile(string notBeforeTimeout, bool? enable, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
