...
namespace Azure.ResourceManager.ComputeSchedule.Models
{
    ...
    internal partial class OccurrenceResourceListResponse
    {
        ...
        internal OccurrenceResourceListResponse(IEnumerable<OccurrenceDetails> value)
        {
            Value = value.ToList();
        }
        ...
        internal OccurrenceResourceListResponse(IList<OccurrenceDetails> value, Uri nextLink, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            NextLink = nextLink;
        ...
        public IList<OccurrenceDetails> Value { get; }
