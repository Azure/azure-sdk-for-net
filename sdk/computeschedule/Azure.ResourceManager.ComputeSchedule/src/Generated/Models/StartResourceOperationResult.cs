...
namespace Azure.ResourceManager.ComputeSchedule.Models
{
    ...
    public partial class StartResourceOperationResult
    {
        ...
        internal StartResourceOperationResult(string description, string resourceType, AzureLocation location, IList<ResourceOperationResult> results, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Description = description;
            ResourceType = resourceType;
            Location = location;
