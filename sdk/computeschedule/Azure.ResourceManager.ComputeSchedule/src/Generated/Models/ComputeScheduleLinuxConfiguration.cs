...
namespace Azure.ResourceManager.ComputeSchedule.Models
{
    ...
    public partial class ComputeScheduleLinuxConfiguration
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="ComputeScheduleLinuxConfiguration"/>. </summary>
        public ComputeScheduleLinuxConfiguration()
        {
        }
        ...
        internal ComputeScheduleLinuxConfiguration(bool? isPasswordAuthenticationDisabled, SshConfiguration ssh, bool? isProvisionVmAgent, ComputeScheduleLinuxPatchSettings patchSettings, bool? isVmAgentPlatformUpdatesEnabled, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
        ...
        public bool? IsProvisionVmAgent { get; set; }

        /// <summary> [Preview Feature] Specifies settings related to VM Guest Patching on Linux. </summary>
        public ComputeScheduleLinuxPatchSettings PatchSettings { get; set; }
        ...
        public IList<ComputeScheduleSshPublicKeyConfiguration> SshPublicKeys
        {
            get
            {
                if (Ssh is null)
