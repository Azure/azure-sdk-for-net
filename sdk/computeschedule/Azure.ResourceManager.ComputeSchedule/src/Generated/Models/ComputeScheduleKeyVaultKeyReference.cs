...
namespace Azure.ResourceManager.ComputeSchedule.Models
{
    ...
    public partial class ComputeScheduleKeyVaultKeyReference
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="ComputeScheduleKeyVaultKeyReference"/>. </summary>
        ...
        public ComputeScheduleKeyVaultKeyReference(Uri keyUri, WritableSubResource sourceVault)
        {
        ...
        internal ComputeScheduleKeyVaultKeyReference(Uri keyUri, WritableSubResource sourceVault, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            KeyUri = keyUri;
            SourceVault = sourceVault;
