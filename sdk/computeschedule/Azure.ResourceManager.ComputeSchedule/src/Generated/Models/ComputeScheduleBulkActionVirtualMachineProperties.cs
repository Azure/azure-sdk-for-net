...
namespace Azure.ResourceManager.ComputeSchedule.Models
{
    ...
    public partial class ComputeScheduleBulkActionVirtualMachineProperties
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="ComputeScheduleBulkActionVirtualMachineProperties"/>. </summary>
        public ComputeScheduleBulkActionVirtualMachineProperties()
        {
        }
        ...
        internal ComputeScheduleBulkActionVirtualMachineProperties(ComputeScheduleScheduledEventsPolicy scheduledEventsPolicy, ComputeScheduleVirtualMachineStorageProfile storageProfile, ComputeScheduleAdditionalCapabilities additionalCapabilities, ComputeScheduleVirtualMachineOSProfile osProfile, ComputeScheduleVirtualMachineNetworkProfile networkProfile, ComputeScheduleVirtualMachineHardwareProfile hardwareProfile, ComputeScheduleSecurityProfile securityProfile, DiagnosticsProfile diagnosticsProfile, string licenseType, string extensionsTimeBudget, ComputeScheduleScheduledEventsProfile scheduledEventsProfile, string userData, CapacityReservationProfile capacityReservation, ApplicationProfile applicationProfile, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
        ...
        public ComputeScheduleVirtualMachineStorageProfile StorageProfile { get; set; }
        ...
        public ComputeScheduleVirtualMachineOSProfile OsProfile { get; set; }

        /// <summary> Specifies the network interfaces of the virtual machine. </summary>
        public ComputeScheduleVirtualMachineNetworkProfile NetworkProfile { get; set; }

        /// <summary> Specifies the hardware profile for the virtual machine. </summary>
        public ComputeScheduleVirtualMachineHardwareProfile HardwareProfile { get; set; }
        ...
        /// <summary> Specifies the gallery applications that should be made available to the VM. </summary>
        public IList<ComputeScheduleVmGalleryApplication> GalleryApplications
        {
            get
            {
