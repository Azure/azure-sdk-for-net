...
namespace Azure.ResourceManager.ComputeSchedule.Models
{
    ...
    public partial class ComputeScheduleDiskEncryptionSettings
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="ComputeScheduleDiskEncryptionSettings"/>. </summary>
        ...
        internal ComputeScheduleDiskEncryptionSettings(ComputeScheduleKeyVaultSecretReference diskEncryptionKey, ComputeScheduleKeyVaultKeyReference keyEncryptionKey, bool? enabled, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
        ...
        public ComputeScheduleKeyVaultSecretReference DiskEncryptionKey { get; set; }

        /// <summary> Specifies the location of the key encryption key in Key Vault. </summary>
        public ComputeScheduleKeyVaultKeyReference KeyEncryptionKey { get; set; }
