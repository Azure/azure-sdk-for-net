...
namespace Azure.ResourceManager.ComputeSchedule.Models
{
    ...
    public partial class ComputeScheduleWinRMListener
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="ComputeScheduleWinRMListener"/>. </summary>
        public ComputeScheduleWinRMListener()
        {
        }
        ...
        internal ComputeScheduleWinRMListener(ComputeScheduleWinRMListenerProtocolType? protocol, Uri certificateUri, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Protocol = protocol;
        ...
        public ComputeScheduleWinRMListenerProtocolType? Protocol { get; set; }
