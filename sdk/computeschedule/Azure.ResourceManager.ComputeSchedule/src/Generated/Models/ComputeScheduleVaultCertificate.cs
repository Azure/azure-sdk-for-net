...
namespace Azure.ResourceManager.ComputeSchedule.Models
{
    ...
    public partial class ComputeScheduleVaultCertificate
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="ComputeScheduleVaultCertificate"/>. </summary>
        ...
        internal ComputeScheduleVaultCertificate(Uri certificateUri, string certificateStore, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
