...
namespace Azure.ResourceManager.ComputeSchedule.Models
{
    ...
    public partial class VirtualMachineNetworkInterfaceIPConfigurationProperties
    {
        ...
        internal VirtualMachineNetworkInterfaceIPConfigurationProperties(WritableSubResource subnet, bool? isPrimary, VirtualMachinePublicIPAddressConfiguration publicIPAddressConfiguration, IPVersion? privateIPAddressVersion, IList<WritableSubResource> applicationSecurityGroups, IList<WritableSubResource> applicationGatewayBackendAddressPools, IList<WritableSubResource> loadBalancerBackendAddressPools, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Subnet = subnet;
            IsPrimary = isPrimary;
