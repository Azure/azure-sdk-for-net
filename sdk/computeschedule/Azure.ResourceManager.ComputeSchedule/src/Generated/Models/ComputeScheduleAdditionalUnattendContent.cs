...
namespace Azure.ResourceManager.ComputeSchedule.Models
{
    ...
    public partial class ComputeScheduleAdditionalUnattendContent
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="ComputeScheduleAdditionalUnattendContent"/>. </summary>
        ...
        internal ComputeScheduleAdditionalUnattendContent(ComputeScheduleAdditionalUnattendContentPassName? passName, ComputeScheduleAdditionalUnattendContentComponentName? componentName, ComputeScheduleSettingName? settingName, string content, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            PassName = passName;
        ...
        public ComputeScheduleAdditionalUnattendContentPassName? PassName { get; set; }

        /// <summary> The component name. Currently, the only allowable value is Microsoft-Windows-Shell-Setup. </summary>
        public ComputeScheduleAdditionalUnattendContentComponentName? ComponentName { get; set; }
