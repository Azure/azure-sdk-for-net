...
namespace Azure.ResourceManager.ComputeSchedule.Models
{
    ...
    public partial class ComputeScheduleBootDiagnostics
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="ComputeScheduleBootDiagnostics"/>. </summary>
        ...
        internal ComputeScheduleBootDiagnostics(bool? enabled, Uri storageUri, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Enabled = enabled;
