...
namespace Azure.ResourceManager.ComputeSchedule.Models
{
    ...
    public partial class ComputeScheduleAdditionalCapabilities
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="ComputeScheduleAdditionalCapabilities"/>. </summary>
        public ComputeScheduleAdditionalCapabilities()
        {
        }
        ...
        internal ComputeScheduleAdditionalCapabilities(bool? isUltraSsdEnabled, bool? isHibernationEnabled, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
