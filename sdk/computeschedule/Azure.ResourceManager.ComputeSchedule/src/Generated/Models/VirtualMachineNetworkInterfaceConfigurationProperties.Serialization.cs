        ...
        internal static VirtualMachineNetworkInterfaceConfigurationProperties DeserializeVirtualMachineNetworkInterfaceConfigurationProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("networkSecurityGroup"u8))
                {
                    ...
                    networkSecurityGroup = ModelReaderWriter.Read<WritableSubResource>(new BinaryData(Encoding.UTF8.GetBytes(prop.Value.GetRawText())), ModelSerializationExtensions.WireOptions, AzureResourceManagerComputeScheduleContext.Default);
                    continue;
                }
                ...
                if (prop.NameEquals("dscpConfiguration"u8))
                {
                    ...
                    dscpConfiguration = ModelReaderWriter.Read<WritableSubResource>(new BinaryData(Encoding.UTF8.GetBytes(prop.Value.GetRawText())), ModelSerializationExtensions.WireOptions, AzureResourceManagerComputeScheduleContext.Default);
                    continue;
                }
