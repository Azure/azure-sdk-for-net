...
namespace Azure.ResourceManager.ComputeSchedule.Models
{
    ...
    public partial class ComputeScheduleVirtualMachineHardwareProfile
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="ComputeScheduleVirtualMachineHardwareProfile"/>. </summary>
        public ComputeScheduleVirtualMachineHardwareProfile()
        {
        }
        ...
        internal ComputeScheduleVirtualMachineHardwareProfile(string vmSize, ComputeScheduleVirtualMachineSizeProperties vmSizeProperties, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            VmSize = vmSize;
        ...
        public ComputeScheduleVirtualMachineSizeProperties VmSizeProperties { get; set; }
    }
}
