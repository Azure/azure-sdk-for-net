...
namespace Azure.ResourceManager.ComputeSchedule.Models
{
    ...
    public partial class ComputeScheduleSshPublicKeyConfiguration
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="ComputeScheduleSshPublicKeyConfiguration"/>. </summary>
        public ComputeScheduleSshPublicKeyConfiguration()
        {
        }
        ...
        internal ComputeScheduleSshPublicKeyConfiguration(string path, string keyData, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Path = path;
            KeyData = keyData;
