...
namespace Azure.ResourceManager.ComputeSchedule.Models
{
    ...
    public partial class ResourceStatus
    {
        ...
        internal ResourceStatus(ResourceIdentifier resourceId, ResourceOperationStatus status, ResponseError error, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ResourceId = resourceId;
            Status = status;
            Error = error;
