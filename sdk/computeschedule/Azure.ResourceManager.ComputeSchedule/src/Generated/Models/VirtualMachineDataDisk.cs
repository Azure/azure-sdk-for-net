...
namespace Azure.ResourceManager.ComputeSchedule.Models
{
    ...
    public partial class VirtualMachineDataDisk
    {
        ...
        internal VirtualMachineDataDisk(int lun, string name, VirtualHardDisk vhd, VirtualHardDisk image, CachingType? caching, bool? isWriteAcceleratorEnabled, DiskCreateOptionType createOption, int? diskSizeGB, ComputeScheduleManagedDiskConfig managedDisk, ApiEntityReference sourceResource, bool? isToBeDetached, DiskDetachOptionType? detachOption, DiskDeleteOptionType? deleteOption, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Lun = lun;
            Name = name;
            Vhd = vhd;
