...
namespace Azure.ResourceManager.ComputeSchedule.Models
{
    ...
    public partial class DataDisk
    {
        ...
        internal DataDisk(int lun, string name, VirtualHardDisk vhd, VirtualHardDisk image, CachingTypes? caching, bool? writeAcceleratorEnabled, DiskCreateOptionTypes createOption, int? diskSizeGB, ComputeScheduleManagedDiskConfig managedDisk, ApiEntityReference sourceResource, bool? toBeDetached, DiskDetachOptionTypes? detachOption, DiskDeleteOptionTypes? deleteOption, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Lun = lun;
            Name = name;
            Vhd = vhd;
