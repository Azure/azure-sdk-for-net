...
namespace Azure.ResourceManager.ComputeSchedule.Models
{
    ...
    public partial class ComputeScheduleImageReference : ComputeScheduleSubResourceInfo
    {
        /// <summary> Initializes a new instance of <see cref="ComputeScheduleImageReference"/>. </summary>
        public ComputeScheduleImageReference()
        {
        }
        ...
        internal ComputeScheduleImageReference(ResourceIdentifier id, IDictionary<string, BinaryData> additionalBinaryDataProperties, string publisher, string offer, string sku, string version, string sharedGalleryImageUniqueId, string communityGalleryImageId) : base(id, additionalBinaryDataProperties)
        {
            Publisher = publisher;
            Offer = offer;
            Sku = sku;
