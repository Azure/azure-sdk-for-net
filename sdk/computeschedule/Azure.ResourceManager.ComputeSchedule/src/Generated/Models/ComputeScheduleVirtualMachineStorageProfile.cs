...
namespace Azure.ResourceManager.ComputeSchedule.Models
{
    ...
    public partial class ComputeScheduleVirtualMachineStorageProfile
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="ComputeScheduleVirtualMachineStorageProfile"/>. </summary>
        public ComputeScheduleVirtualMachineStorageProfile()
        {
        ...
        internal ComputeScheduleVirtualMachineStorageProfile(ComputeScheduleImageReference imageReference, ComputeScheduleVirtualMachineOSDisk osDisk, IList<ComputeScheduleVirtualMachineDataDisk> dataDisks, ComputeScheduleDiskControllerType? diskControllerType, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
        ...
        public ComputeScheduleImageReference ImageReference { get; set; }
        ...
        public ComputeScheduleVirtualMachineOSDisk OSDisk { get; set; }
        ...
        public IList<ComputeScheduleVirtualMachineDataDisk> DataDisks { get; }

        /// <summary> Specifies the disk controller type configured for the VM. <b>Note:</b> This property will be set to the default disk controller type if not specified provided virtual machine is being created with 'hyperVGeneration' set to V2 based on the capabilities of the operating system disk and VM size from the the specified minimum api version. You need to deallocate the VM before updating its disk controller type unless you are updating the VM size in the VM configuration which implicitly deallocates and reallocates the VM. Minimum api-version: 2022-08-01. </summary>
        public ComputeScheduleDiskControllerType? DiskControllerType { get; set; }
    }
}
