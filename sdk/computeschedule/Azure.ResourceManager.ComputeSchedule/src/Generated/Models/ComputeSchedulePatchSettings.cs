...
namespace Azure.ResourceManager.ComputeSchedule.Models
{
    ...
    public partial class ComputeSchedulePatchSettings
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="ComputeSchedulePatchSettings"/>. </summary>
        ...
        internal ComputeSchedulePatchSettings(ComputeScheduleWindowsVmGuestPatchMode? patchMode, bool? enableHotpatching, ComputeScheduleWindowsPatchAssessmentMode? assessmentMode, ComputeScheduleWindowsVmGuestPatchAutomaticByPlatformSettings automaticByPlatformSettings, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            PatchMode = patchMode;
        ...
        public ComputeScheduleWindowsVmGuestPatchMode? PatchMode { get; set; }
        ...
        public ComputeScheduleWindowsPatchAssessmentMode? AssessmentMode { get; set; }

        /// <summary> Specifies additional settings for patch mode AutomaticByPlatform in VM Guest Patching on Windows. </summary>
        public ComputeScheduleWindowsVmGuestPatchAutomaticByPlatformSettings AutomaticByPlatformSettings { get; set; }
    }
}
