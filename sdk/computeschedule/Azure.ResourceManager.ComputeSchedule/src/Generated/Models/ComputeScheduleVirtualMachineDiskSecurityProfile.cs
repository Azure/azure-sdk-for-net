...
namespace Azure.ResourceManager.ComputeSchedule.Models
{
    ...
    public partial class ComputeScheduleVirtualMachineDiskSecurityProfile
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="ComputeScheduleVirtualMachineDiskSecurityProfile"/>. </summary>
        public ComputeScheduleVirtualMachineDiskSecurityProfile()
        {
        }
        ...
        internal ComputeScheduleVirtualMachineDiskSecurityProfile(ComputeScheduleSecurityEncryptionType? securityEncryptionType, ComputeScheduleDiskEncryptionSetConfig diskEncryptionSet, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
