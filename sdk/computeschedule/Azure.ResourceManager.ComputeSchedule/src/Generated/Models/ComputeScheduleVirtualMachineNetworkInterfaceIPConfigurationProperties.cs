...
namespace Azure.ResourceManager.ComputeSchedule.Models
{
    ...
    public partial class ComputeScheduleVirtualMachineNetworkInterfaceIPConfigurationProperties
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="ComputeScheduleVirtualMachineNetworkInterfaceIPConfigurationProperties"/>. </summary>
        public ComputeScheduleVirtualMachineNetworkInterfaceIPConfigurationProperties()
        {
        ...
        internal ComputeScheduleVirtualMachineNetworkInterfaceIPConfigurationProperties(ComputeScheduleSubResourceInfo subnet, bool? isPrimary, ComputeScheduleVirtualMachinePublicIPAddressConfiguration publicIPAddressConfiguration, ComputeScheduleIPVersion? privateIPAddressVersion, IList<ComputeScheduleSubResourceInfo> applicationSecurityGroups, IList<ComputeScheduleSubResourceInfo> applicationGatewayBackendAddressPools, IList<ComputeScheduleSubResourceInfo> loadBalancerBackendAddressPools, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Subnet = subnet;
            IsPrimary = isPrimary;
        ...
        internal ComputeScheduleSubResourceInfo Subnet { get; set; }
        ...
        public ComputeScheduleVirtualMachinePublicIPAddressConfiguration PublicIPAddressConfiguration { get; set; }
        ...
        public ComputeScheduleIPVersion? PrivateIPAddressVersion { get; set; }

        /// <summary> Specifies an array of references to application security group. </summary>
        public IList<ComputeScheduleSubResourceInfo> ApplicationSecurityGroups { get; }
        ...
        public IList<ComputeScheduleSubResourceInfo> ApplicationGatewayBackendAddressPools { get; }
        ...
        public IList<ComputeScheduleSubResourceInfo> LoadBalancerBackendAddressPools { get; }
        ...
        public ResourceIdentifier SubnetId
        {
            ...
            set
            {
                if (Subnet is null)
                {
                    Subnet = new ComputeScheduleSubResourceInfo();
                }
                Subnet.Id = value;
            }
        }
