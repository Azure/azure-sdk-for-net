...
namespace Azure.ResourceManager.ComputeSchedule.Models
{
    ...
    public partial class ComputeScheduleVmGalleryApplication
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="ComputeScheduleVmGalleryApplication"/>. </summary>
        ...
        public ComputeScheduleVmGalleryApplication(string packageReferenceId)
        {
        ...
        internal ComputeScheduleVmGalleryApplication(string tags, int? order, string packageReferenceId, string configurationReference, bool? isTreatFailureAsDeploymentFailure, bool? enableAutomaticUpgrade, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Tags = tags;
            Order = order;
            PackageReferenceId = packageReferenceId;
