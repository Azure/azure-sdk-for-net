...
namespace Azure.ResourceManager.ComputeSchedule.Models
{
    ...
    public partial class ComputeScheduleEventGridAndResourceGraph
    {
        ...
        /// <summary> Initializes a new instance of <see cref="ComputeScheduleEventGridAndResourceGraph"/>. </summary>
        public ComputeScheduleEventGridAndResourceGraph()
        {
        }
        ...
        internal ComputeScheduleEventGridAndResourceGraph(bool? enable, string scheduledEventsApiVersion, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Enable = enable;
