...
namespace Azure.ResourceManager.ComputeSchedule.Models
{
    ...
    public partial class ComputeScheduleResourceResultSummary
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="ComputeScheduleResourceResultSummary"/>. </summary>
        ...
        internal ComputeScheduleResourceResultSummary(string code, int count)
        {
            Code = code;
            Count = count;
        }
        ...
        internal ComputeScheduleResourceResultSummary(string code, int count, ResponseError errorDetails, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Code = code;
            Count = count;
