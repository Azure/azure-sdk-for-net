...
namespace Azure.ResourceManager.ComputeSchedule.Models
{
    ...
    public partial class ComputeScheduleVirtualMachineNetworkInterfaceReferenceProperties
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="ComputeScheduleVirtualMachineNetworkInterfaceReferenceProperties"/>. </summary>
        public ComputeScheduleVirtualMachineNetworkInterfaceReferenceProperties()
        {
        }
        ...
        internal ComputeScheduleVirtualMachineNetworkInterfaceReferenceProperties(bool? isPrimary, ComputeScheduleDeleteConfig? deleteOption, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            IsPrimary = isPrimary;
