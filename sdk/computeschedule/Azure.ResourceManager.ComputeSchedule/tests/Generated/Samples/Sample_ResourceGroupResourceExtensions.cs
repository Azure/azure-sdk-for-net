...
["key2102"] = "obwsqwdydpkscnzceopxgkrhrxtdhv"
        ...
        public async Task UpdateScheduledAction_ScheduledActionsUpdateMaximumSet()
        {
            ...
            {
                Properties = new ScheduledActionProperties(Models.ResourceType.VirtualMachine, ScheduledActionType.Start, DateTimeOffset.Parse("2025-04-17T00:23:58.149Z"), new ScheduledActionsSchedule(XmlConvert.ToTimeSpan("19:00:00"), "bni", new WeekDay[] { WeekDay.Monday }, new Month[] { Month.January }, new int[] { 15 })
                {
                    ExecutionParameters = new ScheduledActionExecutionParameterDetail
                    {
                        OptimizationPreference = ScheduledActionOptimizationPreference.Cost,
