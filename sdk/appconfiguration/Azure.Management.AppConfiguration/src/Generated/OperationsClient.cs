...
namespace Azure.Management.AppConfiguration
{
    ...
    public partial class OperationsClient
    {
        ...
        internal OperationsClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null, string apiVersion = "2019-11-01-preview")
        {
            RestClient = new OperationsRestClient(clientDiagnostics, pipeline, subscriptionId, endpoint, apiVersion);
