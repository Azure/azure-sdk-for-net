...
namespace Azure.Management.AppConfiguration
{
    ...
    public partial class ConfigurationStoresCreateOperation : Operation<ConfigurationStore>, IOperationSource<ConfigurationStore>
    {
        ...
        /// <inheritdoc />
        public override ConfigurationStore Value => _operation.Value;
        ...
        /// <inheritdoc />
        public override ValueTask<Response<ConfigurationStore>> WaitForCompletionAsync(CancellationToken cancellationToken = default) => _operation.WaitForCompletionAsync(cancellationToken);

        /// <inheritdoc />
        public override ValueTask<Response<ConfigurationStore>> WaitForCompletionAsync(TimeSpan pollingInterval, CancellationToken cancellationToken = default) => _operation.WaitForCompletionAsync(pollingInterval, cancellationToken);
