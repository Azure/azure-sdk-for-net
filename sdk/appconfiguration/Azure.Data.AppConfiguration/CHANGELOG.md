...
## 1.3.0-beta.2 (2022-07-10)

### Features Added
- Added configuration settings snapshot feature which allow developers to create a point-in-time snapshot of their configuration store.
