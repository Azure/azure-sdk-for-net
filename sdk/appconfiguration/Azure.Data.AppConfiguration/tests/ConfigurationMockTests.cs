...
namespace Azure.Data.AppConfiguration.Tests
{
    ...
    public class ConfigurationMockTests : ClientTestBase
    {
        ...
        public async Task GetBatch()
        {
            ...
            var escapedWildcard = Uri.EscapeDataString("*");
            Assert.AreEqual($"https://contoso.appconfig.io/kv/?key={escapedWildcard}&label={escapedWildcard}&api-version={s_version}", request1.Uri.ToString());
            ...
            Assert.AreEqual($"https://contoso.appconfig.io/kv/?key={escapedWildcard}&label={escapedWildcard}&after=5&api-version={s_version}", request2.Uri.ToString());
            AssertRequestCommon(request1);
        }
