...
namespace Azure.Data.AppConfiguration.Tests
{
    ...
    public class ConfigurationMockTests : ClientTestBase
    {
        ...
        public async Task GetBatch()
        {
            ...
            Assert.AreEqual($"https://contoso.appconfig.io/kv/?key=%2A&api-version={s_version}", request1.Uri.ToString());
            ...
            Assert.AreEqual($"https://contoso.appconfig.io/kv/?key=%2A&after=5&api-version={s_version}", request2.Uri.ToString());
            AssertRequestCommon(request1);
        }
