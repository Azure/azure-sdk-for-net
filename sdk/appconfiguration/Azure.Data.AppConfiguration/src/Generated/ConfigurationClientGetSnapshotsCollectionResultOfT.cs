...
{
    internal partial class ConfigurationClientGetSnapshotsCollectionResultOfT : Pageable<Snapshot>
    {
        ...
        /// <summary> Initializes a new instance of ConfigurationClientGetSnapshotsCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public ConfigurationClientGetSnapshotsCollectionResultOfT(ConfigurationClient client, Uri nextPage, string accept, string name, string after, IEnumerable<SnapshotFields> @select, IEnumerable<ConfigurationSnapshotStatus> status, string syncToken, RequestContext context) : base(context?.CancellationToken ?? default)
        {
        ...
        /// <summary> Gets the pages of ConfigurationClientGetSnapshotsCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of ConfigurationClientGetSnapshotsCollectionResultOfT as an enumerable collection. </returns>
