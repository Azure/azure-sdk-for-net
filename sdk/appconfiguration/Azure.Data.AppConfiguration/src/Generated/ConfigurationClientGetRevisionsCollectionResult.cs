...
namespace Azure.Data.AppConfiguration
{
    internal partial class ConfigurationClientGetRevisionsCollectionResult : Pageable<BinaryData>
    {
        ...
        public ConfigurationClientGetRevisionsCollectionResult(ConfigurationClient client, Uri nextPage, string accept, string key, string label, string syncToken, string after, string acceptDatetime, IEnumerable<KeyValueFields> @select, IEnumerable<string> tags, RequestContext context) : base(context?.CancellationToken ?? default)
        {
