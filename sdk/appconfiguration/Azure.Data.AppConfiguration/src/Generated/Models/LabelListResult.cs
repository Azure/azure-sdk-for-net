...
namespace Azure.Data.AppConfiguration
{
    ...
    internal partial class LabelListResult
    {
        ...
        {
            Items = new ChangeTrackingList<SettingLabel>();
        }
        ...
        internal LabelListResult(IList<SettingLabel> items, string nextLink, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Items = items;
            NextLink = nextLink;
        ...
        public IList<SettingLabel> Items { get; }
