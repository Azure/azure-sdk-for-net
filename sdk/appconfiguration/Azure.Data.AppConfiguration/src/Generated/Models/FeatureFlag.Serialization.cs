...
namespace Azure.Data.AppConfiguration
{
    ...
    public partial class FeatureFlag : IJsonModel<FeatureFlag>
    {
        ...
        public static implicit operator RequestContent(FeatureFlag featureFlag)
        {
            ...
            return RequestContent.Create(featureFlag, ModelSerializationExtensions.WireOptions);
        }

        /// <param name="response"> The <see cref="Response"/> to deserialize the <see cref="FeatureFlag"/> from. </param>
        public static explicit operator FeatureFlag(Response response)
        {
