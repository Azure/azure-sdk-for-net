...
namespace Azure.Data.AppConfiguration
{
    internal partial class ConfigurationClientGetLabelsAsyncCollectionResult : AsyncPageable<BinaryData>
    {
        ...
        public ConfigurationClientGetLabelsAsyncCollectionResult(ConfigurationClient client, Uri nextPage, string accept, string name, string syncToken, string after, string acceptDatetime, IEnumerable<LabelFields> @select, RequestContext context) : base(context?.CancellationToken ?? default)
        {
