...
{
    internal partial class ConfigurationClientGetFeatureFlagsAsyncCollectionResult : AsyncPageable<BinaryData>
    {
        ...
        /// <summary> Initializes a new instance of ConfigurationClientGetFeatureFlagsAsyncCollectionResult, which is used to iterate over the pages of a collection. </summary>
        ...
        public ConfigurationClientGetFeatureFlagsAsyncCollectionResult(ConfigurationClient client, string name, string label, string syncToken, string after, string acceptDatetime, IEnumerable<string> @select, MatchConditions matchConditions, IEnumerable<string> tags, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _name = name;
            _label = label;
        ...
        /// <summary> Gets the pages of ConfigurationClientGetFeatureFlagsAsyncCollectionResult as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of ConfigurationClientGetFeatureFlagsAsyncCollectionResult as an enumerable collection. </returns>
