...
namespace Azure.Data.AppConfiguration
{
    internal partial class ConfigurationClientGetConfigurationSettingsCollectionResult : Pageable<BinaryData>
    {
        ...
        public ConfigurationClientGetConfigurationSettingsCollectionResult(ConfigurationClient client, string key, string label, string syncToken, string after, string acceptDatetime, IEnumerable<string> @select, string snapshot, MatchConditions matchConditions, IEnumerable<string> tags, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _key = key;
            _label = label;
