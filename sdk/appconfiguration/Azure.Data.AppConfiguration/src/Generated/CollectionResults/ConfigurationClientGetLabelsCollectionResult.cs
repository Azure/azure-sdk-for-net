...
namespace Azure.Data.AppConfiguration
{
    internal partial class ConfigurationClientGetLabelsCollectionResult : Pageable<BinaryData>
    {
        ...
        public ConfigurationClientGetLabelsCollectionResult(ConfigurationClient client, string name, string syncToken, string after, string acceptDatetime, IEnumerable<SettingLabelFields> @select, string resourceType, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _name = name;
