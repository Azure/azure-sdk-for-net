...
namespace Azure.Data.AppConfiguration
{
    ...
    public partial class AzureAppConfigurationClient
    {
        ...
        {
            return CheckKeys(name, after, syncToken, acceptDatetime, cancellationToken.ToRequestContext());
        }
        ...
        {
            return await CheckKeysAsync(name, after, syncToken, acceptDatetime, cancellationToken.ToRequestContext()).ConfigureAwait(false);
        }
        ...
        {
            return CheckSnapshots(syncToken, after, cancellationToken.ToRequestContext());
        }
        ...
        {
            return await CheckSnapshotsAsync(syncToken, after, cancellationToken.ToRequestContext()).ConfigureAwait(false);
        }
        ...
        public virtual Response<OperationDetails> GetOperationDetails(string snapshot, CancellationToken cancellationToken = default)
        {
            ...
            Response result = GetOperationDetails(snapshot, cancellationToken.ToRequestContext());
        ...
        public virtual async Task<Response<OperationDetails>> GetOperationDetailsAsync(string snapshot, CancellationToken cancellationToken = default)
        {
            ...
            Response result = await GetOperationDetailsAsync(snapshot, cancellationToken.ToRequestContext()).ConfigureAwait(false);
            return Response.FromValue((OperationDetails)result, result);
        }
        ...
        {
            return CheckLabels(name, syncToken, after, acceptDatetime, @select, cancellationToken.ToRequestContext());
        }
        ...
        {
            return await CheckLabelsAsync(name, syncToken, after, acceptDatetime, @select, cancellationToken.ToRequestContext()).ConfigureAwait(false);
        }
        ...
        {
            return CheckRevisions(key, label, syncToken, after, acceptDatetime, @select, tags, cancellationToken.ToRequestContext());
        }
        ...
        {
            return await CheckRevisionsAsync(key, label, syncToken, after, acceptDatetime, @select, tags, cancellationToken.ToRequestContext()).ConfigureAwait(false);
        }
    }
}
