...
{
    internal partial class FeatureManagementGetFeatureFlagsCollectionResultOfT : Pageable<FeatureFlag>
    {
        ...
        /// <summary> Initializes a new instance of FeatureManagementGetFeatureFlagsCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public FeatureManagementGetFeatureFlagsCollectionResultOfT(FeatureManagement client, string name, string label, string syncToken, string after, string acceptDatetime, IEnumerable<FeatureFlagFields> @select, MatchConditions matchConditions, IEnumerable<string> tags, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _name = name;
            _label = label;
        ...
        /// <summary> Gets the pages of FeatureManagementGetFeatureFlagsCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of FeatureManagementGetFeatureFlagsCollectionResultOfT as an enumerable collection. </returns>
