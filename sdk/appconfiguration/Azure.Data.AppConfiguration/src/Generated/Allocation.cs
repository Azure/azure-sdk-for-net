...
namespace Azure.Data.AppConfiguration
{
    ...
    public partial class Allocation
    {
        ...
        /// <summary> Initializes a new instance of <see cref="Allocation"/>. </summary>
        public Allocation()
        {
        ...
        internal Allocation(string defaultWhenDisabled, string defaultWhenEnabled, IList<PercentileAllocation> percentile, IList<UserAllocation> user, IList<GroupAllocation> @group, string seed, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
