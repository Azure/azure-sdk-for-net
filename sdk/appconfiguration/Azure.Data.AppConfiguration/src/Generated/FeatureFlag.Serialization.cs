...
namespace Azure.Data.AppConfiguration
{
    ...
    public partial class FeatureFlag : IJsonModel<FeatureFlag>
    {
        ...
        internal static FeatureFlag DeserializeFeatureFlag(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            IList<Variant> variants = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("conditions"u8))
                {
                    ...
                    conditions = Conditions.DeserializeConditions(prop.Value, options);
                    continue;
                }
                if (prop.NameEquals("variants"u8))
                {
                    ...
                    {
                        array.Add(Variant.DeserializeVariant(item, options));
                    }
                    variants = array;
                    continue;
                }
                if (prop.NameEquals("allocation"u8))
                {
                    ...
                    allocation = Allocation.DeserializeAllocation(prop.Value, options);
                    continue;
                }
                if (prop.NameEquals("telemetry"u8))
                {
                    ...
                    telemetry = Telemetry.DeserializeTelemetry(prop.Value, options);
                    continue;
                }
