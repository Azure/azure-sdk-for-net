...
{
    internal partial class FeatureManagementGetFeatureFlagRevisionsCollectionResult : Pageable<BinaryData>
    {
        ...
        /// <summary> Initializes a new instance of FeatureManagementGetFeatureFlagRevisionsCollectionResult, which is used to iterate over the pages of a collection. </summary>
        ...
        public FeatureManagementGetFeatureFlagRevisionsCollectionResult(FeatureManagement client, string name, string label, string after, IEnumerable<FeatureFlagFields> @select, IEnumerable<string> tags, string syncToken, MatchConditions matchConditions, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _name = name;
            _label = label;
        ...
        /// <summary> Gets the pages of FeatureManagementGetFeatureFlagRevisionsCollectionResult as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of FeatureManagementGetFeatureFlagRevisionsCollectionResult as an enumerable collection. </returns>
