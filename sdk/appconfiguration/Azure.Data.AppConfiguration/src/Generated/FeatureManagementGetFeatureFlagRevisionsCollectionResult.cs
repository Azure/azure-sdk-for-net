...
namespace Azure.Data.AppConfiguration
{
    internal partial class FeatureManagementGetFeatureFlagRevisionsCollectionResult : Pageable<BinaryData>
    {
        ...
        public FeatureManagementGetFeatureFlagRevisionsCollectionResult(FeatureManagement client, string name, string label, string after, IEnumerable<SettingFields> @select, IEnumerable<string> tags, string syncToken, MatchConditions matchConditions, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _name = name;
            _label = label;
