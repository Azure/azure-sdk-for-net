...
namespace Azure.Data.AppConfiguration
{
    public partial class KeyValueFilter : IUtf8JsonSerializable, IJsonModel<KeyValueFilter>
    {
        ...
        internal static KeyValueFilter DeserializeKeyValueFilter(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new KeyValueFilter(key, label, tags ?? new ChangeTrackingList<string>(), serializedAdditionalRawData);
        }
        ...
        internal static KeyValueFilter FromResponse(Response response)
        {
            using var document = JsonDocument.Parse(response.Content);
            return DeserializeKeyValueFilter(document.RootElement);
        }
