...
namespace Azure.Data.AppConfiguration
{
    internal partial class ConfigurationClientGetSnapshotsCollectionResult : Pageable<BinaryData>
    {
        ...
        public ConfigurationClientGetSnapshotsCollectionResult(ConfigurationClient client, Uri nextPage, string accept, string name, string after, IEnumerable<SnapshotFields> @select, IEnumerable<ConfigurationSnapshotStatus> status, string syncToken, RequestContext context) : base(context?.CancellationToken ?? default)
        {
