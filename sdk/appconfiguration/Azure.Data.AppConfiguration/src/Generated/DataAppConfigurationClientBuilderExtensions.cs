...
namespace Microsoft.Extensions.Azure
{
    ...
    public static partial class DataAppConfigurationClientBuilderExtensions
    {
        ...
        public static IAzureClientBuilder<ConfigurationClient, ConfigurationClientOptions> AddConfigurationClient<TBuilder>(this TBuilder builder, Uri endpoint, string syncToken)
        where TBuilder : IAzureClientFactoryBuilder
        {
            return builder.RegisterClientFactory<ConfigurationClient, ConfigurationClientOptions>((options) => new ConfigurationClient(endpoint, syncToken, options));
        }
