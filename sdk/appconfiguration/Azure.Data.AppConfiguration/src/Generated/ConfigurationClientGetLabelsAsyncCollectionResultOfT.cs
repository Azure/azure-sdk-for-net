...
{
    internal partial class ConfigurationClientGetLabelsAsyncCollectionResultOfT : AsyncPageable<Label>
    {
        ...
        public ConfigurationClientGetLabelsAsyncCollectionResultOfT(ConfigurationClient client, Uri nextPage, string accept, string name, string syncToken, string after, string acceptDatetime, IEnumerable<LabelFields> @select, RequestContext context) : base(context?.CancellationToken ?? default)
        {
        ...
        public override async IAsyncEnumerable<Page<Label>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            do
            {
                ...
                yield return Page<Label>.FromValues((IReadOnlyList<Label>)responseWithType.Items, nextPage?.AbsoluteUri, response);
            }
            while (nextPage != null);
        }
