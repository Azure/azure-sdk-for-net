...
{
    internal partial class ConfigurationClientGetRevisionsCollectionResultOfT : Pageable<KeyValue>
    {
        ...
        /// <summary> Initializes a new instance of ConfigurationClientGetRevisionsCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public ConfigurationClientGetRevisionsCollectionResultOfT(ConfigurationClient client, Uri nextPage, string accept, string key, string label, string syncToken, string after, string acceptDatetime, IEnumerable<KeyValueFields> @select, IEnumerable<string> tags, RequestContext context) : base(context?.CancellationToken ?? default)
        {
        ...
        /// <summary> Gets the pages of ConfigurationClientGetRevisionsCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of ConfigurationClientGetRevisionsCollectionResultOfT as an enumerable collection. </returns>
        public override IEnumerable<Page<KeyValue>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            do
            {
                ...
                yield return Page<KeyValue>.FromValues((IReadOnlyList<KeyValue>)responseWithType.Items, nextPage?.AbsoluteUri, response);
            }
            while (nextPage != null);
        }
