...
namespace Azure.Data.AppConfiguration
{
    ...
    public static partial class ConfigurationModelFactory
    {
        ...
        {
            return ConfigurationSnapshot(name: name, status: status, filters: filters, snapshotComposition: snapshotComposition, createdOn: createdOn, expiresOn: expiresOn, retentionPeriod: retentionPeriod, sizeInBytes: sizeInBytes, itemCount: itemCount, tags: tags, description: default, eTag: eTag);
        }
    }
}
