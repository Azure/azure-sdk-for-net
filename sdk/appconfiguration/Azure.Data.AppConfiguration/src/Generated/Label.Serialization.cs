...
namespace Azure.Data.AppConfiguration
{
    ...
    public partial class Label : IJsonModel<Label>
    {
        ...
        internal static Label DeserializeLabel(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new Label(name, additionalBinaryDataProperties);
        }
        ...
        /// <param name="label"> The <see cref="Label"/> to serialize into <see cref="RequestContent"/>. </param>
        public static implicit operator RequestContent(Label label)
        {
            if (label == null)
            {
                return null;
            ...
            content.JsonWriter.WriteObjectValue(label, ModelSerializationExtensions.WireOptions);
            return content;
        }

        /// <param name="result"> The <see cref="Response"/> to deserialize the <see cref="Label"/> from. </param>
        public static explicit operator Label(Response result)
        {
