...
{
    internal partial class ConfigurationClientGetRevisionsAsyncCollectionResultOfT : AsyncPageable<KeyValue>
    {
        ...
        /// <summary> Initializes a new instance of ConfigurationClientGetRevisionsAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public ConfigurationClientGetRevisionsAsyncCollectionResultOfT(ConfigurationClient client, Uri nextPage, string accept, string key, string label, string syncToken, string after, string acceptDatetime, IEnumerable<KeyValueFields> @select, IEnumerable<string> tags, RequestContext context) : base(context?.CancellationToken ?? default)
        {
        ...
        /// <summary> Gets the pages of ConfigurationClientGetRevisionsAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of ConfigurationClientGetRevisionsAsyncCollectionResultOfT as an enumerable collection. </returns>
