...
namespace Azure.Data.AppConfiguration
{
    public partial class ConfigurationSnapshot : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            if (SnapshotComposition.HasValue)
            {
        ...
        internal static ConfigurationSnapshot DeserializeSnapshot(JsonElement element)
        {
            ...
            return new ConfigurationSnapshot(name, status, filters, snapshotComposition, created, expires, retentionPeriod, size, itemsCount, tags ?? new ChangeTrackingDictionary<string, string>(), new ETag(etag));
        }
