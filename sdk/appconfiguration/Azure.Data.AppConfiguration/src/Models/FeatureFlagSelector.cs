...
namespace Azure.Data.AppConfiguration
{
    ...
    /// each feature flag to retrieve.</para>
    ...
    public class FeatureFlagSelector
    {
        ...
        /// to <see cref="NameFilter"/> or <see cref="LabelFilter"/>.
        /// </summary>
        ...
        /// <summary>
        /// Creates a default <see cref="FeatureFlagSelector"/> that will retrieve all <see cref="FeatureFlag"/> entities in the configuration store.
        /// </summary>
        ...
        /// <summary>
        /// Check if two FeatureFlagSelector instances are equal.
        /// </summary>
        ...
        /// <summary>
        /// Get a hash code for the FeatureFlagSelector.
        /// </summary>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public override int GetHashCode() => base.GetHashCode();

        /// <summary>
        /// Creates a string in reference to the FeatureFlagSelector.
        /// </summary>
        [EditorBrowsable(EditorBrowsableState.Never)]
