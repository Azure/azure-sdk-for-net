...
namespace Azure.Provisioning.AppConfiguration
{
    ...
    internal partial class PrivateEndpointConnectionProperties : ProvisionableConstruct
    {
        ...
        protected override void DefineProvisionableProperties()
        {
            ...
            _connectionState = DefineModelProperty<AppConfigurationPrivateLinkServiceConnectionState>(nameof(ConnectionState), new string[] { "privateLinkServiceConnectionState" }, isRequired: true);
