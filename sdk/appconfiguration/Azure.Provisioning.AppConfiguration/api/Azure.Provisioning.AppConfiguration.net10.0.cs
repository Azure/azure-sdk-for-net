namespace Azure.Provisioning.AppConfiguration
{
    ...
    {
        internal AppConfigurationPrivateLinkResource() : base (default(string), default(Azure.Core.ResourceType), default(string)) { }
    ...
    {
        internal DeletedAppConfigurationStore() : base (default(string), default(Azure.Core.ResourceType), default(string)) { }
