...
namespace Azure.ResourceManager.AppConfiguration
{
    ...
    public partial class AppConfigurationKeyValueData : ResourceData
    {
        ...
        internal AppConfigurationKeyValueData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string key, string label, string value, string contentType, ETag? eTag, DateTimeOffset? lastModifiedOn, bool? isLocked, IDictionary<string, string> tags, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData)
        {
            Key = key;
            Label = label;
            Value = value;
