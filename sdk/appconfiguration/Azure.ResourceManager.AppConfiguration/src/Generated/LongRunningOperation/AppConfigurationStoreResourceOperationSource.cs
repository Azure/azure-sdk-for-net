...
{
    /// <summary></summary>
    internal partial class AppConfigurationStoreResourceOperationSource : IOperationSource<AppConfigurationStoreResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal AppConfigurationStoreResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
