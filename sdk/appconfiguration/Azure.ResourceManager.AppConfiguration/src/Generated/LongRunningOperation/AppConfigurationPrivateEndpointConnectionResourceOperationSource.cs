...
{
    /// <summary></summary>
    internal partial class AppConfigurationPrivateEndpointConnectionResourceOperationSource : IOperationSource<AppConfigurationPrivateEndpointConnectionResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal AppConfigurationPrivateEndpointConnectionResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
