...
namespace Azure.ResourceManager.AppConfiguration
{
    internal partial class AppConfigurationArmOperation<T> : ArmOperation<T>
    {
        ...
        internal AppConfigurationArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
