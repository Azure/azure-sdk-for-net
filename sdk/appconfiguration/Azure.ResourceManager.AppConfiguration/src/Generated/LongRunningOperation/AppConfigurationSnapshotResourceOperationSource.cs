...
{
    /// <summary></summary>
    internal partial class AppConfigurationSnapshotResourceOperationSource : IOperationSource<AppConfigurationSnapshotResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal AppConfigurationSnapshotResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
