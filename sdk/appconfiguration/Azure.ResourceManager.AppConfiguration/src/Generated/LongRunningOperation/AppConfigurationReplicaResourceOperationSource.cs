...
{
    /// <summary></summary>
    internal partial class AppConfigurationReplicaResourceOperationSource : IOperationSource<AppConfigurationReplicaResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal AppConfigurationReplicaResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
