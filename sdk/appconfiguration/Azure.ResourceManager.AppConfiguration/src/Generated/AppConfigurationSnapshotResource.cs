...
namespace Azure.ResourceManager.AppConfiguration
{
    ...
    public partial class AppConfigurationSnapshotResource : ArmResource
    {
        ...
        /// <summary>
        /// Update a AppConfigurationSnapshot.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AppConfiguration/configurationStores/{configStoreName}/snapshots/{snapshotName}. </description>
        ...
        public virtual async Task<ArmOperation<AppConfigurationSnapshotResource>> UpdateAsync(WaitUntil waitUntil, AppConfigurationSnapshotData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _snapshotsClientDiagnostics.CreateScope("AppConfigurationSnapshotResource.Update");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _snapshotsRestClient.CreateCreateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, AppConfigurationSnapshotData.ToRequestContent(data), context);
