...
namespace Azure.ResourceManager.AppConfiguration
{
    ...
    internal partial class PrivateLinkResourceListResult : IJsonModel<PrivateLinkResourceListResult>
    {
        ...
        /// <param name="response"> The <see cref="Response"/> to deserialize the <see cref="PrivateLinkResourceListResult"/> from. </param>
        public static explicit operator PrivateLinkResourceListResult(Response response)
        {
