...
namespace Azure.ResourceManager.AppConfiguration
{
    ...
    internal partial class ConfigurationStoreListResult : IJsonModel<ConfigurationStoreListResult>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            foreach (ConfigurationStore item in Value)
            {
        ...
        internal static ConfigurationStoreListResult DeserializeConfigurationStoreListResult(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            IList<ConfigurationStore> value = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                if (prop.NameEquals("value"u8))
                {
                    ...
                    {
                        array.Add(ConfigurationStore.DeserializeConfigurationStore(item, options));
                    }
                    value = array;
                    continue;
                }
        ...
        public static explicit operator ConfigurationStoreListResult(Response response)
        {
