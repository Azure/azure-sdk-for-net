...
namespace Azure.ResourceManager.AppConfiguration
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DeletedAppConfigurationStoreData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DeletedAppConfigurationStoreData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DeletedAppConfigurationStoreData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DeletedAppConfigurationStoreData>)} interface");
            }
        ...
        string IPersistableModel<DeletedAppConfigurationStoreData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
