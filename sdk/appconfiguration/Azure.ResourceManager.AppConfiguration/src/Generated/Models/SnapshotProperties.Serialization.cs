...
namespace Azure.ResourceManager.AppConfiguration.Models
{
    ...
    internal partial class SnapshotProperties : IJsonModel<SnapshotProperties>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            foreach (SnapshotKeyValueFilter item in Filters)
            {
        ...
        internal static SnapshotProperties DeserializeSnapshotProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("status"u8))
                {
                    ...
                    status = new AppConfigurationSnapshotStatus(prop.Value.GetString());
                    continue;
                }
                ...
                if (prop.NameEquals("compositionType"u8))
                {
                    ...
                    compositionType = new SnapshotCompositionType(prop.Value.GetString());
                    continue;
                }
