...
namespace Azure.ResourceManager.AppConfiguration.Models
{
    ...
    public partial class AppConfigurationPrivateLinkServiceConnectionState
    {
        ...
        internal AppConfigurationPrivateLinkServiceConnectionState(AppConfigurationPrivateLinkServiceConnectionStatus? status, string description, AppConfigurationActionsRequired? actionsRequired, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Status = status;
