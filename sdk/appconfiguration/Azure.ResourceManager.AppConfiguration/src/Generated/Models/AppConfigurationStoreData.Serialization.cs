...
namespace Azure.ResourceManager.AppConfiguration
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AppConfigurationStoreData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AppConfigurationStoreData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AppConfigurationStoreData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AppConfigurationStoreData>)} interface");
            }
        ...
        string IPersistableModel<AppConfigurationStoreData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
