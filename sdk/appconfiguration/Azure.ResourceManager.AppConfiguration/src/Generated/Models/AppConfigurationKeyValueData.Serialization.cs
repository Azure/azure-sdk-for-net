...
namespace Azure.ResourceManager.AppConfiguration
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AppConfigurationKeyValueData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AppConfigurationKeyValueData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AppConfigurationKeyValueData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AppConfigurationKeyValueData>)} interface");
            }
        ...
        string IPersistableModel<AppConfigurationKeyValueData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
