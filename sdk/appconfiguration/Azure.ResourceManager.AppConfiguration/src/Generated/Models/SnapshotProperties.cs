...
namespace Azure.ResourceManager.AppConfiguration
{
    ...
    public partial class SnapshotProperties
    {
        ...
        public SnapshotProperties(IEnumerable<KeyValueFilter> filters)
        {
        ...
        internal SnapshotProperties(ProvisioningState? provisioningState, SnapshotStatus? status, IList<KeyValueFilter> filters, CompositionType? compositionType, DateTimeOffset? created, DateTimeOffset? expires, long? retentionPeriod, long? size, long? itemsCount, IDictionary<string, string> tags, string etag, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
