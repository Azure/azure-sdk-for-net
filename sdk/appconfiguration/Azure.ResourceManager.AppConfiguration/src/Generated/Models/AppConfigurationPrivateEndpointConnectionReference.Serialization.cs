...
namespace Azure.ResourceManager.AppConfiguration.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AppConfigurationPrivateEndpointConnectionReference>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<AppConfigurationPrivateEndpointConnectionReference>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AppConfigurationPrivateEndpointConnectionReference>)} interface");
            }
        ...
        string IPersistableModel<AppConfigurationPrivateEndpointConnectionReference>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
