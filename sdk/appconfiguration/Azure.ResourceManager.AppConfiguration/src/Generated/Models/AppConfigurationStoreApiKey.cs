...
namespace Azure.ResourceManager.AppConfiguration.Models
{
    ...
    public partial class AppConfigurationStoreApiKey
    {
        ...
        internal AppConfigurationStoreApiKey(string id, string name, string value, string connectionString, DateTimeOffset? lastModifiedOn, bool? isReadOnly, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Name = name;
            Value = value;
