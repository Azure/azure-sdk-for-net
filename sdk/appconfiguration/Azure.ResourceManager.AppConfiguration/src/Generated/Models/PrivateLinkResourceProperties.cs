...
namespace Azure.ResourceManager.AppConfiguration
{
    ...
    public partial class PrivateLinkResourceProperties
    {
        ...
        internal PrivateLinkResourceProperties(string groupId, IReadOnlyList<string> requiredMembers, IReadOnlyList<string> requiredZoneNames, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            GroupId = groupId;
