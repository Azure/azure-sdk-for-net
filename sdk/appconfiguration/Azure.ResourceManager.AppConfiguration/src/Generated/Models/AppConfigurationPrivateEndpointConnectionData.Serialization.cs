...
namespace Azure.ResourceManager.AppConfiguration
{
    public partial class AppConfigurationPrivateEndpointConnectionData : IUtf8JsonSerializable
    {
        ...
        internal static AppConfigurationPrivateEndpointConnectionData DeserializeAppConfigurationPrivateEndpointConnectionData(JsonElement element)
        {
            ...
            return new AppConfigurationPrivateEndpointConnectionData(id, name, type, systemData, Optional.ToNullable(provisioningState), privateEndpoint, privateLinkServiceConnectionState.Value);
        }
    }
}
