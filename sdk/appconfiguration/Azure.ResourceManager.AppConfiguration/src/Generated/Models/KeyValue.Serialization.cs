...
namespace Azure.ResourceManager.AppConfiguration
{
    ...
    public partial class KeyValue : ProxyResource, IJsonModel<KeyValue>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        KeyValue IJsonModel<KeyValue>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (KeyValue)JsonModelCreateCore(ref reader, options);
        ...
        internal static KeyValue DeserializeKeyValue(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            KeyValueProperties properties = default;
            string name = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = KeyValueProperties.DeserializeKeyValueProperties(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        KeyValue IPersistableModel<KeyValue>.Create(BinaryData data, ModelReaderWriterOptions options) => (KeyValue)PersistableModelCreateCore(data, options);
        ...
        /// <param name="response"> The <see cref="Response"/> to deserialize the <see cref="KeyValue"/> from. </param>
