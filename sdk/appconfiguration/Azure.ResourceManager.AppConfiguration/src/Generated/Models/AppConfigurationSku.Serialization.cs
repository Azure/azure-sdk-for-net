...
{
    public partial class AppConfigurationSku : IUtf8JsonSerializable, IJsonModel<AppConfigurationSku>, IPersistableModel<AppConfigurationSku>
    {
        ...
        void IJsonModel<AppConfigurationSku>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AppConfigurationSku)} does not support '{format}' format.");
            }
