...
namespace Azure.ResourceManager.AppConfiguration.Models
{
    ...
    public partial class AppConfigurationSku : IJsonModel<AppConfigurationSku>
    {
        ...
        protected virtual AppConfigurationSku PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<AppConfigurationSku>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<AppConfigurationSku>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        AppConfigurationSku IPersistableModel<AppConfigurationSku>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        AppConfigurationSku IJsonModel<AppConfigurationSku>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual AppConfigurationSku JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<AppConfigurationSku>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static AppConfigurationSku DeserializeAppConfigurationSku(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new AppConfigurationSku(name, additionalBinaryDataProperties);
        }
    }
}
