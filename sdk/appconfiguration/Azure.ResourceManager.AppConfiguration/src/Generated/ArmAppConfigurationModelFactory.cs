...
namespace Azure.ResourceManager.AppConfiguration.Models
{
    ...
    public static partial class ArmAppConfigurationModelFactory
    {
        ...
        {
            return new AppConfigurationPrivateEndpointConnectionReference(id, name, resourceType, systemData, provisioningState, privateEndpointId != null ? ResourceManagerModelFactory.WritableSubResource(privateEndpointId) : null, connectionState, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AppConfigurationPrivateLinkServiceConnectionState(status, description, actionsRequired, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AppConfigurationNameAvailabilityResult(isNameAvailable, message, reason, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AppConfigurationStoreApiKey(id, name, value, connectionString, lastModifiedOn, isReadOnly, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AppConfigurationPrivateEndpointConnectionData(id, name, resourceType, systemData, provisioningState, privateEndpointId != null ? ResourceManagerModelFactory.WritableSubResource(privateEndpointId) : null, connectionState, new Dictionary<string, BinaryData>());
        }
        ...
        public static AppConfigurationPrivateLinkResourceData AppConfigurationPrivateLinkResourceData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string groupId = null, IEnumerable<string> requiredMembers = null, IEnumerable<string> requiredZoneNames = null)
        {
            ...
            return new AppConfigurationPrivateLinkResourceData(id, name, resourceType, systemData, groupId, requiredMembers?.ToList(), requiredZoneNames?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static AppConfigurationKeyValueData AppConfigurationKeyValueData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string key = null, string label = null, string value = null, string contentType = null, ETag? eTag = null, DateTimeOffset? lastModifiedOn = null, bool? isLocked = null, IDictionary<string, string> tags = null)
        {
            ...
            return new AppConfigurationKeyValueData(id, name, resourceType, systemData, key, label, value, contentType, eTag, lastModifiedOn, isLocked, tags, new Dictionary<string, BinaryData>());
        }
        ...
        public static DeletedAppConfigurationStoreData DeletedAppConfigurationStoreData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, ResourceIdentifier configurationStoreId = null, AzureLocation? location = null, DateTimeOffset? deletedOn = null, DateTimeOffset? scheduledPurgeOn = null, IReadOnlyDictionary<string, string> tags = null, bool? isPurgeProtectionEnabled = null)
        {
            ...
            return new DeletedAppConfigurationStoreData(id, name, resourceType, systemData, configurationStoreId, location, deletedOn, scheduledPurgeOn, tags, isPurgeProtectionEnabled, new Dictionary<string, BinaryData>());
        }
    }
}
