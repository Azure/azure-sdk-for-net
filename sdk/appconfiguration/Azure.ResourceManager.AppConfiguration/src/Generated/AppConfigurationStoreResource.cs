...
namespace Azure.ResourceManager.AppConfiguration
{
    ...
    public partial class AppConfigurationStoreResource : ArmResource
    {
        ...
        /// <summary>
        /// Updates the AppConfigurationStore.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AppConfiguration/configurationStores/{configStoreName}. </description>
        ...
        public virtual async Task<ArmOperation<AppConfigurationStoreResource>> UpdateAsync(WaitUntil waitUntil, AppConfigurationStoreData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _configurationStoresRestClient.CreateCreateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, AppConfigurationStoreData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                AppConfigurationArmOperation<AppConfigurationStoreResource> operation = new AppConfigurationArmOperation<AppConfigurationStoreResource>(
                    new AppConfigurationStoreResourceOperationSource(Client),
                    _configurationStoresClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<AppConfigurationStoreResource> Update(WaitUntil waitUntil, AppConfigurationStoreData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
