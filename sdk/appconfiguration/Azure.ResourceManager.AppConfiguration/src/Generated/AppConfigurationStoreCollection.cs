...
namespace Azure.ResourceManager.AppConfiguration
{
    ...
    public partial class AppConfigurationStoreCollection : ArmCollection, IEnumerable<AppConfigurationStoreResource>, IAsyncEnumerable<AppConfigurationStoreResource>
    {
        ...
        public virtual async Task<ArmOperation<AppConfigurationStoreResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string configStoreName, AppConfigurationStoreData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                using var message = _appConfigurationStoreConfigurationStoresRestClient.CreateCreateRequest(Id.SubscriptionId, Id.ResourceGroupName, configStoreName, data);
                var response = await _appConfigurationStoreConfigurationStoresRestClient.CreateAsync(message, cancellationToken).ConfigureAwait(false);
        ...
        public virtual ArmOperation<AppConfigurationStoreResource> CreateOrUpdate(WaitUntil waitUntil, string configStoreName, AppConfigurationStoreData data, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var message = _appConfigurationStoreConfigurationStoresRestClient.CreateCreateRequest(Id.SubscriptionId, Id.ResourceGroupName, configStoreName, data);
                var response = _appConfigurationStoreConfigurationStoresRestClient.Create(message, cancellationToken);
                var operation = new AppConfigurationArmOperation<AppConfigurationStoreResource>(new AppConfigurationStoreOperationSource(Client), _appConfigurationStoreConfigurationStoresClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
