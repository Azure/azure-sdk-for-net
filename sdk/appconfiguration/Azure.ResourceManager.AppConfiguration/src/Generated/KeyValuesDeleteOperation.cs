...
namespace Azure.ResourceManager.AppConfiguration
{
    ...
    public partial class KeyValuesDeleteOperation : Operation<Response>, IOperationSource<Response>
    {
        private readonly ArmOperationHelpers<Response> _operation;

        /// <summary> Initializes a new instance of KeyValuesDeleteOperation for mocking. </summary>
        ...
        {
            _operation = new ArmOperationHelpers<Response>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "KeyValuesDeleteOperation");
        }
        /// <inheritdoc />
