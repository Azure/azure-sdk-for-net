...
namespace Azure.ResourceManager.AppConfiguration
{
    ...
    public partial class KeyValue : ArmResource
    {
        ...
        internal KeyValue(ArmClient armClient, KeyValueData data) : this(armClient, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal KeyValue(ArmClient armClient, ResourceIdentifier id) : base(armClient, id)
        {
            ...
            ArmClient.TryGetApiVersion(ResourceType, out string keyValueApiVersion);
        ...
        {
            using var scope = _keyValueClientDiagnostics.CreateScope("KeyValue.GetAvailableLocations");
            scope.Start();
            try
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async virtual Task<KeyValueDeleteOperation> DeleteAsync(bool waitForCompletion, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new KeyValueDeleteOperation(_keyValueClientDiagnostics, Pipeline, _keyValueRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name).Request, response);
        ...
        /// <param name="waitForCompletion"> Waits for the completion of the long running operations. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual KeyValueDeleteOperation Delete(bool waitForCompletion, CancellationToken cancellationToken = default)
        {
            using var scope = _keyValueClientDiagnostics.CreateScope("KeyValue.Delete");
            scope.Start();
            try
