...
namespace Azure.ResourceManager.AppConfiguration
{
    ...
    public partial class AppConfigurationKeyValueResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of AppConfigurationKeyValueResource for mocking. </summary>
        protected AppConfigurationKeyValueResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="AppConfigurationKeyValueResource"/> class. </summary>
        ...
        {
            string resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AppConfiguration/configurationStores/{configStoreName}/keyValues/{keyValueName}";
        ...
        {
            using DiagnosticScope scope = _keyValuesClientDiagnostics.CreateScope("AppConfigurationKeyValueResource.Get");
            scope.Start();
            try
            {
        ...
        {
            using DiagnosticScope scope = _keyValuesClientDiagnostics.CreateScope("AppConfigurationKeyValueResource.Delete");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _keyValuesRestClient.CreateDeleteRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                AppConfigurationArmOperation operation = new AppConfigurationArmOperation(_keyValuesClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
        ...
        /// <summary>
        /// Update a AppConfigurationKeyValue.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AppConfiguration/configurationStores/{configStoreName}/keyValues/{keyValueName}. </description>
        ...
        public virtual async Task<ArmOperation<AppConfigurationKeyValueResource>> UpdateAsync(WaitUntil waitUntil, AppConfigurationKeyValueData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _keyValuesClientDiagnostics.CreateScope("AppConfigurationKeyValueResource.Update");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _keyValuesRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, AppConfigurationKeyValueData.ToRequestContent(data), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<AppConfigurationKeyValueData> response = Response.FromValue(AppConfigurationKeyValueData.FromResponse(result), result);
