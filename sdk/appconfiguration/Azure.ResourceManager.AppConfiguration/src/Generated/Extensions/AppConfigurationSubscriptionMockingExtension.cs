...
namespace Azure.ResourceManager.AppConfiguration.Mocking
{
    ...
    internal partial class AppConfigurationSubscriptionMockingExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="AppConfigurationSubscriptionMockingExtension"/> class for mocking. </summary>
        protected AppConfigurationSubscriptionMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="AppConfigurationSubscriptionMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal AppConfigurationSubscriptionMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        {
            using var scope = DefaultClientDiagnostics.CreateScope("AppConfigurationSubscriptionMockingExtension.CheckAppConfigurationNameAvailability");
            scope.Start();
            try
            {
