...
using Azure.ResourceManager.AppConfiguration.Mock;
...
namespace Azure.ResourceManager.AppConfiguration
{
    ...
    {
        private static AppConfigurationStoreResourceExtension GetAppConfigurationStoreResourceExtension(ArmResource resource)
        {
            return resource.GetCachedClient(client =>
            {
                return new AppConfigurationStoreResourceExtension(client, resource.Id);
            });
        }

        private static AppConfigurationStoreResourceExtension GetAppConfigurationStoreResourceExtension(ArmClient client, ResourceIdentifier scope)
        {
            return client.GetResourceClient(() =>
            {
                return new AppConfigurationStoreResourceExtension(client, scope);
            });
        }
        ...
        {
            return GetResourceGroupResourceExtension(resourceGroupResource).GetAppConfigurationStores();
        }
        ...
        {
            return GetSubscriptionResourceExtension(subscriptionResource).GetDeletedAppConfigurationStores();
        }
        ...
        {
            return GetAppConfigurationStoreResourceExtension(subscriptionResource).GetAppConfigurationStoresAsync(skipToken, cancellationToken);
        }
        ...
        {
            return GetAppConfigurationStoreResourceExtension(subscriptionResource).GetAppConfigurationStores(skipToken, cancellationToken);
        }
        ...
        public static async Task<Response<AppConfigurationNameAvailabilityResult>> CheckAppConfigurationNameAvailabilityAsync(this SubscriptionResource subscriptionResource, AppConfigurationNameAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            ...
            return await GetSubscriptionResourceExtension(subscriptionResource).CheckAppConfigurationNameAvailabilityAsync(content, cancellationToken).ConfigureAwait(false);
        }
        ...
        public static Response<AppConfigurationNameAvailabilityResult> CheckAppConfigurationNameAvailability(this SubscriptionResource subscriptionResource, AppConfigurationNameAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            ...
            return GetSubscriptionResourceExtension(subscriptionResource).CheckAppConfigurationNameAvailability(content, cancellationToken);
        }
    }
}
