...
namespace Azure.ResourceManager.AppConfiguration.Mock
{
    ...
    public partial class AppConfigurationStoreResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="AppConfigurationStoreResourceExtension"/> class for mocking. </summary>
        protected AppConfigurationStoreResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="AppConfigurationStoreResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal AppConfigurationStoreResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
