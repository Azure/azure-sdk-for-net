# Azure Management AppConfiguration client library for .NET
...
Install the Azure Management App Configuration client library for .NET with [NuGet](https://www.nuget.org/):

```PowerShell
Install-Package Azure.ResourceManager.AppConfiguration
```
