...
namespace Microsoft.Azure.Management.AppConfiguration.Models
{
    ...
    public partial class MetricSpecification
    {
        ...
        public MetricSpecification(string name = default(string), string displayName = default(string), string displayDescription = default(string), string unit = default(string), string aggregationType = default(string), string internalMetricName = default(string), IList<MetricDimension> dimensions = default(IList<MetricDimension>), bool? fillGapWithZero = default(bool?))
        {
            Name = name;
