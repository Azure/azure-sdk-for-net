...
namespace Microsoft.Azure.Management.AppConfiguration.Models
{
    ...
    public partial class PrivateEndpointConnectionReference
    {
        ...
        /// private endpoint connection. Possible values include: 'Creating',
        /// 'Updating', 'Deleting', 'Succeeded', 'Failed', 'Canceled'</param>
        /// <param name="privateEndpoint">The resource of private
        /// endpoint.</param>
        public PrivateEndpointConnectionReference(PrivateLinkServiceConnectionState privateLinkServiceConnectionState, string id = default(string), string name = default(string), string type = default(string), string provisioningState = default(string), PrivateEndpoint privateEndpoint = default(PrivateEndpoint))
        {
            Id = id;
            Name = name;
            Type = type;
        ...
        /// <summary>
        /// Gets the provisioning status of the private endpoint connection.
