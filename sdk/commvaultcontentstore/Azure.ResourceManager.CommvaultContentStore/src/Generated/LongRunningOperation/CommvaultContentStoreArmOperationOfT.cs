...
{
    internal partial class CommvaultContentStoreArmOperation<T> : ArmOperation<T>
    {
        ...
        /// <summary> Initializes a new instance of CommvaultContentStoreArmOperation for mocking. </summary>
        protected CommvaultContentStoreArmOperation()
        {
        }
        ...
        internal CommvaultContentStoreArmOperation(Response<T> response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal CommvaultContentStoreArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal<T>(
                ...
                clientDiagnostics,
                response,
                "CommvaultContentStoreArmOperation",
                null,
