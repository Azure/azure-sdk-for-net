...
{
    internal partial class CommvaultContentStoreArmOperation : ArmOperation
    {
        ...
        internal CommvaultContentStoreArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal CommvaultContentStoreArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
