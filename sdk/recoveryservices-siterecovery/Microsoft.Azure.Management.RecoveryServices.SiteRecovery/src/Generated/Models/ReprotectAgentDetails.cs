...
namespace Microsoft.Azure.Management.RecoveryServices.SiteRecovery.Models
{
    ...
    public partial class ReprotectAgentDetails
    {
        ...
        public ReprotectAgentDetails(string id = default(string), string name = default(string), string version = default(string), System.DateTime? lastHeartbeatUtc = default(System.DateTime?), string health = default(string), IList<HealthError> healthErrors = default(IList<HealthError>))
        {
            Id = id;
            Name = name;
            Version = version;
