...
namespace Microsoft.Azure.Management.RecoveryServices.SiteRecovery.Models
{
    ...
    public partial class InMageFabricSwitchProviderBlockingErrorDetails
    {
        ...
        public InMageFabricSwitchProviderBlockingErrorDetails(string errorCode = default(string), string errorMessage = default(string), string possibleCauses = default(string), string recommendedAction = default(string), IDictionary<string, string> errorMessageParameters = default(IDictionary<string, string>), IDictionary<string, string> errorTags = default(IDictionary<string, string>))
        {
            ErrorCode = errorCode;
