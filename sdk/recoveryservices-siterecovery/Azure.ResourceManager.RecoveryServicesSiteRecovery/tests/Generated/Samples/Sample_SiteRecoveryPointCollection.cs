...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Samples
{
    public partial class Sample_SiteRecoveryPointCollection
    {
        ...
        {
            // Generated from example definition: specification/recoveryservicessiterecovery/resource-manager/Microsoft.RecoveryServices/stable/2025-01-01/examples/RecoveryPoints_Get.json
        ...
        {
            // Generated from example definition: specification/recoveryservicessiterecovery/resource-manager/Microsoft.RecoveryServices/stable/2025-01-01/examples/RecoveryPoints_ListByReplicationProtectedItems.json
        ...
        public async Task GetIfExists_GetsARecoveryPoint()
        {
            ...
            // invoke the operation
            string recoveryPointName = "b22134ea-620c-474b-9fa5-3c1cb47708e3";
            NullableResponse<SiteRecoveryPointResource> response = await collection.GetIfExistsAsync(recoveryPointName);
            SiteRecoveryPointResource result = response.HasValue ? response.Value : null;
