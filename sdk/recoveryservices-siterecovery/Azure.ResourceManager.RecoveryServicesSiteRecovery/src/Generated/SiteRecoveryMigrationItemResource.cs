...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery
{
    ...
    public partial class SiteRecoveryMigrationItemResource : ArmResource
    {
        ...
        internal SiteRecoveryMigrationItemResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _replicationMigrationItemsRestClient = new ReplicationMigrationItems(_replicationMigrationItemsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, siteRecoveryMigrationItemApiVersion ?? "2026-02-01");
        ...
        /// <summary>
        /// Updates the SiteRecoveryMigrationItem.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{resourceName}/replicationFabrics/{fabricName}/replicationProtectionContainers/{protectionContainerName}/replicationMigrationItems/{migrationItemName}. </description>
        ...
        public virtual async Task<ArmOperation<SiteRecoveryMigrationItemResource>> UpdateAsync(WaitUntil waitUntil, SiteRecoveryMigrationItemCreateOrUpdateContent content, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(content, nameof(content));
            ...
            try
            {
                ...
                HttpMessage message = _replicationMigrationItemsRestClient.CreateCreateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, SiteRecoveryMigrationItemCreateOrUpdateContent.ToRequestContent(content), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                RecoveryServicesSiteRecoveryArmOperation<SiteRecoveryMigrationItemResource> operation = new RecoveryServicesSiteRecoveryArmOperation<SiteRecoveryMigrationItemResource>(
                    new SiteRecoveryMigrationItemResourceOperationSource(Client),
                    _replicationMigrationItemsClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="content"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<SiteRecoveryMigrationItemResource> Update(WaitUntil waitUntil, SiteRecoveryMigrationItemCreateOrUpdateContent content, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(content, nameof(content));
