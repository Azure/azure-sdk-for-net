...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery
{
    ...
    public partial class ProtectionContainerMappingData : ResourceData
    {
        ...
        internal ProtectionContainerMappingData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, ProtectionContainerMappingProperties properties, string location) : base(id, name, resourceType, systemData)
        {
