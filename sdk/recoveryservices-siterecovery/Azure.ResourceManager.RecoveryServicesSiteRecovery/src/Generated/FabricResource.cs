...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery
{
    ...
    public partial class FabricResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<FabricResource>> UpdateAsync(WaitUntil waitUntil, FabricCreateOrUpdateContent content, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                using var message = _fabricReplicationFabricsRestClient.CreateCreateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, content);
        ...
        public virtual async Task<ArmOperation<FabricResource>> CheckConsistencyAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                using var message = _fabricReplicationFabricsRestClient.CreateCheckConsistencyRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name);
                var response = await _fabricReplicationFabricsRestClient.CheckConsistencyAsync(message, cancellationToken).ConfigureAwait(false);
                var operation = new RecoveryServicesSiteRecoveryArmOperation<FabricResource>(new FabricOperationSource(Client), _fabricReplicationFabricsClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                    await operation.WaitForCompletionAsync(cancellationToken).ConfigureAwait(false);
                return operation;
        ...
        public virtual ArmOperation<FabricResource> CheckConsistency(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var message = _fabricReplicationFabricsRestClient.CreateCheckConsistencyRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name);
                var response = _fabricReplicationFabricsRestClient.CheckConsistency(message, cancellationToken);
                var operation = new RecoveryServicesSiteRecoveryArmOperation<FabricResource>(new FabricOperationSource(Client), _fabricReplicationFabricsClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                    operation.WaitForCompletion(cancellationToken);
                return operation;
        ...
        public virtual async Task<ArmOperation> MigrateToAadAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                using var message = _fabricReplicationFabricsRestClient.CreateMigrateToAadRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name);
                var response = await _fabricReplicationFabricsRestClient.MigrateToAadAsync(message, cancellationToken).ConfigureAwait(false);
                var operation = new RecoveryServicesSiteRecoveryArmOperation(_fabricReplicationFabricsClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual ArmOperation MigrateToAad(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var message = _fabricReplicationFabricsRestClient.CreateMigrateToAadRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name);
                var response = _fabricReplicationFabricsRestClient.MigrateToAad(message, cancellationToken);
                var operation = new RecoveryServicesSiteRecoveryArmOperation(_fabricReplicationFabricsClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<ArmOperation<FabricResource>> ReassociateGatewayAsync(WaitUntil waitUntil, FailoverProcessServerContent content, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                using var message = _fabricReplicationFabricsRestClient.CreateReassociateGatewayRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, content);
                var response = await _fabricReplicationFabricsRestClient.ReassociateGatewayAsync(message, cancellationToken).ConfigureAwait(false);
                var operation = new RecoveryServicesSiteRecoveryArmOperation<FabricResource>(new FabricOperationSource(Client), _fabricReplicationFabricsClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                    await operation.WaitForCompletionAsync(cancellationToken).ConfigureAwait(false);
                return operation;
        ...
        public virtual ArmOperation<FabricResource> ReassociateGateway(WaitUntil waitUntil, FailoverProcessServerContent content, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var message = _fabricReplicationFabricsRestClient.CreateReassociateGatewayRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, content);
                var response = _fabricReplicationFabricsRestClient.ReassociateGateway(message, cancellationToken);
                var operation = new RecoveryServicesSiteRecoveryArmOperation<FabricResource>(new FabricOperationSource(Client), _fabricReplicationFabricsClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                    operation.WaitForCompletion(cancellationToken);
                return operation;
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                using var message = _fabricReplicationFabricsRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name);
                var response = await _fabricReplicationFabricsRestClient.DeleteAsync(message, cancellationToken).ConfigureAwait(false);
                var operation = new RecoveryServicesSiteRecoveryArmOperation(_fabricReplicationFabricsClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                    await operation.WaitForCompletionResponseAsync(cancellationToken).ConfigureAwait(false);
                return operation;
        ...
        public virtual ArmOperation Delete(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var message = _fabricReplicationFabricsRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name);
                var response = _fabricReplicationFabricsRestClient.Delete(message, cancellationToken);
                var operation = new RecoveryServicesSiteRecoveryArmOperation(_fabricReplicationFabricsClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                    operation.WaitForCompletionResponse(cancellationToken);
                return operation;
        ...
        public virtual async Task<ArmOperation<FabricResource>> RenewCertificateAsync(WaitUntil waitUntil, RenewCertificateContent content, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                using var message = _fabricReplicationFabricsRestClient.CreateRenewCertificateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, content);
                var response = await _fabricReplicationFabricsRestClient.RenewCertificateAsync(message, cancellationToken).ConfigureAwait(false);
                var operation = new RecoveryServicesSiteRecoveryArmOperation<FabricResource>(new FabricOperationSource(Client), _fabricReplicationFabricsClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                    await operation.WaitForCompletionAsync(cancellationToken).ConfigureAwait(false);
                return operation;
        ...
        public virtual ArmOperation<FabricResource> RenewCertificate(WaitUntil waitUntil, RenewCertificateContent content, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var message = _fabricReplicationFabricsRestClient.CreateRenewCertificateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, content);
                var response = _fabricReplicationFabricsRestClient.RenewCertificate(message, cancellationToken);
                var operation = new RecoveryServicesSiteRecoveryArmOperation<FabricResource>(new FabricOperationSource(Client), _fabricReplicationFabricsClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                    operation.WaitForCompletion(cancellationToken);
                return operation;
