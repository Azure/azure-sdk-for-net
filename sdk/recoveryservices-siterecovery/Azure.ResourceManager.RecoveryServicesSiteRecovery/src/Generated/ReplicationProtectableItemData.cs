...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery
{
    ...
    public partial class ReplicationProtectableItemData : ResourceData
    {
        ...
        internal ReplicationProtectableItemData()
        {
        }
        ...
        /// </param>
        internal ReplicationProtectableItemData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, ProtectableItemProperties properties, AzureLocation? location) : base(id, name, resourceType, systemData)
        {
