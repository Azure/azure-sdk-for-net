...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery
{
    ...
    public partial class StorageClassificationMappingCollection : ArmCollection, IEnumerable<StorageClassificationMappingResource>, IAsyncEnumerable<StorageClassificationMappingResource>
    {
        ...
        internal static void ValidateResourceId(ResourceIdentifier id)
        {
            ...
            {
                throw new ArgumentException(string.Format("Invalid resource type {0} expected {1}", id.ResourceType, StorageClassificationResource.ResourceType), nameof(id));
            }
        }
        ...
        public virtual AsyncPageable<StorageClassificationMappingResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<StorageClassificationMappingData, StorageClassificationMappingResource>(new ReplicationStorageClassificationMappingsListByClassificationAsyncCollectionResultOfT(
                ...
                Id.Name,
                context,
                "StorageClassificationMappingCollection.GetAll"), data => new StorageClassificationMappingResource(Client, data));
        }
