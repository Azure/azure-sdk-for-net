...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery
{
    ...
    public partial class SiteRecoveryEventCollection : ArmCollection, IEnumerable<SiteRecoveryEventResource>, IAsyncEnumerable<SiteRecoveryEventResource>
    {
        ...
        /// <summary> Initializes a new instance of SiteRecoveryEventCollection for mocking. </summary>
        protected SiteRecoveryEventCollection()
        {
        }

        /// <summary> Initializes a new instance of <see cref="SiteRecoveryEventCollection"/> class. </summary>
        ...
        internal SiteRecoveryEventCollection(ArmClient client, ResourceIdentifier id, string resourceName) : base(client, id)
        {
            ...
            _replicationEventsRestClient = new ReplicationEvents(_replicationEventsClientDiagnostics, Pipeline, Endpoint, siteRecoveryEventApiVersion ?? "2026-01-01");
        ...
        public virtual async Task<Response<SiteRecoveryEventResource>> GetAsync(string eventName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _replicationEventsClientDiagnostics.CreateScope("SiteRecoveryEventCollection.Get");
            scope.Start();
            try
            {
                ...
                Response<SiteRecoveryEventData> response = Response.FromValue(SiteRecoveryEventData.FromResponse(result), result);
        ...
        public virtual AsyncPageable<SiteRecoveryEventResource> GetAllAsync(string filter = default, CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
            ...
            return new AsyncPageableWrapper<SiteRecoveryEventData, SiteRecoveryEventResource>(new ReplicationEventsGetAllAsyncCollectionResultOfT(
                ...
                filter,
                context,
                "SiteRecoveryEventCollection.GetAll"), data => new SiteRecoveryEventResource(Client, data));
        }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> A collection of <see cref="SiteRecoveryEventResource"/> that may take multiple service requests to iterate over. </returns>
        public virtual Pageable<SiteRecoveryEventResource> GetAll(string filter = default, CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string eventName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _replicationEventsClientDiagnostics.CreateScope("SiteRecoveryEventCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                Response<SiteRecoveryEventData> response = default;
                switch (result.Status)
                {
                    case 200:
                        response = Response.FromValue(SiteRecoveryEventData.FromResponse(result), result);
                        break;
                    case 404:
                        response = Response.FromValue((SiteRecoveryEventData)null, result);
                        break;
                    default:
        ...
        public virtual async Task<NullableResponse<SiteRecoveryEventResource>> GetIfExistsAsync(string eventName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _replicationEventsClientDiagnostics.CreateScope("SiteRecoveryEventCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
