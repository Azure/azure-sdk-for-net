...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery
{
    ...
    /// Otherwise you can get one from its parent resource <see cref="ResourceGroupResource" /> using the GetPolicy method.
    /// </summary>
    public partial class PolicyResource : ArmResource
    {
        ...
        {
            _policyReplicationPoliciesClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.RecoveryServicesSiteRecovery", ResourceType.Namespace, Diagnostics);
            TryGetApiVersion(ResourceType, out string policyReplicationPoliciesApiVersion);
        ...
        {
            using var scope = _policyReplicationPoliciesClientDiagnostics.CreateScope("PolicyResource.Get");
            scope.Start();
            try
            {
                var response = await _policyReplicationPoliciesRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<PolicyResource> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _policyReplicationPoliciesRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new PolicyResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        {
            using var scope = _policyReplicationPoliciesClientDiagnostics.CreateScope("PolicyResource.Delete");
            scope.Start();
            try
            {
                var response = await _policyReplicationPoliciesRestClient.DeleteAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
                var operation = new RecoveryServicesSiteRecoveryArmOperation(_policyReplicationPoliciesClientDiagnostics, Pipeline, _policyReplicationPoliciesRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name).Request, response, OperationFinalStateVia.Location);
        ...
        public virtual ArmOperation Delete(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _policyReplicationPoliciesRestClient.Delete(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                var operation = new RecoveryServicesSiteRecoveryArmOperation(_policyReplicationPoliciesClientDiagnostics, Pipeline, _policyReplicationPoliciesRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<ArmOperation<PolicyResource>> UpdateAsync(WaitUntil waitUntil, PolicyPatch patch, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _policyReplicationPoliciesClientDiagnostics.CreateScope("PolicyResource.Update");
            scope.Start();
            try
            {
                var response = await _policyReplicationPoliciesRestClient.UpdateAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, patch, cancellationToken).ConfigureAwait(false);
        ...
        public virtual ArmOperation<PolicyResource> Update(WaitUntil waitUntil, PolicyPatch patch, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _policyReplicationPoliciesRestClient.Update(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, patch, cancellationToken);
                var operation = new RecoveryServicesSiteRecoveryArmOperation<PolicyResource>(new PolicyOperationSource(Client), _policyReplicationPoliciesClientDiagnostics, Pipeline, _policyReplicationPoliciesRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, patch).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
