...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery
{
    ...
    public partial class MigrationRecoveryPointCollection : ArmCollection, IEnumerable<MigrationRecoveryPointResource>, IAsyncEnumerable<MigrationRecoveryPointResource>
    {
        ...
        internal static void ValidateResourceId(ResourceIdentifier id)
        {
            ...
            {
                throw new ArgumentException(string.Format("Invalid resource type {0} expected {1}", id.ResourceType, SiteRecoveryMigrationItemResource.ResourceType), nameof(id));
            }
        }
        ...
        public virtual AsyncPageable<MigrationRecoveryPointResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<MigrationRecoveryPointData, MigrationRecoveryPointResource>(new MigrationRecoveryPointsGetByReplicationMigrationItemsAsyncCollectionResultOfT(
                ...
                Id.Name,
                context,
                "MigrationRecoveryPointCollection.GetAll"), data => new MigrationRecoveryPointResource(Client, data));
        }
