...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery
{
    ...
    public partial class VaultSettingCollection : ArmCollection, IEnumerable<VaultSettingResource>, IAsyncEnumerable<VaultSettingResource>
    {
        ...
        public virtual AsyncPageable<VaultSettingResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, (e, o) => new VaultSettingResource(Client, VaultSettingData.DeserializeVaultSettingData(e)), _vaultSettingReplicationVaultSettingClientDiagnostics, Pipeline, "VaultSettingCollection.GetAll", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<VaultSettingResource> GetAll(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _vaultSettingReplicationVaultSettingRestClient.CreateListRequest(Id.SubscriptionId, Id.ResourceGroupName, _resourceName);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _vaultSettingReplicationVaultSettingRestClient.CreateListNextPageRequest(nextLink, Id.SubscriptionId, Id.ResourceGroupName, _resourceName);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, (e, o) => new VaultSettingResource(Client, VaultSettingData.DeserializeVaultSettingData(e)), _vaultSettingReplicationVaultSettingClientDiagnostics, Pipeline, "VaultSettingCollection.GetAll", "value", "nextLink", cancellationToken);
        }
