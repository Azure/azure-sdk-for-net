...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery
{
    ...
    public partial class NetworkData : ResourceData
    {
        ...
        internal NetworkData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, NetworkProperties properties, string location) : base(id, name, resourceType, systemData)
        {
