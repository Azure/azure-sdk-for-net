...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery
{
    ...
    public partial class ReplicationEligibilityResultData : ResourceData
    {
        ...
        internal ReplicationEligibilityResultData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, ReplicationEligibilityResultProperties properties) : base(id, name, resourceType, systemData)
        {
