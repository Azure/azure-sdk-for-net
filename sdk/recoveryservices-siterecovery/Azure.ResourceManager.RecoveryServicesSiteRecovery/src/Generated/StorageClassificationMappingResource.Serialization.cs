...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery
{
    public partial class StorageClassificationMappingResource : IJsonModel<StorageClassificationMappingData>
    {
        ...
        BinaryData IPersistableModel<StorageClassificationMappingData>.Write(ModelReaderWriterOptions options) => ModelReaderWriter.Write(Data, options);

        StorageClassificationMappingData IPersistableModel<StorageClassificationMappingData>.Create(BinaryData data, ModelReaderWriterOptions options) => ModelReaderWriter.Read<StorageClassificationMappingData>(data, options);
