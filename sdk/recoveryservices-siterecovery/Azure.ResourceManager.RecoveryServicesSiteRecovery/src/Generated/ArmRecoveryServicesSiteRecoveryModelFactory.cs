...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public static partial class ArmRecoveryServicesSiteRecoveryModelFactory
    {
        ...
        {
            return new SiteRecoveryAlertData(id, name, resourceType, systemData, properties, location, new Dictionary<string, BinaryData>());
        }
        ...
        public static SiteRecoveryAlertProperties SiteRecoveryAlertProperties(string sendToOwners = null, IEnumerable<string> customEmailAddresses = null, string locale = null)
        {
            ...
            return new SiteRecoveryAlertProperties(sendToOwners, customEmailAddresses?.ToList(), locale, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SiteRecoveryReplicationAppliance(siteRecoveryReplicationApplianceProviderSpecificDetails != null ? new SiteRecoveryReplicationApplianceProperties(siteRecoveryReplicationApplianceProviderSpecificDetails, new Dictionary<string, BinaryData>()) : null, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ReplicationEligibilityResultData(id, name, resourceType, systemData, properties, new Dictionary<string, BinaryData>());
        }
        ...
        public static ReplicationEligibilityResultProperties ReplicationEligibilityResultProperties(string clientRequestId = null, IEnumerable<ReplicationEligibilityResultErrorInfo> errors = null)
        {
            ...
            return new ReplicationEligibilityResultProperties(clientRequestId, errors?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ReplicationEligibilityResultErrorInfo(code, message, possibleCauses, recommendedAction, status, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SiteRecoveryEventData(id, name, resourceType, systemData, properties, location, new Dictionary<string, BinaryData>());
        }
        ...
        public static SiteRecoveryEventProperties SiteRecoveryEventProperties(string eventCode = null, string description = null, string eventType = null, string affectedObjectFriendlyName = null, string affectedObjectCorrelationId = null, string severity = null, DateTimeOffset? occurredOn = null, ResourceIdentifier fabricId = null, SiteRecoveryEventProviderSpecificDetails providerSpecificDetails = null, SiteRecoveryEventSpecificDetails eventSpecificDetails = null, IEnumerable<SiteRecoveryHealthError> healthErrors = null)
        {
            ...
            return new SiteRecoveryEventProperties(eventCode, description, eventType, affectedObjectFriendlyName, affectedObjectCorrelationId, severity, occurredOn, fabricId, providerSpecificDetails, eventSpecificDetails, healthErrors?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static SiteRecoveryHealthError SiteRecoveryHealthError(IEnumerable<SiteRecoveryInnerHealthError> innerHealthErrors = null, string errorSource = null, string errorType = null, string errorLevel = null, string errorCategory = null, string errorCode = null, string summaryMessage = null, string errorMessage = null, string possibleCauses = null, string recommendedAction = null, DateTimeOffset? creationTimeUtc = null, string recoveryProviderErrorMessage = null, string entityId = null, string errorId = null, HealthErrorCustomerResolvability? customerResolvability = null)
        {
            ...
            return new SiteRecoveryHealthError(innerHealthErrors?.ToList(), errorSource, errorType, errorLevel, errorCategory, errorCode, summaryMessage, errorMessage, possibleCauses, recommendedAction, creationTimeUtc, recoveryProviderErrorMessage, entityId, errorId, customerResolvability, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SiteRecoveryInnerHealthError(errorSource, errorType, errorLevel, errorCategory, errorCode, summaryMessage, errorMessage, possibleCauses, recommendedAction, createdOn, recoveryProviderErrorMessage, entityId, errorId, customerResolvability, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SiteRecoveryFabricData(id, name, resourceType, systemData, properties, location, new Dictionary<string, BinaryData>());
        }
        ...
        public static SiteRecoveryFabricProperties SiteRecoveryFabricProperties(string friendlyName = null, SiteRecoveryEncryptionDetails encryptionDetails = null, SiteRecoveryEncryptionDetails rolloverEncryptionDetails = null, string internalIdentifier = null, string bcdrState = null, FabricSpecificDetails customDetails = null, IEnumerable<SiteRecoveryHealthError> healthErrorDetails = null, string health = null)
        {
            ...
            return new SiteRecoveryFabricProperties(friendlyName, encryptionDetails, rolloverEncryptionDetails, internalIdentifier, bcdrState, customDetails, healthErrorDetails?.ToList(), health, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SiteRecoveryEncryptionDetails(kekState, kekCertThumbprint, kekCertExpireOn, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SiteRecoveryLogicalNetworkData(id, name, resourceType, systemData, properties, location, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SiteRecoveryLogicalNetworkProperties(friendlyName, networkVirtualizationStatus, logicalNetworkUsage, logicalNetworkDefinitionsStatus, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SiteRecoveryNetworkData(id, name, resourceType, systemData, properties, location, new Dictionary<string, BinaryData>());
        }
        ...
        public static SiteRecoveryNetworkProperties SiteRecoveryNetworkProperties(string fabricType = null, IEnumerable<SiteRecoverySubnet> subnets = null, string friendlyName = null, string networkType = null)
        {
            ...
            return new SiteRecoveryNetworkProperties(fabricType, subnets?.ToList(), friendlyName, networkType, new Dictionary<string, BinaryData>());
        }
        ...
        public static SiteRecoverySubnet SiteRecoverySubnet(string name = null, string friendlyName = null, IEnumerable<string> addressList = null)
        {
            ...
            return new SiteRecoverySubnet(name, friendlyName, addressList?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SiteRecoveryNetworkMappingData(id, name, resourceType, systemData, properties, location, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SiteRecoveryNetworkMappingProperties(state, primaryNetworkFriendlyName, primaryNetworkId, primaryFabricFriendlyName, recoveryNetworkFriendlyName, recoveryNetworkId, recoveryFabricArmId, recoveryFabricFriendlyName, fabricSpecificSettings, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SiteRecoveryCreateReplicationNetworkMappingProperties(recoveryFabricName, recoveryNetworkId, fabricSpecificDetails, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SiteRecoveryProtectionContainerData(id, name, resourceType, systemData, properties, location, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SiteRecoveryMigrationItemData(id, name, resourceType, systemData, properties, location, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new CurrentJobDetails(jobName, jobId, startOn, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new CriticalJobHistoryDetails(jobName, jobId, startOn, jobStatus, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MigrationRecoveryPointData(id, name, resourceType, systemData, properties, location, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MigrationRecoveryPointProperties(recoveryPointOn, recoveryPointType, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SiteRecoveryProtectableItemData(id, name, resourceType, systemData, properties, location, new Dictionary<string, BinaryData>());
        }
        ...
        public static SiteRecoveryProtectableItemProperties SiteRecoveryProtectableItemProperties(string friendlyName = null, string protectionStatus = null, ResourceIdentifier replicationProtectedItemId = null, ResourceIdentifier recoveryServicesProviderId = null, IEnumerable<string> protectionReadinessErrors = null, IEnumerable<string> supportedReplicationProviders = null, SiteRecoveryReplicationProviderSettings customDetails = null)
        {
            ...
            return new SiteRecoveryProtectableItemProperties(friendlyName, protectionStatus, replicationProtectedItemId, recoveryServicesProviderId, protectionReadinessErrors?.ToList(), supportedReplicationProviders?.ToList(), customDetails, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ReplicationProtectedItemData(id, name, resourceType, systemData, properties, location, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new CurrentScenarioDetails(scenarioName, jobId, startOn, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SiteRecoveryApplyRecoveryPointProperties(recoveryPointId, providerSpecificDetails, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SiteRecoveryPointData(id, name, resourceType, systemData, properties, location, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SiteRecoveryPointProperties(recoveryPointOn, recoveryPointType, providerSpecificDetails, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new TargetComputeSize(id, name, resourceType, systemData, properties, new Dictionary<string, BinaryData>());
        }
        ...
        public static TargetComputeSizeProperties TargetComputeSizeProperties(string name = null, string friendlyName = null, int? cpuCoresCount = null, int? vCpusAvailable = null, double? memoryInGB = null, int? maxDataDiskCount = null, int? maxNicsCount = null, IEnumerable<SiteRecoveryComputeSizeErrorDetails> errors = null, string highIopsSupported = null, IEnumerable<string> hyperVGenerations = null)
        {
            ...
            return new TargetComputeSizeProperties(name, friendlyName, cpuCoresCount, vCpusAvailable, memoryInGB, maxDataDiskCount, maxNicsCount, errors?.ToList(), highIopsSupported, hyperVGenerations?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SiteRecoveryComputeSizeErrorDetails(message, severity, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ProtectionContainerMappingData(id, name, resourceType, systemData, properties, location, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SiteRecoveryServicesProviderData(id, name, resourceType, systemData, properties, location, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new IdentityProviderDetails(tenantId, applicationId, objectId, audience, aadAuthority, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SiteRecoveryVersionDetails(version, expireOn, status, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SiteRecoveryAddRecoveryServicesProviderProperties(machineName, machineId, biosId, authenticationIdentityContent, resourceAccessIdentityContent, dataPlaneAuthenticationIdentityContent, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new StorageClassificationData(id, name, resourceType, systemData, storageClassificationFriendlyName != null ? new StorageClassificationProperties(storageClassificationFriendlyName, new Dictionary<string, BinaryData>()) : null, location, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new StorageClassificationMappingData(id, name, resourceType, systemData, targetStorageClassificationId != null ? new StorageClassificationMappingProperties(targetStorageClassificationId, new Dictionary<string, BinaryData>()) : null, location, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SiteRecoveryVCenterData(id, name, resourceType, systemData, properties, location, new Dictionary<string, BinaryData>());
        }
        ...
        public static SiteRecoveryVCenterProperties SiteRecoveryVCenterProperties(string friendlyName = null, string internalId = null, DateTimeOffset? lastHeartbeatReceivedOn = null, string discoveryStatus = null, Guid? processServerId = null, IPAddress ipAddress = null, string infrastructureId = null, string port = null, string runAsAccountId = null, string fabricArmResourceName = null, IEnumerable<SiteRecoveryHealthError> healthErrors = null)
        {
            ...
            return new SiteRecoveryVCenterProperties(friendlyName, internalId, lastHeartbeatReceivedOn, discoveryStatus, processServerId, ipAddress, infrastructureId, port, runAsAccountId, fabricArmResourceName, healthErrors?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SiteRecoveryJobData(id, name, resourceType, systemData, properties, location, new Dictionary<string, BinaryData>());
        }
        ...
        public static SiteRecoveryJobProperties SiteRecoveryJobProperties(string activityId = null, string scenarioName = null, string friendlyName = null, string state = null, string stateDescription = null, IEnumerable<AsrTask> tasks = null, IEnumerable<SiteRecoveryJobErrorDetails> errors = null, DateTimeOffset? startOn = null, DateTimeOffset? endOn = null, IEnumerable<string> allowedActions = null, string targetObjectId = null, string targetObjectName = null, string targetInstanceType = null, SiteRecoveryJobDetails customDetails = null)
        {
            ...
            return new SiteRecoveryJobProperties(activityId, scenarioName, friendlyName, state, stateDescription, tasks?.ToList(), errors?.ToList(), startOn, endOn, allowedActions?.ToList(), targetObjectId, targetObjectName, targetInstanceType, customDetails, new Dictionary<string, BinaryData>());
        }
        ...
        public static AsrTask AsrTask(string taskId = null, string name = null, DateTimeOffset? startOn = null, DateTimeOffset? endOn = null, IEnumerable<string> allowedActions = null, string friendlyName = null, string state = null, string stateDescription = null, string taskType = null, SiteRecoveryTaskTypeDetails customDetails = null, SiteRecoveryGroupTaskDetails groupTaskCustomDetails = null, IEnumerable<SiteRecoveryJobErrorDetails> errors = null)
        {
            ...
            return new AsrTask(taskId, name, startOn, endOn, allowedActions?.ToList(), friendlyName, state, stateDescription, taskType, customDetails, groupTaskCustomDetails, errors?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static SiteRecoveryGroupTaskDetails SiteRecoveryGroupTaskDetails(string instanceType = null, IEnumerable<AsrTask> childTasks = null)
        {
            ...
            return new UnknownGroupTaskDetails(instanceType, childTasks?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SiteRecoveryJobErrorDetails(serviceErrorDetails, providerErrorDetails, errorLevel, createdOn, taskId, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SiteRecoveryServiceError(code, message, possibleCauses, recommendedAction, activityId, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SiteRecoveryJobProviderError(errorCode, errorMessage, errorId, possibleCauses, recommendedAction, new Dictionary<string, BinaryData>());
        }
        ...
        public static SiteRecoveryJobDetails SiteRecoveryJobDetails(string instanceType = null, IReadOnlyDictionary<string, string> affectedObjectDetails = null)
        {
            ...
            return new UnknownJobDetails(instanceType, affectedObjectDetails, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SiteRecoveryPolicyData(id, name, resourceType, systemData, properties, location, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SiteRecoveryPolicyProperties(friendlyName, providerSpecificDetails, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ReplicationProtectionIntentData(id, name, resourceType, systemData, properties, location, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ReplicationProtectionIntentProperties(friendlyName, jobId, jobState, isActive, createdOn, providerSpecificDetails, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SiteRecoveryRecoveryPlanData(id, name, resourceType, systemData, properties, location, new Dictionary<string, BinaryData>());
        }
        ...
        public static SiteRecoveryRecoveryPlanProperties SiteRecoveryRecoveryPlanProperties(string friendlyName = null, ResourceIdentifier primaryFabricId = null, string primaryFabricFriendlyName = null, ResourceIdentifier recoveryFabricId = null, string recoveryFabricFriendlyName = null, string failoverDeploymentModel = null, IEnumerable<string> replicationProviders = null, IEnumerable<string> allowedOperations = null, DateTimeOffset? lastPlannedFailoverOn = null, DateTimeOffset? lastUnplannedFailoverOn = null, DateTimeOffset? lastTestFailoverOn = null, CurrentScenarioDetails currentScenario = null, string currentScenarioStatus = null, string currentScenarioStatusDescription = null, IEnumerable<SiteRecoveryPlanGroup> groups = null, IEnumerable<RecoveryPlanProviderSpecificDetails> providerSpecificDetails = null)
        {
            ...
            return new SiteRecoveryRecoveryPlanProperties(friendlyName, primaryFabricId, primaryFabricFriendlyName, recoveryFabricId, recoveryFabricFriendlyName, failoverDeploymentModel, replicationProviders?.ToList(), allowedOperations?.ToList(), lastPlannedFailoverOn, lastUnplannedFailoverOn, lastTestFailoverOn, currentScenario, currentScenarioStatus, currentScenarioStatusDescription, groups?.ToList(), providerSpecificDetails?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static SiteRecoveryCreateRecoveryPlanProperties SiteRecoveryCreateRecoveryPlanProperties(ResourceIdentifier primaryFabricId = null, ResourceIdentifier recoveryFabricId = null, FailoverDeploymentModel? failoverDeploymentModel = null, IEnumerable<SiteRecoveryPlanGroup> groups = null, IEnumerable<RecoveryPlanProviderSpecificContent> providerSpecificContent = null)
        {
            ...
            return new SiteRecoveryCreateRecoveryPlanProperties(primaryFabricId, recoveryFabricId, failoverDeploymentModel, groups?.ToList(), providerSpecificContent?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static RecoveryPlanPlannedFailoverProperties RecoveryPlanPlannedFailoverProperties(PossibleOperationsDirection failoverDirection = default, IEnumerable<RecoveryPlanProviderSpecificFailoverContent> providerSpecificDetails = null)
        {
            ...
            return new RecoveryPlanPlannedFailoverProperties(failoverDirection, providerSpecificDetails?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static RecoveryPlanTestFailoverProperties RecoveryPlanTestFailoverProperties(PossibleOperationsDirection failoverDirection = default, string networkType = null, ResourceIdentifier networkId = null, IEnumerable<RecoveryPlanProviderSpecificFailoverContent> providerSpecificDetails = null)
        {
            ...
            return new RecoveryPlanTestFailoverProperties(failoverDirection, networkType, networkId, providerSpecificDetails?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static RecoveryPlanUnplannedFailoverProperties RecoveryPlanUnplannedFailoverProperties(PossibleOperationsDirection failoverDirection = default, SourceSiteOperation sourceSiteOperation = default, IEnumerable<RecoveryPlanProviderSpecificFailoverContent> providerSpecificDetails = null)
        {
            ...
            return new RecoveryPlanUnplannedFailoverProperties(failoverDirection, sourceSiteOperation, providerSpecificDetails?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static SiteRecoverySupportedOperatingSystems SiteRecoverySupportedOperatingSystems(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IEnumerable<SiteRecoverySupportedOSProperty> supportedOSList = null, AzureLocation? location = null)
        {
            ...
            return new SiteRecoverySupportedOperatingSystems(id, name, resourceType, systemData, supportedOSList != null ? new SiteRecoverySupportedOSProperties(supportedOSList?.ToList(), new Dictionary<string, BinaryData>()) : null, location, new Dictionary<string, BinaryData>());
        }
        ...
        public static SiteRecoverySupportedOSProperty SiteRecoverySupportedOSProperty(string instanceType = null, IEnumerable<SiteRecoverySupportedOSDetails> supportedOS = null)
        {
            ...
            return new SiteRecoverySupportedOSProperty(instanceType, supportedOS?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static SiteRecoverySupportedOSDetails SiteRecoverySupportedOSDetails(string osName = null, string osType = null, IEnumerable<SiteRecoveryOSVersionWrapper> osVersions = null)
        {
            ...
            return new SiteRecoverySupportedOSDetails(osName, osType, osVersions?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SiteRecoveryOSVersionWrapper(version, servicePack, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new VaultHealthDetails(id, name, resourceType, systemData, properties, location, new Dictionary<string, BinaryData>());
        }
        ...
        public static VaultHealthProperties VaultHealthProperties(IEnumerable<SiteRecoveryHealthError> vaultErrors = null, ResourceHealthSummary protectedItemsHealth = null, ResourceHealthSummary fabricsHealth = null, ResourceHealthSummary containersHealth = null)
        {
            ...
            return new VaultHealthProperties(vaultErrors?.ToList(), protectedItemsHealth, fabricsHealth, containersHealth, new Dictionary<string, BinaryData>());
        }
        ...
        public static ResourceHealthSummary ResourceHealthSummary(int? resourceCount = null, IEnumerable<HealthErrorSummary> issues = null, IReadOnlyDictionary<string, int> categorizedResourceCounts = null)
        {
            ...
            return new ResourceHealthSummary(resourceCount, issues?.ToList(), categorizedResourceCounts, new Dictionary<string, BinaryData>());
        }
        ...
        public static HealthErrorSummary HealthErrorSummary(string summaryCode = null, HealthErrorCategory? category = null, SiteRecoveryErrorSeverity? severity = null, string summaryMessage = null, string affectedResourceType = null, string affectedResourceSubtype = null, IEnumerable<string> affectedResourceCorrelationIds = null)
        {
            ...
            return new HealthErrorSummary(summaryCode, category, severity, summaryMessage, affectedResourceType, affectedResourceSubtype, affectedResourceCorrelationIds?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SiteRecoveryVaultSettingData(id, name, resourceType, systemData, properties, location, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SiteRecoveryVaultSettingProperties(migrationSolutionId, vmwareToAzureProviderType, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new A2AVmManagedDiskDetails(diskId, primaryStagingAzureStorageAccountId, recoveryResourceGroupId, recoveryReplicaDiskAccountType, recoveryTargetDiskAccountType, recoveryDiskEncryptionSetId, diskEncryptionInfo, new Dictionary<string, BinaryData>());
        }
        ...
        public static A2ACreateProtectionIntentContent A2ACreateProtectionIntentContent(ResourceIdentifier fabricObjectId = null, AzureLocation primaryLocation = default, AzureLocation recoveryLocation = default, string recoverySubscriptionId = null, A2ARecoveryAvailabilityType recoveryAvailabilityType = default, ProtectionProfileCustomDetails protectionProfileCustomContent = null, ResourceIdentifier recoveryResourceGroupId = null, StorageAccountCustomDetails primaryStagingStorageAccountCustomContent = null, RecoveryAvailabilitySetCustomDetails recoveryAvailabilitySetCustomContent = null, RecoveryVirtualNetworkCustomDetails recoveryVirtualNetworkCustomContent = null, RecoveryProximityPlacementGroupCustomDetails recoveryProximityPlacementGroupCustomContent = null, AutoProtectionOfDataDisk? autoProtectionOfDataDisk = null, IEnumerable<A2AProtectionIntentDiskDetails> vmDisks = null, IEnumerable<A2AProtectionIntentManagedDiskDetails> vmManagedDisks = null, string multiVmGroupName = null, string multiVmGroupId = null, StorageAccountCustomDetails recoveryBootDiagStorageAccount = null, SiteRecoveryDiskEncryptionInfo diskEncryptionInfo = null, string recoveryAvailabilityZone = null, SiteRecoveryAgentAutoUpdateStatus? agentAutoUpdateStatus = null, AutomationAccountAuthenticationType? automationAccountAuthenticationType = null, ResourceIdentifier automationAccountArmId = null)
        {
            ...
            return new A2ACreateProtectionIntentContent("A2A", new Dictionary<string, BinaryData>(), fabricObjectId, primaryLocation, recoveryLocation, recoverySubscriptionId, recoveryAvailabilityType, protectionProfileCustomContent, recoveryResourceGroupId, primaryStagingStorageAccountCustomContent, recoveryAvailabilitySetCustomContent, recoveryVirtualNetworkCustomContent, recoveryProximityPlacementGroupCustomContent, autoProtectionOfDataDisk, vmDisks?.ToList(), vmManagedDisks?.ToList(), multiVmGroupName, multiVmGroupId, recoveryBootDiagStorageAccount, diskEncryptionInfo, recoveryAvailabilityZone, agentAutoUpdateStatus, automationAccountAuthenticationType, automationAccountArmId);
        }
        ...
        {
            return new A2ACrossClusterMigrationReplicationDetails("A2ACrossClusterMigration", new Dictionary<string, BinaryData>(), fabricObjectId, primaryFabricLocation, osType, vmProtectionState, vmProtectionStateDescription, lifecycleId);
        }
        ...
        {
            return new A2AEventDetails("A2A", new Dictionary<string, BinaryData>(), protectedItemName, fabricObjectId, fabricName, fabricLocation, remoteFabricName, remoteFabricLocation);
        }
        ...
        {
            return new A2AExtendedLocationDetails(primaryExtendedLocation, recoveryExtendedLocation, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new A2APolicyCreationContent("A2A", new Dictionary<string, BinaryData>(), recoveryPointHistory, crashConsistentFrequencyInMinutes, appConsistentFrequencyInMinutes, multiVmSyncStatus);
        }
        ...
        {
            return new A2APolicyDetails("A2A", new Dictionary<string, BinaryData>(), recoveryPointThresholdInMinutes, recoveryPointHistory, appConsistentFrequencyInMinutes, multiVmSyncStatus, crashConsistentFrequencyInMinutes);
        }
        ...
        public static A2AProtectedDiskDetails A2AProtectedDiskDetails(Uri diskUri = null, ResourceIdentifier recoveryAzureStorageAccountId = null, ResourceIdentifier primaryDiskAzureStorageAccountId = null, Uri recoveryDiskUri = null, string diskName = null, long? diskCapacityInBytes = null, ResourceIdentifier primaryStagingAzureStorageAccountId = null, string diskType = null, bool? isResyncRequired = null, int? monitoringPercentageCompletion = null, string monitoringJobType = null, double? dataPendingInStagingStorageAccountInMB = null, double? dataPendingAtSourceAgentInMB = null, string diskState = null, IEnumerable<string> allowedDiskLevelOperation = null, bool? isDiskEncrypted = null, string secretIdentifier = null, ResourceIdentifier dekKeyVaultArmId = null, bool? isDiskKeyEncrypted = null, string keyIdentifier = null, ResourceIdentifier kekKeyVaultArmId = null, string failoverDiskName = null, string tfoDiskName = null)
        {
            ...
            return new A2AProtectedDiskDetails(diskUri, recoveryAzureStorageAccountId, primaryDiskAzureStorageAccountId, recoveryDiskUri, diskName, diskCapacityInBytes, primaryStagingAzureStorageAccountId, diskType, isResyncRequired, monitoringPercentageCompletion, monitoringJobType, dataPendingInStagingStorageAccountInMB, dataPendingAtSourceAgentInMB, diskState, allowedDiskLevelOperation?.ToList(), isDiskEncrypted, secretIdentifier, dekKeyVaultArmId, isDiskKeyEncrypted, keyIdentifier, kekKeyVaultArmId, failoverDiskName, tfoDiskName, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new A2AProtectionContainerMappingDetails("A2A", new Dictionary<string, BinaryData>(), agentAutoUpdateStatus, automationAccountArmId, automationAccountAuthenticationType, scheduleName, jobScheduleName);
        }
        ...
        public static A2ARecoveryPointDetails A2ARecoveryPointDetails(RecoveryPointSyncType? recoveryPointSyncType = null, IEnumerable<string> disks = null)
        {
            ...
            return new A2ARecoveryPointDetails("A2A", new Dictionary<string, BinaryData>(), recoveryPointSyncType, disks?.ToList());
        }
        ...
        {
            return new A2AUnprotectedDiskDetails(diskLunId, diskAutoProtectionStatus, new Dictionary<string, BinaryData>());
        }
        ...
        public static HyperVIPConfigDetails HyperVIPConfigDetails(string name = null, bool? isPrimary = null, string subnetName = null, IPAddress staticIPAddress = null, string ipAddressType = null, bool? isSeletedForFailover = null, string recoverySubnetName = null, IPAddress recoveryStaticIPAddress = null, string recoveryIPAddressType = null, ResourceIdentifier recoveryPublicIPAddressId = null, IEnumerable<string> recoveryLBBackendAddressPoolIds = null, string tfoSubnetName = null, IPAddress tfoStaticIPAddress = null, ResourceIdentifier tfoPublicIPAddressId = null, IEnumerable<string> tfoLBBackendAddressPoolIds = null)
        {
            ...
            return new HyperVIPConfigDetails(name, isPrimary, subnetName, staticIPAddress, ipAddressType, isSeletedForFailover, recoverySubnetName, recoveryStaticIPAddress, recoveryIPAddressType, recoveryPublicIPAddressId, recoveryLBBackendAddressPoolIds?.ToList(), tfoSubnetName, tfoStaticIPAddress, tfoPublicIPAddressId, tfoLBBackendAddressPoolIds?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static A2AVmSyncedConfigDetails A2AVmSyncedConfigDetails(IReadOnlyDictionary<string, string> tags = null, IEnumerable<SiteRecoveryVmEndpoint> vmEndpoints = null)
        {
            ...
            return new A2AVmSyncedConfigDetails(tags, vmEndpoints?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SiteRecoveryVmEndpoint(endpointName, privatePort, publicPort, protocol, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new A2AZoneDetails(source, target, new Dictionary<string, BinaryData>());
        }
        ...
        public static SiteRecoveryAgentDetails SiteRecoveryAgentDetails(string agentId = null, string machineId = null, string biosId = null, string fqdn = null, IEnumerable<SiteRecoveryAgentDiskDetails> disks = null)
        {
            ...
            return new SiteRecoveryAgentDetails(agentId, machineId, biosId, fqdn, disks?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SiteRecoveryAgentDiskDetails(diskId, diskName, isOSDisk, capacityInBytes, lunId, new Dictionary<string, BinaryData>());
        }
        ...
        public static ApplianceMonitoringDetails ApplianceMonitoringDetails(ApplianceResourceDetails cpuDetails = null, ApplianceResourceDetails ramDetails = null, IEnumerable<DataStoreUtilizationDetails> datastoreSnapshot = null, ApplianceResourceDetails disksReplicationDetails = null, ApplianceResourceDetails esxiNfcBuffer = null, ApplianceResourceDetails networkBandwidth = null)
        {
            ...
            return new ApplianceMonitoringDetails(cpuDetails, ramDetails, datastoreSnapshot?.ToList(), disksReplicationDetails, esxiNfcBuffer, networkBandwidth, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ApplianceResourceDetails(capacity, processUtilization, totalUtilization, status, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DataStoreUtilizationDetails(totalSnapshotsSupported, totalSnapshotsCreated, dataStoreName, new Dictionary<string, BinaryData>());
        }
        ...
        public static AsrJobDetails AsrJobDetails(IReadOnlyDictionary<string, string> affectedObjectDetails = null)
        {
            ...
            return new AsrJobDetails("AsrJobDetails", affectedObjectDetails, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AutomationRunbookTaskDetails("AutomationRunbookTaskDetails", new Dictionary<string, BinaryData>(), name, cloudServiceName, subscriptionId, accountName, runbookId, runbookName, jobId, jobOutput, isPrimarySideScript);
        }
        ...
        public static SiteRecoveryFabricProviderSpecificDetails SiteRecoveryFabricProviderSpecificDetails(AzureLocation? location = null, IEnumerable<ResourceIdentifier> containerIds = null, IEnumerable<A2AZoneDetails> zones = null, IEnumerable<A2AExtendedLocationDetails> extendedLocations = null, IEnumerable<A2AFabricSpecificLocationDetails> locationDetails = null)
        {
            ...
            return new SiteRecoveryFabricProviderSpecificDetails("Azure", new Dictionary<string, BinaryData>(), location, containerIds?.ToList(), zones?.ToList(), extendedLocations?.ToList(), locationDetails?.ToList());
        }
        ...
        {
            return new A2ACreateNetworkMappingContent("AzureToAzure", new Dictionary<string, BinaryData>(), primaryNetworkId);
        }
        ...
        {
            return new A2ANetworkMappingSettings("AzureToAzure", new Dictionary<string, BinaryData>(), primaryFabricLocation, recoveryFabricLocation);
        }
        ...
        {
            return new SiteRecoveryVmDiskDetails(vhdType, vhdId, diskId, vhdName, maxSizeMB, targetDiskLocation, targetDiskName, lunId, diskEncryptionSetId, customTargetDiskName, new Dictionary<string, BinaryData>());
        }
        ...
        public static ConsistencyCheckTaskDetails ConsistencyCheckTaskDetails(IEnumerable<InconsistentVmDetails> vmDetails = null)
        {
            ...
            return new ConsistencyCheckTaskDetails("ConsistencyCheckTaskDetails", new Dictionary<string, BinaryData>(), vmDetails?.ToList());
        }
        ...
        public static InconsistentVmDetails InconsistentVmDetails(string vmName = null, string cloudName = null, IEnumerable<string> details = null, IEnumerable<string> errorIds = null)
        {
            ...
            return new InconsistentVmDetails(vmName, cloudName, details?.ToList(), errorIds?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SiteRecoveryDataStore(symbolicName, uuid, capacity, freeSpace, dataStoreType, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SiteRecoveryDiskDetails(maxSizeMB, vhdType, vhdId, vhdName, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SiteRecoveryDiskVolumeDetails(label, name, new Dictionary<string, BinaryData>());
        }
        ...
        public static SiteRecoveryDraDetails SiteRecoveryDraDetails(string id = null, string name = null, string biosId = null, string version = null, DateTimeOffset? lastHeartbeatReceivedOn = null, SiteRecoveryProtectionHealth? health = null, IEnumerable<SiteRecoveryHealthError> healthErrors = null, int? forwardProtectedItemCount = null, int? reverseProtectedItemCount = null)
        {
            ...
            return new SiteRecoveryDraDetails(id, name, biosId, version, lastHeartbeatReceivedOn, health, healthErrors?.ToList(), forwardProtectedItemCount, reverseProtectedItemCount, new Dictionary<string, BinaryData>());
        }
        ...
        public static ExportJobDetails ExportJobDetails(IReadOnlyDictionary<string, string> affectedObjectDetails = null, Uri blobUri = null, string sasToken = null)
        {
            ...
            return new ExportJobDetails("ExportJobDetails", affectedObjectDetails, new Dictionary<string, BinaryData>(), blobUri, sasToken);
        }
        ...
        {
            return new FabricReplicationGroupTaskDetails("FabricReplicationGroupTaskDetails", new Dictionary<string, BinaryData>(), jobTask, skippedReason, skippedReasonString);
        }
        ...
        {
            return new SiteRecoveryJobTaskDetails("JobTaskDetails", new Dictionary<string, BinaryData>(), jobTask);
        }
        ...
        {
            return new SiteRecoveryJobEntity(jobId, jobFriendlyName, targetObjectId, targetObjectName, targetInstanceType, jobScenarioName, new Dictionary<string, BinaryData>());
        }
        ...
        public static FailoverJobDetails FailoverJobDetails(IReadOnlyDictionary<string, string> affectedObjectDetails = null, IEnumerable<FailoverReplicationProtectedItemDetails> protectedItemDetails = null)
        {
            ...
            return new FailoverJobDetails("FailoverJobDetails", affectedObjectDetails, new Dictionary<string, BinaryData>(), protectedItemDetails?.ToList());
        }
        ...
        {
            return new FailoverReplicationProtectedItemDetails(name, friendlyName, testVmName, testVmFriendlyName, networkConnectionStatus, networkFriendlyName, subnet, recoveryPointId, recoveryPointOn, new Dictionary<string, BinaryData>());
        }
        ...
        public static GatewayOperationDetails GatewayOperationDetails(string state = null, int? progressPercentage = null, long? timeElapsed = null, long? timeRemaining = null, long? uploadSpeed = null, string hostName = null, IEnumerable<string> dataStores = null, long? vmwareReadThroughput = null)
        {
            ...
            return new GatewayOperationDetails(state, progressPercentage, timeElapsed, timeRemaining, uploadSpeed, hostName, dataStores?.ToList(), vmwareReadThroughput, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new HyperVHostDetails(id, name, marsAgentVersion, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new HyperVReplica2012EventDetails("HyperVReplica2012", new Dictionary<string, BinaryData>(), containerName, fabricName, remoteContainerName, remoteFabricName);
        }
        ...
        {
            return new HyperVReplica2012R2EventDetails("HyperVReplica2012R2", new Dictionary<string, BinaryData>(), containerName, fabricName, remoteContainerName, remoteFabricName);
        }
        ...
        {
            return new HyperVReplicaAzureEventDetails("HyperVReplicaAzure", new Dictionary<string, BinaryData>(), containerName, fabricName, remoteContainerName);
        }
        ...
        {
            return new HyperVReplicaAzureManagedDiskDetails(diskId, seedManagedDiskId, replicaDiskType, diskEncryptionSetId, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new HyperVReplicaAzurePolicyDetails("HyperVReplicaAzure", new Dictionary<string, BinaryData>(), recoveryPointHistoryDurationInHours, applicationConsistentSnapshotFrequencyInHours, replicationInterval, onlineReplicationStartTime, encryption, activeStorageAccountId);
        }
        ...
        {
            return new InitialReplicationDetails(initialReplicationType, initialReplicationProgressPercentage, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SiteRecoveryOSDetails(osType, productType, osEdition, osVersion, osMajorVersion, osMinorVersion, new Dictionary<string, BinaryData>());
        }
        ...
        public static OSUpgradeSupportedVersions OSUpgradeSupportedVersions(string supportedSourceOSVersion = null, IEnumerable<string> supportedTargetOSVersions = null)
        {
            ...
            return new OSUpgradeSupportedVersions(supportedSourceOSVersion, supportedTargetOSVersions?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new UpdateDiskContent(diskId, targetDiskName, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new HyperVReplicaBaseEventDetails("HyperVReplicaBaseEventDetails", new Dictionary<string, BinaryData>(), containerName, fabricName, remoteContainerName, remoteFabricName);
        }
        ...
        public static HyperVReplicaBaseReplicationDetails HyperVReplicaBaseReplicationDetails(DateTimeOffset? lastReplicatedOn = null, IEnumerable<VmNicDetails> vmNics = null, string vmId = null, string vmProtectionState = null, string vmProtectionStateDescription = null, InitialReplicationDetails initialReplicationDetails = null, IEnumerable<SiteRecoveryDiskDetails> vmDiskDetails = null)
        {
            ...
            return new HyperVReplicaBaseReplicationDetails("HyperVReplicaBaseReplicationDetails", new Dictionary<string, BinaryData>(), lastReplicatedOn, vmNics?.ToList(), vmId, vmProtectionState, vmProtectionStateDescription, initialReplicationDetails, vmDiskDetails?.ToList());
        }
        ...
        public static HyperVReplicaBlueReplicationDetails HyperVReplicaBlueReplicationDetails(DateTimeOffset? lastReplicatedOn = null, IEnumerable<VmNicDetails> vmNics = null, string vmId = null, string vmProtectionState = null, string vmProtectionStateDescription = null, InitialReplicationDetails initialReplicationDetails = null, IEnumerable<SiteRecoveryDiskDetails> vmDiskDetails = null)
        {
            ...
            return new HyperVReplicaBlueReplicationDetails("HyperVReplica2012R2", new Dictionary<string, BinaryData>(), lastReplicatedOn, vmNics?.ToList(), vmId, vmProtectionState, vmProtectionStateDescription, initialReplicationDetails, vmDiskDetails?.ToList());
        }
        ...
        {
            return new HyperVReplicaPolicyDetails("HyperVReplica2012", new Dictionary<string, BinaryData>(), recoveryPoints, applicationConsistentSnapshotFrequencyInHours, compression, initialReplicationMethod, onlineReplicationStartTime, offlineReplicationImportPath, offlineReplicationExportPath, replicationPort, allowedAuthenticationType, replicaDeletionOption);
        }
        ...
        public static HyperVReplicaReplicationDetails HyperVReplicaReplicationDetails(DateTimeOffset? lastReplicatedOn = null, IEnumerable<VmNicDetails> vmNics = null, string vmId = null, string vmProtectionState = null, string vmProtectionStateDescription = null, InitialReplicationDetails initialReplicationDetails = null, IEnumerable<SiteRecoveryDiskDetails> vmDiskDetails = null)
        {
            ...
            return new HyperVReplicaReplicationDetails("HyperVReplica2012", new Dictionary<string, BinaryData>(), lastReplicatedOn, vmNics?.ToList(), vmId, vmProtectionState, vmProtectionStateDescription, initialReplicationDetails, vmDiskDetails?.ToList());
        }
        ...
        public static HyperVSiteDetails HyperVSiteDetails(IEnumerable<HyperVHostDetails> hyperVHosts = null)
        {
            ...
            return new HyperVSiteDetails("HyperVSite", new Dictionary<string, BinaryData>(), hyperVHosts?.ToList());
        }
        ...
        public static HyperVVmDetails HyperVVmDetails(string sourceItemId = null, string generation = null, SiteRecoveryOSDetails osDetails = null, IEnumerable<SiteRecoveryDiskDetails> diskDetails = null, HyperVVmDiskPresenceStatus? hasPhysicalDisk = null, HyperVVmDiskPresenceStatus? hasFibreChannelAdapter = null, HyperVVmDiskPresenceStatus? hasSharedVhd = null, string hyperVHostId = null)
        {
            ...
            return new HyperVVmDetails("HyperVVirtualMachine", new Dictionary<string, BinaryData>(), sourceItemId, generation, osDetails, diskDetails?.ToList(), hasPhysicalDisk, hasFibreChannelAdapter, hasSharedVhd, hyperVHostId);
        }
        ...
        public static InlineWorkflowTaskDetails InlineWorkflowTaskDetails(IEnumerable<AsrTask> childTasks = null, IEnumerable<string> workflowIds = null)
        {
            ...
            return new InlineWorkflowTaskDetails("InlineWorkflowTaskDetails", childTasks?.ToList(), new Dictionary<string, BinaryData>(), workflowIds?.ToList());
        }
        ...
        {
            return new InMageAgentDetails(agentVersion, agentUpdateStatus, postUpdateRebootStatus, agentExpireOn, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new InMageAzureV2EventDetails("InMageAzureV2", new Dictionary<string, BinaryData>(), eventType, category, component, correctiveAction, details, summary, siteName);
        }
        ...
        {
            return new InMageAzureV2ManagedDiskDetails(diskId, seedManagedDiskId, replicaDiskType, diskEncryptionSetId, targetDiskName, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new InMageAzureV2PolicyDetails("InMageAzureV2", new Dictionary<string, BinaryData>(), crashConsistentFrequencyInMinutes, recoveryPointThresholdInMinutes, recoveryPointHistory, appConsistentFrequencyInMinutes, multiVmSyncStatus);
        }
        ...
        {
            return new InMageAzureV2PolicyContent("InMageAzureV2", new Dictionary<string, BinaryData>(), recoveryPointThresholdInMinutes, recoveryPointHistory, crashConsistentFrequencyInMinutes, appConsistentFrequencyInMinutes, multiVmSyncStatus);
        }
        ...
        {
            return new InMageAzureV2RecoveryPointDetails("InMageAzureV2", new Dictionary<string, BinaryData>(), isMultiVmSyncPoint);
        }
        ...
        public static InMageAzureV2SwitchProviderBlockingErrorDetails InMageAzureV2SwitchProviderBlockingErrorDetails(string errorCode = null, string errorMessage = null, string possibleCauses = null, string recommendedAction = null, IReadOnlyDictionary<string, string> errorMessageParameters = null, IReadOnlyDictionary<string, string> errorTags = null)
        {
            ...
            return new InMageAzureV2SwitchProviderBlockingErrorDetails(errorCode, errorMessage, possibleCauses, recommendedAction, errorMessageParameters, errorTags, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new InMageAzureV2SwitchProviderDetails(targetVaultId, targetResourceId, targetFabricId, targetApplianceId, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new InMageAzureV2SwitchProviderContent("InMageAzureV2", new Dictionary<string, BinaryData>(), targetVaultId, targetFabricId, targetApplianceId);
        }
        ...
        {
            return new InMageBasePolicyDetails("InMageBasePolicyDetails", new Dictionary<string, BinaryData>(), recoveryPointThresholdInMinutes, recoveryPointHistory, appConsistentFrequencyInMinutes, multiVmSyncStatus);
        }
        ...
        public static InMageDiskDetails InMageDiskDetails(string diskId = null, string diskName = null, string diskSizeInMB = null, string diskType = null, string diskConfiguration = null, IEnumerable<SiteRecoveryDiskVolumeDetails> volumeList = null)
        {
            ...
            return new InMageDiskDetails(diskId, diskName, diskSizeInMB, diskType, diskConfiguration, volumeList?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static InMageEnableProtectionContent InMageEnableProtectionContent(string vmFriendlyName = null, string masterTargetId = null, Guid processServerId = default, string retentionDrive = null, string runAsAccountId = null, string multiVmGroupId = null, string multiVmGroupName = null, string datastoreName = null, InMageDiskExclusionContent diskExclusionContent = null, IEnumerable<string> disksToInclude = null)
        {
            ...
            return new InMageEnableProtectionContent("InMage", new Dictionary<string, BinaryData>(), vmFriendlyName, masterTargetId, processServerId, retentionDrive, runAsAccountId, multiVmGroupId, multiVmGroupName, datastoreName, diskExclusionContent, disksToInclude?.ToList());
        }
        ...
        public static InMageFabricSwitchProviderBlockingErrorDetails InMageFabricSwitchProviderBlockingErrorDetails(string errorCode = null, string errorMessage = null, string possibleCauses = null, string recommendedAction = null, IReadOnlyDictionary<string, string> errorMessageParameters = null, IReadOnlyDictionary<string, string> errorTags = null)
        {
            ...
            return new InMageFabricSwitchProviderBlockingErrorDetails(errorCode, errorMessage, possibleCauses, recommendedAction, errorMessageParameters, errorTags, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new InMagePolicyDetails("InMage", new Dictionary<string, BinaryData>(), recoveryPointThresholdInMinutes, recoveryPointHistory, appConsistentFrequencyInMinutes, multiVmSyncStatus);
        }
        ...
        {
            return new InMagePolicyContent("InMage", new Dictionary<string, BinaryData>(), recoveryPointThresholdInMinutes, recoveryPointHistory, appConsistentFrequencyInMinutes, multiVmSyncStatus);
        }
        ...
        public static InMageRcmAgentUpgradeBlockingErrorDetails InMageRcmAgentUpgradeBlockingErrorDetails(string errorCode = null, string errorMessage = null, string possibleCauses = null, string recommendedAction = null, IReadOnlyDictionary<string, string> errorMessageParameters = null, IReadOnlyDictionary<string, string> errorTags = null)
        {
            ...
            return new InMageRcmAgentUpgradeBlockingErrorDetails(errorCode, errorMessage, possibleCauses, recommendedAction, errorMessageParameters, errorTags, new Dictionary<string, BinaryData>());
        }
        ...
        public static InMageRcmApplianceDetails InMageRcmApplianceDetails(string id = null, string name = null, ResourceIdentifier fabricArmId = null, SiteRecoveryProcessServerDetails processServer = null, RcmProxyDetails rcmProxy = null, PushInstallerDetails pushInstaller = null, ReplicationAgentDetails replicationAgent = null, ReprotectAgentDetails reprotectAgent = null, MarsAgentDetails marsAgent = null, SiteRecoveryDraDetails dra = null, IEnumerable<InMageRcmFabricSwitchProviderBlockingErrorDetails> switchProviderBlockingErrorDetails = null)
        {
            ...
            return new InMageRcmApplianceDetails(id, name, fabricArmId, processServer, rcmProxy, pushInstaller, replicationAgent, reprotectAgent, marsAgent, dra, switchProviderBlockingErrorDetails?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static RcmProxyDetails RcmProxyDetails(string id = null, string name = null, string biosId = null, ResourceIdentifier fabricObjectId = null, string fqdn = null, string clientAuthenticationType = null, string version = null, DateTimeOffset? lastHeartbeatReceivedOn = null, SiteRecoveryProtectionHealth? health = null, IEnumerable<SiteRecoveryHealthError> healthErrors = null)
        {
            ...
            return new RcmProxyDetails(id, name, biosId, fabricObjectId, fqdn, clientAuthenticationType, version, lastHeartbeatReceivedOn, health, healthErrors?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static PushInstallerDetails PushInstallerDetails(string id = null, string name = null, string biosId = null, ResourceIdentifier fabricObjectId = null, string fqdn = null, string version = null, DateTimeOffset? lastHeartbeatReceivedOn = null, SiteRecoveryProtectionHealth? health = null, IEnumerable<SiteRecoveryHealthError> healthErrors = null)
        {
            ...
            return new PushInstallerDetails(id, name, biosId, fabricObjectId, fqdn, version, lastHeartbeatReceivedOn, health, healthErrors?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static ReplicationAgentDetails ReplicationAgentDetails(string id = null, string name = null, string biosId = null, ResourceIdentifier fabricObjectId = null, string fqdn = null, string version = null, DateTimeOffset? lastHeartbeatUtc = null, SiteRecoveryProtectionHealth? health = null, IEnumerable<SiteRecoveryHealthError> healthErrors = null)
        {
            ...
            return new ReplicationAgentDetails(id, name, biosId, fabricObjectId, fqdn, version, lastHeartbeatUtc, health, healthErrors?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static ReprotectAgentDetails ReprotectAgentDetails(string id = null, string name = null, string biosId = null, ResourceIdentifier fabricObjectId = null, string fqdn = null, string version = null, DateTimeOffset? lastHeartbeatReceivedOn = null, SiteRecoveryProtectionHealth? health = null, IEnumerable<SiteRecoveryHealthError> healthErrors = null, int? protectedItemCount = null, IEnumerable<string> accessibleDatastores = null, string vCenterId = null, DateTimeOffset? last = null)
        {
            ...
            return new ReprotectAgentDetails(id, name, biosId, fabricObjectId, fqdn, version, lastHeartbeatReceivedOn, health, healthErrors?.ToList(), protectedItemCount, accessibleDatastores?.ToList(), vCenterId, last, new Dictionary<string, BinaryData>());
        }
        ...
        public static MarsAgentDetails MarsAgentDetails(string id = null, string name = null, string biosId = null, ResourceIdentifier fabricObjectId = null, string fqdn = null, string version = null, DateTimeOffset? lastHeartbeatReceivedOn = null, SiteRecoveryProtectionHealth? health = null, IEnumerable<SiteRecoveryHealthError> healthErrors = null)
        {
            ...
            return new MarsAgentDetails(id, name, biosId, fabricObjectId, fqdn, version, lastHeartbeatReceivedOn, health, healthErrors?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static InMageRcmFabricSwitchProviderBlockingErrorDetails InMageRcmFabricSwitchProviderBlockingErrorDetails(string errorCode = null, string errorMessage = null, string possibleCauses = null, string recommendedAction = null, IReadOnlyDictionary<string, string> errorMessageParameters = null, IReadOnlyDictionary<string, string> errorTags = null)
        {
            ...
            return new InMageRcmFabricSwitchProviderBlockingErrorDetails(errorCode, errorMessage, possibleCauses, recommendedAction, errorMessageParameters, errorTags, new Dictionary<string, BinaryData>());
        }
        ...
        public static InMageRcmApplianceSpecificDetails InMageRcmApplianceSpecificDetails(IEnumerable<InMageRcmApplianceDetails> appliances = null)
        {
            ...
            return new InMageRcmApplianceSpecificDetails("InMageRcm", new Dictionary<string, BinaryData>(), appliances?.ToList());
        }
        ...
        {
            return new InMageRcmApplyRecoveryPointContent("InMageRcm", new Dictionary<string, BinaryData>(), recoveryPointId);
        }
        ...
        public static InMageRcmDiscoveredProtectedVmDetails InMageRcmDiscoveredProtectedVmDetails(string vCenterId = null, string vCenterFqdn = null, IEnumerable<string> datastores = null, IEnumerable<IPAddress> ipAddresses = null, string vmwareToolsStatus = null, string powerStatus = null, string vmFqdn = null, string osName = null, DateTimeOffset? createdOn = null, DateTimeOffset? updatedOn = null, bool? isDeleted = null, DateTimeOffset? lastDiscoveryTimeInUtc = null)
        {
            ...
            return new InMageRcmDiscoveredProtectedVmDetails(vCenterId, vCenterFqdn, datastores?.ToList(), ipAddresses?.ToList(), vmwareToolsStatus, powerStatus, vmFqdn, osName, createdOn, updatedOn, isDeleted, lastDiscoveryTimeInUtc, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new InMageRcmDiskContent(diskId, logStorageAccountId, diskType, diskEncryptionSetId, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new InMageRcmDisksDefaultContent(logStorageAccountId, diskType, diskEncryptionSetId, new Dictionary<string, BinaryData>());
        }
        ...
        public static InMageRcmEnableProtectionContent InMageRcmEnableProtectionContent(string fabricDiscoveryMachineId = null, IEnumerable<InMageRcmDiskContent> disksToInclude = null, InMageRcmDisksDefaultContent disksDefault = null, ResourceIdentifier targetResourceGroupId = null, ResourceIdentifier targetNetworkId = null, ResourceIdentifier testNetworkId = null, string targetSubnetName = null, string testSubnetName = null, string targetVmName = null, string targetVmSize = null, SiteRecoveryLicenseType? licenseType = null, ResourceIdentifier targetAvailabilitySetId = null, string targetAvailabilityZone = null, ResourceIdentifier targetProximityPlacementGroupId = null, ResourceIdentifier targetBootDiagnosticsStorageAccountId = null, string runAsAccountId = null, Guid processServerId = default, string multiVmGroupName = null)
        {
            ...
            return new InMageRcmEnableProtectionContent("InMageRcm", new Dictionary<string, BinaryData>(), fabricDiscoveryMachineId, disksToInclude?.ToList(), disksDefault, targetResourceGroupId, targetNetworkId, testNetworkId, targetSubnetName, testSubnetName, targetVmName, targetVmSize, licenseType, targetAvailabilitySetId, targetAvailabilityZone, targetProximityPlacementGroupId, targetBootDiagnosticsStorageAccountId, runAsAccountId, processServerId, multiVmGroupName);
        }
        ...
        {
            return new InMageRcmEventDetails("InMageRcm", new Dictionary<string, BinaryData>(), protectedItemName, vmName, latestAgentVersion, jobId, fabricName, applianceName, serverType, componentDisplayName);
        }
        ...
        {
            return new InMageRcmFabricCreationContent("InMageRcm", new Dictionary<string, BinaryData>(), vmwareSiteId, physicalSiteId, sourceAgentIdentity);
        }
        ...
        public static InMageRcmFailbackDiscoveredProtectedVmDetails InMageRcmFailbackDiscoveredProtectedVmDetails(string vCenterId = null, string vCenterFqdn = null, IEnumerable<string> datastores = null, IEnumerable<IPAddress> ipAddresses = null, string vmwareToolsStatus = null, string powerStatus = null, string vmFqdn = null, string osName = null, DateTimeOffset? createdOn = null, DateTimeOffset? updatedOn = null, bool? isDeleted = null, DateTimeOffset? lastDiscoveredOn = null)
        {
            ...
            return new InMageRcmFailbackDiscoveredProtectedVmDetails(vCenterId, vCenterFqdn, datastores?.ToList(), ipAddresses?.ToList(), vmwareToolsStatus, powerStatus, vmFqdn, osName, createdOn, updatedOn, isDeleted, lastDiscoveredOn, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new InMageRcmFailbackEventDetails("InMageRcmFailback", new Dictionary<string, BinaryData>(), protectedItemName, vmName, applianceName, serverType, componentDisplayName);
        }
        ...
        public static InMageRcmFailbackMobilityAgentDetails InMageRcmFailbackMobilityAgentDetails(string version = null, string latestVersion = null, string driverVersion = null, string latestUpgradableVersionWithoutReboot = null, DateTimeOffset? agentVersionExpireOn = null, DateTimeOffset? driverVersionExpireOn = null, DateTimeOffset? lastHeartbeatReceivedOn = null, IEnumerable<AgentUpgradeBlockedReason> reasonsBlockingUpgrade = null, string isUpgradeable = null)
        {
            ...
            return new InMageRcmFailbackMobilityAgentDetails(version, latestVersion, driverVersion, latestUpgradableVersionWithoutReboot, agentVersionExpireOn, driverVersionExpireOn, lastHeartbeatReceivedOn, reasonsBlockingUpgrade?.ToList(), isUpgradeable, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new InMageRcmFailbackNicDetails(macAddress, networkName, adapterType, sourceIPAddress, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new InMageRcmFailbackPlannedFailoverProviderContent("InMageRcmFailback", new Dictionary<string, BinaryData>(), recoveryPointType);
        }
        ...
        {
            return new InMageRcmFailbackPolicyDetails("InMageRcmFailback", new Dictionary<string, BinaryData>(), appConsistentFrequencyInMinutes, crashConsistentFrequencyInMinutes);
        }
        ...
        {
            return new InMageRcmFailbackProtectedDiskDetails(diskId, diskName, isOSDisk, capacityInBytes, diskUuid, dataPendingInLogDataStoreInMB, dataPendingAtSourceAgentInMB, isInitialReplicationComplete, irDetails, resyncDetails, lastSyncedOn, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new InMageRcmFailbackSyncDetails(progressHealth, transferredBytes, last15MinutesTransferredBytes, lastDataTransferOn, processedBytes, startOn, lastRefreshedOn, progressPercentage, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new InMageRcmFailbackReprotectContent("InMageRcmFailback", new Dictionary<string, BinaryData>(), processServerId, runAsAccountId, policyId);
        }
        ...
        public static InMageRcmLastAgentUpgradeErrorDetails InMageRcmLastAgentUpgradeErrorDetails(string errorCode = null, string errorMessage = null, string possibleCauses = null, string recommendedAction = null, IReadOnlyDictionary<string, string> errorMessageParameters = null, IReadOnlyDictionary<string, string> errorTags = null)
        {
            ...
            return new InMageRcmLastAgentUpgradeErrorDetails(errorCode, errorMessage, possibleCauses, recommendedAction, errorMessageParameters, errorTags, new Dictionary<string, BinaryData>());
        }
        ...
        public static InMageRcmMobilityAgentDetails InMageRcmMobilityAgentDetails(string version = null, string latestVersion = null, string latestAgentReleaseDate = null, string driverVersion = null, string latestUpgradableVersionWithoutReboot = null, DateTimeOffset? agentVersionExpireOn = null, DateTimeOffset? driverVersionExpireOn = null, DateTimeOffset? lastHeartbeatReceivedOn = null, IEnumerable<AgentUpgradeBlockedReason> reasonsBlockingUpgrade = null, string isUpgradeable = null)
        {
            ...
            return new InMageRcmMobilityAgentDetails(version, latestVersion, latestAgentReleaseDate, driverVersion, latestUpgradableVersionWithoutReboot, agentVersionExpireOn, driverVersionExpireOn, lastHeartbeatReceivedOn, reasonsBlockingUpgrade?.ToList(), isUpgradeable, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new InMageRcmNicDetails(nicId, isPrimaryNic, isSelectedForFailover, sourceIPAddress, sourceIPAddressType, sourceNetworkId, sourceSubnetName, targetIPAddress, targetIPAddressType, targetSubnetName, testSubnetName, testIPAddress, testIPAddressType, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new InMageRcmNicContent(nicId, isPrimaryNic, isSelectedForFailover, targetSubnetName, targetStaticIPAddress, testSubnetName, testStaticIPAddress, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new InMageRcmPolicyDetails("InMageRcm", new Dictionary<string, BinaryData>(), recoveryPointHistoryInMinutes, appConsistentFrequencyInMinutes, crashConsistentFrequencyInMinutes, enableMultiVmSync);
        }
        ...
        {
            return new InMageRcmProtectedDiskDetails(diskId, diskName, isOSDisk, capacityInBytes, logStorageAccountId, diskEncryptionSetId, seedManagedDiskId, seedBlobUri, targetManagedDiskId, diskType, dataPendingInLogDataStoreInMB, dataPendingAtSourceAgentInMB, isInitialReplicationComplete, irDetails, resyncDetails, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new InMageRcmSyncDetails(progressHealth, transferredBytes, last15MinutesTransferredBytes, lastDataTransferTimeUtc, processedBytes, staStartOn, lastRefreshedOn, progressPercentage, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new InMageRcmProtectionContainerMappingDetails("InMageRcm", new Dictionary<string, BinaryData>(), enableAgentAutoUpgrade);
        }
        ...
        {
            return new InMageRcmRecoveryPointDetails("InMageRcm", new Dictionary<string, BinaryData>(), isMultiVmSyncPoint);
        }
        ...
        {
            return new InMageRcmReprotectContent("InMageRcm", new Dictionary<string, BinaryData>(), reprotectAgentId, datastoreName, logStorageAccountId, policyId);
        }
        ...
        {
            return new InMageRcmUnplannedFailoverContent("InMageRcm", new Dictionary<string, BinaryData>(), performShutdown, recoveryPointId);
        }
        ...
        {
            return new InMageRcmUpdateContainerMappingContent("InMageRcm", new Dictionary<string, BinaryData>(), enableAgentAutoUpgrade);
        }
        ...
        {
            return new SiteRecoveryOSDiskDetails(osVhdId, osType, vhdName, new Dictionary<string, BinaryData>());
        }
        ...
        public static InMageReprotectContent InMageReprotectContent(string masterTargetId = null, Guid processServerId = default, string retentionDrive = null, string runAsAccountId = null, string datastoreName = null, InMageDiskExclusionContent diskExclusionContent = null, string profileId = null, IEnumerable<string> disksToInclude = null)
        {
            ...
            return new InMageReprotectContent("InMage", new Dictionary<string, BinaryData>(), masterTargetId, processServerId, retentionDrive, runAsAccountId, datastoreName, diskExclusionContent, profileId, disksToInclude?.ToList());
        }
        ...
        {
            return new SiteRecoveryJobStatusEventDetails("JobStatus", new Dictionary<string, BinaryData>(), jobId, jobFriendlyName, jobStatus, affectedObjectType);
        }
        ...
        {
            return new ManualActionTaskDetails("ManualActionTaskDetails", new Dictionary<string, BinaryData>(), name, instructions, observation);
        }
        ...
        {
            return new SiteRecoveryRetentionVolume(volumeName, capacityInBytes, freeSpaceInBytes, thresholdPercentage, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MobilityServiceUpdate(version, rebootStatus, osType, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new RecoveryPlanA2ADetails("A2A", new Dictionary<string, BinaryData>(), primaryZone, recoveryZone, primaryExtendedLocation, recoveryExtendedLocation);
        }
        ...
        {
            return new RecoveryPlanA2AFailoverContent("A2A", new Dictionary<string, BinaryData>(), recoveryPointType, cloudServiceCreationOption, multiVmSyncPointOption);
        }
        ...
        public static RecoveryPlanGroupTaskDetails RecoveryPlanGroupTaskDetails(IEnumerable<AsrTask> childTasks = null, string name = null, string groupId = null, string rpGroupType = null)
        {
            ...
            return new RecoveryPlanGroupTaskDetails("RecoveryPlanGroupTaskDetails", childTasks?.ToList(), new Dictionary<string, BinaryData>(), name, groupId, rpGroupType);
        }
        ...
        {
            return new RecoveryPlanHyperVReplicaAzureFailbackContent("HyperVReplicaAzureFailback", new Dictionary<string, BinaryData>(), dataSyncOption, recoveryVmCreationOption);
        }
        ...
        {
            return new RecoveryPlanInMageAzureV2FailoverContent("InMageAzureV2", new Dictionary<string, BinaryData>(), recoveryPointType, useMultiVmSyncPoint);
        }
        ...
        {
            return new RecoveryPlanInMageFailoverContent("InMage", new Dictionary<string, BinaryData>(), recoveryPointType);
        }
        ...
        {
            return new RecoveryPlanInMageRcmFailbackFailoverContent("InMageRcmFailback", new Dictionary<string, BinaryData>(), recoveryPointType, useMultiVmSyncPoint);
        }
        ...
        {
            return new RecoveryPlanInMageRcmFailoverContent("InMageRcm", new Dictionary<string, BinaryData>(), recoveryPointType, useMultiVmSyncPoint);
        }
        ...
        public static RecoveryPlanShutdownGroupTaskDetails RecoveryPlanShutdownGroupTaskDetails(IEnumerable<AsrTask> childTasks = null, string name = null, string groupId = null, string rpGroupType = null)
        {
            ...
            return new RecoveryPlanShutdownGroupTaskDetails("RecoveryPlanShutdownGroupTaskDetails", childTasks?.ToList(), new Dictionary<string, BinaryData>(), name, groupId, rpGroupType);
        }
        ...
        {
            return new SiteRecoveryRunAsAccount(accountId, accountName, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ScriptActionTaskDetails("ScriptActionTaskDetails", new Dictionary<string, BinaryData>(), name, path, output, isPrimarySideScript);
        }
        ...
        public static SwitchProtectionJobDetails SwitchProtectionJobDetails(IReadOnlyDictionary<string, string> affectedObjectDetails = null, ResourceIdentifier newReplicationProtectedItemId = null)
        {
            ...
            return new SwitchProtectionJobDetails("SwitchProtectionJobDetails", affectedObjectDetails, new Dictionary<string, BinaryData>(), newReplicationProtectedItemId);
        }
        ...
        public static TestFailoverJobDetails TestFailoverJobDetails(IReadOnlyDictionary<string, string> affectedObjectDetails = null, string testFailoverStatus = null, string comments = null, string networkName = null, string networkFriendlyName = null, string networkType = null, IEnumerable<FailoverReplicationProtectedItemDetails> protectedItemDetails = null)
        {
            ...
            return new TestFailoverJobDetails("TestFailoverJobDetails", affectedObjectDetails, new Dictionary<string, BinaryData>(), testFailoverStatus, comments, networkName, networkFriendlyName, networkType, protectedItemDetails?.ToList());
        }
        ...
        {
            return new SiteRecoveryVmTaskDetails("VirtualMachineTaskDetails", new Dictionary<string, BinaryData>(), jobTask, skippedReason, skippedReasonString);
        }
        ...
        public static VmmVmDetails VmmVmDetails(string sourceItemId = null, string generation = null, SiteRecoveryOSDetails osDetails = null, IEnumerable<SiteRecoveryDiskDetails> diskDetails = null, HyperVVmDiskPresenceStatus? hasPhysicalDisk = null, HyperVVmDiskPresenceStatus? hasFibreChannelAdapter = null, HyperVVmDiskPresenceStatus? hasSharedVhd = null, string hyperVHostId = null)
        {
            ...
            return new VmmVmDetails("VmmVirtualMachine", new Dictionary<string, BinaryData>(), sourceItemId, generation, osDetails, diskDetails?.ToList(), hasPhysicalDisk, hasFibreChannelAdapter, hasSharedVhd, hyperVHostId);
        }
        ...
        {
            return new VmNicUpdatesTaskDetails("VmNicUpdatesTaskDetails", new Dictionary<string, BinaryData>(), vmId, nicId, name);
        }
        ...
        {
            return new VMwareCbtContainerMappingContent("VMwareCbt", new Dictionary<string, BinaryData>(), keyVaultId, keyVaultUri, storageAccountId, storageAccountSasSecretName, serviceBusConnectionStringSecretName, targetLocation);
        }
        ...
        {
            return new VMwareCbtDiskContent(diskId, diskType, isOSDisk, logStorageAccountId, logStorageAccountSasSecretName, diskEncryptionSetId, new Dictionary<string, BinaryData>());
        }
        ...
        public static VMwareCbtEnableMigrationContent VMwareCbtEnableMigrationContent(ResourceIdentifier vmwareMachineId = null, IEnumerable<VMwareCbtDiskContent> disksToInclude = null, SiteRecoveryLicenseType? licenseType = null, SiteRecoverySqlServerLicenseType? sqlServerLicenseType = null, string performSqlBulkRegistration = null, ResourceIdentifier dataMoverRunAsAccountId = null, ResourceIdentifier snapshotRunAsAccountId = null, string targetVmName = null, string targetVmSize = null, ResourceIdentifier targetResourceGroupId = null, ResourceIdentifier targetNetworkId = null, ResourceIdentifier testNetworkId = null, string targetSubnetName = null, string testSubnetName = null, ResourceIdentifier targetAvailabilitySetId = null, string targetAvailabilityZone = null, ResourceIdentifier targetProximityPlacementGroupId = null, ResourceIdentifier confidentialVmKeyVaultId = null, VMwareCbtSecurityProfileProperties targetVmSecurityProfile = null, ResourceIdentifier targetBootDiagnosticsStorageAccountId = null, string performAutoResync = null, IDictionary<string, string> targetVmTags = null, IDictionary<string, string> seedDiskTags = null, IDictionary<string, string> targetDiskTags = null, IDictionary<string, string> targetNicTags = null)
        {
            ...
            return new VMwareCbtEnableMigrationContent("VMwareCbt", new Dictionary<string, BinaryData>(), vmwareMachineId, disksToInclude?.ToList(), licenseType, sqlServerLicenseType, performSqlBulkRegistration, dataMoverRunAsAccountId, snapshotRunAsAccountId, targetVmName, targetVmSize, targetResourceGroupId, targetNetworkId, testNetworkId, targetSubnetName, testSubnetName, targetAvailabilitySetId, targetAvailabilityZone, targetProximityPlacementGroupId, confidentialVmKeyVaultId, targetVmSecurityProfile, targetBootDiagnosticsStorageAccountId, performAutoResync, targetVmTags, seedDiskTags, targetDiskTags, targetNicTags);
        }
        ...
        {
            return new VMwareCbtEventDetails("VMwareCbt", new Dictionary<string, BinaryData>(), migrationItemName);
        }
        ...
        {
            return new VMwareCbtMigrateContent("VMwareCbt", new Dictionary<string, BinaryData>(), performShutdown, osUpgradeVersion);
        }
        ...
        {
            return new VMwareCbtNicDetails(nicId, isPrimaryNic, sourceIPAddress, sourceIPAddressType, sourceNetworkId, targetIPAddress, targetIPAddressType, targetSubnetName, testNetworkId, testSubnetName, testIPAddress, testIPAddressType, targetNicName, isSelectedForMigration, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new VMwareCbtNicContent(nicId, isPrimaryNic, targetSubnetName, targetStaticIPAddress, isSelectedForMigration, targetNicName, testSubnetName, testStaticIPAddress, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new VMwareCbtPolicyDetails("VMwareCbt", new Dictionary<string, BinaryData>(), recoveryPointHistoryInMinutes, appConsistentFrequencyInMinutes, crashConsistentFrequencyInMinutes);
        }
        ...
        public static VMwareCbtProtectionContainerMappingDetails VMwareCbtProtectionContainerMappingDetails(ResourceIdentifier keyVaultId = null, Uri keyVaultUri = null, ResourceIdentifier storageAccountId = null, string storageAccountSasSecretName = null, string serviceBusConnectionStringSecretName = null, string targetLocation = null, IReadOnlyDictionary<string, int> roleSizeToNicCountMap = null, IEnumerable<string> excludedSkus = null)
        {
            ...
            return new VMwareCbtProtectionContainerMappingDetails("VMwareCbt", new Dictionary<string, BinaryData>(), keyVaultId, keyVaultUri, storageAccountId, storageAccountSasSecretName, serviceBusConnectionStringSecretName, targetLocation, roleSizeToNicCountMap, excludedSkus?.ToList());
        }
        ...
        {
            return new VMwareCbtResyncContent("VMwareCbt", new Dictionary<string, BinaryData>(), skipCbtReset);
        }
        ...
        public static VMwareCbtTestMigrateContent VMwareCbtTestMigrateContent(ResourceIdentifier recoveryPointId = null, ResourceIdentifier networkId = null, IEnumerable<VMwareCbtNicContent> vmNics = null, string osUpgradeVersion = null)
        {
            ...
            return new VMwareCbtTestMigrateContent("VMwareCbt", new Dictionary<string, BinaryData>(), recoveryPointId, networkId, vmNics?.ToList(), osUpgradeVersion);
        }
        ...
        {
            return new VMwareCbtUpdateDiskContent(diskId, targetDiskName, isOSDisk, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new VMwareV2FabricCreationContent("VMwareV2", new Dictionary<string, BinaryData>(), vmwareSiteId, physicalSiteId, migrationSolutionId);
        }
        ...
        public static VMwareV2FabricSpecificDetails VMwareV2FabricSpecificDetails(ResourceIdentifier vmwareSiteId = null, ResourceIdentifier physicalSiteId = null, ResourceIdentifier migrationSolutionId = null, string serviceEndpoint = null, ResourceIdentifier serviceResourceId = null, string serviceContainerId = null, IEnumerable<SiteRecoveryProcessServerDetails> processServers = null)
        {
            ...
            return new VMwareV2FabricSpecificDetails("VMwareV2", new Dictionary<string, BinaryData>(), vmwareSiteId, physicalSiteId, migrationSolutionId, serviceEndpoint, serviceResourceId, serviceContainerId, processServers?.ToList());
        }
        ...
        public static VMwareVmDetails VMwareVmDetails(string agentGeneratedId = null, string agentInstalled = null, string osType = null, string agentVersion = null, IPAddress ipAddress = null, string poweredOn = null, string vCenterInfrastructureId = null, string discoveryType = null, IEnumerable<InMageDiskDetails> diskDetails = null, IEnumerable<SiteRecoveryHealthError> validationErrors = null)
        {
            ...
            return new VMwareVmDetails("VMwareVirtualMachine", new Dictionary<string, BinaryData>(), agentGeneratedId, agentInstalled, osType, agentVersion, ipAddress, poweredOn, vCenterInfrastructureId, discoveryType, diskDetails?.ToList(), validationErrors?.ToList());
        }
    }
}
