...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public static partial class ArmRecoveryServicesSiteRecoveryModelFactory
    {
        ...
        public static SiteRecoveryJobDetails SiteRecoveryJobDetails(string instanceType = null, IDictionary<string, string> affectedObjectDetails = null)
        {
        ...
        public static ResourceHealthSummary ResourceHealthSummary(int? resourceCount = null, IEnumerable<HealthErrorSummary> issues = null, IDictionary<string, int> categorizedResourceCounts = null)
        {
        ...
        public static A2AVmSyncedConfigDetails A2AVmSyncedConfigDetails(IDictionary<string, string> tags = null, IEnumerable<SiteRecoveryVmEndpoint> vmEndpoints = null)
        {
        ...
        public static AsrJobDetails AsrJobDetails(IDictionary<string, string> affectedObjectDetails = null)
        {
            affectedObjectDetails ??= new Dictionary<string, string>();
        ...
        public static ExportJobDetails ExportJobDetails(IDictionary<string, string> affectedObjectDetails = null, Uri blobUri = null, string sasToken = null)
        {
            affectedObjectDetails ??= new Dictionary<string, string>();
        ...
        public static FailoverJobDetails FailoverJobDetails(IDictionary<string, string> affectedObjectDetails = null, IEnumerable<FailoverReplicationProtectedItemDetails> protectedItemDetails = null)
        {
            affectedObjectDetails ??= new Dictionary<string, string>();
        ...
        public static InMageRcmAgentUpgradeBlockingErrorDetails InMageRcmAgentUpgradeBlockingErrorDetails(string errorCode = null, string errorMessage = null, string possibleCauses = null, string recommendedAction = null, IDictionary<string, string> errorMessageParameters = null, IDictionary<string, string> errorTags = null)
        {
            errorMessageParameters ??= new Dictionary<string, string>();
            errorTags ??= new Dictionary<string, string>();
        ...
        public static InMageRcmLastAgentUpgradeErrorDetails InMageRcmLastAgentUpgradeErrorDetails(string errorCode = null, string errorMessage = null, string possibleCauses = null, string recommendedAction = null, IDictionary<string, string> errorMessageParameters = null, IDictionary<string, string> errorTags = null)
        {
            errorMessageParameters ??= new Dictionary<string, string>();
            errorTags ??= new Dictionary<string, string>();
        ...
        public static SwitchProtectionJobDetails SwitchProtectionJobDetails(IDictionary<string, string> affectedObjectDetails = null, ResourceIdentifier newReplicationProtectedItemId = null)
        {
            affectedObjectDetails ??= new Dictionary<string, string>();
        ...
        public static TestFailoverJobDetails TestFailoverJobDetails(IDictionary<string, string> affectedObjectDetails = null, string testFailoverStatus = null, string comments = null, string networkName = null, string networkFriendlyName = null, string networkType = null, IEnumerable<FailoverReplicationProtectedItemDetails> protectedItemDetails = null)
        {
            affectedObjectDetails ??= new Dictionary<string, string>();
            protectedItemDetails ??= new List<FailoverReplicationProtectedItemDetails>();
        ...
        public static VMwareCbtMigrationDetails VMwareCbtMigrationDetails(ResourceIdentifier vmwareMachineId = null, string osType = null, string osName = null, string firmwareType = null, string targetGeneration = null, string licenseType = null, string sqlServerLicenseType = null, ResourceIdentifier dataMoverRunAsAccountId = null, ResourceIdentifier snapshotRunAsAccountId = null, ResourceIdentifier storageAccountId = null, string targetVmName = null, string targetVmSize = null, string targetLocation = null, ResourceIdentifier targetResourceGroupId = null, ResourceIdentifier targetAvailabilitySetId = null, string targetAvailabilityZone = null, ResourceIdentifier targetProximityPlacementGroupId = null, ResourceIdentifier confidentialVmKeyVaultId = null, VMwareCbtSecurityProfileProperties targetVmSecurityProfile = null, ResourceIdentifier targetBootDiagnosticsStorageAccountId = null, IDictionary<string, string> targetVmTags = null, IEnumerable<VMwareCbtProtectedDiskDetails> protectedDisks = null, ResourceIdentifier targetNetworkId = null, ResourceIdentifier testNetworkId = null, IEnumerable<VMwareCbtNicDetails> vmNics = null, IDictionary<string, string> targetNicTags = null, ResourceIdentifier migrationRecoveryPointId = null, DateTimeOffset? lastRecoveryPointReceived = null, ResourceIdentifier lastRecoveryPointId = null, int? initialSeedingProgressPercentage = null, int? migrationProgressPercentage = null, int? resyncProgressPercentage = null, int? resumeProgressPercentage = null, int? deltaSyncProgressPercentage = null, string isCheckSumResyncCycle = null, long? initialSeedingRetryCount = null, long? resyncRetryCount = null, long? resumeRetryCount = null, long? deltaSyncRetryCount = null, string resyncRequired = null, SiteRecoveryResyncState? resyncState = null, string performAutoResync = null, IDictionary<string, string> seedDiskTags = null, IDictionary<string, string> targetDiskTags = null, IEnumerable<string> supportedOSVersions = null, ApplianceMonitoringDetails applianceMonitoringDetails = null, GatewayOperationDetails gatewayOperationDetails = null, string operationName = null)
        {
            targetVmTags ??= new Dictionary<string, string>();
