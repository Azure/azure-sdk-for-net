...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public static partial class ArmRecoveryServicesSiteRecoveryModelFactory
    {
        ...
        {
            return new SiteRecoveryAlertData(id, name, resourceType, systemData, properties, location, default);
        }
        ...
        public static SiteRecoveryAlertProperties SiteRecoveryAlertProperties(string sendToOwners = null, IEnumerable<string> customEmailAddresses = null, string locale = null)
        {
            ...
            return new SiteRecoveryAlertProperties(sendToOwners, customEmailAddresses?.ToList(), locale, default);
        }
        ...
        {
            return new SiteRecoveryReplicationAppliance(siteRecoveryReplicationApplianceProviderSpecificDetails != null ? new SiteRecoveryReplicationApplianceProperties(siteRecoveryReplicationApplianceProviderSpecificDetails, new Dictionary<string, BinaryData>()) : null, default);
        }
        ...
        {
            return new ReplicationEligibilityResultData(id, name, resourceType, systemData, properties, default);
        }
        ...
        public static ReplicationEligibilityResultProperties ReplicationEligibilityResultProperties(string clientRequestId = null, IEnumerable<ReplicationEligibilityResultErrorInfo> errors = null)
        {
            ...
            return new ReplicationEligibilityResultProperties(clientRequestId, errors?.ToList(), default);
        }
        ...
        {
            return new ReplicationEligibilityResultErrorInfo(code, message, possibleCauses, recommendedAction, status, default);
        }

        /// <summary> Initializes a new instance of <see cref="SiteRecoveryEventData"/>. </summary>
        /// <param name="id"> The id. </param>
        /// <param name="name"> The name. </param>
        /// <param name="resourceType"> The resourceType. </param>
        /// <param name="systemData"> The systemData. </param>
        ...
        {
            return new SiteRecoveryEventData(id, name, resourceType, systemData, properties, location, default);
        }
        ...
        public static SiteRecoveryEventProperties SiteRecoveryEventProperties(string eventCode = null, string description = null, string eventType = null, string affectedObjectFriendlyName = null, string affectedObjectCorrelationId = null, string severity = null, DateTimeOffset? occurredOn = null, ResourceIdentifier fabricId = null, SiteRecoveryEventProviderSpecificDetails providerSpecificDetails = null, SiteRecoveryEventSpecificDetails eventSpecificDetails = null, IEnumerable<SiteRecoveryHealthError> healthErrors = null)
        {
            ...
            return new SiteRecoveryEventProperties(eventCode, description, eventType, affectedObjectFriendlyName, affectedObjectCorrelationId, severity, occurredOn, fabricId, providerSpecificDetails, eventSpecificDetails, healthErrors?.ToList(), default);
        }
        ...
        public static SiteRecoveryHealthError SiteRecoveryHealthError(IEnumerable<SiteRecoveryInnerHealthError> innerHealthErrors = null, string errorSource = null, string errorType = null, string errorLevel = null, string errorCategory = null, string errorCode = null, string summaryMessage = null, string errorMessage = null, string possibleCauses = null, string recommendedAction = null, DateTimeOffset? creationTimeUtc = null, string recoveryProviderErrorMessage = null, string entityId = null, string errorId = null, HealthErrorCustomerResolvability? customerResolvability = null)
        {
            ...
            return new SiteRecoveryHealthError(innerHealthErrors?.ToList(), errorSource, errorType, errorLevel, errorCategory, errorCode, summaryMessage, errorMessage, possibleCauses, recommendedAction, creationTimeUtc, recoveryProviderErrorMessage, entityId, errorId, customerResolvability, default);
        }
        ...
        {
            return new SiteRecoveryInnerHealthError(errorSource, errorType, errorLevel, errorCategory, errorCode, summaryMessage, errorMessage, possibleCauses, recommendedAction, createdOn, recoveryProviderErrorMessage, entityId, errorId, customerResolvability, default);
        }
        ...
        {
            return new SiteRecoveryFabricData(id, name, resourceType, systemData, properties, location, default);
        }
        ...
        public static SiteRecoveryFabricProperties SiteRecoveryFabricProperties(string friendlyName = null, SiteRecoveryEncryptionDetails encryptionDetails = null, SiteRecoveryEncryptionDetails rolloverEncryptionDetails = null, string internalIdentifier = null, string bcdrState = null, FabricSpecificDetails customDetails = null, IEnumerable<SiteRecoveryHealthError> healthErrorDetails = null, string health = null)
        {
            ...
            return new SiteRecoveryFabricProperties(friendlyName, encryptionDetails, rolloverEncryptionDetails, internalIdentifier, bcdrState, customDetails, healthErrorDetails?.ToList(), health, default);
        }
        ...
        {
            return new SiteRecoveryLogicalNetworkData(id, name, resourceType, systemData, properties, location, default);
        }
        ...
        {
            return new SiteRecoveryNetworkData(id, name, resourceType, systemData, properties, location, default);
        }
        ...
        public static SiteRecoveryNetworkProperties SiteRecoveryNetworkProperties(string fabricType = null, IEnumerable<SiteRecoverySubnet> subnets = null, string friendlyName = null, string networkType = null)
        {
            ...
            return new SiteRecoveryNetworkProperties(fabricType, subnets?.ToList(), friendlyName, networkType, default);
        }
        ...
        public static SiteRecoverySubnet SiteRecoverySubnet(string name = null, string friendlyName = null, IEnumerable<string> addressList = null)
        {
            ...
            return new SiteRecoverySubnet(name, friendlyName, addressList?.ToList(), default);
        }
        ...
        {
            return new SiteRecoveryNetworkMappingData(id, name, resourceType, systemData, properties, location, default);
        }
        ...
        {
            return new SiteRecoveryNetworkMappingProperties(state, primaryNetworkFriendlyName, primaryNetworkId, primaryFabricFriendlyName, recoveryNetworkFriendlyName, recoveryNetworkId, recoveryFabricArmId, recoveryFabricFriendlyName, fabricSpecificSettings, default);
        }
        ...
        {
            return new SiteRecoveryProtectionContainerData(id, name, resourceType, systemData, properties, location, default);
        }
        ...
        {
            return new SiteRecoveryProtectionContainerProperties(fabricFriendlyName, friendlyName, fabricType, protectedItemCount, pairingStatus, role, fabricSpecificDetailsInstanceType != null ? new ProtectionContainerFabricSpecificDetails(fabricSpecificDetailsInstanceType, new Dictionary<string, BinaryData>()) : null, default);
        }
        ...
        {
            return new SiteRecoveryMigrationItemData(id, name, resourceType, systemData, properties, location, default);
        }
        ...
        /// <summary> Initializes a new instance of <see cref="MigrationRecoveryPointData"/>. </summary>
        /// <param name="id"> The id. </param>
        /// <param name="name"> The name. </param>
        /// <param name="resourceType"> The resourceType. </param>
        /// <param name="systemData"> The systemData. </param>
        ...
        {
            return new MigrationRecoveryPointData(id, name, resourceType, systemData, properties, location, default);
        }
        ...
        {
            return new SiteRecoveryProtectableItemData(id, name, resourceType, systemData, properties, location, default);
        }
        ...
        public static SiteRecoveryProtectableItemProperties SiteRecoveryProtectableItemProperties(string friendlyName = null, string protectionStatus = null, ResourceIdentifier replicationProtectedItemId = null, ResourceIdentifier recoveryServicesProviderId = null, IEnumerable<string> protectionReadinessErrors = null, IEnumerable<string> supportedReplicationProviders = null, SiteRecoveryReplicationProviderSettings customDetails = null)
        {
            ...
            return new SiteRecoveryProtectableItemProperties(friendlyName, protectionStatus, replicationProtectedItemId, recoveryServicesProviderId, protectionReadinessErrors?.ToList(), supportedReplicationProviders?.ToList(), customDetails, default);
        }
        ...
        {
            return new ReplicationProtectedItemData(id, name, resourceType, systemData, properties, location, default);
        }
        ...
        {
            return new SiteRecoveryPointData(id, name, resourceType, systemData, properties, location, default);
        }
        ...
        {
            return new TargetComputeSize(id, name, resourceType, systemData, properties, default);
        }
        ...
        public static TargetComputeSizeProperties TargetComputeSizeProperties(string name = null, string friendlyName = null, int? cpuCoresCount = null, int? vCpusAvailable = null, double? memoryInGB = null, int? maxDataDiskCount = null, int? maxNicsCount = null, IEnumerable<SiteRecoveryComputeSizeErrorDetails> errors = null, string highIopsSupported = null, IEnumerable<string> hyperVGenerations = null)
        {
            ...
            return new TargetComputeSizeProperties(name, friendlyName, cpuCoresCount, vCpusAvailable, memoryInGB, maxDataDiskCount, maxNicsCount, errors?.ToList(), highIopsSupported, hyperVGenerations?.ToList(), default);
        }
        ...
        {
            return new ProtectionContainerMappingData(id, name, resourceType, systemData, properties, location, default);
        }
        ...
        public static ProtectionContainerMappingProperties ProtectionContainerMappingProperties(ResourceIdentifier targetProtectionContainerId = null, string targetProtectionContainerFriendlyName = null, ProtectionContainerMappingProviderSpecificDetails providerSpecificDetails = null, string health = null, IEnumerable<SiteRecoveryHealthError> healthErrorDetails = null, ResourceIdentifier policyId = null, string state = null, string sourceProtectionContainerFriendlyName = null, string sourceFabricFriendlyName = null, string targetFabricFriendlyName = null, string policyFriendlyName = null)
        {
            ...
            return new ProtectionContainerMappingProperties(targetProtectionContainerId, targetProtectionContainerFriendlyName, providerSpecificDetails, health, healthErrorDetails?.ToList(), policyId, state, sourceProtectionContainerFriendlyName, sourceFabricFriendlyName, targetFabricFriendlyName, policyFriendlyName, default);
        }
        ...
        {
            return new SiteRecoveryServicesProviderData(id, name, resourceType, systemData, properties, location, default);
        }
        ...
        {
            return new IdentityProviderDetails(tenantId, applicationId, objectId, audience, aadAuthority, default);
        }
        ...
        {
            return new SiteRecoveryAddRecoveryServicesProviderProperties(machineName, machineId, biosId, authenticationIdentityContent, resourceAccessIdentityContent, dataPlaneAuthenticationIdentityContent, default);
        }
        ...
        {
            return new StorageClassificationData(id, name, resourceType, systemData, storageClassificationFriendlyName != null ? new StorageClassificationProperties(storageClassificationFriendlyName, new Dictionary<string, BinaryData>()) : null, location, default);
        }
        ...
        {
            return new StorageClassificationMappingData(id, name, resourceType, systemData, targetStorageClassificationId != null ? new StorageClassificationMappingProperties(targetStorageClassificationId, new Dictionary<string, BinaryData>()) : null, location, default);
        }
        ...
        {
            return new SiteRecoveryVCenterData(id, name, resourceType, systemData, properties, location, default);
        }
        ...
        public static SiteRecoveryVCenterProperties SiteRecoveryVCenterProperties(string friendlyName = null, string internalId = null, DateTimeOffset? lastHeartbeatReceivedOn = null, string discoveryStatus = null, Guid? processServerId = null, IPAddress ipAddress = null, string infrastructureId = null, string port = null, string runAsAccountId = null, string fabricArmResourceName = null, IEnumerable<SiteRecoveryHealthError> healthErrors = null)
        {
            ...
            return new SiteRecoveryVCenterProperties(friendlyName, internalId, lastHeartbeatReceivedOn, discoveryStatus, processServerId, ipAddress, infrastructureId, port, runAsAccountId, fabricArmResourceName, healthErrors?.ToList(), default);
        }

        /// <summary> Initializes a new instance of <see cref="SiteRecoveryJobData"/>. </summary>
        /// <param name="id"> The id. </param>
        /// <param name="name"> The name. </param>
        /// <param name="resourceType"> The resourceType. </param>
        /// <param name="systemData"> The systemData. </param>
        ...
        {
            return new SiteRecoveryJobData(id, name, resourceType, systemData, properties, location, default);
        }
        ...
        public static SiteRecoveryJobProperties SiteRecoveryJobProperties(string activityId = null, string scenarioName = null, string friendlyName = null, string state = null, string stateDescription = null, IEnumerable<AsrTask> tasks = null, IEnumerable<SiteRecoveryJobErrorDetails> errors = null, DateTimeOffset? startOn = null, DateTimeOffset? endOn = null, IEnumerable<string> allowedActions = null, string targetObjectId = null, string targetObjectName = null, string targetInstanceType = null, SiteRecoveryJobDetails customDetails = null)
        {
            ...
            return new SiteRecoveryJobProperties(activityId, scenarioName, friendlyName, state, stateDescription, tasks?.ToList(), errors?.ToList(), startOn, endOn, allowedActions?.ToList(), targetObjectId, targetObjectName, targetInstanceType, customDetails, default);
        }
        ...
        public static AsrTask AsrTask(string taskId = null, string name = null, DateTimeOffset? startOn = null, DateTimeOffset? endOn = null, IEnumerable<string> allowedActions = null, string friendlyName = null, string state = null, string stateDescription = null, string taskType = null, SiteRecoveryTaskTypeDetails customDetails = null, SiteRecoveryGroupTaskDetails groupTaskCustomDetails = null, IEnumerable<SiteRecoveryJobErrorDetails> errors = null)
        {
            ...
            return new AsrTask(taskId, name, startOn, endOn, allowedActions?.ToList(), friendlyName, state, stateDescription, taskType, customDetails, groupTaskCustomDetails, errors?.ToList(), default);
        }
        ...
        public static SiteRecoveryGroupTaskDetails SiteRecoveryGroupTaskDetails(string instanceType = null, IEnumerable<AsrTask> childTasks = null)
        {
            ...
            return new UnknownGroupTaskDetails(instanceType, childTasks?.ToList(), default);
        }
        ...
        {
            return new SiteRecoveryJobErrorDetails(serviceErrorDetails, providerErrorDetails, errorLevel, createdOn, taskId, default);
        }
        ...
        {
            return new SiteRecoveryServiceError(code, message, possibleCauses, recommendedAction, activityId, default);
        }
        ...
        {
            return new SiteRecoveryJobProviderError(errorCode, errorMessage, errorId, possibleCauses, recommendedAction, default);
        }
        ...
        public static SiteRecoveryJobDetails SiteRecoveryJobDetails(string instanceType = null, IReadOnlyDictionary<string, string> affectedObjectDetails = null)
        {
            ...
            return new UnknownJobDetails(instanceType, affectedObjectDetails, default);
        }
        ...
        {
            return new SiteRecoveryPolicyData(id, name, resourceType, systemData, properties, location, default);
        }
        ...
        {
            return new ReplicationProtectionIntentData(id, name, resourceType, systemData, properties, location, default);
        }
        ...
        {
            return new ReplicationProtectionIntentProperties(friendlyName, jobId, jobState, isActive, createdOn, providerSpecificDetails, default);
        }
        ...
        {
            return new SiteRecoveryRecoveryPlanData(id, name, resourceType, systemData, properties, location, default);
        }
        ...
        public static SiteRecoveryRecoveryPlanProperties SiteRecoveryRecoveryPlanProperties(string friendlyName = null, ResourceIdentifier primaryFabricId = null, string primaryFabricFriendlyName = null, ResourceIdentifier recoveryFabricId = null, string recoveryFabricFriendlyName = null, string failoverDeploymentModel = null, IEnumerable<string> replicationProviders = null, IEnumerable<string> allowedOperations = null, DateTimeOffset? lastPlannedFailoverOn = null, DateTimeOffset? lastUnplannedFailoverOn = null, DateTimeOffset? lastTestFailoverOn = null, CurrentScenarioDetails currentScenario = null, string currentScenarioStatus = null, string currentScenarioStatusDescription = null, IEnumerable<SiteRecoveryPlanGroup> groups = null, IEnumerable<RecoveryPlanProviderSpecificDetails> providerSpecificDetails = null)
        {
            ...
            return new SiteRecoveryRecoveryPlanProperties(friendlyName, primaryFabricId, primaryFabricFriendlyName, recoveryFabricId, recoveryFabricFriendlyName, failoverDeploymentModel, replicationProviders?.ToList(), allowedOperations?.ToList(), lastPlannedFailoverOn, lastUnplannedFailoverOn, lastTestFailoverOn, currentScenario, currentScenarioStatus, currentScenarioStatusDescription, groups?.ToList(), providerSpecificDetails?.ToList(), default);
        }
        ...
        public static SiteRecoveryCreateRecoveryPlanProperties SiteRecoveryCreateRecoveryPlanProperties(ResourceIdentifier primaryFabricId = null, ResourceIdentifier recoveryFabricId = null, FailoverDeploymentModel? failoverDeploymentModel = null, IEnumerable<SiteRecoveryPlanGroup> groups = null, IEnumerable<RecoveryPlanProviderSpecificContent> providerSpecificContent = null)
        {
            ...
            return new SiteRecoveryCreateRecoveryPlanProperties(primaryFabricId, recoveryFabricId, failoverDeploymentModel, groups?.ToList(), providerSpecificContent?.ToList(), default);
        }
        ...
        public static RecoveryPlanPlannedFailoverProperties RecoveryPlanPlannedFailoverProperties(PossibleOperationsDirection failoverDirection = default, IEnumerable<RecoveryPlanProviderSpecificFailoverContent> providerSpecificDetails = null)
        {
            ...
            return new RecoveryPlanPlannedFailoverProperties(failoverDirection, providerSpecificDetails?.ToList(), default);
        }
        ...
        public static RecoveryPlanTestFailoverProperties RecoveryPlanTestFailoverProperties(PossibleOperationsDirection failoverDirection = default, string networkType = null, ResourceIdentifier networkId = null, IEnumerable<RecoveryPlanProviderSpecificFailoverContent> providerSpecificDetails = null)
        {
            ...
            return new RecoveryPlanTestFailoverProperties(failoverDirection, networkType, networkId, providerSpecificDetails?.ToList(), default);
        }
        ...
        public static RecoveryPlanUnplannedFailoverProperties RecoveryPlanUnplannedFailoverProperties(PossibleOperationsDirection failoverDirection = default, SourceSiteOperation sourceSiteOperation = default, IEnumerable<RecoveryPlanProviderSpecificFailoverContent> providerSpecificDetails = null)
        {
            ...
            return new RecoveryPlanUnplannedFailoverProperties(failoverDirection, sourceSiteOperation, providerSpecificDetails?.ToList(), default);
        }
        ...
        public static SiteRecoverySupportedOperatingSystems SiteRecoverySupportedOperatingSystems(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IEnumerable<SiteRecoverySupportedOSProperty> supportedOSList = null, AzureLocation? location = null)
        {
            ...
            return new SiteRecoverySupportedOperatingSystems(id, name, resourceType, systemData, supportedOSList != null ? new SiteRecoverySupportedOSProperties(supportedOSList?.ToList(), new Dictionary<string, BinaryData>()) : null, location, default);
        }
        ...
        public static SiteRecoverySupportedOSProperty SiteRecoverySupportedOSProperty(string instanceType = null, IEnumerable<SiteRecoverySupportedOSDetails> supportedOS = null)
        {
            ...
            return new SiteRecoverySupportedOSProperty(instanceType, supportedOS?.ToList(), default);
        }
        ...
        public static SiteRecoverySupportedOSDetails SiteRecoverySupportedOSDetails(string osName = null, string osType = null, IEnumerable<SiteRecoveryOSVersionWrapper> osVersions = null)
        {
            ...
            return new SiteRecoverySupportedOSDetails(osName, osType, osVersions?.ToList(), default);
        }
        ...
        {
            return new VaultHealthDetails(id, name, resourceType, systemData, properties, location, default);
        }
        ...
        public static VaultHealthProperties VaultHealthProperties(IEnumerable<SiteRecoveryHealthError> vaultErrors = null, ResourceHealthSummary protectedItemsHealth = null, ResourceHealthSummary fabricsHealth = null, ResourceHealthSummary containersHealth = null)
        {
            ...
            return new VaultHealthProperties(vaultErrors?.ToList(), protectedItemsHealth, fabricsHealth, containersHealth, default);
        }
        ...
        public static ResourceHealthSummary ResourceHealthSummary(int? resourceCount = null, IEnumerable<HealthErrorSummary> issues = null, IReadOnlyDictionary<string, int> categorizedResourceCounts = null)
        {
            ...
            return new ResourceHealthSummary(resourceCount, issues?.ToList(), categorizedResourceCounts, default);
        }
        ...
        public static HealthErrorSummary HealthErrorSummary(string summaryCode = null, HealthErrorCategory? category = null, SiteRecoveryErrorSeverity? severity = null, string summaryMessage = null, string affectedResourceType = null, string affectedResourceSubtype = null, IEnumerable<string> affectedResourceCorrelationIds = null)
        {
            ...
            return new HealthErrorSummary(summaryCode, category, severity, summaryMessage, affectedResourceType, affectedResourceSubtype, affectedResourceCorrelationIds?.ToList(), default);
        }
        ...
        {
            return new SiteRecoveryVaultSettingData(id, name, resourceType, systemData, properties, location, default);
        }
        ...
        {
            return new A2AVmManagedDiskDetails(diskId, primaryStagingAzureStorageAccountId, recoveryResourceGroupId, recoveryReplicaDiskAccountType, recoveryTargetDiskAccountType, recoveryDiskEncryptionSetId, diskEncryptionInfo, default);
        }
        ...
        {
            return new A2ACrossClusterMigrationReplicationDetails("A2ACrossClusterMigration", fabricObjectId, primaryFabricLocation, osType, vmProtectionState, vmProtectionStateDescription, lifecycleId, default);
        }
        ...
        {
            return new A2AEventDetails("A2A", protectedItemName, fabricObjectId, fabricName, fabricLocation, remoteFabricName, remoteFabricLocation, default);
        }
        ...
        {
            return new A2APolicyCreationContent("A2A", recoveryPointHistory, crashConsistentFrequencyInMinutes, appConsistentFrequencyInMinutes, multiVmSyncStatus, default);
        }
        ...
        {
            return new A2APolicyDetails("A2A", recoveryPointThresholdInMinutes, recoveryPointHistory, appConsistentFrequencyInMinutes, multiVmSyncStatus, crashConsistentFrequencyInMinutes, default);
        }
        ...
        public static A2AProtectedDiskDetails A2AProtectedDiskDetails(Uri diskUri = null, ResourceIdentifier recoveryAzureStorageAccountId = null, ResourceIdentifier primaryDiskAzureStorageAccountId = null, Uri recoveryDiskUri = null, string diskName = null, long? diskCapacityInBytes = null, ResourceIdentifier primaryStagingAzureStorageAccountId = null, string diskType = null, bool? isResyncRequired = null, int? monitoringPercentageCompletion = null, string monitoringJobType = null, double? dataPendingInStagingStorageAccountInMB = null, double? dataPendingAtSourceAgentInMB = null, string diskState = null, IEnumerable<string> allowedDiskLevelOperation = null, bool? isDiskEncrypted = null, string secretIdentifier = null, ResourceIdentifier dekKeyVaultArmId = null, bool? isDiskKeyEncrypted = null, string keyIdentifier = null, ResourceIdentifier kekKeyVaultArmId = null, string failoverDiskName = null, string tfoDiskName = null)
        {
            ...
            return new A2AProtectedDiskDetails(diskUri, recoveryAzureStorageAccountId, primaryDiskAzureStorageAccountId, recoveryDiskUri, diskName, diskCapacityInBytes, primaryStagingAzureStorageAccountId, diskType, isResyncRequired, monitoringPercentageCompletion, monitoringJobType, dataPendingInStagingStorageAccountInMB, dataPendingAtSourceAgentInMB, diskState, allowedDiskLevelOperation?.ToList(), isDiskEncrypted, secretIdentifier, dekKeyVaultArmId, isDiskKeyEncrypted, keyIdentifier, kekKeyVaultArmId, failoverDiskName, tfoDiskName, default);
        }
        ...
        {
            return new A2AProtectionContainerMappingDetails("A2A", agentAutoUpdateStatus, automationAccountArmId, automationAccountAuthenticationType, scheduleName, jobScheduleName, default);
        }
        ...
        public static A2ARecoveryPointDetails A2ARecoveryPointDetails(RecoveryPointSyncType? recoveryPointSyncType = null, IEnumerable<string> disks = null)
        {
            ...
            return new A2ARecoveryPointDetails("A2A", recoveryPointSyncType, disks?.ToList(), default);
        }
        ...
        public static HyperVIPConfigDetails HyperVIPConfigDetails(string name = null, bool? isPrimary = null, string subnetName = null, IPAddress staticIPAddress = null, string ipAddressType = null, bool? isSeletedForFailover = null, string recoverySubnetName = null, IPAddress recoveryStaticIPAddress = null, string recoveryIPAddressType = null, ResourceIdentifier recoveryPublicIPAddressId = null, IEnumerable<string> recoveryLBBackendAddressPoolIds = null, string tfoSubnetName = null, IPAddress tfoStaticIPAddress = null, ResourceIdentifier tfoPublicIPAddressId = null, IEnumerable<string> tfoLBBackendAddressPoolIds = null)
        {
            ...
            return new HyperVIPConfigDetails(name, isPrimary, subnetName, staticIPAddress, ipAddressType, isSeletedForFailover, recoverySubnetName, recoveryStaticIPAddress, recoveryIPAddressType, recoveryPublicIPAddressId, recoveryLBBackendAddressPoolIds?.ToList(), tfoSubnetName, tfoStaticIPAddress, tfoPublicIPAddressId, tfoLBBackendAddressPoolIds?.ToList(), default);
        }
        ...
        public static A2AVmSyncedConfigDetails A2AVmSyncedConfigDetails(IReadOnlyDictionary<string, string> tags = null, IEnumerable<SiteRecoveryVmEndpoint> vmEndpoints = null)
        {
            ...
            return new A2AVmSyncedConfigDetails(tags, vmEndpoints?.ToList(), default);
        }
        ...
        public static SiteRecoveryAgentDetails SiteRecoveryAgentDetails(string agentId = null, string machineId = null, string biosId = null, string fqdn = null, IEnumerable<SiteRecoveryAgentDiskDetails> disks = null)
        {
            ...
            return new SiteRecoveryAgentDetails(agentId, machineId, biosId, fqdn, disks?.ToList(), default);
        }
        ...
        {
            return new SiteRecoveryAgentDiskDetails(diskId, diskName, isOSDisk, capacityInBytes, lunId, default);
        }
        ...
        public static AsrJobDetails AsrJobDetails(IReadOnlyDictionary<string, string> affectedObjectDetails = null)
        {
            ...
            return new AsrJobDetails("AsrJobDetails", affectedObjectDetails, default);
        }
        ...
        {
            return new AutomationRunbookTaskDetails("AutomationRunbookTaskDetails", name, cloudServiceName, subscriptionId, accountName, runbookId, runbookName, jobId, jobOutput, isPrimarySideScript, default);
        }
        ...
        public static SiteRecoveryFabricProviderSpecificDetails SiteRecoveryFabricProviderSpecificDetails(AzureLocation? location = null, IEnumerable<ResourceIdentifier> containerIds = null, IEnumerable<A2AZoneDetails> zones = null, IEnumerable<A2AExtendedLocationDetails> extendedLocations = null, IEnumerable<A2AFabricSpecificLocationDetails> locationDetails = null)
        {
            ...
            return new SiteRecoveryFabricProviderSpecificDetails("Azure", location, containerIds?.ToList(), zones?.ToList(), extendedLocations?.ToList(), locationDetails?.ToList(), default);
        }
        ...
        {
            return new A2ACreateNetworkMappingContent("AzureToAzure", primaryNetworkId, default);
        }
        ...
        {
            return new A2ANetworkMappingSettings("AzureToAzure", primaryFabricLocation, recoveryFabricLocation, default);
        }
        ...
        {
            return new SiteRecoveryVmDiskDetails(vhdType, vhdId, diskId, vhdName, maxSizeMB, targetDiskLocation, targetDiskName, lunId, diskEncryptionSetId, customTargetDiskName, default);
        }
        ...
        public static ConsistencyCheckTaskDetails ConsistencyCheckTaskDetails(IEnumerable<InconsistentVmDetails> vmDetails = null)
        {
            ...
            return new ConsistencyCheckTaskDetails("ConsistencyCheckTaskDetails", vmDetails?.ToList(), default);
        }
        ...
        public static InconsistentVmDetails InconsistentVmDetails(string vmName = null, string cloudName = null, IEnumerable<string> details = null, IEnumerable<string> errorIds = null)
        {
            ...
            return new InconsistentVmDetails(vmName, cloudName, details?.ToList(), errorIds?.ToList(), default);
        }
        ...
        {
            return new SiteRecoveryDataStore(symbolicName, uuid, capacity, freeSpace, dataStoreType, default);
        }
        ...
        public static SiteRecoveryDraDetails SiteRecoveryDraDetails(string id = null, string name = null, string biosId = null, string version = null, DateTimeOffset? lastHeartbeatReceivedOn = null, SiteRecoveryProtectionHealth? health = null, IEnumerable<SiteRecoveryHealthError> healthErrors = null, int? forwardProtectedItemCount = null, int? reverseProtectedItemCount = null)
        {
            ...
            return new SiteRecoveryDraDetails(id, name, biosId, version, lastHeartbeatReceivedOn, health, healthErrors?.ToList(), forwardProtectedItemCount, reverseProtectedItemCount, default);
        }
        ...
        public static ExportJobDetails ExportJobDetails(IReadOnlyDictionary<string, string> affectedObjectDetails = null, Uri blobUri = null, string sasToken = null)
        {
            ...
            return new ExportJobDetails("ExportJobDetails", affectedObjectDetails, blobUri, sasToken, default);
        }
        ...
        {
            return new FabricReplicationGroupTaskDetails("FabricReplicationGroupTaskDetails", jobTask, skippedReason, skippedReasonString, default);
        }
        ...
        {
            return new SiteRecoveryJobTaskDetails("JobTaskDetails", jobTask, default);
        }
        ...
        {
            return new SiteRecoveryJobEntity(jobId, jobFriendlyName, targetObjectId, targetObjectName, targetInstanceType, jobScenarioName, default);
        }
        ...
        public static FailoverJobDetails FailoverJobDetails(IReadOnlyDictionary<string, string> affectedObjectDetails = null, IEnumerable<FailoverReplicationProtectedItemDetails> protectedItemDetails = null)
        {
            ...
            return new FailoverJobDetails("FailoverJobDetails", affectedObjectDetails, protectedItemDetails?.ToList(), default);
        }
        ...
        {
            return new FailoverReplicationProtectedItemDetails(name, friendlyName, testVmName, testVmFriendlyName, networkConnectionStatus, networkFriendlyName, subnet, recoveryPointId, recoveryPointOn, default);
        }
        ...
        {
            return new HyperVReplica2012EventDetails("HyperVReplica2012", containerName, fabricName, remoteContainerName, remoteFabricName, default);
        }

        /// <summary> Initializes a new instance of <see cref="HyperVReplica2012R2EventDetails"/>. </summary>
        /// <param name="containerName"> The container friendly name. </param>
        /// <param name="fabricName"> The fabric friendly name. </param>
        /// <param name="remoteContainerName"> The remote container name. </param>
        /// <param name="remoteFabricName"> The remote fabric name. </param>
        ...
        {
            return new HyperVReplica2012R2EventDetails("HyperVReplica2012R2", containerName, fabricName, remoteContainerName, remoteFabricName, default);
        }
        ...
        {
            return new HyperVReplicaAzureEventDetails("HyperVReplicaAzure", containerName, fabricName, remoteContainerName, default);
        }
        ...
        {
            return new HyperVReplicaAzureManagedDiskDetails(diskId, seedManagedDiskId, replicaDiskType, diskEncryptionSetId, default);
        }
        ...
        {
            return new HyperVReplicaAzurePolicyDetails("HyperVReplicaAzure", recoveryPointHistoryDurationInHours, applicationConsistentSnapshotFrequencyInHours, replicationInterval, onlineReplicationStartTime, encryption, activeStorageAccountId, default);
        }
        ...
        {
            return new SiteRecoveryOSDetails(osType, productType, osEdition, osVersion, osMajorVersion, osMinorVersion, default);
        }
        ...
        {
            return new UpdateDiskContent(diskId, targetDiskName, default);
        }
        ...
        {
            return new HyperVReplicaBaseEventDetails("HyperVReplicaBaseEventDetails", containerName, fabricName, remoteContainerName, remoteFabricName, default);
        }
        ...
        {
            return new HyperVReplicaBasePolicyDetails("HyperVReplicaBasePolicyDetails", recoveryPoints, applicationConsistentSnapshotFrequencyInHours, compression, initialReplicationMethod, onlineReplicationStartTime, offlineReplicationImportPath, offlineReplicationExportPath, replicationPort, allowedAuthenticationType, replicaDeletionOption, default);
        }
        ...
        public static HyperVReplicaBaseReplicationDetails HyperVReplicaBaseReplicationDetails(DateTimeOffset? lastReplicatedOn = null, IEnumerable<VmNicDetails> vmNics = null, string vmId = null, string vmProtectionState = null, string vmProtectionStateDescription = null, InitialReplicationDetails initialReplicationDetails = null, IEnumerable<SiteRecoveryDiskDetails> vmDiskDetails = null)
        {
            ...
            return new HyperVReplicaBaseReplicationDetails("HyperVReplicaBaseReplicationDetails", lastReplicatedOn, vmNics?.ToList(), vmId, vmProtectionState, vmProtectionStateDescription, initialReplicationDetails, vmDiskDetails?.ToList(), default);
        }
        ...
        {
            return new HyperVReplicaBluePolicyDetails("HyperVReplica2012R2", replicationFrequencyInSeconds, recoveryPoints, applicationConsistentSnapshotFrequencyInHours, compression, initialReplicationMethod, onlineReplicationStartTime, offlineReplicationImportPath, offlineReplicationExportPath, replicationPort, allowedAuthenticationType, replicaDeletionOption, default);
        }
        ...
        public static HyperVReplicaBlueReplicationDetails HyperVReplicaBlueReplicationDetails(DateTimeOffset? lastReplicatedOn = null, IEnumerable<VmNicDetails> vmNics = null, string vmId = null, string vmProtectionState = null, string vmProtectionStateDescription = null, InitialReplicationDetails initialReplicationDetails = null, IEnumerable<SiteRecoveryDiskDetails> vmDiskDetails = null)
        {
            ...
            return new HyperVReplicaBlueReplicationDetails("HyperVReplica2012R2", lastReplicatedOn, vmNics?.ToList(), vmId, vmProtectionState, vmProtectionStateDescription, initialReplicationDetails, vmDiskDetails?.ToList(), default);
        }

        /// <summary> Initializes a new instance of <see cref="HyperVReplicaPolicyDetails"/>. </summary>
        /// <param name="recoveryPoints"> A value indicating the number of recovery points. </param>
        /// <param name="applicationConsistentSnapshotFrequencyInHours"> A value indicating the application consistent frequency. </param>
        /// <param name="compression"> A value indicating whether compression has to be enabled. </param>
        /// <param name="initialReplicationMethod"> A value indicating whether IR is online. </param>
        ...
        {
            return new HyperVReplicaPolicyDetails("HyperVReplica2012", recoveryPoints, applicationConsistentSnapshotFrequencyInHours, compression, initialReplicationMethod, onlineReplicationStartTime, offlineReplicationImportPath, offlineReplicationExportPath, replicationPort, allowedAuthenticationType, replicaDeletionOption, default);
        }

        /// <summary> Initializes a new instance of <see cref="HyperVReplicaReplicationDetails"/>. </summary>
        /// <param name="lastReplicatedOn"> The Last replication time. </param>
        /// <param name="vmNics"> The PE Network details. </param>
        /// <param name="vmId"> The virtual machine Id. </param>
        /// <param name="vmProtectionState"> The protection state for the vm. </param>
        ...
        public static HyperVReplicaReplicationDetails HyperVReplicaReplicationDetails(DateTimeOffset? lastReplicatedOn = null, IEnumerable<VmNicDetails> vmNics = null, string vmId = null, string vmProtectionState = null, string vmProtectionStateDescription = null, InitialReplicationDetails initialReplicationDetails = null, IEnumerable<SiteRecoveryDiskDetails> vmDiskDetails = null)
        {
            ...
            return new HyperVReplicaReplicationDetails("HyperVReplica2012", lastReplicatedOn, vmNics?.ToList(), vmId, vmProtectionState, vmProtectionStateDescription, initialReplicationDetails, vmDiskDetails?.ToList(), default);
        }
        ...
        public static HyperVSiteDetails HyperVSiteDetails(IEnumerable<HyperVHostDetails> hyperVHosts = null)
        {
            ...
            return new HyperVSiteDetails("HyperVSite", hyperVHosts?.ToList(), default);
        }
        ...
        public static HyperVVmDetails HyperVVmDetails(string sourceItemId = null, string generation = null, SiteRecoveryOSDetails osDetails = null, IEnumerable<SiteRecoveryDiskDetails> diskDetails = null, HyperVVmDiskPresenceStatus? hasPhysicalDisk = null, HyperVVmDiskPresenceStatus? hasFibreChannelAdapter = null, HyperVVmDiskPresenceStatus? hasSharedVhd = null, string hyperVHostId = null)
        {
            ...
            return new HyperVVmDetails("HyperVVirtualMachine", sourceItemId, generation, osDetails, diskDetails?.ToList(), hasPhysicalDisk, hasFibreChannelAdapter, hasSharedVhd, hyperVHostId, default);
        }
        ...
        public static InlineWorkflowTaskDetails InlineWorkflowTaskDetails(IEnumerable<AsrTask> childTasks = null, IEnumerable<string> workflowIds = null)
        {
            ...
            return new InlineWorkflowTaskDetails("InlineWorkflowTaskDetails", childTasks?.ToList(), workflowIds?.ToList(), default);
        }
        ...
        {
            return new InMageAzureV2EventDetails("InMageAzureV2", eventType, category, component, correctiveAction, details, summary, siteName, default);
        }
        ...
        {
            return new InMageAzureV2ManagedDiskDetails(diskId, seedManagedDiskId, replicaDiskType, diskEncryptionSetId, targetDiskName, default);
        }

        /// <summary> Initializes a new instance of <see cref="InMageAzureV2PolicyDetails"/>. </summary>
        /// <param name="crashConsistentFrequencyInMinutes"> The crash consistent snapshot frequency in minutes. </param>
        /// <param name="recoveryPointThresholdInMinutes"> The recovery point threshold in minutes. </param>
        /// <param name="recoveryPointHistory"> The duration in minutes until which the recovery points need to be stored. </param>
        /// <param name="appConsistentFrequencyInMinutes"> The app consistent snapshot frequency in minutes. </param>
        ...
        {
            return new InMageAzureV2PolicyDetails("InMageAzureV2", crashConsistentFrequencyInMinutes, recoveryPointThresholdInMinutes, recoveryPointHistory, appConsistentFrequencyInMinutes, multiVmSyncStatus, default);
        }
        ...
        {
            return new InMageAzureV2PolicyContent("InMageAzureV2", recoveryPointThresholdInMinutes, recoveryPointHistory, crashConsistentFrequencyInMinutes, appConsistentFrequencyInMinutes, multiVmSyncStatus, default);
        }
        ...
        {
            return new InMageAzureV2RecoveryPointDetails("InMageAzureV2", isMultiVmSyncPoint, default);
        }
        ...
        public static InMageAzureV2SwitchProviderBlockingErrorDetails InMageAzureV2SwitchProviderBlockingErrorDetails(string errorCode = null, string errorMessage = null, string possibleCauses = null, string recommendedAction = null, IReadOnlyDictionary<string, string> errorMessageParameters = null, IReadOnlyDictionary<string, string> errorTags = null)
        {
            ...
            return new InMageAzureV2SwitchProviderBlockingErrorDetails(errorCode, errorMessage, possibleCauses, recommendedAction, errorMessageParameters, errorTags, default);
        }
        ...
        {
            return new InMageAzureV2SwitchProviderContent("InMageAzureV2", targetVaultId, targetFabricId, targetApplianceId, default);
        }
        ...
        {
            return new InMageBasePolicyDetails("InMageBasePolicyDetails", recoveryPointThresholdInMinutes, recoveryPointHistory, appConsistentFrequencyInMinutes, multiVmSyncStatus, default);
        }
        ...
        public static InMageDiskDetails InMageDiskDetails(string diskId = null, string diskName = null, string diskSizeInMB = null, string diskType = null, string diskConfiguration = null, IEnumerable<SiteRecoveryDiskVolumeDetails> volumeList = null)
        {
            ...
            return new InMageDiskDetails(diskId, diskName, diskSizeInMB, diskType, diskConfiguration, volumeList?.ToList(), default);
        }
        ...
        public static InMageEnableProtectionContent InMageEnableProtectionContent(string vmFriendlyName = null, string masterTargetId = null, Guid processServerId = default, string retentionDrive = null, string runAsAccountId = null, string multiVmGroupId = null, string multiVmGroupName = null, string datastoreName = null, InMageDiskExclusionContent diskExclusionContent = null, IEnumerable<string> disksToInclude = null)
        {
            ...
            return new InMageEnableProtectionContent("InMage", vmFriendlyName, masterTargetId, processServerId, retentionDrive, runAsAccountId, multiVmGroupId, multiVmGroupName, datastoreName, diskExclusionContent, disksToInclude?.ToList(), default);
        }
        ...
        public static InMageFabricSwitchProviderBlockingErrorDetails InMageFabricSwitchProviderBlockingErrorDetails(string errorCode = null, string errorMessage = null, string possibleCauses = null, string recommendedAction = null, IReadOnlyDictionary<string, string> errorMessageParameters = null, IReadOnlyDictionary<string, string> errorTags = null)
        {
            ...
            return new InMageFabricSwitchProviderBlockingErrorDetails(errorCode, errorMessage, possibleCauses, recommendedAction, errorMessageParameters, errorTags, default);
        }
        ...
        {
            return new InMagePolicyDetails("InMage", recoveryPointThresholdInMinutes, recoveryPointHistory, appConsistentFrequencyInMinutes, multiVmSyncStatus, default);
        }
        ...
        {
            return new InMagePolicyContent("InMage", recoveryPointThresholdInMinutes, recoveryPointHistory, appConsistentFrequencyInMinutes, multiVmSyncStatus, default);
        }
        ...
        /// <summary> Initializes a new instance of <see cref="InMageRcmAgentUpgradeBlockingErrorDetails"/>. </summary>
        /// <param name="errorCode"> The error code. </param>
        /// <param name="errorMessage"> The error message. </param>
        /// <param name="possibleCauses"> The possible causes. </param>
        /// <param name="recommendedAction"> The recommended action. </param>
        ...
        public static InMageRcmAgentUpgradeBlockingErrorDetails InMageRcmAgentUpgradeBlockingErrorDetails(string errorCode = null, string errorMessage = null, string possibleCauses = null, string recommendedAction = null, IReadOnlyDictionary<string, string> errorMessageParameters = null, IReadOnlyDictionary<string, string> errorTags = null)
        {
            ...
            return new InMageRcmAgentUpgradeBlockingErrorDetails(errorCode, errorMessage, possibleCauses, recommendedAction, errorMessageParameters, errorTags, default);
        }
        ...
        public static InMageRcmApplianceDetails InMageRcmApplianceDetails(string id = null, string name = null, ResourceIdentifier fabricArmId = null, SiteRecoveryProcessServerDetails processServer = null, RcmProxyDetails rcmProxy = null, PushInstallerDetails pushInstaller = null, ReplicationAgentDetails replicationAgent = null, ReprotectAgentDetails reprotectAgent = null, MarsAgentDetails marsAgent = null, SiteRecoveryDraDetails dra = null, IEnumerable<InMageRcmFabricSwitchProviderBlockingErrorDetails> switchProviderBlockingErrorDetails = null)
        {
            ...
            return new InMageRcmApplianceDetails(id, name, fabricArmId, processServer, rcmProxy, pushInstaller, replicationAgent, reprotectAgent, marsAgent, dra, switchProviderBlockingErrorDetails?.ToList(), default);
        }
        ...
        public static RcmProxyDetails RcmProxyDetails(string id = null, string name = null, string biosId = null, ResourceIdentifier fabricObjectId = null, string fqdn = null, string clientAuthenticationType = null, string version = null, DateTimeOffset? lastHeartbeatReceivedOn = null, SiteRecoveryProtectionHealth? health = null, IEnumerable<SiteRecoveryHealthError> healthErrors = null)
        {
            ...
            return new RcmProxyDetails(id, name, biosId, fabricObjectId, fqdn, clientAuthenticationType, version, lastHeartbeatReceivedOn, health, healthErrors?.ToList(), default);
        }
        ...
        public static PushInstallerDetails PushInstallerDetails(string id = null, string name = null, string biosId = null, ResourceIdentifier fabricObjectId = null, string fqdn = null, string version = null, DateTimeOffset? lastHeartbeatReceivedOn = null, SiteRecoveryProtectionHealth? health = null, IEnumerable<SiteRecoveryHealthError> healthErrors = null)
        {
            ...
            return new PushInstallerDetails(id, name, biosId, fabricObjectId, fqdn, version, lastHeartbeatReceivedOn, health, healthErrors?.ToList(), default);
        }
        ...
        public static ReplicationAgentDetails ReplicationAgentDetails(string id = null, string name = null, string biosId = null, ResourceIdentifier fabricObjectId = null, string fqdn = null, string version = null, DateTimeOffset? lastHeartbeatUtc = null, SiteRecoveryProtectionHealth? health = null, IEnumerable<SiteRecoveryHealthError> healthErrors = null)
        {
            ...
            return new ReplicationAgentDetails(id, name, biosId, fabricObjectId, fqdn, version, lastHeartbeatUtc, health, healthErrors?.ToList(), default);
        }
        ...
        public static ReprotectAgentDetails ReprotectAgentDetails(string id = null, string name = null, string biosId = null, ResourceIdentifier fabricObjectId = null, string fqdn = null, string version = null, DateTimeOffset? lastHeartbeatReceivedOn = null, SiteRecoveryProtectionHealth? health = null, IEnumerable<SiteRecoveryHealthError> healthErrors = null, int? protectedItemCount = null, IEnumerable<string> accessibleDatastores = null, string vCenterId = null, DateTimeOffset? last = null)
        {
            ...
            return new ReprotectAgentDetails(id, name, biosId, fabricObjectId, fqdn, version, lastHeartbeatReceivedOn, health, healthErrors?.ToList(), protectedItemCount, accessibleDatastores?.ToList(), vCenterId, last, default);
        }
        ...
        public static MarsAgentDetails MarsAgentDetails(string id = null, string name = null, string biosId = null, ResourceIdentifier fabricObjectId = null, string fqdn = null, string version = null, DateTimeOffset? lastHeartbeatReceivedOn = null, SiteRecoveryProtectionHealth? health = null, IEnumerable<SiteRecoveryHealthError> healthErrors = null)
        {
            ...
            return new MarsAgentDetails(id, name, biosId, fabricObjectId, fqdn, version, lastHeartbeatReceivedOn, health, healthErrors?.ToList(), default);
        }
        ...
        public static InMageRcmFabricSwitchProviderBlockingErrorDetails InMageRcmFabricSwitchProviderBlockingErrorDetails(string errorCode = null, string errorMessage = null, string possibleCauses = null, string recommendedAction = null, IReadOnlyDictionary<string, string> errorMessageParameters = null, IReadOnlyDictionary<string, string> errorTags = null)
        {
            ...
            return new InMageRcmFabricSwitchProviderBlockingErrorDetails(errorCode, errorMessage, possibleCauses, recommendedAction, errorMessageParameters, errorTags, default);
        }
        ...
        public static InMageRcmApplianceSpecificDetails InMageRcmApplianceSpecificDetails(IEnumerable<InMageRcmApplianceDetails> appliances = null)
        {
            ...
            return new InMageRcmApplianceSpecificDetails("InMageRcm", appliances?.ToList(), default);
        }
        ...
        {
            return new InMageRcmApplyRecoveryPointContent("InMageRcm", recoveryPointId, default);
        }
        ...
        public static InMageRcmDiscoveredProtectedVmDetails InMageRcmDiscoveredProtectedVmDetails(string vCenterId = null, string vCenterFqdn = null, IEnumerable<string> datastores = null, IEnumerable<IPAddress> ipAddresses = null, string vmwareToolsStatus = null, string powerStatus = null, string vmFqdn = null, string osName = null, DateTimeOffset? createdOn = null, DateTimeOffset? updatedOn = null, bool? isDeleted = null, DateTimeOffset? lastDiscoveryTimeInUtc = null)
        {
            ...
            return new InMageRcmDiscoveredProtectedVmDetails(vCenterId, vCenterFqdn, datastores?.ToList(), ipAddresses?.ToList(), vmwareToolsStatus, powerStatus, vmFqdn, osName, createdOn, updatedOn, isDeleted, lastDiscoveryTimeInUtc, default);
        }
        ...
        {
            return new InMageRcmDiskContent(diskId, logStorageAccountId, diskType, diskEncryptionSetId, default);
        }
        ...
        {
            return new InMageRcmDisksDefaultContent(logStorageAccountId, diskType, diskEncryptionSetId, default);
        }
        ...
        public static InMageRcmEnableProtectionContent InMageRcmEnableProtectionContent(string fabricDiscoveryMachineId = null, IEnumerable<InMageRcmDiskContent> disksToInclude = null, InMageRcmDisksDefaultContent disksDefault = null, ResourceIdentifier targetResourceGroupId = null, ResourceIdentifier targetNetworkId = null, ResourceIdentifier testNetworkId = null, string targetSubnetName = null, string testSubnetName = null, string targetVmName = null, string targetVmSize = null, SiteRecoveryLicenseType? licenseType = null, ResourceIdentifier targetAvailabilitySetId = null, string targetAvailabilityZone = null, ResourceIdentifier targetProximityPlacementGroupId = null, ResourceIdentifier targetBootDiagnosticsStorageAccountId = null, string runAsAccountId = null, Guid processServerId = default, string multiVmGroupName = null)
        {
            ...
            return new InMageRcmEnableProtectionContent("InMageRcm", fabricDiscoveryMachineId, disksToInclude?.ToList(), disksDefault, targetResourceGroupId, targetNetworkId, testNetworkId, targetSubnetName, testSubnetName, targetVmName, targetVmSize, licenseType, targetAvailabilitySetId, targetAvailabilityZone, targetProximityPlacementGroupId, targetBootDiagnosticsStorageAccountId, runAsAccountId, processServerId, multiVmGroupName, default);
        }
        ...
        {
            return new InMageRcmEventDetails("InMageRcm", protectedItemName, vmName, latestAgentVersion, jobId, fabricName, applianceName, serverType, componentDisplayName, default);
        }
        ...
        {
            return new InMageRcmFabricCreationContent("InMageRcm", vmwareSiteId, physicalSiteId, sourceAgentIdentity, default);
        }
        ...
        public static InMageRcmFailbackDiscoveredProtectedVmDetails InMageRcmFailbackDiscoveredProtectedVmDetails(string vCenterId = null, string vCenterFqdn = null, IEnumerable<string> datastores = null, IEnumerable<IPAddress> ipAddresses = null, string vmwareToolsStatus = null, string powerStatus = null, string vmFqdn = null, string osName = null, DateTimeOffset? createdOn = null, DateTimeOffset? updatedOn = null, bool? isDeleted = null, DateTimeOffset? lastDiscoveredOn = null)
        {
            ...
            return new InMageRcmFailbackDiscoveredProtectedVmDetails(vCenterId, vCenterFqdn, datastores?.ToList(), ipAddresses?.ToList(), vmwareToolsStatus, powerStatus, vmFqdn, osName, createdOn, updatedOn, isDeleted, lastDiscoveredOn, default);
        }
        ...
        {
            return new InMageRcmFailbackEventDetails("InMageRcmFailback", protectedItemName, vmName, applianceName, serverType, componentDisplayName, default);
        }
        ...
        public static InMageRcmFailbackMobilityAgentDetails InMageRcmFailbackMobilityAgentDetails(string version = null, string latestVersion = null, string driverVersion = null, string latestUpgradableVersionWithoutReboot = null, DateTimeOffset? agentVersionExpireOn = null, DateTimeOffset? driverVersionExpireOn = null, DateTimeOffset? lastHeartbeatReceivedOn = null, IEnumerable<AgentUpgradeBlockedReason> reasonsBlockingUpgrade = null, string isUpgradeable = null)
        {
            ...
            return new InMageRcmFailbackMobilityAgentDetails(version, latestVersion, driverVersion, latestUpgradableVersionWithoutReboot, agentVersionExpireOn, driverVersionExpireOn, lastHeartbeatReceivedOn, reasonsBlockingUpgrade?.ToList(), isUpgradeable, default);
        }
        ...
        {
            return new InMageRcmFailbackPlannedFailoverProviderContent("InMageRcmFailback", recoveryPointType, default);
        }
        ...
        {
            return new InMageRcmFailbackPolicyDetails("InMageRcmFailback", appConsistentFrequencyInMinutes, crashConsistentFrequencyInMinutes, default);
        }
        ...
        {
            return new InMageRcmFailbackProtectedDiskDetails(diskId, diskName, isOSDisk, capacityInBytes, diskUuid, dataPendingInLogDataStoreInMB, dataPendingAtSourceAgentInMB, isInitialReplicationComplete, irDetails, resyncDetails, lastSyncedOn, default);
        }
        ...
        {
            return new InMageRcmFailbackSyncDetails(progressHealth, transferredBytes, last15MinutesTransferredBytes, lastDataTransferOn, processedBytes, startOn, lastRefreshedOn, progressPercentage, default);
        }
        ...
        {
            return new InMageRcmFailbackReprotectContent("InMageRcmFailback", processServerId, runAsAccountId, policyId, default);
        }

        /// <summary> Initializes a new instance of <see cref="InMageRcmLastAgentUpgradeErrorDetails"/>. </summary>
        /// <param name="errorCode"> The error code. </param>
        /// <param name="errorMessage"> The error message. </param>
        /// <param name="possibleCauses"> The possible causes. </param>
        /// <param name="recommendedAction"> The recommended action. </param>
        ...
        public static InMageRcmLastAgentUpgradeErrorDetails InMageRcmLastAgentUpgradeErrorDetails(string errorCode = null, string errorMessage = null, string possibleCauses = null, string recommendedAction = null, IReadOnlyDictionary<string, string> errorMessageParameters = null, IReadOnlyDictionary<string, string> errorTags = null)
        {
            ...
            return new InMageRcmLastAgentUpgradeErrorDetails(errorCode, errorMessage, possibleCauses, recommendedAction, errorMessageParameters, errorTags, default);
        }
        ...
        public static InMageRcmMobilityAgentDetails InMageRcmMobilityAgentDetails(string version = null, string latestVersion = null, string latestAgentReleaseDate = null, string driverVersion = null, string latestUpgradableVersionWithoutReboot = null, DateTimeOffset? agentVersionExpireOn = null, DateTimeOffset? driverVersionExpireOn = null, DateTimeOffset? lastHeartbeatReceivedOn = null, IEnumerable<AgentUpgradeBlockedReason> reasonsBlockingUpgrade = null, string isUpgradeable = null)
        {
            ...
            return new InMageRcmMobilityAgentDetails(version, latestVersion, latestAgentReleaseDate, driverVersion, latestUpgradableVersionWithoutReboot, agentVersionExpireOn, driverVersionExpireOn, lastHeartbeatReceivedOn, reasonsBlockingUpgrade?.ToList(), isUpgradeable, default);
        }
        ...
        {
            return new InMageRcmNicDetails(nicId, isPrimaryNic, isSelectedForFailover, sourceIPAddress, sourceIPAddressType, sourceNetworkId, sourceSubnetName, targetIPAddress, targetIPAddressType, targetSubnetName, testSubnetName, testIPAddress, testIPAddressType, default);
        }
        ...
        {
            return new InMageRcmNicContent(nicId, isPrimaryNic, isSelectedForFailover, targetSubnetName, targetStaticIPAddress, testSubnetName, testStaticIPAddress, default);
        }
        ...
        {
            return new InMageRcmPolicyDetails("InMageRcm", recoveryPointHistoryInMinutes, appConsistentFrequencyInMinutes, crashConsistentFrequencyInMinutes, enableMultiVmSync, default);
        }
        ...
        {
            return new InMageRcmProtectedDiskDetails(diskId, diskName, isOSDisk, capacityInBytes, logStorageAccountId, diskEncryptionSetId, seedManagedDiskId, seedBlobUri, targetManagedDiskId, diskType, dataPendingInLogDataStoreInMB, dataPendingAtSourceAgentInMB, isInitialReplicationComplete, irDetails, resyncDetails, default);
        }
        ...
        {
            return new InMageRcmSyncDetails(progressHealth, transferredBytes, last15MinutesTransferredBytes, lastDataTransferTimeUtc, processedBytes, staStartOn, lastRefreshedOn, progressPercentage, default);
        }
        ...
        {
            return new InMageRcmProtectionContainerMappingDetails("InMageRcm", enableAgentAutoUpgrade, default);
        }
        ...
        {
            return new InMageRcmRecoveryPointDetails("InMageRcm", isMultiVmSyncPoint, default);
        }
        ...
        {
            return new InMageRcmReprotectContent("InMageRcm", reprotectAgentId, datastoreName, logStorageAccountId, policyId, default);
        }
        ...
        {
            return new InMageRcmUnplannedFailoverContent("InMageRcm", performShutdown, recoveryPointId, default);
        }
        ...
        {
            return new InMageRcmUpdateContainerMappingContent("InMageRcm", enableAgentAutoUpgrade, default);
        }
        ...
        public static InMageReprotectContent InMageReprotectContent(string masterTargetId = null, Guid processServerId = default, string retentionDrive = null, string runAsAccountId = null, string datastoreName = null, InMageDiskExclusionContent diskExclusionContent = null, string profileId = null, IEnumerable<string> disksToInclude = null)
        {
            ...
            return new InMageReprotectContent("InMage", masterTargetId, processServerId, retentionDrive, runAsAccountId, datastoreName, diskExclusionContent, profileId, disksToInclude?.ToList(), default);
        }
        ...
        {
            return new SiteRecoveryJobStatusEventDetails("JobStatus", jobId, jobFriendlyName, jobStatus, affectedObjectType, default);
        }
        ...
        {
            return new ManualActionTaskDetails("ManualActionTaskDetails", name, instructions, observation, default);
        }
        ...
        {
            return new RecoveryPlanA2ADetails("A2A", primaryZone, recoveryZone, primaryExtendedLocation, recoveryExtendedLocation, default);
        }
        ...
        {
            return new RecoveryPlanA2AFailoverContent("A2A", recoveryPointType, cloudServiceCreationOption, multiVmSyncPointOption, default);
        }
        ...
        public static RecoveryPlanGroupTaskDetails RecoveryPlanGroupTaskDetails(IEnumerable<AsrTask> childTasks = null, string name = null, string groupId = null, string rpGroupType = null)
        {
            ...
            return new RecoveryPlanGroupTaskDetails("RecoveryPlanGroupTaskDetails", childTasks?.ToList(), name, groupId, rpGroupType, default);
        }
        ...
        {
            return new RecoveryPlanHyperVReplicaAzureFailbackContent("HyperVReplicaAzureFailback", dataSyncOption, recoveryVmCreationOption, default);
        }
        ...
        {
            return new RecoveryPlanInMageAzureV2FailoverContent("InMageAzureV2", recoveryPointType, useMultiVmSyncPoint, default);
        }
        ...
        {
            return new RecoveryPlanInMageFailoverContent("InMage", recoveryPointType, default);
        }
        ...
        {
            return new RecoveryPlanInMageRcmFailbackFailoverContent("InMageRcmFailback", recoveryPointType, useMultiVmSyncPoint, default);
        }
        ...
        {
            return new RecoveryPlanInMageRcmFailoverContent("InMageRcm", recoveryPointType, useMultiVmSyncPoint, default);
        }
        ...
        public static RecoveryPlanShutdownGroupTaskDetails RecoveryPlanShutdownGroupTaskDetails(IEnumerable<AsrTask> childTasks = null, string name = null, string groupId = null, string rpGroupType = null)
        {
            ...
            return new RecoveryPlanShutdownGroupTaskDetails("RecoveryPlanShutdownGroupTaskDetails", childTasks?.ToList(), name, groupId, rpGroupType, default);
        }
        ...
        {
            return new ScriptActionTaskDetails("ScriptActionTaskDetails", name, path, output, isPrimarySideScript, default);
        }
        ...
        public static SwitchProtectionJobDetails SwitchProtectionJobDetails(IReadOnlyDictionary<string, string> affectedObjectDetails = null, ResourceIdentifier newReplicationProtectedItemId = null)
        {
            ...
            return new SwitchProtectionJobDetails("SwitchProtectionJobDetails", affectedObjectDetails, newReplicationProtectedItemId, default);
        }
        ...
        public static TestFailoverJobDetails TestFailoverJobDetails(IReadOnlyDictionary<string, string> affectedObjectDetails = null, string testFailoverStatus = null, string comments = null, string networkName = null, string networkFriendlyName = null, string networkType = null, IEnumerable<FailoverReplicationProtectedItemDetails> protectedItemDetails = null)
        {
            ...
            return new TestFailoverJobDetails("TestFailoverJobDetails", affectedObjectDetails, testFailoverStatus, comments, networkName, networkFriendlyName, networkType, protectedItemDetails?.ToList(), default);
        }
        ...
        {
            return new SiteRecoveryVmTaskDetails("VirtualMachineTaskDetails", jobTask, skippedReason, skippedReasonString, default);
        }
        ...
        public static VmmVmDetails VmmVmDetails(string sourceItemId = null, string generation = null, SiteRecoveryOSDetails osDetails = null, IEnumerable<SiteRecoveryDiskDetails> diskDetails = null, HyperVVmDiskPresenceStatus? hasPhysicalDisk = null, HyperVVmDiskPresenceStatus? hasFibreChannelAdapter = null, HyperVVmDiskPresenceStatus? hasSharedVhd = null, string hyperVHostId = null)
        {
            ...
            return new VmmVmDetails("VmmVirtualMachine", sourceItemId, generation, osDetails, diskDetails?.ToList(), hasPhysicalDisk, hasFibreChannelAdapter, hasSharedVhd, hyperVHostId, default);
        }
        ...
        {
            return new VmNicUpdatesTaskDetails("VmNicUpdatesTaskDetails", vmId, nicId, name, default);
        }
        ...
        {
            return new VMwareCbtContainerMappingContent("VMwareCbt", keyVaultId, keyVaultUri, storageAccountId, storageAccountSasSecretName, serviceBusConnectionStringSecretName, targetLocation, default);
        }
        ...
        {
            return new VMwareCbtDiskContent(diskId, diskType, isOSDisk, logStorageAccountId, logStorageAccountSasSecretName, diskEncryptionSetId, default);
        }
        ...
        public static VMwareCbtEnableMigrationContent VMwareCbtEnableMigrationContent(ResourceIdentifier vmwareMachineId = null, IEnumerable<VMwareCbtDiskContent> disksToInclude = null, SiteRecoveryLicenseType? licenseType = null, SiteRecoverySqlServerLicenseType? sqlServerLicenseType = null, string performSqlBulkRegistration = null, ResourceIdentifier dataMoverRunAsAccountId = null, ResourceIdentifier snapshotRunAsAccountId = null, string targetVmName = null, string targetVmSize = null, ResourceIdentifier targetResourceGroupId = null, ResourceIdentifier targetNetworkId = null, ResourceIdentifier testNetworkId = null, string targetSubnetName = null, string testSubnetName = null, ResourceIdentifier targetAvailabilitySetId = null, string targetAvailabilityZone = null, ResourceIdentifier targetProximityPlacementGroupId = null, ResourceIdentifier confidentialVmKeyVaultId = null, VMwareCbtSecurityProfileProperties targetVmSecurityProfile = null, ResourceIdentifier targetBootDiagnosticsStorageAccountId = null, string performAutoResync = null, IDictionary<string, string> targetVmTags = null, IDictionary<string, string> seedDiskTags = null, IDictionary<string, string> targetDiskTags = null, IDictionary<string, string> targetNicTags = null)
        {
            ...
            return new VMwareCbtEnableMigrationContent("VMwareCbt", vmwareMachineId, disksToInclude?.ToList(), licenseType, sqlServerLicenseType, performSqlBulkRegistration, dataMoverRunAsAccountId, snapshotRunAsAccountId, targetVmName, targetVmSize, targetResourceGroupId, targetNetworkId, testNetworkId, targetSubnetName, testSubnetName, targetAvailabilitySetId, targetAvailabilityZone, targetProximityPlacementGroupId, confidentialVmKeyVaultId, targetVmSecurityProfile, targetBootDiagnosticsStorageAccountId, performAutoResync, targetVmTags, seedDiskTags, targetDiskTags, targetNicTags, default);
        }
        ...
        {
            return new VMwareCbtEventDetails("VMwareCbt", migrationItemName, default);
        }
        ...
        {
            return new VMwareCbtMigrateContent("VMwareCbt", performShutdown, osUpgradeVersion, default);
        }
        ...
        {
            return new VMwareCbtProtectedDiskDetails(diskId, diskName, diskType, diskPath, isOSDisk, capacityInBytes, logStorageAccountId, logStorageAccountSasSecretName, diskEncryptionSetId, seedManagedDiskId, seedBlobUri, targetManagedDiskId, targetBlobUri, targetDiskName, default);
        }
        ...
        {
            return new VMwareCbtNicDetails(nicId, isPrimaryNic, sourceIPAddress, sourceIPAddressType, sourceNetworkId, targetIPAddress, targetIPAddressType, targetSubnetName, testNetworkId, testSubnetName, testIPAddress, testIPAddressType, targetNicName, isSelectedForMigration, default);
        }
        ...
        {
            return new VMwareCbtNicContent(nicId, isPrimaryNic, targetSubnetName, targetStaticIPAddress, isSelectedForMigration, targetNicName, testSubnetName, testStaticIPAddress, default);
        }
        ...
        {
            return new VMwareCbtPolicyDetails("VMwareCbt", recoveryPointHistoryInMinutes, appConsistentFrequencyInMinutes, crashConsistentFrequencyInMinutes, default);
        }
        ...
        public static VMwareCbtProtectionContainerMappingDetails VMwareCbtProtectionContainerMappingDetails(ResourceIdentifier keyVaultId = null, Uri keyVaultUri = null, ResourceIdentifier storageAccountId = null, string storageAccountSasSecretName = null, string serviceBusConnectionStringSecretName = null, string targetLocation = null, IReadOnlyDictionary<string, int> roleSizeToNicCountMap = null, IEnumerable<string> excludedSkus = null)
        {
            ...
            return new VMwareCbtProtectionContainerMappingDetails("VMwareCbt", keyVaultId, keyVaultUri, storageAccountId, storageAccountSasSecretName, serviceBusConnectionStringSecretName, targetLocation, roleSizeToNicCountMap, excludedSkus?.ToList(), default);
        }
        ...
        {
            return new VMwareCbtResyncContent("VMwareCbt", skipCbtReset, default);
        }
        ...
        public static VMwareCbtTestMigrateContent VMwareCbtTestMigrateContent(ResourceIdentifier recoveryPointId = null, ResourceIdentifier networkId = null, IEnumerable<VMwareCbtNicContent> vmNics = null, string osUpgradeVersion = null)
        {
            ...
            return new VMwareCbtTestMigrateContent("VMwareCbt", recoveryPointId, networkId, vmNics?.ToList(), osUpgradeVersion, default);
        }
        ...
        {
            return new VMwareCbtUpdateDiskContent(diskId, targetDiskName, isOSDisk, default);
        }
        ...
        {
            return new VMwareV2FabricCreationContent("VMwareV2", vmwareSiteId, physicalSiteId, migrationSolutionId, default);
        }
        ...
        public static VMwareV2FabricSpecificDetails VMwareV2FabricSpecificDetails(ResourceIdentifier vmwareSiteId = null, ResourceIdentifier physicalSiteId = null, ResourceIdentifier migrationSolutionId = null, string serviceEndpoint = null, ResourceIdentifier serviceResourceId = null, string serviceContainerId = null, IEnumerable<SiteRecoveryProcessServerDetails> processServers = null)
        {
            ...
            return new VMwareV2FabricSpecificDetails("VMwareV2", vmwareSiteId, physicalSiteId, migrationSolutionId, serviceEndpoint, serviceResourceId, serviceContainerId, processServers?.ToList(), default);
        }
        ...
        public static VMwareVmDetails VMwareVmDetails(string agentGeneratedId = null, string agentInstalled = null, string osType = null, string agentVersion = null, IPAddress ipAddress = null, string poweredOn = null, string vCenterInfrastructureId = null, string discoveryType = null, IEnumerable<InMageDiskDetails> diskDetails = null, IEnumerable<SiteRecoveryHealthError> validationErrors = null)
        {
            ...
            return new VMwareVmDetails("VMwareVirtualMachine", agentGeneratedId, agentInstalled, osType, agentVersion, ipAddress, poweredOn, vCenterInfrastructureId, discoveryType, diskDetails?.ToList(), validationErrors?.ToList(), default);
        }
    }
}
