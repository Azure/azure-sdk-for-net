...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SiteRecoveryMigrationItemData>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        internal static SiteRecoveryMigrationItemData DeserializeSiteRecoveryMigrationItemData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("properties"u8))
                {
                    ...
                    properties = SiteRecoveryMigrationItemProperties.DeserializeSiteRecoveryMigrationItemProperties(property.Value, options);
                    continue;
                }
				...
				global::System.ClientModel.Primitives.ModelReaderWriter.Read<global::Azure.ResourceManager.Models.SystemData>(new global::System.BinaryData(global::System.Runtime.InteropServices.JsonMarshal.GetRawUtf8Value(property.Value).ToArray()), global::Azure.ResourceManager.RecoveryServicesSiteRecovery.ModelSerializationExtensions.WireOptions, AzureResourceManagerRecoveryServicesSiteRecoveryContext.Default)
#else
                ModelReaderWriter.Read<SystemData>(new BinaryData(Encoding.UTF8.GetBytes(property.Value.GetRawText())), ModelSerializationExtensions.WireOptions, AzureResourceManagerRecoveryServicesSiteRecoveryContext.Default)
#endif
;
                    continue;
                }
