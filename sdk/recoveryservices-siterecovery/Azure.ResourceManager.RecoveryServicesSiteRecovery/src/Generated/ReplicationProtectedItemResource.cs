...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery
{
    ...
    public partial class ReplicationProtectedItemResource : ArmResource
    {
        ...
        internal ReplicationProtectedItemResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _targetComputeSizesRestClient = new TargetComputeSizes(_targetComputeSizesClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, replicationProtectedItemApiVersion ?? "2026-02-01");
        ...
        /// <summary>
        /// Updates the ReplicationProtectedItem.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{resourceName}/replicationFabrics/{fabricName}/replicationProtectionContainers/{protectionContainerName}/replicationProtectedItems/{replicatedProtectedItemName}. </description>
        ...
        public virtual async Task<ArmOperation<ReplicationProtectedItemResource>> UpdateAsync(WaitUntil waitUntil, ReplicationProtectedItemCreateOrUpdateContent content, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(content, nameof(content));
            ...
            try
            {
                ...
                HttpMessage message = _replicationProtectedItemsRestClient.CreateCreateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, ReplicationProtectedItemCreateOrUpdateContent.ToRequestContent(content), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                RecoveryServicesSiteRecoveryArmOperation<ReplicationProtectedItemResource> operation = new RecoveryServicesSiteRecoveryArmOperation<ReplicationProtectedItemResource>(
                    new ReplicationProtectedItemResourceOperationSource(Client),
                    _replicationProtectedItemsClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="content"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<ReplicationProtectedItemResource> Update(WaitUntil waitUntil, ReplicationProtectedItemCreateOrUpdateContent content, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(content, nameof(content));
