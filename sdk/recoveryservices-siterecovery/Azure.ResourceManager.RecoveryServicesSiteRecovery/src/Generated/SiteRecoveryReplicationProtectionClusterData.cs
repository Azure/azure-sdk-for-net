...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery
{
    ...
    public partial class SiteRecoveryReplicationProtectionClusterData : ResourceData
    {
        ...
        internal SiteRecoveryReplicationProtectionClusterData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, SiteRecoveryReplicationProtectionClusterProperties properties) : base(id, name, resourceType, systemData)
        {
