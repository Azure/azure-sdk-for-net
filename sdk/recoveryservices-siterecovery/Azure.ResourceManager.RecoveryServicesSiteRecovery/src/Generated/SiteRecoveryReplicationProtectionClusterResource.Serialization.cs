...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery
{
    public partial class SiteRecoveryReplicationProtectionClusterResource : IJsonModel<SiteRecoveryReplicationProtectionClusterData>
    {
        ...
        BinaryData IPersistableModel<SiteRecoveryReplicationProtectionClusterData>.Write(ModelReaderWriterOptions options) => ModelReaderWriter.Write(Data, options);

        SiteRecoveryReplicationProtectionClusterData IPersistableModel<SiteRecoveryReplicationProtectionClusterData>.Create(BinaryData data, ModelReaderWriterOptions options) => ModelReaderWriter.Read<SiteRecoveryReplicationProtectionClusterData>(data, options);
