...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Mocking
{
    ...
    internal partial class RecoveryServicesSiteRecoveryResourceGroupMockingExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="RecoveryServicesSiteRecoveryResourceGroupMockingExtension"/> class for mocking. </summary>
        protected RecoveryServicesSiteRecoveryResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="RecoveryServicesSiteRecoveryResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal RecoveryServicesSiteRecoveryResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<SiteRecoveryReplicationAppliance> GetReplicationAppliancesAsync(string resourceName, string filter = null, CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, SiteRecoveryReplicationAppliance.DeserializeSiteRecoveryReplicationAppliance, ReplicationAppliancesClientDiagnostics, Pipeline, "RecoveryServicesSiteRecoveryResourceGroupMockingExtension.GetReplicationAppliances", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<SiteRecoveryReplicationAppliance> GetReplicationAppliances(string resourceName, string filter = null, CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => ReplicationAppliancesRestClient.CreateListRequest(Id.SubscriptionId, Id.ResourceGroupName, resourceName, filter);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => ReplicationAppliancesRestClient.CreateListNextPageRequest(nextLink, Id.SubscriptionId, Id.ResourceGroupName, resourceName, filter);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, SiteRecoveryReplicationAppliance.DeserializeSiteRecoveryReplicationAppliance, ReplicationAppliancesClientDiagnostics, Pipeline, "RecoveryServicesSiteRecoveryResourceGroupMockingExtension.GetReplicationAppliances", "value", "nextLink", cancellationToken);
        }
        ...
        {
            using var scope = SupportedOperatingSystemsClientDiagnostics.CreateScope("RecoveryServicesSiteRecoveryResourceGroupMockingExtension.GetSupportedOperatingSystem");
            scope.Start();
            try
            {
        ...
        {
            using var scope = ReplicationVaultHealthClientDiagnostics.CreateScope("RecoveryServicesSiteRecoveryResourceGroupMockingExtension.GetReplicationVaultHealth");
            scope.Start();
            try
            {
        ...
        {
            using var scope = ReplicationVaultHealthClientDiagnostics.CreateScope("RecoveryServicesSiteRecoveryResourceGroupMockingExtension.RefreshReplicationVaultHealth");
            scope.Start();
            try
            {
