...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Mocking
{
    ...
    internal partial class RecoveryServicesSiteRecoveryArmClientMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="RecoveryServicesSiteRecoveryArmClientMockingExtension"/> class for mocking. </summary>
        protected RecoveryServicesSiteRecoveryArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="RecoveryServicesSiteRecoveryArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal RecoveryServicesSiteRecoveryArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal RecoveryServicesSiteRecoveryArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
