...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Mock
{
    ...
    public partial class ReplicationProtectedItemResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="ReplicationProtectedItemResourceExtension"/> class for mocking. </summary>
        protected ReplicationProtectedItemResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ReplicationProtectedItemResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ReplicationProtectedItemResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
