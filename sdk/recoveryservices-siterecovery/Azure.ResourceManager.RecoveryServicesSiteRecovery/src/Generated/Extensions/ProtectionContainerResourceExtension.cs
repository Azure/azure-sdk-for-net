...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Mock
{
    ...
    public partial class ProtectionContainerResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="ProtectionContainerResourceExtension"/> class for mocking. </summary>
        protected ProtectionContainerResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ProtectionContainerResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ProtectionContainerResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
