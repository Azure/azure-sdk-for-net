...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Mock
{
    ...
    public partial class ProtectionContainerMappingResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="ProtectionContainerMappingResourceExtension"/> class for mocking. </summary>
        protected ProtectionContainerMappingResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ProtectionContainerMappingResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ProtectionContainerMappingResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
