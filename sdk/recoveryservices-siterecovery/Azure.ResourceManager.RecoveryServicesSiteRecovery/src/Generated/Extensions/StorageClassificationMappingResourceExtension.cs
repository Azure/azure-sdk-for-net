...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Mock
{
    ...
    public partial class StorageClassificationMappingResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="StorageClassificationMappingResourceExtension"/> class for mocking. </summary>
        protected StorageClassificationMappingResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="StorageClassificationMappingResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal StorageClassificationMappingResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
