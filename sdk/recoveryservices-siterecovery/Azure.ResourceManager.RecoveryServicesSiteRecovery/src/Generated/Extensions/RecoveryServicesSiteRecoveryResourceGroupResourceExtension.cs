...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Testing
{
    /// <summary> A class to add extension methods to ResourceGroupResource. </summary>
    public partial class RecoveryServicesSiteRecoveryResourceGroupResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="RecoveryServicesSiteRecoveryResourceGroupResourceExtension"/> class for mocking. </summary>
        protected RecoveryServicesSiteRecoveryResourceGroupResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="RecoveryServicesSiteRecoveryResourceGroupResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal RecoveryServicesSiteRecoveryResourceGroupResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<ReplicationAppliance> GetReplicationAppliancesAsync(string resourceName, string filter = null, CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, ReplicationAppliance.DeserializeReplicationAppliance, ReplicationAppliancesClientDiagnostics, Pipeline, "RecoveryServicesSiteRecoveryResourceGroupResourceExtension.GetReplicationAppliances", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<ReplicationAppliance> GetReplicationAppliances(string resourceName, string filter = null, CancellationToken cancellationToken = default)
        {
            ...
            HttpMessage FirstPageRequest(int? pageSizeHint) => ReplicationAppliancesRestClient.CreateListRequest(Id.SubscriptionId, Id.ResourceGroupName, resourceName, filter);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => ReplicationAppliancesRestClient.CreateListNextPageRequest(nextLink, Id.SubscriptionId, Id.ResourceGroupName, resourceName, filter);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, ReplicationAppliance.DeserializeReplicationAppliance, ReplicationAppliancesClientDiagnostics, Pipeline, "RecoveryServicesSiteRecoveryResourceGroupResourceExtension.GetReplicationAppliances", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual AsyncPageable<NetworkResource> GetNetworksAsync(string resourceName, CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new NetworkResource(Client, NetworkData.DeserializeNetworkData(e)), NetworkReplicationNetworksClientDiagnostics, Pipeline, "RecoveryServicesSiteRecoveryResourceGroupResourceExtension.GetNetworks", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<NetworkResource> GetNetworks(string resourceName, CancellationToken cancellationToken = default)
        {
            ...
            HttpMessage FirstPageRequest(int? pageSizeHint) => NetworkReplicationNetworksRestClient.CreateListRequest(Id.SubscriptionId, Id.ResourceGroupName, resourceName);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => NetworkReplicationNetworksRestClient.CreateListNextPageRequest(nextLink, Id.SubscriptionId, Id.ResourceGroupName, resourceName);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new NetworkResource(Client, NetworkData.DeserializeNetworkData(e)), NetworkReplicationNetworksClientDiagnostics, Pipeline, "RecoveryServicesSiteRecoveryResourceGroupResourceExtension.GetNetworks", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual AsyncPageable<ProtectionContainerResource> GetProtectionContainersAsync(string resourceName, CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new ProtectionContainerResource(Client, ProtectionContainerData.DeserializeProtectionContainerData(e)), ProtectionContainerReplicationProtectionContainersClientDiagnostics, Pipeline, "RecoveryServicesSiteRecoveryResourceGroupResourceExtension.GetProtectionContainers", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual AsyncPageable<MigrationItemResource> GetMigrationItemsAsync(string resourceName, string skipToken = null, string takeToken = null, string filter = null, CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new MigrationItemResource(Client, MigrationItemData.DeserializeMigrationItemData(e)), MigrationItemReplicationMigrationItemsClientDiagnostics, Pipeline, "RecoveryServicesSiteRecoveryResourceGroupResourceExtension.GetMigrationItems", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<MigrationItemResource> GetMigrationItems(string resourceName, string skipToken = null, string takeToken = null, string filter = null, CancellationToken cancellationToken = default)
        {
            ...
            HttpMessage FirstPageRequest(int? pageSizeHint) => MigrationItemReplicationMigrationItemsRestClient.CreateListRequest(Id.SubscriptionId, Id.ResourceGroupName, resourceName, skipToken, takeToken, filter);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => MigrationItemReplicationMigrationItemsRestClient.CreateListNextPageRequest(nextLink, Id.SubscriptionId, Id.ResourceGroupName, resourceName, skipToken, takeToken, filter);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new MigrationItemResource(Client, MigrationItemData.DeserializeMigrationItemData(e)), MigrationItemReplicationMigrationItemsClientDiagnostics, Pipeline, "RecoveryServicesSiteRecoveryResourceGroupResourceExtension.GetMigrationItems", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual AsyncPageable<VCenterResource> GetVCentersAsync(string resourceName, CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new VCenterResource(Client, VCenterData.DeserializeVCenterData(e)), VCenterReplicationvCentersClientDiagnostics, Pipeline, "RecoveryServicesSiteRecoveryResourceGroupResourceExtension.GetVCenters", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<VCenterResource> GetVCenters(string resourceName, CancellationToken cancellationToken = default)
        {
            ...
            HttpMessage FirstPageRequest(int? pageSizeHint) => VCenterReplicationvCentersRestClient.CreateListRequest(Id.SubscriptionId, Id.ResourceGroupName, resourceName);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => VCenterReplicationvCentersRestClient.CreateListNextPageRequest(nextLink, Id.SubscriptionId, Id.ResourceGroupName, resourceName);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new VCenterResource(Client, VCenterData.DeserializeVCenterData(e)), VCenterReplicationvCentersClientDiagnostics, Pipeline, "RecoveryServicesSiteRecoveryResourceGroupResourceExtension.GetVCenters", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual async Task<Response<SupportedOperatingSystems>> GetSupportedOperatingSystemAsync(string resourceName, string instanceType = null, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = SupportedOperatingSystemsClientDiagnostics.CreateScope("RecoveryServicesSiteRecoveryResourceGroupResourceExtension.GetSupportedOperatingSystem");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response<VaultHealthDetails>> GetReplicationVaultHealthAsync(string resourceName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = ReplicationVaultHealthClientDiagnostics.CreateScope("RecoveryServicesSiteRecoveryResourceGroupResourceExtension.GetReplicationVaultHealth");
            scope.Start();
            try
            {
        ...
        public virtual async Task<ArmOperation<VaultHealthDetails>> RefreshReplicationVaultHealthAsync(WaitUntil waitUntil, string resourceName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = ReplicationVaultHealthClientDiagnostics.CreateScope("RecoveryServicesSiteRecoveryResourceGroupResourceExtension.RefreshReplicationVaultHealth");
            scope.Start();
            try
            {
