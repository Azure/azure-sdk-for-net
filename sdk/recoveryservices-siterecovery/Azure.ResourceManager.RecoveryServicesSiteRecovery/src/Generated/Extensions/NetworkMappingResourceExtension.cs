...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Mock
{
    ...
    public partial class NetworkMappingResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="NetworkMappingResourceExtension"/> class for mocking. </summary>
        protected NetworkMappingResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="NetworkMappingResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal NetworkMappingResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
