...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Mock
{
    ...
    public partial class StorageClassificationResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="StorageClassificationResourceExtension"/> class for mocking. </summary>
        protected StorageClassificationResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="StorageClassificationResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal StorageClassificationResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
