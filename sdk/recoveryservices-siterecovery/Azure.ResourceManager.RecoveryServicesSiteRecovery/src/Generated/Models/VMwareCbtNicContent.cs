...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class VMwareCbtNicContent
    {
        ...
        internal VMwareCbtNicContent(string nicId, string isPrimaryNic, string targetSubnetName, IPAddress targetStaticIPAddress, string isSelectedForMigration, string targetNicName, string testSubnetName, IPAddress testStaticIPAddress, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            NicId = nicId;
            IsPrimaryNic = isPrimaryNic;
