...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class InMageEnableProtectionContent : EnableProtectionProviderSpecificContent
    {
        ...
        public InMageEnableProtectionContent(string masterTargetId, Guid processServerId, string retentionDrive, string multiVmGroupId, string multiVmGroupName) : base("InMage")
        {
        ...
        internal InMageEnableProtectionContent(string instanceType, IDictionary<string, BinaryData> additionalBinaryDataProperties, string vmFriendlyName, string masterTargetId, Guid processServerId, string retentionDrive, string runAsAccountId, string multiVmGroupId, string multiVmGroupName, string datastoreName, InMageDiskExclusionContent diskExclusionContent, IList<string> disksToInclude) : base(instanceType, additionalBinaryDataProperties)
        {
