...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class HyperVReplicaReplicationDetails : ReplicationProviderSpecificSettings, IJsonModel<HyperVReplicaReplicationDetails>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<HyperVReplicaReplicationDetails>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<HyperVReplicaReplicationDetails>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        HyperVReplicaReplicationDetails IPersistableModel<HyperVReplicaReplicationDetails>.Create(BinaryData data, ModelReaderWriterOptions options) => (HyperVReplicaReplicationDetails)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        HyperVReplicaReplicationDetails IJsonModel<HyperVReplicaReplicationDetails>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (HyperVReplicaReplicationDetails)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static HyperVReplicaReplicationDetails DeserializeHyperVReplicaReplicationDetails(JsonElement element, ModelReaderWriterOptions options)
        {
