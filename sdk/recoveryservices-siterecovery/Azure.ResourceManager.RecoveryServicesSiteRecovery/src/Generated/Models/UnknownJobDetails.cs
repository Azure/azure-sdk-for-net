...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    internal partial class UnknownJobDetails : SiteRecoveryJobDetails
    {
        ...
        internal UnknownJobDetails(string instanceType, IReadOnlyDictionary<string, string> affectedObjectDetails, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(instanceType ?? "unknown", affectedObjectDetails, additionalBinaryDataProperties)
        {
        }
    }
}
