...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    internal partial class UnknownJobDetails : SiteRecoveryJobDetails
    {
        ...
        internal UnknownJobDetails(string instanceType, IReadOnlyDictionary<string, string> affectedObjectDetails, Dictionary<string, BinaryData> rawData) : base(instanceType, affectedObjectDetails, rawData)
        {
