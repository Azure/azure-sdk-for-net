...
{
    public partial class SiteRecoveryLogicalNetworkProperties : IUtf8JsonSerializable, IJsonModel<SiteRecoveryLogicalNetworkProperties>, IPersistableModel<SiteRecoveryLogicalNetworkProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(NetworkVirtualizationStatus))
            {
                builder.Append("  networkVirtualizationStatus:");
                builder.AppendLine($" '{NetworkVirtualizationStatus}'");
            }

            if (Optional.IsDefined(LogicalNetworkUsage))
            {
                builder.Append("  logicalNetworkUsage:");
                builder.AppendLine($" '{LogicalNetworkUsage}'");
            }

            if (Optional.IsDefined(LogicalNetworkDefinitionsStatus))
            {
                builder.Append("  logicalNetworkDefinitionsStatus:");
                builder.AppendLine($" '{LogicalNetworkDefinitionsStatus}'");
            }
