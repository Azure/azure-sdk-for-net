...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class RecoveryPlanGroupTaskDetails : SiteRecoveryGroupTaskDetails
    {
        ...
        internal RecoveryPlanGroupTaskDetails(string instanceType, IReadOnlyList<AsrTask> childTasks, string name, string groupId, string rpGroupType, Dictionary<string, BinaryData> rawData) : base(instanceType, childTasks, rawData)
        {
            Name = name;
            GroupId = groupId;
