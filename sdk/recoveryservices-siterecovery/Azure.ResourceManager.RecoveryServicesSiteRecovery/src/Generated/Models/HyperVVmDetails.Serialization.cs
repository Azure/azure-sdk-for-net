    ...
    public partial class HyperVVmDetails : IUtf8JsonSerializable, IJsonModel<HyperVVmDetails>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SourceItemId))
            {
                ...
                if (SourceItemId.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(HasPhysicalDisk))
            {
                ...
                builder.AppendLine($" '{HasPhysicalDisk.Value.ToString()}'");
            }

            if (Optional.IsDefined(HasFibreChannelAdapter))
            {
                builder.Append("  hasFibreChannelAdapter:");
                builder.AppendLine($" '{HasFibreChannelAdapter.Value.ToString()}'");
            }

            if (Optional.IsDefined(HasSharedVhd))
            {
                builder.Append("  hasSharedVhd:");
                builder.AppendLine($" '{HasSharedVhd.Value.ToString()}'");
            }

            if (Optional.IsDefined(HyperVHostId))
            {
                builder.Append("  hyperVHostId:");
                if (HyperVHostId.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
