...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MigrationRecoveryPointListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MigrationRecoveryPointListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MigrationRecoveryPointListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MigrationRecoveryPointListResult>)} interface");
            }
        ...
        string IPersistableModel<MigrationRecoveryPointListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
