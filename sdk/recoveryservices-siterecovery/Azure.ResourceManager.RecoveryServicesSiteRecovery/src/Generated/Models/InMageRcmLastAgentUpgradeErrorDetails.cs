...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class InMageRcmLastAgentUpgradeErrorDetails
    {
        ...
        internal InMageRcmLastAgentUpgradeErrorDetails(string errorCode, string errorMessage, string possibleCauses, string recommendedAction, IReadOnlyDictionary<string, string> errorMessageParameters, IReadOnlyDictionary<string, string> errorTags, Dictionary<string, BinaryData> rawData)
        {
            ErrorCode = errorCode;
