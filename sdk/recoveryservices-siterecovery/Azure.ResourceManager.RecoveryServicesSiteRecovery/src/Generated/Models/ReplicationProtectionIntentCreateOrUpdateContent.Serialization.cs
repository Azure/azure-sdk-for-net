...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ReplicationProtectionIntentCreateOrUpdateContent>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<ReplicationProtectionIntentCreateOrUpdateContent>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
