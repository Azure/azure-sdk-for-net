...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class HyperVReplicaAzureEventDetails : SiteRecoveryEventProviderSpecificDetails
    {
        ...
        internal HyperVReplicaAzureEventDetails(string instanceType, string containerName, string fabricName, string remoteContainerName, Dictionary<string, BinaryData> rawData) : base(instanceType, rawData)
        {
