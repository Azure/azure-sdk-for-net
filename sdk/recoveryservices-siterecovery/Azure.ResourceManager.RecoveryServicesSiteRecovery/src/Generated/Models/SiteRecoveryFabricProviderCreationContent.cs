...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class SiteRecoveryFabricProviderCreationContent : FabricSpecificCreationContent
    {
        ...
        internal SiteRecoveryFabricProviderCreationContent(string instanceType, AzureLocation? location, Dictionary<string, BinaryData> rawData) : base(instanceType, rawData)
        {
            Location = location;
