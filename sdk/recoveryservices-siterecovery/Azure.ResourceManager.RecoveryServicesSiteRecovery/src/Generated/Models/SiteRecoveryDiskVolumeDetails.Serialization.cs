...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SiteRecoveryDiskVolumeDetails>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        internal static SiteRecoveryDiskVolumeDetails DeserializeSiteRecoveryDiskVolumeDetails(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new SiteRecoveryDiskVolumeDetails(label, name, serializedAdditionalRawData);
        }
