...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class InMageRcmFailbackReprotectContent : ReverseReplicationProviderSpecificContent
    {
        ...
        internal InMageRcmFailbackReprotectContent(string instanceType, Guid processServerId, string runAsAccountId, ResourceIdentifier policyId, Dictionary<string, BinaryData> rawData) : base(instanceType, rawData)
        {
            ProcessServerId = processServerId;
