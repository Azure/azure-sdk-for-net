...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class InMageRcmNicInput
    {
        ...
        /// <summary> Initializes a new instance of <see cref="InMageRcmNicInput"/>. </summary>
        ...
        internal InMageRcmNicInput(string nicId, string isPrimaryNic, string isSelectedForFailover, string targetSubnetName, string targetStaticIPAddress, string testSubnetName, string testStaticIPAddress, string targetNicName, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            NicId = nicId;
            IsPrimaryNic = isPrimaryNic;
