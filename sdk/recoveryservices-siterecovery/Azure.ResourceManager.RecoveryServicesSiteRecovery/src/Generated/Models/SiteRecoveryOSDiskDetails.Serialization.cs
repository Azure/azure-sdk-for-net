...
{
    public partial class SiteRecoveryOSDiskDetails : IUtf8JsonSerializable, IJsonModel<SiteRecoveryOSDiskDetails>, IPersistableModel<SiteRecoveryOSDiskDetails>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(OSVhdId))
            {
                builder.Append("  osVhdId:");
                builder.AppendLine($" '{OSVhdId}'");
            }
