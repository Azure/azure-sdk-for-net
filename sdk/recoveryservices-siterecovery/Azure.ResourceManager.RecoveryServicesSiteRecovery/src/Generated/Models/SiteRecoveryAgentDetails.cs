...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class SiteRecoveryAgentDetails
    {
        ...
        internal SiteRecoveryAgentDetails(string agentId, string machineId, string biosId, string fqdn, IReadOnlyList<SiteRecoveryAgentDiskDetails> disks, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            AgentId = agentId;
            MachineId = machineId;
            BiosId = biosId;
