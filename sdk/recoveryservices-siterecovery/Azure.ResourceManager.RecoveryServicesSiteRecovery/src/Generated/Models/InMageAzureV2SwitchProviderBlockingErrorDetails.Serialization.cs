...
{
    public partial class InMageAzureV2SwitchProviderBlockingErrorDetails : IUtf8JsonSerializable, IJsonModel<InMageAzureV2SwitchProviderBlockingErrorDetails>, IPersistableModel<InMageAzureV2SwitchProviderBlockingErrorDetails>
    {
        ...
        void IJsonModel<InMageAzureV2SwitchProviderBlockingErrorDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(InMageAzureV2SwitchProviderBlockingErrorDetails)} does not support '{format}' format.");
            }
