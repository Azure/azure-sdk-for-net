...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SiteRecoveryJobQueryContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SiteRecoveryJobQueryContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SiteRecoveryJobQueryContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SiteRecoveryJobQueryContent>)} interface");
            }
        ...
        string IPersistableModel<SiteRecoveryJobQueryContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
