...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class RecoveryPlanInMageFailoverContent : RecoveryPlanProviderSpecificFailoverContent
    {
        ...
        internal RecoveryPlanInMageFailoverContent(string instanceType, RpInMageRecoveryPointType recoveryPointType, Dictionary<string, BinaryData> rawData) : base(instanceType, rawData)
        {
            RecoveryPointType = recoveryPointType;
