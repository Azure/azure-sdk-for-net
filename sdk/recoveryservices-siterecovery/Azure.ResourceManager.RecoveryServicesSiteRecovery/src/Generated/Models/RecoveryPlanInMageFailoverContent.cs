...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class RecoveryPlanInMageFailoverContent : RecoveryPlanProviderSpecificFailoverContent
    {
        ...
        internal RecoveryPlanInMageFailoverContent(string instanceType, RpInMageRecoveryPointType recoveryPointType, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(instanceType, serializedAdditionalRawData)
        {
            RecoveryPointType = recoveryPointType;
