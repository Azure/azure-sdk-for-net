...
{
    internal partial class UnknownMigrationProviderSpecificSettings : IUtf8JsonSerializable, IJsonModel<MigrationProviderSpecificSettings>, IPersistableModel<MigrationProviderSpecificSettings>
    {
        ...
        void IJsonModel<MigrationProviderSpecificSettings>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MigrationProviderSpecificSettings)} does not support '{format}' format.");
            }
