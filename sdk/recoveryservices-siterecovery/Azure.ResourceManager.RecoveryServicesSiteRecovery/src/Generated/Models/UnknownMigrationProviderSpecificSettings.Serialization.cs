...
{
    internal partial class UnknownMigrationProviderSpecificSettings : IUtf8JsonSerializable, IModelJsonSerializable<MigrationProviderSpecificSettings>
    {
        ...
        internal static MigrationProviderSpecificSettings DeserializeUnknownMigrationProviderSpecificSettings(JsonElement element, ModelSerializerOptions options = default) => DeserializeMigrationProviderSpecificSettings(element, options);
        ...
        MigrationProviderSpecificSettings IModelJsonSerializable<MigrationProviderSpecificSettings>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            ...
            return DeserializeUnknownMigrationProviderSpecificSettings(doc.RootElement, options);
        }
