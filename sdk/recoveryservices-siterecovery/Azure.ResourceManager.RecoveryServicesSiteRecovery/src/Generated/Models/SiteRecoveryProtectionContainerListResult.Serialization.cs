...
{
    internal partial class SiteRecoveryProtectionContainerListResult : IUtf8JsonSerializable, IJsonModel<SiteRecoveryProtectionContainerListResult>, IPersistableModel<SiteRecoveryProtectionContainerListResult>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SiteRecoveryProtectionContainerListResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<SiteRecoveryProtectionContainerListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SiteRecoveryProtectionContainerListResult)} does not support '{format}' format.");
            }
