...
{
    internal partial class UnknownRemoveDisksProviderSpecificContent : RemoveDisksProviderSpecificContent, IJsonModel<RemoveDisksProviderSpecificContent>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownRemoveDisksProviderSpecificContent DeserializeUnknownRemoveDisksProviderSpecificContent(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownRemoveDisksProviderSpecificContent(instanceType, additionalBinaryDataProperties);
        }
    }
}
