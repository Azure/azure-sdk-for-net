...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class VMwareCbtEventDetails : SiteRecoveryEventProviderSpecificDetails
    {
        ...
        internal VMwareCbtEventDetails(string instanceType, string migrationItemName, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(instanceType, serializedAdditionalRawData)
        {
