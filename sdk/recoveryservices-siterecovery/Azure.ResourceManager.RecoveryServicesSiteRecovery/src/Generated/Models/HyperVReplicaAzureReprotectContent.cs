...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class HyperVReplicaAzureReprotectContent : ReverseReplicationProviderSpecificContent
    {
        ...
        internal HyperVReplicaAzureReprotectContent(string instanceType, string hyperVHostVmId, string vmName, string osType, string vhdId, ResourceIdentifier storageAccountId, ResourceIdentifier logStorageAccountId, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(instanceType, serializedAdditionalRawData)
        {
