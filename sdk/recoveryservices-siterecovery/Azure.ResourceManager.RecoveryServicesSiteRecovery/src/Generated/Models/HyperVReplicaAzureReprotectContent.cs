...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class HyperVReplicaAzureReprotectContent : ReverseReplicationProviderSpecificContent
    {
        ...
        public HyperVReplicaAzureReprotectContent() : base("HyperVReplicaAzure")
        {
        }
        ...
        internal HyperVReplicaAzureReprotectContent(string instanceType, IDictionary<string, BinaryData> additionalBinaryDataProperties, string hyperVHostVmId, string vmName, string osType, string vhdId, ResourceIdentifier storageAccountId, ResourceIdentifier logStorageAccountId) : base(instanceType, additionalBinaryDataProperties)
        {
