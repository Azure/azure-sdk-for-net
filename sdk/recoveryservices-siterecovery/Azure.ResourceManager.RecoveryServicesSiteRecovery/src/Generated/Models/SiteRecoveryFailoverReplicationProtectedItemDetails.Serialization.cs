...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        internal static SiteRecoveryFailoverReplicationProtectedItemDetails DeserializeSiteRecoveryFailoverReplicationProtectedItemDetails(JsonElement element)
        {
            ...
            return new SiteRecoveryFailoverReplicationProtectedItemDetails(name.Value, friendlyName.Value, testVmName.Value, testVmFriendlyName.Value, networkConnectionStatus.Value, networkFriendlyName.Value, subnet.Value, recoveryPointId.Value, Optional.ToNullable(recoveryPointTime));
        }
    }
}
