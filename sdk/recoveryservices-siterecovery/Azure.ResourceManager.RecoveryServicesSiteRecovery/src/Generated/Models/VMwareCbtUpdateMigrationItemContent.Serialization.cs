...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    public partial class VMwareCbtUpdateMigrationItemContent : IUtf8JsonSerializable, IModelJsonSerializable<VMwareCbtUpdateMigrationItemContent>
    {
        ...
        internal static VMwareCbtUpdateMigrationItemContent DeserializeVMwareCbtUpdateMigrationItemContent(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new VMwareCbtUpdateMigrationItemContent(instanceType, targetVmName.Value, targetVmSize.Value, targetResourceGroupId.Value, targetAvailabilitySetId.Value, targetAvailabilityZone.Value, targetProximityPlacementGroupId.Value, targetBootDiagnosticsStorageAccountId.Value, targetNetworkId.Value, testNetworkId.Value, Optional.ToList(vmNics), Optional.ToList(vmDisks), Optional.ToNullable(licenseType), Optional.ToNullable(sqlServerLicenseType), performAutoResync.Value, Optional.ToDictionary(targetVmTags), Optional.ToDictionary(targetDiskTags), Optional.ToDictionary(targetNicTags), rawData);
        }
