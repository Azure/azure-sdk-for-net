...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class TargetComputeSize : ResourceData
    {
        ...
        internal TargetComputeSize(ResourceIdentifier id, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, string name, TargetComputeSizeProperties properties) : base(id, name, resourceType, systemData)
        {
