...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    public partial class InMageAzureV2PolicyDetails : IUtf8JsonSerializable, IJsonModel<InMageAzureV2PolicyDetails>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<InMageAzureV2PolicyDetails>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<InMageAzureV2PolicyDetails>)} interface");
            }
