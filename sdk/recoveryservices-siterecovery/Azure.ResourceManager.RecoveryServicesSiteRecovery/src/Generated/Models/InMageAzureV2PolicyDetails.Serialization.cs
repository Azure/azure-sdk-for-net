...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    public partial class InMageAzureV2PolicyDetails : IUtf8JsonSerializable, IModelJsonSerializable<InMageAzureV2PolicyDetails>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<InMageAzureV2PolicyDetails>(this, options.Format);
        ...
        internal static InMageAzureV2PolicyDetails DeserializeInMageAzureV2PolicyDetails(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new InMageAzureV2PolicyDetails(instanceType, Optional.ToNullable(crashConsistentFrequencyInMinutes), Optional.ToNullable(recoveryPointThresholdInMinutes), Optional.ToNullable(recoveryPointHistory), Optional.ToNullable(appConsistentFrequencyInMinutes), multiVmSyncStatus.Value, serializedAdditionalRawData);
        }
