...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<InMageAzureV2PolicyDetails>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<InMageAzureV2PolicyDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<InMageAzureV2PolicyDetails>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<InMageAzureV2PolicyDetails>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
