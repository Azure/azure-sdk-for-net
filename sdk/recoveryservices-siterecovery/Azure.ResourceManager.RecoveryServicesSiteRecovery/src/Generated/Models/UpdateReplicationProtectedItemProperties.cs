...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class UpdateReplicationProtectedItemProperties
    {
        ...
        internal UpdateReplicationProtectedItemProperties(string recoveryAzureVmName, string recoveryAzureVmSize, ResourceIdentifier selectedRecoveryAzureNetworkId, ResourceIdentifier selectedTfoAzureNetworkId, string selectedSourceNicId, string enableRdpOnTargetOption, IList<VmNicContentDetails> vmNics, SiteRecoveryLicenseType? licenseType, ResourceIdentifier recoveryAvailabilitySetId, UpdateReplicationProtectedItemProviderContent providerSpecificDetails, Dictionary<string, BinaryData> rawData)
        {
