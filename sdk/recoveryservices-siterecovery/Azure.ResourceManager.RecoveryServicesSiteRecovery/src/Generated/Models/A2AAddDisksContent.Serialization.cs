...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<A2AAddDisksContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<A2AAddDisksContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<A2AAddDisksContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<A2AAddDisksContent>)} interface");
            }
        ...
        string IPersistableModel<A2AAddDisksContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
