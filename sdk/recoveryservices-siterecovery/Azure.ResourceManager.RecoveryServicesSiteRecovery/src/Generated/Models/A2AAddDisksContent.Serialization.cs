...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class A2AAddDisksContent : SiteRecoveryAddDisksProviderSpecificContent, IJsonModel<A2AAddDisksContent>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<A2AAddDisksContent>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<A2AAddDisksContent>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        A2AAddDisksContent IPersistableModel<A2AAddDisksContent>.Create(BinaryData data, ModelReaderWriterOptions options) => (A2AAddDisksContent)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        A2AAddDisksContent IJsonModel<A2AAddDisksContent>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (A2AAddDisksContent)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static A2AAddDisksContent DeserializeA2AAddDisksContent(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new A2AAddDisksContent(instanceType, additionalBinaryDataProperties, vmDisks ?? new ChangeTrackingList<A2AVmDiskDetails>(), vmManagedDisks ?? new ChangeTrackingList<A2AVmManagedDiskDetails>());
        }
    }
}
