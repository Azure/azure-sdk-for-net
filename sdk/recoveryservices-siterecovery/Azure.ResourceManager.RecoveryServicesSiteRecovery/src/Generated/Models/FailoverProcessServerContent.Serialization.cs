...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FailoverProcessServerContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<FailoverProcessServerContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<FailoverProcessServerContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<FailoverProcessServerContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
