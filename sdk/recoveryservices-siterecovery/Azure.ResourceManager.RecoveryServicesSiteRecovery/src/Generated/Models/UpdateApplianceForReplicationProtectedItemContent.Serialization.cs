...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<UpdateApplianceForReplicationProtectedItemContent>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<UpdateApplianceForReplicationProtectedItemContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<UpdateApplianceForReplicationProtectedItemContent>)} interface");
            }
        ...
        string IPersistableModel<UpdateApplianceForReplicationProtectedItemContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
