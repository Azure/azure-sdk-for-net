...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class RecoveryPlanInMageRcmFailoverContent : RecoveryPlanProviderSpecificFailoverContent
    {
        ...
        public RecoveryPlanInMageRcmFailoverContent(RecoveryPlanPointType recoveryPointType) : base("InMageRcm")
        {
        ...
        internal RecoveryPlanInMageRcmFailoverContent(string instanceType, IDictionary<string, BinaryData> additionalBinaryDataProperties, RecoveryPlanPointType recoveryPointType, string useMultiVmSyncPoint) : base(instanceType, additionalBinaryDataProperties)
        {
            RecoveryPointType = recoveryPointType;
