...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class RecoveryPlanInMageRcmFailoverContent : RecoveryPlanProviderSpecificFailoverContent
    {
        ...
        internal RecoveryPlanInMageRcmFailoverContent(string instanceType, RecoveryPlanPointType recoveryPointType, string useMultiVmSyncPoint, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(instanceType, serializedAdditionalRawData)
        {
            RecoveryPointType = recoveryPointType;
