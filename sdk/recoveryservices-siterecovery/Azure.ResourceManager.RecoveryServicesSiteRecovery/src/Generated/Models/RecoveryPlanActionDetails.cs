...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    /// </summary>
    [DeserializationProxy(typeof(UnknownRecoveryPlanActionDetails))]
    public abstract partial class RecoveryPlanActionDetails
    {
        ...
        internal RecoveryPlanActionDetails(string instanceType, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
