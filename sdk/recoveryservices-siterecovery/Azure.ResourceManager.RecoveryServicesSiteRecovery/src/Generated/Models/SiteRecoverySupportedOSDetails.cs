...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class SiteRecoverySupportedOSDetails
    {
        ...
        internal SiteRecoverySupportedOSDetails(string osName, string osType, IReadOnlyList<SiteRecoveryOSVersionWrapper> osVersions, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            OSName = osName;
            OSType = osType;
