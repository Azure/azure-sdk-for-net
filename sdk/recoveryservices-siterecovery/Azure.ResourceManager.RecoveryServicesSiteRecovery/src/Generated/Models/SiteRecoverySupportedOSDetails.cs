...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class SiteRecoverySupportedOSDetails
    {
        ...
        internal SiteRecoverySupportedOSDetails(string osName, string osType, IReadOnlyList<SiteRecoveryOSVersionWrapper> osVersions, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            OSName = osName;
            OSType = osType;
