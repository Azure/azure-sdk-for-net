...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class InMageAzureV2PolicyDetails : PolicyProviderSpecificDetails
    {
        ...
        internal InMageAzureV2PolicyDetails(string instanceType, int? crashConsistentFrequencyInMinutes, int? recoveryPointThresholdInMinutes, int? recoveryPointHistory, int? appConsistentFrequencyInMinutes, string multiVmSyncStatus, Dictionary<string, BinaryData> rawData) : base(instanceType, rawData)
        {
