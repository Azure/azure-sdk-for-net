...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class InMageAzureV2PolicyDetails : PolicyProviderSpecificDetails
    {
        ...
        internal InMageAzureV2PolicyDetails() : base("InMageAzureV2")
        {
        }
        ...
        internal InMageAzureV2PolicyDetails(string instanceType, IDictionary<string, BinaryData> additionalBinaryDataProperties, int? crashConsistentFrequencyInMinutes, int? recoveryPointThresholdInMinutes, int? recoveryPointHistory, int? appConsistentFrequencyInMinutes, string multiVmSyncStatus) : base(instanceType, additionalBinaryDataProperties)
        {
