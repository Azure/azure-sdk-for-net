...
{
    public partial class SiteRecoveryNetworkMappingProperties : IUtf8JsonSerializable, IJsonModel<SiteRecoveryNetworkMappingProperties>, IPersistableModel<SiteRecoveryNetworkMappingProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(FabricSpecificSettings))
            {
                ...
                AppendChildObject(builder, FabricSpecificSettings, options, 2);
            }
