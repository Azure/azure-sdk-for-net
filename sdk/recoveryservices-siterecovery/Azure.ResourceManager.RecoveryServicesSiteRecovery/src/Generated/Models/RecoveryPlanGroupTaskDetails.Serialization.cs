...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RecoveryPlanGroupTaskDetails>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RecoveryPlanGroupTaskDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RecoveryPlanGroupTaskDetails>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<RecoveryPlanGroupTaskDetails>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
