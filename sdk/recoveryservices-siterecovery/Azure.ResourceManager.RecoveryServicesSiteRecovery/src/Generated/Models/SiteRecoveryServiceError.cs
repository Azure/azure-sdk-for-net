...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class SiteRecoveryServiceError
    {
        ...
        internal SiteRecoveryServiceError(string code, string message, string possibleCauses, string recommendedAction, string activityId, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Code = code;
            Message = message;
