...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class SiteRecoveryServiceError
    {
        ...
        internal SiteRecoveryServiceError(string code, string message, string possibleCauses, string recommendedAction, string activityId, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Code = code;
            Message = message;
