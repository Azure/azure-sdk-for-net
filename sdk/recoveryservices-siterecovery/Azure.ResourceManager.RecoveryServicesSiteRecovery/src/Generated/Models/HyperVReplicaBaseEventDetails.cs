...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class HyperVReplicaBaseEventDetails : EventProviderSpecificDetails
    {
        ...
        internal HyperVReplicaBaseEventDetails() : base("HyperVReplicaBaseEventDetails")
        {
        }
        ...
        internal HyperVReplicaBaseEventDetails(string instanceType, IDictionary<string, BinaryData> additionalBinaryDataProperties, string containerName, string fabricName, string remoteContainerName, string remoteFabricName) : base(instanceType, additionalBinaryDataProperties)
        {
