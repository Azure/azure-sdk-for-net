...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class HyperVReplicaBaseEventDetails : SiteRecoveryEventProviderSpecificDetails
    {
        ...
        internal HyperVReplicaBaseEventDetails(string instanceType, string containerName, string fabricName, string remoteContainerName, string remoteFabricName, Dictionary<string, BinaryData> rawData) : base(instanceType, rawData)
        {
