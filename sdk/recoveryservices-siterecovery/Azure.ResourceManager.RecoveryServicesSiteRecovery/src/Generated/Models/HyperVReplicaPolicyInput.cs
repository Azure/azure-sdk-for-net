...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="HyperVReplicaPolicyInput"/>. </summary>
        public HyperVReplicaPolicyInput() : base("HyperVReplica2012")
        {
        }
        ...
        internal HyperVReplicaPolicyInput(string instanceType, IDictionary<string, BinaryData> additionalBinaryDataProperties, int? recoveryPoints, int? applicationConsistentSnapshotFrequencyInHours, string compression, string initialReplicationMethod, string onlineReplicationStartTime, string offlineReplicationImportPath, string offlineReplicationExportPath, int? replicationPort, int? allowedAuthenticationType, string replicaDeletion) : base(instanceType, additionalBinaryDataProperties)
        {
        ...
        /// <summary> Initializes a new instance of <see cref="HyperVReplicaPolicyInput"/>. </summary>
        /// <param name="instanceType"> The class type. </param>
        private protected HyperVReplicaPolicyInput(string instanceType) : base(instanceType)
        {
        }
