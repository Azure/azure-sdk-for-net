...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="InMageUnplannedFailoverInput"/>. </summary>
        public InMageUnplannedFailoverInput() : base("InMage")
        {
        }
        ...
        internal InMageUnplannedFailoverInput(string instanceType, IDictionary<string, BinaryData> additionalBinaryDataProperties, RecoveryPointType? recoveryPointType, string recoveryPointId) : base(instanceType, additionalBinaryDataProperties)
        {
