...
{
    public partial class A2AExtendedLocationDetails : IUtf8JsonSerializable, IJsonModel<A2AExtendedLocationDetails>, IPersistableModel<A2AExtendedLocationDetails>
    {
        ...
        void IJsonModel<A2AExtendedLocationDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(A2AExtendedLocationDetails)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(PrimaryExtendedLocation))
            {
                ...
                AppendChildObject(builder, PrimaryExtendedLocation, options, 2);
            }

            if (Optional.IsDefined(RecoveryExtendedLocation))
            {
                builder.Append("  recoveryExtendedLocation:");
                AppendChildObject(builder, RecoveryExtendedLocation, options, 2);
            }
