...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class RecoveryPlanUnplannedFailoverProperties
    {
        ...
        internal RecoveryPlanUnplannedFailoverProperties(PossibleOperationsDirection failoverDirection, SourceSiteOperation sourceSiteOperation, IList<RecoveryPlanProviderSpecificFailoverContent> providerSpecificDetails, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            FailoverDirection = failoverDirection;
            SourceSiteOperation = sourceSiteOperation;
