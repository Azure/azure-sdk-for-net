...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class RecoveryPlanUnplannedFailoverProperties
    {
        ...
        internal RecoveryPlanUnplannedFailoverProperties(PossibleOperationsDirection failoverDirection, SourceSiteOperation sourceSiteOperation, IList<RecoveryPlanProviderSpecificFailoverContent> providerSpecificDetails, Dictionary<string, BinaryData> rawData)
        {
            FailoverDirection = failoverDirection;
            SourceSiteOperation = sourceSiteOperation;
