...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class HyperVReplica2012R2EventDetails : SiteRecoveryEventProviderSpecificDetails
    {
        ...
        internal HyperVReplica2012R2EventDetails(string instanceType, IDictionary<string, BinaryData> serializedAdditionalRawData, string containerName, string fabricName, string remoteContainerName, string remoteFabricName) : base(instanceType, serializedAdditionalRawData)
        {
