...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class HyperVReplica2012R2EventDetails : SiteRecoveryEventProviderSpecificDetails
    {
        /// <summary> Initializes a new instance of <see cref="HyperVReplica2012R2EventDetails"/>. </summary>
        internal HyperVReplica2012R2EventDetails() : base("HyperVReplica2012R2")
        {
        }
        ...
        internal HyperVReplica2012R2EventDetails(string instanceType, IDictionary<string, BinaryData> additionalBinaryDataProperties, string containerName, string fabricName, string remoteContainerName, string remoteFabricName) : base(instanceType, additionalBinaryDataProperties)
        {
