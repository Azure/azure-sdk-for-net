...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class SiteRecoveryVmTaskDetails : SiteRecoveryJobTaskDetails
    {
        ...
        internal SiteRecoveryVmTaskDetails(string instanceType, SiteRecoveryJobEntity jobTask, string skippedReason, string skippedReasonString, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(instanceType, jobTask, serializedAdditionalRawData)
        {
