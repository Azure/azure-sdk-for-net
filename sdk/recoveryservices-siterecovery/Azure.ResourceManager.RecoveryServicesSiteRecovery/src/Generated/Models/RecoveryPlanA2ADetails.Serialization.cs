...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    public partial class RecoveryPlanA2ADetails : IUtf8JsonSerializable, IJsonModel<RecoveryPlanA2ADetails>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<RecoveryPlanA2ADetails>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RecoveryPlanA2ADetails>)} interface");
            }
