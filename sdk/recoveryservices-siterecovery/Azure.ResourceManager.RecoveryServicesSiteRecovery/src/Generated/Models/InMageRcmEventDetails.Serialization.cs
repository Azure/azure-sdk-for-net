...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class InMageRcmEventDetails : SiteRecoveryEventProviderSpecificDetails, IJsonModel<InMageRcmEventDetails>
    {
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected override SiteRecoveryEventProviderSpecificDetails PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
        ...
        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected override SiteRecoveryEventProviderSpecificDetails JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<InMageRcmEventDetails>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
