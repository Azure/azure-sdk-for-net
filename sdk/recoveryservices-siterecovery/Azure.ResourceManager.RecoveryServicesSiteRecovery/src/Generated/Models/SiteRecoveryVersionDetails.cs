...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class SiteRecoveryVersionDetails
    {
        ...
        internal SiteRecoveryVersionDetails(string version, DateTimeOffset? expireOn, SiteRecoveryAgentVersionStatus? status, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Version = version;
            ExpireOn = expireOn;
            Status = status;
