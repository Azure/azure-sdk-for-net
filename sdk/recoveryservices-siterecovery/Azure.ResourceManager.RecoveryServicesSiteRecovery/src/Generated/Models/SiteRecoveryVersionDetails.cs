...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class SiteRecoveryVersionDetails
    {
        ...
        internal SiteRecoveryVersionDetails(string version, DateTimeOffset? expireOn, SiteRecoveryAgentVersionStatus? status, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Version = version;
            ExpireOn = expireOn;
            Status = status;
