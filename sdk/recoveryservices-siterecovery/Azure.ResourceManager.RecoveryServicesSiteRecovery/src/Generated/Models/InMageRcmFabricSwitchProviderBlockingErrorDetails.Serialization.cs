...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<InMageRcmFabricSwitchProviderBlockingErrorDetails>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<InMageRcmFabricSwitchProviderBlockingErrorDetails>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<InMageRcmFabricSwitchProviderBlockingErrorDetails>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
