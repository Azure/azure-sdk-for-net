...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class HyperVReplicaAzurePolicyContent : PolicyProviderSpecificContent
    {
        ...
        internal HyperVReplicaAzurePolicyContent(string instanceType, int? recoveryPointHistoryDuration, int? applicationConsistentSnapshotFrequencyInHours, int? replicationInterval, string onlineReplicationStartTime, IList<string> storageAccounts, Dictionary<string, BinaryData> rawData) : base(instanceType, rawData)
        {
