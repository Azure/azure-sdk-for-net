...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class ClusterTestFailoverJobDetails : SiteRecoveryJobDetails
    {
        /// <summary> Initializes a new instance of <see cref="ClusterTestFailoverJobDetails"/>. </summary>
        internal ClusterTestFailoverJobDetails()
        {
        ...
        internal ClusterTestFailoverJobDetails(string instanceType, IReadOnlyDictionary<string, string> affectedObjectDetails, IDictionary<string, BinaryData> serializedAdditionalRawData, string testFailoverStatus, string comments, string networkName, string networkFriendlyName, string networkType, IReadOnlyList<FailoverReplicationProtectedItemDetails> protectedItemDetails) : base(instanceType, affectedObjectDetails, serializedAdditionalRawData)
        {
            ...
            InstanceType = instanceType ?? "ClusterTestFailoverJobDetails";
        }
