    ...
    public partial class A2AReplicationIntentDetails : IUtf8JsonSerializable, IJsonModel<A2AReplicationIntentDetails>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(RecoverySubscriptionId))
            {
                ...
                if (RecoverySubscriptionId.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(AutoProtectionOfDataDisk))
            {
                ...
                builder.AppendLine($" '{AutoProtectionOfDataDisk.Value.ToString()}'");
            }

            if (Optional.IsDefined(MultiVmGroupName))
            {
                builder.Append("  multiVmGroupName:");
                if (MultiVmGroupName.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(MultiVmGroupId))
            {
                ...
                if (MultiVmGroupId.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(RecoveryAvailabilityZone))
            {
                ...
                if (RecoveryAvailabilityZone.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(RecoveryAvailabilityType))
            {
                ...
                if (RecoveryAvailabilityType.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
