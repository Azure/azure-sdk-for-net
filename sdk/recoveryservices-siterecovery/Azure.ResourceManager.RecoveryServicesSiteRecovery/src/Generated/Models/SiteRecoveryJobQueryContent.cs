...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class SiteRecoveryJobQueryContent
    {
        ...
        internal SiteRecoveryJobQueryContent(string startOn, string endOn, ResourceIdentifier fabricId, string affectedObjectTypes, string jobStatus, ExportJobOutputSerializationType? jobOutputType, string jobName, double? timezoneOffset, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            StartOn = startOn;
            EndOn = endOn;
            FabricId = fabricId;
