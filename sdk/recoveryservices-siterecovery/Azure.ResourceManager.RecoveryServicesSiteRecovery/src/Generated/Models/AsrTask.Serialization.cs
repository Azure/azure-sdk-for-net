...
{
    public partial class AsrTask : IUtf8JsonSerializable, IJsonModel<AsrTask>, IPersistableModel<AsrTask>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(GroupTaskCustomDetails))
            {
                ...
                AppendChildObject(builder, GroupTaskCustomDetails, options, 2);
            }
