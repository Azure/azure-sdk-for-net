...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class TestFailoverJobDetails : SiteRecoveryJobDetails
    {
        ...
        internal TestFailoverJobDetails(string instanceType, IReadOnlyDictionary<string, string> affectedObjectDetails, IDictionary<string, BinaryData> additionalBinaryDataProperties, string testFailoverStatus, string comments, string networkName, string networkFriendlyName, string networkType, IReadOnlyList<FailoverReplicationProtectedItemDetails> protectedItemDetails) : base(instanceType, affectedObjectDetails, additionalBinaryDataProperties)
        {
