...
{
    internal partial class UnknownHyperVReplicaPolicyInput : HyperVReplicaPolicyInput
    {
        /// <summary> Initializes a new instance of <see cref="UnknownHyperVReplicaPolicyInput"/>. </summary>
        ...
        internal UnknownHyperVReplicaPolicyInput(string instanceType, IDictionary<string, BinaryData> additionalBinaryDataProperties, int? recoveryPoints, int? applicationConsistentSnapshotFrequencyInHours, string compression, string initialReplicationMethod, string onlineReplicationStartTime, string offlineReplicationImportPath, string offlineReplicationExportPath, int? replicationPort, int? allowedAuthenticationType, string replicaDeletion) : base(instanceType ?? "unknown", additionalBinaryDataProperties, recoveryPoints, applicationConsistentSnapshotFrequencyInHours, compression, initialReplicationMethod, onlineReplicationStartTime, offlineReplicationImportPath, offlineReplicationExportPath, replicationPort, allowedAuthenticationType, replicaDeletion)
        {
        }
    }
}
