...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ResumeReplicationContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ResumeReplicationContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ResumeReplicationContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ResumeReplicationContent>)} interface");
            }
        ...
        string IPersistableModel<ResumeReplicationContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
