...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<A2ACrossClusterMigrationReplicationDetails>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<A2ACrossClusterMigrationReplicationDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<A2ACrossClusterMigrationReplicationDetails>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<A2ACrossClusterMigrationReplicationDetails>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
