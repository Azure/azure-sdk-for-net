...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    internal partial class UnknownRecoveryPlanProviderSpecificDetails : IUtf8JsonSerializable, IJsonModel<RecoveryPlanProviderSpecificDetails>
    {
        ...
        void IJsonModel<RecoveryPlanProviderSpecificDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(RecoveryPlanProviderSpecificDetails)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<RecoveryPlanProviderSpecificDetails>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(RecoveryPlanProviderSpecificDetails)} does not support '{options.Format}' format.");
            }
        }
