...
{
    public partial class VMwareCbtEventDetails : IUtf8JsonSerializable, IJsonModel<VMwareCbtEventDetails>, IPersistableModel<VMwareCbtEventDetails>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  migrationItemName:");
                builder.AppendLine($" '{MigrationItemName}'");
            }
