...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public abstract partial class SiteRecoveryReplicationProviderSettings : IJsonModel<SiteRecoveryReplicationProviderSettings>
    {
        ...
        protected virtual SiteRecoveryReplicationProviderSettings PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
        ...
        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual SiteRecoveryReplicationProviderSettings JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<SiteRecoveryReplicationProviderSettings>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static SiteRecoveryReplicationProviderSettings DeserializeSiteRecoveryReplicationProviderSettings(JsonElement element, ModelReaderWriterOptions options)
        {
