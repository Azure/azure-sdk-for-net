...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SwitchProtectionProperties>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ProviderSpecificDetails))
            {
                ...
                ((IJsonModel<SwitchProtectionProviderSpecificContent>)ProviderSpecificDetails).Write(writer, options);
            }
        ...
        internal static SwitchProtectionProperties DeserializeSwitchProtectionProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("providerSpecificDetails"u8))
                {
                    ...
                    providerSpecificDetails = ModelSerializationExtensions.JsonDeserialize<SwitchProtectionProviderSpecificContent>(property.Value);
                    continue;
                }
                if (options.Format != "W")
                {
