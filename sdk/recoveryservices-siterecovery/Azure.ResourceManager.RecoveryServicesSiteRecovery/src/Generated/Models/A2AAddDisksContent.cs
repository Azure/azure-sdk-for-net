...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class A2AAddDisksContent : SiteRecoveryAddDisksProviderSpecificContent
    {
        ...
        internal A2AAddDisksContent(string instanceType, IList<A2AVmDiskDetails> vmDisks, IList<A2AVmManagedDiskDetails> vmManagedDisks, Dictionary<string, BinaryData> rawData) : base(instanceType, rawData)
        {
            VmDisks = vmDisks;
