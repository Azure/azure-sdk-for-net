...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class InMageFabricSwitchProviderBlockingErrorDetails
    {
        ...
        internal InMageFabricSwitchProviderBlockingErrorDetails(string errorCode, string errorMessage, string possibleCauses, string recommendedAction, IReadOnlyDictionary<string, string> errorMessageParameters, IReadOnlyDictionary<string, string> errorTags, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ErrorCode = errorCode;
