...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class SiteRecoveryJobTaskDetails : SiteRecoveryTaskTypeDetails
    {
        ...
        internal SiteRecoveryJobTaskDetails(string instanceType, SiteRecoveryJobEntity jobTask, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(instanceType, serializedAdditionalRawData)
        {
            JobTask = jobTask;
