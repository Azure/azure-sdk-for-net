...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    public partial class InMageFabricSwitchProviderBlockingErrorDetails
    {
        internal static InMageFabricSwitchProviderBlockingErrorDetails DeserializeInMageFabricSwitchProviderBlockingErrorDetails(JsonElement element)
        {
            ...
            return new InMageFabricSwitchProviderBlockingErrorDetails(errorCode.Value, errorMessage.Value, possibleCauses.Value, recommendedAction.Value, Optional.ToDictionary(errorMessageParameters), Optional.ToDictionary(errorTags));
        }
    }
}
