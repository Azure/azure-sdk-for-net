...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SiteRecoverySubnet>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SiteRecoverySubnet>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SiteRecoverySubnet>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SiteRecoverySubnet>)} interface");
            }
        ...
        string IPersistableModel<SiteRecoverySubnet>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
