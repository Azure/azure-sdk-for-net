...
{
    public partial class SiteRecoverySubnet : IUtf8JsonSerializable, IJsonModel<SiteRecoverySubnet>, IPersistableModel<SiteRecoverySubnet>
    {
        ...
        void IJsonModel<SiteRecoverySubnet>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SiteRecoverySubnet)} does not support '{format}' format.");
            }
