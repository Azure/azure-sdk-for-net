...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SiteRecoveryPolicyListResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(Value))
            {
                ...
                {
                    ((IJsonModel<SiteRecoveryPolicyData>)item).Write(writer, options);
                }
        ...
        internal static SiteRecoveryPolicyListResult DeserializeSiteRecoveryPolicyListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            IReadOnlyList<SiteRecoveryPolicyData> value = default;
            ...
            return new SiteRecoveryPolicyListResult(value ?? new ChangeTrackingList<SiteRecoveryPolicyData>(), nextLink, serializedAdditionalRawData);
        }
