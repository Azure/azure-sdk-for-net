...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ReplicationProviderSpecificUpdateContainerMappingContent>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<ReplicationProviderSpecificUpdateContainerMappingContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ReplicationProviderSpecificUpdateContainerMappingContent>)} interface");
            }
        ...
        string IPersistableModel<ReplicationProviderSpecificUpdateContainerMappingContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
