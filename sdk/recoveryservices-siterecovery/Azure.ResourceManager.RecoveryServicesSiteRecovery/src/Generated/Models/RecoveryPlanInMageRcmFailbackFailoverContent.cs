...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class RecoveryPlanInMageRcmFailbackFailoverContent : RecoveryPlanProviderSpecificFailoverContent
    {
        ...
        internal RecoveryPlanInMageRcmFailbackFailoverContent(string instanceType, InMageRcmFailbackRecoveryPointType recoveryPointType, string useMultiVmSyncPoint, Dictionary<string, BinaryData> rawData) : base(instanceType, rawData)
        {
            RecoveryPointType = recoveryPointType;
