...
{
    public partial class TargetComputeSizeProperties : IUtf8JsonSerializable, IJsonModel<TargetComputeSizeProperties>, IPersistableModel<TargetComputeSizeProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(CpuCoresCount))
            {
                ...
                builder.AppendLine($" '{CpuCoresCount.Value.ToString()}'");
            }
            ...
            if (Optional.IsDefined(MaxNicsCount))
            {
                ...
                builder.AppendLine($" '{MaxNicsCount.Value.ToString()}'");
            }
