...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="InMageAzureV2UpdateReplicationProtectedItemInput"/>. </summary>
        public InMageAzureV2UpdateReplicationProtectedItemInput() : base("InMageAzureV2")
        {
        ...
        internal InMageAzureV2UpdateReplicationProtectedItemInput(string instanceType, IDictionary<string, BinaryData> additionalBinaryDataProperties, string recoveryAzureV1ResourceGroupId, string recoveryAzureV2ResourceGroupId, string useManagedDisks, string targetProximityPlacementGroupId, string targetAvailabilityZone, IDictionary<string, string> targetVmTags, IDictionary<string, string> targetManagedDiskTags, IDictionary<string, string> targetNicTags, SqlServerLicenseType? sqlServerLicenseType, IList<UpdateDiskInput> vmDisks) : base(instanceType, additionalBinaryDataProperties)
        {
