...
{
    internal partial class UnknownHyperVVmDetails : HyperVVmDetails, IJsonModel<HyperVVmDetails>
    {
        /// <summary> Initializes a new instance of <see cref="UnknownHyperVVmDetails"/> for deserialization. </summary>
        internal UnknownHyperVVmDetails()
        {
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownHyperVVmDetails DeserializeUnknownHyperVVmDetails(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownHyperVVmDetails(
                instanceType,
