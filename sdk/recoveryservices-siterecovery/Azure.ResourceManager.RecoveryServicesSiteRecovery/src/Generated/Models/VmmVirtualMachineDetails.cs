...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="VmmVirtualMachineDetails"/>. </summary>
        ...
        internal VmmVirtualMachineDetails(string instanceType, IDictionary<string, BinaryData> additionalBinaryDataProperties, string sourceItemId, string generation, OSDetails osDetails, IList<DiskDetails> diskDetails, PresenceStatus? hasPhysicalDisk, PresenceStatus? hasFibreChannelAdapter, PresenceStatus? hasSharedVhd, string hyperVHostId) : base(instanceType, additionalBinaryDataProperties, sourceItemId, generation, osDetails, diskDetails, hasPhysicalDisk, hasFibreChannelAdapter, hasSharedVhd, hyperVHostId)
        {
        }
    }
}
