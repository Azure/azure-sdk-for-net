...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    public partial class InMageRcmRecoveryPointDetails : IUtf8JsonSerializable, IModelJsonSerializable<InMageRcmRecoveryPointDetails>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<InMageRcmRecoveryPointDetails>(this, options.Format);
        ...
        internal static InMageRcmRecoveryPointDetails DeserializeInMageRcmRecoveryPointDetails(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new InMageRcmRecoveryPointDetails(instanceType, isMultiVmSyncPoint.Value, serializedAdditionalRawData);
        }
        ...
        /// <summary> Converts a <see cref="InMageRcmRecoveryPointDetails"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="InMageRcmRecoveryPointDetails"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="InMageRcmRecoveryPointDetails"/>. </summary>
