...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class AutomationRunbookTaskDetails : SiteRecoveryTaskTypeDetails
    {
        ...
        internal AutomationRunbookTaskDetails(string instanceType, string name, string cloudServiceName, string subscriptionId, string accountName, string runbookId, string runbookName, ResourceIdentifier jobId, string jobOutput, bool? isPrimarySideScript, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(instanceType, serializedAdditionalRawData)
        {
            Name = name;
