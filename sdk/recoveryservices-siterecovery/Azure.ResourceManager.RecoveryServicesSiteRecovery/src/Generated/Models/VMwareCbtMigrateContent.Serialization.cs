...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class VMwareCbtMigrateContent : MigrateProviderSpecificContent, IJsonModel<VMwareCbtMigrateContent>
    {
        ...
        protected override MigrateProviderSpecificContent PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<VMwareCbtMigrateContent>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<VMwareCbtMigrateContent>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        VMwareCbtMigrateContent IPersistableModel<VMwareCbtMigrateContent>.Create(BinaryData data, ModelReaderWriterOptions options) => (VMwareCbtMigrateContent)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        VMwareCbtMigrateContent IJsonModel<VMwareCbtMigrateContent>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (VMwareCbtMigrateContent)JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected override MigrateProviderSpecificContent JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<VMwareCbtMigrateContent>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static VMwareCbtMigrateContent DeserializeVMwareCbtMigrateContent(JsonElement element, ModelReaderWriterOptions options)
        {
