...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VMwareCbtMigrateContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<VMwareCbtMigrateContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<VMwareCbtMigrateContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<VMwareCbtMigrateContent>)} interface");
            }
        ...
        string IPersistableModel<VMwareCbtMigrateContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
