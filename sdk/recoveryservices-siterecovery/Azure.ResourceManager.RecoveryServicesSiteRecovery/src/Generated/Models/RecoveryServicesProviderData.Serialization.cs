...
{
    public partial class RecoveryServicesProviderData
    {
        internal static RecoveryServicesProviderData DeserializeRecoveryServicesProviderData(JsonElement element)
        {
            ...
            return new RecoveryServicesProviderData(id, name, type, systemData.Value, properties.Value, Optional.ToNullable(location));
        }
    }
}
