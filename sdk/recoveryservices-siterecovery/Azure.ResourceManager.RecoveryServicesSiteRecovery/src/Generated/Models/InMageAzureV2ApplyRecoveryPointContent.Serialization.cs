...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<InMageAzureV2ApplyRecoveryPointContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<InMageAzureV2ApplyRecoveryPointContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<InMageAzureV2ApplyRecoveryPointContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<InMageAzureV2ApplyRecoveryPointContent>)} interface");
            }
        ...
        string IPersistableModel<InMageAzureV2ApplyRecoveryPointContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
