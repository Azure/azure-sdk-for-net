...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<UnplannedFailoverProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<UnplannedFailoverProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<UnplannedFailoverProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<UnplannedFailoverProperties>)} interface");
            }
        ...
        string IPersistableModel<UnplannedFailoverProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
