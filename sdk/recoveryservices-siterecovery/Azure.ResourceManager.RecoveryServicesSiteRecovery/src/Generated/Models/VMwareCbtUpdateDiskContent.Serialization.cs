...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VMwareCbtUpdateDiskContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<VMwareCbtUpdateDiskContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<VMwareCbtUpdateDiskContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<VMwareCbtUpdateDiskContent>)} interface");
            }
        ...
        string IPersistableModel<VMwareCbtUpdateDiskContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
