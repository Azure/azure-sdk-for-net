...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public abstract partial class SiteRecoveryReplicationProviderSettings
    {
        ...
        private protected SiteRecoveryReplicationProviderSettings(string instanceType)
        {
        ...
        internal SiteRecoveryReplicationProviderSettings(string instanceType, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            InstanceType = instanceType;
