...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<InMageDiskSignatureExclusionOptions>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<InMageDiskSignatureExclusionOptions>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<InMageDiskSignatureExclusionOptions>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<InMageDiskSignatureExclusionOptions>)} interface");
            }
        ...
        string IPersistableModel<InMageDiskSignatureExclusionOptions>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
