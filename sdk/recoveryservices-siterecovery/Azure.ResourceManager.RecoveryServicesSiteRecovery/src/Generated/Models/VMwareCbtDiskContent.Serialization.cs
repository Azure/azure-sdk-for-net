...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VMwareCbtDiskContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<VMwareCbtDiskContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<VMwareCbtDiskContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<VMwareCbtDiskContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
