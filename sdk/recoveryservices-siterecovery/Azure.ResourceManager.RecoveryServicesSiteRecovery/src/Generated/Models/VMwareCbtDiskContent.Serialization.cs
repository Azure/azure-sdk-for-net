...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    public partial class VMwareCbtDiskContent : IUtf8JsonSerializable, IJsonModel<VMwareCbtDiskContent>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<VMwareCbtDiskContent>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<VMwareCbtDiskContent>)} interface");
            }
