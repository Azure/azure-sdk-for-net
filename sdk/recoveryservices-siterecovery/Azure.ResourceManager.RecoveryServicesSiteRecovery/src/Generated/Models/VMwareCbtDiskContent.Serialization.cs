...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    public partial class VMwareCbtDiskContent : IUtf8JsonSerializable, IJsonModel<VMwareCbtDiskContent>
    {
        ...
        void IJsonModel<VMwareCbtDiskContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(VMwareCbtDiskContent)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<VMwareCbtDiskContent>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(VMwareCbtDiskContent)} does not support '{options.Format}' format.");
            }
        }
