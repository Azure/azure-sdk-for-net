...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StorageClassificationMappingProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<StorageClassificationMappingProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<StorageClassificationMappingProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<StorageClassificationMappingProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
