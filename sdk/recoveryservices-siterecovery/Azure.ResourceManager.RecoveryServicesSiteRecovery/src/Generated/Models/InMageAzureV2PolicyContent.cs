...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class InMageAzureV2PolicyContent : PolicyProviderSpecificContent
    {
        ...
        internal InMageAzureV2PolicyContent(string instanceType, int? recoveryPointThresholdInMinutes, int? recoveryPointHistory, int? crashConsistentFrequencyInMinutes, int? appConsistentFrequencyInMinutes, SetMultiVmSyncStatus multiVmSyncStatus, Dictionary<string, BinaryData> rawData) : base(instanceType, rawData)
        {
