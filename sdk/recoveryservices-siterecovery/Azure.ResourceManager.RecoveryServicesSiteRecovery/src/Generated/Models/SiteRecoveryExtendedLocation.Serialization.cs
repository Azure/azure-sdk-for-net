...
{
    public partial class SiteRecoveryExtendedLocation : IUtf8JsonSerializable, IJsonModel<SiteRecoveryExtendedLocation>, IPersistableModel<SiteRecoveryExtendedLocation>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SiteRecoveryExtendedLocation>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<SiteRecoveryExtendedLocation>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SiteRecoveryExtendedLocation)} does not support '{format}' format.");
            }
