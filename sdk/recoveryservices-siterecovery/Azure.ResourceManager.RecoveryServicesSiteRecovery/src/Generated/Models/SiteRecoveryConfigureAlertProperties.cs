...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class SiteRecoveryConfigureAlertProperties
    {
        ...
        internal SiteRecoveryConfigureAlertProperties(string sendToOwners, IList<string> customEmailAddresses, string locale, Dictionary<string, BinaryData> rawData)
        {
