...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class SiteRecoveryConfigureAlertProperties
    {
        ...
        internal SiteRecoveryConfigureAlertProperties(string sendToOwners, IList<string> customEmailAddresses, string locale, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
