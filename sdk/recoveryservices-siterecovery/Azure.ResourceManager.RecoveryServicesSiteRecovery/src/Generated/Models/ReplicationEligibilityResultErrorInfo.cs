...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class ReplicationEligibilityResultErrorInfo
    {
        ...
        internal ReplicationEligibilityResultErrorInfo(string code, string message, string possibleCauses, string recommendedAction, string status, Dictionary<string, BinaryData> rawData)
        {
            Code = code;
            Message = message;
