...
{
    public partial class RecoveryPlanAction : IUtf8JsonSerializable, IJsonModel<RecoveryPlanAction>, IPersistableModel<RecoveryPlanAction>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(FailoverTypes))
            {
                builder.Append("  failoverTypes:");
                builder.AppendLine(" [");
                foreach (var item in FailoverTypes)
                {
            ...
            if (Optional.IsCollectionDefined(FailoverDirections))
            {
                builder.Append("  failoverDirections:");
                builder.AppendLine(" [");
                foreach (var item in FailoverDirections)
                {
                    builder.AppendLine($"    '{item.ToString()}'");
