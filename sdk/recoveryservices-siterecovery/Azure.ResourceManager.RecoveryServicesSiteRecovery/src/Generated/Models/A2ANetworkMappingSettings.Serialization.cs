...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<A2ANetworkMappingSettings>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<A2ANetworkMappingSettings>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<A2ANetworkMappingSettings>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<A2ANetworkMappingSettings>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
