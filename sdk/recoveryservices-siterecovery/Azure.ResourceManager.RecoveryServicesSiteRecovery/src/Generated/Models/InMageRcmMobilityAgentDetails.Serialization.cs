...
{
    public partial class InMageRcmMobilityAgentDetails : IUtf8JsonSerializable, IJsonModel<InMageRcmMobilityAgentDetails>, IPersistableModel<InMageRcmMobilityAgentDetails>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(DriverVersionExpireOn))
            {
                ...
                builder.AppendLine($" '{DriverVersionExpireOn.Value.ToString()}'");
            }
