...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class ScriptActionTaskDetails : SiteRecoveryTaskTypeDetails
    {
        ...
        internal ScriptActionTaskDetails(string instanceType, string name, string path, string output, bool? isPrimarySideScript, Dictionary<string, BinaryData> rawData) : base(instanceType, rawData)
        {
            Name = name;
            Path = path;
            Output = output;
