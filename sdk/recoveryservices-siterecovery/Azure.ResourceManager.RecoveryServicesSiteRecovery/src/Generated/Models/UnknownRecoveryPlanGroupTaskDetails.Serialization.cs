...
{
    internal partial class UnknownRecoveryPlanGroupTaskDetails : RecoveryPlanGroupTaskDetails, IJsonModel<RecoveryPlanGroupTaskDetails>
    {
        /// <summary> Initializes a new instance of <see cref="UnknownRecoveryPlanGroupTaskDetails"/> for deserialization. </summary>
        internal UnknownRecoveryPlanGroupTaskDetails()
        {
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownRecoveryPlanGroupTaskDetails DeserializeUnknownRecoveryPlanGroupTaskDetails(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownRecoveryPlanGroupTaskDetails(
                instanceType,
