...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public abstract partial class FabricSpecificCreationContent : IJsonModel<FabricSpecificCreationContent>
    {
        ...
        protected virtual FabricSpecificCreationContent PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
        ...
        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual FabricSpecificCreationContent JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<FabricSpecificCreationContent>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static FabricSpecificCreationContent DeserializeFabricSpecificCreationContent(JsonElement element, ModelReaderWriterOptions options)
        {
