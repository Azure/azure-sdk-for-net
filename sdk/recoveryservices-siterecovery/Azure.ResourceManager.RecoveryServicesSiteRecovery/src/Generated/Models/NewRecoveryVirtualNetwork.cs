...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class NewRecoveryVirtualNetwork : RecoveryVirtualNetworkCustomDetails
    {
        ...
        internal NewRecoveryVirtualNetwork(string resourceType, string recoveryVirtualNetworkResourceGroupName, string recoveryVirtualNetworkName, Dictionary<string, BinaryData> rawData) : base(resourceType, rawData)
        {
