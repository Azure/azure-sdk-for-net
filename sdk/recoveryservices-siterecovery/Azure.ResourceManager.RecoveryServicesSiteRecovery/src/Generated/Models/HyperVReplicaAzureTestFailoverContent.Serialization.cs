...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    public partial class HyperVReplicaAzureTestFailoverContent : IUtf8JsonSerializable, IJsonModel<HyperVReplicaAzureTestFailoverContent>
    {
        ...
        void IJsonModel<HyperVReplicaAzureTestFailoverContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(HyperVReplicaAzureTestFailoverContent)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<HyperVReplicaAzureTestFailoverContent>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(HyperVReplicaAzureTestFailoverContent)} does not support '{options.Format}' format.");
            }
        }
