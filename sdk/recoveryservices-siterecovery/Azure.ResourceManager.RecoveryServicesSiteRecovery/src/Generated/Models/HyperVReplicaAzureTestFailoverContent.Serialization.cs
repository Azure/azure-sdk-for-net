...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    public partial class HyperVReplicaAzureTestFailoverContent : IUtf8JsonSerializable, IJsonModel<HyperVReplicaAzureTestFailoverContent>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<HyperVReplicaAzureTestFailoverContent>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<HyperVReplicaAzureTestFailoverContent>)} interface");
            }
