...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class HyperVReplica2012EventDetails : EventProviderSpecificDetails
    {
        ...
        internal HyperVReplica2012EventDetails() : base("HyperVReplica2012")
        {
        }
        ...
        internal HyperVReplica2012EventDetails(string instanceType, IDictionary<string, BinaryData> additionalBinaryDataProperties, string containerName, string fabricName, string remoteContainerName, string remoteFabricName) : base(instanceType, additionalBinaryDataProperties)
        {
