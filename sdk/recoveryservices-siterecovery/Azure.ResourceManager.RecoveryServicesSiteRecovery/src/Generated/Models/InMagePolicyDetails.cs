...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class InMagePolicyDetails : PolicyProviderSpecificDetails
    {
        ...
        internal InMagePolicyDetails() : base("InMage")
        {
        }
        ...
        internal InMagePolicyDetails(string instanceType, IDictionary<string, BinaryData> additionalBinaryDataProperties, int? recoveryPointThresholdInMinutes, int? recoveryPointHistory, int? appConsistentFrequencyInMinutes, string multiVmSyncStatus) : base(instanceType, additionalBinaryDataProperties)
        {
