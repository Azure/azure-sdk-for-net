...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<InMageEnableProtectionContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<InMageEnableProtectionContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<InMageEnableProtectionContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<InMageEnableProtectionContent>)} interface");
            }
        ...
        string IPersistableModel<InMageEnableProtectionContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
