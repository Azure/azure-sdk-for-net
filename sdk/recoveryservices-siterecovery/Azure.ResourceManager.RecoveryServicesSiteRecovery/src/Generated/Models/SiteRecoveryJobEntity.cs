...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class SiteRecoveryJobEntity
    {
        ...
        internal SiteRecoveryJobEntity(ResourceIdentifier jobId, string jobFriendlyName, string targetObjectId, string targetObjectName, string targetInstanceType, string jobScenarioName, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            JobId = jobId;
