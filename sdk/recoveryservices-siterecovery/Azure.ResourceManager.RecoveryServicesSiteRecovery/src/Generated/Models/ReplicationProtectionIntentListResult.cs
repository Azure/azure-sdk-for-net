...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    internal partial class ReplicationProtectionIntentListResult
    {
        ...
        internal ReplicationProtectionIntentListResult(IReadOnlyList<ReplicationProtectionIntentData> value, string nextLink, Dictionary<string, BinaryData> rawData)
        {
            Value = value;
            NextLink = nextLink;
            _rawData = rawData;
