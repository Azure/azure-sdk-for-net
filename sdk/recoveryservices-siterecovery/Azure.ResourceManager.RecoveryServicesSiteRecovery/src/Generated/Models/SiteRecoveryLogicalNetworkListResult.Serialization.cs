...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SiteRecoveryLogicalNetworkListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SiteRecoveryLogicalNetworkListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SiteRecoveryLogicalNetworkListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SiteRecoveryLogicalNetworkListResult>)} interface");
            }
        ...
        string IPersistableModel<SiteRecoveryLogicalNetworkListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
