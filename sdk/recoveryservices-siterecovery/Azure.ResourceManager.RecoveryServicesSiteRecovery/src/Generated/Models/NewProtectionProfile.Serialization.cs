...
{
    public partial class NewProtectionProfile : IUtf8JsonSerializable, IJsonModel<NewProtectionProfile>, IPersistableModel<NewProtectionProfile>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(MultiVmSyncStatus))
            {
                ...
                builder.AppendLine($" '{MultiVmSyncStatus.ToString()}'");
            }
