...
{
    internal partial class UnknownEnableProtectionProviderSpecificContent : EnableProtectionProviderSpecificContent, IJsonModel<EnableProtectionProviderSpecificContent>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownEnableProtectionProviderSpecificContent DeserializeUnknownEnableProtectionProviderSpecificContent(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownEnableProtectionProviderSpecificContent(instanceType, additionalBinaryDataProperties);
        }
    }
}
