...
{
    public partial class SiteRecoveryOSVersionWrapper : IUtf8JsonSerializable, IJsonModel<SiteRecoveryOSVersionWrapper>, IPersistableModel<SiteRecoveryOSVersionWrapper>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ServicePack))
            {
                ...
                builder.AppendLine($" '{ServicePack}'");
            }
