...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class VMwareCbtMigrateContent : MigrateProviderSpecificContent
    {
        ...
        internal VMwareCbtMigrateContent(string instanceType, string performShutdown, string osUpgradeVersion, Dictionary<string, BinaryData> rawData) : base(instanceType, rawData)
        {
            PerformShutdown = performShutdown;
