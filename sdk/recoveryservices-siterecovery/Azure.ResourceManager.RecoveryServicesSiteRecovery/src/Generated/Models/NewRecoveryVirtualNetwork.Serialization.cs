...
{
    public partial class NewRecoveryVirtualNetwork : IUtf8JsonSerializable, IJsonModel<NewRecoveryVirtualNetwork>, IPersistableModel<NewRecoveryVirtualNetwork>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(RecoveryVirtualNetworkResourceGroupName))
            {
                builder.Append("  recoveryVirtualNetworkResourceGroupName:");
                builder.AppendLine($" '{RecoveryVirtualNetworkResourceGroupName}'");
            }

            if (Optional.IsDefined(RecoveryVirtualNetworkName))
            {
                builder.Append("  recoveryVirtualNetworkName:");
                builder.AppendLine($" '{RecoveryVirtualNetworkName}'");
            }
