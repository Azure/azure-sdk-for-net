...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<UpdateRecoveryPlanContentProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<UpdateRecoveryPlanContentProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<UpdateRecoveryPlanContentProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<UpdateRecoveryPlanContentProperties>)} interface");
            }
        ...
        string IPersistableModel<UpdateRecoveryPlanContentProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
