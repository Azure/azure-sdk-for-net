...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class VMwareCbtResyncContent : ResyncProviderSpecificContent
    {
        ...
        internal VMwareCbtResyncContent(string instanceType, string skipCbtReset, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(instanceType, serializedAdditionalRawData)
        {
            SkipCbtReset = skipCbtReset;
