...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<InMageAzureV2EnableProtectionContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<InMageAzureV2EnableProtectionContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<InMageAzureV2EnableProtectionContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<InMageAzureV2EnableProtectionContent>)} interface");
            }
        ...
        string IPersistableModel<InMageAzureV2EnableProtectionContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
