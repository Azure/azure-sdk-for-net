...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SiteRecoveryJobListResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<SiteRecoveryJobListResult>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
            ...
            if (Optional.IsCollectionDefined(Value))
            {
                ...
                {
                    ((IJsonModel<SiteRecoveryJobData>)item).Write(writer, options);
                }
        ...
        internal static SiteRecoveryJobListResult DeserializeSiteRecoveryJobListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            IReadOnlyList<SiteRecoveryJobData> value = default;
            ...
            return new SiteRecoveryJobListResult(value ?? new ChangeTrackingList<SiteRecoveryJobData>(), nextLink, serializedAdditionalRawData);
        }
