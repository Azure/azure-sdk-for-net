...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    public partial class SiteRecoveryJobStatusEventDetails : IUtf8JsonSerializable, IJsonModel<SiteRecoveryJobStatusEventDetails>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(JobFriendlyName))
            {
                builder.Append("  jobFriendlyName:");
                if (JobFriendlyName.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
                    builder.AppendLine($"{JobFriendlyName}'''");
                }
                else
                {
                    builder.AppendLine($" '{JobFriendlyName}'");
            ...
            if (Optional.IsDefined(AffectedObjectType))
            {
                builder.Append("  affectedObjectType:");
                if (AffectedObjectType.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
                    builder.AppendLine($"{AffectedObjectType}'''");
                }
                else
                {
                    builder.AppendLine($" '{AffectedObjectType}'");
