...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class InMageRcmApplyRecoveryPointContent : SiteRecoveryApplyRecoveryPointProviderSpecificContent
    {
        ...
        public InMageRcmApplyRecoveryPointContent(ResourceIdentifier recoveryPointId) : base("InMageRcm")
        {
        ...
        /// <param name="recoveryPointId"> The recovery point Id. </param>
        internal InMageRcmApplyRecoveryPointContent(string instanceType, IDictionary<string, BinaryData> additionalBinaryDataProperties, ResourceIdentifier recoveryPointId) : base(instanceType, additionalBinaryDataProperties)
        {
            RecoveryPointId = recoveryPointId;
        }
