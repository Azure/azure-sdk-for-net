...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        internal static HyperVReplicaBaseEventDetails DeserializeHyperVReplicaBaseEventDetails(JsonElement element)
        {
            ...
            return new HyperVReplicaBaseEventDetails(instanceType, containerName.Value, fabricName.Value, remoteContainerName.Value, remoteFabricName.Value);
        }
    }
}
