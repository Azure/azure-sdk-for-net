...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class UpdateDiskContent
    {
        ...
        internal UpdateDiskContent(string diskId, string targetDiskName, long? iops, long? throughputInMbps, long? diskSizeInGB, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            DiskId = diskId;
