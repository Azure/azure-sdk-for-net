...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<UpdateReplicationProtectedItemProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<UpdateReplicationProtectedItemProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<UpdateReplicationProtectedItemProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<UpdateReplicationProtectedItemProperties>)} interface");
            }
        ...
        string IPersistableModel<UpdateReplicationProtectedItemProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
