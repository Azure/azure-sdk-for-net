...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SiteRecoveryMigrationItemData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SiteRecoveryMigrationItemData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SiteRecoveryMigrationItemData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SiteRecoveryMigrationItemData>)} interface");
            }
        ...
        string IPersistableModel<SiteRecoveryMigrationItemData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
