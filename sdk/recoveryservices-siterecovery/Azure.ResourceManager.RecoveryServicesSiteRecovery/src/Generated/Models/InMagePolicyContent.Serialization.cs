...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class InMagePolicyContent : PolicyProviderSpecificContent, IJsonModel<InMagePolicyContent>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<InMagePolicyContent>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<InMagePolicyContent>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        InMagePolicyContent IPersistableModel<InMagePolicyContent>.Create(BinaryData data, ModelReaderWriterOptions options) => (InMagePolicyContent)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        InMagePolicyContent IJsonModel<InMagePolicyContent>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (InMagePolicyContent)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static InMagePolicyContent DeserializeInMagePolicyContent(JsonElement element, ModelReaderWriterOptions options)
        {
