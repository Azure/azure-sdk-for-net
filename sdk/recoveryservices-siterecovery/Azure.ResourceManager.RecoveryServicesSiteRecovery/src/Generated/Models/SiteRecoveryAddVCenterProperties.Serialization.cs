...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    public partial class SiteRecoveryAddVCenterProperties : IUtf8JsonSerializable, IJsonModel<SiteRecoveryAddVCenterProperties>
    {
        ...
        void IJsonModel<SiteRecoveryAddVCenterProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(SiteRecoveryAddVCenterProperties)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<SiteRecoveryAddVCenterProperties>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(SiteRecoveryAddVCenterProperties)} does not support '{options.Format}' format.");
            }
        }
