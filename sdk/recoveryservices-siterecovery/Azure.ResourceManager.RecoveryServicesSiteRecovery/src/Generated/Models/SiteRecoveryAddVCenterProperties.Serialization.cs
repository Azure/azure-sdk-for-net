...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    public partial class SiteRecoveryAddVCenterProperties : IUtf8JsonSerializable, IJsonModel<SiteRecoveryAddVCenterProperties>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<SiteRecoveryAddVCenterProperties>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SiteRecoveryAddVCenterProperties>)} interface");
            }
