...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MigrationItemResyncContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MigrationItemResyncContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MigrationItemResyncContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<MigrationItemResyncContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
