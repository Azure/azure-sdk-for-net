...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class InMageDisableProtectionProviderSpecificContent : DisableProtectionProviderSpecificContent
    {
        ...
        internal InMageDisableProtectionProviderSpecificContent(string instanceType, string replicaVmDeletionStatus, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(instanceType, serializedAdditionalRawData)
        {
