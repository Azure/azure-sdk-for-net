...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class VCenterProperties
    {
        ...
        internal VCenterProperties(string friendlyName, string internalId, DateTimeOffset? lastHeartbeat, string discoveryStatus, string processServerId, string ipAddress, string infrastructureId, string port, string runAsAccountId, string fabricArmResourceName, IList<HealthError> healthErrors, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
