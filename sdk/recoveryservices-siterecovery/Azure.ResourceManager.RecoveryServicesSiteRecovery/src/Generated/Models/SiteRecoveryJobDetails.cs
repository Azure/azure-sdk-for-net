...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public abstract partial class SiteRecoveryJobDetails
    {
        ...
        private protected SiteRecoveryJobDetails(string instanceType)
        {
        ...
        internal SiteRecoveryJobDetails(string instanceType, IReadOnlyDictionary<string, string> affectedObjectDetails, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            InstanceType = instanceType;
