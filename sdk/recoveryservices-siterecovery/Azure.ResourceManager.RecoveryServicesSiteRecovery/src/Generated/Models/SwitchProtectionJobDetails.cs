...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class SwitchProtectionJobDetails : SiteRecoveryJobDetails
    {
        ...
        internal SwitchProtectionJobDetails(string instanceType, IReadOnlyDictionary<string, string> affectedObjectDetails, ResourceIdentifier newReplicationProtectedItemId, Dictionary<string, BinaryData> rawData) : base(instanceType, affectedObjectDetails, rawData)
        {
