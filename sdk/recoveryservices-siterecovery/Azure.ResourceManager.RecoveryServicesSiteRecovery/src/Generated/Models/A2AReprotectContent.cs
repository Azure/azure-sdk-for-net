...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class A2AReprotectContent : ReverseReplicationProviderSpecificContent
    {
        ...
        internal A2AReprotectContent(string instanceType, ResourceIdentifier recoveryContainerId, IList<A2AVmDiskDetails> vmDisks, ResourceIdentifier recoveryResourceGroupId, string recoveryCloudServiceId, ResourceIdentifier recoveryAvailabilitySetId, ResourceIdentifier policyId, Dictionary<string, BinaryData> rawData) : base(instanceType, rawData)
        {
