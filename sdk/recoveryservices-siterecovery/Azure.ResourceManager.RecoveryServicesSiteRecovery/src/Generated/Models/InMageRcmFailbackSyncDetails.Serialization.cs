...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<InMageRcmFailbackSyncDetails>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<InMageRcmFailbackSyncDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<InMageRcmFailbackSyncDetails>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<InMageRcmFailbackSyncDetails>)} interface");
            }
        ...
        string IPersistableModel<InMageRcmFailbackSyncDetails>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
