...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class ProviderError
    {
        ...
        /// <summary> Initializes a new instance of <see cref="ProviderError"/>. </summary>
        ...
        internal ProviderError(int? errorCode, string errorMessage, string errorId, string possibleCauses, string recommendedAction, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            ErrorCode = errorCode;
