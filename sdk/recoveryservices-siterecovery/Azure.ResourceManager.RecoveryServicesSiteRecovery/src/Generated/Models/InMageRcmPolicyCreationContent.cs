...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class InMageRcmPolicyCreationContent : PolicyProviderSpecificContent
    {
        ...
        internal InMageRcmPolicyCreationContent(string instanceType, int? recoveryPointHistoryInMinutes, int? crashConsistentFrequencyInMinutes, int? appConsistentFrequencyInMinutes, string enableMultiVmSync, Dictionary<string, BinaryData> rawData) : base(instanceType, rawData)
        {
