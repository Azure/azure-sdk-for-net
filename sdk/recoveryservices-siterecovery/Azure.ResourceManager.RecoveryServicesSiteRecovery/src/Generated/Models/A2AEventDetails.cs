...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class A2AEventDetails : SiteRecoveryEventProviderSpecificDetails
    {
        ...
        internal A2AEventDetails(string instanceType, IDictionary<string, BinaryData> additionalBinaryDataProperties, string protectedItemName, ResourceIdentifier fabricObjectId, string fabricName, AzureLocation? fabricLocation, string remoteFabricName, AzureLocation? remoteFabricLocation) : base(instanceType, additionalBinaryDataProperties)
        {
