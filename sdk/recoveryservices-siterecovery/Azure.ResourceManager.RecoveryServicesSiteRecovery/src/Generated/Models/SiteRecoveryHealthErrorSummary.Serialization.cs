...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        internal static SiteRecoveryHealthErrorSummary DeserializeSiteRecoveryHealthErrorSummary(JsonElement element)
        {
            ...
            Optional<SiteRecoveryHealthErrorCategory> category = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("category"u8))
                {
                    ...
                    category = new SiteRecoveryHealthErrorCategory(property.Value.GetString());
                    continue;
                }
            ...
            return new SiteRecoveryHealthErrorSummary(summaryCode.Value, Optional.ToNullable(category), Optional.ToNullable(severity), summaryMessage.Value, affectedResourceType.Value, affectedResourceSubtype.Value, Optional.ToList(affectedResourceCorrelationIds));
        }
    }
}
