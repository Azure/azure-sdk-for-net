...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<A2AVmManagedDiskDetails>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<A2AVmManagedDiskDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<A2AVmManagedDiskDetails>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<A2AVmManagedDiskDetails>)} interface");
            }
        ...
        string IPersistableModel<A2AVmManagedDiskDetails>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
