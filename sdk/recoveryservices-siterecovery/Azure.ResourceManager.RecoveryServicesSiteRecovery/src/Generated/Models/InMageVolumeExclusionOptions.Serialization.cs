...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<InMageVolumeExclusionOptions>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<InMageVolumeExclusionOptions>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<InMageVolumeExclusionOptions>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<InMageVolumeExclusionOptions>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
