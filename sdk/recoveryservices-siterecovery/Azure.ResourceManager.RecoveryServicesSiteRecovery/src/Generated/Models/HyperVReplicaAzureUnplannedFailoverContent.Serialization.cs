...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class HyperVReplicaAzureUnplannedFailoverContent : UnplannedFailoverProviderSpecificContent, IJsonModel<HyperVReplicaAzureUnplannedFailoverContent>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<HyperVReplicaAzureUnplannedFailoverContent>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<HyperVReplicaAzureUnplannedFailoverContent>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        HyperVReplicaAzureUnplannedFailoverContent IPersistableModel<HyperVReplicaAzureUnplannedFailoverContent>.Create(BinaryData data, ModelReaderWriterOptions options) => (HyperVReplicaAzureUnplannedFailoverContent)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        HyperVReplicaAzureUnplannedFailoverContent IJsonModel<HyperVReplicaAzureUnplannedFailoverContent>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (HyperVReplicaAzureUnplannedFailoverContent)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static HyperVReplicaAzureUnplannedFailoverContent DeserializeHyperVReplicaAzureUnplannedFailoverContent(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new HyperVReplicaAzureUnplannedFailoverContent(instanceType, additionalBinaryDataProperties, primaryKekCertificatePfx, secondaryKekCertificatePfx, recoveryPointId);
        }
    }
}
