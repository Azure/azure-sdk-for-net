...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HyperVReplica2012EventDetails>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<HyperVReplica2012EventDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<HyperVReplica2012EventDetails>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<HyperVReplica2012EventDetails>)} interface");
            }
        ...
        string IPersistableModel<HyperVReplica2012EventDetails>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
