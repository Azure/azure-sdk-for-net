...
{
    public partial class InMageRcmPolicyDetails : IUtf8JsonSerializable, IJsonModel<InMageRcmPolicyDetails>, IPersistableModel<InMageRcmPolicyDetails>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(RecoveryPointHistoryInMinutes))
            {
                ...
                builder.AppendLine($" '{RecoveryPointHistoryInMinutes.Value.ToString()}'");
            }

            if (Optional.IsDefined(AppConsistentFrequencyInMinutes))
            {
                builder.Append("  appConsistentFrequencyInMinutes:");
                builder.AppendLine($" '{AppConsistentFrequencyInMinutes.Value.ToString()}'");
            }

            if (Optional.IsDefined(CrashConsistentFrequencyInMinutes))
            {
                builder.Append("  crashConsistentFrequencyInMinutes:");
                builder.AppendLine($" '{CrashConsistentFrequencyInMinutes.Value.ToString()}'");
            }

            if (Optional.IsDefined(EnableMultiVmSync))
            {
                builder.Append("  enableMultiVmSync:");
                builder.AppendLine($" '{EnableMultiVmSync}'");
            }
