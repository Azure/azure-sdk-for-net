...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FailoverJobDetails>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<FailoverJobDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<FailoverJobDetails>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<FailoverJobDetails>)} interface");
            }
        ...
        string IPersistableModel<FailoverJobDetails>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
