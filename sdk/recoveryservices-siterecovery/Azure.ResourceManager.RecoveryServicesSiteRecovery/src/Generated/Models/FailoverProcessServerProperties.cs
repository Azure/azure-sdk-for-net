...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class FailoverProcessServerProperties
    {
        ...
        internal FailoverProcessServerProperties(string containerName, Guid? sourceProcessServerId, Guid? targetProcessServerId, IList<string> vmsToMigrate, string updateType, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
