...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<UpdateDiskContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<UpdateDiskContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<UpdateDiskContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<UpdateDiskContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
