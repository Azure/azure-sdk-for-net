...
{
    internal partial class UnknownRecoveryPlanProviderSpecificFailoverContent : RecoveryPlanProviderSpecificFailoverContent, IJsonModel<RecoveryPlanProviderSpecificFailoverContent>
    {
        /// <summary> Initializes a new instance of <see cref="UnknownRecoveryPlanProviderSpecificFailoverContent"/> for deserialization. </summary>
        internal UnknownRecoveryPlanProviderSpecificFailoverContent()
        {
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownRecoveryPlanProviderSpecificFailoverContent DeserializeUnknownRecoveryPlanProviderSpecificFailoverContent(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownRecoveryPlanProviderSpecificFailoverContent(instanceType, additionalBinaryDataProperties);
        }
    }
}
