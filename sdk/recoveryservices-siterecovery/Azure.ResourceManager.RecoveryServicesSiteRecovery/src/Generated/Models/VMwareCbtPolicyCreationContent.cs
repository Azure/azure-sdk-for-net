...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class VMwareCbtPolicyCreationContent : PolicyProviderSpecificContent
    {
        ...
        public VMwareCbtPolicyCreationContent() : base("VMwareCbt")
        {
        }
        ...
        internal VMwareCbtPolicyCreationContent(string instanceType, IDictionary<string, BinaryData> additionalBinaryDataProperties, int? recoveryPointHistoryInMinutes, int? crashConsistentFrequencyInMinutes, int? appConsistentFrequencyInMinutes) : base(instanceType, additionalBinaryDataProperties)
        {
