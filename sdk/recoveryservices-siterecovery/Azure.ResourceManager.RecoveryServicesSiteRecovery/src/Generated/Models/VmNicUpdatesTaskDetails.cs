...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class VmNicUpdatesTaskDetails : SiteRecoveryTaskTypeDetails
    {
        ...
        internal VmNicUpdatesTaskDetails(string instanceType, string vmId, string nicId, string name, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(instanceType, serializedAdditionalRawData)
        {
            VmId = vmId;
            NicId = nicId;
            Name = name;
