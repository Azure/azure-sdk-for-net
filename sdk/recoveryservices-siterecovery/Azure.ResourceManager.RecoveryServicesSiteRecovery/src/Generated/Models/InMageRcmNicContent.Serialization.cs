...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    public partial class InMageRcmNicContent : IUtf8JsonSerializable, IJsonModel<InMageRcmNicContent>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<InMageRcmNicContent>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<InMageRcmNicContent>)} interface");
            }
