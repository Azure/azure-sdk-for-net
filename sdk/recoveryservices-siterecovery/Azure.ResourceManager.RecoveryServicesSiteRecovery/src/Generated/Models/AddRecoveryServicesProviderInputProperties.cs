...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class AddRecoveryServicesProviderInputProperties
    {
        ...
        /// <summary> Initializes a new instance of <see cref="AddRecoveryServicesProviderInputProperties"/>. </summary>
        ...
        internal AddRecoveryServicesProviderInputProperties(string machineName, string machineId, string biosId, IdentityProviderInput authenticationIdentityInput, IdentityProviderInput resourceAccessIdentityInput, IdentityProviderInput dataPlaneAuthenticationIdentityInput, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            MachineName = machineName;
            MachineId = machineId;
            BiosId = biosId;
