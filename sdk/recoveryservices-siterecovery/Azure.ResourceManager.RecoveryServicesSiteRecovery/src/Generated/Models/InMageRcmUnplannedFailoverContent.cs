...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class InMageRcmUnplannedFailoverContent : UnplannedFailoverProviderSpecificContent
    {
        ...
        internal InMageRcmUnplannedFailoverContent(string instanceType, string performShutdown, ResourceIdentifier recoveryPointId, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(instanceType, serializedAdditionalRawData)
        {
            PerformShutdown = performShutdown;
