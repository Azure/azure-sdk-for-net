...
{
    public partial class HyperVReplicaBluePolicyContent : IUtf8JsonSerializable, IModelJsonSerializable<HyperVReplicaBluePolicyContent>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IModelJsonSerializable<HyperVReplicaBluePolicyContent>)this).Serialize(writer, ModelSerializerOptions.DefaultWireOptions);

        void IModelJsonSerializable<HyperVReplicaBluePolicyContent>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<HyperVReplicaBluePolicyContent>(this, options.Format);
        ...
        internal static HyperVReplicaBluePolicyContent DeserializeHyperVReplicaBluePolicyContent(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new HyperVReplicaBluePolicyContent(instanceType, Optional.ToNullable(recoveryPoints), Optional.ToNullable(applicationConsistentSnapshotFrequencyInHours), compression.Value, initialReplicationMethod.Value, onlineReplicationStartTime.Value, offlineReplicationImportPath.Value, offlineReplicationExportPath.Value, Optional.ToNullable(replicationPort), Optional.ToNullable(allowedAuthenticationType), replicaDeletion.Value, Optional.ToNullable(replicationFrequencyInSeconds), serializedAdditionalRawData);
        }

        HyperVReplicaBluePolicyContent IModelJsonSerializable<HyperVReplicaBluePolicyContent>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<HyperVReplicaBluePolicyContent>(this, options.Format);

            using var doc = JsonDocument.ParseValue(ref reader);
            return DeserializeHyperVReplicaBluePolicyContent(doc.RootElement, options);
        }

        BinaryData IModelSerializable<HyperVReplicaBluePolicyContent>.Serialize(ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<HyperVReplicaBluePolicyContent>(this, options.Format);
        ...
        HyperVReplicaBluePolicyContent IModelSerializable<HyperVReplicaBluePolicyContent>.Deserialize(BinaryData data, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<HyperVReplicaBluePolicyContent>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="HyperVReplicaBluePolicyContent"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="HyperVReplicaBluePolicyContent"/> to convert. </param>
        public static implicit operator RequestContent(HyperVReplicaBluePolicyContent model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="HyperVReplicaBluePolicyContent"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator HyperVReplicaBluePolicyContent(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeHyperVReplicaBluePolicyContent(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
