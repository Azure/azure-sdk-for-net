...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    public partial class HyperVReplicaBluePolicyContent : IUtf8JsonSerializable, IModelJsonSerializable<HyperVReplicaBluePolicyContent>
    {
        ...
        internal static HyperVReplicaBluePolicyContent DeserializeHyperVReplicaBluePolicyContent(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new HyperVReplicaBluePolicyContent(instanceType, Optional.ToNullable(recoveryPoints), Optional.ToNullable(applicationConsistentSnapshotFrequencyInHours), compression.Value, initialReplicationMethod.Value, onlineReplicationStartTime.Value, offlineReplicationImportPath.Value, offlineReplicationExportPath.Value, Optional.ToNullable(replicationPort), Optional.ToNullable(allowedAuthenticationType), replicaDeletion.Value, Optional.ToNullable(replicationFrequencyInSeconds), rawData);
        }
