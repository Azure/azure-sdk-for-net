...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class A2ARecoveryPointDetails : ProviderSpecificRecoveryPointDetails
    {
        ...
        internal A2ARecoveryPointDetails(string instanceType, RecoveryPointSyncType? recoveryPointSyncType, IReadOnlyList<string> disks, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(instanceType, serializedAdditionalRawData)
        {
