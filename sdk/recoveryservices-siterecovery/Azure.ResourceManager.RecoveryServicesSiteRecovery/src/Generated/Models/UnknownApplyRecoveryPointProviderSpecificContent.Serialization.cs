...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SiteRecoveryApplyRecoveryPointProviderSpecificContent>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<SiteRecoveryApplyRecoveryPointProviderSpecificContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SiteRecoveryApplyRecoveryPointProviderSpecificContent>)} interface");
            }
        ...
        SiteRecoveryApplyRecoveryPointProviderSpecificContent IJsonModel<SiteRecoveryApplyRecoveryPointProviderSpecificContent>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            return DeserializeUnknownApplyRecoveryPointProviderSpecificContent(document.RootElement, options);
        }
        ...
        string IPersistableModel<SiteRecoveryApplyRecoveryPointProviderSpecificContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
