...
{
    public partial class HyperVReplicaBasePolicyDetails : IUtf8JsonSerializable, IModelJsonSerializable<HyperVReplicaBasePolicyDetails>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IModelJsonSerializable<HyperVReplicaBasePolicyDetails>)this).Serialize(writer, ModelSerializerOptions.DefaultWireOptions);

        void IModelJsonSerializable<HyperVReplicaBasePolicyDetails>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<HyperVReplicaBasePolicyDetails>(this, options.Format);
        ...
        internal static HyperVReplicaBasePolicyDetails DeserializeHyperVReplicaBasePolicyDetails(JsonElement element, ModelSerializerOptions options = default)
        {
        ...
        HyperVReplicaBasePolicyDetails IModelJsonSerializable<HyperVReplicaBasePolicyDetails>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<HyperVReplicaBasePolicyDetails>(this, options.Format);

            using var doc = JsonDocument.ParseValue(ref reader);
            return DeserializeHyperVReplicaBasePolicyDetails(doc.RootElement, options);
        }

        BinaryData IModelSerializable<HyperVReplicaBasePolicyDetails>.Serialize(ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<HyperVReplicaBasePolicyDetails>(this, options.Format);
        ...
        HyperVReplicaBasePolicyDetails IModelSerializable<HyperVReplicaBasePolicyDetails>.Deserialize(BinaryData data, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<HyperVReplicaBasePolicyDetails>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="HyperVReplicaBasePolicyDetails"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="HyperVReplicaBasePolicyDetails"/> to convert. </param>
        public static implicit operator RequestContent(HyperVReplicaBasePolicyDetails model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="HyperVReplicaBasePolicyDetails"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator HyperVReplicaBasePolicyDetails(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeHyperVReplicaBasePolicyDetails(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
