...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class InMageDiskDetails
    {
        ...
        internal InMageDiskDetails(string diskId, string diskName, string diskSizeInMB, string diskType, string diskConfiguration, IList<DiskVolumeDetails> volumeList, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            DiskId = diskId;
            DiskName = diskName;
        ...
        public IList<DiskVolumeDetails> VolumeList { get; }
    }
}
