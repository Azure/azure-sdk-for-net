...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HyperVReplicaAzureApplyRecoveryPointContent>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        HyperVReplicaAzureApplyRecoveryPointContent IJsonModel<HyperVReplicaAzureApplyRecoveryPointContent>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
                throw new FormatException($"The model {nameof(HyperVReplicaAzureApplyRecoveryPointContent)} does not support '{options.Format}' format.");
            }
        ...
        internal static HyperVReplicaAzureApplyRecoveryPointContent DeserializeHyperVReplicaAzureApplyRecoveryPointContent(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new HyperVReplicaAzureApplyRecoveryPointContent(instanceType, serializedAdditionalRawData, primaryKekCertificatePfx.Value, secondaryKekCertificatePfx.Value);
        }

        BinaryData IModel<HyperVReplicaAzureApplyRecoveryPointContent>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        HyperVReplicaAzureApplyRecoveryPointContent IModel<HyperVReplicaAzureApplyRecoveryPointContent>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<HyperVReplicaAzureApplyRecoveryPointContent>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
