...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    public partial class HyperVReplicaBaseReplicationDetails : IUtf8JsonSerializable, IModelJsonSerializable<HyperVReplicaBaseReplicationDetails>
    {
        ...
        internal static HyperVReplicaBaseReplicationDetails DeserializeHyperVReplicaBaseReplicationDetails(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new HyperVReplicaBaseReplicationDetails(instanceType, Optional.ToNullable(lastReplicatedTime), Optional.ToList(vmNics), vmId.Value, vmProtectionState.Value, vmProtectionStateDescription.Value, initialReplicationDetails.Value, Optional.ToList(vmDiskDetails), rawData);
        }
