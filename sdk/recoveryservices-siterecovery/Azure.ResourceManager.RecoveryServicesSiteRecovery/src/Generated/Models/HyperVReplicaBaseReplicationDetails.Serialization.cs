...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HyperVReplicaBaseReplicationDetails>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<HyperVReplicaBaseReplicationDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<HyperVReplicaBaseReplicationDetails>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<HyperVReplicaBaseReplicationDetails>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
