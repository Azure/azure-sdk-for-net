...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    public partial class InMageRcmPolicyCreationContent : IUtf8JsonSerializable, IModelJsonSerializable<InMageRcmPolicyCreationContent>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<InMageRcmPolicyCreationContent>(this, options.Format);
        ...
        internal static InMageRcmPolicyCreationContent DeserializeInMageRcmPolicyCreationContent(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new InMageRcmPolicyCreationContent(instanceType, Optional.ToNullable(recoveryPointHistoryInMinutes), Optional.ToNullable(crashConsistentFrequencyInMinutes), Optional.ToNullable(appConsistentFrequencyInMinutes), enableMultiVmSync.Value, serializedAdditionalRawData);
        }
