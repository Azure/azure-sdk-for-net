...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class HyperVReplicaAzurePlannedFailoverProviderContent : PlannedFailoverProviderSpecificFailoverContent
    {
        ...
        internal HyperVReplicaAzurePlannedFailoverProviderContent(string instanceType, string primaryKekCertificatePfx, string secondaryKekCertificatePfx, ResourceIdentifier recoveryPointId, Dictionary<string, BinaryData> rawData) : base(instanceType, rawData)
        {
