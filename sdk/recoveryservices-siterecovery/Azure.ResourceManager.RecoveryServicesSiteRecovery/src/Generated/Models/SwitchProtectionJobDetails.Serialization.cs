...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    public partial class SwitchProtectionJobDetails : IUtf8JsonSerializable, IJsonModel<SwitchProtectionJobDetails>
    {
        ...
        void IJsonModel<SwitchProtectionJobDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(SwitchProtectionJobDetails)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<SwitchProtectionJobDetails>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(SwitchProtectionJobDetails)} does not support '{options.Format}' format.");
            }
        }
