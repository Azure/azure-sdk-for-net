...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    public partial class SwitchProtectionJobDetails : IUtf8JsonSerializable, IJsonModel<SwitchProtectionJobDetails>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<SwitchProtectionJobDetails>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SwitchProtectionJobDetails>)} interface");
            }
