...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class InlineWorkflowTaskDetails : SiteRecoveryGroupTaskDetails
    {
        ...
        internal InlineWorkflowTaskDetails(string instanceType, IReadOnlyList<AsrTask> childTasks, IReadOnlyList<string> workflowIds, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(instanceType, childTasks, serializedAdditionalRawData)
        {
