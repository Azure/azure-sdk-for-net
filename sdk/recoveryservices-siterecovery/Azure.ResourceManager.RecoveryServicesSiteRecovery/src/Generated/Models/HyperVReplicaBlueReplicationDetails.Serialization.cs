...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    public partial class HyperVReplicaBlueReplicationDetails
    {
        internal static HyperVReplicaBlueReplicationDetails DeserializeHyperVReplicaBlueReplicationDetails(JsonElement element)
        {
            ...
            return new HyperVReplicaBlueReplicationDetails(instanceType, Core.Optional.ToNullable(lastReplicatedTime), Core.Optional.ToList(vmNics), vmId.Value, vmProtectionState.Value, vmProtectionStateDescription.Value, initialReplicationDetails.Value, Core.Optional.ToList(vmDiskDetails));
        }
    }
}
