...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TestFailoverCleanupProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<TestFailoverCleanupProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<TestFailoverCleanupProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<TestFailoverCleanupProperties>)} interface");
            }
        ...
        string IPersistableModel<TestFailoverCleanupProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
