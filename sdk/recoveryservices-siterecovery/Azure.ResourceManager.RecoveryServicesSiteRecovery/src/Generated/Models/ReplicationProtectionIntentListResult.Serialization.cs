...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ReplicationProtectionIntentListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ReplicationProtectionIntentListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ReplicationProtectionIntentListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<ReplicationProtectionIntentListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
