...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ReplicationProtectionIntentListResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<ReplicationProtectionIntentListResult>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
            ...
            if (Optional.IsCollectionDefined(Value))
            {
                ...
                {
                    ((IJsonModel<ReplicationProtectionIntentData>)item).Write(writer, options);
                }
        ...
        internal static ReplicationProtectionIntentListResult DeserializeReplicationProtectionIntentListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new ReplicationProtectionIntentListResult(value ?? new ChangeTrackingList<ReplicationProtectionIntentData>(), nextLink, serializedAdditionalRawData);
        }
