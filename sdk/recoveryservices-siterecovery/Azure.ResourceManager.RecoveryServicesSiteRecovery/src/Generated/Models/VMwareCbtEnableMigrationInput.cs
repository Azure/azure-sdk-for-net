...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="VMwareCbtEnableMigrationInput"/>. </summary>
        ...
        public VMwareCbtEnableMigrationInput(string vmwareMachineId, IEnumerable<VMwareCbtDiskInput> disksToInclude, string dataMoverRunAsAccountId, string snapshotRunAsAccountId, string targetResourceGroupId, string targetNetworkId) : base("VMwareCbt")
        {
        ...
        internal VMwareCbtEnableMigrationInput(string instanceType, IDictionary<string, BinaryData> additionalBinaryDataProperties, string vmwareMachineId, IList<VMwareCbtDiskInput> disksToInclude, LicenseType? licenseType, SqlServerLicenseType? sqlServerLicenseType, LinuxLicenseType? linuxLicenseType, string performSqlBulkRegistration, string dataMoverRunAsAccountId, string snapshotRunAsAccountId, string targetVmName, string targetVmSize, string targetResourceGroupId, string targetNetworkId, string testNetworkId, string targetSubnetName, string testSubnetName, string targetAvailabilitySetId, string targetAvailabilityZone, string targetProximityPlacementGroupId, string confidentialVmKeyVaultId, VMwareCbtSecurityProfileProperties targetVmSecurityProfile, string targetBootDiagnosticsStorageAccountId, string performAutoResync, IDictionary<string, string> targetVmTags, IDictionary<string, string> seedDiskTags, IDictionary<string, string> targetDiskTags, IDictionary<string, string> targetNicTags, string userSelectedOSName, string targetCapacityReservationGroupId) : base(instanceType, additionalBinaryDataProperties)
        {
            VmwareMachineId = vmwareMachineId;
