...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VaultHealthDetails>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<VaultHealthDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<VaultHealthDetails>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<VaultHealthDetails>)} interface");
            }
        ...
        string IPersistableModel<VaultHealthDetails>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
