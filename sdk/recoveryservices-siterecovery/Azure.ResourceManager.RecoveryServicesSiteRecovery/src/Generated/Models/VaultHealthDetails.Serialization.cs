...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    public partial class VaultHealthDetails
    {
        internal static VaultHealthDetails DeserializeVaultHealthDetails(JsonElement element)
        {
            ...
            Core.Optional<VaultHealthProperties> properties = default;
            ...
            return new VaultHealthDetails(id, name, type, systemData.Value, properties.Value, Core.Optional.ToNullable(location));
        }
    }
}
