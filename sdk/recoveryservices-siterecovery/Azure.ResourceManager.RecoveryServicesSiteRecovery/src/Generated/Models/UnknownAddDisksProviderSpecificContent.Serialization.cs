...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    internal partial class UnknownAddDisksProviderSpecificContent : IUtf8JsonSerializable, IJsonModel<SiteRecoveryAddDisksProviderSpecificContent>
    {
        ...
        void IJsonModel<SiteRecoveryAddDisksProviderSpecificContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(SiteRecoveryAddDisksProviderSpecificContent)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<SiteRecoveryAddDisksProviderSpecificContent>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(SiteRecoveryAddDisksProviderSpecificContent)} does not support '{options.Format}' format.");
            }
        }
