...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    public partial class HyperVReplicaAzurePlannedFailoverProviderContent : IUtf8JsonSerializable, IJsonModel<HyperVReplicaAzurePlannedFailoverProviderContent>
    {
        ...
        void IJsonModel<HyperVReplicaAzurePlannedFailoverProviderContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(HyperVReplicaAzurePlannedFailoverProviderContent)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<HyperVReplicaAzurePlannedFailoverProviderContent>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(HyperVReplicaAzurePlannedFailoverProviderContent)} does not support '{options.Format}' format.");
            }
        }
