    ...
    public partial class InMageRcmFabricSpecificDetails : FabricSpecificDetails, IJsonModel<InMageRcmFabricSpecificDetails>
    {
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (options.Format != "W" && Optional.IsCollectionDefined(Dras))
            {
                ...
                writer.WriteStartArray();
                foreach (SiteRecoveryDraDetails item in Dras)
                {
                    writer.WriteObjectValue(item, options);
                }
                writer.WriteEndArray();
            ...
            if (options.Format != "W" && Optional.IsCollectionDefined(AgentDetails))
            {
                ...
                writer.WriteStartArray();
                foreach (SiteRecoveryAgentDetails item in AgentDetails)
                {
                    writer.WriteObjectValue(item, options);
                }
                writer.WriteEndArray();
        ...
        internal static InMageRcmFabricSpecificDetails DeserializeInMageRcmFabricSpecificDetails(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("controlPlaneUri"u8))
                {
                    ...
                    controlPlaneUri = string.IsNullOrEmpty(prop.Value.GetString()) ? null : new Uri(prop.Value.GetString(), UriKind.RelativeOrAbsolute);
                    continue;
                }
