...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class A2ATestFailoverContent : TestFailoverProviderSpecificContent
    {
        ...
        public A2ATestFailoverContent() : base("A2A")
        {
        }
        ...
        internal A2ATestFailoverContent(string instanceType, IDictionary<string, BinaryData> additionalBinaryDataProperties, ResourceIdentifier recoveryPointId, string cloudServiceCreationOption) : base(instanceType, additionalBinaryDataProperties)
        {
