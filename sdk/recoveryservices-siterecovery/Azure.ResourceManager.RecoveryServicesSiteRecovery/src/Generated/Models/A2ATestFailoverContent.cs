...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class A2ATestFailoverContent : TestFailoverProviderSpecificContent
    {
        ...
        internal A2ATestFailoverContent(string instanceType, ResourceIdentifier recoveryPointId, string cloudServiceCreationOption, Dictionary<string, BinaryData> rawData) : base(instanceType, rawData)
        {
