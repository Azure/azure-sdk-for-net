...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class InMageRcmAgentUpgradeBlockingErrorDetails
    {
        ...
        internal InMageRcmAgentUpgradeBlockingErrorDetails(string errorCode, string errorMessage, string possibleCauses, string recommendedAction, IReadOnlyDictionary<string, string> errorMessageParameters, IReadOnlyDictionary<string, string> errorTags, Dictionary<string, BinaryData> rawData)
        {
            ErrorCode = errorCode;
