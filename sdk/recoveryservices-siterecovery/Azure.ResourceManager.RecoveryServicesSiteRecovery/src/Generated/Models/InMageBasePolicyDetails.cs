...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class InMageBasePolicyDetails : PolicyProviderSpecificDetails
    {
        ...
        internal InMageBasePolicyDetails() : base("InMageBasePolicyDetails")
        {
        }
        ...
        internal InMageBasePolicyDetails(string instanceType, IDictionary<string, BinaryData> additionalBinaryDataProperties, int? recoveryPointThresholdInMinutes, int? recoveryPointHistory, int? appConsistentFrequencyInMinutes, string multiVmSyncStatus) : base(instanceType, additionalBinaryDataProperties)
        {
