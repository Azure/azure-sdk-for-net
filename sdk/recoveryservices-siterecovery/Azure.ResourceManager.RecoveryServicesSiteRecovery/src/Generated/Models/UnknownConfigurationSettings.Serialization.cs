...
{
    internal partial class UnknownConfigurationSettings : SiteRecoveryReplicationProviderSettings, IJsonModel<SiteRecoveryReplicationProviderSettings>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<SiteRecoveryReplicationProviderSettings>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<SiteRecoveryReplicationProviderSettings>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        SiteRecoveryReplicationProviderSettings IPersistableModel<SiteRecoveryReplicationProviderSettings>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        SiteRecoveryReplicationProviderSettings IJsonModel<SiteRecoveryReplicationProviderSettings>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownConfigurationSettings DeserializeUnknownConfigurationSettings(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownConfigurationSettings(instanceType, additionalBinaryDataProperties);
        }
    }
}
