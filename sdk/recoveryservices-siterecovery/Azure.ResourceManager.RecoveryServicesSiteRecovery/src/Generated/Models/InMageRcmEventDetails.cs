...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class InMageRcmEventDetails : SiteRecoveryEventProviderSpecificDetails
    {
        ...
        internal InMageRcmEventDetails() : base("InMageRcm")
        {
        }
        ...
        internal InMageRcmEventDetails(string instanceType, IDictionary<string, BinaryData> additionalBinaryDataProperties, string protectedItemName, string vmName, string latestAgentVersion, ResourceIdentifier jobId, string fabricName, string applianceName, string serverType, string componentDisplayName) : base(instanceType, additionalBinaryDataProperties)
        {
