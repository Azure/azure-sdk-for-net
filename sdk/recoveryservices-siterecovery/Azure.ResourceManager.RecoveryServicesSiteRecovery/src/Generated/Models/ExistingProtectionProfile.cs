...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class ExistingProtectionProfile : ProtectionProfileCustomDetails
    {
        ...
        internal ExistingProtectionProfile(string resourceType, string protectionProfileId, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(resourceType, serializedAdditionalRawData)
        {
            ProtectionProfileId = protectionProfileId;
