...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public abstract partial class TaskTypeDetails
    {
        ...
        /// <summary> Initializes a new instance of <see cref="TaskTypeDetails"/>. </summary>
        /// <param name="instanceType"> The type of task details. </param>
        private protected TaskTypeDetails(string instanceType)
        {
        ...
        internal TaskTypeDetails(string instanceType, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            InstanceType = instanceType;
