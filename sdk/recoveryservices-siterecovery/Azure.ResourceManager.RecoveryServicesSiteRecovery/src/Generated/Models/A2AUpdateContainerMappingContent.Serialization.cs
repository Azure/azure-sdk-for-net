...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<A2AUpdateContainerMappingContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<A2AUpdateContainerMappingContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<A2AUpdateContainerMappingContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<A2AUpdateContainerMappingContent>)} interface");
            }
        ...
        string IPersistableModel<A2AUpdateContainerMappingContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
