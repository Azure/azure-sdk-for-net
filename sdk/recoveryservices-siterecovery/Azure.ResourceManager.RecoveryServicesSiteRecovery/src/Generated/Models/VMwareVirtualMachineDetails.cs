...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="VMwareVirtualMachineDetails"/>. </summary>
        internal VMwareVirtualMachineDetails() : base("VMwareVirtualMachine")
        {
        ...
        internal VMwareVirtualMachineDetails(string instanceType, IDictionary<string, BinaryData> additionalBinaryDataProperties, string agentGeneratedId, string agentInstalled, string osType, string agentVersion, string ipAddress, string poweredOn, string vCenterInfrastructureId, string discoveryType, IList<InMageDiskDetails> diskDetails, IList<HealthError> validationErrors) : base(instanceType, additionalBinaryDataProperties)
        {
        ...
        public IList<InMageDiskDetails> DiskDetails { get; }
