...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ExistingRecoveryAvailabilitySet>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ExistingRecoveryAvailabilitySet>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ExistingRecoveryAvailabilitySet>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ExistingRecoveryAvailabilitySet>)} interface");
            }
        ...
        string IPersistableModel<ExistingRecoveryAvailabilitySet>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
