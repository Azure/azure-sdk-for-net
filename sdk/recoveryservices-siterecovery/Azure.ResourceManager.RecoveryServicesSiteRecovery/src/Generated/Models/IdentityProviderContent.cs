...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class IdentityProviderContent
    {
        ...
        internal IdentityProviderContent(Guid tenantId, string applicationId, string objectId, string audience, string aadAuthority, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            TenantId = tenantId;
            ApplicationId = applicationId;
            ObjectId = objectId;
