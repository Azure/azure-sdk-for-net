...
{
    public partial class InMagePolicyDetails : IUtf8JsonSerializable, IJsonModel<InMagePolicyDetails>, IPersistableModel<InMagePolicyDetails>
    {
        ...
        void IJsonModel<InMagePolicyDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(InMagePolicyDetails)} does not support '{format}' format.");
            }
