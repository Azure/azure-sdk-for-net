...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    public partial class InMagePolicyDetails
    {
        internal static InMagePolicyDetails DeserializeInMagePolicyDetails(JsonElement element)
        {
            ...
            return new InMagePolicyDetails(instanceType, Core.Optional.ToNullable(recoveryPointThresholdInMinutes), Core.Optional.ToNullable(recoveryPointHistory), Core.Optional.ToNullable(appConsistentFrequencyInMinutes), multiVmSyncStatus.Value);
        }
    }
}
