...
{
    public partial class VaultHealthProperties : IUtf8JsonSerializable, IJsonModel<VaultHealthProperties>, IPersistableModel<VaultHealthProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ProtectedItemsHealth))
            {
                ...
                AppendChildObject(builder, ProtectedItemsHealth, options, 2);
            }

            if (Optional.IsDefined(FabricsHealth))
            {
                builder.Append("  fabricsHealth:");
                AppendChildObject(builder, FabricsHealth, options, 2);
            }

            if (Optional.IsDefined(ContainersHealth))
            {
                builder.Append("  containersHealth:");
                AppendChildObject(builder, ContainersHealth, options, 2);
            }
