...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class HealthErrorSummary
    {
        ...
        internal HealthErrorSummary(string summaryCode, HealthErrorCategory? category, Severity? severity, string summaryMessage, string affectedResourceType, string affectedResourceSubtype, IList<string> affectedResourceCorrelationIds, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
