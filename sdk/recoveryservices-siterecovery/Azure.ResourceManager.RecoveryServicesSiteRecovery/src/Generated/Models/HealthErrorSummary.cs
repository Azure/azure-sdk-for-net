...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class HealthErrorSummary
    {
        ...
        internal HealthErrorSummary(string summaryCode, HealthErrorCategory? category, SiteRecoveryErrorSeverity? severity, string summaryMessage, string affectedResourceType, string affectedResourceSubtype, IReadOnlyList<string> affectedResourceCorrelationIds, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
