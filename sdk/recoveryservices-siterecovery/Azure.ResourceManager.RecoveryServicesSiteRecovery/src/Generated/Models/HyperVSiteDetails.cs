...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class HyperVSiteDetails : FabricSpecificDetails
    {
        ...
        internal HyperVSiteDetails(string instanceType, IReadOnlyList<HyperVHostDetails> hyperVHosts, Dictionary<string, BinaryData> rawData) : base(instanceType, rawData)
        {
