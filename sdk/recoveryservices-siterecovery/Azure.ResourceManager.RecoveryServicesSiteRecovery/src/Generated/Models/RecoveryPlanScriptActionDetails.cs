...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class RecoveryPlanScriptActionDetails : RecoveryPlanActionDetails
    {
        ...
        internal RecoveryPlanScriptActionDetails(string instanceType, string path, string timeout, RecoveryPlanActionLocation fabricLocation, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(instanceType, serializedAdditionalRawData)
        {
            Path = path;
            Timeout = timeout;
            FabricLocation = fabricLocation;
