...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class RecoveryPlanScriptActionDetails : RecoveryPlanActionDetails
    {
        ...
        public RecoveryPlanScriptActionDetails(string path, RecoveryPlanActionLocation fabricLocation) : base("ScriptActionDetails")
        {
        ...
        /// <param name="fabricLocation"> The fabric location. </param>
        internal RecoveryPlanScriptActionDetails(string instanceType, IDictionary<string, BinaryData> additionalBinaryDataProperties, string path, string timeout, RecoveryPlanActionLocation fabricLocation) : base(instanceType, additionalBinaryDataProperties)
        {
            Path = path;
            Timeout = timeout;
            FabricLocation = fabricLocation;
