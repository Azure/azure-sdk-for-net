...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    internal partial class UpdatePolicyContentProperties : IUtf8JsonSerializable, IJsonModel<UpdatePolicyContentProperties>
    {
        ...
        void IJsonModel<UpdatePolicyContentProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(UpdatePolicyContentProperties)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<UpdatePolicyContentProperties>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(UpdatePolicyContentProperties)} does not support '{options.Format}' format.");
            }
        }
