...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ProtectionContainerMappingPatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ProtectionContainerMappingPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ProtectionContainerMappingPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ProtectionContainerMappingPatch>)} interface");
            }
        ...
        string IPersistableModel<ProtectionContainerMappingPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
