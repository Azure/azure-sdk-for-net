...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    public partial class InMageAzureV2DiskDetails : IUtf8JsonSerializable, IJsonModel<InMageAzureV2DiskDetails>
    {
        ...
        void IJsonModel<InMageAzureV2DiskDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(InMageAzureV2DiskDetails)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<InMageAzureV2DiskDetails>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(InMageAzureV2DiskDetails)} does not support '{options.Format}' format.");
            }
        }
