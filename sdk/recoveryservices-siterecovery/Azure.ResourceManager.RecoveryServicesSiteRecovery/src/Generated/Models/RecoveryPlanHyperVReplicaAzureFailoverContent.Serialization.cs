...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RecoveryPlanHyperVReplicaAzureFailoverContent>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        RecoveryPlanHyperVReplicaAzureFailoverContent IJsonModel<RecoveryPlanHyperVReplicaAzureFailoverContent>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<RecoveryPlanHyperVReplicaAzureFailoverContent>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        RecoveryPlanHyperVReplicaAzureFailoverContent IModel<RecoveryPlanHyperVReplicaAzureFailoverContent>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<RecoveryPlanHyperVReplicaAzureFailoverContent>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
