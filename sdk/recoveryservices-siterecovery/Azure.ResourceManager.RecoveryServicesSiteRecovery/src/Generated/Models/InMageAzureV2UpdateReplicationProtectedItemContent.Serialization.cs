...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<InMageAzureV2UpdateReplicationProtectedItemContent>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<InMageAzureV2UpdateReplicationProtectedItemContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<InMageAzureV2UpdateReplicationProtectedItemContent>)} interface");
            }
        ...
        string IPersistableModel<InMageAzureV2UpdateReplicationProtectedItemContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
