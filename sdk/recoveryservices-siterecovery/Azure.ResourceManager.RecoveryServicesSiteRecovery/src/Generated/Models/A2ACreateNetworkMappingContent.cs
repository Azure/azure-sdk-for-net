...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class A2ACreateNetworkMappingContent : FabricSpecificCreateNetworkMappingContent
    {
        ...
        internal A2ACreateNetworkMappingContent(string instanceType, ResourceIdentifier primaryNetworkId, Dictionary<string, BinaryData> rawData) : base(instanceType, rawData)
        {
            PrimaryNetworkId = primaryNetworkId;
