...
{
    public partial class ReplicationLogicalNetworkData
    {
        internal static ReplicationLogicalNetworkData DeserializeReplicationLogicalNetworkData(JsonElement element)
        {
            ...
            return new ReplicationLogicalNetworkData(id, name, type, systemData.Value, properties.Value, Optional.ToNullable(location));
        }
    }
}
