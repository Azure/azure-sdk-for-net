...
{
    public partial class SiteRecoveryJobErrorDetails : IUtf8JsonSerializable, IJsonModel<SiteRecoveryJobErrorDetails>, IPersistableModel<SiteRecoveryJobErrorDetails>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ServiceErrorDetails))
            {
                ...
                AppendChildObject(builder, ServiceErrorDetails, options, 2);
            }

            if (Optional.IsDefined(ProviderErrorDetails))
            {
                builder.Append("  providerErrorDetails:");
                AppendChildObject(builder, ProviderErrorDetails, options, 2);
            }
