...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    public partial class ApplianceResourceDetails : IUtf8JsonSerializable, IJsonModel<ApplianceResourceDetails>
    {
        ...
        void IJsonModel<ApplianceResourceDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(ApplianceResourceDetails)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ApplianceResourceDetails>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(ApplianceResourceDetails)} does not support '{options.Format}' format.");
            }
        }
