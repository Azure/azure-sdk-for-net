...
{
    public partial class ApplianceResourceDetails : IUtf8JsonSerializable, IJsonModel<ApplianceResourceDetails>, IPersistableModel<ApplianceResourceDetails>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  processUtilization:");
                builder.AppendLine($" '{ProcessUtilization.Value.ToString()}'");
            }

            if (Optional.IsDefined(TotalUtilization))
            {
                builder.Append("  totalUtilization:");
                builder.AppendLine($" '{TotalUtilization.Value.ToString()}'");
            }
