...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class SiteRecoveryRetentionVolume
    {
        ...
        internal SiteRecoveryRetentionVolume(string volumeName, long? capacityInBytes, long? freeSpaceInBytes, int? thresholdPercentage, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
