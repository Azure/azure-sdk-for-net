...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class RecoveryPlanA2AContent : RecoveryPlanProviderSpecificContent
    {
        ...
        internal RecoveryPlanA2AContent(string instanceType, string primaryZone, string recoveryZone, SiteRecoveryExtendedLocation primaryExtendedLocation, SiteRecoveryExtendedLocation recoveryExtendedLocation, Dictionary<string, BinaryData> rawData) : base(instanceType, rawData)
        {
