...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TestMigrateCleanupProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<TestMigrateCleanupProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<TestMigrateCleanupProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<TestMigrateCleanupProperties>)} interface");
            }
        ...
        string IPersistableModel<TestMigrateCleanupProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
