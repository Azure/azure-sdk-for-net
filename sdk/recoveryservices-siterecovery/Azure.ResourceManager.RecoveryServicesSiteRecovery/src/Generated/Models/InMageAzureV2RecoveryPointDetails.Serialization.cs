...
{
    public partial class InMageAzureV2RecoveryPointDetails : IUtf8JsonSerializable, IJsonModel<InMageAzureV2RecoveryPointDetails>, IPersistableModel<InMageAzureV2RecoveryPointDetails>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(IsMultiVmSyncPoint))
            {
                builder.Append("  isMultiVmSyncPoint:");
                builder.AppendLine($" '{IsMultiVmSyncPoint}'");
            }
