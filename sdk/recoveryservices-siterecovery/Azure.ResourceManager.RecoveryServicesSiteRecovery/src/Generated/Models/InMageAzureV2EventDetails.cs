...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class InMageAzureV2EventDetails : EventProviderSpecificDetails
    {
        ...
        internal InMageAzureV2EventDetails() : base("InMageAzureV2")
        {
        }
        ...
        internal InMageAzureV2EventDetails(string instanceType, IDictionary<string, BinaryData> additionalBinaryDataProperties, string eventType, string category, string component, string correctiveAction, string details, string summary, string siteName) : base(instanceType, additionalBinaryDataProperties)
        {
            EventType = eventType;
            Category = category;
            Component = component;
