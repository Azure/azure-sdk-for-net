...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class InMageAzureV2EventDetails : SiteRecoveryEventProviderSpecificDetails
    {
        ...
        internal InMageAzureV2EventDetails(string instanceType, string eventType, string category, string component, string correctiveAction, string details, string summary, string siteName, Dictionary<string, BinaryData> rawData) : base(instanceType, rawData)
        {
            EventType = eventType;
            Category = category;
            Component = component;
