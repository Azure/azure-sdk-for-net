...
{
    public partial class SiteRecoveryFailoverJobDetails
    {
        internal static SiteRecoveryFailoverJobDetails DeserializeSiteRecoveryFailoverJobDetails(JsonElement element)
        {
            ...
            return new SiteRecoveryFailoverJobDetails(instanceType, Optional.ToDictionary(affectedObjectDetails), Optional.ToList(protectedItemDetails));
        }
    }
}
