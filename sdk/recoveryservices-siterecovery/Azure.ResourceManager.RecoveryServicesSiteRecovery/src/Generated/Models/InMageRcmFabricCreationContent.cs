...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class InMageRcmFabricCreationContent : FabricSpecificCreationContent
    {
        ...
        internal InMageRcmFabricCreationContent(string instanceType, ResourceIdentifier vmwareSiteId, ResourceIdentifier physicalSiteId, IdentityProviderContent sourceAgentIdentity, Dictionary<string, BinaryData> rawData) : base(instanceType, rawData)
        {
            VMwareSiteId = vmwareSiteId;
            PhysicalSiteId = physicalSiteId;
            SourceAgentIdentity = sourceAgentIdentity;
