...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class IdentityProviderInput
    {
        ...
        /// <summary> Initializes a new instance of <see cref="IdentityProviderInput"/>. </summary>
        ...
        internal IdentityProviderInput(string tenantId, string applicationId, string objectId, string audience, string aadAuthority, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            TenantId = tenantId;
            ApplicationId = applicationId;
            ObjectId = objectId;
