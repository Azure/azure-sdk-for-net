...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class RecoveryPlanA2AFailoverContent : RecoveryPlanProviderSpecificFailoverContent
    {
        ...
        internal RecoveryPlanA2AFailoverContent(string instanceType, A2ARpRecoveryPointType recoveryPointType, string cloudServiceCreationOption, MultiVmSyncPointOption? multiVmSyncPointOption, Dictionary<string, BinaryData> rawData) : base(instanceType, rawData)
        {
            RecoveryPointType = recoveryPointType;
