...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class ManualActionTaskDetails : SiteRecoveryTaskTypeDetails
    {
        ...
        internal ManualActionTaskDetails(string instanceType, string name, string instructions, string observation, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(instanceType, serializedAdditionalRawData)
        {
            Name = name;
