...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<InMageReprotectContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<InMageReprotectContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<InMageReprotectContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<InMageReprotectContent>)} interface");
            }
        ...
        string IPersistableModel<InMageReprotectContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
