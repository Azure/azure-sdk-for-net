...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    public partial class InMageReprotectContent : IUtf8JsonSerializable, IModelJsonSerializable<InMageReprotectContent>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<InMageReprotectContent>(this, options.Format);
        ...
        internal static InMageReprotectContent DeserializeInMageReprotectContent(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new InMageReprotectContent(instanceType, masterTargetId, processServerId, retentionDrive, runAsAccountId.Value, datastoreName.Value, diskExclusionContent.Value, profileId, Optional.ToList(disksToInclude), serializedAdditionalRawData);
        }
