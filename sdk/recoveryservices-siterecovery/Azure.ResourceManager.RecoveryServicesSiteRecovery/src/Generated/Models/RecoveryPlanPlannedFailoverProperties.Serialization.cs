...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class RecoveryPlanPlannedFailoverProperties : IJsonModel<RecoveryPlanPlannedFailoverProperties>
    {
        ...
        protected virtual RecoveryPlanPlannedFailoverProperties PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<RecoveryPlanPlannedFailoverProperties>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<RecoveryPlanPlannedFailoverProperties>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        RecoveryPlanPlannedFailoverProperties IPersistableModel<RecoveryPlanPlannedFailoverProperties>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        RecoveryPlanPlannedFailoverProperties IJsonModel<RecoveryPlanPlannedFailoverProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual RecoveryPlanPlannedFailoverProperties JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<RecoveryPlanPlannedFailoverProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static RecoveryPlanPlannedFailoverProperties DeserializeRecoveryPlanPlannedFailoverProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new RecoveryPlanPlannedFailoverProperties(failoverDirection, providerSpecificDetails ?? new ChangeTrackingList<RecoveryPlanProviderSpecificFailoverContent>(), additionalBinaryDataProperties);
        }
    }
}
