...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class InMageRcmProtectionContainerMappingDetails : ProtectionContainerMappingProviderSpecificDetails
    {
        ...
        internal InMageRcmProtectionContainerMappingDetails() : base("InMageRcm")
        {
        }
        ...
        internal InMageRcmProtectionContainerMappingDetails(string instanceType, IDictionary<string, BinaryData> additionalBinaryDataProperties, string enableAgentAutoUpgrade) : base(instanceType, additionalBinaryDataProperties)
        {
