...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MigrationRecoveryPointProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MigrationRecoveryPointProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MigrationRecoveryPointProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MigrationRecoveryPointProperties>)} interface");
            }
        ...
        string IPersistableModel<MigrationRecoveryPointProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
