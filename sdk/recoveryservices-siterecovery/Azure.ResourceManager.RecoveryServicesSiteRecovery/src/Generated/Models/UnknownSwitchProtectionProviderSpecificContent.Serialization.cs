...
{
    internal partial class UnknownSwitchProtectionProviderSpecificContent : SwitchProtectionProviderSpecificContent, IJsonModel<SwitchProtectionProviderSpecificContent>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownSwitchProtectionProviderSpecificContent DeserializeUnknownSwitchProtectionProviderSpecificContent(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownSwitchProtectionProviderSpecificContent(instanceType, additionalBinaryDataProperties);
        }
    }
}
