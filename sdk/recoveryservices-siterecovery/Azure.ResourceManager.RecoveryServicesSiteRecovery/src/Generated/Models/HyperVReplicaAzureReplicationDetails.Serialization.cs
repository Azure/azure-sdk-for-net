...
{
    public partial class HyperVReplicaAzureReplicationDetails : IUtf8JsonSerializable, IJsonModel<HyperVReplicaAzureReplicationDetails>, IPersistableModel<HyperVReplicaAzureReplicationDetails>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(OSDetails))
            {
                ...
                AppendChildObject(builder, OSDetails, options, 2);
            }
