...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    internal partial class UnknownUpdateReplicationProtectedItemProviderContent : IUtf8JsonSerializable, IJsonModel<UpdateReplicationProtectedItemProviderContent>
    {
        ...
        void IJsonModel<UpdateReplicationProtectedItemProviderContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(UpdateReplicationProtectedItemProviderContent)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<UpdateReplicationProtectedItemProviderContent>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(UpdateReplicationProtectedItemProviderContent)} does not support '{options.Format}' format.");
            }
        }
