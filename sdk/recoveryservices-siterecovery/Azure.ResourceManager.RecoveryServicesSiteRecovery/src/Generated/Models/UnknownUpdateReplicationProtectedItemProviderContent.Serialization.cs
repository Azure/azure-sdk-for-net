...
{
    internal partial class UnknownUpdateReplicationProtectedItemProviderContent : UpdateReplicationProtectedItemProviderContent, IJsonModel<UpdateReplicationProtectedItemProviderContent>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<UpdateReplicationProtectedItemProviderContent>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<UpdateReplicationProtectedItemProviderContent>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownUpdateReplicationProtectedItemProviderContent DeserializeUnknownUpdateReplicationProtectedItemProviderContent(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownUpdateReplicationProtectedItemProviderContent(instanceType, additionalBinaryDataProperties);
        }
    }
}
