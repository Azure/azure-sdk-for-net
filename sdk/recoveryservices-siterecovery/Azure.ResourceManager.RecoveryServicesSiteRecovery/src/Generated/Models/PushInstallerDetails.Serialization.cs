...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PushInstallerDetails>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PushInstallerDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PushInstallerDetails>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PushInstallerDetails>)} interface");
            }
        ...
        string IPersistableModel<PushInstallerDetails>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
