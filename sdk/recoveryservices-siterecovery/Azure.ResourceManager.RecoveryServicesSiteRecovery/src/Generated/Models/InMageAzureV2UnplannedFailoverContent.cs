...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class InMageAzureV2UnplannedFailoverContent : UnplannedFailoverProviderSpecificContent
    {
        ...
        internal InMageAzureV2UnplannedFailoverContent(string instanceType, ResourceIdentifier recoveryPointId, Dictionary<string, BinaryData> rawData) : base(instanceType, rawData)
        {
