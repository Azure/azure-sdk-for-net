...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class ExportJobDetails : JobDetails
    {
        ...
        internal ExportJobDetails(string instanceType, IDictionary<string, string> affectedObjectDetails, IDictionary<string, BinaryData> additionalBinaryDataProperties, string blobUri, string sasToken) : base(instanceType, affectedObjectDetails, additionalBinaryDataProperties)
        {
            BlobUri = blobUri;
            SasToken = sasToken;
        }
