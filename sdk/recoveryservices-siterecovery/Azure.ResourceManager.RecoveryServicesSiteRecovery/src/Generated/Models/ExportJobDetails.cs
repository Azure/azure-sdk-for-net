...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class ExportJobDetails : SiteRecoveryJobDetails
    {
        ...
        internal ExportJobDetails(string instanceType, IReadOnlyDictionary<string, string> affectedObjectDetails, Uri blobUri, string sasToken, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(instanceType, affectedObjectDetails, serializedAdditionalRawData)
        {
            BlobUri = blobUri;
            SasToken = sasToken;
