...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class ProcessServerDetails
    {
        ...
        /// <summary> Initializes a new instance of <see cref="ProcessServerDetails"/>. </summary>
        ...
        internal ProcessServerDetails(string id, string name, string biosId, string fabricObjectId, string fqdn, IReadOnlyList<string> ipAddresses, string version, DateTimeOffset? lastHeartbeatUtc, long? totalMemoryInBytes, long? availableMemoryInBytes, long? usedMemoryInBytes, double? memoryUsagePercentage, long? totalSpaceInBytes, long? availableSpaceInBytes, long? usedSpaceInBytes, double? freeSpacePercentage, long? throughputUploadPendingDataInBytes, long? throughputInBytes, double? processorUsagePercentage, RcmComponentStatus? throughputStatus, long? systemLoad, RcmComponentStatus? systemLoadStatus, RcmComponentStatus? diskUsageStatus, RcmComponentStatus? memoryUsageStatus, RcmComponentStatus? processorUsageStatus, ProtectionHealth? health, IReadOnlyList<HealthError> healthErrors, int? protectedItemCount, ProtectionHealth? historicHealth, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Id = id;
            Name = name;
            BiosId = biosId;
