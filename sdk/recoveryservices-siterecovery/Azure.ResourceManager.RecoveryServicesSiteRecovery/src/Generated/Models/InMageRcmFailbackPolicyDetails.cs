...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class InMageRcmFailbackPolicyDetails : PolicyProviderSpecificDetails
    {
        ...
        internal InMageRcmFailbackPolicyDetails(string instanceType, int? appConsistentFrequencyInMinutes, int? crashConsistentFrequencyInMinutes, Dictionary<string, BinaryData> rawData) : base(instanceType, rawData)
        {
