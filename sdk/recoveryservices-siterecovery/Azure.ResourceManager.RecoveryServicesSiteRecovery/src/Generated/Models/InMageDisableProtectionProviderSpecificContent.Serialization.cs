...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<InMageDisableProtectionProviderSpecificContent>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<InMageDisableProtectionProviderSpecificContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<InMageDisableProtectionProviderSpecificContent>)} interface");
            }
        ...
        string IPersistableModel<InMageDisableProtectionProviderSpecificContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
