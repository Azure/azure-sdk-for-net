...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class InMageRcmFailbackEventDetails : EventProviderSpecificDetails
    {
        ...
        internal InMageRcmFailbackEventDetails() : base("InMageRcmFailback")
        {
        }
        ...
        internal InMageRcmFailbackEventDetails(string instanceType, IDictionary<string, BinaryData> additionalBinaryDataProperties, string protectedItemName, string vmName, string applianceName, string serverType, string componentDisplayName) : base(instanceType, additionalBinaryDataProperties)
        {
