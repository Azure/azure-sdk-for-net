...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class InMageRcmFailbackEventDetails : SiteRecoveryEventProviderSpecificDetails
    {
        ...
        internal InMageRcmFailbackEventDetails(string instanceType, string protectedItemName, string vmName, string applianceName, string serverType, string componentDisplayName, Dictionary<string, BinaryData> rawData) : base(instanceType, rawData)
        {
