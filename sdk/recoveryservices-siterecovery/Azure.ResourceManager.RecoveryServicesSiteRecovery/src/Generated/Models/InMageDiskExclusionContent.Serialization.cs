...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class InMageDiskExclusionContent : IJsonModel<InMageDiskExclusionContent>
    {
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual InMageDiskExclusionContent PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<InMageDiskExclusionContent>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<InMageDiskExclusionContent>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        InMageDiskExclusionContent IPersistableModel<InMageDiskExclusionContent>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        InMageDiskExclusionContent IJsonModel<InMageDiskExclusionContent>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual InMageDiskExclusionContent JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<InMageDiskExclusionContent>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static InMageDiskExclusionContent DeserializeInMageDiskExclusionContent(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new InMageDiskExclusionContent(volumeOptions ?? new ChangeTrackingList<InMageVolumeExclusionOptions>(), diskSignatureOptions ?? new ChangeTrackingList<InMageDiskSignatureExclusionOptions>(), additionalBinaryDataProperties);
        }
    }
}
