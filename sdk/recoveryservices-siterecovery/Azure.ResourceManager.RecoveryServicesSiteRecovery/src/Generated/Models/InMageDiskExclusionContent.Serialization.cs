...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<InMageDiskExclusionContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<InMageDiskExclusionContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<InMageDiskExclusionContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<InMageDiskExclusionContent>)} interface");
            }
        ...
        string IPersistableModel<InMageDiskExclusionContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
