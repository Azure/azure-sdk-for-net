...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class InMageAzureV2PolicyContent : PolicyProviderSpecificContent, IJsonModel<InMageAzureV2PolicyContent>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<InMageAzureV2PolicyContent>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<InMageAzureV2PolicyContent>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        InMageAzureV2PolicyContent IPersistableModel<InMageAzureV2PolicyContent>.Create(BinaryData data, ModelReaderWriterOptions options) => (InMageAzureV2PolicyContent)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        InMageAzureV2PolicyContent IJsonModel<InMageAzureV2PolicyContent>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (InMageAzureV2PolicyContent)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static InMageAzureV2PolicyContent DeserializeInMageAzureV2PolicyContent(JsonElement element, ModelReaderWriterOptions options)
        {
