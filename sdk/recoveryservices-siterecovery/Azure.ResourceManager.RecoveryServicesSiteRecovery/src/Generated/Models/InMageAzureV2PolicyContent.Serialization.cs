...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<InMageAzureV2PolicyContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<InMageAzureV2PolicyContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<InMageAzureV2PolicyContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<InMageAzureV2PolicyContent>)} interface");
            }
        ...
        string IPersistableModel<InMageAzureV2PolicyContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
