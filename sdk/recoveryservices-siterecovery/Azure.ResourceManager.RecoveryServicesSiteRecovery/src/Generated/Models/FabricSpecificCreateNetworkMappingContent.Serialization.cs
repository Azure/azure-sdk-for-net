...
{
    [ModelReaderProxy(typeof(UnknownFabricSpecificCreateNetworkMappingContent))]
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FabricSpecificCreateNetworkMappingContent>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        FabricSpecificCreateNetworkMappingContent IJsonModel<FabricSpecificCreateNetworkMappingContent>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<FabricSpecificCreateNetworkMappingContent>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        FabricSpecificCreateNetworkMappingContent IModel<FabricSpecificCreateNetworkMappingContent>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<FabricSpecificCreateNetworkMappingContent>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
