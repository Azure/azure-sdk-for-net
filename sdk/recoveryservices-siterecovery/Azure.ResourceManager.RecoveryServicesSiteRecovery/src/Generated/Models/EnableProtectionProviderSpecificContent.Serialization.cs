...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    public partial class EnableProtectionProviderSpecificContent : IUtf8JsonSerializable, IModelJsonSerializable<EnableProtectionProviderSpecificContent>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<EnableProtectionProviderSpecificContent>(this, options.Format);
        ...
        internal static EnableProtectionProviderSpecificContent DeserializeEnableProtectionProviderSpecificContent(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new Models.EnableProtectionProviderSpecificContent(instanceType, serializedAdditionalRawData);
        }
        ...
        /// <summary> Converts a <see cref="EnableProtectionProviderSpecificContent"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="EnableProtectionProviderSpecificContent"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="EnableProtectionProviderSpecificContent"/>. </summary>
