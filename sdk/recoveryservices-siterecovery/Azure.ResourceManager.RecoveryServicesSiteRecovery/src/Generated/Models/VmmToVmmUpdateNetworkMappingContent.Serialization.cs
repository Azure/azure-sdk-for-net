...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VmmToVmmUpdateNetworkMappingContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<VmmToVmmUpdateNetworkMappingContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<VmmToVmmUpdateNetworkMappingContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<VmmToVmmUpdateNetworkMappingContent>)} interface");
            }
        ...
        string IPersistableModel<VmmToVmmUpdateNetworkMappingContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
