...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VmmToVmmUpdateNetworkMappingContent>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<VmmToVmmUpdateNetworkMappingContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<VmmToVmmUpdateNetworkMappingContent>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
