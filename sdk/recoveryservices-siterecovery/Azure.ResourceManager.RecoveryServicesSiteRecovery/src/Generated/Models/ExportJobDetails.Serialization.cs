...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class ExportJobDetails : SiteRecoveryJobDetails, IJsonModel<ExportJobDetails>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<ExportJobDetails>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ExportJobDetails>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        ExportJobDetails IPersistableModel<ExportJobDetails>.Create(BinaryData data, ModelReaderWriterOptions options) => (ExportJobDetails)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ExportJobDetails IJsonModel<ExportJobDetails>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (ExportJobDetails)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static ExportJobDetails DeserializeExportJobDetails(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string instanceType = "ExportJobDetails";
