...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ExportJobDetails>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ExportJobDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ExportJobDetails>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ExportJobDetails>)} interface");
            }
        ...
        string IPersistableModel<ExportJobDetails>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
