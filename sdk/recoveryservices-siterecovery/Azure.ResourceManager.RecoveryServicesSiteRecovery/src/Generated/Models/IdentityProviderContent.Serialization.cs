...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IdentityProviderContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<IdentityProviderContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<IdentityProviderContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<IdentityProviderContent>)} interface");
            }
        ...
        string IPersistableModel<IdentityProviderContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
