...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class InMageRcmFailbackPlannedFailoverProviderContent : PlannedFailoverProviderSpecificFailoverContent
    {
        ...
        internal InMageRcmFailbackPlannedFailoverProviderContent(string instanceType, InMageRcmFailbackRecoveryPointType recoveryPointType, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(instanceType, serializedAdditionalRawData)
        {
            RecoveryPointType = recoveryPointType;
