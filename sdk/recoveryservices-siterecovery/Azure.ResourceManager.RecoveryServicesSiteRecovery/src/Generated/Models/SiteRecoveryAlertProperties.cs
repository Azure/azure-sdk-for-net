...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class SiteRecoveryAlertProperties
    {
        ...
        internal SiteRecoveryAlertProperties(string sendToOwners, IReadOnlyList<string> customEmailAddresses, string locale, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
