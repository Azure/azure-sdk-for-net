...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class RecoveryPlanA2ADetails : RecoveryPlanProviderSpecificDetails
    {
        ...
        internal RecoveryPlanA2ADetails(string instanceType, IDictionary<string, BinaryData> additionalBinaryDataProperties, string primaryZone, string recoveryZone, SiteRecoveryExtendedLocation primaryExtendedLocation, SiteRecoveryExtendedLocation recoveryExtendedLocation) : base(instanceType, additionalBinaryDataProperties)
        {
