...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="InMageEnableProtectionInput"/>. </summary>
        ...
        public InMageEnableProtectionInput(string masterTargetId, string processServerId, string retentionDrive, string multiVmGroupId, string multiVmGroupName) : base("InMage")
        {
        ...
        internal InMageEnableProtectionInput(string instanceType, IDictionary<string, BinaryData> additionalBinaryDataProperties, string vmFriendlyName, string masterTargetId, string processServerId, string retentionDrive, string runAsAccountId, string multiVmGroupId, string multiVmGroupName, string datastoreName, InMageDiskExclusionInput diskExclusionInput, IList<string> disksToInclude) : base(instanceType, additionalBinaryDataProperties)
        {
