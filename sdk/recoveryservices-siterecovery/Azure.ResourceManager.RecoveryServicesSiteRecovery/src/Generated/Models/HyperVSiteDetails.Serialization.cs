...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class HyperVSiteDetails : FabricSpecificDetails, IJsonModel<HyperVSiteDetails>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<HyperVSiteDetails>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<HyperVSiteDetails>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        HyperVSiteDetails IPersistableModel<HyperVSiteDetails>.Create(BinaryData data, ModelReaderWriterOptions options) => (HyperVSiteDetails)PersistableModelCreateCore(data, options);
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(HyperVHosts))
            {
                ...
                foreach (HyperVHostDetails item in HyperVHosts)
                {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        HyperVSiteDetails IJsonModel<HyperVSiteDetails>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (HyperVSiteDetails)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static HyperVSiteDetails DeserializeHyperVSiteDetails(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string instanceType = "HyperVSite";
            IDictionary<string, BinaryData> additionalBinaryDataProperties = new ChangeTrackingDictionary<string, BinaryData>();
            IList<HyperVHostDetails> hyperVHosts = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("hyperVHosts"u8))
                {
            ...
            return new HyperVSiteDetails(instanceType, additionalBinaryDataProperties, hyperVHosts ?? new ChangeTrackingList<HyperVHostDetails>());
        }
    }
}
