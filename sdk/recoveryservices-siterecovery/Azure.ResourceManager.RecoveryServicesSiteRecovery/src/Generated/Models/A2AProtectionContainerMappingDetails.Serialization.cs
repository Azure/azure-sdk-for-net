...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<A2AProtectionContainerMappingDetails>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<A2AProtectionContainerMappingDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<A2AProtectionContainerMappingDetails>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<A2AProtectionContainerMappingDetails>)} interface");
            }
        ...
        string IPersistableModel<A2AProtectionContainerMappingDetails>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
