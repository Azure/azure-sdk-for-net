...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MobilityServiceUpdate>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MobilityServiceUpdate>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MobilityServiceUpdate>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MobilityServiceUpdate>)} interface");
            }
        ...
        string IPersistableModel<MobilityServiceUpdate>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
