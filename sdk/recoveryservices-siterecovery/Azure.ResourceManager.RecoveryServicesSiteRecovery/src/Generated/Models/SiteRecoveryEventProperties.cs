...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class SiteRecoveryEventProperties
    {
        ...
        internal SiteRecoveryEventProperties(string eventCode, string description, string eventType, string affectedObjectFriendlyName, string affectedObjectCorrelationId, string severity, DateTimeOffset? occurredOn, ResourceIdentifier fabricId, SiteRecoveryEventProviderSpecificDetails providerSpecificDetails, SiteRecoveryEventSpecificDetails eventSpecificDetails, IReadOnlyList<SiteRecoveryHealthError> healthErrors, Dictionary<string, BinaryData> rawData)
        {
            EventCode = eventCode;
