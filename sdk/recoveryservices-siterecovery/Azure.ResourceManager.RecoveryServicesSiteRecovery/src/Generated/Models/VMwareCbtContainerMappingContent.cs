...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class VMwareCbtContainerMappingContent : ReplicationProviderSpecificContainerMappingContent
    {
        ...
        internal VMwareCbtContainerMappingContent(string instanceType, ResourceIdentifier keyVaultId, Uri keyVaultUri, ResourceIdentifier storageAccountId, string storageAccountSasSecretName, string serviceBusConnectionStringSecretName, string targetLocation, Dictionary<string, BinaryData> rawData) : base(instanceType, rawData)
        {
