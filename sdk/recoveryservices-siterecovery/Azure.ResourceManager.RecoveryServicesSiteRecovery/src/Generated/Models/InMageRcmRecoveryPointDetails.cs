...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class InMageRcmRecoveryPointDetails : ProviderSpecificRecoveryPointDetails
    {
        ...
        internal InMageRcmRecoveryPointDetails(string instanceType, string isMultiVmSyncPoint, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(instanceType, serializedAdditionalRawData)
        {
