...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class A2ACrossClusterMigrationApplyRecoveryPointContent : SiteRecoveryApplyRecoveryPointProviderSpecificContent, IJsonModel<A2ACrossClusterMigrationApplyRecoveryPointContent>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<A2ACrossClusterMigrationApplyRecoveryPointContent>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<A2ACrossClusterMigrationApplyRecoveryPointContent>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        A2ACrossClusterMigrationApplyRecoveryPointContent IPersistableModel<A2ACrossClusterMigrationApplyRecoveryPointContent>.Create(BinaryData data, ModelReaderWriterOptions options) => (A2ACrossClusterMigrationApplyRecoveryPointContent)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        A2ACrossClusterMigrationApplyRecoveryPointContent IJsonModel<A2ACrossClusterMigrationApplyRecoveryPointContent>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (A2ACrossClusterMigrationApplyRecoveryPointContent)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static A2ACrossClusterMigrationApplyRecoveryPointContent DeserializeA2ACrossClusterMigrationApplyRecoveryPointContent(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new A2ACrossClusterMigrationApplyRecoveryPointContent(instanceType, additionalBinaryDataProperties);
        }
    }
}
