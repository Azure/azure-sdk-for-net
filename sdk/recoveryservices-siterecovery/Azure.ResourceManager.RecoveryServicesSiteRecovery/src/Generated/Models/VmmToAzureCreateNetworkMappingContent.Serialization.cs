...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VmmToAzureCreateNetworkMappingContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<VmmToAzureCreateNetworkMappingContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<VmmToAzureCreateNetworkMappingContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<VmmToAzureCreateNetworkMappingContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
