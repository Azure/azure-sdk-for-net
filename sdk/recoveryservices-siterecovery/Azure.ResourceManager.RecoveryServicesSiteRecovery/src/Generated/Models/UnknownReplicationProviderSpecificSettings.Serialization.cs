...
{
    internal partial class UnknownReplicationProviderSpecificSettings : ReplicationProviderSpecificSettings, IJsonModel<ReplicationProviderSpecificSettings>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownReplicationProviderSpecificSettings DeserializeUnknownReplicationProviderSpecificSettings(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownReplicationProviderSpecificSettings(instanceType, additionalBinaryDataProperties);
        }
    }
}
