...
{
    internal partial class UnknownReplicationProviderSpecificSettings : IUtf8JsonSerializable, IJsonModel<ReplicationProviderSpecificSettings>, IPersistableModel<ReplicationProviderSpecificSettings>
    {
        ...
        ReplicationProviderSpecificSettings IJsonModel<ReplicationProviderSpecificSettings>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            return DeserializeUnknownReplicationProviderSpecificSettings(document.RootElement, options);
        }
