...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<UpdateNetworkMappingProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<UpdateNetworkMappingProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<UpdateNetworkMappingProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<UpdateNetworkMappingProperties>)} interface");
            }
        ...
        string IPersistableModel<UpdateNetworkMappingProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
