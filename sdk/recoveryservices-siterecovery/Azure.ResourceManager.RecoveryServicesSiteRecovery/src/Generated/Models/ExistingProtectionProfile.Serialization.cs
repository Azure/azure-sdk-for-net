...
{
    public partial class ExistingProtectionProfile : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ExistingProtectionProfile DeserializeExistingProtectionProfile(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
