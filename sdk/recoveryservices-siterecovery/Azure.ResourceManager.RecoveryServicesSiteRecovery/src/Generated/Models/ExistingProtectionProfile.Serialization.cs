...
{
    public partial class ExistingProtectionProfile : IUtf8JsonSerializable, IJsonModel<ExistingProtectionProfile>, IPersistableModel<ExistingProtectionProfile>
    {
        ...
        void IJsonModel<ExistingProtectionProfile>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ExistingProtectionProfile)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ProtectionProfileId))
            {
                builder.Append("  protectionProfileId:");
                builder.AppendLine($" '{ProtectionProfileId}'");
            }
