...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ExistingProtectionProfile>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ExistingProtectionProfile>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ExistingProtectionProfile>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ExistingProtectionProfile>)} interface");
            }
        ...
        string IPersistableModel<ExistingProtectionProfile>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
