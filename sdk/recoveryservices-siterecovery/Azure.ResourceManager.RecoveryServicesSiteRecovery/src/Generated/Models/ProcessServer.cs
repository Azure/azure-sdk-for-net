...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class ProcessServer
    {
        ...
        /// <summary> Initializes a new instance of <see cref="ProcessServer"/>. </summary>
        ...
        internal ProcessServer(string friendlyName, string id, string ipAddress, string osType, string agentVersion, DateTimeOffset? lastHeartbeat, string versionStatus, IList<MobilityServiceUpdate> mobilityServiceUpdates, string hostId, string machineCount, string replicationPairCount, string systemLoad, string systemLoadStatus, string cpuLoad, string cpuLoadStatus, long? totalMemoryInBytes, long? availableMemoryInBytes, string memoryUsageStatus, long? totalSpaceInBytes, long? availableSpaceInBytes, string spaceUsageStatus, string psServiceStatus, DateTimeOffset? sslCertExpiryOn, int? sslCertExpiryRemainingDays, string osVersion, IList<HealthError> healthErrors, DateTimeOffset? agentExpiryOn, VersionDetails agentVersionDetails, ProtectionHealth? health, DateTimeOffset? psStatsRefreshOn, long? throughputUploadPendingDataInBytes, long? throughputInMBps, long? throughputInBytes, string throughputStatus, string marsCommunicationStatus, string marsRegistrationStatus, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
        ...
        public IList<MobilityServiceUpdate> MobilityServiceUpdates { get; }
