...
{
    internal partial class UnknownPolicyProviderSpecificContent : PolicyProviderSpecificContent, IJsonModel<PolicyProviderSpecificContent>
    {
        /// <summary> Initializes a new instance of <see cref="UnknownPolicyProviderSpecificContent"/> for deserialization. </summary>
        internal UnknownPolicyProviderSpecificContent()
        {
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownPolicyProviderSpecificContent DeserializeUnknownPolicyProviderSpecificContent(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownPolicyProviderSpecificContent(instanceType, additionalBinaryDataProperties);
        }
    }
}
