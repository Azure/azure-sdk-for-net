...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ReplicationProtectionIntentProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ReplicationProtectionIntentProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ReplicationProtectionIntentProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<ReplicationProtectionIntentProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
