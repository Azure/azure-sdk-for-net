...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ResolveHealthContentProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ResolveHealthContentProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ResolveHealthContentProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ResolveHealthContentProperties>)} interface");
            }
        ...
        string IPersistableModel<ResolveHealthContentProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
