...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HyperVReplicaAzurePolicyContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<HyperVReplicaAzurePolicyContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<HyperVReplicaAzurePolicyContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<HyperVReplicaAzurePolicyContent>)} interface");
            }
        ...
        string IPersistableModel<HyperVReplicaAzurePolicyContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
