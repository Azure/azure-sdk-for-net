...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    public partial class PlannedFailoverProperties : IUtf8JsonSerializable, IJsonModel<PlannedFailoverProperties>
    {
        ...
        void IJsonModel<PlannedFailoverProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(PlannedFailoverProperties)} does not support '{format}' format.");
            }
            ...
            if (Optional.IsDefined(ProviderSpecificDetails))
            {
                ...
                ((IJsonModel<PlannedFailoverProviderSpecificFailoverContent>)ProviderSpecificDetails).Write(writer, options);
            }
