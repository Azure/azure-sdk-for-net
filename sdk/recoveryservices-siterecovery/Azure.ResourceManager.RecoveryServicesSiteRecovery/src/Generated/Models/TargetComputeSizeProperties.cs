...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class TargetComputeSizeProperties
    {
        ...
        internal TargetComputeSizeProperties(string name, string friendlyName, int? cpuCoresCount, int? vcpUsAvailable, double? memoryInGB, int? maxDataDiskCount, int? maxNicsCount, IList<ComputeSizeErrorDetails> errors, string highIopsSupported, IList<string> hyperVGenerations, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Name = name;
        ...
        public IList<ComputeSizeErrorDetails> Errors { get; }
        ...
        public IList<string> HyperVGenerations { get; }
    }
}
