...
{
    internal partial class SiteRecoveryReplicationApplianceProperties : IUtf8JsonSerializable, IJsonModel<SiteRecoveryReplicationApplianceProperties>, IPersistableModel<SiteRecoveryReplicationApplianceProperties>
    {
        ...
        void IJsonModel<SiteRecoveryReplicationApplianceProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SiteRecoveryReplicationApplianceProperties)} does not support '{format}' format.");
            }
