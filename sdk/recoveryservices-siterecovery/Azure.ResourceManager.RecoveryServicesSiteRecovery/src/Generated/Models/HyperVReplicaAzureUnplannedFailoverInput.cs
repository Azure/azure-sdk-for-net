...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="HyperVReplicaAzureUnplannedFailoverInput"/>. </summary>
        public HyperVReplicaAzureUnplannedFailoverInput() : base("HyperVReplicaAzure")
        {
        }
        ...
        internal HyperVReplicaAzureUnplannedFailoverInput(string instanceType, IDictionary<string, BinaryData> additionalBinaryDataProperties, string primaryKekCertificatePfx, string secondaryKekCertificatePfx, string recoveryPointId) : base(instanceType, additionalBinaryDataProperties)
        {
