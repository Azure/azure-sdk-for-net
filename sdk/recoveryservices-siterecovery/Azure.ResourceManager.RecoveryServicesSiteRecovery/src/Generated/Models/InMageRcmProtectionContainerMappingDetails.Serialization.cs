...
{
    public partial class InMageRcmProtectionContainerMappingDetails : IUtf8JsonSerializable, IJsonModel<InMageRcmProtectionContainerMappingDetails>, IPersistableModel<InMageRcmProtectionContainerMappingDetails>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<InMageRcmProtectionContainerMappingDetails>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<InMageRcmProtectionContainerMappingDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(InMageRcmProtectionContainerMappingDetails)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  enableAgentAutoUpgrade:");
                builder.AppendLine($" '{EnableAgentAutoUpgrade}'");
            }
