...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    public partial class InMageRcmProtectionContainerMappingDetails : IUtf8JsonSerializable, IModelJsonSerializable<InMageRcmProtectionContainerMappingDetails>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<InMageRcmProtectionContainerMappingDetails>(this, options.Format);
        ...
        internal static InMageRcmProtectionContainerMappingDetails DeserializeInMageRcmProtectionContainerMappingDetails(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new InMageRcmProtectionContainerMappingDetails(instanceType, enableAgentAutoUpgrade.Value, serializedAdditionalRawData);
        }
        ...
        /// <summary> Converts a <see cref="InMageRcmProtectionContainerMappingDetails"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="InMageRcmProtectionContainerMappingDetails"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="InMageRcmProtectionContainerMappingDetails"/>. </summary>
