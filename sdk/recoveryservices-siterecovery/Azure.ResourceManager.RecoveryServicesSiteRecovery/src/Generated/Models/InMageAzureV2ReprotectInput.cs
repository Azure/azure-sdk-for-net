...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="InMageAzureV2ReprotectInput"/>. </summary>
        public InMageAzureV2ReprotectInput() : base("InMageAzureV2")
        {
        ...
        internal InMageAzureV2ReprotectInput(string instanceType, IDictionary<string, BinaryData> additionalBinaryDataProperties, string masterTargetId, string processServerId, string storageAccountId, string runAsAccountId, string policyId, string logStorageAccountId, IList<string> disksToInclude) : base(instanceType, additionalBinaryDataProperties)
        {
