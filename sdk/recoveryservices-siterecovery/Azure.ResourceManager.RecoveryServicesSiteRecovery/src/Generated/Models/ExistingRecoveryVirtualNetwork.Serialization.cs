...
{
    public partial class ExistingRecoveryVirtualNetwork : IUtf8JsonSerializable, IJsonModel<ExistingRecoveryVirtualNetwork>, IPersistableModel<ExistingRecoveryVirtualNetwork>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(RecoveryVirtualNetworkId))
            {
                builder.Append("  recoveryVirtualNetworkId:");
                builder.AppendLine($" '{RecoveryVirtualNetworkId.ToString()}'");
            }
