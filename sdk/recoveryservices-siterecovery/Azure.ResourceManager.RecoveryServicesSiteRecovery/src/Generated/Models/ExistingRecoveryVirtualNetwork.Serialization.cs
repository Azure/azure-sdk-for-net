...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ExistingRecoveryVirtualNetwork>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ExistingRecoveryVirtualNetwork>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ExistingRecoveryVirtualNetwork>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ExistingRecoveryVirtualNetwork>)} interface");
            }
        ...
        string IPersistableModel<ExistingRecoveryVirtualNetwork>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
