...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class ApplianceResourceDetails
    {
        ...
        internal ApplianceResourceDetails(long? capacity, double? processUtilization, double? totalUtilization, string status, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Capacity = capacity;
