...
{
    public partial class DataStoreUtilizationDetails : IUtf8JsonSerializable, IJsonModel<DataStoreUtilizationDetails>, IPersistableModel<DataStoreUtilizationDetails>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  totalSnapshotsSupported:");
                builder.AppendLine($" '{TotalSnapshotsSupported.Value.ToString()}'");
            }

            if (Optional.IsDefined(TotalSnapshotsCreated))
            {
                builder.Append("  totalSnapshotsCreated:");
                builder.AppendLine($" '{TotalSnapshotsCreated.Value.ToString()}'");
            }

            if (Optional.IsDefined(DataStoreName))
            {
                builder.Append("  dataStoreName:");
                builder.AppendLine($" '{DataStoreName}'");
            }
