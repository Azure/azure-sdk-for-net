...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<InMageRcmAgentUpgradeBlockingErrorDetails>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<InMageRcmAgentUpgradeBlockingErrorDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<InMageRcmAgentUpgradeBlockingErrorDetails>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<InMageRcmAgentUpgradeBlockingErrorDetails>)} interface");
            }
        ...
        string IPersistableModel<InMageRcmAgentUpgradeBlockingErrorDetails>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
