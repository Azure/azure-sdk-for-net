...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SiteRecoveryProtectionContainerData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SiteRecoveryProtectionContainerData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SiteRecoveryProtectionContainerData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SiteRecoveryProtectionContainerData>)} interface");
            }
        ...
        string IPersistableModel<SiteRecoveryProtectionContainerData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
