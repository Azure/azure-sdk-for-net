...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class MigrationItemResyncContent
    {
        ...
        internal MigrationItemResyncContent(MigrationItemResyncProperties properties, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Properties = properties;
            _serializedAdditionalRawData = serializedAdditionalRawData;
        }

        /// <summary> Initializes a new instance of <see cref="MigrationItemResyncContent"/> for deserialization. </summary>
        internal MigrationItemResyncContent()
        {
        }
