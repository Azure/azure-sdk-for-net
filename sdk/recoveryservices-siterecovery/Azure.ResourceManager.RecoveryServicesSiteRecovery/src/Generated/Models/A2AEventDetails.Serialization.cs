...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class A2AEventDetails : SiteRecoveryEventProviderSpecificDetails, IJsonModel<A2AEventDetails>
    {
        ...
        internal static A2AEventDetails DeserializeA2AEventDetails(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("fabricLocation"u8))
                {
                    ...
                    fabricLocation = new AzureLocation(prop.Value.GetString());
                    continue;
                }
                ...
                if (prop.NameEquals("remoteFabricLocation"u8))
                {
                    ...
                    remoteFabricLocation = new AzureLocation(prop.Value.GetString());
                    continue;
                }
                if (options.Format != "W")
                {
