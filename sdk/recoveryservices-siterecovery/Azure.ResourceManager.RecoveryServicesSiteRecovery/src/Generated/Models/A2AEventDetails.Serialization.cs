...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<A2AEventDetails>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<A2AEventDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<A2AEventDetails>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<A2AEventDetails>)} interface");
            }
        ...
        string IPersistableModel<A2AEventDetails>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
