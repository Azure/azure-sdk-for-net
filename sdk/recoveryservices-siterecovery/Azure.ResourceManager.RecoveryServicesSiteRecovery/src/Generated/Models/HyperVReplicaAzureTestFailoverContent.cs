...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class HyperVReplicaAzureTestFailoverContent : TestFailoverProviderSpecificContent
    {
        ...
        internal HyperVReplicaAzureTestFailoverContent(string instanceType, string primaryKekCertificatePfx, string secondaryKekCertificatePfx, ResourceIdentifier recoveryPointId) : base(instanceType)
        {
