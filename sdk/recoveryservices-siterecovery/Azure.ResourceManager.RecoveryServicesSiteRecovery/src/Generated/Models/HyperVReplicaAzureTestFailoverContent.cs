...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class HyperVReplicaAzureTestFailoverContent : TestFailoverProviderSpecificContent
    {
        ...
        public HyperVReplicaAzureTestFailoverContent() : base("HyperVReplicaAzure")
        {
        }
        ...
        internal HyperVReplicaAzureTestFailoverContent(string instanceType, IDictionary<string, BinaryData> additionalBinaryDataProperties, string primaryKekCertificatePfx, string secondaryKekCertificatePfx, ResourceIdentifier recoveryPointId, string osUpgradeVersion) : base(instanceType, additionalBinaryDataProperties)
        {
