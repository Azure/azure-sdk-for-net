...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class RecoveryPlanAction
    {
        ...
        internal RecoveryPlanAction(string actionName, IList<ReplicationProtectedItemOperation> failoverTypes, IList<PossibleOperationsDirection> failoverDirections, RecoveryPlanActionDetails customDetails, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ActionName = actionName;
