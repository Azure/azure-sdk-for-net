...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    public partial class A2APolicyDetails : IUtf8JsonSerializable, IJsonModel<A2APolicyDetails>
    {
        ...
        void IJsonModel<A2APolicyDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(A2APolicyDetails)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<A2APolicyDetails>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(A2APolicyDetails)} does not support '{options.Format}' format.");
            }
        }
