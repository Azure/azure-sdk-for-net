...
{
    public partial class A2APolicyDetails : IUtf8JsonSerializable, IJsonModel<A2APolicyDetails>, IPersistableModel<A2APolicyDetails>
    {
        ...
        void IJsonModel<A2APolicyDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(A2APolicyDetails)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(RecoveryPointThresholdInMinutes))
            {
                ...
                builder.AppendLine($" '{RecoveryPointThresholdInMinutes.Value.ToString()}'");
            }

            if (Optional.IsDefined(RecoveryPointHistory))
            {
                builder.Append("  recoveryPointHistory:");
                builder.AppendLine($" '{RecoveryPointHistory.Value.ToString()}'");
            }
