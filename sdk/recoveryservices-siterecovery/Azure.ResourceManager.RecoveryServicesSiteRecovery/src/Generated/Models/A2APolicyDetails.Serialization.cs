...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    public partial class A2APolicyDetails : IUtf8JsonSerializable, IModelJsonSerializable<A2APolicyDetails>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<A2APolicyDetails>(this, options.Format);
        ...
        internal static A2APolicyDetails DeserializeA2APolicyDetails(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new A2APolicyDetails(instanceType, Optional.ToNullable(recoveryPointThresholdInMinutes), Optional.ToNullable(recoveryPointHistory), Optional.ToNullable(appConsistentFrequencyInMinutes), multiVmSyncStatus.Value, Optional.ToNullable(crashConsistentFrequencyInMinutes), serializedAdditionalRawData);
        }
