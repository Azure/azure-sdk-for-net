...
{
    public partial class InitialReplicationDetails : IUtf8JsonSerializable, IJsonModel<InitialReplicationDetails>, IPersistableModel<InitialReplicationDetails>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(InitialReplicationType))
            {
                builder.Append("  initialReplicationType:");
                builder.AppendLine($" '{InitialReplicationType}'");
            }

            if (Optional.IsDefined(InitialReplicationProgressPercentage))
            {
                builder.Append("  initialReplicationProgressPercentage:");
                builder.AppendLine($" '{InitialReplicationProgressPercentage}'");
            }
