...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class A2AUnplannedFailoverContent : UnplannedFailoverProviderSpecificContent
    {
        ...
        public A2AUnplannedFailoverContent() : base("A2A")
        {
        }
        ...
        internal A2AUnplannedFailoverContent(string instanceType, IDictionary<string, BinaryData> additionalBinaryDataProperties, ResourceIdentifier recoveryPointId, string cloudServiceCreationOption) : base(instanceType, additionalBinaryDataProperties)
        {
