...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RecoveryPlanTestFailoverCleanupContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RecoveryPlanTestFailoverCleanupContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RecoveryPlanTestFailoverCleanupContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RecoveryPlanTestFailoverCleanupContent>)} interface");
            }
        ...
        string IPersistableModel<RecoveryPlanTestFailoverCleanupContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
