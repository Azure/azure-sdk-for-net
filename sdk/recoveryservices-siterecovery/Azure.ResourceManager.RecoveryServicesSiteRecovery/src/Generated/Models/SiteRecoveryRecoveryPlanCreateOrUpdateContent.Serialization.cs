...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SiteRecoveryRecoveryPlanCreateOrUpdateContent>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            ((IJsonModel<SiteRecoveryCreateRecoveryPlanProperties>)Properties).Write(writer, options);
        ...
        internal static SiteRecoveryRecoveryPlanCreateOrUpdateContent DeserializeSiteRecoveryRecoveryPlanCreateOrUpdateContent(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    properties = ModelSerializationExtensions.JsonDeserialize<SiteRecoveryCreateRecoveryPlanProperties>(property.Value);
                    continue;
                }
                if (options.Format != "W")
                {
