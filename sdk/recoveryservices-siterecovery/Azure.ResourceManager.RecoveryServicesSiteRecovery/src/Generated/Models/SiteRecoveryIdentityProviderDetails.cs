...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    /// </summary>
    public partial class SiteRecoveryIdentityProviderDetails
    {
        /// <summary> Initializes a new instance of SiteRecoveryIdentityProviderDetails. </summary>
        internal SiteRecoveryIdentityProviderDetails()
        {
        }
        ...
        /// </param>
        internal SiteRecoveryIdentityProviderDetails(Guid? tenantId, string applicationId, string objectId, string audience, string aadAuthority)
        {
            TenantId = tenantId;
