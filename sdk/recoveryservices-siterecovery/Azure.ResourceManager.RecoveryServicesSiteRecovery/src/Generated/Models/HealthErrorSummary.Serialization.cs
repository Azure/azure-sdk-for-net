...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class HealthErrorSummary : IJsonModel<HealthErrorSummary>
    {
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual HealthErrorSummary PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<HealthErrorSummary>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<HealthErrorSummary>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        HealthErrorSummary IPersistableModel<HealthErrorSummary>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        HealthErrorSummary IJsonModel<HealthErrorSummary>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual HealthErrorSummary JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<HealthErrorSummary>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static HealthErrorSummary DeserializeHealthErrorSummary(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            {
                if (prop.NameEquals("summaryCode"u8))
                {
                    summaryCode = prop.Value.GetString();
                    continue;
                }
                if (prop.NameEquals("category"u8))
                {
                    ...
                    category = new HealthErrorCategory(prop.Value.GetString());
                    continue;
                }
                if (prop.NameEquals("severity"u8))
                {
                    ...
                    severity = new SiteRecoveryErrorSeverity(prop.Value.GetString());
                    continue;
                }
                ...
                if (prop.NameEquals("affectedResourceSubtype"u8))
                {
                    affectedResourceSubtype = prop.Value.GetString();
                    continue;
                }
