...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HealthErrorSummary>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<HealthErrorSummary>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<HealthErrorSummary>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<HealthErrorSummary>)} interface");
            }
        ...
        string IPersistableModel<HealthErrorSummary>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
