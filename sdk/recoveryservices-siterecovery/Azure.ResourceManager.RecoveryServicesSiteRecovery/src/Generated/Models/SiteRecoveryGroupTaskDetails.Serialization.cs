...
{
    public partial class SiteRecoveryGroupTaskDetails : IUtf8JsonSerializable, IModelJsonSerializable<SiteRecoveryGroupTaskDetails>
    {
        ...
        internal static SiteRecoveryGroupTaskDetails DeserializeSiteRecoveryGroupTaskDetails(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new UnknownGroupTaskDetails(instanceType, Optional.ToList(childTasks), rawData);
        }
        ...
        /// <summary> Converts a <see cref="SiteRecoveryGroupTaskDetails"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="SiteRecoveryGroupTaskDetails"/> to convert. </param>
        public static implicit operator RequestContent(SiteRecoveryGroupTaskDetails model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="SiteRecoveryGroupTaskDetails"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator SiteRecoveryGroupTaskDetails(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeSiteRecoveryGroupTaskDetails(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
