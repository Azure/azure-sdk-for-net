...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class HyperVReplicaAzureUnplannedFailoverContent : UnplannedFailoverProviderSpecificContent
    {
        ...
        internal HyperVReplicaAzureUnplannedFailoverContent(string instanceType, string primaryKekCertificatePfx, string secondaryKekCertificatePfx, ResourceIdentifier recoveryPointId, Dictionary<string, BinaryData> rawData) : base(instanceType, rawData)
        {
