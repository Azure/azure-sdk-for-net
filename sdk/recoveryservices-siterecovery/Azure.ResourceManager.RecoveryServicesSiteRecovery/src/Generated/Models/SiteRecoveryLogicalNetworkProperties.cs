...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class SiteRecoveryLogicalNetworkProperties
    {
        ...
        internal SiteRecoveryLogicalNetworkProperties(string friendlyName, string networkVirtualizationStatus, string logicalNetworkUsage, string logicalNetworkDefinitionsStatus, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
