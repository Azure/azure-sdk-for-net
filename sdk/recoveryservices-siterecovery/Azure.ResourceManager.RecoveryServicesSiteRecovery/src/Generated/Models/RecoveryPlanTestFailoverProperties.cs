...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class RecoveryPlanTestFailoverProperties
    {
        ...
        internal RecoveryPlanTestFailoverProperties(PossibleOperationsDirection failoverDirection, string networkType, ResourceIdentifier networkId, IList<RecoveryPlanProviderSpecificFailoverContent> providerSpecificDetails, Dictionary<string, BinaryData> rawData)
        {
            FailoverDirection = failoverDirection;
            NetworkType = networkType;
            NetworkId = networkId;
