...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class RecoveryPlanTestFailoverProperties
    {
        ...
        internal RecoveryPlanTestFailoverProperties(PossibleOperationsDirection failoverDirection, string networkType, ResourceIdentifier networkId, IList<RecoveryPlanProviderSpecificFailoverContent> providerSpecificDetails, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            FailoverDirection = failoverDirection;
            NetworkType = networkType;
            NetworkId = networkId;
