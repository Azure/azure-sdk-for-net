...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class VMwareCbtUpdateMigrationItemInput : UpdateMigrationItemProviderSpecificInput, IJsonModel<VMwareCbtUpdateMigrationItemInput>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<VMwareCbtUpdateMigrationItemInput>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
                    using (JsonDocument document = JsonDocument.Parse(data, ModelSerializationExtensions.JsonDocumentOptions))
                    {
                        return DeserializeVMwareCbtUpdateMigrationItemInput(document.RootElement, options);
                    }
                default:
                    throw new FormatException($"The model {nameof(VMwareCbtUpdateMigrationItemInput)} does not support reading '{options.Format}' format.");
            }
        }
        ...
        protected override BinaryData PersistableModelWriteCore(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(VMwareCbtUpdateMigrationItemInput)} does not support writing '{options.Format}' format.");
            }
        }

        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<VMwareCbtUpdateMigrationItemInput>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        VMwareCbtUpdateMigrationItemInput IPersistableModel<VMwareCbtUpdateMigrationItemInput>.Create(BinaryData data, ModelReaderWriterOptions options) => (VMwareCbtUpdateMigrationItemInput)PersistableModelCreateCore(data, options);

        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<VMwareCbtUpdateMigrationItemInput>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";

        /// <param name="writer"> The JSON writer. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        void IJsonModel<VMwareCbtUpdateMigrationItemInput>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(VMwareCbtUpdateMigrationItemInput)} does not support writing '{format}' format.");
            }
            ...
            if (Optional.IsCollectionDefined(VmDisks))
            {
                ...
                writer.WriteStartArray();
                foreach (VMwareCbtUpdateDiskInput item in VmDisks)
                {
                    writer.WriteObjectValue(item, options);
                }
                writer.WriteEndArray();
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        VMwareCbtUpdateMigrationItemInput IJsonModel<VMwareCbtUpdateMigrationItemInput>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (VMwareCbtUpdateMigrationItemInput)JsonModelCreateCore(ref reader, options);
        ...
        protected override UpdateMigrationItemProviderSpecificInput JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(VMwareCbtUpdateMigrationItemInput)} does not support reading '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static VMwareCbtUpdateMigrationItemInput DeserializeVMwareCbtUpdateMigrationItemInput(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            IList<VMwareCbtUpdateDiskInput> vmDisks = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("vmDisks"u8))
                {
                    ...
                    List<VMwareCbtUpdateDiskInput> array = new List<VMwareCbtUpdateDiskInput>();
                    foreach (var item in prop.Value.EnumerateArray())
                    {
                        array.Add(VMwareCbtUpdateDiskInput.DeserializeVMwareCbtUpdateDiskInput(item, options));
                    }
                    vmDisks = array;
                    continue;
                }
