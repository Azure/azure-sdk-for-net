...
{
    internal partial class UnknownRecoveryPlanProviderSpecificContent : IUtf8JsonSerializable, IJsonModel<RecoveryPlanProviderSpecificContent>
    {
        ...
        RecoveryPlanProviderSpecificContent IJsonModel<RecoveryPlanProviderSpecificContent>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            return DeserializeUnknownRecoveryPlanProviderSpecificContent(document.RootElement, options);
        }

        internal static UnknownRecoveryPlanProviderSpecificContent DeserializeUnknownRecoveryPlanProviderSpecificContent(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new UnknownRecoveryPlanProviderSpecificContent(instanceType, serializedAdditionalRawData);
        }
