...
{
    internal partial class SiteRecoverySupportedOSProperties : IUtf8JsonSerializable, IJsonModel<SiteRecoverySupportedOSProperties>, IPersistableModel<SiteRecoverySupportedOSProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(SupportedOSList))
            {
                builder.Append("  supportedOsList:");
                builder.AppendLine(" [");
                foreach (var item in SupportedOSList)
                {
