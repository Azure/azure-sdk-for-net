...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="InMageUnplannedFailoverContent"/>. </summary>
        public InMageUnplannedFailoverContent() : base("InMage")
        {
        }
        ...
        internal InMageUnplannedFailoverContent(string instanceType, IDictionary<string, BinaryData> additionalBinaryDataProperties, SiteRecoveryPointType? recoveryPointType, ResourceIdentifier recoveryPointId) : base(instanceType, additionalBinaryDataProperties)
        {
