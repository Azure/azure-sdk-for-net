...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class SiteRecoveryDiskDetails
    {
        ...
        internal SiteRecoveryDiskDetails(long? maxSizeMB, string vhdType, string vhdId, string vhdName, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            MaxSizeMB = maxSizeMB;
            VhdType = vhdType;
            VhdId = vhdId;
