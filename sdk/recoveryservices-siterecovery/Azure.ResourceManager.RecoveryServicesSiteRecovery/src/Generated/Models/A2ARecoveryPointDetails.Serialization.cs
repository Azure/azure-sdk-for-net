...
{
    public partial class A2ARecoveryPointDetails : IUtf8JsonSerializable, IJsonModel<A2ARecoveryPointDetails>, IPersistableModel<A2ARecoveryPointDetails>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(RecoveryPointSyncType))
            {
                ...
                builder.AppendLine($" '{RecoveryPointSyncType.ToString()}'");
            }
