...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class HyperVReplicaPolicyDetails : PolicyProviderSpecificDetails, IJsonModel<HyperVReplicaPolicyDetails>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<HyperVReplicaPolicyDetails>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<HyperVReplicaPolicyDetails>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        HyperVReplicaPolicyDetails IPersistableModel<HyperVReplicaPolicyDetails>.Create(BinaryData data, ModelReaderWriterOptions options) => (HyperVReplicaPolicyDetails)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        HyperVReplicaPolicyDetails IJsonModel<HyperVReplicaPolicyDetails>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (HyperVReplicaPolicyDetails)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static HyperVReplicaPolicyDetails DeserializeHyperVReplicaPolicyDetails(JsonElement element, ModelReaderWriterOptions options)
        {
