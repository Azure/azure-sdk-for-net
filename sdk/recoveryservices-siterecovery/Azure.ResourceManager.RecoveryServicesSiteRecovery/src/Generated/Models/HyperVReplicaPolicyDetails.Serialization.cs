...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HyperVReplicaPolicyDetails>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<HyperVReplicaPolicyDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<HyperVReplicaPolicyDetails>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<HyperVReplicaPolicyDetails>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
