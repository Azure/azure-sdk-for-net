...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    public partial class HyperVReplicaPolicyDetails : IUtf8JsonSerializable, IModelJsonSerializable<HyperVReplicaPolicyDetails>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<HyperVReplicaPolicyDetails>(this, options.Format);
        ...
        internal static HyperVReplicaPolicyDetails DeserializeHyperVReplicaPolicyDetails(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new HyperVReplicaPolicyDetails(instanceType, Optional.ToNullable(recoveryPoints), Optional.ToNullable(applicationConsistentSnapshotFrequencyInHours), compression.Value, initialReplicationMethod.Value, onlineReplicationStartTime.Value, offlineReplicationImportPath.Value, offlineReplicationExportPath.Value, Optional.ToNullable(replicationPort), Optional.ToNullable(allowedAuthenticationType), replicaDeletionOption.Value, serializedAdditionalRawData);
        }
        ...
        /// <summary> Converts a <see cref="HyperVReplicaPolicyDetails"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="HyperVReplicaPolicyDetails"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="HyperVReplicaPolicyDetails"/>. </summary>
