...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<InMageRcmDiskContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<InMageRcmDiskContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<InMageRcmDiskContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<InMageRcmDiskContent>)} interface");
            }
        ...
        string IPersistableModel<InMageRcmDiskContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
