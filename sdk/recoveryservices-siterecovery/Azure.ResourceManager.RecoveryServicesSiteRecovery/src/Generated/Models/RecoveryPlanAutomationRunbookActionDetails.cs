...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class RecoveryPlanAutomationRunbookActionDetails : RecoveryPlanActionDetails
    {
        ...
        internal RecoveryPlanAutomationRunbookActionDetails(string instanceType, ResourceIdentifier runbookId, string timeout, RecoveryPlanActionLocation fabricLocation, Dictionary<string, BinaryData> rawData) : base(instanceType, rawData)
        {
            RunbookId = runbookId;
            Timeout = timeout;
            FabricLocation = fabricLocation;
