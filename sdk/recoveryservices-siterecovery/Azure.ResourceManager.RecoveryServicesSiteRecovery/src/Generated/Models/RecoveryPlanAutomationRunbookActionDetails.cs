...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class RecoveryPlanAutomationRunbookActionDetails : RecoveryPlanActionDetails
    {
        ...
        /// <param name="fabricLocation"> The fabric location. </param>
        internal RecoveryPlanAutomationRunbookActionDetails(string instanceType, IDictionary<string, BinaryData> additionalBinaryDataProperties, ResourceIdentifier runbookId, string timeout, RecoveryPlanActionLocation fabricLocation) : base(instanceType, additionalBinaryDataProperties)
        {
            RunbookId = runbookId;
            Timeout = timeout;
            FabricLocation = fabricLocation;
