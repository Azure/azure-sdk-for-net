...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VMwareCbtPolicyCreationContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<VMwareCbtPolicyCreationContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<VMwareCbtPolicyCreationContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<VMwareCbtPolicyCreationContent>)} interface");
            }
        ...
        VMwareCbtPolicyCreationContent IJsonModel<VMwareCbtPolicyCreationContent>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        internal static VMwareCbtPolicyCreationContent DeserializeVMwareCbtPolicyCreationContent(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new VMwareCbtPolicyCreationContent(instanceType, serializedAdditionalRawData, Optional.ToNullable(recoveryPointHistoryInMinutes), Optional.ToNullable(crashConsistentFrequencyInMinutes), Optional.ToNullable(appConsistentFrequencyInMinutes));
        }

        BinaryData IPersistableModel<VMwareCbtPolicyCreationContent>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == "J" || options.Format == "W";
            if (!isValid)
            {
        ...
        VMwareCbtPolicyCreationContent IPersistableModel<VMwareCbtPolicyCreationContent>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == "J" || options.Format == "W";
            if (!isValid)
            {
        ...
        string IPersistableModel<VMwareCbtPolicyCreationContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
