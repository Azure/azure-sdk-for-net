...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<A2ACrossClusterMigrationPolicyCreationContent>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<A2ACrossClusterMigrationPolicyCreationContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<A2ACrossClusterMigrationPolicyCreationContent>)} interface");
            }
        ...
        string IPersistableModel<A2ACrossClusterMigrationPolicyCreationContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
