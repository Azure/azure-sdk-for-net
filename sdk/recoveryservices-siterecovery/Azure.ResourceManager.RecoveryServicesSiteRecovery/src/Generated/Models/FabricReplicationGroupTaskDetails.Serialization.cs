...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FabricReplicationGroupTaskDetails>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<FabricReplicationGroupTaskDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<FabricReplicationGroupTaskDetails>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<FabricReplicationGroupTaskDetails>)} interface");
            }
        ...
        string IPersistableModel<FabricReplicationGroupTaskDetails>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
