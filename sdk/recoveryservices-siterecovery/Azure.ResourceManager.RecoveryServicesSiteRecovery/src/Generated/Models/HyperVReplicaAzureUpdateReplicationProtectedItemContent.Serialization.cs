...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HyperVReplicaAzureUpdateReplicationProtectedItemContent>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<HyperVReplicaAzureUpdateReplicationProtectedItemContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<HyperVReplicaAzureUpdateReplicationProtectedItemContent>)} interface");
            }
        ...
        string IPersistableModel<HyperVReplicaAzureUpdateReplicationProtectedItemContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
