...
{
    public partial class SiteRecoveryEventProperties : IUtf8JsonSerializable, IJsonModel<SiteRecoveryEventProperties>, IPersistableModel<SiteRecoveryEventProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(OccurredOn))
            {
                ...
                builder.AppendLine($" '{OccurredOn.Value.ToString()}'");
            }
            ...
            if (Optional.IsDefined(EventSpecificDetails))
            {
                ...
                AppendChildObject(builder, EventSpecificDetails, options, 2);
            }
