...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class SiteRecoveryVmEndpoint
    {
        ...
        internal SiteRecoveryVmEndpoint(string endpointName, int? privatePort, int? publicPort, string protocol, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
