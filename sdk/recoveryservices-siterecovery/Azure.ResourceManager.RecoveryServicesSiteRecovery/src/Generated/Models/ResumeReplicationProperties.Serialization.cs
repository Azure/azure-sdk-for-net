...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ResumeReplicationProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ResumeReplicationProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ResumeReplicationProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<ResumeReplicationProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
