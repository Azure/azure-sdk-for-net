...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TestFailoverContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<TestFailoverContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<TestFailoverContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<TestFailoverContent>)} interface");
            }
        ...
        string IPersistableModel<TestFailoverContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
