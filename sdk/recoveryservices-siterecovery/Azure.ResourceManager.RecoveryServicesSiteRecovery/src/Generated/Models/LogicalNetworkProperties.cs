...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class LogicalNetworkProperties
    {
        ...
        internal LogicalNetworkProperties(string friendlyName, string networkVirtualizationStatus, string logicalNetworkUsage, string logicalNetworkDefinitionsStatus, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
