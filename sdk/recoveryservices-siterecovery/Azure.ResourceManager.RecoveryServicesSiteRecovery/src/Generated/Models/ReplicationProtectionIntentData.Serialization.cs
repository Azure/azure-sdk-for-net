...
{
    public partial class ReplicationProtectionIntentData
    {
        internal static ReplicationProtectionIntentData DeserializeReplicationProtectionIntentData(JsonElement element)
        {
            ...
            return new ReplicationProtectionIntentData(id, name, type, systemData.Value, properties.Value, Optional.ToNullable(location));
        }
    }
}
