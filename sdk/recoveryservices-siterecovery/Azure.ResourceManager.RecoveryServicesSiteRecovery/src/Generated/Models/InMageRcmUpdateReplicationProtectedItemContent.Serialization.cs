...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    public partial class InMageRcmUpdateReplicationProtectedItemContent : IUtf8JsonSerializable, IModelJsonSerializable<InMageRcmUpdateReplicationProtectedItemContent>
    {
        ...
        internal static InMageRcmUpdateReplicationProtectedItemContent DeserializeInMageRcmUpdateReplicationProtectedItemContent(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new InMageRcmUpdateReplicationProtectedItemContent(instanceType, targetVmName.Value, targetVmSize.Value, targetResourceGroupId.Value, targetAvailabilitySetId.Value, targetAvailabilityZone.Value, targetProximityPlacementGroupId.Value, targetBootDiagnosticsStorageAccountId.Value, targetNetworkId.Value, testNetworkId.Value, Optional.ToList(vmNics), Optional.ToNullable(licenseType), serializedAdditionalRawData);
        }
