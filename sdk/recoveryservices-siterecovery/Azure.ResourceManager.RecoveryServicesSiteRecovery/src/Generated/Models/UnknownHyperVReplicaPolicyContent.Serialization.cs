...
{
    internal partial class UnknownHyperVReplicaPolicyContent : HyperVReplicaPolicyContent, IJsonModel<HyperVReplicaPolicyContent>
    {
        /// <summary> Initializes a new instance of <see cref="UnknownHyperVReplicaPolicyContent"/> for deserialization. </summary>
        internal UnknownHyperVReplicaPolicyContent()
        {
        }
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<HyperVReplicaPolicyContent>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<HyperVReplicaPolicyContent>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownHyperVReplicaPolicyContent DeserializeUnknownHyperVReplicaPolicyContent(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownHyperVReplicaPolicyContent(
                instanceType,
