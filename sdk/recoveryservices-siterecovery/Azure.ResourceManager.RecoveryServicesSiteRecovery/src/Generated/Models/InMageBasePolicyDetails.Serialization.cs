...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<InMageBasePolicyDetails>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<InMageBasePolicyDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<InMageBasePolicyDetails>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<InMageBasePolicyDetails>)} interface");
            }
        ...
        string IPersistableModel<InMageBasePolicyDetails>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
