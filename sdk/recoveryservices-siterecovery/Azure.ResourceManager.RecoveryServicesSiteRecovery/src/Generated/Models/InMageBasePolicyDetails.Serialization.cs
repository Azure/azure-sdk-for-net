...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class InMageBasePolicyDetails : PolicyProviderSpecificDetails, IJsonModel<InMageBasePolicyDetails>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<InMageBasePolicyDetails>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<InMageBasePolicyDetails>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        InMageBasePolicyDetails IPersistableModel<InMageBasePolicyDetails>.Create(BinaryData data, ModelReaderWriterOptions options) => (InMageBasePolicyDetails)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        InMageBasePolicyDetails IJsonModel<InMageBasePolicyDetails>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (InMageBasePolicyDetails)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static InMageBasePolicyDetails DeserializeInMageBasePolicyDetails(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string instanceType = "InMageBasePolicyDetails";
