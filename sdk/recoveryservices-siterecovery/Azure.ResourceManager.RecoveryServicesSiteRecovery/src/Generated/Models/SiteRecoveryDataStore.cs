...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class SiteRecoveryDataStore
    {
        ...
        internal SiteRecoveryDataStore(string symbolicName, Guid? uuid, string capacity, string freeSpace, string dataStoreType, Dictionary<string, BinaryData> rawData)
        {
