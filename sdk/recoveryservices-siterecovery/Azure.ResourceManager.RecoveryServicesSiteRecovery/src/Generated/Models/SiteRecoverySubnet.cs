...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class SiteRecoverySubnet
    {
        ...
        internal SiteRecoverySubnet(string name, string friendlyName, IReadOnlyList<string> addressList, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Name = name;
