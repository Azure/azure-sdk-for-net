...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class UpdateApplianceForReplicationProtectedItemProperties
    {
        ...
        internal UpdateApplianceForReplicationProtectedItemProperties(string targetApplianceId, UpdateApplianceForReplicationProtectedItemProviderSpecificContent providerSpecificDetails, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            TargetApplianceId = targetApplianceId;
            ProviderSpecificDetails = providerSpecificDetails;
