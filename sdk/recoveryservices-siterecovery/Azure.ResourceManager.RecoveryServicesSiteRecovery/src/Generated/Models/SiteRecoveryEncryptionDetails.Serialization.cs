...
{
    public partial class SiteRecoveryEncryptionDetails : IUtf8JsonSerializable, IJsonModel<SiteRecoveryEncryptionDetails>, IPersistableModel<SiteRecoveryEncryptionDetails>
    {
        ...
        void IJsonModel<SiteRecoveryEncryptionDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SiteRecoveryEncryptionDetails)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(KekState))
            {
                builder.Append("  kekState:");
                builder.AppendLine($" '{KekState}'");
            }

            if (Optional.IsDefined(KekCertThumbprint))
            {
                builder.Append("  kekCertThumbprint:");
                builder.AppendLine($" '{KekCertThumbprint}'");
            }

            if (Optional.IsDefined(KekCertExpireOn))
            {
                builder.Append("  kekCertExpiryDate:");
                builder.AppendLine($" '{KekCertExpireOn.Value.ToString()}'");
            }
