...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class VMwareCbtTestMigrateContent : TestMigrateProviderSpecificContent
    {
        ...
        internal VMwareCbtTestMigrateContent(string instanceType, ResourceIdentifier recoveryPointId, ResourceIdentifier networkId, IList<VMwareCbtNicContent> vmNics, string osUpgradeVersion, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(instanceType, serializedAdditionalRawData)
        {
            RecoveryPointId = recoveryPointId;
            NetworkId = networkId;
            VmNics = vmNics;
