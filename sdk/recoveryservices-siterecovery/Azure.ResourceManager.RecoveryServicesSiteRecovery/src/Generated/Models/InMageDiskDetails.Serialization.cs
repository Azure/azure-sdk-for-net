...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<InMageDiskDetails>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<InMageDiskDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<InMageDiskDetails>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<InMageDiskDetails>)} interface");
            }
        ...
        string IPersistableModel<InMageDiskDetails>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
