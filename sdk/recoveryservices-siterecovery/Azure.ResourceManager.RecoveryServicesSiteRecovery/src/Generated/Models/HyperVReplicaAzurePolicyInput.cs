...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="HyperVReplicaAzurePolicyInput"/>. </summary>
        public HyperVReplicaAzurePolicyInput() : base("HyperVReplicaAzure")
        {
        ...
        internal HyperVReplicaAzurePolicyInput(string instanceType, IDictionary<string, BinaryData> additionalBinaryDataProperties, int? recoveryPointHistoryDuration, int? applicationConsistentSnapshotFrequencyInHours, int? replicationInterval, string onlineReplicationStartTime, IList<string> storageAccounts) : base(instanceType, additionalBinaryDataProperties)
        {
