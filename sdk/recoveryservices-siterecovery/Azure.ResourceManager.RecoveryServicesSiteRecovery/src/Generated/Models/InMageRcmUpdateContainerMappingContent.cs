...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class InMageRcmUpdateContainerMappingContent : ReplicationProviderSpecificUpdateContainerMappingContent
    {
        ...
        internal InMageRcmUpdateContainerMappingContent(string instanceType, string enableAgentAutoUpgrade, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(instanceType, serializedAdditionalRawData)
        {
            EnableAgentAutoUpgrade = enableAgentAutoUpgrade;
