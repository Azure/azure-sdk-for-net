...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SiteRecoverySupportedOSDetails>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SiteRecoverySupportedOSDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SiteRecoverySupportedOSDetails>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SiteRecoverySupportedOSDetails>)} interface");
            }
        ...
        string IPersistableModel<SiteRecoverySupportedOSDetails>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
