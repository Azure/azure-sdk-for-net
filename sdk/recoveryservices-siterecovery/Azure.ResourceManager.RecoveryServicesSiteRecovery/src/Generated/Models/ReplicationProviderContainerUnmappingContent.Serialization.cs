...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    internal partial class ReplicationProviderContainerUnmappingContent : IUtf8JsonSerializable, IJsonModel<ReplicationProviderContainerUnmappingContent>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<ReplicationProviderContainerUnmappingContent>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ReplicationProviderContainerUnmappingContent>)} interface");
            }
