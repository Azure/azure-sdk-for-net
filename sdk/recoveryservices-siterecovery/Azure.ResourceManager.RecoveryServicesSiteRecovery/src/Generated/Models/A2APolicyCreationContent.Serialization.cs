...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<A2APolicyCreationContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<A2APolicyCreationContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<A2APolicyCreationContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<A2APolicyCreationContent>)} interface");
            }
        ...
        string IPersistableModel<A2APolicyCreationContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
