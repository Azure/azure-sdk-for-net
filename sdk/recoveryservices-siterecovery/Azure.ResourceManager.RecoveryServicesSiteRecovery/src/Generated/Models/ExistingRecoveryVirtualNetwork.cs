...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class ExistingRecoveryVirtualNetwork : RecoveryVirtualNetworkCustomDetails
    {
        ...
        internal ExistingRecoveryVirtualNetwork(string resourceType, ResourceIdentifier recoveryVirtualNetworkId, string recoverySubnetName, Dictionary<string, BinaryData> rawData) : base(resourceType, rawData)
        {
            RecoveryVirtualNetworkId = recoveryVirtualNetworkId;
