...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class ExistingRecoveryVirtualNetwork : RecoveryVirtualNetworkCustomDetails
    {
        ...
        public ExistingRecoveryVirtualNetwork(ResourceIdentifier recoveryVirtualNetworkId) : base("Existing")
        {
        ...
        internal ExistingRecoveryVirtualNetwork(string resourceType, IDictionary<string, BinaryData> additionalBinaryDataProperties, ResourceIdentifier recoveryVirtualNetworkId, string recoverySubnetName) : base(resourceType, additionalBinaryDataProperties)
        {
            RecoveryVirtualNetworkId = recoveryVirtualNetworkId;
