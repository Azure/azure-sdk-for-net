...
{
    internal partial class UnknownHyperVVmDetails : HyperVVmDetails
    {
        /// <summary> Initializes a new instance of <see cref="UnknownHyperVVmDetails"/>. </summary>
        ...
        internal UnknownHyperVVmDetails(string instanceType, IDictionary<string, BinaryData> additionalBinaryDataProperties, string sourceItemId, string generation, SiteRecoveryOSDetails osDetails, IReadOnlyList<SiteRecoveryDiskDetails> diskDetails, HyperVVmDiskPresenceStatus? hasPhysicalDisk, HyperVVmDiskPresenceStatus? hasFibreChannelAdapter, HyperVVmDiskPresenceStatus? hasSharedVhd, string hyperVHostId) : base(instanceType ?? "unknown", additionalBinaryDataProperties, sourceItemId, generation, osDetails, diskDetails, hasPhysicalDisk, hasFibreChannelAdapter, hasSharedVhd, hyperVHostId)
        {
        }
    }
}
