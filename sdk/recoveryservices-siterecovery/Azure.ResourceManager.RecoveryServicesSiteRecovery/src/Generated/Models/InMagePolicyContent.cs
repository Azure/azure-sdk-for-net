...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class InMagePolicyContent : PolicyProviderSpecificContent
    {
        ...
        internal InMagePolicyContent(string instanceType, int? recoveryPointThresholdInMinutes, int? recoveryPointHistory, int? appConsistentFrequencyInMinutes, SetMultiVmSyncStatus multiVmSyncStatus, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(instanceType, serializedAdditionalRawData)
        {
