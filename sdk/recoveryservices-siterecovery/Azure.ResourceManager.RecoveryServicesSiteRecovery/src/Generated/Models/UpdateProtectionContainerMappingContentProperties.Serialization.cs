...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<UpdateProtectionContainerMappingContentProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<UpdateProtectionContainerMappingContentProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<UpdateProtectionContainerMappingContentProperties>)} interface");
            }
        ...
        string IPersistableModel<UpdateProtectionContainerMappingContentProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
