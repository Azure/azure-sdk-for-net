...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    public partial class ReplicationResumeJobContent : IUtf8JsonSerializable, IJsonModel<ReplicationResumeJobContent>
    {
        ...
        void IJsonModel<ReplicationResumeJobContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(ReplicationResumeJobContent)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ReplicationResumeJobContent>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(ReplicationResumeJobContent)} does not support '{options.Format}' format.");
            }
        }
