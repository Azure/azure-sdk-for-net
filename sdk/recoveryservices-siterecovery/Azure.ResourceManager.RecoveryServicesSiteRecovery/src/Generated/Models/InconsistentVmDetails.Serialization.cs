...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<InconsistentVmDetails>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<InconsistentVmDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<InconsistentVmDetails>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<InconsistentVmDetails>)} interface");
            }
        ...
        string IPersistableModel<InconsistentVmDetails>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
