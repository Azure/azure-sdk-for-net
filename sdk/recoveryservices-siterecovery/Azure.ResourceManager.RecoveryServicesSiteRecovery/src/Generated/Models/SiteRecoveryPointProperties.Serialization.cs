...
{
    public partial class SiteRecoveryPointProperties : IUtf8JsonSerializable, IJsonModel<SiteRecoveryPointProperties>, IPersistableModel<SiteRecoveryPointProperties>
    {
        ...
        void IJsonModel<SiteRecoveryPointProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SiteRecoveryPointProperties)} does not support '{format}' format.");
            }
