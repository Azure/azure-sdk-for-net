...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class ConsistencyCheckTaskDetails : SiteRecoveryTaskTypeDetails
    {
        ...
        internal ConsistencyCheckTaskDetails(string instanceType, IReadOnlyList<InconsistentVmDetails> vmDetails, Dictionary<string, BinaryData> rawData) : base(instanceType, rawData)
        {
            VmDetails = vmDetails;
