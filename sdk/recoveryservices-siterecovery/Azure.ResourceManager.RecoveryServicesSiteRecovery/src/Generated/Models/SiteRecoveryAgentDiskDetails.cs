...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class SiteRecoveryAgentDiskDetails
    {
        ...
        internal SiteRecoveryAgentDiskDetails(string diskId, string diskName, string isOSDisk, long? capacityInBytes, int? lunId, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            DiskId = diskId;
            DiskName = diskName;
            IsOSDisk = isOSDisk;
