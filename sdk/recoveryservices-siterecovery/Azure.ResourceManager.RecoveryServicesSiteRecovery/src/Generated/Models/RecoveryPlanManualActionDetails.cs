...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class RecoveryPlanManualActionDetails : RecoveryPlanActionDetails
    {
        ...
        internal RecoveryPlanManualActionDetails(string instanceType, string description, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(instanceType, serializedAdditionalRawData)
        {
