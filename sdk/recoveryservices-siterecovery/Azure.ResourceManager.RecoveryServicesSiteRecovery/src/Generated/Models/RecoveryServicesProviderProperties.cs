...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class RecoveryServicesProviderProperties
    {
        ...
        /// <summary> Initializes a new instance of <see cref="RecoveryServicesProviderProperties"/>. </summary>
        ...
        internal RecoveryServicesProviderProperties(string fabricType, string friendlyName, string providerVersion, string serverVersion, string providerVersionState, DateTimeOffset? providerVersionExpiryOn, string fabricFriendlyName, DateTimeOffset? lastHeartBeat, string connectionStatus, int? protectedItemCount, IList<string> allowedScenarios, IList<HealthError> healthErrorDetails, string draIdentifier, string machineId, string machineName, string biosId, IdentityProviderDetails authenticationIdentityDetails, IdentityProviderDetails resourceAccessIdentityDetails, IdentityProviderDetails dataPlaneAuthenticationIdentityDetails, VersionDetails providerVersionDetails, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
        ...
        public IList<string> AllowedScenarios { get; }
