...
{
    public partial class InMageRcmFailbackDiscoveredProtectedVmDetails : IUtf8JsonSerializable, IJsonModel<InMageRcmFailbackDiscoveredProtectedVmDetails>, IPersistableModel<InMageRcmFailbackDiscoveredProtectedVmDetails>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(LastDiscoveredOn))
            {
                ...
                builder.AppendLine($" '{LastDiscoveredOn.Value.ToString()}'");
            }
