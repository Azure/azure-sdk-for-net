...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TestMigrateContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<TestMigrateContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<TestMigrateContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<TestMigrateContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
