...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class InMageReprotectContent : ReverseReplicationProviderSpecificContent
    {
        ...
        internal InMageReprotectContent(string instanceType, string masterTargetId, Guid processServerId, string retentionDrive, string runAsAccountId, string datastoreName, InMageDiskExclusionContent diskExclusionContent, string profileId, IList<string> disksToInclude, Dictionary<string, BinaryData> rawData) : base(instanceType, rawData)
        {
            MasterTargetId = masterTargetId;
            ProcessServerId = processServerId;
            RetentionDrive = retentionDrive;
