...
{
    public partial class VmmFabricDetails : IUtf8JsonSerializable, IJsonModel<VmmFabricDetails>, IPersistableModel<VmmFabricDetails>
    {
        ...
        void IJsonModel<VmmFabricDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(VmmFabricDetails)} does not support '{format}' format.");
            }
