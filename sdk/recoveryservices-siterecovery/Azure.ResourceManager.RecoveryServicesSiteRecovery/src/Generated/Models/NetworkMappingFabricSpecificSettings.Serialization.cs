...
{
    public partial class NetworkMappingFabricSpecificSettings : IUtf8JsonSerializable, IModelJsonSerializable<NetworkMappingFabricSpecificSettings>
    {
        ...
        internal static NetworkMappingFabricSpecificSettings DeserializeNetworkMappingFabricSpecificSettings(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new UnknownNetworkMappingFabricSpecificSettings(instanceType, rawData);
        }
        ...
        /// <summary> Converts a <see cref="NetworkMappingFabricSpecificSettings"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="NetworkMappingFabricSpecificSettings"/> to convert. </param>
        public static implicit operator RequestContent(NetworkMappingFabricSpecificSettings model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="NetworkMappingFabricSpecificSettings"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator NetworkMappingFabricSpecificSettings(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeNetworkMappingFabricSpecificSettings(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
