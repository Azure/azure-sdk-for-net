    ...
    public partial class InMageRcmApplianceDetails : IUtf8JsonSerializable, IJsonModel<InMageRcmApplianceDetails>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ProcessServer))
            {
                ...
                AppendChildObject(builder, ProcessServer, options, 2, false);
            }

            if (Optional.IsDefined(RcmProxy))
            {
                builder.Append("  rcmProxy:");
                AppendChildObject(builder, RcmProxy, options, 2, false);
            }

            if (Optional.IsDefined(PushInstaller))
            {
                builder.Append("  pushInstaller:");
                AppendChildObject(builder, PushInstaller, options, 2, false);
            }

            if (Optional.IsDefined(ReplicationAgent))
            {
                builder.Append("  replicationAgent:");
                AppendChildObject(builder, ReplicationAgent, options, 2, false);
            }

            if (Optional.IsDefined(ReprotectAgent))
            {
                builder.Append("  reprotectAgent:");
                AppendChildObject(builder, ReprotectAgent, options, 2, false);
            }

            if (Optional.IsDefined(MarsAgent))
            {
                builder.Append("  marsAgent:");
                AppendChildObject(builder, MarsAgent, options, 2, false);
            }

            if (Optional.IsDefined(Dra))
            {
                builder.Append("  dra:");
                AppendChildObject(builder, Dra, options, 2, false);
            }
