        ...
        internal static InMageRcmApplianceDetails DeserializeInMageRcmApplianceDetails(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("fabricArmId"u8))
                {
                    ...
                    fabricArmId = new ResourceIdentifier(prop.Value.GetString());
                    continue;
                }
                if (prop.NameEquals("processServer"u8))
                {
                    ...
                    processServer = SiteRecoveryProcessServerDetails.DeserializeSiteRecoveryProcessServerDetails(prop.Value, options);
                    continue;
                }
                ...
                if (prop.NameEquals("dra"u8))
                {
                    ...
                    dra = SiteRecoveryDraDetails.DeserializeSiteRecoveryDraDetails(prop.Value, options);
                    continue;
                }
