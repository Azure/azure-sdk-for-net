...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RemoveDisksContentProperties>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(RemoveDisksContentProperties)} does not support writing '{format}' format.");
            }

            if (Optional.IsDefined(ProviderSpecificDetails))
            {
                writer.WritePropertyName("providerSpecificDetails"u8);
                ((IJsonModel<RemoveDisksProviderSpecificContent>)ProviderSpecificDetails).Write(writer, options);
            }
        ...
        RemoveDisksContentProperties IJsonModel<RemoveDisksContentProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(RemoveDisksContentProperties)} does not support reading '{format}' format.");
            }
        ...
        internal static RemoveDisksContentProperties DeserializeRemoveDisksContentProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("providerSpecificDetails"u8))
                {
                    ...
                    providerSpecificDetails = ModelSerializationExtensions.JsonDeserialize<RemoveDisksProviderSpecificContent>(property.Value);
                    continue;
                }
                if (options.Format != "W")
                {
        ...
        BinaryData IPersistableModel<RemoveDisksContentProperties>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(RemoveDisksContentProperties)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        RemoveDisksContentProperties IPersistableModel<RemoveDisksContentProperties>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(RemoveDisksContentProperties)} does not support reading '{options.Format}' format.");
            }
        }
