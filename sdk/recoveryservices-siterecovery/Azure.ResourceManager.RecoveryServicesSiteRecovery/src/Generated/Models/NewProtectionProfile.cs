...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class NewProtectionProfile : ProtectionProfileCustomDetails
    {
        ...
        internal NewProtectionProfile(string resourceType, string policyName, int? recoveryPointHistory, int? crashConsistentFrequencyInMinutes, int? appConsistentFrequencyInMinutes, SetMultiVmSyncStatus multiVmSyncStatus, Dictionary<string, BinaryData> rawData) : base(resourceType, rawData)
        {
            PolicyName = policyName;
