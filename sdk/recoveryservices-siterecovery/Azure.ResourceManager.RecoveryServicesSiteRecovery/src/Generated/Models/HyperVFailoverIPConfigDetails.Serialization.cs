...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HyperVFailoverIPConfigDetails>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<HyperVFailoverIPConfigDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<HyperVFailoverIPConfigDetails>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<HyperVFailoverIPConfigDetails>)} interface");
            }
        ...
        string IPersistableModel<HyperVFailoverIPConfigDetails>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
