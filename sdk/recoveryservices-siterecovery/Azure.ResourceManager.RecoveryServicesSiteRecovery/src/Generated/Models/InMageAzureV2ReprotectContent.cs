...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class InMageAzureV2ReprotectContent : ReverseReplicationProviderSpecificContent
    {
        ...
        public InMageAzureV2ReprotectContent() : base("InMageAzureV2")
        {
        ...
        internal InMageAzureV2ReprotectContent(string instanceType, IDictionary<string, BinaryData> additionalBinaryDataProperties, string masterTargetId, Guid? processServerId, ResourceIdentifier storageAccountId, string runAsAccountId, ResourceIdentifier policyId, ResourceIdentifier logStorageAccountId, IList<string> disksToInclude) : base(instanceType, additionalBinaryDataProperties)
        {
