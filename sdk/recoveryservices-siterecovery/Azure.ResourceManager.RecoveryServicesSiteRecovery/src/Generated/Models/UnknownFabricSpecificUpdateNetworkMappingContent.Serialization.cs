...
{
    internal partial class UnknownFabricSpecificUpdateNetworkMappingContent : IUtf8JsonSerializable, IJsonModel<FabricSpecificUpdateNetworkMappingContent>
    {
        ...
        void IJsonModel<FabricSpecificUpdateNetworkMappingContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(FabricSpecificUpdateNetworkMappingContent)} does not support '{format}' format.");
            }
        ...
        FabricSpecificUpdateNetworkMappingContent IJsonModel<FabricSpecificUpdateNetworkMappingContent>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            return DeserializeUnknownFabricSpecificUpdateNetworkMappingContent(document.RootElement, options);
        }

        internal static UnknownFabricSpecificUpdateNetworkMappingContent DeserializeUnknownFabricSpecificUpdateNetworkMappingContent(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new UnknownFabricSpecificUpdateNetworkMappingContent(instanceType, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<FabricSpecificUpdateNetworkMappingContent>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(FabricSpecificUpdateNetworkMappingContent)} does not support '{options.Format}' format.");
            }
        }
