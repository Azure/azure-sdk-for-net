...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    internal partial class SiteRecoveryPolicyListResult
    {
        ...
        internal SiteRecoveryPolicyListResult(IEnumerable<SiteRecoveryPolicyData> value)
        {
            Value = value.ToList();
        }
        ...
        internal SiteRecoveryPolicyListResult(IList<SiteRecoveryPolicyData> value, Uri nextLink, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            NextLink = nextLink;
        ...
        public IList<SiteRecoveryPolicyData> Value { get; }
