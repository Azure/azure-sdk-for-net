...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    internal partial class UnknownTestMigrateProviderSpecificContent : IUtf8JsonSerializable, IJsonModel<TestMigrateProviderSpecificContent>
    {
        ...
        void IJsonModel<TestMigrateProviderSpecificContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(TestMigrateProviderSpecificContent)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<TestMigrateProviderSpecificContent>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(TestMigrateProviderSpecificContent)} does not support '{options.Format}' format.");
            }
        }
