...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FailoverReplicationProtectedItemDetails>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<FailoverReplicationProtectedItemDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<FailoverReplicationProtectedItemDetails>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<FailoverReplicationProtectedItemDetails>)} interface");
            }
        ...
        string IPersistableModel<FailoverReplicationProtectedItemDetails>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
