...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RecoveryPlanShutdownGroupTaskDetails>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RecoveryPlanShutdownGroupTaskDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RecoveryPlanShutdownGroupTaskDetails>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RecoveryPlanShutdownGroupTaskDetails>)} interface");
            }
        ...
        string IPersistableModel<RecoveryPlanShutdownGroupTaskDetails>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
