...
{
    public partial class RecoveryPlanShutdownGroupTaskDetails : IUtf8JsonSerializable, IJsonModel<RecoveryPlanShutdownGroupTaskDetails>, IPersistableModel<RecoveryPlanShutdownGroupTaskDetails>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(RpGroupType))
            {
                builder.Append("  rpGroupType:");
                builder.AppendLine($" '{RpGroupType}'");
            }
