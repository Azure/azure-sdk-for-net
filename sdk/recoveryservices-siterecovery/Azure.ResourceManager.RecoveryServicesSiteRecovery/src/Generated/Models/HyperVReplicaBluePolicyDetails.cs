...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class HyperVReplicaBluePolicyDetails : PolicyProviderSpecificDetails
    {
        ...
        internal HyperVReplicaBluePolicyDetails() : base("HyperVReplica2012R2")
        {
        }
        ...
        internal HyperVReplicaBluePolicyDetails(string instanceType, IDictionary<string, BinaryData> additionalBinaryDataProperties, int? replicationFrequencyInSeconds, int? recoveryPoints, int? applicationConsistentSnapshotFrequencyInHours, string compression, string initialReplicationMethod, string onlineReplicationStartTime, string offlineReplicationImportPath, string offlineReplicationExportPath, int? replicationPort, int? allowedAuthenticationType, string replicaDeletionOption) : base(instanceType, additionalBinaryDataProperties)
        {
