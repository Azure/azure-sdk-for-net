...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<InMageRcmReprotectContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<InMageRcmReprotectContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<InMageRcmReprotectContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<InMageRcmReprotectContent>)} interface");
            }
        ...
        string IPersistableModel<InMageRcmReprotectContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
