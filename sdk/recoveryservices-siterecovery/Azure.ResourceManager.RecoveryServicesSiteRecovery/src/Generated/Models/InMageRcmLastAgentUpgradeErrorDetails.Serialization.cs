...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    public partial class InMageRcmLastAgentUpgradeErrorDetails
    {
        internal static InMageRcmLastAgentUpgradeErrorDetails DeserializeInMageRcmLastAgentUpgradeErrorDetails(JsonElement element)
        {
            ...
            return new InMageRcmLastAgentUpgradeErrorDetails(errorCode.Value, errorMessage.Value, possibleCauses.Value, recommendedAction.Value, Core.Optional.ToDictionary(errorMessageParameters), Core.Optional.ToDictionary(errorTags));
        }
    }
}
