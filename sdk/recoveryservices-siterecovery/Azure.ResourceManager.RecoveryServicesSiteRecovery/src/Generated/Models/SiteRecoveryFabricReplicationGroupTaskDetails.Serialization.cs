...
{
    public partial class SiteRecoveryFabricReplicationGroupTaskDetails
    {
        internal static SiteRecoveryFabricReplicationGroupTaskDetails DeserializeSiteRecoveryFabricReplicationGroupTaskDetails(JsonElement element)
        {
            ...
            return new SiteRecoveryFabricReplicationGroupTaskDetails(instanceType, jobTask.Value, skippedReason.Value, skippedReasonString.Value);
        }
    }
}
