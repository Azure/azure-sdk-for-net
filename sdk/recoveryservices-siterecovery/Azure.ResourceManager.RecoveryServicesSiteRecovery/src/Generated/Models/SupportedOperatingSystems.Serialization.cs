        ...
        internal static SupportedOperatingSystems DeserializeSupportedOperatingSystems(JsonElement element)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("properties"u8))
                {
                    ...
                    properties = SupportedOSProperties.DeserializeSupportedOSProperties(property.Value);
                    continue;
                }
            ...
            return new SupportedOperatingSystems(id, name, type, systemData.Value, properties.Value, Optional.ToNullable(location));
        }
    }
}
