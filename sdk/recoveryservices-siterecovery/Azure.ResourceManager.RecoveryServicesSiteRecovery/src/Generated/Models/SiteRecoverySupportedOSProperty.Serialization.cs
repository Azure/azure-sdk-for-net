...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SiteRecoverySupportedOSProperty>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SiteRecoverySupportedOSProperty>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SiteRecoverySupportedOSProperty>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<SiteRecoverySupportedOSProperty>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
