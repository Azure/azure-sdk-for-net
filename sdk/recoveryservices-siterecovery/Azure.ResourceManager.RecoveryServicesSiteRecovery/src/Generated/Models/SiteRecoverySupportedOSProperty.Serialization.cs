...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    public partial class SiteRecoverySupportedOSProperty : IUtf8JsonSerializable, IJsonModel<SiteRecoverySupportedOSProperty>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<SiteRecoverySupportedOSProperty>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SiteRecoverySupportedOSProperty>)} interface");
            }
