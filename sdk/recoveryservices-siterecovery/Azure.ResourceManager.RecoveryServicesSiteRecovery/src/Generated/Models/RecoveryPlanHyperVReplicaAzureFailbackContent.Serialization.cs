...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class RecoveryPlanHyperVReplicaAzureFailbackContent : RecoveryPlanProviderSpecificFailoverContent, IJsonModel<RecoveryPlanHyperVReplicaAzureFailbackContent>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<RecoveryPlanHyperVReplicaAzureFailbackContent>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<RecoveryPlanHyperVReplicaAzureFailbackContent>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        RecoveryPlanHyperVReplicaAzureFailbackContent IPersistableModel<RecoveryPlanHyperVReplicaAzureFailbackContent>.Create(BinaryData data, ModelReaderWriterOptions options) => (RecoveryPlanHyperVReplicaAzureFailbackContent)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        RecoveryPlanHyperVReplicaAzureFailbackContent IJsonModel<RecoveryPlanHyperVReplicaAzureFailbackContent>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (RecoveryPlanHyperVReplicaAzureFailbackContent)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static RecoveryPlanHyperVReplicaAzureFailbackContent DeserializeRecoveryPlanHyperVReplicaAzureFailbackContent(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    dataSyncOption = new SiteRecoveryDataSyncStatus(prop.Value.GetString());
                    continue;
                }
            ...
            return new RecoveryPlanHyperVReplicaAzureFailbackContent(instanceType, additionalBinaryDataProperties, dataSyncOption, recoveryVmCreationOption);
        }
    }
}
