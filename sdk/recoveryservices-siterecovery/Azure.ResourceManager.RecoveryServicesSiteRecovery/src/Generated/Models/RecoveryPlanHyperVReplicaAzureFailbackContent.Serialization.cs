...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RecoveryPlanHyperVReplicaAzureFailbackContent>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        RecoveryPlanHyperVReplicaAzureFailbackContent IJsonModel<RecoveryPlanHyperVReplicaAzureFailbackContent>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
                throw new FormatException($"The model {nameof(RecoveryPlanHyperVReplicaAzureFailbackContent)} does not support '{options.Format}' format.");
            }
        ...
        BinaryData IModel<RecoveryPlanHyperVReplicaAzureFailbackContent>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        RecoveryPlanHyperVReplicaAzureFailbackContent IModel<RecoveryPlanHyperVReplicaAzureFailbackContent>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<RecoveryPlanHyperVReplicaAzureFailbackContent>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
