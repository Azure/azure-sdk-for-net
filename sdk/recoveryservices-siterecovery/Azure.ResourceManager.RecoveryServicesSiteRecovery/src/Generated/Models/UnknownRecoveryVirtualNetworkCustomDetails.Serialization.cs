...
{
    internal partial class UnknownRecoveryVirtualNetworkCustomDetails : RecoveryVirtualNetworkCustomDetails, IJsonModel<RecoveryVirtualNetworkCustomDetails>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<RecoveryVirtualNetworkCustomDetails>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<RecoveryVirtualNetworkCustomDetails>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        RecoveryVirtualNetworkCustomDetails IPersistableModel<RecoveryVirtualNetworkCustomDetails>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        RecoveryVirtualNetworkCustomDetails IJsonModel<RecoveryVirtualNetworkCustomDetails>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownRecoveryVirtualNetworkCustomDetails DeserializeUnknownRecoveryVirtualNetworkCustomDetails(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownRecoveryVirtualNetworkCustomDetails(resourceType, additionalBinaryDataProperties);
        }
    }
}
