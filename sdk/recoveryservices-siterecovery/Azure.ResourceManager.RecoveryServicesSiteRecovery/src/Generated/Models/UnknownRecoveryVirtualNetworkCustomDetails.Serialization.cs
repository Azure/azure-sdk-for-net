...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    internal partial class UnknownRecoveryVirtualNetworkCustomDetails : IUtf8JsonSerializable, IJsonModel<RecoveryVirtualNetworkCustomDetails>
    {
        ...
        void IJsonModel<RecoveryVirtualNetworkCustomDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(RecoveryVirtualNetworkCustomDetails)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<RecoveryVirtualNetworkCustomDetails>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(RecoveryVirtualNetworkCustomDetails)} does not support '{options.Format}' format.");
            }
        }
