...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class InMageRcmPolicyDetails : PolicyProviderSpecificDetails
    {
        ...
        internal InMageRcmPolicyDetails(string instanceType, int? recoveryPointHistoryInMinutes, int? appConsistentFrequencyInMinutes, int? crashConsistentFrequencyInMinutes, string enableMultiVmSync, Dictionary<string, BinaryData> rawData) : base(instanceType, rawData)
        {
