...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class InMageRcmPolicyDetails : PolicyProviderSpecificDetails
    {
        ...
        internal InMageRcmPolicyDetails() : base("InMageRcm")
        {
        }
        ...
        internal InMageRcmPolicyDetails(string instanceType, IDictionary<string, BinaryData> additionalBinaryDataProperties, int? recoveryPointHistoryInMinutes, int? appConsistentFrequencyInMinutes, int? crashConsistentFrequencyInMinutes, string enableMultiVmSync) : base(instanceType, additionalBinaryDataProperties)
        {
