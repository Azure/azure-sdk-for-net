...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class HyperVReplicaAzureFailbackProviderContent : PlannedFailoverProviderSpecificFailoverContent
    {
        ...
        internal HyperVReplicaAzureFailbackProviderContent(string instanceType, string dataSyncOption, string recoveryVmCreationOption, string providerIdForAlternateRecovery, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(instanceType, serializedAdditionalRawData)
        {
