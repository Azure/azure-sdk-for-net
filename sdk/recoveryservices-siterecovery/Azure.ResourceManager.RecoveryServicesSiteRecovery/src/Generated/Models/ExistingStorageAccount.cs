...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class ExistingStorageAccount : StorageAccountCustomDetails
    {
        ...
        public ExistingStorageAccount(ResourceIdentifier azureStorageAccountId) : base("Existing")
        {
        ...
        /// <param name="azureStorageAccountId"> The storage account Arm Id. Throw error, if resource does not exists. </param>
        internal ExistingStorageAccount(string resourceType, IDictionary<string, BinaryData> additionalBinaryDataProperties, ResourceIdentifier azureStorageAccountId) : base(resourceType, additionalBinaryDataProperties)
        {
            AzureStorageAccountId = azureStorageAccountId;
        }
