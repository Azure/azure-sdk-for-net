...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class AddVCenterRequestProperties
    {
        ...
        /// <summary> Initializes a new instance of <see cref="AddVCenterRequestProperties"/>. </summary>
        ...
        internal AddVCenterRequestProperties(string friendlyName, string ipAddress, string processServerId, string port, string runAsAccountId, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
