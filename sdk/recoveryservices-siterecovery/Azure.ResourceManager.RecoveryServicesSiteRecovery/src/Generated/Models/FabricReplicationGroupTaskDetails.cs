...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class FabricReplicationGroupTaskDetails : JobTaskDetails
    {
        ...
        internal FabricReplicationGroupTaskDetails(string instanceType, IDictionary<string, BinaryData> additionalBinaryDataProperties, JobEntity jobTask, string skippedReason, string skippedReasonString) : base(instanceType, additionalBinaryDataProperties, jobTask)
        {
