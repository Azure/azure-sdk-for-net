...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class FabricReplicationGroupTaskDetails : SiteRecoveryJobTaskDetails
    {
        ...
        internal FabricReplicationGroupTaskDetails(string instanceType, IDictionary<string, BinaryData> additionalBinaryDataProperties, SiteRecoveryJobEntity jobTask, string skippedReason, string skippedReasonString) : base(instanceType, additionalBinaryDataProperties, jobTask)
        {
