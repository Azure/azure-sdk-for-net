...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class FabricReplicationGroupTaskDetails : SiteRecoveryJobTaskDetails
    {
        ...
        internal FabricReplicationGroupTaskDetails(string instanceType, SiteRecoveryJobEntity jobTask, string skippedReason, string skippedReasonString, Dictionary<string, BinaryData> rawData) : base(instanceType, jobTask, rawData)
        {
