...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class VMwareCbtDiskContent
    {
        ...
        internal VMwareCbtDiskContent(string diskId, SiteRecoveryDiskAccountType? diskType, string isOSDisk, ResourceIdentifier logStorageAccountId, string logStorageAccountSasSecretName, ResourceIdentifier diskEncryptionSetId, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            DiskId = diskId;
            DiskType = diskType;
            IsOSDisk = isOSDisk;
