...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    public partial class SiteRecoveryServiceError : IUtf8JsonSerializable, IJsonModel<SiteRecoveryServiceError>
    {
        ...
        void IJsonModel<SiteRecoveryServiceError>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(SiteRecoveryServiceError)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<SiteRecoveryServiceError>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(SiteRecoveryServiceError)} does not support '{options.Format}' format.");
            }
        }
