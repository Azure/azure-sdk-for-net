...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ResourceHealthSummary>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ResourceHealthSummary>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ResourceHealthSummary>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ResourceHealthSummary>)} interface");
            }
        ...
        string IPersistableModel<ResourceHealthSummary>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
