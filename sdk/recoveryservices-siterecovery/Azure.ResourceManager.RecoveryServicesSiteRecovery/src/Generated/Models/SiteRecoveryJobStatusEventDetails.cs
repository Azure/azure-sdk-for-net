...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class SiteRecoveryJobStatusEventDetails : SiteRecoveryEventSpecificDetails
    {
        ...
        internal SiteRecoveryJobStatusEventDetails(string instanceType, ResourceIdentifier jobId, string jobFriendlyName, string jobStatus, string affectedObjectType, Dictionary<string, BinaryData> rawData) : base(instanceType, rawData)
        {
            JobId = jobId;
