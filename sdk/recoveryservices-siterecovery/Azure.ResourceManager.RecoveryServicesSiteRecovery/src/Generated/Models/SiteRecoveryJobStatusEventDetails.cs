...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class SiteRecoveryJobStatusEventDetails : SiteRecoveryEventSpecificDetails
    {
        ...
        internal SiteRecoveryJobStatusEventDetails() : base("JobStatus")
        {
        }
        ...
        internal SiteRecoveryJobStatusEventDetails(string instanceType, IDictionary<string, BinaryData> additionalBinaryDataProperties, ResourceIdentifier jobId, string jobFriendlyName, string jobStatus, string affectedObjectType) : base(instanceType, additionalBinaryDataProperties)
        {
            JobId = jobId;
