...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    /// </summary>
    [AbstractTypeDeserializer(typeof(UnknownPolicyProviderSpecificDetails))]
    public abstract partial class PolicyProviderSpecificDetails
    {
        ...
        internal PolicyProviderSpecificDetails(string instanceType, Dictionary<string, BinaryData> rawData)
        {
