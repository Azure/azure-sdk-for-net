...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class SiteRecoveryFabricProviderSpecificDetails : FabricSpecificDetails
    {
        ...
        internal SiteRecoveryFabricProviderSpecificDetails(string instanceType, AzureLocation? location, IReadOnlyList<ResourceIdentifier> containerIds, IReadOnlyList<A2AZoneDetails> zones, IReadOnlyList<A2AExtendedLocationDetails> extendedLocations, IReadOnlyList<A2AFabricSpecificLocationDetails> locationDetails, Dictionary<string, BinaryData> rawData) : base(instanceType, rawData)
        {
            Location = location;
