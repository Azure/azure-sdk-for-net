...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class A2APolicyCreationContent : PolicyProviderSpecificContent
    {
        ...
        internal A2APolicyCreationContent(string instanceType, int? recoveryPointHistory, int? crashConsistentFrequencyInMinutes, int? appConsistentFrequencyInMinutes, SetMultiVmSyncStatus multiVmSyncStatus, Dictionary<string, BinaryData> rawData) : base(instanceType, rawData)
        {
