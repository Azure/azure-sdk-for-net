...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class RecoveryPlanHyperVReplicaAzureFailoverContent : RecoveryPlanProviderSpecificFailoverContent
    {
        ...
        internal RecoveryPlanHyperVReplicaAzureFailoverContent(string instanceType, string primaryKekCertificatePfx, string secondaryKekCertificatePfx, HyperVReplicaAzureRpRecoveryPointType? recoveryPointType, Dictionary<string, BinaryData> rawData) : base(instanceType, rawData)
        {
