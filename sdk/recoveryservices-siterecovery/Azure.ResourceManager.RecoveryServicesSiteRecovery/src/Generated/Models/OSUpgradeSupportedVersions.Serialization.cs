...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<OSUpgradeSupportedVersions>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<OSUpgradeSupportedVersions>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<OSUpgradeSupportedVersions>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<OSUpgradeSupportedVersions>)} interface");
            }
        ...
        string IPersistableModel<OSUpgradeSupportedVersions>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
