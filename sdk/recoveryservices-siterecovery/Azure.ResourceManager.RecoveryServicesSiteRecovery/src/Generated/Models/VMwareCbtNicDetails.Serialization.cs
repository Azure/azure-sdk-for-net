...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VMwareCbtNicDetails>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<VMwareCbtNicDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<VMwareCbtNicDetails>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<VMwareCbtNicDetails>)} interface");
            }
        ...
        string IPersistableModel<VMwareCbtNicDetails>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
