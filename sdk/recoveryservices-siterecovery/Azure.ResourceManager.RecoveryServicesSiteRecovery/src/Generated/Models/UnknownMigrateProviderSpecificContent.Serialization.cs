...
{
    internal partial class UnknownMigrateProviderSpecificContent : MigrateProviderSpecificContent, IJsonModel<MigrateProviderSpecificContent>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownMigrateProviderSpecificContent DeserializeUnknownMigrateProviderSpecificContent(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownMigrateProviderSpecificContent(instanceType, additionalBinaryDataProperties);
        }
    }
}
