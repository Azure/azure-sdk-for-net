...
{
    public partial class A2AProtectedManagedDiskDetails : IUtf8JsonSerializable, IModelJsonSerializable<A2AProtectedManagedDiskDetails>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IModelJsonSerializable<A2AProtectedManagedDiskDetails>)this).Serialize(writer, ModelSerializerOptions.DefaultWireOptions);

        void IModelJsonSerializable<A2AProtectedManagedDiskDetails>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<A2AProtectedManagedDiskDetails>(this, options.Format);
        ...
        internal static A2AProtectedManagedDiskDetails DeserializeA2AProtectedManagedDiskDetails(JsonElement element, ModelSerializerOptions options = default)
        {
        ...
        A2AProtectedManagedDiskDetails IModelJsonSerializable<A2AProtectedManagedDiskDetails>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<A2AProtectedManagedDiskDetails>(this, options.Format);

            using var doc = JsonDocument.ParseValue(ref reader);
            return DeserializeA2AProtectedManagedDiskDetails(doc.RootElement, options);
        }

        BinaryData IModelSerializable<A2AProtectedManagedDiskDetails>.Serialize(ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<A2AProtectedManagedDiskDetails>(this, options.Format);
        ...
        A2AProtectedManagedDiskDetails IModelSerializable<A2AProtectedManagedDiskDetails>.Deserialize(BinaryData data, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<A2AProtectedManagedDiskDetails>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="A2AProtectedManagedDiskDetails"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="A2AProtectedManagedDiskDetails"/> to convert. </param>
        public static implicit operator RequestContent(A2AProtectedManagedDiskDetails model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="A2AProtectedManagedDiskDetails"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator A2AProtectedManagedDiskDetails(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeA2AProtectedManagedDiskDetails(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
