...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<A2AProtectedManagedDiskDetails>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<A2AProtectedManagedDiskDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<A2AProtectedManagedDiskDetails>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<A2AProtectedManagedDiskDetails>)} interface");
            }
        ...
        string IPersistableModel<A2AProtectedManagedDiskDetails>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
