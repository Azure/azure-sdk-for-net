...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    public partial class TestFailoverJobDetails : IUtf8JsonSerializable, IModelJsonSerializable<TestFailoverJobDetails>
    {
        ...
        internal static TestFailoverJobDetails DeserializeTestFailoverJobDetails(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new TestFailoverJobDetails(instanceType, Optional.ToDictionary(affectedObjectDetails), testFailoverStatus.Value, comments.Value, networkName.Value, networkFriendlyName.Value, networkType.Value, Optional.ToList(protectedItemDetails), serializedAdditionalRawData);
        }
