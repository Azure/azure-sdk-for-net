...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class TestFailoverJobDetails : SiteRecoveryJobDetails, IJsonModel<TestFailoverJobDetails>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<TestFailoverJobDetails>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<TestFailoverJobDetails>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        TestFailoverJobDetails IPersistableModel<TestFailoverJobDetails>.Create(BinaryData data, ModelReaderWriterOptions options) => (TestFailoverJobDetails)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        TestFailoverJobDetails IJsonModel<TestFailoverJobDetails>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (TestFailoverJobDetails)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static TestFailoverJobDetails DeserializeTestFailoverJobDetails(JsonElement element, ModelReaderWriterOptions options)
        {
