...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TestFailoverJobDetails>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<TestFailoverJobDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<TestFailoverJobDetails>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<TestFailoverJobDetails>)} interface");
            }
        ...
        string IPersistableModel<TestFailoverJobDetails>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
