...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="JobStatusEventDetails"/>. </summary>
        internal JobStatusEventDetails() : base("JobStatus")
        {
        }
        ...
        internal JobStatusEventDetails(string instanceType, IDictionary<string, BinaryData> additionalBinaryDataProperties, string jobId, string jobFriendlyName, string jobStatus, string affectedObjectType) : base(instanceType, additionalBinaryDataProperties)
        {
            JobId = jobId;
