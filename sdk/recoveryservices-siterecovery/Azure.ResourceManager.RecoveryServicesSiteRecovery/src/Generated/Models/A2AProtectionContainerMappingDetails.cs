...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class A2AProtectionContainerMappingDetails : ProtectionContainerMappingProviderSpecificDetails
    {
        ...
        internal A2AProtectionContainerMappingDetails(string instanceType, IDictionary<string, BinaryData> additionalBinaryDataProperties, SiteRecoveryAgentAutoUpdateStatus? agentAutoUpdateStatus, ResourceIdentifier automationAccountArmId, AutomationAccountAuthenticationType? automationAccountAuthenticationType, string scheduleName, string jobScheduleName) : base(instanceType, additionalBinaryDataProperties)
        {
