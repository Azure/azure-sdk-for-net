...
{
    public partial class ReplicationAgentDetails : IUtf8JsonSerializable, IJsonModel<ReplicationAgentDetails>, IPersistableModel<ReplicationAgentDetails>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(LastHeartbeatUtc))
            {
                ...
                builder.AppendLine($" '{LastHeartbeatUtc.Value.ToString()}'");
            }
