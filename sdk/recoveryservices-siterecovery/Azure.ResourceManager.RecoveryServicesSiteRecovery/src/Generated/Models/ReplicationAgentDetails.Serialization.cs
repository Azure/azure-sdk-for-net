...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ReplicationAgentDetails>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ReplicationAgentDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ReplicationAgentDetails>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ReplicationAgentDetails>)} interface");
            }
        ...
        string IPersistableModel<ReplicationAgentDetails>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
