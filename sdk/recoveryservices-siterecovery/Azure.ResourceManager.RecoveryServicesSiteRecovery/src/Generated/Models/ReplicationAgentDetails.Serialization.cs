...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    public partial class ReplicationAgentDetails
    {
        internal static ReplicationAgentDetails DeserializeReplicationAgentDetails(JsonElement element)
        {
            ...
            return new ReplicationAgentDetails(id.Value, name.Value, biosId.Value, fabricObjectId.Value, fqdn.Value, version.Value, Core.Optional.ToNullable(lastHeartbeatUtc), Core.Optional.ToNullable(health), Core.Optional.ToList(healthErrors));
        }
    }
}
