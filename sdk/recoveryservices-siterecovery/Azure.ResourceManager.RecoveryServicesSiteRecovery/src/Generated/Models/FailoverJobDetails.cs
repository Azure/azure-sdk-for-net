...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class FailoverJobDetails : SiteRecoveryJobDetails
    {
        ...
        internal FailoverJobDetails(string instanceType, IReadOnlyDictionary<string, string> affectedObjectDetails, IReadOnlyList<FailoverReplicationProtectedItemDetails> protectedItemDetails, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(instanceType, affectedObjectDetails, serializedAdditionalRawData)
        {
