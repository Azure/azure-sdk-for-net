...
{
    public partial class SiteRecoveryJobEntity : IUtf8JsonSerializable, IJsonModel<SiteRecoveryJobEntity>, IPersistableModel<SiteRecoveryJobEntity>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(JobScenarioName))
            {
                builder.Append("  jobScenarioName:");
                builder.AppendLine($" '{JobScenarioName}'");
            }
