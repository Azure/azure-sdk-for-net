    ...
    public partial class InMageRcmDiscoveredProtectedVmDetails : IUtf8JsonSerializable, IJsonModel<InMageRcmDiscoveredProtectedVmDetails>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(VCenterFqdn))
            {
                ...
                if (VCenterFqdn.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(VMwareToolsStatus))
            {
                ...
                if (VMwareToolsStatus.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(PowerStatus))
            {
                ...
                if (PowerStatus.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(VmFqdn))
            {
                ...
                if (VmFqdn.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(LastDiscoveryTimeInUtc))
            {
                ...
                var formattedDateTimeString = TypeFormatters.ToString(LastDiscoveryTimeInUtc.Value, "o");
                builder.AppendLine($" '{formattedDateTimeString}'");
            }
