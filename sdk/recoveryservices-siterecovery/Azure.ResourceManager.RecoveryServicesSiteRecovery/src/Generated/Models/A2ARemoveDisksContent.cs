...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class A2ARemoveDisksContent : RemoveDisksProviderSpecificContent
    {
        ...
        internal A2ARemoveDisksContent(string instanceType, IList<Uri> vmDisksUris, IList<string> vmManagedDisksIds, Dictionary<string, BinaryData> rawData) : base(instanceType, rawData)
        {
