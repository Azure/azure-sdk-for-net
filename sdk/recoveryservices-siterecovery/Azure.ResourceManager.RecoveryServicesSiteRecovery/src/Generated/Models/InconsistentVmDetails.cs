...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class InconsistentVmDetails
    {
        ...
        internal InconsistentVmDetails(string vmName, string cloudName, IReadOnlyList<string> details, IReadOnlyList<string> errorIds, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            VmName = vmName;
            CloudName = cloudName;
            Details = details;
