...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VMwareCbtSecurityProfileProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<VMwareCbtSecurityProfileProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<VMwareCbtSecurityProfileProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<VMwareCbtSecurityProfileProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
