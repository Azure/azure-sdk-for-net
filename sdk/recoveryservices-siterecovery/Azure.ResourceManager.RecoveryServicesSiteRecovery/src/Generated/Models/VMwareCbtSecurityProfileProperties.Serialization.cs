    ...
    public partial class VMwareCbtSecurityProfileProperties : IUtf8JsonSerializable, IJsonModel<VMwareCbtSecurityProfileProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(TargetVmSecurityType))
            {
                ...
                builder.AppendLine($" '{TargetVmSecurityType.Value.ToString()}'");
            }

            if (Optional.IsDefined(IsTargetVmSecureBootEnabled))
            {
                builder.Append("  isTargetVmSecureBootEnabled:");
                if (IsTargetVmSecureBootEnabled.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(IsTargetVmTpmEnabled))
            {
                ...
                if (IsTargetVmTpmEnabled.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(IsTargetVmIntegrityMonitoringEnabled))
            {
                ...
                if (IsTargetVmIntegrityMonitoringEnabled.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(IsTargetVmConfidentialEncryptionEnabled))
            {
                ...
                if (IsTargetVmConfidentialEncryptionEnabled.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
