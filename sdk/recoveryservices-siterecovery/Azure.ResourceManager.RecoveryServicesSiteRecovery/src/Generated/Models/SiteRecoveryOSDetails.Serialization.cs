...
{
    public partial class SiteRecoveryOSDetails : IUtf8JsonSerializable, IJsonModel<SiteRecoveryOSDetails>, IPersistableModel<SiteRecoveryOSDetails>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(OSMajorVersion))
            {
                builder.Append("  oSMajorVersion:");
                builder.AppendLine($" '{OSMajorVersion}'");
            }

            if (Optional.IsDefined(OSMinorVersion))
            {
                builder.Append("  oSMinorVersion:");
                builder.AppendLine($" '{OSMinorVersion}'");
            }
