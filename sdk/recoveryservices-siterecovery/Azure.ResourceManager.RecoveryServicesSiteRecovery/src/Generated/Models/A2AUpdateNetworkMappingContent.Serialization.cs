...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<A2AUpdateNetworkMappingContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<A2AUpdateNetworkMappingContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<A2AUpdateNetworkMappingContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<A2AUpdateNetworkMappingContent>)} interface");
            }
        ...
        string IPersistableModel<A2AUpdateNetworkMappingContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
