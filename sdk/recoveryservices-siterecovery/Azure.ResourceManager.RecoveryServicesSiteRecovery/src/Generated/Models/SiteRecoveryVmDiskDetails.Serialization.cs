...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    public partial class SiteRecoveryVmDiskDetails : IUtf8JsonSerializable, IJsonModel<SiteRecoveryVmDiskDetails>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(VhdType))
            {
                builder.Append("  vhdType:");
                if (VhdType.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
                    builder.AppendLine($"{VhdType}'''");
                }
                else
                {
                    builder.AppendLine($" '{VhdType}'");
            ...
            if (Optional.IsDefined(VhdId))
            {
                builder.Append("  vhdId:");
                if (VhdId.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
                    builder.AppendLine($"{VhdId}'''");
                }
                else
                {
                    builder.AppendLine($" '{VhdId}'");
            ...
            if (Optional.IsDefined(MaxSizeMB))
            {
                builder.Append("  maxSizeMB:");
                if (MaxSizeMB.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
                    builder.AppendLine($"{MaxSizeMB}'''");
                }
                else
                {
                    builder.AppendLine($" '{MaxSizeMB}'");
            ...
            if (Optional.IsDefined(TargetDiskLocation))
            {
                builder.Append("  targetDiskLocation:");
                if (TargetDiskLocation.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
                    builder.AppendLine($"{TargetDiskLocation}'''");
                }
                else
                {
                    builder.AppendLine($" '{TargetDiskLocation}'");
            ...
            if (Optional.IsDefined(TargetDiskName))
            {
                builder.Append("  targetDiskName:");
                if (TargetDiskName.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
                    builder.AppendLine($"{TargetDiskName}'''");
                }
                else
                {
                    builder.AppendLine($" '{TargetDiskName}'");
            ...
            if (Optional.IsDefined(LunId))
            {
                ...
                if (LunId.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
                    builder.AppendLine($"{LunId}'''");
                }
                else
                {
                    builder.AppendLine($" '{LunId}'");
            ...
            if (Optional.IsDefined(CustomTargetDiskName))
            {
                builder.Append("  customTargetDiskName:");
                if (CustomTargetDiskName.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
                    builder.AppendLine($"{CustomTargetDiskName}'''");
                }
                else
                {
                    builder.AppendLine($" '{CustomTargetDiskName}'");
