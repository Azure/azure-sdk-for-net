...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<A2AContainerMappingContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<A2AContainerMappingContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<A2AContainerMappingContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<A2AContainerMappingContent>)} interface");
            }
        ...
        string IPersistableModel<A2AContainerMappingContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
