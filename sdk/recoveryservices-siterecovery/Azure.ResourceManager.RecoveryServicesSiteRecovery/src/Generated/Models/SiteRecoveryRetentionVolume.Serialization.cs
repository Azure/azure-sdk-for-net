...
{
    public partial class SiteRecoveryRetentionVolume : IUtf8JsonSerializable, IJsonModel<SiteRecoveryRetentionVolume>, IPersistableModel<SiteRecoveryRetentionVolume>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(FreeSpaceInBytes))
            {
                builder.Append("  freeSpaceInBytes:");
                builder.AppendLine($" '{FreeSpaceInBytes.Value.ToString()}'");
            }

            if (Optional.IsDefined(ThresholdPercentage))
            {
                builder.Append("  thresholdPercentage:");
                builder.AppendLine($" '{ThresholdPercentage.Value.ToString()}'");
            }
