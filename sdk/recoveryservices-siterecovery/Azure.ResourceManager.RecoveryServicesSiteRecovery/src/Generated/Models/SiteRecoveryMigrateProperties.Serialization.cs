...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SiteRecoveryMigrateProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SiteRecoveryMigrateProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SiteRecoveryMigrateProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SiteRecoveryMigrateProperties>)} interface");
            }
        ...
        string IPersistableModel<SiteRecoveryMigrateProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
