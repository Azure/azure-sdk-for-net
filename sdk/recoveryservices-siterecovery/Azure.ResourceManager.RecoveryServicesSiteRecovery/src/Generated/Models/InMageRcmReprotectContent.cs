...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class InMageRcmReprotectContent : ReverseReplicationProviderSpecificContent
    {
        ...
        public InMageRcmReprotectContent(string reprotectAgentId, string datastoreName, ResourceIdentifier logStorageAccountId) : base("InMageRcm")
        {
        ...
        internal InMageRcmReprotectContent(string instanceType, IDictionary<string, BinaryData> additionalBinaryDataProperties, string reprotectAgentId, string datastoreName, ResourceIdentifier logStorageAccountId, ResourceIdentifier policyId) : base(instanceType, additionalBinaryDataProperties)
        {
            ReprotectAgentId = reprotectAgentId;
            DatastoreName = datastoreName;
            LogStorageAccountId = logStorageAccountId;
