        ...
        internal static A2AProtectedDiskDetails DeserializeA2AProtectedDiskDetails(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                if (prop.NameEquals("diskUri"u8))
                {
                    ...
                    diskUri = string.IsNullOrEmpty(prop.Value.GetString()) ? null : new Uri(prop.Value.GetString(), UriKind.RelativeOrAbsolute);
                    continue;
                }
                if (prop.NameEquals("recoveryAzureStorageAccountId"u8))
                {
                    ...
                    recoveryAzureStorageAccountId = new ResourceIdentifier(prop.Value.GetString());
                    continue;
                }
                if (prop.NameEquals("primaryDiskAzureStorageAccountId"u8))
                {
                    ...
                    primaryDiskAzureStorageAccountId = new ResourceIdentifier(prop.Value.GetString());
                    continue;
                }
                if (prop.NameEquals("recoveryDiskUri"u8))
                {
                    ...
                    recoveryDiskUri = string.IsNullOrEmpty(prop.Value.GetString()) ? null : new Uri(prop.Value.GetString(), UriKind.RelativeOrAbsolute);
                    continue;
                }
                ...
                if (prop.NameEquals("primaryStagingAzureStorageAccountId"u8))
                {
                    ...
                    primaryStagingAzureStorageAccountId = new ResourceIdentifier(prop.Value.GetString());
                    continue;
                }
                ...
                if (prop.NameEquals("dekKeyVaultArmId"u8))
                {
                    ...
                    dekKeyVaultArmId = new ResourceIdentifier(prop.Value.GetString());
                    continue;
                }
                ...
                if (prop.NameEquals("kekKeyVaultArmId"u8))
                {
                    ...
                    kekKeyVaultArmId = new ResourceIdentifier(prop.Value.GetString());
                    continue;
                }
