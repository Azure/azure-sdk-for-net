...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class VMwareV2FabricCreationContent : FabricSpecificCreationContent
    {
        ...
        internal VMwareV2FabricCreationContent(string instanceType, ResourceIdentifier vmwareSiteId, ResourceIdentifier physicalSiteId, ResourceIdentifier migrationSolutionId, Dictionary<string, BinaryData> rawData) : base(instanceType, rawData)
        {
