...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class IdentityProviderDetails
    {
        ...
        internal IdentityProviderDetails(Guid? tenantId, string applicationId, string objectId, string audience, string aadAuthority, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            TenantId = tenantId;
