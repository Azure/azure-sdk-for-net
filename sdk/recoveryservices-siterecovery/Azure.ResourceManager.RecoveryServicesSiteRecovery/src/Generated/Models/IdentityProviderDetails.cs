...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Models
{
    ...
    public partial class IdentityProviderDetails
    {
        ...
        internal IdentityProviderDetails(Guid? tenantId, string applicationId, string objectId, string audience, string aadAuthority, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            TenantId = tenantId;
