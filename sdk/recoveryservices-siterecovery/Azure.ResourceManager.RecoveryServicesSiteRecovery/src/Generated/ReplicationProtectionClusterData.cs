...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery
{
    ...
    public partial class ReplicationProtectionClusterData : ResourceData
    {
        ...
        internal ReplicationProtectionClusterData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, ReplicationProtectionClusterProperties properties) : base(id, name, resourceType, systemData)
        {
