    ...
    public partial class ReplicationProtectionIntentCollection : ArmCollection, IEnumerable<ReplicationProtectionIntentResource>, IAsyncEnumerable<ReplicationProtectionIntentResource>
    {
        ...
        public virtual async Task<ArmOperation<ReplicationProtectionIntentResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string intentObjectName, ReplicationProtectionIntentCreateOrUpdateContent content, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _replicationProtectionIntentsRestClient.CreateCreateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, _resourceName, intentObjectName, ReplicationProtectionIntentCreateOrUpdateContent.ToRequestContent(content), context);
        ...
        public virtual AsyncPageable<ReplicationProtectionIntentResource> GetAllAsync(string skipToken = default, string takeToken = default, CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<ReplicationProtectionIntentData, ReplicationProtectionIntentResource>(new ReplicationProtectionIntentsGetAllAsyncCollectionResultOfT(
                ...
                takeToken,
                context,
                "ReplicationProtectionIntentCollection.GetAll"), data => new ReplicationProtectionIntentResource(Client, data));
        }
