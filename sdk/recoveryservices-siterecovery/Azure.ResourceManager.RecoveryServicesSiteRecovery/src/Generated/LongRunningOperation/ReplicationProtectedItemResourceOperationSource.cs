...
{
    /// <summary></summary>
    internal partial class ReplicationProtectedItemResourceOperationSource : IOperationSource<ReplicationProtectedItemResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal ReplicationProtectedItemResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
