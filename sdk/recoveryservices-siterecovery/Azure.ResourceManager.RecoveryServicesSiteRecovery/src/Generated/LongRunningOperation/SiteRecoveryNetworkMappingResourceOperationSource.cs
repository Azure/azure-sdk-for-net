...
{
    /// <summary></summary>
    internal partial class SiteRecoveryNetworkMappingResourceOperationSource : IOperationSource<SiteRecoveryNetworkMappingResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal SiteRecoveryNetworkMappingResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
