...
{
    /// <summary></summary>
    internal partial class JobOperationSource : IOperationSource<JobResource>
    {
        ...
        JobResource IOperationSource<JobResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            JobData data = JobData.DeserializeJobData(document.RootElement, ModelSerializationExtensions.WireOptions);
