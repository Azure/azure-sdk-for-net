...
{
    /// <summary></summary>
    internal partial class StorageClassificationMappingResourceOperationSource : IOperationSource<StorageClassificationMappingResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal StorageClassificationMappingResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
