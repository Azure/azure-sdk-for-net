...
{
    /// <summary></summary>
    internal partial class VaultSettingOperationSource : IOperationSource<VaultSettingResource>
    {
        ...
        VaultSettingResource IOperationSource<VaultSettingResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            VaultSettingData data = VaultSettingData.DeserializeVaultSettingData(document.RootElement, ModelSerializationExtensions.WireOptions);
