...
{
    /// <summary></summary>
    internal partial class SiteRecoveryProtectionContainerResourceOperationSource : IOperationSource<SiteRecoveryProtectionContainerResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal SiteRecoveryProtectionContainerResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
