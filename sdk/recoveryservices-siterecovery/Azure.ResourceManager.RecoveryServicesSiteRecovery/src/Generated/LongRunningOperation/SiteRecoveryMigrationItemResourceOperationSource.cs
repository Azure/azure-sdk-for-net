...
{
    /// <summary></summary>
    internal partial class SiteRecoveryMigrationItemResourceOperationSource : IOperationSource<SiteRecoveryMigrationItemResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal SiteRecoveryMigrationItemResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
