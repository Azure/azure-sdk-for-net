...
{
    /// <summary></summary>
    internal partial class SiteRecoveryVaultSettingResourceOperationSource : IOperationSource<SiteRecoveryVaultSettingResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal SiteRecoveryVaultSettingResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
