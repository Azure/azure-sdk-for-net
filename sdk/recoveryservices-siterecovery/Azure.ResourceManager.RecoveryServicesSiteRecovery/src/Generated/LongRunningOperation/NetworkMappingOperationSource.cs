...
{
    /// <summary></summary>
    internal partial class NetworkMappingOperationSource : IOperationSource<NetworkMappingResource>
    {
        ...
        NetworkMappingResource IOperationSource<NetworkMappingResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            NetworkMappingData data = NetworkMappingData.DeserializeNetworkMappingData(document.RootElement, ModelSerializationExtensions.WireOptions);
