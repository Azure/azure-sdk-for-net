...
{
    /// <summary></summary>
    internal partial class SiteRecoveryPolicyResourceOperationSource : IOperationSource<SiteRecoveryPolicyResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal SiteRecoveryPolicyResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
