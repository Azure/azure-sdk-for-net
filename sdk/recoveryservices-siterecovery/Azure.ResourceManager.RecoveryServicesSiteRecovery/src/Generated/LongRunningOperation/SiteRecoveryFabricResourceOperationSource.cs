...
{
    /// <summary></summary>
    internal partial class SiteRecoveryFabricResourceOperationSource : IOperationSource<SiteRecoveryFabricResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal SiteRecoveryFabricResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
