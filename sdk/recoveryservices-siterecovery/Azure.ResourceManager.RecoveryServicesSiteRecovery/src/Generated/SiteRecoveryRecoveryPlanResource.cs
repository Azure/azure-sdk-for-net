...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery
{
    ...
    public partial class SiteRecoveryRecoveryPlanResource : ArmResource
    {
        ...
        /// <summary>
        /// Updates the SiteRecoveryRecoveryPlan.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{resourceName}/replicationRecoveryPlans/{recoveryPlanName}. </description>
        ...
        public virtual async Task<ArmOperation<SiteRecoveryRecoveryPlanResource>> UpdateAsync(WaitUntil waitUntil, SiteRecoveryRecoveryPlanCreateOrUpdateContent content, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(content, nameof(content));
            ...
            try
            {
                ...
                HttpMessage message = _replicationRecoveryPlansRestClient.CreateCreateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, SiteRecoveryRecoveryPlanCreateOrUpdateContent.ToRequestContent(content), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                RecoveryServicesSiteRecoveryArmOperation<SiteRecoveryRecoveryPlanResource> operation = new RecoveryServicesSiteRecoveryArmOperation<SiteRecoveryRecoveryPlanResource>(
                    new SiteRecoveryRecoveryPlanResourceOperationSource(Client),
                    _replicationRecoveryPlansClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="content"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<SiteRecoveryRecoveryPlanResource> Update(WaitUntil waitUntil, SiteRecoveryRecoveryPlanCreateOrUpdateContent content, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(content, nameof(content));
