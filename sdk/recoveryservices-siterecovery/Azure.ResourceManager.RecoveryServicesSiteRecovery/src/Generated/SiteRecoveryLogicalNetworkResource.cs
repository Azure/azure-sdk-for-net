...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="SiteRecoveryLogicalNetworkResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="SiteRecoveryFabricResource"/> using the GetSiteRecoveryLogicalNetworks method.
    /// </summary>
    public partial class SiteRecoveryLogicalNetworkResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of SiteRecoveryLogicalNetworkResource for mocking. </summary>
        protected SiteRecoveryLogicalNetworkResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="SiteRecoveryLogicalNetworkResource"/> class. </summary>
        ...
        {
            using DiagnosticScope scope = _replicationLogicalNetworksClientDiagnostics.CreateScope("SiteRecoveryLogicalNetworkResource.Get");
            scope.Start();
            try
            {
