...
{
    public partial class Sample_SiteRecoveryProtectionContainerMappingCollection
    {
        ...
        {
            // Generated from example definition: specification/recoveryservicessiterecovery/resource-manager/Microsoft.RecoveryServices/stable/2023-02-01/examples/ReplicationProtectionContainerMappings_ListByReplicationProtectionContainers.json
            ...
            // get the collection of this SiteRecoveryProtectionContainerMappingResource
            SiteRecoveryProtectionContainerMappingCollection collection = siteRecoveryProtectionContainer.GetSiteRecoveryProtectionContainerMappings();

            // invoke the operation and iterate over the result
            await foreach (SiteRecoveryProtectionContainerMappingResource item in collection.GetAllAsync())
            {
        ...
        public async Task Get_GetsAProtectionContainerMapping()
        {
            ...
            SiteRecoveryProtectionContainerMappingResource result = await collection.GetAsync(mappingName);
