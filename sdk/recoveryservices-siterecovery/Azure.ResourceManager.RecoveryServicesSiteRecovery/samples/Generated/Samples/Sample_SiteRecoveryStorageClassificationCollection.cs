...
{
    public partial class Sample_SiteRecoveryStorageClassificationCollection
    {
        ...
        {
            // Generated from example definition: specification/recoveryservicessiterecovery/resource-manager/Microsoft.RecoveryServices/stable/2023-02-01/examples/ReplicationStorageClassifications_ListByReplicationFabrics.json
            ...
            // get the collection of this SiteRecoveryStorageClassificationResource
            SiteRecoveryStorageClassificationCollection collection = siteRecoveryFabric.GetSiteRecoveryStorageClassifications();

            // invoke the operation and iterate over the result
            await foreach (SiteRecoveryStorageClassificationResource item in collection.GetAllAsync())
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                SiteRecoveryStorageClassificationData resourceData = item.Data;
        ...
        {
            // Generated from example definition: specification/recoveryservicessiterecovery/resource-manager/Microsoft.RecoveryServices/stable/2023-02-01/examples/ReplicationStorageClassifications_Get.json
            ...
            SiteRecoveryStorageClassificationResource result = await collection.GetAsync(storageClassificationName);

            // the variable result is a resource, you could call other operations on this instance as well
            // but just for demo, we get its data from this resource instance
            SiteRecoveryStorageClassificationData resourceData = result.Data;
            // for demo we just print out the id
            Console.WriteLine($"Succeeded on id: {resourceData.Id}");
        }
