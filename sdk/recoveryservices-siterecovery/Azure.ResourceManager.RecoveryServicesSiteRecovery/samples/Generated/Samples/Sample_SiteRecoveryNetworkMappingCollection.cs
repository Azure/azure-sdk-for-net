...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery.Samples
{
    public partial class Sample_SiteRecoveryNetworkMappingCollection
    {
        ...
        {
            // Generated from example definition: specification/recoveryservicessiterecovery/resource-manager/Microsoft.RecoveryServices/stable/2025-01-01/examples/ReplicationNetworkMappings_Get.json
        ...
        {
            // Generated from example definition: specification/recoveryservicessiterecovery/resource-manager/Microsoft.RecoveryServices/stable/2025-01-01/examples/ReplicationNetworkMappings_ListByReplicationNetworks.json
        ...
        public async Task GetIfExists_GetsNetworkMappingByName()
        {
            ...
            // invoke the operation
            string networkMappingName = "corpe2amap";
            NullableResponse<SiteRecoveryNetworkMappingResource> response = await collection.GetIfExistsAsync(networkMappingName);
            SiteRecoveryNetworkMappingResource result = response.HasValue ? response.Value : null;
