...
{
    public partial class Sample_SiteRecoveryProtectionContainerCollection
    {
        ...
        {
            // Generated from example definition: specification/recoveryservicessiterecovery/resource-manager/Microsoft.RecoveryServices/stable/2023-02-01/examples/ReplicationProtectionContainers_ListByReplicationFabrics.json
        ...
        public async Task Get_GetsTheProtectionContainerDetails()
        {
            ...
            SiteRecoveryProtectionContainerResource result = await collection.GetAsync(protectionContainerName);
