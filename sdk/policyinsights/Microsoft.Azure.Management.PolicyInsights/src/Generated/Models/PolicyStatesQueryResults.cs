...
namespace Microsoft.Azure.Management.PolicyInsights.Models
{
    ...
    public partial class PolicyStatesQueryResults
    {
        ...
        /// <param name="odatanextLink">Odata next link; URL to get the next
        /// set of results.</param>
        /// <param name="value">Query results.</param>
        public PolicyStatesQueryResults(string odatacontext = default(string), int? odatacount = default(int?), string odatanextLink = default(string), IList<PolicyState> value = default(IList<PolicyState>))
        {
        ...
        /// <summary>
        /// Gets or sets odata next link; URL to get the next set of results.
        /// </summary>
