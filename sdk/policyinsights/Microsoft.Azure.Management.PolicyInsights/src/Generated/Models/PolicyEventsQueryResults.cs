...
namespace Microsoft.Azure.Management.PolicyInsights.Models
{
    ...
    public partial class PolicyEventsQueryResults
    {
        ...
        public PolicyEventsQueryResults(string odatacontext = default(string), int? odatacount = default(int?), string odatanextLink = default(string), IList<PolicyEvent> value = default(IList<PolicyEvent>))
        {
