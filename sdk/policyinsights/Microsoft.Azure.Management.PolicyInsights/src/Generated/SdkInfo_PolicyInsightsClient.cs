      ...
      public static IEnumerable<Tuple<string, string, string>> ApiInfo_PolicyInsightsClient
      {
          get
          {
              return new Tuple<string, string, string>[]
              {
                ...
                new Tuple<string, string, string>("PolicyInsightsClient", "PolicyEvents", "2019-10-01"),
                new Tuple<string, string, string>("PolicyInsightsClient", "PolicyStates", "2019-10-01"),
              }.AsEnumerable();
          }
      }
  }
