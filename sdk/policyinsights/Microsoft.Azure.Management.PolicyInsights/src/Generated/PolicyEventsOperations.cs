...
namespace Microsoft.Azure.Management.PolicyInsights
{
    ...
    internal partial class PolicyEventsOperations : IServiceOperations<PolicyInsightsClient>, IPolicyEventsOperations
    {
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<PolicyEventsQueryResults>> NextLinkWithHttpMessagesAsync(string nextLink, QueryOptions queryOptions = default(QueryOptions), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (nextLink == null)
            {
            ...
            // Construct URL
            var _baseUrl = Client.BaseUri.AbsoluteUri;
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "{nextLink}").ToString();
