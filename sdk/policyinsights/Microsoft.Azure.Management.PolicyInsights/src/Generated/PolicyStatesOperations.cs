...
namespace Microsoft.Azure.Management.PolicyInsights
{
    ...
    internal partial class PolicyStatesOperations : IServiceOperations<PolicyInsightsClient>, IPolicyStatesOperations
    {
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<PolicyStatesQueryResults>> NextLinkWithHttpMessagesAsync(string nextLink, QueryOptions queryOptions = default(QueryOptions), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (nextLink == null)
            {
