...
namespace Microsoft.Azure.Management.PolicyInsights
{
    ...
    /// </summary>
    internal partial class Operations : IServiceOperations<PolicyInsightsClient>, IOperations
    {
        /// <summary>
        ...
        public async Task<AzureOperationResponse<OperationsListResults>> ListWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Create Result
            var _result = new AzureOperationResponse<OperationsListResults>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<OperationsListResults>(_responseContent, Client.DeserializationSettings);
                }
