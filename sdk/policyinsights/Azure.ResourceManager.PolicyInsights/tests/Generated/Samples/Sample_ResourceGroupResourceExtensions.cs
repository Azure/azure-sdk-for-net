...
namespace Azure.ResourceManager.PolicyInsights
{
    public partial class Sample_ResourceGroupResourceExtensions
    {
        ...
        public async Task GetQueryResultsForResourceGroupLevelPolicyAssignmentPolicyEvents_QueryAtResourceGroupLevelPolicyAssignmentScope()
        {
            ...
            await foreach (PolicyEvent item in resourceGroupResource.GetQueryResultsForResourceGroupLevelPolicyAssignmentPolicyEventsAsync(policyEventType, policyAssignmentName))
            {
                Console.WriteLine($"Succeeded: {item}");
            }
        ...
        public async Task GetQueryResultsForResourceGroupLevelPolicyAssignmentPolicyStates_QueryLatestAtResourceGroupLevelPolicyAssignmentScope()
        {
            ...
            PolicyStateType policyStateType = PolicyStateType.Latest;
            string policyAssignmentName = "myPolicyAssignment";
            await foreach (PolicyState item in resourceGroupResource.GetQueryResultsForResourceGroupLevelPolicyAssignmentPolicyStatesAsync(policyStateType, policyAssignmentName))
            {
                Console.WriteLine($"Succeeded: {item}");
            }
        ...
        public async Task SummarizeForResourceGroupLevelPolicyAssignmentPolicyStates_SummarizeAtPolicyAssignmentScope()
        {
            ...
            await foreach (PolicySummary item in resourceGroupResource.SummarizeForResourceGroupLevelPolicyAssignmentPolicyStatesAsync(policyStateSummaryType, policyAssignmentName))
            {
                Console.WriteLine($"Succeeded: {item}");
            }
