...
{
    public partial class PolicyState : IUtf8JsonSerializable, IJsonModel<PolicyState>, IPersistableModel<PolicyState>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(PolicyEvaluationDetails))
            {
                ...
                AppendChildObject(builder, PolicyEvaluationDetails, options, 2);
            }
