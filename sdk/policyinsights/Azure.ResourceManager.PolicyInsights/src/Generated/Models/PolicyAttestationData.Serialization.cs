...
namespace Azure.ResourceManager.PolicyInsights
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PolicyAttestationData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PolicyAttestationData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PolicyAttestationData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PolicyAttestationData>)} interface");
            }
        ...
        string IPersistableModel<PolicyAttestationData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
