...
namespace Azure.ResourceManager.PolicyInsights.Models
{
    ...
    public partial class PolicyEventsListQueryResultsForPolicySetDefinitionQueryOptions
    {
        ...
        /// <summary> Initializes a new instance of <see cref="PolicyEventsListQueryResultsForPolicySetDefinitionQueryOptions"/>. </summary>
        ...
        internal PolicyEventsListQueryResultsForPolicySetDefinitionQueryOptions(int? top, string orderBy, string @select, DateTimeOffset? @from, DateTimeOffset? to, string filter, string apply, string skipToken, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Top = top;
            OrderBy = orderBy;
            Select = @select;
