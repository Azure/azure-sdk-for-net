...
{
    public partial class PolicyEvaluationDetails : IUtf8JsonSerializable, IJsonModel<PolicyEvaluationDetails>, IPersistableModel<PolicyEvaluationDetails>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(IfNotExistsDetails))
            {
                ...
                AppendChildObject(builder, IfNotExistsDetails, options, 2);
            }
