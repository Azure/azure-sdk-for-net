...
namespace Azure.ResourceManager.PolicyInsights.Models
{
    internal partial class PolicyTrackedResourcesQueryResults
    {
        internal static PolicyTrackedResourcesQueryResults DeserializePolicyTrackedResourcesQueryResults(JsonElement element)
        {
            ...
            Core.Optional<IReadOnlyList<PolicyTrackedResourceRecord>> value = default;
            ...
            return new PolicyTrackedResourcesQueryResults(Core.Optional.ToList(value), nextLink.Value);
        }
    }
}
