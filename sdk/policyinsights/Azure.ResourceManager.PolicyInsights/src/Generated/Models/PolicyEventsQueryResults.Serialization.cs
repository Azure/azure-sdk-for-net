...
namespace Azure.ResourceManager.PolicyInsights.Models
{
    ...
    {
        internal static PolicyEventsQueryResults DeserializePolicyEventsQueryResults(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
