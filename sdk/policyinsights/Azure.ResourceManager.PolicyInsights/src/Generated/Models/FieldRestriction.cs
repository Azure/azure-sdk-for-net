...
namespace Azure.ResourceManager.PolicyInsights.Models
{
    ...
    public partial class FieldRestriction
    {
        ...
        internal FieldRestriction(FieldRestrictionResult? result, string defaultValue, IReadOnlyList<string> values, PolicyReference policy, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Result = result;
