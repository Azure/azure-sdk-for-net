...
namespace Azure.ResourceManager.PolicyInsights.Models
{
    ...
    public partial class FieldRestriction
    {
        ...
        internal FieldRestriction(FieldRestrictionResult? result, string defaultValue, IReadOnlyList<string> values, PolicyReference policy, string policyEffect, string reason, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Result = result;
