...
namespace Azure.ResourceManager.PolicyInsights.Models
{
    ...
    public partial class PolicyDetails
    {
        ...
        internal PolicyDetails(ResourceIdentifier policyDefinitionId, ResourceIdentifier policyAssignmentId, string policyAssignmentDisplayName, string policyAssignmentScope, ResourceIdentifier policySetDefinitionId, string policyDefinitionReferenceId, Dictionary<string, BinaryData> rawData)
        {
