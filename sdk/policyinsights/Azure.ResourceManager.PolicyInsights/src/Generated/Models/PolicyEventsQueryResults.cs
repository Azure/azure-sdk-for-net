...
namespace Azure.ResourceManager.PolicyInsights.Models
{
    ...
    internal partial class PolicyEventsQueryResults
    {
        ...
        internal PolicyEventsQueryResults(string odataContext, int? odataCount, string odataNextLink, IReadOnlyList<PolicyEvent> value, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
