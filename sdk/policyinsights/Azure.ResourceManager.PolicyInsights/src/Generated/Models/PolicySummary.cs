...
namespace Azure.ResourceManager.PolicyInsights.Models
{
    ...
    public partial class PolicySummary
    {
        ...
        internal PolicySummary(string odataId, string odataContext, PolicySummaryResults results, IReadOnlyList<PolicyAssignmentSummary> policyAssignments, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ODataId = odataId;
