...
namespace Azure.ResourceManager.PolicyInsights.Models
{
    ...
    public partial class PolicyStatesListQueryResultsForSubscriptionQueryOptions
    {
        ...
        /// <summary> Initializes a new instance of <see cref="PolicyStatesListQueryResultsForSubscriptionQueryOptions"/>. </summary>
        ...
        internal PolicyStatesListQueryResultsForSubscriptionQueryOptions(int? top, string orderBy, string @select, DateTimeOffset? @from, DateTimeOffset? to, string filter, string apply, string skipToken, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Top = top;
            OrderBy = orderBy;
            Select = @select;
