...
{
    public partial class PolicyEvent : IUtf8JsonSerializable, IModelJsonSerializable<PolicyEvent>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IModelJsonSerializable<PolicyEvent>)this).Serialize(writer, ModelSerializerOptions.DefaultWireOptions);

        void IModelJsonSerializable<PolicyEvent>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<PolicyEvent>(this, options.Format);
            ...
            if (Optional.IsCollectionDefined(Components))
            {
                ...
                foreach (var item in Components)
                {
                    ...
                    {
                        ((IModelJsonSerializable<ComponentEventDetails>)item).Serialize(writer, options);
                    }
                }
        ...
        internal static PolicyEvent DeserializePolicyEvent(JsonElement element, ModelSerializerOptions options = default)
        {
        ...
        PolicyEvent IModelJsonSerializable<PolicyEvent>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<PolicyEvent>(this, options.Format);

            using var doc = JsonDocument.ParseValue(ref reader);
            return DeserializePolicyEvent(doc.RootElement, options);
        }

        BinaryData IModelSerializable<PolicyEvent>.Serialize(ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<PolicyEvent>(this, options.Format);
        ...
        PolicyEvent IModelSerializable<PolicyEvent>.Deserialize(BinaryData data, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<PolicyEvent>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="PolicyEvent"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="PolicyEvent"/> to convert. </param>
        public static implicit operator RequestContent(PolicyEvent model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="PolicyEvent"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator PolicyEvent(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializePolicyEvent(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
