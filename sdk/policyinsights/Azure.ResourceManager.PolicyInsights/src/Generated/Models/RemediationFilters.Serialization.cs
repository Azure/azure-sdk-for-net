...
namespace Azure.ResourceManager.PolicyInsights.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RemediationFilters>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RemediationFilters>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RemediationFilters>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<RemediationFilters>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
