...
{
    public partial class TrackedResourceModificationDetails : IUtf8JsonSerializable, IJsonModel<TrackedResourceModificationDetails>, IPersistableModel<TrackedResourceModificationDetails>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(PolicyDetails))
            {
                ...
                AppendChildObject(builder, PolicyDetails, options, 2);
            }

            if (Optional.IsDefined(DeploymentId))
            {
                builder.Append("  deploymentId:");
                builder.AppendLine($" '{DeploymentId.ToString()}'");
            }

            if (Optional.IsDefined(DeploymentOn))
            {
                builder.Append("  deploymentTime:");
                builder.AppendLine($" '{DeploymentOn.Value.ToString()}'");
            }
