...
{
    public partial class RemediationDeploymentSummary : IUtf8JsonSerializable, IJsonModel<RemediationDeploymentSummary>, IPersistableModel<RemediationDeploymentSummary>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  totalDeployments:");
                builder.AppendLine($" '{TotalDeployments.Value.ToString()}'");
            }

            if (Optional.IsDefined(SuccessfulDeployments))
            {
                builder.Append("  successfulDeployments:");
                builder.AppendLine($" '{SuccessfulDeployments.Value.ToString()}'");
            }

            if (Optional.IsDefined(FailedDeployments))
            {
                builder.Append("  failedDeployments:");
                builder.AppendLine($" '{FailedDeployments.Value.ToString()}'");
            }
