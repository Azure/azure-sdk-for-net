...
namespace Azure.ResourceManager.PolicyInsights.Models
{
    ...
    public partial class ComponentPolicyStatesListQueryResultsForResourceQueryOptions
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="ComponentPolicyStatesListQueryResultsForResourceQueryOptions"/>. </summary>
        ...
        internal ComponentPolicyStatesListQueryResultsForResourceQueryOptions(int? top, string orderBy, string @select, DateTimeOffset? @from, DateTimeOffset? to, string filter, string apply, string expand, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Top = top;
            OrderBy = orderBy;
            Select = @select;
