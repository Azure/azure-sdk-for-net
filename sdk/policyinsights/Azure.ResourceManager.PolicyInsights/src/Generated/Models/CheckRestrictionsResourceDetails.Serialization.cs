...
namespace Azure.ResourceManager.PolicyInsights.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CheckRestrictionsResourceDetails>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CheckRestrictionsResourceDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CheckRestrictionsResourceDetails>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CheckRestrictionsResourceDetails>)} interface");
            }
        ...
        string IPersistableModel<CheckRestrictionsResourceDetails>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
