...
namespace Azure.ResourceManager.PolicyInsights.Models
{
    ...
    public partial class ComponentExpressionEvaluationDetails
    {
        ...
        /// <summary> Initializes a new instance of <see cref="ComponentExpressionEvaluationDetails"/>. </summary>
        ...
        internal ComponentExpressionEvaluationDetails(string result, string expression, string expressionKind, string path, BinaryData expressionValue, BinaryData targetValue, string @operator, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Result = result;
