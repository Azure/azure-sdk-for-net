...
namespace Azure.ResourceManager.PolicyInsights.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PendingField>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<PendingField>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(PendingField)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<PendingField>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(PendingField)} does not support '{options.Format}' format.");
            }
        }
