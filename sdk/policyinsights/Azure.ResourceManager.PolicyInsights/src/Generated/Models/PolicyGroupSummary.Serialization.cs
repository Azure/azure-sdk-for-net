...
{
    public partial class PolicyGroupSummary : IUtf8JsonSerializable, IJsonModel<PolicyGroupSummary>, IPersistableModel<PolicyGroupSummary>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(PolicyGroupName))
            {
                builder.Append("  policyGroupName:");
                builder.AppendLine($" '{PolicyGroupName}'");
            }
