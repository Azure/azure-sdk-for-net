...
namespace Azure.ResourceManager.PolicyInsights
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PolicyRemediationData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PolicyRemediationData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PolicyRemediationData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PolicyRemediationData>)} interface");
            }
        ...
        string IPersistableModel<PolicyRemediationData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
