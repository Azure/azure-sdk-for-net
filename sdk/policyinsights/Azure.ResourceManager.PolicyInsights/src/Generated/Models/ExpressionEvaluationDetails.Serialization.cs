...
namespace Azure.ResourceManager.PolicyInsights.Models
{
    ...
    {
        internal static ExpressionEvaluationDetails DeserializeExpressionEvaluationDetails(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
