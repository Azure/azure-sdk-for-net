...
namespace Azure.ResourceManager.PolicyInsights.Models
{
    ...
    public partial class PolicyStatesListQueryResultsForResourceQueryOptions
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="PolicyStatesListQueryResultsForResourceQueryOptions"/>. </summary>
        ...
        internal PolicyStatesListQueryResultsForResourceQueryOptions(int? top, string orderBy, string @select, DateTimeOffset? @from, DateTimeOffset? to, string filter, string apply, string expand, string skipToken, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Top = top;
            OrderBy = orderBy;
            Select = @select;
