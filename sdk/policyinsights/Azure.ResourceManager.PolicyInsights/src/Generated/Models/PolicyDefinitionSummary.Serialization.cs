...
namespace Azure.ResourceManager.PolicyInsights.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PolicyDefinitionSummary>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PolicyDefinitionSummary>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PolicyDefinitionSummary>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PolicyDefinitionSummary>)} interface");
            }
        ...
        string IPersistableModel<PolicyDefinitionSummary>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
