...
namespace Azure.ResourceManager.PolicyInsights.Models
{
    ...
    public partial class PolicyDefinitionSummary
    {
        ...
        internal PolicyDefinitionSummary(ResourceIdentifier policyDefinitionId, string policyDefinitionReferenceId, IReadOnlyList<string> policyDefinitionGroupNames, string effect, PolicySummaryResults results, Dictionary<string, BinaryData> rawData)
        {
