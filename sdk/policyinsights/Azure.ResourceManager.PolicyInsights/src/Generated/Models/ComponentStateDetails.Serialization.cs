...
namespace Azure.ResourceManager.PolicyInsights.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ComponentStateDetails>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ComponentStateDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ComponentStateDetails>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ComponentStateDetails>)} interface");
            }
        ...
        string IPersistableModel<ComponentStateDetails>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
