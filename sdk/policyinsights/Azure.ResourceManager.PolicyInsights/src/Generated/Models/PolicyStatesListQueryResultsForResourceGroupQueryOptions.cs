...
{
    /// <summary> The PolicyStatesListQueryResultsForResourceGroupQueryOptions. </summary>
    public partial class PolicyStatesListQueryResultsForResourceGroupQueryOptions
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="PolicyStatesListQueryResultsForResourceGroupQueryOptions"/>. </summary>
        ...
        internal PolicyStatesListQueryResultsForResourceGroupQueryOptions(int? top, string orderBy, string @select, DateTimeOffset? @from, DateTimeOffset? to, string filter, string apply, string skipToken, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Top = top;
            OrderBy = orderBy;
            Select = @select;
