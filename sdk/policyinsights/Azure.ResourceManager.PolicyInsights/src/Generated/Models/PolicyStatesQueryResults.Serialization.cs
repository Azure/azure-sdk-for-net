...
namespace Azure.ResourceManager.PolicyInsights.Models
{
    ...
    {
        internal static PolicyStatesQueryResults DeserializePolicyStatesQueryResults(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
