...
namespace Azure.ResourceManager.PolicyInsights.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PolicyReference>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PolicyReference>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PolicyReference>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PolicyReference>)} interface");
            }
        ...
        string IPersistableModel<PolicyReference>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
