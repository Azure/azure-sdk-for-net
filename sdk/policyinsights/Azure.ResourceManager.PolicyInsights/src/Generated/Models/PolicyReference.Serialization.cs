...
{
    public partial class PolicyReference : IUtf8JsonSerializable, IJsonModel<PolicyReference>, IPersistableModel<PolicyReference>
    {
        ...
        void IJsonModel<PolicyReference>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(PolicyReference)} does not support '{format}' format.");
            }
