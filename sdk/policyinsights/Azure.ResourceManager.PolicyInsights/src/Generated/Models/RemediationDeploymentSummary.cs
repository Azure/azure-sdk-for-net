...
namespace Azure.ResourceManager.PolicyInsights.Models
{
    ...
    public partial class RemediationDeploymentSummary
    {
        ...
        internal RemediationDeploymentSummary(int? totalDeployments, int? successfulDeployments, int? failedDeployments, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
