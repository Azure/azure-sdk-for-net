...
namespace Azure.ResourceManager.PolicyInsights.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AttestationEvidence>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AttestationEvidence>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AttestationEvidence>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<AttestationEvidence>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
