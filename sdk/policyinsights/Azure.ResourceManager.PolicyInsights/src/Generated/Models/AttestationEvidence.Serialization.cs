...
{
    public partial class AttestationEvidence : IUtf8JsonSerializable, IJsonModel<AttestationEvidence>, IPersistableModel<AttestationEvidence>
    {
        ...
        void IJsonModel<AttestationEvidence>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AttestationEvidence)} does not support '{format}' format.");
            }
