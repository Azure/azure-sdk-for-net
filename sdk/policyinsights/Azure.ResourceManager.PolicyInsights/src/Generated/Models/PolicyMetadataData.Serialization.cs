...
namespace Azure.ResourceManager.PolicyInsights
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PolicyMetadataData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PolicyMetadataData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PolicyMetadataData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PolicyMetadataData>)} interface");
            }
        ...
        string IPersistableModel<PolicyMetadataData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
