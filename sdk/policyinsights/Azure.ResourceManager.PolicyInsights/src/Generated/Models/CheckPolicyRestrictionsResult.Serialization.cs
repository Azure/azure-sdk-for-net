...
{
    public partial class CheckPolicyRestrictionsResult : IUtf8JsonSerializable, IJsonModel<CheckPolicyRestrictionsResult>, IPersistableModel<CheckPolicyRestrictionsResult>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  fieldRestrictions:");
                builder.AppendLine(" [");
                foreach (var item in FieldRestrictions)
                {
            ...
            {
                builder.Append("  contentEvaluationResult:");
                AppendChildObject(builder, ContentEvaluationResult, options, 2);
            }
