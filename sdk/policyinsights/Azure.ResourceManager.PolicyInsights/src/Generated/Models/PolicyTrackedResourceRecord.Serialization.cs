...
namespace Azure.ResourceManager.PolicyInsights.Models
{
    ...
    {
        internal static PolicyTrackedResourceRecord DeserializePolicyTrackedResourceRecord(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
