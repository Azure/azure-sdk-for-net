...
{
    public partial class PolicyTrackedResourceRecord : IUtf8JsonSerializable, IJsonModel<PolicyTrackedResourceRecord>, IPersistableModel<PolicyTrackedResourceRecord>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  trackedResourceId:");
                builder.AppendLine($" '{TrackedResourceId.ToString()}'");
            }
