...
namespace Azure.ResourceManager.PolicyInsights.Models
{
    ...
    internal partial class RemediationProperties
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="RemediationProperties"/>. </summary>
        ...
        internal RemediationProperties(ResourceIdentifier policyAssignmentId, string policyDefinitionReferenceId, ResourceDiscoveryMode? resourceDiscoveryMode, string provisioningState, DateTimeOffset? createdOn, DateTimeOffset? lastUpdatedOn, RemediationFilters filter, RemediationDeploymentSummary deploymentStatus, string statusMessage, string correlationId, int? resourceCount, int? parallelDeployments, RemediationPropertiesFailureThreshold failureThreshold, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
        ...
        public float? FailureThresholdPercentage
        {
            get
            {
                return FailureThreshold is null ? default : FailureThreshold.Percentage;
            }
            set
            {
