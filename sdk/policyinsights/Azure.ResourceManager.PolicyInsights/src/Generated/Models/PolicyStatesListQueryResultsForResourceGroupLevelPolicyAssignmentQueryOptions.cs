...
namespace Azure.ResourceManager.PolicyInsights.Models
{
    ...
    public partial class PolicyStatesListQueryResultsForResourceGroupLevelPolicyAssignmentQueryOptions
    {
        ...
        /// <summary> Initializes a new instance of <see cref="PolicyStatesListQueryResultsForResourceGroupLevelPolicyAssignmentQueryOptions"/>. </summary>
        ...
        internal PolicyStatesListQueryResultsForResourceGroupLevelPolicyAssignmentQueryOptions(int? top, string orderBy, string @select, DateTimeOffset? @from, DateTimeOffset? to, string filter, string apply, string skipToken, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Top = top;
            OrderBy = orderBy;
            Select = @select;
