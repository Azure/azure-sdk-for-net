...
namespace Azure.ResourceManager.PolicyInsights.Models
{
    ...
    public partial class PolicyStatesListQueryResultsForSubscriptionLevelPolicyAssignmentQueryOptions
    {
        ...
        /// <summary> Initializes a new instance of <see cref="PolicyStatesListQueryResultsForSubscriptionLevelPolicyAssignmentQueryOptions"/>. </summary>
        ...
        internal PolicyStatesListQueryResultsForSubscriptionLevelPolicyAssignmentQueryOptions(int? top, string orderBy, string @select, DateTimeOffset? @from, DateTimeOffset? to, string filter, string apply, string skipToken, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Top = top;
            OrderBy = orderBy;
            Select = @select;
