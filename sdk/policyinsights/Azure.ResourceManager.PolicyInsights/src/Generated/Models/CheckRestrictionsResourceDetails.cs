...
namespace Azure.ResourceManager.PolicyInsights.Models
{
    ...
    public partial class CheckRestrictionsResourceDetails
    {
        ...
        internal CheckRestrictionsResourceDetails(BinaryData resourceContent, string apiVersion, string scope, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            ResourceContent = resourceContent;
