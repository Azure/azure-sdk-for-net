...
namespace Azure.ResourceManager.PolicyInsights.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CheckRestrictionsResultContentEvaluationResult>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<CheckRestrictionsResultContentEvaluationResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CheckRestrictionsResultContentEvaluationResult>)} interface");
            }
        ...
        string IPersistableModel<CheckRestrictionsResultContentEvaluationResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
