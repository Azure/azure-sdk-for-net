...
namespace Azure.ResourceManager.PolicyInsights.Models
{
    ...
    public partial class PolicyQuerySettings
    {
        ...
        internal PolicyQuerySettings(int? top, string filter, string orderBy, string select, DateTimeOffset? @from, DateTimeOffset? to, string apply, string skipToken, string expand, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Top = top;
            Filter = filter;
            OrderBy = orderBy;
