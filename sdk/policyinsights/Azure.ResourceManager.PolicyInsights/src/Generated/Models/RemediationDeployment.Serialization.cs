...
{
    public partial class RemediationDeployment : IUtf8JsonSerializable, IJsonModel<RemediationDeployment>, IPersistableModel<RemediationDeployment>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  remediatedResourceId:");
                builder.AppendLine($" '{RemediatedResourceId.ToString()}'");
            }
