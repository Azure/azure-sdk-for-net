...
{
    public partial class IfNotExistsEvaluationDetails : IUtf8JsonSerializable, IJsonModel<IfNotExistsEvaluationDetails>, IPersistableModel<IfNotExistsEvaluationDetails>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(TotalResources))
            {
                builder.Append("  totalResources:");
                builder.AppendLine($" '{TotalResources.Value.ToString()}'");
            }
