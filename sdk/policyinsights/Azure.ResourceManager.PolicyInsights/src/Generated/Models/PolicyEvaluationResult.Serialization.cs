    ...
    public partial class PolicyEvaluationResult : IUtf8JsonSerializable, IJsonModel<PolicyEvaluationResult>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(PolicyInfo))
            {
                ...
                AppendChildObject(builder, PolicyInfo, options, 2, false);
            }

            if (Optional.IsDefined(EvaluationResult))
            {
                builder.Append("  evaluationResult:");
                if (EvaluationResult.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(EvaluationDetails))
            {
                ...
                AppendChildObject(builder, EvaluationDetails, options, 2, false);
            }
