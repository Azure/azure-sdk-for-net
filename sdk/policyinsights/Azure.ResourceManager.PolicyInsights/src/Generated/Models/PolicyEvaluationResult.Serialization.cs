...
{
    public partial class PolicyEvaluationResult : IUtf8JsonSerializable, IJsonModel<PolicyEvaluationResult>, IPersistableModel<PolicyEvaluationResult>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(EvaluationResult))
            {
                ...
                builder.AppendLine($" '{EvaluationResult}'");
            }

            if (Optional.IsDefined(EvaluationDetails))
            {
                builder.Append("  evaluationDetails:");
                AppendChildObject(builder, EvaluationDetails, options, 2);
            }
