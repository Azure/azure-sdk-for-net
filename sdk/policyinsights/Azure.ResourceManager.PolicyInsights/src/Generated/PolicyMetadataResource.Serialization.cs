...
namespace Azure.ResourceManager.PolicyInsights
{
    public partial class PolicyMetadataResource : IJsonModel<PolicyMetadataData>
    {
        ...
        {
            return ModelReaderWriter.Read<PolicyMetadataData>(new BinaryData(reader.ValueSequence), options);
        }
        ...
        {
            return ModelReaderWriter.Read<PolicyMetadataData>(data, options);
        }
