...
namespace Azure.ResourceManager.PolicyInsights
{
    ...
    public static partial class PolicyInsightsExtensions
    {
        ...
        private static PolicyInsightsArmResourceMockingExtension GetPolicyInsightsArmResourceMockingExtension(ArmResource resource)
        {
            return resource.GetCachedClient(client =>
            {
                return new PolicyInsightsArmResourceMockingExtension(client, resource.Id);
            });
        }
        ...
        /// <returns> An object representing collection of PolicyRemediationResources and their operations over a PolicyRemediationResource. </returns>
        public static PolicyRemediationCollection GetPolicyRemediations(this ArmResource armResource)
        {
            return GetPolicyInsightsArmResourceMockingExtension(armResource).GetPolicyRemediations();
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="remediationName"/> is null. </exception>
        [ForwardsClientCalls]
        public static async Task<Response<PolicyRemediationResource>> GetPolicyRemediationAsync(this ArmResource armResource, string remediationName, CancellationToken cancellationToken = default)
        {
            return await GetPolicyInsightsArmResourceMockingExtension(armResource).GetPolicyRemediationAsync(remediationName, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="remediationName"/> is null. </exception>
        [ForwardsClientCalls]
        public static Response<PolicyRemediationResource> GetPolicyRemediation(this ArmResource armResource, string remediationName, CancellationToken cancellationToken = default)
        {
            return GetPolicyInsightsArmResourceMockingExtension(armResource).GetPolicyRemediation(remediationName, cancellationToken);
        }

        /// <summary> Gets a collection of PolicyAttestationResources in the ArmResource. </summary>
        /// <param name="armResource"> The <see cref="ArmResource" /> instance the method will execute against. </param>
        /// <returns> An object representing collection of PolicyAttestationResources and their operations over a PolicyAttestationResource. </returns>
        public static PolicyAttestationCollection GetPolicyAttestations(this ArmResource armResource)
        {
            return GetPolicyInsightsArmResourceMockingExtension(armResource).GetPolicyAttestations();
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="attestationName"/> is null. </exception>
        [ForwardsClientCalls]
        public static async Task<Response<PolicyAttestationResource>> GetPolicyAttestationAsync(this ArmResource armResource, string attestationName, CancellationToken cancellationToken = default)
        {
            return await GetPolicyInsightsArmResourceMockingExtension(armResource).GetPolicyAttestationAsync(attestationName, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="attestationName"/> is null. </exception>
        [ForwardsClientCalls]
        public static Response<PolicyAttestationResource> GetPolicyAttestation(this ArmResource armResource, string attestationName, CancellationToken cancellationToken = default)
        {
            return GetPolicyInsightsArmResourceMockingExtension(armResource).GetPolicyAttestation(attestationName, cancellationToken);
        }
