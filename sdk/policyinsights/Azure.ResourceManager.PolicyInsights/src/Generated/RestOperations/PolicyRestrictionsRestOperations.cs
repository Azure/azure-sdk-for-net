...
namespace Azure.ResourceManager.PolicyInsights
{
    internal partial class PolicyRestrictionsRestOperations
    {
        ...
        internal HttpMessage CreateCheckAtSubscriptionScopeRequest(string subscriptionId, CheckPolicyRestrictionsContent content)
        {
            ...
            ((IJsonModel<CheckPolicyRestrictionsContent>)content).Write(content0.JsonWriter, ModelSerializationExtensions.WireOptions);
        ...
        internal HttpMessage CreateCheckAtManagementGroupScopeRequest(string managementGroupId, CheckManagementGroupPolicyRestrictionsContent content)
        {
            ...
            request.Headers.Add("Content-Type", "application/json");
            var content0 = new Utf8JsonRequestContent();
            ((IJsonModel<CheckManagementGroupPolicyRestrictionsContent>)content).Write(content0.JsonWriter, ModelSerializationExtensions.WireOptions);
            request.Content = content0;
            _userAgent.Apply(message);
            return message;
        }
