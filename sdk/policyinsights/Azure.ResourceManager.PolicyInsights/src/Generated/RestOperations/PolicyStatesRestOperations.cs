...
namespace Azure.ResourceManager.PolicyInsights
{
    internal partial class PolicyStates
    {
        ...
        internal PolicyStates(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string applicationId, Uri endpoint, string apiVersion)
        {
            ClientDiagnostics = clientDiagnostics;
            _endpoint = endpoint;
            Pipeline = pipeline;
            _apiVersion = apiVersion;
            _userAgent = new TelemetryDetails(typeof(PolicyStates).Assembly, applicationId);
        }
