...
namespace Azure.ResourceManager.PolicyInsights
{
    internal partial class ComponentPolicyStates
    {
        ...
        internal ComponentPolicyStates(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string applicationId, Uri endpoint, string apiVersion)
        {
            ClientDiagnostics = clientDiagnostics;
            _endpoint = endpoint;
            Pipeline = pipeline;
            _apiVersion = apiVersion;
            _userAgent = new TelemetryDetails(typeof(ComponentPolicyStates).Assembly, applicationId);
        }
