...
namespace Azure.ResourceManager.PolicyInsights.Models
{
    ...
    public static partial class ArmPolicyInsightsModelFactory
    {
        ...
        {
            return new PolicyTrackedResourceRecord(trackedResourceId, policyDetails, createdBy, lastModifiedBy, lastUpdateOn, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new PolicyDetails(policyDefinitionId, policyAssignmentId, policyAssignmentDisplayName, policyAssignmentScope, policySetDefinitionId, policyDefinitionReferenceId, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new TrackedResourceModificationDetails(policyDetails, deploymentId, deploymentOn, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new RemediationDeployment(remediatedResourceId, deploymentId, status, resourceLocation, error, createdOn, lastUpdatedOn, new Dictionary<string, BinaryData>());
        }
        ...
        public static PolicyRemediationData PolicyRemediationData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, ResourceIdentifier policyAssignmentId = null, string policyDefinitionReferenceId = null, ResourceDiscoveryMode? resourceDiscoveryMode = null, string provisioningState = null, DateTimeOffset? createdOn = null, DateTimeOffset? lastUpdatedOn = null, IEnumerable<AzureLocation> filterLocations = null, RemediationDeploymentSummary deploymentStatus = null, string statusMessage = null, string correlationId = null, int? resourceCount = null, int? parallelDeployments = null, float? failureThresholdPercentage = null)
        {
            ...
            return new PolicyRemediationData(id, name, resourceType, systemData, policyAssignmentId, policyDefinitionReferenceId, resourceDiscoveryMode, provisioningState, createdOn, lastUpdatedOn, filterLocations != null ? new RemediationFilters(filterLocations?.ToList(), new Dictionary<string, BinaryData>()) : null, deploymentStatus, statusMessage, correlationId, resourceCount, parallelDeployments, failureThresholdPercentage != null ? new RemediationPropertiesFailureThreshold(failureThresholdPercentage, new Dictionary<string, BinaryData>()) : null, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new RemediationDeploymentSummary(totalDeployments, successfulDeployments, failedDeployments, new Dictionary<string, BinaryData>());
        }
        ...
        public static PolicyEvaluationDetails PolicyEvaluationDetails(IEnumerable<ExpressionEvaluationDetails> evaluatedExpressions = null, IfNotExistsEvaluationDetails ifNotExistsDetails = null)
        {
            ...
            return new PolicyEvaluationDetails(evaluatedExpressions?.ToList(), ifNotExistsDetails, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ExpressionEvaluationDetails(result, expression, expressionKind, path, expressionValue, targetValue, @operator, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new IfNotExistsEvaluationDetails(resourceId, totalResources, new Dictionary<string, BinaryData>());
        }
        ...
        public static PolicySummary PolicySummary(string odataId = null, string odataContext = null, PolicySummaryResults results = null, IEnumerable<PolicyAssignmentSummary> policyAssignments = null)
        {
            ...
            return new PolicySummary(odataId, odataContext, results, policyAssignments?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static PolicySummaryResults PolicySummaryResults(Uri queryResultsUri = null, int? nonCompliantResources = null, int? nonCompliantPolicies = null, IEnumerable<ComplianceDetail> resourceDetails = null, IEnumerable<ComplianceDetail> policyDetails = null, IEnumerable<ComplianceDetail> policyGroupDetails = null)
        {
            ...
            return new PolicySummaryResults(queryResultsUri, nonCompliantResources, nonCompliantPolicies, resourceDetails?.ToList(), policyDetails?.ToList(), policyGroupDetails?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ComplianceDetail(complianceState, count, new Dictionary<string, BinaryData>());
        }
        ...
        public static PolicyAssignmentSummary PolicyAssignmentSummary(ResourceIdentifier policyAssignmentId = null, ResourceIdentifier policySetDefinitionId = null, PolicySummaryResults results = null, IEnumerable<PolicyDefinitionSummary> policyDefinitions = null, IEnumerable<PolicyGroupSummary> policyGroups = null)
        {
            ...
            return new PolicyAssignmentSummary(policyAssignmentId, policySetDefinitionId, results, policyDefinitions?.ToList(), policyGroups?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static PolicyDefinitionSummary PolicyDefinitionSummary(ResourceIdentifier policyDefinitionId = null, string policyDefinitionReferenceId = null, IEnumerable<string> policyDefinitionGroupNames = null, string effect = null, PolicySummaryResults results = null)
        {
            ...
            return new PolicyDefinitionSummary(policyDefinitionId, policyDefinitionReferenceId, policyDefinitionGroupNames?.ToList(), effect, results, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new PolicyGroupSummary(policyGroupName, results, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new PolicyMetadataData(id, name, resourceType, systemData, metadataId, category, title, owner, additionalContentUri, metadata, description, requirements, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SlimPolicyMetadata(id, name, resourceType, systemData, metadataId, category, title, owner, additionalContentUri, metadata, new Dictionary<string, BinaryData>());
        }
        ...
        public static CheckPolicyRestrictionsContent CheckPolicyRestrictionsContent(CheckRestrictionsResourceDetails resourceDetails = null, IEnumerable<PendingField> pendingFields = null)
        {
            ...
            return new CheckPolicyRestrictionsContent(resourceDetails, pendingFields?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new CheckRestrictionsResourceDetails(resourceContent, apiVersion, scope, new Dictionary<string, BinaryData>());
        }
        ...
        public static PendingField PendingField(string field = null, IEnumerable<string> values = null)
        {
            ...
            return new PendingField(field, values?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static CheckPolicyRestrictionsResult CheckPolicyRestrictionsResult(IEnumerable<FieldRestrictions> fieldRestrictions = null, IEnumerable<PolicyEvaluationResult> policyEvaluations = null)
        {
            ...
            return new CheckPolicyRestrictionsResult(fieldRestrictions?.ToList(), policyEvaluations != null ? new CheckRestrictionsResultContentEvaluationResult(policyEvaluations?.ToList(), new Dictionary<string, BinaryData>()) : null, new Dictionary<string, BinaryData>());
        }
        ...
        public static FieldRestrictions FieldRestrictions(string field = null, IEnumerable<FieldRestriction> restrictions = null)
        {
            ...
            return new FieldRestrictions(field, restrictions?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static FieldRestriction FieldRestriction(FieldRestrictionResult? result = null, string defaultValue = null, IEnumerable<string> values = null, PolicyReference policy = null)
        {
            ...
            return new FieldRestriction(result, defaultValue, values?.ToList(), policy, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new PolicyReference(policyDefinitionId, policySetDefinitionId, policyDefinitionReferenceId, policyAssignmentId, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new PolicyEvaluationResult(policyInfo, evaluationResult, evaluationDetails, new Dictionary<string, BinaryData>());
        }
        ...
        public static PolicyAttestationData PolicyAttestationData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, ResourceIdentifier policyAssignmentId = null, string policyDefinitionReferenceId = null, PolicyComplianceState? complianceState = null, DateTimeOffset? expireOn = null, string owner = null, string comments = null, IEnumerable<AttestationEvidence> evidence = null, string provisioningState = null, DateTimeOffset? lastComplianceStateChangeOn = null, DateTimeOffset? assessOn = null, BinaryData metadata = null)
        {
            ...
            return new PolicyAttestationData(id, name, resourceType, systemData, policyAssignmentId, policyDefinitionReferenceId, complianceState, expireOn, owner, comments, evidence?.ToList(), provisioningState, lastComplianceStateChangeOn, assessOn, metadata, new Dictionary<string, BinaryData>());
        }
    }
}
