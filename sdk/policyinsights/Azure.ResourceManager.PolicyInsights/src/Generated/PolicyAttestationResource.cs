...
namespace Azure.ResourceManager.PolicyInsights
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="PolicyAttestationResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="ArmResource"/> using the GetPolicyAttestations method.
    /// </summary>
    public partial class PolicyAttestationResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of PolicyAttestationResource for mocking. </summary>
        protected PolicyAttestationResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="PolicyAttestationResource"/> class. </summary>
        ...
        {
            string resourceId0 = $"{resourceId}/providers/Microsoft.PolicyInsights/attestations/{attestationName}";
        ...
        {
            using DiagnosticScope scope = _attestationsClientDiagnostics.CreateScope("PolicyAttestationResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _attestationsRestClient.CreateGetAtResourceRequest(Id.Parent.ToString(), Id.Name, context);
        ...
        {
            using DiagnosticScope scope = _attestationsClientDiagnostics.CreateScope("PolicyAttestationResource.Delete");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _attestationsRestClient.CreateDeleteAtResourceRequest(Id.Parent.ToString(), Id.Name, context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                RequestUriBuilder uri = message.Request.Uri;
                RehydrationToken rehydrationToken = NextLinkOperationImplementation.GetRehydrationToken(RequestMethod.Delete, uri.ToUri(), uri.ToString(), "None", null, OperationFinalStateVia.OriginalUri.ToString());
                PolicyInsightsArmOperation operation = new PolicyInsightsArmOperation(response, rehydrationToken);
        ...
        public virtual async Task<ArmOperation<PolicyAttestationResource>> UpdateAsync(WaitUntil waitUntil, PolicyAttestationData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _attestationsClientDiagnostics.CreateScope("PolicyAttestationResource.Update");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _attestationsRestClient.CreateCreateOrUpdateAtResourceRequest(Id.Parent.ToString(), Id.Name, PolicyAttestationData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
