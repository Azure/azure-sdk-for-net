...
{
    internal partial class PolicyStatesGetQueryResultsForManagementGroupCollectionResultOfT : Pageable<PolicyState>
    {
        ...
        /// <summary> Initializes a new instance of PolicyStatesGetQueryResultsForManagementGroupCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public PolicyStatesGetQueryResultsForManagementGroupCollectionResultOfT(PolicyStates client, string policyStatesResource, string managementGroupName, int? maxCount, string orderBy, string @select, DateTimeOffset? @from, DateTimeOffset? to, string filter, string apply, string skipToken, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of PolicyStatesGetQueryResultsForManagementGroupCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of PolicyStatesGetQueryResultsForManagementGroupCollectionResultOfT as an enumerable collection. </returns>
        ...
        {
            HttpMessage message = nextLink != null ? _client.CreateNextGetQueryResultsForManagementGroupRequest(nextLink, _policyStatesResource, _managementGroupName, _maxCount, _orderBy, _select, _from, _to, _filter, _apply, _skipToken, _context) : _client.CreateGetQueryResultsForManagementGroupRequest(_policyStatesResource, _managementGroupName, _maxCount, _orderBy, _select, _from, _to, _filter, _apply, _skipToken, _context);
