...
{
    internal partial class PolicyEventsGetQueryResultsForResourceGroupLevelPolicyAssignmentPolicyEventsAsyncCollectionResultOfT : AsyncPageable<PolicyEvent>
    {
        ...
        /// <summary> Initializes a new instance of PolicyEventsGetQueryResultsForResourceGroupLevelPolicyAssignmentPolicyEventsAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        /// <summary> Gets the pages of PolicyEventsGetQueryResultsForResourceGroupLevelPolicyAssignmentPolicyEventsAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of PolicyEventsGetQueryResultsForResourceGroupLevelPolicyAssignmentPolicyEventsAsyncCollectionResultOfT as an enumerable collection. </returns>
