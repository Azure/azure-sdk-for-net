...
{
    internal partial class PolicyEventsGetQueryResultsForPolicySetDefinitionAsyncCollectionResultOfT : AsyncPageable<PolicyEvent>
    {
        ...
        /// <summary> Initializes a new instance of PolicyEventsGetQueryResultsForPolicySetDefinitionAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        /// <summary> Gets the pages of PolicyEventsGetQueryResultsForPolicySetDefinitionAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of PolicyEventsGetQueryResultsForPolicySetDefinitionAsyncCollectionResultOfT as an enumerable collection. </returns>
        ...
        {
            HttpMessage message = nextLink != null ? _client.CreateNextGetQueryResultsForPolicySetDefinitionRequest(nextLink, _subscriptionId, _policyEventsResource, _policySetDefinitionName, _maxCount, _orderBy, _select, _from, _to, _filter, _apply, _skipToken, _context) : _client.CreateGetQueryResultsForPolicySetDefinitionRequest(_subscriptionId, _policyEventsResource, _policySetDefinitionName, _maxCount, _orderBy, _select, _from, _to, _filter, _apply, _skipToken, _context);
