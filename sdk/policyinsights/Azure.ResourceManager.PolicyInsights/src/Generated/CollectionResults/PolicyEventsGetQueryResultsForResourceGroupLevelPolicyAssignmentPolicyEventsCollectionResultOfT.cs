...
{
    internal partial class PolicyEventsGetQueryResultsForResourceGroupLevelPolicyAssignmentPolicyEventsCollectionResultOfT : Pageable<PolicyEvent>
    {
        ...
        /// <summary> Initializes a new instance of PolicyEventsGetQueryResultsForResourceGroupLevelPolicyAssignmentPolicyEventsCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        /// <summary> Gets the pages of PolicyEventsGetQueryResultsForResourceGroupLevelPolicyAssignmentPolicyEventsCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of PolicyEventsGetQueryResultsForResourceGroupLevelPolicyAssignmentPolicyEventsCollectionResultOfT as an enumerable collection. </returns>
        ...
        {
            HttpMessage message = nextLink != null ? _client.CreateNextGetQueryResultsForResourceGroupLevelPolicyAssignmentPolicyEventsRequest(nextLink, _subscriptionId, _resourceGroupName, _policyEventsResource, _policyAssignmentName, _maxCount, _orderBy, _select, _from, _to, _filter, _apply, _skipToken, _context) : _client.CreateGetQueryResultsForResourceGroupLevelPolicyAssignmentPolicyEventsRequest(_subscriptionId, _resourceGroupName, _policyEventsResource, _policyAssignmentName, _maxCount, _orderBy, _select, _from, _to, _filter, _apply, _skipToken, _context);
