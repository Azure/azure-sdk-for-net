...
{
    internal partial class PolicyStatesGetQueryResultsForResourceGroupLevelPolicyAssignmentPolicyStatesAsyncCollectionResultOfT : AsyncPageable<PolicyState>
    {
        ...
        /// <summary> Initializes a new instance of PolicyStatesGetQueryResultsForResourceGroupLevelPolicyAssignmentPolicyStatesAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        /// <summary> Gets the pages of PolicyStatesGetQueryResultsForResourceGroupLevelPolicyAssignmentPolicyStatesAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of PolicyStatesGetQueryResultsForResourceGroupLevelPolicyAssignmentPolicyStatesAsyncCollectionResultOfT as an enumerable collection. </returns>
        ...
        {
            HttpMessage message = nextLink != null ? _client.CreateNextGetQueryResultsForResourceGroupLevelPolicyAssignmentPolicyStatesRequest(nextLink, _subscriptionId, _resourceGroupName, _policyStatesResource, _policyAssignmentName, _maxCount, _orderBy, _select, _from, _to, _filter, _apply, _skipToken, _context) : _client.CreateGetQueryResultsForResourceGroupLevelPolicyAssignmentPolicyStatesRequest(_subscriptionId, _resourceGroupName, _policyStatesResource, _policyAssignmentName, _maxCount, _orderBy, _select, _from, _to, _filter, _apply, _skipToken, _context);
