...
{
    internal partial class PolicyStatesGetQueryResultsForPolicySetDefinitionPolicyStatesAsyncCollectionResultOfT : AsyncPageable<PolicyState>
    {
        ...
        /// <summary> Initializes a new instance of PolicyStatesGetQueryResultsForPolicySetDefinitionPolicyStatesAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        /// <summary> Gets the pages of PolicyStatesGetQueryResultsForPolicySetDefinitionPolicyStatesAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of PolicyStatesGetQueryResultsForPolicySetDefinitionPolicyStatesAsyncCollectionResultOfT as an enumerable collection. </returns>
        ...
        {
            HttpMessage message = nextLink != null ? _client.CreateNextGetQueryResultsForPolicySetDefinitionPolicyStatesRequest(nextLink, _subscriptionId, _policyStatesResource, _policySetDefinitionName, _maxCount, _orderBy, _select, _from, _to, _filter, _apply, _skipToken, _context) : _client.CreateGetQueryResultsForPolicySetDefinitionPolicyStatesRequest(_subscriptionId, _policyStatesResource, _policySetDefinitionName, _maxCount, _orderBy, _select, _from, _to, _filter, _apply, _skipToken, _context);
