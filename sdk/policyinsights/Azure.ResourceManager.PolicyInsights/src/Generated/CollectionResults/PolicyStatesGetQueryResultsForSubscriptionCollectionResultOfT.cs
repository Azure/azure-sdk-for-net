...
{
    internal partial class PolicyStatesGetQueryResultsForSubscriptionCollectionResultOfT : Pageable<PolicyState>
    {
        ...
        /// <summary> Initializes a new instance of PolicyStatesGetQueryResultsForSubscriptionCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        /// <summary> Gets the pages of PolicyStatesGetQueryResultsForSubscriptionCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of PolicyStatesGetQueryResultsForSubscriptionCollectionResultOfT as an enumerable collection. </returns>
        ...
        {
            HttpMessage message = nextLink != null ? _client.CreateNextGetQueryResultsForSubscriptionRequest(nextLink, _subscriptionId, _policyStatesResource, _maxCount, _orderBy, _select, _from, _to, _filter, _apply, _skipToken, _context) : _client.CreateGetQueryResultsForSubscriptionRequest(_subscriptionId, _policyStatesResource, _maxCount, _orderBy, _select, _from, _to, _filter, _apply, _skipToken, _context);
