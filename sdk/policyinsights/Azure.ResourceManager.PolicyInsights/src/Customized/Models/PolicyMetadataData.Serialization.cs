...
namespace Azure.ResourceManager.PolicyInsights
{
    public partial class PolicyMetadataData
    {
        internal static PolicyMetadataData DeserializePolicyMetadataData(JsonElement element)
        {
            ...
            return new PolicyMetadataData(id, name, type, systemData.Value, metadataId.Value, category.Value, title.Value, owner.Value, additionalContentUrl.Value, additionalContentUrlString.Value, metadata.Value, description.Value, requirements.Value);
        }
    }
}
