...
namespace Azure.ResourceManager.PolicyInsights.Models
{
    public partial class SlimPolicyMetadata
    {
        internal static SlimPolicyMetadata DeserializeSlimPolicyMetadata(JsonElement element)
        {
            ...
            Optional<string> additionalContentUrlString = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        {
                            additionalContentUrlString = property0.Value.GetString();
                            if (property0.Value.ValueKind == JsonValueKind.Null)
                            {
                                additionalContentUrl = null;
                                continue;
                            }
                            if (property0.Value.GetString().StartsWith("http", StringComparison.CurrentCultureIgnoreCase))
                            {
            ...
            return new SlimPolicyMetadata(id, name, type, systemData.Value, metadataId.Value, category.Value, title.Value, owner.Value, additionalContentUrl.Value, additionalContentUrlString.Value, metadata.Value);
        }
    }
}
