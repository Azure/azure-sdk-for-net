...
namespace Azure.ResourceManager.PolicyInsights.Mocking
{
    ...
    public partial class MockablePolicyInsightsSubscriptionPolicyDefinitionResource : ArmResource
    {
        ...
        /// <param name="policyStateSummaryType"> The virtual resource under PolicyStates resource type for summarize action. </param>
        /// <param name="policyQuerySettings"> Optional OData query parameters. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual AsyncPageable<PolicySummary> SummarizePolicyStatesAsync(PolicyStateSummaryType policyStateSummaryType, PolicyQuerySettings policyQuerySettings = default, CancellationToken cancellationToken = default)
        {
            ...
            {
                using DiagnosticScope scope0 = PolicyStatesClientDiagnostics.CreateScope("MockablePolicyInsightsSubscriptionPolicyDefinitionResource.SummarizePolicyStates");
                scope0.Start();
                try
                {
                    RequestContext context = new RequestContext { CancellationToken = ct };
                    HttpMessage message = PolicyStatesRestClient.CreateSummarizeForPolicyDefinitionPolicyStatesRequest(Id.SubscriptionId, policyStateSummaryType.ToString(), Id.Name, default, default, default, default, context);
