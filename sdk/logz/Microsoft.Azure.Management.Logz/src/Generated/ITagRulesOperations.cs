...
namespace Microsoft.Azure.Management.Logz
{
    ...
    public partial interface ITagRulesOperations
    {
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationHeaderResponse<TagRulesDeleteHeaders>> DeleteWithHttpMessagesAsync(string resourceGroupName, string monitorName, string ruleSetName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// List the tag rules for a given monitor resource.
        /// </summary>
