...
namespace Microsoft.Azure.Management.Logz
{
    ...
    /// </summary>
    internal partial class Operations : IServiceOperations<MicrosoftLogzClient>, IOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal Operations(MicrosoftLogzClient client)
        {
            if (client == null)
            {
        ...
        public async Task<AzureOperationResponse<IPage<OperationResult>>> ListWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "providers/Microsoft.Logz/operations").ToString();
