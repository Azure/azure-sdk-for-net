...
namespace Microsoft.Workloads.SAPVirtualInstance.Models
{
    ...
    public partial class ApplicationServerVmDetails
    {
        ...
        /// Initializes a new instance of the ApplicationServerVmDetails class.
        /// </summary>
        /// <param name="type">Possible values include: 'Active', 'Standby',
        /// 'Unknown'</param>
        ...
        public ApplicationServerVmDetails(string type = default(string), string virtualMachineId = default(string), IList<StorageInformation> storageDetails = default(IList<StorageInformation>))
        {
            Type = type;
