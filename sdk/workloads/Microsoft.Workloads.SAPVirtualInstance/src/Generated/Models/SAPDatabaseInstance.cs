...
namespace Microsoft.Workloads.SAPVirtualInstance.Models
{
    ...
    public partial class SAPDatabaseInstance : TrackedResource
    {
        ...
        /// LoadBalancer ID attached to Database Virtual Machines</param>
        ...
        /// resource.</param>
        public SAPDatabaseInstance(string location, string id = default(string), string name = default(string), string type = default(string), SystemData systemData = default(SystemData), IDictionary<string, string> tags = default(IDictionary<string, string>), string subnet = default(string), string databaseSid = default(string), string databaseType = default(string), string ipAddress = default(string), LoadBalancerDetails loadBalancerDetails = default(LoadBalancerDetails), IList<DatabaseVmDetails> vmDetails = default(IList<DatabaseVmDetails>), string status = default(string), string provisioningState = default(string), SAPVirtualInstanceError errors = default(SAPVirtualInstanceError))
