...
namespace Microsoft.Workloads.SAPVirtualInstance.Models
{
    ...
    public partial class DatabaseVmDetails
    {
        ...
        /// AFS Shared Storage.</param>
        public DatabaseVmDetails(string virtualMachineId = default(string), string status = default(string), IList<StorageInformation> storageDetails = default(IList<StorageInformation>))
        {
