...
namespace Microsoft.Workloads.SAPVirtualInstance.Models
{
    ...
    public partial class UpdateSAPVirtualInstanceRequest
    {
        ...
        public UpdateSAPVirtualInstanceRequest(IDictionary<string, string> tags = default(IDictionary<string, string>), UserAssignedServiceIdentity identity = default(UserAssignedServiceIdentity), UpdateSAPVirtualInstanceProperties properties = default(UpdateSAPVirtualInstanceProperties))
        {
            Tags = tags;
            Identity = identity;
