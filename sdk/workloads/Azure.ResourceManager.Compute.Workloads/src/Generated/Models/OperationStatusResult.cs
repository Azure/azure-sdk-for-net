...
namespace Azure.ResourceManager.Compute.Workloads.Models
{
    ...
    public partial class OperationStatusResult
    {
        ...
        internal OperationStatusResult(string id, string name, string status, float? percentComplete, DateTimeOffset? startOn, DateTimeOffset? endOn, IReadOnlyList<OperationStatusResult> operations, ResponseError error)
        {
            Id = id;
            Name = name;
            Status = status;
