...
namespace Microsoft.Workloads.Models
{
    ...
    public partial class UpdateMonitorRequest
    {
        ...
        public UpdateMonitorRequest(IDictionary<string, string> tags = default(IDictionary<string, string>), UserAssignedServiceIdentity identity = default(UserAssignedServiceIdentity))
        {
            Tags = tags;
            Identity = identity;
            CustomInit();
