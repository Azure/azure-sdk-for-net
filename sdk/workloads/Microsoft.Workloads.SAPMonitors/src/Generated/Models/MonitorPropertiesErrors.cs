...
namespace Microsoft.Workloads.SAPMonitors.Models
{
    ...
    public partial class MonitorPropertiesErrors : Error
    {
        ...
        public MonitorPropertiesErrors(string code = default(string), string message = default(string), string target = default(string), IList<Error> details = default(IList<Error>), ErrorInnerError innerError = default(ErrorInnerError))
