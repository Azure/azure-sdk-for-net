...
namespace Azure.ResourceManager.Workloads.Models
{
    ...
    {
        public static Azure.ResourceManager.Workloads.Models.BackupProfile BackupProfile(Azure.ResourceManager.Workloads.Models.EnableBackup backupEnabled = default(Azure.ResourceManager.Workloads.Models.EnableBackup), Azure.Core.ResourceIdentifier vaultResourceId = null) { throw null; }
        public static Azure.ResourceManager.Workloads.Models.CacheProfile CacheProfile(string name = null, string skuName = null, Azure.ResourceManager.Workloads.Models.RedisCacheFamily family = default(Azure.ResourceManager.Workloads.Models.RedisCacheFamily), long capacity = (long)0, Azure.Core.ResourceIdentifier cacheResourceId = null) { throw null; }
        ...
        public static Azure.ResourceManager.Workloads.Models.DatabaseProfile DatabaseProfile(Azure.ResourceManager.Workloads.Models.DatabaseType databaseType = default(Azure.ResourceManager.Workloads.Models.DatabaseType), string serverName = null, string version = null, string sku = null, Azure.ResourceManager.Workloads.Models.DatabaseTier tier = Azure.ResourceManager.Workloads.Models.DatabaseTier.Burstable, Azure.ResourceManager.Workloads.Models.HAEnabled? haEnabled = default(Azure.ResourceManager.Workloads.Models.HAEnabled?), string storageSku = null, long? storageInGB = default(long?), long? storageIops = default(long?), int? backupRetentionDays = default(int?), Azure.ResourceManager.Workloads.Models.EnableSslEnforcement? sslEnforcementEnabled = default(Azure.ResourceManager.Workloads.Models.EnableSslEnforcement?), Azure.Core.ResourceIdentifier serverResourceId = null) { throw null; }
        public static Azure.ResourceManager.Workloads.Models.DatabaseVmDetails DatabaseVmDetails(Azure.Core.ResourceIdentifier virtualMachineId = null, Azure.ResourceManager.Workloads.Models.SapVirtualInstanceStatus? status = default(Azure.ResourceManager.Workloads.Models.SapVirtualInstanceStatus?)) { throw null; }
        public static Azure.ResourceManager.Workloads.Models.DiscoveryConfiguration DiscoveryConfiguration(string centralServerVmId = null, Azure.Core.AzureLocation? appLocation = default(Azure.Core.AzureLocation?)) { throw null; }
        ...
        public static Azure.ResourceManager.Workloads.Models.FileshareProfile FileshareProfile(Azure.ResourceManager.Workloads.Models.FileShareType shareType = default(Azure.ResourceManager.Workloads.Models.FileShareType), Azure.ResourceManager.Workloads.Models.FileShareStorageType storageType = default(Azure.ResourceManager.Workloads.Models.FileShareStorageType), long? shareSizeInGB = default(long?), Azure.Core.ResourceIdentifier storageResourceId = null, string shareName = null) { throw null; }
        ...
        public static Azure.ResourceManager.Workloads.Models.ImageReference ImageReference(string publisher = null, string offer = null, string sku = null, string version = null, string exactVersion = null, string sharedGalleryImageId = null) { throw null; }
        ...
        public static Azure.ResourceManager.Workloads.Models.NetworkProfile NetworkProfile(Azure.ResourceManager.Workloads.Models.LoadBalancerType loadBalancerType = default(Azure.ResourceManager.Workloads.Models.LoadBalancerType), string loadBalancerSku = null, string loadBalancerTier = null, int? capacity = default(int?), Azure.ResourceManager.Workloads.Models.AzureFrontDoorEnabled? azureFrontDoorEnabled = default(Azure.ResourceManager.Workloads.Models.AzureFrontDoorEnabled?), Azure.Core.ResourceIdentifier vNetResourceId = null, Azure.Core.ResourceIdentifier loadBalancerResourceId = null, Azure.Core.ResourceIdentifier azureFrontDoorResourceId = null, Azure.Core.ResourceIdentifier frontEndPublicIPResourceId = null, System.Collections.Generic.IEnumerable<string> outboundPublicIPResourceIds = null) { throw null; }
        public static Azure.ResourceManager.Workloads.Models.NodeProfile NodeProfile(string name = null, string nodeSku = null, Azure.ResourceManager.Workloads.Models.OSImageProfile osImage = null, Azure.ResourceManager.Workloads.Models.DiskInfo osDisk = null, System.Collections.Generic.IEnumerable<Azure.ResourceManager.Workloads.Models.DiskInfo> dataDisks = null, System.Collections.Generic.IEnumerable<Azure.Core.ResourceIdentifier> nodeResourceIds = null) { throw null; }
        public static Azure.ResourceManager.Workloads.PhpWorkloadResourceData PhpWorkloadResourceData(Azure.Core.ResourceIdentifier id = null, string name = null, Azure.Core.ResourceType resourceType = default(Azure.Core.ResourceType), Azure.ResourceManager.Models.SystemData systemData = null, System.Collections.Generic.IDictionary<string, string> tags = null, Azure.Core.AzureLocation location = default(Azure.Core.AzureLocation), Azure.ResourceManager.Workloads.Models.WorkloadKind kind = default(Azure.ResourceManager.Workloads.Models.WorkloadKind), Azure.ResourceManager.Workloads.Models.WorkloadsSku sku = null, Azure.ResourceManager.Workloads.Models.PhpWorkloadResourceIdentity identity = null, Azure.Core.AzureLocation? appLocation = default(Azure.Core.AzureLocation?), string managedResourceGroupName = null, Azure.ResourceManager.Workloads.Models.UserProfile adminUserProfile = null, Azure.ResourceManager.Workloads.Models.VmssNodesProfile webNodesProfile = null, Azure.ResourceManager.Workloads.Models.NodeProfile controllerProfile = null, Azure.ResourceManager.Workloads.Models.NetworkProfile networkProfile = null, Azure.ResourceManager.Workloads.Models.DatabaseProfile databaseProfile = null, string siteDomainName = null, Azure.ResourceManager.Workloads.Models.FileshareProfile fileshareProfile = null, Azure.ResourceManager.Workloads.Models.PhpVersion? phpVersion = default(Azure.ResourceManager.Workloads.Models.PhpVersion?), Azure.ResourceManager.Workloads.Models.SearchProfile searchProfile = null, Azure.ResourceManager.Workloads.Models.CacheProfile cacheProfile = null, Azure.ResourceManager.Workloads.Models.BackupProfile backupProfile = null, Azure.ResourceManager.Workloads.Models.PhpWorkloadProvisioningState? provisioningState = default(Azure.ResourceManager.Workloads.Models.PhpWorkloadProvisioningState?)) { throw null; }
        public static Azure.ResourceManager.Workloads.Models.RestrictionInfo RestrictionInfo(System.Collections.Generic.IEnumerable<Azure.Core.AzureLocation> locations = null, System.Collections.Generic.IEnumerable<string> zones = null) { throw null; }
        public static Azure.ResourceManager.Workloads.SapApplicationServerInstanceData SapApplicationServerInstanceData(Azure.Core.ResourceIdentifier id = null, string name = null, Azure.Core.ResourceType resourceType = default(Azure.Core.ResourceType), Azure.ResourceManager.Models.SystemData systemData = null, System.Collections.Generic.IDictionary<string, string> tags = null, Azure.Core.AzureLocation location = default(Azure.Core.AzureLocation), string instanceNo = null, Azure.Core.ResourceIdentifier subnetId = null, string hostname = null, string kernelVersion = null, string kernelPatch = null, string ipAddress = null, long? gatewayPort = default(long?), long? icmHttpPort = default(long?), long? icmHttpsPort = default(long?), Azure.Core.ResourceIdentifier virtualMachineId = null, Azure.ResourceManager.Workloads.Models.SapVirtualInstanceStatus? status = default(Azure.ResourceManager.Workloads.Models.SapVirtualInstanceStatus?), Azure.ResourceManager.Workloads.Models.SapHealthState? health = default(Azure.ResourceManager.Workloads.Models.SapHealthState?), Azure.ResourceManager.Workloads.Models.SapVirtualInstanceProvisioningState? provisioningState = default(Azure.ResourceManager.Workloads.Models.SapVirtualInstanceProvisioningState?), Azure.ResourceManager.Workloads.Models.SapVirtualInstanceErrorDetail errorsProperties = null) { throw null; }
        ...
        public static Azure.ResourceManager.Workloads.Models.SearchProfile SearchProfile(string name = null, string nodeSku = null, Azure.ResourceManager.Workloads.Models.OSImageProfile osImage = null, Azure.ResourceManager.Workloads.Models.DiskInfo osDisk = null, System.Collections.Generic.IEnumerable<Azure.ResourceManager.Workloads.Models.DiskInfo> dataDisks = null, System.Collections.Generic.IEnumerable<Azure.Core.ResourceIdentifier> nodeResourceIds = null, Azure.ResourceManager.Workloads.Models.SearchType searchType = default(Azure.ResourceManager.Workloads.Models.SearchType)) { throw null; }
        ...
        public static Azure.ResourceManager.Workloads.Models.SkuCapability SkuCapability(string name = null, string value = null) { throw null; }
        public static Azure.ResourceManager.Workloads.Models.SkuCost SkuCost(string meterId = null, int? quantity = default(int?), string extendedUnit = null) { throw null; }
        public static Azure.ResourceManager.Workloads.Models.SkuDefinition SkuDefinition(string name = null, string resourceType = null, string tier = null, string size = null, string family = null, string kind = null, System.Collections.Generic.IEnumerable<Azure.Core.AzureLocation> locations = null, System.Collections.Generic.IEnumerable<Azure.ResourceManager.Workloads.Models.SkuLocationAndZones> locationInfo = null, System.BinaryData capacity = null, System.Collections.Generic.IEnumerable<Azure.ResourceManager.Workloads.Models.SkuCost> costs = null, System.Collections.Generic.IEnumerable<Azure.ResourceManager.Workloads.Models.SkuCapability> capabilities = null, System.Collections.Generic.IEnumerable<Azure.ResourceManager.Workloads.Models.SkuRestriction> restrictions = null) { throw null; }
        public static Azure.ResourceManager.Workloads.Models.SkuLocationAndZones SkuLocationAndZones(Azure.Core.AzureLocation? location = default(Azure.Core.AzureLocation?), System.Collections.Generic.IEnumerable<string> zones = null, System.Collections.Generic.IEnumerable<Azure.ResourceManager.Workloads.Models.SkuZoneDetail> zoneDetails = null, System.Collections.Generic.IEnumerable<string> extendedLocations = null, Azure.ResourceManager.Workloads.Models.LocationType? locationType = default(Azure.ResourceManager.Workloads.Models.LocationType?)) { throw null; }
        public static Azure.ResourceManager.Workloads.Models.SkuRestriction SkuRestriction(Azure.ResourceManager.Workloads.Models.SkuRestrictionType? restrictionType = default(Azure.ResourceManager.Workloads.Models.SkuRestrictionType?), System.Collections.Generic.IEnumerable<string> values = null, Azure.ResourceManager.Workloads.Models.RestrictionInfo restrictionInfo = null, Azure.ResourceManager.Workloads.Models.SkuRestrictionReasonCode? reasonCode = default(Azure.ResourceManager.Workloads.Models.SkuRestrictionReasonCode?)) { throw null; }
        public static Azure.ResourceManager.Workloads.Models.SkuZoneDetail SkuZoneDetail(System.Collections.Generic.IEnumerable<string> zones = null, System.Collections.Generic.IEnumerable<Azure.ResourceManager.Workloads.Models.SkuCapability> capabilities = null) { throw null; }
        ...
        public static Azure.ResourceManager.Workloads.Models.VmssNodesProfile VmssNodesProfile(string name = null, string nodeSku = null, Azure.ResourceManager.Workloads.Models.OSImageProfile osImage = null, Azure.ResourceManager.Workloads.Models.DiskInfo osDisk = null, System.Collections.Generic.IEnumerable<Azure.ResourceManager.Workloads.Models.DiskInfo> dataDisks = null, System.Collections.Generic.IEnumerable<Azure.Core.ResourceIdentifier> nodeResourceIds = null, int? autoScaleMinCount = default(int?), int? autoScaleMaxCount = default(int?)) { throw null; }
        public static Azure.ResourceManager.Workloads.WordPressInstanceResourceData WordPressInstanceResourceData(Azure.Core.ResourceIdentifier id = null, string name = null, Azure.Core.ResourceType resourceType = default(Azure.Core.ResourceType), Azure.ResourceManager.Models.SystemData systemData = null, Azure.ResourceManager.Workloads.Models.WordPressVersion? version = default(Azure.ResourceManager.Workloads.Models.WordPressVersion?), string databaseName = null, string databaseUser = null, System.Uri siteUri = null, Azure.ResourceManager.Workloads.Models.ApplicationProvisioningState? provisioningState = default(Azure.ResourceManager.Workloads.Models.ApplicationProvisioningState?)) { throw null; }
    }
    [System.Runtime.InteropServices.StructLayoutAttribute(System.Runtime.InteropServices.LayoutKind.Sequential)]
