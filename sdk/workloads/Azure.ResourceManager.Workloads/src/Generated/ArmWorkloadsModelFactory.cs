...
namespace Azure.ResourceManager.Workloads.Models
{
    ...
    public static partial class ArmWorkloadsModelFactory
    {
        ...
        {
            return new SapSizingRecommendationContent(appLocation, environment, sapProduct, deploymentType, saps, dbMemory, databaseType, dbScaleMethod, highAvailabilityType, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SapSupportedSkusContent(appLocation, environment, sapProduct, deploymentType, databaseType, highAvailabilityType, new Dictionary<string, BinaryData>());
        }
        ...
        public static SapSupportedResourceSkusResult SapSupportedResourceSkusResult(IEnumerable<SapSupportedSku> supportedSkus = null)
        {
            ...
            return new SapSupportedResourceSkusResult(supportedSkus?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SapSupportedSku(vmSku, isAppServerCertified, isDatabaseCertified, new Dictionary<string, BinaryData>());
        }
        ...
        public static SapDiskConfigurationsResult SapDiskConfigurationsResult(IReadOnlyDictionary<string, SapDiskConfiguration> volumeConfigurations = null)
        {
            ...
            return new SapDiskConfigurationsResult(volumeConfigurations, new Dictionary<string, BinaryData>());
        }
        ...
        public static SapDiskConfiguration SapDiskConfiguration(DiskVolumeConfiguration recommendedConfiguration = null, IEnumerable<SupportedConfigurationsDiskDetails> supportedConfigurations = null)
        {
            ...
            return new SapDiskConfiguration(recommendedConfiguration, supportedConfigurations?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SupportedConfigurationsDiskDetails(skuName != null ? new SapDiskSku(skuName, new Dictionary<string, BinaryData>()) : null, sizeInGB, minimumSupportedDiskCount, maximumSupportedDiskCount, iopsReadWrite, mbpsReadWrite, diskTier, new Dictionary<string, BinaryData>());
        }
        ...
        public static SapAvailabilityZoneDetailsResult SapAvailabilityZoneDetailsResult(IEnumerable<SapAvailabilityZonePair> availabilityZonePairs = null)
        {
            ...
            return new SapAvailabilityZoneDetailsResult(availabilityZonePairs?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SapAvailabilityZonePair(zoneA, zoneB, new Dictionary<string, BinaryData>());
        }
        ...
        public static SapVirtualInstanceData SapVirtualInstanceData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, UserAssignedServiceIdentity identity = null, SapEnvironmentType environment = default, SapProductType sapProduct = default, SapConfiguration configuration = null, string managedResourceGroupName = null, SapVirtualInstanceStatus? status = null, SapHealthState? health = null, SapVirtualInstanceState? state = null, SapVirtualInstanceProvisioningState? provisioningState = null, SapVirtualInstanceErrorDetail errorsProperties = null)
        {
            ...
            return new SapVirtualInstanceData(id, name, resourceType, systemData, tags, location, identity, environment, sapProduct, configuration, managedResourceGroupName != null ? new ManagedRGConfiguration(managedResourceGroupName, new Dictionary<string, BinaryData>()) : null, status, health, state, provisioningState, errorsProperties != null ? new SapVirtualInstanceError(errorsProperties, new Dictionary<string, BinaryData>()) : null, new Dictionary<string, BinaryData>());
        }
        ...
        public static SapVirtualInstanceErrorDetail SapVirtualInstanceErrorDetail(string code = null, string message = null, IEnumerable<SapVirtualInstanceErrorDetail> details = null)
        {
            ...
            return new SapVirtualInstanceErrorDetail(code, message, details?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MessageServerProperties(msPort, internalMsPort, httpPort, httpsPort, hostname, ipAddress, health, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new EnqueueServerProperties(hostname, ipAddress, port, health, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new GatewayServerProperties(port, health, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new EnqueueReplicationServerProperties(ersVersion, instanceNo, hostname, kernelVersion, kernelPatch, ipAddress, health, new Dictionary<string, BinaryData>());
        }
        ...
        public static CentralServerVmDetails CentralServerVmDetails(CentralServerVirtualMachineType? virtualMachineType = null, ResourceIdentifier virtualMachineId = null, IEnumerable<SubResource> storageDetails = null)
        {
            ...
            return new CentralServerVmDetails(virtualMachineType, virtualMachineId, storageDetails?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static DatabaseVmDetails DatabaseVmDetails(ResourceIdentifier virtualMachineId = null, SapVirtualInstanceStatus? status = null, IEnumerable<SubResource> storageDetails = null)
        {
            ...
            return new DatabaseVmDetails(virtualMachineId, status, storageDetails?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static ApplicationServerVmDetails ApplicationServerVmDetails(ApplicationServerVirtualMachineType? virtualMachineType = null, ResourceIdentifier virtualMachineId = null, IEnumerable<SubResource> storageDetails = null)
        {
            ...
            return new ApplicationServerVmDetails(virtualMachineType, virtualMachineId, storageDetails?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static SapMonitorData SapMonitorData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, UserAssignedServiceIdentity identity = null, WorkloadMonitorProvisioningState? provisioningState = null, ResponseError errors = null, AzureLocation? appLocation = null, SapRoutingPreference? routingPreference = null, string zoneRedundancyPreference = null, string managedResourceGroupName = null, ResourceIdentifier logAnalyticsWorkspaceArmId = null, ResourceIdentifier monitorSubnetId = null, ResourceIdentifier msiArmId = null, ResourceIdentifier storageAccountArmId = null)
        {
            ...
            return new SapMonitorData(id, name, resourceType, systemData, tags, location, identity, provisioningState, errors, appLocation, routingPreference, zoneRedundancyPreference, managedResourceGroupName != null ? new ManagedRGConfiguration(managedResourceGroupName, new Dictionary<string, BinaryData>()) : null, logAnalyticsWorkspaceArmId, monitorSubnetId, msiArmId, storageAccountArmId, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SapProviderInstanceData(id, name, resourceType, systemData, identity, provisioningState, errors, providerSettings, new Dictionary<string, BinaryData>());
        }
        ...
        public static SapLandscapeMonitorData SapLandscapeMonitorData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, SapLandscapeMonitorProvisioningState? provisioningState = null, SapLandscapeMonitorPropertiesGrouping grouping = null, IEnumerable<SapLandscapeMonitorMetricThresholds> topMetricsThresholds = null)
        {
            ...
            return new SapLandscapeMonitorData(id, name, resourceType, systemData, provisioningState, grouping, topMetricsThresholds?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SingleServerRecommendationResult(SapDeploymentType.SingleServer, new Dictionary<string, BinaryData>(), vmSku);
        }
        ...
        {
            return new ThreeTierRecommendationResult(SapDeploymentType.ThreeTier, new Dictionary<string, BinaryData>(), dbVmSku, databaseInstanceCount, centralServerVmSku, centralServerInstanceCount, applicationServerVmSku, applicationServerInstanceCount);
        }
        ...
        {
            return new DiscoveryConfiguration(SapConfigurationType.Discovery, new Dictionary<string, BinaryData>(), centralServerVmId, managedRgStorageAccountName, appLocation);
        }
    }
}
