...
namespace Azure.ResourceManager.Workloads.Models
{
    ...
    public static partial class ArmWorkloadsModelFactory
    {
        ...
        {
            return new SapSizingRecommendationContent(appLocation, environment, sapProduct, deploymentType, saps, dbMemory, databaseType, dbScaleMethod, highAvailabilityType, default);
        }
        ...
        {
            return new SapSupportedSkusContent(appLocation, environment, sapProduct, deploymentType, databaseType, highAvailabilityType, default);
        }
        ...
        public static SapSupportedResourceSkusResult SapSupportedResourceSkusResult(IEnumerable<SapSupportedSku> supportedSkus = null)
        {
            ...
            return new SapSupportedResourceSkusResult(supportedSkus?.ToList(), default);
        }
        ...
        public static SapDiskConfigurationsResult SapDiskConfigurationsResult(IReadOnlyDictionary<string, SapDiskConfiguration> volumeConfigurations = null)
        {
            ...
            return new SapDiskConfigurationsResult(volumeConfigurations, default);
        }
        ...
        public static SapDiskConfiguration SapDiskConfiguration(DiskVolumeConfiguration recommendedConfiguration = null, IEnumerable<SupportedConfigurationsDiskDetails> supportedConfigurations = null)
        {
            ...
            return new SapDiskConfiguration(recommendedConfiguration, supportedConfigurations?.ToList(), default);
        }
        ...
        {
            return new SupportedConfigurationsDiskDetails(skuName != null ? new SapDiskSku(skuName, new Dictionary<string, BinaryData>()) : null, sizeInGB, minimumSupportedDiskCount, maximumSupportedDiskCount, iopsReadWrite, mbpsReadWrite, diskTier, default);
        }
        ...
        public static SapAvailabilityZoneDetailsResult SapAvailabilityZoneDetailsResult(IEnumerable<SapAvailabilityZonePair> availabilityZonePairs = null)
        {
            ...
            return new SapAvailabilityZoneDetailsResult(availabilityZonePairs?.ToList(), default);
        }
        ...
        public static SapVirtualInstanceErrorDetail SapVirtualInstanceErrorDetail(string code = null, string message = null, IEnumerable<SapVirtualInstanceErrorDetail> details = null)
        {
            ...
            return new SapVirtualInstanceErrorDetail(code, message, details?.ToList(), default);
        }
        ...
        {
            return new MessageServerProperties(msPort, internalMsPort, httpPort, httpsPort, hostname, ipAddress, health, default);
        }
        ...
        {
            return new EnqueueReplicationServerProperties(ersVersion, instanceNo, hostname, kernelVersion, kernelPatch, ipAddress, health, default);
        }
        ...
        public static CentralServerVmDetails CentralServerVmDetails(CentralServerVirtualMachineType? virtualMachineType = null, ResourceIdentifier virtualMachineId = null, IEnumerable<SubResource> storageDetails = null)
        {
            ...
            return new CentralServerVmDetails(virtualMachineType, virtualMachineId, storageDetails?.ToList(), default);
        }
        ...
        public static DatabaseVmDetails DatabaseVmDetails(ResourceIdentifier virtualMachineId = null, SapVirtualInstanceStatus? status = null, IEnumerable<SubResource> storageDetails = null)
        {
            ...
            return new DatabaseVmDetails(virtualMachineId, status, storageDetails?.ToList(), default);
        }
        ...
        public static ApplicationServerVmDetails ApplicationServerVmDetails(ApplicationServerVirtualMachineType? virtualMachineType = null, ResourceIdentifier virtualMachineId = null, IEnumerable<SubResource> storageDetails = null)
        {
            ...
            return new ApplicationServerVmDetails(virtualMachineType, virtualMachineId, storageDetails?.ToList(), default);
        }
        ...
        {
            return new SapProviderInstanceData(id, name, resourceType, systemData, identity, provisioningState, errors, providerSettings, default);
        }
        ...
        public static SapLandscapeMonitorData SapLandscapeMonitorData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, SapLandscapeMonitorProvisioningState? provisioningState = null, SapLandscapeMonitorPropertiesGrouping grouping = null, IEnumerable<SapLandscapeMonitorMetricThresholds> topMetricsThresholds = null)
        {
            ...
            return new SapLandscapeMonitorData(id, name, resourceType, systemData, provisioningState, grouping, topMetricsThresholds?.ToList(), default);
        }
        ...
        {
            return new SingleServerRecommendationResult(SapDeploymentType.SingleServer, vmSku, default);
        }
        ...
        {
            return new ThreeTierRecommendationResult(SapDeploymentType.ThreeTier, dbVmSku, databaseInstanceCount, centralServerVmSku, centralServerInstanceCount, applicationServerVmSku, applicationServerInstanceCount, default);
        }
        ...
        {
            return new DiscoveryConfiguration(SapConfigurationType.Discovery, centralServerVmId, managedRgStorageAccountName, appLocation, default);
        }
    }
}
