...
namespace Azure.ResourceManager.Workloads
{
    ...
    public partial class SapApplicationServerInstanceResource : ArmResource
    {
        ...
        internal SapApplicationServerInstanceResource(ArmClient client, SapApplicationServerInstanceData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<SapApplicationServerInstanceResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
                {
                    ...
                    return Response.FromValue(new SapApplicationServerInstanceResource(Client, originalResponse.Value, originalResponse.Value.Id), originalResponse.GetRawResponse());
                }
                else
                {
