...
namespace Azure.ResourceManager.Workloads
{
    ...
    public partial class SapProviderInstanceData : ResourceData
    {
        ...
        internal SapProviderInstanceData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, UserAssignedServiceIdentity identity, WorkloadMonitorProvisioningState? provisioningState, ResponseError errors, ProviderSpecificProperties providerSettings, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData)
        {
            Identity = identity;
