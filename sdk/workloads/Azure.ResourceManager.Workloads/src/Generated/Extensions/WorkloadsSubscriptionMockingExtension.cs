...
namespace Azure.ResourceManager.Workloads.Mocking
{
    ...
    public partial class WorkloadsSubscriptionMockingExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="WorkloadsSubscriptionMockingExtension"/> class for mocking. </summary>
        protected WorkloadsSubscriptionMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="WorkloadsSubscriptionMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal WorkloadsSubscriptionMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        {
            using var scope = DefaultClientDiagnostics.CreateScope("WorkloadsSubscriptionMockingExtension.SapSizingRecommendations");
            scope.Start();
            try
            {
        ...
        {
            using var scope = DefaultClientDiagnostics.CreateScope("WorkloadsSubscriptionMockingExtension.SapSupportedSku");
            scope.Start();
            try
            {
        ...
        {
            using var scope = DefaultClientDiagnostics.CreateScope("WorkloadsSubscriptionMockingExtension.SapDiskConfigurations");
            scope.Start();
            try
            {
        ...
        {
            using var scope = DefaultClientDiagnostics.CreateScope("WorkloadsSubscriptionMockingExtension.SapAvailabilityZoneDetails");
            scope.Start();
            try
            {
        ...
        public virtual AsyncPageable<SapMonitorResource> GetSapMonitorsAsync(CancellationToken cancellationToken = default)
        {
            ...
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new SapMonitorResource(Client, SapMonitorData.DeserializeSapMonitorData(e)), SapMonitormonitorsClientDiagnostics, Pipeline, "WorkloadsSubscriptionMockingExtension.GetSapMonitors", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<SapMonitorResource> GetSapMonitors(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => SapMonitormonitorsRestClient.CreateListRequest(Id.SubscriptionId);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => SapMonitormonitorsRestClient.CreateListNextPageRequest(nextLink, Id.SubscriptionId);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new SapMonitorResource(Client, SapMonitorData.DeserializeSapMonitorData(e)), SapMonitormonitorsClientDiagnostics, Pipeline, "WorkloadsSubscriptionMockingExtension.GetSapMonitors", "value", "nextLink", cancellationToken);
        }
    }
}
