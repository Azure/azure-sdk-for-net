...
namespace Azure.ResourceManager.Workloads.Mock
{
    ...
    public partial class SapVirtualInstanceResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="SapVirtualInstanceResourceExtension"/> class for mocking. </summary>
        protected SapVirtualInstanceResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="SapVirtualInstanceResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal SapVirtualInstanceResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
