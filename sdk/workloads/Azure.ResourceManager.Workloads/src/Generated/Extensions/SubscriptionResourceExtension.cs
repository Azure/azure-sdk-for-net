...
namespace Azure.ResourceManager.Workloads.Mock
{
    ...
    public partial class SubscriptionResourceExtension : ArmResource
    {
        ...
        {
            using var scope = DefaultClientDiagnostics.CreateScope("SubscriptionResourceExtension.SapSizingRecommendations");
            scope.Start();
            try
            {
        ...
        {
            using var scope = DefaultClientDiagnostics.CreateScope("SubscriptionResourceExtension.SapSupportedSku");
            scope.Start();
            try
            {
        ...
        {
            using var scope = DefaultClientDiagnostics.CreateScope("SubscriptionResourceExtension.SapDiskConfigurations");
            scope.Start();
            try
            {
        ...
        {
            using var scope = DefaultClientDiagnostics.CreateScope("SubscriptionResourceExtension.SapAvailabilityZoneDetails");
            scope.Start();
            try
            {
