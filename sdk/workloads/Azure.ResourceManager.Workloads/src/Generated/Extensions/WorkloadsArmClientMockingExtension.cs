...
namespace Azure.ResourceManager.Workloads.Mocking
{
    ...
    internal partial class WorkloadsArmClientMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="WorkloadsArmClientMockingExtension"/> class for mocking. </summary>
        protected WorkloadsArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="WorkloadsArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal WorkloadsArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal WorkloadsArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
