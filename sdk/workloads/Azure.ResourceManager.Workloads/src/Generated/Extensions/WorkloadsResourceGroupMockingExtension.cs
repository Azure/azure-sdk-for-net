...
namespace Azure.ResourceManager.Workloads.Mocking
{
    ...
    internal partial class WorkloadsResourceGroupMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="WorkloadsResourceGroupMockingExtension"/> class for mocking. </summary>
        protected WorkloadsResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="WorkloadsResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal WorkloadsResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
