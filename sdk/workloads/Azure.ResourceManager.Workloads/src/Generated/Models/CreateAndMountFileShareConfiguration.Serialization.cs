...
namespace Azure.ResourceManager.Workloads.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CreateAndMountFileShareConfiguration>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CreateAndMountFileShareConfiguration>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CreateAndMountFileShareConfiguration>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CreateAndMountFileShareConfiguration>)} interface");
            }
        ...
        string IPersistableModel<CreateAndMountFileShareConfiguration>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
