...
namespace Azure.ResourceManager.Workloads.Models
{
    ...
    public partial class SapDiskConfigurationsContent
    {
        ...
        internal SapDiskConfigurationsContent(AzureLocation appLocation, SapEnvironmentType environment, SapProductType sapProduct, SapDatabaseType databaseType, SapDeploymentType deploymentType, string dbVmSku, Dictionary<string, BinaryData> rawData)
        {
            AppLocation = appLocation;
            Environment = environment;
            SapProduct = sapProduct;
