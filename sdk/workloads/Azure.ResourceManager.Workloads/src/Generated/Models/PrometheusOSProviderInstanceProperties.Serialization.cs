...
namespace Azure.ResourceManager.Workloads.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PrometheusOSProviderInstanceProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PrometheusOSProviderInstanceProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PrometheusOSProviderInstanceProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PrometheusOSProviderInstanceProperties>)} interface");
            }
        ...
        string IPersistableModel<PrometheusOSProviderInstanceProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
