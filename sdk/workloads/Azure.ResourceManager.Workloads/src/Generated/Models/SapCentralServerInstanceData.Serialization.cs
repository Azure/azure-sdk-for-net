...
namespace Azure.ResourceManager.Workloads
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SapCentralServerInstanceData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SapCentralServerInstanceData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SapCentralServerInstanceData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SapCentralServerInstanceData>)} interface");
            }
        ...
        string IPersistableModel<SapCentralServerInstanceData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
