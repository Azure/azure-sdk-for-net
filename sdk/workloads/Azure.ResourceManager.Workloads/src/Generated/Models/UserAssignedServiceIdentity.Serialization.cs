...
{
    public partial class UserAssignedServiceIdentity : IUtf8JsonSerializable, IJsonModel<UserAssignedServiceIdentity>, IPersistableModel<UserAssignedServiceIdentity>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  type:");
                builder.AppendLine($" '{ManagedServiceIdentityType.ToString()}'");
            }
