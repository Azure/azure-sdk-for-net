...
namespace Azure.ResourceManager.Workloads.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SapNetWeaverProviderInstanceProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SapNetWeaverProviderInstanceProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SapNetWeaverProviderInstanceProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SapNetWeaverProviderInstanceProperties>)} interface");
            }
        ...
        string IPersistableModel<SapNetWeaverProviderInstanceProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
