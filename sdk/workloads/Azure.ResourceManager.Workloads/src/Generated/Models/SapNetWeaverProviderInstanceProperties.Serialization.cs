    ...
    public partial class SapNetWeaverProviderInstanceProperties : IUtf8JsonSerializable, IJsonModel<SapNetWeaverProviderInstanceProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SapHostname))
            {
                ...
                if (SapHostname.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(SapInstanceNr))
            {
                ...
                if (SapInstanceNr.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(SapUsername))
            {
                ...
                if (SapUsername.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(SapPassword))
            {
                ...
                if (SapPassword.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(SapClientId))
            {
                ...
                if (SapClientId.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(SapPortNumber))
            {
                ...
                if (SapPortNumber.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
