...
namespace Azure.ResourceManager.Workloads
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SapDatabaseInstanceData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SapDatabaseInstanceData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SapDatabaseInstanceData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SapDatabaseInstanceData>)} interface");
            }
        ...
        string IPersistableModel<SapDatabaseInstanceData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
