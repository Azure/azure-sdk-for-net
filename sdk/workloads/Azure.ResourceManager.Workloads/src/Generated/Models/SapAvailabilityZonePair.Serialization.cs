...
{
    public partial class SapAvailabilityZonePair : IUtf8JsonSerializable, IJsonModel<SapAvailabilityZonePair>, IPersistableModel<SapAvailabilityZonePair>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ZoneA))
            {
                builder.Append("  zoneA:");
                builder.AppendLine($" '{ZoneA.Value.ToString()}'");
            }

            if (Optional.IsDefined(ZoneB))
            {
                builder.Append("  zoneB:");
                builder.AppendLine($" '{ZoneB.Value.ToString()}'");
            }
