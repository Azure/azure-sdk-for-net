...
namespace Azure.ResourceManager.Workloads.Models
{
    ...
    public partial class EnqueueServerProperties
    {
        ...
        internal EnqueueServerProperties(string hostname, string ipAddress, long? port, SapHealthState? health, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Hostname = hostname;
            IPAddress = ipAddress;
            Port = port;
