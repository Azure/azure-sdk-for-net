...
namespace Azure.ResourceManager.Workloads.Models
{
    ...
    public partial class PrometheusOSProviderInstanceProperties : ProviderSpecificProperties
    {
        ...
        internal PrometheusOSProviderInstanceProperties(string providerType, Uri prometheusUri, SapSslPreference? sslPreference, Uri sslCertificateUri, string sapSid, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(providerType, serializedAdditionalRawData)
        {
