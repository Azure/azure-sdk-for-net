...
namespace Azure.ResourceManager.Workloads.Models
{
    public partial class SapVirtualInstancePatch : IUtf8JsonSerializable, IJsonModel<SapVirtualInstancePatch>
    {
        ...
        void IJsonModel<SapVirtualInstancePatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(SapVirtualInstancePatch)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<SapVirtualInstancePatch>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(SapVirtualInstancePatch)} does not support '{options.Format}' format.");
            }
        }
