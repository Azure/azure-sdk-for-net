...
{
    public partial class SapDiskConfiguration : IUtf8JsonSerializable, IJsonModel<SapDiskConfiguration>, IPersistableModel<SapDiskConfiguration>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(RecommendedConfiguration))
            {
                builder.Append("  recommendedConfiguration:");
                AppendChildObject(builder, RecommendedConfiguration, options, 2);
            }

            if (Optional.IsCollectionDefined(SupportedConfigurations))
            {
                builder.Append("  supportedConfigurations:");
                builder.AppendLine(" [");
                foreach (var item in SupportedConfigurations)
                {
