...
{
    public partial class DeploymentConfiguration : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static DeploymentConfiguration DeserializeDeploymentConfiguration(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
