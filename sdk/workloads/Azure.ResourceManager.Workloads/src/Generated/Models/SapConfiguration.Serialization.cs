...
{
    public partial class SapConfiguration : IUtf8JsonSerializable, IModelJsonSerializable<SapConfiguration>
    {
        ...
        internal static SapConfiguration DeserializeSapConfiguration(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new UnknownSapConfiguration(configurationType, rawData);
        }
        ...
        /// <summary> Converts a <see cref="SapConfiguration"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="SapConfiguration"/> to convert. </param>
        public static implicit operator RequestContent(SapConfiguration model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="SapConfiguration"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator SapConfiguration(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeSapConfiguration(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
