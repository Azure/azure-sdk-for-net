...
namespace Azure.ResourceManager.Workloads.Models
{
    ...
    public partial class HighAvailabilitySoftwareConfiguration
    {
        ...
        internal HighAvailabilitySoftwareConfiguration(string fencingClientId, string fencingClientPassword, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            FencingClientId = fencingClientId;
            FencingClientPassword = fencingClientPassword;
