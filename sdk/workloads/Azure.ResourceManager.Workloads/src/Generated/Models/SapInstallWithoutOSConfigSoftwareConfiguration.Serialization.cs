...
namespace Azure.ResourceManager.Workloads.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SapInstallWithoutOSConfigSoftwareConfiguration>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<SapInstallWithoutOSConfigSoftwareConfiguration>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SapInstallWithoutOSConfigSoftwareConfiguration>)} interface");
            }
        ...
        string IPersistableModel<SapInstallWithoutOSConfigSoftwareConfiguration>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
