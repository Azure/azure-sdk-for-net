...
namespace Azure.ResourceManager.Workloads.Models
{
    ...
    public partial class SapVirtualMachineConfiguration
    {
        ...
        internal SapVirtualMachineConfiguration(string vmSize, SapImageReference imageReference, SapOSProfile osProfile, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            VmSize = vmSize;
            ImageReference = imageReference;
            OSProfile = osProfile;
