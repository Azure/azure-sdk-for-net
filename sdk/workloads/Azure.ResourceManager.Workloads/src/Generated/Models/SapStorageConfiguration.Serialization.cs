...
{
    internal partial class SapStorageConfiguration : IUtf8JsonSerializable, IJsonModel<SapStorageConfiguration>, IPersistableModel<SapStorageConfiguration>
    {
        ...
        void IJsonModel<SapStorageConfiguration>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SapStorageConfiguration)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(TransportFileShareConfiguration))
            {
                builder.Append("  transportFileShareConfiguration:");
                AppendChildObject(builder, TransportFileShareConfiguration, options, 2);
            }
