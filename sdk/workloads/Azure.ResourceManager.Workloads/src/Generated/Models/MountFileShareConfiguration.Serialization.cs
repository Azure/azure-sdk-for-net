...
{
    public partial class MountFileShareConfiguration : IUtf8JsonSerializable, IJsonModel<MountFileShareConfiguration>, IPersistableModel<MountFileShareConfiguration>
    {
        ...
        void IJsonModel<MountFileShareConfiguration>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MountFileShareConfiguration)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(FileShareId))
            {
                builder.Append("  id:");
                builder.AppendLine($" '{FileShareId.ToString()}'");
            }

            if (Optional.IsDefined(PrivateEndpointId))
            {
                builder.Append("  privateEndpointId:");
                builder.AppendLine($" '{PrivateEndpointId.ToString()}'");
            }
