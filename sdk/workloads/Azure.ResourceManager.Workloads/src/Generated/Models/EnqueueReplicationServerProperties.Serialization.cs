...
{
    public partial class EnqueueReplicationServerProperties : IUtf8JsonSerializable, IJsonModel<EnqueueReplicationServerProperties>, IPersistableModel<EnqueueReplicationServerProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ErsVersion))
            {
                ...
                builder.AppendLine($" '{ErsVersion.ToString()}'");
            }
