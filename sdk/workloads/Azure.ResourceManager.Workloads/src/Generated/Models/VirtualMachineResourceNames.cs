...
namespace Azure.ResourceManager.Workloads.Models
{
    ...
    public partial class VirtualMachineResourceNames
    {
        ...
        internal VirtualMachineResourceNames(string vmName, string hostName, IList<NetworkInterfaceResourceNames> networkInterfaces, string osDiskName, IDictionary<string, IList<string>> dataDiskNames, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            VmName = vmName;
            HostName = hostName;
