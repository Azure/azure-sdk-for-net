...
namespace Azure.ResourceManager.Workloads.Models
{
    ...
    public partial class ApplicationServerConfiguration
    {
        ...
        internal ApplicationServerConfiguration(ResourceIdentifier subnetId, SapVirtualMachineConfiguration virtualMachineConfiguration, long instanceCount, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            SubnetId = subnetId;
            VirtualMachineConfiguration = virtualMachineConfiguration;
            InstanceCount = instanceCount;
