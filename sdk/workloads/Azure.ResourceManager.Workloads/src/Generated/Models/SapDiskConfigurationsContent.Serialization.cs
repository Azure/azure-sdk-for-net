...
namespace Azure.ResourceManager.Workloads.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SapDiskConfigurationsContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SapDiskConfigurationsContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SapDiskConfigurationsContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<SapDiskConfigurationsContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
