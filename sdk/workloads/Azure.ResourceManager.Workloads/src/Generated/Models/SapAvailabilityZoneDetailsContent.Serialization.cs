...
namespace Azure.ResourceManager.Workloads.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SapAvailabilityZoneDetailsContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SapAvailabilityZoneDetailsContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SapAvailabilityZoneDetailsContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<SapAvailabilityZoneDetailsContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
