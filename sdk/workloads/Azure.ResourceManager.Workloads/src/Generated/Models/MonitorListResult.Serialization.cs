...
namespace Azure.ResourceManager.Workloads.Models
{
    internal partial class MonitorListResult : IUtf8JsonSerializable, IJsonModel<MonitorListResult>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<MonitorListResult>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MonitorListResult>)} interface");
            }
