...
{
    public partial class SapAvailabilityZoneDetailsResult : IUtf8JsonSerializable, IJsonModel<SapAvailabilityZoneDetailsResult>, IPersistableModel<SapAvailabilityZoneDetailsResult>
    {
        ...
        void IJsonModel<SapAvailabilityZoneDetailsResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SapAvailabilityZoneDetailsResult)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(AvailabilityZonePairs))
            {
                builder.Append("  availabilityZonePairs:");
                builder.AppendLine(" [");
                foreach (var item in AvailabilityZonePairs)
                {
