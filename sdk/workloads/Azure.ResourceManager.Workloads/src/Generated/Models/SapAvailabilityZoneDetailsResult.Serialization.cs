...
namespace Azure.ResourceManager.Workloads.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SapAvailabilityZoneDetailsResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SapAvailabilityZoneDetailsResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SapAvailabilityZoneDetailsResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SapAvailabilityZoneDetailsResult>)} interface");
            }
        ...
        string IPersistableModel<SapAvailabilityZoneDetailsResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
