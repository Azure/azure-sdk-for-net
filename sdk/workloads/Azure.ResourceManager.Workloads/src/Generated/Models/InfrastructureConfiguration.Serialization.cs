...
{
    public partial class InfrastructureConfiguration : IUtf8JsonSerializable, IModelJsonSerializable<InfrastructureConfiguration>
    {
        ...
        internal static InfrastructureConfiguration DeserializeInfrastructureConfiguration(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new UnknownInfrastructureConfiguration(deploymentType, appResourceGroup, rawData);
        }
        ...
        /// <summary> Converts a <see cref="InfrastructureConfiguration"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="InfrastructureConfiguration"/> to convert. </param>
        public static implicit operator RequestContent(InfrastructureConfiguration model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="InfrastructureConfiguration"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator InfrastructureConfiguration(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeInfrastructureConfiguration(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
