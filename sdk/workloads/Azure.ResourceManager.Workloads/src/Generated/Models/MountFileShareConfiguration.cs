...
namespace Azure.ResourceManager.Workloads.Models
{
    ...
    public partial class MountFileShareConfiguration : FileShareConfiguration
    {
        ...
        internal MountFileShareConfiguration(ConfigurationType configurationType, ResourceIdentifier fileShareId, ResourceIdentifier privateEndpointId, Dictionary<string, BinaryData> rawData) : base(configurationType, rawData)
        {
            FileShareId = fileShareId;
            PrivateEndpointId = privateEndpointId;
