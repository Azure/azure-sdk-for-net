...
{
    public partial class LoadBalancerResourceNames : IUtf8JsonSerializable, IJsonModel<LoadBalancerResourceNames>, IPersistableModel<LoadBalancerResourceNames>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(LoadBalancerName))
            {
                ...
                builder.AppendLine($" '{LoadBalancerName}'");
            }

            if (Optional.IsCollectionDefined(FrontendIPConfigurationNames))
            {
                builder.Append("  frontendIpConfigurationNames:");
                builder.AppendLine(" [");
                foreach (var item in FrontendIPConfigurationNames)
                {
                    if (item == null)
            ...
            if (Optional.IsCollectionDefined(BackendPoolNames))
            {
                builder.Append("  backendPoolNames:");
                builder.AppendLine(" [");
                foreach (var item in BackendPoolNames)
                {
                    if (item == null)
            ...
            if (Optional.IsCollectionDefined(HealthProbeNames))
            {
                builder.Append("  healthProbeNames:");
                builder.AppendLine(" [");
                foreach (var item in HealthProbeNames)
                {
                    if (item == null)
