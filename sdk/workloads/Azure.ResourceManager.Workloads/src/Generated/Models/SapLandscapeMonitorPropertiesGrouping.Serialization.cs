...
namespace Azure.ResourceManager.Workloads.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SapLandscapeMonitorPropertiesGrouping>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SapLandscapeMonitorPropertiesGrouping>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SapLandscapeMonitorPropertiesGrouping>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SapLandscapeMonitorPropertiesGrouping>)} interface");
            }
        ...
        SapLandscapeMonitorPropertiesGrouping IJsonModel<SapLandscapeMonitorPropertiesGrouping>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        SapLandscapeMonitorPropertiesGrouping IPersistableModel<SapLandscapeMonitorPropertiesGrouping>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == "J" || options.Format == "W";
            if (!isValid)
            {
        ...
        string IPersistableModel<SapLandscapeMonitorPropertiesGrouping>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
