...
namespace Azure.ResourceManager.Workloads.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SapDatabaseInstanceList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SapDatabaseInstanceList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SapDatabaseInstanceList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SapDatabaseInstanceList>)} interface");
            }
        ...
        string IPersistableModel<SapDatabaseInstanceList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
