...
namespace Azure.ResourceManager.Workloads.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SapDiskSku>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<SapDiskSku>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(SapDiskSku)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<SapDiskSku>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(SapDiskSku)} does not support '{options.Format}' format.");
            }
        }
