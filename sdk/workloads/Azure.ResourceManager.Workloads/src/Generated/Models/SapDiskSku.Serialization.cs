...
{
    internal partial class SapDiskSku : IUtf8JsonSerializable, IJsonModel<SapDiskSku>, IPersistableModel<SapDiskSku>
    {
        ...
        void IJsonModel<SapDiskSku>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SapDiskSku)} does not support '{format}' format.");
            }
