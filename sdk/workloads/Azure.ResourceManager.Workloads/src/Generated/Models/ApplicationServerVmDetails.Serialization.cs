...
{
    public partial class ApplicationServerVmDetails : IUtf8JsonSerializable, IJsonModel<ApplicationServerVmDetails>, IPersistableModel<ApplicationServerVmDetails>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  type:");
                builder.AppendLine($" '{VirtualMachineType.ToString()}'");
            }
