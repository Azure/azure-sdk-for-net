...
namespace Azure.ResourceManager.Workloads.Models
{
    ...
    {
        internal static ApplicationServerVmDetails DeserializeApplicationServerVmDetails(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
