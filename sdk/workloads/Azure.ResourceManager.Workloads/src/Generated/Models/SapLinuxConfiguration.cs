...
namespace Azure.ResourceManager.Workloads.Models
{
    ...
    public partial class SapLinuxConfiguration : SapOSConfiguration
    {
        ...
        internal SapLinuxConfiguration(SapOSType osType, bool? disablePasswordAuthentication, SapSshConfiguration ssh, SapSshKeyPair sshKeyPair, Dictionary<string, BinaryData> rawData) : base(osType, rawData)
        {
