...
namespace Azure.ResourceManager.Workloads.Models
{
    ...
    public partial class SingleServerRecommendationResult : SapSizingRecommendationResult
    {
        ...
        internal SingleServerRecommendationResult(SapDeploymentType deploymentType, string vmSku, Dictionary<string, BinaryData> rawData) : base(deploymentType, rawData)
        {
            VmSku = vmSku;
