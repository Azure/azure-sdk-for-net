...
namespace Azure.ResourceManager.Workloads.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SapMonitorPatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SapMonitorPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SapMonitorPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SapMonitorPatch>)} interface");
            }
        ...
        string IPersistableModel<SapMonitorPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
