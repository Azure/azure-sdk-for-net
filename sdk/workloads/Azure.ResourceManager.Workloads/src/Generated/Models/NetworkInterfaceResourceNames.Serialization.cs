...
{
    public partial class NetworkInterfaceResourceNames : IUtf8JsonSerializable, IJsonModel<NetworkInterfaceResourceNames>, IPersistableModel<NetworkInterfaceResourceNames>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(NetworkInterfaceName))
            {
                builder.Append("  networkInterfaceName:");
                builder.AppendLine($" '{NetworkInterfaceName}'");
            }
