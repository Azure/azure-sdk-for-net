...
{
    public partial class OSSapConfiguration : IUtf8JsonSerializable, IJsonModel<OSSapConfiguration>, IPersistableModel<OSSapConfiguration>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(DeployerVmPackages))
            {
                builder.Append("  deployerVmPackages:");
                AppendChildObject(builder, DeployerVmPackages, options, 2);
            }
