...
{
    public partial class DatabaseConfiguration : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static DatabaseConfiguration DeserializeDatabaseConfiguration(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
