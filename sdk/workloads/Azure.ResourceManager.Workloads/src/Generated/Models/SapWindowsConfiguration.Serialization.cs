...
{
    public partial class SapWindowsConfiguration : IUtf8JsonSerializable, IJsonModel<SapWindowsConfiguration>, IPersistableModel<SapWindowsConfiguration>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SapWindowsConfiguration>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<SapWindowsConfiguration>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SapWindowsConfiguration)} does not support '{format}' format.");
            }
