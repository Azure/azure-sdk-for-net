...
namespace Azure.ResourceManager.Workloads.Models
{
    ...
    public partial class SapSupportedSkusContent
    {
        ...
        internal SapSupportedSkusContent(AzureLocation appLocation, SapEnvironmentType environment, SapProductType sapProduct, SapDeploymentType deploymentType, SapDatabaseType databaseType, SapHighAvailabilityType? highAvailabilityType, Dictionary<string, BinaryData> rawData)
        {
            AppLocation = appLocation;
            Environment = environment;
            SapProduct = sapProduct;
