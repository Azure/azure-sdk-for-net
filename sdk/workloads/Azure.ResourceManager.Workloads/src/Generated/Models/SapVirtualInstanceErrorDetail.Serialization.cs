...
namespace Azure.ResourceManager.Workloads.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SapVirtualInstanceErrorDetail>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SapVirtualInstanceErrorDetail>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SapVirtualInstanceErrorDetail>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SapVirtualInstanceErrorDetail>)} interface");
            }
        ...
        string IPersistableModel<SapVirtualInstanceErrorDetail>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
