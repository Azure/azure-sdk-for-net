    ...
    public partial class DeploymentWithOSConfiguration : IUtf8JsonSerializable, IJsonModel<DeploymentWithOSConfiguration>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(InfrastructureConfiguration))
            {
                ...
                AppendChildObject(builder, InfrastructureConfiguration, options, 2, false);
            }

            if (Optional.IsDefined(SoftwareConfiguration))
            {
                builder.Append("  softwareConfiguration:");
                AppendChildObject(builder, SoftwareConfiguration, options, 2, false);
            }

            if (Optional.IsDefined(OSSapConfiguration))
            {
                builder.Append("  osSapConfiguration:");
                AppendChildObject(builder, OSSapConfiguration, options, 2, false);
            }
