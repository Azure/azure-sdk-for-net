...
{
    public partial class DeploymentWithOSConfiguration : IUtf8JsonSerializable, IJsonModel<DeploymentWithOSConfiguration>, IPersistableModel<DeploymentWithOSConfiguration>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(OSSapConfiguration))
            {
                builder.Append("  osSapConfiguration:");
                AppendChildObject(builder, OSSapConfiguration, options, 2);
            }
