...
{
    public partial class DeploymentWithOSConfiguration : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static DeploymentWithOSConfiguration DeserializeDeploymentWithOSConfiguration(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
