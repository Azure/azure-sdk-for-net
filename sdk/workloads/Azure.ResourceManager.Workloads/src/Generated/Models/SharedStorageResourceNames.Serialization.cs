...
{
    public partial class SharedStorageResourceNames : IUtf8JsonSerializable, IJsonModel<SharedStorageResourceNames>, IPersistableModel<SharedStorageResourceNames>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SharedStorageResourceNames>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<SharedStorageResourceNames>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SharedStorageResourceNames)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SharedStorageAccountName))
            {
                builder.Append("  sharedStorageAccountName:");
                builder.AppendLine($" '{SharedStorageAccountName}'");
            }

            if (Optional.IsDefined(SharedStorageAccountPrivateEndPointName))
            {
                builder.Append("  sharedStorageAccountPrivateEndPointName:");
                builder.AppendLine($" '{SharedStorageAccountPrivateEndPointName}'");
            }
