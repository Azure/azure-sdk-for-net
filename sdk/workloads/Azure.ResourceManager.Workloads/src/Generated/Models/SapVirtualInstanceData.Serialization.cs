...
{
    public partial class SapVirtualInstanceData : IUtf8JsonSerializable, IJsonModel<SapVirtualInstanceData>, IPersistableModel<SapVirtualInstanceData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  sapProduct:");
                builder.AppendLine($" '{SapProduct.ToString()}'");
            }
