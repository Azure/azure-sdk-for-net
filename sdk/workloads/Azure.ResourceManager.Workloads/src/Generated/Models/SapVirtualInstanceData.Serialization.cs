...
namespace Azure.ResourceManager.Workloads
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SapVirtualInstanceData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SapVirtualInstanceData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SapVirtualInstanceData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SapVirtualInstanceData>)} interface");
            }
        ...
        string IPersistableModel<SapVirtualInstanceData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
