...
namespace Azure.ResourceManager.Workloads.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MsSqlServerProviderInstanceProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MsSqlServerProviderInstanceProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MsSqlServerProviderInstanceProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MsSqlServerProviderInstanceProperties>)} interface");
            }
        ...
        string IPersistableModel<MsSqlServerProviderInstanceProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
