...
namespace Azure.ResourceManager.Workloads.Models
{
    ...
    public partial class MessageServerProperties
    {
        ...
        internal MessageServerProperties(long? msPort, long? internalMsPort, long? httpPort, long? httpsPort, string hostname, string ipAddress, SapHealthState? health, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            MsPort = msPort;
