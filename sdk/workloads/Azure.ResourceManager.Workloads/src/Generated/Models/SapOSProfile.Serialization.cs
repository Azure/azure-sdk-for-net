...
{
    public partial class SapOSProfile : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static SapOSProfile DeserializeSapOSProfile(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
