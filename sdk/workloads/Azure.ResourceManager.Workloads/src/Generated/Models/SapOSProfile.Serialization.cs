...
namespace Azure.ResourceManager.Workloads.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SapOSProfile>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SapOSProfile>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SapOSProfile>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SapOSProfile>)} interface");
            }
        ...
        string IPersistableModel<SapOSProfile>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
