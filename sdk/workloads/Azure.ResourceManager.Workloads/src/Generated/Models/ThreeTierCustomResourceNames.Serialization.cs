...
namespace Azure.ResourceManager.Workloads.Models
{
    ...
    public partial class ThreeTierCustomResourceNames : IUtf8JsonSerializable, IJsonModel<ThreeTierCustomResourceNames>, IPersistableModel<ThreeTierCustomResourceNames>
    {
        ...
        void IJsonModel<ThreeTierCustomResourceNames>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ThreeTierCustomResourceNames)} does not support '{format}' format.");
            }
