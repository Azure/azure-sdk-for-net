...
namespace Azure.ResourceManager.Workloads.Models
{
    ...
    public partial class DB2ProviderInstanceProperties : ProviderSpecificProperties
    {
        ...
        internal DB2ProviderInstanceProperties(string providerType, string hostname, string dbName, string dbPort, string dbUsername, string dbPassword, Uri dbPasswordUri, string sapSid, SapSslPreference? sslPreference, Uri sslCertificateUri, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(providerType, serializedAdditionalRawData)
        {
            Hostname = hostname;
            DBName = dbName;
            DBPort = dbPort;
