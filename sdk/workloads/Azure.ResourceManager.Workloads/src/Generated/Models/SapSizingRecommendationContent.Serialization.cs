...
namespace Azure.ResourceManager.Workloads.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SapSizingRecommendationContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SapSizingRecommendationContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SapSizingRecommendationContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<SapSizingRecommendationContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
