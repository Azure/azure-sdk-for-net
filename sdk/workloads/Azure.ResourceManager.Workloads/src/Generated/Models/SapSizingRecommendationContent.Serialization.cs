...
namespace Azure.ResourceManager.Workloads.Models
{
    public partial class SapSizingRecommendationContent : IUtf8JsonSerializable, IJsonModel<SapSizingRecommendationContent>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<SapSizingRecommendationContent>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SapSizingRecommendationContent>)} interface");
            }
