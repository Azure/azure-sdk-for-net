...
namespace Azure.ResourceManager.Workloads.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SapImageReference>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SapImageReference>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SapImageReference>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<SapImageReference>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
