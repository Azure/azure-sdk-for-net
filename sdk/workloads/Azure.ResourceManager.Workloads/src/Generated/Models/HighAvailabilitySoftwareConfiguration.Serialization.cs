...
{
    public partial class HighAvailabilitySoftwareConfiguration : IUtf8JsonSerializable, IJsonModel<HighAvailabilitySoftwareConfiguration>, IPersistableModel<HighAvailabilitySoftwareConfiguration>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HighAvailabilitySoftwareConfiguration>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<HighAvailabilitySoftwareConfiguration>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(HighAvailabilitySoftwareConfiguration)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(FencingClientId))
            {
                builder.Append("  fencingClientId:");
                builder.AppendLine($" '{FencingClientId}'");
            }

            if (Optional.IsDefined(FencingClientPassword))
            {
                builder.Append("  fencingClientPassword:");
                builder.AppendLine($" '{FencingClientPassword}'");
            }
