...
namespace Azure.ResourceManager.Workloads.Models
{
    ...
    {
        internal static ProviderInstanceListResult DeserializeProviderInstanceListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
