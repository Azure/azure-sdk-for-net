...
namespace Azure.ResourceManager.Workloads.Models
{
    ...
    public partial class PrometheusHAClusterProviderInstanceProperties : ProviderSpecificProperties
    {
        ...
        internal PrometheusHAClusterProviderInstanceProperties(string providerType, Uri prometheusUri, string hostname, string sid, string clusterName, SapSslPreference? sslPreference, Uri sslCertificateUri, Dictionary<string, BinaryData> rawData) : base(providerType, rawData)
        {
