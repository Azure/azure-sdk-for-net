...
namespace Azure.ResourceManager.Workloads
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SapMonitorData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SapMonitorData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SapMonitorData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SapMonitorData>)} interface");
            }
        ...
        string IPersistableModel<SapMonitorData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
