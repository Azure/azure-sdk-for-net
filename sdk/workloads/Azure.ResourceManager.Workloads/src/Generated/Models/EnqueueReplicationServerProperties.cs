...
namespace Azure.ResourceManager.Workloads.Models
{
    ...
    public partial class EnqueueReplicationServerProperties
    {
        ...
        internal EnqueueReplicationServerProperties(EnqueueReplicationServerType? ersVersion, string instanceNo, string hostname, string kernelVersion, string kernelPatch, string ipAddress, SapHealthState? health, Dictionary<string, BinaryData> rawData)
        {
