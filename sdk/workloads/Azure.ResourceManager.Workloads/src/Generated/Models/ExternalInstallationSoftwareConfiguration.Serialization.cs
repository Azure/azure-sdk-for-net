...
{
    public partial class ExternalInstallationSoftwareConfiguration : IUtf8JsonSerializable, IJsonModel<ExternalInstallationSoftwareConfiguration>, IPersistableModel<ExternalInstallationSoftwareConfiguration>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(CentralServerVmId))
            {
                builder.Append("  centralServerVmId:");
                builder.AppendLine($" '{CentralServerVmId.ToString()}'");
            }
