...
namespace Azure.ResourceManager.Workloads.Models
{
    public partial class ServiceInitiatedSoftwareConfiguration : IUtf8JsonSerializable, IModelJsonSerializable<ServiceInitiatedSoftwareConfiguration>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<ServiceInitiatedSoftwareConfiguration>(this, options.Format);
        ...
        internal static ServiceInitiatedSoftwareConfiguration DeserializeServiceInitiatedSoftwareConfiguration(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new ServiceInitiatedSoftwareConfiguration(softwareInstallationType, bomUrl, softwareVersion, sapBitsStorageAccountId, sapFqdn, sshPrivateKey, highAvailabilitySoftwareConfiguration.Value, serializedAdditionalRawData);
        }
        ...
        /// <summary> Converts a <see cref="ServiceInitiatedSoftwareConfiguration"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="ServiceInitiatedSoftwareConfiguration"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="ServiceInitiatedSoftwareConfiguration"/>. </summary>
