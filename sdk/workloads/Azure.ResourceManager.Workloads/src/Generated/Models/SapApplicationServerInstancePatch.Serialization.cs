...
namespace Azure.ResourceManager.Workloads.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SapApplicationServerInstancePatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SapApplicationServerInstancePatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SapApplicationServerInstancePatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SapApplicationServerInstancePatch>)} interface");
            }
        ...
        string IPersistableModel<SapApplicationServerInstancePatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
