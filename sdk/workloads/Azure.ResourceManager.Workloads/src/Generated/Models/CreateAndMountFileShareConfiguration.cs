...
namespace Azure.ResourceManager.Workloads.Models
{
    ...
    public partial class CreateAndMountFileShareConfiguration : FileShareConfiguration
    {
        ...
        internal CreateAndMountFileShareConfiguration(ConfigurationType configurationType, string resourceGroup, string storageAccountName, Dictionary<string, BinaryData> rawData) : base(configurationType, rawData)
        {
