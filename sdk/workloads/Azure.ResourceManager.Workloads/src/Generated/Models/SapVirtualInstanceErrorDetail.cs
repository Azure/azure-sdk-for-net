...
namespace Azure.ResourceManager.Workloads.Models
{
    ...
    public partial class SapVirtualInstanceErrorDetail
    {
        ...
        internal SapVirtualInstanceErrorDetail(string code, string message, IReadOnlyList<SapVirtualInstanceErrorDetail> details, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Code = code;
            Message = message;
            Details = details;
