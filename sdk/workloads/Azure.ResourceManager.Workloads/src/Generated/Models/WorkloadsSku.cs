...
namespace Azure.ResourceManager.Workloads.Models
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="WorkloadsSku"/>. </summary>
        ...
        internal WorkloadsSku(string name, WorkloadsSkuTier? tier, string size, string family, int? capacity)
        {
            Name = name;
            Tier = tier;
            Size = size;
        ...
        public WorkloadsSkuTier? Tier { get; set; }
