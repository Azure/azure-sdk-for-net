...
namespace Azure.ResourceManager.Workloads.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SingleServerRecommendationResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SingleServerRecommendationResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SingleServerRecommendationResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SingleServerRecommendationResult>)} interface");
            }
        ...
        string IPersistableModel<SingleServerRecommendationResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
