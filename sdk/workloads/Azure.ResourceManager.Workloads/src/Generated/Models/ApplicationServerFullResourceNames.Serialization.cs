...
namespace Azure.ResourceManager.Workloads.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ApplicationServerFullResourceNames>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ApplicationServerFullResourceNames>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ApplicationServerFullResourceNames>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ApplicationServerFullResourceNames>)} interface");
            }
        ...
        string IPersistableModel<ApplicationServerFullResourceNames>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
