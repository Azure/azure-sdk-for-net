...
{
    public partial class SapLandscapeMonitorData : IUtf8JsonSerializable, IJsonModel<SapLandscapeMonitorData>, IPersistableModel<SapLandscapeMonitorData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Grouping))
            {
                ...
                AppendChildObject(builder, Grouping, options, 2);
            }

            if (Optional.IsCollectionDefined(TopMetricsThresholds))
            {
                builder.Append("  topMetricsThresholds:");
                builder.AppendLine(" [");
                foreach (var item in TopMetricsThresholds)
                {
