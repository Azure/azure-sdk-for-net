...
namespace Azure.ResourceManager.Workloads
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SapLandscapeMonitorData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SapLandscapeMonitorData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SapLandscapeMonitorData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SapLandscapeMonitorData>)} interface");
            }
        ...
        string IPersistableModel<SapLandscapeMonitorData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
