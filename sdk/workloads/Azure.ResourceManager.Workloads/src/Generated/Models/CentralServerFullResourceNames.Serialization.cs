...
namespace Azure.ResourceManager.Workloads.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CentralServerFullResourceNames>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CentralServerFullResourceNames>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CentralServerFullResourceNames>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<CentralServerFullResourceNames>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
