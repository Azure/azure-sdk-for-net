...
{
    public partial class SapDiskConfigurationsResult : IUtf8JsonSerializable, IJsonModel<SapDiskConfigurationsResult>, IPersistableModel<SapDiskConfigurationsResult>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(VolumeConfigurations))
            {
                builder.Append("  volumeConfigurations:");
                builder.AppendLine(" {");
                foreach (var item in VolumeConfigurations)
                {
