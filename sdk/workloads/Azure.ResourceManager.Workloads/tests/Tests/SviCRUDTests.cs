...
namespace Azure.ResourceManager.Workloads.Tests.Tests
{
    ...
    public class SviCRUDTests : WorkloadsManagementTestBase
    {
        ...
        /// </summary>
        private const int NumberOfMaxIntervals = 6;

        public SviCRUDTests() : base(true, RecordedTestMode.None)
        {
            Environment.SetEnvironmentVariable("AZURE_CLIENT_ID", "a7df1f57-04bc-4411-9ab2-067700f4247b");
            Environment.SetEnvironmentVariable("AZURE_CLIENT_SECRET", "U0z8Q~-mqbREFCvMBi13dMpvzzqrHbUeA9IzbchI");
