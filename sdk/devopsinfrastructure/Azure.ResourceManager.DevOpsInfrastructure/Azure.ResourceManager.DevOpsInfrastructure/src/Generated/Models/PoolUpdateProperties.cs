...
namespace Azure.ResourceManager.DevOpsInfrastructure.Models
{
    ...
    public partial class PoolUpdateProperties
    {
        ...
        internal PoolUpdateProperties(ProvisioningState? provisioningState, int? maximumConcurrency, OrganizationProfile organizationProfile, AgentProfileUpdate agentProfile, FabricProfile fabricProfile, string devCenterProjectResourceId, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
        ...
        /// The available derived classes include <see cref="StatefulUpdate"/> and <see cref="StatelessAgentProfileUpdate"/>.
        /// </summary>
        public AgentProfileUpdate AgentProfile { get; set; }
        /// <summary>
        /// Defines the type of fabric the agent will run on.
        /// Please note <see cref="Models.FabricProfile"/> is the base class. According to the scenario, a derived class of the base class might need to be assigned here, or this property needs to be casted to one of the possible derived classes.
        /// The available derived classes include <see cref="VmssFabricProfile"/>.
