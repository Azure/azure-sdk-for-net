...
namespace Azure.ResourceManager.DevOpsInfrastructure
{
    ...
    public static partial class DevOpsInfrastructureExtensions
    {
        ...
        public static AsyncPageable<ImageVersion> GetImageVersionsByImageAsync(this ResourceGroupResource resourceGroupResource, string imageName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(resourceGroupResource, nameof(resourceGroupResource));
        ...
        public static Pageable<ImageVersion> GetImageVersionsByImage(this ResourceGroupResource resourceGroupResource, string imageName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(resourceGroupResource, nameof(resourceGroupResource));
        ...
        /// <item>
        /// <term>Mocking</term>
        /// <description>To mock this method, please mock <see cref="MockableDevOpsInfrastructureSubscriptionResource.GetSubscriptionUsagesByLocation(string,CancellationToken)"/> instead.</description>
        /// </item>
        /// </summary>
        /// <param name="subscriptionResource"> The <see cref="SubscriptionResource" /> instance the method will execute against. </param>
        /// <param name="locationName"> Name of the location. </param>
        ...
        public static AsyncPageable<Quota> GetSubscriptionUsagesByLocationAsync(this SubscriptionResource subscriptionResource, string locationName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(subscriptionResource, nameof(subscriptionResource));

            return GetMockableDevOpsInfrastructureSubscriptionResource(subscriptionResource).GetSubscriptionUsagesByLocationAsync(locationName, cancellationToken);
        }
        ...
        public static Pageable<Quota> GetSubscriptionUsagesByLocation(this SubscriptionResource subscriptionResource, string locationName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(subscriptionResource, nameof(subscriptionResource));

            return GetMockableDevOpsInfrastructureSubscriptionResource(subscriptionResource).GetSubscriptionUsagesByLocation(locationName, cancellationToken);
        }
