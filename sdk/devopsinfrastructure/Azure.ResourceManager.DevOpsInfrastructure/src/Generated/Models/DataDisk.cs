...
namespace Azure.ResourceManager.DevOpsInfrastructure.Models
{
    ...
    public partial class DataDisk
    {
        ...
        internal DataDisk(CachingType? caching, int? diskSizeGiB, StorageAccountType? storageAccountType, string driveLetter, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Caching = caching;
