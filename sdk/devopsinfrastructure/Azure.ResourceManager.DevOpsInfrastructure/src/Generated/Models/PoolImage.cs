...
namespace Azure.ResourceManager.DevOpsInfrastructure.Models
{
    ...
    public partial class PoolImage
    {
        ...
        /// <summary> Initializes a new instance of <see cref="PoolImage"/>. </summary>
        public PoolImage()
        {
        ...
        internal PoolImage(string resourceId, string wellKnownImageName, IList<string> aliases, string buffer, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
