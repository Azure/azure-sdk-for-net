...
namespace Azure.ResourceManager.DevOpsInfrastructure.Models
{
    ...
    internal partial class NetworkProfile
    {
        ...
        public NetworkProfile(string subnetId)
        {
        ...
        internal NetworkProfile(string subnetId, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            SubnetId = subnetId;
            _serializedAdditionalRawData = serializedAdditionalRawData;
        }

        /// <summary> Initializes a new instance of <see cref="NetworkProfile"/> for deserialization. </summary>
