...
namespace Azure.ResourceManager.DevOpsInfrastructure.Models
{
    ...
    public partial class DevOpsResourceSkuProperties
    {
        ...
        public DevOpsResourceSkuProperties(string resourceType, string tier, string size, string family, IEnumerable<AzureLocation> locations, IEnumerable<ResourceSkuLocationInfo> locationInfo, IEnumerable<ResourceSkuCapabilities> capabilities, IEnumerable<ResourceSkuRestrictions> restrictions)
        {
