...
{
    internal partial class UnknownDevOpsOrganizationProfile : DevOpsOrganizationProfile, IJsonModel<DevOpsOrganizationProfile>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownDevOpsOrganizationProfile DeserializeUnknownDevOpsOrganizationProfile(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownDevOpsOrganizationProfile(kind, additionalBinaryDataProperties);
        }
