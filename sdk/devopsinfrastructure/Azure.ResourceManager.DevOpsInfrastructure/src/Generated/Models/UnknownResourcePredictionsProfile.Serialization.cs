...
{
    internal partial class UnknownResourcePredictionsProfile : ResourcePredictionsProfile, IJsonModel<ResourcePredictionsProfile>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<ResourcePredictionsProfile>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ResourcePredictionsProfile IJsonModel<ResourcePredictionsProfile>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownResourcePredictionsProfile DeserializeUnknownResourcePredictionsProfile(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownResourcePredictionsProfile(kind, additionalBinaryDataProperties);
        }

        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ResourcePredictionsProfile>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ResourcePredictionsProfile IPersistableModel<ResourcePredictionsProfile>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
