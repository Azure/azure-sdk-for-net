...
namespace Azure.ResourceManager.DevOpsInfrastructure
{
    ...
    {
        private static readonly JsonSerializerOptions s_options = new JsonSerializerOptions { Converters = { new JsonModelConverter(WireOptions, AzureResourceManagerDevOpsInfrastructureContext.Default) } };
        private static readonly JsonSerializerOptions s_optionsUseManagedServiceIdentityV3 = new JsonSerializerOptions { Converters = { new JsonModelConverter(WireOptions, AzureResourceManagerDevOpsInfrastructureContext.Default), new ResourceManager.Models.ManagedServiceIdentityTypeV3Converter() } };
