...
namespace Azure.ResourceManager.DevOpsInfrastructure
{
    internal partial class DevOpsInfrastructureArmOperation : ArmOperation
    {
        ...
        internal DevOpsInfrastructureArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
