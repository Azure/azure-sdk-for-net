...
#pragma warning disable SA1649 // File name should match first type name
    internal class DevOpsInfrastructureArmOperation : ArmOperation
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        internal DevOpsInfrastructureArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal DevOpsInfrastructureArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal(nextLinkOperation, clientDiagnostics, response, "DevOpsInfrastructureArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
