...
namespace Azure.ResourceManager.DevOpsInfrastructure
{
    internal partial class DevOpsInfrastructureArmOperation<T> : ArmOperation<T>
    {
        ...
        internal DevOpsInfrastructureArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
