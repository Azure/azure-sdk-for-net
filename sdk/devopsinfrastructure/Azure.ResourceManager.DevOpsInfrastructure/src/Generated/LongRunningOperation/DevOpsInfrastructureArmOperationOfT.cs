...
#pragma warning disable SA1649 // File name should match first type name
    internal class DevOpsInfrastructureArmOperation<T> : ArmOperation<T>
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        /// <summary> Initializes a new instance of DevOpsInfrastructureArmOperation for mocking. </summary>
        protected DevOpsInfrastructureArmOperation()
        {
        }

        internal DevOpsInfrastructureArmOperation(Response<T> response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal DevOpsInfrastructureArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal<T>(NextLinkOperationImplementation.Create(source, nextLinkOperation), clientDiagnostics, response, "DevOpsInfrastructureArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
        ...
        private string GetOperationId(RehydrationToken? rehydrationToken)
        {
            ...
            var lroDetails = ModelReaderWriter.Write(rehydrationToken, ModelReaderWriterOptions.Json, AzureResourceManagerDevOpsInfrastructureContext.Default).ToObjectFromJson<Dictionary<string, string>>();
