...
{
    /// <summary></summary>
    internal partial class DevOpsPoolResourceOperationSource : IOperationSource<DevOpsPoolResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal DevOpsPoolResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
