...
namespace Azure.ResourceManager.DevOpsInfrastructure
{
    internal partial class SkuGetSkusByLocationAsyncCollectionResultOfT : AsyncPageable<DevOpsResourceSku>
    {
        ...
        public SkuGetSkusByLocationAsyncCollectionResultOfT(Sku client, Guid subscriptionId, string locationName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        public override async IAsyncEnumerable<Page<DevOpsResourceSku>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                yield return Page<DevOpsResourceSku>.FromValues((IReadOnlyList<DevOpsResourceSku>)result.Value, nextPage?.IsAbsoluteUri == true ? nextPage.AbsoluteUri : nextPage?.OriginalString, response);
