...
namespace Azure.ResourceManager.DevOpsInfrastructure
{
    internal partial class ImageVersionsGetImageVersionsByImageAsyncCollectionResultOfT : AsyncPageable<DevOpsImageVersion>
    {
        ...
        public ImageVersionsGetImageVersionsByImageAsyncCollectionResultOfT(ImageVersions client, Guid subscriptionId, string resourceGroupName, string imageName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
