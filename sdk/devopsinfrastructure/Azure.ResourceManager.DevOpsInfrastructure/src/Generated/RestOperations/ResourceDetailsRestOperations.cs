...
namespace Azure.ResourceManager.DevOpsInfrastructure
{
    internal partial class ResourceDetails
    {
        ...
        internal HttpMessage CreateGetByPoolRequest(Guid subscriptionId, string resourceGroupName, string poolName, RequestContext context)
        {
        ...
        internal HttpMessage CreateNextGetByPoolRequest(Uri nextPage, Guid subscriptionId, string resourceGroupName, string poolName, RequestContext context)
        {
            RawRequestUriBuilder uri = new RawRequestUriBuilder();
            uri.Reset(nextPage);
            HttpMessage message = Pipeline.CreateMessage();
