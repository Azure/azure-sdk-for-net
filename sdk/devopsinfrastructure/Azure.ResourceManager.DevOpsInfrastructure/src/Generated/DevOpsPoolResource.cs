...
namespace Azure.ResourceManager.DevOpsInfrastructure
{
    ...
    public partial class DevOpsPoolResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<DevOpsPoolResource>> UpdateAsync(WaitUntil waitUntil, DevOpsPoolData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _poolsRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, DevOpsPoolData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                DevOpsInfrastructureArmOperation<DevOpsPoolResource> operation = new DevOpsInfrastructureArmOperation<DevOpsPoolResource>(
                    new DevOpsPoolResourceOperationSource(Client),
                    _poolsClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<DevOpsPoolResource> Update(WaitUntil waitUntil, DevOpsPoolData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
