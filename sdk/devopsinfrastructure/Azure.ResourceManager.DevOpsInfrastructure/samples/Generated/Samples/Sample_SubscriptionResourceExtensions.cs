...
namespace Azure.ResourceManager.DevOpsInfrastructure.Samples
{
    public partial class Sample_SubscriptionResourceExtensions
    {
        ...
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task UsagesSubscriptionUsages_SubscriptionUsagesUsages()
        {
            ...
            await foreach (Quota item in subscriptionResource.UsagesSubscriptionUsagesAsync(location))
            {
                Console.WriteLine($"Succeeded: {item}");
            }
