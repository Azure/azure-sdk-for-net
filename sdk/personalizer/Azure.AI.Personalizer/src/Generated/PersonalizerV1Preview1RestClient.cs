...
namespace Azure.AI.Personalizer
{
    internal partial class PersonalizerV1Preview1RestClient
    {
        ...
        internal HttpMessage CreateRankRequest(RankRequest rankRequest)
        {
        ...
        public async Task<Response<RankResponse>> RankAsync(RankRequest rankRequest, CancellationToken cancellationToken = default)
        {
            if (rankRequest == null)
            {
            ...
            switch (message.Response.Status)
            {
                case 201:
                    {
                        RankResponse value = default;
                        using var document = await JsonDocument.ParseAsync(message.Response.ContentStream, default, cancellationToken).ConfigureAwait(false);
                        value = RankResponse.DeserializeRankResponse(document.RootElement);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="rankRequest"/> is null. </exception>
        public Response<RankResponse> Rank(RankRequest rankRequest, CancellationToken cancellationToken = default)
        {
            if (rankRequest == null)
            {
                throw new ArgumentNullException(nameof(rankRequest));
