...
namespace Azure.AI.Personalizer.Models
{
    ...
    public partial class MultiSlotRankRequest
    {
        ...
        public MultiSlotRankRequest(IEnumerable<RankableAction> actions, IEnumerable<SlotRequest> slots)
        {
            if (actions == null)
            {
        ...
        /// The first item in the array will be used as Baseline item in Offline Evaluations.
        /// </summary>
        public IList<RankableAction> Actions { get; }
        /// <summary>
        /// The set of slots the Personalizer service should select actions for.
        /// 
        /// The set should not contain more than 50 slots.
        /// </summary>
        public IList<SlotRequest> Slots { get; }
        /// <summary>
