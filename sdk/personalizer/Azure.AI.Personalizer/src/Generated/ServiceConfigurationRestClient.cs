...
namespace Azure.AI.Personalizer
{
    internal partial class ServiceConfigurationRestClient
    {
        ...
        internal HttpMessage CreateUpdateRequest(PersonalizerServiceProperties config)
        {
        ...
        public async Task<Response<PersonalizerServiceProperties>> UpdateAsync(PersonalizerServiceProperties config, CancellationToken cancellationToken = default)
        {
            if (config == null)
            {
            ...
            switch (message.Response.Status)
            {
                case 200:
                    {
                        PersonalizerServiceProperties value = default;
                        using var document = await JsonDocument.ParseAsync(message.Response.ContentStream, default, cancellationToken).ConfigureAwait(false);
                        value = PersonalizerServiceProperties.DeserializePersonalizerServiceProperties(document.RootElement);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="config"/> is null. </exception>
        public Response<PersonalizerServiceProperties> Update(PersonalizerServiceProperties config, CancellationToken cancellationToken = default)
        {
            if (config == null)
            {
                throw new ArgumentNullException(nameof(config));
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async Task<Response<PersonalizerServiceProperties>> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <summary> Get the Personalizer service configuration. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public Response<PersonalizerServiceProperties> Get(CancellationToken cancellationToken = default)
        {
            using var message = CreateGetRequest();
            _pipeline.Send(message, cancellationToken);
            switch (message.Response.Status)
