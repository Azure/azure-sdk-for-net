...
namespace Azure.AI.Personalizer
{
    ...
    public partial class ModelClient
    {
        ...
        public ModelClient(string endpoint, TokenCredential credential, PersonalizerV1Preview1ClientOptions options = null)
        {
            if (endpoint == null)
            {
        ...
        /// <param name="credential"> A credential used to authenticate to an Azure Service. </param>
        /// <param name="options"> The options for configuring the client. </param>
        public ModelClient(string endpoint, AzureKeyCredential credential, PersonalizerV1Preview1ClientOptions options = null)
        {
            if (endpoint == null)
            {
                throw new ArgumentNullException(nameof(endpoint));
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<ModelProperties>> GetPropertiesAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <summary> Get properties of the model file generated by Personalizer service. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<ModelProperties> GetProperties(CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("ModelClient.GetProperties");
            scope.Start();
            try
