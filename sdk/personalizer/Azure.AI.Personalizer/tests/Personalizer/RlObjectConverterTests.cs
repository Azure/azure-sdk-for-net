...
namespace Azure.AI.Personalizer.Tests
{
    public class RlObjectConverterTests
    {
        ...
        public void GetActionIdToIndexMappingTest()
        {
            ...
            Assert.That(idToIndex.Keys.Count, Is.EqualTo(3));
        ...
        public void GenerateRankResultTest()
        {
            ...
            Assert.That(rankResponse.Ranking.Count, Is.EqualTo(originalActions.Count));
        ...
        public void GenerateMultiSlotRankResponseTest()
        {
            ...
            Assert.That(response.Slots.Count, Is.EqualTo(actionCount));
