...
namespace PersonalizerClientV1Preview1.Models
{
    ...
    public partial class PolicyResultTotalSummary : PolicyResultSummary
    {
        ...
        internal PolicyResultTotalSummary(DateTimeOffset? timeStamp, float? ipsEstimatorNumerator, float? ipsEstimatorDenominator, float? snipsEstimatorDenominator, TimeSpan? aggregateTimeWindow, float? nonZeroProbability, float? sumOfSquares, float? confidenceInterval, float? averageReward) : base(timeStamp, ipsEstimatorNumerator, ipsEstimatorDenominator, snipsEstimatorDenominator, aggregateTimeWindow, nonZeroProbability, sumOfSquares, confidenceInterval, averageReward)
        {
        }
    }
}
