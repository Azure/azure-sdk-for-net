...
namespace PersonalizerClientV1Preview1.Models
{
    ...
    public partial class PolicyResultSummary
    {
        ...
        internal PolicyResultSummary(DateTimeOffset? timeStamp, float? ipsEstimatorNumerator, float? ipsEstimatorDenominator, float? snipsEstimatorDenominator, TimeSpan? aggregateTimeWindow, float? nonZeroProbability, float? sumOfSquares, float? confidenceInterval, float? averageReward)
        {
            TimeStamp = timeStamp;
