...
{
    internal partial class WidgetArmOperation : ArmOperation
    {
        ...
        /// <summary> Initializes a new instance of WidgetArmOperation for mocking. </summary>
        protected WidgetArmOperation()
        {
        }
        ...
        internal WidgetArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal WidgetArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
