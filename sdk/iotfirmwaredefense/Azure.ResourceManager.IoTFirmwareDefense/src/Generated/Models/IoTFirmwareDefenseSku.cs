...
namespace Azure.ResourceManager.IoTFirmwareDefense.Models
{
    ...
    public partial class IoTFirmwareDefenseSku
    {
        ...
        internal IoTFirmwareDefenseSku(string name, IoTFirmwareDefenseSkuTier? tier, string size, string family, int? capacity, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Name = name;
            Tier = tier;
            Size = size;
