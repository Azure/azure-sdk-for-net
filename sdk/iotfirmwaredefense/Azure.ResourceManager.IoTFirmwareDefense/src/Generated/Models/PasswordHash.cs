...
namespace Azure.ResourceManager.IoTFirmwareDefense.Models
{
    ...
    public partial class PasswordHash
    {
        ...
        internal PasswordHash(string passwordHashId, string filePath, string salt, string hash, string context, string username, string algorithm, ProvisioningState? provisioningState, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
