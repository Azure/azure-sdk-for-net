...
namespace Azure.ResourceManager.IoTFirmwareDefense.Models
{
    ...
    public readonly partial struct ProvisioningState : IEquatable<ProvisioningState>
    {
        ...
        /// <summary> The Firmware is currently being extracted. </summary>
        public static ProvisioningState Extracting { get; } = new ProvisioningState(ExtractingValue);

        /// <summary> Analysis is being run on the firmware. </summary>
        public static ProvisioningState Analyzing { get; } = new ProvisioningState(AnalyzingValue);
