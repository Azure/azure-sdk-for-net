...
namespace Azure.ResourceManager.IoTFirmwareDefense
{
    ...
    public partial class WorkspaceResource : ArmResource
    {
        ...
        internal WorkspaceResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _workspacesRestClient = new Workspaces(_workspacesClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, workspaceApiVersion ?? "2026-06-01-preview");
        ...
        public virtual async Task<Response<UrlToken>> GenerateUploadUriAsync(GenerateUploadUrlContent content, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(content, nameof(content));

            using DiagnosticScope scope = _workspacesClientDiagnostics.CreateScope("WorkspaceResource.GenerateUploadUri");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _workspacesRestClient.CreateGenerateUploadUriRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, GenerateUploadUrlContent.ToRequestContent(content), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<UrlToken> response = Response.FromValue(UrlToken.FromResponse(result), result);
                if (response.Value == null)
                {
                    throw new RequestFailedException(response.GetRawResponse());
                }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="content"/> is null. </exception>
        public virtual Response<UrlToken> GenerateUploadUri(GenerateUploadUrlContent content, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(content, nameof(content));
        ...
        /// <summary> Gets a collection of Firmwares in the <see cref="WorkspaceResource"/>. </summary>
        /// <returns> An object representing collection of Firmwares and their operations over a FirmwareResource. </returns>
        ...
        /// <summary> Gets a collection of UsageMetrics in the <see cref="WorkspaceResource"/>. </summary>
