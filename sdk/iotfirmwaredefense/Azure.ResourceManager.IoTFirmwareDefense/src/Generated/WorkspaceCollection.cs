...
namespace Azure.ResourceManager.IoTFirmwareDefense
{
    ...
    public partial class WorkspaceCollection : ArmCollection, IEnumerable<WorkspaceResource>, IAsyncEnumerable<WorkspaceResource>
    {
        ...
        internal WorkspaceCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _workspacesClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.IoTFirmwareDefense", WorkspaceResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<WorkspaceResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string workspaceName, WorkspaceData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _workspacesRestClient.CreateCreateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, workspaceName, WorkspaceData.ToRequestContent(data), context);
                ...
                IoTFirmwareDefenseArmOperation<WorkspaceResource> operation = new IoTFirmwareDefenseArmOperation<WorkspaceResource>(Response.FromValue(new WorkspaceResource(Client, response.Value), response.GetRawResponse()), rehydrationToken);
