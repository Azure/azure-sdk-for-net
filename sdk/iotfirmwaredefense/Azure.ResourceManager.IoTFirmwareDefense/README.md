# Azure.ResourceManager.IoTFirmwareDefense management client library for .NET
...
Install the Azure.ResourceManager.IoTFirmwareDefense management library for .NET with [NuGet](https://www.nuget.org/):
