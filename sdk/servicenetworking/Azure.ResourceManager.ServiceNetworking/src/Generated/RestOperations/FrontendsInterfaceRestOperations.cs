...
namespace Azure.ResourceManager.ServiceNetworking
{
    internal partial class FrontendsInterfaceRestOperations
    {
        ...
        /// <summary> Get a Traffic Controller Frontend. </summary>
        /// <param name="subscriptionId"> The ID of the target subscription. </param>
        /// <param name="resourceGroupName"> The name of the resource group. The name is case insensitive. </param>
        /// <param name="trafficControllerName"> traffic controller name for path. </param>
        ...
        /// <summary> Create a Traffic Controller Frontend. </summary>
        ...
        /// <summary> Update a Traffic Controller Frontend. </summary>
        /// <param name="subscriptionId"> The ID of the target subscription. </param>
        /// <param name="resourceGroupName"> The name of the resource group. The name is case insensitive. </param>
        /// <param name="trafficControllerName"> traffic controller name for path. </param>
        /// <param name="frontendName"> Frontends. </param>
        ...
        /// <summary> Delete a Traffic Controller Frontend. </summary>
        /// <param name="message"> The HTTP context flowing through the pipeline. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="message"/> is null. </exception>
