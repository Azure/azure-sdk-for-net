...
{
    /// <summary> A class to add extension methods to TrafficControllerResource. </summary>
    public partial class TrafficControllerResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="TrafficControllerResourceExtension"/> class for mocking. </summary>
        protected TrafficControllerResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="TrafficControllerResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal TrafficControllerResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        private ClientDiagnostics TrafficControllerTrafficControllerInterfaceClientDiagnostics => _trafficControllerTrafficControllerInterfaceClientDiagnostics ??= new ClientDiagnostics("Azure.ResourceManager.ServiceNetworking.Mock", TrafficControllerResource.ResourceType.Namespace, Diagnostics);
