...
namespace Azure.ResourceManager.ServiceNetworking.Mock
{
    ...
    public partial class TrafficControllerResourceExtensionClient : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="TrafficControllerResourceExtensionClient"/> class for mocking. </summary>
        protected TrafficControllerResourceExtensionClient()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="TrafficControllerResourceExtensionClient"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal TrafficControllerResourceExtensionClient(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
