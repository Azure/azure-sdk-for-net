...
namespace Azure.ResourceManager.ServiceNetworking.Testing
{
    /// <summary> A class to add extension methods to SubscriptionResource. </summary>
    public partial class ServiceNetworkingSubscriptionResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="ServiceNetworkingSubscriptionResourceExtension"/> class for mocking. </summary>
        protected ServiceNetworkingSubscriptionResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ServiceNetworkingSubscriptionResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ServiceNetworkingSubscriptionResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
