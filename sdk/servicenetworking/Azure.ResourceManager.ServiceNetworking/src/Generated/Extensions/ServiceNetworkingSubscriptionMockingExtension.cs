...
namespace Azure.ResourceManager.ServiceNetworking.Mocking
{
    ...
    internal partial class ServiceNetworkingSubscriptionMockingExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="ServiceNetworkingSubscriptionMockingExtension"/> class for mocking. </summary>
        protected ServiceNetworkingSubscriptionMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ServiceNetworkingSubscriptionMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ServiceNetworkingSubscriptionMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
