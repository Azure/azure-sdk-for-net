...
namespace Azure.ResourceManager.ServiceNetworking.Mocking
{
    ...
    internal partial class ServiceNetworkingResourceGroupMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="ServiceNetworkingResourceGroupMockingExtension"/> class for mocking. </summary>
        protected ServiceNetworkingResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ServiceNetworkingResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ServiceNetworkingResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
