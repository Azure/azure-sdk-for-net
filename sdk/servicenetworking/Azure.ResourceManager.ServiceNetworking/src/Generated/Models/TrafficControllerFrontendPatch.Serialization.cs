...
namespace Azure.ResourceManager.ServiceNetworking.Models
{
    ...
    public partial class TrafficControllerFrontendPatch : IJsonModel<TrafficControllerFrontendPatch>
    {
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual TrafficControllerFrontendPatch PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
        ...
        internal static RequestContent ToRequestContent(TrafficControllerFrontendPatch trafficControllerFrontendPatch)
        {
            ...
            return RequestContent.Create(trafficControllerFrontendPatch, ModelSerializationExtensions.WireOptions);
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        TrafficControllerFrontendPatch IJsonModel<TrafficControllerFrontendPatch>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual TrafficControllerFrontendPatch JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<TrafficControllerFrontendPatch>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static TrafficControllerFrontendPatch DeserializeTrafficControllerFrontendPatch(JsonElement element, ModelReaderWriterOptions options)
        {
