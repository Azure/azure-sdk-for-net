...
{
    public partial class AssociationData : IUtf8JsonSerializable, IJsonModel<AssociationData>, IPersistableModel<AssociationData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(AssociationType))
            {
                ...
                builder.AppendLine($" '{AssociationType.ToString()}'");
            }
