...
namespace Azure.ResourceManager.ServiceNetworking
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AssociationData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AssociationData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AssociationData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AssociationData>)} interface");
            }
        ...
        string IPersistableModel<AssociationData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
