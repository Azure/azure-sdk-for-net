...
namespace Azure.ResourceManager.ServiceNetworking
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FrontendData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<FrontendData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<FrontendData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<FrontendData>)} interface");
            }
        ...
        string IPersistableModel<FrontendData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
