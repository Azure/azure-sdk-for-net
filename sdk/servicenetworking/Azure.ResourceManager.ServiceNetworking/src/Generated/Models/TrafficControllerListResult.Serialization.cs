...
namespace Azure.ResourceManager.ServiceNetworking.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TrafficControllerListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<TrafficControllerListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<TrafficControllerListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<TrafficControllerListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
