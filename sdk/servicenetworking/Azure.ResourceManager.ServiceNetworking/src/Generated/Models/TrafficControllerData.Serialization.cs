...
{
    public partial class TrafficControllerData : IUtf8JsonSerializable, IJsonModel<TrafficControllerData>, IPersistableModel<TrafficControllerData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  configurationEndpoints:");
                builder.AppendLine(" [");
                foreach (var item in ConfigurationEndpoints)
                {
                    if (item == null)
