...
namespace Azure.ResourceManager.ServiceNetworking
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TrafficControllerData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<TrafficControllerData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<TrafficControllerData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<TrafficControllerData>)} interface");
            }
        ...
        string IPersistableModel<TrafficControllerData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
