...
namespace Azure.ResourceManager.ServiceNetworking.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AssociationPatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AssociationPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AssociationPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AssociationPatch>)} interface");
            }
        ...
        string IPersistableModel<AssociationPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
