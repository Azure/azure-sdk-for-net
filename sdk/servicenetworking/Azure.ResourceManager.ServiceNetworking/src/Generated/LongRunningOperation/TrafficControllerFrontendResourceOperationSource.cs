...
{
    /// <summary></summary>
    internal partial class TrafficControllerFrontendResourceOperationSource : IOperationSource<TrafficControllerFrontendResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal TrafficControllerFrontendResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
