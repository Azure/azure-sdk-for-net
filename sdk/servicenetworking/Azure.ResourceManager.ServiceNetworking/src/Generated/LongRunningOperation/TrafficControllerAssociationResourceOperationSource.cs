...
{
    /// <summary></summary>
    internal partial class TrafficControllerAssociationResourceOperationSource : IOperationSource<TrafficControllerAssociationResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal TrafficControllerAssociationResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
