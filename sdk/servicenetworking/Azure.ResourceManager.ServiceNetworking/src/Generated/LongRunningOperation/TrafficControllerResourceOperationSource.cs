...
{
    /// <summary></summary>
    internal partial class TrafficControllerResourceOperationSource : IOperationSource<TrafficControllerResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal TrafficControllerResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
