...
namespace Azure.ResourceManager.ServiceNetworking
{
    internal partial class ServiceNetworkingArmOperation<T> : ArmOperation<T>
    {
        ...
        internal ServiceNetworkingArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
