...
namespace Azure.ResourceManager.ServiceNetworking
{
    ...
    public partial class TrafficControllerResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<TrafficControllerResource>> UpdateAsync(WaitUntil waitUntil, TrafficControllerData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _trafficControllerInterfaceRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, TrafficControllerData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<TrafficControllerResource> Update(WaitUntil waitUntil, TrafficControllerData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
