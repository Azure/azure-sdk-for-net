...
namespace Azure.ResourceManager.ServiceNetworking
{
    ...
    public partial class TrafficControllerAssociationResource : ArmResource
    {
        ...
        /// <summary>
        /// Updates the TrafficControllerAssociation.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ServiceNetworking/trafficControllers/{trafficControllerName}/associations/{associationName}. </description>
        ...
        public virtual async Task<ArmOperation<TrafficControllerAssociationResource>> UpdateAsync(WaitUntil waitUntil, TrafficControllerAssociationData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _associationsInterfaceRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, TrafficControllerAssociationData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<TrafficControllerAssociationResource> Update(WaitUntil waitUntil, TrafficControllerAssociationData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
