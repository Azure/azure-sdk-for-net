...
namespace Azure.ResourceManager.ServiceNetworking
{
    ...
    {
        private static IJsonModel<TrafficControllerFrontendData> s_dataDeserializationInstance;

        private static IJsonModel<TrafficControllerFrontendData> DataDeserializationInstance => s_dataDeserializationInstance ??= new TrafficControllerFrontendData();
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        TrafficControllerFrontendData IJsonModel<TrafficControllerFrontendData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => DataDeserializationInstance.Create(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<TrafficControllerFrontendData>.GetFormatFromOptions(ModelReaderWriterOptions options) => DataDeserializationInstance.GetFormatFromOptions(options);
    }
}
