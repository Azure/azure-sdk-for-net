...
#pragma warning disable SA1649 // File name should match first type name
    internal class TrafficControllerArmOperation<T> : ArmOperation<T>
#pragma warning restore SA1649 // File name should match first type name
    {
        private readonly OperationInternal<T> _operation;

        /// <summary> Initializes a new instance of TrafficControllerArmOperation for mocking. </summary>
        protected TrafficControllerArmOperation()
        {
        }

        internal TrafficControllerArmOperation(Response<T> response)
        {
            _operation = OperationInternal<T>.Succeeded(response.GetRawResponse(), response.Value);
        }

        internal TrafficControllerArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia)
        {
            ...
            _operation = new OperationInternal<T>(clientDiagnostics, nextLinkOperation, response, "TrafficControllerArmOperation", fallbackStrategy: new ExponentialDelayStrategy());
        }
