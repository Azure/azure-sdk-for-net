...
#pragma warning disable SA1649 // File name should match first type name
    internal class TrafficControllerArmOperation : ArmOperation
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        internal TrafficControllerArmOperation(Response response)
        {
            _operation = OperationInternal.Succeeded(response);
        }

        internal TrafficControllerArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia)
        {
            ...
            _operation = new OperationInternal(clientDiagnostics, nextLinkOperation, response, "TrafficControllerArmOperation", fallbackStrategy: new ExponentialDelayStrategy());
        }
