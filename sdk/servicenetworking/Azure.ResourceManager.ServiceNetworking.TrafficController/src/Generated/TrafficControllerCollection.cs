...
namespace Azure.ResourceManager.ServiceNetworking.TrafficController
{
    ...
    public partial class TrafficControllerCollection : ArmCollection, IEnumerable<TrafficControllerResource>, IAsyncEnumerable<TrafficControllerResource>
    {
        ...
        {
            _trafficControllerTrafficControllerInterfaceClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.ServiceNetworking.TrafficController", TrafficControllerResource.ResourceType.Namespace, Diagnostics);
        ...
        /// Operation Id: TrafficControllerInterface_CreateOrUpdate
        /// </summary>
        ...
        public virtual async Task<ArmOperation<TrafficControllerResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string trafficControllerName, TrafficControllerData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new TrafficControllerArmOperation<TrafficControllerResource>(new TrafficControllerOperationSource(Client), _trafficControllerTrafficControllerInterfaceClientDiagnostics, Pipeline, _trafficControllerTrafficControllerInterfaceRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, trafficControllerName, data).Request, response, OperationFinalStateVia.AzureAsyncOperation);
        ...
        /// Request Path: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ServiceNetworking/trafficControllers
        /// Operation Id: TrafficControllerInterface_ListByResourceGroup
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        ...
        public virtual AsyncPageable<TrafficControllerResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _trafficControllerTrafficControllerInterfaceClientDiagnostics.CreateScope("TrafficControllerCollection.GetAll");
                scope.Start();
                try
                {
                    var response = await _trafficControllerTrafficControllerInterfaceRestClient.ListByResourceGroupAsync(Id.SubscriptionId, Id.ResourceGroupName, cancellationToken: cancellationToken).ConfigureAwait(false);
            ...
            async Task<Page<TrafficControllerResource>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _trafficControllerTrafficControllerInterfaceRestClient.ListByResourceGroupNextPageAsync(nextLink, Id.SubscriptionId, Id.ResourceGroupName, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new TrafficControllerResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual Pageable<TrafficControllerResource> GetAll(CancellationToken cancellationToken = default)
        {
            Page<TrafficControllerResource> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _trafficControllerTrafficControllerInterfaceRestClient.ListByResourceGroup(Id.SubscriptionId, Id.ResourceGroupName, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new TrafficControllerResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            Page<TrafficControllerResource> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _trafficControllerTrafficControllerInterfaceRestClient.ListByResourceGroupNextPage(nextLink, Id.SubscriptionId, Id.ResourceGroupName, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new TrafficControllerResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
