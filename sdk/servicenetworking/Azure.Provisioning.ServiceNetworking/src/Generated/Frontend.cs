...
namespace Azure.Provisioning.ServiceNetworking
{
    ...
    public partial class Frontend : ProvisionableResource
    {
        ...
        /// <summary> Creates a new Frontend. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public Frontend(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.ServiceNetworking/trafficControllers/frontends", resourceVersion ?? "2025-01-01")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for Frontend. </summary>
        ...
        /// <summary> Creates a reference to an existing Frontend. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static Frontend FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            Frontend result = new Frontend(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for Frontend that are not part of the generated code. </summary>
