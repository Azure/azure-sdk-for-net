...
namespace Azure.Provisioning.ServiceNetworking
{
    ...
    public partial class Association : ProvisionableResource
    {
        ...
        /// <summary> Creates a new Association. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public Association(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.ServiceNetworking/trafficControllers/associations", resourceVersion ?? "2025-01-01")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for Association. </summary>
        ...
        /// <summary> Creates a reference to an existing Association. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static Association FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            Association result = new Association(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for Association that are not part of the generated code. </summary>
