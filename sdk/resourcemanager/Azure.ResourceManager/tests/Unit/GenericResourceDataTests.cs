...
namespace Azure.ResourceManager.Tests
{
    ...
    public class GenericResourceDataTests
    {
        ...
        public void SerializationTestType1()
        {
            ...
            ArmPlan plan = new ArmPlan("NameForPlan", "PublisherForPlan", "ProductForPlan", "PromotionCodeForPlan", "VersionForPlan", new Dictionary<string, BinaryData>());
            ResourcesSku sku = new ResourcesSku("NameForSku", ArmSkuTier.Basic.ToString(), "SizeForSku", "FamilyForSku", "ModelForSku", 15464547, new Dictionary<string, BinaryData>());
            GenericResourceData data = new GenericResourceData(id, id.Name, id.ResourceType, null, new Dictionary<string, string>(), AzureLocation.EastUS, null, plan, null, "KindForResource", "ManagedByForResource", sku, null, null, null, null, new Dictionary<string, BinaryData>());
        ...
        public void SerializationTestType2()
        {
            ...
            ResourceIdentifier id = new ResourceIdentifier(Id);
            var plan = new ArmPlan("NameForPlan", "PublisherForPlan", "ProductForPlan", "PromotionCodeForPlan", "VersionForPlan", new Dictionary<string, BinaryData>());
            var kind = "KindForResource";
            var managedBy = "ManagedByForResource";
            var sku = new ResourcesSku("NameForSku", ArmSkuTier.Basic.ToString(), "SizeForSku", "FamilyForSku", "ModelForSku", 15464547, new Dictionary<string, BinaryData>());
            GenericResourceData genericResource = new GenericResourceData(id, id.Name, id.ResourceType, null, new Dictionary<string, string>(), AzureLocation.EastUS, null, plan, null, kind, managedBy, sku, null, null, null, null, new Dictionary<string, BinaryData>());
        ...
        public void InvalidSerializationTest()
        {
            ...
            ResourceIdentifier id = new ResourceIdentifier(Id);
            GenericResourceData data = new GenericResourceData(id, id.Name, id.ResourceType, null, new Dictionary<string, string>(), AzureLocation.EastUS, null, null, null, null, null, null, null, null, null, null, new Dictionary<string, BinaryData>());
