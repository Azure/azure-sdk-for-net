...
namespace Azure.ResourceManager.Tests
{
    public class FeatureOperationsTests : ResourceManagerTestBase
    {
        ...
        public void NoDataValidation()
        {
            ...
            var resource = Client.GetArmFeature(new ResourceIdentifier($"/subscriptions/{Guid.NewGuid()}/providers/Microsoft.Features/providers/Microsoft.FakeNamespace/features/fakeFeature"));
        ...
        public async Task Get()
        {
            ...
            ArmFeature featureFromCollection = await GetFirst(provider.GetArmFeatures().GetAllAsync());
            ArmFeature feature = await featureFromCollection.GetAsync();
            ...
            var ex = Assert.ThrowsAsync<RequestFailedException>(async () => _ = await Client.GetArmFeature(invalidId).GetAsync());
            Assert.AreEqual(404, ex.Status);
        }

        private async Task<ArmFeature> GetFirst(AsyncPageable<ArmFeature> asyncPageable, bool? isRegistered = null)
        {
            ArmFeature result = null;
        ...
        public async Task RegisterAndUnregister()
        {
            ...
            ArmFeature afterRegister = await feature.RegisterAsync();
            ...
            ArmFeature afterUnRegister = await feature.UnregisterAsync();
