...
namespace Azure.ResourceManager.Tests
{
    public class LroRehydrationTests : ResourceManagerTestBase
    {
        ...
        public async Task CreateDeleteResourceGroup()
        {
            ...
            var rehydratedOperation = new ArmOperation<ResourceGroupExportResult>(Client, originalOperationToken);
            ...
            var rehydratedDeleteOperation = new ArmOperation(Client, originalDeleteOperationToken);
