...
namespace Azure.ResourceManager.Tests
{
    public class PolicyExemptionCollectionTests : ResourceManagerTestBase
    {
        ...
        public async Task CreateOrUpdateAtMgmtGroup()
        {
            ...
            Assert.ThrowsAsync<ArgumentNullException>(async () => _ = await mgmtGroup.GetPolicyExemptions().CreateOrUpdateAsync(null, policyExemption.Data));
            Assert.ThrowsAsync<ArgumentNullException>(async () => _ = await mgmtGroup.GetPolicyExemptions().CreateOrUpdateAsync(policyExemptionName, null));
        }
        ...
        public async Task CreateOrUpdateAtResourceGroup()
        {
            ...
            Assert.AreEqual(policyExemptionName, policyExemption.Data.Name);
            Assert.ThrowsAsync<ArgumentNullException>(async () => _ = await rg.GetPolicyExemptions().CreateOrUpdateAsync(null, policyExemption.Data));
        ...
        public async Task CreateOrUpdateAtSubscription()
        {
            ...
            Assert.AreEqual(policyExemptionName, policyExemption.Data.Name);
            Assert.ThrowsAsync<ArgumentNullException>(async () => _ = await subscription.GetPolicyExemptions().CreateOrUpdateAsync(null, policyExemption.Data));
            Assert.ThrowsAsync<ArgumentNullException>(async () => _ = await subscription.GetPolicyExemptions().CreateOrUpdateAsync(policyExemptionName, null));
        }
        ...
        public async Task CreateOrUpdateAtResource()
        {
            ...
            Assert.AreEqual(policyExemptionName, policyExemption.Data.Name);
            Assert.ThrowsAsync<ArgumentNullException>(async () => _ = await vn.GetPolicyExemptions().CreateOrUpdateAsync(null, policyExemption.Data));
            Assert.ThrowsAsync<ArgumentNullException>(async () => _ = await vn.GetPolicyExemptions().CreateOrUpdateAsync(policyExemptionName, null));
        }
