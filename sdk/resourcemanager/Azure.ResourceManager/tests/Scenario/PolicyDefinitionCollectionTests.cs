...
namespace Azure.ResourceManager.Tests
{
    public class PolicyDefinitionCollectionTests : ResourceManagerTestBase
    {
        ...
        public async Task CreateOrUpdateAtSubscription()
        {
            ...
            Assert.ThrowsAsync<ArgumentNullException>(async () => _ = await subscription.GetSubscriptionPolicyDefinitions().CreateOrUpdateAsync(null, policyDefinition.Data));
            Assert.ThrowsAsync<ArgumentNullException>(async () => _ = await subscription.GetSubscriptionPolicyDefinitions().CreateOrUpdateAsync(policyDefinitionName, null));
        ...
        public async Task CreateOrUpdateAtMgmtGroup()
        {
            ...
            Assert.AreEqual(policyDefinitionName, policyDefinition.Data.Name);
            Assert.ThrowsAsync<ArgumentNullException>(async () => _ = await mgmtGroup.GetManagementGroupPolicyDefinitions().CreateOrUpdateAsync(null, policyDefinition.Data));
            Assert.ThrowsAsync<ArgumentNullException>(async () => _ = await mgmtGroup.GetManagementGroupPolicyDefinitions().CreateOrUpdateAsync(policyDefinitionName, null));
        }
