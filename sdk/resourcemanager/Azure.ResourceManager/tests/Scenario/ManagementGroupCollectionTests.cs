...
namespace Azure.ResourceManager.Tests
{
    public class ManagementGroupCollectionTests : ResourceManagerTestBase
    {
        ...
        public async Task GetGlobalManagementGroup()
        {
            ...
            var mgmtOp = await mgmtGroupCollection.CreateOrUpdateAsync(WaitUntil.Completed, _mgmtGroupName, new ManagementGroupCreateOrUpdateInfo());
        ...
        public async Task CreateOrUpdate()
        {
            ...
            var mgmtGroupOp = await Client.GetManagementGroups().CreateOrUpdateAsync(WaitUntil.Started, mgmtGroupName, new ManagementGroupCreateOrUpdateInfo());
