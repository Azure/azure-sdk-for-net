...
namespace Azure.ResourceManager.ManagementGroups
{
    ...
    public partial class ManagementGroupCollection : ArmCollection, IEnumerable<ManagementGroupResource>, IAsyncEnumerable<ManagementGroupResource>
    {
        ...
        public virtual async Task<ArmOperation<ManagementGroupResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string groupId, CreateManagementGroupData data, string cacheControl = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _managementGroupRestClient.CreateOrUpdateAsync(groupId, data, cacheControl, cancellationToken).ConfigureAwait(false);
                var operation = new ManagementGroupsArmOperation<ManagementGroupResource>(new ManagementGroupOperationSource(Client), _managementGroupClientDiagnostics, Pipeline, _managementGroupRestClient.CreateCreateOrUpdateRequest(groupId, data, cacheControl).Request, response, OperationFinalStateVia.AzureAsyncOperation);
        ...
        /// <exception cref="ArgumentException"> <paramref name="groupId"/> is an empty string, and was expected to be non-empty. </exception>
        /// <exception cref="ArgumentNullException"> <paramref name="groupId"/> or <paramref name="data"/> is null. </exception>
        public virtual ArmOperation<ManagementGroupResource> CreateOrUpdate(WaitUntil waitUntil, string groupId, CreateManagementGroupData data, string cacheControl = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(groupId, nameof(groupId));
            Argument.AssertNotNull(data, nameof(data));
            ...
            try
            {
                var response = _managementGroupRestClient.CreateOrUpdate(groupId, data, cacheControl, cancellationToken);
                var operation = new ManagementGroupsArmOperation<ManagementGroupResource>(new ManagementGroupOperationSource(Client), _managementGroupClientDiagnostics, Pipeline, _managementGroupRestClient.CreateCreateOrUpdateRequest(groupId, data, cacheControl).Request, response, OperationFinalStateVia.AzureAsyncOperation);
                if (waitUntil == WaitUntil.Completed)
        ...
        {
            async Task<Page<ManagementGroupResource>> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    ...
                    return Page.FromValues(response.Value.Value.Select(value => new ManagementGroupResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
                    scope.Failed(e);
            ...
            async Task<Page<ManagementGroupResource>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                using var scope = _managementGroupClientDiagnostics.CreateScope("ManagementGroupCollection.GetAll");
                scope.Start();
                try
        ...
        {
            Page<ManagementGroupResource> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _managementGroupClientDiagnostics.CreateScope("ManagementGroupCollection.GetAll");
                scope.Start();
                try
            ...
            Page<ManagementGroupResource> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                using var scope = _managementGroupClientDiagnostics.CreateScope("ManagementGroupCollection.GetAll");
                scope.Start();
                try
