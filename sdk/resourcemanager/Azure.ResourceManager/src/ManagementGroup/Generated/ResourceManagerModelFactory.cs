...
namespace Azure.ResourceManager.Models
{
    ...
    public static partial class ResourceManagerModelFactory
    {
        ...
        {
            return new DescendantData(id, name, resourceType, systemData, displayName, parentId != null ? new DescendantParentGroupInfo(parentId, new Dictionary<string, BinaryData>()) : null, serializedAdditionalRawData: null);
        }
