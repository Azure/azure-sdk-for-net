...
namespace Azure.ResourceManager.ManagementGroups.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DescendantData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DescendantData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DescendantData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DescendantData>)} interface");
            }
        ...
        string IPersistableModel<DescendantData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
