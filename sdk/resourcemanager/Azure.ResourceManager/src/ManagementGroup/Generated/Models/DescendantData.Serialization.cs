...
{
    public partial class DescendantData : IUtf8JsonSerializable, IJsonModel<DescendantData>, IPersistableModel<DescendantData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Parent))
            {
                ...
                AppendChildObject(builder, Parent, options, 2);
            }
