...
namespace Azure.ResourceManager.ManagementGroups.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DescendantListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DescendantListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DescendantListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DescendantListResult>)} interface");
            }
        ...
        string IPersistableModel<DescendantListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
