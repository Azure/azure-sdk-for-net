...
namespace Azure.ResourceManager.ManagementGroups.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DescendantListResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DescendantListResult)} does not support writing '{format}' format.");
            }
        ...
        DescendantListResult IJsonModel<DescendantListResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DescendantListResult)} does not support reading '{format}' format.");
            }
        ...
        internal static DescendantListResult DeserializeDescendantListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new DescendantListResult(value, nextLink, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<DescendantListResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(DescendantListResult)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        DescendantListResult IPersistableModel<DescendantListResult>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(DescendantListResult)} does not support reading '{options.Format}' format.");
            }
        }
