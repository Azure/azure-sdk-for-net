...
namespace Azure.ResourceManager.ManagementGroups.Models
{
    ...
    public partial class ManagementGroupChildOptions
    {
        ...
        internal ManagementGroupChildOptions(ManagementGroupChildType? childType, string id, string name, string displayName, IReadOnlyList<ManagementGroupChildOptions> children, Dictionary<string, BinaryData> rawData)
        {
            ChildType = childType;
            Id = id;
            Name = name;
