...
namespace Azure.ResourceManager.ManagementGroups.Models
{
    ...
    public partial class DescendantData : ResourceData
    {
        ...
        internal DescendantData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string displayName, DescendantParentGroupInfo parent, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
