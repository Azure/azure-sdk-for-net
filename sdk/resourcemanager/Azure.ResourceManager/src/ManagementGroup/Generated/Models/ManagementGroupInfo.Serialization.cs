...
namespace Azure.ResourceManager.ManagementGroups.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ManagementGroupInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ManagementGroupInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ManagementGroupInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ManagementGroupInfo>)} interface");
            }
        ...
        string IPersistableModel<ManagementGroupInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
