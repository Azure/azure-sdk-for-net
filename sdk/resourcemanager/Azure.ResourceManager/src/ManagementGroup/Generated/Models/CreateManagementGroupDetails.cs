...
namespace Azure.ResourceManager.ManagementGroups.Models
{
    ...
    public partial class CreateManagementGroupDetails
    {
        ...
        internal CreateManagementGroupDetails(int? version, DateTimeOffset? updatedOn, string updatedBy, ManagementGroupParentCreateOptions parent, Dictionary<string, BinaryData> rawData)
        {
            Version = version;
            UpdatedOn = updatedOn;
            UpdatedBy = updatedBy;
