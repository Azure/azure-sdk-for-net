...
namespace Azure.ResourceManager.Management.Models
{
    ...
    public partial class DescendantInfo : Resource
    {
        ...
        internal DescendantInfo(ResourceIdentifier id, string name, ResourceType type, SystemData systemData, string displayName, SubResource parent) : base(id, name, type, systemData)
        {
