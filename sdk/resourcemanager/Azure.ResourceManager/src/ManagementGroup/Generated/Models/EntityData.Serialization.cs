...
{
    public partial class EntityData : IUtf8JsonSerializable, IJsonModel<EntityData>, IPersistableModel<EntityData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(InheritedPermissions))
            {
                ...
                builder.AppendLine($" '{InheritedPermissions.ToString()}'");
            }

            if (Optional.IsDefined(NumberOfDescendants))
            {
                builder.Append("  numberOfDescendants:");
                builder.AppendLine($" '{NumberOfDescendants.Value.ToString()}'");
            }

            if (Optional.IsDefined(NumberOfChildren))
            {
                builder.Append("  numberOfChildren:");
                builder.AppendLine($" '{NumberOfChildren.Value.ToString()}'");
            }

            if (Optional.IsDefined(NumberOfChildGroups))
            {
                builder.Append("  numberOfChildGroups:");
                builder.AppendLine($" '{NumberOfChildGroups.Value.ToString()}'");
            }
