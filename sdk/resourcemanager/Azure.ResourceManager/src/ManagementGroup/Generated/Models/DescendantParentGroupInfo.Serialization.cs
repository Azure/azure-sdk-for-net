...
namespace Azure.ResourceManager.ManagementGroups.Models
{
    internal partial class DescendantParentGroupInfo : IUtf8JsonSerializable, IJsonModel<DescendantParentGroupInfo>
    {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<DescendantParentGroupInfo>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DescendantParentGroupInfo)} does not support writing '{format}' format.");
            }
        ...
        DescendantParentGroupInfo IJsonModel<DescendantParentGroupInfo>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DescendantParentGroupInfo)} does not support reading '{format}' format.");
            }
        ...
        internal static DescendantParentGroupInfo DeserializeDescendantParentGroupInfo(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new DescendantParentGroupInfo(id, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<DescendantParentGroupInfo>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(DescendantParentGroupInfo)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        DescendantParentGroupInfo IPersistableModel<DescendantParentGroupInfo>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(DescendantParentGroupInfo)} does not support reading '{options.Format}' format.");
            }
        }
