...
namespace Azure.ResourceManager.ManagementGroups.Models
{
    ...
    public partial class ManagementGroupCreateOrUpdateContent
    {
        ...
        internal ManagementGroupCreateOrUpdateContent(string id, ResourceType? resourceType, string name, Guid? tenantId, string displayName, CreateManagementGroupDetails details, IReadOnlyList<ManagementGroupChildOptions> children, Dictionary<string, BinaryData> rawData)
        {
            Id = id;
