...
namespace Azure.ResourceManager.ManagementGroups.Models
{
    ...
    public partial class ManagementGroupChildInfo
    {
        ...
        /// <summary> Initializes a new instance of ManagementGroupChildInfo. </summary>
        /// <param name="groupChildType"> The fully qualified resource type which includes provider namespace (e.g. Microsoft.Management/managementGroups). </param>
        ...
        internal ManagementGroupChildInfo(ManagementGroupChildType? groupChildType, string id, string name, string displayName, IReadOnlyList<ManagementGroupChildInfo> children)
        {
