...
namespace Azure.ResourceManager.ManagementGroups.Models
{
    ...
    public partial class ManagementGroupChildInfo
    {
        ...
        internal ManagementGroupChildInfo(ManagementGroupChildType? childType, string id, string name, string displayName, IReadOnlyList<ManagementGroupChildInfo> children, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ChildType = childType;
            Id = id;
            Name = name;
