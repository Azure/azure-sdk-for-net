...
namespace Azure.ResourceManager.ManagementGroups.Models
{
    ...
    {
        internal static ManagementGroupChildInfo DeserializeManagementGroupChildInfo(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
