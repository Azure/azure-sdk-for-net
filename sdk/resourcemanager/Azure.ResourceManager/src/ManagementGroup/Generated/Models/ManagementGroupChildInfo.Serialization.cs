...
{
    public partial class ManagementGroupChildInfo : IUtf8JsonSerializable, IJsonModel<ManagementGroupChildInfo>, IPersistableModel<ManagementGroupChildInfo>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  type:");
                builder.AppendLine($" '{ChildType.ToString()}'");
            }
