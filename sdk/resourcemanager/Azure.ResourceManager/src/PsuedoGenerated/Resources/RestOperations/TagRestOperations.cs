...
namespace Azure.ResourceManager.Resources
{
    internal partial class TagRestOperations
    {
        ...
        public TagRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ArmClientOptions options, string subscriptionId, Uri endpoint = null)
        {
            ...
            _apiVersion = options.ResourceApiVersionOverrides.TryGetValue(TagResource.ResourceType, out var version) ? version : TagResourceVersion.Default.ToString();
        }
