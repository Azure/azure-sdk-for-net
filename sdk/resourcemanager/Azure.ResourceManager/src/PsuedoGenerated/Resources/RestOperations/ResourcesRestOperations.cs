...
namespace Azure.ResourceManager.Resources
{
    internal partial class ResourcesRestOperations
    {
        ...
        public ResourcesRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ArmClientOptions options, string subscriptionId, Uri endpoint = null)
        {
            ...
            _apiVersion = options.ResourceApiVersionOverrides.TryGetValue(GenericResource.ResourceType, out var version) ? version : GenericResourceVersion.Default.ToString();
        }
