...
{
    /// <summary>
    /// A class representing the PolicySetDefinitionVersion data model.
    ...
    public partial class PolicySetDefinitionVersionData : ResourceData
    {
        ...
        internal PolicySetDefinitionVersionData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, PolicyType? policyType, string displayName, string description, BinaryData metadata, IDictionary<string, ArmPolicyParameter> parameters, IList<PolicyDefinitionReference> policyDefinitions, IList<PolicyDefinitionGroup> policyDefinitionGroups, string version, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
