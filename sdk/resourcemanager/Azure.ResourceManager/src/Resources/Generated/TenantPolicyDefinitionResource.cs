...
namespace Azure.ResourceManager.Resources
{
    ...
    public partial class TenantPolicyDefinitionResource : ArmResource
    {
        ...
        internal TenantPolicyDefinitionResource(ArmClient client, PolicyDefinitionData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<TenantPolicyDefinitionResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new TenantPolicyDefinitionResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
