...
namespace Azure.ResourceManager.Resources
{
    ...
    public partial class FeatureData : ResourceData
    {
        ...
        internal FeatureData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, FeatureProperties properties, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
