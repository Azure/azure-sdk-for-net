...
namespace Azure.ResourceManager.Resources
{
    ...
    public partial class GenericResourceData : TrackedResourceExtended
    {
        ...
        internal GenericResourceData(ResourceIdentifier id, string name, ResourceType type, IDictionary<string, string> tags, AzureLocation location, ExtendedLocation extendedLocation, Plan plan, object properties, string kind, string managedBy, Models.Sku sku, ManagedServiceIdentity identity, DateTimeOffset? createdTime, DateTimeOffset? changedTime, string provisioningState) : base(id, name, type, tags, location, extendedLocation)
        {
            Plan = plan;
