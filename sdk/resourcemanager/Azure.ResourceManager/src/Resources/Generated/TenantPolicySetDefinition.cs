...
namespace Azure.ResourceManager.Resources
{
    ...
    public partial class TenantPolicySetDefinition : ArmResource
    {
        ...
        internal TenantPolicySetDefinition(ArmClient armClient, PolicySetDefinitionData data) : this(armClient, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal TenantPolicySetDefinition(ArmClient armClient, ResourceIdentifier id) : base(armClient, id)
        {
            ...
            ArmClient.TryGetApiVersion(ResourceType, out string tenantPolicySetDefinitionPolicySetDefinitionsApiVersion);
        ...
        {
            using var scope = _tenantPolicySetDefinitionPolicySetDefinitionsClientDiagnostics.CreateScope("TenantPolicySetDefinition.GetAvailableLocations");
            scope.Start();
            try
            {
