...
namespace Azure.ResourceManager.Resources
{
    ...
    public partial class TenantPolicySetDefinition : ArmResource
    {
        ...
        internal TenantPolicySetDefinition(ArmResource options, PolicySetDefinitionData data) : base(options, data.Id)
        {
            HasData = true;
            _data = data;
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("TenantPolicySetDefinition.GetAvailableLocations");
            scope.Start();
            try
            {
