...
namespace Azure.ResourceManager.Resources
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FeatureData>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<FeatureData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Properties))
            {
                ...
                writer.WriteObjectValue<FeatureProperties>(Properties, options);
            }
            if (options.Format != "W")
            {
