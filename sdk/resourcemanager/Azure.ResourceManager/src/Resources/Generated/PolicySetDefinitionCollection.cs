...
namespace Azure.ResourceManager.Resources
{
    ...
    public partial class PolicySetDefinitionCollection : ArmCollection, IEnumerable<PolicySetDefinition>, IAsyncEnumerable<PolicySetDefinition>
    {
        private readonly ClientDiagnostics _clientDiagnostics;
        private readonly PolicySetDefinitionsRestOperations _restClient;

        /// <summary> Initializes a new instance of the <see cref="PolicySetDefinitionCollection"/> class for mocking. </summary>
        protected PolicySetDefinitionCollection()
        {
        }

        /// <summary> Initializes a new instance of PolicySetDefinitionCollection class. </summary>
        /// <param name="parent"> The resource representing the parent resource. </param>
        internal PolicySetDefinitionCollection(ArmResource parent) : base(parent)
        {
            _clientDiagnostics = new ClientDiagnostics(ClientOptions);
            _restClient = new PolicySetDefinitionsRestOperations(_clientDiagnostics, Pipeline, ClientOptions, BaseUri);
        }

        IEnumerator<PolicySetDefinition> IEnumerable<PolicySetDefinition>.GetEnumerator()
        {
        ...
        IAsyncEnumerator<PolicySetDefinition> IAsyncEnumerable<PolicySetDefinition>.GetAsyncEnumerator(CancellationToken cancellationToken)
        {
        ...
        public virtual PolicySetDefinitionCreateOrUpdateOperation CreateOrUpdate(string policySetDefinitionName, PolicySetDefinitionData parameters, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("PolicySetDefinitionCollection.CreateOrUpdate");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("PolicySetDefinitionCollection.Get");
            scope.Start();
            try
            {
                if (policySetDefinitionName == null)
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("PolicySetDefinitionCollection.GetIfExists");
            scope.Start();
            try
            {
                if (policySetDefinitionName == null)
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("PolicySetDefinitionCollection.CheckIfExists");
            scope.Start();
            try
            {
                if (policySetDefinitionName == null)
        ...
        public virtual Pageable<PolicySetDefinition> GetAll(string filter = null, int? top = null, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("PolicySetDefinitionCollection.GetAll");
                scope.Start();
                try
                {
                    if (Id.TryGetSubscriptionId(out _))
