...
namespace Azure.ResourceManager.Resources
{
    ...
    /// </summary>
    public partial class SubscriptionPolicyDefinitionResource : BasePolicyDefinitionResource
    {
        ...
        protected override async Task<Response<T>> GetCoreAsync<T>(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new SubscriptionPolicyDefinitionResource(Client, response.Value) as T, response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public new virtual async Task<Response<SubscriptionPolicyDefinitionResource>> GetAsync(CancellationToken cancellationToken = default)
            => await GetCoreAsync<SubscriptionPolicyDefinitionResource>(cancellationToken).ConfigureAwait(false);
        ...
        public new virtual Response<SubscriptionPolicyDefinitionResource> Get(CancellationToken cancellationToken = default)
            => GetCore<SubscriptionPolicyDefinitionResource>(cancellationToken);
