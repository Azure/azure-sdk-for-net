...
namespace Azure.ResourceManager.Resources
{
    ...
    public partial class PolicyExemption : ArmResource
    {
        ...
        internal PolicyExemption(ArmResource options, PolicyExemptionData data) : base(options, data.Id)
        {
            ...
            _policyExemptionsRestClient = new PolicyExemptionsRestOperations(_clientDiagnostics, Pipeline, DiagnosticOptions.ApplicationId, BaseUri);
#if DEBUG
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("PolicyExemption.GetAvailableLocations");
            scope.Start();
            try
            {
