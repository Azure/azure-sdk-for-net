...
{
    public partial class PolicySetDefinitionVersionData : IUtf8JsonSerializable, IJsonModel<PolicySetDefinitionVersionData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PolicySetDefinitionVersionData>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<PolicySetDefinitionVersionData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        PolicySetDefinitionVersionData IJsonModel<PolicySetDefinitionVersionData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<PolicySetDefinitionVersionData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static PolicySetDefinitionVersionData DeserializePolicySetDefinitionVersionData(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<PolicySetDefinitionVersionData>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<PolicySetDefinitionVersionData>)this).GetFormatFromOptions(options) : options.Format;
        ...
        PolicySetDefinitionVersionData IPersistableModel<PolicySetDefinitionVersionData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<PolicySetDefinitionVersionData>)this).GetFormatFromOptions(options) : options.Format;
