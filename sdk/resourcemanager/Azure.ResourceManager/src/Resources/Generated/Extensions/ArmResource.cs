...
namespace Azure.ResourceManager.Core
{
    public partial class ArmResource
    {
        ...
        {
            return new PolicyAssignmentCollection(ArmClient, this.Id);
        }
        ...
        {
            return new PolicyExemptionCollection(ArmClient, this.Id);
        }
        ...
        {
            return new ManagementLockCollection(ArmClient, this.Id);
        }
    }
}
