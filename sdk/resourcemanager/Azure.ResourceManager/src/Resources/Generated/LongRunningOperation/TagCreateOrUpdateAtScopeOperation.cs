...
namespace Azure.ResourceManager.Resources.Models
{
    ...
    public partial class TagCreateOrUpdateAtScopeOperation : Operation<TagResource>
    {
        private readonly OperationOrResponseInternals<TagResource> _operation;

        /// <summary> Initializes a new instance of TagCreateOrUpdateAtScopeOperation for mocking. </summary>
        protected TagCreateOrUpdateAtScopeOperation()
        {
        }

        internal TagCreateOrUpdateAtScopeOperation(ArmResource operationsBase, Response<TagResourceData> response)
        {
