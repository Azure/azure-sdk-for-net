...
namespace Azure.ResourceManager.Resources
{
    ...
    /// </summary>
    public partial class ManagementGroupPolicyDefinitionResource : BasePolicyDefinitionResource
    {
        ...
        protected override async Task<Response<T>> GetCoreAsync<T>(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new ManagementGroupPolicyDefinitionResource(Client, response.Value) as T, response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public new virtual async Task<Response<ManagementGroupPolicyDefinitionResource>> GetAsync(CancellationToken cancellationToken = default)
            => await GetCoreAsync<ManagementGroupPolicyDefinitionResource>(cancellationToken).ConfigureAwait(false);
        ...
        public new virtual Response<ManagementGroupPolicyDefinitionResource> Get(CancellationToken cancellationToken = default)
            => GetCore<ManagementGroupPolicyDefinitionResource>(cancellationToken);
