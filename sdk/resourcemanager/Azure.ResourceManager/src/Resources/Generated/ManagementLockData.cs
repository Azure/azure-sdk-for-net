...
namespace Azure.ResourceManager.Resources
{
    ...
    public partial class ManagementLockData : ResourceData
    {
        ...
        internal ManagementLockData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, ManagementLockLevel level, string notes, IList<ManagementLockOwner> owners, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData)
        {
            Level = level;
            Notes = notes;
            Owners = owners;
