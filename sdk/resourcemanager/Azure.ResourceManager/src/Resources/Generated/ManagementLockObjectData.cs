...
namespace Azure.ResourceManager.Resources
{
    ...
    public partial class ManagementLockObjectData : Resource
    {
        ...
        internal ManagementLockObjectData(ResourceIdentifier id, string name, ResourceType type, SystemData systemData, LockLevel level, string notes, IList<ManagementLockOwner> owners) : base(id, name, type, systemData)
        {
            Level = level;
            Notes = notes;
            Owners = owners;
