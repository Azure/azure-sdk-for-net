...
namespace Azure.ResourceManager.Resources
{
    ...
    public partial class ResourceProviderData
    {
        ...
        internal ResourceProviderData(ResourceIdentifier id, string @namespace, string registrationState, string registrationPolicy, IReadOnlyList<ProviderResourceType> resourceTypes, ProviderAuthorizationConsentState? providerAuthorizationConsentState, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Namespace = @namespace;
