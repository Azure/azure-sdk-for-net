...
namespace Azure.ResourceManager.Resources
{
    ...
    public partial class FeatureCollection : ArmCollection, IEnumerable<FeatureResource>, IAsyncEnumerable<FeatureResource>
    {
        ...
        {
            if (id.ResourceType != ProviderResource.ResourceType)
                throw new ArgumentException(string.Format(CultureInfo.CurrentCulture, "Invalid resource type {0} expected {1}", id.ResourceType, ProviderResource.ResourceType), nameof(id));
        }
