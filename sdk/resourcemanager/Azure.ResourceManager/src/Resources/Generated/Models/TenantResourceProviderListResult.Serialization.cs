...
namespace Azure.ResourceManager.Resources.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TenantResourceProviderListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<TenantResourceProviderListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<TenantResourceProviderListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<TenantResourceProviderListResult>)} interface");
            }
        ...
        string IPersistableModel<TenantResourceProviderListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
