...
namespace Azure.ResourceManager.Resources.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TenantResourceProviderListResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(TenantResourceProviderListResult)} does not support writing '{format}' format.");
            }
        ...
        TenantResourceProviderListResult IJsonModel<TenantResourceProviderListResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(TenantResourceProviderListResult)} does not support reading '{format}' format.");
            }
        ...
        internal static TenantResourceProviderListResult DeserializeTenantResourceProviderListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            IReadOnlyList<TenantResourceProvider> value = default;
            ...
            return new TenantResourceProviderListResult(value ?? new ChangeTrackingList<TenantResourceProvider>(), nextLink, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<TenantResourceProviderListResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(TenantResourceProviderListResult)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        TenantResourceProviderListResult IPersistableModel<TenantResourceProviderListResult>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(TenantResourceProviderListResult)} does not support reading '{options.Format}' format.");
            }
        }
