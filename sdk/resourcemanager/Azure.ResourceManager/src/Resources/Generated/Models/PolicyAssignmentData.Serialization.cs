...
namespace Azure.ResourceManager.Resources
{
    public partial class PolicyAssignmentData : IUtf8JsonSerializable, IModelJsonSerializable<PolicyAssignmentData>
    {
        ...
        internal static PolicyAssignmentData DeserializePolicyAssignmentData(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new PolicyAssignmentData(id, name, type, systemData.Value, Optional.ToNullable(location), identity, displayName.Value, policyDefinitionId.Value, scope.Value, Optional.ToList(notScopes), Optional.ToDictionary(parameters), description.Value, metadata.Value, Optional.ToNullable(enforcementMode), Optional.ToList(nonComplianceMessages), Optional.ToList(resourceSelectors), Optional.ToList(overrides), rawData);
        }
