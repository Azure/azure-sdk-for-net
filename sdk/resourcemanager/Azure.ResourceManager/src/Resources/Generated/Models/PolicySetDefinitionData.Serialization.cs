...
namespace Azure.ResourceManager.Resources
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PolicySetDefinitionData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PolicySetDefinitionData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PolicySetDefinitionData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PolicySetDefinitionData>)} interface");
            }
        ...
        string IPersistableModel<PolicySetDefinitionData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
