...
{
    public partial class PolicySetDefinitionData : IUtf8JsonSerializable, IJsonModelSerializable
    {
        ...
        object IModelSerializable.Deserialize(BinaryData data, ModelSerializerOptions options) => DeserializePolicySetDefinitionData(JsonDocument.Parse(data).RootElement);
