...
{
    public partial class ArmPolicyParameter : IUtf8JsonSerializable, IJsonModelSerializable
    {
        ...
        object IModelSerializable.Deserialize(BinaryData data, ModelSerializerOptions options) => DeserializeArmPolicyParameter(JsonDocument.Parse(data).RootElement);
