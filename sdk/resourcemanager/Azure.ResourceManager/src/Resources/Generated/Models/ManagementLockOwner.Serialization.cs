...
{
    public partial class ManagementLockOwner : IUtf8JsonSerializable, IJsonModel<ManagementLockOwner>, IPersistableModel<ManagementLockOwner>
    {
        ...
        void IJsonModel<ManagementLockOwner>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ManagementLockOwner)} does not support '{format}' format.");
            }
