...
namespace Azure.ResourceManager.Resources.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ManagementLockOwner>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ManagementLockOwner>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ManagementLockOwner>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ManagementLockOwner>)} interface");
            }
        ...
        string IPersistableModel<ManagementLockOwner>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
