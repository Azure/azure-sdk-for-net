...
{
    public partial class ResourceSelectorExpression : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ResourceSelectorExpression DeserializeResourceSelectorExpression(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
