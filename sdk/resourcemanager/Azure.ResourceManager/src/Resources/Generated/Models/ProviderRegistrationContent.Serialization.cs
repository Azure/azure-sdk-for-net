...
namespace Azure.ResourceManager.Resources.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ProviderRegistrationContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ProviderRegistrationContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ProviderRegistrationContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ProviderRegistrationContent>)} interface");
            }
        ...
        string IPersistableModel<ProviderRegistrationContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
