...
{
    public partial class ResourceTypeAliasPath : IUtf8JsonSerializable, IJsonModel<ResourceTypeAliasPath>, IPersistableModel<ResourceTypeAliasPath>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Pattern))
            {
                ...
                AppendChildObject(builder, Pattern, options, 2);
            }
