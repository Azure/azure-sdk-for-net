...
namespace Azure.ResourceManager.Resources.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataPolicyManifestListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DataPolicyManifestListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DataPolicyManifestListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DataPolicyManifestListResult>)} interface");
            }
        ...
        string IPersistableModel<DataPolicyManifestListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
