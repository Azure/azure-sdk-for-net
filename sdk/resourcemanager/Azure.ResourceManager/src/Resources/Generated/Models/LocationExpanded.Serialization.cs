...
namespace Azure.ResourceManager.Resources.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LocationExpanded>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<LocationExpanded>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<LocationExpanded>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<LocationExpanded>)} interface");
            }
        ...
        string IPersistableModel<LocationExpanded>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
