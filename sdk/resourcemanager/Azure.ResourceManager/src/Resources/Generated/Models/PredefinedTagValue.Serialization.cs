...
{
    public partial class PredefinedTagValue : IUtf8JsonSerializable, IJsonModel<PredefinedTagValue>, IPersistableModel<PredefinedTagValue>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Count))
            {
                ...
                AppendChildObject(builder, Count, options, 2);
            }
