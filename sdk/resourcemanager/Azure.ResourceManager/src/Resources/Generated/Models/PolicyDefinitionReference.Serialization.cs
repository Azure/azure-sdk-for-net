...
{
    public partial class PolicyDefinitionReference : IUtf8JsonSerializable, IJsonModelSerializable
    {
        ...
        object IModelSerializable.Deserialize(BinaryData data, ModelSerializerOptions options) => DeserializePolicyDefinitionReference(JsonDocument.Parse(data).RootElement);
