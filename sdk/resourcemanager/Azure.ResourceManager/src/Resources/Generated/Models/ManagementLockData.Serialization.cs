...
{
    public partial class ManagementLockData : IUtf8JsonSerializable, IJsonModelSerializable
    {
        ...
        object IModelSerializable.Deserialize(BinaryData data, ModelSerializerOptions options) => DeserializeManagementLockData(JsonDocument.Parse(data).RootElement);
