...
namespace Azure.ResourceManager.Resources.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ProviderResourceTypeListResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ProviderResourceTypeListResult)} does not support writing '{format}' format.");
            }
        ...
        ProviderResourceTypeListResult IJsonModel<ProviderResourceTypeListResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ProviderResourceTypeListResult)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ProviderResourceTypeListResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ProviderResourceTypeListResult)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        ProviderResourceTypeListResult IPersistableModel<ProviderResourceTypeListResult>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ProviderResourceTypeListResult)} does not support reading '{options.Format}' format.");
            }
        }
