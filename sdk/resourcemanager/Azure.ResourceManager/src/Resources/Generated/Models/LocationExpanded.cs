...
namespace Azure.ResourceManager.Resources.Models
{
    ...
    public partial class LocationExpanded
    {
        ...
        internal LocationExpanded(string id, string subscriptionId, string name, LocationType? locationType, string displayName, string regionalDisplayName, LocationMetadata metadata, IReadOnlyList<AvailabilityZoneMappings> availabilityZoneMappings, Dictionary<string, BinaryData> rawData)
        {
            Id = id;
