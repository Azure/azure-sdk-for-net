...
namespace Azure.ResourceManager.Resources.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ProviderPermissionListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ProviderPermissionListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ProviderPermissionListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ProviderPermissionListResult>)} interface");
            }
        ...
        string IPersistableModel<ProviderPermissionListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
