...
namespace Azure.ResourceManager.Resources.Models
{
    ...
    public partial class ResourcesSku
    {
        ...
        internal ResourcesSku(string name, string tier, string size, string family, string model, int? capacity, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Tier = tier;
            Size = size;
