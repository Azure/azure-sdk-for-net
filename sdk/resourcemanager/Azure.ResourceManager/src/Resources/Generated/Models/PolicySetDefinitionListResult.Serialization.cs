...
namespace Azure.ResourceManager.Resources.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PolicySetDefinitionListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PolicySetDefinitionListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PolicySetDefinitionListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<PolicySetDefinitionListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
