...
namespace Azure.ResourceManager.Resources.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ResourcesMoveContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ResourcesMoveContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ResourcesMoveContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ResourcesMoveContent>)} interface");
            }
        ...
        string IPersistableModel<ResourcesMoveContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
