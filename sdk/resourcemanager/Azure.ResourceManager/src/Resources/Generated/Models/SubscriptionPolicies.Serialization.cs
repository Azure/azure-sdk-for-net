...
{
    public partial class SubscriptionPolicies : IUtf8JsonSerializable, IJsonModel<SubscriptionPolicies>, IPersistableModel<SubscriptionPolicies>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SpendingLimit))
            {
                ...
                builder.AppendLine($" '{SpendingLimit.ToString()}'");
            }
