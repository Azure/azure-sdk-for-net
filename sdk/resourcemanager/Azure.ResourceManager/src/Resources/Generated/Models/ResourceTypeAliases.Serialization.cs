...
namespace Azure.ResourceManager.Resources.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ResourceTypeAliases>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ResourceTypeAliases>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ResourceTypeAliases>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<ResourceTypeAliases>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
