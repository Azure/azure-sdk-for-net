...
namespace Azure.ResourceManager.Resources.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ArmPolicyParameterValue>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ArmPolicyParameterValue>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ArmPolicyParameterValue>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ArmPolicyParameterValue>)} interface");
            }
        ...
        string IPersistableModel<ArmPolicyParameterValue>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
