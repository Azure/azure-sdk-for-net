...
{
    public partial class SubscriptionData : IUtf8JsonSerializable, IJsonModel<SubscriptionData>, IPersistableModel<SubscriptionData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SubscriptionPolicies))
            {
                ...
                AppendChildObject(builder, SubscriptionPolicies, options, 2);
            }
