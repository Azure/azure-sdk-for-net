...
namespace Azure.ResourceManager.Resources.Models
{
    ...
    public partial class ResourceSelectorExpression
    {
        ...
        internal ResourceSelectorExpression(ResourceSelectorKind? kind, IList<string> @in, IList<string> notIn, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Kind = kind;
            In = @in;
            NotIn = notIn;
