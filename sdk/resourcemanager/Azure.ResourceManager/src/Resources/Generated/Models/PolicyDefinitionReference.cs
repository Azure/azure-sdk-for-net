...
namespace Azure.ResourceManager.Resources.Models
{
    ...
    public partial class PolicyDefinitionReference
    {
        ...
        internal PolicyDefinitionReference(string policyDefinitionId, IDictionary<string, ArmPolicyParameterValue> parameters, string policyDefinitionReferenceId, IList<string> groupNames, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            PolicyDefinitionId = policyDefinitionId;
