...
{
    public partial class ResourcesSku : Core.IUtf8JsonSerializable
    {
        ...
        internal static ResourcesSku DeserializeResourcesSku(JsonElement element)
        {
            ...
            return new ResourcesSku(name.Value, tier.Value, size.Value, family.Value, model.Value, Core.Optional.ToNullable(capacity));
        }
    }
}
