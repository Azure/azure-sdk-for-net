...
{
    public partial class ResourcesSku : IUtf8JsonSerializable, IJsonModelSerializable
    {
        ...
        object IModelSerializable.Deserialize(BinaryData data, ModelSerializerOptions options) => DeserializeResourcesSku(JsonDocument.Parse(data).RootElement);
