...
namespace Azure.ResourceManager.Resources.Models
{
    public partial class ResourcesSku : IUtf8JsonSerializable, IJsonModel<ResourcesSku>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<ResourcesSku>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ResourcesSku>)} interface");
            }
