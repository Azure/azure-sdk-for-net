...
namespace Azure.ResourceManager.Resources.Models
{
    public partial class ZoneMapping : IUtf8JsonSerializable, IModelJsonSerializable<ZoneMapping>
    {
        ...
        void IModelJsonSerializable<ZoneMapping>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<ZoneMapping>(this, options.Format);
        ...
        internal static ZoneMapping DeserializeZoneMapping(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new ZoneMapping(Optional.ToNullable(location), Optional.ToList(zones), rawData);
        }
        ...
        /// <summary> Converts a <see cref="ZoneMapping"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="ZoneMapping"/> to convert. </param>
        public static implicit operator RequestContent(ZoneMapping model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="ZoneMapping"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator ZoneMapping(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeZoneMapping(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
