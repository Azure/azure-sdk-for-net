...
namespace Azure.ResourceManager.Resources
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ResourceGroupData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ResourceGroupData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ResourceGroupData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ResourceGroupData>)} interface");
            }
        ...
        string IPersistableModel<ResourceGroupData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
