...
namespace Azure.ResourceManager.Resources.Models
{
    public partial class ResourceSelector : IUtf8JsonSerializable, IJsonModel<ResourceSelector>
    {
        ...
        void IJsonModel<ResourceSelector>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(ResourceSelector)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ResourceSelector>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(ResourceSelector)} does not support '{options.Format}' format.");
            }
        }
