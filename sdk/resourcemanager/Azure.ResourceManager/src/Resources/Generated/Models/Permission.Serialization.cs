...
namespace Azure.ResourceManager.Resources.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<Permission>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<Permission>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<Permission>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<Permission>)} interface");
            }
        ...
        string IPersistableModel<Permission>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
