...
namespace Azure.ResourceManager.Resources.Models
{
    ...
    public partial class PolicyDefinitionGroup
    {
        ...
        internal PolicyDefinitionGroup(string name, string displayName, string category, string description, string additionalMetadataId, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
