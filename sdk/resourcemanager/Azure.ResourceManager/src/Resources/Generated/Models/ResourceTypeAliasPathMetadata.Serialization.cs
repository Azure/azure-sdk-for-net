...
{
    public partial class ResourceTypeAliasPathMetadata : IUtf8JsonSerializable, IJsonModel<ResourceTypeAliasPathMetadata>, IPersistableModel<ResourceTypeAliasPathMetadata>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Attributes))
            {
                ...
                builder.AppendLine($" '{Attributes.ToString()}'");
            }
