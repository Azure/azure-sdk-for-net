...
namespace Azure.ResourceManager.Resources.Models
{
    ...
    public partial class PredefinedTag
    {
        ...
        internal PredefinedTag(string id, string tagName, PredefinedTagCount count, IReadOnlyList<PredefinedTagValue> values, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            TagName = tagName;
            Count = count;
