...
{
    public partial class ResourceTypeAlias : IUtf8JsonSerializable, IJsonModel<ResourceTypeAlias>, IPersistableModel<ResourceTypeAlias>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  type:");
                builder.AppendLine($" '{AliasType.ToString()}'");
            }
            ...
            if (Optional.IsDefined(DefaultPattern))
            {
                ...
                AppendChildObject(builder, DefaultPattern, options, 2);
            }

            if (Optional.IsDefined(DefaultMetadata))
            {
                builder.Append("  defaultMetadata:");
                AppendChildObject(builder, DefaultMetadata, options, 2);
            }
