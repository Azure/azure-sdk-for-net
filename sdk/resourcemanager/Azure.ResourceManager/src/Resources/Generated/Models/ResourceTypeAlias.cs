...
namespace Azure.ResourceManager.Resources.Models
{
    ...
    public partial class ResourceTypeAlias
    {
        ...
        /// <param name="typeAliasType"> The type of the alias. </param>
        ...
        internal ResourceTypeAlias(string name, IReadOnlyList<ResourceTypeAliasPath> paths, ResourceTypeAliasType? typeAliasType, string defaultPath, ResourceTypeAliasPattern defaultPattern, ResourceTypeAliasPathMetadata defaultMetadata)
        {
            Name = name;
            Paths = paths;
        ...
        public ResourceTypeAliasType? TypeAliasType { get; }
