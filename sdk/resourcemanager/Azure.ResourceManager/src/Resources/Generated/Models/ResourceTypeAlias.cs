...
namespace Azure.ResourceManager.Resources.Models
{
    ...
    public partial class ResourceTypeAlias
    {
        ...
        internal ResourceTypeAlias(string name, IReadOnlyList<AliasPath> paths, AliasType? aliasType, string defaultPath, AliasPattern defaultPattern, AliasPathMetadata defaultMetadata)
        {
            Name = name;
            Paths = paths;
            AliasType = aliasType;
