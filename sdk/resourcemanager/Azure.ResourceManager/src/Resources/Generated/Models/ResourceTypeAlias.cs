...
namespace Azure.ResourceManager.Resources.Models
{
    ...
    public partial class ResourceTypeAlias
    {
        ...
        internal ResourceTypeAlias(string name, IReadOnlyList<ResourceTypeAliasPath> paths, ResourceTypeAliasType? aliasType, string defaultPath, ResourceTypeAliasPattern defaultPattern, ResourceTypeAliasPathMetadata defaultMetadata, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Paths = paths;
            AliasType = aliasType;
