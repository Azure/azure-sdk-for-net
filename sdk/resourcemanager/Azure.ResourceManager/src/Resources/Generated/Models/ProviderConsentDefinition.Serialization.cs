...
namespace Azure.ResourceManager.Resources.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ProviderConsentDefinition>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ProviderConsentDefinition>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ProviderConsentDefinition>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ProviderConsentDefinition>)} interface");
            }
        ...
        string IPersistableModel<ProviderConsentDefinition>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
