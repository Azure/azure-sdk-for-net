...
namespace Azure.ResourceManager.Resources.Models
{
    internal partial class ProviderConsentDefinition : IUtf8JsonSerializable, IJsonModel<ProviderConsentDefinition>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(ConsentToAuthorization), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("  consentToAuthorization: ");
            ...
            else
            {
                ...
                {
                    builder.Append("  consentToAuthorization: ");
                    var boolValue = ConsentToAuthorization.Value == true ? "true" : "false";
