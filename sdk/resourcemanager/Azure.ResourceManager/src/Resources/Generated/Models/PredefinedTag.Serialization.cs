...
namespace Azure.ResourceManager.Resources.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PredefinedTag>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PredefinedTag>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PredefinedTag>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PredefinedTag>)} interface");
            }
        ...
        string IPersistableModel<PredefinedTag>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
