...
namespace Azure.ResourceManager.Resources.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PairedRegion>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PairedRegion>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PairedRegion>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PairedRegion>)} interface");
            }
        ...
        string IPersistableModel<PairedRegion>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
