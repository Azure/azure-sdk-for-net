...
{
    public partial class PolicyOverride : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static PolicyOverride DeserializePolicyOverride(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
