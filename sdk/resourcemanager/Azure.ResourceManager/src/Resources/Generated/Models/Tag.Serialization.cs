...
namespace Azure.ResourceManager.Resources.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<Tag>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<Tag>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<Tag>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<Tag>)} interface");
            }
        ...
        string IPersistableModel<Tag>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
