...
{
    public partial class PolicyDefinitionVersionData : IUtf8JsonSerializable, IJsonModel<PolicyDefinitionVersionData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PolicyDefinitionVersionData>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<PolicyDefinitionVersionData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        PolicyDefinitionVersionData IJsonModel<PolicyDefinitionVersionData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<PolicyDefinitionVersionData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static PolicyDefinitionVersionData DeserializePolicyDefinitionVersionData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("externalEvaluationEnforcementSettings"u8))
                        {
                            if (property0.Value.ValueKind == JsonValueKind.Null)
                            {
                                continue;
                            }
                            externalEvaluationEnforcementSettings = ExternalEvaluationEnforcementSettings.DeserializeExternalEvaluationEnforcementSettings(property0.Value, options);
                            continue;
                        }
                    }
                    continue;
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(ExternalEvaluationEnforcementSettings), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("    externalEvaluationEnforcementSettings: ");
                builder.AppendLine(propertyOverride);
            }
            else
            {
                ...
                {
                    builder.Append("    externalEvaluationEnforcementSettings: ");
                    BicepSerializationHelpers.AppendChildObject(builder, ExternalEvaluationEnforcementSettings, options, 4, false, "    externalEvaluationEnforcementSettings: ");
                }
            }
        ...
        BinaryData IPersistableModel<PolicyDefinitionVersionData>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<PolicyDefinitionVersionData>)this).GetFormatFromOptions(options) : options.Format;
        ...
        PolicyDefinitionVersionData IPersistableModel<PolicyDefinitionVersionData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<PolicyDefinitionVersionData>)this).GetFormatFromOptions(options) : options.Format;
