...
{
    /// <summary>
    /// A class representing the PolicyDefinitionVersion data model.
    ...
    public partial class PolicyDefinitionVersionData : ResourceData
    {
        ...
        internal PolicyDefinitionVersionData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, PolicyType? policyType, string mode, string displayName, string description, BinaryData policyRule, BinaryData metadata, IDictionary<string, ArmPolicyParameter> parameters, string version, ExternalEvaluationEnforcementSettings externalEvaluationEnforcementSettings, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
