...
namespace Azure.ResourceManager.Resources
{
    ...
    public partial class TenantPolicySetDefinitionResource : ArmResource
    {
        ...
        internal TenantPolicySetDefinitionResource(ArmClient client, PolicySetDefinitionData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<TenantPolicySetDefinitionResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new TenantPolicySetDefinitionResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
