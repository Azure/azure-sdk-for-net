...
namespace Azure.ResourceManager.Resources
{
    internal partial class DataPolicyManifestsRestOperations
    {
        ...
        /// <param name="applicationId"> The application id to use in the user agent. </param>
        /// <param name="endpoint"> server parameter. </param>
        public DataPolicyManifestsRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string applicationId, Uri endpoint = null)
        {
