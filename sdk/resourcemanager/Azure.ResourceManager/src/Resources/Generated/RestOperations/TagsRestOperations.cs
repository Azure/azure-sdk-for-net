...
namespace Azure.ResourceManager.Resources
{
    internal partial class TagsRestOperations
    {
        ...
        public TagsRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ArmClientOptions options, Uri endpoint = null, string apiVersion = default)
        {
        ...
        internal HttpMessage CreateUpdateAtScopeRequest(string scope, TagPatchResource parameters)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
