    ...
    public partial class GenericResourceCollection : ArmCollection
    {
        ...
        public virtual ArmOperation<GenericResource> CreateOrUpdate(bool waitForCompletion, ResourceIdentifier resourceId, GenericResourceData parameters, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new ArmOperation<GenericResource>(new GenericResourceSource(Client), _clientDiagnostics, Pipeline, _resourcesRestClient.CreateCreateOrUpdateByIdRequest(resourceId, apiVersion, parameters).Request, response);
