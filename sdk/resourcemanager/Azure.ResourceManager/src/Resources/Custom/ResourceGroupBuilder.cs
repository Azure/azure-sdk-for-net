...
namespace Azure.ResourceManager.Resources
{
    ...
    internal class ResourceGroupBuilder
    {
        ...
        public ArmOperation<ResourceGroup> CreateOrUpdate(string name, WaitUntil waitForCompletion = WaitUntil.Completed, CancellationToken cancellationToken = default)
        {
        ...
        /// <exception cref="ArgumentException"> Name cannot be null or a whitespace. </exception>
        public async Task<ArmOperation<ResourceGroup>> CreateOrUpdateAsync(
            string name,
            WaitUntil waitForCompletion = WaitUntil.Completed,
