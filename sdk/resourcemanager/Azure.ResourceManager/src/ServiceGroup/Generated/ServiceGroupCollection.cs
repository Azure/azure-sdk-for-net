...
namespace Azure.ResourceManager.ServiceGroups
{
    ...
    public partial class ServiceGroupCollection : ArmCollection
    {
        ...
        private readonly ServiceGroupRestOperations _serviceGroupRestClient;
        private readonly ClientDiagnostics _serviceGroupClientDiagnostics0;
        private readonly ServiceGroupsRestOperations _serviceGroupRestClient0;
        ...
        /// <description>CreateOrUpdateServiceGroup</description>
        /// </item>
        /// <item>
        ...
        public virtual async Task<ArmOperation<ServiceGroupResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string serviceGroupName, ServiceGroupData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _serviceGroupRestClient.CreateOrUpdateServiceGroupAsync(serviceGroupName, data, cancellationToken).ConfigureAwait(false);
                var operation = new ServiceGroupsArmOperation<ServiceGroupResource>(new ServiceGroupOperationSource(Client), _serviceGroupClientDiagnostics, Pipeline, _serviceGroupRestClient.CreateCreateOrUpdateServiceGroupRequest(serviceGroupName, data).Request, response, OperationFinalStateVia.AzureAsyncOperation);
        ...
        public virtual ArmOperation<ServiceGroupResource> CreateOrUpdate(WaitUntil waitUntil, string serviceGroupName, ServiceGroupData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _serviceGroupRestClient.CreateOrUpdateServiceGroup(serviceGroupName, data, cancellationToken);
                var operation = new ServiceGroupsArmOperation<ServiceGroupResource>(new ServiceGroupOperationSource(Client), _serviceGroupClientDiagnostics, Pipeline, _serviceGroupRestClient.CreateCreateOrUpdateServiceGroupRequest(serviceGroupName, data).Request, response, OperationFinalStateVia.AzureAsyncOperation);
                if (waitUntil == WaitUntil.Completed)
