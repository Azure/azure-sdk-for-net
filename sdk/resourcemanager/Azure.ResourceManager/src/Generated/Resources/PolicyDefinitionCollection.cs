...
namespace Azure.ResourceManager.Resources
{
    ...
    public partial class PolicyDefinitionCollection : ArmCollection, IEnumerable<PolicyDefinition>, IAsyncEnumerable<PolicyDefinition>
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="PolicyDefinitionCollection"/> class for mocking. </summary>
        protected PolicyDefinitionCollection()
        {
        }

        /// <summary> Initializes a new instance of PolicyDefinitionCollection class. </summary>
        /// <param name="parent"> The resource representing the parent resource. </param>
        internal PolicyDefinitionCollection(ArmResource parent) : base(parent)
        {
        ...
        public virtual PolicyDefinitionCreateOrUpdateOperation CreateOrUpdate(string policyDefinitionName, PolicyDefinitionData parameters, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("PolicyDefinitionCollection.CreateOrUpdate");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("PolicyDefinitionCollection.Get");
            scope.Start();
            try
            {
                if (policyDefinitionName == null)
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("PolicyDefinitionCollection.GetIfExists");
            scope.Start();
            try
            {
                if (policyDefinitionName == null)
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("PolicyDefinitionCollection.CheckIfExists");
            scope.Start();
            try
            {
                if (policyDefinitionName == null)
        ...
        public virtual Pageable<PolicyDefinition> GetAll(string filter = null, int? top = null, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("PolicyDefinitionCollection.GetAll");
                scope.Start();
                try
                {
                    if (Id.TryGetSubscriptionId(out _))
