...
namespace Azure.ResourceManager.Resources
{
    ...
    public class Tenant : ArmResource
    {
        ...
        public virtual AsyncPageable<PolicyDefinition> GetAllBuiltInPolicyDefinitionAsync(string filter = null, int? top = null, CancellationToken cancellationToken = default)
        {
            return new PolicyDefinitionContainer(this).GetAllAsync(filter, top, cancellationToken);
        }
        ...
        public virtual Pageable<PolicyDefinition> GetAllBuiltInPolicyDefinition(string filter = null, int? top = null, CancellationToken cancellationToken = default)
        {
            return new PolicyDefinitionContainer(this).GetAll(filter, top, cancellationToken);
        }
        ...
        public virtual AsyncPageable<PolicySetDefinition> GetAllBuiltInPolicySetDefinitionAsync(string filter = null, int? top = null, CancellationToken cancellationToken = default)
        {
            return new PolicySetDefinitionContainer(this).GetAllAsync(filter, top, cancellationToken);
        }
        ...
        public virtual Pageable<PolicySetDefinition> GetAllBuiltInPolicySetDefinition(string filter = null, int? top = null, CancellationToken cancellationToken = default)
        {
            return new PolicySetDefinitionContainer(this).GetAll(filter, top, cancellationToken);
        }
        ...
        {
            return await new PolicyDefinitionContainer(this).GetAsync(policyDefinitionName, cancellationToken).ConfigureAwait(false);
        }
        ...
        {
            return new PolicyDefinitionContainer(this).Get(policyDefinitionName, cancellationToken);
        }
        ...
        {
            return await new PolicySetDefinitionContainer(this).GetAsync(policySetDefinitionName, cancellationToken).ConfigureAwait(false);
        }
        ...
        {
            return new PolicySetDefinitionContainer(this).Get(policySetDefinitionName, cancellationToken);
        }
    }
}
