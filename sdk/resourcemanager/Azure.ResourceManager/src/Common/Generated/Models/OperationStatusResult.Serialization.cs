...
namespace Azure.ResourceManager.Models
{
    ...
    public partial class OperationStatusResult : IUtf8JsonSerializable, IJsonModelSerializable
    {
        ...
        object IModelSerializable.Deserialize(BinaryData data, ModelSerializerOptions options) => DeserializeOperationStatusResult(JsonDocument.Parse(data).RootElement);
