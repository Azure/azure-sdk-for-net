...
namespace Azure.ResourceManager.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ArmPlan>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ArmPlan>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ArmPlan>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ArmPlan>)} interface");
            }
        ...
        string IPersistableModel<ArmPlan>.GetWireFormat(ModelReaderWriterOptions options) => "J";
