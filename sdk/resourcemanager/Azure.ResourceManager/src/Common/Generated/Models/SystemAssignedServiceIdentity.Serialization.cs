...
namespace Azure.ResourceManager.Models
{
    ...
    public partial class SystemAssignedServiceIdentity : IUtf8JsonSerializable, IJsonModel<SystemAssignedServiceIdentity>, IPersistableModel<SystemAssignedServiceIdentity>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SystemAssignedServiceIdentityType))
            {
                builder.Append("  type:");
