...
namespace Azure.ResourceManager.Models
{
    ...
    public partial class SystemAssignedServiceIdentity : IUtf8JsonSerializable, IJsonModelSerializable
    {
        ...
        object IModelSerializable.Deserialize(BinaryData data, ModelSerializerOptions options) => DeserializeSystemAssignedServiceIdentity(JsonDocument.Parse(data).RootElement);
