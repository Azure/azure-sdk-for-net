...
namespace Azure.ResourceManager.ManagementGroups.Samples
{
    public partial class Sample_ManagementGroupCollection
    {
        ...
        public async Task CreateOrUpdate_PutManagementGroup()
        {
            ...
            ArmOperation<ManagementGroupResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, groupId, content, cacheControl);
        ...
        public async Task Get_GetManagementGroup()
        {
            ...
            string cacheControl = "no-cache";
            ManagementGroupResource result = await collection.GetAsync(groupId, cacheControl);
        ...
        public async Task Get_GetManagementGroupWithAncestors()
        {
            ...
            string cacheControl = "no-cache";
            ManagementGroupResource result = await collection.GetAsync(groupId, expand, cacheControl);
        ...
        public async Task Get_GetManagementGroupsWithExpandAndRecurse()
        {
            ...
            bool? recurse = true;
            string cacheControl = "no-cache";
            ManagementGroupResource result = await collection.GetAsync(groupId, expand, recurse, cacheControl);
        ...
        public async Task GetAll_ListManagementGroups()
        {
            ...
            string cacheControl = "no-cache";
            await foreach (ManagementGroupResource item in collection.GetAllAsync(cacheControl))
            {
        ...
        public async Task Exists_GetManagementGroup()
        {
            ...
            string groupId = "20000000-0001-0000-0000-000000000000";
            string cacheControl = "no-cache";
            bool result = await collection.ExistsAsync(groupId, cacheControl);
        ...
        public async Task Exists_GetManagementGroupWithAncestors()
        {
            ...
            ManagementGroupExpandType? expand = ManagementGroupExpandType.Ancestors;
            string cacheControl = "no-cache";
            bool result = await collection.ExistsAsync(groupId, expand, cacheControl);
        ...
        public async Task Exists_GetManagementGroupsWithExpandAndRecurse()
        {
            ...
            bool? recurse = true;
            string cacheControl = "no-cache";
            bool result = await collection.ExistsAsync(groupId, expand, recurse, cacheControl);
        ...
        public async Task GetIfExists_GetManagementGroup()
        {
            ...
            string groupId = "20000000-0001-0000-0000-000000000000";
            string cacheControl = "no-cache";
            NullableResponse<ManagementGroupResource> response = await collection.GetIfExistsAsync(groupId, cacheControl);
        ...
        public async Task GetIfExists_GetManagementGroupWithAncestors()
        {
            ...
            ManagementGroupExpandType? expand = ManagementGroupExpandType.Ancestors;
            string cacheControl = "no-cache";
            NullableResponse<ManagementGroupResource> response = await collection.GetIfExistsAsync(groupId, expand, cacheControl);
            ManagementGroupResource result = response.HasValue ? response.Value : null;
        ...
        public async Task GetIfExists_GetManagementGroupsWithExpandAndRecurse()
        {
            ...
            bool? recurse = true;
            string cacheControl = "no-cache";
            NullableResponse<ManagementGroupResource> response = await collection.GetIfExistsAsync(groupId, expand, recurse, cacheControl);
            ManagementGroupResource result = response.HasValue ? response.Value : null;
