...
namespace Azure.ResourceManager.ManagementGroups.Samples
{
    public partial class Sample_ManagementGroupResource
    {
        ...
        public async Task Get_GetManagementGroup()
        {
            ...
            ManagementGroupResource result = await managementGroup.GetAsync(cacheControl);
        ...
        public async Task Get_GetManagementGroupWithAncestors()
        {
            ...
            string cacheControl = "no-cache";
            ManagementGroupResource result = await managementGroup.GetAsync(expand, cacheControl);
        ...
        public async Task Get_GetManagementGroupsWithExpandAndRecurse()
        {
            ...
            bool? recurse = true;
            string cacheControl = "no-cache";
            ManagementGroupResource result = await managementGroup.GetAsync(expand, recurse, cacheControl);
        ...
        public async Task Delete_DeleteManagementGroup()
        {
            ...
            // invoke the operation
            string cacheControl = "no-cache";
            await managementGroup.DeleteAsync(WaitUntil.Completed, cacheControl).ConfigureAwait(false);
        ...
        public async Task Update_PatchManagementGroup()
        {
            ...
            string cacheControl = "no-cache";
            ManagementGroupResource result = await managementGroup.UpdateAsync(patch, cacheControl);
