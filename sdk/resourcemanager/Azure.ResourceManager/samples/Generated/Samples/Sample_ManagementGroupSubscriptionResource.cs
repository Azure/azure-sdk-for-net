...
namespace Azure.ResourceManager.ManagementGroups.Samples
{
    public partial class Sample_ManagementGroupSubscriptionResource
    {
        ...
        public async Task Get_GetSubscriptionFromManagementGroup()
        {
            ...
            ManagementGroupSubscriptionResource result = await managementGroupSubscription.GetAsync(cacheControl);
        ...
        public async Task Delete_DeleteSubscriptionFromManagementGroup()
        {
            ...
            // invoke the operation
            string cacheControl = "no-cache";
            await managementGroupSubscription.DeleteAsync(WaitUntil.Completed, cacheControl).ConfigureAwait(false);
        ...
        public async Task Update_AddSubscriptionToManagementGroup()
        {
            ...
            // invoke the operation
            string cacheControl = "no-cache";
            ArmOperation<ManagementGroupSubscriptionResource> lro = await managementGroupSubscription.UpdateAsync(WaitUntil.Completed, cacheControl);
