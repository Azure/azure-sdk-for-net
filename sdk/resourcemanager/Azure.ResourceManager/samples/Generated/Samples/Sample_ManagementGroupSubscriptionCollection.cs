...
namespace Azure.ResourceManager.ManagementGroups.Samples
{
    public partial class Sample_ManagementGroupSubscriptionCollection
    {
        ...
        public async Task CreateOrUpdate_AddSubscriptionToManagementGroup()
        {
            ...
            ArmOperation<ManagementGroupSubscriptionResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, subscriptionId, cacheControl);
        ...
        public async Task Get_GetSubscriptionFromManagementGroup()
        {
            ...
            string subscriptionId = "728bcbe4-8d56-4510-86c2-4921b8beefbc";
            string cacheControl = "no-cache";
            ManagementGroupSubscriptionResource result = await collection.GetAsync(subscriptionId, cacheControl);
        ...
        public async Task Exists_GetSubscriptionFromManagementGroup()
        {
            ...
            string subscriptionId = "728bcbe4-8d56-4510-86c2-4921b8beefbc";
            string cacheControl = "no-cache";
            bool result = await collection.ExistsAsync(subscriptionId, cacheControl);
        ...
        public async Task GetIfExists_GetSubscriptionFromManagementGroup()
        {
            ...
            string subscriptionId = "728bcbe4-8d56-4510-86c2-4921b8beefbc";
            string cacheControl = "no-cache";
            NullableResponse<ManagementGroupSubscriptionResource> response = await collection.GetIfExistsAsync(subscriptionId, cacheControl);
