# Azure Billing Management client library for .NET
...
Install the Azure Billing management library for .NET with [NuGet](https://www.nuget.org/):

```PowerShell
Install-Package Azure.ResourceManager.Billing -Version 1.0.0-preview.1 
```
