...
namespace Azure.ResourceManager.Billing
{
    ...
    public partial class InvoicesDownloadMultipleBillingProfileInvoicesOperation : Operation<DownloadUrl>, IOperationSource<DownloadUrl>
    {
        private readonly ArmOperationHelpers<DownloadUrl> _operation;
        internal InvoicesDownloadMultipleBillingProfileInvoicesOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<DownloadUrl>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "InvoicesDownloadMultipleBillingProfileInvoicesOperation");
        }
        /// <inheritdoc />
