...
namespace Azure.ResourceManager.Billing.Models
{
    public partial class InvoiceSectionListWithCreateSubPermissionResult
    {
        ...
        {
            Optional<IReadOnlyList<InvoiceSectionWithCreateSubPermission>> value = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("value"))
                {
                    ...
                    {
                        array.Add(InvoiceSectionWithCreateSubPermission.DeserializeInvoiceSectionWithCreateSubPermission(item));
                    }
                    value = array;
                    continue;
                }
