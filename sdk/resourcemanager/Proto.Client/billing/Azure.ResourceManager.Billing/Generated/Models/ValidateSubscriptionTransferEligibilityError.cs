...
namespace Azure.ResourceManager.Billing.Models
{
    ...
    {
        /// <summary> Initializes a new instance of ValidateSubscriptionTransferEligibilityError. </summary>
        internal ValidateSubscriptionTransferEligibilityError()
        {
        }
        ...
        internal ValidateSubscriptionTransferEligibilityError(SubscriptionTransferValidationErrorCode? code, string message, string details)
        {
            Code = code;
            Message = message;
            Details = details;
