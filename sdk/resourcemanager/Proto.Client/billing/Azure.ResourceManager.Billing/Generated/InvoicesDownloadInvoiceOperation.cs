...
namespace Azure.ResourceManager.Billing
{
    ...
    public partial class InvoicesDownloadInvoiceOperation : Operation<DownloadUrl>, IOperationSource<DownloadUrl>
    {
        private readonly ArmOperationHelpers<DownloadUrl> _operation;
        internal InvoicesDownloadInvoiceOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<DownloadUrl>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "InvoicesDownloadInvoiceOperation");
        }
        /// <inheritdoc />
