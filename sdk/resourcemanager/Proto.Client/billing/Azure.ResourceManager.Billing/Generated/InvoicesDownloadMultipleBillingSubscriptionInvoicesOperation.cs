...
namespace Azure.ResourceManager.Billing
{
    ...
    public partial class InvoicesDownloadMultipleBillingSubscriptionInvoicesOperation : Operation<DownloadUrl>, IOperationSource<DownloadUrl>
    {
        private readonly ArmOperationHelpers<DownloadUrl> _operation;
        internal InvoicesDownloadMultipleBillingSubscriptionInvoicesOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<DownloadUrl>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "InvoicesDownloadMultipleBillingSubscriptionInvoicesOperation");
        }
        /// <inheritdoc />
