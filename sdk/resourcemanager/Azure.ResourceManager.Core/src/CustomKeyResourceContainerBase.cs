...
namespace Azure.ResourceManager.Core
{
    ...
    public abstract class CustomKeyResourceContainerBase<TIdentifier, TOperations, TResource> : OperationsBase
        where TOperations : CustomKeyResourceOperationsBase<TIdentifier, TOperations> where TIdentifier : ResourceIdentifier
    {
        ...
        /// </summary>
        protected CustomKeyResourceContainerBase()
        {
        }
        ...
        protected CustomKeyResourceContainerBase(ResourceOperationsBase parent)
