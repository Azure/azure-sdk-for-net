...
namespace Azure.ResourceManager._ServiceGroups
{
    ...
    public partial class ServiceGroupCollection : ArmCollection
    {
        ...
        internal ServiceGroupCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _managementClientClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager._ServiceGroups", ServiceGroupResource.ResourceType.Namespace, Diagnostics);
            ...
            _serviceGroupsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager._ServiceGroups", ServiceGroupResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<Response<ServiceGroupResource>> GetAsync(string serviceGroupName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _serviceGroupsClientDiagnostics.CreateScope("ServiceGroupCollection.Get");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _serviceGroupsRestClient.CreateGetRequest(serviceGroupName, context);
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string serviceGroupName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _serviceGroupsClientDiagnostics.CreateScope("ServiceGroupCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual async Task<NullableResponse<ServiceGroupResource>> GetIfExistsAsync(string serviceGroupName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _serviceGroupsClientDiagnostics.CreateScope("ServiceGroupCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
