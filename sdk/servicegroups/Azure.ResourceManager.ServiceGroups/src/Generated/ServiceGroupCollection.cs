...
namespace Azure.ResourceManager.ServiceGroups
{
    ...
    public partial class ServiceGroupCollection : ArmCollection
    {
        ...
        internal ServiceGroupCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _serviceGroupClientClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.ServiceGroups", ServiceGroupResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<Response<ServiceGroupResource>> GetAsync(string serviceGroupName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _serviceGroupClientClientDiagnostics.CreateScope("ServiceGroupCollection.Get");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _serviceGroupClientRestClient.CreateGetRequest(serviceGroupName, context);
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string serviceGroupName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _serviceGroupClientClientDiagnostics.CreateScope("ServiceGroupCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual async Task<NullableResponse<ServiceGroupResource>> GetIfExistsAsync(string serviceGroupName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _serviceGroupClientClientDiagnostics.CreateScope("ServiceGroupCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
