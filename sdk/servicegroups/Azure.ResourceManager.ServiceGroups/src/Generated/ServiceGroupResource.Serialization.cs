...
namespace Azure.ResourceManager._ServiceGroups
{
    ...
    public partial class ServiceGroupResource : IJsonModel<ServiceGroupData>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ServiceGroupData>.Write(ModelReaderWriterOptions options) => ModelReaderWriter.Write<ServiceGroupData>(Data, options, AzureResourceManager_ServiceGroupsContext.Default);

        /// <param name="data"> The binary data to be processed. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        ServiceGroupData IPersistableModel<ServiceGroupData>.Create(BinaryData data, ModelReaderWriterOptions options) => ModelReaderWriter.Read<ServiceGroupData>(data, options, AzureResourceManager_ServiceGroupsContext.Default);
