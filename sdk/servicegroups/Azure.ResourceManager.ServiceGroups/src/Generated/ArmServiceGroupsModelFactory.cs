...
namespace Azure.ResourceManager._ServiceGroups.Models
{
    ...
    public static partial class ArmServiceGroupsModelFactory
    {
        ...
        /// <returns> A new <see cref="_ServiceGroups.ServiceGroupData"/> instance for mocking. </returns>
        ...
        public static ServiceGroupProperties ServiceGroupProperties(ProvisioningState? provisioningState = default, string displayName = default, ResourceIdentifier parentResourceId = default)
        {
        ...
        /// <returns> A new <see cref="Models.ServiceGroupCollectionResponse"/> instance for mocking. </returns>
        public static ServiceGroupCollectionResponse ServiceGroupCollectionResponse(IEnumerable<ServiceGroupData> value = default, Uri nextLink = default)
        {
            value ??= new ChangeTrackingList<ServiceGroupData>();

            return new ServiceGroupCollectionResponse(value.ToList(), nextLink, additionalBinaryDataProperties: null);
        }
    }
}
