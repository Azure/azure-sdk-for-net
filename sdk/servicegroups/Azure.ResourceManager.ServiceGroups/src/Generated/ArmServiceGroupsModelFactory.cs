...
namespace Azure.ResourceManager.ServiceGroups.Models
{
    ...
    public static partial class ArmServiceGroupsModelFactory
    {
        ...
        /// <returns> A new <see cref="Models.ServiceGroupCollectionResult"/> instance for mocking. </returns>
        public static ServiceGroupCollectionResult ServiceGroupCollectionResult(IEnumerable<ServiceGroupData> value = default, Uri nextLink = default)
        {
            value ??= new ChangeTrackingList<ServiceGroupData>();

            return new ServiceGroupCollectionResult(value.ToList(), nextLink, additionalBinaryDataProperties: null);
        }
    }
}
