...
namespace Azure.ResourceManager._ServiceGroups.Models
{
    ...
    public partial class ServiceGroupProperties
    {
        ...
        internal ServiceGroupProperties(ProvisioningState? provisioningState, string displayName, ParentServiceGroupProperties parent, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
