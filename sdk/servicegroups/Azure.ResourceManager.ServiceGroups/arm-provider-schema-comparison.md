...
#### List and action operations differences: `/providers/Microsoft.Management/serviceGroups/{serviceGroupName}`

| Operation | Kind | Request path | Legacy | `resolveArmResources` |
| --- | --- | --- | --- | --- |
| `Microsoft.Management.ServiceGroups.listAncestors` | `List` | `/providers/Microsoft.Management/serviceGroups/{serviceGroupName}/listAncestors` | Different. | Different. |
