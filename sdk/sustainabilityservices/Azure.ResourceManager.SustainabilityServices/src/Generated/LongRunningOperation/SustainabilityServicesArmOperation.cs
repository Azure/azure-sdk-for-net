...
#pragma warning disable SA1649 // File name should match first type name
    internal class SustainabilityServicesArmOperation : ArmOperation
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        internal SustainabilityServicesArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal SustainabilityServicesArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal(nextLinkOperation, clientDiagnostics, response, "SustainabilityServicesArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
