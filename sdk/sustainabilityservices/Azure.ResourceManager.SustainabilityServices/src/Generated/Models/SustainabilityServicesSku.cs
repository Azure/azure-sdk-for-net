...
namespace Azure.ResourceManager.SustainabilityServices.Models
{
    ...
    public partial class SustainabilityServicesSku
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="SustainabilityServicesSku"/>. </summary>
        ...
        internal SustainabilityServicesSku(string name, SustainabilityServicesSkuTier? tier, string size, string family, int? capacity, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Tier = tier;
            Size = size;
        ...
        /// <summary> Initializes a new instance of <see cref="SustainabilityServicesSku"/> for deserialization. </summary>
        internal SustainabilityServicesSku()
        {
        }
        ...
        public SustainabilityServicesSkuTier? Tier { get; set; }
