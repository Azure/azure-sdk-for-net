...
namespace Azure.ResourceManager.DeviceOnboarding.Models
{
    ...
    public readonly partial struct EndpointType : IEquatable<EndpointType>
    {
        ...
        private const string MicrosoftEventGridNamespaceValue = "Microsoft.EventGrid/namespaces";

        /// <summary> Azure event grid broker. </summary>
        public static EndpointType MicrosoftEventGridNamespace { get; } = new EndpointType(MicrosoftEventGridNamespaceValue);
