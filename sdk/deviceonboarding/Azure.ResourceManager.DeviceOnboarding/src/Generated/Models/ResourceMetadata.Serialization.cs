...
{
    internal partial class ResourceMetadata : IUtf8JsonSerializable, IJsonModel<ResourceMetadata>
    {
        ...
        internal static ResourceMetadata DeserializeResourceMetadata(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new ResourceMetadata(customAttributes ?? new ChangeTrackingDictionary<string, BinaryData>(), serializedAdditionalRawData);
        }
