...
namespace Azure.ResourceManager.DeviceOnboarding.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PolicyListResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(PolicyListResult)} does not support writing '{format}' format.");
            }
        ...
        PolicyListResult IJsonModel<PolicyListResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(PolicyListResult)} does not support reading '{format}' format.");
            }
        ...
        internal static PolicyListResult DeserializePolicyListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new PolicyListResult(value, nextLink, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<PolicyListResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(PolicyListResult)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        PolicyListResult IPersistableModel<PolicyListResult>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(PolicyListResult)} does not support reading '{options.Format}' format.");
            }
        }
