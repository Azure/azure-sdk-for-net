...
namespace Azure.ResourceManager.DeviceOnboarding.Models
{
    ...
    public partial class PatchFdoBootstrapAuthenticationRule : PatchBootstrapAuthenticationRule
    {
        /// <summary> Initializes a new instance of <see cref="PatchFdoBootstrapAuthenticationRule"/>. </summary>
        ...
        /// <param name="publicKeys"> Per policy public keys to represent this policy. </param>
        ...
        internal PatchFdoBootstrapAuthenticationRule(BootstrapAuthenticationType type, IDictionary<string, BinaryData> serializedAdditionalRawData, FdoPublicKeys publicKeys, OwnershipVoucherStorage ownershipVoucherStorage, Uri rendezvousEndpoint) : base(type, serializedAdditionalRawData)
        {
        ...
        /// <summary> Per policy public keys to represent this policy. </summary>
