...
namespace Azure.ResourceManager.DeviceOnboarding.Models
{
    ...
    public abstract partial class PublicKeyDetails
    {
        ...
        internal PublicKeyDetails(PublicKeyType publicKeyType, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            PublicKeyType = publicKeyType;
            _serializedAdditionalRawData = serializedAdditionalRawData;
        }

        /// <summary> Gets or sets the public key type. </summary>
