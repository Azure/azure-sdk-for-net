...
#pragma warning disable SA1649 // File name should match first type name
    internal class DeviceOnboardingArmOperation : ArmOperation
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        /// <summary> Initializes a new instance of DeviceOnboardingArmOperation for mocking. </summary>
        protected DeviceOnboardingArmOperation()
        {
        }

        internal DeviceOnboardingArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal DeviceOnboardingArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal(nextLinkOperation, clientDiagnostics, response, "DeviceOnboardingArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
