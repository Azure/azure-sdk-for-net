...
namespace Azure.ResourceManager.DeviceOnboarding.Samples
{
    public partial class Sample_OwnershipVoucherPublicKeyResource
    {
        ...
        {
            // Generated from example definition: 2024-12-01-preview/OwnershipVoucherPublicKeys_Delete_MaximumSet_Gen.json
            // this example is just showing the usage of "OwnershipVoucherPublicKey_Delete" operation, for the dependent resources, they will have to be created separately.
        ...
        {
            // Generated from example definition: 2024-12-01-preview/OwnershipVoucherPublicKeys_Update_MaximumSet_Gen.json
            // this example is just showing the usage of "OwnershipVoucherPublicKey_Update" operation, for the dependent resources, they will have to be created separately.
            ...
            // invoke the operation
            OwnershipVoucherPublicKeyData data = new OwnershipVoucherPublicKeyData(default)
            {
...
["key1947"] = "qixhvgmpfuo"
            ...
            ArmOperation<OwnershipVoucherPublicKeyResource> lro = await ownershipVoucherPublicKey.UpdateAsync(WaitUntil.Completed, data);
