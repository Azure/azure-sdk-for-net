...
namespace Azure.ResourceManager.NetworkFunction
{
    ...
    public partial class AzureTrafficCollectorResource : ArmResource
    {
        ...
        /// <summary>
        /// Updates the AzureTrafficCollector.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NetworkFunction/azureTrafficCollectors/{azureTrafficCollectorName}. </description>
        ...
        public virtual async Task<ArmOperation<AzureTrafficCollectorResource>> UpdateAsync(WaitUntil waitUntil, AzureTrafficCollectorData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _azureTrafficCollectorsRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, AzureTrafficCollectorData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<AzureTrafficCollectorResource> Update(WaitUntil waitUntil, AzureTrafficCollectorData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
