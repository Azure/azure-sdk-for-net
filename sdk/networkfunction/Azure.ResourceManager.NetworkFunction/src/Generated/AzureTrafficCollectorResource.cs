...
namespace Azure.ResourceManager.NetworkFunction
{
    ...
    public partial class AzureTrafficCollectorResource : ArmResource
    {
        ...
        internal AzureTrafficCollectorResource(ArmClient client, AzureTrafficCollectorData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<AzureTrafficCollectorResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
                {
                    ...
                    return Response.FromValue(new AzureTrafficCollectorResource(Client, originalResponse.Value, originalResponse.Value.Id), originalResponse.GetRawResponse());
                }
                else
                {
