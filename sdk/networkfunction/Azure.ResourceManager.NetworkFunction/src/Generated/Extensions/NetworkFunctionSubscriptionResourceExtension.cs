...
namespace Azure.ResourceManager.NetworkFunction.Testing
{
    /// <summary> A class to add extension methods to SubscriptionResource. </summary>
    public partial class NetworkFunctionSubscriptionResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="NetworkFunctionSubscriptionResourceExtension"/> class for mocking. </summary>
        protected NetworkFunctionSubscriptionResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="NetworkFunctionSubscriptionResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal NetworkFunctionSubscriptionResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
