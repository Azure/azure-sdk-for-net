...
namespace Azure.ResourceManager.NetworkFunction.Mocking
{
    ...
    internal partial class NetworkFunctionSubscriptionMockingExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="NetworkFunctionSubscriptionMockingExtension"/> class for mocking. </summary>
        protected NetworkFunctionSubscriptionMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="NetworkFunctionSubscriptionMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal NetworkFunctionSubscriptionMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
