...
namespace Azure.ResourceManager.NetworkFunction
{
    ...
    public static partial class NetworkFunctionExtensions
    {
        ...
        {
            return GetResourceGroupResourceExtension(resourceGroupResource).GetAzureTrafficCollectors();
        }
        ...
        {
            return GetSubscriptionResourceExtension(subscriptionResource).GetAzureTrafficCollectorsAsync(cancellationToken);
        }
        ...
        {
            return GetSubscriptionResourceExtension(subscriptionResource).GetAzureTrafficCollectors(cancellationToken);
        }
    }
}
