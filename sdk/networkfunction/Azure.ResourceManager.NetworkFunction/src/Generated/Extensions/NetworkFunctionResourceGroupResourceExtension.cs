...
namespace Azure.ResourceManager.NetworkFunction.Mock
{
    ...
    public partial class NetworkFunctionResourceGroupResourceExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="NetworkFunctionResourceGroupResourceExtension"/> class for mocking. </summary>
        protected NetworkFunctionResourceGroupResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="NetworkFunctionResourceGroupResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal NetworkFunctionResourceGroupResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
