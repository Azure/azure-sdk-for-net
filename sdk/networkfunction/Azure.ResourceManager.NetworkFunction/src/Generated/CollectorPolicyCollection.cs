...
namespace Azure.ResourceManager.NetworkFunction
{
    ...
    public partial class CollectorPolicyCollection : ArmCollection, IEnumerable<CollectorPolicyResource>, IAsyncEnumerable<CollectorPolicyResource>
    {
        ...
        /// Request Path: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NetworkFunction/azureTrafficCollectors/{azureTrafficCollectorName}/collectorPolicies
        /// Operation Id: CollectorPolicies_List
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        ...
        {
            async Task<Page<CollectorPolicyResource>> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _collectorPolicyClientDiagnostics.CreateScope("CollectorPolicyCollection.GetAll");
                scope.Start();
                try
                {
                    var response = await _collectorPolicyRestClient.ListAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new CollectorPolicyResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
                    scope.Failed(e);
            ...
            async Task<Page<CollectorPolicyResource>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                using var scope = _collectorPolicyClientDiagnostics.CreateScope("CollectorPolicyCollection.GetAll");
                scope.Start();
                try
                {
                    var response = await _collectorPolicyRestClient.ListNextPageAsync(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new CollectorPolicyResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        {
            Page<CollectorPolicyResource> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _collectorPolicyClientDiagnostics.CreateScope("CollectorPolicyCollection.GetAll");
                scope.Start();
                try
                {
                    var response = _collectorPolicyRestClient.List(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new CollectorPolicyResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            Page<CollectorPolicyResource> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                using var scope = _collectorPolicyClientDiagnostics.CreateScope("CollectorPolicyCollection.GetAll");
                scope.Start();
                try
                {
                    var response = _collectorPolicyRestClient.ListNextPage(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new CollectorPolicyResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
