...
namespace Azure.ResourceManager.NetworkFunction
{
    internal partial class AzureTrafficCollectorsBySubscriptionGetAllCollectionResultOfT : Pageable<AzureTrafficCollectorData>
    {
        ...
        public AzureTrafficCollectorsBySubscriptionGetAllCollectionResultOfT(AzureTrafficCollectorsBySubscription client, string subscriptionId, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
