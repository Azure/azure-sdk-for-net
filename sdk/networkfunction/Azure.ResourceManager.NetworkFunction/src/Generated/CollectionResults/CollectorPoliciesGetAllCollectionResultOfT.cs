...
namespace Azure.ResourceManager.NetworkFunction
{
    internal partial class CollectorPoliciesGetAllCollectionResultOfT : Pageable<CollectorPolicyData>
    {
        ...
        public CollectorPoliciesGetAllCollectionResultOfT(CollectorPolicies client, string subscriptionId, string resourceGroupName, string azureTrafficCollectorName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
