...
namespace Azure.ResourceManager.NetworkFunction
{
    internal partial class CollectorPoliciesGetAllCollectionResultOfT : Pageable<CollectorPolicyData>
    {
        ...
        private readonly string _azureTrafficCollectorName;
        private readonly RequestContext _context;
        private readonly string _diagnosticScope;

        /// <summary> Initializes a new instance of CollectorPoliciesGetAllCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        /// <param name="client"> The CollectorPolicies client used to send requests. </param>
        ...
        public CollectorPoliciesGetAllCollectionResultOfT(CollectorPolicies client, string subscriptionId, string resourceGroupName, string azureTrafficCollectorName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _subscriptionId = subscriptionId;
            _resourceGroupName = resourceGroupName;
            _azureTrafficCollectorName = azureTrafficCollectorName;
            _context = context;
            _diagnosticScope = diagnosticScope;
        }

        /// <summary> Gets the pages of CollectorPoliciesGetAllCollectionResultOfT as an enumerable collection. </summary>
