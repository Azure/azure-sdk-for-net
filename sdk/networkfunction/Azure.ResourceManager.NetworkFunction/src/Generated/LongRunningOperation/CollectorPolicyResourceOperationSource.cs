...
{
    /// <summary></summary>
    internal partial class CollectorPolicyResourceOperationSource : IOperationSource<CollectorPolicyResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal CollectorPolicyResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
