...
{
    /// <summary></summary>
    internal partial class AzureTrafficCollectorResourceOperationSource : IOperationSource<AzureTrafficCollectorResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal AzureTrafficCollectorResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
