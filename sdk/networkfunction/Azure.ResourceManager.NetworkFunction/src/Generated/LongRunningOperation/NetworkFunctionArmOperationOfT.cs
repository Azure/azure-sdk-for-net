...
namespace Azure.ResourceManager.NetworkFunction
{
    internal partial class NetworkFunctionArmOperation<T> : ArmOperation<T>
    {
        ...
        internal NetworkFunctionArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
