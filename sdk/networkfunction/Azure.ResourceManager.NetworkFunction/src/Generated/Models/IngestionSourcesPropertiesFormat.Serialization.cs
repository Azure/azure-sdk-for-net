...
namespace Azure.ResourceManager.NetworkFunction.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IngestionSourcesPropertiesFormat>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<IngestionSourcesPropertiesFormat>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<IngestionSourcesPropertiesFormat>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<IngestionSourcesPropertiesFormat>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
