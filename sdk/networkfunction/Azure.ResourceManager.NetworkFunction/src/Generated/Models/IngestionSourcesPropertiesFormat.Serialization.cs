...
{
    public partial class IngestionSourcesPropertiesFormat : IUtf8JsonSerializable, IJsonModel<IngestionSourcesPropertiesFormat>, IPersistableModel<IngestionSourcesPropertiesFormat>
    {
        ...
        void IJsonModel<IngestionSourcesPropertiesFormat>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(IngestionSourcesPropertiesFormat)} does not support '{format}' format.");
            }
