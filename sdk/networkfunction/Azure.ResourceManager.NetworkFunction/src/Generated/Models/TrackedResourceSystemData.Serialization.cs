...
namespace Azure.ResourceManager.NetworkFunction.Models
{
    ...
    {
        internal static TrackedResourceSystemData DeserializeTrackedResourceSystemData(JsonElement element)
        {
            ...
            return new TrackedResourceSystemData(createdBy.Value, Optional.ToNullable(createdByType), Optional.ToNullable(createdAt), lastModifiedBy.Value, Optional.ToNullable(lastModifiedByType));
        }
    }
}
