...
namespace Azure.ResourceManager.NetworkFunction.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EmissionPolicyDestination>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<EmissionPolicyDestination>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<EmissionPolicyDestination>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<EmissionPolicyDestination>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
