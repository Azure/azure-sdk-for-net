...
{
    public partial class EmissionPolicyDestination : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static EmissionPolicyDestination DeserializeEmissionPolicyDestination(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
