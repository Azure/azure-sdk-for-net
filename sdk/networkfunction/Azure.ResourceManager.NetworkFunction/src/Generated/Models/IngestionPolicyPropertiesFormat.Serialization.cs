...
{
    public partial class IngestionPolicyPropertiesFormat : IUtf8JsonSerializable, IJsonModel<IngestionPolicyPropertiesFormat>, IPersistableModel<IngestionPolicyPropertiesFormat>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(IngestionType))
            {
                builder.Append("  ingestionType:");
                builder.AppendLine($" '{IngestionType.ToString()}'");
            }

            if (Optional.IsCollectionDefined(IngestionSources))
            {
                builder.Append("  ingestionSources:");
                builder.AppendLine(" [");
                foreach (var item in IngestionSources)
                {
