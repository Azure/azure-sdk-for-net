...
namespace Azure.ResourceManager.NetworkFunction.Models
{
    ...
    {
        internal static CollectorPolicyListResult DeserializeCollectorPolicyListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
