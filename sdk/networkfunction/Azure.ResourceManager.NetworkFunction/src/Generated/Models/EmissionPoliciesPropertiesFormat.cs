...
namespace Azure.ResourceManager.NetworkFunction.Models
{
    ...
    public partial class EmissionPoliciesPropertiesFormat
    {
        ...
        internal EmissionPoliciesPropertiesFormat(EmissionType? emissionType, IList<EmissionPolicyDestination> emissionDestinations, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
