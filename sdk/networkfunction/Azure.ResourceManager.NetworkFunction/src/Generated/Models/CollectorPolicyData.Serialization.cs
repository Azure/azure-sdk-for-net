...
{
    public partial class CollectorPolicyData : IUtf8JsonSerializable, IJsonModel<CollectorPolicyData>, IPersistableModel<CollectorPolicyData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(IngestionPolicy))
            {
                builder.Append("  ingestionPolicy:");
                AppendChildObject(builder, IngestionPolicy, options, 2);
            }

            if (Optional.IsCollectionDefined(EmissionPolicies))
            {
                builder.Append("  emissionPolicies:");
                builder.AppendLine(" [");
                foreach (var item in EmissionPolicies)
                {
