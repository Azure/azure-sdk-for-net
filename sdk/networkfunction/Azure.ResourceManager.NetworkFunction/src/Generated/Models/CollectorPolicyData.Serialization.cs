...
namespace Azure.ResourceManager.NetworkFunction
{
    public partial class CollectorPolicyData : IUtf8JsonSerializable, IJsonModel<CollectorPolicyData>
    {
        ...
        void IJsonModel<CollectorPolicyData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(CollectorPolicyData)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<CollectorPolicyData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(CollectorPolicyData)} does not support '{options.Format}' format.");
            }
        }
