...
namespace Azure.ResourceManager.NetworkFunction
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CollectorPolicyData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CollectorPolicyData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CollectorPolicyData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CollectorPolicyData>)} interface");
            }
        ...
        string IPersistableModel<CollectorPolicyData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
