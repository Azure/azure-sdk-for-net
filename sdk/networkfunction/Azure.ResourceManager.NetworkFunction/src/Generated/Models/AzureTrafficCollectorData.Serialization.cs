...
namespace Azure.ResourceManager.NetworkFunction
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureTrafficCollectorData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AzureTrafficCollectorData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AzureTrafficCollectorData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AzureTrafficCollectorData>)} interface");
            }
        ...
        string IPersistableModel<AzureTrafficCollectorData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
