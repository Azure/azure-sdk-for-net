...
namespace Azure.ResourceManager.NetworkFunction
{
    public partial class AzureTrafficCollectorData : IUtf8JsonSerializable, IModelJsonSerializable<AzureTrafficCollectorData>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<AzureTrafficCollectorData>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="AzureTrafficCollectorData"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="AzureTrafficCollectorData"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="AzureTrafficCollectorData"/>. </summary>
