...
namespace Azure.ResourceManager.RecoveryServicesDataReplication
{
    internal partial class PrivateLinkResourcesGetAllAsyncCollectionResultOfT : AsyncPageable<DataReplicationPrivateLinkResourceData>
    {
        ...
        public PrivateLinkResourcesGetAllAsyncCollectionResultOfT(PrivateLinkResources client, Guid subscriptionId, string resourceGroupName, string vaultName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
