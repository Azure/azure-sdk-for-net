...
namespace Azure.ResourceManager.RecoveryServicesDataReplication
{
    ...
    public partial class DataReplicationRecoveryPointData : ResourceData
    {
        ...
        internal DataReplicationRecoveryPointData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, DataReplicationRecoveryPointProperties properties) : base(id, name, resourceType, systemData)
        {
