...
namespace Azure.ResourceManager.RecoveryServicesDataReplication.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VMwareToAzStackHciReplicationExtensionModelCustomProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<VMwareToAzStackHciReplicationExtensionModelCustomProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<VMwareToAzStackHciReplicationExtensionModelCustomProperties>)} interface");
            }
        ...
        string IPersistableModel<VMwareToAzStackHciReplicationExtensionModelCustomProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
