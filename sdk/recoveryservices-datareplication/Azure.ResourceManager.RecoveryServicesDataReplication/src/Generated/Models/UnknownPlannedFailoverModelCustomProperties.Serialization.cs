...
namespace Azure.ResourceManager.RecoveryServicesDataReplication.Models
{
    internal partial class UnknownPlannedFailoverModelCustomProperties : IUtf8JsonSerializable, IJsonModel<PlannedFailoverModelCustomProperties>
    {
        ...
        void IJsonModel<PlannedFailoverModelCustomProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(PlannedFailoverModelCustomProperties)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<PlannedFailoverModelCustomProperties>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(PlannedFailoverModelCustomProperties)} does not support '{options.Format}' format.");
            }
        }
