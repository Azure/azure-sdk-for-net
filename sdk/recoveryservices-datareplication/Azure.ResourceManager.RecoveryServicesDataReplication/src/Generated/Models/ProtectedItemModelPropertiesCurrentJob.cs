...
{
    /// <summary> The ProtectedItemModelPropertiesCurrentJob. </summary>
    public partial class ProtectedItemModelPropertiesCurrentJob : ProtectedItemJobProperties
    {
        ...
        internal ProtectedItemModelPropertiesCurrentJob(string scenarioName, string id, string name, string displayName, string state, DateTimeOffset? startOn, DateTimeOffset? endOn) : base(scenarioName, id, name, displayName, state, startOn, endOn)
        {
        }
    }
}
