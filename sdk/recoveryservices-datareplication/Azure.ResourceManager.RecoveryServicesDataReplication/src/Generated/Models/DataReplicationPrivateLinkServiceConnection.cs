...
namespace Azure.ResourceManager.RecoveryServicesDataReplication.Models
{
    ...
    public partial class DataReplicationPrivateLinkServiceConnection
    {
        ...
        internal DataReplicationPrivateLinkServiceConnection(string name, IList<string> groupIds, string requestMessage, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            GroupIds = groupIds;
