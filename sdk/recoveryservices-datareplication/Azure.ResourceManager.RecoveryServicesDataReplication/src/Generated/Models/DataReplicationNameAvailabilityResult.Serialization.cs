...
{
    public partial class DataReplicationNameAvailabilityResult : IUtf8JsonSerializable, IJsonModel<DataReplicationNameAvailabilityResult>, IPersistableModel<DataReplicationNameAvailabilityResult>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataReplicationNameAvailabilityResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<DataReplicationNameAvailabilityResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DataReplicationNameAvailabilityResult)} does not support '{format}' format.");
            }
