...
namespace Azure.ResourceManager.RecoveryServicesDataReplication.Models
{
    ...
    public partial class TestFailoverCleanupJobModelCustomProperties : DataReplicationJobCustomProperties
    {
        ...
        internal TestFailoverCleanupJobModelCustomProperties(string instanceType, AffectedObjectDetails affectedObjectDetails, IDictionary<string, BinaryData> serializedAdditionalRawData, string comments) : base(instanceType, affectedObjectDetails, serializedAdditionalRawData)
        {
            Comments = comments;
