...
namespace Azure.ResourceManager.RecoveryServicesDataReplication.Models
{
    ...
    public partial class HyperVToAzStackHciReplicationExtensionCustomProperties : DataReplicationExtensionCustomProperties, IJsonModel<HyperVToAzStackHciReplicationExtensionCustomProperties>
    {
        ...
        internal static HyperVToAzStackHciReplicationExtensionCustomProperties DeserializeHyperVToAzStackHciReplicationExtensionCustomProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("asrServiceUri"u8))
                {
                    ...
                    asrServiceUri = string.IsNullOrEmpty(prop.Value.GetString()) ? null : new Uri(prop.Value.GetString());
                    continue;
                }
                if (prop.NameEquals("rcmServiceUri"u8))
                {
                    ...
                    rcmServiceUri = string.IsNullOrEmpty(prop.Value.GetString()) ? null : new Uri(prop.Value.GetString());
                    continue;
                }
                if (prop.NameEquals("gatewayServiceUri"u8))
                {
                    ...
                    gatewayServiceUri = string.IsNullOrEmpty(prop.Value.GetString()) ? null : new Uri(prop.Value.GetString());
                    continue;
                }
