...
namespace Azure.ResourceManager.RecoveryServicesDataReplication.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GeneralPlannedFailoverModelCustomProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<GeneralPlannedFailoverModelCustomProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<GeneralPlannedFailoverModelCustomProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<GeneralPlannedFailoverModelCustomProperties>)} interface");
            }
        ...
        string IPersistableModel<GeneralPlannedFailoverModelCustomProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
