...
{
    public partial class GeneralPlannedFailoverModelCustomProperties : IUtf8JsonSerializable, IJsonModel<GeneralPlannedFailoverModelCustomProperties>, IPersistableModel<GeneralPlannedFailoverModelCustomProperties>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GeneralPlannedFailoverModelCustomProperties>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<GeneralPlannedFailoverModelCustomProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(GeneralPlannedFailoverModelCustomProperties)} does not support '{format}' format.");
            }
