...
{
    public partial class HyperVMigrateFabricModelCustomProperties : IUtf8JsonSerializable, IJsonModel<HyperVMigrateFabricModelCustomProperties>, IPersistableModel<HyperVMigrateFabricModelCustomProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(HyperVSiteId))
            {
                builder.Append("  hyperVSiteId:");
                builder.AppendLine($" '{HyperVSiteId.ToString()}'");
            }
