...
namespace Azure.ResourceManager.RecoveryServicesDataReplication.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HyperVMigrateFabricModelCustomProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<HyperVMigrateFabricModelCustomProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<HyperVMigrateFabricModelCustomProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<HyperVMigrateFabricModelCustomProperties>)} interface");
            }
        ...
        string IPersistableModel<HyperVMigrateFabricModelCustomProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
