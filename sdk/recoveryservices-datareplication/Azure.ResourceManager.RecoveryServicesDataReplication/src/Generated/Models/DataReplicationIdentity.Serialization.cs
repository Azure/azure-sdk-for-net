...
{
    public partial class DataReplicationIdentity : IUtf8JsonSerializable, IJsonModel<DataReplicationIdentity>, IPersistableModel<DataReplicationIdentity>
    {
        ...
        void IJsonModel<DataReplicationIdentity>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DataReplicationIdentity)} does not support '{format}' format.");
            }
