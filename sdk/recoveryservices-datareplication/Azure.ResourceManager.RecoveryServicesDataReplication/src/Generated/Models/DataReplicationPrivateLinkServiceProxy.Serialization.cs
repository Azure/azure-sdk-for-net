        ...
        internal static DataReplicationPrivateLinkServiceProxy DeserializeDataReplicationPrivateLinkServiceProxy(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("remotePrivateEndpointConnection"u8))
                {
                    ...
                    remotePrivateEndpointConnection = ModelSerializationExtensions.JsonDeserialize<WritableSubResource>(property.Value.GetRawText(), ModelSerializationExtensions.Options);
                    continue;
                }
