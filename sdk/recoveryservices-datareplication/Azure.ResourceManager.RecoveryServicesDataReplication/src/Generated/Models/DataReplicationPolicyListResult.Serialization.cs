...
namespace Azure.ResourceManager.RecoveryServicesDataReplication.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataReplicationPolicyListResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DataReplicationPolicyListResult)} does not support writing '{format}' format.");
            }
        ...
        DataReplicationPolicyListResult IJsonModel<DataReplicationPolicyListResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DataReplicationPolicyListResult)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<DataReplicationPolicyListResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(DataReplicationPolicyListResult)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        DataReplicationPolicyListResult IPersistableModel<DataReplicationPolicyListResult>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(DataReplicationPolicyListResult)} does not support reading '{options.Format}' format.");
            }
        }
