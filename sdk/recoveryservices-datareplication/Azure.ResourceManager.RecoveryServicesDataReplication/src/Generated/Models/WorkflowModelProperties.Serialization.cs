...
namespace Azure.ResourceManager.RecoveryServicesDataReplication.Models
{
    ...
    {
        internal static WorkflowModelProperties DeserializeWorkflowModelProperties(JsonElement element)
        {
            ...
            Optional<IReadOnlyList<TaskModel>> tasks = default;
            Optional<IReadOnlyList<ErrorModel>> errors = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("tasks"u8))
                {
                    ...
                    foreach (var item in property.Value.EnumerateArray())
                    {
                        array.Add(TaskModel.DeserializeTaskModel(item));
                    }
                    tasks = array;
                    continue;
                }
                if (property.NameEquals("errors"u8))
                {
                    ...
                    foreach (var item in property.Value.EnumerateArray())
                    {
                        array.Add(ErrorModel.DeserializeErrorModel(item));
                    }
                    errors = array;
                    continue;
                }
            ...
            return new WorkflowModelProperties(displayName.Value, Optional.ToNullable(state), Optional.ToNullable(startTime), Optional.ToNullable(endTime), objectId.Value, objectName.Value, objectInternalId.Value, objectInternalName.Value, Optional.ToNullable(objectType), replicationProviderId.Value, sourceFabricProviderId.Value, targetFabricProviderId.Value, Optional.ToList(allowedActions), activityId.Value, Optional.ToList(tasks), Optional.ToList(errors), customProperties);
        }
    }
}
