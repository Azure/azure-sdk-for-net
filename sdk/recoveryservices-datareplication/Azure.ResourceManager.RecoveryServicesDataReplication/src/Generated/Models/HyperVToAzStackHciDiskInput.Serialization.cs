...
namespace Azure.ResourceManager.RecoveryServicesDataReplication.Models
{
    public partial class HyperVToAzStackHciDiskInput : IUtf8JsonSerializable, IJsonModel<HyperVToAzStackHciDiskInput>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<HyperVToAzStackHciDiskInput>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<HyperVToAzStackHciDiskInput>)} interface");
            }
