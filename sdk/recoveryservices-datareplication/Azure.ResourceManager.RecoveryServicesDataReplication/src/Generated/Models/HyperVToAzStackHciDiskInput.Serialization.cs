...
namespace Azure.ResourceManager.RecoveryServicesDataReplication.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HyperVToAzStackHciDiskInput>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<HyperVToAzStackHciDiskInput>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<HyperVToAzStackHciDiskInput>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<HyperVToAzStackHciDiskInput>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
