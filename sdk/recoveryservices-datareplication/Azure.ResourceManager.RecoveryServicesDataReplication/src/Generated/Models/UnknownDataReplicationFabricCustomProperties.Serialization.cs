...
{
    internal partial class UnknownDataReplicationFabricCustomProperties : DataReplicationFabricCustomProperties, IJsonModel<DataReplicationFabricCustomProperties>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownDataReplicationFabricCustomProperties DeserializeUnknownDataReplicationFabricCustomProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownDataReplicationFabricCustomProperties(instanceType, additionalBinaryDataProperties);
        }
