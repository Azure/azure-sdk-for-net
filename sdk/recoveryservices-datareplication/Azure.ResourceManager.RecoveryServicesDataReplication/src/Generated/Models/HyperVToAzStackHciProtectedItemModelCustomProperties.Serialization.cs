...
namespace Azure.ResourceManager.RecoveryServicesDataReplication.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HyperVToAzStackHciProtectedItemModelCustomProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<HyperVToAzStackHciProtectedItemModelCustomProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<HyperVToAzStackHciProtectedItemModelCustomProperties>)} interface");
            }
        ...
        string IPersistableModel<HyperVToAzStackHciProtectedItemModelCustomProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
