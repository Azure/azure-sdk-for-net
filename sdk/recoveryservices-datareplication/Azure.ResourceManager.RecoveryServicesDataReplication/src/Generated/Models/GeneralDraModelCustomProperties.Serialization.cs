...
{
    public partial class GeneralDraModelCustomProperties : IUtf8JsonSerializable, IJsonModel<GeneralDraModelCustomProperties>, IPersistableModel<GeneralDraModelCustomProperties>
    {
        ...
        void IJsonModel<GeneralDraModelCustomProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(GeneralDraModelCustomProperties)} does not support '{format}' format.");
            }
