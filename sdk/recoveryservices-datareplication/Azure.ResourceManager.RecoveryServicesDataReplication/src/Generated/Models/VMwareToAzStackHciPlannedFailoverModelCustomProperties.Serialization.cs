...
{
    public partial class VMwareToAzStackHciPlannedFailoverModelCustomProperties : IUtf8JsonSerializable, IJsonModel<VMwareToAzStackHciPlannedFailoverModelCustomProperties>, IPersistableModel<VMwareToAzStackHciPlannedFailoverModelCustomProperties>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VMwareToAzStackHciPlannedFailoverModelCustomProperties>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<VMwareToAzStackHciPlannedFailoverModelCustomProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(VMwareToAzStackHciPlannedFailoverModelCustomProperties)} does not support '{format}' format.");
            }
