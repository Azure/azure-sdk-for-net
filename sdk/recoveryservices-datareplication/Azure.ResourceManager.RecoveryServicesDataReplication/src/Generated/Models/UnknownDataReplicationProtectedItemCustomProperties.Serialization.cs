...
{
    internal partial class UnknownDataReplicationProtectedItemCustomProperties : DataReplicationProtectedItemCustomProperties, IJsonModel<DataReplicationProtectedItemCustomProperties>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownDataReplicationProtectedItemCustomProperties DeserializeUnknownDataReplicationProtectedItemCustomProperties(JsonElement element, ModelReaderWriterOptions options)
        {
