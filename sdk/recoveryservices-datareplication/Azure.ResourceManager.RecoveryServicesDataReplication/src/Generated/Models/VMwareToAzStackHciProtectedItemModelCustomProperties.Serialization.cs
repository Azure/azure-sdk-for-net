...
namespace Azure.ResourceManager.RecoveryServicesDataReplication.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VMwareToAzStackHciProtectedItemModelCustomProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<VMwareToAzStackHciProtectedItemModelCustomProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<VMwareToAzStackHciProtectedItemModelCustomProperties>)} interface");
            }
        ...
        string IPersistableModel<VMwareToAzStackHciProtectedItemModelCustomProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
