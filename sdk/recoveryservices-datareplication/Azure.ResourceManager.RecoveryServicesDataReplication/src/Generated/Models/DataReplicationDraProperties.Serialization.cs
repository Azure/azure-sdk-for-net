...
{
    public partial class DataReplicationDraProperties : IUtf8JsonSerializable, IJsonModel<DataReplicationDraProperties>, IPersistableModel<DataReplicationDraProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(AuthenticationIdentity))
            {
                ...
                AppendChildObject(builder, AuthenticationIdentity, options, 2);
            }

            if (Optional.IsDefined(ResourceAccessIdentity))
            {
                builder.Append("  resourceAccessIdentity:");
                AppendChildObject(builder, ResourceAccessIdentity, options, 2);
            }
            ...
            if (Optional.IsDefined(LastHeartbeatOn))
            {
                ...
                builder.AppendLine($" '{LastHeartbeatOn.Value.ToString()}'");
            }
