...
{
    public partial class JobModelProperties : IUtf8JsonSerializable, IJsonModel<JobModelProperties>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<JobModelProperties>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<JobModelProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<JobModelProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(JobModelProperties)} does not support writing '{format}' format.");
            }
        ...
        JobModelProperties IJsonModel<JobModelProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<JobModelProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(JobModelProperties)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeJobModelProperties(document.RootElement, options);
        }

        internal static JobModelProperties DeserializeJobModelProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            JobObjectType? objectType = default;
            ...
            IReadOnlyList<TaskModel> tasks = default;
            IReadOnlyList<ErrorModel> errors = default;
            JobModelCustomProperties customProperties = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("objectType"u8))
                {
                    ...
                    objectType = new JobObjectType(property.Value.GetString());
                    continue;
                }
                ...
                if (property.NameEquals("tasks"u8))
                {
                    ...
                    foreach (var item in property.Value.EnumerateArray())
                    {
                        array.Add(TaskModel.DeserializeTaskModel(item, options));
                    }
                    tasks = array;
                    continue;
                }
                if (property.NameEquals("errors"u8))
                {
                    ...
                    foreach (var item in property.Value.EnumerateArray())
                    {
                        array.Add(ErrorModel.DeserializeErrorModel(item, options));
                    }
                    errors = array;
                    continue;
                }
                ...
                {
                    customProperties = JobModelCustomProperties.DeserializeJobModelCustomProperties(property.Value, options);
                    continue;
                }
        ...
        BinaryData IPersistableModel<JobModelProperties>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<JobModelProperties>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(JobModelProperties)} does not support writing '{options.Format}' format.");
            }
        }

        JobModelProperties IPersistableModel<JobModelProperties>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<JobModelProperties>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(JobModelProperties)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<JobModelProperties>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
