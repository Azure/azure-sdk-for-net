...
namespace Azure.ResourceManager.RecoveryServicesDataReplication.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ProtectedItemDynamicMemoryConfig>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ProtectedItemDynamicMemoryConfig>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ProtectedItemDynamicMemoryConfig>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<ProtectedItemDynamicMemoryConfig>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
