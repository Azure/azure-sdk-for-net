...
{
    public partial class DataReplicationTask : IUtf8JsonSerializable, IJsonModel<DataReplicationTask>, IPersistableModel<DataReplicationTask>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(ChildrenWorkflows))
            {
                builder.Append("  childrenWorkflows:");
                builder.AppendLine(" [");
                foreach (var item in ChildrenWorkflows)
                {
