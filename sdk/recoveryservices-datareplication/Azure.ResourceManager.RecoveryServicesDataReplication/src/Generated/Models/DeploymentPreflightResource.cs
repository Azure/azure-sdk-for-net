...
namespace Azure.ResourceManager.RecoveryServicesDataReplication.Models
{
    ...
    public partial class DeploymentPreflightResource
    {
        ...
        /// <summary> Initializes a new instance of <see cref="DeploymentPreflightResource"/>. </summary>
        ...
        internal DeploymentPreflightResource(string name, string type, string location, string apiVersion, BinaryData properties, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Type = type;
            Location = location;
