...
namespace Azure.ResourceManager.RecoveryServicesDataReplication.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataReplicationVaultPatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DataReplicationVaultPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DataReplicationVaultPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DataReplicationVaultPatch>)} interface");
            }
        ...
        string IPersistableModel<DataReplicationVaultPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
