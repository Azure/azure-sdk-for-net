...
namespace Azure.ResourceManager.RecoveryServicesDataReplication
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataReplicationFabricData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DataReplicationFabricData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DataReplicationFabricData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DataReplicationFabricData>)} interface");
            }
        ...
        string IPersistableModel<DataReplicationFabricData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
