...
namespace Azure.ResourceManager.RecoveryServicesDataReplication.Models
{
    ...
    public partial class HyperVToAzStackHCIDiskInput
    {
        ...
        internal HyperVToAzStackHCIDiskInput(string diskId, string storageContainerId, bool? isDynamic, long diskSizeGB, string diskFileFormat, bool isOSDisk, long? diskBlockSize, long? diskLogicalSectorSize, long? diskPhysicalSectorSize, string diskIdentifier, DiskControllerInputs diskController, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            DiskId = diskId;
        ...
        /// <summary> Initializes a new instance of <see cref="HyperVToAzStackHCIDiskInput"/> for deserialization. </summary>
        internal HyperVToAzStackHCIDiskInput()
        {
        }
