...
namespace Azure.ResourceManager.RecoveryServicesDataReplication.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TaskModelCustomProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<TaskModelCustomProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<TaskModelCustomProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<TaskModelCustomProperties>)} interface");
            }
        ...
        string IPersistableModel<TaskModelCustomProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
