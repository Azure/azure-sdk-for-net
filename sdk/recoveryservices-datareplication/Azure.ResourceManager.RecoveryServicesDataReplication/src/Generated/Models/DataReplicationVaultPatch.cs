...
namespace Azure.ResourceManager.RecoveryServicesDataReplication.Models
{
    ...
    public partial class DataReplicationVaultPatch
    {
        ...
        internal DataReplicationVaultPatch(IDictionary<string, string> tags, DataReplicationVaultProperties properties, ManagedServiceIdentity identity, string id, string name, string @type, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Tags = tags;
