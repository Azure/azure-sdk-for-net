...
{
    public partial class DataReplicationVaultProperties : IUtf8JsonSerializable, IJsonModel<DataReplicationVaultProperties>, IPersistableModel<DataReplicationVaultProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(VaultType))
            {
                builder.Append("  vaultType:");
                builder.AppendLine($" '{VaultType.ToString()}'");
            }
