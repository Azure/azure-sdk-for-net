...
{
    /// <summary> Protected item model for update. </summary>
    public partial class ProtectedItemModelPatch : ResourceData
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="ProtectedItemModelPatch"/>. </summary>
        ...
        internal ProtectedItemModelPatch(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, ProtectedItemModelPropertiesUpdate properties, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
