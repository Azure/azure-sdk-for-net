...
namespace Azure.ResourceManager.RecoveryServicesDataReplication.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VMwareToAzStackHciProtectedDiskProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<VMwareToAzStackHciProtectedDiskProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<VMwareToAzStackHciProtectedDiskProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<VMwareToAzStackHciProtectedDiskProperties>)} interface");
            }
        ...
        string IPersistableModel<VMwareToAzStackHciProtectedDiskProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
