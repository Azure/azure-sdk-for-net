...
namespace Azure.ResourceManager.RecoveryServicesDataReplication.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PlannedFailoverModelProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PlannedFailoverModelProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PlannedFailoverModelProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<PlannedFailoverModelProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
