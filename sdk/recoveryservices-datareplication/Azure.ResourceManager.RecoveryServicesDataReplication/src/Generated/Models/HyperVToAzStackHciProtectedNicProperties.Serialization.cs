...
namespace Azure.ResourceManager.RecoveryServicesDataReplication.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HyperVToAzStackHciProtectedNicProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<HyperVToAzStackHciProtectedNicProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<HyperVToAzStackHciProtectedNicProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<HyperVToAzStackHciProtectedNicProperties>)} interface");
            }
        ...
        string IPersistableModel<HyperVToAzStackHciProtectedNicProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
