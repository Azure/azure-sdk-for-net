...
namespace Azure.ResourceManager.RecoveryServicesDataReplication.Models
{
    ...
    {
        internal static HealthErrorModel DeserializeHealthErrorModel(JsonElement element)
        {
            ...
            Optional<IReadOnlyList<InnerHealthErrorModel>> childErrors = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("childErrors"u8))
                {
                    ...
                    foreach (var item in property.Value.EnumerateArray())
                    {
                        array.Add(InnerHealthErrorModel.DeserializeInnerHealthErrorModel(item));
                    }
                    childErrors = array;
                    continue;
                }
            ...
            return new HealthErrorModel(affectedResourceType.Value, Optional.ToList(affectedResourceCorrelationIds), Optional.ToList(childErrors), code.Value, healthCategory.Value, category.Value, severity.Value, source.Value, Optional.ToNullable(creationTime), Optional.ToNullable(isCustomerResolvable), summary.Value, message.Value, causes.Value, recommendation.Value);
        }
    }
}
