...
namespace Azure.ResourceManager.RecoveryServicesDataReplication.Models
{
    ...
    public partial class HealthErrorModel
    {
        ...
        /// <summary> Initializes a new instance of <see cref="HealthErrorModel"/>. </summary>
        internal HealthErrorModel()
        {
            AffectedResourceCorrelationIds = new ChangeTrackingList<string>();
            ChildErrors = new ChangeTrackingList<InnerHealthErrorModel>();
        }
        ...
        internal HealthErrorModel(string affectedResourceType, IReadOnlyList<string> affectedResourceCorrelationIds, IReadOnlyList<InnerHealthErrorModel> childErrors, string code, string healthCategory, string category, string severity, string source, DateTimeOffset? createdOn, bool? isCustomerResolvable, string summary, string message, string causes, string recommendation, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
        ...
        public IReadOnlyList<InnerHealthErrorModel> ChildErrors { get; }
