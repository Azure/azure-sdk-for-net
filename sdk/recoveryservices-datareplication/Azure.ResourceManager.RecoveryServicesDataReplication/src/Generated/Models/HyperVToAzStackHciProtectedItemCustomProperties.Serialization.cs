...
namespace Azure.ResourceManager.RecoveryServicesDataReplication.Models
{
    ...
    public partial class HyperVToAzStackHciProtectedItemCustomProperties : DataReplicationProtectedItemCustomProperties, IJsonModel<HyperVToAzStackHciProtectedItemCustomProperties>
    {
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            foreach (Models.HyperVToAzStackHciDiskInput item in DisksToInclude)
            {
                writer.WriteObjectValue<Models.HyperVToAzStackHciDiskInput>(item, options);
            }
        ...
        internal static HyperVToAzStackHciProtectedItemCustomProperties DeserializeHyperVToAzStackHciProtectedItemCustomProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            IList<Models.HyperVToAzStackHciDiskInput> disksToInclude = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    List<Models.HyperVToAzStackHciDiskInput> array = new List<Models.HyperVToAzStackHciDiskInput>();
                    foreach (var item in prop.Value.EnumerateArray())
                    {
                        array.Add(Models.HyperVToAzStackHciDiskInput.DeserializeHyperVToAzStackHciDiskInput(item, options));
                    }
