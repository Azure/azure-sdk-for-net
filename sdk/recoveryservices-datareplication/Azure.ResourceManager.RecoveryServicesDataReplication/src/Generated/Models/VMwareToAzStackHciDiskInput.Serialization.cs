...
namespace Azure.ResourceManager.RecoveryServicesDataReplication.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VMwareToAzStackHciDiskInput>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<VMwareToAzStackHciDiskInput>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<VMwareToAzStackHciDiskInput>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<VMwareToAzStackHciDiskInput>)} interface");
            }
        ...
        string IPersistableModel<VMwareToAzStackHciDiskInput>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
