...
{
    public partial class DataReplicationRecoveryPointProperties : IUtf8JsonSerializable, IJsonModel<DataReplicationRecoveryPointProperties>, IPersistableModel<DataReplicationRecoveryPointProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(RecoveryPointOn))
            {
                ...
                builder.AppendLine($" '{RecoveryPointOn.ToString()}'");
            }
