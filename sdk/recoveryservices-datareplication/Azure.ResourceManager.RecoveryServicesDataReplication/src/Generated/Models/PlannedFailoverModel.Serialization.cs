...
namespace Azure.ResourceManager.RecoveryServicesDataReplication.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PlannedFailoverModel>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PlannedFailoverModel>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PlannedFailoverModel>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PlannedFailoverModel>)} interface");
            }
        ...
        string IPersistableModel<PlannedFailoverModel>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
