...
{
    internal partial class UnknownDataReplicationProtectedItemCustomPropertiesUpdate : DataReplicationProtectedItemCustomPropertiesUpdate, IJsonModel<DataReplicationProtectedItemCustomPropertiesUpdate>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownDataReplicationProtectedItemCustomPropertiesUpdate DeserializeUnknownDataReplicationProtectedItemCustomPropertiesUpdate(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownDataReplicationProtectedItemCustomPropertiesUpdate(instanceType, additionalBinaryDataProperties);
        }
