...
namespace Azure.ResourceManager.RecoveryServicesDataReplication.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HyperVToAzStackHciPolicyModelCustomProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<HyperVToAzStackHciPolicyModelCustomProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<HyperVToAzStackHciPolicyModelCustomProperties>)} interface");
            }
        ...
        string IPersistableModel<HyperVToAzStackHciPolicyModelCustomProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
