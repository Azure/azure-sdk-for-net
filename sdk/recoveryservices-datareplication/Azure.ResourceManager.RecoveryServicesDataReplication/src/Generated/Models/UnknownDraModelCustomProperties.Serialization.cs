...
namespace Azure.ResourceManager.RecoveryServicesDataReplication.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DraModelCustomProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DraModelCustomProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DraModelCustomProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DraModelCustomProperties>)} interface");
            }
        ...
        string IPersistableModel<DraModelCustomProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
