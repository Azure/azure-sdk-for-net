...
{
    public partial class DataReplicationInnerHealthErrorInfo : IUtf8JsonSerializable, IJsonModel<DataReplicationInnerHealthErrorInfo>, IPersistableModel<DataReplicationInnerHealthErrorInfo>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  healthCategory:");
                builder.AppendLine($" '{HealthCategory}'");
            }
            ...
            {
                builder.Append("  isCustomerResolvable:");
                var boolValue = IsCustomerResolvable.Value == true ? "true" : "false";
