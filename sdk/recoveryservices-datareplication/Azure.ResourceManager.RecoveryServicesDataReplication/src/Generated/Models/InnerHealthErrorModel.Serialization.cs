...
namespace Azure.ResourceManager.RecoveryServicesDataReplication.Models
{
    ...
    {
        internal static InnerHealthErrorModel DeserializeInnerHealthErrorModel(JsonElement element)
        {
            ...
            return new InnerHealthErrorModel(code.Value, healthCategory.Value, category.Value, severity.Value, source.Value, Optional.ToNullable(creationTime), Optional.ToNullable(isCustomerResolvable), summary.Value, message.Value, causes.Value, recommendation.Value);
        }
    }
}
