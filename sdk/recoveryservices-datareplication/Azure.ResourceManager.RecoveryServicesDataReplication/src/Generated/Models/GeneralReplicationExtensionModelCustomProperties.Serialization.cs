...
{
    public partial class GeneralReplicationExtensionModelCustomProperties : IUtf8JsonSerializable, IJsonModel<GeneralReplicationExtensionModelCustomProperties>, IPersistableModel<GeneralReplicationExtensionModelCustomProperties>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GeneralReplicationExtensionModelCustomProperties>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<GeneralReplicationExtensionModelCustomProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(GeneralReplicationExtensionModelCustomProperties)} does not support '{format}' format.");
            }
