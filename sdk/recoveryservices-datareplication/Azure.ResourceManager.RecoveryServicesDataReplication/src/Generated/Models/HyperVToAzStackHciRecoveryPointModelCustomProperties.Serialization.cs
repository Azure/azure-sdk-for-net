...
namespace Azure.ResourceManager.RecoveryServicesDataReplication.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HyperVToAzStackHciRecoveryPointModelCustomProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<HyperVToAzStackHciRecoveryPointModelCustomProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<HyperVToAzStackHciRecoveryPointModelCustomProperties>)} interface");
            }
        ...
        string IPersistableModel<HyperVToAzStackHciRecoveryPointModelCustomProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
