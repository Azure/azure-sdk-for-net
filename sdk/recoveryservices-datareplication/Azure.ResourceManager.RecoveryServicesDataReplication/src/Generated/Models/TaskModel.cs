...
namespace Azure.ResourceManager.RecoveryServicesDataReplication.Models
{
    ...
    public partial class TaskModel
    {
        ...
        /// <summary> Initializes a new instance of <see cref="TaskModel"/>. </summary>
        internal TaskModel()
        {
        ...
        internal TaskModel(string taskName, TaskState? state, DateTimeOffset? startOn, DateTimeOffset? endOn, TaskModelCustomProperties customProperties, IReadOnlyList<JobModelData> childrenJobs, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            TaskName = taskName;
            State = state;
            StartOn = startOn;
        ...
        public IReadOnlyList<JobModelData> ChildrenJobs { get; }
    }
}
