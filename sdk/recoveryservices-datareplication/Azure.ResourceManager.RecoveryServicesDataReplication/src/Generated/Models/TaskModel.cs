...
namespace Azure.ResourceManager.RecoveryServicesDataReplication.Models
{
    ...
    public partial class TaskModel
    {
        ...
        internal TaskModel()
        {
            ChildrenWorkflows = new ChangeTrackingList<WorkflowModelData>();
        }
        ...
        internal TaskModel(string taskName, TaskState? state, DateTimeOffset? startOn, DateTimeOffset? endOn, TaskModelCustomProperties customProperties, IReadOnlyList<WorkflowModelData> childrenWorkflows)
        {
            TaskName = taskName;
            State = state;
            StartOn = startOn;
        ...
        public IReadOnlyList<WorkflowModelData> ChildrenWorkflows { get; }
    }
}
