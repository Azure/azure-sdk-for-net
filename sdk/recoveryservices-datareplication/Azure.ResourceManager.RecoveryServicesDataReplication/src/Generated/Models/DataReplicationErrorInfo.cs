...
namespace Azure.ResourceManager.RecoveryServicesDataReplication.Models
{
    ...
    public partial class DataReplicationErrorInfo
    {
        ...
        internal DataReplicationErrorInfo(string code, string @type, string severity, DateTimeOffset? createdOn, string message, string causes, string recommendation, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Code = code;
            Type = @type;
            Severity = severity;
