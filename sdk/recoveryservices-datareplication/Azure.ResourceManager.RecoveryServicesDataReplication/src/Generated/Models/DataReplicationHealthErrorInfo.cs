...
namespace Azure.ResourceManager.RecoveryServicesDataReplication.Models
{
    ...
    public partial class DataReplicationHealthErrorInfo
    {
        ...
        internal DataReplicationHealthErrorInfo(string affectedResourceType, IReadOnlyList<string> affectedResourceCorrelationIds, IReadOnlyList<DataReplicationInnerHealthErrorInfo> childErrors, string code, string healthCategory, string category, string severity, string source, DateTimeOffset? createdOn, bool? isCustomerResolvable, string summary, string message, string causes, string recommendation)
        {
