...
namespace Azure.ResourceManager.RecoveryServicesDataReplication.Models
{
    ...
    public partial class HyperVToAzStackHciProtectedItemModelCustomPropertiesUpdate : ProtectedItemModelCustomPropertiesUpdate
    {
        /// <summary> Initializes a new instance of <see cref="HyperVToAzStackHciProtectedItemModelCustomPropertiesUpdate"/>. </summary>
        ...
        internal HyperVToAzStackHciProtectedItemModelCustomPropertiesUpdate(string instanceType, IDictionary<string, BinaryData> serializedAdditionalRawData, IList<HyperVToAzStackHciNicInput> nicsToInclude, int? targetCpuCores, bool? isDynamicRam, ProtectedItemDynamicMemoryConfig dynamicMemoryConfig, int? targetMemoryInMegaBytes, string osType) : base(instanceType, serializedAdditionalRawData)
        {
