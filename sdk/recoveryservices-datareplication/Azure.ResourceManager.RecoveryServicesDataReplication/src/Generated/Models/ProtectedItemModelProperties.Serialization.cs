...
{
    public partial class ProtectedItemModelProperties : IUtf8JsonSerializable, IJsonModel<ProtectedItemModelProperties>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ProtectedItemModelProperties>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<ProtectedItemModelProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<ProtectedItemModelProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ProtectedItemModelProperties)} does not support writing '{format}' format.");
            }
        ...
        ProtectedItemModelProperties IJsonModel<ProtectedItemModelProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ProtectedItemModelProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ProtectedItemModelProperties)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeProtectedItemModelProperties(document.RootElement, options);
        }

        internal static ProtectedItemModelProperties DeserializeProtectedItemModelProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            ResynchronizationState? resynchronizationState = default;
            ...
            HealthStatus? replicationHealth = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("resyncRequired"u8))
                {
                    ...
                    resyncRequired = Boolean.Parse(property.Value.GetString());
                    continue;
                }
        ...
        BinaryData IPersistableModel<ProtectedItemModelProperties>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ProtectedItemModelProperties>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ProtectedItemModelProperties)} does not support writing '{options.Format}' format.");
            }
        }

        ProtectedItemModelProperties IPersistableModel<ProtectedItemModelProperties>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ProtectedItemModelProperties>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ProtectedItemModelProperties)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<ProtectedItemModelProperties>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
