...
namespace Azure.ResourceManager.RecoveryServicesDataReplication.Models
{
    ...
    public partial class DataReplicationProtectedItemPatch : ResourceData
    {
        ...
        internal DataReplicationProtectedItemPatch(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, DataReplicationProtectedItemPropertiesUpdate properties) : base(id, name, resourceType, systemData)
        {
