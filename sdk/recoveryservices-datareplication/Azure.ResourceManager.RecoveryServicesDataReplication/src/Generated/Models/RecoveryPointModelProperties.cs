...
namespace Azure.ResourceManager.RecoveryServicesDataReplication.Models
{
    ...
    public partial class RecoveryPointModelProperties
    {
        ...
        /// <summary> Initializes a new instance of <see cref="RecoveryPointModelProperties"/>. </summary>
        ...
        /// The available derived classes include <see cref="HyperVToAzStackHCIRecoveryPointModelCustomProperties"/> and <see cref="VMwareToAzStackHCIRecoveryPointModelCustomProperties"/>.
        /// </param>
        /// <exception cref="ArgumentNullException"> <paramref name="customProperties"/> is null. </exception>
        internal RecoveryPointModelProperties(DateTimeOffset recoveryPointOn, RecoveryPointType recoveryPointType, RecoveryPointModelCustomProperties customProperties)
        {
        ...
        internal RecoveryPointModelProperties(DateTimeOffset recoveryPointOn, RecoveryPointType recoveryPointType, RecoveryPointModelCustomProperties customProperties, ProvisioningState? provisioningState, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            RecoveryPointOn = recoveryPointOn;
            RecoveryPointType = recoveryPointType;
            CustomProperties = customProperties;
        ...
        /// <summary> Initializes a new instance of <see cref="RecoveryPointModelProperties"/> for deserialization. </summary>
        ...
        public RecoveryPointType RecoveryPointType { get; }
        /// <summary>
        /// Recovery point model custom properties.
        /// Please note <see cref="RecoveryPointModelCustomProperties"/> is the base class. According to the scenario, a derived class of the base class might need to be assigned here, or this property needs to be casted to one of the possible derived classes.
        /// The available derived classes include <see cref="HyperVToAzStackHCIRecoveryPointModelCustomProperties"/> and <see cref="VMwareToAzStackHCIRecoveryPointModelCustomProperties"/>.
