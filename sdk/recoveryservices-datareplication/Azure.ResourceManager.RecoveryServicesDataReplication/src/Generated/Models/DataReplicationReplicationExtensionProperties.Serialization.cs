...
{
    public partial class DataReplicationReplicationExtensionProperties : IUtf8JsonSerializable, IJsonModel<DataReplicationReplicationExtensionProperties>, IPersistableModel<DataReplicationReplicationExtensionProperties>
    {
        ...
        void IJsonModel<DataReplicationReplicationExtensionProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DataReplicationReplicationExtensionProperties)} does not support '{format}' format.");
            }
