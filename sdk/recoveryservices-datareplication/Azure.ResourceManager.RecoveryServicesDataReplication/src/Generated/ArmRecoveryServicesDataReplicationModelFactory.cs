...
namespace Azure.ResourceManager.RecoveryServicesDataReplication.Models
{
    ...
    public static partial class ArmRecoveryServicesDataReplicationModelFactory
    {
        ...
        public static DataReplicationVaultPatch DataReplicationVaultPatch(IDictionary<string, string> tags = default, DataReplicationVaultProperties properties = default, ManagedServiceIdentity identity = default, string id = default, string name = default, string @type = default, SystemData systemData = default)
        {
            tags ??= new ChangeTrackingDictionary<string, string>();
        ...
        public static DataReplicationProtectedItemPatch DataReplicationProtectedItemPatch(DataReplicationProtectedItemCustomPropertiesUpdate customProperties = default, string id = default, string name = default, string @type = default, SystemData systemData = default)
        {
        ...
        public static HyperVToAzStackHciProtectedItemCustomPropertiesUpdate HyperVToAzStackHciProtectedItemCustomPropertiesUpdate(IEnumerable<Models.HyperVToAzStackHciNicInput> nicsToInclude = default, int? targetCpuCores = default, bool? isDynamicRam = default, ProtectedItemDynamicMemoryConfig dynamicMemoryConfig = default, int? targetMemoryInMegaBytes = default, string osType = default)
        {
            nicsToInclude ??= new ChangeTrackingList<Models.HyperVToAzStackHciNicInput>();
        ...
        public static DataReplicationVaultPatch DataReplicationVaultPatch(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, DataReplicationVaultProperties properties, ManagedServiceIdentity identity)
        {
            tags ??= new ChangeTrackingDictionary<string, string>();
        ...
        /// <returns> A new <see cref="Models.DataReplicationFabricPatch"/> instance for mocking. </returns>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public static DataReplicationFabricPatch DataReplicationFabricPatch(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, DataReplicationFabricProperties properties)
        {
            tags ??= new ChangeTrackingDictionary<string, string>();
        ...
        /// <returns> A new <see cref="Models.DataReplicationProtectedItemPatch"/> instance for mocking. </returns>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public static DataReplicationProtectedItemPatch DataReplicationProtectedItemPatch(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, DataReplicationProtectedItemCustomPropertiesUpdate customProperties)
        {
            return new DataReplicationProtectedItemPatch(
                default,
                id,
