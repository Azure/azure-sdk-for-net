...
namespace Azure.ResourceManager.RecoveryServicesDataReplication
{
    ...
    {
        private static IJsonModel<DataReplicationFabricData> s_dataDeserializationInstance;

        private static IJsonModel<DataReplicationFabricData> DataDeserializationInstance => s_dataDeserializationInstance ??= new DataReplicationFabricData();
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        DataReplicationFabricData IJsonModel<DataReplicationFabricData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => DataDeserializationInstance.Create(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<DataReplicationFabricData>.GetFormatFromOptions(ModelReaderWriterOptions options) => DataDeserializationInstance.GetFormatFromOptions(options);
    }
}
