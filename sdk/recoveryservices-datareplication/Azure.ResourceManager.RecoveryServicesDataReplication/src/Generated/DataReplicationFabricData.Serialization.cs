...
namespace Azure.ResourceManager.RecoveryServicesDataReplication
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataReplicationFabricData>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<DataReplicationFabricData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DataReplicationFabricData)} does not support '{format}' format.");
            }
        ...
        internal static DataReplicationFabricData DeserializeDataReplicationFabricData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new DataReplicationFabricData(id, name, type, systemData.Value, tags ?? new ChangeTrackingDictionary<string, string>(), location, properties, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<DataReplicationFabricData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(DataReplicationFabricData)} does not support '{options.Format}' format.");
            }
        }
