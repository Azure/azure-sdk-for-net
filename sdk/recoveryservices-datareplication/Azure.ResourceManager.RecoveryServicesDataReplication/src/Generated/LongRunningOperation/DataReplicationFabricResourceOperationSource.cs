...
{
    /// <summary></summary>
    internal partial class DataReplicationFabricResourceOperationSource : IOperationSource<DataReplicationFabricResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal DataReplicationFabricResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
