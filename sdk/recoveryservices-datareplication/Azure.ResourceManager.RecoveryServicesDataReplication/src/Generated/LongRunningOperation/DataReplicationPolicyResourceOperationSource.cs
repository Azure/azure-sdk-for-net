...
{
    /// <summary></summary>
    internal partial class DataReplicationPolicyResourceOperationSource : IOperationSource<DataReplicationPolicyResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal DataReplicationPolicyResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
