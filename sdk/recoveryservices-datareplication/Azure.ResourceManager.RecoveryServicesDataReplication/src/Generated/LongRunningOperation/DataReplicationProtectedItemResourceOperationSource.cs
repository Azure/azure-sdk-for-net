...
{
    /// <summary></summary>
    internal partial class DataReplicationProtectedItemResourceOperationSource : IOperationSource<DataReplicationProtectedItemResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal DataReplicationProtectedItemResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
