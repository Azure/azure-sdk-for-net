...
{
    /// <summary></summary>
    internal partial class DataReplicationVaultResourceOperationSource : IOperationSource<DataReplicationVaultResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal DataReplicationVaultResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
