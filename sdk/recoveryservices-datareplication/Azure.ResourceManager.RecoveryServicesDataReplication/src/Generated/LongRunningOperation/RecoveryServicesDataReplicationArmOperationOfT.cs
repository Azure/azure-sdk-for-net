...
{
    internal partial class RecoveryServicesDataReplicationArmOperation<T> : ArmOperation<T>
    {
        ...
        internal RecoveryServicesDataReplicationArmOperation(Response<T> response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal RecoveryServicesDataReplicationArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
