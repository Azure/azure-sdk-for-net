...
{
    /// <summary></summary>
    internal partial class DataReplicationFabricAgentResourceOperationSource : IOperationSource<DataReplicationFabricAgentResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal DataReplicationFabricAgentResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
