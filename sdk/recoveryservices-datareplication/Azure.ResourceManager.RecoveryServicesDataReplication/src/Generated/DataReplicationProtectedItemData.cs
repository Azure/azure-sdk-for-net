...
namespace Azure.ResourceManager.RecoveryServicesDataReplication
{
    ...
    public partial class DataReplicationProtectedItemData : ResourceData
    {
        ...
        internal DataReplicationProtectedItemData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, DataReplicationProtectedItemProperties properties) : base(id, name, resourceType, systemData)
        {
