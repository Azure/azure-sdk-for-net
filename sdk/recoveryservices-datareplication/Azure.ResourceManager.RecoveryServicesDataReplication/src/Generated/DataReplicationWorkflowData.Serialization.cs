...
namespace Azure.ResourceManager.RecoveryServicesDataReplication
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataReplicationWorkflowData>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<DataReplicationWorkflowData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<DataReplicationWorkflowData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DataReplicationWorkflowData)} does not support writing '{format}' format.");
            }

            writer.WriteStartObject();
            writer.WritePropertyName("properties"u8);
            writer.WriteObjectValue<DataReplicationWorkflowProperties>(Properties, options);
            if (options.Format != "W")
            {
        ...
        DataReplicationWorkflowData IJsonModel<DataReplicationWorkflowData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DataReplicationWorkflowData)} does not support reading '{format}' format.");
            }
        ...
        internal static DataReplicationWorkflowData DeserializeDataReplicationWorkflowData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            DataReplicationWorkflowProperties properties = default;
        ...
        BinaryData IPersistableModel<DataReplicationWorkflowData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(DataReplicationWorkflowData)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        DataReplicationWorkflowData IPersistableModel<DataReplicationWorkflowData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(DataReplicationWorkflowData)} does not support reading '{options.Format}' format.");
            }
        }
