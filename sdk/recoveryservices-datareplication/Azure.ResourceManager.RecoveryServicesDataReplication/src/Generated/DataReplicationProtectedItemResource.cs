...
namespace Azure.ResourceManager.RecoveryServicesDataReplication
{
    ...
    public partial class DataReplicationProtectedItemResource : ArmResource
    {
        ...
        /// <item>
        /// <term> Operation Id. </term>
        /// <description> ProtectedItem_Update. </description>
        /// </item>
        /// <item>
        /// <term> Default Api Version. </term>
        /// <description> 2024-09-01. </description>
        ...
        /// <summary>
        /// Updates the DataReplicationProtectedItem.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataReplication/replicationVaults/{vaultName}/protectedItems/{protectedItemName}. </description>
        ...
        public virtual async Task<ArmOperation<DataReplicationProtectedItemResource>> UpdateAsync(WaitUntil waitUntil, DataReplicationProtectedItemData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _protectedItemRestClient.CreateCreateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, DataReplicationProtectedItemData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                RecoveryServicesDataReplicationArmOperation<DataReplicationProtectedItemResource> operation = new RecoveryServicesDataReplicationArmOperation<DataReplicationProtectedItemResource>(
                    new DataReplicationProtectedItemResourceOperationSource(Client),
                    _protectedItemClientDiagnostics,
