...
{
    internal partial class DeploymentPreflightRestOperations
    {
        ...
        /// <summary> Initializes a new instance of DeploymentPreflightRestOperations. </summary>
        /// <param name="pipeline"> The HTTP pipeline for sending and receiving REST requests and responses. </param>
        /// <param name="applicationId"> The application id to use for user agent. </param>
        /// <param name="endpoint"> Service host. </param>
        /// <param name="apiVersion"> The API version to use for this operation. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="pipeline"/> or <paramref name="apiVersion"/> is null. </exception>
        public DeploymentPreflightRestOperations(HttpPipeline pipeline, string applicationId, Uri endpoint = null, string apiVersion = default)
        {
        ...
        internal HttpMessage CreatePostRequest(string subscriptionId, string resourceGroupName, string deploymentId, DeploymentPreflight body)
        {
            ...
            if (body != null)
            {
                ...
                ((IJsonModel<DeploymentPreflight>)body).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
        ...
        public async Task<Response<DeploymentPreflight>> PostAsync(string subscriptionId, string resourceGroupName, string deploymentId, DeploymentPreflight body = null, CancellationToken cancellationToken = default)
        {
            ...
            using var message = CreatePostRequest(subscriptionId, resourceGroupName, deploymentId, body);
