...
namespace Azure.ResourceManager.RecoveryServicesDataReplication
{
    ...
    public partial class DataReplicationPrivateEndpointConnectionCollection : ArmCollection, IEnumerable<DataReplicationPrivateEndpointConnectionResource>, IAsyncEnumerable<DataReplicationPrivateEndpointConnectionResource>
    {
        ...
        internal DataReplicationPrivateEndpointConnectionCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _privateEndpointConnectionsRestClient = new PrivateEndpointConnections(_privateEndpointConnectionsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, dataReplicationPrivateEndpointConnectionApiVersion ?? "2024-09-01");
        ...
        public virtual AsyncPageable<DataReplicationPrivateEndpointConnectionResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<DataReplicationPrivateEndpointConnectionData, DataReplicationPrivateEndpointConnectionResource>(new PrivateEndpointConnectionsGetAllAsyncCollectionResultOfT(
                _privateEndpointConnectionsRestClient,
                Guid.Parse(Id.SubscriptionId),
                Id.ResourceGroupName,
                Id.Name,
                context,
                "DataReplicationPrivateEndpointConnectionCollection.GetAll"), data => new DataReplicationPrivateEndpointConnectionResource(Client, data));
        }
        ...
        public virtual Pageable<DataReplicationPrivateEndpointConnectionResource> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            return new PageableWrapper<DataReplicationPrivateEndpointConnectionData, DataReplicationPrivateEndpointConnectionResource>(new PrivateEndpointConnectionsGetAllCollectionResultOfT(
                _privateEndpointConnectionsRestClient,
                Guid.Parse(Id.SubscriptionId),
                Id.ResourceGroupName,
                Id.Name,
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string privateEndpointConnectionName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                Response<DataReplicationPrivateEndpointConnectionData> response = default;
                switch (result.Status)
                {
                    case 200:
                        response = Response.FromValue(DataReplicationPrivateEndpointConnectionData.FromResponse(result), result);
                        break;
                    case 404:
                        response = Response.FromValue((DataReplicationPrivateEndpointConnectionData)null, result);
                        break;
                    default:
