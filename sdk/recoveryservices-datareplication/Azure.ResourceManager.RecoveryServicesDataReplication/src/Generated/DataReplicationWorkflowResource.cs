...
namespace Azure.ResourceManager.RecoveryServicesDataReplication
{
    ...
    public partial class DataReplicationWorkflowResource : ArmResource
    {
        ...
        private readonly ClientDiagnostics _dataReplicationWorkflowWorkflowClientDiagnostics;
        ...
        internal DataReplicationWorkflowResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            _dataReplicationWorkflowWorkflowClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.RecoveryServicesDataReplication", ResourceType.Namespace, Diagnostics);
            TryGetApiVersion(ResourceType, out string dataReplicationWorkflowWorkflowApiVersion);
            _dataReplicationWorkflowWorkflowRestClient = new WorkflowRestOperations(Pipeline, Diagnostics.ApplicationId, Endpoint, dataReplicationWorkflowWorkflowApiVersion);
#if DEBUG
        ...
        public virtual DataReplicationWorkflowData Data
        {
            get
            {
                if (!HasData)
        ...
        public virtual async Task<Response<DataReplicationWorkflowResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            using var scope = _dataReplicationWorkflowWorkflowClientDiagnostics.CreateScope("DataReplicationWorkflowResource.Get");
            scope.Start();
            try
            {
                var response = await _dataReplicationWorkflowWorkflowRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new DataReplicationWorkflowResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<DataReplicationWorkflowResource> Get(CancellationToken cancellationToken = default)
        {
            using var scope = _dataReplicationWorkflowWorkflowClientDiagnostics.CreateScope("DataReplicationWorkflowResource.Get");
            scope.Start();
            try
            {
                var response = _dataReplicationWorkflowWorkflowRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new DataReplicationWorkflowResource(Client, response.Value), response.GetRawResponse());
            }
