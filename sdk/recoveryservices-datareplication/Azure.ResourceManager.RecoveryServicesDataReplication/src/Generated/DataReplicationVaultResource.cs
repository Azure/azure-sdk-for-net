...
namespace Azure.ResourceManager.RecoveryServicesDataReplication
{
    ...
    public partial class DataReplicationVaultResource : ArmResource
    {
        ...
        /// <summary>
        /// Updates the DataReplicationVault.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataReplication/replicationVaults/{vaultName}. </description>
        ...
        public virtual async Task<ArmOperation<DataReplicationVaultResource>> UpdateAsync(WaitUntil waitUntil, DataReplicationVaultData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _vaultRestClient.CreateCreateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, DataReplicationVaultData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                RecoveryServicesDataReplicationArmOperation<DataReplicationVaultResource> operation = new RecoveryServicesDataReplicationArmOperation<DataReplicationVaultResource>(
                    new DataReplicationVaultResourceOperationSource(Client),
                    _vaultClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<DataReplicationVaultResource> Update(WaitUntil waitUntil, DataReplicationVaultData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
