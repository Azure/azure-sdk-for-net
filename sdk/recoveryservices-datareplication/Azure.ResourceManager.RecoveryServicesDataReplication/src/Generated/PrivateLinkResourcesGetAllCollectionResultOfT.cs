...
{
    internal partial class PrivateLinkResourcesGetAllCollectionResultOfT : Pageable<DataReplicationPrivateLinkResourceData>
    {
        ...
        public PrivateLinkResourcesGetAllCollectionResultOfT(PrivateLinkResources client, Guid subscriptionId, string resourceGroupName, string vaultName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
        ...
        public override IEnumerable<Page<DataReplicationPrivateLinkResourceData>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                yield return Page<DataReplicationPrivateLinkResourceData>.FromValues((IReadOnlyList<DataReplicationPrivateLinkResourceData>)result.Value, nextPage?.AbsoluteUri, response);
        ...
        private Response GetNextResponse(int? pageSizeHint, Uri nextLink)
        {
            ...
            using DiagnosticScope scope = _client.ClientDiagnostics.CreateScope("DataReplicationPrivateLinkResourceCollection.GetAll");
            scope.Start();
            try
            {
