...
namespace Azure.ResourceManager.RecoveryServicesDataReplication.Mocking
{
    ...
    public partial class MockableRecoveryServicesDataReplicationSubscriptionResource : ArmResource
    {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<DataReplicationNameAvailabilityResult>> PostAsync(AzureLocation location, DataReplicationNameAvailabilityContent content = default, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = CheckNameAvailabilityRestClient.CreatePostRequest(Guid.Parse(Id.SubscriptionId), location, DataReplicationNameAvailabilityContent.ToRequestContent(content), context);
        ...
        /// <param name="content"> Resource details. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<DataReplicationNameAvailabilityResult> Post(AzureLocation location, DataReplicationNameAvailabilityContent content = default, CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = CheckNameAvailabilityClientDiagnostics.CreateScope("MockableRecoveryServicesDataReplicationSubscriptionResource.Post");
            scope.Start();
            try
