...
namespace Azure.ResourceManager.RecoveryServicesDataReplication.Mocking
{
    ...
    public partial class RecoveryServicesDataReplicationResourceGroupMockingExtension : ArmResource
    {
        private ClientDiagnostics _defaultClientDiagnostics;
        private AzureSiteRecoveryManagementServiceAPIRestOperations _defaultRestClient;

        /// <summary> Initializes a new instance of the <see cref="RecoveryServicesDataReplicationResourceGroupMockingExtension"/> class for mocking. </summary>
        protected RecoveryServicesDataReplicationResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="RecoveryServicesDataReplicationResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal RecoveryServicesDataReplicationResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual async Task<Response<DeploymentPreflightModel>> DeploymentPreflightAsync(string deploymentId, DeploymentPreflightModel body = null, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = DefaultClientDiagnostics.CreateScope("RecoveryServicesDataReplicationResourceGroupMockingExtension.DeploymentPreflight");
            scope.Start();
            try
            {
