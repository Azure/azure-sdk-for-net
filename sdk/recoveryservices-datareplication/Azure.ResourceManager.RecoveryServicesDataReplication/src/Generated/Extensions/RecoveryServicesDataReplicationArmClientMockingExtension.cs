...
namespace Azure.ResourceManager.RecoveryServicesDataReplication.Mocking
{
    ...
    public partial class RecoveryServicesDataReplicationArmClientMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="RecoveryServicesDataReplicationArmClientMockingExtension"/> class for mocking. </summary>
        protected RecoveryServicesDataReplicationArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="RecoveryServicesDataReplicationArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal RecoveryServicesDataReplicationArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal RecoveryServicesDataReplicationArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
