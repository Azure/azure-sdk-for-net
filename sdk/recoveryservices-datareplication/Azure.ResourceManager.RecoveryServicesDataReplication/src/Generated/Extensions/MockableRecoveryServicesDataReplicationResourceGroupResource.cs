...
namespace Azure.ResourceManager.RecoveryServicesDataReplication.Mocking
{
    ...
    public partial class MockableRecoveryServicesDataReplicationResourceGroupResource : ArmResource
    {
        ...
        public virtual async Task<Response<DeploymentPreflight>> PostAsync(string deploymentId, DeploymentPreflight body = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(deploymentId, nameof(deploymentId));

            using DiagnosticScope scope = DeploymentPreflightOperationsClientDiagnostics.CreateScope("MockableRecoveryServicesDataReplicationResourceGroupResource.Post");
            scope.Start();
            try
            {
                ...
                HttpMessage message = DeploymentPreflightOperationsRestClient.CreatePostRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, deploymentId, DeploymentPreflight.ToRequestContent(body), context);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="deploymentId"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="deploymentId"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual Response<DeploymentPreflight> Post(string deploymentId, DeploymentPreflight body = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(deploymentId, nameof(deploymentId));
