...
{
    public partial class Sample_FabricModelCollection
    {
        [Test]
        ...
        public async Task CreateOrUpdate_PutsTheFabric()
        {
            ...
            // get the collection of this FabricModelResource
            FabricModelCollection collection = resourceGroupResource.GetFabricModels();

            // invoke the operation
            string fabricName = "wPR";
            FabricModelData data = new FabricModelData(new AzureLocation("tqygutlpob"))
            {
                Properties = new FabricModelProperties(null),
            };
            ArmOperation<FabricModelResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, fabricName, data);
        ...
        public async Task Get_GetsTheFabric()
        {
            ...
            // invoke the operation
            string fabricName = "wPR";
            FabricModelResource result = await collection.GetAsync(fabricName);
        ...
        public async Task GetAll_ListsTheFabrics()
        {
            ...
            await foreach (FabricModelResource item in collection.GetAllAsync(continuationToken: continuationToken))
            {
        ...
        public async Task GetIfExists_GetsTheFabric()
        {
            ...
            // invoke the operation
            string fabricName = "wPR";
            NullableResponse<FabricModelResource> response = await collection.GetIfExistsAsync(fabricName);
            FabricModelResource result = response.HasValue ? response.Value : null;
