...
{
    public partial class Sample_PolicyModelCollection
    {
        [Test]
        ...
        public async Task CreateOrUpdate_PutsThePolicy()
        {
            ...
            // get the collection of this PolicyModelResource
            PolicyModelCollection collection = vaultModel.GetPolicyModels();
            ...
            ArmOperation<PolicyModelResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, policyName, data);
        ...
        public async Task Get_GetsThePolicy()
        {
            ...
            PolicyModelResource result = await collection.GetAsync(policyName);
        ...
        public async Task GetAll_ListsThePolicies()
        {
            ...
            await foreach (PolicyModelResource item in collection.GetAllAsync())
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                PolicyModelData resourceData = item.Data;
                // for demo we just print out the id
                Console.WriteLine($"Succeeded on id: {resourceData.Id}");
            }
        ...
        public async Task GetIfExists_GetsThePolicy()
        {
            ...
            // invoke the operation
            string policyName = "wdqsacasc";
            NullableResponse<PolicyModelResource> response = await collection.GetIfExistsAsync(policyName);
            PolicyModelResource result = response.HasValue ? response.Value : null;
