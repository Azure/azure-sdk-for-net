...
{
    public partial class Sample_ProtectedItemModelCollection
    {
        [Test]
        ...
        public async Task CreateOrUpdate_PutsTheProtectedItem()
        {
            ...
            // get the collection of this ProtectedItemModelResource
            ProtectedItemModelCollection collection = vaultModel.GetProtectedItemModels();

            // invoke the operation
            string protectedItemName = "d";
            ProtectedItemModelData data = new ProtectedItemModelData
            {
                Properties = new ProtectedItemModelProperties("tjoeiynplt", "jwxdo", null),
            };
            ArmOperation<ProtectedItemModelResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, protectedItemName, data);
        ...
        public async Task Get_GetsTheProtectedItem()
        {
            ...
            // invoke the operation
            string protectedItemName = "d";
            ProtectedItemModelResource result = await collection.GetAsync(protectedItemName);
        ...
        public async Task GetAll_ListsTheProtectedItems()
        {
            ...
            await foreach (ProtectedItemModelResource item in collection.GetAllAsync())
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                ProtectedItemModelData resourceData = item.Data;
                // for demo we just print out the id
                Console.WriteLine($"Succeeded on id: {resourceData.Id}");
            }
        ...
        public async Task GetIfExists_GetsTheProtectedItem()
        {
            ...
            // invoke the operation
            string protectedItemName = "d";
            NullableResponse<ProtectedItemModelResource> response = await collection.GetIfExistsAsync(protectedItemName);
            ProtectedItemModelResource result = response.HasValue ? response.Value : null;
