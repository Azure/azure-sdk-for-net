...
namespace Azure.ResourceManager.RecoveryServicesDataReplication.Samples
{
    public partial class Sample_SubscriptionResourceExtensions
    {
        ...
        public async Task GetDataReplicationFabrics_FabricListBySubscription()
        {
            ...
            await foreach (DataReplicationFabricResource item in subscriptionResource.GetDataReplicationFabricsAsync(continuationToken))
            {
        ...
        public async Task CheckDataReplicationNameAvailability_CheckNameAvailability()
        {
            ...
            DataReplicationNameAvailabilityResult result = await subscriptionResource.CheckDataReplicationNameAvailabilityAsync(location, content);
        ...
        public async Task GetDataReplicationVaults_VaultListBySubscription()
        {
            ...
            await foreach (DataReplicationVaultResource item in subscriptionResource.GetDataReplicationVaultsAsync(continuationToken))
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
