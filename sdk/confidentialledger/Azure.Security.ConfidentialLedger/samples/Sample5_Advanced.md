# Advanced — Custom TLS certificate validation

This sample demonstrates how to configure custom TLS certificate validation for the Confidential Ledger client using the identity service.

## Retrieve the ledger identity and configure TLS validation

Because Confidential Ledgers use self-signed certificates generated and stored in an SGX enclave, the certificate for each Confidential Ledger must first be retrieved from the Confidential Ledger Identity Service.

```C# Snippet:ConfidentialLedger_GetIdentity
