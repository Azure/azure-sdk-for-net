...
namespace Azure.Security.ConfidentialLedger.Tests
{
    public class ConfidentialLedgerClientLiveTests : RecordedTestBase<ConfidentialLedgerEnvironment>
    {
        ...
        public async Task JSRuntimeOptionsTest()
        {
            ...
            result = await Client.UpdateRuntimeOptionsStableAsync(runtimeOptionsContent);
            Assert.AreEqual((int)HttpStatusCode.OK, result.Status);
        ...
        public async Task CustomRoleTest()
        {
            ...
            try
            {
                Response result = await Client.CreateUserDefinedRoleStableAsync(RequestContent.Create(JsonSerializer.Serialize(rolesParam)));
                Assert.AreEqual((int)HttpStatusCode.OK, result.Status);
            ...
            {
                Response result = await Client.DeleteUserDefinedRoleStableAsync(roleName);
                Assert.AreEqual((int)HttpStatusCode.OK, result.Status);
            }
        }
        #endregion
