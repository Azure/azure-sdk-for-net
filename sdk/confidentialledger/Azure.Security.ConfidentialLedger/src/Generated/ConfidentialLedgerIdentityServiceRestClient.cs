...
{
    /// <summary> The ConfidentialLedgerIdentityServiceRest service client. </summary>
    internal partial class ConfidentialLedgerIdentityServiceRestClient
    {
        ...
        public async Task<Response> GetLedgerIdentityAsync(string ledgerId, RequestOptions options = null)
        {
            if (ledgerId == null)
            {
        ...
        /// <param name="options"> The request options. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="ledgerId"/> is null. </exception>
        public Response GetLedgerIdentity(string ledgerId, RequestOptions options = null)
        {
            if (ledgerId == null)
            {
                throw new ArgumentNullException(nameof(ledgerId));
