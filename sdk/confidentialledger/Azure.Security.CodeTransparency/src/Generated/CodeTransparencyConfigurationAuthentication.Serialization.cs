...
namespace Azure.Security.CodeTransparency
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CodeTransparencyConfigurationAuthentication>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<CodeTransparencyConfigurationAuthentication>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CodeTransparencyConfigurationAuthentication)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<CodeTransparencyConfigurationAuthentication>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CodeTransparencyConfigurationAuthentication)} does not support '{options.Format}' format.");
            }
        }
