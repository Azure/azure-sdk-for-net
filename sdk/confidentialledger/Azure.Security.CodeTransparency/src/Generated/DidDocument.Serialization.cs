...
namespace Azure.Security.CodeTransparency
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DidDocument>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<DidDocument>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DidDocument)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<DidDocument>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(DidDocument)} does not support '{options.Format}' format.");
            }
        }
