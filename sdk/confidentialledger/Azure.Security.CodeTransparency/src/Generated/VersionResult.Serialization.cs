...
namespace Azure.Security.CodeTransparency
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VersionResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<VersionResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(VersionResult)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<VersionResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(VersionResult)} does not support '{options.Format}' format.");
            }
        }
