...
namespace Azure.Security.CodeTransparency
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CodeTransparencyConfigurationPolicy>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<CodeTransparencyConfigurationPolicy>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CodeTransparencyConfigurationPolicy)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<CodeTransparencyConfigurationPolicy>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CodeTransparencyConfigurationPolicy)} does not support '{options.Format}' format.");
            }
        }
