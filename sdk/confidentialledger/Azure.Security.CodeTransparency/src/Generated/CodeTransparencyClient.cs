...
namespace Azure.Security.CodeTransparency
{
    ...
    public partial class CodeTransparencyClient
    {
        ...
        public virtual Response<BinaryData> CreateEntry(BinaryData body, CancellationToken cancellationToken = default)
        {
            ...
            Response result = CreateEntry(RequestContent.Create(body), cancellationToken.ToRequestContext());
            return Response.FromValue(result.Content, result);
        }
        ...
        public virtual async Task<Response<BinaryData>> CreateEntryAsync(BinaryData body, CancellationToken cancellationToken = default)
        {
            ...
            Response result = await CreateEntryAsync(RequestContent.Create(body), cancellationToken.ToRequestContext()).ConfigureAwait(false);
            return Response.FromValue(result.Content, result);
        }
