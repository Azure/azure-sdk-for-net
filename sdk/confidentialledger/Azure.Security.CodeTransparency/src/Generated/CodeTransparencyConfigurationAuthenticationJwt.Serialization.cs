...
namespace Azure.Security.CodeTransparency
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CodeTransparencyConfigurationAuthenticationJwt>)this).Write(writer, ModelSerializationExtensions.WireOptions);
