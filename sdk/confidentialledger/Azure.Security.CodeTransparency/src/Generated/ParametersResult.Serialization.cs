...
namespace Azure.Security.CodeTransparency
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ParametersResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ParametersResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ParametersResult)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ParametersResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ParametersResult)} does not support '{options.Format}' format.");
            }
        }
