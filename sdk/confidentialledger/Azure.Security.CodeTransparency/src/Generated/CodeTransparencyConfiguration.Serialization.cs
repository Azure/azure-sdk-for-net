...
namespace Azure.Security.CodeTransparency
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CodeTransparencyConfiguration>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<CodeTransparencyConfiguration>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CodeTransparencyConfiguration)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<CodeTransparencyConfiguration>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CodeTransparencyConfiguration)} does not support '{options.Format}' format.");
            }
        }
