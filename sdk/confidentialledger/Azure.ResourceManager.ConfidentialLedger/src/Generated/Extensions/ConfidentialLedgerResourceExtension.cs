...
namespace Azure.ResourceManager.ConfidentialLedger.Mock
{
    ...
    public partial class ConfidentialLedgerResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="ConfidentialLedgerResourceExtension"/> class for mocking. </summary>
        protected ConfidentialLedgerResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ConfidentialLedgerResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ConfidentialLedgerResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
