...
{
    /// <summary> A class to add extension methods to ConfidentialLedgerResource. </summary>
    public partial class ConfidentialLedgerResourceExtensionClient : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="ConfidentialLedgerResourceExtensionClient"/> class for mocking. </summary>
        protected ConfidentialLedgerResourceExtensionClient()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ConfidentialLedgerResourceExtensionClient"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ConfidentialLedgerResourceExtensionClient(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        private ClientDiagnostics ConfidentialLedgerLedgerClientDiagnostics => _confidentialLedgerLedgerClientDiagnostics ??= new ClientDiagnostics("Azure.ResourceManager.ConfidentialLedger.Mock", ConfidentialLedgerResource.ResourceType.Namespace, Diagnostics);
