...
namespace Azure.ResourceManager.ConfidentialLedger.Mocking
{
    ...
    internal partial class ConfidentialLedgerResourceGroupMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="ConfidentialLedgerResourceGroupMockingExtension"/> class for mocking. </summary>
        protected ConfidentialLedgerResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ConfidentialLedgerResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ConfidentialLedgerResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
