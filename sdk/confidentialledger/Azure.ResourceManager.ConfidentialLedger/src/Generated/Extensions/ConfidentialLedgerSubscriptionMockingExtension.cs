...
namespace Azure.ResourceManager.ConfidentialLedger.Mocking
{
    ...
    internal partial class ConfidentialLedgerSubscriptionMockingExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="ConfidentialLedgerSubscriptionMockingExtension"/> class for mocking. </summary>
        protected ConfidentialLedgerSubscriptionMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ConfidentialLedgerSubscriptionMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ConfidentialLedgerSubscriptionMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        {
            using var scope = DefaultClientDiagnostics.CreateScope("ConfidentialLedgerSubscriptionMockingExtension.CheckConfidentialLedgerNameAvailability");
            scope.Start();
            try
            {
