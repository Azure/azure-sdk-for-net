...
namespace Azure.ResourceManager.ConfidentialLedger
{
    ...
    {
        private static ConfidentialLedgerResourceExtension GetConfidentialLedgerResourceExtension(ArmResource resource)
        {
            return resource.GetCachedClient(client =>
            {
                return new ConfidentialLedgerResourceExtension(client, resource.Id);
            });
        }

        private static ConfidentialLedgerResourceExtension GetConfidentialLedgerResourceExtension(ArmClient client, ResourceIdentifier scope)
        {
            return client.GetResourceClient(() =>
            {
                return new ConfidentialLedgerResourceExtension(client, scope);
            });
        }
        ...
        {
            return GetResourceGroupResourceExtension(resourceGroupResource).GetConfidentialLedgers();
        }
        ...
        public static async Task<Response<ConfidentialLedgerNameAvailabilityResult>> CheckConfidentialLedgerNameAvailabilityAsync(this SubscriptionResource subscriptionResource, ConfidentialLedgerNameAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            ...
            return await GetSubscriptionResourceExtension(subscriptionResource).CheckConfidentialLedgerNameAvailabilityAsync(content, cancellationToken).ConfigureAwait(false);
        }
        ...
        public static Response<ConfidentialLedgerNameAvailabilityResult> CheckConfidentialLedgerNameAvailability(this SubscriptionResource subscriptionResource, ConfidentialLedgerNameAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            ...
            return GetSubscriptionResourceExtension(subscriptionResource).CheckConfidentialLedgerNameAvailability(content, cancellationToken);
        }
        ...
        {
            return GetConfidentialLedgerResourceExtension(subscriptionResource).GetConfidentialLedgersAsync(filter, cancellationToken);
        }
        ...
        {
            return GetConfidentialLedgerResourceExtension(subscriptionResource).GetConfidentialLedgers(filter, cancellationToken);
        }
    }
}
