...
namespace Azure.ResourceManager.ConfidentialLedger.Testing
{
    ...
    public partial class ConfidentialLedgerSubscriptionResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="ConfidentialLedgerSubscriptionResourceExtension"/> class for mocking. </summary>
        protected ConfidentialLedgerSubscriptionResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ConfidentialLedgerSubscriptionResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ConfidentialLedgerSubscriptionResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual async Task<Response<ConfidentialLedgerNameAvailabilityResult>> CheckConfidentialLedgerNameAvailabilityAsync(ConfidentialLedgerNameAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = DefaultClientDiagnostics.CreateScope("ConfidentialLedgerSubscriptionResourceExtension.CheckConfidentialLedgerNameAvailability");
            scope.Start();
            try
            {
