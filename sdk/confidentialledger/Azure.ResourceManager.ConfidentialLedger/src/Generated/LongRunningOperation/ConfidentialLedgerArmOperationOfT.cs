...
#pragma warning disable SA1649 // File name should match first type name
    internal class ConfidentialLedgerArmOperation<T> : ArmOperation<T>
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        internal ConfidentialLedgerArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal<T>(nextLinkOperation, clientDiagnostics, response, "ConfidentialLedgerArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
