...
namespace Azure.ResourceManager.ConfidentialLedger
{
    internal partial class ConfidentialLedgerArmOperation<T> : ArmOperation<T>
    {
        ...
        internal ConfidentialLedgerArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
