...
namespace Azure.ResourceManager.ConfidentialLedger
{
    internal partial class ConfidentialLedgerArmOperation : ArmOperation
    {
        ...
        internal ConfidentialLedgerArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
