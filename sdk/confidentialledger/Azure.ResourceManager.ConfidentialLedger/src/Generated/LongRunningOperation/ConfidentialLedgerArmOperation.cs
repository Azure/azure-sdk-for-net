...
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        internal ConfidentialLedgerArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        private string GetOperationId(RehydrationToken? rehydrationToken)
        {
            ...
            var lroDetails = ModelReaderWriter.Write(rehydrationToken, ModelReaderWriterOptions.Json, AzureResourceManagerConfidentialLedgerContext.Default).ToObjectFromJson<Dictionary<string, string>>();
