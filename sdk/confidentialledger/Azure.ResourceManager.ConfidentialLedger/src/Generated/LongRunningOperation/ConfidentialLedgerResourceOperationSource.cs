...
{
    /// <summary></summary>
    internal partial class ConfidentialLedgerResourceOperationSource : IOperationSource<ConfidentialLedgerResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal ConfidentialLedgerResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
