...
{
    public partial class ConfidentialLedgerDeploymentType : IUtf8JsonSerializable, IJsonModel<ConfidentialLedgerDeploymentType>, IPersistableModel<ConfidentialLedgerDeploymentType>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(LanguageRuntime))
            {
                builder.Append("  languageRuntime:");
                builder.AppendLine($" '{LanguageRuntime.ToString()}'");
            }

            if (Optional.IsDefined(AppSourceUri))
            {
                builder.Append("  appSourceUri:");
                builder.AppendLine($" '{AppSourceUri.AbsoluteUri}'");
            }
