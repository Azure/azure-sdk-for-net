...
namespace Azure.ResourceManager.ConfidentialLedger.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ConfidentialLedgerDeploymentType>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        ConfidentialLedgerDeploymentType IJsonModel<ConfidentialLedgerDeploymentType>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<ConfidentialLedgerDeploymentType>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ConfidentialLedgerDeploymentType IModel<ConfidentialLedgerDeploymentType>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<ConfidentialLedgerDeploymentType>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
