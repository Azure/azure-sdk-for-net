...
namespace Azure.ResourceManager.ConfidentialLedger.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ConfidentialLedgerMemberIdentityCertificate>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ConfidentialLedgerMemberIdentityCertificate>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ConfidentialLedgerMemberIdentityCertificate>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ConfidentialLedgerMemberIdentityCertificate>)} interface");
            }
        ...
        string IPersistableModel<ConfidentialLedgerMemberIdentityCertificate>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
