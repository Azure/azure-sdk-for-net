...
{
    public partial class ManagedCcfData : Core.IUtf8JsonSerializable
    {
        ...
        internal static ManagedCcfData DeserializeManagedCcfData(JsonElement element)
        {
            ...
            Core.Optional<ManagedCcfProperties> properties = default;
            ...
            return new ManagedCcfData(id, name, type, systemData.Value, Core.Optional.ToDictionary(tags), location, properties.Value);
        }
    }
}
