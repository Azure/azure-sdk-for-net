...
namespace Azure.ResourceManager.ConfidentialLedger.Models
{
    public partial class ConfidentialLedgerNameAvailabilityContent : IUtf8JsonSerializable, IJsonModel<ConfidentialLedgerNameAvailabilityContent>
    {
        ...
        void IJsonModel<ConfidentialLedgerNameAvailabilityContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(ConfidentialLedgerNameAvailabilityContent)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ConfidentialLedgerNameAvailabilityContent>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(ConfidentialLedgerNameAvailabilityContent)} does not support '{options.Format}' format.");
            }
        }
