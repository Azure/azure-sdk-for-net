...
{
    public partial class AadBasedSecurityPrincipal : IUtf8JsonSerializable, IJsonModel<AadBasedSecurityPrincipal>, IPersistableModel<AadBasedSecurityPrincipal>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(LedgerRoleName))
            {
                builder.Append("  ledgerRoleName:");
                builder.AppendLine($" '{LedgerRoleName.ToString()}'");
            }
