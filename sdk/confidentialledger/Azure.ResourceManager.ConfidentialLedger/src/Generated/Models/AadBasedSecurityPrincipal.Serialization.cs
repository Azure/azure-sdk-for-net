...
namespace Azure.ResourceManager.ConfidentialLedger.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AadBasedSecurityPrincipal>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AadBasedSecurityPrincipal>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AadBasedSecurityPrincipal>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AadBasedSecurityPrincipal>)} interface");
            }
        ...
        string IPersistableModel<AadBasedSecurityPrincipal>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
