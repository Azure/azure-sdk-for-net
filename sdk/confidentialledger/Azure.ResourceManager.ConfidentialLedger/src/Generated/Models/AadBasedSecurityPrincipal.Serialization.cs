...
{
    public partial class AadBasedSecurityPrincipal : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static AadBasedSecurityPrincipal DeserializeAadBasedSecurityPrincipal(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
