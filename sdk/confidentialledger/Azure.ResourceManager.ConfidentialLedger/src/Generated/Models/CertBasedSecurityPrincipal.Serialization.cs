...
namespace Azure.ResourceManager.ConfidentialLedger.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CertBasedSecurityPrincipal>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        CertBasedSecurityPrincipal IJsonModel<CertBasedSecurityPrincipal>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<CertBasedSecurityPrincipal>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        CertBasedSecurityPrincipal IModel<CertBasedSecurityPrincipal>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<CertBasedSecurityPrincipal>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
