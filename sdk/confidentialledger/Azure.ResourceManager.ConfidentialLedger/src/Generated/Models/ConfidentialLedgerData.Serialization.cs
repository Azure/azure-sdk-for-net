...
{
    public partial class ConfidentialLedgerData : Core.IUtf8JsonSerializable
    {
        ...
        internal static ConfidentialLedgerData DeserializeConfidentialLedgerData(JsonElement element)
        {
            ...
            Core.Optional<ConfidentialLedgerProperties> properties = default;
            ...
            return new ConfidentialLedgerData(id, name, type, systemData.Value, Core.Optional.ToDictionary(tags), location, properties.Value);
        }
    }
}
