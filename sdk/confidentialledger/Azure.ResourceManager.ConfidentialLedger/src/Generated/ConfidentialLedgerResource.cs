...
namespace Azure.ResourceManager.ConfidentialLedger
{
    ...
    public partial class ConfidentialLedgerResource : ArmResource
    {
        ...
        internal ConfidentialLedgerResource(ArmClient client, ConfidentialLedgerData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<ConfidentialLedgerResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
                {
                    ...
                    return Response.FromValue(new ConfidentialLedgerResource(Client, originalResponse.Value, originalResponse.Value.Id), originalResponse.GetRawResponse());
                }
                else
                {
