# Microsoft Azure Commerce management client library for .NET
...
Install the Azure.ResourceManager.Commerce management library for .NET with [NuGet](https://www.nuget.org/):

```dotnetcli
dotnet add package Azure.ResourceManager.Commerce --prerelease
```
