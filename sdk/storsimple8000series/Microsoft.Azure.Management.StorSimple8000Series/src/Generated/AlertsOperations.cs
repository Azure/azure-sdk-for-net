...
namespace Microsoft.Azure.Management.StorSimple8000Series
{
    ...
    /// </summary>
    internal partial class AlertsOperations : IServiceOperations<StorSimple8000SeriesManagementClient>, IAlertsOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal AlertsOperations(StorSimple8000SeriesManagementClient client)
        {
            if (client == null)
            {
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse> ClearWithHttpMessagesAsync(ClearAlertRequest parameters, string resourceGroupName, string managerName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (parameters == null)
            {
