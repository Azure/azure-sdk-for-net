...
namespace Azure.MixedReality.ObjectAnchors.Conversion.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<Quaternion>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<Quaternion>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<Quaternion>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<Quaternion>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
