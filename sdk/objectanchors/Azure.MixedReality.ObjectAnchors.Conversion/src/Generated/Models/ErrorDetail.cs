...
namespace Azure.MixedReality.ObjectAnchors.Conversion.Models
{
    ...
    internal partial class ErrorDetail
    {
        ...
        internal ErrorDetail(string code, string message, string target, IReadOnlyList<ErrorDetail> details, InnerError innererror, Dictionary<string, BinaryData> rawData)
        {
            Code = code;
            Message = message;
            Target = target;
