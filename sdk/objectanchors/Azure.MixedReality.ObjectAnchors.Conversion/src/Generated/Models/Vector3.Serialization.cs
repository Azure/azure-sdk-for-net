...
namespace Azure.MixedReality.ObjectAnchors.Conversion.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<Vector3>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<Vector3>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<Vector3>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<Vector3>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
