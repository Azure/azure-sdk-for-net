...
{
    internal partial class Vector3 : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static Vector3 DeserializeVector3(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
