...
namespace Azure.MixedReality.ObjectAnchors.Conversion
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AssetConversionConfiguration>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AssetConversionConfiguration>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AssetConversionConfiguration>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<AssetConversionConfiguration>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
