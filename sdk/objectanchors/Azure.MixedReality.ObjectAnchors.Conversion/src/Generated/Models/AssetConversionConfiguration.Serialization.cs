...
namespace Azure.MixedReality.ObjectAnchors.Conversion
{
    public partial class AssetConversionConfiguration : IUtf8JsonSerializable, IJsonModel<AssetConversionConfiguration>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<AssetConversionConfiguration>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AssetConversionConfiguration>)} interface");
            }
        ...
        AssetConversionConfiguration IJsonModel<AssetConversionConfiguration>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (!isValid)
            {
                throw new FormatException($"The model {nameof(AssetConversionConfiguration)} does not support '{options.Format}' format.");
            }
