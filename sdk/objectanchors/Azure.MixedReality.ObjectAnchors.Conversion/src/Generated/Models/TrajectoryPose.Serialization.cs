...
namespace Azure.MixedReality.ObjectAnchors.Conversion
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TrajectoryPose>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<TrajectoryPose>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<TrajectoryPose>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<TrajectoryPose>)} interface");
            }
        ...
        string IPersistableModel<TrajectoryPose>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        string IPersistableModel<object>.GetWireFormat(ModelReaderWriterOptions options) => ((IPersistableModel<TrajectoryPose>)this).GetWireFormat(options);
    }
}
