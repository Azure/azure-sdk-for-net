...
{
    internal partial class Vector4 : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static Vector4 DeserializeVector4(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
