...
{
    internal partial class SerialConsoleArmOperation<T> : ArmOperation<T>
    {
        ...
        /// <summary> Initializes a new instance of SerialConsoleArmOperation for mocking. </summary>
        protected SerialConsoleArmOperation()
        {
        }
        ...
        internal SerialConsoleArmOperation(Response<T> response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal SerialConsoleArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
