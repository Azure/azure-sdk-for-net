...
{
    internal partial class SerialConsoleArmOperation : ArmOperation
    {
        ...
        internal SerialConsoleArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal SerialConsoleArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
