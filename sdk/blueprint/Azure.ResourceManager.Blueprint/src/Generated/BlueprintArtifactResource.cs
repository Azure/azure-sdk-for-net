...
namespace Azure.ResourceManager.Blueprint
{
    ...
    /// </summary>
    public partial class BlueprintArtifactResource : ArtifactResource
    {
        ...
        internal BlueprintArtifactResource(ArmClient client, ArtifactData data) : base(client, data)
        {
        ...
        protected override async Task<Response<ArtifactResource>> GetCoreAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue((ArtifactResource)new BlueprintArtifactResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public new async Task<Response<BlueprintArtifactResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            var result = await GetCoreAsync(cancellationToken).ConfigureAwait(false);
            return Response.FromValue((BlueprintArtifactResource)result.Value, result.GetRawResponse());
        }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public new Response<BlueprintArtifactResource> Get(CancellationToken cancellationToken = default)
        {
