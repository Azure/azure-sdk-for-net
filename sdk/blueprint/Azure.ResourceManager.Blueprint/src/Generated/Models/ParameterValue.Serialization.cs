...
{
    public partial class ParameterValue : IUtf8JsonSerializable, IJsonModel<ParameterValue>, IPersistableModel<ParameterValue>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Reference))
            {
                ...
                AppendChildObject(builder, Reference, options, 2);
            }
