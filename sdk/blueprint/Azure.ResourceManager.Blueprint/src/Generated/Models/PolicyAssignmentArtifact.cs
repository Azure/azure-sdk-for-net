...
namespace Azure.ResourceManager.Blueprint.Models
{
    ...
    public partial class PolicyAssignmentArtifact : ArtifactData
    {
        ...
        internal PolicyAssignmentArtifact(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, ArtifactKind kind, string displayName, string description, IList<string> dependsOn, string policyDefinitionId, IDictionary<string, ParameterValue> parameters, string resourceGroup, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData, kind, rawData)
        {
