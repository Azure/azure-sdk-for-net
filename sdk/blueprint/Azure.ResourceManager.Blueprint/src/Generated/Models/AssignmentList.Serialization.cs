...
namespace Azure.ResourceManager.Blueprint.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AssignmentList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AssignmentList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AssignmentList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AssignmentList>)} interface");
            }
        ...
        string IPersistableModel<AssignmentList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
