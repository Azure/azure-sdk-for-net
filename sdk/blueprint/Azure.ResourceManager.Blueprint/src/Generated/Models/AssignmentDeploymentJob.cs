...
namespace Azure.ResourceManager.Blueprint.Models
{
    ...
    public partial class AssignmentDeploymentJob
    {
        ...
        internal AssignmentDeploymentJob(string kind, string action, string jobId, string jobState, AssignmentDeploymentJobResult result, IList<AssignmentDeploymentJobResult> history, Uri requestUri, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Kind = kind;
            Action = action;
            JobId = jobId;
