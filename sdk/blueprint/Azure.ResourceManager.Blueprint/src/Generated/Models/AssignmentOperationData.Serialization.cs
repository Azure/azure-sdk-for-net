...
namespace Azure.ResourceManager.Blueprint
{
    public partial class AssignmentOperationData : IUtf8JsonSerializable, IJsonModel<AssignmentOperationData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(BlueprintVersion))
            {
                builder.Append("    blueprintVersion:");
                if (BlueprintVersion.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
                    builder.AppendLine($"{BlueprintVersion}'''");
                }
                else
                {
                    builder.AppendLine($" '{BlueprintVersion}'");
            ...
            if (Optional.IsDefined(AssignmentState))
            {
                builder.Append("    assignmentState:");
                if (AssignmentState.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
                    builder.AppendLine($"{AssignmentState}'''");
                }
                else
                {
                    builder.AppendLine($" '{AssignmentState}'");
            ...
            if (Optional.IsDefined(TimeStarted))
            {
                ...
                if (TimeStarted.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
                    builder.AppendLine($"{TimeStarted}'''");
                }
                else
                {
                    builder.AppendLine($" '{TimeStarted}'");
            ...
            if (Optional.IsDefined(TimeFinished))
            {
                builder.Append("    timeFinished:");
                if (TimeFinished.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
                    builder.AppendLine($"{TimeFinished}'''");
                }
                else
                {
                    builder.AppendLine($" '{TimeFinished}'");
