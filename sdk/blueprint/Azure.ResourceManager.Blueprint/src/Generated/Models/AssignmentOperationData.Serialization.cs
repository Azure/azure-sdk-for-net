...
namespace Azure.ResourceManager.Blueprint
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AssignmentOperationData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AssignmentOperationData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AssignmentOperationData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AssignmentOperationData>)} interface");
            }
        ...
        string IPersistableModel<AssignmentOperationData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
