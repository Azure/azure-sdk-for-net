...
namespace Azure.ResourceManager.Blueprint.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PolicyAssignmentArtifact>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PolicyAssignmentArtifact>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PolicyAssignmentArtifact>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PolicyAssignmentArtifact>)} interface");
            }
        ...
        string IPersistableModel<PolicyAssignmentArtifact>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
