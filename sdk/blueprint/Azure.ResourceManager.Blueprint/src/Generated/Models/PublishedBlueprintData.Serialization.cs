...
namespace Azure.ResourceManager.Blueprint
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PublishedBlueprintData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PublishedBlueprintData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PublishedBlueprintData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PublishedBlueprintData>)} interface");
            }
        ...
        string IPersistableModel<PublishedBlueprintData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
