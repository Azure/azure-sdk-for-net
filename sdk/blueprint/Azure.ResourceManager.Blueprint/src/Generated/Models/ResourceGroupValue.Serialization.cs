...
namespace Azure.ResourceManager.Blueprint.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ResourceGroupValue>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ResourceGroupValue>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ResourceGroupValue>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ResourceGroupValue>)} interface");
            }
        ...
        string IPersistableModel<ResourceGroupValue>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
