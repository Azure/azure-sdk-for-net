...
{
    public partial class ResourceGroupValue : IUtf8JsonSerializable, IJsonModel<ResourceGroupValue>, IPersistableModel<ResourceGroupValue>
    {
        ...
        void IJsonModel<ResourceGroupValue>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ResourceGroupValue)} does not support '{format}' format.");
            }
