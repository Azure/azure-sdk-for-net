...
namespace Azure.ResourceManager.Blueprint.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AssignmentDeploymentJobResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AssignmentDeploymentJobResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AssignmentDeploymentJobResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AssignmentDeploymentJobResult>)} interface");
            }
        ...
        string IPersistableModel<AssignmentDeploymentJobResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
