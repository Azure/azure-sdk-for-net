...
{
    public partial class AssignmentStatus : IUtf8JsonSerializable, IJsonModel<AssignmentStatus>, IPersistableModel<AssignmentStatus>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  managedResources:");
                builder.AppendLine(" [");
                foreach (var item in ManagedResources)
                {
                    if (item == null)
