...
namespace Azure.ResourceManager.Blueprint.Models
{
    ...
    public partial class ParameterDefinition
    {
        ...
        internal ParameterDefinition(TemplateParameterType templateParameterType, BinaryData defaultValue, IList<BinaryData> allowedValues, string displayName, string description, string strongType, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            TemplateParameterType = templateParameterType;
