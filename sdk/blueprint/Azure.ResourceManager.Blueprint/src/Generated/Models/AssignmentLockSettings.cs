...
namespace Azure.ResourceManager.Blueprint.Models
{
    ...
    public partial class AssignmentLockSettings
    {
        ...
        internal AssignmentLockSettings(AssignmentLockMode? mode, IList<string> excludedPrincipals, IList<string> excludedActions, Dictionary<string, BinaryData> rawData)
        {
            Mode = mode;
