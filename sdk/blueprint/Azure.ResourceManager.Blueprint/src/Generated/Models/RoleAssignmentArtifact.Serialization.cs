...
namespace Azure.ResourceManager.Blueprint.Models
{
    public partial class RoleAssignmentArtifact : IUtf8JsonSerializable, IModelJsonSerializable<RoleAssignmentArtifact>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<RoleAssignmentArtifact>(this, options.Format);
        ...
        internal static RoleAssignmentArtifact DeserializeRoleAssignmentArtifact(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new RoleAssignmentArtifact(id, name, type, systemData.Value, kind, displayName.Value, description.Value, Optional.ToList(dependsOn), roleDefinitionId, principalIds, resourceGroup.Value, serializedAdditionalRawData);
        }
