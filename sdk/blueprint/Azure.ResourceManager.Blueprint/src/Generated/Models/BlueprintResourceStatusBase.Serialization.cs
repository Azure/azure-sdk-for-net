...
namespace Azure.ResourceManager.Blueprint.Models
{
    ...
    {
        internal static BlueprintResourceStatusBase DeserializeBlueprintResourceStatusBase(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
