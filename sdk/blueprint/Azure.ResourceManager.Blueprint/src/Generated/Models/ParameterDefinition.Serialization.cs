...
{
    public partial class ParameterDefinition : IUtf8JsonSerializable, IJsonModel<ParameterDefinition>, IPersistableModel<ParameterDefinition>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(TemplateParameterType))
            {
                builder.Append("  type:");
                builder.AppendLine($" '{TemplateParameterType.ToString()}'");
            }
