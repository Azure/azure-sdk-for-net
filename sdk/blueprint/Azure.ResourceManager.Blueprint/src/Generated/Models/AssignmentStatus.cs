...
namespace Azure.ResourceManager.Blueprint.Models
{
    ...
    public partial class AssignmentStatus : BlueprintResourceStatusBase
    {
        ...
        internal AssignmentStatus(DateTimeOffset? timeCreated, DateTimeOffset? lastModified, IReadOnlyList<string> managedResources, Dictionary<string, BinaryData> rawData) : base(timeCreated, lastModified, rawData)
        {
