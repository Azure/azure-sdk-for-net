...
namespace Azure.ResourceManager.Blueprint.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PublishedBlueprintList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PublishedBlueprintList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PublishedBlueprintList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PublishedBlueprintList>)} interface");
            }
        ...
        string IPersistableModel<PublishedBlueprintList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
