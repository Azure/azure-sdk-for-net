...
namespace Azure.ResourceManager.Blueprint.Models
{
    ...
    public partial class SecretValueReference
    {
        ...
        internal SecretValueReference(WritableSubResource keyVault, string secretName, string secretVersion, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            KeyVault = keyVault;
            SecretName = secretName;
