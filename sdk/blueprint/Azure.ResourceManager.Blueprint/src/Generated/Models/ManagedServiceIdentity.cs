...
namespace Azure.ResourceManager.Blueprint.Models
{
    ...
    public partial class ManagedServiceIdentity
    {
        ...
        internal ManagedServiceIdentity(ManagedServiceIdentityType identityType, string principalId, Guid? tenantId, IDictionary<string, UserAssignedIdentity> userAssignedIdentities, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            IdentityType = identityType;
