...
namespace Azure.ResourceManager.Blueprint
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BlueprintData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<BlueprintData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BlueprintData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<BlueprintData>)} interface");
            }
        ...
        string IPersistableModel<BlueprintData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
