...
namespace Azure.ResourceManager.Blueprint.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BlueprintList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<BlueprintList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BlueprintList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<BlueprintList>)} interface");
            }
        ...
        string IPersistableModel<BlueprintList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
