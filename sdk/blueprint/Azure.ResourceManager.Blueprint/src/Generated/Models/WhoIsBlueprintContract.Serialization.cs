...
namespace Azure.ResourceManager.Blueprint.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<WhoIsBlueprintContract>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(WhoIsBlueprintContract)} does not support writing '{format}' format.");
            }
        ...
        WhoIsBlueprintContract IJsonModel<WhoIsBlueprintContract>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(WhoIsBlueprintContract)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<WhoIsBlueprintContract>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(WhoIsBlueprintContract)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        WhoIsBlueprintContract IPersistableModel<WhoIsBlueprintContract>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(WhoIsBlueprintContract)} does not support reading '{options.Format}' format.");
            }
        }
