...
namespace Azure.ResourceManager.Blueprint.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<WhoIsBlueprintContract>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<WhoIsBlueprintContract>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<WhoIsBlueprintContract>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<WhoIsBlueprintContract>)} interface");
            }
        ...
        string IPersistableModel<WhoIsBlueprintContract>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
