...
namespace Azure.ResourceManager.Blueprint.Models
{
    ...
    public partial class ResourceGroupDefinition
    {
        ...
        internal ResourceGroupDefinition(string name, AzureLocation? location, IList<string> dependsOn, IDictionary<string, string> tags, string displayName, string description, string strongType, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Location = location;
            DependsOn = dependsOn;
