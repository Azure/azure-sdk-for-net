...
{
    public partial class AssignmentData : IUtf8JsonSerializable, IJsonModel<AssignmentData>, IPersistableModel<AssignmentData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(BlueprintId))
            {
                builder.Append("  blueprintId:");
                builder.AppendLine($" '{BlueprintId}'");
            }
            ...
            if (Optional.IsDefined(Locks))
            {
                ...
                AppendChildObject(builder, Locks, options, 2);
            }
