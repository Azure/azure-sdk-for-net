...
namespace Azure.ResourceManager.Blueprint
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AssignmentData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AssignmentData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AssignmentData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AssignmentData>)} interface");
            }
        ...
        string IPersistableModel<AssignmentData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
