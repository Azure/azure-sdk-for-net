...
namespace Azure.ResourceManager.Blueprint.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ResourceGroupDefinition>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ResourceGroupDefinition>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ResourceGroupDefinition>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<ResourceGroupDefinition>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
