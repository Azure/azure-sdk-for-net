...
namespace Azure.ResourceManager.Blueprint
{
    ...
    public partial class BlueprintVersionArtifactResource : ArmResource
    {
        ...
        internal BlueprintVersionArtifactResource(ArmClient client, ArtifactData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<BlueprintVersionArtifactResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new BlueprintVersionArtifactResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
