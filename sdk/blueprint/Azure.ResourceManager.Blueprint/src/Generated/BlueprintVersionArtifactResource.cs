...
namespace Azure.ResourceManager.Blueprint
{
    ...
    public partial class BlueprintVersionArtifactResource : ArtifactResource
    {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public new async Task<Response<BlueprintVersionArtifactResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            var result = await GetCoreAsync(cancellationToken).ConfigureAwait(false);
            return Response.FromValue((BlueprintVersionArtifactResource)result.Value, result.GetRawResponse());
        }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public new Response<BlueprintVersionArtifactResource> Get(CancellationToken cancellationToken = default)
        {
