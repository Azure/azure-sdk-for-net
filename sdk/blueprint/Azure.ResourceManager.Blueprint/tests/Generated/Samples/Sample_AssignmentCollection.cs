...
namespace Azure.ResourceManager.Blueprint.Samples
{
    public partial class Sample_AssignmentCollection
    {
        ...
        public async Task CreateOrUpdate_AssignmentWithSystemAssignedManagedIdentityAtManagementGroupScope()
        {
            ...
            ArmOperation<AssignmentResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, assignmentName, data);
        ...
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task CreateOrUpdate_AssignmentWithSystemAssignedManagedIdentityAtSubscriptionScope()
        {
        ...
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task CreateOrUpdate_AssignmentWithUserAssignedManagedIdentityAtManagementGroupScope()
        {
...
["/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/contoso-resource-group/providers/Microsoft.ManagedIdentity/userAssignedIdentities/contoso-identity"] = new UserAssignedIdentity(),
        ...
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task CreateOrUpdate_AssignmentWithUserAssignedManagedIdentityAtSubscriptionScope()
        {
