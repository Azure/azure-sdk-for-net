...
namespace Azure.ResourceManager.Blueprint.Samples
{
    public partial class Sample_AssignmentResource
    {
        ...
        public async Task Update_AssignmentWithSystemAssignedManagedIdentityAtManagementGroupScope()
        {
        ...
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task Update_AssignmentWithSystemAssignedManagedIdentityAtSubscriptionScope()
        {
        ...
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task Update_AssignmentWithUserAssignedManagedIdentityAtManagementGroupScope()
        {
...
["/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/contoso-resource-group/providers/Microsoft.ManagedIdentity/userAssignedIdentities/contoso-identity"] = new UserAssignedIdentity(),
        ...
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task Update_AssignmentWithUserAssignedManagedIdentityAtSubscriptionScope()
        {
