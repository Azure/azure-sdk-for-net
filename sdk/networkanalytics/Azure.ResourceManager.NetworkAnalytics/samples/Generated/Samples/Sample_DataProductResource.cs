...
namespace Azure.ResourceManager.NetworkAnalytics.Samples
{
    public partial class Sample_DataProductResource
    {
        ...
        public async Task Delete_DataProductsDeleteMaximumSetGen()
        {
            ...
            // invoke the operation
            await dataProduct.DeleteAsync(WaitUntil.Completed).ConfigureAwait(false);
...
{
[new ResourceIdentifier("/subscriptions/subid/resourceGroups/resourceGroupName/providers/Microsoft.ManagedIdentity/userAssignedIdentities/id1")] = null
},
                },
                Tags =
{
["userSpecifiedKeyName"] = "userSpecifiedKeyValue"
        ...
        public async Task GenerateStorageAccountSasToken_DataProductsGenerateStorageAccountSasTokenMaximumSetGen()
        {
            ...
            // invoke the operation
            AccountSasContent content = new AccountSasContent(default, default, "1.1.1.1");
        ...
        public async Task RemoveUserRole_DataProductsRemoveUserRoleMaximumSetGen()
        {
            ...
            RoleAssignmentDetail body = new RoleAssignmentDetail(
                ...
                DataProductUserRole.Reader,
                "00000000-0000-0000-0000-00000000000");
            await dataProduct.RemoveUserRoleAsync(body).ConfigureAwait(false);
        ...
        public async Task RotateKey_DataProductsRotateKeyMaximumSetGen()
        {
            ...
            await dataProduct.RotateKeyAsync(content).ConfigureAwait(false);
