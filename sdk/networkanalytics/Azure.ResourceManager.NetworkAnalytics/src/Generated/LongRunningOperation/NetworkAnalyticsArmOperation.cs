...
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        /// <summary> Initializes a new instance of NetworkAnalyticsArmOperation for mocking. </summary>
        protected NetworkAnalyticsArmOperation()
        {
        }

        internal NetworkAnalyticsArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        private string GetOperationId(RehydrationToken? rehydrationToken)
        {
            ...
            var lroDetails = ModelReaderWriter.Write(rehydrationToken, ModelReaderWriterOptions.Json, AzureResourceManagerNetworkAnalyticsContext.Default).ToObjectFromJson<Dictionary<string, string>>();
