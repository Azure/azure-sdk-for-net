...
namespace Azure.ResourceManager.NetworkAnalytics.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EncryptionKeyDetails>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<EncryptionKeyDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<EncryptionKeyDetails>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<EncryptionKeyDetails>)} interface");
            }
        ...
        string IPersistableModel<EncryptionKeyDetails>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
