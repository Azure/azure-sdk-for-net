...
{
    public partial class DataProductNetworkAcls : IUtf8JsonSerializable, IJsonModel<DataProductNetworkAcls>, IPersistableModel<DataProductNetworkAcls>
    {
        ...
        void IJsonModel<DataProductNetworkAcls>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DataProductNetworkAcls)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(VirtualNetworkRule))
            {
                builder.Append("  virtualNetworkRule:");
                builder.AppendLine(" [");
                foreach (var item in VirtualNetworkRule)
                {
            ...
            if (Optional.IsCollectionDefined(AllowedQueryIPRangeList))
            {
                builder.Append("  allowedQueryIpRangeList:");
                builder.AppendLine(" [");
                foreach (var item in AllowedQueryIPRangeList)
                {
                    if (item == null)
