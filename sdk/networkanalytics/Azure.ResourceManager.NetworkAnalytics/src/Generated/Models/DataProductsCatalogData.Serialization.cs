...
{
    public partial class DataProductsCatalogData : IUtf8JsonSerializable, IJsonModel<DataProductsCatalogData>, IPersistableModel<DataProductsCatalogData>
    {
        ...
        void IJsonModel<DataProductsCatalogData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DataProductsCatalogData)} does not support '{format}' format.");
            }
