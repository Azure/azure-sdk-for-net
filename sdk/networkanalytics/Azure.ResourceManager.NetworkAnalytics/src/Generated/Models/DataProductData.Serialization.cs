...
namespace Azure.ResourceManager.NetworkAnalytics
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataProductData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DataProductData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DataProductData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<DataProductData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
