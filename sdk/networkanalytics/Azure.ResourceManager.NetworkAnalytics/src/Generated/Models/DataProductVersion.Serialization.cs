...
namespace Azure.ResourceManager.NetworkAnalytics.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataProductVersion>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DataProductVersion)} does not support writing '{format}' format.");
            }
        ...
        DataProductVersion IJsonModel<DataProductVersion>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DataProductVersion)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<DataProductVersion>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(DataProductVersion)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        DataProductVersion IPersistableModel<DataProductVersion>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(DataProductVersion)} does not support reading '{options.Format}' format.");
            }
        }
