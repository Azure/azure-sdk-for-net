...
{
    internal partial class DataProductsCatalogListResult : IUtf8JsonSerializable, IJsonModel<DataProductsCatalogListResult>, IPersistableModel<DataProductsCatalogListResult>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataProductsCatalogListResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<DataProductsCatalogListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DataProductsCatalogListResult)} does not support '{format}' format.");
            }
