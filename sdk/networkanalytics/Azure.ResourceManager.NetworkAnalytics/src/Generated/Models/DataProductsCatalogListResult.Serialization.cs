...
namespace Azure.ResourceManager.NetworkAnalytics.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataProductsCatalogListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DataProductsCatalogListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DataProductsCatalogListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DataProductsCatalogListResult>)} interface");
            }
        ...
        string IPersistableModel<DataProductsCatalogListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
