...
namespace Azure.ResourceManager.NetworkAnalytics.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataProductDataType>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DataProductDataType>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DataProductDataType>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DataProductDataType>)} interface");
            }
        ...
        string IPersistableModel<DataProductDataType>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
