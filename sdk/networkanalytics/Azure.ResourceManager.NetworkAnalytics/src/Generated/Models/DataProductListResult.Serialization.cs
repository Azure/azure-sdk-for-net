...
{
    internal partial class DataProductListResult : IUtf8JsonSerializable, IJsonModel<DataProductListResult>, IPersistableModel<DataProductListResult>
    {
        ...
        void IJsonModel<DataProductListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DataProductListResult)} does not support '{format}' format.");
            }
