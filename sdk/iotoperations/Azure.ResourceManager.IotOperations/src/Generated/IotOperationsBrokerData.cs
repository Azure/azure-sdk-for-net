...
namespace Azure.ResourceManager.IotOperations
{
    ...
    public partial class IotOperationsBrokerData : ResourceData
    {
        ...
        internal IotOperationsBrokerData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, IotOperationsBrokerProperties properties, IotOperationsExtendedLocation extendedLocation) : base(id, name, resourceType, systemData)
        {
