...
namespace Azure.ResourceManager.IoTOperations
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="BrokerListenerResource"/>
    /// from an instance of <see cref="ArmClient"/> using the GetBrokerListenerResource method.
    /// Otherwise you can get one from its parent resource <see cref="BrokerResource"/> using the GetBrokerListenerResource method.
    /// </summary>
    public partial class BrokerListenerResource : ArmResource
    {
        /// <summary> Generate the resource identifier of a <see cref="BrokerListenerResource"/> instance. </summary>
        ...
        /// <summary> Initializes a new instance of the <see cref="BrokerListenerResource"/> class for mocking. </summary>
        protected BrokerListenerResource()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="BrokerListenerResource"/> class. </summary>
        ...
        public virtual async Task<Response<BrokerListenerResource>> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<BrokerListenerResource> Get(CancellationToken cancellationToken = default)
        {
            using var scope = _brokerListenerResourceBrokerListenerClientDiagnostics.CreateScope("BrokerListenerResource.Get");
            scope.Start();
            try
        ...
        public virtual async Task<ArmOperation<BrokerListenerResource>> UpdateAsync(WaitUntil waitUntil, BrokerListenerResourceData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new IoTOperationsArmOperation<BrokerListenerResource>(new BrokerListenerResourceOperationSource(Client), _brokerListenerResourceBrokerListenerClientDiagnostics, Pipeline, _brokerListenerResourceBrokerListenerRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, data).Request, response, OperationFinalStateVia.AzureAsyncOperation);
                if (waitUntil == WaitUntil.Completed)
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        public virtual ArmOperation<BrokerListenerResource> Update(WaitUntil waitUntil, BrokerListenerResourceData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
