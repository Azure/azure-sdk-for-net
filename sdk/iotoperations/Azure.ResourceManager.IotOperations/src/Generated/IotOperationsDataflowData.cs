...
namespace Azure.ResourceManager.IotOperations
{
    ...
    public partial class IotOperationsDataflowData : ResourceData
    {
        ...
        internal IotOperationsDataflowData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, IotOperationsDataflowProperties properties, IotOperationsExtendedLocation extendedLocation) : base(id, name, resourceType, systemData)
        {
        ...
        public IotOperationsDataflowProperties Properties { get; set; }
