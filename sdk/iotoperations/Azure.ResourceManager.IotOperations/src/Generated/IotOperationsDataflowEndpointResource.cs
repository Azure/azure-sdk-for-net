...
{
    /// <summary>
    /// A class representing a IotOperationsDataflowEndpoint along with the instance operations that can be performed on it.
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="IotOperationsDataflowEndpointResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="IotOperationsInstanceResource"/> using the GetIotOperationsDataflowEndpoints method.
    /// </summary>
    public partial class IotOperationsDataflowEndpointResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of IotOperationsDataflowEndpointResource for mocking. </summary>
        protected IotOperationsDataflowEndpointResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="IotOperationsDataflowEndpointResource"/> class. </summary>
        ...
        {
            TryGetApiVersion(ResourceType, out string iotOperationsDataflowEndpointApiVersion);
            _dataflowEndpointClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.IotOperations", ResourceType.Namespace, Diagnostics);
            _dataflowEndpointRestClient = new DataflowEndpoint(_dataflowEndpointClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, iotOperationsDataflowEndpointApiVersion ?? "2025-10-01");
        ...
        {
            string resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.IoTOperations/instances/{instanceName}/dataflowEndpoints/{dataflowEndpointName}";
        ...
        {
            using DiagnosticScope scope = _dataflowEndpointClientDiagnostics.CreateScope("IotOperationsDataflowEndpointResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _dataflowEndpointRestClient.CreateGetRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, context);
        ...
        {
            using DiagnosticScope scope = _dataflowEndpointClientDiagnostics.CreateScope("IotOperationsDataflowEndpointResource.Delete");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _dataflowEndpointRestClient.CreateDeleteRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                IotOperationsArmOperation operation = new IotOperationsArmOperation(_dataflowEndpointClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
        ...
        /// <summary>
        /// Update a IotOperationsDataflowEndpoint.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.IoTOperations/instances/{instanceName}/dataflowEndpoints/{dataflowEndpointName}. </description>
        ...
        public virtual async Task<ArmOperation<IotOperationsDataflowEndpointResource>> UpdateAsync(WaitUntil waitUntil, IotOperationsDataflowEndpointData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _dataflowEndpointClientDiagnostics.CreateScope("IotOperationsDataflowEndpointResource.Update");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
