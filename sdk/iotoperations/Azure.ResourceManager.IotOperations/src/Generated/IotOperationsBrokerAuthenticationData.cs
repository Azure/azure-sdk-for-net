...
namespace Azure.ResourceManager.IotOperations
{
    ...
    public partial class IotOperationsBrokerAuthenticationData : ResourceData
    {
        ...
        internal IotOperationsBrokerAuthenticationData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, IotOperationsBrokerAuthenticationProperties properties, IotOperationsExtendedLocation extendedLocation) : base(id, name, resourceType, systemData)
        {
