...
namespace Azure.ResourceManager.IotOperations
{
    ...
    public partial class IotOperationsAkriConnectorTemplateData : ResourceData, IJsonModel<IotOperationsAkriConnectorTemplateData>
    {
        ...
        internal static RequestContent ToRequestContent(IotOperationsAkriConnectorTemplateData iotOperationsAkriConnectorTemplateData)
        {
            ...
            return RequestContent.Create(iotOperationsAkriConnectorTemplateData, ModelSerializationExtensions.WireOptions);
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        IotOperationsAkriConnectorTemplateData IJsonModel<IotOperationsAkriConnectorTemplateData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (IotOperationsAkriConnectorTemplateData)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static IotOperationsAkriConnectorTemplateData DeserializeIotOperationsAkriConnectorTemplateData(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = IotOperationsAkriConnectorTemplateProperties.DeserializeIotOperationsAkriConnectorTemplateProperties(prop.Value, options);
                    continue;
                }
