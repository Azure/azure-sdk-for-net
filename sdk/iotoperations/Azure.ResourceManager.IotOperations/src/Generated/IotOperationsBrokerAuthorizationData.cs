...
namespace Azure.ResourceManager.IotOperations
{
    ...
    public partial class IotOperationsBrokerAuthorizationData : ResourceData
    {
        ...
        internal IotOperationsBrokerAuthorizationData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, IotOperationsBrokerAuthorizationProperties properties, IotOperationsExtendedLocation extendedLocation) : base(id, name, resourceType, systemData)
        {
