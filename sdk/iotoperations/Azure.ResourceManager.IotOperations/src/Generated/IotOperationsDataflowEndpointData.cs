...
namespace Azure.ResourceManager.IotOperations
{
    ...
    public partial class IotOperationsDataflowEndpointData : ResourceData
    {
        ...
        internal IotOperationsDataflowEndpointData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, IotOperationsDataflowEndpointProperties properties, IotOperationsExtendedLocation extendedLocation) : base(id, name, resourceType, systemData)
        {
