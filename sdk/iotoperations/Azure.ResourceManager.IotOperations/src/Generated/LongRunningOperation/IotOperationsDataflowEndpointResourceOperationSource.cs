...
{
    /// <summary></summary>
    internal partial class IotOperationsDataflowEndpointResourceOperationSource : IOperationSource<IotOperationsDataflowEndpointResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal IotOperationsDataflowEndpointResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
