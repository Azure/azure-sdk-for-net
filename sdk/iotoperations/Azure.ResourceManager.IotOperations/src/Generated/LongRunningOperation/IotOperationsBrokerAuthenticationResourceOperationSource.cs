...
{
    /// <summary></summary>
    internal partial class IotOperationsBrokerAuthenticationResourceOperationSource : IOperationSource<IotOperationsBrokerAuthenticationResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal IotOperationsBrokerAuthenticationResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
