...
namespace Azure.ResourceManager.IotOperations
{
    internal partial class IotOperationsArmOperation<T> : ArmOperation<T>
    {
        ...
        internal IotOperationsArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
