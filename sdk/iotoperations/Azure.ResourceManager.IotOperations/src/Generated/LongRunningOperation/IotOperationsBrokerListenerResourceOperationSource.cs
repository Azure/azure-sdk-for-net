...
{
    /// <summary></summary>
    internal partial class IotOperationsBrokerListenerResourceOperationSource : IOperationSource<IotOperationsBrokerListenerResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal IotOperationsBrokerListenerResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
