...
namespace Azure.ResourceManager.IotOperations
{
    internal partial class IotOperationsArmOperation : ArmOperation
    {
        ...
        internal IotOperationsArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
