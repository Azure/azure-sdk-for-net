...
{
    /// <summary></summary>
    internal partial class IotOperationsInstanceResourceOperationSource : IOperationSource<IotOperationsInstanceResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal IotOperationsInstanceResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
