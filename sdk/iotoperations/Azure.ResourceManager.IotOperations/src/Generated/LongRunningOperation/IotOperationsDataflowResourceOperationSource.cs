...
{
    /// <summary></summary>
    internal partial class IotOperationsDataflowResourceOperationSource : IOperationSource<IotOperationsDataflowResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal IotOperationsDataflowResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
