...
{
    public partial class BrokerListenerResourceData : IUtf8JsonSerializable, IJsonModel<BrokerListenerResourceData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BrokerListenerResourceData>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<BrokerListenerResourceData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<BrokerListenerResourceData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        BrokerListenerResourceData IJsonModel<BrokerListenerResourceData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<BrokerListenerResourceData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        BinaryData IPersistableModel<BrokerListenerResourceData>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<BrokerListenerResourceData>)this).GetFormatFromOptions(options) : options.Format;
        ...
        BrokerListenerResourceData IPersistableModel<BrokerListenerResourceData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<BrokerListenerResourceData>)this).GetFormatFromOptions(options) : options.Format;
        ...
        string IPersistableModel<BrokerListenerResourceData>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
