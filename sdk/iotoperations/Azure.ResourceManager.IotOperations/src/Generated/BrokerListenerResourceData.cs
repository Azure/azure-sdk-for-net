...
namespace Azure.ResourceManager.IoTOperations
{
    ...
    public partial class BrokerListenerResourceData : ResourceData
    {
        ...
        /// <summary> Initializes a new instance of <see cref="BrokerListenerResourceData"/>. </summary>
        ...
        internal BrokerListenerResourceData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, BrokerListenerProperties properties, ExtendedLocation extendedLocation, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
        ...
        /// <summary> Initializes a new instance of <see cref="BrokerListenerResourceData"/> for deserialization. </summary>
