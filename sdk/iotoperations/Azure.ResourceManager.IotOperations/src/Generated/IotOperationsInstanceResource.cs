...
namespace Azure.ResourceManager.IotOperations
{
    ...
    public partial class IotOperationsInstanceResource : ArmResource
    {
        ...
        /// <summary>
        /// Updates the IotOperationsInstance.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.IoTOperations/instances/{instanceName}. </description>
        ...
        public virtual async Task<ArmOperation<IotOperationsInstanceResource>> UpdateAsync(WaitUntil waitUntil, IotOperationsInstanceData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _instanceRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, IotOperationsInstanceData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<IotOperationsInstanceResource> Update(WaitUntil waitUntil, IotOperationsInstanceData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
