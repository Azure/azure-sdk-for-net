...
namespace Azure.ResourceManager.IotOperations
{
    ...
    public partial class IotOperationsDataflowProfileData : ResourceData
    {
        ...
        internal IotOperationsDataflowProfileData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, IotOperationsDataflowProfileProperties properties, IotOperationsExtendedLocation extendedLocation) : base(id, name, resourceType, systemData)
        {
