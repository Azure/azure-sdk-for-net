...
namespace Azure.ResourceManager.IotOperations.Models
{
    ...
    public partial class PrincipalConfig
    {
        ...
        internal PrincipalConfig(IList<IDictionary<string, string>> attributes, IList<string> clientIds, IList<string> usernames, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
