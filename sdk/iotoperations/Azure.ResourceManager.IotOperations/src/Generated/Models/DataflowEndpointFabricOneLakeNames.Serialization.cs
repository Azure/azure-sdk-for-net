...
namespace Azure.ResourceManager.IotOperations.Models
{
    ...
    public partial class DataflowEndpointFabricOneLakeNames : IJsonModel<DataflowEndpointFabricOneLakeNames>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<DataflowEndpointFabricOneLakeNames>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        DataflowEndpointFabricOneLakeNames IJsonModel<DataflowEndpointFabricOneLakeNames>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual DataflowEndpointFabricOneLakeNames JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<DataflowEndpointFabricOneLakeNames>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static DataflowEndpointFabricOneLakeNames DeserializeDataflowEndpointFabricOneLakeNames(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            {
                if (prop.NameEquals("lakehouseName"u8))
                {
                    lakehouseName = prop.Value.GetString();
                    continue;
                }
            ...
            return new DataflowEndpointFabricOneLakeNames(lakehouseName, workspaceName, additionalBinaryDataProperties);
        }

        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<DataflowEndpointFabricOneLakeNames>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        DataflowEndpointFabricOneLakeNames IPersistableModel<DataflowEndpointFabricOneLakeNames>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
