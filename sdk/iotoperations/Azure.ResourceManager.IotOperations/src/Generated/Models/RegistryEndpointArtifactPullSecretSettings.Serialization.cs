...
namespace Azure.ResourceManager.IotOperations.Models
{
    ...
    internal partial class RegistryEndpointArtifactPullSecretSettings : IJsonModel<RegistryEndpointArtifactPullSecretSettings>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        RegistryEndpointArtifactPullSecretSettings IJsonModel<RegistryEndpointArtifactPullSecretSettings>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual RegistryEndpointArtifactPullSecretSettings JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<RegistryEndpointArtifactPullSecretSettings>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static RegistryEndpointArtifactPullSecretSettings DeserializeRegistryEndpointArtifactPullSecretSettings(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new RegistryEndpointArtifactPullSecretSettings(secretRef, additionalBinaryDataProperties);
        }

        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<RegistryEndpointArtifactPullSecretSettings>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
