...
namespace Azure.ResourceManager.IotOperations.Models
{
    ...
    public partial class DataflowEndpointDataExplorerAuthentication : IJsonModel<DataflowEndpointDataExplorerAuthentication>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<DataflowEndpointDataExplorerAuthentication>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        DataflowEndpointDataExplorerAuthentication IJsonModel<DataflowEndpointDataExplorerAuthentication>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual DataflowEndpointDataExplorerAuthentication JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<DataflowEndpointDataExplorerAuthentication>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static DataflowEndpointDataExplorerAuthentication DeserializeDataflowEndpointDataExplorerAuthentication(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    @method = new DataExplorerAuthMethod(prop.Value.GetString());
                    continue;
                }
            ...
            return new DataflowEndpointDataExplorerAuthentication(@method, systemAssignedManagedIdentitySettings, userAssignedManagedIdentitySettings, additionalBinaryDataProperties);
        }

        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<DataflowEndpointDataExplorerAuthentication>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        DataflowEndpointDataExplorerAuthentication IPersistableModel<DataflowEndpointDataExplorerAuthentication>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual DataflowEndpointDataExplorerAuthentication PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<DataflowEndpointDataExplorerAuthentication>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
