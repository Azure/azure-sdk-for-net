...
namespace Azure.ResourceManager.IotOperations.Models
{
    ...
    public partial class RegistryEndpointUserAssignedManagedIdentitySettings
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="RegistryEndpointUserAssignedManagedIdentitySettings"/>. </summary>
        ...
        internal RegistryEndpointUserAssignedManagedIdentitySettings(string clientId, string scope, string tenantId, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            ClientId = clientId;
            Scope = scope;
            TenantId = tenantId;
