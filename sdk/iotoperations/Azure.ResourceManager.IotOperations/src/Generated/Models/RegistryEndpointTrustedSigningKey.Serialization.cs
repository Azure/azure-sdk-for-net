...
namespace Azure.ResourceManager.IotOperations.Models
{
    ...
    public abstract partial class RegistryEndpointTrustedSigningKey : IJsonModel<RegistryEndpointTrustedSigningKey>
    {
        ...
        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual RegistryEndpointTrustedSigningKey JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<RegistryEndpointTrustedSigningKey>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static RegistryEndpointTrustedSigningKey DeserializeRegistryEndpointTrustedSigningKey(JsonElement element, ModelReaderWriterOptions options)
        {
