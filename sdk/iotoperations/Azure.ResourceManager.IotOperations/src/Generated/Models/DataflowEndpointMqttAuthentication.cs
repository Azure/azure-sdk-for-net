...
namespace Azure.ResourceManager.IoTOperations.Models
{
    ...
    public partial class DataflowEndpointMqttAuthentication
    {
        ...
        /// <param name="serviceAccountTokenSettings"> Kubernetes service account token authentication. Default audience if not set is aio-mq-internal. </param>
        ...
        /// <summary> Kubernetes service account token authentication. Default audience if not set is aio-mq-internal. </summary>
