...
{
    public partial class Sample_IotOperationsAkriConnectorResource
    {
        [Test]
        ...
        public async Task Get_AkriConnectorGetMaximumSet()
        {
            ...
            IotOperationsAkriConnectorResource result = await iotOperationsAkriConnector.GetAsync();
        ...
        public async Task Update_AkriConnectorCreateOrUpdateMaximumSet()
        {
            ...
            ArmOperation<IotOperationsAkriConnectorResource> lro = await iotOperationsAkriConnector.UpdateAsync(WaitUntil.Completed, data);
