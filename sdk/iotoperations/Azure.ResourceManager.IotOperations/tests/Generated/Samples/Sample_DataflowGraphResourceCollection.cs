...
{
    public partial class Sample_DataflowGraphResourceCollection
    {
        [Test]
        ...
        public async Task CreateOrUpdate_DataflowGraphCreateOrUpdateMaximumSet()
        {
            ...
            // get the collection of this DataflowGraphResource
            DataflowGraphResourceCollection collection = iotOperationsDataflowProfile.GetDataflowGraphResources();

            // invoke the operation
            string dataflowGraphName = "resource-123";
            DataflowGraphResourceData data = new DataflowGraphResourceData
            {
                Properties = new DataflowGraphProperties(new DataflowGraphNode[]
            {
...
SchemaRef = "aio-sr://namespace/alert:1",
            ...
            ArmOperation<DataflowGraphResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, dataflowGraphName, data);
            DataflowGraphResource result = lro.Value;

            // the variable result is a resource, you could call other operations on this instance as well
            // but just for demo, we get its data from this resource instance
            DataflowGraphResourceData resourceData = result.Data;
        ...
        public async Task Get_DataflowGraphGetMaximumSet()
        {
            ...
            // invoke the operation
            string dataflowGraphName = "resource-123";
            DataflowGraphResource result = await collection.GetAsync(dataflowGraphName);
        ...
        public async Task GetAll_DataflowGraphListByDataflowProfileMaximumSet()
        {
            ...
            await foreach (DataflowGraphResource item in collection.GetAllAsync())
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                DataflowGraphResourceData resourceData = item.Data;
                // for demo we just print out the id
                Console.WriteLine($"Succeeded on id: {resourceData.Id}");
            }
        ...
        public async Task GetIfExists_DataflowGraphGetMaximumSet()
        {
            ...
            // invoke the operation
            string dataflowGraphName = "resource-123";
            NullableResponse<DataflowGraphResource> response = await collection.GetIfExistsAsync(dataflowGraphName);
            DataflowGraphResource result = response.HasValue ? response.Value : null;
