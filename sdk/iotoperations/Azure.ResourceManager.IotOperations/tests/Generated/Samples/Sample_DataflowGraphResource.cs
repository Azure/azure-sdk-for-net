...
{
    public partial class Sample_DataflowGraphResource
    {
        [Test]
        ...
        public async Task Get_DataflowGraphGetMaximumSet()
        {
            ...
            // this example assumes you already have this DataflowGraphResource created on azure
            // for more information of creating DataflowGraphResource, please refer to the document of DataflowGraphResource
            ...
            ResourceIdentifier dataflowGraphResourceId = DataflowGraphResource.CreateResourceIdentifier(subscriptionId, resourceGroupName, instanceName, dataflowProfileName, dataflowGraphName);
            DataflowGraphResource dataflowGraphResource = client.GetDataflowGraphResource(dataflowGraphResourceId);

            // invoke the operation
            DataflowGraphResource result = await dataflowGraphResource.GetAsync();
        ...
        public async Task Delete_DataflowGraphDeleteMaximumSet()
        {
            ...
            // invoke the operation
            await dataflowGraphResource.DeleteAsync(WaitUntil.Completed);
...
SchemaRef = "aio-sr://namespace/alert:1",
            ...
            ArmOperation<DataflowGraphResource> lro = await dataflowGraphResource.UpdateAsync(WaitUntil.Completed, data);
