...
namespace Azure.ResourceManager.IotOperations.Tests
{
    public class AkriConnectorTests : IotOperationsManagementClientBase
    {
        ...
        [TestCase]
        [RecordedTest]
        public async Task TestAkriConnectorResource()
        {
            // Get AkriConnectorResourceCollection
            AkriConnectorResourceCollection connectorCollection = await GetAkriConnectorResourceCollectionAsync();
