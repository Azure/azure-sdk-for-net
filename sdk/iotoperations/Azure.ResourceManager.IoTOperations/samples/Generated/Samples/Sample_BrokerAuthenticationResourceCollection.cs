...
TrustedClientCaCert = "my-ca",
            ...
            ArmOperation<BrokerAuthenticationResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, authenticationName, data);
...
TrustedClientCaCert = "vlctsqddl",
        ...
        public async Task GetIfExists_BrokerAuthenticationGet()
        {
            ...
            // invoke the operation
            string authenticationName = "resource-name123";
            NullableResponse<BrokerAuthenticationResource> response = await collection.GetIfExistsAsync(authenticationName);
