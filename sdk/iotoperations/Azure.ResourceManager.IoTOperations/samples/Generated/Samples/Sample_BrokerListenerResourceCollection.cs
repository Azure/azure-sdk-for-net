...
ManualSecretRef = "example-secret",
            ...
            ArmOperation<BrokerListenerResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, listenerName, data);
...
new ListenerPort(1883)
        ...
        public async Task GetIfExists_BrokerListenerGet()
        {
            ...
            // invoke the operation
            string listenerName = "resource-name123";
            NullableResponse<BrokerListenerResource> response = await collection.GetIfExistsAsync(listenerName);
