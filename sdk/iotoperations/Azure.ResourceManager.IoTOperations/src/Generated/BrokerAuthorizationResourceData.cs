...
namespace Azure.ResourceManager.IoTOperations
{
    ...
    public partial class BrokerAuthorizationResourceData : ResourceData
    {
        ...
        /// <summary> Initializes a new instance of <see cref="BrokerAuthorizationResourceData"/>. </summary>
        ...
        internal BrokerAuthorizationResourceData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, BrokerAuthorizationProperties properties, ExtendedLocation extendedLocation, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
        ...
        /// <summary> Initializes a new instance of <see cref="BrokerAuthorizationResourceData"/> for deserialization. </summary>
