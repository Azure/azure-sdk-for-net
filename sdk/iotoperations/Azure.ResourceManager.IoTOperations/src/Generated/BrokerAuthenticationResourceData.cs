...
namespace Azure.ResourceManager.IoTOperations
{
    ...
    public partial class BrokerAuthenticationResourceData : ResourceData
    {
        ...
        /// <summary> Initializes a new instance of <see cref="BrokerAuthenticationResourceData"/>. </summary>
        ...
        internal BrokerAuthenticationResourceData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, BrokerAuthenticationProperties properties, ExtendedLocation extendedLocation, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
        ...
        /// <summary> Initializes a new instance of <see cref="BrokerAuthenticationResourceData"/> for deserialization. </summary>
