...
namespace Azure.ResourceManager.IoTOperations.Models
{
    ...
    public partial class DataflowEndpointProperties
    {
        ...
        /// <summary> Initializes a new instance of <see cref="DataflowEndpointProperties"/>. </summary>
        /// <param name="endpointType"> Endpoint Type. </param>
        public DataflowEndpointProperties(EndpointType endpointType)
        {
        ...
        internal DataflowEndpointProperties(EndpointType endpointType, DataflowEndpointDataExplorer dataExplorerSettings, DataflowEndpointDataLakeStorage dataLakeStorageSettings, DataflowEndpointFabricOneLake fabricOneLakeSettings, DataflowEndpointKafka kafkaSettings, DataflowEndpointLocalStorage localStorageSettings, DataflowEndpointMqtt mqttSettings, ProvisioningState? provisioningState, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            EndpointType = endpointType;
        ...
        /// <summary> Initializes a new instance of <see cref="DataflowEndpointProperties"/> for deserialization. </summary>
        internal DataflowEndpointProperties()
        {
        }
