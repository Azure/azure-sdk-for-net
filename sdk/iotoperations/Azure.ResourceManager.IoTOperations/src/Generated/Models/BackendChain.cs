...
namespace Azure.ResourceManager.IoTOperations.Models
{
    ...
    public partial class BackendChain
    {
        ...
        /// <summary> Initializes a new instance of <see cref="BackendChain"/>. </summary>
        ...
        internal BackendChain(int partitions, int redundancyFactor, int? workers, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Partitions = partitions;
            RedundancyFactor = redundancyFactor;
            Workers = workers;
        ...
        /// <summary> Initializes a new instance of <see cref="BackendChain"/> for deserialization. </summary>
        internal BackendChain()
        {
        }
