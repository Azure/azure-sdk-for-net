...
{
    /// <summary> Defines a component binding for a provider. </summary>
    public partial class BindingProperties
    {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="config"/>, <paramref name="provider"/> or <paramref name="role"/> is null. </exception>
        public BindingProperties(IDictionary<string, BinaryData> config, string provider, string role)
        {
        ...
        internal BindingProperties(IDictionary<string, BinaryData> config, string provider, string role, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Config = config;
            Provider = provider;
            Role = role;
