...
namespace Azure.ResourceManager.IoTOperations.Models
{
    ...
    public partial class SelfCheck
    {
        ...
        /// <summary> Initializes a new instance of <see cref="SelfCheck"/>. </summary>
        public SelfCheck()
        {
        }
        ...
        internal SelfCheck(OperationalMode? mode, int? intervalSeconds, int? timeoutSeconds, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Mode = mode;
