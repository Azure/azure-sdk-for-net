...
namespace Azure.ResourceManager.IoTOperations.Models
{
    ...
    public partial class Traces
    {
        ...
        internal Traces(OperationalMode? mode, int? cacheSizeMegabytes, SelfTracing selfTracing, int? spanChannelCapacity, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Mode = mode;
