...
namespace Azure.ResourceManager.IoTOperations.Tests.Helpers
{
    ...
    {
        public const string DefaultResourceGroupName = "sdk-test-cluster";
        ...
        {
            await resourceGroupsOperations.CreateOrUpdateAsync(WaitUntil.Completed, DefaultResourceGroupName, new ResourceGroupData(location));
        }
    }
}
