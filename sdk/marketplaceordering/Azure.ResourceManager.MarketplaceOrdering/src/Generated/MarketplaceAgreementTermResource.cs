    ...
    public partial class MarketplaceAgreementTermResource : BaseMarketplaceAgreementTermResource
    {
        ...
        protected override async Task<Response<BaseMarketplaceAgreementTermResource>> GetCoreAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue((BaseMarketplaceAgreementTermResource)new MarketplaceAgreementTermResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public virtual new async Task<Response<MarketplaceAgreementTermResource>> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public virtual new Response<MarketplaceAgreementTermResource> Get(CancellationToken cancellationToken = default)
        {
