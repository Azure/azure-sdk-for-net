...
namespace Azure.ResourceManager.MarketplaceOrdering
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MarketplaceAgreementTermData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MarketplaceAgreementTermData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MarketplaceAgreementTermData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MarketplaceAgreementTermData>)} interface");
            }
        ...
        string IPersistableModel<MarketplaceAgreementTermData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
