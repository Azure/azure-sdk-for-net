...
namespace Azure.ResourceManager.MarketplaceOrdering.Models
{
    ...
    public static partial class ArmMarketplaceOrderingModelFactory
    {
        ...
        {
            return new MarketplaceAgreementTermData(id, name, resourceType, systemData, publisher, product, plan, licenseTextLink, privacyPolicyLink, marketplaceTermsLink, retrievedOn, signature, isAccepted, new Dictionary<string, BinaryData>());
        }
    }
}
