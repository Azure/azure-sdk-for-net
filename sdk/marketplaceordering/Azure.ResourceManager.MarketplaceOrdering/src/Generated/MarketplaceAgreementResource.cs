...
namespace Azure.ResourceManager.MarketplaceOrdering
{
    ...
    public partial class MarketplaceAgreementResource : BaseMarketplaceAgreementTermResource
    {
        ...
        {
            using var scope = _marketplaceAgreementClientDiagnostics.CreateScope("MarketplaceAgreementResource.GetCore");
            scope.Start();
            try
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public new async Task<Response<MarketplaceAgreementResource>> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public new Response<MarketplaceAgreementResource> Get(CancellationToken cancellationToken = default)
        {
