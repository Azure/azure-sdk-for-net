...
namespace Azure.ResourceManager.MarketplaceOrdering.Mocking
{
    ...
    internal partial class MarketplaceOrderingArmClientMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="MarketplaceOrderingArmClientMockingExtension"/> class for mocking. </summary>
        protected MarketplaceOrderingArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MarketplaceOrderingArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MarketplaceOrderingArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal MarketplaceOrderingArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
