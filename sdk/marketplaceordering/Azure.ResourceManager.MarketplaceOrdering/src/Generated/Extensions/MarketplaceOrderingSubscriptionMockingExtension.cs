...
namespace Azure.ResourceManager.MarketplaceOrdering.Mocking
{
    ...
    internal partial class MarketplaceOrderingSubscriptionMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="MarketplaceOrderingSubscriptionMockingExtension"/> class for mocking. </summary>
        protected MarketplaceOrderingSubscriptionMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MarketplaceOrderingSubscriptionMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MarketplaceOrderingSubscriptionMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
