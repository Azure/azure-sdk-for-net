...
namespace Azure.ResourceManager.MarketplaceOrdering.Testing
{
    /// <summary> A class to add extension methods to SubscriptionResource. </summary>
    public partial class MarketplaceOrderingSubscriptionResourceExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="MarketplaceOrderingSubscriptionResourceExtension"/> class for mocking. </summary>
        protected MarketplaceOrderingSubscriptionResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MarketplaceOrderingSubscriptionResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MarketplaceOrderingSubscriptionResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
