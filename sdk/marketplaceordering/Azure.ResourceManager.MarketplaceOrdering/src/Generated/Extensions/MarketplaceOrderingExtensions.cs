...
namespace Azure.ResourceManager.MarketplaceOrdering
{
    ...
    public static partial class MarketplaceOrderingExtensions
    {
        ...
        {
            return GetSubscriptionResourceExtension(subscriptionResource).GetMarketplaceAgreementTerms();
        }
        ...
        {
            return GetSubscriptionResourceExtension(subscriptionResource).GetMarketplaceAgreements();
        }
