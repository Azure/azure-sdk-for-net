...
namespace Azure.Temp.Batch.Models
{
    ...
    {
        /// <summary> Initializes a new instance of CertificateListOptions. </summary>
        public CertificateListOptions()
        {
        }

        /// <summary> An OData $filter clause. For more information on constructing this filter, see https://docs.microsoft.com/en-us/rest/api/batchservice/odata-filters-in-batch#list-certificates. </summary>
        public string Filter { get; set; }
        /// <summary> An OData $select clause. </summary>
        public string Select { get; set; }
        /// <summary> The maximum number of items to return in the response. A maximum of 1000 Certificates can be returned. </summary>
