...
namespace Azure.Temp.Batch.Models
{
    ...
    public partial class NetworkConfiguration
    {
        ...
        /// <param name="publicIPAddressConfiguration"> Public IP configuration property is only supported on Pools with the virtualMachineConfiguration property. </param>
        ...
        internal NetworkConfiguration(string subnetId, DynamicVNetAssignmentScope? dynamicVNetAssignmentScope, PoolEndpointConfiguration endpointConfiguration, PublicIPAddressConfiguration publicIPAddressConfiguration, bool? enableAcceleratedNetworking)
        {
            SubnetId = subnetId;
        ...
        /// <summary> Public IP configuration property is only supported on Pools with the virtualMachineConfiguration property. </summary>
