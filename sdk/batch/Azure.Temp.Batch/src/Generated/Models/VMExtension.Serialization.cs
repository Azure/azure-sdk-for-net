...
namespace Azure.Temp.Batch.Models
{
    public partial class VMExtension : IUtf8JsonSerializable
    {
        ...
        internal static VMExtension DeserializeVMExtension(JsonElement element)
        {
            ...
            return new VMExtension(name, publisher, type, typeHandlerVersion.Value, Optional.ToNullable(autoUpgradeMinorVersion), Optional.ToNullable(enableAutomaticUpgrade), settings.Value, protectedSettings.Value, Optional.ToList(provisionAfterExtensions));
        }
    }
}
