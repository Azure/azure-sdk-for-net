...
namespace Azure.Temp.Batch.Models
{
    ...
    {
        /// <summary> Initializes a new instance of AccountListSupportedImagesOptions. </summary>
        public AccountListSupportedImagesOptions()
        {
        }

        /// <summary> An OData $filter clause. For more information on constructing this filter, see https://docs.microsoft.com/en-us/rest/api/batchservice/odata-filters-in-batch#list-support-images. </summary>
