...
namespace Azure.Temp.Batch.Models
{
    ...
    public partial class StartTaskInformation
    {
        ...
        /// <summary> This value is reset every time the Task is restarted or retried (that is, this is the most recent time at which the StartTask started running). </summary>
        public DateTimeOffset StartTime { get; }
        /// <summary> This is the end time of the most recent run of the StartTask, if that run has completed (even if that run failed and a retry is pending). This element is not present if the StartTask is currently running. </summary>
