...
namespace Azure.Temp.Batch
{
    ...
    public partial class ApplicationClient
    {
        ...
        /// <include file="Docs/ApplicationClient.xml" path="doc/members/member[@name='GetApplicationAsync(string,int?,Guid?,bool?,DateTimeOffset?,RequestContext)']/*" />
        public virtual async Task<Response> GetApplicationAsync(string applicationId, int? timeout, Guid? clientRequestId, bool? returnClientRequestId, DateTimeOffset? ocpDate, RequestContext context)
        {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/ApplicationClient.xml" path="doc/members/member[@name='GetApplication(string,int?,Guid?,bool?,DateTimeOffset?,RequestContext)']/*" />
        public virtual Response GetApplication(string applicationId, int? timeout, Guid? clientRequestId, bool? returnClientRequestId, DateTimeOffset? ocpDate, RequestContext context)
        {
            Argument.AssertNotNullOrEmpty(applicationId, nameof(applicationId));
        ...
        /// <include file="Docs/ApplicationClient.xml" path="doc/members/member[@name='GetApplicationsAsync(int?,int?,Guid?,bool?,DateTimeOffset?,RequestContext)']/*" />
        public virtual AsyncPageable<BinaryData> GetApplicationsAsync(int? maxResults, int? timeout, Guid? clientRequestId, bool? returnClientRequestId, DateTimeOffset? ocpDate, RequestContext context)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetApplicationsRequest(maxResults, timeout, clientRequestId, returnClientRequestId, ocpDate, context);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CreateGetApplicationsNextPageRequest(nextLink, maxResults, timeout, clientRequestId, returnClientRequestId, ocpDate, context);
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => BinaryData.FromString(e.GetRawText()), ClientDiagnostics, _pipeline, "ApplicationClient.GetApplications", "value", "odata.nextLink", context);
        }
        ...
        /// <include file="Docs/ApplicationClient.xml" path="doc/members/member[@name='GetApplications(int?,int?,Guid?,bool?,DateTimeOffset?,RequestContext)']/*" />
        public virtual Pageable<BinaryData> GetApplications(int? maxResults, int? timeout, Guid? clientRequestId, bool? returnClientRequestId, DateTimeOffset? ocpDate, RequestContext context)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetApplicationsRequest(maxResults, timeout, clientRequestId, returnClientRequestId, ocpDate, context);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CreateGetApplicationsNextPageRequest(nextLink, maxResults, timeout, clientRequestId, returnClientRequestId, ocpDate, context);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => BinaryData.FromString(e.GetRawText()), ClientDiagnostics, _pipeline, "ApplicationClient.GetApplications", "value", "odata.nextLink", context);
        }
