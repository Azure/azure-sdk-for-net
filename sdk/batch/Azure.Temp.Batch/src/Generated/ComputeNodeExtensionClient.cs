...
namespace Azure.Temp.Batch
{
    ...
    public partial class ComputeNodeExtensionClient
    {
        ...
        /// <include file="Docs/ComputeNodeExtensionClient.xml" path="doc/members/member[@name='GetComputeNodeExtensionAsync(string,string,string,string,int?,Guid?,bool?,DateTimeOffset?,RequestContext)']/*" />
        public virtual async Task<Response> GetComputeNodeExtensionAsync(string poolId, string nodeId, string extensionName, string select, int? timeout, Guid? clientRequestId, bool? returnClientRequestId, DateTimeOffset? ocpDate, RequestContext context)
        {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/ComputeNodeExtensionClient.xml" path="doc/members/member[@name='GetComputeNodeExtension(string,string,string,string,int?,Guid?,bool?,DateTimeOffset?,RequestContext)']/*" />
        public virtual Response GetComputeNodeExtension(string poolId, string nodeId, string extensionName, string select, int? timeout, Guid? clientRequestId, bool? returnClientRequestId, DateTimeOffset? ocpDate, RequestContext context)
        {
            Argument.AssertNotNullOrEmpty(poolId, nameof(poolId));
            Argument.AssertNotNullOrEmpty(nodeId, nameof(nodeId));
            Argument.AssertNotNullOrEmpty(extensionName, nameof(extensionName));
        ...
        /// <include file="Docs/ComputeNodeExtensionClient.xml" path="doc/members/member[@name='GetComputeNodeExtensionsAsync(string,string,string,int?,int?,Guid?,bool?,DateTimeOffset?,RequestContext)']/*" />
        public virtual AsyncPageable<BinaryData> GetComputeNodeExtensionsAsync(string poolId, string nodeId, string select, int? maxResults, int? timeout, Guid? clientRequestId, bool? returnClientRequestId, DateTimeOffset? ocpDate, RequestContext context)
        {
            Argument.AssertNotNullOrEmpty(poolId, nameof(poolId));
            Argument.AssertNotNullOrEmpty(nodeId, nameof(nodeId));

            HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetComputeNodeExtensionsRequest(poolId, nodeId, select, maxResults, timeout, clientRequestId, returnClientRequestId, ocpDate, context);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CreateGetComputeNodeExtensionsNextPageRequest(nextLink, poolId, nodeId, select, maxResults, timeout, clientRequestId, returnClientRequestId, ocpDate, context);
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => BinaryData.FromString(e.GetRawText()), ClientDiagnostics, _pipeline, "ComputeNodeExtensionClient.GetComputeNodeExtensions", "value", "odata.nextLink", context);
        }
        ...
        /// <include file="Docs/ComputeNodeExtensionClient.xml" path="doc/members/member[@name='GetComputeNodeExtensions(string,string,string,int?,int?,Guid?,bool?,DateTimeOffset?,RequestContext)']/*" />
        public virtual Pageable<BinaryData> GetComputeNodeExtensions(string poolId, string nodeId, string select, int? maxResults, int? timeout, Guid? clientRequestId, bool? returnClientRequestId, DateTimeOffset? ocpDate, RequestContext context)
        {
            Argument.AssertNotNullOrEmpty(poolId, nameof(poolId));
            Argument.AssertNotNullOrEmpty(nodeId, nameof(nodeId));
            ...
            HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetComputeNodeExtensionsRequest(poolId, nodeId, select, maxResults, timeout, clientRequestId, returnClientRequestId, ocpDate, context);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CreateGetComputeNodeExtensionsNextPageRequest(nextLink, poolId, nodeId, select, maxResults, timeout, clientRequestId, returnClientRequestId, ocpDate, context);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => BinaryData.FromString(e.GetRawText()), ClientDiagnostics, _pipeline, "ComputeNodeExtensionClient.GetComputeNodeExtensions", "value", "odata.nextLink", context);
        }
