...
namespace Azure.Temp.Batch
{
    ...
    public partial class AccountClient
    {
        ...
        /// <include file="Docs/AccountClient.xml" path="doc/members/member[@name='GetSupportedImagesAsync(string,int?,int?,Guid?,bool?,DateTimeOffset?,RequestContext)']/*" />
        public virtual AsyncPageable<BinaryData> GetSupportedImagesAsync(string filter, int? maxResults, int? timeout, Guid? clientRequestId, bool? returnClientRequestId, DateTimeOffset? ocpDate, RequestContext context)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetSupportedImagesRequest(filter, maxResults, timeout, clientRequestId, returnClientRequestId, ocpDate, context);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CreateGetSupportedImagesNextPageRequest(nextLink, filter, maxResults, timeout, clientRequestId, returnClientRequestId, ocpDate, context);
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => BinaryData.FromString(e.GetRawText()), ClientDiagnostics, _pipeline, "AccountClient.GetSupportedImages", "value", "odata.nextLink", context);
        }
        ...
        /// <include file="Docs/AccountClient.xml" path="doc/members/member[@name='GetSupportedImages(string,int?,int?,Guid?,bool?,DateTimeOffset?,RequestContext)']/*" />
        public virtual Pageable<BinaryData> GetSupportedImages(string filter, int? maxResults, int? timeout, Guid? clientRequestId, bool? returnClientRequestId, DateTimeOffset? ocpDate, RequestContext context)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetSupportedImagesRequest(filter, maxResults, timeout, clientRequestId, returnClientRequestId, ocpDate, context);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CreateGetSupportedImagesNextPageRequest(nextLink, filter, maxResults, timeout, clientRequestId, returnClientRequestId, ocpDate, context);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => BinaryData.FromString(e.GetRawText()), ClientDiagnostics, _pipeline, "AccountClient.GetSupportedImages", "value", "odata.nextLink", context);
        }
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The <see cref="AsyncPageable{T}"/> from the service containing a list of <see cref="BinaryData"/> objects. Details of the body schema for each item in the collection are in the Remarks section below. </returns>
        /// <include file="Docs/AccountClient.xml" path="doc/members/member[@name='GetPoolNodeCountsAsync(string,int?,int?,Guid?,bool?,DateTimeOffset?,RequestContext)']/*" />
        public virtual AsyncPageable<BinaryData> GetPoolNodeCountsAsync(string filter, int? maxResults, int? timeout, Guid? clientRequestId, bool? returnClientRequestId, DateTimeOffset? ocpDate, RequestContext context)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetPoolNodeCountsRequest(filter, maxResults, timeout, clientRequestId, returnClientRequestId, ocpDate, context);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CreateGetPoolNodeCountsNextPageRequest(nextLink, filter, maxResults, timeout, clientRequestId, returnClientRequestId, ocpDate, context);
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => BinaryData.FromString(e.GetRawText()), ClientDiagnostics, _pipeline, "AccountClient.GetPoolNodeCounts", "value", "odata.nextLink", context);
        }
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The <see cref="Pageable{T}"/> from the service containing a list of <see cref="BinaryData"/> objects. Details of the body schema for each item in the collection are in the Remarks section below. </returns>
        /// <include file="Docs/AccountClient.xml" path="doc/members/member[@name='GetPoolNodeCounts(string,int?,int?,Guid?,bool?,DateTimeOffset?,RequestContext)']/*" />
        public virtual Pageable<BinaryData> GetPoolNodeCounts(string filter, int? maxResults, int? timeout, Guid? clientRequestId, bool? returnClientRequestId, DateTimeOffset? ocpDate, RequestContext context)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetPoolNodeCountsRequest(filter, maxResults, timeout, clientRequestId, returnClientRequestId, ocpDate, context);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CreateGetPoolNodeCountsNextPageRequest(nextLink, filter, maxResults, timeout, clientRequestId, returnClientRequestId, ocpDate, context);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => BinaryData.FromString(e.GetRawText()), ClientDiagnostics, _pipeline, "AccountClient.GetPoolNodeCounts", "value", "odata.nextLink", context);
        }
