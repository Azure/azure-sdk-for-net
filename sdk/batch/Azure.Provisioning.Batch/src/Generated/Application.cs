...
namespace Azure.Provisioning.Batch
{
    ...
    public partial class Application : ProvisionableResource
    {
        ...
        public Application(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.Batch/batchAccounts/applications", resourceVersion ?? "2025-06-01")
        {
        }
