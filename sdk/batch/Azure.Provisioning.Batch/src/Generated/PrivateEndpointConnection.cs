...
namespace Azure.Provisioning.Batch
{
    ...
    public partial class PrivateEndpointConnection : ProvisionableResource
    {
        ...
        internal PrivateEndpointConnection(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.Batch/batchAccounts/privateEndpointConnections", resourceVersion ?? "2025-06-01")
        {
        }
