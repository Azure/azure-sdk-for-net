...
namespace Azure.Provisioning.Batch
{
    ...
    public partial class Pool : ProvisionableResource
    {
        ...
        public Pool(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.Batch/batchAccounts/pools", resourceVersion ?? "2025-06-01")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for Pool. </summary>
        ...
        /// <summary> Creates a reference to an existing Pool. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static Pool FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            Pool result = new Pool(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for Pool that are not part of the generated code. </summary>
