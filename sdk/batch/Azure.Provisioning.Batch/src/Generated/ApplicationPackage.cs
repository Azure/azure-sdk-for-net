...
namespace Azure.Provisioning.Batch
{
    ...
    public partial class ApplicationPackage : ProvisionableResource
    {
        ...
        private ResourceReference<Application> _parent;

        /// <summary> Creates a new ApplicationPackage. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public ApplicationPackage(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.Batch/batchAccounts/applications/versions", resourceVersion ?? "2025-06-01")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for ApplicationPackage. </summary>
        protected override void DefineProvisionableProperties()
        {
            ...
            _parent = DefineResource<Application>("Parent", new string[] { "parent" }, isRequired: true);
            DefineAdditionalProperties();
        }

        /// <summary> Creates a reference to an existing ApplicationPackage. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static ApplicationPackage FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            ApplicationPackage result = new ApplicationPackage(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for ApplicationPackage that are not part of the generated code. </summary>
