...
namespace Microsoft.Azure.Batch.Protocol.Models
{
    ...
    public partial class ComputeNodeExtensionGetOptions
    {
        ...
        public ComputeNodeExtensionGetOptions(string select = default(string), int? timeout = default(int?), System.Guid? clientRequestId = default(System.Guid?), bool? returnClientRequestId = default(bool?), System.DateTime? ocpDate = default(System.DateTime?))
        {
            Select = select;
            Timeout = timeout;
