...
namespace Microsoft.Azure.Batch.Protocol.Models
{
    ...
    /// </summary>
    public partial class ComputeNodeExtensionsListOptions
    {
        /// <summary>
        /// Initializes a new instance of the ComputeNodeExtensionsListOptions
        /// class.
        /// </summary>
        public ComputeNodeExtensionsListOptions()
        {
            CustomInit();
        }
        ...
        public ComputeNodeExtensionsListOptions(string select = default(string), int? maxResults = default(int?), int? timeout = default(int?), System.Guid? clientRequestId = default(System.Guid?), bool? returnClientRequestId = default(bool?), System.DateTime? ocpDate = default(System.DateTime?))
        {
            Select = select;
