...
namespace Microsoft.Azure.Batch.Protocol.Models
{
    ...
    public partial class JobDeleteOptions
    {
        ...
        /// modified since the specified time.</param>
        /// <param name="force">If true, the server will delete the Job even if
        /// the corresponding nodes have not fully processed the deletion. The
        ...
        /// <summary>
        /// Gets or sets if true, the server will delete the Job even if the
        /// corresponding nodes have not fully processed the deletion. The
