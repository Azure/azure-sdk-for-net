...
namespace Microsoft.Azure.Batch.Protocol.Models
{
    ...
    public partial class JobTerminateOptions
    {
        ...
        /// modified since the specified time.</param>
        /// <param name="force">If true, the server will terminate the Job even
        /// if the corresponding nodes have not fully processed the
        /// termination. The default value is false.</param>
        ...
        /// <summary>
        /// Gets or sets if true, the server will terminate the Job even if the
