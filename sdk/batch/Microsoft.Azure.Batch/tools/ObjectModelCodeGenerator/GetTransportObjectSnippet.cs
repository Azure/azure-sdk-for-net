...
namespace ObjectModelCodeGenerator
{
    ...
    public partial class GetTransportObjectSnippet : GetTransportObjectSnippetBase
    {
        /// <summary>
...
foreach (var kvp in type.OrderedPublicProperties)
{
    if (kvp.Key.CanSerializeToServer)
    {
            ...
            this.Write("                ");
            this.Write(this.ToStringHelper.ToStringWithCulture(CodeGenerationUtilities.GetProtocolPropertyName(kvp.Key, kvp.Value)));
            this.Write(" = ");
            this.Write(this.ToStringHelper.ToStringWithCulture(CodeGenerationUtilities.GetObjectModelToProtocolString(kvp.Key, kvp.Value)));
            this.Write(",\r\n");
...
if ((typeValueAcquired == false))
{
    ...
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.VisualStudio.TextTemplating", "15.0.0.0")]
    public class GetTransportObjectSnippetBase
    {
        #region Fields
