...
namespace Batch.FileStaging.Tests
{
    ...
    {
        [Fact]
        public void StagingStorageAccount_EmptyStorageAccountName_ThrowsArgumentOutofRange()
        {
            Assert.Throws<ArgumentOutOfRangeException>(() => { new StagingStorageAccount(storageAccount: " ", storageAccountKey: "key", blobEndpoint: "blob"); });
        }

        [Fact]
        public void StagingStorageAccount_EmptyStorageAccountKey_ThrowsArgumentOutofRange()
        {
            Assert.Throws<ArgumentOutOfRangeException>(() => { new StagingStorageAccount(storageAccount: "account", storageAccountKey: " ", blobEndpoint: "blob"); });
        }
