...
internal static class PoolEndpointConfig
{
    public static async Task SetPortsBasicAsync()
    {
        ...
        BatchAccountPoolData poolData = NewLinuxPool();

        #region Snippet:endpoint_config_basic
        poolData.NetworkConfiguration = new BatchNetworkConfiguration()
        {
    ...
    private static BatchAccountPoolData NewLinuxPool() => new BatchAccountPoolData()
    {
