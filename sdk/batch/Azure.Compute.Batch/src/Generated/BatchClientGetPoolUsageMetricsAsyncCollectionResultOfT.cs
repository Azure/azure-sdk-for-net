    ...
    internal partial class BatchClientGetPoolUsageMetricsAsyncCollectionResultOfT : AsyncPageable<BatchPoolUsageMetrics>
    {
        ...
        public override async IAsyncEnumerable<Page<BatchPoolUsageMetrics>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            do
            {
                ...
                yield return Page<BatchPoolUsageMetrics>.FromValues((IReadOnlyList<BatchPoolUsageMetrics>)responseWithType.Value, nextPage?.AbsoluteUri, response);
            }
            while (nextPage != null);
        }
