...
namespace Azure.Compute.Batch
{
    internal partial class BatchClientGetTasksCollectionResult : Pageable<BinaryData>
    {
        ...
        public BatchClientGetTasksCollectionResult(BatchClient client, string jobId, TimeSpan? timeOutInSeconds, DateTimeOffset? ocpDate, int? maxresults, string filter, IEnumerable<string> @select, IEnumerable<string> expand, RequestContext context) : base(context?.CancellationToken ?? default)
        {
