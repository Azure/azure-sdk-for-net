...
namespace Azure.Batch
{
    internal partial class BatchClientGetApplicationsCollectionResultOfT : Pageable<BatchApplication>
    {
        ...
        public BatchClientGetApplicationsCollectionResultOfT(BatchClient client, int? timeOutInSeconds, string clientRequestId, bool? returnClientRequestId, DateTimeOffset? ocpdate, int? maxresults, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
