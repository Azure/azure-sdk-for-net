...
namespace Azure.Compute.Batch
{
    ...
    public partial class ResourceFile
    {
        ...
        internal ResourceFile(string autoStorageContainerName, string storageContainerUrl, string httpUrl, string blobPrefix, string filePath, string fileMode, BatchNodeIdentityReference identityReference)
        {
