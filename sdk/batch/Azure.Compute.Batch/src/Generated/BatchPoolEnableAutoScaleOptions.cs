...
{
    /// <summary> Options for enabling automatic scaling on an Azure Batch Pool. </summary>
    public partial class BatchPoolEnableAutoScaleOptions
    {
        /// <summary> Initializes a new instance of BatchPoolEnableAutoScaleOptions. </summary>
        public BatchPoolEnableAutoScaleOptions()
        {
        }

        /// <summary> Initializes a new instance of BatchPoolEnableAutoScaleOptions. </summary>
        /// <param name="autoScaleFormula"> The formula for the desired number of Compute Nodes in the Pool. The formula is checked for validity before it is applied to the Pool. If the formula is not valid, the Batch service rejects the request with detailed error information. For more information about specifying this formula, see Automatically scale Compute Nodes in an Azure Batch Pool (https://azure.microsoft.com/en-us/documentation/articles/batch-automatic-scaling). </param>
        ...
        internal BatchPoolEnableAutoScaleOptions(string autoScaleFormula, TimeSpan? autoScaleEvaluationInterval)
        {
