...
{
    /// <summary> Options for creating an Azure Batch Pool. </summary>
    public partial class BatchPoolCreateOptions
    {
        /// <summary> Initializes a new instance of BatchPoolCreateOptions. </summary>
        ...
        internal BatchPoolCreateOptions(string id, string displayName, string vmSize, CloudServiceConfiguration cloudServiceConfiguration, VirtualMachineConfiguration virtualMachineConfiguration, TimeSpan? resizeTimeout, int? targetDedicatedNodes, int? targetLowPriorityNodes, bool? enableAutoScale, string autoScaleFormula, TimeSpan? autoScaleEvaluationInterval, bool? enableInterNodeCommunication, NetworkConfiguration networkConfiguration, StartTask startTask, IList<CertificateReference> certificateReferences, IList<ApplicationPackageReference> applicationPackageReferences, IList<string> applicationLicenses, int? taskSlotsPerNode, TaskSchedulingPolicy taskSchedulingPolicy, IList<UserAccount> userAccounts, IList<MetadataItem> metadata, IList<MountConfiguration> mountConfiguration, NodeCommunicationMode? targetNodeCommunicationMode)
        {
            Id = id;
