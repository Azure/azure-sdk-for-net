...
namespace Azure.Compute.Batch
{
    internal partial class BatchClientGetNodeFilesCollectionResult : Pageable<BinaryData>
    {
        ...
        public BatchClientGetNodeFilesCollectionResult(BatchClient client, string poolId, string nodeId, TimeSpan? timeOutInSeconds, string clientRequestId, bool? returnClientRequestId, DateTimeOffset? ocpDate, int? maxresults, string filter, bool? recursive, RequestContext context) : base(context?.CancellationToken ?? default)
        {
