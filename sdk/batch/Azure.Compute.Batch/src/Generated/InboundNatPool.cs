...
namespace Azure.Batch
{
    ...
    public partial class InboundNatPool
    {
        ...
        internal InboundNatPool(string name, InboundEndpointProtocol protocol, int backendPort, int frontendPortRangeStart, int frontendPortRangeEnd, IList<NetworkSecurityGroupRule> networkSecurityGroupRules, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Name = name;
            Protocol = protocol;
            BackendPort = backendPort;
