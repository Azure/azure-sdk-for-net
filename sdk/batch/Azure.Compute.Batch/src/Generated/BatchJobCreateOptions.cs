...
{
    /// <summary> Options for creating an Azure Batch Job. </summary>
    public partial class BatchJobCreateOptions
    {
        /// <summary> Initializes a new instance of BatchJobCreateOptions. </summary>
        ...
        public BatchJobCreateOptions(string id, PoolInformation poolInfo)
        {
        ...
        internal BatchJobCreateOptions(string id, string displayName, bool? usesTaskDependencies, int? priority, bool? allowTaskPreemption, int? maxParallelTasks, JobConstraints constraints, JobManagerTask jobManagerTask, JobPreparationTask jobPreparationTask, JobReleaseTask jobReleaseTask, IList<EnvironmentSetting> commonEnvironmentSettings, PoolInformation poolInfo, OnAllTasksComplete? onAllTasksComplete, OnTaskFailure? onTaskFailure, JobNetworkConfiguration networkConfiguration, IList<MetadataItem> metadata)
        {
            Id = id;
