...
namespace Azure.Compute.Batch
{
    ...
    public partial class BatchCertificateReference
    {
        ...
        internal BatchCertificateReference(string thumbprint, string thumbprintAlgorithm, BatchCertificateStoreLocation? storeLocation, string storeName, IList<BatchCertificateVisibility> visibility, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Thumbprint = thumbprint;
            ThumbprintAlgorithm = thumbprintAlgorithm;
