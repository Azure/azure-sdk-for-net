...
namespace Azure.Compute.Batch
{
    ...
    public static partial class BatchModelFactory
    {
        ...
        public static ManagedDisk ManagedDisk(DiskEncryptionSetParameters diskEncryptionSet = default, StorageAccountType? storageAccountType = default, BatchVmDiskSecurityProfile securityProfile = default)
        {
            return new ManagedDisk(diskEncryptionSet, storageAccountType, securityProfile, additionalBinaryDataProperties: null);
        }
        ...
        /// <returns> A new <see cref="Batch.DiskEncryptionSetParameters"/> instance for mocking. </returns>
        ...
        public static DiskEncryptionConfiguration DiskEncryptionConfiguration(DiskCustomerManagedKey customerManagedKey = default, IEnumerable<DiskEncryptionTarget> targets = default)
        {
            targets ??= new ChangeTrackingList<DiskEncryptionTarget>();

            return new DiskEncryptionConfiguration(customerManagedKey, targets.ToList(), additionalBinaryDataProperties: null);
        }
        ...
        /// <returns> A new <see cref="Batch.BatchPoolIdentityReference"/> instance for mocking. </returns>
        public static BatchPoolIdentityReference BatchPoolIdentityReference(ResourceIdentifier resourceId = default)
        {
            return new BatchPoolIdentityReference(resourceId, additionalBinaryDataProperties: null);
        }
        ...
        /// <returns> A new <see cref="Batch.ProxyAgentSettings"/> instance for mocking. </returns>
        public static ProxyAgentSettings ProxyAgentSettings(bool? enabled = default, HostEndpointSettings imds = default, HostEndpointSettings wireServer = default)
        {
            return new ProxyAgentSettings(enabled, imds, wireServer, additionalBinaryDataProperties: null);
        }
        ...
        public static BatchPublicIpAddressConfiguration BatchPublicIpAddressConfiguration(IpAddressProvisioningType? ipAddressProvisioningType = default, IEnumerable<IPFamily> ipFamilies = default, IEnumerable<ResourceIdentifier> ipAddressIds = default, IEnumerable<IPTag> ipTags = default)
        {
            ...
            return new BatchPublicIpAddressConfiguration(ipAddressProvisioningType, ipFamilies.ToList(), ipAddressIds.ToList(), ipTags.ToList(), additionalBinaryDataProperties: null);
        }
        ...
        /// <returns> A new <see cref="Batch.IPTag"/> instance for mocking. </returns>
        public static IPTag IPTag(string ipTagType = default, string tag = default)
        {
            return new IPTag(ipTagType, tag, additionalBinaryDataProperties: null);
        }
        ...
        {
            return new BatchTaskSchedulingPolicy(jobDefaultOrder, nodeFillType, additionalBinaryDataProperties: null);
        }
        ...
        public static BatchPoolUpdateOptions BatchPoolUpdateOptions(string displayName = default, string vmSize = default, bool? enableInterNodeCommunication = default, BatchStartTask startTask = default, IEnumerable<BatchApplicationPackageReference> applicationPackageReferences = default, IEnumerable<BatchMetadataItem> metadata = default, VirtualMachineConfiguration virtualMachineConfiguration = default, int? taskSlotsPerNode = default, BatchTaskSchedulingPolicy taskSchedulingPolicy = default, NetworkConfiguration networkConfiguration = default, IEnumerable<UserAccount> userAccounts = default, IEnumerable<MountConfiguration> mountConfiguration = default, UpgradePolicy upgradePolicy = default)
        {
            applicationPackageReferences ??= new ChangeTrackingList<BatchApplicationPackageReference>();
            metadata ??= new ChangeTrackingList<BatchMetadataItem>();
            userAccounts ??= new ChangeTrackingList<UserAccount>();
        ...
        public static BatchPoolReplaceOptions BatchPoolReplaceOptions(BatchStartTask startTask = default, IEnumerable<BatchApplicationPackageReference> applicationPackageReferences = default, IEnumerable<BatchMetadataItem> metadata = default)
        {
            applicationPackageReferences ??= new ChangeTrackingList<BatchApplicationPackageReference>();
            metadata ??= new ChangeTrackingList<BatchMetadataItem>();

            return new BatchPoolReplaceOptions(startTask, applicationPackageReferences.ToList(), metadata.ToList(), additionalBinaryDataProperties: null);
        }
