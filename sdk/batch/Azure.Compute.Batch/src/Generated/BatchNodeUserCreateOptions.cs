...
{
    /// <summary> Options for creating a user account for RDP or SSH access on an Azure Batch Compute Node. </summary>
    public partial class BatchNodeUserCreateOptions
    {
        /// <summary> Initializes a new instance of BatchNodeUserCreateOptions. </summary>
        ...
        /// <param name="password"> The password of the Account. The password is required for Windows Compute Nodes (those created with 'cloudServiceConfiguration', or created with 'virtualMachineConfiguration' using a Windows Image reference). For Linux Compute Nodes, the password can optionally be specified along with the sshPublicKey property. </param>
        ...
        internal BatchNodeUserCreateOptions(string name, bool? isAdmin, DateTimeOffset? expiryTime, string password, string sshPublicKey)
        {
            Name = name;
            IsAdmin = isAdmin;
        ...
        /// <summary> The password of the Account. The password is required for Windows Compute Nodes (those created with 'cloudServiceConfiguration', or created with 'virtualMachineConfiguration' using a Windows Image reference). For Linux Compute Nodes, the password can optionally be specified along with the sshPublicKey property. </summary>
