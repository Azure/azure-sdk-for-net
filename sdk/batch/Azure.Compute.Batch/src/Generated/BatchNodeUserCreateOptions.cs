...
namespace Azure.Compute.Batch
{
    ...
    public partial class BatchNodeUserCreateOptions
    {
        ...
        internal BatchNodeUserCreateOptions(string name, bool? isAdmin, DateTimeOffset? expiryTime, string password, string sshPublicKey, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Name = name;
            IsAdmin = isAdmin;
