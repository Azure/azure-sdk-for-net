...
namespace Azure.Compute.Batch
{
    ...
    public partial class BatchCertificateDeleteError
    {
        ...
        internal BatchCertificateDeleteError(string code, string message, IList<NameValuePair> values, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Code = code;
            Message = message;
            Values = values;
