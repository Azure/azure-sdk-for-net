...
namespace Azure.Compute.Batch
{
    internal partial class BatchClientGetNodeFilesAsyncCollectionResult : AsyncPageable<BinaryData>
    {
        ...
        public BatchClientGetNodeFilesAsyncCollectionResult(BatchClient client, string poolId, string nodeId, TimeSpan? timeOutInSeconds, DateTimeOffset? ocpDate, int? maxresults, string filter, bool? recursive, RequestContext context) : base(context?.CancellationToken ?? default)
        {
