...
namespace Azure.Batch
{
    internal partial class BatchClientGetPoolNodeCountsAsyncCollectionResult : AsyncPageable<BinaryData>
    {
        ...
        public BatchClientGetPoolNodeCountsAsyncCollectionResult(BatchClient client, int? timeOutInSeconds, string clientRequestId, bool? returnClientRequestId, DateTimeOffset? ocpdate, int? maxresults, string filter, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
