...
namespace Azure.Batch
{
    internal partial class BatchClientGetPoolsCollectionResult : Pageable<BinaryData>
    {
        ...
        public BatchClientGetPoolsCollectionResult(BatchClient client, int? timeOutInSeconds, string clientRequestId, bool? returnClientRequestId, DateTimeOffset? ocpdate, int? maxresults, string filter, IEnumerable<string> @select, IEnumerable<string> expand, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        public override IEnumerable<Page<BinaryData>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            do
            {
                ...
                BatchPoolListResult responseWithType = (BatchPoolListResult)response;
        ...
        {
            HttpMessage message = nextLink != null ? _client.CreateNextListPoolsRequest(nextLink, _timeOutInSeconds, _clientRequestId, _returnClientRequestId, _ocpdate, _maxresults, _filter, _select, _expand, _context) : _client.CreateListPoolsRequest(_timeOutInSeconds, _clientRequestId, _returnClientRequestId, _ocpdate, _maxresults, _filter, _select, _expand, _context);
