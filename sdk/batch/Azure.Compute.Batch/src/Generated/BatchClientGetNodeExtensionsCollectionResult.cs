...
namespace Azure.Batch
{
    internal partial class BatchClientGetNodeExtensionsCollectionResult : Pageable<BinaryData>
    {
        ...
        public BatchClientGetNodeExtensionsCollectionResult(BatchClient client, string poolId, string nodeId, int? timeOutInSeconds, string clientRequestId, bool? returnClientRequestId, DateTimeOffset? ocpdate, int? maxresults, IEnumerable<string> @select, RequestContext context) : base(context?.CancellationToken ?? default)
        {
