...
namespace Azure.Batch
{
    ...
    /// </summary>
    public partial class InboundNatPool : IJsonModel<InboundNatPool>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        InboundNatPool IJsonModel<InboundNatPool>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual InboundNatPool JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<InboundNatPool>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        InboundNatPool IPersistableModel<InboundNatPool>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual InboundNatPool PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<InboundNatPool>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
