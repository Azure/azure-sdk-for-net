...
{
    /// <summary> Options for replacing properties on an Azure Batch Pool. </summary>
    public partial class BatchPoolReplaceOptions
    {
        /// <summary> Initializes a new instance of BatchPoolReplaceOptions. </summary>
        ...
        public BatchPoolReplaceOptions(IEnumerable<CertificateReference> certificateReferences, IEnumerable<ApplicationPackageReference> applicationPackageReferences, IEnumerable<MetadataItem> metadata)
        {
        ...
        internal BatchPoolReplaceOptions(StartTask startTask, IList<CertificateReference> certificateReferences, IList<ApplicationPackageReference> applicationPackageReferences, IList<MetadataItem> metadata, NodeCommunicationMode? targetNodeCommunicationMode)
        {
            StartTask = startTask;
