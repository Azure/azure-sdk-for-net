...
namespace Azure.Compute.Batch
{
    ...
    public partial class BatchJobConstraints
    {
        ...
        /// <summary> Initializes a new instance of <see cref="global::Azure.Compute.Batch.BatchJobConstraints"/>. </summary>
        ...
        internal BatchJobConstraints(TimeSpan? maxWallClockTime, int? maxTaskRetryCount, IDictionary<string, global::System.BinaryData> additionalBinaryDataProperties)
        {
        ...
        /// <summary> The maximum elapsed time that the Job may run, measured from the time the Job is created. If the Job does not complete within the time limit, the Batch service terminates it and any Tasks that are still running. In this case, the termination reason will be MaxWallClockTimeExpiry. If this property is not specified, there is no time limit on how long the Job may run. The time duration is specified in ISO 8601 format. </summary>
