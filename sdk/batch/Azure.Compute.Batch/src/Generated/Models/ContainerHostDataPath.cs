...
namespace Azure.Compute.Batch
{
    ...
    public readonly partial struct ContainerHostDataPath : IEquatable<global::Azure.Compute.Batch.ContainerHostDataPath>
    {
        ...
        /// <summary> Initializes a new instance of <see cref="global::Azure.Compute.Batch.ContainerHostDataPath"/>. </summary>
        ...
        /// <summary> Determines if two <see cref="global::Azure.Compute.Batch.ContainerHostDataPath"/> values are the same. </summary>
        /// <param name="left"> The left value to compare. </param>
        /// <param name="right"> The right value to compare. </param>
        public static bool operator ==(ContainerHostDataPath left, ContainerHostDataPath right) => left.Equals(right);

        /// <summary> Determines if two <see cref="global::Azure.Compute.Batch.ContainerHostDataPath"/> values are not the same. </summary>
        /// <param name="left"> The left value to compare. </param>
        /// <param name="right"> The right value to compare. </param>
        public static bool operator !=(ContainerHostDataPath left, ContainerHostDataPath right) => !left.Equals(right);

        /// <summary> Converts a string to a <see cref="global::Azure.Compute.Batch.ContainerHostDataPath"/>. </summary>
        /// <param name="value"> The value. </param>
        ...
        public override bool Equals(object obj) => ((obj is ContainerHostDataPath other) && this.Equals(other));

        /// <inheritdoc/>
        public bool Equals(ContainerHostDataPath other) => string.Equals(_value, other._value, global::System.StringComparison.InvariantCultureIgnoreCase);
