...
namespace Azure.Compute.Batch
{
    ...
    public partial class BatchNodeCounts : IJsonModel<global::Azure.Compute.Batch.BatchNodeCounts>
    {
        /// <summary> Initializes a new instance of <see cref="global::Azure.Compute.Batch.BatchNodeCounts"/> for deserialization. </summary>
        ...
        {
            string format = (options.Format == "W") ? ((IPersistableModel<global::Azure.Compute.Batch.BatchNodeCounts>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
                    ...
                    {
                        return global::Azure.Compute.Batch.BatchNodeCounts.DeserializeBatchNodeCounts(document.RootElement, options);
                    }
                default:
                    throw new FormatException($"The model {nameof(global::Azure.Compute.Batch.BatchNodeCounts)} does not support reading '{options.Format}' format.");
            }
        }
        ...
        protected virtual BinaryData PersistableModelWriteCore(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(global::Azure.Compute.Batch.BatchNodeCounts)} does not support writing '{options.Format}' format.");
            }
        }

        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<global::Azure.Compute.Batch.BatchNodeCounts>.Write(ModelReaderWriterOptions options) => this.PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        BatchNodeCounts IPersistableModel<global::Azure.Compute.Batch.BatchNodeCounts>.Create(BinaryData data, ModelReaderWriterOptions options) => this.PersistableModelCreateCore(data, options);

        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<global::Azure.Compute.Batch.BatchNodeCounts>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";

        /// <param name="writer"> The JSON writer. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        void IJsonModel<global::Azure.Compute.Batch.BatchNodeCounts>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if ((format != "J"))
            {
                throw new FormatException($"The model {nameof(global::Azure.Compute.Batch.BatchNodeCounts)} does not support writing '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BatchNodeCounts IJsonModel<global::Azure.Compute.Batch.BatchNodeCounts>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => this.JsonModelCreateCore(ref reader, options);
        ...
        protected virtual BatchNodeCounts JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if ((format != "J"))
            {
                throw new FormatException($"The model {nameof(global::Azure.Compute.Batch.BatchNodeCounts)} does not support reading '{format}' format.");
            }
