...
namespace Azure.Compute.Batch
{
    ...
    public partial class InstanceViewStatus
    {
        ...
        internal InstanceViewStatus(string code, string displayStatus, StatusLevelTypes? level, string message, DateTimeOffset? time, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Code = code;
