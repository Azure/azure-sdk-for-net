...
namespace Azure.Compute.Batch
{
    ...
    public partial class BatchJobScheduleStatistics
    {
        ...
        /// <summary> Initializes a new instance of <see cref="global::Azure.Compute.Batch.BatchJobScheduleStatistics"/>. </summary>
        ...
        internal BatchJobScheduleStatistics(global::System.Uri uri, DateTimeOffset startTime, DateTimeOffset lastUpdateTime, TimeSpan userCpuTime, TimeSpan kernelCpuTime, TimeSpan duration, long readIops, long writeIops, float readIoGiB, float writeIoGiB, long succeededTasksCount, long failedTasksCount, long taskRetriesCount, TimeSpan waitTime)
        {
            Uri = uri;
            StartTime = startTime;
