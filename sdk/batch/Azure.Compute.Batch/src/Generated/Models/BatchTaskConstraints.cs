...
namespace Azure.Compute.Batch
{
    ...
    public partial class BatchTaskConstraints
    {
        ...
        /// <summary> Initializes a new instance of <see cref="global::Azure.Compute.Batch.BatchTaskConstraints"/>. </summary>
        ...
        internal BatchTaskConstraints(TimeSpan? maxWallClockTime, TimeSpan? retentionTime, int? maxTaskRetryCount, IDictionary<string, global::System.BinaryData> additionalBinaryDataProperties)
        {
        ...
        /// <summary> The maximum elapsed time that the Task may run, measured from the time the Task starts. If the Task does not complete within the time limit, the Batch service terminates it. If this is not specified, there is no time limit on how long the Task may run. The time duration is specified in ISO 8601 format. </summary>
