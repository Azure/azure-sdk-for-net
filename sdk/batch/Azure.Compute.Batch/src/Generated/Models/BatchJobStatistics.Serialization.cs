...
namespace Azure.Compute.Batch
{
    ...
    public partial class BatchJobStatistics : IJsonModel<global::Azure.Compute.Batch.BatchJobStatistics>
    {
        /// <summary> Initializes a new instance of <see cref="global::Azure.Compute.Batch.BatchJobStatistics"/> for deserialization. </summary>
        ...
        protected virtual BatchJobStatistics PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = (options.Format == "W") ? ((IPersistableModel<global::Azure.Compute.Batch.BatchJobStatistics>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
                    ...
                    {
                        return global::Azure.Compute.Batch.BatchJobStatistics.DeserializeBatchJobStatistics(document.RootElement, options);
                    }
                default:
                    throw new FormatException($"The model {nameof(global::Azure.Compute.Batch.BatchJobStatistics)} does not support reading '{options.Format}' format.");
            }
        }
        ...
        protected virtual BinaryData PersistableModelWriteCore(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(global::Azure.Compute.Batch.BatchJobStatistics)} does not support writing '{options.Format}' format.");
            }
        }

        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<global::Azure.Compute.Batch.BatchJobStatistics>.Write(ModelReaderWriterOptions options) => this.PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        BatchJobStatistics IPersistableModel<global::Azure.Compute.Batch.BatchJobStatistics>.Create(BinaryData data, ModelReaderWriterOptions options) => this.PersistableModelCreateCore(data, options);

        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<global::Azure.Compute.Batch.BatchJobStatistics>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";

        /// <param name="writer"> The JSON writer. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        void IJsonModel<global::Azure.Compute.Batch.BatchJobStatistics>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if ((format != "J"))
            {
                throw new FormatException($"The model {nameof(global::Azure.Compute.Batch.BatchJobStatistics)} does not support writing '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BatchJobStatistics IJsonModel<global::Azure.Compute.Batch.BatchJobStatistics>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => this.JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual BatchJobStatistics JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = (options.Format == "W") ? ((IPersistableModel<global::Azure.Compute.Batch.BatchJobStatistics>)this).GetFormatFromOptions(options) : options.Format;
            if ((format != "J"))
            {
                throw new FormatException($"The model {nameof(global::Azure.Compute.Batch.BatchJobStatistics)} does not support reading '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static BatchJobStatistics DeserializeBatchJobStatistics(JsonElement element, ModelReaderWriterOptions options)
        {
