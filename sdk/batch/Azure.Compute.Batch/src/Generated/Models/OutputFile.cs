...
namespace Azure.Compute.Batch
{
    ...
    public partial class OutputFile
    {
        ...
        internal OutputFile(string filePattern, OutputFileDestination destination, OutputFileUploadConfig uploadOptions, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            FilePattern = filePattern;
            Destination = destination;
            UploadOptions = uploadOptions;
