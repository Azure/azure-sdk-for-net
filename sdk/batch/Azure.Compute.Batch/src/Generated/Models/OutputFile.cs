...
namespace Azure.Compute.Batch
{
    ...
    public partial class OutputFile
    {
        ...
        /// <summary> Initializes a new instance of <see cref="global::Azure.Compute.Batch.OutputFile"/>. </summary>
        ...
        /// <exception cref="global::System.ArgumentNullException"> <paramref name="filePattern"/>, <paramref name="destination"/> or <paramref name="uploadOptions"/> is null. </exception>
        public OutputFile(string filePattern, OutputFileDestination destination, OutputFileUploadConfig uploadOptions)
        {
            global::Azure.Compute.Batch.Argument.AssertNotNull(filePattern, nameof(filePattern));
            global::Azure.Compute.Batch.Argument.AssertNotNull(destination, nameof(destination));
        ...
        internal OutputFile(string filePattern, OutputFileDestination destination, OutputFileUploadConfig uploadOptions, IDictionary<string, global::System.BinaryData> additionalBinaryDataProperties)
        {
            FilePattern = filePattern;
            Destination = destination;
            UploadOptions = uploadOptions;
