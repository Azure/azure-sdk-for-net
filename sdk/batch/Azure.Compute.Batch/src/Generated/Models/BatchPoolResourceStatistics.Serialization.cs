...
namespace Azure.Compute.Batch
{
    ...
    public partial class BatchPoolResourceStatistics : IJsonModel<global::Azure.Compute.Batch.BatchPoolResourceStatistics>
    {
        /// <summary> Initializes a new instance of <see cref="global::Azure.Compute.Batch.BatchPoolResourceStatistics"/> for deserialization. </summary>
        ...
        {
            string format = (options.Format == "W") ? ((IPersistableModel<global::Azure.Compute.Batch.BatchPoolResourceStatistics>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
                    ...
                    {
                        return global::Azure.Compute.Batch.BatchPoolResourceStatistics.DeserializeBatchPoolResourceStatistics(document.RootElement, options);
                    }
                default:
                    throw new FormatException($"The model {nameof(global::Azure.Compute.Batch.BatchPoolResourceStatistics)} does not support reading '{options.Format}' format.");
            }
        }
        ...
        protected virtual BinaryData PersistableModelWriteCore(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(global::Azure.Compute.Batch.BatchPoolResourceStatistics)} does not support writing '{options.Format}' format.");
            }
        }

        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<global::Azure.Compute.Batch.BatchPoolResourceStatistics>.Write(ModelReaderWriterOptions options) => this.PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        BatchPoolResourceStatistics IPersistableModel<global::Azure.Compute.Batch.BatchPoolResourceStatistics>.Create(BinaryData data, ModelReaderWriterOptions options) => this.PersistableModelCreateCore(data, options);

        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<global::Azure.Compute.Batch.BatchPoolResourceStatistics>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";

        /// <param name="writer"> The JSON writer. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        void IJsonModel<global::Azure.Compute.Batch.BatchPoolResourceStatistics>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if ((format != "J"))
            {
                throw new FormatException($"The model {nameof(global::Azure.Compute.Batch.BatchPoolResourceStatistics)} does not support writing '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BatchPoolResourceStatistics IJsonModel<global::Azure.Compute.Batch.BatchPoolResourceStatistics>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => this.JsonModelCreateCore(ref reader, options);
        ...
        protected virtual BatchPoolResourceStatistics JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if ((format != "J"))
            {
                throw new FormatException($"The model {nameof(global::Azure.Compute.Batch.BatchPoolResourceStatistics)} does not support reading '{format}' format.");
            }
