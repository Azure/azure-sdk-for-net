...
namespace Azure.Compute.Batch
{
    ...
    public readonly partial struct BatchNodeState : IEquatable<global::Azure.Compute.Batch.BatchNodeState>
    {
        ...
        /// <summary> Initializes a new instance of <see cref="global::Azure.Compute.Batch.BatchNodeState"/>. </summary>
        ...
        /// <summary> Determines if two <see cref="global::Azure.Compute.Batch.BatchNodeState"/> values are the same. </summary>
        /// <param name="left"> The left value to compare. </param>
        /// <param name="right"> The right value to compare. </param>
        public static bool operator ==(BatchNodeState left, BatchNodeState right) => left.Equals(right);

        /// <summary> Determines if two <see cref="global::Azure.Compute.Batch.BatchNodeState"/> values are not the same. </summary>
        /// <param name="left"> The left value to compare. </param>
        /// <param name="right"> The right value to compare. </param>
        public static bool operator !=(BatchNodeState left, BatchNodeState right) => !left.Equals(right);

        /// <summary> Converts a string to a <see cref="global::Azure.Compute.Batch.BatchNodeState"/>. </summary>
        /// <param name="value"> The value. </param>
        public static implicit operator BatchNodeState(string value) => new BatchNodeState(value);

        /// <summary> Converts a string to a <see cref="global::Azure.Compute.Batch.BatchNodeState"/>. </summary>
        /// <param name="value"> The value. </param>
        public static implicit operator BatchNodeState?(string value) => (value == null) ? null : new BatchNodeState(value);

        /// <inheritdoc/>
        [EditorBrowsableAttribute(global::System.ComponentModel.EditorBrowsableState.Never)]
        public override bool Equals(object obj) => ((obj is BatchNodeState other) && this.Equals(other));

        /// <inheritdoc/>
        public bool Equals(BatchNodeState other) => string.Equals(_value, other._value, global::System.StringComparison.InvariantCultureIgnoreCase);
