...
namespace Azure.Compute.Batch
{
    ...
    public partial class BatchJobStatistics
    {
        ...
        /// <summary> The total user mode CPU time (summed across all cores and all Compute Nodes) consumed by all Tasks in the Job. The time duration is specified in ISO 8601 format. </summary>
        public TimeSpan UserCpuTime { get; }

        /// <summary> The total kernel mode CPU time (summed across all cores and all Compute Nodes) consumed by all Tasks in the Job. The time duration is specified in ISO 8601 format. </summary>
