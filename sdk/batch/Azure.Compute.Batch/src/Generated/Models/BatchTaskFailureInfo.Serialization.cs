...
namespace Azure.Compute.Batch
{
    ...
    public partial class BatchTaskFailureInfo : IJsonModel<BatchTaskFailureInfo>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(BatchTaskFailureInfo)} does not support writing '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BatchTaskFailureInfo IJsonModel<BatchTaskFailureInfo>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);
        ...
        protected virtual BatchTaskFailureInfo JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(BatchTaskFailureInfo)} does not support reading '{format}' format.");
            }
