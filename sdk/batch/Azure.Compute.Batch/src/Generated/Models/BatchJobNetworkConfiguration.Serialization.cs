...
namespace Azure.Compute.Batch
{
    ...
    public partial class BatchJobNetworkConfiguration : IJsonModel<BatchJobNetworkConfiguration>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<BatchJobNetworkConfiguration>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BatchJobNetworkConfiguration IJsonModel<BatchJobNetworkConfiguration>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<BatchJobNetworkConfiguration>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BatchJobNetworkConfiguration IPersistableModel<BatchJobNetworkConfiguration>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
