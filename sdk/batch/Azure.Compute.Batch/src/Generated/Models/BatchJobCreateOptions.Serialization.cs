...
namespace Azure.Compute.Batch
{
    ...
    public partial class BatchJobCreateOptions : IJsonModel<global::Azure.Compute.Batch.BatchJobCreateOptions>
    {
        /// <summary> Initializes a new instance of <see cref="global::Azure.Compute.Batch.BatchJobCreateOptions"/> for deserialization. </summary>
        ...
        {
            string format = (options.Format == "W") ? ((IPersistableModel<global::Azure.Compute.Batch.BatchJobCreateOptions>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
                    ...
                    {
                        return global::Azure.Compute.Batch.BatchJobCreateOptions.DeserializeBatchJobCreateOptions(document.RootElement, options);
                    }
                default:
                    throw new FormatException($"The model {nameof(global::Azure.Compute.Batch.BatchJobCreateOptions)} does not support reading '{options.Format}' format.");
            }
        }
        ...
        protected virtual BinaryData PersistableModelWriteCore(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(global::Azure.Compute.Batch.BatchJobCreateOptions)} does not support writing '{options.Format}' format.");
            }
        }

        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<global::Azure.Compute.Batch.BatchJobCreateOptions>.Write(ModelReaderWriterOptions options) => this.PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        BatchJobCreateOptions IPersistableModel<global::Azure.Compute.Batch.BatchJobCreateOptions>.Create(BinaryData data, ModelReaderWriterOptions options) => this.PersistableModelCreateCore(data, options);

        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<global::Azure.Compute.Batch.BatchJobCreateOptions>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";

        /// <param name="batchJobCreateOptions"> The <see cref="global::Azure.Compute.Batch.BatchJobCreateOptions"/> to serialize into <see cref="global::Azure.Core.RequestContent"/>. </param>
        public static implicit operator RequestContent(BatchJobCreateOptions batchJobCreateOptions)
        {
            ...
            return global::Azure.Core.RequestContent.Create(batchJobCreateOptions, global::Azure.Compute.Batch.ModelSerializationExtensions.WireOptions);
        }

        /// <param name="writer"> The JSON writer. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        void IJsonModel<global::Azure.Compute.Batch.BatchJobCreateOptions>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if ((format != "J"))
            {
                throw new FormatException($"The model {nameof(global::Azure.Compute.Batch.BatchJobCreateOptions)} does not support writing '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BatchJobCreateOptions IJsonModel<global::Azure.Compute.Batch.BatchJobCreateOptions>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => this.JsonModelCreateCore(ref reader, options);
        ...
        protected virtual BatchJobCreateOptions JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if ((format != "J"))
            {
                throw new FormatException($"The model {nameof(global::Azure.Compute.Batch.BatchJobCreateOptions)} does not support reading '{format}' format.");
            }
