...
namespace Azure.Compute.Batch
{
    ...
    public partial class BatchNodeDisableSchedulingOptions : IJsonModel<BatchNodeDisableSchedulingOptions>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(BatchNodeDisableSchedulingOptions)} does not support writing '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BatchNodeDisableSchedulingOptions IJsonModel<BatchNodeDisableSchedulingOptions>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);
        ...
        protected virtual BatchNodeDisableSchedulingOptions JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(BatchNodeDisableSchedulingOptions)} does not support reading '{format}' format.");
            }
