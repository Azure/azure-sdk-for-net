...
namespace Azure.Compute.Batch
{
    ...
    public readonly partial struct BatchNodeDeallocateOption : IEquatable<global::Azure.Compute.Batch.BatchNodeDeallocateOption>
    {
        ...
        /// <summary> Deprecated, we encourage you to upload task data to Azure Storage in your task and use `TaskCompletion` instead. Allow currently running Tasks to complete, then wait for all Task data retention periods to expire. Schedule no new Tasks while waiting. Deallocate the Compute Node when all Task retention periods have expired. </summary>
        private const string RetainedDataValue = "retaineddata";

        /// <summary> Initializes a new instance of <see cref="global::Azure.Compute.Batch.BatchNodeDeallocateOption"/>. </summary>
        ...
        /// <summary> Determines if two <see cref="global::Azure.Compute.Batch.BatchNodeDeallocateOption"/> values are the same. </summary>
        ...
        /// <summary> Determines if two <see cref="global::Azure.Compute.Batch.BatchNodeDeallocateOption"/> values are not the same. </summary>
        /// <param name="left"> The left value to compare. </param>
        /// <param name="right"> The right value to compare. </param>
        public static bool operator !=(BatchNodeDeallocateOption left, BatchNodeDeallocateOption right) => !left.Equals(right);

        /// <summary> Converts a string to a <see cref="global::Azure.Compute.Batch.BatchNodeDeallocateOption"/>. </summary>
        /// <param name="value"> The value. </param>
        public static implicit operator BatchNodeDeallocateOption(string value) => new BatchNodeDeallocateOption(value);

        /// <summary> Converts a string to a <see cref="global::Azure.Compute.Batch.BatchNodeDeallocateOption"/>. </summary>
        /// <param name="value"> The value. </param>
        public static implicit operator BatchNodeDeallocateOption?(string value) => (value == null) ? null : new BatchNodeDeallocateOption(value);

        /// <inheritdoc/>
        [EditorBrowsableAttribute(global::System.ComponentModel.EditorBrowsableState.Never)]
        public override bool Equals(object obj) => ((obj is BatchNodeDeallocateOption other) && this.Equals(other));

        /// <inheritdoc/>
        public bool Equals(BatchNodeDeallocateOption other) => string.Equals(_value, other._value, global::System.StringComparison.InvariantCultureIgnoreCase);
