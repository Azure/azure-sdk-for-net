...
namespace Azure.Compute.Batch
{
    ...
    public partial class BatchJobExecutionInfo
    {
        ...
        internal BatchJobExecutionInfo(DateTimeOffset startTime, DateTimeOffset? endTime, string poolId, BatchJobSchedulingError schedulingError, string terminationReason, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            StartTime = startTime;
            EndTime = endTime;
            PoolId = poolId;
