...
namespace Azure.Batch
{
    internal partial class BatchClientGetApplicationsAsyncCollectionResult : AsyncPageable<BinaryData>
    {
        ...
        public BatchClientGetApplicationsAsyncCollectionResult(BatchClient client, int? timeOutInSeconds, string clientRequestId, bool? returnClientRequestId, DateTimeOffset? ocpdate, int? maxresults, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
