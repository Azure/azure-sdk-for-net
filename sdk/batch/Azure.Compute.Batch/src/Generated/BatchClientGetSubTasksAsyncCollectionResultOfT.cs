...
namespace Azure.Compute.Batch
{
    internal partial class BatchClientGetSubTasksAsyncCollectionResultOfT : AsyncPageable<BatchSubtask>
    {
        ...
        public BatchClientGetSubTasksAsyncCollectionResultOfT(BatchClient client, string jobId, string taskId, TimeSpan? timeOutInSeconds, string clientRequestId, bool? returnClientRequestId, DateTimeOffset? ocpDate, IEnumerable<string> @select, RequestContext context) : base(context?.CancellationToken ?? default)
        {
