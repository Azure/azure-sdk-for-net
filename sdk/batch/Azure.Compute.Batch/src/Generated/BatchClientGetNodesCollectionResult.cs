...
{
    internal partial class BatchClientGetNodesCollectionResult : Pageable<BinaryData>
    {
        ...
        /// <summary> Initializes a new instance of BatchClientGetNodesCollectionResult, which is used to iterate over the pages of a collection. </summary>
        ...
        public BatchClientGetNodesCollectionResult(BatchClient client, string poolId, TimeSpan? timeOutInSeconds, string clientRequestId, bool? returnClientRequestId, DateTimeOffset? ocpDate, int? maxresults, string filter, IEnumerable<string> @select, RequestContext context) : base(context?.CancellationToken ?? default)
        {
        ...
        /// <summary> Gets the pages of BatchClientGetNodesCollectionResult as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of BatchClientGetNodesCollectionResult as an enumerable collection. </returns>
        public override IEnumerable<Page<BinaryData>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            do
            {
                ...
                BatchNodeListResult responseWithType = (BatchNodeListResult)response;
