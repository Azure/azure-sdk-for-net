...
namespace Azure.Batch
{
    ...
    public partial class ImageReference
    {
        ...
        internal ImageReference(string publisher, string offer, string sku, string version, string virtualMachineImageId, string exactVersion, string sharedGalleryImageId, string communityGalleryImageId, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Publisher = publisher;
            Offer = offer;
            Sku = sku;
