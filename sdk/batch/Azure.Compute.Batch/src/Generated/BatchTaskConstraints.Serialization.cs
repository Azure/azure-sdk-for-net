...
{
    public partial class BatchTaskConstraints : IUtf8JsonSerializable, IJsonModel<BatchTaskConstraints>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BatchTaskConstraints>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<BatchTaskConstraints>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<BatchTaskConstraints>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        BatchTaskConstraints IJsonModel<BatchTaskConstraints>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<BatchTaskConstraints>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static BatchTaskConstraints DeserializeBatchTaskConstraints(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new BatchTaskConstraints(maxWallClockTime, retentionTime, maxTaskRetryCount, serializedAdditionalRawData);
        }

        BinaryData IPersistableModel<BatchTaskConstraints>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<BatchTaskConstraints>)this).GetFormatFromOptions(options) : options.Format;
        ...
        BatchTaskConstraints IPersistableModel<BatchTaskConstraints>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<BatchTaskConstraints>)this).GetFormatFromOptions(options) : options.Format;
        ...
        internal static BatchTaskConstraints FromResponse(Response response)
        {
            using var document = JsonDocument.Parse(response.Content);
            return DeserializeBatchTaskConstraints(document.RootElement);
        }
        ...
        internal virtual RequestContent ToRequestContent()
        {
            ...
            content.JsonWriter.WriteObjectValue<BatchTaskConstraints>(this, new ModelReaderWriterOptions("W"));
            return content;
        }
    }
}
