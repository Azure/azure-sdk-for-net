...
namespace Azure.Batch
{
    internal partial class BatchClientGetSupportedImagesCollectionResult : Pageable<BinaryData>
    {
        ...
        public BatchClientGetSupportedImagesCollectionResult(BatchClient client, int? timeOutInSeconds, string clientRequestId, bool? returnClientRequestId, DateTimeOffset? ocpdate, int? maxresults, string filter, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
