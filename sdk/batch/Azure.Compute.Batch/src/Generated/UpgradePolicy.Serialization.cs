...
namespace Azure.Compute.Batch
{
    public partial class UpgradePolicy : IUtf8JsonSerializable, IJsonModel<UpgradePolicy>
    {
        ...
        internal static UpgradePolicy FromResponse(Response response)
        {
            using var document = JsonDocument.Parse(response.Content);
            return DeserializeUpgradePolicy(document.RootElement);
        }
        ...
        internal virtual RequestContent ToRequestContent()
        {
            ...
            content.JsonWriter.WriteObjectValue<UpgradePolicy>(this, new ModelReaderWriterOptions("W"));
            return content;
        }
    }
}
