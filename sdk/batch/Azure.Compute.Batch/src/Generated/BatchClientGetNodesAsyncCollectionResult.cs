...
namespace Azure.Batch
{
    internal partial class BatchClientGetNodesAsyncCollectionResult : AsyncPageable<BinaryData>
    {
        ...
        public BatchClientGetNodesAsyncCollectionResult(BatchClient client, string poolId, int? timeOutInSeconds, string clientRequestId, bool? returnClientRequestId, DateTimeOffset? ocpdate, int? maxresults, string filter, IEnumerable<string> @select, RequestContext context) : base(context?.CancellationToken ?? default)
        {
