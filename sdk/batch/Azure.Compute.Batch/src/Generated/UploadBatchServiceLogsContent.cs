...
namespace Azure.Batch
{
    ...
    public partial class UploadBatchServiceLogsContent
    {
        ...
        internal UploadBatchServiceLogsContent(string containerUrl, DateTimeOffset startTime, DateTimeOffset? endTime, BatchNodeIdentityReference identityReference, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            ContainerUrl = containerUrl;
            StartTime = startTime;
            EndTime = endTime;
