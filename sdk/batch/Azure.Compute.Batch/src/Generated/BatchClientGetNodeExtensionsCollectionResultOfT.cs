...
namespace Azure.Batch
{
    internal partial class BatchClientGetNodeExtensionsCollectionResultOfT : Pageable<BatchNodeVMExtension>
    {
        ...
        public BatchClientGetNodeExtensionsCollectionResultOfT(BatchClient client, string poolId, string nodeId, int? timeOutInSeconds, string clientRequestId, bool? returnClientRequestId, DateTimeOffset? ocpdate, int? maxresults, IEnumerable<string> @select, RequestContext context) : base(context?.CancellationToken ?? default)
        {
