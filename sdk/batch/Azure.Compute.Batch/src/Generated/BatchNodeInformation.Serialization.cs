...
{
    public partial class BatchNodeInformation : IUtf8JsonSerializable
    {
        ...
        internal static BatchNodeInformation DeserializeBatchNodeInformation(JsonElement element)
        {
            ...
            return new BatchNodeInformation(affinityId.Value, nodeUrl.Value, poolId.Value, nodeId.Value, taskRootDirectory.Value, taskRootDirectoryUrl.Value);
        }

        /// <summary> Deserializes the model from a raw response. </summary>
        /// <param name="response"> The response to deserialize the model from. </param>
        internal static BatchNodeInformation FromResponse(Response response)
        {
            using var document = JsonDocument.Parse(response.Content);
            return DeserializeBatchNodeInformation(document.RootElement);
        }
