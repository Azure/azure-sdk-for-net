...
{
    /// <summary> The Azure Batch service log files upload options for a Compute Node. </summary>
    public partial class UploadBatchServiceLogsOptions
    {
        /// <summary> Initializes a new instance of UploadBatchServiceLogsOptions. </summary>
        ...
        public UploadBatchServiceLogsOptions(string containerUrl, DateTimeOffset startTime)
        {
        ...
        internal UploadBatchServiceLogsOptions(string containerUrl, DateTimeOffset startTime, DateTimeOffset? endTime, BatchNodeIdentityReference identityReference)
        {
            ContainerUrl = containerUrl;
            StartTime = startTime;
            EndTime = endTime;
