...
namespace Azure.Batch
{
    ...
    public partial class BatchJobScheduleCreateContent
    {
        ...
        internal BatchJobScheduleCreateContent(string id, string displayName, BatchJobScheduleConfiguration schedule, BatchJobSpecification jobSpecification, IList<MetadataItem> metadata, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Id = id;
