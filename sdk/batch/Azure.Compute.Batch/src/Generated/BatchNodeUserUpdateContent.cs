...
namespace Azure.Batch
{
    ...
    public partial class BatchNodeUserUpdateContent
    {
        ...
        internal BatchNodeUserUpdateContent(string password, DateTimeOffset? expiryTime, string sshPublicKey, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Password = password;
