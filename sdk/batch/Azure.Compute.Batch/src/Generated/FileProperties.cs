...
namespace Azure.Compute.Batch
{
    ...
    public partial class FileProperties
    {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="contentLength"/> is null. </exception>
        internal FileProperties(DateTimeOffset lastModified, string contentLength)
        {
            Argument.AssertNotNull(contentLength, nameof(contentLength));
        ...
        internal FileProperties(DateTimeOffset? creationTime, DateTimeOffset lastModified, string contentLength, string contentType, string fileMode, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
