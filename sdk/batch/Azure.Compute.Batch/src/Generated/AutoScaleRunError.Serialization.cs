...
{
    public partial class AutoScaleRunError : IUtf8JsonSerializable, IJsonModel<AutoScaleRunError>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AutoScaleRunError>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<AutoScaleRunError>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AutoScaleRunError>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        AutoScaleRunError IJsonModel<AutoScaleRunError>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AutoScaleRunError>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static AutoScaleRunError DeserializeAutoScaleRunError(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new AutoScaleRunError(code, message, values ?? new ChangeTrackingList<NameValuePair>(), serializedAdditionalRawData);
        }

        BinaryData IPersistableModel<AutoScaleRunError>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AutoScaleRunError>)this).GetFormatFromOptions(options) : options.Format;
        ...
        AutoScaleRunError IPersistableModel<AutoScaleRunError>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AutoScaleRunError>)this).GetFormatFromOptions(options) : options.Format;
        ...
        internal virtual RequestContent ToRequestContent()
        {
            ...
            content.JsonWriter.WriteObjectValue<AutoScaleRunError>(this, new ModelReaderWriterOptions("W"));
            return content;
        }
    }
}
