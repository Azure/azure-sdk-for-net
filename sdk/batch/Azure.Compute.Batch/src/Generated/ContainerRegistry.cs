...
namespace Azure.Compute.Batch
{
    ...
    public partial class ContainerRegistry
    {
        ...
        internal ContainerRegistry(string username, string password, string registryServer, BatchNodeIdentityReference identityReference, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Username = username;
            Password = password;
