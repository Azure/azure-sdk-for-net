...
namespace Azure.Compute.Batch
{
    internal partial class BatchClientGetNodesAsyncCollectionResultOfT : AsyncPageable<BatchNode>
    {
        ...
        public BatchClientGetNodesAsyncCollectionResultOfT(BatchClient client, string poolId, TimeSpan? timeOutInSeconds, string clientRequestId, bool? returnClientRequestId, DateTimeOffset? ocpDate, int? maxresults, string filter, IEnumerable<string> @select, RequestContext context) : base(context?.CancellationToken ?? default)
        {
        ...
        public override async IAsyncEnumerable<Page<BatchNode>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            do
            {
                ...
                yield return Page<BatchNode>.FromValues((IReadOnlyList<BatchNode>)responseWithType.Value, nextPage?.AbsoluteUri, response);
            }
            while (nextPage != null);
        }
