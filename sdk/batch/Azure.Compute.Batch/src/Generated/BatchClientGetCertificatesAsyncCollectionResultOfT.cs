...
namespace Azure.Compute.Batch
{
    internal partial class BatchClientGetCertificatesAsyncCollectionResultOfT : AsyncPageable<BatchCertificate>
    {
        ...
        public BatchClientGetCertificatesAsyncCollectionResultOfT(BatchClient client, TimeSpan? timeOutInSeconds, string clientRequestId, bool? returnClientRequestId, DateTimeOffset? ocpDate, int? maxresults, string filter, IEnumerable<string> @select, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        public override async IAsyncEnumerable<Page<BatchCertificate>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            do
            {
                ...
                BatchCertificateListResult responseWithType = (BatchCertificateListResult)response;
                nextPage = responseWithType.OdataNextLink;
                yield return Page<BatchCertificate>.FromValues((IReadOnlyList<BatchCertificate>)responseWithType.Value, nextPage?.AbsoluteUri, response);
            }
            while (nextPage != null);
        }
