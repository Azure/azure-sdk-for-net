    ...
    internal partial class BatchClientGetPoolUsageMetricsAsyncCollectionResult : AsyncPageable<BinaryData>
    {
        ...
        public override async IAsyncEnumerable<Page<BinaryData>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            do
            {
                ...
                BatchPoolListUsageMetricsResult responseWithType = (BatchPoolListUsageMetricsResult)response;
