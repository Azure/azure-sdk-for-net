...
namespace Azure.Batch
{
    internal partial class BatchClientGetJobsCollectionResultOfT : Pageable<BatchJob>
    {
        ...
        public BatchClientGetJobsCollectionResultOfT(BatchClient client, int? timeOutInSeconds, string clientRequestId, bool? returnClientRequestId, DateTimeOffset? ocpdate, int? maxresults, string filter, IEnumerable<string> @select, IEnumerable<string> expand, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <returns> The pages of BatchClientGetJobsCollectionResultOfT as an enumerable collection. </returns>
