...
namespace Azure.Compute.Batch
{
    ...
    {
        private static readonly JsonSerializerOptions s_options = new JsonSerializerOptions { Converters = { new JsonModelConverter(WireOptions, AzureComputeBatchContext.Default) } };
