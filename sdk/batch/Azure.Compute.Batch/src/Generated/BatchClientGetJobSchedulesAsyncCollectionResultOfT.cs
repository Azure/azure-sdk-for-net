    ...
    internal partial class BatchClientGetJobSchedulesAsyncCollectionResultOfT : AsyncPageable<BatchJobSchedule>
    {
        ...
        public override async IAsyncEnumerable<Page<BatchJobSchedule>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            do
            {
                ...
                yield return Page<BatchJobSchedule>.FromValues((IReadOnlyList<BatchJobSchedule>)responseWithType.Value, nextPage?.AbsoluteUri, response);
            }
            while (nextPage != null);
        }
