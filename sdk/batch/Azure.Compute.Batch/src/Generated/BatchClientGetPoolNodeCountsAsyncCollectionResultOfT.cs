...
namespace Azure.Compute.Batch
{
    internal partial class BatchClientGetPoolNodeCountsAsyncCollectionResultOfT : AsyncPageable<BatchPoolNodeCounts>
    {
        ...
        public BatchClientGetPoolNodeCountsAsyncCollectionResultOfT(BatchClient client, TimeSpan? timeOutInSeconds, string clientRequestId, bool? returnClientRequestId, DateTimeOffset? ocpDate, int? maxresults, string filter, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        public override async IAsyncEnumerable<Page<BatchPoolNodeCounts>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            do
            {
                ...
                BatchPoolNodeCountsListResult responseWithType = (BatchPoolNodeCountsListResult)response;
                nextPage = responseWithType.OdataNextLink;
                yield return Page<BatchPoolNodeCounts>.FromValues((IReadOnlyList<BatchPoolNodeCounts>)responseWithType.Value, nextPage?.AbsoluteUri, response);
            }
            while (nextPage != null);
        }
