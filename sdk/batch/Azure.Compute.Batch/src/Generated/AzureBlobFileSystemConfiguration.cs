...
namespace Azure.Compute.Batch
{
    ...
    public partial class AzureBlobFileSystemConfiguration
    {
        ...
        internal AzureBlobFileSystemConfiguration(string accountName, string containerName, string accountKey, string sasKey, string blobfuseOptions, string relativeMountPath, BatchNodeIdentityReference identityReference)
        {
            AccountName = accountName;
            ContainerName = containerName;
