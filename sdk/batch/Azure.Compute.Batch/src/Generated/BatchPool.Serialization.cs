    ...
    public partial class BatchPool : IUtf8JsonSerializable, IJsonModel<BatchPool>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (options.Format != "W" && Optional.IsCollectionDefined(ResizeErrors))
            {
                ...
                {
                    ((IJsonModel<ResizeError>)item).Write(writer, options);
                }
            ...
            if (options.Format != "W" && Optional.IsDefined(AutoScaleRun))
            {
                ...
                ((IJsonModel<AutoScaleRun>)AutoScaleRun).Write(writer, options);
            }
            ...
            if (options.Format != "W" && Optional.IsDefined(Stats))
            {
                ...
                ((IJsonModel<BatchPoolStatistics>)Stats).Write(writer, options);
            }
            ...
            if (options.Format != "W" && Optional.IsDefined(Identity))
            {
                ...
                ((IJsonModel<BatchPoolIdentity>)Identity).Write(writer, options);
            }
        ...
        internal static BatchPool DeserializeBatchPool(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("autoScaleRun"u8))
                {
                    ...
                    autoScaleRun = ModelSerializationExtensions.JsonDeserialize<AutoScaleRun>(property.Value);
                    continue;
                }
                ...
                if (property.NameEquals("stats"u8))
                {
                    ...
                    stats = ModelSerializationExtensions.JsonDeserialize<BatchPoolStatistics>(property.Value);
                    continue;
                }
                ...
                if (property.NameEquals("identity"u8))
                {
                    ...
                    identity = ModelSerializationExtensions.JsonDeserialize<BatchPoolIdentity>(property.Value);
                    continue;
                }
