...
{
    public partial class BatchAffinityInfo : IUtf8JsonSerializable, IJsonModel<BatchAffinityInfo>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BatchAffinityInfo>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<BatchAffinityInfo>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        BatchAffinityInfo IJsonModel<BatchAffinityInfo>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<BatchAffinityInfo>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        BinaryData IPersistableModel<BatchAffinityInfo>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<BatchAffinityInfo>)this).GetFormatFromOptions(options) : options.Format;
        ...
        BatchAffinityInfo IPersistableModel<BatchAffinityInfo>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<BatchAffinityInfo>)this).GetFormatFromOptions(options) : options.Format;
