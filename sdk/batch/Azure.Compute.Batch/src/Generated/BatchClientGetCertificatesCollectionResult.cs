...
namespace Azure.Batch
{
    internal partial class BatchClientGetCertificatesCollectionResult : Pageable<BinaryData>
    {
        ...
        public BatchClientGetCertificatesCollectionResult(BatchClient client, int? timeOutInSeconds, string clientRequestId, bool? returnClientRequestId, DateTimeOffset? ocpdate, int? maxresults, string filter, IEnumerable<string> @select, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
