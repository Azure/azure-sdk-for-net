...
{
    /// <summary> Options for updating a user account for RDP or SSH access on an Azure Batch Compute Node. </summary>
    public partial class BatchNodeUserUpdateOptions
    {
        /// <summary> Initializes a new instance of BatchNodeUserUpdateOptions. </summary>
        ...
        internal BatchNodeUserUpdateOptions(string password, DateTimeOffset? expiryTime, string sshPublicKey)
        {
            Password = password;
