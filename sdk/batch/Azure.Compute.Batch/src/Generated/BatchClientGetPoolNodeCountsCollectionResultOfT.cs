...
namespace Azure.Batch
{
    internal partial class BatchClientGetPoolNodeCountsCollectionResultOfT : Pageable<BatchPoolNodeCounts>
    {
        ...
        public BatchClientGetPoolNodeCountsCollectionResultOfT(BatchClient client, int? timeOutInSeconds, string clientRequestId, bool? returnClientRequestId, DateTimeOffset? ocpdate, int? maxresults, string filter, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
