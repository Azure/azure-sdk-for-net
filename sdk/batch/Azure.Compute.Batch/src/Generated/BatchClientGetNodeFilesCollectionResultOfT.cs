...
namespace Azure.Batch
{
    internal partial class BatchClientGetNodeFilesCollectionResultOfT : Pageable<BatchNodeFile>
    {
        ...
        /// <summary> Initializes a new instance of BatchClientGetNodeFilesCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public BatchClientGetNodeFilesCollectionResultOfT(BatchClient client, string poolId, string nodeId, int? timeOutInSeconds, string clientRequestId, bool? returnClientRequestId, DateTimeOffset? ocpdate, int? maxresults, string filter, bool? recursive, RequestContext context) : base(context?.CancellationToken ?? default)
        {
        ...
        /// <summary> Gets the pages of BatchClientGetNodeFilesCollectionResultOfT as an enumerable collection. </summary>
        ...
        public override IEnumerable<Page<BatchNodeFile>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            do
            {
                ...
                yield return Page<BatchNodeFile>.FromValues((IReadOnlyList<BatchNodeFile>)responseWithType.Value, nextPage?.AbsoluteUri, response);
            }
            while (nextPage != null);
        }
