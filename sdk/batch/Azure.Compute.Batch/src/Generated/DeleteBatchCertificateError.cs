...
namespace Azure.Compute.Batch
{
    ...
    public partial class DeleteBatchCertificateError
    {
        ...
        public DeleteBatchCertificateError()
        {
        ...
        internal DeleteBatchCertificateError(string code, string message, IList<NameValuePair> values, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Code = code;
            Message = message;
            Values = values;
