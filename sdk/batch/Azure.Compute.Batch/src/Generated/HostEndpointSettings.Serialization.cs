...
namespace Azure.Compute.Batch
{
    public partial class HostEndpointSettings : IUtf8JsonSerializable, IJsonModel<HostEndpointSettings>
    {
        ...
        internal static HostEndpointSettings DeserializeHostEndpointSettings(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("mode"u8))
                {
                    ...
                    mode = new HostEndpointSettingsModeTypes(property.Value.GetString());
                    continue;
                }
                if (options.Format != "W")
                {
            ...
            return new HostEndpointSettings(inVMAccessControlProfileReferenceId, mode, serializedAdditionalRawData);
        }
        ...
        internal static HostEndpointSettings FromResponse(Response response)
        {
            using var document = JsonDocument.Parse(response.Content, ModelSerializationExtensions.JsonDocumentOptions);
            return DeserializeHostEndpointSettings(document.RootElement);
        }
