...
namespace Azure.Compute.Batch
{
    ...
    public partial class BatchNodeInformation
    {
        /// <summary> Initializes a new instance of BatchNodeInformation. </summary>
        public BatchNodeInformation()
        {
        }
        ...
        internal BatchNodeInformation(string affinityId, string nodeUrl, string poolId, string nodeId, string taskRootDirectory, string taskRootDirectoryUrl)
        {
