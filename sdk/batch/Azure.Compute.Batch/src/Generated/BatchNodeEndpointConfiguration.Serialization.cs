...
namespace Azure.Compute.Batch
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BatchNodeEndpointConfiguration>)this).Write(writer, ModelSerializationExtensions.WireOptions);
