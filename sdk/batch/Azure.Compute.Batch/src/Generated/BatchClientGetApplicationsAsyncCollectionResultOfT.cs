...
namespace Azure.Batch
{
    internal partial class BatchClientGetApplicationsAsyncCollectionResultOfT : AsyncPageable<BatchApplication>
    {
        ...
        public BatchClientGetApplicationsAsyncCollectionResultOfT(BatchClient client, int? timeOutInSeconds, string clientRequestId, bool? returnClientRequestId, DateTimeOffset? ocpdate, int? maxresults, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
