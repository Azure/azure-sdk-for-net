...
{
    internal partial class BatchClientGetApplicationsAsyncCollectionResultOfT : AsyncPageable<BatchApplication>
    {
        ...
        public BatchClientGetApplicationsAsyncCollectionResultOfT(BatchClient client, TimeSpan? timeOutInSeconds, string clientRequestId, bool? returnClientRequestId, DateTimeOffset? ocpDate, int? maxresults, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of BatchClientGetApplicationsAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of BatchClientGetApplicationsAsyncCollectionResultOfT as an enumerable collection. </returns>
        public override async IAsyncEnumerable<Page<BatchApplication>> AsPages(string continuationToken, int? pageSizeHint)
        {
