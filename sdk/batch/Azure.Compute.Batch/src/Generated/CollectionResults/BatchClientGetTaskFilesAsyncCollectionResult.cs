...
{
    internal partial class BatchClientGetTaskFilesAsyncCollectionResult : AsyncPageable<BinaryData>
    {
        ...
        public BatchClientGetTaskFilesAsyncCollectionResult(BatchClient client, string jobId, string taskId, TimeSpan? timeOutInSeconds, DateTimeOffset? ocpDate, int? maxresults, string filter, bool? recursive, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _jobId = jobId;
            _taskId = taskId;
        ...
        /// <returns> The pages of BatchClientGetTaskFilesAsyncCollectionResult as an enumerable collection. </returns>
