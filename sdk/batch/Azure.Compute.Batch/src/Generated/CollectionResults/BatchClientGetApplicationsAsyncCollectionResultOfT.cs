...
namespace Azure.Compute.Batch
{
    internal partial class BatchClientGetApplicationsAsyncCollectionResultOfT : AsyncPageable<BatchApplication>
    {
        ...
        public BatchClientGetApplicationsAsyncCollectionResultOfT(BatchClient client, TimeSpan? timeOutInSeconds, DateTimeOffset? ocpDate, int? maxresults, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        public override async IAsyncEnumerable<Page<BatchApplication>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                yield return Page<BatchApplication>.FromValues((IReadOnlyList<BatchApplication>)result.Value, nextPage?.AbsoluteUri, response);
