...
{
    internal partial class BatchClientGetPoolsCollectionResultOfT : Pageable<global::Azure.Compute.Batch.BatchPool>
    {
        ...
        public override IEnumerable<global::Azure.Page<global::Azure.Compute.Batch.BatchPool>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                yield return global::Azure.Page<BatchPool>.FromValues(((IReadOnlyList<global::Azure.Compute.Batch.BatchPool>)result.Value), (nextPage?.IsAbsoluteUri == true) ? nextPage.AbsoluteUri : nextPage?.OriginalString, response);
