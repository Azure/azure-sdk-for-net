...
{
    internal partial class BatchClientGetPoolsCollectionResultOfT : Pageable<BatchPool>
    {
        ...
        public BatchClientGetPoolsCollectionResultOfT(BatchClient client, TimeSpan? timeOutInSeconds, DateTimeOffset? ocpDate, int? maxresults, string filter, IEnumerable<string> @select, IEnumerable<string> expand, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of BatchClientGetPoolsCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of BatchClientGetPoolsCollectionResultOfT as an enumerable collection. </returns>
        public override IEnumerable<Page<BatchPool>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                BatchPoolListResult result = (BatchPoolListResult)response;
                yield return Page<BatchPool>.FromValues((IReadOnlyList<BatchPool>)result.Value, nextPage?.IsAbsoluteUri == true ? nextPage.AbsoluteUri : nextPage?.OriginalString, response);
        ...
        private Response GetNextResponse(int? pageSizeHint, Uri nextLink)
        {
            ...
            using DiagnosticScope scope = _client.ClientDiagnostics.CreateScope("BatchClient.GetPools");
            scope.Start();
            try
            {
