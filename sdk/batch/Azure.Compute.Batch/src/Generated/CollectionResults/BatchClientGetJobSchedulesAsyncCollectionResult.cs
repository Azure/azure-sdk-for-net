...
namespace Azure.Compute.Batch
{
    internal partial class BatchClientGetJobSchedulesAsyncCollectionResult : AsyncPageable<BinaryData>
    {
        ...
        public BatchClientGetJobSchedulesAsyncCollectionResult(BatchClient client, TimeSpan? timeOutInSeconds, DateTimeOffset? ocpDate, int? maxresults, string filter, IEnumerable<string> @select, IEnumerable<string> expand, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
