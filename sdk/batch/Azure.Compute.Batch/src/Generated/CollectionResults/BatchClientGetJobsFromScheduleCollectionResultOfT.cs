...
namespace Azure.Compute.Batch
{
    internal partial class BatchClientGetJobsFromScheduleCollectionResultOfT : Pageable<BatchJob>
    {
        ...
        /// <summary> Initializes a new instance of BatchClientGetJobsFromScheduleCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public BatchClientGetJobsFromScheduleCollectionResultOfT(BatchClient client, string jobScheduleId, TimeSpan? timeOutInSeconds, DateTimeOffset? ocpDate, int? maxresults, string filter, IEnumerable<string> @select, IEnumerable<string> expand, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of BatchClientGetJobsFromScheduleCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of BatchClientGetJobsFromScheduleCollectionResultOfT as an enumerable collection. </returns>
        public override IEnumerable<Page<BatchJob>> AsPages(string continuationToken, int? pageSizeHint)
        {
        ...
        {
            HttpMessage message = nextLink != null ? _client.CreateNextGetJobsFromScheduleRequest(nextLink, _jobScheduleId, _timeOutInSeconds, _ocpDate, _maxresults, _filter, _select, _expand, _context) : _client.CreateGetJobsFromScheduleRequest(_jobScheduleId, _timeOutInSeconds, _ocpDate, _maxresults, _filter, _select, _expand, _context);
