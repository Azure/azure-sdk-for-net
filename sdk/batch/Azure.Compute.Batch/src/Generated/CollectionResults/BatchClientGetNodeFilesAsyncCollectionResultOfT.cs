...
{
    internal partial class BatchClientGetNodeFilesAsyncCollectionResultOfT : AsyncPageable<BatchNodeFile>
    {
        ...
        /// <summary> Initializes a new instance of BatchClientGetNodeFilesAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public BatchClientGetNodeFilesAsyncCollectionResultOfT(BatchClient client, string poolId, string nodeId, TimeSpan? timeOutInSeconds, DateTimeOffset? ocpDate, int? maxresults, string filter, bool? recursive, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _poolId = poolId;
            _nodeId = nodeId;
        ...
        /// <summary> Gets the pages of BatchClientGetNodeFilesAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of BatchClientGetNodeFilesAsyncCollectionResultOfT as an enumerable collection. </returns>
        public override async IAsyncEnumerable<Page<BatchNodeFile>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                yield return Page<BatchNodeFile>.FromValues((IReadOnlyList<BatchNodeFile>)result.Value, nextPage?.AbsoluteUri, response);
