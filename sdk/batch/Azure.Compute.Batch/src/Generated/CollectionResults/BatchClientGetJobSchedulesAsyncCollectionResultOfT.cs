...
{
    internal partial class BatchClientGetJobSchedulesAsyncCollectionResultOfT : AsyncPageable<global::Azure.Compute.Batch.BatchJobSchedule>
    {
        ...
        public override async IAsyncEnumerable<global::Azure.Page<global::Azure.Compute.Batch.BatchJobSchedule>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                yield return global::Azure.Page<BatchJobSchedule>.FromValues(((IReadOnlyList<global::Azure.Compute.Batch.BatchJobSchedule>)result.Value), (nextPage?.IsAbsoluteUri == true) ? nextPage.AbsoluteUri : nextPage?.OriginalString, response);
