...
namespace Azure.Compute.Batch
{
    internal partial class BatchClientGetPoolNodeCountsCollectionResult : Pageable<BinaryData>
    {
        ...
        public BatchClientGetPoolNodeCountsCollectionResult(BatchClient client, TimeSpan? timeOutInSeconds, DateTimeOffset? ocpDate, int? maxresults, string filter, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
