...
{
    internal partial class BatchClientGetNodeExtensionsCollectionResultOfT : Pageable<global::Azure.Compute.Batch.BatchNodeVMExtension>
    {
        ...
        /// <returns> The pages of BatchClientGetNodeExtensionsCollectionResultOfT as an enumerable collection. </returns>
        public override IEnumerable<global::Azure.Page<global::Azure.Compute.Batch.BatchNodeVMExtension>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                yield return global::Azure.Page<BatchNodeVMExtension>.FromValues(((IReadOnlyList<global::Azure.Compute.Batch.BatchNodeVMExtension>)result.Value), (nextPage?.IsAbsoluteUri == true) ? nextPage.AbsoluteUri : nextPage?.OriginalString, response);
