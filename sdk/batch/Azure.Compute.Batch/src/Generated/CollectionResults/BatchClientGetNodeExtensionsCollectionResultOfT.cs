...
{
    internal partial class BatchClientGetNodeExtensionsCollectionResultOfT : Pageable<BatchNodeVMExtension>
    {
        ...
        public override IEnumerable<Page<BatchNodeVMExtension>> AsPages(string continuationToken, int? pageSizeHint)
        {
