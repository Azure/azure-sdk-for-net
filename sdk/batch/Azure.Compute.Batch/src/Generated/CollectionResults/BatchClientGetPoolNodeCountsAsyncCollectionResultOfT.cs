...
{
    internal partial class BatchClientGetPoolNodeCountsAsyncCollectionResultOfT : AsyncPageable<global::Azure.Compute.Batch.BatchPoolNodeCounts>
    {
        ...
        /// <summary> Gets the pages of BatchClientGetPoolNodeCountsAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of BatchClientGetPoolNodeCountsAsyncCollectionResultOfT as an enumerable collection. </returns>
        public override async IAsyncEnumerable<global::Azure.Page<global::Azure.Compute.Batch.BatchPoolNodeCounts>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                yield return global::Azure.Page<BatchPoolNodeCounts>.FromValues(((IReadOnlyList<global::Azure.Compute.Batch.BatchPoolNodeCounts>)result.Value), (nextPage?.IsAbsoluteUri == true) ? nextPage.AbsoluteUri : nextPage?.OriginalString, response);
