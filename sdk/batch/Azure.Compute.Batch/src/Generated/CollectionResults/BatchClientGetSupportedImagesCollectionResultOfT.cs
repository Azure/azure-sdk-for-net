...
{
    internal partial class BatchClientGetSupportedImagesCollectionResultOfT : Pageable<global::Azure.Compute.Batch.BatchSupportedImage>
    {
        ...
        public override IEnumerable<global::Azure.Page<global::Azure.Compute.Batch.BatchSupportedImage>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                yield return global::Azure.Page<BatchSupportedImage>.FromValues(((IReadOnlyList<global::Azure.Compute.Batch.BatchSupportedImage>)result.Value), (nextPage?.IsAbsoluteUri == true) ? nextPage.AbsoluteUri : nextPage?.OriginalString, response);
