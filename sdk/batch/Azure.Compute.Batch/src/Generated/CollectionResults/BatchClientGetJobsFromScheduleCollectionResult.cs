...
namespace Azure.Compute.Batch
{
    internal partial class BatchClientGetJobsFromScheduleCollectionResult : Pageable<BinaryData>
    {
        ...
        public BatchClientGetJobsFromScheduleCollectionResult(BatchClient client, string jobScheduleId, TimeSpan? timeOutInSeconds, DateTimeOffset? ocpDate, int? maxresults, string filter, IEnumerable<string> @select, IEnumerable<string> expand, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
