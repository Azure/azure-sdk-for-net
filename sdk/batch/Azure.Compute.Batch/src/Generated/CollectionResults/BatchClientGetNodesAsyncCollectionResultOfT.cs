...
{
    internal partial class BatchClientGetNodesAsyncCollectionResultOfT : AsyncPageable<global::Azure.Compute.Batch.BatchNode>
    {
        ...
        public override async IAsyncEnumerable<global::Azure.Page<global::Azure.Compute.Batch.BatchNode>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                yield return global::Azure.Page<BatchNode>.FromValues(((IReadOnlyList<global::Azure.Compute.Batch.BatchNode>)result.Value), (nextPage?.IsAbsoluteUri == true) ? nextPage.AbsoluteUri : nextPage?.OriginalString, response);
