...
namespace Azure.Compute.Batch
{
    internal partial class BatchClientGetPoolNodeCountsAsyncCollectionResult : AsyncPageable<BinaryData>
    {
        ...
        public BatchClientGetPoolNodeCountsAsyncCollectionResult(BatchClient client, TimeSpan? timeOutInSeconds, DateTimeOffset? ocpDate, int? maxresults, string filter, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
