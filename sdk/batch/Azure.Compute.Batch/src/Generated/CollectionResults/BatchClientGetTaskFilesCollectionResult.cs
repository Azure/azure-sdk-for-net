...
{
    internal partial class BatchClientGetTaskFilesCollectionResult : Pageable<BinaryData>
    {
        ...
        /// <summary> Initializes a new instance of BatchClientGetTaskFilesCollectionResult, which is used to iterate over the pages of a collection. </summary>
        ...
        public BatchClientGetTaskFilesCollectionResult(BatchClient client, string jobId, string taskId, TimeSpan? timeOutInSeconds, DateTimeOffset? ocpDate, int? maxresults, string filter, bool? recursive, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _jobId = jobId;
            _taskId = taskId;
        ...
        /// <summary> Gets the pages of BatchClientGetTaskFilesCollectionResult as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of BatchClientGetTaskFilesCollectionResult as an enumerable collection. </returns>
