...
{
    internal partial class BatchClientGetTasksCollectionResultOfT : Pageable<global::Azure.Compute.Batch.BatchTask>
    {
        ...
        public override IEnumerable<global::Azure.Page<global::Azure.Compute.Batch.BatchTask>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                yield return global::Azure.Page<BatchTask>.FromValues(((IReadOnlyList<global::Azure.Compute.Batch.BatchTask>)result.Value), (nextPage?.IsAbsoluteUri == true) ? nextPage.AbsoluteUri : nextPage?.OriginalString, response);
