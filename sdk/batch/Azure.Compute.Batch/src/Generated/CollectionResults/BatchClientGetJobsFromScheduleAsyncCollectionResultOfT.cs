...
namespace Azure.Compute.Batch
{
    internal partial class BatchClientGetJobsFromScheduleAsyncCollectionResultOfT : AsyncPageable<BatchJob>
    {
        ...
        public BatchClientGetJobsFromScheduleAsyncCollectionResultOfT(BatchClient client, string jobScheduleId, TimeSpan? timeOutInSeconds, DateTimeOffset? ocpDate, int? maxresults, string filter, IEnumerable<string> @select, IEnumerable<string> expand, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
