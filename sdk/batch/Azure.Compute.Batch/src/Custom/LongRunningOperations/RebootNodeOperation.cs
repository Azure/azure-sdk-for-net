...
namespace Azure.Compute.Batch
{
    ...
    /// </summary>
    public class RebootNodeOperation : Operation<BatchNode>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new <see cref="RebootNodeOperation"/> instance
        /// </summary>
        /// <param name="client">
        /// The client used to check for completion.
        /// </param>
        ...
        /// <summary>
        /// Initializes a new <see cref="RebootNodeOperation"/> instance for
        /// mocking.
        /// </summary>
        ...
        private async Task<Response> UpdateStatusAsync(bool async, CancellationToken cancellationToken)
        {
            ...
            if (response != null)
            {
                ...
                if (response.Value.State != BatchNodeState.Rebooting)
                {
                    _hasValue = true;
