...
namespace Azure.Compute.Batch
{
    ...
    /// </summary>
    public class StopPoolResizeOperation : Operation<BatchPool>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new <see cref="StopPoolResizeOperation"/> instance
        /// </summary>
        /// <param name="client">
        /// The client used to check for completion.
        /// </param>
        ...
        /// </param>
        internal StopPoolResizeOperation(
            BatchClient client,
            string resizeId,
        ...
        public StopPoolResizeOperation(
            BatchClient client,
            string id)
        {
        ...
        /// <summary>
        /// Initializes a new <see cref="StopPoolResizeOperation"/> instance for
        /// mocking.
        /// </summary>
