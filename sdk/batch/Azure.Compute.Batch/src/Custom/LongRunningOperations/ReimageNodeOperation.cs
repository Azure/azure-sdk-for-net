...
namespace Azure.Compute.Batch
{
    ...
    /// </summary>
    public class ReimageNodeOperation : Operation<BatchNode>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new <see cref="ReimageNodeOperation"/> instance
        /// </summary>
        /// <param name="client">
        /// The client used to check for completion.
        /// </param>
        ...
        /// <summary>
        /// Initializes a new <see cref="ReimageNodeOperation"/> instance for
        /// mocking.
        /// </summary>
        ...
        private async Task<Response> UpdateStatusAsync(bool async, CancellationToken cancellationToken)
        {
            ...
            if (response != null)
            {
                ...
                if (response.Value.State != BatchNodeState.Reimaging)
                {
                    _hasValue = true;
