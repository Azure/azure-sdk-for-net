...
{
    /// <summary>
    /// Upon success a Job will be disabled
    /// </summary>
    public class DisableJobOperation : Operation<BatchJob>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new <see cref="DisableJobOperation"/> instance
        /// </summary>
        /// <param name="client">
        /// The client used to check for completion.
        /// </param>
        ...
        /// <summary>
        /// Initializes a new <see cref="DisableJobOperation"/> instance for
        /// mocking.
        /// </summary>
        ...
        private async Task<Response> UpdateStatusAsync(bool async, CancellationToken cancellationToken)
        {
            ...
            if (response != null)
            {
                ...
                if (response.Value.State != BatchJobState.Disabling)
                {
                    _hasValue = true;
