...
namespace Azure.Compute.Batch.Models
{
    ...
    {
        /// <summary> Initializes a new instance of PoolListOptions. </summary>
        public PoolListOptions()
        {
        }

        /// <summary> An OData $filter clause. For more information on constructing this filter, see https://docs.microsoft.com/en-us/rest/api/batchservice/odata-filters-in-batch#list-pools. </summary>
        public string Filter { get; set; }
        /// <summary> An OData $select clause. </summary>
        public string Select { get; set; }
        /// <summary> An OData $expand clause. </summary>
        public string Expand { get; set; }
        /// <summary> The maximum number of items to return in the response. A maximum of 1000 Pools can be returned. </summary>
