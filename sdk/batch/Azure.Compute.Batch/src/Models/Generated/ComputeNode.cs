...
namespace Azure.Compute.Batch.Models
{
    ...
    public partial class ComputeNode
    {
        ...
        /// <summary> Every Compute Node that is added to a Pool is assigned a unique ID. Whenever a Compute Node is removed from a Pool, all of its local files are deleted, and the ID is reclaimed and could be reused for new Compute Nodes. </summary>
        ...
        /// <summary> This is the time when the Compute Node was initially allocated and doesn&apos;t change once set. It is not updated when the Compute Node is service healed or preempted. </summary>
        public DateTimeOffset? AllocationTime { get; }
        /// <summary> Every Compute Node that is added to a Pool is assigned a unique IP address. Whenever a Compute Node is removed from a Pool, all of its local files are deleted, and the IP address is reclaimed and could be reused for new Compute Nodes. </summary>
        public string IpAddress { get; }
        /// <summary> Note that this is just a soft affinity. If the target Compute Node is busy or unavailable at the time the Task is scheduled, then the Task will be scheduled elsewhere. </summary>
        ...
        /// <summary> This property is present only if at least one Task has run on this Compute Node since it was assigned to the Pool. </summary>
        ...
        /// <summary> The Batch Compute Node agent is a program that runs on each Compute Node in the Pool and provides Batch capability on the Compute Node. </summary>
