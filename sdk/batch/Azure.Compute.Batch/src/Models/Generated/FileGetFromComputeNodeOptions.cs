...
namespace Azure.Compute.Batch.Models
{
    ...
    {
        /// <summary> Initializes a new instance of FileGetFromComputeNodeOptions. </summary>
        ...
        /// <summary> The byte range to be retrieved. The default is to retrieve the entire file. The format is bytes=startRange-endRange. </summary>
