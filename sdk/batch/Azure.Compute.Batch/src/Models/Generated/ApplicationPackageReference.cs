...
namespace Azure.Compute.Batch.Models
{
    ...
    public partial class ApplicationPackageReference
    {
        ...
        /// <summary> Initializes a new instance of ApplicationPackageReference. </summary>
        /// <param name="applicationId"> The ID of the application to deploy. </param>
        /// <param name="version"> If this is omitted on a Pool, and no default version is specified for this application, the request fails with the error code InvalidApplicationPackageReferences and HTTP status code 409. If this is omitted on a Task, and no default version is specified for this application, the Task fails with a pre-processing error. </param>
        ...
        /// <summary> The ID of the application to deploy. </summary>
        public string ApplicationId { get; set; }
        /// <summary> If this is omitted on a Pool, and no default version is specified for this application, the request fails with the error code InvalidApplicationPackageReferences and HTTP status code 409. If this is omitted on a Task, and no default version is specified for this application, the Task fails with a pre-processing error. </summary>
