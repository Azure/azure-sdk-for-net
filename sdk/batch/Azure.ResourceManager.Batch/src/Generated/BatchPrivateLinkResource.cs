...
namespace Azure.ResourceManager.Batch
{
    ...
    public partial class BatchPrivateLinkResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of BatchPrivateLinkResource for mocking. </summary>
        protected BatchPrivateLinkResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="BatchPrivateLinkResource"/> class. </summary>
        ...
        {
            string resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Batch/batchAccounts/{accountName}/privateLinkResources/{privateLinkResourceName}";
        ...
        {
            using DiagnosticScope scope = _privateLinkResourceClientDiagnostics.CreateScope("BatchPrivateLinkResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _privateLinkResourceRestClient.CreateGetRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, context);
