...
namespace Azure.ResourceManager.Batch
{
    ...
    public partial class BatchAccountDetectorData : ResourceData
    {
        ...
        internal BatchAccountDetectorData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, DetectorResponseProperties properties, ETag? eTag, IDictionary<string, string> tags, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, name, resourceType, systemData)
        {
