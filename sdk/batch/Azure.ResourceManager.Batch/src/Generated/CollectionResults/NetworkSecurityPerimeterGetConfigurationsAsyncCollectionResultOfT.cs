...
{
    internal partial class NetworkSecurityPerimeterGetConfigurationsAsyncCollectionResultOfT : AsyncPageable<NetworkSecurityPerimeterConfigurationData>
    {
        ...
        /// <summary> Initializes a new instance of NetworkSecurityPerimeterGetConfigurationsAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        /// <param name="client"> The NetworkSecurityPerimeter client used to send requests. </param>
        ...
        public NetworkSecurityPerimeterGetConfigurationsAsyncCollectionResultOfT(NetworkSecurityPerimeter client, Guid subscriptionId, string resourceGroupName, string accountName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of NetworkSecurityPerimeterGetConfigurationsAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of NetworkSecurityPerimeterGetConfigurationsAsyncCollectionResultOfT as an enumerable collection. </returns>
