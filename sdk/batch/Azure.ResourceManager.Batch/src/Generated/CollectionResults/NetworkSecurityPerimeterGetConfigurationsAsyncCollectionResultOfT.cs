...
namespace Azure.ResourceManager.Batch
{
    internal partial class NetworkSecurityPerimeterGetConfigurationsAsyncCollectionResultOfT : AsyncPageable<NetworkSecurityPerimeterConfigurationData>
    {
        ...
        public NetworkSecurityPerimeterGetConfigurationsAsyncCollectionResultOfT(NetworkSecurityPerimeter client, Guid subscriptionId, string resourceGroupName, string accountName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
