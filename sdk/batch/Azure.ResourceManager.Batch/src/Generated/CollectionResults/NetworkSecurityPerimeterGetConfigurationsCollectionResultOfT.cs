...
namespace Azure.ResourceManager.Batch
{
    internal partial class NetworkSecurityPerimeterGetConfigurationsCollectionResultOfT : Pageable<NetworkSecurityPerimeterConfigurationData>
    {
        ...
        /// <summary> Initializes a new instance of NetworkSecurityPerimeterGetConfigurationsCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public NetworkSecurityPerimeterGetConfigurationsCollectionResultOfT(NetworkSecurityPerimeter client, Guid subscriptionId, string resourceGroupName, string accountName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of NetworkSecurityPerimeterGetConfigurationsCollectionResultOfT as an enumerable collection. </summary>
