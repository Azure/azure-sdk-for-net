...
namespace Azure.ResourceManager.Batch
{
    internal partial class NetworkSecurityPerimeterGetConfigurationsCollectionResultOfT : Pageable<NetworkSecurityPerimeterConfiguration>
    {
        ...
        public NetworkSecurityPerimeterGetConfigurationsCollectionResultOfT(NetworkSecurityPerimeter client, Guid subscriptionId, string resourceGroupName, string accountName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
