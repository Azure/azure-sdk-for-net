...
namespace Azure.ResourceManager.Batch
{
    internal partial class LocationGetBatchSupportedVirtualMachineSkusAsyncCollectionResultOfT : AsyncPageable<BatchSupportedSku>
    {
        ...
        public LocationGetBatchSupportedVirtualMachineSkusAsyncCollectionResultOfT(Location client, Guid subscriptionId, AzureLocation locationName, int? maxresults, string filter, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
