...
{
    internal partial class PoolGetByBatchAccountCollectionResultOfT : Pageable<BatchAccountPoolData>
    {
        ...
        /// <returns> The pages of PoolGetByBatchAccountCollectionResultOfT as an enumerable collection. </returns>
        public override IEnumerable<Page<BatchAccountPoolData>> AsPages(string continuationToken, int? pageSizeHint)
        {
