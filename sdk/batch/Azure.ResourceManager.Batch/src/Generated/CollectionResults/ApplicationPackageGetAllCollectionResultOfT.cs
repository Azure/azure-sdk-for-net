...
{
    internal partial class ApplicationPackageGetAllCollectionResultOfT : Pageable<BatchApplicationPackageData>
    {
        ...
        /// <returns> The pages of ApplicationPackageGetAllCollectionResultOfT as an enumerable collection. </returns>
        public override IEnumerable<Page<BatchApplicationPackageData>> AsPages(string continuationToken, int? pageSizeHint)
        {
