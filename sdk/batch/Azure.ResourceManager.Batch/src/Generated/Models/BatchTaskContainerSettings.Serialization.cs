...
{
    public partial class BatchTaskContainerSettings : IUtf8JsonSerializable, IJsonModel<BatchTaskContainerSettings>, IPersistableModel<BatchTaskContainerSettings>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ContainerRunOptions))
            {
                builder.Append("  containerRunOptions:");
                builder.AppendLine($" '{ContainerRunOptions}'");
            }
            ...
            if (Optional.IsDefined(Registry))
            {
                ...
                AppendChildObject(builder, Registry, options, 2);
            }

            if (Optional.IsDefined(WorkingDirectory))
            {
                builder.Append("  workingDirectory:");
                builder.AppendLine($" '{WorkingDirectory.ToString()}'");
            }
