...
namespace Azure.ResourceManager.Batch.Models
{
    ...
    public partial class BatchNfsMountConfiguration
    {
        ...
        internal BatchNfsMountConfiguration(string source, string relativeMountPath, string mountOptions, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Source = source;
            RelativeMountPath = relativeMountPath;
