...
namespace Azure.ResourceManager.Batch.Models
{
    ...
    public partial class BatchVmDataDisk
    {
        ...
        internal BatchVmDataDisk(int lun, BatchDiskCachingType? caching, int diskSizeInGB, BatchStorageAccountType? storageAccountType, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Lun = lun;
            Caching = caching;
            DiskSizeInGB = diskSizeInGB;
