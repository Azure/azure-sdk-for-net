...
namespace Azure.ResourceManager.Batch.Models
{
    ...
    public partial class BatchAccountOutboundEnvironmentEndpoint
    {
        ...
        internal BatchAccountOutboundEnvironmentEndpoint(string category, IReadOnlyList<BatchAccountEndpointDependency> endpoints, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Category = category;
            Endpoints = endpoints;
