...
namespace Azure.ResourceManager.Batch.Models
{
    ...
    public partial class BatchAccountPoolStartTask
    {
        ...
        internal BatchAccountPoolStartTask(string commandLine, IList<BatchResourceFile> resourceFiles, IList<BatchEnvironmentSetting> environmentSettings, BatchUserIdentity userIdentity, int? maxTaskRetryCount, bool? waitForSuccess, BatchTaskContainerSettings containerSettings, Dictionary<string, BinaryData> rawData)
        {
