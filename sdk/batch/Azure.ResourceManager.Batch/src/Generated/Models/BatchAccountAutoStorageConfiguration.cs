...
namespace Azure.ResourceManager.Batch.Models
{
    ...
    public partial class BatchAccountAutoStorageConfiguration : BatchAccountAutoStorageBaseConfiguration
    {
        ...
        public BatchAccountAutoStorageConfiguration(ResourceIdentifier storageAccountId, DateTimeOffset lastKeySync) : base(storageAccountId)
        {
        ...
        /// <param name="lastKeySync"> The UTC time at which storage keys were last synchronized with the Batch account. </param>
        internal BatchAccountAutoStorageConfiguration(ResourceIdentifier storageAccountId, BatchAutoStorageAuthenticationMode? authenticationMode, ComputeNodeIdentityReference nodeIdentity, DateTimeOffset lastKeySync) : base(storageAccountId, authenticationMode, nodeIdentity)
        {
            LastKeySync = lastKeySync;
        }
