...
namespace Azure.ResourceManager.Batch.Models
{
    ...
    public partial class BatchAccountAutoStorageConfiguration : BatchAccountAutoStorageBaseConfiguration
    {
        ...
        internal BatchAccountAutoStorageConfiguration(ResourceIdentifier storageAccountId, BatchAutoStorageAuthenticationMode? authenticationMode, ComputeNodeIdentityReference nodeIdentity, DateTimeOffset lastKeySyncedOn, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(storageAccountId, authenticationMode, nodeIdentity, serializedAdditionalRawData)
        {
            LastKeySyncedOn = lastKeySyncedOn;
        }
