...
{
    public partial class BatchAccountPoolScaleSettings : IUtf8JsonSerializable, IJsonModel<BatchAccountPoolScaleSettings>, IPersistableModel<BatchAccountPoolScaleSettings>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(FixedScale))
            {
                builder.Append("  fixedScale:");
                AppendChildObject(builder, FixedScale, options, 2);
            }
