...
{
    public partial class BatchVmContainerConfiguration : IUtf8JsonSerializable, IJsonModel<BatchVmContainerConfiguration>, IPersistableModel<BatchVmContainerConfiguration>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(ContainerImageNames))
            {
                builder.Append("  containerImageNames:");
                builder.AppendLine(" [");
                foreach (var item in ContainerImageNames)
                {
                    if (item == null)
