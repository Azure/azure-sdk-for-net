...
{
    public partial class BatchIPRule : IUtf8JsonSerializable, IJsonModel<BatchIPRule>, IPersistableModel<BatchIPRule>
    {
        ...
        void IJsonModel<BatchIPRule>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(BatchIPRule)} does not support '{format}' format.");
            }
