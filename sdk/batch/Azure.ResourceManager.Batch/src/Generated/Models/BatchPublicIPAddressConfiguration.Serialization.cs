...
{
    public partial class BatchPublicIPAddressConfiguration : IUtf8JsonSerializable, IJsonModel<BatchPublicIPAddressConfiguration>, IPersistableModel<BatchPublicIPAddressConfiguration>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Provision))
            {
                ...
                builder.AppendLine($" '{Provision.ToString()}'");
            }

            if (Optional.IsCollectionDefined(IPAddressIds))
            {
                builder.Append("  ipAddressIds:");
                builder.AppendLine(" [");
                foreach (var item in IPAddressIds)
                {
                    if (item == null)
