...
{
    public partial class BatchUserIdentity : IUtf8JsonSerializable, IJsonModel<BatchUserIdentity>, IPersistableModel<BatchUserIdentity>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(AutoUser))
            {
                builder.Append("  autoUser:");
                AppendChildObject(builder, AutoUser, options, 2);
            }
