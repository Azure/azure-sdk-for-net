...
namespace Azure.ResourceManager.Batch.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ListApplicationsResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ListApplicationsResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ListApplicationsResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ListApplicationsResult>)} interface");
            }
        ...
        string IPersistableModel<ListApplicationsResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
