...
namespace Azure.ResourceManager.Batch.Models
{
    internal static partial class BatchPrivateEndpointConnectionProvisioningStateExtensions
    {
        ...
        public static BatchPrivateEndpointConnectionProvisioningState ToBatchPrivateEndpointConnectionProvisioningState(this string value)
        {
            ...
            {
                return BatchPrivateEndpointConnectionProvisioningState.Creating;
            }
            if (StringComparer.OrdinalIgnoreCase.Equals(value, "Updating"))
            {
                return BatchPrivateEndpointConnectionProvisioningState.Updating;
            }
            if (StringComparer.OrdinalIgnoreCase.Equals(value, "Deleting"))
            {
                return BatchPrivateEndpointConnectionProvisioningState.Deleting;
            }
            if (StringComparer.OrdinalIgnoreCase.Equals(value, "Succeeded"))
            {
                return BatchPrivateEndpointConnectionProvisioningState.Succeeded;
            }
            if (StringComparer.OrdinalIgnoreCase.Equals(value, "Failed"))
            {
                return BatchPrivateEndpointConnectionProvisioningState.Failed;
            }
            if (StringComparer.OrdinalIgnoreCase.Equals(value, "Cancelled"))
            {
                return BatchPrivateEndpointConnectionProvisioningState.Cancelled;
            }
