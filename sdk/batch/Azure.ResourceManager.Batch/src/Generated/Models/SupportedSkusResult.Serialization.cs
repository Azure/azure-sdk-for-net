...
namespace Azure.ResourceManager.Batch.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SupportedSkusResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SupportedSkusResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SupportedSkusResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SupportedSkusResult>)} interface");
            }
        ...
        SupportedSkusResult IJsonModel<SupportedSkusResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        SupportedSkusResult IPersistableModel<SupportedSkusResult>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == "J" || options.Format == "W";
            if (!isValid)
            {
        ...
        string IPersistableModel<SupportedSkusResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
