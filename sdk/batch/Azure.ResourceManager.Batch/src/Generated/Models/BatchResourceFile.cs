...
namespace Azure.ResourceManager.Batch.Models
{
    ...
    public partial class BatchResourceFile
    {
        ...
        internal BatchResourceFile(string autoStorageContainerName, Uri storageContainerUri, Uri httpUri, string blobPrefix, string filePath, string fileMode, ComputeNodeIdentityReference identity)
        {
