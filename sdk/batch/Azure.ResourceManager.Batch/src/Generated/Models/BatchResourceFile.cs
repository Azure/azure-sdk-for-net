...
namespace Azure.ResourceManager.Batch.Models
{
    ...
    public partial class BatchResourceFile
    {
        ...
        internal BatchResourceFile(string autoBlobContainerName, Uri blobContainerUri, Uri httpUri, string blobPrefix, string filePath, string fileMode, ComputeNodeIdentityReference identity, Dictionary<string, BinaryData> rawData)
        {
