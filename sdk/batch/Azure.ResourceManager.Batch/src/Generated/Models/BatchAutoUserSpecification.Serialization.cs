...
namespace Azure.ResourceManager.Batch.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BatchAutoUserSpecification>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<BatchAutoUserSpecification>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BatchAutoUserSpecification>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<BatchAutoUserSpecification>)} interface");
            }
        ...
        string IPersistableModel<BatchAutoUserSpecification>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
