...
namespace Azure.ResourceManager.Batch.Models
{
    ...
    {
        internal static BatchAccountEndpointDependency DeserializeBatchAccountEndpointDependency(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
