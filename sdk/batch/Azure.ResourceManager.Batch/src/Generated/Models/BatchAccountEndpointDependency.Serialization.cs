...
namespace Azure.ResourceManager.Batch.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BatchAccountEndpointDependency>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<BatchAccountEndpointDependency>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BatchAccountEndpointDependency>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<BatchAccountEndpointDependency>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
