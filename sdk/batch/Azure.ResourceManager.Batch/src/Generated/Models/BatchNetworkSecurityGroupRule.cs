...
namespace Azure.ResourceManager.Batch.Models
{
    ...
    public partial class BatchNetworkSecurityGroupRule
    {
        ...
        internal BatchNetworkSecurityGroupRule(int priority, BatchNetworkSecurityGroupRuleAccess access, string sourceAddressPrefix, IList<string> sourcePortRanges, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Priority = priority;
            Access = access;
            SourceAddressPrefix = sourceAddressPrefix;
        ...
        /// <summary> Valid values are '<i>' (for all ports 0 - 65535) or arrays of ports or port ranges (i.e. 100-200). The ports should in the range of 0 to 65535 and the port ranges or ports can't overlap. If any other values are provided the request fails with HTTP status code 400. Default value will be </i>. </summary>
