...
namespace Azure.ResourceManager.Batch.Models
{
    ...
    public partial class BatchNetworkSecurityGroupRule
    {
        ...
        internal BatchNetworkSecurityGroupRule(int priority, BatchNetworkSecurityGroupRuleAccess access, string sourceAddressPrefix, IList<string> sourcePortRanges, Dictionary<string, BinaryData> rawData)
        {
            Priority = priority;
            Access = access;
            SourceAddressPrefix = sourceAddressPrefix;
