...
{
    public partial class BatchAccountCertificateCreateOrUpdateContent : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static BatchAccountCertificateCreateOrUpdateContent DeserializeBatchAccountCertificateCreateOrUpdateContent(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
