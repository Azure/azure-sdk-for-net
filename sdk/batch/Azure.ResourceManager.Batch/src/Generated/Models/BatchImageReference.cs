...
namespace Azure.ResourceManager.Batch.Models
{
    ...
    public partial class BatchImageReference
    {
        ...
        internal BatchImageReference(string publisher, string offer, string sku, string version, ResourceIdentifier id, string sharedGalleryImageId, string communityGalleryImageId, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Publisher = publisher;
            Offer = offer;
            Sku = sku;
