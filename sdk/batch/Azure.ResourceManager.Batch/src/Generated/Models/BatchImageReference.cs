...
namespace Azure.ResourceManager.Batch.Models
{
    ...
    public partial class BatchImageReference
    {
        ...
        internal BatchImageReference(string publisher, string offer, string sku, string version, ResourceIdentifier id, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Publisher = publisher;
            Offer = offer;
            Sku = sku;
