...
namespace Azure.ResourceManager.Batch.Models
{
    ...
    {
        internal static ListPrivateLinkResourcesResult DeserializeListPrivateLinkResourcesResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
