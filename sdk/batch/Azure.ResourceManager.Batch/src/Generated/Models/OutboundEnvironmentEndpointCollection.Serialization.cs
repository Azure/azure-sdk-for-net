...
namespace Azure.ResourceManager.Batch.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<OutboundEnvironmentEndpointCollection>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<OutboundEnvironmentEndpointCollection>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<OutboundEnvironmentEndpointCollection>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<OutboundEnvironmentEndpointCollection>)} interface");
            }
        ...
        string IPersistableModel<OutboundEnvironmentEndpointCollection>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
