...
{
    public partial class BatchUefiSettings : IUtf8JsonSerializable, IJsonModel<BatchUefiSettings>, IPersistableModel<BatchUefiSettings>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(IsVTpmEnabled))
            {
                builder.Append("  vTpmEnabled:");
                var boolValue = IsVTpmEnabled.Value == true ? "true" : "false";
                builder.AppendLine($" {boolValue}");
            }
