...
namespace Azure.ResourceManager.Batch.Models
{
    internal partial class ListPrivateEndpointConnectionsResult
    {
        internal static ListPrivateEndpointConnectionsResult DeserializeListPrivateEndpointConnectionsResult(JsonElement element)
        {
            ...
            Core.Optional<IReadOnlyList<BatchPrivateEndpointConnectionData>> value = default;
            ...
            return new ListPrivateEndpointConnectionsResult(Core.Optional.ToList(value), nextLink.Value);
        }
    }
}
