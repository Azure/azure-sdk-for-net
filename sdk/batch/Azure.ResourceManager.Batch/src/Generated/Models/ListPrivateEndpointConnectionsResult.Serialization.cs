...
namespace Azure.ResourceManager.Batch.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ListPrivateEndpointConnectionsResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ListPrivateEndpointConnectionsResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ListPrivateEndpointConnectionsResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ListPrivateEndpointConnectionsResult>)} interface");
            }
        ...
        string IPersistableModel<ListPrivateEndpointConnectionsResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
