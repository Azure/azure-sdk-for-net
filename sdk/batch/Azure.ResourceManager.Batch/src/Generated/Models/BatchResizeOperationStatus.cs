...
namespace Azure.ResourceManager.Batch.Models
{
    ...
    public partial class BatchResizeOperationStatus
    {
        ...
        /// <param name="startsOn"> The time when this resize operation was started. </param>
        ...
        internal BatchResizeOperationStatus(int? targetDedicatedNodes, int? targetLowPriorityNodes, TimeSpan? resizeTimeout, BatchNodeDeallocationOption? nodeDeallocationOption, DateTimeOffset? startsOn, IReadOnlyList<ResponseError> errors, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
