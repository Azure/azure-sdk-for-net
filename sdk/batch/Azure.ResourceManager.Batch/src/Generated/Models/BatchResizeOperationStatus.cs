...
namespace Azure.ResourceManager.Batch.Models
{
    ...
    public partial class BatchResizeOperationStatus
    {
        ...
        internal BatchResizeOperationStatus(int? targetDedicatedNodes, int? targetLowPriorityNodes, TimeSpan? resizeTimeout, BatchNodeDeallocationOption? nodeDeallocationOption, DateTimeOffset? startOn, IReadOnlyList<ResponseError> errors, Dictionary<string, BinaryData> rawData)
        {
