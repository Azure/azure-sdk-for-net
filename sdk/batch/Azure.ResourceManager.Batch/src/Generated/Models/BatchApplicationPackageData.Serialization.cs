    ...
    public partial class BatchApplicationPackageData : IUtf8JsonSerializable, IJsonModel<BatchApplicationPackageData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(StorageUriExpireOn))
            {
                ...
                var formattedDateTimeString = TypeFormatters.ToString(StorageUriExpireOn.Value, "o");
            ...
            if (Optional.IsDefined(LastActivatedOn))
            {
                ...
                var formattedDateTimeString = TypeFormatters.ToString(LastActivatedOn.Value, "o");
                builder.AppendLine($" '{formattedDateTimeString}'");
            }
