...
{
    public partial class BatchApplicationPackageData : IUtf8JsonSerializable, IJsonModel<BatchApplicationPackageData>, IPersistableModel<BatchApplicationPackageData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  storageUrlExpiry:");
                builder.AppendLine($" '{StorageUriExpireOn.Value.ToString()}'");
            }

            if (Optional.IsDefined(LastActivatedOn))
            {
                builder.Append("  lastActivationTime:");
                builder.AppendLine($" '{LastActivatedOn.Value.ToString()}'");
            }
