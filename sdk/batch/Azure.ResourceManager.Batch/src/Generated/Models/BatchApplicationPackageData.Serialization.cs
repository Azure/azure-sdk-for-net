...
namespace Azure.ResourceManager.Batch
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BatchApplicationPackageData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<BatchApplicationPackageData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BatchApplicationPackageData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<BatchApplicationPackageData>)} interface");
            }
        ...
        string IPersistableModel<BatchApplicationPackageData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
