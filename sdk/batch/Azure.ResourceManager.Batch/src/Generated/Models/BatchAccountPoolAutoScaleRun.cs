...
namespace Azure.ResourceManager.Batch.Models
{
    ...
    public partial class BatchAccountPoolAutoScaleRun
    {
        ...
        internal BatchAccountPoolAutoScaleRun(DateTimeOffset evaluationOn, string results, ResponseError error, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            EvaluationOn = evaluationOn;
            Results = results;
            Error = error;
