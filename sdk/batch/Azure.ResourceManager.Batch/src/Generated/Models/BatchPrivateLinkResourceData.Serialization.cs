...
{
    public partial class BatchPrivateLinkResourceData : Core.IUtf8JsonSerializable
    {
        ...
        internal static BatchPrivateLinkResourceData DeserializeBatchPrivateLinkResourceData(JsonElement element)
        {
            ...
            return new BatchPrivateLinkResourceData(id, name, type, systemData.Value, groupId.Value, Core.Optional.ToList(requiredMembers), Core.Optional.ToList(requiredZoneNames), Core.Optional.ToNullable(etag));
        }
    }
}
