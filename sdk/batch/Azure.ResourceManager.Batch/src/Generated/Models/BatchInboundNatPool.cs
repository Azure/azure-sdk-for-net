...
namespace Azure.ResourceManager.Batch.Models
{
    ...
    public partial class BatchInboundNatPool
    {
        ...
        internal BatchInboundNatPool(string name, BatchInboundEndpointProtocol protocol, int backendPort, int frontendPortRangeStart, int frontendPortRangeEnd, IList<BatchNetworkSecurityGroupRule> networkSecurityGroupRules, Dictionary<string, BinaryData> rawData)
        {
            Name = name;
            Protocol = protocol;
            BackendPort = backendPort;
