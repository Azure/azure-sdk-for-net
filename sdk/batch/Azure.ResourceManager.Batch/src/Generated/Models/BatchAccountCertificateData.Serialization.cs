...
{
    public partial class BatchAccountCertificateData : IUtf8JsonSerializable, IJsonModel<BatchAccountCertificateData>, IPersistableModel<BatchAccountCertificateData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(DeleteCertificateError))
            {
                ...
                AppendChildObject(builder, DeleteCertificateError, options, 2);
            }
