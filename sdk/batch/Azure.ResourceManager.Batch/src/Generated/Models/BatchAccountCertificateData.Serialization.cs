...
namespace Azure.ResourceManager.Batch
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BatchAccountCertificateData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<BatchAccountCertificateData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BatchAccountCertificateData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<BatchAccountCertificateData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
