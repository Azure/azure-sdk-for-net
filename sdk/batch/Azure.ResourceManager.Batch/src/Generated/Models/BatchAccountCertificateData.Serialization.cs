...
namespace Azure.ResourceManager.Batch
{
    public partial class BatchAccountCertificateData : IUtf8JsonSerializable, IJsonModel<BatchAccountCertificateData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ThumbprintAlgorithm))
            {
                builder.Append("    thumbprintAlgorithm:");
                if (ThumbprintAlgorithm.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
                    builder.AppendLine($"{ThumbprintAlgorithm}'''");
                }
                else
                {
                    builder.AppendLine($" '{ThumbprintAlgorithm}'");
            ...
            if (Optional.IsDefined(Format))
            {
                ...
                builder.AppendLine($" '{Format.Value.ToSerialString()}'");
            }
            ...
            {
                builder.Append("    provisioningStateTransitionTime:");
                var formattedDateTimeString = TypeFormatters.ToString(ProvisioningStateTransitOn.Value, "o");
                builder.AppendLine($" '{formattedDateTimeString}'");
            }

            if (Optional.IsDefined(PreviousProvisioningState))
            {
                builder.Append("    previousProvisioningState:");
                builder.AppendLine($" '{PreviousProvisioningState.Value.ToString()}'");
            }

            if (Optional.IsDefined(PreviousProvisioningStateTransitOn))
            {
                builder.Append("    previousProvisioningStateTransitionTime:");
                var formattedDateTimeString = TypeFormatters.ToString(PreviousProvisioningStateTransitOn.Value, "o");
                builder.AppendLine($" '{formattedDateTimeString}'");
            }
            ...
            if (Optional.IsDefined(PublicData))
            {
                ...
                if (PublicData.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
                    builder.AppendLine($"{PublicData}'''");
                }
                else
                {
                    builder.AppendLine($" '{PublicData}'");
            ...
            {
                builder.Append("    deleteCertificateError:");
                AppendChildObject(builder, DeleteCertificateError, options, 4, false);
            }
