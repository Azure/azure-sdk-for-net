...
{
    public partial class BatchOSDisk : IUtf8JsonSerializable, IJsonModel<BatchOSDisk>, IPersistableModel<BatchOSDisk>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(EphemeralOSDiskSettings))
            {
                builder.Append("  ephemeralOSDiskSettings:");
                AppendChildObject(builder, EphemeralOSDiskSettings, options, 2);
            }
            ...
            if (Optional.IsDefined(IsWriteAcceleratorEnabled))
            {
                ...
                var boolValue = IsWriteAcceleratorEnabled.Value == true ? "true" : "false";
