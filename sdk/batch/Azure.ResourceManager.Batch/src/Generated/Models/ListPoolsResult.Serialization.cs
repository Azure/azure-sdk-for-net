...
namespace Azure.ResourceManager.Batch.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ListPoolsResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ListPoolsResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ListPoolsResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ListPoolsResult>)} interface");
            }
        ...
        string IPersistableModel<ListPoolsResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
