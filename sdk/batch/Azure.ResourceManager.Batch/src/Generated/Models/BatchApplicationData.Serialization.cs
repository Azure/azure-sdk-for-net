...
namespace Azure.ResourceManager.Batch
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BatchApplicationData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<BatchApplicationData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BatchApplicationData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<BatchApplicationData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
