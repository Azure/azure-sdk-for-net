...
{
    public partial class BatchNetworkConfiguration : IUtf8JsonSerializable, IJsonModel<BatchNetworkConfiguration>, IPersistableModel<BatchNetworkConfiguration>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(EndpointConfiguration))
            {
                ...
                AppendChildObject(builder, EndpointConfiguration, options, 2);
            }
