...
namespace Azure.ResourceManager.Batch.Models
{
    public partial class BatchHostEndpointSettings : IUtf8JsonSerializable, IJsonModel<BatchHostEndpointSettings>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<ListCertificatesResult>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual ListCertificatesResult PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<ListCertificatesResult>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
