...
namespace Azure.ResourceManager.Batch.Models
{
    ...
    public partial class BatchUserAccount
    {
        ...
        internal BatchUserAccount(string name, string password, BatchUserAccountElevationLevel? elevationLevel, BatchLinuxUserConfiguration linuxUserConfiguration, BatchWindowsUserConfiguration windowsUserConfiguration, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Password = password;
