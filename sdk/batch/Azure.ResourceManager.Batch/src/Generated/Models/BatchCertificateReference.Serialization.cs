...
{
    public partial class BatchCertificateReference : IUtf8JsonSerializable, IJsonModel<BatchCertificateReference>, IPersistableModel<BatchCertificateReference>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(StoreLocation))
            {
                ...
                builder.AppendLine($" '{StoreLocation.ToString()}'");
            }
