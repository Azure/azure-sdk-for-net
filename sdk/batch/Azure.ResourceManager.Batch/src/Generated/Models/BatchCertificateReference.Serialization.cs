...
namespace Azure.ResourceManager.Batch.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BatchCertificateReference>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<BatchCertificateReference>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BatchCertificateReference>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<BatchCertificateReference>)} interface");
            }
        ...
        string IPersistableModel<BatchCertificateReference>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
