...
namespace Azure.ResourceManager.Batch.Models
{
    ...
    public partial class BatchPrivateLinkServiceConnectionState
    {
        ...
        internal BatchPrivateLinkServiceConnectionState(BatchPrivateLinkServiceConnectionStatus status, string description, string actionRequired, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Status = status;
