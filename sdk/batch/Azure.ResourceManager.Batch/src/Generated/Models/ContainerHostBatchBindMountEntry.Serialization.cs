...
namespace Azure.ResourceManager.Batch.Models
{
    ...
    public partial class ContainerHostBatchBindMountEntry : IJsonModel<ContainerHostBatchBindMountEntry>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ContainerHostBatchBindMountEntry IJsonModel<ContainerHostBatchBindMountEntry>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ContainerHostBatchBindMountEntry>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
