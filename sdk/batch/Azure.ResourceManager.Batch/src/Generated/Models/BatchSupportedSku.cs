...
namespace Azure.ResourceManager.Batch.Models
{
    ...
    public partial class BatchSupportedSku
    {
        ...
        internal BatchSupportedSku(string name, string familyName, IReadOnlyList<BatchSkuCapability> capabilities, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
