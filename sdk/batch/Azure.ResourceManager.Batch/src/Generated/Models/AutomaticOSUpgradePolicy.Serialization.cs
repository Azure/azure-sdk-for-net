...
namespace Azure.ResourceManager.Batch.Models
{
    public partial class AutomaticOSUpgradePolicy : IUtf8JsonSerializable, IJsonModel<AutomaticOSUpgradePolicy>
    {
        ...
        internal static AutomaticOSUpgradePolicy DeserializeAutomaticOSUpgradePolicy(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new AutomaticOSUpgradePolicy(Optional.ToNullable(disableAutomaticRollback), Optional.ToNullable(enableAutomaticOSUpgrade), Optional.ToNullable(useRollingUpgradePolicy), Optional.ToNullable(osRollingUpgradeDeferral), serializedAdditionalRawData);
        }
