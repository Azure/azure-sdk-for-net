...
{
    public partial class BatchInboundNatPool : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static BatchInboundNatPool DeserializeBatchInboundNatPool(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
