...
namespace Azure.ResourceManager.Batch.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BatchInboundNatPool>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<BatchInboundNatPool>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BatchInboundNatPool>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<BatchInboundNatPool>)} interface");
            }
        ...
        string IPersistableModel<BatchInboundNatPool>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
