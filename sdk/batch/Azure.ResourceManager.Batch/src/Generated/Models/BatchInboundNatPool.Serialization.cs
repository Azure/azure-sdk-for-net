...
{
    public partial class BatchInboundNatPool : IUtf8JsonSerializable, IJsonModel<BatchInboundNatPool>, IPersistableModel<BatchInboundNatPool>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(FrontendPortRangeStart))
            {
                ...
                builder.AppendLine($" '{FrontendPortRangeStart.ToString()}'");
            }

            if (Optional.IsDefined(FrontendPortRangeEnd))
            {
                builder.Append("  frontendPortRangeEnd:");
                builder.AppendLine($" '{FrontendPortRangeEnd.ToString()}'");
            }

            if (Optional.IsCollectionDefined(NetworkSecurityGroupRules))
            {
                builder.Append("  networkSecurityGroupRules:");
                builder.AppendLine(" [");
                foreach (var item in NetworkSecurityGroupRules)
                {
