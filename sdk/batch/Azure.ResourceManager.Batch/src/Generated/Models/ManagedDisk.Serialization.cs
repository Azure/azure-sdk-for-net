...
{
    internal partial class ManagedDisk : IUtf8JsonSerializable, IJsonModel<ManagedDisk>, IPersistableModel<ManagedDisk>
    {
        ...
        void IJsonModel<ManagedDisk>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ManagedDisk)} does not support '{format}' format.");
            }
        ...
        internal static ManagedDisk DeserializeManagedDisk(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new ManagedDisk(Optional.ToNullable(storageAccountType), serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<ManagedDisk>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ManagedDisk)} does not support '{options.Format}' format.");
            }
        }
