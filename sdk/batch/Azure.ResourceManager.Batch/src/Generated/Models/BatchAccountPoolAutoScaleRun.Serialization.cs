...
namespace Azure.ResourceManager.Batch.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BatchAccountPoolAutoScaleRun>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<BatchAccountPoolAutoScaleRun>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BatchAccountPoolAutoScaleRun>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<BatchAccountPoolAutoScaleRun>)} interface");
            }
        ...
        string IPersistableModel<BatchAccountPoolAutoScaleRun>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
