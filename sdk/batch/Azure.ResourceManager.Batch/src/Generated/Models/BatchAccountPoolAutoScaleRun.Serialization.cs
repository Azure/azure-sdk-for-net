...
{
    public partial class BatchAccountPoolAutoScaleRun : IUtf8JsonSerializable, IJsonModel<BatchAccountPoolAutoScaleRun>, IPersistableModel<BatchAccountPoolAutoScaleRun>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(EvaluationOn))
            {
                ...
                builder.AppendLine($" '{EvaluationOn.ToString()}'");
            }
