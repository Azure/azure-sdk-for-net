...
namespace Azure.ResourceManager.Batch.Models
{
    ...
    {
        internal static BatchAccountPoolAutoScaleRun DeserializeBatchAccountPoolAutoScaleRun(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
