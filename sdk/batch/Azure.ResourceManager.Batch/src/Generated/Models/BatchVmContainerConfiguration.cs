...
namespace Azure.ResourceManager.Batch.Models
{
    ...
    public partial class BatchVmContainerConfiguration
    {
        ...
        internal BatchVmContainerConfiguration(BatchVmContainerType containerType, IList<string> containerImageNames, IList<BatchVmContainerRegistry> containerRegistries, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ContainerType = containerType;
