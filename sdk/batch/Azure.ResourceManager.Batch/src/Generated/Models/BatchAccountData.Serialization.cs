...
{
    public partial class BatchAccountData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static BatchAccountData DeserializeBatchAccountData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
