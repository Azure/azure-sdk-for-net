...
namespace Azure.ResourceManager.Batch.Models
{
    ...
    public partial class BatchCifsMountConfiguration
    {
        ...
        internal BatchCifsMountConfiguration(string username, string source, string relativeMountPath, string mountOptions, string password, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Username = username;
            Source = source;
            RelativeMountPath = relativeMountPath;
