...
namespace Azure.ResourceManager.Batch.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BatchAccountAutoScaleSettings>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<BatchAccountAutoScaleSettings>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BatchAccountAutoScaleSettings>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<BatchAccountAutoScaleSettings>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
