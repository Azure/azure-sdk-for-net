...
{
    public partial class BatchLinuxUserConfiguration : IUtf8JsonSerializable, IJsonModel<BatchLinuxUserConfiguration>, IPersistableModel<BatchLinuxUserConfiguration>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  uid:");
                builder.AppendLine($" '{Uid.Value.ToString()}'");
            }

            if (Optional.IsDefined(Gid))
            {
                builder.Append("  gid:");
                builder.AppendLine($" '{Gid.Value.ToString()}'");
            }
