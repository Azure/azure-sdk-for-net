...
{
    public partial class BatchLocationQuota : IUtf8JsonSerializable, IJsonModel<BatchLocationQuota>, IPersistableModel<BatchLocationQuota>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  accountQuota:");
                builder.AppendLine($" '{AccountQuota.Value.ToString()}'");
            }
