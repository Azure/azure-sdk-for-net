...
namespace Azure.ResourceManager.Batch.Models
{
    public partial class BatchPoolIdentity : IUtf8JsonSerializable, IJsonModel<BatchPoolIdentity>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            writer.WriteStringValue(PoolIdentityType.ToSerialString());
        ...
        internal static BatchPoolIdentity DeserializeBatchPoolIdentity(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("userAssignedIdentities"u8))
                {
                    ...
                    {
                        dictionary.Add(property0.Name, ModelReaderWriter.Read<UserAssignedIdentity>(new BinaryData(Encoding.UTF8.GetBytes(property0.Value.GetRawText())), options, AzureResourceManagerBatchContext.Default));
                    }
            ...
            return new BatchPoolIdentity(type, userAssignedIdentities ?? new ChangeTrackingDictionary<string, UserAssignedIdentity>(), serializedAdditionalRawData);
        }
