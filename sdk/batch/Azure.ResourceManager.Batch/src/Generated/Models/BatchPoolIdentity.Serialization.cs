    ...
    public partial class BatchPoolIdentity : IJsonModel<BatchPoolIdentity>
    {
        ...
        internal static BatchPoolIdentity DeserializeBatchPoolIdentity(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    @type = prop.Value.GetString().ToPoolIdentityType();
                    continue;
                }
            ...
            return new BatchPoolIdentity(@type, userAssignedIdentities ?? new ChangeTrackingDictionary<string, UserAssignedIdentities>(), additionalBinaryDataProperties);
        }
