...
{
    public partial class BatchNetworkProfile : IUtf8JsonSerializable, IJsonModel<BatchNetworkProfile>, IPersistableModel<BatchNetworkProfile>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(AccountAccess))
            {
                ...
                AppendChildObject(builder, AccountAccess, options, 2);
            }

            if (Optional.IsDefined(NodeManagementAccess))
            {
                builder.Append("  nodeManagementAccess:");
                AppendChildObject(builder, NodeManagementAccess, options, 2);
            }
