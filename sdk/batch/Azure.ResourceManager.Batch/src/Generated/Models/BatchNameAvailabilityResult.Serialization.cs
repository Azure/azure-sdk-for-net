...
namespace Azure.ResourceManager.Batch.Models
{
    ...
    {
        internal static BatchNameAvailabilityResult DeserializeBatchNameAvailabilityResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
