...
namespace Azure.ResourceManager.Batch.Models
{
    ...
    public partial class BatchFileShareConfiguration
    {
        ...
        internal BatchFileShareConfiguration(string accountName, Uri fileUri, string accountKey, string relativeMountPath, string mountOptions, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            AccountName = accountName;
            FileUri = fileUri;
            AccountKey = accountKey;
