...
namespace Azure.ResourceManager.Batch.Models
{
    ...
    public partial class BatchFileShareConfiguration
    {
        ...
        /// <param name="uri"> This is of the form 'https://{account}.file.core.windows.net/'. </param>
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="accountName"/>, <paramref name="uri"/>, <paramref name="accountKey"/> or <paramref name="relativeMountPath"/> is null. </exception>
        public BatchFileShareConfiguration(string accountName, string uri, string accountKey, string relativeMountPath)
        {
        ...
        internal BatchFileShareConfiguration(string accountName, string uri, string accountKey, string relativeMountPath, string mountOptions, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            AccountName = accountName;
            Uri = uri;
            AccountKey = accountKey;
