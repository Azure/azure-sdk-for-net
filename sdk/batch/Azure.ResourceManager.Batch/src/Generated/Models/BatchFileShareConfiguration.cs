...
namespace Azure.ResourceManager.Batch.Models
{
    ...
    public partial class BatchFileShareConfiguration
    {
        ...
        public BatchFileShareConfiguration(string accountName, string fileUri, string accountKey, string relativeMountPath)
        {
        ...
        internal BatchFileShareConfiguration(string accountName, string fileUri, string accountKey, string relativeMountPath, string mountOptions, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            AccountName = accountName;
            FileUri = fileUri;
            AccountKey = accountKey;
