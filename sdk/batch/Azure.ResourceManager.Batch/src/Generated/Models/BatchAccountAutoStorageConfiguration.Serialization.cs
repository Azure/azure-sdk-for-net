...
{
    public partial class BatchAccountAutoStorageConfiguration : IUtf8JsonSerializable, IJsonModel<BatchAccountAutoStorageConfiguration>, IPersistableModel<BatchAccountAutoStorageConfiguration>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(LastKeySyncedOn))
            {
                builder.Append("  lastKeySync:");
                builder.AppendLine($" '{LastKeySyncedOn.ToString()}'");
            }
