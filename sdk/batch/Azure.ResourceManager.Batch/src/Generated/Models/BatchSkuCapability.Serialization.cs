...
namespace Azure.ResourceManager.Batch.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BatchSkuCapability>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<BatchSkuCapability>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BatchSkuCapability>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<BatchSkuCapability>)} interface");
            }
        ...
        string IPersistableModel<BatchSkuCapability>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
