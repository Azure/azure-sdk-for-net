...
namespace Azure.ResourceManager.Batch
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BatchAccountPoolData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<BatchAccountPoolData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BatchAccountPoolData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<BatchAccountPoolData>)} interface");
            }
        ...
        string IPersistableModel<BatchAccountPoolData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
