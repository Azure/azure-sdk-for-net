...
{
    public partial class BatchUserAccount : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static BatchUserAccount DeserializeBatchUserAccount(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
