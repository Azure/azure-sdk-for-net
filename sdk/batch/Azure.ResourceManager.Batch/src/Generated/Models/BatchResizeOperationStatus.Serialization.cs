...
namespace Azure.ResourceManager.Batch.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BatchResizeOperationStatus>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<BatchResizeOperationStatus>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BatchResizeOperationStatus>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<BatchResizeOperationStatus>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
