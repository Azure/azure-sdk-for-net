...
namespace Azure.ResourceManager.Batch.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BatchAccountOutboundEnvironmentEndpoint>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<BatchAccountOutboundEnvironmentEndpoint>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BatchAccountOutboundEnvironmentEndpoint>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<BatchAccountOutboundEnvironmentEndpoint>)} interface");
            }
        ...
        string IPersistableModel<BatchAccountOutboundEnvironmentEndpoint>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
