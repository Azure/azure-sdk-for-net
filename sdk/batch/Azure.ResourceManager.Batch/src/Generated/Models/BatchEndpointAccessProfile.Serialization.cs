...
namespace Azure.ResourceManager.Batch.Models
{
    public partial class BatchEndpointAccessProfile : IUtf8JsonSerializable, IJsonModel<BatchEndpointAccessProfile>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<BatchEndpointAccessProfile>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<BatchEndpointAccessProfile>)} interface");
            }
