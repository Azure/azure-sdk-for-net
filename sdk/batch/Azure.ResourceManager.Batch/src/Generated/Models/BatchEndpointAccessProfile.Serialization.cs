...
namespace Azure.ResourceManager.Batch.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BatchEndpointAccessProfile>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<BatchEndpointAccessProfile>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BatchEndpointAccessProfile>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<BatchEndpointAccessProfile>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
