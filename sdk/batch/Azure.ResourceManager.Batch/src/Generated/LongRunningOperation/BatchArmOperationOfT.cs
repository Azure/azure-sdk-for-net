...
namespace Azure.ResourceManager.Batch
{
    internal partial class BatchArmOperation<T> : ArmOperation<T>
    {
        ...
        internal BatchArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
