...
{
    /// <summary></summary>
    internal partial class BatchPrivateEndpointConnectionResourceOperationSource : IOperationSource<BatchPrivateEndpointConnectionResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal BatchPrivateEndpointConnectionResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
