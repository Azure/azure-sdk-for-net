...
{
    /// <summary></summary>
    internal partial class BatchPrivateEndpointConnectionOperationSource : IOperationSource<BatchPrivateEndpointConnectionResource>
    {
        ...
        BatchPrivateEndpointConnectionResource IOperationSource<BatchPrivateEndpointConnectionResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            BatchPrivateEndpointConnectionData data = BatchPrivateEndpointConnectionData.DeserializeBatchPrivateEndpointConnectionData(document.RootElement, ModelSerializationExtensions.WireOptions);
