...
namespace Azure.ResourceManager.Batch.Mocking
{
    ...
    internal partial class BatchArmClientMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="BatchArmClientMockingExtension"/> class for mocking. </summary>
        protected BatchArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="BatchArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal BatchArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal BatchArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
