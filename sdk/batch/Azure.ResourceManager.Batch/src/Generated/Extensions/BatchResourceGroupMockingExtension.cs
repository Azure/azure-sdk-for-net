...
namespace Azure.ResourceManager.Batch.Mocking
{
    ...
    internal partial class BatchResourceGroupMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="BatchResourceGroupMockingExtension"/> class for mocking. </summary>
        protected BatchResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="BatchResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal BatchResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
