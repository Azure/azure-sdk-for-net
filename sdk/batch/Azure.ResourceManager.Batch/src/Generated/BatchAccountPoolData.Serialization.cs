...
namespace Azure.ResourceManager.Batch
{
    ...
    public partial class BatchAccountPoolData : ResourceData, IJsonModel<BatchAccountPoolData>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<BatchAccountPoolData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BatchAccountPoolData IJsonModel<BatchAccountPoolData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (BatchAccountPoolData)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static BatchAccountPoolData DeserializeBatchAccountPoolData(JsonElement element, ModelReaderWriterOptions options)
        {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<BatchAccountPoolData>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BatchAccountPoolData IPersistableModel<BatchAccountPoolData>.Create(BinaryData data, ModelReaderWriterOptions options) => (BatchAccountPoolData)PersistableModelCreateCore(data, options);
        ...
        /// <param name="batchAccountPoolData"> The <see cref="BatchAccountPoolData"/> to serialize into <see cref="RequestContent"/>. </param>
        internal static RequestContent ToRequestContent(BatchAccountPoolData batchAccountPoolData)
        {
            if (batchAccountPoolData == null)
            {
                return null;
            }
        ...
        internal static BatchAccountPoolData FromResponse(Response response)
        {
            using JsonDocument document = JsonDocument.Parse(response.Content, ModelSerializationExtensions.JsonDocumentOptions);
            return DeserializeBatchAccountPoolData(document.RootElement, ModelSerializationExtensions.WireOptions);
        }
    }
}
