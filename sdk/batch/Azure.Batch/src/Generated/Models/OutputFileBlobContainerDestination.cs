...
namespace Azure.Batch.Service.Models
{
    ...
    public partial class OutputFileBlobContainerDestination
    {
        ...
        /// <param name="containerUrl"> If not using a managed identity, the URL must include a Shared Access Signature (SAS) granting write permissions to the container. </param>
        ...
        /// <param name="uploadHeaders"> These headers will be specified when uploading files to Azure Storage. For more information, see [Request Headers (All Blob Types)](https://docs.microsoft.com/rest/api/storageservices/put-blob#request-headers-all-blob-types). </param>
        ...
        /// <summary> If not using a managed identity, the URL must include a Shared Access Signature (SAS) granting write permissions to the container. </summary>
        ...
        /// <summary> These headers will be specified when uploading files to Azure Storage. For more information, see [Request Headers (All Blob Types)](https://docs.microsoft.com/rest/api/storageservices/put-blob#request-headers-all-blob-types). </summary>
