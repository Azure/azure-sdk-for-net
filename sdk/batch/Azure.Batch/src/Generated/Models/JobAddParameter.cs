...
{
    /// <summary> An Azure Batch Job to add. </summary>
    public partial class JobAddParameter
    {
        /// <summary> Initializes a new instance of JobAddParameter. </summary>
        ...
        public JobAddParameter(string id, PoolInformation poolInfo)
        {
            if (id == null)
            {
        ...
        /// <summary> A Job Release Task cannot be specified without also specifying a Job Preparation Task for the Job. The Batch service runs the Job Release Task on the Nodes that have run the Job Preparation Task. The primary purpose of the Job Release Task is to undo changes to Compute Nodes made by the Job Preparation Task. Example activities include deleting local files, or shutting down services that were started as part of Job preparation. </summary>
