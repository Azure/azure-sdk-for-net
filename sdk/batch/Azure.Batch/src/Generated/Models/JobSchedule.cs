...
namespace Azure.Batch.Service.Models
{
    ...
    public partial class JobSchedule
    {
        ...
        internal JobSchedule(string id, string displayName, string url, string eTag, DateTimeOffset? lastModified, DateTimeOffset? creationTime, JobScheduleState? state, DateTimeOffset? stateTransitionTime, JobScheduleState? previousState, DateTimeOffset? previousStateTransitionTime, Schedule schedule, JobSpecification jobSpecification, JobScheduleExecutionInformation executionInfo, IList<MetadataItem> metadata, JobScheduleStatistics stats)
        {
            Id = id;
        ...
        /// <summary> This is an opaque string. You can use it to detect whether the Job Schedule has changed between requests. In particular, you can be pass the ETag with an Update Job Schedule request to specify that your changes should take effect only if nobody else has modified the schedule in the meantime. </summary>
        public string ETag { get; }
        /// <summary> This is the last time at which the schedule level data, such as the Job specification or recurrence information, changed. It does not factor in job-level changes such as new Jobs being created or Jobs changing state. </summary>
        ...
        /// <summary> Contains information about Jobs that have been and will be run under a Job Schedule. </summary>
