...
{
    internal partial class ComputeNodeUpdateUserHeaders
    {
        private readonly Response _response;
        public ComputeNodeUpdateUserHeaders(Response response)
        {
            _response = response;
        }
        ...
        /// <summary> The OData ID of the resource to which the request applied. </summary>
