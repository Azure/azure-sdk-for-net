...
namespace Azure.Data.Batch.Tests
{
    public class BatchClientTest: RecordedTestBase<BatchClientTestEnvironment>
    {
        ...
        // private BatchClient CreateClient()
        // {
        ...
        //         return true;
        //     };
        //     var options = new BatchClientOptions { Transport = new HttpClientTransport(httpHandler) };
        //     var client = InstrumentClient(
        //         new BatchClient(TestEnvironment.Endpoint, TestEnvironment.<other-client-parameters>, TestEnvironment.Credential, InstrumentClientOptions(options)));
        //     return client;
        // }
