...
namespace Azure.Data.Batch.Models
{
    ...
    {
        /// <summary> Initializes a new instance of FileListFromComputeNodeOptions. </summary>
        public FileListFromComputeNodeOptions()
        {
        }

        /// <summary> An OData $filter clause. For more information on constructing this filter, see https://docs.microsoft.com/en-us/rest/api/batchservice/odata-filters-in-batch#list-compute-node-files. </summary>
        public string Filter { get; set; }
        /// <summary> The maximum number of items to return in the response. A maximum of 1000 files can be returned. </summary>
