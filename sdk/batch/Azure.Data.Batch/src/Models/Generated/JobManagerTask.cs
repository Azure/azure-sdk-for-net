...
namespace Azure.Data.Batch.Models
{
    ...
    public partial class JobManagerTask
    {
        ...
        /// <param name="requiredSlots"> The default is 1. A Task can only be scheduled to run on a compute node if the node has enough free scheduling slots available. For multi-instance Tasks, this property is not supported and must not be specified. </param>
        ...
        /// <summary> The default is 1. A Task can only be scheduled to run on a compute node if the node has enough free scheduling slots available. For multi-instance Tasks, this property is not supported and must not be specified. </summary>
