...
#pragma warning disable SA1649 // File name should match first type name
    internal class ImageBuilderArmOperation<T> : ArmOperation<T>
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        /// <summary> Initializes a new instance of ImageBuilderArmOperation for mocking. </summary>
        protected ImageBuilderArmOperation()
        {
        }

        internal ImageBuilderArmOperation(Response<T> response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal ImageBuilderArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal<T>(NextLinkOperationImplementation.Create(source, nextLinkOperation), clientDiagnostics, response, "ImageBuilderArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
        ...
        private string GetOperationId(RehydrationToken? rehydrationToken)
        {
            ...
            var data = ModelReaderWriter.Write(rehydrationToken, ModelReaderWriterOptions.Json, AzureResourceManagerImageBuilderContext.Default);
