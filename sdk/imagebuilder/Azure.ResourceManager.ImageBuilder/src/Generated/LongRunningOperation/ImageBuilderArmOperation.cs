...
#pragma warning disable SA1649 // File name should match first type name
    internal class ImageBuilderArmOperation : ArmOperation
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        internal ImageBuilderArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal ImageBuilderArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal(nextLinkOperation, clientDiagnostics, response, "ImageBuilderArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
