...
namespace Azure.ResourceManager.ImageBuilder
{
    internal partial class TriggersGetByImageTemplateAsyncCollectionResultOfT : AsyncPageable<ImageTemplateTriggerData>
    {
        ...
        /// <summary> Initializes a new instance of TriggersGetByImageTemplateAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public TriggersGetByImageTemplateAsyncCollectionResultOfT(Triggers client, string subscriptionId, string resourceGroupName, string imageTemplateName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of TriggersGetByImageTemplateAsyncCollectionResultOfT as an enumerable collection. </summary>
        ...
        {
            HttpMessage message = nextLink != null ? _client.CreateNextGetByImageTemplateRequest(nextLink, _subscriptionId, _resourceGroupName, _imageTemplateName, _context) : _client.CreateGetByImageTemplateRequest(_subscriptionId, _resourceGroupName, _imageTemplateName, _context);
