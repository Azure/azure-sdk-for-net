...
namespace Azure.ResourceManager.ImageBuilder.Models
{
    ...
    public partial class Operation
    {
        ...
        internal Operation(string name, OperationDisplay display, string origin, BinaryData properties, bool? isDataAction, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Display = display;
            Origin = origin;
