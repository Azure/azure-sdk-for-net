...
{
    public partial class TriggerStatus : IUtf8JsonSerializable, IJsonModel<TriggerStatus>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TriggerStatus>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<TriggerStatus>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        TriggerStatus IJsonModel<TriggerStatus>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<TriggerStatus>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static TriggerStatus DeserializeTriggerStatus(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new TriggerStatus(code, message, time, serializedAdditionalRawData);
        }

        BinaryData IPersistableModel<TriggerStatus>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<TriggerStatus>)this).GetFormatFromOptions(options) : options.Format;
        ...
        TriggerStatus IPersistableModel<TriggerStatus>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<TriggerStatus>)this).GetFormatFromOptions(options) : options.Format;
