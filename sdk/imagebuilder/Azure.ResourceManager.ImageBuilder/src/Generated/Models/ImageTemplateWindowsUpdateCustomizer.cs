...
namespace Azure.ResourceManager.ImageBuilder.Models
{
    ...
    public partial class ImageTemplateWindowsUpdateCustomizer : ImageTemplateCustomizer
    {
        ...
        public ImageTemplateWindowsUpdateCustomizer() : base("WindowsUpdate")
        {
        ...
        internal ImageTemplateWindowsUpdateCustomizer(string @type, string name, IDictionary<string, BinaryData> additionalBinaryDataProperties, string searchCriteria, IList<string> filters, int? updateLimit) : base(@type, name, additionalBinaryDataProperties)
        {
