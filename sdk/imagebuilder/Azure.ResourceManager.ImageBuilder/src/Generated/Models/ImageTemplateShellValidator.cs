...
namespace Azure.ResourceManager.ImageBuilder.Models
{
    ...
    public partial class ImageTemplateShellValidator : ImageTemplateInVMValidator
    {
        ...
        public ImageTemplateShellValidator() : base("Shell")
        {
        ...
        internal ImageTemplateShellValidator(string @type, string name, IDictionary<string, BinaryData> additionalBinaryDataProperties, string scriptUri, string sha256Checksum, IList<string> inline) : base(@type, name, additionalBinaryDataProperties)
        {
            ScriptUri = scriptUri;
