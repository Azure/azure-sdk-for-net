...
namespace Azure.ResourceManager.ImageBuilder.Models
{
    ...
    public partial class ImageTemplateFileCustomizer : ImageTemplateCustomizer
    {
        ...
        internal ImageTemplateFileCustomizer(string type, string name, IDictionary<string, BinaryData> serializedAdditionalRawData, string sourceUri, string sha256Checksum, string destination) : base(type, name, serializedAdditionalRawData)
        {
            SourceUri = sourceUri;
