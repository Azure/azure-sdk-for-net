...
namespace Azure.ResourceManager.ImageBuilder.Models
{
    ...
    public partial class VirtualNetworkConfig
    {
        ...
        internal VirtualNetworkConfig(string subnetId, string containerInstanceSubnetId, string proxyVmSize, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            SubnetId = subnetId;
