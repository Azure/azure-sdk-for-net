...
namespace Azure.ResourceManager.ImageBuilder.Models
{
    ...
    public partial class ImageTemplateRestartCustomizer : ImageTemplateCustomizer
    {
        ...
        public ImageTemplateRestartCustomizer() : base("WindowsRestart")
        {
        }
        ...
        internal ImageTemplateRestartCustomizer(string @type, string name, IDictionary<string, BinaryData> additionalBinaryDataProperties, string restartCommand, string restartCheckCommand, string restartTimeout) : base(@type, name, additionalBinaryDataProperties)
        {
