...
namespace Azure.ResourceManager.ImageBuilder.Models
{
    ...
    public partial class ImageTemplatePowerShellValidator : ImageTemplateInVMValidator
    {
        ...
        public ImageTemplatePowerShellValidator() : base("PowerShell")
        {
        ...
        internal ImageTemplatePowerShellValidator(string @type, string name, IDictionary<string, BinaryData> additionalBinaryDataProperties, string scriptUri, string sha256Checksum, IList<string> inline, bool? isRunElevated, bool? isRunAsSystem, IList<int> validExitCodes) : base(@type, name, additionalBinaryDataProperties)
        {
            ScriptUri = scriptUri;
