...
namespace Azure.ResourceManager.ImageBuilder
{
    ...
    public partial class TriggerData : ResourceData
    {
        ...
        /// <summary> Initializes a new instance of <see cref="TriggerData"/>. </summary>
        public TriggerData()
        {
        }
        ...
        internal TriggerData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, TriggerProperties properties, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, name, resourceType, systemData)
        {
