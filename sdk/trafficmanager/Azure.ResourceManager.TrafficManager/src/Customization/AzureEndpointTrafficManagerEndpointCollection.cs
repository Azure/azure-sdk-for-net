...
namespace Azure.ResourceManager.TrafficManager
{
    ...
    public partial class AzureEndpointTrafficManagerEndpointCollection
    {
        private const string EndpointType = "AzureEndpoints";

        /// <summary> Create or update a Traffic Manager Azure endpoint. </summary>
        ...
        /// <summary> Gets a Traffic Manager Azure endpoint. </summary>
        /// <param name="endpointName"> The name of the Traffic Manager endpoint. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        ...
        /// <summary> Checks to see if the Traffic Manager Azure endpoint exists in Azure. </summary>
        /// <param name="endpointName"> The name of the Traffic Manager endpoint. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="endpointName"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="endpointName"/> is an empty string, and was expected to be non-empty. </exception>
        ...
        {
            NullableResponse<AzureEndpointTrafficManagerEndpointResource> response = await GetIfExistsAsync(endpointName, cancellationToken).ConfigureAwait(false);
        ...
        {
            NullableResponse<AzureEndpointTrafficManagerEndpointResource> response = GetIfExists(endpointName, cancellationToken);
            return Response.FromValue(response.HasValue, response.GetRawResponse());
        }

        /// <summary> Tries to get details for this Traffic Manager Azure endpoint from the service. </summary>
        /// <param name="endpointName"> The name of the Traffic Manager endpoint. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="endpointName"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="endpointName"/> is an empty string, and was expected to be non-empty. </exception>
