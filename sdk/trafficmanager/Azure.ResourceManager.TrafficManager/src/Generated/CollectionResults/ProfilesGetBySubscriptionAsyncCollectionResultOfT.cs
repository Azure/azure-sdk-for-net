...
namespace Azure.ResourceManager.TrafficManager
{
    internal partial class ProfilesGetBySubscriptionAsyncCollectionResultOfT : AsyncPageable<TrafficManagerProfileData>
    {
        ...
        /// <summary> Initializes a new instance of ProfilesGetBySubscriptionAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        /// <param name="client"> The Profiles client used to send requests. </param>
        /// <param name="subscriptionId"> The ID of the target subscription. The value must be an UUID. </param>
        /// <param name="context"> The request options, which can override default behaviors of the client pipeline on a per-call basis. </param>
        public ProfilesGetBySubscriptionAsyncCollectionResultOfT(Profiles client, string subscriptionId, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of ProfilesGetBySubscriptionAsyncCollectionResultOfT as an enumerable collection. </summary>
