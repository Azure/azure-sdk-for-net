    ...
    public partial class TrafficManagerHeatMapResource : ArmResource
    {
        ...
        public virtual async Task<Response<TrafficManagerHeatMapResource>> GetAsync(IEnumerable<double> topLeft = default, IEnumerable<double> botRight = default, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _heatMapRestClient.CreateGetRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, topLeft, botRight, context);
