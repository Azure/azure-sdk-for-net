...
namespace Azure.ResourceManager.TrafficManager
{
    ...
    public partial class TrafficManagerUserMetricData : TrafficManagerProxyResourceData
    {
        ...
        internal TrafficManagerUserMetricData(ResourceIdentifier id, string name, ResourceType? resourceType, string key, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, rawData)
        {
            Key = key;
        }
