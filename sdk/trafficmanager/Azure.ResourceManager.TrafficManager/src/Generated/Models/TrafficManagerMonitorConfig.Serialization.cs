...
namespace Azure.ResourceManager.TrafficManager.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TrafficManagerMonitorConfig>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<TrafficManagerMonitorConfig>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<TrafficManagerMonitorConfig>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<TrafficManagerMonitorConfig>)} interface");
            }
        ...
        string IPersistableModel<TrafficManagerMonitorConfig>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
