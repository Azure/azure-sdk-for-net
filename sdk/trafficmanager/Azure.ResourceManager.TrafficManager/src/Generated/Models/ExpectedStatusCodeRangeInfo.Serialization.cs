...
namespace Azure.ResourceManager.TrafficManager.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ExpectedStatusCodeRangeInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ExpectedStatusCodeRangeInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ExpectedStatusCodeRangeInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ExpectedStatusCodeRangeInfo>)} interface");
            }
        ...
        string IPersistableModel<ExpectedStatusCodeRangeInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
