...
namespace Azure.ResourceManager.TrafficManager.Models
{
    ...
    public partial class ExpectedStatusCodeRangeInfo : IJsonModel<ExpectedStatusCodeRangeInfo>
    {
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual ExpectedStatusCodeRangeInfo PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<ExpectedStatusCodeRangeInfo>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ExpectedStatusCodeRangeInfo>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        ExpectedStatusCodeRangeInfo IPersistableModel<ExpectedStatusCodeRangeInfo>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ExpectedStatusCodeRangeInfo IJsonModel<ExpectedStatusCodeRangeInfo>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual ExpectedStatusCodeRangeInfo JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<ExpectedStatusCodeRangeInfo>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static ExpectedStatusCodeRangeInfo DeserializeExpectedStatusCodeRangeInfo(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new ExpectedStatusCodeRangeInfo(min, max, additionalBinaryDataProperties);
        }
    }
}
