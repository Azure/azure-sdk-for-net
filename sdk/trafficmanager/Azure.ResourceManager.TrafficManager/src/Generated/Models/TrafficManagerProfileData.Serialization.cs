...
namespace Azure.ResourceManager.TrafficManager
{
    public partial class TrafficManagerProfileData : IUtf8JsonSerializable, IModelJsonSerializable<TrafficManagerProfileData>
    {
        ...
        internal static TrafficManagerProfileData DeserializeTrafficManagerProfileData(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new TrafficManagerProfileData(id.Value, name.Value, Optional.ToNullable(type), Optional.ToDictionary(tags), Optional.ToNullable(location), Optional.ToNullable(profileStatus), Optional.ToNullable(trafficRoutingMethod), dnsConfig.Value, monitorConfig.Value, Optional.ToList(endpoints), Optional.ToNullable(trafficViewEnrollmentStatus), Optional.ToList(allowedEndpointRecordTypes), Optional.ToNullable(maxReturn), serializedAdditionalRawData);
        }
