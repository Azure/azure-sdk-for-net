...
namespace Azure.ResourceManager.TrafficManager
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TrafficManagerProfileData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<TrafficManagerProfileData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<TrafficManagerProfileData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<TrafficManagerProfileData>)} interface");
            }
        ...
        string IPersistableModel<TrafficManagerProfileData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
