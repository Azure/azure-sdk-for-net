...
namespace Azure.ResourceManager.TrafficManager.Models
{
    ...
    public partial class TrackedResource : TrafficManagerResourceData
    {
        ...
        internal TrackedResource(string id, string name, string resourceType, IDictionary<string, string> tags, string location) : base(id, name, resourceType)
        {
            Tags = tags;
            Location = location;
        }
