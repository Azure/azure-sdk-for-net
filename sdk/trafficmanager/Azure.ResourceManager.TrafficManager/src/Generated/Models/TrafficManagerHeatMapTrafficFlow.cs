...
namespace Azure.ResourceManager.TrafficManager.Models
{
    ...
    public partial class TrafficManagerHeatMapTrafficFlow
    {
        ...
        internal TrafficManagerHeatMapTrafficFlow(IPAddress sourceIP, double? latitude, double? longitude, IList<TrafficManagerHeatMapQueryExperience> queryExperiences, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            SourceIP = sourceIP;
            Latitude = latitude;
            Longitude = longitude;
