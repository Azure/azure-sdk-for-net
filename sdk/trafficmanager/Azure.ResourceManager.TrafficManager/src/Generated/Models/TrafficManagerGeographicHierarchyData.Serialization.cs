...
{
    public partial class TrafficManagerGeographicHierarchyData : IUtf8JsonSerializable, IJsonModel<TrafficManagerGeographicHierarchyData>, IPersistableModel<TrafficManagerGeographicHierarchyData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(GeographicHierarchy))
            {
                builder.Append("  geographicHierarchy:");
                AppendChildObject(builder, GeographicHierarchy, options, 2);
            }
