...
namespace Azure.ResourceManager.TrafficManager
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TrafficManagerGeographicHierarchyData>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        TrafficManagerGeographicHierarchyData IJsonModel<TrafficManagerGeographicHierarchyData>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<TrafficManagerGeographicHierarchyData>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        TrafficManagerGeographicHierarchyData IModel<TrafficManagerGeographicHierarchyData>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<TrafficManagerGeographicHierarchyData>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
