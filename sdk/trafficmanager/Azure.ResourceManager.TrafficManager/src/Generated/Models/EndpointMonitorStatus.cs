...
namespace Azure.ResourceManager.TrafficManager.Models
{
    ...
    public readonly partial struct EndpointMonitorStatus : IEquatable<EndpointMonitorStatus>
    {
        ...
        public static EndpointMonitorStatus Unmonitored { get; } = new EndpointMonitorStatus(UnmonitoredValue);
        ...
        /// <summary> Converts a string to a <see cref="EndpointMonitorStatus"/>. </summary>
        /// <param name="value"> The value. </param>
        public static implicit operator EndpointMonitorStatus?(string value) => value == null ? null : new EndpointMonitorStatus(value);
