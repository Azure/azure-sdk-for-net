...
namespace Azure.ResourceManager.TrafficManager.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TrafficManagerHeatMapQueryExperience>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        TrafficManagerHeatMapQueryExperience IJsonModel<TrafficManagerHeatMapQueryExperience>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<TrafficManagerHeatMapQueryExperience>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        TrafficManagerHeatMapQueryExperience IModel<TrafficManagerHeatMapQueryExperience>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<TrafficManagerHeatMapQueryExperience>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
