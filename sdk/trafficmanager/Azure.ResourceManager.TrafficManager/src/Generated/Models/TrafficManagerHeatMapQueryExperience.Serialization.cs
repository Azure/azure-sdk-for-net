...
namespace Azure.ResourceManager.TrafficManager.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TrafficManagerHeatMapQueryExperience>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<TrafficManagerHeatMapQueryExperience>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<TrafficManagerHeatMapQueryExperience>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<TrafficManagerHeatMapQueryExperience>)} interface");
            }
        ...
        string IPersistableModel<TrafficManagerHeatMapQueryExperience>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
