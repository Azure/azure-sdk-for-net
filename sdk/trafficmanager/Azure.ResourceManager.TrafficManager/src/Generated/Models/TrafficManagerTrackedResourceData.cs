...
namespace Azure.ResourceManager.TrafficManager.Models
{
    ...
    public partial class TrafficManagerTrackedResourceData : TrafficManagerResourceData
    {
        ...
        internal TrafficManagerTrackedResourceData(ResourceIdentifier id, string name, ResourceType? resourceType, IDictionary<string, string> tags, AzureLocation? location, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, rawData)
        {
            Tags = tags;
            Location = location;
        }
