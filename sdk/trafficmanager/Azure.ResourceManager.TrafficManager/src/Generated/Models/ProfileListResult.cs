...
namespace Azure.ResourceManager.TrafficManager.Models
{
    ...
    internal partial class ProfileListResult
    {
        ...
        internal ProfileListResult(IEnumerable<TrafficManagerProfileData> value)
        {
            Value = value.ToList();
        }
        ...
        internal ProfileListResult(IList<TrafficManagerProfileData> value, Uri nextLink, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            NextLink = nextLink;
        ...
        public IList<TrafficManagerProfileData> Value { get; }
