...
namespace Azure.ResourceManager.TrafficManager.Models
{
    ...
    internal partial class ProfileListResult
    {
        ...
        internal ProfileListResult(IEnumerable<Profile> value)
        {
            Value = value.ToList();
        }
        ...
        internal ProfileListResult(IList<Profile> value, Uri nextLink, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            NextLink = nextLink;
        ...
        public IList<Profile> Value { get; }
