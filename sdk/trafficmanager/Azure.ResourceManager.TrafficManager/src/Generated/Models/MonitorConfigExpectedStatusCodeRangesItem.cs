...
namespace Azure.ResourceManager.TrafficManager.Models
{
    ...
    {
        /// <summary> Initializes a new instance of MonitorConfigExpectedStatusCodeRangesItem. </summary>
        ...
        internal MonitorConfigExpectedStatusCodeRangesItem(int? min, int? max)
        {
            Min = min;
            Max = max;
        }
