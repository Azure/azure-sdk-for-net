...
namespace Azure.ResourceManager.TrafficManager.Models
{
    ...
    public partial class TrafficManagerHeatMapQueryExperience
    {
        ...
        internal TrafficManagerHeatMapQueryExperience(int endpointId, int queryCount)
        {
        ...
        internal TrafficManagerHeatMapQueryExperience(int endpointId, int queryCount, double? latency, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            EndpointId = endpointId;
            QueryCount = queryCount;
            Latency = latency;
