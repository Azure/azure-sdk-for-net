...
{
    public partial class TrafficManagerTrackedResourceData : IUtf8JsonSerializable, IJsonModel<TrafficManagerTrackedResourceData>, IPersistableModel<TrafficManagerTrackedResourceData>
    {
        ...
        void IJsonModel<TrafficManagerTrackedResourceData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(TrafficManagerTrackedResourceData)} does not support '{format}' format.");
            }
