...
namespace Azure.ResourceManager.TrafficManager.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TrafficManagerTrackedResourceData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<TrafficManagerTrackedResourceData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<TrafficManagerTrackedResourceData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<TrafficManagerTrackedResourceData>)} interface");
            }
        ...
        string IPersistableModel<TrafficManagerTrackedResourceData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
