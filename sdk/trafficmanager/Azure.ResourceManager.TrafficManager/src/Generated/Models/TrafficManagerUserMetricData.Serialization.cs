...
namespace Azure.ResourceManager.TrafficManager
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TrafficManagerUserMetricData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<TrafficManagerUserMetricData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<TrafficManagerUserMetricData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<TrafficManagerUserMetricData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
