...
namespace Azure.ResourceManager.TrafficManager.Models
{
    ...
    public partial class TrafficManagerNameAvailabilityResult
    {
        ...
        internal TrafficManagerNameAvailabilityResult(string name, ResourceType? resourceType, bool? isNameAvailable, string unavailableReason, string message, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
