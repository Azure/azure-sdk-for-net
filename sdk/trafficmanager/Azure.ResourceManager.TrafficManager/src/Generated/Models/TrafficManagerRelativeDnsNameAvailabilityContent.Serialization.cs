...
namespace Azure.ResourceManager.TrafficManager.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TrafficManagerRelativeDnsNameAvailabilityContent>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<TrafficManagerRelativeDnsNameAvailabilityContent>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
