...
namespace Azure.ResourceManager.TrafficManager.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TrafficManagerRelativeDnsNameAvailabilityContent>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<TrafficManagerRelativeDnsNameAvailabilityContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<TrafficManagerRelativeDnsNameAvailabilityContent>)} interface");
            }
        ...
        string IPersistableModel<TrafficManagerRelativeDnsNameAvailabilityContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
