...
{
    public partial class TrafficManagerEndpointSubnetInfo : IUtf8JsonSerializable, IJsonModel<TrafficManagerEndpointSubnetInfo>, IPersistableModel<TrafficManagerEndpointSubnetInfo>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  last:");
                builder.AppendLine($" '{Last.ToString()}'");
            }
