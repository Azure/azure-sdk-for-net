...
namespace Azure.ResourceManager.TrafficManager.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TrafficManagerRegion>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<TrafficManagerRegion>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<TrafficManagerRegion>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<TrafficManagerRegion>)} interface");
            }
        ...
        string IPersistableModel<TrafficManagerRegion>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
