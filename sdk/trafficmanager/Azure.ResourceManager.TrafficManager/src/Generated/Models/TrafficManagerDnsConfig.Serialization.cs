...
{
    public partial class TrafficManagerDnsConfig : IUtf8JsonSerializable, IJsonModel<TrafficManagerDnsConfig>, IPersistableModel<TrafficManagerDnsConfig>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(RelativeName))
            {
                ...
                builder.AppendLine($" '{RelativeName}'");
            }
            ...
            {
                builder.Append("  ttl:");
                builder.AppendLine($" '{Ttl.Value.ToString()}'");
            }
