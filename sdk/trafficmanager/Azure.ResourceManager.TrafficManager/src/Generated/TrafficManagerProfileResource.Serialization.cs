...
namespace Azure.ResourceManager.TrafficManager
{
    public partial class TrafficManagerProfileResource : IJsonModel<TrafficManagerProfileData>
    {
        ...
        {
            return ModelReaderWriter.Read<TrafficManagerProfileData>(new BinaryData(reader.ValueSequence), options);
        }
        ...
        {
            return ModelReaderWriter.Read<TrafficManagerProfileData>(data, options);
        }
