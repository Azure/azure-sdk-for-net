...
namespace Azure.ResourceManager.TrafficManager
{
    ...
    public partial class ProfileData : TrackedResource
    {
        ...
        public ProfileData()
        {
            Endpoints = new ChangeTrackingList<EndpointData>();
        ...
        internal ProfileData(string id, string name, string resourceType, IDictionary<string, string> tags, string location, ProfileStatus? profileStatus, TrafficRoutingMethod? trafficRoutingMethod, DnsConfig dnsConfig, MonitorConfig monitorConfig, IList<EndpointData> endpoints, TrafficViewEnrollmentStatus? trafficViewEnrollmentStatus, IList<AllowedEndpointRecordType> allowedEndpointRecordTypes, long? maxReturn) : base(id, name, resourceType, tags, location)
        {
        ...
        public IList<EndpointData> Endpoints { get; }
