...
namespace Azure.ResourceManager.TrafficManager
{
    ...
    public partial class TrafficManagerGeographicHierarchyData : TrafficManagerProxyResourceData
    {
        ...
        internal TrafficManagerGeographicHierarchyData(ResourceIdentifier id, string name, ResourceType? resourceType, TrafficManagerRegion geographicHierarchy, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, rawData)
        {
