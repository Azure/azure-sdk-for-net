...
namespace Azure.ResourceManager.TrafficManager
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="TrafficManagerUserMetricResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    ...
    /// </summary>
    public partial class TrafficManagerUserMetricResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of TrafficManagerUserMetricResource for mocking. </summary>
        protected TrafficManagerUserMetricResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="TrafficManagerUserMetricResource"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="data"> The resource that is the target of operations. </param>
        internal TrafficManagerUserMetricResource(ArmClient client, TrafficManagerUserMetricData data) : this(client, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal TrafficManagerUserMetricResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        ...
        /// <item>
        /// <term> Resource. </term>
        /// <description> <see cref="TrafficManagerUserMetricResource"/>. </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        {
            using DiagnosticScope scope = _trafficManagerUserMetricsKeysClientDiagnostics.CreateScope("TrafficManagerUserMetricResource.Get");
            scope.Start();
            try
            {
        ...
        {
            using DiagnosticScope scope = _trafficManagerUserMetricsKeysClientDiagnostics.CreateScope("TrafficManagerUserMetricResource.Delete");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        /// <param name="waitUntil"> <see cref="WaitUntil.Completed"/> if the method should wait to return until the long-running operation has completed on the service; <see cref="WaitUntil.Started"/> if it should return after starting the operation. For more information on long-running operations, please see <see href="https://github.com/Azure/azure-sdk-for-net/blob/main/sdk/core/Azure.Core/samples/LongRunningOperations.md"> Azure.Core Long-Running Operation samples</see>. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<ArmOperation<TrafficManagerUserMetricResource>> UpdateAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _trafficManagerUserMetricsKeysClientDiagnostics.CreateScope("TrafficManagerUserMetricResource.Update");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        /// <param name="waitUntil"> <see cref="WaitUntil.Completed"/> if the method should wait to return until the long-running operation has completed on the service; <see cref="WaitUntil.Started"/> if it should return after starting the operation. For more information on long-running operations, please see <see href="https://github.com/Azure/azure-sdk-for-net/blob/main/sdk/core/Azure.Core/samples/LongRunningOperations.md"> Azure.Core Long-Running Operation samples</see>. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual ArmOperation<TrafficManagerUserMetricResource> Update(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _trafficManagerUserMetricsKeysClientDiagnostics.CreateScope("TrafficManagerUserMetricResource.Update");
            scope.Start();
            try
