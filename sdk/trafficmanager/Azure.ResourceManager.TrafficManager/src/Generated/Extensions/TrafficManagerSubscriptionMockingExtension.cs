...
namespace Azure.ResourceManager.TrafficManager.Mocking
{
    ...
    internal partial class TrafficManagerSubscriptionMockingExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="TrafficManagerSubscriptionMockingExtension"/> class for mocking. </summary>
        protected TrafficManagerSubscriptionMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="TrafficManagerSubscriptionMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal TrafficManagerSubscriptionMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        {
            using var scope = TrafficManagerProfileProfilesClientDiagnostics.CreateScope("TrafficManagerSubscriptionMockingExtension.CheckTrafficManagerNameAvailabilityV2");
            scope.Start();
            try
            {
