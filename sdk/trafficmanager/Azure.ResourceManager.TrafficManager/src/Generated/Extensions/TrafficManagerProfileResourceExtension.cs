...
namespace Azure.ResourceManager.TrafficManager.Mock
{
    ...
    public partial class TrafficManagerProfileResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="TrafficManagerProfileResourceExtension"/> class for mocking. </summary>
        protected TrafficManagerProfileResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="TrafficManagerProfileResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal TrafficManagerProfileResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual async Task<Response<TrafficManagerNameAvailabilityResult>> CheckTrafficManagerRelativeDnsNameAvailabilityAsync(TrafficManagerRelativeDnsNameAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = TrafficManagerProfileProfilesClientDiagnostics.CreateScope("TrafficManagerProfileResourceExtension.CheckTrafficManagerRelativeDnsNameAvailability");
            scope.Start();
            try
            {
