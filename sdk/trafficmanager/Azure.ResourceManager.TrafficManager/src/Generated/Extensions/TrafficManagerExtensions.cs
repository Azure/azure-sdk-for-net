...
namespace Azure.ResourceManager.TrafficManager
{
    ...
    public static partial class TrafficManagerExtensions
    {
        ...
        private static TrafficManagerProfileResourceExtensionClient GetTrafficManagerProfileResourceExtensionClient(ArmResource resource)
        {
            return resource.GetCachedClient(client =>
            {
                return new TrafficManagerProfileResourceExtensionClient(client, resource.Id);
            });
        }

        private static TrafficManagerProfileResourceExtensionClient GetTrafficManagerProfileResourceExtensionClient(ArmClient client, ResourceIdentifier scope)
        {
            return client.GetResourceClient(() =>
            {
                return new TrafficManagerProfileResourceExtensionClient(client, scope);
            });
        }
        ...
        {
            return GetTrafficManagerProfileResourceExtensionClient(subscriptionResource).GetTrafficManagerProfilesAsync(cancellationToken);
        }
        ...
        {
            return GetTrafficManagerProfileResourceExtensionClient(subscriptionResource).GetTrafficManagerProfiles(cancellationToken);
        }
        ...
        public static async Task<Response<TrafficManagerNameAvailabilityResult>> CheckTrafficManagerRelativeDnsNameAvailabilityAsync(this TenantResource tenantResource, TrafficManagerRelativeDnsNameAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            ...
            return await GetTrafficManagerProfileResourceExtensionClient(tenantResource).CheckTrafficManagerRelativeDnsNameAvailabilityAsync(content, cancellationToken).ConfigureAwait(false);
        }
        ...
        public static Response<TrafficManagerNameAvailabilityResult> CheckTrafficManagerRelativeDnsNameAvailability(this TenantResource tenantResource, TrafficManagerRelativeDnsNameAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            ...
            return GetTrafficManagerProfileResourceExtensionClient(tenantResource).CheckTrafficManagerRelativeDnsNameAvailability(content, cancellationToken);
        }
    }
}
