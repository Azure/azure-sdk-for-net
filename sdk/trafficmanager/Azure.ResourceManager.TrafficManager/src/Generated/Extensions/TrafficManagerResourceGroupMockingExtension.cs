...
namespace Azure.ResourceManager.TrafficManager.Mocking
{
    ...
    internal partial class TrafficManagerResourceGroupMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="TrafficManagerResourceGroupMockingExtension"/> class for mocking. </summary>
        protected TrafficManagerResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="TrafficManagerResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal TrafficManagerResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
