...
namespace Azure.ResourceManager.TrafficManager.Mocking
{
    ...
    internal partial class TrafficManagerTenantMockingExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="TrafficManagerTenantMockingExtension"/> class for mocking. </summary>
        protected TrafficManagerTenantMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="TrafficManagerTenantMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal TrafficManagerTenantMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        {
            using var scope = TrafficManagerProfileProfilesClientDiagnostics.CreateScope("TrafficManagerTenantMockingExtension.CheckTrafficManagerRelativeDnsNameAvailability");
            scope.Start();
            try
            {
