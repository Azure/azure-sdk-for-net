...
namespace Azure.ResourceManager.TrafficManager.Models
{
    ...
    public static partial class ArmTrafficManagerModelFactory
    {
        ...
        {
            return new TrafficManagerNameAvailabilityResult(name, resourceType, isNameAvailable, unavailableReason, message, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new TrafficManagerDnsConfig(relativeName, fqdn, ttl, new Dictionary<string, BinaryData>());
        }
    }
}
