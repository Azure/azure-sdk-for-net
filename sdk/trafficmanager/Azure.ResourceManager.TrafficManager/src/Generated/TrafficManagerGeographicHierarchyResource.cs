...
namespace Azure.ResourceManager.TrafficManager
{
    ...
    public partial class TrafficManagerGeographicHierarchyResource : ArmResource
    {
        ...
        internal TrafficManagerGeographicHierarchyResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _geographicHierarchiesRestClient = new GeographicHierarchies(_geographicHierarchiesClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, trafficManagerGeographicHierarchyApiVersion ?? "2026-09-01");
