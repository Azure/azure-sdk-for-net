...
namespace Azure.ResourceManager.TrafficManager
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TrafficManagerUserMetricData>)this).Write(writer, ModelSerializationExtensions.WireOptions);
