...
namespace Azure.ResourceManager.TrafficManager.Tests
{
    public sealed class ProfileTests : ProfileTestBase
    {
        ...
        {
            const string ProfileWithHeatmapResrouceGroupName = "dialtone-traffic-manager";
            const string ProfileWithHeatmapName = "az-int-int-msftmetrics";

            ResourceGroupResource resourceGroup = await _subscription.GetResourceGroupAsync(ProfileWithHeatmapResrouceGroupName);
