...
- Updated the Traffic Manager management APIs to the 2024-04-01-preview service version.
- Added AOT compatibility support.
...
- Upgraded API version to 2022-04-01.
...
- Prepended `TrafficManager` prefix to all single / simple model names.
...
The package name has been changed from `Microsoft.Azure.Management.TrafficManager` to `Azure.ResourceManager.TrafficManager`.
