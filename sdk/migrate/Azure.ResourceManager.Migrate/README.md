# Azure.ResourceManager.Migrate management client library for .NET
...
Install the Azure.ResourceManager.Migrate management library for .NET with [NuGet](https://www.nuget.org/):
