...
{
    public partial class Sample_MigrateSqlAssessmentV2Resource
    {
        ...
        public async Task Get_SqlAssessmentV2OperationsGetMaximumSetGen()
        {
            ...
            MigrateSqlAssessmentV2Resource result = await migrateSqlAssessmentV2.GetAsync();
...
AzureVmFamily.Eadsv5Series
            ...
            ArmOperation<MigrateSqlAssessmentV2Resource> lro = await migrateSqlAssessmentV2.UpdateAsync(WaitUntil.Completed, data);
        ...
        public async Task Delete_SqlAssessmentV2OperationsDeleteMaximumSetGen()
        {
            ...
            // invoke the operation
            await migrateSqlAssessmentV2.DeleteAsync(WaitUntil.Completed);
        ...
        public async Task DownloadUrl_SqlAssessmentV2OperationsDownloadUrlMaximumSetGen()
        {
            ...
            ArmOperation<AssessmentReportDownloadUri> lro = await migrateSqlAssessmentV2.DownloadUrlAsync(WaitUntil.Completed, body);
