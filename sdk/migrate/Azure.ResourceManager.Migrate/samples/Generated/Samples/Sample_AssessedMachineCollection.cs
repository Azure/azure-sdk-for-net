...
namespace Azure.ResourceManager.Migrate.Samples
{
    public partial class Sample_AssessedMachineCollection
    {
        ...
        public async Task GetAll_AssessedMachinesOperationsListByAssessmentMaximumSetGen()
        {
            ...
            AssessedMachineCollection collection = migrateAssessment.GetAssessedMachines();
            ...
            await foreach (AssessedMachineResource item in collection.GetAllAsync(filter: filter, pageSize: pageSize, continuationToken: continuationToken, totalRecordCount: totalRecordCount))
            {
        ...
        public async Task GetIfExists_AssessedMachinesOperationsGetMaximumSetGen()
        {
            ...
            // invoke the operation
            string assessedMachineName = "oqxjeheiipjmuo";
            NullableResponse<AssessedMachineResource> response = await collection.GetIfExistsAsync(assessedMachineName);
            AssessedMachineResource result = response.HasValue ? response.Value : null;
