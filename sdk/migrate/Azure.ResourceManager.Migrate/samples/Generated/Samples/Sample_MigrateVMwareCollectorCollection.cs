...
{
    public partial class Sample_MigrateVMwareCollectorCollection
    {
        ...
        public async Task GetAll_VmwareCollectorsOperationsListByAssessmentProjectMaximumSetGen()
        {
            ...
            // get the collection of this MigrateVMwareCollectorResource
            MigrateVMwareCollectorCollection collection = migrateAssessmentProject.GetMigrateVMwareCollectors();

            // invoke the operation and iterate over the result
            await foreach (MigrateVMwareCollectorResource item in collection.GetAllAsync())
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                MigrateVMwareCollectorData resourceData = item.Data;
        ...
        public async Task Get_VmwareCollectorsOperationsGetMaximumSetGen()
        {
            ...
            MigrateVMwareCollectorResource result = await collection.GetAsync(vmWareCollectorName);
        ...
        public async Task GetIfExists_VmwareCollectorsOperationsGetMaximumSetGen()
        {
            ...
            // invoke the operation
            string vmWareCollectorName = "Vmware2258collector";
            NullableResponse<MigrateVMwareCollectorResource> response = await collection.GetIfExistsAsync(vmWareCollectorName);
            MigrateVMwareCollectorResource result = response.HasValue ? response.Value : null;
        ...
        public async Task CreateOrUpdate_VmwareCollectorsOperationsCreateMaximumSetGen()
        {
            ...
            ArmOperation<MigrateVMwareCollectorResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, vmWareCollectorName, data);
