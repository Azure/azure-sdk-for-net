...
namespace Azure.ResourceManager.Migrate.Models
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="Migrate.MigrateAssessmentProjectData"/>. </summary>
        ...
        /// disabled.
        /// </param>
        /// <returns> A new <see cref="Migrate.MigrateAssessmentProjectData"/> instance for mocking. </returns>
        public static MigrateAssessmentProjectData MigrateAssessmentProjectData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, MigrateProvisioningState? provisioningState = null, DateTimeOffset? createOn = null, DateTimeOffset? updatedOn = null, string serviceEndpoint = null, string assessmentSolutionId = null, AssessmentProjectStatus? projectStatus = null, string customerWorkspaceId = null, string customerWorkspaceLocation = null, string publicNetworkAccess = null, IEnumerable<MigratePrivateEndpointConnectionData> privateEndpointConnections = null, ResourceIdentifier customerStorageAccountArmId = null)
        {
        ...
        public static MigratePrivateEndpointConnectionData MigratePrivateEndpointConnectionData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IEnumerable<string> groupIds = null, ResourceIdentifier privateEndpointId = null, MigratePrivateLinkServiceConnectionState connectionState = null, MigratePrivateEndpointConnectionProvisioningState? provisioningState = null)
        {
        ...
        /// <summary> Initializes a new instance of <see cref="Migrate.MigrateAvsAssessmentOptionData"/>. </summary>
        /// <param name="id"> The id. </param>
        /// <param name="name"> The name. </param>
        /// <param name="resourceType"> The resourceType. </param>
        /// <param name="systemData"> The systemData. </param>
        ...
        /// <returns> A new <see cref="Migrate.MigrateGroupData"/> instance for mocking. </returns>
        public static MigrateGroupData MigrateGroupData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, MigrateProvisioningState? provisioningState = null, MigrateGroupStatus? groupStatus = null, int? machineCount = null, IEnumerable<string> assessments = null, IEnumerable<AssessmentType> supportedAssessmentTypes = null, bool? areAssessmentsRunning = null, DateTimeOffset? createdOn = null, DateTimeOffset? updatedOn = null, MigrateGroupType? groupType = null)
        {
        ...
        /// <summary> Initializes a new instance of <see cref="Migrate.AssessedMachineData"/>. </summary>
        /// <param name="id"> The id. </param>
        /// <param name="name"> The name. </param>
        /// <param name="resourceType"> The resourceType. </param>
        /// <param name="systemData"> The systemData. </param>
        ...
        public static AssessedMachineData AssessedMachineData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IEnumerable<MigrateError> errors = null, IReadOnlyDictionary<string, AssessedDisk> disks = null, double? monthlyUltraStorageCost = null, ProcessorInfo hostProcessor = null, IEnumerable<CostComponent> costComponents = null, ProductSupportStatus productSupportStatus = null, double? monthlyBandwidthCost = null, double? monthlyStorageCost = null, double? monthlyPremiumStorageCost = null, double? monthlyStandardSsdStorageCost = null, IReadOnlyDictionary<string, AssessedNetworkAdapter> networkAdapters = null, AzureVmSize? recommendedSize = null, int? numberOfCoresForRecommendedSize = null, double? megabytesOfMemoryForRecommendedSize = null, double? monthlyComputeCostForRecommendedSize = null, AzureVmSuitabilityExplanation? suitabilityExplanation = null, AzureVmSuitabilityDetail? suitabilityDetail = null, AssessedMachineType? typePropertiesType = null, MachineBootType? bootType = null, string operatingSystemType = null, string operatingSystemName = null, string operatingSystemVersion = null, GuestOperatingSystemArchitecture? operatingSystemArchitecture = null, DateTimeOffset? createdOn = null, DateTimeOffset? updatedOn = null, string displayName = null, string description = null, ResourceIdentifier datacenterMachineArmId = null, ResourceIdentifier datacenterManagementServerArmId = null, string datacenterManagementServerName = null, double? megabytesOfMemory = null, int? numberOfCores = null, double? confidenceRatingInPercentage = null, double? percentageCoresUtilization = null, double? percentageMemoryUtilization = null, MigrateCloudSuitability? suitability = null)
        {
            errors ??= new List<MigrateError>();
        ...
        public static AssessedNetworkAdapter AssessedNetworkAdapter(MigrateCloudSuitability? suitability = null, AzureNetworkAdapterSuitabilityDetail? suitabilityDetail = null, AzureNetworkAdapterSuitabilityExplanation? suitabilityExplanation = null, double? monthlyBandwidthCosts = null, double? netGigabytesTransmittedPerMonth = null, string displayName = null, string macAddress = null, IEnumerable<string> ipAddresses = null, double? megabytesPerSecondReceived = null, double? megabytesPerSecondTransmitted = null)
        {
        ...
        /// <summary> Initializes a new instance of <see cref="Migrate.MigrateAvsAssessmentData"/>. </summary>
        /// <param name="id"> The id. </param>
        /// <param name="name"> The name. </param>
        /// <param name="resourceType"> The resourceType. </param>
        /// <param name="systemData"> The systemData. </param>
        ...
        /// <param name="status"> Whether assessment is in valid state and all machines have been assessed. </param>
        /// <param name="schemaVersion"> Schema version. </param>
        /// <returns> A new <see cref="Migrate.MigrateAvsAssessmentData"/> instance for mocking. </returns>
        public static MigrateAvsAssessmentData MigrateAvsAssessmentData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, MigrateProvisioningState? provisioningState = null, IReadOnlyDictionary<string, int> assessmentErrorSummary = null, FttAndRaidLevel? failuresToTolerateAndRaidLevel = null, double? vcpuOversubscription = null, AvsNodeType? nodeType = null, AzureReservedInstance? reservedInstance = null, double? totalMonthlyCost = null, MigrateCloudSuitability? suitability = null, AvsSuitabilityExplanation? suitabilityExplanation = null, int? numberOfNodes = null, double? cpuUtilization = null, double? ramUtilization = null, double? storageUtilization = null, double? totalCpuCores = null, double? totalRamInGB = null, double? totalStorageInGB = null, int? numberOfMachines = null, IReadOnlyDictionary<string, int> suitabilitySummary = null, double? memOvercommit = null, double? dedupeCompression = null, string limitingFactor = null, bool? isStretchClusterEnabled = null, MigrateGroupType? groupType = null, AssessmentType? assessmentType = null, AzureLocation? azureLocation = null, AzureOfferCode? azureOfferCode = null, AzureCurrency? currency = null, double? scalingFactor = null, PercentileOfUtilization? percentile = null, AssessmentTimeRange? timeRange = null, DateTimeOffset? perfDataStartOn = null, DateTimeOffset? perfDataEndOn = null, AssessmentStage? stage = null, double? discountPercentage = null, AssessmentSizingCriterion? sizingCriterion = null, double? confidenceRatingInPercentage = null, DateTimeOffset? pricesQueriedOn = null, DateTimeOffset? createdOn = null, DateTimeOffset? updatedOn = null, AssessmentStatus? status = null, string schemaVersion = null)
        {
            assessmentErrorSummary ??= new Dictionary<string, int>();
            suitabilitySummary ??= new Dictionary<string, int>();
        ...
        /// <param name="status"> Whether assessment is in valid state and all machines have been assessed. </param>
        /// <param name="schemaVersion"> Schema version. </param>
        /// <returns> A new <see cref="Migrate.MigrateSqlAssessmentV2Data"/> instance for mocking. </returns>
        public static MigrateSqlAssessmentV2Data MigrateSqlAssessmentV2Data(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, MigrateProvisioningState? provisioningState = null, MigrateOSLicense? osLicense = null, AssessmentEnvironmentType? environmentType = null, EntityUptime entityUptime = null, SqlOptimizationLogic? optimizationLogic = null, AzureReservedInstance? reservedInstanceForVm = null, AzureOfferCode? azureOfferCodeForVm = null, string eaSubscriptionId = null, SqlMISettings azureSqlManagedInstanceSettings = null, SqlDBSettings azureSqlDatabaseSettings = null, IEnumerable<AzureVmFamily> azureSqlVmInstanceSeries = null, MultiSubnetIntent? multiSubnetIntent = null, AsyncCommitModeIntent? asyncCommitModeIntent = null, bool? isInternetAccessAvailable = null, AzureLocation? disasterRecoveryLocation = null, bool? enableHadrAssessment = null, AzureSecurityOfferingType? azureSecurityOfferingType = null, AzureReservedInstance? reservedInstance = null, SqlServerLicense? sqlServerLicense = null, MigrateGroupType? groupType = null, AssessmentType? assessmentType = null, AzureLocation? azureLocation = null, AzureOfferCode? azureOfferCode = null, AzureCurrency? currency = null, double? scalingFactor = null, PercentileOfUtilization? percentile = null, AssessmentTimeRange? timeRange = null, DateTimeOffset? perfDataStartOn = null, DateTimeOffset? perfDataEndOn = null, AssessmentStage? stage = null, double? discountPercentage = null, AssessmentSizingCriterion? sizingCriterion = null, double? confidenceRatingInPercentage = null, DateTimeOffset? pricesQueriedOn = null, DateTimeOffset? createdOn = null, DateTimeOffset? updatedOn = null, AssessmentStatus? status = null, string schemaVersion = null)
        {
        ...
        public static SqlAssessmentV2PaasSuitabilityDetails SqlAssessmentV2PaasSuitabilityDetails(AzureSqlPaasSkuDto azureSqlSku = null, IEnumerable<AzureSqlPaasSkuDto> replicaAzureSqlSku = null, SharedResourcesDto sharedResources = null, double? monthlyComputeCost = null, double? monthlyStorageCost = null, IEnumerable<CostComponent> costComponents = null, MigrateCloudSuitability? securitySuitability = null, bool? shouldProvisionReplicas = null, SkuReplicationMode? skuReplicationMode = null, IEnumerable<SqlMigrationGuideline> migrationGuidelines = null, IEnumerable<SqlRecommendationReasoning> recommendationReasonings = null, MigrateTargetType? migrationTargetPlatform = null, MigrateCloudSuitability? suitability = null, IEnumerable<SqlAssessmentMigrationIssue> migrationIssues = null)
        {
        ...
        /// <returns> A new <see cref="Migrate.AssessedSqlInstanceV2Data"/> instance for mocking. </returns>
        public static AssessedSqlInstanceV2Data AssessedSqlInstanceV2Data(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, double? memoryInUseInMB = null, bool? hasScanOccurred = null, MigrateTargetType? recommendedAzureSqlTargetType = null, RecommendedSuitability? recommendedSuitability = null, SqlAssessmentV2PaasSuitabilityDetails azureSqlMISuitabilityDetails = null, SqlAssessmentV2PaasSuitabilityDetails azureSqlDBSuitabilityDetails = null, SqlAssessmentV2IaasSuitabilityDetails azureSqlVmSuitabilityDetails = null, IEnumerable<AssessedSqlInstanceStorageDetails> storageTypeBasedDetails = null, ProductSupportStatus productSupportStatus = null, SqlFciMetadata fciMetadata = null, SqlAvailabilityReplicaSummary availabilityReplicaSummary = null, bool? isClustered = null, bool? isHighAvailabilityEnabled = null, IEnumerable<SqlRecommendationReasoning> recommendedTargetReasonings = null, ResourceIdentifier machineArmId = null, string machineName = null, string instanceName = null, ResourceIdentifier sqlInstanceSdsArmId = null, string sqlEdition = null, string sqlVersion = null, int? numberOfCoresAllocated = null, double? percentageCoresUtilization = null, IEnumerable<AssessedSqlInstanceDiskDetails> logicalDisks = null, AssessedSqlInstanceDatabaseSummary databaseSummary = null, double? confidenceRatingInPercentage = null, AssessmentSizingCriterion? sizingCriterion = null, DateTimeOffset? createdOn = null, DateTimeOffset? updatedOn = null)
        {
        ...
        public static SqlAssessmentV2IaasSuitabilityDetails SqlAssessmentV2IaasSuitabilityDetails(AzureSqlIaasSkuDto azureSqlSku = null, IEnumerable<AzureSqlIaasSkuDto> replicaAzureSqlSku = null, SharedResourcesDto sharedResources = null, double? monthlyComputeCost = null, double? monthlyStorageCost = null, IEnumerable<CostComponent> costComponents = null, MigrateCloudSuitability? securitySuitability = null, bool? shouldProvisionReplicas = null, SkuReplicationMode? skuReplicationMode = null, IEnumerable<SqlMigrationGuideline> migrationGuidelines = null, IEnumerable<SqlRecommendationReasoning> recommendationReasonings = null, MigrateTargetType? migrationTargetPlatform = null, MigrateCloudSuitability? suitability = null, IEnumerable<SqlAssessmentMigrationIssue> migrationIssues = null)
        {
        ...
        public static AzureSqlIaasSkuDto AzureSqlIaasSkuDto(AzureVmSkuDto virtualMachineSize = null, IEnumerable<AzureManagedDiskSkuDto> dataDiskSizes = null, IEnumerable<AzureManagedDiskSkuDto> logDiskSizes = null, MigrateTargetType? azureSqlTargetType = null)
        {
        ...
        /// <summary> Initializes a new instance of <see cref="Migrate.AssessedSqlMachineData"/>. </summary>
        /// <param name="id"> The id. </param>
        /// <param name="name"> The name. </param>
        /// <param name="resourceType"> The resourceType. </param>
        /// <param name="systemData"> The systemData. </param>
        ...
        public static SqlAssessedNetworkAdapter SqlAssessedNetworkAdapter(MigrateCloudSuitability? suitability = null, AzureNetworkAdapterSuitabilityDetail? suitabilityDetail = null, AzureNetworkAdapterSuitabilityExplanation? suitabilityExplanation = null, double? monthlyBandwidthCosts = null, double? netGigabytesTransmittedPerMonth = null, string name = null, string displayName = null, string macAddress = null, IEnumerable<string> ipAddresses = null, double? megabytesPerSecondReceived = null, double? megabytesPerSecondTransmitted = null)
        {
            ipAddresses ??= new List<string>();
        ...
        /// <param name="updatedOn"> When was machine last updated. </param>
        /// <returns> A new <see cref="Migrate.MigrateMachineData"/> instance for mocking. </returns>
        public static MigrateMachineData MigrateMachineData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, WorkloadSummary workloadSummary = null, IEnumerable<MigrateError> errors = null, ProcessorInfo hostProcessor = null, ProductSupportStatus productSupportStatus = null, ResourceIdentifier discoveryMachineArmId = null, ResourceIdentifier datacenterManagementServerArmId = null, string datacenterManagementServerName = null, MachineBootType? bootType = null, string displayName = null, double? megabytesOfMemory = null, int? numberOfCores = null, string operatingSystemType = null, string operatingSystemName = null, string operatingSystemVersion = null, string description = null, DateTimeOffset? createdOn = null, IReadOnlyDictionary<string, MigrateDisk> disks = null, IEnumerable<string> groups = null, IReadOnlyDictionary<string, MigrateNetworkAdapter> networkAdapters = null, IEnumerable<string> sqlInstances = null, IEnumerable<string> webApplications = null, DateTimeOffset? updatedOn = null)
        {
            errors ??= new List<MigrateError>();
            disks ??= new Dictionary<string, MigrateDisk>();
            groups ??= new List<string>();
            networkAdapters ??= new Dictionary<string, MigrateNetworkAdapter>();
        ...
        /// <summary> Initializes a new instance of <see cref="Models.MigrateDisk"/>. </summary>
        ...
        /// <returns> A new <see cref="Models.MigrateDisk"/> instance for mocking. </returns>
        public static MigrateDisk MigrateDisk(double? gigabytesAllocated = null, string displayName = null)
        {
            return new MigrateDisk(gigabytesAllocated, displayName, serializedAdditionalRawData: null);
        }

        /// <summary> Initializes a new instance of <see cref="Models.MigrateNetworkAdapter"/>. </summary>
        ...
        /// <returns> A new <see cref="Models.MigrateNetworkAdapter"/> instance for mocking. </returns>
        public static MigrateNetworkAdapter MigrateNetworkAdapter(string macAddress = null, IEnumerable<string> ipAddresses = null, string displayName = null)
        {
            ipAddresses ??= new List<string>();

            return new MigrateNetworkAdapter(macAddress, ipAddresses?.ToList(), displayName, serializedAdditionalRawData: null);
        }

        /// <summary> Initializes a new instance of <see cref="Migrate.MigratePrivateLinkResourceData"/>. </summary>
        /// <param name="id"> The id. </param>
        /// <param name="name"> The name. </param>
        /// <param name="resourceType"> The resourceType. </param>
        /// <param name="systemData"> The systemData. </param>
        ...
        public static MigratePrivateLinkResourceData MigratePrivateLinkResourceData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string groupId = null, IEnumerable<string> requiredMembers = null, IEnumerable<string> requiredZoneNames = null)
        {
        ...
        /// <summary> Initializes a new instance of <see cref="Migrate.MigrateServerCollectorData"/>. </summary>
        /// <param name="id"> The id. </param>
        /// <param name="name"> The name. </param>
        /// <param name="resourceType"> The resourceType. </param>
        /// <param name="systemData"> The systemData. </param>
        ...
        /// <returns> A new <see cref="Migrate.MigrateSqlAssessmentOptionData"/> instance for mocking. </returns>
        public static MigrateSqlAssessmentOptionData MigrateSqlAssessmentOptionData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IEnumerable<VmFamilyConfig> vmFamilies = null, IEnumerable<AzureVmFamily> reservedInstanceVmFamilies = null, IEnumerable<AzureVmFamily> premiumDiskVmFamilies = null, IEnumerable<AzureVmFamily> savingsPlanVmFamilies = null, IEnumerable<AzureLocation> savingsPlanSupportedLocations = null, IEnumerable<AzureLocation> savingsPlanSupportedLocationsForPaas = null, IEnumerable<AzureLocation> reservedInstanceSupportedLocationsForIaas = null, IEnumerable<AzureOfferCode> savingsPlanSupportedOffers = null, IEnumerable<SqlPaaSTargetConfig> sqlSkus = null, IEnumerable<MigrateTargetType> reservedInstanceSqlTargets = null, IEnumerable<AzureLocation> reservedInstanceSupportedLocations = null, IEnumerable<AzureCurrency> reservedInstanceSupportedCurrencies = null, IEnumerable<AzureOfferCode> reservedInstanceSupportedOffers = null, IEnumerable<AzureOfferCode> supportedOffers = null)
        {
            vmFamilies ??= new List<VmFamilyConfig>();
            ...
            reservedInstanceSqlTargets ??= new List<MigrateTargetType>();
            reservedInstanceSupportedLocations ??= new List<AzureLocation>();
            reservedInstanceSupportedCurrencies ??= new List<AzureCurrency>();
            reservedInstanceSupportedOffers ??= new List<AzureOfferCode>();
