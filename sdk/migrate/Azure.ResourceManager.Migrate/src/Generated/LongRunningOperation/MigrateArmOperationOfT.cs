...
{
    internal partial class MigrateArmOperation<T> : ArmOperation<T>
    {
        ...
        internal MigrateArmOperation(Response<T> response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal MigrateArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
