...
namespace Azure.ResourceManager.Migrate.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AssessedSqlInstanceV2ListResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<AssessedSqlInstanceV2ListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AssessedSqlInstanceV2ListResult)} does not support '{format}' format.");
            }
        ...
        internal static AssessedSqlInstanceV2ListResult DeserializeAssessedSqlInstanceV2ListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("value"u8))
                {
                    ...
                    {
                        array.Add(AssessedSqlInstanceV2Data.DeserializeAssessedSqlInstanceV2Data(item));
                    }
                    value = array;
                    continue;
                }
            ...
            return new AssessedSqlInstanceV2ListResult(value, nextLink.Value, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<AssessedSqlInstanceV2ListResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AssessedSqlInstanceV2ListResult)} does not support '{options.Format}' format.");
            }
        }
