...
namespace Azure.ResourceManager.Migrate.Models
{
    ...
    public partial class SqlPaaSTargetConfig
    {
        ...
        internal SqlPaaSTargetConfig(MigrateComputeTier? computeTier, MigrateHardwareGeneration? hardwareGeneration, MigrateTargetType? targetType, AzureSqlServiceTier? serviceTier, IList<AzureLocation> targetLocations, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
        ...
        public MigrateComputeTier? ComputeTier { get; set; }
        /// <summary> Gets or sets the Azure SQL hardware generation. </summary>
        public MigrateHardwareGeneration? HardwareGeneration { get; set; }
        /// <summary> Gets or sets the Azure SQL target type. </summary>
        public MigrateTargetType? TargetType { get; set; }
