...
{
    /// <summary> The AssessedDisk. </summary>
    public partial class AssessedDisk
    {
        ...
        /// <summary> Initializes a new instance of <see cref="AssessedDisk"/>. </summary>
        ...
        internal AssessedDisk(MigrateCloudSuitability? suitability, AzureDiskSuitabilityExplanation? suitabilityExplanation, AzureDiskSuitabilityDetail? suitabilityDetail, AzureDiskSize? recommendedDiskSize, AzureDiskType? recommendedDiskType, int? gigabytesForRecommendedDiskSize, double? recommendDiskThroughputInMbps, double? recommendedDiskIops, double? monthlyStorageCost, string name, string displayName, double? gigabytesProvisioned, double? megabytesPerSecondOfRead, double? megabytesPerSecondOfWrite, double? numberOfReadOperationsPerSecond, double? numberOfWriteOperationsPerSecond, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
