...
namespace Azure.ResourceManager.Migrate.Models
{
    ...
    public partial class MigrateAssessmentProjectPatch
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="MigrateAssessmentProjectPatch"/>. </summary>
        ...
        internal MigrateAssessmentProjectPatch(IDictionary<string, string> tags, string assessmentSolutionId, AssessmentProjectStatus? projectStatus, ResourceIdentifier customerWorkspaceId, string customerWorkspaceLocation, string publicNetworkAccess, ResourceIdentifier customerStorageAccountArmId, MigrateProvisioningState? provisioningState, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Tags = tags;
