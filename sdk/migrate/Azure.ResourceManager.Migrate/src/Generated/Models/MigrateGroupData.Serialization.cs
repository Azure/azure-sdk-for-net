...
{
    public partial class MigrateGroupData : IUtf8JsonSerializable, IJsonModel<MigrateGroupData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MigrateGroupData>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<MigrateGroupData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<MigrateGroupData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MigrateGroupData)} does not support '{format}' format.");
            }
        ...
        MigrateGroupData IJsonModel<MigrateGroupData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<MigrateGroupData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
            ...
            return DeserializeMigrateGroupData(document.RootElement, options);
        }

        internal static MigrateGroupData DeserializeMigrateGroupData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            Optional<IList<AssessmentType>> supportedAssessmentTypes = default;
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("groupStatus"u8))
                        {
                            ...
                            groupStatus = new MigrateGroupStatus(property0.Value.GetString());
                            continue;
                        }
            ...
            return new MigrateGroupData(id, name, type, systemData.Value, Optional.ToNullable(provisioningState), Optional.ToNullable(groupStatus), Optional.ToNullable(machineCount), Optional.ToList(assessments), Optional.ToList(supportedAssessmentTypes), Optional.ToNullable(areAssessmentsRunning), Optional.ToNullable(createdTimestamp), Optional.ToNullable(updatedTimestamp), Optional.ToNullable(groupType), serializedAdditionalRawData);
        }

        BinaryData IPersistableModel<MigrateGroupData>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<MigrateGroupData>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(MigrateGroupData)} does not support '{options.Format}' format.");
            }
        }

        MigrateGroupData IPersistableModel<MigrateGroupData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<MigrateGroupData>)this).GetFormatFromOptions(options) : options.Format;
        ...
        string IPersistableModel<MigrateGroupData>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
