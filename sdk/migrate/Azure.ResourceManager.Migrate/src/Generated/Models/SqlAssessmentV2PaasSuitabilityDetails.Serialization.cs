...
namespace Azure.ResourceManager.Migrate.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SqlAssessmentV2PaasSuitabilityDetails>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<SqlAssessmentV2PaasSuitabilityDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SqlAssessmentV2PaasSuitabilityDetails)} does not support '{format}' format.");
            }
        ...
        internal static SqlAssessmentV2PaasSuitabilityDetails DeserializeSqlAssessmentV2PaasSuitabilityDetails(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            Optional<AzureSqlPaasSkuDto> azureSqlSku = default;
            Optional<IReadOnlyList<AzureSqlPaasSkuDto>> replicaAzureSqlSku = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("azureSqlSku"u8))
                {
                    ...
                    azureSqlSku = AzureSqlPaasSkuDto.DeserializeAzureSqlPaasSkuDto(property.Value);
                    continue;
                }
                if (property.NameEquals("replicaAzureSqlSku"u8))
                {
                    ...
                    {
                        array.Add(AzureSqlPaasSkuDto.DeserializeAzureSqlPaasSkuDto(item));
                    }
        ...
        BinaryData IPersistableModel<SqlAssessmentV2PaasSuitabilityDetails>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SqlAssessmentV2PaasSuitabilityDetails)} does not support '{options.Format}' format.");
            }
        }
