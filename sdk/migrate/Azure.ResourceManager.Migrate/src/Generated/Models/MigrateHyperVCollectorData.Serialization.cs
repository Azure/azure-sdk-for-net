...
{
    public partial class MigrateHyperVCollectorData : IUtf8JsonSerializable, IJsonModel<MigrateHyperVCollectorData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MigrateHyperVCollectorData>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<MigrateHyperVCollectorData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<MigrateHyperVCollectorData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MigrateHyperVCollectorData)} does not support '{format}' format.");
            }
        ...
        MigrateHyperVCollectorData IJsonModel<MigrateHyperVCollectorData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<MigrateHyperVCollectorData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
            ...
            return DeserializeMigrateHyperVCollectorData(document.RootElement, options);
        }

        internal static MigrateHyperVCollectorData DeserializeMigrateHyperVCollectorData(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<MigrateHyperVCollectorData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(MigrateHyperVCollectorData)} does not support '{options.Format}' format.");
            }
        }

        MigrateHyperVCollectorData IPersistableModel<MigrateHyperVCollectorData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<MigrateHyperVCollectorData>)this).GetFormatFromOptions(options) : options.Format;
        ...
        string IPersistableModel<MigrateHyperVCollectorData>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
