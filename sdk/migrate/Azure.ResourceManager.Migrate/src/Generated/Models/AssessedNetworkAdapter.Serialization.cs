...
namespace Azure.ResourceManager.Migrate.Models
{
    public partial class AssessedNetworkAdapter : IUtf8JsonSerializable, IJsonModel<AssessedNetworkAdapter>
    {
        ...
        internal static AssessedNetworkAdapter DeserializeAssessedNetworkAdapter(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new AssessedNetworkAdapter(Optional.ToNullable(suitability), Optional.ToNullable(suitabilityDetail), Optional.ToNullable(suitabilityExplanation), Optional.ToNullable(monthlyBandwidthCosts), Optional.ToNullable(netGigabytesTransmittedPerMonth), displayName.Value, macAddress.Value, Optional.ToList(ipAddresses), Optional.ToNullable(megabytesPerSecondReceived), Optional.ToNullable(megabytesPerSecondTransmitted), serializedAdditionalRawData);
        }
