...
namespace Azure.ResourceManager.Migrate.Models
{
    ...
    public partial class AssessedDataDisk
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="AssessedDataDisk"/>. </summary>
        ...
        internal AssessedDataDisk(MigrateCloudSuitability? suitability, AzureDiskSuitabilityExplanation? suitabilityExplanation, AzureDiskSuitabilityDetail? suitabilityDetail, AzureDiskSize? recommendedDiskSize, AzureDiskType? recommendedDiskType, int? recommendedDiskSizeGigabytes, double? recommendDiskThroughputInMbps, double? recommendedDiskIops, double? monthlyStorageCost, string name, string displayName, double? gigabytesProvisioned, double? megabytesPerSecondOfRead, double? megabytesPerSecondOfWrite, double? numberOfReadOperationsPerSecond, double? numberOfWriteOperationsPerSecond, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
