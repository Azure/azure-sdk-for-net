...
namespace Azure.ResourceManager.Migrate
{
    ...
    public partial class TaskCollection : ArmCollection, IEnumerable<TaskResource>, IAsyncEnumerable<TaskResource>
    {
        ...
        internal TaskCollection(ArmClient client, ResourceIdentifier id, string projectName) : base(client, id)
        {
            TryGetApiVersion(TaskResource.ResourceType, out string taskApiVersion);
            _projectName = projectName;
            _tasksClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Migrate", TaskResource.ResourceType.Namespace, Diagnostics);
            _tasksRestClient = new Tasks(_tasksClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, taskApiVersion ?? "2026-06-01-preview");
        ...
        public virtual async Task<ArmOperation<TaskResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string taskName, TaskData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _tasksRestClient.CreateCreateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, _projectName, taskName, TaskData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                MigrateArmOperation<TaskResource> operation = new MigrateArmOperation<TaskResource>(
                    new TaskResourceOperationSource(Client),
                    _tasksClientDiagnostics,
                    Pipeline,
                    message.Request,
                    response,
        ...
        public virtual async Task<Response<TaskResource>> GetAsync(string taskName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _tasksRestClient.CreateGetRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, _projectName, taskName, context);
        ...
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Migrate/migrateProjects/{projectName}/tasks. </description>
        /// </item>
        /// <item>
        /// <term> Operation Id. </term>
        /// <description> Tasks_ListByParent. </description>
        /// </item>
        /// <item>
        /// <term> Default Api Version. </term>
        /// <description> 2026-06-01-preview. </description>
        ...
        public virtual AsyncPageable<TaskResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<TaskData, TaskResource>(new TasksGetByParentAsyncCollectionResultOfT(
                _tasksRestClient,
        ...
        public virtual Pageable<TaskResource> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            return new PageableWrapper<TaskData, TaskResource>(new TasksGetByParentCollectionResultOfT(
                _tasksRestClient,
                Guid.Parse(Id.SubscriptionId),
                Id.ResourceGroupName,
                _projectName,
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string taskName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                {
                    case 200:
                        response = Response.FromValue(TaskData.FromResponse(result), result);
                        break;
                    case 404:
                        response = Response.FromValue((TaskData)null, result);
                        break;
                    default:
