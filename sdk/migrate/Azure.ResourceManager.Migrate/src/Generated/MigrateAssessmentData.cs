...
{
    /// <summary>
    /// A class representing the MigrateAssessment data model.
    /// Machine assessment resource.
    /// </summary>
    public partial class MigrateAssessmentData : ResourceData
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="MigrateAssessmentData"/>. </summary>
        ...
        internal MigrateAssessmentData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, MigrateProvisioningState? provisioningState, IReadOnlyDictionary<string, int> assessmentErrorSummary, double? monthlyUltraStorageCost, IReadOnlyList<CostComponent> costComponents, string eaSubscriptionId, AzurePricingTier? azurePricingTier, AzureStorageRedundancy? azureStorageRedundancy, AzureReservedInstance? reservedInstance, AzureHybridUseBenefit? azureHybridUseBenefit, IList<AzureDiskType> azureDiskTypes, IList<AzureVmFamily> azureVmFamilies, IReadOnlyDictionary<string, int> distributionBySupportStatus, IReadOnlyDictionary<string, int> distributionByServicePackInsight, IReadOnlyDictionary<string, int> distributionByOSName, double? monthlyComputeCost, double? monthlyBandwidthCost, double? monthlyStorageCost, double? monthlyPremiumStorageCost, double? monthlyStandardSsdStorageCost, IReadOnlyDictionary<string, int> suitabilitySummary, int? numberOfMachines, VmUptime vmUptime, MigrateGroupType? groupType, AssessmentType? assessmentType, AzureLocation? azureLocation, AzureOfferCode? azureOfferCode, AzureCurrency? currency, double? scalingFactor, PercentileOfUtilization? percentile, AssessmentTimeRange? timeRange, DateTimeOffset? perfDataStartOn, DateTimeOffset? perfDataEndOn, AssessmentStage? stage, double? discountPercentage, AssessmentSizingCriterion? sizingCriterion, double? confidenceRatingInPercentage, DateTimeOffset? pricesQueriedOn, DateTimeOffset? createdOn, DateTimeOffset? updatedOn, AssessmentStatus? status, string schemaVersion, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
        ...
        public MigrateGroupType? GroupType { get; }
