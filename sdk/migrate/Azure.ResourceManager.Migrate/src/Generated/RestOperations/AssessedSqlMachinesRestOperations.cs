...
namespace Azure.ResourceManager.Migrate
{
    internal partial class AssessedSqlMachinesRestOperations
    {
        ...
        public async Task<Response<AssessedSqlMachineData>> GetAsync(string subscriptionId, string resourceGroupName, string projectName, string groupName, string assessmentName, string assessedSqlMachineName, CancellationToken cancellationToken = default)
        {
            ...
            {
                throw new ArgumentNullException(nameof(assessedSqlMachineName));
            }
            if (assessedSqlMachineName.Length == 0)
            {
                throw new ArgumentException("Value cannot be an empty string.", nameof(assessedSqlMachineName));
            }
