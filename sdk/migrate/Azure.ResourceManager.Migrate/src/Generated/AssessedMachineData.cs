...
{
    /// <summary>
    /// A class representing the AssessedMachine data model.
    ...
    public partial class AssessedMachineData : ResourceData
    {
        ...
        /// <summary> Initializes a new instance of <see cref="AssessedMachineData"/>. </summary>
        ...
        internal AssessedMachineData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IReadOnlyList<MigrateError> errors, IReadOnlyDictionary<string, AssessedDisk> disks, double? monthlyUltraStorageCost, ProcessorInfo hostProcessor, IList<CostComponent> costComponents, ProductSupportStatus productSupportStatus, double? monthlyBandwidthCost, double? monthlyStorageCost, double? monthlyPremiumStorageCost, double? monthlyStandardSsdStorageCost, IReadOnlyDictionary<string, AssessedNetworkAdapter> networkAdapters, AzureVmSize? recommendedSize, int? numberOfCoresForRecommendedSize, double? megabytesOfMemoryForRecommendedSize, double? monthlyComputeCostForRecommendedSize, AzureVmSuitabilityExplanation? suitabilityExplanation, AzureVmSuitabilityDetail? suitabilityDetail, AssessedMachineType? typePropertiesType, MachineBootType? bootType, string operatingSystemType, string operatingSystemName, string operatingSystemVersion, GuestOperatingSystemArchitecture? operatingSystemArchitecture, DateTimeOffset? createdOn, DateTimeOffset? updatedOn, string displayName, string description, ResourceIdentifier datacenterMachineArmId, ResourceIdentifier datacenterManagementServerArmId, string datacenterManagementServerName, double? megabytesOfMemory, int? numberOfCores, double? confidenceRatingInPercentage, double? percentageCoresUtilization, double? percentageMemoryUtilization, MigrateCloudSuitability? suitability, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
            Errors = errors;
            Disks = disks;
        ...
        public ProcessorInfo HostProcessor { get; set; }
