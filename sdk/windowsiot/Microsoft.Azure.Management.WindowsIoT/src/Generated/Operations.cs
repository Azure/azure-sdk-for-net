...
namespace Microsoft.Azure.Management.WindowsIoT
{
    ...
    /// </summary>
    internal partial class Operations : IServiceOperations<DeviceServicesClient>, IOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal Operations(DeviceServicesClient client)
        {
            if (client == null)
            {
        ...
        public async Task<AzureOperationResponse<IPage<OperationEntity>>> ListWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "providers/Microsoft.WindowsIoT/operations").ToString();
