...
#pragma warning disable SA1649 // File name should match first type name
    internal class PureStorageBlockArmOperation : ArmOperation
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        internal PureStorageBlockArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal PureStorageBlockArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal(nextLinkOperation, clientDiagnostics, response, "PureStorageBlockArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
