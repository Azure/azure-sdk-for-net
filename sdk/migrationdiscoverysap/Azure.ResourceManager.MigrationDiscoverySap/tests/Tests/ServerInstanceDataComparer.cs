...
{
    public class ServerInstanceDataComparer : IEqualityComparer<ServerInstanceData>
    {
        public bool Equals(ServerInstanceData x, ServerInstanceData y)
        {
        ...
        public int GetHashCode(ServerInstanceData serverData)
        {
