    ...
    internal class OperationStatusResultOperationSource : IOperationSource<OperationStatusResult>
    {
        OperationStatusResult IOperationSource<OperationStatusResult>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            return
				...
				global::System.ClientModel.Primitives.ModelReaderWriter.Read<global::Azure.ResourceManager.Models.OperationStatusResult>(new global::System.BinaryData(global::System.Runtime.InteropServices.JsonMarshal.GetRawUtf8Value(document.RootElement).ToArray()), global::Azure.ResourceManager.MigrationDiscoverySap.ModelSerializationExtensions.WireOptions, AzureResourceManagerMigrationDiscoverySapContext.Default)
#else
                ModelReaderWriter.Read<OperationStatusResult>(new BinaryData(Encoding.UTF8.GetBytes(document.RootElement.GetRawText())), ModelSerializationExtensions.WireOptions, AzureResourceManagerMigrationDiscoverySapContext.Default)
#endif
;
        }
