...
#pragma warning disable SA1649 // File name should match first type name
    internal class MigrationDiscoverySapArmOperation : ArmOperation
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        /// <summary> Initializes a new instance of MigrationDiscoverySapArmOperation for mocking. </summary>
        protected MigrationDiscoverySapArmOperation()
        {
        }

        internal MigrationDiscoverySapArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal MigrationDiscoverySapArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal(nextLinkOperation, clientDiagnostics, response, "MigrationDiscoverySapArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
        ...
        private string GetOperationId(RehydrationToken? rehydrationToken)
        {
            ...
            var lroDetails = ModelReaderWriter.Write(rehydrationToken, ModelReaderWriterOptions.Json, AzureResourceManagerMigrationDiscoverySapContext.Default).ToObjectFromJson<Dictionary<string, string>>();
