...
namespace Azure.ResourceManager.MigrationDiscoverySap
{
    ...
    public partial class SapInstanceResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<SapInstanceResource>> UpdateAsync(WaitUntil waitUntil, SapInstanceData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _sapInstancesRestClient.CreateCreateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, SapInstanceData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<SapInstanceResource> Update(WaitUntil waitUntil, SapInstanceData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
