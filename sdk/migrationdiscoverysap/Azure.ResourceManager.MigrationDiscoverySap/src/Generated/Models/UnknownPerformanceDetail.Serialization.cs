...
{
    internal partial class UnknownPerformanceDetail : PerformanceDetail, IJsonModel<PerformanceDetail>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownPerformanceDetail DeserializeUnknownPerformanceDetail(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownPerformanceDetail(dataSource, additionalBinaryDataProperties);
        }
    }
}
