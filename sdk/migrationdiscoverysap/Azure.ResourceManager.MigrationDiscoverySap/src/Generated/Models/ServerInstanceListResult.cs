...
namespace Azure.ResourceManager.MigrationDiscoverySap.Models
{
    ...
    internal partial class ServerInstanceListResult
    {
        ...
        internal ServerInstanceListResult(IList<SapDiscoveryServerInstanceData> value, Uri nextLink, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            NextLink = nextLink;
        ...
        public IList<SapDiscoveryServerInstanceData> Value { get; }
