...
namespace Azure.ResourceManager.MigrationDiscoverySap.Models
{
    ...
    public partial class OperationStatusResult
    {
        ...
        internal OperationStatusResult(string id, string name, string status, float? percentComplete, DateTimeOffset? startOn, DateTimeOffset? endOn, IReadOnlyList<ResourceManager.Models.OperationStatusResult> operations, ResponseError error, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Name = name;
            Status = status;
