...
namespace Azure.ResourceManager.MigrationDiscoverySap.Models
{
    public partial class SAPMigrateError : IUtf8JsonSerializable, IJsonModel<SAPMigrateError>
    {
        ...
        void IJsonModel<SAPMigrateError>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SAPMigrateError)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<SAPMigrateError>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SAPMigrateError)} does not support '{options.Format}' format.");
            }
        }
