...
namespace Azure.ResourceManager.MigrationDiscoverySap.Models
{
    ...
    public partial class SapDiscoveryErrorDetail
    {
        ...
        internal SapDiscoveryErrorDetail(string code, string message, string recommendation, IReadOnlyList<SapDiscoveryErrorDetail> details, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Code = code;
            Message = message;
