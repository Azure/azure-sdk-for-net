...
namespace Microsoft.Azure.Management.Datadog
{
    ...
    public partial interface IMarketplaceAgreementsOperations
    {
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationResponse<DatadogAgreementResource>> CreateWithHttpMessagesAsync(DatadogAgreementProperties properties = default(DatadogAgreementProperties), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// List Datadog marketplace agreements in the subscription.
        /// </summary>
