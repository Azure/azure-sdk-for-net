...
namespace Microsoft.Azure.Management.Datadog
{
    ...
    public partial interface IRefreshSetPasswordOperations
    {
        ...
        /// </exception>
        Task<AzureOperationResponse<DatadogSetPasswordLink>> GetWithHttpMessagesAsync(string resourceGroupName, string monitorName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
    }
}
