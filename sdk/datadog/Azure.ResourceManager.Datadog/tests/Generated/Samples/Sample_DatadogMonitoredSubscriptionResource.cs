...
{
    public partial class Sample_DatadogMonitoredSubscriptionResource
    {
        [Test]
        ...
        public async Task Get_MonitorsGetMonitoredSubscriptions()
        {
            ...
            DatadogMonitoredSubscriptionResource result = await datadogMonitoredSubscription.GetAsync();
        ...
        public async Task Delete_MonitorsDeleteMonitoredSubscriptions()
        {
            ...
            // invoke the operation
            await datadogMonitoredSubscription.DeleteAsync(WaitUntil.Completed);
