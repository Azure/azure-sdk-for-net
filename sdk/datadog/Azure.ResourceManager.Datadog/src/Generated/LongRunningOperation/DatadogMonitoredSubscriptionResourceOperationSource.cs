...
{
    /// <summary></summary>
    internal partial class DatadogMonitoredSubscriptionResourceOperationSource : IOperationSource<DatadogMonitoredSubscriptionResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal DatadogMonitoredSubscriptionResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
