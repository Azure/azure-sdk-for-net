...
namespace Azure.ResourceManager.Datadog
{
    internal partial class DatadogArmOperation<T> : ArmOperation<T>
    {
        ...
        internal DatadogArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
