...
namespace Azure.ResourceManager.Datadog
{
    public partial class LocationConnectorResource : IJsonModel<LinkerResourceData>
    {
        ...
        BinaryData IPersistableModel<LinkerResourceData>.Write(ModelReaderWriterOptions options) => ModelReaderWriter.Write<LinkerResourceData>(Data, options, AzureResourceManagerDatadogContext.Default);

        LinkerResourceData IPersistableModel<LinkerResourceData>.Create(BinaryData data, ModelReaderWriterOptions options) => ModelReaderWriter.Read<LinkerResourceData>(data, options, AzureResourceManagerDatadogContext.Default);
