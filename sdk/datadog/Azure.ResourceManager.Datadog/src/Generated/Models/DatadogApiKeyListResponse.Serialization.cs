...
namespace Azure.ResourceManager.Datadog.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DatadogApiKeyListResponse>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DatadogApiKeyListResponse>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DatadogApiKeyListResponse>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DatadogApiKeyListResponse>)} interface");
            }
        ...
        DatadogApiKeyListResponse IJsonModel<DatadogApiKeyListResponse>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        DatadogApiKeyListResponse IPersistableModel<DatadogApiKeyListResponse>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == "J" || options.Format == "W";
            if (!isValid)
            {
        ...
        string IPersistableModel<DatadogApiKeyListResponse>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
