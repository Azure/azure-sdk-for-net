...
namespace Azure.ResourceManager.Datadog.Models
{
    ...
    {
        internal static DatadogApiKeyListResponse DeserializeDatadogApiKeyListResponse(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
