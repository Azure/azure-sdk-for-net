...
namespace Azure.ResourceManager.Datadog.Models
{
    ...
    public partial class ServicePrincipalCertificateAuthInfo : AuthInfoBase
    {
        ...
        internal ServicePrincipalCertificateAuthInfo(AuthType authType, AuthMode? authMode, IDictionary<string, BinaryData> serializedAdditionalRawData, string clientId, string principalId, string certificate, DeleteOrUpdateBehavior? deleteOrUpdateBehavior, IList<string> roles) : base(authType, authMode, serializedAdditionalRawData)
        {
            ClientId = clientId;
            PrincipalId = principalId;
            Certificate = certificate;
