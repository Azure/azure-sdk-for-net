...
{
    internal partial class DatadogHostListResponse : IUtf8JsonSerializable, IJsonModel<DatadogHostListResponse>, IPersistableModel<DatadogHostListResponse>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DatadogHostListResponse>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<DatadogHostListResponse>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DatadogHostListResponse)} does not support '{format}' format.");
            }
