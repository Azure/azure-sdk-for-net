...
namespace Azure.ResourceManager.Datadog.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DatadogHostListResponse>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DatadogHostListResponse>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DatadogHostListResponse>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DatadogHostListResponse>)} interface");
            }
        ...
        string IPersistableModel<DatadogHostListResponse>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
