...
namespace Azure.ResourceManager.Datadog.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LinkedResourceListResponse>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<LinkedResourceListResponse>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<LinkedResourceListResponse>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<LinkedResourceListResponse>)} interface");
            }
        ...
        string IPersistableModel<LinkedResourceListResponse>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
