...
namespace Azure.ResourceManager.Datadog.Models
{
    ...
    public partial class DatadogSaaSResourceDetailsData : ResourceData
    {
        ...
        internal DatadogSaaSResourceDetailsData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string saaSId, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, name, resourceType, systemData)
        {
            SaaSId = saaSId;
