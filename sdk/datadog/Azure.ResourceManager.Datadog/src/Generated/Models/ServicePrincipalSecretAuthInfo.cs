...
namespace Azure.ResourceManager.Datadog.Models
{
    ...
    public partial class ServicePrincipalSecretAuthInfo : AuthInfoBase
    {
        ...
        internal ServicePrincipalSecretAuthInfo(AuthType authType, AuthMode? authMode, IDictionary<string, BinaryData> serializedAdditionalRawData, string clientId, string principalId, string secret, DeleteOrUpdateBehavior? deleteOrUpdateBehavior, IList<string> roles, string userName) : base(authType, authMode, serializedAdditionalRawData)
        {
            ClientId = clientId;
            PrincipalId = principalId;
            Secret = secret;
