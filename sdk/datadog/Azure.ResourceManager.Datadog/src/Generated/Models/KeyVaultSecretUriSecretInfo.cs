...
namespace Azure.ResourceManager.Datadog.Models
{
    ...
    public partial class KeyVaultSecretUriSecretInfo : SecretInfoBase
    {
        ...
        internal KeyVaultSecretUriSecretInfo(SecretType secretType, IDictionary<string, BinaryData> serializedAdditionalRawData, string value) : base(secretType, serializedAdditionalRawData)
        {
            Value = value;
