...
namespace Azure.ResourceManager.Datadog.Models
{
    ...
    public partial class DatadogAgreementProperties
    {
        ...
        internal DatadogAgreementProperties(string publisher, string product, string plan, string licenseTextLink, string privacyPolicyLink, DateTimeOffset? retrieveDatetime, string signature, bool? accepted, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Publisher = publisher;
            Product = product;
            Plan = plan;
