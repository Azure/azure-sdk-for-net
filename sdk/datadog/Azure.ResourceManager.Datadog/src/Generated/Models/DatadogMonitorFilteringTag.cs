...
namespace Azure.ResourceManager.Datadog.Models
{
    ...
    public partial class DatadogMonitorFilteringTag
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="DatadogMonitorFilteringTag"/>. </summary>
        ...
        internal DatadogMonitorFilteringTag(string name, string value, DatadogMonitorTagAction? action, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Name = name;
            Value = value;
            Action = action;
        ...
        public DatadogMonitorTagAction? Action { get; set; }
    }
}
