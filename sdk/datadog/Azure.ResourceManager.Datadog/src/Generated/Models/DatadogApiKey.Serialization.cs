...
namespace Azure.ResourceManager.Datadog.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DatadogApiKey>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DatadogApiKey>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DatadogApiKey>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DatadogApiKey>)} interface");
            }
        ...
        string IPersistableModel<DatadogApiKey>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
