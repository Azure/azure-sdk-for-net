...
namespace Azure.ResourceManager.Datadog
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DatadogMonitorResourceData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DatadogMonitorResourceData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DatadogMonitorResourceData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<DatadogMonitorResourceData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
