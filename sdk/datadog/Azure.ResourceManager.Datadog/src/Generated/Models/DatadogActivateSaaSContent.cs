...
namespace Azure.ResourceManager.Datadog.Models
{
    ...
    public partial class DatadogActivateSaaSContent
    {
        ...
        public DatadogActivateSaaSContent(string saaSResourceId)
        {
        ...
        internal DatadogActivateSaaSContent(string saaSResourceId, DatadogUserInfo userInfo, DatadogOrganizationProperties datadogOrganizationProperties, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            SaaSResourceId = saaSResourceId;
            UserInfo = userInfo;
