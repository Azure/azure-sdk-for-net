...
namespace Azure.ResourceManager.Datadog.Models
{
    ...
    public partial class KeyVaultSecretReferenceSecretInfo : SecretInfoBase
    {
        ...
        internal KeyVaultSecretReferenceSecretInfo(SecretType secretType, IDictionary<string, BinaryData> serializedAdditionalRawData, string name, string version) : base(secretType, serializedAdditionalRawData)
        {
            Name = name;
            Version = version;
