...
namespace Azure.ResourceManager.Datadog.Models
{
    ...
    public partial class DatadogHost
    {
        ...
        internal DatadogHost(string name, IReadOnlyList<string> aliases, IReadOnlyList<string> apps, DatadogHostMetadata meta, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Aliases = aliases;
            Apps = apps;
