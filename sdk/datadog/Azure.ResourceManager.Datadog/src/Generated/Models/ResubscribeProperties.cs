...
namespace Azure.ResourceManager.Datadog.Models
{
    ...
    public partial class ResubscribeProperties
    {
        ...
        internal ResubscribeProperties(ResourceSku sku, string azureSubscriptionId, string resourceGroup, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Sku = sku;
