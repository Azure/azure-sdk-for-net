...
namespace Azure.ResourceManager.Datadog.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MetricRules>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MetricRules>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MetricRules>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MetricRules>)} interface");
            }
        ...
        string IPersistableModel<MetricRules>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
