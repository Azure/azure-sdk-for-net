...
namespace Azure.ResourceManager.Datadog.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DatadogMonitorResourceListResponse>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DatadogMonitorResourceListResponse>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DatadogMonitorResourceListResponse>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DatadogMonitorResourceListResponse>)} interface");
            }
        ...
        string IPersistableModel<DatadogMonitorResourceListResponse>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
