...
{
    public partial class UserInfo : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static UserInfo DeserializeUserInfo(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
