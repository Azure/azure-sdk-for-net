...
namespace Azure.ResourceManager.Datadog.Models
{
    public partial class DatadogInstallMethod : IUtf8JsonSerializable, IJsonModel<DatadogInstallMethod>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  tool:");
                if (Tool.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(ToolVersion))
            {
                ...
                if (ToolVersion.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
                    builder.AppendLine($"{ToolVersion}'''");
                }
                else
                {
                    builder.AppendLine($" '{ToolVersion}'");
            ...
            if (Optional.IsDefined(InstallerVersion))
            {
                builder.Append("  installerVersion:");
                if (InstallerVersion.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
                    builder.AppendLine($"{InstallerVersion}'''");
                }
                else
                {
                    builder.AppendLine($" '{InstallerVersion}'");
