...
{
    public partial class DatadogHostMetadata : IUtf8JsonSerializable, IJsonModel<DatadogHostMetadata>, IPersistableModel<DatadogHostMetadata>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(InstallMethod))
            {
                builder.Append("  installMethod:");
                AppendChildObject(builder, InstallMethod, options, 2);
            }

            if (Optional.IsDefined(LogsAgent))
            {
                builder.Append("  logsAgent:");
                AppendChildObject(builder, LogsAgent, options, 2);
            }
