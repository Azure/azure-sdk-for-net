...
namespace Azure.ResourceManager.Datadog.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DatadogHostMetadata>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DatadogHostMetadata>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DatadogHostMetadata>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DatadogHostMetadata>)} interface");
            }
        ...
        string IPersistableModel<DatadogHostMetadata>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
