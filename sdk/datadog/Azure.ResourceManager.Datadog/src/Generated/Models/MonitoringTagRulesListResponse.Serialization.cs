...
namespace Azure.ResourceManager.Datadog.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MonitoringTagRulesListResponse>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MonitoringTagRulesListResponse>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MonitoringTagRulesListResponse>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MonitoringTagRulesListResponse>)} interface");
            }
        ...
        string IPersistableModel<MonitoringTagRulesListResponse>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
