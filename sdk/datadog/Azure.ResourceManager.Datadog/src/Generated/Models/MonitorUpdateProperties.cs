...
namespace Azure.ResourceManager.Datadog.Models
{
    ...
    public partial class MonitorUpdateProperties
    {
        ...
        /// <param name="resourceCollection"> The new resource collection value of the monitor resource. This collects configuration information for all resources in a subscription. </param>
        /// <param name="serializedAdditionalRawData"> Keeps track of any properties unknown to the library. </param>
        internal MonitorUpdateProperties(MonitoringStatus? monitoringStatus, bool? cspm, bool? resourceCollection, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
