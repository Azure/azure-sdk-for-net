...
namespace Azure.ResourceManager.Datadog.Models
{
    ...
    internal partial class DatadogSingleSignOnResourceListResponse
    {
        ...
        internal DatadogSingleSignOnResourceListResponse(IReadOnlyList<DatadogSingleSignOnResourceData> value, string nextLink, Dictionary<string, BinaryData> rawData)
        {
            Value = value;
            NextLink = nextLink;
            _rawData = rawData;
