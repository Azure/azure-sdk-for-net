...
namespace Azure.ResourceManager.Datadog.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DaprConfigurationList>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DaprConfigurationList)} does not support writing '{format}' format.");
            }
        ...
        DaprConfigurationList IJsonModel<DaprConfigurationList>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DaprConfigurationList)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<DaprConfigurationList>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(DaprConfigurationList)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        DaprConfigurationList IPersistableModel<DaprConfigurationList>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(DaprConfigurationList)} does not support reading '{options.Format}' format.");
            }
        }
