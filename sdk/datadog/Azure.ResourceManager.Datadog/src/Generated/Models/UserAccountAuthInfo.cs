...
namespace Azure.ResourceManager.Datadog.Models
{
    ...
    public partial class UserAccountAuthInfo : AuthInfoBase
    {
        ...
        internal UserAccountAuthInfo(AuthType authType, AuthMode? authMode, IDictionary<string, BinaryData> serializedAdditionalRawData, string principalId, DeleteOrUpdateBehavior? deleteOrUpdateBehavior, IList<string> roles, string userName) : base(authType, authMode, serializedAdditionalRawData)
        {
