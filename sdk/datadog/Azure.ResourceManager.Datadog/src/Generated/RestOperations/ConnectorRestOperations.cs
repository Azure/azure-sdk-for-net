...
namespace Azure.ResourceManager.Datadog
{
    internal partial class ConnectorRestOperations
    {
        ...
        internal RequestUriBuilder CreateUpdateRequestUri(string subscriptionId, string resourceGroupName, AzureLocation location, string connectorName, LinkerPatch patch)
        {
            var uri = new RawRequestUriBuilder();
            uri.Reset(_endpoint);
            uri.AppendPath("/subscriptions/", false);
