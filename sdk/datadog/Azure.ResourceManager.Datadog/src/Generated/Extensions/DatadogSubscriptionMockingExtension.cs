...
namespace Azure.ResourceManager.Datadog.Mocking
{
    ...
    internal partial class DatadogSubscriptionMockingExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="DatadogSubscriptionMockingExtension"/> class for mocking. </summary>
        protected DatadogSubscriptionMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="DatadogSubscriptionMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal DatadogSubscriptionMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<DatadogAgreementResource> GetMarketplaceAgreementsAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, DatadogAgreementResource.DeserializeDatadogAgreementResource, MarketplaceAgreementsClientDiagnostics, Pipeline, "DatadogSubscriptionMockingExtension.GetMarketplaceAgreements", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<DatadogAgreementResource> GetMarketplaceAgreements(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => MarketplaceAgreementsRestClient.CreateListRequest(Id.SubscriptionId);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => MarketplaceAgreementsRestClient.CreateListNextPageRequest(nextLink, Id.SubscriptionId);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, DatadogAgreementResource.DeserializeDatadogAgreementResource, MarketplaceAgreementsClientDiagnostics, Pipeline, "DatadogSubscriptionMockingExtension.GetMarketplaceAgreements", "value", "nextLink", cancellationToken);
        }
        ...
        {
            using var scope = MarketplaceAgreementsClientDiagnostics.CreateScope("DatadogSubscriptionMockingExtension.CreateOrUpdateMarketplaceAgreement");
            scope.Start();
            try
            {
