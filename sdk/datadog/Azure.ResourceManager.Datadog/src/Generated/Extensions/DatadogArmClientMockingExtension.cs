...
namespace Azure.ResourceManager.Datadog.Mocking
{
    ...
    internal partial class DatadogArmClientMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="DatadogArmClientMockingExtension"/> class for mocking. </summary>
        protected DatadogArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="DatadogArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal DatadogArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal DatadogArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
