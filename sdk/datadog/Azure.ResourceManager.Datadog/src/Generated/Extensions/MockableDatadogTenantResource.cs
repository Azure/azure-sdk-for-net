...
namespace Azure.ResourceManager.Datadog.Mocking
{
    ...
    public partial class MockableDatadogTenantResource : ArmResource
    {
        ...
        private ClientDiagnostics ConfigurationNamesClientDiagnostics => _configurationNamesClientDiagnostics ??= new ClientDiagnostics("Azure.ResourceManager.Datadog", ProviderConstants.DefaultProviderNamespace, Diagnostics);
        ...
        public virtual AsyncPageable<ConfigurationNameItem> GetConfigurationNamesAsync(string filter = null, string skipToken = null, CancellationToken cancellationToken = default)
        {
            ...
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => ConfigurationNameItem.DeserializeConfigurationNameItem(e), ConfigurationNamesClientDiagnostics, Pipeline, "MockableDatadogTenantResource.GetConfigurationNames", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<ConfigurationNameItem> GetConfigurationNames(string filter = null, string skipToken = null, CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => ConfigurationNamesRestClient.CreateListRequest(filter, skipToken);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => ConfigurationNamesRestClient.CreateListNextPageRequest(nextLink, filter, skipToken);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => ConfigurationNameItem.DeserializeConfigurationNameItem(e), ConfigurationNamesClientDiagnostics, Pipeline, "MockableDatadogTenantResource.GetConfigurationNames", "value", "nextLink", cancellationToken);
        }
    }
}
