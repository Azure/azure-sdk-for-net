...
namespace Azure.ResourceManager.Datadog.Mock
{
    ...
    public partial class DatadogMonitorResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="DatadogMonitorResourceExtension"/> class for mocking. </summary>
        protected DatadogMonitorResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="DatadogMonitorResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal DatadogMonitorResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
