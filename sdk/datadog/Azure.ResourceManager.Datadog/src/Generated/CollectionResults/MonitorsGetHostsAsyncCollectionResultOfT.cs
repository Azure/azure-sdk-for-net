...
{
    internal partial class MonitorsGetHostsAsyncCollectionResultOfT : AsyncPageable<DatadogHost>
    {
        ...
        public MonitorsGetHostsAsyncCollectionResultOfT(Monitors client, string subscriptionId, string resourceGroupName, string monitorName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
