...
namespace Azure.ResourceManager.Datadog
{
    internal partial class MonitorsGetMonitoredResourcesAsyncCollectionResultOfT : AsyncPageable<DatadogMonitoredResourceResult>
    {
        ...
        public MonitorsGetMonitoredResourcesAsyncCollectionResultOfT(Monitors client, string subscriptionId, string resourceGroupName, string monitorName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
