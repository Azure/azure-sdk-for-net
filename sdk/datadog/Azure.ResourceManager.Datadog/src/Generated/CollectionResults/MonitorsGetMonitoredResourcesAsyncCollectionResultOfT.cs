...
{
    internal partial class MonitorsGetMonitoredResourcesAsyncCollectionResultOfT : AsyncPageable<DatadogMonitoredResourceResult>
    {
        ...
        public MonitorsGetMonitoredResourcesAsyncCollectionResultOfT(Monitors client, string subscriptionId, string resourceGroupName, string monitorName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <returns> The pages of MonitorsGetMonitoredResourcesAsyncCollectionResultOfT as an enumerable collection. </returns>
        public override async IAsyncEnumerable<Page<DatadogMonitoredResourceResult>> AsPages(string continuationToken, int? pageSizeHint)
        {
        ...
        private async ValueTask<Response> GetNextResponseAsync(int? pageSizeHint, Uri nextLink)
        {
            ...
            using DiagnosticScope scope = _client.ClientDiagnostics.CreateScope("DatadogMonitorResource.GetMonitoredResources");
            scope.Start();
            try
            {
