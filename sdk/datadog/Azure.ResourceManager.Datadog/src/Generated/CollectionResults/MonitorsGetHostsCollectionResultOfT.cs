...
namespace Azure.ResourceManager.Datadog
{
    internal partial class MonitorsGetHostsCollectionResultOfT : Pageable<DatadogHost>
    {
        ...
        public MonitorsGetHostsCollectionResultOfT(Monitors client, string subscriptionId, string resourceGroupName, string monitorName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
