...
{
    internal partial class CreationSupportedGetSubscriptionStatusesCollectionResultOfT : Pageable<DatadogSubscriptionStatusResult>
    {
        private readonly CreationSupported _client;
        ...
        /// <returns> The pages of CreationSupportedGetSubscriptionStatusesCollectionResultOfT as an enumerable collection. </returns>
        public override IEnumerable<Page<DatadogSubscriptionStatusResult>> AsPages(string continuationToken, int? pageSizeHint)
        {
