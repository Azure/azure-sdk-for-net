...
namespace Azure.ResourceManager.Datadog
{
    ...
    public partial class DatadogSingleSignOnResourceData : ResourceData
    {
        ...
        internal DatadogSingleSignOnResourceData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, DatadogSingleSignOnProperties properties, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
