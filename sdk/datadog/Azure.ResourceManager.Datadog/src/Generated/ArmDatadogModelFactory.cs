...
namespace Azure.ResourceManager.Datadog.Models
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="Datadog.DryrunResourceData"/>. </summary>
        ...
        /// Please note <see cref="DatadogDryrunParametersContent"/> is the base class. According to the scenario, a derived class of the base class might need to be assigned here, or this property needs to be casted to one of the possible derived classes.
        /// The available derived classes include <see cref="Models.DatadogCreateOrUpdateDryrunParametersContent"/>.
        /// </param>
        ...
        /// <returns> A new <see cref="Datadog.DryrunResourceData"/> instance for mocking. </returns>
        public static DryrunResourceData DryrunResourceData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, DatadogDryrunParametersContent parameters = null, IEnumerable<DryrunPrerequisiteResult> prerequisiteResults = null, IEnumerable<DryrunOperationPreview> operationPreviews = null, string provisioningState = null)
        {
        ...
        public static DryrunPatch DryrunPatch(DatadogDryrunParametersContent parameters = null, IEnumerable<DryrunPrerequisiteResult> prerequisiteResults = null, IEnumerable<DryrunOperationPreview> operationPreviews = null, string provisioningState = null)
        {
            prerequisiteResults ??= new List<DryrunPrerequisiteResult>();
            operationPreviews ??= new List<DryrunOperationPreview>();
        ...
        /// <summary> Initializes a new instance of <see cref="Datadog.LinkerResourceData"/>. </summary>
        /// <param name="id"> The id. </param>
        /// <param name="name"> The name. </param>
        /// <param name="resourceType"> The resourceType. </param>
        /// <param name="systemData"> The systemData. </param>
        ...
        /// <returns> A new <see cref="Datadog.LinkerResourceData"/> instance for mocking. </returns>
        ...
        /// <summary> Initializes a new instance of <see cref="Models.LinkerPatch"/>. </summary>
        /// <param name="targetService">
        /// The target service properties
        /// Please note <see cref="TargetServiceBase"/> is the base class. According to the scenario, a derived class of the base class might need to be assigned here, or this property needs to be casted to one of the possible derived classes.
        /// The available derived classes include <see cref="AzureResource"/>, <see cref="ConfluentBootstrapServer"/>, <see cref="ConfluentSchemaRegistry"/>, <see cref="FabricPlatform"/> and <see cref="SelfHostedServer"/>.
        ...
        /// <param name="publicNetworkSolution"> The network solution. </param>
        /// <param name="configurationInfo"> The connection information consumed by applications, including secrets, connection strings. </param>
        /// <returns> A new <see cref="Models.LinkerPatch"/> instance for mocking. </returns>
        public static LinkerPatch LinkerPatch(TargetServiceBase targetService = null, AuthInfoBase authInfo = null, ClientType? clientType = null, string provisioningState = null, VNetSolution vNetSolution = null, SecretStore secretStore = null, string scope = null, PublicNetworkSolution publicNetworkSolution = null, ConfigurationInfo configurationInfo = null)
        {
        ...
        /// <summary> Initializes a new instance of <see cref="Models.ValidateOperationResult"/>. </summary>
        ...
        /// <summary> Initializes a new instance of <see cref="Models.ValidationResultItem"/>. </summary>
        ...
        /// <summary> Initializes a new instance of <see cref="Models.ConfigurationResult"/>. </summary>
        ...
        public static ConfigurationNameItem ConfigurationNameItem(string targetService = null, ClientType? clientType = null, AuthType? authType = null, SecretSourceType? secretType = null, DaprProperties daprProperties = null, IEnumerable<ConfigurationName> names = null)
        {
        ...
        public static DaprConfigurationResource DaprConfigurationResource(string targetType = null, AuthType? authType = null, DaprProperties daprProperties = null)
        {
            return new DaprConfigurationResource(targetType, authType, daprProperties, serializedAdditionalRawData: null);
        }

        /// <summary> Initializes a new instance of <see cref="Models.DatadogCreateOrUpdateDryrunParametersContent"/>. </summary>
        /// <param name="targetService">
        /// The target service properties
        /// Please note <see cref="TargetServiceBase"/> is the base class. According to the scenario, a derived class of the base class might need to be assigned here, or this property needs to be casted to one of the possible derived classes.
        /// The available derived classes include <see cref="AzureResource"/>, <see cref="ConfluentBootstrapServer"/>, <see cref="ConfluentSchemaRegistry"/>, <see cref="FabricPlatform"/> and <see cref="SelfHostedServer"/>.
        ...
        /// <param name="publicNetworkSolution"> The network solution. </param>
        /// <param name="configurationInfo"> The connection information consumed by applications, including secrets, connection strings. </param>
        /// <returns> A new <see cref="Models.DatadogCreateOrUpdateDryrunParametersContent"/> instance for mocking. </returns>
        public static DatadogCreateOrUpdateDryrunParametersContent DatadogCreateOrUpdateDryrunParametersContent(TargetServiceBase targetService = null, AuthInfoBase authInfo = null, ClientType? clientType = null, string provisioningState = null, VNetSolution vNetSolution = null, SecretStore secretStore = null, string scope = null, PublicNetworkSolution publicNetworkSolution = null, ConfigurationInfo configurationInfo = null)
        {
