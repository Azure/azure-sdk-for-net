...
namespace Azure.ResourceManager.Datadog.Models
{
    ...
    public static partial class ArmDatadogModelFactory
    {
        ...
        {
            return new DatadogAgreementResourceProperties(id, name, resourceType, systemData, properties, new Dictionary<string, BinaryData>());
        }
        ...
        public static DatadogHost DatadogHost(string name = null, IEnumerable<string> aliases = null, IEnumerable<string> apps = null, DatadogHostMetadata meta = null)
        {
            ...
            return new DatadogHost(name, aliases?.ToList(), apps?.ToList(), meta, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DatadogHostMetadata(agentVersion, installMethod, logsAgentTransport != null ? new DatadogLogsAgent(logsAgentTransport, new Dictionary<string, BinaryData>()) : null, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DatadogInstallMethod(tool, toolVersion, installerVersion, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MonitoredResourceContent(id, sendingMetrics, reasonForMetricsStatus, sendingLogs, reasonForLogsStatus, new Dictionary<string, BinaryData>());
        }
        ...
        public static DatadogMonitorResourceData DatadogMonitorResourceData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, string skuName = null, MonitorProperties properties = null, ManagedServiceIdentity identity = null)
        {
            ...
            return new DatadogMonitorResourceData(id, name, resourceType, systemData, tags, location, skuName != null ? new ResourceSku(skuName, new Dictionary<string, BinaryData>()) : null, properties, identity, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MonitorProperties(provisioningState, monitoringStatus, marketplaceSubscriptionStatus, datadogOrganizationProperties, userInfo, liftrResourceCategory, liftrResourcePreference, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DatadogOrganizationProperties(name, id, linkingAuthCode, linkingClientId, redirectUri, apiKey, applicationKey, enterpriseAppId, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DatadogSetPasswordLink(setPasswordLink, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MonitoringTagRuleData(id, name, resourceType, systemData, properties, new Dictionary<string, BinaryData>());
        }
        ...
        public static MonitoringTagRulesProperties MonitoringTagRulesProperties(ProvisioningState? provisioningState = null, LogRules logRules = null, IEnumerable<FilteringTag> metricRulesFilteringTags = null)
        {
            ...
            return new MonitoringTagRulesProperties(provisioningState, logRules, metricRulesFilteringTags != null ? new MetricRules(metricRulesFilteringTags?.ToList(), new Dictionary<string, BinaryData>()) : null, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DatadogSingleSignOnResourceData(id, name, resourceType, systemData, properties, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DatadogSingleSignOnProperties(provisioningState, singleSignOnState, enterpriseAppId, singleSignOnUri, new Dictionary<string, BinaryData>());
        }
    }
}
