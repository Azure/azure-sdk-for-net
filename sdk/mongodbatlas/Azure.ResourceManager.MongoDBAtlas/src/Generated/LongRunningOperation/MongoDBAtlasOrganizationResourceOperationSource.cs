...
{
    /// <summary></summary>
    internal partial class MongoDBAtlasOrganizationResourceOperationSource : IOperationSource<MongoDBAtlasOrganizationResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal MongoDBAtlasOrganizationResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
