...
namespace Azure.ResourceManager.MongoDBAtlas
{
    internal partial class MongoDBAtlasArmOperation : ArmOperation
    {
        ...
        internal MongoDBAtlasArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
