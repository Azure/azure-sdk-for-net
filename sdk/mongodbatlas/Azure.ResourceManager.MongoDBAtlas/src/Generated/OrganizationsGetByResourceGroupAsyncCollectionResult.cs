...
{
    internal partial class OrganizationsGetByResourceGroupAsyncCollectionResult : AsyncPageable<BinaryData>
    {
        ...
        /// <summary> Initializes a new instance of OrganizationsGetByResourceGroupAsyncCollectionResult, which is used to iterate over the pages of a collection. </summary>
        ...
        public OrganizationsGetByResourceGroupAsyncCollectionResult(Organizations client, Guid subscriptionId, string resourceGroupName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
        ...
        /// <summary> Gets the pages of OrganizationsGetByResourceGroupAsyncCollectionResult as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of OrganizationsGetByResourceGroupAsyncCollectionResult as an enumerable collection. </returns>
