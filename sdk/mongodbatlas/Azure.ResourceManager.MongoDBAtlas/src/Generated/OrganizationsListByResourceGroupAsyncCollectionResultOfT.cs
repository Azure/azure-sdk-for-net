...
{
    internal partial class OrganizationsListByResourceGroupAsyncCollectionResultOfT : AsyncPageable<MongoDBAtlasOrganizationData>
    {
        ...
        /// <summary> Initializes a new instance of OrganizationsListByResourceGroupAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public OrganizationsListByResourceGroupAsyncCollectionResultOfT(Organizations client, Uri nextPage, Guid subscriptionId, string resourceGroupName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
        ...
        /// <summary> Gets the pages of OrganizationsListByResourceGroupAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of OrganizationsListByResourceGroupAsyncCollectionResultOfT as an enumerable collection. </returns>
