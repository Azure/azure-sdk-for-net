...
namespace Azure.ResourceManager.MongoDBAtlas
{
    ...
    public partial class MongoDBAtlasOrganizationResource : ArmResource
    {
        ...
        /// <summary>
        /// Updates the MongoDBAtlasOrganization.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/MongoDB.Atlas/organizations/{organizationName}. </description>
        ...
        public virtual async Task<ArmOperation<MongoDBAtlasOrganizationResource>> UpdateAsync(WaitUntil waitUntil, MongoDBAtlasOrganizationData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _organizationsRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, MongoDBAtlasOrganizationData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                MongoDBAtlasArmOperation<MongoDBAtlasOrganizationResource> operation = new MongoDBAtlasArmOperation<MongoDBAtlasOrganizationResource>(
                    new MongoDBAtlasOrganizationResourceOperationSource(Client),
                    _organizationsClientDiagnostics,
        ...
        public virtual async Task<Response<MongoDBAtlasOrganizationResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                {
                    MongoDBAtlasOrganizationData current = (await GetAsync(cancellationToken: cancellationToken).ConfigureAwait(false)).Value.Data;
                    ...
                    ArmOperation<MongoDBAtlasOrganizationResource> result = await UpdateAsync(WaitUntil.Completed, patch, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<MongoDBAtlasOrganizationResource> AddTag(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                {
                    MongoDBAtlasOrganizationData current = Get(cancellationToken: cancellationToken).Value.Data;
                    MongoDBAtlasOrganizationPatch patch = new MongoDBAtlasOrganizationPatch();
                    foreach (KeyValuePair<string, string> tag in current.Tags)
                    {
                        patch.Tags.Add(tag);
                    ...
                    patch.Tags[key] = value;
                    ArmOperation<MongoDBAtlasOrganizationResource> result = Update(WaitUntil.Completed, patch, cancellationToken: cancellationToken);
                    return Response.FromValue(result.Value, result.GetRawResponse());
                }
            }
            catch (Exception e)
