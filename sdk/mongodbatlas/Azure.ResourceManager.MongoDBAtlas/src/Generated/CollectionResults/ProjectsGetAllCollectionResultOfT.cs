...
namespace Azure.ResourceManager.MongoDBAtlas
{
    internal partial class ProjectsGetAllCollectionResultOfT : Pageable<MongoDBAtlasProjectData>
    {
        ...
        public ProjectsGetAllCollectionResultOfT(Projects client, Guid subscriptionId, string resourceGroupName, string organizationName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
