...
namespace Azure.ResourceManager.MongoDBAtlas
{
    internal partial class ClustersGetAllAsyncCollectionResultOfT : AsyncPageable<ClusterData>
    {
        ...
        public ClustersGetAllAsyncCollectionResultOfT(Clusters client, Guid subscriptionId, string resourceGroupName, string organizationName, string projectName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
