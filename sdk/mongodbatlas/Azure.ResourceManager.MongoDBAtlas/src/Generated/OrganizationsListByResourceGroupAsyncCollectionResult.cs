...
{
    internal partial class OrganizationsListByResourceGroupAsyncCollectionResult : AsyncPageable<BinaryData>
    {
        ...
        /// <summary> Initializes a new instance of OrganizationsListByResourceGroupAsyncCollectionResult, which is used to iterate over the pages of a collection. </summary>
        ...
        public OrganizationsListByResourceGroupAsyncCollectionResult(Organizations client, Uri nextPage, Guid subscriptionId, string resourceGroupName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
        ...
        /// <summary> Gets the pages of OrganizationsListByResourceGroupAsyncCollectionResult as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of OrganizationsListByResourceGroupAsyncCollectionResult as an enumerable collection. </returns>
        ...
        private async ValueTask<Response> GetNextResponse(int? pageSizeHint, Uri nextLink)
        {
            ...
            using DiagnosticScope scope = _client.ClientDiagnostics.CreateScope("Organizations.ListByResourceGroup");
            scope.Start();
            try
            {
