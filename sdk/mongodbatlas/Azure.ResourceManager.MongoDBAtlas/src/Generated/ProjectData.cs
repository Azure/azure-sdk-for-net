...
namespace Azure.ResourceManager.MongoDBAtlas
{
    ...
    public partial class ProjectData : ResourceData
    {
        ...
        internal ProjectData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, ProjectProperties properties, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, name, resourceType, systemData)
        {
