...
namespace Azure.ResourceManager.MongoDBAtlas.Models
{
    ...
    public partial class MongoDBAtlasOrganizationUpdateProperties : IJsonModel<MongoDBAtlasOrganizationUpdateProperties>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<MongoDBAtlasOrganizationUpdateProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        MongoDBAtlasOrganizationUpdateProperties IJsonModel<MongoDBAtlasOrganizationUpdateProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual MongoDBAtlasOrganizationUpdateProperties JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<MongoDBAtlasOrganizationUpdateProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static MongoDBAtlasOrganizationUpdateProperties DeserializeMongoDBAtlasOrganizationUpdateProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new MongoDBAtlasOrganizationUpdateProperties(user, partnerProperties, additionalBinaryDataProperties);
        }

        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<MongoDBAtlasOrganizationUpdateProperties>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        MongoDBAtlasOrganizationUpdateProperties IPersistableModel<MongoDBAtlasOrganizationUpdateProperties>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual MongoDBAtlasOrganizationUpdateProperties PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<MongoDBAtlasOrganizationUpdateProperties>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
