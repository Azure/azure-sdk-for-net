...
namespace Azure.ResourceManager.MongoDBAtlas.Models
{
    ...
    internal partial class OrganizationResourceListResult
    {
        ...
        internal OrganizationResourceListResult(IList<MongoDBAtlasOrganizationData> value, Uri nextLink, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            NextLink = nextLink;
        ...
        public IList<MongoDBAtlasOrganizationData> Value { get; }
