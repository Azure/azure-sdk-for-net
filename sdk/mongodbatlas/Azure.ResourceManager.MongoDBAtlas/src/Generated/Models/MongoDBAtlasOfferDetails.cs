...
namespace Azure.ResourceManager.MongoDBAtlas.Models
{
    ...
    public partial class MongoDBAtlasOfferDetails
    {
        ...
        internal MongoDBAtlasOfferDetails(string publisherId, string offerId, string planId, string planName, string termUnit, string termId, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            PublisherId = publisherId;
            OfferId = offerId;
            PlanId = planId;
