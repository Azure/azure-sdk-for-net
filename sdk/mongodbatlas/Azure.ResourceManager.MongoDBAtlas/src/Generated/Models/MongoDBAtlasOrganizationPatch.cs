...
namespace Azure.ResourceManager.MongoDBAtlas.Models
{
    ...
    public partial class MongoDBAtlasOrganizationPatch
    {
        ...
        internal MongoDBAtlasOrganizationPatch(ManagedServiceIdentity identity, IDictionary<string, string> tags, OrganizationResourceUpdateProperties properties, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Identity = identity;
            Tags = tags;
