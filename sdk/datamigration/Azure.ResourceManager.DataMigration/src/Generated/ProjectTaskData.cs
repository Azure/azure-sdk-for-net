...
namespace Azure.ResourceManager.DataMigration
{
    ...
    public partial class ProjectTaskData : ResourceData
    {
        ...
        internal ProjectTaskData(ResourceIdentifier id, string name, Core.ResourceType resourceType, SystemData systemData, ETag? etag, ProjectTaskProperties properties, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
            ETag = etag;
