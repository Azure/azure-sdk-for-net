...
namespace Azure.ResourceManager.DataMigration
{
    ...
    public partial class DatabaseMigrationSqlDbData : ResourceData
    {
        ...
        internal DatabaseMigrationSqlDbData(ResourceIdentifier id, string name, Core.ResourceType resourceType, SystemData systemData, DatabaseMigrationPropertiesSqlDb properties) : base(id, name, resourceType, systemData)
        {
            Properties = properties;
        }

        /// <summary> Database Migration Resource properties for SQL database. </summary>
        public DatabaseMigrationPropertiesSqlDb Properties { get; set; }
    }
}
