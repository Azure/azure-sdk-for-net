...
{
    /// <summary>
    /// A class representing the DataMigrationProjectTask data model.
    /// A task resource
    /// </summary>
    public partial class DataMigrationProjectTaskData : ResourceData
    {
        ...
        internal DataMigrationProjectTaskData(ResourceIdentifier id, string name, Core.ResourceType resourceType, SystemData systemData, ETag? etag, DataMigrationProjectTaskProperties properties, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
            ETag = etag;
