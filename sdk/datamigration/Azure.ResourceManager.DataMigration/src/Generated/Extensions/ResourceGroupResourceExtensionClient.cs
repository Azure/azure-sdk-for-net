...
namespace Azure.ResourceManager.DataMigration
{
    ...
    internal partial class ResourceGroupResourceExtensionClient : ArmResource
    {
        ...
        public virtual DatabaseMigrationSqlDbResourceCollection GetDatabaseMigrationSqlDbResources()
        {
            return GetCachedClient(Client => new DatabaseMigrationSqlDbResourceCollection(Client, Id));
        }
        ...
        public virtual DatabaseMigrationSqlMiResourceCollection GetDatabaseMigrationSqlMiResources()
        {
            return GetCachedClient(Client => new DatabaseMigrationSqlMiResourceCollection(Client, Id));
        }
        ...
        public virtual DatabaseMigrationSqlVmResourceCollection GetDatabaseMigrationSqlVmResources()
        {
            return GetCachedClient(Client => new DatabaseMigrationSqlVmResourceCollection(Client, Id));
        }
