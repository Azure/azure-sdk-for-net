...
namespace Azure.ResourceManager.DataMigration
{
    ...
    public static partial class DataMigrationExtensions
    {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="location"/> or <paramref name="nameAvailabilityRequest"/> is null. </exception>
        public static async Task<Response<NameAvailabilityResponse>> CheckNameAvailabilityServiceAsync(this SubscriptionResource subscriptionResource, string location, NameAvailabilityRequest nameAvailabilityRequest, CancellationToken cancellationToken = default)
        {
        ...
        /// <exception cref="ArgumentException"> <paramref name="location"/> is an empty string, and was expected to be non-empty. </exception>
        /// <exception cref="ArgumentNullException"> <paramref name="location"/> or <paramref name="nameAvailabilityRequest"/> is null. </exception>
        public static Response<NameAvailabilityResponse> CheckNameAvailabilityService(this SubscriptionResource subscriptionResource, string location, NameAvailabilityRequest nameAvailabilityRequest, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(location, nameof(location));
            Argument.AssertNotNull(nameAvailabilityRequest, nameof(nameAvailabilityRequest));
        ...
        public static AsyncPageable<Quota> GetUsagesAsync(this SubscriptionResource subscriptionResource, string location, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(location, nameof(location));
        ...
        public static Pageable<Quota> GetUsages(this SubscriptionResource subscriptionResource, string location, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(location, nameof(location));
        ...
        public static DatabaseMigrationSqlDbResourceCollection GetDatabaseMigrationSqlDbResources(this ResourceGroupResource resourceGroupResource)
        {
            return GetExtensionClient(resourceGroupResource).GetDatabaseMigrationSqlDbResources();
        }
        ...
        [ForwardsClientCalls]
        public static async Task<Response<DatabaseMigrationSqlDbResource>> GetDatabaseMigrationSqlDbResourceAsync(this ResourceGroupResource resourceGroupResource, string sqlDbInstanceName, string targetDbName, Guid? migrationOperationId = null, string expand = null, CancellationToken cancellationToken = default)
        {
            return await resourceGroupResource.GetDatabaseMigrationSqlDbResources().GetAsync(sqlDbInstanceName, targetDbName, migrationOperationId, expand, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="sqlDbInstanceName"/> or <paramref name="targetDbName"/> is null. </exception>
        [ForwardsClientCalls]
        public static Response<DatabaseMigrationSqlDbResource> GetDatabaseMigrationSqlDbResource(this ResourceGroupResource resourceGroupResource, string sqlDbInstanceName, string targetDbName, Guid? migrationOperationId = null, string expand = null, CancellationToken cancellationToken = default)
        {
            return resourceGroupResource.GetDatabaseMigrationSqlDbResources().Get(sqlDbInstanceName, targetDbName, migrationOperationId, expand, cancellationToken);
        }
        ...
        public static DatabaseMigrationSqlMiResourceCollection GetDatabaseMigrationSqlMiResources(this ResourceGroupResource resourceGroupResource)
        {
            return GetExtensionClient(resourceGroupResource).GetDatabaseMigrationSqlMiResources();
        }
        ...
        [ForwardsClientCalls]
        public static async Task<Response<DatabaseMigrationSqlMiResource>> GetDatabaseMigrationSqlMiResourceAsync(this ResourceGroupResource resourceGroupResource, string managedInstanceName, string targetDbName, Guid? migrationOperationId = null, string expand = null, CancellationToken cancellationToken = default)
        {
            return await resourceGroupResource.GetDatabaseMigrationSqlMiResources().GetAsync(managedInstanceName, targetDbName, migrationOperationId, expand, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="managedInstanceName"/> or <paramref name="targetDbName"/> is null. </exception>
        [ForwardsClientCalls]
        public static Response<DatabaseMigrationSqlMiResource> GetDatabaseMigrationSqlMiResource(this ResourceGroupResource resourceGroupResource, string managedInstanceName, string targetDbName, Guid? migrationOperationId = null, string expand = null, CancellationToken cancellationToken = default)
        {
            return resourceGroupResource.GetDatabaseMigrationSqlMiResources().Get(managedInstanceName, targetDbName, migrationOperationId, expand, cancellationToken);
        }
        ...
        public static DatabaseMigrationSqlVmResourceCollection GetDatabaseMigrationSqlVmResources(this ResourceGroupResource resourceGroupResource)
        {
            return GetExtensionClient(resourceGroupResource).GetDatabaseMigrationSqlVmResources();
        }
        ...
        [ForwardsClientCalls]
        public static async Task<Response<DatabaseMigrationSqlVmResource>> GetDatabaseMigrationSqlVmResourceAsync(this ResourceGroupResource resourceGroupResource, string sqlVirtualMachineName, string targetDbName, Guid? migrationOperationId = null, string expand = null, CancellationToken cancellationToken = default)
        {
            return await resourceGroupResource.GetDatabaseMigrationSqlVmResources().GetAsync(sqlVirtualMachineName, targetDbName, migrationOperationId, expand, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="sqlVirtualMachineName"/> or <paramref name="targetDbName"/> is null. </exception>
        [ForwardsClientCalls]
        public static Response<DatabaseMigrationSqlVmResource> GetDatabaseMigrationSqlVmResource(this ResourceGroupResource resourceGroupResource, string sqlVirtualMachineName, string targetDbName, Guid? migrationOperationId = null, string expand = null, CancellationToken cancellationToken = default)
        {
            return resourceGroupResource.GetDatabaseMigrationSqlVmResources().Get(sqlVirtualMachineName, targetDbName, migrationOperationId, expand, cancellationToken);
        }
        ...
        #region DatabaseMigrationSqlDbDatabaseMigrationCancelResource
        /// <summary>
        /// Gets an object representing a <see cref="DatabaseMigrationSqlDbDatabaseMigrationCancelResource" /> along with the instance operations that can be performed on it but with no data.
        /// You can use <see cref="DatabaseMigrationSqlDbDatabaseMigrationCancelResource.CreateResourceIdentifier" /> to create a <see cref="DatabaseMigrationSqlDbDatabaseMigrationCancelResource" /> <see cref="ResourceIdentifier" /> from its components.
        /// </summary>
        /// <param name="client"> The <see cref="ArmClient" /> instance the method will execute against. </param>
        /// <param name="id"> The resource ID of the resource to get. </param>
        /// <returns> Returns a <see cref="DatabaseMigrationSqlDbDatabaseMigrationCancelResource" /> object. </returns>
        public static DatabaseMigrationSqlDbDatabaseMigrationCancelResource GetDatabaseMigrationSqlDbDatabaseMigrationCancelResource(this ArmClient client, ResourceIdentifier id)
        {
            return client.GetResourceClient(() =>
            {
                DatabaseMigrationSqlDbDatabaseMigrationCancelResource.ValidateResourceId(id);
                return new DatabaseMigrationSqlDbDatabaseMigrationCancelResource(client, id);
            }
            );
        }
        #endregion
        ...
        #region DatabaseMigrationSqlMiDatabaseMigrationCancelResource
        /// <summary>
        /// Gets an object representing a <see cref="DatabaseMigrationSqlMiDatabaseMigrationCancelResource" /> along with the instance operations that can be performed on it but with no data.
        /// You can use <see cref="DatabaseMigrationSqlMiDatabaseMigrationCancelResource.CreateResourceIdentifier" /> to create a <see cref="DatabaseMigrationSqlMiDatabaseMigrationCancelResource" /> <see cref="ResourceIdentifier" /> from its components.
        /// </summary>
        /// <param name="client"> The <see cref="ArmClient" /> instance the method will execute against. </param>
        /// <param name="id"> The resource ID of the resource to get. </param>
        /// <returns> Returns a <see cref="DatabaseMigrationSqlMiDatabaseMigrationCancelResource" /> object. </returns>
        public static DatabaseMigrationSqlMiDatabaseMigrationCancelResource GetDatabaseMigrationSqlMiDatabaseMigrationCancelResource(this ArmClient client, ResourceIdentifier id)
        {
            return client.GetResourceClient(() =>
            {
                DatabaseMigrationSqlMiDatabaseMigrationCancelResource.ValidateResourceId(id);
                return new DatabaseMigrationSqlMiDatabaseMigrationCancelResource(client, id);
            }
            );
        }
        #endregion

        #region DatabaseMigrationSqlMiDatabaseMigrationCutoverResource
        /// <summary>
        /// Gets an object representing a <see cref="DatabaseMigrationSqlMiDatabaseMigrationCutoverResource" /> along with the instance operations that can be performed on it but with no data.
        /// You can use <see cref="DatabaseMigrationSqlMiDatabaseMigrationCutoverResource.CreateResourceIdentifier" /> to create a <see cref="DatabaseMigrationSqlMiDatabaseMigrationCutoverResource" /> <see cref="ResourceIdentifier" /> from its components.
        /// </summary>
        /// <param name="client"> The <see cref="ArmClient" /> instance the method will execute against. </param>
        /// <param name="id"> The resource ID of the resource to get. </param>
        /// <returns> Returns a <see cref="DatabaseMigrationSqlMiDatabaseMigrationCutoverResource" /> object. </returns>
        public static DatabaseMigrationSqlMiDatabaseMigrationCutoverResource GetDatabaseMigrationSqlMiDatabaseMigrationCutoverResource(this ArmClient client, ResourceIdentifier id)
        {
            return client.GetResourceClient(() =>
            {
                DatabaseMigrationSqlMiDatabaseMigrationCutoverResource.ValidateResourceId(id);
                return new DatabaseMigrationSqlMiDatabaseMigrationCutoverResource(client, id);
            }
            );
        }
        #endregion
        ...
        #region DatabaseMigrationSqlVmDatabaseMigrationCancelResource
        /// <summary>
        /// Gets an object representing a <see cref="DatabaseMigrationSqlVmDatabaseMigrationCancelResource" /> along with the instance operations that can be performed on it but with no data.
        /// You can use <see cref="DatabaseMigrationSqlVmDatabaseMigrationCancelResource.CreateResourceIdentifier" /> to create a <see cref="DatabaseMigrationSqlVmDatabaseMigrationCancelResource" /> <see cref="ResourceIdentifier" /> from its components.
        /// </summary>
        /// <param name="client"> The <see cref="ArmClient" /> instance the method will execute against. </param>
        /// <param name="id"> The resource ID of the resource to get. </param>
        /// <returns> Returns a <see cref="DatabaseMigrationSqlVmDatabaseMigrationCancelResource" /> object. </returns>
        public static DatabaseMigrationSqlVmDatabaseMigrationCancelResource GetDatabaseMigrationSqlVmDatabaseMigrationCancelResource(this ArmClient client, ResourceIdentifier id)
        {
            return client.GetResourceClient(() =>
            {
                DatabaseMigrationSqlVmDatabaseMigrationCancelResource.ValidateResourceId(id);
                return new DatabaseMigrationSqlVmDatabaseMigrationCancelResource(client, id);
            }
            );
        }
        #endregion

        #region DatabaseMigrationSqlVmDatabaseMigrationCutoverResource
        /// <summary>
        /// Gets an object representing a <see cref="DatabaseMigrationSqlVmDatabaseMigrationCutoverResource" /> along with the instance operations that can be performed on it but with no data.
        /// You can use <see cref="DatabaseMigrationSqlVmDatabaseMigrationCutoverResource.CreateResourceIdentifier" /> to create a <see cref="DatabaseMigrationSqlVmDatabaseMigrationCutoverResource" /> <see cref="ResourceIdentifier" /> from its components.
        /// </summary>
        /// <param name="client"> The <see cref="ArmClient" /> instance the method will execute against. </param>
        /// <param name="id"> The resource ID of the resource to get. </param>
        /// <returns> Returns a <see cref="DatabaseMigrationSqlVmDatabaseMigrationCutoverResource" /> object. </returns>
        public static DatabaseMigrationSqlVmDatabaseMigrationCutoverResource GetDatabaseMigrationSqlVmDatabaseMigrationCutoverResource(this ArmClient client, ResourceIdentifier id)
        {
            return client.GetResourceClient(() =>
            {
                DatabaseMigrationSqlVmDatabaseMigrationCutoverResource.ValidateResourceId(id);
                return new DatabaseMigrationSqlVmDatabaseMigrationCutoverResource(client, id);
            }
            );
        }
        #endregion
