...
namespace Azure.ResourceManager.DataMigration.Mock
{
    ...
    public partial class SqlMigrationServiceResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="SqlMigrationServiceResourceExtension"/> class for mocking. </summary>
        protected SqlMigrationServiceResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="SqlMigrationServiceResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal SqlMigrationServiceResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
