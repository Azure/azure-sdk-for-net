...
namespace Azure.ResourceManager.DataMigration.Mocking
{
    ...
    internal partial class DataMigrationArmClientMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="DataMigrationArmClientMockingExtension"/> class for mocking. </summary>
        protected DataMigrationArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="DataMigrationArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal DataMigrationArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal DataMigrationArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
