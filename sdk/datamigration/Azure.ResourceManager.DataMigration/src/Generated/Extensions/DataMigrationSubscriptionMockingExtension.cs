...
namespace Azure.ResourceManager.DataMigration.Mocking
{
    ...
    public partial class DataMigrationSubscriptionMockingExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="DataMigrationSubscriptionMockingExtension"/> class for mocking. </summary>
        protected DataMigrationSubscriptionMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="DataMigrationSubscriptionMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal DataMigrationSubscriptionMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<ResourceSku> GetSkusResourceSkusAsync(CancellationToken cancellationToken = default)
        {
            ...
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, ResourceSku.DeserializeResourceSku, ResourceSkusClientDiagnostics, Pipeline, "DataMigrationSubscriptionMockingExtension.GetSkusResourceSkus", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<ResourceSku> GetSkusResourceSkus(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => ResourceSkusRestClient.CreateListSkusRequest(Id.SubscriptionId);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => ResourceSkusRestClient.CreateListSkusNextPageRequest(nextLink, Id.SubscriptionId);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, ResourceSku.DeserializeResourceSku, ResourceSkusClientDiagnostics, Pipeline, "DataMigrationSubscriptionMockingExtension.GetSkusResourceSkus", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual async Task<Response<NameAvailabilityResponse>> CheckNameAvailabilityServiceAsync(AzureLocation location, NameAvailabilityRequest nameAvailabilityRequest, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = DataMigrationServiceServicesClientDiagnostics.CreateScope("DataMigrationSubscriptionMockingExtension.CheckNameAvailabilityService");
            scope.Start();
            try
            {
        ...
        public virtual AsyncPageable<Quota> GetUsagesAsync(AzureLocation location, CancellationToken cancellationToken = default)
        {
            ...
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, Quota.DeserializeQuota, UsagesClientDiagnostics, Pipeline, "DataMigrationSubscriptionMockingExtension.GetUsages", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<Quota> GetUsages(AzureLocation location, CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => UsagesRestClient.CreateListRequest(Id.SubscriptionId, location);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => UsagesRestClient.CreateListNextPageRequest(nextLink, Id.SubscriptionId, location);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, Quota.DeserializeQuota, UsagesClientDiagnostics, Pipeline, "DataMigrationSubscriptionMockingExtension.GetUsages", "value", "nextLink", cancellationToken);
        }
    }
}
