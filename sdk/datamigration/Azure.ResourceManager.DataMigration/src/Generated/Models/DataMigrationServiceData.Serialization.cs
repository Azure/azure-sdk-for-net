...
namespace Azure.ResourceManager.DataMigration
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataMigrationServiceData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DataMigrationServiceData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DataMigrationServiceData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DataMigrationServiceData>)} interface");
            }
        ...
        string IPersistableModel<DataMigrationServiceData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
