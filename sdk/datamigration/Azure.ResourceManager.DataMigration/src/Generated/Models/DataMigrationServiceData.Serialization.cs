...
{
    public partial class DataMigrationServiceData : IUtf8JsonSerializable, IJsonModel<DataMigrationServiceData>, IPersistableModel<DataMigrationServiceData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(VirtualSubnetId))
            {
                builder.Append("  virtualSubnetId:");
                builder.AppendLine($" '{VirtualSubnetId}'");
            }

            if (Optional.IsDefined(VirtualNicId))
            {
                builder.Append("  virtualNicId:");
                builder.AppendLine($" '{VirtualNicId}'");
            }

            if (Optional.IsDefined(AutoStopDelay))
            {
                builder.Append("  autoStopDelay:");
                builder.AppendLine($" '{AutoStopDelay}'");
            }

            if (Optional.IsDefined(DeleteResourcesOnStop))
            {
                builder.Append("  deleteResourcesOnStop:");
                var boolValue = DeleteResourcesOnStop.Value == true ? "true" : "false";
