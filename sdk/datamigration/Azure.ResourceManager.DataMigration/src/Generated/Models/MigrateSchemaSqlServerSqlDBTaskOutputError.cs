...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class MigrateSchemaSqlServerSqlDBTaskOutputError : MigrateSchemaSqlServerSqlDBTaskOutput
    {
        ...
        internal MigrateSchemaSqlServerSqlDBTaskOutputError(string id, string resultType, string commandText, string errorText, Dictionary<string, BinaryData> rawData) : base(id, resultType, rawData)
        {
