...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class MigrateSqlServerSqlMITaskOutputError : MigrateSqlServerSqlMITaskOutput
    {
        ...
        internal MigrateSqlServerSqlMITaskOutputError() : base("ErrorOutput")
        {
        }
        ...
        internal MigrateSqlServerSqlMITaskOutputError(string id, string resultType, IDictionary<string, BinaryData> additionalBinaryDataProperties, DataMigrationReportableException error) : base(id, resultType, additionalBinaryDataProperties)
        {
            Error = error;
        }
