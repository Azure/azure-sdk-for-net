...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class MigrateSqlServerSqlMITaskOutputError : MigrateSqlServerSqlMITaskOutput
    {
        ...
        internal MigrateSqlServerSqlMITaskOutputError(string id, string resultType, IDictionary<string, BinaryData> serializedAdditionalRawData, DataMigrationReportableException error) : base(id, resultType, serializedAdditionalRawData)
        {
            Error = error;
