...
{
    public partial class GetUserTablesOracleTaskInput : IUtf8JsonSerializable, IJsonModel<GetUserTablesOracleTaskInput>, IPersistableModel<GetUserTablesOracleTaskInput>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(SelectedSchemas))
            {
                builder.Append("  selectedSchemas:");
                builder.AppendLine(" [");
                foreach (var item in SelectedSchemas)
                {
                    if (item == null)
