...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GetUserTablesOracleTaskInput>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<GetUserTablesOracleTaskInput>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<GetUserTablesOracleTaskInput>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<GetUserTablesOracleTaskInput>)} interface");
            }
        ...
        string IPersistableModel<GetUserTablesOracleTaskInput>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
