...
namespace Azure.ResourceManager.DataMigration.Models
{
    public partial class ConnectToSourceSqlServerTaskOutputDatabaseLevel : IUtf8JsonSerializable, IModelJsonSerializable<ConnectToSourceSqlServerTaskOutputDatabaseLevel>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<ConnectToSourceSqlServerTaskOutputDatabaseLevel>(this, options.Format);
        ...
        internal static ConnectToSourceSqlServerTaskOutputDatabaseLevel DeserializeConnectToSourceSqlServerTaskOutputDatabaseLevel(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new ConnectToSourceSqlServerTaskOutputDatabaseLevel(id.Value, resultType, name.Value, Optional.ToNullable(sizeMB), Optional.ToList(databaseFiles), Optional.ToNullable(compatibilityLevel), Optional.ToNullable(databaseState), serializedAdditionalRawData);
        }
