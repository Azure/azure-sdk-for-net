...
{
    public partial class DatabaseMigrationSqlVmData : IUtf8JsonSerializable
    {
        ...
        internal static DatabaseMigrationSqlVmData DeserializeDatabaseMigrationSqlVmData(JsonElement element)
        {
            ...
            return new DatabaseMigrationSqlVmData(id, name, type, systemData.Value, properties.Value);
        }
    }
}
