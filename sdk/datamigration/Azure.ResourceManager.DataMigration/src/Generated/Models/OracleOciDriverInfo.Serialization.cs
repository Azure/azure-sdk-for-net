    ...
    public partial class OracleOciDriverInfo : IUtf8JsonSerializable, IJsonModel<OracleOciDriverInfo>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(DriverName))
            {
                ...
                if (DriverName.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(DriverSize))
            {
                ...
                if (DriverSize.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
                    builder.AppendLine($"{DriverSize}'''");
                }
                else
                {
                    builder.AppendLine($" '{DriverSize}'");
            ...
            {
                builder.Append("  archiveChecksum:");
                if (ArchiveChecksum.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
                    builder.AppendLine($"{ArchiveChecksum}'''");
                }
                else
                {
                    builder.AppendLine($" '{ArchiveChecksum}'");
            ...
            {
                builder.Append("  oracleChecksum:");
                if (OracleChecksum.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
                    builder.AppendLine($"{OracleChecksum}'''");
                }
                else
                {
                    builder.AppendLine($" '{OracleChecksum}'");
            ...
            {
                if (SupportedOracleVersions.Any())
                {
                    builder.Append("  supportedOracleVersions:");
                    builder.AppendLine(" [");
                    foreach (var item in SupportedOracleVersions)
                    {
                        if (item == null)
