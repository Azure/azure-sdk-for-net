...
namespace Azure.ResourceManager.DataMigration.Models
{
    public partial class OracleOciDriverInfo : IUtf8JsonSerializable, IJsonModel<OracleOciDriverInfo>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<OracleOciDriverInfo>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<OracleOciDriverInfo>)} interface");
            }
