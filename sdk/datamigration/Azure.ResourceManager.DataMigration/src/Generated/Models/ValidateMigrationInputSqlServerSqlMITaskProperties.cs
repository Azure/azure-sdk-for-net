...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class ValidateMigrationInputSqlServerSqlMITaskProperties : DataMigrationProjectTaskProperties
    {
        ...
        internal ValidateMigrationInputSqlServerSqlMITaskProperties(DataMigrationTaskType taskType, IReadOnlyList<DataMigrationODataError> errors, DataMigrationTaskState? state, IReadOnlyList<DataMigrationCommandProperties> commands, IDictionary<string, string> clientData, IDictionary<string, BinaryData> additionalBinaryDataProperties, ValidateMigrationInputSqlServerSqlMITaskInput input, IReadOnlyList<ValidateMigrationInputSqlServerSqlMITaskOutput> output) : base(taskType, errors, state, commands, clientData, additionalBinaryDataProperties)
        {
            Input = input;
            Output = output;
        }
