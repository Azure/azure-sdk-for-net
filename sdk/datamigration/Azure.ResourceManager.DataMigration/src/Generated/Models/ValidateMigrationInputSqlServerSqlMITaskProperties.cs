...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class ValidateMigrationInputSqlServerSqlMITaskProperties : ProjectTaskProperties
    {
        ...
        internal ValidateMigrationInputSqlServerSqlMITaskProperties(TaskType taskType, IReadOnlyList<ODataError> errors, TaskState? state, IReadOnlyList<CommandProperties> commands, IDictionary<string, string> clientData, ValidateMigrationInputSqlServerSqlMITaskInput input, IReadOnlyList<ValidateMigrationInputSqlServerSqlMITaskOutput> output) : base(taskType, errors, state, commands, clientData)
        {
            Input = input;
            Output = output;
            TaskType = taskType;
