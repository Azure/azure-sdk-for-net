...
namespace Azure.ResourceManager.DataMigration.Models
{
    public partial class MigrateOracleAzureDBPostgreSqlSyncTaskOutputDatabaseError : IUtf8JsonSerializable, IModelJsonSerializable<MigrateOracleAzureDBPostgreSqlSyncTaskOutputDatabaseError>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<MigrateOracleAzureDBPostgreSqlSyncTaskOutputDatabaseError>(this, options.Format);
        ...
        internal static MigrateOracleAzureDBPostgreSqlSyncTaskOutputDatabaseError DeserializeMigrateOracleAzureDBPostgreSqlSyncTaskOutputDatabaseError(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new MigrateOracleAzureDBPostgreSqlSyncTaskOutputDatabaseError(id.Value, resultType, errorMessage.Value, Optional.ToList(events), serializedAdditionalRawData);
        }
        ...
        /// <summary> Converts a <see cref="MigrateOracleAzureDBPostgreSqlSyncTaskOutputDatabaseError"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="MigrateOracleAzureDBPostgreSqlSyncTaskOutputDatabaseError"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="MigrateOracleAzureDBPostgreSqlSyncTaskOutputDatabaseError"/>. </summary>
