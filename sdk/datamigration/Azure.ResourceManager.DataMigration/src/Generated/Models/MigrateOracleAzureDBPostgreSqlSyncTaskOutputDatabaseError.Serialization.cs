...
{
    public partial class MigrateOracleAzureDBPostgreSqlSyncTaskOutputDatabaseError : IUtf8JsonSerializable, IJsonModel<MigrateOracleAzureDBPostgreSqlSyncTaskOutputDatabaseError>, IPersistableModel<MigrateOracleAzureDBPostgreSqlSyncTaskOutputDatabaseError>
    {
        ...
        void IJsonModel<MigrateOracleAzureDBPostgreSqlSyncTaskOutputDatabaseError>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MigrateOracleAzureDBPostgreSqlSyncTaskOutputDatabaseError)} does not support '{format}' format.");
            }
