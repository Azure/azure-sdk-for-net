...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class DatabaseFileInfo
    {
        ...
        internal DatabaseFileInfo(string databaseName, string id, string logicalName, string physicalFullName, string restoreFullName, DatabaseFileType? fileType, double? sizeMB, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
