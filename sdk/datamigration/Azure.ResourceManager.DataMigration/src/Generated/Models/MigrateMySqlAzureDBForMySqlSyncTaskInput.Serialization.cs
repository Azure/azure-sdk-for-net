...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MigrateMySqlAzureDBForMySqlSyncTaskInput>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MigrateMySqlAzureDBForMySqlSyncTaskInput>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MigrateMySqlAzureDBForMySqlSyncTaskInput>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MigrateMySqlAzureDBForMySqlSyncTaskInput>)} interface");
            }
        ...
        string IPersistableModel<MigrateMySqlAzureDBForMySqlSyncTaskInput>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
