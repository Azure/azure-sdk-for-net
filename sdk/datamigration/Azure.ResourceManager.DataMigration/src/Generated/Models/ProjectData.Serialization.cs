...
namespace Azure.ResourceManager.DataMigration
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ProjectData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ProjectData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ProjectData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ProjectData>)} interface");
            }
        ...
        string IPersistableModel<ProjectData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
