...
{
    public partial class ValidateMongoDBTaskProperties : Core.IUtf8JsonSerializable
    {
        ...
        internal static ValidateMongoDBTaskProperties DeserializeValidateMongoDBTaskProperties(JsonElement element)
        {
            ...
            Core.Optional<MongoDBMigrationSettings> input = default;
            Core.Optional<IReadOnlyList<MongoDBMigrationProgress>> output = default;
            ...
            return new ValidateMongoDBTaskProperties(taskType, Core.Optional.ToList(errors), Core.Optional.ToNullable(state), Core.Optional.ToList(commands), Core.Optional.ToDictionary(clientData), input.Value, Core.Optional.ToList(output));
        }
    }
}
