...
{
    public partial class ValidateMongoDBTaskProperties : IUtf8JsonSerializable
    {
        ...
        internal static ValidateMongoDBTaskProperties DeserializeValidateMongoDBTaskProperties(JsonElement element)
        {
            ...
            return new ValidateMongoDBTaskProperties(taskType, Optional.ToList(errors), Optional.ToNullable(state), Optional.ToList(commands), Optional.ToDictionary(clientData), input.Value, Optional.ToList(output));
        }
    }
}
