...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ConnectToTargetAzureDBForPostgreSqlSyncTaskOutput>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        ConnectToTargetAzureDBForPostgreSqlSyncTaskOutput IJsonModel<ConnectToTargetAzureDBForPostgreSqlSyncTaskOutput>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<ConnectToTargetAzureDBForPostgreSqlSyncTaskOutput>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ConnectToTargetAzureDBForPostgreSqlSyncTaskOutput IModel<ConnectToTargetAzureDBForPostgreSqlSyncTaskOutput>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<ConnectToTargetAzureDBForPostgreSqlSyncTaskOutput>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
