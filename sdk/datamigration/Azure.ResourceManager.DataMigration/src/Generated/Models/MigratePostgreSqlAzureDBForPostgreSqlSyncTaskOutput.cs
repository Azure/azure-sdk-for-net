...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    /// </summary>
    [DeserializationProxy(typeof(UnknownMigratePostgreSqlAzureDBForPostgreSqlSyncTaskOutput))]
    public abstract partial class MigratePostgreSqlAzureDBForPostgreSqlSyncTaskOutput
    {
        ...
        internal MigratePostgreSqlAzureDBForPostgreSqlSyncTaskOutput(string id, string resultType, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
