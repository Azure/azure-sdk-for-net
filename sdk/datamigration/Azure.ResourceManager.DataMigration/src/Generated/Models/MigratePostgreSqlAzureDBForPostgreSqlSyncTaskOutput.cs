...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    /// </summary>
    [AbstractTypeDeserializer(typeof(UnknownMigratePostgreSqlAzureDBForPostgreSqlSyncTaskOutput))]
    public abstract partial class MigratePostgreSqlAzureDBForPostgreSqlSyncTaskOutput
    {
        ...
        internal MigratePostgreSqlAzureDBForPostgreSqlSyncTaskOutput(string id, string resultType, Dictionary<string, BinaryData> rawData)
        {
            Id = id;
