...
{
    public partial class GetUserTablesSqlTaskOutput : IUtf8JsonSerializable, IJsonModel<GetUserTablesSqlTaskOutput>, IPersistableModel<GetUserTablesSqlTaskOutput>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  databasesToTables:");
                builder.AppendLine($" '{DatabasesToTables}'");
            }
