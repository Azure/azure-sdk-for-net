...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GetUserTablesSqlTaskOutput>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        internal static GetUserTablesSqlTaskOutput DeserializeGetUserTablesSqlTaskOutput(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new GetUserTablesSqlTaskOutput(id, databasesToTables, validationErrors ?? new ChangeTrackingList<DataMigrationReportableException>(), serializedAdditionalRawData);
        }
