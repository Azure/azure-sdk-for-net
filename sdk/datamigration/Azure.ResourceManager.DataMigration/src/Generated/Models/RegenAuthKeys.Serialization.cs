...
{
    public partial class RegenAuthKeys : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static RegenAuthKeys DeserializeRegenAuthKeys(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
