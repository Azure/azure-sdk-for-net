...
{
    public partial class ConnectToSourceSqlServerTaskInput : IUtf8JsonSerializable, IJsonModel<ConnectToSourceSqlServerTaskInput>, IPersistableModel<ConnectToSourceSqlServerTaskInput>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(CollectDatabases))
            {
                builder.Append("  collectDatabases:");
                var boolValue = CollectDatabases.Value == true ? "true" : "false";
            ...
            if (Optional.IsDefined(CollectTdeCertificateInfo))
            {
                builder.Append("  collectTdeCertificateInfo:");
                var boolValue = CollectTdeCertificateInfo.Value == true ? "true" : "false";
                builder.AppendLine($" {boolValue}");
            }
