...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class MigrateSqlServerSqlMITaskProperties : DataMigrationProjectTaskProperties, IJsonModel<MigrateSqlServerSqlMITaskProperties>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<MigrateSqlServerSqlMITaskProperties>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<MigrateSqlServerSqlMITaskProperties>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        MigrateSqlServerSqlMITaskProperties IPersistableModel<MigrateSqlServerSqlMITaskProperties>.Create(BinaryData data, ModelReaderWriterOptions options) => (MigrateSqlServerSqlMITaskProperties)PersistableModelCreateCore(data, options);
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (options.Format != "W" && Optional.IsCollectionDefined(Output))
            {
                ...
                foreach (MigrateSqlServerSqlMITaskOutput item in Output)
                {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        MigrateSqlServerSqlMITaskProperties IJsonModel<MigrateSqlServerSqlMITaskProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (MigrateSqlServerSqlMITaskProperties)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static MigrateSqlServerSqlMITaskProperties DeserializeMigrateSqlServerSqlMITaskProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("input"u8))
                {
                    ...
                    input = MigrateSqlServerSqlMITaskInput.DeserializeMigrateSqlServerSqlMITaskInput(prop.Value, options);
                    continue;
                }
                ...
                if (prop.NameEquals("parentTaskId"u8))
                {
                    parentTaskId = prop.Value.GetString();
                    continue;
                }
