...
{
    public partial class SqlConnectionInfo : IUtf8JsonSerializable, IJsonModel<SqlConnectionInfo>, IPersistableModel<SqlConnectionInfo>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Platform))
            {
                ...
                builder.AppendLine($" '{Platform.ToString()}'");
            }
