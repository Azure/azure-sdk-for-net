...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    {
        internal static SqlDBOfflineConfiguration DeserializeSqlDBOfflineConfiguration(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
