...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SqlFileShare>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SqlFileShare>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SqlFileShare>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SqlFileShare>)} interface");
            }
        ...
        string IPersistableModel<SqlFileShare>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
