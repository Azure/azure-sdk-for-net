...
{
    public partial class MongoDBDatabaseSettings : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static MongoDBDatabaseSettings DeserializeMongoDBDatabaseSettings(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
