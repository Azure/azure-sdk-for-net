...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class ConnectToSourcePostgreSqlSyncTaskOutput
    {
        ...
        internal ConnectToSourcePostgreSqlSyncTaskOutput(string id, string sourceServerVersion, IReadOnlyList<string> databases, string sourceServerBrandVersion, IReadOnlyList<DataMigrationReportableException> validationErrors, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Id = id;
