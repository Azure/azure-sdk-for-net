...
namespace Azure.ResourceManager.DataMigration.Models
{
    public partial class DataIntegrityValidationResult : IUtf8JsonSerializable, IJsonModel<DataIntegrityValidationResult>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<DataIntegrityValidationResult>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DataIntegrityValidationResult>)} interface");
            }
