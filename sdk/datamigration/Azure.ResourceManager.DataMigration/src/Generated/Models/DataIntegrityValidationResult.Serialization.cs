...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataIntegrityValidationResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DataIntegrityValidationResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DataIntegrityValidationResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<DataIntegrityValidationResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
