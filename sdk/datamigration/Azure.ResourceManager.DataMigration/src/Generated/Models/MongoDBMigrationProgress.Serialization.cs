...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    {
        internal static MongoDBMigrationProgress DeserializeMongoDBMigrationProgress(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
