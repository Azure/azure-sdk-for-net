...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MongoDBMigrationProgress>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MongoDBMigrationProgress>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MongoDBMigrationProgress>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MongoDBMigrationProgress>)} interface");
            }
        ...
        string IPersistableModel<MongoDBMigrationProgress>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
