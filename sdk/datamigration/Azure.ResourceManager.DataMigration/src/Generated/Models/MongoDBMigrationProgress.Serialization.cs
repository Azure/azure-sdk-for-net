...
namespace Azure.ResourceManager.DataMigration.Models
{
    public partial class MongoDBMigrationProgress : IUtf8JsonSerializable, IModelJsonSerializable<MongoDBMigrationProgress>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<MongoDBMigrationProgress>(this, options.Format);
            ...
            if (Optional.IsCollectionDefined(Databases))
            {
                ...
                foreach (var item in Databases)
                {
                    ...
                    {
                        ((IModelJsonSerializable<MongoDBDatabaseProgress>)item.Value).Serialize(writer, options);
                    }
                }
        ...
        /// <summary> Converts a <see cref="MongoDBMigrationProgress"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="MongoDBMigrationProgress"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="MongoDBMigrationProgress"/>. </summary>
