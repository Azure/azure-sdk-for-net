...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SqlBackupSetInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SqlBackupSetInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SqlBackupSetInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<SqlBackupSetInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
