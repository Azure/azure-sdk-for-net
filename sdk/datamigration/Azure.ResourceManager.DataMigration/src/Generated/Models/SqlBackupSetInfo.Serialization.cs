...
namespace Azure.ResourceManager.DataMigration.Models
{
    public partial class SqlBackupSetInfo : IUtf8JsonSerializable, IModelJsonSerializable<SqlBackupSetInfo>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<SqlBackupSetInfo>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="SqlBackupSetInfo"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="SqlBackupSetInfo"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="SqlBackupSetInfo"/>. </summary>
