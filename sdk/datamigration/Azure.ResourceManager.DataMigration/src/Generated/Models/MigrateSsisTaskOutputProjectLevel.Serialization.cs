...
namespace Azure.ResourceManager.DataMigration.Models
{
    public partial class MigrateSsisTaskOutputProjectLevel : IUtf8JsonSerializable, IModelJsonSerializable<MigrateSsisTaskOutputProjectLevel>
    {
        ...
        internal static MigrateSsisTaskOutputProjectLevel DeserializeMigrateSsisTaskOutputProjectLevel(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new MigrateSsisTaskOutputProjectLevel(id.Value, resultType, folderName.Value, projectName.Value, Optional.ToNullable(state), Optional.ToNullable(stage), Optional.ToNullable(startedOn), Optional.ToNullable(endedOn), message.Value, Optional.ToList(exceptionsAndWarnings), serializedAdditionalRawData);
        }
