...
namespace Azure.ResourceManager.DataMigration
{
    public partial class ProjectFileData : IUtf8JsonSerializable, IJsonModel<ProjectFileData>
    {
        ...
        void IJsonModel<ProjectFileData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(ProjectFileData)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ProjectFileData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(ProjectFileData)} does not support '{options.Format}' format.");
            }
        }
