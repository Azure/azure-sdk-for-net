...
namespace Azure.ResourceManager.DataMigration
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ProjectFileData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ProjectFileData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ProjectFileData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ProjectFileData>)} interface");
            }
        ...
        string IPersistableModel<ProjectFileData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
