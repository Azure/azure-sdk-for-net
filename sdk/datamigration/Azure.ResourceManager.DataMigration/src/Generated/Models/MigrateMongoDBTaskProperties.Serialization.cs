...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class MigrateMongoDBTaskProperties : DataMigrationProjectTaskProperties, IJsonModel<MigrateMongoDBTaskProperties>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<MigrateMongoDBTaskProperties>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<MigrateMongoDBTaskProperties>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        MigrateMongoDBTaskProperties IPersistableModel<MigrateMongoDBTaskProperties>.Create(BinaryData data, ModelReaderWriterOptions options) => (MigrateMongoDBTaskProperties)PersistableModelCreateCore(data, options);
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (options.Format != "W" && Optional.IsCollectionDefined(Output))
            {
                ...
                foreach (DataMigrationMongoDBProgress item in Output)
                {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        MigrateMongoDBTaskProperties IJsonModel<MigrateMongoDBTaskProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (MigrateMongoDBTaskProperties)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static MigrateMongoDBTaskProperties DeserializeMigrateMongoDBTaskProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            IReadOnlyList<DataMigrationMongoDBProgress> output = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("output"u8))
                {
                    ...
                    List<DataMigrationMongoDBProgress> array = new List<DataMigrationMongoDBProgress>();
                    foreach (var item in prop.Value.EnumerateArray())
                    {
                        array.Add(DataMigrationMongoDBProgress.DeserializeDataMigrationMongoDBProgress(item, options));
                    }
                    output = array;
                    continue;
                }
