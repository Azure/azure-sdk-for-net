...
{
    public partial class MigrateMongoDBTaskProperties : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static MigrateMongoDBTaskProperties DeserializeMigrateMongoDBTaskProperties(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
