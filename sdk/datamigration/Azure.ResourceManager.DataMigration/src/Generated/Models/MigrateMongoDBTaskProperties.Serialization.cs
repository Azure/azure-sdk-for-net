...
{
    public partial class MigrateMongoDBTaskProperties : Core.IUtf8JsonSerializable
    {
        ...
        internal static MigrateMongoDBTaskProperties DeserializeMigrateMongoDBTaskProperties(JsonElement element)
        {
            ...
            Core.Optional<IReadOnlyList<MongoDBProgress>> output = default;
            ...
            return new MigrateMongoDBTaskProperties(taskType, Core.Optional.ToList(errors), Core.Optional.ToNullable(state), Core.Optional.ToList(commands), Core.Optional.ToDictionary(clientData), input.Value, Core.Optional.ToList(output));
        }
    }
}
