...
namespace Azure.ResourceManager.DataMigration.Models
{
    public partial class ConnectToTargetOracleAzureDBForPostgreSqlSyncTaskProperties : IUtf8JsonSerializable, IModelJsonSerializable<ConnectToTargetOracleAzureDBForPostgreSqlSyncTaskProperties>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<ConnectToTargetOracleAzureDBForPostgreSqlSyncTaskProperties>(this, options.Format);
            ...
            if (Optional.IsDefined(Input))
            {
                ...
                {
                    ((IModelJsonSerializable<ConnectToTargetOracleAzureDBForPostgreSqlSyncTaskInput>)Input).Serialize(writer, options);
                }
            }
        ...
        internal static ConnectToTargetOracleAzureDBForPostgreSqlSyncTaskProperties DeserializeConnectToTargetOracleAzureDBForPostgreSqlSyncTaskProperties(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new ConnectToTargetOracleAzureDBForPostgreSqlSyncTaskProperties(taskType, Optional.ToList(errors), Optional.ToNullable(state), Optional.ToList(commands), Optional.ToDictionary(clientData), input.Value, Optional.ToList(output), serializedAdditionalRawData);
        }
        ...
        /// <summary> Converts a <see cref="ConnectToTargetOracleAzureDBForPostgreSqlSyncTaskProperties"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="ConnectToTargetOracleAzureDBForPostgreSqlSyncTaskProperties"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="ConnectToTargetOracleAzureDBForPostgreSqlSyncTaskProperties"/>. </summary>
