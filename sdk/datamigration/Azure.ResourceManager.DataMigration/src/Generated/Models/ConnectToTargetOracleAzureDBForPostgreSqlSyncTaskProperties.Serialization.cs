...
{
    public partial class ConnectToTargetOracleAzureDBForPostgreSqlSyncTaskProperties : Core.IUtf8JsonSerializable
    {
        ...
        internal static ConnectToTargetOracleAzureDBForPostgreSqlSyncTaskProperties DeserializeConnectToTargetOracleAzureDBForPostgreSqlSyncTaskProperties(JsonElement element)
        {
            ...
            Core.Optional<ConnectToTargetOracleAzureDBForPostgreSqlSyncTaskInput> input = default;
            Core.Optional<IReadOnlyList<ConnectToTargetOracleAzureDBForPostgreSqlSyncTaskOutput>> output = default;
            ...
            return new ConnectToTargetOracleAzureDBForPostgreSqlSyncTaskProperties(taskType, Core.Optional.ToList(errors), Core.Optional.ToNullable(state), Core.Optional.ToList(commands), Core.Optional.ToDictionary(clientData), input.Value, Core.Optional.ToList(output));
        }
    }
}
