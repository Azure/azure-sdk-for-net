...
{
    public partial class QueryAnalysisValidationResult : IUtf8JsonSerializable, IJsonModel<QueryAnalysisValidationResult>, IPersistableModel<QueryAnalysisValidationResult>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(QueryResults))
            {
                ...
                AppendChildObject(builder, QueryResults, options, 2);
            }

            if (Optional.IsDefined(ValidationErrors))
            {
                builder.Append("  validationErrors:");
                AppendChildObject(builder, ValidationErrors, options, 2);
            }
