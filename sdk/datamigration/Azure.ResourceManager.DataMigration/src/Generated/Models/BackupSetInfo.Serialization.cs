...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BackupSetInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<BackupSetInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BackupSetInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<BackupSetInfo>)} interface");
            }
        ...
        string IPersistableModel<BackupSetInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
