...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SqlServerSqlMISyncTaskInput>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SqlServerSqlMISyncTaskInput>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SqlServerSqlMISyncTaskInput>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SqlServerSqlMISyncTaskInput>)} interface");
            }
        ...
        string IPersistableModel<SqlServerSqlMISyncTaskInput>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
