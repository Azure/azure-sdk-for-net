...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class DataMigrationODataError
    {
        ...
        internal DataMigrationODataError(string code, string message, IReadOnlyList<DataMigrationODataError> details, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Code = code;
            Message = message;
            Details = details;
