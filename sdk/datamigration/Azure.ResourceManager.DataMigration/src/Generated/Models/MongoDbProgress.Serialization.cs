...
namespace Azure.ResourceManager.DataMigration.Models
{
    public partial class MongoDbProgress
    {
        internal static MongoDbProgress DeserializeMongoDbProgress(JsonElement element)
        {
            ...
            return new MongoDbProgress(bytesCopied, documentsCopied, elapsedTime, errors, eventsPending, eventsReplayed, Optional.ToNullable(lastEventTime), Optional.ToNullable(lastReplayTime), name.Value, qualifiedName.Value, resultType, state, totalBytes, totalDocuments);
        }
    }
}
