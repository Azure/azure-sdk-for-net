...
{
    public partial class GetUserTablesMySqlTaskProperties : IUtf8JsonSerializable
    {
        ...
        internal static GetUserTablesMySqlTaskProperties DeserializeGetUserTablesMySqlTaskProperties(JsonElement element)
        {
            ...
            return new GetUserTablesMySqlTaskProperties(taskType, Optional.ToList(errors), Optional.ToNullable(state), Optional.ToList(commands), Optional.ToDictionary(clientData), input.Value, Optional.ToList(output));
        }
    }
}
