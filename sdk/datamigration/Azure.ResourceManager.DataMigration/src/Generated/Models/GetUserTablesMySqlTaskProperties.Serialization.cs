...
{
    public partial class GetUserTablesMySqlTaskProperties : Core.IUtf8JsonSerializable
    {
        ...
        internal static GetUserTablesMySqlTaskProperties DeserializeGetUserTablesMySqlTaskProperties(JsonElement element)
        {
            ...
            Core.Optional<GetUserTablesMySqlTaskInput> input = default;
            Core.Optional<IReadOnlyList<GetUserTablesMySqlTaskOutput>> output = default;
            ...
            return new GetUserTablesMySqlTaskProperties(taskType, Core.Optional.ToList(errors), Core.Optional.ToNullable(state), Core.Optional.ToList(commands), Core.Optional.ToDictionary(clientData), input.Value, Core.Optional.ToList(output));
        }
    }
}
