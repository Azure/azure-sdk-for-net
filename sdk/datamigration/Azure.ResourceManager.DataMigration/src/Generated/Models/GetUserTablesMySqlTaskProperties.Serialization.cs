...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class GetUserTablesMySqlTaskProperties : DataMigrationProjectTaskProperties, IJsonModel<GetUserTablesMySqlTaskProperties>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<GetUserTablesMySqlTaskProperties>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
                ...
                default:
                    throw new FormatException($"The model {nameof(GetUserTablesMySqlTaskProperties)} does not support reading '{options.Format}' format.");
            }
        }
        ...
        protected override BinaryData PersistableModelWriteCore(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(GetUserTablesMySqlTaskProperties)} does not support writing '{options.Format}' format.");
            }
        }

        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<GetUserTablesMySqlTaskProperties>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        GetUserTablesMySqlTaskProperties IPersistableModel<GetUserTablesMySqlTaskProperties>.Create(BinaryData data, ModelReaderWriterOptions options) => (GetUserTablesMySqlTaskProperties)PersistableModelCreateCore(data, options);
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(GetUserTablesMySqlTaskProperties)} does not support writing '{format}' format.");
            }
            ...
            if (options.Format != "W" && Optional.IsCollectionDefined(Output))
            {
                ...
                foreach (GetUserTablesMySqlTaskOutput item in Output)
                {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        GetUserTablesMySqlTaskProperties IJsonModel<GetUserTablesMySqlTaskProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (GetUserTablesMySqlTaskProperties)JsonModelCreateCore(ref reader, options);
        ...
        protected override DataMigrationProjectTaskProperties JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(GetUserTablesMySqlTaskProperties)} does not support reading '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static GetUserTablesMySqlTaskProperties DeserializeGetUserTablesMySqlTaskProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            GetUserTablesMySqlTaskInput input = default;
            IReadOnlyList<GetUserTablesMySqlTaskOutput> output = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("input"u8))
                {
                    ...
                    input = GetUserTablesMySqlTaskInput.DeserializeGetUserTablesMySqlTaskInput(prop.Value, options);
                    continue;
                }
                if (prop.NameEquals("output"u8))
                {
                    ...
                    foreach (var item in prop.Value.EnumerateArray())
                    {
                        array.Add(GetUserTablesMySqlTaskOutput.DeserializeGetUserTablesMySqlTaskOutput(item, options));
                    }
                    output = array;
                    continue;
                }
