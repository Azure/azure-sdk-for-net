...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GetUserTablesMySqlTaskProperties>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Input))
            {
                ...
                ((IJsonModel<GetUserTablesMySqlTaskInput>)Input).Write(writer, options);
            }
            if (options.Format != "W" && Optional.IsCollectionDefined(Output))
            {
                ...
                {
                    ((IJsonModel<GetUserTablesMySqlTaskOutput>)item).Write(writer, options);
                }
        ...
        internal static GetUserTablesMySqlTaskProperties DeserializeGetUserTablesMySqlTaskProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("input"u8))
                {
                    ...
                    input = ModelSerializationExtensions.JsonDeserialize<GetUserTablesMySqlTaskInput>(property.Value);
                    continue;
                }
