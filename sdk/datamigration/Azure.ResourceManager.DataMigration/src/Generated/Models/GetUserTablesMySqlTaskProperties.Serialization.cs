...
namespace Azure.ResourceManager.DataMigration.Models
{
    public partial class GetUserTablesMySqlTaskProperties : IUtf8JsonSerializable, IJsonModel<GetUserTablesMySqlTaskProperties>
    {
        ...
        void IJsonModel<GetUserTablesMySqlTaskProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (options.Format != "W" && !(Output is ChangeTrackingList<GetUserTablesMySqlTaskOutput> collection && collection.IsUndefined))
            {
        ...
        internal static GetUserTablesMySqlTaskProperties DeserializeGetUserTablesMySqlTaskProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new GetUserTablesMySqlTaskProperties(taskType, errors ?? new ChangeTrackingList<ODataError>(), Optional.ToNullable(state), commands ?? new ChangeTrackingList<CommandProperties>(), clientData ?? new ChangeTrackingDictionary<string, string>(), serializedAdditionalRawData, input.Value, output ?? new ChangeTrackingList<GetUserTablesMySqlTaskOutput>());
        }
