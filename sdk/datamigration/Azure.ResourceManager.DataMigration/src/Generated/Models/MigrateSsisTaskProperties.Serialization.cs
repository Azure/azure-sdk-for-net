...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class MigrateSsisTaskProperties : DataMigrationProjectTaskProperties, IJsonModel<MigrateSsisTaskProperties>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<MigrateSsisTaskProperties>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
                ...
                default:
                    throw new FormatException($"The model {nameof(MigrateSsisTaskProperties)} does not support reading '{options.Format}' format.");
            }
        }
        ...
        protected override BinaryData PersistableModelWriteCore(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(MigrateSsisTaskProperties)} does not support writing '{options.Format}' format.");
            }
        }

        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<MigrateSsisTaskProperties>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        MigrateSsisTaskProperties IPersistableModel<MigrateSsisTaskProperties>.Create(BinaryData data, ModelReaderWriterOptions options) => (MigrateSsisTaskProperties)PersistableModelCreateCore(data, options);
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MigrateSsisTaskProperties)} does not support writing '{format}' format.");
            }
            ...
            if (options.Format != "W" && Optional.IsCollectionDefined(Output))
            {
                ...
                foreach (MigrateSsisTaskOutput item in Output)
                {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        MigrateSsisTaskProperties IJsonModel<MigrateSsisTaskProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (MigrateSsisTaskProperties)JsonModelCreateCore(ref reader, options);
        ...
        protected override DataMigrationProjectTaskProperties JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MigrateSsisTaskProperties)} does not support reading '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static MigrateSsisTaskProperties DeserializeMigrateSsisTaskProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            MigrateSsisTaskInput input = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("input"u8))
                {
                    ...
                    input = MigrateSsisTaskInput.DeserializeMigrateSsisTaskInput(prop.Value, options);
                    continue;
                }
