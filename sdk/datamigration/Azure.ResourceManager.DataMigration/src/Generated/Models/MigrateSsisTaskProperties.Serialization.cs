...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MigrateSsisTaskProperties>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Input))
            {
                ...
                ((IJsonModel<MigrateSsisTaskInput>)Input).Write(writer, options);
            }
            if (options.Format != "W" && Optional.IsCollectionDefined(Output))
            {
                ...
                {
                    ((IJsonModel<MigrateSsisTaskOutput>)item).Write(writer, options);
                }
        ...
        internal static MigrateSsisTaskProperties DeserializeMigrateSsisTaskProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("input"u8))
                {
                    ...
                    input = ModelSerializationExtensions.JsonDeserialize<MigrateSsisTaskInput>(property.Value);
                    continue;
                }
