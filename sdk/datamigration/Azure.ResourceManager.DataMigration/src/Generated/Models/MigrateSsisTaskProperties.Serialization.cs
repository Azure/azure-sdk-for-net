...
{
    public partial class MigrateSsisTaskProperties : Core.IUtf8JsonSerializable
    {
        ...
        internal static MigrateSsisTaskProperties DeserializeMigrateSsisTaskProperties(JsonElement element)
        {
            ...
            Core.Optional<MigrateSsisTaskInput> input = default;
            Core.Optional<IReadOnlyList<MigrateSsisTaskOutput>> output = default;
            ...
            return new MigrateSsisTaskProperties(taskType, Core.Optional.ToList(errors), Core.Optional.ToNullable(state), Core.Optional.ToList(commands), Core.Optional.ToDictionary(clientData), input.Value, Core.Optional.ToList(output));
        }
    }
}
