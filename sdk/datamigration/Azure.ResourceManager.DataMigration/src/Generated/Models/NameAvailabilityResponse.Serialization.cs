...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    {
        internal static NameAvailabilityResponse DeserializeNameAvailabilityResponse(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
