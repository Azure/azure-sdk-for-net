...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ConnectToSourceMySqlTaskProperties>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Input))
            {
                ...
                ((IJsonModel<ConnectToSourceMySqlTaskInput>)Input).Write(writer, options);
            }
            if (options.Format != "W" && Optional.IsCollectionDefined(Output))
            {
                ...
                {
                    ((IJsonModel<ConnectToSourceNonSqlTaskOutput>)item).Write(writer, options);
                }
        ...
        internal static ConnectToSourceMySqlTaskProperties DeserializeConnectToSourceMySqlTaskProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("input"u8))
                {
                    ...
                    input = ModelSerializationExtensions.JsonDeserialize<ConnectToSourceMySqlTaskInput>(property.Value);
                    continue;
                }
