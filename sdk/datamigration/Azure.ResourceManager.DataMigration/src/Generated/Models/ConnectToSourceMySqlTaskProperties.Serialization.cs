...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class ConnectToSourceMySqlTaskProperties : DataMigrationProjectTaskProperties, IJsonModel<ConnectToSourceMySqlTaskProperties>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<ConnectToSourceMySqlTaskProperties>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
                ...
                default:
                    throw new FormatException($"The model {nameof(ConnectToSourceMySqlTaskProperties)} does not support reading '{options.Format}' format.");
            }
        }
        ...
        protected override BinaryData PersistableModelWriteCore(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ConnectToSourceMySqlTaskProperties)} does not support writing '{options.Format}' format.");
            }
        }

        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ConnectToSourceMySqlTaskProperties>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        ConnectToSourceMySqlTaskProperties IPersistableModel<ConnectToSourceMySqlTaskProperties>.Create(BinaryData data, ModelReaderWriterOptions options) => (ConnectToSourceMySqlTaskProperties)PersistableModelCreateCore(data, options);
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ConnectToSourceMySqlTaskProperties)} does not support writing '{format}' format.");
            }
            ...
            if (options.Format != "W" && Optional.IsCollectionDefined(Output))
            {
                ...
                foreach (ConnectToSourceNonSqlTaskOutput item in Output)
                {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ConnectToSourceMySqlTaskProperties IJsonModel<ConnectToSourceMySqlTaskProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (ConnectToSourceMySqlTaskProperties)JsonModelCreateCore(ref reader, options);
        ...
        protected override DataMigrationProjectTaskProperties JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ConnectToSourceMySqlTaskProperties)} does not support reading '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static ConnectToSourceMySqlTaskProperties DeserializeConnectToSourceMySqlTaskProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            ConnectToSourceMySqlTaskInput input = default;
            IReadOnlyList<ConnectToSourceNonSqlTaskOutput> output = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("input"u8))
                {
                    ...
                    input = ConnectToSourceMySqlTaskInput.DeserializeConnectToSourceMySqlTaskInput(prop.Value, options);
                    continue;
                }
