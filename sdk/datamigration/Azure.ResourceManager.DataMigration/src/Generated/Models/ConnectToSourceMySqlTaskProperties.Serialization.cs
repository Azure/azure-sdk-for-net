...
{
    public partial class ConnectToSourceMySqlTaskProperties : Core.IUtf8JsonSerializable
    {
        ...
        internal static ConnectToSourceMySqlTaskProperties DeserializeConnectToSourceMySqlTaskProperties(JsonElement element)
        {
            ...
            Core.Optional<ConnectToSourceMySqlTaskInput> input = default;
            Core.Optional<IReadOnlyList<ConnectToSourceNonSqlTaskOutput>> output = default;
            ...
            return new ConnectToSourceMySqlTaskProperties(taskType, Core.Optional.ToList(errors), Core.Optional.ToNullable(state), Core.Optional.ToList(commands), Core.Optional.ToDictionary(clientData), input.Value, Core.Optional.ToList(output));
        }
    }
}
