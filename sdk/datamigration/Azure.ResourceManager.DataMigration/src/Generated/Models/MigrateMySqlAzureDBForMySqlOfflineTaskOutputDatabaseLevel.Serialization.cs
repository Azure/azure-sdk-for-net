...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class MigrateMySqlAzureDBForMySqlOfflineTaskOutputDatabaseLevel : MigrateMySqlAzureDBForMySqlOfflineTaskOutput, IJsonModel<MigrateMySqlAzureDBForMySqlOfflineTaskOutputDatabaseLevel>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<MigrateMySqlAzureDBForMySqlOfflineTaskOutputDatabaseLevel>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<MigrateMySqlAzureDBForMySqlOfflineTaskOutputDatabaseLevel>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        MigrateMySqlAzureDBForMySqlOfflineTaskOutputDatabaseLevel IPersistableModel<MigrateMySqlAzureDBForMySqlOfflineTaskOutputDatabaseLevel>.Create(BinaryData data, ModelReaderWriterOptions options) => (MigrateMySqlAzureDBForMySqlOfflineTaskOutputDatabaseLevel)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        MigrateMySqlAzureDBForMySqlOfflineTaskOutputDatabaseLevel IJsonModel<MigrateMySqlAzureDBForMySqlOfflineTaskOutputDatabaseLevel>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (MigrateMySqlAzureDBForMySqlOfflineTaskOutputDatabaseLevel)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static MigrateMySqlAzureDBForMySqlOfflineTaskOutputDatabaseLevel DeserializeMigrateMySqlAzureDBForMySqlOfflineTaskOutputDatabaseLevel(JsonElement element, ModelReaderWriterOptions options)
        {
