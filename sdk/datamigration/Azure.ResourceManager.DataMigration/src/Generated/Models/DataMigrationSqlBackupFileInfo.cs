...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class DataMigrationSqlBackupFileInfo
    {
        ...
        internal DataMigrationSqlBackupFileInfo(string fileName, string status, long? totalSize, long? dataRead, long? dataWritten, double? copyThroughput, int? copyDuration, int? familySequenceNumber, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            FileName = fileName;
            Status = status;
            TotalSize = totalSize;
