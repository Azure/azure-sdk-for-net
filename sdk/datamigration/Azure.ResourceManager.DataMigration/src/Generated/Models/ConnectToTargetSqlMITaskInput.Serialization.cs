...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ConnectToTargetSqlMITaskInput>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ConnectToTargetSqlMITaskInput>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ConnectToTargetSqlMITaskInput>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ConnectToTargetSqlMITaskInput>)} interface");
            }
        ...
        string IPersistableModel<ConnectToTargetSqlMITaskInput>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
