...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NameAvailabilityRequest>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NameAvailabilityRequest>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NameAvailabilityRequest>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<NameAvailabilityRequest>)} interface");
            }
        ...
        string IPersistableModel<NameAvailabilityRequest>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
