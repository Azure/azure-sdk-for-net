...
{
    public partial class GetUserTablesPostgreSqlTaskProperties : IUtf8JsonSerializable
    {
        ...
        internal static GetUserTablesPostgreSqlTaskProperties DeserializeGetUserTablesPostgreSqlTaskProperties(JsonElement element)
        {
            ...
            return new GetUserTablesPostgreSqlTaskProperties(taskType, Optional.ToList(errors), Optional.ToNullable(state), Optional.ToList(commands), Optional.ToDictionary(clientData), input.Value, Optional.ToList(output));
        }
    }
}
