...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class ConnectToSourceNonSqlTaskOutput
    {
        ...
        internal ConnectToSourceNonSqlTaskOutput(string id, string sourceServerBrandVersion, ServerProperties serverProperties, IReadOnlyList<string> databases, IReadOnlyList<ReportableException> validationErrors, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
