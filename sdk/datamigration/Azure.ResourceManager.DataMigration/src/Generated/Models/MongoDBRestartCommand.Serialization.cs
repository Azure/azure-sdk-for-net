...
{
    public partial class MongoDBRestartCommand : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static MongoDBRestartCommand DeserializeMongoDBRestartCommand(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
