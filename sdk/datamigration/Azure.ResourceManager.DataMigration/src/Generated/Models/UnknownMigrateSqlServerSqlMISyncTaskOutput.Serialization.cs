...
{
    internal partial class UnknownMigrateSqlServerSqlMISyncTaskOutput : MigrateSqlServerSqlMISyncTaskOutput, IJsonModel<MigrateSqlServerSqlMISyncTaskOutput>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownMigrateSqlServerSqlMISyncTaskOutput DeserializeUnknownMigrateSqlServerSqlMISyncTaskOutput(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownMigrateSqlServerSqlMISyncTaskOutput(id, resultType, additionalBinaryDataProperties);
        }
    }
}
