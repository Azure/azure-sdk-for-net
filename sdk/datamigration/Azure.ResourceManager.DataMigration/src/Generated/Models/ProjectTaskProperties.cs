...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    /// </summary>
    [DeserializationProxy(typeof(UnknownProjectTaskProperties))]
    public abstract partial class ProjectTaskProperties
    {
        ...
        internal ProjectTaskProperties(TaskType taskType, IReadOnlyList<ODataError> errors, TaskState? state, IReadOnlyList<CommandProperties> commands, IDictionary<string, string> clientData, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            TaskType = taskType;
            Errors = errors;
            State = state;
