...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ConnectToSourceSqlServerTaskOutputTaskLevel>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ConnectToSourceSqlServerTaskOutputTaskLevel>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ConnectToSourceSqlServerTaskOutputTaskLevel>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ConnectToSourceSqlServerTaskOutputTaskLevel>)} interface");
            }
        ...
        string IPersistableModel<ConnectToSourceSqlServerTaskOutputTaskLevel>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
