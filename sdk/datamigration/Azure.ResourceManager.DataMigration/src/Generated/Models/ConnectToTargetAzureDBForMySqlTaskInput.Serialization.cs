...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ConnectToTargetAzureDBForMySqlTaskInput>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ConnectToTargetAzureDBForMySqlTaskInput>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ConnectToTargetAzureDBForMySqlTaskInput>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ConnectToTargetAzureDBForMySqlTaskInput>)} interface");
            }
        ...
        string IPersistableModel<ConnectToTargetAzureDBForMySqlTaskInput>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
