...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class ProjectFileProperties
    {
        ...
        internal ProjectFileProperties(string extension, string filePath, DateTimeOffset? lastModified, string mediaType, long? size, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Extension = extension;
            FilePath = filePath;
