...
namespace Azure.ResourceManager.DataMigration.Models
{
    public partial class WaitStatistics : IUtf8JsonSerializable, IJsonModel<WaitStatistics>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(WaitType))
            {
                builder.Append("  waitType:");
                if (WaitType.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
                    builder.AppendLine($"{WaitType}'''");
                }
                else
                {
                    builder.AppendLine($" '{WaitType}'");
            ...
            if (Optional.IsDefined(WaitTimeMs))
            {
                builder.Append("  waitTimeMs:");
                builder.AppendLine($" '{WaitTimeMs.Value.ToString()}'");
            }

            if (Optional.IsDefined(WaitCount))
            {
                builder.Append("  waitCount:");
                builder.AppendLine($" '{WaitCount.Value.ToString()}'");
            }
