...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    /// </summary>
    [DeserializationProxy(typeof(UnknownMigrateSqlServerSqlMISyncTaskOutput))]
    public abstract partial class MigrateSqlServerSqlMISyncTaskOutput
    {
        ...
        internal MigrateSqlServerSqlMISyncTaskOutput(string id, string resultType, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
