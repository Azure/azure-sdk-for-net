...
{
    public partial class MigrateSqlServerSqlDBDatabaseInput : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static MigrateSqlServerSqlDBDatabaseInput DeserializeMigrateSqlServerSqlDBDatabaseInput(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
