...
{
    public partial class MigrateSqlServerSqlDBDatabaseInput : IUtf8JsonSerializable, IJsonModel<MigrateSqlServerSqlDBDatabaseInput>, IPersistableModel<MigrateSqlServerSqlDBDatabaseInput>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(MakeSourceDBReadOnly))
            {
                builder.Append("  makeSourceDbReadOnly:");
                var boolValue = MakeSourceDBReadOnly.Value == true ? "true" : "false";
            ...
            if (Optional.IsDefined(SchemaSetting))
            {
                ...
                builder.AppendLine($" '{SchemaSetting.ToString()}'");
            }
