...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class SqlConnectionInfo : ConnectionInfo
    {
        ...
        internal SqlConnectionInfo(string connectionInfoType, string userName, string password, string dataSource, string serverName, int? port, string serverVersion, string serverBrandVersion, string resourceId, AuthenticationType? authentication, bool? encryptConnection, string additionalSettings, bool? trustServerCertificate, SqlSourcePlatform? platform, Dictionary<string, BinaryData> rawData) : base(connectionInfoType, userName, password, rawData)
        {
            DataSource = dataSource;
