...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MigrationValidationOptions>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MigrationValidationOptions>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MigrationValidationOptions>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MigrationValidationOptions>)} interface");
            }
        ...
        string IPersistableModel<MigrationValidationOptions>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
