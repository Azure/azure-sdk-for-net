...
{
    public partial class MigrationValidationOptions : IUtf8JsonSerializable, IJsonModel<MigrationValidationOptions>, IPersistableModel<MigrationValidationOptions>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(EnableSchemaValidation))
            {
                builder.Append("  enableSchemaValidation:");
                var boolValue = EnableSchemaValidation.Value == true ? "true" : "false";
                builder.AppendLine($" {boolValue}");
            }

            if (Optional.IsDefined(EnableDataIntegrityValidation))
            {
                builder.Append("  enableDataIntegrityValidation:");
                var boolValue = EnableDataIntegrityValidation.Value == true ? "true" : "false";
                builder.AppendLine($" {boolValue}");
            }

            if (Optional.IsDefined(EnableQueryAnalysisValidation))
            {
                builder.Append("  enableQueryAnalysisValidation:");
                var boolValue = EnableQueryAnalysisValidation.Value == true ? "true" : "false";
                builder.AppendLine($" {boolValue}");
            }
