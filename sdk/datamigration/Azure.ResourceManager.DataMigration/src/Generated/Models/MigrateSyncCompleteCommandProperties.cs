...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class MigrateSyncCompleteCommandProperties : CommandProperties
    {
        ...
        internal MigrateSyncCompleteCommandProperties(CommandType commandType, IReadOnlyList<ODataError> errors, CommandState? state, MigrateSyncCompleteCommandInput input, MigrateSyncCompleteCommandOutput output, string commandId, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(commandType, errors, state, serializedAdditionalRawData)
        {
            Input = input;
            Output = output;
            CommandId = commandId;
