...
{
    public partial class MongoDBCommandInput : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static MongoDBCommandInput DeserializeMongoDBCommandInput(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
