...
namespace Azure.ResourceManager.DataMigration.Models
{
    public partial class ResourceSkuRestrictions : IUtf8JsonSerializable, IJsonModel<ResourceSkuRestrictions>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<ResourceSkuRestrictions>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ResourceSkuRestrictions>)} interface");
            }
