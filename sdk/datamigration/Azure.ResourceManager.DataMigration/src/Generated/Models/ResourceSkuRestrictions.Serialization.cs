...
{
    public partial class ResourceSkuRestrictions : IUtf8JsonSerializable, IJsonModel<ResourceSkuRestrictions>, IPersistableModel<ResourceSkuRestrictions>
    {
        ...
        void IJsonModel<ResourceSkuRestrictions>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ResourceSkuRestrictions)} does not support '{format}' format.");
            }
