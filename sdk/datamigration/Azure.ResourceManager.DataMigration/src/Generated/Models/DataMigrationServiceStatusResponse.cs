...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class DataMigrationServiceStatusResponse
    {
        ...
        internal DataMigrationServiceStatusResponse(string agentVersion, BinaryData agentConfiguration, string status, string vmSize, IReadOnlyList<string> supportedTaskTypes, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
