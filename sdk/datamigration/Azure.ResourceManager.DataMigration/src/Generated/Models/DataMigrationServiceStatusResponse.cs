...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class DataMigrationServiceStatusResponse
    {
        ...
        internal DataMigrationServiceStatusResponse(string agentVersion, BinaryData agentConfiguration, string status, string vmSize, IReadOnlyList<string> supportedTaskTypes, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
