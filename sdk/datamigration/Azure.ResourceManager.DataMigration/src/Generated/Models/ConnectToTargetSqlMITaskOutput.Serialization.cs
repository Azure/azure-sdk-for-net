...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ConnectToTargetSqlMITaskOutput>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ConnectToTargetSqlMITaskOutput>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ConnectToTargetSqlMITaskOutput>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ConnectToTargetSqlMITaskOutput>)} interface");
            }
        ...
        string IPersistableModel<ConnectToTargetSqlMITaskOutput>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
