...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class ConnectToTargetOracleAzureDBForPostgreSqlSyncTaskOutputDatabaseSchemaMapItem
    {
        ...
        internal ConnectToTargetOracleAzureDBForPostgreSqlSyncTaskOutputDatabaseSchemaMapItem(string database, IReadOnlyList<string> schemas, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Database = database;
            Schemas = schemas;
