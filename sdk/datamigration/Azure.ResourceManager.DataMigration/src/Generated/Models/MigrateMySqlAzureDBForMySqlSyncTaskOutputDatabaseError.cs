...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class MigrateMySqlAzureDBForMySqlSyncTaskOutputDatabaseError : MigrateMySqlAzureDBForMySqlSyncTaskOutput
    {
        ...
        internal MigrateMySqlAzureDBForMySqlSyncTaskOutputDatabaseError(string id, string resultType, string errorMessage, IReadOnlyList<SyncMigrationDatabaseErrorEvent> events, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, resultType, serializedAdditionalRawData)
        {
