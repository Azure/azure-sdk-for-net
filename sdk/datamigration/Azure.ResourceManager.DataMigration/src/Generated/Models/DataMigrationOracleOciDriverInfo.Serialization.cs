...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class DataMigrationOracleOciDriverInfo : IJsonModel<DataMigrationOracleOciDriverInfo>
    {
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual DataMigrationOracleOciDriverInfo PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<DataMigrationOracleOciDriverInfo>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<DataMigrationOracleOciDriverInfo>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        DataMigrationOracleOciDriverInfo IPersistableModel<DataMigrationOracleOciDriverInfo>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (options.Format != "W" && Optional.IsCollectionDefined(SupportedOracleVersions))
            {
                ...
                foreach (string item in SupportedOracleVersions)
                {
                    if (item == null)
                    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        DataMigrationOracleOciDriverInfo IJsonModel<DataMigrationOracleOciDriverInfo>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual DataMigrationOracleOciDriverInfo JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<DataMigrationOracleOciDriverInfo>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static DataMigrationOracleOciDriverInfo DeserializeDataMigrationOracleOciDriverInfo(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            {
                if (prop.NameEquals("driverName"u8))
                {
                    driverName = prop.Value.GetString();
                    continue;
                }
                if (prop.NameEquals("driverSize"u8))
                {
                    driverSize = prop.Value.GetString();
                    continue;
                }
                if (prop.NameEquals("archiveChecksum"u8))
                {
                    archiveChecksum = prop.Value.GetString();
                    continue;
                }
                if (prop.NameEquals("oracleChecksum"u8))
                {
                    oracleChecksum = prop.Value.GetString();
                    continue;
                }
                ...
                if (prop.NameEquals("supportedOracleVersions"u8))
                {
