...
{
    public partial class MigrateSqlServerSqlDBSyncDatabaseInput : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static MigrateSqlServerSqlDBSyncDatabaseInput DeserializeMigrateSqlServerSqlDBSyncDatabaseInput(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
