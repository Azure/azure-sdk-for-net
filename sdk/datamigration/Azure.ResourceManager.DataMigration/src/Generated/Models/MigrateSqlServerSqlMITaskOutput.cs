...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    /// </summary>
    [AbstractTypeDeserializer(typeof(UnknownMigrateSqlServerSqlMITaskOutput))]
    public abstract partial class MigrateSqlServerSqlMITaskOutput
    {
        ...
        internal MigrateSqlServerSqlMITaskOutput(string id, string resultType, Dictionary<string, BinaryData> rawData)
        {
            Id = id;
