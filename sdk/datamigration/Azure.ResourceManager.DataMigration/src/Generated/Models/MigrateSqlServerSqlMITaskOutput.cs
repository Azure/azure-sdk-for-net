...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public abstract partial class MigrateSqlServerSqlMITaskOutput
    {
        ...
        internal MigrateSqlServerSqlMITaskOutput(string id, string resultType, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
