...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public abstract partial class MigrateSqlServerSqlMITaskOutput
    {
        ...
        private protected MigrateSqlServerSqlMITaskOutput(string resultType)
        {
        ...
        internal MigrateSqlServerSqlMITaskOutput(string id, string resultType, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Id = id;
            ResultType = resultType;
