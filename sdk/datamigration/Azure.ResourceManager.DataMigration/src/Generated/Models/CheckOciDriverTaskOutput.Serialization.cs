...
{
    public partial class CheckOciDriverTaskOutput : IUtf8JsonSerializable, IJsonModel<CheckOciDriverTaskOutput>, IPersistableModel<CheckOciDriverTaskOutput>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(InstalledDriver))
            {
                ...
                AppendChildObject(builder, InstalledDriver, options, 2);
            }
