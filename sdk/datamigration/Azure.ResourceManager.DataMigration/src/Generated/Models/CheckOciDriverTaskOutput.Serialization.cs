...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    {
        internal static CheckOciDriverTaskOutput DeserializeCheckOciDriverTaskOutput(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
