...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class ConnectToTargetAzureDBForMySqlTaskProperties : DataMigrationProjectTaskProperties
    {
        ...
        internal ConnectToTargetAzureDBForMySqlTaskProperties(DataMigrationTaskType taskType, IReadOnlyList<DataMigrationODataError> errors, DataMigrationTaskState? state, IReadOnlyList<DataMigrationCommandProperties> commands, IDictionary<string, string> clientData, IDictionary<string, BinaryData> additionalBinaryDataProperties, ConnectToTargetAzureDBForMySqlTaskInput input, IReadOnlyList<ConnectToTargetAzureDBForMySqlTaskOutput> output) : base(taskType, errors, state, commands, clientData, additionalBinaryDataProperties)
        {
            Input = input;
            Output = output;
        }
