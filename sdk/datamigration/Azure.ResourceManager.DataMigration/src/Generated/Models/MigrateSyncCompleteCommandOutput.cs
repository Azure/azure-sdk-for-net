...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class MigrateSyncCompleteCommandOutput
    {
        ...
        internal MigrateSyncCompleteCommandOutput(string id, IReadOnlyList<DataMigrationReportableException> errors, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Id = id;
            Errors = errors;
