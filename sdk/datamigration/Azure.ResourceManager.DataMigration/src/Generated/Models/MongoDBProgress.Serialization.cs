...
{
    public partial class MongoDBProgress : IUtf8JsonSerializable, IModelJsonSerializable<MongoDBProgress>
    {
        ...
        internal static MongoDBProgress DeserializeMongoDBProgress(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new UnknownMongoDBProgress(bytesCopied, documentsCopied, elapsedTime, errors, eventsPending, eventsReplayed, Optional.ToNullable(lastEventTime), Optional.ToNullable(lastReplayTime), name.Value, qualifiedName.Value, resultType, state, totalBytes, totalDocuments, rawData);
        }
        ...
        /// <summary> Converts a <see cref="MongoDBProgress"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="MongoDBProgress"/> to convert. </param>
        public static implicit operator RequestContent(MongoDBProgress model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="MongoDBProgress"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator MongoDBProgress(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeMongoDBProgress(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
