...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ValidateMigrationInputSqlServerSqlMITaskInput>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<ValidateMigrationInputSqlServerSqlMITaskInput>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ValidateMigrationInputSqlServerSqlMITaskInput>)} interface");
            }
        ...
        string IPersistableModel<ValidateMigrationInputSqlServerSqlMITaskInput>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
