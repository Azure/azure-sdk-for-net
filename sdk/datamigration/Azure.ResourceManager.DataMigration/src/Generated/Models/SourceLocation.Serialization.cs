...
{
    public partial class SourceLocation : IUtf8JsonSerializable, IJsonModel<SourceLocation>, IPersistableModel<SourceLocation>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(FileShare))
            {
                ...
                AppendChildObject(builder, FileShare, options, 2);
            }
            ...
            if (Optional.IsDefined(FileStorageType))
            {
                ...
                builder.AppendLine($" '{FileStorageType}'");
            }
