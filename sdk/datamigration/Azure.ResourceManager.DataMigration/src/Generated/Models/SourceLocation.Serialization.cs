...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SourceLocation>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SourceLocation>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SourceLocation>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SourceLocation>)} interface");
            }
        ...
        string IPersistableModel<SourceLocation>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
