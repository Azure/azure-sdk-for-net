...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SsisMigrationInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SsisMigrationInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SsisMigrationInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SsisMigrationInfo>)} interface");
            }
        ...
        string IPersistableModel<SsisMigrationInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
