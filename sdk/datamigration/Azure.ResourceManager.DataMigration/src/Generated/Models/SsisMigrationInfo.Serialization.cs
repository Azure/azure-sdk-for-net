...
{
    public partial class SsisMigrationInfo : IUtf8JsonSerializable, IJsonModel<SsisMigrationInfo>, IPersistableModel<SsisMigrationInfo>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SsisStoreType))
            {
                builder.Append("  ssisStoreType:");
                builder.AppendLine($" '{SsisStoreType.ToString()}'");
            }

            if (Optional.IsDefined(ProjectOverwriteOption))
            {
                builder.Append("  projectOverwriteOption:");
                builder.AppendLine($" '{ProjectOverwriteOption.ToString()}'");
            }

            if (Optional.IsDefined(EnvironmentOverwriteOption))
            {
                builder.Append("  environmentOverwriteOption:");
                builder.AppendLine($" '{EnvironmentOverwriteOption.ToString()}'");
            }
