    ...
    public partial class SsisMigrationInfo : IUtf8JsonSerializable, IJsonModel<SsisMigrationInfo>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SsisStoreType))
            {
                ...
                builder.AppendLine($" '{SsisStoreType.Value.ToString()}'");
            }

            if (Optional.IsDefined(ProjectOverwriteOption))
            {
                builder.Append("  projectOverwriteOption:");
                builder.AppendLine($" '{ProjectOverwriteOption.Value.ToString()}'");
            }

            if (Optional.IsDefined(EnvironmentOverwriteOption))
            {
                builder.Append("  environmentOverwriteOption:");
                builder.AppendLine($" '{EnvironmentOverwriteOption.Value.ToString()}'");
            }
