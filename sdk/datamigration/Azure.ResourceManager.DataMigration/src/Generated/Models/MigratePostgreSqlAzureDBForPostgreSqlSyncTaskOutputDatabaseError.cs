...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class MigratePostgreSqlAzureDBForPostgreSqlSyncTaskOutputDatabaseError : MigratePostgreSqlAzureDBForPostgreSqlSyncTaskOutput
    {
        ...
        internal MigratePostgreSqlAzureDBForPostgreSqlSyncTaskOutputDatabaseError(string id, string resultType, IDictionary<string, BinaryData> serializedAdditionalRawData, string errorMessage, IReadOnlyList<SyncMigrationDatabaseErrorEvent> events) : base(id, resultType, serializedAdditionalRawData)
        {
