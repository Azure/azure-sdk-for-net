...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class MigratePostgreSqlAzureDBForPostgreSqlSyncTaskOutputDatabaseError : MigratePostgreSqlAzureDBForPostgreSqlSyncTaskOutput
    {
        ...
        internal MigratePostgreSqlAzureDBForPostgreSqlSyncTaskOutputDatabaseError(string id, string resultType, string errorMessage, IList<SyncMigrationDatabaseErrorEvent> events) : base(id, resultType)
        {
