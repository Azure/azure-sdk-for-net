...
{
    public partial class MigrateMySqlAzureDBForMySqlOfflineDatabaseInput : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static MigrateMySqlAzureDBForMySqlOfflineDatabaseInput DeserializeMigrateMySqlAzureDBForMySqlOfflineDatabaseInput(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
