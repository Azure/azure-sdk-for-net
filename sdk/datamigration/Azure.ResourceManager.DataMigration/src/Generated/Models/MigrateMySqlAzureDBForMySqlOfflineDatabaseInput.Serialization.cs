...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MigrateMySqlAzureDBForMySqlOfflineDatabaseInput>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<MigrateMySqlAzureDBForMySqlOfflineDatabaseInput>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MigrateMySqlAzureDBForMySqlOfflineDatabaseInput>)} interface");
            }
        ...
        string IPersistableModel<MigrateMySqlAzureDBForMySqlOfflineDatabaseInput>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
