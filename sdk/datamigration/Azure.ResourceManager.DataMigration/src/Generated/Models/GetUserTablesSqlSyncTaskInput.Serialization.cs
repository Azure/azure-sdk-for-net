...
{
    public partial class GetUserTablesSqlSyncTaskInput : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static GetUserTablesSqlSyncTaskInput DeserializeGetUserTablesSqlSyncTaskInput(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
