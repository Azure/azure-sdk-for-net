...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class DatabaseMigration : ResourceData
    {
        ...
        internal DatabaseMigration(ResourceIdentifier id, string name, Core.ResourceType resourceType, SystemData systemData, DatabaseMigrationProperties properties, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData)
        {
