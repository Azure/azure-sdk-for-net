...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ConnectToSourcePostgreSqlSyncTaskOutput>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ConnectToSourcePostgreSqlSyncTaskOutput>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ConnectToSourcePostgreSqlSyncTaskOutput>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ConnectToSourcePostgreSqlSyncTaskOutput>)} interface");
            }
        ...
        string IPersistableModel<ConnectToSourcePostgreSqlSyncTaskOutput>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
