...
{
    internal partial class UnknownMigrateMySqlAzureDBForMySqlOfflineTaskOutput : MigrateMySqlAzureDBForMySqlOfflineTaskOutput, IJsonModel<MigrateMySqlAzureDBForMySqlOfflineTaskOutput>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownMigrateMySqlAzureDBForMySqlOfflineTaskOutput DeserializeUnknownMigrateMySqlAzureDBForMySqlOfflineTaskOutput(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownMigrateMySqlAzureDBForMySqlOfflineTaskOutput(id, resultType, additionalBinaryDataProperties);
        }
    }
}
