...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    /// </summary>
    [DeserializationProxy(typeof(UnknownMigrateSqlServerSqlDBTaskOutput))]
    public abstract partial class MigrateSqlServerSqlDBTaskOutput
    {
        ...
        internal MigrateSqlServerSqlDBTaskOutput(string id, string resultType, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
