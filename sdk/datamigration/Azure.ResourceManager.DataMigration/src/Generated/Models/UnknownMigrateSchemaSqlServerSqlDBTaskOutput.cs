...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    internal partial class UnknownMigrateSchemaSqlServerSqlDBTaskOutput : MigrateSchemaSqlServerSqlDBTaskOutput
    {
        ...
        internal UnknownMigrateSchemaSqlServerSqlDBTaskOutput(string id, string resultType, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, resultType, serializedAdditionalRawData)
        {
