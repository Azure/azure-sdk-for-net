...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class MigrateMISyncCompleteCommandProperties : CommandProperties
    {
        ...
        internal MigrateMISyncCompleteCommandProperties(CommandType commandType, IReadOnlyList<ODataError> errors, CommandState? state, MigrateMISyncCompleteCommandInput input, MigrateMISyncCompleteCommandOutput output, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(commandType, errors, state, serializedAdditionalRawData)
        {
            Input = input;
            Output = output;
