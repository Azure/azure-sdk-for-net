...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class MigrateMISyncCompleteCommandProperties : CommandProperties
    {
        ...
        internal MigrateMISyncCompleteCommandProperties(CommandType commandType, IReadOnlyList<ODataError> errors, CommandState? state, MigrateMISyncCompleteCommandInput input, MigrateMISyncCompleteCommandOutput output, Dictionary<string, BinaryData> rawData) : base(commandType, errors, state, rawData)
        {
            Input = input;
            Output = output;
