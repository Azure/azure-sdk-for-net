...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class MigrateSqlServerSqlMITaskProperties : DataMigrationProjectTaskProperties
    {
        ...
        internal MigrateSqlServerSqlMITaskProperties(DataMigrationTaskType taskType, IReadOnlyList<DataMigrationODataError> errors, DataMigrationTaskState? state, IReadOnlyList<DataMigrationCommandProperties> commands, IDictionary<string, string> clientData, IDictionary<string, BinaryData> additionalBinaryDataProperties, MigrateSqlServerSqlMITaskInput input, IReadOnlyList<MigrateSqlServerSqlMITaskOutput> output, string taskId, DateTimeOffset? createdOn, string parentTaskId, bool? isCloneable) : base(taskType, errors, state, commands, clientData, additionalBinaryDataProperties)
        {
            Input = input;
            Output = output;
            TaskId = taskId;
