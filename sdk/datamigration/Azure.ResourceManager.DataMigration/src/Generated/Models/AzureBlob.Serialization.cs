...
{
    public partial class AzureBlob : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static AzureBlob DeserializeAzureBlob(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
