...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DatabaseMigrationSqlVmProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DatabaseMigrationSqlVmProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DatabaseMigrationSqlVmProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DatabaseMigrationSqlVmProperties>)} interface");
            }
        ...
        string IPersistableModel<DatabaseMigrationSqlVmProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
