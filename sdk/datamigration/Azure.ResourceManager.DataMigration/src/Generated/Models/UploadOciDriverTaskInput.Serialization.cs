...
{
    internal partial class UploadOciDriverTaskInput : IUtf8JsonSerializable, IJsonModel<UploadOciDriverTaskInput>, IPersistableModel<UploadOciDriverTaskInput>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(DriverShare))
            {
                builder.Append("  driverShare:");
                AppendChildObject(builder, DriverShare, options, 2);
            }
