...
{
    internal partial class UploadOciDriverTaskInput : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static UploadOciDriverTaskInput DeserializeUploadOciDriverTaskInput(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
