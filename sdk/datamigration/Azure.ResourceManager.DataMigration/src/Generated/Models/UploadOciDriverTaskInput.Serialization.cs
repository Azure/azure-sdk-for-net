...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<UploadOciDriverTaskInput>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<UploadOciDriverTaskInput>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<UploadOciDriverTaskInput>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<UploadOciDriverTaskInput>)} interface");
            }
        ...
        string IPersistableModel<UploadOciDriverTaskInput>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
