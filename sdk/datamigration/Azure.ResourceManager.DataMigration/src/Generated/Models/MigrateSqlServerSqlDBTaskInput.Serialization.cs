...
{
    public partial class MigrateSqlServerSqlDBTaskInput : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static MigrateSqlServerSqlDBTaskInput DeserializeMigrateSqlServerSqlDBTaskInput(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
