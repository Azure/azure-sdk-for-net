...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MongoDBFinishCommand>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MongoDBFinishCommand>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MongoDBFinishCommand>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<MongoDBFinishCommand>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
