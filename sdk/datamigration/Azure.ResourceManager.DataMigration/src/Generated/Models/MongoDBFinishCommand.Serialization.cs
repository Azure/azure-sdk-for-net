...
{
    public partial class MongoDBFinishCommand : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static MongoDBFinishCommand DeserializeMongoDBFinishCommand(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
