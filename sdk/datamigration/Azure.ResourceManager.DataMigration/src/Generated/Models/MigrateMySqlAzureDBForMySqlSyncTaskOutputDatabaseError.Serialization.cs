...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MigrateMySqlAzureDBForMySqlSyncTaskOutputDatabaseError>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        MigrateMySqlAzureDBForMySqlSyncTaskOutputDatabaseError IJsonModel<MigrateMySqlAzureDBForMySqlSyncTaskOutputDatabaseError>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<MigrateMySqlAzureDBForMySqlSyncTaskOutputDatabaseError>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        MigrateMySqlAzureDBForMySqlSyncTaskOutputDatabaseError IModel<MigrateMySqlAzureDBForMySqlSyncTaskOutputDatabaseError>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<MigrateMySqlAzureDBForMySqlSyncTaskOutputDatabaseError>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
