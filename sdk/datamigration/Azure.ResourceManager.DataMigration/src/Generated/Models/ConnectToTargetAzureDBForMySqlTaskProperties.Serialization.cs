...
{
    public partial class ConnectToTargetAzureDBForMySqlTaskProperties : IUtf8JsonSerializable
    {
        ...
        internal static ConnectToTargetAzureDBForMySqlTaskProperties DeserializeConnectToTargetAzureDBForMySqlTaskProperties(JsonElement element)
        {
            ...
            return new ConnectToTargetAzureDBForMySqlTaskProperties(taskType, Optional.ToList(errors), Optional.ToNullable(state), Optional.ToList(commands), Optional.ToDictionary(clientData), input.Value, Optional.ToList(output));
        }
    }
}
