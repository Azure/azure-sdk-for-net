...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ConnectToTargetAzureDBForMySqlTaskProperties>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ConnectToTargetAzureDBForMySqlTaskProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ConnectToTargetAzureDBForMySqlTaskProperties)} does not support '{format}' format.");
            }
            ...
            if (options.Format != "W" && !(Output is ChangeTrackingList<ConnectToTargetAzureDBForMySqlTaskOutput> collection && collection.IsUndefined))
            {
        ...
        internal static ConnectToTargetAzureDBForMySqlTaskProperties DeserializeConnectToTargetAzureDBForMySqlTaskProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new ConnectToTargetAzureDBForMySqlTaskProperties(taskType, errors ?? new ChangeTrackingList<ODataError>(), Optional.ToNullable(state), commands ?? new ChangeTrackingList<CommandProperties>(), clientData ?? new ChangeTrackingDictionary<string, string>(), serializedAdditionalRawData, input.Value, output ?? new ChangeTrackingList<ConnectToTargetAzureDBForMySqlTaskOutput>());
        }
