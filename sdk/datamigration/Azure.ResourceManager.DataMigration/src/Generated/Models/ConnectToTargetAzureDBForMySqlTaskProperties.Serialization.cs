...
{
    public partial class ConnectToTargetAzureDBForMySqlTaskProperties : Core.IUtf8JsonSerializable
    {
        ...
        internal static ConnectToTargetAzureDBForMySqlTaskProperties DeserializeConnectToTargetAzureDBForMySqlTaskProperties(JsonElement element)
        {
            ...
            Core.Optional<ConnectToTargetAzureDBForMySqlTaskInput> input = default;
            Core.Optional<IReadOnlyList<ConnectToTargetAzureDBForMySqlTaskOutput>> output = default;
            ...
            return new ConnectToTargetAzureDBForMySqlTaskProperties(taskType, Core.Optional.ToList(errors), Core.Optional.ToNullable(state), Core.Optional.ToList(commands), Core.Optional.ToDictionary(clientData), input.Value, Core.Optional.ToList(output));
        }
    }
}
