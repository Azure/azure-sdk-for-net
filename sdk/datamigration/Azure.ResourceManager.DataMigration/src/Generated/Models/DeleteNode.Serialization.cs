...
{
    public partial class DeleteNode : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static DeleteNode DeserializeDeleteNode(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
