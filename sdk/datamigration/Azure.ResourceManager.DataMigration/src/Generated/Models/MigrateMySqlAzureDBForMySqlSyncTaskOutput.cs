...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    /// </summary>
    [AbstractTypeDeserializer(typeof(UnknownMigrateMySqlAzureDBForMySqlSyncTaskOutput))]
    public abstract partial class MigrateMySqlAzureDBForMySqlSyncTaskOutput
    {
        ...
        internal MigrateMySqlAzureDBForMySqlSyncTaskOutput(string id, string resultType, Dictionary<string, BinaryData> rawData)
        {
            Id = id;
