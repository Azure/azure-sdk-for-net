...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public abstract partial class MigrateMySqlAzureDBForMySqlSyncTaskOutput
    {
        ...
        private protected MigrateMySqlAzureDBForMySqlSyncTaskOutput(string resultType)
        {
        ...
        internal MigrateMySqlAzureDBForMySqlSyncTaskOutput(string id, string resultType, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Id = id;
            ResultType = resultType;
