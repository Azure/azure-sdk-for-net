...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class MigrationValidationDatabaseSummaryResult
    {
        ...
        internal MigrationValidationDatabaseSummaryResult(string id, string migrationId, string sourceDatabaseName, string targetDatabaseName, DateTimeOffset? startedOn, DateTimeOffset? endedOn, MigrationValidationStatus? status, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Id = id;
