...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class MongoDBDatabaseSettings
    {
        ...
        internal MongoDBDatabaseSettings(IDictionary<string, MongoDBCollectionSettings> collections, int? targetRUs, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Collections = collections;
            TargetRUs = targetRUs;
