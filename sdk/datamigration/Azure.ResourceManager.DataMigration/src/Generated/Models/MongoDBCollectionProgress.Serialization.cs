...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    {
        internal static MongoDBCollectionProgress DeserializeMongoDBCollectionProgress(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
