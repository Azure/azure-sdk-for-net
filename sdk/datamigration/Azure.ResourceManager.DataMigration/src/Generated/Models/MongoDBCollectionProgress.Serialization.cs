...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MongoDBCollectionProgress>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MongoDBCollectionProgress>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MongoDBCollectionProgress>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MongoDBCollectionProgress>)} interface");
            }
        ...
        string IPersistableModel<MongoDBCollectionProgress>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
