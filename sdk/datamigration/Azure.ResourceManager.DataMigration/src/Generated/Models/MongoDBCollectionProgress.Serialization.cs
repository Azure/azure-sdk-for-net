...
namespace Azure.ResourceManager.DataMigration.Models
{
    public partial class MongoDBCollectionProgress
    {
        internal static MongoDBCollectionProgress DeserializeMongoDBCollectionProgress(JsonElement element)
        {
            ...
            return new MongoDBCollectionProgress(bytesCopied, documentsCopied, elapsedTime, errors, eventsPending, eventsReplayed, Core.Optional.ToNullable(lastEventTime), Core.Optional.ToNullable(lastReplayTime), name.Value, qualifiedName.Value, resultType, state, totalBytes, totalDocuments);
        }
    }
}
