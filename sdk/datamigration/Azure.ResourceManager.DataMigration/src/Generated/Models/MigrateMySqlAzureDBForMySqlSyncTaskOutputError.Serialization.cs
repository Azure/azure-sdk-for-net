...
{
    public partial class MigrateMySqlAzureDBForMySqlSyncTaskOutputError : IUtf8JsonSerializable, IJsonModel<MigrateMySqlAzureDBForMySqlSyncTaskOutputError>, IPersistableModel<MigrateMySqlAzureDBForMySqlSyncTaskOutputError>
    {
        ...
        void IJsonModel<MigrateMySqlAzureDBForMySqlSyncTaskOutputError>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MigrateMySqlAzureDBForMySqlSyncTaskOutputError)} does not support '{format}' format.");
            }
