...
{
    public partial class Quota : IUtf8JsonSerializable, IJsonModel<Quota>, IPersistableModel<Quota>
    {
        ...
        void IJsonModel<Quota>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(Quota)} does not support '{format}' format.");
            }
