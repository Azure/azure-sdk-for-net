...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FileStorageInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<FileStorageInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<FileStorageInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<FileStorageInfo>)} interface");
            }
        ...
        string IPersistableModel<FileStorageInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
