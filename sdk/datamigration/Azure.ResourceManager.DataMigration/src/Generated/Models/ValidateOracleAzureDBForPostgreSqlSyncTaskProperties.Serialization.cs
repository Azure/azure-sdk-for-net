...
{
    public partial class ValidateOracleAzureDBForPostgreSqlSyncTaskProperties : Core.IUtf8JsonSerializable
    {
        ...
        internal static ValidateOracleAzureDBForPostgreSqlSyncTaskProperties DeserializeValidateOracleAzureDBForPostgreSqlSyncTaskProperties(JsonElement element)
        {
            ...
            Core.Optional<MigrateOracleAzureDBPostgreSqlSyncTaskInput> input = default;
            Core.Optional<IReadOnlyList<ValidateOracleAzureDBPostgreSqlSyncTaskOutput>> output = default;
            ...
            return new ValidateOracleAzureDBForPostgreSqlSyncTaskProperties(taskType, Core.Optional.ToList(errors), Core.Optional.ToNullable(state), Core.Optional.ToList(commands), Core.Optional.ToDictionary(clientData), input.Value, Core.Optional.ToList(output));
        }
    }
}
