...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class ValidateOracleAzureDBForPostgreSqlSyncTaskProperties : DataMigrationProjectTaskProperties, IJsonModel<ValidateOracleAzureDBForPostgreSqlSyncTaskProperties>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<ValidateOracleAzureDBForPostgreSqlSyncTaskProperties>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ValidateOracleAzureDBForPostgreSqlSyncTaskProperties>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        ValidateOracleAzureDBForPostgreSqlSyncTaskProperties IPersistableModel<ValidateOracleAzureDBForPostgreSqlSyncTaskProperties>.Create(BinaryData data, ModelReaderWriterOptions options) => (ValidateOracleAzureDBForPostgreSqlSyncTaskProperties)PersistableModelCreateCore(data, options);
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (options.Format != "W" && Optional.IsCollectionDefined(Output))
            {
                ...
                foreach (ValidateOracleAzureDBPostgreSqlSyncTaskOutput item in Output)
                {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ValidateOracleAzureDBForPostgreSqlSyncTaskProperties IJsonModel<ValidateOracleAzureDBForPostgreSqlSyncTaskProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (ValidateOracleAzureDBForPostgreSqlSyncTaskProperties)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static ValidateOracleAzureDBForPostgreSqlSyncTaskProperties DeserializeValidateOracleAzureDBForPostgreSqlSyncTaskProperties(JsonElement element, ModelReaderWriterOptions options)
        {
