...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class PostgreSqlConnectionInfo : ConnectionInfo
    {
        ...
        internal PostgreSqlConnectionInfo(string connectionInfoType, string userName, string password, string serverName, string dataSource, string serverVersion, string databaseName, int port, bool? encryptConnection, bool? trustServerCertificate, string additionalSettings, string serverBrandVersion, AuthenticationType? authentication, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(connectionInfoType, userName, password, serializedAdditionalRawData)
        {
            ServerName = serverName;
