...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    internal partial class UnknownMigrateMySqlAzureDBForMySqlSyncTaskOutput : MigrateMySqlAzureDBForMySqlSyncTaskOutput
    {
        ...
        internal UnknownMigrateMySqlAzureDBForMySqlSyncTaskOutput(string id, string resultType, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, resultType, serializedAdditionalRawData)
        {
