...
{
    public partial class ProjectTaskData : IUtf8JsonSerializable, IJsonModel<ProjectTaskData>, IPersistableModel<ProjectTaskData>
    {
        ...
        void IJsonModel<ProjectTaskData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ProjectTaskData)} does not support '{format}' format.");
            }
