...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SyncMigrationDatabaseErrorEvent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SyncMigrationDatabaseErrorEvent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SyncMigrationDatabaseErrorEvent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<SyncMigrationDatabaseErrorEvent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
