...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class MongoDBFinishCommand : CommandProperties
    {
        ...
        internal MongoDBFinishCommand(CommandType commandType, IReadOnlyList<ODataError> errors, CommandState? state, MongoDBFinishCommandInput input, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(commandType, errors, state, serializedAdditionalRawData)
        {
            Input = input;
