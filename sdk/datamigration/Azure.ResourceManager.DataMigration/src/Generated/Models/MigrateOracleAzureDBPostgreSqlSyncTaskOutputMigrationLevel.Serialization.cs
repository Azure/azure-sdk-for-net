...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MigrateOracleAzureDBPostgreSqlSyncTaskOutputMigrationLevel>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        MigrateOracleAzureDBPostgreSqlSyncTaskOutputMigrationLevel IJsonModel<MigrateOracleAzureDBPostgreSqlSyncTaskOutputMigrationLevel>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<MigrateOracleAzureDBPostgreSqlSyncTaskOutputMigrationLevel>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        MigrateOracleAzureDBPostgreSqlSyncTaskOutputMigrationLevel IModel<MigrateOracleAzureDBPostgreSqlSyncTaskOutputMigrationLevel>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<MigrateOracleAzureDBPostgreSqlSyncTaskOutputMigrationLevel>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
