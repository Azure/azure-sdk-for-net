...
namespace Azure.ResourceManager.DataMigration.Models
{
    public partial class MigrateSqlServerSqlDBTaskOutputValidationResult : IUtf8JsonSerializable, IModelJsonSerializable<MigrateSqlServerSqlDBTaskOutputValidationResult>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<MigrateSqlServerSqlDBTaskOutputValidationResult>(this, options.Format);
        ...
        internal static MigrateSqlServerSqlDBTaskOutputValidationResult DeserializeMigrateSqlServerSqlDBTaskOutputValidationResult(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new MigrateSqlServerSqlDBTaskOutputValidationResult(id.Value, resultType, migrationId.Value, Optional.ToDictionary(summaryResults), Optional.ToNullable(status), serializedAdditionalRawData);
        }
        ...
        /// <summary> Converts a <see cref="MigrateSqlServerSqlDBTaskOutputValidationResult"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="MigrateSqlServerSqlDBTaskOutputValidationResult"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="MigrateSqlServerSqlDBTaskOutputValidationResult"/>. </summary>
