...
{
    public partial class MongoDBThrottlingSettings : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static MongoDBThrottlingSettings DeserializeMongoDBThrottlingSettings(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
