...
{
    public partial class MongoDBThrottlingSettings : IUtf8JsonSerializable, IJsonModel<MongoDBThrottlingSettings>, IPersistableModel<MongoDBThrottlingSettings>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(MinFreeCpu))
            {
                builder.Append("  minFreeCpu:");
                builder.AppendLine($" '{MinFreeCpu.Value.ToString()}'");
            }

            if (Optional.IsDefined(MinFreeMemoryMb))
            {
                builder.Append("  minFreeMemoryMb:");
                builder.AppendLine($" '{MinFreeMemoryMb.Value.ToString()}'");
            }

            if (Optional.IsDefined(MaxParallelism))
            {
                builder.Append("  maxParallelism:");
                builder.AppendLine($" '{MaxParallelism.Value.ToString()}'");
            }
