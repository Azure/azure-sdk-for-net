...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DatabaseMigrationSqlMIProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DatabaseMigrationSqlMIProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DatabaseMigrationSqlMIProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DatabaseMigrationSqlMIProperties>)} interface");
            }
        ...
        string IPersistableModel<DatabaseMigrationSqlMIProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
