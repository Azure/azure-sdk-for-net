...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MigrateSchemaSqlTaskOutputError>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MigrateSchemaSqlTaskOutputError>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MigrateSchemaSqlTaskOutputError>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MigrateSchemaSqlTaskOutputError>)} interface");
            }
        ...
        string IPersistableModel<MigrateSchemaSqlTaskOutputError>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
