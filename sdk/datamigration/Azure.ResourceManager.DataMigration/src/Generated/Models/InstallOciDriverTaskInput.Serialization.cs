...
{
    internal partial class InstallOciDriverTaskInput : IUtf8JsonSerializable, IJsonModel<InstallOciDriverTaskInput>, IPersistableModel<InstallOciDriverTaskInput>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(DriverPackageName))
            {
                builder.Append("  driverPackageName:");
                builder.AppendLine($" '{DriverPackageName}'");
            }
