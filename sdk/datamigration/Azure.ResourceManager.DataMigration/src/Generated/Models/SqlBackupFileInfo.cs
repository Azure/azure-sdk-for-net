...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class SqlBackupFileInfo
    {
        ...
        internal SqlBackupFileInfo(string fileName, string status, long? totalSize, long? dataRead, long? dataWritten, double? copyThroughput, int? copyDuration, int? familySequenceNumber, Dictionary<string, BinaryData> rawData)
        {
            FileName = fileName;
            Status = status;
            TotalSize = totalSize;
