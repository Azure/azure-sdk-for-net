...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class CopyProgressDetails
    {
        ...
        internal CopyProgressDetails(string tableName, string status, string parallelCopyType, int? usedParallelCopies, long? dataRead, long? dataWritten, long? rowsRead, long? rowsCopied, DateTimeOffset? copyStartOn, double? copyThroughput, int? copyDuration, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            TableName = tableName;
            Status = status;
