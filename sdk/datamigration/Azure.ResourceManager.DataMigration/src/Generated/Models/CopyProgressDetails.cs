...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class CopyProgressDetails
    {
        ...
        internal CopyProgressDetails(string tableName, string status, string parallelCopyType, int? usedParallelCopies, long? dataRead, long? dataWritten, long? rowsRead, long? rowsCopied, DateTimeOffset? copyStart, double? copyThroughput, int? copyDuration, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            TableName = tableName;
            Status = status;
