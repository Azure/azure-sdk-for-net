...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    internal partial class UnknownCommandProperties : CommandProperties
    {
        ...
        internal UnknownCommandProperties(CommandType commandType, IReadOnlyList<ODataError> errors, CommandState? state, Dictionary<string, BinaryData> rawData) : base(commandType, errors, state, rawData)
        {
