...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class MongoDBMigrationSettings
    {
        ...
        internal MongoDBMigrationSettings(int? boostRUs, IDictionary<string, MongoDBDatabaseSettings> databases, MongoDBReplication? replication, MongoDBConnectionInfo source, MongoDBConnectionInfo target, MongoDBThrottlingSettings throttling, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            BoostRUs = boostRUs;
            Databases = databases;
