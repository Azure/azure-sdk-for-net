...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class MigrateMySqlAzureDBForMySqlOfflineTaskOutputError : MigrateMySqlAzureDBForMySqlOfflineTaskOutput
    {
        ...
        internal MigrateMySqlAzureDBForMySqlOfflineTaskOutputError(string id, string resultType, ReportableException error, Dictionary<string, BinaryData> rawData) : base(id, resultType, rawData)
        {
            Error = error;
