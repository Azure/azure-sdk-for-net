...
{
    public partial class ConnectToTargetSqlMISyncTaskProperties : Core.IUtf8JsonSerializable
    {
        ...
        internal static ConnectToTargetSqlMISyncTaskProperties DeserializeConnectToTargetSqlMISyncTaskProperties(JsonElement element)
        {
            ...
            Core.Optional<ConnectToTargetSqlMISyncTaskInput> input = default;
            Core.Optional<IReadOnlyList<ConnectToTargetSqlMISyncTaskOutput>> output = default;
            ...
            return new ConnectToTargetSqlMISyncTaskProperties(taskType, Core.Optional.ToList(errors), Core.Optional.ToNullable(state), Core.Optional.ToList(commands), Core.Optional.ToDictionary(clientData), input.Value, Core.Optional.ToList(output));
        }
    }
}
