...
{
    public partial class ConnectToTargetSqlMISyncTaskProperties : IUtf8JsonSerializable
    {
        ...
        internal static ConnectToTargetSqlMISyncTaskProperties DeserializeConnectToTargetSqlMISyncTaskProperties(JsonElement element)
        {
            ...
            return new ConnectToTargetSqlMISyncTaskProperties(taskType, Optional.ToList(errors), Optional.ToNullable(state), Optional.ToList(commands), Optional.ToDictionary(clientData), input.Value, Optional.ToList(output));
        }
    }
}
