...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class MongoDBObjectInfo
    {
        ...
        internal MongoDBObjectInfo(long averageDocumentSize, long dataSize, long documentCount, string name, string qualifiedName, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            AverageDocumentSize = averageDocumentSize;
            DataSize = dataSize;
            DocumentCount = documentCount;
