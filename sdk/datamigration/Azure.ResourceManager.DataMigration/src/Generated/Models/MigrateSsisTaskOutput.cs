...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    /// </summary>
    [DeserializationProxy(typeof(UnknownMigrateSsisTaskOutput))]
    public abstract partial class MigrateSsisTaskOutput
    {
        ...
        internal MigrateSsisTaskOutput(string id, string resultType, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
