...
namespace Azure.ResourceManager.DataMigration.Models
{
    internal partial class UnknownMigrateOracleAzureDBPostgreSqlSyncTaskOutput : MigrateOracleAzureDBPostgreSqlSyncTaskOutput
    {
        ...
        internal UnknownMigrateOracleAzureDBPostgreSqlSyncTaskOutput(string id, string resultType, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, resultType ?? "unknown", additionalBinaryDataProperties)
        {
        }
    }
}
