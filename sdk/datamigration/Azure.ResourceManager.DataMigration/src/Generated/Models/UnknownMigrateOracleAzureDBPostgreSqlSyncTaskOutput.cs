...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    internal partial class UnknownMigrateOracleAzureDBPostgreSqlSyncTaskOutput : MigrateOracleAzureDBPostgreSqlSyncTaskOutput
    {
        ...
        internal UnknownMigrateOracleAzureDBPostgreSqlSyncTaskOutput(string id, string resultType, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, resultType, serializedAdditionalRawData)
        {
