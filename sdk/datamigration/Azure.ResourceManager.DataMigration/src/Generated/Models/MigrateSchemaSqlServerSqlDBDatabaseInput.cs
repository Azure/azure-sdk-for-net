...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class MigrateSchemaSqlServerSqlDBDatabaseInput
    {
        ...
        internal MigrateSchemaSqlServerSqlDBDatabaseInput(string name, string id, string targetDatabaseName, SchemaMigrationSetting schemaSetting, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Id = id;
