...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MigrateSqlServerSqlDBSyncTaskInput>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MigrateSqlServerSqlDBSyncTaskInput>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MigrateSqlServerSqlDBSyncTaskInput>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MigrateSqlServerSqlDBSyncTaskInput>)} interface");
            }
        ...
        string IPersistableModel<MigrateSqlServerSqlDBSyncTaskInput>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
