...
{
    public partial class GetTdeCertificatesSqlTaskProperties : IUtf8JsonSerializable
    {
        ...
        internal static GetTdeCertificatesSqlTaskProperties DeserializeGetTdeCertificatesSqlTaskProperties(JsonElement element)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("input"u8))
                {
                    ...
                    input = GetTdeCertificatesSqlTaskInput.DeserializeGetTdeCertificatesSqlTaskInput(property.Value);
                    continue;
                }
                if (property.NameEquals("output"u8))
                {
                    ...
                    List<GetTdeCertificatesSqlTaskOutput> array = new List<GetTdeCertificatesSqlTaskOutput>();
                    foreach (var item in property.Value.EnumerateArray())
                    {
                        array.Add(GetTdeCertificatesSqlTaskOutput.DeserializeGetTdeCertificatesSqlTaskOutput(item));
                    }
                    output = array;
                    continue;
                }
            ...
            return new GetTdeCertificatesSqlTaskProperties(taskType, Optional.ToList(errors), Optional.ToNullable(state), Optional.ToList(commands), Optional.ToDictionary(clientData), input.Value, Optional.ToList(output));
        }
    }
}
