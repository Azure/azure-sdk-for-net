...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class ConnectToTargetAzureDBForPostgreSqlSyncTaskInput
    {
        ...
        internal ConnectToTargetAzureDBForPostgreSqlSyncTaskInput(PostgreSqlConnectionInfo sourceConnectionInfo, PostgreSqlConnectionInfo targetConnectionInfo, Dictionary<string, BinaryData> rawData)
        {
            SourceConnectionInfo = sourceConnectionInfo;
            TargetConnectionInfo = targetConnectionInfo;
            _rawData = rawData;
