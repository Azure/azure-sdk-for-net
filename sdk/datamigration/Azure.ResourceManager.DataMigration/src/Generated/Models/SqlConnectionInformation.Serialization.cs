...
namespace Azure.ResourceManager.DataMigration.Models
{
    public partial class SqlConnectionInformation : IUtf8JsonSerializable, IJsonModel<SqlConnectionInformation>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<SqlConnectionInformation>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SqlConnectionInformation>)} interface");
            }
