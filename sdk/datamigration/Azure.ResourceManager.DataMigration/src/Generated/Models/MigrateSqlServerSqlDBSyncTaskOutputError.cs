...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class MigrateSqlServerSqlDBSyncTaskOutputError : MigrateSqlServerSqlDBSyncTaskOutput
    {
        ...
        internal MigrateSqlServerSqlDBSyncTaskOutputError(string id, string resultType, IDictionary<string, BinaryData> serializedAdditionalRawData, DataMigrationReportableException error) : base(id, resultType, serializedAdditionalRawData)
        {
            Error = error;
