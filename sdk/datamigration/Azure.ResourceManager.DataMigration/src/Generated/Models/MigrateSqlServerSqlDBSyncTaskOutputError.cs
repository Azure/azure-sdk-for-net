...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class MigrateSqlServerSqlDBSyncTaskOutputError : MigrateSqlServerSqlDBSyncTaskOutput
    {
        ...
        internal MigrateSqlServerSqlDBSyncTaskOutputError() : base("ErrorOutput")
        {
        }
        ...
        internal MigrateSqlServerSqlDBSyncTaskOutputError(string id, string resultType, IDictionary<string, BinaryData> additionalBinaryDataProperties, DataMigrationReportableException error) : base(id, resultType, additionalBinaryDataProperties)
        {
            Error = error;
        }
