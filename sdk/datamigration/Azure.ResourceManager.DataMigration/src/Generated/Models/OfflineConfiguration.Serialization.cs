...
{
    public partial class OfflineConfiguration : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static OfflineConfiguration DeserializeOfflineConfiguration(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
