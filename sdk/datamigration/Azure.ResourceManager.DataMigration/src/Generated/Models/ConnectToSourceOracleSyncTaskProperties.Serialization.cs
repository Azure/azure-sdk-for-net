...
{
    public partial class ConnectToSourceOracleSyncTaskProperties : IUtf8JsonSerializable
    {
        ...
        internal static ConnectToSourceOracleSyncTaskProperties DeserializeConnectToSourceOracleSyncTaskProperties(JsonElement element)
        {
            ...
            return new ConnectToSourceOracleSyncTaskProperties(taskType, Optional.ToList(errors), Optional.ToNullable(state), Optional.ToList(commands), Optional.ToDictionary(clientData), input.Value, Optional.ToList(output));
        }
    }
}
