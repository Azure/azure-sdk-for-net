...
{
    public partial class ConnectToSourceOracleSyncTaskProperties : Core.IUtf8JsonSerializable
    {
        ...
        internal static ConnectToSourceOracleSyncTaskProperties DeserializeConnectToSourceOracleSyncTaskProperties(JsonElement element)
        {
            ...
            Core.Optional<ConnectToSourceOracleSyncTaskInput> input = default;
            Core.Optional<IReadOnlyList<ConnectToSourceOracleSyncTaskOutput>> output = default;
            ...
            return new ConnectToSourceOracleSyncTaskProperties(taskType, Core.Optional.ToList(errors), Core.Optional.ToNullable(state), Core.Optional.ToList(commands), Core.Optional.ToDictionary(clientData), input.Value, Core.Optional.ToList(output));
        }
    }
}
