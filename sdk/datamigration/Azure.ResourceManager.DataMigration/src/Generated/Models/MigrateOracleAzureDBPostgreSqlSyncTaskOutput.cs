...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    /// </summary>
    [DeserializationProxy(typeof(UnknownMigrateOracleAzureDBPostgreSqlSyncTaskOutput))]
    public abstract partial class MigrateOracleAzureDBPostgreSqlSyncTaskOutput
    {
        ...
        internal MigrateOracleAzureDBPostgreSqlSyncTaskOutput(string id, string resultType, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
