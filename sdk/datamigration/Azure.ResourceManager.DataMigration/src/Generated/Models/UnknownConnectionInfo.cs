...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    internal partial class UnknownConnectionInfo : ConnectionInfo
    {
        ...
        internal UnknownConnectionInfo(string connectionInfoType, string userName, string password, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(connectionInfoType, userName, password, serializedAdditionalRawData)
        {
