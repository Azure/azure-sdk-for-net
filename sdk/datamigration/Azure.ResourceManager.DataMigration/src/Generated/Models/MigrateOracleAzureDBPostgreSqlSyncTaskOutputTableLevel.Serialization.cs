...
{
    public partial class MigrateOracleAzureDBPostgreSqlSyncTaskOutputTableLevel : IUtf8JsonSerializable, IJsonModel<MigrateOracleAzureDBPostgreSqlSyncTaskOutputTableLevel>, IPersistableModel<MigrateOracleAzureDBPostgreSqlSyncTaskOutputTableLevel>
    {
        ...
        void IJsonModel<MigrateOracleAzureDBPostgreSqlSyncTaskOutputTableLevel>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MigrateOracleAzureDBPostgreSqlSyncTaskOutputTableLevel)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<MigrateOracleAzureDBPostgreSqlSyncTaskOutputTableLevel>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(MigrateOracleAzureDBPostgreSqlSyncTaskOutputTableLevel)} does not support '{options.Format}' format.");
            }
        }
