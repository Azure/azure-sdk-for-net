...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class MigrateOracleAzureDBPostgreSqlSyncTaskInput : IJsonModel<MigrateOracleAzureDBPostgreSqlSyncTaskInput>
    {
        ...
        protected virtual MigrateOracleAzureDBPostgreSqlSyncTaskInput PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<MigrateOracleAzureDBPostgreSqlSyncTaskInput>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<MigrateOracleAzureDBPostgreSqlSyncTaskInput>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        MigrateOracleAzureDBPostgreSqlSyncTaskInput IPersistableModel<MigrateOracleAzureDBPostgreSqlSyncTaskInput>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            foreach (MigrateOracleAzureDBPostgreSqlSyncDatabaseInput item in SelectedDatabases)
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        MigrateOracleAzureDBPostgreSqlSyncTaskInput IJsonModel<MigrateOracleAzureDBPostgreSqlSyncTaskInput>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual MigrateOracleAzureDBPostgreSqlSyncTaskInput JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<MigrateOracleAzureDBPostgreSqlSyncTaskInput>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static MigrateOracleAzureDBPostgreSqlSyncTaskInput DeserializeMigrateOracleAzureDBPostgreSqlSyncTaskInput(JsonElement element, ModelReaderWriterOptions options)
        {
