...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class GetUserTablesSqlSyncTaskOutput
    {
        ...
        internal GetUserTablesSqlSyncTaskOutput(string databasesToSourceTables, string databasesToTargetTables, string tableValidationErrors, IReadOnlyList<ReportableException> validationErrors, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
