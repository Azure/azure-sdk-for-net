...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    /// </summary>
    [DeserializationProxy(typeof(UnknownMigrateSqlServerSqlDBSyncTaskOutput))]
    public abstract partial class MigrateSqlServerSqlDBSyncTaskOutput
    {
        ...
        internal MigrateSqlServerSqlDBSyncTaskOutput(string id, string resultType, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
