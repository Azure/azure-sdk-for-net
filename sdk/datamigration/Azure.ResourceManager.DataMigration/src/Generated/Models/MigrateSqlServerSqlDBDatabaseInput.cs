...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class MigrateSqlServerSqlDBDatabaseInput
    {
        ...
        internal MigrateSqlServerSqlDBDatabaseInput(string name, string targetDatabaseName, bool? makeSourceDBReadOnly, IDictionary<string, string> tableMap, BinaryData schemaSetting, string id, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
