...
{
    public partial class MigrationReportResult : IUtf8JsonSerializable, IJsonModel<MigrationReportResult>, IPersistableModel<MigrationReportResult>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ReportUri))
            {
                ...
                builder.AppendLine($" '{ReportUri.AbsoluteUri}'");
            }
