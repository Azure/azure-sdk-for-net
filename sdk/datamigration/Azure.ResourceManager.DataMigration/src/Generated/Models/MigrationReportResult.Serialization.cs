...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MigrationReportResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MigrationReportResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MigrationReportResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MigrationReportResult>)} interface");
            }
        ...
        string IPersistableModel<MigrationReportResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
