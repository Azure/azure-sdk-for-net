...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    /// </summary>
    [AbstractTypeDeserializer(typeof(UnknownMigrateMySqlAzureDBForMySqlOfflineTaskOutput))]
    public abstract partial class MigrateMySqlAzureDBForMySqlOfflineTaskOutput
    {
        ...
        internal MigrateMySqlAzureDBForMySqlOfflineTaskOutput(string id, string resultType, Dictionary<string, BinaryData> rawData)
        {
            Id = id;
