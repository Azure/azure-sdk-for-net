...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    /// </summary>
    [DeserializationProxy(typeof(UnknownMigrateMySqlAzureDBForMySqlOfflineTaskOutput))]
    public abstract partial class MigrateMySqlAzureDBForMySqlOfflineTaskOutput
    {
        ...
        internal MigrateMySqlAzureDBForMySqlOfflineTaskOutput(string id, string resultType, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
