...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MongoDBShardKeyField>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MongoDBShardKeyField>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MongoDBShardKeyField>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MongoDBShardKeyField>)} interface");
            }
        ...
        string IPersistableModel<MongoDBShardKeyField>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
