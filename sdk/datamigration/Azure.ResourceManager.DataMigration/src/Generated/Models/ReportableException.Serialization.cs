...
{
    public partial class ReportableException : IUtf8JsonSerializable, IJsonModel<ReportableException>, IPersistableModel<ReportableException>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ActionableMessage))
            {
                builder.Append("  actionableMessage:");
                builder.AppendLine($" '{ActionableMessage}'");
            }
            ...
            if (Optional.IsDefined(LineNumber))
            {
                ...
                builder.AppendLine($" '{LineNumber}'");
            }

            if (Optional.IsDefined(HResult))
            {
                builder.Append("  hResult:");
                builder.AppendLine($" '{HResult.Value.ToString()}'");
            }
