...
{
    public partial class MigrateSchemaSqlServerSqlDBTaskInput : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static MigrateSchemaSqlServerSqlDBTaskInput DeserializeMigrateSchemaSqlServerSqlDBTaskInput(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
