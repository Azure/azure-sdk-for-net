...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class AzureActiveDirectoryApp
    {
        ...
        internal AzureActiveDirectoryApp(string applicationId, string appKey, Guid? tenantId, bool? ignoreAzurePermissions, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
