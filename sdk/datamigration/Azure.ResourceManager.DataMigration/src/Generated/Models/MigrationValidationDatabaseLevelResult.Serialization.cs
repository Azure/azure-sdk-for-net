...
{
    internal partial class MigrationValidationDatabaseLevelResult
    {
        internal static MigrationValidationDatabaseLevelResult DeserializeMigrationValidationDatabaseLevelResult(JsonElement element)
        {
            ...
            return new MigrationValidationDatabaseLevelResult(id.Value, migrationId.Value, sourceDatabaseName.Value, targetDatabaseName.Value, Optional.ToNullable(startedOn), Optional.ToNullable(endedOn), dataIntegrityValidationResult.Value, schemaValidationResult.Value, queryAnalysisValidationResult.Value, Optional.ToNullable(status));
        }
    }
}
