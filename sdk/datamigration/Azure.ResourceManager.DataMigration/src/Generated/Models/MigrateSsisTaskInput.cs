...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class MigrateSsisTaskInput : SqlMigrationTaskInput
    {
        ...
        internal MigrateSsisTaskInput(SqlConnectionInfo sourceConnectionInfo, SqlConnectionInfo targetConnectionInfo, SsisMigrationInfo ssisMigrationInfo, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(sourceConnectionInfo, targetConnectionInfo, serializedAdditionalRawData)
        {
            SsisMigrationInfo = ssisMigrationInfo;
        }
