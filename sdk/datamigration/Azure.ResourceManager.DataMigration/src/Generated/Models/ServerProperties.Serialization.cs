...
{
    public partial class ServerProperties : IUtf8JsonSerializable, IJsonModel<ServerProperties>, IPersistableModel<ServerProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  serverPlatform:");
                builder.AppendLine($" '{ServerPlatform}'");
            }
            ...
            {
                builder.Append("  serverOperatingSystemVersion:");
                builder.AppendLine($" '{ServerOperatingSystemVersion}'");
            }

            if (Optional.IsDefined(ServerDatabaseCount))
            {
                builder.Append("  serverDatabaseCount:");
                builder.AppendLine($" '{ServerDatabaseCount.Value.ToString()}'");
            }
