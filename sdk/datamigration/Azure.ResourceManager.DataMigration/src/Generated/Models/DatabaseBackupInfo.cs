...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class DatabaseBackupInfo
    {
        ...
        internal DatabaseBackupInfo(string databaseName, BackupType? backupType, IReadOnlyList<string> backupFiles, int? position, bool? isDamaged, bool? isCompressed, int? familyCount, DateTimeOffset? backupFinishOn, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
