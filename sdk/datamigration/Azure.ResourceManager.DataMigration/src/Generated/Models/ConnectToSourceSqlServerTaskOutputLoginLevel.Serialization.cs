...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ConnectToSourceSqlServerTaskOutputLoginLevel>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<ConnectToSourceSqlServerTaskOutputLoginLevel>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ConnectToSourceSqlServerTaskOutputLoginLevel>)} interface");
            }
        ...
        string IPersistableModel<ConnectToSourceSqlServerTaskOutputLoginLevel>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
