...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class MigrateMySqlAzureDBForMySqlSyncTaskProperties : DataMigrationProjectTaskProperties, IJsonModel<MigrateMySqlAzureDBForMySqlSyncTaskProperties>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<MigrateMySqlAzureDBForMySqlSyncTaskProperties>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<MigrateMySqlAzureDBForMySqlSyncTaskProperties>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        MigrateMySqlAzureDBForMySqlSyncTaskProperties IPersistableModel<MigrateMySqlAzureDBForMySqlSyncTaskProperties>.Create(BinaryData data, ModelReaderWriterOptions options) => (MigrateMySqlAzureDBForMySqlSyncTaskProperties)PersistableModelCreateCore(data, options);
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (options.Format != "W" && Optional.IsCollectionDefined(Output))
            {
                ...
                foreach (MigrateMySqlAzureDBForMySqlSyncTaskOutput item in Output)
                {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        MigrateMySqlAzureDBForMySqlSyncTaskProperties IJsonModel<MigrateMySqlAzureDBForMySqlSyncTaskProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (MigrateMySqlAzureDBForMySqlSyncTaskProperties)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static MigrateMySqlAzureDBForMySqlSyncTaskProperties DeserializeMigrateMySqlAzureDBForMySqlSyncTaskProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("input"u8))
                {
                    ...
                    input = MigrateMySqlAzureDBForMySqlSyncTaskInput.DeserializeMigrateMySqlAzureDBForMySqlSyncTaskInput(prop.Value, options);
                    continue;
                }
