...
{
    public partial class MigrateMySqlAzureDBForMySqlSyncTaskProperties : Core.IUtf8JsonSerializable
    {
        ...
        internal static MigrateMySqlAzureDBForMySqlSyncTaskProperties DeserializeMigrateMySqlAzureDBForMySqlSyncTaskProperties(JsonElement element)
        {
            ...
            Core.Optional<MigrateMySqlAzureDBForMySqlSyncTaskInput> input = default;
            Core.Optional<IReadOnlyList<MigrateMySqlAzureDBForMySqlSyncTaskOutput>> output = default;
            ...
            return new MigrateMySqlAzureDBForMySqlSyncTaskProperties(taskType, Core.Optional.ToList(errors), Core.Optional.ToNullable(state), Core.Optional.ToList(commands), Core.Optional.ToDictionary(clientData), input.Value, Core.Optional.ToList(output));
        }
    }
}
