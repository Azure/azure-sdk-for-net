...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class ConnectToTargetSqlMITaskOutput
    {
        ...
        internal ConnectToTargetSqlMITaskOutput(string id, string targetServerVersion, string targetServerBrandVersion, IReadOnlyList<string> logins, IReadOnlyList<string> agentJobs, IReadOnlyList<DataMigrationReportableException> validationErrors, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Id = id;
