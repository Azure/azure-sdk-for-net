...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MigrateOracleAzureDBPostgreSqlSyncDatabaseInput>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<MigrateOracleAzureDBPostgreSqlSyncDatabaseInput>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MigrateOracleAzureDBPostgreSqlSyncDatabaseInput>)} interface");
            }
        ...
        string IPersistableModel<MigrateOracleAzureDBPostgreSqlSyncDatabaseInput>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
