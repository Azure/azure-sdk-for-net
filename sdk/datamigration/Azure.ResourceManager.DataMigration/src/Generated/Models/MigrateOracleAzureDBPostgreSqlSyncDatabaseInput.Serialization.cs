...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MigrateOracleAzureDBPostgreSqlSyncDatabaseInput>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        MigrateOracleAzureDBPostgreSqlSyncDatabaseInput IJsonModel<MigrateOracleAzureDBPostgreSqlSyncDatabaseInput>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<MigrateOracleAzureDBPostgreSqlSyncDatabaseInput>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        MigrateOracleAzureDBPostgreSqlSyncDatabaseInput IModel<MigrateOracleAzureDBPostgreSqlSyncDatabaseInput>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<MigrateOracleAzureDBPostgreSqlSyncDatabaseInput>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
