...
{
    public partial class MigrateOracleAzureDBPostgreSqlSyncDatabaseInput : IUtf8JsonSerializable, IJsonModel<MigrateOracleAzureDBPostgreSqlSyncDatabaseInput>, IPersistableModel<MigrateOracleAzureDBPostgreSqlSyncDatabaseInput>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(CaseManipulation))
            {
                builder.Append("  caseManipulation:");
                builder.AppendLine($" '{CaseManipulation}'");
            }
