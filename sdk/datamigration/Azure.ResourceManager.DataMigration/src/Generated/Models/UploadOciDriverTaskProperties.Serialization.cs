...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class UploadOciDriverTaskProperties : DataMigrationProjectTaskProperties, IJsonModel<UploadOciDriverTaskProperties>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<UploadOciDriverTaskProperties>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<UploadOciDriverTaskProperties>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        UploadOciDriverTaskProperties IPersistableModel<UploadOciDriverTaskProperties>.Create(BinaryData data, ModelReaderWriterOptions options) => (UploadOciDriverTaskProperties)PersistableModelCreateCore(data, options);
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (options.Format != "W" && Optional.IsCollectionDefined(Output))
            {
                ...
                foreach (UploadOciDriverTaskOutput item in Output)
                {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        UploadOciDriverTaskProperties IJsonModel<UploadOciDriverTaskProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (UploadOciDriverTaskProperties)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UploadOciDriverTaskProperties DeserializeUploadOciDriverTaskProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("input"u8))
                {
                    ...
                    input = UploadOciDriverTaskInput.DeserializeUploadOciDriverTaskInput(prop.Value, options);
                    continue;
                }
