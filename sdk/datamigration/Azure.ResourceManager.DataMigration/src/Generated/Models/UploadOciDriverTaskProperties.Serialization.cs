...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<UploadOciDriverTaskProperties>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<UploadOciDriverTaskProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(UploadOciDriverTaskProperties)} does not support '{format}' format.");
            }
            ...
            if (options.Format != "W" && !(Output is ChangeTrackingList<UploadOciDriverTaskOutput> collection && collection.IsUndefined))
            {
        ...
        internal static UploadOciDriverTaskProperties DeserializeUploadOciDriverTaskProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new UploadOciDriverTaskProperties(taskType, errors ?? new ChangeTrackingList<ODataError>(), Optional.ToNullable(state), commands ?? new ChangeTrackingList<CommandProperties>(), Optional.ToDictionary(clientData), serializedAdditionalRawData, input.Value, output ?? new ChangeTrackingList<UploadOciDriverTaskOutput>());
        }
