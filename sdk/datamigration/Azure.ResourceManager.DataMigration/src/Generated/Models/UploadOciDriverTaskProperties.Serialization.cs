...
namespace Azure.ResourceManager.DataMigration.Models
{
    public partial class UploadOciDriverTaskProperties : IUtf8JsonSerializable, IModelJsonSerializable<UploadOciDriverTaskProperties>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<UploadOciDriverTaskProperties>(this, options.Format);
        ...
        internal static UploadOciDriverTaskProperties DeserializeUploadOciDriverTaskProperties(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new UploadOciDriverTaskProperties(taskType, Optional.ToList(errors), Optional.ToNullable(state), Optional.ToList(commands), Optional.ToDictionary(clientData), input.Value, Optional.ToList(output), serializedAdditionalRawData);
        }
