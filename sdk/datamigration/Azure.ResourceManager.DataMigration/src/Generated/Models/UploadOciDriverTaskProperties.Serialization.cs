...
{
    public partial class UploadOciDriverTaskProperties : IUtf8JsonSerializable
    {
        ...
        internal static UploadOciDriverTaskProperties DeserializeUploadOciDriverTaskProperties(JsonElement element)
        {
            ...
            return new UploadOciDriverTaskProperties(taskType, Optional.ToList(errors), Optional.ToNullable(state), Optional.ToList(commands), Optional.ToDictionary(clientData), input.Value, Optional.ToList(output));
        }
    }
}
