...
{
    public partial class UploadOciDriverTaskProperties : Core.IUtf8JsonSerializable
    {
        ...
        internal static UploadOciDriverTaskProperties DeserializeUploadOciDriverTaskProperties(JsonElement element)
        {
            ...
            Core.Optional<UploadOciDriverTaskInput> input = default;
            Core.Optional<IReadOnlyList<UploadOciDriverTaskOutput>> output = default;
            ...
            return new UploadOciDriverTaskProperties(taskType, Core.Optional.ToList(errors), Core.Optional.ToNullable(state), Core.Optional.ToList(commands), Core.Optional.ToDictionary(clientData), input.Value, Core.Optional.ToList(output));
        }
    }
}
