...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class ConnectToTargetSqlDBTaskOutput
    {
        ...
        internal ConnectToTargetSqlDBTaskOutput(string id, string databases, string targetServerVersion, string targetServerBrandVersion, Dictionary<string, BinaryData> rawData)
        {
            Id = id;
            Databases = databases;
