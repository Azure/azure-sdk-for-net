...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class ConnectToTargetSqlDBTaskOutput
    {
        ...
        /// <summary> Initializes a new instance of <see cref="ConnectToTargetSqlDBTaskOutput"/>. </summary>
        ...
        internal ConnectToTargetSqlDBTaskOutput(string id, string databases, string targetServerVersion, string targetServerBrandVersion, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Id = id;
            Databases = databases;
