...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class MigrateSqlServerSqlDBSyncTaskOutputTableLevel : MigrateSqlServerSqlDBSyncTaskOutput, IJsonModel<MigrateSqlServerSqlDBSyncTaskOutputTableLevel>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<MigrateSqlServerSqlDBSyncTaskOutputTableLevel>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<MigrateSqlServerSqlDBSyncTaskOutputTableLevel>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        MigrateSqlServerSqlDBSyncTaskOutputTableLevel IPersistableModel<MigrateSqlServerSqlDBSyncTaskOutputTableLevel>.Create(BinaryData data, ModelReaderWriterOptions options) => (MigrateSqlServerSqlDBSyncTaskOutputTableLevel)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        MigrateSqlServerSqlDBSyncTaskOutputTableLevel IJsonModel<MigrateSqlServerSqlDBSyncTaskOutputTableLevel>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (MigrateSqlServerSqlDBSyncTaskOutputTableLevel)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static MigrateSqlServerSqlDBSyncTaskOutputTableLevel DeserializeMigrateSqlServerSqlDBSyncTaskOutputTableLevel(JsonElement element, ModelReaderWriterOptions options)
        {
