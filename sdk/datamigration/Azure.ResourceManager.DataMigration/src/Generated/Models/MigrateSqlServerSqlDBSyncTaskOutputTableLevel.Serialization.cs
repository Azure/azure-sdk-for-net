...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MigrateSqlServerSqlDBSyncTaskOutputTableLevel>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<MigrateSqlServerSqlDBSyncTaskOutputTableLevel>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MigrateSqlServerSqlDBSyncTaskOutputTableLevel>)} interface");
            }
        ...
        string IPersistableModel<MigrateSqlServerSqlDBSyncTaskOutputTableLevel>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
