...
namespace Azure.ResourceManager.DataMigration.Models
{
    public partial class MigrateSqlServerSqlDBSyncTaskOutputTableLevel
    {
        internal static MigrateSqlServerSqlDBSyncTaskOutputTableLevel DeserializeMigrateSqlServerSqlDBSyncTaskOutputTableLevel(JsonElement element)
        {
            ...
            return new MigrateSqlServerSqlDBSyncTaskOutputTableLevel(id.Value, resultType, tableName.Value, databaseName.Value, Core.Optional.ToNullable(cdcInsertCounter), Core.Optional.ToNullable(cdcUpdateCounter), Core.Optional.ToNullable(cdcDeleteCounter), Core.Optional.ToNullable(fullLoadEstFinishTime), Core.Optional.ToNullable(fullLoadStartedOn), Core.Optional.ToNullable(fullLoadEndedOn), Core.Optional.ToNullable(fullLoadTotalRows), Core.Optional.ToNullable(state), Core.Optional.ToNullable(totalChangesApplied), Core.Optional.ToNullable(dataErrorsCounter), Core.Optional.ToNullable(lastModifiedTime));
        }
    }
}
