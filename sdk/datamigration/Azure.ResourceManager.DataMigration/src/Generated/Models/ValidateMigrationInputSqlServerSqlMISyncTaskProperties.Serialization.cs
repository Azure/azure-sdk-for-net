...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class ValidateMigrationInputSqlServerSqlMISyncTaskProperties : DataMigrationProjectTaskProperties, IJsonModel<ValidateMigrationInputSqlServerSqlMISyncTaskProperties>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<ValidateMigrationInputSqlServerSqlMISyncTaskProperties>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ValidateMigrationInputSqlServerSqlMISyncTaskProperties>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        ValidateMigrationInputSqlServerSqlMISyncTaskProperties IPersistableModel<ValidateMigrationInputSqlServerSqlMISyncTaskProperties>.Create(BinaryData data, ModelReaderWriterOptions options) => (ValidateMigrationInputSqlServerSqlMISyncTaskProperties)PersistableModelCreateCore(data, options);
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (options.Format != "W" && Optional.IsCollectionDefined(Output))
            {
                ...
                foreach (ValidateMigrationInputSqlServerSqlMISyncTaskOutput item in Output)
                {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ValidateMigrationInputSqlServerSqlMISyncTaskProperties IJsonModel<ValidateMigrationInputSqlServerSqlMISyncTaskProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (ValidateMigrationInputSqlServerSqlMISyncTaskProperties)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static ValidateMigrationInputSqlServerSqlMISyncTaskProperties DeserializeValidateMigrationInputSqlServerSqlMISyncTaskProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("input"u8))
                {
                    ...
                    input = ValidateMigrationInputSqlServerSqlMISyncTaskInput.DeserializeValidateMigrationInputSqlServerSqlMISyncTaskInput(prop.Value, options);
                    continue;
                }
