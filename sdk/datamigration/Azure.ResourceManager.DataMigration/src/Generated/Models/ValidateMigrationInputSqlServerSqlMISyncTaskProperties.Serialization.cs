...
{
    public partial class ValidateMigrationInputSqlServerSqlMISyncTaskProperties : Core.IUtf8JsonSerializable
    {
        ...
        internal static ValidateMigrationInputSqlServerSqlMISyncTaskProperties DeserializeValidateMigrationInputSqlServerSqlMISyncTaskProperties(JsonElement element)
        {
            ...
            Core.Optional<ValidateMigrationInputSqlServerSqlMISyncTaskInput> input = default;
            Core.Optional<IReadOnlyList<ValidateMigrationInputSqlServerSqlMISyncTaskOutput>> output = default;
            ...
            return new ValidateMigrationInputSqlServerSqlMISyncTaskProperties(taskType, Core.Optional.ToList(errors), Core.Optional.ToNullable(state), Core.Optional.ToList(commands), Core.Optional.ToDictionary(clientData), input.Value, Core.Optional.ToList(output));
        }
    }
}
