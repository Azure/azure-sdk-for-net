...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ValidateMigrationInputSqlServerSqlMISyncTaskProperties>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ValidateMigrationInputSqlServerSqlMISyncTaskProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ValidateMigrationInputSqlServerSqlMISyncTaskProperties)} does not support '{format}' format.");
            }
            ...
            if (options.Format != "W" && !(Output is ChangeTrackingList<ValidateMigrationInputSqlServerSqlMISyncTaskOutput> collection && collection.IsUndefined))
            {
        ...
        internal static ValidateMigrationInputSqlServerSqlMISyncTaskProperties DeserializeValidateMigrationInputSqlServerSqlMISyncTaskProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new ValidateMigrationInputSqlServerSqlMISyncTaskProperties(taskType, errors ?? new ChangeTrackingList<ODataError>(), Optional.ToNullable(state), commands ?? new ChangeTrackingList<CommandProperties>(), clientData ?? new ChangeTrackingDictionary<string, string>(), serializedAdditionalRawData, input.Value, output ?? new ChangeTrackingList<ValidateMigrationInputSqlServerSqlMISyncTaskOutput>());
        }
