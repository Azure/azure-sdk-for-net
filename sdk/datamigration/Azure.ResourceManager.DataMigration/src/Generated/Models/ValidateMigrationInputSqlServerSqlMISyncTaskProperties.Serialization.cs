...
namespace Azure.ResourceManager.DataMigration.Models
{
    public partial class ValidateMigrationInputSqlServerSqlMISyncTaskProperties : IUtf8JsonSerializable, IModelJsonSerializable<ValidateMigrationInputSqlServerSqlMISyncTaskProperties>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<ValidateMigrationInputSqlServerSqlMISyncTaskProperties>(this, options.Format);
            ...
            if (Optional.IsDefined(Input))
            {
                ...
                {
                    ((IModelJsonSerializable<ValidateMigrationInputSqlServerSqlMISyncTaskInput>)Input).Serialize(writer, options);
                }
            }
        ...
        internal static ValidateMigrationInputSqlServerSqlMISyncTaskProperties DeserializeValidateMigrationInputSqlServerSqlMISyncTaskProperties(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new ValidateMigrationInputSqlServerSqlMISyncTaskProperties(taskType, Optional.ToList(errors), Optional.ToNullable(state), Optional.ToList(commands), Optional.ToDictionary(clientData), input.Value, Optional.ToList(output), serializedAdditionalRawData);
        }
        ...
        /// <summary> Converts a <see cref="ValidateMigrationInputSqlServerSqlMISyncTaskProperties"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="ValidateMigrationInputSqlServerSqlMISyncTaskProperties"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="ValidateMigrationInputSqlServerSqlMISyncTaskProperties"/>. </summary>
