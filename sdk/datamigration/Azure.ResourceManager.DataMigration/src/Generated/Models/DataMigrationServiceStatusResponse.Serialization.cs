...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataMigrationServiceStatusResponse>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DataMigrationServiceStatusResponse>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DataMigrationServiceStatusResponse>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DataMigrationServiceStatusResponse>)} interface");
            }
        ...
        string IPersistableModel<DataMigrationServiceStatusResponse>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
