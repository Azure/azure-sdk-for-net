...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NodeMonitoringData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NodeMonitoringData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NodeMonitoringData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<NodeMonitoringData>)} interface");
            }
        ...
        string IPersistableModel<NodeMonitoringData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
