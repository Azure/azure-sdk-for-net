...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class MigrateMySqlAzureDBForMySqlSyncTaskOutputTableLevel : MigrateMySqlAzureDBForMySqlSyncTaskOutput, IJsonModel<MigrateMySqlAzureDBForMySqlSyncTaskOutputTableLevel>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<MigrateMySqlAzureDBForMySqlSyncTaskOutputTableLevel>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<MigrateMySqlAzureDBForMySqlSyncTaskOutputTableLevel>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        MigrateMySqlAzureDBForMySqlSyncTaskOutputTableLevel IPersistableModel<MigrateMySqlAzureDBForMySqlSyncTaskOutputTableLevel>.Create(BinaryData data, ModelReaderWriterOptions options) => (MigrateMySqlAzureDBForMySqlSyncTaskOutputTableLevel)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        MigrateMySqlAzureDBForMySqlSyncTaskOutputTableLevel IJsonModel<MigrateMySqlAzureDBForMySqlSyncTaskOutputTableLevel>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (MigrateMySqlAzureDBForMySqlSyncTaskOutputTableLevel)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static MigrateMySqlAzureDBForMySqlSyncTaskOutputTableLevel DeserializeMigrateMySqlAzureDBForMySqlSyncTaskOutputTableLevel(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    cdcInsertCounter = prop.Value.GetString();
                    continue;
                }
                if (prop.NameEquals("cdcUpdateCounter"u8))
                {
                    cdcUpdateCounter = prop.Value.GetString();
                    continue;
                }
                if (prop.NameEquals("cdcDeleteCounter"u8))
                {
                    cdcDeleteCounter = prop.Value.GetString();
                    continue;
                }
