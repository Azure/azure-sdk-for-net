...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BlobShare>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<BlobShare>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BlobShare>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<BlobShare>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
