...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MigratePostgreSqlAzureDBForPostgreSqlSyncTaskOutputError>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<MigratePostgreSqlAzureDBForPostgreSqlSyncTaskOutputError>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MigratePostgreSqlAzureDBForPostgreSqlSyncTaskOutputError>)} interface");
            }
        ...
        string IPersistableModel<MigratePostgreSqlAzureDBForPostgreSqlSyncTaskOutputError>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
