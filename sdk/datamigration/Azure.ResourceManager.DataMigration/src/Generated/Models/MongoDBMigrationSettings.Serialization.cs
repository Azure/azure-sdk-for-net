...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MongoDBMigrationSettings>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MongoDBMigrationSettings>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MongoDBMigrationSettings>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MongoDBMigrationSettings>)} interface");
            }
        ...
        string IPersistableModel<MongoDBMigrationSettings>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
