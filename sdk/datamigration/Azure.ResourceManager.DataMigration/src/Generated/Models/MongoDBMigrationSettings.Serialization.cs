...
{
    public partial class MongoDBMigrationSettings : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static MongoDBMigrationSettings DeserializeMongoDBMigrationSettings(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
