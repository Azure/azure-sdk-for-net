...
namespace Azure.ResourceManager.DataMigration.Models
{
    public partial class ConnectToSourcePostgreSqlSyncTaskProperties : IUtf8JsonSerializable, IJsonModel<ConnectToSourcePostgreSqlSyncTaskProperties>
    {
        ...
        internal static ConnectToSourcePostgreSqlSyncTaskProperties DeserializeConnectToSourcePostgreSqlSyncTaskProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new ConnectToSourcePostgreSqlSyncTaskProperties(taskType, errors ?? new ChangeTrackingList<ODataError>(), Optional.ToNullable(state), commands ?? new ChangeTrackingList<CommandProperties>(), Optional.ToDictionary(clientData), serializedAdditionalRawData, input.Value, output ?? new ChangeTrackingList<ConnectToSourcePostgreSqlSyncTaskOutput>());
        }
