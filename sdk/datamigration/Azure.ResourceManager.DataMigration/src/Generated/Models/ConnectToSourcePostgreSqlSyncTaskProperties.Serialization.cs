...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ConnectToSourcePostgreSqlSyncTaskProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ConnectToSourcePostgreSqlSyncTaskProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ConnectToSourcePostgreSqlSyncTaskProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ConnectToSourcePostgreSqlSyncTaskProperties>)} interface");
            }
        ...
        string IPersistableModel<ConnectToSourcePostgreSqlSyncTaskProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
