...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class ConnectToSourcePostgreSqlSyncTaskProperties : DataMigrationProjectTaskProperties, IJsonModel<ConnectToSourcePostgreSqlSyncTaskProperties>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<ConnectToSourcePostgreSqlSyncTaskProperties>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ConnectToSourcePostgreSqlSyncTaskProperties>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        ConnectToSourcePostgreSqlSyncTaskProperties IPersistableModel<ConnectToSourcePostgreSqlSyncTaskProperties>.Create(BinaryData data, ModelReaderWriterOptions options) => (ConnectToSourcePostgreSqlSyncTaskProperties)PersistableModelCreateCore(data, options);
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (options.Format != "W" && Optional.IsCollectionDefined(Output))
            {
                ...
                foreach (ConnectToSourcePostgreSqlSyncTaskOutput item in Output)
                {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ConnectToSourcePostgreSqlSyncTaskProperties IJsonModel<ConnectToSourcePostgreSqlSyncTaskProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (ConnectToSourcePostgreSqlSyncTaskProperties)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static ConnectToSourcePostgreSqlSyncTaskProperties DeserializeConnectToSourcePostgreSqlSyncTaskProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("input"u8))
                {
                    ...
                    input = ConnectToSourcePostgreSqlSyncTaskInput.DeserializeConnectToSourcePostgreSqlSyncTaskInput(prop.Value, options);
                    continue;
                }
