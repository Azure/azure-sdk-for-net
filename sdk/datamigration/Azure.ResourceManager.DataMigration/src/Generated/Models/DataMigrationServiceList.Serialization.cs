...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    {
        internal static DataMigrationServiceList DeserializeDataMigrationServiceList(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
