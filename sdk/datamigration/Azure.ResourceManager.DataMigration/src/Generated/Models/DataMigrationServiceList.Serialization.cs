...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataMigrationServiceList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DataMigrationServiceList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DataMigrationServiceList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<DataMigrationServiceList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
