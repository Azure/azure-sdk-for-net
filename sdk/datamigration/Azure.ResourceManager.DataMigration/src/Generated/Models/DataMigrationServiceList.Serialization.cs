...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataMigrationServiceList>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(Value))
            {
                ...
                {
                    ((IJsonModel<DataMigrationServiceData>)item).Write(writer, options);
                }
        ...
        internal static DataMigrationServiceList DeserializeDataMigrationServiceList(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new DataMigrationServiceList(value ?? new ChangeTrackingList<DataMigrationServiceData>(), nextLink, serializedAdditionalRawData);
        }
