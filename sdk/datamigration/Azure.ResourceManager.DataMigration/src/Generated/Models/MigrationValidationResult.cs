...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class MigrationValidationResult
    {
        ...
        internal MigrationValidationResult(string id, string migrationId, IReadOnlyDictionary<string, MigrationValidationDatabaseSummaryResult> summaryResults, ValidationStatus? status, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
