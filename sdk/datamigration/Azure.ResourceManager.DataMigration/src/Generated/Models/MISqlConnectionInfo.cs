...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class MISqlConnectionInfo : ConnectionInfo
    {
        ...
        internal MISqlConnectionInfo(string connectionInfoType, string userName, string password, string managedInstanceResourceId, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(connectionInfoType, userName, password, serializedAdditionalRawData)
        {
            ManagedInstanceResourceId = managedInstanceResourceId;
