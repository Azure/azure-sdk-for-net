...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MISqlConnectionInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MISqlConnectionInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MISqlConnectionInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MISqlConnectionInfo>)} interface");
            }
        ...
        string IPersistableModel<MISqlConnectionInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
