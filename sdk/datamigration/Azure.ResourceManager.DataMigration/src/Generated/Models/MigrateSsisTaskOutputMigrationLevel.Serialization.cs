...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MigrateSsisTaskOutputMigrationLevel>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MigrateSsisTaskOutputMigrationLevel>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MigrateSsisTaskOutputMigrationLevel>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MigrateSsisTaskOutputMigrationLevel>)} interface");
            }
        ...
        string IPersistableModel<MigrateSsisTaskOutputMigrationLevel>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
