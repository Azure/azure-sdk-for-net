...
{
    public partial class MigrateMySqlAzureDBForMySqlOfflineTaskOutputMigrationLevel : IUtf8JsonSerializable, IJsonModel<MigrateMySqlAzureDBForMySqlOfflineTaskOutputMigrationLevel>, IPersistableModel<MigrateMySqlAzureDBForMySqlOfflineTaskOutputMigrationLevel>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(LastStorageUpdate))
            {
                ...
                builder.AppendLine($" '{LastStorageUpdate.Value.ToString()}'");
            }
