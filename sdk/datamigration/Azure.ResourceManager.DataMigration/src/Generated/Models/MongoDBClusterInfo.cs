...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class MongoDBClusterInfo
    {
        ...
        internal MongoDBClusterInfo(IReadOnlyList<MongoDBDatabaseInfo> databases, bool supportsSharding, MongoDBClusterType clusterType, string version, Dictionary<string, BinaryData> rawData)
        {
            Databases = databases;
            SupportsSharding = supportsSharding;
            ClusterType = clusterType;
