...
{
    public partial class MongoDBError : IUtf8JsonSerializable, IJsonModel<MongoDBError>, IPersistableModel<MongoDBError>
    {
        ...
        void IJsonModel<MongoDBError>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MongoDBError)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  type:");
                builder.AppendLine($" '{ErrorType.ToString()}'");
            }
