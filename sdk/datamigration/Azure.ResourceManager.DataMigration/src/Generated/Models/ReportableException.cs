...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class ReportableException
    {
        ...
        internal ReportableException(string message, string actionableMessage, string filePath, string lineNumber, int? hResult, string stackTrace, Dictionary<string, BinaryData> rawData)
        {
            Message = message;
