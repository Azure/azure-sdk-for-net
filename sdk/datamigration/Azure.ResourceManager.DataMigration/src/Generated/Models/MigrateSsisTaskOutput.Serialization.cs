...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public abstract partial class MigrateSsisTaskOutput : IJsonModel<MigrateSsisTaskOutput>
    {
        ...
        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual MigrateSsisTaskOutput JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<MigrateSsisTaskOutput>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static MigrateSsisTaskOutput DeserializeMigrateSsisTaskOutput(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            if (element.TryGetProperty("resultType"u8, out JsonElement discriminator))
            {
                switch (discriminator.GetString())
                {
                    case "MigrationLevelOutput":
                        return MigrateSsisTaskOutputMigrationLevel.DeserializeMigrateSsisTaskOutputMigrationLevel(element, options);
                    case "SsisProjectLevelOutput":
                        return MigrateSsisTaskOutputProjectLevel.DeserializeMigrateSsisTaskOutputProjectLevel(element, options);
                }
            }
