...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class GetUserTablesSqlTaskOutput
    {
        ...
        internal GetUserTablesSqlTaskOutput(string id, string databasesToTables, IReadOnlyList<ReportableException> validationErrors, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
