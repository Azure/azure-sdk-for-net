...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class GetUserTablesSqlTaskOutput
    {
        ...
        internal GetUserTablesSqlTaskOutput(string id, string databasesToTables, IReadOnlyList<DataMigrationReportableException> validationErrors, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Id = id;
