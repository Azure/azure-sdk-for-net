...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class MigrateSqlServerSqlDBSyncTaskOutputDatabaseError : MigrateSqlServerSqlDBSyncTaskOutput
    {
        ...
        internal MigrateSqlServerSqlDBSyncTaskOutputDatabaseError() : base("DatabaseLevelErrorOutput")
        {
        ...
        internal MigrateSqlServerSqlDBSyncTaskOutputDatabaseError(string id, string resultType, IDictionary<string, BinaryData> additionalBinaryDataProperties, string errorMessage, IReadOnlyList<SyncMigrationDatabaseErrorEvent> events) : base(id, resultType, additionalBinaryDataProperties)
        {
