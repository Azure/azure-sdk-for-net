...
{
    public partial class ConnectToSourceSqlServerSyncTaskProperties : Core.IUtf8JsonSerializable
    {
        ...
        internal static ConnectToSourceSqlServerSyncTaskProperties DeserializeConnectToSourceSqlServerSyncTaskProperties(JsonElement element)
        {
            ...
            return new ConnectToSourceSqlServerSyncTaskProperties(taskType, Core.Optional.ToList(errors), Core.Optional.ToNullable(state), Core.Optional.ToList(commands), Core.Optional.ToDictionary(clientData), input.Value, Core.Optional.ToList(output));
        }
    }
}
