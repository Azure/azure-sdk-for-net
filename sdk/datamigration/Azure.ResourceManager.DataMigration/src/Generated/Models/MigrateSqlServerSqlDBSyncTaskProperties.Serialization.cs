...
{
    public partial class MigrateSqlServerSqlDBSyncTaskProperties : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static MigrateSqlServerSqlDBSyncTaskProperties DeserializeMigrateSqlServerSqlDBSyncTaskProperties(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
