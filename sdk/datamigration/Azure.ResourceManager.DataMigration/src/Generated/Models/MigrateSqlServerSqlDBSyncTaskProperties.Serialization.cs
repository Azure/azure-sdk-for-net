...
namespace Azure.ResourceManager.DataMigration.Models
{
    public partial class MigrateSqlServerSqlDBSyncTaskProperties : IUtf8JsonSerializable, IJsonModel<MigrateSqlServerSqlDBSyncTaskProperties>
    {
        ...
        internal static MigrateSqlServerSqlDBSyncTaskProperties DeserializeMigrateSqlServerSqlDBSyncTaskProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new MigrateSqlServerSqlDBSyncTaskProperties(taskType, errors ?? new ChangeTrackingList<ODataError>(), Optional.ToNullable(state), commands ?? new ChangeTrackingList<CommandProperties>(), Optional.ToDictionary(clientData), serializedAdditionalRawData, input.Value, output ?? new ChangeTrackingList<MigrateSqlServerSqlDBSyncTaskOutput>());
        }
