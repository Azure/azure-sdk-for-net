...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class MigrateSqlServerSqlDBSyncTaskProperties : DataMigrationProjectTaskProperties, IJsonModel<MigrateSqlServerSqlDBSyncTaskProperties>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<MigrateSqlServerSqlDBSyncTaskProperties>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<MigrateSqlServerSqlDBSyncTaskProperties>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        MigrateSqlServerSqlDBSyncTaskProperties IPersistableModel<MigrateSqlServerSqlDBSyncTaskProperties>.Create(BinaryData data, ModelReaderWriterOptions options) => (MigrateSqlServerSqlDBSyncTaskProperties)PersistableModelCreateCore(data, options);
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (options.Format != "W" && Optional.IsCollectionDefined(Output))
            {
                ...
                foreach (MigrateSqlServerSqlDBSyncTaskOutput item in Output)
                {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        MigrateSqlServerSqlDBSyncTaskProperties IJsonModel<MigrateSqlServerSqlDBSyncTaskProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (MigrateSqlServerSqlDBSyncTaskProperties)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static MigrateSqlServerSqlDBSyncTaskProperties DeserializeMigrateSqlServerSqlDBSyncTaskProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("input"u8))
                {
                    ...
                    input = MigrateSqlServerSqlDBSyncTaskInput.DeserializeMigrateSqlServerSqlDBSyncTaskInput(prop.Value, options);
                    continue;
                }
