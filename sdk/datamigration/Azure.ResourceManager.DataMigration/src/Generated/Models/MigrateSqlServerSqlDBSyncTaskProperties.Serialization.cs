...
{
    public partial class MigrateSqlServerSqlDBSyncTaskProperties : Core.IUtf8JsonSerializable
    {
        ...
        internal static MigrateSqlServerSqlDBSyncTaskProperties DeserializeMigrateSqlServerSqlDBSyncTaskProperties(JsonElement element)
        {
            ...
            Core.Optional<MigrateSqlServerSqlDBSyncTaskInput> input = default;
            Core.Optional<IReadOnlyList<MigrateSqlServerSqlDBSyncTaskOutput>> output = default;
            ...
            return new MigrateSqlServerSqlDBSyncTaskProperties(taskType, Core.Optional.ToList(errors), Core.Optional.ToNullable(state), Core.Optional.ToList(commands), Core.Optional.ToDictionary(clientData), input.Value, Core.Optional.ToList(output));
        }
    }
}
