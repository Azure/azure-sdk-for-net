...
{
    public partial class ConnectToTargetSqlDBSyncTaskProperties : IUtf8JsonSerializable
    {
        ...
        internal static ConnectToTargetSqlDBSyncTaskProperties DeserializeConnectToTargetSqlDBSyncTaskProperties(JsonElement element)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            Optional<ConnectToTargetSqlDBSyncTaskInput> input = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("input"u8))
                {
                    ...
                    input = ConnectToTargetSqlDBSyncTaskInput.DeserializeConnectToTargetSqlDBSyncTaskInput(property.Value);
                    continue;
                }
            ...
            return new ConnectToTargetSqlDBSyncTaskProperties(taskType, Optional.ToList(errors), Optional.ToNullable(state), Optional.ToList(commands), Optional.ToDictionary(clientData), input.Value, Optional.ToList(output));
        }
    }
}
