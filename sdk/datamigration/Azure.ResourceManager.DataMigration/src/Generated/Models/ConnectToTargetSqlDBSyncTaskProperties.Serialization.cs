...
{
    public partial class ConnectToTargetSqlDBSyncTaskProperties : Core.IUtf8JsonSerializable
    {
        ...
        internal static ConnectToTargetSqlDBSyncTaskProperties DeserializeConnectToTargetSqlDBSyncTaskProperties(JsonElement element)
        {
            ...
            Core.Optional<ConnectToTargetSqlDBSyncTaskInput> input = default;
            Core.Optional<IReadOnlyList<ConnectToTargetSqlDBTaskOutput>> output = default;
            ...
            return new ConnectToTargetSqlDBSyncTaskProperties(taskType, Core.Optional.ToList(errors), Core.Optional.ToNullable(state), Core.Optional.ToList(commands), Core.Optional.ToDictionary(clientData), input.Value, Core.Optional.ToList(output));
        }
    }
}
