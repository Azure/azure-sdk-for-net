...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ResourceSkusResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ResourceSkusResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ResourceSkusResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ResourceSkusResult>)} interface");
            }
        ...
        string IPersistableModel<ResourceSkusResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
