...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class MySqlConnectionInfo : ConnectionInfo
    {
        ...
        internal MySqlConnectionInfo(string connectionInfoType, string userName, string password, string serverName, string dataSource, int port, bool? encryptConnection, AuthenticationType? authentication, string additionalSettings, Dictionary<string, BinaryData> rawData) : base(connectionInfoType, userName, password, rawData)
        {
            ServerName = serverName;
