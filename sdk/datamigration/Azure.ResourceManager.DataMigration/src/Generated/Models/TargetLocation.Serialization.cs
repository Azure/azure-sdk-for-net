...
{
    public partial class TargetLocation : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static TargetLocation DeserializeTargetLocation(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
