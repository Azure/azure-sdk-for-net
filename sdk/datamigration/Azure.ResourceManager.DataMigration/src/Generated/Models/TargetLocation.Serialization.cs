...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TargetLocation>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<TargetLocation>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<TargetLocation>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<TargetLocation>)} interface");
            }
        ...
        string IPersistableModel<TargetLocation>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
