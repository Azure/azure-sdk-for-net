...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class DataMigrationPostgreSqlConnectionInfo : ServerConnectionInfo
    {
        ...
        public DataMigrationPostgreSqlConnectionInfo(string serverName, int port) : base("PostgreSqlConnectionInfo")
        {
        ...
        internal DataMigrationPostgreSqlConnectionInfo(string @type, string userName, string password, IDictionary<string, BinaryData> additionalBinaryDataProperties, string serverName, string dataSource, string serverVersion, string databaseName, int port, bool? shouldEncryptConnection, bool? shouldTrustServerCertificate, string additionalSettings, string serverBrandVersion, DataMigrationAuthenticationType? authentication) : base(@type, userName, password, additionalBinaryDataProperties)
        {
            ServerName = serverName;
