...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class MigratePostgreSqlAzureDBForPostgreSqlSyncTaskOutputError : MigratePostgreSqlAzureDBForPostgreSqlSyncTaskOutput
    {
        ...
        internal MigratePostgreSqlAzureDBForPostgreSqlSyncTaskOutputError(string id, string resultType, ReportableException error, IReadOnlyList<SyncMigrationDatabaseErrorEvent> events, Dictionary<string, BinaryData> rawData) : base(id, resultType, rawData)
        {
            Error = error;
            Events = events;
