...
{
    public partial class CheckOciDriverTaskProperties : Core.IUtf8JsonSerializable
    {
        ...
        internal static CheckOciDriverTaskProperties DeserializeCheckOciDriverTaskProperties(JsonElement element)
        {
            ...
            Core.Optional<CheckOciDriverTaskInput> input = default;
            Core.Optional<IReadOnlyList<CheckOciDriverTaskOutput>> output = default;
            ...
            return new CheckOciDriverTaskProperties(taskType, Core.Optional.ToList(errors), Core.Optional.ToNullable(state), Core.Optional.ToList(commands), Core.Optional.ToDictionary(clientData), input.Value, Core.Optional.ToList(output));
        }
    }
}
