...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class DataMigrationServiceSku
    {
        ...
        internal DataMigrationServiceSku(string name, string tier, string family, string size, int? capacity, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Name = name;
            Tier = tier;
            Family = family;
