...
{
    public partial class GetUserTablesOracleTaskProperties : Core.IUtf8JsonSerializable
    {
        ...
        internal static GetUserTablesOracleTaskProperties DeserializeGetUserTablesOracleTaskProperties(JsonElement element)
        {
            ...
            Core.Optional<GetUserTablesOracleTaskInput> input = default;
            Core.Optional<IReadOnlyList<GetUserTablesOracleTaskOutput>> output = default;
            ...
            return new GetUserTablesOracleTaskProperties(taskType, Core.Optional.ToList(errors), Core.Optional.ToNullable(state), Core.Optional.ToList(commands), Core.Optional.ToDictionary(clientData), input.Value, Core.Optional.ToList(output));
        }
    }
}
