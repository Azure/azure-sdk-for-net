...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MigratePostgreSqlAzureDBForPostgreSqlSyncDatabaseInput>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<MigratePostgreSqlAzureDBForPostgreSqlSyncDatabaseInput>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MigratePostgreSqlAzureDBForPostgreSqlSyncDatabaseInput>)} interface");
            }
        ...
        string IPersistableModel<MigratePostgreSqlAzureDBForPostgreSqlSyncDatabaseInput>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
