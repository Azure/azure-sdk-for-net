...
namespace Azure.ResourceManager.DataMigration.Models
{
    public partial class MigratePostgreSqlAzureDBForPostgreSqlSyncDatabaseInput : IUtf8JsonSerializable, IJsonModel<MigratePostgreSqlAzureDBForPostgreSqlSyncDatabaseInput>
    {
        ...
        void IJsonModel<MigratePostgreSqlAzureDBForPostgreSqlSyncDatabaseInput>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (!(MigrationSetting is ChangeTrackingDictionary<string, BinaryData> collection && collection.IsUndefined))
            {
            ...
            if (!(SelectedTables is ChangeTrackingList<MigratePostgreSqlAzureDBForPostgreSqlSyncDatabaseTableInput> collection2 && collection2.IsUndefined))
            {
        ...
        internal static MigratePostgreSqlAzureDBForPostgreSqlSyncDatabaseInput DeserializeMigratePostgreSqlAzureDBForPostgreSqlSyncDatabaseInput(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new MigratePostgreSqlAzureDBForPostgreSqlSyncDatabaseInput(name.Value, id.Value, targetDatabaseName.Value, Optional.ToDictionary(migrationSetting), Optional.ToDictionary(sourceSetting), Optional.ToDictionary(targetSetting), selectedTables ?? new ChangeTrackingList<MigratePostgreSqlAzureDBForPostgreSqlSyncDatabaseTableInput>(), serializedAdditionalRawData);
        }
