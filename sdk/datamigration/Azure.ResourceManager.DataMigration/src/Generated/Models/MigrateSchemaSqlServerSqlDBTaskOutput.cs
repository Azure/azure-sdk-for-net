...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    /// </summary>
    [DeserializationProxy(typeof(UnknownMigrateSchemaSqlServerSqlDBTaskOutput))]
    public abstract partial class MigrateSchemaSqlServerSqlDBTaskOutput
    {
        ...
        internal MigrateSchemaSqlServerSqlDBTaskOutput(string id, string resultType, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
