...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    /// </summary>
    [AbstractTypeDeserializer(typeof(UnknownMigrateSchemaSqlServerSqlDBTaskOutput))]
    public abstract partial class MigrateSchemaSqlServerSqlDBTaskOutput
    {
        ...
        internal MigrateSchemaSqlServerSqlDBTaskOutput(string id, string resultType, Dictionary<string, BinaryData> rawData)
        {
            Id = id;
