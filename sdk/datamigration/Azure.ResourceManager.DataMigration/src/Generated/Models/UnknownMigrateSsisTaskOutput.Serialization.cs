...
namespace Azure.ResourceManager.DataMigration.Models
{
    internal partial class UnknownMigrateSsisTaskOutput : IUtf8JsonSerializable, IJsonModel<MigrateSsisTaskOutput>
    {
        ...
        void IJsonModel<MigrateSsisTaskOutput>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(MigrateSsisTaskOutput)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<MigrateSsisTaskOutput>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(MigrateSsisTaskOutput)} does not support '{options.Format}' format.");
            }
        }
