...
{
    public partial class MigrateSqlServerSqlDBTaskProperties : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static MigrateSqlServerSqlDBTaskProperties DeserializeMigrateSqlServerSqlDBTaskProperties(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
