...
namespace Azure.ResourceManager.DataMigration.Models
{
    public partial class MigrateSqlServerSqlDBTaskProperties : IUtf8JsonSerializable, IJsonModel<MigrateSqlServerSqlDBTaskProperties>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<MigrateSqlServerSqlDBTaskProperties>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MigrateSqlServerSqlDBTaskProperties>)} interface");
            }
