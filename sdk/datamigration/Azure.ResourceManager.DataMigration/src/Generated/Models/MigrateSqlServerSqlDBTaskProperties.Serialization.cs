...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class MigrateSqlServerSqlDBTaskProperties : DataMigrationProjectTaskProperties, IJsonModel<MigrateSqlServerSqlDBTaskProperties>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<MigrateSqlServerSqlDBTaskProperties>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<MigrateSqlServerSqlDBTaskProperties>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        MigrateSqlServerSqlDBTaskProperties IPersistableModel<MigrateSqlServerSqlDBTaskProperties>.Create(BinaryData data, ModelReaderWriterOptions options) => (MigrateSqlServerSqlDBTaskProperties)PersistableModelCreateCore(data, options);
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (options.Format != "W" && Optional.IsCollectionDefined(Output))
            {
                ...
                foreach (MigrateSqlServerSqlDBTaskOutput item in Output)
                {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        MigrateSqlServerSqlDBTaskProperties IJsonModel<MigrateSqlServerSqlDBTaskProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (MigrateSqlServerSqlDBTaskProperties)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static MigrateSqlServerSqlDBTaskProperties DeserializeMigrateSqlServerSqlDBTaskProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            MigrateSqlServerSqlDBTaskInput input = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("input"u8))
                {
                    ...
                    input = MigrateSqlServerSqlDBTaskInput.DeserializeMigrateSqlServerSqlDBTaskInput(prop.Value, options);
                    continue;
                }
