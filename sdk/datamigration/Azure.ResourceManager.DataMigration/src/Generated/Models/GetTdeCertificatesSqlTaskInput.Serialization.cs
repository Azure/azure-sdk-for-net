...
{
    public partial class GetTdeCertificatesSqlTaskInput : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static GetTdeCertificatesSqlTaskInput DeserializeGetTdeCertificatesSqlTaskInput(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
