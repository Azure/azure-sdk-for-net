...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class MigrateMySqlAzureDBForMySqlOfflineDatabaseInput
    {
        ...
        internal MigrateMySqlAzureDBForMySqlOfflineDatabaseInput(string name, string targetDatabaseName, IDictionary<string, string> tableMap, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
