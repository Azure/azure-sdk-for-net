...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class AvailableServiceSkuCapacity
    {
        ...
        internal AvailableServiceSkuCapacity(int? minimum, int? maximum, int? @default, ServiceScalability? scaleType, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Minimum = minimum;
            Maximum = maximum;
            Default = @default;
