...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MigrationOperationInput>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MigrationOperationInput>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MigrationOperationInput>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<MigrationOperationInput>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
