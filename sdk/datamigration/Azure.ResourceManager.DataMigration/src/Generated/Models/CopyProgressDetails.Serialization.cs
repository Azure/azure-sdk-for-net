...
{
    public partial class CopyProgressDetails : IUtf8JsonSerializable, IJsonModel<CopyProgressDetails>, IPersistableModel<CopyProgressDetails>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(UsedParallelCopies))
            {
                ...
                builder.AppendLine($" '{UsedParallelCopies.Value.ToString()}'");
            }
            ...
            if (Optional.IsDefined(CopyStart))
            {
                ...
                builder.AppendLine($" '{CopyStart.Value.ToString()}'");
            }
