...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class InstallOciDriverTaskOutput : IJsonModel<InstallOciDriverTaskOutput>
    {
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual InstallOciDriverTaskOutput PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<InstallOciDriverTaskOutput>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<InstallOciDriverTaskOutput>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        InstallOciDriverTaskOutput IPersistableModel<InstallOciDriverTaskOutput>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        InstallOciDriverTaskOutput IJsonModel<InstallOciDriverTaskOutput>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual InstallOciDriverTaskOutput JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<InstallOciDriverTaskOutput>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static InstallOciDriverTaskOutput DeserializeInstallOciDriverTaskOutput(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new InstallOciDriverTaskOutput(validationErrors ?? new ChangeTrackingList<DataMigrationReportableException>(), additionalBinaryDataProperties);
        }
    }
}
