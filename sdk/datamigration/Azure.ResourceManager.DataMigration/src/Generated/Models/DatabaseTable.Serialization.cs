...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DatabaseTable>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DatabaseTable)} does not support writing '{format}' format.");
            }
        ...
        DatabaseTable IJsonModel<DatabaseTable>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DatabaseTable)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<DatabaseTable>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(DatabaseTable)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        DatabaseTable IPersistableModel<DatabaseTable>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(DatabaseTable)} does not support reading '{options.Format}' format.");
            }
        }
