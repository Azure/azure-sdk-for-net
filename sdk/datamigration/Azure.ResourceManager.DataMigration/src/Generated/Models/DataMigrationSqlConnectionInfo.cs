...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class DataMigrationSqlConnectionInfo : ServerConnectionInfo
    {
        ...
        public DataMigrationSqlConnectionInfo(string dataSource) : base("SqlConnectionInfo")
        {
        ...
        internal DataMigrationSqlConnectionInfo(string @type, string userName, string password, IDictionary<string, BinaryData> additionalBinaryDataProperties, string dataSource, string serverName, int? port, string serverVersion, string serverBrandVersion, string resourceId, DataMigrationAuthenticationType? authentication, bool? shouldEncryptConnection, string additionalSettings, bool? shouldTrustServerCertificate, DataMigrationSqlSourcePlatform? platform) : base(@type, userName, password, additionalBinaryDataProperties)
        {
            DataSource = dataSource;
