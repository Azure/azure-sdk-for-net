...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    internal partial class UnknownMigrateSqlServerSqlMISyncTaskOutput : MigrateSqlServerSqlMISyncTaskOutput
    {
        ...
        internal UnknownMigrateSqlServerSqlMISyncTaskOutput(string id, string resultType, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, resultType, serializedAdditionalRawData)
        {
