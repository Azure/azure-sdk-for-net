...
namespace Azure.ResourceManager.DataMigration.Models
{
    internal partial class UnknownMigrateSqlServerSqlMISyncTaskOutput : MigrateSqlServerSqlMISyncTaskOutput
    {
        ...
        internal UnknownMigrateSqlServerSqlMISyncTaskOutput(string id, string resultType, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, resultType ?? "unknown", additionalBinaryDataProperties)
        {
        }
    }
}
