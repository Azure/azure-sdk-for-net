...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MigratePostgreSqlAzureDBForPostgreSqlSyncTaskOutputDatabaseLevel>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        MigratePostgreSqlAzureDBForPostgreSqlSyncTaskOutputDatabaseLevel IJsonModel<MigratePostgreSqlAzureDBForPostgreSqlSyncTaskOutputDatabaseLevel>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<MigratePostgreSqlAzureDBForPostgreSqlSyncTaskOutputDatabaseLevel>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        MigratePostgreSqlAzureDBForPostgreSqlSyncTaskOutputDatabaseLevel IModel<MigratePostgreSqlAzureDBForPostgreSqlSyncTaskOutputDatabaseLevel>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<MigratePostgreSqlAzureDBForPostgreSqlSyncTaskOutputDatabaseLevel>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
