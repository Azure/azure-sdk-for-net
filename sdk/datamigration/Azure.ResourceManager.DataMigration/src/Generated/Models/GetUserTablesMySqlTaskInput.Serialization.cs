...
{
    public partial class GetUserTablesMySqlTaskInput : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static GetUserTablesMySqlTaskInput DeserializeGetUserTablesMySqlTaskInput(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
