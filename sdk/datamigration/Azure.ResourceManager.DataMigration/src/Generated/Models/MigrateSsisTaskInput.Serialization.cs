...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MigrateSsisTaskInput>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MigrateSsisTaskInput>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MigrateSsisTaskInput>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MigrateSsisTaskInput>)} interface");
            }
        ...
        string IPersistableModel<MigrateSsisTaskInput>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
