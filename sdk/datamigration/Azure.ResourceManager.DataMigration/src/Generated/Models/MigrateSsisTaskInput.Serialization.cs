...
{
    public partial class MigrateSsisTaskInput : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static MigrateSsisTaskInput DeserializeMigrateSsisTaskInput(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
