...
{
    public partial class MongoDBFinishCommandInput : IUtf8JsonSerializable, IJsonModel<MongoDBFinishCommandInput>, IPersistableModel<MongoDBFinishCommandInput>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Immediate))
            {
                builder.Append("  immediate:");
                var boolValue = Immediate == true ? "true" : "false";
