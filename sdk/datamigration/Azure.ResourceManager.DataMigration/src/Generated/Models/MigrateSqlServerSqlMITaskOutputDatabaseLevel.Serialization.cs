...
namespace Azure.ResourceManager.DataMigration.Models
{
    public partial class MigrateSqlServerSqlMITaskOutputDatabaseLevel : IUtf8JsonSerializable, IModelJsonSerializable<MigrateSqlServerSqlMITaskOutputDatabaseLevel>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<MigrateSqlServerSqlMITaskOutputDatabaseLevel>(this, options.Format);
        ...
        internal static MigrateSqlServerSqlMITaskOutputDatabaseLevel DeserializeMigrateSqlServerSqlMITaskOutputDatabaseLevel(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new MigrateSqlServerSqlMITaskOutputDatabaseLevel(id.Value, resultType, databaseName.Value, Optional.ToNullable(sizeMB), Optional.ToNullable(state), Optional.ToNullable(stage), Optional.ToNullable(startedOn), Optional.ToNullable(endedOn), message.Value, Optional.ToList(exceptionsAndWarnings), serializedAdditionalRawData);
        }
        ...
        /// <summary> Converts a <see cref="MigrateSqlServerSqlMITaskOutputDatabaseLevel"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="MigrateSqlServerSqlMITaskOutputDatabaseLevel"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="MigrateSqlServerSqlMITaskOutputDatabaseLevel"/>. </summary>
