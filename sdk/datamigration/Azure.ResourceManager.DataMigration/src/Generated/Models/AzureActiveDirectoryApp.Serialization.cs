...
{
    public partial class AzureActiveDirectoryApp : IUtf8JsonSerializable, IJsonModel<AzureActiveDirectoryApp>, IPersistableModel<AzureActiveDirectoryApp>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(IgnoreAzurePermissions))
            {
                builder.Append("  ignoreAzurePermissions:");
                var boolValue = IgnoreAzurePermissions.Value == true ? "true" : "false";
