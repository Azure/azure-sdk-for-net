...
{
    public partial class MongoDBCancelCommand : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static MongoDBCancelCommand DeserializeMongoDBCancelCommand(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
