...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MongoDBCancelCommand>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MongoDBCancelCommand>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MongoDBCancelCommand>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MongoDBCancelCommand>)} interface");
            }
        ...
        string IPersistableModel<MongoDBCancelCommand>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
