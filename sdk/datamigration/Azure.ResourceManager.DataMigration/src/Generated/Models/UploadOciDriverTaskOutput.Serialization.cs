...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    {
        internal static UploadOciDriverTaskOutput DeserializeUploadOciDriverTaskOutput(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
