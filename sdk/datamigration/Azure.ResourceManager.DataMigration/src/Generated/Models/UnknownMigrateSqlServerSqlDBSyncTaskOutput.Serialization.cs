...
{
    internal partial class UnknownMigrateSqlServerSqlDBSyncTaskOutput : MigrateSqlServerSqlDBSyncTaskOutput, IJsonModel<MigrateSqlServerSqlDBSyncTaskOutput>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownMigrateSqlServerSqlDBSyncTaskOutput DeserializeUnknownMigrateSqlServerSqlDBSyncTaskOutput(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownMigrateSqlServerSqlDBSyncTaskOutput(id, resultType, additionalBinaryDataProperties);
        }
    }
}
