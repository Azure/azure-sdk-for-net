...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class MigrateSqlServerSqlDBTaskOutputTableLevel : MigrateSqlServerSqlDBTaskOutput, IJsonModel<MigrateSqlServerSqlDBTaskOutputTableLevel>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<MigrateSqlServerSqlDBTaskOutputTableLevel>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<MigrateSqlServerSqlDBTaskOutputTableLevel>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        MigrateSqlServerSqlDBTaskOutputTableLevel IPersistableModel<MigrateSqlServerSqlDBTaskOutputTableLevel>.Create(BinaryData data, ModelReaderWriterOptions options) => (MigrateSqlServerSqlDBTaskOutputTableLevel)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        MigrateSqlServerSqlDBTaskOutputTableLevel IJsonModel<MigrateSqlServerSqlDBTaskOutputTableLevel>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (MigrateSqlServerSqlDBTaskOutputTableLevel)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static MigrateSqlServerSqlDBTaskOutputTableLevel DeserializeMigrateSqlServerSqlDBTaskOutputTableLevel(JsonElement element, ModelReaderWriterOptions options)
        {
