...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MigrateSchemaSqlServerSqlDBTaskOutputError>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MigrateSchemaSqlServerSqlDBTaskOutputError>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MigrateSchemaSqlServerSqlDBTaskOutputError>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MigrateSchemaSqlServerSqlDBTaskOutputError>)} interface");
            }
        ...
        string IPersistableModel<MigrateSchemaSqlServerSqlDBTaskOutputError>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
