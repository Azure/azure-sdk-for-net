...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    {
        internal static SqlDBMigrationStatusDetails DeserializeSqlDBMigrationStatusDetails(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
