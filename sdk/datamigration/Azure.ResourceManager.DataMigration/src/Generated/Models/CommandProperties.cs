...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    /// </summary>
    [DeserializationProxy(typeof(UnknownCommandProperties))]
    public abstract partial class CommandProperties
    {
        ...
        internal CommandProperties(CommandType commandType, IReadOnlyList<ODataError> errors, CommandState? state, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
