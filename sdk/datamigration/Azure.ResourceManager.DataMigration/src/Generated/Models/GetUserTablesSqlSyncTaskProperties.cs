...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class GetUserTablesSqlSyncTaskProperties : DataMigrationProjectTaskProperties
    {
        ...
        internal GetUserTablesSqlSyncTaskProperties(DataMigrationTaskType taskType, IReadOnlyList<DataMigrationODataError> errors, DataMigrationTaskState? state, IReadOnlyList<DataMigrationCommandProperties> commands, IDictionary<string, string> clientData, IDictionary<string, BinaryData> additionalBinaryDataProperties, GetUserTablesSqlSyncTaskInput input, IReadOnlyList<GetUserTablesSqlSyncTaskOutput> output) : base(taskType, errors, state, commands, clientData, additionalBinaryDataProperties)
        {
            Input = input;
            Output = output;
        }
