...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    {
        internal static DatabaseMigrationListResult DeserializeDatabaseMigrationListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
