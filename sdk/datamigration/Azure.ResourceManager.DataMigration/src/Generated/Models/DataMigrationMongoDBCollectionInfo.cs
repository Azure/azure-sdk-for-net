...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class DataMigrationMongoDBCollectionInfo : DataMigrationMongoDBObjectInfo
    {
        ...
        internal DataMigrationMongoDBCollectionInfo(long averageDocumentSize, long dataSize, long documentCount, string name, string qualifiedName, IDictionary<string, BinaryData> additionalBinaryDataProperties, string databaseName, bool isCapped, bool isSystemCollection, bool isView, DataMigrationMongoDBShardKeyInfo shardKey, bool isShardingSupported, string viewOf) : base(averageDocumentSize, dataSize, documentCount, name, qualifiedName, additionalBinaryDataProperties)
        {
            DatabaseName = databaseName;
            IsCapped = isCapped;
            IsSystemCollection = isSystemCollection;
