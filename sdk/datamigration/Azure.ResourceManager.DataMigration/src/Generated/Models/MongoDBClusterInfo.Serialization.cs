...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MongoDBClusterInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MongoDBClusterInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MongoDBClusterInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MongoDBClusterInfo>)} interface");
            }
        ...
        string IPersistableModel<MongoDBClusterInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
