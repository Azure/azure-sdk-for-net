...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class DataMigrationReportableException
    {
        ...
        internal DataMigrationReportableException(string message, string actionableMessage, string filePath, string lineNumber, int? hResult, string stackTrace, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Message = message;
