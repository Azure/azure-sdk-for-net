...
{
    internal partial class UnknownMigrateSqlServerSqlMITaskOutput : MigrateSqlServerSqlMITaskOutput, IJsonModel<MigrateSqlServerSqlMITaskOutput>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownMigrateSqlServerSqlMITaskOutput DeserializeUnknownMigrateSqlServerSqlMITaskOutput(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownMigrateSqlServerSqlMITaskOutput(id, resultType, additionalBinaryDataProperties);
        }
    }
}
