...
{
    internal partial class UnknownMigrateSqlServerSqlMITaskOutput : IUtf8JsonSerializable, IModelJsonSerializable<MigrateSqlServerSqlMITaskOutput>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<MigrateSqlServerSqlMITaskOutput>(this, options.Format);
        ...
        internal static MigrateSqlServerSqlMITaskOutput DeserializeUnknownMigrateSqlServerSqlMITaskOutput(JsonElement element, ModelSerializerOptions options = default) => DeserializeMigrateSqlServerSqlMITaskOutput(element, options);
        ...
        MigrateSqlServerSqlMITaskOutput IModelJsonSerializable<MigrateSqlServerSqlMITaskOutput>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            ...
            return DeserializeUnknownMigrateSqlServerSqlMITaskOutput(doc.RootElement, options);
        }
