...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class ServerProperties
    {
        ...
        internal ServerProperties(string serverPlatform, string serverName, string serverVersion, string serverEdition, string serverOperatingSystemVersion, int? serverDatabaseCount, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
