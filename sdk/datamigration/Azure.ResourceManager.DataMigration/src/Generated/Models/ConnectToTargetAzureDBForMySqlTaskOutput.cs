...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class ConnectToTargetAzureDBForMySqlTaskOutput
    {
        ...
        internal ConnectToTargetAzureDBForMySqlTaskOutput(string id, string serverVersion, IReadOnlyList<string> databases, string targetServerBrandVersion, IReadOnlyList<ReportableException> validationErrors, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
