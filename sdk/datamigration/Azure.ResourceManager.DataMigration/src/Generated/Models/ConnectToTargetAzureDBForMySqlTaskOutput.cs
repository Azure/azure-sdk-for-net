...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class ConnectToTargetAzureDBForMySqlTaskOutput
    {
        ...
        internal ConnectToTargetAzureDBForMySqlTaskOutput(string id, string serverVersion, IReadOnlyList<string> databases, string targetServerBrandVersion, IReadOnlyList<DataMigrationReportableException> validationErrors, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Id = id;
