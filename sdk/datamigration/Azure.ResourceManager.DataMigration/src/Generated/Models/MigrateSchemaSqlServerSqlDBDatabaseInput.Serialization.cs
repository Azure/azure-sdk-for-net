...
{
    public partial class MigrateSchemaSqlServerSqlDBDatabaseInput : IUtf8JsonSerializable, IJsonModel<MigrateSchemaSqlServerSqlDBDatabaseInput>, IPersistableModel<MigrateSchemaSqlServerSqlDBDatabaseInput>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SchemaSetting))
            {
                builder.Append("  schemaSetting:");
                AppendChildObject(builder, SchemaSetting, options, 2);
            }
