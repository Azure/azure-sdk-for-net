...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    {
        internal static MigrationValidationResult DeserializeMigrationValidationResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
