...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class DataMigrationAvailableServiceSkuCapacity
    {
        ...
        internal DataMigrationAvailableServiceSkuCapacity(int? minimum, int? maximum, int? @default, DataMigrationServiceScalability? scaleType, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Minimum = minimum;
            Maximum = maximum;
            Default = @default;
