...
{
    public partial class ValidateMigrationInputSqlServerSqlMITaskOutput : IUtf8JsonSerializable, IJsonModel<ValidateMigrationInputSqlServerSqlMITaskOutput>, IPersistableModel<ValidateMigrationInputSqlServerSqlMITaskOutput>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(DatabaseBackupInfo))
            {
                ...
                AppendChildObject(builder, DatabaseBackupInfo, options, 2);
            }
