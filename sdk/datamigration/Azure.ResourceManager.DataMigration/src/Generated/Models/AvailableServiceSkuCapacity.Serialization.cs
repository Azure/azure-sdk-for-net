...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    {
        internal static AvailableServiceSkuCapacity DeserializeAvailableServiceSkuCapacity(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
