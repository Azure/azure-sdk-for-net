...
{
    public partial class GetTdeCertificatesSqlTaskOutput : IUtf8JsonSerializable, IJsonModel<GetTdeCertificatesSqlTaskOutput>, IPersistableModel<GetTdeCertificatesSqlTaskOutput>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  base64EncodedCertificates:");
                builder.AppendLine($" '{Base64EncodedCertificates}'");
            }
