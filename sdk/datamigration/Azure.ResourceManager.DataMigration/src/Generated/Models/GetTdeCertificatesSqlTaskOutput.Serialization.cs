...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class GetTdeCertificatesSqlTaskOutput : IJsonModel<GetTdeCertificatesSqlTaskOutput>
    {
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual GetTdeCertificatesSqlTaskOutput PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<GetTdeCertificatesSqlTaskOutput>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<GetTdeCertificatesSqlTaskOutput>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        GetTdeCertificatesSqlTaskOutput IPersistableModel<GetTdeCertificatesSqlTaskOutput>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        GetTdeCertificatesSqlTaskOutput IJsonModel<GetTdeCertificatesSqlTaskOutput>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual GetTdeCertificatesSqlTaskOutput JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<GetTdeCertificatesSqlTaskOutput>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static GetTdeCertificatesSqlTaskOutput DeserializeGetTdeCertificatesSqlTaskOutput(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            {
                if (prop.NameEquals("base64EncodedCertificates"u8))
                {
                    base64EncodedCertificates = prop.Value.GetString();
                    continue;
                }
            ...
            return new GetTdeCertificatesSqlTaskOutput(base64EncodedCertificates, validationErrors ?? new ChangeTrackingList<DataMigrationReportableException>(), additionalBinaryDataProperties);
        }
    }
}
