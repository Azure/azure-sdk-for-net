...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class ValidateMigrationInputSqlServerSqlDBSyncTaskProperties : DataMigrationProjectTaskProperties, IJsonModel<ValidateMigrationInputSqlServerSqlDBSyncTaskProperties>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<ValidateMigrationInputSqlServerSqlDBSyncTaskProperties>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
                ...
                default:
                    throw new FormatException($"The model {nameof(ValidateMigrationInputSqlServerSqlDBSyncTaskProperties)} does not support reading '{options.Format}' format.");
            }
        }
        ...
        protected override BinaryData PersistableModelWriteCore(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ValidateMigrationInputSqlServerSqlDBSyncTaskProperties)} does not support writing '{options.Format}' format.");
            }
        }

        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ValidateMigrationInputSqlServerSqlDBSyncTaskProperties>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        ValidateMigrationInputSqlServerSqlDBSyncTaskProperties IPersistableModel<ValidateMigrationInputSqlServerSqlDBSyncTaskProperties>.Create(BinaryData data, ModelReaderWriterOptions options) => (ValidateMigrationInputSqlServerSqlDBSyncTaskProperties)PersistableModelCreateCore(data, options);
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ValidateMigrationInputSqlServerSqlDBSyncTaskProperties)} does not support writing '{format}' format.");
            }
            ...
            if (options.Format != "W" && Optional.IsCollectionDefined(Output))
            {
                ...
                foreach (ValidateSyncMigrationInputSqlServerTaskOutput item in Output)
                {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ValidateMigrationInputSqlServerSqlDBSyncTaskProperties IJsonModel<ValidateMigrationInputSqlServerSqlDBSyncTaskProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (ValidateMigrationInputSqlServerSqlDBSyncTaskProperties)JsonModelCreateCore(ref reader, options);
        ...
        protected override DataMigrationProjectTaskProperties JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ValidateMigrationInputSqlServerSqlDBSyncTaskProperties)} does not support reading '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static ValidateMigrationInputSqlServerSqlDBSyncTaskProperties DeserializeValidateMigrationInputSqlServerSqlDBSyncTaskProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            ValidateSyncMigrationInputSqlServerTaskInput input = default;
            IReadOnlyList<ValidateSyncMigrationInputSqlServerTaskOutput> output = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("input"u8))
                {
                    ...
                    input = ValidateSyncMigrationInputSqlServerTaskInput.DeserializeValidateSyncMigrationInputSqlServerTaskInput(prop.Value, options);
                    continue;
                }
