...
namespace Azure.ResourceManager.DataMigration.Models
{
    public partial class MigrateSchemaSqlServerSqlDBTaskProperties : IUtf8JsonSerializable, IJsonModel<MigrateSchemaSqlServerSqlDBTaskProperties>
    {
        ...
        void IJsonModel<MigrateSchemaSqlServerSqlDBTaskProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (options.Format != "W" && !(Output is ChangeTrackingList<MigrateSchemaSqlServerSqlDBTaskOutput> collection && collection.IsUndefined))
            {
        ...
        internal static MigrateSchemaSqlServerSqlDBTaskProperties DeserializeMigrateSchemaSqlServerSqlDBTaskProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new MigrateSchemaSqlServerSqlDBTaskProperties(taskType, errors ?? new ChangeTrackingList<ODataError>(), Optional.ToNullable(state), commands ?? new ChangeTrackingList<CommandProperties>(), Optional.ToDictionary(clientData), serializedAdditionalRawData, input.Value, output ?? new ChangeTrackingList<MigrateSchemaSqlServerSqlDBTaskOutput>(), createdOn.Value, taskId.Value, Optional.ToNullable(isCloneable));
        }
