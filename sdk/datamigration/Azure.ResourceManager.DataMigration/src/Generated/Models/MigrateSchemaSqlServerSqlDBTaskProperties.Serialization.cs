...
{
    public partial class MigrateSchemaSqlServerSqlDBTaskProperties : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static MigrateSchemaSqlServerSqlDBTaskProperties DeserializeMigrateSchemaSqlServerSqlDBTaskProperties(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
