...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MigrateSchemaSqlServerSqlDBTaskProperties>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        MigrateSchemaSqlServerSqlDBTaskProperties IJsonModel<MigrateSchemaSqlServerSqlDBTaskProperties>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        internal static MigrateSchemaSqlServerSqlDBTaskProperties DeserializeMigrateSchemaSqlServerSqlDBTaskProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new MigrateSchemaSqlServerSqlDBTaskProperties(taskType, Optional.ToList(errors), Optional.ToNullable(state), Optional.ToList(commands), Optional.ToDictionary(clientData), serializedAdditionalRawData, input.Value, Optional.ToList(output), createdOn.Value, taskId.Value, Optional.ToNullable(isCloneable));
        }

        BinaryData IModel<MigrateSchemaSqlServerSqlDBTaskProperties>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        MigrateSchemaSqlServerSqlDBTaskProperties IModel<MigrateSchemaSqlServerSqlDBTaskProperties>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<MigrateSchemaSqlServerSqlDBTaskProperties>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
