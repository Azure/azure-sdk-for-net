...
{
    public partial class MigrateSqlServerSqlMITaskInput : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static MigrateSqlServerSqlMITaskInput DeserializeMigrateSqlServerSqlMITaskInput(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
