...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BackupFileInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<BackupFileInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BackupFileInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<BackupFileInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
