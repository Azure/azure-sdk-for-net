...
namespace Azure.ResourceManager.DataMigration.Models
{
    public partial class BackupFileInfo : IUtf8JsonSerializable, IJsonModel<BackupFileInfo>
    {
        ...
        void IJsonModel<BackupFileInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(BackupFileInfo)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<BackupFileInfo>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(BackupFileInfo)} does not support '{options.Format}' format.");
            }
        }
