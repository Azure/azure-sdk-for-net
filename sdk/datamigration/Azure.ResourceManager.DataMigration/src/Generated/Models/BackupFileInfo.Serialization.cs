...
{
    public partial class BackupFileInfo : IUtf8JsonSerializable, IJsonModel<BackupFileInfo>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BackupFileInfo>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<BackupFileInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BackupFileInfo>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<BackupFileInfo>)} interface");
            }
        ...
        BackupFileInfo IJsonModel<BackupFileInfo>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        internal static BackupFileInfo DeserializeBackupFileInfo(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BackupFileInfo IPersistableModel<BackupFileInfo>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == "J" || options.Format == "W";
            if (!isValid)
            {
        ...
        string IPersistableModel<BackupFileInfo>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
