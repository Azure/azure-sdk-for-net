...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ProjectFileProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ProjectFileProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ProjectFileProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ProjectFileProperties>)} interface");
            }
        ...
        string IPersistableModel<ProjectFileProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
