...
{
    public partial class MigrateMySqlAzureDBForMySqlSyncDatabaseInput : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static MigrateMySqlAzureDBForMySqlSyncDatabaseInput DeserializeMigrateMySqlAzureDBForMySqlSyncDatabaseInput(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
