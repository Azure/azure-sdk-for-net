...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class GetUserTablesMySqlTaskOutput
    {
        ...
        internal GetUserTablesMySqlTaskOutput(string id, string databasesToTables, IReadOnlyList<ReportableException> validationErrors, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
