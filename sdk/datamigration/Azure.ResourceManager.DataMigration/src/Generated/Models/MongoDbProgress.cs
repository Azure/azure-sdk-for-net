...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class MongoDbProgress
    {
        ...
        internal MongoDbProgress(long bytesCopied, long documentsCopied, string elapsedTime, IReadOnlyDictionary<string, MongoDbError> errors, long eventsPending, long eventsReplayed, MongoDbMigrationState state, long totalBytes, long totalDocuments)
        {
            if (elapsedTime == null)
            {
