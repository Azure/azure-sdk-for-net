...
{
    public partial class ResourceSkuCapacity : IUtf8JsonSerializable, IJsonModel<ResourceSkuCapacity>, IPersistableModel<ResourceSkuCapacity>
    {
        ...
        void IJsonModel<ResourceSkuCapacity>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ResourceSkuCapacity)} does not support '{format}' format.");
            }
