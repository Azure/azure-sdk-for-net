...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class MongoDBCancelCommand : CommandProperties
    {
        ...
        internal MongoDBCancelCommand(CommandType commandType, IReadOnlyList<ODataError> errors, CommandState? state, MongoDBCommandInput input, Dictionary<string, BinaryData> rawData) : base(commandType, errors, state, rawData)
        {
            Input = input;
