...
{
    public partial class DatabaseMigrationSqlDBProperties : IUtf8JsonSerializable, IJsonModel<DatabaseMigrationSqlDBProperties>, IPersistableModel<DatabaseMigrationSqlDBProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(TargetSqlConnection))
            {
                ...
                AppendChildObject(builder, TargetSqlConnection, options, 2);
            }
