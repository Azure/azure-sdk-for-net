...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MigrateMySqlAzureDBForMySqlOfflineTaskProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<MigrateMySqlAzureDBForMySqlOfflineTaskProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MigrateMySqlAzureDBForMySqlOfflineTaskProperties>)} interface");
            }
        ...
        string IPersistableModel<MigrateMySqlAzureDBForMySqlOfflineTaskProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
