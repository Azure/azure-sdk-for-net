...
{
    public partial class MigrateMySqlAzureDBForMySqlOfflineTaskProperties : IUtf8JsonSerializable, IJsonModel<MigrateMySqlAzureDBForMySqlOfflineTaskProperties>, IPersistableModel<MigrateMySqlAzureDBForMySqlOfflineTaskProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(IsCloneable))
            {
                builder.Append("  isCloneable:");
                var boolValue = IsCloneable.Value == true ? "true" : "false";
