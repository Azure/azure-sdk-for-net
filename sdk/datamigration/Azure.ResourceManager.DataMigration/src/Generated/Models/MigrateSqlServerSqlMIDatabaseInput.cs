...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class MigrateSqlServerSqlMIDatabaseInput
    {
        ...
        internal MigrateSqlServerSqlMIDatabaseInput(string name, string restoreDatabaseName, FileShare backupFileShare, IList<string> backupFilePaths, string id, Dictionary<string, BinaryData> rawData)
        {
            Name = name;
            RestoreDatabaseName = restoreDatabaseName;
