...
{
    public partial class GetUserTablesSqlTaskInput : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static GetUserTablesSqlTaskInput DeserializeGetUserTablesSqlTaskInput(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
