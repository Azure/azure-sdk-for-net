...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GetUserTablesSqlTaskInput>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<GetUserTablesSqlTaskInput>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<GetUserTablesSqlTaskInput>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<GetUserTablesSqlTaskInput>)} interface");
            }
        ...
        string IPersistableModel<GetUserTablesSqlTaskInput>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
