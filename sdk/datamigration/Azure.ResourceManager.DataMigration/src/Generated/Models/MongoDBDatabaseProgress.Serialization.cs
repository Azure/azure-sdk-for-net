...
namespace Azure.ResourceManager.DataMigration.Models
{
    public partial class MongoDBDatabaseProgress
    {
        internal static MongoDBDatabaseProgress DeserializeMongoDBDatabaseProgress(JsonElement element)
        {
            ...
            Core.Optional<IReadOnlyDictionary<string, MongoDBCollectionProgress>> collections = default;
            ...
            return new MongoDBDatabaseProgress(bytesCopied, documentsCopied, elapsedTime, errors, eventsPending, eventsReplayed, Core.Optional.ToNullable(lastEventTime), Core.Optional.ToNullable(lastReplayTime), name.Value, qualifiedName.Value, resultType, state, totalBytes, totalDocuments, Core.Optional.ToDictionary(collections));
        }
    }
}
