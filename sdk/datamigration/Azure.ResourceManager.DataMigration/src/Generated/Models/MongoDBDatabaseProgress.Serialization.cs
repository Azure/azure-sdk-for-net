...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MongoDBDatabaseProgress>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MongoDBDatabaseProgress>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MongoDBDatabaseProgress>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MongoDBDatabaseProgress>)} interface");
            }
        ...
        string IPersistableModel<MongoDBDatabaseProgress>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
