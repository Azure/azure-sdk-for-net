...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class GetUserTablesSqlTaskInput
    {
        ...
        internal GetUserTablesSqlTaskInput(DataMigrationSqlConnectionInfo connectionInfo, IList<string> selectedDatabases, string encryptedKeyForSecureFields, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            ConnectionInfo = connectionInfo;
