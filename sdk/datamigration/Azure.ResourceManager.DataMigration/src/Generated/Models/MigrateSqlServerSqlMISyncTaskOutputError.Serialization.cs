...
{
    public partial class MigrateSqlServerSqlMISyncTaskOutputError : IUtf8JsonSerializable, IJsonModel<MigrateSqlServerSqlMISyncTaskOutputError>, IPersistableModel<MigrateSqlServerSqlMISyncTaskOutputError>
    {
        ...
        void IJsonModel<MigrateSqlServerSqlMISyncTaskOutputError>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MigrateSqlServerSqlMISyncTaskOutputError)} does not support '{format}' format.");
            }
