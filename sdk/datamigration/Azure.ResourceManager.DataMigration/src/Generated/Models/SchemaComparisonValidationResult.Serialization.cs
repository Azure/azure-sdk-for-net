...
{
    public partial class SchemaComparisonValidationResult : IUtf8JsonSerializable, IJsonModel<SchemaComparisonValidationResult>, IPersistableModel<SchemaComparisonValidationResult>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SchemaDifferences))
            {
                builder.Append("  schemaDifferences:");
                AppendChildObject(builder, SchemaDifferences, options, 2);
            }
            ...
            if (Optional.IsCollectionDefined(SourceDatabaseObjectCount))
            {
                builder.Append("  sourceDatabaseObjectCount:");
                builder.AppendLine(" {");
                foreach (var item in SourceDatabaseObjectCount)
                {
            ...
            if (Optional.IsCollectionDefined(TargetDatabaseObjectCount))
            {
                builder.Append("  targetDatabaseObjectCount:");
                builder.AppendLine(" {");
                foreach (var item in TargetDatabaseObjectCount)
                {
                    builder.Append($"    {item.Key}: ");
