...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ValidateMigrationInputSqlServerSqlMISyncTaskOutput>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        ValidateMigrationInputSqlServerSqlMISyncTaskOutput IJsonModel<ValidateMigrationInputSqlServerSqlMISyncTaskOutput>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<ValidateMigrationInputSqlServerSqlMISyncTaskOutput>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ValidateMigrationInputSqlServerSqlMISyncTaskOutput IModel<ValidateMigrationInputSqlServerSqlMISyncTaskOutput>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<ValidateMigrationInputSqlServerSqlMISyncTaskOutput>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
