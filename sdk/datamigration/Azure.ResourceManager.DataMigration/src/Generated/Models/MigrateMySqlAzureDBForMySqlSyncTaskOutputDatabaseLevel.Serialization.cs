...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class MigrateMySqlAzureDBForMySqlSyncTaskOutputDatabaseLevel : MigrateMySqlAzureDBForMySqlSyncTaskOutput, IJsonModel<MigrateMySqlAzureDBForMySqlSyncTaskOutputDatabaseLevel>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<MigrateMySqlAzureDBForMySqlSyncTaskOutputDatabaseLevel>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<MigrateMySqlAzureDBForMySqlSyncTaskOutputDatabaseLevel>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        MigrateMySqlAzureDBForMySqlSyncTaskOutputDatabaseLevel IPersistableModel<MigrateMySqlAzureDBForMySqlSyncTaskOutputDatabaseLevel>.Create(BinaryData data, ModelReaderWriterOptions options) => (MigrateMySqlAzureDBForMySqlSyncTaskOutputDatabaseLevel)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        MigrateMySqlAzureDBForMySqlSyncTaskOutputDatabaseLevel IJsonModel<MigrateMySqlAzureDBForMySqlSyncTaskOutputDatabaseLevel>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (MigrateMySqlAzureDBForMySqlSyncTaskOutputDatabaseLevel)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static MigrateMySqlAzureDBForMySqlSyncTaskOutputDatabaseLevel DeserializeMigrateMySqlAzureDBForMySqlSyncTaskOutputDatabaseLevel(JsonElement element, ModelReaderWriterOptions options)
        {
