...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class ConnectToTargetSqlMITaskProperties : DataMigrationProjectTaskProperties
    {
        ...
        public ConnectToTargetSqlMITaskProperties()
        {
            ...
            TaskType = DataMigrationTaskType.ConnectToTargetAzureSqlDBMI;
        }
        ...
        internal ConnectToTargetSqlMITaskProperties(DataMigrationTaskType taskType, IReadOnlyList<DataMigrationODataError> errors, DataMigrationTaskState? state, IReadOnlyList<DataMigrationCommandProperties> commands, IDictionary<string, string> clientData, IDictionary<string, BinaryData> serializedAdditionalRawData, ConnectToTargetSqlMITaskInput input, IReadOnlyList<ConnectToTargetSqlMITaskOutput> output) : base(taskType, errors, state, commands, clientData, serializedAdditionalRawData)
        {
            Input = input;
            Output = output;
            TaskType = taskType;
