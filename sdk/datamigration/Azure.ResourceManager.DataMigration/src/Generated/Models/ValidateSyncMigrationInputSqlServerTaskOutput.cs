...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class ValidateSyncMigrationInputSqlServerTaskOutput
    {
        ...
        internal ValidateSyncMigrationInputSqlServerTaskOutput(string id, string name, IReadOnlyList<ReportableException> validationErrors, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Name = name;
