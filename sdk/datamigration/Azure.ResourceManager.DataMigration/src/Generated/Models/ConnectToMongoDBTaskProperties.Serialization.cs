...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class ConnectToMongoDBTaskProperties : DataMigrationProjectTaskProperties, IJsonModel<ConnectToMongoDBTaskProperties>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<ConnectToMongoDBTaskProperties>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
                ...
                default:
                    throw new FormatException($"The model {nameof(ConnectToMongoDBTaskProperties)} does not support reading '{options.Format}' format.");
            }
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ConnectToMongoDBTaskProperties>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        ConnectToMongoDBTaskProperties IPersistableModel<ConnectToMongoDBTaskProperties>.Create(BinaryData data, ModelReaderWriterOptions options) => (ConnectToMongoDBTaskProperties)PersistableModelCreateCore(data, options);

        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<ConnectToMongoDBTaskProperties>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";

        /// <param name="writer"> The JSON writer. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        void IJsonModel<ConnectToMongoDBTaskProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ConnectToMongoDBTaskProperties)} does not support writing '{format}' format.");
            }
            ...
            if (options.Format != "W" && Optional.IsCollectionDefined(Output))
            {
                ...
                foreach (DataMigrationMongoDBClusterInfo item in Output)
                {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ConnectToMongoDBTaskProperties IJsonModel<ConnectToMongoDBTaskProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (ConnectToMongoDBTaskProperties)JsonModelCreateCore(ref reader, options);
        ...
        protected override DataMigrationProjectTaskProperties JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ConnectToMongoDBTaskProperties)} does not support reading '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static ConnectToMongoDBTaskProperties DeserializeConnectToMongoDBTaskProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("input"u8))
                {
                    ...
                    input = DataMigrationMongoDBConnectionInfo.DeserializeDataMigrationMongoDBConnectionInfo(prop.Value, options);
                    continue;
                }
