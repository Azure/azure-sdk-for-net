...
{
    public partial class ConnectToMongoDBTaskProperties : Core.IUtf8JsonSerializable
    {
        ...
        internal static ConnectToMongoDBTaskProperties DeserializeConnectToMongoDBTaskProperties(JsonElement element)
        {
            ...
            Core.Optional<MongoDBConnectionInfo> input = default;
            Core.Optional<IReadOnlyList<MongoDBClusterInfo>> output = default;
            ...
            return new ConnectToMongoDBTaskProperties(taskType, Core.Optional.ToList(errors), Core.Optional.ToNullable(state), Core.Optional.ToList(commands), Core.Optional.ToDictionary(clientData), input.Value, Core.Optional.ToList(output));
        }
    }
}
