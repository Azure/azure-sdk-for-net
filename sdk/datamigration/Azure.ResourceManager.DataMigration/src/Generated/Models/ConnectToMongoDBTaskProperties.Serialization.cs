...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ConnectToMongoDBTaskProperties>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Input))
            {
                ...
                ((IJsonModel<MongoDBConnectionInfo>)Input).Write(writer, options);
            }
            if (options.Format != "W" && Optional.IsCollectionDefined(Output))
            {
                ...
                {
                    ((IJsonModel<MongoDBClusterInfo>)item).Write(writer, options);
                }
                writer.WriteEndArray();
            }
        }

        ConnectToMongoDBTaskProperties IJsonModel<ConnectToMongoDBTaskProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ConnectToMongoDBTaskProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static ConnectToMongoDBTaskProperties DeserializeConnectToMongoDBTaskProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("input"u8))
                {
                    ...
                    input = ModelSerializationExtensions.JsonDeserialize<MongoDBConnectionInfo>(property.Value);
                    continue;
                }
        ...
        ConnectToMongoDBTaskProperties IPersistableModel<ConnectToMongoDBTaskProperties>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ConnectToMongoDBTaskProperties>)this).GetFormatFromOptions(options) : options.Format;
