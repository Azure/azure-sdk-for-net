...
namespace Azure.ResourceManager.DataMigration.Models
{
    public partial class ConnectToMongoDBTaskProperties : IUtf8JsonSerializable, IJsonModel<ConnectToMongoDBTaskProperties>
    {
        ...
        void IJsonModel<ConnectToMongoDBTaskProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ConnectToMongoDBTaskProperties)} does not support '{format}' format.");
            }
            ...
            if (options.Format != "W" && !(Output is ChangeTrackingList<MongoDBClusterInfo> collection && collection.IsUndefined))
            {
        ...
        internal static ConnectToMongoDBTaskProperties DeserializeConnectToMongoDBTaskProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new ConnectToMongoDBTaskProperties(taskType, errors ?? new ChangeTrackingList<ODataError>(), Optional.ToNullable(state), commands ?? new ChangeTrackingList<CommandProperties>(), Optional.ToDictionary(clientData), serializedAdditionalRawData, input.Value, output ?? new ChangeTrackingList<MongoDBClusterInfo>());
        }
