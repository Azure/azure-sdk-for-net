...
namespace Azure.ResourceManager.DataMigration.Models
{
    public partial class ConnectToMongoDBTaskProperties : IUtf8JsonSerializable, IJsonModel<ConnectToMongoDBTaskProperties>
    {
        ...
        void IJsonModel<ConnectToMongoDBTaskProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(ConnectToMongoDBTaskProperties)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ConnectToMongoDBTaskProperties>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(ConnectToMongoDBTaskProperties)} does not support '{options.Format}' format.");
            }
        }
