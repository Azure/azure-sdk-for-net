...
namespace Azure.ResourceManager.DataMigration.Models
{
    ...
    public partial class GetUserTablesSqlTaskProperties : DataMigrationProjectTaskProperties
    {
        /// <summary> Initializes a new instance of <see cref="GetUserTablesSqlTaskProperties"/>. </summary>
        public GetUserTablesSqlTaskProperties() : base(DataMigrationTaskType.GetUserTablesSql)
        {
        ...
        internal GetUserTablesSqlTaskProperties(DataMigrationTaskType taskType, IReadOnlyList<DataMigrationODataError> errors, DataMigrationTaskState? state, IReadOnlyList<DataMigrationCommandProperties> commands, IDictionary<string, string> clientData, IDictionary<string, BinaryData> additionalBinaryDataProperties, GetUserTablesSqlTaskInput input, IReadOnlyList<GetUserTablesSqlTaskOutput> output, string taskId) : base(taskType, errors, state, commands, clientData, additionalBinaryDataProperties)
        {
            Input = input;
            Output = output;
            TaskId = taskId;
