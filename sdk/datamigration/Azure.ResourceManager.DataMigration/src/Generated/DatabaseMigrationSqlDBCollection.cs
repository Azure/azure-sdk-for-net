...
namespace Azure.ResourceManager.DataMigration
{
    ...
    public partial class DatabaseMigrationSqlDBCollection : ArmCollection
    {
        ...
        {
            if (id.ResourceType != "Microsoft.Sql/servers")
            {
        ...
        /// <exception cref="ArgumentException"> <paramref name="targetDbName"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual async Task<Response<DatabaseMigrationSqlDBResource>> GetAsync(string targetDbName, string migrationOperationId = default, string expand = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(targetDbName, nameof(targetDbName));
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="targetDbName"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="targetDbName"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual Response<DatabaseMigrationSqlDBResource> Get(string targetDbName, string migrationOperationId = default, string expand = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(targetDbName, nameof(targetDbName));
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="targetDbName"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="targetDbName"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual async Task<NullableResponse<DatabaseMigrationSqlDBResource>> GetIfExistsAsync(string targetDbName, string migrationOperationId = default, string expand = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(targetDbName, nameof(targetDbName));
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="targetDbName"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="targetDbName"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual NullableResponse<DatabaseMigrationSqlDBResource> GetIfExists(string targetDbName, string migrationOperationId = default, string expand = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(targetDbName, nameof(targetDbName));
