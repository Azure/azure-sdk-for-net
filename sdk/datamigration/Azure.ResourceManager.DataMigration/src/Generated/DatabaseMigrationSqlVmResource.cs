...
namespace Azure.ResourceManager.DataMigration
{
    ...
    public partial class DatabaseMigrationSqlVmResource : ArmResource
    {
        ...
        internal DatabaseMigrationSqlVmResource(ArmClient client, DatabaseMigrationSqlVmData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<DatabaseMigrationSqlVmResource>> GetAsync(Guid? migrationOperationId = null, string expand = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new DatabaseMigrationSqlVmResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
