...
namespace Azure.ResourceManager.DataMigration
{
    ...
    public partial class DataMigrationServiceData : TrackedResourceData
    {
        ...
        internal DataMigrationServiceData(ResourceIdentifier id, string name, Core.ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, DataMigrationServiceProperties properties, IDictionary<string, string> tags, string location, ETag? eTag, string kind, DataMigrationServiceSku sku) : base(id, name, resourceType, systemData, tags, location)
        {
