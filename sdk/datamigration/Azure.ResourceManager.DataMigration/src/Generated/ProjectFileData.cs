...
namespace Azure.ResourceManager.DataMigration
{
    ...
    public partial class ProjectFileData : ResourceData
    {
        ...
        internal ProjectFileData(ResourceIdentifier id, string name, Core.ResourceType resourceType, SystemData systemData, string etag, ProjectFileProperties properties) : base(id, name, resourceType, systemData)
        {
            Etag = etag;
