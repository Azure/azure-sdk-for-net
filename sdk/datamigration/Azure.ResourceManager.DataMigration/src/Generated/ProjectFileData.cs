...
namespace Azure.ResourceManager.DataMigration
{
    ...
    public partial class ProjectFileData : ResourceData
    {
        ...
        internal ProjectFileData(ResourceIdentifier id, string name, Core.ResourceType resourceType, SystemData systemData, ETag? etag, ProjectFileProperties properties, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
            ETag = etag;
