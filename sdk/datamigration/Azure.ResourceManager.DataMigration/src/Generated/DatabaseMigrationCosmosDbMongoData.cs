...
namespace Azure.ResourceManager.DataMigration
{
    ...
    public partial class DatabaseMigrationCosmosDbMongoData : ResourceData
    {
        ...
        internal DatabaseMigrationCosmosDbMongoData(ResourceIdentifier id, string name, Core.ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, DatabaseMigrationPropertiesCosmosDbMongo properties) : base(id, name, resourceType, systemData)
        {
