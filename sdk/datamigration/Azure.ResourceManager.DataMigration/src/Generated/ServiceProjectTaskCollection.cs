    ...
    public partial class ServiceProjectTaskCollection : ArmCollection, IEnumerable<ServiceProjectTaskResource>, IAsyncEnumerable<ServiceProjectTaskResource>
    {
        ...
        public virtual async Task<ArmOperation<ServiceProjectTaskResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string taskName, ProjectTaskData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new DataMigrationArmOperation<ServiceProjectTaskResource>(Response.FromValue(new ServiceProjectTaskResource(Client, response), response.GetRawResponse()), operationId);
