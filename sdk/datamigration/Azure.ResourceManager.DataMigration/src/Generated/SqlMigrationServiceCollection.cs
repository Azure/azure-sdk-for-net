...
namespace Azure.ResourceManager.DataMigration
{
    ...
    public partial class SqlMigrationServiceCollection : ArmCollection, IEnumerable<SqlMigrationServiceResource>, IAsyncEnumerable<SqlMigrationServiceResource>
    {
        ...
        public virtual AsyncPageable<SqlMigrationServiceResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => { var data = SqlMigrationServiceData.DeserializeSqlMigrationServiceData(e); return new SqlMigrationServiceResource(Client, data, data.Id); }, _sqlMigrationServiceClientDiagnostics, Pipeline, "SqlMigrationServiceCollection.GetAll", "value", "nextLink", cancellationToken);
        }
