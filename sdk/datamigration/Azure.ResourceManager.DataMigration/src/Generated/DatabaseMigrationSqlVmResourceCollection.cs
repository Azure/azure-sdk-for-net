...
namespace Azure.ResourceManager.DataMigration
{
    ...
    /// To get a <see cref="DatabaseMigrationSqlVmResourceCollection" /> instance call the GetDatabaseMigrationSqlVmResources method from an instance of <see cref="ResourceGroupResource" />.
    /// </summary>
    public partial class DatabaseMigrationSqlVmResourceCollection : ArmCollection
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="DatabaseMigrationSqlVmResourceCollection"/> class for mocking. </summary>
        protected DatabaseMigrationSqlVmResourceCollection()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="DatabaseMigrationSqlVmResourceCollection"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the parent resource that is the target of operations. </param>
        internal DatabaseMigrationSqlVmResourceCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            _databaseMigrationSqlVmResourceDatabaseMigrationsSqlVmClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.DataMigration", DatabaseMigrationSqlVmResource.ResourceType.Namespace, Diagnostics);
            TryGetApiVersion(DatabaseMigrationSqlVmResource.ResourceType, out string databaseMigrationSqlVmResourceDatabaseMigrationsSqlVmApiVersion);
        ...
        public virtual async Task<ArmOperation<DatabaseMigrationSqlVmResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string sqlVirtualMachineName, string targetDbName, DatabaseMigrationSqlVmData data, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _databaseMigrationSqlVmResourceDatabaseMigrationsSqlVmClientDiagnostics.CreateScope("DatabaseMigrationSqlVmResourceCollection.CreateOrUpdate");
            scope.Start();
            try
            {
                var response = await _databaseMigrationSqlVmResourceDatabaseMigrationsSqlVmRestClient.CreateOrUpdateAsync(Id.SubscriptionId, Id.ResourceGroupName, sqlVirtualMachineName, targetDbName, data, cancellationToken).ConfigureAwait(false);
        ...
        public virtual ArmOperation<DatabaseMigrationSqlVmResource> CreateOrUpdate(WaitUntil waitUntil, string sqlVirtualMachineName, string targetDbName, DatabaseMigrationSqlVmData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _databaseMigrationSqlVmResourceDatabaseMigrationsSqlVmRestClient.CreateOrUpdate(Id.SubscriptionId, Id.ResourceGroupName, sqlVirtualMachineName, targetDbName, data, cancellationToken);
                var operation = new DataMigrationArmOperation<DatabaseMigrationSqlVmResource>(new DatabaseMigrationSqlVmResourceOperationSource(Client), _databaseMigrationSqlVmResourceDatabaseMigrationsSqlVmClientDiagnostics, Pipeline, _databaseMigrationSqlVmResourceDatabaseMigrationsSqlVmRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, sqlVirtualMachineName, targetDbName, data).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<Response<DatabaseMigrationSqlVmResource>> GetAsync(string sqlVirtualMachineName, string targetDbName, Guid? migrationOperationId = null, string expand = null, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _databaseMigrationSqlVmResourceDatabaseMigrationsSqlVmClientDiagnostics.CreateScope("DatabaseMigrationSqlVmResourceCollection.Get");
            scope.Start();
            try
            {
                var response = await _databaseMigrationSqlVmResourceDatabaseMigrationsSqlVmRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, sqlVirtualMachineName, targetDbName, migrationOperationId, expand, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<DatabaseMigrationSqlVmResource> Get(string sqlVirtualMachineName, string targetDbName, Guid? migrationOperationId = null, string expand = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _databaseMigrationSqlVmResourceDatabaseMigrationsSqlVmRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, sqlVirtualMachineName, targetDbName, migrationOperationId, expand, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new DatabaseMigrationSqlVmResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string sqlVirtualMachineName, string targetDbName, Guid? migrationOperationId = null, string expand = null, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _databaseMigrationSqlVmResourceDatabaseMigrationsSqlVmClientDiagnostics.CreateScope("DatabaseMigrationSqlVmResourceCollection.Exists");
            scope.Start();
            try
            {
                var response = await _databaseMigrationSqlVmResourceDatabaseMigrationsSqlVmRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, sqlVirtualMachineName, targetDbName, migrationOperationId, expand, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<bool> Exists(string sqlVirtualMachineName, string targetDbName, Guid? migrationOperationId = null, string expand = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _databaseMigrationSqlVmResourceDatabaseMigrationsSqlVmRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, sqlVirtualMachineName, targetDbName, migrationOperationId, expand, cancellationToken: cancellationToken);
                return Response.FromValue(response.Value != null, response.GetRawResponse());
            }
            catch (Exception e)
            {
