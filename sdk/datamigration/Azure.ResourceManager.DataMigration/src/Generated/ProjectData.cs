...
namespace Azure.ResourceManager.DataMigration
{
    ...
    public partial class ProjectData : TrackedResourceData
    {
        ...
        internal ProjectData(ResourceIdentifier id, string name, Core.ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, string etag, ProjectSourcePlatform? sourcePlatform, AzureActiveDirectoryApp azureAuthenticationInfo, ProjectTargetPlatform? targetPlatform, DateTimeOffset? creationOn, ConnectionInfo sourceConnectionInfo, ConnectionInfo targetConnectionInfo, IList<DatabaseInfo> databasesInfo, ProjectProvisioningState? provisioningState) : base(id, name, resourceType, systemData, tags, location)
        {
            Etag = etag;
