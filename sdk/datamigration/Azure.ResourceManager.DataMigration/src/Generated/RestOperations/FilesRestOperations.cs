...
namespace Azure.ResourceManager.DataMigration
{
    internal partial class Files
    {
        ...
        internal Files(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string applicationId, Uri endpoint, string apiVersion)
        {
            ClientDiagnostics = clientDiagnostics;
            _endpoint = endpoint;
            Pipeline = pipeline;
            _apiVersion = apiVersion;
            _userAgent = new TelemetryDetails(typeof(Files).Assembly, applicationId);
        }
