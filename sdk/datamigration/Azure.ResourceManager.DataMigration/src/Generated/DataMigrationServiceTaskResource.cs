...
namespace Azure.ResourceManager.DataMigration
{
    ...
    public partial class DataMigrationServiceTaskResource : ArmResource
    {
        ...
        {
            using DiagnosticScope scope = _dataMigrationServiceTasksClientDiagnostics.CreateScope("DataMigrationServiceTaskResource.Get");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response<DataMigrationServiceTaskResource>> UpdateAsync(DataMigrationProjectTaskData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _dataMigrationServiceTasksClientDiagnostics.CreateScope("DataMigrationServiceTaskResource.Update");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        {
            using DiagnosticScope scope = _dataMigrationServiceTasksClientDiagnostics.CreateScope("DataMigrationServiceTaskResource.Delete");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        {
            using DiagnosticScope scope = _dataMigrationServiceTasksClientDiagnostics.CreateScope("DataMigrationServiceTaskResource.Cancel");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
