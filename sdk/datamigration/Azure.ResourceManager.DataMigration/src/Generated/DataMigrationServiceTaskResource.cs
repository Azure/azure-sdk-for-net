...
namespace Azure.ResourceManager.DataMigration
{
    ...
    public partial class DataMigrationServiceTaskResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of DataMigrationServiceTaskResource for mocking. </summary>
        protected DataMigrationServiceTaskResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="DataMigrationServiceTaskResource"/> class. </summary>
        ...
        public virtual async Task<Response<DataMigrationServiceTaskResource>> GetAsync(string expand = default, CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _tasksClientDiagnostics.CreateScope("DataMigrationServiceTaskResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _tasksRestClient.CreateGetRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, expand, context);
        ...
        /// <param name="expand"> Expand the response. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<DataMigrationServiceTaskResource> Get(string expand = default, CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _tasksClientDiagnostics.CreateScope("DataMigrationServiceTaskResource.Get");
            scope.Start();
            try
        ...
        public virtual async Task<Response<DataMigrationServiceTaskResource>> UpdateAsync(DataMigrationProjectTaskData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _tasksClientDiagnostics.CreateScope("DataMigrationServiceTaskResource.Update");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _tasksRestClient.CreateUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, DataMigrationProjectTaskData.ToRequestContent(data), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<DataMigrationProjectTaskData> response = Response.FromValue(DataMigrationProjectTaskData.FromResponse(result), result);
                if (response.Value == null)
                {
        ...
        {
            using DiagnosticScope scope = _tasksClientDiagnostics.CreateScope("DataMigrationServiceTaskResource.Delete");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _tasksRestClient.CreateDeleteRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, deleteRunningTasks, context);
        ...
        {
            using DiagnosticScope scope = _tasksClientDiagnostics.CreateScope("DataMigrationServiceTaskResource.Cancel");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _tasksRestClient.CreateCancelRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<DataMigrationProjectTaskData> response = Response.FromValue(DataMigrationProjectTaskData.FromResponse(result), result);
                if (response.Value == null)
                {
        ...
        public virtual async Task<Response<DataMigrationCommandProperties>> CommandAsync(DataMigrationCommandProperties dataMigrationCommandProperties, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _tasksClientDiagnostics.CreateScope("DataMigrationServiceTaskResource.Command");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _tasksRestClient.CreateCommandRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, DataMigrationCommandProperties.ToRequestContent(dataMigrationCommandProperties), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        /// <summary>
        /// Updates the DataMigrationServiceTask.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{groupName}/providers/Microsoft.DataMigration/services/{serviceName}/projects/{projectName}/tasks/{taskName}. </description>
        ...
        public virtual async Task<ArmOperation<DataMigrationServiceTaskResource>> UpdateAsync(WaitUntil waitUntil, DataMigrationProjectTaskData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
            ...
            try
            {
                ...
                HttpMessage message = _tasksRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, DataMigrationProjectTaskData.ToRequestContent(data), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<DataMigrationProjectTaskData> response = Response.FromValue(DataMigrationProjectTaskData.FromResponse(result), result);
                RequestUriBuilder uri = message.Request.Uri;
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<DataMigrationServiceTaskResource> Update(WaitUntil waitUntil, DataMigrationProjectTaskData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
