...
namespace Azure.ResourceManager.DataMigration
{
    ...
    internal partial class DatabaseMigrationSqlDBOperationSource : IOperationSource<DatabaseMigrationSqlDBResource>
    {
        ...
        DatabaseMigrationSqlDBResource IOperationSource<DatabaseMigrationSqlDBResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            DatabaseMigrationSqlDBData data = DatabaseMigrationSqlDBData.DeserializeDatabaseMigrationSqlDBData(document.RootElement, ModelSerializationExtensions.WireOptions);
