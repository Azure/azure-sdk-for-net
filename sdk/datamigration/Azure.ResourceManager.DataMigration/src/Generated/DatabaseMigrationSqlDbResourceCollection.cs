...
namespace Azure.ResourceManager.DataMigration
{
    ...
    /// To get a <see cref="DatabaseMigrationSqlDbResourceCollection" /> instance call the GetDatabaseMigrationSqlDbResources method from an instance of <see cref="ResourceGroupResource" />.
    /// </summary>
    public partial class DatabaseMigrationSqlDbResourceCollection : ArmCollection
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="DatabaseMigrationSqlDbResourceCollection"/> class for mocking. </summary>
        protected DatabaseMigrationSqlDbResourceCollection()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="DatabaseMigrationSqlDbResourceCollection"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the parent resource that is the target of operations. </param>
        internal DatabaseMigrationSqlDbResourceCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            _databaseMigrationSqlDbResourceDatabaseMigrationsSqlDbClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.DataMigration", DatabaseMigrationSqlDbResource.ResourceType.Namespace, Diagnostics);
            TryGetApiVersion(DatabaseMigrationSqlDbResource.ResourceType, out string databaseMigrationSqlDbResourceDatabaseMigrationsSqlDbApiVersion);
        ...
        public virtual async Task<ArmOperation<DatabaseMigrationSqlDbResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string sqlDbInstanceName, string targetDbName, DatabaseMigrationSqlDbData data, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _databaseMigrationSqlDbResourceDatabaseMigrationsSqlDbClientDiagnostics.CreateScope("DatabaseMigrationSqlDbResourceCollection.CreateOrUpdate");
            scope.Start();
            try
            {
                var response = await _databaseMigrationSqlDbResourceDatabaseMigrationsSqlDbRestClient.CreateOrUpdateAsync(Id.SubscriptionId, Id.ResourceGroupName, sqlDbInstanceName, targetDbName, data, cancellationToken).ConfigureAwait(false);
        ...
        public virtual ArmOperation<DatabaseMigrationSqlDbResource> CreateOrUpdate(WaitUntil waitUntil, string sqlDbInstanceName, string targetDbName, DatabaseMigrationSqlDbData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _databaseMigrationSqlDbResourceDatabaseMigrationsSqlDbRestClient.CreateOrUpdate(Id.SubscriptionId, Id.ResourceGroupName, sqlDbInstanceName, targetDbName, data, cancellationToken);
                var operation = new DataMigrationArmOperation<DatabaseMigrationSqlDbResource>(new DatabaseMigrationSqlDbResourceOperationSource(Client), _databaseMigrationSqlDbResourceDatabaseMigrationsSqlDbClientDiagnostics, Pipeline, _databaseMigrationSqlDbResourceDatabaseMigrationsSqlDbRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, sqlDbInstanceName, targetDbName, data).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<Response<DatabaseMigrationSqlDbResource>> GetAsync(string sqlDbInstanceName, string targetDbName, Guid? migrationOperationId = null, string expand = null, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _databaseMigrationSqlDbResourceDatabaseMigrationsSqlDbClientDiagnostics.CreateScope("DatabaseMigrationSqlDbResourceCollection.Get");
            scope.Start();
            try
            {
                var response = await _databaseMigrationSqlDbResourceDatabaseMigrationsSqlDbRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, sqlDbInstanceName, targetDbName, migrationOperationId, expand, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<DatabaseMigrationSqlDbResource> Get(string sqlDbInstanceName, string targetDbName, Guid? migrationOperationId = null, string expand = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _databaseMigrationSqlDbResourceDatabaseMigrationsSqlDbRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, sqlDbInstanceName, targetDbName, migrationOperationId, expand, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new DatabaseMigrationSqlDbResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string sqlDbInstanceName, string targetDbName, Guid? migrationOperationId = null, string expand = null, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _databaseMigrationSqlDbResourceDatabaseMigrationsSqlDbClientDiagnostics.CreateScope("DatabaseMigrationSqlDbResourceCollection.Exists");
            scope.Start();
            try
            {
                var response = await _databaseMigrationSqlDbResourceDatabaseMigrationsSqlDbRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, sqlDbInstanceName, targetDbName, migrationOperationId, expand, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<bool> Exists(string sqlDbInstanceName, string targetDbName, Guid? migrationOperationId = null, string expand = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _databaseMigrationSqlDbResourceDatabaseMigrationsSqlDbRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, sqlDbInstanceName, targetDbName, migrationOperationId, expand, cancellationToken: cancellationToken);
                return Response.FromValue(response.Value != null, response.GetRawResponse());
            }
            catch (Exception e)
            {
