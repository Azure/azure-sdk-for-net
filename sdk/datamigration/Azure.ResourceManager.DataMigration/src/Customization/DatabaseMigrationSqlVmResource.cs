...
namespace Azure.ResourceManager.DataMigration
{
    ...
    public partial class DatabaseMigrationSqlVmResource
    {
        ...
        /// <summary> Stop in-progress database migration to SQL Virtual Machine. </summary>
        ...
        /// <summary> Initiate cutover for in-progress online database migration to SQL Virtual Machine. </summary>
        /// <param name="waitUntil"> <see cref="WaitUntil.Completed"/> if the method should wait to return until the long-running operation has completed on the service; <see cref="WaitUntil.Started"/> if it should return after starting the operation. </param>
