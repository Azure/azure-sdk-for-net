...
namespace Azure.ResourceManager.DataMigration.Samples
{
    public partial class Sample_DatabaseMigrationSqlDBResource
    {
        ...
        public async Task Get_GetSqlDBDatabaseMigrationWithTheExpandParameter()
        {
            ...
            DatabaseMigrationSqlDBResource result = await databaseMigrationSqlDB.GetAsync(migrationOperationId: (string)null, expand: expand);
        ...
        public async Task Get_GetSqlDBDatabaseMigrationWithoutTheExpandParameter()
        {
            ...
            // invoke the operation
            DatabaseMigrationSqlDBResource result = await databaseMigrationSqlDB.GetAsync(migrationOperationId: (string)null);
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task Retry_RetryDatabaseMigrationResource()
        {
