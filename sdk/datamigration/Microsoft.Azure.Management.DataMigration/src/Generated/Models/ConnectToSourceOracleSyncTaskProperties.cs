...
namespace Microsoft.Azure.Management.DataMigration.Models
{
    ...
    /// </summary>
    [Newtonsoft.Json.JsonObject("ConnectToSource.Oracle.Sync")]
    public partial class ConnectToSourceOracleSyncTaskProperties : ProjectTaskProperties
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ConnectToSourceOracleSyncTaskProperties class.
        /// </summary>
        ...
        /// submitted.</param>
        public ConnectToSourceOracleSyncTaskProperties(IList<ODataError> errors = default(IList<ODataError>), string state = default(string), IList<CommandProperties> commands = default(IList<CommandProperties>), IDictionary<string, string> clientData = default(IDictionary<string, string>), ConnectToSourceOracleSyncTaskInput input = default(ConnectToSourceOracleSyncTaskInput), IList<ConnectToSourceOracleSyncTaskOutput> output = default(IList<ConnectToSourceOracleSyncTaskOutput>))
        ...
        public ConnectToSourceOracleSyncTaskInput Input { get; set; }

        /// <summary>
        /// Gets task output. This is ignored if submitted.
        /// </summary>
        [JsonProperty(PropertyName = "output")]
        public IList<ConnectToSourceOracleSyncTaskOutput> Output { get; private set; }
