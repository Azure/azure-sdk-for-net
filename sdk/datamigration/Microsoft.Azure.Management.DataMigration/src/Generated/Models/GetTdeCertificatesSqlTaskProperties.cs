...
namespace Microsoft.Azure.Management.DataMigration.Models
{
    ...
    public partial class GetTdeCertificatesSqlTaskProperties : ProjectTaskProperties
    {
        ...
        /// GetTdeCertificatesSqlTaskProperties class.
        /// </summary>
        ...
        /// submitted.</param>
        public GetTdeCertificatesSqlTaskProperties(IList<ODataError> errors = default(IList<ODataError>), string state = default(string), IList<CommandProperties> commands = default(IList<CommandProperties>), IDictionary<string, string> clientData = default(IDictionary<string, string>), GetTdeCertificatesSqlTaskInput input = default(GetTdeCertificatesSqlTaskInput), IList<GetTdeCertificatesSqlTaskOutput> output = default(IList<GetTdeCertificatesSqlTaskOutput>))
        ...
        public IList<GetTdeCertificatesSqlTaskOutput> Output { get; private set; }
