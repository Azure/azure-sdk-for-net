...
namespace Microsoft.Azure.Management.DataMigration.Models
{
    ...
    public partial class MigrateSqlServerSqlDbTaskProperties : ProjectTaskProperties
    {
        ...
        /// submitted.</param>
        public MigrateSqlServerSqlDbTaskProperties(IList<ODataError> errors = default(IList<ODataError>), string state = default(string), IList<CommandProperties> commands = default(IList<CommandProperties>), IDictionary<string, string> clientData = default(IDictionary<string, string>), MigrateSqlServerSqlDbTaskInput input = default(MigrateSqlServerSqlDbTaskInput), IList<MigrateSqlServerSqlDbTaskOutput> output = default(IList<MigrateSqlServerSqlDbTaskOutput>))
