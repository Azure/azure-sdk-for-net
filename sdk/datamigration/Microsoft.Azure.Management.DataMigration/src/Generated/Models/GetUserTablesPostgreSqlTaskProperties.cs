...
namespace Microsoft.Azure.Management.DataMigration.Models
{
    ...
    /// databases
    /// </summary>
    [Newtonsoft.Json.JsonObject("GetUserTablesPostgreSql")]
    public partial class GetUserTablesPostgreSqlTaskProperties : ProjectTaskProperties
    {
        /// <summary>
        /// Initializes a new instance of the
        /// GetUserTablesPostgreSqlTaskProperties class.
        /// </summary>
        ...
        /// submitted.</param>
        public GetUserTablesPostgreSqlTaskProperties(IList<ODataError> errors = default(IList<ODataError>), string state = default(string), IList<CommandProperties> commands = default(IList<CommandProperties>), IDictionary<string, string> clientData = default(IDictionary<string, string>), GetUserTablesPostgreSqlTaskInput input = default(GetUserTablesPostgreSqlTaskInput), IList<GetUserTablesPostgreSqlTaskOutput> output = default(IList<GetUserTablesPostgreSqlTaskOutput>))
        ...
        public IList<GetUserTablesPostgreSqlTaskOutput> Output { get; private set; }
