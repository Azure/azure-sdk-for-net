...
namespace Microsoft.Azure.Management.DataMigration.Models
{
    ...
    /// </summary>
    [Newtonsoft.Json.JsonObject("Service.Upload.OCI")]
    public partial class UploadOCIDriverTaskProperties : ProjectTaskProperties
    {
        /// <summary>
        /// Initializes a new instance of the UploadOCIDriverTaskProperties
        /// class.
        /// </summary>
        ...
        /// submitted.</param>
        public UploadOCIDriverTaskProperties(IList<ODataError> errors = default(IList<ODataError>), string state = default(string), IList<CommandProperties> commands = default(IList<CommandProperties>), IDictionary<string, string> clientData = default(IDictionary<string, string>), UploadOCIDriverTaskInput input = default(UploadOCIDriverTaskInput), IList<UploadOCIDriverTaskOutput> output = default(IList<UploadOCIDriverTaskOutput>))
        ...
        public UploadOCIDriverTaskInput Input { get; set; }

        /// <summary>
        /// Gets task output. This is ignored if submitted.
        /// </summary>
        [JsonProperty(PropertyName = "output")]
        public IList<UploadOCIDriverTaskOutput> Output { get; private set; }
