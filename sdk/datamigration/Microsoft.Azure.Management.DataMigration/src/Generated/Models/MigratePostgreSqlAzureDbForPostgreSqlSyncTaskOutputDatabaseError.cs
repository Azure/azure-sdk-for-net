...
namespace Microsoft.Azure.Management.DataMigration.Models
{
    ...
    public partial class MigratePostgreSqlAzureDbForPostgreSqlSyncTaskOutputDatabaseError : MigratePostgreSqlAzureDbForPostgreSqlSyncTaskOutput
    {
        ...
        public MigratePostgreSqlAzureDbForPostgreSqlSyncTaskOutputDatabaseError(string id = default(string), string errorMessage = default(string), IList<SyncMigrationDatabaseErrorEvent> events = default(IList<SyncMigrationDatabaseErrorEvent>))
            : base(id)
        {
