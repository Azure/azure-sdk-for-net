...
namespace Microsoft.Azure.Management.DataMigration.Models
{
    ...
    public partial class MongoDbCancelCommand : CommandProperties
    {
        ...
        public MongoDbCancelCommand(IList<ODataError> errors = default(IList<ODataError>), string state = default(string), MongoDbCommandInput input = default(MongoDbCommandInput))
            : base(errors, state)
        {
            Input = input;
            CustomInit();
