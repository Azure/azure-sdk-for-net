...
namespace Microsoft.Azure.Management.DataMigration.Models
{
    ...
    public partial class GetUserTablesSqlTaskProperties : ProjectTaskProperties
    {
        ...
        /// submitted.</param>
        public GetUserTablesSqlTaskProperties(IList<ODataError> errors = default(IList<ODataError>), string state = default(string), IList<CommandProperties> commands = default(IList<CommandProperties>), IDictionary<string, string> clientData = default(IDictionary<string, string>), GetUserTablesSqlTaskInput input = default(GetUserTablesSqlTaskInput), IList<GetUserTablesSqlTaskOutput> output = default(IList<GetUserTablesSqlTaskOutput>))
