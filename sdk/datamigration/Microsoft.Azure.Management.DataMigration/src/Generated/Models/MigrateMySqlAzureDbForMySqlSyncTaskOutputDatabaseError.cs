...
namespace Microsoft.Azure.Management.DataMigration.Models
{
    ...
    public partial class MigrateMySqlAzureDbForMySqlSyncTaskOutputDatabaseError : MigrateMySqlAzureDbForMySqlSyncTaskOutput
    {
        ...
        public MigrateMySqlAzureDbForMySqlSyncTaskOutputDatabaseError(string id = default(string), string errorMessage = default(string), IList<SyncMigrationDatabaseErrorEvent> events = default(IList<SyncMigrationDatabaseErrorEvent>))
            : base(id)
        {
