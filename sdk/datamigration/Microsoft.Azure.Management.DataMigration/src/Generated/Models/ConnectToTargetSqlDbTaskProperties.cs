...
namespace Microsoft.Azure.Management.DataMigration.Models
{
    ...
    public partial class ConnectToTargetSqlDbTaskProperties : ProjectTaskProperties
    {
        ...
        /// submitted.</param>
        public ConnectToTargetSqlDbTaskProperties(IList<ODataError> errors = default(IList<ODataError>), string state = default(string), IList<CommandProperties> commands = default(IList<CommandProperties>), IDictionary<string, string> clientData = default(IDictionary<string, string>), ConnectToTargetSqlDbTaskInput input = default(ConnectToTargetSqlDbTaskInput), IList<ConnectToTargetSqlDbTaskOutput> output = default(IList<ConnectToTargetSqlDbTaskOutput>))
