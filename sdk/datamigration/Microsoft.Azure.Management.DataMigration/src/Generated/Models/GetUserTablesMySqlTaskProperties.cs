...
namespace Microsoft.Azure.Management.DataMigration.Models
{
    ...
    /// databases
    /// </summary>
    [Newtonsoft.Json.JsonObject("GetUserTablesMySql")]
    public partial class GetUserTablesMySqlTaskProperties : ProjectTaskProperties
    {
        /// <summary>
        /// Initializes a new instance of the GetUserTablesMySqlTaskProperties
        /// class.
        /// </summary>
        ...
        /// submitted.</param>
        public GetUserTablesMySqlTaskProperties(IList<ODataError> errors = default(IList<ODataError>), string state = default(string), IList<CommandProperties> commands = default(IList<CommandProperties>), IDictionary<string, string> clientData = default(IDictionary<string, string>), GetUserTablesMySqlTaskInput input = default(GetUserTablesMySqlTaskInput), IList<GetUserTablesMySqlTaskOutput> output = default(IList<GetUserTablesMySqlTaskOutput>))
        ...
        public IList<GetUserTablesMySqlTaskOutput> Output { get; private set; }
