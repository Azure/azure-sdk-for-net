...
namespace Microsoft.Azure.Management.DataMigration.Models
{
    ...
    public partial class MigrateSqlServerSqlDbSyncTaskProperties : ProjectTaskProperties
    {
        ...
        /// submitted.</param>
        public MigrateSqlServerSqlDbSyncTaskProperties(IList<ODataError> errors = default(IList<ODataError>), string state = default(string), IList<CommandProperties> commands = default(IList<CommandProperties>), IDictionary<string, string> clientData = default(IDictionary<string, string>), MigrateSqlServerSqlDbSyncTaskInput input = default(MigrateSqlServerSqlDbSyncTaskInput), IList<MigrateSqlServerSqlDbSyncTaskOutput> output = default(IList<MigrateSqlServerSqlDbSyncTaskOutput>))
        ...
        public IList<MigrateSqlServerSqlDbSyncTaskOutput> Output { get; private set; }
