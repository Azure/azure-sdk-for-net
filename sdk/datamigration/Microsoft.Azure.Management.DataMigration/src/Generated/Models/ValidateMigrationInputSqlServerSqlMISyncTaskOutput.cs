...
namespace Microsoft.Azure.Management.DataMigration.Models
{
    ...
    public partial class ValidateMigrationInputSqlServerSqlMISyncTaskOutput
    {
        ...
        public ValidateMigrationInputSqlServerSqlMISyncTaskOutput(string id = default(string), string name = default(string), IList<ReportableException> validationErrors = default(IList<ReportableException>))
        {
            Id = id;
            Name = name;
