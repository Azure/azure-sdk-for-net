...
namespace Microsoft.Azure.Management.DataMigration.Models
{
    ...
    /// </summary>
    [Newtonsoft.Json.JsonObject("Service.Install.OCI")]
    public partial class InstallOCIDriverTaskProperties : ProjectTaskProperties
    {
        /// <summary>
        /// Initializes a new instance of the InstallOCIDriverTaskProperties
        /// class.
        /// </summary>
        ...
        /// submitted.</param>
        public InstallOCIDriverTaskProperties(IList<ODataError> errors = default(IList<ODataError>), string state = default(string), IList<CommandProperties> commands = default(IList<CommandProperties>), IDictionary<string, string> clientData = default(IDictionary<string, string>), InstallOCIDriverTaskInput input = default(InstallOCIDriverTaskInput), IList<InstallOCIDriverTaskOutput> output = default(IList<InstallOCIDriverTaskOutput>))
        ...
        public InstallOCIDriverTaskInput Input { get; set; }

        /// <summary>
        /// Gets task output. This is ignored if submitted.
        /// </summary>
        [JsonProperty(PropertyName = "output")]
        public IList<InstallOCIDriverTaskOutput> Output { get; private set; }
