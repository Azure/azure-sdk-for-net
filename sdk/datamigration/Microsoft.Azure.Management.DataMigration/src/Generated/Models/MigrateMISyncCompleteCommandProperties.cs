...
namespace Microsoft.Azure.Management.DataMigration.Models
{
    ...
    public partial class MigrateMISyncCompleteCommandProperties : CommandProperties
    {
        ...
        /// submitted.</param>
        public MigrateMISyncCompleteCommandProperties(IList<ODataError> errors = default(IList<ODataError>), string state = default(string), MigrateMISyncCompleteCommandInput input = default(MigrateMISyncCompleteCommandInput), MigrateMISyncCompleteCommandOutput output = default(MigrateMISyncCompleteCommandOutput))
            : base(errors, state)
        {
            Input = input;
            Output = output;
        ...
        public MigrateMISyncCompleteCommandInput Input { get; set; }

        /// <summary>
        /// Gets command output. This is ignored if submitted.
        /// </summary>
        [JsonProperty(PropertyName = "output")]
        public MigrateMISyncCompleteCommandOutput Output { get; private set; }
