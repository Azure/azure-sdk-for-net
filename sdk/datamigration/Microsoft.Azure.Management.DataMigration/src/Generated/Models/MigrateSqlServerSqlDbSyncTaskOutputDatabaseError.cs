...
namespace Microsoft.Azure.Management.DataMigration.Models
{
    ...
    public partial class MigrateSqlServerSqlDbSyncTaskOutputDatabaseError : MigrateSqlServerSqlDbSyncTaskOutput
    {
        ...
        public MigrateSqlServerSqlDbSyncTaskOutputDatabaseError(string id = default(string), string errorMessage = default(string), IList<SyncMigrationDatabaseErrorEvent> events = default(IList<SyncMigrationDatabaseErrorEvent>))
            : base(id)
        {
