...
namespace Microsoft.Azure.Management.DataMigration.Models
{
    ...
    public partial class MigrateSqlServerSqlMISyncTaskProperties : ProjectTaskProperties
    {
        ...
        /// MigrateSqlServerSqlMISyncTaskProperties class.
        /// </summary>
        ...
        /// submitted.</param>
        public MigrateSqlServerSqlMISyncTaskProperties(IList<ODataError> errors = default(IList<ODataError>), string state = default(string), IList<CommandProperties> commands = default(IList<CommandProperties>), IDictionary<string, string> clientData = default(IDictionary<string, string>), MigrateSqlServerSqlMISyncTaskInput input = default(MigrateSqlServerSqlMISyncTaskInput), IList<MigrateSqlServerSqlMISyncTaskOutput> output = default(IList<MigrateSqlServerSqlMISyncTaskOutput>))
        ...
        public IList<MigrateSqlServerSqlMISyncTaskOutput> Output { get; private set; }
