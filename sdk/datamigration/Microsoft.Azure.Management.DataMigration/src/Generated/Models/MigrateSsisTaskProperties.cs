...
namespace Microsoft.Azure.Management.DataMigration.Models
{
    ...
    /// <summary>
    /// Properties for task that migrates SSIS packages from SQL Server
    /// databases to Azure SQL Database Managed Instance.
    /// </summary>
    [Newtonsoft.Json.JsonObject("Migrate.Ssis")]
    public partial class MigrateSsisTaskProperties : ProjectTaskProperties
    {
        /// <summary>
        /// Initializes a new instance of the MigrateSsisTaskProperties class.
        /// </summary>
        ...
        /// submitted.</param>
        public MigrateSsisTaskProperties(IList<ODataError> errors = default(IList<ODataError>), string state = default(string), IList<CommandProperties> commands = default(IList<CommandProperties>), IDictionary<string, string> clientData = default(IDictionary<string, string>), MigrateSsisTaskInput input = default(MigrateSsisTaskInput), IList<MigrateSsisTaskOutput> output = default(IList<MigrateSsisTaskOutput>))
        ...
        public IList<MigrateSsisTaskOutput> Output { get; private set; }
