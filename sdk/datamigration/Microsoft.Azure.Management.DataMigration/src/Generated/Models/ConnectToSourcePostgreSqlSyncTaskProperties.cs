...
namespace Microsoft.Azure.Management.DataMigration.Models
{
    ...
    /// <summary>
    /// Properties for the task that validates connection to PostgreSQL server
    ...
    public partial class ConnectToSourcePostgreSqlSyncTaskProperties : ProjectTaskProperties
    {
        ...
        /// ConnectToSourcePostgreSqlSyncTaskProperties class.
        /// </summary>
        ...
        /// submitted.</param>
        public ConnectToSourcePostgreSqlSyncTaskProperties(IList<ODataError> errors = default(IList<ODataError>), string state = default(string), IList<CommandProperties> commands = default(IList<CommandProperties>), IDictionary<string, string> clientData = default(IDictionary<string, string>), ConnectToSourcePostgreSqlSyncTaskInput input = default(ConnectToSourcePostgreSqlSyncTaskInput), IList<ConnectToSourcePostgreSqlSyncTaskOutput> output = default(IList<ConnectToSourcePostgreSqlSyncTaskOutput>))
        ...
        public IList<ConnectToSourcePostgreSqlSyncTaskOutput> Output { get; private set; }
