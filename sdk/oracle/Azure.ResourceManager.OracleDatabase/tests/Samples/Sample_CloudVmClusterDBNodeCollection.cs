...
namespace Azure.ResourceManager.OracleDatabase.Samples
{
    public partial class Sample_CloudVmClusterDBNodeCollection
    {
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task Exists_GetDbNodeGeneratedByMaximumSetRule()
        {
            // Generated from example definition: 2025-09-01/DbNodes_Get_MaximumSet_Gen.json
            // this example is just showing the usage of "DbNode_Get" operation, for the dependent resources, they will have to be created separately.
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task Exists_GetDbNodeGeneratedByMinimumSetRule()
        {
            // Generated from example definition: 2025-09-01/DbNodes_Get_MinimumSet_Gen.json
            // this example is just showing the usage of "DbNode_Get" operation, for the dependent resources, they will have to be created separately.
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task Exists_DbNodesGet()
        {
            // Generated from example definition: 2025-09-01/dbNodes_get.json
            // this example is just showing the usage of "DbNode_Get" operation, for the dependent resources, they will have to be created separately.
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task GetIfExists_GetDbNodeGeneratedByMaximumSetRule()
        {
            // Generated from example definition: 2025-09-01/DbNodes_Get_MaximumSet_Gen.json
            // this example is just showing the usage of "DbNode_Get" operation, for the dependent resources, they will have to be created separately.
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task GetIfExists_GetDbNodeGeneratedByMinimumSetRule()
        {
            // Generated from example definition: 2025-09-01/DbNodes_Get_MinimumSet_Gen.json
            // this example is just showing the usage of "DbNode_Get" operation, for the dependent resources, they will have to be created separately.
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task GetIfExists_DbNodesGet()
        {
            // Generated from example definition: 2025-09-01/dbNodes_get.json
            // this example is just showing the usage of "DbNode_Get" operation, for the dependent resources, they will have to be created separately.
