...
namespace Azure.ResourceManager.OracleDatabase.Samples
{
    public partial class Sample_AutonomousDatabaseCollection
    {
        ...
        {
            // Generated from example definition: specification/oracle/resource-manager/Oracle.Database/stable/2025-03-01/examples/autonomousDatabase_create.json
...
["tagK1"] = "tagV1"
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task CreateOrUpdate_AutonomousDatabasesCreateOrUpdateCrossRegionPeer()
        {
            // Generated from example definition: specification/oracle/resource-manager/Oracle.Database/stable/2025-03-01/examples/autonomousDatabaseCrossRegionPeer_create.json
            // this example is just showing the usage of "AutonomousDatabases_CreateOrUpdate" operation, for the dependent resources, they will have to be created separately.
            ...
            AutonomousDatabaseData data = new AutonomousDatabaseData(new AzureLocation("eastus"))
            {
                Properties = new AutonomousDatabaseCrossRegionDisasterRecoveryProperties(new ResourceIdentifier("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg000/providers/Oracle.Database/autonomousDatabases/databasedb1"), DisasterRecoveryType.Adg)
                {
...
["tagK1"] = "tagV1"
        ...
        {
            // Generated from example definition: specification/oracle/resource-manager/Oracle.Database/stable/2025-03-01/examples/autonomousDatabaseClone_create.json
            // this example is just showing the usage of "AutonomousDatabases_CreateOrUpdate" operation, for the dependent resources, they will have to be created separately.
...
["tagK1"] = "tagV1"
        ...
        {
            // Generated from example definition: specification/oracle/resource-manager/Oracle.Database/stable/2025-03-01/examples/autonomousDatabase_listByResourceGroup.json
