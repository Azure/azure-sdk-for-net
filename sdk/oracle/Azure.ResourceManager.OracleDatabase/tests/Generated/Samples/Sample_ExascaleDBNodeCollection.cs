...
namespace Azure.ResourceManager.OracleDatabase.Samples
{
    public partial class Sample_ExascaleDBNodeCollection
    {
        ...
        {
            // Generated from example definition: specification/oracle/resource-manager/Oracle.Database/stable/2025-03-01/examples/ExascaleDbNodes_ListByParent_MaximumSet_Gen.json
            // this example is just showing the usage of "ExascaleDbNodes_ListByParent" operation, for the dependent resources, they will have to be created separately.
