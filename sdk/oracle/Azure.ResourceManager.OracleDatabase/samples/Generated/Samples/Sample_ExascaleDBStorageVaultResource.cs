...
namespace Azure.ResourceManager.OracleDatabase.Samples
{
    public partial class Sample_ExascaleDBStorageVaultResource
    {
        ...
        {
            // Generated from example definition: specification/oracle/resource-manager/Oracle.Database/stable/2025-03-01/examples/ExascaleDbStorageVaults_Delete_MaximumSet_Gen.json
            // this example is just showing the usage of "ExascaleDbStorageVaults_Delete" operation, for the dependent resources, they will have to be created separately.
        ...
        {
            // Generated from example definition: specification/oracle/resource-manager/Oracle.Database/stable/2025-03-01/examples/ExascaleDbStorageVaults_Update_MaximumSet_Gen.json
            // this example is just showing the usage of "ExascaleDbStorageVaults_Update" operation, for the dependent resources, they will have to be created separately.
