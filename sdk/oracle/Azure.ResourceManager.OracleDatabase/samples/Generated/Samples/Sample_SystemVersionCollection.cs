...
{
    public partial class Sample_SystemVersionCollection
    {
        ...
        {
            // Generated from example definition: specification/oracle/resource-manager/Oracle.Database/preview/2023-09-01-preview/examples/systemVersions_listByLocation.json
            ...
            // get the collection of this SystemVersionResource
            AzureLocation location = new AzureLocation("eastus");
            SystemVersionCollection collection = subscriptionResource.GetSystemVersions(location);

            // invoke the operation and iterate over the result
            await foreach (SystemVersionResource item in collection.GetAllAsync())
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                SystemVersionData resourceData = item.Data;
        ...
        {
            // Generated from example definition: specification/oracle/resource-manager/Oracle.Database/preview/2023-09-01-preview/examples/systemVersions_get.json
            ...
            SystemVersionResource result = await collection.GetAsync(systemversionname);

            // the variable result is a resource, you could call other operations on this instance as well
            // but just for demo, we get its data from this resource instance
            SystemVersionData resourceData = result.Data;
            // for demo we just print out the id
            Console.WriteLine($"Succeeded on id: {resourceData.Id}");
        }
        ...
        public async Task GetIfExists_GetExadataSystemVersion()
        {
            ...
            // invoke the operation
            string systemversionname = "22.x";
            NullableResponse<SystemVersionResource> response = await collection.GetIfExistsAsync(systemversionname);
            SystemVersionResource result = response.HasValue ? response.Value : null;
