...
namespace Azure.ResourceManager.OracleDatabase
{
    ...
    public partial class ExadbVmClusterData : IJsonModel<ExadbVmClusterData>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ExadbVmClusterData IJsonModel<ExadbVmClusterData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (ExadbVmClusterData)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static ExadbVmClusterData DeserializeExadbVmClusterData(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = ExadbVmClusterProperties.DeserializeExadbVmClusterProperties(prop.Value, options);
                    continue;
                }
        ...
        /// <param name="result"> The <see cref="Response"/> to deserialize the <see cref="ExadbVmClusterData"/> from. </param>
        internal static ExadbVmClusterData FromResponse(Response result)
        {
