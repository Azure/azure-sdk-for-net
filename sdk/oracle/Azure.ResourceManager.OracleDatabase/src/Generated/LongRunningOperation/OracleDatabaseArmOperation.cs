...
#pragma warning disable SA1649 // File name should match first type name
    internal class OracleDatabaseArmOperation : ArmOperation
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        internal OracleDatabaseArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal OracleDatabaseArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal(nextLinkOperation, clientDiagnostics, response, "OracleDatabaseArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
