...
{
    /// <summary></summary>
    internal partial class CloudVmClusterResourceOperationSource : IOperationSource<CloudVmClusterResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal CloudVmClusterResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
