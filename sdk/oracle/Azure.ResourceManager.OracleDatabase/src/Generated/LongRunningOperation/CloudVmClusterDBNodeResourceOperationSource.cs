...
{
    /// <summary></summary>
    internal partial class CloudVmClusterDBNodeResourceOperationSource : IOperationSource<CloudVmClusterDBNodeResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal CloudVmClusterDBNodeResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
