...
namespace Azure.ResourceManager.OracleDatabase
{
    internal partial class OracleDatabaseArmOperation<T> : ArmOperation<T>
    {
        ...
        internal OracleDatabaseArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
