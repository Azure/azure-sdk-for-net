...
{
    /// <summary></summary>
    internal partial class AutonomousDatabaseBackupResourceOperationSource : IOperationSource<AutonomousDatabaseBackupResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal AutonomousDatabaseBackupResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
