...
{
    /// <summary></summary>
    internal partial class ExadbVmClusterResourceOperationSource : IOperationSource<ExadbVmClusterResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal ExadbVmClusterResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
