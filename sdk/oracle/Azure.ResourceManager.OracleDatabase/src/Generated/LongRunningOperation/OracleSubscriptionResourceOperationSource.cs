...
{
    /// <summary></summary>
    internal partial class OracleSubscriptionResourceOperationSource : IOperationSource<OracleSubscriptionResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal OracleSubscriptionResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
