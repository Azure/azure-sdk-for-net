...
{
    /// <summary></summary>
    internal partial class OracleResourceAnchorResourceOperationSource : IOperationSource<OracleResourceAnchorResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal OracleResourceAnchorResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
