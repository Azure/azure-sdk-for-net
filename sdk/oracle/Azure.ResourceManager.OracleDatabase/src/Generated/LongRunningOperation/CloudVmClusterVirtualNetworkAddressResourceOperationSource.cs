...
{
    /// <summary></summary>
    internal partial class CloudVmClusterVirtualNetworkAddressResourceOperationSource : IOperationSource<CloudVmClusterVirtualNetworkAddressResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal CloudVmClusterVirtualNetworkAddressResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
