...
{
    /// <summary></summary>
    internal partial class AutonomousDatabaseResourceOperationSource : IOperationSource<AutonomousDatabaseResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal AutonomousDatabaseResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
