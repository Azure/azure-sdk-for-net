...
{
    /// <summary></summary>
    internal partial class OracleDBSystemResourceOperationSource : IOperationSource<OracleDBSystemResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal OracleDBSystemResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
