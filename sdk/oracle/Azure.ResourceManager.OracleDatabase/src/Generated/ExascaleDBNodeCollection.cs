...
namespace Azure.ResourceManager.OracleDatabase
{
    ...
    /// To get a <see cref="ExascaleDBNodeCollection"/> instance call the GetExascaleDBNodes method from an instance of <see cref="ExadbVmClusterResource"/>.
    /// </summary>
    public partial class ExascaleDBNodeCollection : ArmCollection, IEnumerable<ExascaleDBNodeResource>, IAsyncEnumerable<ExascaleDBNodeResource>
    {
        ...
        /// <item>
        /// <term> Operation Id. </term>
        /// <description> ExascaleDbNodes_ListByParent. </description>
        /// </item>
        /// <item>
        /// <term> Default Api Version. </term>
        /// <description> 2025-09-01. </description>
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string exascaleDbNodeName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                {
                    case 200:
                        response = Response.FromValue(ExascaleDBNodeData.FromResponse(result), result);
                        break;
                    case 404:
                        response = Response.FromValue((ExascaleDBNodeData)null, result);
                        break;
                    default:
