...
namespace Azure.ResourceManager.OracleDatabase
{
    ...
    public partial class DBNodeResource : ArmResource
    {
        ...
        {
            _dbNodeDBNodesClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.OracleDatabase", ResourceType.Namespace, Diagnostics);
            TryGetApiVersion(ResourceType, out string dbNodeDBNodesApiVersion);
        ...
        {
            using var scope = _dbNodeDBNodesClientDiagnostics.CreateScope("DBNodeResource.Get");
            scope.Start();
            try
            {
                var response = await _dbNodeDBNodesRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<DBNodeResource> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _dbNodeDBNodesRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new DBNodeResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        public virtual async Task<ArmOperation<DBNodeResource>> ActionAsync(WaitUntil waitUntil, DBNodeAction body, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _dbNodeDBNodesClientDiagnostics.CreateScope("DBNodeResource.Action");
            scope.Start();
            try
            {
                var response = await _dbNodeDBNodesRestClient.ActionAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, body, cancellationToken).ConfigureAwait(false);
                var operation = new OracleDatabaseArmOperation<DBNodeResource>(new DBNodeOperationSource(Client), _dbNodeDBNodesClientDiagnostics, Pipeline, _dbNodeDBNodesRestClient.CreateActionRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, body).Request, response, OperationFinalStateVia.Location);
        ...
        public virtual ArmOperation<DBNodeResource> Action(WaitUntil waitUntil, DBNodeAction body, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _dbNodeDBNodesRestClient.Action(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, body, cancellationToken);
                var operation = new OracleDatabaseArmOperation<DBNodeResource>(new DBNodeOperationSource(Client), _dbNodeDBNodesClientDiagnostics, Pipeline, _dbNodeDBNodesRestClient.CreateActionRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, body).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
