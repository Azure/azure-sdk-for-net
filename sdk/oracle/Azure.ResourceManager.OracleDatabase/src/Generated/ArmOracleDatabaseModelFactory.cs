...
namespace Azure.ResourceManager.OracleDatabase.Models
{
    ...
    public static partial class ArmOracleDatabaseModelFactory
    {
        ...
        /// <param name="location"> The geo-location where the resource lives. </param>
        /// <param name="properties"> The resource-specific properties for this resource. </param>
        /// <param name="name0"> CloudVmCluster name. </param>
        /// <returns> A new <see cref="OracleDatabase.CloudVmClusterData"/> instance for mocking. </returns>
        public static CloudVmClusterData CloudVmClusterData(ResourceIdentifier id = default, string name = default, ResourceType resourceType = default, SystemData systemData = default, IDictionary<string, string> tags = default, AzureLocation location = default, CloudVmClusterProperties properties = default, string name0 = default)
        {
            tags ??= new ChangeTrackingDictionary<string, string>();
