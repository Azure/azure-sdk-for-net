...
namespace Azure.ResourceManager.OracleDatabase
{
    ...
    /// To get a <see cref="AutonomousDatabaseNationalCharacterSetCollection"/> instance call the GetAutonomousDatabaseNationalCharacterSets method from an instance of <see cref="SubscriptionResource"/>.
    /// </summary>
    public partial class AutonomousDatabaseNationalCharacterSetCollection : ArmCollection, IEnumerable<AutonomousDatabaseNationalCharacterSetResource>, IAsyncEnumerable<AutonomousDatabaseNationalCharacterSetResource>
    {
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string adbsncharsetname, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                Response<AutonomousDatabaseNationalCharacterSetData> response = default;
                switch (result.Status)
                {
                    case 200:
                        response = Response.FromValue(AutonomousDatabaseNationalCharacterSetData.FromResponse(result), result);
                        break;
                    case 404:
                        response = Response.FromValue((AutonomousDatabaseNationalCharacterSetData)null, result);
                        break;
                    default:
