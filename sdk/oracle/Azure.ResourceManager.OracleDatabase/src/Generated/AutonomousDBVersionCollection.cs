...
namespace Azure.ResourceManager.OracleDatabase
{
    ...
    /// To get a <see cref="AutonomousDBVersionCollection"/> instance call the GetAutonomousDBVersions method from an instance of <see cref="SubscriptionResource"/>.
    /// </summary>
    public partial class AutonomousDBVersionCollection : ArmCollection, IEnumerable<AutonomousDBVersionResource>, IAsyncEnumerable<AutonomousDBVersionResource>
    {
        ...
        /// <item>
        /// <term> Operation Id. </term>
        /// <description> AutonomousDatabaseVersions_ListByLocation. </description>
        /// </item>
        /// <item>
        /// <term> Default Api Version. </term>
        /// <description> 2025-09-01. </description>
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string autonomousdbversionsname, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                Response<AutonomousDBVersionData> response = default;
                switch (result.Status)
                {
                    case 200:
                        response = Response.FromValue(AutonomousDBVersionData.FromResponse(result), result);
                        break;
                    case 404:
                        response = Response.FromValue((AutonomousDBVersionData)null, result);
                        break;
                    default:
