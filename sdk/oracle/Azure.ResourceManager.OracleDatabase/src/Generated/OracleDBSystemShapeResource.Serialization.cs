...
namespace Azure.ResourceManager.OracleDatabase
{
    public partial class OracleDBSystemShapeResource : IJsonModel<OracleDBSystemShapeData>
    {
        ...
        BinaryData IPersistableModel<OracleDBSystemShapeData>.Write(ModelReaderWriterOptions options) => ModelReaderWriter.Write(Data, options);

        OracleDBSystemShapeData IPersistableModel<OracleDBSystemShapeData>.Create(BinaryData data, ModelReaderWriterOptions options) => ModelReaderWriter.Read<OracleDBSystemShapeData>(data, options);
