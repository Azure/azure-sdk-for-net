...
namespace Azure.ResourceManager.OracleDatabase.Models
{
    ...
    internal partial class ExascaleDbStorageVaultListResult : IJsonModel<ExascaleDbStorageVaultListResult>
    {
        ...
        /// <param name="result"> The <see cref="Response"/> to deserialize the <see cref="ExascaleDbStorageVaultListResult"/> from. </param>
        internal static ExascaleDbStorageVaultListResult FromResponse(Response result)
        {
