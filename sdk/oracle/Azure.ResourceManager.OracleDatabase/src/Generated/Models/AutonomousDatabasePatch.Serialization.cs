    ...
    public partial class AutonomousDatabasePatch : IUtf8JsonSerializable, IJsonModel<AutonomousDatabasePatch>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Properties))
            {
                ...
                ((IJsonModel<AutonomousDatabaseUpdateProperties>)Properties).Write(writer, options);
            }
        ...
        internal static AutonomousDatabasePatch DeserializeAutonomousDatabasePatch(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    properties = ModelSerializationExtensions.JsonDeserialize<AutonomousDatabaseUpdateProperties>(property.Value);
                    continue;
                }
                if (options.Format != "W")
                {
            ...
            return new AutonomousDatabasePatch(tags ?? new ChangeTrackingDictionary<string, string>(), properties, serializedAdditionalRawData);
        }
