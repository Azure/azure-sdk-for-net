...
namespace Azure.ResourceManager.OracleDatabase.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GiVersionListResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            {
                ((IJsonModel<OracleGIVersionData>)item).Write(writer, options);
            }
        ...
        internal static GiVersionListResult DeserializeGiVersionListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            IReadOnlyList<OracleGIVersionData> value = default;
            ...
            return new GiVersionListResult(value, nextLink, serializedAdditionalRawData);
        }
