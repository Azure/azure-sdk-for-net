...
namespace Azure.ResourceManager.OracleDatabase.Models
{
    ...
    internal partial class DbNodeListResult : IJsonModel<DbNodeListResult>
    {
        ...
        /// <param name="result"> The <see cref="Response"/> to deserialize the <see cref="DbNodeListResult"/> from. </param>
        internal static DbNodeListResult FromResponse(Response result)
        {
