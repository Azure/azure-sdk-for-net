...
namespace Azure.ResourceManager.OracleDatabase.Models
{
    ...
    public partial class DbSystemShapeProperties
    {
        ...
        internal DbSystemShapeProperties(string shapeName, int availableCoreCount)
        {
