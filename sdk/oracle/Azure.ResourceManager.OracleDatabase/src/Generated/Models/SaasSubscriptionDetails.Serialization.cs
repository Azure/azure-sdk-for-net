...
namespace Azure.ResourceManager.OracleDatabase.Models
{
    ...
    public partial class SaasSubscriptionDetails : IJsonModel<SaasSubscriptionDetails>
    {
        ...
        /// <param name="response"> The <see cref="Response"/> to deserialize the <see cref="SaasSubscriptionDetails"/> from. </param>
        internal static SaasSubscriptionDetails FromResponse(Response response)
        {
