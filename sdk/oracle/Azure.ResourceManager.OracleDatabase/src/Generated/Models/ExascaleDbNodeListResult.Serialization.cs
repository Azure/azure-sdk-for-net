...
namespace Azure.ResourceManager.OracleDatabase.Models
{
    ...
    internal partial class ExascaleDbNodeListResult : IJsonModel<ExascaleDbNodeListResult>
    {
        ...
        /// <param name="result"> The <see cref="Response"/> to deserialize the <see cref="ExascaleDbNodeListResult"/> from. </param>
        internal static ExascaleDbNodeListResult FromResponse(Response result)
        {
