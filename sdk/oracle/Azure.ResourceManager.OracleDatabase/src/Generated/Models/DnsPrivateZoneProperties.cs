...
namespace Azure.ResourceManager.OracleDatabase.Models
{
    ...
    public partial class DnsPrivateZoneProperties
    {
        ...
        internal DnsPrivateZoneProperties(string ocid, bool isProtected, DnsPrivateZonesLifecycleState lifecycleState, string self, int serial, string version, ZoneType zoneType, DateTimeOffset timeCreated)
        {
