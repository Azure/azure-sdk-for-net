...
namespace Azure.ResourceManager.OracleDatabase.Models
{
    ...
    public readonly partial struct CredentialType : IEquatable<CredentialType>
    {
        ...
        /// <summary> The GoldenGate credential. </summary>
        private const string GoldenGateValue = "GoldenGate";
        /// <summary> The IAM credential. </summary>
        private const string IamValue = "IAM";
        ...
        /// <summary> The GoldenGate credential. </summary>
        public static CredentialType GoldenGate { get; } = new CredentialType(GoldenGateValue);

        /// <summary> The IAM credential. </summary>
        public static CredentialType Iam { get; } = new CredentialType(IamValue);
