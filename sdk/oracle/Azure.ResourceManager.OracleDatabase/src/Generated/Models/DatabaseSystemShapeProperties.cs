...
{
    /// <summary> DatabaseSystemShape resource model. </summary>
    public partial class DatabaseSystemShapeProperties
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="DatabaseSystemShapeProperties"/>. </summary>
        ...
        internal DatabaseSystemShapeProperties(string shapeName, int availableCoreCount)
        {
            ShapeName = shapeName;
        ...
        /// <param name="computeModel"> The compute model of the DB system for this shape. </param>
        ...
        /// <summary> The compute model of the DB system for this shape. </summary>
