...
namespace Azure.ResourceManager.OracleDatabase.Models
{
    ...
    public partial class AutonomousDatabaseConnectionStrings
    {
        ...
        internal AutonomousDatabaseConnectionStrings(AutonomousDatabaseConnectionStringType allConnectionStrings, string dedicated, string high, string low, string medium, IReadOnlyList<AutonomousDatabaseConnectionStringProfile> profiles, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
