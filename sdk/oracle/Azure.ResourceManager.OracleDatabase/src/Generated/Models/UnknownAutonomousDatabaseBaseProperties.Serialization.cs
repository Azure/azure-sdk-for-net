...
{
    internal partial class UnknownAutonomousDatabaseBaseProperties : AutonomousDatabaseBaseProperties, IJsonModel<AutonomousDatabaseBaseProperties>
    {
        /// <summary> Initializes a new instance of <see cref="UnknownAutonomousDatabaseBaseProperties"/> for deserialization. </summary>
        internal UnknownAutonomousDatabaseBaseProperties()
        {
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownAutonomousDatabaseBaseProperties DeserializeUnknownAutonomousDatabaseBaseProperties(JsonElement element, ModelReaderWriterOptions options)
        {
