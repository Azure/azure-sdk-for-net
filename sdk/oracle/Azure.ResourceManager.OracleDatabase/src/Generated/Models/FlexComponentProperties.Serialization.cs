...
{
    public partial class FlexComponentProperties : IUtf8JsonSerializable, IJsonModel<FlexComponentProperties>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FlexComponentProperties>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<FlexComponentProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<FlexComponentProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(FlexComponentProperties)} does not support writing '{format}' format.");
            }
        ...
        FlexComponentProperties IJsonModel<FlexComponentProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<FlexComponentProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(FlexComponentProperties)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeFlexComponentProperties(document.RootElement, options);
        }

        internal static FlexComponentProperties DeserializeFlexComponentProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<FlexComponentProperties>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<FlexComponentProperties>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(FlexComponentProperties)} does not support writing '{options.Format}' format.");
            }
        }

        FlexComponentProperties IPersistableModel<FlexComponentProperties>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<FlexComponentProperties>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(FlexComponentProperties)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<FlexComponentProperties>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
