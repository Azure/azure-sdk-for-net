...
namespace Azure.ResourceManager.OracleDatabase.Models
{
    ...
    public partial class MaintenanceWindow
    {
        ...
        internal MaintenanceWindow(MaintenancePreference? preference, IList<MaintenanceMonth> months, IList<int> weeksOfMonth, IList<DayOfWeek> daysOfWeek, IList<int> hoursOfDay, int? leadTimeInWeeks, MaintenancePatchingMode? patchingMode, int? customActionTimeoutInMins, bool? isCustomActionTimeoutEnabled, bool? isMonthlyPatchingEnabled, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
