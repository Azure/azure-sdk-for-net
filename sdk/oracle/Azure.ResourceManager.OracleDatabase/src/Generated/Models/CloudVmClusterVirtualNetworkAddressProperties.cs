...
namespace Azure.ResourceManager.OracleDatabase.Models
{
    ...
    public partial class CloudVmClusterVirtualNetworkAddressProperties
    {
        ...
        internal CloudVmClusterVirtualNetworkAddressProperties(string ipAddress, string vmOcid, string ocid, string domain, string lifecycleDetails, OracleDatabaseProvisioningState? provisioningState, VirtualNetworkAddressLifecycleState? lifecycleState, DateTimeOffset? assignedOn, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            IPAddress = ipAddress;
            VmOcid = vmOcid;
            Ocid = ocid;
