...
namespace Azure.ResourceManager.OracleDatabase.Models
{
    ...
    internal partial class DbVersionListResult : IJsonModel<DbVersionListResult>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            foreach (DbVersionData item in Value)
            {
        ...
        internal static DbVersionListResult DeserializeDbVersionListResult(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            IList<DbVersionData> value = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    List<DbVersionData> array = new List<DbVersionData>();
                    foreach (var item in prop.Value.EnumerateArray())
                    {
                        array.Add(DbVersionData.DeserializeDbVersionData(item, options));
                    }
                    value = array;
                    continue;
                }
        ...
        /// <param name="result"> The <see cref="Response"/> to deserialize the <see cref="DbVersionListResult"/> from. </param>
        internal static DbVersionListResult FromResponse(Response result)
        {
