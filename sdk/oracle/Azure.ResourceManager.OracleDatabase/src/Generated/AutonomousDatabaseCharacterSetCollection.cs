...
namespace Azure.ResourceManager.OracleDatabase
{
    ...
    /// To get a <see cref="AutonomousDatabaseCharacterSetCollection"/> instance call the GetAutonomousDatabaseCharacterSets method from an instance of <see cref="SubscriptionResource"/>.
    /// </summary>
    public partial class AutonomousDatabaseCharacterSetCollection : ArmCollection, IEnumerable<AutonomousDatabaseCharacterSetResource>, IAsyncEnumerable<AutonomousDatabaseCharacterSetResource>
    {
        ...
        internal AutonomousDatabaseCharacterSetCollection(ArmClient client, ResourceIdentifier id, AzureLocation location) : base(client, id)
        {
            ...
            _autonomousDatabaseCharacterSetsRestClient = new AutonomousDatabaseCharacterSets(_autonomousDatabaseCharacterSetsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, autonomousDatabaseCharacterSetApiVersion ?? "2025-11-01-preview");
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string adbscharsetname, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                Response<AutonomousDatabaseCharacterSetData> response = default;
                switch (result.Status)
                {
                    case 200:
                        response = Response.FromValue(AutonomousDatabaseCharacterSetData.FromResponse(result), result);
                        break;
                    case 404:
                        response = Response.FromValue((AutonomousDatabaseCharacterSetData)null, result);
                        break;
                    default:
