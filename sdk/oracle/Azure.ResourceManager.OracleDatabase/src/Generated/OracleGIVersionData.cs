...
namespace Azure.ResourceManager.OracleDatabase
{
    ...
    public partial class OracleGIVersionData : ResourceData
    {
        ...
        internal OracleGIVersionData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, OracleGIVersionProperties properties) : base(id, name, resourceType, systemData)
        {
