...
namespace Azure.ResourceManager.OracleDatabase
{
    ...
    {
        private static IJsonModel<ExascaleDBNodeData> s_dataDeserializationInstance;

        private static IJsonModel<ExascaleDBNodeData> DataDeserializationInstance => s_dataDeserializationInstance ??= new ExascaleDBNodeData();
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ExascaleDBNodeData IJsonModel<ExascaleDBNodeData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => DataDeserializationInstance.Create(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<ExascaleDBNodeData>.GetFormatFromOptions(ModelReaderWriterOptions options) => DataDeserializationInstance.GetFormatFromOptions(options);
    }
}
