...
namespace Azure.ResourceManager.OracleDatabase
{
    ...
    public partial class ExascaleDbNodeCollection : ArmCollection, IEnumerable<ExascaleDbNodeResource>, IAsyncEnumerable<ExascaleDbNodeResource>
    {
        ...
        {
            _exascaleDbNodeClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.OracleDatabase", ExascaleDbNodeResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<Response<ExascaleDbNodeResource>> GetAsync(string exascaleDbNodeName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _exascaleDbNodeClientDiagnostics.CreateScope("ExascaleDbNodeCollection.Get");
            scope.Start();
            try
            {
                var response = await _exascaleDbNodeRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, exascaleDbNodeName, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<ExascaleDbNodeResource> Get(string exascaleDbNodeName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _exascaleDbNodeRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, exascaleDbNodeName, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new ExascaleDbNodeResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _exascaleDbNodeRestClient.CreateListByParentRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _exascaleDbNodeRestClient.CreateListByParentNextPageRequest(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Name);
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new ExascaleDbNodeResource(Client, ExascaleDbNodeData.DeserializeExascaleDbNodeData(e)), _exascaleDbNodeClientDiagnostics, Pipeline, "ExascaleDbNodeCollection.GetAll", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<ExascaleDbNodeResource> GetAll(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _exascaleDbNodeRestClient.CreateListByParentRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _exascaleDbNodeRestClient.CreateListByParentNextPageRequest(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Name);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new ExascaleDbNodeResource(Client, ExascaleDbNodeData.DeserializeExascaleDbNodeData(e)), _exascaleDbNodeClientDiagnostics, Pipeline, "ExascaleDbNodeCollection.GetAll", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string exascaleDbNodeName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _exascaleDbNodeClientDiagnostics.CreateScope("ExascaleDbNodeCollection.Exists");
            scope.Start();
            try
            {
                var response = await _exascaleDbNodeRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, exascaleDbNodeName, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<bool> Exists(string exascaleDbNodeName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _exascaleDbNodeRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, exascaleDbNodeName, cancellationToken: cancellationToken);
                return Response.FromValue(response.Value != null, response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        public virtual async Task<NullableResponse<ExascaleDbNodeResource>> GetIfExistsAsync(string exascaleDbNodeName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _exascaleDbNodeClientDiagnostics.CreateScope("ExascaleDbNodeCollection.GetIfExists");
            scope.Start();
            try
            {
                var response = await _exascaleDbNodeRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, exascaleDbNodeName, cancellationToken: cancellationToken).ConfigureAwait(false);
