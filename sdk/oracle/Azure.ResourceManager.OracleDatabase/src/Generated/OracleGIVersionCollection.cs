...
namespace Azure.ResourceManager.OracleDatabase
{
    ...
    /// To get a <see cref="OracleGIVersionCollection"/> instance call the GetOracleGIVersions method from an instance of <see cref="SubscriptionResource"/>.
    /// </summary>
    public partial class OracleGIVersionCollection : ArmCollection, IEnumerable<OracleGIVersionResource>, IAsyncEnumerable<OracleGIVersionResource>
    {
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string giversionname, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                Response<OracleGIVersionData> response = default;
                switch (result.Status)
                {
                    case 200:
                        response = Response.FromValue(OracleGIVersionData.FromResponse(result), result);
                        break;
                    case 404:
                        response = Response.FromValue((OracleGIVersionData)null, result);
                        break;
                    default:
