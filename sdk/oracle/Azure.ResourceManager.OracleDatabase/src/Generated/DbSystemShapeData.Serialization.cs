...
namespace Azure.ResourceManager.OracleDatabase
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DbSystemShapeData>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DbSystemShapeData)} does not support writing '{format}' format.");
            }
        ...
        DbSystemShapeData IJsonModel<DbSystemShapeData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DbSystemShapeData)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<DbSystemShapeData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(DbSystemShapeData)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        DbSystemShapeData IPersistableModel<DbSystemShapeData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(DbSystemShapeData)} does not support reading '{options.Format}' format.");
            }
        }
