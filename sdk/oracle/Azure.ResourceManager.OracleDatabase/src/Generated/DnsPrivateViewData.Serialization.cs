...
namespace Azure.ResourceManager.OracleDatabase
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DnsPrivateViewData>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DnsPrivateViewData)} does not support writing '{format}' format.");
            }
        ...
        DnsPrivateViewData IJsonModel<DnsPrivateViewData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DnsPrivateViewData)} does not support reading '{format}' format.");
            }
        ...
        internal static DnsPrivateViewData DeserializeDnsPrivateViewData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            DnsPrivateViewProperties properties = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("properties"u8))
                {
                    ...
                    properties = DnsPrivateViewProperties.DeserializeDnsPrivateViewProperties(property.Value, options);
                    continue;
                }
        ...
        BinaryData IPersistableModel<DnsPrivateViewData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(DnsPrivateViewData)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        DnsPrivateViewData IPersistableModel<DnsPrivateViewData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(DnsPrivateViewData)} does not support reading '{options.Format}' format.");
            }
        }
