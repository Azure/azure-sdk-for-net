    ...
    public partial class ExascaleDBStorageVaultData : IUtf8JsonSerializable, IJsonModel<ExascaleDBStorageVaultData>
    {
        ...
        internal static ExascaleDBStorageVaultData DeserializeExascaleDBStorageVaultData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
				...
				global::System.ClientModel.Primitives.ModelReaderWriter.Read<global::Azure.ResourceManager.Models.SystemData>(new global::System.BinaryData(global::System.Runtime.InteropServices.JsonMarshal.GetRawUtf8Value(property.Value).ToArray()), global::Azure.ResourceManager.OracleDatabase.ModelSerializationExtensions.WireOptions, AzureResourceManagerOracleDatabaseContext.Default)
#else
                ModelReaderWriter.Read<SystemData>(new BinaryData(Encoding.UTF8.GetBytes(property.Value.GetRawText())), ModelSerializationExtensions.WireOptions, AzureResourceManagerOracleDatabaseContext.Default)
#endif
;
                    continue;
                }
