...
{
    internal partial class DbVersionsGetByLocationCollectionResultOfT : Pageable<OracleDBVersionData>
    {
        ...
        public override IEnumerable<Page<OracleDBVersionData>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                yield return Page<OracleDBVersionData>.FromValues((IReadOnlyList<OracleDBVersionData>)result.Value, nextPage?.AbsoluteUri, response);
