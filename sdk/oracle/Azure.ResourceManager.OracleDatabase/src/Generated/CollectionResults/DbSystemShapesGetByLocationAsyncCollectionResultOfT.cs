...
{
    internal partial class DbSystemShapesGetByLocationAsyncCollectionResultOfT : AsyncPageable<OracleDBSystemShapeData>
    {
        ...
        /// <summary> Initializes a new instance of DbSystemShapesGetByLocationAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public DbSystemShapesGetByLocationAsyncCollectionResultOfT(DbSystemShapes client, Guid subscriptionId, AzureLocation location, string zone, string shapeAttribute, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of DbSystemShapesGetByLocationAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of DbSystemShapesGetByLocationAsyncCollectionResultOfT as an enumerable collection. </returns>
