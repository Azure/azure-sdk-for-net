...
namespace Azure.ResourceManager.OracleDatabase
{
    internal partial class DbSystemShapesGetByLocationAsyncCollectionResultOfT : AsyncPageable<OracleDBSystemShapeData>
    {
        ...
        public DbSystemShapesGetByLocationAsyncCollectionResultOfT(DbSystemShapes client, Guid subscriptionId, AzureLocation location, string zone, string shapeAttribute, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
