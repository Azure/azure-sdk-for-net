...
namespace Azure.ResourceManager.OracleDatabase
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GiVersionData>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(GiVersionData)} does not support writing '{format}' format.");
            }
        ...
        GiVersionData IJsonModel<GiVersionData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(GiVersionData)} does not support reading '{format}' format.");
            }
        ...
        internal static GiVersionData DeserializeGiVersionData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            GiVersionProperties properties = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("properties"u8))
                {
                    ...
                    properties = GiVersionProperties.DeserializeGiVersionProperties(property.Value, options);
                    continue;
                }
        ...
        BinaryData IPersistableModel<GiVersionData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(GiVersionData)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        GiVersionData IPersistableModel<GiVersionData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(GiVersionData)} does not support reading '{options.Format}' format.");
            }
        }
