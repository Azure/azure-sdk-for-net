...
namespace Azure.ResourceManager.OracleDatabase
{
    ...
    public partial class AutonomousDatabaseCharacterSetData : ResourceData
    {
        ...
        internal AutonomousDatabaseCharacterSetData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, AutonomousDatabaseCharacterSetProperties properties) : base(id, name, resourceType, systemData)
        {
