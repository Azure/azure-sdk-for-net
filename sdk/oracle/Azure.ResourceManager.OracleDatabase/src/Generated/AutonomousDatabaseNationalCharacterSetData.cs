...
namespace Azure.ResourceManager.OracleDatabase
{
    ...
    public partial class AutonomousDatabaseNationalCharacterSetData : ResourceData
    {
        ...
        internal AutonomousDatabaseNationalCharacterSetData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string characterSet, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
