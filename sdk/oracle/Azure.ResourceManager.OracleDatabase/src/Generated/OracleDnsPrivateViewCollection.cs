...
namespace Azure.ResourceManager.OracleDatabase
{
    ...
    /// To get a <see cref="OracleDnsPrivateViewCollection"/> instance call the GetOracleDnsPrivateViews method from an instance of <see cref="SubscriptionResource"/>.
    /// </summary>
    public partial class OracleDnsPrivateViewCollection : ArmCollection, IEnumerable<OracleDnsPrivateViewResource>, IAsyncEnumerable<OracleDnsPrivateViewResource>
    {
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string dnsprivateviewocid, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                Response<OracleDnsPrivateViewData> response = default;
                switch (result.Status)
                {
                    case 200:
                        response = Response.FromValue(OracleDnsPrivateViewData.FromResponse(result), result);
                        break;
                    case 404:
                        response = Response.FromValue((OracleDnsPrivateViewData)null, result);
                        break;
                    default:
