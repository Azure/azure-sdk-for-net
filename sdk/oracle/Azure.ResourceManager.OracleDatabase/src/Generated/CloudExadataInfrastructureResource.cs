...
namespace Azure.ResourceManager.OracleDatabase
{
    ...
    public partial class CloudExadataInfrastructureResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<CloudExadataInfrastructureResource>> UpdateAsync(WaitUntil waitUntil, CloudExadataInfrastructurePatch patch, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="patch"/> is null. </exception>
        public virtual ArmOperation<CloudExadataInfrastructureResource> Update(WaitUntil waitUntil, CloudExadataInfrastructurePatch patch, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(patch, nameof(patch));
        ...
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Oracle.Database/cloudExadataInfrastructures/{cloudexadatainfrastructurename}/configureExascale. </description>
        /// </item>
        /// <item>
        /// <term> Operation Id. </term>
        /// <description> CloudExadataInfrastructures_ConfigureExascale. </description>
        /// </item>
        /// <item>
        /// <term> Default Api Version. </term>
        /// <description> 2025-09-01. </description>
        ...
        public virtual async Task<ArmOperation<CloudExadataInfrastructureResource>> ConfigureExascaleAsync(WaitUntil waitUntil, ConfigureExascaleCloudExadataInfrastructureDetails details, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _cloudExadataInfrastructuresRestClient.CreateConfigureExascaleRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, ConfigureExascaleCloudExadataInfrastructureDetails.ToRequestContent(details), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                OracleDatabaseArmOperation<CloudExadataInfrastructureResource> operation = new OracleDatabaseArmOperation<CloudExadataInfrastructureResource>(
                    new CloudExadataInfrastructureResourceOperationSource(Client),
                    _cloudExadataInfrastructuresClientDiagnostics,
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="details"/> is null. </exception>
        public virtual ArmOperation<CloudExadataInfrastructureResource> ConfigureExascale(WaitUntil waitUntil, ConfigureExascaleCloudExadataInfrastructureDetails details, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(details, nameof(details));
        ...
        /// <summary>
        /// Updates the CloudExadataInfrastructure.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Oracle.Database/cloudExadataInfrastructures/{cloudexadatainfrastructurename}. </description>
        ...
        public virtual async Task<ArmOperation<CloudExadataInfrastructureResource>> UpdateAsync(WaitUntil waitUntil, CloudExadataInfrastructureData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _cloudExadataInfrastructuresRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, CloudExadataInfrastructureData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                OracleDatabaseArmOperation<CloudExadataInfrastructureResource> operation = new OracleDatabaseArmOperation<CloudExadataInfrastructureResource>(
                    new CloudExadataInfrastructureResourceOperationSource(Client),
                    _cloudExadataInfrastructuresClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<CloudExadataInfrastructureResource> Update(WaitUntil waitUntil, CloudExadataInfrastructureData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
        ...
        public virtual async Task<Response<CloudExadataInfrastructureResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    ArmOperation<CloudExadataInfrastructureResource> result = await UpdateAsync(WaitUntil.Completed, patch, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="key"/> or <paramref name="value"/> is null. </exception>
        public virtual Response<CloudExadataInfrastructureResource> AddTag(string key, string value, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(key, nameof(key));
            Argument.AssertNotNull(value, nameof(value));
            ...
            try
            {
                ...
                else
                {
                    ...
                    patch.Tags[key] = value;
                    ArmOperation<CloudExadataInfrastructureResource> result = Update(WaitUntil.Completed, patch, cancellationToken: cancellationToken);
                    return Response.FromValue(result.Value, result.GetRawResponse());
                }
            }
            catch (Exception e)
        ...
        public virtual async Task<Response<CloudExadataInfrastructureResource>> RemoveTagAsync(string key, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(key, nameof(key));
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="key"/> is null. </exception>
        public virtual Response<CloudExadataInfrastructureResource> RemoveTag(string key, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(key, nameof(key));
