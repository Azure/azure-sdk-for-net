...
namespace Azure.ResourceManager.OracleDatabase
{
    ...
    /// To get a <see cref="OracleSystemVersionCollection"/> instance call the GetOracleSystemVersions method from an instance of <see cref="SubscriptionResource"/>.
    /// </summary>
    public partial class OracleSystemVersionCollection : ArmCollection, IEnumerable<OracleSystemVersionResource>, IAsyncEnumerable<OracleSystemVersionResource>
    {
        ...
        internal OracleSystemVersionCollection(ArmClient client, ResourceIdentifier id, AzureLocation location) : base(client, id)
        {
            ...
            _systemVersionsRestClient = new SystemVersions(_systemVersionsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, oracleSystemVersionApiVersion ?? "2025-11-01-preview");
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string systemversionname, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                Response<OracleSystemVersionData> response = default;
                switch (result.Status)
                {
                    case 200:
                        response = Response.FromValue(OracleSystemVersionData.FromResponse(result), result);
                        break;
                    case 404:
                        response = Response.FromValue((OracleSystemVersionData)null, result);
                        break;
                    default:
