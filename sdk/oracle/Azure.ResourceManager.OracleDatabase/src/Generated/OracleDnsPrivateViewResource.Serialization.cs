...
namespace Azure.ResourceManager.OracleDatabase
{
    ...
    {
        private static IJsonModel<OracleDnsPrivateViewData> s_dataDeserializationInstance;

        private static IJsonModel<OracleDnsPrivateViewData> DataDeserializationInstance => s_dataDeserializationInstance ??= new OracleDnsPrivateViewData();
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        OracleDnsPrivateViewData IJsonModel<OracleDnsPrivateViewData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => DataDeserializationInstance.Create(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<OracleDnsPrivateViewData>.GetFormatFromOptions(ModelReaderWriterOptions options) => DataDeserializationInstance.GetFormatFromOptions(options);
    }
}
