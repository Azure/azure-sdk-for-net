...
namespace Azure.ResourceManager.OracleDatabase
{
    ...
    public partial class OracleSubscriptionData : ResourceData
    {
        ...
        internal OracleSubscriptionData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, ArmPlan plan, OracleSubscriptionProvisioningState? provisioningState, string saasSubscriptionId, string cloudAccountId, CloudAccountProvisioningState? cloudAccountState, string termUnit, string productCode, Intent? intent, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
            Plan = plan;
