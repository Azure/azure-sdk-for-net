...
namespace Azure.ResourceManager.OracleDatabase
{
    ...
    public partial class OracleDnsPrivateViewResource : ArmResource
    {
        ...
        internal OracleDnsPrivateViewResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _dnsPrivateViewsRestClient = new DnsPrivateViews(_dnsPrivateViewsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, oracleDnsPrivateViewApiVersion ?? "2025-11-01-preview");
