...
namespace Azure.ResourceManager.OracleDatabase
{
    ...
    public partial class OracleSubscriptionResource : ArmResource
    {
        ...
        internal OracleSubscriptionResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _oracleSubscriptionsRestClient = new OracleSubscriptions(_oracleSubscriptionsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, oracleSubscriptionApiVersion ?? "2026-06-01");
