...
{
    public partial class Sample_DbServerCollection
    {
        ...
        {
            // Generated from example definition: specification/oracle/resource-manager/Oracle.Database/preview/2023-09-01-preview/examples/dbServers_listByParent.json
            ...
            // get the collection of this DbServerResource
            DbServerCollection collection = cloudExadataInfrastructure.GetDbServers();

            // invoke the operation and iterate over the result
            await foreach (DbServerResource item in collection.GetAllAsync())
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                DbServerData resourceData = item.Data;
        ...
        public async Task Get_GetDbServerByParent()
        {
            ...
            DbServerResource result = await collection.GetAsync(dbserverocid);
        ...
        public async Task GetIfExists_GetDbServerByParent()
        {
            ...
            // invoke the operation
            string dbserverocid = "ocid1....aaaaaa";
            NullableResponse<DbServerResource> response = await collection.GetIfExistsAsync(dbserverocid);
            DbServerResource result = response.HasValue ? response.Value : null;
