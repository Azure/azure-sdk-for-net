...
{
    public partial class Sample_VirtualNetworkAddressResource
    {
        ...
        public async Task Get_GetVirtualNetworkAddress()
        {
            ...
            // this example assumes you already have this VirtualNetworkAddressResource created on azure
            // for more information of creating VirtualNetworkAddressResource, please refer to the document of VirtualNetworkAddressResource
            string subscriptionId = "00000000-0000-0000-0000-000000000000";
            string resourceGroupName = "rg000";
            string cloudvmclustername = "cluster1";
            string virtualnetworkaddressname = "hosname1";
            ResourceIdentifier virtualNetworkAddressResourceId = VirtualNetworkAddressResource.CreateResourceIdentifier(subscriptionId, resourceGroupName, cloudvmclustername, virtualnetworkaddressname);
            VirtualNetworkAddressResource virtualNetworkAddress = client.GetVirtualNetworkAddressResource(virtualNetworkAddressResourceId);

            // invoke the operation
            VirtualNetworkAddressResource result = await virtualNetworkAddress.GetAsync();
        ...
        {
            // Generated from example definition: specification/oracle/resource-manager/Oracle.Database/preview/2023-09-01-preview/examples/virtualNetworkAddresses_delete.json
            ...
            // invoke the operation
            await virtualNetworkAddress.DeleteAsync(WaitUntil.Completed);
