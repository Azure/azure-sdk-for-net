...
{
    public partial class Sample_DbSystemShapeCollection
    {
        ...
        public async Task GetAll_ListDbSystemShapesByLocation()
        {
            ...
            // get the collection of this DbSystemShapeResource
            AzureLocation location = new AzureLocation("eastus");
            DbSystemShapeCollection collection = subscriptionResource.GetDbSystemShapes(location);

            // invoke the operation and iterate over the result
            await foreach (DbSystemShapeResource item in collection.GetAllAsync())
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                DbSystemShapeData resourceData = item.Data;
        ...
        public async Task Get_GetADbSystemShapeByName()
        {
            ...
            DbSystemShapeResource result = await collection.GetAsync(dbsystemshapename);
        ...
        public async Task GetIfExists_GetADbSystemShapeByName()
        {
            ...
            // invoke the operation
            string dbsystemshapename = "EXADATA.X9M";
            NullableResponse<DbSystemShapeResource> response = await collection.GetIfExistsAsync(dbsystemshapename);
            DbSystemShapeResource result = response.HasValue ? response.Value : null;
