...
namespace Azure.ResourceManager.Oracle
{
    ...
    public partial class DbServerData : ResourceData
    {
        ...
        internal DbServerData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string ocid, string displayName, string compartmentId, string exadataInfrastructureId, string lifecycleDetails, int? cpuCoreCount, DbServerPatchingDetails dbServerPatchingDetails, int? maxMemoryInGbs, int? dbNodeStorageSizeInGbs, IReadOnlyList<string> vmClusterIds, IReadOnlyList<string> dbNodeIds, DbServerProvisioningState? provisioningState, int? maxCpuCount, IReadOnlyList<string> autonomousVmClusterIds, IReadOnlyList<string> autonomousVirtualMachineIds, int? maxDbNodeStorageInGbs, int? memorySizeInGbs, string shape, DateTimeOffset? timeCreated, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
            Ocid = ocid;
        ...
        public DbServerProvisioningState? ProvisioningState { get; }
