...
namespace Azure.ResourceManager.Oracle.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CloudVmClusterPatch>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<CloudVmClusterPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CloudVmClusterPatch)} does not support '{format}' format.");
            }
        ...
        internal static CloudVmClusterPatch DeserializeCloudVmClusterPatch(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new CloudVmClusterPatch(Optional.ToDictionary(tags), Optional.ToNullable(storageSizeInGbs), Optional.ToNullable(dataStorageSizeInTbs), Optional.ToNullable(dbNodeStorageSizeInGbs), Optional.ToNullable(memorySizeInGbs), Optional.ToNullable(cpuCoreCount), Optional.ToNullable(ocpuCount), Optional.ToList(sshPublicKeys), Optional.ToNullable(licenseModel), dataCollectionOptions.Value, displayName.Value, Optional.ToList(computeNodes), serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<CloudVmClusterPatch>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CloudVmClusterPatch)} does not support '{options.Format}' format.");
            }
        }
