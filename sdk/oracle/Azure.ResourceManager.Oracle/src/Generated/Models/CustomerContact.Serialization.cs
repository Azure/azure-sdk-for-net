...
namespace Azure.ResourceManager.Oracle.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CustomerContact>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<CustomerContact>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CustomerContact)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<CustomerContact>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CustomerContact)} does not support '{options.Format}' format.");
            }
        }
