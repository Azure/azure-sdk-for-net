...
namespace Azure.ResourceManager.Oracle.Models
{
    ...
    public partial class ExadataIormConfig
    {
        ...
        internal ExadataIormConfig(IReadOnlyList<DbIormConfig> dbPlans, string lifecycleDetails, IormLifecycleState? provisioningState, Objective? objective, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            DbPlans = dbPlans;
        ...
        public IormLifecycleState? ProvisioningState { get; }
