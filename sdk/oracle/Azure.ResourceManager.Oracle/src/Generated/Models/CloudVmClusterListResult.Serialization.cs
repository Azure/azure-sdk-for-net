...
namespace Azure.ResourceManager.Oracle.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CloudVmClusterListResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<CloudVmClusterListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CloudVmClusterListResult)} does not support '{format}' format.");
            }
        ...
        internal static CloudVmClusterListResult DeserializeCloudVmClusterListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("value"u8))
                {
                    ...
                    {
                        array.Add(CloudVmClusterData.DeserializeCloudVmClusterData(item));
                    }
                    value = array;
                    continue;
                }
            ...
            return new CloudVmClusterListResult(value, nextLink.Value, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<CloudVmClusterListResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CloudVmClusterListResult)} does not support '{options.Format}' format.");
            }
        }
