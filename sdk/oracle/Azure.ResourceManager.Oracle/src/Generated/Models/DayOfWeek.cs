...
namespace Azure.ResourceManager.Oracle.Models
{
    ...
    public partial class DayOfWeek
    {
        ...
        public DayOfWeek(DayOfWeekName name)
        {
            Name = name;
        }
        ...
        internal DayOfWeek(DayOfWeekName name, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            _serializedAdditionalRawData = serializedAdditionalRawData;
        }

        /// <summary> Initializes a new instance of <see cref="DayOfWeek"/> for deserialization. </summary>
        internal DayOfWeek()
        {
        }
