...
namespace Azure.ResourceManager.Oracle.Mocking
{
    ...
    public partial class MockableOracleResourceGroupResource : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="MockableOracleResourceGroupResource"/> class for mocking. </summary>
        protected MockableOracleResourceGroupResource()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MockableOracleResourceGroupResource"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MockableOracleResourceGroupResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
