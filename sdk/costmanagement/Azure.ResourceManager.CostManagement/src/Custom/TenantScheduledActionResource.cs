...
namespace Azure.ResourceManager.CostManagement
{
    ...
    public partial class TenantScheduledActionResource
    {
        ...
        /// <summary> Create or update a private scheduled action. </summary>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual async Task<ArmOperation<TenantScheduledActionResource>> UpdateAsync(WaitUntil waitUntil, ScheduledActionData data, string ifMatch, CancellationToken cancellationToken = default)
        {
