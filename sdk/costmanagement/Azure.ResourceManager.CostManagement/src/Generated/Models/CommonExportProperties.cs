...
namespace Azure.ResourceManager.CostManagement.Models
{
    ...
    public partial class CommonExportProperties
    {
        ...
        internal CommonExportProperties(ExportFormatType? format, ExportDeliveryInfo deliveryInfo, ExportDefinition definition, ExportExecutionListResult runHistory, bool? partitionData, DateTimeOffset? nextRunTimeEstimate, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Format = format;
            DeliveryInfo = deliveryInfo;
            Definition = definition;
