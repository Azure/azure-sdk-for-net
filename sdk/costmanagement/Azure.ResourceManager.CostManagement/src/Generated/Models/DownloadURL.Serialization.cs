...
{
    public partial class DownloadURL : IUtf8JsonSerializable, IJsonModel<DownloadURL>, IPersistableModel<DownloadURL>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ValidTill))
            {
                ...
                builder.AppendLine($" '{ValidTill.Value.ToString()}'");
            }

            if (Optional.IsDefined(DownloadUri))
            {
                builder.Append("  downloadUrl:");
                builder.AppendLine($" '{DownloadUri.AbsoluteUri}'");
            }
