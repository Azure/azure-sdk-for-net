...
namespace Azure.ResourceManager.CostManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DownloadURL>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DownloadURL>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DownloadURL>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DownloadURL>)} interface");
            }
        ...
        string IPersistableModel<DownloadURL>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
