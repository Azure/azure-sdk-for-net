...
{
    public partial class IncludedQuantityUtilizationSummary : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static IncludedQuantityUtilizationSummary DeserializeIncludedQuantityUtilizationSummary(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
