...
namespace Azure.ResourceManager.CostManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IncludedQuantityUtilizationSummary>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<IncludedQuantityUtilizationSummary>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<IncludedQuantityUtilizationSummary>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<IncludedQuantityUtilizationSummary>)} interface");
            }
        ...
        string IPersistableModel<IncludedQuantityUtilizationSummary>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
