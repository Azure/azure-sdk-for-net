...
namespace Azure.ResourceManager.CostManagement.Models
{
    ...
    public partial class GenerateCostDetailsReportContent
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="GenerateCostDetailsReportContent"/>. </summary>
        ...
        internal GenerateCostDetailsReportContent(CostDetailsMetricType? metric, CostDetailsTimePeriod timePeriod, string billingPeriod, string invoiceId, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Metric = metric;
