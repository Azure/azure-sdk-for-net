...
namespace Azure.ResourceManager.CostManagement.Models
{
    ...
    public partial class ExportDeliveryDestination
    {
        ...
        /// <summary> Initializes a new instance of ExportDeliveryDestination. </summary>
        /// <param name="destinationId"> The resource id of the storage account where exports will be delivered. This is not required if a sasToken and storageAccount are specified. </param>
        /// <param name="container"> The name of the container where exports will be uploaded. If the container does not exist it will be created. </param>
        ...
        internal ExportDeliveryDestination(ResourceIdentifier destinationId, string container, string rootFolderPath, string sasToken, string storageAccount)
        {
