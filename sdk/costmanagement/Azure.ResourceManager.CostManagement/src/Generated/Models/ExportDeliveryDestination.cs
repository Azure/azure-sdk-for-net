...
namespace Azure.ResourceManager.CostManagement.Models
{
    ...
    public partial class ExportDeliveryDestination
    {
        ...
        internal ExportDeliveryDestination(DestinationType? @type, ResourceIdentifier resourceId, string container, string rootFolderPath, string sasToken, string storageAccount, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Type = @type;
