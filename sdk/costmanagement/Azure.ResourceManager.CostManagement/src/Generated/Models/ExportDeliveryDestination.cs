...
namespace Azure.ResourceManager.CostManagement.Models
{
    ...
    public partial class ExportDeliveryDestination
    {
        ...
        internal ExportDeliveryDestination(ResourceIdentifier resourceId, string container, string rootFolderPath, string sasToken, string storageAccount, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
