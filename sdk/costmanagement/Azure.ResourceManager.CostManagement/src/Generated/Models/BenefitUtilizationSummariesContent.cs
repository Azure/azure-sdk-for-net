...
namespace Azure.ResourceManager.CostManagement.Models
{
    ...
    public partial class BenefitUtilizationSummariesContent
    {
        ...
        internal BenefitUtilizationSummariesContent(string billingAccountId, string billingProfileId, string benefitOrderId, string benefitId, BenefitRecommendationUsageGrain grain, DateTimeOffset startOn, DateTimeOffset endOn, BillingAccountBenefitKind? kind, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
