...
namespace Azure.ResourceManager.CostManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ForecastDatasetConfiguration>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ForecastDatasetConfiguration>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ForecastDatasetConfiguration>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<ForecastDatasetConfiguration>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
