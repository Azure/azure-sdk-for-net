...
{
    public partial class ScheduledActionData : IUtf8JsonSerializable, IJsonModel<ScheduledActionData>, IPersistableModel<ScheduledActionData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(FileDestination))
            {
                ...
                AppendChildObject(builder, FileDestination, options, 2);
            }
