...
namespace Azure.ResourceManager.CostManagement
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ScheduledActionData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ScheduledActionData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ScheduledActionData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ScheduledActionData>)} interface");
            }
        ...
        string IPersistableModel<ScheduledActionData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
