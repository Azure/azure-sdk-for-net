...
namespace Azure.ResourceManager.CostManagement
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CostManagementAlertData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CostManagementAlertData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CostManagementAlertData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CostManagementAlertData>)} interface");
            }
        ...
        string IPersistableModel<CostManagementAlertData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
