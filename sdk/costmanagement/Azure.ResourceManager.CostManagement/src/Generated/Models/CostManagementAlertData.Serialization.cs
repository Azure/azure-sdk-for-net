    ...
    public partial class CostManagementAlertData : IUtf8JsonSerializable, IJsonModel<CostManagementAlertData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(CostEntityId))
            {
                ...
                if (CostEntityId.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(CloseOn))
            {
                ...
                var formattedDateTimeString = TypeFormatters.ToString(CloseOn.Value, "o");
                builder.AppendLine($" '{formattedDateTimeString}'");
            }
            ...
            if (Optional.IsDefined(StatusModificationUserName))
            {
                ...
                if (StatusModificationUserName.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(StatusModifiedOn))
            {
                ...
                var formattedDateTimeString = TypeFormatters.ToString(StatusModifiedOn.Value, "o");
                builder.AppendLine($" '{formattedDateTimeString}'");
            }
