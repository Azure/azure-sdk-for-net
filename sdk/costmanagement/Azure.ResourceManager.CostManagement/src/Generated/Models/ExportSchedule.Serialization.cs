...
{
    public partial class ExportSchedule : IUtf8JsonSerializable, IJsonModel<ExportSchedule>, IPersistableModel<ExportSchedule>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(RecurrencePeriod))
            {
                builder.Append("  recurrencePeriod:");
                AppendChildObject(builder, RecurrencePeriod, options, 2);
            }
