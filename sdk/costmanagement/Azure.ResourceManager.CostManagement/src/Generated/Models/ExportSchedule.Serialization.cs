...
{
    public partial class ExportSchedule : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ExportSchedule DeserializeExportSchedule(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
