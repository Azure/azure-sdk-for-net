...
namespace Azure.ResourceManager.CostManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ReportConfigTimePeriod>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ReportConfigTimePeriod>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ReportConfigTimePeriod>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ReportConfigTimePeriod>)} interface");
            }
        ...
        string IPersistableModel<ReportConfigTimePeriod>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
