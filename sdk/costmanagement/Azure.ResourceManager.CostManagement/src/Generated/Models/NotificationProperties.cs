...
namespace Azure.ResourceManager.CostManagement.Models
{
    ...
    public partial class NotificationProperties
    {
        ...
        internal NotificationProperties(IList<string> to, string language, string message, string regionalFormat, string subject, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            To = to;
            Language = language;
            Message = message;
