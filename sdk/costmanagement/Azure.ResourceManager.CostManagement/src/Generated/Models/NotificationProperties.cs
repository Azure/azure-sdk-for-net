...
namespace Azure.ResourceManager.CostManagement.Models
{
    ...
    public partial class NotificationProperties
    {
        ...
        internal NotificationProperties(IList<string> to, string language, string message, string regionalFormat, string subject, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            To = to;
            Language = language;
            Message = message;
