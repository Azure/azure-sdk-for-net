...
namespace Azure.ResourceManager.CostManagement.Models
{
    ...
    public partial class CostDetailsTimePeriod
    {
        ...
        /// <summary> Initializes a new instance of <see cref="CostDetailsTimePeriod"/>. </summary>
        ...
        internal CostDetailsTimePeriod(string start, string end, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Start = start;
            End = end;
