...
namespace Azure.ResourceManager.CostManagement.Models
{
    ...
    public partial class Notification
    {
        ...
        internal Notification(bool enabled, BudgetNotificationOperatorType @operator, float threshold, Frequency? frequency, IList<string> contactEmails, IList<string> contactRoles, IList<string> contactGroups, ThresholdType? thresholdType, CultureCode? locale, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Enabled = enabled;
            Operator = @operator;
            Threshold = threshold;
