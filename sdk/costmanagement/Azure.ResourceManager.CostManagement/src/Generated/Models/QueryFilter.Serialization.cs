    ...
    public partial class QueryFilter : IUtf8JsonSerializable, IJsonModel<QueryFilter>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(And))
            {
                ...
                {
                    ((IJsonModel<QueryFilter>)item).Write(writer, options);
                }
            ...
            if (Optional.IsDefined(Dimensions))
            {
                ...
                ((IJsonModel<QueryComparisonExpression>)Dimensions).Write(writer, options);
            }
            if (Optional.IsDefined(Tags))
            {
                writer.WritePropertyName("tags"u8);
                ((IJsonModel<QueryComparisonExpression>)Tags).Write(writer, options);
            }
        ...
        internal static QueryFilter DeserializeQueryFilter(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("dimensions"u8))
                {
                    ...
                    dimensions = ModelSerializationExtensions.JsonDeserialize<QueryComparisonExpression>(property.Value);
                    continue;
                }
                if (property.NameEquals("tags"u8))
                {
                    ...
                    tags = ModelSerializationExtensions.JsonDeserialize<QueryComparisonExpression>(property.Value);
                    continue;
                }
                if (options.Format != "W")
                {
