...
namespace Azure.ResourceManager.CostManagement.Models
{
    ...
    public partial class QueryFilter : IJsonModel<QueryFilter>
    {
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual QueryFilter PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<QueryFilter>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<QueryFilter>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        QueryFilter IPersistableModel<QueryFilter>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(And))
            {
                ...
                foreach (QueryFilter item in And)
                {
            ...
            if (Optional.IsCollectionDefined(Or))
            {
                ...
                writer.WriteStartArray();
                foreach (QueryFilter item in Or)
                {
                    writer.WriteObjectValue(item, options);
                }
                writer.WriteEndArray();
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        QueryFilter IJsonModel<QueryFilter>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual QueryFilter JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<QueryFilter>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static QueryFilter DeserializeQueryFilter(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("dimensions"u8))
                {
                    ...
                    dimensions = QueryComparisonExpression.DeserializeQueryComparisonExpression(prop.Value, options);
                    continue;
                }
                if (prop.NameEquals("tags"u8))
                {
                    ...
                    tags = QueryComparisonExpression.DeserializeQueryComparisonExpression(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
            ...
            return new QueryFilter(@and ?? new ChangeTrackingList<QueryFilter>(), @or ?? new ChangeTrackingList<QueryFilter>(), dimensions, tags, additionalBinaryDataProperties);
        }
    }
}
