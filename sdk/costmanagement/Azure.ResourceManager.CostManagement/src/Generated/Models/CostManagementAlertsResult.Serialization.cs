...
namespace Azure.ResourceManager.CostManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CostManagementAlertsResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CostManagementAlertsResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CostManagementAlertsResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CostManagementAlertsResult>)} interface");
            }
        ...
        string IPersistableModel<CostManagementAlertsResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
