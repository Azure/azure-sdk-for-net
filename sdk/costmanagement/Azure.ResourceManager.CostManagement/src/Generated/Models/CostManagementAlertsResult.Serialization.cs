...
namespace Azure.ResourceManager.CostManagement.Models
{
    ...
    {
        internal static CostManagementAlertsResult DeserializeCostManagementAlertsResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
