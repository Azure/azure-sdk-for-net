...
namespace Azure.ResourceManager.CostManagement.Models
{
    ...
    internal partial class AlertProperties
    {
        ...
        internal AlertProperties(AlertPropertiesDefinition definition, string description, CostManagementAlertSource? source, AlertPropertiesDetails details, string costEntityId, CostManagementAlertStatus? status, DateTimeOffset? createdOn, DateTimeOffset? closeOn, DateTimeOffset? modifiedOn, string statusModificationUserName, DateTimeOffset? statusModifiedOn, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
