...
namespace Azure.ResourceManager.CostManagement.Models
{
    public partial class CostManagementNameAvailabilityResult
    {
        internal static CostManagementNameAvailabilityResult DeserializeCostManagementNameAvailabilityResult(JsonElement element)
        {
            ...
            Core.Optional<CostManagementUnavailabilityReason> reason = default;
            ...
            return new CostManagementNameAvailabilityResult(Core.Optional.ToNullable(nameAvailable), Core.Optional.ToNullable(reason), message.Value);
        }
    }
}
