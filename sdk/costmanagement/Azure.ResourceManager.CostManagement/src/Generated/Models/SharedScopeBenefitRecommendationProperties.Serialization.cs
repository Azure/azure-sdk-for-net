...
namespace Azure.ResourceManager.CostManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SharedScopeBenefitRecommendationProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SharedScopeBenefitRecommendationProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SharedScopeBenefitRecommendationProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SharedScopeBenefitRecommendationProperties>)} interface");
            }
        ...
        string IPersistableModel<SharedScopeBenefitRecommendationProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
