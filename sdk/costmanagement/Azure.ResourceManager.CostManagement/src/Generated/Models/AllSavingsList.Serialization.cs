...
namespace Azure.ResourceManager.CostManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AllSavingsList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AllSavingsList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AllSavingsList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AllSavingsList>)} interface");
            }
        ...
        string IPersistableModel<AllSavingsList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
