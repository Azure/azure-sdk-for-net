...
namespace Azure.ResourceManager.CostManagement.Models
{
    ...
    public partial class BenefitUtilizationSummariesOperationStatus
    {
        ...
        internal BenefitUtilizationSummariesOperationStatus(BenefitUtilizationSummariesContent input, OperationStatusType? status, AsyncOperationStatusProperties properties, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Input = input;
            Status = status;
