...
namespace Azure.ResourceManager.CostManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SavingsPlanUtilizationSummary>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SavingsPlanUtilizationSummary>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SavingsPlanUtilizationSummary>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SavingsPlanUtilizationSummary>)} interface");
            }
        ...
        string IPersistableModel<SavingsPlanUtilizationSummary>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
