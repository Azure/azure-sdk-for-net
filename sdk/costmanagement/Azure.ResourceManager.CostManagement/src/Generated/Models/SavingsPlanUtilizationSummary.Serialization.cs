...
namespace Azure.ResourceManager.CostManagement.Models
{
    public partial class SavingsPlanUtilizationSummary : IUtf8JsonSerializable, IModelJsonSerializable<SavingsPlanUtilizationSummary>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<SavingsPlanUtilizationSummary>(this, options.Format);
        ...
        internal static SavingsPlanUtilizationSummary DeserializeSavingsPlanUtilizationSummary(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new SavingsPlanUtilizationSummary(id, name, type, systemData.Value, kind, armSkuName.Value, benefitId.Value, benefitOrderId.Value, Optional.ToNullable(benefitType), Optional.ToNullable(usageDate), Optional.ToNullable(avgUtilizationPercentage), Optional.ToNullable(minUtilizationPercentage), Optional.ToNullable(maxUtilizationPercentage), serializedAdditionalRawData);
        }
