...
namespace Azure.ResourceManager.CostManagement.Models
{
    ...
    public partial class SavingsPlanUtilizationSummary : BenefitUtilizationSummary, IJsonModel<SavingsPlanUtilizationSummary>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<SavingsPlanUtilizationSummary>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<SavingsPlanUtilizationSummary>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        SavingsPlanUtilizationSummary IPersistableModel<SavingsPlanUtilizationSummary>.Create(BinaryData data, ModelReaderWriterOptions options) => (SavingsPlanUtilizationSummary)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        SavingsPlanUtilizationSummary IJsonModel<SavingsPlanUtilizationSummary>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (SavingsPlanUtilizationSummary)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static SavingsPlanUtilizationSummary DeserializeSavingsPlanUtilizationSummary(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = SavingsPlanUtilizationSummaryProperties.DeserializeSavingsPlanUtilizationSummaryProperties(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
