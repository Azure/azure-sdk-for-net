...
namespace Azure.ResourceManager.CostManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SingleScopeBenefitRecommendationProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SingleScopeBenefitRecommendationProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SingleScopeBenefitRecommendationProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SingleScopeBenefitRecommendationProperties>)} interface");
            }
        ...
        string IPersistableModel<SingleScopeBenefitRecommendationProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
