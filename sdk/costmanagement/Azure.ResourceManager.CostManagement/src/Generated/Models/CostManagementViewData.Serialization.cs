    ...
    public partial class CostManagementViewData : IUtf8JsonSerializable, IJsonModel<CostManagementViewData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(DateRange))
            {
                ...
                if (DateRange.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(Chart))
            {
                ...
                builder.AppendLine($" '{Chart.Value.ToString()}'");
            }

            if (Optional.IsDefined(Accumulated))
            {
                builder.Append("    accumulated:");
                builder.AppendLine($" '{Accumulated.Value.ToString()}'");
            }

            if (Optional.IsDefined(Metric))
            {
                builder.Append("    metric:");
                builder.AppendLine($" '{Metric.Value.ToString()}'");
            }
            ...
            {
                builder.Append("      type:");
                builder.AppendLine($" '{TypePropertiesQueryType.Value.ToString()}'");
            }

            if (Optional.IsDefined(Timeframe))
            {
                builder.Append("      timeframe:");
                builder.AppendLine($" '{Timeframe.Value.ToString()}'");
            }
