...
{
    public partial class CostManagementViewData : IUtf8JsonSerializable, IModelJsonSerializable<CostManagementViewData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IModelJsonSerializable<CostManagementViewData>)this).Serialize(writer, ModelSerializerOptions.DefaultWireOptions);

        void IModelJsonSerializable<CostManagementViewData>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<CostManagementViewData>(this, options.Format);
            ...
            if (Optional.IsCollectionDefined(Kpis))
            {
                ...
                foreach (var item in Kpis)
                {
                    ...
                    {
                        ((IModelJsonSerializable<ViewKpiProperties>)item).Serialize(writer, options);
                    }
                }
            ...
            if (Optional.IsCollectionDefined(Pivots))
            {
                ...
                foreach (var item in Pivots)
                {
                    ...
                    {
                        ((IModelJsonSerializable<ViewPivotProperties>)item).Serialize(writer, options);
                    }
                }
                writer.WriteEndArray();
            }
            ...
            if (Optional.IsDefined(TimePeriod))
            {
                ...
                {
                    ((IModelJsonSerializable<ReportConfigTimePeriod>)TimePeriod).Serialize(writer, options);
                }
            }
            if (Optional.IsDefined(DataSet))
            {
                ...
                {
                    ((IModelJsonSerializable<ReportConfigDataset>)DataSet).Serialize(writer, options);
                }
            }
        ...
        internal static CostManagementViewData DeserializeCostManagementViewData(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new CostManagementViewData(id, name, type, systemData.Value, displayName.Value, scope.Value, Optional.ToNullable(createdOn), Optional.ToNullable(modifiedOn), dateRange.Value, currency.Value, Optional.ToNullable(chart), Optional.ToNullable(accumulated), Optional.ToNullable(metric), Optional.ToList(kpis), Optional.ToList(pivots), Optional.ToNullable(type0), Optional.ToNullable(timeframe), timePeriod.Value, dataSet.Value, Optional.ToNullable(includeMonetaryCommitment), Optional.ToNullable(eTag), rawData);
        }

        CostManagementViewData IModelJsonSerializable<CostManagementViewData>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<CostManagementViewData>(this, options.Format);

            using var doc = JsonDocument.ParseValue(ref reader);
            return DeserializeCostManagementViewData(doc.RootElement, options);
        }

        BinaryData IModelSerializable<CostManagementViewData>.Serialize(ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<CostManagementViewData>(this, options.Format);
        ...
        CostManagementViewData IModelSerializable<CostManagementViewData>.Deserialize(BinaryData data, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<CostManagementViewData>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="CostManagementViewData"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="CostManagementViewData"/> to convert. </param>
        public static implicit operator RequestContent(CostManagementViewData model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="CostManagementViewData"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator CostManagementViewData(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeCostManagementViewData(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
