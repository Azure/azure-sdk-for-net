    ...
    public partial class ExportDataset : IUtf8JsonSerializable, IJsonModel<ExportDataset>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Configuration))
            {
                ...
                ((IJsonModel<ExportDatasetConfiguration>)Configuration).Write(writer, options);
            }
        ...
        internal static ExportDataset DeserializeExportDataset(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("configuration"u8))
                {
                    ...
                    configuration = ModelSerializationExtensions.JsonDeserialize<ExportDatasetConfiguration>(property.Value);
                    continue;
                }
                if (options.Format != "W")
                {
