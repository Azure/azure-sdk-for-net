...
namespace Azure.ResourceManager.CostManagement.Models
{
    ...
    public partial class ForecastFilter
    {
        ...
        internal ForecastFilter(IList<ForecastFilter> @and, IList<ForecastFilter> @or, ForecastComparisonExpression dimensions, ForecastComparisonExpression tags, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            And = @and;
            Or = @or;
