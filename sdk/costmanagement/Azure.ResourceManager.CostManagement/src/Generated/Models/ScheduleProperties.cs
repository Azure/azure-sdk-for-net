...
namespace Azure.ResourceManager.CostManagement.Models
{
    ...
    public partial class ScheduleProperties
    {
        ...
        internal ScheduleProperties(ScheduleFrequency frequency, int? hourOfDay, IList<ScheduledActionDaysOfWeek> daysOfWeek, IList<ScheduledActionWeeksOfMonth> weeksOfMonth, int? dayOfMonth, DateTimeOffset startOn, DateTimeOffset endOn, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Frequency = frequency;
            HourOfDay = hourOfDay;
