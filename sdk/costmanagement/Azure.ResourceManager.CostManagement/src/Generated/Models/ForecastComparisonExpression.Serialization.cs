...
namespace Azure.ResourceManager.CostManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ForecastComparisonExpression>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ForecastComparisonExpression>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ForecastComparisonExpression>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ForecastComparisonExpression>)} interface");
            }
        ...
        string IPersistableModel<ForecastComparisonExpression>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
