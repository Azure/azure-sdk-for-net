...
namespace Azure.ResourceManager.CostManagement.Models
{
    ...
    public partial class OperationStatus
    {
        ...
        internal OperationStatus(OperationStatusType? status, ReservationReportSchema? reportUri, DateTimeOffset? validUntil, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Status = status;
            ReportUri = reportUri;
