...
namespace Azure.ResourceManager.CostManagement.Models
{
    ...
    public partial class ReportConfigComparisonExpression
    {
        ...
        internal ReportConfigComparisonExpression(string name, ComparisonOperatorType @operator, IList<string> values, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Operator = @operator;
            Values = values;
