...
namespace Azure.ResourceManager.CostManagement.Models
{
    ...
    public partial class ExportSchedule
    {
        ...
        internal ExportSchedule(ExportScheduleStatusType? status, ExportScheduleRecurrenceType? recurrence, ExportRecurrencePeriod recurrencePeriod, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Status = status;
