...
namespace Azure.ResourceManager.CostManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BenefitUtilizationSummariesContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<BenefitUtilizationSummariesContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BenefitUtilizationSummariesContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<BenefitUtilizationSummariesContent>)} interface");
            }
        ...
        string IPersistableModel<BenefitUtilizationSummariesContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
