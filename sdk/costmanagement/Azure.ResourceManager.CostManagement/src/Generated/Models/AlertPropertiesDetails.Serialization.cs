...
{
    public partial class AlertPropertiesDetails : IUtf8JsonSerializable, IModelJsonSerializable<AlertPropertiesDetails>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IModelJsonSerializable<AlertPropertiesDetails>)this).Serialize(writer, ModelSerializerOptions.DefaultWireOptions);

        void IModelJsonSerializable<AlertPropertiesDetails>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<AlertPropertiesDetails>(this, options.Format);
        ...
        internal static AlertPropertiesDetails DeserializeAlertPropertiesDetails(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new AlertPropertiesDetails(Optional.ToNullable(timeGrainType), periodStartDate.Value, triggeredBy.Value, Optional.ToList(resourceGroupFilter), Optional.ToList(resourceFilter), Optional.ToList(meterFilter), tagFilter.Value, Optional.ToNullable(threshold), Optional.ToNullable(@operator), Optional.ToNullable(amount), unit.Value, Optional.ToNullable(currentSpend), Optional.ToList(contactEmails), Optional.ToList(contactGroups), Optional.ToList(contactRoles), overridingAlert.Value, departmentName.Value, companyName.Value, enrollmentNumber.Value, enrollmentStartDate.Value, enrollmentEndDate.Value, Optional.ToNullable(invoicingThreshold), rawData);
        }

        AlertPropertiesDetails IModelJsonSerializable<AlertPropertiesDetails>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<AlertPropertiesDetails>(this, options.Format);

            using var doc = JsonDocument.ParseValue(ref reader);
            return DeserializeAlertPropertiesDetails(doc.RootElement, options);
        }

        BinaryData IModelSerializable<AlertPropertiesDetails>.Serialize(ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<AlertPropertiesDetails>(this, options.Format);
        ...
        AlertPropertiesDetails IModelSerializable<AlertPropertiesDetails>.Deserialize(BinaryData data, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<AlertPropertiesDetails>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="AlertPropertiesDetails"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="AlertPropertiesDetails"/> to convert. </param>
        public static implicit operator RequestContent(AlertPropertiesDetails model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="AlertPropertiesDetails"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator AlertPropertiesDetails(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeAlertPropertiesDetails(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
