...
namespace Azure.ResourceManager.CostManagement.Models
{
    ...
    public partial class ForecastComparisonExpression
    {
        ...
        internal ForecastComparisonExpression(string name, ForecastOperatorType @operator, IList<string> values, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Name = name;
            Operator = @operator;
            Values = values;
