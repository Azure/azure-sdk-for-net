...
namespace Azure.ResourceManager.CostManagement.Models
{
    ...
    public partial class ForecastComparisonExpression
    {
        ...
        internal ForecastComparisonExpression(string name, ForecastOperatorType @operator, IList<string> values, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Operator = @operator;
            Values = values;
