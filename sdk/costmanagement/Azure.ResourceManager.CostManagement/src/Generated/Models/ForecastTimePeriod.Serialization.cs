...
namespace Azure.ResourceManager.CostManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ForecastTimePeriod>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ForecastTimePeriod>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ForecastTimePeriod>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ForecastTimePeriod>)} interface");
            }
        ...
        string IPersistableModel<ForecastTimePeriod>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
