...
namespace Azure.ResourceManager.CostManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AsyncOperationStatusProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AsyncOperationStatusProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AsyncOperationStatusProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AsyncOperationStatusProperties>)} interface");
            }
        ...
        string IPersistableModel<AsyncOperationStatusProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
