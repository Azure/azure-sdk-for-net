...
{
    public partial class AsyncOperationStatusProperties : IUtf8JsonSerializable, IJsonModel<AsyncOperationStatusProperties>, IPersistableModel<AsyncOperationStatusProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ReportUri))
            {
                ...
                builder.AppendLine($" '{ReportUri.ToString()}'");
            }

            if (Optional.IsDefined(SecondaryReportUri))
            {
                builder.Append("  secondaryReportUrl:");
                builder.AppendLine($" '{SecondaryReportUri.ToString()}'");
            }

            if (Optional.IsDefined(ValidUntil))
            {
                builder.Append("  validUntil:");
                builder.AppendLine($" '{ValidUntil.Value.ToString()}'");
            }
