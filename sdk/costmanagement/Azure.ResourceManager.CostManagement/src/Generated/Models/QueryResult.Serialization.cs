...
namespace Azure.ResourceManager.CostManagement.Models
{
    ...
    public partial class QueryResult : ResourceData, IJsonModel<QueryResult>
    {
        ...
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        QueryResult IPersistableModel<QueryResult>.Create(BinaryData data, ModelReaderWriterOptions options) => (QueryResult)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        QueryResult IJsonModel<QueryResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (QueryResult)JsonModelCreateCore(ref reader, options);
