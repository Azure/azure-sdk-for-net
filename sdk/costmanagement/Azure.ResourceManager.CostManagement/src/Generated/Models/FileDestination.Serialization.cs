...
{
    internal partial class FileDestination : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static FileDestination DeserializeFileDestination(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
