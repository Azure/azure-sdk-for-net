...
{
    public partial class ExportRun : IUtf8JsonSerializable, IJsonModel<ExportRun>, IPersistableModel<ExportRun>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ExecutionType))
            {
                ...
                builder.AppendLine($" '{ExecutionType.ToString()}'");
            }
            ...
            if (Optional.IsDefined(SubmittedBy))
            {
                builder.Append("  submittedBy:");
                builder.AppendLine($" '{SubmittedBy}'");
            }
            ...
            if (Optional.IsDefined(ProcessingStartOn))
            {
                builder.Append("  processingStartTime:");
                builder.AppendLine($" '{ProcessingStartOn.Value.ToString()}'");
            }
            ...
            if (Optional.IsDefined(RunSettings))
            {
                builder.Append("  runSettings:");
                AppendChildObject(builder, RunSettings, options, 2);
            }
