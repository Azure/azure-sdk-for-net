...
{
    public partial class ExportRun : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ExportRun DeserializeExportRun(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
