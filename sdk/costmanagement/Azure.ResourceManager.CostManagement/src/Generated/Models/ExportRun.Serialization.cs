    ...
    public partial class ExportRun : IUtf8JsonSerializable, IJsonModel<ExportRun>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SubmittedBy))
            {
                ...
                if (SubmittedBy.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(ProcessingStartOn))
            {
                ...
                var formattedDateTimeString = TypeFormatters.ToString(ProcessingStartOn.Value, "o");
                builder.AppendLine($" '{formattedDateTimeString}'");
            }
            ...
            if (Optional.IsDefined(RunSettings))
            {
                ...
                AppendChildObject(builder, RunSettings, options, 4, false);
            }
