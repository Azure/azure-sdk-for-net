...
namespace Azure.ResourceManager.CostManagement.Models
{
    ...
    public partial class ForecastFilter : IJsonModel<ForecastFilter>
    {
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual ForecastFilter PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<ForecastFilter>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ForecastFilter>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        ForecastFilter IPersistableModel<ForecastFilter>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(And))
            {
                ...
                foreach (ForecastFilter item in And)
                {
            ...
            if (Optional.IsCollectionDefined(Or))
            {
                ...
                writer.WriteStartArray();
                foreach (ForecastFilter item in Or)
                {
                    writer.WriteObjectValue(item, options);
                }
                writer.WriteEndArray();
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ForecastFilter IJsonModel<ForecastFilter>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual ForecastFilter JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<ForecastFilter>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static ForecastFilter DeserializeForecastFilter(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("dimensions"u8))
                {
                    ...
                    dimensions = ForecastComparisonExpression.DeserializeForecastComparisonExpression(prop.Value, options);
                    continue;
                }
                if (prop.NameEquals("tags"u8))
                {
                    ...
                    tags = ForecastComparisonExpression.DeserializeForecastComparisonExpression(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
            ...
            return new ForecastFilter(@and ?? new ChangeTrackingList<ForecastFilter>(), @or ?? new ChangeTrackingList<ForecastFilter>(), dimensions, tags, additionalBinaryDataProperties);
        }
    }
}
