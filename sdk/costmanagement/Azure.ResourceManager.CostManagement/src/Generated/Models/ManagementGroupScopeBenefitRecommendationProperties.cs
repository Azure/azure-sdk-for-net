...
{
    /// <summary> The properties of the benefit recommendation when scope is 'ManagementGroup'. </summary>
    public partial class ManagementGroupScopeBenefitRecommendationProperties : BenefitRecommendationProperties
    {
        /// <summary> Initializes a new instance of <see cref="ManagementGroupScopeBenefitRecommendationProperties"/>. </summary>
        public ManagementGroupScopeBenefitRecommendationProperties() : base(BenefitRecommendationScope.ManagementGroup)
        {
        }
