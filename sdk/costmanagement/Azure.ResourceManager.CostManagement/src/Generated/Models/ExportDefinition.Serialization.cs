...
{
    public partial class ExportDefinition : IUtf8JsonSerializable, IJsonModel<ExportDefinition>, IPersistableModel<ExportDefinition>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ExportType))
            {
                builder.Append("  type:");
                builder.AppendLine($" '{ExportType.ToString()}'");
            }
