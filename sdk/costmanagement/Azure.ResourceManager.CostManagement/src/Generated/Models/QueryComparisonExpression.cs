...
namespace Azure.ResourceManager.CostManagement.Models
{
    ...
    public partial class QueryComparisonExpression
    {
        ...
        internal QueryComparisonExpression(string name, QueryOperatorType @operator, IList<string> values, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Operator = @operator;
            Values = values;
