...
namespace Azure.ResourceManager.CostManagement.Models
{
    ...
    public partial class QueryComparisonExpression
    {
        ...
        internal QueryComparisonExpression(string name, QueryOperatorType @operator, IList<string> values, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Name = name;
            Operator = @operator;
            Values = values;
