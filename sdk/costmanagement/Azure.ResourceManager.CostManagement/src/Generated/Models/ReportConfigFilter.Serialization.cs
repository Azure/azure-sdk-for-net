...
namespace Azure.ResourceManager.CostManagement.Models
{
    public partial class ReportConfigFilter : IUtf8JsonSerializable, IModelJsonSerializable<ReportConfigFilter>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<ReportConfigFilter>(this, options.Format);
            ...
            if (Optional.IsCollectionDefined(And))
            {
                ...
                foreach (var item in And)
                {
                    ...
                    {
                        ((IModelJsonSerializable<ReportConfigFilter>)item).Serialize(writer, options);
                    }
                }
            ...
            if (Optional.IsDefined(Dimensions))
            {
                ...
                {
                    ((IModelJsonSerializable<ReportConfigComparisonExpression>)Dimensions).Serialize(writer, options);
                }
            }
            if (Optional.IsDefined(Tags))
            {
                ...
                {
                    ((IModelJsonSerializable<ReportConfigComparisonExpression>)Tags).Serialize(writer, options);
                }
            }
        ...
        /// <summary> Converts a <see cref="ReportConfigFilter"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="ReportConfigFilter"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="ReportConfigFilter"/>. </summary>
