...
namespace Azure.ResourceManager.CostManagement.Models
{
    ...
    public partial class BudgetComparisonExpression
    {
        ...
        internal BudgetComparisonExpression(string name, BudgetOperatorType @operator, IList<string> values, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Name = name;
            Operator = @operator;
            Values = values;
