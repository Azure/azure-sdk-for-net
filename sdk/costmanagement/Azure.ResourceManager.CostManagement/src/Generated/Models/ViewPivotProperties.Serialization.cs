...
namespace Azure.ResourceManager.CostManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ViewPivotProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ViewPivotProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ViewPivotProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<ViewPivotProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
