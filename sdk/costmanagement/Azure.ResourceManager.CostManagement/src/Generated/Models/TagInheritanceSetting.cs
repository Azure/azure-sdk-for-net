...
namespace Azure.ResourceManager.CostManagement.Models
{
    ...
    public partial class TagInheritanceSetting : CostManagementSettingData
    {
        ...
        internal TagInheritanceSetting(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, SettingsKind kind, IDictionary<string, BinaryData> additionalBinaryDataProperties, TagInheritanceProperties properties) : base(id, name, resourceType, systemData, kind, additionalBinaryDataProperties)
        {
        ...
        public bool? TagInheritancePreferContainerTags
        {
            get
            {
