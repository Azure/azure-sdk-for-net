...
{
    internal partial class CostManagementDimensionsListResult : IUtf8JsonSerializable, IJsonModel<CostManagementDimensionsListResult>, IPersistableModel<CostManagementDimensionsListResult>
    {
        ...
        void IJsonModel<CostManagementDimensionsListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CostManagementDimensionsListResult)} does not support '{format}' format.");
            }
