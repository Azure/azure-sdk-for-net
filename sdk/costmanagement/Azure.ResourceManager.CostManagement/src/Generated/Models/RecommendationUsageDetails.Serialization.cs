...
{
    public partial class RecommendationUsageDetails : IUtf8JsonSerializable, IJsonModel<RecommendationUsageDetails>, IPersistableModel<RecommendationUsageDetails>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(UsageGrain))
            {
                ...
                builder.AppendLine($" '{UsageGrain.ToString()}'");
            }
