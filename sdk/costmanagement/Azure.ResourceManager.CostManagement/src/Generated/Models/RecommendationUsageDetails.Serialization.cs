...
namespace Azure.ResourceManager.CostManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RecommendationUsageDetails>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RecommendationUsageDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RecommendationUsageDetails>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RecommendationUsageDetails>)} interface");
            }
        ...
        string IPersistableModel<RecommendationUsageDetails>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
