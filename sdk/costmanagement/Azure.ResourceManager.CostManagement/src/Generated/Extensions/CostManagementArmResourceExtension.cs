...
namespace Azure.ResourceManager.CostManagement.Testing
{
    ...
    public partial class CostManagementArmResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="CostManagementArmResourceExtension"/> class for mocking. </summary>
        protected CostManagementArmResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="CostManagementArmResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal CostManagementArmResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<BenefitRecommendationModel> GetBenefitRecommendationsAsync(string filter = null, string orderby = null, string expand = null, CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, BenefitRecommendationModel.DeserializeBenefitRecommendationModel, BenefitRecommendationsClientDiagnostics, Pipeline, "CostManagementArmResourceExtension.GetBenefitRecommendations", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<BenefitRecommendationModel> GetBenefitRecommendations(string filter = null, string orderby = null, string expand = null, CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => BenefitRecommendationsRestClient.CreateListRequest(Id, filter, orderby, expand);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => BenefitRecommendationsRestClient.CreateListNextPageRequest(nextLink, Id, filter, orderby, expand);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, BenefitRecommendationModel.DeserializeBenefitRecommendationModel, BenefitRecommendationsClientDiagnostics, Pipeline, "CostManagementArmResourceExtension.GetBenefitRecommendations", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual async Task<Response<ForecastResult>> UsageForecastAsync(ForecastDefinition forecastDefinition, string filter = null, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = ForecastClientDiagnostics.CreateScope("CostManagementArmResourceExtension.UsageForecast");
            scope.Start();
            try
            {
        ...
        public virtual AsyncPageable<CostManagementDimension> GetDimensionsAsync(string filter = null, string expand = null, string skiptoken = null, int? top = null, CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, null, CostManagementDimension.DeserializeCostManagementDimension, DimensionsClientDiagnostics, Pipeline, "CostManagementArmResourceExtension.GetDimensions", "value", null, cancellationToken);
        }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => DimensionsRestClient.CreateListRequest(Id, filter, expand, skiptoken, top);
            return PageableHelpers.CreatePageable(FirstPageRequest, null, CostManagementDimension.DeserializeCostManagementDimension, DimensionsClientDiagnostics, Pipeline, "CostManagementArmResourceExtension.GetDimensions", "value", null, cancellationToken);
        }
        ...
        public virtual async Task<Response<QueryResult>> UsageQueryAsync(QueryDefinition queryDefinition, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = QueryClientDiagnostics.CreateScope("CostManagementArmResourceExtension.UsageQuery");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response<CheckNameAvailabilityResponse>> CheckNameAvailabilityByScopeScheduledActionAsync(CheckNameAvailabilityRequest checkNameAvailabilityRequest, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = ScheduledActionsClientDiagnostics.CreateScope("CostManagementArmResourceExtension.CheckNameAvailabilityByScopeScheduledAction");
            scope.Start();
            try
            {
