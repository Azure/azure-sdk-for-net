...
namespace Azure.ResourceManager.CostManagement.Mocking
{
    ...
    public partial class CostManagementArmClientMockingExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="CostManagementArmClientMockingExtension"/> class for mocking. </summary>
        protected CostManagementArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="CostManagementArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal CostManagementArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal CostManagementArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
        ...
        public virtual AsyncPageable<BenefitRecommendationModel> GetBenefitRecommendationsAsync(ResourceIdentifier scope, string filter = null, string orderby = null, string expand = null, CancellationToken cancellationToken = default)
        {
            ...
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, BenefitRecommendationModel.DeserializeBenefitRecommendationModel, BenefitRecommendationsClientDiagnostics, Pipeline, "CostManagementArmClientMockingExtension.GetBenefitRecommendations", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<BenefitRecommendationModel> GetBenefitRecommendations(ResourceIdentifier scope, string filter = null, string orderby = null, string expand = null, CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => BenefitRecommendationsRestClient.CreateListRequest(scope, filter, orderby, expand);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => BenefitRecommendationsRestClient.CreateListNextPageRequest(nextLink, scope, filter, orderby, expand);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, BenefitRecommendationModel.DeserializeBenefitRecommendationModel, BenefitRecommendationsClientDiagnostics, Pipeline, "CostManagementArmClientMockingExtension.GetBenefitRecommendations", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual async Task<Response<ForecastResult>> UsageForecastAsync(ResourceIdentifier scope, ForecastDefinition forecastDefinition, string filter = null, CancellationToken cancellationToken = default)
        {
            ...
            using var scope0 = ForecastClientDiagnostics.CreateScope("CostManagementArmClientMockingExtension.UsageForecast");
            scope0.Start();
            try
            {
        ...
        public virtual AsyncPageable<CostManagementDimension> GetDimensionsAsync(ResourceIdentifier scope, string filter = null, string expand = null, string skiptoken = null, int? top = null, CancellationToken cancellationToken = default)
        {
            ...
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, null, CostManagementDimension.DeserializeCostManagementDimension, DimensionsClientDiagnostics, Pipeline, "CostManagementArmClientMockingExtension.GetDimensions", "value", null, cancellationToken);
        }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => DimensionsRestClient.CreateListRequest(scope, filter, expand, skiptoken, top);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, null, CostManagementDimension.DeserializeCostManagementDimension, DimensionsClientDiagnostics, Pipeline, "CostManagementArmClientMockingExtension.GetDimensions", "value", null, cancellationToken);
        }
        ...
        public virtual async Task<Response<QueryResult>> UsageQueryAsync(ResourceIdentifier scope, QueryDefinition queryDefinition, CancellationToken cancellationToken = default)
        {
            ...
            using var scope0 = QueryClientDiagnostics.CreateScope("CostManagementArmClientMockingExtension.UsageQuery");
            scope0.Start();
            try
            {
        ...
        public virtual async Task<Response<CostManagementNameAvailabilityResult>> CheckCostManagementNameAvailabilityByScopeScheduledActionAsync(ResourceIdentifier scope, CostManagementNameAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            ...
            using var scope0 = ScheduledActionsClientDiagnostics.CreateScope("CostManagementArmClientMockingExtension.CheckCostManagementNameAvailabilityByScopeScheduledAction");
            scope0.Start();
            try
            {
