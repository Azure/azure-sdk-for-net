...
namespace Azure.ResourceManager.CostManagement.Models
{
    ...
    public static partial class ArmCostManagementModelFactory
    {
        ...
        {
            return new BenefitRecommendationModel(id, name, resourceType, systemData, properties, kind, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new UnknownBenefitRecommendationProperties(firstConsumptionOn, lastConsumptionOn, lookBackPeriod, totalHours, usage, armSkuName, term, commitmentGranularity, currencyCode, costWithoutBenefit, recommendationDetails, allRecommendationDetails, scope, new Dictionary<string, BinaryData>());
        }
        ...
        public static RecommendationUsageDetails RecommendationUsageDetails(BenefitRecommendationUsageGrain? usageGrain = null, IEnumerable<decimal> charges = null)
        {
            ...
            return new RecommendationUsageDetails(usageGrain, charges?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AllSavingsBenefitDetails(overageCost, benefitCost, totalCost, savingsAmount, savingsPercentage, coveragePercentage, commitmentAmount, averageUtilizationPercentage, wastageCost, new Dictionary<string, BinaryData>());
        }
        ...
        public static AllSavingsList AllSavingsList(IEnumerable<AllSavingsBenefitDetails> value = null, Uri nextLink = null)
        {
            ...
            return new AllSavingsList(value?.ToList(), nextLink, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ExportRunErrorDetails(code, message, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new BenefitUtilizationSummary(id, name, resourceType, systemData, kind, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new BenefitUtilizationSummariesOperationStatus(input, status, properties, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AsyncOperationStatusProperties(reportUri, secondaryReportUri, validUntil, new Dictionary<string, BinaryData>());
        }
        ...
        public static CostManagementExportData CostManagementExportData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, ExportFormatType? format = null, ExportDeliveryDestination deliveryInfoDestination = null, ExportDefinition definition = null, IEnumerable<ExportRun> runHistoryValue = null, bool? partitionData = null, DateTimeOffset? nextRunTimeEstimate = null, ExportSchedule schedule = null, ETag? eTag = null)
        {
            ...
            return new CostManagementExportData(id, name, resourceType, systemData, format, deliveryInfoDestination != null ? new ExportDeliveryInfo(deliveryInfoDestination, new Dictionary<string, BinaryData>()) : null, definition, runHistoryValue != null ? new ExportExecutionListResult(runHistoryValue?.ToList(), new Dictionary<string, BinaryData>()) : null, partitionData, nextRunTimeEstimate, schedule, eTag, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ExportRun(id, name, resourceType, systemData, executionType, status, submittedBy, submittedOn, processingStartOn, processingEndOn, fileName, runSettings, error, eTag, new Dictionary<string, BinaryData>());
        }
        ...
        public static CostManagementViewData CostManagementViewData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string displayName = null, ResourceIdentifier scope = null, DateTimeOffset? createdOn = null, DateTimeOffset? modifiedOn = null, string dateRange = null, string currency = null, ViewChartType? chart = null, AccumulatedType? accumulated = null, ViewMetricType? metric = null, IEnumerable<ViewKpiProperties> kpis = null, IEnumerable<ViewPivotProperties> pivots = null, ViewReportType? typePropertiesQueryType = null, ReportTimeframeType? timeframe = null, ReportConfigTimePeriod timePeriod = null, ReportConfigDataset dataSet = null, bool? includeMonetaryCommitment = null, ETag? eTag = null)
        {
            ...
            return new CostManagementViewData(id, name, resourceType, systemData, displayName, scope, createdOn, modifiedOn, dateRange, currency, chart, accumulated, metric, kpis?.ToList(), pivots?.ToList(), typePropertiesQueryType, timeframe, timePeriod, dataSet, includeMonetaryCommitment, eTag, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new CostManagementAlertData(id, name, resourceType, systemData, definition, description, source, details, costEntityId, status, createdOn, closeOn, modifiedOn, statusModificationUserName, statusModifiedOn, eTag, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ForecastDefinition(forecastType, timeframe, timePeriod, dataset, includeActualCost, includeFreshPartialCost, new Dictionary<string, BinaryData>());
        }
        ...
        public static ForecastResult ForecastResult(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string nextLink = null, IEnumerable<ForecastColumn> columns = null, IEnumerable<IList<BinaryData>> rows = null, AzureLocation? location = null, string sku = null, ETag? eTag = null, IReadOnlyDictionary<string, string> tags = null)
        {
            ...
            return new ForecastResult(id, name, resourceType, systemData, nextLink, columns?.ToList(), rows?.ToList(), location, sku, eTag, tags, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ForecastColumn(name, forecastColumnType, new Dictionary<string, BinaryData>());
        }
        ...
        public static CostManagementDimension CostManagementDimension(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string description = null, bool? isFilterEnabled = null, bool? isGroupingEnabled = null, IEnumerable<string> data = null, int? total = null, string category = null, DateTimeOffset? usageStart = null, DateTimeOffset? usageEnd = null, string nextLink = null, AzureLocation? location = null, string sku = null, ETag? eTag = null, IReadOnlyDictionary<string, string> tags = null)
        {
            ...
            return new CostManagementDimension(id, name, resourceType, systemData, description, isFilterEnabled, isGroupingEnabled, data?.ToList(), total, category, usageStart, usageEnd, nextLink, location, sku, eTag, tags, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new QueryDefinition(exportType, timeframe, timePeriod, dataset, new Dictionary<string, BinaryData>());
        }
        ...
        public static QueryResult QueryResult(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string nextLink = null, IEnumerable<QueryColumn> columns = null, IEnumerable<IList<BinaryData>> rows = null, AzureLocation? location = null, string sku = null, ETag? eTag = null, IReadOnlyDictionary<string, string> tags = null)
        {
            ...
            return new QueryResult(id, name, resourceType, systemData, nextLink, columns?.ToList(), rows?.ToList(), location, sku, eTag, tags, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new QueryColumn(name, queryColumnType, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new OperationStatus(status, reportUri, validUntil, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DownloadURL(expiryOn, validTill, downloadUri, new Dictionary<string, BinaryData>());
        }
        ...
        public static ScheduledActionData ScheduledActionData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string displayName = null, IEnumerable<ScheduledActionFileFormat> fileFormats = null, NotificationProperties notification = null, string notificationEmail = null, ScheduleProperties schedule = null, ResourceIdentifier scope = null, ScheduledActionStatus? status = null, ResourceIdentifier viewId = null, ETag? eTag = null, ScheduledActionKind? kind = null)
        {
            ...
            return new ScheduledActionData(id, name, resourceType, systemData, displayName, fileFormats != null ? new FileDestination(fileFormats?.ToList(), new Dictionary<string, BinaryData>()) : null, notification, notificationEmail, schedule, scope, status, viewId, eTag, kind, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new CostManagementNameAvailabilityResult(nameAvailable, reason, message, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new IncludedQuantityUtilizationSummary(id, name, resourceType, systemData, BillingAccountBenefitKind.IncludedQuantity, new Dictionary<string, BinaryData>(), armSkuName, benefitId, benefitOrderId, benefitType, usageOn, utilizationPercentage);
        }
        ...
        {
            return new SavingsPlanUtilizationSummary(id, name, resourceType, systemData, BillingAccountBenefitKind.SavingsPlan, new Dictionary<string, BinaryData>(), armSkuName, benefitId, benefitOrderId, benefitType, usageOn, avgUtilizationPercentage, minUtilizationPercentage, maxUtilizationPercentage);
        }
    }
}
