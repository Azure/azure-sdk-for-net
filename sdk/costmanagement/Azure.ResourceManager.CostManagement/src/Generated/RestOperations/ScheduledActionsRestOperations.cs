...
namespace Azure.ResourceManager.CostManagement
{
    internal partial class ScheduledActionsRestOperations
    {
        ...
        internal HttpMessage CreateCreateOrUpdateRequest(string name, ScheduledActionData data, string ifMatch)
        {
            ...
            ((IJsonModel<ScheduledActionData>)data).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
        ...
        internal HttpMessage CreateCheckNameAvailabilityRequest(CostManagementNameAvailabilityContent content)
        {
            ...
            ((IJsonModel<CostManagementNameAvailabilityContent>)content).Write(content0.JsonWriter, ModelSerializationExtensions.WireOptions);
