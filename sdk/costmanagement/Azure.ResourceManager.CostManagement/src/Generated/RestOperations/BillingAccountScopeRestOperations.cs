...
namespace Azure.ResourceManager.CostManagement
{
    internal partial class BillingAccountScopeRestOperations
    {
        ...
        internal HttpMessage CreateGenerateBenefitUtilizationSummariesReportRequest(string billingAccountId, BenefitUtilizationSummariesRequest benefitUtilizationSummariesRequest)
        {
        ...
        public async Task<Response> GenerateBenefitUtilizationSummariesReportAsync(string billingAccountId, BenefitUtilizationSummariesRequest benefitUtilizationSummariesRequest, CancellationToken cancellationToken = default)
        {
            ...
            using var message = CreateGenerateBenefitUtilizationSummariesReportRequest(billingAccountId, benefitUtilizationSummariesRequest);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="billingAccountId"/> or <paramref name="benefitUtilizationSummariesRequest"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="billingAccountId"/> is an empty string, and was expected to be non-empty. </exception>
        public Response GenerateBenefitUtilizationSummariesReport(string billingAccountId, BenefitUtilizationSummariesRequest benefitUtilizationSummariesRequest, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(billingAccountId, nameof(billingAccountId));
            Argument.AssertNotNull(benefitUtilizationSummariesRequest, nameof(benefitUtilizationSummariesRequest));
