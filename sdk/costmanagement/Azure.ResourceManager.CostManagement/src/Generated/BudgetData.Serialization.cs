...
{
    public partial class BudgetData : IUtf8JsonSerializable, IJsonModel<BudgetData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BudgetData>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<BudgetData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        BudgetData IJsonModel<BudgetData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<BudgetData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        BinaryData IPersistableModel<BudgetData>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<BudgetData>)this).GetFormatFromOptions(options) : options.Format;
        ...
        BudgetData IPersistableModel<BudgetData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<BudgetData>)this).GetFormatFromOptions(options) : options.Format;
