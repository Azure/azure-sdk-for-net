...
namespace Azure.ResourceManager.CostManagement
{
    ...
    public abstract partial class SettingData : ResourceData
    {
        ...
        private protected SettingData(SettingsKind kind)
        {
            Kind = kind;
        }
        ...
        /// <param name="kind"> Metadata used by portal/tooling/etc to render different UX experiences for resources of the same type; e.g. ApiApps are a kind of Microsoft.Web/sites type.  If supported, the resource provider must validate and persist this value. </param>
        internal SettingData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, SettingsKind kind) : base(id, name, resourceType, systemData)
        {
