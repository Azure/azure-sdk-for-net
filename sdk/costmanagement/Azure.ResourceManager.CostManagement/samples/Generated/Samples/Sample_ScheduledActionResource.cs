...
namespace Azure.ResourceManager.CostManagement.Samples
{
    public partial class Sample_ScheduledActionResource
    {
        ...
        public async Task Delete_ScheduledActionDeleteByScope()
        {
            ...
            // invoke the operation
            await scheduledAction.DeleteAsync(WaitUntil.Completed).ConfigureAwait(false);
        ...
        public async Task Update_CreateOrUpdateInsightAlertScheduledActionByScope()
        {
            ...
            ScheduledActionData data = new ScheduledActionData
            {
                ...
                Schedule = new ScheduleProperties(ScheduleFrequency.Daily, default, default),
            ...
            string ifMatch = "";
            ArmOperation<ScheduledActionResource> lro = await scheduledAction.UpdateAsync(WaitUntil.Completed, data, ifMatch);
        ...
        public async Task RunByScope_ScheduledActionRunByScope()
        {
            ...
            // invoke the operation
            await scheduledAction.RunByScopeAsync().ConfigureAwait(false);
