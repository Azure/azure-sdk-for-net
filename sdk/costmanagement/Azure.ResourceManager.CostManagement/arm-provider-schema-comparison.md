# ARM provider schema comparison: Azure.ResourceManager.CostManagement
...
| --- | --- | --- |
| `/providers/microsoft.Billing/billingAccounts/{billingAccountId}/providers/Microsoft.CostManagement/costAllocationRules/{ruleName}` | `CostAllocationRule` | `ExternalResourceCostAllocationRuleDefinition` |
| `/{scope}/providers/Microsoft.CostManagement/alerts/{alertId}` | `CostManagementAlert` | `Alert` |
| `/{scope}/providers/Microsoft.CostManagement/exports/{exportName}` | `CostManagementExport` | `Export` |
| `/{scope}/providers/Microsoft.CostManagement/settings/{type}` | `CostManagementSetting` | `Setting` |
