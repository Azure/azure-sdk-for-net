...
| --- | --- | --- |
| `/providers/microsoft.billing/billingaccounts/{}/providers/microsoft.costmanagement/costallocationrules/{}` | `CostAllocationRule` | `ExternalResourceCostAllocationRuleDefinition` |
| `/{}/providers/microsoft.costmanagement/alerts/{}` | `CostManagementAlert` | `Alert` |
| `/{}/providers/microsoft.costmanagement/exports/{}` | `CostManagementExport` | `Export` |
| `/{}/providers/microsoft.costmanagement/settings/{}` | `CostManagementSetting` | `Setting` |
