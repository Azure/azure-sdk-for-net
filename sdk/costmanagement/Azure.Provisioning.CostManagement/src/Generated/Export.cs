...
namespace Azure.Provisioning.CostManagement
{
    ...
    public partial class Export : ProvisionableResource
    {
        ...
        /// <summary> Creates a new Export. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public Export(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.CostManagement/exports", resourceVersion ?? "2025-03-01")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for Export. </summary>
        ...
        /// <summary> Creates a reference to an existing Export. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static Export FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            Export result = new Export(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for Export that are not part of the generated code. </summary>
