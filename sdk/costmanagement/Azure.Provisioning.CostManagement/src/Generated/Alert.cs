...
namespace Azure.Provisioning.CostManagement
{
    ...
    public partial class Alert : ProvisionableResource
    {
        ...
        internal Alert(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.CostManagement/alerts", resourceVersion ?? "2025-03-01")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for Alert. </summary>
        ...
        /// <summary> Creates a reference to an existing Alert. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static Alert FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            Alert result = new Alert(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for Alert that are not part of the generated code. </summary>
