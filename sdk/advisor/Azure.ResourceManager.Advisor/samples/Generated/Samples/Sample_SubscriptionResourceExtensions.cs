...
State = DigestConfigState.Active,
        ...
        public async Task GenerateRecommendation_GenerateRecommendations()
        {
            ...
            // invoke the operation
            await subscriptionResource.GenerateRecommendationAsync().ConfigureAwait(false);
        ...
        public async Task GetGenerateStatusRecommendation_GetGenerateStatus()
        {
            ...
            await subscriptionResource.GetGenerateStatusRecommendationAsync(operationId).ConfigureAwait(false);
