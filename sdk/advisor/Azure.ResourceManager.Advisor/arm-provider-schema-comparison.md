...
#### List and action operations differences: `/{resourceUri}/providers/Microsoft.Advisor/recommendations/{recommendationId}`
...
| --- | --- | --- |
| `/providers/microsoft.advisor/metadata/{}` | `AdvisorMetadataEntity` | `MetadataEntity` |
| `/subscriptions/{}/providers/microsoft.advisor/assessments/{}` | `AdvisorAssessment` | `AssessmentResult` |
| `/subscriptions/{}/providers/microsoft.advisor/resiliencyreviews/{}` | `AdvisorResiliencyReview` | `ResiliencyReview` |
| `/subscriptions/{}/providers/microsoft.advisor/resiliencyreviews/{}/providers/microsoft.advisor/triagerecommendations/{}` | `AdvisorTriageRecommendation` | `TriageRecommendations` |
| `/subscriptions/{}/providers/microsoft.advisor/resiliencyreviews/{}/providers/microsoft.advisor/triagerecommendations/{}/providers/microsoft.advisor/triageresources/{}` | `AdvisorTriage` | `TriageResources` |
| `/{}/providers/microsoft.advisor/recommendations/{}` | `AdvisorRecommendation` | `ResourceRecommendationBase` |
| `/{}/providers/microsoft.advisor/recommendations/{}/suppressions/{}` | `AdvisorSuppressionContract` | `SuppressionContract` |
