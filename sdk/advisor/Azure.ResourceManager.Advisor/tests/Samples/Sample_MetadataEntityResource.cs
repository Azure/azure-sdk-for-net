...
namespace Azure.ResourceManager.Advisor.Samples
{
    public partial class Sample_MetadataEntityResource
    {
        ...
        public async Task Get_GetMetadata()
        {
            ...
            string name = "types";
            ResourceIdentifier metadataEntityResourceId = AdvisorMetadataEntityResource.CreateResourceIdentifier(name);
            AdvisorMetadataEntityResource metadataEntity = client.GetAdvisorMetadataEntityResource(metadataEntityResourceId);

            // invoke the operation
            AdvisorMetadataEntityResource result = await metadataEntity.GetAsync();
