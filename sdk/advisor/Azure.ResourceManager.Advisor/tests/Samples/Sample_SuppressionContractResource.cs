...
namespace Azure.ResourceManager.Advisor.Samples
{
    public partial class Sample_SuppressionContractResource
    {
        ...
        public async Task Get_GetSuppressionDetail()
        {
            ...
            ResourceIdentifier suppressionContractResourceId = AdvisorSuppressionContractResource.CreateResourceIdentifier(resourceUri, recommendationId, name);
            AdvisorSuppressionContractResource suppressionContract = client.GetAdvisorSuppressionContractResource(suppressionContractResourceId);

            // invoke the operation
            AdvisorSuppressionContractResource result = await suppressionContract.GetAsync();
        ...
        public async Task Update_CreateSuppression()
        {
            ...
            ArmOperation<AdvisorSuppressionContractResource> lro = await suppressionContract.UpdateAsync(WaitUntil.Completed, data);
