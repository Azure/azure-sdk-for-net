...
namespace Azure.ResourceManager.Advisor.Samples
{
    public partial class Sample_MetadataEntityCollection
    {
        ...
        public async Task Get_GetMetadata()
        {
            ...
            string name = "types";
            MetadataEntityResource result = await collection.GetAsync(name);
        ...
        {
            // Generated from example definition: specification/advisor/resource-manager/Microsoft.Advisor/stable/2020-01-01/examples/ListRecommendationMetadata.json
            // this example is just showing the usage of "RecommendationMetadata_List" operation, for the dependent resources, they will have to be created separately.
            ...
            await foreach (MetadataEntityResource item in collection.GetAllAsync())
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                MetadataEntityData resourceData = item.Data;
                // for demo we just print out the id
                Console.WriteLine($"Succeeded on id: {resourceData.Id}");
            }
