...
namespace Azure.ResourceManager.Advisor.Models
{
    ...
    public partial class DigestConfig
    {
        ...
        internal DigestConfig(string name, string actionGroupResourceId, int? frequency, IList<Category> categories, string language, DigestConfigState? state, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
