    ...
    public partial class ConfigData : IUtf8JsonSerializable, IJsonModel<ConfigData>
    {
        ...
        internal static ConfigData DeserializeConfigData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
				...
				global::System.ClientModel.Primitives.ModelReaderWriter.Read<global::Azure.ResourceManager.Models.SystemData>(new global::System.BinaryData(global::System.Runtime.InteropServices.JsonMarshal.GetRawUtf8Value(property.Value).ToArray()), global::Azure.ResourceManager.Advisor.ModelSerializationExtensions.WireOptions, AzureResourceManagerAdvisorContext.Default)
#else
                ModelReaderWriter.Read<SystemData>(new BinaryData(Encoding.UTF8.GetBytes(property.Value.GetRawText())), ModelSerializationExtensions.WireOptions, AzureResourceManagerAdvisorContext.Default)
#endif
;
                    continue;
                }
