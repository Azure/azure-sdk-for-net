...
{
    public partial class ConfigData : IUtf8JsonSerializable, IJsonModel<ConfigData>, IPersistableModel<ConfigData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Exclude))
            {
                ...
                var boolValue = Exclude.Value == true ? "true" : "false";
                builder.AppendLine($" {boolValue}");
            }

            if (Optional.IsDefined(LowCpuThreshold))
            {
                builder.Append("  lowCpuThreshold:");
                builder.AppendLine($" '{LowCpuThreshold.ToString()}'");
            }

            if (Optional.IsCollectionDefined(Digests))
            {
                builder.Append("  digests:");
                builder.AppendLine(" [");
                foreach (var item in Digests)
                {
