...
namespace Azure.ResourceManager.Advisor.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ConfigData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ConfigData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ConfigData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ConfigData>)} interface");
            }
        ...
        string IPersistableModel<ConfigData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
