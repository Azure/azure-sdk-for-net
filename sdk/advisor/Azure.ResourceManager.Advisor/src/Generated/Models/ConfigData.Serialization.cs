...
{
    public partial class ConfigData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ConfigData DeserializeConfigData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
