...
namespace Azure.ResourceManager.Advisor.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ShortDescription>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ShortDescription>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ShortDescription>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ShortDescription>)} interface");
            }
        ...
        string IPersistableModel<ShortDescription>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
