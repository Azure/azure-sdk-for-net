...
namespace Azure.ResourceManager.Advisor.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SuppressionContractListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SuppressionContractListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SuppressionContractListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SuppressionContractListResult>)} interface");
            }
        ...
        string IPersistableModel<SuppressionContractListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
