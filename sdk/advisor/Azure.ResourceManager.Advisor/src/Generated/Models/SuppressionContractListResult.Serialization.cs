...
namespace Azure.ResourceManager.Advisor.Models
{
    ...
    {
        internal static SuppressionContractListResult DeserializeSuppressionContractListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
