...
{
    public partial class DigestConfig : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static DigestConfig DeserializeDigestConfig(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
