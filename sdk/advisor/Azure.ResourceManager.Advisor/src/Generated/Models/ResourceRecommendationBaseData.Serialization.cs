...
namespace Azure.ResourceManager.Advisor
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ResourceRecommendationBaseData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ResourceRecommendationBaseData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ResourceRecommendationBaseData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ResourceRecommendationBaseData>)} interface");
            }
        ...
        string IPersistableModel<ResourceRecommendationBaseData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
