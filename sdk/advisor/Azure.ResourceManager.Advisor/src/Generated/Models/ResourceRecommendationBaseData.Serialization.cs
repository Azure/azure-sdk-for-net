    ...
    public partial class ResourceRecommendationBaseData : IUtf8JsonSerializable, IJsonModel<ResourceRecommendationBaseData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Impact))
            {
                ...
                builder.AppendLine($" '{Impact.Value.ToString()}'");
            }

            if (Optional.IsDefined(ImpactedField))
            {
                builder.Append("    impactedField:");
                if (ImpactedField.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(ImpactedValue))
            {
                ...
                if (ImpactedValue.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            {
                builder.Append("    risk:");
                builder.AppendLine($" '{Risk.Value.ToString()}'");
            }
            ...
            if (Optional.IsDefined(LearnMoreLink))
            {
                ...
                if (LearnMoreLink.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(PotentialBenefits))
            {
                ...
                if (PotentialBenefits.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
