...
namespace Azure.ResourceManager.Advisor
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MetadataEntityData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MetadataEntityData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MetadataEntityData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MetadataEntityData>)} interface");
            }
        ...
        string IPersistableModel<MetadataEntityData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
