...
namespace Azure.ResourceManager.Advisor.Models
{
    ...
    public partial class ConfigData : ResourceData
    {
        ...
        internal ConfigData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, bool? exclude, CpuThreshold? lowCpuThreshold, IList<DigestConfig> digests, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData)
        {
            Exclude = exclude;
