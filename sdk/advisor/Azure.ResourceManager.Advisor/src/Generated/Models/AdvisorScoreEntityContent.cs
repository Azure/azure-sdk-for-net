...
namespace Azure.ResourceManager.Advisor.Models
{
    ...
    public partial class AdvisorScoreEntityContent
    {
        ...
        internal AdvisorScoreEntityContent(string date, float? score, float? consumptionUnits, float? impactedResourceCount, float? potentialScoreIncrease, float? categoryCount, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Date = date;
            Score = score;
