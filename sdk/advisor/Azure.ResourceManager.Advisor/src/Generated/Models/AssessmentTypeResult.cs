...
namespace Azure.ResourceManager.Advisor.Models
{
    ...
    public partial class AssessmentTypeResult
    {
        ...
        /// <summary> Initializes a new instance of <see cref="AssessmentTypeResult"/>. </summary>
        ...
        internal AssessmentTypeResult(string id, string title, string description, string locale, string version, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Title = title;
