...
{
    public partial class SuppressionContractData : IUtf8JsonSerializable, IJsonModel<SuppressionContractData>, IPersistableModel<SuppressionContractData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SuppressionId))
            {
                builder.Append("  suppressionId:");
                builder.AppendLine($" '{SuppressionId}'");
            }
