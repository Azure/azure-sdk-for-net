...
namespace Azure.ResourceManager.Advisor
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SuppressionContractData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SuppressionContractData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SuppressionContractData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SuppressionContractData>)} interface");
            }
        ...
        string IPersistableModel<SuppressionContractData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
