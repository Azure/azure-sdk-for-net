...
namespace Azure.ResourceManager.Advisor.Models
{
    ...
    public partial class MetadataSupportedValueDetail : IJsonModel<MetadataSupportedValueDetail>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        MetadataSupportedValueDetail IJsonModel<MetadataSupportedValueDetail>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual MetadataSupportedValueDetail JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<MetadataSupportedValueDetail>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static MetadataSupportedValueDetail DeserializeMetadataSupportedValueDetail(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new MetadataSupportedValueDetail(id, displayName, additionalBinaryDataProperties);
        }

        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<MetadataSupportedValueDetail>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
