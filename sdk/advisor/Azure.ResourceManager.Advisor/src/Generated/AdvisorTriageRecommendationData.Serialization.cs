...
namespace Azure.ResourceManager.Advisor
{
    ...
    public partial class AdvisorTriageRecommendationData : ResourceData, IJsonModel<AdvisorTriageRecommendationData>
    {
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AdvisorTriageRecommendationData)} does not support writing '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        AdvisorTriageRecommendationData IJsonModel<AdvisorTriageRecommendationData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (AdvisorTriageRecommendationData)JsonModelCreateCore(ref reader, options);
        ...
        protected virtual ResourceData JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AdvisorTriageRecommendationData)} does not support reading '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static AdvisorTriageRecommendationData DeserializeAdvisorTriageRecommendationData(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            AdvisorTriageRecommendationProperties properties = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = AdvisorTriageRecommendationProperties.DeserializeAdvisorTriageRecommendationProperties(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<AdvisorTriageRecommendationData>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        protected virtual BinaryData PersistableModelWriteCore(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AdvisorTriageRecommendationData)} does not support writing '{options.Format}' format.");
            }
        }
