...
namespace Azure.ResourceManager.Advisor.Mock
{
    ...
    public partial class AdvisorResourceGroupResourceExtension : ArmResource
    {
        private ClientDiagnostics _configurationsClientDiagnostics;
        private ConfigurationsRestOperations _configurationsRestClient;

        /// <summary> Initializes a new instance of the <see cref="AdvisorResourceGroupResourceExtension"/> class for mocking. </summary>
        protected AdvisorResourceGroupResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="AdvisorResourceGroupResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal AdvisorResourceGroupResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<ConfigData> GetConfigurationsAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, null, ConfigData.DeserializeConfigData, ConfigurationsClientDiagnostics, Pipeline, "AdvisorResourceGroupResourceExtension.GetConfigurations", "value", null, cancellationToken);
        }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => ConfigurationsRestClient.CreateListByResourceGroupRequest(Id.SubscriptionId, Id.ResourceGroupName);
            return PageableHelpers.CreatePageable(FirstPageRequest, null, ConfigData.DeserializeConfigData, ConfigurationsClientDiagnostics, Pipeline, "AdvisorResourceGroupResourceExtension.GetConfigurations", "value", null, cancellationToken);
        }
        ...
        public virtual async Task<Response<ConfigData>> CreateConfigurationAsync(ConfigurationName configurationName, ConfigData data, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = ConfigurationsClientDiagnostics.CreateScope("AdvisorResourceGroupResourceExtension.CreateConfiguration");
            scope.Start();
            try
            {
