...
namespace Azure.ResourceManager.Advisor.Mocking
{
    ...
    public partial class AdvisorResourceGroupMockingExtension : ArmResource
    {
        private ClientDiagnostics _configurationsClientDiagnostics;
        private ConfigurationsRestOperations _configurationsRestClient;

        /// <summary> Initializes a new instance of the <see cref="AdvisorResourceGroupMockingExtension"/> class for mocking. </summary>
        protected AdvisorResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="AdvisorResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal AdvisorResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<ConfigData> GetConfigurationsAsync(CancellationToken cancellationToken = default)
        {
            ...
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, null, ConfigData.DeserializeConfigData, ConfigurationsClientDiagnostics, Pipeline, "AdvisorResourceGroupMockingExtension.GetConfigurations", "value", null, cancellationToken);
        }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => ConfigurationsRestClient.CreateListByResourceGroupRequest(Id.SubscriptionId, Id.ResourceGroupName);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, null, ConfigData.DeserializeConfigData, ConfigurationsClientDiagnostics, Pipeline, "AdvisorResourceGroupMockingExtension.GetConfigurations", "value", null, cancellationToken);
        }
        ...
        public virtual async Task<Response<ConfigData>> CreateConfigurationAsync(ConfigurationName configurationName, ConfigData data, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = ConfigurationsClientDiagnostics.CreateScope("AdvisorResourceGroupMockingExtension.CreateConfiguration");
            scope.Start();
            try
            {
