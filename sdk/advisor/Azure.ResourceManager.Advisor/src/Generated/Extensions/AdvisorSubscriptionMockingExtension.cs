...
namespace Azure.ResourceManager.Advisor.Mocking
{
    ...
    internal partial class AdvisorSubscriptionMockingExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="AdvisorSubscriptionMockingExtension"/> class for mocking. </summary>
        protected AdvisorSubscriptionMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="AdvisorSubscriptionMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal AdvisorSubscriptionMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<ConfigData> GetConfigurationsAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, ConfigData.DeserializeConfigData, ConfigurationsClientDiagnostics, Pipeline, "AdvisorSubscriptionMockingExtension.GetConfigurations", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<ConfigData> GetConfigurations(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => ConfigurationsRestClient.CreateListBySubscriptionRequest(Id.SubscriptionId);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => ConfigurationsRestClient.CreateListBySubscriptionNextPageRequest(nextLink, Id.SubscriptionId);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, ConfigData.DeserializeConfigData, ConfigurationsClientDiagnostics, Pipeline, "AdvisorSubscriptionMockingExtension.GetConfigurations", "value", "nextLink", cancellationToken);
        }
        ...
        {
            using var scope = ConfigurationsClientDiagnostics.CreateScope("AdvisorSubscriptionMockingExtension.CreateConfiguration");
            scope.Start();
            try
            {
        ...
        {
            using var scope = ResourceRecommendationBaseRecommendationsClientDiagnostics.CreateScope("AdvisorSubscriptionMockingExtension.GenerateRecommendation");
            scope.Start();
            try
            {
        ...
        {
            using var scope = ResourceRecommendationBaseRecommendationsClientDiagnostics.CreateScope("AdvisorSubscriptionMockingExtension.GetGenerateStatusRecommendation");
            scope.Start();
            try
            {
