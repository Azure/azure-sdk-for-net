...
namespace Azure.ResourceManager.Advisor.Mocking
{
    ...
    public partial class AdvisorSubscriptionMockingExtension : ArmResource
    {
        ...
        public virtual AsyncPageable<ConfigData> GetConfigurationsAsync(CancellationToken cancellationToken = default)
        {
            ...
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, ConfigData.DeserializeConfigData, ConfigurationsClientDiagnostics, Pipeline, "AdvisorSubscriptionMockingExtension.GetConfigurations", "value", "nextLink", cancellationToken);
        }
