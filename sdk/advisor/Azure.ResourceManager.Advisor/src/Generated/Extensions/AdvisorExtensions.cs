...
namespace Azure.ResourceManager.Advisor
{
    ...
    public static partial class AdvisorExtensions
    {
        ...
        private static ResourceRecommendationBaseResourceExtensionClient GetResourceRecommendationBaseResourceExtensionClient(ArmResource resource)
        {
            return resource.GetCachedClient(client =>
            {
                return new ResourceRecommendationBaseResourceExtensionClient(client, resource.Id);
            });
        }

        private static ResourceRecommendationBaseResourceExtensionClient GetResourceRecommendationBaseResourceExtensionClient(ArmClient client, ResourceIdentifier scope)
        {
            return client.GetResourceClient(() =>
            {
                return new ResourceRecommendationBaseResourceExtensionClient(client, scope);
            });
        }
        ...
        private static SuppressionContractResourceExtensionClient GetSuppressionContractResourceExtensionClient(ArmResource resource)
        {
            return resource.GetCachedClient(client =>
            {
                return new SuppressionContractResourceExtensionClient(client, resource.Id);
            });
        }

        private static SuppressionContractResourceExtensionClient GetSuppressionContractResourceExtensionClient(ArmClient client, ResourceIdentifier scope)
        {
            return client.GetResourceClient(() =>
            {
                return new SuppressionContractResourceExtensionClient(client, scope);
            });
        }
        ...
        {
            return await GetResourceRecommendationBaseResourceExtensionClient(subscriptionResource).GenerateRecommendationAsync(cancellationToken).ConfigureAwait(false);
        }
        ...
        {
            return GetResourceRecommendationBaseResourceExtensionClient(subscriptionResource).GenerateRecommendation(cancellationToken);
        }
        ...
        {
            return await GetResourceRecommendationBaseResourceExtensionClient(subscriptionResource).GetGenerateStatusRecommendationAsync(operationId, cancellationToken).ConfigureAwait(false);
        }
        ...
        {
            return GetResourceRecommendationBaseResourceExtensionClient(subscriptionResource).GetGenerateStatusRecommendation(operationId, cancellationToken);
        }
        ...
        {
            return GetSuppressionContractResourceExtensionClient(subscriptionResource).GetSuppressionContractsAsync(top, skipToken, cancellationToken);
        }
        ...
        {
            return GetSuppressionContractResourceExtensionClient(subscriptionResource).GetSuppressionContracts(top, skipToken, cancellationToken);
        }
