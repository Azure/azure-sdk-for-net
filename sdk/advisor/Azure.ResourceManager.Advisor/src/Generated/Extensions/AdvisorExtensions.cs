...
namespace Azure.ResourceManager.Advisor
{
    ...
    public static partial class AdvisorExtensions
    {
        ...
        private static AdvisorArmResourceMockingExtension GetAdvisorArmResourceMockingExtension(ArmResource resource)
        {
            return resource.GetCachedClient(client =>
            {
                return new AdvisorArmResourceMockingExtension(client, resource.Id);
            });
        }
        ...
        /// <returns> An object representing collection of ResourceRecommendationBaseResources and their operations over a ResourceRecommendationBaseResource. </returns>
        public static ResourceRecommendationBaseCollection GetResourceRecommendationBases(this ArmResource armResource)
        {
            return GetAdvisorArmResourceMockingExtension(armResource).GetResourceRecommendationBases();
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="recommendationId"/> is null. </exception>
        [ForwardsClientCalls]
        public static async Task<Response<ResourceRecommendationBaseResource>> GetResourceRecommendationBaseAsync(this ArmResource armResource, string recommendationId, CancellationToken cancellationToken = default)
        {
            return await GetAdvisorArmResourceMockingExtension(armResource).GetResourceRecommendationBaseAsync(recommendationId, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="recommendationId"/> is null. </exception>
        [ForwardsClientCalls]
        public static Response<ResourceRecommendationBaseResource> GetResourceRecommendationBase(this ArmResource armResource, string recommendationId, CancellationToken cancellationToken = default)
        {
            return GetAdvisorArmResourceMockingExtension(armResource).GetResourceRecommendationBase(recommendationId, cancellationToken);
        }
