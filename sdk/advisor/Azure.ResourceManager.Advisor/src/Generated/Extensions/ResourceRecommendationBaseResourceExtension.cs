...
namespace Azure.ResourceManager.Advisor.Mock
{
    ...
    public partial class ResourceRecommendationBaseResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="ResourceRecommendationBaseResourceExtension"/> class for mocking. </summary>
        protected ResourceRecommendationBaseResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ResourceRecommendationBaseResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ResourceRecommendationBaseResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        {
            using var scope = ResourceRecommendationBaseRecommendationsClientDiagnostics.CreateScope("ResourceRecommendationBaseResourceExtension.GenerateRecommendation");
            scope.Start();
            try
            {
        ...
        {
            using var scope = ResourceRecommendationBaseRecommendationsClientDiagnostics.CreateScope("ResourceRecommendationBaseResourceExtension.GetGenerateStatusRecommendation");
            scope.Start();
            try
            {
