...
namespace Azure.ResourceManager.Advisor.Mock
{
    ...
    public partial class SuppressionContractResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="SuppressionContractResourceExtension"/> class for mocking. </summary>
        protected SuppressionContractResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="SuppressionContractResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal SuppressionContractResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
