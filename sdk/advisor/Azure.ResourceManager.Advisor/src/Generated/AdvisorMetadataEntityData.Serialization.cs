...
namespace Azure.ResourceManager.Advisor
{
    ...
    public partial class AdvisorMetadataEntityData : ResourceData, IJsonModel<AdvisorMetadataEntityData>
    {
        /// <param name="writer"> The JSON writer. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        void IJsonModel<AdvisorMetadataEntityData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AdvisorMetadataEntityData)} does not support writing '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        AdvisorMetadataEntityData IJsonModel<AdvisorMetadataEntityData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (AdvisorMetadataEntityData)JsonModelCreateCore(ref reader, options);
        ...
        protected virtual ResourceData JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AdvisorMetadataEntityData)} does not support reading '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static AdvisorMetadataEntityData DeserializeAdvisorMetadataEntityData(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            AdvisorMetadataEntityProperties properties = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = AdvisorMetadataEntityProperties.DeserializeAdvisorMetadataEntityProperties(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
