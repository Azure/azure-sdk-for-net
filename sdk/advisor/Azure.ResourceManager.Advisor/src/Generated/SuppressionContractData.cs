...
namespace Azure.ResourceManager.Advisor
{
    ...
    public partial class SuppressionContractData : ResourceData
    {
        ...
        internal SuppressionContractData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string suppressionId, string ttl, DateTimeOffset? expirationTimeStamp, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData)
        {
