...
{
    internal partial class ResourceRecommendationBasesGetByTenantAsyncCollectionResultOfT : AsyncPageable<AdvisorRecommendationData>
    {
        ...
        /// <returns> The pages of ResourceRecommendationBasesGetByTenantAsyncCollectionResultOfT as an enumerable collection. </returns>
        public override async IAsyncEnumerable<Page<AdvisorRecommendationData>> AsPages(string continuationToken, int? pageSizeHint)
        {
