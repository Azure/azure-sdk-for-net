...
{
    internal partial class TriageResourcesGetAllAsyncCollectionResultOfT : AsyncPageable<AdvisorTriageData>
    {
        ...
        /// <returns> The pages of TriageResourcesGetAllAsyncCollectionResultOfT as an enumerable collection. </returns>
        public override async IAsyncEnumerable<Page<AdvisorTriageData>> AsPages(string continuationToken, int? pageSizeHint)
        {
