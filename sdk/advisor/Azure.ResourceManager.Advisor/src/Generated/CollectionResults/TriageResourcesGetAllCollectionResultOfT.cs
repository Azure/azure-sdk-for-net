...
namespace Azure.ResourceManager.Advisor
{
    internal partial class TriageResourcesGetAllCollectionResultOfT : Pageable<AdvisorTriageData>
    {
        ...
        public TriageResourcesGetAllCollectionResultOfT(TriageResources client, Guid subscriptionId, string reviewId, string recommendationId, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
