...
namespace Azure.ResourceManager.Advisor
{
    ...
    public partial class AdvisorRecommendationData : ResourceData
    {
        ...
        internal AdvisorRecommendationData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, AdvisorRecommendationProperties properties, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, name, resourceType, systemData)
        {
