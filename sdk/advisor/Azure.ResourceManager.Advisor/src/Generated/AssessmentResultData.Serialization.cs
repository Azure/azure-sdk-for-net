...
{
    public partial class AssessmentResultData : IUtf8JsonSerializable, IJsonModel<AssessmentResultData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AssessmentResultData>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<AssessmentResultData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<AssessmentResultData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AssessmentResultData)} does not support writing '{format}' format.");
            }
        ...
        AssessmentResultData IJsonModel<AssessmentResultData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AssessmentResultData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AssessmentResultData)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeAssessmentResultData(document.RootElement, options);
        }

        internal static AssessmentResultData DeserializeAssessmentResultData(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<AssessmentResultData>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AssessmentResultData>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AssessmentResultData)} does not support writing '{options.Format}' format.");
            }
        }

        AssessmentResultData IPersistableModel<AssessmentResultData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AssessmentResultData>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AssessmentResultData)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<AssessmentResultData>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
