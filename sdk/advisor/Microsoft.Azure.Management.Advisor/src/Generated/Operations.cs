...
namespace Microsoft.Azure.Management.Advisor
{
    ...
    /// </summary>
    internal partial class Operations : IServiceOperations<AdvisorManagementClient>, IOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal Operations(AdvisorManagementClient client)
        {
            if (client == null)
            {
        ...
        public async Task<AzureOperationResponse<IPage<OperationEntity>>> ListWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "providers/Microsoft.Advisor/operations").ToString();
