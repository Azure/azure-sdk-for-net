...
| --- | --- | --- |
| `/subscriptions/{}/resourcegroups/{}/providers/microsoft.secretsynccontroller/azurekeyvaultsecretproviderclasses/{}` | `KeyVaultSecretProviderClass` | `AzureKeyVaultSecretProviderClass` |
