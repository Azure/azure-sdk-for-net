...
namespace Azure.ResourceManager.SecretsStoreExtension
{
    ...
    public partial class KeyVaultSecretProviderClassData : TrackedResourceData, IJsonModel<KeyVaultSecretProviderClassData>
    {
        /// <summary> Initializes a new instance of <see cref="KeyVaultSecretProviderClassData"/> for deserialization. </summary>
        internal KeyVaultSecretProviderClassData()
        {
        }
        ...
        internal static RequestContent ToRequestContent(KeyVaultSecretProviderClassData keyVaultSecretProviderClassData)
        {
            ...
            return RequestContent.Create(keyVaultSecretProviderClassData, ModelSerializationExtensions.WireOptions);
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        KeyVaultSecretProviderClassData IJsonModel<KeyVaultSecretProviderClassData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (KeyVaultSecretProviderClassData)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static KeyVaultSecretProviderClassData DeserializeKeyVaultSecretProviderClassData(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("systemData"u8))
                {
                    ...
                    systemData = ModelReaderWriter.Read<SystemData>(new BinaryData(Encoding.UTF8.GetBytes(prop.Value.GetRawText())), ModelSerializationExtensions.WireOptions, AzureResourceManagerSecretsStoreExtensionContext.Default);
                    continue;
                }
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = KeyVaultSecretProviderClassProperties.DeserializeKeyVaultSecretProviderClassProperties(prop.Value, options);
                    continue;
                }
                if (prop.NameEquals("extendedLocation"u8))
                {
                    ...
                    extendedLocation = ModelReaderWriter.Read<ExtendedLocation>(new BinaryData(Encoding.UTF8.GetBytes(prop.Value.GetRawText())), ModelSerializationExtensions.WireOptions, AzureResourceManagerSecretsStoreExtensionContext.Default);
                    continue;
                }
                if (options.Format != "W")
                {
