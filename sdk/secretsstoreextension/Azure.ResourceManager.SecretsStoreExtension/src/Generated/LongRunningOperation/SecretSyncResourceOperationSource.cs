...
{
    /// <summary></summary>
    internal partial class SecretSyncResourceOperationSource : IOperationSource<SecretSyncResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal SecretSyncResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
