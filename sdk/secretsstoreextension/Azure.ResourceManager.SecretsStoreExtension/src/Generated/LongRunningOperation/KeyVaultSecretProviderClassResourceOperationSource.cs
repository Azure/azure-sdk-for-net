...
{
    /// <summary></summary>
    internal partial class KeyVaultSecretProviderClassResourceOperationSource : IOperationSource<KeyVaultSecretProviderClassResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal KeyVaultSecretProviderClassResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
