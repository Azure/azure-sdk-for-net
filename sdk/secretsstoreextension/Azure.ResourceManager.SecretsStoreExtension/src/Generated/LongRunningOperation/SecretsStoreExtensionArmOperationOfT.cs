...
namespace Azure.ResourceManager.SecretsStoreExtension
{
    internal partial class SecretsStoreExtensionArmOperation<T> : ArmOperation<T>
    {
        ...
        internal SecretsStoreExtensionArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
