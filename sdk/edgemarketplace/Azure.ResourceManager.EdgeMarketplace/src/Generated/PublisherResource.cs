...
namespace Azure.ResourceManager.EdgeMarketplace
{
    ...
    /// Otherwise you can get one from its parent resource <see cref="ArmResource"/> using the GetPublishers method.
    /// </summary>
    public partial class PublisherResource : ArmResource
    {
        ...
        internal PublisherResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _publishersClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.EdgeMarketplace", ResourceType.Namespace, Diagnostics);
        ...
        {
            string resourceId = $"{resourceUri}/providers/Microsoft.EdgeMarketplace/publishers/{publisherName}";
        ...
        public virtual async Task<Response<PublisherResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _publishersRestClient.CreateGetRequest(Id.Parent, Id.Name, context);
