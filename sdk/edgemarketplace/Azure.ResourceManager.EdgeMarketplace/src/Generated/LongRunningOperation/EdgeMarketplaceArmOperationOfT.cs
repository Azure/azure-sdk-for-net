...
{
    internal partial class EdgeMarketplaceArmOperation<T> : ArmOperation<T>
    {
        ...
        internal EdgeMarketplaceArmOperation(Response<T> response, RehydrationToken? rehydrationToken = null)
        {
