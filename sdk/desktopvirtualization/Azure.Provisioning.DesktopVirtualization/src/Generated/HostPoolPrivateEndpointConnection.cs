...
namespace Azure.Provisioning.DesktopVirtualization
{
    ...
    public partial class HostPoolPrivateEndpointConnection : ProvisionableResource
    {
        ...
        /// <summary> Creates a new HostPoolPrivateEndpointConnection. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public HostPoolPrivateEndpointConnection(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.DesktopVirtualization/hostPools/privateEndpointConnections", resourceVersion ?? "2026-04-01-preview")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for HostPoolPrivateEndpointConnection. </summary>
        ...
        /// <summary> Creates a reference to an existing HostPoolPrivateEndpointConnection. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static HostPoolPrivateEndpointConnection FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            HostPoolPrivateEndpointConnection result = new HostPoolPrivateEndpointConnection(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for HostPoolPrivateEndpointConnection that are not part of the generated code. </summary>
