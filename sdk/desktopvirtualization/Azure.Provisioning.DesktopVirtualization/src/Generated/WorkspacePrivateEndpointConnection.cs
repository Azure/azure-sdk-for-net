...
namespace Azure.Provisioning.DesktopVirtualization
{
    ...
    public partial class WorkspacePrivateEndpointConnection : ProvisionableResource
    {
        ...
        public WorkspacePrivateEndpointConnection(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.DesktopVirtualization/workspaces/privateEndpointConnections", resourceVersion ?? "2026-04-01-preview")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for WorkspacePrivateEndpointConnection. </summary>
        protected override void DefineProvisionableProperties()
        {
            ...
            _parent = DefineResource<VirtualWorkspace>(nameof(Parent), new string[] { "parent" }, isRequired: true);
            DefineAdditionalProperties();
        }

        /// <summary> Creates a reference to an existing WorkspacePrivateEndpointConnection. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static WorkspacePrivateEndpointConnection FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            WorkspacePrivateEndpointConnection result = new WorkspacePrivateEndpointConnection(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for WorkspacePrivateEndpointConnection that are not part of the generated code. </summary>
