...
namespace Azure.Provisioning.DesktopVirtualization
{
    ...
    public partial class ApplicationGroup : ProvisionableResource
    {
        ...
        /// <summary> Creates a new ApplicationGroup. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public ApplicationGroup(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.DesktopVirtualization/applicationGroups", resourceVersion ?? "2026-04-01-preview")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for ApplicationGroup. </summary>
        ...
        /// <summary> Creates a reference to an existing ApplicationGroup. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static ApplicationGroup FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            ApplicationGroup result = new ApplicationGroup(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for ApplicationGroup that are not part of the generated code. </summary>
