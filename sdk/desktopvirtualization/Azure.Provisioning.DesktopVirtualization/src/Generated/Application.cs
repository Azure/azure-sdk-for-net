...
namespace Azure.Provisioning.DesktopVirtualization
{
    ...
    public partial class Application : ProvisionableResource
    {
        private BicepValue<ResourceIdentifier> _id;
        private BicepValue<string> _name;
        private SystemData _systemData;
        private ApplicationProperties _properties;
        private ResourceReference<ApplicationGroup> _parent;

        /// <summary> Creates a new Application. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public Application(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.DesktopVirtualization/applicationGroups/applications", resourceVersion ?? "2026-04-01-preview")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for Application. </summary>
        protected override void DefineProvisionableProperties()
        {
            ...
            _parent = DefineResource<ApplicationGroup>("Parent", new string[] { "parent" }, isRequired: true);
            DefineAdditionalProperties();
        }

        /// <summary> Creates a reference to an existing Application. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static Application FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            Application result = new Application(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for Application that are not part of the generated code. </summary>
