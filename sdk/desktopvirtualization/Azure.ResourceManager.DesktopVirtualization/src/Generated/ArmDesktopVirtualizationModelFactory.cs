...
namespace Azure.ResourceManager.DesktopVirtualization.Models
{
    ...
    public static partial class ArmDesktopVirtualizationModelFactory
    {
        ...
        {
            return VirtualWorkspaceData(id: id, name: name, resourceType: resourceType, systemData: systemData, tags: tags, location: location, objectId: objectId, description: description, friendlyName: friendlyName, isCloudPCResource: isCloudPCResource, publicNetworkAccess: publicNetworkAccess, privateEndpointConnections: privateEndpointConnections, oboTenantId: default, deploymentScope: default, applicationGroupReferences: applicationGroupReferences, identity: identity, etag: etag, kind: kind, managedBy: managedBy, plan: plan, sku: sku);
        }
        ...
        {
            return VirtualApplicationGroupData(id: id, name: name, resourceType: resourceType, systemData: systemData, tags: tags, location: location, objectId: objectId, description: description, friendlyName: friendlyName, hostPoolId: hostPoolId, workspaceId: workspaceId, applicationGroupType: applicationGroupType, isCloudPCResource: isCloudPCResource, showInFeed: default, oboTenantId: default, deploymentScope: default, identity: identity, etag: etag, kind: kind, managedBy: managedBy, plan: plan, sku: sku);
        }
        ...
        {
            return VirtualWorkspaceData(id: id, name: name, resourceType: resourceType, systemData: systemData, tags: tags, location: location, objectId: objectId, description: description, friendlyName: friendlyName, isCloudPCResource: isCloudPCResource, publicNetworkAccess: default, privateEndpointConnections: default, oboTenantId: default, deploymentScope: default, applicationGroupReferences: applicationGroupReferences, identity: identity, etag: etag, kind: kind, managedBy: managedBy, plan: plan, sku: sku);
        }
