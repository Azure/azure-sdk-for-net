...
namespace Azure.ResourceManager.DesktopVirtualization.Models
{
    ...
    public static partial class ArmDesktopVirtualizationModelFactory
    {
        ...
        {
            return VirtualApplicationGroupData(id, name, resourceType, systemData, tags, location, objectId, description, friendlyName, hostPoolId, workspaceId, applicationGroupType, isCloudPCResource, showInFeed: default, managedBy, kind, etag, identity, sku, plan);
        }
        ...
        {
            return VirtualWorkspaceData(id, name, resourceType, systemData, tags, location, objectId, description, friendlyName, applicationGroupReferences, isCloudPCResource, publicNetworkAccess: default, privateEndpointConnections: default, managedBy, kind, etag, identity, sku, plan);
        }
    }
}
