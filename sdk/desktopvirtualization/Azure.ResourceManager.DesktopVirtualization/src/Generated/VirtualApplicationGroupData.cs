...
namespace Azure.ResourceManager.DesktopVirtualization
{
    ...
    public partial class VirtualApplicationGroupData : TrackedResourceData
    {
        ...
        internal VirtualApplicationGroupData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, string objectId, string description, string friendlyName, string hostPoolArmPath, string workspaceArmPath, ApplicationGroupType applicationGroupType, MigrationRequestProperties migrationRequest, bool? cloudPcResource, string managedBy, string kind, ETag? etag, ManagedServiceIdentity identity, ResourceModelWithAllowedPropertySetSku sku, ArmPlan plan) : base(id, name, resourceType, systemData, tags, location)
        {
            ObjectId = objectId;
