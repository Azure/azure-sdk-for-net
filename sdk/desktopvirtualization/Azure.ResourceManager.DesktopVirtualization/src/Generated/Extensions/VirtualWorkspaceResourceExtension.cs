...
namespace Azure.ResourceManager.DesktopVirtualization.Mock
{
    ...
    public partial class VirtualWorkspaceResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="VirtualWorkspaceResourceExtension"/> class for mocking. </summary>
        protected VirtualWorkspaceResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="VirtualWorkspaceResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal VirtualWorkspaceResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
