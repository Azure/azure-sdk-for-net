...
namespace Azure.ResourceManager.DesktopVirtualization.Mocking
{
    ...
    internal partial class DesktopVirtualizationArmClientMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="DesktopVirtualizationArmClientMockingExtension"/> class for mocking. </summary>
        protected DesktopVirtualizationArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="DesktopVirtualizationArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal DesktopVirtualizationArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal DesktopVirtualizationArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
