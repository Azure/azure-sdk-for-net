...
namespace Azure.ResourceManager.DesktopVirtualization.Testing
{
    /// <summary> A class to add extension methods to ResourceGroupResource. </summary>
    public partial class DesktopVirtualizationResourceGroupResourceExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="DesktopVirtualizationResourceGroupResourceExtension"/> class for mocking. </summary>
        protected DesktopVirtualizationResourceGroupResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="DesktopVirtualizationResourceGroupResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal DesktopVirtualizationResourceGroupResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
