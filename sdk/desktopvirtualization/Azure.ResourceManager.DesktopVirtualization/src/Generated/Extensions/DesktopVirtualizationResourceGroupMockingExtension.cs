...
namespace Azure.ResourceManager.DesktopVirtualization.Mocking
{
    ...
    internal partial class DesktopVirtualizationResourceGroupMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="DesktopVirtualizationResourceGroupMockingExtension"/> class for mocking. </summary>
        protected DesktopVirtualizationResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="DesktopVirtualizationResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal DesktopVirtualizationResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
