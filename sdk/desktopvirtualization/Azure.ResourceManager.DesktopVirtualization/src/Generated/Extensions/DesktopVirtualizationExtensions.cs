...
namespace Azure.ResourceManager.DesktopVirtualization
{
    ...
    {
        private static HostPoolResourceExtensionClient GetHostPoolResourceExtensionClient(ArmResource resource)
        {
            return resource.GetCachedClient(client =>
            {
                return new HostPoolResourceExtensionClient(client, resource.Id);
            });
        }

        private static HostPoolResourceExtensionClient GetHostPoolResourceExtensionClient(ArmClient client, ResourceIdentifier scope)
        {
            return client.GetResourceClient(() =>
            {
                return new HostPoolResourceExtensionClient(client, scope);
            });
        }
        ...
        private static ScalingPlanResourceExtensionClient GetScalingPlanResourceExtensionClient(ArmResource resource)
        {
            return resource.GetCachedClient(client =>
            {
                return new ScalingPlanResourceExtensionClient(client, resource.Id);
            });
        }

        private static ScalingPlanResourceExtensionClient GetScalingPlanResourceExtensionClient(ArmClient client, ResourceIdentifier scope)
        {
            return client.GetResourceClient(() =>
            {
                return new ScalingPlanResourceExtensionClient(client, scope);
            });
        }

        private static VirtualApplicationGroupResourceExtensionClient GetVirtualApplicationGroupResourceExtensionClient(ArmResource resource)
        {
            return resource.GetCachedClient(client =>
            {
                return new VirtualApplicationGroupResourceExtensionClient(client, resource.Id);
            });
        }

        private static VirtualApplicationGroupResourceExtensionClient GetVirtualApplicationGroupResourceExtensionClient(ArmClient client, ResourceIdentifier scope)
        {
            return client.GetResourceClient(() =>
            {
                return new VirtualApplicationGroupResourceExtensionClient(client, scope);
            });
        }

        private static VirtualWorkspaceResourceExtensionClient GetVirtualWorkspaceResourceExtensionClient(ArmResource resource)
        {
            return resource.GetCachedClient(client =>
            {
                return new VirtualWorkspaceResourceExtensionClient(client, resource.Id);
            });
        }

        private static VirtualWorkspaceResourceExtensionClient GetVirtualWorkspaceResourceExtensionClient(ArmClient client, ResourceIdentifier scope)
        {
            return client.GetResourceClient(() =>
            {
                return new VirtualWorkspaceResourceExtensionClient(client, scope);
            });
        }
        ...
        {
            return GetVirtualWorkspaceResourceExtensionClient(subscriptionResource).GetVirtualWorkspacesAsync(cancellationToken);
        }
        ...
        {
            return GetVirtualWorkspaceResourceExtensionClient(subscriptionResource).GetVirtualWorkspaces(cancellationToken);
        }
        ...
        {
            return GetScalingPlanResourceExtensionClient(subscriptionResource).GetScalingPlansAsync(cancellationToken);
        }
        ...
        {
            return GetScalingPlanResourceExtensionClient(subscriptionResource).GetScalingPlans(cancellationToken);
        }
        ...
        {
            return GetVirtualApplicationGroupResourceExtensionClient(subscriptionResource).GetVirtualApplicationGroupsAsync(filter, cancellationToken);
        }
        ...
        {
            return GetVirtualApplicationGroupResourceExtensionClient(subscriptionResource).GetVirtualApplicationGroups(filter, cancellationToken);
        }
        ...
        {
            return GetHostPoolResourceExtensionClient(subscriptionResource).GetHostPoolsAsync(cancellationToken);
        }
        ...
        {
            return GetHostPoolResourceExtensionClient(subscriptionResource).GetHostPools(cancellationToken);
        }
    }
}
