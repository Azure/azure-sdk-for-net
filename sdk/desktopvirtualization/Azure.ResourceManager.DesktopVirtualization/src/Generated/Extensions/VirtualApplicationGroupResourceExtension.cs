...
namespace Azure.ResourceManager.DesktopVirtualization.Mock
{
    ...
    public partial class VirtualApplicationGroupResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="VirtualApplicationGroupResourceExtension"/> class for mocking. </summary>
        protected VirtualApplicationGroupResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="VirtualApplicationGroupResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal VirtualApplicationGroupResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
