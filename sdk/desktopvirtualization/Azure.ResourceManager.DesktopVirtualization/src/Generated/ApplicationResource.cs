...
namespace Azure.ResourceManager.DesktopVirtualization
{
    ...
    /// Otherwise you can get one from its parent resource <see cref="ApplicationGroupResource"/> using the GetApplications method.
    /// </summary>
    public partial class ApplicationResource : ArmResource
    {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<ApplicationResource>> UpdateAsync(ApplicationPatch patch = default, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _applicationsRestClient.CreateUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, ApplicationPatch.ToRequestContent(patch), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<ApplicationData> response = Response.FromValue(ApplicationData.FromResponse(result), result);
                if (response.Value == null)
                {
        ...
        /// <param name="patch"> The resource properties to be updated. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<ApplicationResource> Update(ApplicationPatch patch = default, CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _applicationsClientDiagnostics.CreateScope("ApplicationResource.Update");
            scope.Start();
            try
