...
namespace Azure.ResourceManager.DesktopVirtualization
{
    ...
    public partial class VirtualApplicationCollection : ArmCollection, IEnumerable<VirtualApplicationResource>, IAsyncEnumerable<VirtualApplicationResource>
    {
        ...
        internal VirtualApplicationCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _applicationsRestClient = new Applications(_applicationsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, virtualApplicationApiVersion ?? "2026-03-01-preview");
        ...
        public virtual AsyncPageable<VirtualApplicationResource> GetAllAsync(int? pageSize = default, bool? isDescending = default, int? initialSkip = default, CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<VirtualApplicationData, VirtualApplicationResource>(new ApplicationsGetAllAsyncCollectionResultOfT(
                ...
                initialSkip,
                context,
                "VirtualApplicationCollection.GetAll"), data => new VirtualApplicationResource(Client, data));
        }
