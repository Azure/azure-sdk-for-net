...
namespace Azure.ResourceManager.DesktopVirtualization
{
    ...
    public partial class WorkspaceCollection : ArmCollection, IEnumerable<WorkspaceResource>, IAsyncEnumerable<WorkspaceResource>
    {
        ...
        internal WorkspaceCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _workspacesClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.DesktopVirtualization", WorkspaceResource.ResourceType.Namespace, Diagnostics);
            ...
            _privateLinkResourcesClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.DesktopVirtualization", WorkspaceResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<WorkspaceResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string workspaceName, WorkspaceData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                DesktopVirtualizationArmOperation<WorkspaceResource> operation = new DesktopVirtualizationArmOperation<WorkspaceResource>(Response.FromValue(new WorkspaceResource(Client, response.Value), response.GetRawResponse()), rehydrationToken);
        ...
        public virtual AsyncPageable<WorkspaceResource> GetAllAsync(int? pageSize = default, bool? isDescending = default, int? initialSkip = default, CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
            };
            return new AsyncPageableWrapper<WorkspaceData, WorkspaceResource>(new WorkspacesGetByResourceGroupAsyncCollectionResultOfT(
                ...
                isDescending,
                initialSkip,
                context), data => new WorkspaceResource(Client, data));
        }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> A collection of <see cref="WorkspaceResource"/> that may take multiple service requests to iterate over. </returns>
        public virtual Pageable<WorkspaceResource> GetAll(int? pageSize = default, bool? isDescending = default, int? initialSkip = default, CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
            };
            return new PageableWrapper<WorkspaceData, WorkspaceResource>(new WorkspacesGetByResourceGroupCollectionResultOfT(
                _workspacesRestClient,
                Guid.Parse(Id.SubscriptionId),
                Id.ResourceGroupName,
                pageSize,
