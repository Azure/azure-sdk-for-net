...
namespace Azure.ResourceManager.DesktopVirtualization
{
    ...
    public partial class Application : ArmResource
    {
        ...
        {
            _applicationClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.DesktopVirtualization", ResourceType.Namespace, DiagnosticOptions);
        ...
        public async virtual Task<Response<Application>> UpdateAsync(ApplicationUpdateOptions options = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _applicationRestClient.UpdateAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, options, cancellationToken).ConfigureAwait(false);
                return Response.FromValue(new Application(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        public virtual Response<Application> Update(ApplicationUpdateOptions options = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _applicationRestClient.Update(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, options, cancellationToken);
                return Response.FromValue(new Application(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
