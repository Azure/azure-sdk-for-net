...
namespace Azure.ResourceManager.DesktopVirtualization
{
    ...
    public partial class MsixPackageResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<MsixPackageResource>> UpdateAsync(WaitUntil waitUntil, MsixPackageData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _msixPackagesRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, MsixPackageData.ToRequestContent(data), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<MsixPackageData> response = Response.FromValue(MsixPackageData.FromResponse(result), result);
                RequestUriBuilder uri = message.Request.Uri;
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<MsixPackageResource> Update(WaitUntil waitUntil, MsixPackageData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
