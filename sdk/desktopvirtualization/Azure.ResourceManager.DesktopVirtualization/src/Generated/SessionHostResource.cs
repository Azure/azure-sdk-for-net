...
namespace Azure.ResourceManager.DesktopVirtualization
{
    ...
    public partial class SessionHostResource : ArmResource
    {
        ...
        internal SessionHostResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _sessionHostsRestClient = new SessionHosts(_sessionHostsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, sessionHostApiVersion ?? "2026-03-01-preview");
        ...
        /// <item>
        /// <term> Operation Id. </term>
        /// <description> SessionHosts_Create. </description>
        /// </item>
        /// <item>
        /// <term> Default Api Version. </term>
        /// <description> 2026-03-01-preview. </description>
        ...
        public virtual async Task<ArmOperation<SessionHostResource>> UpdateAsync(WaitUntil waitUntil, SessionHostData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _sessionHostsRestClient.CreateCreateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, SessionHostData.ToRequestContent(data), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<SessionHostData> response = Response.FromValue(SessionHostData.FromResponse(result), result);
                RequestUriBuilder uri = message.Request.Uri;
                RehydrationToken rehydrationToken = NextLinkOperationImplementation.GetRehydrationToken(RequestMethod.Put, uri.ToUri(), uri.ToString(), "None", null, OperationFinalStateVia.OriginalUri.ToString());
                DesktopVirtualizationArmOperation<SessionHostResource> operation = new DesktopVirtualizationArmOperation<SessionHostResource>(Response.FromValue(new SessionHostResource(Client, response.Value), response.GetRawResponse()), rehydrationToken);
                if (waitUntil == WaitUntil.Completed)
                {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<SessionHostResource> Update(WaitUntil waitUntil, SessionHostData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
