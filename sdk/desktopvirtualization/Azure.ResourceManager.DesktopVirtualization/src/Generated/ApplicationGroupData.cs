...
namespace Azure.ResourceManager.DesktopVirtualization
{
    ...
    public partial class ApplicationGroupData : TrackedResourceData
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="ApplicationGroupData"/>. </summary>
        /// <param name="location"> The geo-location where the resource lives. </param>
        /// <param name="properties"> Detailed properties for ApplicationGroup. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="properties"/> is null. </exception>
        public ApplicationGroupData(AzureLocation location, ApplicationGroupProperties properties) : base(location)
        {
