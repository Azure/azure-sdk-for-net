...
namespace Azure.ResourceManager.DesktopVirtualization
{
    ...
    public partial class PrivateEndpointConnectionResource : ArmResource
    {
        ...
        internal PrivateEndpointConnectionResource(ArmClient client, DesktopVirtualizationPrivateEndpointConnectionDataData data) : this(client, data.Id)
        {
            this.HasData = true;
            _data = data;
        }
        ...
        {
            this.TryGetApiVersion(ResourceType, out string privateEndpointConnectionApiVersion);
        ...
        public virtual async Task<ArmOperation<PrivateEndpointConnectionResource>> UpdateAsync(WaitUntil waitUntil, DesktopVirtualizationPrivateEndpointConnection connection, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="connection"/> is null. </exception>
        public virtual ArmOperation<PrivateEndpointConnectionResource> Update(WaitUntil waitUntil, DesktopVirtualizationPrivateEndpointConnection connection, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(connection, nameof(connection));
