...
namespace Azure.ResourceManager.DesktopVirtualization
{
    ...
    public partial class ScalingPlanPooledScheduleResource : ArmResource
    {
        ...
        /// <summary>
        /// Updates the ScalingPlanPooledSchedule.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DesktopVirtualization/scalingPlans/{scalingPlanName}/pooledSchedules/{scalingPlanScheduleName}. </description>
        ...
        public virtual async Task<ArmOperation<ScalingPlanPooledScheduleResource>> UpdateAsync(WaitUntil waitUntil, ScalingPlanPooledScheduleData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _scalingPlanPooledSchedulesRestClient.CreateCreateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, ScalingPlanPooledScheduleData.ToRequestContent(data), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<ScalingPlanPooledScheduleData> response = Response.FromValue(ScalingPlanPooledScheduleData.FromResponse(result), result);
                RequestUriBuilder uri = message.Request.Uri;
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<ScalingPlanPooledScheduleResource> Update(WaitUntil waitUntil, ScalingPlanPooledScheduleData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
