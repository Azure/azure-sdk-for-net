...
namespace Azure.ResourceManager.DesktopVirtualization
{
    ...
    public partial class WorkspaceResource : ArmResource
    {
        ...
        internal WorkspaceResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _workspacesRestClient = new Workspaces(_workspacesClientDiagnostics, Pipeline, Endpoint, workspaceApiVersion ?? "2026-01-01-preview");
            ...
            _privateLinkResourcesRestClient = new PrivateLinkResources(_privateLinkResourcesClientDiagnostics, Pipeline, Endpoint, workspaceApiVersion ?? "2026-01-01-preview");
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<WorkspaceResource>> UpdateAsync(WorkspacePatch patch = default, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="patch"> The resource properties to be updated. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<WorkspaceResource> Update(WorkspacePatch patch = default, CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _workspacesClientDiagnostics.CreateScope("WorkspaceResource.Update");
            scope.Start();
            try
        ...
        public virtual AsyncPageable<DesktopVirtualizationPrivateLinkResource> GetByWorkspaceAsync(int? pageSize = default, bool? isDescending = default, int? initialSkip = default, CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
            };
            return new PrivateLinkResourcesGetByWorkspaceAsyncCollectionResultOfT(
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> A collection of <see cref="DesktopVirtualizationPrivateLinkResource"/> that may take multiple service requests to iterate over. </returns>
        public virtual Pageable<DesktopVirtualizationPrivateLinkResource> GetByWorkspace(int? pageSize = default, bool? isDescending = default, int? initialSkip = default, CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
            };
            return new PrivateLinkResourcesGetByWorkspaceCollectionResultOfT(
                _privateLinkResourcesRestClient,
                Guid.Parse(Id.SubscriptionId),
                Id.ResourceGroupName,
                Id.Name,
        ...
        public virtual async Task<Response<WorkspaceResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    Response<WorkspaceResource> result = await UpdateAsync(patch, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<WorkspaceResource> AddTag(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    patch.Tags[key] = value;
                    Response<WorkspaceResource> result = Update(patch, cancellationToken: cancellationToken);
                    return Response.FromValue(result.Value, result.GetRawResponse());
                }
            }
            catch (Exception e)
