...
namespace Azure.ResourceManager.DesktopVirtualization
{
    public partial class ScalingPlanPooledScheduleResource : IJsonModel<ScalingPlanPooledScheduleData>
    {
        ...
        {
            return ModelReaderWriter.Read<ScalingPlanPooledScheduleData>(new BinaryData(reader.ValueSequence), options);
        }
        ...
        {
            return ModelReaderWriter.Read<ScalingPlanPooledScheduleData>(data, options);
        }
