...
namespace Azure.ResourceManager.DesktopVirtualization.Models
{
    ...
    public partial class MsixPackageApplications
    {
        ...
        internal MsixPackageApplications(string appId, string description, string appUserModelId, string friendlyName, string iconImageName, BinaryData rawIcon, BinaryData rawPng, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            AppId = appId;
