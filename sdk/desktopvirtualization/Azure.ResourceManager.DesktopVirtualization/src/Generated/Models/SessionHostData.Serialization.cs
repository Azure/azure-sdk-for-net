...
{
    public partial class SessionHostData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static SessionHostData DeserializeSessionHostData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
