...
{
    public partial class SessionHostData : IUtf8JsonSerializable, IModelJsonSerializable<SessionHostData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IModelJsonSerializable<SessionHostData>)this).Serialize(writer, ModelSerializerOptions.DefaultWireOptions);

        void IModelJsonSerializable<SessionHostData>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<SessionHostData>(this, options.Format);
        ...
        internal static SessionHostData DeserializeSessionHostData(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new SessionHostData(id, name, type, systemData.Value, objectId.Value, Optional.ToNullable(lastHeartBeat), Optional.ToNullable(sessions), agentVersion.Value, Optional.ToNullable(allowNewSession), virtualMachineId.Value, resourceId.Value, assignedUser.Value, friendlyName.Value, Optional.ToNullable(status), Optional.ToNullable(statusTimestamp), osVersion.Value, sxsStackVersion.Value, Optional.ToNullable(updateState), Optional.ToNullable(lastUpdateTime), updateErrorMessage.Value, Optional.ToList(sessionHostHealthCheckResults), rawData);
        }

        SessionHostData IModelJsonSerializable<SessionHostData>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<SessionHostData>(this, options.Format);

            using var doc = JsonDocument.ParseValue(ref reader);
            return DeserializeSessionHostData(doc.RootElement, options);
        }

        BinaryData IModelSerializable<SessionHostData>.Serialize(ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<SessionHostData>(this, options.Format);
        ...
        SessionHostData IModelSerializable<SessionHostData>.Deserialize(BinaryData data, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<SessionHostData>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="SessionHostData"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="SessionHostData"/> to convert. </param>
        public static implicit operator RequestContent(SessionHostData model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="SessionHostData"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator SessionHostData(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeSessionHostData(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
