...
{
    public partial class ResourceModelWithAllowedPropertySetSku : IUtf8JsonSerializable
    {
        ...
        internal static ResourceModelWithAllowedPropertySetSku DeserializeResourceModelWithAllowedPropertySetSku(JsonElement element)
        {
            ...
            return new ResourceModelWithAllowedPropertySetSku(name, Optional.ToNullable(tier), size.Value, family.Value, Optional.ToNullable(capacity));
        }
    }
}
