...
namespace Azure.ResourceManager.DesktopVirtualization.Models
{
    ...
    public partial class VirtualApplicationPatch
    {
        ...
        internal VirtualApplicationPatch(IDictionary<string, string> tags, string description, string friendlyName, string filePath, VirtualApplicationCommandLineSetting? commandLineSetting, string commandLineArguments, bool? showInPortal, string iconPath, int? iconIndex, string msixPackageFamilyName, string msixPackageApplicationId, RemoteApplicationType? applicationType, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Tags = tags;
