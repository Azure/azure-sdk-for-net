...
namespace Azure.ResourceManager.DesktopVirtualization
{
    public partial class DesktopVirtualizationPrivateEndpointConnectionDataData : IUtf8JsonSerializable, IJsonModel<DesktopVirtualizationPrivateEndpointConnectionDataData>
    {
        ...
        void IJsonModel<DesktopVirtualizationPrivateEndpointConnectionDataData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(DesktopVirtualizationPrivateEndpointConnectionDataData)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<DesktopVirtualizationPrivateEndpointConnectionDataData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(DesktopVirtualizationPrivateEndpointConnectionDataData)} does not support '{options.Format}' format.");
            }
        }
