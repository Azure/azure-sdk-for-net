...
{
    public partial class DesktopVirtualizationPrivateEndpointConnectionDataData : IUtf8JsonSerializable, IJsonModel<DesktopVirtualizationPrivateEndpointConnectionDataData>, IPersistableModel<DesktopVirtualizationPrivateEndpointConnectionDataData>
    {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<DesktopVirtualizationPrivateEndpointConnectionDataData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DesktopVirtualizationPrivateEndpointConnectionDataData)} does not support '{format}' format.");
            }
