...
namespace Azure.ResourceManager.DesktopVirtualization
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DesktopVirtualizationPrivateEndpointConnectionDataData>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<DesktopVirtualizationPrivateEndpointConnectionDataData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DesktopVirtualizationPrivateEndpointConnectionDataData>)} interface");
            }
        ...
        string IPersistableModel<DesktopVirtualizationPrivateEndpointConnectionDataData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
