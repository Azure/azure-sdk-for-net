...
{
    public partial class MsixPackagePatch : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static MsixPackagePatch DeserializeMsixPackagePatch(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
