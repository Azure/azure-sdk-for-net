...
namespace Azure.ResourceManager.DesktopVirtualization.Models
{
    public partial class ResourceModelWithAllowedPropertySet : IUtf8JsonSerializable
    {
        ...
        internal static ResourceModelWithAllowedPropertySet DeserializeResourceModelWithAllowedPropertySet(JsonElement element)
        {
            ...
            return new ResourceModelWithAllowedPropertySet(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, managedBy.Value, kind.Value, etag.Value, identity, sku.Value, plan);
        }
    }
}
