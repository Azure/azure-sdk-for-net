...
namespace Azure.ResourceManager.DesktopVirtualization.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SessionHostAgentUpdatePatchProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SessionHostAgentUpdatePatchProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SessionHostAgentUpdatePatchProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SessionHostAgentUpdatePatchProperties>)} interface");
            }
        ...
        string IPersistableModel<SessionHostAgentUpdatePatchProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
