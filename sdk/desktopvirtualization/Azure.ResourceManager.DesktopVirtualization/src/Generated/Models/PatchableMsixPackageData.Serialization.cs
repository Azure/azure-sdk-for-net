...
{
    public partial class PatchableMsixPackageData : IUtf8JsonSerializable
    {
        ...
        internal static PatchableMsixPackageData DeserializePatchableMsixPackageData(JsonElement element)
        {
            ...
            return new PatchableMsixPackageData(id, name, type, systemData, Optional.ToNullable(isActive), Optional.ToNullable(isRegularRegistration), displayName.Value);
        }
    }
}
