...
namespace Azure.ResourceManager.DesktopVirtualization
{
    public partial class MsixPackageData : IUtf8JsonSerializable
    {
        ...
        internal static MsixPackageData DeserializeMsixPackageData(JsonElement element)
        {
            ...
            return new MsixPackageData(id, name, type, systemData, imagePath.Value, packageName.Value, packageFamilyName.Value, displayName.Value, packageRelativePath.Value, Optional.ToNullable(isRegularRegistration), Optional.ToNullable(isActive), Optional.ToList(packageDependencies), version.Value, Optional.ToNullable(lastUpdated), Optional.ToList(packageApplications));
        }
    }
}
