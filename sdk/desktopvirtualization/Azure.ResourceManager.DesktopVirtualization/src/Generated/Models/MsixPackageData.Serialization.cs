...
{
    public partial class MsixPackageData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static MsixPackageData DeserializeMsixPackageData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
