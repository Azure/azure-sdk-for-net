...
namespace Azure.ResourceManager.DesktopVirtualization
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MsixPackageData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MsixPackageData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MsixPackageData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MsixPackageData>)} interface");
            }
        ...
        string IPersistableModel<MsixPackageData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
