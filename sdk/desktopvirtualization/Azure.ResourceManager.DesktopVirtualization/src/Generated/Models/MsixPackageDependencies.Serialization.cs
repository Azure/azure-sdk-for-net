...
namespace Azure.ResourceManager.DesktopVirtualization.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MsixPackageDependencies>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MsixPackageDependencies>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MsixPackageDependencies>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MsixPackageDependencies>)} interface");
            }
        ...
        string IPersistableModel<MsixPackageDependencies>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
