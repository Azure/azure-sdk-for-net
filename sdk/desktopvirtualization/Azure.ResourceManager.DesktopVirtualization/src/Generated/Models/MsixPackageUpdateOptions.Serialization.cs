...
{
    public partial class MsixPackageUpdateOptions : IUtf8JsonSerializable
    {
        ...
        internal static MsixPackageUpdateOptions DeserializeMsixPackageUpdateOptions(JsonElement element)
        {
            ...
            return new MsixPackageUpdateOptions(id, name, type, systemData, Optional.ToNullable(isActive), Optional.ToNullable(isRegularRegistration), displayName.Value);
        }
    }
}
