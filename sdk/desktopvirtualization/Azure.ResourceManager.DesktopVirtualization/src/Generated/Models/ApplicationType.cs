...
namespace Azure.ResourceManager.DesktopVirtualization.Models
{
    ...
    public readonly partial struct ApplicationType : IEquatable<ApplicationType>
    {
        ...
        /// <summary> Remote Applications (non-desktop). </summary>
        public static ApplicationType RemoteApp { get; } = new ApplicationType(RemoteAppValue);

        /// <summary> Desktop Applications. </summary>
        public static ApplicationType Desktop { get; } = new ApplicationType(DesktopValue);
        ...
        /// <summary> Converts a string to a <see cref="ApplicationType"/>. </summary>
        /// <param name="value"> The value. </param>
        public static implicit operator ApplicationType?(string value) => value == null ? null : new ApplicationType(value);
