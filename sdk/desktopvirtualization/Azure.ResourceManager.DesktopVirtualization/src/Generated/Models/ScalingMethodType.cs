...
namespace Azure.ResourceManager.DesktopVirtualization.Models
{
    ...
    public readonly partial struct ScalingMethodType : IEquatable<ScalingMethodType>
    {
        ...
        /// <summary> Converts a string to a <see cref="ScalingMethodType"/>. </summary>
        /// <param name="value"> The value. </param>
        public static implicit operator ScalingMethodType(string value) => new ScalingMethodType(value);

        /// <summary> Converts a string to a <see cref="ScalingMethodType"/>. </summary>
        /// <param name="value"> The value. </param>
        public static implicit operator ScalingMethodType?(string value) => value == null ? null : new ScalingMethodType(value);
