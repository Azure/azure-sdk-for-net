...
namespace Azure.ResourceManager.DesktopVirtualization.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DesktopVirtualizationPrivateEndpointConnection>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<DesktopVirtualizationPrivateEndpointConnection>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DesktopVirtualizationPrivateEndpointConnection>)} interface");
            }
        ...
        string IPersistableModel<DesktopVirtualizationPrivateEndpointConnection>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
