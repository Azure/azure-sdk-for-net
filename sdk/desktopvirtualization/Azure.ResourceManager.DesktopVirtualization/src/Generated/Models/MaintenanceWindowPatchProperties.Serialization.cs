...
{
    public partial class MaintenanceWindowPatchProperties : IUtf8JsonSerializable, IJsonModel<MaintenanceWindowPatchProperties>, IPersistableModel<MaintenanceWindowPatchProperties>
    {
        ...
        void IJsonModel<MaintenanceWindowPatchProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MaintenanceWindowPatchProperties)} does not support '{format}' format.");
            }
