...
namespace Azure.ResourceManager.DesktopVirtualization.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MaintenanceWindowPatchProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MaintenanceWindowPatchProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MaintenanceWindowPatchProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<MaintenanceWindowPatchProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
