...
namespace Azure.ResourceManager.DesktopVirtualization.Models
{
    ...
    public partial class VirtualWorkspacePatch
    {
        ...
        internal VirtualWorkspacePatch(IDictionary<string, string> tags, string description, string friendlyName, IList<string> applicationGroupReferences, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Tags = tags;
