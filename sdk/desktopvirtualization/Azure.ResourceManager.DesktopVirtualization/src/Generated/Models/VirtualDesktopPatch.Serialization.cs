...
namespace Azure.ResourceManager.DesktopVirtualization.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VirtualDesktopPatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<VirtualDesktopPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<VirtualDesktopPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<VirtualDesktopPatch>)} interface");
            }
        ...
        string IPersistableModel<VirtualDesktopPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
