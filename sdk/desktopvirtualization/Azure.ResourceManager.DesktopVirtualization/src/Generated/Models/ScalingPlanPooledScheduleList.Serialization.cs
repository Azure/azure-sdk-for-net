...
namespace Azure.ResourceManager.DesktopVirtualization.Models
{
    internal partial class ScalingPlanPooledScheduleList : IUtf8JsonSerializable, IModelJsonSerializable<ScalingPlanPooledScheduleList>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<ScalingPlanPooledScheduleList>(this, options.Format);
            ...
            if (Optional.IsCollectionDefined(Value))
            {
                ...
                foreach (var item in Value)
                {
                    ...
                    {
                        ((IModelJsonSerializable<ScalingPlanPooledScheduleData>)item).Serialize(writer, options);
                    }
                }
        ...
        /// <summary> Converts a <see cref="ScalingPlanPooledScheduleList"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="ScalingPlanPooledScheduleList"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="ScalingPlanPooledScheduleList"/>. </summary>
