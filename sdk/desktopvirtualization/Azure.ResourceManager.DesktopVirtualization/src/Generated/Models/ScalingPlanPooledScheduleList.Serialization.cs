...
namespace Azure.ResourceManager.DesktopVirtualization.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ScalingPlanPooledScheduleList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ScalingPlanPooledScheduleList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ScalingPlanPooledScheduleList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ScalingPlanPooledScheduleList>)} interface");
            }
        ...
        string IPersistableModel<ScalingPlanPooledScheduleList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
