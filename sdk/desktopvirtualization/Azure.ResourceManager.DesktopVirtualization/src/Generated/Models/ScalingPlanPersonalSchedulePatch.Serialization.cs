...
namespace Azure.ResourceManager.DesktopVirtualization.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ScalingPlanPersonalSchedulePatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ScalingPlanPersonalSchedulePatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ScalingPlanPersonalSchedulePatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ScalingPlanPersonalSchedulePatch>)} interface");
            }
        ...
        string IPersistableModel<ScalingPlanPersonalSchedulePatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
