...
{
    public partial class ScalingActionTime : IUtf8JsonSerializable, IJsonModel<ScalingActionTime>, IPersistableModel<ScalingActionTime>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  hour:");
                builder.AppendLine($" '{Hour.ToString()}'");
            }

            if (Optional.IsDefined(Minute))
            {
                builder.Append("  minute:");
                builder.AppendLine($" '{Minute.ToString()}'");
            }
