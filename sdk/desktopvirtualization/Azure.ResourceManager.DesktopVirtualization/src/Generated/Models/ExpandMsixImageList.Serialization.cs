...
namespace Azure.ResourceManager.DesktopVirtualization.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ExpandMsixImageList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ExpandMsixImageList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ExpandMsixImageList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ExpandMsixImageList>)} interface");
            }
        ...
        string IPersistableModel<ExpandMsixImageList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
