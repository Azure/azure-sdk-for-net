...
namespace Azure.ResourceManager.DesktopVirtualization.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DesktopVirtualizationStartMenuItem>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DesktopVirtualizationStartMenuItem>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DesktopVirtualizationStartMenuItem>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<DesktopVirtualizationStartMenuItem>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
