...
namespace Azure.ResourceManager.DesktopVirtualization.Models
{
    ...
    public partial class ScalingPlanPatch
    {
        ...
        internal ScalingPlanPatch(IDictionary<string, string> tags, string description, string friendlyName, string timeZone, string exclusionTag, IList<ScalingSchedule> schedules, IList<ScalingHostPoolReference> hostPoolReferences, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Tags = tags;
