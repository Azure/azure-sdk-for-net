...
{
    public partial class ScalingHostPoolReference : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ScalingHostPoolReference DeserializeScalingHostPoolReference(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
