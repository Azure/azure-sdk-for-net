...
namespace Azure.ResourceManager.DesktopVirtualization
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VirtualApplicationGroupData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<VirtualApplicationGroupData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<VirtualApplicationGroupData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<VirtualApplicationGroupData>)} interface");
            }
        ...
        string IPersistableModel<VirtualApplicationGroupData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
