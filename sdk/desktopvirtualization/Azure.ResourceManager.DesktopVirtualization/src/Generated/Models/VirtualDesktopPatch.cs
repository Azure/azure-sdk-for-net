...
namespace Azure.ResourceManager.DesktopVirtualization.Models
{
    ...
    public partial class VirtualDesktopPatch
    {
        ...
        internal VirtualDesktopPatch(IDictionary<string, string> tags, string description, string friendlyName, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Tags = tags;
