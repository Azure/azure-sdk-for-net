...
namespace Azure.ResourceManager.DesktopVirtualization.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SessionHostList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SessionHostList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SessionHostList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SessionHostList>)} interface");
            }
        ...
        string IPersistableModel<SessionHostList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
