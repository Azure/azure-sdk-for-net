...
{
    internal partial class SessionHostList : IUtf8JsonSerializable, IJsonModel<SessionHostList>, IPersistableModel<SessionHostList>
    {
        ...
        void IJsonModel<SessionHostList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SessionHostList)} does not support '{format}' format.");
            }
