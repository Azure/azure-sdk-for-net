...
namespace Azure.ResourceManager.DesktopVirtualization.Models
{
    ...
    public partial class MsixPackageUpdateOptions : ResourceData
    {
        /// <summary> Initializes a new instance of MsixPackageUpdateOptions. </summary>
        ...
        internal MsixPackageUpdateOptions(ResourceIdentifier id, string name, ResourceType type, SystemData systemData, bool? isActive, bool? isRegularRegistration, string displayName) : base(id, name, type, systemData)
        {
            IsActive = isActive;
