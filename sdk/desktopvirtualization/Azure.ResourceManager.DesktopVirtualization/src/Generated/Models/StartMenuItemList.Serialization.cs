...
namespace Azure.ResourceManager.DesktopVirtualization.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StartMenuItemList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<StartMenuItemList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<StartMenuItemList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<StartMenuItemList>)} interface");
            }
        ...
        string IPersistableModel<StartMenuItemList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
