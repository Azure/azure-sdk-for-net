...
{
    public partial class SessionHostHealthCheckFailureDetails : IUtf8JsonSerializable, IJsonModel<SessionHostHealthCheckFailureDetails>, IPersistableModel<SessionHostHealthCheckFailureDetails>
    {
        ...
        void IJsonModel<SessionHostHealthCheckFailureDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SessionHostHealthCheckFailureDetails)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(LastHealthCheckOn))
            {
                ...
                builder.AppendLine($" '{LastHealthCheckOn.Value.ToString()}'");
            }
