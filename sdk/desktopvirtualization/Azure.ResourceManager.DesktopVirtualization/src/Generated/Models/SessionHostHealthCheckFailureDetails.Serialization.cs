...
namespace Azure.ResourceManager.DesktopVirtualization.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SessionHostHealthCheckFailureDetails>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SessionHostHealthCheckFailureDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SessionHostHealthCheckFailureDetails>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<SessionHostHealthCheckFailureDetails>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
