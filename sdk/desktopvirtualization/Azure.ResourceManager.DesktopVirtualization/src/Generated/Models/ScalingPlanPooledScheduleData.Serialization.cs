...
namespace Azure.ResourceManager.DesktopVirtualization
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ScalingPlanPooledScheduleData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ScalingPlanPooledScheduleData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ScalingPlanPooledScheduleData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ScalingPlanPooledScheduleData>)} interface");
            }
        ...
        string IPersistableModel<ScalingPlanPooledScheduleData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
