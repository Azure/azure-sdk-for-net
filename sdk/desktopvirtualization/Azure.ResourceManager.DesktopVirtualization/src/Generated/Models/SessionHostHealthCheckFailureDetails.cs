...
namespace Azure.ResourceManager.DesktopVirtualization.Models
{
    ...
    public partial class SessionHostHealthCheckFailureDetails
    {
        ...
        internal SessionHostHealthCheckFailureDetails(string message, int? errorCode, DateTimeOffset? lastHealthCheckOn, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Message = message;
            ErrorCode = errorCode;
