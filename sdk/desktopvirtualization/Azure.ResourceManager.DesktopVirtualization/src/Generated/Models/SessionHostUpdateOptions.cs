...
namespace Azure.ResourceManager.DesktopVirtualization.Models
{
    ...
    public partial class SessionHostUpdateOptions : ResourceData
    {
        /// <summary> Initializes a new instance of SessionHostUpdateOptions. </summary>
        ...
        internal SessionHostUpdateOptions(ResourceIdentifier id, string name, ResourceType type, SystemData systemData, bool? allowNewSession, string assignedUser) : base(id, name, type, systemData)
        {
