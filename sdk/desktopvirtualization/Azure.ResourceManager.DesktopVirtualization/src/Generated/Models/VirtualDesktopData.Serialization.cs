...
namespace Azure.ResourceManager.DesktopVirtualization
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VirtualDesktopData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<VirtualDesktopData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<VirtualDesktopData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<VirtualDesktopData>)} interface");
            }
        ...
        string IPersistableModel<VirtualDesktopData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
