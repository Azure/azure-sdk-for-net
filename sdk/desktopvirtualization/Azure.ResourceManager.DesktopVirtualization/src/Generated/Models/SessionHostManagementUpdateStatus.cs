...
namespace Azure.ResourceManager.DesktopVirtualization.Models
{
    ...
    public partial class SessionHostManagementUpdateStatus
    {
        ...
        internal SessionHostManagementUpdateStatus(ResourceIdentifier id, string name, double? percentComplete, DateTimeOffset? startsOn, DateTimeOffset? endsOn, ResponseError error, SessionHostManagementUpdateOperationStatus status, SessionHostManagementUpdateStatusProperties properties, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Id = id;
            Name = name;
