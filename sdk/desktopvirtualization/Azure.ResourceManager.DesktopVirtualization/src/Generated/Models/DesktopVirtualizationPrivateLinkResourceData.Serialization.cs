...
{
    public partial class DesktopVirtualizationPrivateLinkResourceData : IUtf8JsonSerializable, IJsonModel<DesktopVirtualizationPrivateLinkResourceData>, IPersistableModel<DesktopVirtualizationPrivateLinkResourceData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DesktopVirtualizationPrivateLinkResourceData>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<DesktopVirtualizationPrivateLinkResourceData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DesktopVirtualizationPrivateLinkResourceData)} does not support '{format}' format.");
            }
