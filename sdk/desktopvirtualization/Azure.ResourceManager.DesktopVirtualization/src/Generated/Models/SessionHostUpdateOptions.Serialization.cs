...
{
    public partial class SessionHostUpdateOptions : IUtf8JsonSerializable
    {
        ...
        internal static SessionHostUpdateOptions DeserializeSessionHostUpdateOptions(JsonElement element)
        {
            ...
            return new SessionHostUpdateOptions(id, name, type, systemData, Optional.ToNullable(allowNewSession), assignedUser.Value);
        }
    }
}
