...
namespace Azure.ResourceManager.DesktopVirtualization.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SessionHostPatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SessionHostPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SessionHostPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SessionHostPatch>)} interface");
            }
        ...
        string IPersistableModel<SessionHostPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
