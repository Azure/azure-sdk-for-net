...
{
    public partial class SessionHostPatch : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static SessionHostPatch DeserializeSessionHostPatch(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
