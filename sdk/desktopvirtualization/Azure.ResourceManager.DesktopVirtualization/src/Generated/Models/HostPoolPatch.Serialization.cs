...
{
    public partial class HostPoolPatch : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static HostPoolPatch DeserializeHostPoolPatch(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
