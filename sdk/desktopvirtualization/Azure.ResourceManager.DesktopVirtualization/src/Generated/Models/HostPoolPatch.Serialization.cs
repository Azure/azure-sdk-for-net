...
namespace Azure.ResourceManager.DesktopVirtualization.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HostPoolPatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<HostPoolPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<HostPoolPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<HostPoolPatch>)} interface");
            }
        ...
        string IPersistableModel<HostPoolPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
