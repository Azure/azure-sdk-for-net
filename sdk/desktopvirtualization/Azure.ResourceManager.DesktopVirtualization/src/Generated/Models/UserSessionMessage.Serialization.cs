...
namespace Azure.ResourceManager.DesktopVirtualization.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<UserSessionMessage>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<UserSessionMessage>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<UserSessionMessage>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<UserSessionMessage>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
