...
namespace Azure.ResourceManager.DesktopVirtualization.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HostPoolList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<HostPoolList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<HostPoolList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<HostPoolList>)} interface");
            }
        ...
        string IPersistableModel<HostPoolList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
