...
namespace Azure.ResourceManager.DesktopVirtualization.Models
{
    ...
    public partial class DesktopVirtualizationSku
    {
        ...
        internal DesktopVirtualizationSku(string name, DesktopVirtualizationSkuTier? tier, string size, string family, int? capacity, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Name = name;
            Tier = tier;
            Size = size;
