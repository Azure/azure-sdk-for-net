...
namespace Azure.ResourceManager.DesktopVirtualization.Models
{
    ...
    public partial class DesktopVirtualizationSku
    {
        ...
        internal DesktopVirtualizationSku(string name, DesktopVirtualizationSkuTier? tier, string size, string family, int? capacity, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Tier = tier;
            Size = size;
