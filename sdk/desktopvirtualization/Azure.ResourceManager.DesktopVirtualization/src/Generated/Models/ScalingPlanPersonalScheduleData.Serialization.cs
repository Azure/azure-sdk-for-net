...
namespace Azure.ResourceManager.DesktopVirtualization
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ScalingPlanPersonalScheduleData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ScalingPlanPersonalScheduleData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ScalingPlanPersonalScheduleData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ScalingPlanPersonalScheduleData>)} interface");
            }
        ...
        string IPersistableModel<ScalingPlanPersonalScheduleData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
