...
namespace Azure.ResourceManager.DesktopVirtualization.Models
{
    ...
    internal partial class WorkspaceList
    {
        ...
        internal WorkspaceList(IEnumerable<WorkspaceData> value)
        {
            Value = value.ToList();
        }
        ...
        internal WorkspaceList(IList<WorkspaceData> value, Uri nextLink, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            NextLink = nextLink;
