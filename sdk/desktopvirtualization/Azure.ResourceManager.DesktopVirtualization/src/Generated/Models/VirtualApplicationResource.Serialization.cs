...
namespace Azure.ResourceManager.DesktopVirtualization
{
    public partial class VirtualApplicationResource : IJsonModel<VirtualApplicationData>
    {
        ...
        {
            return ModelReaderWriter.Read<VirtualApplicationData>(new BinaryData(reader.ValueSequence), options);
        }
        ...
        {
            return ModelReaderWriter.Read<VirtualApplicationData>(data, options);
        }
