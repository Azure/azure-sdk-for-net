...
namespace Azure.ResourceManager.DesktopVirtualization.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VirtualApplicationPatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<VirtualApplicationPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<VirtualApplicationPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<VirtualApplicationPatch>)} interface");
            }
        ...
        string IPersistableModel<VirtualApplicationPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
