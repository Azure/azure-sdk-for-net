...
{
    public partial class PatchableSessionHostData : IUtf8JsonSerializable
    {
        ...
        internal static PatchableSessionHostData DeserializePatchableSessionHostData(JsonElement element)
        {
            ...
            return new PatchableSessionHostData(id, name, type, systemData, Optional.ToNullable(allowNewSession), assignedUser.Value);
        }
    }
}
