...
{
    public partial class HostPoolRegistrationInfo : IUtf8JsonSerializable, IJsonModel<HostPoolRegistrationInfo>, IPersistableModel<HostPoolRegistrationInfo>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(RegistrationTokenOperation))
            {
                ...
                builder.AppendLine($" '{RegistrationTokenOperation.ToString()}'");
            }
