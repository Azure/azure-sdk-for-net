...
{
    public partial class UserSessionData : IUtf8JsonSerializable, IJsonModel<UserSessionData>, IPersistableModel<UserSessionData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SessionState))
            {
                ...
                builder.AppendLine($" '{SessionState.ToString()}'");
            }
