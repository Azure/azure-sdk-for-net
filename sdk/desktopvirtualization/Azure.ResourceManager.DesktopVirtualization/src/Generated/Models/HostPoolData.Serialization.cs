...
{
    public partial class HostPoolData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static HostPoolData DeserializeHostPoolData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
