...
{
    public partial class ScalingSchedule : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ScalingSchedule DeserializeScalingSchedule(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
