...
namespace Azure.ResourceManager.DesktopVirtualization.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ScalingSchedule>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ScalingSchedule>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ScalingSchedule>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ScalingSchedule>)} interface");
            }
        ...
        string IPersistableModel<ScalingSchedule>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
