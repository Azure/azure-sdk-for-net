...
namespace Azure.ResourceManager.DesktopVirtualization.Models
{
    ...
    public partial class HostPoolRegistrationInfo
    {
        ...
        internal HostPoolRegistrationInfo(DateTimeOffset? expiresOn, string token, HostPoolRegistrationTokenOperation? registrationTokenOperation, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            ExpiresOn = expiresOn;
            Token = token;
