...
namespace Azure.ResourceManager.DesktopVirtualization.Models
{
    ...
    public partial class HostPoolRegistrationInfo
    {
        ...
        internal HostPoolRegistrationInfo(DateTimeOffset? expireOn, string token, HostPoolRegistrationTokenOperation? registrationTokenOperation, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ExpireOn = expireOn;
            Token = token;
