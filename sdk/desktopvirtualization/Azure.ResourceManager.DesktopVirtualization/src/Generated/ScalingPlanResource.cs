...
{
    /// <summary> A Class representing a ScalingPlanResource along with the instance operations that can be performed on it. </summary>
    public partial class ScalingPlanResource : ArmResource
    {
        ...
        {
            _scalingPlanClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.DesktopVirtualization", ResourceType.Namespace, DiagnosticOptions);
        ...
        public virtual async Task<Response<ScalingPlanResource>> UpdateAsync(PatchableScalingPlanData data, CancellationToken cancellationToken = default)
        {
