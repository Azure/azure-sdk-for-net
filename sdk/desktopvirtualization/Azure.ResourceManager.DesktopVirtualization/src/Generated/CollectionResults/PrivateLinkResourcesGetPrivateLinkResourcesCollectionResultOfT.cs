...
{
    internal partial class PrivateLinkResourcesGetPrivateLinkResourcesCollectionResultOfT : Pageable<DesktopVirtualizationPrivateLinkResourceData>
    {
        ...
        public PrivateLinkResourcesGetPrivateLinkResourcesCollectionResultOfT(PrivateLinkResources client, Guid subscriptionId, string resourceGroupName, string hostPoolName, int? pageSize, bool? isDescending, int? initialSkip, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
