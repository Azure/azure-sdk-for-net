...
{
    internal partial class PrivateEndpointConnectionsGetByWorkspaceAsyncCollectionResultOfT : AsyncPageable<PrivateEndpointConnectionWithSystemData>
    {
        ...
        /// <summary> Initializes a new instance of PrivateEndpointConnectionsGetByWorkspaceAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public PrivateEndpointConnectionsGetByWorkspaceAsyncCollectionResultOfT(PrivateEndpointConnections client, Guid subscriptionId, string resourceGroupName, string workspaceName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of PrivateEndpointConnectionsGetByWorkspaceAsyncCollectionResultOfT as an enumerable collection. </summary>
