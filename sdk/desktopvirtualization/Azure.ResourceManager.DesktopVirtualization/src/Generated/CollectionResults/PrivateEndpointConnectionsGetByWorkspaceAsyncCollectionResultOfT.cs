...
namespace Azure.ResourceManager.DesktopVirtualization
{
    internal partial class PrivateEndpointConnectionsGetByWorkspaceAsyncCollectionResultOfT : AsyncPageable<DesktopVirtualizationPrivateEndpointConnectionDataData>
    {
        ...
        public PrivateEndpointConnectionsGetByWorkspaceAsyncCollectionResultOfT(PrivateEndpointConnections client, Guid subscriptionId, string resourceGroupName, string workspaceName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
