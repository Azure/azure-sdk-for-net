...
namespace Azure.ResourceManager.DesktopVirtualization
{
    internal partial class WorkspacesGetByResourceGroupCollectionResultOfT : Pageable<VirtualWorkspaceData>
    {
        ...
        /// <summary> Initializes a new instance of WorkspacesGetByResourceGroupCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public WorkspacesGetByResourceGroupCollectionResultOfT(Workspaces client, Guid subscriptionId, string resourceGroupName, int? pageSize, bool? isDescending, int? initialSkip, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of WorkspacesGetByResourceGroupCollectionResultOfT as an enumerable collection. </summary>
        ...
        public override IEnumerable<Page<VirtualWorkspaceData>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                yield return Page<VirtualWorkspaceData>.FromValues((IReadOnlyList<VirtualWorkspaceData>)result.Value, nextPage?.IsAbsoluteUri == true ? nextPage.AbsoluteUri : nextPage?.OriginalString, response);
