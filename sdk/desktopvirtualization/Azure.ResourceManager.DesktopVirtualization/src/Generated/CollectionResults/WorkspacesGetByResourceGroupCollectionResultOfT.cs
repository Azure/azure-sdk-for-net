...
namespace Azure.ResourceManager.DesktopVirtualization
{
    internal partial class WorkspacesGetByResourceGroupCollectionResultOfT : Pageable<VirtualWorkspaceData>
    {
        ...
        public WorkspacesGetByResourceGroupCollectionResultOfT(Workspaces client, Guid subscriptionId, string resourceGroupName, int? pageSize, bool? isDescending, int? initialSkip, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
