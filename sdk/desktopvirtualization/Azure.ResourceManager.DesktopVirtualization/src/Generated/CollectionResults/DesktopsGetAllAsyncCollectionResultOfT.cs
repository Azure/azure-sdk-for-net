...
namespace Azure.ResourceManager.DesktopVirtualization
{
    internal partial class DesktopsGetAllAsyncCollectionResultOfT : AsyncPageable<VirtualDesktopData>
    {
        ...
        private readonly string _applicationGroupName;
        ...
        /// <summary> Initializes a new instance of DesktopsGetAllAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public DesktopsGetAllAsyncCollectionResultOfT(Desktops client, Guid subscriptionId, string resourceGroupName, string applicationGroupName, int? pageSize, bool? isDescending, int? initialSkip, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _subscriptionId = subscriptionId;
            _resourceGroupName = resourceGroupName;
            _applicationGroupName = applicationGroupName;
            _pageSize = pageSize;
        ...
        /// <summary> Gets the pages of DesktopsGetAllAsyncCollectionResultOfT as an enumerable collection. </summary>
