...
namespace Azure.ResourceManager.DesktopVirtualization
{
    internal partial class DesktopsGetAllAsyncCollectionResultOfT : AsyncPageable<VirtualDesktopData>
    {
        ...
        public DesktopsGetAllAsyncCollectionResultOfT(Desktops client, Guid subscriptionId, string resourceGroupName, string applicationGroupName, int? pageSize, bool? isDescending, int? initialSkip, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
