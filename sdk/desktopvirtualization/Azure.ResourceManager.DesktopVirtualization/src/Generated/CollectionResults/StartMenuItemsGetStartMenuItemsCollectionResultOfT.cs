...
namespace Azure.ResourceManager.DesktopVirtualization
{
    internal partial class StartMenuItemsGetStartMenuItemsCollectionResultOfT : Pageable<DesktopVirtualizationStartMenuItem>
    {
        ...
        public StartMenuItemsGetStartMenuItemsCollectionResultOfT(StartMenuItems client, Guid subscriptionId, string resourceGroupName, string applicationGroupName, int? pageSize, bool? isDescending, int? initialSkip, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
