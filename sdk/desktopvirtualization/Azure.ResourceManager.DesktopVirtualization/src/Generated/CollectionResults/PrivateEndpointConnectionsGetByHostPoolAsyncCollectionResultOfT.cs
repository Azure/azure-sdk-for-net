...
namespace Azure.ResourceManager.DesktopVirtualization
{
    internal partial class PrivateEndpointConnectionsGetByHostPoolAsyncCollectionResultOfT : AsyncPageable<DesktopVirtualizationPrivateEndpointConnectionDataData>
    {
        ...
        public PrivateEndpointConnectionsGetByHostPoolAsyncCollectionResultOfT(PrivateEndpointConnections client, Guid subscriptionId, string resourceGroupName, string hostPoolName, int? pageSize, bool? isDescending, int? initialSkip, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
