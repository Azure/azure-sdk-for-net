...
{
    internal partial class PrivateEndpointConnectionsGetByHostPoolAsyncCollectionResultOfT : AsyncPageable<PrivateEndpointConnectionWithSystemData>
    {
        ...
        public override async IAsyncEnumerable<Page<PrivateEndpointConnectionWithSystemData>> AsPages(string continuationToken, int? pageSizeHint)
        {
