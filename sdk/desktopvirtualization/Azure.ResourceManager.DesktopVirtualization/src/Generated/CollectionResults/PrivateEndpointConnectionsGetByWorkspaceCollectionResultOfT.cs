...
{
    internal partial class PrivateEndpointConnectionsGetByWorkspaceCollectionResultOfT : Pageable<DesktopVirtualizationPrivateEndpointConnectionDataData>
    {
        ...
        /// <summary> Initializes a new instance of PrivateEndpointConnectionsGetByWorkspaceCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public PrivateEndpointConnectionsGetByWorkspaceCollectionResultOfT(PrivateEndpointConnections client, Guid subscriptionId, string resourceGroupName, string workspaceName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of PrivateEndpointConnectionsGetByWorkspaceCollectionResultOfT as an enumerable collection. </summary>
        ...
        public override IEnumerable<Page<DesktopVirtualizationPrivateEndpointConnectionDataData>> AsPages(string continuationToken, int? pageSizeHint)
        {
