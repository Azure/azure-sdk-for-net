...
namespace Azure.ResourceManager.DesktopVirtualization
{
    internal partial class PrivateEndpointConnectionsGetByWorkspaceCollectionResultOfT : Pageable<DesktopVirtualizationPrivateEndpointConnectionDataData>
    {
        ...
        public PrivateEndpointConnectionsGetByWorkspaceCollectionResultOfT(PrivateEndpointConnections client, Guid subscriptionId, string resourceGroupName, string workspaceName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
