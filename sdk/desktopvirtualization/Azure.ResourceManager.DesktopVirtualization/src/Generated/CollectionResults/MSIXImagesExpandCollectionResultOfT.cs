...
{
    internal partial class MSIXImagesExpandCollectionResultOfT : Pageable<ExpandMsixImage>
    {
        ...
        /// <summary> Initializes a new instance of MSIXImagesExpandCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public MSIXImagesExpandCollectionResultOfT(MSIXImages client, Guid subscriptionId, string resourceGroupName, string hostPoolName, RequestContent content, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of MSIXImagesExpandCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of MSIXImagesExpandCollectionResultOfT as an enumerable collection. </returns>
        public override IEnumerable<Page<ExpandMsixImage>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                yield return Page<ExpandMsixImage>.FromValues((IReadOnlyList<ExpandMsixImage>)result.Value, nextPage?.AbsoluteUri, response);
