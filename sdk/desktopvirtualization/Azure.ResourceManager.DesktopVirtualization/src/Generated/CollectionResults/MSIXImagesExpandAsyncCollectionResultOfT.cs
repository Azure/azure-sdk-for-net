...
{
    internal partial class MSIXImagesExpandAsyncCollectionResultOfT : AsyncPageable<ExpandMsixImage>
    {
        ...
        /// <summary> Initializes a new instance of MSIXImagesExpandAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public MSIXImagesExpandAsyncCollectionResultOfT(MSIXImages client, Guid subscriptionId, string resourceGroupName, string hostPoolName, RequestContent content, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of MSIXImagesExpandAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of MSIXImagesExpandAsyncCollectionResultOfT as an enumerable collection. </returns>
