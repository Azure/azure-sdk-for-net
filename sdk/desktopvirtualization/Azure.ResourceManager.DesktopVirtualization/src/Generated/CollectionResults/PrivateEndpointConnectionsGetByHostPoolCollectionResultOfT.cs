...
namespace Azure.ResourceManager.DesktopVirtualization
{
    internal partial class PrivateEndpointConnectionsGetByHostPoolCollectionResultOfT : Pageable<DesktopVirtualizationPrivateEndpointConnectionDataData>
    {
        ...
        public PrivateEndpointConnectionsGetByHostPoolCollectionResultOfT(PrivateEndpointConnections client, Guid subscriptionId, string resourceGroupName, string hostPoolName, int? pageSize, bool? isDescending, int? initialSkip, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
