...
{
    internal partial class PrivateEndpointConnectionsGetByHostPoolCollectionResultOfT : Pageable<DesktopVirtualizationPrivateEndpointConnectionDataData>
    {
        ...
        /// <summary> Initializes a new instance of PrivateEndpointConnectionsGetByHostPoolCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public PrivateEndpointConnectionsGetByHostPoolCollectionResultOfT(PrivateEndpointConnections client, Guid subscriptionId, string resourceGroupName, string hostPoolName, int? pageSize, bool? isDescending, int? initialSkip, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of PrivateEndpointConnectionsGetByHostPoolCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of PrivateEndpointConnectionsGetByHostPoolCollectionResultOfT as an enumerable collection. </returns>
