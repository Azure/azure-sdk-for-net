...
namespace Azure.ResourceManager.DesktopVirtualization
{
    internal partial class MSIXPackagesGetAllCollectionResultOfT : Pageable<MsixPackageData>
    {
        ...
        /// <summary> Initializes a new instance of MSIXPackagesGetAllCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public MSIXPackagesGetAllCollectionResultOfT(MSIXPackages client, Guid subscriptionId, string resourceGroupName, string hostPoolName, int? pageSize, bool? isDescending, int? initialSkip, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of MSIXPackagesGetAllCollectionResultOfT as an enumerable collection. </summary>
