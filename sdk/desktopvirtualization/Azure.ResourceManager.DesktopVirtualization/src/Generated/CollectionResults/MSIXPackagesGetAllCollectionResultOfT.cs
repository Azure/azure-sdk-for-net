...
namespace Azure.ResourceManager.DesktopVirtualization
{
    internal partial class MSIXPackagesGetAllCollectionResultOfT : Pageable<MsixPackageData>
    {
        ...
        public MSIXPackagesGetAllCollectionResultOfT(MSIXPackages client, Guid subscriptionId, string resourceGroupName, string hostPoolName, int? pageSize, bool? isDescending, int? initialSkip, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
