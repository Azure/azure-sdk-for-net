...
namespace Azure.ResourceManager.DesktopVirtualization
{
    internal partial class ApplicationGroupsGetBySubscriptionCollectionResultOfT : Pageable<VirtualApplicationGroupData>
    {
        ...
        public ApplicationGroupsGetBySubscriptionCollectionResultOfT(ApplicationGroups client, Guid subscriptionId, string filter, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
