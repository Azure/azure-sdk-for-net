...
namespace Azure.ResourceManager.DesktopVirtualization
{
    ...
    public partial class HostPoolResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<HostPoolResource>> UpdateAsync(WaitUntil waitUntil, HostPoolData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _hostPoolsRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, HostPoolData.ToRequestContent(data), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<HostPoolData> response = Response.FromValue(HostPoolData.FromResponse(result), result);
                RequestUriBuilder uri = message.Request.Uri;
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<HostPoolResource> Update(WaitUntil waitUntil, HostPoolData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
