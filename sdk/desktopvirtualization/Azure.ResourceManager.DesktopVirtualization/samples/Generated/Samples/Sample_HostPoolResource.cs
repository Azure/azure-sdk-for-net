...
namespace Azure.ResourceManager.DesktopVirtualization.Samples
{
    public partial class Sample_HostPoolResource
    {
        ...
        public async Task Delete_HostPoolDelete()
        {
            ...
            // invoke the operation
            bool? force = true;
            await hostPool.DeleteAsync(WaitUntil.Completed, force).ConfigureAwait(false);
...
DayOfWeek = DesktopVirtualizationDayOfWeek.Saturday,
        ...
        public async Task GetScalingPlans_ScalingPlanListByHostPool()
        {
            ...
            int? initialSkip = 0;
            await foreach (ScalingPlanResource item in hostPool.GetScalingPlansAsync(pageSize, isDescending, initialSkip))
            {
        ...
        public async Task GetUserSessions_UserSessionListByHostPool()
        {
            ...
            bool? isDescending = true;
            int? initialSkip = 0;
            await foreach (UserSessionResource item in hostPool.GetUserSessionsAsync(filter, pageSize, isDescending, initialSkip))
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
