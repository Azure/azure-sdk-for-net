...
{
    public partial class Sample_WorkspacePrivateEndpointConnectionCollection
    {
        ...
        public async Task GetAll_PrivateEndpointConnectionListByWorkspace()
        {
            ...
            await foreach (WorkspacePrivateEndpointConnectionResource item in collection.GetAllAsync())
            {
                ...
                PrivateEndpointConnectionWithSystemDataData resourceData = item.Data;
        ...
        public async Task Get_PrivateEndpointConnectionGetByWorkspace()
        {
            ...
            WorkspacePrivateEndpointConnectionResource result = await collection.GetAsync(privateEndpointConnectionName);
