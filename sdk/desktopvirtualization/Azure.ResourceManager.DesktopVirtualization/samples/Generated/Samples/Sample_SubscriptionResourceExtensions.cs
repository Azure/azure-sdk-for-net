...
namespace Azure.ResourceManager.DesktopVirtualization.Samples
{
    public partial class Sample_SubscriptionResourceExtensions
    {
        ...
        public async Task GetScalingPlans_ScalingPlansListBySubscription()
        {
            ...
            int? initialSkip = 0;
            await foreach (ScalingPlanResource item in subscriptionResource.GetScalingPlansAsync(pageSize, isDescending, initialSkip))
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
        ...
        public async Task GetVirtualApplicationGroups_ApplicationGroupList()
        {
            ...
            await foreach (VirtualApplicationGroupResource item in subscriptionResource.GetVirtualApplicationGroupsAsync(filter))
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
        ...
        public async Task GetHostPools_HostPoolList()
        {
            ...
            bool? isDescending = true;
            int? initialSkip = 0;
            await foreach (HostPoolResource item in subscriptionResource.GetHostPoolsAsync(pageSize, isDescending, initialSkip))
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
        ...
        public async Task GetAppAttachPackages_AppAttachPackageListBySubscription()
        {
            ...
            await foreach (AppAttachPackageResource item in subscriptionResource.GetAppAttachPackagesAsync(filter))
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
