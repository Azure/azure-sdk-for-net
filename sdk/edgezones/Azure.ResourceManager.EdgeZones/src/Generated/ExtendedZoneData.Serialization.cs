...
namespace Azure.ResourceManager.EdgeZones
{
    ...
    public partial class ExtendedZoneData : ResourceData, IJsonModel<ExtendedZoneData>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ExtendedZoneData IJsonModel<ExtendedZoneData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (ExtendedZoneData)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static ExtendedZoneData DeserializeExtendedZoneData(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            ExtendedZoneProperties properties = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("systemData"u8))
                {
                    ...
                    systemData = ModelReaderWriter.Read<SystemData>(new BinaryData(Encoding.UTF8.GetBytes(prop.Value.GetRawText())), ModelSerializationExtensions.WireOptions, AzureResourceManagerEdgeZonesContext.Default);
                    continue;
                }
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = ExtendedZoneProperties.DeserializeExtendedZoneProperties(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ExtendedZoneData>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
