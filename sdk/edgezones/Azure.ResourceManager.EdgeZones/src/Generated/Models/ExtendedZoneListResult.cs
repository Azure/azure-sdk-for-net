...
namespace Azure.ResourceManager.EdgeZones.Models
{
    ...
    internal partial class ExtendedZoneListResult
    {
        ...
        internal ExtendedZoneListResult(IList<ExtendedZoneData> value, Uri nextLink, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            NextLink = nextLink;
        ...
        public IList<ExtendedZoneData> Value { get; }
