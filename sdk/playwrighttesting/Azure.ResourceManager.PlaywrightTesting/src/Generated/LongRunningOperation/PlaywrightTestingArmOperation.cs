...
#pragma warning disable SA1649 // File name should match first type name
    internal class PlaywrightTestingArmOperation : ArmOperation
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        /// <summary> Initializes a new instance of PlaywrightTestingArmOperation for mocking. </summary>
        protected PlaywrightTestingArmOperation()
        {
        }

        internal PlaywrightTestingArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal PlaywrightTestingArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal(nextLinkOperation, clientDiagnostics, response, "PlaywrightTestingArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
        ...
        private string GetOperationId(RehydrationToken? rehydrationToken)
        {
            ...
            var lroDetails = ModelReaderWriter.Write(rehydrationToken, ModelReaderWriterOptions.Json, AzureResourceManagerPlaywrightTestingContext.Default).ToObjectFromJson<Dictionary<string, string>>();
