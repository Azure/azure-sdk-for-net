...
namespace Azure.ResourceManager.PlaywrightTesting.Models
{
    ...
    public partial class AccountProperties
    {
        ...
        internal AccountProperties(Uri dashboardUri, EnablementStatus? regionalAffinity, EnablementStatus? scalableExecution, EnablementStatus? reporting, PlaywrightTestingProvisioningState? provisioningState, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
