...
{
    public partial class PlaywrightTestingAccountData : IUtf8JsonSerializable, IJsonModel<PlaywrightTestingAccountData>, IPersistableModel<PlaywrightTestingAccountData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(DashboardUri))
            {
                builder.Append("  dashboardUri:");
                builder.AppendLine($" '{DashboardUri.AbsoluteUri}'");
            }

            if (Optional.IsDefined(RegionalAffinity))
            {
                builder.Append("  regionalAffinity:");
                builder.AppendLine($" '{RegionalAffinity.ToString()}'");
            }

            if (Optional.IsDefined(ScalableExecution))
            {
                builder.Append("  scalableExecution:");
                builder.AppendLine($" '{ScalableExecution.ToString()}'");
            }

            if (Optional.IsDefined(Reporting))
            {
                builder.Append("  reporting:");
                builder.AppendLine($" '{Reporting.ToString()}'");
            }
