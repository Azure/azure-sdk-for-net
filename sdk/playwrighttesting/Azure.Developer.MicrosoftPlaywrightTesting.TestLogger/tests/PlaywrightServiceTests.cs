...
public class PlaywrightServiceTests
{
    ...
    public void Setup()
    {
        ...
        Environment.SetEnvironmentVariable(ServiceEnvironmentVariable.PlaywrightServiceOs.ToString(), null);
        Environment.SetEnvironmentVariable(ServiceEnvironmentVariable.PlaywrightServiceRunId.ToString().ToString(), null);
        Environment.SetEnvironmentVariable(ServiceEnvironmentVariable.PlaywrightServiceExposeNetwork.ToString(), null);
    ...
    public void Constructor_NoServiceParams_SetsDefaultValues()
    {
        ...
        Assert.Multiple(() =>
        {
            Assert.That(Environment.GetEnvironmentVariable(ServiceEnvironmentVariable.PlaywrightServiceOs.ToString()), Is.EqualTo(Constants.s_default_os));
            Assert.That(Environment.GetEnvironmentVariable(ServiceEnvironmentVariable.PlaywrightServiceExposeNetwork.ToString()), Is.EqualTo(Constants.s_default_expose_network));
            Assert.That(Environment.GetEnvironmentVariable(ServiceEnvironmentVariable.PlaywrightServiceRunId.ToString().ToString()), Is.Not.Null);
    ...
    public void Constructor_PassServiceOS_SetsServiceOS()
    {
        ...
        Assert.That(Environment.GetEnvironmentVariable(ServiceEnvironmentVariable.PlaywrightServiceOs.ToString()), Is.EqualTo(ServiceOs.Windows));
    ...
    public void Constructor_PassExposeNetwork_SetsExposeNetwork()
    {
        ...
        Assert.That(Environment.GetEnvironmentVariable(ServiceEnvironmentVariable.PlaywrightServiceExposeNetwork.ToString()), Is.EqualTo("new-expose"));
    ...
    public void Constructor_PassRunId_SetsRunId()
    {
        ...
        Assert.That(Environment.GetEnvironmentVariable(ServiceEnvironmentVariable.PlaywrightServiceRunId.ToString().ToString()), Is.EqualTo("new-run-id"));
    ...
    {
        var playwrightService = new PlaywrightService(entraLifecycle: null, serviceAuth: ServiceAuthType.AccessToken.ToString());
    ...
    {
        Environment.SetEnvironmentVariable(ServiceEnvironmentVariable.PlaywrightServiceOs.ToString(), ServiceOs.Windows);
    ...
    {
        Environment.SetEnvironmentVariable(ServiceEnvironmentVariable.PlaywrightServiceExposeNetwork.ToString(), "new-expose");
        _ = new PlaywrightService(entraLifecycle: null);
        Assert.That(Environment.GetEnvironmentVariable(ServiceEnvironmentVariable.PlaywrightServiceExposeNetwork.ToString()), Is.EqualTo("new-expose"));
    }
    ...
    {
        _ = new PlaywrightService(entraLifecycle: null, os: OSPlatform.Linux, exposeNetwork: "old-expose", runId: "old-run-id", useCloudHostedBrowsers: false, serviceAuth: ServiceAuthType.EntraId.ToString());
        var newPlaywrightService = new PlaywrightService(entraLifecycle: null, os: OSPlatform.Windows, exposeNetwork: "new-expose", runId: "new-run-id", useCloudHostedBrowsers: true, serviceAuth: ServiceAuthType.AccessToken.ToString());
        Assert.Multiple(() =>
        {
            Assert.That(Environment.GetEnvironmentVariable(ServiceEnvironmentVariable.PlaywrightServiceOs.ToString()), Is.EqualTo(ServiceOs.Linux));
            Assert.That(Environment.GetEnvironmentVariable(ServiceEnvironmentVariable.PlaywrightServiceExposeNetwork.ToString()), Is.EqualTo("old-expose"));
            Assert.That(Environment.GetEnvironmentVariable(ServiceEnvironmentVariable.PlaywrightServiceRunId.ToString().ToString()), Is.EqualTo("old-run-id"));
            Assert.That(Environment.GetEnvironmentVariable(Constants.s_playwright_service_disable_scalable_execution_environment_variable), Is.EqualTo("true"));
            Assert.That(Environment.GetEnvironmentVariable(Constants.s_playwright_service_auth_type_environment_variable), Is.EqualTo(ServiceAuthType.EntraId.ToString()));
    ...
    public void InitializeAsync_WhenDefaultAuthIsEntraIdAccessTokenAndAccessTokenEnvironmentVariableIsSetAndCredentialsArePassed_FetchesEntraIdAccessTokenUsedPassedCredentials()
    {
        ...
        tokenCredential
            ...
            .ReturnsAsync(new AccessToken(token, DateTimeOffset.UtcNow.AddMinutes(10)));
        Environment.SetEnvironmentVariable(ServiceEnvironmentVariable.PlaywrightServiceAccessToken.ToString(), "access_token");
        PlaywrightService service = new(credential: tokenCredential.Object, new PlaywrightServiceOptions());
        service.InitializeAsync().Wait();
...
#pragma warning restore CS8625 // Cannot convert null literal to non-nullable reference type.
    ...
    public void InitializeAsync_WhenDefaultAuthIsMptPATAndPATIsSet_DoesNotSetUpRotationHandler()
    {
        ...
        var defaultAzureCredentialMock = new Mock<DefaultAzureCredential>();
        var entraLifecycleMock = new Mock<EntraLifecycle>(defaultAzureCredentialMock.Object, new JsonWebTokenHandler(), null);
        PlaywrightService service = new(entraLifecycle: entraLifecycleMock.Object, jsonWebTokenHandler: new JsonWebTokenHandler(), serviceAuth: ServiceAuthType.AccessToken.ToString());
        service.InitializeAsync().Wait();
        Assert.That(service.RotationTimer, Is.Null);
    }
    ...
    public void Initialize_WhenFailsToFetchEntraIdAccessToken_ThrowsException()
    {
        ...
        var entraLifecycleMock = new Mock<EntraLifecycle>(defaultAzureCredentialMock.Object, jsonWebTokenHandlerMock.Object, null);
        PlaywrightService service = new(entraLifecycle: entraLifecycleMock.Object);
        Exception? ex = Assert.Throws<Exception>(() => service.Initialize());
        Assert.That(ex!.Message, Is.EqualTo(Constants.s_no_auth_error));
    }
    ...
    public void Initialize_WhenEntraIdAccessTokenFailsAndMptPatIsNotValid_ThrowsError()
    {
        ...
        var entraLifecycleMock = new Mock<EntraLifecycle>(defaultAzureCredentialMock.Object, new JsonWebTokenHandler(), null);
        PlaywrightService service = new(entraLifecycle: entraLifecycleMock.Object, jsonWebTokenHandler: new JsonWebTokenHandler());
        Assert.That(() => service.Initialize(), Throws.Exception);
    }
...
#pragma warning restore CS8625 // Cannot convert null literal to non-nullable reference type.
    ...
    public async Task GetConnectOptionsAsync_WhenParametersAreSetInTheObject_UsesObjectParameters()
    {
        ...
        Environment.SetEnvironmentVariable(ServiceEnvironmentVariable.PlaywrightServiceOs.ToString(), ServiceOs.Linux);
        Environment.SetEnvironmentVariable(ServiceEnvironmentVariable.PlaywrightServiceExposeNetwork.ToString(), "expose");
        Environment.SetEnvironmentVariable(ServiceEnvironmentVariable.PlaywrightServiceRunId.ToString().ToString(), "invalid-run-id");
    ...
    public async Task GetConnectOptionsAsync_WhenServiceParametersAreSetViaEnvironment_SetsServiceParameters()
    {
        ...
        Environment.SetEnvironmentVariable(ServiceEnvironmentVariable.PlaywrightServiceOs.ToString(), ServiceOs.Windows);
        Environment.SetEnvironmentVariable(ServiceEnvironmentVariable.PlaywrightServiceExposeNetwork.ToString(), "localhost");
        Environment.SetEnvironmentVariable(ServiceEnvironmentVariable.PlaywrightServiceRunId.ToString().ToString(), runId);
