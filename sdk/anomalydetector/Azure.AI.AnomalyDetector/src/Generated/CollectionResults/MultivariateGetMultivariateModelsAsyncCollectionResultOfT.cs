...
namespace Azure.AI.AnomalyDetector
{
    internal partial class MultivariateGetMultivariateModelsAsyncCollectionResultOfT : AsyncPageable<AnomalyDetectionModel>
    {
        ...
        public MultivariateGetMultivariateModelsAsyncCollectionResultOfT(Multivariate client, int? skip, int? top, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _skip = skip;
            _top = top;
