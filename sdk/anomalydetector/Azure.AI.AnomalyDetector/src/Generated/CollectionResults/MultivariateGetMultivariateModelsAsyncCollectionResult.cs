...
{
    internal partial class MultivariateGetMultivariateModelsAsyncCollectionResult : AsyncPageable<global::System.BinaryData>
    {
        ...
        /// <summary> Initializes a new instance of MultivariateGetMultivariateModelsAsyncCollectionResult, which is used to iterate over the pages of a collection. </summary>
        ...
        public MultivariateGetMultivariateModelsAsyncCollectionResult(Multivariate client, int? skip, int? maxCount, RequestContext context, string diagnosticScope) : base((context?.CancellationToken ?? default))
        {
            _client = client;
            _skip = skip;
            _maxCount = maxCount;
        ...
        /// <summary> Gets the pages of MultivariateGetMultivariateModelsAsyncCollectionResult as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of MultivariateGetMultivariateModelsAsyncCollectionResult as an enumerable collection. </returns>
