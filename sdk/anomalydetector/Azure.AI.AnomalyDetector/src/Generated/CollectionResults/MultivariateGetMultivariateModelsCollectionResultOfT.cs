...
{
    internal partial class MultivariateGetMultivariateModelsCollectionResultOfT : Pageable<global::Azure.AI.AnomalyDetector.AnomalyDetectionModel>
    {
        ...
        public MultivariateGetMultivariateModelsCollectionResultOfT(Multivariate client, int? skip, int? maxCount, RequestContext context, string diagnosticScope) : base((context?.CancellationToken ?? default))
        {
            _client = client;
            _skip = skip;
            _maxCount = maxCount;
        ...
        public override IEnumerable<global::Azure.Page<global::Azure.AI.AnomalyDetector.AnomalyDetectionModel>> AsPages(string continuationToken, int? pageSizeHint)
        {
