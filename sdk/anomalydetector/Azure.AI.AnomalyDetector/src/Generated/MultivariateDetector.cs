...
{
    /// <summary> The MultivariateDetector sub-client. </summary>
    public partial class MultivariateDetector
    {
        private readonly Uri _endpoint;
        private readonly string _apiVersion;

        /// <summary> Initializes a new instance of MultivariateDetector for mocking. </summary>
        protected MultivariateDetector()
        {
        }
        ...
        internal MultivariateDetector(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Uri endpoint, string apiVersion)
        {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("MultivariateDetector.GetMultivariateBatchDetectionResult");
            scope.Start();
            try
            {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("MultivariateDetector.TrainMultivariateModel");
            scope.Start();
            try
            {
        ...
        {
            return new MultivariateDetectorGetMultivariateModelsCollectionResult(this, skip, maxCount, context, "MultivariateDetector.GetMultivariateModels");
        }
        ...
        {
            return new MultivariateDetectorGetMultivariateModelsAsyncCollectionResult(this, skip, maxCount, context, "MultivariateDetector.GetMultivariateModels");
        }
        ...
        {
            return new MultivariateDetectorGetMultivariateModelsCollectionResultOfT(this, skip, maxCount, cancellationToken.ToRequestContext(), "MultivariateDetector.GetMultivariateModels");
        }
        ...
        {
            return new MultivariateDetectorGetMultivariateModelsAsyncCollectionResultOfT(this, skip, maxCount, cancellationToken.ToRequestContext(), "MultivariateDetector.GetMultivariateModels");
        }
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("MultivariateDetector.DeleteMultivariateModel");
            scope.Start();
            try
            {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("MultivariateDetector.GetMultivariateModel");
            scope.Start();
            try
            {
                Argument.AssertNotNullOrEmpty(modelId, nameof(modelId));
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("MultivariateDetector.DetectMultivariateBatchAnomaly");
            scope.Start();
            try
            {
                Argument.AssertNotNullOrEmpty(modelId, nameof(modelId));
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("MultivariateDetector.DetectMultivariateLastAnomaly");
            scope.Start();
            try
            {
                Argument.AssertNotNullOrEmpty(modelId, nameof(modelId));
