...
namespace Azure.AI.AnomalyDetector
{
    ...
    public partial class UnivariateLastDetectionResult
    {
        ...
        internal UnivariateLastDetectionResult(int period, int suggestedWindow, float expectedValue, float upperMargin, float lowerMargin, bool isAnomaly, bool isNegativeAnomaly, bool isPositiveAnomaly, float? severity, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Period = period;
            SuggestedWindow = suggestedWindow;
            ExpectedValue = expectedValue;
