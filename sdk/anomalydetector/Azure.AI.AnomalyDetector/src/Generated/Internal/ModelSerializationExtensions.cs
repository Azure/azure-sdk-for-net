...
namespace Azure.AI.AnomalyDetector
{
    ...
    {
        private static readonly JsonSerializerOptions s_options = new JsonSerializerOptions { Converters = { new JsonModelConverter(WireOptions, AzureAIAnomalyDetectorContext.Default) } };
