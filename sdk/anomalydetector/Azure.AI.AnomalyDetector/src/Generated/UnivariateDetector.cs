...
{
    /// <summary> The UnivariateDetector sub-client. </summary>
    public partial class UnivariateDetector
    {
        private readonly Uri _endpoint;
        private readonly string _apiVersion;

        /// <summary> Initializes a new instance of UnivariateDetector for mocking. </summary>
        ...
        internal UnivariateDetector(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Uri endpoint, string apiVersion)
        {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("UnivariateDetector.DetectUnivariateEntireSeries");
            scope.Start();
            try
            {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("UnivariateDetector.DetectUnivariateLastPoint");
            scope.Start();
            try
            {
                Argument.AssertNotNull(content, nameof(content));
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("UnivariateDetector.DetectUnivariateChangePoint");
            scope.Start();
            try
            {
                Argument.AssertNotNull(content, nameof(content));
