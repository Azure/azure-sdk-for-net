...
{
    public partial class MultivariateTests : AIAnomalyDetectorTestBase
    {
        public MultivariateTests(bool isAsync) : base(isAsync)
        {
        }

        [Test]
        [Ignore("Please remove the Ignore attribute to let the test method run")]
        public async Task Multivariate_GetMultivariateBatchDetectionResult_GetMultivariateBatchDetectionResult()
        {
            Uri endpoint = new Uri("<endpoint>");
            AzureKeyCredential credential = new AzureKeyCredential("<key>");
            Multivariate client = CreateAnomalyDetectorClient(endpoint, credential).GetMultivariateClient();
        ...
        [Test]
        [Ignore("Please remove the Ignore attribute to let the test method run")]
        public async Task Multivariate_GetMultivariateBatchDetectionResult_GetMultivariateBatchDetectionResult_Convenience()
        {
            Uri endpoint = new Uri("<endpoint>");
            AzureKeyCredential credential = new AzureKeyCredential("<key>");
            Multivariate client = CreateAnomalyDetectorClient(endpoint, credential).GetMultivariateClient();
        ...
        [Test]
        [Ignore("Please remove the Ignore attribute to let the test method run")]
        public async Task Multivariate_TrainMultivariateModel_CreateAndTrainMultivariateModel()
        {
            Uri endpoint = new Uri("<endpoint>");
            AzureKeyCredential credential = new AzureKeyCredential("<key>");
            Multivariate client = CreateAnomalyDetectorClient(endpoint, credential).GetMultivariateClient();
        ...
        [Test]
        [Ignore("Please remove the Ignore attribute to let the test method run")]
        public async Task Multivariate_TrainMultivariateModel_CreateAndTrainMultivariateModel_Convenience()
        {
            Uri endpoint = new Uri("<endpoint>");
            AzureKeyCredential credential = new AzureKeyCredential("<key>");
            Multivariate client = CreateAnomalyDetectorClient(endpoint, credential).GetMultivariateClient();
        ...
        [Test]
        [Ignore("Please remove the Ignore attribute to let the test method run")]
        public async Task Multivariate_DeleteMultivariateModel_DeleteMultivariateModel()
        {
            Uri endpoint = new Uri("<endpoint>");
            AzureKeyCredential credential = new AzureKeyCredential("<key>");
            Multivariate client = CreateAnomalyDetectorClient(endpoint, credential).GetMultivariateClient();
        ...
        [Test]
        [Ignore("Please remove the Ignore attribute to let the test method run")]
        public async Task Multivariate_GetMultivariateModel_GetAMultivariateModel()
        {
            Uri endpoint = new Uri("<endpoint>");
            AzureKeyCredential credential = new AzureKeyCredential("<key>");
            Multivariate client = CreateAnomalyDetectorClient(endpoint, credential).GetMultivariateClient();
        ...
        [Test]
        [Ignore("Please remove the Ignore attribute to let the test method run")]
        public async Task Multivariate_GetMultivariateModel_GetAMultivariateModel_Convenience()
        {
            Uri endpoint = new Uri("<endpoint>");
            AzureKeyCredential credential = new AzureKeyCredential("<key>");
            Multivariate client = CreateAnomalyDetectorClient(endpoint, credential).GetMultivariateClient();
        ...
        [Test]
        [Ignore("Please remove the Ignore attribute to let the test method run")]
        public async Task Multivariate_DetectMultivariateBatchAnomaly_DetectMultivariateBatchAnomaly()
        {
            Uri endpoint = new Uri("<endpoint>");
            AzureKeyCredential credential = new AzureKeyCredential("<key>");
            Multivariate client = CreateAnomalyDetectorClient(endpoint, credential).GetMultivariateClient();
        ...
        [Test]
        [Ignore("Please remove the Ignore attribute to let the test method run")]
        public async Task Multivariate_DetectMultivariateBatchAnomaly_DetectMultivariateBatchAnomaly_Convenience()
        {
            Uri endpoint = new Uri("<endpoint>");
            AzureKeyCredential credential = new AzureKeyCredential("<key>");
            Multivariate client = CreateAnomalyDetectorClient(endpoint, credential).GetMultivariateClient();
        ...
        [Test]
        [Ignore("Please remove the Ignore attribute to let the test method run")]
        public async Task Multivariate_DetectMultivariateLastAnomaly_DetectMultivariateLastAnomaly()
        {
            Uri endpoint = new Uri("<endpoint>");
            AzureKeyCredential credential = new AzureKeyCredential("<key>");
            Multivariate client = CreateAnomalyDetectorClient(endpoint, credential).GetMultivariateClient();
...
0.93626815F
        ...
        [Test]
        [Ignore("Please remove the Ignore attribute to let the test method run")]
        public async Task Multivariate_DetectMultivariateLastAnomaly_DetectMultivariateLastAnomaly_Convenience()
        {
            Uri endpoint = new Uri("<endpoint>");
            AzureKeyCredential credential = new AzureKeyCredential("<key>");
            Multivariate client = CreateAnomalyDetectorClient(endpoint, credential).GetMultivariateClient();
...
new VariableValues("Variable_3", new string[]{"2021-01-01T00:00:00Z", "2021-01-01T00:01:00Z", "2021-01-01T00:02:00Z", "2021-01-01T00:03:00Z", "2021-01-01T00:04:00Z", "2021-01-01T00:05:00Z", "2021-01-01T00:06:00Z", "2021-01-01T00:07:00Z", "2021-01-01T00:08:00Z", "2021-01-01T00:09:00Z", "2021-01-01T00:10:00Z", "2021-01-01T00:11:00Z", "2021-01-01T00:12:00Z", "2021-01-01T00:13:00Z", "2021-01-01T00:14:00Z", "2021-01-01T00:15:00Z", "2021-01-01T00:16:00Z", "2021-01-01T00:17:00Z", "2021-01-01T00:18:00Z", "2021-01-01T00:19:00Z", "2021-01-01T00:20:00Z", "2021-01-01T00:21:00Z", "2021-01-01T00:22:00Z", "2021-01-01T00:23:00Z", "2021-01-01T00:24:00Z", "2021-01-01T00:25:00Z", "2021-01-01T00:26:00Z", "2021-01-01T00:27:00Z", "2021-01-01T00:28:00Z", "2021-01-01T00:29:00Z"}, new float[]{0.4030757F, 0.1552689F, 0.36352226F, 0.60512006F, 0.8516795F, 0.26456058F, 0.68108755F, 0.91658944F, 0.70078325F, 0.56241554F, 0.62772894F, 0.15992056F, 0.60209644F, 0.35937968F, 0.8731686F, 0.20301549F, 0.029261872F, 0.62614995F, 0.4585078F, 0.8275007F, 0.03276027F, 0.44852027F, 0.8915691F, 0.89166903F, 0.94699794F, 0.115293086F, 0.088187724F, 0.74262863F, 0.32372248F, 0.93626815F})
        ...
        [Test]
        [Ignore("Please remove the Ignore attribute to let the test method run")]
        public async Task Multivariate_GetMultivariateModels_ListMultivariateModels()
        {
            Uri endpoint = new Uri("<endpoint>");
            AzureKeyCredential credential = new AzureKeyCredential("<key>");
            Multivariate client = CreateAnomalyDetectorClient(endpoint, credential).GetMultivariateClient();
        ...
        [Test]
        [Ignore("Please remove the Ignore attribute to let the test method run")]
        public async Task Multivariate_GetMultivariateModels_ListMultivariateModels_Convenience()
        {
            Uri endpoint = new Uri("<endpoint>");
            AzureKeyCredential credential = new AzureKeyCredential("<key>");
            Multivariate client = CreateAnomalyDetectorClient(endpoint, credential).GetMultivariateClient();
