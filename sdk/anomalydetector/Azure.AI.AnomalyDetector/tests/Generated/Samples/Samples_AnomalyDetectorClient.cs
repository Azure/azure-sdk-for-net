    ...
    new TimeSeriesPoint(3.14f)
{
        ...
        public async Task Example_TrainMultivariateModel_Convenience_Async()
        {
            ...
            var modelInfo = new ModelInfo(null, DateTimeOffset.UtcNow, DateTimeOffset.UtcNow)
            {
        ...
        public async Task Example_DetectMultivariateBatchAnomaly_Convenience_Async()
        {
            ...
            var options = new MultivariateBatchDetectionOptions(null, DateTimeOffset.UtcNow, DateTimeOffset.UtcNow)
            {
                TopContributorCount = 1234,
            };
