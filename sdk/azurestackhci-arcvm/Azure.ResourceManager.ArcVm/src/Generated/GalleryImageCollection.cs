...
namespace Azure.ResourceManager.ArcVm
{
    ...
    public partial class GalleryImageCollection : ArmCollection, IEnumerable<GalleryImageResource>, IAsyncEnumerable<GalleryImageResource>
    {
        ...
        {
            _galleryImageClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.ArcVm", GalleryImageResource.ResourceType.Namespace, Diagnostics);
        ...
        /// <param name="data"> The GalleryImage to use. </param>
