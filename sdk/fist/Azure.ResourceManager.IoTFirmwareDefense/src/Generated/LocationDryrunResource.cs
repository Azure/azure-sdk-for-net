...
namespace Azure.ResourceManager.IoTFirmwareDefense
{
    ...
    public partial class LocationDryrunResource : ArmResource
    {
        ...
        {
            _locationDryrunConnectorClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.IoTFirmwareDefense", ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<LocationDryrunResource>> UpdateAsync(WaitUntil waitUntil, DryrunPatch patch, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new IoTFirmwareDefenseArmOperation<LocationDryrunResource>(new LocationDryrunOperationSource(Client), _locationDryrunConnectorClientDiagnostics, Pipeline, _locationDryrunConnectorRestClient.CreateUpdateDryrunRequest(Id.SubscriptionId, Id.ResourceGroupName, new AzureLocation(Id.Parent.Name), Id.Name, patch).Request, response, OperationFinalStateVia.AzureAsyncOperation);
                if (waitUntil == WaitUntil.Completed)
