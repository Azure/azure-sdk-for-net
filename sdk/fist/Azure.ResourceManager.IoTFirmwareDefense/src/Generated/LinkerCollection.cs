...
namespace Azure.ResourceManager.IoTFirmwareDefense
{
    ...
    public partial class LinkerCollection : ArmCollection, IEnumerable<LinkerResource>, IAsyncEnumerable<LinkerResource>
    {
        ...
        {
            _linkerClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.IoTFirmwareDefense", LinkerResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<LinkerResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string linkerName, LinkerResourceData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new IoTFirmwareDefenseArmOperation<LinkerResource>(new LinkerOperationSource(Client), _linkerClientDiagnostics, Pipeline, _linkerRestClient.CreateCreateOrUpdateRequest(Id, linkerName, data).Request, response, OperationFinalStateVia.AzureAsyncOperation);
