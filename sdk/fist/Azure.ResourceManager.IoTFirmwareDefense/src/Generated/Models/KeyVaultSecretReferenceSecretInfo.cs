...
namespace Azure.ResourceManager.IoTFirmwareDefense.Models
{
    ...
    public partial class KeyVaultSecretReferenceSecretInfo : SecretInfoBase
    {
        ...
        {
            SecretType = SecretType.KeyVaultSecretReference;
        }
        ...
        internal KeyVaultSecretReferenceSecretInfo(SecretType secretType, string name, string version) : base(secretType)
        {
            Name = name;
            Version = version;
