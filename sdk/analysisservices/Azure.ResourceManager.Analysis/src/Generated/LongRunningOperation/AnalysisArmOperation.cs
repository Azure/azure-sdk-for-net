...
#pragma warning disable SA1649 // File name should match first type name
    internal class AnalysisArmOperation : ArmOperation
#pragma warning restore SA1649 // File name should match first type name
    {
        private readonly OperationInternal _operation;

        /// <summary> Initializes a new instance of AnalysisArmOperation for mocking. </summary>
        protected AnalysisArmOperation()
        {
        }

        internal AnalysisArmOperation(Response response)
        {
            _operation = OperationInternal.Succeeded(response);
        }

        internal AnalysisArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal(nextLinkOperation, clientDiagnostics, response, "AnalysisArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
