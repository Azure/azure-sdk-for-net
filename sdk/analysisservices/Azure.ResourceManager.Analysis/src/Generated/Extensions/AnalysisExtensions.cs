...
using Azure.ResourceManager.Analysis.Testing;
...
namespace Azure.ResourceManager.Analysis
{
    ...
    {
        private static AnalysisResourceGroupResourceExtension GetAnalysisResourceGroupResourceExtension(ArmResource resource)
        {
            return resource.GetCachedClient(client =>
            {
                return new AnalysisResourceGroupResourceExtension(client, resource.Id);
            });
        }

        private static AnalysisResourceGroupResourceExtension GetAnalysisResourceGroupResourceExtension(ArmClient client, ResourceIdentifier scope)
        {
            return client.GetResourceClient(() =>
            {
                return new AnalysisResourceGroupResourceExtension(client, scope);
            });
        }

        private static AnalysisSubscriptionResourceExtension GetAnalysisSubscriptionResourceExtension(ArmResource resource)
        {
            return resource.GetCachedClient(client =>
            {
                return new AnalysisSubscriptionResourceExtension(client, resource.Id);
            });
        }

        private static AnalysisSubscriptionResourceExtension GetAnalysisSubscriptionResourceExtension(ArmClient client, ResourceIdentifier scope)
        {
            return client.GetResourceClient(() =>
            {
                return new AnalysisSubscriptionResourceExtension(client, scope);
            });
        }
        ...
        {
            return GetAnalysisResourceGroupResourceExtension(resourceGroupResource).GetAnalysisServers();
        }
        ...
        {
            return GetAnalysisSubscriptionResourceExtension(subscriptionResource).GetAnalysisServersAsync(cancellationToken);
        }
        ...
        {
            return GetAnalysisSubscriptionResourceExtension(subscriptionResource).GetAnalysisServers(cancellationToken);
        }
        ...
        {
            return GetAnalysisSubscriptionResourceExtension(subscriptionResource).GetEligibleSkusAsync(cancellationToken);
        }
        ...
        {
            return GetAnalysisSubscriptionResourceExtension(subscriptionResource).GetEligibleSkus(cancellationToken);
        }
        ...
        public static async Task<Response<AnalysisServerNameAvailabilityResult>> CheckAnalysisServerNameAvailabilityAsync(this SubscriptionResource subscriptionResource, AzureLocation location, AnalysisServerNameAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            ...
            return await GetAnalysisSubscriptionResourceExtension(subscriptionResource).CheckAnalysisServerNameAvailabilityAsync(location, content, cancellationToken).ConfigureAwait(false);
        }
        ...
        public static Response<AnalysisServerNameAvailabilityResult> CheckAnalysisServerNameAvailability(this SubscriptionResource subscriptionResource, AzureLocation location, AnalysisServerNameAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            ...
            return GetAnalysisSubscriptionResourceExtension(subscriptionResource).CheckAnalysisServerNameAvailability(location, content, cancellationToken);
        }
    }
}
