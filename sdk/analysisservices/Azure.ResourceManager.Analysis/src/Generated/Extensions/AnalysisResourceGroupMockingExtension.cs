...
namespace Azure.ResourceManager.Analysis.Mocking
{
    ...
    internal partial class AnalysisResourceGroupMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="AnalysisResourceGroupMockingExtension"/> class for mocking. </summary>
        protected AnalysisResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="AnalysisResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal AnalysisResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
