...
namespace Azure.ResourceManager.Analysis.Mock
{
    ...
    public partial class AnalysisServerResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="AnalysisServerResourceExtension"/> class for mocking. </summary>
        protected AnalysisServerResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="AnalysisServerResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal AnalysisServerResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<AnalysisServerResource> GetAnalysisServersAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, null, e => new AnalysisServerResource(Client, AnalysisServerData.DeserializeAnalysisServerData(e)), AnalysisServerServersClientDiagnostics, Pipeline, "AnalysisServerResourceExtension.GetAnalysisServers", "value", null, cancellationToken);
        }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => AnalysisServerServersRestClient.CreateListRequest(Id.SubscriptionId);
            return PageableHelpers.CreatePageable(FirstPageRequest, null, e => new AnalysisServerResource(Client, AnalysisServerData.DeserializeAnalysisServerData(e)), AnalysisServerServersClientDiagnostics, Pipeline, "AnalysisServerResourceExtension.GetAnalysisServers", "value", null, cancellationToken);
        }
        ...
        public virtual AsyncPageable<AnalysisResourceSku> GetEligibleSkusAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, null, AnalysisResourceSku.DeserializeAnalysisResourceSku, AnalysisServerServersClientDiagnostics, Pipeline, "AnalysisServerResourceExtension.GetEligibleSkus", "value", null, cancellationToken);
        }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => AnalysisServerServersRestClient.CreateListSkusForNewRequest(Id.SubscriptionId);
            return PageableHelpers.CreatePageable(FirstPageRequest, null, AnalysisResourceSku.DeserializeAnalysisResourceSku, AnalysisServerServersClientDiagnostics, Pipeline, "AnalysisServerResourceExtension.GetEligibleSkus", "value", null, cancellationToken);
        }
        ...
        public virtual async Task<Response<AnalysisServerNameAvailabilityResult>> CheckAnalysisServerNameAvailabilityAsync(AzureLocation location, AnalysisServerNameAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = AnalysisServerServersClientDiagnostics.CreateScope("AnalysisServerResourceExtension.CheckAnalysisServerNameAvailability");
            scope.Start();
            try
            {
