...
namespace Azure.ResourceManager.Analysis
{
    ...
    public partial class AnalysisServerCollection : ArmCollection, IEnumerable<AnalysisServerResource>, IAsyncEnumerable<AnalysisServerResource>
    {
        ...
        public virtual AsyncPageable<AnalysisServerResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, null, e => { var data = AnalysisServerData.DeserializeAnalysisServerData(e); return new AnalysisServerResource(Client, data, data.Id); }, _analysisServerServersClientDiagnostics, Pipeline, "AnalysisServerCollection.GetAll", "value", null, cancellationToken);
        }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _analysisServerServersRestClient.CreateListByResourceGroupRequest(Id.SubscriptionId, Id.ResourceGroupName);
            return PageableHelpers.CreatePageable(FirstPageRequest, null, e => { var data = AnalysisServerData.DeserializeAnalysisServerData(e); return new AnalysisServerResource(Client, data, data.Id); }, _analysisServerServersClientDiagnostics, Pipeline, "AnalysisServerCollection.GetAll", "value", null, cancellationToken);
        }
