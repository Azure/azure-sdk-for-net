...
namespace Azure.ResourceManager.Analysis.Models
{
    internal partial class ExistingResourceResultSkuEnumeration : IUtf8JsonSerializable, IJsonModel<ExistingResourceResultSkuEnumeration>
    {
        ...
        void IJsonModel<ExistingResourceResultSkuEnumeration>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(ExistingResourceResultSkuEnumeration)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ExistingResourceResultSkuEnumeration>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(ExistingResourceResultSkuEnumeration)} does not support '{options.Format}' format.");
            }
        }
