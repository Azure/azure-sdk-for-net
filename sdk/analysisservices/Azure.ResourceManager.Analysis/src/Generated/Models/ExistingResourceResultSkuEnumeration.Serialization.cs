...
namespace Azure.ResourceManager.Analysis.Models
{
    internal partial class ExistingResourceResultSkuEnumeration : IUtf8JsonSerializable, IModelJsonSerializable<ExistingResourceResultSkuEnumeration>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<ExistingResourceResultSkuEnumeration>(this, options.Format);
            ...
            if (Optional.IsCollectionDefined(Value))
            {
                ...
                foreach (var item in Value)
                {
                    ...
                    {
                        ((IModelJsonSerializable<AnalysisExistingSku>)item).Serialize(writer, options);
                    }
                }
        ...
        /// <summary> Converts a <see cref="ExistingResourceResultSkuEnumeration"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="ExistingResourceResultSkuEnumeration"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="ExistingResourceResultSkuEnumeration"/>. </summary>
