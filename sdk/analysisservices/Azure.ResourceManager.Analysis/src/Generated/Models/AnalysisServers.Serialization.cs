...
namespace Azure.ResourceManager.Analysis.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AnalysisServers>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AnalysisServers>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AnalysisServers>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AnalysisServers>)} interface");
            }
        ...
        string IPersistableModel<AnalysisServers>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
