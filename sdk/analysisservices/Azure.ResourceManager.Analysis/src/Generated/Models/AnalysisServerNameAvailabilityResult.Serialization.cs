...
namespace Azure.ResourceManager.Analysis.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AnalysisServerNameAvailabilityResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        AnalysisServerNameAvailabilityResult IJsonModel<AnalysisServerNameAvailabilityResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AnalysisServerNameAvailabilityResult)} does not support reading '{format}' format.");
            }
        ...
        internal static AnalysisServerNameAvailabilityResult DeserializeAnalysisServerNameAvailabilityResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new AnalysisServerNameAvailabilityResult(nameAvailable, reason, message, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<AnalysisServerNameAvailabilityResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AnalysisServerNameAvailabilityResult)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        AnalysisServerNameAvailabilityResult IPersistableModel<AnalysisServerNameAvailabilityResult>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AnalysisServerNameAvailabilityResult)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<AnalysisServerNameAvailabilityResult>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
