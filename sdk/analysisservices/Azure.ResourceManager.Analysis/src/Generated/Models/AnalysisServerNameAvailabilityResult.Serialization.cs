...
{
    public partial class AnalysisServerNameAvailabilityResult : IUtf8JsonSerializable, IJsonModel<AnalysisServerNameAvailabilityResult>, IPersistableModel<AnalysisServerNameAvailabilityResult>
    {
        ...
        void IJsonModel<AnalysisServerNameAvailabilityResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AnalysisServerNameAvailabilityResult)} does not support '{format}' format.");
            }
