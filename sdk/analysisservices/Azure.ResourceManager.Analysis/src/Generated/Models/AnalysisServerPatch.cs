...
namespace Azure.ResourceManager.Analysis.Models
{
    ...
    public partial class AnalysisServerPatch
    {
        ...
        internal AnalysisServerPatch(AnalysisResourceSku sku, IDictionary<string, string> tags, ServerAdministrators asAdministrators, Uri backupBlobContainerUri, AnalysisGatewayDetails gatewayDetails, AnalysisIPv4FirewallSettings ipV4FirewallSettings, AnalysisConnectionMode? querypoolConnectionMode, AnalysisManagedMode? managedMode, ServerMonitorMode? serverMonitorMode, Dictionary<string, BinaryData> rawData)
        {
            Sku = sku;
            Tags = tags;
