...
namespace Azure.ResourceManager.Analysis.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AnalysisGatewayStatus>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AnalysisGatewayStatus>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AnalysisGatewayStatus>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AnalysisGatewayStatus>)} interface");
            }
        ...
        string IPersistableModel<AnalysisGatewayStatus>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
