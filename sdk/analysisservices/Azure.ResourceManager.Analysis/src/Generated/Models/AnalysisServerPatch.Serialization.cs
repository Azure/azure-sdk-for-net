...
namespace Azure.ResourceManager.Analysis.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AnalysisServerPatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AnalysisServerPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AnalysisServerPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AnalysisServerPatch>)} interface");
            }
        ...
        string IPersistableModel<AnalysisServerPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
