...
namespace Azure.ResourceManager.Analysis.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AnalysisGatewayDetails>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AnalysisGatewayDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AnalysisGatewayDetails>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<AnalysisGatewayDetails>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
