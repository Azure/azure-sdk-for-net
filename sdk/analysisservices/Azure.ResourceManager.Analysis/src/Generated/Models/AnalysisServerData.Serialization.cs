...
{
    public partial class AnalysisServerData : IUtf8JsonSerializable, IJsonModel<AnalysisServerData>, IPersistableModel<AnalysisServerData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(AsAdministrators))
            {
                ...
                AppendChildObject(builder, AsAdministrators, options, 2);
            }
            ...
            if (Optional.IsDefined(GatewayDetails))
            {
                ...
                AppendChildObject(builder, GatewayDetails, options, 2);
            }

            if (Optional.IsDefined(IPv4FirewallSettings))
            {
                builder.Append("  ipV4FirewallSettings:");
                AppendChildObject(builder, IPv4FirewallSettings, options, 2);
            }

            if (Optional.IsDefined(QueryPoolConnectionMode))
            {
                builder.Append("  querypoolConnectionMode:");
                builder.AppendLine($" '{QueryPoolConnectionMode.ToString()}'");
            }

            if (Optional.IsDefined(ManagedMode))
            {
                builder.Append("  managedMode:");
                builder.AppendLine($" '{ManagedMode.ToString()}'");
            }

            if (Optional.IsDefined(ServerMonitorMode))
            {
                builder.Append("  serverMonitorMode:");
                builder.AppendLine($" '{ServerMonitorMode.ToString()}'");
            }
            ...
            {
                builder.Append("  sku:");
                AppendChildObject(builder, AnalysisServerSku, options, 2);
            }

            if (Optional.IsDefined(AnalysisSku))
            {
                builder.Append("  sku:");
                AppendChildObject(builder, AnalysisSku, options, 2);
            }
