...
namespace Azure.ResourceManager.Analysis.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ServerAdministrators>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ServerAdministrators>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ServerAdministrators>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<ServerAdministrators>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
