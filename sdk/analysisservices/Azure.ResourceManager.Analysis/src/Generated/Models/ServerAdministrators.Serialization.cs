...
namespace Azure.ResourceManager.Analysis.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ServerAdministrators>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        internal static ServerAdministrators DeserializeServerAdministrators(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new ServerAdministrators(members ?? new ChangeTrackingList<string>(), serializedAdditionalRawData);
        }
