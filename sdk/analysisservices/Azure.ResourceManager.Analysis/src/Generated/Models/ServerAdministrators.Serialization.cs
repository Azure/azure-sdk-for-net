...
namespace Azure.ResourceManager.Analysis.Models
{
    internal partial class ServerAdministrators : IUtf8JsonSerializable, IJsonModel<ServerAdministrators>
    {
        ...
        void IJsonModel<ServerAdministrators>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(ServerAdministrators)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ServerAdministrators>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(ServerAdministrators)} does not support '{options.Format}' format.");
            }
        }
