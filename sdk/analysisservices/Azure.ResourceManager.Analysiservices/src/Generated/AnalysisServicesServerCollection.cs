...
namespace Azure.ResourceManager.Analysiservices
{
    ...
    public partial class AnalysisServicesServerCollection : ArmCollection, IEnumerable<AnalysisServicesServerResource>, IAsyncEnumerable<AnalysisServicesServerResource>
    {
        ...
        {
            _analysisServicesServerServersClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Analysiservices", AnalysisServicesServerResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<AnalysisServicesServerResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string serverName, AnalysisServicesServerData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new AnalysiservicesArmOperation<AnalysisServicesServerResource>(new AnalysisServicesServerOperationSource(Client), _analysisServicesServerServersClientDiagnostics, Pipeline, _analysisServicesServerServersRestClient.CreateCreateRequest(Id.SubscriptionId, Id.ResourceGroupName, serverName, data).Request, response, OperationFinalStateVia.Location);
