...
#pragma warning disable SA1649 // File name should match first type name
    internal class AnalysiservicesArmOperation : ArmOperation
#pragma warning restore SA1649 // File name should match first type name
    {
        private readonly OperationInternal _operation;

        /// <summary> Initializes a new instance of AnalysiservicesArmOperation for mocking. </summary>
        protected AnalysiservicesArmOperation()
        {
        }

        internal AnalysiservicesArmOperation(Response response)
        {
            _operation = OperationInternal.Succeeded(response);
        }

        internal AnalysiservicesArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia)
        {
            ...
            _operation = new OperationInternal(clientDiagnostics, nextLinkOperation, response, "AnalysiservicesArmOperation", fallbackStrategy: new ExponentialDelayStrategy());
        }
