...
#pragma warning disable SA1649 // File name should match first type name
    internal class DellArmOperation : ArmOperation
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        /// <summary> Initializes a new instance of DellArmOperation for mocking. </summary>
        protected DellArmOperation()
        {
        }

        internal DellArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal DellArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal(nextLinkOperation, clientDiagnostics, response, "DellArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
