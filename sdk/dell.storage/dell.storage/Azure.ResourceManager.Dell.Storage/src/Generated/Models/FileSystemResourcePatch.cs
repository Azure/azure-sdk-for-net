...
namespace Azure.ResourceManager.Dell.Models
{
    ...
    public partial class FileSystemResourcePatch
    {
        ...
        internal FileSystemResourcePatch(ManagedServiceIdentityUpdate identity, IDictionary<string, string> tags, FileSystemResourceUpdateProperties properties, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Identity = identity;
            Tags = tags;
