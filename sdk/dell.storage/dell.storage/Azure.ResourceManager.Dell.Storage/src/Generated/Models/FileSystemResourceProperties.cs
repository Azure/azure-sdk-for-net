...
namespace Azure.ResourceManager.Dell.Models
{
    ...
    public partial class FileSystemResourceProperties
    {
        ...
        public FileSystemResourceProperties(MarketplaceDetails marketplace, string delegatedSubnetId, string delegatedSubnetCidr, UserDetails user, string dellReferenceNumber, EncryptionProperties encryption)
        {
        ...
        internal FileSystemResourceProperties(Capacity capacity, MarketplaceDetails marketplace, ProvisioningState? provisioningState, string delegatedSubnetId, string delegatedSubnetCidr, UserDetails user, string fileSystemId, string smartConnectFqdn, string oneFsUri, string dellReferenceNumber, EncryptionProperties encryption, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Capacity = capacity;
            Marketplace = marketplace;
        ...
        internal UserDetails User { get; set; }
        /// <summary> User Email. </summary>
        public string UserEmail
        {
            get => User is null ? default : User.Email;
            set => User = new UserDetails(value);
        }
