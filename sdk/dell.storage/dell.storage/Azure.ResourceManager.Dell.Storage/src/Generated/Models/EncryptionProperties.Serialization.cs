...
namespace Azure.ResourceManager.Dell.Models
{
    public partial class EncryptionProperties : IUtf8JsonSerializable, IJsonModel<EncryptionProperties>
    {
        ...
        internal static EncryptionProperties DeserializeEncryptionProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            EncryptionIdentityProperties encryptionIdentityProperties = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("encryptionIdentityProperties"u8))
                {
                    ...
                    encryptionIdentityProperties = EncryptionIdentityProperties.DeserializeEncryptionIdentityProperties(property.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
            ...
            return new EncryptionProperties(encryptionType, keyUrl, encryptionIdentityProperties, serializedAdditionalRawData);
        }
