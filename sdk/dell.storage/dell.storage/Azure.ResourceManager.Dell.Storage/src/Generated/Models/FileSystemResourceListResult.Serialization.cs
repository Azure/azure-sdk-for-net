...
namespace Azure.ResourceManager.Dell.Models
{
    internal partial class FileSystemResourceListResult : IUtf8JsonSerializable, IJsonModel<FileSystemResourceListResult>
    {
        ...
        internal static FileSystemResourceListResult DeserializeFileSystemResourceListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            IReadOnlyList<FileSystemResourceData> value = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    List<FileSystemResourceData> array = new List<FileSystemResourceData>();
                    foreach (var item in property.Value.EnumerateArray())
                    {
                        array.Add(FileSystemResourceData.DeserializeFileSystemResourceData(item, options));
                    }
                    value = array;
                    continue;
                }
