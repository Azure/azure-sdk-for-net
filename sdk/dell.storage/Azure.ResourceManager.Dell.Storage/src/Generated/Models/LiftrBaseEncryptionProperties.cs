...
namespace Azure.ResourceManager.Dell.Storage.Models
{
    ...
    public partial class LiftrBaseEncryptionProperties
    {
        ...
        /// <summary> Initializes a new instance of <see cref="LiftrBaseEncryptionProperties"/>. </summary>
        /// <param name="encryptionType"> Encryption Type - MMK/CMK. </param>
        public LiftrBaseEncryptionProperties(ResourceEncryptionType encryptionType)
        {
        ...
        internal LiftrBaseEncryptionProperties(ResourceEncryptionType encryptionType, string keyUri, LiftrBaseEncryptionIdentityProperties encryptionIdentityProperties, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            EncryptionType = encryptionType;
            KeyUri = keyUri;
        ...
        /// <summary> Initializes a new instance of <see cref="LiftrBaseEncryptionProperties"/> for deserialization. </summary>
        internal LiftrBaseEncryptionProperties()
        {
        }
        ...
        public LiftrBaseEncryptionIdentityProperties EncryptionIdentityProperties { get; set; }
    }
}
