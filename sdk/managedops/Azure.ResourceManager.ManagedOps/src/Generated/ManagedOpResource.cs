...
namespace Azure.ResourceManager.ManagedOps
{
    ...
    public partial class ManagedOpResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<ManagedOpResource>> UpdateAsync(WaitUntil waitUntil, ManagedOpData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _managedOperationsRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.Name, ManagedOpData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                ManagedOpsArmOperation<ManagedOpResource> operation = new ManagedOpsArmOperation<ManagedOpResource>(
                    new ManagedOpResourceOperationSource(Client),
                    _managedOperationsClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<ManagedOpResource> Update(WaitUntil waitUntil, ManagedOpData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
