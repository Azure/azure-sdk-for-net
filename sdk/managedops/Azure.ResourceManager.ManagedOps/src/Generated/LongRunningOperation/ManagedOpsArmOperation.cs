...
namespace Azure.ResourceManager.ManagedOps
{
    internal partial class ManagedOpsArmOperation : ArmOperation
    {
        ...
        internal ManagedOpsArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
