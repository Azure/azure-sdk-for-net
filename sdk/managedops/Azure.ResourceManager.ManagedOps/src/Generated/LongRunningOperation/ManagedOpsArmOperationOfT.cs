...
namespace Azure.ResourceManager.ManagedOps
{
    internal partial class ManagedOpsArmOperation<T> : ArmOperation<T>
    {
        ...
        internal ManagedOpsArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
