...
namespace Azure.ResourceManager.ManagedOps.Models
{
    ...
    public partial class ManagedOpsAzureMonitorInformation
    {
        ...
        internal ManagedOpsAzureMonitorInformation(ResourceIdentifier dcrId, ManagedOpsEnablementStatus enablementStatus, ErrorDetails errorDetails, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            DcrId = dcrId;
            EnablementStatus = enablementStatus;
