...
namespace Azure.ResourceManager.AgFoodPlatform.Mocking
{
    ...
    internal partial class AgFoodPlatformResourceGroupMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="AgFoodPlatformResourceGroupMockingExtension"/> class for mocking. </summary>
        protected AgFoodPlatformResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="AgFoodPlatformResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal AgFoodPlatformResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
