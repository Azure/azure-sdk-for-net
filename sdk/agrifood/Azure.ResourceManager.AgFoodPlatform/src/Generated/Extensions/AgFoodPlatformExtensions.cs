...
namespace Azure.ResourceManager.AgFoodPlatform
{
    ...
    {
        private static FarmBeatResourceExtensionClient GetFarmBeatResourceExtensionClient(ArmResource resource)
        {
            return resource.GetCachedClient(client =>
            {
                return new FarmBeatResourceExtensionClient(client, resource.Id);
            });
        }

        private static FarmBeatResourceExtensionClient GetFarmBeatResourceExtensionClient(ArmClient client, ResourceIdentifier scope)
        {
            return client.GetResourceClient(() =>
            {
                return new FarmBeatResourceExtensionClient(client, scope);
            });
        }
        ...
        {
            return GetFarmBeatResourceExtensionClient(subscriptionResource).GetFarmBeatsAsync(maxPageSize, skipToken, cancellationToken);
        }
        ...
        {
            return GetFarmBeatResourceExtensionClient(subscriptionResource).GetFarmBeats(maxPageSize, skipToken, cancellationToken);
        }
