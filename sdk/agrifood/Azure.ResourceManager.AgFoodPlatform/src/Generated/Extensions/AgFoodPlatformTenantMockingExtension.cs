...
namespace Azure.ResourceManager.AgFoodPlatform.Mocking
{
    ...
    internal partial class AgFoodPlatformTenantMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="AgFoodPlatformTenantMockingExtension"/> class for mocking. </summary>
        protected AgFoodPlatformTenantMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="AgFoodPlatformTenantMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal AgFoodPlatformTenantMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
