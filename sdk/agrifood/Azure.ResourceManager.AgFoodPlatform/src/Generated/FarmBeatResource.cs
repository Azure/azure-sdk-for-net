...
namespace Azure.ResourceManager.AgFoodPlatform
{
    ...
    public partial class FarmBeatResource : ArmResource
    {
        ...
        {
            _farmBeatFarmBeatsModelsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.AgFoodPlatform", ResourceType.Namespace, Diagnostics);
        ...
        {
            return await GetAgFoodPlatformPrivateLinkResources().GetAsync(subResourceName, cancellationToken).ConfigureAwait(false);
        }
        ...
        {
            return GetAgFoodPlatformPrivateLinkResources().Get(subResourceName, cancellationToken);
        }
        ...
        public virtual async Task<Response<FarmBeatResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _farmBeatFarmBeatsModelsRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<FarmBeatResource> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _farmBeatFarmBeatsModelsRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new FarmBeatResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        /// <item>
        /// <term>Request Path</term>
        /// <description>/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AgFoodPlatform/farmBeats/{farmBeatsResourceName}/operationResults/{operationResultsId}</description>
        /// </item>
        /// <item>
        /// <term>Operation Id</term>
        ...
        public virtual async Task<Response<ArmAsyncOperation>> GetOperationResultAsync(string operationResultsId, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _farmBeatFarmBeatsModelsRestClient.GetOperationResultAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, operationResultsId, cancellationToken).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
            {
        ...
        public virtual Response<ArmAsyncOperation> GetOperationResult(string operationResultsId, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _farmBeatFarmBeatsModelsRestClient.GetOperationResult(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, operationResultsId, cancellationToken);
                return response;
            }
            catch (Exception e)
            {
        ...
        public virtual async Task<Response<FarmBeatResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
                {
                    ...
                    var originalResponse = await _farmBeatFarmBeatsModelsRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<FarmBeatResource> AddTag(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                if (CanUseTagResource(cancellationToken: cancellationToken))
                {
                    ...
                    var originalResponse = _farmBeatFarmBeatsModelsRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken);
                    return Response.FromValue(new FarmBeatResource(Client, originalResponse.Value), originalResponse.GetRawResponse());
                }
                else
                {
