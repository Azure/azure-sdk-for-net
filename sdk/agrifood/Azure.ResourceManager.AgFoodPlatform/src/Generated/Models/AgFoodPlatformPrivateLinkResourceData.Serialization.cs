...
{
    public partial class AgFoodPlatformPrivateLinkResourceData : Core.IUtf8JsonSerializable
    {
        ...
        internal static AgFoodPlatformPrivateLinkResourceData DeserializeAgFoodPlatformPrivateLinkResourceData(JsonElement element)
        {
            ...
            return new AgFoodPlatformPrivateLinkResourceData(id, name, type, systemData.Value, groupId.Value, Core.Optional.ToList(requiredMembers), Core.Optional.ToList(requiredZoneNames));
        }
    }
}
