...
{
    public partial class AgFoodPlatformPrivateLinkResourceData : IUtf8JsonSerializable
    {
        ...
        internal static AgFoodPlatformPrivateLinkResourceData DeserializeAgFoodPlatformPrivateLinkResourceData(JsonElement element)
        {
            ...
            return new AgFoodPlatformPrivateLinkResourceData(id, name, type, systemData.Value, groupId.Value, Optional.ToList(requiredMembers), Optional.ToList(requiredZoneNames));
        }
    }
}
