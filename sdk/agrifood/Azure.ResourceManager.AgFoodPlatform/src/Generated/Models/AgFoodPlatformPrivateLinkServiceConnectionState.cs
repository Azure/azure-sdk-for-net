...
namespace Azure.ResourceManager.AgFoodPlatform.Models
{
    ...
    public partial class AgFoodPlatformPrivateLinkServiceConnectionState
    {
        ...
        internal AgFoodPlatformPrivateLinkServiceConnectionState(AgFoodPlatformPrivateEndpointServiceConnectionStatus? status, string description, string actionsRequired, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Status = status;
