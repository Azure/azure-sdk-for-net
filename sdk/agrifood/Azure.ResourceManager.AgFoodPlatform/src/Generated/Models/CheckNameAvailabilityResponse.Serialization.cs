...
namespace Azure.ResourceManager.AgFoodPlatform.Models
{
    public partial class CheckNameAvailabilityResponse : IUtf8JsonSerializable, IModelJsonSerializable<CheckNameAvailabilityResponse>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<CheckNameAvailabilityResponse>(this, options.Format);
        ...
        internal static CheckNameAvailabilityResponse DeserializeCheckNameAvailabilityResponse(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new CheckNameAvailabilityResponse(Optional.ToNullable(nameAvailable), Optional.ToNullable(reason), message.Value, serializedAdditionalRawData);
        }
        ...
        /// <summary> Converts a <see cref="CheckNameAvailabilityResponse"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="CheckNameAvailabilityResponse"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="CheckNameAvailabilityResponse"/>. </summary>
