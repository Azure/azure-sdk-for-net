...
namespace Azure.ResourceManager.AgFoodPlatform
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ExtensionData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ExtensionData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ExtensionData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ExtensionData>)} interface");
            }
        ...
        string IPersistableModel<ExtensionData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
