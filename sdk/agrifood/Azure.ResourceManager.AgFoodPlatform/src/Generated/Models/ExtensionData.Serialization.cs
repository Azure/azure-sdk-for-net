...
{
    public partial class ExtensionData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ExtensionData DeserializeExtensionData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
