...
namespace Azure.ResourceManager.AgFoodPlatform.Models
{
    ...
    public partial class FarmBeatPatch
    {
        ...
        internal FarmBeatPatch(AzureLocation? location, ManagedServiceIdentity identity, FarmBeatsUpdateProperties properties, IDictionary<string, string> tags, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Location = location;
            Identity = identity;
