...
namespace Azure.ResourceManager.AgFoodPlatform.Models
{
    ...
    public partial class SensorIntegration
    {
        ...
        internal SensorIntegration(string enabled, ProvisioningState? provisioningState, ErrorResponse provisioningInfo, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Enabled = enabled;
