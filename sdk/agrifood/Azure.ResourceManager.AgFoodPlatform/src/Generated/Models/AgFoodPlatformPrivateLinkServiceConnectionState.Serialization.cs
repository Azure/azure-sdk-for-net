...
{
    public partial class AgFoodPlatformPrivateLinkServiceConnectionState : Core.IUtf8JsonSerializable
    {
        ...
        internal static AgFoodPlatformPrivateLinkServiceConnectionState DeserializeAgFoodPlatformPrivateLinkServiceConnectionState(JsonElement element)
        {
            ...
            Core.Optional<AgFoodPlatformPrivateEndpointServiceConnectionStatus> status = default;
            ...
            return new AgFoodPlatformPrivateLinkServiceConnectionState(Core.Optional.ToNullable(status), description.Value, actionsRequired.Value);
        }
    }
}
