...
{
    public partial class FarmBeatData : IUtf8JsonSerializable, IJsonModel<FarmBeatData>, IPersistableModel<FarmBeatData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SensorIntegration))
            {
                builder.Append("  sensorIntegration:");
                AppendChildObject(builder, SensorIntegration, options, 2);
            }
            ...
            if (Optional.IsDefined(PrivateEndpointConnections))
            {
                ...
                AppendChildObject(builder, PrivateEndpointConnections, options, 2);
            }
