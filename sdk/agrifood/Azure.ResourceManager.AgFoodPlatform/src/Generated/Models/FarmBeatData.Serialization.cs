...
namespace Azure.ResourceManager.AgFoodPlatform
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FarmBeatData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<FarmBeatData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<FarmBeatData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<FarmBeatData>)} interface");
            }
        ...
        string IPersistableModel<FarmBeatData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
