...
namespace Azure.ResourceManager.AgFoodPlatform.Models
{
    ...
    public partial class DetailedInformation
    {
        ...
        internal DetailedInformation(string apiName, IReadOnlyList<string> customParameters, IReadOnlyList<string> platformParameters, UnitSystemsInfo unitsSupported, IReadOnlyList<string> apiInputParameters, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ApiName = apiName;
