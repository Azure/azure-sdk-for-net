...
namespace Azure.ResourceManager.AgFoodPlatform.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FarmBeatPatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<FarmBeatPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<FarmBeatPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<FarmBeatPatch>)} interface");
            }
        ...
        string IPersistableModel<FarmBeatPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
