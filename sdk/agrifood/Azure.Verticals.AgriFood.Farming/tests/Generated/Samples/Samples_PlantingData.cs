...
namespace Azure.Verticals.AgriFood.Farming.Samples
{
    internal class Samples_PlantingData
    {
        ...
        public void Example_CreateOrUpdate_AllParameters()
        {
            ...
            RequestContent content = RequestContent.Create(new Dictionary<string, object>()
            {
                ["avgPlantingRate"] = new Dictionary<string, object>()
                {
                    ["unit"] = "<unit>",
                    ["value"] = 123.45,
                },
...
,
        ...
        public void Example_GetAllPlantingDataByPartyId_AllParameters()
        {
            ...
            foreach (BinaryData item in client.GetAllPlantingDataByPartyId("<partyId>", (double)123.45, (double)123.45, (double)123.45, (double)123.45, (double)123.45, (double)123.45, new List<string>()
{
"<sources>"
}, new List<string>()
{
...
"<statuses>"
        ...
        public async Task Example_GetAllPlantingDataByPartyId_AllParameters_Async()
        {
            ...
            await foreach (BinaryData item in client.GetAllPlantingDataByPartyIdAsync("<partyId>", (double)123.45, (double)123.45, (double)123.45, (double)123.45, (double)123.45, (double)123.45, new List<string>()
{
"<sources>"
}, new List<string>()
{
...
"<statuses>"
        ...
        public void Example_GetAllPlantingData_AllParameters()
        {
            ...
            foreach (BinaryData item in client.GetAllPlantingData((double)123.45, (double)123.45, (double)123.45, (double)123.45, (double)123.45, (double)123.45, new List<string>()
{
"<sources>"
}, new List<string>()
{
...
"<statuses>"
        ...
        public async Task Example_GetAllPlantingData_AllParameters_Async()
        {
            ...
            await foreach (BinaryData item in client.GetAllPlantingDataAsync((double)123.45, (double)123.45, (double)123.45, (double)123.45, (double)123.45, (double)123.45, new List<string>()
{
"<sources>"
}, new List<string>()
{
