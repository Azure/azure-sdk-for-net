...
namespace Azure.Verticals.AgriFood.Farming.Samples
{
    internal class Samples_PlantingData
    {
        ...
        new {
            ...
            Response response = client.CreateOrUpdate("<partyId>", "<plantingDataId>", RequestContent.Create(data), new RequestContext());
        ...
        new {
            ...
            Response response = await client.CreateOrUpdateAsync("<partyId>", "<plantingDataId>", RequestContent.Create(data), new RequestContext());
        ...
        public void Example_Delete_AllParameters()
        {
            ...
            Response response = client.Delete("<partyId>", "<plantingDataId>", new RequestContext());
            Console.WriteLine(response.Status);
        }
        ...
        public async Task Example_Delete_AllParameters_Async()
        {
            ...
            Response response = await client.DeleteAsync("<partyId>", "<plantingDataId>", new RequestContext());
            Console.WriteLine(response.Status);
        }
        ...
        public void Example_GetAllPlantingDataByPartyId_AllParameters()
        {
            ...
            foreach (var item in client.GetAllPlantingDataByPartyId("<partyId>", 1234, 1234, 1234, 1234, 1234, 1234, new string[] { "<sources>" }, new string[] { "<associatedBoundaryIds>" }, DateTimeOffset.UtcNow, DateTimeOffset.UtcNow, DateTimeOffset.UtcNow, DateTimeOffset.UtcNow, DateTimeOffset.UtcNow, DateTimeOffset.UtcNow, 1234, 1234, new string[] { "<ids>" }, new string[] { "<names>" }, new string[] { "<propertyFilters>" }, new string[] { "<statuses>" }, DateTimeOffset.UtcNow, DateTimeOffset.UtcNow, DateTimeOffset.UtcNow, DateTimeOffset.UtcNow, 1234, "<skipToken>", new RequestContext()))
            {
                JsonElement result = JsonDocument.Parse(item.ToStream()).RootElement;
                Console.WriteLine(result.GetProperty("avgPlantingRate").GetProperty("unit").ToString());
                Console.WriteLine(result.GetProperty("avgPlantingRate").GetProperty("value").ToString());
        ...
        public async Task Example_GetAllPlantingDataByPartyId_AllParameters_Async()
        {
            ...
            await foreach (var item in client.GetAllPlantingDataByPartyIdAsync("<partyId>", 1234, 1234, 1234, 1234, 1234, 1234, new string[] { "<sources>" }, new string[] { "<associatedBoundaryIds>" }, DateTimeOffset.UtcNow, DateTimeOffset.UtcNow, DateTimeOffset.UtcNow, DateTimeOffset.UtcNow, DateTimeOffset.UtcNow, DateTimeOffset.UtcNow, 1234, 1234, new string[] { "<ids>" }, new string[] { "<names>" }, new string[] { "<propertyFilters>" }, new string[] { "<statuses>" }, DateTimeOffset.UtcNow, DateTimeOffset.UtcNow, DateTimeOffset.UtcNow, DateTimeOffset.UtcNow, 1234, "<skipToken>", new RequestContext()))
            {
                JsonElement result = JsonDocument.Parse(item.ToStream()).RootElement;
                Console.WriteLine(result.GetProperty("avgPlantingRate").GetProperty("unit").ToString());
                Console.WriteLine(result.GetProperty("avgPlantingRate").GetProperty("value").ToString());
        ...
        public void Example_GetAllPlantingData_AllParameters()
        {
            ...
            foreach (var item in client.GetAllPlantingData(1234, 1234, 1234, 1234, 1234, 1234, new string[] { "<sources>" }, new string[] { "<associatedBoundaryIds>" }, DateTimeOffset.UtcNow, DateTimeOffset.UtcNow, DateTimeOffset.UtcNow, DateTimeOffset.UtcNow, DateTimeOffset.UtcNow, DateTimeOffset.UtcNow, 1234, 1234, new string[] { "<plantingDataIds>" }, new string[] { "<names>" }, new string[] { "<propertyFilters>" }, new string[] { "<statuses>" }, DateTimeOffset.UtcNow, DateTimeOffset.UtcNow, DateTimeOffset.UtcNow, DateTimeOffset.UtcNow, 1234, "<skipToken>", new RequestContext()))
            {
                JsonElement result = JsonDocument.Parse(item.ToStream()).RootElement;
                Console.WriteLine(result.GetProperty("avgPlantingRate").GetProperty("unit").ToString());
                Console.WriteLine(result.GetProperty("avgPlantingRate").GetProperty("value").ToString());
        ...
        public async Task Example_GetAllPlantingData_AllParameters_Async()
        {
            ...
            await foreach (var item in client.GetAllPlantingDataAsync(1234, 1234, 1234, 1234, 1234, 1234, new string[] { "<sources>" }, new string[] { "<associatedBoundaryIds>" }, DateTimeOffset.UtcNow, DateTimeOffset.UtcNow, DateTimeOffset.UtcNow, DateTimeOffset.UtcNow, DateTimeOffset.UtcNow, DateTimeOffset.UtcNow, 1234, 1234, new string[] { "<plantingDataIds>" }, new string[] { "<names>" }, new string[] { "<propertyFilters>" }, new string[] { "<statuses>" }, DateTimeOffset.UtcNow, DateTimeOffset.UtcNow, DateTimeOffset.UtcNow, DateTimeOffset.UtcNow, 1234, "<skipToken>", new RequestContext()))
            {
                JsonElement result = JsonDocument.Parse(item.ToStream()).RootElement;
                Console.WriteLine(result.GetProperty("avgPlantingRate").GetProperty("unit").ToString());
                Console.WriteLine(result.GetProperty("avgPlantingRate").GetProperty("value").ToString());
