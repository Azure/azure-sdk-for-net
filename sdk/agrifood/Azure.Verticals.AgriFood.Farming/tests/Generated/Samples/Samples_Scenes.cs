    ...
    internal class Samples_Scenes
    {
        ...
        public void Example_SearchFeatures_AllParameters()
        {
            ...
            RequestContent content = RequestContent.Create(new Dictionary<string, object>()
            {
                ["startDateTime"] = "2022-05-10T18:57:31.2311892Z",
                ["endDateTime"] = "2022-05-10T18:57:31.2311892Z",
                ["intersects"] = new Dictionary<string, object>()
                {
...
"<featureIds>"
        ...
        public void Example_GetScenes_AllParameters()
        {
            ...
            foreach (BinaryData item in client.GetScenes("<provider>", "<partyId>", "<boundaryId>", "<source>", DateTimeOffset.Parse("2022-05-10T18:57:31.2311892Z"), DateTimeOffset.Parse("2022-05-10T18:57:31.2311892Z"), (double)123.45, (double)123.45, new List<string>()
{
"<imageNames>"
}, new List<double>()
{
...
"<imageFormats>"
        ...
        public async Task Example_GetScenes_AllParameters_Async()
        {
            ...
            await foreach (BinaryData item in client.GetScenesAsync("<provider>", "<partyId>", "<boundaryId>", "<source>", DateTimeOffset.Parse("2022-05-10T18:57:31.2311892Z"), DateTimeOffset.Parse("2022-05-10T18:57:31.2311892Z"), (double)123.45, (double)123.45, new List<string>()
{
"<imageNames>"
}, new List<double>()
{
