...
namespace Azure.Verticals.AgriFood.Farming.Samples
{
    internal class Samples_TillageData
    {
        ...
        public void Example_CreateOrUpdate_AllParameters()
        {
            ...
            Response response = client.CreateOrUpdate("<partyId>", "<tillageDataId>", RequestContent.Create(data), new RequestContext());
        ...
        public async Task Example_CreateOrUpdate_AllParameters_Async()
        {
            ...
            Response response = await client.CreateOrUpdateAsync("<partyId>", "<tillageDataId>", RequestContent.Create(data), new RequestContext());
        ...
        public void Example_Delete_AllParameters()
        {
            ...
            Response response = client.Delete("<partyId>", "<tillageDataId>", new RequestContext());
            Console.WriteLine(response.Status);
        }
        ...
        public async Task Example_Delete_AllParameters_Async()
        {
            ...
            Response response = await client.DeleteAsync("<partyId>", "<tillageDataId>", new RequestContext());
            Console.WriteLine(response.Status);
        }
        ...
        public void Example_GetAllTillageDataByPartyId_AllParameters()
        {
            ...
            foreach (var item in client.GetAllTillageDataByPartyId("<partyId>", 1234, 1234, 1234, 1234, new string[] { "<sources>" }, new string[] { "<associatedBoundaryIds>" }, DateTimeOffset.UtcNow, DateTimeOffset.UtcNow, DateTimeOffset.UtcNow, DateTimeOffset.UtcNow, DateTimeOffset.UtcNow, DateTimeOffset.UtcNow, 1234, 1234, new string[] { "<ids>" }, new string[] { "<names>" }, new string[] { "<propertyFilters>" }, new string[] { "<statuses>" }, DateTimeOffset.UtcNow, DateTimeOffset.UtcNow, DateTimeOffset.UtcNow, DateTimeOffset.UtcNow, 1234, "<skipToken>", new RequestContext()))
            {
                JsonElement result = JsonDocument.Parse(item.ToStream()).RootElement;
                Console.WriteLine(result.GetProperty("tillageDepth").GetProperty("unit").ToString());
                Console.WriteLine(result.GetProperty("tillageDepth").GetProperty("value").ToString());
        ...
        public async Task Example_GetAllTillageDataByPartyId_AllParameters_Async()
        {
            ...
            await foreach (var item in client.GetAllTillageDataByPartyIdAsync("<partyId>", 1234, 1234, 1234, 1234, new string[] { "<sources>" }, new string[] { "<associatedBoundaryIds>" }, DateTimeOffset.UtcNow, DateTimeOffset.UtcNow, DateTimeOffset.UtcNow, DateTimeOffset.UtcNow, DateTimeOffset.UtcNow, DateTimeOffset.UtcNow, 1234, 1234, new string[] { "<ids>" }, new string[] { "<names>" }, new string[] { "<propertyFilters>" }, new string[] { "<statuses>" }, DateTimeOffset.UtcNow, DateTimeOffset.UtcNow, DateTimeOffset.UtcNow, DateTimeOffset.UtcNow, 1234, "<skipToken>", new RequestContext()))
            {
                JsonElement result = JsonDocument.Parse(item.ToStream()).RootElement;
                Console.WriteLine(result.GetProperty("tillageDepth").GetProperty("unit").ToString());
                Console.WriteLine(result.GetProperty("tillageDepth").GetProperty("value").ToString());
        ...
        public void Example_GetAllTillageData_AllParameters()
        {
            ...
            foreach (var item in client.GetAllTillageData(1234, 1234, 1234, 1234, new string[] { "<sources>" }, new string[] { "<associatedBoundaryIds>" }, DateTimeOffset.UtcNow, DateTimeOffset.UtcNow, DateTimeOffset.UtcNow, DateTimeOffset.UtcNow, DateTimeOffset.UtcNow, DateTimeOffset.UtcNow, 1234, 1234, new string[] { "<tillageDataIds>" }, new string[] { "<names>" }, new string[] { "<propertyFilters>" }, new string[] { "<statuses>" }, DateTimeOffset.UtcNow, DateTimeOffset.UtcNow, DateTimeOffset.UtcNow, DateTimeOffset.UtcNow, 1234, "<skipToken>", new RequestContext()))
            {
                JsonElement result = JsonDocument.Parse(item.ToStream()).RootElement;
                Console.WriteLine(result.GetProperty("tillageDepth").GetProperty("unit").ToString());
                Console.WriteLine(result.GetProperty("tillageDepth").GetProperty("value").ToString());
        ...
        public async Task Example_GetAllTillageData_AllParameters_Async()
        {
            ...
            await foreach (var item in client.GetAllTillageDataAsync(1234, 1234, 1234, 1234, new string[] { "<sources>" }, new string[] { "<associatedBoundaryIds>" }, DateTimeOffset.UtcNow, DateTimeOffset.UtcNow, DateTimeOffset.UtcNow, DateTimeOffset.UtcNow, DateTimeOffset.UtcNow, DateTimeOffset.UtcNow, 1234, 1234, new string[] { "<tillageDataIds>" }, new string[] { "<names>" }, new string[] { "<propertyFilters>" }, new string[] { "<statuses>" }, DateTimeOffset.UtcNow, DateTimeOffset.UtcNow, DateTimeOffset.UtcNow, DateTimeOffset.UtcNow, 1234, "<skipToken>", new RequestContext()))
            {
                JsonElement result = JsonDocument.Parse(item.ToStream()).RootElement;
                Console.WriteLine(result.GetProperty("tillageDepth").GetProperty("unit").ToString());
                Console.WriteLine(result.GetProperty("tillageDepth").GetProperty("value").ToString());
