...
namespace Azure.Verticals.AgriFood.Farming.Samples
{
    internal class Samples_TillageData
    {
        ...
        public void Example_CreateOrUpdate_AllParameters()
        {
            ...
            RequestContent content = RequestContent.Create(new Dictionary<string, object>()
            {
                ["tillageDepth"] = new Dictionary<string, object>()
                {
                    ["unit"] = "<unit>",
                    ["value"] = 123.45,
                },
                ["tillagePressure"] = null
            ,
                ["area"] = null
            ,
        ...
        public void Example_GetAllTillageDataByPartyId_AllParameters()
        {
            ...
            foreach (BinaryData item in client.GetAllTillageDataByPartyId("<partyId>", (double)123.45, (double)123.45, (double)123.45, (double)123.45, new List<string>()
{
"<sources>"
}, new List<string>()
{
"<associatedBoundaryIds>"
}, DateTimeOffset.Parse("2022-05-10T18:57:31.2311892Z"), DateTimeOffset.Parse("2022-05-10T18:57:31.2311892Z"), DateTimeOffset.Parse("2022-05-10T18:57:31.2311892Z"), DateTimeOffset.Parse("2022-05-10T18:57:31.2311892Z"), DateTimeOffset.Parse("2022-05-10T18:57:31.2311892Z"), DateTimeOffset.Parse("2022-05-10T18:57:31.2311892Z"), (double)123.45, (double)123.45, new List<string>()
{
"<ids>"
}, new List<string>()
{
...
"<statuses>"
        ...
        public async Task Example_GetAllTillageDataByPartyId_AllParameters_Async()
        {
            ...
            await foreach (BinaryData item in client.GetAllTillageDataByPartyIdAsync("<partyId>", (double)123.45, (double)123.45, (double)123.45, (double)123.45, new List<string>()
{
"<sources>"
}, new List<string>()
{
...
"<statuses>"
        ...
        public void Example_GetAllTillageData_AllParameters()
        {
            ...
            foreach (BinaryData item in client.GetAllTillageData((double)123.45, (double)123.45, (double)123.45, (double)123.45, new List<string>()
{
"<sources>"
}, new List<string>()
{
...
"<statuses>"
        ...
        public async Task Example_GetAllTillageData_AllParameters_Async()
        {
            ...
            await foreach (BinaryData item in client.GetAllTillageDataAsync((double)123.45, (double)123.45, (double)123.45, (double)123.45, new List<string>()
{
"<sources>"
}, new List<string>()
{
