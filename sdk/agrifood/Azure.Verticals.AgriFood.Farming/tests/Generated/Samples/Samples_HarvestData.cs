...
namespace Azure.Verticals.AgriFood.Farming.Samples
{
    internal class Samples_HarvestData
    {
        ...
        public void Example_CreateOrUpdate_AllParameters()
        {
            ...
            RequestContent content = RequestContent.Create(new Dictionary<string, object>()
            {
                ["totalYield"] = new Dictionary<string, object>()
                {
                    ["unit"] = "<unit>",
                    ["value"] = 123.45,
                },
...
,
        ...
        public void Example_GetAllHarvestData_AllParameters()
        {
            ...
            foreach (BinaryData item in client.GetAllHarvestData((double)123.45, (double)123.45, (double)123.45, (double)123.45, (double)123.45, (double)123.45, (double)123.45, (double)123.45, (double)123.45, (double)123.45, (double)123.45, (double)123.45, new List<string>()
{
"<sources>"
}, new List<string>()
{
...
"<statuses>"
        ...
        public async Task Example_GetAllHarvestData_AllParameters_Async()
        {
            ...
            await foreach (BinaryData item in client.GetAllHarvestDataAsync((double)123.45, (double)123.45, (double)123.45, (double)123.45, (double)123.45, (double)123.45, (double)123.45, (double)123.45, (double)123.45, (double)123.45, (double)123.45, (double)123.45, new List<string>()
{
"<sources>"
}, new List<string>()
{
...
"<statuses>"
        ...
        public void Example_GetAllHarvestDataByPartyId_AllParameters()
        {
            ...
            foreach (BinaryData item in client.GetAllHarvestDataByPartyId("<partyId>", (double)123.45, (double)123.45, (double)123.45, (double)123.45, (double)123.45, (double)123.45, (double)123.45, (double)123.45, (double)123.45, (double)123.45, (double)123.45, (double)123.45, new List<string>()
{
"<sources>"
}, new List<string>()
{
...
"<statuses>"
        ...
        public async Task Example_GetAllHarvestDataByPartyId_AllParameters_Async()
        {
            ...
            await foreach (BinaryData item in client.GetAllHarvestDataByPartyIdAsync("<partyId>", (double)123.45, (double)123.45, (double)123.45, (double)123.45, (double)123.45, (double)123.45, (double)123.45, (double)123.45, (double)123.45, (double)123.45, (double)123.45, (double)123.45, new List<string>()
{
"<sources>"
}, new List<string>()
{
