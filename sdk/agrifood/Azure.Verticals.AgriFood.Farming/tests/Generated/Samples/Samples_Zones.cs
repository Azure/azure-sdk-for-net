...
namespace Azure.Verticals.AgriFood.Farming.Samples
{
    internal class Samples_Zones
    {
        ...
        public void Example_GetZonesByPartyId_AllParameters()
        {
            ...
            foreach (BinaryData item in client.GetZonesByPartyId("<partyId>", new List<string>()
{
"<types>"
}, new List<string>()
{
...
"<statuses>"
}, DateTimeOffset.Parse("2022-05-10T18:57:31.2311892Z"), DateTimeOffset.Parse("2022-05-10T18:57:31.2311892Z"), DateTimeOffset.Parse("2022-05-10T18:57:31.2311892Z"), DateTimeOffset.Parse("2022-05-10T18:57:31.2311892Z"), 1234, "<skipToken>", null))
            {
                ...
                Console.WriteLine(result[0].GetProperty("managementZoneId").ToString());
        ...
        public async Task Example_GetZonesByPartyId_AllParameters_Async()
        {
            ...
            await foreach (BinaryData item in client.GetZonesByPartyIdAsync("<partyId>", new List<string>()
{
"<types>"
}, new List<string>()
{
...
"<statuses>"
        ...
        public void Example_GetZones_AllParameters()
        {
            ...
            foreach (BinaryData item in client.GetZones(new List<string>()
{
"<types>"
}, new List<string>()
{
...
"<statuses>"
        ...
        public async Task Example_GetZones_AllParameters_Async()
        {
            ...
            await foreach (BinaryData item in client.GetZonesAsync(new List<string>()
{
"<types>"
}, new List<string>()
{
