...
namespace Azure.Verticals.AgriFood.Farming.Models
{
    ...
    public partial class FoodCrop
    {
        ...
        /// </param>
        internal FoodCrop(string phenotype, string id, string eTag, string status, DateTimeOffset? createdDateTime, DateTimeOffset? modifiedDateTime, string name, string description, IDictionary<string, object> properties)
        {
            Phenotype = phenotype;
            Id = id;
            ETag = eTag;
