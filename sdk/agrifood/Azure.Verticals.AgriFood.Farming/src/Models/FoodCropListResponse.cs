...
namespace Azure.Verticals.AgriFood.Farming.Models
{
    ...
    internal partial class FoodCropListResponse
    {
        ...
        internal FoodCropListResponse()
        {
            Value = new ChangeTrackingList<FoodCrop>();
        }
        ...
        internal FoodCropListResponse(IReadOnlyList<FoodCrop> value, string skipToken, string nextLink)
        {
            Value = value;
            SkipToken = skipToken;
            NextLink = nextLink;
        ...
        public IReadOnlyList<FoodCrop> Value { get; }
