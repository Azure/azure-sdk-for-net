...
{
    // Data plane generated client. The SolutionInference service client.
    /// <summary> The SolutionInference service client. </summary>
    public partial class SolutionInferenceClient
    {
        ...
        /// <summary> Initializes a new instance of SolutionInferenceClient for mocking. </summary>
        protected SolutionInferenceClient()
        {
        }

        /// <summary> Initializes a new instance of SolutionInferenceClient. </summary>
        /// <param name="endpoint"> The endpoint of your FarmBeats resource (protocol and hostname, for example: https://{resourceName}.farmbeats.azure.net). </param>
        /// <param name="credential"> A credential used to authenticate to an Azure Service. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="endpoint"/> or <paramref name="credential"/> is null. </exception>
        public SolutionInferenceClient(TokenCredential credential, Uri endpoint) : this(credential, endpoint, new FarmBeatsClientOptions())
        {
        }
        ...
        public SolutionInferenceClient(TokenCredential credential, Uri endpoint, FarmBeatsClientOptions options)
        {
        ...
        /// var client = new SolutionInferenceClient(credential);
        /// 
        /// var data = new {
        ...
        public virtual async Task<Response> CancelAsync(string solutionId, RequestContent content, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("SolutionInferenceClient.Cancel");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response> FetchAsync(string solutionId, RequestContent content, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("SolutionInferenceClient.Fetch");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Operation<BinaryData>> CreateOrUpdateAsync(WaitUntil waitUntil, string solutionId, RequestContent content, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("SolutionInferenceClient.CreateOrUpdate");
            scope.Start();
            try
            {
                using HttpMessage message = CreateCreateOrUpdateRequest(solutionId, content, context);
                return await ProtocolOperationHelpers.ProcessMessageAsync(_pipeline, message, ClientDiagnostics, "SolutionInferenceClient.CreateOrUpdate", OperationFinalStateVia.Location, context, waitUntil).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual Operation<BinaryData> CreateOrUpdate(WaitUntil waitUntil, string solutionId, RequestContent content, RequestContext context = null)
        {
            ...
            {
                using HttpMessage message = CreateCreateOrUpdateRequest(solutionId, content, context);
                return ProtocolOperationHelpers.ProcessMessage(_pipeline, message, ClientDiagnostics, "SolutionInferenceClient.CreateOrUpdate", OperationFinalStateVia.Location, context, waitUntil);
            }
            catch (Exception e)
            {
                scope.Failed(e);
