...
{
    // Data plane generated client. The SensorDataModels service client.
    /// <summary> The SensorDataModels service client. </summary>
    public partial class SensorDataModelsClient
    {
        ...
        /// <summary> Initializes a new instance of SensorDataModelsClient for mocking. </summary>
        protected SensorDataModelsClient()
        {
        }

        /// <summary> Initializes a new instance of SensorDataModelsClient. </summary>
        /// <param name="endpoint"> The endpoint of your FarmBeats resource (protocol and hostname, for example: https://{resourceName}.farmbeats.azure.net). </param>
        /// <param name="credential"> A credential used to authenticate to an Azure Service. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="endpoint"/> or <paramref name="credential"/> is null. </exception>
        public SensorDataModelsClient(TokenCredential credential, Uri endpoint) : this(credential, endpoint, new FarmBeatsClientOptions())
        {
        }
        ...
        public SensorDataModelsClient(TokenCredential credential, Uri endpoint, FarmBeatsClientOptions options)
        {
        ...
        /// var client = new SensorDataModelsClient(credential);
        /// 
        /// var data = new {
        ///     measures = new {
        ///         key = new {
        ...
        public virtual async Task<Response> CreateOrUpdateAsync(string sensorPartnerId, string sensorDataModelId, RequestContent content, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("SensorDataModelsClient.CreateOrUpdate");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response> GetSensorDataModelAsync(string sensorPartnerId, string sensorDataModelId, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("SensorDataModelsClient.GetSensorDataModel");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response> DeleteAsync(string sensorPartnerId, string sensorDataModelId, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("SensorDataModelsClient.Delete");
            scope.Start();
            try
            {
        ...
        public virtual AsyncPageable<BinaryData> GetSensorDataModelsAsync(string sensorPartnerId, IEnumerable<string> ids = null, IEnumerable<string> names = null, IEnumerable<string> propertyFilters = null, IEnumerable<string> statuses = null, DateTimeOffset? minCreatedDateTime = null, DateTimeOffset? maxCreatedDateTime = null, DateTimeOffset? minLastModifiedDateTime = null, DateTimeOffset? maxLastModifiedDateTime = null, int? maxPageSize = null, string skipToken = null, RequestContext context = null)
        {
            ...
            return GetSensorDataModelsImplementationAsync("SensorDataModelsClient.GetSensorDataModels", sensorPartnerId, ids, names, propertyFilters, statuses, minCreatedDateTime, maxCreatedDateTime, minLastModifiedDateTime, maxLastModifiedDateTime, maxPageSize, skipToken, context);
        }
        ...
        public virtual Pageable<BinaryData> GetSensorDataModels(string sensorPartnerId, IEnumerable<string> ids = null, IEnumerable<string> names = null, IEnumerable<string> propertyFilters = null, IEnumerable<string> statuses = null, DateTimeOffset? minCreatedDateTime = null, DateTimeOffset? maxCreatedDateTime = null, DateTimeOffset? minLastModifiedDateTime = null, DateTimeOffset? maxLastModifiedDateTime = null, int? maxPageSize = null, string skipToken = null, RequestContext context = null)
        {
            ...
            return GetSensorDataModelsImplementation("SensorDataModelsClient.GetSensorDataModels", sensorPartnerId, ids, names, propertyFilters, statuses, minCreatedDateTime, maxCreatedDateTime, minLastModifiedDateTime, maxLastModifiedDateTime, maxPageSize, skipToken, context);
        }
