...
{
    /// <summary> The SeasonsRest service client. </summary>
    internal partial class SeasonsRestClient
    {
        ...
        /// <param name="skipToken"> Skip token for getting next set of results. </param>
        /// <param name="options"> The request options. </param>
        public Response List(DateTimeOffset? minStartDateTime = null, DateTimeOffset? maxStartDateTime = null, DateTimeOffset? minEndDateTime = null, DateTimeOffset? maxEndDateTime = null, IEnumerable<int> years = null, IEnumerable<string> ids = null, IEnumerable<string> names = null, IEnumerable<string> propertyFilters = null, IEnumerable<string> statuses = null, DateTimeOffset? minCreatedDateTime = null, DateTimeOffset? maxCreatedDateTime = null, DateTimeOffset? minLastModifiedDateTime = null, DateTimeOffset? maxLastModifiedDateTime = null, int? maxPageSize = null, string skipToken = null, RequestOptions options = null)
        {
            options ??= new RequestOptions();
            using HttpMessage message = CreateListRequest(minStartDateTime, maxStartDateTime, minEndDateTime, maxEndDateTime, years, ids, names, propertyFilters, statuses, minCreatedDateTime, maxCreatedDateTime, minLastModifiedDateTime, maxLastModifiedDateTime, maxPageSize, skipToken);
            RequestOptions.Apply(options, message);
        ...
        public async Task<Response> GetAsync(string seasonId, RequestOptions options = null)
        {
            if (seasonId == null)
            {
        ...
        /// <param name="options"> The request options. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="seasonId"/> is null. </exception>
        public Response Get(string seasonId, RequestOptions options = null)
        {
            if (seasonId == null)
            {
                throw new ArgumentNullException(nameof(seasonId));
        ...
        /// <param name="options"> The request options. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="seasonId"/> is null. </exception>
        public async Task<Response> CreateOrUpdateAsync(string seasonId, RequestContent content, RequestOptions options = null)
        {
            if (seasonId == null)
            {
                throw new ArgumentNullException(nameof(seasonId));
        ...
        /// <param name="options"> The request options. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="seasonId"/> is null. </exception>
        public Response CreateOrUpdate(string seasonId, RequestContent content, RequestOptions options = null)
        {
            if (seasonId == null)
            {
                throw new ArgumentNullException(nameof(seasonId));
        ...
        /// <param name="options"> The request options. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="seasonId"/> is null. </exception>
        public async Task<Response> DeleteAsync(string seasonId, RequestOptions options = null)
        {
            if (seasonId == null)
            {
                throw new ArgumentNullException(nameof(seasonId));
        ...
        /// <param name="options"> The request options. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="seasonId"/> is null. </exception>
        public Response Delete(string seasonId, RequestOptions options = null)
        {
            if (seasonId == null)
            {
                throw new ArgumentNullException(nameof(seasonId));
        ...
        public async Task<Response> ListNextPageAsync(string nextLink, DateTimeOffset? minStartDateTime = null, DateTimeOffset? maxStartDateTime = null, DateTimeOffset? minEndDateTime = null, DateTimeOffset? maxEndDateTime = null, IEnumerable<int> years = null, IEnumerable<string> ids = null, IEnumerable<string> names = null, IEnumerable<string> propertyFilters = null, IEnumerable<string> statuses = null, DateTimeOffset? minCreatedDateTime = null, DateTimeOffset? maxCreatedDateTime = null, DateTimeOffset? minLastModifiedDateTime = null, DateTimeOffset? maxLastModifiedDateTime = null, int? maxPageSize = null, string skipToken = null, RequestOptions options = null)
        {
            ...
            options ??= new RequestOptions();
            using HttpMessage message = CreateListNextPageRequest(nextLink, minStartDateTime, maxStartDateTime, minEndDateTime, maxEndDateTime, years, ids, names, propertyFilters, statuses, minCreatedDateTime, maxCreatedDateTime, minLastModifiedDateTime, maxLastModifiedDateTime, maxPageSize, skipToken);
            RequestOptions.Apply(options, message);
            await _pipeline.SendAsync(message, options.CancellationToken).ConfigureAwait(false);
            if (options.StatusOption == ResponseStatusOption.Default)
            {
