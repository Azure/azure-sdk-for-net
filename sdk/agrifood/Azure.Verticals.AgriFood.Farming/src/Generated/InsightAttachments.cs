...
namespace Azure.Verticals.AgriFood.Farming
{
    ...
    public partial class InsightAttachments
    {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="partyId"/>, <paramref name="modelId"/>, <paramref name="resourceType"/>, <paramref name="resourceId"/>, <paramref name="insightAttachmentId"/> or <paramref name="content"/> is null. </exception>
        ...
        /// <include file="Docs/InsightAttachments.xml" path="doc/members/member[@name='CreateOrUpdateAsync(string,string,string,string,string,RequestContent,ContentType,RequestContext)']/*" />
        public virtual async Task<Response> CreateOrUpdateAsync(string partyId, string modelId, string resourceType, string resourceId, string insightAttachmentId, RequestContent content, ContentType contentType, RequestContext context = null)
        {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/InsightAttachments.xml" path="doc/members/member[@name='CreateOrUpdate(string,string,string,string,string,RequestContent,ContentType,RequestContext)']/*" />
        public virtual Response CreateOrUpdate(string partyId, string modelId, string resourceType, string resourceId, string insightAttachmentId, RequestContent content, ContentType contentType, RequestContext context = null)
        {
            Argument.AssertNotNullOrEmpty(partyId, nameof(partyId));
            Argument.AssertNotNullOrEmpty(modelId, nameof(modelId));
            Argument.AssertNotNullOrEmpty(resourceType, nameof(resourceType));
        ...
        internal HttpMessage CreateCreateOrUpdateRequest(string partyId, string modelId, string resourceType, string resourceId, string insightAttachmentId, RequestContent content, ContentType contentType, RequestContext context)
        {
