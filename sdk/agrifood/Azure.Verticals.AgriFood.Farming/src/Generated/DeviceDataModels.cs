...
namespace Azure.Verticals.AgriFood.Farming
{
    ...
    public partial class DeviceDataModels
    {
        ...
        internal RequestUriBuilder CreateGetDeviceDataModelsRequestUri(string sensorPartnerId, IEnumerable<string> ids, IEnumerable<string> names, IEnumerable<string> propertyFilters, IEnumerable<string> statuses, DateTimeOffset? minCreatedDateTime, DateTimeOffset? maxCreatedDateTime, DateTimeOffset? minLastModifiedDateTime, DateTimeOffset? maxLastModifiedDateTime, int? maxPageSize, string skipToken, RequestContext context)
        {
        ...
        internal RequestUriBuilder CreateCreateOrUpdateRequestUri(string sensorPartnerId, string deviceDataModelId, RequestContent content, RequestContext context)
        {
            var uri = new RawRequestUriBuilder();
            uri.Reset(_endpoint);
            uri.AppendPath("/sensor-partners/", false);
        ...
        internal RequestUriBuilder CreateGetDeviceDataModelRequestUri(string sensorPartnerId, string deviceDataModelId, RequestContext context)
        {
            var uri = new RawRequestUriBuilder();
            uri.Reset(_endpoint);
            uri.AppendPath("/sensor-partners/", false);
        ...
        internal RequestUriBuilder CreateDeleteRequestUri(string sensorPartnerId, string deviceDataModelId, RequestContext context)
        {
            var uri = new RawRequestUriBuilder();
            uri.Reset(_endpoint);
            uri.AppendPath("/sensor-partners/", false);
