...
namespace Azure.Verticals.AgriFood.Farming
{
    ...
    public partial class OAuthProvidersClient
    {
        ...
        /// https://docs.microsoft.com/rest/api/FarmBeats/OAuthProviders/Get
        /// Schema for <c>Response Body</c>:
        /// <code>{
        ///   appId: string, # Optional. <Description>OAuth App ID for given OAuth Provider.</Description>
        ///   appSecret: string, # Optional. <Description>OAuth App secret for given Provider.
        /// Note: Won&apos;t be sent in response.</Description>
        ///   apiKey: string, # Optional. <Description>OAuth Api key for given Provider.
        /// Note: currently Applicable to Climate provider. Won&apos;t be sent in response.</Description>
        ///   isProductionApp: boolean, # Optional. <Description>An optional flag to determine if the App is ready to be used for Production scenarios in the provider side or not. (Default value: false)
        /// Note: Currently applicable for JohnDeere.</Description>
        ///   id: string, # Optional. <Description>Unique OAuth provider ID.</Description>
        ...
        /// Below is the JSON schema for the request and response payloads.
        /// Additional information can be found in the service REST API documentation:
        /// https://docs.microsoft.com/rest/api/FarmBeats/OAuthProviders/CreateOrUpdate
        ...
        /// Below is the JSON schema for the request and response payloads.
        /// Additional information can be found in the service REST API documentation:
        /// https://docs.microsoft.com/rest/api/FarmBeats/OAuthProviders/List
        /// Schema for <c>Response Body</c>:
        /// <code>{
        ///   value: [
        ///     {
