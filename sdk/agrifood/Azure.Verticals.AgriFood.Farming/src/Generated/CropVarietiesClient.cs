...
namespace Azure.Verticals.AgriFood.Farming
{
    ...
    public partial class CropVarietiesClient
    {
        ...
        /// <example>
        /// This sample shows how to call GetCropVarietyAsync and parse the result.
        /// <code>
        ...
        /// <exception cref="ArgumentException"> <paramref name="cropId"/> or <paramref name="cropVarietyId"/> is an empty string, and was expected to be non-empty. </exception>
        /// <example>
        /// This sample shows how to call GetCropVariety and parse the result.
        /// <code>
        /// var credential = new DefaultAzureCredential();
        /// var endpoint = new Uri("https://my-account-name.azure.com");
        /// var client = new CropVarietiesClient(endpoint, credential);
        ...
        /// <example>
        /// This sample shows how to call GetCropVarietiesByCropIdAsync with required parameters, and how to parse the result.
        /// <code>
        /// var credential = new DefaultAzureCredential();
        /// var endpoint = new Uri("https://my-account-name.azure.com");
        /// var client = new CropVarietiesClient(endpoint, credential);
        ...
        /// <exception cref="ArgumentException"> <paramref name="cropId"/> is an empty string, and was expected to be non-empty. </exception>
        /// <example>
        /// This sample shows how to call GetCropVarietiesByCropId with required parameters, and how to parse the result.
        /// <code>
        /// var credential = new DefaultAzureCredential();
        /// var endpoint = new Uri("https://my-account-name.azure.com");
        /// var client = new CropVarietiesClient(endpoint, credential);
