...
namespace Azure.Verticals.AgriFood.Farming
{
    ...
    public partial class Attachments
    {
        ...
        internal RequestUriBuilder CreateGetAttachmentsByPartyIdRequestUri(string partyId, IEnumerable<string> resourceIds, IEnumerable<string> resourceTypes, IEnumerable<string> ids, IEnumerable<string> names, IEnumerable<string> propertyFilters, IEnumerable<string> statuses, DateTimeOffset? minCreatedDateTime, DateTimeOffset? maxCreatedDateTime, DateTimeOffset? minLastModifiedDateTime, DateTimeOffset? maxLastModifiedDateTime, int? maxPageSize, string skipToken, RequestContext context)
        {
        ...
        internal RequestUriBuilder CreateGetAttachmentRequestUri(string partyId, string attachmentId, RequestContext context)
        {
            var uri = new RawRequestUriBuilder();
            uri.Reset(_endpoint);
            uri.AppendPath("/parties/", false);
        ...
        internal RequestUriBuilder CreateCreateOrUpdateRequestUri(string partyId, string attachmentId, RequestContent content, RequestContext context)
        {
            var uri = new RawRequestUriBuilder();
            uri.Reset(_endpoint);
            uri.AppendPath("/parties/", false);
        ...
        internal RequestUriBuilder CreateDeleteRequestUri(string partyId, string attachmentId, RequestContext context)
        {
            var uri = new RawRequestUriBuilder();
            uri.Reset(_endpoint);
            uri.AppendPath("/parties/", false);
        ...
        internal RequestUriBuilder CreateDownloadRequestUri(string partyId, string attachmentId, RequestContext context)
        {
            var uri = new RawRequestUriBuilder();
            uri.Reset(_endpoint);
            uri.AppendPath("/parties/", false);
        ...
        internal RequestUriBuilder CreateGetAttachmentsByPartyIdNextPageRequestUri(string nextLink, string partyId, IEnumerable<string> resourceIds, IEnumerable<string> resourceTypes, IEnumerable<string> ids, IEnumerable<string> names, IEnumerable<string> propertyFilters, IEnumerable<string> statuses, DateTimeOffset? minCreatedDateTime, DateTimeOffset? maxCreatedDateTime, DateTimeOffset? minLastModifiedDateTime, DateTimeOffset? maxLastModifiedDateTime, int? maxPageSize, string skipToken, RequestContext context)
        {
            var uri = new RawRequestUriBuilder();
            uri.Reset(_endpoint);
