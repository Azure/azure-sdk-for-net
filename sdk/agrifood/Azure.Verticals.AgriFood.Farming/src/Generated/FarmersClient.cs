...
#pragma warning restore AZC0002
        {
            options ??= new RequestOptions();
            using HttpMessage message = CreateGetRequest(farmerId, options);
            RequestOptions.Apply(options, message);
...
#pragma warning restore AZC0002
        ...
        /// <param name="farmerId"> ID of the associated farmer. </param>
        /// <param name="options"> The request options. </param>
        private HttpMessage CreateGetRequest(string farmerId, RequestOptions options = null)
        {
            var message = Pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Get;
...
#pragma warning restore AZC0002
        {
            options ??= new RequestOptions();
            using HttpMessage message = CreateCreateOrUpdateRequest(farmerId, content, options);
            RequestOptions.Apply(options, message);
...
#pragma warning restore AZC0002
        ...
        /// <param name="content"> The content to send as the body of the request. </param>
        /// <param name="options"> The request options. </param>
        private HttpMessage CreateCreateOrUpdateRequest(string farmerId, RequestContent content, RequestOptions options = null)
        {
            var message = Pipeline.CreateMessage();
            var request = message.Request;
...
#pragma warning restore AZC0002
        {
            options ??= new RequestOptions();
            using HttpMessage message = CreateDeleteRequest(farmerId, options);
            RequestOptions.Apply(options, message);
...
#pragma warning restore AZC0002
        ...
        /// <param name="farmerId"> ID of farmer to be deleted. </param>
        /// <param name="options"> The request options. </param>
        private HttpMessage CreateDeleteRequest(string farmerId, RequestOptions options = null)
        {
            var message = Pipeline.CreateMessage();
            var request = message.Request;
...
#pragma warning restore AZC0002
        {
            options ??= new RequestOptions();
            using HttpMessage message = CreateCreateCascadeDeleteJobRequest(jobId, farmerId, options);
            RequestOptions.Apply(options, message);
...
#pragma warning restore AZC0002
        ...
        /// <param name="farmerId"> ID of the farmer to be deleted. </param>
        /// <param name="options"> The request options. </param>
        private HttpMessage CreateCreateCascadeDeleteJobRequest(string jobId, string farmerId, RequestOptions options = null)
        {
            var message = Pipeline.CreateMessage();
            var request = message.Request;
