...
namespace Azure.Verticals.AgriFood.Farming
{
    ...
    public partial class FarmersClient
    {
        ...
        /// https://docs.microsoft.com/rest/api/FarmBeats/Farmers/Get
        ...
        /// Below is the JSON schema for the request and response payloads.
        /// Additional information can be found in the service REST API documentation:
        /// https://docs.microsoft.com/rest/api/FarmBeats/Farmers/CreateOrUpdate
        ...
        /// Below is the JSON schema for the request and response payloads.
        /// Additional information can be found in the service REST API documentation:
        /// https://docs.microsoft.com/rest/api/FarmBeats/Farmers/GetCascadeDeleteJobDetails
        /// Schema for <c>Response Body</c>:
        /// <code>{
        ...
        /// Below is the JSON schema for the request and response payloads.
        /// Additional information can be found in the service REST API documentation:
        /// https://docs.microsoft.com/rest/api/FarmBeats/Farmers/List
        /// Schema for <c>Response Body</c>:
        /// <code>{
        ///   value: [
        ///     {
        ...
        /// Below is the JSON schema for the request and response payloads.
        /// Additional information can be found in the service REST API documentation:
        /// https://docs.microsoft.com/rest/api/FarmBeats/Farmers/CreateCascadeDeleteJob
        /// Schema for <c>Response Body</c>:
        /// <code>{
        ///   farmerId: string, # Required. <Description>Farmer ID.</Description>
        ///   resourceId: string, # Required. <Description>The id of the resource.</Description>
