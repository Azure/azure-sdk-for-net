...
namespace Azure.Verticals.AgriFood.Farming
{
    ...
    /// <summary> The Prescriptions sub-client. </summary>
    public partial class Prescriptions
    {
        ...
        /// <summary> Initializes a new instance of Prescriptions for mocking. </summary>
        ...
        internal Prescriptions(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, TokenCredential tokenCredential, Uri endpoint, string apiVersion)
        {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="partyId"/> or <paramref name="prescriptionId"/> is null. </exception>
        ...
        public virtual async Task<Response> GetPrescriptionAsync(string partyId, string prescriptionId, RequestContext context = null)
        {
            ...
            try
            {
                using HttpMessage message = CreateGetPrescriptionRequest(partyId, prescriptionId, context);
        ...
        /// <param name="context"> The request context, which can override default behaviors of the client pipeline on a per-call basis. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="partyId"/>, <paramref name="prescriptionId"/> or <paramref name="content"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="partyId"/> or <paramref name="prescriptionId"/> is an empty string, and was expected to be non-empty. </exception>
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        ...
        public virtual async Task<Response> CreateOrUpdateAsync(string partyId, string prescriptionId, RequestContent content, RequestContext context = null)
        {
            ...
            try
            {
                using HttpMessage message = CreateCreateOrUpdateRequest(partyId, prescriptionId, content, context);
                return await _pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
            }
            catch (Exception e)
            {
        ...
        public virtual async Task<Response> DeleteAsync(string partyId, string prescriptionId, RequestContext context = null)
        {
            ...
            try
            {
                using HttpMessage message = CreateDeleteRequest(partyId, prescriptionId, context);
                return await _pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
            }
            catch (Exception e)
            {
        ...
        /// <param name="productNames"> Product Names of the resource. </param>
        ...
        /// <param name="partyId"> ID of the associated party. </param>
        /// <param name="prescriptionId"> ID of the prescription to be deleted. </param>
        /// <param name="context"> The request context, which can override default behaviors of the client pipeline on a per-call basis. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="jobId"/>, <paramref name="partyId"/> or <paramref name="prescriptionId"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="jobId"/> is an empty string, and was expected to be non-empty. </exception>
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        ...
        public virtual async Task<Operation<BinaryData>> CreateCascadeDeleteJobAsync(WaitUntil waitUntil, string jobId, string partyId, string prescriptionId, RequestContext context = null)
        {
            ...
            try
            {
                using HttpMessage message = CreateCreateCascadeDeleteJobRequest(jobId, partyId, prescriptionId, context);
                return await ProtocolOperationHelpers.ProcessMessageAsync(_pipeline, message, ClientDiagnostics, "Prescriptions.CreateCascadeDeleteJob", OperationFinalStateVia.Location, context, waitUntil).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual Operation<BinaryData> CreateCascadeDeleteJob(WaitUntil waitUntil, string jobId, string partyId, string prescriptionId, RequestContext context = null)
        {
            ...
            {
                using HttpMessage message = CreateCreateCascadeDeleteJobRequest(jobId, partyId, prescriptionId, context);
                return ProtocolOperationHelpers.ProcessMessage(_pipeline, message, ClientDiagnostics, "Prescriptions.CreateCascadeDeleteJob", OperationFinalStateVia.Location, context, waitUntil);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        internal HttpMessage CreateGetPrescriptionRequest(string partyId, string prescriptionId, RequestContext context)
        {
            var message = _pipeline.CreateMessage(context, ResponseClassifier200);
            var request = message.Request;
            request.Method = RequestMethod.Get;
            ...
            uri.AppendPath(partyId, true);
            uri.AppendPath("/prescriptions/", false);
            uri.AppendPath(prescriptionId, true);
            uri.AppendQuery("api-version", _apiVersion, true);
            request.Uri = uri;
            request.Headers.Add("Accept", "application/json");
            return message;
        ...
        internal HttpMessage CreateCreateOrUpdateRequest(string partyId, string prescriptionId, RequestContent content, RequestContext context)
        {
        ...
        internal HttpMessage CreateDeleteRequest(string partyId, string prescriptionId, RequestContext context)
        {
        ...
        internal HttpMessage CreateGetPrescriptionsRequest(IEnumerable<string> prescriptionMapIds, IEnumerable<string> types, IEnumerable<string> productCodes, IEnumerable<string> productNames, IEnumerable<string> sources, IEnumerable<string> ids, IEnumerable<string> names, IEnumerable<string> propertyFilters, IEnumerable<string> statuses, DateTimeOffset? minCreatedDateTime, DateTimeOffset? maxCreatedDateTime, DateTimeOffset? minLastModifiedDateTime, DateTimeOffset? maxLastModifiedDateTime, int? maxPageSize, string skipToken, RequestContext context)
        {
            var message = _pipeline.CreateMessage(context, ResponseClassifier200);
            var request = message.Request;
            request.Method = RequestMethod.Get;
        ...
        internal HttpMessage CreateGetCascadeDeleteJobDetailsRequest(string jobId, RequestContext context)
        {
            ...
            var uri = new RawRequestUriBuilder();
            uri.Reset(_endpoint);
            uri.AppendPath("/prescriptions/cascade-delete/", false);
        ...
        internal HttpMessage CreateCreateCascadeDeleteJobRequest(string jobId, string partyId, string prescriptionId, RequestContext context)
        {
            ...
            uri.AppendQuery("prescriptionId", prescriptionId, true);
            uri.AppendQuery("api-version", _apiVersion, true);
            request.Uri = uri;
            request.Headers.Add("Accept", "application/json");
            return message;
        ...
        internal HttpMessage CreateGetPrescriptionsByPartyIdNextPageRequest(string nextLink, string partyId, IEnumerable<string> prescriptionMapIds, IEnumerable<string> types, IEnumerable<string> productCodes, IEnumerable<string> productNames, IEnumerable<string> sources, IEnumerable<string> ids, IEnumerable<string> names, IEnumerable<string> propertyFilters, IEnumerable<string> statuses, DateTimeOffset? minCreatedDateTime, DateTimeOffset? maxCreatedDateTime, DateTimeOffset? minLastModifiedDateTime, DateTimeOffset? maxLastModifiedDateTime, int? maxPageSize, string skipToken, RequestContext context)
        {
            var message = _pipeline.CreateMessage(context, ResponseClassifier200);
            var request = message.Request;
            request.Method = RequestMethod.Get;
        ...
        internal HttpMessage CreateGetPrescriptionsNextPageRequest(string nextLink, IEnumerable<string> prescriptionMapIds, IEnumerable<string> types, IEnumerable<string> productCodes, IEnumerable<string> productNames, IEnumerable<string> sources, IEnumerable<string> ids, IEnumerable<string> names, IEnumerable<string> propertyFilters, IEnumerable<string> statuses, DateTimeOffset? minCreatedDateTime, DateTimeOffset? maxCreatedDateTime, DateTimeOffset? minLastModifiedDateTime, DateTimeOffset? maxLastModifiedDateTime, int? maxPageSize, string skipToken, RequestContext context)
        {
            var message = _pipeline.CreateMessage(context, ResponseClassifier200);
            var request = message.Request;
            request.Method = RequestMethod.Get;
