...
namespace Azure.Verticals.AgriFood.Farming
{
    ...
    public partial class OAuthProviders
    {
        ...
        internal RequestUriBuilder CreateGetOAuthProvidersRequestUri(IEnumerable<string> providerIds, IEnumerable<string> names, IEnumerable<string> propertyFilters, IEnumerable<string> statuses, DateTimeOffset? minCreatedDateTime, DateTimeOffset? maxCreatedDateTime, DateTimeOffset? minLastModifiedDateTime, DateTimeOffset? maxLastModifiedDateTime, int? maxPageSize, string skipToken, RequestContext context)
        {
        ...
        internal RequestUriBuilder CreateGetOAuthProviderRequestUri(string oauthProviderId, RequestContext context)
        {
            var uri = new RawRequestUriBuilder();
            uri.Reset(_endpoint);
            uri.AppendPath("/oauth/providers/", false);
        ...
        internal RequestUriBuilder CreateCreateOrUpdateRequestUri(string oauthProviderId, RequestContent content, RequestContext context)
        {
            var uri = new RawRequestUriBuilder();
            uri.Reset(_endpoint);
            uri.AppendPath("/oauth/providers/", false);
        ...
        internal RequestUriBuilder CreateDeleteRequestUri(string oauthProviderId, RequestContext context)
        {
            var uri = new RawRequestUriBuilder();
            uri.Reset(_endpoint);
            uri.AppendPath("/oauth/providers/", false);
        ...
        internal RequestUriBuilder CreateCreateCascadeDeleteJobRequestUri(string jobId, string oauthProviderId, RequestContext context)
        {
            var uri = new RawRequestUriBuilder();
            uri.Reset(_endpoint);
            uri.AppendPath("/oauth/providers/cascade-delete/", false);
        ...
        internal RequestUriBuilder CreateGetOAuthProvidersNextPageRequestUri(string nextLink, IEnumerable<string> providerIds, IEnumerable<string> names, IEnumerable<string> propertyFilters, IEnumerable<string> statuses, DateTimeOffset? minCreatedDateTime, DateTimeOffset? maxCreatedDateTime, DateTimeOffset? minLastModifiedDateTime, DateTimeOffset? maxLastModifiedDateTime, int? maxPageSize, string skipToken, RequestContext context)
        {
            var uri = new RawRequestUriBuilder();
            uri.Reset(_endpoint);
