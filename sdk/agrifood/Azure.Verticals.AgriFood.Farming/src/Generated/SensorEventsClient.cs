...
{
    // Data plane generated client. The SensorEvents service client.
    /// <summary> The SensorEvents service client. </summary>
    public partial class SensorEventsClient
    {
        ...
        /// <summary> Initializes a new instance of SensorEventsClient for mocking. </summary>
        protected SensorEventsClient()
        {
        }

        /// <summary> Initializes a new instance of SensorEventsClient. </summary>
        /// <param name="endpoint"> The endpoint of your FarmBeats resource (protocol and hostname, for example: https://{resourceName}.farmbeats.azure.net). </param>
        /// <param name="credential"> A credential used to authenticate to an Azure Service. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="endpoint"/> or <paramref name="credential"/> is null. </exception>
        public SensorEventsClient(TokenCredential credential, Uri endpoint) : this(credential, endpoint, new FarmBeatsClientOptions())
        {
        }
        ...
        public SensorEventsClient(TokenCredential credential, Uri endpoint, FarmBeatsClientOptions options)
        {
        ...
        /// var client = new SensorEventsClient(credential);
        /// 
        ...
        /// Console.WriteLine(result.GetProperty("value")[0].GetProperty("farmerId").ToString());
        ...
        public virtual async Task<Response> GetSensorEventsAsync(string sensorId, string sensorPartnerId, DateTimeOffset? startDateTime = null, DateTimeOffset? endDateTime = null, bool? excludeDuplicateEvents = null, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("SensorEventsClient.GetSensorEvents");
            scope.Start();
            try
            {
