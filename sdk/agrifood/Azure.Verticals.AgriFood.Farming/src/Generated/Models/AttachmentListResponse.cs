...
namespace Azure.Verticals.AgriFood.Farming.Models
{
    ...
    {
        /// <summary> Initializes a new instance of AttachmentListResponse. </summary>
        internal AttachmentListResponse()
        {
            Value = new ChangeTrackingList<Attachment>();
        }
        ...
        internal AttachmentListResponse(IReadOnlyList<Attachment> value, string skipToken, string nextLink)
        {
            Value = value;
            SkipToken = skipToken;
            NextLink = nextLink;
        ...
        public IReadOnlyList<Attachment> Value { get; }
