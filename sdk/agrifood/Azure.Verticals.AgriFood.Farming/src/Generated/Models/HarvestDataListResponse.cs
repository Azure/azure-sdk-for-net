...
namespace Azure.Verticals.AgriFood.Farming.Models
{
    ...
    {
        /// <summary> Initializes a new instance of HarvestDataListResponse. </summary>
        internal HarvestDataListResponse()
        {
            Value = new ChangeTrackingList<HarvestData>();
        }
        ...
        internal HarvestDataListResponse(IReadOnlyList<HarvestData> value, string skipToken, string nextLink)
        {
            Value = value;
            SkipToken = skipToken;
            NextLink = nextLink;
        ...
        public IReadOnlyList<HarvestData> Value { get; }
