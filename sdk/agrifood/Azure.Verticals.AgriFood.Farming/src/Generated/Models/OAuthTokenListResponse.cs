...
namespace Azure.Verticals.AgriFood.Farming.Models
{
    ...
    {
        /// <summary> Initializes a new instance of OAuthTokenListResponse. </summary>
        internal OAuthTokenListResponse()
        {
            Value = new ChangeTrackingList<OAuthToken>();
        }
        ...
        internal OAuthTokenListResponse(IReadOnlyList<OAuthToken> value, string skipToken, string nextLink)
        {
            Value = value;
            SkipToken = skipToken;
            NextLink = nextLink;
        ...
        public IReadOnlyList<OAuthToken> Value { get; }
