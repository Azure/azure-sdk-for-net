...
namespace Azure.Verticals.AgriFood.Farming.Models
{
    ...
    {
        /// <summary> Initializes a new instance of FarmListResponse. </summary>
        internal FarmListResponse()
        {
            Value = new ChangeTrackingList<Farm>();
        }
        ...
        internal FarmListResponse(IReadOnlyList<Farm> value, string skipToken, string nextLink)
        {
            Value = value;
            SkipToken = skipToken;
            NextLink = nextLink;
        ...
        public IReadOnlyList<Farm> Value { get; }
