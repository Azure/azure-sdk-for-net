...
{
    /// <summary> Schema of farm resource. </summary>
    public partial class Farm
    {
        ...
        /// </param>
        internal Farm(string farmerId, string id, string eTag, string status, DateTimeOffset? createdDateTime, DateTimeOffset? modifiedDateTime, string name, string description, IDictionary<string, object> properties)
        {
            FarmerId = farmerId;
            Id = id;
            ETag = eTag;
