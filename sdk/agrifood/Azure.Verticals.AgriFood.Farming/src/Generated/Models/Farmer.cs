...
{
    /// <summary> Schema of farmer resource. </summary>
    public partial class Farmer
    {
        ...
        /// </param>
        internal Farmer(string id, string eTag, string status, DateTimeOffset? createdDateTime, DateTimeOffset? modifiedDateTime, string name, string description, IDictionary<string, object> properties)
        {
            Id = id;
            ETag = eTag;
            Status = status;
