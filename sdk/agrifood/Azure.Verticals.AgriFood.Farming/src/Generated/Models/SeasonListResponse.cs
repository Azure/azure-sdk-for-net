...
namespace Azure.Verticals.AgriFood.Farming.Models
{
    ...
    {
        /// <summary> Initializes a new instance of SeasonListResponse. </summary>
        internal SeasonListResponse()
        {
            Value = new ChangeTrackingList<Season>();
        }
        ...
        internal SeasonListResponse(IReadOnlyList<Season> value, string skipToken, string nextLink)
        {
            Value = value;
            SkipToken = skipToken;
            NextLink = nextLink;
        ...
        public IReadOnlyList<Season> Value { get; }
