...
{
    /// <summary> Schema of season resource. </summary>
    public partial class Season
    {
        ...
        /// </param>
        internal Season(DateTimeOffset? startDateTime, DateTimeOffset? endDateTime, int? year, string id, string eTag, string status, DateTimeOffset? createdDateTime, DateTimeOffset? modifiedDateTime, string name, string description, IDictionary<string, object> properties)
        {
        ...
        /// <summary> Season start datetime, sample format: yyyy-MM-ddTHH:mm:ssZ. </summary>
        public DateTimeOffset? StartDateTime { get; set; }
        /// <summary> Season end datetime, sample format: yyyy-MM-ddTHH:mm:ssZ. </summary>
