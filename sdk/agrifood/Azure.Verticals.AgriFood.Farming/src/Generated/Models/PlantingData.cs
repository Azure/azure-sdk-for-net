...
{
    /// <summary> Schema of planting data resource. </summary>
    public partial class PlantingData
    {
        /// <summary> Initializes a new instance of PlantingData. </summary>
        public PlantingData()
        {
            PlantingProductDetails = new ChangeTrackingList<PlantingProductDetail>();
        ...
        /// </param>
        internal PlantingData(Measure avgPlantingRate, Measure totalMaterial, Measure avgMaterial, IList<PlantingProductDetail> plantingProductDetails, Measure area, string source, DateTimeOffset? operationModifiedDateTime, DateTimeOffset? operationStartDateTime, DateTimeOffset? operationEndDateTime, string attachmentsLink, string associatedBoundaryId, string operationBoundaryId, string farmerId, string id, string eTag, string status, DateTimeOffset? createdDateTime, DateTimeOffset? modifiedDateTime, string name, string description, IDictionary<string, object> properties)
        {
            AvgPlantingRate = avgPlantingRate;
            TotalMaterial = totalMaterial;
            AvgMaterial = avgMaterial;
            PlantingProductDetails = plantingProductDetails;
            Area = area;
            Source = source;
        ...
        public Measure AvgPlantingRate { get; set; }
        /// <summary> Schema for storing measurement reading and unit. </summary>
        public Measure TotalMaterial { get; set; }
        /// <summary> Schema for storing measurement reading and unit. </summary>
        public Measure AvgMaterial { get; set; }
        /// <summary> Planting product details. </summary>
        public IList<PlantingProductDetail> PlantingProductDetails { get; }
        /// <summary> Schema for storing measurement reading and unit. </summary>
