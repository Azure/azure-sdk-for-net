...
{
    /// <summary> Schema of field resource. </summary>
    public partial class Field
    {
        ...
        /// </param>
        internal Field(string farmId, string farmerId, string primaryBoundaryId, IReadOnlyList<string> boundaryIds, string id, string eTag, string status, DateTimeOffset? createdDateTime, DateTimeOffset? modifiedDateTime, string name, string description, IDictionary<string, object> properties)
        {
            FarmId = farmId;
            FarmerId = farmerId;
