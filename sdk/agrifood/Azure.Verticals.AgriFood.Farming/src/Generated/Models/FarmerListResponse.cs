...
namespace Azure.Verticals.AgriFood.Farming.Models
{
    ...
    internal partial class FarmerListResponse
    {
        /// <summary> Initializes a new instance of FarmerListResponse. </summary>
        internal FarmerListResponse()
        {
            Value = new ChangeTrackingList<Farmer>();
        }
        ...
        internal FarmerListResponse(IReadOnlyList<Farmer> value, string skipToken, string nextLink)
        {
            Value = value;
            SkipToken = skipToken;
            NextLink = nextLink;
        ...
        public IReadOnlyList<Farmer> Value { get; }
