...
namespace Azure.Verticals.AgriFood.Farming.Models
{
    ...
    {
        /// <summary> Initializes a new instance of BoundaryListResponse. </summary>
        internal BoundaryListResponse()
        {
            Value = new ChangeTrackingList<Boundary>();
        }
        ...
        internal BoundaryListResponse(IReadOnlyList<Boundary> value, string skipToken, string nextLink)
        {
            Value = value;
            SkipToken = skipToken;
            NextLink = nextLink;
        ...
        public IReadOnlyList<Boundary> Value { get; }
