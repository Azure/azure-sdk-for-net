...
{
    public partial class PlantingData : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            writer.WriteStartObject();
            if (Optional.IsDefined(AvgPlantingRate))
            {
                writer.WritePropertyName("avgPlantingRate");
                writer.WriteObjectValue(AvgPlantingRate);
            }
            ...
            if (Optional.IsCollectionDefined(PlantingProductDetails))
            {
                writer.WritePropertyName("plantingProductDetails");
                writer.WriteStartArray();
                foreach (var item in PlantingProductDetails)
                {
        ...
        internal static PlantingData DeserializePlantingData(JsonElement element)
        {
            Optional<Measure> avgPlantingRate = default;
            Optional<Measure> totalMaterial = default;
            Optional<Measure> avgMaterial = default;
            Optional<IList<PlantingProductDetail>> plantingProductDetails = default;
            ...
            {
                if (property.NameEquals("avgPlantingRate"))
                {
                    ...
                    avgPlantingRate = Measure.DeserializeMeasure(property.Value);
                    continue;
                }
                ...
                if (property.NameEquals("plantingProductDetails"))
                {
                    if (property.Value.ValueKind == JsonValueKind.Null)
                    {
                        property.ThrowNonNullablePropertyIsNull();
                    ...
                    List<PlantingProductDetail> array = new List<PlantingProductDetail>();
                    foreach (var item in property.Value.EnumerateArray())
                    {
                        array.Add(PlantingProductDetail.DeserializePlantingProductDetail(item));
                    }
                    plantingProductDetails = array;
                    continue;
                }
            ...
            return new PlantingData(avgPlantingRate.Value, totalMaterial.Value, avgMaterial.Value, Optional.ToList(plantingProductDetails), area.Value, source.Value, Optional.ToNullable(operationModifiedDateTime), Optional.ToNullable(operationStartDateTime), Optional.ToNullable(operationEndDateTime), attachmentsLink.Value, associatedBoundaryId.Value, operationBoundaryId.Value, farmerId.Value, id.Value, eTag.Value, status.Value, Optional.ToNullable(createdDateTime), Optional.ToNullable(modifiedDateTime), name.Value, description.Value, Optional.ToDictionary(properties));
        }
    }
}
