...
{
    /// <summary> Schema of harvest data resource. </summary>
    public partial class HarvestData
    {
        /// <summary> Initializes a new instance of HarvestData. </summary>
        public HarvestData()
        {
            HarvestProductDetails = new ChangeTrackingList<HarvestProductDetail>();
        ...
        /// </param>
        internal HarvestData(Measure totalYield, Measure avgYield, Measure totalWetMass, Measure avgWetMass, Measure avgMoisture, Measure avgSpeed, IList<HarvestProductDetail> harvestProductDetails, Measure area, string source, DateTimeOffset? operationModifiedDateTime, DateTimeOffset? operationStartDateTime, DateTimeOffset? operationEndDateTime, string attachmentsLink, string associatedBoundaryId, string operationBoundaryId, string farmerId, string id, string eTag, string status, DateTimeOffset? createdDateTime, DateTimeOffset? modifiedDateTime, string name, string description, IDictionary<string, object> properties)
        {
            ...
            AvgSpeed = avgSpeed;
            HarvestProductDetails = harvestProductDetails;
            Area = area;
            Source = source;
        ...
        /// <summary> Schema for storing measurement reading and unit. </summary>
        public Measure AvgSpeed { get; set; }
        /// <summary> Harvest product details. </summary>
        public IList<HarvestProductDetail> HarvestProductDetails { get; }
        /// <summary> Schema for storing measurement reading and unit. </summary>
