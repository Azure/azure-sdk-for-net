...
namespace Azure.Verticals.AgriFood.Farming.Models
{
    ...
    {
        /// <summary> Initializes a new instance of OAuthProviderListResponse. </summary>
        internal OAuthProviderListResponse()
        {
            Value = new ChangeTrackingList<OAuthProvider>();
        }
        ...
        internal OAuthProviderListResponse(IReadOnlyList<OAuthProvider> value, string skipToken, string nextLink)
        {
            Value = value;
            SkipToken = skipToken;
            NextLink = nextLink;
        ...
        public IReadOnlyList<OAuthProvider> Value { get; }
