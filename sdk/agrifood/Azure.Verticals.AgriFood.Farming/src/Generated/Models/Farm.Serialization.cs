...
{
    public partial class Farm : IUtf8JsonSerializable
    {
        ...
        internal static Farm DeserializeFarm(JsonElement element)
        {
            ...
            return new Farm(farmerId.Value, id.Value, eTag.Value, status.Value, Optional.ToNullable(createdDateTime), Optional.ToNullable(modifiedDateTime), name.Value, description.Value, Optional.ToDictionary(properties));
        }
    }
}
