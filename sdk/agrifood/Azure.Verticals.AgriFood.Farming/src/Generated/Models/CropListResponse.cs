...
namespace Azure.Verticals.AgriFood.Farming.Models
{
    ...
    {
        /// <summary> Initializes a new instance of CropListResponse. </summary>
        internal CropListResponse()
        {
            Value = new ChangeTrackingList<Crop>();
        }
        ...
        internal CropListResponse(IReadOnlyList<Crop> value, string skipToken, string nextLink)
        {
            Value = value;
            SkipToken = skipToken;
            NextLink = nextLink;
        ...
        public IReadOnlyList<Crop> Value { get; }
