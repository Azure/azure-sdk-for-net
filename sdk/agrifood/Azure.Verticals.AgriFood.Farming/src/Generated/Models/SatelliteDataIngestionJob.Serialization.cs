...
{
    public partial class SatelliteDataIngestionJob : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            writer.WriteStringValue(EndDateTime, "O");
        ...
        internal static SatelliteDataIngestionJob DeserializeSatelliteDataIngestionJob(JsonElement element)
        {
            string farmerId = default;
            string boundaryId = default;
            DateTimeOffset startDateTime = default;
            DateTimeOffset endDateTime = default;
            Optional<DataProvider> provider = default;
            Optional<Source> source = default;
            Optional<SatelliteData> data = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("provider"))
                {
                    ...
                    provider = new DataProvider(property.Value.GetString());
                    continue;
                }
                ...
                if (property.NameEquals("data"))
                {
                    ...
                    data = SatelliteData.DeserializeSatelliteData(property.Value);
                    continue;
                }
            ...
            return new SatelliteDataIngestionJob(farmerId, boundaryId, startDateTime, endDateTime, Optional.ToNullable(provider), Optional.ToNullable(source), data.Value, id.Value, status.Value, Optional.ToNullable(durationInSeconds), message.Value, Optional.ToNullable(createdDateTime), Optional.ToNullable(lastActionDateTime), Optional.ToNullable(startTime), Optional.ToNullable(endTime), name.Value, description.Value, Optional.ToDictionary(properties));
        }
    }
}
