...
namespace Azure.Verticals.AgriFood.Farming.Models
{
    ...
    {
        /// <summary> Initializes a new instance of ApplicationDataListResponse. </summary>
        internal ApplicationDataListResponse()
        {
        ...
        internal ApplicationDataListResponse(IReadOnlyList<ApplicationData> value, string skipToken, string nextLink)
        {
            Value = value;
            SkipToken = skipToken;
            NextLink = nextLink;
