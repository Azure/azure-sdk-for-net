...
namespace Azure.Verticals.AgriFood.Farming.Models
{
    ...
    {
        /// <summary> Initializes a new instance of FieldListResponse. </summary>
        internal FieldListResponse()
        {
            Value = new ChangeTrackingList<Field>();
        }
        ...
        internal FieldListResponse(IReadOnlyList<Field> value, string skipToken, string nextLink)
        {
            Value = value;
            SkipToken = skipToken;
            NextLink = nextLink;
        ...
        public IReadOnlyList<Field> Value { get; }
