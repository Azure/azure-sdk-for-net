...
namespace Azure.Verticals.AgriFood.Farming.Models
{
    ...
    {
        /// <summary> Initializes a new instance of TillageDataListResponse. </summary>
        internal TillageDataListResponse()
        {
            Value = new ChangeTrackingList<TillageData>();
        }
        ...
        internal TillageDataListResponse(IReadOnlyList<TillageData> value, string skipToken, string nextLink)
        {
            Value = value;
            SkipToken = skipToken;
            NextLink = nextLink;
        ...
        public IReadOnlyList<TillageData> Value { get; }
