...
namespace Azure.Verticals.AgriFood.Farming.Models
{
    ...
    {
        /// <summary> Initializes a new instance of WeatherDataListResponse. </summary>
        internal WeatherDataListResponse()
        {
            Value = new ChangeTrackingList<WeatherData>();
        }
        ...
        internal WeatherDataListResponse(IReadOnlyList<WeatherData> value, string skipToken, string nextLink)
        {
            Value = value;
            SkipToken = skipToken;
            NextLink = nextLink;
        ...
        public IReadOnlyList<WeatherData> Value { get; }
