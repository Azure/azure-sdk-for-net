...
namespace Azure.Verticals.AgriFood.Farming
{
    ...
    public partial class PlantingData
    {
        ...
        /// <include file="Docs/PlantingData.xml" path="doc/members/member[@name='GetAllPlantingDataByFarmerIdAsync(String,Double,Double,Double,Double,Double,Double,IEnumerable,IEnumerable,DateTimeOffset,DateTimeOffset,DateTimeOffset,DateTimeOffset,DateTimeOffset,DateTimeOffset,Double,Double,IEnumerable,IEnumerable,IEnumerable,IEnumerable,DateTimeOffset,DateTimeOffset,DateTimeOffset,DateTimeOffset,Int32,String,RequestContext)']/*" />
        ...
        /// <include file="Docs/PlantingData.xml" path="doc/members/member[@name='GetAllPlantingDataByFarmerId(String,Double,Double,Double,Double,Double,Double,IEnumerable,IEnumerable,DateTimeOffset,DateTimeOffset,DateTimeOffset,DateTimeOffset,DateTimeOffset,DateTimeOffset,Double,Double,IEnumerable,IEnumerable,IEnumerable,IEnumerable,DateTimeOffset,DateTimeOffset,DateTimeOffset,DateTimeOffset,Int32,String,RequestContext)']/*" />
