...
namespace Azure.ResourceManager.WorkloadsSapVirtualInstance.Models
{
    ...
    public partial class StopSapInstanceContent : IJsonModel<StopSapInstanceContent>
    {
        ...
        internal static RequestContent ToRequestContent(StopSapInstanceContent stopSapInstanceContent)
        {
            ...
            return RequestContent.Create(stopSapInstanceContent, ModelSerializationExtensions.WireOptions);
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        StopSapInstanceContent IJsonModel<StopSapInstanceContent>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual StopSapInstanceContent JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<StopSapInstanceContent>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static StopSapInstanceContent DeserializeStopSapInstanceContent(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            {
                if (prop.NameEquals("softStopTimeoutSeconds"u8))
                {
                    if (prop.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
                    }
                    softStopTimeoutSeconds = prop.Value.GetInt64();
                    continue;
                }
                if (prop.NameEquals("deallocateVm"u8))
                {
                    if (prop.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
                    }
                    deallocateVm = prop.Value.GetBoolean();
                    continue;
                }
                if (options.Format != "W")
                {
