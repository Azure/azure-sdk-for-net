...
namespace Azure.ResourceManager.WorkloadsSapVirtualInstance.Models
{
    ...
    internal partial class VirtualMachineResourceNames
    {
        ...
        internal VirtualMachineResourceNames(string vmName, string hostName, IList<NetworkInterfaceResourceNames> networkInterfaces, string osDiskName, IDictionary<string, IList<string>> dataDiskNames, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            VmName = vmName;
            HostName = hostName;
