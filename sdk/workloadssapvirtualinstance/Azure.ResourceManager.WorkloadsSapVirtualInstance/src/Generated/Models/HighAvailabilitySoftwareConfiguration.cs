...
namespace Azure.ResourceManager.WorkloadsSapVirtualInstance.Models
{
    ...
    internal partial class HighAvailabilitySoftwareConfiguration
    {
        ...
        internal HighAvailabilitySoftwareConfiguration(string fencingClientId, string fencingClientPassword, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            FencingClientId = fencingClientId;
            FencingClientPassword = fencingClientPassword;
