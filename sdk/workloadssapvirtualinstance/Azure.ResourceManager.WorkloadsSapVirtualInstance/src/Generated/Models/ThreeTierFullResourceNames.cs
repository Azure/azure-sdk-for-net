...
namespace Azure.ResourceManager.WorkloadsSapVirtualInstance.Models
{
    ...
    internal partial class ThreeTierFullResourceNames : ThreeTierCustomResourceNames
    {
        /// <summary> Initializes a new instance of <see cref="ThreeTierFullResourceNames"/>. </summary>
        public ThreeTierFullResourceNames() : base(SapNamingPatternType.FullResourceName)
        {
        }
        ...
        internal ThreeTierFullResourceNames(SapNamingPatternType namingPatternType, IDictionary<string, BinaryData> additionalBinaryDataProperties, CentralServerFullResourceNames centralServer, ApplicationServerFullResourceNames applicationServer, DatabaseServerFullResourceNames databaseServer, SharedStorageResourceNames sharedStorage) : base(namingPatternType, additionalBinaryDataProperties)
        {
