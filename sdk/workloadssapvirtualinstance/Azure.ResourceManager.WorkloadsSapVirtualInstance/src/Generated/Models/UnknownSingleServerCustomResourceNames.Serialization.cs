...
{
    internal partial class UnknownSingleServerCustomResourceNames : SingleServerCustomResourceNames, IJsonModel<SingleServerCustomResourceNames>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownSingleServerCustomResourceNames DeserializeUnknownSingleServerCustomResourceNames(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownSingleServerCustomResourceNames(namingPatternType, additionalBinaryDataProperties);
        }
