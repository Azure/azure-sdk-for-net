...
namespace Azure.ResourceManager.WorkloadsSapVirtualInstance.Models
{
    ...
    public partial class SapApplicationServerInstancePatch : IJsonModel<SapApplicationServerInstancePatch>
    {
        ...
        /// <param name="patch"> The <see cref="SapApplicationServerInstancePatch"/> to serialize into <see cref="RequestContent"/>. </param>
        internal static RequestContent ToRequestContent(SapApplicationServerInstancePatch patch)
        {
            if (patch == null)
            {
                return null;
