...
namespace Azure.ResourceManager.WorkloadsSapVirtualInstance.Models
{
    ...
    public partial class ThreeTierRecommendationResult : SapSizingRecommendationResult
    {
        ...
        internal ThreeTierRecommendationResult() : base(SapDeploymentType.ThreeTier)
        {
        }
        ...
        internal ThreeTierRecommendationResult(SapDeploymentType deploymentType, IDictionary<string, BinaryData> additionalBinaryDataProperties, string dbVmSku, long? databaseInstanceCount, string centralServerVmSku, long? centralServerInstanceCount, string applicationServerVmSku, long? applicationServerInstanceCount) : base(deploymentType, additionalBinaryDataProperties)
        {
            DBVmSku = dbVmSku;
