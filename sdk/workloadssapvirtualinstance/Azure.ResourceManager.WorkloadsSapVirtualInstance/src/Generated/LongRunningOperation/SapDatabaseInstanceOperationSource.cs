...
namespace Azure.ResourceManager.WorkloadsSapVirtualInstance
{
    internal class SapDatabaseInstanceOperationSource : IOperationSource<SapDatabaseInstanceResource>
    {
        ...
        {
            var data = ModelReaderWriter.Read<SapDatabaseInstanceData>(response.Content, ModelReaderWriterOptions.Json, AzureResourceManagerWorkloadsSapVirtualInstanceContext.Default);
