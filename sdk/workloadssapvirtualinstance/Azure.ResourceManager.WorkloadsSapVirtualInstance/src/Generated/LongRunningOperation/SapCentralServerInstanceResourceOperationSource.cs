...
{
    /// <summary></summary>
    internal partial class SapCentralServerInstanceResourceOperationSource : IOperationSource<SapCentralServerInstanceResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal SapCentralServerInstanceResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
