...
#pragma warning disable SA1649 // File name should match first type name
    internal class WorkloadsSapVirtualInstanceArmOperation<T> : ArmOperation<T>
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        /// <summary> Initializes a new instance of WorkloadsSapVirtualInstanceArmOperation for mocking. </summary>
        protected WorkloadsSapVirtualInstanceArmOperation()
        {
        }

        internal WorkloadsSapVirtualInstanceArmOperation(Response<T> response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal WorkloadsSapVirtualInstanceArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal<T>(NextLinkOperationImplementation.Create(source, nextLinkOperation), clientDiagnostics, response, "WorkloadsSapVirtualInstanceArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
        ...
        private string GetOperationId(RehydrationToken? rehydrationToken)
        {
            ...
            var lroDetails = ModelReaderWriter.Write(rehydrationToken, ModelReaderWriterOptions.Json, AzureResourceManagerWorkloadsSapVirtualInstanceContext.Default).ToObjectFromJson<Dictionary<string, string>>();
