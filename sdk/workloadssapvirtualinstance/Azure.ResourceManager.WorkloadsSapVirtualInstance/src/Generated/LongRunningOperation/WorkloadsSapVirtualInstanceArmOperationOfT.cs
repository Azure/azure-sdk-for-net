...
namespace Azure.ResourceManager.WorkloadsSapVirtualInstance
{
    internal partial class WorkloadsSapVirtualInstanceArmOperation<T> : ArmOperation<T>
    {
        ...
        internal WorkloadsSapVirtualInstanceArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
