...
#pragma warning disable SA1649 // File name should match first type name
    internal class WorkloadsSapVirtualInstanceArmOperation : ArmOperation
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        internal WorkloadsSapVirtualInstanceArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal WorkloadsSapVirtualInstanceArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal(nextLinkOperation, clientDiagnostics, response, "WorkloadsSapVirtualInstanceArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
