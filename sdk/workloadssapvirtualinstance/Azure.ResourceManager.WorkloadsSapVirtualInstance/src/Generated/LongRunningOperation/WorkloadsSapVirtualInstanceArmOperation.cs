...
namespace Azure.ResourceManager.WorkloadsSapVirtualInstance
{
    internal partial class WorkloadsSapVirtualInstanceArmOperation : ArmOperation
    {
        ...
        internal WorkloadsSapVirtualInstanceArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
