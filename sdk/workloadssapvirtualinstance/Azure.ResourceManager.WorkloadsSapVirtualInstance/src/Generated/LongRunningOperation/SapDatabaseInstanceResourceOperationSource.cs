...
{
    /// <summary></summary>
    internal partial class SapDatabaseInstanceResourceOperationSource : IOperationSource<SapDatabaseInstanceResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal SapDatabaseInstanceResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
