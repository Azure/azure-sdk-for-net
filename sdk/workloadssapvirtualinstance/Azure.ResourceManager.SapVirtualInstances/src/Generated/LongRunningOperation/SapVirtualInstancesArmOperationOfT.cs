...
#pragma warning disable SA1649 // File name should match first type name
    internal class SapVirtualInstancesArmOperation<T> : ArmOperation<T>
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        /// <summary> Initializes a new instance of SapVirtualInstancesArmOperation for mocking. </summary>
        protected SapVirtualInstancesArmOperation()
        {
        }

        internal SapVirtualInstancesArmOperation(Response<T> response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal SapVirtualInstancesArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal<T>(NextLinkOperationImplementation.Create(source, nextLinkOperation), clientDiagnostics, response, "SapVirtualInstancesArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
