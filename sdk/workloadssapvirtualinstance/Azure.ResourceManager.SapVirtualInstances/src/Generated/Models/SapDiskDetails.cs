...
namespace Azure.ResourceManager.SapVirtualInstances.Models
{
    ...
    public partial class SapDiskDetails
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="SapDiskDetails"/>. </summary>
        internal SapDiskDetails()
        {
        }
        ...
        internal SapDiskDetails(DiskSku sku, long? sizeGB, long? minimumSupportedDiskCount, long? maximumSupportedDiskCount, long? iopsReadWrite, long? mbpsReadWrite, string diskTier, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Sku = sku;
            SizeGB = sizeGB;
