...
namespace Azure.ResourceManager.SapVirtualInstances.Models
{
    ...
    public partial class SapImageReference
    {
        ...
        internal SapImageReference(string publisher, string offer, string sku, string version, ResourceIdentifier id, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Publisher = publisher;
            Offer = offer;
            Sku = sku;
