...
namespace Azure.ResourceManager.SapVirtualInstances.Models
{
    ...
    public partial class ExternalInstallationSoftwareConfiguration : SoftwareConfiguration
    {
        ...
        internal ExternalInstallationSoftwareConfiguration(SapSoftwareInstallationType softwareInstallationType, IDictionary<string, BinaryData> serializedAdditionalRawData, string centralServerVmId) : base(softwareInstallationType, serializedAdditionalRawData)
        {
