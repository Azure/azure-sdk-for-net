...
namespace Azure.ResourceManager.SapVirtualInstances.Models
{
    ...
    public partial class CentralServerConfiguration
    {
        ...
        internal CentralServerConfiguration(string subnetId, VirtualMachineConfiguration virtualMachineConfiguration, long instanceCount, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            SubnetId = subnetId;
            VirtualMachineConfiguration = virtualMachineConfiguration;
            InstanceCount = instanceCount;
