...
namespace Azure.ResourceManager.SapVirtualInstances.Models
{
    ...
    public partial class SapDatabaseConfiguration
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="SapDatabaseConfiguration"/>. </summary>
        ...
        public SapDatabaseConfiguration(string subnetId, VirtualMachineConfiguration virtualMachineConfiguration, long instanceCount)
        {
        ...
        internal SapDatabaseConfiguration(SapDatabaseType? databaseType, string subnetId, VirtualMachineConfiguration virtualMachineConfiguration, long instanceCount, DiskConfiguration diskConfiguration, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
        ...
        /// <summary> Initializes a new instance of <see cref="SapDatabaseConfiguration"/> for deserialization. </summary>
        internal SapDatabaseConfiguration()
        {
        }
