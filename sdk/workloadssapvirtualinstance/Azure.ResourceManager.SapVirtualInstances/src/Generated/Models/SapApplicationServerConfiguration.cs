...
namespace Azure.ResourceManager.SapVirtualInstances.Models
{
    ...
    public partial class SapApplicationServerConfiguration
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="SapApplicationServerConfiguration"/>. </summary>
        ...
        public SapApplicationServerConfiguration(string subnetId, VirtualMachineConfiguration virtualMachineConfiguration, long instanceCount)
        {
        ...
        internal SapApplicationServerConfiguration(string subnetId, VirtualMachineConfiguration virtualMachineConfiguration, long instanceCount, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            SubnetId = subnetId;
            VirtualMachineConfiguration = virtualMachineConfiguration;
            InstanceCount = instanceCount;
        ...
        /// <summary> Initializes a new instance of <see cref="SapApplicationServerConfiguration"/> for deserialization. </summary>
        internal SapApplicationServerConfiguration()
        {
        }
