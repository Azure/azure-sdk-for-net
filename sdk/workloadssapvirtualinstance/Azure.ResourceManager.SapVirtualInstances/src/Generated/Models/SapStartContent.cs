...
namespace Azure.ResourceManager.SapVirtualInstances.Models
{
    ...
    public partial class SapStartContent
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="SapStartContent"/>. </summary>
        public SapStartContent()
        {
        }
        ...
        internal SapStartContent(bool? startVm, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            StartVm = startVm;
