...
namespace Azure.ResourceManager.SapVirtualInstances.Models
{
    ...
    public partial class SapDiscoveryConfiguration : SapConfiguration
    {
        /// <summary> Initializes a new instance of <see cref="SapDiscoveryConfiguration"/>. </summary>
        public SapDiscoveryConfiguration()
        {
        ...
        internal SapDiscoveryConfiguration(SapConfigurationType configurationType, IDictionary<string, BinaryData> serializedAdditionalRawData, string centralServerVmId, string managedRgStorageAccountName, string appLocation) : base(configurationType, serializedAdditionalRawData)
        {
