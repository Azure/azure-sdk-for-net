...
namespace Azure.ResourceManager.SapVirtualInstances.Models
{
    ...
    public partial class SapLinuxConfiguration : SapOSConfiguration
    {
        ...
        internal SapLinuxConfiguration(OSType osType, IDictionary<string, BinaryData> serializedAdditionalRawData, bool? disablePasswordAuthentication, SshConfiguration ssh, SapSshKeyPair sshKeyPair) : base(osType, serializedAdditionalRawData)
        {
