...
namespace Azure.ResourceManager.SapVirtualInstances.Models
{
    ...
    public partial class DeploymentConfiguration : SapConfiguration
    {
        ...
        /// Please note <see cref="Models.SoftwareConfiguration"/> is the base class. According to the scenario, a derived class of the base class might need to be assigned here, or this property needs to be casted to one of the possible derived classes.
        ...
        /// </param>
        internal DeploymentConfiguration(SapConfigurationType configurationType, IDictionary<string, BinaryData> serializedAdditionalRawData, string appLocation, InfrastructureConfiguration infrastructureConfiguration, SoftwareConfiguration softwareConfiguration) : base(configurationType, serializedAdditionalRawData)
        {
