...
namespace Microsoft.Azure.Management.Quota
{
    ...
    {
        /// <summary>
        /// Gets the quota request details and status by quota request ID for
        ...
        /// quota requests under the subscription for a one year period ending
        /// at the time is made. Use the **oData** filter can be used to select
        /// quota requests.
        /// </summary>
        /// <param name='scope'>
        /// The target Azure resource URI. For example,
        ...
        /// **nextLink** element, the value of the **nextLink** element
        /// includes a **skiptoken** parameter that specifies a starting point
