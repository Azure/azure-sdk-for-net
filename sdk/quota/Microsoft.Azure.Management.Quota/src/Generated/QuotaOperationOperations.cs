...
namespace Microsoft.Azure.Management.Quota
{
    ...
    /// </summary>
    internal partial class QuotaOperationOperations : IServiceOperations<AzureQuotaExtensionAPIClient>, IQuotaOperationOperations
    {
        /// <summary>
        /// Initializes a new instance of the QuotaOperationOperations class.
        /// </summary>
        /// <param name='client'>
        ...
        /// </exception>
        internal QuotaOperationOperations(AzureQuotaExtensionAPIClient client)
        {
            if (client == null)
            {
