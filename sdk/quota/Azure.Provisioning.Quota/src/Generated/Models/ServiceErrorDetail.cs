...
namespace Azure.Provisioning.Quota
{
    ...
    public partial class ServiceErrorDetail : ProvisionableConstruct
    {
        private BicepValue<string> _code;
        private BicepValue<string> _message;

        /// <summary> Creates a new ServiceErrorDetail. </summary>
        ...
        /// <summary> Define all the provisionable properties for ServiceErrorDetail. </summary>
        ...
        /// <summary> Define additional provisionable properties for ServiceErrorDetail that are not part of the generated code. </summary>
