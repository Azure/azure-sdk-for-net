...
{
    public partial class Sample_GroupQuotaSubscriptionIdCollection
    {
        ...
        public async Task CreateOrUpdate_GroupQuotaSubscriptionsPutSubscriptions()
        {
            ...
            ArmOperation<GroupQuotaSubscriptionIdResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, subscriptionId);
        ...
        public async Task Get_GroupQuotaSubscriptionsGetSubscriptions()
        {
            ...
            // invoke the operation
            string subscriptionId = "00000000-0000-0000-0000-000000000000";
            GroupQuotaSubscriptionIdResource result = await collection.GetAsync(subscriptionId);
        ...
        public async Task GetIfExists_GroupQuotaSubscriptionsGetSubscriptions()
        {
            ...
            // invoke the operation
            string subscriptionId = "00000000-0000-0000-0000-000000000000";
            NullableResponse<GroupQuotaSubscriptionIdResource> response = await collection.GetIfExistsAsync(subscriptionId);
            GroupQuotaSubscriptionIdResource result = response.HasValue ? response.Value : null;
        ...
        public async Task GetAll_GroupQuotaSubscriptionsListSubscriptions()
        {
            ...
            await foreach (GroupQuotaSubscriptionIdResource item in collection.GetAllAsync())
            {
