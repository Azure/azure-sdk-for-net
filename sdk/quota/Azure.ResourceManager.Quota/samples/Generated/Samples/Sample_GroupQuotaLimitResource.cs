...
{
    public partial class Sample_GroupQuotaLimitResource
    {
        [Test]
        ...
        public async Task Get_GroupQuotaLimitsGetRequestForCompute()
        {
            ...
            // this example assumes you already have this GroupQuotaLimitResource created on azure
            // for more information of creating GroupQuotaLimitResource, please refer to the document of GroupQuotaLimitResource
            ...
            ResourceIdentifier groupQuotaLimitResourceId = GroupQuotaLimitResource.CreateResourceIdentifier(managementGroupId, groupQuotaName, resourceProviderName, resourceName);
            GroupQuotaLimitResource groupQuotaLimit = client.GetGroupQuotaLimitResource(groupQuotaLimitResourceId);

            // invoke the operation
            string filter = "location eq westus";
            GroupQuotaLimitResource result = await groupQuotaLimit.GetAsync(filter);
