...
{
    public partial class Sample_GroupQuotasEntityCollection
    {
        ...
        public async Task Get_GroupQuotasGetRequestForCompute()
        {
            ...
            // invoke the operation
            string groupQuotaName = "groupquota1";
            GroupQuotasEntityResource result = await collection.GetAsync(groupQuotaName);
        ...
        public async Task GetIfExists_GroupQuotasGetRequestForCompute()
        {
            ...
            // invoke the operation
            string groupQuotaName = "groupquota1";
            NullableResponse<GroupQuotasEntityResource> response = await collection.GetIfExistsAsync(groupQuotaName);
            GroupQuotasEntityResource result = response.HasValue ? response.Value : null;
