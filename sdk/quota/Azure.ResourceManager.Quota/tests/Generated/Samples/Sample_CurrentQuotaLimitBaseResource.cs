...
namespace Azure.ResourceManager.Quota
{
    public partial class Sample_CurrentQuotaLimitBaseResource
    {
        ...
        {
            // Generated from example definition: specification/quota/resource-manager/Microsoft.Quota/preview/2021-03-15-preview/examples/patchComputeQuotaRequest.json
            ...
            CurrentQuotaLimitBaseData data = new CurrentQuotaLimitBaseData()
            {
                ...
                {
                    Limit = new LimitJsonObject()
                    {
                        LimitObjectType = LimitType.LimitValue,
                    },
        ...
        {
            // Generated from example definition: specification/quota/resource-manager/Microsoft.Quota/preview/2021-03-15-preview/examples/patchNetworkOneSkuQuotaRequest.json
            // this example is just showing the usage of "Quota_Update" operation, for the dependent resources, they will have to be created separately.
