...
namespace Azure.ResourceManager.Quota.Models
{
    ...
    public partial class QuotaUsagesProperties
    {
        ...
        internal QuotaUsagesProperties(QuotaUsagesObject usages, string unit, QuotaRequestResourceName name, string resourceTypeName, TimeSpan? quotaPeriod, bool? isQuotaApplicable, BinaryData properties, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Usages = usages;
            Unit = unit;
            Name = name;
