...
namespace Azure.ResourceManager.Quota.Models
{
    ...
    internal partial class QuotaAllocationRequestBasePropertiesName : IJsonModel<QuotaAllocationRequestBasePropertiesName>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        QuotaAllocationRequestBasePropertiesName IJsonModel<QuotaAllocationRequestBasePropertiesName>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual QuotaAllocationRequestBasePropertiesName JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<QuotaAllocationRequestBasePropertiesName>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static QuotaAllocationRequestBasePropertiesName DeserializeQuotaAllocationRequestBasePropertiesName(JsonElement element, ModelReaderWriterOptions options)
        {
