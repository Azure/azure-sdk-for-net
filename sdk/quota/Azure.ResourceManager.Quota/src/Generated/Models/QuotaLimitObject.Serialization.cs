...
namespace Azure.ResourceManager.Quota.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<QuotaLimitObject>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<QuotaLimitObject>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<QuotaLimitObject>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<QuotaLimitObject>)} interface");
            }
        ...
        string IPersistableModel<QuotaLimitObject>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
