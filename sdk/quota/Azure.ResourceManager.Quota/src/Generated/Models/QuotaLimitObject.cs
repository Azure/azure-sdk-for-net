...
namespace Azure.ResourceManager.Quota.Models
{
    ...
    public partial class QuotaLimitObject : QuotaLimitJsonObject
    {
        ...
        internal QuotaLimitObject(LimitType limitObjectType, int value, QuotaLimitType? limitType, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(limitObjectType, serializedAdditionalRawData)
        {
            Value = value;
            LimitType = limitType;
