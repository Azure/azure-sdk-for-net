...
namespace Azure.ResourceManager.Quota.Models
{
    ...
    public partial class QuotaLimitObject : QuotaLimitJsonObject
    {
        ...
        internal QuotaLimitObject(LimitType limitObjectType, int value, QuotaLimitType? limitType, Dictionary<string, BinaryData> rawData) : base(limitObjectType, rawData)
        {
            Value = value;
            LimitType = limitType;
