...
namespace Azure.ResourceManager.Quota.Models
{
    ...
    public partial class QuotaSubRequestDetail
    {
        ...
        internal QuotaSubRequestDetail(QuotaRequestResourceName name, string resourceTypeName, string unit, QuotaRequestState? provisioningState, string message, Guid? subRequestId, QuotaLimitJsonObject limit, Dictionary<string, BinaryData> rawData)
        {
            Name = name;
