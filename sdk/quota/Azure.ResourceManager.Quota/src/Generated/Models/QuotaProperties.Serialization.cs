...
{
    public partial class QuotaProperties : IUtf8JsonSerializable, IJsonModel<QuotaProperties>, IPersistableModel<QuotaProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Limit))
            {
                ...
                AppendChildObject(builder, Limit, options, 2);
            }
            ...
            if (Optional.IsDefined(QuotaPeriod))
            {
                ...
                var formattedTimeSpan = XmlConvert.ToString(QuotaPeriod.Value);
