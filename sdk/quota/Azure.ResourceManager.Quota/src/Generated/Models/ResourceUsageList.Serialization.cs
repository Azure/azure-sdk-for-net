...
{
    internal partial class ResourceUsageList : IUtf8JsonSerializable, IJsonModel<ResourceUsageList>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ResourceUsageList>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<ResourceUsageList>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        ResourceUsageList IJsonModel<ResourceUsageList>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ResourceUsageList>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static ResourceUsageList DeserializeResourceUsageList(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new ResourceUsageList(value, nextLink, serializedAdditionalRawData);
        }
        ...
        ResourceUsageList IPersistableModel<ResourceUsageList>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ResourceUsageList>)this).GetFormatFromOptions(options) : options.Format;
