...
namespace Azure.ResourceManager.Quota.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<QuotaUsagesProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<QuotaUsagesProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<QuotaUsagesProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<QuotaUsagesProperties>)} interface");
            }
        ...
        string IPersistableModel<QuotaUsagesProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
