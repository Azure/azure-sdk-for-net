...
namespace Azure.ResourceManager.Quota.Models
{
    ...
    internal partial class QuotaRequestDetailsList
    {
        ...
        internal QuotaRequestDetailsList(IEnumerable<Quota.QuotaRequestDetailData> value)
        {
            Value = value.ToList();
        }
        ...
        internal QuotaRequestDetailsList(IList<Quota.QuotaRequestDetailData> value, Uri nextLink, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            NextLink = nextLink;
        ...
        [WirePath("value")]
        public IList<Quota.QuotaRequestDetailData> Value { get; }
