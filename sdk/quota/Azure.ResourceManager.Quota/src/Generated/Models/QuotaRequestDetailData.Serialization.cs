...
namespace Azure.ResourceManager.Quota
{
    public partial class QuotaRequestDetailData : IUtf8JsonSerializable, IModelJsonSerializable<QuotaRequestDetailData>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<QuotaRequestDetailData>(this, options.Format);
            ...
            if (Optional.IsDefined(Error))
            {
                ...
                {
                    ((IModelJsonSerializable<ServiceErrorDetail>)Error).Serialize(writer, options);
                }
            }
            if (Optional.IsCollectionDefined(Value))
            {
                ...
                foreach (var item in Value)
                {
                    ...
                    {
                        ((IModelJsonSerializable<QuotaSubRequestDetail>)item).Serialize(writer, options);
                    }
                }
        ...
        internal static QuotaRequestDetailData DeserializeQuotaRequestDetailData(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new QuotaRequestDetailData(id, name, type, systemData.Value, Optional.ToNullable(provisioningState), message.Value, error.Value, Optional.ToNullable(requestSubmitTime), Optional.ToList(value), rawData);
        }
