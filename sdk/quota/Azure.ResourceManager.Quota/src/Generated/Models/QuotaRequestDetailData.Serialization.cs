...
{
    public partial class QuotaRequestDetailData : IUtf8JsonSerializable, IJsonModel<QuotaRequestDetailData>, IPersistableModel<QuotaRequestDetailData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(RequestSubmitOn))
            {
                ...
                builder.AppendLine($" '{RequestSubmitOn.Value.ToString()}'");
            }
