...
namespace Azure.ResourceManager.Quota.Models
{
    ...
    public partial class GroupQuotasEntityPatch : ResourceData
    {
        ...
        internal GroupQuotasEntityPatch(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, GroupQuotasEntityBasePatch properties, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
        ...
        /// <summary> Properties and filters for ShareQuota. The request parameter is optional, if there are no filters specified. </summary>
        public GroupQuotasEntityBasePatch Properties { get; set; }
    }
}
