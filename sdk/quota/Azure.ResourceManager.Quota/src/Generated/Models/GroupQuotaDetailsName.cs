...
namespace Azure.ResourceManager.Quota.Models
{
    ...
    internal partial class GroupQuotaDetailsName
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="GroupQuotaDetailsName"/>. </summary>
        ...
        internal GroupQuotaDetailsName(string value, string localizedValue, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
