...
namespace Azure.ResourceManager.Quota
{
    ...
    public partial class GroupQuotasEnforcementStatusData : ResourceData
    {
        ...
        internal GroupQuotasEnforcementStatusData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, GroupQuotasEnforcementStatusProperties properties, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, name, resourceType, systemData)
        {
