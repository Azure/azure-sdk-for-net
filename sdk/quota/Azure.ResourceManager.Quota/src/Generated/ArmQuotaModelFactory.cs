...
namespace Azure.ResourceManager.Quota.Models
{
    ...
    public static partial class ArmQuotaModelFactory
    {
        ...
        {
            return new CurrentUsagesBaseData(id, name, resourceType, systemData, properties, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new QuotaUsagesProperties(usages, unit, name, resourceTypeName, quotaPeriod, isQuotaApplicable, properties, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new QuotaUsagesObject(value, usagesType, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new QuotaRequestResourceName(value, localizedValue, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ServiceErrorDetail(code, message, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new CurrentQuotaLimitBaseData(id, name, resourceType, systemData, properties, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new QuotaProperties(limit, unit, name, resourceTypeName, quotaPeriod, isQuotaApplicable, properties, new Dictionary<string, BinaryData>());
        }
        ...
        public static QuotaRequestDetailData QuotaRequestDetailData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, QuotaRequestState? provisioningState = null, string message = null, ServiceErrorDetail error = null, DateTimeOffset? requestSubmitOn = null, IEnumerable<QuotaSubRequestDetail> value = null)
        {
            ...
            return new QuotaRequestDetailData(id, name, resourceType, systemData, provisioningState, message, error, requestSubmitOn, value?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new QuotaSubRequestDetail(name, resourceTypeName, unit, provisioningState, message, subRequestId, limit, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new QuotaOperationResult(name, display, origin, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new QuotaOperationDisplay(provider, resource, operation, description, new Dictionary<string, BinaryData>());
        }
    }
}
