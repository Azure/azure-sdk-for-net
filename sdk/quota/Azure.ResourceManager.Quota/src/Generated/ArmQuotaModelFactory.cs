...
namespace Azure.ResourceManager.Quota.Models
{
    ...
    public static partial class ArmQuotaModelFactory
    {
        ...
        {
            return new CurrentUsagesBaseData(id, name, resourceType, systemData, properties, default);
        }
        ...
        {
            return new QuotaUsagesProperties(usages, unit, name, resourceTypeName, quotaPeriod, isQuotaApplicable, properties, default);
        }
        ...
        {
            return new CurrentQuotaLimitBaseData(id, name, resourceType, systemData, properties, default);
        }
        ...
        {
            return new QuotaProperties(limit, unit, name, resourceTypeName, quotaPeriod, isQuotaApplicable, properties, default);
        }
        ...
        public static QuotaRequestDetailData QuotaRequestDetailData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, QuotaRequestState? provisioningState = null, string message = null, ServiceErrorDetail error = null, DateTimeOffset? requestSubmitOn = null, IEnumerable<QuotaSubRequestDetail> value = null)
        {
            ...
            return new QuotaRequestDetailData(id, name, resourceType, systemData, provisioningState, message, error, requestSubmitOn, value?.ToList(), default);
        }
        ...
        {
            return new QuotaSubRequestDetail(name, resourceTypeName, unit, provisioningState, message, subRequestId, limit, default);
        }
