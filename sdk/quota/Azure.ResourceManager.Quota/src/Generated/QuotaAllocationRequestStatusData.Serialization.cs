...
namespace Azure.ResourceManager.Quota
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<QuotaAllocationRequestStatusData>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static QuotaAllocationRequestStatusData DeserializeQuotaAllocationRequestStatusData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("properties"u8))
                {
                    ...
                    properties = QuotaAllocationRequestStatusProperties.DeserializeQuotaAllocationRequestStatusProperties(property.Value, options);
                    continue;
                }
