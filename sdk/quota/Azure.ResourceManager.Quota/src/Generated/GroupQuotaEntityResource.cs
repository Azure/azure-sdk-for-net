...
namespace Azure.ResourceManager.Quota
{
    ...
    public partial class GroupQuotaEntityResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<GroupQuotaEntityResource>> UpdateAsync(WaitUntil waitUntil, GroupQuotaEntityData data, CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _groupQuotasEntitiesClientDiagnostics.CreateScope("GroupQuotaEntityResource.Update");
            scope.Start();
            try
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<GroupQuotaEntityResource> Update(WaitUntil waitUntil, GroupQuotaEntityData data, CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _groupQuotasEntitiesClientDiagnostics.CreateScope("GroupQuotaEntityResource.Update");
            scope.Start();
            try
