...
{
    internal partial class GroupQuotasEntitiesGetAllAsyncCollectionResultOfT : AsyncPageable<GroupQuotaEntityData>
    {
        ...
        public GroupQuotasEntitiesGetAllAsyncCollectionResultOfT(GroupQuotasEntities client, string managementGroupId, RequestContext context) : base(context?.CancellationToken ?? default)
        {
        ...
        public override async IAsyncEnumerable<Page<GroupQuotaEntityData>> AsPages(string continuationToken, int? pageSizeHint)
        {
