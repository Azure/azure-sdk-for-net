...
{
    internal partial class GroupQuotasEntitiesGetAllAsyncCollectionResultOfT : AsyncPageable<GroupQuotaResourceUsages>
    {
        ...
        /// <summary> Initializes a new instance of GroupQuotasEntitiesGetAllAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public GroupQuotasEntitiesGetAllAsyncCollectionResultOfT(GroupQuotasEntities client, string managementGroupId, string groupQuotaName, string resourceProviderName, AzureLocation location, RequestContext context) : base(context?.CancellationToken ?? default)
        {
        ...
        /// <summary> Gets the pages of GroupQuotasEntitiesGetAllAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of GroupQuotasEntitiesGetAllAsyncCollectionResultOfT as an enumerable collection. </returns>
        public override async IAsyncEnumerable<Page<GroupQuotaResourceUsages>> AsPages(string continuationToken, int? pageSizeHint)
        {
