...
namespace Azure.ResourceManager.Quota
{
    ...
    public partial class GroupQuotaSubscriptionRequestStatusData : IJsonModel<GroupQuotaSubscriptionRequestStatusData>
    {
        ...
        internal static GroupQuotaSubscriptionRequestStatusData DeserializeGroupQuotaSubscriptionRequestStatusData(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = GroupQuotaSubscriptionRequestStatusProperties.DeserializeGroupQuotaSubscriptionRequestStatusProperties(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
