...
namespace Azure.ResourceManager.Quota
{
    internal partial class GroupQuotasEntitiesGetAllCollectionResultOfT : Pageable<GroupQuotaEntityData>
    {
        ...
        public GroupQuotasEntitiesGetAllCollectionResultOfT(GroupQuotasEntities client, string managementGroupId, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
