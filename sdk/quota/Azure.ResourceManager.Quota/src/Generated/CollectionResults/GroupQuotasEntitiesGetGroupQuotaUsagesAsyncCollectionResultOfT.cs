...
{
    internal partial class GroupQuotasEntitiesGetGroupQuotaUsagesAsyncCollectionResultOfT : AsyncPageable<GroupQuotaResourceUsages>
    {
        ...
        /// <summary> Initializes a new instance of GroupQuotasEntitiesGetGroupQuotaUsagesAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public GroupQuotasEntitiesGetGroupQuotaUsagesAsyncCollectionResultOfT(GroupQuotasEntities client, string managementGroupId, string groupQuotaName, string resourceProviderName, AzureLocation location, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of GroupQuotasEntitiesGetGroupQuotaUsagesAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of GroupQuotasEntitiesGetGroupQuotaUsagesAsyncCollectionResultOfT as an enumerable collection. </returns>
