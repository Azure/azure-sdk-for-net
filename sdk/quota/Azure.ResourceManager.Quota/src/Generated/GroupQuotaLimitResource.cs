...
namespace Azure.ResourceManager.Quota
{
    ...
    public partial class GroupQuotaLimitResource : ArmResource
    {
        ...
        public static ResourceIdentifier CreateResourceIdentifier(string managementGroupId, string groupQuotaName, string resourceProviderName, string resourceName)
        {
            var resourceId = $"/providers/Microsoft.Management/managementGroups/{managementGroupId}/providers/Microsoft.Quota/groupQuotas/{groupQuotaName}/resourceProviders/{resourceProviderName}/groupQuotaLimits/{resourceName}";
        ...
        public virtual async Task<Response<GroupQuotaLimitResource>> GetAsync(string filter, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _groupQuotaLimitRestClient.GetAsync(Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, filter, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<GroupQuotaLimitResource> Get(string filter, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _groupQuotaLimitRestClient.Get(Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, filter, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new GroupQuotaLimitResource(Client, response.Value), response.GetRawResponse());
            }
