...
namespace Azure.ResourceManager.Quota
{
    ...
    public partial class CurrentUsagesBaseResource : ArmResource
    {
        ...
        internal CurrentUsagesBaseResource(ArmClient client, CurrentUsagesBaseData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<CurrentUsagesBaseResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new CurrentUsagesBaseResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
