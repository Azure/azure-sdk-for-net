...
namespace Azure.ResourceManager.Quota.Mocking
{
    ...
    internal partial class QuotaArmClientMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="QuotaArmClientMockingExtension"/> class for mocking. </summary>
        protected QuotaArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="QuotaArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal QuotaArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal QuotaArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
