...
namespace Azure.ResourceManager.Quota.Mock
{
    ...
    public partial class TenantResourceExtension : ArmResource
    {
        ...
        public virtual AsyncPageable<OperationResponse> GetQuotaOperationsAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, OperationResponse.DeserializeOperationResponse, QuotaOperationClientDiagnostics, Pipeline, "TenantResourceExtension.GetQuotaOperations", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<OperationResponse> GetQuotaOperations(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => QuotaOperationRestClient.CreateListRequest();
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => QuotaOperationRestClient.CreateListNextPageRequest(nextLink);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, OperationResponse.DeserializeOperationResponse, QuotaOperationClientDiagnostics, Pipeline, "TenantResourceExtension.GetQuotaOperations", "value", "nextLink", cancellationToken);
        }
    }
}
