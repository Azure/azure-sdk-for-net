...
namespace Azure.ResourceManager.Quota.Testing
{
    ...
    public partial class QuotaTenantResourceExtension : ArmResource
    {
        private ClientDiagnostics _quotaOperationClientDiagnostics;
        private QuotaOperationRestOperations _quotaOperationRestClient;

        /// <summary> Initializes a new instance of the <see cref="QuotaTenantResourceExtension"/> class for mocking. </summary>
        protected QuotaTenantResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="QuotaTenantResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal QuotaTenantResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<QuotaOperationResult> GetQuotaOperationsAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, QuotaOperationResult.DeserializeQuotaOperationResult, QuotaOperationClientDiagnostics, Pipeline, "QuotaTenantResourceExtension.GetQuotaOperations", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<QuotaOperationResult> GetQuotaOperations(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => QuotaOperationRestClient.CreateListRequest();
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => QuotaOperationRestClient.CreateListNextPageRequest(nextLink);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, QuotaOperationResult.DeserializeQuotaOperationResult, QuotaOperationClientDiagnostics, Pipeline, "QuotaTenantResourceExtension.GetQuotaOperations", "value", "nextLink", cancellationToken);
        }
    }
}
