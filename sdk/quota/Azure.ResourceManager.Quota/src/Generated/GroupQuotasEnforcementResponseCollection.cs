...
namespace Azure.ResourceManager.Quota
{
    ...
    {
        private readonly ClientDiagnostics _groupQuotasEnforcementResponseGroupQuotaLocationSettingsClientDiagnostics;
        private readonly GroupQuotaLocationSettingsRestOperations _groupQuotasEnforcementResponseGroupQuotaLocationSettingsRestClient;
        ...
        internal GroupQuotasEnforcementResponseCollection(ArmClient client, ResourceIdentifier id, string resourceProviderName) : base(client, id)
        {
            ...
            _groupQuotasEnforcementResponseGroupQuotaLocationSettingsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Quota", GroupQuotasEnforcementResponseResource.ResourceType.Namespace, Diagnostics);
            TryGetApiVersion(GroupQuotasEnforcementResponseResource.ResourceType, out string groupQuotasEnforcementResponseGroupQuotaLocationSettingsApiVersion);
            _groupQuotasEnforcementResponseGroupQuotaLocationSettingsRestClient = new GroupQuotaLocationSettingsRestOperations(Pipeline, Diagnostics.ApplicationId, Endpoint, groupQuotasEnforcementResponseGroupQuotaLocationSettingsApiVersion);
#if DEBUG
        ...
        public virtual async Task<ArmOperation<GroupQuotasEnforcementResponseResource>> CreateOrUpdateAsync(WaitUntil waitUntil, AzureLocation location, GroupQuotasEnforcementResponseData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));

            using var scope = _groupQuotasEnforcementResponseGroupQuotaLocationSettingsClientDiagnostics.CreateScope("GroupQuotasEnforcementResponseCollection.CreateOrUpdate");
            scope.Start();
            try
            {
                var response = await _groupQuotasEnforcementResponseGroupQuotaLocationSettingsRestClient.CreateOrUpdateAsync(Id.Parent.Name, Id.Name, _resourceProviderName, location, data, cancellationToken).ConfigureAwait(false);
                var operation = new QuotaArmOperation<GroupQuotasEnforcementResponseResource>(new GroupQuotasEnforcementResponseOperationSource(Client), _groupQuotasEnforcementResponseGroupQuotaLocationSettingsClientDiagnostics, Pipeline, _groupQuotasEnforcementResponseGroupQuotaLocationSettingsRestClient.CreateCreateOrUpdateRequest(Id.Parent.Name, Id.Name, _resourceProviderName, location, data).Request, response, OperationFinalStateVia.Location);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        public virtual ArmOperation<GroupQuotasEnforcementResponseResource> CreateOrUpdate(WaitUntil waitUntil, AzureLocation location, GroupQuotasEnforcementResponseData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
            ...
            try
            {
                var response = _groupQuotasEnforcementResponseGroupQuotaLocationSettingsRestClient.CreateOrUpdate(Id.Parent.Name, Id.Name, _resourceProviderName, location, data, cancellationToken);
                var operation = new QuotaArmOperation<GroupQuotasEnforcementResponseResource>(new GroupQuotasEnforcementResponseOperationSource(Client), _groupQuotasEnforcementResponseGroupQuotaLocationSettingsClientDiagnostics, Pipeline, _groupQuotasEnforcementResponseGroupQuotaLocationSettingsRestClient.CreateCreateOrUpdateRequest(Id.Parent.Name, Id.Name, _resourceProviderName, location, data).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
        ...
        {
            using var scope = _groupQuotasEnforcementResponseGroupQuotaLocationSettingsClientDiagnostics.CreateScope("GroupQuotasEnforcementResponseCollection.Get");
            scope.Start();
            try
            {
                var response = await _groupQuotasEnforcementResponseGroupQuotaLocationSettingsRestClient.GetAsync(Id.Parent.Name, Id.Name, _resourceProviderName, location, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<GroupQuotasEnforcementResponseResource> Get(AzureLocation location, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _groupQuotasEnforcementResponseGroupQuotaLocationSettingsRestClient.Get(Id.Parent.Name, Id.Name, _resourceProviderName, location, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new GroupQuotasEnforcementResponseResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _groupQuotasEnforcementResponseGroupQuotaLocationSettingsRestClient.CreateListRequest(Id.Parent.Name, Id.Name, _resourceProviderName);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _groupQuotasEnforcementResponseGroupQuotaLocationSettingsRestClient.CreateListNextPageRequest(nextLink, Id.Parent.Name, Id.Name, _resourceProviderName);
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new GroupQuotasEnforcementResponseResource(Client, GroupQuotasEnforcementResponseData.DeserializeGroupQuotasEnforcementResponseData(e)), _groupQuotasEnforcementResponseGroupQuotaLocationSettingsClientDiagnostics, Pipeline, "GroupQuotasEnforcementResponseCollection.GetAll", "value", "nextLink", cancellationToken);
        }
        ...
        {
            using var scope = _groupQuotasEnforcementResponseGroupQuotaLocationSettingsClientDiagnostics.CreateScope("GroupQuotasEnforcementResponseCollection.Exists");
            scope.Start();
            try
            {
                var response = await _groupQuotasEnforcementResponseGroupQuotaLocationSettingsRestClient.GetAsync(Id.Parent.Name, Id.Name, _resourceProviderName, location, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<bool> Exists(AzureLocation location, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _groupQuotasEnforcementResponseGroupQuotaLocationSettingsRestClient.Get(Id.Parent.Name, Id.Name, _resourceProviderName, location, cancellationToken: cancellationToken);
                return Response.FromValue(response.Value != null, response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        {
            using var scope = _groupQuotasEnforcementResponseGroupQuotaLocationSettingsClientDiagnostics.CreateScope("GroupQuotasEnforcementResponseCollection.GetIfExists");
            scope.Start();
            try
            {
                var response = await _groupQuotasEnforcementResponseGroupQuotaLocationSettingsRestClient.GetAsync(Id.Parent.Name, Id.Name, _resourceProviderName, location, cancellationToken: cancellationToken).ConfigureAwait(false);
