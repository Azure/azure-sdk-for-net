...
namespace Azure.ResourceManager.Quota
{
    ...
    public partial class SubscriptionQuotaAllocationsListData : ResourceData
    {
        ...
        internal SubscriptionQuotaAllocationsListData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, SubscriptionQuotaAllocationsListProperties properties, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, name, resourceType, systemData)
        {
