...
namespace Azure.ResourceManager.Quota
{
    ...
    public partial class GroupQuotasEnforcementResponseResource : ArmResource
    {
        ...
        {
            _groupQuotasEnforcementResponseGroupQuotaLocationSettingsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Quota", ResourceType.Namespace, Diagnostics);
            TryGetApiVersion(ResourceType, out string groupQuotasEnforcementResponseGroupQuotaLocationSettingsApiVersion);
        ...
        {
            using var scope = _groupQuotasEnforcementResponseGroupQuotaLocationSettingsClientDiagnostics.CreateScope("GroupQuotasEnforcementResponseResource.Get");
            scope.Start();
            try
            {
                var response = await _groupQuotasEnforcementResponseGroupQuotaLocationSettingsRestClient.GetAsync(Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, new AzureLocation(Id.Name), cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<GroupQuotasEnforcementResponseResource> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _groupQuotasEnforcementResponseGroupQuotaLocationSettingsRestClient.Get(Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, new AzureLocation(Id.Name), cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new GroupQuotasEnforcementResponseResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        public virtual async Task<ArmOperation<GroupQuotasEnforcementResponseResource>> UpdateAsync(WaitUntil waitUntil, GroupQuotasEnforcementResponseData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));

            using var scope = _groupQuotasEnforcementResponseGroupQuotaLocationSettingsClientDiagnostics.CreateScope("GroupQuotasEnforcementResponseResource.Update");
            scope.Start();
            try
            {
                var response = await _groupQuotasEnforcementResponseGroupQuotaLocationSettingsRestClient.UpdateAsync(Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, new AzureLocation(Id.Name), data, cancellationToken).ConfigureAwait(false);
                var operation = new QuotaArmOperation<GroupQuotasEnforcementResponseResource>(new GroupQuotasEnforcementResponseOperationSource(Client), _groupQuotasEnforcementResponseGroupQuotaLocationSettingsClientDiagnostics, Pipeline, _groupQuotasEnforcementResponseGroupQuotaLocationSettingsRestClient.CreateUpdateRequest(Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, new AzureLocation(Id.Name), data).Request, response, OperationFinalStateVia.Location);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        public virtual ArmOperation<GroupQuotasEnforcementResponseResource> Update(WaitUntil waitUntil, GroupQuotasEnforcementResponseData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
            ...
            try
            {
                var response = _groupQuotasEnforcementResponseGroupQuotaLocationSettingsRestClient.Update(Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, new AzureLocation(Id.Name), data, cancellationToken);
                var operation = new QuotaArmOperation<GroupQuotasEnforcementResponseResource>(new GroupQuotasEnforcementResponseOperationSource(Client), _groupQuotasEnforcementResponseGroupQuotaLocationSettingsClientDiagnostics, Pipeline, _groupQuotasEnforcementResponseGroupQuotaLocationSettingsRestClient.CreateUpdateRequest(Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, new AzureLocation(Id.Name), data).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
