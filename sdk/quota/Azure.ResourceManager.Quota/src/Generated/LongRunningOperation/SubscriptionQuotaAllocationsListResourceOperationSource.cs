...
{
    /// <summary></summary>
    internal partial class SubscriptionQuotaAllocationsListResourceOperationSource : IOperationSource<SubscriptionQuotaAllocationsListResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal SubscriptionQuotaAllocationsListResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
