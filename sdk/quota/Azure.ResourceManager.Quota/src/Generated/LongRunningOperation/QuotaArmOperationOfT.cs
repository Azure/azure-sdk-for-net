...
namespace Azure.ResourceManager.Quota
{
    internal partial class QuotaArmOperation<T> : ArmOperation<T>
    {
        ...
        internal QuotaArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
