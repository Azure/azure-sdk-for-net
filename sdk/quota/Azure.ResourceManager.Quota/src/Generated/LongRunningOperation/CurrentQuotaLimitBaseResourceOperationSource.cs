...
{
    /// <summary></summary>
    internal partial class CurrentQuotaLimitBaseResourceOperationSource : IOperationSource<CurrentQuotaLimitBaseResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal CurrentQuotaLimitBaseResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
