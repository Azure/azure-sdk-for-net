...
{
    /// <summary></summary>
    internal partial class GroupQuotaEntityResourceOperationSource : IOperationSource<GroupQuotaEntityResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal GroupQuotaEntityResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
