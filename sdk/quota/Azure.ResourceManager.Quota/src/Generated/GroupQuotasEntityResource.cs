...
namespace Azure.ResourceManager.Quota
{
    ...
    public partial class GroupQuotasEntityResource : ArmResource
    {
        ...
        private readonly ClientDiagnostics _submittedResourceRequestStatusGroupQuotaLimitsRequestClientDiagnostics;
        private readonly GroupQuotaLimitsRequestRestOperations _submittedResourceRequestStatusGroupQuotaLimitsRequestRestClient;
        ...
        internal GroupQuotasEntityResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _submittedResourceRequestStatusGroupQuotaLimitsRequestClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Quota", SubmittedResourceRequestStatusResource.ResourceType.Namespace, Diagnostics);
            TryGetApiVersion(SubmittedResourceRequestStatusResource.ResourceType, out string submittedResourceRequestStatusGroupQuotaLimitsRequestApiVersion);
            _submittedResourceRequestStatusGroupQuotaLimitsRequestRestClient = new GroupQuotaLimitsRequestRestOperations(Pipeline, Diagnostics.ApplicationId, Endpoint, submittedResourceRequestStatusGroupQuotaLimitsRequestApiVersion);
        ...
        /// <summary> Gets a collection of SubmittedResourceRequestStatusResources in the GroupQuotasEntity. </summary>
        /// <returns> An object representing collection of SubmittedResourceRequestStatusResources and their operations over a SubmittedResourceRequestStatusResource. </returns>
        public virtual SubmittedResourceRequestStatusCollection GetSubmittedResourceRequestStatuses()
        {
            return GetCachedClient(client => new SubmittedResourceRequestStatusCollection(client, Id));
        }
        ...
        /// <item>
        /// <term>Resource</term>
        /// <description><see cref="SubmittedResourceRequestStatusResource"/></description>
        /// </item>
        /// </list>
        /// </summary>
        /// <param name="requestId"> Request Id. </param>
        ...
        /// <exception cref="ArgumentException"> <paramref name="requestId"/> is an empty string, and was expected to be non-empty. </exception>
        [ForwardsClientCalls]
        public virtual async Task<Response<SubmittedResourceRequestStatusResource>> GetSubmittedResourceRequestStatusAsync(string requestId, CancellationToken cancellationToken = default)
        {
            return await GetSubmittedResourceRequestStatuses().GetAsync(requestId, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <exception cref="ArgumentException"> <paramref name="requestId"/> is an empty string, and was expected to be non-empty. </exception>
        [ForwardsClientCalls]
        public virtual Response<SubmittedResourceRequestStatusResource> GetSubmittedResourceRequestStatus(string requestId, CancellationToken cancellationToken = default)
        {
            return GetSubmittedResourceRequestStatuses().Get(requestId, cancellationToken);
        }
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new QuotaArmOperation(_groupQuotasEntityGroupQuotasClientDiagnostics, Pipeline, _groupQuotasEntityGroupQuotasRestClient.CreateDeleteRequest(Id.Parent.Name, Id.Name).Request, response, OperationFinalStateVia.Location);
        ...
        public virtual async Task<ArmOperation<GroupQuotasEntityResource>> UpdateAsync(WaitUntil waitUntil, GroupQuotasEntityPatch patch, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _groupQuotasEntityGroupQuotasRestClient.UpdateAsync(Id.Parent.Name, Id.Name, patch, cancellationToken).ConfigureAwait(false);
                var operation = new QuotaArmOperation<GroupQuotasEntityResource>(new GroupQuotasEntityOperationSource(Client), _groupQuotasEntityGroupQuotasClientDiagnostics, Pipeline, _groupQuotasEntityGroupQuotasRestClient.CreateUpdateRequest(Id.Parent.Name, Id.Name, patch).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="patch"/> is null. </exception>
        public virtual ArmOperation<GroupQuotasEntityResource> Update(WaitUntil waitUntil, GroupQuotasEntityPatch patch, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(patch, nameof(patch));
            ...
            try
            {
                var response = _groupQuotasEntityGroupQuotasRestClient.Update(Id.Parent.Name, Id.Name, patch, cancellationToken);
                var operation = new QuotaArmOperation<GroupQuotasEntityResource>(new GroupQuotasEntityOperationSource(Client), _groupQuotasEntityGroupQuotasClientDiagnostics, Pipeline, _groupQuotasEntityGroupQuotasRestClient.CreateUpdateRequest(Id.Parent.Name, Id.Name, patch).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<ArmOperation<SubmittedResourceRequestStatusResource>> CreateOrUpdateGroupQuotaLimitsRequestAsync(WaitUntil waitUntil, string resourceProviderName, string resourceName, SubmittedResourceRequestStatusData data = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(resourceProviderName, nameof(resourceProviderName));
            Argument.AssertNotNullOrEmpty(resourceName, nameof(resourceName));

            using var scope = _submittedResourceRequestStatusGroupQuotaLimitsRequestClientDiagnostics.CreateScope("GroupQuotasEntityResource.CreateOrUpdateGroupQuotaLimitsRequest");
            scope.Start();
            try
            {
                var response = await _submittedResourceRequestStatusGroupQuotaLimitsRequestRestClient.CreateOrUpdateAsync(Id.Parent.Name, Id.Name, resourceProviderName, resourceName, data, cancellationToken).ConfigureAwait(false);
                var operation = new QuotaArmOperation<SubmittedResourceRequestStatusResource>(new SubmittedResourceRequestStatusOperationSource(Client), _submittedResourceRequestStatusGroupQuotaLimitsRequestClientDiagnostics, Pipeline, _submittedResourceRequestStatusGroupQuotaLimitsRequestRestClient.CreateCreateOrUpdateRequest(Id.Parent.Name, Id.Name, resourceProviderName, resourceName, data).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                    await operation.WaitForCompletionAsync(cancellationToken).ConfigureAwait(false);
                return operation;
            }
        ...
        /// <exception cref="ArgumentException"> <paramref name="resourceProviderName"/> or <paramref name="resourceName"/> is an empty string, and was expected to be non-empty. </exception>
        /// <exception cref="ArgumentNullException"> <paramref name="resourceProviderName"/> or <paramref name="resourceName"/> is null. </exception>
        public virtual ArmOperation<SubmittedResourceRequestStatusResource> CreateOrUpdateGroupQuotaLimitsRequest(WaitUntil waitUntil, string resourceProviderName, string resourceName, SubmittedResourceRequestStatusData data = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(resourceProviderName, nameof(resourceProviderName));
            Argument.AssertNotNullOrEmpty(resourceName, nameof(resourceName));
            ...
            try
            {
                var response = _submittedResourceRequestStatusGroupQuotaLimitsRequestRestClient.CreateOrUpdate(Id.Parent.Name, Id.Name, resourceProviderName, resourceName, data, cancellationToken);
                var operation = new QuotaArmOperation<SubmittedResourceRequestStatusResource>(new SubmittedResourceRequestStatusOperationSource(Client), _submittedResourceRequestStatusGroupQuotaLimitsRequestClientDiagnostics, Pipeline, _submittedResourceRequestStatusGroupQuotaLimitsRequestRestClient.CreateCreateOrUpdateRequest(Id.Parent.Name, Id.Name, resourceProviderName, resourceName, data).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                    operation.WaitForCompletion(cancellationToken);
                return operation;
        ...
        /// <exception cref="ArgumentException"> <paramref name="resourceProviderName"/> or <paramref name="resourceName"/> is an empty string, and was expected to be non-empty. </exception>
        /// <exception cref="ArgumentNullException"> <paramref name="resourceProviderName"/> or <paramref name="resourceName"/> is null. </exception>
        public virtual async Task<ArmOperation<SubmittedResourceRequestStatusResource>> UpdateGroupQuotaLimitsRequestAsync(WaitUntil waitUntil, string resourceProviderName, string resourceName, SubmittedResourceRequestStatusData data = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(resourceProviderName, nameof(resourceProviderName));
            Argument.AssertNotNullOrEmpty(resourceName, nameof(resourceName));

            using var scope = _submittedResourceRequestStatusGroupQuotaLimitsRequestClientDiagnostics.CreateScope("GroupQuotasEntityResource.UpdateGroupQuotaLimitsRequest");
            scope.Start();
            try
            {
                var response = await _submittedResourceRequestStatusGroupQuotaLimitsRequestRestClient.UpdateAsync(Id.Parent.Name, Id.Name, resourceProviderName, resourceName, data, cancellationToken).ConfigureAwait(false);
                var operation = new QuotaArmOperation<SubmittedResourceRequestStatusResource>(new SubmittedResourceRequestStatusOperationSource(Client), _submittedResourceRequestStatusGroupQuotaLimitsRequestClientDiagnostics, Pipeline, _submittedResourceRequestStatusGroupQuotaLimitsRequestRestClient.CreateUpdateRequest(Id.Parent.Name, Id.Name, resourceProviderName, resourceName, data).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                    await operation.WaitForCompletionAsync(cancellationToken).ConfigureAwait(false);
                return operation;
            }
        ...
        /// <exception cref="ArgumentException"> <paramref name="resourceProviderName"/> or <paramref name="resourceName"/> is an empty string, and was expected to be non-empty. </exception>
        /// <exception cref="ArgumentNullException"> <paramref name="resourceProviderName"/> or <paramref name="resourceName"/> is null. </exception>
        public virtual ArmOperation<SubmittedResourceRequestStatusResource> UpdateGroupQuotaLimitsRequest(WaitUntil waitUntil, string resourceProviderName, string resourceName, SubmittedResourceRequestStatusData data = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(resourceProviderName, nameof(resourceProviderName));
            Argument.AssertNotNullOrEmpty(resourceName, nameof(resourceName));
            ...
            try
            {
                var response = _submittedResourceRequestStatusGroupQuotaLimitsRequestRestClient.Update(Id.Parent.Name, Id.Name, resourceProviderName, resourceName, data, cancellationToken);
                var operation = new QuotaArmOperation<SubmittedResourceRequestStatusResource>(new SubmittedResourceRequestStatusOperationSource(Client), _submittedResourceRequestStatusGroupQuotaLimitsRequestClientDiagnostics, Pipeline, _submittedResourceRequestStatusGroupQuotaLimitsRequestRestClient.CreateUpdateRequest(Id.Parent.Name, Id.Name, resourceProviderName, resourceName, data).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                    operation.WaitForCompletion(cancellationToken);
                return operation;
        ...
        /// <returns> An async collection of <see cref="SubmittedResourceRequestStatusResource"/> that may take multiple service requests to iterate over. </returns>
        public virtual AsyncPageable<SubmittedResourceRequestStatusResource> GetGroupQuotaLimitsRequestsAsync(string resourceProviderName, string filter, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(resourceProviderName, nameof(resourceProviderName));
            Argument.AssertNotNull(filter, nameof(filter));

            HttpMessage FirstPageRequest(int? pageSizeHint) => _submittedResourceRequestStatusGroupQuotaLimitsRequestRestClient.CreateListRequest(Id.Parent.Name, Id.Name, resourceProviderName, filter);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _submittedResourceRequestStatusGroupQuotaLimitsRequestRestClient.CreateListNextPageRequest(nextLink, Id.Parent.Name, Id.Name, resourceProviderName, filter);
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new SubmittedResourceRequestStatusResource(Client, SubmittedResourceRequestStatusData.DeserializeSubmittedResourceRequestStatusData(e)), _submittedResourceRequestStatusGroupQuotaLimitsRequestClientDiagnostics, Pipeline, "GroupQuotasEntityResource.GetGroupQuotaLimitsRequests", "value", "nextLink", cancellationToken);
        }
        ...
        /// <exception cref="ArgumentException"> <paramref name="resourceProviderName"/> is an empty string, and was expected to be non-empty. </exception>
        /// <exception cref="ArgumentNullException"> <paramref name="resourceProviderName"/> or <paramref name="filter"/> is null. </exception>
        /// <returns> A collection of <see cref="SubmittedResourceRequestStatusResource"/> that may take multiple service requests to iterate over. </returns>
        public virtual Pageable<SubmittedResourceRequestStatusResource> GetGroupQuotaLimitsRequests(string resourceProviderName, string filter, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(resourceProviderName, nameof(resourceProviderName));
            Argument.AssertNotNull(filter, nameof(filter));
            ...
            HttpMessage FirstPageRequest(int? pageSizeHint) => _submittedResourceRequestStatusGroupQuotaLimitsRequestRestClient.CreateListRequest(Id.Parent.Name, Id.Name, resourceProviderName, filter);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _submittedResourceRequestStatusGroupQuotaLimitsRequestRestClient.CreateListNextPageRequest(nextLink, Id.Parent.Name, Id.Name, resourceProviderName, filter);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new SubmittedResourceRequestStatusResource(Client, SubmittedResourceRequestStatusData.DeserializeSubmittedResourceRequestStatusData(e)), _submittedResourceRequestStatusGroupQuotaLimitsRequestClientDiagnostics, Pipeline, "GroupQuotasEntityResource.GetGroupQuotaLimitsRequests", "value", "nextLink", cancellationToken);
        }
        ...
        /// <exception cref="ArgumentException"> <paramref name="resourceProviderName"/> is an empty string, and was expected to be non-empty. </exception>
        /// <exception cref="ArgumentNullException"> <paramref name="resourceProviderName"/> is null. </exception>
        /// <returns> An async collection of <see cref="ResourceUsages"/> that may take multiple service requests to iterate over. </returns>
        public virtual AsyncPageable<ResourceUsages> GetGroupQuotaUsagesAsync(string resourceProviderName, AzureLocation location, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(resourceProviderName, nameof(resourceProviderName));
            ...
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => ResourceUsages.DeserializeResourceUsages(e), _groupQuotaUsagesClientDiagnostics, Pipeline, "GroupQuotasEntityResource.GetGroupQuotaUsages", "value", "nextLink", cancellationToken);
        }
        ...
        /// <exception cref="ArgumentException"> <paramref name="resourceProviderName"/> is an empty string, and was expected to be non-empty. </exception>
        /// <exception cref="ArgumentNullException"> <paramref name="resourceProviderName"/> is null. </exception>
        /// <returns> A collection of <see cref="ResourceUsages"/> that may take multiple service requests to iterate over. </returns>
        public virtual Pageable<ResourceUsages> GetGroupQuotaUsages(string resourceProviderName, AzureLocation location, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(resourceProviderName, nameof(resourceProviderName));

            HttpMessage FirstPageRequest(int? pageSizeHint) => _groupQuotaUsagesRestClient.CreateListRequest(Id.Parent.Name, Id.Name, resourceProviderName, location);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _groupQuotaUsagesRestClient.CreateListNextPageRequest(nextLink, Id.Parent.Name, Id.Name, resourceProviderName, location);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => ResourceUsages.DeserializeResourceUsages(e), _groupQuotaUsagesClientDiagnostics, Pipeline, "GroupQuotasEntityResource.GetGroupQuotaUsages", "value", "nextLink", cancellationToken);
        }
    }
}
