...
{
    public partial class Sample_AppPlatformCustomDomainResourceCollection
    {
        // CustomDomains_Get
        ...
        public async Task Get_CustomDomainsGet()
        {
            ...
            AppPlatformCustomDomainResourceCollection collection = appPlatformAppResource.GetAppPlatformCustomDomainResources();
        ...
        {
            // Generated from example definition: specification/appplatform/resource-manager/Microsoft.AppPlatform/preview/2022-03-01-preview/examples/CustomDomains_CreateOrUpdate.json
        ...
        {
            // Generated from example definition: specification/appplatform/resource-manager/Microsoft.AppPlatform/preview/2022-03-01-preview/examples/CustomDomains_List.json
            ...
            await foreach (AppPlatformCustomDomainResource item in collection.GetAllAsync())
            {
                ...
                // but just for demo, we get its data from this resource instance
                AppPlatformCustomDomainResourceData resourceData = item.Data;
                // for demo we just print out the id
                Console.WriteLine($"Succeeded on id: {resourceData.Id}");
            }
