...
{
    public partial class Sample_SupportedStackResourceCollection
    {
        ...
        {
            // Generated from example definition: specification/appplatform/resource-manager/Microsoft.AppPlatform/preview/2022-03-01-preview/examples/BuildService_ListSupportedStacks.json
            ...
            // get the collection of this SupportedStackResource
            SupportedStackResourceCollection collection = appBuildService.GetSupportedStackResources();

            // invoke the operation and iterate over the result
            await foreach (SupportedStackResource item in collection.GetAllAsync())
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                SupportedStackResourceData resourceData = item.Data;
        ...
        {
            // Generated from example definition: specification/appplatform/resource-manager/Microsoft.AppPlatform/preview/2022-03-01-preview/examples/BuildService_GetSupportedStack.json
            ...
            SupportedStackResource result = await collection.GetAsync(stackName);

            // the variable result is a resource, you could call other operations on this instance as well
            // but just for demo, we get its data from this resource instance
            SupportedStackResourceData resourceData = result.Data;
            // for demo we just print out the id
            Console.WriteLine($"Succeeded on id: {resourceData.Id}");
        }
