...
namespace Azure.ResourceManager.AppPlatform
{
    ...
    public partial class AppPlatformGatewayRouteConfigResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                using var message = _appPlatformGatewayRouteConfigGatewayRouteConfigsRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name);
                var response = await _appPlatformGatewayRouteConfigGatewayRouteConfigsRestClient.DeleteAsync(message, cancellationToken).ConfigureAwait(false);
                var operation = new AppPlatformArmOperation(_appPlatformGatewayRouteConfigGatewayRouteConfigsClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
        ...
        public virtual ArmOperation Delete(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var message = _appPlatformGatewayRouteConfigGatewayRouteConfigsRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name);
                var response = _appPlatformGatewayRouteConfigGatewayRouteConfigsRestClient.Delete(message, cancellationToken);
                var operation = new AppPlatformArmOperation(_appPlatformGatewayRouteConfigGatewayRouteConfigsClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<ArmOperation<AppPlatformGatewayRouteConfigResource>> UpdateAsync(WaitUntil waitUntil, AppPlatformGatewayRouteConfigData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                using var message = _appPlatformGatewayRouteConfigGatewayRouteConfigsRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, data);
                var response = await _appPlatformGatewayRouteConfigGatewayRouteConfigsRestClient.CreateOrUpdateAsync(message, cancellationToken).ConfigureAwait(false);
                var operation = new AppPlatformArmOperation<AppPlatformGatewayRouteConfigResource>(new AppPlatformGatewayRouteConfigOperationSource(Client), _appPlatformGatewayRouteConfigGatewayRouteConfigsClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual ArmOperation<AppPlatformGatewayRouteConfigResource> Update(WaitUntil waitUntil, AppPlatformGatewayRouteConfigData data, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var message = _appPlatformGatewayRouteConfigGatewayRouteConfigsRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, data);
                var response = _appPlatformGatewayRouteConfigGatewayRouteConfigsRestClient.CreateOrUpdate(message, cancellationToken);
                var operation = new AppPlatformArmOperation<AppPlatformGatewayRouteConfigResource>(new AppPlatformGatewayRouteConfigOperationSource(Client), _appPlatformGatewayRouteConfigGatewayRouteConfigsClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
