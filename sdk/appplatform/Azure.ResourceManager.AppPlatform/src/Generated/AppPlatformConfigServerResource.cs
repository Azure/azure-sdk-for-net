...
namespace Azure.ResourceManager.AppPlatform
{
    ...
    public partial class AppPlatformConfigServerResource : ArmResource
    {
        ...
        internal AppPlatformConfigServerResource(ArmClient client, AppPlatformConfigServerData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<AppPlatformConfigServerResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new AppPlatformConfigServerResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
