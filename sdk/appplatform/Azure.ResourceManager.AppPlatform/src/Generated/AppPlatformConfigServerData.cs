...
namespace Azure.ResourceManager.AppPlatform
{
    ...
    public partial class AppPlatformConfigServerData : ResourceData
    {
        ...
        internal AppPlatformConfigServerData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, AppPlatformConfigServerProperties properties, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
