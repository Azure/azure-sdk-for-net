...
namespace Azure.ResourceManager.AppPlatform.Mock
{
    ...
    public partial class AppPlatformServiceResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="AppPlatformServiceResourceExtension"/> class for mocking. </summary>
        protected AppPlatformServiceResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="AppPlatformServiceResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal AppPlatformServiceResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual async Task<Response<AppPlatformNameAvailabilityResult>> CheckAppPlatformNameAvailabilityAsync(AzureLocation location, AppPlatformNameAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = AppPlatformServiceServicesClientDiagnostics.CreateScope("AppPlatformServiceResourceExtension.CheckAppPlatformNameAvailability");
            scope.Start();
            try
            {
