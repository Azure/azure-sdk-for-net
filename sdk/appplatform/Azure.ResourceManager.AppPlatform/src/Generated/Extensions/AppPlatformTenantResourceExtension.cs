...
namespace Azure.ResourceManager.AppPlatform.Testing
{
    /// <summary> A class to add extension methods to TenantResource. </summary>
    public partial class AppPlatformTenantResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="AppPlatformTenantResourceExtension"/> class for mocking. </summary>
        protected AppPlatformTenantResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="AppPlatformTenantResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal AppPlatformTenantResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<AppPlatformSupportedRuntimeVersion> GetRuntimeVersionsAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, null, AppPlatformSupportedRuntimeVersion.DeserializeAppPlatformSupportedRuntimeVersion, RuntimeVersionsClientDiagnostics, Pipeline, "AppPlatformTenantResourceExtension.GetRuntimeVersions", "value", null, cancellationToken);
        }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => RuntimeVersionsRestClient.CreateListRuntimeVersionsRequest();
            return PageableHelpers.CreatePageable(FirstPageRequest, null, AppPlatformSupportedRuntimeVersion.DeserializeAppPlatformSupportedRuntimeVersion, RuntimeVersionsClientDiagnostics, Pipeline, "AppPlatformTenantResourceExtension.GetRuntimeVersions", "value", null, cancellationToken);
        }
    }
}
