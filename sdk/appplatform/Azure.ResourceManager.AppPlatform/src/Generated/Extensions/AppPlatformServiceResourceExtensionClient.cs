...
{
    /// <summary> A class to add extension methods to AppPlatformServiceResource. </summary>
    public partial class AppPlatformServiceResourceExtensionClient : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="AppPlatformServiceResourceExtensionClient"/> class for mocking. </summary>
        protected AppPlatformServiceResourceExtensionClient()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="AppPlatformServiceResourceExtensionClient"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal AppPlatformServiceResourceExtensionClient(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        private ClientDiagnostics AppPlatformServiceServicesClientDiagnostics => _appPlatformServiceServicesClientDiagnostics ??= new ClientDiagnostics("Azure.ResourceManager.AppPlatform.Mock", AppPlatformServiceResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<Response<AppPlatformNameAvailabilityResult>> CheckAppPlatformNameAvailabilityAsync(AzureLocation location, AppPlatformNameAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = AppPlatformServiceServicesClientDiagnostics.CreateScope("AppPlatformServiceResourceExtensionClient.CheckAppPlatformNameAvailability");
            scope.Start();
            try
            {
