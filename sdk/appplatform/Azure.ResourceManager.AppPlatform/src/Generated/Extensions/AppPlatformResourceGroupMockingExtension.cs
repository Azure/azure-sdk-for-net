...
namespace Azure.ResourceManager.AppPlatform.Mocking
{
    ...
    internal partial class AppPlatformResourceGroupMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="AppPlatformResourceGroupMockingExtension"/> class for mocking. </summary>
        protected AppPlatformResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="AppPlatformResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal AppPlatformResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
