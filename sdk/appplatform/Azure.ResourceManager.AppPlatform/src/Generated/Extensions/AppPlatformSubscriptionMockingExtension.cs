...
namespace Azure.ResourceManager.AppPlatform.Mocking
{
    ...
    internal partial class AppPlatformSubscriptionMockingExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="AppPlatformSubscriptionMockingExtension"/> class for mocking. </summary>
        protected AppPlatformSubscriptionMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="AppPlatformSubscriptionMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal AppPlatformSubscriptionMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        {
            using var scope = AppPlatformServiceServicesClientDiagnostics.CreateScope("AppPlatformSubscriptionMockingExtension.CheckAppPlatformNameAvailability");
            scope.Start();
            try
            {
        ...
        public virtual AsyncPageable<AvailableAppPlatformSku> GetSkusAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, AvailableAppPlatformSku.DeserializeAvailableAppPlatformSku, SkusClientDiagnostics, Pipeline, "AppPlatformSubscriptionMockingExtension.GetSkus", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<AvailableAppPlatformSku> GetSkus(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => SkusRestClient.CreateListRequest(Id.SubscriptionId);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => SkusRestClient.CreateListNextPageRequest(nextLink, Id.SubscriptionId);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, AvailableAppPlatformSku.DeserializeAvailableAppPlatformSku, SkusClientDiagnostics, Pipeline, "AppPlatformSubscriptionMockingExtension.GetSkus", "value", "nextLink", cancellationToken);
        }
    }
}
