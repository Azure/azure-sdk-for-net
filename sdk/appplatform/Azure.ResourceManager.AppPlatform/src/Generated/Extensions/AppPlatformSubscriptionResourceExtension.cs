...
namespace Azure.ResourceManager.AppPlatform.Testing
{
    ...
    public partial class AppPlatformSubscriptionResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="AppPlatformSubscriptionResourceExtension"/> class for mocking. </summary>
        protected AppPlatformSubscriptionResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="AppPlatformSubscriptionResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal AppPlatformSubscriptionResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual async Task<Response<AppPlatformNameAvailabilityResult>> CheckAppPlatformNameAvailabilityAsync(AzureLocation location, AppPlatformNameAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = AppPlatformServiceServicesClientDiagnostics.CreateScope("AppPlatformSubscriptionResourceExtension.CheckAppPlatformNameAvailability");
            scope.Start();
            try
            {
        ...
        public virtual AsyncPageable<AvailableAppPlatformSku> GetSkusAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, AvailableAppPlatformSku.DeserializeAvailableAppPlatformSku, SkusClientDiagnostics, Pipeline, "AppPlatformSubscriptionResourceExtension.GetSkus", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<AvailableAppPlatformSku> GetSkus(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => SkusRestClient.CreateListRequest(Id.SubscriptionId);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => SkusRestClient.CreateListNextPageRequest(nextLink, Id.SubscriptionId);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, AvailableAppPlatformSku.DeserializeAvailableAppPlatformSku, SkusClientDiagnostics, Pipeline, "AppPlatformSubscriptionResourceExtension.GetSkus", "value", "nextLink", cancellationToken);
        }
    }
}
