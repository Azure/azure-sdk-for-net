        ...
        internal static AppPlatformBuilderData DeserializeAppPlatformBuilderData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("properties"u8))
                {
                    ...
                    properties = AppPlatformBuilderProperties.DeserializeAppPlatformBuilderProperties(property.Value);
                    continue;
                }
            ...
            return new AppPlatformBuilderData(id, name, type, systemData.Value, properties.Value, serializedAdditionalRawData);
        }
