...
namespace Azure.ResourceManager.AppPlatform.Models
{
    ...
    public static partial class ArmAppPlatformModelFactory
    {
        ...
        public static AppPlatformServiceData AppPlatformServiceData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, AppPlatformServiceProperties properties = null, AppPlatformSku sku = null)
        {
            ...
            return new AppPlatformServiceData(id, name, resourceType, systemData, tags, location, properties, sku, default);
        }
        ...
        {
            return new AppPlatformServiceProperties(provisioningState, networkProfile, isLogStreamPublicEndpoint != null ? new ServiceVnetAddons(isLogStreamPublicEndpoint, new Dictionary<string, BinaryData>()) : null, version, serviceInstanceId, powerState, isZoneRedundant, fqdn, default);
        }
        ...
        public static AppPlatformServiceRequiredTraffic AppPlatformServiceRequiredTraffic(string protocol = null, int? port = null, IEnumerable<IPAddress> ips = null, IEnumerable<string> fqdns = null, AppPlatformServiceTrafficDirection? direction = null)
        {
            ...
            return new AppPlatformServiceRequiredTraffic(protocol, port, ips?.ToList(), fqdns?.ToList(), direction, default);
        }
        ...
        {
            return new AppPlatformServiceTestKeys(primaryKey, secondaryKey, primaryTestEndpoint, secondaryTestEndpoint, isEnabled, default);
        }
        ...
        {
            return new AppPlatformConfigServerData(id, name, resourceType, systemData, properties, default);
        }
        ...
        {
            return new AppPlatformConfigServerProperties(provisioningState, error, configServerGitProperty != null ? new ConfigServerSettings(configServerGitProperty, new Dictionary<string, BinaryData>()) : null, default);
        }
        ...
        public static ConfigServerSettingsValidateResult ConfigServerSettingsValidateResult(bool? isValid = null, IEnumerable<ConfigServerSettingsErrorRecord> details = null)
        {
            ...
            return new ConfigServerSettingsValidateResult(isValid, details?.ToList(), default);
        }
        ...
        public static ConfigServerSettingsErrorRecord ConfigServerSettingsErrorRecord(string name = null, Uri uri = null, IEnumerable<string> messages = null)
        {
            ...
            return new ConfigServerSettingsErrorRecord(name, uri, messages?.ToList(), default);
        }
        ...
        {
            return new AppPlatformConfigurationServiceData(id, name, resourceType, systemData, properties, default);
        }
        ...
        {
            return new AppPlatformConfigurationServiceRequirements(cpu, memory, instanceCount, default);
        }
        ...
        {
            return new AppPlatformConfigurationServiceInstance(name, status, default);
        }
        ...
        {
            return new AppPlatformConfigurationServiceSettingsValidateResult(gitPropertyValidationResult, default);
        }
        ...
        public static AppPlatformConfigurationServiceGitValidateResult AppPlatformConfigurationServiceGitValidateResult(bool? isValid = null, IEnumerable<AppPlatformConfigurationServiceGitReposValidationMessages> gitReposValidationResult = null)
        {
            ...
            return new AppPlatformConfigurationServiceGitValidateResult(isValid, gitReposValidationResult?.ToList(), default);
        }
        ...
        public static AppPlatformConfigurationServiceGitReposValidationMessages AppPlatformConfigurationServiceGitReposValidationMessages(string name = null, IEnumerable<string> messages = null)
        {
            ...
            return new AppPlatformConfigurationServiceGitReposValidationMessages(name, messages?.ToList(), default);
        }
        ...
        {
            return new AppPlatformServiceRegistryData(id, name, resourceType, systemData, properties, default);
        }
        ...
        public static AppPlatformServiceRegistryProperties AppPlatformServiceRegistryProperties(AppPlatformServiceRegistryProvisioningState? provisioningState = null, AppPlatformServiceRegistryResourceRequirements resourceRequests = null, IEnumerable<AppPlatformServiceRegistryInstance> instances = null)
        {
            ...
            return new AppPlatformServiceRegistryProperties(provisioningState, resourceRequests, instances?.ToList(), default);
        }
        ...
        {
            return new AppPlatformServiceRegistryResourceRequirements(cpu, memory, instanceCount, default);
        }
        ...
        {
            return new AppPlatformServiceRegistryInstance(name, status, default);
        }
        ...
        {
            return new AppPlatformBuildServiceData(id, name, resourceType, systemData, properties, default);
        }
        ...
        {
            return new AppPlatformBuildServiceProperties(kPackVersion, provisioningState, resourceRequests, default);
        }
        ...
        {
            return new AppPlatformBuildServiceResourceRequirements(cpu, memory, default);
        }
        ...
        {
            return new AppPlatformBuildData(id, name, resourceType, systemData, properties, default);
        }
        ...
        public static AppPlatformBuildProperties AppPlatformBuildProperties(string relativePath = null, string builder = null, string agentPool = null, AppPlatformBuildProvisioningState? provisioningState = null, IDictionary<string, string> env = null, ResourceIdentifier triggeredBuildResultId = null, AppPlatformBuildResourceRequirements resourceRequests = null)
        {
            ...
            return new AppPlatformBuildProperties(relativePath, builder, agentPool, provisioningState, env, triggeredBuildResultId != null ? ResourceManagerModelFactory.SubResource(triggeredBuildResultId) : null, resourceRequests, default);
        }
        ...
        {
            return new AppPlatformBuildpackBindingData(id, name, resourceType, systemData, properties, default);
        }
        ...
        {
            return new AppPlatformBuildpackBindingProperties(bindingType, provisioningState, launchProperties, default);
        }
        ...
        {
            return new AppPlatformBuildResultData(id, name, resourceType, systemData, properties, default);
        }
        ...
        public static AppPlatformBuildResultProperties AppPlatformBuildResultProperties(string name = null, AppPlatformBuildResultProvisioningState? provisioningState = null, string buildPodName = null, IEnumerable<AppPlatformBuildStageProperties> buildStages = null)
        {
            ...
            return new AppPlatformBuildResultProperties(name, provisioningState, buildPodName, buildStages?.ToList(), default);
        }
        ...
        {
            return new AppPlatformBuildStageProperties(name, status, default);
        }
        ...
        {
            return new AppPlatformBuildResultLog(blobUri, default);
        }
        ...
        {
            return new AppPlatformBuilderData(id, name, resourceType, systemData, properties, default);
        }
        ...
        public static AppPlatformBuilderProperties AppPlatformBuilderProperties(AppPlatformBuilderProvisioningState? provisioningState = null, AppPlatformClusterStackProperties stack = null, IEnumerable<BuildpacksGroupProperties> buildpackGroups = null)
        {
            ...
            return new AppPlatformBuilderProperties(provisioningState, stack, buildpackGroups?.ToList(), default);
        }
        ...
        {
            return new AppPlatformResourceUploadResult(relativePath, uploadUri, default);
        }
        ...
        {
            return new AppPlatformSupportedBuildpackData(id, name, resourceType, systemData, supportedBuildpackId != null ? new SupportedBuildpackResourceProperties(supportedBuildpackId, new Dictionary<string, BinaryData>()) : null, default);
        }
        ...
        {
            return new AppPlatformSupportedStackData(id, name, resourceType, systemData, properties, default);
        }
        ...
        {
            return new AppPlatformBuildServiceAgentPoolData(id, name, resourceType, systemData, properties, default);
        }
        ...
        {
            return new AppPlatformBuildServiceAgentPoolProperties(provisioningState, poolSize, default);
        }
        ...
        {
            return new BuildServiceAgentPoolSizeProperties(name, cpu, memory, default);
        }
        ...
        {
            return new AppPlatformMonitoringSettingData(id, name, resourceType, systemData, properties, default);
        }
        ...
        {
            return new AppPlatformMonitoringSettingProperties(provisioningState, error, isTraceEnabled, appInsightsInstrumentationKey, appInsightsSamplingRate, appInsightsJavaAgentVersion != null ? new ApplicationInsightsAgentVersions(appInsightsJavaAgentVersion, new Dictionary<string, BinaryData>()) : null, default);
        }
        ...
        {
            return new AppPlatformAppData(id, name, resourceType, systemData, properties, identity, location, default);
        }
        ...
        public static AppPlatformAppProperties AppPlatformAppProperties(bool? isPublic = null, string uriString = null, IDictionary<string, IDictionary<string, BinaryData>> addonConfigs = null, AppPlatformAppProvisioningState? provisioningState = null, string fqdn = null, bool? isHttpsOnly = null, AppTemporaryDisk temporaryDisk = null, AppPersistentDisk persistentDisk = null, IEnumerable<AppCustomPersistentDisk> customPersistentDisks = null, bool? isEndToEndTlsEnabled = null, IEnumerable<AppLoadedCertificate> loadedCertificates = null, AppVnetAddons vnetAddons = null, AppIngressSettings ingressSettings = null)
        {
            ...
            return new AppPlatformAppProperties(isPublic, uriString, addonConfigs, provisioningState, fqdn, isHttpsOnly, temporaryDisk, persistentDisk, customPersistentDisks?.ToList(), isEndToEndTlsEnabled, loadedCertificates?.ToList(), vnetAddons, ingressSettings, default);
        }
        ...
        {
            return new AppPersistentDisk(sizeInGB, usedInGB, mountPath, default);
        }
        ...
        {
            return new AppVnetAddons(isPublicEndpoint, publicEndpointUri, default);
        }
        ...
        {
            return new AppPlatformBindingData(id, name, resourceType, systemData, properties, default);
        }
        ...
        public static AppPlatformBindingProperties AppPlatformBindingProperties(string resourceName = null, string resourceType = null, ResourceIdentifier resourceId = null, string key = null, IDictionary<string, BinaryData> bindingParameters = null, string generatedProperties = null, DateTimeOffset? createdOn = null, DateTimeOffset? updatedOn = null)
        {
            ...
            return new AppPlatformBindingProperties(resourceName, resourceType, resourceId, key, bindingParameters, generatedProperties, createdOn, updatedOn, default);
        }

        /// <summary> Initializes a new instance of <see cref="AppPlatformStorageData"/>. </summary>
        /// <param name="id"> The id. </param>
        /// <param name="name"> The name. </param>
        /// <param name="resourceType"> The resourceType. </param>
        /// <param name="systemData"> The systemData. </param>
        ...
        {
            return new AppPlatformStorageData(id, name, resourceType, systemData, properties, default);
        }
        ...
        {
            return new AppPlatformCertificateData(id, name, resourceType, systemData, properties, default);
        }
        ...
        public static AppPlatformCertificateProperties AppPlatformCertificateProperties(string certificatePropertiesType = null, string thumbprint = null, string issuer = null, DateTimeOffset? issuedOn = null, DateTimeOffset? expireOn = null, DateTimeOffset? activateOn = null, string subjectName = null, IEnumerable<string> dnsNames = null, AppPlatformCertificateProvisioningState? provisioningState = null)
        {
            ...
            return new UnknownCertificateProperties(certificatePropertiesType, thumbprint, issuer, issuedOn, expireOn, activateOn, subjectName, dnsNames?.ToList(), provisioningState, default);
        }
        ...
        {
            return new AppPlatformNameAvailabilityResult(isNameAvailable, reason, message, default);
        }
        ...
        {
            return new AppPlatformCustomDomainData(id, name, resourceType, systemData, properties, default);
        }
        ...
        {
            return new AppPlatformCustomDomainProperties(thumbprint, appName, certName, provisioningState, default);
        }
        ...
        {
            return new AppPlatformCustomDomainValidateResult(isValid, message, default);
        }
        ...
        {
            return new AppPlatformDeploymentData(id, name, resourceType, systemData, properties, sku, default);
        }
        ...
        public static AppPlatformDeploymentProperties AppPlatformDeploymentProperties(AppPlatformUserSourceInfo source = null, AppPlatformDeploymentSettings deploymentSettings = null, AppPlatformDeploymentProvisioningState? provisioningState = null, AppPlatformDeploymentStatus? status = null, bool? isActive = null, IEnumerable<AppPlatformDeploymentInstance> instances = null)
        {
            ...
            return new AppPlatformDeploymentProperties(source, deploymentSettings, provisioningState, status, isActive, instances?.ToList(), default);
        }
        ...
        {
            return new AppPlatformDeploymentInstance(name, status, reason, discoveryStatus, startedOn, zone, default);
        }
        ...
        {
            return new ApplicationRemoteDebuggingConfig(port, isEnabled, default);
        }
        ...
        {
            return new AppPlatformLogFileUriResult(uri, default);
        }
        ...
        {
            return new AppPlatformSupportedRuntimeVersion(value, platform, version, default);
        }
        ...
        public static AvailableAppPlatformSku AvailableAppPlatformSku(ResourceType? resourceType = null, string name = null, string tier = null, AppPlatformSkuCapacity capacity = null, IEnumerable<AzureLocation> locations = null, IEnumerable<AppPlatformSkuLocationInfo> locationInfo = null, IEnumerable<AppPlatformSkuRestrictions> restrictions = null)
        {
            ...
            return new AvailableAppPlatformSku(resourceType, name, tier, capacity, locations?.ToList(), locationInfo?.ToList(), restrictions?.ToList(), default);
        }
        ...
        {
            return new AppPlatformSkuCapacity(minimum, maximum, @default, scaleType, default);
        }
        ...
        public static AppPlatformSkuLocationInfo AppPlatformSkuLocationInfo(AzureLocation? location = null, IEnumerable<string> zones = null, IEnumerable<AppPlatformSkuZoneDetails> zoneDetails = null)
        {
            ...
            return new AppPlatformSkuLocationInfo(location, zones?.ToList(), zoneDetails?.ToList(), default);
        }
        ...
        public static AppPlatformSkuZoneDetails AppPlatformSkuZoneDetails(IEnumerable<string> name = null, IEnumerable<AppPlatformSkuCapabilities> capabilities = null)
        {
            ...
            return new AppPlatformSkuZoneDetails(name?.ToList(), capabilities?.ToList(), default);
        }
        ...
        {
            return new AppPlatformSkuCapabilities(name, value, default);
        }
        ...
        public static AppPlatformSkuRestrictions AppPlatformSkuRestrictions(AppPlatformSkuRestrictionsType? restrictionsType = null, IEnumerable<string> values = null, AppPlatformSkuRestrictionInfo restrictionInfo = null, AppPlatformSkuRestrictionsReasonCode? reasonCode = null)
        {
            ...
            return new AppPlatformSkuRestrictions(restrictionsType, values?.ToList(), restrictionInfo, reasonCode, default);
        }
        ...
        public static AppPlatformSkuRestrictionInfo AppPlatformSkuRestrictionInfo(IEnumerable<AzureLocation> locations = null, IEnumerable<string> zones = null)
        {
            ...
            return new AppPlatformSkuRestrictionInfo(locations?.ToList(), zones?.ToList(), default);
        }
        ...
        {
            return new AppPlatformGatewayData(id, name, resourceType, systemData, properties, sku, default);
        }
        ...
        public static AppPlatformGatewayProperties AppPlatformGatewayProperties(AppPlatformGatewayProvisioningState? provisioningState = null, bool? isPublic = null, Uri uri = null, bool? isHttpsOnly = null, AppPlatformSsoProperties ssoProperties = null, AppPlatformGatewayApiMetadataProperties apiMetadataProperties = null, AppPlatformGatewayCorsProperties corsProperties = null, AppPlatformGatewayResourceRequirements resourceRequests = null, IEnumerable<AppPlatformGatewayInstance> instances = null, AppPlatformGatewayOperatorProperties operatorProperties = null)
        {
            ...
            return new AppPlatformGatewayProperties(provisioningState, isPublic, uri, isHttpsOnly, ssoProperties, apiMetadataProperties, corsProperties, resourceRequests, instances?.ToList(), operatorProperties, default);
        }
        ...
        {
            return new AppPlatformGatewayInstance(name, status, default);
        }
        ...
        public static AppPlatformGatewayOperatorProperties AppPlatformGatewayOperatorProperties(AppPlatformGatewayOperatorResourceRequirements resourceRequests = null, IEnumerable<AppPlatformGatewayInstance> instances = null)
        {
            ...
            return new AppPlatformGatewayOperatorProperties(resourceRequests, instances?.ToList(), default);
        }
        ...
        {
            return new AppPlatformGatewayOperatorResourceRequirements(cpu, memory, instanceCount, default);
        }
        ...
        {
            return new AppPlatformGatewayRouteConfigData(id, name, resourceType, systemData, properties, default);
        }
        ...
        public static AppPlatformGatewayRouteConfigProperties AppPlatformGatewayRouteConfigProperties(AppPlatformGatewayProvisioningState? provisioningState = null, ResourceIdentifier appResourceId = null, Uri openApiUri = null, AppPlatformGatewayRouteConfigProtocol? protocol = null, IEnumerable<AppPlatformGatewayApiRoute> routes = null)
        {
            ...
            return new AppPlatformGatewayRouteConfigProperties(provisioningState, appResourceId, openApiUri != null ? new GatewayRouteConfigOpenApiProperties(openApiUri, new Dictionary<string, BinaryData>()) : null, protocol, routes?.ToList(), default);
        }
        ...
        {
            return new AppPlatformGatewayCustomDomainData(id, name, resourceType, systemData, gatewayCustomDomainThumbprint != null ? new GatewayCustomDomainProperties(gatewayCustomDomainThumbprint, new Dictionary<string, BinaryData>()) : null, default);
        }
        ...
        {
            return new AppPlatformApiPortalData(id, name, resourceType, systemData, properties, sku, default);
        }
        ...
        public static AppPlatformApiPortalProperties AppPlatformApiPortalProperties(AppPlatformApiPortalProvisioningState? provisioningState = null, bool? isPublic = null, Uri uri = null, bool? isHttpsOnly = null, IEnumerable<ResourceIdentifier> gatewayIds = null, IEnumerable<Uri> sourceUris = null, AppPlatformSsoProperties ssoProperties = null, AppPlatformApiPortalResourceRequirements resourceRequests = null, IEnumerable<AppPlatformApiPortalInstance> instances = null)
        {
            ...
            return new AppPlatformApiPortalProperties(provisioningState, isPublic, uri, isHttpsOnly, gatewayIds?.ToList(), sourceUris?.ToList(), ssoProperties, resourceRequests, instances?.ToList(), default);
        }
        ...
        {
            return new AppPlatformApiPortalResourceRequirements(cpu, memory, default);
        }
        ...
        {
            return new AppPlatformApiPortalInstance(name, status, default);
        }
        ...
        {
            return new AppPlatformApiPortalCustomDomainData(id, name, resourceType, systemData, apiPortalCustomDomainThumbprint != null ? new ApiPortalCustomDomainProperties(apiPortalCustomDomainThumbprint, new Dictionary<string, BinaryData>()) : null, default);
        }
        ...
        public static AppPlatformKeyVaultCertificateProperties AppPlatformKeyVaultCertificateProperties(string thumbprint = null, string issuer = null, DateTimeOffset? issuedOn = null, DateTimeOffset? expireOn = null, DateTimeOffset? activateOn = null, string subjectName = null, IEnumerable<string> dnsNames = null, AppPlatformCertificateProvisioningState? provisioningState = null, Uri vaultUri = null, string keyVaultCertName = null, string certVersion = null, bool? isPrivateKeyExcluded = null)
        {
            ...
            return new AppPlatformKeyVaultCertificateProperties("KeyVaultCertificate", thumbprint, issuer, issuedOn, expireOn, activateOn, subjectName, dnsNames?.ToList(), provisioningState, vaultUri, keyVaultCertName, certVersion, isPrivateKeyExcluded, default);
        }

        /// <summary> Initializes a new instance of <see cref="AppPlatformContentCertificateProperties"/>. </summary>
        /// <param name="thumbprint"> The thumbprint of certificate. </param>
        /// <param name="issuer"> The issuer of certificate. </param>
        /// <param name="issuedOn"> The issue date of certificate. </param>
        /// <param name="expireOn"> The expiration date of certificate. </param>
        ...
        public static AppPlatformContentCertificateProperties AppPlatformContentCertificateProperties(string thumbprint = null, string issuer = null, DateTimeOffset? issuedOn = null, DateTimeOffset? expireOn = null, DateTimeOffset? activateOn = null, string subjectName = null, IEnumerable<string> dnsNames = null, AppPlatformCertificateProvisioningState? provisioningState = null, string content = null)
        {
            ...
            return new AppPlatformContentCertificateProperties("ContentCertificate", thumbprint, issuer, issuedOn, expireOn, activateOn, subjectName, dnsNames?.ToList(), provisioningState, content, default);
        }
    }
}
