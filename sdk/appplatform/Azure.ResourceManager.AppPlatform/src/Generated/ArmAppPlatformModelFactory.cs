...
namespace Azure.ResourceManager.AppPlatform.Models
{
    ...
    public static partial class ArmAppPlatformModelFactory
    {
        ...
        public static AppPlatformServiceData AppPlatformServiceData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, AppPlatformServiceProperties properties = null, AppPlatformSku sku = null)
        {
            ...
            return new AppPlatformServiceData(id, name, resourceType, systemData, tags, location, properties, sku, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AppPlatformServiceProperties(provisioningState, networkProfile, isLogStreamPublicEndpoint != null ? new ServiceVnetAddons(isLogStreamPublicEndpoint, new Dictionary<string, BinaryData>()) : null, version, serviceInstanceId, powerState, isZoneRedundant, fqdn, new Dictionary<string, BinaryData>());
        }
        ...
        public static AppPlatformServiceNetworkProfile AppPlatformServiceNetworkProfile(ResourceIdentifier serviceRuntimeSubnetId = null, ResourceIdentifier appSubnetId = null, string serviceCidr = null, string serviceRuntimeNetworkResourceGroup = null, string appNetworkResourceGroup = null, IEnumerable<IPAddress> outboundPublicIPs = null, IEnumerable<AppPlatformServiceRequiredTraffic> requiredTraffics = null, int? ingressConfigReadTimeoutInSeconds = null, string outboundType = null)
        {
            ...
            return new AppPlatformServiceNetworkProfile(serviceRuntimeSubnetId, appSubnetId, serviceCidr, serviceRuntimeNetworkResourceGroup, appNetworkResourceGroup, outboundPublicIPs != null ? new NetworkProfileOutboundIPs(outboundPublicIPs?.ToList(), new Dictionary<string, BinaryData>()) : null, requiredTraffics?.ToList(), ingressConfigReadTimeoutInSeconds != null ? new IngressConfig(ingressConfigReadTimeoutInSeconds, new Dictionary<string, BinaryData>()) : null, outboundType, new Dictionary<string, BinaryData>());
        }
        ...
        public static AppPlatformServiceRequiredTraffic AppPlatformServiceRequiredTraffic(string protocol = null, int? port = null, IEnumerable<IPAddress> ips = null, IEnumerable<string> fqdns = null, AppPlatformServiceTrafficDirection? direction = null)
        {
            ...
            return new AppPlatformServiceRequiredTraffic(protocol, port, ips?.ToList(), fqdns?.ToList(), direction, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AppPlatformServiceTestKeys(primaryKey, secondaryKey, primaryTestEndpoint, secondaryTestEndpoint, isEnabled, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AppPlatformConfigServerData(id, name, resourceType, systemData, properties, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AppPlatformConfigServerProperties(provisioningState, error, configServerGitProperty != null ? new ConfigServerSettings(configServerGitProperty, new Dictionary<string, BinaryData>()) : null, new Dictionary<string, BinaryData>());
        }
        ...
        public static ConfigServerSettingsValidateResult ConfigServerSettingsValidateResult(bool? isValid = null, IEnumerable<ConfigServerSettingsErrorRecord> details = null)
        {
            ...
            return new ConfigServerSettingsValidateResult(isValid, details?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static ConfigServerSettingsErrorRecord ConfigServerSettingsErrorRecord(string name = null, Uri uri = null, IEnumerable<string> messages = null)
        {
            ...
            return new ConfigServerSettingsErrorRecord(name, uri, messages?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AppPlatformConfigurationServiceData(id, name, resourceType, systemData, properties, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AppPlatformConfigurationServiceRequirements(cpu, memory, instanceCount, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AppPlatformConfigurationServiceInstance(name, status, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AppPlatformConfigurationServiceSettingsValidateResult(gitPropertyValidationResult, new Dictionary<string, BinaryData>());
        }
        ...
        public static AppPlatformConfigurationServiceGitValidateResult AppPlatformConfigurationServiceGitValidateResult(bool? isValid = null, IEnumerable<AppPlatformConfigurationServiceGitReposValidationMessages> gitReposValidationResult = null)
        {
            ...
            return new AppPlatformConfigurationServiceGitValidateResult(isValid, gitReposValidationResult?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static AppPlatformConfigurationServiceGitReposValidationMessages AppPlatformConfigurationServiceGitReposValidationMessages(string name = null, IEnumerable<string> messages = null)
        {
            ...
            return new AppPlatformConfigurationServiceGitReposValidationMessages(name, messages?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AppPlatformServiceRegistryData(id, name, resourceType, systemData, properties, new Dictionary<string, BinaryData>());
        }
        ...
        public static AppPlatformServiceRegistryProperties AppPlatformServiceRegistryProperties(AppPlatformServiceRegistryProvisioningState? provisioningState = null, AppPlatformServiceRegistryResourceRequirements resourceRequests = null, IEnumerable<AppPlatformServiceRegistryInstance> instances = null)
        {
            ...
            return new AppPlatformServiceRegistryProperties(provisioningState, resourceRequests, instances?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AppPlatformServiceRegistryResourceRequirements(cpu, memory, instanceCount, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AppPlatformServiceRegistryInstance(name, status, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AppPlatformBuildServiceData(id, name, resourceType, systemData, properties, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AppPlatformBuildServiceProperties(kPackVersion, provisioningState, resourceRequests, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AppPlatformBuildServiceResourceRequirements(cpu, memory, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AppPlatformBuildData(id, name, resourceType, systemData, properties, new Dictionary<string, BinaryData>());
        }
        ...
        public static AppPlatformBuildProperties AppPlatformBuildProperties(string relativePath = null, string builder = null, string agentPool = null, AppPlatformBuildProvisioningState? provisioningState = null, IDictionary<string, string> env = null, ResourceIdentifier triggeredBuildResultId = null, AppPlatformBuildResourceRequirements resourceRequests = null)
        {
            ...
            return new AppPlatformBuildProperties(relativePath, builder, agentPool, provisioningState, env, triggeredBuildResultId != null ? ResourceManagerModelFactory.SubResource(triggeredBuildResultId) : null, resourceRequests, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AppPlatformBuildpackBindingData(id, name, resourceType, systemData, properties, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AppPlatformBuildpackBindingProperties(bindingType, provisioningState, launchProperties, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AppPlatformBuildResultData(id, name, resourceType, systemData, properties, new Dictionary<string, BinaryData>());
        }
        ...
        public static AppPlatformBuildResultProperties AppPlatformBuildResultProperties(string name = null, AppPlatformBuildResultProvisioningState? provisioningState = null, string buildPodName = null, IEnumerable<AppPlatformBuildStageProperties> buildStages = null)
        {
            ...
            return new AppPlatformBuildResultProperties(name, provisioningState, buildPodName, buildStages?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AppPlatformBuildStageProperties(name, status, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AppPlatformBuildResultLog(blobUri, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AppPlatformBuilderData(id, name, resourceType, systemData, properties, new Dictionary<string, BinaryData>());
        }
        ...
        public static AppPlatformBuilderProperties AppPlatformBuilderProperties(AppPlatformBuilderProvisioningState? provisioningState = null, AppPlatformClusterStackProperties stack = null, IEnumerable<BuildpacksGroupProperties> buildpackGroups = null)
        {
            ...
            return new AppPlatformBuilderProperties(provisioningState, stack, buildpackGroups?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AppPlatformResourceUploadResult(relativePath, uploadUri, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AppPlatformSupportedBuildpackData(id, name, resourceType, systemData, supportedBuildpackId != null ? new SupportedBuildpackResourceProperties(supportedBuildpackId, new Dictionary<string, BinaryData>()) : null, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AppPlatformSupportedStackData(id, name, resourceType, systemData, properties, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AppPlatformBuildServiceAgentPoolData(id, name, resourceType, systemData, properties, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AppPlatformBuildServiceAgentPoolProperties(provisioningState, poolSize, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new BuildServiceAgentPoolSizeProperties(name, cpu, memory, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AppPlatformMonitoringSettingData(id, name, resourceType, systemData, properties, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AppPlatformMonitoringSettingProperties(provisioningState, error, isTraceEnabled, appInsightsInstrumentationKey, appInsightsSamplingRate, appInsightsJavaAgentVersion != null ? new ApplicationInsightsAgentVersions(appInsightsJavaAgentVersion, new Dictionary<string, BinaryData>()) : null, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AppPlatformAppData(id, name, resourceType, systemData, properties, identity, location, new Dictionary<string, BinaryData>());
        }
        ...
        public static AppPlatformAppProperties AppPlatformAppProperties(bool? isPublic = null, string uriString = null, IDictionary<string, IDictionary<string, BinaryData>> addonConfigs = null, AppPlatformAppProvisioningState? provisioningState = null, string fqdn = null, bool? isHttpsOnly = null, AppTemporaryDisk temporaryDisk = null, AppPersistentDisk persistentDisk = null, IEnumerable<AppCustomPersistentDisk> customPersistentDisks = null, bool? isEndToEndTlsEnabled = null, IEnumerable<AppLoadedCertificate> loadedCertificates = null, AppVnetAddons vnetAddons = null, AppIngressSettings ingressSettings = null)
        {
            ...
            return new AppPlatformAppProperties(isPublic, uriString, addonConfigs, provisioningState, fqdn, isHttpsOnly, temporaryDisk, persistentDisk, customPersistentDisks?.ToList(), isEndToEndTlsEnabled, loadedCertificates?.ToList(), vnetAddons, ingressSettings, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AppPersistentDisk(sizeInGB, usedInGB, mountPath, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AppVnetAddons(isPublicEndpoint, publicEndpointUri, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AppPlatformBindingData(id, name, resourceType, systemData, properties, new Dictionary<string, BinaryData>());
        }
        ...
        public static AppPlatformBindingProperties AppPlatformBindingProperties(string resourceName = null, string resourceType = null, ResourceIdentifier resourceId = null, string key = null, IDictionary<string, BinaryData> bindingParameters = null, string generatedProperties = null, DateTimeOffset? createdOn = null, DateTimeOffset? updatedOn = null)
        {
            ...
            return new AppPlatformBindingProperties(resourceName, resourceType, resourceId, key, bindingParameters, generatedProperties, createdOn, updatedOn, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AppPlatformStorageData(id, name, resourceType, systemData, properties, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AppPlatformCertificateData(id, name, resourceType, systemData, properties, new Dictionary<string, BinaryData>());
        }
        ...
        public static AppPlatformCertificateProperties AppPlatformCertificateProperties(string certificatePropertiesType = null, string thumbprint = null, string issuer = null, DateTimeOffset? issuedOn = null, DateTimeOffset? expireOn = null, DateTimeOffset? activateOn = null, string subjectName = null, IEnumerable<string> dnsNames = null, AppPlatformCertificateProvisioningState? provisioningState = null)
        {
            ...
            return new UnknownCertificateProperties(certificatePropertiesType, thumbprint, issuer, issuedOn, expireOn, activateOn, subjectName, dnsNames?.ToList(), provisioningState, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AppPlatformNameAvailabilityResult(isNameAvailable, reason, message, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AppPlatformCustomDomainData(id, name, resourceType, systemData, properties, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AppPlatformCustomDomainProperties(thumbprint, appName, certName, provisioningState, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AppPlatformCustomDomainValidateResult(isValid, message, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AppPlatformDeploymentData(id, name, resourceType, systemData, properties, sku, new Dictionary<string, BinaryData>());
        }
        ...
        public static AppPlatformDeploymentProperties AppPlatformDeploymentProperties(AppPlatformUserSourceInfo source = null, AppPlatformDeploymentSettings deploymentSettings = null, AppPlatformDeploymentProvisioningState? provisioningState = null, AppPlatformDeploymentStatus? status = null, bool? isActive = null, IEnumerable<AppPlatformDeploymentInstance> instances = null)
        {
            ...
            return new AppPlatformDeploymentProperties(source, deploymentSettings, provisioningState, status, isActive, instances?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AppPlatformDeploymentInstance(name, status, reason, discoveryStatus, startedOn, zone, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ApplicationRemoteDebuggingConfig(port, isEnabled, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AppPlatformLogFileUriResult(uri, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AppPlatformSupportedRuntimeVersion(value, platform, version, new Dictionary<string, BinaryData>());
        }
        ...
        public static AvailableAppPlatformSku AvailableAppPlatformSku(ResourceType? resourceType = null, string name = null, string tier = null, AppPlatformSkuCapacity capacity = null, IEnumerable<AzureLocation> locations = null, IEnumerable<AppPlatformSkuLocationInfo> locationInfo = null, IEnumerable<AppPlatformSkuRestrictions> restrictions = null)
        {
            ...
            return new AvailableAppPlatformSku(resourceType, name, tier, capacity, locations?.ToList(), locationInfo?.ToList(), restrictions?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AppPlatformSkuCapacity(minimum, maximum, @default, scaleType, new Dictionary<string, BinaryData>());
        }
        ...
        public static AppPlatformSkuLocationInfo AppPlatformSkuLocationInfo(AzureLocation? location = null, IEnumerable<string> zones = null, IEnumerable<AppPlatformSkuZoneDetails> zoneDetails = null)
        {
            ...
            return new AppPlatformSkuLocationInfo(location, zones?.ToList(), zoneDetails?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static AppPlatformSkuZoneDetails AppPlatformSkuZoneDetails(IEnumerable<string> name = null, IEnumerable<AppPlatformSkuCapabilities> capabilities = null)
        {
            ...
            return new AppPlatformSkuZoneDetails(name?.ToList(), capabilities?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AppPlatformSkuCapabilities(name, value, new Dictionary<string, BinaryData>());
        }
        ...
        public static AppPlatformSkuRestrictions AppPlatformSkuRestrictions(AppPlatformSkuRestrictionsType? restrictionsType = null, IEnumerable<string> values = null, AppPlatformSkuRestrictionInfo restrictionInfo = null, AppPlatformSkuRestrictionsReasonCode? reasonCode = null)
        {
            ...
            return new AppPlatformSkuRestrictions(restrictionsType, values?.ToList(), restrictionInfo, reasonCode, new Dictionary<string, BinaryData>());
        }
        ...
        public static AppPlatformSkuRestrictionInfo AppPlatformSkuRestrictionInfo(IEnumerable<AzureLocation> locations = null, IEnumerable<string> zones = null)
        {
            ...
            return new AppPlatformSkuRestrictionInfo(locations?.ToList(), zones?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AppPlatformGatewayData(id, name, resourceType, systemData, properties, sku, new Dictionary<string, BinaryData>());
        }
        ...
        public static AppPlatformGatewayProperties AppPlatformGatewayProperties(AppPlatformGatewayProvisioningState? provisioningState = null, bool? isPublic = null, Uri uri = null, bool? isHttpsOnly = null, AppPlatformSsoProperties ssoProperties = null, AppPlatformGatewayApiMetadataProperties apiMetadataProperties = null, AppPlatformGatewayCorsProperties corsProperties = null, AppPlatformGatewayResourceRequirements resourceRequests = null, IEnumerable<AppPlatformGatewayInstance> instances = null, AppPlatformGatewayOperatorProperties operatorProperties = null)
        {
            ...
            return new AppPlatformGatewayProperties(provisioningState, isPublic, uri, isHttpsOnly, ssoProperties, apiMetadataProperties, corsProperties, resourceRequests, instances?.ToList(), operatorProperties, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AppPlatformGatewayInstance(name, status, new Dictionary<string, BinaryData>());
        }
        ...
        public static AppPlatformGatewayOperatorProperties AppPlatformGatewayOperatorProperties(AppPlatformGatewayOperatorResourceRequirements resourceRequests = null, IEnumerable<AppPlatformGatewayInstance> instances = null)
        {
            ...
            return new AppPlatformGatewayOperatorProperties(resourceRequests, instances?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AppPlatformGatewayOperatorResourceRequirements(cpu, memory, instanceCount, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AppPlatformGatewayRouteConfigData(id, name, resourceType, systemData, properties, new Dictionary<string, BinaryData>());
        }
        ...
        public static AppPlatformGatewayRouteConfigProperties AppPlatformGatewayRouteConfigProperties(AppPlatformGatewayProvisioningState? provisioningState = null, ResourceIdentifier appResourceId = null, Uri openApiUri = null, AppPlatformGatewayRouteConfigProtocol? protocol = null, IEnumerable<AppPlatformGatewayApiRoute> routes = null)
        {
            ...
            return new AppPlatformGatewayRouteConfigProperties(provisioningState, appResourceId, openApiUri != null ? new GatewayRouteConfigOpenApiProperties(openApiUri, new Dictionary<string, BinaryData>()) : null, protocol, routes?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AppPlatformGatewayCustomDomainData(id, name, resourceType, systemData, gatewayCustomDomainThumbprint != null ? new GatewayCustomDomainProperties(gatewayCustomDomainThumbprint, new Dictionary<string, BinaryData>()) : null, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AppPlatformApiPortalData(id, name, resourceType, systemData, properties, sku, new Dictionary<string, BinaryData>());
        }
        ...
        public static AppPlatformApiPortalProperties AppPlatformApiPortalProperties(AppPlatformApiPortalProvisioningState? provisioningState = null, bool? isPublic = null, Uri uri = null, bool? isHttpsOnly = null, IEnumerable<ResourceIdentifier> gatewayIds = null, IEnumerable<Uri> sourceUris = null, AppPlatformSsoProperties ssoProperties = null, AppPlatformApiPortalResourceRequirements resourceRequests = null, IEnumerable<AppPlatformApiPortalInstance> instances = null)
        {
            ...
            return new AppPlatformApiPortalProperties(provisioningState, isPublic, uri, isHttpsOnly, gatewayIds?.ToList(), sourceUris?.ToList(), ssoProperties, resourceRequests, instances?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AppPlatformApiPortalResourceRequirements(cpu, memory, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AppPlatformApiPortalInstance(name, status, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AppPlatformApiPortalCustomDomainData(id, name, resourceType, systemData, apiPortalCustomDomainThumbprint != null ? new ApiPortalCustomDomainProperties(apiPortalCustomDomainThumbprint, new Dictionary<string, BinaryData>()) : null, new Dictionary<string, BinaryData>());
        }
        ...
        public static AppPlatformKeyVaultCertificateProperties AppPlatformKeyVaultCertificateProperties(string thumbprint = null, string issuer = null, DateTimeOffset? issuedOn = null, DateTimeOffset? expireOn = null, DateTimeOffset? activateOn = null, string subjectName = null, IEnumerable<string> dnsNames = null, AppPlatformCertificateProvisioningState? provisioningState = null, Uri vaultUri = null, string keyVaultCertName = null, string certVersion = null, bool? isPrivateKeyExcluded = null)
        {
            ...
            return new AppPlatformKeyVaultCertificateProperties("KeyVaultCertificate", thumbprint, issuer, issuedOn, expireOn, activateOn, subjectName, dnsNames?.ToList(), provisioningState, new Dictionary<string, BinaryData>(), vaultUri, keyVaultCertName, certVersion, isPrivateKeyExcluded);
        }
        ...
        public static AppPlatformContentCertificateProperties AppPlatformContentCertificateProperties(string thumbprint = null, string issuer = null, DateTimeOffset? issuedOn = null, DateTimeOffset? expireOn = null, DateTimeOffset? activateOn = null, string subjectName = null, IEnumerable<string> dnsNames = null, AppPlatformCertificateProvisioningState? provisioningState = null, string content = null)
        {
            ...
            return new AppPlatformContentCertificateProperties("ContentCertificate", thumbprint, issuer, issuedOn, expireOn, activateOn, subjectName, dnsNames?.ToList(), provisioningState, new Dictionary<string, BinaryData>(), content);
        }
    }
}
