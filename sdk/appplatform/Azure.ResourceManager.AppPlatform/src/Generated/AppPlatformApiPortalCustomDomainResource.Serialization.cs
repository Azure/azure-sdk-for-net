...
namespace Azure.ResourceManager.AppPlatform
{
    public partial class AppPlatformApiPortalCustomDomainResource : IJsonModel<AppPlatformApiPortalCustomDomainData>
    {
        ...
        {
            return ModelReaderWriter.Read<AppPlatformApiPortalCustomDomainData>(new BinaryData(reader.ValueSequence), options);
        }
        ...
        {
            return ModelReaderWriter.Read<AppPlatformApiPortalCustomDomainData>(data, options);
        }
