...
namespace Azure.ResourceManager.AppPlatform
{
    ...
    public partial class AppPlatformCertificateResource : ArmResource
    {
        ...
        internal AppPlatformCertificateResource(ArmClient client, AppPlatformCertificateData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<AppPlatformCertificateResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new AppPlatformCertificateResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
