...
namespace Azure.ResourceManager.AppPlatform.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AppIngressSettings>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AppIngressSettings>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AppIngressSettings>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AppIngressSettings>)} interface");
            }
        ...
        string IPersistableModel<AppIngressSettings>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
