...
namespace Azure.ResourceManager.AppPlatform.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AppPlatformConfigurationServiceGitReposValidationMessages>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<AppPlatformConfigurationServiceGitReposValidationMessages>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AppPlatformConfigurationServiceGitReposValidationMessages>)} interface");
            }
        ...
        string IPersistableModel<AppPlatformConfigurationServiceGitReposValidationMessages>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
