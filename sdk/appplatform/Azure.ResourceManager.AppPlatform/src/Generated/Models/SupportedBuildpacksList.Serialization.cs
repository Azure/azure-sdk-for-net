...
namespace Azure.ResourceManager.AppPlatform.Models
{
    internal partial class SupportedBuildpacksList
    {
        internal static SupportedBuildpacksList DeserializeSupportedBuildpacksList(JsonElement element)
        {
            ...
            Core.Optional<IReadOnlyList<AppPlatformSupportedBuildpackData>> value = default;
            ...
            return new SupportedBuildpacksList(Core.Optional.ToList(value), nextLink.Value);
        }
    }
}
