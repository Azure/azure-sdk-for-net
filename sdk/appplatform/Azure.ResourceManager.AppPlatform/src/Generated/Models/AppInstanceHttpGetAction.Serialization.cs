...
namespace Azure.ResourceManager.AppPlatform.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AppInstanceHttpGetAction>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AppInstanceHttpGetAction>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AppInstanceHttpGetAction>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AppInstanceHttpGetAction>)} interface");
            }
        ...
        string IPersistableModel<AppInstanceHttpGetAction>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
