...
namespace Azure.ResourceManager.AppPlatform.Models
{
    ...
    public partial class AppPlatformDeploymentInstance
    {
        ...
        internal AppPlatformDeploymentInstance(string name, string status, string reason, string discoveryStatus, DateTimeOffset? startedOn, string zone, Dictionary<string, BinaryData> rawData)
        {
            Name = name;
            Status = status;
            Reason = reason;
