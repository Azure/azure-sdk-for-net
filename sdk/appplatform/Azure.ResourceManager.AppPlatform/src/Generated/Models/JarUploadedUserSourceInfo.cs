...
namespace Azure.ResourceManager.AppPlatform.Models
{
    ...
    public partial class JarUploadedUserSourceInfo : AppPlatformUploadedUserSourceInfo
    {
        ...
        internal JarUploadedUserSourceInfo(string userSourceInfoType, string version, string relativePath, string runtimeVersion, string jvmOptions, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(userSourceInfoType, version, relativePath, serializedAdditionalRawData)
        {
