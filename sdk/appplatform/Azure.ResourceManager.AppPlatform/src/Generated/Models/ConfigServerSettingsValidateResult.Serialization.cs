...
namespace Azure.ResourceManager.AppPlatform.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ConfigServerSettingsValidateResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ConfigServerSettingsValidateResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ConfigServerSettingsValidateResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ConfigServerSettingsValidateResult>)} interface");
            }
        ...
        string IPersistableModel<ConfigServerSettingsValidateResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
