...
{
    internal partial class ApiPortalCustomDomainResourceList : IUtf8JsonSerializable, IJsonModel<ApiPortalCustomDomainResourceList>, IPersistableModel<ApiPortalCustomDomainResourceList>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ApiPortalCustomDomainResourceList>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ApiPortalCustomDomainResourceList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ApiPortalCustomDomainResourceList)} does not support '{format}' format.");
            }
