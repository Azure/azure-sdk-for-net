...
namespace Azure.ResourceManager.AppPlatform.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ApiPortalCustomDomainResourceList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ApiPortalCustomDomainResourceList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ApiPortalCustomDomainResourceList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ApiPortalCustomDomainResourceList>)} interface");
            }
        ...
        string IPersistableModel<ApiPortalCustomDomainResourceList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
