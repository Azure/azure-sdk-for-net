...
namespace Azure.ResourceManager.AppPlatform.Models
{
    internal partial class ApiPortalCustomDomainResourceList
    {
        internal static ApiPortalCustomDomainResourceList DeserializeApiPortalCustomDomainResourceList(JsonElement element)
        {
            ...
            Core.Optional<IReadOnlyList<AppPlatformApiPortalCustomDomainData>> value = default;
            ...
            return new ApiPortalCustomDomainResourceList(Core.Optional.ToList(value), nextLink.Value);
        }
    }
}
