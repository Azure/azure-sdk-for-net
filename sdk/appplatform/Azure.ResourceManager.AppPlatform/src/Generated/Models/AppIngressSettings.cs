...
namespace Azure.ResourceManager.AppPlatform.Models
{
    ...
    public partial class AppIngressSettings
    {
        ...
        internal AppIngressSettings(int? readTimeoutInSeconds, int? sendTimeoutInSeconds, AppSessionAffinity? sessionAffinity, int? sessionCookieMaxAge, AppBackendProtocol? backendProtocol, IngressSettingsClientAuth clientAuth, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
