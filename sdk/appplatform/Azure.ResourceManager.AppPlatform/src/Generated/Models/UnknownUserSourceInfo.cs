...
namespace Azure.ResourceManager.AppPlatform.Models
{
    ...
    internal partial class UnknownUserSourceInfo : AppPlatformUserSourceInfo
    {
        ...
        internal UnknownUserSourceInfo(string userSourceInfoType, string version, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(userSourceInfoType, version, serializedAdditionalRawData)
        {
