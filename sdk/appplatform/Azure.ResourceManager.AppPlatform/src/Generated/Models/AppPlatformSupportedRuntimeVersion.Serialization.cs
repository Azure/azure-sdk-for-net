...
namespace Azure.ResourceManager.AppPlatform.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AppPlatformSupportedRuntimeVersion>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AppPlatformSupportedRuntimeVersion>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AppPlatformSupportedRuntimeVersion>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<AppPlatformSupportedRuntimeVersion>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
