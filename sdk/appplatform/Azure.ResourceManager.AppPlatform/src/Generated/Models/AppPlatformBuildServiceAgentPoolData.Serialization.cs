        ...
        internal static AppPlatformBuildServiceAgentPoolData DeserializeAppPlatformBuildServiceAgentPoolData(JsonElement element)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("properties"u8))
                {
                    ...
                    properties = AppPlatformBuildServiceAgentPoolProperties.DeserializeAppPlatformBuildServiceAgentPoolProperties(property.Value);
                    continue;
                }
            ...
            return new AppPlatformBuildServiceAgentPoolData(id, name, type, systemData.Value, properties.Value);
        }
    }
}
