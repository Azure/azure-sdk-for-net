...
namespace Azure.ResourceManager.AppPlatform.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NetCoreZipUploadedUserSourceInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NetCoreZipUploadedUserSourceInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NetCoreZipUploadedUserSourceInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<NetCoreZipUploadedUserSourceInfo>)} interface");
            }
        ...
        string IPersistableModel<NetCoreZipUploadedUserSourceInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
