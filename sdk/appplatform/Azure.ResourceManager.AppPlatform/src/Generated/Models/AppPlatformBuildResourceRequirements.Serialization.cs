...
namespace Azure.ResourceManager.AppPlatform.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AppPlatformBuildResourceRequirements>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AppPlatformBuildResourceRequirements>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AppPlatformBuildResourceRequirements>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AppPlatformBuildResourceRequirements>)} interface");
            }
        ...
        string IPersistableModel<AppPlatformBuildResourceRequirements>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
