...
namespace Azure.ResourceManager.AppPlatform.Models
{
    ...
    public partial class AppPlatformAzureFileVolume : AppCustomPersistentDiskProperties
    {
        ...
        internal AppPlatformAzureFileVolume(UnderlyingResourceType underlyingResourceType, string mountPath, bool? isReadOnly, IList<string> mountOptions, string shareName, Dictionary<string, BinaryData> rawData) : base(underlyingResourceType, mountPath, isReadOnly, mountOptions, rawData)
        {
            ShareName = shareName;
