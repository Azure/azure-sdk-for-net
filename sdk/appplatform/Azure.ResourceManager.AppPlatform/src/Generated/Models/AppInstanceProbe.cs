...
namespace Azure.ResourceManager.AppPlatform.Models
{
    ...
    public partial class AppInstanceProbe
    {
        ...
        internal AppInstanceProbe(AppInstanceProbeAction probeAction, bool isProbeDisabled, int? initialDelayInSeconds, int? periodInSeconds, int? timeoutInSeconds, int? failureThreshold, int? successThreshold, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
