...
{
    public partial class BuilderProperties : IUtf8JsonSerializable
    {
        ...
        internal static BuilderProperties DeserializeBuilderProperties(JsonElement element)
        {
            Optional<BuilderProvisioningState> provisioningState = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("provisioningState"))
                {
                    ...
                    provisioningState = new BuilderProvisioningState(property.Value.GetString());
                    continue;
                }
            ...
            return new BuilderProperties(Optional.ToNullable(provisioningState), stack.Value, Optional.ToList(buildpackGroups));
        }
    }
}
