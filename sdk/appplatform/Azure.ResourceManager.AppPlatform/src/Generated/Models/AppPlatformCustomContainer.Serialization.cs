...
{
    public partial class AppPlatformCustomContainer : IUtf8JsonSerializable, IJsonModel<AppPlatformCustomContainer>, IPersistableModel<AppPlatformCustomContainer>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ImageRegistryCredential))
            {
                ...
                AppendChildObject(builder, ImageRegistryCredential, options, 2);
            }
