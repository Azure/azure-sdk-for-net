...
namespace Azure.ResourceManager.AppPlatform.Models
{
    ...
    public abstract partial class AppCustomPersistentDiskProperties
    {
        ...
        internal AppCustomPersistentDiskProperties(UnderlyingResourceType underlyingResourceType, string mountPath, bool? isReadOnly, IList<string> mountOptions, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
