...
namespace Azure.ResourceManager.AppPlatform.Models
{
    ...
    public partial class AppPlatformCustomContainerUserSourceInfo : AppPlatformUserSourceInfo
    {
        ...
        internal AppPlatformCustomContainerUserSourceInfo(string userSourceInfoType, string version, AppPlatformCustomContainer customContainer, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(userSourceInfoType, version, serializedAdditionalRawData)
        {
