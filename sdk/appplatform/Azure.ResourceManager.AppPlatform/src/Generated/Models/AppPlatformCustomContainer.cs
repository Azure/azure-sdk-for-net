...
namespace Azure.ResourceManager.AppPlatform.Models
{
    ...
    public partial class AppPlatformCustomContainer
    {
        ...
        internal AppPlatformCustomContainer(string server, string containerImage, IList<string> command, IList<string> args, AppPlatformImageRegistryCredential imageRegistryCredential, string languageFramework, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Server = server;
