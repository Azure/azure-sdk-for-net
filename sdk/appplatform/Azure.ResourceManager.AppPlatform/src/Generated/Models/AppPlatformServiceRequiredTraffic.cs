...
namespace Azure.ResourceManager.AppPlatform.Models
{
    ...
    public partial class AppPlatformServiceRequiredTraffic
    {
        ...
        internal AppPlatformServiceRequiredTraffic(string protocol, int? port, IReadOnlyList<IPAddress> ips, IReadOnlyList<string> fqdns, AppPlatformServiceTrafficDirection? direction, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Protocol = protocol;
            Port = port;
            IPs = ips;
