...
{
    internal partial class IngressConfig : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static IngressConfig DeserializeIngressConfig(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
