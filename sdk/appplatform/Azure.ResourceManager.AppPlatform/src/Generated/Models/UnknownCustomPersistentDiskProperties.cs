...
namespace Azure.ResourceManager.AppPlatform.Models
{
    ...
    internal partial class UnknownCustomPersistentDiskProperties : AppCustomPersistentDiskProperties
    {
        ...
        internal UnknownCustomPersistentDiskProperties(UnderlyingResourceType underlyingResourceType, string mountPath, bool? isReadOnly, IList<string> mountOptions, Dictionary<string, BinaryData> rawData) : base(underlyingResourceType, mountPath, isReadOnly, mountOptions, rawData)
        {
