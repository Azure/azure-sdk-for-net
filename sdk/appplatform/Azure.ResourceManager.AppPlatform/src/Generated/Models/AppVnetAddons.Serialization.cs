...
{
    public partial class AppVnetAddons : IUtf8JsonSerializable, IJsonModel<AppVnetAddons>, IPersistableModel<AppVnetAddons>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(IsPublicEndpoint))
            {
                builder.Append("  publicEndpoint:");
                var boolValue = IsPublicEndpoint.Value == true ? "true" : "false";
                builder.AppendLine($" {boolValue}");
            }

            if (Optional.IsDefined(PublicEndpointUri))
            {
                builder.Append("  publicEndpointUrl:");
                builder.AppendLine($" '{PublicEndpointUri.AbsoluteUri}'");
            }
