...
namespace Azure.ResourceManager.AppPlatform.Models
{
    ...
    public partial class AppPlatformGatewayCorsProperties
    {
        ...
        internal AppPlatformGatewayCorsProperties(IList<string> allowedOrigins, IList<string> allowedMethods, IList<string> allowedHeaders, int? maxAge, bool? areCredentialsAllowed, IList<string> exposedHeaders, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
