...
namespace Azure.ResourceManager.AppPlatform.Models
{
    ...
    public partial class AppInstanceHttpGetAction : AppInstanceProbeAction
    {
        ...
        internal AppInstanceHttpGetAction(ProbeActionType probeActionType, string path, AppInstanceHttpSchemeType? scheme, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(probeActionType, serializedAdditionalRawData)
        {
            Path = path;
            Scheme = scheme;
