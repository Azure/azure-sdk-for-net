...
namespace Azure.ResourceManager.AppPlatform.Models
{
    ...
    public partial class SourceUploadedUserSourceInfo : AppPlatformUploadedUserSourceInfo
    {
        ...
        internal SourceUploadedUserSourceInfo(string userSourceInfoType, string version, string relativePath, string artifactSelector, string runtimeVersion, Dictionary<string, BinaryData> rawData) : base(userSourceInfoType, version, relativePath, rawData)
        {
