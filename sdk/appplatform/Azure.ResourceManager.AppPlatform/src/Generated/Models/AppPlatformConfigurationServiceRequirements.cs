...
namespace Azure.ResourceManager.AppPlatform.Models
{
    ...
    public partial class AppPlatformConfigurationServiceRequirements
    {
        ...
        internal AppPlatformConfigurationServiceRequirements(string cpu, string memory, int? instanceCount, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Cpu = cpu;
            Memory = memory;
