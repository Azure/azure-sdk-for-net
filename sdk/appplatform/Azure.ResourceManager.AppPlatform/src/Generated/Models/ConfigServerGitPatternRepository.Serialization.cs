...
namespace Azure.ResourceManager.AppPlatform.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ConfigServerGitPatternRepository>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ConfigServerGitPatternRepository>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ConfigServerGitPatternRepository>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ConfigServerGitPatternRepository>)} interface");
            }
        ...
        string IPersistableModel<ConfigServerGitPatternRepository>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
