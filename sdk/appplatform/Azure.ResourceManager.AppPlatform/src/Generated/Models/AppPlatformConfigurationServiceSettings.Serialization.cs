...
namespace Azure.ResourceManager.AppPlatform.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AppPlatformConfigurationServiceSettings>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AppPlatformConfigurationServiceSettings>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AppPlatformConfigurationServiceSettings>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AppPlatformConfigurationServiceSettings>)} interface");
            }
        ...
        string IPersistableModel<AppPlatformConfigurationServiceSettings>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
