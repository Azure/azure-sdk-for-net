...
namespace Azure.ResourceManager.AppPlatform.Models
{
    ...
    public partial class NetCoreZipUploadedUserSourceInfo : AppPlatformUploadedUserSourceInfo
    {
        ...
        internal NetCoreZipUploadedUserSourceInfo(string userSourceInfoType, string version, string relativePath, string netCoreMainEntryPath, string runtimeVersion, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(userSourceInfoType, version, relativePath, serializedAdditionalRawData)
        {
