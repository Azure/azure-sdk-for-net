...
namespace Azure.ResourceManager.AppPlatform.Models
{
    ...
    {
        internal static AppPlatformSkuZoneDetails DeserializeAppPlatformSkuZoneDetails(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
