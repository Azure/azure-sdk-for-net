...
namespace Azure.ResourceManager.AppPlatform.Models
{
    ...
    public partial class AppPlatformGatewayApiRoute
    {
        ...
        internal AppPlatformGatewayApiRoute(string title, string description, Uri uri, bool? isSsoEnabled, bool? isTokenRelayed, IList<string> predicates, IList<string> filters, int? order, IList<string> tags, Dictionary<string, BinaryData> rawData)
        {
            Title = title;
