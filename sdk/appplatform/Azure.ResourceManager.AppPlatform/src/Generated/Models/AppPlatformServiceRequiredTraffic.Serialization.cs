...
namespace Azure.ResourceManager.AppPlatform.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AppPlatformServiceRequiredTraffic>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AppPlatformServiceRequiredTraffic>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AppPlatformServiceRequiredTraffic>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AppPlatformServiceRequiredTraffic>)} interface");
            }
        ...
        string IPersistableModel<AppPlatformServiceRequiredTraffic>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
