...
namespace Azure.ResourceManager.AppPlatform
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AppPlatformGatewayData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AppPlatformGatewayData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AppPlatformGatewayData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AppPlatformGatewayData>)} interface");
            }
        ...
        string IPersistableModel<AppPlatformGatewayData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
