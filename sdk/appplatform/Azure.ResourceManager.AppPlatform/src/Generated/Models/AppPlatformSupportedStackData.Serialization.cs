...
namespace Azure.ResourceManager.AppPlatform
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AppPlatformSupportedStackData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AppPlatformSupportedStackData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AppPlatformSupportedStackData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AppPlatformSupportedStackData>)} interface");
            }
        ...
        string IPersistableModel<AppPlatformSupportedStackData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
