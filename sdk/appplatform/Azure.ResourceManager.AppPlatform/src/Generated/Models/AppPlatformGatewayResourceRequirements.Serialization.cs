...
{
    public partial class AppPlatformGatewayResourceRequirements : IUtf8JsonSerializable
    {
        ...
        internal static AppPlatformGatewayResourceRequirements DeserializeAppPlatformGatewayResourceRequirements(JsonElement element)
        {
            ...
            return new AppPlatformGatewayResourceRequirements(cpu.Value, memory.Value);
        }
    }
}
