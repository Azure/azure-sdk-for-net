...
namespace Azure.ResourceManager.AppPlatform.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GatewayRouteConfigOpenApiProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<GatewayRouteConfigOpenApiProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<GatewayRouteConfigOpenApiProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<GatewayRouteConfigOpenApiProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
