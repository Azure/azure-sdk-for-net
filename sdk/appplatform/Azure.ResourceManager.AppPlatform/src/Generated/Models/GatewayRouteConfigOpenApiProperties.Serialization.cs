...
{
    internal partial class GatewayRouteConfigOpenApiProperties : IUtf8JsonSerializable, IJsonModel<GatewayRouteConfigOpenApiProperties>, IPersistableModel<GatewayRouteConfigOpenApiProperties>
    {
        ...
        void IJsonModel<GatewayRouteConfigOpenApiProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(GatewayRouteConfigOpenApiProperties)} does not support '{format}' format.");
            }
