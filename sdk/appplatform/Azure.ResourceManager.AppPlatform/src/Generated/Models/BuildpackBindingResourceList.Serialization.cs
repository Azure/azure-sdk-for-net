...
namespace Azure.ResourceManager.AppPlatform.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BuildpackBindingResourceList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<BuildpackBindingResourceList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BuildpackBindingResourceList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<BuildpackBindingResourceList>)} interface");
            }
        ...
        string IPersistableModel<BuildpackBindingResourceList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
