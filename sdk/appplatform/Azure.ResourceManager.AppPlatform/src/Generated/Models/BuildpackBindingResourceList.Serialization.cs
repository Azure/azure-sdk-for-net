...
namespace Azure.ResourceManager.AppPlatform.Models
{
    ...
    {
        internal static BuildpackBindingResourceList DeserializeBuildpackBindingResourceList(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
