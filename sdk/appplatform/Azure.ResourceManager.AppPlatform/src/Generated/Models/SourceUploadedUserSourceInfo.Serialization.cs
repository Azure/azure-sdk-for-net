...
namespace Azure.ResourceManager.AppPlatform.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SourceUploadedUserSourceInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SourceUploadedUserSourceInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SourceUploadedUserSourceInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SourceUploadedUserSourceInfo>)} interface");
            }
        ...
        string IPersistableModel<SourceUploadedUserSourceInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
