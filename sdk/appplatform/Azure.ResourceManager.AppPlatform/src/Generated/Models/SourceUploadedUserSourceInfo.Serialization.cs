...
{
    public partial class SourceUploadedUserSourceInfo : IUtf8JsonSerializable, IJsonModel<SourceUploadedUserSourceInfo>, IPersistableModel<SourceUploadedUserSourceInfo>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ArtifactSelector))
            {
                builder.Append("  artifactSelector:");
                builder.AppendLine($" '{ArtifactSelector}'");
            }
