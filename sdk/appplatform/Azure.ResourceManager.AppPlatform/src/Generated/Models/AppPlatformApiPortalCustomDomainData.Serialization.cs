...
{
    public partial class AppPlatformApiPortalCustomDomainData : IUtf8JsonSerializable, IJsonModel<AppPlatformApiPortalCustomDomainData>, IPersistableModel<AppPlatformApiPortalCustomDomainData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AppPlatformApiPortalCustomDomainData>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<AppPlatformApiPortalCustomDomainData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AppPlatformApiPortalCustomDomainData)} does not support '{format}' format.");
            }
