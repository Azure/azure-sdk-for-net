...
namespace Azure.ResourceManager.AppPlatform.Models
{
    ...
    {
        internal static AppPlatformBuildResultLog DeserializeAppPlatformBuildResultLog(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
