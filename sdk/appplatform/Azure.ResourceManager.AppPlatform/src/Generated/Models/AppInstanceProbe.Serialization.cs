...
{
    public partial class AppInstanceProbe : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static AppInstanceProbe DeserializeAppInstanceProbe(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
