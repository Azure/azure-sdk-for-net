...
namespace Azure.ResourceManager.AppPlatform.Models
{
    ...
    public partial class AppPlatformSkuCapacity
    {
        ...
        internal AppPlatformSkuCapacity(int minimum, int? maximum, int? @default, AppPlatformSkuScaleType? scaleType, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Minimum = minimum;
            Maximum = maximum;
            Default = @default;
