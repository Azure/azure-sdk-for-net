...
namespace Azure.ResourceManager.AppPlatform.Models
{
    ...
    public partial class AppPlatformBuildResultProperties
    {
        ...
        internal AppPlatformBuildResultProperties(string name, AppPlatformBuildResultProvisioningState? provisioningState, string buildPodName, IReadOnlyList<AppPlatformBuildStageProperties> buildStages, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
