...
namespace Azure.ResourceManager.AppPlatform.Models
{
    internal partial class UnknownProbeAction : IUtf8JsonSerializable, IJsonModel<AppInstanceProbeAction>
    {
        ...
        void IJsonModel<AppInstanceProbeAction>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(AppInstanceProbeAction)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<AppInstanceProbeAction>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(AppInstanceProbeAction)} does not support '{options.Format}' format.");
            }
        }
