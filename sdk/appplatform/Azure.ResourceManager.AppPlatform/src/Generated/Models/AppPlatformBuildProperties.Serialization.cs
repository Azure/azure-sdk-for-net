...
{
    public partial class AppPlatformBuildProperties : IUtf8JsonSerializable, IJsonModel<AppPlatformBuildProperties>, IPersistableModel<AppPlatformBuildProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(AgentPool))
            {
                builder.Append("  agentPool:");
                builder.AppendLine($" '{AgentPool}'");
            }
            ...
            {
                builder.Append("  triggeredBuildResult:");
                AppendChildObject(builder, TriggeredBuildResult, options, 2);
            }

            if (Optional.IsDefined(ResourceRequests))
            {
                builder.Append("  resourceRequests:");
                AppendChildObject(builder, ResourceRequests, options, 2);
            }
