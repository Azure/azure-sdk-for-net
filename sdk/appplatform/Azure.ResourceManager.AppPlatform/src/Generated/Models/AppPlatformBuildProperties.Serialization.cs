    ...
    public partial class AppPlatformBuildProperties : IUtf8JsonSerializable, IJsonModel<AppPlatformBuildProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Builder))
            {
                ...
                if (Builder.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(AgentPool))
            {
                ...
                if (AgentPool.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(TriggeredBuildResult))
            {
                ...
                AppendChildObject(builder, TriggeredBuildResult, options, 2, false);
            }

            if (Optional.IsDefined(ResourceRequests))
            {
                builder.Append("  resourceRequests:");
                AppendChildObject(builder, ResourceRequests, options, 2, false);
            }
