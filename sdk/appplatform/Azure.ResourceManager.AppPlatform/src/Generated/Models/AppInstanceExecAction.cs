...
namespace Azure.ResourceManager.AppPlatform.Models
{
    ...
    public partial class AppInstanceExecAction : AppInstanceProbeAction
    {
        ...
        internal AppInstanceExecAction(ProbeActionType probeActionType, IList<string> command, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(probeActionType, serializedAdditionalRawData)
        {
            Command = command;
