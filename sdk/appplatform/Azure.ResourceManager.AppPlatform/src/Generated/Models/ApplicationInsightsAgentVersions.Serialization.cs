...
namespace Azure.ResourceManager.AppPlatform.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ApplicationInsightsAgentVersions>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ApplicationInsightsAgentVersions>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ApplicationInsightsAgentVersions>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ApplicationInsightsAgentVersions>)} interface");
            }
        ...
        string IPersistableModel<ApplicationInsightsAgentVersions>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
