...
namespace Azure.ResourceManager.AppPlatform.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ApplicationInsightsAgentVersions>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ApplicationInsightsAgentVersions)} does not support writing '{format}' format.");
            }
        ...
        ApplicationInsightsAgentVersions IJsonModel<ApplicationInsightsAgentVersions>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ApplicationInsightsAgentVersions)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ApplicationInsightsAgentVersions>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ApplicationInsightsAgentVersions)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        ApplicationInsightsAgentVersions IPersistableModel<ApplicationInsightsAgentVersions>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ApplicationInsightsAgentVersions)} does not support reading '{options.Format}' format.");
            }
        }
