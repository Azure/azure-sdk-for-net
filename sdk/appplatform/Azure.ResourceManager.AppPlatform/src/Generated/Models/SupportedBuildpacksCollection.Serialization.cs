...
{
    internal partial class SupportedBuildpacksCollection
    {
        internal static SupportedBuildpacksCollection DeserializeSupportedBuildpacksCollection(JsonElement element)
        {
            ...
            return new SupportedBuildpacksCollection(Optional.ToList(value), nextLink.Value);
        }
    }
}
