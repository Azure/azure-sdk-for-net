...
namespace Azure.ResourceManager.AppPlatform.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AppLoadedCertificate>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AppLoadedCertificate>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AppLoadedCertificate>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<AppLoadedCertificate>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
