...
namespace Azure.ResourceManager.AppPlatform.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DeploymentList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DeploymentList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DeploymentList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DeploymentList>)} interface");
            }
        ...
        string IPersistableModel<DeploymentList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
