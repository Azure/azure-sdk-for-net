...
{
    public partial class AppPlatformAppProperties : IUtf8JsonSerializable, IJsonModel<AppPlatformAppProperties>, IPersistableModel<AppPlatformAppProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(TemporaryDisk))
            {
                ...
                AppendChildObject(builder, TemporaryDisk, options, 2);
            }

            if (Optional.IsDefined(PersistentDisk))
            {
                builder.Append("  persistentDisk:");
                AppendChildObject(builder, PersistentDisk, options, 2);
            }
            ...
            if (Optional.IsDefined(IngressSettings))
            {
                ...
                AppendChildObject(builder, IngressSettings, options, 2);
            }
