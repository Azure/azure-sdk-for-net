...
{
    public partial class AppPlatformConfigServerProperties : IUtf8JsonSerializable, IJsonModel<AppPlatformConfigServerProperties>, IPersistableModel<AppPlatformConfigServerProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ConfigServer))
            {
                ...
                AppendChildObject(builder, ConfigServer, options, 2);
            }
