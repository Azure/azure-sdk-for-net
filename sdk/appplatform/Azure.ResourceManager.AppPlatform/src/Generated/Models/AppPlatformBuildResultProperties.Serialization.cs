...
{
    public partial class AppPlatformBuildResultProperties : IUtf8JsonSerializable, IJsonModel<AppPlatformBuildResultProperties>, IPersistableModel<AppPlatformBuildResultProperties>
    {
        ...
        void IJsonModel<AppPlatformBuildResultProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AppPlatformBuildResultProperties)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(BuildPodName))
            {
                builder.Append("  buildPodName:");
                builder.AppendLine($" '{BuildPodName}'");
            }

            if (Optional.IsCollectionDefined(BuildStages))
            {
                builder.Append("  buildStages:");
                builder.AppendLine(" [");
                foreach (var item in BuildStages)
                {
