...
{
    public partial class AppPlatformBuildResultUserSourceInfo : IUtf8JsonSerializable, IJsonModel<AppPlatformBuildResultUserSourceInfo>, IPersistableModel<AppPlatformBuildResultUserSourceInfo>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(BuildResultId))
            {
                builder.Append("  buildResultId:");
                builder.AppendLine($" '{BuildResultId}'");
            }
