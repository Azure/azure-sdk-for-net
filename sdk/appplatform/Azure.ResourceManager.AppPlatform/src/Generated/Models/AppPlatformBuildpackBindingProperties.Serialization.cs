...
{
    public partial class AppPlatformBuildpackBindingProperties : IUtf8JsonSerializable, IJsonModel<AppPlatformBuildpackBindingProperties>, IPersistableModel<AppPlatformBuildpackBindingProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(BindingType))
            {
                ...
                builder.AppendLine($" '{BindingType.ToString()}'");
            }
            ...
            if (Optional.IsDefined(LaunchProperties))
            {
                builder.Append("  launchProperties:");
                AppendChildObject(builder, LaunchProperties, options, 2);
            }
