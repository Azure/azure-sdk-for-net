...
namespace Azure.ResourceManager.AppPlatform.Models
{
    ...
    public partial class AppPlatformSkuLocationInfo
    {
        ...
        internal AppPlatformSkuLocationInfo(AzureLocation? location, IReadOnlyList<string> zones, IReadOnlyList<AppPlatformSkuZoneDetails> zoneDetails, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Location = location;
            Zones = zones;
