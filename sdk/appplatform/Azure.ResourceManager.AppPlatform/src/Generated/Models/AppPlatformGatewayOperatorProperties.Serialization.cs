...
namespace Azure.ResourceManager.AppPlatform.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AppPlatformGatewayOperatorProperties>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (options.Format != "W" && Optional.IsDefined(ResourceRequests))
            {
                ...
                ((IJsonModel<AppPlatformGatewayOperatorResourceRequirements>)ResourceRequests).Write(writer, options);
            }
        ...
        internal static AppPlatformGatewayOperatorProperties DeserializeAppPlatformGatewayOperatorProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("resourceRequests"u8))
                {
                    ...
                    resourceRequests = ModelSerializationExtensions.JsonDeserialize<AppPlatformGatewayOperatorResourceRequirements>(property.Value);
                    continue;
                }
