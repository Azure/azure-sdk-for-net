...
{
    public partial class AppPlatformDeploymentSettings : IUtf8JsonSerializable, IJsonModel<AppPlatformDeploymentSettings>, IPersistableModel<AppPlatformDeploymentSettings>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(StartupProbe))
            {
                builder.Append("  startupProbe:");
                AppendChildObject(builder, StartupProbe, options, 2);
            }

            if (Optional.IsDefined(TerminationGracePeriodInSeconds))
            {
                builder.Append("  terminationGracePeriodSeconds:");
                builder.AppendLine($" '{TerminationGracePeriodInSeconds.Value.ToString()}'");
            }

            if (Optional.IsDefined(ContainerProbeSettings))
            {
                builder.Append("  containerProbeSettings:");
                AppendChildObject(builder, ContainerProbeSettings, options, 2);
            }
