    ...
    public partial class AppPlatformDeploymentSettings : IUtf8JsonSerializable, IJsonModel<AppPlatformDeploymentSettings>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(StartupProbe))
            {
                ...
                AppendChildObject(builder, StartupProbe, options, 2, false);
            }

            if (Optional.IsDefined(TerminationGracePeriodInSeconds))
            {
                builder.Append("  terminationGracePeriodSeconds:");
                builder.AppendLine($" {TerminationGracePeriodInSeconds.Value}");
            }

            if (Optional.IsDefined(ContainerProbeSettings))
            {
                builder.Append("  containerProbeSettings:");
                AppendChildObject(builder, ContainerProbeSettings, options, 2, false);
            }
