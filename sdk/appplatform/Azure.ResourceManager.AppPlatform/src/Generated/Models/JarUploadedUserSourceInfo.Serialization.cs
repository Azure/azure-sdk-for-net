...
namespace Azure.ResourceManager.AppPlatform.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<JarUploadedUserSourceInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<JarUploadedUserSourceInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<JarUploadedUserSourceInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<JarUploadedUserSourceInfo>)} interface");
            }
        ...
        string IPersistableModel<JarUploadedUserSourceInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
