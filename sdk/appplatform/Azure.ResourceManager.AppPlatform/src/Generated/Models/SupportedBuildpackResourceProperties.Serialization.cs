...
namespace Azure.ResourceManager.AppPlatform.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SupportedBuildpackResourceProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SupportedBuildpackResourceProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SupportedBuildpackResourceProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SupportedBuildpackResourceProperties>)} interface");
            }
        ...
        string IPersistableModel<SupportedBuildpackResourceProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
