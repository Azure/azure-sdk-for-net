...
{
    internal partial class SupportedBuildpackResourceProperties : IUtf8JsonSerializable, IJsonModel<SupportedBuildpackResourceProperties>, IPersistableModel<SupportedBuildpackResourceProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(BuildpackId))
            {
                builder.Append("  buildpackId:");
                builder.AppendLine($" '{BuildpackId}'");
            }
