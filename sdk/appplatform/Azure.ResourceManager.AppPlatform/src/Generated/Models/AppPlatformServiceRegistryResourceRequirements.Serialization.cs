...
namespace Azure.ResourceManager.AppPlatform.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AppPlatformServiceRegistryResourceRequirements>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<AppPlatformServiceRegistryResourceRequirements>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AppPlatformServiceRegistryResourceRequirements>)} interface");
            }
        ...
        string IPersistableModel<AppPlatformServiceRegistryResourceRequirements>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
