...
{
    public partial class AppPlatformConfigurationServiceGitValidateResult : IUtf8JsonSerializable, IJsonModel<AppPlatformConfigurationServiceGitValidateResult>, IPersistableModel<AppPlatformConfigurationServiceGitValidateResult>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(GitReposValidationResult))
            {
                builder.Append("  gitReposValidationResult:");
                builder.AppendLine(" [");
                foreach (var item in GitReposValidationResult)
                {
