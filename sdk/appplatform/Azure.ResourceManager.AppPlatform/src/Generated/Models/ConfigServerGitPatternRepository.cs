...
namespace Azure.ResourceManager.AppPlatform.Models
{
    ...
    public partial class ConfigServerGitPatternRepository
    {
        ...
        internal ConfigServerGitPatternRepository(string name, IList<string> pattern, Uri uri, string label, IList<string> searchPaths, string username, string password, string hostKey, string hostKeyAlgorithm, string privateKey, bool? isHostKeyCheckingStrict, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Pattern = pattern;
            Uri = uri;
