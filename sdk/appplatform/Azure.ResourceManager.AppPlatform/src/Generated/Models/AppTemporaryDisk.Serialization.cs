...
{
    public partial class AppTemporaryDisk : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static AppTemporaryDisk DeserializeAppTemporaryDisk(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
