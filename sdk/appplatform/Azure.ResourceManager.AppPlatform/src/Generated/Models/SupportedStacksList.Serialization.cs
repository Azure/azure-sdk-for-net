...
namespace Azure.ResourceManager.AppPlatform.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SupportedStacksList>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SupportedStacksList)} does not support writing '{format}' format.");
            }
            ...
            if (Optional.IsCollectionDefined(Value))
            {
                ...
                {
                    ((IJsonModel<AppPlatformSupportedStackData>)item).Write(writer, options);
                }
        ...
        SupportedStacksList IJsonModel<SupportedStacksList>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SupportedStacksList)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<SupportedStacksList>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SupportedStacksList)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        SupportedStacksList IPersistableModel<SupportedStacksList>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SupportedStacksList)} does not support reading '{options.Format}' format.");
            }
        }
