...
namespace Azure.ResourceManager.AppPlatform.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SupportedStacksList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SupportedStacksList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SupportedStacksList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SupportedStacksList>)} interface");
            }
        ...
        string IPersistableModel<SupportedStacksList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
