...
namespace Azure.ResourceManager.AppPlatform.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AppPlatformContentCertificateProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AppPlatformContentCertificateProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AppPlatformContentCertificateProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AppPlatformContentCertificateProperties>)} interface");
            }
        ...
        string IPersistableModel<AppPlatformContentCertificateProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
