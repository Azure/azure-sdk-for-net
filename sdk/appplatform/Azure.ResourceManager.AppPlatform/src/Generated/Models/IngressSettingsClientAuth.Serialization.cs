...
{
    internal partial class IngressSettingsClientAuth : IUtf8JsonSerializable, IJsonModel<IngressSettingsClientAuth>, IPersistableModel<IngressSettingsClientAuth>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IngressSettingsClientAuth>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<IngressSettingsClientAuth>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(IngressSettingsClientAuth)} does not support '{format}' format.");
            }
