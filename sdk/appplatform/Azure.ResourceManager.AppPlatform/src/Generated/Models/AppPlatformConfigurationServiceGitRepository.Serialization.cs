...
namespace Azure.ResourceManager.AppPlatform.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AppPlatformConfigurationServiceGitRepository>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<AppPlatformConfigurationServiceGitRepository>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AppPlatformConfigurationServiceGitRepository>)} interface");
            }
        ...
        string IPersistableModel<AppPlatformConfigurationServiceGitRepository>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
