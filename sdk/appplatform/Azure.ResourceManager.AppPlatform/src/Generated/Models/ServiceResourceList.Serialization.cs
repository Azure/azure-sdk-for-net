...
namespace Azure.ResourceManager.AppPlatform.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ServiceResourceList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ServiceResourceList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ServiceResourceList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ServiceResourceList>)} interface");
            }
        ...
        string IPersistableModel<ServiceResourceList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
