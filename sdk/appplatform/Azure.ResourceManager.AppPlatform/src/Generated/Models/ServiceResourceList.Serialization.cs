...
namespace Azure.ResourceManager.AppPlatform.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ServiceResourceList>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ServiceResourceList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ServiceResourceList)} does not support '{format}' format.");
            }

            writer.WriteStartObject();
            if (!(Value is ChangeTrackingList<AppPlatformServiceData> collection && collection.IsUndefined))
            {
        ...
        internal static ServiceResourceList DeserializeServiceResourceList(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("value"u8))
                {
                    ...
                    {
                        array.Add(AppPlatformServiceData.DeserializeAppPlatformServiceData(item, options));
                    }
                    value = array;
                    continue;
                }
            ...
            return new ServiceResourceList(value ?? new ChangeTrackingList<AppPlatformServiceData>(), nextLink, serializedAdditionalRawData);
        }
