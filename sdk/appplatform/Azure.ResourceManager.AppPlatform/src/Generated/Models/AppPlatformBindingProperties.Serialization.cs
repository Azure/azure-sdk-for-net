...
{
    public partial class AppPlatformBindingProperties : IUtf8JsonSerializable, IJsonModel<AppPlatformBindingProperties>, IPersistableModel<AppPlatformBindingProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(BindingParameters))
            {
                builder.Append("  bindingParameters:");
                builder.AppendLine(" {");
                foreach (var item in BindingParameters)
                {
            ...
            {
                builder.Append("  generatedProperties:");
                builder.AppendLine($" '{GeneratedProperties}'");
            }
