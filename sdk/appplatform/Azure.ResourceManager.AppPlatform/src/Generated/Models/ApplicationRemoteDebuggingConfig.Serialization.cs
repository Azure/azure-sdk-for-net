...
namespace Azure.ResourceManager.AppPlatform.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ApplicationRemoteDebuggingConfig>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ApplicationRemoteDebuggingConfig>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ApplicationRemoteDebuggingConfig>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ApplicationRemoteDebuggingConfig>)} interface");
            }
        ...
        string IPersistableModel<ApplicationRemoteDebuggingConfig>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
