...
{
    public partial class AppPlatformAzureFileVolume : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static AppPlatformAzureFileVolume DeserializeAppPlatformAzureFileVolume(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
