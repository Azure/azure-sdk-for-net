    ...
    public partial class AppPlatformGatewayProperties : IUtf8JsonSerializable, IJsonModel<AppPlatformGatewayProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SsoProperties))
            {
                ...
                AppendChildObject(builder, SsoProperties, options, 2, false);
            }

            if (Optional.IsDefined(ApiMetadataProperties))
            {
                builder.Append("  apiMetadataProperties:");
                AppendChildObject(builder, ApiMetadataProperties, options, 2, false);
            }

            if (Optional.IsDefined(CorsProperties))
            {
                builder.Append("  corsProperties:");
                AppendChildObject(builder, CorsProperties, options, 2, false);
            }
            ...
            if (Optional.IsDefined(OperatorProperties))
            {
                ...
                AppendChildObject(builder, OperatorProperties, options, 2, false);
            }
