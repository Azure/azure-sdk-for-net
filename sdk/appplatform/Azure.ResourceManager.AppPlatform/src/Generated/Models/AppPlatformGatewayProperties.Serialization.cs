...
{
    public partial class AppPlatformGatewayProperties : IUtf8JsonSerializable, IJsonModel<AppPlatformGatewayProperties>, IPersistableModel<AppPlatformGatewayProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SsoProperties))
            {
                builder.Append("  ssoProperties:");
                AppendChildObject(builder, SsoProperties, options, 2);
            }

            if (Optional.IsDefined(ApiMetadataProperties))
            {
                builder.Append("  apiMetadataProperties:");
                AppendChildObject(builder, ApiMetadataProperties, options, 2);
            }

            if (Optional.IsDefined(CorsProperties))
            {
                builder.Append("  corsProperties:");
                AppendChildObject(builder, CorsProperties, options, 2);
            }
            ...
            {
                builder.Append("  operatorProperties:");
                AppendChildObject(builder, OperatorProperties, options, 2);
            }
