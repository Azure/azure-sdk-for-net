...
namespace Azure.ResourceManager.AppPlatform.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AppPlatformNameAvailabilityResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AppPlatformNameAvailabilityResult)} does not support writing '{format}' format.");
            }
        ...
        AppPlatformNameAvailabilityResult IJsonModel<AppPlatformNameAvailabilityResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AppPlatformNameAvailabilityResult)} does not support reading '{format}' format.");
            }
        ...
        internal static AppPlatformNameAvailabilityResult DeserializeAppPlatformNameAvailabilityResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new AppPlatformNameAvailabilityResult(nameAvailable, reason, message, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<AppPlatformNameAvailabilityResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AppPlatformNameAvailabilityResult)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        AppPlatformNameAvailabilityResult IPersistableModel<AppPlatformNameAvailabilityResult>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AppPlatformNameAvailabilityResult)} does not support reading '{options.Format}' format.");
            }
        }
