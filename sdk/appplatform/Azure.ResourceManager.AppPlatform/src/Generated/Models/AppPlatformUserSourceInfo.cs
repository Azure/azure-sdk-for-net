...
namespace Azure.ResourceManager.AppPlatform.Models
{
    ...
    /// </summary>
    [DeserializationProxy(typeof(UnknownUserSourceInfo))]
    public abstract partial class AppPlatformUserSourceInfo
    {
        ...
        internal AppPlatformUserSourceInfo(string userSourceInfoType, string version, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
