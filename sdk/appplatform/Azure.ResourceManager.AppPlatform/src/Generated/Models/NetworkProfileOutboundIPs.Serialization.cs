...
namespace Azure.ResourceManager.AppPlatform.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NetworkProfileOutboundIPs>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NetworkProfileOutboundIPs>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NetworkProfileOutboundIPs>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<NetworkProfileOutboundIPs>)} interface");
            }
        ...
        string IPersistableModel<NetworkProfileOutboundIPs>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
