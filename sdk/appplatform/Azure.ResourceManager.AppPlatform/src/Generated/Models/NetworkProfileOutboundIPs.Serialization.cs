...
namespace Azure.ResourceManager.AppPlatform.Models
{
    ...
    {
        internal static NetworkProfileOutboundIPs DeserializeNetworkProfileOutboundIPs(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
