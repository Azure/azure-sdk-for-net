...
namespace Azure.ResourceManager.AppPlatform.Models
{
    ...
    public partial class AppPlatformSsoProperties
    {
        ...
        internal AppPlatformSsoProperties(IList<string> scope, string clientId, string clientSecret, Uri issuerUri, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Scope = scope;
            ClientId = clientId;
