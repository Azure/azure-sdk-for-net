...
namespace Azure.ResourceManager.AppPlatform.Models
{
    ...
    public partial class AppPlatformBuildResultUserSourceInfo : AppPlatformUserSourceInfo
    {
        ...
        internal AppPlatformBuildResultUserSourceInfo(string userSourceInfoType, string version, string buildResultId, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(userSourceInfoType, version, serializedAdditionalRawData)
        {
