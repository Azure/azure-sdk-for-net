...
namespace Azure.ResourceManager.AppPlatform.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AppPlatformBuildServiceResourceRequirements>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AppPlatformBuildServiceResourceRequirements>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AppPlatformBuildServiceResourceRequirements>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AppPlatformBuildServiceResourceRequirements>)} interface");
            }
        ...
        string IPersistableModel<AppPlatformBuildServiceResourceRequirements>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
