...
{
    public partial class AppPlatformServiceTestKeys : IUtf8JsonSerializable, IJsonModel<AppPlatformServiceTestKeys>, IPersistableModel<AppPlatformServiceTestKeys>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(PrimaryTestEndpoint))
            {
                builder.Append("  primaryTestEndpoint:");
                builder.AppendLine($" '{PrimaryTestEndpoint}'");
            }

            if (Optional.IsDefined(SecondaryTestEndpoint))
            {
                builder.Append("  secondaryTestEndpoint:");
                builder.AppendLine($" '{SecondaryTestEndpoint}'");
            }
