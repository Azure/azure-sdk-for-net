...
namespace Azure.ResourceManager.AppPlatform.Models
{
    ...
    public partial class AppPlatformUploadedUserSourceInfo : AppPlatformUserSourceInfo
    {
        ...
        internal AppPlatformUploadedUserSourceInfo(string userSourceInfoType, string version, string relativePath, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(userSourceInfoType, version, serializedAdditionalRawData)
        {
