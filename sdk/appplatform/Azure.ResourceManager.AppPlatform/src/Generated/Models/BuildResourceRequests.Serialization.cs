...
{
    public partial class BuildResourceRequests : IUtf8JsonSerializable
    {
        ...
        internal static BuildResourceRequests DeserializeBuildResourceRequests(JsonElement element)
        {
            ...
            return new BuildResourceRequests(cpu.Value, memory.Value);
        }
    }
}
