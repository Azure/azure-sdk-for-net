...
namespace Azure.ResourceManager.AppPlatform.Models
{
    ...
    public partial class AppPlatformGatewayApiMetadataProperties
    {
        ...
        internal AppPlatformGatewayApiMetadataProperties(string title, string description, string documentation, string version, Uri serverUri, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Title = title;
