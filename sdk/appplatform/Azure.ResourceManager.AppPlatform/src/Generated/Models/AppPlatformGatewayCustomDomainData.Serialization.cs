...
namespace Azure.ResourceManager.AppPlatform
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AppPlatformGatewayCustomDomainData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AppPlatformGatewayCustomDomainData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AppPlatformGatewayCustomDomainData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AppPlatformGatewayCustomDomainData>)} interface");
            }
        ...
        string IPersistableModel<AppPlatformGatewayCustomDomainData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
