...
{
    public partial class AppPlatformGatewayRouteConfigData : IUtf8JsonSerializable
    {
        ...
        internal static AppPlatformGatewayRouteConfigData DeserializeAppPlatformGatewayRouteConfigData(JsonElement element)
        {
            ...
            return new AppPlatformGatewayRouteConfigData(id, name, type, systemData.Value, properties.Value);
        }
    }
}
