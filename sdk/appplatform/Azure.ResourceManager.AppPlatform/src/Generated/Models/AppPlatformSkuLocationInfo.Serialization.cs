...
namespace Azure.ResourceManager.AppPlatform.Models
{
    ...
    {
        internal static AppPlatformSkuLocationInfo DeserializeAppPlatformSkuLocationInfo(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
