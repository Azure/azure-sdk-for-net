...
namespace Azure.ResourceManager.AppPlatform.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ServiceRegistryResourceList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ServiceRegistryResourceList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ServiceRegistryResourceList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ServiceRegistryResourceList>)} interface");
            }
        ...
        string IPersistableModel<ServiceRegistryResourceList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
