...
namespace Azure.ResourceManager.AppPlatform.Models
{
    ...
    {
        internal static ServiceRegistryResourceList DeserializeServiceRegistryResourceList(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
