...
{
    public partial class AppPlatformDeploymentData : IUtf8JsonSerializable
    {
        ...
        internal static AppPlatformDeploymentData DeserializeAppPlatformDeploymentData(JsonElement element)
        {
            ...
            return new AppPlatformDeploymentData(id, name, type, systemData.Value, properties.Value, sku.Value);
        }
    }
}
