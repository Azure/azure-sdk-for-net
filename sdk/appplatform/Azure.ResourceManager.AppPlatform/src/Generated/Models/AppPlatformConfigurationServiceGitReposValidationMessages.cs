...
namespace Azure.ResourceManager.AppPlatform.Models
{
    ...
    public partial class AppPlatformConfigurationServiceGitReposValidationMessages
    {
        ...
        internal AppPlatformConfigurationServiceGitReposValidationMessages(string name, IReadOnlyList<string> messages, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Messages = messages;
