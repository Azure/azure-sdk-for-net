...
namespace Azure.ResourceManager.AppPlatform.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GatewayResourceList>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<GatewayResourceList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<GatewayResourceList>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
