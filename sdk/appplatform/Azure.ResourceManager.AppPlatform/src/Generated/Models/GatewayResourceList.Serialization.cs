...
{
    internal partial class GatewayResourceList : IUtf8JsonSerializable, IJsonModel<GatewayResourceList>, IPersistableModel<GatewayResourceList>
    {
        ...
        void IJsonModel<GatewayResourceList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(GatewayResourceList)} does not support '{format}' format.");
            }
