...
namespace Azure.ResourceManager.AppPlatform.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BuildpackBindingLaunchProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<BuildpackBindingLaunchProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BuildpackBindingLaunchProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<BuildpackBindingLaunchProperties>)} interface");
            }
        ...
        string IPersistableModel<BuildpackBindingLaunchProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
