...
{
    public partial class AppInstanceTcpSocketAction : IUtf8JsonSerializable, IJsonModel<AppInstanceTcpSocketAction>, IPersistableModel<AppInstanceTcpSocketAction>
    {
        ...
        void IJsonModel<AppInstanceTcpSocketAction>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AppInstanceTcpSocketAction)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ProbeActionType))
            {
                builder.Append("  type:");
                builder.AppendLine($" '{ProbeActionType.ToString()}'");
            }
