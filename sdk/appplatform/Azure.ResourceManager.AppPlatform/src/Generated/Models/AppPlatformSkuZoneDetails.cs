...
namespace Azure.ResourceManager.AppPlatform.Models
{
    ...
    public partial class AppPlatformSkuZoneDetails
    {
        ...
        internal AppPlatformSkuZoneDetails(IReadOnlyList<string> name, IReadOnlyList<AppPlatformSkuCapabilities> capabilities, Dictionary<string, BinaryData> rawData)
        {
            Name = name;
