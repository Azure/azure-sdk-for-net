...
{
    public partial class AppPlatformMonitoringSettingProperties : IUtf8JsonSerializable, IJsonModel<AppPlatformMonitoringSettingProperties>, IPersistableModel<AppPlatformMonitoringSettingProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(IsTraceEnabled))
            {
                ...
                var boolValue = IsTraceEnabled.Value == true ? "true" : "false";
            ...
            if (Optional.IsDefined(AppInsightsSamplingRate))
            {
                builder.Append("  appInsightsSamplingRate:");
                builder.AppendLine($" '{AppInsightsSamplingRate.Value.ToString()}'");
            }

            if (Optional.IsDefined(AppInsightsAgentVersions))
            {
                builder.Append("  appInsightsAgentVersions:");
                AppendChildObject(builder, AppInsightsAgentVersions, options, 2);
            }
