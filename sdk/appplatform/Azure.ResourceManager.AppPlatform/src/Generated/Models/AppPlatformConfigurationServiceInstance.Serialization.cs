...
namespace Azure.ResourceManager.AppPlatform.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AppPlatformConfigurationServiceInstance>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AppPlatformConfigurationServiceInstance>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AppPlatformConfigurationServiceInstance>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AppPlatformConfigurationServiceInstance>)} interface");
            }
        ...
        string IPersistableModel<AppPlatformConfigurationServiceInstance>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
