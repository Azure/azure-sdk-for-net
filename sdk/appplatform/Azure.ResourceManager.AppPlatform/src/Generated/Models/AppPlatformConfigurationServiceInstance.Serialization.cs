...
namespace Azure.ResourceManager.AppPlatform.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AppPlatformConfigurationServiceInstance>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AppPlatformConfigurationServiceInstance)} does not support writing '{format}' format.");
            }
        ...
        AppPlatformConfigurationServiceInstance IJsonModel<AppPlatformConfigurationServiceInstance>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AppPlatformConfigurationServiceInstance)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<AppPlatformConfigurationServiceInstance>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AppPlatformConfigurationServiceInstance)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        AppPlatformConfigurationServiceInstance IPersistableModel<AppPlatformConfigurationServiceInstance>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AppPlatformConfigurationServiceInstance)} does not support reading '{options.Format}' format.");
            }
        }
