...
{
    public partial class AppPlatformCertificateProperties : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static AppPlatformCertificateProperties DeserializeAppPlatformCertificateProperties(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
