...
{
    internal partial class AppBuildServiceList : IUtf8JsonSerializable, IJsonModel<AppBuildServiceList>, IPersistableModel<AppBuildServiceList>
    {
        ...
        void IJsonModel<AppBuildServiceList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AppBuildServiceList)} does not support '{format}' format.");
            }
