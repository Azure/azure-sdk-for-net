...
namespace Azure.ResourceManager.AppPlatform.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AppBuildServiceList>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<AppBuildServiceList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AppBuildServiceList>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
