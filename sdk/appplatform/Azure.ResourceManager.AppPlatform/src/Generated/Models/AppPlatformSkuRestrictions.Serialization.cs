...
namespace Azure.ResourceManager.AppPlatform.Models
{
    ...
    {
        internal static AppPlatformSkuRestrictions DeserializeAppPlatformSkuRestrictions(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
