...
{
    public partial class AppPlatformSupportedBuildpackData : IUtf8JsonSerializable
    {
        ...
        internal static AppPlatformSupportedBuildpackData DeserializeAppPlatformSupportedBuildpackData(JsonElement element)
        {
            ...
            return new AppPlatformSupportedBuildpackData(id, name, type, systemData.Value, properties.Value);
        }
    }
}
