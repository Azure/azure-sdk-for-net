...
namespace Azure.ResourceManager.AppPlatform.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AppPlatformDeploymentResourceRequirements>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AppPlatformDeploymentResourceRequirements>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AppPlatformDeploymentResourceRequirements>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AppPlatformDeploymentResourceRequirements>)} interface");
            }
        ...
        string IPersistableModel<AppPlatformDeploymentResourceRequirements>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
