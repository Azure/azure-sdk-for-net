...
{
    public partial class AppPlatformDeploymentResourceRequirements : IUtf8JsonSerializable, IJsonModel<AppPlatformDeploymentResourceRequirements>, IPersistableModel<AppPlatformDeploymentResourceRequirements>
    {
        ...
        void IJsonModel<AppPlatformDeploymentResourceRequirements>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AppPlatformDeploymentResourceRequirements)} does not support '{format}' format.");
            }
