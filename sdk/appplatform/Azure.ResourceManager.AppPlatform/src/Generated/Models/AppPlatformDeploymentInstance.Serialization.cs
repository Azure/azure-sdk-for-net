...
namespace Azure.ResourceManager.AppPlatform.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AppPlatformDeploymentInstance>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AppPlatformDeploymentInstance>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AppPlatformDeploymentInstance>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<AppPlatformDeploymentInstance>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
