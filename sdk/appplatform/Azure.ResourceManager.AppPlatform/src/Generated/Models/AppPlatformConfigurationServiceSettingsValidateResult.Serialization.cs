...
namespace Azure.ResourceManager.AppPlatform.Models
{
    public partial class AppPlatformConfigurationServiceSettingsValidateResult : IUtf8JsonSerializable, IJsonModel<AppPlatformConfigurationServiceSettingsValidateResult>
    {
        ...
        AppPlatformConfigurationServiceSettingsValidateResult IJsonModel<AppPlatformConfigurationServiceSettingsValidateResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AppPlatformConfigurationServiceSettingsValidateResult)} does not support reading '{format}' format.");
            }
        ...
        internal static AppPlatformConfigurationServiceSettingsValidateResult DeserializeAppPlatformConfigurationServiceSettingsValidateResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("gitPropertyValidationResult"u8))
                {
                    ...
                    gitPropertyValidationResult = AppPlatformConfigurationServiceGitValidateResult.DeserializeAppPlatformConfigurationServiceGitValidateResult(property.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
        ...
        BinaryData IPersistableModel<AppPlatformConfigurationServiceSettingsValidateResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AppPlatformConfigurationServiceSettingsValidateResult)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        AppPlatformConfigurationServiceSettingsValidateResult IPersistableModel<AppPlatformConfigurationServiceSettingsValidateResult>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AppPlatformConfigurationServiceSettingsValidateResult)} does not support reading '{options.Format}' format.");
            }
        }
