...
{
    public partial class AppPlatformConfigurationServiceSettingsValidateResult : IUtf8JsonSerializable, IJsonModel<AppPlatformConfigurationServiceSettingsValidateResult>, IPersistableModel<AppPlatformConfigurationServiceSettingsValidateResult>
    {
        ...
        void IJsonModel<AppPlatformConfigurationServiceSettingsValidateResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AppPlatformConfigurationServiceSettingsValidateResult)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(GitPropertyValidationResult))
            {
                builder.Append("  gitPropertyValidationResult:");
                AppendChildObject(builder, GitPropertyValidationResult, options, 2);
            }
        ...
        string IPersistableModel<AppPlatformConfigurationServiceSettingsValidateResult>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
