...
namespace Azure.ResourceManager.AppPlatform.Models
{
    public partial class AppPlatformConfigurationServiceSettingsValidateResult : IUtf8JsonSerializable, IJsonModel<AppPlatformConfigurationServiceSettingsValidateResult>
    {
        ...
        void IJsonModel<AppPlatformConfigurationServiceSettingsValidateResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(AppPlatformConfigurationServiceSettingsValidateResult)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<AppPlatformConfigurationServiceSettingsValidateResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(AppPlatformConfigurationServiceSettingsValidateResult)} does not support '{options.Format}' format.");
            }
        }
