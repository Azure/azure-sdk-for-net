...
{
    internal partial class ServiceVnetAddons : IUtf8JsonSerializable, IJsonModel<ServiceVnetAddons>, IPersistableModel<ServiceVnetAddons>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(IsLogStreamPublicEndpoint))
            {
                builder.Append("  logStreamPublicEndpoint:");
                var boolValue = IsLogStreamPublicEndpoint.Value == true ? "true" : "false";
