...
namespace Azure.ResourceManager.AppPlatform.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AppPlatformSkuCapacity>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AppPlatformSkuCapacity>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AppPlatformSkuCapacity>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AppPlatformSkuCapacity>)} interface");
            }
        ...
        string IPersistableModel<AppPlatformSkuCapacity>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
