...
{
    public partial class IngressSettings : IUtf8JsonSerializable
    {
        ...
        internal static IngressSettings DeserializeIngressSettings(JsonElement element)
        {
            Optional<int> readTimeoutInSeconds = default;
            Optional<int> sendTimeoutInSeconds = default;
            Optional<SessionAffinity> sessionAffinity = default;
            Optional<int> sessionCookieMaxAge = default;
            Optional<BackendProtocol> backendProtocol = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("sessionAffinity"))
                {
                    ...
                    sessionAffinity = new SessionAffinity(property.Value.GetString());
                    continue;
                }
                ...
                if (property.NameEquals("backendProtocol"))
                {
                    ...
                    backendProtocol = new BackendProtocol(property.Value.GetString());
                    continue;
                }
            ...
            return new IngressSettings(Optional.ToNullable(readTimeoutInSeconds), Optional.ToNullable(sendTimeoutInSeconds), Optional.ToNullable(sessionAffinity), Optional.ToNullable(sessionCookieMaxAge), Optional.ToNullable(backendProtocol), clientAuth.Value);
        }
    }
}
