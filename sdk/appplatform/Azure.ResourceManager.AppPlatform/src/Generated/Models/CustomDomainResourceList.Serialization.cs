...
namespace Azure.ResourceManager.AppPlatform.Models
{
    ...
    {
        internal static CustomDomainResourceList DeserializeCustomDomainResourceList(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
