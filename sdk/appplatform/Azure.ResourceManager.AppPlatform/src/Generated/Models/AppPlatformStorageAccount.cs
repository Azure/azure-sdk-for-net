...
namespace Azure.ResourceManager.AppPlatform.Models
{
    ...
    public partial class AppPlatformStorageAccount : AppPlatformStorageProperties
    {
        ...
        internal AppPlatformStorageAccount(StorageType storageType, string accountName, string accountKey, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(storageType, serializedAdditionalRawData)
        {
            AccountName = accountName;
            AccountKey = accountKey;
