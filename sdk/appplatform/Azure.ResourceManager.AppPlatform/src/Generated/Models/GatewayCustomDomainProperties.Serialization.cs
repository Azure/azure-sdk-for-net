...
namespace Azure.ResourceManager.AppPlatform.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GatewayCustomDomainProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<GatewayCustomDomainProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<GatewayCustomDomainProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<GatewayCustomDomainProperties>)} interface");
            }
        ...
        string IPersistableModel<GatewayCustomDomainProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
