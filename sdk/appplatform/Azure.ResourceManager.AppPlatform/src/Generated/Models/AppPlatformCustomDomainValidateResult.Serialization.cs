...
{
    public partial class AppPlatformCustomDomainValidateResult : IUtf8JsonSerializable, IJsonModel<AppPlatformCustomDomainValidateResult>, IPersistableModel<AppPlatformCustomDomainValidateResult>
    {
        ...
        void IJsonModel<AppPlatformCustomDomainValidateResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AppPlatformCustomDomainValidateResult)} does not support '{format}' format.");
            }
