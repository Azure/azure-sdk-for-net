...
{
    public partial class TemporaryDisk : IUtf8JsonSerializable
    {
        ...
        internal static TemporaryDisk DeserializeTemporaryDisk(JsonElement element)
        {
            ...
            return new TemporaryDisk(Optional.ToNullable(sizeInGB), mountPath.Value);
        }
    }
}
