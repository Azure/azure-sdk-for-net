...
namespace Azure.ResourceManager.AppPlatform.Models
{
    ...
    public partial class BuildpackBindingLaunchProperties
    {
        ...
        internal BuildpackBindingLaunchProperties(IDictionary<string, string> properties, IDictionary<string, string> secrets, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
