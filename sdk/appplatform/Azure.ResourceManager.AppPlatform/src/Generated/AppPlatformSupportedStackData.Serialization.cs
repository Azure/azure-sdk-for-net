...
namespace Azure.ResourceManager.AppPlatform
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AppPlatformSupportedStackData>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<AppPlatformSupportedStackData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AppPlatformSupportedStackData)} does not support '{format}' format.");
            }
        ...
        internal static AppPlatformSupportedStackData DeserializeAppPlatformSupportedStackData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new AppPlatformSupportedStackData(id, name, type, systemData.Value, properties.Value, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<AppPlatformSupportedStackData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AppPlatformSupportedStackData)} does not support '{options.Format}' format.");
            }
        }
