...
namespace Azure.ResourceManager.AppPlatform
{
    ...
    public partial class AppPlatformCustomDomainData : ResourceData
    {
        ...
        internal AppPlatformCustomDomainData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, AppPlatformCustomDomainProperties properties, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData)
        {
