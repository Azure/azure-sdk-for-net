...
namespace Azure.ResourceManager.AppPlatform
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AppPlatformGatewayCustomDomainData>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<AppPlatformGatewayCustomDomainData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AppPlatformGatewayCustomDomainData)} does not support '{format}' format.");
            }
        ...
        internal static AppPlatformGatewayCustomDomainData DeserializeAppPlatformGatewayCustomDomainData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new AppPlatformGatewayCustomDomainData(id, name, type, systemData.Value, properties.Value, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<AppPlatformGatewayCustomDomainData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AppPlatformGatewayCustomDomainData)} does not support '{options.Format}' format.");
            }
        }
