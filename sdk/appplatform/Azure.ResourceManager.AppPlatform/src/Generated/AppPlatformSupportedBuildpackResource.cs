...
namespace Azure.ResourceManager.AppPlatform
{
    ...
    public partial class AppPlatformSupportedBuildpackResource : ArmResource
    {
        ...
        internal AppPlatformSupportedBuildpackResource(ArmClient client, AppPlatformSupportedBuildpackData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<AppPlatformSupportedBuildpackResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new AppPlatformSupportedBuildpackResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
