...
namespace Azure.ResourceManager.AppPlatform
{
    ...
    public partial class AppPlatformConfigurationServiceResource : ArmResource
    {
        ...
        internal AppPlatformConfigurationServiceResource(ArmClient client, AppPlatformConfigurationServiceData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<AppPlatformConfigurationServiceResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new AppPlatformConfigurationServiceResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
