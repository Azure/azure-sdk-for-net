...
namespace Azure.ResourceManager.AppPlatform
{
    ...
    public partial class AppPlatformGatewayRouteConfigData : ResourceData
    {
        ...
        internal AppPlatformGatewayRouteConfigData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, AppPlatformGatewayRouteConfigProperties properties, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
