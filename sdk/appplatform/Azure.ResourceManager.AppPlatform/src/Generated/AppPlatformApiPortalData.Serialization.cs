...
namespace Azure.ResourceManager.AppPlatform
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AppPlatformApiPortalData>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<AppPlatformApiPortalData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Properties))
            {
                ...
                writer.WriteObjectValue<AppPlatformApiPortalProperties>(Properties, options);
            }
