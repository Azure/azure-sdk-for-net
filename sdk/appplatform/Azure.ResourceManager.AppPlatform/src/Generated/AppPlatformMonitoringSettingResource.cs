...
namespace Azure.ResourceManager.AppPlatform
{
    ...
    public partial class AppPlatformMonitoringSettingResource : ArmResource
    {
        ...
        internal AppPlatformMonitoringSettingResource(ArmClient client, AppPlatformMonitoringSettingData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<AppPlatformMonitoringSettingResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new AppPlatformMonitoringSettingResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
