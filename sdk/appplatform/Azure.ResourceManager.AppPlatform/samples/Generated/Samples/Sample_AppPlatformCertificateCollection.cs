...
{
    public partial class Sample_AppPlatformCertificateCollection
    {
        // Certificates_Get
        ...
        public async Task Get_CertificatesGet()
        {
            ...
            AppPlatformCertificateResource result = await collection.GetAsync(certificateName);
        ...
        public async Task GetIfExists_CertificatesGet()
        {
            ...
            // invoke the operation
            string certificateName = "mycertificate";
            NullableResponse<AppPlatformCertificateResource> response = await collection.GetIfExistsAsync(certificateName);
            AppPlatformCertificateResource result = response.HasValue ? response.Value : null;
        ...
        {
            // Generated from example definition: specification/appplatform/resource-manager/Microsoft.AppPlatform/stable/2022-12-01/examples/Certificates_List.json
            ...
            await foreach (AppPlatformCertificateResource item in collection.GetAllAsync())
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                AppPlatformCertificateData resourceData = item.Data;
                // for demo we just print out the id
                Console.WriteLine($"Succeeded on id: {resourceData.Id}");
            }
