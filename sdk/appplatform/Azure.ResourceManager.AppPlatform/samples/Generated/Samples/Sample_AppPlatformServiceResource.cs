...
namespace Azure.ResourceManager.AppPlatform.Samples
{
    public partial class Sample_AppPlatformServiceResource
    {
        ...
        public async Task Delete_ServicesDelete()
        {
            ...
            // invoke the operation
            await appPlatformService.DeleteAsync(WaitUntil.Completed).ConfigureAwait(false);
...
["key1"] = "value1"
        ...
        public async Task DisableTestEndpoint_ServicesDisableTestEndpoint()
        {
            ...
            // invoke the operation
            await appPlatformService.DisableTestEndpointAsync().ConfigureAwait(false);
        ...
        public async Task Stop_ServicesStop()
        {
            ...
            // invoke the operation
            await appPlatformService.StopAsync(WaitUntil.Completed).ConfigureAwait(false);
        ...
        public async Task Start_ServicesStart()
        {
            ...
            // invoke the operation
            await appPlatformService.StartAsync(WaitUntil.Completed).ConfigureAwait(false);
