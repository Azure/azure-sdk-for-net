...
namespace Microsoft.Azure.Management.AppPlatform.Models
{
    ...
    /// </summary>
    public partial class SupportedRuntimeVersion1
    {
        /// <summary>
        /// Initializes a new instance of the SupportedRuntimeVersion1 class.
        /// </summary>
        public SupportedRuntimeVersion1()
        {
            CustomInit();
        }
        ...
        /// platform.</param>
        public SupportedRuntimeVersion1(string value = default(string), string platform = default(string), string version = default(string))
        {
            Value = value;
            Platform = platform;
            Version = version;
