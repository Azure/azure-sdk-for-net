...
namespace Microsoft.Azure.Management.AppPlatform
{
    ...
    internal partial class AppsOperations : IServiceOperations<AppPlatformManagementClient>, IAppsOperations
    {
        ...
        /// The cancellation token.
        /// </param>
        public async Task<AzureOperationResponse<AppResource>> SetActiveDeploymentsWithHttpMessagesAsync(string resourceGroupName, string serviceName, string appName, ActiveDeploymentCollection activeDeploymentCollection, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            // Send request
            AzureOperationResponse<AppResource> _response = await BeginSetActiveDeploymentsWithHttpMessagesAsync(resourceGroupName, serviceName, appName, activeDeploymentCollection, customHeaders, cancellationToken).ConfigureAwait(false);
            return await Client.GetPostOrDeleteOperationResultAsync(_response, customHeaders, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<AppResource>> BeginSetActiveDeploymentsWithHttpMessagesAsync(string resourceGroupName, string serviceName, string appName, ActiveDeploymentCollection activeDeploymentCollection, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (Client.ApiVersion == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "this.Client.ApiVersion");
            ...
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "activeDeploymentCollection");
            }
            // Tracing
            bool _shouldTrace = ServiceClientTracing.IsEnabled;
            string _invocationId = null;
            if (_shouldTrace)
            {
                ...
                tracingParameters.Add("serviceName", serviceName);
                tracingParameters.Add("appName", appName);
                tracingParameters.Add("activeDeploymentCollection", activeDeploymentCollection);
                tracingParameters.Add("cancellationToken", cancellationToken);
                ServiceClientTracing.Enter(_invocationId, this, "BeginSetActiveDeployments", tracingParameters);
            }
            // Construct URL
            var _baseUrl = Client.BaseUri.AbsoluteUri;
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AppPlatform/Spring/{serviceName}/apps/{appName}/setActiveDeployments").ToString();
            _url = _url.Replace("{subscriptionId}", System.Uri.EscapeDataString(Client.SubscriptionId));
            _url = _url.Replace("{resourceGroupName}", System.Uri.EscapeDataString(resourceGroupName));
            _url = _url.Replace("{serviceName}", System.Uri.EscapeDataString(serviceName));
            _url = _url.Replace("{appName}", System.Uri.EscapeDataString(appName));
            ...
            if(activeDeploymentCollection != null)
            {
                _requestContent = Rest.Serialization.SafeJsonConvert.SerializeObject(activeDeploymentCollection, Client.SerializationSettings);
                _httpRequest.Content = new StringContent(_requestContent, System.Text.Encoding.UTF8);
                _httpRequest.Content.Headers.ContentType =System.Net.Http.Headers.MediaTypeHeaderValue.Parse("application/json; charset=utf-8");
            }
            // Set Credentials
