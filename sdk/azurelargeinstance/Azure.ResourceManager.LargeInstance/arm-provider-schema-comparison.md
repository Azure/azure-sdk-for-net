# ARM provider schema comparison: Azure.ResourceManager.LargeInstance
...
| --- | --- | --- |
| `/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AzureLargeInstance/azureLargeInstances/{azureLargeInstanceName}` | `LargeInstance` | `AzureLargeInstance` |
| `/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AzureLargeInstance/azureLargeStorageInstances/{azureLargeStorageInstanceName}` | `LargeStorageInstance` | `AzureLargeStorageInstance` |
