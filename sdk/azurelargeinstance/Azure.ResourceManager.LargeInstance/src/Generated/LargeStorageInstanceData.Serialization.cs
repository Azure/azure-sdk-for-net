...
namespace Azure.ResourceManager.LargeInstance
{
    ...
    /// </summary>
    public partial class LargeStorageInstanceData : TrackedResourceData, IJsonModel<LargeStorageInstanceData>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        LargeStorageInstanceData IJsonModel<LargeStorageInstanceData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (LargeStorageInstanceData)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static LargeStorageInstanceData DeserializeLargeStorageInstanceData(JsonElement element, ModelReaderWriterOptions options)
        {
