...
namespace Azure.ResourceManager.LargeInstance
{
    ...
    /// properties)
    /// </summary>
    public partial class LargeInstanceData : TrackedResourceData, IJsonModel<LargeInstanceData>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<LargeInstanceData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        LargeInstanceData IJsonModel<LargeInstanceData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (LargeInstanceData)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static LargeInstanceData DeserializeLargeInstanceData(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("systemData"u8))
                {
                    ...
                    systemData = ModelReaderWriter.Read<SystemData>(new BinaryData(Encoding.UTF8.GetBytes(prop.Value.GetRawText())), ModelSerializationExtensions.WireOptions, AzureResourceManagerLargeInstanceContext.Default);
                    continue;
                }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<LargeInstanceData>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        LargeInstanceData IPersistableModel<LargeInstanceData>.Create(BinaryData data, ModelReaderWriterOptions options) => (LargeInstanceData)PersistableModelCreateCore(data, options);
        ...
        /// <param name="largeInstanceData"> The <see cref="LargeInstanceData"/> to serialize into <see cref="RequestContent"/>. </param>
        internal static RequestContent ToRequestContent(LargeInstanceData largeInstanceData)
        {
            if (largeInstanceData == null)
            {
                return null;
            }
        ...
        internal static LargeInstanceData FromResponse(Response response)
        {
            using JsonDocument document = JsonDocument.Parse(response.Content, ModelSerializationExtensions.JsonDocumentOptions);
            return DeserializeLargeInstanceData(document.RootElement, ModelSerializationExtensions.WireOptions);
        }
    }
}
