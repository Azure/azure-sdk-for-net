    ...
    public partial class LargeInstanceData : IUtf8JsonSerializable, IJsonModel<LargeInstanceData>
    {
        ...
        internal static LargeInstanceData DeserializeLargeInstanceData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
				...
				global::System.ClientModel.Primitives.ModelReaderWriter.Read<global::Azure.ResourceManager.Models.SystemData>(new global::System.BinaryData(global::System.Runtime.InteropServices.JsonMarshal.GetRawUtf8Value(property.Value).ToArray()), global::Azure.ResourceManager.LargeInstance.ModelSerializationExtensions.WireOptions, AzureResourceManagerLargeInstanceContext.Default)
#else
                ModelReaderWriter.Read<SystemData>(new BinaryData(Encoding.UTF8.GetBytes(property.Value.GetRawText())), ModelSerializationExtensions.WireOptions, AzureResourceManagerLargeInstanceContext.Default)
#endif
;
                    continue;
                }
