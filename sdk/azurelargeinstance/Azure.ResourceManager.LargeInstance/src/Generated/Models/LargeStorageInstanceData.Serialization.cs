...
{
    public partial class LargeStorageInstanceData : IUtf8JsonSerializable, IJsonModel<LargeStorageInstanceData>, IPersistableModel<LargeStorageInstanceData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(AzureLargeStorageInstanceUniqueIdentifier))
            {
                builder.Append("  azureLargeStorageInstanceUniqueIdentifier:");
                builder.AppendLine($" '{AzureLargeStorageInstanceUniqueIdentifier}'");
            }

            if (Optional.IsDefined(StorageProperties))
            {
                builder.Append("  storageProperties:");
                AppendChildObject(builder, StorageProperties, options, 2);
            }
