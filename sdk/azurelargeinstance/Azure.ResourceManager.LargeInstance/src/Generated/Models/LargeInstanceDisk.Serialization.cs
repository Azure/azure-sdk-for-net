...
{
    public partial class LargeInstanceDisk : IUtf8JsonSerializable, IJsonModel<LargeInstanceDisk>, IPersistableModel<LargeInstanceDisk>
    {
        ...
        internal static LargeInstanceDisk DeserializeLargeInstanceDisk(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new LargeInstanceDisk(name.Value, Optional.ToNullable(diskSizeGB), Optional.ToNullable(lun), serializedAdditionalRawData);
        }
