...
namespace Azure.ResourceManager.LargeInstance.Models
{
    ...
    public partial class LargeInstanceDisk : IJsonModel<LargeInstanceDisk>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        LargeInstanceDisk IJsonModel<LargeInstanceDisk>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual LargeInstanceDisk JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<LargeInstanceDisk>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static LargeInstanceDisk DeserializeLargeInstanceDisk(JsonElement element, ModelReaderWriterOptions options)
        {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<LargeInstanceDisk>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
