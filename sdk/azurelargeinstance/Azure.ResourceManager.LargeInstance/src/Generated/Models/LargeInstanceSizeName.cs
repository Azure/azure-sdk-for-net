...
{
    /// <summary> Enum of available model types (each of which have their own storage / memory sizes) for an Azure Large Instance type. See https://learn.microsoft.com/azure/sap/large-instances/hana-available-skus. </summary>
    public readonly partial struct LargeInstanceSizeName : IEquatable<LargeInstanceSizeName>
    {
        ...
        /// <summary> Converts a string to a <see cref="LargeInstanceSizeName"/>. </summary>
        /// <param name="value"> The value. </param>
        public static implicit operator LargeInstanceSizeName?(string value) => value == null ? null : new LargeInstanceSizeName(value);
