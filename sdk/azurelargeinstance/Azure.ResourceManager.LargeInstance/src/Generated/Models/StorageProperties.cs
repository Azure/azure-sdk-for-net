...
namespace Azure.ResourceManager.LargeInstance.Models
{
    ...
    public partial class StorageProperties
    {
        ...
        internal StorageProperties(ProvisioningState? provisioningState, string offeringType, string storageType, string generation, AzureLargeInstanceHardwareTypeNamesEnum? hardwareType, string workloadType, StorageBillingProperties storageBillingProperties)
        {
