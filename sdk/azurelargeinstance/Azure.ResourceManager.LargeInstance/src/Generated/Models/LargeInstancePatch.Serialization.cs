...
namespace Azure.ResourceManager.LargeInstance.Models
{
    public partial class LargeInstancePatch : IUtf8JsonSerializable, IJsonModel<LargeInstancePatch>
    {
        ...
        void IJsonModel<LargeInstancePatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(LargeInstancePatch)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<LargeInstancePatch>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(LargeInstancePatch)} does not support '{options.Format}' format.");
            }
        }
