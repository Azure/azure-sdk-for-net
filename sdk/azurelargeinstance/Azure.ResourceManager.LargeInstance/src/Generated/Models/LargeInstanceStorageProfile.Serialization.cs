...
{
    public partial class LargeInstanceStorageProfile : IUtf8JsonSerializable, IJsonModel<LargeInstanceStorageProfile>, IPersistableModel<LargeInstanceStorageProfile>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  nfsIpAddress:");
                builder.AppendLine($" '{NfsIPAddress}'");
            }

            if (Optional.IsCollectionDefined(OSDisks))
            {
                builder.Append("  osDisks:");
                builder.AppendLine(" [");
                foreach (var item in OSDisks)
                {
