...
{
    public partial class LargeInstanceHardwareProfile : IUtf8JsonSerializable, IJsonModel<LargeInstanceHardwareProfile>, IPersistableModel<LargeInstanceHardwareProfile>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  azureLargeInstanceSize:");
                builder.AppendLine($" '{AzureLargeInstanceSize.ToString()}'");
            }
