...
{
    public partial class LargeInstanceStorageBillingProperties : IUtf8JsonSerializable, IJsonModel<LargeInstanceStorageBillingProperties>, IPersistableModel<LargeInstanceStorageBillingProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(BillingMode))
            {
                builder.Append("  billingMode:");
                builder.AppendLine($" '{BillingMode}'");
            }
