...
namespace Azure.ResourceManager.LargeInstance.Models
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="AzureLargeStorageInstancePatch"/>. </summary>
        ...
        internal AzureLargeStorageInstancePatch(IDictionary<string, string> tags)
        {
            Tags = tags;
        }
