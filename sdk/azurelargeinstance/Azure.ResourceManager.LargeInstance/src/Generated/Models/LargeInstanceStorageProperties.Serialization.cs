...
{
    public partial class LargeInstanceStorageProperties : IUtf8JsonSerializable, IJsonModel<LargeInstanceStorageProperties>, IPersistableModel<LargeInstanceStorageProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(OfferingType))
            {
                ...
                builder.AppendLine($" '{OfferingType}'");
            }
            ...
            if (Optional.IsDefined(HardwareType))
            {
                ...
                builder.AppendLine($" '{HardwareType.ToString()}'");
            }
            ...
            if (Optional.IsDefined(StorageBillingProperties))
            {
                builder.Append("  storageBillingProperties:");
                AppendChildObject(builder, StorageBillingProperties, options, 2);
            }
