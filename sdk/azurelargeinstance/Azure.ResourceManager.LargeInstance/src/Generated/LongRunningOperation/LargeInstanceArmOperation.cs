...
namespace Azure.ResourceManager.LargeInstance
{
    internal partial class LargeInstanceArmOperation : ArmOperation
    {
        ...
        internal LargeInstanceArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
