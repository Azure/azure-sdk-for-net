...
{
    public partial class Sample_AzureLargeInstanceCollection
    {
        // List all Azure Large Instances in a resource group
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task GetAll_ListAllAzureLargeInstancesInAResourceGroup()
        {
            ...
            // get the collection of this AzureLargeInstanceResource
            AzureLargeInstanceCollection collection = resourceGroupResource.GetAzureLargeInstances();

            // invoke the operation and iterate over the result
            await foreach (AzureLargeInstanceResource item in collection.GetAllAsync())
            {
        ...
        public async Task Get_GetAnAzureLargeInstance()
        {
            ...
            AzureLargeInstanceResource result = await collection.GetAsync(azureLargeInstanceName);
        ...
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task Exists_GetAnAzureLargeInstance()
        {
            // Generated from example definition: specification/azurelargeinstance/resource-manager/Microsoft.AzureLargeInstance/preview/2023-07-20-preview/examples/AzureLargeInstance_Get.json
            // this example is just showing the usage of "AzureLargeInstance_Get" operation, for the dependent resources, they will have to be created separately.
        ...
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task GetIfExists_GetAnAzureLargeInstance()
        {
            // Generated from example definition: specification/azurelargeinstance/resource-manager/Microsoft.AzureLargeInstance/preview/2023-07-20-preview/examples/AzureLargeInstance_Get.json
            // this example is just showing the usage of "AzureLargeInstance_Get" operation, for the dependent resources, they will have to be created separately.
            ...
            // invoke the operation
            string azureLargeInstanceName = "myAzureLargeInstance";
            NullableResponse<AzureLargeInstanceResource> response = await collection.GetIfExistsAsync(azureLargeInstanceName);
            AzureLargeInstanceResource result = response.HasValue ? response.Value : null;
