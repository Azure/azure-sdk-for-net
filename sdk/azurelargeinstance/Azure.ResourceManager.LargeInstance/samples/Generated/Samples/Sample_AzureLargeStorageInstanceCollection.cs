...
{
    public partial class Sample_AzureLargeStorageInstanceCollection
    {
        // List all AzureLargeStorageInstances in a resource group
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task GetAll_ListAllAzureLargeStorageInstancesInAResourceGroup()
        {
            ...
            // get the collection of this AzureLargeStorageInstanceResource
            AzureLargeStorageInstanceCollection collection = resourceGroupResource.GetAzureLargeStorageInstances();

            // invoke the operation and iterate over the result
            await foreach (AzureLargeStorageInstanceResource item in collection.GetAllAsync())
            {
        ...
        public async Task Get_GetAnAzureLargeStorageStorageInstance()
        {
            ...
            AzureLargeStorageInstanceResource result = await collection.GetAsync(azureLargeStorageInstanceName);
        ...
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task Exists_GetAnAzureLargeStorageStorageInstance()
        {
            // Generated from example definition: specification/azurelargeinstance/resource-manager/Microsoft.AzureLargeInstance/preview/2023-07-20-preview/examples/AzureLargeStorageInstance_Get.json
            // this example is just showing the usage of "AzureLargeStorageInstance_Get" operation, for the dependent resources, they will have to be created separately.
        ...
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task GetIfExists_GetAnAzureLargeStorageStorageInstance()
        {
            // Generated from example definition: specification/azurelargeinstance/resource-manager/Microsoft.AzureLargeInstance/preview/2023-07-20-preview/examples/AzureLargeStorageInstance_Get.json
            // this example is just showing the usage of "AzureLargeStorageInstance_Get" operation, for the dependent resources, they will have to be created separately.
            ...
            // invoke the operation
            string azureLargeStorageInstanceName = "myAzureLargeStorageInstance";
            NullableResponse<AzureLargeStorageInstanceResource> response = await collection.GetIfExistsAsync(azureLargeStorageInstanceName);
            AzureLargeStorageInstanceResource result = response.HasValue ? response.Value : null;
