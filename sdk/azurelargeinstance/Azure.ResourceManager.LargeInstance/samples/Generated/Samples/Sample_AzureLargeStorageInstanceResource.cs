...
namespace Azure.ResourceManager.LargeInstance.Samples
{
    public partial class Sample_AzureLargeStorageInstanceResource
    {
        ...
        public async Task GetAzureLargeStorageInstances_AzureLargeStorageInstanceListBySubscription()
        {
        ...
        public async Task Update_AzureLargeStorageInstanceDeleteTag()
        {
            ...
            // invoke the operation
            AzureLargeStorageInstancePatch patch = new AzureLargeStorageInstancePatch();
            AzureLargeStorageInstanceResource result = await azureLargeStorageInstance.UpdateAsync(patch);
