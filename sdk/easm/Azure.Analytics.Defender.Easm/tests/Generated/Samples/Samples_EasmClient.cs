...
namespace Azure.Analytics.Defender.Easm.Samples
{
    public partial class Samples_EasmClient
    {
        ...
        public void Example_UpdateAssets_ShortVersion_Convenience()
        {
            ...
            AssetResource assetResource = new AsAssetResource(new AsAsset());
            Response<AssetResource> response = client.UpdateAssets("<filter>", assetResource);
        }
        ...
        public async System.Threading.Tasks.Task Example_UpdateAssets_ShortVersion_Convenience_Async()
        {
            ...
            AssetResource assetResource = new AsAssetResource(new AsAsset());
            Response<AssetResource> response = await client.UpdateAssetsAsync("<filter>", assetResource);
        }
...
{
source = "<source>",
firstSeen = "2022-05-10T14:57:31.2311892-04:00",
lastSeen = "2022-05-10T14:57:31.2311892-04:00",
count = 1234L,
reason = "<reason>",
}
},
...
recent = true,
                    ...
                    registrarUpdatedAt = new object[]
            {
null
            },
                    registrantContacts = new object[]
            {
null
            },
                    adminContacts = new object[]
            {
null
            },
                    technicalContacts = new object[]
            {
null
            },
                    registrarNames = new object[]
            {
null
            },
                    registrantNames = new object[]
            {
null
            },
                    adminNames = new object[]
            {
null
            },
                    technicalNames = new object[]
            {
null
            },
                    adminOrgs = new object[]
            {
null
            },
                    technicalOrgs = new object[]
            {
null
            },
                    registrantPhones = new object[]
            {
null
            },
                    adminPhones = new object[]
            {
null
            },
                    technicalPhones = new object[]
            {
null
            },
                    detailedFromWhoisAt = "2022-05-10T14:57:31.2311892-04:00",
                },
                kind = "as",
                name = "<name>",
                displayName = "<displayName>",
                uuid = "73f411fe-4f43-4b4b-9cbd-6828d8f4cf9a",
                createdDate = "2022-05-10T14:57:31.2311892-04:00",
                updatedDate = "2022-05-10T14:57:31.2311892-04:00",
                state = "candidate",
...
reason = "<reason>",
        ...
        public void Example_UpdateAssets_AllParameters_Convenience()
        {
            ...
            {
                Asn = 1234L,
                AsNames = {new ObservedString
{
Value = "<value>",
Sources = {new Source
{
SourceProperty = "<source>",
FirstSeen = DateTimeOffset.Parse("2022-05-10T14:57:31.2311892-04:00"),
LastSeen = DateTimeOffset.Parse("2022-05-10T14:57:31.2311892-04:00"),
Count = 1234L,
Reason = "<reason>",
}},
}},
...
Sources = {default},
                ...
                RegistrarUpdatedAt = { default },
                RegistrantContacts = { default },
                AdminContacts = { default },
                TechnicalContacts = { default },
                RegistrarNames = { default },
                RegistrantNames = { default },
                AdminNames = { default },
                TechnicalNames = { default },
                AdminOrgs = { default },
                TechnicalOrgs = { default },
                RegistrantPhones = { default },
                AdminPhones = { default },
                TechnicalPhones = { default },
                DetailedFromWhoisAt = DateTimeOffset.Parse("2022-05-10T14:57:31.2311892-04:00"),
            })
            {
                Name = "<name>",
                DisplayName = "<displayName>",
                Uuid = Guid.Parse("73f411fe-4f43-4b4b-9cbd-6828d8f4cf9a"),
                CreatedDate = DateTimeOffset.Parse("2022-05-10T14:57:31.2311892-04:00"),
                UpdatedDate = DateTimeOffset.Parse("2022-05-10T14:57:31.2311892-04:00"),
                State = AssetState.Candidate,
                ExternalId = "<externalId>",
                Labels = { "<labels>" },
                Wildcard = true,
                DiscoGroupName = "<discoGroupName>",
                AuditTrail = {new AuditTrailItem
{
Id = "<id>",
Name = "<name>",
DisplayName = "<displayName>",
Kind = AuditTrailItemKind.As,
Reason = "<reason>",
}},
                Reason = "<reason>",
            };
...
Reason = "<reason>",
        ...
        public void Example_CreateOrReplaceDataConnection_ShortVersion_Convenience()
        {
            ...
            DataConnection dataConnection = new LogAnalyticsDataConnection(new LogAnalyticsDataConnectionProperties());
            Response<DataConnection> response = client.CreateOrReplaceDataConnection("<dataConnectionName>", dataConnection);
        }
        ...
        public async System.Threading.Tasks.Task Example_CreateOrReplaceDataConnection_ShortVersion_Convenience_Async()
        {
            ...
            DataConnection dataConnection = new LogAnalyticsDataConnection(new LogAnalyticsDataConnectionProperties());
            Response<DataConnection> response = await client.CreateOrReplaceDataConnectionAsync("<dataConnectionName>", dataConnection);
        }
...
Name = "<name>",
        ...
        public void Example_CreateOrReplaceDiscoGroup_ShortVersion_Convenience()
        {
            ...
            DiscoGroup discoGroup = new DiscoGroup();
            Response<DiscoGroup> response = client.CreateOrReplaceDiscoGroup("<groupName>", discoGroup);
        }
        ...
        public async System.Threading.Tasks.Task Example_CreateOrReplaceDiscoGroup_ShortVersion_Convenience_Async()
        {
            ...
            DiscoGroup discoGroup = new DiscoGroup();
            Response<DiscoGroup> response = await client.CreateOrReplaceDiscoGroupAsync("<groupName>", discoGroup);
        }
...
null
                ...
                latestRun = new
                {
                    submittedDate = "2022-05-10T14:57:31.2311892-04:00",
                    startedDate = "2022-05-10T14:57:31.2311892-04:00",
                    completedDate = "2022-05-10T14:57:31.2311892-04:00",
                    tier = "<tier>",
                    state = "pending",
                    totalAssetsFoundCount = 1234L,
                    seeds = new object[]
            {
null
            },
...
Name = "<name>",
                ...
                Names = { "<names>" },
                Excludes = { default },
                LatestRun = new DiscoRunResult
                {
                    SubmittedDate = DateTimeOffset.Parse("2022-05-10T14:57:31.2311892-04:00"),
                    StartedDate = DateTimeOffset.Parse("2022-05-10T14:57:31.2311892-04:00"),
                    CompletedDate = DateTimeOffset.Parse("2022-05-10T14:57:31.2311892-04:00"),
                    Tier = "<tier>",
                    State = DiscoRunState.Pending,
                    TotalAssetsFoundCount = 1234L,
                    Seeds = { default },
                    Excludes = { default },
                    Names = { "<names>" },
...
"<filters>"
        ...
        public void Example_CreateOrReplaceSavedFilter_ShortVersion_Convenience()
        {
            ...
            Response<SavedFilter> response = client.CreateOrReplaceSavedFilter("<filterName>", savedFilter);
        }
        ...
        public async System.Threading.Tasks.Task Example_CreateOrReplaceSavedFilter_ShortVersion_Convenience_Async()
        {
            ...
            SavedFilter savedFilter = new SavedFilter();
            Response<SavedFilter> response = await client.CreateOrReplaceSavedFilterAsync("<filterName>", savedFilter);
        }
