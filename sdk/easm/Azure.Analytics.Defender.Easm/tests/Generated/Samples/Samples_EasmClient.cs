...
"name"
        ...
        public void Example_EasmClient_GetAssetsExport_AssetsGetAssetsExport_Convenience()
        {
            ...
            AssetsExportRequestContent body = new AssetsExportRequestContent("ThisisaFileName", new string[] { "asset", "name" });
        ...
        public void Example_EasmClient_GetDeltaSummary_AssetsGetDeltaSummary_Convenience()
        {
            ...
            DeltaSummaryRequestContent body = new DeltaSummaryRequestContent
            {
                PriorDays = 30,
                Date = "2024-03-17",
            };
...
"DOMAIN$$contoso.com"
        ...
        public void Example_EasmClient_GetAssetChainSummary_DiscoveryGroupsGetAssetChainSummary_Convenience()
        {
            ...
            AssetChainRequestContent body = new AssetChainRequestContent(AssetChainSource.ASSET, new string[] { "DOMAIN$$contoso.com" });
...
"Column3"
        ...
        public void Example_Policy_GetPolicy_PoliciesGetPolicy_Convenience()
        {
            ...
            Response<EasmPolicy> response = client.GetPolicy("ThisisaPolicy");
        }
        ...
        public async Task Example_Policy_GetPolicy_PoliciesGetPolicy_Convenience_Async()
        {
            ...
            Response<EasmPolicy> response = await client.GetPolicyAsync("ThisisaPolicy");
        }
        ...
        public void Example_Policy_CreateOrReplacePolicy_PoliciesCreateOrReplacePolicy_Convenience()
        {
            ...
            EasmPolicy body = new EasmPolicy("ThisisaFilter", PolicyAction.SetState, new ActionParametersContent
            {
                Value = "confirmed",
            })
            {
            ...
            Response<EasmPolicy> response = client.CreateOrReplacePolicy("ThisisaPolicy", body);
        }
        ...
        public async Task Example_Policy_CreateOrReplacePolicy_PoliciesCreateOrReplacePolicy_Convenience_Async()
        {
            ...
            Response<EasmPolicy> response = await client.CreateOrReplacePolicyAsync("ThisisaPolicy", body);
        }
        ...
        public void Example_EasmClient_GetDeltaDetails_AssetsGetDeltaDetails_Convenience()
        {
            ...
            DeltaDetailsRequestContent body = new DeltaDetailsRequestContent(DeltaDetailType.Added, GlobalAssetType.Domain)
            {
                PriorDays = 30,
                Date = "2024-03-17",
            };
        ...
        public void Example_Policy_GetPolicies_PoliciesListPolicy_Convenience()
        {
            ...
            foreach (EasmPolicy item in client.GetPolicies())
            {
            }
        }
        ...
        public async Task Example_Policy_GetPolicies_PoliciesListPolicy_Convenience_Async()
        {
            ...
            await foreach (EasmPolicy item in client.GetPoliciesAsync())
            {
            }
        }
    }
