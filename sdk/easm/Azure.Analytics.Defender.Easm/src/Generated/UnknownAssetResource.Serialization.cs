...
{
    internal partial class UnknownAssetResource : IUtf8JsonWriteable, IJsonModel<AssetResource>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<AssetResource>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static new UnknownAssetResource FromResponse(PipelineResponse response)
        {
