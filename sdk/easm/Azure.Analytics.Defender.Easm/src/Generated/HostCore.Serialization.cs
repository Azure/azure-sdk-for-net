...
{
    public partial class HostCore : IUtf8JsonWriteable, IJsonModel<HostCore>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<HostCore>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static HostCore FromResponse(PipelineResponse response)
        {
