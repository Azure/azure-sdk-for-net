...
{
    public partial class SubResourceIntegrityCheck : IUtf8JsonWriteable, IJsonModel<SubResourceIntegrityCheck>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<SubResourceIntegrityCheck>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static SubResourceIntegrityCheck FromResponse(PipelineResponse response)
        {
