...
namespace Azure.Analytics.Defender.Easm
{
    ...
    public partial class DiscoveryGroupData
    {
        ...
        internal DiscoveryGroupData(string name, string description, string tier, long? frequencyMilliseconds, IList<DiscoverySource> seeds, IList<string> names, IList<DiscoverySource> excludes, string templateId)
        {
            Name = name;
