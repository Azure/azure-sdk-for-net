...
namespace Azure.Analytics.Defender.Easm
{
    ...
    public partial class ReputationDetails
    {
        ...
        internal ReputationDetails(string listName, string threatType, bool? trusted, string cidr, DateTimeOffset? firstSeen, DateTimeOffset? lastSeen, DateTimeOffset? listUpdatedAt, bool? recent)
        {
            ListName = listName;
