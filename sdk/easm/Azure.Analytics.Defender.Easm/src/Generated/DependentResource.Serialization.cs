...
{
    public partial class DependentResource : IUtf8JsonWriteable, IJsonModel<DependentResource>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<DependentResource>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static DependentResource FromResponse(PipelineResponse response)
        {
