...
{
    public partial class SoaRecord : IUtf8JsonWriteable, IJsonModel<SoaRecord>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<SoaRecord>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static SoaRecord FromResponse(PipelineResponse response)
        {
