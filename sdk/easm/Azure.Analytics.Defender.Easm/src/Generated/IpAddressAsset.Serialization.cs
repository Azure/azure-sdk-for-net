...
{
    public partial class IpAddressAsset : IUtf8JsonWriteable, IJsonModel<IpAddressAsset>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<IpAddressAsset>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static new IpAddressAsset FromResponse(PipelineResponse response)
        {
