...
{
    public partial class LogAnalyticsDataConnectionProperties : IUtf8JsonWriteable, IJsonModel<LogAnalyticsDataConnectionProperties>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<LogAnalyticsDataConnectionProperties>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<LogAnalyticsDataConnectionProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(LogAnalyticsDataConnectionProperties)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<LogAnalyticsDataConnectionProperties>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(LogAnalyticsDataConnectionProperties)} does not support '{options.Format}' format.");
            }
        }
        ...
        internal static new LogAnalyticsDataConnectionProperties FromResponse(PipelineResponse response)
        {
