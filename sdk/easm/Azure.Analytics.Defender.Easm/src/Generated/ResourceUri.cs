...
namespace Azure.Analytics.Defender.Easm
{
    ...
    public partial class ResourceUri
    {
        ...
        internal ResourceUri(Uri url, IReadOnlyList<DependentResource> resources, DateTimeOffset? firstSeen, DateTimeOffset? lastSeen, long? count, bool? recent, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Url = url;
            Resources = resources;
            FirstSeen = firstSeen;
