...
{
    public partial class AssetSummaryResult : IUtf8JsonWriteable, IJsonModel<AssetSummaryResult>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<AssetSummaryResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static AssetSummaryResult FromResponse(PipelineResponse response)
        {
