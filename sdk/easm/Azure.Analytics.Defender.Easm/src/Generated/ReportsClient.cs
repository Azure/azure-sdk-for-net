...
namespace Azure.Analytics.Defender.Easm
{
    ...
    /// <summary> The Reports sub-client. </summary>
    public partial class ReportsClient
    {
        ...
        internal ReportsClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, TokenCredential tokenCredential, Uri endpoint, string subscriptionId, string resourceGroupName, string workspaceName, string apiVersion)
        {
        ...
        public virtual async Task<Response<ReportBillableAssetSummaryResponse>> GetBillableAsync(CancellationToken cancellationToken = default)
        {
            RequestContext context = FromCancellationToken(cancellationToken);
            Response response = await GetBillableAsync(context).ConfigureAwait(false);
            return Response.FromValue(ReportBillableAssetSummaryResponse.FromResponse(response), response);
        }

        /// <summary> Get billable assets summary for the workspace. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <include file="Docs/Reports.xml" path="doc/members/member[@name='GetBillable(CancellationToken)']/*" />
        public virtual Response<ReportBillableAssetSummaryResponse> GetBillable(CancellationToken cancellationToken = default)
        {
            RequestContext context = FromCancellationToken(cancellationToken);
...
#pragma warning restore AZC0002 // DO ensure all service methods, both asynchronous and synchronous, take an optional CancellationToken parameter called cancellationToken.
        ...
        public virtual async Task<Response<ReportAssetSnapshotResponse>> GetSnapshotAsync(ReportAssetSnapshotRequest reportAssetSnapshotRequest, CancellationToken cancellationToken = default)
        {
            ...
            return Response.FromValue(ReportAssetSnapshotResponse.FromResponse(response), response);
        }
        ...
        public virtual Response<ReportAssetSnapshotResponse> GetSnapshot(ReportAssetSnapshotRequest reportAssetSnapshotRequest, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(reportAssetSnapshotRequest, nameof(reportAssetSnapshotRequest));
        ...
        public virtual async Task<Response<ReportAssetSummaryResponse>> GetSummaryAsync(ReportAssetSummaryRequest reportAssetSummaryRequest, CancellationToken cancellationToken = default)
        {
            ...
            return Response.FromValue(ReportAssetSummaryResponse.FromResponse(response), response);
        }
        ...
        public virtual Response<ReportAssetSummaryResponse> GetSummary(ReportAssetSummaryRequest reportAssetSummaryRequest, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(reportAssetSummaryRequest, nameof(reportAssetSummaryRequest));
