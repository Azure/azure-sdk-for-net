...
{
    public partial class ScanMetadata : IUtf8JsonWriteable, IJsonModel<ScanMetadata>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ScanMetadata>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static ScanMetadata FromResponse(PipelineResponse response)
        {
