...
namespace Azure.Analytics.Defender.Easm
{
    ...
    public partial class DomainAssetResource : AssetResource
    {
        ...
        public DomainAssetResource(DomainAsset asset)
        {
        ...
        /// <param name="asset"> asset. </param>
        internal DomainAssetResource(string kind, string id, string name, string displayName, Guid? uuid, DateTimeOffset? createdDate, DateTimeOffset? updatedDate, AssetState? state, string externalId, IList<string> labels, bool? wildcard, string discoGroupName, IList<AuditTrailItem> auditTrail, string reason, DomainAsset asset) : base(kind, id, name, displayName, uuid, createdDate, updatedDate, state, externalId, labels, wildcard, discoGroupName, auditTrail, reason)
        {
            Asset = asset;
        }

        /// <summary> asset. </summary>
        public DomainAsset Asset { get; set; }
    }
}
