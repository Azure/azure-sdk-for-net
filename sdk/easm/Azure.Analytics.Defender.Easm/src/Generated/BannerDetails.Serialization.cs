...
{
    public partial class BannerDetails : IUtf8JsonWriteable, IJsonModel<BannerDetails>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<BannerDetails>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static BannerDetails FromResponse(PipelineResponse response)
        {
