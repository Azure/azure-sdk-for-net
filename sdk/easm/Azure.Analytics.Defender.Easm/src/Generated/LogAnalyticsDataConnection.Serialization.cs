...
{
    public partial class LogAnalyticsDataConnection : IUtf8JsonWriteable, IJsonModel<LogAnalyticsDataConnection>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<LogAnalyticsDataConnection>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static new LogAnalyticsDataConnection FromResponse(PipelineResponse response)
        {
