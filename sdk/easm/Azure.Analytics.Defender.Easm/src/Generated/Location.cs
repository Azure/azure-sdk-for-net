...
namespace Azure.Analytics.Defender.Easm
{
    ...
    public partial class Location
    {
        ...
        internal Location(string countryCode, string countryName, string region, string regionName, string city, int? areaCode, string postalCode, float? latitude, float? longitude, int? dmaCode, int? metroCodeId, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
