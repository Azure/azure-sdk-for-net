...
namespace Azure.Analytics.Defender.Easm
{
    ...
    public partial class Policy
    {
        ...
        public Policy(string filterName, PolicyAction action, ActionParameters actionParameters)
        {
        ...
        internal Policy(string id, string name, string displayName, string description, string filterName, PolicyAction action, long? updatedAssetsCount, string user, DateTimeOffset? createdDate, DateTimeOffset? updatedDate, ActionParameters actionParameters, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Name = name;
        ...
        /// <summary> Initializes a new instance of <see cref="Policy"/> for deserialization. </summary>
        internal Policy()
        {
        }
