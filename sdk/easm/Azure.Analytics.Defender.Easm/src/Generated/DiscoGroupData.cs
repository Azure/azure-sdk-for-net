...
namespace Azure.Analytics.Defender.Easm
{
    ...
    public partial class DiscoGroupData
    {
        ...
        internal DiscoGroupData(string name, string description, string tier, long? frequencyMilliseconds, IList<DiscoSource> seeds, IList<string> names, IList<DiscoSource> excludes, string templateId, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
