...
{
    public partial class SslCertAsset : IUtf8JsonWriteable, IJsonModel<SslCertAsset>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<SslCertAsset>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static new SslCertAsset FromResponse(PipelineResponse response)
        {
