...
{
    public partial class DiscoveryRunResult : IUtf8JsonWriteable, IJsonModel<DiscoveryRunResult>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<DiscoveryRunResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static DiscoveryRunResult FromResponse(PipelineResponse response)
        {
