...
namespace Azure.Analytics.Defender.Easm
{
    ...
    {
        internal static DiscoveryRunResult DeserializeDiscoveryRunResult(JsonElement element)
        {
            ...
            return new DiscoveryRunResult(Optional.ToNullable(submittedDate), Optional.ToNullable(startedDate), Optional.ToNullable(completedDate), tier.Value, Optional.ToNullable(state), Optional.ToNullable(totalAssetsFoundCount), Optional.ToList(seeds), Optional.ToList(excludes), Optional.ToList(names));
        }
