...
{
    public partial class AzureDataExplorerDataConnectionPayload : IUtf8JsonWriteable, IJsonModel<AzureDataExplorerDataConnectionPayload>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureDataExplorerDataConnectionPayload>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static new AzureDataExplorerDataConnectionPayload FromResponse(PipelineResponse response)
        {
