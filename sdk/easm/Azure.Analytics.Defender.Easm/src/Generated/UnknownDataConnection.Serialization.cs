...
{
    internal partial class UnknownDataConnection : IUtf8JsonWriteable, IJsonModel<DataConnection>
    {
        ...
        internal static new UnknownDataConnection FromResponse(PipelineResponse response)
        {
