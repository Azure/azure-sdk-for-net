...
{
    public partial class CookieDetails : IUtf8JsonWriteable, IJsonModel<CookieDetails>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<CookieDetails>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static CookieDetails FromResponse(PipelineResponse response)
        {
