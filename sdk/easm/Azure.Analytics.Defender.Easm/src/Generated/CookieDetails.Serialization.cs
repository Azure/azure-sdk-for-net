...
namespace Azure.Analytics.Defender.Easm
{
    ...
    {
        internal static CookieDetails DeserializeCookieDetails(JsonElement element)
        {
            ...
            return new CookieDetails(cookieName.Value, cookieDomain.Value, Optional.ToNullable(firstSeen), Optional.ToNullable(lastSeen), Optional.ToNullable(count), Optional.ToNullable(recent), Optional.ToNullable(cookieExpiryDate));
        }
