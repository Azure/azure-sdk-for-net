...
{
    public partial class SslServerConfig : IUtf8JsonWriteable, IJsonModel<SslServerConfig>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<SslServerConfig>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static SslServerConfig FromResponse(PipelineResponse response)
        {
