...
{
    public partial class DiscoveryGroupPayload : IUtf8JsonWriteable, IJsonModel<DiscoveryGroupPayload>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<DiscoveryGroupPayload>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static DiscoveryGroupPayload FromResponse(PipelineResponse response)
        {
