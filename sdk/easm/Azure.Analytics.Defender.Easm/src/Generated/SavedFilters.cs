...
namespace Azure.Analytics.Defender.Easm
{
    ...
    /// <summary> The SavedFilters sub-client. </summary>
    public partial class SavedFilters
    {
        ...
        public virtual async Task<Response<SavedFilterPageResponse>> GetSavedFiltersAsync(string filter = null, int? skip = null, int? maxpagesize = null, CancellationToken cancellationToken = default)
        {
            RequestContext context = FromCancellationToken(cancellationToken);
            Response response = await GetSavedFiltersAsync(filter, skip, maxpagesize, context).ConfigureAwait(false);
            return Response.FromValue(SavedFilterPageResponse.FromResponse(response), response);
        }
        ...
        public virtual Response<SavedFilterPageResponse> GetSavedFilters(string filter = null, int? skip = null, int? maxpagesize = null, CancellationToken cancellationToken = default)
        {
            RequestContext context = FromCancellationToken(cancellationToken);
        ...
        {
            using var scope = ClientDiagnostics.CreateScope("SavedFilters.GetSavedFilters");
            scope.Start();
            try
            {
        ...
        /// <exception cref="ArgumentException"> <paramref name="filterName"/> is an empty string, and was expected to be non-empty. </exception>
        /// <include file="Docs/SavedFilters.xml" path="doc/members/member[@name='PutAsync(string,SavedFilterData,CancellationToken)']/*" />
        public virtual async Task<Response<SavedFilter>> PutAsync(string filterName, SavedFilterData savedFilterData, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(filterName, nameof(filterName));
            Argument.AssertNotNull(savedFilterData, nameof(savedFilterData));

            RequestContext context = FromCancellationToken(cancellationToken);
            Response response = await PutAsync(filterName, savedFilterData.ToRequestContent(), context).ConfigureAwait(false);
            return Response.FromValue(SavedFilter.FromResponse(response), response);
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="filterName"/> or <paramref name="savedFilterData"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="filterName"/> is an empty string, and was expected to be non-empty. </exception>
        /// <include file="Docs/SavedFilters.xml" path="doc/members/member[@name='Put(string,SavedFilterData,CancellationToken)']/*" />
        public virtual Response<SavedFilter> Put(string filterName, SavedFilterData savedFilterData, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(filterName, nameof(filterName));
            Argument.AssertNotNull(savedFilterData, nameof(savedFilterData));

            RequestContext context = FromCancellationToken(cancellationToken);
            Response response = Put(filterName, savedFilterData.ToRequestContent(), context);
            return Response.FromValue(SavedFilter.FromResponse(response), response);
        }
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="PutAsync(string,SavedFilterData,CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/SavedFilters.xml" path="doc/members/member[@name='PutAsync(string,RequestContent,RequestContext)']/*" />
        public virtual async Task<Response> PutAsync(string filterName, RequestContent content, RequestContext context = null)
        {
            Argument.AssertNotNullOrEmpty(filterName, nameof(filterName));
            Argument.AssertNotNull(content, nameof(content));

            using var scope = ClientDiagnostics.CreateScope("SavedFilters.Put");
            scope.Start();
            try
            {
                using HttpMessage message = CreatePutRequest(filterName, content, context);
                return await _pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
            }
            catch (Exception e)
            {
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="Put(string,SavedFilterData,CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/SavedFilters.xml" path="doc/members/member[@name='Put(string,RequestContent,RequestContext)']/*" />
        public virtual Response Put(string filterName, RequestContent content, RequestContext context = null)
        {
            Argument.AssertNotNullOrEmpty(filterName, nameof(filterName));
            Argument.AssertNotNull(content, nameof(content));
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/SavedFilters.xml" path="doc/members/member[@name='DeleteAsync(string,RequestContext)']/*" />
        public virtual async Task<Response> DeleteAsync(string filterName, RequestContext context = null)
        {
            Argument.AssertNotNullOrEmpty(filterName, nameof(filterName));

            using var scope = ClientDiagnostics.CreateScope("SavedFilters.Delete");
            scope.Start();
            try
            {
                using HttpMessage message = CreateDeleteRequest(filterName, context);
                return await _pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
            }
            catch (Exception e)
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/SavedFilters.xml" path="doc/members/member[@name='Delete(string,RequestContext)']/*" />
        public virtual Response Delete(string filterName, RequestContext context = null)
        {
            Argument.AssertNotNullOrEmpty(filterName, nameof(filterName));
        ...
        internal HttpMessage CreatePutRequest(string filterName, RequestContent content, RequestContext context)
        {
            var message = _pipeline.CreateMessage(context, ResponseClassifier200);
            var request = message.Request;
        ...
        internal HttpMessage CreateDeleteRequest(string filterName, RequestContext context)
        {
