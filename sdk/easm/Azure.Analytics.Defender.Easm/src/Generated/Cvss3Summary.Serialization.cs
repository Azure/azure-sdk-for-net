...
{
    public partial class Cvss3Summary : IUtf8JsonWriteable, IJsonModel<Cvss3Summary>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<Cvss3Summary>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static Cvss3Summary FromResponse(PipelineResponse response)
        {
