...
{
    internal partial class EasmClientGetPoliciesCollectionResult : Pageable<BinaryData>
    {
        ...
        /// <summary> Initializes a new instance of EasmClientGetPoliciesCollectionResult, which is used to iterate over the pages of a collection. </summary>
        ...
        public EasmClientGetPoliciesCollectionResult(EasmClient client, string filter, int? skip, int? maxpagesize, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _filter = filter;
            _skip = skip;
        ...
        /// <summary> Gets the pages of EasmClientGetPoliciesCollectionResult as an enumerable collection. </summary>
