...
namespace Azure.Analytics.Defender.Easm
{
    ...
    public partial class HostAssetResource : AssetResource
    {
        ...
        public HostAssetResource(HostAsset asset)
        {
        ...
        /// <param name="asset"> asset. </param>
        internal HostAssetResource(string kind, string id, string name, string displayName, Guid? uuid, DateTimeOffset? createdDate, DateTimeOffset? updatedDate, AssetState? state, string externalId, IList<string> labels, bool? wildcard, string discoGroupName, IList<AuditTrailItem> auditTrail, string reason, HostAsset asset) : base(kind, id, name, displayName, uuid, createdDate, updatedDate, state, externalId, labels, wildcard, discoGroupName, auditTrail, reason)
        {
            Asset = asset;
        }

        /// <summary> asset. </summary>
        public HostAsset Asset { get; set; }
    }
}
