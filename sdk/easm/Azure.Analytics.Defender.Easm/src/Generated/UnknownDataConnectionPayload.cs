...
namespace Azure.Analytics.Defender.Easm
{
    ...
    internal partial class UnknownDataConnectionPayload : DataConnectionPayload
    {
        ...
        internal UnknownDataConnectionPayload(string name, DataConnectionContent? content, DataConnectionFrequency? frequency, int? frequencyOffset, string kind, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(name, content, frequency, frequencyOffset, kind, serializedAdditionalRawData)
        {
        }
