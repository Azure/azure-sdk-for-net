...
{
    public partial class PageAsset : IUtf8JsonWriteable, IJsonModel<PageAsset>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<PageAsset>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static new PageAsset FromResponse(PipelineResponse response)
        {
