...
namespace Azure.Analytics.Defender.Easm
{
    ...
    {
        public static void AppendQueryDelimited<T>(this RawRequestUriBuilder builder, string name, IEnumerable<T> value, string delimiter, SerializationFormat format = global::Azure.Analytics.Defender.Easm.SerializationFormat.Default, bool escape = true)
        {
            delimiter ??= ",";
            IEnumerable<string> stringValues = value.Select(v => global::Azure.Analytics.Defender.Easm.TypeFormatters.ConvertToString(v, format));
