...
namespace Azure.Analytics.Defender.Easm
{
    ...
    {
        internal static ReputationDetails DeserializeReputationDetails(JsonElement element)
        {
            ...
            return new ReputationDetails(listName.Value, threatType.Value, Optional.ToNullable(trusted), cidr.Value, Optional.ToNullable(firstSeen), Optional.ToNullable(lastSeen), Optional.ToNullable(listUpdatedAt), Optional.ToNullable(recent));
        }
