...
{
    public partial class ReputationDetails : IUtf8JsonWriteable, IJsonModel<ReputationDetails>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ReputationDetails>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static ReputationDetails FromResponse(PipelineResponse response)
        {
