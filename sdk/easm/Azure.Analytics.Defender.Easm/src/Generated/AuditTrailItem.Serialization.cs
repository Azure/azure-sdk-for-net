...
{
    public partial class AuditTrailItem : IUtf8JsonWriteable, IJsonModel<AuditTrailItem>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<AuditTrailItem>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static AuditTrailItem FromResponse(PipelineResponse response)
        {
