...
{
    public partial class Attribute : IUtf8JsonSerializable
    {
        ...
        internal static Attribute DeserializeAttribute(JsonElement element)
        {
            ...
            return new Attribute(attributeType.Value, attributeValue.Value, Optional.ToList(sources), Optional.ToNullable(firstSeen), Optional.ToNullable(lastSeen), Optional.ToNullable(count), Optional.ToNullable(recent));
        }
