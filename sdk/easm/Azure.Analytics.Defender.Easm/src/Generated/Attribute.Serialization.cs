...
{
    public partial class Attribute : IUtf8JsonSerializable, IJsonModel<Attribute>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<Attribute>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<Attribute>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<Attribute>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(Attribute)} does not support '{format}' format.");
            }
        ...
        Attribute IJsonModel<Attribute>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<Attribute>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static Attribute DeserializeAttribute(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            Optional<string> attributeType = default;
            ...
            return new Attribute(attributeType.Value, attributeValue.Value, Optional.ToList(sources), Optional.ToNullable(firstSeen), Optional.ToNullable(lastSeen), Optional.ToNullable(count), Optional.ToNullable(recent), serializedAdditionalRawData);
        }

        BinaryData IPersistableModel<Attribute>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<Attribute>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(Attribute)} does not support '{options.Format}' format.");
            }
        }

        Attribute IPersistableModel<Attribute>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<Attribute>)this).GetFormatFromOptions(options) : options.Format;
        ...
        internal static Attribute FromResponse(Response response)
        {
            using var document = JsonDocument.Parse(response.Content);
            return DeserializeAttribute(document.RootElement);
        }
