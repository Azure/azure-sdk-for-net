...
{
    public partial class ContactAssetResource : IUtf8JsonWriteable, IJsonModel<ContactAssetResource>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContactAssetResource>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static new ContactAssetResource FromResponse(PipelineResponse response)
        {
