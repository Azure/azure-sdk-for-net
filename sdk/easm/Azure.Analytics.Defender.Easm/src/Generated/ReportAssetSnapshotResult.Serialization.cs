...
{
    public partial class ReportAssetSnapshotResult : IUtf8JsonWriteable, IJsonModel<ReportAssetSnapshotResult>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ReportAssetSnapshotResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ReportAssetSnapshotResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ReportAssetSnapshotResult)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ReportAssetSnapshotResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ReportAssetSnapshotResult)} does not support '{options.Format}' format.");
            }
        }
        ...
        internal static ReportAssetSnapshotResult FromResponse(PipelineResponse response)
        {
