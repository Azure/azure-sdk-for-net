...
{
    internal partial class EasmClientGetPolicyAsyncCollectionResultOfT : AsyncPageable<EasmPolicy>
    {
        ...
        /// <summary> Initializes a new instance of EasmClientGetPolicyAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public EasmClientGetPolicyAsyncCollectionResultOfT(EasmClient client, string filter, int? skip, int? maxpagesize, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _filter = filter;
            _skip = skip;
        ...
        /// <summary> Gets the pages of EasmClientGetPolicyAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of EasmClientGetPolicyAsyncCollectionResultOfT as an enumerable collection. </returns>
