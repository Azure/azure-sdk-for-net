...
{
    public partial class AttributeDetails : IUtf8JsonWriteable, IJsonModel<AttributeDetails>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<AttributeDetails>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static AttributeDetails FromResponse(PipelineResponse response)
        {
