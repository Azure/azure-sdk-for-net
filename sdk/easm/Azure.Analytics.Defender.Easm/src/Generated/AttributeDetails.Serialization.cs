...
namespace Azure.Analytics.Defender.Easm
{
    ...
    {
        internal static AttributeDetails DeserializeAttributeDetails(JsonElement element)
        {
            ...
            return new AttributeDetails(attributeType.Value, attributeValue.Value, Optional.ToList(sources), Optional.ToNullable(firstSeen), Optional.ToNullable(lastSeen), Optional.ToNullable(count), Optional.ToNullable(recent));
        }
