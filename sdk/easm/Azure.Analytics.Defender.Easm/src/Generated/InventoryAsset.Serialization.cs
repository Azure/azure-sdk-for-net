...
{
    public partial class InventoryAsset : IUtf8JsonWriteable, IJsonModel<InventoryAsset>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<InventoryAsset>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static InventoryAsset FromResponse(PipelineResponse response)
        {
