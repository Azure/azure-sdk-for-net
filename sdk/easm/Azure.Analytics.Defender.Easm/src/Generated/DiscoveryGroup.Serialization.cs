...
{
    public partial class DiscoveryGroup : IUtf8JsonWriteable, IJsonModel<DiscoveryGroup>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<DiscoveryGroup>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static DiscoveryGroup FromResponse(PipelineResponse response)
        {
