...
{
    public partial class ReportAssetSnapshotPayload : IUtf8JsonWriteable, IJsonModel<ReportAssetSnapshotPayload>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ReportAssetSnapshotPayload>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static ReportAssetSnapshotPayload FromResponse(PipelineResponse response)
        {
