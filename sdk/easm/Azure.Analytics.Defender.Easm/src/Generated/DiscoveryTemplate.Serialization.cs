...
namespace Azure.Analytics.Defender.Easm
{
    ...
    {
        internal static DiscoveryTemplate DeserializeDiscoveryTemplate(JsonElement element)
        {
            ...
            return new DiscoveryTemplate(id, name.Value, displayName.Value, industry.Value, region.Value, countryCode.Value, stateCode.Value, city.Value, Optional.ToList(seeds), Optional.ToList(names));
        }
