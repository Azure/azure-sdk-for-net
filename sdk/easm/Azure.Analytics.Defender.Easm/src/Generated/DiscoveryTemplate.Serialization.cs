...
{
    public partial class DiscoveryTemplate : IUtf8JsonWriteable, IJsonModel<DiscoveryTemplate>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<DiscoveryTemplate>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static DiscoveryTemplate FromResponse(PipelineResponse response)
        {
