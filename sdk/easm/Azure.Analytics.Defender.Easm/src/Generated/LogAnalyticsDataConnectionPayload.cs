...
namespace Azure.Analytics.Defender.Easm
{
    ...
    public partial class LogAnalyticsDataConnectionPayload : DataConnectionPayload
    {
        ...
        /// <param name="properties"> properties. </param>
        internal LogAnalyticsDataConnectionPayload(string name, DataConnectionContent? content, DataConnectionFrequency? frequency, int? frequencyOffset, string kind, IDictionary<string, BinaryData> serializedAdditionalRawData, LogAnalyticsDataConnectionProperties properties) : base(name, content, frequency, frequencyOffset, kind, serializedAdditionalRawData)
        {
            Properties = properties;
        }
