...
{
    public partial class DomainAsset : IUtf8JsonWriteable, IJsonModel<DomainAsset>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<DomainAsset>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static DomainAsset FromResponse(PipelineResponse response)
        {
