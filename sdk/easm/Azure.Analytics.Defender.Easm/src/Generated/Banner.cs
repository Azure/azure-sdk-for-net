...
namespace Azure.Analytics.Defender.Easm
{
    ...
    public partial class Banner
    {
        ...
        internal Banner(int? port, string bannerProperty, DateTimeOffset? firstSeen, DateTimeOffset? lastSeen, long? count, string scanType, string bannerMetadata, bool? recent, string sha256, IReadOnlyList<Source> sources, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Port = port;
