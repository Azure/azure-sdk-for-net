...
{
    public partial class SavedFilterPayload : IUtf8JsonWriteable, IJsonModel<SavedFilterPayload>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<SavedFilterPayload>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static SavedFilterPayload FromResponse(PipelineResponse response)
        {
