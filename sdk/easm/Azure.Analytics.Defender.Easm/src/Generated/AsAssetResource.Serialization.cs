...
{
    public partial class AsAssetResource : IUtf8JsonWriteable, IJsonModel<AsAssetResource>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<AsAssetResource>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static new AsAssetResource FromResponse(PipelineResponse response)
        {
