...
{
    public partial class GuidPair : IUtf8JsonWriteable, IJsonModel<GuidPair>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<GuidPair>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static GuidPair FromResponse(PipelineResponse response)
        {
