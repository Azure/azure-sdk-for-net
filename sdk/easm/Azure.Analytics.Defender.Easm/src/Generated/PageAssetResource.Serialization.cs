...
namespace Azure.Analytics.Defender.Easm
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PageAssetResource>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            ((IJsonModel<PageAsset>)Asset).Write(writer, options);
        }
        ...
        internal static PageAssetResource DeserializePageAssetResource(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    asset = ModelSerializationExtensions.JsonDeserialize<PageAsset>(property.Value);
                    continue;
                }
