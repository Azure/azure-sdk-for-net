...
{
    public partial class PageAssetResource : IUtf8JsonWriteable, IJsonModel<PageAssetResource>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<PageAssetResource>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static new PageAssetResource FromResponse(PipelineResponse response)
        {
