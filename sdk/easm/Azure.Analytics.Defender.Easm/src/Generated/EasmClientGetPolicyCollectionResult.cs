...
{
    internal partial class EasmClientGetPolicyCollectionResult : Pageable<BinaryData>
    {
        ...
        /// <summary> Initializes a new instance of EasmClientGetPolicyCollectionResult, which is used to iterate over the pages of a collection. </summary>
        ...
        public EasmClientGetPolicyCollectionResult(EasmClient client, string filter, int? skip, int? maxpagesize, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _filter = filter;
            _skip = skip;
        ...
        /// <summary> Gets the pages of EasmClientGetPolicyCollectionResult as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of EasmClientGetPolicyCollectionResult as an enumerable collection. </returns>
