...
namespace Azure.Analytics.Defender.Easm
{
    ...
    {
        internal static SourceDetails DeserializeSourceDetails(JsonElement element)
        {
            ...
            return new SourceDetails(source.Value, Optional.ToNullable(firstSeen), Optional.ToNullable(lastSeen), Optional.ToNullable(count), reason.Value);
        }
