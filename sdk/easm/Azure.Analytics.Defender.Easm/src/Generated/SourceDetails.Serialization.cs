...
{
    public partial class SourceDetails : IUtf8JsonWriteable, IJsonModel<SourceDetails>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<SourceDetails>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static SourceDetails FromResponse(PipelineResponse response)
        {
