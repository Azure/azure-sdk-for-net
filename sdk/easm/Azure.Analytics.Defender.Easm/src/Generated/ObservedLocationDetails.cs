...
namespace Azure.Analytics.Defender.Easm
{
    ...
    public partial class ObservedLocationDetails
    {
        ...
        internal ObservedLocationDetails(string countryCode, string countryName, string region, string regionName, string city, int? areaCode, string postalCode, float? latitude, float? longitude, int? dmaCode, int? metroCodeId)
        {
