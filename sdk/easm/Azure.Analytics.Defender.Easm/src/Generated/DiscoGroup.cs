...
namespace Azure.Analytics.Defender.Easm
{
    ...
    public partial class DiscoGroup
    {
        ...
        internal DiscoGroup(string id, string name, string displayName, string description, string tier, long? frequencyMilliseconds, IReadOnlyList<DiscoSource> seeds, IReadOnlyList<string> names, IReadOnlyList<DiscoSource> excludes, DiscoRunResult latestRun, DateTimeOffset? createdDate, string templateId, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Name = name;
