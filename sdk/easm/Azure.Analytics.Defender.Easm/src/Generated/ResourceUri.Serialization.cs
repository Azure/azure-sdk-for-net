...
namespace Azure.Analytics.Defender.Easm
{
    ...
    {
        internal static ResourceUri DeserializeResourceUri(JsonElement element)
        {
            ...
            return new ResourceUri(url.Value, Optional.ToList(resources), Optional.ToNullable(firstSeen), Optional.ToNullable(lastSeen), Optional.ToNullable(count), Optional.ToNullable(recent));
        }
