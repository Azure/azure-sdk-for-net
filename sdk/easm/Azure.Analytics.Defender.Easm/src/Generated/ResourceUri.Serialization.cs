...
{
    public partial class ResourceUri : IUtf8JsonWriteable, IJsonModel<ResourceUri>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ResourceUri>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ResourceUri>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ResourceUri)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ResourceUri>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ResourceUri)} does not support '{options.Format}' format.");
            }
        }
        ...
        internal static ResourceUri FromResponse(PipelineResponse response)
        {
