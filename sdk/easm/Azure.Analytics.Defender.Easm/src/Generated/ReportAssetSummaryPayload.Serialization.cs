...
{
    public partial class ReportAssetSummaryPayload : IUtf8JsonWriteable, IJsonModel<ReportAssetSummaryPayload>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ReportAssetSummaryPayload>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static ReportAssetSummaryPayload FromResponse(PipelineResponse response)
        {
