...
namespace Azure.Analytics.Defender.Easm
{
    ...
    public partial class Reputation
    {
        ...
        internal Reputation(string listName, string threatType, bool? trusted, string cidr, DateTimeOffset? firstSeen, DateTimeOffset? lastSeen, DateTimeOffset? listUpdatedAt, bool? recent, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ListName = listName;
