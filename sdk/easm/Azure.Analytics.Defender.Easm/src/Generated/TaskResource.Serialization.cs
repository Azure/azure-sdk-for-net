...
{
    public partial class TaskResource : IUtf8JsonWriteable, IJsonModel<TaskResource>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<TaskResource>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static TaskResource DeserializeTaskResource(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new TaskResource(
                ...
                phase,
                reason,
                metadata ?? new OptionalDictionary<string, BinaryData>(),
        ...
        internal static TaskResource FromResponse(PipelineResponse response)
        {
