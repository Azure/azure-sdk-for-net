...
namespace Azure.Analytics.Defender.Easm
{
    ...
    public partial class EasmDeltaDetailsRequestContent
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="EasmDeltaDetailsRequestContent"/>. </summary>
        /// <param name="deltaDetailType"> The type of delta detail to retrieve. </param>
        /// <param name="kind"> The type of asset. </param>
        public EasmDeltaDetailsRequestContent(DeltaDetailType deltaDetailType, GlobalAssetType kind)
        {
        ...
        internal EasmDeltaDetailsRequestContent(DeltaDetailType deltaDetailType, int? priorDays, GlobalAssetType kind, string date, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            DeltaDetailType = deltaDetailType;
            PriorDays = priorDays;
            Kind = kind;
        ...
        /// <summary> Initializes a new instance of <see cref="EasmDeltaDetailsRequestContent"/> for deserialization. </summary>
        internal EasmDeltaDetailsRequestContent()
        {
        }
