...
namespace Azure.Analytics.Defender.Easm
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AssetSecurityPolicy>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<AssetSecurityPolicy>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AssetSecurityPolicy)} does not support '{format}' format.");
            }
        ...
        internal static AssetSecurityPolicy DeserializeAssetSecurityPolicy(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new AssetSecurityPolicy(policyName.Value, Optional.ToNullable(isAffected), description.Value, Optional.ToNullable(firstSeen), Optional.ToNullable(lastSeen), Optional.ToNullable(count), Optional.ToNullable(recent), Optional.ToList(sources), serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<AssetSecurityPolicy>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AssetSecurityPolicy)} does not support '{options.Format}' format.");
            }
        }
