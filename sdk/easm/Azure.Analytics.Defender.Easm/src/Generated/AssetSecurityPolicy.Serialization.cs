...
{
    public partial class AssetSecurityPolicy : IUtf8JsonWriteable, IJsonModel<AssetSecurityPolicy>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<AssetSecurityPolicy>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static AssetSecurityPolicy FromResponse(PipelineResponse response)
        {
