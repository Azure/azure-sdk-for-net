...
namespace Azure.Analytics.Defender.Easm.Models
{
    ...
    public partial class SavedFilterPageResult
    {
        ...
        internal SavedFilterPageResult(long? totalElements, string nextLink, IReadOnlyList<SavedFilter> value)
        {
