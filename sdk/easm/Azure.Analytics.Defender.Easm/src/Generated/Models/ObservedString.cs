...
namespace Azure.Analytics.Defender.Easm.Models
{
    ...
    public partial class ObservedString : ObservedValue
    {
        ...
        internal ObservedString(DateTimeOffset? firstSeen, DateTimeOffset? lastSeen, long? count, bool? recent, string value, IReadOnlyList<Source> sources) : base(firstSeen, lastSeen, count, recent)
        {
            Value = value;
            Sources = sources;
        }
