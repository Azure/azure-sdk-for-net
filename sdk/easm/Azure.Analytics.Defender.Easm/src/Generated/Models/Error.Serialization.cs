    ...
    internal partial class Error : IJsonModel<Error>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(Details))
            {
                ...
                foreach (ResponseError item in Details)
                {
                    if (item == null)
                    {
        ...
        internal static Error DeserializeError(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            IList<ResponseError> details = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("details"u8))
                {
                    ...
                    foreach (var item in prop.Value.EnumerateArray())
                    {
                        ...
                        {
                            array.Add(ModelReaderWriter.Read<ResponseError>(new BinaryData(Encoding.UTF8.GetBytes(item.GetRawText())), options, AzureAnalyticsDefenderEasmContext.Default));
                        }
                    }
                    details = array;
                    continue;
                ...
                if (prop.NameEquals("innererror"u8))
                {
                    ...
                    innererror = CoreInnerError.DeserializeCoreInnerError(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
