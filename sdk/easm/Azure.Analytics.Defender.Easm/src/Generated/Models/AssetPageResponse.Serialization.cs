...
{
    public partial class AssetPageResponse
    {
        internal static AssetPageResponse DeserializeAssetPageResponse(JsonElement element)
        {
            ...
            return new AssetPageResponse(Optional.ToNullable(totalElements), mark.Value, nextLink.Value, Optional.ToList(value));
        }

        /// <summary> Deserializes the model from a raw response. </summary>
        /// <param name="response"> The response to deserialize the model from. </param>
        internal static AssetPageResponse FromResponse(Response response)
        {
            using var document = JsonDocument.Parse(response.Content);
            return DeserializeAssetPageResponse(document.RootElement);
        }
    }
}
