...
{
    /// <summary> The DiscoTemplatePageResponse. </summary>
    public partial class DiscoTemplatePageResponse
    {
        /// <summary> Initializes a new instance of DiscoTemplatePageResponse. </summary>
        internal DiscoTemplatePageResponse()
        {
            Value = new ChangeTrackingList<DiscoTemplate>();
        }
        ...
        internal DiscoTemplatePageResponse(long? totalElements, string nextLink, IReadOnlyList<DiscoTemplate> value)
        {
        ...
        public IReadOnlyList<DiscoTemplate> Value { get; }
    }
}
