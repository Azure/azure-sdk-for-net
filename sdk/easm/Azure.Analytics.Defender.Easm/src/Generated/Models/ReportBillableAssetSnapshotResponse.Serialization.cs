...
namespace Azure.Analytics.Defender.Easm.Models
{
    ...
    {
        internal static ReportBillableAssetSnapshotResponse DeserializeReportBillableAssetSnapshotResponse(JsonElement element)
        {
            ...
            return new ReportBillableAssetSnapshotResponse(Optional.ToNullable(date), Optional.ToNullable(total), Optional.ToList(assetBreakdown));
        }

        /// <summary> Deserializes the model from a raw response. </summary>
        /// <param name="response"> The response to deserialize the model from. </param>
        internal static ReportBillableAssetSnapshotResponse FromResponse(Response response)
        {
            using var document = JsonDocument.Parse(response.Content);
            return DeserializeReportBillableAssetSnapshotResponse(document.RootElement);
        }
    }
}
