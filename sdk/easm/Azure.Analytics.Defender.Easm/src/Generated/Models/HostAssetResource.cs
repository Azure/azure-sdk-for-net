...
namespace Azure.Analytics.Defender.Easm
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="global::Azure.Analytics.Defender.Easm.HostAssetResource"/>. </summary>
        /// <param name="asset"> asset. </param>
        internal HostAssetResource(HostAsset asset) : base("host")
        {
            Asset = asset;
        }
