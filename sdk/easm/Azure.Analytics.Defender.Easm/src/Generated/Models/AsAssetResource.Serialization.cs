...
{
    public partial class AsAssetResource
    {
        internal static AsAssetResource DeserializeAsAssetResource(JsonElement element)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    asset = AsAsset.DeserializeAsAsset(property.Value);
                    continue;
                }
