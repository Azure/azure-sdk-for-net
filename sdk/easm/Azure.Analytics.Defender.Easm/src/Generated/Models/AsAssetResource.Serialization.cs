...
namespace Azure.Analytics.Defender.Easm
{
    ...
    public partial class AsAssetResource : AssetResource, IJsonModel<AsAssetResource>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<AsAssetResource>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
                ...
                default:
                    throw new FormatException($"The model {nameof(AsAssetResource)} does not support reading '{options.Format}' format.");
            }
        }
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AsAssetResource)} does not support writing '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        AsAssetResource IJsonModel<AsAssetResource>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (AsAssetResource)JsonModelCreateCore(ref reader, options);
        ...
        protected override AssetResource JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AsAssetResource)} does not support reading '{format}' format.");
            }
        ...
        internal static AsAssetResource DeserializeAsAssetResource(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    asset = AsAsset.DeserializeAsAsset(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<AsAssetResource>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        protected override BinaryData PersistableModelWriteCore(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AsAssetResource)} does not support writing '{options.Format}' format.");
            }
        }

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        AsAssetResource IPersistableModel<AsAssetResource>.Create(BinaryData data, ModelReaderWriterOptions options) => (AsAssetResource)PersistableModelCreateCore(data, options);
