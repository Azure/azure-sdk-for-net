...
namespace Azure.Analytics.Defender.Easm
{
    ...
    public partial class ResourceUri : IJsonModel<ResourceUri>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<ResourceUri>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ResourceUri IJsonModel<ResourceUri>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);
        ...
        internal static ResourceUri DeserializeResourceUri(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            Uri url = default;
            IList<DependentResource> resources = default;
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ResourceUri>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ResourceUri IPersistableModel<ResourceUri>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
