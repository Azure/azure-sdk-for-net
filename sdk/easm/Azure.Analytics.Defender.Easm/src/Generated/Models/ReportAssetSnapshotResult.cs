...
namespace Azure.Analytics.Defender.Easm.Models
{
    ...
    public partial class ReportAssetSnapshotResult
    {
        ...
        internal ReportAssetSnapshotResult(string displayName, string metric, string labelName, DateTimeOffset? updatedAt, string description, AssetPageResult assets)
        {
