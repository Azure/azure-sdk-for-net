...
namespace Azure.Analytics.Defender.Easm.Models
{
    ...
    public partial class ReportAssetSnapshotResponse
    {
        ...
        internal ReportAssetSnapshotResponse()
        {
        }
        ...
        internal ReportAssetSnapshotResponse(string displayName, string metric, string labelName, DateTimeOffset? updatedAt, string description, AssetPageResponse assets)
        {
        ...
        public AssetPageResponse Assets { get; }
    }
}
