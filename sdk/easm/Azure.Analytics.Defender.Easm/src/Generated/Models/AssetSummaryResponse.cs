...
namespace Azure.Analytics.Defender.Easm.Models
{
    ...
    public partial class AssetSummaryResponse
    {
        ...
        internal AssetSummaryResponse()
        {
            Children = new ChangeTrackingList<AssetSummaryResponse>();
        }
        ...
        internal AssetSummaryResponse(string displayName, string description, DateTimeOffset? updatedAt, string metricCategory, string metric, string filter, string labelName, long? count, string link, IReadOnlyList<AssetSummaryResponse> children)
        {
        ...
        public IReadOnlyList<AssetSummaryResponse> Children { get; }
    }
}
