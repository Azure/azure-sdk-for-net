...
namespace Azure.Analytics.Defender.Easm.Models
{
    ...
    public partial class DiscoRunResponse
    {
        /// <summary> Initializes a new instance of DiscoRunResponse. </summary>
        internal DiscoRunResponse()
        {
        ...
        internal DiscoRunResponse(DateTimeOffset? submittedDate, DateTimeOffset? startedDate, DateTimeOffset? completedDate, string tier, DiscoRunState? state, long? totalAssetsFoundCount, IReadOnlyList<DiscoSource> seeds, IReadOnlyList<DiscoSource> excludes, IReadOnlyList<string> names)
        {
