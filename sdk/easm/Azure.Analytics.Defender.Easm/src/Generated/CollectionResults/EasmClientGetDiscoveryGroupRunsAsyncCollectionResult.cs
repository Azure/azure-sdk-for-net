...
namespace Azure.Analytics.Defender.Easm
{
    internal partial class EasmClientGetDiscoveryGroupRunsAsyncCollectionResult : AsyncPageable<BinaryData>
    {
        ...
        public EasmClientGetDiscoveryGroupRunsAsyncCollectionResult(EasmClient client, string groupName, string filter, int? skip, int? maxpagesize, RequestContext context) : base(context?.CancellationToken ?? default)
        {
