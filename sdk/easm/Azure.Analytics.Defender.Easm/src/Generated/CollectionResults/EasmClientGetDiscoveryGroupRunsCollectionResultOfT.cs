...
namespace Azure.Analytics.Defender.Easm
{
    internal partial class EasmClientGetDiscoveryGroupRunsCollectionResultOfT : Pageable<DiscoveryRunResult>
    {
        ...
        public EasmClientGetDiscoveryGroupRunsCollectionResultOfT(EasmClient client, string groupName, string filter, int? skip, int? maxpagesize, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
