...
{
    internal partial class EasmClientGetTasksCollectionResultOfT : Pageable<global::Azure.Analytics.Defender.Easm.TaskResource>
    {
        ...
        public EasmClientGetTasksCollectionResultOfT(EasmClient client, string filter, string @orderby, int? skip, int? maxPageSize, RequestContext context, string diagnosticScope) : base((context?.CancellationToken ?? default))
        {
            _client = client;
            _filter = filter;
            _orderby = @orderby;
        ...
        public override IEnumerable<global::Azure.Page<global::Azure.Analytics.Defender.Easm.TaskResource>> AsPages(string continuationToken, int? pageSizeHint)
        {
