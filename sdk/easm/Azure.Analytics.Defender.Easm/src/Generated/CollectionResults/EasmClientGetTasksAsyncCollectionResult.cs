...
{
    internal partial class EasmClientGetTasksAsyncCollectionResult : AsyncPageable<global::System.BinaryData>
    {
        ...
        public EasmClientGetTasksAsyncCollectionResult(EasmClient client, string filter, string @orderby, int? skip, int? maxPageSize, RequestContext context, string diagnosticScope) : base((context?.CancellationToken ?? default))
        {
            _client = client;
            _filter = filter;
            _orderby = @orderby;
