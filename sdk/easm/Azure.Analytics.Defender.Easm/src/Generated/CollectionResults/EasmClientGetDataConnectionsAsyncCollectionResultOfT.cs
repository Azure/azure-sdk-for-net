...
{
    internal partial class EasmClientGetDataConnectionsAsyncCollectionResultOfT : AsyncPageable<global::Azure.Analytics.Defender.Easm.DataConnection>
    {
        ...
        public EasmClientGetDataConnectionsAsyncCollectionResultOfT(EasmClient client, int? skip, int? maxPageSize, RequestContext context, string diagnosticScope) : base((context?.CancellationToken ?? default))
        {
            _client = client;
            _skip = skip;
        ...
        public override async IAsyncEnumerable<global::Azure.Page<global::Azure.Analytics.Defender.Easm.DataConnection>> AsPages(string continuationToken, int? pageSizeHint)
        {
