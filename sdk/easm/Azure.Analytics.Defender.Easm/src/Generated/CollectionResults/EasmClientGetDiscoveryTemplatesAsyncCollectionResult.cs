...
{
    internal partial class EasmClientGetDiscoveryTemplatesAsyncCollectionResult : AsyncPageable<global::System.BinaryData>
    {
        ...
        /// <summary> Initializes a new instance of EasmClientGetDiscoveryTemplatesAsyncCollectionResult, which is used to iterate over the pages of a collection. </summary>
        ...
        public EasmClientGetDiscoveryTemplatesAsyncCollectionResult(EasmClient client, string filter, int? skip, int? maxPageSize, RequestContext context, string diagnosticScope) : base((context?.CancellationToken ?? default))
        {
            _client = client;
            _filter = filter;
            _skip = skip;
        ...
        /// <summary> Gets the pages of EasmClientGetDiscoveryTemplatesAsyncCollectionResult as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of EasmClientGetDiscoveryTemplatesAsyncCollectionResult as an enumerable collection. </returns>
