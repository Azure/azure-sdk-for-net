...
{
    internal partial class EasmClientGetDeltaDetailsCollectionResultOfT : Pageable<global::Azure.Analytics.Defender.Easm.DeltaResult>
    {
        ...
        /// <summary> Initializes a new instance of EasmClientGetDeltaDetailsCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public EasmClientGetDeltaDetailsCollectionResultOfT(EasmClient client, RequestContent content, int? skip, int? maxpagesize, RequestContext context, string diagnosticScope) : base((context?.CancellationToken ?? default))
        {
            _client = client;
            _content = content;
            _skip = skip;
        ...
        /// <summary> Gets the pages of EasmClientGetDeltaDetailsCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of EasmClientGetDeltaDetailsCollectionResultOfT as an enumerable collection. </returns>
        public override IEnumerable<global::Azure.Page<global::Azure.Analytics.Defender.Easm.DeltaResult>> AsPages(string continuationToken, int? pageSizeHint)
        {
