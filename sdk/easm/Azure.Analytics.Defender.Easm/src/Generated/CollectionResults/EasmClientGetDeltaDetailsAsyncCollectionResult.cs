...
{
    internal partial class EasmClientGetDeltaDetailsAsyncCollectionResult : AsyncPageable<global::System.BinaryData>
    {
        ...
        public EasmClientGetDeltaDetailsAsyncCollectionResult(EasmClient client, RequestContent content, int? skip, int? maxpagesize, RequestContext context, string diagnosticScope) : base((context?.CancellationToken ?? default))
        {
            _client = client;
            _content = content;
            _skip = skip;
