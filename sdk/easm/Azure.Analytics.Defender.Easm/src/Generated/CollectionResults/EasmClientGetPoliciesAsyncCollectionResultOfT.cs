...
{
    internal partial class EasmClientGetPoliciesAsyncCollectionResultOfT : AsyncPageable<global::Azure.Analytics.Defender.Easm.EasmPolicy>
    {
        ...
        public EasmClientGetPoliciesAsyncCollectionResultOfT(EasmClient client, string filter, int? skip, int? maxPageSize, RequestContext context, string diagnosticScope) : base((context?.CancellationToken ?? default))
        {
            _client = client;
            _filter = filter;
            _skip = skip;
        ...
        public override async IAsyncEnumerable<global::Azure.Page<global::Azure.Analytics.Defender.Easm.EasmPolicy>> AsPages(string continuationToken, int? pageSizeHint)
        {
