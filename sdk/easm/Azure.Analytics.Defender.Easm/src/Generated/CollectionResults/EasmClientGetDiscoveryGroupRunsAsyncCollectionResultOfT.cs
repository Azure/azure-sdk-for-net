...
{
    internal partial class EasmClientGetDiscoveryGroupRunsAsyncCollectionResultOfT : AsyncPageable<global::Azure.Analytics.Defender.Easm.DiscoveryRunResult>
    {
        ...
        public EasmClientGetDiscoveryGroupRunsAsyncCollectionResultOfT(EasmClient client, string groupName, string filter, int? skip, int? maxPageSize, RequestContext context, string diagnosticScope) : base((context?.CancellationToken ?? default))
        {
            _client = client;
        ...
        /// <summary> Gets the pages of EasmClientGetDiscoveryGroupRunsAsyncCollectionResultOfT as an enumerable collection. </summary>
        ...
        public override async IAsyncEnumerable<global::Azure.Page<global::Azure.Analytics.Defender.Easm.DiscoveryRunResult>> AsPages(string continuationToken, int? pageSizeHint)
        {
