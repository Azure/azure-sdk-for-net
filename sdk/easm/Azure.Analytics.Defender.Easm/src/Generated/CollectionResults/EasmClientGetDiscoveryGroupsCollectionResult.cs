...
{
    internal partial class EasmClientGetDiscoveryGroupsCollectionResult : Pageable<global::System.BinaryData>
    {
        ...
        public EasmClientGetDiscoveryGroupsCollectionResult(EasmClient client, string filter, int? skip, int? maxPageSize, RequestContext context, string diagnosticScope) : base((context?.CancellationToken ?? default))
        {
            _client = client;
            _filter = filter;
            _skip = skip;
