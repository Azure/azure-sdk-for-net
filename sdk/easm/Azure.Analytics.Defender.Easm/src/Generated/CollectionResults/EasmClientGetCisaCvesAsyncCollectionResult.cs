...
namespace Azure.Analytics.Defender.Easm
{
    internal partial class EasmClientGetCisaCvesAsyncCollectionResult : AsyncPageable<BinaryData>
    {
        ...
        /// <summary> Initializes a new instance of EasmClientGetCisaCvesAsyncCollectionResult, which is used to iterate over the pages of a collection. </summary>
        /// <param name="client"> The EasmClient client used to send requests. </param>
        /// <param name="context"> The request options, which can override default behaviors of the client pipeline on a per-call basis. </param>
        public EasmClientGetCisaCvesAsyncCollectionResult(EasmClient client, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _context = context;
        }

        /// <summary> Gets the pages of EasmClientGetCisaCvesAsyncCollectionResult as an enumerable collection. </summary>
