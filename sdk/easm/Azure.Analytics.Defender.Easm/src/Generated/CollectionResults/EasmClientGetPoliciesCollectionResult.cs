...
{
    internal partial class EasmClientGetPoliciesCollectionResult : Pageable<global::System.BinaryData>
    {
        ...
        public EasmClientGetPoliciesCollectionResult(EasmClient client, string filter, int? skip, int? maxPageSize, RequestContext context, string diagnosticScope) : base((context?.CancellationToken ?? default))
        {
            _client = client;
            _filter = filter;
            _skip = skip;
