...
{
    public partial class ObservedHeader : IUtf8JsonWriteable, IJsonModel<ObservedHeader>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ObservedHeader>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static new ObservedHeader FromResponse(PipelineResponse response)
        {
