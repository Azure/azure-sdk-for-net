...
namespace Azure.Analytics.Defender.Easm
{
    public partial class ObservedHeader : IUtf8JsonSerializable, IJsonModel<ObservedHeader>
    {
        ...
        void IJsonModel<ObservedHeader>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ObservedHeader)} does not support '{format}' format.");
            }
        ...
        internal static ObservedHeader DeserializeObservedHeader(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new ObservedHeader(Optional.ToNullable(firstSeen), Optional.ToNullable(lastSeen), Optional.ToNullable(count), Optional.ToNullable(recent), serializedAdditionalRawData, headerName.Value, headerValue.Value);
        }
        ...
        BinaryData IPersistableModel<ObservedHeader>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ObservedHeader)} does not support '{options.Format}' format.");
            }
        }
