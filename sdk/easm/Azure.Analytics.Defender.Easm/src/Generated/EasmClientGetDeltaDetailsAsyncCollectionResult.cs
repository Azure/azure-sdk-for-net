...
{
    internal partial class EasmClientGetDeltaDetailsAsyncCollectionResult : AsyncPageable<BinaryData>
    {
        ...
        /// <summary> Initializes a new instance of EasmClientGetDeltaDetailsAsyncCollectionResult, which is used to iterate over the pages of a collection. </summary>
        ...
        public EasmClientGetDeltaDetailsAsyncCollectionResult(EasmClient client, RequestContent content, int? skip, int? maxpagesize, RequestContext context) : base(context?.CancellationToken ?? default)
        {
        ...
        /// <summary> Gets the pages of EasmClientGetDeltaDetailsAsyncCollectionResult as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of EasmClientGetDeltaDetailsAsyncCollectionResult as an enumerable collection. </returns>
