...
namespace Azure.Analytics.Defender.Easm
{
    ...
    public partial class Task
    {
        ...
        internal Task(string id, DateTimeOffset? startedAt, DateTimeOffset? completedAt, DateTimeOffset? lastPolledAt, TaskState? state, TaskPhase? phase, string reason, IReadOnlyDictionary<string, BinaryData> metadata, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            StartedAt = startedAt;
