...
{
    public partial class SslCertAssetResource : IUtf8JsonWriteable, IJsonModel<SslCertAssetResource>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<SslCertAssetResource>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static new SslCertAssetResource FromResponse(PipelineResponse response)
        {
