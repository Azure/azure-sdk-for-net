...
namespace Azure.Analytics.Defender.Easm
{
    ...
    public partial class Cve
    {
        ...
        /// <summary> Gets or sets the cwe id. </summary>
        public string CweId { get; set; }
        /// <summary> Gets or sets the cvss score. </summary>
        public float? CvssScore { get; set; }
        /// <summary> Gets or sets the cvss 3 summary. </summary>
        public Cvss3Summary Cvss3Summary { get; set; }
    }
}
