...
{
    public partial class AssetService : IUtf8JsonWriteable, IJsonModel<AssetService>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<AssetService>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static AssetService FromResponse(PipelineResponse response)
        {
