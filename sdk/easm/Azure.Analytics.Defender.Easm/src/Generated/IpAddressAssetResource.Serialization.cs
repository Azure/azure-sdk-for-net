...
{
    public partial class IpAddressAssetResource : IUtf8JsonWriteable, IJsonModel<IpAddressAssetResource>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<IpAddressAssetResource>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static new IpAddressAssetResource FromResponse(PipelineResponse response)
        {
