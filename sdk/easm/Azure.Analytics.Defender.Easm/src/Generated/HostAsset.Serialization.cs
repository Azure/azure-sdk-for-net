...
{
    public partial class HostAsset : IUtf8JsonWriteable, IJsonModel<HostAsset>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<HostAsset>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static new HostAsset FromResponse(PipelineResponse response)
        {
