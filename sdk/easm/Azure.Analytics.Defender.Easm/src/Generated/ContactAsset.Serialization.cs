...
{
    public partial class ContactAsset : IUtf8JsonWriteable, IJsonModel<ContactAsset>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContactAsset>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ContactAsset>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ContactAsset)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ContactAsset>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ContactAsset)} does not support '{options.Format}' format.");
            }
        }
        ...
        internal static new ContactAsset FromResponse(PipelineResponse response)
        {
