...
namespace Azure.Analytics.Defender.Easm
{
    ...
    {
        internal static CveDetails DeserializeCveDetails(JsonElement element)
        {
            ...
            return new CveDetails(name.Value, cweId.Value, Optional.ToNullable(cvssScore), cvss3Summary.Value);
        }
