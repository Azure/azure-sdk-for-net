...
{
    public partial class CveDetails : IUtf8JsonWriteable, IJsonModel<CveDetails>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<CveDetails>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static CveDetails FromResponse(PipelineResponse response)
        {
