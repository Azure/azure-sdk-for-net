...
namespace Azure.Analytics.Defender.Easm
{
    public partial class Location : IUtf8JsonSerializable, IJsonModel<Location>
    {
        ...
        internal static Location DeserializeLocation(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new Location(countryCode.Value, countryName.Value, region.Value, regionName.Value, city.Value, Optional.ToNullable(areaCode), postalCode.Value, Optional.ToNullable(latitude), Optional.ToNullable(longitude), Optional.ToNullable(dmaCode), Optional.ToNullable(metroCodeId), serializedAdditionalRawData);
        }
