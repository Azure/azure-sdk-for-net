...
namespace Azure.Analytics.Defender.Easm
{
    ...
    public partial class DiscoTemplate
    {
        ...
        internal DiscoTemplate(string id, string name, string displayName, string industry, string region, string countryCode, string stateCode, string city, IReadOnlyList<DiscoSource> seeds, IReadOnlyList<string> names, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Name = name;
