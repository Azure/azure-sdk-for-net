...
{
    public partial class ErrorDetail : IUtf8JsonWriteable, IJsonModel<ErrorDetail>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ErrorDetail>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static ErrorDetail FromResponse(PipelineResponse response)
        {
