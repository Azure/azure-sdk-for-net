...
namespace Azure.Analytics.Defender.Easm
{
    ...
    public partial class TaskResource
    {
        ...
        internal TaskResource(string id, DateTimeOffset? startedAt, DateTimeOffset? completedAt, DateTimeOffset? lastPolledAt, TaskResourceState? state, TaskResourcePhase? phase, string reason, IReadOnlyDictionary<string, BinaryData> metadata)
        {
            Id = id;
            StartedAt = startedAt;
