...
namespace Azure.Analytics.Defender.Easm
{
    public partial class IpBlockAssetResource : IUtf8JsonSerializable, IJsonModel<IpBlockAssetResource>
    {
        ...
        void IJsonModel<IpBlockAssetResource>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(IpBlockAssetResource)} does not support '{format}' format.");
            }
        ...
        internal static IpBlockAssetResource DeserializeIpBlockAssetResource(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    asset = IpBlockAsset.DeserializeIpBlockAsset(property.Value);
                    continue;
                }
        ...
        BinaryData IPersistableModel<IpBlockAssetResource>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(IpBlockAssetResource)} does not support '{options.Format}' format.");
            }
        }
