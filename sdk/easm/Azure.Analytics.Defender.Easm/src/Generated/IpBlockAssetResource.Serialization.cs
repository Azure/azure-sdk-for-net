...
{
    public partial class IpBlockAssetResource : IUtf8JsonWriteable, IJsonModel<IpBlockAssetResource>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<IpBlockAssetResource>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static new IpBlockAssetResource FromResponse(PipelineResponse response)
        {
