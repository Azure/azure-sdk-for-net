...
{
    public partial class WebComponent : IUtf8JsonWriteable, IJsonModel<WebComponent>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<WebComponent>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static WebComponent FromResponse(PipelineResponse response)
        {
