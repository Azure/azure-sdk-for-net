...
{
    public partial class AlexaInfo : IUtf8JsonWriteable, IJsonModel<AlexaInfo>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<AlexaInfo>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static AlexaInfo FromResponse(PipelineResponse response)
        {
