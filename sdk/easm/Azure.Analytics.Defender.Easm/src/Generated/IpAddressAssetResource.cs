...
namespace Azure.Analytics.Defender.Easm
{
    ...
    public partial class IpAddressAssetResource : AssetResource
    {
        ...
        public IpAddressAssetResource(IpAddressAsset asset)
        {
        ...
        /// <param name="asset"> asset. </param>
        internal IpAddressAssetResource(string kind, string id, string name, string displayName, Guid? uuid, DateTimeOffset? createdDate, DateTimeOffset? updatedDate, AssetState? state, string externalId, IList<string> labels, bool? wildcard, string discoGroupName, IList<AuditTrailItem> auditTrail, string reason, IpAddressAsset asset) : base(kind, id, name, displayName, uuid, createdDate, updatedDate, state, externalId, labels, wildcard, discoGroupName, auditTrail, reason)
        {
            Asset = asset;
        }

        /// <summary> asset. </summary>
        public IpAddressAsset Asset { get; set; }
    }
}
