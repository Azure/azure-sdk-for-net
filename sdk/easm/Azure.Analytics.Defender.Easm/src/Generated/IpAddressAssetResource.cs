...
namespace Azure.Analytics.Defender.Easm
{
    ...
    public partial class IpAddressAssetResource : AssetResource
    {
        /// <summary> Initializes a new instance of <see cref="IpAddressAssetResource"/>. </summary>
        /// <param name="asset"> asset. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="asset"/> is null. </exception>
        internal IpAddressAssetResource(IpAddressAsset asset)
        {
        ...
        /// <param name="asset"> asset. </param>
        internal IpAddressAssetResource(string kind, string id, string name, string displayName, Guid? uuid, DateTimeOffset? createdDate, DateTimeOffset? updatedDate, AssetState? state, string externalId, IReadOnlyList<string> labels, bool? wildcard, string discoGroupName, IReadOnlyList<AuditTrailItem> auditTrail, string reason, IpAddressAsset asset) : base(kind, id, name, displayName, uuid, createdDate, updatedDate, state, externalId, labels, wildcard, discoGroupName, auditTrail, reason)
        {
            Asset = asset;
        }

        /// <summary> asset. </summary>
        public IpAddressAsset Asset { get; }
    }
}
