...
namespace Azure.Analytics.Defender.Easm
{
    ...
    public partial class SslCertAssetResource : AssetResource
    {
        ...
        /// <param name="asset"> asset. </param>
        internal SslCertAssetResource(string id, string name, string displayName, Guid? uuid, DateTimeOffset? createdDate, DateTimeOffset? updatedDate, AssetState? state, string externalId, IReadOnlyList<string> labels, bool? wildcard, string discoGroupName, IReadOnlyList<AuditTrailItem> auditTrail, string reason, string kind, IDictionary<string, BinaryData> serializedAdditionalRawData, SslCertAsset asset) : base(id, name, displayName, uuid, createdDate, updatedDate, state, externalId, labels, wildcard, discoGroupName, auditTrail, reason, kind, serializedAdditionalRawData)
        {
            Asset = asset;
        }

        /// <summary> Initializes a new instance of <see cref="SslCertAssetResource"/> for deserialization. </summary>
        internal SslCertAssetResource()
        {
        }

        /// <summary> asset. </summary>
        public SslCertAsset Asset { get; }
    }
}
