...
{
    public partial class ObservedIntegers : IUtf8JsonWriteable, IJsonModel<ObservedIntegers>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ObservedIntegers>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static new ObservedIntegers FromResponse(PipelineResponse response)
        {
