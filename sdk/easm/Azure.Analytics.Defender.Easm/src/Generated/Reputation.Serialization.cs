...
{
    public partial class Reputation : IUtf8JsonSerializable, IJsonModel<Reputation>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<Reputation>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<Reputation>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<Reputation>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(Reputation)} does not support '{format}' format.");
            }
        ...
        Reputation IJsonModel<Reputation>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<Reputation>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
            ...
            return DeserializeReputation(document.RootElement, options);
        }

        internal static Reputation DeserializeReputation(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new Reputation(listName.Value, threatType.Value, Optional.ToNullable(trusted), cidr.Value, Optional.ToNullable(firstSeen), Optional.ToNullable(lastSeen), Optional.ToNullable(listUpdatedAt), Optional.ToNullable(recent), serializedAdditionalRawData);
        }

        BinaryData IPersistableModel<Reputation>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<Reputation>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(Reputation)} does not support '{options.Format}' format.");
            }
        }

        Reputation IPersistableModel<Reputation>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<Reputation>)this).GetFormatFromOptions(options) : options.Format;
        ...
        string IPersistableModel<Reputation>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
