...
{
    public partial class SavedFilter : IUtf8JsonWriteable, IJsonModel<SavedFilter>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<SavedFilter>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static SavedFilter FromResponse(PipelineResponse response)
        {
