...
{
    public partial class AssetsExportRequest : IUtf8JsonSerializable, IJsonModel<AssetsExportRequest>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AssetsExportRequest>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<AssetsExportRequest>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<AssetsExportRequest>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        AssetsExportRequest IJsonModel<AssetsExportRequest>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AssetsExportRequest>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        BinaryData IPersistableModel<AssetsExportRequest>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AssetsExportRequest>)this).GetFormatFromOptions(options) : options.Format;
        ...
        AssetsExportRequest IPersistableModel<AssetsExportRequest>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AssetsExportRequest>)this).GetFormatFromOptions(options) : options.Format;
        ...
        string IPersistableModel<AssetsExportRequest>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
