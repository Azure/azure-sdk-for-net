...
{
    public partial class IpBlockAsset : IUtf8JsonWriteable, IJsonModel<IpBlockAsset>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<IpBlockAsset>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static new IpBlockAsset FromResponse(PipelineResponse response)
        {
