...
{
    public partial class LogAnalyticsDataConnectionPayload : IUtf8JsonWriteable, IJsonModel<LogAnalyticsDataConnectionPayload>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<LogAnalyticsDataConnectionPayload>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static new LogAnalyticsDataConnectionPayload FromResponse(PipelineResponse response)
        {
