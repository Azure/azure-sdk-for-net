...
{
    public partial class AssetUpdatePayload : IUtf8JsonWriteable, IJsonModel<AssetUpdatePayload>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<AssetUpdatePayload>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static AssetUpdatePayload DeserializeAssetUpdatePayload(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new AssetUpdatePayload(state, externalId, labels ?? new OptionalDictionary<string, bool>(), transfers, serializedAdditionalRawData);
        }
        ...
        internal static AssetUpdatePayload FromResponse(PipelineResponse response)
        {
