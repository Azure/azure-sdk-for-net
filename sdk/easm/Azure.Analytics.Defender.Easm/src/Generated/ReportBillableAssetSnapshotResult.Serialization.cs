...
{
    public partial class ReportBillableAssetSnapshotResult : IUtf8JsonWriteable, IJsonModel<ReportBillableAssetSnapshotResult>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ReportBillableAssetSnapshotResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static ReportBillableAssetSnapshotResult FromResponse(PipelineResponse response)
        {
