...
{
    public partial class ObservedLocationDetails : IUtf8JsonWriteable, IJsonModel<ObservedLocationDetails>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ObservedLocationDetails>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static ObservedLocationDetails FromResponse(PipelineResponse response)
        {
