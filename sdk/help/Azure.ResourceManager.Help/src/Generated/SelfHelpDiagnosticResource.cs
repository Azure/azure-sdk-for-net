...
namespace Azure.ResourceManager.Help
{
    ...
    public partial class SelfHelpDiagnosticResource : ArmResource
    {
        ...
        {
            _selfHelpDiagnosticDiagnosticResourcesClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Help", ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<SelfHelpDiagnosticResource>> UpdateAsync(WaitUntil waitUntil, SelfHelpDiagnosticData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new HelpArmOperation<SelfHelpDiagnosticResource>(new SelfHelpDiagnosticOperationSource(Client), _selfHelpDiagnosticDiagnosticResourcesClientDiagnostics, Pipeline, _selfHelpDiagnosticDiagnosticResourcesRestClient.CreateCreateRequest(Id.Parent, Id.Name, data).Request, response, OperationFinalStateVia.AzureAsyncOperation);
