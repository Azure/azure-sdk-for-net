...
namespace Azure.ResourceManager.Help
{
    public partial class SelfHelpSimplifiedSolutionResource : IJsonModel<SelfHelpSimplifiedSolutionData>
    {
        ...
        BinaryData IPersistableModel<SelfHelpSimplifiedSolutionData>.Write(ModelReaderWriterOptions options) => ModelReaderWriter.Write<SelfHelpSimplifiedSolutionData>(Data, options, AzureResourceManagerHelpContext.Default);

        SelfHelpSimplifiedSolutionData IPersistableModel<SelfHelpSimplifiedSolutionData>.Create(BinaryData data, ModelReaderWriterOptions options) => ModelReaderWriter.Read<SelfHelpSimplifiedSolutionData>(data, options, AzureResourceManagerHelpContext.Default);
