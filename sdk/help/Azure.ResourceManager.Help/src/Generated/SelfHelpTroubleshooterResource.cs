...
namespace Azure.ResourceManager.Help
{
    ...
    public partial class SelfHelpTroubleshooterResource : ArmResource
    {
        ...
        {
            _selfHelpTroubleshooterTroubleshooterResourcesClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Help", ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<SelfHelpTroubleshooterResource>> UpdateAsync(WaitUntil waitUntil, SelfHelpTroubleshooterData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new HelpArmOperation<SelfHelpTroubleshooterResource>(Response.FromValue(new SelfHelpTroubleshooterResource(Client, response), response.GetRawResponse()), rehydrationToken);
