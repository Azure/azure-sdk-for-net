...
namespace Azure.ResourceManager.Help
{
    public partial class SelfHelpDiagnosticResource : IJsonModel<SelfHelpDiagnosticData>
    {
        ...
        BinaryData IPersistableModel<SelfHelpDiagnosticData>.Write(ModelReaderWriterOptions options) => ModelReaderWriter.Write<SelfHelpDiagnosticData>(Data, options, AzureResourceManagerHelpContext.Default);

        SelfHelpDiagnosticData IPersistableModel<SelfHelpDiagnosticData>.Create(BinaryData data, ModelReaderWriterOptions options) => ModelReaderWriter.Read<SelfHelpDiagnosticData>(data, options, AzureResourceManagerHelpContext.Default);
