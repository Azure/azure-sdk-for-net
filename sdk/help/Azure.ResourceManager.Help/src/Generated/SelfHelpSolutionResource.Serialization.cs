...
namespace Azure.ResourceManager.Help
{
    public partial class SelfHelpSolutionResource : IJsonModel<SelfHelpSolutionData>
    {
        ...
        BinaryData IPersistableModel<SelfHelpSolutionData>.Write(ModelReaderWriterOptions options) => ModelReaderWriter.Write<SelfHelpSolutionData>(Data, options, AzureResourceManagerHelpContext.Default);

        SelfHelpSolutionData IPersistableModel<SelfHelpSolutionData>.Create(BinaryData data, ModelReaderWriterOptions options) => ModelReaderWriter.Read<SelfHelpSolutionData>(data, options, AzureResourceManagerHelpContext.Default);
