...
namespace Azure.ResourceManager.Help.Mocking
{
    ...
    public partial class MockableHelpArmClient : ArmResource
    {
        ...
        private ClientDiagnostics CheckNameAvailabilityClientDiagnostics => _checkNameAvailabilityClientDiagnostics ??= new ClientDiagnostics("Azure.ResourceManager.Help", ProviderConstants.DefaultProviderNamespace, Diagnostics);
        ...
        public virtual async Task<Response<SelfHelpNameAvailabilityResult>> CheckSelfHelpNameAvailabilityAsync(ResourceIdentifier scope, SelfHelpNameAvailabilityContent content = null, CancellationToken cancellationToken = default)
        {
            ...
            using var scope0 = CheckNameAvailabilityClientDiagnostics.CreateScope("MockableHelpArmClient.CheckSelfHelpNameAvailability");
            scope0.Start();
            try
            {
