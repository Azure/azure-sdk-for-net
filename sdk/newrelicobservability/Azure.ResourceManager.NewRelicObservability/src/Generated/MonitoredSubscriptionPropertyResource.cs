...
namespace Azure.ResourceManager.NewRelicObservability
{
    ...
    /// Otherwise you can get one from its parent resource <see cref="NewRelicMonitorResource"/> using the GetMonitoredSubscriptionProperty method.
    /// </summary>
    public partial class MonitoredSubscriptionPropertyResource : ArmResource
    {
        ...
        public static ResourceIdentifier CreateResourceIdentifier(string subscriptionId, string resourceGroupName, string monitorName, ConfigurationName configurationName)
        {
        ...
        {
            _monitoredSubscriptionPropertyMonitoredSubscriptionsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.NewRelicObservability", ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new NewRelicObservabilityArmOperation(_monitoredSubscriptionPropertyMonitoredSubscriptionsClientDiagnostics, Pipeline, _monitoredSubscriptionPropertyMonitoredSubscriptionsRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name).Request, response, OperationFinalStateVia.Location);
