...
namespace Azure.ResourceManager.NewRelicObservability.Models
{
    ...
    public static partial class ArmNewRelicObservabilityModelFactory
    {
        ...
        {
            return new NewRelicAccountResourceData(id, name, resourceType, systemData, organizationId, accountId, accountName, region, default);
        }
        ...
        {
            return new NewRelicOrganizationResourceData(id, name, resourceType, systemData, organizationId, organizationName, billingSource, default);
        }
        ...
        {
            return new NewRelicPlanData(id, name, resourceType, systemData, planData, orgCreationSource, accountCreationSource, default);
        }
        ...
        public static NewRelicMetricsStatusContent NewRelicMetricsStatusContent(IEnumerable<string> azureResourceIds = null, string userEmail = null)
        {
            ...
            return new NewRelicMetricsStatusContent(azureResourceIds?.ToList(), userEmail, default);
        }
        ...
        public static NewRelicMetricsStatusResult NewRelicMetricsStatusResult(IEnumerable<string> azureResourceIds = null)
        {
            ...
            return new NewRelicMetricsStatusResult(azureResourceIds?.ToList(), default);
        }
        ...
        public static NewRelicAppServicesGetContent NewRelicAppServicesGetContent(IEnumerable<ResourceIdentifier> azureResourceIds = null, string userEmail = null)
        {
            ...
            return new NewRelicAppServicesGetContent(azureResourceIds?.ToList(), userEmail, default);
        }
        ...
        public static NewRelicHostsGetContent NewRelicHostsGetContent(IEnumerable<ResourceIdentifier> vmIds = null, string userEmail = null)
        {
            ...
            return new NewRelicHostsGetContent(vmIds?.ToList(), userEmail, default);
        }
        ...
        {
            return new NewRelicResourceMonitorResult(id, sendingMetrics, reasonForMetricsStatus, sendingLogs, reasonForLogsStatus, default);
        }
        ...
        {
            return new NewRelicObservabilityTagRuleData(id, name, resourceType, systemData, provisioningState, logRules, metricRules, default);
        }
