...
namespace Azure.ResourceManager.NewRelicObservability.Models
{
    ...
    public static partial class ArmNewRelicObservabilityModelFactory
    {
        ...
        {
            return new NewRelicAccountResourceData(id, name, resourceType, systemData, organizationId, accountId, accountName, region, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new NewRelicOrganizationResourceData(id, name, resourceType, systemData, organizationId, organizationName, billingSource, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new NewRelicPlanData(id, name, resourceType, systemData, planData, orgCreationSource, accountCreationSource, new Dictionary<string, BinaryData>());
        }
        ...
        public static NewRelicMetricsStatusContent NewRelicMetricsStatusContent(IEnumerable<string> azureResourceIds = null, string userEmail = null)
        {
            ...
            return new NewRelicMetricsStatusContent(azureResourceIds?.ToList(), userEmail, new Dictionary<string, BinaryData>());
        }
        ...
        public static NewRelicMetricsStatusResult NewRelicMetricsStatusResult(IEnumerable<string> azureResourceIds = null)
        {
            ...
            return new NewRelicMetricsStatusResult(azureResourceIds?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static NewRelicAppServicesGetContent NewRelicAppServicesGetContent(IEnumerable<ResourceIdentifier> azureResourceIds = null, string userEmail = null)
        {
            ...
            return new NewRelicAppServicesGetContent(azureResourceIds?.ToList(), userEmail, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new NewRelicObservabilityAppServiceInfo(azureResourceId, agentVersion, agentStatus, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new NewRelicSwitchBillingContent(azureResourceId, organizationId, planData, userEmail, new Dictionary<string, BinaryData>());
        }
        ...
        public static NewRelicHostsGetContent NewRelicHostsGetContent(IEnumerable<ResourceIdentifier> vmIds = null, string userEmail = null)
        {
            ...
            return new NewRelicHostsGetContent(vmIds?.ToList(), userEmail, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new NewRelicObservabilityVmInfo(vmId, agentVersion, agentStatus, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new NewRelicResourceMonitorResult(id, sendingMetrics, reasonForMetricsStatus, sendingLogs, reasonForLogsStatus, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new NewRelicObservabilityTagRuleData(id, name, resourceType, systemData, provisioningState, logRules, metricRules, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new NewRelicObservabilityVmExtensionPayload(ingestionKey, new Dictionary<string, BinaryData>());
        }
    }
}
