...
namespace Azure.ResourceManager.NewRelicObservability
{
    ...
    public partial class NewRelicMonitoredSubscriptionData : ResourceData
    {
        ...
        internal NewRelicMonitoredSubscriptionData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, NewRelicMonitoredSubscriptionProperties properties) : base(id, name, resourceType, systemData)
        {
