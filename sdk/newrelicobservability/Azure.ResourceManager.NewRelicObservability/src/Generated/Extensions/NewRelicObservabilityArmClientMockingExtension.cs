...
namespace Azure.ResourceManager.NewRelicObservability.Mocking
{
    ...
    internal partial class NewRelicObservabilityArmClientMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="NewRelicObservabilityArmClientMockingExtension"/> class for mocking. </summary>
        protected NewRelicObservabilityArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="NewRelicObservabilityArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal NewRelicObservabilityArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal NewRelicObservabilityArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
