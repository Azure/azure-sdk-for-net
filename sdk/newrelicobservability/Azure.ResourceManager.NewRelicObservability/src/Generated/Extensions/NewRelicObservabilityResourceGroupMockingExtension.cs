...
namespace Azure.ResourceManager.NewRelicObservability.Mocking
{
    ...
    internal partial class NewRelicObservabilityResourceGroupMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="NewRelicObservabilityResourceGroupMockingExtension"/> class for mocking. </summary>
        protected NewRelicObservabilityResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="NewRelicObservabilityResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal NewRelicObservabilityResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
