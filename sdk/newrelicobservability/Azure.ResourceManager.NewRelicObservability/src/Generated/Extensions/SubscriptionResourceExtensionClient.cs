...
namespace Azure.ResourceManager.NewRelicObservability
{
    ...
    internal partial class SubscriptionResourceExtensionClient : ArmResource
    {
        ...
        public virtual AsyncPageable<NewRelicAccountResourceData> GetAccountsAsync(string userEmail, AzureLocation location, CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, NewRelicAccountResourceData.DeserializeNewRelicAccountResourceData, AccountsClientDiagnostics, Pipeline, "SubscriptionResourceExtensionClient.GetAccounts", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<NewRelicAccountResourceData> GetAccounts(string userEmail, AzureLocation location, CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => AccountsRestClient.CreateListRequest(Id.SubscriptionId, userEmail, location);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => AccountsRestClient.CreateListNextPageRequest(nextLink, Id.SubscriptionId, userEmail, location);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, NewRelicAccountResourceData.DeserializeNewRelicAccountResourceData, AccountsClientDiagnostics, Pipeline, "SubscriptionResourceExtensionClient.GetAccounts", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual AsyncPageable<NewRelicOrganizationResourceData> GetOrganizationsAsync(string userEmail, AzureLocation location, CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, NewRelicOrganizationResourceData.DeserializeNewRelicOrganizationResourceData, OrganizationsClientDiagnostics, Pipeline, "SubscriptionResourceExtensionClient.GetOrganizations", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<NewRelicOrganizationResourceData> GetOrganizations(string userEmail, AzureLocation location, CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => OrganizationsRestClient.CreateListRequest(Id.SubscriptionId, userEmail, location);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => OrganizationsRestClient.CreateListNextPageRequest(nextLink, Id.SubscriptionId, userEmail, location);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, NewRelicOrganizationResourceData.DeserializeNewRelicOrganizationResourceData, OrganizationsClientDiagnostics, Pipeline, "SubscriptionResourceExtensionClient.GetOrganizations", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual AsyncPageable<NewRelicPlanResourceData> GetPlansAsync(string accountId = null, string organizationId = null, CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, NewRelicPlanResourceData.DeserializeNewRelicPlanResourceData, PlansClientDiagnostics, Pipeline, "SubscriptionResourceExtensionClient.GetPlans", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<NewRelicPlanResourceData> GetPlans(string accountId = null, string organizationId = null, CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => PlansRestClient.CreateListRequest(Id.SubscriptionId, accountId, organizationId);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => PlansRestClient.CreateListNextPageRequest(nextLink, Id.SubscriptionId, accountId, organizationId);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, NewRelicPlanResourceData.DeserializeNewRelicPlanResourceData, PlansClientDiagnostics, Pipeline, "SubscriptionResourceExtensionClient.GetPlans", "value", "nextLink", cancellationToken);
        }
    }
}
