...
{
    internal partial class OrganizationsGetNewRelicOrganizationsCollectionResultOfT : Pageable<NewRelicOrganizationResourceData>
    {
        ...
        /// <summary> Initializes a new instance of OrganizationsGetNewRelicOrganizationsCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public OrganizationsGetNewRelicOrganizationsCollectionResultOfT(Organizations client, string subscriptionId, string userEmail, AzureLocation location, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of OrganizationsGetNewRelicOrganizationsCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of OrganizationsGetNewRelicOrganizationsCollectionResultOfT as an enumerable collection. </returns>
