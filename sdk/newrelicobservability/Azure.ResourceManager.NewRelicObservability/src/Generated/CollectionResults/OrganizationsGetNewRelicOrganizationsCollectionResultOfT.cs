...
namespace Azure.ResourceManager.NewRelicObservability
{
    internal partial class OrganizationsGetNewRelicOrganizationsCollectionResultOfT : Pageable<NewRelicOrganizationResourceData>
    {
        ...
        public OrganizationsGetNewRelicOrganizationsCollectionResultOfT(Organizations client, string subscriptionId, string userEmail, string location, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
