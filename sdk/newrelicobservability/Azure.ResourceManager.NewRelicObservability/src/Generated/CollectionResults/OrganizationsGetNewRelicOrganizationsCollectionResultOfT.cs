...
namespace Azure.ResourceManager.NewRelicObservability
{
    internal partial class OrganizationsGetNewRelicOrganizationsCollectionResultOfT : Pageable<NewRelicOrganizationResourceData>
    {
        ...
        public OrganizationsGetNewRelicOrganizationsCollectionResultOfT(Organizations client, string subscriptionId, string userEmail, AzureLocation location, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
