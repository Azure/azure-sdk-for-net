...
{
    internal partial class MonitorsGetMonitoredResourcesCollectionResultOfT : Pageable<NewRelicResourceMonitorResult>
    {
        ...
        /// <summary> Initializes a new instance of MonitorsGetMonitoredResourcesCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public MonitorsGetMonitoredResourcesCollectionResultOfT(Monitors client, string subscriptionId, string resourceGroupName, string monitorName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of MonitorsGetMonitoredResourcesCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of MonitorsGetMonitoredResourcesCollectionResultOfT as an enumerable collection. </returns>
