...
namespace Azure.ResourceManager.NewRelicObservability
{
    internal partial class MonitorsGetMonitoredResourcesCollectionResultOfT : Pageable<NewRelicResourceMonitorResult>
    {
        ...
        public MonitorsGetMonitoredResourcesCollectionResultOfT(Monitors client, string subscriptionId, string resourceGroupName, string monitorName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
