...
{
    internal partial class MonitorsGetMonitoredResourcesAsyncCollectionResultOfT : AsyncPageable<NewRelicResourceMonitorResult>
    {
        ...
        public override async IAsyncEnumerable<Page<NewRelicResourceMonitorResult>> AsPages(string continuationToken, int? pageSizeHint)
        {
        ...
        private async ValueTask<Response> GetNextResponseAsync(int? pageSizeHint, Uri nextLink)
        {
            ...
            using DiagnosticScope scope = _client.ClientDiagnostics.CreateScope("NewRelicMonitorResource.GetMonitoredResources");
            scope.Start();
            try
            {
