...
{
    internal partial class OrganizationsGetNewRelicOrganizationsAsyncCollectionResultOfT : AsyncPageable<NewRelicOrganizationResourceData>
    {
        ...
        /// <returns> The pages of OrganizationsGetNewRelicOrganizationsAsyncCollectionResultOfT as an enumerable collection. </returns>
        public override async IAsyncEnumerable<Page<NewRelicOrganizationResourceData>> AsPages(string continuationToken, int? pageSizeHint)
        {
