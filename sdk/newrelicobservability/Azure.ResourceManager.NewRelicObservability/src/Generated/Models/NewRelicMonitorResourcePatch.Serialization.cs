...
namespace Azure.ResourceManager.NewRelicObservability.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NewRelicMonitorResourcePatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NewRelicMonitorResourcePatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NewRelicMonitorResourcePatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<NewRelicMonitorResourcePatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
