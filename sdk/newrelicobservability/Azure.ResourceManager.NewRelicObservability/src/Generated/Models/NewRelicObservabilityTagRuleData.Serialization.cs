...
namespace Azure.ResourceManager.NewRelicObservability
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NewRelicObservabilityTagRuleData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NewRelicObservabilityTagRuleData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NewRelicObservabilityTagRuleData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<NewRelicObservabilityTagRuleData>)} interface");
            }
        ...
        string IPersistableModel<NewRelicObservabilityTagRuleData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
