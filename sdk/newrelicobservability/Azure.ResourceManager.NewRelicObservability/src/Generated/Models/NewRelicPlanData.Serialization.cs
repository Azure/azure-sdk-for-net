...
namespace Azure.ResourceManager.NewRelicObservability.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NewRelicPlanData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NewRelicPlanData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NewRelicPlanData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<NewRelicPlanData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
