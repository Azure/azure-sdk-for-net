...
namespace Azure.ResourceManager.NewRelicObservability.Models
{
    public partial class NewRelicPlanData : IUtf8JsonSerializable, IJsonModel<NewRelicPlanData>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<NewRelicPlanData>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<NewRelicPlanData>)} interface");
            }
