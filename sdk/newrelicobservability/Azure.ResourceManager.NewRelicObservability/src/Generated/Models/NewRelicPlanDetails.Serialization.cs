...
{
    public partial class NewRelicPlanDetails : IUtf8JsonSerializable, IJsonModel<NewRelicPlanDetails>, IPersistableModel<NewRelicPlanDetails>
    {
        ...
        void IJsonModel<NewRelicPlanDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(NewRelicPlanDetails)} does not support '{format}' format.");
            }
