...
namespace Azure.ResourceManager.NewRelicObservability.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NewRelicPlanDetails>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NewRelicPlanDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NewRelicPlanDetails>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<NewRelicPlanDetails>)} interface");
            }
        ...
        string IPersistableModel<NewRelicPlanDetails>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
