...
namespace Azure.ResourceManager.NewRelicObservability
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NewRelicMonitorResourceData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NewRelicMonitorResourceData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NewRelicMonitorResourceData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<NewRelicMonitorResourceData>)} interface");
            }
        ...
        string IPersistableModel<NewRelicMonitorResourceData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
