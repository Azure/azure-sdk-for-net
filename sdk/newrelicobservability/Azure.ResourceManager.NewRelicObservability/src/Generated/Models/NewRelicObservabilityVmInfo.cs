...
namespace Azure.ResourceManager.NewRelicObservability.Models
{
    ...
    public partial class NewRelicObservabilityVmInfo
    {
        ...
        internal NewRelicObservabilityVmInfo(ResourceIdentifier vmId, string agentVersion, string agentStatus, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            VmId = vmId;
