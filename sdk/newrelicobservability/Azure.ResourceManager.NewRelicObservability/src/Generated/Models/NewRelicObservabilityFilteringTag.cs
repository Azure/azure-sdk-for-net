...
namespace Azure.ResourceManager.NewRelicObservability.Models
{
    ...
    public partial class NewRelicObservabilityFilteringTag
    {
        ...
        internal NewRelicObservabilityFilteringTag(string name, string value, NewRelicObservabilityTagAction? action, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Value = value;
            Action = action;
