...
namespace Azure.ResourceManager.NewRelicObservability.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NewRelicAccountResourceData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NewRelicAccountResourceData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NewRelicAccountResourceData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<NewRelicAccountResourceData>)} interface");
            }
        ...
        string IPersistableModel<NewRelicAccountResourceData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
