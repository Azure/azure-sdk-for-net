        ...
        internal static SubscriptionList DeserializeSubscriptionList(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("patchOperation"u8))
                {
                    ...
                    patchOperation = new PatchOperation(property.Value.GetString());
                    continue;
                }
            ...
            return new SubscriptionList(patchOperation, monitoredSubscriptionList ?? new ChangeTrackingList<MonitoredSubscription>(), provisioningState, serializedAdditionalRawData);
        }
