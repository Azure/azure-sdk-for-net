...
namespace Azure.ResourceManager.NewRelicObservability.Models
{
    public partial class NewRelicMetricsStatusContent : IUtf8JsonSerializable, IJsonModel<NewRelicMetricsStatusContent>
    {
        ...
        void IJsonModel<NewRelicMetricsStatusContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(NewRelicMetricsStatusContent)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<NewRelicMetricsStatusContent>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(NewRelicMetricsStatusContent)} does not support '{options.Format}' format.");
            }
        }
