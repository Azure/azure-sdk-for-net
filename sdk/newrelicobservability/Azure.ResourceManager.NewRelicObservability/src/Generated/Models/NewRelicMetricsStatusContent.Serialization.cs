...
namespace Azure.ResourceManager.NewRelicObservability.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NewRelicMetricsStatusContent>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<NewRelicMetricsStatusContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NewRelicMetricsStatusContent>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
