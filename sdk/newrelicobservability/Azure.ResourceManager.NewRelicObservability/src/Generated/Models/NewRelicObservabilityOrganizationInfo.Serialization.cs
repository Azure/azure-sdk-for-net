...
namespace Azure.ResourceManager.NewRelicObservability.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NewRelicObservabilityOrganizationInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NewRelicObservabilityOrganizationInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NewRelicObservabilityOrganizationInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<NewRelicObservabilityOrganizationInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
