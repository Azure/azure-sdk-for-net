...
{
    public partial class NewRelicResourceMonitorResult : IUtf8JsonSerializable, IJsonModel<NewRelicResourceMonitorResult>, IPersistableModel<NewRelicResourceMonitorResult>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SendingMetrics))
            {
                ...
                builder.AppendLine($" '{SendingMetrics.ToString()}'");
            }
            ...
            if (Optional.IsDefined(SendingLogs))
            {
                ...
                builder.AppendLine($" '{SendingLogs.ToString()}'");
            }
