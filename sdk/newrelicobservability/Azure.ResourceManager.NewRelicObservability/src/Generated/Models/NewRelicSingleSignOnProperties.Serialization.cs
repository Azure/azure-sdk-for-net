...
namespace Azure.ResourceManager.NewRelicObservability.Models
{
    ...
    public partial class NewRelicSingleSignOnProperties : IJsonModel<NewRelicSingleSignOnProperties>
    {
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual NewRelicSingleSignOnProperties PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<NewRelicSingleSignOnProperties>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<NewRelicSingleSignOnProperties>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        NewRelicSingleSignOnProperties IPersistableModel<NewRelicSingleSignOnProperties>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        NewRelicSingleSignOnProperties IJsonModel<NewRelicSingleSignOnProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual NewRelicSingleSignOnProperties JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<NewRelicSingleSignOnProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static NewRelicSingleSignOnProperties DeserializeNewRelicSingleSignOnProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                if (prop.NameEquals("singleSignOnState"u8))
                {
                    ...
                    singleSignOnState = new NewRelicSingleSignOnState(prop.Value.GetString());
                    continue;
                }
            ...
            return new NewRelicSingleSignOnProperties(singleSignOnState, enterpriseAppId, singleSignOnUri, provisioningState, additionalBinaryDataProperties);
        }
    }
}
