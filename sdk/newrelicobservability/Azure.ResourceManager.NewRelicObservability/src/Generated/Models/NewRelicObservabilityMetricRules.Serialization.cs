...
{
    public partial class NewRelicObservabilityMetricRules : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static NewRelicObservabilityMetricRules DeserializeNewRelicObservabilityMetricRules(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
