...
{
    public partial class NewRelicObservabilityMetricRules : IUtf8JsonSerializable, IJsonModel<NewRelicObservabilityMetricRules>, IPersistableModel<NewRelicObservabilityMetricRules>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SendMetrics))
            {
                ...
                builder.AppendLine($" '{SendMetrics.ToString()}'");
            }
