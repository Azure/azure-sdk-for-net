...
namespace Azure.ResourceManager.NewRelicObservability.Models
{
    ...
    public partial class NewRelicObservabilitySaaSResourceDetailsResult : ResourceData
    {
        ...
        internal NewRelicObservabilitySaaSResourceDetailsResult(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string saasId, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, name, resourceType, systemData)
        {
            SaasId = saasId;
