...
namespace Azure.ResourceManager.NewRelicObservability
{
    public partial class TagRuleData : IUtf8JsonSerializable
    {
        ...
        internal static TagRuleData DeserializeTagRuleData(JsonElement element, SerializableOptions options = default)
        {
            ...
            return new TagRuleData(id, name, type, systemData.Value, Optional.ToNullable(provisioningState), logRules.Value, metricRules.Value);
        }
    }
}
