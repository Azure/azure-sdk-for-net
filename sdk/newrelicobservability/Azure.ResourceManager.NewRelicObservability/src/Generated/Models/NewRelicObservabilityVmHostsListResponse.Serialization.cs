...
namespace Azure.ResourceManager.NewRelicObservability.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NewRelicObservabilityVmHostsListResponse>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NewRelicObservabilityVmHostsListResponse>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NewRelicObservabilityVmHostsListResponse>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<NewRelicObservabilityVmHostsListResponse>)} interface");
            }
        ...
        string IPersistableModel<NewRelicObservabilityVmHostsListResponse>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
