...
namespace Azure.ResourceManager.NewRelicObservability.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NewRelicObservabilityLogRules>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NewRelicObservabilityLogRules>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NewRelicObservabilityLogRules>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<NewRelicObservabilityLogRules>)} interface");
            }
        ...
        string IPersistableModel<NewRelicObservabilityLogRules>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
