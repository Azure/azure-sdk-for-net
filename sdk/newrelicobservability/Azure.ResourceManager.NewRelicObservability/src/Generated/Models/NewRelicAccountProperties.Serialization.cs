...
namespace Azure.ResourceManager.NewRelicObservability.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NewRelicAccountProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NewRelicAccountProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NewRelicAccountProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<NewRelicAccountProperties>)} interface");
            }
        ...
        string IPersistableModel<NewRelicAccountProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
