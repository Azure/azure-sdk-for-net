...
namespace Azure.ResourceManager.NewRelicObservability.Models
{
    ...
    public partial class NewRelicObservabilityUserInfo
    {
        ...
        internal NewRelicObservabilityUserInfo(string firstName, string lastName, string emailAddress, string phoneNumber, string country, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            FirstName = firstName;
            LastName = lastName;
