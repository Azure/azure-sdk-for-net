...
namespace Azure.ResourceManager.NewRelicObservability.Models
{
    ...
    public partial class NewRelicObservabilityUserInfo
    {
        ...
        internal NewRelicObservabilityUserInfo(string firstName, string lastName, string emailAddress, string phoneNumber, string country, Dictionary<string, BinaryData> rawData)
        {
            FirstName = firstName;
            LastName = lastName;
