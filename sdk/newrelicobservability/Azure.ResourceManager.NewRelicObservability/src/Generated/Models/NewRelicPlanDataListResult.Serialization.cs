...
namespace Azure.ResourceManager.NewRelicObservability.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NewRelicPlanDataListResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(NewRelicPlanDataListResult)} does not support writing '{format}' format.");
            }
            ...
            {
                ((IJsonModel<NewRelicPlanData>)item).Write(writer, options);
            }
        ...
        NewRelicPlanDataListResult IJsonModel<NewRelicPlanDataListResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(NewRelicPlanDataListResult)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<NewRelicPlanDataListResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(NewRelicPlanDataListResult)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        NewRelicPlanDataListResult IPersistableModel<NewRelicPlanDataListResult>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(NewRelicPlanDataListResult)} does not support reading '{options.Format}' format.");
            }
        }
