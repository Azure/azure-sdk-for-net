...
namespace Azure.ResourceManager.NewRelicObservability.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NewRelicPlanDataListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NewRelicPlanDataListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NewRelicPlanDataListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<NewRelicPlanDataListResult>)} interface");
            }
        ...
        string IPersistableModel<NewRelicPlanDataListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
