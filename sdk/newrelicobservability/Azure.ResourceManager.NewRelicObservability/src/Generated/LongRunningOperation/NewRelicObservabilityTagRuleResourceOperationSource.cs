...
{
    /// <summary></summary>
    internal partial class NewRelicObservabilityTagRuleResourceOperationSource : IOperationSource<NewRelicObservabilityTagRuleResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal NewRelicObservabilityTagRuleResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
