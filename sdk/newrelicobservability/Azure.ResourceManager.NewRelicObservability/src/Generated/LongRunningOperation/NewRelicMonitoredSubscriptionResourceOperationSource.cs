...
{
    /// <summary></summary>
    internal partial class NewRelicMonitoredSubscriptionResourceOperationSource : IOperationSource<NewRelicMonitoredSubscriptionResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal NewRelicMonitoredSubscriptionResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
