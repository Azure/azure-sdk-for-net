...
{
    /// <summary></summary>
    internal partial class NewRelicMonitorResourceOperationSource : IOperationSource<NewRelicMonitorResource>
    {
        ...
        NewRelicMonitorResource IOperationSource<NewRelicMonitorResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            NewRelicMonitorResourceData data = NewRelicMonitorResourceData.DeserializeNewRelicMonitorResourceData(document.RootElement, ModelSerializationExtensions.WireOptions);
