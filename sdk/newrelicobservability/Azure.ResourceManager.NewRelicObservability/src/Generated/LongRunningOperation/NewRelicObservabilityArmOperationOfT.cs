...
{
    internal partial class NewRelicObservabilityArmOperation<T> : ArmOperation<T>
    {
        ...
        internal NewRelicObservabilityArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal<T>(
                ...
                clientDiagnostics,
                response,
                "NewRelicObservabilityArmOperation",
                null,
