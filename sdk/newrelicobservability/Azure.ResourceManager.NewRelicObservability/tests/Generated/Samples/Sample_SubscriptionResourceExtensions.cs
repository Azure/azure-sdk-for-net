...
namespace Azure.ResourceManager.NewRelicObservability.Samples
{
    public partial class Sample_SubscriptionResourceExtensions
    {
        ...
        public async Task ActivateResourceSaaS_ActivateSaaS()
        {
            ...
            ActivateSaaSParameterContent content = new ActivateSaaSParameterContent(Guid.Parse("00000000-0000-0000-0000-000005430000"), "publisherId");
            NewRelicSaaSResourceDetailsResult result = await subscriptionResource.ActivateResourceSaaSAsync(content);
