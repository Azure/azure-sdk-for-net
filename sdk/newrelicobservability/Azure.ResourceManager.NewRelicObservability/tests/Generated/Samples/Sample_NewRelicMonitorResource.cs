...
["key164"] = "jqakdrrmmyzytqu"
        ...
        public async Task LatestLinkedSaaS_MonitorsLatestLinkedSaaSMaximumSetGen()
        {
            ...
            // invoke the operation
            NewRelicLatestLinkedSaaSResult result = await newRelicMonitorResource.LatestLinkedSaaSAsync();
        ...
        public async Task LinkSaaS_MonitorsLinkSaaS()
        {
            ...
            // invoke the operation
            NewRelicSaaSDataDetails details = new NewRelicSaaSDataDetails
            {
            ...
            ArmOperation<NewRelicMonitorResource> lro = await newRelicMonitorResource.LinkSaaSAsync(WaitUntil.Completed, details);
            NewRelicMonitorResource result = lro.Value;
