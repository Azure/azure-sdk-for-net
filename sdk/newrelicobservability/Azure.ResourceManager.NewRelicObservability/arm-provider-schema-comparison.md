...
| --- | --- | --- |
| `/subscriptions/{}/resourcegroups/{}/providers/newrelic.observability/monitors/{}/monitoredsubscriptions/{}` | `NewRelicMonitoredSubscription` | `MonitoredSubscriptionProperties` |
| `/subscriptions/{}/resourcegroups/{}/providers/newrelic.observability/monitors/{}/tagrules/{}` | `NewRelicObservabilityTagRule` | `TagRule` |
