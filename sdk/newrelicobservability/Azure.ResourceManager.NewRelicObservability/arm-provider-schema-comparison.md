# ARM provider schema comparison: Azure.ResourceManager.NewRelicObservability
...
| --- | --- | --- |
| `/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/NewRelic.Observability/monitors/{monitorName}/monitoredSubscriptions/{configurationName}` | `NewRelicMonitoredSubscription` | `MonitoredSubscriptionProperties` |
| `/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/NewRelic.Observability/monitors/{monitorName}/tagRules/{ruleSetName}` | `NewRelicObservabilityTagRule` | `TagRule` |
