...
namespace Azure.ResourceManager.Fleet.Models
{
    ...
    public partial class ComputeProfile
    {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="baseVirtualMachineProfile"/> or <paramref name="computeApiVersion"/> is null. </exception>
        public ComputeProfile(VirtualMachineScaleSetVmProfile baseVirtualMachineProfile, string computeApiVersion)
        {
