...
{
    /// <summary> Ondemand allocation strategy types for Fleet. </summary>
    public readonly partial struct RegularPriorityAllocationStrategy : IEquatable<RegularPriorityAllocationStrategy>
    {
        ...
        /// <summary> Default. Sku split will be determined to optimize for price. Note: Capacity will still be considered here but will be given much less weight. </summary>
        public static RegularPriorityAllocationStrategy LowestPrice { get; } = new RegularPriorityAllocationStrategy(LowestPriceValue);
        /// <summary> Sku split will be determined to optimize for the "priority" as specified for each vm size. </summary>
