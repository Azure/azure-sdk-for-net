...
{
    public partial class VmDiskSecurityProfile : IUtf8JsonSerializable
    {
        ...
        internal static VmDiskSecurityProfile DeserializeVmDiskSecurityProfile(JsonElement element)
        {
            ...
            return new VmDiskSecurityProfile(Optional.ToNullable(securityEncryptionType), diskEncryptionSet);
        }
    }
}
