...
namespace Azure.ResourceManager.Fleet.Models
{
    ...
    public partial class VirtualMachineScaleSetDataDisk
    {
        ...
        internal VirtualMachineScaleSetDataDisk(string name, int lun, CachingType? caching, bool? writeAcceleratorEnabled, DiskCreateOptionType createOption, int? diskSizeGB, VirtualMachineScaleSetManagedDiskContent managedDisk, long? diskIopsReadWrite, long? diskMBpsReadWrite, DiskDeleteOptionType? deleteOption)
        {
            Name = name;
            Lun = lun;
            Caching = caching;
        ...
        public VirtualMachineScaleSetManagedDiskContent ManagedDisk { get; set; }
