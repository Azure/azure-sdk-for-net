...
namespace Azure.ResourceManager.Fleet.Models
{
    ...
    public partial class BaseVirtualMachineProfileUpdate
    {
        /// <summary> Initializes a new instance of <see cref="BaseVirtualMachineProfileUpdate"/>. </summary>
        public BaseVirtualMachineProfileUpdate()
        {
            VirtualMachineProfile = new ChangeTrackingDictionary<string, BinaryData>();
        }
        ...
        internal BaseVirtualMachineProfileUpdate(IDictionary<string, BinaryData> virtualMachineProfile, string computeApiVersion)
        {
