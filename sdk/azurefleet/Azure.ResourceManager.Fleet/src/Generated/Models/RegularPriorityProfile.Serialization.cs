...
{
    public partial class RegularPriorityProfile : IUtf8JsonSerializable
    {
        ...
        internal static RegularPriorityProfile DeserializeRegularPriorityProfile(JsonElement element)
        {
            ...
            return new RegularPriorityProfile(Optional.ToNullable(capacity), Optional.ToNullable(minCapacity), Optional.ToNullable(allocationStrategy));
        }
    }
}
