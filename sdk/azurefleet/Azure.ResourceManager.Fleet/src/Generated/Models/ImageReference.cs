...
namespace Azure.ResourceManager.Fleet.Models
{
    ...
    public partial class ImageReference : SubResource
    {
        ...
        internal ImageReference(string id, string publisher, string offer, string sku, string version, string exactVersion, string sharedGalleryImageId, string communityGalleryImageId) : base(id)
        {
            Publisher = publisher;
            Offer = offer;
            Sku = sku;
