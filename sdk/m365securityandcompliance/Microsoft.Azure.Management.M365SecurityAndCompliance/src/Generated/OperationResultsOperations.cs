...
namespace Microsoft.Azure.Management.M365SecurityAndCompliance
{
    ...
    /// </summary>
    internal partial class OperationResultsOperations : IServiceOperations<M365SecurityAndComplianceClient>, IOperationResultsOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal OperationResultsOperations(M365SecurityAndComplianceClient client)
        {
            if (client == null)
            {
        ...
        public async Task<AzureOperationResponse<OperationResultsDescription>> GetWithHttpMessagesAsync(string locationName, string operationResultId, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "subscriptions/{subscriptionId}/providers/Microsoft.M365SecurityAndCompliance/locations/{locationName}/operationresults/{operationResultId}").ToString();
