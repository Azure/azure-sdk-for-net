...
namespace Microsoft.Azure.Management.M365SecurityAndCompliance
{
    ...
    /// </summary>
    internal partial class Operations : IServiceOperations<M365SecurityAndComplianceClient>, IOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal Operations(M365SecurityAndComplianceClient client)
        {
            if (client == null)
            {
        ...
        public async Task<AzureOperationResponse<IPage<Operation>>> ListWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "providers/Microsoft.M365SecurityAndCompliance/operations").ToString();
