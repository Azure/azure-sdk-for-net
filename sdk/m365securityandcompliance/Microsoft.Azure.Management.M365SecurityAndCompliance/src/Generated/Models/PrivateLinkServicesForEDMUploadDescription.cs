...
namespace Microsoft.Azure.Management.M365SecurityAndCompliance.Models
{
    ...
    public partial class PrivateLinkServicesForEDMUploadDescription : ServicesResource
    {
        ...
        /// service.</param>
        public PrivateLinkServicesForEDMUploadDescription(Kind kind, string location, string id = default(string), string name = default(string), string type = default(string), SystemData systemData = default(SystemData), IDictionary<string, string> tags = default(IDictionary<string, string>), string etag = default(string), ServicesResourceIdentity identity = default(ServicesResourceIdentity), ServicesProperties properties = default(ServicesProperties))
