...
namespace Azure.ResourceManager.NetworkCloud.Samples
{
    public partial class Sample_NetworkCloudClusterResource
    {
        ...
        public async Task Delete_DeleteCluster()
        {
            ...
            // invoke the operation
            await networkCloudCluster.DeleteAsync(WaitUntil.Completed).ConfigureAwait(false);
...
["key2"] = "myvalue2"
        ...
        public async Task Deploy_DeployCluster()
        {
            ...
            ArmOperation<NetworkCloudOperationStatusResult> lro = await networkCloudCluster.DeployAsync(WaitUntil.Completed, content);
