    ...
    public partial class Sample_NetworkCloudVirtualMachineCollection
    {
        ...
        public async Task CreateOrUpdate_CreateOrUpdateVirtualMachine()
        {
            ...
            NetworkCloudVirtualMachineData data = new NetworkCloudVirtualMachineData(
                ...
                "username",
                new NetworkAttachment("/subscriptions/123e4567-e89b-12d3-a456-426655440000/resourceGroups/resourceGroupName/providers/Microsoft.NetworkCloud/cloudServicesNetworks/cloudServicesNetworkName", VirtualMachineIPAllocationMethod.Dynamic),
                2L,
                8L,
                ...
                "myacr.azurecr.io/foobar:latest")
            {
                ...
                NetworkAttachments = {new NetworkAttachment("/subscriptions/123e4567-e89b-12d3-a456-426655440000/resourceGroups/resourceGroupName/providers/Microsoft.NetworkCloud/l3Networks/l3NetworkName", VirtualMachineIPAllocationMethod.Dynamic)
{
