...
{
    public partial class Sample_RackCollection
    {
        ...
        {
            // Generated from example definition: specification/networkcloud/resource-manager/Microsoft.NetworkCloud/preview/2022-12-12-preview/examples/Racks_ListByResourceGroup.json
            ...
            // get the collection of this RackResource
            RackCollection collection = resourceGroupResource.GetRacks();

            // invoke the operation and iterate over the result
            await foreach (RackResource item in collection.GetAllAsync())
            {
        ...
        public async Task Get_GetRack()
        {
            ...
            RackResource result = await collection.GetAsync(rackName);
