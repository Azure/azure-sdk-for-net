...
["key2"] = "myvalue2"
        ...
        public async Task Cordon_CordonBareMetalMachine()
        {
            ...
            ArmOperation<NetworkCloudOperationStatusResult> lro = await networkCloudBareMetalMachine.CordonAsync(WaitUntil.Completed, content);
        ...
        public async Task PowerOff_PowerOffBareMetalMachine()
        {
            ...
            ArmOperation<NetworkCloudOperationStatusResult> lro = await networkCloudBareMetalMachine.PowerOffAsync(WaitUntil.Completed, content);
            NetworkCloudOperationStatusResult result = lro.Value;
        ...
        public async Task Replace_ReplaceBareMetalMachine()
        {
            ...
            ArmOperation<NetworkCloudOperationStatusResult> lro = await networkCloudBareMetalMachine.ReplaceAsync(WaitUntil.Completed, content);
            NetworkCloudOperationStatusResult result = lro.Value;
