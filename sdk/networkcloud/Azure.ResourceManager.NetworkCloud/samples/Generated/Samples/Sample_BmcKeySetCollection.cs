...
{
    public partial class Sample_BmcKeySetCollection
    {
        // List baseboard management controller key set of cluster for resource group
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task GetAll_ListBaseboardManagementControllerKeySetOfClusterForResourceGroup()
        {
            // Generated from example definition: specification/networkcloud/resource-manager/Microsoft.NetworkCloud/preview/2022-12-12-preview/examples/BmcKeySets_ListByResourceGroup.json
            // this example is just showing the usage of "BmcKeySets_ListByResourceGroup" operation, for the dependent resources, they will have to be created separately.
            ...
            // get the collection of this BmcKeySetResource
            ...
            await foreach (BmcKeySetResource item in collection.GetAllAsync())
            {
                ...
                BmcKeySetData resourceData = item.Data;
        ...
        public async Task Get_GetBaseboardManagementControllerKeySetOfCluster()
        {
            ...
            BmcKeySetResource result = await collection.GetAsync(bmcKeySetName);
        ...
        {
            // Generated from example definition: specification/networkcloud/resource-manager/Microsoft.NetworkCloud/preview/2022-12-12-preview/examples/BmcKeySets_Create.json
...
["key2"] = "myvalue2",
            ...
            ArmOperation<BmcKeySetResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, bmcKeySetName, data);
