...
namespace Azure.ResourceManager.NetworkCloud
{
    public partial class NetworkCloudVirtualMachineResource : IJsonModel<NetworkCloudVirtualMachineData>
    {
        ...
        {
            return ModelReaderWriter.Read<NetworkCloudVirtualMachineData>(new BinaryData(reader.ValueSequence), options);
        }
        ...
        {
            return ModelReaderWriter.Read<NetworkCloudVirtualMachineData>(data, options);
        }
