...
{
    /// <summary></summary>
    internal partial class NetworkCloudKubernetesVersionResourceOperationSource : IOperationSource<NetworkCloudKubernetesVersionResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal NetworkCloudKubernetesVersionResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
