...
{
    /// <summary></summary>
    internal partial class NetworkCloudTrunkedNetworkResourceOperationSource : IOperationSource<NetworkCloudTrunkedNetworkResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal NetworkCloudTrunkedNetworkResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
