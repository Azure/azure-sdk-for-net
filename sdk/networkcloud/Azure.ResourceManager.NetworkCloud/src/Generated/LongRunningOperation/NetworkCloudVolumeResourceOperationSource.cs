...
{
    /// <summary></summary>
    internal partial class NetworkCloudVolumeResourceOperationSource : IOperationSource<NetworkCloudVolumeResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal NetworkCloudVolumeResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
