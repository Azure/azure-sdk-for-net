...
{
    /// <summary></summary>
    internal partial class NetworkCloudBmcKeySetResourceOperationSource : IOperationSource<NetworkCloudBmcKeySetResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal NetworkCloudBmcKeySetResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
