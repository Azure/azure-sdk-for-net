...
{
    /// <summary></summary>
    internal partial class NetworkCloudAgentPoolResourceOperationSource : IOperationSource<NetworkCloudAgentPoolResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal NetworkCloudAgentPoolResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
