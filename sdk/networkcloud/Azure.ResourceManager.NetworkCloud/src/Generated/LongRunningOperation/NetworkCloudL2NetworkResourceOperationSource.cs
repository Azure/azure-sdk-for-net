...
{
    /// <summary></summary>
    internal partial class NetworkCloudL2NetworkResourceOperationSource : IOperationSource<NetworkCloudL2NetworkResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal NetworkCloudL2NetworkResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
