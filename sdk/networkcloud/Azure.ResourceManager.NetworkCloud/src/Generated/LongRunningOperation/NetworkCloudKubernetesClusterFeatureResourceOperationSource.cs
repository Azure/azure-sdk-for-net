...
{
    /// <summary></summary>
    internal partial class NetworkCloudKubernetesClusterFeatureResourceOperationSource : IOperationSource<NetworkCloudKubernetesClusterFeatureResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal NetworkCloudKubernetesClusterFeatureResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
