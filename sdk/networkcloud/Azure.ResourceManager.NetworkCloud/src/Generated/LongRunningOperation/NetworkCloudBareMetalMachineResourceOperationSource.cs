...
{
    /// <summary></summary>
    internal partial class NetworkCloudBareMetalMachineResourceOperationSource : IOperationSource<NetworkCloudBareMetalMachineResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal NetworkCloudBareMetalMachineResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
