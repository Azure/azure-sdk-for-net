...
namespace Azure.ResourceManager.NetworkCloud
{
    internal partial class NetworkCloudArmOperation<T> : ArmOperation<T>
    {
        ...
        internal NetworkCloudArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
