...
{
    /// <summary></summary>
    internal partial class NetworkCloudClusterMetricsConfigurationResourceOperationSource : IOperationSource<NetworkCloudClusterMetricsConfigurationResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal NetworkCloudClusterMetricsConfigurationResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
        ...
        NetworkCloudClusterMetricsConfigurationResource IOperationSource<NetworkCloudClusterMetricsConfigurationResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            NetworkCloudClusterMetricsConfigurationData data = NetworkCloudClusterMetricsConfigurationData.DeserializeNetworkCloudClusterMetricsConfigurationData(document.RootElement, ModelSerializationExtensions.WireOptions);
