...
{
    /// <summary></summary>
    internal partial class NetworkCloudBareMetalMachineKeySetResourceOperationSource : IOperationSource<NetworkCloudBareMetalMachineKeySetResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal NetworkCloudBareMetalMachineKeySetResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
