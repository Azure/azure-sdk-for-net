...
{
    /// <summary></summary>
    internal partial class NetworkCloudCloudServicesNetworkResourceOperationSource : IOperationSource<NetworkCloudCloudServicesNetworkResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal NetworkCloudCloudServicesNetworkResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
