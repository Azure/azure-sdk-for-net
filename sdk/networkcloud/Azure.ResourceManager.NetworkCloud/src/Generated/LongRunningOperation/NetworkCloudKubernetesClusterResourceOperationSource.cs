...
{
    /// <summary></summary>
    internal partial class NetworkCloudKubernetesClusterResourceOperationSource : IOperationSource<NetworkCloudKubernetesClusterResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal NetworkCloudKubernetesClusterResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
