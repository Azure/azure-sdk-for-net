...
{
    /// <summary></summary>
    internal partial class NetworkCloudL3NetworkResourceOperationSource : IOperationSource<NetworkCloudL3NetworkResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal NetworkCloudL3NetworkResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
