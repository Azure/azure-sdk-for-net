...
{
    /// <summary></summary>
    internal partial class NetworkCloudVirtualMachineResourceOperationSource : IOperationSource<NetworkCloudVirtualMachineResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal NetworkCloudVirtualMachineResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
