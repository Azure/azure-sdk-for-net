...
{
    /// <summary></summary>
    internal partial class NetworkCloudStorageApplianceResourceOperationSource : IOperationSource<NetworkCloudStorageApplianceResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal NetworkCloudStorageApplianceResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
