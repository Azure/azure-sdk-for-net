...
{
    /// <summary></summary>
    internal partial class NetworkCloudVirtualMachineConsoleResourceOperationSource : IOperationSource<NetworkCloudVirtualMachineConsoleResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal NetworkCloudVirtualMachineConsoleResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
