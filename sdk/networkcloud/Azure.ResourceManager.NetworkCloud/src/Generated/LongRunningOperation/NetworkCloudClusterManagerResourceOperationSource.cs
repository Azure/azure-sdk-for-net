...
{
    /// <summary></summary>
    internal partial class NetworkCloudClusterManagerResourceOperationSource : IOperationSource<NetworkCloudClusterManagerResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal NetworkCloudClusterManagerResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
