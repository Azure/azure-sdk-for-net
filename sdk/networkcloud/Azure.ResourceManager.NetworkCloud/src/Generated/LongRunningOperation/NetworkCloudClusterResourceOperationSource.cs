...
{
    /// <summary></summary>
    internal partial class NetworkCloudClusterResourceOperationSource : IOperationSource<NetworkCloudClusterResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal NetworkCloudClusterResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
