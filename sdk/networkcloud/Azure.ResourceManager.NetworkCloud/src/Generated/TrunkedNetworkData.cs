...
{
    /// <summary>
    /// A class representing the TrunkedNetwork data model.
    ...
    /// </summary>
    public partial class TrunkedNetworkData : TrackedResourceData
    {
        ...
        public TrunkedNetworkData(AzureLocation location, ExtendedLocation extendedLocation, IEnumerable<string> isolationDomainIds, IEnumerable<long> vlans) : base(location)
        {
