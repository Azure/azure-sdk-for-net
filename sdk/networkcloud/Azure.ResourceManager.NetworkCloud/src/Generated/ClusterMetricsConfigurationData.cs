...
{
    /// <summary>
    /// A class representing the ClusterMetricsConfiguration data model.
    /// ClusterMetricsConfiguration represents the metrics configuration of an on-premises Network Cloud cluster.
    /// </summary>
    public partial class ClusterMetricsConfigurationData : TrackedResourceData
    {
        ...
        public ClusterMetricsConfigurationData(AzureLocation location, ExtendedLocation extendedLocation, long collectionInterval) : base(location)
        {
