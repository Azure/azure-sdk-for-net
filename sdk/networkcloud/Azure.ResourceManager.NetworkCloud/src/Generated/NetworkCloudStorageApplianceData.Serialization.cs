...
namespace Azure.ResourceManager.NetworkCloud
{
    ...
    public partial class NetworkCloudStorageApplianceData : TrackedResourceData, IJsonModel<NetworkCloudStorageApplianceData>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<NetworkCloudStorageApplianceData>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<NetworkCloudStorageApplianceData>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        NetworkCloudStorageApplianceData IPersistableModel<NetworkCloudStorageApplianceData>.Create(BinaryData data, ModelReaderWriterOptions options) => (NetworkCloudStorageApplianceData)PersistableModelCreateCore(data, options);

        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<NetworkCloudStorageApplianceData>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";

        /// <param name="response"> The <see cref="Response"/> to deserialize the <see cref="NetworkCloudStorageApplianceData"/> from. </param>
        internal static NetworkCloudStorageApplianceData FromResponse(Response response)
        {
            using JsonDocument document = JsonDocument.Parse(response.Content, ModelSerializationExtensions.JsonDocumentOptions);
            return DeserializeNetworkCloudStorageApplianceData(document.RootElement, ModelSerializationExtensions.WireOptions);
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        NetworkCloudStorageApplianceData IJsonModel<NetworkCloudStorageApplianceData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (NetworkCloudStorageApplianceData)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static NetworkCloudStorageApplianceData DeserializeNetworkCloudStorageApplianceData(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            StorageApplianceProperties properties = default;
            ETag? eTag = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    properties = StorageApplianceProperties.DeserializeStorageApplianceProperties(prop.Value, options);
                    continue;
                }
