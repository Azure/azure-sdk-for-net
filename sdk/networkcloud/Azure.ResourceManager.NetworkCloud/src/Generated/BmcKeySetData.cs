...
{
    /// <summary>
    /// A class representing the BmcKeySet data model.
    /// BmcKeySet represents the baseboard management controller key set.
    /// </summary>
    public partial class BmcKeySetData : TrackedResourceData
    {
        ...
        public BmcKeySetData(AzureLocation location, ExtendedLocation extendedLocation, string azureGroupId, DateTimeOffset expiration, BmcKeySetPrivilegeLevel privilegeLevel, IEnumerable<KeySetUser> userList) : base(location)
        {
