...
{
    /// <summary>
    /// A class representing the Rack data model.
    /// Rack represents the hardware of the rack and is dependent upon the cluster for lifecycle.
    /// </summary>
    public partial class RackData : TrackedResourceData
    {
        ...
        public RackData(AzureLocation location, ExtendedLocation extendedLocation, string availabilityZone, string rackLocation, string rackSerialNumber, string rackSkuId) : base(location)
        {
