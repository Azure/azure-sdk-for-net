...
namespace Azure.ResourceManager.NetworkCloud
{
    ...
    public partial class NetworkCloudBareMetalMachineData : TrackedResourceData, IJsonModel<NetworkCloudBareMetalMachineData>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<NetworkCloudBareMetalMachineData>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<NetworkCloudBareMetalMachineData>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        NetworkCloudBareMetalMachineData IPersistableModel<NetworkCloudBareMetalMachineData>.Create(BinaryData data, ModelReaderWriterOptions options) => (NetworkCloudBareMetalMachineData)PersistableModelCreateCore(data, options);

        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<NetworkCloudBareMetalMachineData>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";

        /// <param name="response"> The <see cref="Response"/> to deserialize the <see cref="NetworkCloudBareMetalMachineData"/> from. </param>
        internal static NetworkCloudBareMetalMachineData FromResponse(Response response)
        {
            using JsonDocument document = JsonDocument.Parse(response.Content, ModelSerializationExtensions.JsonDocumentOptions);
            return DeserializeNetworkCloudBareMetalMachineData(document.RootElement, ModelSerializationExtensions.WireOptions);
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        NetworkCloudBareMetalMachineData IJsonModel<NetworkCloudBareMetalMachineData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (NetworkCloudBareMetalMachineData)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static NetworkCloudBareMetalMachineData DeserializeNetworkCloudBareMetalMachineData(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            BareMetalMachineProperties properties = default;
            ETag? eTag = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    properties = BareMetalMachineProperties.DeserializeBareMetalMachineProperties(prop.Value, options);
                    continue;
                }
