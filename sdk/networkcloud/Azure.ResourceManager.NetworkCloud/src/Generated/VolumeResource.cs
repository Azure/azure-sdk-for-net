...
namespace Azure.ResourceManager.NetworkCloud
{
    ...
    public partial class VolumeResource : ArmResource
    {
        ...
        {
            _volumeClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.NetworkCloud", ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<Response<VolumeResource>> UpdateAsync(VolumePatch patch, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="patch"/> is null. </exception>
        public virtual Response<VolumeResource> Update(VolumePatch patch, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(patch, nameof(patch));
