...
namespace Azure.ResourceManager.NetworkCloud
{
    ...
    public partial class NetworkCloudClusterManagerResource : ArmResource
    {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<ArmOperation<NetworkCloudOperationStatusResult>> UpdateRelayPrivateEndpointConnectionAsync(WaitUntil waitUntil, ClusterManagerUpdateRelayPrivateEndpointConnectionParameters content = default, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _clusterManagersRestClient.CreateUpdateRelayPrivateEndpointConnectionRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, ClusterManagerUpdateRelayPrivateEndpointConnectionParameters.ToRequestContent(content), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                NetworkCloudArmOperation<NetworkCloudOperationStatusResult> operation = new NetworkCloudArmOperation<NetworkCloudOperationStatusResult>(
                    new NetworkCloudOperationStatusResultOperationSource(),
                    _clusterManagersClientDiagnostics,
        ...
        /// <param name="content"> The request body. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual ArmOperation<NetworkCloudOperationStatusResult> UpdateRelayPrivateEndpointConnection(WaitUntil waitUntil, ClusterManagerUpdateRelayPrivateEndpointConnectionParameters content = default, CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _clusterManagersClientDiagnostics.CreateScope("NetworkCloudClusterManagerResource.UpdateRelayPrivateEndpointConnection");
            scope.Start();
            try
