    ...
    public partial class NetworkCloudClusterManagerResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, MatchConditions matchConditions = default, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                NetworkCloudArmOperation operation = new NetworkCloudArmOperation(_clusterManagersClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
