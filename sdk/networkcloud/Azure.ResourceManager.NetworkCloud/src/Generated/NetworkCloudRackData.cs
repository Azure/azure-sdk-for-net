...
namespace Azure.ResourceManager.NetworkCloud
{
    ...
    public partial class NetworkCloudRackData : TrackedResourceData
    {
        ...
        public NetworkCloudRackData(AzureLocation location, string availabilityZone, string rackLocation, string rackSerialNumber, ResourceIdentifier rackSkuId, Models.ExtendedLocation extendedLocation) : base(location)
        {
