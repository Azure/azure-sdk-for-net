...
namespace Azure.ResourceManager.NetworkCloud
{
    ...
    public partial class NetworkCloudKubernetesClusterResource : ArmResource
    {
        ...
        /// <summary>
        /// Updates the NetworkCloudKubernetesCluster.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NetworkCloud/kubernetesClusters/{kubernetesClusterName}. </description>
        ...
        public virtual async Task<ArmOperation<NetworkCloudKubernetesClusterResource>> UpdateAsync(WaitUntil waitUntil, NetworkCloudKubernetesClusterData data, MatchConditions matchConditions = default, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _kubernetesClustersRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, NetworkCloudKubernetesClusterData.ToRequestContent(data), matchConditions, context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                NetworkCloudArmOperation<NetworkCloudKubernetesClusterResource> operation = new NetworkCloudArmOperation<NetworkCloudKubernetesClusterResource>(
                    new NetworkCloudKubernetesClusterResourceOperationSource(Client),
                    _kubernetesClustersClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<NetworkCloudKubernetesClusterResource> Update(WaitUntil waitUntil, NetworkCloudKubernetesClusterData data, MatchConditions matchConditions = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
