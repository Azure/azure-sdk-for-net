...
namespace Azure.ResourceManager.NetworkCloud
{
    ...
    public partial class NetworkCloudKubernetesClusterResource : ArmResource
    {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<ArmOperation<NetworkCloudKubernetesClusterResource>> UpdateAsync(WaitUntil waitUntil, NetworkCloudKubernetesClusterPatch patch = default, MatchConditions matchConditions = default, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="matchConditions"> The content to send as the request conditions of the request. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual ArmOperation<NetworkCloudKubernetesClusterResource> Update(WaitUntil waitUntil, NetworkCloudKubernetesClusterPatch patch = default, MatchConditions matchConditions = default, CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _kubernetesClustersClientDiagnostics.CreateScope("NetworkCloudKubernetesClusterResource.Update");
            scope.Start();
            try
