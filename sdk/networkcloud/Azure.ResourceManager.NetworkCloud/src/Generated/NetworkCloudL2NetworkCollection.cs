...
namespace Azure.ResourceManager.NetworkCloud
{
    ...
    public partial class NetworkCloudL2NetworkCollection : ArmCollection, IEnumerable<NetworkCloudL2NetworkResource>, IAsyncEnumerable<NetworkCloudL2NetworkResource>
    {
        ...
        internal NetworkCloudL2NetworkCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _l2NetworksRestClient = new L2Networks(_l2NetworksClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, networkCloudL2NetworkApiVersion ?? "2026-05-01-preview");
        ...
        public virtual async Task<ArmOperation<NetworkCloudL2NetworkResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string l2NetworkName, NetworkCloudL2NetworkData data, MatchConditions matchConditions = default, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                NetworkCloudArmOperation<NetworkCloudL2NetworkResource> operation = new NetworkCloudArmOperation<NetworkCloudL2NetworkResource>(
                    new NetworkCloudL2NetworkResourceOperationSource(Client),
