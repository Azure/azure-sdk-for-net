...
namespace Azure.ResourceManager.NetworkCloud.Testing
{
    ...
    public partial class NetworkCloudResourceGroupResourceExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="NetworkCloudResourceGroupResourceExtension"/> class for mocking. </summary>
        protected NetworkCloudResourceGroupResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="NetworkCloudResourceGroupResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal NetworkCloudResourceGroupResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
