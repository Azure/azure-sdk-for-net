...
{
    /// <summary>
    /// A class representing the Volume data model.
    ...
    public partial class VolumeData : TrackedResourceData
    {
        ...
        public VolumeData(AzureLocation location, ExtendedLocation extendedLocation, long sizeMiB) : base(location)
        {
