...
namespace Azure.ResourceManager.NetworkCloud
{
    public partial class NetworkCloudTrunkedNetworkResource : IJsonModel<NetworkCloudTrunkedNetworkData>
    {
        ...
        {
            return ModelReaderWriter.Read<NetworkCloudTrunkedNetworkData>(new BinaryData(reader.ValueSequence), options);
        }
        ...
        {
            return ModelReaderWriter.Read<NetworkCloudTrunkedNetworkData>(data, options);
        }
