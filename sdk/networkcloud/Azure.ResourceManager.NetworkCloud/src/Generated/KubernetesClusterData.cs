...
{
    /// <summary>
    /// A class representing the KubernetesCluster data model.
    /// KubernetesCluster represents the Kubernetes cluster hosted on Network Cloud.
    /// </summary>
    public partial class KubernetesClusterData : TrackedResourceData
    {
        /// <summary> Initializes a new instance of KubernetesClusterData. </summary>
        ...
        public KubernetesClusterData(AzureLocation location, ExtendedLocation extendedLocation, ControlPlaneNodeConfiguration controlPlaneNodeConfiguration, IEnumerable<InitialAgentPoolConfiguration> initialAgentPoolConfigurations, string kubernetesVersion, NetworkConfiguration networkConfiguration) : base(location)
        {
            ...
            AttachedNetworkIds = new ChangeTrackingList<string>();
        ...
        internal AadConfiguration AadConfiguration { get; set; }
        ...
        public IList<string> AadAdminGroupObjectIds
        {
            ...
            set => AadConfiguration = new AadConfiguration(value);
        }
        ...
        public IReadOnlyList<string> AttachedNetworkIds { get; }
        ...
        public string ConnectedClusterId { get; }
