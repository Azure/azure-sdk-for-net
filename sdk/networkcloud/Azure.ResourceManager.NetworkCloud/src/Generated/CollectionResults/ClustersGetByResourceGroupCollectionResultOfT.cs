...
namespace Azure.ResourceManager.NetworkCloud
{
    internal partial class ClustersGetByResourceGroupCollectionResultOfT : Pageable<NetworkCloudClusterData>
    {
        ...
        public ClustersGetByResourceGroupCollectionResultOfT(Clusters client, Guid subscriptionId, string resourceGroupName, int? top, string skipToken, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
