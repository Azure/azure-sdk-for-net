...
{
    internal partial class ClustersGetByResourceGroupCollectionResultOfT : Pageable<NetworkCloudClusterData>
    {
        ...
        public ClustersGetByResourceGroupCollectionResultOfT(Clusters client, Guid subscriptionId, string resourceGroupName, int? top, string skipToken, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        public override IEnumerable<Page<NetworkCloudClusterData>> AsPages(string continuationToken, int? pageSizeHint)
        {
        ...
        private Response GetNextResponse(int? pageSizeHint, Uri nextLink)
        {
            ...
            using DiagnosticScope scope = _client.ClientDiagnostics.CreateScope("NetworkCloudClusterCollection.GetAll");
            scope.Start();
            try
            {
