...
namespace Azure.ResourceManager.NetworkCloud
{
    internal partial class AccessBridgesGetByResourceGroupCollectionResultOfT : Pageable<NetworkCloudAccessBridgeData>
    {
        ...
        public AccessBridgesGetByResourceGroupCollectionResultOfT(AccessBridges client, Guid subscriptionId, string resourceGroupName, int? top, string skipToken, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
