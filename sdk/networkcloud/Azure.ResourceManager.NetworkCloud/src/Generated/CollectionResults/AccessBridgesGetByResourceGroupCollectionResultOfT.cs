...
namespace Azure.ResourceManager.NetworkCloud
{
    internal partial class AccessBridgesGetByResourceGroupCollectionResultOfT : Pageable<NetworkCloudAccessBridgeData>
    {
        ...
        /// <summary> Initializes a new instance of AccessBridgesGetByResourceGroupCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public AccessBridgesGetByResourceGroupCollectionResultOfT(AccessBridges client, Guid subscriptionId, string resourceGroupName, int? top, string skipToken, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of AccessBridgesGetByResourceGroupCollectionResultOfT as an enumerable collection. </summary>
