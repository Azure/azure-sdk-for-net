...
namespace Azure.ResourceManager.NetworkCloud
{
    internal partial class KubernetesVersionsGetByResourceGroupAsyncCollectionResultOfT : AsyncPageable<NetworkCloudKubernetesVersionData>
    {
        ...
        /// <summary> Initializes a new instance of KubernetesVersionsGetByResourceGroupAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public KubernetesVersionsGetByResourceGroupAsyncCollectionResultOfT(KubernetesVersions client, Guid subscriptionId, string resourceGroupName, int? top, string skipToken, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of KubernetesVersionsGetByResourceGroupAsyncCollectionResultOfT as an enumerable collection. </summary>
