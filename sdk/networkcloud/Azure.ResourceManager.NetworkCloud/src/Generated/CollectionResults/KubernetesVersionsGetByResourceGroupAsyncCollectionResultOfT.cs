...
namespace Azure.ResourceManager.NetworkCloud
{
    internal partial class KubernetesVersionsGetByResourceGroupAsyncCollectionResultOfT : AsyncPageable<NetworkCloudKubernetesVersionData>
    {
        ...
        public KubernetesVersionsGetByResourceGroupAsyncCollectionResultOfT(KubernetesVersions client, Guid subscriptionId, string resourceGroupName, int? top, string skipToken, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
