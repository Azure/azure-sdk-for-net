...
namespace Azure.ResourceManager.NetworkCloud
{
    internal partial class KubernetesVersionsGetByResourceGroupCollectionResultOfT : Pageable<NetworkCloudKubernetesVersionData>
    {
        ...
        public KubernetesVersionsGetByResourceGroupCollectionResultOfT(KubernetesVersions client, Guid subscriptionId, string resourceGroupName, int? top, string skipToken, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
