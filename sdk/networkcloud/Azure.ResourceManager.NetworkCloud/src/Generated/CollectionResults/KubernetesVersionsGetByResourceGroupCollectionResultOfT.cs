...
namespace Azure.ResourceManager.NetworkCloud
{
    internal partial class KubernetesVersionsGetByResourceGroupCollectionResultOfT : Pageable<NetworkCloudKubernetesVersionData>
    {
        ...
        /// <summary> Initializes a new instance of KubernetesVersionsGetByResourceGroupCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public KubernetesVersionsGetByResourceGroupCollectionResultOfT(KubernetesVersions client, Guid subscriptionId, string resourceGroupName, int? top, string skipToken, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of KubernetesVersionsGetByResourceGroupCollectionResultOfT as an enumerable collection. </summary>
