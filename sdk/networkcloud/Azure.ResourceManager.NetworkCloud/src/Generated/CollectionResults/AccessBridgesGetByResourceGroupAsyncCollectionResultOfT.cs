...
namespace Azure.ResourceManager.NetworkCloud
{
    internal partial class AccessBridgesGetByResourceGroupAsyncCollectionResultOfT : AsyncPageable<NetworkCloudAccessBridgeData>
    {
        ...
        /// <summary> Initializes a new instance of AccessBridgesGetByResourceGroupAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public AccessBridgesGetByResourceGroupAsyncCollectionResultOfT(AccessBridges client, Guid subscriptionId, string resourceGroupName, int? top, string skipToken, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of AccessBridgesGetByResourceGroupAsyncCollectionResultOfT as an enumerable collection. </summary>
