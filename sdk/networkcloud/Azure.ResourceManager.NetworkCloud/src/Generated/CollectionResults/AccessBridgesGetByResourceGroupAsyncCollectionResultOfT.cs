...
namespace Azure.ResourceManager.NetworkCloud
{
    internal partial class AccessBridgesGetByResourceGroupAsyncCollectionResultOfT : AsyncPageable<NetworkCloudAccessBridgeData>
    {
        ...
        public AccessBridgesGetByResourceGroupAsyncCollectionResultOfT(AccessBridges client, Guid subscriptionId, string resourceGroupName, int? top, string skipToken, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
