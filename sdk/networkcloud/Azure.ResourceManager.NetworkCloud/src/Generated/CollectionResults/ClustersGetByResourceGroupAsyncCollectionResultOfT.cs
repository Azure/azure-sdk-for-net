...
namespace Azure.ResourceManager.NetworkCloud
{
    internal partial class ClustersGetByResourceGroupAsyncCollectionResultOfT : AsyncPageable<NetworkCloudClusterData>
    {
        ...
        public ClustersGetByResourceGroupAsyncCollectionResultOfT(Clusters client, Guid subscriptionId, string resourceGroupName, int? top, string skipToken, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
