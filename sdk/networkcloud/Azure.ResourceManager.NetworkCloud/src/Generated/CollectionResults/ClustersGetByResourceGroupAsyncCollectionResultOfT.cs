...
{
    internal partial class ClustersGetByResourceGroupAsyncCollectionResultOfT : AsyncPageable<NetworkCloudClusterData>
    {
        ...
        public ClustersGetByResourceGroupAsyncCollectionResultOfT(Clusters client, Guid subscriptionId, string resourceGroupName, int? top, string skipToken, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        public override async IAsyncEnumerable<Page<NetworkCloudClusterData>> AsPages(string continuationToken, int? pageSizeHint)
        {
