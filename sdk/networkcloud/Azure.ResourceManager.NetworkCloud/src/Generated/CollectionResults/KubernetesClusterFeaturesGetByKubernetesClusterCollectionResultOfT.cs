...
{
    internal partial class KubernetesClusterFeaturesGetByKubernetesClusterCollectionResultOfT : Pageable<NetworkCloudKubernetesClusterFeatureData>
    {
        ...
        /// <returns> The pages of KubernetesClusterFeaturesGetByKubernetesClusterCollectionResultOfT as an enumerable collection. </returns>
        public override IEnumerable<Page<NetworkCloudKubernetesClusterFeatureData>> AsPages(string continuationToken, int? pageSizeHint)
        {
