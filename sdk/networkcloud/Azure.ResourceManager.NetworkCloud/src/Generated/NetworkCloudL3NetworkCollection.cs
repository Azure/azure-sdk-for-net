...
namespace Azure.ResourceManager.NetworkCloud
{
    ...
    public partial class NetworkCloudL3NetworkCollection : ArmCollection, IEnumerable<NetworkCloudL3NetworkResource>, IAsyncEnumerable<NetworkCloudL3NetworkResource>
    {
        ...
        internal NetworkCloudL3NetworkCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _l3NetworksRestClient = new L3Networks(_l3NetworksClientDiagnostics, Pipeline, Endpoint, networkCloudL3NetworkApiVersion ?? "2026-05-01-preview");
        ...
        public virtual async Task<ArmOperation<NetworkCloudL3NetworkResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string l3NetworkName, NetworkCloudL3NetworkData data, MatchConditions matchConditions = default, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                NetworkCloudArmOperation<NetworkCloudL3NetworkResource> operation = new NetworkCloudArmOperation<NetworkCloudL3NetworkResource>(
                    new NetworkCloudL3NetworkResourceOperationSource(Client),
