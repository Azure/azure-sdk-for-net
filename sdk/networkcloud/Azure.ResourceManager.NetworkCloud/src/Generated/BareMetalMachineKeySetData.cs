...
{
    /// <summary>
    /// A class representing the BareMetalMachineKeySet data model.
    /// BareMetalMachineKeySet represents the bare metal machine key set.
    /// </summary>
    public partial class BareMetalMachineKeySetData : TrackedResourceData
    {
        ...
        public BareMetalMachineKeySetData(AzureLocation location, ExtendedLocation extendedLocation, string azureGroupId, DateTimeOffset expiration, IEnumerable<string> jumpHostsAllowed, BareMetalMachineKeySetPrivilegeLevel privilegeLevel, IEnumerable<KeySetUser> userList) : base(location)
        {
        ...
        internal BareMetalMachineKeySetData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, ExtendedLocation extendedLocation, string azureGroupId, BareMetalMachineKeySetDetailedStatus? detailedStatus, string detailedStatusMessage, DateTimeOffset expiration, IList<string> jumpHostsAllowed, DateTimeOffset? lastValidation, string osGroupName, BareMetalMachineKeySetPrivilegeLevel privilegeLevel, BareMetalMachineKeySetProvisioningState? provisioningState, IList<KeySetUser> userList, IReadOnlyList<KeySetUserStatus> userListStatus) : base(id, name, resourceType, systemData, tags, location)
        {
            ExtendedLocation = extendedLocation;
            AzureGroupId = azureGroupId;
        ...
        public DateTimeOffset? LastValidation { get; }
