...
namespace Azure.ResourceManager.NetworkCloud.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StorageApplianceEnableRemoteVendorManagementContent>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<StorageApplianceEnableRemoteVendorManagementContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<StorageApplianceEnableRemoteVendorManagementContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
