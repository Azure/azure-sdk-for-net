...
namespace Azure.ResourceManager.NetworkCloud.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StorageApplianceEnableRemoteVendorManagementContent>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        StorageApplianceEnableRemoteVendorManagementContent IJsonModel<StorageApplianceEnableRemoteVendorManagementContent>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<StorageApplianceEnableRemoteVendorManagementContent>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        StorageApplianceEnableRemoteVendorManagementContent IModel<StorageApplianceEnableRemoteVendorManagementContent>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<StorageApplianceEnableRemoteVendorManagementContent>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
