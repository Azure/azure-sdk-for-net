...
{
    internal partial class CloudServicesNetworkList : IUtf8JsonSerializable, IJsonModel<CloudServicesNetworkList>, IPersistableModel<CloudServicesNetworkList>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CloudServicesNetworkList>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<CloudServicesNetworkList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CloudServicesNetworkList)} does not support '{format}' format.");
            }
