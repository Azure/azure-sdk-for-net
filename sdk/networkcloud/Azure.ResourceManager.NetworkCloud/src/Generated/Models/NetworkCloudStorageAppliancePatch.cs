...
namespace Azure.ResourceManager.NetworkCloud.Models
{
    ...
    public partial class NetworkCloudStorageAppliancePatch
    {
        ...
        internal NetworkCloudStorageAppliancePatch(IDictionary<string, string> tags, string serialNumber, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Tags = tags;
