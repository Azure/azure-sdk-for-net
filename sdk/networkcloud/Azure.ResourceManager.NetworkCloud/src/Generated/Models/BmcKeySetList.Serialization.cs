...
{
    internal partial class BmcKeySetList : IUtf8JsonSerializable, IJsonModel<BmcKeySetList>, IPersistableModel<BmcKeySetList>
    {
        ...
        void IJsonModel<BmcKeySetList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(BmcKeySetList)} does not support '{format}' format.");
            }
