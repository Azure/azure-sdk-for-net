...
namespace Azure.ResourceManager.NetworkCloud.Models
{
    ...
    public partial class ClusterManagerUpdateRelayPrivateEndpointConnectionParameters
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="ClusterManagerUpdateRelayPrivateEndpointConnectionParameters"/>. </summary>
        ...
        public ClusterManagerUpdateRelayPrivateEndpointConnectionParameters(RelayPrivateEndpointConnectionState connectionState, ResourceIdentifier privateEndpointResourceId)
        {
        ...
        internal ClusterManagerUpdateRelayPrivateEndpointConnectionParameters(RelayPrivateEndpointConnectionState connectionState, string description, ResourceIdentifier privateEndpointResourceId, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            ConnectionState = connectionState;
