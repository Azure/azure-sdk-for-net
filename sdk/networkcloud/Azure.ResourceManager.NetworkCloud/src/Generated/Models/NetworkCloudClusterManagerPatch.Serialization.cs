...
namespace Azure.ResourceManager.NetworkCloud.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NetworkCloudClusterManagerPatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NetworkCloudClusterManagerPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NetworkCloudClusterManagerPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<NetworkCloudClusterManagerPatch>)} interface");
            }
        ...
        string IPersistableModel<NetworkCloudClusterManagerPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
