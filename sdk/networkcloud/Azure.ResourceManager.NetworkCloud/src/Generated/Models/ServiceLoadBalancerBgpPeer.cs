...
namespace Azure.ResourceManager.NetworkCloud.Models
{
    ...
    public partial class ServiceLoadBalancerBgpPeer
    {
        ...
        internal ServiceLoadBalancerBgpPeer(BfdEnabled? bfdEnabled, BgpMultiHop? bgpMultiHop, string holdTime, string keepAliveTime, long? myAsn, string name, string password, string peerAddress, long peerAsn, long? peerPort, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
