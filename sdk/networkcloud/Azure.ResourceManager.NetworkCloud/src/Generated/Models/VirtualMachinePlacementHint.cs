...
namespace Azure.ResourceManager.NetworkCloud.Models
{
    ...
    public partial class VirtualMachinePlacementHint
    {
        ...
        internal VirtualMachinePlacementHint(VirtualMachinePlacementHintType hintType, ResourceIdentifier resourceId, VirtualMachineSchedulingExecution schedulingExecution, VirtualMachinePlacementHintPodAffinityScope scope, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            HintType = hintType;
            ResourceId = resourceId;
            SchedulingExecution = schedulingExecution;
