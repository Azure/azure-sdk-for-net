...
namespace Azure.ResourceManager.NetworkCloud.Models
{
    ...
    public partial class VirtualMachinePlacementHint
    {
        ...
        internal VirtualMachinePlacementHint(VirtualMachinePlacementHintType hintType, ResourceIdentifier resourceId, VirtualMachineSchedulingExecution schedulingExecution, VirtualMachinePlacementHintPodAffinityScope scope, Dictionary<string, BinaryData> rawData)
        {
            HintType = hintType;
            ResourceId = resourceId;
            SchedulingExecution = schedulingExecution;
