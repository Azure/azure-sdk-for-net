...
{
    internal partial class NetworkCloudAadConfiguration : IUtf8JsonSerializable, IJsonModel<NetworkCloudAadConfiguration>, IPersistableModel<NetworkCloudAadConfiguration>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NetworkCloudAadConfiguration>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<NetworkCloudAadConfiguration>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(NetworkCloudAadConfiguration)} does not support '{format}' format.");
            }
