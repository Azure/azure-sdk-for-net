...
{
    public partial class AvailableUpgrade : IUtf8JsonSerializable, IJsonModel<AvailableUpgrade>, IPersistableModel<AvailableUpgrade>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  availabilityLifecycle:");
                builder.AppendLine($" '{AvailabilityLifecycle.ToString()}'");
            }
