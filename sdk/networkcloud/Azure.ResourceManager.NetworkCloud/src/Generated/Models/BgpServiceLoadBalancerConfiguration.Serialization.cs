...
{
    public partial class BgpServiceLoadBalancerConfiguration : IUtf8JsonSerializable, IJsonModel<BgpServiceLoadBalancerConfiguration>, IPersistableModel<BgpServiceLoadBalancerConfiguration>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(BgpAdvertisements))
            {
                builder.Append("  bgpAdvertisements:");
                builder.AppendLine(" [");
                foreach (var item in BgpAdvertisements)
                {
            ...
            if (Optional.IsDefined(FabricPeeringEnabled))
            {
                builder.Append("  fabricPeeringEnabled:");
                builder.AppendLine($" '{FabricPeeringEnabled.ToString()}'");
            }
