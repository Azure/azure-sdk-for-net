...
namespace Azure.ResourceManager.NetworkCloud.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NetworkCloudVirtualMachineConsolePatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NetworkCloudVirtualMachineConsolePatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NetworkCloudVirtualMachineConsolePatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<NetworkCloudVirtualMachineConsolePatch>)} interface");
            }
        ...
        string IPersistableModel<NetworkCloudVirtualMachineConsolePatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
