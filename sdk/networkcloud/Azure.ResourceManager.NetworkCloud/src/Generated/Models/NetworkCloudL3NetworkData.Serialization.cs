...
{
    public partial class NetworkCloudL3NetworkData : IUtf8JsonSerializable, IModelJsonSerializable<NetworkCloudL3NetworkData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IModelJsonSerializable<NetworkCloudL3NetworkData>)this).Serialize(writer, ModelSerializerOptions.DefaultWireOptions);

        void IModelJsonSerializable<NetworkCloudL3NetworkData>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<NetworkCloudL3NetworkData>(this, options.Format);
        ...
        internal static NetworkCloudL3NetworkData DeserializeNetworkCloudL3NetworkData(JsonElement element, ModelSerializerOptions options = default)
        {
        ...
        NetworkCloudL3NetworkData IModelJsonSerializable<NetworkCloudL3NetworkData>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<NetworkCloudL3NetworkData>(this, options.Format);

            using var doc = JsonDocument.ParseValue(ref reader);
            return DeserializeNetworkCloudL3NetworkData(doc.RootElement, options);
        }

        BinaryData IModelSerializable<NetworkCloudL3NetworkData>.Serialize(ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<NetworkCloudL3NetworkData>(this, options.Format);
        ...
        NetworkCloudL3NetworkData IModelSerializable<NetworkCloudL3NetworkData>.Deserialize(BinaryData data, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<NetworkCloudL3NetworkData>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="NetworkCloudL3NetworkData"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="NetworkCloudL3NetworkData"/> to convert. </param>
        public static implicit operator RequestContent(NetworkCloudL3NetworkData model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="NetworkCloudL3NetworkData"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator NetworkCloudL3NetworkData(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeNetworkCloudL3NetworkData(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
