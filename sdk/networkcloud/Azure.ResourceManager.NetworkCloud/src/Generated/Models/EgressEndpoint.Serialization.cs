...
namespace Azure.ResourceManager.NetworkCloud.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EgressEndpoint>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<EgressEndpoint>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<EgressEndpoint>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<EgressEndpoint>)} interface");
            }
        ...
        string IPersistableModel<EgressEndpoint>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
