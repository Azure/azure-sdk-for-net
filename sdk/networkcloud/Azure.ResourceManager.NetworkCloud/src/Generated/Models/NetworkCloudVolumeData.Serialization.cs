...
{
    public partial class NetworkCloudVolumeData : IUtf8JsonSerializable, IJsonModel<NetworkCloudVolumeData>, IPersistableModel<NetworkCloudVolumeData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SizeInMiB))
            {
                builder.Append("  sizeMiB:");
                builder.AppendLine($" '{SizeInMiB.ToString()}'");
            }
