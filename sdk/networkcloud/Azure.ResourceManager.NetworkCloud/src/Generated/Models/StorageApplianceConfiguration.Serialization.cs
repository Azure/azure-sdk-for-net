...
{
    public partial class StorageApplianceConfiguration : IUtf8JsonSerializable, IJsonModel<StorageApplianceConfiguration>, IPersistableModel<StorageApplianceConfiguration>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(StorageApplianceName))
            {
                builder.Append("  storageApplianceName:");
                builder.AppendLine($" '{StorageApplianceName}'");
            }
