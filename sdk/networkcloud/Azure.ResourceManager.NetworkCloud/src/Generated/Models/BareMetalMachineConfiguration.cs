...
namespace Azure.ResourceManager.NetworkCloud.Models
{
    ...
    public partial class BareMetalMachineConfiguration
    {
        ...
        internal BareMetalMachineConfiguration(string bmcConnectionString, AdministrativeCredentials bmcCredentials, string bmcMacAddress, string bootMacAddress, string machineDetails, string machineName, long rackSlot, string serialNumber, Dictionary<string, BinaryData> rawData)
        {
