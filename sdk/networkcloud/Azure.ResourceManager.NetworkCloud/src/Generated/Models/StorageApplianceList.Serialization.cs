...
namespace Azure.ResourceManager.NetworkCloud.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StorageApplianceList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<StorageApplianceList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<StorageApplianceList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<StorageApplianceList>)} interface");
            }
        ...
        string IPersistableModel<StorageApplianceList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
