...
namespace Azure.ResourceManager.NetworkCloud.Models
{
    public partial class NetworkConfiguration : IUtf8JsonSerializable
    {
        ...
        internal static NetworkConfiguration DeserializeNetworkConfiguration(JsonElement element)
        {
            ...
            return new NetworkConfiguration(attachedNetworkConfiguration.Value, bgpServiceLoadBalancerConfiguration.Value, cloudServicesNetworkId, cniNetworkId, dnsServiceIP.Value, Optional.ToList(podCidrs), Optional.ToList(serviceCidrs));
        }
    }
}
