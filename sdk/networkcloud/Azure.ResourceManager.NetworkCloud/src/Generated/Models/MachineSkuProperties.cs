...
namespace Azure.ResourceManager.NetworkCloud.Models
{
    ...
    internal partial class MachineSkuProperties
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="MachineSkuProperties"/>. </summary>
        internal MachineSkuProperties()
        {
        ...
        public IReadOnlyList<MachineDisk> Disks { get; } = new ChangeTrackingList<MachineDisk>();
        ...
        public IReadOnlyList<NetworkCloudNetworkInterface> NetworkInterfaces { get; } = new ChangeTrackingList<NetworkCloudNetworkInterface>();
