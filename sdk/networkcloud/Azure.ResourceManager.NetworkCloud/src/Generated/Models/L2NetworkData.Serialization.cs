...
{
    public partial class L2NetworkData : IUtf8JsonSerializable
    {
        ...
        internal static L2NetworkData DeserializeL2NetworkData(JsonElement element)
        {
            ...
            string l2IsolationDomainId = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        {
                            l2IsolationDomainId = property0.Value.GetString();
                            continue;
                        }
