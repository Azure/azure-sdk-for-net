...
namespace Azure.ResourceManager.NetworkCloud.Models
{
    ...
    public partial class KeySetUserStatus
    {
        ...
        internal KeySetUserStatus(string azureUserName, BareMetalMachineKeySetUserSetupStatus? status, string statusMessage, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
