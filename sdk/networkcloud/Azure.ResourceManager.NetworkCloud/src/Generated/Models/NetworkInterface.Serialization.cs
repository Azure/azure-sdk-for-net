...
namespace Azure.ResourceManager.NetworkCloud.Models
{
    public partial class NetworkInterface
    {
        internal static NetworkInterface DeserializeNetworkInterface(JsonElement element)
        {
            ...
            return new NetworkInterface(address.Value, Optional.ToNullable(deviceConnectionType), model.Value, Optional.ToNullable(physicalSlot), Optional.ToNullable(portCount), Optional.ToNullable(portSpeed), vendor.Value);
        }
    }
}
