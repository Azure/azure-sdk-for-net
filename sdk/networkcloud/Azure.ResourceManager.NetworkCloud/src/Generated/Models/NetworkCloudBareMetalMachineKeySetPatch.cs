...
namespace Azure.ResourceManager.NetworkCloud.Models
{
    ...
    public partial class NetworkCloudBareMetalMachineKeySetPatch
    {
        ...
        internal NetworkCloudBareMetalMachineKeySetPatch(DateTimeOffset? expireOn, IList<IPAddress> jumpHostsAllowed, IList<KeySetUser> userList, IDictionary<string, string> tags, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ExpireOn = expireOn;
