...
namespace Azure.ResourceManager.NetworkCloud.Models
{
    ...
    public partial class NetworkCloudBareMetalMachineKeySetPatch
    {
        ...
        internal NetworkCloudBareMetalMachineKeySetPatch(IDictionary<string, string> tags, DateTimeOffset? expireOn, IList<IPAddress> jumpHostsAllowed, IList<KeySetUser> userList, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Tags = tags;
            ExpireOn = expireOn;
