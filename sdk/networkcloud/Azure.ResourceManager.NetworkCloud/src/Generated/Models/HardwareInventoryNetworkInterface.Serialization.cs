...
{
    public partial class HardwareInventoryNetworkInterface : IUtf8JsonSerializable, IJsonModel<HardwareInventoryNetworkInterface>, IPersistableModel<HardwareInventoryNetworkInterface>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  linkStatus:");
                builder.AppendLine($" '{LinkStatus}'");
            }
