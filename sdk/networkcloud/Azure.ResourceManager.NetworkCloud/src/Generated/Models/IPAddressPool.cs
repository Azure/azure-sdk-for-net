...
namespace Azure.ResourceManager.NetworkCloud.Models
{
    ...
    public partial class IPAddressPool
    {
        ...
        internal IPAddressPool(IList<string> addresses, BfdEnabled? autoAssign, string name, BfdEnabled? onlyUseHostIPs, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Addresses = addresses;
