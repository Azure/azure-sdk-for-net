...
namespace Azure.ResourceManager.NetworkCloud.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IPAddressPool>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<IPAddressPool>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<IPAddressPool>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<IPAddressPool>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
