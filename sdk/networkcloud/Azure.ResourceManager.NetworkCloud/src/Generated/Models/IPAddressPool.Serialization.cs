...
namespace Azure.ResourceManager.NetworkCloud.Models
{
    public partial class IPAddressPool : IUtf8JsonSerializable, IJsonModel<IPAddressPool>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<IPAddressPool>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<IPAddressPool>)} interface");
            }
