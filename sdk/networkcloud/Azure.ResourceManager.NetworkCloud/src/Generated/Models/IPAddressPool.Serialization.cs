...
{
    public partial class IPAddressPool : IUtf8JsonSerializable, IJsonModel<IPAddressPool>, IPersistableModel<IPAddressPool>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(AutoAssign))
            {
                ...
                builder.AppendLine($" '{AutoAssign.ToString()}'");
            }
            ...
            if (Optional.IsDefined(OnlyUseHostIPs))
            {
                ...
                builder.AppendLine($" '{OnlyUseHostIPs.ToString()}'");
            }
