...
namespace Azure.ResourceManager.NetworkCloud.Models
{
    public partial class IPAddressPool : IUtf8JsonSerializable, IJsonModel<IPAddressPool>
    {
        ...
        void IJsonModel<IPAddressPool>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(IPAddressPool)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<IPAddressPool>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(IPAddressPool)} does not support '{options.Format}' format.");
            }
        }
