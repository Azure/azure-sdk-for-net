...
{
    public partial class BgpAdvertisement : IUtf8JsonSerializable, IJsonModel<BgpAdvertisement>, IPersistableModel<BgpAdvertisement>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(AdvertiseToFabric))
            {
                builder.Append("  advertiseToFabric:");
                builder.AppendLine($" '{AdvertiseToFabric.ToString()}'");
            }
