...
namespace Azure.ResourceManager.NetworkCloud.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BgpAdvertisement>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<BgpAdvertisement>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BgpAdvertisement>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<BgpAdvertisement>)} interface");
            }
        ...
        string IPersistableModel<BgpAdvertisement>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
