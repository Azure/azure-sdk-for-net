...
{
    public partial class ClusterAvailableVersion : IUtf8JsonSerializable, IJsonModel<ClusterAvailableVersion>, IPersistableModel<ClusterAvailableVersion>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SupportExpiryDate))
            {
                ...
                builder.AppendLine($" '{SupportExpiryDate}'");
            }
