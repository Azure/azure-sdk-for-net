...
namespace Azure.ResourceManager.NetworkCloud.Models
{
    public partial class ClusterAvailableVersion : IUtf8JsonSerializable, IModelJsonSerializable<ClusterAvailableVersion>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<ClusterAvailableVersion>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="ClusterAvailableVersion"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="ClusterAvailableVersion"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="ClusterAvailableVersion"/>. </summary>
