...
namespace Azure.ResourceManager.NetworkCloud.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TrunkedNetworkAttachmentConfiguration>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<TrunkedNetworkAttachmentConfiguration>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<TrunkedNetworkAttachmentConfiguration>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<TrunkedNetworkAttachmentConfiguration>)} interface");
            }
        ...
        string IPersistableModel<TrunkedNetworkAttachmentConfiguration>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
