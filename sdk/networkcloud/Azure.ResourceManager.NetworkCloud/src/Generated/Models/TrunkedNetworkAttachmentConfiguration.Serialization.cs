...
namespace Azure.ResourceManager.NetworkCloud.Models
{
    ...
    public partial class TrunkedNetworkAttachmentConfiguration : IJsonModel<TrunkedNetworkAttachmentConfiguration>
    {
        ...
        protected virtual TrunkedNetworkAttachmentConfiguration PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<TrunkedNetworkAttachmentConfiguration>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<TrunkedNetworkAttachmentConfiguration>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        TrunkedNetworkAttachmentConfiguration IPersistableModel<TrunkedNetworkAttachmentConfiguration>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        TrunkedNetworkAttachmentConfiguration IJsonModel<TrunkedNetworkAttachmentConfiguration>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual TrunkedNetworkAttachmentConfiguration JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<TrunkedNetworkAttachmentConfiguration>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static TrunkedNetworkAttachmentConfiguration DeserializeTrunkedNetworkAttachmentConfiguration(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new TrunkedNetworkAttachmentConfiguration(networkId, pluginType, additionalBinaryDataProperties);
        }
    }
}
