...
{
    public partial class TrunkedNetworkAttachmentConfiguration : Core.IUtf8JsonSerializable
    {
        ...
        internal static TrunkedNetworkAttachmentConfiguration DeserializeTrunkedNetworkAttachmentConfiguration(JsonElement element)
        {
            ...
            return new TrunkedNetworkAttachmentConfiguration(networkId, Core.Optional.ToNullable(pluginType));
        }
    }
}
