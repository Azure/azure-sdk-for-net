...
{
    public partial class TrunkedNetworkAttachmentConfiguration : IUtf8JsonSerializable
    {
        ...
        internal static TrunkedNetworkAttachmentConfiguration DeserializeTrunkedNetworkAttachmentConfiguration(JsonElement element)
        {
            ...
            return new TrunkedNetworkAttachmentConfiguration(networkId, Optional.ToNullable(pluginType));
        }
    }
}
