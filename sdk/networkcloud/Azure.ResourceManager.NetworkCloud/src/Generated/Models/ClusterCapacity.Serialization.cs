...
namespace Azure.ResourceManager.NetworkCloud.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ClusterCapacity>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ClusterCapacity>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ClusterCapacity>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ClusterCapacity>)} interface");
            }
        ...
        string IPersistableModel<ClusterCapacity>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
