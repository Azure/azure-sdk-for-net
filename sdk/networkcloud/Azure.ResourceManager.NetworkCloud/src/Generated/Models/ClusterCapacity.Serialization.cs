...
{
    public partial class ClusterCapacity : IUtf8JsonSerializable, IJsonModel<ClusterCapacity>, IPersistableModel<ClusterCapacity>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(AvailableApplianceStorageGB))
            {
                builder.Append("  availableApplianceStorageGB:");
                builder.AppendLine($" '{AvailableApplianceStorageGB.Value.ToString()}'");
            }

            if (Optional.IsDefined(AvailableCoreCount))
            {
                builder.Append("  availableCoreCount:");
                builder.AppendLine($" '{AvailableCoreCount.Value.ToString()}'");
            }

            if (Optional.IsDefined(AvailableHostStorageGB))
            {
                builder.Append("  availableHostStorageGB:");
                builder.AppendLine($" '{AvailableHostStorageGB.Value.ToString()}'");
            }

            if (Optional.IsDefined(AvailableMemoryGB))
            {
                builder.Append("  availableMemoryGB:");
                builder.AppendLine($" '{AvailableMemoryGB.Value.ToString()}'");
            }

            if (Optional.IsDefined(TotalApplianceStorageGB))
            {
                builder.Append("  totalApplianceStorageGB:");
                builder.AppendLine($" '{TotalApplianceStorageGB.Value.ToString()}'");
            }
            ...
            if (Optional.IsDefined(TotalHostStorageGB))
            {
                builder.Append("  totalHostStorageGB:");
                builder.AppendLine($" '{TotalHostStorageGB.Value.ToString()}'");
            }
