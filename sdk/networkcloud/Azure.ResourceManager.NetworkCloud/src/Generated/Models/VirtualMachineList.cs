...
namespace Azure.ResourceManager.NetworkCloud.Models
{
    ...
    internal partial class VirtualMachineList
    {
        ...
        internal VirtualMachineList(IEnumerable<NetworkCloudVirtualMachineData> value)
        {
            Value = value.ToList();
        }
        ...
        internal VirtualMachineList(IList<NetworkCloudVirtualMachineData> value, Uri nextLink, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            NextLink = nextLink;
        ...
        public IList<NetworkCloudVirtualMachineData> Value { get; }
