...
namespace Azure.ResourceManager.NetworkCloud.Models
{
    ...
    public partial class BareMetalMachineRunCommandContent
    {
        ...
        internal BareMetalMachineRunCommandContent(IList<string> arguments, long limitTimeSeconds, string script, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Arguments = arguments;
            LimitTimeSeconds = limitTimeSeconds;
            Script = script;
