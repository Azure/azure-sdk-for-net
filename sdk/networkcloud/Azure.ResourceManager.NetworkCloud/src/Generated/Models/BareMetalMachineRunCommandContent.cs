...
namespace Azure.ResourceManager.NetworkCloud.Models
{
    ...
    public partial class BareMetalMachineRunCommandContent
    {
        ...
        internal BareMetalMachineRunCommandContent(IList<string> arguments, long limitTimeSeconds, string script, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Arguments = arguments;
            LimitTimeSeconds = limitTimeSeconds;
            Script = script;
