...
{
    public partial class HardwareValidationStatus : IUtf8JsonSerializable, IJsonModel<HardwareValidationStatus>, IPersistableModel<HardwareValidationStatus>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  lastValidationTime:");
                builder.AppendLine($" '{LastValidationOn.Value.ToString()}'");
            }
