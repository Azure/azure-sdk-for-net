...
namespace Azure.ResourceManager.NetworkCloud.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HardwareValidationStatus>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<HardwareValidationStatus>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<HardwareValidationStatus>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<HardwareValidationStatus>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
