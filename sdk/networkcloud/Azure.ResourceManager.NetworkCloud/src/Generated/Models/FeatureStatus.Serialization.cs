...
namespace Azure.ResourceManager.NetworkCloud.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FeatureStatus>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<FeatureStatus>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<FeatureStatus>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<FeatureStatus>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
