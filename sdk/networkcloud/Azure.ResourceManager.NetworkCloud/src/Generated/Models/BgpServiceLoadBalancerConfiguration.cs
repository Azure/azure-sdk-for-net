...
namespace Azure.ResourceManager.NetworkCloud.Models
{
    ...
    public partial class BgpServiceLoadBalancerConfiguration
    {
        ...
        internal BgpServiceLoadBalancerConfiguration(IList<BgpAdvertisement> bgpAdvertisements, IList<ServiceLoadBalancerBgpPeer> bgpPeers, FabricPeeringEnabled? fabricPeeringEnabled, IList<IPAddressPool> ipAddressPools, Dictionary<string, BinaryData> rawData)
        {
