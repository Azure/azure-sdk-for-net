...
namespace Azure.ResourceManager.NetworkCloud.Models
{
    ...
    internal partial class AadConfiguration
    {
        /// <summary> Initializes a new instance of AadConfiguration. </summary>
        ...
        public AadConfiguration(IEnumerable<string> adminGroupObjectIds)
        {
        ...
        /// <summary> Initializes a new instance of AadConfiguration. </summary>
        /// <param name="adminGroupObjectIds"> The list of Azure Active Directory group object IDs that will have an administrative role on the Kubernetes cluster. </param>
        internal AadConfiguration(IList<string> adminGroupObjectIds)
        {
