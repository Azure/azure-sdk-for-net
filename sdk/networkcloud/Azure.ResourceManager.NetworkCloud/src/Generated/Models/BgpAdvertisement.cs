...
namespace Azure.ResourceManager.NetworkCloud.Models
{
    ...
    public partial class BgpAdvertisement
    {
        ...
        internal BgpAdvertisement(AdvertiseToFabric? advertiseToFabric, IList<string> communities, IList<string> ipAddressPools, IList<string> peers, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
