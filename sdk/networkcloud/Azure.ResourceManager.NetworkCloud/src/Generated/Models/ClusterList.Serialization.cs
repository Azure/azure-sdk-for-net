...
namespace Azure.ResourceManager.NetworkCloud.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ClusterList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ClusterList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ClusterList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ClusterList>)} interface");
            }
        ...
        string IPersistableModel<ClusterList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
