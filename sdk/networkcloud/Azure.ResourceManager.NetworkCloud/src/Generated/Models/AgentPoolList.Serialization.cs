...
{
    internal partial class AgentPoolList : IUtf8JsonSerializable, IJsonModel<AgentPoolList>, IPersistableModel<AgentPoolList>
    {
        ...
        void IJsonModel<AgentPoolList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AgentPoolList)} does not support '{format}' format.");
            }
