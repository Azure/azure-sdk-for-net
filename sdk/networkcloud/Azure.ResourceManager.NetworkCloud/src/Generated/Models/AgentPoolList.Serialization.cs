...
namespace Azure.ResourceManager.NetworkCloud.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AgentPoolList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AgentPoolList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AgentPoolList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AgentPoolList>)} interface");
            }
        ...
        string IPersistableModel<AgentPoolList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
