...
namespace Azure.ResourceManager.NetworkCloud.Models
{
    ...
    public partial class NetworkCloudKubernetesClusterPatch
    {
        ...
        internal NetworkCloudKubernetesClusterPatch(IDictionary<string, string> tags, ControlPlaneNodePatchConfiguration controlPlaneNodeConfiguration, string kubernetesVersion, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Tags = tags;
