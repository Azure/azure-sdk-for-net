...
namespace Azure.ResourceManager.NetworkCloud.Models
{
    public partial class NetworkCloudVirtualMachinePatch : IUtf8JsonSerializable, IJsonModel<NetworkCloudVirtualMachinePatch>
    {
        ...
        void IJsonModel<NetworkCloudVirtualMachinePatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(NetworkCloudVirtualMachinePatch)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<NetworkCloudVirtualMachinePatch>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(NetworkCloudVirtualMachinePatch)} does not support '{options.Format}' format.");
            }
        }
