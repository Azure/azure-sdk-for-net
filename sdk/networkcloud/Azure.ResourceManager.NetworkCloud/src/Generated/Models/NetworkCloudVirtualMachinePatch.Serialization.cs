...
namespace Azure.ResourceManager.NetworkCloud.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NetworkCloudVirtualMachinePatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NetworkCloudVirtualMachinePatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NetworkCloudVirtualMachinePatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<NetworkCloudVirtualMachinePatch>)} interface");
            }
        ...
        string IPersistableModel<NetworkCloudVirtualMachinePatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
