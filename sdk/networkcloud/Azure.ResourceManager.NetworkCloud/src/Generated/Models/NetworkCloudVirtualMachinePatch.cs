...
namespace Azure.ResourceManager.NetworkCloud.Models
{
    ...
    public partial class NetworkCloudVirtualMachinePatch
    {
        ...
        internal NetworkCloudVirtualMachinePatch(IDictionary<string, string> tags, ImageRepositoryCredentials vmImageRepositoryCredentials, Dictionary<string, BinaryData> rawData)
        {
            Tags = tags;
