...
namespace Azure.ResourceManager.NetworkCloud.Models
{
    ...
    public partial class InitialAgentPoolConfiguration
    {
        ...
        internal InitialAgentPoolConfiguration(AdministratorConfiguration administratorConfiguration, NetworkCloudAgentConfiguration agentOptions, AttachedNetworkConfiguration attachedNetworkConfiguration, IList<string> availabilityZones, long count, IList<KubernetesLabel> labels, NetworkCloudAgentPoolMode mode, string name, IList<KubernetesLabel> taints, AgentPoolUpgradeSettings upgradeSettings, string vmSkuName, Dictionary<string, BinaryData> rawData)
        {
