...
namespace Azure.ResourceManager.NetworkCloud.Models
{
    ...
    public partial class NetworkCloudVirtualMachineConsolePatch
    {
        ...
        internal NetworkCloudVirtualMachineConsolePatch(IDictionary<string, string> tags, ConsoleEnabled? enabled, DateTimeOffset? expireOn, NetworkCloudSshPublicKey sshPublicKey, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Tags = tags;
            Enabled = enabled;
            ExpireOn = expireOn;
