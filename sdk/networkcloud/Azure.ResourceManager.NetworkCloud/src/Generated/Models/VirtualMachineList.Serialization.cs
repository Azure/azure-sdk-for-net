...
{
    internal partial class VirtualMachineList : IUtf8JsonSerializable, IJsonModel<VirtualMachineList>, IPersistableModel<VirtualMachineList>
    {
        ...
        void IJsonModel<VirtualMachineList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(VirtualMachineList)} does not support '{format}' format.");
            }
