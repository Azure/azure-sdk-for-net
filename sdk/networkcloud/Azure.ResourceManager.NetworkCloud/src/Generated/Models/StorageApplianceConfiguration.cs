...
namespace Azure.ResourceManager.NetworkCloud.Models
{
    ...
    public partial class StorageApplianceConfiguration
    {
        ...
        internal StorageApplianceConfiguration(AdministrativeCredentials adminCredentials, long rackSlot, string serialNumber, string storageApplianceName, Dictionary<string, BinaryData> rawData)
        {
            AdminCredentials = adminCredentials;
            RackSlot = rackSlot;
            SerialNumber = serialNumber;
