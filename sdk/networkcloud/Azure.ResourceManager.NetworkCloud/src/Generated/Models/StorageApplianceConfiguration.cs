...
namespace Azure.ResourceManager.NetworkCloud.Models
{
    ...
    public partial class StorageApplianceConfiguration
    {
        ...
        internal StorageApplianceConfiguration(AdministrativeCredentials adminCredentials, long rackSlot, string serialNumber, string storageApplianceName, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            AdminCredentials = adminCredentials;
            RackSlot = rackSlot;
            SerialNumber = serialNumber;
