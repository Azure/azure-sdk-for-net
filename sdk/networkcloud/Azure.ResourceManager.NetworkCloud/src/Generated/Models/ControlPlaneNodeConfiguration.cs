...
namespace Azure.ResourceManager.NetworkCloud.Models
{
    ...
    public partial class ControlPlaneNodeConfiguration
    {
        ...
        internal ControlPlaneNodeConfiguration(AdministratorConfiguration administratorConfiguration, IList<string> availabilityZones, long count, string vmSkuName, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
