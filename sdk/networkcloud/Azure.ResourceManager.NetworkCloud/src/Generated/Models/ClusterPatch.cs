...
namespace Azure.ResourceManager.NetworkCloud.Models
{
    ...
    public partial class ClusterPatch
    {
        ...
        /// </param>
        internal ClusterPatch(IDictionary<string, string> tags, RackDefinition aggregatorOrSingleRackDefinition, string clusterLocation, ServicePrincipalInformation clusterServicePrincipal, ValidationThreshold computeDeploymentThreshold, IList<RackDefinition> computeRackDefinitions)
        {
            Tags = tags;
