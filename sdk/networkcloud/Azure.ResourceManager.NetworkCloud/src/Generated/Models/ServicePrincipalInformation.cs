...
namespace Azure.ResourceManager.NetworkCloud.Models
{
    ...
    public partial class ServicePrincipalInformation
    {
        ...
        internal ServicePrincipalInformation(string applicationId, string password, string principalId, string tenantId, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            ApplicationId = applicationId;
            Password = password;
            PrincipalId = principalId;
