...
{
    public partial class NetworkCloudL2NetworkData : IUtf8JsonSerializable, IJsonModel<NetworkCloudL2NetworkData>, IPersistableModel<NetworkCloudL2NetworkData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(L2IsolationDomainId))
            {
                builder.Append("  l2IsolationDomainId:");
                builder.AppendLine($" '{L2IsolationDomainId.ToString()}'");
            }
