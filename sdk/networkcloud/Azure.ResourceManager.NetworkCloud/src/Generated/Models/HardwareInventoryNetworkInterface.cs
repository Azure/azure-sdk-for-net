...
namespace Azure.ResourceManager.NetworkCloud.Models
{
    ...
    public partial class HardwareInventoryNetworkInterface
    {
        ...
        internal HardwareInventoryNetworkInterface(string linkStatus, string macAddress, string name, string networkInterfaceId, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
