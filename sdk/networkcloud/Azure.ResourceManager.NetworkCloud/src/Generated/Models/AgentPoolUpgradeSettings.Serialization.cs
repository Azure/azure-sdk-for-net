...
namespace Azure.ResourceManager.NetworkCloud.Models
{
    ...
    public partial class AgentPoolUpgradeSettings : IJsonModel<AgentPoolUpgradeSettings>
    {
        ...
        internal static AgentPoolUpgradeSettings DeserializeAgentPoolUpgradeSettings(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            {
                if (prop.NameEquals("drainTimeout"u8))
                {
                    if (prop.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
                    }
                    drainTimeout = prop.Value.GetInt64();
                    continue;
                }
            ...
            return new AgentPoolUpgradeSettings(drainTimeout, maxSurge, maxUnavailable, additionalBinaryDataProperties);
        }
    }
}
