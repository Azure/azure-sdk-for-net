...
namespace Azure.ResourceManager.NetworkCloud.Models
{
    ...
    public partial class ValidationThreshold
    {
        ...
        internal ValidationThreshold(ValidationThresholdGrouping grouping, ValidationThresholdType thresholdType, long value, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Grouping = grouping;
            ThresholdType = thresholdType;
            Value = value;
