...
namespace Azure.ResourceManager.NetworkCloud.Models
{
    ...
    public partial class LldpNeighbor
    {
        ...
        internal LldpNeighbor(string portDescription, string portName, string systemDescription, string systemName, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
