...
namespace Azure.ResourceManager.NetworkCloud.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BareMetalMachineRunDataExtractsContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<BareMetalMachineRunDataExtractsContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BareMetalMachineRunDataExtractsContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<BareMetalMachineRunDataExtractsContent>)} interface");
            }
        ...
        string IPersistableModel<BareMetalMachineRunDataExtractsContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
