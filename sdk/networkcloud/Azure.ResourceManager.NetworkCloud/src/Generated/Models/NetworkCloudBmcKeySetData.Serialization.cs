...
{
    public partial class NetworkCloudBmcKeySetData : IUtf8JsonSerializable, IJsonModel<NetworkCloudBmcKeySetData>, IPersistableModel<NetworkCloudBmcKeySetData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(LastValidatedOn))
            {
                ...
                builder.AppendLine($" '{LastValidatedOn.Value.ToString()}'");
            }
