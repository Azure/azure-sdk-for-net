...
namespace Azure.ResourceManager.NetworkCloud.Models
{
    ...
    public partial class CloudServicesNetworkStorageStatus
    {
        ...
        internal CloudServicesNetworkStorageStatus(CloudServicesNetworkStorageMode? mode, long? sizeMiB, CloudServicesNetworkStorageStatusStatus? status, string statusMessage, ResourceIdentifier volumeId, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Mode = mode;
            SizeMiB = sizeMiB;
            Status = status;
