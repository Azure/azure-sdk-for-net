...
{
    public partial class KubernetesClusterData : IUtf8JsonSerializable
    {
        ...
        internal static KubernetesClusterData DeserializeKubernetesClusterData(JsonElement element)
        {
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        if (property0.NameEquals("aadConfiguration"u8))
                        {
                            ...
                            aadConfiguration = AadConfiguration.DeserializeAadConfiguration(property0.Value);
                            continue;
                        }
                        ...
                        {
                            connectedClusterId = property0.Value.GetString();
                            continue;
                        }
