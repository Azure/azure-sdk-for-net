...
namespace Azure.ResourceManager.NetworkCloud.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BareMetalMachineRunCommandContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<BareMetalMachineRunCommandContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BareMetalMachineRunCommandContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<BareMetalMachineRunCommandContent>)} interface");
            }
        ...
        string IPersistableModel<BareMetalMachineRunCommandContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
