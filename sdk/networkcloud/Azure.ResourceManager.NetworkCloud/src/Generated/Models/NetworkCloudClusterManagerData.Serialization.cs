...
{
    public partial class NetworkCloudClusterManagerData : IUtf8JsonSerializable, IJsonModel<NetworkCloudClusterManagerData>, IPersistableModel<NetworkCloudClusterManagerData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(FabricControllerId))
            {
                builder.Append("  fabricControllerId:");
                builder.AppendLine($" '{FabricControllerId.ToString()}'");
            }
            ...
            {
                builder.Append("  managerExtendedLocation:");
                AppendChildObject(builder, ManagerExtendedLocation, options, 2);
            }
