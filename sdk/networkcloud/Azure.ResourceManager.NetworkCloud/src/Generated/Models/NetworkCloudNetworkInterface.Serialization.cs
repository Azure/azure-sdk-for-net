...
{
    public partial class NetworkCloudNetworkInterface : IUtf8JsonSerializable, IJsonModel<NetworkCloudNetworkInterface>, IPersistableModel<NetworkCloudNetworkInterface>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(DeviceConnectionType))
            {
                ...
                builder.AppendLine($" '{DeviceConnectionType.ToString()}'");
            }
