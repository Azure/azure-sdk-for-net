...
namespace Azure.ResourceManager.NetworkCloud.Models
{
    ...
    public partial class NetworkCloudBareMetalMachinePatch
    {
        ...
        internal NetworkCloudBareMetalMachinePatch(IDictionary<string, string> tags, string machineDetails, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Tags = tags;
