...
namespace Azure.ResourceManager.NetworkCloud.Models
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="AgentPoolProperties"/> for deserialization. </summary>
        internal AgentPoolProperties()
        {
        }
        ...
        internal static AgentPoolProperties DeserializeAgentPoolProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("detailedStatus"u8))
                {
                    ...
                    detailedStatus = new AgentPoolDetailedStatus(prop.Value.GetString());
                    continue;
                }
                ...
                if (prop.NameEquals("provisioningState"u8))
                {
                    ...
                    provisioningState = new AgentPoolProvisioningState(prop.Value.GetString());
                    continue;
                }
                if (options.Format != "W")
                {
