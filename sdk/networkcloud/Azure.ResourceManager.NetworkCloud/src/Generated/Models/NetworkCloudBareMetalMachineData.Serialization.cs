...
{
    public partial class NetworkCloudBareMetalMachineData : IUtf8JsonSerializable, IJsonModel<NetworkCloudBareMetalMachineData>, IPersistableModel<NetworkCloudBareMetalMachineData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(BmcCredentials))
            {
                ...
                AppendChildObject(builder, BmcCredentials, options, 2);
            }
            ...
            if (Optional.IsDefined(CordonStatus))
            {
                ...
                builder.AppendLine($" '{CordonStatus.ToString()}'");
            }
            ...
            if (Optional.IsDefined(HardwareInventory))
            {
                ...
                AppendChildObject(builder, HardwareInventory, options, 2);
            }

            if (Optional.IsDefined(HardwareValidationStatus))
            {
                builder.Append("  hardwareValidationStatus:");
                AppendChildObject(builder, HardwareValidationStatus, options, 2);
            }
            ...
            if (Optional.IsDefined(ReadyState))
            {
                ...
                builder.AppendLine($" '{ReadyState.ToString()}'");
            }
