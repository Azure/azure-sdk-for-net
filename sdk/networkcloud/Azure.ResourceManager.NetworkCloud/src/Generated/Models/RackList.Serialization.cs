...
namespace Azure.ResourceManager.NetworkCloud.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RackList>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        internal static RackList DeserializeRackList(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new RackList(nextLink, value ?? new ChangeTrackingList<NetworkCloudRackData>(), serializedAdditionalRawData);
        }
