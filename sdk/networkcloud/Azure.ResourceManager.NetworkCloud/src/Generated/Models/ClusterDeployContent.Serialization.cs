...
namespace Azure.ResourceManager.NetworkCloud.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ClusterDeployContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ClusterDeployContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ClusterDeployContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<ClusterDeployContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
