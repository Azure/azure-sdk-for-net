...
namespace Azure.ResourceManager.NetworkCloud
{
    public partial class VolumeData : IUtf8JsonSerializable
    {
        ...
        internal static VolumeData DeserializeVolumeData(JsonElement element)
        {
            ...
            return new VolumeData(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, extendedLocation, Optional.ToList(attachedTo), Optional.ToNullable(detailedStatus), detailedStatusMessage.Value, Optional.ToNullable(provisioningState), serialNumber.Value, sizeMiB);
        }
    }
}
