...
{
    public partial class RackDefinition : IUtf8JsonSerializable
    {
        ...
        internal static RackDefinition DeserializeRackDefinition(JsonElement element)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    rackSkuId = property.Value.GetString();
                    continue;
                }
            ...
            return new RackDefinition(availabilityZone.Value, Optional.ToList(bareMetalMachineConfigurationData), networkRackId, rackLocation.Value, rackSerialNumber, rackSkuId, Optional.ToList(storageApplianceConfigurationData));
        }
    }
}
