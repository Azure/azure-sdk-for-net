...
namespace Azure.ResourceManager.NetworkCloud.Models
{
    ...
    public partial class BareMetalMachineReplaceContent
    {
        ...
        internal BareMetalMachineReplaceContent(AdministrativeCredentials bmcCredentials, string bmcMacAddress, string bootMacAddress, string machineName, string serialNumber, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
