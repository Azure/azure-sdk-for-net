...
{
    public partial class RackData : IUtf8JsonSerializable
    {
        ...
        internal static RackData DeserializeRackData(JsonElement element)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        {
                            rackSkuId = property0.Value.GetString();
                            continue;
                        }
                    }
                    continue;
            ...
            return new RackData(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, extendedLocation, availabilityZone, clusterId.Value, Optional.ToNullable(detailedStatus), detailedStatusMessage.Value, Optional.ToNullable(provisioningState), rackLocation, rackSerialNumber, rackSkuId);
        }
    }
}
