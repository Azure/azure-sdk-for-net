...
{
    public partial class AttachedNetworkConfiguration : IUtf8JsonSerializable, IJsonModel<AttachedNetworkConfiguration>, IPersistableModel<AttachedNetworkConfiguration>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(TrunkedNetworks))
            {
                builder.Append("  trunkedNetworks:");
                builder.AppendLine(" [");
                foreach (var item in TrunkedNetworks)
                {
                    AppendChildObject(builder, item, options, 4);
