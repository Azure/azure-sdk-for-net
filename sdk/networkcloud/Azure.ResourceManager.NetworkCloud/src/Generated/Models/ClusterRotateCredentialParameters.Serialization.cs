...
namespace Azure.ResourceManager.NetworkCloud.Models
{
    ...
    public partial class ClusterRotateCredentialContent : IJsonModel<ClusterRotateCredentialContent>
    {
        ...
        /// <param name="clusterRotateCredentialContent"> The <see cref="ClusterRotateCredentialContent"/> to serialize into <see cref="RequestContent"/>. </param>
        internal static RequestContent ToRequestContent(ClusterRotateCredentialContent clusterRotateCredentialContent)
        {
            if (clusterRotateCredentialContent == null)
            {
                return null;
            }
            return RequestContent.Create(clusterRotateCredentialContent, ModelSerializationExtensions.WireOptions);
        }
