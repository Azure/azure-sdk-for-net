...
namespace Azure.ResourceManager.NetworkCloud.Models
{
    public partial class NetworkCloudNic : IUtf8JsonSerializable, IJsonModel<NetworkCloudNic>
    {
        ...
        void IJsonModel<NetworkCloudNic>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(NetworkCloudNic)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<NetworkCloudNic>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(NetworkCloudNic)} does not support '{options.Format}' format.");
            }
        }
