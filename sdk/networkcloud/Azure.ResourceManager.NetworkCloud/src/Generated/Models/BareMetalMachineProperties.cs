...
namespace Azure.ResourceManager.NetworkCloud.Models
{
    ...
    internal partial class BareMetalMachineProperties
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="BareMetalMachineProperties"/>. </summary>
        ...
        public BareMetalMachineProperties(string bmcConnectionString, AdministrativeCredentials bmcCredentials, string bmcMacAddress, string bootMacAddress, string machineDetails, string machineName, string machineSkuId, ResourceIdentifier rackId, long rackSlot, string serialNumber)
        {
        ...
        public IReadOnlyList<string> HybridAksClustersAssociatedIds { get; } = new ChangeTrackingList<string>();
        ...
        public IReadOnlyList<string> VirtualMachinesAssociatedIds { get; } = new ChangeTrackingList<string>();
