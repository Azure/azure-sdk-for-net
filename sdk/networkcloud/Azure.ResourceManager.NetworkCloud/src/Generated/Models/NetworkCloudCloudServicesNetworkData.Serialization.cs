...
namespace Azure.ResourceManager.NetworkCloud
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NetworkCloudCloudServicesNetworkData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NetworkCloudCloudServicesNetworkData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NetworkCloudCloudServicesNetworkData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<NetworkCloudCloudServicesNetworkData>)} interface");
            }
        ...
        string IPersistableModel<NetworkCloudCloudServicesNetworkData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
