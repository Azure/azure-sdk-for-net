...
namespace Azure.ResourceManager.NetworkCloud.Models
{
    ...
    {
        internal static BareMetalMachineKeySetList DeserializeBareMetalMachineKeySetList(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
