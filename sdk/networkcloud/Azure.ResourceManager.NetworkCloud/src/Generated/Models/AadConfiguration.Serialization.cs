...
{
    internal partial class AadConfiguration : IUtf8JsonSerializable
    {
        ...
        internal static AadConfiguration DeserializeAadConfiguration(JsonElement element)
        {
            ...
            return new AadConfiguration(adminGroupObjectIds);
        }
    }
}
