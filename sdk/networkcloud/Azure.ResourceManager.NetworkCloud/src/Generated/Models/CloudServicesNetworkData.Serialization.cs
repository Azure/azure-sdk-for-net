...
{
    public partial class CloudServicesNetworkData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static CloudServicesNetworkData DeserializeCloudServicesNetworkData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
