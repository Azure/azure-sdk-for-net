...
namespace Azure.ResourceManager.NetworkCloud.Models
{
    ...
    public partial class NetworkCloudKubernetesClusterFeaturePatch
    {
        ...
        internal NetworkCloudKubernetesClusterFeaturePatch(IList<StringKeyValuePair> options, IDictionary<string, string> tags, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Options = options;
            Tags = tags;
