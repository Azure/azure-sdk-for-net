...
{
    public partial class BareMetalMachineData : IUtf8JsonSerializable
    {
        ...
        internal static BareMetalMachineData DeserializeBareMetalMachineData(JsonElement element)
        {
            ...
            Optional<string> oamIPv4Address = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        {
                            oamIPv4Address = property0.Value.GetString();
                            continue;
                        }
