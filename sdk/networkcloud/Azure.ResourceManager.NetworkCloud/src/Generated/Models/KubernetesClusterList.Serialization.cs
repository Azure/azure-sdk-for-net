...
namespace Azure.ResourceManager.NetworkCloud.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<KubernetesClusterList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<KubernetesClusterList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<KubernetesClusterList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<KubernetesClusterList>)} interface");
            }
        ...
        string IPersistableModel<KubernetesClusterList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
