...
namespace Azure.ResourceManager.NetworkCloud.Models
{
    ...
    public partial class NetworkAttachment
    {
        ...
        internal NetworkAttachment(string attachedNetworkId, DefaultGateway? defaultGateway, VirtualMachineIPAllocationMethod ipAllocationMethod, string ipv4Address, string ipv6Address, string macAddress, string networkAttachmentName, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            AttachedNetworkId = attachedNetworkId;
