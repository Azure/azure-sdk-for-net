...
{
    public partial class NetworkCloudStorageApplianceData : IUtf8JsonSerializable, IJsonModel<NetworkCloudStorageApplianceData>, IPersistableModel<NetworkCloudStorageApplianceData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(AdministratorCredentials))
            {
                ...
                AppendChildObject(builder, AdministratorCredentials, options, 2);
            }
            ...
            if (Optional.IsDefined(RemoteVendorManagementFeature))
            {
                ...
                builder.AppendLine($" '{RemoteVendorManagementFeature.ToString()}'");
            }

            if (Optional.IsDefined(RemoteVendorManagementStatus))
            {
                builder.Append("  remoteVendorManagementStatus:");
                builder.AppendLine($" '{RemoteVendorManagementStatus.ToString()}'");
            }
