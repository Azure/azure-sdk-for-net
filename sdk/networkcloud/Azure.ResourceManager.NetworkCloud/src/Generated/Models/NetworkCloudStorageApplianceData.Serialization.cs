...
namespace Azure.ResourceManager.NetworkCloud
{
    public partial class NetworkCloudStorageApplianceData : IUtf8JsonSerializable, IModelJsonSerializable<NetworkCloudStorageApplianceData>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<NetworkCloudStorageApplianceData>(this, options.Format);
            ...
            if (AdministratorCredentials is null)
            {
                writer.WriteNullValue();
            }
            else
            {
                ((IModelJsonSerializable<AdministrativeCredentials>)AdministratorCredentials).Serialize(writer, options);
            }
        ...
        /// <summary> Converts a <see cref="NetworkCloudStorageApplianceData"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="NetworkCloudStorageApplianceData"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="NetworkCloudStorageApplianceData"/>. </summary>
