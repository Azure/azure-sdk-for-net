...
namespace Azure.ResourceManager.NetworkCloud.Models
{
    ...
    public partial class KeySetUser
    {
        ...
        internal KeySetUser(string azureUserName, string description, NetworkCloudSshPublicKey sshPublicKey, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            AzureUserName = azureUserName;
