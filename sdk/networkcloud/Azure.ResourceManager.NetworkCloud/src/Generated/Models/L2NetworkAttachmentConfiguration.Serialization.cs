...
{
    public partial class L2NetworkAttachmentConfiguration : IUtf8JsonSerializable, IJsonModel<L2NetworkAttachmentConfiguration>, IPersistableModel<L2NetworkAttachmentConfiguration>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(NetworkId))
            {
                ...
                builder.AppendLine($" '{NetworkId.ToString()}'");
            }

            if (Optional.IsDefined(PluginType))
            {
                builder.Append("  pluginType:");
                builder.AppendLine($" '{PluginType.ToString()}'");
            }
