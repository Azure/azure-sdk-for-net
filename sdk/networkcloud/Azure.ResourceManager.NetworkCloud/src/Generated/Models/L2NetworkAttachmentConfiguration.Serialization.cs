...
namespace Azure.ResourceManager.NetworkCloud.Models
{
    ...
    public partial class L2NetworkAttachmentConfiguration : IJsonModel<L2NetworkAttachmentConfiguration>
    {
        ...
        protected virtual L2NetworkAttachmentConfiguration PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<L2NetworkAttachmentConfiguration>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<L2NetworkAttachmentConfiguration>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        L2NetworkAttachmentConfiguration IPersistableModel<L2NetworkAttachmentConfiguration>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        L2NetworkAttachmentConfiguration IJsonModel<L2NetworkAttachmentConfiguration>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual L2NetworkAttachmentConfiguration JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<L2NetworkAttachmentConfiguration>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static L2NetworkAttachmentConfiguration DeserializeL2NetworkAttachmentConfiguration(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new L2NetworkAttachmentConfiguration(networkId, pluginType, additionalBinaryDataProperties);
        }
    }
}
