...
namespace Azure.ResourceManager.NetworkCloud.Models
{
    ...
    public partial class NetworkCloudRackPatch
    {
        ...
        internal NetworkCloudRackPatch(IDictionary<string, string> tags, string rackLocation, string rackSerialNumber, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Tags = tags;
