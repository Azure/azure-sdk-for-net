...
namespace Azure.ResourceManager.NetworkCloud.Models
{
    ...
    public partial class NetworkCloudBmcKeySetPatch
    {
        ...
        internal NetworkCloudBmcKeySetPatch(IDictionary<string, string> tags, DateTimeOffset? expireOn, IList<KeySetUser> userList, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Tags = tags;
            ExpireOn = expireOn;
            UserList = userList;
