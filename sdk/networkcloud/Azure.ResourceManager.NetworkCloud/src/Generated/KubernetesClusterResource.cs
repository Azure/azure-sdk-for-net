...
namespace Azure.ResourceManager.NetworkCloud
{
    ...
    public partial class KubernetesClusterResource : ArmResource
    {
        ...
        private readonly KubernetesClusterData _data;

        /// <summary> Initializes a new instance of the <see cref="KubernetesClusterResource"/> class for mocking. </summary>
        protected KubernetesClusterResource()
        {
        }

        /// <summary> Initializes a new instance of the <see cref = "KubernetesClusterResource"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="data"> The resource that is the target of operations. </param>
        internal KubernetesClusterResource(ArmClient client, KubernetesClusterData data) : this(client, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal KubernetesClusterResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            _kubernetesClusterClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.NetworkCloud", ResourceType.Namespace, Diagnostics);
            TryGetApiVersion(ResourceType, out string kubernetesClusterApiVersion);
        ...
        public virtual KubernetesClusterData Data
        {
            get
            {
                if (!HasData)
        ...
        /// <summary> Gets a collection of AgentPoolResources in the KubernetesCluster. </summary>
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<KubernetesClusterResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            using var scope = _kubernetesClusterClientDiagnostics.CreateScope("KubernetesClusterResource.Get");
            scope.Start();
            try
            {
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<KubernetesClusterResource> Get(CancellationToken cancellationToken = default)
        {
            using var scope = _kubernetesClusterClientDiagnostics.CreateScope("KubernetesClusterResource.Get");
            scope.Start();
            try
        ...
        {
            using var scope = _kubernetesClusterClientDiagnostics.CreateScope("KubernetesClusterResource.Delete");
            scope.Start();
            try
            {
        ...
        public virtual async Task<ArmOperation<KubernetesClusterResource>> UpdateAsync(WaitUntil waitUntil, KubernetesClusterPatch patch, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(patch, nameof(patch));

            using var scope = _kubernetesClusterClientDiagnostics.CreateScope("KubernetesClusterResource.Update");
            scope.Start();
            try
            {
                ...
                var operation = new NetworkCloudArmOperation<KubernetesClusterResource>(new KubernetesClusterOperationSource(Client), _kubernetesClusterClientDiagnostics, Pipeline, _kubernetesClusterRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, patch).Request, response, OperationFinalStateVia.AzureAsyncOperation);
                if (waitUntil == WaitUntil.Completed)
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="patch"/> is null. </exception>
        public virtual ArmOperation<KubernetesClusterResource> Update(WaitUntil waitUntil, KubernetesClusterPatch patch, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(patch, nameof(patch));
        ...
        public virtual async Task<ArmOperation> RestartNodeAsync(WaitUntil waitUntil, KubernetesClusterRestartNodeContent content, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _kubernetesClusterClientDiagnostics.CreateScope("KubernetesClusterResource.RestartNode");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response<KubernetesClusterResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(key, nameof(key));
            Argument.AssertNotNull(value, nameof(value));

            using var scope = _kubernetesClusterClientDiagnostics.CreateScope("KubernetesClusterResource.AddTag");
            scope.Start();
            try
            {
                ...
                else
                {
                    ...
                    var patch = new KubernetesClusterPatch();
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="key"/> or <paramref name="value"/> is null. </exception>
        public virtual Response<KubernetesClusterResource> AddTag(string key, string value, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(key, nameof(key));
            Argument.AssertNotNull(value, nameof(value));
        ...
        public virtual async Task<Response<KubernetesClusterResource>> SetTagsAsync(IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(tags, nameof(tags));

            using var scope = _kubernetesClusterClientDiagnostics.CreateScope("KubernetesClusterResource.SetTags");
            scope.Start();
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="tags"/> is null. </exception>
        public virtual Response<KubernetesClusterResource> SetTags(IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(tags, nameof(tags));
        ...
        public virtual async Task<Response<KubernetesClusterResource>> RemoveTagAsync(string key, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(key, nameof(key));

            using var scope = _kubernetesClusterClientDiagnostics.CreateScope("KubernetesClusterResource.RemoveTag");
            scope.Start();
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="key"/> is null. </exception>
        public virtual Response<KubernetesClusterResource> RemoveTag(string key, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(key, nameof(key));
