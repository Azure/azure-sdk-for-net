...
namespace Azure.ResourceManager.NetworkCloud
{
    public partial class NetworkCloudTrunkedNetworkResource
    {
        ...
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual Response<NetworkCloudTrunkedNetworkResource> Update(NetworkCloudTrunkedNetworkPatch patch, string ifMatch, string ifNoneMatch, CancellationToken cancellationToken = default)
            => Update(patch, matchConditions: default, cancellationToken: cancellationToken);

        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual async Task<Response<NetworkCloudTrunkedNetworkResource>> UpdateAsync(NetworkCloudTrunkedNetworkPatch patch, string ifMatch, string ifNoneMatch, CancellationToken cancellationToken = default)
            => await UpdateAsync(patch, matchConditions: default, cancellationToken: cancellationToken).ConfigureAwait(false);
    }
}
