...
namespace Azure.ResourceManager.NetworkCloud
{
    public partial class NetworkCloudL2NetworkResource
    {
        ...
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual Response<NetworkCloudL2NetworkResource> Update(NetworkCloudL2NetworkPatch patch, string ifMatch, string ifNoneMatch, CancellationToken cancellationToken)
            => Update(patch, null, cancellationToken);

        /// <summary> Backward compatible overload for API compatibility. </summary>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual async Task<Response<NetworkCloudL2NetworkResource>> UpdateAsync(NetworkCloudL2NetworkPatch patch, string ifMatch, string ifNoneMatch, CancellationToken cancellationToken)
            => await UpdateAsync(patch, null, cancellationToken).ConfigureAwait(false);
