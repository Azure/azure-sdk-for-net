...
namespace Azure.ResourceManager.NetworkCloud
{
    public partial class NetworkCloudVolumeResource
    {
        ...
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual Response<NetworkCloudVolumeResource> Update(NetworkCloudVolumePatch patch, string ifMatch, string ifNoneMatch, CancellationToken cancellationToken = default)
            => Update(patch, matchConditions: default, cancellationToken: cancellationToken);

        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual async Task<Response<NetworkCloudVolumeResource>> UpdateAsync(NetworkCloudVolumePatch patch, string ifMatch, string ifNoneMatch, CancellationToken cancellationToken = default)
            => await UpdateAsync(patch, matchConditions: default, cancellationToken: cancellationToken).ConfigureAwait(false);
    }
}
