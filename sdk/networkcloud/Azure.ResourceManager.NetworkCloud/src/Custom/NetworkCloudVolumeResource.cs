...
namespace Azure.ResourceManager.NetworkCloud
{
    public partial class NetworkCloudVolumeResource
    {
        ...
        public virtual async Task<Response<NetworkCloudVolumeResource>> UpdateAsync(NetworkCloudVolumePatch patch, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="patch"/> is null. </exception>
        public virtual Response<NetworkCloudVolumeResource> Update(NetworkCloudVolumePatch patch, CancellationToken cancellationToken = default)
        {
