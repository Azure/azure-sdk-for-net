...
namespace Azure.ResourceManager.NetworkCloud
{
    public partial class NetworkCloudClusterResource
    {
        ...
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<NetworkCloudClusterResource> Update(WaitUntil waitUntil, NetworkCloudClusterPatch patch, string ifMatch, string ifNoneMatch, CancellationToken cancellationToken = default)
            => Update(waitUntil, patch, matchConditions: default, cancellationToken: cancellationToken);

        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual async Task<ArmOperation<NetworkCloudClusterResource>> UpdateAsync(WaitUntil waitUntil, NetworkCloudClusterPatch patch, string ifMatch, string ifNoneMatch, CancellationToken cancellationToken = default)
            => await UpdateAsync(waitUntil, patch, matchConditions: default, cancellationToken: cancellationToken).ConfigureAwait(false);
    }
}
