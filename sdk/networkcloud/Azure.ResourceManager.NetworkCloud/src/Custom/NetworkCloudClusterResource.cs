...
namespace Azure.ResourceManager.NetworkCloud
{
    public partial class NetworkCloudClusterResource
    {
        ...
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<NetworkCloudClusterResource> Update(WaitUntil waitUntil, NetworkCloudClusterPatch patch, string ifMatch, string ifNoneMatch, CancellationToken cancellationToken)
            => Update(waitUntil, patch, null, cancellationToken);

        /// <summary> Backward compatible overload for API compatibility. </summary>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual async Task<ArmOperation<NetworkCloudClusterResource>> UpdateAsync(WaitUntil waitUntil, NetworkCloudClusterPatch patch, string ifMatch, string ifNoneMatch, CancellationToken cancellationToken)
            => await UpdateAsync(waitUntil, patch, null, cancellationToken).ConfigureAwait(false);
        /// <summary> Backward compatible overload for API compatibility. </summary>
        [EditorBrowsable(EditorBrowsableState.Never)]
