...
namespace Azure.ResourceManager.NetworkCloud
{
    ...
    public partial class NetworkCloudBareMetalMachineResource : ArmResource
    {
        ...
        public virtual Task<ArmOperation<NetworkCloudOperationStatusResult>> RunDataExtracts(WaitUntil waitUntil, BareMetalMachineRunDataExtractsContent bareMetalMachineRunDataExtractsContent, CancellationToken cancellationToken)
		{
			return null;
		}
        ...
        // /// <param name="cancellationToken"> The cancellation token to use. </param>
        // /// <exception cref="ArgumentNullException"> <paramref name="bareMetalMachineRunDataExtractsContent"/> is null. </exception>
        // public virtual async Task<ArmOperation<NetworkCloudOperationStatusResult>> RunDataExtractsAsync(WaitUntil waitUntil, BareMetalMachineRunDataExtractsContent bareMetalMachineRunDataExtractsContent, CancellationToken cancellationToken)
		// {
		// 	return Task<ArmOperation<NetworkCloudOperationStatusResult>>.CompletedTask;
		// }
    }
}
