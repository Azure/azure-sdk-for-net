...
namespace Azure.ResourceManager.NetworkCloud.Models
{
    public static partial class ArmNetworkCloudModelFactory
    {
        ...
        {
            return NetworkCloudOperationStatusResult(endOn, error, id, name, operations, percentComplete, (string)default, (string)default, (Uri)default, (Uri)default, resourceId, startOn, status);
        }
