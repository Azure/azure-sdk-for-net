...
namespace Azure.ResourceManager.NetworkCloud.Samples
{
    public partial class Sample_SubscriptionResourceExtensions
    {
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task GetNetworkCloudAccessBridges_ListAccessBridgesForSubscription()
        {
            ...
            // invoke the operation and iterate over the result
            await foreach (NetworkCloudAccessBridgeResource item in subscriptionResource.GetNetworkCloudAccessBridgesAsync())
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task GetNetworkCloudKubernetesVersions_ListKubernetesVersionsForSubscription()
        {
            ...
            // invoke the operation and iterate over the result
            await foreach (NetworkCloudKubernetesVersionResource item in subscriptionResource.GetNetworkCloudKubernetesVersionsAsync())
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                NetworkCloudKubernetesVersionData resourceData = item.Data;
                // for demo we just print out the id
                Console.WriteLine($"Succeeded on id: {resourceData.Id}");
            }
