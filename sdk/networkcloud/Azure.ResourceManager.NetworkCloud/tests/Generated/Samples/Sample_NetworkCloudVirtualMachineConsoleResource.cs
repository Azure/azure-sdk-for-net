...
namespace Azure.ResourceManager.NetworkCloud.Samples
{
    public partial class Sample_NetworkCloudVirtualMachineConsoleResource
    {
        ...
        {
            // Generated from example definition: 2025-02-01/Consoles_Delete.json
            // this example is just showing the usage of "Console_Delete" operation, for the dependent resources, they will have to be created separately.
            ...
            // invoke the operation
            ArmOperation<NetworkCloudOperationStatusResult> lro = await networkCloudVirtualMachineConsole.DeleteAsync(WaitUntil.Completed);
        ...
        {
            // Generated from example definition: 2025-02-01/Consoles_Patch.json
            // this example is just showing the usage of "Console_Update" operation, for the dependent resources, they will have to be created separately.
