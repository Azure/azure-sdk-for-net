...
namespace Azure.ResourceManager.NetworkCloud.Samples
{
    public partial class Sample_NetworkCloudClusterMetricsConfigurationResource
    {
        ...
        {
            // Generated from example definition: 2025-02-01/ClusterMetricsConfigurations_Delete.json
            // this example is just showing the usage of "ClusterMetricsConfiguration_Delete" operation, for the dependent resources, they will have to be created separately.
            ...
            // invoke the operation
            ArmOperation<NetworkCloudOperationStatusResult> lro = await networkCloudClusterMetricsConfiguration.DeleteAsync(WaitUntil.Completed);
        ...
        {
            // Generated from example definition: 2025-02-01/ClusterMetricsConfigurations_Patch.json
            // this example is just showing the usage of "ClusterMetricsConfiguration_Update" operation, for the dependent resources, they will have to be created separately.
