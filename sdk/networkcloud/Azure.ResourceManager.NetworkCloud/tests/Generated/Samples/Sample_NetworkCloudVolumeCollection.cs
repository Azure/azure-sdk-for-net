...
namespace Azure.ResourceManager.NetworkCloud.Samples
{
    public partial class Sample_NetworkCloudVolumeCollection
    {
        ...
        {
            // Generated from example definition: 2025-02-01/Volumes_Create.json
            // this example is just showing the usage of "Volume_CreateOrUpdate" operation, for the dependent resources, they will have to be created separately.
            ...
            NetworkCloudVolumeData data = new NetworkCloudVolumeData(new AzureLocation("location"), default, new ExtendedLocation("/subscriptions/123e4567-e89b-12d3-a456-426655440000/resourceGroups/resourceGroupName/providers/Microsoft.ExtendedLocation/customLocations/clusterExtendedLocationName", "CustomLocation"))
            {
                Tags =
{
["key1"] = "myvalue1",
["key2"] = "myvalue2"
        ...
        {
            // Generated from example definition: 2025-02-01/Volumes_ListByResourceGroup.json
            // this example is just showing the usage of "Volume_ListByResourceGroup" operation, for the dependent resources, they will have to be created separately.
