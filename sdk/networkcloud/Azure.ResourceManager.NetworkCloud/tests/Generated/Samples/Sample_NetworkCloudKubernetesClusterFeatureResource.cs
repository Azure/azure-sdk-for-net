...
namespace Azure.ResourceManager.NetworkCloud.Samples
{
    public partial class Sample_NetworkCloudKubernetesClusterFeatureResource
    {
        ...
        {
            // Generated from example definition: 2025-02-01/KubernetesClusterFeatures_Delete.json
            // this example is just showing the usage of "KubernetesClusterFeature_Delete" operation, for the dependent resources, they will have to be created separately.
        ...
        {
            // Generated from example definition: 2025-02-01/KubernetesClusterFeatures_Patch.json
            // this example is just showing the usage of "KubernetesClusterFeature_Update" operation, for the dependent resources, they will have to be created separately.
