...
namespace Azure.ResourceManager.Newrelic.Models
{
    public partial class MetricRules : IUtf8JsonSerializable
    {
        ...
        internal static MetricRules DeserializeMetricRules(JsonElement element)
        {
            ...
            Optional<SendMetricsStatus> sendMetrics = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("sendMetrics"u8))
                {
                    ...
                    sendMetrics = new SendMetricsStatus(property.Value.GetString());
                    continue;
                }
            ...
            return new MetricRules(Optional.ToNullable(sendMetrics), Optional.ToList(filteringTags), userEmail.Value);
        }
    }
}
