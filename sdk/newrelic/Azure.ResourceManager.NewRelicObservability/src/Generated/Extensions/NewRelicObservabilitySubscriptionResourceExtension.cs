...
namespace Azure.ResourceManager.NewRelicObservability.Mock
{
    ...
    public partial class NewRelicObservabilitySubscriptionResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="NewRelicObservabilitySubscriptionResourceExtension"/> class for mocking. </summary>
        protected NewRelicObservabilitySubscriptionResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="NewRelicObservabilitySubscriptionResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal NewRelicObservabilitySubscriptionResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<AccountResource> GetAccountsAsync(string userEmail, AzureLocation location, CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, AccountResource.DeserializeAccountResource, AccountsClientDiagnostics, Pipeline, "NewRelicObservabilitySubscriptionResourceExtension.GetAccounts", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<AccountResource> GetAccounts(string userEmail, AzureLocation location, CancellationToken cancellationToken = default)
        {
            ...
            HttpMessage FirstPageRequest(int? pageSizeHint) => AccountsRestClient.CreateListRequest(Id.SubscriptionId, userEmail, location);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => AccountsRestClient.CreateListNextPageRequest(nextLink, Id.SubscriptionId, userEmail, location);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, AccountResource.DeserializeAccountResource, AccountsClientDiagnostics, Pipeline, "NewRelicObservabilitySubscriptionResourceExtension.GetAccounts", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual AsyncPageable<OrganizationResource> GetOrganizationsAsync(string userEmail, AzureLocation location, CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, OrganizationResource.DeserializeOrganizationResource, OrganizationsClientDiagnostics, Pipeline, "NewRelicObservabilitySubscriptionResourceExtension.GetOrganizations", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<OrganizationResource> GetOrganizations(string userEmail, AzureLocation location, CancellationToken cancellationToken = default)
        {
            ...
            HttpMessage FirstPageRequest(int? pageSizeHint) => OrganizationsRestClient.CreateListRequest(Id.SubscriptionId, userEmail, location);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => OrganizationsRestClient.CreateListNextPageRequest(nextLink, Id.SubscriptionId, userEmail, location);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, OrganizationResource.DeserializeOrganizationResource, OrganizationsClientDiagnostics, Pipeline, "NewRelicObservabilitySubscriptionResourceExtension.GetOrganizations", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual AsyncPageable<PlanDataResource> GetPlansAsync(string accountId = null, string organizationId = null, CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, PlanDataResource.DeserializePlanDataResource, PlansClientDiagnostics, Pipeline, "NewRelicObservabilitySubscriptionResourceExtension.GetPlans", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<PlanDataResource> GetPlans(string accountId = null, string organizationId = null, CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => PlansRestClient.CreateListRequest(Id.SubscriptionId, accountId, organizationId);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => PlansRestClient.CreateListNextPageRequest(nextLink, Id.SubscriptionId, accountId, organizationId);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, PlanDataResource.DeserializePlanDataResource, PlansClientDiagnostics, Pipeline, "NewRelicObservabilitySubscriptionResourceExtension.GetPlans", "value", "nextLink", cancellationToken);
        }
    }
}
