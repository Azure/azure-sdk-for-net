...
namespace Azure.ResourceManager.NewRelicObservability
{
    ...
    /// Each <see cref="TagRuleResource" /> in the collection will belong to the same instance of <see cref="NewRelicMonitorResource" />.
    /// To get a <see cref="TagRuleCollection" /> instance call the GetTagRules method from an instance of <see cref="NewRelicMonitorResource" />.
    /// </summary>
    public partial class TagRuleCollection : ArmCollection, IEnumerable<TagRuleResource>, IAsyncEnumerable<TagRuleResource>
    {
        ...
        {
            _tagRuleClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.NewRelicObservability", TagRuleResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<TagRuleResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string ruleSetName, TagRuleData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new NewRelicObservabilityArmOperation<TagRuleResource>(new TagRuleOperationSource(Client), _tagRuleClientDiagnostics, Pipeline, _tagRuleRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, ruleSetName, data).Request, response, OperationFinalStateVia.AzureAsyncOperation);
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _tagRuleRestClient.CreateListByNewRelicMonitorResourceRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _tagRuleRestClient.CreateListByNewRelicMonitorResourceNextPageRequest(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Name);
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => { var data = TagRuleData.DeserializeTagRuleData(e); return new TagRuleResource(Client, data, data.Id); }, _tagRuleClientDiagnostics, Pipeline, "TagRuleCollection.GetAll", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<TagRuleResource> GetAll(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _tagRuleRestClient.CreateListByNewRelicMonitorResourceRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _tagRuleRestClient.CreateListByNewRelicMonitorResourceNextPageRequest(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Name);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => { var data = TagRuleData.DeserializeTagRuleData(e); return new TagRuleResource(Client, data, data.Id); }, _tagRuleClientDiagnostics, Pipeline, "TagRuleCollection.GetAll", "value", "nextLink", cancellationToken);
        }
