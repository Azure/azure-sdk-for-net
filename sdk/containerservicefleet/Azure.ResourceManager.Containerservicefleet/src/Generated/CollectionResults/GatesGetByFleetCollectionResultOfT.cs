...
{
    internal partial class GatesGetByFleetCollectionResultOfT : Pageable<GateData>
    {
        ...
        public override IEnumerable<Page<GateData>> AsPages(string continuationToken, int? pageSizeHint)
        {
