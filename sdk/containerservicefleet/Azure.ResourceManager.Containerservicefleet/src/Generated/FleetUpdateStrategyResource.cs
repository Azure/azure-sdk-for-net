...
namespace Azure.ResourceManager.Containerservicefleet
{
    ...
    /// Otherwise you can get one from its parent resource <see cref="FleetResource"/> using the GetFleetUpdateStrategies method.
    /// </summary>
    public partial class FleetUpdateStrategyResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<FleetUpdateStrategyResource>> UpdateAsync(WaitUntil waitUntil, FleetUpdateStrategyData data, MatchConditions matchConditions = default, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _fleetUpdateStrategiesRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, FleetUpdateStrategyData.ToRequestContent(data), ifMatch, ifNoneMatch, context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
