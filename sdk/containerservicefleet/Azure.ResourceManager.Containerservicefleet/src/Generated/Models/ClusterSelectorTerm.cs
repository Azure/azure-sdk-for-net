...
namespace Azure.ResourceManager.Containerservicefleet.Models
{
    ...
    public partial class ClusterSelectorTerm
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="ClusterSelectorTerm"/>. </summary>
        ...
        internal ClusterSelectorTerm(LabelSelector labelSelector, PropertySelector propertySelector, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
        ...
        public IList<PropertySelectorRequirement> PropertySelectorMatchExpressions
        {
            get
            {
