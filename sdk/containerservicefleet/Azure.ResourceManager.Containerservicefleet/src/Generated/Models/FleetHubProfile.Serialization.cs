        ...
        internal static FleetHubProfile DeserializeFleetHubProfile(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("apiServerAccessProfile"u8))
                {
                    ...
                    apiServerAccessProfile = APIServerAccessProfile.DeserializeAPIServerAccessProfile(prop.Value, options);
                    continue;
                }
                if (prop.NameEquals("agentProfile"u8))
                {
                    ...
                    agentProfile = AgentProfile.DeserializeAgentProfile(prop.Value, options);
                    continue;
                }
