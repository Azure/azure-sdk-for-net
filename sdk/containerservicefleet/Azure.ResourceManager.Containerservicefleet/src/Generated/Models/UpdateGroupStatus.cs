...
namespace Azure.ResourceManager.Containerservicefleet.Models
{
    ...
    public partial class UpdateGroupStatus
    {
        ...
        internal UpdateGroupStatus(UpdateStatus status, string name, IReadOnlyList<MemberUpdateStatus> members, IReadOnlyList<UpdateRunGateStatus> beforeGates, IReadOnlyList<UpdateRunGateStatus> afterGates, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Status = status;
            Name = name;
            Members = members;
