...
namespace Azure.ResourceManager.Containerservicefleet.Models
{
    ...
    public partial class UpdateRunStatus
    {
        ...
        /// <summary> Initializes a new instance of <see cref="UpdateRunStatus"/>. </summary>
        ...
        internal UpdateRunStatus(UpdateStatus status, IReadOnlyList<UpdateStageStatus> stages, NodeImageSelectionStatus nodeImageSelection, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Status = status;
            Stages = stages;
