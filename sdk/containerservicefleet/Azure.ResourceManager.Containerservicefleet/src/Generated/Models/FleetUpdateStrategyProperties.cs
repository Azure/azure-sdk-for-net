...
namespace Azure.ResourceManager.Containerservicefleet.Models
{
    ...
    internal partial class FleetUpdateStrategyProperties
    {
        ...
        public FleetUpdateStrategyProperties(UpdateRunStrategy strategy)
        {
        ...
        internal FleetUpdateStrategyProperties(FleetUpdateStrategyProvisioningState? provisioningState, UpdateRunStrategy strategy, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
        ...
        public IList<UpdateStage> StrategyStages
        {
            get
            {
                if (Strategy is null)
                {
                    Strategy = new UpdateRunStrategy();
                }
                return Strategy.Stages;
            }
            set
            {
                Strategy = new UpdateRunStrategy(value);
            }
        }
    }
}
