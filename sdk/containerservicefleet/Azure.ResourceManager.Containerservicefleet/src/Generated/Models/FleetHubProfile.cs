...
namespace Azure.ResourceManager.Containerservicefleet.Models
{
    ...
    public partial class FleetHubProfile
    {
        ...
        internal FleetHubProfile(string dnsPrefix, APIServerAccessProfile apiServerAccessProfile, AgentProfile agentProfile, string fqdn, string kubernetesVersion, string portalFqdn, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            DnsPrefix = dnsPrefix;
