...
namespace Azure.ResourceManager.Containerservicefleet.Models
{
    ...
    public partial class UpdateRunGateTargetProperties
    {
        ...
        internal UpdateRunGateTargetProperties(Timing timing)
        {
            Timing = timing;
        }
        ...
        internal UpdateRunGateTargetProperties(string name, string stage, string @group, Timing timing, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Name = name;
            Stage = stage;
            Group = @group;
