...
namespace Azure.ResourceManager.Containerservicefleet.Models
{
    ...
    public partial class NodeImageSelection
    {
        ...
        public NodeImageSelection(NodeImageSelectionType @type)
        {
            Type = @type;
        ...
        internal NodeImageSelection(NodeImageSelectionType @type, IList<NodeImageVersion> customNodeImageVersions, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Type = @type;
        ...
        public NodeImageSelectionType Type { get; set; }
