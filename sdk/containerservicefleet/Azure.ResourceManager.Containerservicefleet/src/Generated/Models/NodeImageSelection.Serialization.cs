    ...
    public partial class NodeImageSelection : IJsonModel<NodeImageSelection>
    {
        ...
        internal static NodeImageSelection DeserializeNodeImageSelection(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    @type = new NodeImageSelectionType(prop.Value.GetString());
                    continue;
                }
            ...
            return new NodeImageSelection(@type, customNodeImageVersions ?? new ChangeTrackingList<NodeImageVersion>(), additionalBinaryDataProperties);
        }
