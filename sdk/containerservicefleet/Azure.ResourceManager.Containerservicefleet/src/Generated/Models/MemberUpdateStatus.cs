...
namespace Azure.ResourceManager.Containerservicefleet.Models
{
    ...
    public partial class MemberUpdateStatus
    {
        ...
        internal MemberUpdateStatus(UpdateStatus status, string name, string clusterResourceId, string operationId, string message, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Status = status;
            Name = name;
