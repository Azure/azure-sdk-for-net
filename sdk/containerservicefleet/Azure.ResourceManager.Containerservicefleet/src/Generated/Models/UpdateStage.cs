...
namespace Azure.ResourceManager.Containerservicefleet.Models
{
    ...
    public partial class UpdateStage
    {
        ...
        /// <summary> Initializes a new instance of <see cref="UpdateStage"/>. </summary>
        ...
        internal UpdateStage(string name, IList<UpdateGroup> groups, int? afterStageWaitInSeconds, IList<GateConfiguration> beforeGates, IList<GateConfiguration> afterGates, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Name = name;
            Groups = groups;
