...
namespace Azure.ResourceManager.Containerservicefleet
{
    ...
    public partial class FleetMemberData : ResourceData
    {
        ...
        /// <summary> Initializes a new instance of <see cref="FleetMemberData"/>. </summary>
        ...
        internal FleetMemberData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, FleetMemberProperties properties, string eTag) : base(id, name, resourceType, systemData)
        {
