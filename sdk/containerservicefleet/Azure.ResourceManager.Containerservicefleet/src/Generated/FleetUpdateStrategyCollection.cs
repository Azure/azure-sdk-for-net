...
namespace Azure.ResourceManager.Containerservicefleet
{
    ...
    /// Each <see cref="FleetUpdateStrategyResource"/> in the collection will belong to the same instance of <see cref="FleetResource"/>.
    /// To get a <see cref="FleetUpdateStrategyCollection"/> instance call the GetFleetUpdateStrategies method from an instance of <see cref="FleetResource"/>.
    /// </summary>
    public partial class FleetUpdateStrategyCollection : ArmCollection, IEnumerable<FleetUpdateStrategyResource>, IAsyncEnumerable<FleetUpdateStrategyResource>
    {
        ...
        public virtual async Task<ArmOperation<FleetUpdateStrategyResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string updateStrategyName, FleetUpdateStrategyData data, MatchConditions matchConditions = default, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _fleetUpdateStrategiesRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, updateStrategyName, FleetUpdateStrategyData.ToRequestContent(data), ifMatch, ifNoneMatch, context);
