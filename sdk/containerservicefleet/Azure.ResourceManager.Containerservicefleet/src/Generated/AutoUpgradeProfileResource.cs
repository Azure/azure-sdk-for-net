...
namespace Azure.ResourceManager.Containerservicefleet
{
    ...
    /// Otherwise you can get one from its parent resource <see cref="FleetResource"/> using the GetAutoUpgradeProfiles method.
    /// </summary>
    public partial class AutoUpgradeProfileResource : ArmResource
    {
        ...
        /// <param name="waitUntil"> <see cref="WaitUntil.Completed"/> if the method should wait to return until the long-running operation has completed on the service; <see cref="WaitUntil.Started"/> if it should return after starting the operation. For more information on long-running operations, please see <see href="https://github.com/Azure/azure-sdk-for-net/blob/main/sdk/core/Azure.Core/samples/LongRunningOperations.md"> Azure.Core Long-Running Operation samples</see>. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<ArmOperation<GenerateResponse>> GenerateUpdateRunAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                ContainerservicefleetArmOperation<GenerateResponse> operation = new ContainerservicefleetArmOperation<GenerateResponse>(
                    new GenerateResponseOperationSource(),
        ...
        /// <param name="waitUntil"> <see cref="WaitUntil.Completed"/> if the method should wait to return until the long-running operation has completed on the service; <see cref="WaitUntil.Started"/> if it should return after starting the operation. For more information on long-running operations, please see <see href="https://github.com/Azure/azure-sdk-for-net/blob/main/sdk/core/Azure.Core/samples/LongRunningOperations.md"> Azure.Core Long-Running Operation samples</see>. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual ArmOperation<GenerateResponse> GenerateUpdateRun(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _autoUpgradeProfileOperationsClientDiagnostics.CreateScope("AutoUpgradeProfileResource.GenerateUpdateRun");
            scope.Start();
            try
        ...
        public virtual async Task<ArmOperation<AutoUpgradeProfileResource>> UpdateAsync(WaitUntil waitUntil, AutoUpgradeProfileData data, MatchConditions matchConditions = default, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _autoUpgradeProfilesRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, AutoUpgradeProfileData.ToRequestContent(data), ifMatch, ifNoneMatch, context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
