...
#pragma warning disable SA1649 // File name should match first type name
    internal class SiteConfigurationArmOperation : ArmOperation
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        /// <summary> Initializes a new instance of SiteConfigurationArmOperation for mocking. </summary>
        protected SiteConfigurationArmOperation()
        {
        }

        internal SiteConfigurationArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal SiteConfigurationArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal(nextLinkOperation, clientDiagnostics, response, "SiteConfigurationArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
        ...
        private string GetOperationId(RehydrationToken? rehydrationToken)
        {
            ...
            var lroDetails = ModelReaderWriter.Write(rehydrationToken, ModelReaderWriterOptions.Json, AzureResourceManagerSiteConfigurationContext.Default).ToObjectFromJson<Dictionary<string, string>>();
