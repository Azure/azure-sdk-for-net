...
namespace Azure.ResourceManager.SiteConfiguration
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ConfigurationData>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ConfigurationData)} does not support writing '{format}' format.");
            }
        ...
        ConfigurationData IJsonModel<ConfigurationData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ConfigurationData)} does not support reading '{format}' format.");
            }
        ...
        internal static ConfigurationData DeserializeConfigurationData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("properties"u8))
                {
                    ...
                    properties = ConfigurationProperties.DeserializeConfigurationProperties(property.Value, options);
                    continue;
                }
        ...
        BinaryData IPersistableModel<ConfigurationData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ConfigurationData)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        ConfigurationData IPersistableModel<ConfigurationData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ConfigurationData)} does not support reading '{options.Format}' format.");
            }
        }
