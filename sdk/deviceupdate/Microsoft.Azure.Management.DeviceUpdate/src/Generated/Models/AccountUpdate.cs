...
namespace Microsoft.Azure.Management.DeviceUpdate.Models
{
    ...
    public partial class AccountUpdate : TagUpdate
    {
        ...
        /// lives</param>
        public AccountUpdate(IDictionary<string, string> tags = default(IDictionary<string, string>), Identity identity = default(Identity), string location = default(string))
            : base(tags)
        {
            Identity = identity;
            Location = location;
