...
namespace Microsoft.Azure.Management.DeviceUpdate
{
    ...
    /// </summary>
    internal partial class PrivateEndpointConnectionsOperations : IServiceOperations<DeviceUpdateClient>, IPrivateEndpointConnectionsOperations
    {
        /// <summary>
        ...
        /// </return>
        public async Task<AzureOperationResponse<IEnumerable<PrivateEndpointConnection>>> ListByAccountWithHttpMessagesAsync(string resourceGroupName, string accountName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        {
            // Send Request
            AzureOperationResponse<PrivateEndpointConnection> _response = await BeginCreateOrUpdateWithHttpMessagesAsync(resourceGroupName, accountName, privateEndpointConnectionName, privateEndpointConnection, customHeaders, cancellationToken).ConfigureAwait(false);
