...
{
    public partial class Sample_PrivateLinkCollection
    {
        ...
        {
            // Generated from example definition: specification/deviceupdate/resource-manager/Microsoft.DeviceUpdate/stable/2022-10-01/examples/PrivateLinkResources/PrivateLinkResources_ListByAccount.json
            ...
            // get the collection of this PrivateLinkResource
            PrivateLinkCollection collection = deviceUpdateAccount.GetPrivateLinks();

            // invoke the operation and iterate over the result
            await foreach (PrivateLinkResource item in collection.GetAllAsync())
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                PrivateLinkData resourceData = item.Data;
        ...
        public async Task Get_PrivateLinkResourcesGet()
        {
            ...
            string groupId = "adu";
            PrivateLinkResource result = await collection.GetAsync(groupId);
