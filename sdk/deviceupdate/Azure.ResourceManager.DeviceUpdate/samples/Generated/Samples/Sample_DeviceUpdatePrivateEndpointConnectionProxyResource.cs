...
namespace Azure.ResourceManager.DeviceUpdate.Samples
{
    public partial class Sample_DeviceUpdatePrivateEndpointConnectionProxyResource
    {
        ...
        public async Task Delete_PrivateEndpointConnectionProxyDelete()
        {
            ...
            // invoke the operation
            await deviceUpdatePrivateEndpointConnectionProxy.DeleteAsync(WaitUntil.Completed).ConfigureAwait(false);
...
GroupConnectivityInformation = {},
            ...
            await deviceUpdatePrivateEndpointConnectionProxy.ValidateAsync(data).ConfigureAwait(false);
        ...
        public async Task UpdatePrivateEndpointProperties_PrivateEndpointConnectionProxyPrivateEndpointUpdate()
        {
            ...
            await deviceUpdatePrivateEndpointConnectionProxy.UpdatePrivateEndpointPropertiesAsync(privateEndpointUpdate).ConfigureAwait(false);
