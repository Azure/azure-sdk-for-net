...
namespace Azure.ResourceManager.DeviceUpdate
{
    ...
    public partial class DeviceUpdatePrivateEndpointConnectionResource : ArmResource
    {
        ...
        internal DeviceUpdatePrivateEndpointConnectionResource(ArmClient client, DeviceUpdatePrivateEndpointConnectionData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
