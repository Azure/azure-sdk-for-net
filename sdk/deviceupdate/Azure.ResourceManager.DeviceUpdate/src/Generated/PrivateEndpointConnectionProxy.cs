...
namespace Azure.ResourceManager.DeviceUpdate
{
    ...
    public partial class PrivateEndpointConnectionProxy : ArmResource
    {
        ...
        public async virtual Task<Response<PrivateEndpointConnectionProxy>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _privateEndpointConnectionProxiesRestClient.GetAsync(Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<PrivateEndpointConnectionProxy> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _privateEndpointConnectionProxiesRestClient.Get(Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                if (response.Value == null)
        ...
        public async virtual Task<PrivateEndpointConnectionProxyDeleteOperation> DeleteAsync(bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _privateEndpointConnectionProxiesRestClient.DeleteAsync(Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
                var operation = new PrivateEndpointConnectionProxyDeleteOperation(_clientDiagnostics, Pipeline, _privateEndpointConnectionProxiesRestClient.CreateDeleteRequest(Id.ResourceGroupName, Id.Parent.Name, Id.Name).Request, response);
        ...
        public virtual PrivateEndpointConnectionProxyDeleteOperation Delete(bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _privateEndpointConnectionProxiesRestClient.Delete(Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                var operation = new PrivateEndpointConnectionProxyDeleteOperation(_clientDiagnostics, Pipeline, _privateEndpointConnectionProxiesRestClient.CreateDeleteRequest(Id.ResourceGroupName, Id.Parent.Name, Id.Name).Request, response);
                if (waitForCompletion)
        ...
        public async virtual Task<Response> ValidateAsync(PrivateEndpointConnectionProxyData privateEndpointConnectionProxy, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _privateEndpointConnectionProxiesRestClient.ValidateAsync(Id.ResourceGroupName, Id.Parent.Name, Id.Name, privateEndpointConnectionProxy, cancellationToken).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
            {
        ...
        public virtual Response Validate(PrivateEndpointConnectionProxyData privateEndpointConnectionProxy, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _privateEndpointConnectionProxiesRestClient.Validate(Id.ResourceGroupName, Id.Parent.Name, Id.Name, privateEndpointConnectionProxy, cancellationToken);
                return response;
            }
            catch (Exception e)
            {
