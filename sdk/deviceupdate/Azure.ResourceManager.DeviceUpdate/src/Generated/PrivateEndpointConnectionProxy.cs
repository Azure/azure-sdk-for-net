...
namespace Azure.ResourceManager.DeviceUpdate
{
    ...
    public partial class PrivateEndpointConnectionProxy : ArmResource
    {
        ...
        internal PrivateEndpointConnectionProxy(ArmResource options, PrivateEndpointConnectionProxyData data) : base(options, data.Id)
        {
            HasData = true;
            _data = data;
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("PrivateEndpointConnectionProxy.GetAvailableLocations");
            scope.Start();
            try
            {
