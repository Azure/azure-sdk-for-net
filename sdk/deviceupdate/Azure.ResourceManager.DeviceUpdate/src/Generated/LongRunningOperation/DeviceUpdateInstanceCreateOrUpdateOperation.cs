...
namespace Azure.ResourceManager.DeviceUpdate.Models
{
    ...
    public partial class DeviceUpdateInstanceCreateOrUpdateOperation : Operation<DeviceUpdateInstance>, IOperationSource<DeviceUpdateInstance>
    {
        ...
        internal DeviceUpdateInstanceCreateOrUpdateOperation(ArmResource operationsBase, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
        ...
        DeviceUpdateInstance IOperationSource<DeviceUpdateInstance>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            return new DeviceUpdateInstance(_operationBase, data);
        }
