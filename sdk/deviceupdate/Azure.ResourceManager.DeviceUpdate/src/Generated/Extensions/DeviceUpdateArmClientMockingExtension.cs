...
namespace Azure.ResourceManager.DeviceUpdate.Mocking
{
    ...
    internal partial class DeviceUpdateArmClientMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="DeviceUpdateArmClientMockingExtension"/> class for mocking. </summary>
        protected DeviceUpdateArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="DeviceUpdateArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal DeviceUpdateArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal DeviceUpdateArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
