...
namespace Azure.ResourceManager.DeviceUpdate.Mocking
{
    ...
    internal partial class DeviceUpdateResourceGroupMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="DeviceUpdateResourceGroupMockingExtension"/> class for mocking. </summary>
        protected DeviceUpdateResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="DeviceUpdateResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal DeviceUpdateResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
