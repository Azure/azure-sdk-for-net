...
namespace Azure.ResourceManager.DeviceUpdate.Mocking
{
    ...
    internal partial class DeviceUpdateSubscriptionMockingExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="DeviceUpdateSubscriptionMockingExtension"/> class for mocking. </summary>
        protected DeviceUpdateSubscriptionMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="DeviceUpdateSubscriptionMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal DeviceUpdateSubscriptionMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        {
            using var scope = DefaultClientDiagnostics.CreateScope("DeviceUpdateSubscriptionMockingExtension.CheckDeviceUpdateNameAvailability");
            scope.Start();
            try
            {
