...
namespace Azure.ResourceManager.DeviceUpdate.Mock
{
    ...
    public partial class DeviceUpdateAccountResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="DeviceUpdateAccountResourceExtension"/> class for mocking. </summary>
        protected DeviceUpdateAccountResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="DeviceUpdateAccountResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal DeviceUpdateAccountResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
