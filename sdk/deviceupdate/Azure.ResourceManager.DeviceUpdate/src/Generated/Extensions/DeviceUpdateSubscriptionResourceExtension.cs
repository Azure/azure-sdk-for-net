...
namespace Azure.ResourceManager.DeviceUpdate.Testing
{
    /// <summary> A class to add extension methods to SubscriptionResource. </summary>
    public partial class DeviceUpdateSubscriptionResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="DeviceUpdateSubscriptionResourceExtension"/> class for mocking. </summary>
        protected DeviceUpdateSubscriptionResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="DeviceUpdateSubscriptionResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal DeviceUpdateSubscriptionResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual async Task<Response<CheckNameAvailabilityResponse>> CheckDeviceUpdateNameAvailabilityAsync(CheckNameAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = DefaultClientDiagnostics.CreateScope("DeviceUpdateSubscriptionResourceExtension.CheckDeviceUpdateNameAvailability");
            scope.Start();
            try
            {
