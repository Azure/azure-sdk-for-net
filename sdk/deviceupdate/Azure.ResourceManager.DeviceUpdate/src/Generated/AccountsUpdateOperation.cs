...
namespace Azure.ResourceManager.DeviceUpdate
{
    ...
    public partial class AccountsUpdateOperation : Operation<Account>, IOperationSource<Account>
    {
        private readonly ArmOperationHelpers<Account> _operation;
        internal AccountsUpdateOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<Account>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.AzureAsyncOperation, "AccountsUpdateOperation");
        }
        /// <inheritdoc />
