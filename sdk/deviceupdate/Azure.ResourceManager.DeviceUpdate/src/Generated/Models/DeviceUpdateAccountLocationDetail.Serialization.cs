...
namespace Azure.ResourceManager.DeviceUpdate.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DeviceUpdateAccountLocationDetail>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DeviceUpdateAccountLocationDetail>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DeviceUpdateAccountLocationDetail>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DeviceUpdateAccountLocationDetail>)} interface");
            }
        ...
        string IPersistableModel<DeviceUpdateAccountLocationDetail>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
