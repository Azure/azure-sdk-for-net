...
namespace Azure.ResourceManager.DeviceUpdate.Models
{
    ...
    public partial class DeviceUpdateAccountPatch
    {
        ...
        internal DeviceUpdateAccountPatch(ManagedServiceIdentity identity, AzureLocation? location, IDictionary<string, string> tags, Dictionary<string, BinaryData> rawData)
        {
            Identity = identity;
            Location = location;
            Tags = tags;
