...
{
    public partial class DeviceUpdatePrivateEndpointConnectionProxyData : IUtf8JsonSerializable, IJsonModel<DeviceUpdatePrivateEndpointConnectionProxyData>, IPersistableModel<DeviceUpdatePrivateEndpointConnectionProxyData>
    {
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        if (property0.NameEquals("provisioningState"u8))
                        {
                            ...
                            provisioningState = new DeviceUpdatePrivateEndpointConnectionProxyProvisioningState(property0.Value.GetString());
                            continue;
                        }
                    }
                    continue;
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(RemotePrivateEndpoint))
            {
                builder.Append("  remotePrivateEndpoint:");
                AppendChildObject(builder, RemotePrivateEndpoint, options, 2);
            }
