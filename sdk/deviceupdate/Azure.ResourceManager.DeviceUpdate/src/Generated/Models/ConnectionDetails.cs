...
namespace Azure.ResourceManager.DeviceUpdate.Models
{
    ...
    public partial class ConnectionDetails
    {
        ...
        internal ConnectionDetails(string id, string privateIPAddress, string linkIdentifier, string groupId, string memberName, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
