...
namespace Azure.ResourceManager.DeviceUpdate.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DiagnosticStorageProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DiagnosticStorageProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DiagnosticStorageProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DiagnosticStorageProperties>)} interface");
            }
        ...
        string IPersistableModel<DiagnosticStorageProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
