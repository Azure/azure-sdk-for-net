...
{
    public partial class GroupConnectivityInformation : IUtf8JsonSerializable, IJsonModel<GroupConnectivityInformation>, IPersistableModel<GroupConnectivityInformation>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(CustomerVisibleFqdns))
            {
                builder.Append("  customerVisibleFqdns:");
                builder.AppendLine(" [");
                foreach (var item in CustomerVisibleFqdns)
                {
                    if (item == null)
            ...
            if (Optional.IsDefined(RedirectMapId))
            {
                builder.Append("  redirectMapId:");
                builder.AppendLine($" '{RedirectMapId}'");
            }

            if (Optional.IsDefined(PrivateLinkServiceArmRegion))
            {
                builder.Append("  privateLinkServiceArmRegion:");
                builder.AppendLine($" '{PrivateLinkServiceArmRegion.Value.ToString()}'");
            }
