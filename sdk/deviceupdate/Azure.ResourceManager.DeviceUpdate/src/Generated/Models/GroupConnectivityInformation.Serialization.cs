...
namespace Azure.ResourceManager.DeviceUpdate.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GroupConnectivityInformation>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<GroupConnectivityInformation>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<GroupConnectivityInformation>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<GroupConnectivityInformation>)} interface");
            }
        ...
        string IPersistableModel<GroupConnectivityInformation>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
