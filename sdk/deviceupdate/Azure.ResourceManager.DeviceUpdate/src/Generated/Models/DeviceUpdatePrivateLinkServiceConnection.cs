...
namespace Azure.ResourceManager.DeviceUpdate.Models
{
    ...
    public partial class DeviceUpdatePrivateLinkServiceConnection
    {
        ...
        internal DeviceUpdatePrivateLinkServiceConnection(string name, IList<string> groupIds, string requestMessage, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            GroupIds = groupIds;
