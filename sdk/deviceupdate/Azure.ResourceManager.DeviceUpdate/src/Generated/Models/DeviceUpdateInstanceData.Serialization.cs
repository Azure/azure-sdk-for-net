...
{
    public partial class DeviceUpdateInstanceData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static DeviceUpdateInstanceData DeserializeDeviceUpdateInstanceData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
