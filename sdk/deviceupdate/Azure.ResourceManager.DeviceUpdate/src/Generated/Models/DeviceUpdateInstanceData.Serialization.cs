...
namespace Azure.ResourceManager.DeviceUpdate
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DeviceUpdateInstanceData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DeviceUpdateInstanceData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DeviceUpdateInstanceData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DeviceUpdateInstanceData>)} interface");
            }
        ...
        string IPersistableModel<DeviceUpdateInstanceData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
