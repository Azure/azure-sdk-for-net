...
{
    public partial class DeviceUpdateInstanceData : IUtf8JsonSerializable, IJsonModel<DeviceUpdateInstanceData>, IPersistableModel<DeviceUpdateInstanceData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(EnableDiagnostics))
            {
                builder.Append("  enableDiagnostics:");
                var boolValue = EnableDiagnostics.Value == true ? "true" : "false";
                builder.AppendLine($" {boolValue}");
            }

            if (Optional.IsDefined(DiagnosticStorageProperties))
            {
                builder.Append("  diagnosticStorageProperties:");
                AppendChildObject(builder, DiagnosticStorageProperties, options, 2);
            }
