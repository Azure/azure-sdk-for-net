...
namespace Azure.ResourceManager.DeviceUpdate.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DeviceUpdateAccountPatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DeviceUpdateAccountPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DeviceUpdateAccountPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DeviceUpdateAccountPatch>)} interface");
            }
        ...
        DeviceUpdateAccountPatch IJsonModel<DeviceUpdateAccountPatch>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        DeviceUpdateAccountPatch IPersistableModel<DeviceUpdateAccountPatch>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == "J" || options.Format == "W";
            if (!isValid)
            {
        ...
        string IPersistableModel<DeviceUpdateAccountPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
