...
namespace Azure.ResourceManager.DeviceUpdate.Models
{
    ...
    public partial class DeviceUpdatePrivateLinkServiceConnectionState
    {
        ...
        /// <summary> Initializes a new instance of <see cref="DeviceUpdatePrivateLinkServiceConnectionState"/>. </summary>
        ...
        internal DeviceUpdatePrivateLinkServiceConnectionState(DeviceUpdatePrivateEndpointServiceConnectionStatus? status, string description, string actionsRequired, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Status = status;
