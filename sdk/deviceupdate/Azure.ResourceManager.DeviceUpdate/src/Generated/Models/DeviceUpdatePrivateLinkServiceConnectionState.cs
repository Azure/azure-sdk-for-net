...
namespace Azure.ResourceManager.DeviceUpdate.Models
{
    ...
    public partial class DeviceUpdatePrivateLinkServiceConnectionState
    {
        ...
        internal DeviceUpdatePrivateLinkServiceConnectionState(DeviceUpdatePrivateEndpointServiceConnectionStatus? status, string description, string actionsRequired, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Status = status;
