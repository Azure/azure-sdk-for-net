...
namespace Azure.ResourceManager.DeviceUpdate.Models
{
    ...
    public partial class DiagnosticStorageProperties
    {
        ...
        internal DiagnosticStorageProperties(AuthenticationType authenticationType, string connectionString, string resourceId, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            AuthenticationType = authenticationType;
