...
namespace Azure.ResourceManager.DeviceUpdate.Models
{
    ...
    public partial class PrivateLinkServiceConnection
    {
        ...
        internal PrivateLinkServiceConnection(string name, IList<string> groupIds, string requestMessage, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            GroupIds = groupIds;
