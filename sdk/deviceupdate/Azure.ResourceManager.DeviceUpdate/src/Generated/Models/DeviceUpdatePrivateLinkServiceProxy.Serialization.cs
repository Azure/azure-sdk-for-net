...
{
    public partial class DeviceUpdatePrivateLinkServiceProxy : IUtf8JsonSerializable, IJsonModel<DeviceUpdatePrivateLinkServiceProxy>, IPersistableModel<DeviceUpdatePrivateLinkServiceProxy>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(RemotePrivateLinkServiceConnectionState))
            {
                builder.Append("  remotePrivateLinkServiceConnectionState:");
                AppendChildObject(builder, RemotePrivateLinkServiceConnectionState, options, 2);
            }

            if (Optional.IsDefined(RemotePrivateEndpointConnection))
            {
                builder.Append("  remotePrivateEndpointConnection:");
                AppendChildObject(builder, RemotePrivateEndpointConnection, options, 2);
            }

            if (Optional.IsCollectionDefined(GroupConnectivityInformation))
            {
                builder.Append("  groupConnectivityInformation:");
                builder.AppendLine(" [");
                foreach (var item in GroupConnectivityInformation)
                {
