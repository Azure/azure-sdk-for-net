...
namespace Azure.ResourceManager.DeviceUpdate.Models
{
    ...
    public partial class PrivateEndpointUpdate
    {
        ...
        internal PrivateEndpointUpdate(string id, AzureLocation? location, string immutableSubscriptionId, string immutableResourceId, string vnetTrafficTag, Dictionary<string, BinaryData> rawData)
        {
            Id = id;
            Location = location;
