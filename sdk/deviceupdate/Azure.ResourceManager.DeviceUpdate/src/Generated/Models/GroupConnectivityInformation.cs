...
namespace Azure.ResourceManager.DeviceUpdate.Models
{
    ...
    public partial class GroupConnectivityInformation
    {
        ...
        internal GroupConnectivityInformation(string groupId, string memberName, IList<string> customerVisibleFqdns, string internalFqdn, string redirectMapId, string privateLinkServiceArmRegion, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            GroupId = groupId;
