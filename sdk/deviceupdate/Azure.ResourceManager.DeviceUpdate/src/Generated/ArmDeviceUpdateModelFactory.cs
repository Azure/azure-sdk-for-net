...
namespace Azure.ResourceManager.DeviceUpdate.Models
{
    ...
    public static partial class ArmDeviceUpdateModelFactory
    {
        ...
        public static DeviceUpdateAccountData DeviceUpdateAccountData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, ManagedServiceIdentity identity = null, ProvisioningState? provisioningState = null, string hostName = null, PublicNetworkAccess? publicNetworkAccess = null, IEnumerable<DeviceUpdatePrivateEndpointConnectionData> privateEndpointConnections = null, DeviceUpdateSku? sku = null, IEnumerable<DeviceUpdateAccountLocationDetail> locations = null)
        {
            ...
            return new DeviceUpdateAccountData(id, name, resourceType, systemData, tags, location, identity, provisioningState, hostName, publicNetworkAccess, privateEndpointConnections?.ToList(), sku, locations?.ToList(), default);
        }
        ...
        public static DeviceUpdatePrivateEndpointConnectionData DeviceUpdatePrivateEndpointConnectionData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, ResourceIdentifier privateEndpointId = null, DeviceUpdatePrivateLinkServiceConnectionState connectionState = null, IEnumerable<string> groupIds = null, DeviceUpdatePrivateEndpointConnectionProvisioningState? provisioningState = null)
        {
            ...
            return new DeviceUpdatePrivateEndpointConnectionData(id, name, resourceType, systemData, privateEndpointId != null ? ResourceManagerModelFactory.SubResource(privateEndpointId) : null, connectionState, groupIds?.ToList(), provisioningState, default);
        }
        ...
        {
            return new DeviceUpdateAccountLocationDetail(name, role, default);
        }
        ...
        public static DeviceUpdateInstanceData DeviceUpdateInstanceData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, ProvisioningState? provisioningState = null, string accountName = null, IEnumerable<IotHubSettings> iotHubs = null, bool? enableDiagnostics = null, DiagnosticStorageProperties diagnosticStorageProperties = null)
        {
            ...
            return new DeviceUpdateInstanceData(id, name, resourceType, systemData, tags, location, provisioningState, accountName, iotHubs?.ToList(), enableDiagnostics, diagnosticStorageProperties, default);
        }
        ...
        public static PrivateLinkData PrivateLinkData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string groupId = null, IEnumerable<string> requiredMembers = null, IEnumerable<string> requiredZoneNames = null, GroupIdProvisioningState? provisioningState = null)
        {
            ...
            return new PrivateLinkData(id, name, resourceType, systemData, groupId, requiredMembers?.ToList(), requiredZoneNames?.ToList(), provisioningState, default);
        }
        ...
        {
            return new PrivateEndpointConnectionProxyData(id, name, resourceType, systemData, provisioningState, eTag, remotePrivateEndpoint, status, default);
        }
        ...
        public static GroupConnectivityInformation GroupConnectivityInformation(string groupId = null, string memberName = null, IEnumerable<string> customerVisibleFqdns = null, string internalFqdn = null, string redirectMapId = null, string privateLinkServiceArmRegion = null)
        {
            ...
            return new GroupConnectivityInformation(groupId, memberName, customerVisibleFqdns?.ToList(), internalFqdn, redirectMapId, privateLinkServiceArmRegion, default);
        }
        ...
        {
            return new ConnectionDetails(id, privateIPAddress, linkIdentifier, groupId, memberName, default);
        }
    }
}
