...
namespace Azure.ResourceManager.DeviceUpdate.Models
{
    ...
    public static partial class ArmDeviceUpdateModelFactory
    {
        ...
        public static PrivateLinkData PrivateLinkData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string groupId = null, IEnumerable<string> requiredMembers = null, IEnumerable<string> requiredZoneNames = null, GroupIdProvisioningState? provisioningState = null)
        {
            ...
            return new PrivateLinkData(id, name, resourceType, systemData, groupId, requiredMembers?.ToList(), requiredZoneNames?.ToList(), provisioningState, serializedAdditionalRawData: null);
        }
        ...
        {
            return new PrivateEndpointConnectionProxyData(id, name, resourceType, systemData, provisioningState, eTag, remotePrivateEndpoint, status, serializedAdditionalRawData: null);
        }
        ...
        {
            return new ConnectionDetails(id, privateIPAddress, linkIdentifier, groupId, memberName, serializedAdditionalRawData: null);
        }
    }
}
