...
namespace Azure.ResourceManager.DeviceUpdate
{
    ...
    public partial class DeviceUpdatePrivateLinkData : ResourceData
    {
        ...
        internal DeviceUpdatePrivateLinkData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string groupId, IReadOnlyList<string> requiredMembers, IList<string> requiredZoneNames, DeviceUpdatePrivateLinkProvisioningState? provisioningState, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
            GroupId = groupId;
