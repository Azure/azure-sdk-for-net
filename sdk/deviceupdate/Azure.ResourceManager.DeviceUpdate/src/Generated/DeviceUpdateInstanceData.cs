...
namespace Azure.ResourceManager.DeviceUpdate
{
    ...
    public partial class DeviceUpdateInstanceData : TrackedResourceData
    {
        ...
        internal DeviceUpdateInstanceData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, ProvisioningState? provisioningState, string accountName, IList<IotHubSettings> iotHubs, bool? enableDiagnostics, DiagnosticStorageProperties diagnosticStorageProperties, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData, tags, location)
        {
