...
namespace Azure.Iot.DeviceUpdate.Tests
{
    ...
    public class DevicesClientTests : RecordedTestBase<ServiceClientTestEnvironment>
    {
        public DevicesClientTests(bool isAsync) : base(isAsync)
        {
        ...
        {
            return InstrumentClient(new DevicesClient(
                TestEnvironment.AccountEndpoint,
                TestEnvironment.InstanceId,
                TestEnvironment.Credential,
                InstrumentClientOptions(new DevicesClientOptions())
            ));
        }
