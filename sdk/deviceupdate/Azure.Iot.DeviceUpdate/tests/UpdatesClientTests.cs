...
namespace Azure.Iot.DeviceUpdate.Tests
{
    ...
    public class UpdatesClientTests : RecordedTestBase<ServiceClientTestEnvironment>
    {
        private const string FileName = "setup.exe";

        public UpdatesClientTests(bool isAsync) : base(isAsync)
        {
        ...
        {
            return InstrumentClient(new UpdatesClient(
                TestEnvironment.AccountEndpoint,
                TestEnvironment.InstanceId,
                TestEnvironment.Credential,
                InstrumentClientOptions(new UpdatesClientOptions())
            ));
        }
