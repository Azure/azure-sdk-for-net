...
namespace Azure.Iot.DeviceUpdate
{
    ...
    public partial class DeploymentsClient
    {
        ...
        public DeploymentsClient(string accountEndpoint, string instanceId, TokenCredential credential)
            : this(accountEndpoint, instanceId, credential, new DeploymentsClientOptions())
        { }

        /// <summary>
        /// Initializes a new instance of the <see cref="DeploymentsClient"/>.
        /// </summary>
        public DeploymentsClient(string accountEndpoint, string instanceId, TokenCredential credential, DeploymentsClientOptions options)
            : this(
