...
namespace Azure.Iot.DeviceUpdate
{
    ...
    public partial class UpdatesClient
    {
        ...
        public UpdatesClient(string accountEndpoint, string instanceId, TokenCredential credential)
            : this(accountEndpoint, instanceId, credential, new UpdatesClientOptions())
        {
        }
        ...
        /// Initializes a new instance of the <see cref="UpdatesClient"/>.
        /// </summary>
        public UpdatesClient(string accountEndpoint, string instanceId, TokenCredential credential, UpdatesClientOptions options)
            : this(
