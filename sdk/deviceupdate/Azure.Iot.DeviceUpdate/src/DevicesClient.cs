...
namespace Azure.Iot.DeviceUpdate
{
    ...
    public partial class DevicesClient
    {
        ...
        public DevicesClient(string accountEndpoint, string instanceId, TokenCredential credential)
            : this(accountEndpoint, instanceId, credential, new DevicesClientOptions())
        { }

        /// <summary>
        /// Initializes a new instance of the <see cref="DevicesClient"/>.
        /// </summary>
        public DevicesClient(string accountEndpoint, string instanceId, TokenCredential credential, DevicesClientOptions options)
            : this(
