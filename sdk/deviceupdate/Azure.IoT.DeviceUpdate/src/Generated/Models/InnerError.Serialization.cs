...
namespace Azure.IoT._DeviceUpdate
{
    ...
    public partial class InnerError : IJsonModel<InnerError>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(InnerErrorProperty))
            {
                writer.WritePropertyName("innerError"u8);
                writer.WriteObjectValue(InnerErrorProperty, options);
            }
        ...
        internal static InnerError DeserializeInnerError(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            InnerError innerErrorProperty = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("innerError"u8))
                {
                    ...
                    innerErrorProperty = DeserializeInnerError(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
            ...
            return new InnerError(code, message, errorDetail, innerErrorProperty, additionalBinaryDataProperties);
        }
    }
}
