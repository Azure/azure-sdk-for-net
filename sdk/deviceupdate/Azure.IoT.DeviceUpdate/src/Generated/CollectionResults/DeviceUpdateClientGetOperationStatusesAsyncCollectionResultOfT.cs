...
{
    internal partial class DeviceUpdateClientGetOperationStatusesAsyncCollectionResultOfT : AsyncPageable<UpdateOperation>
    {
        ...
        /// <summary> Initializes a new instance of DeviceUpdateClientGetOperationStatusesAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public DeviceUpdateClientGetOperationStatusesAsyncCollectionResultOfT(DeviceUpdateClient client, string filter, int? maxCount, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _filter = filter;
            _maxCount = maxCount;
        ...
        /// <summary> Gets the pages of DeviceUpdateClientGetOperationStatusesAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of DeviceUpdateClientGetOperationStatusesAsyncCollectionResultOfT as an enumerable collection. </returns>
