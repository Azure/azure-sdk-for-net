...
namespace Azure.IoT._DeviceUpdate
{
    internal partial class DeviceManagementGetInstallableUpdatesForDeviceClassCollectionResultOfT : Pageable<UpdateInfo>
    {
        ...
        /// <summary> Initializes a new instance of DeviceManagementGetInstallableUpdatesForDeviceClassCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public DeviceManagementGetInstallableUpdatesForDeviceClassCollectionResultOfT(DeviceManagement client, string deviceClassId, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of DeviceManagementGetInstallableUpdatesForDeviceClassCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of DeviceManagementGetInstallableUpdatesForDeviceClassCollectionResultOfT as an enumerable collection. </returns>
        public override IEnumerable<Page<UpdateInfo>> AsPages(string continuationToken, int? pageSizeHint)
        {
