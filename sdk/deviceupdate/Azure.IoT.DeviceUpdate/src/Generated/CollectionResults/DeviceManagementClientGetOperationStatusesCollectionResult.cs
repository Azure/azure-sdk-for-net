...
{
    internal partial class DeviceManagementClientGetOperationStatusesCollectionResult : Pageable<BinaryData>
    {
        ...
        /// <summary> Initializes a new instance of DeviceManagementClientGetOperationStatusesCollectionResult, which is used to iterate over the pages of a collection. </summary>
        ...
        public DeviceManagementClientGetOperationStatusesCollectionResult(DeviceManagementClient client, string filter, int? maxCount, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _filter = filter;
            _maxCount = maxCount;
        ...
        /// <summary> Gets the pages of DeviceManagementClientGetOperationStatusesCollectionResult as an enumerable collection. </summary>
