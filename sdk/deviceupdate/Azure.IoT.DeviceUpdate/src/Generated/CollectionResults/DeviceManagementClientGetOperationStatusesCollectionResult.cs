...
namespace Azure.IoT.DeviceUpdate
{
    internal partial class DeviceManagementClientGetOperationStatusesCollectionResult : Pageable<BinaryData>
    {
        ...
        public DeviceManagementClientGetOperationStatusesCollectionResult(DeviceManagementClient client, string filter, int? top, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _filter = filter;
            _top = top;
