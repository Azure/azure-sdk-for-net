...
{
    internal partial class DeviceManagementGetDeviceStatesForDeviceClassSubgroupDeploymentAsyncCollectionResult : AsyncPageable<BinaryData>
    {
        ...
        /// <summary> Initializes a new instance of DeviceManagementGetDeviceStatesForDeviceClassSubgroupDeploymentAsyncCollectionResult, which is used to iterate over the pages of a collection. </summary>
        ...
        public DeviceManagementGetDeviceStatesForDeviceClassSubgroupDeploymentAsyncCollectionResult(DeviceManagement client, string groupId, string deviceClassId, string deploymentId, string filter, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _groupId = groupId;
        ...
        /// <summary> Gets the pages of DeviceManagementGetDeviceStatesForDeviceClassSubgroupDeploymentAsyncCollectionResult as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of DeviceManagementGetDeviceStatesForDeviceClassSubgroupDeploymentAsyncCollectionResult as an enumerable collection. </returns>
