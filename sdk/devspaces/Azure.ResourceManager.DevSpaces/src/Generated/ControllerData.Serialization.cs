    ...
    public partial class ControllerData : IUtf8JsonSerializable, IJsonModel<ControllerData>
    {
        ...
        internal static ControllerData DeserializeControllerData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
				...
				global::System.ClientModel.Primitives.ModelReaderWriter.Read<global::Azure.ResourceManager.Models.SystemData>(new global::System.BinaryData(global::System.Runtime.InteropServices.JsonMarshal.GetRawUtf8Value(property.Value).ToArray()), global::Azure.ResourceManager.DevSpaces.ModelSerializationExtensions.WireOptions, AzureResourceManagerDevSpacesContext.Default)
#else
                ModelReaderWriter.Read<SystemData>(new BinaryData(Encoding.UTF8.GetBytes(property.Value.GetRawText())), ModelSerializationExtensions.WireOptions, AzureResourceManagerDevSpacesContext.Default)
#endif
;
                    continue;
                }
