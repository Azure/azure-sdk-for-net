...
namespace Azure.ResourceManager.DevSpaces.Testing
{
    ...
    public partial class DevSpacesSubscriptionResourceExtension : ArmResource
    {
        private ClientDiagnostics _controllerClientDiagnostics;
        private ControllersRestOperations _controllerRestClient;

        /// <summary> Initializes a new instance of the <see cref="DevSpacesSubscriptionResourceExtension"/> class for mocking. </summary>
        protected DevSpacesSubscriptionResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="DevSpacesSubscriptionResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal DevSpacesSubscriptionResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<ControllerResource> GetControllersAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new ControllerResource(Client, ControllerData.DeserializeControllerData(e)), ControllerClientDiagnostics, Pipeline, "DevSpacesSubscriptionResourceExtension.GetControllers", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<ControllerResource> GetControllers(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => ControllerRestClient.CreateListRequest(Id.SubscriptionId);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => ControllerRestClient.CreateListNextPageRequest(nextLink, Id.SubscriptionId);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new ControllerResource(Client, ControllerData.DeserializeControllerData(e)), ControllerClientDiagnostics, Pipeline, "DevSpacesSubscriptionResourceExtension.GetControllers", "value", "nextLink", cancellationToken);
        }
    }
}
