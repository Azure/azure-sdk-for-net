...
namespace Azure.ResourceManager.DevSpaces.Mocking
{
    ...
    internal partial class DevSpacesResourceGroupMockingExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="DevSpacesResourceGroupMockingExtension"/> class for mocking. </summary>
        protected DevSpacesResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="DevSpacesResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal DevSpacesResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        {
            using var scope = ContainerHostMappingsClientDiagnostics.CreateScope("DevSpacesResourceGroupMockingExtension.GetContainerHostMappingContainerHostMapping");
            scope.Start();
            try
            {
