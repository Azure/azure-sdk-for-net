...
namespace Azure.ResourceManager.DevSpaces.Mocking
{
    ...
    internal partial class DevSpacesSubscriptionMockingExtension : ArmResource
    {
        ...
        public virtual AsyncPageable<ControllerResource> GetControllersAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new ControllerResource(Client, ControllerData.DeserializeControllerData(e)), ControllerClientDiagnostics, Pipeline, "DevSpacesSubscriptionMockingExtension.GetControllers", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<ControllerResource> GetControllers(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => ControllerRestClient.CreateListRequest(Id.SubscriptionId);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => ControllerRestClient.CreateListNextPageRequest(nextLink, Id.SubscriptionId);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new ControllerResource(Client, ControllerData.DeserializeControllerData(e)), ControllerClientDiagnostics, Pipeline, "DevSpacesSubscriptionMockingExtension.GetControllers", "value", "nextLink", cancellationToken);
        }
    }
}
