...
using Azure.ResourceManager.DevSpaces.Testing;
...
namespace Azure.ResourceManager.DevSpaces
{
    ...
    public static partial class DevSpacesExtensions
    {
        ...
        private static DevSpacesSubscriptionResourceExtension GetDevSpacesSubscriptionResourceExtension(ArmResource resource)
        {
            return resource.GetCachedClient(client =>
            {
                return new DevSpacesSubscriptionResourceExtension(client, resource.Id);
            });
        }

        private static DevSpacesSubscriptionResourceExtension GetDevSpacesSubscriptionResourceExtension(ArmClient client, ResourceIdentifier scope)
        {
            return client.GetResourceClient(() =>
            {
                return new DevSpacesSubscriptionResourceExtension(client, scope);
            });
        }
        ...
        {
            return GetDevSpacesSubscriptionResourceExtension(subscriptionResource).GetControllersAsync(cancellationToken);
        }
        ...
        {
            return GetDevSpacesSubscriptionResourceExtension(subscriptionResource).GetControllers(cancellationToken);
        }
    }
}
