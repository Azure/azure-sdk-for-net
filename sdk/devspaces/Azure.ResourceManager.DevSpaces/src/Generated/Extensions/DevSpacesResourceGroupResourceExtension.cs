...
namespace Azure.ResourceManager.DevSpaces.Testing
{
    /// <summary> A class to add extension methods to ResourceGroupResource. </summary>
    public partial class DevSpacesResourceGroupResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="DevSpacesResourceGroupResourceExtension"/> class for mocking. </summary>
        protected DevSpacesResourceGroupResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="DevSpacesResourceGroupResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal DevSpacesResourceGroupResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual async Task<Response<ContainerHostMapping>> GetContainerHostMappingContainerHostMappingAsync(AzureLocation location, ContainerHostMapping containerHostMapping, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = ContainerHostMappingsClientDiagnostics.CreateScope("DevSpacesResourceGroupResourceExtension.GetContainerHostMappingContainerHostMapping");
            scope.Start();
            try
            {
