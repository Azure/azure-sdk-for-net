...
namespace Azure.ResourceManager.DevSpaces.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ControllerPatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ControllerPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ControllerPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ControllerPatch>)} interface");
            }
        ...
        string IPersistableModel<ControllerPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
