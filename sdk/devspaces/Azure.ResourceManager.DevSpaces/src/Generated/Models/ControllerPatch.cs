...
namespace Azure.ResourceManager.DevSpaces.Models
{
    ...
    public partial class ControllerPatch
    {
        ...
        internal ControllerPatch(IDictionary<string, string> tags, string targetContainerHostCredentialsBase64, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Tags = tags;
