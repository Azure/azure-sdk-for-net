...
namespace Azure.ResourceManager.DevSpaces.Models
{
    ...
    public partial class KubernetesConnectionDetails : OrchestratorSpecificConnectionDetails
    {
        ...
        internal KubernetesConnectionDetails(string instanceType, string kubeConfig, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(instanceType, serializedAdditionalRawData)
        {
