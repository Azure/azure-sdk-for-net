...
namespace Azure.ResourceManager.DevSpaces
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ControllerData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ControllerData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ControllerData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ControllerData>)} interface");
            }
        ...
        string IPersistableModel<ControllerData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
