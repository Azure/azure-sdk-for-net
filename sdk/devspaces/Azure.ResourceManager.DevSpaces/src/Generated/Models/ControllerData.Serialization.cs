    ...
    public partial class ControllerData : IUtf8JsonSerializable, IJsonModel<ControllerData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(HostSuffix))
            {
                ...
                if (HostSuffix.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(DataPlaneFqdn))
            {
                ...
                if (DataPlaneFqdn.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(TargetContainerHostApiServerFqdn))
            {
                ...
                if (TargetContainerHostApiServerFqdn.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(TargetContainerHostResourceId))
            {
                ...
                if (TargetContainerHostResourceId.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(TargetContainerHostCredentialsBase64))
            {
                ...
                if (TargetContainerHostCredentialsBase64.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
