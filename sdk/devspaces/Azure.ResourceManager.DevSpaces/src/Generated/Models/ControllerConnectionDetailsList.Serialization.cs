...
namespace Azure.ResourceManager.DevSpaces.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ControllerConnectionDetailsList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ControllerConnectionDetailsList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ControllerConnectionDetailsList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ControllerConnectionDetailsList>)} interface");
            }
        ...
        string IPersistableModel<ControllerConnectionDetailsList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
