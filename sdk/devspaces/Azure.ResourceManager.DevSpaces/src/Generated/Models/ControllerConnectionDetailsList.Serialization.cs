...
{
    public partial class ControllerConnectionDetailsList : IUtf8JsonSerializable, IJsonModel<ControllerConnectionDetailsList>, IPersistableModel<ControllerConnectionDetailsList>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(ConnectionDetailsList))
            {
                builder.Append("  connectionDetailsList:");
                builder.AppendLine(" [");
                foreach (var item in ConnectionDetailsList)
                {
