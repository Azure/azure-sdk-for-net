...
{
    public partial class ControllerConnectionDetails : IUtf8JsonSerializable, IJsonModel<ControllerConnectionDetails>, IPersistableModel<ControllerConnectionDetails>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(OrchestratorSpecificConnectionDetails))
            {
                builder.Append("  orchestratorSpecificConnectionDetails:");
                AppendChildObject(builder, OrchestratorSpecificConnectionDetails, options, 2);
            }
