...
namespace Azure.ResourceManager.DevSpaces.Models
{
    ...
    {
        internal static ControllerConnectionDetails DeserializeControllerConnectionDetails(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
