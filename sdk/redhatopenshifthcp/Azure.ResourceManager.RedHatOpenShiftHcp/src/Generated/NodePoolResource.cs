...
namespace Azure.ResourceManager.RedHatOpenShiftHcp
{
    ...
    /// Otherwise you can get one from its parent resource <see cref="HcpOpenShiftClusterResource"/> using the GetNodePools method.
    /// </summary>
    public partial class NodePoolResource : ArmResource
    {
        ...
        internal NodePoolResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _nodePoolsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.RedHatOpenShiftHcp", ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                RedHatOpenShiftHcpArmOperation operation = new RedHatOpenShiftHcpArmOperation(_nodePoolsClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                {
