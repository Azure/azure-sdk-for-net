...
namespace Azure.ResourceManager.RedHatOpenShiftHcp.Models
{
    ...
    /// </summary>
    public partial class HcpOpenShiftClusterAutoscalingProfile
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="HcpOpenShiftClusterAutoscalingProfile"/>. </summary>
        ...
        internal HcpOpenShiftClusterAutoscalingProfile(int? maxNodesTotal, int? maxPodGracePeriodSeconds, int? maxNodeProvisionTimeSeconds, int? podPriorityThreshold, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
