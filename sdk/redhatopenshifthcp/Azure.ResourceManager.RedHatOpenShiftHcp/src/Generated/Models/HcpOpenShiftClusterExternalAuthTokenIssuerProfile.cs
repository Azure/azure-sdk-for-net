...
namespace Azure.ResourceManager.RedHatOpenShiftHcp.Models
{
    ...
    public partial class HcpOpenShiftClusterExternalAuthTokenIssuerProfile
    {
        ...
        /// <summary> Initializes a new instance of <see cref="HcpOpenShiftClusterExternalAuthTokenIssuerProfile"/>. </summary>
        /// <param name="uri">
        ...
        public HcpOpenShiftClusterExternalAuthTokenIssuerProfile(Uri uri, IEnumerable<string> audiences)
        {
        ...
        internal HcpOpenShiftClusterExternalAuthTokenIssuerProfile(Uri uri, IList<string> audiences, string ca, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Uri = uri;
            Audiences = audiences;
            CA = ca;
