...
namespace Azure.ResourceManager.RedHatOpenShiftHcp.Models
{
    ...
    /// </summary>
    public partial class HcpOpenShiftClusterExternalAuthClientComponentProfile
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="HcpOpenShiftClusterExternalAuthClientComponentProfile"/>. </summary>
        /// <param name="name">
        ...
        internal HcpOpenShiftClusterExternalAuthClientComponentProfile(string name, string authClientNamespace, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Name = name;
            AuthClientNamespace = authClientNamespace;
