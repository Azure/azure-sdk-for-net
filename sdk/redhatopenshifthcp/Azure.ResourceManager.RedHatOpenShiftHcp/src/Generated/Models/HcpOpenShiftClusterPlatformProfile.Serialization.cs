...
namespace Azure.ResourceManager.RedHatOpenShiftHcp.Models
{
    ...
    public partial class HcpOpenShiftClusterPlatformProfile : IJsonModel<HcpOpenShiftClusterPlatformProfile>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            writer.WritePropertyName("vnetIntegrationSubnetId"u8);
            writer.WriteStringValue(VnetIntegrationSubnetId);
            ...
            writer.WritePropertyName("operatorsAuthentication"u8);
            writer.WriteObjectValue(OperatorsAuthentication, options);
            if (options.Format != "W")
            {
        ...
        internal static HcpOpenShiftClusterPlatformProfile DeserializeHcpOpenShiftClusterPlatformProfile(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("vnetIntegrationSubnetId"u8))
                {
                    vnetIntegrationSubnetId = new ResourceIdentifier(prop.Value.GetString());
                    continue;
                }
