...
{
    internal partial class RedHatOpenShiftHcpArmOperation<T> : ArmOperation<T>
    {
        ...
        /// <summary> Initializes a new instance of RedHatOpenShiftHcpArmOperation for mocking. </summary>
        protected RedHatOpenShiftHcpArmOperation()
        {
        }
        ...
        internal RedHatOpenShiftHcpArmOperation(Response<T> response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal RedHatOpenShiftHcpArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal<T>(
                ...
                clientDiagnostics,
                response,
                "RedHatOpenShiftHcpArmOperation",
                null,
