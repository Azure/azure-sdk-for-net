...
{
    internal partial class RedHatOpenShiftHcpArmOperation : ArmOperation
    {
        ...
        internal RedHatOpenShiftHcpArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal RedHatOpenShiftHcpArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
