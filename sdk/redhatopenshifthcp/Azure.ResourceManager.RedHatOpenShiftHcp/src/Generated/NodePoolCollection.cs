...
namespace Azure.ResourceManager.RedHatOpenShiftHcp
{
    ...
    /// Each <see cref="NodePoolResource"/> in the collection will belong to the same instance of <see cref="HcpOpenShiftClusterResource"/>.
    /// To get a <see cref="NodePoolCollection"/> instance call the GetNodePools method from an instance of <see cref="HcpOpenShiftClusterResource"/>.
    /// </summary>
    public partial class NodePoolCollection : ArmCollection, IEnumerable<NodePoolResource>, IAsyncEnumerable<NodePoolResource>
    {
        ...
        internal NodePoolCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _nodePoolsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.RedHatOpenShiftHcp", NodePoolResource.ResourceType.Namespace, Diagnostics);
            _nodePoolsRestClient = new NodePools(_nodePoolsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, nodePoolApiVersion ?? "2026-06-30-preview");
        ...
        public virtual async Task<ArmOperation<NodePoolResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string nodePoolName, NodePoolData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                RedHatOpenShiftHcpArmOperation<NodePoolResource> operation = new RedHatOpenShiftHcpArmOperation<NodePoolResource>(
        ...
        public virtual AsyncPageable<NodePoolResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<NodePoolData, NodePoolResource>(new NodePoolsGetByParentAsyncCollectionResultOfT(
        ...
        public virtual Pageable<NodePoolResource> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            return new PageableWrapper<NodePoolData, NodePoolResource>(new NodePoolsGetByParentCollectionResultOfT(
                _nodePoolsRestClient,
                Guid.Parse(Id.SubscriptionId),
                Id.ResourceGroupName,
                Id.Name,
