    ...
    public partial class ClusterResizeContent : IUtf8JsonSerializable, IJsonModel<ClusterResizeContent>
    {
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Properties))
            {
                ...
                ((IJsonModel<ClusterResizeProperties>)Properties).Write(writer, options);
            }
        }
        ...
        internal static ClusterResizeContent DeserializeClusterResizeContent(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            ClusterResizeProperties properties = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("properties"u8))
                {
                    ...
                    properties = ModelSerializationExtensions.JsonDeserialize<ClusterResizeProperties>(property.Value);
                    continue;
                }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue("ClusterResizeTargetWorkerNodeCount", out propertyOverride);
            if (hasPropertyOverride)
            {
