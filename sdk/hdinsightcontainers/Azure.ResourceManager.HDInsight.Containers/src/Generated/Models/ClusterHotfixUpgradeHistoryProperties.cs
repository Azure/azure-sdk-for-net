...
{
    /// <summary> Cluster hotfix upgrade history properties. </summary>
    public partial class ClusterHotfixUpgradeHistoryProperties : ClusterInPlaceUpgradeHistoryProperties
    {
        /// <summary> Initializes a new instance of <see cref="ClusterHotfixUpgradeHistoryProperties"/>. </summary>
        ...
        public ClusterHotfixUpgradeHistoryProperties(string utcTime, ClusterUpgradeHistoryUpgradeResultType upgradeResult) : base(utcTime, upgradeResult)
        {
            Argument.AssertNotNull(utcTime, nameof(utcTime));

            UpgradeType = ClusterUpgradeHistoryType.HotfixUpgrade;
        }
