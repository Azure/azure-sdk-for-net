...
namespace Azure.ResourceManager.HDInsight.Containers.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ClusterPoolVersion>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        internal static ClusterPoolVersion DeserializeClusterPoolVersion(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            ClusterPoolVersionProperties properties = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("properties"u8))
                {
                    ...
                    properties = ClusterPoolVersionProperties.DeserializeClusterPoolVersionProperties(property.Value, options);
                    continue;
                }
				...
				global::System.ClientModel.Primitives.ModelReaderWriter.Read<global::Azure.ResourceManager.Models.SystemData>(new global::System.BinaryData(global::System.Runtime.InteropServices.JsonMarshal.GetRawUtf8Value(property.Value).ToArray()), global::Azure.ResourceManager.HDInsight.Containers.ModelSerializationExtensions.WireOptions, AzureResourceManagerHDInsightContainersContext.Default)
#else
                ModelReaderWriter.Read<SystemData>(new BinaryData(Encoding.UTF8.GetBytes(property.Value.GetRawText())), ModelSerializationExtensions.WireOptions, AzureResourceManagerHDInsightContainersContext.Default)
#endif
;
                    continue;
                }
