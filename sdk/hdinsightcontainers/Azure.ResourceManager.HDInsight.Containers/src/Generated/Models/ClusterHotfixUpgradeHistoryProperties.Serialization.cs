...
{
    public partial class ClusterHotfixUpgradeHistoryProperties : IUtf8JsonSerializable, IJsonModel<ClusterHotfixUpgradeHistoryProperties>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ClusterHotfixUpgradeHistoryProperties>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<ClusterHotfixUpgradeHistoryProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<ClusterHotfixUpgradeHistoryProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ClusterHotfixUpgradeHistoryProperties)} does not support writing '{format}' format.");
            }

            base.JsonModelWriteCore(writer, options);
        }

        ClusterHotfixUpgradeHistoryProperties IJsonModel<ClusterHotfixUpgradeHistoryProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ClusterHotfixUpgradeHistoryProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ClusterHotfixUpgradeHistoryProperties)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeClusterHotfixUpgradeHistoryProperties(document.RootElement, options);
        }

        internal static ClusterHotfixUpgradeHistoryProperties DeserializeClusterHotfixUpgradeHistoryProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new ClusterHotfixUpgradeHistoryProperties(
                upgradeType,
                utcTime,
                upgradeResult,
        ...
        BinaryData IPersistableModel<ClusterHotfixUpgradeHistoryProperties>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ClusterHotfixUpgradeHistoryProperties>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ClusterHotfixUpgradeHistoryProperties)} does not support writing '{options.Format}' format.");
            }
        }

        ClusterHotfixUpgradeHistoryProperties IPersistableModel<ClusterHotfixUpgradeHistoryProperties>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ClusterHotfixUpgradeHistoryProperties>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ClusterHotfixUpgradeHistoryProperties)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<ClusterHotfixUpgradeHistoryProperties>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
