...
{
    public partial class ClusterPatchVersionUpgradeRollbackHistoryProperties : IUtf8JsonSerializable, IJsonModel<ClusterPatchVersionUpgradeRollbackHistoryProperties>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ClusterPatchVersionUpgradeRollbackHistoryProperties>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<ClusterPatchVersionUpgradeRollbackHistoryProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<ClusterPatchVersionUpgradeRollbackHistoryProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ClusterPatchVersionUpgradeRollbackHistoryProperties)} does not support writing '{format}' format.");
            }

            base.JsonModelWriteCore(writer, options);
        }

        ClusterPatchVersionUpgradeRollbackHistoryProperties IJsonModel<ClusterPatchVersionUpgradeRollbackHistoryProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ClusterPatchVersionUpgradeRollbackHistoryProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ClusterPatchVersionUpgradeRollbackHistoryProperties)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeClusterPatchVersionUpgradeRollbackHistoryProperties(document.RootElement, options);
        }

        internal static ClusterPatchVersionUpgradeRollbackHistoryProperties DeserializeClusterPatchVersionUpgradeRollbackHistoryProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new ClusterPatchVersionUpgradeRollbackHistoryProperties(
                upgradeType,
                utcTime,
                upgradeResult,
        ...
        BinaryData IPersistableModel<ClusterPatchVersionUpgradeRollbackHistoryProperties>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ClusterPatchVersionUpgradeRollbackHistoryProperties>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ClusterPatchVersionUpgradeRollbackHistoryProperties)} does not support writing '{options.Format}' format.");
            }
        }

        ClusterPatchVersionUpgradeRollbackHistoryProperties IPersistableModel<ClusterPatchVersionUpgradeRollbackHistoryProperties>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ClusterPatchVersionUpgradeRollbackHistoryProperties>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ClusterPatchVersionUpgradeRollbackHistoryProperties)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<ClusterPatchVersionUpgradeRollbackHistoryProperties>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
