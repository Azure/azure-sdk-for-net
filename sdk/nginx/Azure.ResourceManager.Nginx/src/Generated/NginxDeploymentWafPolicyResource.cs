...
namespace Azure.ResourceManager.Nginx
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="NginxDeploymentWafPolicyResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="NginxDeploymentResource"/> using the GetNginxDeploymentWafPolicies method.
    /// </summary>
    public partial class NginxDeploymentWafPolicyResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of NginxDeploymentWafPolicyResource for mocking. </summary>
        protected NginxDeploymentWafPolicyResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="NginxDeploymentWafPolicyResource"/> class. </summary>
        ...
        {
            string resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Nginx.NginxPlus/nginxDeployments/{deploymentName}/wafPolicies/{wafPolicyName}";
        ...
        {
            using DiagnosticScope scope = _nginxDeploymentWafPoliciesClientDiagnostics.CreateScope("NginxDeploymentWafPolicyResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _nginxDeploymentWafPoliciesRestClient.CreateGetRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, context);
        ...
        /// <item>
        /// <term> Operation Id. </term>
        /// <description> NginxDeploymentWafPolicies_Delete. </description>
        /// </item>
        /// <item>
        /// <term> Default Api Version. </term>
        /// <description> 2025-03-01-preview. </description>
        ...
        {
            using DiagnosticScope scope = _nginxDeploymentWafPoliciesClientDiagnostics.CreateScope("NginxDeploymentWafPolicyResource.Delete");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _nginxDeploymentWafPoliciesRestClient.CreateDeleteRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                NginxArmOperation operation = new NginxArmOperation(_nginxDeploymentWafPoliciesClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
