...
namespace Azure.ResourceManager.Nginx
{
    ...
    public partial class NginxConfigurationData : ResourceData
    {
        ...
        internal NginxConfigurationData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, NginxConfigurationProperties properties) : base(id, name, resourceType, systemData)
        {
