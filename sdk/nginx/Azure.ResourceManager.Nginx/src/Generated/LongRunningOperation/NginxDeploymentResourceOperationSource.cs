...
{
    /// <summary></summary>
    internal partial class NginxDeploymentResourceOperationSource : IOperationSource<NginxDeploymentResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal NginxDeploymentResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
