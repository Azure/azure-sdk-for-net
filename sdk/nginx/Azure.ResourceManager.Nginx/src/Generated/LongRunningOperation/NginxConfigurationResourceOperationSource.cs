...
{
    /// <summary></summary>
    internal partial class NginxConfigurationResourceOperationSource : IOperationSource<NginxConfigurationResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal NginxConfigurationResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
