...
{
    /// <summary></summary>
    internal partial class NginxDeploymentWafPolicyResourceOperationSource : IOperationSource<NginxDeploymentWafPolicyResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal NginxDeploymentWafPolicyResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
