...
{
    /// <summary></summary>
    internal partial class NginxCertificateResourceOperationSource : IOperationSource<NginxCertificateResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal NginxCertificateResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
