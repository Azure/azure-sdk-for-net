...
{
    public partial class NginxDeploymentData : Core.IUtf8JsonSerializable
    {
        ...
        internal static NginxDeploymentData DeserializeNginxDeploymentData(JsonElement element)
        {
            ...
            Core.Optional<NginxDeploymentProperties> properties = default;
            ...
            return new NginxDeploymentData(id, name, type, systemData.Value, Core.Optional.ToDictionary(tags), location, identity, properties.Value, sku.Value);
        }
    }
}
