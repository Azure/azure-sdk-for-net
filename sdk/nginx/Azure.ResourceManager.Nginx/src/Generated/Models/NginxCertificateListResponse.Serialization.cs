...
namespace Azure.ResourceManager.Nginx.Models
{
    ...
    {
        internal static NginxCertificateListResponse DeserializeNginxCertificateListResponse(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
