...
namespace Azure.ResourceManager.Nginx.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NginxCertificateListResponse>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NginxCertificateListResponse>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NginxCertificateListResponse>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<NginxCertificateListResponse>)} interface");
            }
        ...
        string IPersistableModel<NginxCertificateListResponse>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
