...
namespace Azure.ResourceManager.Nginx.Models
{
    ...
    public partial class AnalysisDiagnostic
    {
        ...
        /// <summary> Initializes a new instance of <see cref="AnalysisDiagnostic"/>. </summary>
        ...
        internal AnalysisDiagnostic(string directive, string description, string file, float line, string message, string rule)
        {
        ...
        internal AnalysisDiagnostic(string id, string directive, string description, string file, float line, string message, string rule, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Directive = directive;
            Description = description;
        ...
        /// <summary> Initializes a new instance of <see cref="AnalysisDiagnostic"/> for deserialization. </summary>
        internal AnalysisDiagnostic()
        {
        }
