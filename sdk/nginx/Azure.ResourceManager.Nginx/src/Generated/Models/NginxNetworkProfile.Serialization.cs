...
{
    public partial class NginxNetworkProfile : IUtf8JsonSerializable, IJsonModel<NginxNetworkProfile>, IPersistableModel<NginxNetworkProfile>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(NetworkInterfaceConfiguration))
            {
                builder.Append("  networkInterfaceConfiguration:");
                AppendChildObject(builder, NetworkInterfaceConfiguration, options, 2);
            }
