...
{
    public partial class NginxConfigurationProperties : IUtf8JsonSerializable, IJsonModel<NginxConfigurationProperties>, IPersistableModel<NginxConfigurationProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Package))
            {
                ...
                AppendChildObject(builder, Package, options, 2);
            }

            if (Optional.IsDefined(RootFile))
            {
                builder.Append("  rootFile:");
                builder.AppendLine($" '{RootFile}'");
            }
