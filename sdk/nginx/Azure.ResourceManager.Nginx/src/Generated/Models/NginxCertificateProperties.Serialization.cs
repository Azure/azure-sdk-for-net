...
{
    public partial class NginxCertificateProperties : IUtf8JsonSerializable, IJsonModel<NginxCertificateProperties>, IPersistableModel<NginxCertificateProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(KeyVirtualPath))
            {
                builder.Append("  keyVirtualPath:");
                builder.AppendLine($" '{KeyVirtualPath}'");
            }

            if (Optional.IsDefined(CertificateVirtualPath))
            {
                builder.Append("  certificateVirtualPath:");
                builder.AppendLine($" '{CertificateVirtualPath}'");
            }
