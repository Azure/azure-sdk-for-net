...
namespace Azure.ResourceManager.Nginx.Models
{
    ...
    public partial class NginxDeploymentPatch
    {
        ...
        internal NginxDeploymentPatch(ManagedServiceIdentity identity, IDictionary<string, string> tags, ResourceSku sku, AzureLocation? location, NginxDeploymentUpdateProperties properties, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Identity = identity;
            Tags = tags;
            Sku = sku;
