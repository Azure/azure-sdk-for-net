...
namespace Azure.ResourceManager.Nginx.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NginxConfigurationListResponse>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NginxConfigurationListResponse>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NginxConfigurationListResponse>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<NginxConfigurationListResponse>)} interface");
            }
        ...
        string IPersistableModel<NginxConfigurationListResponse>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
