...
namespace Azure.ResourceManager.Nginx.Models
{
    ...
    {
        internal static NginxConfigurationListResponse DeserializeNginxConfigurationListResponse(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
