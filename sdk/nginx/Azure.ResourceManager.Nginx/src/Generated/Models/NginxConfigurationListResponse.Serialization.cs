...
{
    internal partial class NginxConfigurationListResponse : IUtf8JsonSerializable, IJsonModel<NginxConfigurationListResponse>, IPersistableModel<NginxConfigurationListResponse>
    {
        ...
        void IJsonModel<NginxConfigurationListResponse>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(NginxConfigurationListResponse)} does not support '{format}' format.");
            }
