...
namespace Azure.ResourceManager.Nginx.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NginxDeploymentListResponse>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NginxDeploymentListResponse>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NginxDeploymentListResponse>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<NginxDeploymentListResponse>)} interface");
            }
        ...
        string IPersistableModel<NginxDeploymentListResponse>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
