...
namespace Azure.ResourceManager.Nginx.Models
{
    ...
    {
        internal static NginxDeploymentListResponse DeserializeNginxDeploymentListResponse(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
