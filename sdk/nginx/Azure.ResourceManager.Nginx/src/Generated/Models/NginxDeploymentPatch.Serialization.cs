...
namespace Azure.ResourceManager.Nginx.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NginxDeploymentPatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NginxDeploymentPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NginxDeploymentPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<NginxDeploymentPatch>)} interface");
            }
        ...
        string IPersistableModel<NginxDeploymentPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
