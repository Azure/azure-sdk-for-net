...
namespace Azure.ResourceManager.Nginx
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NginxCertificateData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NginxCertificateData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NginxCertificateData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<NginxCertificateData>)} interface");
            }
        ...
        string IPersistableModel<NginxCertificateData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
