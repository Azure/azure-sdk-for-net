...
namespace Azure.ResourceManager.Nginx.Models
{
    ...
    public static partial class ArmNginxModelFactory
    {
        ...
        public static NginxConfigurationProperties NginxConfigurationProperties(ProvisioningState? provisioningState = null, IEnumerable<NginxConfigurationFile> files = null, IEnumerable<NginxConfigurationFile> protectedFiles = null, string packageData = null, string rootFile = null)
        {
            ...
            return new NginxConfigurationProperties(provisioningState, files?.ToList(), protectedFiles?.ToList(), packageData != null ? new NginxConfigurationPackage(packageData, new Dictionary<string, BinaryData>()) : null, rootFile, serializedAdditionalRawData: null);
        }
        ...
        public static NginxDeploymentData NginxDeploymentData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, ManagedServiceIdentity identity = null, NginxDeploymentProperties properties = null, string skuName = null)
        {
            ...
            return new NginxDeploymentData(id, name, resourceType, systemData, tags, location, identity, properties, skuName != null ? new ResourceSku(skuName, new Dictionary<string, BinaryData>()) : null, serializedAdditionalRawData: null);
        }
        ...
        {
            return new NginxDeploymentProperties(provisioningState, nginxVersion, managedResourceGroup, networkProfile, ipAddress, enableDiagnosticsSupport, loggingStorageAccount != null ? new NginxLogging(loggingStorageAccount, new Dictionary<string, BinaryData>()) : null, serializedAdditionalRawData: null);
        }
    }
}
