...
namespace Azure.ResourceManager.Nginx
{
    ...
    public partial class NginxDeploymentApiKeyData : ResourceData, IJsonModel<NginxDeploymentApiKeyData>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        NginxDeploymentApiKeyData IJsonModel<NginxDeploymentApiKeyData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (NginxDeploymentApiKeyData)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static NginxDeploymentApiKeyData DeserializeNginxDeploymentApiKeyData(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = NginxDeploymentApiKeyProperties.DeserializeNginxDeploymentApiKeyProperties(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
        ...
        internal static NginxDeploymentApiKeyData FromResponse(Response response)
        {
            ...
            return DeserializeNginxDeploymentApiKeyData(document.RootElement, ModelSerializationExtensions.WireOptions);
        }
    }
}
