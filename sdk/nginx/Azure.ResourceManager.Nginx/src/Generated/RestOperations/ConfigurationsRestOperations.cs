...
namespace Azure.ResourceManager.Nginx
{
    internal partial class ConfigurationsRestOperations
    {
        ...
        internal RequestUriBuilder CreateCreateOrUpdateRequestUri(string subscriptionId, string resourceGroupName, string deploymentName, string configurationName, NginxConfigurationData data)
        {
            var uri = new RawRequestUriBuilder();
            uri.Reset(_endpoint);
            uri.AppendPath("/subscriptions/", false);
        ...
        internal HttpMessage CreateCreateOrUpdateRequest(string subscriptionId, string resourceGroupName, string deploymentName, string configurationName, NginxConfigurationData data)
        {
            ...
            content.JsonWriter.WriteObjectValue<NginxConfigurationData>(data, new ModelReaderWriterOptions("W"));
