...
namespace Azure.ResourceManager.Nginx
{
    ...
    public partial class NginxDeploymentResource : ArmResource
    {
        ...
        internal NginxDeploymentResource(ArmClient client, NginxDeploymentData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<NginxDeploymentResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
                {
                    ...
                    return Response.FromValue(new NginxDeploymentResource(Client, originalResponse.Value, originalResponse.Value.Id), originalResponse.GetRawResponse());
                }
                else
                {
