...
namespace Azure.ResourceManager.Nginx
{
    ...
    public partial class NginxDeploymentResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<NginxDeploymentResource>> UpdateAsync(WaitUntil waitUntil, NginxDeploymentData data, CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _nginxDeploymentsClientDiagnostics.CreateScope("NginxDeploymentResource.Update");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _nginxDeploymentsRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, NginxDeploymentData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                NginxArmOperation<NginxDeploymentResource> operation = new NginxArmOperation<NginxDeploymentResource>(
                    new NginxDeploymentResourceOperationSource(Client),
                    _nginxDeploymentsClientDiagnostics,
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<NginxDeploymentResource> Update(WaitUntil waitUntil, NginxDeploymentData data, CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _nginxDeploymentsClientDiagnostics.CreateScope("NginxDeploymentResource.Update");
            scope.Start();
            try
