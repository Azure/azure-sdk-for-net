...
namespace Azure.ResourceManager.Nginx.Testing
{
    ...
    public partial class NginxSubscriptionResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="NginxSubscriptionResourceExtension"/> class for mocking. </summary>
        protected NginxSubscriptionResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="NginxSubscriptionResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal NginxSubscriptionResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<NginxDeploymentResource> GetNginxDeploymentsAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new NginxDeploymentResource(Client, NginxDeploymentData.DeserializeNginxDeploymentData(e)), NginxDeploymentDeploymentsClientDiagnostics, Pipeline, "NginxSubscriptionResourceExtension.GetNginxDeployments", "value", "nextLink", cancellationToken);
        }
