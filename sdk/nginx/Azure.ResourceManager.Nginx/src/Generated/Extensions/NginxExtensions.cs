...
using Azure.ResourceManager.Nginx.Testing;
...
namespace Azure.ResourceManager.Nginx
{
    ...
    {
        private static NginxResourceGroupResourceExtension GetNginxResourceGroupResourceExtension(ArmResource resource)
        {
            return resource.GetCachedClient(client =>
            {
                return new NginxResourceGroupResourceExtension(client, resource.Id);
            });
        }

        private static NginxResourceGroupResourceExtension GetNginxResourceGroupResourceExtension(ArmClient client, ResourceIdentifier scope)
        {
            return client.GetResourceClient(() =>
            {
                return new NginxResourceGroupResourceExtension(client, scope);
            });
        }

        private static NginxSubscriptionResourceExtension GetNginxSubscriptionResourceExtension(ArmResource resource)
        {
            return resource.GetCachedClient(client =>
            {
                return new NginxSubscriptionResourceExtension(client, resource.Id);
            });
        }

        private static NginxSubscriptionResourceExtension GetNginxSubscriptionResourceExtension(ArmClient client, ResourceIdentifier scope)
        {
            return client.GetResourceClient(() =>
            {
                return new NginxSubscriptionResourceExtension(client, scope);
            });
        }
        ...
        {
            return GetNginxResourceGroupResourceExtension(resourceGroupResource).GetNginxDeployments();
        }
        ...
        {
            return GetNginxSubscriptionResourceExtension(subscriptionResource).GetNginxDeploymentsAsync(cancellationToken);
        }
        ...
        {
            return GetNginxSubscriptionResourceExtension(subscriptionResource).GetNginxDeployments(cancellationToken);
        }
    }
}
