...
namespace Azure.ResourceManager.Nginx.Mock
{
    ...
    public partial class NginxDeploymentResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="NginxDeploymentResourceExtension"/> class for mocking. </summary>
        protected NginxDeploymentResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="NginxDeploymentResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal NginxDeploymentResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<NginxDeploymentResource> GetNginxDeploymentsAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new NginxDeploymentResource(Client, NginxDeploymentData.DeserializeNginxDeploymentData(e)), NginxDeploymentDeploymentsClientDiagnostics, Pipeline, "NginxDeploymentResourceExtension.GetNginxDeployments", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<NginxDeploymentResource> GetNginxDeployments(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => NginxDeploymentDeploymentsRestClient.CreateListRequest(Id.SubscriptionId);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => NginxDeploymentDeploymentsRestClient.CreateListNextPageRequest(nextLink, Id.SubscriptionId);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new NginxDeploymentResource(Client, NginxDeploymentData.DeserializeNginxDeploymentData(e)), NginxDeploymentDeploymentsClientDiagnostics, Pipeline, "NginxDeploymentResourceExtension.GetNginxDeployments", "value", "nextLink", cancellationToken);
        }
    }
}
