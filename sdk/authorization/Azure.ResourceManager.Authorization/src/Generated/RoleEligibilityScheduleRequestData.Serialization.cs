...
namespace Azure.ResourceManager.Authorization
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RoleEligibilityScheduleRequestData>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(TicketInfo))
            {
                ...
                ((IJsonModel<RoleEligibilityScheduleRequestPropertiesTicketInfo>)TicketInfo).Write(writer, options);
            }
        ...
        internal static RoleEligibilityScheduleRequestData DeserializeRoleEligibilityScheduleRequestData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            ResourceIdentifier targetRoleEligibilityScheduleId = default;
            ResourceIdentifier targetRoleEligibilityScheduleInstanceId = default;
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("ticketInfo"u8))
                        {
                            ...
                            ticketInfo = ModelSerializationExtensions.JsonDeserialize<RoleEligibilityScheduleRequestPropertiesTicketInfo>(property0.Value);
                            continue;
                        }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(TargetRoleEligibilityScheduleId), out propertyOverride);
            if (hasPropertyOverride)
            {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(TargetRoleEligibilityScheduleInstanceId), out propertyOverride);
            if (hasPropertyOverride)
            {
