...
namespace Azure.ResourceManager.Authorization
{
    ...
    public partial class AuthorizationProviderOperationsMetadataResource : ArmResource
    {
        ...
        internal AuthorizationProviderOperationsMetadataResource(ArmClient client, AuthorizationProviderOperationsMetadataData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
