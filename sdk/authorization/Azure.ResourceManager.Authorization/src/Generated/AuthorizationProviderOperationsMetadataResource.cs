...
{
    /// <summary>
    /// A class representing a AuthorizationProviderOperationsMetadata along with the instance operations that can be performed on it.
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="AuthorizationProviderOperationsMetadataResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="TenantResource"/> using the GetAllAuthorizationProviderOperationsMetadata method.
    /// </summary>
    public partial class AuthorizationProviderOperationsMetadataResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of AuthorizationProviderOperationsMetadataResource for mocking. </summary>
        protected AuthorizationProviderOperationsMetadataResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="AuthorizationProviderOperationsMetadataResource"/> class. </summary>
        ...
        {
            TryGetApiVersion(ResourceType, out string authorizationProviderOperationsMetadataApiVersion);
            _providerOperationsMetadataClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Authorization", ResourceType.Namespace, Diagnostics);
        ...
        {
            string resourceId = $"/providers/Microsoft.Authorization/providerOperations/{resourceProviderNamespace}";
        ...
        public virtual async Task<Response<AuthorizationProviderOperationsMetadataResource>> GetAsync(string expand = default, CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _providerOperationsMetadataClientDiagnostics.CreateScope("AuthorizationProviderOperationsMetadataResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _providerOperationsMetadataRestClient.CreateGetRequest(Id.Name, expand, context);
        ...
        /// <param name="expand"> Specifies whether to expand the values. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<AuthorizationProviderOperationsMetadataResource> Get(string expand = default, CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _providerOperationsMetadataClientDiagnostics.CreateScope("AuthorizationProviderOperationsMetadataResource.Get");
            scope.Start();
            try
