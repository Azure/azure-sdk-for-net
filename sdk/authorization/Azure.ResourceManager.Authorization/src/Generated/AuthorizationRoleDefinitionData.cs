...
namespace Azure.ResourceManager.Authorization
{
    ...
    public partial class AuthorizationRoleDefinitionData : ResourceData
    {
        ...
        internal AuthorizationRoleDefinitionData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string roleName, string description, AuthorizationRoleType? roleType, IList<RoleDefinitionPermission> permissions, IList<string> assignableScopes, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData)
        {
            RoleName = roleName;
