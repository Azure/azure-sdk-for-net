...
namespace Azure.ResourceManager.Authorization
{
    ...
    public partial class RoleDefinitionData : ResourceData
    {
        ...
        internal RoleDefinitionData(ResourceIdentifier id, string name, Core.ResourceType resourceType, SystemData systemData, string roleName, string description, string roleType, IList<Permission> permissions, IList<string> assignableScopes) : base(id, name, resourceType, systemData)
        {
            RoleName = roleName;
