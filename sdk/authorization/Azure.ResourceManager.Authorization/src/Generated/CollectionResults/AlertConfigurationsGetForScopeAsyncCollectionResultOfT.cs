...
namespace Azure.ResourceManager.Authorization
{
    internal partial class AlertConfigurationsGetForScopeAsyncCollectionResultOfT : AsyncPageable<AlertConfigurationData>
    {
        ...
        /// <summary> Initializes a new instance of AlertConfigurationsGetForScopeAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public AlertConfigurationsGetForScopeAsyncCollectionResultOfT(AlertConfigurations client, string scope, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _scope = scope;
            _context = context;
        ...
        /// <summary> Gets the pages of AlertConfigurationsGetForScopeAsyncCollectionResultOfT as an enumerable collection. </summary>
