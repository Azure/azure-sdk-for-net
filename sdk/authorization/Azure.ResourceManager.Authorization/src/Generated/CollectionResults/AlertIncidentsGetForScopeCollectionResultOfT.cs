...
namespace Azure.ResourceManager.Authorization
{
    internal partial class AlertIncidentsGetForScopeCollectionResultOfT : Pageable<AlertIncidentData>
    {
        ...
        /// <summary> Initializes a new instance of AlertIncidentsGetForScopeCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        /// <param name="client"> The AlertIncidents client used to send requests. </param>
        ...
        public AlertIncidentsGetForScopeCollectionResultOfT(AlertIncidents client, string scope, string alertId, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _scope = scope;
            _alertId = alertId;
        ...
        /// <summary> Gets the pages of AlertIncidentsGetForScopeCollectionResultOfT as an enumerable collection. </summary>
        ...
        {
            HttpMessage message = nextLink != null ? _client.CreateNextGetForScopeRequest(nextLink, _scope, _alertId, _context) : _client.CreateGetForScopeRequest(_scope, _alertId, _context);
