...
namespace Azure.ResourceManager.Authorization.Models
{
    ...
    internal partial class ExpandedPropertiesScope
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="ExpandedPropertiesScope"/>. </summary>
        ...
        internal ExpandedPropertiesScope(ResourceIdentifier scopeId, string scopeDisplayName, RoleManagementScopeType? scopeType, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            ScopeId = scopeId;
