...
namespace Azure.ResourceManager.Authorization
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RoleManagementPolicyData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RoleManagementPolicyData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RoleManagementPolicyData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RoleManagementPolicyData>)} interface");
            }
        ...
        string IPersistableModel<RoleManagementPolicyData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
