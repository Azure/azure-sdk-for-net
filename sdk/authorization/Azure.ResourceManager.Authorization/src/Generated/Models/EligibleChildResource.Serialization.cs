...
namespace Azure.ResourceManager.Authorization.Models
{
    public partial class EligibleChildResource : IUtf8JsonSerializable, IJsonModel<EligibleChildResource>
    {
        ...
        void IJsonModel<EligibleChildResource>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(EligibleChildResource)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<EligibleChildResource>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(EligibleChildResource)} does not support '{options.Format}' format.");
            }
        }
