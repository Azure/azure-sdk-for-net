...
namespace Azure.ResourceManager.Authorization.Models
{
    ...
    internal partial class RoleAssignmentScheduleInstanceProperties
    {
        ...
        internal RoleAssignmentScheduleInstanceProperties(string scope, string roleDefinitionId, string principalId, PrincipalType? principalType, string roleAssignmentScheduleId, string originRoleAssignmentId, Status? status, DateTimeOffset? startOn, DateTimeOffset? endOn, string linkedRoleEligibilityScheduleId, string linkedRoleEligibilityScheduleInstanceId, AssignmentType? assignmentType, MemberType? memberType, string condition, string conditionVersion, DateTimeOffset? createdOn, ExpandedProperties expandedProperties, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Scope = scope;
