...
namespace Azure.ResourceManager.Authorization.Models
{
    ...
    internal partial class AuthorizationProviderOperationsMetadataListResult
    {
        ...
        internal AuthorizationProviderOperationsMetadataListResult(IReadOnlyList<AuthorizationProviderOperationsMetadataData> value, string nextLink, Dictionary<string, BinaryData> rawData)
        {
            Value = value;
            NextLink = nextLink;
            _rawData = rawData;
