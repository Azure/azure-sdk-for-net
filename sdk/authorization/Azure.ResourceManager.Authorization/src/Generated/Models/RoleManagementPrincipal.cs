...
namespace Azure.ResourceManager.Authorization.Models
{
    ...
    public partial class RoleManagementPrincipal
    {
        ...
        internal RoleManagementPrincipal(string id, string displayName, RoleManagementPrincipalType? principalType, string email, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
