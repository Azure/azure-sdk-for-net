...
{
    public partial class RoleManagementPolicyAssignmentData : IUtf8JsonSerializable, IJsonModel<RoleManagementPolicyAssignmentData>, IPersistableModel<RoleManagementPolicyAssignmentData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(PolicyAssignmentProperties))
            {
                ...
                AppendChildObject(builder, PolicyAssignmentProperties, options, 2);
            }
