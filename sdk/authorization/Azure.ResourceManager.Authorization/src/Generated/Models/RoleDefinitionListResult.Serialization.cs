...
{
    /// <summary> The response of a RoleDefinition list operation. </summary>
    internal partial class RoleDefinitionListResult : IJsonModel<RoleDefinitionListResult>
    {
        /// <summary> Initializes a new instance of <see cref="RoleDefinitionListResult"/> for deserialization. </summary>
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            foreach (RoleDefinitionData item in Value)
            {
        ...
        internal static RoleDefinitionListResult DeserializeRoleDefinitionListResult(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            IList<RoleDefinitionData> value = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                if (prop.NameEquals("value"u8))
                {
                    ...
                    {
                        array.Add(RoleDefinitionData.DeserializeRoleDefinitionData(item, options));
                    }
                    value = array;
                    continue;
                }
            ...
            return new RoleDefinitionListResult(value, nextLink, additionalBinaryDataProperties);
        }
    }
}
