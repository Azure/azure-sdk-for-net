...
namespace Azure.ResourceManager.Authorization.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RoleManagementExpandedProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RoleManagementExpandedProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RoleManagementExpandedProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RoleManagementExpandedProperties>)} interface");
            }
        ...
        string IPersistableModel<RoleManagementExpandedProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
