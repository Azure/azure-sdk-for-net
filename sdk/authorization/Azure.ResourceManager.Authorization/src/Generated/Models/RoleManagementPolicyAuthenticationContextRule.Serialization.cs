...
namespace Azure.ResourceManager.Authorization.Models
{
    ...
    public partial class RoleManagementPolicyAuthenticationContextRule : RoleManagementPolicyRule, IJsonModel<RoleManagementPolicyAuthenticationContextRule>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<RoleManagementPolicyAuthenticationContextRule>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<RoleManagementPolicyAuthenticationContextRule>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        RoleManagementPolicyAuthenticationContextRule IPersistableModel<RoleManagementPolicyAuthenticationContextRule>.Create(BinaryData data, ModelReaderWriterOptions options) => (RoleManagementPolicyAuthenticationContextRule)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        RoleManagementPolicyAuthenticationContextRule IJsonModel<RoleManagementPolicyAuthenticationContextRule>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (RoleManagementPolicyAuthenticationContextRule)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static RoleManagementPolicyAuthenticationContextRule DeserializeRoleManagementPolicyAuthenticationContextRule(JsonElement element, ModelReaderWriterOptions options)
        {
