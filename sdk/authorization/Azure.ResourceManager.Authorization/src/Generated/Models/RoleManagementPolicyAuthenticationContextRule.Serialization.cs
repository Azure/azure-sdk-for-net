...
namespace Azure.ResourceManager.Authorization.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RoleManagementPolicyAuthenticationContextRule>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<RoleManagementPolicyAuthenticationContextRule>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RoleManagementPolicyAuthenticationContextRule>)} interface");
            }
        ...
        string IPersistableModel<RoleManagementPolicyAuthenticationContextRule>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
