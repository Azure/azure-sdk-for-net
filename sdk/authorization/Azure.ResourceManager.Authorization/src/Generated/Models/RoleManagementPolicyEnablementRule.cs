...
namespace Azure.ResourceManager.Authorization.Models
{
    ...
    public partial class RoleManagementPolicyEnablementRule : RoleManagementPolicyRule
    {
        ...
        internal RoleManagementPolicyEnablementRule(string id, RoleManagementPolicyRuleType ruleType, RoleManagementPolicyRuleTarget target, IList<RoleAssignmentEnablementRuleType> enablementRules, Dictionary<string, BinaryData> rawData) : base(id, ruleType, target, rawData)
        {
