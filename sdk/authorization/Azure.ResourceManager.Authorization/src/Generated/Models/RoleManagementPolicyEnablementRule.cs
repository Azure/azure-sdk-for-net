...
namespace Azure.ResourceManager.Authorization.Models
{
    ...
    public partial class RoleManagementPolicyEnablementRule : RoleManagementPolicyRule
    {
        ...
        internal RoleManagementPolicyEnablementRule(string id, RoleManagementPolicyRuleType ruleType, RoleManagementPolicyRuleTarget target, IDictionary<string, BinaryData> additionalBinaryDataProperties, IList<RoleAssignmentEnablementRuleType> enablementRules) : base(id, ruleType, target, additionalBinaryDataProperties)
        {
