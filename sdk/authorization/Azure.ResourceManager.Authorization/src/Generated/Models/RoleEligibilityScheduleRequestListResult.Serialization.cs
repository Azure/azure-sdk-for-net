...
namespace Azure.ResourceManager.Authorization.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RoleEligibilityScheduleRequestListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RoleEligibilityScheduleRequestListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RoleEligibilityScheduleRequestListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RoleEligibilityScheduleRequestListResult>)} interface");
            }
        ...
        string IPersistableModel<RoleEligibilityScheduleRequestListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
