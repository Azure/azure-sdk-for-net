...
namespace Azure.ResourceManager.Authorization.Models
{
    ...
    public partial class RoleManagementPolicyNotificationRule : RoleManagementPolicyRule
    {
        ...
        internal RoleManagementPolicyNotificationRule(string id, RoleManagementPolicyRuleType ruleType, RoleManagementPolicyRuleTarget target, NotificationDeliveryType? notificationDeliveryType, RoleManagementPolicyNotificationLevel? notificationLevel, RoleManagementPolicyRecipientType? recipientType, IList<string> notificationRecipients, bool? areDefaultRecipientsEnabled, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, ruleType, target, serializedAdditionalRawData)
        {
