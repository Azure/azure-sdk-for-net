...
namespace Azure.ResourceManager.Authorization.Models
{
    ...
    public partial class AzureRolesAssignedOutsidePimAlertConfigurationProperties : AlertConfigurationProperties
    {
        ...
        internal AzureRolesAssignedOutsidePimAlertConfigurationProperties(string alertDefinitionId, string scope, bool? isEnabled, string alertConfigurationType, RoleManagementAlertDefinitionData alertDefinition, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(alertDefinitionId, scope, isEnabled, alertConfigurationType, alertDefinition, additionalBinaryDataProperties)
        {
        }
    }
}
