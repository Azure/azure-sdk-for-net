...
namespace Azure.ResourceManager.Authorization.Models
{
    ...
    internal partial class RoleManagementPolicyAssignmentDataProperties
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="RoleManagementPolicyAssignmentDataProperties"/>. </summary>
        public RoleManagementPolicyAssignmentDataProperties()
        {
        ...
        internal RoleManagementPolicyAssignmentDataProperties(string scope, ResourceIdentifier roleDefinitionId, ResourceIdentifier policyId, IReadOnlyList<RoleManagementPolicyRule> effectiveRules, RoleManagementPolicyAssignmentProperties roleManagementPolicyAssignmentProperties, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Scope = scope;
        ...
        public RoleManagementPolicyAssignmentProperties RoleManagementPolicyAssignmentProperties { get; }
    }
}
