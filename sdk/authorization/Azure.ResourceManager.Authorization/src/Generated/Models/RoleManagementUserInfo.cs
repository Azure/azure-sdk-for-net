...
namespace Azure.ResourceManager.Authorization.Models
{
    ...
    public partial class RoleManagementUserInfo
    {
        ...
        internal RoleManagementUserInfo(RoleManagementUserType? userType, bool? isBackup, string id, string description, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            UserType = userType;
            IsBackup = isBackup;
            Id = id;
