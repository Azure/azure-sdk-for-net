...
namespace Azure.ResourceManager.Authorization.Models
{
    ...
    public partial class RoleManagementPolicyExpirationRule : RoleManagementPolicyRule
    {
        ...
        internal RoleManagementPolicyExpirationRule(string id, RoleManagementPolicyRuleType ruleType, RoleManagementPolicyRuleTarget target, bool? isExpirationRequired, TimeSpan? maximumDuration, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, ruleType, target, serializedAdditionalRawData)
        {
