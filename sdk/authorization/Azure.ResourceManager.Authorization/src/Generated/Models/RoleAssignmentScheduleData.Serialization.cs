...
namespace Azure.ResourceManager.Authorization
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RoleAssignmentScheduleData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RoleAssignmentScheduleData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RoleAssignmentScheduleData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RoleAssignmentScheduleData>)} interface");
            }
        ...
        string IPersistableModel<RoleAssignmentScheduleData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
