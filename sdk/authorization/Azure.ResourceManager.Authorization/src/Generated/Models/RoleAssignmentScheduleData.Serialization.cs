...
namespace Azure.ResourceManager.Authorization
{
    ...
    {
        internal static RoleAssignmentScheduleData DeserializeRoleAssignmentScheduleData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
