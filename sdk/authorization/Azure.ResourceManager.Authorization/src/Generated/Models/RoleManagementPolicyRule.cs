...
namespace Azure.ResourceManager.Authorization.Models
{
    ...
    /// </summary>
    [DeserializationProxy(typeof(UnknownRoleManagementPolicyRule))]
    public abstract partial class RoleManagementPolicyRule
    {
        ...
        internal RoleManagementPolicyRule(string id, RoleManagementPolicyRuleType ruleType, RoleManagementPolicyRuleTarget target, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            RuleType = ruleType;
            Target = target;
