...
namespace Azure.ResourceManager.Authorization.Models
{
    ...
    public partial class AuthorizationProviderOperationInfo
    {
        ...
        internal AuthorizationProviderOperationInfo(string name, string displayName, string description, string origin, BinaryData properties, bool? isDataAction, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Name = name;
