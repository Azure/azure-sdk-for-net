...
namespace Azure.ResourceManager.Authorization.Models
{
    ...
    public partial class AuthorizationProviderOperationInfo
    {
        ...
        internal AuthorizationProviderOperationInfo(string name, string displayName, string description, string origin, BinaryData properties, bool? isDataAction, Dictionary<string, BinaryData> rawData)
        {
            Name = name;
