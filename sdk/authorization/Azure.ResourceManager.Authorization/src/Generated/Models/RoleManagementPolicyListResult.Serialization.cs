...
namespace Azure.ResourceManager.Authorization.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RoleManagementPolicyListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RoleManagementPolicyListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RoleManagementPolicyListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RoleManagementPolicyListResult>)} interface");
            }
        ...
        string IPersistableModel<RoleManagementPolicyListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
