...
namespace Azure.ResourceManager.Authorization.Models
{
    ...
    public partial class RoleManagementPolicyAuthenticationContextRule : RoleManagementPolicyRule
    {
        ...
        public RoleManagementPolicyAuthenticationContextRule() : base(RoleManagementPolicyRuleType.RoleManagementPolicyAuthenticationContextRule)
        {
        }
        ...
        internal RoleManagementPolicyAuthenticationContextRule(string id, RoleManagementPolicyRuleType ruleType, RoleManagementPolicyRuleTarget target, IDictionary<string, BinaryData> additionalBinaryDataProperties, bool? isEnabled, string claimValue) : base(id, ruleType, target, additionalBinaryDataProperties)
        {
            IsEnabled = isEnabled;
