...
namespace Azure.ResourceManager.Authorization.Models
{
    ...
    public partial class RoleManagementPolicyAuthenticationContextRule : RoleManagementPolicyRule
    {
        ...
        internal RoleManagementPolicyAuthenticationContextRule(string id, RoleManagementPolicyRuleType ruleType, RoleManagementPolicyRuleTarget target, bool? isEnabled, string claimValue, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, ruleType, target, serializedAdditionalRawData)
        {
            IsEnabled = isEnabled;
