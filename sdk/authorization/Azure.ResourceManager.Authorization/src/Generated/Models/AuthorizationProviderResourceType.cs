...
namespace Azure.ResourceManager.Authorization.Models
{
    ...
    public partial class AuthorizationProviderResourceType
    {
        ...
        internal AuthorizationProviderResourceType(string name, string displayName, IReadOnlyList<AuthorizationProviderOperationInfo> operations, Dictionary<string, BinaryData> rawData)
        {
            Name = name;
