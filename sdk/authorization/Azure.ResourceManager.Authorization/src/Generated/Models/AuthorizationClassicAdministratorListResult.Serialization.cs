...
namespace Azure.ResourceManager.Authorization.Models
{
    internal partial class AuthorizationClassicAdministratorListResult : IUtf8JsonSerializable, IJsonModel<AuthorizationClassicAdministratorListResult>
    {
        ...
        void IJsonModel<AuthorizationClassicAdministratorListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(AuthorizationClassicAdministratorListResult)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<AuthorizationClassicAdministratorListResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(AuthorizationClassicAdministratorListResult)} does not support '{options.Format}' format.");
            }
        }
