...
namespace Azure.ResourceManager.Authorization.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RoleManagementPolicyRuleTarget>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RoleManagementPolicyRuleTarget>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RoleManagementPolicyRuleTarget>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RoleManagementPolicyRuleTarget>)} interface");
            }
        ...
        string IPersistableModel<RoleManagementPolicyRuleTarget>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
