...
namespace Azure.ResourceManager.Authorization.Models
{
    ...
    public partial class RoleManagementPolicyRuleTarget : IJsonModel<RoleManagementPolicyRuleTarget>
    {
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual RoleManagementPolicyRuleTarget PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<RoleManagementPolicyRuleTarget>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<RoleManagementPolicyRuleTarget>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        RoleManagementPolicyRuleTarget IPersistableModel<RoleManagementPolicyRuleTarget>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Level))
            {
                ...
                writer.WriteObjectValue<Models.RoleManagementAssignmentLevel?>(Level.Value, options);
            }
            if (Optional.IsCollectionDefined(TargetObjects))
            {
                writer.WritePropertyName("targetObjects"u8);
                writer.WriteStartArray();
                foreach (string item in TargetObjects)
                {
                    if (item == null)
                    {
                        writer.WriteNullValue();
            ...
            if (Optional.IsCollectionDefined(InheritableSettings))
            {
                ...
                writer.WriteStartArray();
                foreach (string item in InheritableSettings)
                {
                    if (item == null)
                    {
                        writer.WriteNullValue();
            ...
            if (Optional.IsCollectionDefined(EnforcedSettings))
            {
                ...
                writer.WriteStartArray();
                foreach (string item in EnforcedSettings)
                {
                    if (item == null)
                    {
                        writer.WriteNullValue();
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        RoleManagementPolicyRuleTarget IJsonModel<RoleManagementPolicyRuleTarget>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual RoleManagementPolicyRuleTarget JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<RoleManagementPolicyRuleTarget>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static RoleManagementPolicyRuleTarget DeserializeRoleManagementPolicyRuleTarget(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            Models.RoleManagementAssignmentLevel? level = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("level"u8))
                {
                    ...
                    level = Models.RoleManagementAssignmentLevel.DeserializeRoleManagementAssignmentLevel(prop.Value, options);
                    continue;
                }
                if (prop.NameEquals("targetObjects"u8))
                {
                    if (prop.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
                ...
                if (prop.NameEquals("inheritableSettings"u8))
                {
                    if (prop.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
                ...
                if (prop.NameEquals("enforcedSettings"u8))
                {
                    if (prop.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
