...
namespace Azure.ResourceManager.Authorization.Models
{
    ...
    public partial class PolicyAssignmentPropertiesRoleDefinition
    {
        ...
        internal PolicyAssignmentPropertiesRoleDefinition(string id, string displayName, string @type, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Id = id;
