...
namespace Azure.ResourceManager.Authorization.Models
{
    ...
    internal partial class PolicyAssignmentPropertiesRoleDefinition
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="PolicyAssignmentPropertiesRoleDefinition"/>. </summary>
        ...
        internal PolicyAssignmentPropertiesRoleDefinition(ResourceIdentifier roleDefinitionId, string roleDefinitionDisplayName, AuthorizationRoleType? roleType, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
