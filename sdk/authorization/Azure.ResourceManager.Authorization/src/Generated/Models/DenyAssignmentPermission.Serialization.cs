...
namespace Azure.ResourceManager.Authorization.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DenyAssignmentPermission>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DenyAssignmentPermission>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DenyAssignmentPermission>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DenyAssignmentPermission>)} interface");
            }
        ...
        string IPersistableModel<DenyAssignmentPermission>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
