...
namespace Azure.ResourceManager.Authorization.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EligibleChildResourcesListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<EligibleChildResourcesListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<EligibleChildResourcesListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<EligibleChildResourcesListResult>)} interface");
            }
        ...
        string IPersistableModel<EligibleChildResourcesListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
