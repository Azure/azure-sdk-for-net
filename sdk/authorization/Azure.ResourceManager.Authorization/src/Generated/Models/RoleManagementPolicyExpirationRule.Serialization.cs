...
namespace Azure.ResourceManager.Authorization.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RoleManagementPolicyExpirationRule>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RoleManagementPolicyExpirationRule>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RoleManagementPolicyExpirationRule>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RoleManagementPolicyExpirationRule>)} interface");
            }
        ...
        string IPersistableModel<RoleManagementPolicyExpirationRule>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
