...
namespace Azure.ResourceManager.Authorization.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RoleDefinitionPermissionListResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(RoleDefinitionPermissionListResult)} does not support writing '{format}' format.");
            }
        ...
        RoleDefinitionPermissionListResult IJsonModel<RoleDefinitionPermissionListResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(RoleDefinitionPermissionListResult)} does not support reading '{format}' format.");
            }
        ...
        internal static RoleDefinitionPermissionListResult DeserializeRoleDefinitionPermissionListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new RoleDefinitionPermissionListResult(value ?? new ChangeTrackingList<RoleDefinitionPermission>(), nextLink, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<RoleDefinitionPermissionListResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(RoleDefinitionPermissionListResult)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        RoleDefinitionPermissionListResult IPersistableModel<RoleDefinitionPermissionListResult>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(RoleDefinitionPermissionListResult)} does not support reading '{options.Format}' format.");
            }
        }
