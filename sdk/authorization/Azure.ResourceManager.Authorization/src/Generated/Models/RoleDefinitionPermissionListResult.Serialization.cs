...
namespace Azure.ResourceManager.Authorization.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RoleDefinitionPermissionListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RoleDefinitionPermissionListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RoleDefinitionPermissionListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RoleDefinitionPermissionListResult>)} interface");
            }
        ...
        string IPersistableModel<RoleDefinitionPermissionListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
