...
namespace Azure.ResourceManager.Authorization
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RoleEligibilityScheduleData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RoleEligibilityScheduleData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RoleEligibilityScheduleData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RoleEligibilityScheduleData>)} interface");
            }
        ...
        string IPersistableModel<RoleEligibilityScheduleData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
