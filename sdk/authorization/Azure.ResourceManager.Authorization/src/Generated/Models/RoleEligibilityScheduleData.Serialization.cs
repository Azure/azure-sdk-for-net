...
namespace Azure.ResourceManager.Authorization
{
    ...
    {
        internal static RoleEligibilityScheduleData DeserializeRoleEligibilityScheduleData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
