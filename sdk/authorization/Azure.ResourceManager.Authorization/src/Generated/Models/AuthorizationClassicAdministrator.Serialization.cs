...
namespace Azure.ResourceManager.Authorization.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AuthorizationClassicAdministrator>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AuthorizationClassicAdministrator>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AuthorizationClassicAdministrator>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AuthorizationClassicAdministrator>)} interface");
            }
        ...
        string IPersistableModel<AuthorizationClassicAdministrator>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
