...
namespace Azure.ResourceManager.Authorization.Models
{
    ...
    public partial class RoleManagementPolicyRuleTarget
    {
        ...
        internal RoleManagementPolicyRuleTarget(string caller, IList<string> operations, RoleManagementAssignmentLevel? level, IList<string> targetObjects, IList<string> inheritableSettings, IList<string> enforcedSettings, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Caller = caller;
