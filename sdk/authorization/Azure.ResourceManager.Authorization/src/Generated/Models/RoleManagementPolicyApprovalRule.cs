...
namespace Azure.ResourceManager.Authorization.Models
{
    ...
    public partial class RoleManagementPolicyApprovalRule : RoleManagementPolicyRule
    {
        ...
        internal RoleManagementPolicyApprovalRule(string id, RoleManagementPolicyRuleType ruleType, RoleManagementPolicyRuleTarget target, IDictionary<string, BinaryData> additionalBinaryDataProperties, RoleManagementApprovalSettings settings) : base(id, ruleType, target, additionalBinaryDataProperties)
        {
            Settings = settings;
        }
