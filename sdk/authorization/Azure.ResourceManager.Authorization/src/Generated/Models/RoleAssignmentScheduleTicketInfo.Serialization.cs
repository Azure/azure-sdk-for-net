...
namespace Azure.ResourceManager.Authorization.Models
{
    ...
    public partial class RoleAssignmentScheduleTicketInfo : IJsonModel<RoleAssignmentScheduleTicketInfo>
    {
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual RoleAssignmentScheduleTicketInfo PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<RoleAssignmentScheduleTicketInfo>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<RoleAssignmentScheduleTicketInfo>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        RoleAssignmentScheduleTicketInfo IPersistableModel<RoleAssignmentScheduleTicketInfo>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        RoleAssignmentScheduleTicketInfo IJsonModel<RoleAssignmentScheduleTicketInfo>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual RoleAssignmentScheduleTicketInfo JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<RoleAssignmentScheduleTicketInfo>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static RoleAssignmentScheduleTicketInfo DeserializeRoleAssignmentScheduleTicketInfo(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new RoleAssignmentScheduleTicketInfo(ticketNumber, ticketSystem, additionalBinaryDataProperties);
        }
    }
}
