...
namespace Azure.ResourceManager.Authorization.Models
{
    ...
    internal partial class UnknownRoleManagementPolicyRule : RoleManagementPolicyRule
    {
        ...
        internal UnknownRoleManagementPolicyRule(string id, RoleManagementPolicyRuleType ruleType, RoleManagementPolicyRuleTarget target, Dictionary<string, BinaryData> rawData) : base(id, ruleType, target, rawData)
        {
            RuleType = ruleType;
        }
