...
namespace Azure.ResourceManager.Authorization.Models
{
    ...
    internal partial class UnknownRoleManagementPolicyRule : RoleManagementPolicyRule
    {
        ...
        internal UnknownRoleManagementPolicyRule(string id, RoleManagementPolicyRuleType ruleType, RoleManagementPolicyRuleTarget target, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, ruleType, target, serializedAdditionalRawData)
        {
            RuleType = ruleType;
        }
