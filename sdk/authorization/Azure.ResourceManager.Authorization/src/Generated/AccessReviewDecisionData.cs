...
namespace Azure.ResourceManager.Authorization
{
    ...
    public partial class AccessReviewDecisionData : ResourceData
    {
        ...
        internal AccessReviewDecisionData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, AccessReviewDecisionPatch properties, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, name, resourceType, systemData)
        {
        ...
        [WirePath("properties.recommendation")]
        ...
        [WirePath("properties.reviewedDateTime")]
        ...
        [WirePath("properties.reviewedBy")]
        public AccessReviewActorIdentity ReviewedBy
        {
            get
            {
                return Properties is null ? default : Properties.ReviewedBy;
            }
        }

        /// <summary> The outcome of applying the decision. </summary>
        [WirePath("properties.applyResult")]
        ...
        [WirePath("properties.appliedDateTime")]
        ...
        /// <summary> Details of the approver. </summary>
        [WirePath("properties.appliedBy")]
        public AccessReviewActorIdentity AppliedBy
        {
            get
            {
                return Properties is null ? default : Properties.AppliedBy;
            }
        }
        ...
        [WirePath("properties.principalResourceMembership.membershipTypes")]
