...
namespace Azure.ResourceManager.Authorization
{
    ...
    public partial class RoleAssignmentResource : ArmResource
    {
        ...
        /// <param name="tenantId"> Tenant ID for cross-tenant request. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, string tenantId = default, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="tenantId"> Tenant ID for cross-tenant request. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual ArmOperation Delete(WaitUntil waitUntil, string tenantId = default, CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _roleAssignmentsClientDiagnostics.CreateScope("RoleAssignmentResource.Delete");
            scope.Start();
            try
        ...
        public virtual async Task<ArmOperation<RoleAssignmentResource>> UpdateAsync(WaitUntil waitUntil, RoleAssignmentCreateOrUpdateContent content, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _roleAssignmentsRestClient.CreateCreateRequest(Id.Parent.ToString(), Id.Name, RoleAssignmentCreateOrUpdateContent.ToRequestContent(content), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<RoleAssignmentData> response = Response.FromValue(RoleAssignmentData.FromResponse(result), result);
                RequestUriBuilder uri = message.Request.Uri;
