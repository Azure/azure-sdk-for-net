...
namespace Azure.ResourceManager.Authorization.Mocking
{
    ...
    public partial class AuthorizationArmClientMockingExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="AuthorizationArmClientMockingExtension"/> class for mocking. </summary>
        protected AuthorizationArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="AuthorizationArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal AuthorizationArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal AuthorizationArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
        ...
        public virtual AsyncPageable<EligibleChildResource> GetEligibleChildResourcesAsync(ResourceIdentifier scope, string filter = null, CancellationToken cancellationToken = default)
        {
            ...
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, EligibleChildResource.DeserializeEligibleChildResource, EligibleChildResourcesClientDiagnostics, Pipeline, "AuthorizationArmClientMockingExtension.GetEligibleChildResources", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<EligibleChildResource> GetEligibleChildResources(ResourceIdentifier scope, string filter = null, CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => EligibleChildResourcesRestClient.CreateGetRequest(scope, filter);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => EligibleChildResourcesRestClient.CreateGetNextPageRequest(nextLink, scope, filter);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, EligibleChildResource.DeserializeEligibleChildResource, EligibleChildResourcesClientDiagnostics, Pipeline, "AuthorizationArmClientMockingExtension.GetEligibleChildResources", "value", "nextLink", cancellationToken);
        }
        /// <summary>
