...
namespace Azure.ResourceManager.Authorization.Mocking
{
    ...
    public partial class MockableAuthorizationArmClient : ArmResource
    {
        ...
        /// <summary> Gets an object representing a <see cref="AuthorizationRoleDefinitionResource"/> along with the instance operations that can be performed on it but with no data. </summary>
        /// <param name="id"> The resource ID of the resource to get. </param>
        ...
        /// <summary> Gets a collection of <see cref="AuthorizationRoleDefinitionCollection"/> objects within the specified scope. </summary>
        /// <param name="scope"> The scope of the resource collection to get. </param>
        /// <returns> Returns a collection of <see cref="AuthorizationRoleDefinitionResource"/> objects. </returns>
        ...
        [ForwardsClientCalls]
        public virtual Response<AuthorizationRoleDefinitionResource> GetAuthorizationRoleDefinition(ResourceIdentifier scope, string roleDefinitionId, CancellationToken cancellationToken = default)
        {
        ...
        /// <exception cref="ArgumentException"> <paramref name="roleDefinitionId"/> is an empty string, and was expected to be non-empty. </exception>
        [ForwardsClientCalls]
        public virtual async Task<Response<AuthorizationRoleDefinitionResource>> GetAuthorizationRoleDefinitionAsync(ResourceIdentifier scope, string roleDefinitionId, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(roleDefinitionId, nameof(roleDefinitionId));
        ...
        /// <summary> Gets an object representing a <see cref="AuthorizationProviderOperationsMetadataResource"/> along with the instance operations that can be performed on it but with no data. </summary>
        /// <param name="id"> The resource ID of the resource to get. </param>
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> A collection of <see cref="DenyAssignmentResource"/> that may take multiple service requests to iterate over. </returns>
        internal virtual Pageable<DenyAssignmentResource> GetForResource(ResourceIdentifier scope, string resourceGroupName, string resourceProviderNamespace, string parentResourcePath, string resourceType, string resourceName, string subscriptionId, string filter = default, CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
        ...
        internal virtual AsyncPageable<RoleAssignmentResource> GetForResourceAsync(ResourceIdentifier scope, string filter = default, string tenantId = default, CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> A collection of <see cref="RoleAssignmentResource"/> that may take multiple service requests to iterate over. </returns>
        internal virtual Pageable<RoleAssignmentResource> GetForResource(ResourceIdentifier scope, string filter = default, string tenantId = default, CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
        ...
        public virtual AsyncPageable<EligibleChildResource> GetEligibleChildResourcesAsync(ResourceIdentifier scope, string filter = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(scope, nameof(scope));
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="scope"/> is null. </exception>
        /// <returns> A collection of <see cref="EligibleChildResource"/> that may take multiple service requests to iterate over. </returns>
        public virtual Pageable<EligibleChildResource> GetEligibleChildResources(ResourceIdentifier scope, string filter = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(scope, nameof(scope));
        ...
        public virtual async Task<Response<AlertOperationResult>> GetAlertOperationAsync(ResourceIdentifier scope, string operationId, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope0 = AlertOperationClientDiagnostics.CreateScope("MockableAuthorizationArmClient.GetAlertOperation");
            scope0.Start();
            try
            {
                RequestContext context = new RequestContext
