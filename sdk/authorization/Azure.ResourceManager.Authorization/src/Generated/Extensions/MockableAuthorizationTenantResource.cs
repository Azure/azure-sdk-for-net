...
namespace Azure.ResourceManager.Authorization.Mocking
{
    ...
    public partial class MockableAuthorizationTenantResource : ArmResource
    {
        ...
        /// <summary> Gets a collection of AuthorizationProviderOperationsMetadata in the <see cref="TenantResource"/>. </summary>
        /// <returns> An object representing collection of AuthorizationProviderOperationsMetadata and their operations over a AuthorizationProviderOperationsMetadataResource. </returns>
        ...
        [ForwardsClientCalls]
        public virtual async Task<Response<AuthorizationProviderOperationsMetadataResource>> GetAuthorizationProviderOperationsMetadataAsync(string resourceProviderNamespace, string expand = default, CancellationToken cancellationToken = default)
        {
        ...
        /// <exception cref="ArgumentException"> <paramref name="resourceProviderNamespace"/> is an empty string, and was expected to be non-empty. </exception>
        [ForwardsClientCalls]
        public virtual Response<AuthorizationProviderOperationsMetadataResource> GetAuthorizationProviderOperationsMetadata(string resourceProviderNamespace, string expand = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(resourceProviderNamespace, nameof(resourceProviderNamespace));
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        internal virtual async Task<Response<DenyAssignmentResource>> GetByIdAsync(string denyAssignmentId, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="denyAssignmentId"> The fully qualified ID of the role assignment including scope, resource name, and resource type. Format: /{scope}/providers/Microsoft.Authorization/roleAssignments/{roleAssignmentName}. Example: /subscriptions/&lt;SUB_ID&gt;/resourcegroups/&lt;RESOURCE_GROUP&gt;/providers/Microsoft.Authorization/roleAssignments/&lt;ROLE_ASSIGNMENT_NAME&gt;. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        internal virtual Response<DenyAssignmentResource> GetById(string denyAssignmentId, CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = DenyAssignmentsClientDiagnostics.CreateScope("MockableAuthorizationTenantResource.GetById");
            scope.Start();
            try
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        internal virtual async Task<Response<RoleAssignmentResource>> GetByIdAsync(string roleAssignmentId, string tenantId = default, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="tenantId"> Tenant ID for cross-tenant request. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        internal virtual Response<RoleAssignmentResource> GetById(string roleAssignmentId, string tenantId = default, CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = RoleAssignmentsClientDiagnostics.CreateScope("MockableAuthorizationTenantResource.GetById");
            scope.Start();
            try
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        internal virtual async Task<Response<RoleAssignmentResource>> CreateByIdAsync(string roleAssignmentId, RoleAssignmentCreateOrUpdateContent content, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = RoleAssignmentsRestClient.CreateCreateByIdRequest(roleAssignmentId, RoleAssignmentCreateOrUpdateContent.ToRequestContent(content), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<RoleAssignmentData> response = Response.FromValue(RoleAssignmentData.FromResponse(result), result);
                if (response.Value == null)
                {
        ...
        /// <param name="content"> Resource create parameters. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        internal virtual Response<RoleAssignmentResource> CreateById(string roleAssignmentId, RoleAssignmentCreateOrUpdateContent content, CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = RoleAssignmentsClientDiagnostics.CreateScope("MockableAuthorizationTenantResource.CreateById");
            scope.Start();
            try
        ...
        /// <param name="tenantId"> Tenant ID for cross-tenant request. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        internal virtual async Task<Response<RoleAssignmentResource>> DeleteByIdAsync(string roleAssignmentId, string tenantId = default, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="tenantId"> Tenant ID for cross-tenant request. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        internal virtual Response<RoleAssignmentResource> DeleteById(string roleAssignmentId, string tenantId = default, CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = RoleAssignmentsClientDiagnostics.CreateScope("MockableAuthorizationTenantResource.DeleteById");
            scope.Start();
            try
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        internal virtual async Task<Response<AuthorizationRoleDefinitionResource>> GetAuthorizationRoleDefinitionAsync(string roleId, CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = RoleDefinitionsClientDiagnostics.CreateScope("MockableAuthorizationTenantResource.GetAuthorizationRoleDefinition");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = RoleDefinitionsRestClient.CreateGetAuthorizationRoleDefinitionRequest(roleId, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        /// <param name="roleId"> The fully qualified role definition ID. Use the format, /subscriptions/{guid}/providers/Microsoft.Authorization/roleDefinitions/{roleDefinitionId} for subscription level role definitions, or /providers/Microsoft.Authorization/roleDefinitions/{roleDefinitionId} for tenant level role definitions. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        internal virtual Response<AuthorizationRoleDefinitionResource> GetAuthorizationRoleDefinition(string roleId, CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = RoleDefinitionsClientDiagnostics.CreateScope("MockableAuthorizationTenantResource.GetAuthorizationRoleDefinition");
            scope.Start();
            try
        ...
        {
            using DiagnosticScope scope = GlobalAdministratorClientDiagnostics.CreateScope("MockableAuthorizationTenantResource.ElevateAccessGlobalAdministrator");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = GlobalAdministratorRestClient.CreateElevateAccessGlobalAdministratorRequest(context);
