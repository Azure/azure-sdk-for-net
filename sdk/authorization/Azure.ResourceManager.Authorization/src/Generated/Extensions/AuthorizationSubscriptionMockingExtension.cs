...
namespace Azure.ResourceManager.Authorization.Mocking
{
    ...
    internal partial class AuthorizationSubscriptionMockingExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="AuthorizationSubscriptionMockingExtension"/> class for mocking. </summary>
        protected AuthorizationSubscriptionMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="AuthorizationSubscriptionMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal AuthorizationSubscriptionMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual Pageable<AuthorizationClassicAdministrator> GetClassicAdministrators(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => ClassicAdministratorsRestClient.CreateListRequest(Id.SubscriptionId);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => ClassicAdministratorsRestClient.CreateListNextPageRequest(nextLink, Id.SubscriptionId);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, AuthorizationClassicAdministrator.DeserializeAuthorizationClassicAdministrator, ClassicAdministratorsClientDiagnostics, Pipeline, "AuthorizationSubscriptionMockingExtension.GetClassicAdministrators", "value", "nextLink", cancellationToken);
        }
    }
}
