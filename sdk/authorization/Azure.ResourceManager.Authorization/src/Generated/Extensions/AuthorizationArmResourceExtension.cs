...
namespace Azure.ResourceManager.Authorization.Mock
{
    ...
    public partial class AuthorizationArmResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="AuthorizationArmResourceExtension"/> class for mocking. </summary>
        protected AuthorizationArmResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="AuthorizationArmResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal AuthorizationArmResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<EligibleChildResource> GetEligibleChildResourcesAsync(string filter = null, CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, EligibleChildResource.DeserializeEligibleChildResource, EligibleChildResourcesClientDiagnostics, Pipeline, "AuthorizationArmResourceExtension.GetEligibleChildResources", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<EligibleChildResource> GetEligibleChildResources(string filter = null, CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => EligibleChildResourcesRestClient.CreateGetRequest(Id, filter);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => EligibleChildResourcesRestClient.CreateGetNextPageRequest(nextLink, Id, filter);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, EligibleChildResource.DeserializeEligibleChildResource, EligibleChildResourcesClientDiagnostics, Pipeline, "AuthorizationArmResourceExtension.GetEligibleChildResources", "value", "nextLink", cancellationToken);
        }
    }
}
