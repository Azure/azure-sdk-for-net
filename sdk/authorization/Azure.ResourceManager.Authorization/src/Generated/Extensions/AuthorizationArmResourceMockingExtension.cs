...
namespace Azure.ResourceManager.Authorization.Mocking
{
    ...
    internal partial class AuthorizationArmResourceMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="AuthorizationArmResourceMockingExtension"/> class for mocking. </summary>
        protected AuthorizationArmResourceMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="AuthorizationArmResourceMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal AuthorizationArmResourceMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
