...
namespace Azure.ResourceManager.Authorization.Testing
{
    /// <summary> A class to add extension methods to SubscriptionResource. </summary>
    public partial class AuthorizationSubscriptionResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="AuthorizationSubscriptionResourceExtension"/> class for mocking. </summary>
        protected AuthorizationSubscriptionResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="AuthorizationSubscriptionResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal AuthorizationSubscriptionResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<AuthorizationClassicAdministrator> GetClassicAdministratorsAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, AuthorizationClassicAdministrator.DeserializeAuthorizationClassicAdministrator, ClassicAdministratorsClientDiagnostics, Pipeline, "AuthorizationSubscriptionResourceExtension.GetClassicAdministrators", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<AuthorizationClassicAdministrator> GetClassicAdministrators(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => ClassicAdministratorsRestClient.CreateListRequest(Id.SubscriptionId);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => ClassicAdministratorsRestClient.CreateListNextPageRequest(nextLink, Id.SubscriptionId);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, AuthorizationClassicAdministrator.DeserializeAuthorizationClassicAdministrator, ClassicAdministratorsClientDiagnostics, Pipeline, "AuthorizationSubscriptionResourceExtension.GetClassicAdministrators", "value", "nextLink", cancellationToken);
        }
    }
}
