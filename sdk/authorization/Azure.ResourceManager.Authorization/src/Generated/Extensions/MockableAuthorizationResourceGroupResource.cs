...
namespace Azure.ResourceManager.Authorization.Mocking
{
    ...
    public partial class MockableAuthorizationResourceGroupResource : ArmResource
    {
        ...
        internal virtual AsyncPageable<DenyAssignmentResource> GetDenyAssignmentsAsync(string filter = default, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> A collection of <see cref="DenyAssignmentResource"/> that may take multiple service requests to iterate over. </returns>
        internal virtual Pageable<DenyAssignmentResource> GetDenyAssignments(string filter = default, CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
        ...
        internal virtual AsyncPageable<RoleAssignmentResource> GetRoleAssignmentsAsync(string filter = default, string tenantId = default, CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> A collection of <see cref="RoleAssignmentResource"/> that may take multiple service requests to iterate over. </returns>
        internal virtual Pageable<RoleAssignmentResource> GetRoleAssignments(string filter = default, string tenantId = default, CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
