...
namespace Azure.ResourceManager.Authorization.Mocking
{
    ...
    internal partial class AuthorizationTenantMockingExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="AuthorizationTenantMockingExtension"/> class for mocking. </summary>
        protected AuthorizationTenantMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="AuthorizationTenantMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal AuthorizationTenantMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        {
            using var scope = GlobalAdministratorClientDiagnostics.CreateScope("AuthorizationTenantMockingExtension.ElevateAccessGlobalAdministrator");
            scope.Start();
            try
            {
