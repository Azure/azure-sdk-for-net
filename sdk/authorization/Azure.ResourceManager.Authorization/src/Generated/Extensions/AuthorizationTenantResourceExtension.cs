...
namespace Azure.ResourceManager.Authorization.Mock
{
    ...
    public partial class AuthorizationTenantResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="AuthorizationTenantResourceExtension"/> class for mocking. </summary>
        protected AuthorizationTenantResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="AuthorizationTenantResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal AuthorizationTenantResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        {
            using var scope = GlobalAdministratorClientDiagnostics.CreateScope("AuthorizationTenantResourceExtension.ElevateAccessGlobalAdministrator");
            scope.Start();
            try
            {
