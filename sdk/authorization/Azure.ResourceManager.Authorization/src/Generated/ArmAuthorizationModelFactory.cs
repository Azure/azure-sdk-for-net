...
namespace Azure.ResourceManager.Authorization.Models
{
    ...
    public static partial class ArmAuthorizationModelFactory
    {
        ...
        {
            return new AuthorizationClassicAdministrator(id, name, resourceType, systemData, emailAddress, role, default);
        }
        ...
        public static DenyAssignmentData DenyAssignmentData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string denyAssignmentName = null, string description = null, IEnumerable<DenyAssignmentPermission> permissions = null, string scope = null, bool? isAppliedToChildScopes = null, IEnumerable<RoleManagementPrincipal> principals = null, IEnumerable<RoleManagementPrincipal> excludePrincipals = null, bool? isSystemProtected = null)
        {
            ...
            return new DenyAssignmentData(id, name, resourceType, systemData, denyAssignmentName, description, permissions?.ToList(), scope, isAppliedToChildScopes, principals?.ToList(), excludePrincipals?.ToList(), isSystemProtected, default);
        }
        ...
        public static DenyAssignmentPermission DenyAssignmentPermission(IEnumerable<string> actions = null, IEnumerable<string> notActions = null, IEnumerable<string> dataActions = null, IEnumerable<string> notDataActions = null, string condition = null, string conditionVersion = null)
        {
            ...
            return new DenyAssignmentPermission(actions?.ToList(), notActions?.ToList(), dataActions?.ToList(), notDataActions?.ToList(), condition, conditionVersion, default);
        }
        ...
        public static AuthorizationProviderOperationsMetadataData AuthorizationProviderOperationsMetadataData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string displayName = null, IEnumerable<AuthorizationProviderResourceType> resourceTypes = null, IEnumerable<AuthorizationProviderOperationInfo> operations = null)
        {
            ...
            return new AuthorizationProviderOperationsMetadataData(id, name, resourceType, systemData, displayName, resourceTypes?.ToList(), operations?.ToList(), default);
        }
        ...
        public static AuthorizationProviderResourceType AuthorizationProviderResourceType(string name = null, string displayName = null, IEnumerable<AuthorizationProviderOperationInfo> operations = null)
        {
            ...
            return new AuthorizationProviderResourceType(name, displayName, operations?.ToList(), default);
        }
        ...
        {
            return new AuthorizationProviderOperationInfo(name, displayName, description, origin, properties, isDataAction, default);
        }
        ...
        {
            return new RoleAssignmentData(id, name, resourceType, systemData, scope, roleDefinitionId, principalId, principalType, description, condition, conditionVersion, createdOn, updatedOn, createdBy, updatedBy, delegatedManagedIdentityResourceId, default);
        }
        ...
        {
            return new RoleAssignmentCreateOrUpdateContent(scope, roleDefinitionId, principalId, principalType, description, condition, conditionVersion, createdOn, updatedOn, createdBy, updatedBy, delegatedManagedIdentityResourceId, default);
        }
        ...
        public static AuthorizationRoleDefinitionData AuthorizationRoleDefinitionData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string roleName = null, string description = null, AuthorizationRoleType? roleType = null, IEnumerable<RoleDefinitionPermission> permissions = null, IEnumerable<string> assignableScopes = null)
        {
            ...
            return new AuthorizationRoleDefinitionData(id, name, resourceType, systemData, roleName, description, roleType, permissions?.ToList(), assignableScopes?.ToList(), default);
        }
        ...
        {
            return new RoleAssignmentScheduleData(id, name, resourceType, systemData, scope, roleDefinitionId, principalId, principalType, roleAssignmentScheduleRequestId, linkedRoleEligibilityScheduleId, assignmentType, memberType, status, startOn, endOn, condition, conditionVersion, createdOn, updatedOn, expandedProperties, default);
        }
        ...
        {
            return new RoleManagementExpandedProperties(principalId, principalDisplayName, email, principalType, roleDefinitionId, roleDefinitionDisplayName, roleType, scopeId, scopeDisplayName, scopeType, default);
        }
        ...
        {
            return new RoleEligibilityScheduleData(id, name, resourceType, systemData, scope, roleDefinitionId, principalId, principalType, roleEligibilityScheduleRequestId, memberType, status, startOn, endOn, condition, conditionVersion, createdOn, updatedOn, expandedProperties, default);
        }
        ...
        {
            return new RoleEligibilityScheduleInstanceData(id, name, resourceType, systemData, scope, roleDefinitionId, principalId, principalType, roleEligibilityScheduleId, status, startOn, endOn, memberType, condition, conditionVersion, createdOn, expandedProperties, default);
        }
        ...
        {
            return new RoleEligibilityScheduleRequestData(id, name, resourceType, systemData, scope, roleDefinitionId, principalId, principalType, requestType, status, approvalId, targetRoleEligibilityScheduleId, targetRoleEligibilityScheduleInstanceId, justification, ticketInfo, condition, conditionVersion, createdOn, requestorId, expandedProperties, startOn, expirationType, endOn, duration, default);
        }
        ...
        public static RoleManagementPolicyData RoleManagementPolicyData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string scope = null, string displayName = null, string description = null, bool? isOrganizationDefault = null, RoleManagementPrincipal lastModifiedBy = null, DateTimeOffset? lastModifiedOn = null, IEnumerable<RoleManagementPolicyRule> rules = null, IEnumerable<RoleManagementPolicyRule> effectiveRules = null, RoleManagementPolicyProperties policyProperties = null)
        {
            ...
            return new RoleManagementPolicyData(id, name, resourceType, systemData, scope, displayName, description, isOrganizationDefault, lastModifiedBy, lastModifiedOn, rules?.ToList(), effectiveRules?.ToList(), policyProperties, default);
        }
        ...
        {
            return new RoleManagementPolicyProperties(scopeId, scopeDisplayName, scopeType, default);
        }
        ...
        public static RoleManagementPolicyAssignmentData RoleManagementPolicyAssignmentData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string scope = null, ResourceIdentifier roleDefinitionId = null, ResourceIdentifier policyId = null, IEnumerable<RoleManagementPolicyRule> effectiveRules = null, PolicyAssignmentProperties policyAssignmentProperties = null)
        {
            ...
            return new RoleManagementPolicyAssignmentData(id, name, resourceType, systemData, scope, roleDefinitionId, policyId, effectiveRules?.ToList(), policyAssignmentProperties, default);
        }
        ...
        {
            return new PolicyAssignmentProperties(id, name, resourceType, systemData, policyId, lastModifiedBy, lastModifiedOn, roleDefinitionId, roleDefinitionDisplayName, roleType, scopeId, scopeDisplayName, scopeType, default);
        }
    }
}
