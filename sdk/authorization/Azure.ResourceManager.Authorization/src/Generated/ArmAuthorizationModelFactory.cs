...
namespace Azure.ResourceManager.Authorization.Models
{
    ...
    public static partial class ArmAuthorizationModelFactory
    {
        ...
        /// <param name="principalName"> The identity display name. </param>
        /// <param name="userPrincipalName"> The user principal name(if valid). </param>
        /// <returns> A new <see cref="Models.AccessReviewActorIdentity"/> instance for mocking. </returns>
        public static AccessReviewActorIdentity AccessReviewActorIdentity(string principalId = default, AccessReviewActorIdentityType? principalType = default, string principalName = default, string userPrincipalName = default)
        {
            return new AccessReviewActorIdentity(principalId, principalType, principalName, userPrincipalName, default);
        }
        ...
        /// <returns> A new <see cref="Models.AccessReviewRecurrencePattern"/> instance for mocking. </returns>
        public static AccessReviewRecurrencePattern AccessReviewRecurrencePattern(AccessReviewRecurrencePatternType? @type = default, int? interval = default)
        {
            return new AccessReviewRecurrencePattern(@type, interval, default);
        }
        ...
        public static RoleAssignmentScheduleData RoleAssignmentScheduleData(ResourceIdentifier id = default, string name = default, ResourceType resourceType = default, SystemData systemData = default, string scope = default, ResourceIdentifier roleDefinitionId = default, Guid? principalId = default, RoleManagementPrincipalType? principalType = default, ResourceIdentifier roleAssignmentScheduleRequestId = default, ResourceIdentifier linkedRoleEligibilityScheduleId = default, RoleAssignmentScheduleAssignmentType? assignmentType = default, RoleManagementScheduleMemberType? memberType = default, RoleManagementScheduleStatus? status = default, DateTimeOffset? startOn = default, DateTimeOffset? endOn = default, string condition = default, string conditionVersion = default, DateTimeOffset? createdOn = default, DateTimeOffset? updatedOn = default, RoleManagementExpandedProperties expandedProperties = default)
        {
        ...
        public static RoleAssignmentScheduleInstanceData RoleAssignmentScheduleInstanceData(ResourceIdentifier id = default, string name = default, ResourceType resourceType = default, SystemData systemData = default, string scope = default, ResourceIdentifier roleDefinitionId = default, Guid? principalId = default, RoleManagementPrincipalType? principalType = default, ResourceIdentifier roleAssignmentScheduleId = default, ResourceIdentifier originRoleAssignmentId = default, RoleManagementScheduleStatus? status = default, DateTimeOffset? startOn = default, DateTimeOffset? endOn = default, ResourceIdentifier linkedRoleEligibilityScheduleId = default, ResourceIdentifier linkedRoleEligibilityScheduleInstanceId = default, RoleAssignmentScheduleAssignmentType? assignmentType = default, RoleManagementScheduleMemberType? memberType = default, string condition = default, string conditionVersion = default, DateTimeOffset? createdOn = default, RoleManagementExpandedProperties expandedProperties = default)
        {
        ...
        public static RoleAssignmentScheduleRequestData RoleAssignmentScheduleRequestData(ResourceIdentifier id = default, string name = default, ResourceType resourceType = default, SystemData systemData = default, string scope = default, ResourceIdentifier roleDefinitionId = default, Guid? principalId = default, RoleManagementPrincipalType? principalType = default, RoleManagementScheduleRequestType? requestType = default, RoleManagementScheduleStatus? status = default, string approvalId = default, ResourceIdentifier targetRoleAssignmentScheduleId = default, ResourceIdentifier targetRoleAssignmentScheduleInstanceId = default, ResourceIdentifier linkedRoleEligibilityScheduleId = default, string justification = default, RoleAssignmentScheduleTicketInfo ticketInfo = default, string condition = default, string conditionVersion = default, DateTimeOffset? createdOn = default, Guid? requestorId = default, RoleManagementExpandedProperties expandedProperties = default, DateTimeOffset? startOn = default, RoleManagementScheduleExpirationType? expirationType = default, DateTimeOffset? endOn = default, TimeSpan? duration = default)
        {
        ...
        public static RoleEligibilityScheduleData RoleEligibilityScheduleData(ResourceIdentifier id = default, string name = default, ResourceType resourceType = default, SystemData systemData = default, string scope = default, ResourceIdentifier roleDefinitionId = default, Guid? principalId = default, RoleManagementPrincipalType? principalType = default, ResourceIdentifier roleEligibilityScheduleRequestId = default, RoleManagementScheduleMemberType? memberType = default, RoleManagementScheduleStatus? status = default, DateTimeOffset? startOn = default, DateTimeOffset? endOn = default, string condition = default, string conditionVersion = default, DateTimeOffset? createdOn = default, DateTimeOffset? updatedOn = default, RoleManagementExpandedProperties expandedProperties = default)
        {
        ...
        public static RoleEligibilityScheduleInstanceData RoleEligibilityScheduleInstanceData(ResourceIdentifier id = default, string name = default, ResourceType resourceType = default, SystemData systemData = default, string scope = default, ResourceIdentifier roleDefinitionId = default, Guid? principalId = default, RoleManagementPrincipalType? principalType = default, ResourceIdentifier roleEligibilityScheduleId = default, RoleManagementScheduleStatus? status = default, DateTimeOffset? startOn = default, DateTimeOffset? endOn = default, RoleManagementScheduleMemberType? memberType = default, string condition = default, string conditionVersion = default, DateTimeOffset? createdOn = default, RoleManagementExpandedProperties expandedProperties = default)
        {
        ...
        public static RoleEligibilityScheduleRequestData RoleEligibilityScheduleRequestData(ResourceIdentifier id = default, string name = default, ResourceType resourceType = default, SystemData systemData = default, string scope = default, ResourceIdentifier roleDefinitionId = default, Guid? principalId = default, RoleManagementPrincipalType? principalType = default, RoleManagementScheduleRequestType? requestType = default, RoleManagementScheduleStatus? status = default, string approvalId = default, ResourceIdentifier targetRoleEligibilityScheduleId = default, ResourceIdentifier targetRoleEligibilityScheduleInstanceId = default, string justification = default, RoleEligibilityScheduleRequestPropertiesTicketInfo ticketInfo = default, string condition = default, string conditionVersion = default, DateTimeOffset? createdOn = default, Guid? requestorId = default, RoleManagementExpandedProperties expandedProperties = default, DateTimeOffset? startOn = default, RoleManagementScheduleExpirationType? expirationType = default, DateTimeOffset? endOn = default, TimeSpan? duration = default)
        {
        ...
        public static RoleManagementPrincipal RoleManagementPrincipal(string id = default, string displayName = default, RoleManagementPrincipalType? principalType = default, string email = default)
        {
            return new RoleManagementPrincipal(id, displayName, principalType, email, default);
        }

        /// <summary>
        /// The role management policy rule.
        /// Please note this is the abstract base class. The derived classes available for instantiation are: <see cref="Models.RoleManagementPolicyApprovalRule"/>, <see cref="Models.RoleManagementPolicyAuthenticationContextRule"/>, <see cref="Models.RoleManagementPolicyEnablementRule"/>, <see cref="Models.RoleManagementPolicyExpirationRule"/>, <see cref="Models.RoleManagementPolicyNotificationRule"/>, and <see cref="Models.RoleManagementPolicyPimOnlyModeRule"/>.
        /// </summary>
        ...
        public static RoleManagementPolicyRuleTarget RoleManagementPolicyRuleTarget(string caller = default, IEnumerable<string> operations = default, RoleManagementAssignmentLevel? level = default, IEnumerable<string> targetObjects = default, IEnumerable<string> inheritableSettings = default, IEnumerable<string> enforcedSettings = default)
        {
        ...
        public static RoleManagementApprovalSettings RoleManagementApprovalSettings(bool? isApprovalRequired = default, bool? isApprovalRequiredForExtension = default, bool? isRequestorJustificationRequired = default, RoleManagementApprovalMode? approvalMode = default, IEnumerable<RoleManagementApprovalStage> approvalStages = default)
        {
            ...
            return new RoleManagementApprovalSettings(
                ...
                approvalMode,
                (approvalStages ?? new ChangeTrackingList<RoleManagementApprovalStage>()).ToList(),
                default);
        }
        ...
        public static RoleManagementApprovalStage RoleManagementApprovalStage(int? approvalStageTimeOutInDays = default, bool? isApproverJustificationRequired = default, int? escalationTimeInMinutes = default, IEnumerable<RoleManagementUserInfo> primaryApprovers = default, bool? isEscalationEnabled = default, IEnumerable<RoleManagementUserInfo> escalationApprovers = default)
        {
            ...
            return new RoleManagementApprovalStage(
                ...
                (primaryApprovers ?? new ChangeTrackingList<RoleManagementUserInfo>()).ToList(),
                isEscalationEnabled,
                (escalationApprovers ?? new ChangeTrackingList<RoleManagementUserInfo>()).ToList(),
                default);
        }
        ...
        public static RoleManagementUserInfo RoleManagementUserInfo(RoleManagementUserType? userType = default, bool? isBackup = default, string id = default, string description = default)
        {
            return new RoleManagementUserInfo(userType, isBackup, id, description, default);
        }
        ...
        public static RoleManagementPolicyEnablementRule RoleManagementPolicyEnablementRule(string id = default, RoleManagementPolicyRuleTarget target = default, IEnumerable<RoleAssignmentEnablementRuleType> enablementRules = default)
        {
        ...
        public static RoleManagementPolicyExpirationRule RoleManagementPolicyExpirationRule(string id = default, RoleManagementPolicyRuleTarget target = default, bool? isExpirationRequired = default, TimeSpan? maximumDuration = default, IEnumerable<RoleManagementUserInfo> exceptionMembers = default)
        {
            ...
            return new RoleManagementPolicyExpirationRule(
                ...
                maximumDuration,
                (exceptionMembers ?? new ChangeTrackingList<RoleManagementUserInfo>()).ToList());
        }
        ...
        public static RoleManagementPolicyProperties RoleManagementPolicyProperties(ResourceIdentifier scopeId = default, string scopeDisplayName = default, RoleManagementScopeType? scopeType = default)
        {
            return new RoleManagementPolicyProperties(scopeId is null && scopeDisplayName is null && scopeType is null ? default : new PolicyPropertiesScope(scopeId, scopeDisplayName, scopeType, default), default);
        }
        ...
        public static RoleAssignmentData RoleAssignmentData(ResourceIdentifier id = default, string name = default, ResourceType resourceType = default, SystemData systemData = default, string scope = default, ResourceIdentifier roleDefinitionId = default, Guid? principalId = default, RoleManagementPrincipalType? principalType = default, string description = default, string condition = default, string conditionVersion = default, DateTimeOffset? createdOn = default, DateTimeOffset? updatedOn = default, string createdBy = default, string updatedBy = default, ResourceIdentifier delegatedManagedIdentityResourceId = default)
        {
        ...
        {
            return new RoleAssignmentCreateOrUpdateContent(new RoleAssignmentProperties(
                scope,
                roleDefinitionId,
                principalId,
                principalType,
        ...
        /// Please note this is the abstract base class. The derived classes available for instantiation are: <see cref="Models.AzureRolesAssignedOutsidePimAlertIncidentProperties"/>, <see cref="Models.DuplicateRoleCreatedAlertIncidentProperties"/>, <see cref="Models.TooManyOwnersAssignedToResourceAlertIncidentProperties"/>, and <see cref="Models.TooManyPermanentOwnersAssignedToResourceAlertIncidentProperties"/>.
        /// </summary>
        ...
        /// Please note this is the abstract base class. The derived classes available for instantiation are: <see cref="Models.AzureRolesAssignedOutsidePimAlertConfigurationProperties"/>, <see cref="Models.DuplicateRoleCreatedAlertConfigurationProperties"/>, <see cref="Models.TooManyOwnersAssignedToResourceAlertConfigurationProperties"/>, and <see cref="Models.TooManyPermanentOwnersAssignedToResourceAlertConfigurationProperties"/>.
        /// </summary>
        ...
        public static AccessReviewDecisionData AccessReviewDecisionData(ResourceIdentifier id = default, string name = default, ResourceType resourceType = default, SystemData systemData = default, AccessReviewDecisionIdentity principal = default, AccessReviewDecisionResourceTarget resource = default, AccessRecommendationType? recommendation = default, AccessReviewResult? decision = default, string justification = default, DateTimeOffset? reviewedOn = default, AccessReviewActorIdentity reviewedBy = default, AccessReviewApplyResult? applyResult = default, DateTimeOffset? appliedOn = default, AccessReviewActorIdentity appliedBy = default, IEnumerable<AccessReviewDecisionInsight> insights = default, IEnumerable<AccessReviewDecisionPrincipalResourceMembershipType> membershipTypes = default)
        {
            return new AccessReviewDecisionData(
                ...
                resourceType,
                systemData,
                principal is null && resource is null && recommendation is null && decision is null && justification is null && reviewedOn is null && reviewedBy is null && applyResult is null && appliedOn is null && appliedBy is null && insights is null && membershipTypes is null ? default : new AccessReviewDecisionPatch(
                    principal,
                    resource,
                    recommendation,
                    decision,
        ...
        /// Please note this is the abstract base class. The derived classes available for instantiation are: <see cref="Models.AccessReviewDecisionUserSignInInsightProperties"/>.
        /// </summary>
        ...
        public static AuthorizationProviderResourceType AuthorizationProviderResourceType(string name = default, string displayName = default, IEnumerable<AuthorizationProviderOperationInfo> operations = default)
        {
            operations ??= new ChangeTrackingList<AuthorizationProviderOperationInfo>();

            return new AuthorizationProviderResourceType(name, displayName, (operations ?? new ChangeTrackingList<AuthorizationProviderOperationInfo>()).ToList(), default);
        }
        ...
        public static AuthorizationProviderOperationInfo AuthorizationProviderOperationInfo(string name = default, string displayName = default, string description = default, string origin = default, BinaryData properties = default, bool? isDataAction = default)
        {
