...
{
    internal partial class AccessReviewHistoryDefinition
    {
        private readonly Uri _endpoint;
        private readonly string _apiVersion;
        private readonly TelemetryDetails _userAgent;

        /// <summary> Initializes a new instance of AccessReviewHistoryDefinition for mocking. </summary>
        ...
        internal AccessReviewHistoryDefinition(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string applicationId, Uri endpoint, string apiVersion)
        {
            ClientDiagnostics = clientDiagnostics;
            _endpoint = endpoint;
            Pipeline = pipeline;
            _apiVersion = apiVersion;
            _userAgent = new TelemetryDetails(typeof(AccessReviewHistoryDefinition).Assembly, applicationId);
        }
