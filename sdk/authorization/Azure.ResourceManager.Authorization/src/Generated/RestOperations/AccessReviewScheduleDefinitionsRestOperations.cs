...
namespace Azure.ResourceManager.Authorization
{
    internal partial class AccessReviewScheduleDefinitions
    {
        ...
        internal AccessReviewScheduleDefinitions(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string applicationId, Uri endpoint, string apiVersion)
        {
            ClientDiagnostics = clientDiagnostics;
            _endpoint = endpoint;
            Pipeline = pipeline;
            _apiVersion = apiVersion;
            _userAgent = new TelemetryDetails(typeof(AccessReviewScheduleDefinitions).Assembly, applicationId);
        }
