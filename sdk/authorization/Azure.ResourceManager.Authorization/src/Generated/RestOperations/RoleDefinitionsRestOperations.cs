...
namespace Azure.ResourceManager.Authorization
{
    internal partial class RoleDefinitionsRestOperations
    {
        ...
        internal HttpMessage CreateGetByIdRequest(string roleDefinitionId)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Get;
            ...
            uri.Reset(_endpoint);
            uri.AppendPath("/", false);
            uri.AppendPath(roleDefinitionId, false);
            uri.AppendQuery("api-version", _apiVersion, true);
            request.Uri = uri;
            request.Headers.Add("Accept", "application/json");
            _userAgent.Apply(message);
        ...
        public async Task<Response<RoleDefinitionData>> GetByIdAsync(string roleDefinitionId, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(roleDefinitionId, nameof(roleDefinitionId));

            using var message = CreateGetByIdRequest(roleDefinitionId);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 200:
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="roleDefinitionId"/> is null. </exception>
        public Response<RoleDefinitionData> GetById(string roleDefinitionId, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(roleDefinitionId, nameof(roleDefinitionId));
