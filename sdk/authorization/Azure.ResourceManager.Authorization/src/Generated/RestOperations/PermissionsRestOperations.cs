...
namespace Azure.ResourceManager.Authorization
{
    internal partial class Permissions
    {
        ...
        internal Permissions(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string applicationId, Uri endpoint, string apiVersion)
        {
            ClientDiagnostics = clientDiagnostics;
            _endpoint = endpoint;
            Pipeline = pipeline;
            _apiVersion = apiVersion;
            _userAgent = new TelemetryDetails(typeof(Permissions).Assembly, applicationId);
        }
