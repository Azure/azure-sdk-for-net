...
namespace Azure.ResourceManager.Authorization
{
    internal partial class AccessReviewInstance
    {
        ...
        internal AccessReviewInstance(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string applicationId, Uri endpoint, string apiVersion)
        {
            ClientDiagnostics = clientDiagnostics;
            _endpoint = endpoint;
            Pipeline = pipeline;
            _apiVersion = apiVersion;
            _userAgent = new TelemetryDetails(typeof(AccessReviewInstance).Assembly, applicationId);
        }
