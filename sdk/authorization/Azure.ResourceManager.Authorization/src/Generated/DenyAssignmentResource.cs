...
namespace Azure.ResourceManager.Authorization
{
    ...
    public partial class DenyAssignmentResource : ArmResource
    {
        ...
        {
            using var scope = _denyAssignmentClientDiagnostics.CreateScope("DenyAssignmentResource.Delete");
            scope.Start();
            try
            {
                var response = await _denyAssignmentRestClient.DeleteAsync(Id.Parent, Id.Name, cancellationToken).ConfigureAwait(false);
                var uri = _denyAssignmentRestClient.CreateDeleteRequestUri(Id.Parent, Id.Name);
                var rehydrationToken = NextLinkOperationImplementation.GetRehydrationToken(RequestMethod.Delete, uri.ToUri(), uri.ToString(), "None", null, OperationFinalStateVia.OriginalUri.ToString());
                var operation = new AuthorizationArmOperation(response, rehydrationToken);
        ...
        public virtual ArmOperation Delete(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _denyAssignmentRestClient.Delete(Id.Parent, Id.Name, cancellationToken);
                var uri = _denyAssignmentRestClient.CreateDeleteRequestUri(Id.Parent, Id.Name);
                var rehydrationToken = NextLinkOperationImplementation.GetRehydrationToken(RequestMethod.Delete, uri.ToUri(), uri.ToString(), "None", null, OperationFinalStateVia.OriginalUri.ToString());
                var operation = new AuthorizationArmOperation(response, rehydrationToken);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<ArmOperation<DenyAssignmentResource>> UpdateAsync(WaitUntil waitUntil, DenyAssignmentData data, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _denyAssignmentClientDiagnostics.CreateScope("DenyAssignmentResource.Update");
            scope.Start();
            try
            {
                var response = await _denyAssignmentRestClient.CreateOrUpdateAsync(Id.Parent, Id.Name, data, cancellationToken).ConfigureAwait(false);
                var uri = _denyAssignmentRestClient.CreateCreateOrUpdateRequestUri(Id.Parent, Id.Name, data);
                var rehydrationToken = NextLinkOperationImplementation.GetRehydrationToken(RequestMethod.Put, uri.ToUri(), uri.ToString(), "None", null, OperationFinalStateVia.OriginalUri.ToString());
                var operation = new AuthorizationArmOperation<DenyAssignmentResource>(Response.FromValue(new DenyAssignmentResource(Client, response), response.GetRawResponse()), rehydrationToken);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual ArmOperation<DenyAssignmentResource> Update(WaitUntil waitUntil, DenyAssignmentData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _denyAssignmentRestClient.CreateOrUpdate(Id.Parent, Id.Name, data, cancellationToken);
                var uri = _denyAssignmentRestClient.CreateCreateOrUpdateRequestUri(Id.Parent, Id.Name, data);
                var rehydrationToken = NextLinkOperationImplementation.GetRehydrationToken(RequestMethod.Put, uri.ToUri(), uri.ToString(), "None", null, OperationFinalStateVia.OriginalUri.ToString());
                var operation = new AuthorizationArmOperation<DenyAssignmentResource>(Response.FromValue(new DenyAssignmentResource(Client, response), response.GetRawResponse()), rehydrationToken);
                if (waitUntil == WaitUntil.Completed)
