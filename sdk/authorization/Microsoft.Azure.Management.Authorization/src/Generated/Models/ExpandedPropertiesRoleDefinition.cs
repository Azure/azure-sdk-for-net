...
namespace Microsoft.Azure.Management.Authorization.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the ExpandedPropertiesRoleDefinition
        /// class.
        /// </summary>
        ...
        public ExpandedPropertiesRoleDefinition(string id = default(string), string displayName = default(string), string type = default(string))
        {
            Id = id;
