...
namespace Microsoft.Azure.Management.Authorization.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the PolicyAssignmentPropertiesScope
        /// class.
        /// </summary>
        ...
        public PolicyAssignmentPropertiesScope(string id = default(string), string displayName = default(string), string type = default(string))
        {
            Id = id;
