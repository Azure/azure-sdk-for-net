...
namespace Microsoft.Azure.Management.Authorization.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the PolicyPropertiesScope class.
        /// </summary>
        ...
        public PolicyPropertiesScope(string id = default(string), string displayName = default(string), string type = default(string))
        {
            Id = id;
