...
namespace Azure.Analytics.Synapse.Spark
{
    ...
    public partial class SparkBatchClient
    {
        ...
        public virtual async Task<SparkBatchOperation> CreateSparkBatchJobAsync(WaitUntil waitUntil, SparkBatchJobOptions options, bool? detailed = null, CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _clientDiagnostics.CreateScope("SparkBatchClient.CreateSparkBatchJob");
            scope.Start();
            try
            {
                var response = await RestClient.CreateSparkBatchJobAsync(
                    options,
                    detailed,
                    cancellationToken).ConfigureAwait(false);

                var operation = new SparkBatchOperation(this, _clientDiagnostics, response, options.CreationCompletionType);
        ...
        public virtual SparkBatchOperation CreateSparkBatchJob(WaitUntil waitUntil, SparkBatchJobOptions options, bool? detailed = null, CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _clientDiagnostics.CreateScope("SparkBatchClient.CreateSparkBatchJob");
            scope.Start();
            try
            {
                var response = RestClient.CreateSparkBatchJob(
                    options,
                    detailed,
                    cancellationToken);
