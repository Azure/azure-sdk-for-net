...
namespace Azure.Analytics.Synapse.Spark
{
    ...
    public partial class SparkSessionClient
    {
        ...
        public virtual async Task<SparkSessionOperation> CreateSparkSessionAsync(WaitUntil waitUntil, SparkSessionOptions sparkSessionOptions, bool? detailed = null, CancellationToken cancellationToken = default) {
            using DiagnosticScope scope = _clientDiagnostics.CreateScope($"{nameof(SparkSessionClient)}.{nameof(CreateSparkSession)}");
            scope.Start();
            try
            {
               var response = await RestClient.CreateSparkSessionAsync(
                   sparkSessionOptions,
                   detailed,
                   cancellationToken).ConfigureAwait(false);
                
                var operation = new SparkSessionOperation(this, _clientDiagnostics, response);
        ...
        public virtual SparkSessionOperation CreateSparkSession(WaitUntil waitUntil, SparkSessionOptions sparkSessionOptions, bool? detailed = null, CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _clientDiagnostics.CreateScope($"{nameof(SparkSessionClient)}.{nameof(CreateSparkSession)}");
            scope.Start();
            try
            {
                var response = RestClient.CreateSparkSession(
                    sparkSessionOptions,
                    detailed,
                    cancellationToken);
        ...
        public virtual async Task<SparkStatementOperation> CreateSparkStatementAsync(WaitUntil waitUntil, int sessionId, SparkStatementOptions sparkStatementOptions, CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _clientDiagnostics.CreateScope($"{nameof(SparkSessionClient)}.{nameof(CreateSparkStatement)}");
            scope.Start();
            try
            {
                var response = await RestClient.CreateSparkStatementAsync(
                    sessionId,
                    sparkStatementOptions,
                    cancellationToken).ConfigureAwait(false);

                var operation = new SparkStatementOperation(this, _clientDiagnostics, response, sessionId);
        ...
        public virtual SparkStatementOperation CreateSparkStatement(WaitUntil waitUntil, int sessionId, SparkStatementOptions sparkStatementOptions, CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _clientDiagnostics.CreateScope($"{nameof(SparkSessionClient)}.{nameof(CreateSparkStatement)}");
            scope.Start();
            try
            {
                var response = RestClient.CreateSparkStatement(
                    sessionId,
                    sparkStatementOptions,
                    cancellationToken);
