...
namespace Azure.Analytics.Synapse.Spark.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SparkSessionOptions>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SparkSessionOptions>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SparkSessionOptions>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<SparkSessionOptions>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
