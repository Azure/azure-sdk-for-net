...
namespace Azure.Analytics.Synapse.Spark.Models
{
    ...
    public partial class SparkStatement
    {
        ...
        internal SparkStatement(int id, string code, LivyStatementStates? state, SparkStatementOutput output, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Code = code;
            State = state;
