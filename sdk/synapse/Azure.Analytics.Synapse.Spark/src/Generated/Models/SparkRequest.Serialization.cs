...
namespace Azure.Analytics.Synapse.Spark.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SparkRequest>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SparkRequest>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SparkRequest>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SparkRequest>)} interface");
            }
        ...
        string IPersistableModel<SparkRequest>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
