...
namespace Azure.Analytics.Synapse.Spark.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SparkBatchJob>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SparkBatchJob>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SparkBatchJob>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<SparkBatchJob>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
