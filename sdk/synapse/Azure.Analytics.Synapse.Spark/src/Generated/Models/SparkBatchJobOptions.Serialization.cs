...
namespace Azure.Analytics.Synapse.Spark.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SparkBatchJobOptions>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SparkBatchJobOptions>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SparkBatchJobOptions>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<SparkBatchJobOptions>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
