...
{
    public partial class SparkBatchJobOptions : IUtf8JsonSerializable, IModelJsonSerializable<SparkBatchJobOptions>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IModelJsonSerializable<SparkBatchJobOptions>)this).Serialize(writer, ModelSerializerOptions.DefaultWireOptions);

        void IModelJsonSerializable<SparkBatchJobOptions>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<SparkBatchJobOptions>(this, options.Format);
        ...
        internal static SparkBatchJobOptions DeserializeSparkBatchJobOptions(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new SparkBatchJobOptions(Optional.ToDictionary(tags), artifactId.Value, name, file, className.Value, Optional.ToList(args), Optional.ToList(jars), Optional.ToList(pyFiles), Optional.ToList(files), Optional.ToList(archives), Optional.ToDictionary(conf), driverMemory.Value, Optional.ToNullable(driverCores), executorMemory.Value, Optional.ToNullable(executorCores), Optional.ToNullable(numExecutors), rawData);
        }

        SparkBatchJobOptions IModelJsonSerializable<SparkBatchJobOptions>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<SparkBatchJobOptions>(this, options.Format);

            using var doc = JsonDocument.ParseValue(ref reader);
            return DeserializeSparkBatchJobOptions(doc.RootElement, options);
        }

        BinaryData IModelSerializable<SparkBatchJobOptions>.Serialize(ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<SparkBatchJobOptions>(this, options.Format);
        ...
        SparkBatchJobOptions IModelSerializable<SparkBatchJobOptions>.Deserialize(BinaryData data, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<SparkBatchJobOptions>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="SparkBatchJobOptions"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="SparkBatchJobOptions"/> to convert. </param>
        public static implicit operator RequestContent(SparkBatchJobOptions model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="SparkBatchJobOptions"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator SparkBatchJobOptions(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeSparkBatchJobOptions(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
