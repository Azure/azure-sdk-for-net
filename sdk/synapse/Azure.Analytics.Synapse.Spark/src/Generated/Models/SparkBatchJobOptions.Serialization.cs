...
namespace Azure.Analytics.Synapse.Spark.Models
{
    public partial class SparkBatchJobOptions : IUtf8JsonSerializable, IJsonModel<SparkBatchJobOptions>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<SparkBatchJobOptions>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SparkBatchJobOptions>)} interface");
            }
