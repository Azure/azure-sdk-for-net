...
namespace Azure.Analytics.Synapse.Spark.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SparkBatchJobCollection>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SparkBatchJobCollection>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SparkBatchJobCollection>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<SparkBatchJobCollection>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
