...
namespace Azure.Analytics.Synapse.Spark.Models
{
    public partial class SparkBatchJobCollection : IUtf8JsonSerializable, IJsonModel<SparkBatchJobCollection>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<SparkBatchJobCollection>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SparkBatchJobCollection>)} interface");
            }
