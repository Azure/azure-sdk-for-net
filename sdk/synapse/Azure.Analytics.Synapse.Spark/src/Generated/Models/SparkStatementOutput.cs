...
namespace Azure.Analytics.Synapse.Spark.Models
{
    ...
    public partial class SparkStatementOutput
    {
        ...
        internal SparkStatementOutput(string status, int executionCount, object data, string errorName, string errorValue, IReadOnlyList<string> traceback, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Status = status;
            ExecutionCount = executionCount;
            Data = data;
