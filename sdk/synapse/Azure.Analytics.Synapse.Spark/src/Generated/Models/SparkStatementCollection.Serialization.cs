...
namespace Azure.Analytics.Synapse.Spark.Models
{
    ...
    {
        internal static SparkStatementCollection DeserializeSparkStatementCollection(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
