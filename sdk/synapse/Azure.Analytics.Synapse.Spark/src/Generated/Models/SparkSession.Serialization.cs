...
namespace Azure.Analytics.Synapse.Spark.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SparkSession>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SparkSession>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SparkSession>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<SparkSession>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
