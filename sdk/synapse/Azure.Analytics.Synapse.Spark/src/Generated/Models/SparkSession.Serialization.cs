...
namespace Azure.Analytics.Synapse.Spark.Models
{
    public partial class SparkSession : IUtf8JsonSerializable, IModelJsonSerializable<SparkSession>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<SparkSession>(this, options.Format);
            ...
            if (Optional.IsDefined(LivyInfo))
            {
                ...
                {
                    ((IModelJsonSerializable<SparkSessionState>)LivyInfo).Serialize(writer, options);
                }
            }
        ...
        /// <summary> Converts a <see cref="SparkSession"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="SparkSession"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="SparkSession"/>. </summary>
