...
namespace Azure.Analytics.Synapse.Spark.Models
{
    public partial class SparkSession : IUtf8JsonSerializable, IJsonModel<SparkSession>
    {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<SparkSession>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(SparkSession)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<SparkSession>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(SparkSession)} does not support '{options.Format}' format.");
            }
        }
