...
namespace Azure.Analytics.Synapse.ManagedPrivateEndpoints
{
    internal partial class ManagedPrivateEndpointsRestClient
    {
        ...
        /// <param name="apiVersion"> Api Version. The default is "2020-12-01". </param>
        ...
        /// <param name="managedVirtualNetworkName"> Managed virtual network name. The default is "default". </param>
