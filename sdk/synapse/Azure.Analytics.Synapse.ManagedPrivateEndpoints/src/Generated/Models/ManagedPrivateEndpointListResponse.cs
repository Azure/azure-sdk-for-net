...
namespace Azure.Analytics.Synapse.ManagedPrivateEndpoints.Models
{
    ...
    internal partial class ManagedPrivateEndpointListResponse
    {
        ...
        internal ManagedPrivateEndpointListResponse(IReadOnlyList<ManagedPrivateEndpoint> value, string nextLink, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Value = value;
            NextLink = nextLink;
