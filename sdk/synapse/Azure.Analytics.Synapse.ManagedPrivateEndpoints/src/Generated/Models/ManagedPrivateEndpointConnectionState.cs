...
namespace Azure.Analytics.Synapse.ManagedPrivateEndpoints.Models
{
    ...
    public partial class ManagedPrivateEndpointConnectionState
    {
        ...
        internal ManagedPrivateEndpointConnectionState(string status, string description, string actionsRequired, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Status = status;
