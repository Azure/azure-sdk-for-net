...
namespace Azure.Analytics.Synapse.ManagedPrivateEndpoints.Models
{
    ...
    public partial class ManagedPrivateEndpoint
    {
        ...
        internal ManagedPrivateEndpoint(string id, string name, string type, ManagedPrivateEndpointProperties properties, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Name = name;
            Type = type;
