...
namespace Azure.Analytics.Synapse.ManagedPrivateEndpoints
{
    ...
    public partial class ManagedPrivateEndpointsClient
    {
        ...
        public virtual AsyncPageable<ManagedPrivateEndpoint> ListAsync(string managedVirtualNetworkName, CancellationToken cancellationToken = default)
        {
            ...
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => ManagedPrivateEndpoint.DeserializeManagedPrivateEndpoint(e), _clientDiagnostics, _pipeline, "ManagedPrivateEndpointsClient.List", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<ManagedPrivateEndpoint> List(string managedVirtualNetworkName, CancellationToken cancellationToken = default)
        {
            ...
            HttpMessage FirstPageRequest(int? pageSizeHint) => RestClient.CreateListRequest(managedVirtualNetworkName);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => RestClient.CreateListNextPageRequest(nextLink, managedVirtualNetworkName);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => ManagedPrivateEndpoint.DeserializeManagedPrivateEndpoint(e), _clientDiagnostics, _pipeline, "ManagedPrivateEndpointsClient.List", "value", "nextLink", cancellationToken);
        }
    }
}
