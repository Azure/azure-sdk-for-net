...
namespace Azure.Provisioning.Synapse
{
    ...
    public partial class SynapsePrivateEndpointConnection : ProvisionableResource
    {
        ...
        /// <summary> Creates a new SynapsePrivateEndpointConnection. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public SynapsePrivateEndpointConnection(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.Synapse/workspaces/privateEndpointConnections", resourceVersion ?? "2021-06-01-preview")
        {
        }
        ...
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static SynapsePrivateEndpointConnection FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            SynapsePrivateEndpointConnection result = new SynapsePrivateEndpointConnection(bicepIdentifier, resourceVersion);
