...
namespace Azure.Provisioning.Synapse
{
    ...
    public partial class SynapsePrivateLinkResourceProperties : ProvisionableConstruct
    {
        private BicepValue<string> _groupId;
        private BicepList<string> _requiredMembers;
        private BicepList<string> _requiredZoneNames;

        /// <summary> Creates a new SynapsePrivateLinkResourceProperties. </summary>
        ...
        /// <summary> Define all the provisionable properties for SynapsePrivateLinkResourceProperties. </summary>
        ...
        /// <summary> Define additional provisionable properties for SynapsePrivateLinkResourceProperties that are not part of the generated code. </summary>
