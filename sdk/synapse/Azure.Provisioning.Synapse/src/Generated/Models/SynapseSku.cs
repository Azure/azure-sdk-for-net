...
namespace Azure.Provisioning.Synapse
{
    ...
    public partial class SynapseSku : ProvisionableConstruct
    {
        private BicepValue<string> _tier;
        private BicepValue<string> _name;
        private BicepValue<int> _capacity;

        /// <summary> Creates a new SynapseSku. </summary>
        public SynapseSku()
        {
        }
        ...
        /// <summary> Define all the provisionable properties for SynapseSku. </summary>
        ...
        /// <summary> Define additional provisionable properties for SynapseSku that are not part of the generated code. </summary>
