...
namespace Azure.Analytics.Synapse.Monitoring.Models
{
    ...
    {
        internal static SparkJobListViewResponse DeserializeSparkJobListViewResponse(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
