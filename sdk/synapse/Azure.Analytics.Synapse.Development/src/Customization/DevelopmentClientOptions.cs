...
{
    /// <summary>
    /// The options for Azure Synapse Development.
    /// </summary>
    public class DevelopmentClientOptions : ClientOptions
    {
        private const ServiceVersion Latest = ServiceVersion.V2019_06_01_preview;

        internal static DevelopmentClientOptions Default { get; } = new DevelopmentClientOptions();

        /// <summary>
        /// Initializes a new instance of the <see cref="DevelopmentClientOptions"/>.
        /// </summary>
        public DevelopmentClientOptions(ServiceVersion serviceVersion = Latest)
        {
