...
namespace Azure.Analytics.Synapse.Development.Models
{
    public partial class AzureMLServiceLinkedService : IUtf8JsonSerializable
    {
        ...
        internal static AzureMLServiceLinkedService DeserializeAzureMLServiceLinkedService(JsonElement element)
        {
            ...
            return new AzureMLServiceLinkedService(type, connectVia, description, parameters, annotations, additionalProperties, subscriptionId, resourceGroupName, mlWorkspaceName, servicePrincipalId, servicePrincipalKey, tenant, encryptedCredential);
        }
    }
}
