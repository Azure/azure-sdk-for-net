...
namespace Azure.Analytics.Synapse.Development.Models
{
    public partial class SftpServerLinkedService : IUtf8JsonSerializable
    {
        ...
        internal static SftpServerLinkedService DeserializeSftpServerLinkedService(JsonElement element)
        {
            ...
            return new SftpServerLinkedService(type, connectVia, description, parameters, annotations, additionalProperties, host, port, authenticationType, userName, password, encryptedCredential, privateKeyPath, privateKeyContent, passPhrase, skipHostKeyValidation, hostKeyFingerprint);
        }
    }
}
