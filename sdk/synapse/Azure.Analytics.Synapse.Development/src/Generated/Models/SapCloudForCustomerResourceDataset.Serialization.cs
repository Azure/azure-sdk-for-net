...
namespace Azure.Analytics.Synapse.Development.Models
{
    public partial class SapCloudForCustomerResourceDataset : IUtf8JsonSerializable
    {
        ...
        internal static SapCloudForCustomerResourceDataset DeserializeSapCloudForCustomerResourceDataset(JsonElement element)
        {
            ...
            return new SapCloudForCustomerResourceDataset(type, description, structure, schema, linkedServiceName, parameters, annotations, folder, additionalProperties, path);
        }
    }
}
