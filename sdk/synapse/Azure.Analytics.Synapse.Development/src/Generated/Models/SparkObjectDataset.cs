...
namespace Azure.Analytics.Synapse.Development.Models
{
    ...
    public partial class SparkObjectDataset : Dataset
    {
        ...
        internal SparkObjectDataset(string type, string description, object structure, object schema, LinkedServiceReference linkedServiceName, IDictionary<string, ParameterSpecification> parameters, IList<object> annotations, DatasetFolder folder, IDictionary<string, object> additionalProperties, object tableName, object table, object schemaTypePropertiesSchema) : base(type, description, structure, schema, linkedServiceName, parameters, annotations, folder, additionalProperties)
        {
            ...
            Type = type ?? "SparkObject";
        }

        /// <summary> This property will be retired. Please consider using schema + table properties instead. </summary>
        public object TableName { get; set; }
        /// <summary> The table name of the Spark. Type: string (or Expression with resultType string). </summary>
        public object Table { get; set; }
        /// <summary> The schema name of the Spark. Type: string (or Expression with resultType string). </summary>
