...
namespace Azure.Analytics.Synapse.Development.Models
{
    public partial class AmazonRedshiftTableDataset : IUtf8JsonSerializable
    {
        ...
        internal static AmazonRedshiftTableDataset DeserializeAmazonRedshiftTableDataset(JsonElement element)
        {
            ...
            return new AmazonRedshiftTableDataset(type, description, structure, schema, linkedServiceName, parameters, annotations, folder, additionalProperties, tableName, table, schema0);
        }
    }
}
