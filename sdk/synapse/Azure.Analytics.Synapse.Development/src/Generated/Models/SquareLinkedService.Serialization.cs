...
namespace Azure.Analytics.Synapse.Development.Models
{
    public partial class SquareLinkedService : IUtf8JsonSerializable
    {
        ...
        internal static SquareLinkedService DeserializeSquareLinkedService(JsonElement element)
        {
            ...
            return new SquareLinkedService(type, connectVia, description, parameters, annotations, additionalProperties, host, clientId, clientSecret, redirectUri, useEncryptedEndpoints, useHostVerification, usePeerVerification, encryptedCredential);
        }
    }
}
