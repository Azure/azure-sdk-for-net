...
namespace Azure.Analytics.Synapse.Development.Models
{
    public partial class SapBWLinkedService : IUtf8JsonSerializable
    {
        ...
        internal static SapBWLinkedService DeserializeSapBWLinkedService(JsonElement element)
        {
            ...
            return new SapBWLinkedService(type, connectVia, description, parameters, annotations, additionalProperties, server, systemNumber, clientId, userName, password, encryptedCredential);
        }
    }
}
