...
namespace Azure.Analytics.Synapse.Development.Models
{
    public partial class GreenplumTableDataset : IUtf8JsonSerializable
    {
        ...
        internal static GreenplumTableDataset DeserializeGreenplumTableDataset(JsonElement element)
        {
            ...
            return new GreenplumTableDataset(type, description, structure, schema, linkedServiceName, parameters, annotations, folder, additionalProperties, tableName, table, schema0);
        }
    }
}
