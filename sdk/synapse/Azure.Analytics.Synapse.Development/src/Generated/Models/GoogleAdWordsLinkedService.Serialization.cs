...
namespace Azure.Analytics.Synapse.Development.Models
{
    public partial class GoogleAdWordsLinkedService : IUtf8JsonSerializable
    {
        ...
        internal static GoogleAdWordsLinkedService DeserializeGoogleAdWordsLinkedService(JsonElement element)
        {
            ...
            return new GoogleAdWordsLinkedService(type, connectVia, description, parameters, annotations, additionalProperties, clientCustomerID, developerToken, authenticationType, refreshToken, clientId, clientSecret, email, keyFilePath, trustedCertPath, useSystemTrustStore, encryptedCredential);
        }
    }
}
