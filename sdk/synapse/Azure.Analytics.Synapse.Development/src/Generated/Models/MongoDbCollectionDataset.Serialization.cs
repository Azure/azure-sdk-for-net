...
namespace Azure.Analytics.Synapse.Development.Models
{
    public partial class MongoDbCollectionDataset : IUtf8JsonSerializable
    {
        ...
        internal static MongoDbCollectionDataset DeserializeMongoDbCollectionDataset(JsonElement element)
        {
            ...
            return new MongoDbCollectionDataset(type, description, structure, schema, linkedServiceName, parameters, annotations, folder, additionalProperties, collectionName);
        }
    }
}
