...
namespace Azure.Analytics.Synapse.Development.Models
{
    public partial class AzureMLLinkedService : IUtf8JsonSerializable
    {
        ...
        internal static AzureMLLinkedService DeserializeAzureMLLinkedService(JsonElement element)
        {
            ...
            return new AzureMLLinkedService(type, connectVia, description, parameters, annotations, additionalProperties, mlEndpoint, apiKey, updateResourceEndpoint, servicePrincipalId, servicePrincipalKey, tenant, encryptedCredential);
        }
    }
}
