...
{
    public partial class JiraLinkedService : IUtf8JsonSerializable
    {
        ...
        internal static JiraLinkedService DeserializeJiraLinkedService(JsonElement element)
        {
            string type = default;
            ...
            return new JiraLinkedService(type, connectVia, description, parameters, annotations, additionalProperties, host, port, username, password, useEncryptedEndpoints, useHostVerification, usePeerVerification, encryptedCredential);
        }
    }
}
