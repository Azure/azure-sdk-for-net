...
namespace Azure.Analytics.Synapse.Development.Models
{
    public partial class AzurePostgreSqlTableDataset : IUtf8JsonSerializable
    {
        ...
        internal static AzurePostgreSqlTableDataset DeserializeAzurePostgreSqlTableDataset(JsonElement element)
        {
            ...
            return new AzurePostgreSqlTableDataset(type, description, structure, schema, linkedServiceName, parameters, annotations, folder, additionalProperties, tableName, table, schema0);
        }
    }
}
