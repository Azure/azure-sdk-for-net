...
namespace Azure.Analytics.Synapse.Development.Models
{
    public partial class MicrosoftAccessTableDataset : IUtf8JsonSerializable
    {
        ...
        internal static MicrosoftAccessTableDataset DeserializeMicrosoftAccessTableDataset(JsonElement element)
        {
            ...
            return new MicrosoftAccessTableDataset(type, description, structure, schema, linkedServiceName, parameters, annotations, folder, additionalProperties, tableName);
        }
    }
}
