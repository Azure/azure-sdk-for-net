...
namespace Azure.Analytics.Synapse.Development.Models
{
    public partial class SalesforceObjectDataset : IUtf8JsonSerializable
    {
        ...
        internal static SalesforceObjectDataset DeserializeSalesforceObjectDataset(JsonElement element)
        {
            ...
            return new SalesforceObjectDataset(type, description, structure, schema, linkedServiceName, parameters, annotations, folder, additionalProperties, objectApiName);
        }
    }
}
