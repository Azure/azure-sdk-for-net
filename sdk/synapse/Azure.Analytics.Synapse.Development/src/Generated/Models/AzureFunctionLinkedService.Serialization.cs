...
namespace Azure.Analytics.Synapse.Development.Models
{
    public partial class AzureFunctionLinkedService : IUtf8JsonSerializable
    {
        ...
        internal static AzureFunctionLinkedService DeserializeAzureFunctionLinkedService(JsonElement element)
        {
            ...
            return new AzureFunctionLinkedService(type, connectVia, description, parameters, annotations, additionalProperties, functionAppUrl, functionKey, encryptedCredential);
        }
    }
}
