...
namespace Azure.Analytics.Synapse.Development.Models
{
    public partial class HBaseLinkedService : IUtf8JsonSerializable
    {
        ...
        internal static HBaseLinkedService DeserializeHBaseLinkedService(JsonElement element)
        {
            ...
            return new HBaseLinkedService(type, connectVia, description, parameters, annotations, additionalProperties, host, port, httpPath, authenticationType, username, password, enableSsl, trustedCertPath, allowHostNameCNMismatch, allowSelfSignedServerCert, encryptedCredential);
        }
    }
}
