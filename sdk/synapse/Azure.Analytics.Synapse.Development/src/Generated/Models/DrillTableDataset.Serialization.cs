...
namespace Azure.Analytics.Synapse.Development.Models
{
    public partial class DrillTableDataset : IUtf8JsonSerializable
    {
        ...
        internal static DrillTableDataset DeserializeDrillTableDataset(JsonElement element)
        {
            ...
            return new DrillTableDataset(type, description, structure, schema, linkedServiceName, parameters, annotations, folder, additionalProperties, tableName, table, schema0);
        }
    }
}
