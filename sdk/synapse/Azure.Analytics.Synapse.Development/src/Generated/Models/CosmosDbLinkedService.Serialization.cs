...
namespace Azure.Analytics.Synapse.Development.Models
{
    public partial class CosmosDbLinkedService : IUtf8JsonSerializable
    {
        ...
        internal static CosmosDbLinkedService DeserializeCosmosDbLinkedService(JsonElement element)
        {
            ...
            return new CosmosDbLinkedService(type, connectVia, description, parameters, annotations, additionalProperties, connectionString, accountEndpoint, database, accountKey, encryptedCredential);
        }
    }
}
