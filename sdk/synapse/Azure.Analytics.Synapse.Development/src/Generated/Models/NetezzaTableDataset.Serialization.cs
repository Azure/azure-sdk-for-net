...
namespace Azure.Analytics.Synapse.Development.Models
{
    public partial class NetezzaTableDataset : IUtf8JsonSerializable
    {
        ...
        internal static NetezzaTableDataset DeserializeNetezzaTableDataset(JsonElement element)
        {
            ...
            return new NetezzaTableDataset(type, description, structure, schema, linkedServiceName, parameters, annotations, folder, additionalProperties, tableName, table, schema0);
        }
    }
}
