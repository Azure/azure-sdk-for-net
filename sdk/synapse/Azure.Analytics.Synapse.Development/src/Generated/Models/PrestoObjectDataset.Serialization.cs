...
namespace Azure.Analytics.Synapse.Development.Models
{
    public partial class PrestoObjectDataset : IUtf8JsonSerializable
    {
        ...
        internal static PrestoObjectDataset DeserializePrestoObjectDataset(JsonElement element)
        {
            ...
            return new PrestoObjectDataset(type, description, structure, schema, linkedServiceName, parameters, annotations, folder, additionalProperties, tableName, table, schema0);
        }
    }
}
