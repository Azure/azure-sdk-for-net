...
namespace Azure.Analytics.Synapse.Development.Models
{
    public partial class MicrosoftAccessLinkedService : IUtf8JsonSerializable
    {
        ...
        internal static MicrosoftAccessLinkedService DeserializeMicrosoftAccessLinkedService(JsonElement element)
        {
            ...
            return new MicrosoftAccessLinkedService(type, connectVia, description, parameters, annotations, additionalProperties, connectionString, authenticationType, credential, userName, password, encryptedCredential);
        }
    }
}
