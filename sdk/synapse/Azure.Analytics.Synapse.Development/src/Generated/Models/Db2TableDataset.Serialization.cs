...
namespace Azure.Analytics.Synapse.Development.Models
{
    public partial class Db2TableDataset : IUtf8JsonSerializable
    {
        ...
        internal static Db2TableDataset DeserializeDb2TableDataset(JsonElement element)
        {
            ...
            return new Db2TableDataset(type, description, structure, schema, linkedServiceName, parameters, annotations, folder, additionalProperties, tableName, schema0, table);
        }
    }
}
