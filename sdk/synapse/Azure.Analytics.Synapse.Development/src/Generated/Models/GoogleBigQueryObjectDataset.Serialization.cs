...
namespace Azure.Analytics.Synapse.Development.Models
{
    public partial class GoogleBigQueryObjectDataset : IUtf8JsonSerializable
    {
        ...
        internal static GoogleBigQueryObjectDataset DeserializeGoogleBigQueryObjectDataset(JsonElement element)
        {
            ...
            return new GoogleBigQueryObjectDataset(type, description, structure, schema, linkedServiceName, parameters, annotations, folder, additionalProperties, tableName, table, dataset);
        }
    }
}
