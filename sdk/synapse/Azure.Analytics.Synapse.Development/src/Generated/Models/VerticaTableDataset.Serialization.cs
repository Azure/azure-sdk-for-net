...
namespace Azure.Analytics.Synapse.Development.Models
{
    public partial class VerticaTableDataset : IUtf8JsonSerializable
    {
        ...
        internal static VerticaTableDataset DeserializeVerticaTableDataset(JsonElement element)
        {
            ...
            return new VerticaTableDataset(type, description, structure, schema, linkedServiceName, parameters, annotations, folder, additionalProperties, tableName, table, schema0);
        }
    }
}
