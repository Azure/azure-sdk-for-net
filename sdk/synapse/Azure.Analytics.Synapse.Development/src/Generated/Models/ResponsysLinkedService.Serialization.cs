...
namespace Azure.Analytics.Synapse.Development.Models
{
    public partial class ResponsysLinkedService : IUtf8JsonSerializable
    {
        ...
        internal static ResponsysLinkedService DeserializeResponsysLinkedService(JsonElement element)
        {
            ...
            return new ResponsysLinkedService(type, connectVia, description, parameters, annotations, additionalProperties, endpoint, clientId, clientSecret, useEncryptedEndpoints, useHostVerification, usePeerVerification, encryptedCredential);
        }
    }
}
