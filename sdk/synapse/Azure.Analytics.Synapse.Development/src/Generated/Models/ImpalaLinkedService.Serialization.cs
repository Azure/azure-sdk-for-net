...
namespace Azure.Analytics.Synapse.Development.Models
{
    public partial class ImpalaLinkedService : IUtf8JsonSerializable
    {
        ...
        internal static ImpalaLinkedService DeserializeImpalaLinkedService(JsonElement element)
        {
            ...
            return new ImpalaLinkedService(type, connectVia, description, parameters, annotations, additionalProperties, host, port, authenticationType, username, password, enableSsl, trustedCertPath, useSystemTrustStore, allowHostNameCNMismatch, allowSelfSignedServerCert, encryptedCredential);
        }
    }
}
