...
namespace Azure.Analytics.Synapse.Development.Models
{
    public partial class CosmosDbSqlApiCollectionDataset : IUtf8JsonSerializable
    {
        ...
        internal static CosmosDbSqlApiCollectionDataset DeserializeCosmosDbSqlApiCollectionDataset(JsonElement element)
        {
            ...
            return new CosmosDbSqlApiCollectionDataset(type, description, structure, schema, linkedServiceName, parameters, annotations, folder, additionalProperties, collectionName);
        }
    }
}
