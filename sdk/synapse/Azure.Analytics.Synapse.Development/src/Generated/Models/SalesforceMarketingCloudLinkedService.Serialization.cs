...
namespace Azure.Analytics.Synapse.Development.Models
{
    public partial class SalesforceMarketingCloudLinkedService : IUtf8JsonSerializable
    {
        ...
        internal static SalesforceMarketingCloudLinkedService DeserializeSalesforceMarketingCloudLinkedService(JsonElement element)
        {
            ...
            return new SalesforceMarketingCloudLinkedService(type, connectVia, description, parameters, annotations, additionalProperties, clientId, clientSecret, useEncryptedEndpoints, useHostVerification, usePeerVerification, encryptedCredential);
        }
    }
}
