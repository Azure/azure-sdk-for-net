...
namespace Azure.Analytics.Synapse.Development.Models
{
    public partial class AzureSqlMITableDataset : IUtf8JsonSerializable
    {
        ...
        internal static AzureSqlMITableDataset DeserializeAzureSqlMITableDataset(JsonElement element)
        {
            ...
            return new AzureSqlMITableDataset(type, description, structure, schema, linkedServiceName, parameters, annotations, folder, additionalProperties, tableName, schema0, table);
        }
    }
}
