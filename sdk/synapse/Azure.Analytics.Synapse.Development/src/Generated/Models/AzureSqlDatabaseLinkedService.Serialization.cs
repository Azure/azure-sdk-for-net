...
namespace Azure.Analytics.Synapse.Development.Models
{
    public partial class AzureSqlDatabaseLinkedService : IUtf8JsonSerializable
    {
        ...
        internal static AzureSqlDatabaseLinkedService DeserializeAzureSqlDatabaseLinkedService(JsonElement element)
        {
            ...
            return new AzureSqlDatabaseLinkedService(type, connectVia, description, parameters, annotations, additionalProperties, connectionString, password, servicePrincipalId, servicePrincipalKey, tenant, encryptedCredential);
        }
    }
}
