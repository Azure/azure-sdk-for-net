...
namespace Azure.Analytics.Synapse.Development.Models
{
    public partial class AzureMLUpdateResourceActivity : IUtf8JsonSerializable
    {
        ...
        internal static AzureMLUpdateResourceActivity DeserializeAzureMLUpdateResourceActivity(JsonElement element)
        {
            ...
            return new AzureMLUpdateResourceActivity(name, type, description, dependsOn, userProperties, additionalProperties, linkedServiceName, policy, trainedModelName, trainedModelLinkedServiceName, trainedModelFilePath);
        }
    }
}
