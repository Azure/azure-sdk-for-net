...
namespace Azure.Analytics.Synapse.Development.Models
{
    public partial class OracleServiceCloudObjectDataset : IUtf8JsonSerializable
    {
        ...
        internal static OracleServiceCloudObjectDataset DeserializeOracleServiceCloudObjectDataset(JsonElement element)
        {
            ...
            return new OracleServiceCloudObjectDataset(type, description, structure, schema, linkedServiceName, parameters, annotations, folder, additionalProperties, tableName);
        }
    }
}
