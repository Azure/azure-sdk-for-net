...
namespace Azure.Analytics.Synapse.Development.Models
{
    public partial class MongoDbV2CollectionDataset : IUtf8JsonSerializable
    {
        ...
        internal static MongoDbV2CollectionDataset DeserializeMongoDbV2CollectionDataset(JsonElement element)
        {
            ...
            return new MongoDbV2CollectionDataset(type, description, structure, schema, linkedServiceName, parameters, annotations, folder, additionalProperties, collection);
        }
    }
}
