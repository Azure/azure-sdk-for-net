...
namespace Azure.Analytics.Synapse.Development.Models
{
    public partial class AzureFunctionActivity : IUtf8JsonSerializable
    {
        ...
        internal static AzureFunctionActivity DeserializeAzureFunctionActivity(JsonElement element)
        {
            ...
            return new AzureFunctionActivity(name, type, description, dependsOn, userProperties, additionalProperties, linkedServiceName, policy, method, functionName, headers, body);
        }
    }
}
