...
namespace Azure.Analytics.Synapse.Development.Models
{
    ...
    public partial class WebHookActivity : ControlActivity
    {
        ...
        public WebHookActivity(string name, object url) : base(name)
        {
            if (name == null)
            {
        ...
        internal WebHookActivity(string name, string type, string description, IList<ActivityDependency> dependsOn, IList<UserProperty> userProperties, IDictionary<string, object> additionalProperties, string method, object url, string timeout, object headers, object body, WebActivityAuthentication authentication, object reportStatusOnCallBack) : base(name, type, description, dependsOn, userProperties, additionalProperties)
        {
            Method = method;
            Url = url;
            Timeout = timeout;
