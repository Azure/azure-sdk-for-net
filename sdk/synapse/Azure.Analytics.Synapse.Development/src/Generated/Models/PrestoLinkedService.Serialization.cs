...
namespace Azure.Analytics.Synapse.Development.Models
{
    public partial class PrestoLinkedService : IUtf8JsonSerializable
    {
        ...
        internal static PrestoLinkedService DeserializePrestoLinkedService(JsonElement element)
        {
            ...
            return new PrestoLinkedService(type, connectVia, description, parameters, annotations, additionalProperties, host, serverVersion, catalog, port, authenticationType, username, password, enableSsl, trustedCertPath, useSystemTrustStore, allowHostNameCNMismatch, allowSelfSignedServerCert, timeZoneID, encryptedCredential);
        }
    }
}
