...
namespace Azure.Analytics.Synapse.Development.Models
{
    public partial class MarketoLinkedService : IUtf8JsonSerializable
    {
        ...
        internal static MarketoLinkedService DeserializeMarketoLinkedService(JsonElement element)
        {
            ...
            return new MarketoLinkedService(type, connectVia, description, parameters, annotations, additionalProperties, endpoint, clientId, clientSecret, useEncryptedEndpoints, useHostVerification, usePeerVerification, encryptedCredential);
        }
    }
}
