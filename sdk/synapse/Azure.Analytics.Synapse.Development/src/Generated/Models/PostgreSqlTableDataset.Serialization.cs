...
namespace Azure.Analytics.Synapse.Development.Models
{
    public partial class PostgreSqlTableDataset : IUtf8JsonSerializable
    {
        ...
        internal static PostgreSqlTableDataset DeserializePostgreSqlTableDataset(JsonElement element)
        {
            ...
            return new PostgreSqlTableDataset(type, description, structure, schema, linkedServiceName, parameters, annotations, folder, additionalProperties, tableName, table, schema0);
        }
    }
}
