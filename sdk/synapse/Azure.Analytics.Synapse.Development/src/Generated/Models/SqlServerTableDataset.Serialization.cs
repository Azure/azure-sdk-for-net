...
namespace Azure.Analytics.Synapse.Development.Models
{
    public partial class SqlServerTableDataset : IUtf8JsonSerializable
    {
        ...
        internal static SqlServerTableDataset DeserializeSqlServerTableDataset(JsonElement element)
        {
            ...
            return new SqlServerTableDataset(type, description, structure, schema, linkedServiceName, parameters, annotations, folder, additionalProperties, tableName, schema0, table);
        }
    }
}
