...
namespace Azure.Analytics.Synapse.Development.Models
{
    public partial class Office365Dataset : IUtf8JsonSerializable
    {
        ...
        internal static Office365Dataset DeserializeOffice365Dataset(JsonElement element)
        {
            ...
            return new Office365Dataset(type, description, structure, schema, linkedServiceName, parameters, annotations, folder, additionalProperties, tableName, predicate);
        }
    }
}
