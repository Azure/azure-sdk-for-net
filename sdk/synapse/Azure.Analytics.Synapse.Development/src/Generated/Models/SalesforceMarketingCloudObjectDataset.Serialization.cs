...
namespace Azure.Analytics.Synapse.Development.Models
{
    public partial class SalesforceMarketingCloudObjectDataset : IUtf8JsonSerializable
    {
        ...
        internal static SalesforceMarketingCloudObjectDataset DeserializeSalesforceMarketingCloudObjectDataset(JsonElement element)
        {
            ...
            return new SalesforceMarketingCloudObjectDataset(type, description, structure, schema, linkedServiceName, parameters, annotations, folder, additionalProperties, tableName);
        }
    }
}
