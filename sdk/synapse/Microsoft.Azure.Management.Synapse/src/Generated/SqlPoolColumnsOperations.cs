...
namespace Microsoft.Azure.Management.Synapse
{
    ...
    /// </summary>
    internal partial class SqlPoolColumnsOperations : IServiceOperations<SynapseManagementClient>, ISqlPoolColumnsOperations
    {
        /// <summary>
        ...
        /// </return>
        public async Task<AzureOperationResponse<SqlPoolColumn>> GetWithHttpMessagesAsync(string resourceGroupName, string workspaceName, string sqlPoolName, string schemaName, string tableName, string columnName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Create Result
            var _result = new AzureOperationResponse<SqlPoolColumn>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<SqlPoolColumn>(_responseContent, Client.DeserializationSettings);
                }
