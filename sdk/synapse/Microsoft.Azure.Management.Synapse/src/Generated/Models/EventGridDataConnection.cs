...
namespace Microsoft.Azure.Management.Synapse.Models
{
    ...
    public partial class EventGridDataConnection : DataConnection
    {
        ...
        public EventGridDataConnection(string storageAccountResourceId, string eventHubResourceId, string consumerGroup, string id = default(string), string name = default(string), string type = default(string), string location = default(string), SystemData systemData = default(SystemData), string tableName = default(string), string mappingRuleName = default(string), string dataFormat = default(string), bool? ignoreFirstRecord = default(bool?), string blobStorageEventType = default(string), string provisioningState = default(string))
