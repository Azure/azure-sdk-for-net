...
namespace Microsoft.Azure.Management.Synapse.Models
{
    ...
    public partial class LibraryInfo
    {
        ...
        public LibraryInfo(string name = default(string), string path = default(string), string containerName = default(string), System.DateTime? uploadedTimestamp = default(System.DateTime?), string type = default(string))
        {
            Name = name;
            Path = path;
