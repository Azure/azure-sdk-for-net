...
namespace Microsoft.Azure.Management.Synapse.Models
{
    ...
    public partial class SqlPoolBlobAuditingPolicy : ProxyResource
    {
        ...
        /// </param>
        public SqlPoolBlobAuditingPolicy(BlobAuditingPolicyState state, string id = default(string), string name = default(string), string type = default(string), string kind = default(string), string storageEndpoint = default(string), string storageAccountAccessKey = default(string), int? retentionDays = default(int?), IList<string> auditActionsAndGroups = default(IList<string>), System.Guid? storageAccountSubscriptionId = default(System.Guid?), bool? isStorageSecondaryKeyInUse = default(bool?), bool? isAzureMonitorTargetEnabled = default(bool?))
            : base(id, name, type)
        {
            Kind = kind;
            State = state;
