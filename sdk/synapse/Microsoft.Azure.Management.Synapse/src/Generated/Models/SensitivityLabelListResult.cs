...
namespace Microsoft.Azure.Management.Synapse.Models
{
    ...
    public partial class SensitivityLabelListResult
    {
        ...
        /// results.</param>
        public SensitivityLabelListResult(IList<SensitivityLabel> value = default(IList<SensitivityLabel>), string nextLink = default(string))
        {
            Value = value;
            NextLink = nextLink;
            CustomInit();
        ...
        public IList<SensitivityLabel> Value { get; private set; }
