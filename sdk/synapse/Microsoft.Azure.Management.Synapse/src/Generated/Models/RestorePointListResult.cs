...
namespace Microsoft.Azure.Management.Synapse.Models
{
    ...
    public partial class RestorePointListResult
    {
        ...
        /// results.</param>
        public RestorePointListResult(IList<RestorePoint> value = default(IList<RestorePoint>), string nextLink = default(string))
        {
            Value = value;
            NextLink = nextLink;
            CustomInit();
        ...
        public IList<RestorePoint> Value { get; private set; }
