...
namespace Microsoft.Azure.Management.Synapse
{
    ...
    /// </summary>
    internal partial class SqlPoolRecommendedSensitivityLabelsOperations : IServiceOperations<SynapseManagementClient>, ISqlPoolRecommendedSensitivityLabelsOperations
    {
        /// <summary>
        ...
        /// </return>
        public async Task<AzureOperationResponse> UpdateWithHttpMessagesAsync(string resourceGroupName, string workspaceName, string sqlPoolName, RecommendedSensitivityLabelUpdateList parameters, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
