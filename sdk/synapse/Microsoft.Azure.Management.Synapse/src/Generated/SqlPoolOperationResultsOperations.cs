...
namespace Microsoft.Azure.Management.Synapse
{
    ...
    /// </summary>
    internal partial class SqlPoolOperationResultsOperations : IServiceOperations<SynapseManagementClient>, ISqlPoolOperationResultsOperations
    {
        /// <summary>
        ...
        /// </return>
        public async Task<AzureOperationResponse<object>> GetLocationHeaderResultWithHttpMessagesAsync(string resourceGroupName, string workspaceName, string sqlPoolName, string operationId, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
