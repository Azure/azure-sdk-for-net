...
namespace Microsoft.Azure.Management.Synapse
{
    ...
    public partial interface IIntegrationRuntimeObjectMetadataOperations
    {
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationResponse<SsisObjectMetadataStatusResponse>> BeginRefreshWithHttpMessagesAsync(string resourceGroupName, string workspaceName, string integrationRuntimeName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
    }
}
