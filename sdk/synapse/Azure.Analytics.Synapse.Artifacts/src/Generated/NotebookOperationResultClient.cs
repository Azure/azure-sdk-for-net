...
namespace Azure.Analytics.Synapse.Artifacts
{
    ...
    public partial class NotebookOperationResultClient
    {
        ...
        public NotebookOperationResultClient(Uri endpoint, TokenCredential credential, ArtifactsClientOptions options = null)
        {
            ...
            RestClient = new NotebookOperationResultRestClient(_clientDiagnostics, _pipeline, endpoint, options.Version);
        }
        ...
        internal NotebookOperationResultClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Uri endpoint, string apiVersion = "2021-06-01-preview")
        {
            RestClient = new NotebookOperationResultRestClient(clientDiagnostics, pipeline, endpoint, apiVersion);
