...
namespace Azure.Analytics.Synapse.Artifacts
{
    internal partial class MetastoreRestClient
    {
        ...
        internal HttpMessage CreateRegisterRequest(string id, MetastoreRegisterObject registerBody)
        {
            ...
            ((IJsonModel<MetastoreRegisterObject>)registerBody).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
        ...
        internal HttpMessage CreateUpdateRequest(string id, MetastoreUpdateObject updateBody)
        {
            ...
            request.Headers.Add("Content-Type", "application/json");
            var content = new Utf8JsonRequestContent();
            ((IJsonModel<MetastoreUpdateObject>)updateBody).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
            request.Content = content;
            return message;
        }
