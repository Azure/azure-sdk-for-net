...
namespace Azure.Analytics.Synapse.Artifacts
{
    ...
    public partial class NotebookRenameNotebookOperation : Operation
    {
        ...
        internal NotebookRenameNotebookOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            ...
            _operation = new OperationInternal(nextLinkOperation, clientDiagnostics, response, "NotebookRenameNotebookOperation");
        }
