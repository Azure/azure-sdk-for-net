...
namespace Azure.Analytics.Synapse.Artifacts
{
    internal partial class WorkspaceGitRepoManagementRestClient
    {
        ...
        public WorkspaceGitRepoManagementRestClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Uri endpoint, string apiVersion = "2019-06-01-preview")
        {
            if (endpoint == null)
            {
