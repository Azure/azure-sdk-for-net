...
namespace Azure.Analytics.Synapse.Artifacts
{
    ...
    public partial class NotebookCreateOrUpdateNotebookOperation : Operation<NotebookResource>, Core.IOperationSource<NotebookResource>
    {
        ...
        {
            IOperation<NotebookResource> nextLinkOperation = Core.NextLinkOperationImplementation.Create(this, pipeline, request.Method, request.Uri.ToUri(), response, Core.OperationFinalStateVia.Location);
