...
namespace Azure.Analytics.Synapse.Artifacts
{
    ...
    public partial class NotebookCreateOrUpdateNotebookOperation : Operation<NotebookResource>, IOperationSource<NotebookResource>
    {
        ...
        {
            IOperation<NotebookResource> nextLinkOperation = NextLinkOperationImplementation.Create(this, pipeline, request.Method, request.Uri.ToUri(), response, Core.OperationFinalStateVia.Location);
