...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public static partial class ArtifactsModelFactory
    {
        ...
        /// <returns> A new <see cref="Models.CloudErrorAutoGenerated2"/> instance for mocking. </returns>
        public static CloudErrorAutoGenerated2 CloudErrorAutoGenerated2(string code = null, string message = null, string target = null, IEnumerable<CloudErrorAutoGenerated2> details = null)
        {
            details ??= new List<CloudErrorAutoGenerated2>();

            return new CloudErrorAutoGenerated2(code, message, target, details?.ToList());
        }
        ...
        public static OperationResult OperationResult(string status = null, string code = null, string message = null, string target = null, IEnumerable<CloudErrorAutoGenerated2> details = null)
        {
            details ??= new List<CloudErrorAutoGenerated2>();
