...
namespace Azure.Analytics.Synapse.Artifacts
{
    ...
    public partial class DataFlowDebugSessionExecuteCommandOperation : Operation<DataFlowDebugCommandResponse>, Core.IOperationSource<DataFlowDebugCommandResponse>
    {
        ...
        {
            IOperation<DataFlowDebugCommandResponse> nextLinkOperation = Core.NextLinkOperationImplementation.Create(this, pipeline, request.Method, request.Uri.ToUri(), response, Core.OperationFinalStateVia.Location);
