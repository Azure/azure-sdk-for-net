...
namespace Azure.Analytics.Synapse.Artifacts
{
    ...
    public partial class WorkspaceClient
    {
        ...
        public WorkspaceClient(string endpoint, TokenCredential credential, ArtifactsClientOptions options = null)
        {
            if (endpoint == null)
            {
        ...
        internal WorkspaceClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string endpoint, string apiVersion = "2019-06-01-preview")
        {
