...
namespace Azure.Analytics.Synapse.Artifacts
{
    ...
    public partial class LibraryDeleteOperation : Operation
    {
        ...
        internal LibraryDeleteOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            ...
            _operation = new OperationInternal(nextLinkOperation, clientDiagnostics, response, "LibraryDeleteOperation");
        }
