...
namespace Azure.Analytics.Synapse.Artifacts
{
    ...
    public partial class IntegrationRuntimesClient
    {
        ...
        public IntegrationRuntimesClient(string endpoint, TokenCredential credential, ArtifactsClientOptions options = null)
        {
            if (endpoint == null)
            {
        ...
        internal IntegrationRuntimesClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string endpoint, string apiVersion = "2019-06-01-preview")
        {
