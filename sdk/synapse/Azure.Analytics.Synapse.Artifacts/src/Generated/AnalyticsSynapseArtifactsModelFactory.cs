...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public static partial class AnalyticsSynapseArtifactsModelFactory
    {
        ...
        public static CloudError CloudError(string code = null, string message = null, string target = null, IEnumerable<CloudError> details = null)
        {
            ...
            return new CloudError(code, message, target, details?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new LinkConnectionDetailedStatus(id, name, isApplyingChanges, isPartiallyFailed, startTime, stopTime, status, continuousRunId, error, refreshStatus, landingZoneCredentialExpireTime, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new LinkConnectionRefreshStatus(refreshStatus, errorMessage, new Dictionary<string, BinaryData>());
        }
        ...
        public static LinkTableListResponse LinkTableListResponse(IEnumerable<LinkTableResource> value = null)
        {
            ...
            return new LinkTableListResponse(value?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new LinkTableResource(id, name, source, target, new Dictionary<string, BinaryData>());
        }
        ...
        public static LinkConnectionQueryTableStatus LinkConnectionQueryTableStatus(IEnumerable<LinkTableStatus> value = null, object continuationToken = null)
        {
            ...
            return new LinkConnectionQueryTableStatus(value?.ToList(), continuationToken, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new LinkTableStatus(id, status, errorMessage, startTime, stopTime, linkTableId, errorCode, lastProcessedData, lastTransactionCommitTime, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new RunNotebookResponse(message, result, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new RunNotebookResult(runId, runStatus, lastCheckedOn, sessionId, sparkPool, sessionDetail, exitValue, error, new Dictionary<string, BinaryData>());
        }
        ...
        public static RunNotebookError RunNotebookError(string ename = null, string evalue = null, IEnumerable<string> traceback = null)
        {
            ...
            return new RunNotebookError(ename, evalue, traceback?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new RunNotebookSnapshotResponse(message, result, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new RunNotebookSnapshotResult(snapshot, error, runId, runStatus, lastCheckedOn, sessionId, sparkPool, new Dictionary<string, BinaryData>());
        }
        ...
        public static RunNotebookSnapshot RunNotebookSnapshot(string exitValue = null, string id = null, string notebook = null, RunNotebookSparkSessionOptions sessionOptions = null, bool? honorSessionTimeToLive = null, string sessionId = null, string sparkPool = null, IReadOnlyDictionary<string, RunNotebookParameter> parameters = null, NotebookResource notebookContent = null)
        {
            ...
            return new RunNotebookSnapshot(exitValue, id, notebook, sessionOptions, honorSessionTimeToLive, sessionId, sparkPool, parameters, notebookContent, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new NotebookResource(id, name, type, etag, properties, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MetastoreRegistrationResponse(status, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MetastoreRequestSuccessResponse(status, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MetastoreUpdationResponse(status, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SparkConfigurationResource(id, name, type, new Dictionary<string, BinaryData>(), etag, properties);
        }
        ...
        {
            return new SubResource(id, name, type, new Dictionary<string, BinaryData>(), etag);
        }
        ...
        {
            return new AzureEntityResource(id, name, type, new Dictionary<string, BinaryData>(), etag);
        }
        ...
        {
            return new Resource(id, name, type, new Dictionary<string, BinaryData>());
        }
        ...
        public static BigDataPoolResourceInfoListResult BigDataPoolResourceInfoListResult(string nextLink = null, IEnumerable<BigDataPoolResourceInfo> value = null)
        {
            ...
            return new BigDataPoolResourceInfoListResult(nextLink, value?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static BigDataPoolResourceInfo BigDataPoolResourceInfo(string id = null, string name = null, string type = null, IDictionary<string, string> tags = null, string location = null, string provisioningState = null, AutoScaleProperties autoScale = null, DateTimeOffset? creationDate = null, AutoPauseProperties autoPause = null, bool? isComputeIsolationEnabled = null, bool? sessionLevelPackagesEnabled = null, int? cacheSize = null, DynamicExecutorAllocation dynamicExecutorAllocation = null, string sparkEventsFolder = null, int? nodeCount = null, LibraryRequirements libraryRequirements = null, IEnumerable<LibraryInfo> customLibraries = null, LibraryRequirements sparkConfigProperties = null, string sparkVersion = null, string defaultSparkLogFolder = null, NodeSize? nodeSize = null, NodeSizeFamily? nodeSizeFamily = null, DateTimeOffset? lastSucceededTimestamp = null)
        {
            ...
            return new BigDataPoolResourceInfo(id, name, type, new Dictionary<string, BinaryData>(), tags, location, provisioningState, autoScale, creationDate, autoPause, isComputeIsolationEnabled, sessionLevelPackagesEnabled, cacheSize, dynamicExecutorAllocation, sparkEventsFolder, nodeCount, libraryRequirements, customLibraries?.ToList(), sparkConfigProperties, sparkVersion, defaultSparkLogFolder, nodeSize, nodeSizeFamily, lastSucceededTimestamp);
        }
        ...
        {
            return new LibraryRequirements(time, content, filename, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new LibraryInfo(name, path, containerName, uploadedTimestamp, type, provisioningStatus, creatorId, new Dictionary<string, BinaryData>());
        }
        ...
        public static TrackedResource TrackedResource(string id = null, string name = null, string type = null, IDictionary<string, string> tags = null, string location = null)
        {
            ...
            return new TrackedResource(id, name, type, new Dictionary<string, BinaryData>(), tags, location);
        }
        ...
        {
            return new DataFlowResource(id, name, type, new Dictionary<string, BinaryData>(), etag, properties);
        }
        ...
        {
            return new CreateDataFlowDebugSessionResponse(sessionId, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AddDataFlowToDebugSessionResponse(jobVersion, new Dictionary<string, BinaryData>());
        }
        ...
        public static DataFlowDebugCommandPayload DataFlowDebugCommandPayload(string streamName = null, int? rowLimits = null, IEnumerable<string> columns = null, string expression = null)
        {
            ...
            return new DataFlowDebugCommandPayload(streamName, rowLimits, columns?.ToList(), expression, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DataFlowDebugCommandResponse(status, data, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DatasetResource(id, name, type, new Dictionary<string, BinaryData>(), etag, properties);
        }
        ...
        {
            return new GitHubAccessTokenResponse(gitHubAccessToken, new Dictionary<string, BinaryData>());
        }
        ...
        public static IntegrationRuntimeListResponse IntegrationRuntimeListResponse(IEnumerable<IntegrationRuntimeResource> value = null, string nextLink = null)
        {
            ...
            return new IntegrationRuntimeListResponse(value?.ToList(), nextLink, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new IntegrationRuntimeResource(id, name, type, new Dictionary<string, BinaryData>(), etag, properties);
        }
        ...
        {
            return new LibraryResource(id, name, type, new Dictionary<string, BinaryData>(), etag, properties);
        }
        ...
        {
            return new LibraryResourceProperties(name, path, containerName, uploadedTimestamp, type, provisioningStatus, creatorId, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new LibraryResourceInfo(id, recordId, state, created, changed, type, name, operationId, artifactId, new Dictionary<string, BinaryData>());
        }
        ...
        public static OperationResult OperationResult(string status = null, string code = null, string message = null, string target = null, IEnumerable<CloudError> details = null)
        {
            ...
            return new OperationResult(status, code, message, target, details?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new LinkedServiceResource(id, name, type, new Dictionary<string, BinaryData>(), etag, properties);
        }
        ...
        {
            return new CreateRunResponse(runId, new Dictionary<string, BinaryData>());
        }
        ...
        public static RunFilterParameters RunFilterParameters(string continuationToken = null, DateTimeOffset lastUpdatedAfter = default, DateTimeOffset lastUpdatedBefore = default, IEnumerable<RunQueryFilter> filters = null, IEnumerable<RunQueryOrderBy> orderBy = null)
        {
            ...
            return new RunFilterParameters(continuationToken, lastUpdatedAfter, lastUpdatedBefore, filters?.ToList(), orderBy?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static PipelineRunsQueryResponse PipelineRunsQueryResponse(IEnumerable<PipelineRun> value = null, string continuationToken = null)
        {
            ...
            return new PipelineRunsQueryResponse(value?.ToList(), continuationToken, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new PipelineRunInvokedBy(name, id, invokedByType, new Dictionary<string, BinaryData>());
        }
        ...
        public static ActivityRunsQueryResponse ActivityRunsQueryResponse(IEnumerable<ActivityRun> value = null, string continuationToken = null)
        {
            ...
            return new ActivityRunsQueryResponse(value?.ToList(), continuationToken, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SparkJobDefinitionResource(id, name, type, new Dictionary<string, BinaryData>(), etag, properties);
        }
        ...
        public static SqlPoolInfoListResult SqlPoolInfoListResult(string nextLink = null, IEnumerable<SqlPool> value = null)
        {
            ...
            return new SqlPoolInfoListResult(nextLink, value?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static SqlPool SqlPool(string id = null, string name = null, string type = null, IDictionary<string, string> tags = null, string location = null, Sku sku = null, long? maxSizeBytes = null, string collation = null, string sourceDatabaseId = null, string recoverableDatabaseId = null, string provisioningState = null, string status = null, string restorePointInTime = null, CreateMode? createMode = null, DateTimeOffset? creationDate = null)
        {
            ...
            return new SqlPool(id, name, type, new Dictionary<string, BinaryData>(), tags, location, sku, maxSizeBytes, collation, sourceDatabaseId, recoverableDatabaseId, provisioningState, status, restorePointInTime, createMode, creationDate);
        }
        ...
        {
            return new SqlScriptResource(id, name, type, etag, properties, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new TriggerResource(id, name, type, new Dictionary<string, BinaryData>(), etag, properties);
        }
        ...
        {
            return new TriggerSubscriptionOperationStatus(triggerName, status, new Dictionary<string, BinaryData>());
        }
        ...
        public static TriggerRunsQueryResponse TriggerRunsQueryResponse(IEnumerable<TriggerRun> value = null, string continuationToken = null)
        {
            ...
            return new TriggerRunsQueryResponse(value?.ToList(), continuationToken, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new PrivateEndpointConnection(id, name, type, new Dictionary<string, BinaryData>(), privateEndpoint, connectionState, provisioningState);
        }
        ...
        {
            return new PrivateEndpoint(id, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new PrivateLinkServiceConnectionState(status, description, actionsRequired, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ProxyResource(id, name, type, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new EncryptionDetails(doubleEncryptionEnabled, cmk, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new CustomerManagedKeyDetails(status, key, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ManagedIdentity(principalId, tenantId, type, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new WorkspaceIdentity(type, principalId, tenantId, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ExposureControlResponse(featureName, value, new Dictionary<string, BinaryData>());
        }
        ...
        public static RerunTriggerListResponse RerunTriggerListResponse(IEnumerable<RerunTriggerResource> value = null, string nextLink = null)
        {
            ...
            return new RerunTriggerListResponse(value?.ToList(), nextLink, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new RerunTriggerResource(id, name, type, new Dictionary<string, BinaryData>(), etag, properties);
        }
        ...
        {
            return new ManagedVirtualNetworkReference(type, referenceName, new Dictionary<string, BinaryData>());
        }
    }
}
