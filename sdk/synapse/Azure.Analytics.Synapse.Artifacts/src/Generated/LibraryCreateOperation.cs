...
namespace Azure.Analytics.Synapse.Artifacts
{
    ...
    public partial class LibraryCreateOperation : Operation
    {
        ...
        internal LibraryCreateOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            ...
            _operation = new OperationInternal(nextLinkOperation, clientDiagnostics, response, "LibraryCreateOperation");
        }
