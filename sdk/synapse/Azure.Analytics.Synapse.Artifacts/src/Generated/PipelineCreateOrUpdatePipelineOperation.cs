...
namespace Azure.Analytics.Synapse.Artifacts
{
    ...
    public partial class PipelineCreateOrUpdatePipelineOperation : Operation<PipelineResource>, Core.IOperationSource<PipelineResource>
    {
        ...
        {
            IOperation<PipelineResource> nextLinkOperation = Core.NextLinkOperationImplementation.Create(this, pipeline, request.Method, request.Uri.ToUri(), response, Core.OperationFinalStateVia.Location);
