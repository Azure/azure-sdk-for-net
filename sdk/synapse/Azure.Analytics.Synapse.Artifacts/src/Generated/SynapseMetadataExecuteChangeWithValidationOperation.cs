...
namespace Azure.Analytics.Synapse.Artifacts
{
    ...
    public partial class SynapseMetadataExecuteChangeWithValidationOperation : Operation
    {
        private readonly OperationInternal _operation;

        /// <summary> Initializes a new instance of SynapseMetadataExecuteChangeWithValidationOperation for mocking. </summary>
        protected SynapseMetadataExecuteChangeWithValidationOperation()
        {
        }

        internal SynapseMetadataExecuteChangeWithValidationOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            ...
            _operation = new OperationInternal(nextLinkOperation, clientDiagnostics, response, "SynapseMetadataExecuteChangeWithValidationOperation");
        }
