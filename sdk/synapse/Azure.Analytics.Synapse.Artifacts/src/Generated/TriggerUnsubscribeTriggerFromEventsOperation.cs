...
namespace Azure.Analytics.Synapse.Artifacts
{
    ...
    public partial class TriggerUnsubscribeTriggerFromEventsOperation : Operation<TriggerSubscriptionOperationStatus>, Core.IOperationSource<TriggerSubscriptionOperationStatus>
    {
        ...
        {
            IOperation<TriggerSubscriptionOperationStatus> nextLinkOperation = Core.NextLinkOperationImplementation.Create(this, pipeline, request.Method, request.Uri.ToUri(), response, Core.OperationFinalStateVia.Location);
