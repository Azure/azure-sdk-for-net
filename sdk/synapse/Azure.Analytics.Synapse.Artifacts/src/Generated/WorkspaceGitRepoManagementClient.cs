...
namespace Azure.Analytics.Synapse.Artifacts
{
    ...
    public partial class WorkspaceGitRepoManagementClient
    {
        ...
        public WorkspaceGitRepoManagementClient(Uri endpoint, TokenCredential credential, ArtifactsClientOptions options = null)
        {
            ...
            RestClient = new WorkspaceGitRepoManagementRestClient(_clientDiagnostics, _pipeline, endpoint);
        }
        ...
        {
            RestClient = new WorkspaceGitRepoManagementRestClient(clientDiagnostics, pipeline, endpoint);
