...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    internal partial class UnknownActivity : IUtf8JsonSerializable
    {
        ...
        internal static UnknownActivity DeserializeUnknownActivity(JsonElement element)
        {
            ...
            return new UnknownActivity(name, type, description.Value, Optional.ToNullable(state), Optional.ToNullable(onInactiveMarkAs), dependsOn ?? new ChangeTrackingList<ActivityDependency>(), userProperties ?? new ChangeTrackingList<UserProperty>(), additionalProperties);
        }
    }
}
