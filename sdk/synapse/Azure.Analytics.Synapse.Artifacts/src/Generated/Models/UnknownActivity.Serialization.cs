...
{
    internal partial class UnknownActivity : Core.IUtf8JsonSerializable
    {
        ...
        internal static UnknownActivity DeserializeUnknownActivity(JsonElement element)
        {
            ...
            return new UnknownActivity(name, type, description.Value, Core.Optional.ToNullable(state), Core.Optional.ToNullable(onInactiveMarkAs), Core.Optional.ToList(dependsOn), Core.Optional.ToList(userProperties), additionalProperties);
        }
    }
}
