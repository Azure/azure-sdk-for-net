...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class ParquetDataset : IUtf8JsonSerializable
    {
        ...
        internal static ParquetDataset DeserializeParquetDataset(JsonElement element)
        {
            ...
            return new ParquetDataset(type, description.HasValue ? description.Value : null, structure.HasValue ? structure.Value : null, schema.HasValue ? schema.Value : null, linkedServiceName, new ChangeTrackingDictionary<string, ParameterSpecification>(parameters), new ChangeTrackingList<object>(annotations), folder.HasValue ? folder.Value : null, additionalProperties, location.HasValue ? location.Value : null, compressionCodec.HasValue ? compressionCodec.Value : (ParquetCompressionCodec?)null);
        }
    }
}
