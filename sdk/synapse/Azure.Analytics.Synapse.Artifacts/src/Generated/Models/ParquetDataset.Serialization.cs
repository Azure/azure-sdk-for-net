...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ParquetDataset>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ParquetDataset>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ParquetDataset>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ParquetDataset>)} interface");
            }
        ...
        string IPersistableModel<ParquetDataset>.GetWireFormat(ModelReaderWriterOptions options) => "J";
