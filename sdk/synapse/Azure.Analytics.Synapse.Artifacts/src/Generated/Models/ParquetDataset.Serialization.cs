...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class ParquetDataset : IUtf8JsonSerializable, IJsonModel<ParquetDataset>
    {
        ...
        void IJsonModel<ParquetDataset>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(ParquetDataset)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ParquetDataset>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(ParquetDataset)} does not support '{options.Format}' format.");
            }
        }
