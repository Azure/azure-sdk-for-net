...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class ParquetDataset : Core.IUtf8JsonSerializable
    {
        void Core.IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            if (Core.Optional.IsDefined(CompressionCodec))
            {
        ...
        internal static ParquetDataset DeserializeParquetDataset(JsonElement element)
        {
            ...
            Core.Optional<object> compressionCodec = default;
            ...
            return new ParquetDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), folder.Value, additionalProperties, location.Value, compressionCodec.Value);
        }
