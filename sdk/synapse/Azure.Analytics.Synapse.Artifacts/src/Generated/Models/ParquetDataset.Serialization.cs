    ...
    public partial class ParquetDataset : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            if (Optional.IsDefined(Location))
            {
                ...
                writer.WriteObjectValue<DatasetLocation>(Location);
            }
        ...
        internal static new ParquetDataset FromResponse(Response response)
        {
        ...
        internal override RequestContent ToRequestContent()
        {
            ...
            content.JsonWriter.WriteObjectValue<ParquetDataset>(this);
            return content;
        }
        ...
        internal partial class ParquetDatasetConverter : JsonConverter<ParquetDataset>
        {
            ...
            {
                writer.WriteObjectValue<ParquetDataset>(model);
            }
