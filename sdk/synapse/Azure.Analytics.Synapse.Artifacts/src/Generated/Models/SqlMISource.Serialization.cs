...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SqlMISource>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SqlMISource>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SqlMISource>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SqlMISource>)} interface");
            }
        ...
        string IPersistableModel<SqlMISource>.GetWireFormat(ModelReaderWriterOptions options) => "J";
