...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class BlobSink : IUtf8JsonSerializable, IJsonModel<BlobSink>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<BlobSink>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<BlobSink>)} interface");
            }
