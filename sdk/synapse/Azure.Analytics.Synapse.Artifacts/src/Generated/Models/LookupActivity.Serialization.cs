...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class LookupActivity : Core.IUtf8JsonSerializable
    {
        ...
        internal static LookupActivity DeserializeLookupActivity(JsonElement element)
        {
            ...
            Core.Optional<object> firstRowOnly = default;
            ...
            return new LookupActivity(name, type, description.Value, Core.Optional.ToNullable(state), Core.Optional.ToNullable(onInactiveMarkAs), Core.Optional.ToList(dependsOn), Core.Optional.ToList(userProperties), additionalProperties, linkedServiceName.Value, policy.Value, source, dataset, firstRowOnly.Value);
        }
