...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LookupActivity>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<LookupActivity>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<LookupActivity>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<LookupActivity>)} interface");
            }
        ...
        string IPersistableModel<LookupActivity>.GetWireFormat(ModelReaderWriterOptions options) => "J";
