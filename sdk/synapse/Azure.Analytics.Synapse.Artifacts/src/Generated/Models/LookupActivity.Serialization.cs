...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class LookupActivity : IUtf8JsonSerializable
    {
        ...
        internal static LookupActivity DeserializeLookupActivity(JsonElement element)
        {
            ...
            return new LookupActivity(name, type, description.HasValue ? description.Value : null, new ChangeTrackingList<ActivityDependency>(dependsOn), new ChangeTrackingList<UserProperty>(userProperties), additionalProperties, linkedServiceName.HasValue ? linkedServiceName.Value : null, policy.HasValue ? policy.Value : null, source, dataset, firstRowOnly.HasValue ? firstRowOnly.Value : null);
        }
    }
}
