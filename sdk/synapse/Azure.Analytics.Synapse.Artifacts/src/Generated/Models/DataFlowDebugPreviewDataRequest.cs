...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class DataFlowDebugPreviewDataRequest
    {
        ...
        internal DataFlowDebugPreviewDataRequest(string sessionId, string dataFlowName, string streamName, int? rowLimits, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            SessionId = sessionId;
