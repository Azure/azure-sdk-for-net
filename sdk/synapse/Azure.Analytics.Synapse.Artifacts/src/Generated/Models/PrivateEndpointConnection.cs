...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class PrivateEndpointConnection : ProxyResource
    {
        ...
        internal PrivateEndpointConnection(string id, string name, string type, IDictionary<string, BinaryData> serializedAdditionalRawData, PrivateEndpoint privateEndpoint, PrivateLinkServiceConnectionState connectionState, string provisioningState) : base(id, name, type, serializedAdditionalRawData)
        {
