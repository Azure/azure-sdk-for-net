...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class PrivateEndpointConnection : ProxyResource
    {
        ...
        internal PrivateEndpointConnection(string id, string name, string type, PrivateEndpoint privateEndpoint, PrivateLinkServiceConnectionState connectionState, string provisioningState, Dictionary<string, BinaryData> rawData) : base(id, name, type, rawData)
        {
