...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class AmazonRedshiftLinkedService : IUtf8JsonSerializable
    {
        ...
        internal static AmazonRedshiftLinkedService DeserializeAmazonRedshiftLinkedService(JsonElement element)
        {
            ...
            return new AmazonRedshiftLinkedService(type, connectVia.HasValue ? connectVia.Value : null, description.HasValue ? description.Value : null, new ChangeTrackingDictionary<string, ParameterSpecification>(parameters), new ChangeTrackingList<object>(annotations), additionalProperties, server, username.HasValue ? username.Value : null, password.HasValue ? password.Value : null, database, port.HasValue ? port.Value : null, encryptedCredential.HasValue ? encryptedCredential.Value : null);
        }
    }
}
