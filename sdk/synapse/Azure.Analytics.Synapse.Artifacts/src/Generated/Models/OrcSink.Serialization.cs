...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<OrcSink>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<OrcSink>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<OrcSink>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<OrcSink>)} interface");
            }
        ...
        string IPersistableModel<OrcSink>.GetWireFormat(ModelReaderWriterOptions options) => "J";
