    ...
    public partial class OrcSink : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            if (Optional.IsDefined(FormatSettings))
            {
                ...
                writer.WriteObjectValue<OrcWriteSettings>(FormatSettings);
            }
        ...
        internal static new OrcSink FromResponse(Response response)
        {
        ...
        internal override RequestContent ToRequestContent()
        {
            ...
            content.JsonWriter.WriteObjectValue<OrcSink>(this);
            return content;
        }
        ...
        internal partial class OrcSinkConverter : JsonConverter<OrcSink>
        {
            ...
            {
                writer.WriteObjectValue<OrcSink>(model);
            }
