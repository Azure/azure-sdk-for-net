...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class SapHanaPartitionSettings : IUtf8JsonSerializable, IJsonModel<SapHanaPartitionSettings>
    {
        ...
        void IJsonModel<SapHanaPartitionSettings>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(SapHanaPartitionSettings)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<SapHanaPartitionSettings>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(SapHanaPartitionSettings)} does not support '{options.Format}' format.");
            }
        }
