...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class MarketoSource : IUtf8JsonSerializable
    {
        ...
        internal static MarketoSource DeserializeMarketoSource(JsonElement element)
        {
            ...
            return new MarketoSource(type, sourceRetryCount.Value, sourceRetryWait.Value, maxConcurrentConnections.Value, additionalProperties, queryTimeout.Value, query.Value);
        }
