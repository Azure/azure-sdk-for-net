...
{
    [JsonConverter(typeof(MarketoSourceConverter))]
    public partial class MarketoSource : IUtf8JsonSerializable
    {
        ...
        internal static MarketoSource DeserializeMarketoSource(JsonElement element)
        {
            ...
            return new MarketoSource(type, sourceRetryCount.Value, sourceRetryWait.Value, maxConcurrentConnections.Value, additionalProperties, queryTimeout.Value, additionalColumns.Value, query.Value);
        }

        internal partial class MarketoSourceConverter : JsonConverter<MarketoSource>
        {
            ...
            public override MarketoSource Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
            {
                ...
                return DeserializeMarketoSource(document.RootElement);
            }
        }
    }
}
