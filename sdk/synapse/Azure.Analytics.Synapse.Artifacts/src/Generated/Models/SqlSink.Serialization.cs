...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SqlSink>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SqlSink>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SqlSink>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SqlSink>)} interface");
            }
        ...
        string IPersistableModel<SqlSink>.GetWireFormat(ModelReaderWriterOptions options) => "J";
