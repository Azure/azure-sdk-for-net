...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class FtpServerLinkedService : Core.IUtf8JsonSerializable
    {
        ...
        internal static FtpServerLinkedService DeserializeFtpServerLinkedService(JsonElement element)
        {
            ...
            Core.Optional<FtpAuthenticationType> authenticationType = default;
            ...
            return new FtpServerLinkedService(type, connectVia.Value, description.Value, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), additionalProperties, host, port.Value, Core.Optional.ToNullable(authenticationType), userName.Value, password.Value, encryptedCredential.Value, enableSsl.Value, enableServerCertificateValidation.Value);
        }
