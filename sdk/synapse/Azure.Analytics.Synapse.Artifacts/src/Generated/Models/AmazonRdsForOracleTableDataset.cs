...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class AmazonRdsForOracleTableDataset : Dataset
    {
        ...
        public AmazonRdsForOracleTableDataset(LinkedServiceReferenceAutoGenerated linkedServiceName) : base(linkedServiceName)
        {
        ...
        internal AmazonRdsForOracleTableDataset(string type, string description, object structure, object schema, LinkedServiceReferenceAutoGenerated linkedServiceName, IDictionary<string, ParameterSpecification> parameters, IList<object> annotations, DatasetFolder folder, IDictionary<string, object> additionalProperties, object schemaTypePropertiesSchema, object table) : base(type, description, structure, schema, linkedServiceName, parameters, annotations, folder, additionalProperties)
        {
