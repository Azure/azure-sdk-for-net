...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class ConcurObjectDataset : IUtf8JsonSerializable
    {
        ...
        internal static ConcurObjectDataset DeserializeConcurObjectDataset(JsonElement element)
        {
            ...
            return new ConcurObjectDataset(type, description.HasValue ? description.Value : null, structure.HasValue ? structure.Value : null, schema.HasValue ? schema.Value : null, linkedServiceName, new ChangeTrackingDictionary<string, ParameterSpecification>(parameters), new ChangeTrackingList<object>(annotations), folder.HasValue ? folder.Value : null, additionalProperties, tableName.HasValue ? tableName.Value : null);
        }
    }
}
