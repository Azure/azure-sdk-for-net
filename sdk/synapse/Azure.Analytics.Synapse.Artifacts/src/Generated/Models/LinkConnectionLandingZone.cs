...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class LinkConnectionLandingZone
    {
        ...
        internal LinkConnectionLandingZone(LinkedServiceReference linkedService, string fileSystem, string folderPath, SecureString sasToken, Dictionary<string, BinaryData> rawData)
        {
