...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class AzurePostgreSqlTableDataset : IUtf8JsonSerializable
    {
        ...
        internal static AzurePostgreSqlTableDataset DeserializeAzurePostgreSqlTableDataset(JsonElement element)
        {
            ...
            return new AzurePostgreSqlTableDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, parameters ?? new ChangeTrackingDictionary<string, ParameterSpecification>(), annotations ?? new ChangeTrackingList<object>(), folder.Value, additionalProperties, tableName.Value, table.Value, schema0.Value);
        }
