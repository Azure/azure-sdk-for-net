...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class AmazonRdsForSqlServerLinkedService : IUtf8JsonSerializable
    {
        ...
        internal static AmazonRdsForSqlServerLinkedService DeserializeAmazonRdsForSqlServerLinkedService(JsonElement element)
        {
            ...
            return new AmazonRdsForSqlServerLinkedService(type, connectVia.Value, description.Value, Optional.ToDictionary(parameters), annotations ?? new ChangeTrackingList<object>(), additionalProperties, connectionString, userName.Value, password.Value, encryptedCredential.Value, alwaysEncryptedSettings.Value);
        }
