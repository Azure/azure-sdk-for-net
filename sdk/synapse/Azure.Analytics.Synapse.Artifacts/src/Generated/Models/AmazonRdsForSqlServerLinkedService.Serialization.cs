...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class AmazonRdsForSqlServerLinkedService : Core.IUtf8JsonSerializable
    {
        ...
        internal static AmazonRdsForSqlServerLinkedService DeserializeAmazonRdsForSqlServerLinkedService(JsonElement element)
        {
            ...
            return new AmazonRdsForSqlServerLinkedService(type, connectVia.Value, description.Value, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), additionalProperties, connectionString, userName.Value, password.Value, encryptedCredential.Value, alwaysEncryptedSettings.Value);
        }
