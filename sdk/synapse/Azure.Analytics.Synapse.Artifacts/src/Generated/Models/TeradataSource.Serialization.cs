...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class TeradataSource : IUtf8JsonSerializable
    {
        ...
        internal static TeradataSource DeserializeTeradataSource(JsonElement element)
        {
            ...
            return new TeradataSource(type, sourceRetryCount.Value, sourceRetryWait.Value, maxConcurrentConnections.Value, additionalProperties, queryTimeout.Value, query.Value, Optional.ToNullable(partitionOption), partitionSettings.Value);
        }
    }
}
