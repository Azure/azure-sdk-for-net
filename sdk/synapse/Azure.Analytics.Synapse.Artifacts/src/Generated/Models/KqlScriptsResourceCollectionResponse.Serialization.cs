...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<KqlScriptsResourceCollectionResponse>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<KqlScriptsResourceCollectionResponse>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<KqlScriptsResourceCollectionResponse>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<KqlScriptsResourceCollectionResponse>.GetWireFormat(ModelReaderWriterOptions options) => "J";
