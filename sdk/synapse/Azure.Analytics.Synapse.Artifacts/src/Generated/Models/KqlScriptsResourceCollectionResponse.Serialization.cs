...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    internal partial class KqlScriptsResourceCollectionResponse : IUtf8JsonSerializable, IJsonModel<KqlScriptsResourceCollectionResponse>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<KqlScriptsResourceCollectionResponse>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<KqlScriptsResourceCollectionResponse>)} interface");
            }
