...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class NotebookCellOutputItem
    {
        ...
        internal NotebookCellOutputItem(string name, int? executionCount, CellOutputType outputType, object text, object data, object metadata, Dictionary<string, BinaryData> rawData)
        {
            Name = name;
