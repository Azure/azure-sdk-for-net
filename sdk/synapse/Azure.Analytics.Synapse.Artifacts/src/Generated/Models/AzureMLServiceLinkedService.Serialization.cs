...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class AzureMLServiceLinkedService : IUtf8JsonSerializable
    {
        ...
        internal static AzureMLServiceLinkedService DeserializeAzureMLServiceLinkedService(JsonElement element)
        {
            ...
            return new AzureMLServiceLinkedService(type, connectVia.HasValue ? connectVia.Value : null, description.HasValue ? description.Value : null, new ChangeTrackingDictionary<string, ParameterSpecification>(parameters), new ChangeTrackingList<object>(annotations), additionalProperties, subscriptionId, resourceGroupName, mlWorkspaceName, servicePrincipalId.HasValue ? servicePrincipalId.Value : null, servicePrincipalKey.HasValue ? servicePrincipalKey.Value : null, tenant.HasValue ? tenant.Value : null, encryptedCredential.HasValue ? encryptedCredential.Value : null);
        }
    }
}
