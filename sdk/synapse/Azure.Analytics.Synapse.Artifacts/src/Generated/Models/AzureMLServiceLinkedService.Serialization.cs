...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class AzureMLServiceLinkedService : Core.IUtf8JsonSerializable
    {
        ...
        internal static AzureMLServiceLinkedService DeserializeAzureMLServiceLinkedService(JsonElement element)
        {
            ...
            return new AzureMLServiceLinkedService(type, connectVia.Value, description.Value, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), additionalProperties, subscriptionId, resourceGroupName, mlWorkspaceName, authentication.Value, servicePrincipalId.Value, servicePrincipalKey.Value, tenant.Value, encryptedCredential.Value);
        }
