...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class AmazonRdsForOracleLinkedService : Core.IUtf8JsonSerializable
    {
        ...
        internal static AmazonRdsForOracleLinkedService DeserializeAmazonRdsForOracleLinkedService(JsonElement element)
        {
            ...
            return new AmazonRdsForOracleLinkedService(type, connectVia.Value, description.Value, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), additionalProperties, connectionString, password.Value, encryptedCredential.Value);
        }
