...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class AmazonRdsForOracleLinkedService : IUtf8JsonSerializable
    {
        ...
        internal static AmazonRdsForOracleLinkedService DeserializeAmazonRdsForOracleLinkedService(JsonElement element)
        {
            ...
            return new AmazonRdsForOracleLinkedService(type, connectVia.Value, description.Value, parameters ?? new ChangeTrackingDictionary<string, ParameterSpecification>(), annotations ?? new ChangeTrackingList<object>(), additionalProperties, connectionString, password.Value, encryptedCredential.Value);
        }
