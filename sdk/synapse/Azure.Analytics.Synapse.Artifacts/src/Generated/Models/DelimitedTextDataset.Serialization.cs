...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class DelimitedTextDataset : IUtf8JsonSerializable
    {
        ...
        internal static DelimitedTextDataset DeserializeDelimitedTextDataset(JsonElement element)
        {
            ...
            return new DelimitedTextDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Optional.ToDictionary(parameters), annotations ?? new ChangeTrackingList<object>(), folder.Value, additionalProperties, location.Value, columnDelimiter.Value, rowDelimiter.Value, encodingName.Value, compressionCodec.Value, compressionLevel.Value, quoteChar.Value, escapeChar.Value, firstRowAsHeader.Value, nullValue.Value);
        }
