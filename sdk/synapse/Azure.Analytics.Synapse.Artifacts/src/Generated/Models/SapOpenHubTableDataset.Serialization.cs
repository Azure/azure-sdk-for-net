...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class SapOpenHubTableDataset : IUtf8JsonSerializable
    {
        ...
        internal static SapOpenHubTableDataset DeserializeSapOpenHubTableDataset(JsonElement element)
        {
            ...
            return new SapOpenHubTableDataset(type, description.HasValue ? description.Value : null, structure.HasValue ? structure.Value : null, schema.HasValue ? schema.Value : null, linkedServiceName, new ChangeTrackingDictionary<string, ParameterSpecification>(parameters), new ChangeTrackingList<object>(annotations), folder.HasValue ? folder.Value : null, additionalProperties, openHubDestinationName, excludeLastRequest.HasValue ? excludeLastRequest.Value : null, baseRequestId.HasValue ? baseRequestId.Value : null);
        }
    }
}
