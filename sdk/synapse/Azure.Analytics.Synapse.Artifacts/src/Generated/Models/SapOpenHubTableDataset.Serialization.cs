...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class SapOpenHubTableDataset : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            writer.WriteObjectValue<object>(OpenHubDestinationName);
        ...
        internal static new SapOpenHubTableDataset FromResponse(Response response)
        {
        ...
        internal override RequestContent ToRequestContent()
        {
            ...
            content.JsonWriter.WriteObjectValue<SapOpenHubTableDataset>(this);
            return content;
        }
        ...
        internal partial class SapOpenHubTableDatasetConverter : JsonConverter<SapOpenHubTableDataset>
        {
            ...
            {
                writer.WriteObjectValue<SapOpenHubTableDataset>(model);
            }
