...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class SapOpenHubTableDataset : IUtf8JsonSerializable
    {
        ...
        internal static SapOpenHubTableDataset DeserializeSapOpenHubTableDataset(JsonElement element)
        {
            ...
            return new SapOpenHubTableDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, parameters ?? new ChangeTrackingDictionary<string, ParameterSpecification>(), annotations ?? new ChangeTrackingList<object>(), folder.Value, additionalProperties, openHubDestinationName, excludeLastRequest.Value, baseRequestId.Value);
        }
