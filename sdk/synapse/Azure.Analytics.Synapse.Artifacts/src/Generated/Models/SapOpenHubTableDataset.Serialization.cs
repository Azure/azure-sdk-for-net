...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class SapOpenHubTableDataset : IUtf8JsonSerializable
    {
        ...
        internal static SapOpenHubTableDataset DeserializeSapOpenHubTableDataset(JsonElement element)
        {
            ...
            return new SapOpenHubTableDataset(type, description, structure, schema, linkedServiceName, parameters, annotations, folder, additionalProperties, openHubDestinationName, excludeLastRequest, baseRequestId);
        }
    }
}
