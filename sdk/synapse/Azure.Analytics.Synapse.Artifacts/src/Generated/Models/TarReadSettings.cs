...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class TarReadSettings : CompressionReadSettings
    {
        ...
        internal TarReadSettings(string type, IDictionary<string, BinaryData> additionalProperties, BinaryData preserveCompressionFileNameAsFolder) : base(type, additionalProperties)
        {
