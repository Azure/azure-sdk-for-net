...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class Workspace : IUtf8JsonSerializable, IJsonModel<Workspace>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<Workspace>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<Workspace>)} interface");
            }
        ...
        Workspace IJsonModel<Workspace>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (!isValid)
            {
                throw new FormatException($"The model {nameof(Workspace)} does not support '{options.Format}' format.");
            }
