...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class SapBWLinkedService : IUtf8JsonSerializable
    {
        ...
        internal static SapBWLinkedService DeserializeSapBWLinkedService(JsonElement element)
        {
            ...
            return new SapBWLinkedService(type, connectVia.HasValue ? connectVia.Value : null, description.HasValue ? description.Value : null, new ChangeTrackingDictionary<string, ParameterSpecification>(parameters), new ChangeTrackingList<object>(annotations), additionalProperties, server, systemNumber, clientId, userName.HasValue ? userName.Value : null, password.HasValue ? password.Value : null, encryptedCredential.HasValue ? encryptedCredential.Value : null);
        }
    }
}
