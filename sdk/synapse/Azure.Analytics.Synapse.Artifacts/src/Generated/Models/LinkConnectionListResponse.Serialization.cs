...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    {
        internal static LinkConnectionListResponse DeserializeLinkConnectionListResponse(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
