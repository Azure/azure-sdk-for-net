...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class SftpWriteSettings : StoreWriteSettings
    {
        ...
        internal SftpWriteSettings(string type, BinaryData maxConcurrentConnections, BinaryData copyBehavior, IDictionary<string, BinaryData> additionalProperties, BinaryData operationTimeout, BinaryData useTempFileRename) : base(type, maxConcurrentConnections, copyBehavior, additionalProperties)
        {
