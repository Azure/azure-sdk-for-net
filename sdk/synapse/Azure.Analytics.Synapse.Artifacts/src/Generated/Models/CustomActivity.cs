...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class CustomActivity : ExecutionActivity
    {
        ...
        internal CustomActivity(string name, string type, string description, IList<ActivityDependency> dependsOn, IList<UserProperty> userProperties, IDictionary<string, object> additionalProperties, LinkedServiceReferenceAutoGenerated linkedServiceName, ActivityPolicy policy, object command, LinkedServiceReferenceAutoGenerated resourceLinkedService, object folderPath, CustomActivityReferenceObject referenceObjects, IDictionary<string, object> extendedProperties, object retentionTimeInDays, object autoUserSpecification) : base(name, type, description, dependsOn, userProperties, additionalProperties, linkedServiceName, policy)
        {
            Command = command;
        ...
        public LinkedServiceReferenceAutoGenerated ResourceLinkedService { get; set; }
