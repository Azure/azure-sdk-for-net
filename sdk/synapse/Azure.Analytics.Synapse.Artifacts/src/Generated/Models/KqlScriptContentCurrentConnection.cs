...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class KqlScriptContentCurrentConnection
    {
        ...
        internal KqlScriptContentCurrentConnection(string name, string poolName, string databaseName, string type, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            PoolName = poolName;
