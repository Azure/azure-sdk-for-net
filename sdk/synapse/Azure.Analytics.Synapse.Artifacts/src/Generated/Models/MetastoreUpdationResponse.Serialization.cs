...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    {
        internal static MetastoreUpdationResponse DeserializeMetastoreUpdationResponse(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
