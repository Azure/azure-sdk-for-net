...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class SqlScriptResource
    {
        ...
        internal SqlScriptResource(string id, string name, string type, string etag, SqlScript properties, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Name = name;
            Type = type;
