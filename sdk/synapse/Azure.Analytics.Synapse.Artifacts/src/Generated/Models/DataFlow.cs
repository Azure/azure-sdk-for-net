...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class DataFlow
    {
        ...
        internal DataFlow(string type, string description, IList<object> annotations, DataFlowFolder folder, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Type = type;
