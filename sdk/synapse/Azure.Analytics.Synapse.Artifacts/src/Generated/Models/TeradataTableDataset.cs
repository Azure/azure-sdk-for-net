...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class TeradataTableDataset : Dataset
    {
        ...
        public TeradataTableDataset(LinkedServiceReferenceAutoGenerated linkedServiceName) : base(linkedServiceName)
        {
        ...
        internal TeradataTableDataset(string type, string description, object structure, object schema, LinkedServiceReferenceAutoGenerated linkedServiceName, IDictionary<string, ParameterSpecification> parameters, IList<object> annotations, DatasetFolder folder, IDictionary<string, object> additionalProperties, object database, object table) : base(type, description, structure, schema, linkedServiceName, parameters, annotations, folder, additionalProperties)
        {
            Database = database;
            Table = table;
