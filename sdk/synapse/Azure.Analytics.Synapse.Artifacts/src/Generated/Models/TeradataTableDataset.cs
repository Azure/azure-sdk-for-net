...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class TeradataTableDataset : Dataset
    {
        ...
        internal TeradataTableDataset(string type, string description, BinaryData structure, BinaryData schema, LinkedServiceReference linkedServiceName, IDictionary<string, ParameterSpecification> parameters, IList<BinaryData> annotations, DatasetFolder folder, IDictionary<string, BinaryData> additionalProperties, BinaryData database, BinaryData table) : base(type, description, structure, schema, linkedServiceName, parameters, annotations, folder, additionalProperties)
        {
            Database = database;
            Table = table;
