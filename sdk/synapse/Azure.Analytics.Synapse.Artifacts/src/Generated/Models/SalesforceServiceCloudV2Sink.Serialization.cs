...
{
    [JsonConverter(typeof(SalesforceServiceCloudV2SinkConverter))]
    public partial class SalesforceServiceCloudV2Sink : IUtf8JsonSerializable
    {
        ...
        internal static SalesforceServiceCloudV2Sink DeserializeSalesforceServiceCloudV2Sink(JsonElement element)
        {
        ...
        internal static new SalesforceServiceCloudV2Sink FromResponse(Response response)
        {
            using var document = JsonDocument.Parse(response.Content, ModelSerializationExtensions.JsonDocumentOptions);
            return DeserializeSalesforceServiceCloudV2Sink(document.RootElement);
        }
        ...
        internal partial class SalesforceServiceCloudV2SinkConverter : JsonConverter<SalesforceServiceCloudV2Sink>
        {
            public override void Write(Utf8JsonWriter writer, SalesforceServiceCloudV2Sink model, JsonSerializerOptions options)
            {
                writer.WriteObjectValue(model);
            }

            public override SalesforceServiceCloudV2Sink Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
            {
