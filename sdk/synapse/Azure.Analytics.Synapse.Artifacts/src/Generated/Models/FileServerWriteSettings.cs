...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class FileServerWriteSettings : StoreWriteSettings
    {
        ...
        internal FileServerWriteSettings(string type, BinaryData maxConcurrentConnections, BinaryData copyBehavior, IDictionary<string, BinaryData> additionalProperties) : base(type, maxConcurrentConnections, copyBehavior, additionalProperties)
        {
