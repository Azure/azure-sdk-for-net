...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class DataFlowSink : Transformation
    {
        ...
        internal DataFlowSink(string name, string description, DatasetReference dataset, LinkedServiceReferenceAutoGenerated linkedService, DataFlowReference flowlet, LinkedServiceReferenceAutoGenerated schemaLinkedService) : base(name, description, dataset, linkedService, flowlet)
        {
