...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class DataFlowSink : Transformation
    {
        ...
        internal DataFlowSink(string name, string description, DatasetReference dataset, LinkedServiceReference linkedService, DataFlowReference flowlet, LinkedServiceReference schemaLinkedService, LinkedServiceReference rejectedDataLinkedService, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(name, description, dataset, linkedService, flowlet, serializedAdditionalRawData)
        {
