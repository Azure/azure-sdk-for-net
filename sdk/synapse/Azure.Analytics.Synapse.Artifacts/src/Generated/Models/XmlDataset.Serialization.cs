...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class XmlDataset : IUtf8JsonSerializable
    {
        ...
        internal static XmlDataset DeserializeXmlDataset(JsonElement element)
        {
            ...
            return new XmlDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Optional.ToDictionary(parameters), annotations ?? new ChangeTrackingList<object>(), folder.Value, additionalProperties, location.Value, encodingName.Value, nullValue.Value, compression.Value);
        }
