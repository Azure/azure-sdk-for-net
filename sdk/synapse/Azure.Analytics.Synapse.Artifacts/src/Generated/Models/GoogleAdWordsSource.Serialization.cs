...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class GoogleAdWordsSource : IUtf8JsonSerializable
    {
        ...
        internal static GoogleAdWordsSource DeserializeGoogleAdWordsSource(JsonElement element)
        {
            ...
            return new GoogleAdWordsSource(type, sourceRetryCount.Value, sourceRetryWait.Value, maxConcurrentConnections.Value, additionalProperties, queryTimeout.Value, query.Value);
        }
