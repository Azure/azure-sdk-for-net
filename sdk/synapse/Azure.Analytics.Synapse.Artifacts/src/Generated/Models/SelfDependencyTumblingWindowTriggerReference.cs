...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class SelfDependencyTumblingWindowTriggerReference : DependencyReference
    {
        ...
        internal SelfDependencyTumblingWindowTriggerReference(string type, string offset, string size, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(type, serializedAdditionalRawData)
        {
            Offset = offset;
            Size = size;
