...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class WaitActivity : IUtf8JsonSerializable
    {
        ...
        internal static WaitActivity DeserializeWaitActivity(JsonElement element)
        {
            ...
            return new WaitActivity(name, type, description.HasValue ? description.Value : null, new ChangeTrackingList<ActivityDependency>(dependsOn), new ChangeTrackingList<UserProperty>(userProperties), additionalProperties, waitTimeInSeconds);
        }
    }
}
