...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class WaitActivity : Core.IUtf8JsonSerializable
    {
        ...
        internal static WaitActivity DeserializeWaitActivity(JsonElement element)
        {
            ...
            return new WaitActivity(name, type, description.Value, Core.Optional.ToNullable(state), Core.Optional.ToNullable(onInactiveMarkAs), Core.Optional.ToList(dependsOn), Core.Optional.ToList(userProperties), additionalProperties, waitTimeInSeconds);
        }
