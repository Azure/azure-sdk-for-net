...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class MongoDbV2CollectionDataset : Core.IUtf8JsonSerializable
    {
        ...
        internal static MongoDbV2CollectionDataset DeserializeMongoDbV2CollectionDataset(JsonElement element)
        {
            ...
            return new MongoDbV2CollectionDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), folder.Value, additionalProperties, collection);
        }
