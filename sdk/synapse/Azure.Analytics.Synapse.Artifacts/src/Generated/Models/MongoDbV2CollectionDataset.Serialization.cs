...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class MongoDbV2CollectionDataset : IUtf8JsonSerializable
    {
        ...
        internal static MongoDbV2CollectionDataset DeserializeMongoDbV2CollectionDataset(JsonElement element)
        {
            ...
            return new MongoDbV2CollectionDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Optional.ToDictionary(parameters), annotations ?? new ChangeTrackingList<object>(), folder.Value, additionalProperties, collection);
        }
