...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class MicrosoftAccessTableDataset : IUtf8JsonSerializable
    {
        ...
        internal static MicrosoftAccessTableDataset DeserializeMicrosoftAccessTableDataset(JsonElement element)
        {
            ...
            return new MicrosoftAccessTableDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Optional.ToDictionary(parameters), annotations ?? new ChangeTrackingList<object>(), folder.Value, additionalProperties, tableName.Value);
        }
