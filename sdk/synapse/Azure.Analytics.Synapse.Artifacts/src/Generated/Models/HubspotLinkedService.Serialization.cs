...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HubspotLinkedService>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<HubspotLinkedService>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<HubspotLinkedService>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<HubspotLinkedService>)} interface");
            }
        ...
        HubspotLinkedService IJsonModel<HubspotLinkedService>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        HubspotLinkedService IPersistableModel<HubspotLinkedService>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == "J" || options.Format == "W";
            if (!isValid)
            {
        ...
        string IPersistableModel<HubspotLinkedService>.GetWireFormat(ModelReaderWriterOptions options) => "J";
