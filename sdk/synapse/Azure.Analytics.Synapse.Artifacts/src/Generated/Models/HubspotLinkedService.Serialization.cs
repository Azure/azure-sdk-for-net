...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class HubspotLinkedService : IUtf8JsonSerializable, IJsonModel<HubspotLinkedService>
    {
        ...
        void IJsonModel<HubspotLinkedService>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(HubspotLinkedService)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<HubspotLinkedService>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(HubspotLinkedService)} does not support '{options.Format}' format.");
            }
        }
