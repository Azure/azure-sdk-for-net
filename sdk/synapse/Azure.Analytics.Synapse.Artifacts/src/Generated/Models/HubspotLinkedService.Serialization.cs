...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class HubspotLinkedService : IUtf8JsonSerializable, IJsonModel<HubspotLinkedService>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<HubspotLinkedService>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<HubspotLinkedService>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
