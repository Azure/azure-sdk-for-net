...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class HubspotLinkedService : IUtf8JsonSerializable
    {
        ...
        internal static HubspotLinkedService DeserializeHubspotLinkedService(JsonElement element)
        {
            ...
            return new HubspotLinkedService(type, connectVia.Value, description.Value, parameters ?? new ChangeTrackingDictionary<string, ParameterSpecification>(), annotations ?? new ChangeTrackingList<object>(), additionalProperties, clientId, clientSecret.Value, accessToken.Value, refreshToken.Value, useEncryptedEndpoints.Value, useHostVerification.Value, usePeerVerification.Value, encryptedCredential.Value);
        }
