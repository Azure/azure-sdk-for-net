...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class HubspotLinkedService : IUtf8JsonSerializable
    {
        ...
        internal static HubspotLinkedService DeserializeHubspotLinkedService(JsonElement element)
        {
            ...
            return new HubspotLinkedService(type, connectVia.HasValue ? connectVia.Value : null, description.HasValue ? description.Value : null, new ChangeTrackingDictionary<string, ParameterSpecification>(parameters), new ChangeTrackingList<object>(annotations), additionalProperties, clientId, clientSecret.HasValue ? clientSecret.Value : null, accessToken.HasValue ? accessToken.Value : null, refreshToken.HasValue ? refreshToken.Value : null, useEncryptedEndpoints.HasValue ? useEncryptedEndpoints.Value : null, useHostVerification.HasValue ? useHostVerification.Value : null, usePeerVerification.HasValue ? usePeerVerification.Value : null, encryptedCredential.HasValue ? encryptedCredential.Value : null);
        }
    }
}
