...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class OracleLinkedService : IUtf8JsonSerializable
    {
        ...
        internal static OracleLinkedService DeserializeOracleLinkedService(JsonElement element)
        {
            ...
            return new OracleLinkedService(type, connectVia.Value, description.Value, Optional.ToDictionary(parameters), annotations ?? new ChangeTrackingList<object>(), additionalProperties, connectionString, password.Value, encryptedCredential.Value);
        }
