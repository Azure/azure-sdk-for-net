...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class DynamicsLinkedService : IUtf8JsonSerializable
    {
        ...
        internal static DynamicsLinkedService DeserializeDynamicsLinkedService(JsonElement element)
        {
            ...
            return new DynamicsLinkedService(type, connectVia, description, parameters, annotations, additionalProperties, deploymentType, hostName, port, serviceUri, organizationName, authenticationType, username, password, servicePrincipalId, servicePrincipalCredentialType, servicePrincipalCredential, encryptedCredential);
        }
    }
}
