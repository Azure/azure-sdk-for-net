...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class VerticaSource : IUtf8JsonSerializable
    {
        ...
        internal static VerticaSource DeserializeVerticaSource(JsonElement element)
        {
            ...
            return new VerticaSource(type, sourceRetryCount.Value, sourceRetryWait.Value, maxConcurrentConnections.Value, additionalProperties, queryTimeout.Value, query.Value);
        }
