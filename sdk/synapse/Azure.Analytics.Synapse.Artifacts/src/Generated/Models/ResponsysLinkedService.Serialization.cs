...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class ResponsysLinkedService : Core.IUtf8JsonSerializable
    {
        ...
        internal static ResponsysLinkedService DeserializeResponsysLinkedService(JsonElement element)
        {
            ...
            return new ResponsysLinkedService(type, connectVia.Value, description.Value, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), additionalProperties, endpoint, clientId, clientSecret.Value, useEncryptedEndpoints.Value, useHostVerification.Value, usePeerVerification.Value, encryptedCredential.Value);
        }
