...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    internal partial class UnknownCompressionReadSettings : IUtf8JsonSerializable
    {
        ...
        internal static new UnknownCompressionReadSettings FromResponse(Response response)
        {
            using var document = JsonDocument.Parse(response.Content);
            return DeserializeUnknownCompressionReadSettings(document.RootElement);
        }
        ...
        internal override RequestContent ToRequestContent()
        {
            ...
            content.JsonWriter.WriteObjectValue<UnknownCompressionReadSettings>(this);
            return content;
        }
    }
}
