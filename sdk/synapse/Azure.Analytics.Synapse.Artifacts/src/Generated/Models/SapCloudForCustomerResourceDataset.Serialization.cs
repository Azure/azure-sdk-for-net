...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class SapCloudForCustomerResourceDataset : IUtf8JsonSerializable
    {
        ...
        internal static SapCloudForCustomerResourceDataset DeserializeSapCloudForCustomerResourceDataset(JsonElement element)
        {
            ...
            return new SapCloudForCustomerResourceDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, parameters ?? new ChangeTrackingDictionary<string, ParameterSpecification>(), annotations ?? new ChangeTrackingList<object>(), folder.Value, additionalProperties, path);
        }
