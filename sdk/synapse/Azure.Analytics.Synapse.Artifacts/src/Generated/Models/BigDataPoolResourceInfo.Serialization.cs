...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class BigDataPoolResourceInfo : IUtf8JsonSerializable, IJsonModel<BigDataPoolResourceInfo>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BigDataPoolResourceInfo>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<BigDataPoolResourceInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<BigDataPoolResourceInfo>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(BigDataPoolResourceInfo)} does not support '{format}' format.");
            }
            ...
            if (options.Format != "W" && Optional.IsDefined(LastSucceededTimestamp))
            {
                writer.WritePropertyName("lastSucceededTimestamp"u8);
                writer.WriteStringValue(LastSucceededTimestamp.Value, "O");
            }
            writer.WriteEndObject();
        ...
        BigDataPoolResourceInfo IJsonModel<BigDataPoolResourceInfo>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<BigDataPoolResourceInfo>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
            ...
            return DeserializeBigDataPoolResourceInfo(document.RootElement, options);
        }

        internal static BigDataPoolResourceInfo DeserializeBigDataPoolResourceInfo(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<BigDataPoolResourceInfo>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(BigDataPoolResourceInfo)} does not support '{options.Format}' format.");
            }
        }

        BigDataPoolResourceInfo IPersistableModel<BigDataPoolResourceInfo>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<BigDataPoolResourceInfo>)this).GetFormatFromOptions(options) : options.Format;
        ...
        string IPersistableModel<BigDataPoolResourceInfo>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
