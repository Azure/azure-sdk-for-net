...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class BigDataPoolResourceInfo : IUtf8JsonSerializable, IJsonModel<BigDataPoolResourceInfo>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<BigDataPoolResourceInfo>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<BigDataPoolResourceInfo>)} interface");
            }
            ...
            if (options.Format == "J")
            {
                if (Optional.IsDefined(LastSucceededTimestamp))
                {
        ...
        BigDataPoolResourceInfo IJsonModel<BigDataPoolResourceInfo>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (!isValid)
            {
                throw new FormatException($"The model {nameof(BigDataPoolResourceInfo)} does not support '{options.Format}' format.");
            }
