...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class SqlDWSource : IUtf8JsonSerializable, IModelJsonSerializable<SqlDWSource>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<SqlDWSource>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="SqlDWSource"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="SqlDWSource"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="SqlDWSource"/>. </summary>
