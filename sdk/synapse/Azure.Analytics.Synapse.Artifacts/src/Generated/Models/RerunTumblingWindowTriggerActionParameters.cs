...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    internal partial class RerunTumblingWindowTriggerActionParameters
    {
        ...
        internal RerunTumblingWindowTriggerActionParameters(DateTimeOffset startTime, DateTimeOffset endTime, int maxConcurrency, Dictionary<string, BinaryData> rawData)
        {
            StartTime = startTime;
            EndTime = endTime;
            MaxConcurrency = maxConcurrency;
