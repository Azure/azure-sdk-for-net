...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class ScheduleTrigger : MultiplePipelineTrigger
    {
        ...
        /// <param name="recurrence"> Recurrence schedule configuration. </param>
        internal ScheduleTrigger(string type, string description, TriggerRuntimeState? runtimeState, IList<BinaryData> annotations, IDictionary<string, BinaryData> additionalProperties, IList<TriggerPipelineReference> pipelines, ScheduleTriggerRecurrence recurrence) : base(type, description, runtimeState, annotations, additionalProperties, pipelines)
        {
            Recurrence = recurrence;
