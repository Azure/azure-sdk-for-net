...
{
    [JsonConverter(typeof(ServiceNowV2SourceConverter))]
    public partial class ServiceNowV2Source : IUtf8JsonSerializable
    {
        ...
        internal partial class ServiceNowV2SourceConverter : JsonConverter<ServiceNowV2Source>
        {
            public override void Write(Utf8JsonWriter writer, ServiceNowV2Source model, JsonSerializerOptions options)
            {
                writer.WriteObjectValue(model);
            }

            public override ServiceNowV2Source Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
            {
