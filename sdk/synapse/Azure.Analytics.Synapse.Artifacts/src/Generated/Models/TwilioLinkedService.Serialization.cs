...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class TwilioLinkedService : Core.IUtf8JsonSerializable
    {
        ...
        internal static TwilioLinkedService DeserializeTwilioLinkedService(JsonElement element)
        {
            ...
            return new TwilioLinkedService(type, connectVia.Value, description.Value, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), additionalProperties, userName, password);
        }
