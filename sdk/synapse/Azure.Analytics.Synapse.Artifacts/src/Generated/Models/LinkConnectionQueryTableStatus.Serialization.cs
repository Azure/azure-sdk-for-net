...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class LinkConnectionQueryTableStatus : IUtf8JsonSerializable, IJsonModel<LinkConnectionQueryTableStatus>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<LinkConnectionQueryTableStatus>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<LinkConnectionQueryTableStatus>)} interface");
            }
