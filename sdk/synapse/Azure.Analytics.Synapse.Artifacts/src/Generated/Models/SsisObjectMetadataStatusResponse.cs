...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class SsisObjectMetadataStatusResponse
    {
        ...
        internal SsisObjectMetadataStatusResponse(string status, string name, string properties, string error, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Status = status;
            Name = name;
