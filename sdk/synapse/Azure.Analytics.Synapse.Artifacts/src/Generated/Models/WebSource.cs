...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class WebSource : CopySource
    {
        ...
        internal WebSource(string type, object sourceRetryCount, object sourceRetryWait, object maxConcurrentConnections, IDictionary<string, object> additionalProperties, IList<AdditionalColumns> additionalColumns) : base(type, sourceRetryCount, sourceRetryWait, maxConcurrentConnections, additionalProperties)
        {
