...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class HttpLinkedService : IUtf8JsonSerializable
    {
        ...
        internal static HttpLinkedService DeserializeHttpLinkedService(JsonElement element)
        {
            ...
            return new HttpLinkedService(type, connectVia.HasValue ? connectVia.Value : null, description.HasValue ? description.Value : null, new ChangeTrackingDictionary<string, ParameterSpecification>(parameters), new ChangeTrackingList<object>(annotations), additionalProperties, url, authenticationType.HasValue ? authenticationType.Value : (HttpAuthenticationType?)null, userName.HasValue ? userName.Value : null, password.HasValue ? password.Value : null, embeddedCertData.HasValue ? embeddedCertData.Value : null, certThumbprint.HasValue ? certThumbprint.Value : null, encryptedCredential.HasValue ? encryptedCredential.Value : null, enableServerCertificateValidation.HasValue ? enableServerCertificateValidation.Value : null);
        }
    }
}
