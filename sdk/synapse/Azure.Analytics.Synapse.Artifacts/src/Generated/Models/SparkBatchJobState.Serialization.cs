...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class SparkBatchJobState : IUtf8JsonSerializable, IJsonModel<SparkBatchJobState>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<SparkBatchJobState>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SparkBatchJobState>)} interface");
            }
