...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SparkBatchJobState>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SparkBatchJobState>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SparkBatchJobState>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<SparkBatchJobState>.GetWireFormat(ModelReaderWriterOptions options) => "J";
