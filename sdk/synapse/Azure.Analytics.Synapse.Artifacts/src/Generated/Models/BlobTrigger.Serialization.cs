...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class BlobTrigger : Core.IUtf8JsonSerializable
    {
        ...
        internal static BlobTrigger DeserializeBlobTrigger(JsonElement element)
        {
            ...
            return new BlobTrigger(type, description.Value, Core.Optional.ToNullable(runtimeState), Core.Optional.ToList(annotations), additionalProperties, Core.Optional.ToList(pipelines), folderPath, maxConcurrency, linkedService);
        }
