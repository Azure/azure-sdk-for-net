...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BlobTrigger>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<BlobTrigger>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<BlobTrigger>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(BlobTrigger)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<BlobTrigger>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(BlobTrigger)} does not support '{options.Format}' format.");
            }
        }
        ...
        string IPersistableModel<BlobTrigger>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
