...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class BlobTrigger : IUtf8JsonSerializable
    {
        ...
        internal static BlobTrigger DeserializeBlobTrigger(JsonElement element)
        {
            ...
            LinkedServiceReferenceAutoGenerated linkedService = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("typeProperties"))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        {
                            linkedService = LinkedServiceReferenceAutoGenerated.DeserializeLinkedServiceReferenceAutoGenerated(property0.Value);
                            continue;
                        }
                    }
                    continue;
