...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class SqlServerStoredProcedureActivity : ExecutionActivity
    {
        ...
        internal SqlServerStoredProcedureActivity(string name, string type, string description, IList<ActivityDependency> dependsOn, IList<UserProperty> userProperties, IDictionary<string, object> additionalProperties, LinkedServiceReferenceAutoGenerated linkedServiceName, ActivityPolicy policy, object storedProcedureName, IDictionary<string, StoredProcedureParameter> storedProcedureParameters) : base(name, type, description, dependsOn, userProperties, additionalProperties, linkedServiceName, policy)
        {
            StoredProcedureName = storedProcedureName;
