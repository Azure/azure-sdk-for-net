...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class RelationalTableDataset : IUtf8JsonSerializable
    {
        ...
        {
            public override void Write(Utf8JsonWriter writer, RelationalTableDataset model, JsonSerializerOptions options)
            {
                writer.WriteObjectValue(model);
            }
            public override RelationalTableDataset Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
            {
                using var document = JsonDocument.ParseValue(ref reader);
                return DeserializeRelationalTableDataset(document.RootElement);
            }
        }
    }
}
