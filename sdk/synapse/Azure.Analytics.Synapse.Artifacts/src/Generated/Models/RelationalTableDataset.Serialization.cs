...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class RelationalTableDataset : Core.IUtf8JsonSerializable
    {
        ...
        internal static RelationalTableDataset DeserializeRelationalTableDataset(JsonElement element)
        {
            ...
            return new RelationalTableDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), folder.Value, additionalProperties, tableName.Value);
        }
