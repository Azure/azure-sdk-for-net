...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class RelationalTableDataset : IUtf8JsonSerializable
    {
        ...
        internal static RelationalTableDataset DeserializeRelationalTableDataset(JsonElement element)
        {
            ...
            return new RelationalTableDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, parameters ?? new ChangeTrackingDictionary<string, ParameterSpecification>(), annotations ?? new ChangeTrackingList<object>(), folder.Value, additionalProperties, tableName.Value);
        }
