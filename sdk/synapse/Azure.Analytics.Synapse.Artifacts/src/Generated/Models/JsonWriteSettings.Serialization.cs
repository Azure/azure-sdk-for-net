...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<JsonWriteSettings>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<JsonWriteSettings>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<JsonWriteSettings>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<JsonWriteSettings>)} interface");
            }
        ...
        string IPersistableModel<JsonWriteSettings>.GetWireFormat(ModelReaderWriterOptions options) => "J";
