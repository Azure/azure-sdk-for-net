...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SparkScheduler>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SparkScheduler>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SparkScheduler>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<SparkScheduler>.GetWireFormat(ModelReaderWriterOptions options) => "J";
