...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class WebHookActivity : ControlActivity
    {
        ...
        public WebHookActivity(string name, WebHookActivityMethod method, BinaryData url) : base(name)
        {
            if (name == null)
            {
        ...
        internal WebHookActivity(string name, string type, string description, IList<ActivityDependency> dependsOn, IList<UserProperty> userProperties, IDictionary<string, BinaryData> additionalProperties, WebHookActivityMethod method, BinaryData url, string timeout, BinaryData headers, BinaryData body, WebActivityAuthentication authentication, BinaryData reportStatusOnCallBack) : base(name, type, description, dependsOn, userProperties, additionalProperties)
        {
            Method = method;
            Url = url;
            Timeout = timeout;
