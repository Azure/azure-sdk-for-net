...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class ODataLinkedService : IUtf8JsonSerializable
    {
        ...
        internal static ODataLinkedService DeserializeODataLinkedService(JsonElement element)
        {
            ...
            return new ODataLinkedService(type, connectVia.HasValue ? connectVia.Value : null, description.HasValue ? description.Value : null, new ChangeTrackingDictionary<string, ParameterSpecification>(parameters), new ChangeTrackingList<object>(annotations), additionalProperties, url, authenticationType.HasValue ? authenticationType.Value : (ODataAuthenticationType?)null, userName.HasValue ? userName.Value : null, password.HasValue ? password.Value : null, tenant.HasValue ? tenant.Value : null, servicePrincipalId.HasValue ? servicePrincipalId.Value : null, aadResourceId.HasValue ? aadResourceId.Value : null, aadServicePrincipalCredentialType.HasValue ? aadServicePrincipalCredentialType.Value : (ODataAadServicePrincipalCredentialType?)null, servicePrincipalKey.HasValue ? servicePrincipalKey.Value : null, servicePrincipalEmbeddedCert.HasValue ? servicePrincipalEmbeddedCert.Value : null, servicePrincipalEmbeddedCertPassword.HasValue ? servicePrincipalEmbeddedCertPassword.Value : null, encryptedCredential.HasValue ? encryptedCredential.Value : null);
        }
    }
}
