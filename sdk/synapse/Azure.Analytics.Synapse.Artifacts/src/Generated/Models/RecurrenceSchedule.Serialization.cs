...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RecurrenceSchedule>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RecurrenceSchedule>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RecurrenceSchedule>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RecurrenceSchedule>)} interface");
            }
        ...
        string IPersistableModel<RecurrenceSchedule>.GetWireFormat(ModelReaderWriterOptions options) => "J";
