...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class OrcDataset : IUtf8JsonSerializable
    {
        ...
        internal static OrcDataset DeserializeOrcDataset(JsonElement element)
        {
            ...
            return new OrcDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Optional.ToDictionary(parameters), annotations ?? new ChangeTrackingList<object>(), folder.Value, additionalProperties, location.Value, orcCompressionCodec.Value);
        }
