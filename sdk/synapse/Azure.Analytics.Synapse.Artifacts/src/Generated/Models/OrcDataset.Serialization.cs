...
{
    [JsonConverter(typeof(OrcDatasetConverter))]
    public partial class OrcDataset : IUtf8JsonSerializable
    {
        ...
        {
            public override void Write(Utf8JsonWriter writer, OrcDataset model, JsonSerializerOptions options)
            {
                writer.WriteObjectValue(model);
            }
            public override OrcDataset Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
            {
                using var document = JsonDocument.ParseValue(ref reader);
                return DeserializeOrcDataset(document.RootElement);
            }
        }
    }
}
