...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class OrcDataset : IUtf8JsonSerializable
    {
        ...
        internal static OrcDataset DeserializeOrcDataset(JsonElement element)
        {
            ...
            return new OrcDataset(type, description.HasValue ? description.Value : null, structure.HasValue ? structure.Value : null, schema.HasValue ? schema.Value : null, linkedServiceName, new ChangeTrackingDictionary<string, ParameterSpecification>(parameters), new ChangeTrackingList<object>(annotations), folder.HasValue ? folder.Value : null, additionalProperties, location.HasValue ? location.Value : null, orcCompressionCodec.HasValue ? orcCompressionCodec.Value : (OrcCompressionCodec?)null);
        }
    }
}
