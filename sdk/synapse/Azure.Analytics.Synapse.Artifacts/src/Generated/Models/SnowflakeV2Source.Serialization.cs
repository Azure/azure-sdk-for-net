...
{
    [JsonConverter(typeof(SnowflakeV2SourceConverter))]
    public partial class SnowflakeV2Source : IUtf8JsonSerializable
    {
        ...
        internal partial class SnowflakeV2SourceConverter : JsonConverter<SnowflakeV2Source>
        {
            public override void Write(Utf8JsonWriter writer, SnowflakeV2Source model, JsonSerializerOptions options)
            {
                writer.WriteObjectValue(model);
            }

            public override SnowflakeV2Source Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
            {
