...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class NotebookSessionProperties
    {
        ...
        internal NotebookSessionProperties(string driverMemory, int driverCores, string executorMemory, int executorCores, int numExecutors, Dictionary<string, BinaryData> rawData)
        {
            DriverMemory = driverMemory;
            DriverCores = driverCores;
            ExecutorMemory = executorMemory;
