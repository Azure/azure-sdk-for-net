...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class SapHanaTableDataset : IUtf8JsonSerializable
    {
        ...
        internal static SapHanaTableDataset DeserializeSapHanaTableDataset(JsonElement element)
        {
            ...
            return new SapHanaTableDataset(type, description.HasValue ? description.Value : null, structure.HasValue ? structure.Value : null, schema.HasValue ? schema.Value : null, linkedServiceName, new ChangeTrackingDictionary<string, ParameterSpecification>(parameters), new ChangeTrackingList<object>(annotations), folder.HasValue ? folder.Value : null, additionalProperties, schema0.HasValue ? schema0.Value : null, table.HasValue ? table.Value : null);
        }
    }
}
