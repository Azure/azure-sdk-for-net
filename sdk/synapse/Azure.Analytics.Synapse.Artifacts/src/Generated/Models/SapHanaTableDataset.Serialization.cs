...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class SapHanaTableDataset : IUtf8JsonSerializable
    {
        ...
        internal static SapHanaTableDataset DeserializeSapHanaTableDataset(JsonElement element)
        {
            ...
            return new SapHanaTableDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Optional.ToDictionary(parameters), annotations ?? new ChangeTrackingList<object>(), folder.Value, additionalProperties, schema0.Value, table.Value);
        }
