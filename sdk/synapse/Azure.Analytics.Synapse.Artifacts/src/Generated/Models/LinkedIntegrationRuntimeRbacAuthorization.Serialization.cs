...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LinkedIntegrationRuntimeRbacAuthorization>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<LinkedIntegrationRuntimeRbacAuthorization>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<LinkedIntegrationRuntimeRbacAuthorization>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<LinkedIntegrationRuntimeRbacAuthorization>.GetWireFormat(ModelReaderWriterOptions options) => "J";
