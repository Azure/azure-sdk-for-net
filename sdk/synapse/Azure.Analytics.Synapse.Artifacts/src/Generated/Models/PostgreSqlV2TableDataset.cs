...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class PostgreSqlV2TableDataset : Dataset
    {
        ...
        public PostgreSqlV2TableDataset(LinkedServiceReference linkedServiceName) : base(linkedServiceName)
        {
        ...
        internal PostgreSqlV2TableDataset(string type, string description, object structure, object schema, LinkedServiceReference linkedServiceName, IDictionary<string, ParameterSpecification> parameters, IList<object> annotations, DatasetFolder folder, IDictionary<string, object> additionalProperties, object table, object schemaTypePropertiesSchema) : base(type, description, structure, schema, linkedServiceName, parameters, annotations, folder, additionalProperties)
        {
            Table = table;
            SchemaTypePropertiesSchema = schemaTypePropertiesSchema;
            Type = type ?? "PostgreSqlV2Table";
        }
