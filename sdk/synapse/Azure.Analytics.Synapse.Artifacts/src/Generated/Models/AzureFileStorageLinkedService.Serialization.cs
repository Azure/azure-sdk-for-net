                ...
                if (property.NameEquals("typeProperties"))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("sasUri"))
                        {
                            ...
                            sasUri = BinaryData.FromString(property.Value.GetRawText());
                            continue;
                        }
                        ...
                        if (property0.NameEquals("fileShare"))
                        {
                            ...
                            fileShare = BinaryData.FromString(property.Value.GetRawText());
                            continue;
                        }
                        if (property0.NameEquals("snapshot"))
                        {
                            ...
                            snapshot = BinaryData.FromString(property.Value.GetRawText());
                            continue;
                        }
