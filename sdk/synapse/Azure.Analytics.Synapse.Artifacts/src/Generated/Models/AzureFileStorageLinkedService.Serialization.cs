...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class AzureFileStorageLinkedService : IUtf8JsonSerializable
    {
        ...
        internal static AzureFileStorageLinkedService DeserializeAzureFileStorageLinkedService(JsonElement element)
        {
            ...
            return new AzureFileStorageLinkedService(type, connectVia.Value, description.Value, Optional.ToDictionary(parameters), Optional.ToList(annotations), additionalProperties, host, userId.Value, password.Value, encryptedCredential.Value);
        }
    }
}
