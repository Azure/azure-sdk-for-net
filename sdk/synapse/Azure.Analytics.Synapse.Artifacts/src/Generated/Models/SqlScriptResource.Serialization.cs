...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class SqlScriptResource : IUtf8JsonSerializable, IJsonModel<SqlScriptResource>
    {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<SqlScriptResource>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(SqlScriptResource)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<SqlScriptResource>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(SqlScriptResource)} does not support '{options.Format}' format.");
            }
        }
