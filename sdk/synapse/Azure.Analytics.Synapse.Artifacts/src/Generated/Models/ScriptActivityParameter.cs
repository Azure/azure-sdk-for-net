...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class ScriptActivityParameter
    {
        ...
        internal ScriptActivityParameter(object name, ScriptActivityParameterType? type, object value, ScriptActivityParameterDirection? direction, int? size, Dictionary<string, BinaryData> rawData)
        {
            Name = name;
            Type = type;
            Value = value;
