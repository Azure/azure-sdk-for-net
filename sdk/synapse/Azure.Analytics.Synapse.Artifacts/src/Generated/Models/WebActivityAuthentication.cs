...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class WebActivityAuthentication
    {
        ...
        internal WebActivityAuthentication(string type, SecretBase pfx, string username, SecretBase password, object resource, object userTenant, CredentialReference credential, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Type = type;
            Pfx = pfx;
            Username = username;
