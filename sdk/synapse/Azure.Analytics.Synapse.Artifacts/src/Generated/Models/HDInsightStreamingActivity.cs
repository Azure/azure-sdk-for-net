...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class HDInsightStreamingActivity : ExecutionActivity
    {
        ...
        public HDInsightStreamingActivity(string name, object mapper, object reducer, object input, object output, IEnumerable<object> filePaths) : base(name)
        {
            ...
            StorageLinkedServices = new ChangeTrackingList<LinkedServiceReferenceAutoGenerated>();
        ...
        internal HDInsightStreamingActivity(string name, string type, string description, IList<ActivityDependency> dependsOn, IList<UserProperty> userProperties, IDictionary<string, object> additionalProperties, LinkedServiceReferenceAutoGenerated linkedServiceName, ActivityPolicy policy, IList<LinkedServiceReferenceAutoGenerated> storageLinkedServices, IList<object> arguments, HDInsightActivityDebugInfoOption? getDebugInfo, object mapper, object reducer, object input, object output, IList<object> filePaths, LinkedServiceReferenceAutoGenerated fileLinkedService, object combiner, IList<object> commandEnvironment, IDictionary<string, object> defines) : base(name, type, description, dependsOn, userProperties, additionalProperties, linkedServiceName, policy)
        {
        ...
        public IList<LinkedServiceReferenceAutoGenerated> StorageLinkedServices { get; }
        ...
        public LinkedServiceReferenceAutoGenerated FileLinkedService { get; set; }
