...
{
    [JsonConverter(typeof(ServicePrincipalCredentialConverter))]
    public partial class ServicePrincipalCredential : IUtf8JsonSerializable
    {
        ...
        internal partial class ServicePrincipalCredentialConverter : JsonConverter<ServicePrincipalCredential>
        {
            public override void Write(Utf8JsonWriter writer, ServicePrincipalCredential model, JsonSerializerOptions options)
            {
                writer.WriteObjectValue(model);
            }
            public override ServicePrincipalCredential Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
            {
                using var document = JsonDocument.ParseValue(ref reader);
                return DeserializeServicePrincipalCredential(document.RootElement);
            }
        }
    }
}
