...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class NetezzaTableDataset : IUtf8JsonSerializable
    {
        ...
        internal static NetezzaTableDataset DeserializeNetezzaTableDataset(JsonElement element)
        {
            ...
            return new NetezzaTableDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Optional.ToDictionary(parameters), annotations ?? new ChangeTrackingList<object>(), folder.Value, additionalProperties, tableName.Value, table.Value, schema0.Value);
        }
