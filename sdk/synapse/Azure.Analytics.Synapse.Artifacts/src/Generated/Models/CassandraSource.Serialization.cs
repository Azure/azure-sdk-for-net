...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class CassandraSource : IUtf8JsonSerializable
    {
        ...
        internal static CassandraSource DeserializeCassandraSource(JsonElement element)
        {
            ...
            return new CassandraSource(type, sourceRetryCount.Value, sourceRetryWait.Value, maxConcurrentConnections.Value, additionalProperties, queryTimeout.Value, query.Value, Optional.ToNullable(consistencyLevel));
        }
