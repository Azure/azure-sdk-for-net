...
{
    [JsonConverter(typeof(WarehouseSourceConverter))]
    public partial class WarehouseSource : IUtf8JsonSerializable
    {
        ...
        internal static WarehouseSource DeserializeWarehouseSource(JsonElement element)
        {
        ...
        internal static new WarehouseSource FromResponse(Response response)
        {
            using var document = JsonDocument.Parse(response.Content, ModelSerializationExtensions.JsonDocumentOptions);
            return DeserializeWarehouseSource(document.RootElement);
        }
        ...
        internal partial class WarehouseSourceConverter : JsonConverter<WarehouseSource>
        {
            public override void Write(Utf8JsonWriter writer, WarehouseSource model, JsonSerializerOptions options)
            {
                writer.WriteObjectValue(model);
            }

            public override WarehouseSource Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
            {
