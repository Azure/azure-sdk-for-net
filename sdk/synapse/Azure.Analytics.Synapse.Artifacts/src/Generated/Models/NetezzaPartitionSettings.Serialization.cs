...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NetezzaPartitionSettings>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NetezzaPartitionSettings>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NetezzaPartitionSettings>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<NetezzaPartitionSettings>)} interface");
            }
        ...
        string IPersistableModel<NetezzaPartitionSettings>.GetWireFormat(ModelReaderWriterOptions options) => "J";
