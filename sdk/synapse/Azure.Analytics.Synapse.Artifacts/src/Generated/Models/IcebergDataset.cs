...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class IcebergDataset : Dataset
    {
        ...
        public IcebergDataset(LinkedServiceReference linkedServiceName) : base(linkedServiceName)
        {
        ...
        /// </param>
        internal IcebergDataset(string type, string description, object structure, object schema, LinkedServiceReference linkedServiceName, IDictionary<string, ParameterSpecification> parameters, IList<object> annotations, DatasetFolder folder, IDictionary<string, object> additionalProperties, DatasetLocation location) : base(type, description, structure, schema, linkedServiceName, parameters, annotations, folder, additionalProperties)
        {
            Location = location;
            Type = type ?? "Iceberg";
        }
