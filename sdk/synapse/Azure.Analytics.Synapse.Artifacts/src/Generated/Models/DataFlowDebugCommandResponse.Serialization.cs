...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    {
        internal static DataFlowDebugCommandResponse DeserializeDataFlowDebugCommandResponse(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
