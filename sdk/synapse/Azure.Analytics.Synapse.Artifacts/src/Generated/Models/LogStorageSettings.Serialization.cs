...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LogStorageSettings>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<LogStorageSettings>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<LogStorageSettings>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<LogStorageSettings>)} interface");
            }
        ...
        string IPersistableModel<LogStorageSettings>.GetWireFormat(ModelReaderWriterOptions options) => "J";
