...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class SetVariableActivity : IUtf8JsonSerializable
    {
        ...
        internal static SetVariableActivity DeserializeSetVariableActivity(JsonElement element)
        {
            ...
            return new SetVariableActivity(name, type, description.HasValue ? description.Value : null, new ChangeTrackingList<ActivityDependency>(dependsOn), new ChangeTrackingList<UserProperty>(userProperties), additionalProperties, variableName.HasValue ? variableName.Value : null, value.HasValue ? value.Value : null);
        }
    }
}
