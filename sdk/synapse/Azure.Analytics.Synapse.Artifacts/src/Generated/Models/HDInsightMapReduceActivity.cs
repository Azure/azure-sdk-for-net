...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class HDInsightMapReduceActivity : ExecutionActivity
    {
        ...
        internal HDInsightMapReduceActivity(string name, string type, string description, IList<ActivityDependency> dependsOn, IList<UserProperty> userProperties, IDictionary<string, object> additionalProperties, LinkedServiceReferenceAutoGenerated linkedServiceName, ActivityPolicy policy, IList<LinkedServiceReferenceAutoGenerated> storageLinkedServices, IList<object> arguments, HDInsightActivityDebugInfoOption? getDebugInfo, object className, object jarFilePath, LinkedServiceReferenceAutoGenerated jarLinkedService, IList<object> jarLibs, IDictionary<string, object> defines) : base(name, type, description, dependsOn, userProperties, additionalProperties, linkedServiceName, policy)
        {
        ...
        public LinkedServiceReferenceAutoGenerated JarLinkedService { get; set; }
