...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class CassandraLinkedService : IUtf8JsonSerializable
    {
        ...
        internal static CassandraLinkedService DeserializeCassandraLinkedService(JsonElement element)
        {
            ...
            return new CassandraLinkedService(type, connectVia.Value, description.Value, Optional.ToDictionary(parameters), annotations ?? new ChangeTrackingList<object>(), additionalProperties, host, authenticationType.Value, port.Value, username.Value, password.Value, encryptedCredential.Value);
        }
