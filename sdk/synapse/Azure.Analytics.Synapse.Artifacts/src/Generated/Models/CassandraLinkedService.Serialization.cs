...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class CassandraLinkedService : IUtf8JsonSerializable
    {
        ...
        internal static CassandraLinkedService DeserializeCassandraLinkedService(JsonElement element)
        {
            ...
            return new CassandraLinkedService(type, connectVia.HasValue ? connectVia.Value : null, description.HasValue ? description.Value : null, new ChangeTrackingDictionary<string, ParameterSpecification>(parameters), new ChangeTrackingList<object>(annotations), additionalProperties, host, authenticationType.HasValue ? authenticationType.Value : null, port.HasValue ? port.Value : null, username.HasValue ? username.Value : null, password.HasValue ? password.Value : null, encryptedCredential.HasValue ? encryptedCredential.Value : null);
        }
    }
}
