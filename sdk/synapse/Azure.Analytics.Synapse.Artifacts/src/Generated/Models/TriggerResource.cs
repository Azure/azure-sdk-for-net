...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class TriggerResource : SubResource
    {
        ...
        internal TriggerResource(string id, string name, string type, string etag, Trigger properties, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, type, etag, serializedAdditionalRawData)
        {
            Properties = properties;
        }
