...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class TriggerResource : SubResource
    {
        ...
        /// The available derived classes include <see cref="BlobEventsTrigger"/>, <see cref="BlobTrigger"/>, <see cref="ChainingTrigger"/>, <see cref="CustomEventsTrigger"/>, <see cref="MultiplePipelineTrigger"/>, <see cref="RerunTumblingWindowTrigger"/>, <see cref="ScheduleTrigger"/> and <see cref="TumblingWindowTrigger"/>.
        /// </param>
        internal TriggerResource(string id, string name, string type, IDictionary<string, BinaryData> serializedAdditionalRawData, string etag, Trigger properties) : base(id, name, type, serializedAdditionalRawData, etag)
        {
            Properties = properties;
        }

        /// <summary> Initializes a new instance of <see cref="TriggerResource"/> for deserialization. </summary>
        internal TriggerResource()
        {
        }
