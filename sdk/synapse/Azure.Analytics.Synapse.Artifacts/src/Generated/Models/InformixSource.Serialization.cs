...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class InformixSource : IUtf8JsonSerializable
    {
        ...
        internal static InformixSource DeserializeInformixSource(JsonElement element)
        {
            ...
            return new InformixSource(type, sourceRetryCount.Value, sourceRetryWait.Value, maxConcurrentConnections.Value, additionalProperties, queryTimeout.Value, query.Value);
        }
    }
}
