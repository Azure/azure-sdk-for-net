...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class NotebookCellOutputItem : IUtf8JsonSerializable
    {
        ...
        internal static NotebookCellOutputItem DeserializeNotebookCellOutputItem(JsonElement element)
        {
            ...
            return new NotebookCellOutputItem(name.HasValue ? name.Value : null, executionCount.HasValue ? executionCount.Value : (int?)null, outputType, text.HasValue ? text.Value : null, data.HasValue ? data.Value : null, metadata.HasValue ? metadata.Value : null);
        }
    }
}
