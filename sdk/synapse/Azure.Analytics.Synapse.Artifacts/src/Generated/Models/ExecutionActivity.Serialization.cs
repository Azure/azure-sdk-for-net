...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class ExecutionActivity : IUtf8JsonSerializable
    {
        ...
        internal static ExecutionActivity DeserializeExecutionActivity(JsonElement element)
        {
            ...
            return new ExecutionActivity(name, type, description.HasValue ? description.Value : null, new ChangeTrackingList<ActivityDependency>(dependsOn), new ChangeTrackingList<UserProperty>(userProperties), additionalProperties, linkedServiceName.HasValue ? linkedServiceName.Value : null, policy.HasValue ? policy.Value : null);
        }
    }
}
