...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class SalesforceLinkedService : Core.IUtf8JsonSerializable
    {
        void Core.IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            writer.WriteStartObject();
            if (Core.Optional.IsDefined(EnvironmentUrl))
            {
        ...
        internal static SalesforceLinkedService DeserializeSalesforceLinkedService(JsonElement element)
        {
            ...
            Core.Optional<object> environmentUrl = default;
            Core.Optional<object> username = default;
            Core.Optional<SecretBase> password = default;
            Core.Optional<SecretBase> securityToken = default;
            Core.Optional<object> apiVersion = default;
            ...
            return new SalesforceLinkedService(type, connectVia.Value, description.Value, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), additionalProperties, environmentUrl.Value, username.Value, password.Value, securityToken.Value, apiVersion.Value, encryptedCredential.Value);
        }
