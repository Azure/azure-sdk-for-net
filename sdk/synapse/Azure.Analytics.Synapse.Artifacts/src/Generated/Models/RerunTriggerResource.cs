...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class RerunTriggerResource : SubResource
    {
        ...
        internal RerunTriggerResource(string id, string name, string type, string etag, RerunTumblingWindowTrigger properties, Dictionary<string, BinaryData> rawData) : base(id, name, type, etag, rawData)
        {
            Properties = properties;
        }
