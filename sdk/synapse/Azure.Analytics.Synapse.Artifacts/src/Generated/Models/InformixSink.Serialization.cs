...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<InformixSink>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<InformixSink>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<InformixSink>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<InformixSink>)} interface");
            }
        ...
        string IPersistableModel<InformixSink>.GetWireFormat(ModelReaderWriterOptions options) => "J";
