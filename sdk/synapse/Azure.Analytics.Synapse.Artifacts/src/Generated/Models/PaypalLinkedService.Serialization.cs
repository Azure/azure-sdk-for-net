...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class PaypalLinkedService : IUtf8JsonSerializable, IJsonModel<PaypalLinkedService>
    {
        ...
        void IJsonModel<PaypalLinkedService>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(PaypalLinkedService)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<PaypalLinkedService>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(PaypalLinkedService)} does not support '{options.Format}' format.");
            }
        }
