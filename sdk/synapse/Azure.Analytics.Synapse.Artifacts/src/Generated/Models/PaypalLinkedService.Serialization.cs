...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class PaypalLinkedService : IUtf8JsonSerializable
    {
        ...
        internal static PaypalLinkedService DeserializePaypalLinkedService(JsonElement element)
        {
            ...
            return new PaypalLinkedService(type, connectVia.HasValue ? connectVia.Value : null, description.HasValue ? description.Value : null, new ChangeTrackingDictionary<string, ParameterSpecification>(parameters), new ChangeTrackingList<object>(annotations), additionalProperties, host, clientId, clientSecret.HasValue ? clientSecret.Value : null, useEncryptedEndpoints.HasValue ? useEncryptedEndpoints.Value : null, useHostVerification.HasValue ? useHostVerification.Value : null, usePeerVerification.HasValue ? usePeerVerification.Value : null, encryptedCredential.HasValue ? encryptedCredential.Value : null);
        }
    }
}
