...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PaypalLinkedService>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PaypalLinkedService>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PaypalLinkedService>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PaypalLinkedService>)} interface");
            }
        ...
        string IPersistableModel<PaypalLinkedService>.GetWireFormat(ModelReaderWriterOptions options) => "J";
