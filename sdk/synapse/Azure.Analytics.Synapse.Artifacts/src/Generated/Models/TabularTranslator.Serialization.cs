...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TabularTranslator>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<TabularTranslator>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<TabularTranslator>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<TabularTranslator>.GetWireFormat(ModelReaderWriterOptions options) => "J";
