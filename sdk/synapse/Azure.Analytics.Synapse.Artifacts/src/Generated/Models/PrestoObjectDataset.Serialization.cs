...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class PrestoObjectDataset : IUtf8JsonSerializable
    {
        ...
        internal static PrestoObjectDataset DeserializePrestoObjectDataset(JsonElement element)
        {
            ...
            return new PrestoObjectDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Optional.ToDictionary(parameters), annotations ?? new ChangeTrackingList<object>(), folder.Value, additionalProperties, tableName.Value, table.Value, schema0.Value);
        }
