...
{
    [JsonConverter(typeof(PrestoObjectDatasetConverter))]
    public partial class PrestoObjectDataset : IUtf8JsonSerializable
    {
        ...
        {
            public override void Write(Utf8JsonWriter writer, PrestoObjectDataset model, JsonSerializerOptions options)
            {
                writer.WriteObjectValue(model);
            }
            public override PrestoObjectDataset Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
            {
                using var document = JsonDocument.ParseValue(ref reader);
                return DeserializePrestoObjectDataset(document.RootElement);
            }
        }
    }
}
