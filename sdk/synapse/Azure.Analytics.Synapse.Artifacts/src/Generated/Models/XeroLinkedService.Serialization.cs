...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class XeroLinkedService : IUtf8JsonSerializable
    {
        ...
        internal static XeroLinkedService DeserializeXeroLinkedService(JsonElement element)
        {
            ...
            return new XeroLinkedService(type, connectVia.HasValue ? connectVia.Value : null, description.HasValue ? description.Value : null, new ChangeTrackingDictionary<string, ParameterSpecification>(parameters), new ChangeTrackingList<object>(annotations), additionalProperties, host, consumerKey.HasValue ? consumerKey.Value : null, privateKey.HasValue ? privateKey.Value : null, useEncryptedEndpoints.HasValue ? useEncryptedEndpoints.Value : null, useHostVerification.HasValue ? useHostVerification.Value : null, usePeerVerification.HasValue ? usePeerVerification.Value : null, encryptedCredential.HasValue ? encryptedCredential.Value : null);
        }
    }
}
