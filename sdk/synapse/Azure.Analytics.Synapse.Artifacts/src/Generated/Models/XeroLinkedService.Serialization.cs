                ...
                if (property.NameEquals("typeProperties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("consumerKey"u8))
                        {
                            ...
                            consumerKey = ModelSerializationExtensions.JsonDeserialize<SecretBase>(property0.Value);
                            continue;
                        }
                        if (property0.NameEquals("privateKey"u8))
                        {
                            ...
                            privateKey = ModelSerializationExtensions.JsonDeserialize<SecretBase>(property0.Value);
                            continue;
                        }
