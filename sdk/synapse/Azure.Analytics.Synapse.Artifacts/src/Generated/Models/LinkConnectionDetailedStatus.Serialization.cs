...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class LinkConnectionDetailedStatus : IUtf8JsonSerializable, IModelJsonSerializable<LinkConnectionDetailedStatus>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<LinkConnectionDetailedStatus>(this, options.Format);
            ...
            if (Optional.IsDefined(RefreshStatus))
            {
                ...
                {
                    ((IModelJsonSerializable<LinkConnectionRefreshStatus>)RefreshStatus).Serialize(writer, options);
                }
            }
        ...
        /// <summary> Converts a <see cref="LinkConnectionDetailedStatus"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="LinkConnectionDetailedStatus"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="LinkConnectionDetailedStatus"/>. </summary>
