...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    {
        internal static LinkConnectionDetailedStatus DeserializeLinkConnectionDetailedStatus(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
