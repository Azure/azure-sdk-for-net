...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LinkConnectionDetailedStatus>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<LinkConnectionDetailedStatus>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<LinkConnectionDetailedStatus>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<LinkConnectionDetailedStatus>)} interface");
            }
        ...
        string IPersistableModel<LinkConnectionDetailedStatus>.GetWireFormat(ModelReaderWriterOptions options) => "J";
