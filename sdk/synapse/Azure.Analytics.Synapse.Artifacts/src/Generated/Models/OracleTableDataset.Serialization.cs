...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class OracleTableDataset : IUtf8JsonSerializable
    {
        ...
        internal static OracleTableDataset DeserializeOracleTableDataset(JsonElement element)
        {
            ...
            return new OracleTableDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Optional.ToDictionary(parameters), annotations ?? new ChangeTrackingList<object>(), folder.Value, additionalProperties, tableName.Value, schema0.Value, table.Value);
        }
