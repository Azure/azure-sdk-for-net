...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<OracleTableDataset>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<OracleTableDataset>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<OracleTableDataset>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<OracleTableDataset>)} interface");
            }
        ...
        string IPersistableModel<OracleTableDataset>.GetWireFormat(ModelReaderWriterOptions options) => "J";
