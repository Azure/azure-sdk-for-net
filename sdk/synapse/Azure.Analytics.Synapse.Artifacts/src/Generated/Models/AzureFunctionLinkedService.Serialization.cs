...
#if NET6_0_OR_GREATER
				writer.WriteRawValue(FunctionAppUrl);
#else
            JsonSerializer.Serialize(writer, JsonDocument.Parse(FunctionAppUrl.ToString()).RootElement);
#endif
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("typeProperties"))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        {
                            functionAppUrl = BinaryData.FromString(property.Value.GetRawText());
                            continue;
                        }
