...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class AzureFunctionLinkedService : IUtf8JsonSerializable
    {
        ...
        internal static AzureFunctionLinkedService DeserializeAzureFunctionLinkedService(JsonElement element)
        {
            ...
            return new AzureFunctionLinkedService(type, connectVia.HasValue ? connectVia.Value : null, description.HasValue ? description.Value : null, new ChangeTrackingDictionary<string, ParameterSpecification>(parameters), new ChangeTrackingList<object>(annotations), additionalProperties, functionAppUrl, functionKey.HasValue ? functionKey.Value : null, encryptedCredential.HasValue ? encryptedCredential.Value : null);
        }
    }
}
