...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class AzureFunctionLinkedService : IUtf8JsonSerializable
    {
        ...
        internal static AzureFunctionLinkedService DeserializeAzureFunctionLinkedService(JsonElement element)
        {
            ...
            return new AzureFunctionLinkedService(type, connectVia.Value, description.Value, parameters ?? new ChangeTrackingDictionary<string, ParameterSpecification>(), annotations ?? new ChangeTrackingList<object>(), additionalProperties, functionAppUrl, functionKey.Value, encryptedCredential.Value, credential.Value, resourceId.Value, authentication.Value);
        }
