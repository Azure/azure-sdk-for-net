...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class SalesforceServiceCloudLinkedService : IUtf8JsonSerializable, IJsonModel<SalesforceServiceCloudLinkedService>
    {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<SalesforceServiceCloudLinkedService>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(SalesforceServiceCloudLinkedService)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<SalesforceServiceCloudLinkedService>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(SalesforceServiceCloudLinkedService)} does not support '{options.Format}' format.");
            }
        }
