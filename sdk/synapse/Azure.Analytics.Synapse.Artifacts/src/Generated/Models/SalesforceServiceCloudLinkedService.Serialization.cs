...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class SalesforceServiceCloudLinkedService : IUtf8JsonSerializable
    {
        ...
        internal static SalesforceServiceCloudLinkedService DeserializeSalesforceServiceCloudLinkedService(JsonElement element)
        {
            ...
            return new SalesforceServiceCloudLinkedService(type, connectVia.HasValue ? connectVia.Value : null, description.HasValue ? description.Value : null, new ChangeTrackingDictionary<string, ParameterSpecification>(parameters), new ChangeTrackingList<object>(annotations), additionalProperties, environmentUrl.HasValue ? environmentUrl.Value : null, username.HasValue ? username.Value : null, password.HasValue ? password.Value : null, securityToken.HasValue ? securityToken.Value : null, extendedProperties.HasValue ? extendedProperties.Value : null, encryptedCredential.HasValue ? encryptedCredential.Value : null);
        }
    }
}
