...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class RerunTriggerResource : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            writer.WriteObjectValue<RerunTumblingWindowTrigger>(Properties);
        ...
        internal static new RerunTriggerResource FromResponse(Response response)
        {
        ...
        internal override RequestContent ToRequestContent()
        {
            ...
            content.JsonWriter.WriteObjectValue<RerunTriggerResource>(this);
            return content;
        }
        ...
        internal partial class RerunTriggerResourceConverter : JsonConverter<RerunTriggerResource>
        {
            ...
            {
                writer.WriteObjectValue<RerunTriggerResource>(model);
            }
