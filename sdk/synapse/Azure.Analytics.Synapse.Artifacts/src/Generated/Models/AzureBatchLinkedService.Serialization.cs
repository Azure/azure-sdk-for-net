...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class AzureBatchLinkedService : IUtf8JsonSerializable
    {
        ...
        internal static AzureBatchLinkedService DeserializeAzureBatchLinkedService(JsonElement element)
        {
            ...
            return new AzureBatchLinkedService(type, connectVia.HasValue ? connectVia.Value : null, description.HasValue ? description.Value : null, new ChangeTrackingDictionary<string, ParameterSpecification>(parameters), new ChangeTrackingList<object>(annotations), additionalProperties, accountName, accessKey.HasValue ? accessKey.Value : null, batchUri, poolName, linkedServiceName, encryptedCredential.HasValue ? encryptedCredential.Value : null);
        }
    }
}
