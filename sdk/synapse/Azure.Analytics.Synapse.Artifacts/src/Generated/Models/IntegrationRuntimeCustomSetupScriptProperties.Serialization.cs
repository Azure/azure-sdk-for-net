...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IntegrationRuntimeCustomSetupScriptProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<IntegrationRuntimeCustomSetupScriptProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<IntegrationRuntimeCustomSetupScriptProperties>)} interface");
            }
        ...
        string IPersistableModel<IntegrationRuntimeCustomSetupScriptProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
