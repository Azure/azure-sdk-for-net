...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class LinkConnectionResource
    {
        ...
        internal LinkConnectionResource(string id, string name, string type, LinkConnection properties, string description, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Name = name;
            Type = type;
