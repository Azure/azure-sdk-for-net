...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class SftpReadSettings : Core.IUtf8JsonSerializable
    {
        ...
        internal static SftpReadSettings DeserializeSftpReadSettings(JsonElement element)
        {
            ...
            return new SftpReadSettings(type, maxConcurrentConnections.Value, additionalProperties, recursive.Value, wildcardFolderPath.Value, wildcardFileName.Value, Core.Optional.ToNullable(enablePartitionDiscovery), partitionRootPath.Value, fileListPath.Value, deleteFilesAfterCompletion.Value, modifiedDatetimeStart.Value, modifiedDatetimeEnd.Value, disableChunking.Value);
        }
