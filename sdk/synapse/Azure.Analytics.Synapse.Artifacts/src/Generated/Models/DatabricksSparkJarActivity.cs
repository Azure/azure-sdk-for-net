...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class DatabricksSparkJarActivity : ExecutionActivity
    {
        ...
        internal DatabricksSparkJarActivity(string name, string type, string description, IList<ActivityDependency> dependsOn, IList<UserProperty> userProperties, IDictionary<string, object> additionalProperties, LinkedServiceReferenceAutoGenerated linkedServiceName, ActivityPolicy policy, object mainClassName, IList<object> parameters, IList<IDictionary<string, object>> libraries) : base(name, type, description, dependsOn, userProperties, additionalProperties, linkedServiceName, policy)
        {
            MainClassName = mainClassName;
