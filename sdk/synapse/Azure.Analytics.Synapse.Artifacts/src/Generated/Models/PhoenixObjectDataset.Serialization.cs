...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class PhoenixObjectDataset : IUtf8JsonSerializable
    {
        ...
        internal static PhoenixObjectDataset DeserializePhoenixObjectDataset(JsonElement element)
        {
            ...
            return new PhoenixObjectDataset(type, description, structure, schema, linkedServiceName, parameters, annotations, folder, additionalProperties, tableName, table, schema0);
        }
    }
}
