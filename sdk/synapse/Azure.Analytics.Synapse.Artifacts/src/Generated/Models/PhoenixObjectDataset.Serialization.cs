...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class PhoenixObjectDataset : Core.IUtf8JsonSerializable
    {
        ...
        internal static PhoenixObjectDataset DeserializePhoenixObjectDataset(JsonElement element)
        {
            ...
            return new PhoenixObjectDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), folder.Value, additionalProperties, tableName.Value, table.Value, schema0.Value);
        }
