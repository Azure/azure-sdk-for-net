...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class CouchbaseLinkedService : IUtf8JsonSerializable
    {
        ...
        internal static CouchbaseLinkedService DeserializeCouchbaseLinkedService(JsonElement element)
        {
            ...
            return new CouchbaseLinkedService(type, connectVia.HasValue ? connectVia.Value : null, description.HasValue ? description.Value : null, new ChangeTrackingDictionary<string, ParameterSpecification>(parameters), new ChangeTrackingList<object>(annotations), additionalProperties, connectionString.HasValue ? connectionString.Value : null, credString.HasValue ? credString.Value : null, encryptedCredential.HasValue ? encryptedCredential.Value : null);
        }
    }
}
