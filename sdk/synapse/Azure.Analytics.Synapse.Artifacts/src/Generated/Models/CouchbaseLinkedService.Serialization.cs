...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class CouchbaseLinkedService : Core.IUtf8JsonSerializable
    {
        ...
        internal static CouchbaseLinkedService DeserializeCouchbaseLinkedService(JsonElement element)
        {
            ...
            Core.Optional<AzureKeyVaultSecretReference> credString = default;
            ...
            return new CouchbaseLinkedService(type, connectVia.Value, description.Value, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), additionalProperties, connectionString.Value, credString.Value, encryptedCredential.Value);
        }
