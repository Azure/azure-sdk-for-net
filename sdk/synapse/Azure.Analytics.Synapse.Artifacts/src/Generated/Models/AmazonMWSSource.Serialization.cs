...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class AmazonMWSSource : IUtf8JsonSerializable
    {
        ...
        internal static AmazonMWSSource DeserializeAmazonMWSSource(JsonElement element)
        {
            ...
            return new AmazonMWSSource(type, sourceRetryCount.Value, sourceRetryWait.Value, maxConcurrentConnections.Value, additionalProperties, queryTimeout.Value, query.Value);
        }
