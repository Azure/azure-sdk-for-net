...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class JsonFormat : DatasetStorageFormat
    {
        ...
        internal JsonFormat(string type, BinaryData serializer, BinaryData deserializer, IDictionary<string, BinaryData> additionalProperties, BinaryData filePattern, BinaryData nestingSeparator, BinaryData encodingName, BinaryData jsonNodeReference, BinaryData jsonPathDefinition) : base(type, serializer, deserializer, additionalProperties)
        {
