...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class ZohoLinkedService : IUtf8JsonSerializable
    {
        ...
        internal static ZohoLinkedService DeserializeZohoLinkedService(JsonElement element)
        {
            ...
            return new ZohoLinkedService(type, connectVia.HasValue ? connectVia.Value : null, description.HasValue ? description.Value : null, new ChangeTrackingDictionary<string, ParameterSpecification>(parameters), new ChangeTrackingList<object>(annotations), additionalProperties, endpoint, accessToken.HasValue ? accessToken.Value : null, useEncryptedEndpoints.HasValue ? useEncryptedEndpoints.Value : null, useHostVerification.HasValue ? useHostVerification.Value : null, usePeerVerification.HasValue ? usePeerVerification.Value : null, encryptedCredential.HasValue ? encryptedCredential.Value : null);
        }
    }
}
