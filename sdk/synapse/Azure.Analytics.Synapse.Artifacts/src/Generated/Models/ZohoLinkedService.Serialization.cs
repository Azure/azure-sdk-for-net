...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class ZohoLinkedService : IUtf8JsonSerializable, IModelJsonSerializable<ZohoLinkedService>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IModelJsonSerializable<ZohoLinkedService>)this).Serialize(writer, ModelSerializerOptions.DefaultWireOptions);

        void IModelJsonSerializable<ZohoLinkedService>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<ZohoLinkedService>(this, options.Format);
        ...
        internal static ZohoLinkedService DeserializeZohoLinkedService(JsonElement element, ModelSerializerOptions options = default)
        {
        ...
        ZohoLinkedService IModelJsonSerializable<ZohoLinkedService>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<ZohoLinkedService>(this, options.Format);

            using var doc = JsonDocument.ParseValue(ref reader);
            return DeserializeZohoLinkedService(doc.RootElement, options);
        }

        BinaryData IModelSerializable<ZohoLinkedService>.Serialize(ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<ZohoLinkedService>(this, options.Format);
        ...
        ZohoLinkedService IModelSerializable<ZohoLinkedService>.Deserialize(BinaryData data, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<ZohoLinkedService>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="ZohoLinkedService"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="ZohoLinkedService"/> to convert. </param>
        public static implicit operator RequestContent(ZohoLinkedService model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="ZohoLinkedService"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator ZohoLinkedService(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeZohoLinkedService(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
