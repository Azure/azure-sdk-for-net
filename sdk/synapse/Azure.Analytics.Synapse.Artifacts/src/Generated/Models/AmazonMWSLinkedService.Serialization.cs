...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class AmazonMWSLinkedService : IUtf8JsonSerializable
    {
        ...
        internal static AmazonMWSLinkedService DeserializeAmazonMWSLinkedService(JsonElement element)
        {
            ...
            return new AmazonMWSLinkedService(type, connectVia.HasValue ? connectVia.Value : null, description.HasValue ? description.Value : null, new ChangeTrackingDictionary<string, ParameterSpecification>(parameters), new ChangeTrackingList<object>(annotations), additionalProperties, endpoint, marketplaceID, sellerID, mwsAuthToken.HasValue ? mwsAuthToken.Value : null, accessKeyId, secretKey.HasValue ? secretKey.Value : null, useEncryptedEndpoints.HasValue ? useEncryptedEndpoints.Value : null, useHostVerification.HasValue ? useHostVerification.Value : null, usePeerVerification.HasValue ? usePeerVerification.Value : null, encryptedCredential.HasValue ? encryptedCredential.Value : null);
        }
    }
}
