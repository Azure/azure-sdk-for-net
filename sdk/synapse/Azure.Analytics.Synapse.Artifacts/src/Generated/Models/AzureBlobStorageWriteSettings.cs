...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class AzureBlobStorageWriteSettings : StoreWriteSettings
    {
        ...
        internal AzureBlobStorageWriteSettings(string type, BinaryData maxConcurrentConnections, BinaryData copyBehavior, IDictionary<string, BinaryData> additionalProperties, BinaryData blockSizeInMB) : base(type, maxConcurrentConnections, copyBehavior, additionalProperties)
        {
