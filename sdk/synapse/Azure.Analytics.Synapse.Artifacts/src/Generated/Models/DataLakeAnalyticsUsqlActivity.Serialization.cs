...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class DataLakeAnalyticsUsqlActivity : Core.IUtf8JsonSerializable
    {
        ...
        internal static DataLakeAnalyticsUsqlActivity DeserializeDataLakeAnalyticsUsqlActivity(JsonElement element)
        {
            ...
            Core.Optional<object> degreeOfParallelism = default;
            Core.Optional<object> priority = default;
            Core.Optional<IDictionary<string, object>> parameters = default;
            Core.Optional<object> runtimeVersion = default;
            Core.Optional<object> compilationMode = default;
            ...
            return new DataLakeAnalyticsUsqlActivity(name, type, description.Value, Core.Optional.ToNullable(state), Core.Optional.ToNullable(onInactiveMarkAs), Core.Optional.ToList(dependsOn), Core.Optional.ToList(userProperties), additionalProperties, linkedServiceName.Value, policy.Value, scriptPath, scriptLinkedService, degreeOfParallelism.Value, priority.Value, Core.Optional.ToDictionary(parameters), runtimeVersion.Value, compilationMode.Value);
        }
