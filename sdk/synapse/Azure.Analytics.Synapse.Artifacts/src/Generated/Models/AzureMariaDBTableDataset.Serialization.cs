...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class AzureMariaDBTableDataset : IUtf8JsonSerializable
    {
        ...
        internal static AzureMariaDBTableDataset DeserializeAzureMariaDBTableDataset(JsonElement element)
        {
            ...
            return new AzureMariaDBTableDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Optional.ToDictionary(parameters), annotations ?? new ChangeTrackingList<object>(), folder.Value, additionalProperties, tableName.Value);
        }
