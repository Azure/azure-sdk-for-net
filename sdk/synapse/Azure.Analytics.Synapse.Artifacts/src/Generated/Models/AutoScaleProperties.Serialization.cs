...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class AutoScaleProperties : IUtf8JsonSerializable, IJsonModel<AutoScaleProperties>
    {
        ...
        void IJsonModel<AutoScaleProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(AutoScaleProperties)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<AutoScaleProperties>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(AutoScaleProperties)} does not support '{options.Format}' format.");
            }
        }
