...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AutoScaleProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AutoScaleProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AutoScaleProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AutoScaleProperties>)} interface");
            }
        ...
        string IPersistableModel<AutoScaleProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
