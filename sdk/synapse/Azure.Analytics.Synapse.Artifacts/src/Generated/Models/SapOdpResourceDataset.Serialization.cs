...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class SapOdpResourceDataset : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            writer.WriteObjectValue<object>(Context);
            writer.WritePropertyName("objectName"u8);
            writer.WriteObjectValue<object>(ObjectName);
            writer.WriteEndObject();
        ...
        internal static new SapOdpResourceDataset FromResponse(Response response)
        {
        ...
        internal override RequestContent ToRequestContent()
        {
            ...
            content.JsonWriter.WriteObjectValue<SapOdpResourceDataset>(this);
            return content;
        }
        ...
        internal partial class SapOdpResourceDatasetConverter : JsonConverter<SapOdpResourceDataset>
        {
            ...
            {
                writer.WriteObjectValue<SapOdpResourceDataset>(model);
            }
