...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class SapOdpResourceDataset : IUtf8JsonSerializable
    {
        ...
        internal static SapOdpResourceDataset DeserializeSapOdpResourceDataset(JsonElement element)
        {
            ...
            return new SapOdpResourceDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Optional.ToDictionary(parameters), annotations ?? new ChangeTrackingList<object>(), folder.Value, additionalProperties, context, objectName);
        }
