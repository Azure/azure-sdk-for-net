...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class RunNotebookSnapshot
    {
        ...
        internal RunNotebookSnapshot(string exitValue, string id, string notebook, RunNotebookSparkSessionOptions sessionOptions, bool? honorSessionTimeToLive, long? sessionId, string sparkPool, IReadOnlyDictionary<string, RunNotebookParameter> parameters, NotebookResource notebookContent, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ExitValue = exitValue;
            Id = id;
            Notebook = notebook;
