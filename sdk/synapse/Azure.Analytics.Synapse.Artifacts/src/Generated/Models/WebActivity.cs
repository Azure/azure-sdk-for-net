...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class WebActivity : ExecutionActivity
    {
        ...
        internal WebActivity(string name, string type, string description, IList<ActivityDependency> dependsOn, IList<UserProperty> userProperties, IDictionary<string, object> additionalProperties, LinkedServiceReferenceAutoGenerated linkedServiceName, ActivityPolicy policy, WebActivityMethod method, object url, object headers, object body, WebActivityAuthentication authentication, IList<DatasetReference> datasets, IList<LinkedServiceReferenceAutoGenerated> linkedServices, IntegrationRuntimeReference connectVia) : base(name, type, description, dependsOn, userProperties, additionalProperties, linkedServiceName, policy)
        {
            Method = method;
            Url = url;
            Headers = headers;
