...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ImpalaLinkedService>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ImpalaLinkedService>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ImpalaLinkedService>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ImpalaLinkedService>)} interface");
            }
        ...
        string IPersistableModel<ImpalaLinkedService>.GetWireFormat(ModelReaderWriterOptions options) => "J";
