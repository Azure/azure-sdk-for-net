...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class AzureMLUpdateResourceActivity : ExecutionActivity
    {
        ...
        public AzureMLUpdateResourceActivity(string name, object trainedModelName, LinkedServiceReferenceAutoGenerated trainedModelLinkedServiceName, object trainedModelFilePath) : base(name)
        {
            if (name == null)
            {
        ...
        /// <param name="trainedModelLinkedServiceName"> Name of Azure Storage linked service holding the .ilearner file that will be uploaded by the update operation. </param>
        /// <param name="trainedModelFilePath"> The relative file path in trainedModelLinkedService to represent the .ilearner file that will be uploaded by the update operation.  Type: string (or Expression with resultType string). </param>
        internal AzureMLUpdateResourceActivity(string name, string type, string description, IList<ActivityDependency> dependsOn, IList<UserProperty> userProperties, IDictionary<string, object> additionalProperties, LinkedServiceReferenceAutoGenerated linkedServiceName, ActivityPolicy policy, object trainedModelName, LinkedServiceReferenceAutoGenerated trainedModelLinkedServiceName, object trainedModelFilePath) : base(name, type, description, dependsOn, userProperties, additionalProperties, linkedServiceName, policy)
        {
            TrainedModelName = trainedModelName;
            TrainedModelLinkedServiceName = trainedModelLinkedServiceName;
            TrainedModelFilePath = trainedModelFilePath;
        ...
        public LinkedServiceReferenceAutoGenerated TrainedModelLinkedServiceName { get; set; }
