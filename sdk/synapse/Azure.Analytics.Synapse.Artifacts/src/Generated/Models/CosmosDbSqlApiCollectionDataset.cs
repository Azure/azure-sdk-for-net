...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class CosmosDbSqlApiCollectionDataset : Dataset
    {
        ...
        public CosmosDbSqlApiCollectionDataset(LinkedServiceReferenceAutoGenerated linkedServiceName, object collectionName) : base(linkedServiceName)
        {
        ...
        /// <param name="collectionName"> CosmosDB (SQL API) collection name. Type: string (or Expression with resultType string). </param>
        internal CosmosDbSqlApiCollectionDataset(string type, string description, object structure, object schema, LinkedServiceReferenceAutoGenerated linkedServiceName, IDictionary<string, ParameterSpecification> parameters, IList<object> annotations, DatasetFolder folder, IDictionary<string, object> additionalProperties, object collectionName) : base(type, description, structure, schema, linkedServiceName, parameters, annotations, folder, additionalProperties)
        {
            CollectionName = collectionName;
