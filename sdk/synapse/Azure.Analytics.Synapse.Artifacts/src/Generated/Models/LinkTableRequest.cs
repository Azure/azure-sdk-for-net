...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class LinkTableRequest
    {
        ...
        internal LinkTableRequest(string id, LinkTableRequestSource source, LinkTableRequestTarget target, string operationType, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Source = source;
            Target = target;
