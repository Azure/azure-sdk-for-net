...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class ServiceNowObjectDataset : Dataset
    {
        ...
        public ServiceNowObjectDataset(LinkedServiceReferenceAutoGenerated linkedServiceName) : base(linkedServiceName)
        {
        ...
        internal ServiceNowObjectDataset(string type, string description, object structure, object schema, LinkedServiceReferenceAutoGenerated linkedServiceName, IDictionary<string, ParameterSpecification> parameters, IList<object> annotations, DatasetFolder folder, IDictionary<string, object> additionalProperties, object tableName) : base(type, description, structure, schema, linkedServiceName, parameters, annotations, folder, additionalProperties)
        {
            TableName = tableName;
