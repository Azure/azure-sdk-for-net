...
{
    [JsonConverter(typeof(AzureDataExplorerTableDatasetConverter))]
    public partial class AzureDataExplorerTableDataset : IUtf8JsonSerializable
    {
        ...
        {
            public override void Write(Utf8JsonWriter writer, AzureDataExplorerTableDataset model, JsonSerializerOptions options)
            {
                writer.WriteObjectValue(model);
            }
            public override AzureDataExplorerTableDataset Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
            {
                using var document = JsonDocument.ParseValue(ref reader);
                return DeserializeAzureDataExplorerTableDataset(document.RootElement);
            }
        }
    }
}
