...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class AzureDataExplorerTableDataset : IUtf8JsonSerializable
    {
        ...
        internal static AzureDataExplorerTableDataset DeserializeAzureDataExplorerTableDataset(JsonElement element)
        {
            ...
            return new AzureDataExplorerTableDataset(type, description.HasValue ? description.Value : null, structure.HasValue ? structure.Value : null, schema.HasValue ? schema.Value : null, linkedServiceName, new ChangeTrackingDictionary<string, ParameterSpecification>(parameters), new ChangeTrackingList<object>(annotations), folder.HasValue ? folder.Value : null, additionalProperties, table.HasValue ? table.Value : null);
        }
    }
}
