...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class DatasetReference
    {
        ...
        internal DatasetReference(DatasetReferenceType type, string referenceName, IDictionary<string, object> parameters, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Type = type;
            ReferenceName = referenceName;
