            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("typeProperties"))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        {
                            deploymentType = BinaryData.FromString(property.Value.GetRawText());
                            continue;
                        }
                        if (property0.NameEquals("hostName"))
                        {
                            ...
                            hostName = BinaryData.FromString(property.Value.GetRawText());
                            continue;
                        }
                        ...
                        if (property0.NameEquals("serviceUri"))
                        {
                            ...
                            serviceUri = BinaryData.FromString(property.Value.GetRawText());
                            continue;
                        }
                        if (property0.NameEquals("organizationName"))
                        {
                            ...
                            organizationName = BinaryData.FromString(property.Value.GetRawText());
                            continue;
                        }
