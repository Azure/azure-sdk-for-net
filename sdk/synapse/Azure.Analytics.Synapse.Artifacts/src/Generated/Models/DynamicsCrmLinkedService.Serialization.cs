...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DynamicsCrmLinkedService>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DynamicsCrmLinkedService>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DynamicsCrmLinkedService>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DynamicsCrmLinkedService>)} interface");
            }
        ...
        string IPersistableModel<DynamicsCrmLinkedService>.GetWireFormat(ModelReaderWriterOptions options) => "J";
