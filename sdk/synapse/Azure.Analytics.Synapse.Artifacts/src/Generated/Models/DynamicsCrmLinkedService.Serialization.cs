...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class DynamicsCrmLinkedService : IUtf8JsonSerializable
    {
        ...
        internal static DynamicsCrmLinkedService DeserializeDynamicsCrmLinkedService(JsonElement element)
        {
            ...
            return new DynamicsCrmLinkedService(type, connectVia.HasValue ? connectVia.Value : null, description.HasValue ? description.Value : null, new ChangeTrackingDictionary<string, ParameterSpecification>(parameters), new ChangeTrackingList<object>(annotations), additionalProperties, deploymentType, hostName.HasValue ? hostName.Value : null, port.HasValue ? port.Value : null, serviceUri.HasValue ? serviceUri.Value : null, organizationName.HasValue ? organizationName.Value : null, authenticationType, username.HasValue ? username.Value : null, password.HasValue ? password.Value : null, servicePrincipalId.HasValue ? servicePrincipalId.Value : null, servicePrincipalCredentialType.HasValue ? servicePrincipalCredentialType.Value : (DynamicsServicePrincipalCredentialType?)null, servicePrincipalCredential.HasValue ? servicePrincipalCredential.Value : null, encryptedCredential.HasValue ? encryptedCredential.Value : null);
        }
    }
}
