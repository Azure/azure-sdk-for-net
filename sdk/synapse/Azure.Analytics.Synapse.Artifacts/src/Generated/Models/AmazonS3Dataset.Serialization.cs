...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class AmazonS3Dataset : IUtf8JsonSerializable
    {
        ...
        internal static AmazonS3Dataset DeserializeAmazonS3Dataset(JsonElement element)
        {
            ...
            return new AmazonS3Dataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Optional.ToDictionary(parameters), annotations ?? new ChangeTrackingList<object>(), folder.Value, additionalProperties, bucketName, key.Value, prefix.Value, version.Value, modifiedDatetimeStart.Value, modifiedDatetimeEnd.Value, format.Value, compression.Value);
        }
