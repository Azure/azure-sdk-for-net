...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GitHubClientSecret>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<GitHubClientSecret>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<GitHubClientSecret>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<GitHubClientSecret>.GetWireFormat(ModelReaderWriterOptions options) => "J";
