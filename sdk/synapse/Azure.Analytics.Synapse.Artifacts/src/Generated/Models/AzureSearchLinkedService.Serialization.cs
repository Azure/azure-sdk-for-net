...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class AzureSearchLinkedService : Core.IUtf8JsonSerializable
    {
        ...
        internal static AzureSearchLinkedService DeserializeAzureSearchLinkedService(JsonElement element)
        {
            ...
            object url = default;
            Core.Optional<SecretBase> key = default;
            ...
            return new AzureSearchLinkedService(type, connectVia.Value, description.Value, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), additionalProperties, url, key.Value, encryptedCredential.Value);
        }
