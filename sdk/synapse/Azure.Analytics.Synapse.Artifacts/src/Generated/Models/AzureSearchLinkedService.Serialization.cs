    ...
    public partial class AzureSearchLinkedService : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            if (Optional.IsDefined(Key))
            {
                ...
                writer.WriteObjectValue<SecretBase>(Key);
            }
        ...
        internal static new AzureSearchLinkedService FromResponse(Response response)
        {
        ...
        internal override RequestContent ToRequestContent()
        {
            ...
            content.JsonWriter.WriteObjectValue<AzureSearchLinkedService>(this);
            return content;
        }
        ...
        internal partial class AzureSearchLinkedServiceConverter : JsonConverter<AzureSearchLinkedService>
        {
            ...
            {
                writer.WriteObjectValue<AzureSearchLinkedService>(model);
            }
