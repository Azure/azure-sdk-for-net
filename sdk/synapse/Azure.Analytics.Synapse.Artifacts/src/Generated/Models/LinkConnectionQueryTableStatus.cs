...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class LinkConnectionQueryTableStatus
    {
        ...
        internal LinkConnectionQueryTableStatus(IReadOnlyList<LinkTableStatus> value, object continuationToken, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Value = value;
