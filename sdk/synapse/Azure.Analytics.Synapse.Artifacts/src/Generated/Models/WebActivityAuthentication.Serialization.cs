...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class WebActivityAuthentication : IUtf8JsonSerializable
    {
        ...
        internal static WebActivityAuthentication DeserializeWebActivityAuthentication(JsonElement element)
        {
            ...
            return new WebActivityAuthentication(type, pfx.HasValue ? pfx.Value : null, username.HasValue ? username.Value : null, password.HasValue ? password.Value : null, resource.HasValue ? resource.Value : null);
        }
    }
}
