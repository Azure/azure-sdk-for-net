...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class TumblingWindowTriggerDependencyReference : TriggerDependencyReference
    {
        ...
        internal TumblingWindowTriggerDependencyReference(string type, IDictionary<string, BinaryData> serializedAdditionalRawData, TriggerReference referenceTrigger, string offset, string size) : base(type, serializedAdditionalRawData, referenceTrigger)
        {
            Offset = offset;
            Size = size;
