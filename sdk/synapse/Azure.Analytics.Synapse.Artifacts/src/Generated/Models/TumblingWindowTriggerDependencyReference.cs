...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class TumblingWindowTriggerDependencyReference : TriggerDependencyReference
    {
        ...
        internal TumblingWindowTriggerDependencyReference(string type, TriggerReference referenceTrigger, string offset, string size, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(type, referenceTrigger, serializedAdditionalRawData)
        {
            Offset = offset;
            Size = size;
