...
{
    [JsonConverter(typeof(SybaseTableDatasetConverter))]
    public partial class SybaseTableDataset : IUtf8JsonSerializable
    {
        ...
        internal partial class SybaseTableDatasetConverter : JsonConverter<SybaseTableDataset>
        {
            ...
            public override SybaseTableDataset Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
            {
