...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class SybaseTableDataset : IUtf8JsonSerializable
    {
        ...
        internal static SybaseTableDataset DeserializeSybaseTableDataset(JsonElement element)
        {
            ...
            return new SybaseTableDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Optional.ToDictionary(parameters), annotations ?? new ChangeTrackingList<object>(), folder.Value, additionalProperties, tableName.Value);
        }
