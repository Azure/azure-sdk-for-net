...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class SybaseTableDataset : Core.IUtf8JsonSerializable
    {
        ...
        internal static SybaseTableDataset DeserializeSybaseTableDataset(JsonElement element)
        {
            ...
            return new SybaseTableDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), folder.Value, additionalProperties, tableName.Value);
        }
