...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class RedshiftUnloadSettings : IUtf8JsonSerializable
    {
        ...
        {
            LinkedServiceReferenceAutoGenerated s3LinkedServiceName = default;
            object bucketName = default;
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("s3LinkedServiceName"))
                {
                    s3LinkedServiceName = LinkedServiceReferenceAutoGenerated.DeserializeLinkedServiceReferenceAutoGenerated(property.Value);
                    continue;
                }
