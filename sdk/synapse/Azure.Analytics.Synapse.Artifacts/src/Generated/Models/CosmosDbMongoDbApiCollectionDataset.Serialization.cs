...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class CosmosDbMongoDbApiCollectionDataset : IUtf8JsonSerializable
    {
        ...
        {
            public override void Write(Utf8JsonWriter writer, CosmosDbMongoDbApiCollectionDataset model, JsonSerializerOptions options)
            {
                writer.WriteObjectValue(model);
            }
            public override CosmosDbMongoDbApiCollectionDataset Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
            {
                using var document = JsonDocument.ParseValue(ref reader);
                return DeserializeCosmosDbMongoDbApiCollectionDataset(document.RootElement);
            }
        }
    }
}
