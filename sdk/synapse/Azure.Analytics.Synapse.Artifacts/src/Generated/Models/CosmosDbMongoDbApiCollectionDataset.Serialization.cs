...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class CosmosDbMongoDbApiCollectionDataset : Core.IUtf8JsonSerializable
    {
        ...
        internal static CosmosDbMongoDbApiCollectionDataset DeserializeCosmosDbMongoDbApiCollectionDataset(JsonElement element)
        {
            ...
            return new CosmosDbMongoDbApiCollectionDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), folder.Value, additionalProperties, collection);
        }
