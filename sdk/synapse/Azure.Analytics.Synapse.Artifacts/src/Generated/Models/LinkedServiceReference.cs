...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class LinkedServiceReference
    {
        ...
        internal LinkedServiceReference(LinkedServiceReferenceType type, string referenceName, IDictionary<string, object> parameters, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Type = type;
            ReferenceName = referenceName;
