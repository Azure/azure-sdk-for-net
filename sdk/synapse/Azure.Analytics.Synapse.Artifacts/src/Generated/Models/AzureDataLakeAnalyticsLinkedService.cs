...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class AzureDataLakeAnalyticsLinkedService : LinkedService
    {
        ...
        internal AzureDataLakeAnalyticsLinkedService(string type, IntegrationRuntimeReference connectVia, string description, IDictionary<string, ParameterSpecification> parameters, IList<BinaryData> annotations, IDictionary<string, BinaryData> additionalProperties, BinaryData accountName, BinaryData servicePrincipalId, SecretBase servicePrincipalKey, BinaryData tenant, BinaryData subscriptionId, BinaryData resourceGroupName, BinaryData dataLakeAnalyticsUri, BinaryData encryptedCredential) : base(type, connectVia, description, parameters, annotations, additionalProperties)
        {
            AccountName = accountName;
