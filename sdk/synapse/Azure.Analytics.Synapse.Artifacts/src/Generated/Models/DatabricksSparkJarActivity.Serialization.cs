...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class DatabricksSparkJarActivity : IUtf8JsonSerializable
    {
        ...
        internal static DatabricksSparkJarActivity DeserializeDatabricksSparkJarActivity(JsonElement element)
        {
            ...
            return new DatabricksSparkJarActivity(name, type, description.HasValue ? description.Value : null, new ChangeTrackingList<ActivityDependency>(dependsOn), new ChangeTrackingList<UserProperty>(userProperties), additionalProperties, linkedServiceName.HasValue ? linkedServiceName.Value : null, policy.HasValue ? policy.Value : null, mainClassName, new ChangeTrackingList<object>(parameters), new ChangeTrackingList<IDictionary<string, object>>(libraries));
        }
    }
}
