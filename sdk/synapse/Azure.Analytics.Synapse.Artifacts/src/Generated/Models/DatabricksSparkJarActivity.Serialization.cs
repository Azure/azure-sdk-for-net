...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DatabricksSparkJarActivity>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DatabricksSparkJarActivity>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DatabricksSparkJarActivity>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DatabricksSparkJarActivity>)} interface");
            }
        ...
        string IPersistableModel<DatabricksSparkJarActivity>.GetWireFormat(ModelReaderWriterOptions options) => "J";
