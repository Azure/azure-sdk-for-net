...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    internal partial class UnknownImportSettings : IUtf8JsonSerializable
    {
        ...
        internal static new UnknownImportSettings FromResponse(Response response)
        {
            using var document = JsonDocument.Parse(response.Content);
            return DeserializeUnknownImportSettings(document.RootElement);
        }
        ...
        internal override RequestContent ToRequestContent()
        {
            ...
            content.JsonWriter.WriteObjectValue<UnknownImportSettings>(this);
            return content;
        }
    }
}
