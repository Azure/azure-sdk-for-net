...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class SalesforceSink : IUtf8JsonSerializable, IJsonModel<SalesforceSink>
    {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<SalesforceSink>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(SalesforceSink)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<SalesforceSink>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(SalesforceSink)} does not support '{options.Format}' format.");
            }
        }
