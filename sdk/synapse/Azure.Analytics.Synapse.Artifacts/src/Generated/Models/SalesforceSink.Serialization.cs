...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class SalesforceSink : IUtf8JsonSerializable, IJsonModel<SalesforceSink>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SalesforceSink>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<SalesforceSink>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SalesforceSink>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SalesforceSink>)} interface");
            }
        ...
        SalesforceSink IJsonModel<SalesforceSink>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == "J" || options.Format == "W";
            if (!isValid)
            {
                throw new FormatException($"The model {nameof(SalesforceSink)} does not support '{options.Format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeSalesforceSink(document.RootElement, options);
        }

        internal static SalesforceSink DeserializeSalesforceSink(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<SalesforceSink>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == "J" || options.Format == "W";
            if (!isValid)
            {
        ...
        SalesforceSink IPersistableModel<SalesforceSink>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == "J" || options.Format == "W";
            if (!isValid)
            {
        ...
        string IPersistableModel<SalesforceSink>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
