...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class SalesforceSink : Core.IUtf8JsonSerializable
    {
        ...
        internal static SalesforceSink DeserializeSalesforceSink(JsonElement element)
        {
            ...
            return new SalesforceSink(type, writeBatchSize.Value, writeBatchTimeout.Value, sinkRetryCount.Value, sinkRetryWait.Value, maxConcurrentConnections.Value, additionalProperties, Core.Optional.ToNullable(writeBehavior), externalIdFieldName.Value, ignoreNullValues.Value);
        }
