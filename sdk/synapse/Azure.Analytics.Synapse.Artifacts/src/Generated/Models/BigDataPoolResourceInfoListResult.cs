...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class BigDataPoolResourceInfoListResult
    {
        ...
        internal BigDataPoolResourceInfoListResult(string nextLink, IReadOnlyList<BigDataPoolResourceInfo> value, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            NextLink = nextLink;
            Value = value;
