...
{
    [JsonConverter(typeof(SalesforceMarketingCloudObjectDatasetConverter))]
    public partial class SalesforceMarketingCloudObjectDataset : IUtf8JsonSerializable
    {
        ...
        internal partial class SalesforceMarketingCloudObjectDatasetConverter : JsonConverter<SalesforceMarketingCloudObjectDataset>
        {
            public override void Write(Utf8JsonWriter writer, SalesforceMarketingCloudObjectDataset model, JsonSerializerOptions options)
            {
                writer.WriteObjectValue(model);
            }
            public override SalesforceMarketingCloudObjectDataset Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
            {
                using var document = JsonDocument.ParseValue(ref reader);
                return DeserializeSalesforceMarketingCloudObjectDataset(document.RootElement);
            }
        }
    }
}
