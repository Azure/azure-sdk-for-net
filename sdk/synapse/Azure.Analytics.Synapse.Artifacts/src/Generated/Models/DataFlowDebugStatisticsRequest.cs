...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class DataFlowDebugStatisticsRequest
    {
        ...
        internal DataFlowDebugStatisticsRequest(string sessionId, string dataFlowName, string streamName, IList<string> columns, Dictionary<string, BinaryData> rawData)
        {
            SessionId = sessionId;
