...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class AmazonS3LinkedService : LinkedService
    {
        ...
        internal AmazonS3LinkedService(string type, string version, IntegrationRuntimeReference connectVia, string description, IDictionary<string, ParameterSpecification> parameters, IList<object> annotations, IDictionary<string, object> additionalProperties, object authenticationType, object accessKeyId, SecretBase secretAccessKey, object serviceUrl, SecretBase sessionToken, object encryptedCredential) : base(type, version, connectVia, description, parameters, annotations, additionalProperties)
        {
