...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class CosmosDbLinkedService : LinkedService
    {
        ...
        internal CosmosDbLinkedService(string type, string version, IntegrationRuntimeReference connectVia, string description, IDictionary<string, ParameterSpecification> parameters, IList<object> annotations, IDictionary<string, object> additionalProperties, object connectionString, object accountEndpoint, object database, SecretBase accountKey, object encryptedCredential, CredentialReference credential) : base(type, version, connectVia, description, parameters, annotations, additionalProperties)
        {
