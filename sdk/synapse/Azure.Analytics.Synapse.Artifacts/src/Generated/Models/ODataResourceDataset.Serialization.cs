...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class ODataResourceDataset : IUtf8JsonSerializable
    {
        ...
        internal static ODataResourceDataset DeserializeODataResourceDataset(JsonElement element)
        {
            ...
            return new ODataResourceDataset(type, description.HasValue ? description.Value : null, structure.HasValue ? structure.Value : null, schema.HasValue ? schema.Value : null, linkedServiceName, new ChangeTrackingDictionary<string, ParameterSpecification>(parameters), new ChangeTrackingList<object>(annotations), folder.HasValue ? folder.Value : null, additionalProperties, path.HasValue ? path.Value : null);
        }
    }
}
