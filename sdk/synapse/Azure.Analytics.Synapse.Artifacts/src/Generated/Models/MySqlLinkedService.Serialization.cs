...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class MySqlLinkedService : IUtf8JsonSerializable
    {
        ...
        internal static MySqlLinkedService DeserializeMySqlLinkedService(JsonElement element)
        {
            ...
            return new MySqlLinkedService(type, connectVia.Value, description.Value, Optional.ToDictionary(parameters), annotations ?? new ChangeTrackingList<object>(), additionalProperties, connectionString, password.Value, encryptedCredential.Value);
        }
