...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FileServerLinkedService>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<FileServerLinkedService>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<FileServerLinkedService>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<FileServerLinkedService>)} interface");
            }
        ...
        string IPersistableModel<FileServerLinkedService>.GetWireFormat(ModelReaderWriterOptions options) => "J";
