...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class FileServerLinkedService : Core.IUtf8JsonSerializable
    {
        ...
        internal static FileServerLinkedService DeserializeFileServerLinkedService(JsonElement element)
        {
            ...
            object host = default;
            Core.Optional<object> userId = default;
            ...
            return new FileServerLinkedService(type, connectVia.Value, description.Value, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), additionalProperties, host, userId.Value, password.Value, encryptedCredential.Value);
        }
