...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class AzureMySqlTableDataset : IUtf8JsonSerializable
    {
        ...
        internal static AzureMySqlTableDataset DeserializeAzureMySqlTableDataset(JsonElement element)
        {
            ...
            return new AzureMySqlTableDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Optional.ToDictionary(parameters), annotations ?? new ChangeTrackingList<object>(), folder.Value, additionalProperties, tableName.Value, table.Value);
        }
