...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TriggerDependencyProvisioningStatus>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<TriggerDependencyProvisioningStatus>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<TriggerDependencyProvisioningStatus>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(TriggerDependencyProvisioningStatus)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<TriggerDependencyProvisioningStatus>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(TriggerDependencyProvisioningStatus)} does not support '{options.Format}' format.");
            }
        }
        ...
        string IPersistableModel<TriggerDependencyProvisioningStatus>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
