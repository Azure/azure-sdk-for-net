...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class AvroDataset : IUtf8JsonSerializable
    {
        ...
        internal static AvroDataset DeserializeAvroDataset(JsonElement element)
        {
            ...
            return new AvroDataset(type, description.HasValue ? description.Value : null, structure.HasValue ? structure.Value : null, schema.HasValue ? schema.Value : null, linkedServiceName, new ChangeTrackingDictionary<string, ParameterSpecification>(parameters), new ChangeTrackingList<object>(annotations), folder.HasValue ? folder.Value : null, additionalProperties, location.HasValue ? location.Value : null, avroCompressionCodec.HasValue ? avroCompressionCodec.Value : (AvroCompressionCodec?)null, avroCompressionLevel.HasValue ? avroCompressionLevel.Value : (int?)null);
        }
    }
}
