...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class Dataset
    {
        ...
        public Dataset(LinkedServiceReferenceAutoGenerated linkedServiceName)
        {
        ...
        internal Dataset(string type, string description, object structure, object schema, LinkedServiceReferenceAutoGenerated linkedServiceName, IDictionary<string, ParameterSpecification> parameters, IList<object> annotations, DatasetFolder folder, IDictionary<string, object> additionalProperties)
        {
            Type = type;
