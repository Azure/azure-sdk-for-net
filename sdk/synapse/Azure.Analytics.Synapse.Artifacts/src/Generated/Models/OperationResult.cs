...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class OperationResult
    {
        ...
        {
            Details = new ChangeTrackingList<CloudErrorAutoGenerated2>();
        }
        ...
        internal OperationResult(string status, string code, string message, string target, IReadOnlyList<CloudErrorAutoGenerated2> details)
        {
            Status = status;
            Code = code;
            Message = message;
        ...
        public IReadOnlyList<CloudErrorAutoGenerated2> Details { get; }
    }
}
