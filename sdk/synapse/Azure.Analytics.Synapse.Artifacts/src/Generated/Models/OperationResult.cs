...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class OperationResult
    {
        ...
        internal OperationResult(string status, string code, string message, string target, IReadOnlyList<CloudError> details, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Status = status;
            Code = code;
            Message = message;
