...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HDInsightPigActivity>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<HDInsightPigActivity>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<HDInsightPigActivity>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<HDInsightPigActivity>)} interface");
            }
        ...
        string IPersistableModel<HDInsightPigActivity>.GetWireFormat(ModelReaderWriterOptions options) => "J";
