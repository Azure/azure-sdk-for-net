...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class ConcurLinkedService : IUtf8JsonSerializable
    {
        ...
        internal static ConcurLinkedService DeserializeConcurLinkedService(JsonElement element)
        {
            ...
            return new ConcurLinkedService(type, connectVia.Value, description.Value, Optional.ToDictionary(parameters), Optional.ToList(annotations), additionalProperties, clientId, username, password.Value, useEncryptedEndpoints.Value, useHostVerification.Value, usePeerVerification.Value, encryptedCredential.Value);
        }
