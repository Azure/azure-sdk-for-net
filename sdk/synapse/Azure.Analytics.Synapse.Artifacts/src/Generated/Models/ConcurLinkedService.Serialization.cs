...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class ConcurLinkedService : IUtf8JsonSerializable
    {
        ...
        internal static ConcurLinkedService DeserializeConcurLinkedService(JsonElement element)
        {
            ...
            return new ConcurLinkedService(type, connectVia, description, parameters, annotations, additionalProperties, clientId, username, password, useEncryptedEndpoints, useHostVerification, usePeerVerification, encryptedCredential);
        }
    }
}
