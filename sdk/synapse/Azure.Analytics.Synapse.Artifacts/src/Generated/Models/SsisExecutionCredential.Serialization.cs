...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SsisExecutionCredential>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SsisExecutionCredential>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SsisExecutionCredential>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SsisExecutionCredential>)} interface");
            }
        ...
        string IPersistableModel<SsisExecutionCredential>.GetWireFormat(ModelReaderWriterOptions options) => "J";
