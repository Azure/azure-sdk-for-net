...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class SparkJobDefinitionResource : SubResource
    {
        ...
        internal SparkJobDefinitionResource(string id, string name, string type, string etag, SparkJobDefinition properties, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, type, etag, serializedAdditionalRawData)
        {
            Properties = properties;
        }
