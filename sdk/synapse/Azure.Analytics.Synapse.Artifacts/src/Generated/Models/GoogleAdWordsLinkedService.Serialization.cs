...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class GoogleAdWordsLinkedService : IUtf8JsonSerializable
    {
        ...
        internal static GoogleAdWordsLinkedService DeserializeGoogleAdWordsLinkedService(JsonElement element)
        {
            ...
            return new GoogleAdWordsLinkedService(type, connectVia.HasValue ? connectVia.Value : null, description.HasValue ? description.Value : null, new ChangeTrackingDictionary<string, ParameterSpecification>(parameters), new ChangeTrackingList<object>(annotations), additionalProperties, clientCustomerID, developerToken, authenticationType, refreshToken.HasValue ? refreshToken.Value : null, clientId.HasValue ? clientId.Value : null, clientSecret.HasValue ? clientSecret.Value : null, email.HasValue ? email.Value : null, keyFilePath.HasValue ? keyFilePath.Value : null, trustedCertPath.HasValue ? trustedCertPath.Value : null, useSystemTrustStore.HasValue ? useSystemTrustStore.Value : null, encryptedCredential.HasValue ? encryptedCredential.Value : null);
        }
    }
}
