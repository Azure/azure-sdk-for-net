...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class SparkLinkedService : IUtf8JsonSerializable
    {
        ...
        internal static SparkLinkedService DeserializeSparkLinkedService(JsonElement element)
        {
            ...
            return new SparkLinkedService(type, connectVia.HasValue ? connectVia.Value : null, description.HasValue ? description.Value : null, new ChangeTrackingDictionary<string, ParameterSpecification>(parameters), new ChangeTrackingList<object>(annotations), additionalProperties, host, port, serverType.HasValue ? serverType.Value : (SparkServerType?)null, thriftTransportProtocol.HasValue ? thriftTransportProtocol.Value : (SparkThriftTransportProtocol?)null, authenticationType, username.HasValue ? username.Value : null, password.HasValue ? password.Value : null, httpPath.HasValue ? httpPath.Value : null, enableSsl.HasValue ? enableSsl.Value : null, trustedCertPath.HasValue ? trustedCertPath.Value : null, useSystemTrustStore.HasValue ? useSystemTrustStore.Value : null, allowHostNameCNMismatch.HasValue ? allowHostNameCNMismatch.Value : null, allowSelfSignedServerCert.HasValue ? allowSelfSignedServerCert.Value : null, encryptedCredential.HasValue ? encryptedCredential.Value : null);
        }
    }
}
