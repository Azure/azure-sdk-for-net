...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SparkLinkedService>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SparkLinkedService>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SparkLinkedService>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SparkLinkedService>)} interface");
            }
        ...
        string IPersistableModel<SparkLinkedService>.GetWireFormat(ModelReaderWriterOptions options) => "J";
