...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class MongoDbSource : IUtf8JsonSerializable
    {
        ...
        internal static new MongoDbSource FromResponse(Response response)
        {
        ...
        internal override RequestContent ToRequestContent()
        {
            ...
            content.JsonWriter.WriteObjectValue<MongoDbSource>(this);
            return content;
        }
        ...
        internal partial class MongoDbSourceConverter : JsonConverter<MongoDbSource>
        {
            ...
            {
                writer.WriteObjectValue<MongoDbSource>(model);
            }
