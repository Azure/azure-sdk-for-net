...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class ScriptActivityScriptBlock
    {
        ...
        internal ScriptActivityScriptBlock(object text, ScriptType type, IList<ScriptActivityParameter> parameters, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Text = text;
            Type = type;
