...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class HDInsightHiveActivity : ExecutionActivity
    {
        ...
        internal HDInsightHiveActivity(string name, string type, string description, IList<ActivityDependency> dependsOn, IList<UserProperty> userProperties, IDictionary<string, object> additionalProperties, LinkedServiceReferenceAutoGenerated linkedServiceName, ActivityPolicy policy, IList<LinkedServiceReferenceAutoGenerated> storageLinkedServices, IList<object> arguments, HDInsightActivityDebugInfoOption? getDebugInfo, object scriptPath, LinkedServiceReferenceAutoGenerated scriptLinkedService, IDictionary<string, object> defines, IList<object> variables, int? queryTimeout) : base(name, type, description, dependsOn, userProperties, additionalProperties, linkedServiceName, policy)
        {
