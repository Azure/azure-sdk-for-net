...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class AzureBlobFSLinkedService : IUtf8JsonSerializable
    {
        ...
        internal static AzureBlobFSLinkedService DeserializeAzureBlobFSLinkedService(JsonElement element)
        {
            ...
            return new AzureBlobFSLinkedService(type, connectVia.HasValue ? connectVia.Value : null, description.HasValue ? description.Value : null, new ChangeTrackingDictionary<string, ParameterSpecification>(parameters), new ChangeTrackingList<object>(annotations), additionalProperties, url, accountKey.HasValue ? accountKey.Value : null, servicePrincipalId.HasValue ? servicePrincipalId.Value : null, servicePrincipalKey.HasValue ? servicePrincipalKey.Value : null, tenant.HasValue ? tenant.Value : null, encryptedCredential.HasValue ? encryptedCredential.Value : null);
        }
    }
}
