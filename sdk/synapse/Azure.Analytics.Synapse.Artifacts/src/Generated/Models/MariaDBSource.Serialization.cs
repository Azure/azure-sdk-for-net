...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class MariaDBSource : IUtf8JsonSerializable
    {
        ...
        internal static new MariaDBSource FromResponse(Response response)
        {
        ...
        internal override RequestContent ToRequestContent()
        {
            ...
            content.JsonWriter.WriteObjectValue<MariaDBSource>(this);
            return content;
        }
        ...
        internal partial class MariaDBSourceConverter : JsonConverter<MariaDBSource>
        {
            ...
            {
                writer.WriteObjectValue<MariaDBSource>(model);
            }
