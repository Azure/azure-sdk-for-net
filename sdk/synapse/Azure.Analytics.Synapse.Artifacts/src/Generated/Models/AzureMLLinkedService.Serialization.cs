...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class AzureMLLinkedService : IUtf8JsonSerializable
    {
        ...
        internal static AzureMLLinkedService DeserializeAzureMLLinkedService(JsonElement element)
        {
            ...
            return new AzureMLLinkedService(type, connectVia.Value, description.Value, parameters ?? new ChangeTrackingDictionary<string, ParameterSpecification>(), annotations ?? new ChangeTrackingList<object>(), additionalProperties, mlEndpoint, apiKey, updateResourceEndpoint.Value, servicePrincipalId.Value, servicePrincipalKey.Value, tenant.Value, encryptedCredential.Value, authentication.Value);
        }
