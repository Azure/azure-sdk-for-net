...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class WebBasicAuthentication : WebLinkedServiceTypeProperties
    {
        ...
        internal WebBasicAuthentication(object url, WebAuthenticationType authenticationType, object username, SecretBase password, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(url, authenticationType, serializedAdditionalRawData)
        {
            Username = username;
            Password = password;
