...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class WebBasicAuthentication : WebLinkedServiceTypeProperties
    {
        ...
        internal WebBasicAuthentication(object url, WebAuthenticationType authenticationType, object username, SecretBase password, Dictionary<string, BinaryData> rawData) : base(url, authenticationType, rawData)
        {
            Username = username;
            Password = password;
