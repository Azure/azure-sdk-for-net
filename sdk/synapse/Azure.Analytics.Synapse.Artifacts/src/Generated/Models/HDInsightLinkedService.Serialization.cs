...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class HDInsightLinkedService : IUtf8JsonSerializable
    {
        ...
        internal static HDInsightLinkedService DeserializeHDInsightLinkedService(JsonElement element)
        {
            ...
            Optional<LinkedServiceReferenceAutoGenerated> hcatalogLinkedServiceName = default;
                ...
                if (property.NameEquals("typeProperties"))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("linkedServiceName"))
                        {
                            ...
                            linkedServiceName = LinkedServiceReferenceAutoGenerated.DeserializeLinkedServiceReferenceAutoGenerated(property0.Value);
                            continue;
                        }
                        if (property0.NameEquals("hcatalogLinkedServiceName"))
                        {
                            ...
                            hcatalogLinkedServiceName = LinkedServiceReferenceAutoGenerated.DeserializeLinkedServiceReferenceAutoGenerated(property0.Value);
                            continue;
                        }
