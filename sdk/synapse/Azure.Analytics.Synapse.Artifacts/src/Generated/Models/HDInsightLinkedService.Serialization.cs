...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class HDInsightLinkedService : IUtf8JsonSerializable
    {
        ...
        internal static HDInsightLinkedService DeserializeHDInsightLinkedService(JsonElement element)
        {
            ...
            return new HDInsightLinkedService(type, connectVia, description, parameters, annotations, additionalProperties, clusterUri, userName, password, linkedServiceName, hcatalogLinkedServiceName, encryptedCredential, isEspEnabled, fileSystem);
        }
    }
}
