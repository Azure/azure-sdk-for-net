...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class HDInsightLinkedService : IUtf8JsonSerializable
    {
        ...
        internal static HDInsightLinkedService DeserializeHDInsightLinkedService(JsonElement element)
        {
            ...
            return new HDInsightLinkedService(type, connectVia.HasValue ? connectVia.Value : null, description.HasValue ? description.Value : null, new ChangeTrackingDictionary<string, ParameterSpecification>(parameters), new ChangeTrackingList<object>(annotations), additionalProperties, clusterUri, userName.HasValue ? userName.Value : null, password.HasValue ? password.Value : null, linkedServiceName.HasValue ? linkedServiceName.Value : null, hcatalogLinkedServiceName.HasValue ? hcatalogLinkedServiceName.Value : null, encryptedCredential.HasValue ? encryptedCredential.Value : null, isEspEnabled.HasValue ? isEspEnabled.Value : null, fileSystem.HasValue ? fileSystem.Value : null);
        }
    }
}
