...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class AzureBlobFSDataset : Core.IUtf8JsonSerializable
    {
        ...
        internal static AzureBlobFSDataset DeserializeAzureBlobFSDataset(JsonElement element)
        {
            ...
            return new AzureBlobFSDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), folder.Value, additionalProperties, folderPath.Value, fileName.Value, format.Value, compression.Value);
        }
