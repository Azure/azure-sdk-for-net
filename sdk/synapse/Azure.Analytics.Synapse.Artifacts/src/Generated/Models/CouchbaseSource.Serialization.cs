...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class CouchbaseSource : IUtf8JsonSerializable
    {
        ...
        internal static CouchbaseSource DeserializeCouchbaseSource(JsonElement element)
        {
            ...
            return new CouchbaseSource(type, sourceRetryCount.Value, sourceRetryWait.Value, maxConcurrentConnections.Value, additionalProperties, queryTimeout.Value, query.Value);
        }
