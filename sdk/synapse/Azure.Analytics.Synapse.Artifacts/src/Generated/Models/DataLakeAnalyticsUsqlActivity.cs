...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class DataLakeAnalyticsUsqlActivity : ExecutionActivity
    {
        ...
        public DataLakeAnalyticsUsqlActivity(string name, object scriptPath, LinkedServiceReferenceAutoGenerated scriptLinkedService) : base(name)
        {
            if (name == null)
            {
        ...
        internal DataLakeAnalyticsUsqlActivity(string name, string type, string description, IList<ActivityDependency> dependsOn, IList<UserProperty> userProperties, IDictionary<string, object> additionalProperties, LinkedServiceReferenceAutoGenerated linkedServiceName, ActivityPolicy policy, object scriptPath, LinkedServiceReferenceAutoGenerated scriptLinkedService, object degreeOfParallelism, object priority, IDictionary<string, object> parameters, object runtimeVersion, object compilationMode) : base(name, type, description, dependsOn, userProperties, additionalProperties, linkedServiceName, policy)
        {
            ScriptPath = scriptPath;
            ScriptLinkedService = scriptLinkedService;
        ...
        public LinkedServiceReferenceAutoGenerated ScriptLinkedService { get; set; }
