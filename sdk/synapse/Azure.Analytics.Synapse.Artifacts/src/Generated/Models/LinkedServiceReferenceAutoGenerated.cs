...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class LinkedServiceReferenceAutoGenerated
    {
        /// <summary> Initializes a new instance of LinkedServiceReferenceAutoGenerated. </summary>
        ...
        public LinkedServiceReferenceAutoGenerated(LinkedServiceReferenceType type, string referenceName)
        {
        ...
        internal LinkedServiceReferenceAutoGenerated(LinkedServiceReferenceType type, string referenceName, IDictionary<string, object> parameters)
        {
            Type = type;
            ReferenceName = referenceName;
