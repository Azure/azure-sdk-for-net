...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class QuickBooksObjectDataset : IUtf8JsonSerializable
    {
        ...
        internal static QuickBooksObjectDataset DeserializeQuickBooksObjectDataset(JsonElement element)
        {
            ...
            return new QuickBooksObjectDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Optional.ToDictionary(parameters), annotations ?? new ChangeTrackingList<object>(), folder.Value, additionalProperties, tableName.Value);
        }
