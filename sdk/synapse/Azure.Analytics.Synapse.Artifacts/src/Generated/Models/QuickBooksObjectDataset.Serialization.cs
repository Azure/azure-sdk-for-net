...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class QuickBooksObjectDataset : Core.IUtf8JsonSerializable
    {
        ...
        internal static QuickBooksObjectDataset DeserializeQuickBooksObjectDataset(JsonElement element)
        {
            ...
            return new QuickBooksObjectDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), folder.Value, additionalProperties, tableName.Value);
        }
