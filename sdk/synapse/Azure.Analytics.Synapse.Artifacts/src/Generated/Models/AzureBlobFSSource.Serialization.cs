...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class AzureBlobFSSource : Core.IUtf8JsonSerializable
    {
        void Core.IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            if (Core.Optional.IsDefined(SkipHeaderLineCount))
            {
        ...
        internal static AzureBlobFSSource DeserializeAzureBlobFSSource(JsonElement element)
        {
            ...
            Core.Optional<object> skipHeaderLineCount = default;
