...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HDInsightOnDemandLinkedService>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<HDInsightOnDemandLinkedService>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<HDInsightOnDemandLinkedService>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<HDInsightOnDemandLinkedService>)} interface");
            }
        ...
        string IPersistableModel<HDInsightOnDemandLinkedService>.GetWireFormat(ModelReaderWriterOptions options) => "J";
