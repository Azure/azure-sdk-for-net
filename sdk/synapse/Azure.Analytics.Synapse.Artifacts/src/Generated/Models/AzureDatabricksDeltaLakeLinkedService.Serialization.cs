...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class AzureDatabricksDeltaLakeLinkedService : Core.IUtf8JsonSerializable
    {
        ...
        internal static AzureDatabricksDeltaLakeLinkedService DeserializeAzureDatabricksDeltaLakeLinkedService(JsonElement element)
        {
            ...
            Core.Optional<object> clusterId = default;
            ...
            return new AzureDatabricksDeltaLakeLinkedService(type, connectVia.Value, description.Value, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), additionalProperties, domain, accessToken, clusterId.Value, encryptedCredential.Value, credential.Value);
        }
