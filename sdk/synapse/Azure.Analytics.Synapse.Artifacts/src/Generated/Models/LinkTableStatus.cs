...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class LinkTableStatus
    {
        ...
        internal LinkTableStatus(string id, string status, string errorMessage, object startTime, object stopTime, string linkTableId, string errorCode, DateTimeOffset? lastProcessedData, DateTimeOffset? lastTransactionCommitTime, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Status = status;
