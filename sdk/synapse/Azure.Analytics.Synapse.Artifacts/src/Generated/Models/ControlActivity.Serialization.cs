...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class ControlActivity : IUtf8JsonSerializable
    {
        ...
        internal static ControlActivity DeserializeControlActivity(JsonElement element)
        {
            ...
            return new ControlActivity(name, type, description.Value, Optional.ToNullable(state), Optional.ToNullable(onInactiveMarkAs), dependsOn ?? new ChangeTrackingList<ActivityDependency>(), userProperties ?? new ChangeTrackingList<UserProperty>(), additionalProperties);
        }
