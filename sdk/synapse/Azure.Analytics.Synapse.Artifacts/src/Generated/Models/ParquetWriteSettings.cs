...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class ParquetWriteSettings : FormatWriteSettings
    {
        ...
        internal ParquetWriteSettings(string type, IDictionary<string, BinaryData> additionalProperties, BinaryData maxRowsPerFile, BinaryData fileNamePrefix) : base(type, additionalProperties)
        {
