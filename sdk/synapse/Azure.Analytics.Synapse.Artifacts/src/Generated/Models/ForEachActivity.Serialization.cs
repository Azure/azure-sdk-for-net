...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ForEachActivity>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ForEachActivity>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ForEachActivity>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ForEachActivity>)} interface");
            }
        ...
        string IPersistableModel<ForEachActivity>.GetWireFormat(ModelReaderWriterOptions options) => "J";
