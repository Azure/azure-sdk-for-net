...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class ForEachActivity : IUtf8JsonSerializable
    {
        ...
        internal static ForEachActivity DeserializeForEachActivity(JsonElement element)
        {
            ...
            return new ForEachActivity(name, type, description.HasValue ? description.Value : null, new ChangeTrackingList<ActivityDependency>(dependsOn), new ChangeTrackingList<UserProperty>(userProperties), additionalProperties, isSequential.HasValue ? isSequential.Value : (bool?)null, batchCount.HasValue ? batchCount.Value : (int?)null, items, activities);
        }
    }
}
