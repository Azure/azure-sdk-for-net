...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    internal partial class ErrorResponse
    {
        internal static ErrorResponse DeserializeErrorResponse(JsonElement element)
        {
            ...
            Core.Optional<IReadOnlyList<ErrorResponse>> details = default;
            ...
            return new ErrorResponse(code.Value, message.Value, target.Value, Core.Optional.ToList(details), Core.Optional.ToList(additionalInfo));
        }
