...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class VirtualNetworkProfile : IUtf8JsonSerializable, IJsonModel<VirtualNetworkProfile>
    {
        ...
        void IJsonModel<VirtualNetworkProfile>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(VirtualNetworkProfile)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<VirtualNetworkProfile>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(VirtualNetworkProfile)} does not support '{options.Format}' format.");
            }
        }
