...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class FilterActivity : IUtf8JsonSerializable
    {
        ...
        internal static FilterActivity DeserializeFilterActivity(JsonElement element)
        {
            ...
            return new FilterActivity(name, type, description.HasValue ? description.Value : null, new ChangeTrackingList<ActivityDependency>(dependsOn), new ChangeTrackingList<UserProperty>(userProperties), additionalProperties, items, condition);
        }
    }
}
