...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FilterActivity>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<FilterActivity>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<FilterActivity>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<FilterActivity>)} interface");
            }
        ...
        string IPersistableModel<FilterActivity>.GetWireFormat(ModelReaderWriterOptions options) => "J";
