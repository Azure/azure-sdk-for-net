...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class FilterActivity : Core.IUtf8JsonSerializable
    {
        ...
        internal static FilterActivity DeserializeFilterActivity(JsonElement element)
        {
            ...
            return new FilterActivity(name, type, description.Value, Core.Optional.ToNullable(state), Core.Optional.ToNullable(onInactiveMarkAs), Core.Optional.ToList(dependsOn), Core.Optional.ToList(userProperties), additionalProperties, items, condition);
        }
