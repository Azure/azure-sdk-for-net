...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class AzureMLExecutePipelineActivity : Core.IUtf8JsonSerializable
    {
        ...
        internal static AzureMLExecutePipelineActivity DeserializeAzureMLExecutePipelineActivity(JsonElement element)
        {
            ...
            Core.Optional<object> experimentName = default;
            Core.Optional<object> mlPipelineParameters = default;
            Core.Optional<object> mlParentRunId = default;
            Core.Optional<object> continueOnStepFailure = default;
            ...
            return new AzureMLExecutePipelineActivity(name, type, description.Value, Core.Optional.ToNullable(state), Core.Optional.ToNullable(onInactiveMarkAs), Core.Optional.ToList(dependsOn), Core.Optional.ToList(userProperties), additionalProperties, linkedServiceName.Value, policy.Value, mlPipelineId, experimentName.Value, mlPipelineParameters.Value, mlParentRunId.Value, continueOnStepFailure.Value);
        }
