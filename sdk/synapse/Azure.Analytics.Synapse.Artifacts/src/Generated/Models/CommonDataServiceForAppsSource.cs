...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class CommonDataServiceForAppsSource : CopySource
    {
        ...
        internal CommonDataServiceForAppsSource(string type, BinaryData sourceRetryCount, BinaryData sourceRetryWait, BinaryData maxConcurrentConnections, IDictionary<string, BinaryData> additionalProperties, BinaryData query, BinaryData additionalColumns) : base(type, sourceRetryCount, sourceRetryWait, maxConcurrentConnections, additionalProperties)
        {
            Query = query;
