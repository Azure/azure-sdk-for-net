...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class StagingSettings : IUtf8JsonSerializable
    {
        ...
        internal static StagingSettings DeserializeStagingSettings(JsonElement element)
        {
            ...
            return new StagingSettings(linkedServiceName, path.HasValue ? path.Value : null, enableCompression.HasValue ? enableCompression.Value : null, additionalProperties);
        }
    }
}
