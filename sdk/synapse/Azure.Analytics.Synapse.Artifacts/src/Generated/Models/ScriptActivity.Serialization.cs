...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class ScriptActivity : Core.IUtf8JsonSerializable
    {
        void Core.IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            writer.WriteStartObject();
            if (Core.Optional.IsCollectionDefined(Scripts))
            {
        ...
        internal static ScriptActivity DeserializeScriptActivity(JsonElement element)
        {
            ...
            Core.Optional<IList<ScriptActivityScriptBlock>> scripts = default;
            Core.Optional<ScriptActivityTypePropertiesLogSettings> logSettings = default;
            ...
            return new ScriptActivity(name, type, description.Value, Core.Optional.ToNullable(state), Core.Optional.ToNullable(onInactiveMarkAs), Core.Optional.ToList(dependsOn), Core.Optional.ToList(userProperties), additionalProperties, linkedServiceName.Value, policy.Value, Core.Optional.ToList(scripts), logSettings.Value);
        }
