...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class SparkConfiguration
    {
        ...
        internal SparkConfiguration(string description, IDictionary<string, string> configs, IList<string> annotations, string notes, string createdBy, DateTimeOffset? created, IDictionary<string, string> configMergeRule, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
