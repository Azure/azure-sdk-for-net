...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class AvroWriteSettings : FormatWriteSettings
    {
        ...
        internal AvroWriteSettings(string type, IDictionary<string, BinaryData> additionalProperties, string recordName, string recordNamespace, BinaryData maxRowsPerFile, BinaryData fileNamePrefix) : base(type, additionalProperties)
        {
