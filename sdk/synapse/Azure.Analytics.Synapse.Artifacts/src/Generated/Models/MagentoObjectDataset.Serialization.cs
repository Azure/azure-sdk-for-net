...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class MagentoObjectDataset : IUtf8JsonSerializable
    {
        ...
        internal static MagentoObjectDataset DeserializeMagentoObjectDataset(JsonElement element)
        {
            ...
            return new MagentoObjectDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Optional.ToDictionary(parameters), annotations ?? new ChangeTrackingList<object>(), folder.Value, additionalProperties, tableName.Value);
        }
