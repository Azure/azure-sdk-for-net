...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class DatabricksSparkPythonActivity : IUtf8JsonSerializable
    {
        ...
        internal static DatabricksSparkPythonActivity DeserializeDatabricksSparkPythonActivity(JsonElement element)
        {
            ...
            return new DatabricksSparkPythonActivity(name, type, description.HasValue ? description.Value : null, new ChangeTrackingList<ActivityDependency>(dependsOn), new ChangeTrackingList<UserProperty>(userProperties), additionalProperties, linkedServiceName.HasValue ? linkedServiceName.Value : null, policy.HasValue ? policy.Value : null, pythonFile, new ChangeTrackingList<object>(parameters), new ChangeTrackingList<IDictionary<string, object>>(libraries));
        }
    }
}
