...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class TeamDeskLinkedService : Core.IUtf8JsonSerializable
    {
        ...
        internal static TeamDeskLinkedService DeserializeTeamDeskLinkedService(JsonElement element)
        {
            ...
            return new TeamDeskLinkedService(type, connectVia.Value, description.Value, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), additionalProperties, authenticationType, url, userName.Value, password.Value, apiToken.Value, encryptedCredential.Value);
        }
