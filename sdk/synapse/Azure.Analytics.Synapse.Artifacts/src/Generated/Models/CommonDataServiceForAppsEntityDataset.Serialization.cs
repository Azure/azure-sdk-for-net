...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class CommonDataServiceForAppsEntityDataset : Core.IUtf8JsonSerializable
    {
        ...
        internal static CommonDataServiceForAppsEntityDataset DeserializeCommonDataServiceForAppsEntityDataset(JsonElement element)
        {
            ...
            return new CommonDataServiceForAppsEntityDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), folder.Value, additionalProperties, entityName.Value);
        }
