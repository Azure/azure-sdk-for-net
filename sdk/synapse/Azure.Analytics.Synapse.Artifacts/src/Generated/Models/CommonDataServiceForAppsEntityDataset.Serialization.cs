...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class CommonDataServiceForAppsEntityDataset : IUtf8JsonSerializable
    {
        ...
        internal static CommonDataServiceForAppsEntityDataset DeserializeCommonDataServiceForAppsEntityDataset(JsonElement element)
        {
            ...
            return new CommonDataServiceForAppsEntityDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Optional.ToDictionary(parameters), annotations ?? new ChangeTrackingList<object>(), folder.Value, additionalProperties, entityName.Value);
        }
