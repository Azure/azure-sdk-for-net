...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class AzureFunctionActivity : IUtf8JsonSerializable
    {
        ...
        internal static AzureFunctionActivity DeserializeAzureFunctionActivity(JsonElement element)
        {
            ...
            return new AzureFunctionActivity(name, type, description.HasValue ? description.Value : null, new ChangeTrackingList<ActivityDependency>(dependsOn), new ChangeTrackingList<UserProperty>(userProperties), additionalProperties, linkedServiceName.HasValue ? linkedServiceName.Value : null, policy.HasValue ? policy.Value : null, method, functionName, headers.HasValue ? headers.Value : null, body.HasValue ? body.Value : null);
        }
    }
}
