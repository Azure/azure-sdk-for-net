...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class AzureFunctionActivity : Core.IUtf8JsonSerializable
    {
        ...
        internal static AzureFunctionActivity DeserializeAzureFunctionActivity(JsonElement element)
        {
            ...
            return new AzureFunctionActivity(name, type, description.Value, Core.Optional.ToNullable(state), Core.Optional.ToNullable(onInactiveMarkAs), Core.Optional.ToList(dependsOn), Core.Optional.ToList(userProperties), additionalProperties, linkedServiceName.Value, policy.Value, method, functionName, headers.Value, body.Value);
        }
