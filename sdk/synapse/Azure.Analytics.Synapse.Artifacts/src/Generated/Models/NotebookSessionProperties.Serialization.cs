...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NotebookSessionProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NotebookSessionProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NotebookSessionProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<NotebookSessionProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
