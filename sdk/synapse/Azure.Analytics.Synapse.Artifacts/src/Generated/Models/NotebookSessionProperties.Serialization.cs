...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class NotebookSessionProperties : IUtf8JsonSerializable, IJsonModel<NotebookSessionProperties>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<NotebookSessionProperties>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<NotebookSessionProperties>)} interface");
            }
