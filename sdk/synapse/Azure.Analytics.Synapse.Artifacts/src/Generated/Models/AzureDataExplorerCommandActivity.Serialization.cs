...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class AzureDataExplorerCommandActivity : IUtf8JsonSerializable
    {
        ...
        internal static AzureDataExplorerCommandActivity DeserializeAzureDataExplorerCommandActivity(JsonElement element)
        {
            ...
            return new AzureDataExplorerCommandActivity(name, type, description.HasValue ? description.Value : null, new ChangeTrackingList<ActivityDependency>(dependsOn), new ChangeTrackingList<UserProperty>(userProperties), additionalProperties, linkedServiceName.HasValue ? linkedServiceName.Value : null, policy.HasValue ? policy.Value : null, command, commandTimeout.HasValue ? commandTimeout.Value : null);
        }
    }
}
