...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class TriggerDependencyReference : DependencyReference
    {
        ...
        /// <param name="referenceTrigger"> Referenced trigger. </param>
        internal TriggerDependencyReference(string type, IDictionary<string, BinaryData> serializedAdditionalRawData, TriggerReference referenceTrigger) : base(type, serializedAdditionalRawData)
        {
            ReferenceTrigger = referenceTrigger;
