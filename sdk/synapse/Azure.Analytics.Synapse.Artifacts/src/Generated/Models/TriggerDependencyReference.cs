...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class TriggerDependencyReference : DependencyReference
    {
        ...
        internal TriggerDependencyReference(string type, TriggerReference referenceTrigger, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(type, serializedAdditionalRawData)
        {
            ReferenceTrigger = referenceTrigger;
