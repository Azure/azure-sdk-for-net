...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class AzureBlobStorageReadSettings : IUtf8JsonSerializable
    {
        ...
        internal static AzureBlobStorageReadSettings DeserializeAzureBlobStorageReadSettings(JsonElement element)
        {
            ...
            return new AzureBlobStorageReadSettings(type, maxConcurrentConnections.Value, additionalProperties, recursive.Value, wildcardFolderPath.Value, wildcardFileName.Value, prefix.Value, Optional.ToNullable(enablePartitionDiscovery), modifiedDatetimeStart.Value, modifiedDatetimeEnd.Value);
        }
    }
}
