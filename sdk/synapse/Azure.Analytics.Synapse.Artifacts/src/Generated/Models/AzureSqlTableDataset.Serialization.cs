...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class AzureSqlTableDataset : IUtf8JsonSerializable
    {
        ...
        internal static AzureSqlTableDataset DeserializeAzureSqlTableDataset(JsonElement element)
        {
            ...
            return new AzureSqlTableDataset(type, description.HasValue ? description.Value : null, structure.HasValue ? structure.Value : null, schema.HasValue ? schema.Value : null, linkedServiceName, new ChangeTrackingDictionary<string, ParameterSpecification>(parameters), new ChangeTrackingList<object>(annotations), folder.HasValue ? folder.Value : null, additionalProperties, tableName.HasValue ? tableName.Value : null, schema0.HasValue ? schema0.Value : null, table.HasValue ? table.Value : null);
        }
    }
}
