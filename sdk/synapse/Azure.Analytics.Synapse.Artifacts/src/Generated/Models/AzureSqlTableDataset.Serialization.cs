...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class AzureSqlTableDataset : IUtf8JsonSerializable
    {
        ...
        internal static AzureSqlTableDataset DeserializeAzureSqlTableDataset(JsonElement element)
        {
            ...
            return new AzureSqlTableDataset(type, description, structure, schema, linkedServiceName, parameters, annotations, folder, additionalProperties, tableName, schema0, table);
        }
    }
}
