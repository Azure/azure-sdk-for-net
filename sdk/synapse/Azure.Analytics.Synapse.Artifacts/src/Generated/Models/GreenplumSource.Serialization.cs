...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class GreenplumSource : IUtf8JsonSerializable
    {
        ...
        internal static GreenplumSource DeserializeGreenplumSource(JsonElement element)
        {
            ...
            return new GreenplumSource(type, sourceRetryCount.Value, sourceRetryWait.Value, maxConcurrentConnections.Value, additionalProperties, queryTimeout.Value, Optional.ToList(additionalColumns), query.Value);
        }
