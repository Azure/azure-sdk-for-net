...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class MicrosoftAccessLinkedService : IUtf8JsonSerializable
    {
        ...
        internal static MicrosoftAccessLinkedService DeserializeMicrosoftAccessLinkedService(JsonElement element)
        {
            ...
            return new MicrosoftAccessLinkedService(type, connectVia.Value, description.Value, Optional.ToDictionary(parameters), annotations ?? new ChangeTrackingList<object>(), additionalProperties, connectionString, authenticationType.Value, credential.Value, userName.Value, password.Value, encryptedCredential.Value);
        }
