...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class SybaseLinkedService : IUtf8JsonSerializable
    {
        ...
        internal static SybaseLinkedService DeserializeSybaseLinkedService(JsonElement element)
        {
            ...
            return new SybaseLinkedService(type, connectVia.HasValue ? connectVia.Value : null, description.HasValue ? description.Value : null, new ChangeTrackingDictionary<string, ParameterSpecification>(parameters), new ChangeTrackingList<object>(annotations), additionalProperties, server, database, schema.HasValue ? schema.Value : null, authenticationType.HasValue ? authenticationType.Value : (SybaseAuthenticationType?)null, username.HasValue ? username.Value : null, password.HasValue ? password.Value : null, encryptedCredential.HasValue ? encryptedCredential.Value : null);
        }
    }
}
