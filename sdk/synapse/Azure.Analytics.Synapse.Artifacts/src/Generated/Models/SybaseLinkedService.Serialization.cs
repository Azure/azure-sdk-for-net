...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class SybaseLinkedService : Core.IUtf8JsonSerializable
    {
        ...
        internal static SybaseLinkedService DeserializeSybaseLinkedService(JsonElement element)
        {
            ...
            Core.Optional<SybaseAuthenticationType> authenticationType = default;
            ...
            return new SybaseLinkedService(type, connectVia.Value, description.Value, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), additionalProperties, server, database, schema.Value, Core.Optional.ToNullable(authenticationType), username.Value, password.Value, encryptedCredential.Value);
        }
