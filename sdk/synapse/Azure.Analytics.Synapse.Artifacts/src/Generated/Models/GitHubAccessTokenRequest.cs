...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class GitHubAccessTokenRequest
    {
        ...
        internal GitHubAccessTokenRequest(string gitHubClientId, string gitHubAccessCode, string gitHubAccessTokenBaseUrl, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            GitHubClientId = gitHubClientId;
            GitHubAccessCode = gitHubAccessCode;
            GitHubAccessTokenBaseUrl = gitHubAccessTokenBaseUrl;
