...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class HdfsLinkedService : IUtf8JsonSerializable
    {
        ...
        internal static HdfsLinkedService DeserializeHdfsLinkedService(JsonElement element)
        {
            ...
            return new HdfsLinkedService(type, connectVia.HasValue ? connectVia.Value : null, description.HasValue ? description.Value : null, new ChangeTrackingDictionary<string, ParameterSpecification>(parameters), new ChangeTrackingList<object>(annotations), additionalProperties, url, authenticationType.HasValue ? authenticationType.Value : null, encryptedCredential.HasValue ? encryptedCredential.Value : null, userName.HasValue ? userName.Value : null, password.HasValue ? password.Value : null);
        }
    }
}
