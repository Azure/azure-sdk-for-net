...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class HdfsLinkedService : IUtf8JsonSerializable
    {
        ...
        internal static HdfsLinkedService DeserializeHdfsLinkedService(JsonElement element)
        {
            ...
            return new HdfsLinkedService(type, connectVia, description, parameters, annotations, additionalProperties, url, authenticationType, encryptedCredential, userName, password);
        }
    }
}
