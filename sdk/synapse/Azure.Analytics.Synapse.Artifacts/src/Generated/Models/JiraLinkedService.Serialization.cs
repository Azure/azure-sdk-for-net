...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class JiraLinkedService : IUtf8JsonSerializable
    {
        ...
        internal static JiraLinkedService DeserializeJiraLinkedService(JsonElement element)
        {
            ...
            return new JiraLinkedService(type, connectVia.HasValue ? connectVia.Value : null, description.HasValue ? description.Value : null, new ChangeTrackingDictionary<string, ParameterSpecification>(parameters), new ChangeTrackingList<object>(annotations), additionalProperties, host, port.HasValue ? port.Value : null, username, password.HasValue ? password.Value : null, useEncryptedEndpoints.HasValue ? useEncryptedEndpoints.Value : null, useHostVerification.HasValue ? useHostVerification.Value : null, usePeerVerification.HasValue ? usePeerVerification.Value : null, encryptedCredential.HasValue ? encryptedCredential.Value : null);
        }
    }
}
