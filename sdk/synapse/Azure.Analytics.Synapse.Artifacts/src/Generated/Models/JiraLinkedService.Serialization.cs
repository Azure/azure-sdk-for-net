...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class JiraLinkedService : Core.IUtf8JsonSerializable
    {
        ...
        internal static JiraLinkedService DeserializeJiraLinkedService(JsonElement element)
        {
            ...
            return new JiraLinkedService(type, connectVia.Value, description.Value, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), additionalProperties, host, port.Value, username, password.Value, useEncryptedEndpoints.Value, useHostVerification.Value, usePeerVerification.Value, encryptedCredential.Value);
        }
