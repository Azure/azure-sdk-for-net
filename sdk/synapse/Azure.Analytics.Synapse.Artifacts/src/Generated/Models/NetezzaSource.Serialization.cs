    ...
    public partial class NetezzaSource : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            if (Optional.IsDefined(PartitionSettings))
            {
                ...
                writer.WriteObjectValue<NetezzaPartitionSettings>(PartitionSettings);
            }
        ...
        internal static new NetezzaSource FromResponse(Response response)
        {
        ...
        internal override RequestContent ToRequestContent()
        {
            ...
            content.JsonWriter.WriteObjectValue<NetezzaSource>(this);
            return content;
        }
        ...
        internal partial class NetezzaSourceConverter : JsonConverter<NetezzaSource>
        {
            ...
            {
                writer.WriteObjectValue<NetezzaSource>(model);
            }
