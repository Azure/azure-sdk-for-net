...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class NetezzaSource : Core.IUtf8JsonSerializable
    {
        ...
        internal static NetezzaSource DeserializeNetezzaSource(JsonElement element)
        {
            ...
            Core.Optional<NetezzaPartitionOption> partitionOption = default;
            ...
            return new NetezzaSource(type, sourceRetryCount.Value, sourceRetryWait.Value, maxConcurrentConnections.Value, additionalProperties, queryTimeout.Value, additionalColumns.Value, query.Value, Core.Optional.ToNullable(partitionOption), partitionSettings.Value);
        }
