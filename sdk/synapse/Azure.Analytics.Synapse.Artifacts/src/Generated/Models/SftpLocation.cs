...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class SftpLocation : DatasetLocation
    {
        ...
        internal SftpLocation(string type, BinaryData folderPath, BinaryData fileName, IDictionary<string, BinaryData> additionalProperties) : base(type, folderPath, fileName, additionalProperties)
        {
