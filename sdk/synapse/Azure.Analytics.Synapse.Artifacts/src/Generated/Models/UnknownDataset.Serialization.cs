...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    internal partial class UnknownDataset : IUtf8JsonSerializable
    {
        ...
        internal static new UnknownDataset FromResponse(Response response)
        {
            using var document = JsonDocument.Parse(response.Content);
            return DeserializeUnknownDataset(document.RootElement);
        }
        ...
        internal override RequestContent ToRequestContent()
        {
            ...
            content.JsonWriter.WriteObjectValue<UnknownDataset>(this);
            return content;
        }
    }
}
