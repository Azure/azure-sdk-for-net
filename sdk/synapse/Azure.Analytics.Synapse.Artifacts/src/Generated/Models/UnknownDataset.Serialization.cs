...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    internal partial class UnknownDataset : IUtf8JsonSerializable
    {
        ...
        internal static UnknownDataset DeserializeUnknownDataset(JsonElement element)
        {
            ...
            return new UnknownDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Optional.ToDictionary(parameters), annotations ?? new ChangeTrackingList<object>(), folder.Value, additionalProperties);
        }
    }
}
