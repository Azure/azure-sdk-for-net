...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class SybaseSource : IUtf8JsonSerializable
    {
        ...
        internal static SybaseSource DeserializeSybaseSource(JsonElement element)
        {
            ...
            return new SybaseSource(type, sourceRetryCount.Value, sourceRetryWait.Value, maxConcurrentConnections.Value, additionalProperties, queryTimeout.Value, query.Value);
        }
