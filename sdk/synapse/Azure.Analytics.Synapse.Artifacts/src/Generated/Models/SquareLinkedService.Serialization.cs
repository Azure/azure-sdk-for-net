...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class SquareLinkedService : IUtf8JsonSerializable
    {
        ...
        internal static SquareLinkedService DeserializeSquareLinkedService(JsonElement element)
        {
            ...
            return new SquareLinkedService(type, connectVia.HasValue ? connectVia.Value : null, description.HasValue ? description.Value : null, new ChangeTrackingDictionary<string, ParameterSpecification>(parameters), new ChangeTrackingList<object>(annotations), additionalProperties, host, clientId, clientSecret.HasValue ? clientSecret.Value : null, redirectUri, useEncryptedEndpoints.HasValue ? useEncryptedEndpoints.Value : null, useHostVerification.HasValue ? useHostVerification.Value : null, usePeerVerification.HasValue ? usePeerVerification.Value : null, encryptedCredential.HasValue ? encryptedCredential.Value : null);
        }
    }
}
