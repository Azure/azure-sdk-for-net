...
{
    [JsonConverter(typeof(AmazonRdsForSqlServerTableDatasetConverter))]
    public partial class AmazonRdsForSqlServerTableDataset : IUtf8JsonSerializable
    {
        ...
        internal partial class AmazonRdsForSqlServerTableDatasetConverter : JsonConverter<AmazonRdsForSqlServerTableDataset>
        {
            public override void Write(Utf8JsonWriter writer, AmazonRdsForSqlServerTableDataset model, JsonSerializerOptions options)
            {
                writer.WriteObjectValue(model);
            }
            public override AmazonRdsForSqlServerTableDataset Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
            {
                using var document = JsonDocument.ParseValue(ref reader);
                return DeserializeAmazonRdsForSqlServerTableDataset(document.RootElement);
            }
        }
    }
}
