...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class HBaseLinkedService : IUtf8JsonSerializable
    {
        ...
        internal static HBaseLinkedService DeserializeHBaseLinkedService(JsonElement element)
        {
            ...
            return new HBaseLinkedService(type, connectVia.HasValue ? connectVia.Value : null, description.HasValue ? description.Value : null, new ChangeTrackingDictionary<string, ParameterSpecification>(parameters), new ChangeTrackingList<object>(annotations), additionalProperties, host, port.HasValue ? port.Value : null, httpPath.HasValue ? httpPath.Value : null, authenticationType, username.HasValue ? username.Value : null, password.HasValue ? password.Value : null, enableSsl.HasValue ? enableSsl.Value : null, trustedCertPath.HasValue ? trustedCertPath.Value : null, allowHostNameCNMismatch.HasValue ? allowHostNameCNMismatch.Value : null, allowSelfSignedServerCert.HasValue ? allowSelfSignedServerCert.Value : null, encryptedCredential.HasValue ? encryptedCredential.Value : null);
        }
    }
}
