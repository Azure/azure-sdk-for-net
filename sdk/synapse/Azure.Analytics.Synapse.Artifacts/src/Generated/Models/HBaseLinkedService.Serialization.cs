...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class HBaseLinkedService : Core.IUtf8JsonSerializable
    {
        ...
        internal static HBaseLinkedService DeserializeHBaseLinkedService(JsonElement element)
        {
            ...
            return new HBaseLinkedService(type, connectVia.Value, description.Value, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), additionalProperties, host, port.Value, httpPath.Value, authenticationType, username.Value, password.Value, enableSsl.Value, trustedCertPath.Value, allowHostNameCNMismatch.Value, allowSelfSignedServerCert.Value, encryptedCredential.Value);
        }
