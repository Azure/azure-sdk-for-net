...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class IntegrationRuntimeResource : SubResource
    {
        ...
        internal IntegrationRuntimeResource(string id, string name, string type, string etag, IntegrationRuntime properties, Dictionary<string, BinaryData> rawData) : base(id, name, type, etag, rawData)
        {
            Properties = properties;
        }
