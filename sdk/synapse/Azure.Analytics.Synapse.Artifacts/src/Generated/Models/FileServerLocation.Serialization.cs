...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FileServerLocation>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<FileServerLocation>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<FileServerLocation>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<FileServerLocation>)} interface");
            }
        ...
        string IPersistableModel<FileServerLocation>.GetWireFormat(ModelReaderWriterOptions options) => "J";
