...
{
    [JsonConverter(typeof(SalesforceV2SourceConverter))]
    public partial class SalesforceV2Source : IUtf8JsonSerializable
    {
        ...
        internal partial class SalesforceV2SourceConverter : JsonConverter<SalesforceV2Source>
        {
            public override void Write(Utf8JsonWriter writer, SalesforceV2Source model, JsonSerializerOptions options)
            {
                writer.WriteObjectValue(model);
            }

            public override SalesforceV2Source Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
            {
