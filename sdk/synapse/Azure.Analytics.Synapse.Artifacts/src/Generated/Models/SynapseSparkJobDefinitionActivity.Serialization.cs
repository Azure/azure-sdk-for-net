...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class SynapseSparkJobDefinitionActivity : IUtf8JsonSerializable, IModelJsonSerializable<SynapseSparkJobDefinitionActivity>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<SynapseSparkJobDefinitionActivity>(this, options.Format);
            ...
            {
                ((IModelJsonSerializable<SynapseSparkJobReference>)SparkJob).Serialize(writer, options);
            }
            ...
            if (Optional.IsDefined(TargetBigDataPool))
            {
                ...
                {
                    ((IModelJsonSerializable<BigDataPoolParametrizationReference>)TargetBigDataPool).Serialize(writer, options);
                }
            }
            ...
            if (Optional.IsDefined(TargetSparkConfiguration))
            {
                ...
                {
                    ((IModelJsonSerializable<SparkConfigurationParametrizationReference>)TargetSparkConfiguration).Serialize(writer, options);
                }
            }
        ...
        /// <summary> Converts a <see cref="SynapseSparkJobDefinitionActivity"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="SynapseSparkJobDefinitionActivity"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="SynapseSparkJobDefinitionActivity"/>. </summary>
