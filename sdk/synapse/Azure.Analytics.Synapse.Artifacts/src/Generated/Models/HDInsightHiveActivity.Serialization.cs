...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class HDInsightHiveActivity : IUtf8JsonSerializable
    {
        ...
        internal static HDInsightHiveActivity DeserializeHDInsightHiveActivity(JsonElement element)
        {
            ...
            return new HDInsightHiveActivity(name, type, description.HasValue ? description.Value : null, new ChangeTrackingList<ActivityDependency>(dependsOn), new ChangeTrackingList<UserProperty>(userProperties), additionalProperties, linkedServiceName.HasValue ? linkedServiceName.Value : null, policy.HasValue ? policy.Value : null, new ChangeTrackingList<LinkedServiceReference>(storageLinkedServices), new ChangeTrackingList<object>(arguments), getDebugInfo.HasValue ? getDebugInfo.Value : (HDInsightActivityDebugInfoOption?)null, scriptPath.HasValue ? scriptPath.Value : null, scriptLinkedService.HasValue ? scriptLinkedService.Value : null, new ChangeTrackingDictionary<string, object>(defines), new ChangeTrackingList<object>(variables), queryTimeout.HasValue ? queryTimeout.Value : (int?)null);
        }
    }
}
