...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class OdbcTableDataset : Dataset
    {
        ...
        public OdbcTableDataset(LinkedServiceReferenceAutoGenerated linkedServiceName) : base(linkedServiceName)
        {
        ...
        internal OdbcTableDataset(string type, string description, object structure, object schema, LinkedServiceReferenceAutoGenerated linkedServiceName, IDictionary<string, ParameterSpecification> parameters, IList<object> annotations, DatasetFolder folder, IDictionary<string, object> additionalProperties, object tableName) : base(type, description, structure, schema, linkedServiceName, parameters, annotations, folder, additionalProperties)
        {
            TableName = tableName;
            Type = type ?? "OdbcTable";
        }
