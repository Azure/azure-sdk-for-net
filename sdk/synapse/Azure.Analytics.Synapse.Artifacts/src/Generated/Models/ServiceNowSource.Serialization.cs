...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class ServiceNowSource : IUtf8JsonSerializable
    {
        ...
        internal static ServiceNowSource DeserializeServiceNowSource(JsonElement element)
        {
            ...
            return new ServiceNowSource(type, sourceRetryCount.Value, sourceRetryWait.Value, maxConcurrentConnections.Value, additionalProperties, queryTimeout.Value, Optional.ToList(additionalColumns), query.Value);
        }
