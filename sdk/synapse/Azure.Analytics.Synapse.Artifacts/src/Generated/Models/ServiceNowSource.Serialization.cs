...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ServiceNowSource>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<ServiceNowSource>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ServiceNowSource>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(ServiceNowSource)} does not support '{format}' format.");
            }
        ...
        ServiceNowSource IJsonModel<ServiceNowSource>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ServiceNowSource>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        BinaryData IPersistableModel<ServiceNowSource>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ServiceNowSource>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(ServiceNowSource)} does not support '{options.Format}' format.");
            }
        }

        ServiceNowSource IPersistableModel<ServiceNowSource>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ServiceNowSource>)this).GetFormatFromOptions(options) : options.Format;
        ...
        string IPersistableModel<ServiceNowSource>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
