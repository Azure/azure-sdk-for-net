...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class GreenplumLinkedService : Core.IUtf8JsonSerializable
    {
        ...
        internal static GreenplumLinkedService DeserializeGreenplumLinkedService(JsonElement element)
        {
            ...
            return new GreenplumLinkedService(type, connectVia.Value, description.Value, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), additionalProperties, connectionString.Value, pwd.Value, encryptedCredential.Value);
        }
