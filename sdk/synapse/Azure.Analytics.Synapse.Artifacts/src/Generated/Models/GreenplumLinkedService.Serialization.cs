...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class GreenplumLinkedService : IUtf8JsonSerializable
    {
        ...
        internal static GreenplumLinkedService DeserializeGreenplumLinkedService(JsonElement element)
        {
            ...
            return new GreenplumLinkedService(type, connectVia.Value, description.Value, Optional.ToDictionary(parameters), annotations ?? new ChangeTrackingList<object>(), additionalProperties, connectionString.Value, pwd.Value, encryptedCredential.Value);
        }
