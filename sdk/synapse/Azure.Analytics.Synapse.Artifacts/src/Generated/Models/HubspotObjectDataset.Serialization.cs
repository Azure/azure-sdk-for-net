...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class HubspotObjectDataset : IUtf8JsonSerializable
    {
        ...
        internal static HubspotObjectDataset DeserializeHubspotObjectDataset(JsonElement element)
        {
            ...
            return new HubspotObjectDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, parameters ?? new ChangeTrackingDictionary<string, ParameterSpecification>(), annotations ?? new ChangeTrackingList<object>(), folder.Value, additionalProperties, tableName.Value);
        }
