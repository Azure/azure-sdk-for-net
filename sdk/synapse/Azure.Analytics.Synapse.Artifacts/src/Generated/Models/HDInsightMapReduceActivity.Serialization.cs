...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class HDInsightMapReduceActivity : IUtf8JsonSerializable
    {
        ...
        internal static HDInsightMapReduceActivity DeserializeHDInsightMapReduceActivity(JsonElement element)
        {
            ...
            return new HDInsightMapReduceActivity(name, type, description.HasValue ? description.Value : null, new ChangeTrackingList<ActivityDependency>(dependsOn), new ChangeTrackingList<UserProperty>(userProperties), additionalProperties, linkedServiceName.HasValue ? linkedServiceName.Value : null, policy.HasValue ? policy.Value : null, new ChangeTrackingList<LinkedServiceReference>(storageLinkedServices), new ChangeTrackingList<object>(arguments), getDebugInfo.HasValue ? getDebugInfo.Value : (HDInsightActivityDebugInfoOption?)null, className, jarFilePath, jarLinkedService.HasValue ? jarLinkedService.Value : null, new ChangeTrackingList<object>(jarLibs), new ChangeTrackingDictionary<string, object>(defines));
        }
    }
}
