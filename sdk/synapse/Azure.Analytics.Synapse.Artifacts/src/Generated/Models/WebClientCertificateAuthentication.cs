...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class WebClientCertificateAuthentication : WebLinkedServiceTypeProperties
    {
        ...
        internal WebClientCertificateAuthentication(object url, WebAuthenticationType authenticationType, SecretBase pfx, SecretBase password, Dictionary<string, BinaryData> rawData) : base(url, authenticationType, rawData)
        {
            Pfx = pfx;
            Password = password;
