...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class GetMetadataActivity : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            if (!(FieldList is ChangeTrackingList<object> collection1 && collection1.IsUndefined))
            {
        ...
        internal static GetMetadataActivity DeserializeGetMetadataActivity(JsonElement element)
        {
            ...
            return new GetMetadataActivity(name, type, description.Value, Optional.ToNullable(state), Optional.ToNullable(onInactiveMarkAs), dependsOn ?? new ChangeTrackingList<ActivityDependency>(), userProperties ?? new ChangeTrackingList<UserProperty>(), additionalProperties, linkedServiceName.Value, policy.Value, dataset, fieldList ?? new ChangeTrackingList<object>(), storeSettings.Value, formatSettings.Value);
        }
