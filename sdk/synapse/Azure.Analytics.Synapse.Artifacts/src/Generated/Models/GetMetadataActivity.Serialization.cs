...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class GetMetadataActivity : IUtf8JsonSerializable, IJsonModel<GetMetadataActivity>
    {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<GetMetadataActivity>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(GetMetadataActivity)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<GetMetadataActivity>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(GetMetadataActivity)} does not support '{options.Format}' format.");
            }
        }
