    ...
    public partial class GetMetadataActivity : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            if (Optional.IsDefined(FormatSettings))
            {
                ...
                writer.WriteObjectValue<FormatReadSettings>(FormatSettings);
            }
        ...
        internal static new GetMetadataActivity FromResponse(Response response)
        {
        ...
        internal override RequestContent ToRequestContent()
        {
            ...
            content.JsonWriter.WriteObjectValue<GetMetadataActivity>(this);
            return content;
        }
        ...
        internal partial class GetMetadataActivityConverter : JsonConverter<GetMetadataActivity>
        {
            ...
            {
                writer.WriteObjectValue<GetMetadataActivity>(model);
            }
