...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SapTablePartitionSettings>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SapTablePartitionSettings>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SapTablePartitionSettings>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<SapTablePartitionSettings>.GetWireFormat(ModelReaderWriterOptions options) => "J";
