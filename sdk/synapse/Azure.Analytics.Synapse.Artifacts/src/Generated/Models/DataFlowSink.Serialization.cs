...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class DataFlowSink : IUtf8JsonSerializable
    {
        ...
        {
            Optional<LinkedServiceReferenceAutoGenerated> schemaLinkedService = default;
            string name = default;
            Optional<string> description = default;
            Optional<DatasetReference> dataset = default;
            Optional<LinkedServiceReferenceAutoGenerated> linkedService = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("schemaLinkedService"))
                {
                    ...
                    schemaLinkedService = LinkedServiceReferenceAutoGenerated.DeserializeLinkedServiceReferenceAutoGenerated(property.Value);
                    continue;
                }
                ...
                if (property.NameEquals("linkedService"))
                {
                    ...
                    linkedService = LinkedServiceReferenceAutoGenerated.DeserializeLinkedServiceReferenceAutoGenerated(property.Value);
                    continue;
                }
