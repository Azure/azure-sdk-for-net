...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    internal partial class UnknownDatasetLocation : IUtf8JsonSerializable
    {
        ...
        internal static new UnknownDatasetLocation FromResponse(Response response)
        {
            using var document = JsonDocument.Parse(response.Content);
            return DeserializeUnknownDatasetLocation(document.RootElement);
        }
        ...
        internal override RequestContent ToRequestContent()
        {
            ...
            content.JsonWriter.WriteObjectValue<UnknownDatasetLocation>(this);
            return content;
        }
    }
}
