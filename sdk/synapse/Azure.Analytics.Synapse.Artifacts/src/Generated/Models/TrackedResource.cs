...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class TrackedResource : Resource
    {
        ...
        internal TrackedResource(string id, string name, string type, IDictionary<string, string> tags, string location, Dictionary<string, BinaryData> rawData) : base(id, name, type, rawData)
        {
            Tags = tags;
            Location = location;
        }
