...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class TrackedResource : Resource
    {
        ...
        /// <param name="location"> The geo-location where the resource lives. </param>
        internal TrackedResource(string id, string name, string type, IDictionary<string, BinaryData> serializedAdditionalRawData, IDictionary<string, string> tags, string location) : base(id, name, type, serializedAdditionalRawData)
        {
            Tags = tags;
            Location = location;
        }
