...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class Db2TableDataset : IUtf8JsonSerializable
    {
        ...
        internal static Db2TableDataset DeserializeDb2TableDataset(JsonElement element)
        {
            ...
            return new Db2TableDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Optional.ToDictionary(parameters), annotations ?? new ChangeTrackingList<object>(), folder.Value, additionalProperties, tableName.Value, schema0.Value, table.Value);
        }
