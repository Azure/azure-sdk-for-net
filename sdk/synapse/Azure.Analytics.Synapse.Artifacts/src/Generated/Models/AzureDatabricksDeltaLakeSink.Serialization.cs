...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class AzureDatabricksDeltaLakeSink : Core.IUtf8JsonSerializable
    {
        void Core.IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            if (Core.Optional.IsDefined(ImportSettings))
            {
        ...
        internal static AzureDatabricksDeltaLakeSink DeserializeAzureDatabricksDeltaLakeSink(JsonElement element)
        {
            ...
            Core.Optional<AzureDatabricksDeltaLakeImportCommand> importSettings = default;
            string type = default;
