...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class HDInsightLinkedService : LinkedService
    {
        ...
        internal HDInsightLinkedService(string type, IntegrationRuntimeReference connectVia, string description, IDictionary<string, ParameterSpecification> parameters, IList<object> annotations, IDictionary<string, object> additionalProperties, object clusterUri, object userName, SecretBase password, LinkedServiceReferenceAutoGenerated linkedServiceName, LinkedServiceReferenceAutoGenerated hcatalogLinkedServiceName, object encryptedCredential, object isEspEnabled, object fileSystem) : base(type, connectVia, description, parameters, annotations, additionalProperties)
        {
            ClusterUri = clusterUri;
            UserName = userName;
            Password = password;
        ...
        public LinkedServiceReferenceAutoGenerated HcatalogLinkedServiceName { get; set; }
