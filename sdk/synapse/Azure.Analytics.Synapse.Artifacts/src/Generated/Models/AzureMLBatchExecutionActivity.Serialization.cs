...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class AzureMLBatchExecutionActivity : IUtf8JsonSerializable, IModelJsonSerializable<AzureMLBatchExecutionActivity>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<AzureMLBatchExecutionActivity>(this, options.Format);
            ...
            if (Optional.IsCollectionDefined(WebServiceOutputs))
            {
                ...
                foreach (var item in WebServiceOutputs)
                {
                    ...
                    {
                        ((IModelJsonSerializable<AzureMLWebServiceFile>)item.Value).Serialize(writer, options);
                    }
                }
                writer.WriteEndObject();
            }
        ...
        /// <summary> Converts a <see cref="AzureMLBatchExecutionActivity"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="AzureMLBatchExecutionActivity"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="AzureMLBatchExecutionActivity"/>. </summary>
