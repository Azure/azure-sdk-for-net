...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class AmazonMWSObjectDataset : IUtf8JsonSerializable
    {
        ...
        internal static AmazonMWSObjectDataset DeserializeAmazonMWSObjectDataset(JsonElement element)
        {
            ...
            return new AmazonMWSObjectDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, parameters ?? new ChangeTrackingDictionary<string, ParameterSpecification>(), annotations ?? new ChangeTrackingList<object>(), folder.Value, additionalProperties, tableName.Value);
        }
