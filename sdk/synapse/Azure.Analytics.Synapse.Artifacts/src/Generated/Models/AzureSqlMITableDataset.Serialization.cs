...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class AzureSqlMITableDataset : IUtf8JsonSerializable
    {
        ...
        internal static AzureSqlMITableDataset DeserializeAzureSqlMITableDataset(JsonElement element)
        {
            ...
            return new AzureSqlMITableDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Optional.ToDictionary(parameters), annotations ?? new ChangeTrackingList<object>(), folder.Value, additionalProperties, tableName.Value, schema0.Value, table.Value);
        }
