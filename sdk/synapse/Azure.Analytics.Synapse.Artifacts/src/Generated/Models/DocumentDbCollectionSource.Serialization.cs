...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DocumentDbCollectionSource>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        DocumentDbCollectionSource IJsonModel<DocumentDbCollectionSource>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<DocumentDbCollectionSource>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        DocumentDbCollectionSource IModel<DocumentDbCollectionSource>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<DocumentDbCollectionSource>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
