...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class LibraryInfo
    {
        ...
        internal LibraryInfo(string name, string path, string containerName, DateTimeOffset? uploadedTimestamp, string type, string provisioningStatus, string creatorId, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Path = path;
