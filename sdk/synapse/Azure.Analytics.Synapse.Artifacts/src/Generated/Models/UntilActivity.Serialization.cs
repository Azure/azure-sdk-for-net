...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class UntilActivity : IUtf8JsonSerializable
    {
        ...
        internal static UntilActivity DeserializeUntilActivity(JsonElement element)
        {
            ...
            return new UntilActivity(name, type, description.HasValue ? description.Value : null, new ChangeTrackingList<ActivityDependency>(dependsOn), new ChangeTrackingList<UserProperty>(userProperties), additionalProperties, expression, timeout.HasValue ? timeout.Value : null, activities);
        }
    }
}
