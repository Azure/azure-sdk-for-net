...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class SalesforceV2LinkedService : LinkedService
    {
        ...
        internal SalesforceV2LinkedService(string type, IntegrationRuntimeReference connectVia, string description, IDictionary<string, ParameterSpecification> parameters, IList<object> annotations, IDictionary<string, object> additionalProperties, object environmentUrl, object authenticationType, object clientId, SecretBase clientSecret, object apiVersion, string encryptedCredential) : base(type, connectVia, description, parameters, annotations, additionalProperties)
        {
