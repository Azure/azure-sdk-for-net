...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class BinaryDataset : IUtf8JsonSerializable
    {
        ...
        internal static BinaryDataset DeserializeBinaryDataset(JsonElement element)
        {
            ...
            return new BinaryDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Optional.ToDictionary(parameters), annotations ?? new ChangeTrackingList<object>(), folder.Value, additionalProperties, location.Value, compression.Value);
        }
