...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class BinaryDataset : IUtf8JsonSerializable
    {
        ...
        internal static BinaryDataset DeserializeBinaryDataset(JsonElement element)
        {
            ...
            return new BinaryDataset(type, description.HasValue ? description.Value : null, structure.HasValue ? structure.Value : null, schema.HasValue ? schema.Value : null, linkedServiceName, new ChangeTrackingDictionary<string, ParameterSpecification>(parameters), new ChangeTrackingList<object>(annotations), folder.HasValue ? folder.Value : null, additionalProperties, location.HasValue ? location.Value : null, compression.HasValue ? compression.Value : null);
        }
    }
}
