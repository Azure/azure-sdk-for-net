...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class AppendVariableActivity : ControlActivity
    {
        ...
        internal AppendVariableActivity(string name, string type, string description, IList<ActivityDependency> dependsOn, IList<UserProperty> userProperties, IDictionary<string, BinaryData> additionalProperties, string variableName, BinaryData value) : base(name, type, description, dependsOn, userProperties, additionalProperties)
        {
