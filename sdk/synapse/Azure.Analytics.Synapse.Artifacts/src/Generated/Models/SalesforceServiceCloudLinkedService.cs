...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class SalesforceServiceCloudLinkedService : LinkedService
    {
        ...
        internal SalesforceServiceCloudLinkedService(string type, IntegrationRuntimeReference connectVia, string description, IDictionary<string, ParameterSpecification> parameters, IList<BinaryData> annotations, IDictionary<string, BinaryData> additionalProperties, BinaryData environmentUrl, BinaryData username, SecretBase password, SecretBase securityToken, BinaryData apiVersion, BinaryData extendedProperties, BinaryData encryptedCredential) : base(type, connectVia, description, parameters, annotations, additionalProperties)
        {
        ...
        public BinaryData EnvironmentUrl { get; set; }
