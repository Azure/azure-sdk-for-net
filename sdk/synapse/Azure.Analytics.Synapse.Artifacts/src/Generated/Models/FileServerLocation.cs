...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class FileServerLocation : DatasetLocation
    {
        ...
        internal FileServerLocation(string type, BinaryData folderPath, BinaryData fileName, IDictionary<string, BinaryData> additionalProperties) : base(type, folderPath, fileName, additionalProperties)
        {
