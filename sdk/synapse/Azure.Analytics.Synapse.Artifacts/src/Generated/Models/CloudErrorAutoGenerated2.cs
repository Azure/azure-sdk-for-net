...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class CloudErrorAutoGenerated2
    {
        ...
        internal CloudErrorAutoGenerated2(string code, string message)
        {
            if (code == null)
            {
        ...
        internal CloudErrorAutoGenerated2(string code, string message, string target, IReadOnlyList<CloudErrorAutoGenerated2> details)
        {
            Code = code;
            Message = message;
            Target = target;
