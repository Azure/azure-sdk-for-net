...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class AzureKeyVaultSecretReference : SecretBase
    {
        ...
        public AzureKeyVaultSecretReference(LinkedServiceReferenceAutoGenerated store, object secretName)
        {
            if (store == null)
            {
        ...
        internal AzureKeyVaultSecretReference(string type, LinkedServiceReferenceAutoGenerated store, object secretName, object secretVersion) : base(type)
        {
            Store = store;
            SecretName = secretName;
        ...
        public LinkedServiceReferenceAutoGenerated Store { get; set; }
