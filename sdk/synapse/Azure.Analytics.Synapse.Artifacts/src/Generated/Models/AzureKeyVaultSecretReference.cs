...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class AzureKeyVaultSecretReference : SecretBase
    {
        ...
        internal AzureKeyVaultSecretReference(string type, LinkedServiceReference store, object secretName, object secretVersion, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(type, serializedAdditionalRawData)
        {
            Store = store;
            SecretName = secretName;
