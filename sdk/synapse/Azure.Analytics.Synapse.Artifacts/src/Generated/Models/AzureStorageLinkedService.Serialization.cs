...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class AzureStorageLinkedService : Core.IUtf8JsonSerializable
    {
        ...
        internal static AzureStorageLinkedService DeserializeAzureStorageLinkedService(JsonElement element)
        {
            ...
            return new AzureStorageLinkedService(type, connectVia.Value, description.Value, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), additionalProperties, connectionString.Value, accountKey.Value, sasUri.Value, sasToken.Value, encryptedCredential.Value);
        }
