...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class XeroSource : IUtf8JsonSerializable
    {
        ...
        internal static XeroSource DeserializeXeroSource(JsonElement element)
        {
            ...
            return new XeroSource(type, sourceRetryCount.Value, sourceRetryWait.Value, maxConcurrentConnections.Value, additionalProperties, queryTimeout.Value, query.Value);
        }
