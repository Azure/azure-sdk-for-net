...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class StagingSettings
    {
        ...
        public StagingSettings(LinkedServiceReferenceAutoGenerated linkedServiceName)
        {
        ...
        internal StagingSettings(LinkedServiceReferenceAutoGenerated linkedServiceName, object path, object enableCompression, IDictionary<string, object> additionalProperties)
        {
            LinkedServiceName = linkedServiceName;
            Path = path;
        ...
        public LinkedServiceReferenceAutoGenerated LinkedServiceName { get; set; }
