...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class LinkTableRequestTarget
    {
        ...
        internal LinkTableRequestTarget(string tableName, string schemaName, LinkTableRequestTargetDistributionOptions distributionOptions, LinkTableRequestTargetStructureOptions structureOptions, Dictionary<string, BinaryData> rawData)
        {
            TableName = tableName;
