...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class SapCloudForCustomerLinkedService : LinkedService
    {
        ...
        public SapCloudForCustomerLinkedService(BinaryData url)
        {
            if (url == null)
            {
        ...
        internal SapCloudForCustomerLinkedService(string type, IntegrationRuntimeReference connectVia, string description, IDictionary<string, ParameterSpecification> parameters, IList<BinaryData> annotations, IDictionary<string, BinaryData> additionalProperties, BinaryData url, BinaryData username, SecretBase password, BinaryData encryptedCredential) : base(type, connectVia, description, parameters, annotations, additionalProperties)
        {
            Url = url;
            Username = username;
            Password = password;
