...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class SapOpenHubLinkedService : IUtf8JsonSerializable
    {
        ...
        internal static SapOpenHubLinkedService DeserializeSapOpenHubLinkedService(JsonElement element)
        {
            ...
            return new SapOpenHubLinkedService(type, connectVia, description, parameters, annotations, additionalProperties, server, systemNumber, clientId, language, userName, password, encryptedCredential);
        }
    }
}
