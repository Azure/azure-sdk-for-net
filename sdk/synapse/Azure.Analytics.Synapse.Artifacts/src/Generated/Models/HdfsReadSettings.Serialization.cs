...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class HdfsReadSettings : Core.IUtf8JsonSerializable
    {
        void Core.IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            if (Core.Optional.IsDefined(DistcpSettings))
            {
        ...
        internal static HdfsReadSettings DeserializeHdfsReadSettings(JsonElement element)
        {
            ...
            Core.Optional<DistcpSettings> distcpSettings = default;
            ...
            return new HdfsReadSettings(type, maxConcurrentConnections.Value, additionalProperties, recursive.Value, wildcardFolderPath.Value, wildcardFileName.Value, fileListPath.Value, Core.Optional.ToNullable(enablePartitionDiscovery), partitionRootPath.Value, modifiedDatetimeStart.Value, modifiedDatetimeEnd.Value, distcpSettings.Value, deleteFilesAfterCompletion.Value);
        }
