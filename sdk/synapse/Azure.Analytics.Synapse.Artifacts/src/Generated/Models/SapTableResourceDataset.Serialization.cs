...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class SapTableResourceDataset : Core.IUtf8JsonSerializable
    {
        ...
        internal static SapTableResourceDataset DeserializeSapTableResourceDataset(JsonElement element)
        {
            ...
            return new SapTableResourceDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), folder.Value, additionalProperties, tableName);
        }
