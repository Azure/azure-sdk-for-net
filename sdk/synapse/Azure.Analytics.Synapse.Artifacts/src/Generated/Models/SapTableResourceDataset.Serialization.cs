...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class SapTableResourceDataset : IUtf8JsonSerializable, IJsonModel<SapTableResourceDataset>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<SapTableResourceDataset>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<SapTableResourceDataset>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
