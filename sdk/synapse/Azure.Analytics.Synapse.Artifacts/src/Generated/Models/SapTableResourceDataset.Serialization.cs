...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SapTableResourceDataset>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SapTableResourceDataset>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SapTableResourceDataset>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SapTableResourceDataset>)} interface");
            }
        ...
        SapTableResourceDataset IJsonModel<SapTableResourceDataset>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IPersistableModel<SapTableResourceDataset>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == "J" || options.Format == "W";
            if (!isValid)
            {
        ...
        SapTableResourceDataset IPersistableModel<SapTableResourceDataset>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == "J" || options.Format == "W";
            if (!isValid)
            {
        ...
        string IPersistableModel<SapTableResourceDataset>.GetWireFormat(ModelReaderWriterOptions options) => "J";
