...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class SapTableResourceDataset : IUtf8JsonSerializable, IJsonModel<SapTableResourceDataset>
    {
        ...
        void IJsonModel<SapTableResourceDataset>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(SapTableResourceDataset)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<SapTableResourceDataset>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(SapTableResourceDataset)} does not support '{options.Format}' format.");
            }
        }
