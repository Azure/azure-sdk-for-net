...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class SapTableResourceDataset : IUtf8JsonSerializable
    {
        ...
        internal static SapTableResourceDataset DeserializeSapTableResourceDataset(JsonElement element)
        {
            ...
            return new SapTableResourceDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Optional.ToDictionary(parameters), annotations ?? new ChangeTrackingList<object>(), folder.Value, additionalProperties, tableName);
        }
