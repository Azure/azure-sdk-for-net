...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class SapTableResourceDataset : Dataset
    {
        ...
        public SapTableResourceDataset(LinkedServiceReferenceAutoGenerated linkedServiceName, object tableName) : base(linkedServiceName)
        {
        ...
        /// <param name="tableName"> The name of the SAP Table. Type: string (or Expression with resultType string). </param>
        internal SapTableResourceDataset(string type, string description, object structure, object schema, LinkedServiceReferenceAutoGenerated linkedServiceName, IDictionary<string, ParameterSpecification> parameters, IList<object> annotations, DatasetFolder folder, IDictionary<string, object> additionalProperties, object tableName) : base(type, description, structure, schema, linkedServiceName, parameters, annotations, folder, additionalProperties)
        {
            TableName = tableName;
