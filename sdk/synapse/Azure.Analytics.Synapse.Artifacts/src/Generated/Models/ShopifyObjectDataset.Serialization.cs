...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class ShopifyObjectDataset : IUtf8JsonSerializable
    {
        ...
        internal static ShopifyObjectDataset DeserializeShopifyObjectDataset(JsonElement element)
        {
            ...
            return new ShopifyObjectDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Optional.ToDictionary(parameters), annotations ?? new ChangeTrackingList<object>(), folder.Value, additionalProperties, tableName.Value);
        }
