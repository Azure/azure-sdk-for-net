...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class SparkConfigurationReference
    {
        ...
        internal SparkConfigurationReference(SparkConfigurationReferenceType type, string referenceName, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Type = type;
            ReferenceName = referenceName;
