...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class ActivityPolicy : IUtf8JsonSerializable, IJsonModel<ActivityPolicy>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<ActivityPolicy>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ActivityPolicy>)} interface");
            }
        ...
        ActivityPolicy IJsonModel<ActivityPolicy>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (!isValid)
            {
                throw new FormatException($"The model {nameof(ActivityPolicy)} does not support '{options.Format}' format.");
            }
