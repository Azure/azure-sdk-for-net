...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class SqlPoolInfoListResult : IUtf8JsonSerializable, IJsonModel<SqlPoolInfoListResult>
    {
        ...
        void IJsonModel<SqlPoolInfoListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(SqlPoolInfoListResult)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<SqlPoolInfoListResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(SqlPoolInfoListResult)} does not support '{options.Format}' format.");
            }
        }
