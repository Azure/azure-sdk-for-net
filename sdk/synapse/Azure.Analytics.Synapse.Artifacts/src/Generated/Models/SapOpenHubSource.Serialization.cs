...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SapOpenHubSource>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SapOpenHubSource>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SapOpenHubSource>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SapOpenHubSource>)} interface");
            }
        ...
        string IPersistableModel<SapOpenHubSource>.GetWireFormat(ModelReaderWriterOptions options) => "J";
