...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class Office365Dataset : Dataset
    {
        ...
        public Office365Dataset(LinkedServiceReferenceAutoGenerated linkedServiceName, object tableName) : base(linkedServiceName)
        {
        ...
        internal Office365Dataset(string type, string description, object structure, object schema, LinkedServiceReferenceAutoGenerated linkedServiceName, IDictionary<string, ParameterSpecification> parameters, IList<object> annotations, DatasetFolder folder, IDictionary<string, object> additionalProperties, object tableName, object predicate) : base(type, description, structure, schema, linkedServiceName, parameters, annotations, folder, additionalProperties)
        {
            TableName = tableName;
            Predicate = predicate;
