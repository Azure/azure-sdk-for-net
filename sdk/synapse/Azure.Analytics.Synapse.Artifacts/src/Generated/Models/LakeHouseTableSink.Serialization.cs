...
{
    [JsonConverter(typeof(LakeHouseTableSinkConverter))]
    public partial class LakeHouseTableSink : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            if (Optional.IsDefined(TableActionOption))
            {
                ...
                writer.WriteObjectValue<object>(TableActionOption);
            }
            ...
            if (Optional.IsDefined(PartitionNameList))
            {
                ...
                writer.WriteObjectValue<object>(PartitionNameList);
            }
        ...
        internal static LakeHouseTableSink DeserializeLakeHouseTableSink(JsonElement element)
        {
            ...
            object tableActionOption = default;
            object partitionOption = default;
            object partitionNameList = default;
            string type = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("tableActionOption"u8))
                {
                    ...
                    tableActionOption = property.Value.GetObject();
                    continue;
                }
                ...
                if (property.NameEquals("partitionNameList"u8))
                {
                    ...
                    partitionNameList = property.Value.GetObject();
                    continue;
                }
        ...
        internal static new LakeHouseTableSink FromResponse(Response response)
        {
            using var document = JsonDocument.Parse(response.Content, ModelSerializationExtensions.JsonDocumentOptions);
            return DeserializeLakeHouseTableSink(document.RootElement);
        }
        ...
        internal partial class LakeHouseTableSinkConverter : JsonConverter<LakeHouseTableSink>
        {
            public override void Write(Utf8JsonWriter writer, LakeHouseTableSink model, JsonSerializerOptions options)
            {
                writer.WriteObjectValue(model);
            }

            public override LakeHouseTableSink Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
            {
