...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class OdbcLinkedService : IUtf8JsonSerializable
    {
        ...
        internal static OdbcLinkedService DeserializeOdbcLinkedService(JsonElement element)
        {
            ...
            return new OdbcLinkedService(type, connectVia.Value, description.Value, Optional.ToDictionary(parameters), annotations ?? new ChangeTrackingList<object>(), additionalProperties, connectionString, authenticationType.Value, credential.Value, userName.Value, password.Value, encryptedCredential.Value);
        }
