...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class OdbcLinkedService : Core.IUtf8JsonSerializable
    {
        ...
        internal static OdbcLinkedService DeserializeOdbcLinkedService(JsonElement element)
        {
            ...
            return new OdbcLinkedService(type, connectVia.Value, description.Value, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), additionalProperties, connectionString, authenticationType.Value, credential.Value, userName.Value, password.Value, encryptedCredential.Value);
        }
