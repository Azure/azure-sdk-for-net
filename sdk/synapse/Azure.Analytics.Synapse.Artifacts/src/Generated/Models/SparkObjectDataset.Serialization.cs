...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class SparkObjectDataset : IUtf8JsonSerializable, IModelJsonSerializable<SparkObjectDataset>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IModelJsonSerializable<SparkObjectDataset>)this).Serialize(writer, ModelSerializerOptions.DefaultWireOptions);

        void IModelJsonSerializable<SparkObjectDataset>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<SparkObjectDataset>(this, options.Format);
        ...
        internal static SparkObjectDataset DeserializeSparkObjectDataset(JsonElement element, ModelSerializerOptions options = default)
        {
        ...
        SparkObjectDataset IModelJsonSerializable<SparkObjectDataset>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<SparkObjectDataset>(this, options.Format);

            using var doc = JsonDocument.ParseValue(ref reader);
            return DeserializeSparkObjectDataset(doc.RootElement, options);
        }

        BinaryData IModelSerializable<SparkObjectDataset>.Serialize(ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<SparkObjectDataset>(this, options.Format);
        ...
        SparkObjectDataset IModelSerializable<SparkObjectDataset>.Deserialize(BinaryData data, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<SparkObjectDataset>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="SparkObjectDataset"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="SparkObjectDataset"/> to convert. </param>
        public static implicit operator RequestContent(SparkObjectDataset model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="SparkObjectDataset"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator SparkObjectDataset(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeSparkObjectDataset(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
