...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SparkObjectDataset>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<SparkObjectDataset>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SparkObjectDataset>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
