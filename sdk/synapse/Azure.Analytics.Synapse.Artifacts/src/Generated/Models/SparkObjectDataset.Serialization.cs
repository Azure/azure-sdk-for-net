...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class SparkObjectDataset : Core.IUtf8JsonSerializable
    {
        ...
        internal static SparkObjectDataset DeserializeSparkObjectDataset(JsonElement element)
        {
            ...
            return new SparkObjectDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), folder.Value, additionalProperties, tableName.Value, table.Value, schema0.Value);
        }
