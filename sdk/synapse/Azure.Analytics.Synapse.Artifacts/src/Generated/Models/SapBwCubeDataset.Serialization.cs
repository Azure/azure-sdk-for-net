...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class SapBwCubeDataset : IUtf8JsonSerializable
    {
        ...
        internal static SapBwCubeDataset DeserializeSapBwCubeDataset(JsonElement element)
        {
            ...
            return new SapBwCubeDataset(type, description.HasValue ? description.Value : null, structure.HasValue ? structure.Value : null, schema.HasValue ? schema.Value : null, linkedServiceName, new ChangeTrackingDictionary<string, ParameterSpecification>(parameters), new ChangeTrackingList<object>(annotations), folder.HasValue ? folder.Value : null, additionalProperties);
        }
    }
}
