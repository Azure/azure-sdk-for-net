...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class SapBwCubeDataset : Core.IUtf8JsonSerializable
    {
        ...
        internal static SapBwCubeDataset DeserializeSapBwCubeDataset(JsonElement element)
        {
            ...
            return new SapBwCubeDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), folder.Value, additionalProperties);
        }
