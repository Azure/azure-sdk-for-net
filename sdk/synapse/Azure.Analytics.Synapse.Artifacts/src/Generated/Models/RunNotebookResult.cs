...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class RunNotebookResult
    {
        ...
        internal RunNotebookResult(string runId, string runStatus, string lastCheckedOn, long? sessionId, string sparkPool, object sessionDetail, string exitValue, RunNotebookError error, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            RunId = runId;
            RunStatus = runStatus;
