...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class CustomActivity : IUtf8JsonSerializable
    {
        ...
        internal static CustomActivity DeserializeCustomActivity(JsonElement element)
        {
            ...
            Optional<LinkedServiceReferenceAutoGenerated> resourceLinkedService = default;
                ...
                if (property.NameEquals("typeProperties"))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("resourceLinkedService"))
                        {
                            ...
                            resourceLinkedService = LinkedServiceReferenceAutoGenerated.DeserializeLinkedServiceReferenceAutoGenerated(property0.Value);
                            continue;
                        }
