    ...
    public partial class CustomActivity : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            if (Optional.IsDefined(ReferenceObjects))
            {
                ...
                JsonSerializer.Serialize(writer, ReferenceObjects);
            }
                ...
                if (property.NameEquals("typeProperties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("resourceLinkedService"u8))
                        {
                            ...
                            resourceLinkedService = ModelSerializationExtensions.JsonDeserialize<LinkedServiceReference>(property0.Value);
                            continue;
                        }
        ...
        internal static new CustomActivity FromResponse(Response response)
        {
