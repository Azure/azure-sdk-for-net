...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class CustomActivity : IUtf8JsonSerializable
    {
        ...
        internal static CustomActivity DeserializeCustomActivity(JsonElement element)
        {
            ...
            return new CustomActivity(name, type, description.HasValue ? description.Value : null, new ChangeTrackingList<ActivityDependency>(dependsOn), new ChangeTrackingList<UserProperty>(userProperties), additionalProperties, linkedServiceName.HasValue ? linkedServiceName.Value : null, policy.HasValue ? policy.Value : null, command, resourceLinkedService.HasValue ? resourceLinkedService.Value : null, folderPath.HasValue ? folderPath.Value : null, referenceObjects.HasValue ? referenceObjects.Value : null, new ChangeTrackingDictionary<string, object>(extendedProperties), retentionTimeInDays.HasValue ? retentionTimeInDays.Value : null);
        }
    }
}
