...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class AzureDataLakeStoreLocation : DatasetLocation
    {
        ...
        internal AzureDataLakeStoreLocation(string type, BinaryData folderPath, BinaryData fileName, IDictionary<string, BinaryData> additionalProperties) : base(type, folderPath, fileName, additionalProperties)
        {
