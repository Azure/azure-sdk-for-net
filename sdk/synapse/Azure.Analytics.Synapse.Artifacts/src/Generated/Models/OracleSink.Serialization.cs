...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class OracleSink : IUtf8JsonSerializable
    {
        ...
        internal static new OracleSink FromResponse(Response response)
        {
        ...
        internal override RequestContent ToRequestContent()
        {
            ...
            content.JsonWriter.WriteObjectValue<OracleSink>(this);
            return content;
        }
        ...
        internal partial class OracleSinkConverter : JsonConverter<OracleSink>
        {
            ...
            {
                writer.WriteObjectValue<OracleSink>(model);
            }
