...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<OracleSink>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<OracleSink>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<OracleSink>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<OracleSink>)} interface");
            }
        ...
        string IPersistableModel<OracleSink>.GetWireFormat(ModelReaderWriterOptions options) => "J";
