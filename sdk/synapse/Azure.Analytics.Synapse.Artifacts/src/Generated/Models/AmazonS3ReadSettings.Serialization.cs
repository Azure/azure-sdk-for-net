...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class AmazonS3ReadSettings : Core.IUtf8JsonSerializable
    {
        ...
        internal static AmazonS3ReadSettings DeserializeAmazonS3ReadSettings(JsonElement element)
        {
            ...
            return new AmazonS3ReadSettings(type, maxConcurrentConnections.Value, additionalProperties, recursive.Value, wildcardFolderPath.Value, wildcardFileName.Value, prefix.Value, fileListPath.Value, Core.Optional.ToNullable(enablePartitionDiscovery), partitionRootPath.Value, deleteFilesAfterCompletion.Value, modifiedDatetimeStart.Value, modifiedDatetimeEnd.Value);
        }
