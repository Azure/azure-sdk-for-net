...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AmazonS3ReadSettings>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<AmazonS3ReadSettings>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AmazonS3ReadSettings>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
