...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class DelimitedTextWriteSettings : FormatWriteSettings
    {
        ...
        internal DelimitedTextWriteSettings(string type, IDictionary<string, BinaryData> additionalProperties, BinaryData quoteAllText, BinaryData fileExtension, BinaryData maxRowsPerFile, BinaryData fileNamePrefix) : base(type, additionalProperties)
        {
