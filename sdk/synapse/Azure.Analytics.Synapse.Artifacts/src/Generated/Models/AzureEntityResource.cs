...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class AzureEntityResource : Resource
    {
        ...
        internal AzureEntityResource(string id, string name, string type, string etag, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, type, serializedAdditionalRawData)
        {
            Etag = etag;
        }
