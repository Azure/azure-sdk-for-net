...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class AzureEntityResource : Resource
    {
        ...
        internal AzureEntityResource(string id, string name, string type, IDictionary<string, BinaryData> serializedAdditionalRawData, string etag) : base(id, name, type, serializedAdditionalRawData)
        {
            Etag = etag;
        }
