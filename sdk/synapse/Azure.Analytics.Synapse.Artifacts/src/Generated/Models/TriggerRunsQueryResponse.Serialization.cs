...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    {
        internal static TriggerRunsQueryResponse DeserializeTriggerRunsQueryResponse(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
