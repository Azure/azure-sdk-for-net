...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class HBaseObjectDataset : IUtf8JsonSerializable
    {
        ...
        internal static HBaseObjectDataset DeserializeHBaseObjectDataset(JsonElement element)
        {
            ...
            return new HBaseObjectDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, parameters ?? new ChangeTrackingDictionary<string, ParameterSpecification>(), annotations ?? new ChangeTrackingList<object>(), folder.Value, additionalProperties, tableName.Value);
        }
