...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class MarketoObjectDataset : IUtf8JsonSerializable, IModelJsonSerializable<MarketoObjectDataset>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<MarketoObjectDataset>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="MarketoObjectDataset"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="MarketoObjectDataset"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="MarketoObjectDataset"/>. </summary>
