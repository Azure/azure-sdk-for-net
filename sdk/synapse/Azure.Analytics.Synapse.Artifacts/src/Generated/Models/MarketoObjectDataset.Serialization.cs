...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class MarketoObjectDataset : Core.IUtf8JsonSerializable
    {
        ...
        internal static MarketoObjectDataset DeserializeMarketoObjectDataset(JsonElement element)
        {
            ...
            return new MarketoObjectDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), folder.Value, additionalProperties, tableName.Value);
        }
