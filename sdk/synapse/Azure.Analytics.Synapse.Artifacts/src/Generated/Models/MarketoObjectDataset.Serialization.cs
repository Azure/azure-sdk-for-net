...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class MarketoObjectDataset : IUtf8JsonSerializable
    {
        ...
        internal static MarketoObjectDataset DeserializeMarketoObjectDataset(JsonElement element)
        {
            ...
            return new MarketoObjectDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, parameters ?? new ChangeTrackingDictionary<string, ParameterSpecification>(), annotations ?? new ChangeTrackingList<object>(), folder.Value, additionalProperties, tableName.Value);
        }
