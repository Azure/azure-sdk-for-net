...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class TypeConversionSettings : IUtf8JsonSerializable, IModelJsonSerializable<TypeConversionSettings>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<TypeConversionSettings>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="TypeConversionSettings"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="TypeConversionSettings"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="TypeConversionSettings"/>. </summary>
