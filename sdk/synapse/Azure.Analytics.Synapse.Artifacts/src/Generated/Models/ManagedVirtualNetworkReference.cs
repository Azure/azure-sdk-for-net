...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class ManagedVirtualNetworkReference
    {
        ...
        internal ManagedVirtualNetworkReference(ManagedVirtualNetworkReferenceType type, string referenceName, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Type = type;
            ReferenceName = referenceName;
