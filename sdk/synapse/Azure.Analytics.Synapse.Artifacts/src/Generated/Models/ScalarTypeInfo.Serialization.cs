...
{
    [JsonConverter(typeof(ScalarTypeInfoConverter))]
    public partial class ScalarTypeInfo : IUtf8JsonSerializable
    {
        ...
        internal static ScalarTypeInfo DeserializeScalarTypeInfo(JsonElement element)
        {
            ...
            return new ScalarTypeInfo(typeFamily.Value, typeName, Optional.ToNullable(isTableType), Optional.ToNullable(isComplexType), Optional.ToNullable(isNullable), Optional.ToNullable(length), Optional.ToNullable(precision), Optional.ToNullable(scale), Optional.ToDictionary(properties));
        }

        internal partial class ScalarTypeInfoConverter : JsonConverter<ScalarTypeInfo>
        {
            public override void Write(Utf8JsonWriter writer, ScalarTypeInfo model, JsonSerializerOptions options)
            {
                writer.WriteObjectValue(model);
            }
            public override ScalarTypeInfo Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
            {
                using var document = JsonDocument.ParseValue(ref reader);
                return DeserializeScalarTypeInfo(document.RootElement);
            }
        }
    }
}
