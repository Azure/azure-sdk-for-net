...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class LibraryResource : SubResource
    {
        ...
        internal LibraryResource(string id, string name, string type, string etag, LibraryResourceProperties properties, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, type, etag, serializedAdditionalRawData)
        {
            Properties = properties;
        }
