...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class LibraryResource : SubResource
    {
        ...
        /// <param name="properties"> Library/package properties. </param>
        internal LibraryResource(string id, string name, string type, IDictionary<string, BinaryData> serializedAdditionalRawData, string etag, LibraryResourceProperties properties) : base(id, name, type, serializedAdditionalRawData, etag)
        {
            Properties = properties;
        }

        /// <summary> Initializes a new instance of <see cref="LibraryResource"/> for deserialization. </summary>
