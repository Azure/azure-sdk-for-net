...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class MappingDataFlow : IUtf8JsonSerializable, IJsonModel<MappingDataFlow>
    {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<MappingDataFlow>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(MappingDataFlow)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<MappingDataFlow>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(MappingDataFlow)} does not support '{options.Format}' format.");
            }
        }
