...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MappingDataFlow>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MappingDataFlow>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MappingDataFlow>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<MappingDataFlow>.GetWireFormat(ModelReaderWriterOptions options) => "J";
