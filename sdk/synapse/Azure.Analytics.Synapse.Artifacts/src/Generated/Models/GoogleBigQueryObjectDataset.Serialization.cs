...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class GoogleBigQueryObjectDataset : IUtf8JsonSerializable
    {
        ...
        internal static GoogleBigQueryObjectDataset DeserializeGoogleBigQueryObjectDataset(JsonElement element)
        {
            ...
            return new GoogleBigQueryObjectDataset(type, description.HasValue ? description.Value : null, structure.HasValue ? structure.Value : null, schema.HasValue ? schema.Value : null, linkedServiceName, new ChangeTrackingDictionary<string, ParameterSpecification>(parameters), new ChangeTrackingList<object>(annotations), folder.HasValue ? folder.Value : null, additionalProperties, tableName.HasValue ? tableName.Value : null, table.HasValue ? table.Value : null, dataset.HasValue ? dataset.Value : null);
        }
    }
}
