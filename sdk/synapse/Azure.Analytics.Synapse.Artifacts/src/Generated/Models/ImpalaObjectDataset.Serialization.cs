...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class ImpalaObjectDataset : Core.IUtf8JsonSerializable
    {
        ...
        internal static ImpalaObjectDataset DeserializeImpalaObjectDataset(JsonElement element)
        {
            ...
            Core.Optional<object> table = default;
            Core.Optional<object> schema0 = default;
            ...
            return new ImpalaObjectDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), folder.Value, additionalProperties, tableName.Value, table.Value, schema0.Value);
        }
