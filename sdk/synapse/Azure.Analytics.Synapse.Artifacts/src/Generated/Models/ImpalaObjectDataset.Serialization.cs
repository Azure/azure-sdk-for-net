...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class ImpalaObjectDataset : IUtf8JsonSerializable
    {
        ...
        internal static ImpalaObjectDataset DeserializeImpalaObjectDataset(JsonElement element)
        {
            ...
            return new ImpalaObjectDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Optional.ToDictionary(parameters), annotations ?? new ChangeTrackingList<object>(), folder.Value, additionalProperties, tableName.Value, table.Value, schema0.Value);
        }
