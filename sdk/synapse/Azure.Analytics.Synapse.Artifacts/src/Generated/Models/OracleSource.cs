...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="OracleSource"/>. </summary>
        public OracleSource()
        {
            Type = "OracleSource";
        }
