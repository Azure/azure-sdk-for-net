...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class DynamicsEntityDataset : IUtf8JsonSerializable
    {
        ...
        internal static DynamicsEntityDataset DeserializeDynamicsEntityDataset(JsonElement element)
        {
            ...
            return new DynamicsEntityDataset(type, description.HasValue ? description.Value : null, structure.HasValue ? structure.Value : null, schema.HasValue ? schema.Value : null, linkedServiceName, new ChangeTrackingDictionary<string, ParameterSpecification>(parameters), new ChangeTrackingList<object>(annotations), folder.HasValue ? folder.Value : null, additionalProperties, entityName.HasValue ? entityName.Value : null);
        }
    }
}
