...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class DynamicsEntityDataset : Core.IUtf8JsonSerializable
    {
        ...
        internal static DynamicsEntityDataset DeserializeDynamicsEntityDataset(JsonElement element)
        {
            ...
            Core.Optional<object> entityName = default;
            ...
            return new DynamicsEntityDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), folder.Value, additionalProperties, entityName.Value);
        }
