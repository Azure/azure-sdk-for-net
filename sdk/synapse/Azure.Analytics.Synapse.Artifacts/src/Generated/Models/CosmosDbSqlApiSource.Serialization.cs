    ...
    public partial class CosmosDbSqlApiSource : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            if (Optional.IsDefined(PreferredRegions))
            {
                ...
                writer.WriteObjectValue<object>(PreferredRegions);
            }
            if (Optional.IsDefined(DetectDatetime))
            {
                writer.WritePropertyName("detectDatetime"u8);
                writer.WriteObjectValue<object>(DetectDatetime);
            }
        ...
        internal static new CosmosDbSqlApiSource FromResponse(Response response)
        {
        ...
        internal override RequestContent ToRequestContent()
        {
            ...
            content.JsonWriter.WriteObjectValue<CosmosDbSqlApiSource>(this);
            return content;
        }
        ...
        internal partial class CosmosDbSqlApiSourceConverter : JsonConverter<CosmosDbSqlApiSource>
        {
            ...
            {
                writer.WriteObjectValue<CosmosDbSqlApiSource>(model);
            }
