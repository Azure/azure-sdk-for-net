...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class LinkedServiceResource : IUtf8JsonSerializable, IJsonModel<LinkedServiceResource>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<LinkedServiceResource>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<LinkedServiceResource>)} interface");
            }
