...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LinkedServiceResource>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<LinkedServiceResource>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<LinkedServiceResource>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<LinkedServiceResource>.GetWireFormat(ModelReaderWriterOptions options) => "J";
