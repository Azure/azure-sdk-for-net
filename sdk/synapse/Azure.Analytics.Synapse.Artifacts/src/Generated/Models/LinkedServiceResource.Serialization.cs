    ...
    public partial class LinkedServiceResource : IUtf8JsonSerializable
    {
        ...
        internal static LinkedServiceResource DeserializeLinkedServiceResource(JsonElement element)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    properties = ModelSerializationExtensions.JsonDeserialize<LinkedService>(property.Value);
                    continue;
                }
        ...
        internal static new LinkedServiceResource FromResponse(Response response)
        {
