...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SparkJobDefinition>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SparkJobDefinition>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SparkJobDefinition>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SparkJobDefinition>)} interface");
            }
        ...
        string IPersistableModel<SparkJobDefinition>.GetWireFormat(ModelReaderWriterOptions options) => "J";
