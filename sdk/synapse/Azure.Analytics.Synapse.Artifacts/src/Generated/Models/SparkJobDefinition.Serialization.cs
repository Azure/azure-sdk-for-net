...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class SparkJobDefinition : IUtf8JsonSerializable
    {
        ...
        internal static SparkJobDefinition DeserializeSparkJobDefinition(JsonElement element)
        {
            ...
            return new SparkJobDefinition(description.HasValue ? description.Value : null, targetBigDataPool, requiredSparkVersion.HasValue ? requiredSparkVersion.Value : null, language.HasValue ? language.Value : null, jobProperties, additionalProperties);
        }
    }
}
