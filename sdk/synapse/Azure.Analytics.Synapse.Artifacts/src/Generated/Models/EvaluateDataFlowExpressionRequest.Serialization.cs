...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EvaluateDataFlowExpressionRequest>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        EvaluateDataFlowExpressionRequest IJsonModel<EvaluateDataFlowExpressionRequest>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
                throw new FormatException($"The model {nameof(EvaluateDataFlowExpressionRequest)} does not support '{options.Format}' format.");
            }
        ...
        BinaryData IModel<EvaluateDataFlowExpressionRequest>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        EvaluateDataFlowExpressionRequest IModel<EvaluateDataFlowExpressionRequest>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<EvaluateDataFlowExpressionRequest>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
