...
{
    [JsonConverter(typeof(GoogleAdWordsObjectDatasetConverter))]
    public partial class GoogleAdWordsObjectDataset : IUtf8JsonSerializable
    {
        ...
        internal partial class GoogleAdWordsObjectDatasetConverter : JsonConverter<GoogleAdWordsObjectDataset>
        {
            public override void Write(Utf8JsonWriter writer, GoogleAdWordsObjectDataset model, JsonSerializerOptions options)
            {
                writer.WriteObjectValue(model);
            }
            public override GoogleAdWordsObjectDataset Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
            {
                using var document = JsonDocument.ParseValue(ref reader);
                return DeserializeGoogleAdWordsObjectDataset(document.RootElement);
            }
        }
    }
}
