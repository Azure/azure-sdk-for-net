...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class PurviewConfiguration : IUtf8JsonSerializable, IJsonModel<PurviewConfiguration>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PurviewConfiguration>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        PurviewConfiguration IJsonModel<PurviewConfiguration>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<PurviewConfiguration>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        PurviewConfiguration IModel<PurviewConfiguration>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<PurviewConfiguration>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
