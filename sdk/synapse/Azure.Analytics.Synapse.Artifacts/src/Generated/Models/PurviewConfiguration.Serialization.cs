...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class PurviewConfiguration : IUtf8JsonSerializable, IJsonModel<PurviewConfiguration>
    {
        ...
        void IJsonModel<PurviewConfiguration>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(PurviewConfiguration)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<PurviewConfiguration>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(PurviewConfiguration)} does not support '{options.Format}' format.");
            }
        }
