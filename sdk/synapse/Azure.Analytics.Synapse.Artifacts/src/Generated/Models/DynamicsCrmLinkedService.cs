...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class DynamicsCrmLinkedService : LinkedService
    {
        ...
        internal DynamicsCrmLinkedService(string type, string version, IntegrationRuntimeReference connectVia, string description, IDictionary<string, ParameterSpecification> parameters, IList<object> annotations, IDictionary<string, object> additionalProperties, object deploymentType, object hostName, object port, object serviceUri, object organizationName, object authenticationType, object domain, object username, SecretBase password, object servicePrincipalId, object servicePrincipalCredentialType, SecretBase servicePrincipalCredential, SecretBase credential, object encryptedCredential) : base(type, version, connectVia, description, parameters, annotations, additionalProperties)
        {
            DeploymentType = deploymentType;
            HostName = hostName;
            Port = port;
