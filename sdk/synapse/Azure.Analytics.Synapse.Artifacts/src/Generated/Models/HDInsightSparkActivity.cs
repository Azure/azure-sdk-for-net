...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class HDInsightSparkActivity : ExecutionActivity
    {
        ...
        internal HDInsightSparkActivity(string name, string type, string description, IList<ActivityDependency> dependsOn, IList<UserProperty> userProperties, IDictionary<string, object> additionalProperties, LinkedServiceReferenceAutoGenerated linkedServiceName, ActivityPolicy policy, object rootPath, object entryFilePath, IList<object> arguments, HDInsightActivityDebugInfoOption? getDebugInfo, LinkedServiceReferenceAutoGenerated sparkJobLinkedService, string className, object proxyUser, IDictionary<string, object> sparkConfig) : base(name, type, description, dependsOn, userProperties, additionalProperties, linkedServiceName, policy)
        {
            RootPath = rootPath;
            EntryFilePath = entryFilePath;
            Arguments = arguments;
        ...
        public LinkedServiceReferenceAutoGenerated SparkJobLinkedService { get; set; }
