...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class RunNotebookSnapshot : IUtf8JsonSerializable, IModelJsonSerializable<RunNotebookSnapshot>
    {
        ...
        internal static RunNotebookSnapshot DeserializeRunNotebookSnapshot(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new RunNotebookSnapshot(exitValue.Value, id, notebook, sessionOptions.Value, Optional.ToNullable(honorSessionTimeToLive), Optional.ToNullable(sessionId), sparkPool.Value, Optional.ToDictionary(parameters), notebookContent.Value, rawData);
        }
