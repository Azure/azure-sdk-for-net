...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class HiveObjectDataset : IUtf8JsonSerializable
    {
        ...
        internal static HiveObjectDataset DeserializeHiveObjectDataset(JsonElement element)
        {
            ...
            return new HiveObjectDataset(type, description, structure, schema, linkedServiceName, parameters, annotations, folder, additionalProperties, tableName, table, schema0);
        }
    }
}
