...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class HiveObjectDataset : Core.IUtf8JsonSerializable
    {
        ...
        internal static HiveObjectDataset DeserializeHiveObjectDataset(JsonElement element)
        {
            ...
            return new HiveObjectDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), folder.Value, additionalProperties, tableName.Value, table.Value, schema0.Value);
        }
