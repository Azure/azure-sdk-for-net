...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class HiveObjectDataset : IUtf8JsonSerializable
    {
        ...
        internal static HiveObjectDataset DeserializeHiveObjectDataset(JsonElement element)
        {
            ...
            return new HiveObjectDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Optional.ToDictionary(parameters), annotations ?? new ChangeTrackingList<object>(), folder.Value, additionalProperties, tableName.Value, table.Value, schema0.Value);
        }
