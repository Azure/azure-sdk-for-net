...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class SsisLogLocation
    {
        ...
        public SsisLogLocation(BinaryData logPath, SsisLogLocationType type)
        {
            if (logPath == null)
            {
        ...
        internal SsisLogLocation(BinaryData logPath, SsisLogLocationType type, SsisAccessCredential accessCredential, BinaryData logRefreshInterval)
        {
            LogPath = logPath;
            Type = type;
