...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    internal partial class ErrorResponse
    {
        ...
        internal ErrorResponse(string code, string message, string target, IReadOnlyList<ErrorResponse> details, IReadOnlyList<ErrorAdditionalInfo> additionalInfo, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Code = code;
            Message = message;
            Target = target;
