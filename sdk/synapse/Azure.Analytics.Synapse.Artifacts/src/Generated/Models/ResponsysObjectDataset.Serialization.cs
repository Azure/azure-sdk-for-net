...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class ResponsysObjectDataset : Core.IUtf8JsonSerializable
    {
        ...
        internal static ResponsysObjectDataset DeserializeResponsysObjectDataset(JsonElement element)
        {
            ...
            return new ResponsysObjectDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), folder.Value, additionalProperties, tableName.Value);
        }
