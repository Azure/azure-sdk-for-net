...
{
    [JsonConverter(typeof(ResponsysObjectDatasetConverter))]
    public partial class ResponsysObjectDataset : IUtf8JsonSerializable
    {
        ...
        internal partial class ResponsysObjectDatasetConverter : JsonConverter<ResponsysObjectDataset>
        {
            public override void Write(Utf8JsonWriter writer, ResponsysObjectDataset model, JsonSerializerOptions options)
            {
                writer.WriteObjectValue(model);
            }
            public override ResponsysObjectDataset Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
            {
                using var document = JsonDocument.ParseValue(ref reader);
                return DeserializeResponsysObjectDataset(document.RootElement);
            }
        }
    }
}
