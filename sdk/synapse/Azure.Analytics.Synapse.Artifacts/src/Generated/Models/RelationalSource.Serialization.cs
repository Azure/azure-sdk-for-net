...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class RelationalSource : IUtf8JsonSerializable
    {
        ...
        internal static new RelationalSource FromResponse(Response response)
        {
        ...
        internal override RequestContent ToRequestContent()
        {
            ...
            content.JsonWriter.WriteObjectValue<RelationalSource>(this);
            return content;
        }
        ...
        internal partial class RelationalSourceConverter : JsonConverter<RelationalSource>
        {
            ...
            {
                writer.WriteObjectValue<RelationalSource>(model);
            }
