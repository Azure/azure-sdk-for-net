...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class PostgreSqlTableDataset : IUtf8JsonSerializable
    {
        ...
        internal static PostgreSqlTableDataset DeserializePostgreSqlTableDataset(JsonElement element)
        {
            ...
            return new PostgreSqlTableDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, parameters ?? new ChangeTrackingDictionary<string, ParameterSpecification>(), annotations ?? new ChangeTrackingList<object>(), folder.Value, additionalProperties, tableName.Value, table.Value, schema0.Value);
        }
