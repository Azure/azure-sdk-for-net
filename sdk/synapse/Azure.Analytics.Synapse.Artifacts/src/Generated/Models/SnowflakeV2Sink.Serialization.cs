...
{
    [JsonConverter(typeof(SnowflakeV2SinkConverter))]
    public partial class SnowflakeV2Sink : IUtf8JsonSerializable
    {
        ...
        internal static SnowflakeV2Sink DeserializeSnowflakeV2Sink(JsonElement element)
        {
        ...
        internal static new SnowflakeV2Sink FromResponse(Response response)
        {
            using var document = JsonDocument.Parse(response.Content, ModelSerializationExtensions.JsonDocumentOptions);
            return DeserializeSnowflakeV2Sink(document.RootElement);
        }
        ...
        internal partial class SnowflakeV2SinkConverter : JsonConverter<SnowflakeV2Sink>
        {
            public override void Write(Utf8JsonWriter writer, SnowflakeV2Sink model, JsonSerializerOptions options)
            {
                writer.WriteObjectValue(model);
            }

            public override SnowflakeV2Sink Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
            {
