...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class SapCloudForCustomerLinkedService : IUtf8JsonSerializable
    {
        ...
        internal static SapCloudForCustomerLinkedService DeserializeSapCloudForCustomerLinkedService(JsonElement element)
        {
            ...
            return new SapCloudForCustomerLinkedService(type, connectVia.HasValue ? connectVia.Value : null, description.HasValue ? description.Value : null, new ChangeTrackingDictionary<string, ParameterSpecification>(parameters), new ChangeTrackingList<object>(annotations), additionalProperties, url, username.HasValue ? username.Value : null, password.HasValue ? password.Value : null, encryptedCredential.HasValue ? encryptedCredential.Value : null);
        }
    }
}
