...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class DocumentDbCollectionDataset : IUtf8JsonSerializable
    {
        ...
        internal static DocumentDbCollectionDataset DeserializeDocumentDbCollectionDataset(JsonElement element)
        {
            ...
            return new DocumentDbCollectionDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Optional.ToDictionary(parameters), annotations ?? new ChangeTrackingList<object>(), folder.Value, additionalProperties, collectionName);
        }
