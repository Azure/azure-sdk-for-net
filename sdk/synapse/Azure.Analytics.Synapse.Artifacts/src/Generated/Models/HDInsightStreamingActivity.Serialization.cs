...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class HDInsightStreamingActivity : Core.IUtf8JsonSerializable
    {
        ...
        internal static HDInsightStreamingActivity DeserializeHDInsightStreamingActivity(JsonElement element)
        {
            ...
            Core.Optional<LinkedServiceReference> fileLinkedService = default;
            Core.Optional<object> combiner = default;
            Core.Optional<IList<object>> commandEnvironment = default;
            ...
            return new HDInsightStreamingActivity(name, type, description.Value, Core.Optional.ToNullable(state), Core.Optional.ToNullable(onInactiveMarkAs), Core.Optional.ToList(dependsOn), Core.Optional.ToList(userProperties), additionalProperties, linkedServiceName.Value, policy.Value, Core.Optional.ToList(storageLinkedServices), Core.Optional.ToList(arguments), Core.Optional.ToNullable(getDebugInfo), mapper, reducer, input, output, filePaths, fileLinkedService.Value, combiner.Value, Core.Optional.ToList(commandEnvironment), Core.Optional.ToDictionary(defines));
        }
