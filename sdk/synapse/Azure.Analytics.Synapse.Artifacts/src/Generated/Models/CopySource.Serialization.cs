...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class CopySource : IUtf8JsonSerializable, IJsonModel<CopySource>
    {
        ...
        CopySource IJsonModel<CopySource>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            return DeserializeCopySource(document.RootElement, options);
        }

        internal static CopySource DeserializeCopySource(JsonElement element, ModelReaderWriterOptions options = null)
        {
