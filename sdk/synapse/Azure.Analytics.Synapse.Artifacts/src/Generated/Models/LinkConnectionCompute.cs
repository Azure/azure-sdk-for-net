...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class LinkConnectionCompute
    {
        ...
        internal LinkConnectionCompute(int? coreCount, string computeType, int? dataProcessIntervalMinutes, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            CoreCount = coreCount;
