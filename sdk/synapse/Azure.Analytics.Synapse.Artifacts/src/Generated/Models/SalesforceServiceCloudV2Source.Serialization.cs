...
{
    [JsonConverter(typeof(SalesforceServiceCloudV2SourceConverter))]
    public partial class SalesforceServiceCloudV2Source : IUtf8JsonSerializable
    {
        ...
        internal partial class SalesforceServiceCloudV2SourceConverter : JsonConverter<SalesforceServiceCloudV2Source>
        {
            public override void Write(Utf8JsonWriter writer, SalesforceServiceCloudV2Source model, JsonSerializerOptions options)
            {
                writer.WriteObjectValue(model);
            }

            public override SalesforceServiceCloudV2Source Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
            {
