...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class OracleServiceCloudLinkedService : IUtf8JsonSerializable
    {
        ...
        internal static OracleServiceCloudLinkedService DeserializeOracleServiceCloudLinkedService(JsonElement element)
        {
            ...
            return new OracleServiceCloudLinkedService(type, connectVia.HasValue ? connectVia.Value : null, description.HasValue ? description.Value : null, new ChangeTrackingDictionary<string, ParameterSpecification>(parameters), new ChangeTrackingList<object>(annotations), additionalProperties, host, username, password, useEncryptedEndpoints.HasValue ? useEncryptedEndpoints.Value : null, useHostVerification.HasValue ? useHostVerification.Value : null, usePeerVerification.HasValue ? usePeerVerification.Value : null, encryptedCredential.HasValue ? encryptedCredential.Value : null);
        }
    }
}
