...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class LakeHouseWriteSettings : StoreWriteSettings
    {
        ...
        internal LakeHouseWriteSettings(string type, object maxConcurrentConnections, object copyBehavior, IList<MetadataItem> metadata, IDictionary<string, object> additionalProperties) : base(type, maxConcurrentConnections, copyBehavior, metadata, additionalProperties)
        {
