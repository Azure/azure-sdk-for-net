...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class DataFlowDebugPackage : IUtf8JsonSerializable, IJsonModel<DataFlowDebugPackage>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<DataFlowDebugPackage>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DataFlowDebugPackage>)} interface");
            }
