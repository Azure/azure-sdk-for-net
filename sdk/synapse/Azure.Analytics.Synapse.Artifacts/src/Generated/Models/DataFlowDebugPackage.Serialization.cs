...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataFlowDebugPackage>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DataFlowDebugPackage>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DataFlowDebugPackage>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<DataFlowDebugPackage>.GetWireFormat(ModelReaderWriterOptions options) => "J";
