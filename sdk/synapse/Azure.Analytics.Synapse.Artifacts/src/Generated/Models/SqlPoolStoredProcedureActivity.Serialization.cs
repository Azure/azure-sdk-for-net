...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class SqlPoolStoredProcedureActivity : IUtf8JsonSerializable, IJsonModel<SqlPoolStoredProcedureActivity>
    {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<SqlPoolStoredProcedureActivity>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(SqlPoolStoredProcedureActivity)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<SqlPoolStoredProcedureActivity>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(SqlPoolStoredProcedureActivity)} does not support '{options.Format}' format.");
            }
        }
