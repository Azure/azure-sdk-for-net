...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SqlPoolStoredProcedureActivity>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SqlPoolStoredProcedureActivity>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SqlPoolStoredProcedureActivity>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<SqlPoolStoredProcedureActivity>.GetWireFormat(ModelReaderWriterOptions options) => "J";
