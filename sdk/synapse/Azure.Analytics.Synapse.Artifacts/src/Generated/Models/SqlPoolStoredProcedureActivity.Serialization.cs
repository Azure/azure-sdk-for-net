...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class SqlPoolStoredProcedureActivity : Core.IUtf8JsonSerializable
    {
        ...
        internal static SqlPoolStoredProcedureActivity DeserializeSqlPoolStoredProcedureActivity(JsonElement element)
        {
            ...
            return new SqlPoolStoredProcedureActivity(name, type, description.Value, Core.Optional.ToNullable(state), Core.Optional.ToNullable(onInactiveMarkAs), Core.Optional.ToList(dependsOn), Core.Optional.ToList(userProperties), additionalProperties, sqlPool, storedProcedureName, Core.Optional.ToDictionary(storedProcedureParameters));
        }
