...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class LogLocationSettings
    {
        ...
        public LogLocationSettings(LinkedServiceReferenceAutoGenerated linkedServiceName)
        {
        ...
        internal LogLocationSettings(LinkedServiceReferenceAutoGenerated linkedServiceName, object path)
        {
            LinkedServiceName = linkedServiceName;
            Path = path;
        }
