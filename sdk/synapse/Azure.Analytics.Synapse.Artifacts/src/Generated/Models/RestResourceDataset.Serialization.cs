...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class RestResourceDataset : IUtf8JsonSerializable
    {
        ...
        internal static RestResourceDataset DeserializeRestResourceDataset(JsonElement element)
        {
            ...
            return new RestResourceDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, parameters ?? new ChangeTrackingDictionary<string, ParameterSpecification>(), annotations ?? new ChangeTrackingList<object>(), folder.Value, additionalProperties, relativeUrl.Value, requestMethod.Value, requestBody.Value, additionalHeaders.Value, paginationRules.Value);
        }
