...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class RestResourceDataset : IUtf8JsonSerializable
    {
        ...
        internal static RestResourceDataset DeserializeRestResourceDataset(JsonElement element)
        {
            ...
            return new RestResourceDataset(type, description.HasValue ? description.Value : null, structure.HasValue ? structure.Value : null, schema.HasValue ? schema.Value : null, linkedServiceName, new ChangeTrackingDictionary<string, ParameterSpecification>(parameters), new ChangeTrackingList<object>(annotations), folder.HasValue ? folder.Value : null, additionalProperties, relativeUrl.HasValue ? relativeUrl.Value : null, requestMethod.HasValue ? requestMethod.Value : null, requestBody.HasValue ? requestBody.Value : null, additionalHeaders.HasValue ? additionalHeaders.Value : null, paginationRules.HasValue ? paginationRules.Value : null);
        }
    }
}
