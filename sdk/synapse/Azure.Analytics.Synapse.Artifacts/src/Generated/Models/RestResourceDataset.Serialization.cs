...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class RestResourceDataset : IUtf8JsonSerializable
    {
        ...
        internal static RestResourceDataset DeserializeRestResourceDataset(JsonElement element)
        {
            ...
            return new RestResourceDataset(type, description, structure, schema, linkedServiceName, parameters, annotations, folder, additionalProperties, relativeUrl, requestMethod, requestBody, additionalHeaders, paginationRules);
        }
    }
}
