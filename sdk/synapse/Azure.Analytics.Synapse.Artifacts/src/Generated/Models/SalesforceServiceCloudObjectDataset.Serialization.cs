...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class SalesforceServiceCloudObjectDataset : IUtf8JsonSerializable
    {
        ...
        internal static SalesforceServiceCloudObjectDataset DeserializeSalesforceServiceCloudObjectDataset(JsonElement element)
        {
            ...
            return new SalesforceServiceCloudObjectDataset(type, description.HasValue ? description.Value : null, structure.HasValue ? structure.Value : null, schema.HasValue ? schema.Value : null, linkedServiceName, new ChangeTrackingDictionary<string, ParameterSpecification>(parameters), new ChangeTrackingList<object>(annotations), folder.HasValue ? folder.Value : null, additionalProperties, objectApiName.HasValue ? objectApiName.Value : null);
        }
    }
}
