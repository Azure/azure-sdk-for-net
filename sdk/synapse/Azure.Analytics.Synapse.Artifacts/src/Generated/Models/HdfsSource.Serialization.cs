...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HdfsSource>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<HdfsSource>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<HdfsSource>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<HdfsSource>)} interface");
            }
        ...
        string IPersistableModel<HdfsSource>.GetWireFormat(ModelReaderWriterOptions options) => "J";
