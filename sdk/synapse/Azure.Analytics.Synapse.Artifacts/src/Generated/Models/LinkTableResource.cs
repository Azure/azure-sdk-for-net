...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class LinkTableResource
    {
        ...
        internal LinkTableResource(string id, string name, LinkTableRequestSource source, LinkTableRequestTarget target, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Name = name;
            Source = source;
