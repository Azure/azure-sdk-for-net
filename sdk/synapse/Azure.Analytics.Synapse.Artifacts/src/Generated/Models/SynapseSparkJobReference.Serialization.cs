...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SynapseSparkJobReference>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SynapseSparkJobReference>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SynapseSparkJobReference>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SynapseSparkJobReference>)} interface");
            }
        ...
        string IPersistableModel<SynapseSparkJobReference>.GetWireFormat(ModelReaderWriterOptions options) => "J";
