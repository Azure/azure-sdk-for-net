...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RunNotebookSparkSessionOptions>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<RunNotebookSparkSessionOptions>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<RunNotebookSparkSessionOptions>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(RunNotebookSparkSessionOptions)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<RunNotebookSparkSessionOptions>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(RunNotebookSparkSessionOptions)} does not support '{options.Format}' format.");
            }
        }
        ...
        string IPersistableModel<RunNotebookSparkSessionOptions>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
