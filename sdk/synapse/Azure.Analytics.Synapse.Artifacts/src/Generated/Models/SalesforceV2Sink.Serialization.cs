...
{
    [JsonConverter(typeof(SalesforceV2SinkConverter))]
    public partial class SalesforceV2Sink : IUtf8JsonSerializable
    {
        ...
        internal static new SalesforceV2Sink FromResponse(Response response)
        {
            using var document = JsonDocument.Parse(response.Content, ModelSerializationExtensions.JsonDocumentOptions);
            return DeserializeSalesforceV2Sink(document.RootElement);
        }
        ...
        internal partial class SalesforceV2SinkConverter : JsonConverter<SalesforceV2Sink>
        {
            public override void Write(Utf8JsonWriter writer, SalesforceV2Sink model, JsonSerializerOptions options)
            {
                writer.WriteObjectValue(model);
            }

            public override SalesforceV2Sink Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
            {
