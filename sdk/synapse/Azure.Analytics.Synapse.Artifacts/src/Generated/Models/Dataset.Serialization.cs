...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class Dataset : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static Dataset DeserializeDataset(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
