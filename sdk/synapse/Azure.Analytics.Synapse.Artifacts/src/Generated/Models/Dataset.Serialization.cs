...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class Dataset : IUtf8JsonSerializable, IModelJsonSerializable<Dataset>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<Dataset>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="Dataset"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="Dataset"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="Dataset"/>. </summary>
