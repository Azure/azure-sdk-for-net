...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<Dataset>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<Dataset>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<Dataset>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<Dataset>)} interface");
            }
        ...
        string IPersistableModel<Dataset>.GetWireFormat(ModelReaderWriterOptions options) => "J";
