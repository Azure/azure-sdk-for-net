...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class SapHanaSource : IUtf8JsonSerializable
    {
        ...
        internal static SapHanaSource DeserializeSapHanaSource(JsonElement element)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("partitionSettings"u8))
                {
                    ...
                    partitionSettings = ModelSerializationExtensions.JsonDeserialize<SapHanaPartitionSettings>(property.Value);
                    continue;
                }
        ...
        internal static new SapHanaSource FromResponse(Response response)
        {
