...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class SapHanaSource : Core.IUtf8JsonSerializable
    {
        void Core.IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            if (Core.Optional.IsDefined(PacketSize))
            {
        ...
        internal static SapHanaSource DeserializeSapHanaSource(JsonElement element)
        {
            ...
            Core.Optional<object> packetSize = default;
            Core.Optional<SapHanaPartitionOption> partitionOption = default;
            Core.Optional<SapHanaPartitionSettings> partitionSettings = default;
            ...
            return new SapHanaSource(type, sourceRetryCount.Value, sourceRetryWait.Value, maxConcurrentConnections.Value, additionalProperties, queryTimeout.Value, additionalColumns.Value, query.Value, packetSize.Value, Core.Optional.ToNullable(partitionOption), partitionSettings.Value);
        }
