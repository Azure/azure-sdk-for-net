...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class JsonDataset : IUtf8JsonSerializable
    {
        ...
        internal static new JsonDataset FromResponse(Response response)
        {
        ...
        internal override RequestContent ToRequestContent()
        {
            ...
            content.JsonWriter.WriteObjectValue<JsonDataset>(this);
            return content;
        }
        ...
        internal partial class JsonDatasetConverter : JsonConverter<JsonDataset>
        {
            ...
            {
                writer.WriteObjectValue<JsonDataset>(model);
            }
