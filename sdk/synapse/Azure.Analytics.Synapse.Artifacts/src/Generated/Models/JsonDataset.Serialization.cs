...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class JsonDataset : IUtf8JsonSerializable
    {
        ...
        internal static JsonDataset DeserializeJsonDataset(JsonElement element)
        {
            ...
            return new JsonDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Optional.ToDictionary(parameters), annotations ?? new ChangeTrackingList<object>(), folder.Value, additionalProperties, location.Value, encodingName.Value, compression.Value);
        }
