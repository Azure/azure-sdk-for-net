...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class AzureDataExplorerLinkedService : IUtf8JsonSerializable
    {
        ...
        internal static AzureDataExplorerLinkedService DeserializeAzureDataExplorerLinkedService(JsonElement element)
        {
            ...
            return new AzureDataExplorerLinkedService(type, connectVia.Value, description.Value, Optional.ToDictionary(parameters), annotations ?? new ChangeTrackingList<object>(), additionalProperties, endpoint, servicePrincipalId.Value, servicePrincipalKey.Value, database, tenant.Value, credential.Value);
        }
