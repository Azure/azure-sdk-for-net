...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class LogStorageSettings
    {
        ...
        public LogStorageSettings(LinkedServiceReferenceAutoGenerated linkedServiceName)
        {
        ...
        internal LogStorageSettings(LinkedServiceReferenceAutoGenerated linkedServiceName, object path, object logLevel, object enableReliableLogging, IDictionary<string, object> additionalProperties)
        {
            LinkedServiceName = linkedServiceName;
            Path = path;
            LogLevel = logLevel;
