...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class AzureBlobStorageLocation : IUtf8JsonSerializable, IModelJsonSerializable<AzureBlobStorageLocation>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<AzureBlobStorageLocation>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="AzureBlobStorageLocation"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="AzureBlobStorageLocation"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="AzureBlobStorageLocation"/>. </summary>
