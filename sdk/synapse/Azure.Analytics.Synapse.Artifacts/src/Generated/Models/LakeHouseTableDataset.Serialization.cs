...
{
    [JsonConverter(typeof(LakeHouseTableDatasetConverter))]
    public partial class LakeHouseTableDataset : IUtf8JsonSerializable
    {
        ...
        internal partial class LakeHouseTableDatasetConverter : JsonConverter<LakeHouseTableDataset>
        {
            public override void Write(Utf8JsonWriter writer, LakeHouseTableDataset model, JsonSerializerOptions options)
            {
                writer.WriteObjectValue(model);
            }

            public override LakeHouseTableDataset Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
            {
