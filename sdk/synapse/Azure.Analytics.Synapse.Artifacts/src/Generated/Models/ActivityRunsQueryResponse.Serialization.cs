...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    {
        internal static ActivityRunsQueryResponse DeserializeActivityRunsQueryResponse(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
