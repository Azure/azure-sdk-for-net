...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ScheduleTrigger>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ScheduleTrigger>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ScheduleTrigger>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<ScheduleTrigger>.GetWireFormat(ModelReaderWriterOptions options) => "J";
