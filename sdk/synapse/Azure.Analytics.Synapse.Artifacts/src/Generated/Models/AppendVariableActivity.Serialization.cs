...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class AppendVariableActivity : IUtf8JsonSerializable
    {
        ...
        internal static AppendVariableActivity DeserializeAppendVariableActivity(JsonElement element)
        {
            ...
            return new AppendVariableActivity(name, type, description.HasValue ? description.Value : null, new ChangeTrackingList<ActivityDependency>(dependsOn), new ChangeTrackingList<UserProperty>(userProperties), additionalProperties, variableName.HasValue ? variableName.Value : null, value.HasValue ? value.Value : null);
        }
    }
}
