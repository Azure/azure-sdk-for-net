...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class AzurePostgreSqlLinkedService : IUtf8JsonSerializable
    {
        ...
        internal static AzurePostgreSqlLinkedService DeserializeAzurePostgreSqlLinkedService(JsonElement element)
        {
            ...
            return new AzurePostgreSqlLinkedService(type, connectVia.HasValue ? connectVia.Value : null, description.HasValue ? description.Value : null, new ChangeTrackingDictionary<string, ParameterSpecification>(parameters), new ChangeTrackingList<object>(annotations), additionalProperties, connectionString.HasValue ? connectionString.Value : null, password.HasValue ? password.Value : null, encryptedCredential.HasValue ? encryptedCredential.Value : null);
        }
    }
}
