...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class DrillTableDataset : IUtf8JsonSerializable
    {
        ...
        internal static DrillTableDataset DeserializeDrillTableDataset(JsonElement element)
        {
            ...
            return new DrillTableDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Optional.ToDictionary(parameters), annotations ?? new ChangeTrackingList<object>(), folder.Value, additionalProperties, tableName.Value, table.Value, schema0.Value);
        }
