...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    {
        internal static LinkConnectionRefreshStatus DeserializeLinkConnectionRefreshStatus(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
