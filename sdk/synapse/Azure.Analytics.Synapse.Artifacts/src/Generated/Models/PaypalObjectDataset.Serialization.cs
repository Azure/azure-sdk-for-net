...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class PaypalObjectDataset : Core.IUtf8JsonSerializable
    {
        ...
        internal static PaypalObjectDataset DeserializePaypalObjectDataset(JsonElement element)
        {
            ...
            return new PaypalObjectDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), folder.Value, additionalProperties, tableName.Value);
        }
