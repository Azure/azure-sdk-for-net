...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class PaypalObjectDataset : IUtf8JsonSerializable
    {
        ...
        internal static PaypalObjectDataset DeserializePaypalObjectDataset(JsonElement element)
        {
            ...
            return new PaypalObjectDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Optional.ToDictionary(parameters), annotations ?? new ChangeTrackingList<object>(), folder.Value, additionalProperties, tableName.Value);
        }
