...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class VerticaTableDataset : IUtf8JsonSerializable
    {
        ...
        internal static VerticaTableDataset DeserializeVerticaTableDataset(JsonElement element)
        {
            ...
            return new VerticaTableDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Optional.ToDictionary(parameters), annotations ?? new ChangeTrackingList<object>(), folder.Value, additionalProperties, tableName.Value, table.Value, schema0.Value);
        }
