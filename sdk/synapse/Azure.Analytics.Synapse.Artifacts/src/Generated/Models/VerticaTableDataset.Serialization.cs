...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class VerticaTableDataset : Core.IUtf8JsonSerializable
    {
        ...
        internal static VerticaTableDataset DeserializeVerticaTableDataset(JsonElement element)
        {
            ...
            return new VerticaTableDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), folder.Value, additionalProperties, tableName.Value, table.Value, schema0.Value);
        }
