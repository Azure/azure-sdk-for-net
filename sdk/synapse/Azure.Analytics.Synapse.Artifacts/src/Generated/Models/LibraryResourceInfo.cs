...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class LibraryResourceInfo
    {
        ...
        internal LibraryResourceInfo(string id, int? recordId, string state, string created, string changed, string type, string name, string operationId, string artifactId, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            RecordId = recordId;
            State = state;
