...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ScriptActivityScriptBlock>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ScriptActivityScriptBlock>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ScriptActivityScriptBlock>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<ScriptActivityScriptBlock>.GetWireFormat(ModelReaderWriterOptions options) => "J";
