...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ScriptActivityScriptBlock>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        ScriptActivityScriptBlock IJsonModel<ScriptActivityScriptBlock>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<ScriptActivityScriptBlock>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ScriptActivityScriptBlock IModel<ScriptActivityScriptBlock>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<ScriptActivityScriptBlock>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
