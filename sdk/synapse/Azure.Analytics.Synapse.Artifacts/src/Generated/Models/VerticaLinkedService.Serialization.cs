...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class VerticaLinkedService : IUtf8JsonSerializable
    {
        ...
        internal static VerticaLinkedService DeserializeVerticaLinkedService(JsonElement element)
        {
            ...
            return new VerticaLinkedService(type, connectVia.Value, description.Value, parameters ?? new ChangeTrackingDictionary<string, ParameterSpecification>(), annotations ?? new ChangeTrackingList<object>(), additionalProperties, connectionString.Value, pwd.Value, encryptedCredential.Value);
        }
