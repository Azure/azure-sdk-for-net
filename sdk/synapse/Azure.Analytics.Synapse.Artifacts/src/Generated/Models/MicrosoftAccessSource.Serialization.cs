...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class MicrosoftAccessSource : IUtf8JsonSerializable
    {
        ...
        internal static new MicrosoftAccessSource FromResponse(Response response)
        {
        ...
        internal override RequestContent ToRequestContent()
        {
            ...
            content.JsonWriter.WriteObjectValue<MicrosoftAccessSource>(this);
            return content;
        }
        ...
        internal partial class MicrosoftAccessSourceConverter : JsonConverter<MicrosoftAccessSource>
        {
            ...
            {
                writer.WriteObjectValue<MicrosoftAccessSource>(model);
            }
