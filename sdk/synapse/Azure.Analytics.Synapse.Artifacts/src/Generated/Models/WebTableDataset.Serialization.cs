...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class WebTableDataset : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            writer.WriteObjectValue<object>(Index);
        ...
        internal static new WebTableDataset FromResponse(Response response)
        {
        ...
        internal override RequestContent ToRequestContent()
        {
            ...
            content.JsonWriter.WriteObjectValue<WebTableDataset>(this);
            return content;
        }
        ...
        internal partial class WebTableDatasetConverter : JsonConverter<WebTableDataset>
        {
            ...
            {
                writer.WriteObjectValue<WebTableDataset>(model);
            }
