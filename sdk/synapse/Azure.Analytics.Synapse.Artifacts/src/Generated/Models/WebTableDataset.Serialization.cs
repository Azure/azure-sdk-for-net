...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class WebTableDataset : IUtf8JsonSerializable, IModelJsonSerializable<WebTableDataset>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<WebTableDataset>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="WebTableDataset"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="WebTableDataset"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="WebTableDataset"/>. </summary>
