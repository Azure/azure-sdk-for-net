...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class WebTableDataset : IUtf8JsonSerializable
    {
        ...
        internal static WebTableDataset DeserializeWebTableDataset(JsonElement element)
        {
            ...
            return new WebTableDataset(type, description.HasValue ? description.Value : null, structure.HasValue ? structure.Value : null, schema.HasValue ? schema.Value : null, linkedServiceName, new ChangeTrackingDictionary<string, ParameterSpecification>(parameters), new ChangeTrackingList<object>(annotations), folder.HasValue ? folder.Value : null, additionalProperties, index, path.HasValue ? path.Value : null);
        }
    }
}
