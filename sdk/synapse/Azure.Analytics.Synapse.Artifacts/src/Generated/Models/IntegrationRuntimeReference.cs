...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class IntegrationRuntimeReference
    {
        ...
        internal IntegrationRuntimeReference(IntegrationRuntimeReferenceType type, string referenceName, IDictionary<string, object> parameters, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Type = type;
            ReferenceName = referenceName;
