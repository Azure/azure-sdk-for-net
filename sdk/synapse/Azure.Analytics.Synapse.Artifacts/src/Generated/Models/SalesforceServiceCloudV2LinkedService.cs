...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class SalesforceServiceCloudV2LinkedService : LinkedService
    {
        ...
        /// <param name="environmentUrl"> The URL of Salesforce Service Cloud instance. For example, 'https://[domain].my.salesforce.com'. Type: string (or Expression with resultType string). </param>
        ...
        internal SalesforceServiceCloudV2LinkedService(string type, string version, IntegrationRuntimeReference connectVia, string description, IDictionary<string, ParameterSpecification> parameters, IList<object> annotations, IDictionary<string, object> additionalProperties, object environmentUrl, object authenticationType, object clientId, SecretBase clientSecret, object apiVersion, string encryptedCredential) : base(type, version, connectVia, description, parameters, annotations, additionalProperties)
        {
            ...
            Type = type ?? "SalesforceServiceCloudV2";
        }
