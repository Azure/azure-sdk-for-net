...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class AzureMariaDBLinkedService : IUtf8JsonSerializable
    {
        ...
        internal static AzureMariaDBLinkedService DeserializeAzureMariaDBLinkedService(JsonElement element)
        {
            ...
            return new AzureMariaDBLinkedService(type, connectVia.Value, description.Value, parameters ?? new ChangeTrackingDictionary<string, ParameterSpecification>(), annotations ?? new ChangeTrackingList<object>(), additionalProperties, connectionString.Value, pwd.Value, encryptedCredential.Value);
        }
