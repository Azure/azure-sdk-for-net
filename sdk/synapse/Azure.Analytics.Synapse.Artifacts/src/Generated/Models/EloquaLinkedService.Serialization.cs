...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class EloquaLinkedService : IUtf8JsonSerializable
    {
        ...
        internal static EloquaLinkedService DeserializeEloquaLinkedService(JsonElement element)
        {
            ...
            return new EloquaLinkedService(type, connectVia, description, parameters, annotations, additionalProperties, endpoint, username, password, useEncryptedEndpoints, useHostVerification, usePeerVerification, encryptedCredential);
        }
    }
}
