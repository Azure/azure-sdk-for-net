...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class SapCloudForCustomerSink : IUtf8JsonSerializable, IJsonModel<SapCloudForCustomerSink>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SapCloudForCustomerSink>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SapCloudForCustomerSink>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SapCloudForCustomerSink>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SapCloudForCustomerSink>)} interface");
            }
        ...
        SapCloudForCustomerSink IJsonModel<SapCloudForCustomerSink>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == "J" || options.Format == "W";
            if (!isValid)
            {
                throw new FormatException($"The model {nameof(SapCloudForCustomerSink)} does not support '{options.Format}' format.");
            }
        ...
        internal static SapCloudForCustomerSink DeserializeSapCloudForCustomerSink(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        SapCloudForCustomerSink IPersistableModel<SapCloudForCustomerSink>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == "J" || options.Format == "W";
            if (!isValid)
            {
        ...
        string IPersistableModel<SapCloudForCustomerSink>.GetWireFormat(ModelReaderWriterOptions options) => "J";
