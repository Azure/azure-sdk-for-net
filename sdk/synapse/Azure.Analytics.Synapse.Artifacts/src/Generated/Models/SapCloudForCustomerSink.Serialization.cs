...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class SapCloudForCustomerSink : IUtf8JsonSerializable, IJsonModel<SapCloudForCustomerSink>
    {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<SapCloudForCustomerSink>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(SapCloudForCustomerSink)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<SapCloudForCustomerSink>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(SapCloudForCustomerSink)} does not support '{options.Format}' format.");
            }
        }
