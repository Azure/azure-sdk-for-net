...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SapCloudForCustomerSink>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<SapCloudForCustomerSink>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SapCloudForCustomerSink>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
