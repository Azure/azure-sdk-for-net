...
{
    [JsonConverter(typeof(IcebergSinkConverter))]
    public partial class IcebergSink : IUtf8JsonSerializable
    {
        ...
        internal static IcebergSink DeserializeIcebergSink(JsonElement element)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("formatSettings"u8))
                {
                    ...
                    formatSettings = IcebergWriteSettings.DeserializeIcebergWriteSettings(property.Value);
                    continue;
                }
        ...
        internal static new IcebergSink FromResponse(Response response)
        {
            using var document = JsonDocument.Parse(response.Content, ModelSerializationExtensions.JsonDocumentOptions);
            return DeserializeIcebergSink(document.RootElement);
        }
        ...
        internal partial class IcebergSinkConverter : JsonConverter<IcebergSink>
        {
            public override void Write(Utf8JsonWriter writer, IcebergSink model, JsonSerializerOptions options)
            {
                writer.WriteObjectValue(model);
            }

            public override IcebergSink Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
            {
