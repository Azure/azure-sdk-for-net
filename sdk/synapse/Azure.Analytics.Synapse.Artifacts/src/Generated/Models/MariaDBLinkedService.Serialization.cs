...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class MariaDBLinkedService : Core.IUtf8JsonSerializable
    {
        void Core.IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            if (Core.Optional.IsDefined(Pwd))
            {
        ...
        internal static MariaDBLinkedService DeserializeMariaDBLinkedService(JsonElement element)
        {
            ...
            Core.Optional<object> connectionString = default;
            Core.Optional<AzureKeyVaultSecretReference> pwd = default;
            ...
            return new MariaDBLinkedService(type, connectVia.Value, description.Value, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), additionalProperties, connectionString.Value, pwd.Value, encryptedCredential.Value);
        }
