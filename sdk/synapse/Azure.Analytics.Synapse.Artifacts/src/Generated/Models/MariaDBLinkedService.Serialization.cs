...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class MariaDBLinkedService : IUtf8JsonSerializable
    {
        ...
        internal static MariaDBLinkedService DeserializeMariaDBLinkedService(JsonElement element)
        {
            ...
            return new MariaDBLinkedService(type, connectVia.Value, description.Value, Optional.ToDictionary(parameters), annotations ?? new ChangeTrackingList<object>(), additionalProperties, connectionString.Value, pwd.Value, encryptedCredential.Value);
        }
