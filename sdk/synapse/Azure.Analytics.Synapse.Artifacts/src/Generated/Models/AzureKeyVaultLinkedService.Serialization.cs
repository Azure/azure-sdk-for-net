...
#if NET6_0_OR_GREATER
				writer.WriteRawValue(BaseUrl);
#else
            JsonSerializer.Serialize(writer, JsonDocument.Parse(BaseUrl.ToString()).RootElement);
#endif
            writer.WriteEndObject();
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("typeProperties"))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        {
                            baseUrl = BinaryData.FromString(property.Value.GetRawText());
                            continue;
                        }
                    }
                    continue;
