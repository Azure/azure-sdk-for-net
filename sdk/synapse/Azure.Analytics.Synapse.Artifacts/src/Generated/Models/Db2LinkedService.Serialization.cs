...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class Db2LinkedService : IUtf8JsonSerializable
    {
        ...
        internal static Db2LinkedService DeserializeDb2LinkedService(JsonElement element)
        {
            ...
            return new Db2LinkedService(type, connectVia.HasValue ? connectVia.Value : null, description.HasValue ? description.Value : null, new ChangeTrackingDictionary<string, ParameterSpecification>(parameters), new ChangeTrackingList<object>(annotations), additionalProperties, server, database, authenticationType.HasValue ? authenticationType.Value : null, username.HasValue ? username.Value : null, password.HasValue ? password.Value : null, packageCollection.HasValue ? packageCollection.Value : null, certificateCommonName.HasValue ? certificateCommonName.Value : null, encryptedCredential.HasValue ? encryptedCredential.Value : null);
        }
    }
}
