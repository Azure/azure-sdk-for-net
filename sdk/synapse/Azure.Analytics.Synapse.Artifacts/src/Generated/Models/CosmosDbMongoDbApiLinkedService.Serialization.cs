...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class CosmosDbMongoDbApiLinkedService : IUtf8JsonSerializable
    {
        ...
        internal static CosmosDbMongoDbApiLinkedService DeserializeCosmosDbMongoDbApiLinkedService(JsonElement element)
        {
            ...
            return new CosmosDbMongoDbApiLinkedService(type, connectVia.HasValue ? connectVia.Value : null, description.HasValue ? description.Value : null, new ChangeTrackingDictionary<string, ParameterSpecification>(parameters), new ChangeTrackingList<object>(annotations), additionalProperties, connectionString, database);
        }
    }
}
