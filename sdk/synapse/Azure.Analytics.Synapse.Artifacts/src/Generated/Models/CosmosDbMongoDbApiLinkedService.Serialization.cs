...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CosmosDbMongoDbApiLinkedService>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CosmosDbMongoDbApiLinkedService>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CosmosDbMongoDbApiLinkedService>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CosmosDbMongoDbApiLinkedService>)} interface");
            }
        ...
        string IPersistableModel<CosmosDbMongoDbApiLinkedService>.GetWireFormat(ModelReaderWriterOptions options) => "J";
