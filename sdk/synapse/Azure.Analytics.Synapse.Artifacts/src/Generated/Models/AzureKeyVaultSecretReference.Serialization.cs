...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class AzureKeyVaultSecretReference : IUtf8JsonSerializable
    {
        ...
        {
            LinkedServiceReferenceAutoGenerated store = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    store = LinkedServiceReferenceAutoGenerated.DeserializeLinkedServiceReferenceAutoGenerated(property.Value);
                    continue;
                }
