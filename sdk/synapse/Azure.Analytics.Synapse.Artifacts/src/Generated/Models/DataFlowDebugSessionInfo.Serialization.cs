...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    {
        internal static DataFlowDebugSessionInfo DeserializeDataFlowDebugSessionInfo(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
