...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureSqlMILinkedService>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AzureSqlMILinkedService>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AzureSqlMILinkedService>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AzureSqlMILinkedService>)} interface");
            }
        ...
        string IPersistableModel<AzureSqlMILinkedService>.GetWireFormat(ModelReaderWriterOptions options) => "J";
