    ...
    public partial class AzureSqlMILinkedService : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            if (Optional.IsDefined(AlwaysEncryptedSettings))
            {
                ...
                writer.WriteObjectValue<SqlAlwaysEncryptedProperties>(AlwaysEncryptedSettings);
            }
        ...
        internal static new AzureSqlMILinkedService FromResponse(Response response)
        {
        ...
        internal override RequestContent ToRequestContent()
        {
            ...
            content.JsonWriter.WriteObjectValue<AzureSqlMILinkedService>(this);
            return content;
        }
        ...
        internal partial class AzureSqlMILinkedServiceConverter : JsonConverter<AzureSqlMILinkedService>
        {
            ...
            {
                writer.WriteObjectValue<AzureSqlMILinkedService>(model);
            }
