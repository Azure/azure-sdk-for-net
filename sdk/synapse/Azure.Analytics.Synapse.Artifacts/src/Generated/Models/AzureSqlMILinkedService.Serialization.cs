...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class AzureSqlMILinkedService : IUtf8JsonSerializable
    {
        ...
        internal static AzureSqlMILinkedService DeserializeAzureSqlMILinkedService(JsonElement element)
        {
            ...
            return new AzureSqlMILinkedService(type, connectVia.HasValue ? connectVia.Value : null, description.HasValue ? description.Value : null, new ChangeTrackingDictionary<string, ParameterSpecification>(parameters), new ChangeTrackingList<object>(annotations), additionalProperties, connectionString, password.HasValue ? password.Value : null, servicePrincipalId.HasValue ? servicePrincipalId.Value : null, servicePrincipalKey.HasValue ? servicePrincipalKey.Value : null, tenant.HasValue ? tenant.Value : null, encryptedCredential.HasValue ? encryptedCredential.Value : null);
        }
    }
}
