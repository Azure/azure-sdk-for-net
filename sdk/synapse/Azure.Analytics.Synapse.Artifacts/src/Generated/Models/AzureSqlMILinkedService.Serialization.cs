...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class AzureSqlMILinkedService : IUtf8JsonSerializable
    {
        ...
        internal static AzureSqlMILinkedService DeserializeAzureSqlMILinkedService(JsonElement element)
        {
            ...
            return new AzureSqlMILinkedService(type, connectVia, description, parameters, annotations, additionalProperties, connectionString, password, servicePrincipalId, servicePrincipalKey, tenant, encryptedCredential);
        }
    }
}
