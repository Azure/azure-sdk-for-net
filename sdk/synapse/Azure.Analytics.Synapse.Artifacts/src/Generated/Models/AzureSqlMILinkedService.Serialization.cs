...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class AzureSqlMILinkedService : Core.IUtf8JsonSerializable
    {
        ...
        internal static AzureSqlMILinkedService DeserializeAzureSqlMILinkedService(JsonElement element)
        {
            ...
            return new AzureSqlMILinkedService(type, connectVia.Value, description.Value, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), additionalProperties, connectionString, password.Value, servicePrincipalId.Value, servicePrincipalKey.Value, tenant.Value, azureCloudType.Value, alwaysEncryptedSettings.Value, encryptedCredential.Value, credential.Value);
        }
