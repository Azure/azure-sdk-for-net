...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class RunNotebookSnapshotResult
    {
        ...
        internal RunNotebookSnapshotResult(RunNotebookSnapshot snapshot, RunNotebookError error, string runId, string runStatus, string lastCheckedOn, long? sessionId, string sparkPool, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Snapshot = snapshot;
            Error = error;
            RunId = runId;
