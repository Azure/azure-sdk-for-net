...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class EvaluateDataFlowExpressionRequest
    {
        ...
        internal EvaluateDataFlowExpressionRequest(string sessionId, string dataFlowName, string streamName, int? rowLimits, string expression, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            SessionId = sessionId;
