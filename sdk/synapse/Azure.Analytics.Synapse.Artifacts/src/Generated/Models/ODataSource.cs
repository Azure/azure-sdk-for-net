...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class ODataSource : CopySource
    {
        ...
        internal ODataSource(string type, BinaryData sourceRetryCount, BinaryData sourceRetryWait, BinaryData maxConcurrentConnections, IDictionary<string, BinaryData> additionalProperties, BinaryData query, BinaryData httpRequestTimeout, BinaryData additionalColumns) : base(type, sourceRetryCount, sourceRetryWait, maxConcurrentConnections, additionalProperties)
        {
            Query = query;
