...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class HttpDataset : IUtf8JsonSerializable, IJsonModel<HttpDataset>
    {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<HttpDataset>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(HttpDataset)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<HttpDataset>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(HttpDataset)} does not support '{options.Format}' format.");
            }
        }
