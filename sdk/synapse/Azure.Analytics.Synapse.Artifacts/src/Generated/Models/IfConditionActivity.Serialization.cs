...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class IfConditionActivity : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            if (Optional.IsDefined(IfTrueActivities))
            {
            ...
            if (Optional.IsDefined(IfFalseActivities))
            {
        ...
        internal static IfConditionActivity DeserializeIfConditionActivity(JsonElement element)
        {
            ...
            return new IfConditionActivity(name, type, description.HasValue ? description.Value : null, new ChangeTrackingList<ActivityDependency>(dependsOn), new ChangeTrackingList<UserProperty>(userProperties), additionalProperties, expression, new ChangeTrackingList<Activity>(ifTrueActivities), new ChangeTrackingList<Activity>(ifFalseActivities));
        }
    }
}
