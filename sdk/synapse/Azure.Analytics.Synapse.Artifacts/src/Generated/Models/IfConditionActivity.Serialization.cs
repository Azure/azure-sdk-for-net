...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class IfConditionActivity : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            if (!(IfTrueActivities is ChangeTrackingList<Activity> collection1 && collection1.IsUndefined))
            {
            ...
            if (!(IfFalseActivities is ChangeTrackingList<Activity> collection2 && collection2.IsUndefined))
            {
