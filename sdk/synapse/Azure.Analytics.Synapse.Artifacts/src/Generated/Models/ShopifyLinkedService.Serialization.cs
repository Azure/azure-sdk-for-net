...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class ShopifyLinkedService : Core.IUtf8JsonSerializable
    {
        ...
        internal static ShopifyLinkedService DeserializeShopifyLinkedService(JsonElement element)
        {
            ...
            return new ShopifyLinkedService(type, connectVia.Value, description.Value, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), additionalProperties, host, accessToken.Value, useEncryptedEndpoints.Value, useHostVerification.Value, usePeerVerification.Value, encryptedCredential.Value);
        }
