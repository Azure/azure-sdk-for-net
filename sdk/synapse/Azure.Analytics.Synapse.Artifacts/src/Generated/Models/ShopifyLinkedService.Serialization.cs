...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class ShopifyLinkedService : IUtf8JsonSerializable
    {
        ...
        internal static ShopifyLinkedService DeserializeShopifyLinkedService(JsonElement element)
        {
            ...
            return new ShopifyLinkedService(type, connectVia.Value, description.Value, Optional.ToDictionary(parameters), annotations ?? new ChangeTrackingList<object>(), additionalProperties, host, accessToken.Value, useEncryptedEndpoints.Value, useHostVerification.Value, usePeerVerification.Value, encryptedCredential.Value);
        }
