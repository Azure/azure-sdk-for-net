...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class TriggerReference : IUtf8JsonSerializable, IJsonModel<TriggerReference>
    {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<TriggerReference>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(TriggerReference)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<TriggerReference>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(TriggerReference)} does not support '{options.Format}' format.");
            }
        }
