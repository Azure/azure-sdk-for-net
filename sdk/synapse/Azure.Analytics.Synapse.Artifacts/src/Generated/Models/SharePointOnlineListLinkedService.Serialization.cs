...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class SharePointOnlineListLinkedService : IUtf8JsonSerializable
    {
        ...
        internal static SharePointOnlineListLinkedService DeserializeSharePointOnlineListLinkedService(JsonElement element)
        {
            ...
            return new SharePointOnlineListLinkedService(type, connectVia.Value, description.Value, Optional.ToDictionary(parameters), annotations ?? new ChangeTrackingList<object>(), additionalProperties, siteUrl, tenantId, servicePrincipalId, servicePrincipalKey, encryptedCredential.Value);
        }
