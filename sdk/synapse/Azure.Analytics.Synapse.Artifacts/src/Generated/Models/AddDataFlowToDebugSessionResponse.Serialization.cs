...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AddDataFlowToDebugSessionResponse>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AddDataFlowToDebugSessionResponse>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AddDataFlowToDebugSessionResponse>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AddDataFlowToDebugSessionResponse>)} interface");
            }
        ...
        string IPersistableModel<AddDataFlowToDebugSessionResponse>.GetWireFormat(ModelReaderWriterOptions options) => "J";
