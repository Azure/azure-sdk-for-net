...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class LinkedIntegrationRuntimeKeyAuthorization : LinkedIntegrationRuntimeType
    {
        ...
        internal LinkedIntegrationRuntimeKeyAuthorization(string authorizationType, SecureString key, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(authorizationType, serializedAdditionalRawData)
        {
            Key = key;
