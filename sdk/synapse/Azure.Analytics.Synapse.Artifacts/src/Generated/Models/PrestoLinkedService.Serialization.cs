...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class PrestoLinkedService : IUtf8JsonSerializable
    {
        ...
        internal static PrestoLinkedService DeserializePrestoLinkedService(JsonElement element)
        {
            ...
            return new PrestoLinkedService(type, connectVia.HasValue ? connectVia.Value : null, description.HasValue ? description.Value : null, new ChangeTrackingDictionary<string, ParameterSpecification>(parameters), new ChangeTrackingList<object>(annotations), additionalProperties, host, serverVersion, catalog, port.HasValue ? port.Value : null, authenticationType, username.HasValue ? username.Value : null, password.HasValue ? password.Value : null, enableSsl.HasValue ? enableSsl.Value : null, trustedCertPath.HasValue ? trustedCertPath.Value : null, useSystemTrustStore.HasValue ? useSystemTrustStore.Value : null, allowHostNameCNMismatch.HasValue ? allowHostNameCNMismatch.Value : null, allowSelfSignedServerCert.HasValue ? allowSelfSignedServerCert.Value : null, timeZoneID.HasValue ? timeZoneID.Value : null, encryptedCredential.HasValue ? encryptedCredential.Value : null);
        }
    }
}
