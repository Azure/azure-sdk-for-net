...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class SmartsheetLinkedService : IUtf8JsonSerializable
    {
        ...
        internal static SmartsheetLinkedService DeserializeSmartsheetLinkedService(JsonElement element)
        {
            ...
            return new SmartsheetLinkedService(type, connectVia.Value, description.Value, Optional.ToDictionary(parameters), annotations ?? new ChangeTrackingList<object>(), additionalProperties, apiToken, encryptedCredential.Value);
        }
