...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class SmartsheetLinkedService : Core.IUtf8JsonSerializable
    {
        ...
        internal static SmartsheetLinkedService DeserializeSmartsheetLinkedService(JsonElement element)
        {
            ...
            return new SmartsheetLinkedService(type, connectVia.Value, description.Value, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), additionalProperties, apiToken, encryptedCredential.Value);
        }
