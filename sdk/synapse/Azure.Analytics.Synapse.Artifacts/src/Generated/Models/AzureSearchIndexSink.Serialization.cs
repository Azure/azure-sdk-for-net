...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class AzureSearchIndexSink : Core.IUtf8JsonSerializable
    {
        ...
        internal static AzureSearchIndexSink DeserializeAzureSearchIndexSink(JsonElement element)
        {
            ...
            Core.Optional<AzureSearchIndexWriteBehaviorType> writeBehavior = default;
            string type = default;
            ...
            return new AzureSearchIndexSink(type, writeBatchSize.Value, writeBatchTimeout.Value, sinkRetryCount.Value, sinkRetryWait.Value, maxConcurrentConnections.Value, additionalProperties, Core.Optional.ToNullable(writeBehavior));
        }
