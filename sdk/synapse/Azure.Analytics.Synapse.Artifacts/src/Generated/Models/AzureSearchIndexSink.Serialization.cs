...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureSearchIndexSink>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<AzureSearchIndexSink>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AzureSearchIndexSink>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
