...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SparkConfigurationParametrizationReference>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        SparkConfigurationParametrizationReference IJsonModel<SparkConfigurationParametrizationReference>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<SparkConfigurationParametrizationReference>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        SparkConfigurationParametrizationReference IModel<SparkConfigurationParametrizationReference>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<SparkConfigurationParametrizationReference>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
