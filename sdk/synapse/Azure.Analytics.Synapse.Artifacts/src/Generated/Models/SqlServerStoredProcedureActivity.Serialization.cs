...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class SqlServerStoredProcedureActivity : IUtf8JsonSerializable
    {
        ...
        internal static SqlServerStoredProcedureActivity DeserializeSqlServerStoredProcedureActivity(JsonElement element)
        {
            ...
            return new SqlServerStoredProcedureActivity(name, type, description.HasValue ? description.Value : null, new ChangeTrackingList<ActivityDependency>(dependsOn), new ChangeTrackingList<UserProperty>(userProperties), additionalProperties, linkedServiceName.HasValue ? linkedServiceName.Value : null, policy.HasValue ? policy.Value : null, storedProcedureName, new ChangeTrackingDictionary<string, StoredProcedureParameter>(storedProcedureParameters));
        }
    }
}
