...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class SqlServerStoredProcedureActivity : Core.IUtf8JsonSerializable
    {
        ...
        internal static SqlServerStoredProcedureActivity DeserializeSqlServerStoredProcedureActivity(JsonElement element)
        {
            ...
            return new SqlServerStoredProcedureActivity(name, type, description.Value, Core.Optional.ToNullable(state), Core.Optional.ToNullable(onInactiveMarkAs), Core.Optional.ToList(dependsOn), Core.Optional.ToList(userProperties), additionalProperties, linkedServiceName.Value, policy.Value, storedProcedureName, storedProcedureParameters.Value);
        }
