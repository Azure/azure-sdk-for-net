...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class LookupActivity : ExecutionActivity
    {
        ...
        internal LookupActivity(string name, string type, string description, IList<ActivityDependency> dependsOn, IList<UserProperty> userProperties, IDictionary<string, object> additionalProperties, LinkedServiceReferenceAutoGenerated linkedServiceName, ActivityPolicy policy, CopySource source, DatasetReference dataset, object firstRowOnly) : base(name, type, description, dependsOn, userProperties, additionalProperties, linkedServiceName, policy)
        {
            Source = source;
            Dataset = dataset;
