...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class DataFlowDebugResource : SubResourceDebugResource
    {
        ...
        internal DataFlowDebugResource(string name, DataFlow properties, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(name, serializedAdditionalRawData)
        {
            Properties = properties;
        }
