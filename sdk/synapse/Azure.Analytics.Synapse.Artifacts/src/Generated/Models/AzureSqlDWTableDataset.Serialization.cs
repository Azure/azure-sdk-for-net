...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class AzureSqlDWTableDataset : IUtf8JsonSerializable
    {
        ...
        internal static AzureSqlDWTableDataset DeserializeAzureSqlDWTableDataset(JsonElement element)
        {
            ...
            return new AzureSqlDWTableDataset(type, description, structure, schema, linkedServiceName, parameters, annotations, folder, additionalProperties, tableName, schema0, table);
        }
    }
}
