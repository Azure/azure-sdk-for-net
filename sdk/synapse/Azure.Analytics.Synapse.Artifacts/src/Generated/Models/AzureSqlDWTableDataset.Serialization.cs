...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class AzureSqlDWTableDataset : IUtf8JsonSerializable
    {
        ...
        internal static AzureSqlDWTableDataset DeserializeAzureSqlDWTableDataset(JsonElement element)
        {
            ...
            return new AzureSqlDWTableDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, parameters ?? new ChangeTrackingDictionary<string, ParameterSpecification>(), annotations ?? new ChangeTrackingList<object>(), folder.Value, additionalProperties, tableName.Value, schema0.Value, table.Value);
        }
