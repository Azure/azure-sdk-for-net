...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class WebTableDataset : Dataset
    {
        ...
        public WebTableDataset(LinkedServiceReferenceAutoGenerated linkedServiceName, object index) : base(linkedServiceName)
        {
        ...
        internal WebTableDataset(string type, string description, object structure, object schema, LinkedServiceReferenceAutoGenerated linkedServiceName, IDictionary<string, ParameterSpecification> parameters, IList<object> annotations, DatasetFolder folder, IDictionary<string, object> additionalProperties, object index, object path) : base(type, description, structure, schema, linkedServiceName, parameters, annotations, folder, additionalProperties)
        {
            Index = index;
            Path = path;
            Type = type ?? "WebTable";
