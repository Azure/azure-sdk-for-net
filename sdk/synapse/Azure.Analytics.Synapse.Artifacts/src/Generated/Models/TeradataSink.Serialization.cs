...
{
    [JsonConverter(typeof(TeradataSinkConverter))]
    public partial class TeradataSink : IUtf8JsonSerializable
    {
        ...
        internal static TeradataSink DeserializeTeradataSink(JsonElement element)
        {
        ...
        internal static new TeradataSink FromResponse(Response response)
        {
            using var document = JsonDocument.Parse(response.Content, ModelSerializationExtensions.JsonDocumentOptions);
            return DeserializeTeradataSink(document.RootElement);
        }
        ...
        internal partial class TeradataSinkConverter : JsonConverter<TeradataSink>
        {
            public override void Write(Utf8JsonWriter writer, TeradataSink model, JsonSerializerOptions options)
            {
                writer.WriteObjectValue(model);
            }

            public override TeradataSink Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
            {
