...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class ExecuteDataFlowActivity : IUtf8JsonSerializable
    {
        ...
        internal static ExecuteDataFlowActivity DeserializeExecuteDataFlowActivity(JsonElement element)
        {
            ...
            return new ExecuteDataFlowActivity(name, type, description.HasValue ? description.Value : null, new ChangeTrackingList<ActivityDependency>(dependsOn), new ChangeTrackingList<UserProperty>(userProperties), additionalProperties, linkedServiceName.HasValue ? linkedServiceName.Value : null, policy.HasValue ? policy.Value : null, dataFlow, staging.HasValue ? staging.Value : null, integrationRuntime.HasValue ? integrationRuntime.Value : null, compute.HasValue ? compute.Value : null);
        }
    }
}
