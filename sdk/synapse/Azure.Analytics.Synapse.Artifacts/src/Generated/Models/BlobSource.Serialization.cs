...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class BlobSource : IUtf8JsonSerializable
    {
        ...
        internal static new BlobSource FromResponse(Response response)
        {
        ...
        internal override RequestContent ToRequestContent()
        {
            ...
            content.JsonWriter.WriteObjectValue<BlobSource>(this);
            return content;
        }
        ...
        internal partial class BlobSourceConverter : JsonConverter<BlobSource>
        {
            ...
            {
                writer.WriteObjectValue<BlobSource>(model);
            }
