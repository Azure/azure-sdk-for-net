...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class BlobSource : IUtf8JsonSerializable, IJsonModel<BlobSource>
    {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<BlobSource>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(BlobSource)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<BlobSource>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(BlobSource)} does not support '{options.Format}' format.");
            }
        }
