...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class BlobSource : IUtf8JsonSerializable, IModelJsonSerializable<BlobSource>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<BlobSource>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="BlobSource"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="BlobSource"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="BlobSource"/>. </summary>
