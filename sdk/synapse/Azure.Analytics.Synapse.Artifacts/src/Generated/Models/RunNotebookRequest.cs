...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class RunNotebookRequest
    {
        ...
        internal RunNotebookRequest(string notebook, string sparkPool, RunNotebookSparkSessionOptions sessionOptions, bool? honorSessionTimeToLive, IDictionary<string, RunNotebookParameter> parameters, Dictionary<string, BinaryData> rawData)
        {
            Notebook = notebook;
            SparkPool = sparkPool;
