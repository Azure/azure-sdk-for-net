...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class Transformation
    {
        ...
        internal Transformation(string name, string description, DatasetReference dataset, LinkedServiceReferenceAutoGenerated linkedService, DataFlowReference flowlet)
        {
            Name = name;
        ...
        public LinkedServiceReferenceAutoGenerated LinkedService { get; set; }
