...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class Transformation
    {
        ...
        internal Transformation(string name, string description, DatasetReference dataset, LinkedServiceReference linkedService, DataFlowReference flowlet, Dictionary<string, BinaryData> rawData)
        {
            Name = name;
