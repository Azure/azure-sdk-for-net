...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class AzureDataLakeAnalyticsLinkedService : IUtf8JsonSerializable
    {
        ...
        internal static AzureDataLakeAnalyticsLinkedService DeserializeAzureDataLakeAnalyticsLinkedService(JsonElement element)
        {
            ...
            return new AzureDataLakeAnalyticsLinkedService(type, connectVia.HasValue ? connectVia.Value : null, description.HasValue ? description.Value : null, new ChangeTrackingDictionary<string, ParameterSpecification>(parameters), new ChangeTrackingList<object>(annotations), additionalProperties, accountName, servicePrincipalId.HasValue ? servicePrincipalId.Value : null, servicePrincipalKey.HasValue ? servicePrincipalKey.Value : null, tenant, subscriptionId.HasValue ? subscriptionId.Value : null, resourceGroupName.HasValue ? resourceGroupName.Value : null, dataLakeAnalyticsUri.HasValue ? dataLakeAnalyticsUri.Value : null, encryptedCredential.HasValue ? encryptedCredential.Value : null);
        }
    }
}
