...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class AzureDataLakeAnalyticsLinkedService : IUtf8JsonSerializable
    {
        ...
        internal static AzureDataLakeAnalyticsLinkedService DeserializeAzureDataLakeAnalyticsLinkedService(JsonElement element)
        {
            ...
            return new AzureDataLakeAnalyticsLinkedService(type, connectVia, description, parameters, annotations, additionalProperties, accountName, servicePrincipalId, servicePrincipalKey, tenant, subscriptionId, resourceGroupName, dataLakeAnalyticsUri, encryptedCredential);
        }
    }
}
