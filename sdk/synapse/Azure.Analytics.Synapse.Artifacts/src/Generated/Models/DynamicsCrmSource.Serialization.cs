...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class DynamicsCrmSource : IUtf8JsonSerializable, IModelJsonSerializable<DynamicsCrmSource>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<DynamicsCrmSource>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="DynamicsCrmSource"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="DynamicsCrmSource"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="DynamicsCrmSource"/>. </summary>
