...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class ExecutePipelineActivity : Core.IUtf8JsonSerializable
    {
        void Core.IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            if (Core.Optional.IsDefined(WaitOnCompletion))
            {
        ...
        internal static ExecutePipelineActivity DeserializeExecutePipelineActivity(JsonElement element)
        {
            ...
            Core.Optional<bool> waitOnCompletion = default;
            ...
            return new ExecutePipelineActivity(name, type, description.Value, Core.Optional.ToNullable(state), Core.Optional.ToNullable(onInactiveMarkAs), Core.Optional.ToList(dependsOn), Core.Optional.ToList(userProperties), additionalProperties, pipeline, Core.Optional.ToDictionary(parameters), Core.Optional.ToNullable(waitOnCompletion));
        }
