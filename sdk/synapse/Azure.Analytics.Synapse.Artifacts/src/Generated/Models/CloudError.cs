...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class CloudError
    {
        ...
        internal CloudError(string code, string message, string target, IReadOnlyList<CloudError> details, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Code = code;
            Message = message;
            Target = target;
