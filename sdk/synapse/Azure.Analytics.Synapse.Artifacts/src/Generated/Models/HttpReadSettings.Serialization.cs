...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HttpReadSettings>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<HttpReadSettings>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<HttpReadSettings>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<HttpReadSettings>)} interface");
            }
        ...
        string IPersistableModel<HttpReadSettings>.GetWireFormat(ModelReaderWriterOptions options) => "J";
