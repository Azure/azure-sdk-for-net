...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class LinkTableResource : IUtf8JsonSerializable, IModelJsonSerializable<LinkTableResource>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<LinkTableResource>(this, options.Format);
            ...
            if (Optional.IsDefined(Source))
            {
                ...
                {
                    ((IModelJsonSerializable<LinkTableRequestSource>)Source).Serialize(writer, options);
                }
            }
            if (Optional.IsDefined(Target))
            {
                ...
                {
                    ((IModelJsonSerializable<LinkTableRequestTarget>)Target).Serialize(writer, options);
                }
            }
        ...
        /// <summary> Converts a <see cref="LinkTableResource"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="LinkTableResource"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="LinkTableResource"/>. </summary>
