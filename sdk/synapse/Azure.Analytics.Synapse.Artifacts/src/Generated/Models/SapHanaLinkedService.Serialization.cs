...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class SapHanaLinkedService : IUtf8JsonSerializable
    {
        ...
        internal static SapHanaLinkedService DeserializeSapHanaLinkedService(JsonElement element)
        {
            ...
            return new SapHanaLinkedService(type, connectVia.Value, description.Value, Optional.ToDictionary(parameters), annotations ?? new ChangeTrackingList<object>(), additionalProperties, connectionString.Value, server, Optional.ToNullable(authenticationType), userName.Value, password.Value, encryptedCredential.Value);
        }
