...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class SapHanaLinkedService : Core.IUtf8JsonSerializable
    {
        ...
        internal static SapHanaLinkedService DeserializeSapHanaLinkedService(JsonElement element)
        {
            ...
            return new SapHanaLinkedService(type, connectVia.Value, description.Value, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), additionalProperties, connectionString.Value, server, Core.Optional.ToNullable(authenticationType), userName.Value, password.Value, encryptedCredential.Value);
        }
