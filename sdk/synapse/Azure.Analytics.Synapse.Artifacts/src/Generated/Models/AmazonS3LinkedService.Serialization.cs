...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class AmazonS3LinkedService : IUtf8JsonSerializable
    {
        ...
        internal static AmazonS3LinkedService DeserializeAmazonS3LinkedService(JsonElement element)
        {
            ...
            return new AmazonS3LinkedService(type, connectVia.Value, description.Value, Optional.ToDictionary(parameters), annotations ?? new ChangeTrackingList<object>(), additionalProperties, authenticationType.Value, accessKeyId.Value, secretAccessKey.Value, serviceUrl.Value, sessionToken.Value, encryptedCredential.Value);
        }
