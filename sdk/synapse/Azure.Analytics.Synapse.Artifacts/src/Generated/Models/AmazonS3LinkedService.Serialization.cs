                ...
                if (property.NameEquals("typeProperties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("secretAccessKey"u8))
                        {
                            ...
                            secretAccessKey = ModelSerializationExtensions.JsonDeserialize<SecretBase>(property0.Value);
                            continue;
                        }
                        ...
                        if (property0.NameEquals("sessionToken"u8))
                        {
                            ...
                            sessionToken = ModelSerializationExtensions.JsonDeserialize<SecretBase>(property0.Value);
                            continue;
                        }
