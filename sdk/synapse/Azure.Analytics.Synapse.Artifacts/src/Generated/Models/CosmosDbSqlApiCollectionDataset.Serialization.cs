...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class CosmosDbSqlApiCollectionDataset : Core.IUtf8JsonSerializable
    {
        ...
        internal static CosmosDbSqlApiCollectionDataset DeserializeCosmosDbSqlApiCollectionDataset(JsonElement element)
        {
            ...
            return new CosmosDbSqlApiCollectionDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), folder.Value, additionalProperties, collectionName);
        }
