...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class CosmosDbSqlApiCollectionDataset : IUtf8JsonSerializable
    {
        ...
        internal static CosmosDbSqlApiCollectionDataset DeserializeCosmosDbSqlApiCollectionDataset(JsonElement element)
        {
            ...
            return new CosmosDbSqlApiCollectionDataset(type, description.HasValue ? description.Value : null, structure.HasValue ? structure.Value : null, schema.HasValue ? schema.Value : null, linkedServiceName, new ChangeTrackingDictionary<string, ParameterSpecification>(parameters), new ChangeTrackingList<object>(annotations), folder.HasValue ? folder.Value : null, additionalProperties, collectionName);
        }
    }
}
