...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class XeroLinkedService : LinkedService
    {
        ...
        public XeroLinkedService(BinaryData host)
        {
            if (host == null)
            {
