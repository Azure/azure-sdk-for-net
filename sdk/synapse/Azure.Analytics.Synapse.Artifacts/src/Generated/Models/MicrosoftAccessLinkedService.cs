...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class MicrosoftAccessLinkedService : LinkedService
    {
        ...
        internal MicrosoftAccessLinkedService(string type, string version, IntegrationRuntimeReference connectVia, string description, IDictionary<string, ParameterSpecification> parameters, IList<object> annotations, IDictionary<string, object> additionalProperties, object connectionString, object authenticationType, SecretBase credential, object userName, SecretBase password, object encryptedCredential) : base(type, version, connectVia, description, parameters, annotations, additionalProperties)
        {
            ConnectionString = connectionString;
