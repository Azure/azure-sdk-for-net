...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class SetVariableActivity : ControlActivity
    {
        ...
        internal SetVariableActivity(string name, string type, string description, IList<ActivityDependency> dependsOn, IList<UserProperty> userProperties, IDictionary<string, BinaryData> additionalProperties, string variableName, BinaryData value) : base(name, type, description, dependsOn, userProperties, additionalProperties)
        {
