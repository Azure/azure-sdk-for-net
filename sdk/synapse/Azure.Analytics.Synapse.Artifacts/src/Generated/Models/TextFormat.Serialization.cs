...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class TextFormat : IUtf8JsonSerializable, IModelJsonSerializable<TextFormat>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IModelJsonSerializable<TextFormat>)this).Serialize(writer, ModelSerializerOptions.DefaultWireOptions);

        void IModelJsonSerializable<TextFormat>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<TextFormat>(this, options.Format);
        ...
        internal static TextFormat DeserializeTextFormat(JsonElement element, ModelSerializerOptions options = default)
        {
        ...
        TextFormat IModelJsonSerializable<TextFormat>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<TextFormat>(this, options.Format);

            using var doc = JsonDocument.ParseValue(ref reader);
            return DeserializeTextFormat(doc.RootElement, options);
        }

        BinaryData IModelSerializable<TextFormat>.Serialize(ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<TextFormat>(this, options.Format);
        ...
        TextFormat IModelSerializable<TextFormat>.Deserialize(BinaryData data, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<TextFormat>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="TextFormat"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="TextFormat"/> to convert. </param>
        public static implicit operator RequestContent(TextFormat model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="TextFormat"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator TextFormat(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeTextFormat(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
