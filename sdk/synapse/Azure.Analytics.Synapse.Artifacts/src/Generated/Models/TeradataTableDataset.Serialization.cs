...
{
    [JsonConverter(typeof(TeradataTableDatasetConverter))]
    public partial class TeradataTableDataset : IUtf8JsonSerializable
    {
        ...
        internal partial class TeradataTableDatasetConverter : JsonConverter<TeradataTableDataset>
        {
            public override void Write(Utf8JsonWriter writer, TeradataTableDataset model, JsonSerializerOptions options)
            {
                writer.WriteObjectValue(model);
            }
            public override TeradataTableDataset Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
            {
                using var document = JsonDocument.ParseValue(ref reader);
                return DeserializeTeradataTableDataset(document.RootElement);
            }
        }
    }
}
