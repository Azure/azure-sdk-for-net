...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class BlobEventsTrigger : IUtf8JsonSerializable, IJsonModel<BlobEventsTrigger>
    {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<BlobEventsTrigger>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(BlobEventsTrigger)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<BlobEventsTrigger>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(BlobEventsTrigger)} does not support '{options.Format}' format.");
            }
        }
