...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BlobEventsTrigger>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<BlobEventsTrigger>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BlobEventsTrigger>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<BlobEventsTrigger>.GetWireFormat(ModelReaderWriterOptions options) => "J";
