...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class BlobEventsTrigger : IUtf8JsonSerializable, IJsonModel<BlobEventsTrigger>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BlobEventsTrigger>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<BlobEventsTrigger>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BlobEventsTrigger>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<BlobEventsTrigger>)} interface");
            }
        ...
        BlobEventsTrigger IJsonModel<BlobEventsTrigger>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == "J" || options.Format == "W";
            if (!isValid)
            {
                throw new FormatException($"The model {nameof(BlobEventsTrigger)} does not support '{options.Format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeBlobEventsTrigger(document.RootElement, options);
        }

        internal static BlobEventsTrigger DeserializeBlobEventsTrigger(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<BlobEventsTrigger>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == "J" || options.Format == "W";
            if (!isValid)
            {
        ...
        BlobEventsTrigger IPersistableModel<BlobEventsTrigger>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == "J" || options.Format == "W";
            if (!isValid)
            {
        ...
        string IPersistableModel<BlobEventsTrigger>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
