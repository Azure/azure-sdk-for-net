...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class SftpServerLinkedService : IUtf8JsonSerializable
    {
        ...
        internal static SftpServerLinkedService DeserializeSftpServerLinkedService(JsonElement element)
        {
            ...
            return new SftpServerLinkedService(type, connectVia.HasValue ? connectVia.Value : null, description.HasValue ? description.Value : null, new ChangeTrackingDictionary<string, ParameterSpecification>(parameters), new ChangeTrackingList<object>(annotations), additionalProperties, host, port.HasValue ? port.Value : null, authenticationType.HasValue ? authenticationType.Value : (SftpAuthenticationType?)null, userName.HasValue ? userName.Value : null, password.HasValue ? password.Value : null, encryptedCredential.HasValue ? encryptedCredential.Value : null, privateKeyPath.HasValue ? privateKeyPath.Value : null, privateKeyContent.HasValue ? privateKeyContent.Value : null, passPhrase.HasValue ? passPhrase.Value : null, skipHostKeyValidation.HasValue ? skipHostKeyValidation.Value : null, hostKeyFingerprint.HasValue ? hostKeyFingerprint.Value : null);
        }
    }
}
