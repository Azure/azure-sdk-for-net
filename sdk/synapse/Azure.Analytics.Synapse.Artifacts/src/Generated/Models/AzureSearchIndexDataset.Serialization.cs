...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class AzureSearchIndexDataset : Core.IUtf8JsonSerializable
    {
        ...
        internal static AzureSearchIndexDataset DeserializeAzureSearchIndexDataset(JsonElement element)
        {
            ...
            return new AzureSearchIndexDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Core.Optional.ToDictionary(parameters), Core.Optional.ToList(annotations), folder.Value, additionalProperties, indexName);
        }
