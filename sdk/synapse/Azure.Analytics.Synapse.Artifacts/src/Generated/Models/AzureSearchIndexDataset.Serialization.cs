...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class AzureSearchIndexDataset : IUtf8JsonSerializable
    {
        ...
        internal static AzureSearchIndexDataset DeserializeAzureSearchIndexDataset(JsonElement element)
        {
            ...
            return new AzureSearchIndexDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, parameters ?? new ChangeTrackingDictionary<string, ParameterSpecification>(), annotations ?? new ChangeTrackingList<object>(), folder.Value, additionalProperties, indexName);
        }
