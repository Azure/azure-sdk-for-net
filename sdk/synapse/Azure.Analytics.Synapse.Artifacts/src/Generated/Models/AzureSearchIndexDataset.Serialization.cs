...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class AzureSearchIndexDataset : IUtf8JsonSerializable
    {
        ...
        internal static AzureSearchIndexDataset DeserializeAzureSearchIndexDataset(JsonElement element)
        {
            ...
            return new AzureSearchIndexDataset(type, description.HasValue ? description.Value : null, structure.HasValue ? structure.Value : null, schema.HasValue ? schema.Value : null, linkedServiceName, new ChangeTrackingDictionary<string, ParameterSpecification>(parameters), new ChangeTrackingList<object>(annotations), folder.HasValue ? folder.Value : null, additionalProperties, indexName);
        }
    }
}
