...
#if NET6_0_OR_GREATER
				writer.WriteRawValue(IndexName);
#else
            JsonSerializer.Serialize(writer, JsonDocument.Parse(IndexName.ToString()).RootElement);
#endif
            writer.WriteEndObject();
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("typeProperties"))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        {
                            indexName = BinaryData.FromString(property.Value.GetRawText());
                            continue;
                        }
                    }
                    continue;
