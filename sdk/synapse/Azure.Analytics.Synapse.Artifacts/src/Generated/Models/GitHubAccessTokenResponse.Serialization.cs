...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    {
        internal static GitHubAccessTokenResponse DeserializeGitHubAccessTokenResponse(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
