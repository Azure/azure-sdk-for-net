...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IntegrationRuntimeListResponse>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<IntegrationRuntimeListResponse>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<IntegrationRuntimeListResponse>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(IntegrationRuntimeListResponse)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<IntegrationRuntimeListResponse>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(IntegrationRuntimeListResponse)} does not support '{options.Format}' format.");
            }
        }
        ...
        string IPersistableModel<IntegrationRuntimeListResponse>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
