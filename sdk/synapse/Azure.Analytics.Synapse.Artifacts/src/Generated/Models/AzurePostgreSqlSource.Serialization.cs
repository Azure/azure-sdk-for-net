...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class AzurePostgreSqlSource : IUtf8JsonSerializable
    {
        ...
        internal static AzurePostgreSqlSource DeserializeAzurePostgreSqlSource(JsonElement element)
        {
            ...
            return new AzurePostgreSqlSource(type, sourceRetryCount.Value, sourceRetryWait.Value, maxConcurrentConnections.Value, additionalProperties, queryTimeout.Value, query.Value);
        }
