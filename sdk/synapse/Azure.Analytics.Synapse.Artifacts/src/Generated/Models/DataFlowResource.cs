...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class DataFlowResource : SubResource
    {
        ...
        internal DataFlowResource(string id, string name, string type, string etag, DataFlow properties, Dictionary<string, BinaryData> rawData) : base(id, name, type, etag, rawData)
        {
            Properties = properties;
        }
