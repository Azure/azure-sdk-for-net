...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class MarketoLinkedService : IUtf8JsonSerializable
    {
        ...
        internal static MarketoLinkedService DeserializeMarketoLinkedService(JsonElement element)
        {
            ...
            return new MarketoLinkedService(type, connectVia.Value, description.Value, Optional.ToDictionary(parameters), annotations ?? new ChangeTrackingList<object>(), additionalProperties, endpoint, clientId, clientSecret.Value, useEncryptedEndpoints.Value, useHostVerification.Value, usePeerVerification.Value, encryptedCredential.Value);
        }
