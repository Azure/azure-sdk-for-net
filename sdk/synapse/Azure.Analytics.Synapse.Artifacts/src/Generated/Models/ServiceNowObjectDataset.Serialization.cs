...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class ServiceNowObjectDataset : IUtf8JsonSerializable
    {
        ...
        internal static ServiceNowObjectDataset DeserializeServiceNowObjectDataset(JsonElement element)
        {
            ...
            return new ServiceNowObjectDataset(type, description.Value, structure.Value, schema.Value, linkedServiceName, Optional.ToDictionary(parameters), annotations ?? new ChangeTrackingList<object>(), folder.Value, additionalProperties, tableName.Value);
        }
