...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class CosmosDbLinkedService : IUtf8JsonSerializable
    {
        ...
        internal static CosmosDbLinkedService DeserializeCosmosDbLinkedService(JsonElement element)
        {
            ...
            return new CosmosDbLinkedService(type, connectVia.HasValue ? connectVia.Value : null, description.HasValue ? description.Value : null, new ChangeTrackingDictionary<string, ParameterSpecification>(parameters), new ChangeTrackingList<object>(annotations), additionalProperties, connectionString.HasValue ? connectionString.Value : null, accountEndpoint.HasValue ? accountEndpoint.Value : null, database.HasValue ? database.Value : null, accountKey.HasValue ? accountKey.Value : null, encryptedCredential.HasValue ? encryptedCredential.Value : null);
        }
    }
}
