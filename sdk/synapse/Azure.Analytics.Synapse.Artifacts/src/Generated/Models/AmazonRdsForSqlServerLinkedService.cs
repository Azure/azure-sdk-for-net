...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class AmazonRdsForSqlServerLinkedService : LinkedService
    {
        ...
        internal AmazonRdsForSqlServerLinkedService(string type, string version, IntegrationRuntimeReference connectVia, string description, IDictionary<string, ParameterSpecification> parameters, IList<object> annotations, IDictionary<string, object> additionalProperties, object server, object database, object encrypt, object trustServerCertificate, object hostNameInCertificate, object applicationIntent, object connectTimeout, object connectRetryCount, object connectRetryInterval, object loadBalanceTimeout, object commandTimeout, object integratedSecurity, object failoverPartner, object maxPoolSize, object minPoolSize, object multipleActiveResultSets, object multiSubnetFailover, object packetSize, object pooling, object connectionString, AmazonRdsForSqlServerAuthenticationType? authenticationType, object userName, SecretBase password, object encryptedCredential, SqlAlwaysEncryptedProperties alwaysEncryptedSettings) : base(type, version, connectVia, description, parameters, annotations, additionalProperties)
        {
            Server = server;
            Database = database;
            Encrypt = encrypt;
        ...
        public AmazonRdsForSqlServerAuthenticationType? AuthenticationType { get; set; }
