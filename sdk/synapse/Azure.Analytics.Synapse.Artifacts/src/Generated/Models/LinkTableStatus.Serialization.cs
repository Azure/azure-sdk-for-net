...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class LinkTableStatus : IUtf8JsonSerializable, IJsonModel<LinkTableStatus>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<LinkTableStatus>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<LinkTableStatus>)} interface");
            }
