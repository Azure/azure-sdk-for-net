...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class BlobTrigger : MultiplePipelineTrigger
    {
        ...
        public BlobTrigger(string folderPath, int maxConcurrency, LinkedServiceReferenceAutoGenerated linkedService)
        {
            if (folderPath == null)
            {
        ...
        /// <param name="maxConcurrency"> The max number of parallel files to handle when it is triggered. </param>
        /// <param name="linkedService"> The Azure Storage linked service reference. </param>
        internal BlobTrigger(string type, string description, TriggerRuntimeState? runtimeState, IList<object> annotations, IDictionary<string, object> additionalProperties, IList<TriggerPipelineReference> pipelines, string folderPath, int maxConcurrency, LinkedServiceReferenceAutoGenerated linkedService) : base(type, description, runtimeState, annotations, additionalProperties, pipelines)
        {
            FolderPath = folderPath;
            MaxConcurrency = maxConcurrency;
            LinkedService = linkedService;
