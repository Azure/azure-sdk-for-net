...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    ...
    public partial class ProxyResource : Resource
    {
        ...
        internal ProxyResource(string id, string name, string type, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, type, serializedAdditionalRawData)
        {
        }
    }
}
