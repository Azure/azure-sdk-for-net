...
namespace Azure.Analytics.Synapse.Artifacts
{
    ...
    public partial class SparkConfigurationClient
    {
        ...
        public SparkConfigurationClient(Uri endpoint, TokenCredential credential, ArtifactsClientOptions options = null)
        {
            ...
            RestClient = new SparkConfigurationRestClient(_clientDiagnostics, _pipeline, endpoint, options.Version);
        }
        ...
        internal SparkConfigurationClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Uri endpoint, string apiVersion = "2021-06-01-preview")
        {
            RestClient = new SparkConfigurationRestClient(clientDiagnostics, pipeline, endpoint, apiVersion);
