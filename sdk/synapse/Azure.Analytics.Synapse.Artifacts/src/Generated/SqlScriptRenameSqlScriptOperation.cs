...
namespace Azure.Analytics.Synapse.Artifacts
{
    ...
    public partial class SqlScriptRenameSqlScriptOperation : Operation
    {
        private readonly OperationInternal _operation;

        /// <summary> Initializes a new instance of SqlScriptRenameSqlScriptOperation for mocking. </summary>
        ...
        internal SqlScriptRenameSqlScriptOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            ...
            _operation = new OperationInternal(nextLinkOperation, clientDiagnostics, response, "SqlScriptRenameSqlScriptOperation");
        }
