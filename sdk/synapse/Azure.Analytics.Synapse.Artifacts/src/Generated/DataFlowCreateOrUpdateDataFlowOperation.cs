...
namespace Azure.Analytics.Synapse.Artifacts
{
    ...
    public partial class DataFlowCreateOrUpdateDataFlowOperation : Operation<DataFlowResource>, Core.IOperationSource<DataFlowResource>
    {
        ...
        {
            IOperation<DataFlowResource> nextLinkOperation = Core.NextLinkOperationImplementation.Create(this, pipeline, request.Method, request.Uri.ToUri(), response, Core.OperationFinalStateVia.Location);
