...
namespace Azure.Analytics.Synapse.Artifacts
{
    ...
    public partial class SparkJobDefinitionRenameSparkJobDefinitionOperation : Operation
    {
        ...
        internal SparkJobDefinitionRenameSparkJobDefinitionOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            ...
            _operation = new OperationInternal(nextLinkOperation, clientDiagnostics, response, "SparkJobDefinitionRenameSparkJobDefinitionOperation");
        }
