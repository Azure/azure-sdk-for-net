...
namespace Azure.Analytics.Synapse.Artifacts
{
    ...
    public partial class SparkJobDefinitionRenameSparkJobDefinitionOperation : Operation
    {
        ...
        {
            _operation = new OperationInternals(clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "SparkJobDefinitionRenameSparkJobDefinitionOperation");
        }
