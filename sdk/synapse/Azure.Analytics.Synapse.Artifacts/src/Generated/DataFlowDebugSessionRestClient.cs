...
namespace Azure.Analytics.Synapse.Artifacts
{
    internal partial class DataFlowDebugSessionRestClient
    {
        ...
        internal HttpMessage CreateCreateDataFlowDebugSessionRequest(CreateDataFlowDebugSessionRequest request)
        {
            ...
            ((IJsonModel<CreateDataFlowDebugSessionRequest>)request).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
        ...
        internal HttpMessage CreateAddDataFlowRequest(DataFlowDebugPackage request)
        {
            ...
            request0.Headers.Add("Content-Type", "application/json");
            var content = new Utf8JsonRequestContent();
            ((IJsonModel<DataFlowDebugPackage>)request).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
            request0.Content = content;
            return message;
        }
        ...
        internal HttpMessage CreateDeleteDataFlowDebugSessionRequest(DeleteDataFlowDebugSessionRequest request)
        {
            ...
            request0.Headers.Add("Content-Type", "application/json");
            var content = new Utf8JsonRequestContent();
            ((IJsonModel<DeleteDataFlowDebugSessionRequest>)request).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
            request0.Content = content;
            return message;
        }
        ...
        internal HttpMessage CreateExecuteCommandRequest(DataFlowDebugCommandRequest request)
        {
            ...
            request0.Headers.Add("Content-Type", "application/json");
            var content = new Utf8JsonRequestContent();
            ((IJsonModel<DataFlowDebugCommandRequest>)request).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
            request0.Content = content;
            return message;
        }
