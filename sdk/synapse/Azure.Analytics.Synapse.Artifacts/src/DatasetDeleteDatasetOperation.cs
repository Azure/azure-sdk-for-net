...
namespace Azure.Analytics.Synapse.Artifacts
{
    ...
    public partial class DatasetDeleteDatasetOperation : Operation
    {
        ...
        internal DatasetDeleteDatasetOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            ...
            _operation = new OperationInternal(clientDiagnostics, nextLinkOperation, response, "DatasetDeleteDatasetOperation");
        }
