# Azure Synapse Management client library for .NET
...
Install the Azure Synapse management library for .NET with [NuGet](https://www.nuget.org/):

```dotnetcli
dotnet add package Azure.ResourceManager.Synapse --prerelease
```
