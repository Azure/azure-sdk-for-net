...
{
    public partial class Sample_SqlPoolConnectionPolicyCollection
    {
        ...
        public async Task Get_GetAConnectionPolicyOfASQLAnalyticsPool()
        {
            ...
            // get the collection of this SqlPoolConnectionPolicyResource
            SqlPoolConnectionPolicyCollection collection = sqlPool.GetSqlPoolConnectionPolicies();

            // invoke the operation
            ConnectionPolicyName connectionPolicyName = ConnectionPolicyName.Default;
            SqlPoolConnectionPolicyResource result = await collection.GetAsync(connectionPolicyName);
