...
{
    public partial class Sample_DataMaskingRuleCollection
    {
        ...
        public async Task CreateOrUpdate_CreateUpdateDataMaskingRuleForDefaultMax()
        {
            ...
            // get the collection of this DataMaskingRuleResource
            DataMaskingRuleCollection collection = dataMaskingPolicy.GetDataMaskingRules();
            ...
            ArmOperation<DataMaskingRuleResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, dataMaskingRuleName, data);
        ...
        public async Task Get_GetDataMaskingRule()
        {
            ...
            // invoke the operation
            string dataMaskingRuleName = "rule1";
            DataMaskingRuleResource result = await collection.GetAsync(dataMaskingRuleName);
        ...
        public async Task GetAll_ListDataMaskingRules()
        {
            ...
            await foreach (DataMaskingRuleResource item in collection.GetAllAsync())
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                DataMaskingRuleData resourceData = item.Data;
                // for demo we just print out the id
                Console.WriteLine($"Succeeded on id: {resourceData.Id}");
            }
