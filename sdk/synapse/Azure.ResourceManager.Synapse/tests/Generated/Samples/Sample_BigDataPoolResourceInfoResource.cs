...
{
    public partial class Sample_BigDataPoolResourceInfoResource
    {
        // Get a Big Data pool
        ...
        public async Task Get_GetABigDataPool()
        {
            ...
            // this example assumes you already have this BigDataPoolResourceInfoResource created on azure
            // for more information of creating BigDataPoolResourceInfoResource, please refer to the document of BigDataPoolResourceInfoResource
            string subscriptionId = "01234567-89ab-4def-0123-456789abcdef";
            string resourceGroupName = "ExampleResourceGroup";
            string workspaceName = "ExampleWorkspace";
            string bigDataPoolName = "ExamplePool";
            ResourceIdentifier bigDataPoolResourceInfoResourceId = BigDataPoolResourceInfoResource.CreateResourceIdentifier(subscriptionId, resourceGroupName, workspaceName, bigDataPoolName);
            BigDataPoolResourceInfoResource bigDataPoolResourceInfo = client.GetBigDataPoolResourceInfoResource(bigDataPoolResourceInfoResourceId);

            // invoke the operation
            BigDataPoolResourceInfoResource result = await bigDataPoolResourceInfo.GetAsync();
        ...
        public async Task Update_UpdateABigDataPool()
        {
            ...
            // invoke the operation
            BigDataPoolResourceInfoPatch patch = new BigDataPoolResourceInfoPatch()
            {
                Tags =
{
["key"] = "value",
            ...
            BigDataPoolResourceInfoResource result = await bigDataPoolResourceInfo.UpdateAsync(patch);
        ...
        public async Task Delete_DeleteABigDataPool()
        {
            ...
            // invoke the operation
            ArmOperation<BinaryData> lro = await bigDataPoolResourceInfo.DeleteAsync(WaitUntil.Completed);
