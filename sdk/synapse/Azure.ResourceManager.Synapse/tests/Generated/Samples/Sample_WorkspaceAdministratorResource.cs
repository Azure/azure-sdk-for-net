...
{
    public partial class Sample_WorkspaceAdministratorResource
    {
        ...
        public async Task Get_GetWorkspaceActiveDirectoryAdmin()
        {
            ...
            // this example assumes you already have this WorkspaceAdministratorResource created on azure
            // for more information of creating WorkspaceAdministratorResource, please refer to the document of WorkspaceAdministratorResource
            string subscriptionId = "00000000-1111-2222-3333-444444444444";
            string resourceGroupName = "resourceGroup1";
            string workspaceName = "workspace1";
            ResourceIdentifier workspaceAdministratorResourceId = WorkspaceAdministratorResource.CreateResourceIdentifier(subscriptionId, resourceGroupName, workspaceName);
            WorkspaceAdministratorResource workspaceAdministrator = client.GetWorkspaceAdministratorResource(workspaceAdministratorResourceId);

            // invoke the operation
            WorkspaceAdministratorResource result = await workspaceAdministrator.GetAsync();
        ...
        public async Task CreateOrUpdate_CreateOrUpdateWorkspaceActiveDirectoryAdmin()
        {
            ...
            ArmOperation<WorkspaceAdministratorResource> lro = await workspaceAdministrator.CreateOrUpdateAsync(WaitUntil.Completed, info);
            WorkspaceAdministratorResource result = lro.Value;
        ...
        public async Task Delete_DeleteWorkspaceActiveDirectoryAdmin()
        {
            ...
            // invoke the operation
            await workspaceAdministrator.DeleteAsync(WaitUntil.Completed);
