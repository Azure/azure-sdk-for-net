...
{
    public partial class Sample_ServerSecurityAlertPolicyResource
    {
        ...
        public async Task Get_GetWorkspaceManagedSqlServerSSecurityAlertPolicy()
        {
            ...
            // this example assumes you already have this ServerSecurityAlertPolicyResource created on azure
            // for more information of creating ServerSecurityAlertPolicyResource, please refer to the document of ServerSecurityAlertPolicyResource
            ...
            ResourceIdentifier serverSecurityAlertPolicyResourceId = ServerSecurityAlertPolicyResource.CreateResourceIdentifier(subscriptionId, resourceGroupName, workspaceName, securityAlertPolicyName);
            ServerSecurityAlertPolicyResource serverSecurityAlertPolicy = client.GetServerSecurityAlertPolicyResource(serverSecurityAlertPolicyResourceId);

            // invoke the operation
            ServerSecurityAlertPolicyResource result = await serverSecurityAlertPolicy.GetAsync();
...
"testSecurityAlert@microsoft.com"
            ...
            ArmOperation<ServerSecurityAlertPolicyResource> lro = await serverSecurityAlertPolicy.UpdateAsync(WaitUntil.Completed, data);
