...
{
    public partial class Sample_ReplicationLinkCollection
    {
        ...
        public async Task GetAll_ListsASqlAnalyticPoolSReplicationLinks()
        {
            ...
            // get the collection of this ReplicationLinkResource
            ReplicationLinkCollection collection = sqlPool.GetReplicationLinks();

            // invoke the operation and iterate over the result
            await foreach (ReplicationLinkResource item in collection.GetAllAsync())
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                ReplicationLinkData resourceData = item.Data;
        ...
        public async Task Get_ListsASqlAnalyticPoolSReplicationLinks()
        {
            ...
            ReplicationLinkResource result = await collection.GetAsync(linkId);
