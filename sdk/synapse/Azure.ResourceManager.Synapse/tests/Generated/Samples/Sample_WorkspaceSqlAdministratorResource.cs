...
{
    public partial class Sample_WorkspaceSqlAdministratorResource
    {
        ...
        public async Task Get_GetWorkspaceActiveDirectoryAdmin()
        {
            ...
            // this example assumes you already have this WorkspaceSqlAdministratorResource created on azure
            // for more information of creating WorkspaceSqlAdministratorResource, please refer to the document of WorkspaceSqlAdministratorResource
            string subscriptionId = "00000000-1111-2222-3333-444444444444";
            string resourceGroupName = "resourceGroup1";
            string workspaceName = "workspace1";
            ResourceIdentifier workspaceSqlAdministratorResourceId = WorkspaceSqlAdministratorResource.CreateResourceIdentifier(subscriptionId, resourceGroupName, workspaceName);
            WorkspaceSqlAdministratorResource workspaceSqlAdministrator = client.GetWorkspaceSqlAdministratorResource(workspaceSqlAdministratorResourceId);

            // invoke the operation
            WorkspaceSqlAdministratorResource result = await workspaceSqlAdministrator.GetAsync();

            // the variable result is a resource, you could call other operations on this instance as well
            // but just for demo, we get its data from this resource instance
            WorkspaceAadAdminInfoData resourceData = result.Data;
        ...
        public async Task CreateOrUpdate_CreateOrUpdateWorkspaceActiveDirectoryAdmin()
        {
            ...
            // invoke the operation
            WorkspaceAadAdminInfoData info = new WorkspaceAadAdminInfoData()
            {
            ...
            ArmOperation<WorkspaceSqlAdministratorResource> lro = await workspaceSqlAdministrator.CreateOrUpdateAsync(WaitUntil.Completed, info);
            WorkspaceSqlAdministratorResource result = lro.Value;
        ...
        public async Task Delete_DeleteWorkspaceActiveDirectoryAdmin()
        {
            ...
            // invoke the operation
            await workspaceSqlAdministrator.DeleteAsync(WaitUntil.Completed);
