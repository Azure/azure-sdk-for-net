...
{
    public partial class Sample_SynapseTransparentDataEncryptionCollection
    {
        [Test]
        ...
        public async Task CreateOrUpdate_CreateOrUpdateASqlPoolSTransparentDataEncryptionConfiguration()
        {
            ...
            SynapseTransparentDataEncryptionCollection collection = synapseSqlPool.GetSynapseTransparentDataEncryptions();
            ...
            ArmOperation<SynapseTransparentDataEncryptionResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, transparentDataEncryptionName, data);
        ...
        public async Task Get_GetTransparentDataEncryptionConfigurationOfASQLAnalyticsPool()
        {
            ...
            // invoke the operation
            SynapseTransparentDataEncryptionName transparentDataEncryptionName = SynapseTransparentDataEncryptionName.Current;
            SynapseTransparentDataEncryptionResource result = await collection.GetAsync(transparentDataEncryptionName);
        ...
        public async Task GetAll_GetListOfTransparentDataEncryptionConfigurationsOfASQLAnalyticsPool()
        {
            ...
            await foreach (SynapseTransparentDataEncryptionResource item in collection.GetAllAsync())
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                SynapseTransparentDataEncryptionData resourceData = item.Data;
                // for demo we just print out the id
                Console.WriteLine($"Succeeded on id: {resourceData.Id}");
            }
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task GetIfExists_GetTransparentDataEncryptionConfigurationOfASQLAnalyticsPool()
        {
            // Generated from example definition: specification/synapse/resource-manager/Microsoft.Synapse/stable/2021-06-01/examples/GetSqlPoolTransparentDataEncryption.json
            // this example is just showing the usage of "SqlPoolTransparentDataEncryptions_Get" operation, for the dependent resources, they will have to be created separately.
            ...
            // invoke the operation
            SynapseTransparentDataEncryptionName transparentDataEncryptionName = SynapseTransparentDataEncryptionName.Current;
            NullableResponse<SynapseTransparentDataEncryptionResource> response = await collection.GetIfExistsAsync(transparentDataEncryptionName);
            SynapseTransparentDataEncryptionResource result = response.HasValue ? response.Value : null;
