...
{
    public partial class Sample_KustoPoolCollection
    {
        ...
        public async Task GetAll_ListKustoPoolsInAWorkspace()
        {
            ...
            // get the collection of this KustoPoolResource
            KustoPoolCollection collection = workspace.GetKustoPools();

            // invoke the operation and iterate over the result
            await foreach (KustoPoolResource item in collection.GetAllAsync())
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                KustoPoolData resourceData = item.Data;
        ...
        public async Task Get_KustoPoolsGet()
        {
            ...
            KustoPoolResource result = await collection.GetAsync(kustoPoolName);
        ...
        public async Task CreateOrUpdate_KustoPoolsCreateOrUpdate()
        {
            ...
            // invoke the operation
            string kustoPoolName = "kustoclusterrptest4";
            KustoPoolData data = new KustoPoolData(new AzureLocation("westus"), new AzureSku(SynapseSkuName.StorageOptimized, SkuSize.Medium)
            {
                Capacity = 2,
            })
            {
            ...
            ArmOperation<KustoPoolResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, kustoPoolName, data);
