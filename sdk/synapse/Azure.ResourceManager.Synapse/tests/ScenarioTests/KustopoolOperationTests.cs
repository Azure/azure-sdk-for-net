...
namespace Azure.ResourceManager.Synapse.Tests
{
    public class KustopoolOperationTests : SynapseManagementTestBase
    {
        ...
        public async Task TestKustoPoolLifeCycle()
        {
            ...
            Assert.That(kustoPool, Is.Not.EqualTo(null), string.Format("kusto pool created earlier is not found when listing all in workspace {0}", workspaceName));
        ...
        public async Task TestKustoPoolDatabaseLifeCycle()
        {
            ...
            Assert.That(kustoDatabase, Is.Not.EqualTo(null), string.Format("kusto Database created earlier is not found when listing all in kusto pool {0}", kustoPoolName));
        ...
        private void VerifyKustoPool(SynapseKustoPoolResource kustoPool, string name, SynapseDataSourceSku sku, KustoPoolState state, string workspaceName)
        {
            ...
            Assert.That(poolFullName, Is.EqualTo(kustoPool.Data.Name));
