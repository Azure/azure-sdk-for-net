...
namespace Azure.ResourceManager.Synapse
{
    ...
    public partial class SynapseDedicatedSqlMinimalTlsSettingResource : ArmResource
    {
        ...
        internal SynapseDedicatedSqlMinimalTlsSettingResource(ArmClient client, SynapseDedicatedSqlMinimalTlsSettingData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
