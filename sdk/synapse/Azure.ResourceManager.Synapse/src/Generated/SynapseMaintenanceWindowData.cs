...
namespace Azure.ResourceManager.Synapse
{
    ...
    public partial class SynapseMaintenanceWindowData : ResourceData
    {
        ...
        internal SynapseMaintenanceWindowData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IList<SynapseMaintenanceWindowTimeRange> timeRanges, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData)
        {
