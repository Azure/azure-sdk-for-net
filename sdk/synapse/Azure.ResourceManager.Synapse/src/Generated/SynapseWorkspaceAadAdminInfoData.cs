...
namespace Azure.ResourceManager.Synapse
{
    ...
    public partial class SynapseWorkspaceAadAdminInfoData : ResourceData
    {
        ...
        internal SynapseWorkspaceAadAdminInfoData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, Guid? tenantId, string login, string administratorType, string sid, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
            TenantId = tenantId;
            Login = login;
