...
namespace Azure.ResourceManager.Synapse
{
    ...
    public partial class SynapseWorkspaceSqlAdministratorResource : ArmResource
    {
        ...
        internal SynapseWorkspaceSqlAdministratorResource(ArmClient client, SynapseWorkspaceAadAdminInfoData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<SynapseWorkspaceSqlAdministratorResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new SynapseWorkspaceSqlAdministratorResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
