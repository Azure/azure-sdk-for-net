...
namespace Azure.ResourceManager.Synapse
{
    ...
    public partial class SynapseDatabaseData : ResourceData
    {
        ...
        internal SynapseDatabaseData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, AzureLocation? location, SynapseKind kind, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
            Location = location;
            Kind = kind;
