...
namespace Azure.ResourceManager.Synapse
{
    ...
    /// Otherwise you can get one from its parent resource <see cref="SqlPoolResource" /> using the GetMaintenanceWindow method.
    /// </summary>
    public partial class MaintenanceWindowResource : ArmResource
    {
        ...
        private readonly ClientDiagnostics _maintenanceWindowSqlPoolMaintenanceWindowsClientDiagnostics;
        private readonly SqlPoolMaintenanceWindowsRestOperations _maintenanceWindowSqlPoolMaintenanceWindowsRestClient;
        ...
        {
            _maintenanceWindowSqlPoolMaintenanceWindowsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Synapse", ResourceType.Namespace, Diagnostics);
            TryGetApiVersion(ResourceType, out string maintenanceWindowSqlPoolMaintenanceWindowsApiVersion);
            _maintenanceWindowSqlPoolMaintenanceWindowsRestClient = new SqlPoolMaintenanceWindowsRestOperations(Pipeline, Diagnostics.ApplicationId, Endpoint, maintenanceWindowSqlPoolMaintenanceWindowsApiVersion);
#if DEBUG
        ...
        public virtual async Task<Response<MaintenanceWindowResource>> GetAsync(string maintenanceWindowName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _maintenanceWindowSqlPoolMaintenanceWindowsClientDiagnostics.CreateScope("MaintenanceWindowResource.Get");
            scope.Start();
            try
            {
                var response = await _maintenanceWindowSqlPoolMaintenanceWindowsRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, maintenanceWindowName, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<MaintenanceWindowResource> Get(string maintenanceWindowName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _maintenanceWindowSqlPoolMaintenanceWindowsRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, maintenanceWindowName, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new MaintenanceWindowResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        public virtual async Task<ArmOperation> CreateOrUpdateAsync(WaitUntil waitUntil, string maintenanceWindowName, MaintenanceWindowData data, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _maintenanceWindowSqlPoolMaintenanceWindowsClientDiagnostics.CreateScope("MaintenanceWindowResource.CreateOrUpdate");
            scope.Start();
            try
            {
                var response = await _maintenanceWindowSqlPoolMaintenanceWindowsRestClient.CreateOrUpdateAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, maintenanceWindowName, data, cancellationToken).ConfigureAwait(false);
        ...
        public virtual ArmOperation CreateOrUpdate(WaitUntil waitUntil, string maintenanceWindowName, MaintenanceWindowData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _maintenanceWindowSqlPoolMaintenanceWindowsRestClient.CreateOrUpdate(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, maintenanceWindowName, data, cancellationToken);
                var operation = new SynapseArmOperation(response);
                if (waitUntil == WaitUntil.Completed)
