...
namespace Azure.ResourceManager.Synapse
{
    ...
    public partial class SynapseSqlPoolBlobAuditingPolicyResource : ArmResource
    {
        ...
        internal SynapseSqlPoolBlobAuditingPolicyResource(ArmClient client, SynapseSqlPoolBlobAuditingPolicyData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<SynapseSqlPoolBlobAuditingPolicyResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new SynapseSqlPoolBlobAuditingPolicyResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual async Task<ArmOperation<SynapseSqlPoolBlobAuditingPolicyResource>> CreateOrUpdateAsync(WaitUntil waitUntil, SynapseSqlPoolBlobAuditingPolicyData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new SynapseArmOperation<SynapseSqlPoolBlobAuditingPolicyResource>(Response.FromValue(new SynapseSqlPoolBlobAuditingPolicyResource(Client, response.Value, response.Value.Id), response.GetRawResponse()));
