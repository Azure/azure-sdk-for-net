...
namespace Azure.ResourceManager.Synapse
{
    ...
    public partial class SynapseDataMaskingRuleResource : ArmResource
    {
        ...
        internal SynapseDataMaskingRuleResource(ArmClient client, SynapseDataMaskingRuleData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<SynapseDataMaskingRuleResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new SynapseDataMaskingRuleResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual async Task<ArmOperation<SynapseDataMaskingRuleResource>> UpdateAsync(WaitUntil waitUntil, SynapseDataMaskingRuleData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new SynapseArmOperation<SynapseDataMaskingRuleResource>(Response.FromValue(new SynapseDataMaskingRuleResource(Client, response.Value, response.Value.Id), response.GetRawResponse()));
