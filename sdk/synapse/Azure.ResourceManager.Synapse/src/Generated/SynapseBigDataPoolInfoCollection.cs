...
namespace Azure.ResourceManager.Synapse
{
    ...
    public partial class SynapseBigDataPoolInfoCollection : ArmCollection, IEnumerable<SynapseBigDataPoolInfoResource>, IAsyncEnumerable<SynapseBigDataPoolInfoResource>
    {
        ...
        {
            async Task<Page<SynapseBigDataPoolInfoResource>> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _synapseBigDataPoolInfoBigDataPoolsClientDiagnostics.CreateScope("SynapseBigDataPoolInfoCollection.GetAll");
                scope.Start();
                try
                {
                    var response = await _synapseBigDataPoolInfoBigDataPoolsRestClient.ListByWorkspaceAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new SynapseBigDataPoolInfoResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
                    scope.Failed(e);
            ...
            async Task<Page<SynapseBigDataPoolInfoResource>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                using var scope = _synapseBigDataPoolInfoBigDataPoolsClientDiagnostics.CreateScope("SynapseBigDataPoolInfoCollection.GetAll");
                scope.Start();
                try
                {
                    var response = await _synapseBigDataPoolInfoBigDataPoolsRestClient.ListByWorkspaceNextPageAsync(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new SynapseBigDataPoolInfoResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        {
            Page<SynapseBigDataPoolInfoResource> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _synapseBigDataPoolInfoBigDataPoolsClientDiagnostics.CreateScope("SynapseBigDataPoolInfoCollection.GetAll");
                scope.Start();
                try
                {
                    var response = _synapseBigDataPoolInfoBigDataPoolsRestClient.ListByWorkspace(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new SynapseBigDataPoolInfoResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            Page<SynapseBigDataPoolInfoResource> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                using var scope = _synapseBigDataPoolInfoBigDataPoolsClientDiagnostics.CreateScope("SynapseBigDataPoolInfoCollection.GetAll");
                scope.Start();
                try
                {
                    var response = _synapseBigDataPoolInfoBigDataPoolsRestClient.ListByWorkspaceNextPage(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new SynapseBigDataPoolInfoResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
