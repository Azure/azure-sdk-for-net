...
namespace Azure.ResourceManager.Synapse
{
    ...
    /// The available derived classes include <see cref="ReadOnlyFollowingDatabase"/> and <see cref="ReadWriteDatabase"/>.
    /// </summary>
    public abstract partial class DatabaseData : ResourceData
    {
        ...
        internal DatabaseData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, AzureLocation? location, SynapseKind kind) : base(id, name, resourceType, systemData)
        {
            Location = location;
            Kind = kind;
        }
