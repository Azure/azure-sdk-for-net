...
namespace Azure.ResourceManager.Synapse
{
    internal partial class IpFirewallRulesRestOperations
    {
        ...
        /// <summary> Deletes a firewall rule. You can call ToObjectFromJson&lt;SynapseIPFirewallRuleInfoResource&gt;() against the Value property of the result to get specified type. </summary>
        /// <param name="subscriptionId"> The ID of the target subscription. </param>
        /// <param name="resourceGroupName"> The name of the resource group. The name is case insensitive. </param>
        /// <param name="workspaceName"> The name of the workspace. </param>
        /// <param name="ruleName"> The IP firewall rule name. </param>
