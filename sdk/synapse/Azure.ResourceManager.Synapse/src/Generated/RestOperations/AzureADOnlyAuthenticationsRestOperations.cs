...
{
    internal partial class AzureADOnlyAuthenticationsRestOperations
    {
        ...
        /// <summary> Initializes a new instance of AzureADOnlyAuthenticationsRestOperations. </summary>
        /// <param name="pipeline"> The HTTP pipeline for sending and receiving REST requests and responses. </param>
        /// <param name="applicationId"> The application id to use for user agent. </param>
        /// <param name="endpoint"> server parameter. </param>
        /// <param name="apiVersion"> Api Version. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="pipeline"/> or <paramref name="apiVersion"/> is null. </exception>
        public AzureADOnlyAuthenticationsRestOperations(HttpPipeline pipeline, string applicationId, Uri endpoint = null, string apiVersion = default)
        {
        ...
        internal HttpMessage CreateGetRequest(string subscriptionId, string resourceGroupName, string workspaceName, SynapseAadOnlyAuthenticationName azureADOnlyAuthenticationName)
        {
            ...
            uri.AppendPath(azureADOnlyAuthenticationName.ToString(), true);
        ...
        /// <summary> Gets a Azure Active Directory only authentication property. </summary>
        ...
        public async Task<Response<SynapseAadOnlyAuthenticationData>> GetAsync(string subscriptionId, string resourceGroupName, string workspaceName, SynapseAadOnlyAuthenticationName azureADOnlyAuthenticationName, CancellationToken cancellationToken = default)
        {
            ...
            using var message = CreateGetRequest(subscriptionId, resourceGroupName, workspaceName, azureADOnlyAuthenticationName);
        ...
        /// <summary> Create or Update a Azure Active Directory only authentication property for the workspaces. </summary>
        /// <param name="subscriptionId"> The ID of the target subscription. </param>
        /// <param name="resourceGroupName"> The name of the resource group. The name is case insensitive. </param>
        /// <param name="workspaceName"> The name of the workspace. </param>
        /// <param name="azureADOnlyAuthenticationName"> name of the property. </param>
        ...
        public async Task<Response> CreateAsync(string subscriptionId, string resourceGroupName, string workspaceName, SynapseAadOnlyAuthenticationName azureADOnlyAuthenticationName, SynapseAadOnlyAuthenticationData data, CancellationToken cancellationToken = default)
        {
            ...
            using var message = CreateCreateRequest(subscriptionId, resourceGroupName, workspaceName, azureADOnlyAuthenticationName, data);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 200:
        ...
        /// <summary> Gets a list of Azure Active Directory only authentication property for a workspace. </summary>
        /// <param name="subscriptionId"> The ID of the target subscription. </param>
        /// <param name="resourceGroupName"> The name of the resource group. The name is case insensitive. </param>
        /// <param name="workspaceName"> The name of the workspace. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
