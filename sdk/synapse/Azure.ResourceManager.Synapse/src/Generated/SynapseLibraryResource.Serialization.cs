...
namespace Azure.ResourceManager.Synapse
{
    public partial class SynapseLibraryResource : IJsonModel<SynapseLibraryData>
    {
        ...
        {
            return ModelReaderWriter.Read<SynapseLibraryData>(new BinaryData(reader.ValueSequence), options);
        }
        ...
        {
            return ModelReaderWriter.Read<SynapseLibraryData>(data, options);
        }
