...
namespace Azure.ResourceManager.Synapse
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SynapseMaintenanceWindowData>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SynapseMaintenanceWindowData)} does not support writing '{format}' format.");
            }
            ...
            if (Optional.IsCollectionDefined(TimeRanges))
            {
                ...
                {
                    ((IJsonModel<SynapseMaintenanceWindowTimeRange>)item).Write(writer, options);
                }
        ...
        SynapseMaintenanceWindowData IJsonModel<SynapseMaintenanceWindowData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SynapseMaintenanceWindowData)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<SynapseMaintenanceWindowData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SynapseMaintenanceWindowData)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        SynapseMaintenanceWindowData IPersistableModel<SynapseMaintenanceWindowData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SynapseMaintenanceWindowData)} does not support reading '{options.Format}' format.");
            }
        }
