...
{
    /// <summary> A class representing the KustoPool data model. </summary>
    public partial class KustoPoolData : TrackedResourceData
    {
        ...
        public KustoPoolData(AzureLocation location, AzureSku sku) : base(location)
        {
