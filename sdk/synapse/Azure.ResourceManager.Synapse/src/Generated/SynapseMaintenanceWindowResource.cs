...
namespace Azure.ResourceManager.Synapse
{
    ...
    public partial class SynapseMaintenanceWindowResource : ArmResource
    {
        ...
        internal SynapseMaintenanceWindowResource(ArmClient client, SynapseMaintenanceWindowData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<SynapseMaintenanceWindowResource>> GetAsync(string maintenanceWindowName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new SynapseMaintenanceWindowResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
