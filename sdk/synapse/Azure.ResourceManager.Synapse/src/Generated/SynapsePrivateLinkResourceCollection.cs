...
namespace Azure.ResourceManager.Synapse
{
    ...
    public partial class SynapsePrivateLinkResourceCollection : ArmCollection, IEnumerable<SynapsePrivateLinkResource>, IAsyncEnumerable<SynapsePrivateLinkResource>
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="SynapsePrivateLinkResourceCollection"/> class for mocking. </summary>
        protected SynapsePrivateLinkResourceCollection()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="SynapsePrivateLinkResourceCollection"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the parent resource that is the target of operations. </param>
        internal SynapsePrivateLinkResourceCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            _synapsePrivateLinkResourcePrivateLinkHubPrivateLinkResourcesClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Synapse", SynapsePrivateLinkResource.ResourceType.Namespace, Diagnostics);
            TryGetApiVersion(SynapsePrivateLinkResource.ResourceType, out string synapsePrivateLinkResourcePrivateLinkHubPrivateLinkResourcesApiVersion);
        ...
        public virtual async Task<Response<SynapsePrivateLinkResource>> GetAsync(string privateLinkResourceName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(privateLinkResourceName, nameof(privateLinkResourceName));

            using var scope = _synapsePrivateLinkResourcePrivateLinkHubPrivateLinkResourcesClientDiagnostics.CreateScope("SynapsePrivateLinkResourceCollection.Get");
            scope.Start();
            try
            {
                var response = await _synapsePrivateLinkResourcePrivateLinkHubPrivateLinkResourcesRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, privateLinkResourceName, cancellationToken).ConfigureAwait(false);
        ...
        /// <exception cref="ArgumentException"> <paramref name="privateLinkResourceName"/> is an empty string, and was expected to be non-empty. </exception>
        /// <exception cref="ArgumentNullException"> <paramref name="privateLinkResourceName"/> is null. </exception>
        public virtual Response<SynapsePrivateLinkResource> Get(string privateLinkResourceName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(privateLinkResourceName, nameof(privateLinkResourceName));
            ...
            try
            {
                var response = _synapsePrivateLinkResourcePrivateLinkHubPrivateLinkResourcesRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, privateLinkResourceName, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new SynapsePrivateLinkResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        /// <item>
        /// <term>Request Path</term>
        /// <description>/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Synapse/privateLinkHubs/{privateLinkHubName}/privateLinkResources</description>
        /// </item>
        /// <item>
        /// <term>Operation Id</term>
        /// <description>PrivateLinkHubPrivateLinkResources_List</description>
        /// </item>
        /// </list>
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        ...
        public virtual AsyncPageable<SynapsePrivateLinkResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _synapsePrivateLinkResourcePrivateLinkHubPrivateLinkResourcesRestClient.CreateListNextPageRequest(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Name);
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new SynapsePrivateLinkResource(Client, SynapsePrivateLinkResourceData.DeserializeSynapsePrivateLinkResourceData(e)), _synapsePrivateLinkResourcePrivateLinkHubPrivateLinkResourcesClientDiagnostics, Pipeline, "SynapsePrivateLinkResourceCollection.GetAll", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<SynapsePrivateLinkResource> GetAll(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _synapsePrivateLinkResourcePrivateLinkHubPrivateLinkResourcesRestClient.CreateListRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _synapsePrivateLinkResourcePrivateLinkHubPrivateLinkResourcesRestClient.CreateListNextPageRequest(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Name);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new SynapsePrivateLinkResource(Client, SynapsePrivateLinkResourceData.DeserializeSynapsePrivateLinkResourceData(e)), _synapsePrivateLinkResourcePrivateLinkHubPrivateLinkResourcesClientDiagnostics, Pipeline, "SynapsePrivateLinkResourceCollection.GetAll", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string privateLinkResourceName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _synapsePrivateLinkResourcePrivateLinkHubPrivateLinkResourcesClientDiagnostics.CreateScope("SynapsePrivateLinkResourceCollection.Exists");
            scope.Start();
            try
            {
        ...
        IEnumerator<SynapsePrivateLinkResource> IEnumerable<SynapsePrivateLinkResource>.GetEnumerator()
        {
        ...
        IAsyncEnumerator<SynapsePrivateLinkResource> IAsyncEnumerable<SynapsePrivateLinkResource>.GetAsyncEnumerator(CancellationToken cancellationToken)
        {
