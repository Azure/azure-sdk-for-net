...
namespace Azure.ResourceManager.Synapse
{
    ...
    public partial class SynapseClusterPrincipalAssignmentResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                using var message = _synapseClusterPrincipalAssignmentKustoPoolPrincipalAssignmentsRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name);
                var response = await _synapseClusterPrincipalAssignmentKustoPoolPrincipalAssignmentsRestClient.DeleteAsync(message, cancellationToken).ConfigureAwait(false);
                var operation = new SynapseArmOperation(_synapseClusterPrincipalAssignmentKustoPoolPrincipalAssignmentsClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
        ...
        public virtual ArmOperation Delete(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var message = _synapseClusterPrincipalAssignmentKustoPoolPrincipalAssignmentsRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name);
                var response = _synapseClusterPrincipalAssignmentKustoPoolPrincipalAssignmentsRestClient.Delete(message, cancellationToken);
                var operation = new SynapseArmOperation(_synapseClusterPrincipalAssignmentKustoPoolPrincipalAssignmentsClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<ArmOperation<SynapseClusterPrincipalAssignmentResource>> UpdateAsync(WaitUntil waitUntil, SynapseClusterPrincipalAssignmentData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                using var message = _synapseClusterPrincipalAssignmentKustoPoolPrincipalAssignmentsRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, data);
                var response = await _synapseClusterPrincipalAssignmentKustoPoolPrincipalAssignmentsRestClient.CreateOrUpdateAsync(message, cancellationToken).ConfigureAwait(false);
                var operation = new SynapseArmOperation<SynapseClusterPrincipalAssignmentResource>(new SynapseClusterPrincipalAssignmentOperationSource(Client), _synapseClusterPrincipalAssignmentKustoPoolPrincipalAssignmentsClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual ArmOperation<SynapseClusterPrincipalAssignmentResource> Update(WaitUntil waitUntil, SynapseClusterPrincipalAssignmentData data, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var message = _synapseClusterPrincipalAssignmentKustoPoolPrincipalAssignmentsRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, data);
                var response = _synapseClusterPrincipalAssignmentKustoPoolPrincipalAssignmentsRestClient.CreateOrUpdate(message, cancellationToken);
                var operation = new SynapseArmOperation<SynapseClusterPrincipalAssignmentResource>(new SynapseClusterPrincipalAssignmentOperationSource(Client), _synapseClusterPrincipalAssignmentKustoPoolPrincipalAssignmentsClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
