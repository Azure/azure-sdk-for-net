...
namespace Azure.ResourceManager.Synapse
{
    ...
    public partial class SynapseDataConnectionData : ResourceData
    {
        ...
        internal SynapseDataConnectionData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, AzureLocation? location, SynapseDataConnectionKind kind, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
            Location = location;
            Kind = kind;
