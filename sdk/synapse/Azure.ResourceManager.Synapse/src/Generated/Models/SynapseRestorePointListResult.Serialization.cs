...
namespace Azure.ResourceManager.Synapse.Models
{
    ...
    {
        internal static SynapseRestorePointListResult DeserializeSynapseRestorePointListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
