...
{
    public partial class SynapseWorkspaceData : IUtf8JsonSerializable, IJsonModel<SynapseWorkspaceData>, IPersistableModel<SynapseWorkspaceData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(DefaultDataLakeStorage))
            {
                ...
                AppendChildObject(builder, DefaultDataLakeStorage, options, 2);
            }
            ...
            if (Optional.IsDefined(ManagedVirtualNetworkSettings))
            {
                ...
                AppendChildObject(builder, ManagedVirtualNetworkSettings, options, 2);
            }

            if (Optional.IsDefined(WorkspaceRepositoryConfiguration))
            {
                builder.Append("  workspaceRepositoryConfiguration:");
                AppendChildObject(builder, WorkspaceRepositoryConfiguration, options, 2);
            }

            if (Optional.IsDefined(PurviewConfiguration))
            {
                builder.Append("  purviewConfiguration:");
                AppendChildObject(builder, PurviewConfiguration, options, 2);
            }
            ...
            if (Optional.IsDefined(CspWorkspaceAdminProperties))
            {
                ...
                AppendChildObject(builder, CspWorkspaceAdminProperties, options, 2);
            }
