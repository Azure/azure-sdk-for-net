...
namespace Azure.ResourceManager.Synapse.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SynapseIntegrationRuntimeOutboundNetworkDependenciesEndpoint>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<SynapseIntegrationRuntimeOutboundNetworkDependenciesEndpoint>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SynapseIntegrationRuntimeOutboundNetworkDependenciesEndpoint>)} interface");
            }
        ...
        string IPersistableModel<SynapseIntegrationRuntimeOutboundNetworkDependenciesEndpoint>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
