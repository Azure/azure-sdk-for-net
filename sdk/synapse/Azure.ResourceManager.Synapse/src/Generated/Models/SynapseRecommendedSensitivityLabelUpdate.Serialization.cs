...
namespace Azure.ResourceManager.Synapse.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SynapseRecommendedSensitivityLabelUpdate>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SynapseRecommendedSensitivityLabelUpdate>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SynapseRecommendedSensitivityLabelUpdate>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SynapseRecommendedSensitivityLabelUpdate>)} interface");
            }
        ...
        string IPersistableModel<SynapseRecommendedSensitivityLabelUpdate>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
