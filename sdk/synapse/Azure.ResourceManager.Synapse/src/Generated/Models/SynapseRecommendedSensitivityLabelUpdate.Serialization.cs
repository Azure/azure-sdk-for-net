...
{
    public partial class SynapseRecommendedSensitivityLabelUpdate : IUtf8JsonSerializable, IJsonModel<SynapseRecommendedSensitivityLabelUpdate>, IPersistableModel<SynapseRecommendedSensitivityLabelUpdate>
    {
        ...
        void IJsonModel<SynapseRecommendedSensitivityLabelUpdate>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SynapseRecommendedSensitivityLabelUpdate)} does not support '{format}' format.");
            }
