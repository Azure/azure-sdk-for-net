...
namespace Azure.ResourceManager.Synapse.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SynapseRecommendedSensitivityLabelUpdate>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        SynapseRecommendedSensitivityLabelUpdate IJsonModel<SynapseRecommendedSensitivityLabelUpdate>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
                throw new FormatException($"The model {nameof(SynapseRecommendedSensitivityLabelUpdate)} does not support '{options.Format}' format.");
            }
        ...
        BinaryData IModel<SynapseRecommendedSensitivityLabelUpdate>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        SynapseRecommendedSensitivityLabelUpdate IModel<SynapseRecommendedSensitivityLabelUpdate>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<SynapseRecommendedSensitivityLabelUpdate>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
