...
namespace Azure.ResourceManager.Synapse
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SynapseTransparentDataEncryptionData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SynapseTransparentDataEncryptionData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SynapseTransparentDataEncryptionData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<SynapseTransparentDataEncryptionData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
