...
{
    public partial class SynapseDynamicExecutorAllocation : IUtf8JsonSerializable, IJsonModel<SynapseDynamicExecutorAllocation>, IPersistableModel<SynapseDynamicExecutorAllocation>
    {
        ...
        void IJsonModel<SynapseDynamicExecutorAllocation>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SynapseDynamicExecutorAllocation)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(MinExecutors))
            {
                builder.Append("  minExecutors:");
                builder.AppendLine($" '{MinExecutors.Value.ToString()}'");
            }

            if (Optional.IsDefined(MaxExecutors))
            {
                builder.Append("  maxExecutors:");
                builder.AppendLine($" '{MaxExecutors.Value.ToString()}'");
            }
