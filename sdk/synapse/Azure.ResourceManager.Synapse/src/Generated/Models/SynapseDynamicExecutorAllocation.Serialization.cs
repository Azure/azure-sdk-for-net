...
namespace Azure.ResourceManager.Synapse.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SynapseDynamicExecutorAllocation>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SynapseDynamicExecutorAllocation>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SynapseDynamicExecutorAllocation>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SynapseDynamicExecutorAllocation>)} interface");
            }
        ...
        string IPersistableModel<SynapseDynamicExecutorAllocation>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
