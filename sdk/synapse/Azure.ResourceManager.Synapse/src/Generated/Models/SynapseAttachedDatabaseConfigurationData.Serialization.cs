...
namespace Azure.ResourceManager.Synapse
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SynapseAttachedDatabaseConfigurationData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SynapseAttachedDatabaseConfigurationData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SynapseAttachedDatabaseConfigurationData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SynapseAttachedDatabaseConfigurationData>)} interface");
            }
        ...
        string IPersistableModel<SynapseAttachedDatabaseConfigurationData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
