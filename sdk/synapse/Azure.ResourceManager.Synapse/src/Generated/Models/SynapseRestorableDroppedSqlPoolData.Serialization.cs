...
namespace Azure.ResourceManager.Synapse
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SynapseRestorableDroppedSqlPoolData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SynapseRestorableDroppedSqlPoolData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SynapseRestorableDroppedSqlPoolData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SynapseRestorableDroppedSqlPoolData>)} interface");
            }
        ...
        string IPersistableModel<SynapseRestorableDroppedSqlPoolData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
