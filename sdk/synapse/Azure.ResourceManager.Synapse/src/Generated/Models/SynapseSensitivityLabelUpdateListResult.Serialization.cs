...
namespace Azure.ResourceManager.Synapse.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SynapseSensitivityLabelUpdateListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SynapseSensitivityLabelUpdateListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SynapseSensitivityLabelUpdateListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SynapseSensitivityLabelUpdateListResult>)} interface");
            }
        ...
        string IPersistableModel<SynapseSensitivityLabelUpdateListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
