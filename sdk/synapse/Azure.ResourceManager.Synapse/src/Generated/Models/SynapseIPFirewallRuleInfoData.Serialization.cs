...
namespace Azure.ResourceManager.Synapse
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SynapseIPFirewallRuleInfoData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SynapseIPFirewallRuleInfoData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SynapseIPFirewallRuleInfoData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SynapseIPFirewallRuleInfoData>)} interface");
            }
        ...
        string IPersistableModel<SynapseIPFirewallRuleInfoData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
