...
namespace Azure.ResourceManager.Synapse.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SynapseTableLevelSharingProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SynapseTableLevelSharingProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SynapseTableLevelSharingProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SynapseTableLevelSharingProperties>)} interface");
            }
        ...
        string IPersistableModel<SynapseTableLevelSharingProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
