...
namespace Azure.ResourceManager.Synapse.Models
{
    ...
    public partial class SynapseEnvironmentVariableSetup : SynapseCustomSetupBase
    {
        ...
        internal SynapseEnvironmentVariableSetup(string customSetupBaseType, string variableName, string variableValue, Dictionary<string, BinaryData> rawData) : base(customSetupBaseType, rawData)
        {
            VariableName = variableName;
            VariableValue = variableValue;
