...
namespace Azure.ResourceManager.Synapse.Models
{
    ...
    internal partial class SqlPoolSchemaListResult
    {
        ...
        {
            Value = new ChangeTrackingList<SqlPoolSchemaData>();
        }

        /// <summary> Initializes a new instance of SqlPoolSchemaListResult. </summary>
        /// <param name="value"> Array of results. </param>
        /// <param name="nextLink"> Link to retrieve next page of results. </param>
        internal SqlPoolSchemaListResult(IReadOnlyList<SqlPoolSchemaData> value, string nextLink)
        {
            Value = value;
            NextLink = nextLink;
        }
        ...
        public IReadOnlyList<SqlPoolSchemaData> Value { get; }
