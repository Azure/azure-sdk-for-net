...
namespace Azure.ResourceManager.Synapse
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SynapseWorkspaceAadAdminInfoData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SynapseWorkspaceAadAdminInfoData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SynapseWorkspaceAadAdminInfoData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SynapseWorkspaceAadAdminInfoData>)} interface");
            }
        ...
        string IPersistableModel<SynapseWorkspaceAadAdminInfoData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
