...
{
    public partial class SynapseWorkspaceAadAdminInfoData : IUtf8JsonSerializable, IJsonModel<SynapseWorkspaceAadAdminInfoData>, IPersistableModel<SynapseWorkspaceAadAdminInfoData>
    {
        ...
        void IJsonModel<SynapseWorkspaceAadAdminInfoData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SynapseWorkspaceAadAdminInfoData)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(AdministratorType))
            {
                ...
                builder.AppendLine($" '{AdministratorType}'");
            }
