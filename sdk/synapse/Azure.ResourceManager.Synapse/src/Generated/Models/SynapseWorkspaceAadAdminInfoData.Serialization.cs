...
namespace Azure.ResourceManager.Synapse
{
    public partial class SynapseWorkspaceAadAdminInfoData : IUtf8JsonSerializable, IJsonModel<SynapseWorkspaceAadAdminInfoData>
    {
        ...
        void IJsonModel<SynapseWorkspaceAadAdminInfoData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(SynapseWorkspaceAadAdminInfoData)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<SynapseWorkspaceAadAdminInfoData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(SynapseWorkspaceAadAdminInfoData)} does not support '{options.Format}' format.");
            }
        }
