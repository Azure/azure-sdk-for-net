...
namespace Azure.ResourceManager.Synapse
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SynapseWorkspaceAadAdminInfoData>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        SynapseWorkspaceAadAdminInfoData IJsonModel<SynapseWorkspaceAadAdminInfoData>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
                throw new FormatException($"The model {nameof(SynapseWorkspaceAadAdminInfoData)} does not support '{options.Format}' format.");
            }
        ...
        BinaryData IModel<SynapseWorkspaceAadAdminInfoData>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        SynapseWorkspaceAadAdminInfoData IModel<SynapseWorkspaceAadAdminInfoData>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<SynapseWorkspaceAadAdminInfoData>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
