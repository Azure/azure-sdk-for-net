...
namespace Azure.ResourceManager.Synapse.Models
{
    ...
    internal partial class BigDataPoolLibraryListResult
    {
        ...
        internal BigDataPoolLibraryListResult(IReadOnlyList<SynapseLibraryData> value, string nextLink, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Value = value;
            NextLink = nextLink;
        ...
        /// <summary> Initializes a new instance of <see cref="BigDataPoolLibraryListResult"/> for deserialization. </summary>
        internal BigDataPoolLibraryListResult()
        {
        }
