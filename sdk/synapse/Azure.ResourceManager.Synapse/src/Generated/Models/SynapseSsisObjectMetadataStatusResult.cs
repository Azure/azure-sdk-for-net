...
namespace Azure.ResourceManager.Synapse.Models
{
    ...
    public partial class SynapseSsisObjectMetadataStatusResult
    {
        ...
        internal SynapseSsisObjectMetadataStatusResult(string status, string name, string properties, string error, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Status = status;
            Name = name;
