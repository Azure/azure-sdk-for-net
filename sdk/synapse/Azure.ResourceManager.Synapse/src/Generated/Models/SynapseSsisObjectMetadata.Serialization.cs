...
namespace Azure.ResourceManager.Synapse.Models
{
    ...
    {
        internal static SynapseSsisObjectMetadata DeserializeSynapseSsisObjectMetadata(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
