...
namespace Azure.ResourceManager.Synapse.Models
{
    ...
    public partial class SqlPoolUsage
    {
        ...
        internal SqlPoolUsage(string name, string resourceName, string displayName, double? currentValue, double? limit, string unit, DateTimeOffset? nextResetOn, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
