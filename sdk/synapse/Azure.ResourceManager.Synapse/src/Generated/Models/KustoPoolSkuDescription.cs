...
namespace Azure.ResourceManager.Synapse.Models
{
    ...
    public partial class KustoPoolSkuDescription
    {
        ...
        internal KustoPoolSkuDescription(string resourceType, string name, string size, IReadOnlyList<AzureLocation> locations, IReadOnlyList<KustoPoolSkuLocationInfoItem> locationInfo, IReadOnlyList<BinaryData> restrictions, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
