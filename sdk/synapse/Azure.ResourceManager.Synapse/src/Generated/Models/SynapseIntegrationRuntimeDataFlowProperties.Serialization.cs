...
namespace Azure.ResourceManager.Synapse.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SynapseIntegrationRuntimeDataFlowProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SynapseIntegrationRuntimeDataFlowProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SynapseIntegrationRuntimeDataFlowProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SynapseIntegrationRuntimeDataFlowProperties>)} interface");
            }
        ...
        string IPersistableModel<SynapseIntegrationRuntimeDataFlowProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
