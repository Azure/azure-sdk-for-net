...
{
    public partial class SynapseIntegrationRuntimeDataFlowProperties : IUtf8JsonSerializable, IJsonModel<SynapseIntegrationRuntimeDataFlowProperties>, IPersistableModel<SynapseIntegrationRuntimeDataFlowProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(TimeToLive))
            {
                ...
                builder.AppendLine($" '{TimeToLive.Value.ToString()}'");
            }
