...
namespace Azure.ResourceManager.Synapse.Models
{
    ...
    public partial class SynapseIntegrationRuntimeMonitoringResult
    {
        ...
        internal SynapseIntegrationRuntimeMonitoringResult(string name, IReadOnlyList<SynapseIntegrationRuntimeNodeMonitoringResult> nodes, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Nodes = nodes;
