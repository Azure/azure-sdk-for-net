...
namespace Azure.ResourceManager.Synapse.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SynapseRestorableDroppedSqlPoolListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SynapseRestorableDroppedSqlPoolListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SynapseRestorableDroppedSqlPoolListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SynapseRestorableDroppedSqlPoolListResult>)} interface");
            }
        ...
        string IPersistableModel<SynapseRestorableDroppedSqlPoolListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
