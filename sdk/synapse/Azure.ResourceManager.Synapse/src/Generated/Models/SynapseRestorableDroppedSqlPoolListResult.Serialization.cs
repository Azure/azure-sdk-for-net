...
namespace Azure.ResourceManager.Synapse.Models
{
    internal partial class SynapseRestorableDroppedSqlPoolListResult : IUtf8JsonSerializable, IModelJsonSerializable<SynapseRestorableDroppedSqlPoolListResult>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<SynapseRestorableDroppedSqlPoolListResult>(this, options.Format);
            ...
            foreach (var item in Value)
            {
                ...
                {
                    ((IModelJsonSerializable<SynapseRestorableDroppedSqlPoolData>)item).Serialize(writer, options);
                }
            }
        ...
        /// <summary> Converts a <see cref="SynapseRestorableDroppedSqlPoolListResult"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="SynapseRestorableDroppedSqlPoolListResult"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="SynapseRestorableDroppedSqlPoolListResult"/>. </summary>
