...
namespace Azure.ResourceManager.Synapse.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SynapseRecommendedSensitivityLabelUpdateOperationListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<SynapseRecommendedSensitivityLabelUpdateOperationListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SynapseRecommendedSensitivityLabelUpdateOperationListResult>)} interface");
            }
        ...
        string IPersistableModel<SynapseRecommendedSensitivityLabelUpdateOperationListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
