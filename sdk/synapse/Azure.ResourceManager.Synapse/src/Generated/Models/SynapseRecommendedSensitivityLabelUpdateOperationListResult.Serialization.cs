...
namespace Azure.ResourceManager.Synapse.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SynapseRecommendedSensitivityLabelUpdateOperationListResult>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        SynapseRecommendedSensitivityLabelUpdateOperationListResult IJsonModel<SynapseRecommendedSensitivityLabelUpdateOperationListResult>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
                throw new FormatException($"The model {nameof(SynapseRecommendedSensitivityLabelUpdateOperationListResult)} does not support '{options.Format}' format.");
            }
        ...
        BinaryData IModel<SynapseRecommendedSensitivityLabelUpdateOperationListResult>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        SynapseRecommendedSensitivityLabelUpdateOperationListResult IModel<SynapseRecommendedSensitivityLabelUpdateOperationListResult>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<SynapseRecommendedSensitivityLabelUpdateOperationListResult>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
