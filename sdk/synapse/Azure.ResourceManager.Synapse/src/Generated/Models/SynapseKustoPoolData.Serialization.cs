...
namespace Azure.ResourceManager.Synapse
{
    public partial class SynapseKustoPoolData : IUtf8JsonSerializable, IModelJsonSerializable<SynapseKustoPoolData>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<SynapseKustoPoolData>(this, options.Format);
            ...
            if (Optional.IsDefined(OptimizedAutoscale))
            {
                ...
                {
                    ((IModelJsonSerializable<SynapseOptimizedAutoscale>)OptimizedAutoscale).Serialize(writer, options);
                }
            }
        ...
        /// <summary> Converts a <see cref="SynapseKustoPoolData"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="SynapseKustoPoolData"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="SynapseKustoPoolData"/>. </summary>
