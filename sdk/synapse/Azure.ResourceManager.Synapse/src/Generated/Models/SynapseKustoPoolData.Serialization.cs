...
namespace Azure.ResourceManager.Synapse
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SynapseKustoPoolData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SynapseKustoPoolData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SynapseKustoPoolData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SynapseKustoPoolData>)} interface");
            }
        ...
        string IPersistableModel<SynapseKustoPoolData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
