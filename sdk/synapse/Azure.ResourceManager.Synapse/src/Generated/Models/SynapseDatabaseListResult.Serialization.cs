...
namespace Azure.ResourceManager.Synapse.Models
{
    ...
    {
        internal static SynapseDatabaseListResult DeserializeSynapseDatabaseListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
