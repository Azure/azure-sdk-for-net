...
{
    internal partial class SynapseDatabaseListResult : IUtf8JsonSerializable, IJsonModel<SynapseDatabaseListResult>, IPersistableModel<SynapseDatabaseListResult>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SynapseDatabaseListResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<SynapseDatabaseListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SynapseDatabaseListResult)} does not support '{format}' format.");
            }
