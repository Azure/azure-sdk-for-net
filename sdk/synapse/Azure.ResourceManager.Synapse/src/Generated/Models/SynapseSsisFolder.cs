...
namespace Azure.ResourceManager.Synapse.Models
{
    ...
    public partial class SynapseSsisFolder : SynapseSsisObjectMetadata
    {
        ...
        internal SynapseSsisFolder(SynapseSsisObjectMetadataType metadataType, long? id, string name, string description, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(metadataType, id, name, description, serializedAdditionalRawData)
        {
