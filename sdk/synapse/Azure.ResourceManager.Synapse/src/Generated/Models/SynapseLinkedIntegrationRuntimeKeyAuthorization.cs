...
namespace Azure.ResourceManager.Synapse.Models
{
    ...
    public partial class SynapseLinkedIntegrationRuntimeKeyAuthorization : SynapseLinkedIntegrationRuntimeType
    {
        ...
        internal SynapseLinkedIntegrationRuntimeKeyAuthorization(string authorizationType, SynapseSecureString key, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(authorizationType, serializedAdditionalRawData)
        {
            Key = key;
