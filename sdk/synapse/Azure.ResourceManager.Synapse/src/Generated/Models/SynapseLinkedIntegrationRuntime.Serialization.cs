...
namespace Azure.ResourceManager.Synapse.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SynapseLinkedIntegrationRuntime>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SynapseLinkedIntegrationRuntime>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SynapseLinkedIntegrationRuntime>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SynapseLinkedIntegrationRuntime>)} interface");
            }
        ...
        string IPersistableModel<SynapseLinkedIntegrationRuntime>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
