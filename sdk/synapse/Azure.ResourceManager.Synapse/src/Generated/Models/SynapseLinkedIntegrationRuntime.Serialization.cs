...
{
    public partial class SynapseLinkedIntegrationRuntime : IUtf8JsonSerializable, IJsonModel<SynapseLinkedIntegrationRuntime>, IPersistableModel<SynapseLinkedIntegrationRuntime>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(DataFactoryLocation))
            {
                ...
                builder.AppendLine($" '{DataFactoryLocation}'");
            }
