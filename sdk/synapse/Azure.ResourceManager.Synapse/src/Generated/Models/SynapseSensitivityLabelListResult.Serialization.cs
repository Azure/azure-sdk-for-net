...
namespace Azure.ResourceManager.Synapse.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SynapseSensitivityLabelListResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SynapseSensitivityLabelListResult)} does not support writing '{format}' format.");
            }
            ...
            if (options.Format != "W" && Optional.IsCollectionDefined(Value))
            {
                ...
                {
                    ((IJsonModel<SynapseSensitivityLabelData>)item).Write(writer, options);
                }
        ...
        SynapseSensitivityLabelListResult IJsonModel<SynapseSensitivityLabelListResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SynapseSensitivityLabelListResult)} does not support reading '{format}' format.");
            }
        ...
        internal static SynapseSensitivityLabelListResult DeserializeSynapseSensitivityLabelListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            IReadOnlyList<SynapseSensitivityLabelData> value = default;
            ...
            return new SynapseSensitivityLabelListResult(value ?? new ChangeTrackingList<SynapseSensitivityLabelData>(), nextLink, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<SynapseSensitivityLabelListResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SynapseSensitivityLabelListResult)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        SynapseSensitivityLabelListResult IPersistableModel<SynapseSensitivityLabelListResult>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SynapseSensitivityLabelListResult)} does not support reading '{options.Format}' format.");
            }
        }
