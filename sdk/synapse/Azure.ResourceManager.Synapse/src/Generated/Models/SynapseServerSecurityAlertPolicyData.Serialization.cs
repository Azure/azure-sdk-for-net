...
namespace Azure.ResourceManager.Synapse
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SynapseServerSecurityAlertPolicyData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SynapseServerSecurityAlertPolicyData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SynapseServerSecurityAlertPolicyData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<SynapseServerSecurityAlertPolicyData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
