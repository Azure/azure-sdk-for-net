...
namespace Azure.ResourceManager.Synapse
{
    public partial class SynapseServerSecurityAlertPolicyData : IUtf8JsonSerializable, IJsonModel<SynapseServerSecurityAlertPolicyData>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<SynapseServerSecurityAlertPolicyData>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SynapseServerSecurityAlertPolicyData>)} interface");
            }
