...
namespace Azure.ResourceManager.Synapse
{
    public partial class SynapseServerSecurityAlertPolicyData : IUtf8JsonSerializable, IJsonModel<SynapseServerSecurityAlertPolicyData>
    {
        ...
        void IJsonModel<SynapseServerSecurityAlertPolicyData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(SynapseServerSecurityAlertPolicyData)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<SynapseServerSecurityAlertPolicyData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(SynapseServerSecurityAlertPolicyData)} does not support '{options.Format}' format.");
            }
        }
