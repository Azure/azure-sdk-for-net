...
namespace Azure.ResourceManager.Synapse.Models
{
    ...
    public partial class SynapseComponentSetup : SynapseCustomSetupBase
    {
        ...
        internal SynapseComponentSetup(string customSetupBaseType, string componentName, SynapseSecretBase licenseKey, Dictionary<string, BinaryData> rawData) : base(customSetupBaseType, rawData)
        {
            ComponentName = componentName;
