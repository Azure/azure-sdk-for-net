...
namespace Azure.ResourceManager.Synapse.Models
{
    public partial class SynapseReadOnlyFollowingDatabase : IUtf8JsonSerializable, IModelJsonSerializable<SynapseReadOnlyFollowingDatabase>
    {
        ...
        {
            ModelSerializerHelper.ValidateFormat<SynapseReadOnlyFollowingDatabase>(this, options.Format);
        ...
        internal static SynapseReadOnlyFollowingDatabase DeserializeSynapseReadOnlyFollowingDatabase(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new SynapseReadOnlyFollowingDatabase(id, name, type, systemData.Value, Optional.ToNullable(location), kind, Optional.ToNullable(provisioningState), Optional.ToNullable(softDeletePeriod), Optional.ToNullable(hotCachePeriod), statistics.Value, leaderClusterResourceId.Value, attachedDatabaseConfigurationName.Value, Optional.ToNullable(principalsModificationKind), rawData);
        }
