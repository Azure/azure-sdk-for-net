...
{
    public partial class SparkConfigurationResourceData : IUtf8JsonSerializable
    {
        ...
        internal static SparkConfigurationResourceData DeserializeSparkConfigurationResourceData(JsonElement element)
        {
            ...
            return new SparkConfigurationResourceData(id, name, type, systemData.Value, description.Value, configs, Optional.ToList(annotations), notes.Value, createdBy.Value, Optional.ToNullable(created), Optional.ToDictionary(configMergeRule), Optional.ToNullable(etag));
        }
    }
}
