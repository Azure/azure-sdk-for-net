...
namespace Azure.ResourceManager.Synapse.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SynapseManagedIntegrationRuntimeStatus>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SynapseManagedIntegrationRuntimeStatus>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SynapseManagedIntegrationRuntimeStatus>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SynapseManagedIntegrationRuntimeStatus>)} interface");
            }
        ...
        string IPersistableModel<SynapseManagedIntegrationRuntimeStatus>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
