...
namespace Azure.ResourceManager.Synapse.Models
{
    ...
    public partial class SynapseServerUsage
    {
        ...
        internal SynapseServerUsage(string name, string resourceName, string displayName, double? currentValue, double? limit, string unit, DateTimeOffset? nextResetOn, Dictionary<string, BinaryData> rawData)
        {
            Name = name;
