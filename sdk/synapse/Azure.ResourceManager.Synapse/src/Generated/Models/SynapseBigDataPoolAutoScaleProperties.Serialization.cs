...
{
    public partial class SynapseBigDataPoolAutoScaleProperties : IUtf8JsonSerializable
    {
        ...
        internal static SynapseBigDataPoolAutoScaleProperties DeserializeSynapseBigDataPoolAutoScaleProperties(JsonElement element)
        {
            ...
            return new SynapseBigDataPoolAutoScaleProperties(Optional.ToNullable(minNodeCount), Optional.ToNullable(enabled), Optional.ToNullable(maxNodeCount));
        }
    }
}
