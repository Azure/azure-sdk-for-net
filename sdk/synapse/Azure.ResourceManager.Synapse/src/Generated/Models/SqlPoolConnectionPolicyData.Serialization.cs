...
{
    public partial class SqlPoolConnectionPolicyData : IUtf8JsonSerializable
    {
        ...
        internal static SqlPoolConnectionPolicyData DeserializeSqlPoolConnectionPolicyData(JsonElement element)
        {
            ...
            return new SqlPoolConnectionPolicyData(id, name, type, systemData.Value, kind.Value, Optional.ToNullable(location), securityEnabledAccess.Value, proxyDnsName.Value, proxyPort.Value, visibility.Value, useServerDefault.Value, redirectionState.Value, state.Value);
        }
    }
}
