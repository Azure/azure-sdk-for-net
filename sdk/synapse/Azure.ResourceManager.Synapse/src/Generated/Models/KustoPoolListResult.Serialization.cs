...
namespace Azure.ResourceManager.Synapse.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<KustoPoolListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<KustoPoolListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<KustoPoolListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<KustoPoolListResult>)} interface");
            }
        ...
        string IPersistableModel<KustoPoolListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
