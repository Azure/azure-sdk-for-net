...
{
    public partial class SynapseIntegrationRuntimeCustomSetupScriptProperties : IUtf8JsonSerializable, IJsonModel<SynapseIntegrationRuntimeCustomSetupScriptProperties>, IPersistableModel<SynapseIntegrationRuntimeCustomSetupScriptProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SasToken))
            {
                ...
                AppendChildObject(builder, SasToken, options, 2);
            }
