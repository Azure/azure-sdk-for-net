...
namespace Azure.ResourceManager.Synapse.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SynapseKustoPoolPrivateLinkList>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SynapseKustoPoolPrivateLinkList)} does not support writing '{format}' format.");
            }
            ...
            if (Optional.IsCollectionDefined(Value))
            {
                ...
                {
                    ((IJsonModel<SynapseKustoPoolPrivateLinkData>)item).Write(writer, options);
                }
        ...
        SynapseKustoPoolPrivateLinkList IJsonModel<SynapseKustoPoolPrivateLinkList>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SynapseKustoPoolPrivateLinkList)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<SynapseKustoPoolPrivateLinkList>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SynapseKustoPoolPrivateLinkList)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        SynapseKustoPoolPrivateLinkList IPersistableModel<SynapseKustoPoolPrivateLinkList>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SynapseKustoPoolPrivateLinkList)} does not support reading '{options.Format}' format.");
            }
        }
