...
namespace Azure.ResourceManager.Synapse.Models
{
    ...
    internal partial class UnknownSsisObjectMetadata : SynapseSsisObjectMetadata
    {
        ...
        internal UnknownSsisObjectMetadata(SynapseSsisObjectMetadataType metadataType, long? id, string name, string description, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(metadataType, id, name, description, serializedAdditionalRawData)
        {
