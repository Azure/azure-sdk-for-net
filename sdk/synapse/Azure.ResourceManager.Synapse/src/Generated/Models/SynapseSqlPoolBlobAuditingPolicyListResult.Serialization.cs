...
namespace Azure.ResourceManager.Synapse.Models
{
    internal partial class SynapseSqlPoolBlobAuditingPolicyListResult : IUtf8JsonSerializable, IJsonModel<SynapseSqlPoolBlobAuditingPolicyListResult>
    {
        ...
        void IJsonModel<SynapseSqlPoolBlobAuditingPolicyListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(SynapseSqlPoolBlobAuditingPolicyListResult)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<SynapseSqlPoolBlobAuditingPolicyListResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(SynapseSqlPoolBlobAuditingPolicyListResult)} does not support '{options.Format}' format.");
            }
        }
