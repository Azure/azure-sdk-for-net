...
namespace Azure.ResourceManager.Synapse.Models
{
    internal partial class SynapseSqlPoolBlobAuditingPolicyListResult
    {
        internal static SynapseSqlPoolBlobAuditingPolicyListResult DeserializeSynapseSqlPoolBlobAuditingPolicyListResult(JsonElement element)
        {
            ...
            Core.Optional<IReadOnlyList<SynapseSqlPoolBlobAuditingPolicyData>> value = default;
            ...
            return new SynapseSqlPoolBlobAuditingPolicyListResult(Core.Optional.ToList(value), nextLink.Value);
        }
    }
}
