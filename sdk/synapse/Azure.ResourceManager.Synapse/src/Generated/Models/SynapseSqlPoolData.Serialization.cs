...
{
    public partial class SynapseSqlPoolData : IUtf8JsonSerializable, IModelJsonSerializable<SynapseSqlPoolData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IModelJsonSerializable<SynapseSqlPoolData>)this).Serialize(writer, ModelSerializerOptions.DefaultWireOptions);

        void IModelJsonSerializable<SynapseSqlPoolData>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<SynapseSqlPoolData>(this, options.Format);
        ...
        internal static SynapseSqlPoolData DeserializeSynapseSqlPoolData(JsonElement element, ModelSerializerOptions options = default)
        {
        ...
        SynapseSqlPoolData IModelJsonSerializable<SynapseSqlPoolData>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<SynapseSqlPoolData>(this, options.Format);

            using var doc = JsonDocument.ParseValue(ref reader);
            return DeserializeSynapseSqlPoolData(doc.RootElement, options);
        }

        BinaryData IModelSerializable<SynapseSqlPoolData>.Serialize(ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<SynapseSqlPoolData>(this, options.Format);
        ...
        SynapseSqlPoolData IModelSerializable<SynapseSqlPoolData>.Deserialize(BinaryData data, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<SynapseSqlPoolData>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="SynapseSqlPoolData"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="SynapseSqlPoolData"/> to convert. </param>
        public static implicit operator RequestContent(SynapseSqlPoolData model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="SynapseSqlPoolData"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator SynapseSqlPoolData(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeSynapseSqlPoolData(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
