...
{
    public partial class BigDataPoolAutoScaleProperties : IUtf8JsonSerializable, IJsonModel<BigDataPoolAutoScaleProperties>, IPersistableModel<BigDataPoolAutoScaleProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(MinNodeCount))
            {
                ...
                builder.AppendLine($" '{MinNodeCount.Value.ToString()}'");
            }
            ...
            if (Optional.IsDefined(MaxNodeCount))
            {
                ...
                builder.AppendLine($" '{MaxNodeCount.Value.ToString()}'");
            }
