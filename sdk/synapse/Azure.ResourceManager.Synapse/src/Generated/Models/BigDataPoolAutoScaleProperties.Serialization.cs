...
namespace Azure.ResourceManager.Synapse.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BigDataPoolAutoScaleProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<BigDataPoolAutoScaleProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BigDataPoolAutoScaleProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<BigDataPoolAutoScaleProperties>)} interface");
            }
        ...
        string IPersistableModel<BigDataPoolAutoScaleProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
