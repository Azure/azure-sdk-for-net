...
{
    public partial class SynapseIntegrationRuntimeSsisCatalogInfo : IUtf8JsonSerializable, IJsonModel<SynapseIntegrationRuntimeSsisCatalogInfo>, IPersistableModel<SynapseIntegrationRuntimeSsisCatalogInfo>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(CatalogServerEndpoint))
            {
                ...
                builder.AppendLine($" '{CatalogServerEndpoint.AbsoluteUri}'");
            }
            ...
            if (Optional.IsDefined(CatalogAdminPassword))
            {
                ...
                AppendChildObject(builder, CatalogAdminPassword, options, 2);
            }

            if (Optional.IsDefined(CatalogPricingTier))
            {
                builder.Append("  catalogPricingTier:");
                builder.AppendLine($" '{CatalogPricingTier.ToString()}'");
            }
