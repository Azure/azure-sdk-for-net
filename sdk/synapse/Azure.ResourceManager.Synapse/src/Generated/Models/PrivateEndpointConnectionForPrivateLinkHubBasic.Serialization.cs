...
namespace Azure.ResourceManager.Synapse.Models
{
    public partial class PrivateEndpointConnectionForPrivateLinkHubBasic : IUtf8JsonSerializable, IJsonModel<PrivateEndpointConnectionForPrivateLinkHubBasic>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<PrivateEndpointConnectionForPrivateLinkHubBasic>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<PrivateEndpointConnectionForPrivateLinkHubBasic>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
