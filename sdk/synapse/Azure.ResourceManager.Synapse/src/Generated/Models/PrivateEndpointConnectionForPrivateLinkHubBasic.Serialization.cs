...
namespace Azure.ResourceManager.Synapse.Models
{
    public partial class PrivateEndpointConnectionForPrivateLinkHubBasic : IUtf8JsonSerializable, IJsonModel<PrivateEndpointConnectionForPrivateLinkHubBasic>
    {
        ...
        void IJsonModel<PrivateEndpointConnectionForPrivateLinkHubBasic>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(PrivateEndpointConnectionForPrivateLinkHubBasic)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<PrivateEndpointConnectionForPrivateLinkHubBasic>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(PrivateEndpointConnectionForPrivateLinkHubBasic)} does not support '{options.Format}' format.");
            }
        }
