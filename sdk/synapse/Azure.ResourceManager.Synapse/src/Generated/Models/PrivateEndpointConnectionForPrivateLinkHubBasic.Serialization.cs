...
namespace Azure.ResourceManager.Synapse.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PrivateEndpointConnectionForPrivateLinkHubBasic>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        PrivateEndpointConnectionForPrivateLinkHubBasic IJsonModel<PrivateEndpointConnectionForPrivateLinkHubBasic>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<PrivateEndpointConnectionForPrivateLinkHubBasic>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        PrivateEndpointConnectionForPrivateLinkHubBasic IModel<PrivateEndpointConnectionForPrivateLinkHubBasic>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<PrivateEndpointConnectionForPrivateLinkHubBasic>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
