...
namespace Azure.ResourceManager.Synapse.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SynapseManagedIntegrationRuntimeOperationResult>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<SynapseManagedIntegrationRuntimeOperationResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SynapseManagedIntegrationRuntimeOperationResult>)} interface");
            }
        ...
        string IPersistableModel<SynapseManagedIntegrationRuntimeOperationResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
