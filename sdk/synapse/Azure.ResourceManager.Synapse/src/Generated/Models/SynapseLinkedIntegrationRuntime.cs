...
namespace Azure.ResourceManager.Synapse.Models
{
    ...
    public partial class SynapseLinkedIntegrationRuntime
    {
        ...
        internal SynapseLinkedIntegrationRuntime(string name, string subscriptionId, string dataFactoryName, string dataFactoryLocation, DateTimeOffset? createOn, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
