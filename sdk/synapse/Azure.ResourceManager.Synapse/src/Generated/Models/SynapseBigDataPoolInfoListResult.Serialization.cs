...
namespace Azure.ResourceManager.Synapse.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SynapseBigDataPoolInfoListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SynapseBigDataPoolInfoListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SynapseBigDataPoolInfoListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SynapseBigDataPoolInfoListResult>)} interface");
            }
        ...
        string IPersistableModel<SynapseBigDataPoolInfoListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
