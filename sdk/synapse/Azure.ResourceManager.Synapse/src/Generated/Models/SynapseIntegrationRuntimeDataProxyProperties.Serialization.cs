...
{
    public partial class SynapseIntegrationRuntimeDataProxyProperties : IUtf8JsonSerializable, IJsonModel<SynapseIntegrationRuntimeDataProxyProperties>, IPersistableModel<SynapseIntegrationRuntimeDataProxyProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ConnectVia))
            {
                ...
                AppendChildObject(builder, ConnectVia, options, 2);
            }

            if (Optional.IsDefined(StagingLinkedService))
            {
                builder.Append("  stagingLinkedService:");
                AppendChildObject(builder, StagingLinkedService, options, 2);
            }
