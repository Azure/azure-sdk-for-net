...
{
    public partial class SynapseIotHubDataConnection : IUtf8JsonSerializable, IModelJsonSerializable<SynapseIotHubDataConnection>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IModelJsonSerializable<SynapseIotHubDataConnection>)this).Serialize(writer, ModelSerializerOptions.DefaultWireOptions);

        void IModelJsonSerializable<SynapseIotHubDataConnection>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<SynapseIotHubDataConnection>(this, options.Format);
        ...
        internal static SynapseIotHubDataConnection DeserializeSynapseIotHubDataConnection(JsonElement element, ModelSerializerOptions options = default)
        {
        ...
        SynapseIotHubDataConnection IModelJsonSerializable<SynapseIotHubDataConnection>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<SynapseIotHubDataConnection>(this, options.Format);

            using var doc = JsonDocument.ParseValue(ref reader);
            return DeserializeSynapseIotHubDataConnection(doc.RootElement, options);
        }

        BinaryData IModelSerializable<SynapseIotHubDataConnection>.Serialize(ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<SynapseIotHubDataConnection>(this, options.Format);
        ...
        SynapseIotHubDataConnection IModelSerializable<SynapseIotHubDataConnection>.Deserialize(BinaryData data, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<SynapseIotHubDataConnection>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="SynapseIotHubDataConnection"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="SynapseIotHubDataConnection"/> to convert. </param>
        public static implicit operator RequestContent(SynapseIotHubDataConnection model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="SynapseIotHubDataConnection"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator SynapseIotHubDataConnection(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeSynapseIotHubDataConnection(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
