...
namespace Azure.ResourceManager.Synapse.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SynapseIotHubDataConnection>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SynapseIotHubDataConnection>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SynapseIotHubDataConnection>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SynapseIotHubDataConnection>)} interface");
            }
        ...
        string IPersistableModel<SynapseIotHubDataConnection>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
