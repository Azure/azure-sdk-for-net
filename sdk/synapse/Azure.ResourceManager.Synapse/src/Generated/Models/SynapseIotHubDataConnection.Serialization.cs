...
namespace Azure.ResourceManager.Synapse.Models
{
    public partial class SynapseIotHubDataConnection : IUtf8JsonSerializable, IJsonModel<SynapseIotHubDataConnection>
    {
        ...
        void IJsonModel<SynapseIotHubDataConnection>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(SynapseIotHubDataConnection)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<SynapseIotHubDataConnection>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(SynapseIotHubDataConnection)} does not support '{options.Format}' format.");
            }
        }
