...
namespace Azure.ResourceManager.Synapse.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SynapseManagedIntegrationRuntimeError>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SynapseManagedIntegrationRuntimeError>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SynapseManagedIntegrationRuntimeError>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<SynapseManagedIntegrationRuntimeError>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
