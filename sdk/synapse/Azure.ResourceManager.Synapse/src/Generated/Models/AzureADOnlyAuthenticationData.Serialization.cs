...
{
    public partial class AzureADOnlyAuthenticationData : IUtf8JsonSerializable
    {
        ...
        internal static AzureADOnlyAuthenticationData DeserializeAzureADOnlyAuthenticationData(JsonElement element)
        {
            ...
            return new AzureADOnlyAuthenticationData(id, name, type, systemData.Value, Optional.ToNullable(azureADOnlyAuthentication), Optional.ToNullable(state), Optional.ToNullable(creationDate));
        }
    }
}
