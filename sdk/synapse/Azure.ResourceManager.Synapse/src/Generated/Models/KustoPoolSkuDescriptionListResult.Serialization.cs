...
namespace Azure.ResourceManager.Synapse.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<KustoPoolSkuDescriptionListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<KustoPoolSkuDescriptionListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<KustoPoolSkuDescriptionListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<KustoPoolSkuDescriptionListResult>)} interface");
            }
        ...
        string IPersistableModel<KustoPoolSkuDescriptionListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
