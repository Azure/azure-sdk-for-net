...
namespace Azure.ResourceManager.Synapse.Models
{
    public partial class SynapseSelfHostedIntegrationRuntimeNode
    {
        internal static SynapseSelfHostedIntegrationRuntimeNode DeserializeSynapseSelfHostedIntegrationRuntimeNode(JsonElement element)
        {
            ...
            Core.Optional<SynapseSelfHostedIntegrationRuntimeNodeStatus> status = default;
            ...
            Core.Optional<SynapseIntegrationRuntimeUpdateResult> lastUpdateResult = default;
            ...
            return new SynapseSelfHostedIntegrationRuntimeNode(nodeName.Value, machineName.Value, hostServiceUri.Value, Core.Optional.ToNullable(status), Core.Optional.ToDictionary(capabilities), versionStatus.Value, version.Value, Core.Optional.ToNullable(registerTime), Core.Optional.ToNullable(lastConnectTime), Core.Optional.ToNullable(expiryTime), Core.Optional.ToNullable(lastStartTime), Core.Optional.ToNullable(lastStopTime), Core.Optional.ToNullable(lastUpdateResult), Core.Optional.ToNullable(lastStartUpdateTime), Core.Optional.ToNullable(lastEndUpdateTime), Core.Optional.ToNullable(isActiveDispatcher), Core.Optional.ToNullable(concurrentJobsLimit), Core.Optional.ToNullable(maxConcurrentJobs), additionalProperties);
        }
    }
}
