...
namespace Azure.ResourceManager.Synapse.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SynapseSelfHostedIntegrationRuntimeNode>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SynapseSelfHostedIntegrationRuntimeNode>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SynapseSelfHostedIntegrationRuntimeNode>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SynapseSelfHostedIntegrationRuntimeNode>)} interface");
            }
        ...
        string IPersistableModel<SynapseSelfHostedIntegrationRuntimeNode>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
