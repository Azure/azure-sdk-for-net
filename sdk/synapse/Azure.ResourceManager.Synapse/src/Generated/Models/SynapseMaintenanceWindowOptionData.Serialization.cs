...
namespace Azure.ResourceManager.Synapse
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SynapseMaintenanceWindowOptionData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SynapseMaintenanceWindowOptionData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SynapseMaintenanceWindowOptionData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SynapseMaintenanceWindowOptionData>)} interface");
            }
        ...
        string IPersistableModel<SynapseMaintenanceWindowOptionData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
