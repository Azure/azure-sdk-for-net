...
{
    public partial class SynapseMaintenanceWindowOptionData : IUtf8JsonSerializable, IJsonModel<SynapseMaintenanceWindowOptionData>, IPersistableModel<SynapseMaintenanceWindowOptionData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(MinDurationInMinutes))
            {
                ...
                builder.AppendLine($" '{MinDurationInMinutes.Value.ToString()}'");
            }

            if (Optional.IsDefined(DefaultDurationInMinutes))
            {
                builder.Append("  defaultDurationInMinutes:");
                builder.AppendLine($" '{DefaultDurationInMinutes.Value.ToString()}'");
            }

            if (Optional.IsDefined(MinCycles))
            {
                builder.Append("  minCycles:");
                builder.AppendLine($" '{MinCycles.Value.ToString()}'");
            }

            if (Optional.IsDefined(TimeGranularityInMinutes))
            {
                builder.Append("  timeGranularityInMinutes:");
                builder.AppendLine($" '{TimeGranularityInMinutes.Value.ToString()}'");
            }
