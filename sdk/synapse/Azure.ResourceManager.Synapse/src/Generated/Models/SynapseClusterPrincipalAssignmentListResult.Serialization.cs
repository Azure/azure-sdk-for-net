...
namespace Azure.ResourceManager.Synapse.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SynapseClusterPrincipalAssignmentListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SynapseClusterPrincipalAssignmentListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SynapseClusterPrincipalAssignmentListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SynapseClusterPrincipalAssignmentListResult>)} interface");
            }
        ...
        string IPersistableModel<SynapseClusterPrincipalAssignmentListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
