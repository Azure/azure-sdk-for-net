...
namespace Azure.ResourceManager.Synapse.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SynapseReadWriteDatabase>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SynapseReadWriteDatabase>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SynapseReadWriteDatabase>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SynapseReadWriteDatabase>)} interface");
            }
        ...
        string IPersistableModel<SynapseReadWriteDatabase>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
