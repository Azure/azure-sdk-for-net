...
namespace Azure.ResourceManager.Synapse.Models
{
    public partial class SynapseReadWriteDatabase : IUtf8JsonSerializable, IModelJsonSerializable<SynapseReadWriteDatabase>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<SynapseReadWriteDatabase>(this, options.Format);
        ...
        internal static SynapseReadWriteDatabase DeserializeSynapseReadWriteDatabase(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new SynapseReadWriteDatabase(id, name, type, systemData.Value, Optional.ToNullable(location), kind, Optional.ToNullable(provisioningState), Optional.ToNullable(softDeletePeriod), Optional.ToNullable(hotCachePeriod), statistics.Value, Optional.ToNullable(isFollowed), serializedAdditionalRawData);
        }
        ...
        /// <summary> Converts a <see cref="SynapseReadWriteDatabase"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="SynapseReadWriteDatabase"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="SynapseReadWriteDatabase"/>. </summary>
