...
namespace Azure.ResourceManager.Synapse
{
    public partial class SynapseGeoBackupPolicyData : IUtf8JsonSerializable, IJsonModel<SynapseGeoBackupPolicyData>
    {
        ...
        void IJsonModel<SynapseGeoBackupPolicyData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(SynapseGeoBackupPolicyData)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<SynapseGeoBackupPolicyData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(SynapseGeoBackupPolicyData)} does not support '{options.Format}' format.");
            }
        }
