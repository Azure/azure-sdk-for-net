...
namespace Azure.ResourceManager.Synapse.Models
{
    ...
    public partial class SynapseSsisVariable
    {
        ...
        internal SynapseSsisVariable(long? id, string name, string description, string dataType, bool? isSensitive, string value, string sensitiveValue, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Name = name;
