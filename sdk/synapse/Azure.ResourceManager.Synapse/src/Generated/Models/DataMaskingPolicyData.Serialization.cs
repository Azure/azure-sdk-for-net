...
namespace Azure.ResourceManager.Synapse
{
    public partial class DataMaskingPolicyData : IUtf8JsonSerializable
    {
        ...
        internal static DataMaskingPolicyData DeserializeDataMaskingPolicyData(JsonElement element)
        {
            ...
            return new DataMaskingPolicyData(id, name, type, systemData.Value, Optional.ToNullable(location), kind.Value, managedBy.Value, Optional.ToNullable(dataMaskingState), exemptPrincipals.Value, applicationPrincipals.Value, maskingLevel.Value);
        }
    }
}
