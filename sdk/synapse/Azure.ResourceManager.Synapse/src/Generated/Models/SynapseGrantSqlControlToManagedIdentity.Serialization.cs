...
namespace Azure.ResourceManager.Synapse.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SynapseGrantSqlControlToManagedIdentity>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SynapseGrantSqlControlToManagedIdentity>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SynapseGrantSqlControlToManagedIdentity>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<SynapseGrantSqlControlToManagedIdentity>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
