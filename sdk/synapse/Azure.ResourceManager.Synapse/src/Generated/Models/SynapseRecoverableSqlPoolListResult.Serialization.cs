...
namespace Azure.ResourceManager.Synapse.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SynapseRecoverableSqlPoolListResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<SynapseRecoverableSqlPoolListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SynapseRecoverableSqlPoolListResult)} does not support '{format}' format.");
            }

            writer.WriteStartObject();
            if (options.Format != "W" && !(Value is ChangeTrackingList<SynapseRecoverableSqlPoolData> collection && collection.IsUndefined))
            {
        ...
        internal static SynapseRecoverableSqlPoolListResult DeserializeSynapseRecoverableSqlPoolListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new SynapseRecoverableSqlPoolListResult(value ?? new ChangeTrackingList<SynapseRecoverableSqlPoolData>(), nextLink.Value, serializedAdditionalRawData);
        }
