...
{
    public partial class SynapseSsisParameter : IUtf8JsonSerializable, IJsonModel<SynapseSsisParameter>, IPersistableModel<SynapseSsisParameter>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ValueSet))
            {
                ...
                var boolValue = ValueSet.Value == true ? "true" : "false";
                builder.AppendLine($" {boolValue}");
            }
