...
namespace Azure.ResourceManager.Synapse.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SynapseSsisParameter>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SynapseSsisParameter>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SynapseSsisParameter>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SynapseSsisParameter>)} interface");
            }
        ...
        string IPersistableModel<SynapseSsisParameter>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
