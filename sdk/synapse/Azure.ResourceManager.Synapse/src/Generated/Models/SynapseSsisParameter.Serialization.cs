...
namespace Azure.ResourceManager.Synapse.Models
{
    public partial class SynapseSsisParameter
    {
        internal static SynapseSsisParameter DeserializeSynapseSsisParameter(JsonElement element)
        {
            ...
            return new SynapseSsisParameter(Core.Optional.ToNullable(id), name.Value, description.Value, dataType.Value, Core.Optional.ToNullable(required), Core.Optional.ToNullable(sensitive), designDefaultValue.Value, defaultValue.Value, sensitiveDefaultValue.Value, valueType.Value, Core.Optional.ToNullable(valueSet), variable.Value);
        }
    }
}
