...
namespace Azure.ResourceManager.Synapse.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SynapseSsisParameter>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        SynapseSsisParameter IJsonModel<SynapseSsisParameter>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SynapseSsisParameter)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<SynapseSsisParameter>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SynapseSsisParameter)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        SynapseSsisParameter IPersistableModel<SynapseSsisParameter>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SynapseSsisParameter)} does not support reading '{options.Format}' format.");
            }
        }
