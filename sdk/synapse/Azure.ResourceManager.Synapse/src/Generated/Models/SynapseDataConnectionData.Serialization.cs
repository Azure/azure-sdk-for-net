...
namespace Azure.ResourceManager.Synapse
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SynapseDataConnectionData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SynapseDataConnectionData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SynapseDataConnectionData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SynapseDataConnectionData>)} interface");
            }
        ...
        string IPersistableModel<SynapseDataConnectionData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
