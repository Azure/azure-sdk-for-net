...
{
    public partial class PrivateLinkHubData : IUtf8JsonSerializable
    {
        ...
        internal static PrivateLinkHubData DeserializePrivateLinkHubData(JsonElement element)
        {
            ...
            return new PrivateLinkHubData(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, provisioningState.Value, Optional.ToList(privateEndpointConnections));
        }
    }
}
