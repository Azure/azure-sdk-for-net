...
namespace Azure.ResourceManager.Synapse.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BigDataPoolLibraryRequirements>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<BigDataPoolLibraryRequirements>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BigDataPoolLibraryRequirements>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<BigDataPoolLibraryRequirements>)} interface");
            }
        ...
        string IPersistableModel<BigDataPoolLibraryRequirements>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
