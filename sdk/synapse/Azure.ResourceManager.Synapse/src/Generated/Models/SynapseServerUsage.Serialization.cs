...
namespace Azure.ResourceManager.Synapse.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SynapseServerUsage>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SynapseServerUsage>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SynapseServerUsage>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SynapseServerUsage>)} interface");
            }
        ...
        string IPersistableModel<SynapseServerUsage>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
