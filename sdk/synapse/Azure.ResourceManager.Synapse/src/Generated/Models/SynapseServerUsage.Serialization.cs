...
namespace Azure.ResourceManager.Synapse.Models
{
    public partial class SynapseServerUsage
    {
        internal static SynapseServerUsage DeserializeSynapseServerUsage(JsonElement element)
        {
            ...
            return new SynapseServerUsage(name.Value, resourceName.Value, displayName.Value, Core.Optional.ToNullable(currentValue), Core.Optional.ToNullable(limit), unit.Value, Core.Optional.ToNullable(nextResetTime));
        }
    }
}
