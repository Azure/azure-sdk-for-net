...
{
    public partial class LibraryResourceData : IUtf8JsonSerializable
    {
        ...
        internal static LibraryResourceData DeserializeLibraryResourceData(JsonElement element)
        {
            ...
            return new LibraryResourceData(id, name, type, systemData.Value, name0.Value, path.Value, containerName.Value, Optional.ToNullable(uploadedTimestamp), type0.Value, provisioningStatus.Value, creatorId.Value, Optional.ToNullable(etag));
        }
    }
}
