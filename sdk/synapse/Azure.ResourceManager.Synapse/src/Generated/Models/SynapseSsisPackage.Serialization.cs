...
namespace Azure.ResourceManager.Synapse.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SynapseSsisPackage>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        SynapseSsisPackage IJsonModel<SynapseSsisPackage>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        internal static SynapseSsisPackage DeserializeSynapseSsisPackage(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new SynapseSsisPackage(type, Optional.ToNullable(id), name.Value, description.Value, serializedAdditionalRawData, Optional.ToNullable(folderId), Optional.ToNullable(projectVersion), Optional.ToNullable(projectId), Optional.ToList(parameters));
        }

        BinaryData IModel<SynapseSsisPackage>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        SynapseSsisPackage IModel<SynapseSsisPackage>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<SynapseSsisPackage>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
