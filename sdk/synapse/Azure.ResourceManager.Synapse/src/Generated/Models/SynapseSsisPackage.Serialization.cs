...
namespace Azure.ResourceManager.Synapse.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SynapseSsisPackage>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SynapseSsisPackage>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SynapseSsisPackage>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SynapseSsisPackage>)} interface");
            }
        ...
        string IPersistableModel<SynapseSsisPackage>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
