...
namespace Azure.ResourceManager.Synapse.Models
{
    ...
    public partial class SynapseIntegrationRuntimeOutboundNetworkDependenciesCategoryEndpoint
    {
        ...
        internal SynapseIntegrationRuntimeOutboundNetworkDependenciesCategoryEndpoint(string category, IReadOnlyList<SynapseIntegrationRuntimeOutboundNetworkDependenciesEndpoint> endpoints, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Category = category;
            Endpoints = endpoints;
