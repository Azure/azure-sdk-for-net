...
namespace Azure.ResourceManager.Synapse.Models
{
    ...
    public partial class WorkspaceCustomerManagedKeyDetails
    {
        ...
        internal WorkspaceCustomerManagedKeyDetails(string status, SynapseWorkspaceKeyDetails key, KekIdentityProperties kekIdentity, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Status = status;
            Key = key;
