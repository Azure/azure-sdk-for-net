...
namespace Azure.ResourceManager.Synapse
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SynapseMaintenanceWindowData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SynapseMaintenanceWindowData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SynapseMaintenanceWindowData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SynapseMaintenanceWindowData>)} interface");
            }
        ...
        string IPersistableModel<SynapseMaintenanceWindowData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
