...
namespace Azure.ResourceManager.Synapse.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SynapseSsisProject>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SynapseSsisProject>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SynapseSsisProject>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SynapseSsisProject>)} interface");
            }
        ...
        string IPersistableModel<SynapseSsisProject>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
