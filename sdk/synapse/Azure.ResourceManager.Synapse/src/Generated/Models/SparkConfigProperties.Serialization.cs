...
{
    public partial class SparkConfigProperties : IUtf8JsonSerializable
    {
        ...
        internal static SparkConfigProperties DeserializeSparkConfigProperties(JsonElement element)
        {
            ...
            return new SparkConfigProperties(Optional.ToNullable(time), content.Value, filename.Value, Optional.ToNullable(configurationType));
        }
    }
}
