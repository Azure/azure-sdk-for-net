...
namespace Azure.ResourceManager.Synapse
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SynapseDataMaskingRuleData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SynapseDataMaskingRuleData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SynapseDataMaskingRuleData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SynapseDataMaskingRuleData>)} interface");
            }
        ...
        string IPersistableModel<SynapseDataMaskingRuleData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
