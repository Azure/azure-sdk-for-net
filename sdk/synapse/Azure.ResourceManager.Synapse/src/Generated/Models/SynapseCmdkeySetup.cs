...
namespace Azure.ResourceManager.Synapse.Models
{
    ...
    public partial class SynapseCmdkeySetup : SynapseCustomSetupBase
    {
        ...
        internal SynapseCmdkeySetup(string customSetupBaseType, BinaryData targetName, BinaryData userName, SynapseSecretBase password, Dictionary<string, BinaryData> rawData) : base(customSetupBaseType, rawData)
        {
            TargetName = targetName;
            UserName = userName;
            Password = password;
