...
namespace Azure.ResourceManager.Synapse.Models
{
    ...
    public partial class SynapseCmdkeySetup : SynapseCustomSetupBase
    {
        ...
        internal SynapseCmdkeySetup(string customSetupBaseType, BinaryData targetName, BinaryData userName, SynapseSecretBase password, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(customSetupBaseType, serializedAdditionalRawData)
        {
            TargetName = targetName;
            UserName = userName;
            Password = password;
