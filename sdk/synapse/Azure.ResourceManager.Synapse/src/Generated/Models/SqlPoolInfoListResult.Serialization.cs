...
{
    internal partial class SqlPoolInfoListResult : IUtf8JsonSerializable, IModelJsonSerializable<SqlPoolInfoListResult>
    {
        ...
        void IModelJsonSerializable<SqlPoolInfoListResult>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(Value))
            {
                ...
                foreach (var item in Value)
                {
                    ...
                    {
                        ((IModelJsonSerializable<SynapseSqlPoolData>)item).Serialize(writer, options);
                    }
                }
