...
namespace Azure.ResourceManager.Synapse.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SqlPoolInfoListResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SqlPoolInfoListResult)} does not support writing '{format}' format.");
            }
            ...
            if (Optional.IsCollectionDefined(Value))
            {
                ...
                {
                    ((IJsonModel<SynapseSqlPoolData>)item).Write(writer, options);
                }
        ...
        SqlPoolInfoListResult IJsonModel<SqlPoolInfoListResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SqlPoolInfoListResult)} does not support reading '{format}' format.");
            }
        ...
        internal static SqlPoolInfoListResult DeserializeSqlPoolInfoListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            IReadOnlyList<SynapseSqlPoolData> value = default;
            ...
            return new SqlPoolInfoListResult(nextLink, value ?? new ChangeTrackingList<SynapseSqlPoolData>(), serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<SqlPoolInfoListResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SqlPoolInfoListResult)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        SqlPoolInfoListResult IPersistableModel<SqlPoolInfoListResult>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SqlPoolInfoListResult)} does not support reading '{options.Format}' format.");
            }
        }
