...
{
    internal partial class SynapseGeoBackupPolicyListResult : IUtf8JsonSerializable, IJsonModel<SynapseGeoBackupPolicyListResult>, IPersistableModel<SynapseGeoBackupPolicyListResult>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SynapseGeoBackupPolicyListResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<SynapseGeoBackupPolicyListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SynapseGeoBackupPolicyListResult)} does not support '{format}' format.");
            }
