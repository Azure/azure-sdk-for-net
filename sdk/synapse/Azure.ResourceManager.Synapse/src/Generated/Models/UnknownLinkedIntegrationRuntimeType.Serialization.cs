...
namespace Azure.ResourceManager.Synapse.Models
{
    internal partial class UnknownLinkedIntegrationRuntimeType : IUtf8JsonSerializable, IJsonModel<SynapseLinkedIntegrationRuntimeType>
    {
        ...
        void IJsonModel<SynapseLinkedIntegrationRuntimeType>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(SynapseLinkedIntegrationRuntimeType)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<SynapseLinkedIntegrationRuntimeType>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(SynapseLinkedIntegrationRuntimeType)} does not support '{options.Format}' format.");
            }
        }
