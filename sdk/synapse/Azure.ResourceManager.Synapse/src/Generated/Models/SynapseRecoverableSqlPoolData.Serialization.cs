...
namespace Azure.ResourceManager.Synapse
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SynapseRecoverableSqlPoolData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SynapseRecoverableSqlPoolData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SynapseRecoverableSqlPoolData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SynapseRecoverableSqlPoolData>)} interface");
            }
        ...
        string IPersistableModel<SynapseRecoverableSqlPoolData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
