...
namespace Azure.ResourceManager.Synapse.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SynapseDataSourceResourceSkuListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SynapseDataSourceResourceSkuListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SynapseDataSourceResourceSkuListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SynapseDataSourceResourceSkuListResult>)} interface");
            }
        ...
        string IPersistableModel<SynapseDataSourceResourceSkuListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
