...
namespace Azure.ResourceManager.Synapse.Models
{
    ...
    public partial class BigDataPoolLibraryInfo
    {
        ...
        internal BigDataPoolLibraryInfo(string name, string path, string containerName, DateTimeOffset? uploadedOn, string libraryInfoType, string provisioningStatus, string creatorId, Dictionary<string, BinaryData> rawData)
        {
            Name = name;
            Path = path;
