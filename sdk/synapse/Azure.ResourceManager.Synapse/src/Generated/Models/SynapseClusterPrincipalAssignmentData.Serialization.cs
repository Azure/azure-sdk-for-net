...
namespace Azure.ResourceManager.Synapse
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SynapseClusterPrincipalAssignmentData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SynapseClusterPrincipalAssignmentData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SynapseClusterPrincipalAssignmentData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SynapseClusterPrincipalAssignmentData>)} interface");
            }
        ...
        string IPersistableModel<SynapseClusterPrincipalAssignmentData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
