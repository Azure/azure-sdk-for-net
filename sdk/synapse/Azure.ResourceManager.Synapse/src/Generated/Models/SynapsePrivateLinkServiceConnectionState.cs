...
namespace Azure.ResourceManager.Synapse.Models
{
    ...
    public partial class SynapsePrivateLinkServiceConnectionState
    {
        ...
        internal SynapsePrivateLinkServiceConnectionState(string status, string description, string actionsRequired, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Status = status;
