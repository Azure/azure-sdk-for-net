...
namespace Azure.ResourceManager.Synapse.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SynapseEventHubDataConnection>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SynapseEventHubDataConnection>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SynapseEventHubDataConnection>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SynapseEventHubDataConnection>)} interface");
            }
        ...
        string IPersistableModel<SynapseEventHubDataConnection>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
