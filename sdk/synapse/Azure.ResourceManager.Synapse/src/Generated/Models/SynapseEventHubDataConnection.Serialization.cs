...
namespace Azure.ResourceManager.Synapse.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SynapseEventHubDataConnection>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SynapseEventHubDataConnection)} does not support writing '{format}' format.");
            }
        ...
        SynapseEventHubDataConnection IJsonModel<SynapseEventHubDataConnection>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SynapseEventHubDataConnection)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<SynapseEventHubDataConnection>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SynapseEventHubDataConnection)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        SynapseEventHubDataConnection IPersistableModel<SynapseEventHubDataConnection>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SynapseEventHubDataConnection)} does not support reading '{options.Format}' format.");
            }
        }
