...
{
    public partial class SynapseEventHubDataConnection : IUtf8JsonSerializable, IModelJsonSerializable<SynapseEventHubDataConnection>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IModelJsonSerializable<SynapseEventHubDataConnection>)this).Serialize(writer, ModelSerializerOptions.DefaultWireOptions);

        void IModelJsonSerializable<SynapseEventHubDataConnection>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<SynapseEventHubDataConnection>(this, options.Format);
        ...
        internal static SynapseEventHubDataConnection DeserializeSynapseEventHubDataConnection(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new SynapseEventHubDataConnection(id, name, type, systemData.Value, Optional.ToNullable(location), kind, eventHubResourceId.Value, consumerGroup.Value, tableName.Value, mappingRuleName.Value, Optional.ToNullable(dataFormat), Optional.ToList(eventSystemProperties), Optional.ToNullable(compression), Optional.ToNullable(provisioningState), managedIdentityResourceId.Value, serializedAdditionalRawData);
        }

        SynapseEventHubDataConnection IModelJsonSerializable<SynapseEventHubDataConnection>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<SynapseEventHubDataConnection>(this, options.Format);

            using var doc = JsonDocument.ParseValue(ref reader);
            return DeserializeSynapseEventHubDataConnection(doc.RootElement, options);
        }

        BinaryData IModelSerializable<SynapseEventHubDataConnection>.Serialize(ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<SynapseEventHubDataConnection>(this, options.Format);
        ...
        SynapseEventHubDataConnection IModelSerializable<SynapseEventHubDataConnection>.Deserialize(BinaryData data, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<SynapseEventHubDataConnection>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="SynapseEventHubDataConnection"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="SynapseEventHubDataConnection"/> to convert. </param>
        public static implicit operator RequestContent(SynapseEventHubDataConnection model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="SynapseEventHubDataConnection"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator SynapseEventHubDataConnection(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeSynapseEventHubDataConnection(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
