...
namespace Azure.ResourceManager.Synapse.Models
{
    public partial class SynapseEventHubDataConnection : IUtf8JsonSerializable, IModelJsonSerializable<SynapseEventHubDataConnection>
    {
        ...
        internal static SynapseEventHubDataConnection DeserializeSynapseEventHubDataConnection(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new SynapseEventHubDataConnection(id, name, type, systemData.Value, Optional.ToNullable(location), kind, eventHubResourceId.Value, consumerGroup.Value, tableName.Value, mappingRuleName.Value, Optional.ToNullable(dataFormat), Optional.ToList(eventSystemProperties), Optional.ToNullable(compression), Optional.ToNullable(provisioningState), managedIdentityResourceId.Value, rawData);
        }
