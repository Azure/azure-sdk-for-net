...
namespace Azure.ResourceManager.Synapse.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SynapseDataSourceResourceSku>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SynapseDataSourceResourceSku>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SynapseDataSourceResourceSku>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SynapseDataSourceResourceSku>)} interface");
            }
        ...
        string IPersistableModel<SynapseDataSourceResourceSku>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
