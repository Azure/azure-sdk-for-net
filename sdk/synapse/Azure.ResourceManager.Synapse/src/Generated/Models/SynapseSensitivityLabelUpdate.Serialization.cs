...
namespace Azure.ResourceManager.Synapse.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SynapseSensitivityLabelUpdate>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SynapseSensitivityLabelUpdate>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SynapseSensitivityLabelUpdate>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SynapseSensitivityLabelUpdate>)} interface");
            }
        ...
        string IPersistableModel<SynapseSensitivityLabelUpdate>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
