...
namespace Azure.ResourceManager.Synapse
{
    public partial class SynapseDatabasePrincipalAssignmentData : IUtf8JsonSerializable, IJsonModel<SynapseDatabasePrincipalAssignmentData>
    {
        ...
        void IJsonModel<SynapseDatabasePrincipalAssignmentData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(SynapseDatabasePrincipalAssignmentData)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<SynapseDatabasePrincipalAssignmentData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(SynapseDatabasePrincipalAssignmentData)} does not support '{options.Format}' format.");
            }
        }
