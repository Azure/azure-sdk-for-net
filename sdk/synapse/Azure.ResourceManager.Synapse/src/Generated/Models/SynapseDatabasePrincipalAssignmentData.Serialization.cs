...
namespace Azure.ResourceManager.Synapse
{
    public partial class SynapseDatabasePrincipalAssignmentData : IUtf8JsonSerializable
    {
        ...
        internal static SynapseDatabasePrincipalAssignmentData DeserializeSynapseDatabasePrincipalAssignmentData(JsonElement element)
        {
            ...
            return new SynapseDatabasePrincipalAssignmentData(id, name, type, systemData.Value, principalId.Value, Optional.ToNullable(role), Optional.ToNullable(tenantId), Optional.ToNullable(principalType), tenantName.Value, principalName.Value, Optional.ToNullable(provisioningState), aadObjectId.Value);
        }
    }
}
