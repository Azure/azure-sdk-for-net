...
namespace Azure.ResourceManager.Synapse
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SynapseDatabasePrincipalAssignmentData>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        SynapseDatabasePrincipalAssignmentData IJsonModel<SynapseDatabasePrincipalAssignmentData>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
                throw new FormatException($"The model {nameof(SynapseDatabasePrincipalAssignmentData)} does not support '{options.Format}' format.");
            }
        ...
        BinaryData IModel<SynapseDatabasePrincipalAssignmentData>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        SynapseDatabasePrincipalAssignmentData IModel<SynapseDatabasePrincipalAssignmentData>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<SynapseDatabasePrincipalAssignmentData>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
