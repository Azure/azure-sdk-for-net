...
namespace Azure.ResourceManager.Synapse
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SynapseDatabasePrincipalAssignmentData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SynapseDatabasePrincipalAssignmentData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SynapseDatabasePrincipalAssignmentData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SynapseDatabasePrincipalAssignmentData>)} interface");
            }
        ...
        string IPersistableModel<SynapseDatabasePrincipalAssignmentData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
