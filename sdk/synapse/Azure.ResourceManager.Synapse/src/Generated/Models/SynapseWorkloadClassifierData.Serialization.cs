...
{
    public partial class SynapseWorkloadClassifierData : IUtf8JsonSerializable
    {
        ...
        internal static SynapseWorkloadClassifierData DeserializeSynapseWorkloadClassifierData(JsonElement element)
        {
            ...
            return new SynapseWorkloadClassifierData(id, name, type, systemData.Value, memberName.Value, label.Value, context.Value, startTime.Value, endTime.Value, importance.Value);
        }
    }
}
