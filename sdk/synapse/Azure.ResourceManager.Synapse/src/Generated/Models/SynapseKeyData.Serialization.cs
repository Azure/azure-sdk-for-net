...
namespace Azure.ResourceManager.Synapse
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SynapseKeyData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SynapseKeyData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SynapseKeyData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<SynapseKeyData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
