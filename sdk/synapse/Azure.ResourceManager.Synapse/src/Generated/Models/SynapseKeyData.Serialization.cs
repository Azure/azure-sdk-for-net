...
{
    public partial class SynapseKeyData : IUtf8JsonSerializable, IJsonModel<SynapseKeyData>, IPersistableModel<SynapseKeyData>
    {
        ...
        void IJsonModel<SynapseKeyData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SynapseKeyData)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(IsActiveCmk))
            {
                builder.Append("  isActiveCMK:");
                var boolValue = IsActiveCmk.Value == true ? "true" : "false";
