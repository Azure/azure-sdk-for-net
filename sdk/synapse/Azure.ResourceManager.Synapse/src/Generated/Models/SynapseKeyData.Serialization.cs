...
{
    public partial class SynapseKeyData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static SynapseKeyData DeserializeSynapseKeyData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
