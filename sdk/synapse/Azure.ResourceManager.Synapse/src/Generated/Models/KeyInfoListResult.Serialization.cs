...
namespace Azure.ResourceManager.Synapse.Models
{
    internal partial class KeyInfoListResult : IUtf8JsonSerializable, IModelJsonSerializable<KeyInfoListResult>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<KeyInfoListResult>(this, options.Format);
            ...
            if (Optional.IsCollectionDefined(Value))
            {
                ...
                foreach (var item in Value)
                {
                    ...
                    {
                        ((IModelJsonSerializable<SynapseKeyData>)item).Serialize(writer, options);
                    }
                }
        ...
        /// <summary> Converts a <see cref="KeyInfoListResult"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="KeyInfoListResult"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="KeyInfoListResult"/>. </summary>
