...
{
    public partial class RecoverableSqlPoolData : IUtf8JsonSerializable
    {
        ...
        internal static RecoverableSqlPoolData DeserializeRecoverableSqlPoolData(JsonElement element)
        {
            ...
            return new RecoverableSqlPoolData(id, name, type, systemData.Value, edition.Value, serviceLevelObjective.Value, elasticPoolName.Value, Optional.ToNullable(lastAvailableBackupDate));
        }
    }
}
