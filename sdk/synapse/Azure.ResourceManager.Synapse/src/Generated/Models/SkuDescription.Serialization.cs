...
namespace Azure.ResourceManager.Synapse.Models
{
    public partial class SkuDescription
    {
        internal static SkuDescription DeserializeSkuDescription(JsonElement element)
        {
            ...
            return new SkuDescription(resourceType.Value, name.Value, size.Value, Optional.ToList(locations), Optional.ToList(locationInfo), Optional.ToList(restrictions));
        }
    }
}
