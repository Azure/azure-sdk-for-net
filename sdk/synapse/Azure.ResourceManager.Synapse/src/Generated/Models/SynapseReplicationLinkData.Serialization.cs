...
namespace Azure.ResourceManager.Synapse
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SynapseReplicationLinkData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SynapseReplicationLinkData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SynapseReplicationLinkData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SynapseReplicationLinkData>)} interface");
            }
        ...
        string IPersistableModel<SynapseReplicationLinkData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
