...
namespace Azure.ResourceManager.Synapse
{
    public partial class SynapseReplicationLinkData : IUtf8JsonSerializable, IJsonModel<SynapseReplicationLinkData>
    {
        ...
        void IJsonModel<SynapseReplicationLinkData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(SynapseReplicationLinkData)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<SynapseReplicationLinkData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(SynapseReplicationLinkData)} does not support '{options.Format}' format.");
            }
        }
