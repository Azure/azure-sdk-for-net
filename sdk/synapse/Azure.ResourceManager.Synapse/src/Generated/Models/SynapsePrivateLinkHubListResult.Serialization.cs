...
namespace Azure.ResourceManager.Synapse.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SynapsePrivateLinkHubListResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<SynapsePrivateLinkHubListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SynapsePrivateLinkHubListResult)} does not support '{format}' format.");
            }
            ...
            if (!(Value is ChangeTrackingList<SynapsePrivateLinkHubData> collection && collection.IsUndefined))
            {
        ...
        internal static SynapsePrivateLinkHubListResult DeserializeSynapsePrivateLinkHubListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new SynapsePrivateLinkHubListResult(nextLink.Value, value ?? new ChangeTrackingList<SynapsePrivateLinkHubData>(), serializedAdditionalRawData);
        }
