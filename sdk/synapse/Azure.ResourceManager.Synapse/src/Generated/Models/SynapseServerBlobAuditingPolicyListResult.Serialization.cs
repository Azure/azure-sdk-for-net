...
namespace Azure.ResourceManager.Synapse.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SynapseServerBlobAuditingPolicyListResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SynapseServerBlobAuditingPolicyListResult)} does not support writing '{format}' format.");
            }
            ...
            if (options.Format != "W" && Optional.IsCollectionDefined(Value))
            {
                ...
                {
                    ((IJsonModel<SynapseServerBlobAuditingPolicyData>)item).Write(writer, options);
                }
        ...
        SynapseServerBlobAuditingPolicyListResult IJsonModel<SynapseServerBlobAuditingPolicyListResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SynapseServerBlobAuditingPolicyListResult)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<SynapseServerBlobAuditingPolicyListResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SynapseServerBlobAuditingPolicyListResult)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        SynapseServerBlobAuditingPolicyListResult IPersistableModel<SynapseServerBlobAuditingPolicyListResult>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SynapseServerBlobAuditingPolicyListResult)} does not support reading '{options.Format}' format.");
            }
        }
