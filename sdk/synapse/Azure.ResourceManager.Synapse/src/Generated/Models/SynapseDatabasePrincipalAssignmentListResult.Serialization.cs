...
namespace Azure.ResourceManager.Synapse.Models
{
    internal partial class SynapseDatabasePrincipalAssignmentListResult
    {
        internal static SynapseDatabasePrincipalAssignmentListResult DeserializeSynapseDatabasePrincipalAssignmentListResult(JsonElement element)
        {
            ...
            Core.Optional<IReadOnlyList<SynapseDatabasePrincipalAssignmentData>> value = default;
            ...
            return new SynapseDatabasePrincipalAssignmentListResult(Core.Optional.ToList(value));
        }
    }
}
