...
namespace Azure.ResourceManager.Synapse.Models
{
    ...
    public partial class SynapsePrivateLinkResourceProperties
    {
        ...
        internal SynapsePrivateLinkResourceProperties(string groupId, IReadOnlyList<string> requiredMembers, IReadOnlyList<string> requiredZoneNames, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            GroupId = groupId;
