...
{
    public partial class SynapseRestorePointData : IUtf8JsonSerializable, IJsonModel<SynapseRestorePointData>, IPersistableModel<SynapseRestorePointData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(RestorePointCreationOn))
            {
                ...
                builder.AppendLine($" '{RestorePointCreationOn.Value.ToString()}'");
            }
