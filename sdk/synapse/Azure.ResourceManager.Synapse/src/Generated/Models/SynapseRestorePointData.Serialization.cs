...
namespace Azure.ResourceManager.Synapse
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SynapseRestorePointData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SynapseRestorePointData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SynapseRestorePointData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<SynapseRestorePointData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
