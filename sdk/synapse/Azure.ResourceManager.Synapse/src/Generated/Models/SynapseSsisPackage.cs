...
namespace Azure.ResourceManager.Synapse.Models
{
    ...
    public partial class SynapseSsisPackage : SynapseSsisObjectMetadata
    {
        ...
        internal SynapseSsisPackage(SynapseSsisObjectMetadataType metadataType, long? id, string name, string description, long? folderId, long? projectVersion, long? projectId, IReadOnlyList<SynapseSsisParameter> parameters, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(metadataType, id, name, description, serializedAdditionalRawData)
        {
            FolderId = folderId;
