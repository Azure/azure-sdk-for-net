...
{
    public partial class SynapseEncryptionDetails : IUtf8JsonSerializable, IJsonModel<SynapseEncryptionDetails>, IPersistableModel<SynapseEncryptionDetails>
    {
        ...
        void IJsonModel<SynapseEncryptionDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SynapseEncryptionDetails)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  doubleEncryptionEnabled:");
            ...
            {
                builder.Append("  cmk:");
                AppendChildObject(builder, Cmk, options, 2);
            }
