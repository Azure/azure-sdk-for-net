...
namespace Azure.ResourceManager.Synapse.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ReplaceAllFirewallRulesOperationResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ReplaceAllFirewallRulesOperationResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ReplaceAllFirewallRulesOperationResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ReplaceAllFirewallRulesOperationResult>)} interface");
            }
        ...
        string IPersistableModel<ReplaceAllFirewallRulesOperationResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
