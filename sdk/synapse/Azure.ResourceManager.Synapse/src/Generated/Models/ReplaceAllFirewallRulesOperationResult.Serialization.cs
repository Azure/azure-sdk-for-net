...
namespace Azure.ResourceManager.Synapse.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ReplaceAllFirewallRulesOperationResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ReplaceAllFirewallRulesOperationResult)} does not support writing '{format}' format.");
            }
        ...
        ReplaceAllFirewallRulesOperationResult IJsonModel<ReplaceAllFirewallRulesOperationResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ReplaceAllFirewallRulesOperationResult)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ReplaceAllFirewallRulesOperationResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ReplaceAllFirewallRulesOperationResult)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        ReplaceAllFirewallRulesOperationResult IPersistableModel<ReplaceAllFirewallRulesOperationResult>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ReplaceAllFirewallRulesOperationResult)} does not support reading '{options.Format}' format.");
            }
        }
