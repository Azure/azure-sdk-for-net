...
namespace Azure.ResourceManager.Synapse.Models
{
    ...
    {
        internal static BigDataPoolLibraryListResult DeserializeBigDataPoolLibraryListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
