...
{
    internal partial class BigDataPoolLibraryListResult : IUtf8JsonSerializable, IJsonModel<BigDataPoolLibraryListResult>, IPersistableModel<BigDataPoolLibraryListResult>
    {
        ...
        void IJsonModel<BigDataPoolLibraryListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(BigDataPoolLibraryListResult)} does not support '{format}' format.");
            }
