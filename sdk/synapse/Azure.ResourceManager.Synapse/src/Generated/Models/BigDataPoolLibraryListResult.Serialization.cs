...
namespace Azure.ResourceManager.Synapse.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BigDataPoolLibraryListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<BigDataPoolLibraryListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BigDataPoolLibraryListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<BigDataPoolLibraryListResult>)} interface");
            }
        ...
        string IPersistableModel<BigDataPoolLibraryListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
