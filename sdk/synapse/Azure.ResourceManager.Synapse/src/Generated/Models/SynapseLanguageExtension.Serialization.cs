...
{
    public partial class SynapseLanguageExtension : IUtf8JsonSerializable, IJsonModel<SynapseLanguageExtension>, IPersistableModel<SynapseLanguageExtension>
    {
        ...
        void IJsonModel<SynapseLanguageExtension>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SynapseLanguageExtension)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(LanguageExtensionName))
            {
                ...
                builder.AppendLine($" '{LanguageExtensionName.ToString()}'");
            }
