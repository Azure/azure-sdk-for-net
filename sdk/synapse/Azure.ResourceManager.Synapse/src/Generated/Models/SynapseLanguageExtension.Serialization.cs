...
namespace Azure.ResourceManager.Synapse.Models
{
    public partial class SynapseLanguageExtension : IUtf8JsonSerializable, IJsonModel<SynapseLanguageExtension>
    {
        ...
        void IJsonModel<SynapseLanguageExtension>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(SynapseLanguageExtension)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<SynapseLanguageExtension>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(SynapseLanguageExtension)} does not support '{options.Format}' format.");
            }
        }
