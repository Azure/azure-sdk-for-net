...
namespace Azure.ResourceManager.Synapse
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SynapseSqlPoolConnectionPolicyData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SynapseSqlPoolConnectionPolicyData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SynapseSqlPoolConnectionPolicyData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SynapseSqlPoolConnectionPolicyData>)} interface");
            }
        ...
        string IPersistableModel<SynapseSqlPoolConnectionPolicyData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
