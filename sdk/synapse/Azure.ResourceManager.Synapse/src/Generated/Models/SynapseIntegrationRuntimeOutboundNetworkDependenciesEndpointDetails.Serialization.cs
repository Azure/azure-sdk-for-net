...
namespace Azure.ResourceManager.Synapse.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SynapseIntegrationRuntimeOutboundNetworkDependenciesEndpointDetails>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        SynapseIntegrationRuntimeOutboundNetworkDependenciesEndpointDetails IJsonModel<SynapseIntegrationRuntimeOutboundNetworkDependenciesEndpointDetails>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<SynapseIntegrationRuntimeOutboundNetworkDependenciesEndpointDetails>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        SynapseIntegrationRuntimeOutboundNetworkDependenciesEndpointDetails IModel<SynapseIntegrationRuntimeOutboundNetworkDependenciesEndpointDetails>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<SynapseIntegrationRuntimeOutboundNetworkDependenciesEndpointDetails>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
