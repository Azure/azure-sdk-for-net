...
namespace Azure.ResourceManager.Synapse.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SynapseIntegrationRuntimeOutboundNetworkDependenciesEndpointDetails>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SynapseIntegrationRuntimeOutboundNetworkDependenciesEndpointDetails)} does not support writing '{format}' format.");
            }
        ...
        SynapseIntegrationRuntimeOutboundNetworkDependenciesEndpointDetails IJsonModel<SynapseIntegrationRuntimeOutboundNetworkDependenciesEndpointDetails>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SynapseIntegrationRuntimeOutboundNetworkDependenciesEndpointDetails)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<SynapseIntegrationRuntimeOutboundNetworkDependenciesEndpointDetails>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SynapseIntegrationRuntimeOutboundNetworkDependenciesEndpointDetails)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        SynapseIntegrationRuntimeOutboundNetworkDependenciesEndpointDetails IPersistableModel<SynapseIntegrationRuntimeOutboundNetworkDependenciesEndpointDetails>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SynapseIntegrationRuntimeOutboundNetworkDependenciesEndpointDetails)} does not support reading '{options.Format}' format.");
            }
        }
