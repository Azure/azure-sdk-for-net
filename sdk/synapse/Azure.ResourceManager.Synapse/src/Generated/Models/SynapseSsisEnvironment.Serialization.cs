...
namespace Azure.ResourceManager.Synapse.Models
{
    public partial class SynapseSsisEnvironment : IUtf8JsonSerializable, IJsonModel<SynapseSsisEnvironment>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<SynapseSsisEnvironment>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SynapseSsisEnvironment>)} interface");
            }
