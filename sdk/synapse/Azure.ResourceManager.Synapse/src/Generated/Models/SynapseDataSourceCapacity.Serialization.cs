...
namespace Azure.ResourceManager.Synapse.Models
{
    ...
    {
        internal static SynapseDataSourceCapacity DeserializeSynapseDataSourceCapacity(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
