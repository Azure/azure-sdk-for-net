...
{
    internal partial class VirtualNetworkProfile : IUtf8JsonSerializable, IJsonModel<VirtualNetworkProfile>, IPersistableModel<VirtualNetworkProfile>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ComputeSubnetId))
            {
                builder.Append("  computeSubnetId:");
                builder.AppendLine($" '{ComputeSubnetId}'");
            }
