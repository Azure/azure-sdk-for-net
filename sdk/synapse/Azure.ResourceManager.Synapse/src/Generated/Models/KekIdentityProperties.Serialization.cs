...
{
    public partial class KekIdentityProperties : IUtf8JsonSerializable, IJsonModel<KekIdentityProperties>, IPersistableModel<KekIdentityProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(UserAssignedIdentityId))
            {
                ...
                builder.AppendLine($" '{UserAssignedIdentityId.ToString()}'");
            }

            if (Optional.IsDefined(UseSystemAssignedIdentity))
            {
                builder.Append("  useSystemAssignedIdentity:");
                builder.AppendLine($" '{UseSystemAssignedIdentity.ToString()}'");
            }
