...
namespace Azure.ResourceManager.Synapse.Models
{
    internal partial class SynapseDedicatedSqlMinimalTlsSettingListResult : IUtf8JsonSerializable, IJsonModel<SynapseDedicatedSqlMinimalTlsSettingListResult>
    {
        ...
        void IJsonModel<SynapseDedicatedSqlMinimalTlsSettingListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(SynapseDedicatedSqlMinimalTlsSettingListResult)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<SynapseDedicatedSqlMinimalTlsSettingListResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(SynapseDedicatedSqlMinimalTlsSettingListResult)} does not support '{options.Format}' format.");
            }
        }
