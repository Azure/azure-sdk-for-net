...
namespace Azure.ResourceManager.Synapse.Models
{
    ...
    public partial class SynapseLinkedIntegrationRuntimeRbacAuthorization : SynapseLinkedIntegrationRuntimeType
    {
        ...
        internal SynapseLinkedIntegrationRuntimeRbacAuthorization(string authorizationType, ResourceIdentifier resourceId, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(authorizationType, serializedAdditionalRawData)
        {
            ResourceId = resourceId;
