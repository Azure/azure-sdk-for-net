...
namespace Azure.ResourceManager.Synapse
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SynapseSqlPoolBlobAuditingPolicyData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SynapseSqlPoolBlobAuditingPolicyData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SynapseSqlPoolBlobAuditingPolicyData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SynapseSqlPoolBlobAuditingPolicyData>)} interface");
            }
        ...
        string IPersistableModel<SynapseSqlPoolBlobAuditingPolicyData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
