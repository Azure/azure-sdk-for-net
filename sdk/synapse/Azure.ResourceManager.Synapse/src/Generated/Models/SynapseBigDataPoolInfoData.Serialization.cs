...
namespace Azure.ResourceManager.Synapse
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SynapseBigDataPoolInfoData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SynapseBigDataPoolInfoData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SynapseBigDataPoolInfoData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SynapseBigDataPoolInfoData>)} interface");
            }
        ...
        string IPersistableModel<SynapseBigDataPoolInfoData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
