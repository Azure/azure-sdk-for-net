    ...
    public partial class SynapseBigDataPoolInfoData : IUtf8JsonSerializable, IJsonModel<SynapseBigDataPoolInfoData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SparkEventsFolder))
            {
                ...
                if (SparkEventsFolder.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(DefaultSparkLogFolder))
            {
                ...
                if (DefaultSparkLogFolder.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(NodeSize))
            {
                ...
                builder.AppendLine($" '{NodeSize.Value.ToString()}'");
            }

            if (Optional.IsDefined(NodeSizeFamily))
            {
                builder.Append("    nodeSizeFamily:");
                builder.AppendLine($" '{NodeSizeFamily.Value.ToString()}'");
            }
