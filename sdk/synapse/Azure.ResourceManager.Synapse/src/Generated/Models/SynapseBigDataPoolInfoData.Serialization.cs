...
{
    public partial class SynapseBigDataPoolInfoData : IUtf8JsonSerializable, IJsonModel<SynapseBigDataPoolInfoData>, IPersistableModel<SynapseBigDataPoolInfoData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(AutoPause))
            {
                ...
                AppendChildObject(builder, AutoPause, options, 2);
            }
            ...
            if (Optional.IsDefined(CacheSize))
            {
                ...
                builder.AppendLine($" '{CacheSize.Value.ToString()}'");
            }

            if (Optional.IsDefined(DynamicExecutorAllocation))
            {
                builder.Append("  dynamicExecutorAllocation:");
                AppendChildObject(builder, DynamicExecutorAllocation, options, 2);
            }
            ...
            if (Optional.IsDefined(LibraryRequirements))
            {
                ...
                AppendChildObject(builder, LibraryRequirements, options, 2);
            }
            ...
            if (Optional.IsDefined(SparkConfigProperties))
            {
                ...
                AppendChildObject(builder, SparkConfigProperties, options, 2);
            }
            ...
            if (Optional.IsDefined(LastSucceededOn))
            {
                ...
                builder.AppendLine($" '{LastSucceededOn.Value.ToString()}'");
            }
