...
namespace Azure.ResourceManager.Synapse.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SynapseLanguageExtensionsList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SynapseLanguageExtensionsList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SynapseLanguageExtensionsList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SynapseLanguageExtensionsList>)} interface");
            }
        ...
        string IPersistableModel<SynapseLanguageExtensionsList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
