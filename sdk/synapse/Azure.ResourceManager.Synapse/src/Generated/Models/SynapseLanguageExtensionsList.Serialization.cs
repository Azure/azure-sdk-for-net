...
namespace Azure.ResourceManager.Synapse.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SynapseLanguageExtensionsList>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SynapseLanguageExtensionsList)} does not support writing '{format}' format.");
            }
            ...
            if (Optional.IsCollectionDefined(Value))
            {
                ...
                {
                    ((IJsonModel<SynapseLanguageExtension>)item).Write(writer, options);
                }
        ...
        SynapseLanguageExtensionsList IJsonModel<SynapseLanguageExtensionsList>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SynapseLanguageExtensionsList)} does not support reading '{format}' format.");
            }
        ...
        internal static SynapseLanguageExtensionsList DeserializeSynapseLanguageExtensionsList(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            IList<SynapseLanguageExtension> value = default;
            ...
            return new SynapseLanguageExtensionsList(value ?? new ChangeTrackingList<SynapseLanguageExtension>(), serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<SynapseLanguageExtensionsList>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SynapseLanguageExtensionsList)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        SynapseLanguageExtensionsList IPersistableModel<SynapseLanguageExtensionsList>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SynapseLanguageExtensionsList)} does not support reading '{options.Format}' format.");
            }
        }
