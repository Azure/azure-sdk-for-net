...
namespace Azure.ResourceManager.Synapse.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SynapseComponentSetup>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SynapseComponentSetup>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SynapseComponentSetup>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SynapseComponentSetup>)} interface");
            }
        ...
        string IPersistableModel<SynapseComponentSetup>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
