...
namespace Azure.ResourceManager.Synapse.Models
{
    ...
    public partial class BigDataPoolSparkConfigProperties
    {
        ...
        internal BigDataPoolSparkConfigProperties(DateTimeOffset? updatedOn, string content, string filename, SynapseSparkConfigurationType? configurationType, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            UpdatedOn = updatedOn;
            Content = content;
            Filename = filename;
