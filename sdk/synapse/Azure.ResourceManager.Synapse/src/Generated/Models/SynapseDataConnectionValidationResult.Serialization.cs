...
{
    public partial class SynapseDataConnectionValidationResult : IUtf8JsonSerializable, IJsonModel<SynapseDataConnectionValidationResult>, IPersistableModel<SynapseDataConnectionValidationResult>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SynapseDataConnectionValidationResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<SynapseDataConnectionValidationResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SynapseDataConnectionValidationResult)} does not support '{format}' format.");
            }
