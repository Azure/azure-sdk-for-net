...
namespace Azure.ResourceManager.Synapse.Models
{
    public partial class ManagedIntegrationRuntime : IUtf8JsonSerializable
    {
        ...
        internal static ManagedIntegrationRuntime DeserializeManagedIntegrationRuntime(JsonElement element)
        {
            ...
            return new ManagedIntegrationRuntime(type, description.Value, additionalProperties, Optional.ToNullable(state), referenceName.Value, type0.Value, id.Value, computeProperties.Value, ssisProperties.Value);
        }
    }
}
