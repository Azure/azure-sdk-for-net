...
namespace Azure.ResourceManager.Synapse.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BigDataPoolLibraryInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<BigDataPoolLibraryInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BigDataPoolLibraryInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<BigDataPoolLibraryInfo>)} interface");
            }
        ...
        string IPersistableModel<BigDataPoolLibraryInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
