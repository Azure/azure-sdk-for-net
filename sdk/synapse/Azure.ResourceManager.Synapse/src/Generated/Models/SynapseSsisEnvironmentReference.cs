...
namespace Azure.ResourceManager.Synapse.Models
{
    ...
    public partial class SynapseSsisEnvironmentReference
    {
        ...
        internal SynapseSsisEnvironmentReference(long? id, string environmentFolderName, string environmentName, string referenceType, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
