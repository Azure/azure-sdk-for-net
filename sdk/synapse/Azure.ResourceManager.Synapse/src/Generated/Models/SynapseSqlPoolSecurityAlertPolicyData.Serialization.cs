...
namespace Azure.ResourceManager.Synapse
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SynapseSqlPoolSecurityAlertPolicyData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SynapseSqlPoolSecurityAlertPolicyData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SynapseSqlPoolSecurityAlertPolicyData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SynapseSqlPoolSecurityAlertPolicyData>)} interface");
            }
        ...
        string IPersistableModel<SynapseSqlPoolSecurityAlertPolicyData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
