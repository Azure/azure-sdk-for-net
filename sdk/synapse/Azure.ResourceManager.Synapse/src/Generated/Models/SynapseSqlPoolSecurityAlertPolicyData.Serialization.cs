...
namespace Azure.ResourceManager.Synapse
{
    public partial class SynapseSqlPoolSecurityAlertPolicyData : IUtf8JsonSerializable, IJsonModel<SynapseSqlPoolSecurityAlertPolicyData>
    {
        ...
        void IJsonModel<SynapseSqlPoolSecurityAlertPolicyData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(SynapseSqlPoolSecurityAlertPolicyData)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<SynapseSqlPoolSecurityAlertPolicyData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(SynapseSqlPoolSecurityAlertPolicyData)} does not support '{options.Format}' format.");
            }
        }
