...
{
    public partial class SynapseSqlPoolSecurityAlertPolicyData : Core.IUtf8JsonSerializable
    {
        void Core.IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            if (Core.Optional.IsDefined(EnableEmailToAccountAdmins))
            {
        ...
        internal static SynapseSqlPoolSecurityAlertPolicyData DeserializeSynapseSqlPoolSecurityAlertPolicyData(JsonElement element)
        {
            ...
            Core.Optional<SynapseSecurityAlertPolicyState> state = default;
