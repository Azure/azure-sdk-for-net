...
{
    public partial class SynapseSqlPoolSecurityAlertPolicyData : IUtf8JsonSerializable, IModelJsonSerializable<SynapseSqlPoolSecurityAlertPolicyData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IModelJsonSerializable<SynapseSqlPoolSecurityAlertPolicyData>)this).Serialize(writer, ModelSerializerOptions.DefaultWireOptions);

        void IModelJsonSerializable<SynapseSqlPoolSecurityAlertPolicyData>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<SynapseSqlPoolSecurityAlertPolicyData>(this, options.Format);
        ...
        internal static SynapseSqlPoolSecurityAlertPolicyData DeserializeSynapseSqlPoolSecurityAlertPolicyData(JsonElement element, ModelSerializerOptions options = default)
        {
        ...
        SynapseSqlPoolSecurityAlertPolicyData IModelJsonSerializable<SynapseSqlPoolSecurityAlertPolicyData>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<SynapseSqlPoolSecurityAlertPolicyData>(this, options.Format);

            using var doc = JsonDocument.ParseValue(ref reader);
            return DeserializeSynapseSqlPoolSecurityAlertPolicyData(doc.RootElement, options);
        }

        BinaryData IModelSerializable<SynapseSqlPoolSecurityAlertPolicyData>.Serialize(ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<SynapseSqlPoolSecurityAlertPolicyData>(this, options.Format);
        ...
        SynapseSqlPoolSecurityAlertPolicyData IModelSerializable<SynapseSqlPoolSecurityAlertPolicyData>.Deserialize(BinaryData data, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<SynapseSqlPoolSecurityAlertPolicyData>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="SynapseSqlPoolSecurityAlertPolicyData"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="SynapseSqlPoolSecurityAlertPolicyData"/> to convert. </param>
        public static implicit operator RequestContent(SynapseSqlPoolSecurityAlertPolicyData model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="SynapseSqlPoolSecurityAlertPolicyData"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator SynapseSqlPoolSecurityAlertPolicyData(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeSynapseSqlPoolSecurityAlertPolicyData(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
