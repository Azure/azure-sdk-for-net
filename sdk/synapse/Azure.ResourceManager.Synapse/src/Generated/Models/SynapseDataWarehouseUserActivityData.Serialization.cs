...
namespace Azure.ResourceManager.Synapse
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SynapseDataWarehouseUserActivityData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SynapseDataWarehouseUserActivityData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SynapseDataWarehouseUserActivityData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SynapseDataWarehouseUserActivityData>)} interface");
            }
        ...
        string IPersistableModel<SynapseDataWarehouseUserActivityData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
