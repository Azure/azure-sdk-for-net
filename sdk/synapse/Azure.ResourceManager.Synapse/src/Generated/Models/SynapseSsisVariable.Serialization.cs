...
namespace Azure.ResourceManager.Synapse.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SynapseSsisVariable>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SynapseSsisVariable>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SynapseSsisVariable>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SynapseSsisVariable>)} interface");
            }
        ...
        string IPersistableModel<SynapseSsisVariable>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
