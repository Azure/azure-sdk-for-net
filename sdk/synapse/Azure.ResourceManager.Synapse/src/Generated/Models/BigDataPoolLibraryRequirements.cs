...
namespace Azure.ResourceManager.Synapse.Models
{
    ...
    public partial class BigDataPoolLibraryRequirements
    {
        ...
        internal BigDataPoolLibraryRequirements(DateTimeOffset? updatedOn, string content, string filename, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            UpdatedOn = updatedOn;
            Content = content;
            Filename = filename;
