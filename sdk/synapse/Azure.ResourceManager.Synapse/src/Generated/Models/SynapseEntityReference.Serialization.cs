...
{
    public partial class SynapseEntityReference : IUtf8JsonSerializable, IJsonModel<SynapseEntityReference>, IPersistableModel<SynapseEntityReference>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  type:");
                builder.AppendLine($" '{IntegrationRuntimeEntityReferenceType.ToString()}'");
            }
