...
{
    public partial class WorkspaceAadAdminInfoData : IUtf8JsonSerializable
    {
        ...
        internal static WorkspaceAadAdminInfoData DeserializeWorkspaceAadAdminInfoData(JsonElement element)
        {
            ...
            return new WorkspaceAadAdminInfoData(id, name, type, systemData.Value, Optional.ToNullable(tenantId), login.Value, administratorType.Value, sid.Value);
        }
    }
}
