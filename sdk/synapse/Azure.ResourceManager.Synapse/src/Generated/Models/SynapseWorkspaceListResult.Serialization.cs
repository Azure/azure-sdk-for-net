...
namespace Azure.ResourceManager.Synapse.Models
{
    ...
    {
        internal static SynapseWorkspaceListResult DeserializeSynapseWorkspaceListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
