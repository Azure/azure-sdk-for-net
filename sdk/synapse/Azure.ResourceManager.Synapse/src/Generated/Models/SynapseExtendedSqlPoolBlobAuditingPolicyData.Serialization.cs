...
namespace Azure.ResourceManager.Synapse
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SynapseExtendedSqlPoolBlobAuditingPolicyData>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<SynapseExtendedSqlPoolBlobAuditingPolicyData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SynapseExtendedSqlPoolBlobAuditingPolicyData>)} interface");
            }
        ...
        string IPersistableModel<SynapseExtendedSqlPoolBlobAuditingPolicyData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
