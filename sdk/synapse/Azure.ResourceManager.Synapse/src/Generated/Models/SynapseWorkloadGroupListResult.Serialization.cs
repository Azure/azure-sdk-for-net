...
namespace Azure.ResourceManager.Synapse.Models
{
    ...
    {
        internal static SynapseWorkloadGroupListResult DeserializeSynapseWorkloadGroupListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
