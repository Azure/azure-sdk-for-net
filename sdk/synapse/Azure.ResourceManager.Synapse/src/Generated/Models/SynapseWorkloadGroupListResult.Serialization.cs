...
namespace Azure.ResourceManager.Synapse.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SynapseWorkloadGroupListResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SynapseWorkloadGroupListResult)} does not support writing '{format}' format.");
            }
            ...
            if (options.Format != "W" && Optional.IsCollectionDefined(Value))
            {
                ...
                {
                    ((IJsonModel<SynapseWorkloadGroupData>)item).Write(writer, options);
                }
        ...
        SynapseWorkloadGroupListResult IJsonModel<SynapseWorkloadGroupListResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SynapseWorkloadGroupListResult)} does not support reading '{format}' format.");
            }
        ...
        internal static SynapseWorkloadGroupListResult DeserializeSynapseWorkloadGroupListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new SynapseWorkloadGroupListResult(value ?? new ChangeTrackingList<SynapseWorkloadGroupData>(), nextLink, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<SynapseWorkloadGroupListResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SynapseWorkloadGroupListResult)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        SynapseWorkloadGroupListResult IPersistableModel<SynapseWorkloadGroupListResult>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SynapseWorkloadGroupListResult)} does not support reading '{options.Format}' format.");
            }
        }
