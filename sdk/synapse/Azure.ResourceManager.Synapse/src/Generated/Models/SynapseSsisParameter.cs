...
namespace Azure.ResourceManager.Synapse.Models
{
    ...
    public partial class SynapseSsisParameter
    {
        ...
        internal SynapseSsisParameter(long? id, string name, string description, string dataType, bool? isRequired, bool? isSensitive, string designDefaultValue, string defaultValue, string sensitiveDefaultValue, string valueType, bool? valueSet, string variable, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Name = name;
