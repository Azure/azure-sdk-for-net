...
namespace Azure.ResourceManager.Synapse.Models
{
    public partial class SynapseManagedIntegrationRuntime : IUtf8JsonSerializable, IJsonModel<SynapseManagedIntegrationRuntime>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("    type:");
                if (TypeManagedVirtualNetworkType.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(ComputeProperties))
            {
                ...
                AppendChildObject(builder, ComputeProperties, options, 4, false);
            }

            if (Optional.IsDefined(SsisProperties))
            {
                builder.Append("    ssisProperties:");
                AppendChildObject(builder, SsisProperties, options, 4, false);
            }
