...
namespace Azure.ResourceManager.Synapse.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CspWorkspaceAdminProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CspWorkspaceAdminProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CspWorkspaceAdminProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<CspWorkspaceAdminProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
