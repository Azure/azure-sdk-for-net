...
namespace Azure.ResourceManager.Synapse.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SynapseIntegrationRuntimeNodeMonitoringResult>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<SynapseIntegrationRuntimeNodeMonitoringResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SynapseIntegrationRuntimeNodeMonitoringResult>)} interface");
            }
        ...
        string IPersistableModel<SynapseIntegrationRuntimeNodeMonitoringResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
