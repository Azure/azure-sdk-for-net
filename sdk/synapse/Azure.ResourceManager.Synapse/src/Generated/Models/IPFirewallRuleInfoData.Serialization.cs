...
{
    public partial class IPFirewallRuleInfoData : IUtf8JsonSerializable
    {
        ...
        internal static IPFirewallRuleInfoData DeserializeIPFirewallRuleInfoData(JsonElement element)
        {
            ...
            return new IPFirewallRuleInfoData(id, name, type, systemData.Value, endIPAddress.Value, Optional.ToNullable(provisioningState), startIPAddress.Value);
        }
    }
}
