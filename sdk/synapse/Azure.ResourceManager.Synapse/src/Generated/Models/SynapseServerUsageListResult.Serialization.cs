...
namespace Azure.ResourceManager.Synapse.Models
{
    ...
    {
        internal static SynapseServerUsageListResult DeserializeSynapseServerUsageListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
