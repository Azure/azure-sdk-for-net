...
{
    public partial class SynapseWorkloadGroupData : IUtf8JsonSerializable, IModelJsonSerializable<SynapseWorkloadGroupData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IModelJsonSerializable<SynapseWorkloadGroupData>)this).Serialize(writer, ModelSerializerOptions.DefaultWireOptions);

        void IModelJsonSerializable<SynapseWorkloadGroupData>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<SynapseWorkloadGroupData>(this, options.Format);
        ...
        internal static SynapseWorkloadGroupData DeserializeSynapseWorkloadGroupData(JsonElement element, ModelSerializerOptions options = default)
        {
        ...
        SynapseWorkloadGroupData IModelJsonSerializable<SynapseWorkloadGroupData>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<SynapseWorkloadGroupData>(this, options.Format);

            using var doc = JsonDocument.ParseValue(ref reader);
            return DeserializeSynapseWorkloadGroupData(doc.RootElement, options);
        }

        BinaryData IModelSerializable<SynapseWorkloadGroupData>.Serialize(ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<SynapseWorkloadGroupData>(this, options.Format);
        ...
        SynapseWorkloadGroupData IModelSerializable<SynapseWorkloadGroupData>.Deserialize(BinaryData data, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<SynapseWorkloadGroupData>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="SynapseWorkloadGroupData"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="SynapseWorkloadGroupData"/> to convert. </param>
        public static implicit operator RequestContent(SynapseWorkloadGroupData model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="SynapseWorkloadGroupData"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator SynapseWorkloadGroupData(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeSynapseWorkloadGroupData(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
