...
namespace Azure.ResourceManager.Synapse
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SynapseWorkloadGroupData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SynapseWorkloadGroupData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SynapseWorkloadGroupData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SynapseWorkloadGroupData>)} interface");
            }
        ...
        string IPersistableModel<SynapseWorkloadGroupData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
