...
namespace Azure.ResourceManager.Synapse.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SynapseCustomSetupBase>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SynapseCustomSetupBase>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SynapseCustomSetupBase>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<SynapseCustomSetupBase>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
