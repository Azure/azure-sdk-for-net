...
{
    public partial class SynapsePrivateLinkResourceData : IUtf8JsonSerializable
    {
        ...
        internal static SynapsePrivateLinkResourceData DeserializeSynapsePrivateLinkResourceData(JsonElement element)
        {
            ...
            return new SynapsePrivateLinkResourceData(id, name, type, systemData.Value, properties.Value);
        }
    }
}
