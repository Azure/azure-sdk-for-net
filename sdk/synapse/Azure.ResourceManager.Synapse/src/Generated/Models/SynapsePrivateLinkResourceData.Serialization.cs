...
namespace Azure.ResourceManager.Synapse
{
    public partial class SynapsePrivateLinkResourceData : IUtf8JsonSerializable, IJsonModel<SynapsePrivateLinkResourceData>
    {
        ...
        void IJsonModel<SynapsePrivateLinkResourceData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(SynapsePrivateLinkResourceData)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<SynapsePrivateLinkResourceData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(SynapsePrivateLinkResourceData)} does not support '{options.Format}' format.");
            }
        }
