...
{
    public partial class SqlPoolColumnData : IUtf8JsonSerializable
    {
        ...
        internal static SqlPoolColumnData DeserializeSqlPoolColumnData(JsonElement element)
        {
            ...
            return new SqlPoolColumnData(id, name, type, systemData.Value, Optional.ToNullable(columnType), Optional.ToNullable(isComputed));
        }
    }
}
