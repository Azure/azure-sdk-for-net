...
{
    public partial class SynapseIntegrationRuntimeAuthKeys : IUtf8JsonSerializable, IJsonModel<SynapseIntegrationRuntimeAuthKeys>, IPersistableModel<SynapseIntegrationRuntimeAuthKeys>
    {
        ...
        void IJsonModel<SynapseIntegrationRuntimeAuthKeys>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SynapseIntegrationRuntimeAuthKeys)} does not support '{format}' format.");
            }
