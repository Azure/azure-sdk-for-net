...
namespace Azure.ResourceManager.Synapse
{
    ...
    public partial class SynapseExtendedSqlPoolBlobAuditingPolicyResource : ArmResource
    {
        ...
        internal SynapseExtendedSqlPoolBlobAuditingPolicyResource(ArmClient client, SynapseExtendedSqlPoolBlobAuditingPolicyData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<SynapseExtendedSqlPoolBlobAuditingPolicyResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new SynapseExtendedSqlPoolBlobAuditingPolicyResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual async Task<ArmOperation<SynapseExtendedSqlPoolBlobAuditingPolicyResource>> CreateOrUpdateAsync(WaitUntil waitUntil, SynapseExtendedSqlPoolBlobAuditingPolicyData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new SynapseArmOperation<SynapseExtendedSqlPoolBlobAuditingPolicyResource>(Response.FromValue(new SynapseExtendedSqlPoolBlobAuditingPolicyResource(Client, response.Value, response.Value.Id), response.GetRawResponse()));
