...
namespace Azure.ResourceManager.Synapse
{
    ...
    public partial class SynapseServerSecurityAlertPolicyResource : ArmResource
    {
        ...
        internal SynapseServerSecurityAlertPolicyResource(ArmClient client, SynapseServerSecurityAlertPolicyData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<SynapseServerSecurityAlertPolicyResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new SynapseServerSecurityAlertPolicyResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
