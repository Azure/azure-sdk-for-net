...
namespace Azure.ResourceManager.Synapse
{
    ...
    public partial class SynapseMetadataSyncConfigurationData : ResourceData
    {
        ...
        internal SynapseMetadataSyncConfigurationData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, bool? isEnabled, int? syncIntervalInMinutes, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData)
        {
            IsEnabled = isEnabled;
