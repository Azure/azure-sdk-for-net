...
namespace Azure.ResourceManager.Synapse
{
    ...
    public partial class SynapsePrivateEndpointConnectionForPrivateLinkHubData : ResourceData
    {
        ...
        internal SynapsePrivateEndpointConnectionForPrivateLinkHubData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, SynapsePrivateEndpointConnectionProperties properties, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
