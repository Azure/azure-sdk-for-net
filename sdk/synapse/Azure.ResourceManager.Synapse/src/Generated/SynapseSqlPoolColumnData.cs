...
namespace Azure.ResourceManager.Synapse
{
    ...
    public partial class SynapseSqlPoolColumnData : ResourceData
    {
        ...
        internal SynapseSqlPoolColumnData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, SqlPoolColumnDataType? columnType, bool? isComputed, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
