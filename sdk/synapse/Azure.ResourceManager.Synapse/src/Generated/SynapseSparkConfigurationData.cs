...
namespace Azure.ResourceManager.Synapse
{
    ...
    public partial class SynapseSparkConfigurationData : ResourceData
    {
        ...
        internal SynapseSparkConfigurationData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string description, IDictionary<string, string> configs, IList<string> annotations, string notes, string createdBy, DateTimeOffset? createdOn, IDictionary<string, string> configMergeRule, ETag? etag, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData)
        {
