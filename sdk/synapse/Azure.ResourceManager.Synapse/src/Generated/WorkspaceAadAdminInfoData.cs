...
{
    /// <summary> A class representing the WorkspaceAadAdminInfo data model. </summary>
    public partial class WorkspaceAadAdminInfoData : ResourceData
    {
        ...
        internal WorkspaceAadAdminInfoData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, Guid? tenantId, string login, string administratorType, string sid) : base(id, name, resourceType, systemData)
        {
            TenantId = tenantId;
            Login = login;
