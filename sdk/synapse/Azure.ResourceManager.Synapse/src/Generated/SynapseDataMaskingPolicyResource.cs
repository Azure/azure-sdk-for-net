...
namespace Azure.ResourceManager.Synapse
{
    ...
    public partial class SynapseDataMaskingPolicyResource : ArmResource
    {
        ...
        internal SynapseDataMaskingPolicyResource(ArmClient client, SynapseDataMaskingPolicyData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<SynapseDataMaskingPolicyResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new SynapseDataMaskingPolicyResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual async Task<ArmOperation<SynapseDataMaskingPolicyResource>> CreateOrUpdateAsync(WaitUntil waitUntil, SynapseDataMaskingPolicyData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new SynapseArmOperation<SynapseDataMaskingPolicyResource>(Response.FromValue(new SynapseDataMaskingPolicyResource(Client, response.Value, response.Value.Id), response.GetRawResponse()));
