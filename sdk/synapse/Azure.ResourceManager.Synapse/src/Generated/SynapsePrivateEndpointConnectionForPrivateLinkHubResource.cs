...
namespace Azure.ResourceManager.Synapse
{
    ...
    public partial class SynapsePrivateEndpointConnectionForPrivateLinkHubResource : ArmResource
    {
        ...
        internal SynapsePrivateEndpointConnectionForPrivateLinkHubResource(ArmClient client, SynapsePrivateEndpointConnectionForPrivateLinkHubData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<SynapsePrivateEndpointConnectionForPrivateLinkHubResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new SynapsePrivateEndpointConnectionForPrivateLinkHubResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
