...
{
    /// <summary> A class representing the PrivateLinkHub data model. </summary>
    public partial class PrivateLinkHubData : TrackedResourceData
    {
        /// <summary> Initializes a new instance of PrivateLinkHubData. </summary>
        /// <param name="location"> The location. </param>
        public PrivateLinkHubData(AzureLocation location) : base(location)
        {
