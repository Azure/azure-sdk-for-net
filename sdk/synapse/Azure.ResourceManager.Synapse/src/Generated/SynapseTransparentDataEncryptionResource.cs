...
namespace Azure.ResourceManager.Synapse
{
    ...
    public partial class SynapseTransparentDataEncryptionResource : ArmResource
    {
        ...
        internal SynapseTransparentDataEncryptionResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            _synapseTransparentDataEncryptionSqlPoolTransparentDataEncryptionsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Synapse", ResourceType.Namespace, Diagnostics);
            TryGetApiVersion(ResourceType, out string synapseTransparentDataEncryptionSqlPoolTransparentDataEncryptionsApiVersion);
        ...
        public virtual SynapseTransparentDataEncryptionData Data
        {
            get
            {
                if (!HasData)
        ...
        public virtual async Task<Response<SynapseTransparentDataEncryptionResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            using var scope = _synapseTransparentDataEncryptionSqlPoolTransparentDataEncryptionsClientDiagnostics.CreateScope("SynapseTransparentDataEncryptionResource.Get");
            scope.Start();
            try
            {
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<SynapseTransparentDataEncryptionResource> Get(CancellationToken cancellationToken = default)
        {
            using var scope = _synapseTransparentDataEncryptionSqlPoolTransparentDataEncryptionsClientDiagnostics.CreateScope("SynapseTransparentDataEncryptionResource.Get");
            scope.Start();
            try
