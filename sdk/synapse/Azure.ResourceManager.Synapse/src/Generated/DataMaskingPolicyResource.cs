...
namespace Azure.ResourceManager.Synapse
{
    ...
    /// Otherwise you can get one from its parent resource <see cref="SqlPoolResource" /> using the GetDataMaskingPolicy method.
    /// </summary>
    public partial class DataMaskingPolicyResource : ArmResource
    {
        ...
        {
            _dataMaskingPolicyClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Synapse", ResourceType.Namespace, Diagnostics);
        ...
        /// <summary> Gets a collection of DataMaskingRuleResources in the DataMaskingPolicy. </summary>
        /// <returns> An object representing collection of DataMaskingRuleResources and their operations over a DataMaskingRuleResource. </returns>
        public virtual DataMaskingRuleCollection GetDataMaskingRules()
        {
            return GetCachedClient(Client => new DataMaskingRuleCollection(Client, Id));
        }
        ...
        [ForwardsClientCalls]
        public virtual async Task<Response<DataMaskingRuleResource>> GetDataMaskingRuleAsync(string dataMaskingRuleName, CancellationToken cancellationToken = default)
        {
            return await GetDataMaskingRules().GetAsync(dataMaskingRuleName, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="dataMaskingRuleName"/> is null. </exception>
        [ForwardsClientCalls]
        public virtual Response<DataMaskingRuleResource> GetDataMaskingRule(string dataMaskingRuleName, CancellationToken cancellationToken = default)
        {
            return GetDataMaskingRules().Get(dataMaskingRuleName, cancellationToken);
        }
        ...
        public virtual async Task<ArmOperation<DataMaskingPolicyResource>> CreateOrUpdateAsync(WaitUntil waitUntil, DataMaskingPolicyData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _dataMaskingPolicyRestClient.CreateOrUpdateAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, data, cancellationToken).ConfigureAwait(false);
                var operation = new SynapseArmOperation<DataMaskingPolicyResource>(Response.FromValue(new DataMaskingPolicyResource(Client, response), response.GetRawResponse()));
        ...
        public virtual ArmOperation<DataMaskingPolicyResource> CreateOrUpdate(WaitUntil waitUntil, DataMaskingPolicyData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _dataMaskingPolicyRestClient.CreateOrUpdate(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, data, cancellationToken);
                var operation = new SynapseArmOperation<DataMaskingPolicyResource>(Response.FromValue(new DataMaskingPolicyResource(Client, response), response.GetRawResponse()));
                if (waitUntil == WaitUntil.Completed)
