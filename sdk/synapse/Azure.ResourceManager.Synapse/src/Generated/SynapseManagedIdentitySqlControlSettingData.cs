...
namespace Azure.ResourceManager.Synapse
{
    ...
    public partial class SynapseManagedIdentitySqlControlSettingData : ResourceData
    {
        ...
        internal SynapseManagedIdentitySqlControlSettingData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, SynapseGrantSqlControlToManagedIdentity grantSqlControlToManagedIdentity, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData)
        {
