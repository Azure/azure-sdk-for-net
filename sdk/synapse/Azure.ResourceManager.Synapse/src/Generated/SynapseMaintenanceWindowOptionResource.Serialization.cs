...
namespace Azure.ResourceManager.Synapse
{
    public partial class SynapseMaintenanceWindowOptionResource : IJsonModel<SynapseMaintenanceWindowOptionData>
    {
        ...
        {
            return ModelReaderWriter.Read<SynapseMaintenanceWindowOptionData>(new BinaryData(reader.ValueSequence), options);
        }
        ...
        {
            return ModelReaderWriter.Read<SynapseMaintenanceWindowOptionData>(data, options);
        }
