...
namespace Azure.ResourceManager.Synapse
{
    ...
    public partial class SynapseEncryptionProtectorResource : ArmResource
    {
        ...
        internal SynapseEncryptionProtectorResource(ArmClient client, SynapseEncryptionProtectorData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<SynapseEncryptionProtectorResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new SynapseEncryptionProtectorResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
