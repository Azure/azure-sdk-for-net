...
{
    /// <summary> A class representing the RecoverableSqlPool data model. </summary>
    public partial class RecoverableSqlPoolData : ResourceData
    {
        ...
        internal RecoverableSqlPoolData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string edition, string serviceLevelObjective, string elasticPoolName, DateTimeOffset? lastAvailableBackupOn) : base(id, name, resourceType, systemData)
        {
            Edition = edition;
