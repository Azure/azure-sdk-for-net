...
namespace Azure.ResourceManager.Synapse
{
    ...
    public partial class SynapseSqlPoolConnectionPolicyData : ResourceData
    {
        ...
        internal SynapseSqlPoolConnectionPolicyData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string kind, AzureLocation? location, string securityEnabledAccess, string proxyDnsName, string proxyPort, string visibility, string useServerDefault, string redirectionState, string state, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData)
        {
            Kind = kind;
            Location = location;
