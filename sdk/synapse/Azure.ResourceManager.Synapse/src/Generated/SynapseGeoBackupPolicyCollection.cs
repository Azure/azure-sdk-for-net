...
namespace Azure.ResourceManager.Synapse
{
    ...
    public partial class SynapseGeoBackupPolicyCollection : ArmCollection, IEnumerable<SynapseGeoBackupPolicyResource>, IAsyncEnumerable<SynapseGeoBackupPolicyResource>
    {
        ...
        {
            async Task<Page<SynapseGeoBackupPolicyResource>> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _synapseGeoBackupPolicySqlPoolGeoBackupPoliciesClientDiagnostics.CreateScope("SynapseGeoBackupPolicyCollection.GetAll");
                scope.Start();
                try
                {
                    var response = await _synapseGeoBackupPolicySqlPoolGeoBackupPoliciesRestClient.ListAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new SynapseGeoBackupPolicyResource(Client, value)), null, response.GetRawResponse());
                }
                catch (Exception e)
                {
                    scope.Failed(e);
        ...
        {
            Page<SynapseGeoBackupPolicyResource> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _synapseGeoBackupPolicySqlPoolGeoBackupPoliciesClientDiagnostics.CreateScope("SynapseGeoBackupPolicyCollection.GetAll");
                scope.Start();
                try
                {
                    var response = _synapseGeoBackupPolicySqlPoolGeoBackupPoliciesRestClient.List(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new SynapseGeoBackupPolicyResource(Client, value)), null, response.GetRawResponse());
                }
                catch (Exception e)
                {
