...
namespace Azure.ResourceManager.Synapse
{
    ...
    public partial class SynapseIntegrationRuntimeCollection : ArmCollection, IEnumerable<SynapseIntegrationRuntimeResource>, IAsyncEnumerable<SynapseIntegrationRuntimeResource>
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="SynapseIntegrationRuntimeCollection"/> class for mocking. </summary>
        protected SynapseIntegrationRuntimeCollection()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="SynapseIntegrationRuntimeCollection"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the parent resource that is the target of operations. </param>
        internal SynapseIntegrationRuntimeCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            _synapseIntegrationRuntimeIntegrationRuntimesClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Synapse", SynapseIntegrationRuntimeResource.ResourceType.Namespace, Diagnostics);
            TryGetApiVersion(SynapseIntegrationRuntimeResource.ResourceType, out string synapseIntegrationRuntimeIntegrationRuntimesApiVersion);
        ...
        public virtual async Task<Response<SynapseIntegrationRuntimeResource>> GetAsync(string integrationRuntimeName, string ifNoneMatch = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _synapseIntegrationRuntimeIntegrationRuntimesRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, integrationRuntimeName, ifNoneMatch, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<SynapseIntegrationRuntimeResource> Get(string integrationRuntimeName, string ifNoneMatch = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _synapseIntegrationRuntimeIntegrationRuntimesRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, integrationRuntimeName, ifNoneMatch, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new SynapseIntegrationRuntimeResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        /// <item>
        /// <term>Request Path</term>
        /// <description>/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Synapse/workspaces/{workspaceName}/integrationRuntimes</description>
        /// </item>
        /// <item>
        /// <term>Operation Id</term>
        ...
        IEnumerator<SynapseIntegrationRuntimeResource> IEnumerable<SynapseIntegrationRuntimeResource>.GetEnumerator()
        {
        ...
        IAsyncEnumerator<SynapseIntegrationRuntimeResource> IAsyncEnumerable<SynapseIntegrationRuntimeResource>.GetAsyncEnumerator(CancellationToken cancellationToken)
        {
