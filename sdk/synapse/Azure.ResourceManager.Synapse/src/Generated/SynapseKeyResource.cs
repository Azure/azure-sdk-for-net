    ...
    public partial class SynapseKeyResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<SynapseKeyResource>> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var uri = _synapseKeyKeysRestClient.CreateDeleteRequestUri(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name);
        ...
        public virtual async Task<ArmOperation<SynapseKeyResource>> UpdateAsync(WaitUntil waitUntil, SynapseKeyData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var uri = _synapseKeyKeysRestClient.CreateCreateOrUpdateRequestUri(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, data);
