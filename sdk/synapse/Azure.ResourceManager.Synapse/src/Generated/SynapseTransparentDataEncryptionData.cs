...
namespace Azure.ResourceManager.Synapse
{
    ...
    public partial class SynapseTransparentDataEncryptionData : ResourceData
    {
        ...
        internal SynapseTransparentDataEncryptionData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, AzureLocation? location, SynapseTransparentDataEncryptionStatus? status, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
            Location = location;
            Status = status;
