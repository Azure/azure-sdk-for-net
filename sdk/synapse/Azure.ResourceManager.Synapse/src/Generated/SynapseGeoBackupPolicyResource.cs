    ...
    public partial class SynapseGeoBackupPolicyResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<SynapseGeoBackupPolicyResource>> UpdateAsync(WaitUntil waitUntil, SynapseGeoBackupPolicyData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new SynapseArmOperation<SynapseGeoBackupPolicyResource>(Response.FromValue(new SynapseGeoBackupPolicyResource(Client, response), response.GetRawResponse()), operationId);
