...
namespace Azure.ResourceManager.Synapse
{
    ...
    public partial class SynapseGeoBackupPolicyData : ResourceData
    {
        ...
        internal SynapseGeoBackupPolicyData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string kind, AzureLocation? location, SynapseGeoBackupPolicyState state, string storageType, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData)
        {
            Kind = kind;
            Location = location;
            State = state;
