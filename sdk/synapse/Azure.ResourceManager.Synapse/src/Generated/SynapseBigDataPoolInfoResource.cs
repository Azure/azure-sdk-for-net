...
namespace Azure.ResourceManager.Synapse
{
    ...
    public partial class SynapseBigDataPoolInfoResource : ArmResource
    {
        ...
        internal SynapseBigDataPoolInfoResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            _synapseBigDataPoolInfoBigDataPoolsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Synapse", ResourceType.Namespace, Diagnostics);
            TryGetApiVersion(ResourceType, out string synapseBigDataPoolInfoBigDataPoolsApiVersion);
        ...
        public virtual SynapseBigDataPoolInfoData Data
        {
            get
            {
                if (!HasData)
        ...
        public virtual async Task<Response<SynapseBigDataPoolInfoResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            using var scope = _synapseBigDataPoolInfoBigDataPoolsClientDiagnostics.CreateScope("SynapseBigDataPoolInfoResource.Get");
            scope.Start();
            try
            {
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<SynapseBigDataPoolInfoResource> Get(CancellationToken cancellationToken = default)
        {
            using var scope = _synapseBigDataPoolInfoBigDataPoolsClientDiagnostics.CreateScope("SynapseBigDataPoolInfoResource.Get");
            scope.Start();
            try
        ...
        {
            using var scope = _synapseBigDataPoolInfoBigDataPoolsClientDiagnostics.CreateScope("SynapseBigDataPoolInfoResource.Delete");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response<SynapseBigDataPoolInfoResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    var patch = new SynapseBigDataPoolInfoPatch();
