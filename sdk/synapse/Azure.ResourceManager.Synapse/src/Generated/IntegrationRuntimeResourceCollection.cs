...
namespace Azure.ResourceManager.Synapse
{
    ...
    /// Each <see cref="IntegrationRuntimeResource" /> in the collection will belong to the same instance of <see cref="WorkspaceResource" />.
    /// To get an <see cref="IntegrationRuntimeResourceCollection" /> instance call the GetIntegrationRuntimeResources method from an instance of <see cref="WorkspaceResource" />.
    /// </summary>
    public partial class IntegrationRuntimeResourceCollection : ArmCollection, IEnumerable<IntegrationRuntimeResource>, IAsyncEnumerable<IntegrationRuntimeResource>
    {
        ...
        {
            _integrationRuntimeResourceIntegrationRuntimesClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Synapse", IntegrationRuntimeResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<IntegrationRuntimeResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string integrationRuntimeName, IntegrationRuntimeResourceData data, string ifMatch = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _integrationRuntimeResourceIntegrationRuntimesRestClient.CreateAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, integrationRuntimeName, data, ifMatch, cancellationToken).ConfigureAwait(false);
                var operation = new SynapseArmOperation<IntegrationRuntimeResource>(new IntegrationRuntimeResourceOperationSource(Client), _integrationRuntimeResourceIntegrationRuntimesClientDiagnostics, Pipeline, _integrationRuntimeResourceIntegrationRuntimesRestClient.CreateCreateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, integrationRuntimeName, data, ifMatch).Request, response, OperationFinalStateVia.NotSpecified);
        ...
        public virtual ArmOperation<IntegrationRuntimeResource> CreateOrUpdate(WaitUntil waitUntil, string integrationRuntimeName, IntegrationRuntimeResourceData data, string ifMatch = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _integrationRuntimeResourceIntegrationRuntimesRestClient.Create(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, integrationRuntimeName, data, ifMatch, cancellationToken);
                var operation = new SynapseArmOperation<IntegrationRuntimeResource>(new IntegrationRuntimeResourceOperationSource(Client), _integrationRuntimeResourceIntegrationRuntimesClientDiagnostics, Pipeline, _integrationRuntimeResourceIntegrationRuntimesRestClient.CreateCreateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, integrationRuntimeName, data, ifMatch).Request, response, OperationFinalStateVia.NotSpecified);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual AsyncPageable<IntegrationRuntimeResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            async Task<Page<IntegrationRuntimeResource>> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _integrationRuntimeResourceIntegrationRuntimesRestClient.ListByWorkspaceAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken).ConfigureAwait(false);
            ...
            async Task<Page<IntegrationRuntimeResource>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _integrationRuntimeResourceIntegrationRuntimesRestClient.ListByWorkspaceNextPageAsync(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new IntegrationRuntimeResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual Pageable<IntegrationRuntimeResource> GetAll(CancellationToken cancellationToken = default)
        {
            Page<IntegrationRuntimeResource> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _integrationRuntimeResourceIntegrationRuntimesRestClient.ListByWorkspace(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new IntegrationRuntimeResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            Page<IntegrationRuntimeResource> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _integrationRuntimeResourceIntegrationRuntimesRestClient.ListByWorkspaceNextPage(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new IntegrationRuntimeResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
