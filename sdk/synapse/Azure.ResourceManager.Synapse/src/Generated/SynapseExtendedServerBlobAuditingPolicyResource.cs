...
namespace Azure.ResourceManager.Synapse
{
    ...
    public partial class SynapseExtendedServerBlobAuditingPolicyResource : ArmResource
    {
        ...
        internal SynapseExtendedServerBlobAuditingPolicyResource(ArmClient client, SynapseExtendedServerBlobAuditingPolicyData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
