...
namespace Azure.ResourceManager.Synapse
{
    ...
    public partial class SynapseDataConnectionResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                using var message = _synapseDataConnectionKustoPoolDataConnectionsRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name);
                var response = await _synapseDataConnectionKustoPoolDataConnectionsRestClient.DeleteAsync(message, cancellationToken).ConfigureAwait(false);
                var operation = new SynapseArmOperation(_synapseDataConnectionKustoPoolDataConnectionsClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
        ...
        public virtual ArmOperation Delete(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var message = _synapseDataConnectionKustoPoolDataConnectionsRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name);
                var response = _synapseDataConnectionKustoPoolDataConnectionsRestClient.Delete(message, cancellationToken);
                var operation = new SynapseArmOperation(_synapseDataConnectionKustoPoolDataConnectionsClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<ArmOperation<SynapseDataConnectionResource>> UpdateAsync(WaitUntil waitUntil, SynapseDataConnectionData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                using var message = _synapseDataConnectionKustoPoolDataConnectionsRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, data);
                var response = await _synapseDataConnectionKustoPoolDataConnectionsRestClient.UpdateAsync(message, cancellationToken).ConfigureAwait(false);
        ...
        public virtual ArmOperation<SynapseDataConnectionResource> Update(WaitUntil waitUntil, SynapseDataConnectionData data, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var message = _synapseDataConnectionKustoPoolDataConnectionsRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, data);
                var response = _synapseDataConnectionKustoPoolDataConnectionsRestClient.Update(message, cancellationToken);
                var operation = new SynapseArmOperation<SynapseDataConnectionResource>(new SynapseDataConnectionOperationSource(Client), _synapseDataConnectionKustoPoolDataConnectionsClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
