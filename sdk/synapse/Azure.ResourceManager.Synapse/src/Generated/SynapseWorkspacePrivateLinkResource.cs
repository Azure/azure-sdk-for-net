...
namespace Azure.ResourceManager.Synapse
{
    ...
    public partial class SynapseWorkspacePrivateLinkResource : ArmResource
    {
        ...
        internal SynapseWorkspacePrivateLinkResource(ArmClient client, SynapsePrivateLinkResourceData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<SynapseWorkspacePrivateLinkResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new SynapseWorkspacePrivateLinkResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
