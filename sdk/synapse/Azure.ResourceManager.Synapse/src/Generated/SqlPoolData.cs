...
{
    /// <summary> A class representing the SqlPool data model. </summary>
    public partial class SqlPoolData : TrackedResourceData
    {
        /// <summary> Initializes a new instance of SqlPoolData. </summary>
        /// <param name="location"> The location. </param>
        public SqlPoolData(AzureLocation location) : base(location)
        {
        }
