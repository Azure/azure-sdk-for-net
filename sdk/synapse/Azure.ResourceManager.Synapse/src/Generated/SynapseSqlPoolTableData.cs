...
namespace Azure.ResourceManager.Synapse
{
    ...
    public partial class SynapseSqlPoolTableData : ResourceData
    {
        ...
        internal SynapseSqlPoolTableData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
