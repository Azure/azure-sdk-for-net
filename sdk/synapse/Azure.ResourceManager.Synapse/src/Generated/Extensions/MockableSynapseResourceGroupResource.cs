...
namespace Azure.ResourceManager.Synapse.Mocking
{
    ...
    public partial class MockableSynapseResourceGroupResource : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="MockableSynapseResourceGroupResource"/> class for mocking. </summary>
        protected MockableSynapseResourceGroupResource()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MockableSynapseResourceGroupResource"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MockableSynapseResourceGroupResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        {
            return await GetSynapsePrivateLinkHubs().GetAsync(privateLinkHubName, cancellationToken).ConfigureAwait(false);
        }
        ...
        {
            return GetSynapsePrivateLinkHubs().Get(privateLinkHubName, cancellationToken);
        }
        ...
        {
            return await GetSynapseWorkspaces().GetAsync(workspaceName, cancellationToken).ConfigureAwait(false);
        }
        ...
        {
            return GetSynapseWorkspaces().Get(workspaceName, cancellationToken);
        }
    }
}
