...
namespace Azure.ResourceManager.Synapse.Mocking
{
    ...
    internal partial class SynapseResourceGroupMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="SynapseResourceGroupMockingExtension"/> class for mocking. </summary>
        protected SynapseResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="SynapseResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal SynapseResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
