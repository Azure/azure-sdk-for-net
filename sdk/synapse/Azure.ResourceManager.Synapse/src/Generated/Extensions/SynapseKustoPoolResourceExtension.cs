...
namespace Azure.ResourceManager.Synapse.Mock
{
    ...
    public partial class SynapseKustoPoolResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="SynapseKustoPoolResourceExtension"/> class for mocking. </summary>
        protected SynapseKustoPoolResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="SynapseKustoPoolResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal SynapseKustoPoolResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<KustoPoolSkuDescription> GetSkusKustoPoolsAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, null, KustoPoolSkuDescription.DeserializeKustoPoolSkuDescription, SynapseKustoPoolKustoPoolsClientDiagnostics, Pipeline, "SynapseKustoPoolResourceExtension.GetSkusKustoPools", "value", null, cancellationToken);
        }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => SynapseKustoPoolKustoPoolsRestClient.CreateListSkusRequest(Id.SubscriptionId);
            return PageableHelpers.CreatePageable(FirstPageRequest, null, KustoPoolSkuDescription.DeserializeKustoPoolSkuDescription, SynapseKustoPoolKustoPoolsClientDiagnostics, Pipeline, "SynapseKustoPoolResourceExtension.GetSkusKustoPools", "value", null, cancellationToken);
        }
        ...
        public virtual async Task<Response<KustoPoolNameAvailabilityResult>> CheckKustoPoolNameAvailabilityAsync(AzureLocation location, KustoPoolNameAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = SynapseKustoPoolKustoPoolsClientDiagnostics.CreateScope("SynapseKustoPoolResourceExtension.CheckKustoPoolNameAvailability");
            scope.Start();
            try
            {
