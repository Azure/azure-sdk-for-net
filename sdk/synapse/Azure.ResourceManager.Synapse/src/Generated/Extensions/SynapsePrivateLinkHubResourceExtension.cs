...
namespace Azure.ResourceManager.Synapse.Mock
{
    ...
    public partial class SynapsePrivateLinkHubResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="SynapsePrivateLinkHubResourceExtension"/> class for mocking. </summary>
        protected SynapsePrivateLinkHubResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="SynapsePrivateLinkHubResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal SynapsePrivateLinkHubResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
