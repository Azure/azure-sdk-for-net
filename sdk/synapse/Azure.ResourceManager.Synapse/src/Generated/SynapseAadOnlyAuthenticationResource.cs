...
namespace Azure.ResourceManager.Synapse
{
    ...
    public partial class SynapseAadOnlyAuthenticationResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<SynapseAadOnlyAuthenticationResource>> UpdateAsync(WaitUntil waitUntil, SynapseAadOnlyAuthenticationData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                using var message = _synapseAadOnlyAuthenticationAzureADOnlyAuthenticationsRestClient.CreateCreateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, data);
