...
namespace Azure.ResourceManager.Synapse
{
    ...
    public partial class SynapsePrivateEndpointConnectionResource : ArmResource
    {
        ...
        internal SynapsePrivateEndpointConnectionResource(ArmClient client, SynapsePrivateEndpointConnectionData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<SynapsePrivateEndpointConnectionResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new SynapsePrivateEndpointConnectionResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
