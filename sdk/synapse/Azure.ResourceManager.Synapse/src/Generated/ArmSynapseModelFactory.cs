...
namespace Azure.ResourceManager.Synapse.Models
{
    ...
    public static partial class ArmSynapseModelFactory
    {
        ...
        {
            return new SynapseAadOnlyAuthenticationData(id, name, resourceType, systemData, isAadOnlyAuthenticationEnabled, state, createdOn, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SynapseIPFirewallRuleInfoData(id, name, resourceType, systemData, endIPAddress, provisioningState, startIPAddress, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SynapseIPFirewallRuleProperties(endIPAddress, provisioningState, startIPAddress, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ReplaceAllFirewallRulesOperationResult(operationId, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SynapseKeyData(id, name, resourceType, systemData, isActiveCmk, keyVaultUri, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SynapsePrivateEndpointConnectionData(id, name, resourceType, systemData, privateEndpointId != null ? ResourceManagerModelFactory.SubResource(privateEndpointId) : null, connectionState, provisioningState, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SynapsePrivateEndpointConnectionProperties(privateEndpointId != null ? ResourceManagerModelFactory.SubResource(privateEndpointId) : null, connectionState, provisioningState, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SynapsePrivateLinkServiceConnectionState(status, description, actionsRequired, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SynapsePrivateLinkResourceData(id, name, resourceType, systemData, properties, new Dictionary<string, BinaryData>());
        }
        ...
        public static SynapsePrivateLinkResourceProperties SynapsePrivateLinkResourceProperties(string groupId = null, IEnumerable<string> requiredMembers = null, IEnumerable<string> requiredZoneNames = null)
        {
            ...
            return new SynapsePrivateLinkResourceProperties(groupId, requiredMembers?.ToList(), requiredZoneNames?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static SynapsePrivateLinkHubData SynapsePrivateLinkHubData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, string provisioningState = null, IEnumerable<PrivateEndpointConnectionForPrivateLinkHubBasic> privateEndpointConnections = null)
        {
            ...
            return new SynapsePrivateLinkHubData(id, name, resourceType, systemData, tags, location, provisioningState, privateEndpointConnections?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new PrivateEndpointConnectionForPrivateLinkHubBasic(id, properties, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SynapsePrivateEndpointConnectionForPrivateLinkHubData(id, name, resourceType, systemData, properties, new Dictionary<string, BinaryData>());
        }
        ...
        public static SynapseSqlPoolData SynapseSqlPoolData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, SynapseSku sku = null, long? maxSizeBytes = null, string collation = null, string sourceDatabaseId = null, string recoverableDatabaseId = null, string provisioningState = null, string status = null, DateTimeOffset? restorePointInTime = null, SqlPoolCreateMode? createMode = null, DateTimeOffset? createdOn = null, SqlPoolStorageAccountType? storageAccountType = null, DateTimeOffset? sourceDatabaseDeletionOn = null)
        {
            ...
            return new SynapseSqlPoolData(id, name, resourceType, systemData, tags, location, sku, maxSizeBytes, collation, sourceDatabaseId, recoverableDatabaseId, provisioningState, status, restorePointInTime, createMode, createdOn, storageAccountType, sourceDatabaseDeletionOn, new Dictionary<string, BinaryData>());
        }
        ...
        public static SynapseSqlPoolPatch SynapseSqlPoolPatch(IDictionary<string, string> tags = null, AzureLocation? location = null, SynapseSku sku = null, long? maxSizeBytes = null, string collation = null, string sourceDatabaseId = null, string recoverableDatabaseId = null, string provisioningState = null, string status = null, DateTimeOffset? restorePointInTime = null, SqlPoolCreateMode? createMode = null, DateTimeOffset? createdOn = null, SqlPoolStorageAccountType? storageAccountType = null, DateTimeOffset? sourceDatabaseDeletionOn = null)
        {
            ...
            return new SynapseSqlPoolPatch(tags, location, sku, maxSizeBytes, collation, sourceDatabaseId, recoverableDatabaseId, provisioningState, status, restorePointInTime, createMode, createdOn, storageAccountType, sourceDatabaseDeletionOn, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SynapseMetadataSyncConfigurationData(id, name, resourceType, systemData, isEnabled, syncIntervalInMinutes, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SynapseGeoBackupPolicyData(id, name, resourceType, systemData, kind, location, state, storageType, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SynapseDataWarehouseUserActivityData(id, name, resourceType, systemData, activeQueriesCount, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SynapseRestorePointData(id, name, resourceType, systemData, location, restorePointType, earliestRestoreOn, restorePointCreationOn, restorePointLabel, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SynapseReplicationLinkData(id, name, resourceType, systemData, location, isTerminationAllowed, replicationMode, partnerServer, partnerDatabase, partnerLocation, role, partnerRole, startOn, percentComplete, replicationState, new Dictionary<string, BinaryData>());
        }
        ...
        public static SynapseMaintenanceWindowData SynapseMaintenanceWindowData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IEnumerable<SynapseMaintenanceWindowTimeRange> timeRanges = null)
        {
            ...
            return new SynapseMaintenanceWindowData(id, name, resourceType, systemData, timeRanges?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static SynapseMaintenanceWindowOptionData SynapseMaintenanceWindowOptionData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, bool? isEnabled = null, IEnumerable<SynapseMaintenanceWindowTimeRange> maintenanceWindowCycles = null, int? minDurationInMinutes = null, int? defaultDurationInMinutes = null, int? minCycles = null, int? timeGranularityInMinutes = null, bool? allowMultipleMaintenanceWindowsPerCycle = null)
        {
            ...
            return new SynapseMaintenanceWindowOptionData(id, name, resourceType, systemData, isEnabled, maintenanceWindowCycles?.ToList(), minDurationInMinutes, defaultDurationInMinutes, minCycles, timeGranularityInMinutes, allowMultipleMaintenanceWindowsPerCycle, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SynapseTransparentDataEncryptionData(id, name, resourceType, systemData, location, status, new Dictionary<string, BinaryData>());
        }
        ...
        public static SynapseSqlPoolBlobAuditingPolicyData SynapseSqlPoolBlobAuditingPolicyData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string kind = null, SynapseBlobAuditingPolicyState? state = null, string storageEndpoint = null, string storageAccountAccessKey = null, int? retentionDays = null, IEnumerable<string> auditActionsAndGroups = null, Guid? storageAccountSubscriptionId = null, bool? isStorageSecondaryKeyInUse = null, bool? isAzureMonitorTargetEnabled = null)
        {
            ...
            return new SynapseSqlPoolBlobAuditingPolicyData(id, name, resourceType, systemData, kind, state, storageEndpoint, storageAccountAccessKey, retentionDays, auditActionsAndGroups?.ToList(), storageAccountSubscriptionId, isStorageSecondaryKeyInUse, isAzureMonitorTargetEnabled, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SqlPoolUsage(name, resourceName, displayName, currentValue, limit, unit, nextResetOn, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SynapseSensitivityLabelData(id, name, resourceType, systemData, managedBy, schemaName, tableName, columnName, labelName, labelId, informationType, informationTypeId, isDisabled, rank, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SynapseSensitivityLabelUpdate(id, name, resourceType, systemData, op, schema, table, column, sensitivityLabel, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SynapseRecommendedSensitivityLabelUpdate(id, name, resourceType, systemData, op, schema, table, column, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SynapseSqlPoolSchemaData(id, name, resourceType, systemData, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SynapseSqlPoolTableData(id, name, resourceType, systemData, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SynapseSqlPoolColumnData(id, name, resourceType, systemData, columnType, isComputed, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SynapseSqlPoolConnectionPolicyData(id, name, resourceType, systemData, kind, location, securityEnabledAccess, proxyDnsName, proxyPort, visibility, useServerDefault, redirectionState, state, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SynapseSqlPoolVulnerabilityAssessmentData(id, name, resourceType, systemData, storageContainerPath, storageContainerSasKey, storageAccountAccessKey, recurringScans, new Dictionary<string, BinaryData>());
        }
        ...
        public static SynapseVulnerabilityAssessmentScanRecordData SynapseVulnerabilityAssessmentScanRecordData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string scanId = null, SynapseVulnerabilityAssessmentScanTriggerType? triggerType = null, SynapseVulnerabilityAssessmentScanState? state = null, DateTimeOffset? startOn = null, DateTimeOffset? endOn = null, IEnumerable<SynapseVulnerabilityAssessmentScanError> errors = null, string storageContainerPath = null, int? numberOfFailedSecurityChecks = null)
        {
            ...
            return new SynapseVulnerabilityAssessmentScanRecordData(id, name, resourceType, systemData, scanId, triggerType, state, startOn, endOn, errors?.ToList(), storageContainerPath, numberOfFailedSecurityChecks, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SynapseVulnerabilityAssessmentScanError(code, message, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SqlPoolVulnerabilityAssessmentScansExport(id, name, resourceType, systemData, exportedReportLocation, new Dictionary<string, BinaryData>());
        }
        ...
        public static SynapseSqlPoolSecurityAlertPolicyData SynapseSqlPoolSecurityAlertPolicyData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, SynapseSecurityAlertPolicyState? state = null, IEnumerable<string> disabledAlerts = null, IEnumerable<string> emailAddresses = null, bool? enableEmailToAccountAdmins = null, string storageEndpoint = null, string storageAccountAccessKey = null, int? retentionDays = null, DateTimeOffset? createdOn = null)
        {
            ...
            return new SynapseSqlPoolSecurityAlertPolicyData(id, name, resourceType, systemData, state, disabledAlerts?.ToList(), emailAddresses?.ToList(), enableEmailToAccountAdmins, storageEndpoint, storageAccountAccessKey, retentionDays, createdOn, new Dictionary<string, BinaryData>());
        }
        ...
        public static SynapseSqlPoolVulnerabilityAssessmentRuleBaselineData SynapseSqlPoolVulnerabilityAssessmentRuleBaselineData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IEnumerable<SqlPoolVulnerabilityAssessmentRuleBaselineItem> baselineResults = null)
        {
            ...
            return new SynapseSqlPoolVulnerabilityAssessmentRuleBaselineData(id, name, resourceType, systemData, baselineResults?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SynapseDataMaskingPolicyData(id, name, resourceType, systemData, location, kind, managedBy, dataMaskingState, exemptPrincipals, applicationPrincipals, maskingLevel, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SynapseDataMaskingRuleData(id, name, resourceType, systemData, location, kind, ruleId, aliasName, ruleState, schemaName, tableName, columnName, maskingFunction, numberFrom, numberTo, prefixSize, suffixSize, replacementString, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SynapseWorkloadGroupData(id, name, resourceType, systemData, minResourcePercent, maxResourcePercent, minResourcePercentPerRequest, maxResourcePercentPerRequest, importance, queryExecutionTimeout, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SynapseWorkloadClassifierData(id, name, resourceType, systemData, memberName, label, context, startTime, endTime, importance, new Dictionary<string, BinaryData>());
        }
        ...
        public static SynapseServerSecurityAlertPolicyData SynapseServerSecurityAlertPolicyData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, SynapseSecurityAlertPolicyState? state = null, IEnumerable<string> disabledAlerts = null, IEnumerable<string> emailAddresses = null, bool? enableEmailToAccountAdmins = null, string storageEndpoint = null, string storageAccountAccessKey = null, int? retentionDays = null, DateTimeOffset? createdOn = null)
        {
            ...
            return new SynapseServerSecurityAlertPolicyData(id, name, resourceType, systemData, state, disabledAlerts?.ToList(), emailAddresses?.ToList(), enableEmailToAccountAdmins, storageEndpoint, storageAccountAccessKey, retentionDays, createdOn, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SynapseServerVulnerabilityAssessmentData(id, name, resourceType, systemData, storageContainerPath, storageContainerSasKey, storageAccountAccessKey, recurringScans, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SynapseEncryptionProtectorData(id, name, resourceType, systemData, kind, location, subregion, serverKeyName, serverKeyType, uri, thumbprint, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SynapseServerUsage(name, resourceName, displayName, currentValue, limit, unit, nextResetOn, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SynapseRecoverableSqlPoolData(id, name, resourceType, systemData, edition, serviceLevelObjective, elasticPoolName, lastAvailableBackupOn, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SynapseDedicatedSqlMinimalTlsSettingData(id, name, resourceType, systemData, location, minimalTlsVersion, new Dictionary<string, BinaryData>());
        }
        ...
        public static SynapseWorkspaceData SynapseWorkspaceData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, ManagedServiceIdentity identity = null, SynapseDataLakeStorageAccountDetails defaultDataLakeStorage = null, string sqlAdministratorLoginPassword = null, string managedResourceGroupName = null, string provisioningState = null, string sqlAdministratorLogin = null, string virtualNetworkComputeSubnetId = null, IDictionary<string, string> connectivityEndpoints = null, string managedVirtualNetwork = null, IEnumerable<SynapsePrivateEndpointConnectionData> privateEndpointConnections = null, SynapseEncryptionDetails encryption = null, Guid? workspaceUid = null, IReadOnlyDictionary<string, BinaryData> extraProperties = null, SynapseManagedVirtualNetworkSettings managedVirtualNetworkSettings = null, SynapseWorkspaceRepositoryConfiguration workspaceRepositoryConfiguration = null, ResourceIdentifier purviewResourceId = null, ResourceIdentifier adlaResourceId = null, WorkspacePublicNetworkAccess? publicNetworkAccess = null, Guid? initialWorkspaceAdminObjectId = null, IReadOnlyDictionary<string, BinaryData> settings = null, bool? isAadOnlyAuthenticationEnabled = null, bool? isTrustedServiceBypassEnabled = null)
        {
            ...
            return new SynapseWorkspaceData(id, name, resourceType, systemData, tags, location, identity, defaultDataLakeStorage, sqlAdministratorLoginPassword, managedResourceGroupName, provisioningState, sqlAdministratorLogin, virtualNetworkComputeSubnetId != null ? new VirtualNetworkProfile(virtualNetworkComputeSubnetId, new Dictionary<string, BinaryData>()) : null, connectivityEndpoints, managedVirtualNetwork, privateEndpointConnections?.ToList(), encryption, workspaceUid, extraProperties, managedVirtualNetworkSettings, workspaceRepositoryConfiguration, purviewResourceId != null ? new PurviewConfiguration(purviewResourceId, new Dictionary<string, BinaryData>()) : null, adlaResourceId, publicNetworkAccess, initialWorkspaceAdminObjectId != null ? new CspWorkspaceAdminProperties(initialWorkspaceAdminObjectId, new Dictionary<string, BinaryData>()) : null, settings, isAadOnlyAuthenticationEnabled, isTrustedServiceBypassEnabled, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SynapseEncryptionDetails(isDoubleEncryptionEnabled, cmk, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new WorkspaceCustomerManagedKeyDetails(status, key, kekIdentity, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SynapseWorkspaceAadAdminInfoData(id, name, resourceType, systemData, tenantId, login, administratorType, sid, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SynapseManagedIdentitySqlControlSettingData(id, name, resourceType, systemData, grantSqlControlToManagedIdentity, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SynapseGrantSqlControlToManagedIdentity(desiredState, actualState, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SynapseRestorableDroppedSqlPoolData(id, name, resourceType, systemData, location, databaseName, edition, maxSizeBytes, serviceLevelObjective, elasticPoolName, createdOn, deletedOn, earliestRestoreOn, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new BigDataPoolLibraryRequirements(updatedOn, content, filename, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new BigDataPoolLibraryInfo(name, path, containerName, uploadedOn, libraryInfoType, provisioningStatus, creatorId, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new BigDataPoolSparkConfigProperties(updatedOn, content, filename, configurationType, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SynapseLibraryData(id, name, resourceType, systemData, namePropertiesName, path, containerName, uploadedOn, typePropertiesType, provisioningStatus, creatorId, etag, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SynapseIntegrationRuntimeData(id, name, resourceType, systemData, properties, etag, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SynapseIntegrationRuntimeNodeIPAddress(ipAddress, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new UnknownSsisObjectMetadata(metadataType, id, name, description, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SynapseIntegrationRuntimeStatusResult(name, properties, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SynapseIntegrationRuntimeAuthKeys(authKey1, authKey2, new Dictionary<string, BinaryData>());
        }
        ...
        public static SynapseIntegrationRuntimeMonitoringResult SynapseIntegrationRuntimeMonitoringResult(string name = null, IEnumerable<SynapseIntegrationRuntimeNodeMonitoringResult> nodes = null)
        {
            ...
            return new SynapseIntegrationRuntimeMonitoringResult(name, nodes?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SynapseSsisObjectMetadataStatusResult(status, name, properties, error, new Dictionary<string, BinaryData>());
        }
        ...
        public static SynapseIntegrationRuntimeOutboundNetworkDependenciesCategoryEndpoint SynapseIntegrationRuntimeOutboundNetworkDependenciesCategoryEndpoint(string category = null, IEnumerable<SynapseIntegrationRuntimeOutboundNetworkDependenciesEndpoint> endpoints = null)
        {
            ...
            return new SynapseIntegrationRuntimeOutboundNetworkDependenciesCategoryEndpoint(category, endpoints?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static SynapseIntegrationRuntimeOutboundNetworkDependenciesEndpoint SynapseIntegrationRuntimeOutboundNetworkDependenciesEndpoint(string domainName = null, IEnumerable<SynapseIntegrationRuntimeOutboundNetworkDependenciesEndpointDetails> endpointDetails = null)
        {
            ...
            return new SynapseIntegrationRuntimeOutboundNetworkDependenciesEndpoint(domainName, endpointDetails?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SynapseIntegrationRuntimeOutboundNetworkDependenciesEndpointDetails(port, new Dictionary<string, BinaryData>());
        }
        ...
        public static SynapseSparkConfigurationData SynapseSparkConfigurationData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string description = null, IDictionary<string, string> configs = null, IEnumerable<string> annotations = null, string notes = null, string createdBy = null, DateTimeOffset? createdOn = null, IDictionary<string, string> configMergeRule = null, ETag? etag = null)
        {
            ...
            return new SynapseSparkConfigurationData(id, name, resourceType, systemData, description, configs, annotations?.ToList(), notes, createdBy, createdOn, configMergeRule, etag, new Dictionary<string, BinaryData>());
        }
        ...
        public static KustoPoolSkuDescription KustoPoolSkuDescription(string resourceType = null, string name = null, string size = null, IEnumerable<AzureLocation> locations = null, IEnumerable<KustoPoolSkuLocationInfoItem> locationInfo = null, IEnumerable<BinaryData> restrictions = null)
        {
            ...
            return new KustoPoolSkuDescription(resourceType, name, size, locations?.ToList(), locationInfo?.ToList(), restrictions?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static KustoPoolSkuLocationInfoItem KustoPoolSkuLocationInfoItem(AzureLocation location = default, IEnumerable<string> zones = null)
        {
            ...
            return new KustoPoolSkuLocationInfoItem(location, zones?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new KustoPoolNameAvailabilityContent(name, resourceType, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new KustoPoolNameAvailabilityResult(isNameAvailable, name, message, reason, new Dictionary<string, BinaryData>());
        }
        ...
        public static SynapseKustoPoolData SynapseKustoPoolData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, SynapseDataSourceSku sku = null, ETag? etag = null, KustoPoolState? state = null, ResourceProvisioningState? provisioningState = null, Uri uri = null, Uri dataIngestionUri = null, string stateReason = null, SynapseOptimizedAutoscale optimizedAutoscale = null, bool? enableStreamingIngest = null, bool? enablePurge = null, IEnumerable<SynapseLanguageExtension> languageExtensionsValue = null, Guid? workspaceUid = null)
        {
            ...
            return new SynapseKustoPoolData(id, name, resourceType, systemData, tags, location, sku, etag, state, provisioningState, uri, dataIngestionUri, stateReason, optimizedAutoscale, enableStreamingIngest, enablePurge, languageExtensionsValue != null ? new SynapseLanguageExtensionsList(languageExtensionsValue?.ToList(), new Dictionary<string, BinaryData>()) : null, workspaceUid, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SynapseDataSourceResourceSku(resourceType, sku, capacity, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SynapseDataSourceCapacity(scaleType, minimum, maximum, @default, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SynapseFollowerDatabaseDefinition(kustoPoolResourceId, attachedDatabaseConfigurationName, databaseName, new Dictionary<string, BinaryData>());
        }
        ...
        public static SynapseAttachedDatabaseConfigurationData SynapseAttachedDatabaseConfigurationData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, AzureLocation? location = null, ResourceProvisioningState? provisioningState = null, string databaseName = null, ResourceIdentifier kustoPoolResourceId = null, IEnumerable<string> attachedDatabaseNames = null, SynapseDefaultPrincipalsModificationKind? defaultPrincipalsModificationKind = null, SynapseTableLevelSharingProperties tableLevelSharingProperties = null)
        {
            ...
            return new SynapseAttachedDatabaseConfigurationData(id, name, resourceType, systemData, location, provisioningState, databaseName, kustoPoolResourceId, attachedDatabaseNames?.ToList(), defaultPrincipalsModificationKind, tableLevelSharingProperties, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SynapseDatabaseData(id, name, resourceType, systemData, location, kind, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new KustoPoolDataConnectionNameAvailabilityContent(name, resourceType, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SynapseDataConnectionData(id, name, resourceType, systemData, location, kind, new Dictionary<string, BinaryData>());
        }
        ...
        public static SynapseDataConnectionValidationListResult SynapseDataConnectionValidationListResult(IEnumerable<SynapseDataConnectionValidationResult> value = null)
        {
            ...
            return new SynapseDataConnectionValidationListResult(value?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SynapseDataConnectionValidationResult(errorMessage, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new KustoPoolPrincipalAssignmentNameAvailabilityContent(name, resourceType, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SynapseClusterPrincipalAssignmentData(id, name, resourceType, systemData, principalId, role, tenantId, principalType, tenantName, principalName, provisioningState, aadObjectId, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new KustoPoolDatabasePrincipalAssignmentNameAvailabilityContent(name, resourceType, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SynapseDatabasePrincipalAssignmentData(id, name, resourceType, systemData, principalId, role, tenantId, principalType, tenantName, principalName, provisioningState, aadObjectId, new Dictionary<string, BinaryData>());
        }
        ...
        public static SynapseKustoPoolPrivateLinkData SynapseKustoPoolPrivateLinkData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string groupId = null, IEnumerable<string> requiredMembers = null, IEnumerable<string> requiredZoneNames = null, ResourceProvisioningState? provisioningState = null)
        {
            ...
            return new SynapseKustoPoolPrivateLinkData(id, name, resourceType, systemData, groupId, requiredMembers?.ToList(), requiredZoneNames?.ToList(), provisioningState, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SynapseLinkedIntegrationRuntime(name, subscriptionId, dataFactoryName, dataFactoryLocation, createOn, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SynapseSsisFolder(SynapseSsisObjectMetadataType.Folder, id, name, description, new Dictionary<string, BinaryData>());
        }
        ...
        public static SynapseSsisProject SynapseSsisProject(long? id = null, string name = null, string description = null, long? folderId = null, long? version = null, IEnumerable<SynapseSsisEnvironmentReference> environmentRefs = null, IEnumerable<SynapseSsisParameter> parameters = null)
        {
            ...
            return new SynapseSsisProject(SynapseSsisObjectMetadataType.Project, id, name, description, new Dictionary<string, BinaryData>(), folderId, version, environmentRefs?.ToList(), parameters?.ToList());
        }
        ...
        {
            return new SynapseSsisEnvironmentReference(id, environmentFolderName, environmentName, referenceType, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SynapseSsisParameter(id, name, description, dataType, isRequired, isSensitive, designDefaultValue, defaultValue, sensitiveDefaultValue, valueType, valueSet, variable, new Dictionary<string, BinaryData>());
        }
        ...
        public static SynapseSsisPackage SynapseSsisPackage(long? id = null, string name = null, string description = null, long? folderId = null, long? projectVersion = null, long? projectId = null, IEnumerable<SynapseSsisParameter> parameters = null)
        {
            ...
            return new SynapseSsisPackage(SynapseSsisObjectMetadataType.Package, id, name, description, new Dictionary<string, BinaryData>(), folderId, projectVersion, projectId, parameters?.ToList());
        }
        ...
        public static SynapseSsisEnvironment SynapseSsisEnvironment(long? id = null, string name = null, string description = null, long? folderId = null, IEnumerable<SynapseSsisVariable> variables = null)
        {
            ...
            return new SynapseSsisEnvironment(SynapseSsisObjectMetadataType.Environment, id, name, description, new Dictionary<string, BinaryData>(), folderId, variables?.ToList());
        }
        ...
        {
            return new SynapseSsisVariable(id, name, description, dataType, isSensitive, value, sensitiveValue, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SynapseReadWriteDatabase(id, name, resourceType, systemData, location, SynapseKind.ReadWrite, new Dictionary<string, BinaryData>(), provisioningState, softDeletePeriod, hotCachePeriod, statisticsSize != null ? new DatabaseStatistics(statisticsSize, new Dictionary<string, BinaryData>()) : null, isFollowed);
        }
        ...
        public static SynapseIotHubDataConnection SynapseIotHubDataConnection(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, AzureLocation? location = null, ResourceIdentifier iotHubResourceId = null, string consumerGroup = null, string tableName = null, string mappingRuleName = null, SynapseIotHubDataFormat? dataFormat = null, IEnumerable<string> eventSystemProperties = null, string sharedAccessPolicyName = null, ResourceProvisioningState? provisioningState = null)
        {
            ...
            return new SynapseIotHubDataConnection(id, name, resourceType, systemData, location, SynapseDataConnectionKind.IotHub, new Dictionary<string, BinaryData>(), iotHubResourceId, consumerGroup, tableName, mappingRuleName, dataFormat, eventSystemProperties?.ToList(), sharedAccessPolicyName, provisioningState);
        }
