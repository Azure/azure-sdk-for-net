...
namespace Azure.ResourceManager.Synapse.Models
{
    ...
    public static partial class ArmSynapseModelFactory
    {
        ...
        {
            return new SynapseAadOnlyAuthenticationData(id, name, resourceType, systemData, isAadOnlyAuthenticationEnabled, state, createdOn, default);
        }
        ...
        {
            return new SynapseIPFirewallRuleInfoData(id, name, resourceType, systemData, endIPAddress, provisioningState, startIPAddress, default);
        }
        ...
        {
            return new SynapseIPFirewallRuleProperties(endIPAddress, provisioningState, startIPAddress, default);
        }
        ...
        {
            return new ReplaceAllFirewallRulesOperationResult(operationId, default);
        }
        ...
        {
            return new SynapseKeyData(id, name, resourceType, systemData, isActiveCmk, keyVaultUri, default);
        }
        ...
        {
            return new SynapsePrivateEndpointConnectionData(id, name, resourceType, systemData, privateEndpointId != null ? ResourceManagerModelFactory.SubResource(privateEndpointId) : null, connectionState, provisioningState, default);
        }
        ...
        {
            return new SynapsePrivateEndpointConnectionProperties(privateEndpointId != null ? ResourceManagerModelFactory.SubResource(privateEndpointId) : null, connectionState, provisioningState, default);
        }
        ...
        {
            return new SynapsePrivateLinkServiceConnectionState(status, description, actionsRequired, default);
        }

        /// <summary> Initializes a new instance of <see cref="SynapsePrivateLinkResourceData"/>. </summary>
        /// <param name="id"> The id. </param>
        /// <param name="name"> The name. </param>
        /// <param name="resourceType"> The resourceType. </param>
        /// <param name="systemData"> The systemData. </param>
        ...
        {
            return new SynapsePrivateLinkResourceData(id, name, resourceType, systemData, properties, default);
        }
        ...
        public static SynapsePrivateLinkResourceProperties SynapsePrivateLinkResourceProperties(string groupId = null, IEnumerable<string> requiredMembers = null, IEnumerable<string> requiredZoneNames = null)
        {
            ...
            return new SynapsePrivateLinkResourceProperties(groupId, requiredMembers?.ToList(), requiredZoneNames?.ToList(), default);
        }
        ...
        public static SynapsePrivateLinkHubData SynapsePrivateLinkHubData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, string provisioningState = null, IEnumerable<PrivateEndpointConnectionForPrivateLinkHubBasic> privateEndpointConnections = null)
        {
            ...
            return new SynapsePrivateLinkHubData(id, name, resourceType, systemData, tags, location, provisioningState, privateEndpointConnections?.ToList(), default);
        }
        ...
        {
            return new PrivateEndpointConnectionForPrivateLinkHubBasic(id, properties, default);
        }
        ...
        {
            return new SynapsePrivateEndpointConnectionForPrivateLinkHubData(id, name, resourceType, systemData, properties, default);
        }
        ...
        public static SynapseSqlPoolData SynapseSqlPoolData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, SynapseSku sku = null, long? maxSizeBytes = null, string collation = null, string sourceDatabaseId = null, string recoverableDatabaseId = null, string provisioningState = null, string status = null, DateTimeOffset? restorePointInTime = null, SqlPoolCreateMode? createMode = null, DateTimeOffset? createdOn = null, SqlPoolStorageAccountType? storageAccountType = null, DateTimeOffset? sourceDatabaseDeletionOn = null)
        {
            ...
            return new SynapseSqlPoolData(id, name, resourceType, systemData, tags, location, sku, maxSizeBytes, collation, sourceDatabaseId, recoverableDatabaseId, provisioningState, status, restorePointInTime, createMode, createdOn, storageAccountType, sourceDatabaseDeletionOn, default);
        }
        ...
        public static SynapseSqlPoolPatch SynapseSqlPoolPatch(IDictionary<string, string> tags = null, AzureLocation? location = null, SynapseSku sku = null, long? maxSizeBytes = null, string collation = null, string sourceDatabaseId = null, string recoverableDatabaseId = null, string provisioningState = null, string status = null, DateTimeOffset? restorePointInTime = null, SqlPoolCreateMode? createMode = null, DateTimeOffset? createdOn = null, SqlPoolStorageAccountType? storageAccountType = null, DateTimeOffset? sourceDatabaseDeletionOn = null)
        {
            ...
            return new SynapseSqlPoolPatch(tags, location, sku, maxSizeBytes, collation, sourceDatabaseId, recoverableDatabaseId, provisioningState, status, restorePointInTime, createMode, createdOn, storageAccountType, sourceDatabaseDeletionOn, default);
        }
        ...
        {
            return new SynapseMetadataSyncConfigurationData(id, name, resourceType, systemData, isEnabled, syncIntervalInMinutes, default);
        }
        ...
        {
            return new SynapseGeoBackupPolicyData(id, name, resourceType, systemData, kind, location, state, storageType, default);
        }
        ...
        {
            return new SynapseDataWarehouseUserActivityData(id, name, resourceType, systemData, activeQueriesCount, default);
        }
        ...
        {
            return new SynapseRestorePointData(id, name, resourceType, systemData, location, restorePointType, earliestRestoreOn, restorePointCreationOn, restorePointLabel, default);
        }
        ...
        {
            return new SynapseReplicationLinkData(id, name, resourceType, systemData, location, isTerminationAllowed, replicationMode, partnerServer, partnerDatabase, partnerLocation, role, partnerRole, startOn, percentComplete, replicationState, default);
        }
        ...
        public static SynapseMaintenanceWindowData SynapseMaintenanceWindowData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IEnumerable<SynapseMaintenanceWindowTimeRange> timeRanges = null)
        {
            ...
            return new SynapseMaintenanceWindowData(id, name, resourceType, systemData, timeRanges?.ToList(), default);
        }
        ...
        public static SynapseMaintenanceWindowOptionData SynapseMaintenanceWindowOptionData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, bool? isEnabled = null, IEnumerable<SynapseMaintenanceWindowTimeRange> maintenanceWindowCycles = null, int? minDurationInMinutes = null, int? defaultDurationInMinutes = null, int? minCycles = null, int? timeGranularityInMinutes = null, bool? allowMultipleMaintenanceWindowsPerCycle = null)
        {
            ...
            return new SynapseMaintenanceWindowOptionData(id, name, resourceType, systemData, isEnabled, maintenanceWindowCycles?.ToList(), minDurationInMinutes, defaultDurationInMinutes, minCycles, timeGranularityInMinutes, allowMultipleMaintenanceWindowsPerCycle, default);
        }
        ...
        {
            return new SynapseTransparentDataEncryptionData(id, name, resourceType, systemData, location, status, default);
        }
        ...
        public static SynapseSqlPoolBlobAuditingPolicyData SynapseSqlPoolBlobAuditingPolicyData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string kind = null, SynapseBlobAuditingPolicyState? state = null, string storageEndpoint = null, string storageAccountAccessKey = null, int? retentionDays = null, IEnumerable<string> auditActionsAndGroups = null, Guid? storageAccountSubscriptionId = null, bool? isStorageSecondaryKeyInUse = null, bool? isAzureMonitorTargetEnabled = null)
        {
            ...
            return new SynapseSqlPoolBlobAuditingPolicyData(id, name, resourceType, systemData, kind, state, storageEndpoint, storageAccountAccessKey, retentionDays, auditActionsAndGroups?.ToList(), storageAccountSubscriptionId, isStorageSecondaryKeyInUse, isAzureMonitorTargetEnabled, default);
        }
        ...
        {
            return new SqlPoolUsage(name, resourceName, displayName, currentValue, limit, unit, nextResetOn, default);
        }
        ...
        {
            return new SynapseSensitivityLabelData(id, name, resourceType, systemData, managedBy, schemaName, tableName, columnName, labelName, labelId, informationType, informationTypeId, isDisabled, rank, default);
        }
        ...
        {
            return new SynapseSensitivityLabelUpdate(id, name, resourceType, systemData, op, schema, table, column, sensitivityLabel, default);
        }
        ...
        {
            return new SynapseRecommendedSensitivityLabelUpdate(id, name, resourceType, systemData, op, schema, table, column, default);
        }
        ...
        {
            return new SynapseSqlPoolSchemaData(id, name, resourceType, systemData, default);
        }
        ...
        {
            return new SynapseSqlPoolTableData(id, name, resourceType, systemData, default);
        }
        ...
        {
            return new SynapseSqlPoolColumnData(id, name, resourceType, systemData, columnType, isComputed, default);
        }
        ...
        {
            return new SynapseSqlPoolConnectionPolicyData(id, name, resourceType, systemData, kind, location, securityEnabledAccess, proxyDnsName, proxyPort, visibility, useServerDefault, redirectionState, state, default);
        }

        /// <summary> Initializes a new instance of <see cref="SynapseSqlPoolVulnerabilityAssessmentData"/>. </summary>
        /// <param name="id"> The id. </param>
        /// <param name="name"> The name. </param>
        /// <param name="resourceType"> The resourceType. </param>
        /// <param name="systemData"> The systemData. </param>
        ...
        {
            return new SynapseSqlPoolVulnerabilityAssessmentData(id, name, resourceType, systemData, storageContainerPath, storageContainerSasKey, storageAccountAccessKey, recurringScans, default);
        }
        ...
        public static SynapseVulnerabilityAssessmentScanRecordData SynapseVulnerabilityAssessmentScanRecordData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string scanId = null, SynapseVulnerabilityAssessmentScanTriggerType? triggerType = null, SynapseVulnerabilityAssessmentScanState? state = null, DateTimeOffset? startOn = null, DateTimeOffset? endOn = null, IEnumerable<SynapseVulnerabilityAssessmentScanError> errors = null, string storageContainerPath = null, int? numberOfFailedSecurityChecks = null)
        {
            ...
            return new SynapseVulnerabilityAssessmentScanRecordData(id, name, resourceType, systemData, scanId, triggerType, state, startOn, endOn, errors?.ToList(), storageContainerPath, numberOfFailedSecurityChecks, default);
        }

        /// <summary> Initializes a new instance of <see cref="SynapseVulnerabilityAssessmentScanError"/>. </summary>
        ...
        {
            return new SynapseVulnerabilityAssessmentScanError(code, message, default);
        }

        /// <summary> Initializes a new instance of <see cref="SqlPoolVulnerabilityAssessmentScansExport"/>. </summary>
        /// <param name="id"> The id. </param>
        /// <param name="name"> The name. </param>
        /// <param name="resourceType"> The resourceType. </param>
        /// <param name="systemData"> The systemData. </param>
        ...
        {
            return new SqlPoolVulnerabilityAssessmentScansExport(id, name, resourceType, systemData, exportedReportLocation, default);
        }
        ...
        public static SynapseSqlPoolSecurityAlertPolicyData SynapseSqlPoolSecurityAlertPolicyData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, SynapseSecurityAlertPolicyState? state = null, IEnumerable<string> disabledAlerts = null, IEnumerable<string> emailAddresses = null, bool? enableEmailToAccountAdmins = null, string storageEndpoint = null, string storageAccountAccessKey = null, int? retentionDays = null, DateTimeOffset? createdOn = null)
        {
            ...
            return new SynapseSqlPoolSecurityAlertPolicyData(id, name, resourceType, systemData, state, disabledAlerts?.ToList(), emailAddresses?.ToList(), enableEmailToAccountAdmins, storageEndpoint, storageAccountAccessKey, retentionDays, createdOn, default);
        }

        /// <summary> Initializes a new instance of <see cref="SynapseSqlPoolVulnerabilityAssessmentRuleBaselineData"/>. </summary>
        /// <param name="id"> The id. </param>
        /// <param name="name"> The name. </param>
        /// <param name="resourceType"> The resourceType. </param>
        /// <param name="systemData"> The systemData. </param>
        ...
        public static SynapseSqlPoolVulnerabilityAssessmentRuleBaselineData SynapseSqlPoolVulnerabilityAssessmentRuleBaselineData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IEnumerable<SqlPoolVulnerabilityAssessmentRuleBaselineItem> baselineResults = null)
        {
            ...
            return new SynapseSqlPoolVulnerabilityAssessmentRuleBaselineData(id, name, resourceType, systemData, baselineResults?.ToList(), default);
        }
        ...
        {
            return new SynapseDataMaskingPolicyData(id, name, resourceType, systemData, location, kind, managedBy, dataMaskingState, exemptPrincipals, applicationPrincipals, maskingLevel, default);
        }
        ...
        {
            return new SynapseDataMaskingRuleData(id, name, resourceType, systemData, location, kind, ruleId, aliasName, ruleState, schemaName, tableName, columnName, maskingFunction, numberFrom, numberTo, prefixSize, suffixSize, replacementString, default);
        }
        ...
        {
            return new SynapseWorkloadGroupData(id, name, resourceType, systemData, minResourcePercent, maxResourcePercent, minResourcePercentPerRequest, maxResourcePercentPerRequest, importance, queryExecutionTimeout, default);
        }
        ...
        {
            return new SynapseWorkloadClassifierData(id, name, resourceType, systemData, memberName, label, context, startTime, endTime, importance, default);
        }
        ...
        public static SynapseServerBlobAuditingPolicyData SynapseServerBlobAuditingPolicyData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, SynapseBlobAuditingPolicyState? state = null, string storageEndpoint = null, string storageAccountAccessKey = null, int? retentionDays = null, IEnumerable<string> auditActionsAndGroups = null, Guid? storageAccountSubscriptionId = null, bool? isStorageSecondaryKeyInUse = null, bool? isAzureMonitorTargetEnabled = null, int? queueDelayMs = null, bool? isDevopsAuditEnabled = null)
        {
            ...
            return new SynapseServerBlobAuditingPolicyData(id, name, resourceType, systemData, state, storageEndpoint, storageAccountAccessKey, retentionDays, auditActionsAndGroups?.ToList(), storageAccountSubscriptionId, isStorageSecondaryKeyInUse, isAzureMonitorTargetEnabled, queueDelayMs, isDevopsAuditEnabled, default);
        }
        ...
        public static SynapseServerSecurityAlertPolicyData SynapseServerSecurityAlertPolicyData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, SynapseSecurityAlertPolicyState? state = null, IEnumerable<string> disabledAlerts = null, IEnumerable<string> emailAddresses = null, bool? enableEmailToAccountAdmins = null, string storageEndpoint = null, string storageAccountAccessKey = null, int? retentionDays = null, DateTimeOffset? createdOn = null)
        {
            ...
            return new SynapseServerSecurityAlertPolicyData(id, name, resourceType, systemData, state, disabledAlerts?.ToList(), emailAddresses?.ToList(), enableEmailToAccountAdmins, storageEndpoint, storageAccountAccessKey, retentionDays, createdOn, default);
        }
        ...
        {
            return new SynapseServerVulnerabilityAssessmentData(id, name, resourceType, systemData, storageContainerPath, storageContainerSasKey, storageAccountAccessKey, recurringScans, default);
        }
        ...
        {
            return new SynapseEncryptionProtectorData(id, name, resourceType, systemData, kind, location, subregion, serverKeyName, serverKeyType, uri, thumbprint, default);
        }
        ...
        {
            return new SynapseServerUsage(name, resourceName, displayName, currentValue, limit, unit, nextResetOn, default);
        }
        ...
        {
            return new SynapseRecoverableSqlPoolData(id, name, resourceType, systemData, edition, serviceLevelObjective, elasticPoolName, lastAvailableBackupOn, default);
        }
        ...
        {
            return new SynapseDedicatedSqlMinimalTlsSettingData(id, name, resourceType, systemData, location, minimalTlsVersion, default);
        }
        ...
        {
            return new SynapseEncryptionDetails(isDoubleEncryptionEnabled, cmk, default);
        }
        ...
        {
            return new WorkspaceCustomerManagedKeyDetails(status, key, kekIdentity, default);
        }
        ...
        public static SynapseWorkspacePatch SynapseWorkspacePatch(IDictionary<string, string> tags = null, ManagedServiceIdentity identity = null, string sqlAdministratorLoginPassword = null, SynapseManagedVirtualNetworkSettings managedVirtualNetworkSettings = null, SynapseWorkspaceRepositoryConfiguration workspaceRepositoryConfiguration = null, ResourceIdentifier purviewResourceId = null, string provisioningState = null, SynapseEncryptionDetails encryption = null, WorkspacePublicNetworkAccess? publicNetworkAccess = null)
        {
            ...
            return new SynapseWorkspacePatch(tags, identity, sqlAdministratorLoginPassword, managedVirtualNetworkSettings, workspaceRepositoryConfiguration, purviewResourceId != null ? new PurviewConfiguration(purviewResourceId, new Dictionary<string, BinaryData>()) : null, provisioningState, encryption, publicNetworkAccess, default);
        }
        ...
        {
            return new SynapseWorkspaceAadAdminInfoData(id, name, resourceType, systemData, tenantId, login, administratorType, sid, default);
        }
        ...
        {
            return new SynapseManagedIdentitySqlControlSettingData(id, name, resourceType, systemData, grantSqlControlToManagedIdentity, default);
        }
        ...
        {
            return new SynapseGrantSqlControlToManagedIdentity(desiredState, actualState, default);
        }
        ...
        {
            return new SynapseRestorableDroppedSqlPoolData(id, name, resourceType, systemData, location, databaseName, edition, maxSizeBytes, serviceLevelObjective, elasticPoolName, createdOn, deletedOn, earliestRestoreOn, default);
        }
        ...
        {
            return new BigDataPoolLibraryRequirements(updatedOn, content, filename, default);
        }
        ...
        {
            return new BigDataPoolLibraryInfo(name, path, containerName, uploadedOn, libraryInfoType, provisioningStatus, creatorId, default);
        }
        ...
        {
            return new BigDataPoolSparkConfigProperties(updatedOn, content, filename, configurationType, default);
        }
        ...
        {
            return new SynapseLibraryData(id, name, resourceType, systemData, namePropertiesName, path, containerName, uploadedOn, typePropertiesType, provisioningStatus, creatorId, etag, default);
        }
        ...
        {
            return new SynapseIntegrationRuntimeData(id, name, resourceType, systemData, properties, etag, default);
        }
        ...
        {
            return new SynapseIntegrationRuntimeNodeIPAddress(ipAddress, default);
        }
        ...
        {
            return new UnknownSsisObjectMetadata(metadataType, id, name, description, default);
        }
        ...
        {
            return new SynapseIntegrationRuntimeStatusResult(name, properties, default);
        }
        ...
        {
            return new SynapseIntegrationRuntimeAuthKeys(authKey1, authKey2, default);
        }
        ...
        public static SynapseIntegrationRuntimeMonitoringResult SynapseIntegrationRuntimeMonitoringResult(string name = null, IEnumerable<SynapseIntegrationRuntimeNodeMonitoringResult> nodes = null)
        {
            ...
            return new SynapseIntegrationRuntimeMonitoringResult(name, nodes?.ToList(), default);
        }
        ...
        {
            return new SynapseSsisObjectMetadataStatusResult(status, name, properties, error, default);
        }
        ...
        public static SynapseIntegrationRuntimeOutboundNetworkDependenciesCategoryEndpoint SynapseIntegrationRuntimeOutboundNetworkDependenciesCategoryEndpoint(string category = null, IEnumerable<SynapseIntegrationRuntimeOutboundNetworkDependenciesEndpoint> endpoints = null)
        {
            ...
            return new SynapseIntegrationRuntimeOutboundNetworkDependenciesCategoryEndpoint(category, endpoints?.ToList(), default);
        }
        ...
        public static SynapseIntegrationRuntimeOutboundNetworkDependenciesEndpoint SynapseIntegrationRuntimeOutboundNetworkDependenciesEndpoint(string domainName = null, IEnumerable<SynapseIntegrationRuntimeOutboundNetworkDependenciesEndpointDetails> endpointDetails = null)
        {
            ...
            return new SynapseIntegrationRuntimeOutboundNetworkDependenciesEndpoint(domainName, endpointDetails?.ToList(), default);
        }
        ...
        {
            return new SynapseIntegrationRuntimeOutboundNetworkDependenciesEndpointDetails(port, default);
        }
        ...
        public static SynapseSparkConfigurationData SynapseSparkConfigurationData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string description = null, IDictionary<string, string> configs = null, IEnumerable<string> annotations = null, string notes = null, string createdBy = null, DateTimeOffset? createdOn = null, IDictionary<string, string> configMergeRule = null, ETag? etag = null)
        {
            ...
            return new SynapseSparkConfigurationData(id, name, resourceType, systemData, description, configs, annotations?.ToList(), notes, createdBy, createdOn, configMergeRule, etag, default);
        }
        ...
        public static KustoPoolSkuDescription KustoPoolSkuDescription(string resourceType = null, string name = null, string size = null, IEnumerable<AzureLocation> locations = null, IEnumerable<KustoPoolSkuLocationInfoItem> locationInfo = null, IEnumerable<BinaryData> restrictions = null)
        {
            ...
            return new KustoPoolSkuDescription(resourceType, name, size, locations?.ToList(), locationInfo?.ToList(), restrictions?.ToList(), default);
        }
        ...
        public static KustoPoolSkuLocationInfoItem KustoPoolSkuLocationInfoItem(AzureLocation location = default, IEnumerable<string> zones = null)
        {
            ...
            return new KustoPoolSkuLocationInfoItem(location, zones?.ToList(), default);
        }
        ...
        {
            return new KustoPoolNameAvailabilityContent(name, resourceType, default);
        }
        ...
        {
            return new KustoPoolNameAvailabilityResult(isNameAvailable, name, message, reason, default);
        }
        ...
        {
            return new SynapseDataSourceResourceSku(resourceType, sku, capacity, default);
        }
        ...
        {
            return new SynapseDataSourceCapacity(scaleType, minimum, maximum, @default, default);
        }
        ...
        {
            return new SynapseFollowerDatabaseDefinition(kustoPoolResourceId, attachedDatabaseConfigurationName, databaseName, default);
        }
        ...
        public static SynapseAttachedDatabaseConfigurationData SynapseAttachedDatabaseConfigurationData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, AzureLocation? location = null, ResourceProvisioningState? provisioningState = null, string databaseName = null, ResourceIdentifier kustoPoolResourceId = null, IEnumerable<string> attachedDatabaseNames = null, SynapseDefaultPrincipalsModificationKind? defaultPrincipalsModificationKind = null, SynapseTableLevelSharingProperties tableLevelSharingProperties = null)
        {
            ...
            return new SynapseAttachedDatabaseConfigurationData(id, name, resourceType, systemData, location, provisioningState, databaseName, kustoPoolResourceId, attachedDatabaseNames?.ToList(), defaultPrincipalsModificationKind, tableLevelSharingProperties, default);
        }
        ...
        {
            return new KustoPoolDataConnectionNameAvailabilityContent(name, resourceType, default);
        }
        ...
        public static SynapseDataConnectionValidationListResult SynapseDataConnectionValidationListResult(IEnumerable<SynapseDataConnectionValidationResult> value = null)
        {
            ...
            return new SynapseDataConnectionValidationListResult(value?.ToList(), default);
        }
        ...
        {
            return new SynapseDataConnectionValidationResult(errorMessage, default);
        }
        ...
        {
            return new KustoPoolPrincipalAssignmentNameAvailabilityContent(name, resourceType, default);
        }

        /// <summary> Initializes a new instance of <see cref="SynapseClusterPrincipalAssignmentData"/>. </summary>
        /// <param name="id"> The id. </param>
        /// <param name="name"> The name. </param>
        /// <param name="resourceType"> The resourceType. </param>
        /// <param name="systemData"> The systemData. </param>
        ...
        {
            return new SynapseClusterPrincipalAssignmentData(id, name, resourceType, systemData, principalId, role, tenantId, principalType, tenantName, principalName, provisioningState, aadObjectId, default);
        }
        ...
        {
            return new KustoPoolDatabasePrincipalAssignmentNameAvailabilityContent(name, resourceType, default);
        }
        ...
        {
            return new SynapseDatabasePrincipalAssignmentData(id, name, resourceType, systemData, principalId, role, tenantId, principalType, tenantName, principalName, provisioningState, aadObjectId, default);
        }
        ...
        public static SynapseKustoPoolPrivateLinkData SynapseKustoPoolPrivateLinkData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string groupId = null, IEnumerable<string> requiredMembers = null, IEnumerable<string> requiredZoneNames = null, ResourceProvisioningState? provisioningState = null)
        {
            ...
            return new SynapseKustoPoolPrivateLinkData(id, name, resourceType, systemData, groupId, requiredMembers?.ToList(), requiredZoneNames?.ToList(), provisioningState, default);
        }
        ...
        {
            return new SynapseLinkedIntegrationRuntime(name, subscriptionId, dataFactoryName, dataFactoryLocation, createOn, default);
        }
        ...
        {
            return new SynapseSsisFolder(SynapseSsisObjectMetadataType.Folder, id, name, description, default);
        }
        ...
        public static SynapseSsisProject SynapseSsisProject(long? id = null, string name = null, string description = null, long? folderId = null, long? version = null, IEnumerable<SynapseSsisEnvironmentReference> environmentRefs = null, IEnumerable<SynapseSsisParameter> parameters = null)
        {
            ...
            return new SynapseSsisProject(SynapseSsisObjectMetadataType.Project, id, name, description, folderId, version, environmentRefs?.ToList(), parameters?.ToList(), default);
        }
        ...
        {
            return new SynapseSsisEnvironmentReference(id, environmentFolderName, environmentName, referenceType, default);
        }
        ...
        {
            return new SynapseSsisParameter(id, name, description, dataType, isRequired, isSensitive, designDefaultValue, defaultValue, sensitiveDefaultValue, valueType, valueSet, variable, default);
        }
        ...
        public static SynapseSsisPackage SynapseSsisPackage(long? id = null, string name = null, string description = null, long? folderId = null, long? projectVersion = null, long? projectId = null, IEnumerable<SynapseSsisParameter> parameters = null)
        {
            ...
            return new SynapseSsisPackage(SynapseSsisObjectMetadataType.Package, id, name, description, folderId, projectVersion, projectId, parameters?.ToList(), default);
        }
        ...
        public static SynapseSsisEnvironment SynapseSsisEnvironment(long? id = null, string name = null, string description = null, long? folderId = null, IEnumerable<SynapseSsisVariable> variables = null)
        {
            ...
            return new SynapseSsisEnvironment(SynapseSsisObjectMetadataType.Environment, id, name, description, folderId, variables?.ToList(), default);
        }
        ...
        {
            return new SynapseSsisVariable(id, name, description, dataType, isSensitive, value, sensitiveValue, default);
        }
        ...
        {
            return new SynapseReadWriteDatabase(id, name, resourceType, systemData, location, SynapseKind.ReadWrite, provisioningState, softDeletePeriod, hotCachePeriod, statisticsSize != null ? new DatabaseStatistics(statisticsSize, new Dictionary<string, BinaryData>()) : null, isFollowed, default);
        }
        ...
        public static SynapseEventHubDataConnection SynapseEventHubDataConnection(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, AzureLocation? location = null, ResourceIdentifier eventHubResourceId = null, string consumerGroup = null, string tableName = null, string mappingRuleName = null, SynapseEventHubDataFormat? dataFormat = null, IEnumerable<string> eventSystemProperties = null, KustoPoolCompressionType? compression = null, ResourceProvisioningState? provisioningState = null, ResourceIdentifier managedIdentityResourceId = null)
        {
            ...
            return new SynapseEventHubDataConnection(id, name, resourceType, systemData, location, SynapseDataConnectionKind.EventHub, eventHubResourceId, consumerGroup, tableName, mappingRuleName, dataFormat, eventSystemProperties?.ToList(), compression, provisioningState, managedIdentityResourceId, default);
        }
        ...
        public static SynapseIotHubDataConnection SynapseIotHubDataConnection(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, AzureLocation? location = null, ResourceIdentifier iotHubResourceId = null, string consumerGroup = null, string tableName = null, string mappingRuleName = null, SynapseIotHubDataFormat? dataFormat = null, IEnumerable<string> eventSystemProperties = null, string sharedAccessPolicyName = null, ResourceProvisioningState? provisioningState = null)
        {
            ...
            return new SynapseIotHubDataConnection(id, name, resourceType, systemData, location, SynapseDataConnectionKind.IotHub, iotHubResourceId, consumerGroup, tableName, mappingRuleName, dataFormat, eventSystemProperties?.ToList(), sharedAccessPolicyName, provisioningState, default);
        }
        ...
        {
            return new SynapseEventGridDataConnection(id, name, resourceType, systemData, location, SynapseDataConnectionKind.EventGrid, storageAccountResourceId, eventHubResourceId, consumerGroup, tableName, mappingRuleName, dataFormat, ignoreFirstRecord, blobStorageEventType, provisioningState, default);
        }
    }
}
