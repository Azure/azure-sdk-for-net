...
{
    /// <summary> A class representing the SparkConfigurationResource data model. </summary>
    public partial class SparkConfigurationResourceData : ResourceData
    {
        ...
        public SparkConfigurationResourceData(IDictionary<string, string> configs)
        {
            if (configs == null)
            {
