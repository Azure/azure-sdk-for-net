...
namespace Microsoft.Azure.Synapse.Models
{
    ...
    public partial class ExtendedLivySessionRequest
    {
        /// <summary>
        /// Initializes a new instance of the ExtendedLivySessionRequest class.
        /// </summary>
        public ExtendedLivySessionRequest()
        {
            CustomInit();
        }
        ...
        /// Initializes a new instance of the ExtendedLivySessionRequest class.
        /// </summary>
        public ExtendedLivySessionRequest(IDictionary<string, string> tags = default(IDictionary<string, string>), string artifactId = default(string), string name = default(string), string file = default(string), string className = default(string), IList<string> args = default(IList<string>), IList<string> jars = default(IList<string>), IList<string> files = default(IList<string>), IList<string> archives = default(IList<string>), IDictionary<string, string> conf = default(IDictionary<string, string>), string driverMemory = default(string), int? driverCores = default(int?), string executorMemory = default(string), int? executorCores = default(int?), int? numExecutors = default(int?))
        {
            Tags = tags;
