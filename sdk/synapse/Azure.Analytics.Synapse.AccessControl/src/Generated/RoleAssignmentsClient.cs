...
namespace Azure.Analytics.Synapse.AccessControl
{
    ...
    public partial class RoleAssignmentsClient
    {
        ...
        internal RoleAssignmentsClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Uri endpoint, string apiVersion = "2020-12-01")
        {
        ...
        public virtual async Task<Response<Models.CheckPrincipalAccessResponse>> CheckPrincipalAccessAsync(Models.SubjectInfo subject, IEnumerable<Models.RequiredAction> actions, string scope, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="scope"> Scope at which the check access is done. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<Models.CheckPrincipalAccessResponse> CheckPrincipalAccess(Models.SubjectInfo subject, IEnumerable<Models.RequiredAction> actions, string scope, CancellationToken cancellationToken = default)
        {
            using var scope0 = _clientDiagnostics.CreateScope("RoleAssignmentsClient.CheckPrincipalAccess");
            scope0.Start();
            try
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<Models.RoleAssignmentDetails>> CreateRoleAssignmentAsync(string roleAssignmentId, Guid roleId, Guid principalId, string scope, string principalType = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="principalType"> Type of the principal Id: User, Group or ServicePrincipal. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<Models.RoleAssignmentDetails> CreateRoleAssignment(string roleAssignmentId, Guid roleId, Guid principalId, string scope, string principalType = null, CancellationToken cancellationToken = default)
        {
            using var scope0 = _clientDiagnostics.CreateScope("RoleAssignmentsClient.CreateRoleAssignment");
            scope0.Start();
            try
        ...
        /// <param name="roleAssignmentId"> The ID of the role assignment. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<Models.RoleAssignmentDetails>> GetRoleAssignmentByIdAsync(string roleAssignmentId, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="roleAssignmentId"> The ID of the role assignment. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<Models.RoleAssignmentDetails> GetRoleAssignmentById(string roleAssignmentId, CancellationToken cancellationToken = default)
        {
            using var scope0 = _clientDiagnostics.CreateScope("RoleAssignmentsClient.GetRoleAssignmentById");
            scope0.Start();
            try
