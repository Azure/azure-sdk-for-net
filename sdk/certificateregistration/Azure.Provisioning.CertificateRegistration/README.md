# Azure Provisioning CertificateRegistration client library for .NET

Azure.Provisioning.CertificateRegistration simplifies declarative resource provisioning in .NET.
...
```dotnetcli
dotnet add package Azure.Provisioning.CertificateRegistration --prerelease
```
