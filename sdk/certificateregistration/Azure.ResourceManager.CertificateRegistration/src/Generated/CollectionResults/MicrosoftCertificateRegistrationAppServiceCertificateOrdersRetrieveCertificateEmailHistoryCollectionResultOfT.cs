...
{
    internal partial class MicrosoftCertificateRegistrationAppServiceCertificateOrdersRetrieveCertificateEmailHistoryCollectionResultOfT : Pageable<AppServiceCertificateEmail>
    {
        ...
        /// <summary> Initializes a new instance of MicrosoftCertificateRegistrationAppServiceCertificateOrdersRetrieveCertificateEmailHistoryCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public MicrosoftCertificateRegistrationAppServiceCertificateOrdersRetrieveCertificateEmailHistoryCollectionResultOfT(AppServiceCertificateOrders client, string subscriptionId, string resourceGroupName, string name, RequestContext context, string diagnosticScope)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of MicrosoftCertificateRegistrationAppServiceCertificateOrdersRetrieveCertificateEmailHistoryCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of MicrosoftCertificateRegistrationAppServiceCertificateOrdersRetrieveCertificateEmailHistoryCollectionResultOfT as an enumerable collection. </returns>
