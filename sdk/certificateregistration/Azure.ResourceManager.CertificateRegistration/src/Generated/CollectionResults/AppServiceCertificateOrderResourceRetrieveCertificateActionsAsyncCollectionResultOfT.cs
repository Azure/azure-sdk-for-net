...
namespace Azure.ResourceManager.CertificateRegistration
{
    internal partial class AppServiceCertificateOrderResourceRetrieveCertificateActionsAsyncCollectionResultOfT : AsyncPageable<CertificateOrderAction>
    {
        ...
        public AppServiceCertificateOrderResourceRetrieveCertificateActionsAsyncCollectionResultOfT(AppServiceCertificateOrders client, string subscriptionId, string resourceGroupName, string name, RequestContext context, string diagnosticScope)
        {
            _client = client;
