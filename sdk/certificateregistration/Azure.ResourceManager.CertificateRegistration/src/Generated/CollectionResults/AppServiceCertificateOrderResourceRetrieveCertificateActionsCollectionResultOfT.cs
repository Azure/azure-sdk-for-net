...
namespace Azure.ResourceManager.CertificateRegistration
{
    internal partial class AppServiceCertificateOrderResourceRetrieveCertificateActionsCollectionResultOfT : Pageable<CertificateOrderAction>
    {
        ...
        public AppServiceCertificateOrderResourceRetrieveCertificateActionsCollectionResultOfT(AppServiceCertificateOrders client, string subscriptionId, string resourceGroupName, string name, RequestContext context)
        {
            _client = client;
