...
namespace Azure.ResourceManager.CertificateRegistration.Models
{
    internal static partial class CertificateOrderActionTypeExtensions
    {
        ...
        {
            if (StringComparer.OrdinalIgnoreCase.Equals(value, "CertificateIssued"))
            {
                return CertificateOrderActionType.CertificateIssued;
            }
            if (StringComparer.OrdinalIgnoreCase.Equals(value, "CertificateOrderCanceled"))
            {
                return CertificateOrderActionType.CertificateOrderCanceled;
            }
            if (StringComparer.OrdinalIgnoreCase.Equals(value, "CertificateOrderCreated"))
            {
                return CertificateOrderActionType.CertificateOrderCreated;
            }
            if (StringComparer.OrdinalIgnoreCase.Equals(value, "CertificateRevoked"))
            {
                return CertificateOrderActionType.CertificateRevoked;
            }
            if (StringComparer.OrdinalIgnoreCase.Equals(value, "DomainValidationComplete"))
            {
                return CertificateOrderActionType.DomainValidationComplete;
            }
            if (StringComparer.OrdinalIgnoreCase.Equals(value, "FraudDetected"))
            {
                return CertificateOrderActionType.FraudDetected;
            }
            if (StringComparer.OrdinalIgnoreCase.Equals(value, "OrgNameChange"))
            {
                return CertificateOrderActionType.OrgNameChange;
            }
            if (StringComparer.OrdinalIgnoreCase.Equals(value, "OrgValidationComplete"))
            {
                return CertificateOrderActionType.OrgValidationComplete;
            }
            if (StringComparer.OrdinalIgnoreCase.Equals(value, "SanDrop"))
            {
                return CertificateOrderActionType.SanDrop;
            }
            if (StringComparer.OrdinalIgnoreCase.Equals(value, "FraudCleared"))
            {
            ...
            if (StringComparer.OrdinalIgnoreCase.Equals(value, "CertificateExpirationWarning"))
            {
                return CertificateOrderActionType.CertificateExpirationWarning;
            }
            if (StringComparer.OrdinalIgnoreCase.Equals(value, "FraudDocumentationRequired"))
            {
