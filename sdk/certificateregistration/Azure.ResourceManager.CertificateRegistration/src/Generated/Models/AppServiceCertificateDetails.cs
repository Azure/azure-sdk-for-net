...
namespace Azure.ResourceManager.CertificateRegistration.Models
{
    ...
    public partial class AppServiceCertificateDetails
    {
        ...
        internal AppServiceCertificateDetails(int? version, string serialNumber, string thumbprint, string subject, DateTimeOffset? notBefore, DateTimeOffset? notAfter, string signatureAlgorithm, string issuer, string rawData, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Version = version;
