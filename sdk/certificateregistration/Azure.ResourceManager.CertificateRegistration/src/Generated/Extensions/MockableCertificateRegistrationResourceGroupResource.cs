...
namespace Azure.ResourceManager.CertificateRegistration.Mocking
{
    ...
    public partial class MockableCertificateRegistrationResourceGroupResource : ArmResource
    {
        /// <summary> Initializes a new instance of MockableCertificateRegistrationResourceGroupResource for mocking. </summary>
        protected MockableCertificateRegistrationResourceGroupResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="MockableCertificateRegistrationResourceGroupResource"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MockableCertificateRegistrationResourceGroupResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        /// <summary> Gets a collection of AppServiceCertificateOrders in the <see cref="ResourceGroupResource"/>. </summary>
