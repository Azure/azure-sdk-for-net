...
{
    /// <summary></summary>
    public partial class AppServiceDetectorResource : IJsonModel<AppServiceDetectorData>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<AppServiceDetectorData>.Write(ModelReaderWriterOptions options) => ModelReaderWriter.Write<AppServiceDetectorData>(Data, options, AzureResourceManagerCertificateRegistrationContext.Default);

        /// <param name="data"> The binary data to be processed. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        AppServiceDetectorData IPersistableModel<AppServiceDetectorData>.Create(BinaryData data, ModelReaderWriterOptions options) => ModelReaderWriter.Read<AppServiceDetectorData>(data, options, AzureResourceManagerCertificateRegistrationContext.Default);
