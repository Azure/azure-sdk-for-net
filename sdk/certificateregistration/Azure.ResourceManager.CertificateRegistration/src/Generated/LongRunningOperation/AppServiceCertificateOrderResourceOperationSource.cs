...
{
    /// <summary></summary>
    internal partial class AppServiceCertificateOrderResourceOperationSource : IOperationSource<AppServiceCertificateOrderResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal AppServiceCertificateOrderResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
