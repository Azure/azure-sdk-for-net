...
{
    internal partial class CertificateRegistrationArmOperation : ArmOperation
    {
        ...
        internal CertificateRegistrationArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal CertificateRegistrationArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
