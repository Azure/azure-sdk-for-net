...
namespace Azure.ResourceManager.CertificateRegistration
{
    internal partial class CertificateRegistrationArmOperation : ArmOperation
    {
        ...
        internal CertificateRegistrationArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
