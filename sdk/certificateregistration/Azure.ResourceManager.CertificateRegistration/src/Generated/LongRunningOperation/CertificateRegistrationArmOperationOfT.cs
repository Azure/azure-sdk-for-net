...
{
    internal partial class CertificateRegistrationArmOperation<T> : ArmOperation<T>
    {
        ...
        /// <summary> Initializes a new instance of CertificateRegistrationArmOperation for mocking. </summary>
        protected CertificateRegistrationArmOperation()
        {
        }
        ...
        internal CertificateRegistrationArmOperation(Response<T> response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal CertificateRegistrationArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal<T>(
                ...
                clientDiagnostics,
                response,
                "CertificateRegistrationArmOperation",
                null,
