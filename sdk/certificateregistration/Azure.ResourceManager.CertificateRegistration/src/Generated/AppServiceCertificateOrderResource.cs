...
{
    /// <summary>
    /// A class representing a AppServiceCertificateOrder along with the instance operations that can be performed on it.
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="AppServiceCertificateOrderResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="ResourceGroupResource"/> using the GetAppServiceCertificateOrders method.
    /// </summary>
    public partial class AppServiceCertificateOrderResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of AppServiceCertificateOrderResource for mocking. </summary>
        protected AppServiceCertificateOrderResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="AppServiceCertificateOrderResource"/> class. </summary>
        ...
        internal AppServiceCertificateOrderResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _appServiceCertificateOrdersClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.CertificateRegistration", ResourceType.Namespace, Diagnostics);
        ...
        {
            string resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.CertificateRegistration/certificateOrders/{certificateOrderName}";
        ...
        {
            using DiagnosticScope scope = _appServiceCertificateOrdersClientDiagnostics.CreateScope("AppServiceCertificateOrderResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _appServiceCertificateOrdersRestClient.CreateGetRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, context);
        ...
        public virtual async Task<Response<AppServiceCertificateOrderResource>> UpdateAsync(AppServiceCertificateOrderPatch patch, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _appServiceCertificateOrdersClientDiagnostics.CreateScope("AppServiceCertificateOrderResource.Update");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _appServiceCertificateOrdersRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, AppServiceCertificateOrderPatch.ToRequestContent(patch), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<AppServiceCertificateOrderData> response = Response.FromValue(AppServiceCertificateOrderData.FromResponse(result), result);
                if (response.Value == null)
                {
        ...
        {
            using DiagnosticScope scope = _appServiceCertificateOrdersClientDiagnostics.CreateScope("AppServiceCertificateOrderResource.Delete");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _appServiceCertificateOrdersRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, context);
        ...
        public virtual async Task<Response> ReissueAsync(ReissueCertificateOrderContent content, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _appServiceCertificateOrdersClientDiagnostics.CreateScope("AppServiceCertificateOrderResource.Reissue");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _appServiceCertificateOrdersRestClient.CreateReissueRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, ReissueCertificateOrderContent.ToRequestContent(content), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
        ...
        public virtual async Task<Response> RenewAsync(RenewCertificateOrderContent content, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _appServiceCertificateOrdersClientDiagnostics.CreateScope("AppServiceCertificateOrderResource.Renew");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _appServiceCertificateOrdersRestClient.CreateRenewRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, RenewCertificateOrderContent.ToRequestContent(content), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
        ...
        {
            using DiagnosticScope scope = _appServiceCertificateOrdersClientDiagnostics.CreateScope("AppServiceCertificateOrderResource.ResendEmail");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _appServiceCertificateOrdersRestClient.CreateResendEmailRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
        ...
        public virtual async Task<Response> ResendRequestEmailsAsync(AppServiceDomainNameIdentifier nameIdentifier, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _appServiceCertificateOrdersClientDiagnostics.CreateScope("AppServiceCertificateOrderResource.ResendRequestEmails");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _appServiceCertificateOrdersRestClient.CreateResendRequestEmailsRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, AppServiceDomainNameIdentifier.ToRequestContent(nameIdentifier), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
        ...
        public virtual async Task<Response<SiteSeal>> RetrieveSiteSealAsync(SiteSealContent content, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _appServiceCertificateOrdersClientDiagnostics.CreateScope("AppServiceCertificateOrderResource.RetrieveSiteSeal");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _appServiceCertificateOrdersRestClient.CreateRetrieveSiteSealRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, SiteSealContent.ToRequestContent(content), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<SiteSeal> response = Response.FromValue(SiteSeal.FromResponse(result), result);
                if (response.Value == null)
                {
                    throw new RequestFailedException(response.GetRawResponse());
                }
        ...
        {
            using DiagnosticScope scope = _appServiceCertificateOrdersClientDiagnostics.CreateScope("AppServiceCertificateOrderResource.VerifyDomainOwnership");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _appServiceCertificateOrdersRestClient.CreateVerifyDomainOwnershipRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
        ...
        /// <summary>
        /// Updates the AppServiceCertificateOrder.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.CertificateRegistration/certificateOrders/{certificateOrderName}. </description>
        ...
        public virtual async Task<ArmOperation<AppServiceCertificateOrderResource>> UpdateAsync(WaitUntil waitUntil, AppServiceCertificateOrderData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _appServiceCertificateOrdersRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, AppServiceCertificateOrderData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<AppServiceCertificateOrderResource> Update(WaitUntil waitUntil, AppServiceCertificateOrderData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
        ...
        /// <summary> Gets a collection of AppServiceCertificates in the <see cref="AppServiceCertificateOrderResource"/>. </summary>
        /// <returns> An object representing collection of AppServiceCertificates and their operations over a AppServiceCertificateResource. </returns>
        ...
        /// <summary> Gets a collection of AppServiceDetectors in the <see cref="AppServiceCertificateOrderResource"/>. </summary>
        /// <returns> An object representing collection of AppServiceDetectors and their operations over a AppServiceDetectorResource. </returns>
