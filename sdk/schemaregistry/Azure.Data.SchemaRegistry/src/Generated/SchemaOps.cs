...
namespace Azure.Data.SchemaRegistry
{
    ...
    /// <summary> The SchemaOps sub-client. </summary>
    public partial class SchemaOps
    {
        ...
        /// <summary> Initializes a new instance of SchemaOps for mocking. </summary>
        protected SchemaOps()
        {
        }
        ...
        internal SchemaOps(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, TokenCredential tokenCredential, Uri endpoint, string apiVersion)
        {
        ...
        internal virtual async Task<Response> GetSchemaByIdAsync(string id, RequestContext context)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("SchemaOps.GetSchemaById");
            scope.Start();
            try
            {
        ...
        /// <include file="Docs/SchemaOps.xml" path="doc/members/member[@name='GetSchemaByVersionAsync(string,string,int,CancellationToken)']/*" />
        ...
        /// <exception cref="ArgumentException"> <paramref name="groupName"/> or <paramref name="name"/> is an empty string, and was expected to be non-empty. </exception>
        /// <remarks> Gets one specific version of one schema. </remarks>
        /// <include file="Docs/SchemaOps.xml" path="doc/members/member[@name='GetSchemaByVersion(string,string,int,CancellationToken)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/SchemaOps.xml" path="doc/members/member[@name='GetSchemaByVersionAsync(string,string,int,RequestContext)']/*" />
        public virtual async Task<Response> GetSchemaByVersionAsync(string groupName, string name, int schemaVersion, RequestContext context)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("SchemaOps.GetSchemaByVersion");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/SchemaOps.xml" path="doc/members/member[@name='GetSchemaByVersion(string,string,int,RequestContext)']/*" />
        ...
        /// <param name="contentType"> The content type for given schema. Allowed values: "application/octet-stream" | "application/json; serialization=Avro" | "application/json; serialization=json" | "text/vnd.ms.protobuf". </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        ...
        internal virtual async Task<Response> GetSchemaIdByContentAsync(string groupName, string name, RequestContent content, Core.ContentType contentType, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("SchemaOps.GetSchemaIdByContent");
            scope.Start();
            try
            {
        ...
        internal virtual async Task<Response> RegisterSchemaAsync(string groupName, string name, RequestContent content, Core.ContentType contentType, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("SchemaOps.RegisterSchema");
            scope.Start();
            try
            {
        ...
        internal virtual AsyncPageable<SchemaGroup> GetSchemaGroupsAsync(CancellationToken cancellationToken = default)
        {
            ...
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, SchemaGroup.DeserializeSchemaGroup, ClientDiagnostics, _pipeline, "SchemaOps.GetSchemaGroups", "value", "nextLink", context);
        }
        ...
        internal virtual Pageable<SchemaGroup> GetSchemaGroups(CancellationToken cancellationToken = default)
        {
            ...
            HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetSchemaGroupsRequest(context);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CreateGetSchemaGroupsNextPageRequest(nextLink, context);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, SchemaGroup.DeserializeSchemaGroup, ClientDiagnostics, _pipeline, "SchemaOps.GetSchemaGroups", "value", "nextLink", context);
        }
        ...
        internal virtual AsyncPageable<BinaryData> GetSchemaGroupsAsync(RequestContext context)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetSchemaGroupsRequest(context);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CreateGetSchemaGroupsNextPageRequest(nextLink, context);
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => BinaryData.FromString(e.GetRawText()), ClientDiagnostics, _pipeline, "SchemaOps.GetSchemaGroups", "value", "nextLink", context);
        }
        ...
        internal virtual Pageable<BinaryData> GetSchemaGroups(RequestContext context)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetSchemaGroupsRequest(context);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CreateGetSchemaGroupsNextPageRequest(nextLink, context);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => BinaryData.FromString(e.GetRawText()), ClientDiagnostics, _pipeline, "SchemaOps.GetSchemaGroups", "value", "nextLink", context);
        }
        ...
        internal virtual AsyncPageable<SchemaVersion> GetSchemaVersionsAsync(string groupName, string name, CancellationToken cancellationToken = default)
        {
            ...
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, SchemaVersion.DeserializeSchemaVersion, ClientDiagnostics, _pipeline, "SchemaOps.GetSchemaVersions", "value", "nextLink", context);
        }
        ...
        internal virtual Pageable<SchemaVersion> GetSchemaVersions(string groupName, string name, CancellationToken cancellationToken = default)
        {
            ...
            HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetSchemaVersionsRequest(groupName, name, context);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CreateGetSchemaVersionsNextPageRequest(nextLink, groupName, name, context);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, SchemaVersion.DeserializeSchemaVersion, ClientDiagnostics, _pipeline, "SchemaOps.GetSchemaVersions", "value", "nextLink", context);
        }
        ...
        internal virtual AsyncPageable<BinaryData> GetSchemaVersionsAsync(string groupName, string name, RequestContext context)
        {
            ...
            HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetSchemaVersionsRequest(groupName, name, context);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CreateGetSchemaVersionsNextPageRequest(nextLink, groupName, name, context);
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => BinaryData.FromString(e.GetRawText()), ClientDiagnostics, _pipeline, "SchemaOps.GetSchemaVersions", "value", "nextLink", context);
        }
        ...
        internal virtual Pageable<BinaryData> GetSchemaVersions(string groupName, string name, RequestContext context)
        {
            ...
            HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetSchemaVersionsRequest(groupName, name, context);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CreateGetSchemaVersionsNextPageRequest(nextLink, groupName, name, context);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => BinaryData.FromString(e.GetRawText()), ClientDiagnostics, _pipeline, "SchemaOps.GetSchemaVersions", "value", "nextLink", context);
        }
