...
namespace Azure.Data.SchemaRegistry
{
    ...
    /// <summary> The Schema sub-client. </summary>
    public partial class Schema
    {
        ...
        internal Schema(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, TokenCredential tokenCredential, Uri endpoint, string apiVersion)
        {
        ...
        internal virtual async Task<Response> GetSchemaByIdAsync(string id, RequestContext context)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("Schema.GetSchemaById");
            scope.Start();
            try
            {
        ...
        /// <include file="Docs/Schema.xml" path="doc/members/member[@name='GetSchemaByVersionAsync(string,string,int,CancellationToken)']/*" />
        ...
        /// <exception cref="ArgumentException"> <paramref name="groupName"/> or <paramref name="name"/> is an empty string, and was expected to be non-empty. </exception>
        /// <remarks> Gets one specific version of one schema. </remarks>
        /// <include file="Docs/Schema.xml" path="doc/members/member[@name='GetSchemaByVersion(string,string,int,CancellationToken)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/Schema.xml" path="doc/members/member[@name='GetSchemaByVersionAsync(string,string,int,RequestContext)']/*" />
        public virtual async Task<Response> GetSchemaByVersionAsync(string groupName, string name, int schemaVersion, RequestContext context)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("Schema.GetSchemaByVersion");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/Schema.xml" path="doc/members/member[@name='GetSchemaByVersion(string,string,int,RequestContext)']/*" />
        ...
        internal virtual async Task<Response> GetSchemaIdByContentAsync(string groupName, string name, RequestContent content, Core.ContentType contentType, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("Schema.GetSchemaIdByContent");
            scope.Start();
            try
            {
        ...
        internal virtual async Task<Response> RegisterSchemaAsync(string groupName, string name, RequestContent content, Core.ContentType contentType, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("Schema.RegisterSchema");
            scope.Start();
            try
            {
        ...
        internal virtual AsyncPageable<SchemaGroup> GetSchemaGroupsAsync(CancellationToken cancellationToken = default)
        {
            ...
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, SchemaGroup.DeserializeSchemaGroup, ClientDiagnostics, _pipeline, "Schema.GetSchemaGroups", "value", "nextLink", context);
        }
        ...
        internal virtual Pageable<SchemaGroup> GetSchemaGroups(CancellationToken cancellationToken = default)
        {
            ...
            HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetSchemaGroupsRequest(context);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CreateGetSchemaGroupsNextPageRequest(nextLink, context);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, SchemaGroup.DeserializeSchemaGroup, ClientDiagnostics, _pipeline, "Schema.GetSchemaGroups", "value", "nextLink", context);
        }
        ...
        internal virtual AsyncPageable<BinaryData> GetSchemaGroupsAsync(RequestContext context)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetSchemaGroupsRequest(context);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CreateGetSchemaGroupsNextPageRequest(nextLink, context);
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => BinaryData.FromString(e.GetRawText()), ClientDiagnostics, _pipeline, "Schema.GetSchemaGroups", "value", "nextLink", context);
        }
        ...
        internal virtual Pageable<BinaryData> GetSchemaGroups(RequestContext context)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetSchemaGroupsRequest(context);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CreateGetSchemaGroupsNextPageRequest(nextLink, context);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => BinaryData.FromString(e.GetRawText()), ClientDiagnostics, _pipeline, "Schema.GetSchemaGroups", "value", "nextLink", context);
        }
        ...
        internal virtual AsyncPageable<SchemaVersion> GetSchemaVersionsAsync(string groupName, string name, CancellationToken cancellationToken = default)
        {
            ...
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, SchemaVersion.DeserializeSchemaVersion, ClientDiagnostics, _pipeline, "Schema.GetSchemaVersions", "value", "nextLink", context);
        }
        ...
        internal virtual Pageable<SchemaVersion> GetSchemaVersions(string groupName, string name, CancellationToken cancellationToken = default)
        {
            ...
            HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetSchemaVersionsRequest(groupName, name, context);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CreateGetSchemaVersionsNextPageRequest(nextLink, groupName, name, context);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, SchemaVersion.DeserializeSchemaVersion, ClientDiagnostics, _pipeline, "Schema.GetSchemaVersions", "value", "nextLink", context);
        }
        ...
        internal virtual AsyncPageable<BinaryData> GetSchemaVersionsAsync(string groupName, string name, RequestContext context)
        {
            ...
            HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetSchemaVersionsRequest(groupName, name, context);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CreateGetSchemaVersionsNextPageRequest(nextLink, groupName, name, context);
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => BinaryData.FromString(e.GetRawText()), ClientDiagnostics, _pipeline, "Schema.GetSchemaVersions", "value", "nextLink", context);
        }
        ...
        internal virtual Pageable<BinaryData> GetSchemaVersions(string groupName, string name, RequestContext context)
        {
            ...
            HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetSchemaVersionsRequest(groupName, name, context);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CreateGetSchemaVersionsNextPageRequest(nextLink, groupName, name, context);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => BinaryData.FromString(e.GetRawText()), ClientDiagnostics, _pipeline, "Schema.GetSchemaVersions", "value", "nextLink", context);
        }
