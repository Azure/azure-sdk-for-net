...
{
    internal partial class SchemaRegistryClientGetSchemaVersionsAsyncCollectionResultOfT : AsyncPageable<int>
    {
        ...
        /// <summary> Initializes a new instance of SchemaRegistryClientGetSchemaVersionsAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        /// <summary> Gets the pages of SchemaRegistryClientGetSchemaVersionsAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of SchemaRegistryClientGetSchemaVersionsAsyncCollectionResultOfT as an enumerable collection. </returns>
        public override async IAsyncEnumerable<Page<int>> AsPages(string continuationToken, int? pageSizeHint)
        {
