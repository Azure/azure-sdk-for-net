...
namespace Azure.Data.SchemaRegistry
{
    ...
    {
        public static void AppendQueryDelimited<T>(this RawRequestUriBuilder builder, string name, IEnumerable<T> value, string delimiter, SerializationFormat format = global::Azure.Data.SchemaRegistry.SerializationFormat.Default, bool escape = true)
        {
            delimiter ??= ",";
            IEnumerable<string> stringValues = value.Select(v => global::Azure.Data.SchemaRegistry.TypeFormatters.ConvertToString(v, format));
