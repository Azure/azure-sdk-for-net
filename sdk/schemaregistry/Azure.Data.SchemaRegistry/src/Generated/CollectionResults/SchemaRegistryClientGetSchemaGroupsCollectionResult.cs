...
{
    internal partial class SchemaRegistryClientGetSchemaGroupsCollectionResult : Pageable<global::System.BinaryData>
    {
        ...
        public SchemaRegistryClientGetSchemaGroupsCollectionResult(SchemaRegistryClient client, RequestContext context, string diagnosticScope) : base((context?.CancellationToken ?? default))
        {
            _client = client;
            _context = context;
