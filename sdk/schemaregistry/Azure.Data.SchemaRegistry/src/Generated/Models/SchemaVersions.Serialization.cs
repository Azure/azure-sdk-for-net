...
namespace Azure.Data.SchemaRegistry.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SchemaVersions>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SchemaVersions>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SchemaVersions>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SchemaVersions>)} interface");
            }
        ...
        string IPersistableModel<SchemaVersions>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
