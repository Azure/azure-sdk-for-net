...
namespace Azure.Data.SchemaRegistry.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SchemaGroups>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<SchemaGroups>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SchemaGroups>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
