...
namespace Azure.Data.SchemaRegistry.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SchemaGroups>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SchemaGroups>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SchemaGroups>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SchemaGroups>)} interface");
            }
        ...
        string IPersistableModel<SchemaGroups>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
