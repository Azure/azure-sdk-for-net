...
namespace Azure.Data.SchemaRegistry.Samples
{
    public partial class Samples_SchemaRegistryClient
    {
        ...
        public void Example_GetSchemaByVersion_ShortVersion()
        {
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task Example_GetSchemaByVersion_ShortVersion_Async()
        {
            Uri endpoint = new Uri("<https://my-service.azure.com>");
            TokenCredential credential = new DefaultAzureCredential();
            SchemaRegistryClient client = new SchemaRegistryClient(endpoint, credential);
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public void Example_GetSchemaByVersion_ShortVersion_Convenience()
        {
            Uri endpoint = new Uri("<https://my-service.azure.com>");
            TokenCredential credential = new DefaultAzureCredential();
            SchemaRegistryClient client = new SchemaRegistryClient(endpoint, credential);
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task Example_GetSchemaByVersion_ShortVersion_Convenience_Async()
        {
            Uri endpoint = new Uri("<https://my-service.azure.com>");
            TokenCredential credential = new DefaultAzureCredential();
            SchemaRegistryClient client = new SchemaRegistryClient(endpoint, credential);
