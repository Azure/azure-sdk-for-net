...
namespace Microsoft.Azure.Data.SchemaRegistry.JsonSchema
{
    ...
    internal class SchemaRegistryJsonEventSource : AzureEventSource
    {
        ...
        ///   use for logging.
        /// </summary>
        public static SchemaRegistryJsonEventSource Log { get; } = new SchemaRegistryJsonEventSource();

        /// <summary>
        ///   Prevents an instance of the <see cref="SchemaRegistryJsonEventSource"/> class from being
        ...
        /// </summary>
        protected SchemaRegistryJsonEventSource() : base(EventSourceName)
        {
        }
