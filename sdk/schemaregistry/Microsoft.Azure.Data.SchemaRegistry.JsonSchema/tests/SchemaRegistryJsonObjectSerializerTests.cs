...
namespace Microsoft.Azure.Data.SchemaRegistry.JsonSchema.Tests
{
    public class SchemaRegistryJsonObjectSerializerTests
    {
        ...
        public async Task SerializeWorksWithNoOptions()
        {
           ...
           var serializer = new SchemaRegistryJsonSerializer(mockClient.Object, "groupName");
           ...
           serializer = new SchemaRegistryJsonSerializer(mockClient.Object, "groupName", null);
        ...
        {
            var options = new SchemaRegistryJsonSerializerOptions() { AutoRegisterSchemas = true };
