...
namespace Azure.Data.SchemaRegistry.JsonSchema.Tests
{
    ...
    public class EventSourceLiveTests : SchemaRegistryJsonObjectSerializerLiveTestBase
    {
        ...
        public void Setup()
        {
            ...
            _listener.EnableEvents(SchemaRegistryJsonEventSource.Log, EventLevel.Verbose);
        }
        ...
        public async Task UpdatingCacheLogsEvents()
        {
            ...
            var events = _listener.EventsById(SchemaRegistryJsonEventSource.CacheUpdatedEvent).ToArray();
