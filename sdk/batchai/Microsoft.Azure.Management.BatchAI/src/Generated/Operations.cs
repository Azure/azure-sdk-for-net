...
namespace Microsoft.Azure.Management.BatchAI
{
    ...
    /// </summary>
    internal partial class Operations : IServiceOperations<BatchAIManagementClient>, IOperations
    {
        /// <summary>
        ...
        public async Task<AzureOperationResponse<IPage<Operation>>> ListWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "providers/Microsoft.BatchAI/operations").ToString();
