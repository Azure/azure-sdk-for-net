...
namespace Microsoft.Azure.Management.Chaos.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the ExperimentCancelOperationResult
        /// class.
        /// </summary>
        ...
        /// status.</param>
        public ExperimentCancelOperationResult(string name = default(string), string statusUrl = default(string))
        {
            Name = name;
            StatusUrl = statusUrl;
            CustomInit();
