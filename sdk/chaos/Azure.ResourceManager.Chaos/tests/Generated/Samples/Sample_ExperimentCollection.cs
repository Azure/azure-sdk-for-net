...
namespace Azure.ResourceManager.Chaos
{
    public partial class Sample_ExperimentCollection
    {
        ...
        {
            // Generated from example definition: specification/chaos/resource-manager/Microsoft.Chaos/preview/2022-07-01-preview/examples/ListExperimentsInAResourceGroup.json
        ...
        {
            // Generated from example definition: specification/chaos/resource-manager/Microsoft.Chaos/preview/2022-07-01-preview/examples/GetAExperiment.json
        ...
        {
            // Generated from example definition: specification/chaos/resource-manager/Microsoft.Chaos/preview/2022-07-01-preview/examples/CreateOrUpdateAExperiment.json
            ...
            // invoke the operation
            string experimentName = "exampleExperiment";
            ExperimentData data = new ExperimentData(new AzureLocation("centraluseuap"), new Step[]
            {
new Step("step1",new Branch[]
{
new Branch("branch1",new Models.Action[]
{
new Action("urn:csci:provider:providername:Shutdown/1.0")
{
