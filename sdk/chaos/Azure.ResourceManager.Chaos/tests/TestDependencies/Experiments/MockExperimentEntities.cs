...
namespace Azure.ResourceManager.Chaos.Tests.TestDependencies.Experiments
{
    public class MockExperimentEntities
    {
        ...
        public ChaosExperimentData GetVmssShutdownV2v0Experiment()
        {
            ...
            IEnumerable<Models.ContinuousActionKeyValuePair> actionParams = new List<Models.ContinuousActionKeyValuePair>() { new Models.ContinuousActionKeyValuePair("abruptShutdown", "true") };
            Models.ChaosExperimentAction action = new ExperimentContinuousAction(
