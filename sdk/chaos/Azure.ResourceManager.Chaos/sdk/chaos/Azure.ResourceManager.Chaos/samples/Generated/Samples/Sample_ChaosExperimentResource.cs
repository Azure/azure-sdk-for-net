...
[new ResourceIdentifier("/subscriptions/6b052e15-03d3-4f17-b2e1-be7f07588291/resourceGroups/exampleRG/providers/Microsoft.ManagedIdentity/userAssignedIdentity/exampleUMI")] = new UserAssignedIdentity(),
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task CancelExperiment_CancelARunningExperiment()
        {
            // Generated from example definition: 2025-01-01/Experiments_Cancel.json
            // this example is just showing the usage of "Experiments_CancelExperiment" operation, for the dependent resources, they will have to be created separately.
            ...
            // invoke the operation
            ArmOperation<PostActionResult> lro = await chaosExperiment.CancelExperimentAsync(WaitUntil.Completed);
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task StartExperiment_StartAExperiment()
        {
            // Generated from example definition: 2025-01-01/Experiments_Start.json
            // this example is just showing the usage of "Experiments_StartExperiment" operation, for the dependent resources, they will have to be created separately.
            ...
            // invoke the operation
            ArmOperation<PostActionResult> lro = await chaosExperiment.StartExperimentAsync(WaitUntil.Completed);
            PostActionResult result = lro.Value;
