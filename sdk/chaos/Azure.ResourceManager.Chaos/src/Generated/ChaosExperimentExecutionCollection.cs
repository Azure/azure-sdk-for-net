...
namespace Azure.ResourceManager.Chaos
{
    ...
    public partial class ChaosExperimentExecutionCollection : ArmCollection, IEnumerable<ChaosExperimentExecutionResource>, IAsyncEnumerable<ChaosExperimentExecutionResource>
    {
        ...
        public virtual async Task<Response<ChaosExperimentExecutionResource>> GetAsync(string executionId, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _chaosExperimentExecutionExperimentExecutionsRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, executionId, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<ChaosExperimentExecutionResource> Get(string executionId, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _chaosExperimentExecutionExperimentExecutionsRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, executionId, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new ChaosExperimentExecutionResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        /// <item>
        /// <term>Operation Id</term>
        /// <description>ExperimentExecution_List</description>
        /// </item>
        /// <item>
        /// <term>Default Api Version</term>
        /// <description>2025-01-01</description>
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _chaosExperimentExecutionExperimentExecutionsRestClient.CreateListRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _chaosExperimentExecutionExperimentExecutionsRestClient.CreateListNextPageRequest(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Name);
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string executionId, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _chaosExperimentExecutionExperimentExecutionsRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, executionId, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<bool> Exists(string executionId, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _chaosExperimentExecutionExperimentExecutionsRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, executionId, cancellationToken: cancellationToken);
                return Response.FromValue(response.Value != null, response.GetRawResponse());
            }
            catch (Exception e)
            {
