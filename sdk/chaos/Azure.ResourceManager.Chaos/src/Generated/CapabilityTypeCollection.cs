...
namespace Azure.ResourceManager.Chaos
{
    ...
    public partial class CapabilityTypeCollection : ArmCollection, IEnumerable<CapabilityTypeResource>, IAsyncEnumerable<CapabilityTypeResource>
    {
        ...
        public virtual async Task<Response<CapabilityTypeResource>> GetAsync(string capabilityTypeName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _capabilityTypeRestClient.GetAsync(Id.SubscriptionId, new AzureLocation(Id.Parent.Name), Id.Name, capabilityTypeName, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<CapabilityTypeResource> Get(string capabilityTypeName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _capabilityTypeRestClient.Get(Id.SubscriptionId, new AzureLocation(Id.Parent.Name), Id.Name, capabilityTypeName, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new CapabilityTypeResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _capabilityTypeRestClient.CreateListRequest(Id.SubscriptionId, new AzureLocation(Id.Parent.Name), Id.Name, continuationToken);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _capabilityTypeRestClient.CreateListNextPageRequest(nextLink, Id.SubscriptionId, new AzureLocation(Id.Parent.Name), Id.Name, continuationToken);
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string capabilityTypeName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _capabilityTypeRestClient.GetAsync(Id.SubscriptionId, new AzureLocation(Id.Parent.Name), Id.Name, capabilityTypeName, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<bool> Exists(string capabilityTypeName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _capabilityTypeRestClient.Get(Id.SubscriptionId, new AzureLocation(Id.Parent.Name), Id.Name, capabilityTypeName, cancellationToken: cancellationToken);
                return Response.FromValue(response.Value != null, response.GetRawResponse());
            }
            catch (Exception e)
            {
