...
namespace Azure.ResourceManager.Chaos
{
    ...
    public partial class ChaosTargetTypeData : ResourceData
    {
        ...
        /// <param name="location"> Azure location of the resource. </param>
        /// <param name="serializedAdditionalRawData"> Keeps track of any properties unknown to the library. </param>
        internal ChaosTargetTypeData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string displayName, string description, string propertiesSchema, IReadOnlyList<string> resourceTypes, AzureLocation? location, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
        ...
        /// <summary> Azure location of the resource. </summary>
