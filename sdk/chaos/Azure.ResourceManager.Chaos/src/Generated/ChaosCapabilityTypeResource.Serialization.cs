...
namespace Azure.ResourceManager.Chaos
{
    ...
    {
        private static ChaosCapabilityTypeData s_dataDeserializationInstance;
        private static ChaosCapabilityTypeData DataDeserializationInstance => s_dataDeserializationInstance ??= new();
        ...
        ChaosCapabilityTypeData IJsonModel<ChaosCapabilityTypeData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => ((IJsonModel<ChaosCapabilityTypeData>)DataDeserializationInstance).Create(ref reader, options);
        ...
        string IPersistableModel<ChaosCapabilityTypeData>.GetFormatFromOptions(ModelReaderWriterOptions options) => ((IPersistableModel<ChaosCapabilityTypeData>)DataDeserializationInstance).GetFormatFromOptions(options);
    }
}
