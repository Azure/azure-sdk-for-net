...
namespace Azure.ResourceManager.Chaos
{
    ...
    public partial class ChaosCapabilityTypeData : ResourceData
    {
        ...
        internal ChaosCapabilityTypeData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string publisher, string targetType, string displayName, string description, string parametersSchema, string urn, string kind, IReadOnlyList<string> azureRbacActions, IReadOnlyList<string> azureRbacDataActions, CapabilityTypePropertiesRuntimeProperties runtimeProperties, AzureLocation? location, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
            Publisher = publisher;
