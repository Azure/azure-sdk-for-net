...
namespace Azure.ResourceManager.Chaos
{
    ...
    public partial class ChaosCapabilityTypeData : ResourceData
    {
        ...
        internal ChaosCapabilityTypeData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string publisher, string targetType, string displayName, string description, string parametersSchema, string urn, string kind, IReadOnlyList<string> azureRbacActions, IReadOnlyList<string> azureRbacDataActions, IReadOnlyList<string> requiredAzureRoleDefinitionIds, ChaosCapabilityTypeRuntimeProperties runtimeProperties, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
            Publisher = publisher;
        ...
        internal ChaosCapabilityTypeRuntimeProperties RuntimeProperties { get; }
