...
namespace Azure.ResourceManager.Chaos
{
    ...
    public partial class TargetTypeData : ResourceData
    {
        ...
        internal TargetTypeData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, AzureLocation? location, string displayName, string description, string propertiesSchema, IReadOnlyList<string> resourceTypes, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData)
        {
            Location = location;
