...
namespace Azure.ResourceManager.Chaos
{
    ...
    public partial class ChaosWorkspaceResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<ChaosWorkspaceResource>> UpdateAsync(WaitUntil waitUntil, ChaosWorkspaceData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _workspacesRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, ChaosWorkspaceData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                ChaosArmOperation<ChaosWorkspaceResource> operation = new ChaosArmOperation<ChaosWorkspaceResource>(
                    new ChaosWorkspaceResourceOperationSource(Client),
                    _workspacesClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<ChaosWorkspaceResource> Update(WaitUntil waitUntil, ChaosWorkspaceData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
