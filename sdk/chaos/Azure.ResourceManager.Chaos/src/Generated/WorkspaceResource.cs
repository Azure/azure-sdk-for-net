...
namespace Azure.ResourceManager.Chaos
{
    ...
    public partial class WorkspaceResource : ArmResource
    {
        ...
        {
            _workspaceClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Chaos", ResourceType.Namespace, Diagnostics);
        ...
        /// <summary> Gets a collection of DiscoveredResources in the Workspace. </summary>
        ...
        /// <summary> Gets a collection of ScenarioResources in the Workspace. </summary>
        /// <returns> An object representing collection of ScenarioResources and their operations over a ScenarioResource. </returns>
        public virtual ScenarioCollection GetScenarios()
        {
            return GetCachedClient(client => new ScenarioCollection(client, Id));
        }
        ...
        [ForwardsClientCalls]
        public virtual async Task<Response<ScenarioResource>> GetScenarioAsync(string scenarioName, CancellationToken cancellationToken = default)
        {
            return await GetScenarios().GetAsync(scenarioName, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <exception cref="ArgumentException"> <paramref name="scenarioName"/> is an empty string, and was expected to be non-empty. </exception>
        [ForwardsClientCalls]
        public virtual Response<ScenarioResource> GetScenario(string scenarioName, CancellationToken cancellationToken = default)
        {
            return GetScenarios().Get(scenarioName, cancellationToken);
        }
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new ChaosArmOperation(_workspaceClientDiagnostics, Pipeline, _workspaceRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name).Request, response, OperationFinalStateVia.Location);
        ...
        public virtual async Task<ArmOperation<WorkspaceResource>> UpdateAsync(WaitUntil waitUntil, WorkspacePatch patch, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new ChaosArmOperation<WorkspaceResource>(new WorkspaceOperationSource(Client), _workspaceClientDiagnostics, Pipeline, _workspaceRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, patch).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
        ...
        {
            using var scope = _workspaceClientDiagnostics.CreateScope("WorkspaceResource.RefreshRecommendations");
            scope.Start();
            try
            {
                var response = await _workspaceRestClient.RefreshRecommendationsAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken).ConfigureAwait(false);
                var operation = new ChaosArmOperation<OperationStatusResult>(new OperationStatusResultOperationSource(), _workspaceClientDiagnostics, Pipeline, _workspaceRestClient.CreateRefreshRecommendationsRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                    await operation.WaitForCompletionAsync(cancellationToken).ConfigureAwait(false);
                return operation;
            }
        ...
        public virtual ArmOperation<OperationStatusResult> RefreshRecommendations(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _workspaceRestClient.RefreshRecommendations(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken);
                var operation = new ChaosArmOperation<OperationStatusResult>(new OperationStatusResultOperationSource(), _workspaceClientDiagnostics, Pipeline, _workspaceRestClient.CreateRefreshRecommendationsRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                    operation.WaitForCompletion(cancellationToken);
                return operation;
