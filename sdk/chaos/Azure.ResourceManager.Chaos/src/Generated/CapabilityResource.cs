...
namespace Azure.ResourceManager.Chaos
{
    ...
    public partial class CapabilityResource : ArmResource
    {
        ...
        internal CapabilityResource(ArmClient client, CapabilityData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<CapabilityResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new CapabilityResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual async Task<ArmOperation<CapabilityResource>> UpdateAsync(WaitUntil waitUntil, CapabilityData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new ChaosArmOperation<CapabilityResource>(Response.FromValue(new CapabilityResource(Client, response.Value, response.Value.Id), response.GetRawResponse()));
                if (waitUntil == WaitUntil.Completed)
