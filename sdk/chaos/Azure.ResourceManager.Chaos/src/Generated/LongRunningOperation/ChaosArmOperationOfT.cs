...
namespace Azure.ResourceManager.Chaos
{
    internal partial class ChaosArmOperation<T> : ArmOperation<T>
    {
        ...
        internal ChaosArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
