...
namespace Azure.ResourceManager.Chaos
{
    internal partial class DiscoveredResourcesGetByWorkspaceCollectionResultOfT : Pageable<DiscoveredResourceData>
    {
        ...
        public DiscoveredResourcesGetByWorkspaceCollectionResultOfT(DiscoveredResources client, Guid subscriptionId, string resourceGroupName, string workspaceName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
