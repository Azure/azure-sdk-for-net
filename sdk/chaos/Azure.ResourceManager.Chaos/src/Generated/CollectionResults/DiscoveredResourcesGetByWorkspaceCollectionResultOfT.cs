...
namespace Azure.ResourceManager.Chaos
{
    internal partial class DiscoveredResourcesGetByWorkspaceCollectionResultOfT : Pageable<ChaosDiscoveredData>
    {
        ...
        /// <summary> Initializes a new instance of DiscoveredResourcesGetByWorkspaceCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public DiscoveredResourcesGetByWorkspaceCollectionResultOfT(DiscoveredResources client, Guid subscriptionId, string resourceGroupName, string workspaceName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of DiscoveredResourcesGetByWorkspaceCollectionResultOfT as an enumerable collection. </summary>
