...
namespace Azure.ResourceManager.Chaos
{
    internal partial class ConnectionsGetAllCollectionResultOfT : Pageable<ChaosConnectionData>
    {
        ...
        public ConnectionsGetAllCollectionResultOfT(Connections client, Guid subscriptionId, string resourceGroupName, string workspaceName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
