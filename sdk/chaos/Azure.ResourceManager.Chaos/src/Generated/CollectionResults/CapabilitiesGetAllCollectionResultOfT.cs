...
namespace Azure.ResourceManager.Chaos
{
    internal partial class CapabilitiesGetAllCollectionResultOfT : Pageable<ChaosCapabilityData>
    {
        ...
        public CapabilitiesGetAllCollectionResultOfT(Capabilities client, Guid subscriptionId, string resourceGroupName, string parentProviderNamespace, string parentResourceType, string parentResourceName, string targetName, string continuationToken, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
