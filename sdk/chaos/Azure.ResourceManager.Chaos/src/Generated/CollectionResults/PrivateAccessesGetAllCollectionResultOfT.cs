...
namespace Azure.ResourceManager.Chaos
{
    internal partial class PrivateAccessesGetAllCollectionResultOfT : Pageable<PrivateAccessData>
    {
        ...
        public PrivateAccessesGetAllCollectionResultOfT(PrivateAccesses client, Guid subscriptionId, string resourceGroupName, string continuationToken, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
