...
namespace Azure.ResourceManager.Chaos
{
    internal partial class ExperimentsGetAllAsyncCollectionResultOfT : AsyncPageable<ChaosExperimentData>
    {
        ...
        public ExperimentsGetAllAsyncCollectionResultOfT(Experiments client, Guid subscriptionId, string resourceGroupName, bool? running, string continuationToken, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
