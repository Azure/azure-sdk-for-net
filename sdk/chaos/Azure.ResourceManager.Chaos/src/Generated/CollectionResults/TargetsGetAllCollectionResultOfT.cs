    ...
    internal partial class TargetsGetAllCollectionResultOfT : Pageable<ChaosTargetData>
    {
        ...
        public override IEnumerable<Page<ChaosTargetData>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                yield return Page<ChaosTargetData>.FromValues((IReadOnlyList<ChaosTargetData>)result.Value, nextPage?.IsAbsoluteUri == true ? nextPage.AbsoluteUri : nextPage?.OriginalString, response);
