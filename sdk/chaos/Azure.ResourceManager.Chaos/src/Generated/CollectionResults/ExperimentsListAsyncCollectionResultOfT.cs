...
{
    internal partial class ExperimentsListAsyncCollectionResultOfT : AsyncPageable<ChaosExperimentData>
    {
        ...
        /// <summary> Initializes a new instance of ExperimentsListAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public ExperimentsListAsyncCollectionResultOfT(Experiments client, Guid subscriptionId, string resourceGroupName, bool? running, string continuationToken, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of ExperimentsListAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of ExperimentsListAsyncCollectionResultOfT as an enumerable collection. </returns>
