...
{
    internal partial class ExperimentsGetExperimentsCollectionResultOfT : Pageable<ChaosExperimentData>
    {
        ...
        /// <summary> Initializes a new instance of ExperimentsGetExperimentsCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public ExperimentsGetExperimentsCollectionResultOfT(Experiments client, Guid subscriptionId, bool? running, string continuationToken, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of ExperimentsGetExperimentsCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of ExperimentsGetExperimentsCollectionResultOfT as an enumerable collection. </returns>
