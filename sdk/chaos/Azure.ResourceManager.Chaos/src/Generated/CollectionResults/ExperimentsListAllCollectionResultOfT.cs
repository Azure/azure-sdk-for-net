...
{
    internal partial class ExperimentsListAllCollectionResultOfT : Pageable<ChaosExperimentData>
    {
        ...
        /// <summary> Initializes a new instance of ExperimentsListAllCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public ExperimentsListAllCollectionResultOfT(Experiments client, Guid subscriptionId, bool? running, string continuationToken, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of ExperimentsListAllCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of ExperimentsListAllCollectionResultOfT as an enumerable collection. </returns>
