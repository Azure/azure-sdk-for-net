...
namespace Azure.ResourceManager.Chaos
{
    internal partial class PrivateAccessesGetPrivateAccessesAsyncCollectionResultOfT : AsyncPageable<ChaosPrivateAccessData>
    {
        ...
        public PrivateAccessesGetPrivateAccessesAsyncCollectionResultOfT(PrivateAccesses client, Guid subscriptionId, string continuationToken, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
