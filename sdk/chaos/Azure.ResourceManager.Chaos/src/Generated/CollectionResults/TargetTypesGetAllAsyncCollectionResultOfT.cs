...
namespace Azure.ResourceManager.Chaos
{
    internal partial class TargetTypesGetAllAsyncCollectionResultOfT : AsyncPageable<ChaosTargetMetadataData>
    {
        ...
        public TargetTypesGetAllAsyncCollectionResultOfT(TargetTypes client, Guid subscriptionId, AzureLocation location, string continuationToken, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        public override async IAsyncEnumerable<Page<ChaosTargetMetadataData>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                yield return Page<ChaosTargetMetadataData>.FromValues((IReadOnlyList<ChaosTargetMetadataData>)result.Value, nextPage?.IsAbsoluteUri == true ? nextPage.AbsoluteUri : nextPage?.OriginalString, response);
