...
{
    internal partial class PrivateAccessesGetAllAsyncCollectionResultOfT : AsyncPageable<ChaosPrivateAccessData>
    {
        ...
        public PrivateAccessesGetAllAsyncCollectionResultOfT(PrivateAccesses client, Guid subscriptionId, string resourceGroupName, string continuationToken, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
