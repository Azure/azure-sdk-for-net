...
namespace Azure.ResourceManager.Chaos
{
    ...
    public partial class TargetTypeCollection : ArmCollection, IEnumerable<TargetTypeResource>, IAsyncEnumerable<TargetTypeResource>
    {
        ...
        internal TargetTypeCollection(ArmClient client, ResourceIdentifier id, AzureLocation location) : base(client, id)
        {
            _location = location;
        ...
        public virtual async Task<Response<TargetTypeResource>> GetAsync(string targetTypeName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _targetTypeRestClient.GetAsync(Id.SubscriptionId, new AzureLocation(_location), targetTypeName, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<TargetTypeResource> Get(string targetTypeName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _targetTypeRestClient.Get(Id.SubscriptionId, new AzureLocation(_location), targetTypeName, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new TargetTypeResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _targetTypeRestClient.CreateListRequest(Id.SubscriptionId, new AzureLocation(_location), continuationToken);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _targetTypeRestClient.CreateListNextPageRequest(nextLink, Id.SubscriptionId, new AzureLocation(_location), continuationToken);
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string targetTypeName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _targetTypeRestClient.GetAsync(Id.SubscriptionId, new AzureLocation(_location), targetTypeName, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<bool> Exists(string targetTypeName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _targetTypeRestClient.Get(Id.SubscriptionId, new AzureLocation(_location), targetTypeName, cancellationToken: cancellationToken);
                return Response.FromValue(response.Value != null, response.GetRawResponse());
            }
            catch (Exception e)
            {
