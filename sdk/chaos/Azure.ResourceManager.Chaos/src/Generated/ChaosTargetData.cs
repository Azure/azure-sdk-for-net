...
namespace Azure.ResourceManager.Chaos
{
    ...
    public partial class ChaosTargetData : ResourceData
    {
        ...
        /// Serialized Name: Target.properties
        /// </param>
        internal ChaosTargetData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, AzureLocation? location, IDictionary<string, BinaryData> properties) : base(id, name, resourceType, systemData)
        {
            Location = location;
            Properties = properties;
        }
