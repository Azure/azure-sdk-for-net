...
namespace Azure.ResourceManager.Chaos.Mocking
{
    ...
    internal partial class ChaosResourceGroupMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="ChaosResourceGroupMockingExtension"/> class for mocking. </summary>
        protected ChaosResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ChaosResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ChaosResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
