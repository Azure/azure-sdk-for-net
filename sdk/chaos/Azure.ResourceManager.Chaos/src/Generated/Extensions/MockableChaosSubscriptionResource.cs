...
namespace Azure.ResourceManager.Chaos.Mocking
{
    ...
    public partial class MockableChaosSubscriptionResource : ArmResource
    {
        ...
        /// <item>
        /// <term>Operation Id</term>
        /// <description>Experiment_ListBySubscription</description>
        /// </item>
        /// <item>
        /// <term>Default Api Version</term>
        /// <description>2025-01-01</description>
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => ChaosExperimentExperimentsRestClient.CreateListBySubscriptionRequest(Id.SubscriptionId, running, continuationToken);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => ChaosExperimentExperimentsRestClient.CreateListBySubscriptionNextPageRequest(nextLink, Id.SubscriptionId, running, continuationToken);
