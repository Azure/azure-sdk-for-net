...
namespace Azure.ResourceManager.Chaos.Mocking
{
    ...
    public partial class MockableChaosArmClient : ArmResource
    {
        ...
        /// <summary>
        /// Gets an object representing a <see cref="ChaosTargetCapabilityResource"/> along with the instance operations that can be performed on it but with no data.
        /// You can use <see cref="ChaosTargetCapabilityResource.CreateResourceIdentifier" /> to create a <see cref="ChaosTargetCapabilityResource"/> <see cref="ResourceIdentifier"/> from its components.
        /// </summary>
        /// <param name="id"> The resource ID of the resource to get. </param>
        /// <returns> Returns a <see cref="ChaosTargetCapabilityResource"/> object. </returns>
        public virtual ChaosTargetCapabilityResource GetChaosTargetCapabilityResource(ResourceIdentifier id)
        {
            ChaosTargetCapabilityResource.ValidateResourceId(id);
            return new ChaosTargetCapabilityResource(Client, id);
        }
