...
using Azure.ResourceManager.Chaos.Testing;
...
namespace Azure.ResourceManager.Chaos
{
    ...
    public static partial class ChaosExtensions
    {
        ...
        {
            return GetChaosSubscriptionResourceExtension(subscriptionResource).GetExperimentsAsync(running, continuationToken, cancellationToken);
        }
        ...
        {
            return GetChaosSubscriptionResourceExtension(subscriptionResource).GetExperiments(running, continuationToken, cancellationToken);
        }
    }
}
