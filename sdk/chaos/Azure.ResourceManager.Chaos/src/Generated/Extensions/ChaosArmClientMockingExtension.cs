...
namespace Azure.ResourceManager.Chaos.Mocking
{
    ...
    internal partial class ChaosArmClientMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="ChaosArmClientMockingExtension"/> class for mocking. </summary>
        protected ChaosArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ChaosArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ChaosArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal ChaosArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
