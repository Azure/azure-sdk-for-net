...
namespace Azure.ResourceManager.Chaos
{
    ...
    public partial class ChaosPrivateEndpointConnectionCollection : ArmCollection, IEnumerable<ChaosPrivateEndpointConnectionResource>, IAsyncEnumerable<ChaosPrivateEndpointConnectionResource>
    {
        ...
        {
            _chaosPrivateEndpointConnectionPrivateAccessesClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Chaos", ChaosPrivateEndpointConnectionResource.ResourceType.Namespace, Diagnostics);
            TryGetApiVersion(ChaosPrivateEndpointConnectionResource.ResourceType, out string chaosPrivateEndpointConnectionPrivateAccessesApiVersion);
        ...
        public virtual async Task<Response<ChaosPrivateEndpointConnectionResource>> GetAsync(string privateEndpointConnectionName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _chaosPrivateEndpointConnectionPrivateAccessesClientDiagnostics.CreateScope("ChaosPrivateEndpointConnectionCollection.Get");
            scope.Start();
            try
            {
                var response = await _chaosPrivateEndpointConnectionPrivateAccessesRestClient.GetAPrivateEndpointConnectionAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, privateEndpointConnectionName, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<ChaosPrivateEndpointConnectionResource> Get(string privateEndpointConnectionName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _chaosPrivateEndpointConnectionPrivateAccessesRestClient.GetAPrivateEndpointConnection(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, privateEndpointConnectionName, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new ChaosPrivateEndpointConnectionResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        /// <item>
        /// <term>Operation Id</term>
        /// <description>PrivateAccesses_ListPrivateEndpointConnections</description>
        /// </item>
        /// <item>
        /// <term>Default Api Version</term>
        /// <description>2026-02-01-preview</description>
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _chaosPrivateEndpointConnectionPrivateAccessesRestClient.CreateListPrivateEndpointConnectionsRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _chaosPrivateEndpointConnectionPrivateAccessesRestClient.CreateListPrivateEndpointConnectionsNextPageRequest(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Name);
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new ChaosPrivateEndpointConnectionResource(Client, ChaosPrivateEndpointConnectionData.DeserializeChaosPrivateEndpointConnectionData(e)), _chaosPrivateEndpointConnectionPrivateAccessesClientDiagnostics, Pipeline, "ChaosPrivateEndpointConnectionCollection.GetAll", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string privateEndpointConnectionName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _chaosPrivateEndpointConnectionPrivateAccessesClientDiagnostics.CreateScope("ChaosPrivateEndpointConnectionCollection.Exists");
            scope.Start();
            try
            {
                var response = await _chaosPrivateEndpointConnectionPrivateAccessesRestClient.GetAPrivateEndpointConnectionAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, privateEndpointConnectionName, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<bool> Exists(string privateEndpointConnectionName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _chaosPrivateEndpointConnectionPrivateAccessesRestClient.GetAPrivateEndpointConnection(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, privateEndpointConnectionName, cancellationToken: cancellationToken);
                return Response.FromValue(response.Value != null, response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        public virtual async Task<NullableResponse<ChaosPrivateEndpointConnectionResource>> GetIfExistsAsync(string privateEndpointConnectionName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _chaosPrivateEndpointConnectionPrivateAccessesClientDiagnostics.CreateScope("ChaosPrivateEndpointConnectionCollection.GetIfExists");
            scope.Start();
            try
            {
                var response = await _chaosPrivateEndpointConnectionPrivateAccessesRestClient.GetAPrivateEndpointConnectionAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, privateEndpointConnectionName, cancellationToken: cancellationToken).ConfigureAwait(false);
