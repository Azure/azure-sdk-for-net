...
namespace Azure.ResourceManager.Chaos
{
    ...
    /// Each <see cref="ChaosPrivateEndpointConnectionResource"/> in the collection will belong to the same instance of <see cref="ChaosPrivateAccessResource"/>.
    /// To get a <see cref="ChaosPrivateEndpointConnectionCollection"/> instance call the GetChaosPrivateEndpointConnections method from an instance of <see cref="ChaosPrivateAccessResource"/>.
    /// </summary>
    public partial class ChaosPrivateEndpointConnectionCollection : ArmCollection, IEnumerable<ChaosPrivateEndpointConnectionResource>, IAsyncEnumerable<ChaosPrivateEndpointConnectionResource>
    {
        ...
        /// <summary> Initializes a new instance of ChaosPrivateEndpointConnectionCollection for mocking. </summary>
        protected ChaosPrivateEndpointConnectionCollection()
        {
        }

        /// <summary> Initializes a new instance of <see cref="ChaosPrivateEndpointConnectionCollection"/> class. </summary>
        ...
        {
            TryGetApiVersion(ChaosPrivateEndpointConnectionResource.ResourceType, out string chaosPrivateEndpointConnectionApiVersion);
            _privateEndpointConnectionsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Chaos", ChaosPrivateEndpointConnectionResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<Response<ChaosPrivateEndpointConnectionResource>> GetAsync(string privateEndpointConnectionName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _privateEndpointConnectionsClientDiagnostics.CreateScope("ChaosPrivateEndpointConnectionCollection.Get");
            scope.Start();
            try
            {
        ...
        public virtual AsyncPageable<ChaosPrivateEndpointConnectionResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<ChaosPrivateEndpointConnectionData, ChaosPrivateEndpointConnectionResource>(new PrivateEndpointConnectionsGetPrivateEndpointConnectionsAsyncCollectionResultOfT(
                _privateEndpointConnectionsRestClient,
                Guid.Parse(Id.SubscriptionId),
                Id.ResourceGroupName,
                Id.Name,
                context,
                "ChaosPrivateEndpointConnectionCollection.GetAll"), data => new ChaosPrivateEndpointConnectionResource(Client, data));
        }
        ...
        public virtual Pageable<ChaosPrivateEndpointConnectionResource> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            return new PageableWrapper<ChaosPrivateEndpointConnectionData, ChaosPrivateEndpointConnectionResource>(new PrivateEndpointConnectionsGetPrivateEndpointConnectionsCollectionResultOfT(
                _privateEndpointConnectionsRestClient,
                Guid.Parse(Id.SubscriptionId),
                Id.ResourceGroupName,
                Id.Name,
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string privateEndpointConnectionName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _privateEndpointConnectionsClientDiagnostics.CreateScope("ChaosPrivateEndpointConnectionCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual async Task<NullableResponse<ChaosPrivateEndpointConnectionResource>> GetIfExistsAsync(string privateEndpointConnectionName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _privateEndpointConnectionsClientDiagnostics.CreateScope("ChaosPrivateEndpointConnectionCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
