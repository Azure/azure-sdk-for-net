...
namespace Azure.ResourceManager.Chaos
{
    ...
    public partial class ChaosExperimentData : TrackedResourceData, IJsonModel<ChaosExperimentData>
    {
        ...
        internal static RequestContent ToRequestContent(ChaosExperimentData chaosExperimentData)
        {
            ...
            return RequestContent.Create(chaosExperimentData, ModelSerializationExtensions.WireOptions);
        }
        ...
        internal static ChaosExperimentData FromResponse(Response response)
        {
            ...
            return DeserializeChaosExperimentData(document.RootElement, ModelSerializationExtensions.WireOptions);
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ChaosExperimentData IJsonModel<ChaosExperimentData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (ChaosExperimentData)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static ChaosExperimentData DeserializeChaosExperimentData(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("identity"u8))
                {
                    ...
                    identity = ModelReaderWriter.Read<ManagedServiceIdentity>(new BinaryData(Encoding.UTF8.GetBytes(prop.Value.GetRawText())), options.Format == "W" ? ModelSerializationExtensions.WireV3Options : ModelSerializationExtensions.JsonV3Options, AzureResourceManagerChaosContext.Default);
                    continue;
                }
