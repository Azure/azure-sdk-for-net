...
namespace Azure.ResourceManager.Chaos
{
    ...
    public partial class ChaosCapabilityMetadataData : IJsonModel<ChaosCapabilityMetadataData>
    {
        ...
        /// <param name="result"> The <see cref="Response"/> to deserialize the <see cref="ChaosCapabilityMetadataData"/> from. </param>
        internal static ChaosCapabilityMetadataData FromResponse(Response result)
        {
