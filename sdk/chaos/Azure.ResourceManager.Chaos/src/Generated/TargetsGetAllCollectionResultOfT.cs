...
{
    internal partial class TargetsGetAllCollectionResultOfT : Pageable<ChaosTargetData>
    {
        ...
        /// <returns> The pages of TargetsGetAllCollectionResultOfT as an enumerable collection. </returns>
        public override IEnumerable<Page<ChaosTargetData>> AsPages(string continuationToken, int? pageSizeHint)
        {
        ...
        private Response GetNextResponse(int? pageSizeHint, Uri nextLink)
        {
            ...
            using DiagnosticScope scope = _client.ClientDiagnostics.CreateScope("Targets.GetAll");
            scope.Start();
            try
            {
