...
{
    internal partial class TargetTypesGetCollectionResult : Pageable<BinaryData>
    {
        ...
        /// <summary> Initializes a new instance of TargetTypesGetCollectionResult, which is used to iterate over the pages of a collection. </summary>
        ...
        public TargetTypesGetCollectionResult(TargetTypes client, Guid subscriptionId, AzureLocation location, string continuationToken, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of TargetTypesGetCollectionResult as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of TargetTypesGetCollectionResult as an enumerable collection. </returns>
