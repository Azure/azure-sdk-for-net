...
namespace Azure.ResourceManager.Chaos
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TargetTypeData>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<TargetTypeData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(TargetTypeData)} does not support writing '{format}' format.");
            }
        ...
        TargetTypeData IJsonModel<TargetTypeData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(TargetTypeData)} does not support reading '{format}' format.");
            }
        ...
        internal static TargetTypeData DeserializeTargetTypeData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    properties = TargetTypeProperties.DeserializeTargetTypeProperties(property.Value, options);
                    continue;
                }
        ...
        BinaryData IPersistableModel<TargetTypeData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(TargetTypeData)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        TargetTypeData IPersistableModel<TargetTypeData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(TargetTypeData)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<TargetTypeData>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
