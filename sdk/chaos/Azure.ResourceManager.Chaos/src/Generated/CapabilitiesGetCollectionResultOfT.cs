...
{
    internal partial class CapabilitiesGetCollectionResultOfT : Pageable<ChaosCapabilityData>
    {
        ...
        /// <summary> Initializes a new instance of CapabilitiesGetCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public CapabilitiesGetCollectionResultOfT(Capabilities client, Guid subscriptionId, string resourceGroupName, string parentProviderNamespace, string parentResourceType, string parentResourceName, string targetName, string continuationToken, RequestContext context) : base(context?.CancellationToken ?? default)
        {
        ...
        /// <summary> Gets the pages of CapabilitiesGetCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of CapabilitiesGetCollectionResultOfT as an enumerable collection. </returns>
