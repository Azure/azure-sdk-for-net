...
{
    internal partial class CapabilityTypesGetAllCollectionResult : Pageable<BinaryData>
    {
        ...
        /// <summary> Initializes a new instance of CapabilityTypesGetAllCollectionResult, which is used to iterate over the pages of a collection. </summary>
        ...
        public CapabilityTypesGetAllCollectionResult(CapabilityTypes client, Guid subscriptionId, AzureLocation location, string targetTypeName, string continuationToken, RequestContext context) : base(context?.CancellationToken ?? default)
        {
        ...
        /// <summary> Gets the pages of CapabilityTypesGetAllCollectionResult as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of CapabilityTypesGetAllCollectionResult as an enumerable collection. </returns>
