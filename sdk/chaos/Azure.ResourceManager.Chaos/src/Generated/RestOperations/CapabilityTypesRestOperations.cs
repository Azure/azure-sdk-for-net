...
{
    internal partial class CapabilityTypes
    {
        private readonly Uri _endpoint;
        private readonly string _apiVersion;
        private readonly TelemetryDetails _userAgent;

        /// <summary> Initializes a new instance of CapabilityTypes for mocking. </summary>
        protected CapabilityTypes()
        {
        }

        /// <summary> Initializes a new instance of CapabilityTypes. </summary>
        /// <param name="clientDiagnostics"> The ClientDiagnostics is used to provide tracing support for the client library. </param>
        /// <param name="pipeline"> The HTTP pipeline for sending and receiving REST requests and responses. </param>
        /// <param name="applicationId"> The application id to use for user agent. </param>
        /// <param name="endpoint"> Service endpoint. </param>
        /// <param name="apiVersion"></param>
        internal CapabilityTypes(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string applicationId, Uri endpoint, string apiVersion)
        {
            ClientDiagnostics = clientDiagnostics;
            _endpoint = endpoint;
            Pipeline = pipeline;
            _apiVersion = apiVersion;
            _userAgent = new TelemetryDetails(typeof(CapabilityTypes).Assembly, applicationId);
        }
        ...
        internal HttpMessage CreateGetRequest(Guid subscriptionId, AzureLocation location, string targetTypeName, string capabilityTypeName, RequestContext context)
        {
