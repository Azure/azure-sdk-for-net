...
namespace Azure.ResourceManager.Chaos
{
    internal partial class Workspaces
    {
        ...
        internal HttpMessage CreateGetWorkspacesRequest(Guid subscriptionId, string continuationToken, RequestContext context)
        {
            RawRequestUriBuilder uri = new RawRequestUriBuilder();
            uri.Reset(_endpoint);
            uri.AppendPath("/subscriptions/", false);
        ...
        internal HttpMessage CreateNextGetWorkspacesRequest(Uri nextPage, Guid subscriptionId, string continuationToken, RequestContext context)
        {
            RawRequestUriBuilder uri = new RawRequestUriBuilder();
            if (nextPage.IsAbsoluteUri)
            {
