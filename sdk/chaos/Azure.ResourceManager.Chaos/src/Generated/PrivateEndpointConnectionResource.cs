...
namespace Azure.ResourceManager.Chaos
{
    ...
    /// Otherwise you can get one from its parent resource <see cref="ChaosPrivateAccessResource"/> using the GetPrivateEndpointConnections method.
    /// </summary>
    public partial class PrivateEndpointConnectionResource : ArmResource
    {
        ...
        internal PrivateEndpointConnectionResource(ArmClient client, ChaosPrivateEndpointConnectionData data) : this(client, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal PrivateEndpointConnectionResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _privateEndpointConnectionsRestClient = new PrivateEndpointConnections(_privateEndpointConnectionsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, privateEndpointConnectionApiVersion ?? "2026-08-01-preview");
