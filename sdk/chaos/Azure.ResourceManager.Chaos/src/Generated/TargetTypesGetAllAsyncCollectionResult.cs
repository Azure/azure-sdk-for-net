...
{
    internal partial class TargetTypesGetAllAsyncCollectionResult : AsyncPageable<BinaryData>
    {
        ...
        /// <summary> Initializes a new instance of TargetTypesGetAllAsyncCollectionResult, which is used to iterate over the pages of a collection. </summary>
        ...
        public TargetTypesGetAllAsyncCollectionResult(TargetTypes client, Guid subscriptionId, AzureLocation location, string continuationToken, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of TargetTypesGetAllAsyncCollectionResult as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of TargetTypesGetAllAsyncCollectionResult as an enumerable collection. </returns>
