...
namespace Azure.ResourceManager.Chaos
{
    internal partial class ExperimentsGetAllCollectionResultOfT : Pageable<ChaosExperimentData>
    {
        ...
        public ExperimentsGetAllCollectionResultOfT(Experiments client, Guid subscriptionId, bool? running, string continuationToken, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        public override IEnumerable<Page<ChaosExperimentData>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            do
            {
                ...
                yield return Page<ChaosExperimentData>.FromValues((IReadOnlyList<ChaosExperimentData>)responseWithType.Value, nextPage?.AbsoluteUri, response);
            }
            while (nextPage != null);
        }
        ...
        private Response GetNextResponse(int? pageSizeHint, Uri nextLink)
        {
            ...
            using DiagnosticScope scope = _client.ClientDiagnostics.CreateScope("Experiments.GetAll");
            scope.Start();
            try
            {
