...
namespace Azure.ResourceManager.Chaos.Models
{
    ...
    public static partial class ArmChaosModelFactory
    {
        ...
        {
            return new CapabilityData(id, name, resourceType, systemData, publisher, targetType, description, parametersSchema, urn, new Dictionary<string, BinaryData>());
        }
        ...
        public static ExperimentData ExperimentData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, ManagedServiceIdentity identity = null, IEnumerable<Step> steps = null, IEnumerable<Selector> selectors = null, bool? startOnCreation = null)
        {
            ...
            return new ExperimentData(id, name, resourceType, systemData, tags, location, identity, steps?.ToList(), selectors?.ToList(), startOnCreation, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ExperimentCancelOperationResult(name, statusUri, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ExperimentStartOperationResult(name, statusUri, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ExperimentStatusData(id, name, resourceType, systemData, status, createdDateUtc, endDateUtc, new Dictionary<string, BinaryData>());
        }
        ...
        public static StepStatus StepStatus(string stepName = null, string stepId = null, string status = null, IEnumerable<BranchStatus> branches = null)
        {
            ...
            return new StepStatus(stepName, stepId, status, branches?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static BranchStatus BranchStatus(string branchName = null, string branchId = null, string status = null, IEnumerable<ActionStatus> actions = null)
        {
            ...
            return new BranchStatus(branchName, branchId, status, actions?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static ActionStatus ActionStatus(string actionName = null, string actionId = null, string status = null, DateTimeOffset? startOn = null, DateTimeOffset? endOn = null, IEnumerable<ExperimentExecutionActionTargetDetailsProperties> targets = null)
        {
            ...
            return new ActionStatus(actionName, actionId, status, startOn, endOn, targets?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ExperimentExecutionActionTargetDetailsProperties(status, target, targetFailedOn, targetCompletedOn, error, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ExperimentExecutionActionTargetDetailsError(code, message, new Dictionary<string, BinaryData>());
        }
        ...
        public static TargetTypeData TargetTypeData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, AzureLocation? location = null, string displayName = null, string description = null, string propertiesSchema = null, IEnumerable<string> resourceTypes = null)
        {
            ...
            return new TargetTypeData(id, name, resourceType, systemData, location, displayName, description, propertiesSchema, resourceTypes?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static TargetData TargetData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, AzureLocation? location = null, IDictionary<string, BinaryData> properties = null)
        {
            ...
            return new TargetData(id, name, resourceType, systemData, location, properties, new Dictionary<string, BinaryData>());
        }
    }
}
