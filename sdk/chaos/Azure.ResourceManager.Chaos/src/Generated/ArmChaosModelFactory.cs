...
namespace Azure.ResourceManager.Chaos.Models
{
    ...
    public static partial class ArmChaosModelFactory
    {
        ...
        public static ExperimentExecutionDetails ExperimentExecutionDetails(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string failureReason = null, DateTimeOffset? lastActionOn = null, IEnumerable<ChaosExperimentRunStepStatus> runInformationSteps = null)
        {
        ...
        public static ChaosExperimentData ChaosExperimentData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, ChaosProvisioningState? provisioningState = null, IEnumerable<ChaosExperimentStep> steps = null, IEnumerable<ChaosTargetSelector> selectors = null, ManagedServiceIdentity identity = null)
        {
        ...
        /// <summary> Initializes a new instance of <see cref="Models.PostActionResult"/>. </summary>
        /// <param name="name"> The name of the resource. </param>
        /// <param name="statusUri"> The statusUrl of the post action. </param>
        /// <returns> A new <see cref="Models.PostActionResult"/> instance for mocking. </returns>
        public static PostActionResult PostActionResult(string name = null, string statusUri = null)
        {
            return new PostActionResult(name, statusUri, serializedAdditionalRawData: null);
        }
        ...
        public static ChaosTargetData ChaosTargetData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, AzureLocation? location = null)
        {
