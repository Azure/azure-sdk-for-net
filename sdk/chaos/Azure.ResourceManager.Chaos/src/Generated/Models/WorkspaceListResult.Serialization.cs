...
namespace Azure.ResourceManager.Chaos.Models
{
    ...
    internal partial class WorkspaceListResult : IJsonModel<WorkspaceListResult>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            foreach (ChaosWorkspaceData item in Value)
            {
        ...
        internal static WorkspaceListResult DeserializeWorkspaceListResult(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            IList<ChaosWorkspaceData> value = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    List<ChaosWorkspaceData> array = new List<ChaosWorkspaceData>();
                    foreach (var item in prop.Value.EnumerateArray())
                    {
                        array.Add(ChaosWorkspaceData.DeserializeChaosWorkspaceData(item, options));
                    }
                    value = array;
                    continue;
                }
