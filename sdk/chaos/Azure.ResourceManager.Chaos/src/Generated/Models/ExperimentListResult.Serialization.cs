...
namespace Azure.ResourceManager.Chaos.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ExperimentListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ExperimentListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ExperimentListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ExperimentListResult>)} interface");
            }
        ...
        string IPersistableModel<ExperimentListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
