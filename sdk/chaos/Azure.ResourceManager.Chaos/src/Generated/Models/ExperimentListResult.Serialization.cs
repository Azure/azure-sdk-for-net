...
{
    internal partial class ExperimentListResult : IUtf8JsonSerializable, IJsonModel<ExperimentListResult>, IPersistableModel<ExperimentListResult>
    {
        ...
        internal static ExperimentListResult DeserializeExperimentListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("value"u8))
                {
                    ...
                    {
                        array.Add(ChaosExperimentData.DeserializeChaosExperimentData(item));
                    }
                    value = array;
                    continue;
                }
