...
{
    public partial class ExperimentExecutionDetails : IUtf8JsonSerializable, IJsonModel<ExperimentExecutionDetails>, IPersistableModel<ExperimentExecutionDetails>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  lastActionAt:");
                builder.AppendLine($" '{LastActionOn.Value.ToString()}'");
            }

            if (Optional.IsDefined(RunInformation))
            {
                builder.Append("  runInformation:");
                AppendChildObject(builder, RunInformation, options, 2);
            }
