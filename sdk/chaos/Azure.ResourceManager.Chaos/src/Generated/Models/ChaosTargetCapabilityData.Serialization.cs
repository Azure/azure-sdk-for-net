...
{
    public partial class ChaosTargetCapabilityData : IUtf8JsonSerializable
    {
        ...
        internal static ChaosTargetCapabilityData DeserializeChaosTargetCapabilityData(JsonElement element)
        {
            ...
            return new ChaosTargetCapabilityData(id, name, type, systemData.Value, publisher.Value, targetType.Value, description.Value, parametersSchema.Value, urn.Value);
        }
    }
}
