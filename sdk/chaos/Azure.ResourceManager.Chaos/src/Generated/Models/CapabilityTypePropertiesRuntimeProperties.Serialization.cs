...
namespace Azure.ResourceManager.Chaos.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CapabilityTypePropertiesRuntimeProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CapabilityTypePropertiesRuntimeProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CapabilityTypePropertiesRuntimeProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<CapabilityTypePropertiesRuntimeProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
