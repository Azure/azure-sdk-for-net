...
{
    internal partial class UnknownChaosTargetSelector : ChaosTargetSelector, IJsonModel<ChaosTargetSelector>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownChaosTargetSelector DeserializeUnknownChaosTargetSelector(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownChaosTargetSelector(id, @type, filter, additionalBinaryDataProperties);
        }
