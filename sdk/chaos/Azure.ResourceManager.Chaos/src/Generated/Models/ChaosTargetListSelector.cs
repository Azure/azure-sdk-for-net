...
namespace Azure.ResourceManager.Chaos.Models
{
    ...
    public partial class ChaosTargetListSelector : ChaosTargetSelector
    {
        ...
        public ChaosTargetListSelector(string id, IEnumerable<ChaosTargetReference> targets) : base(id)
        {
            ...
            SelectorType = ChaosTargetSelectorType.List;
        }
        ...
        /// Serialized Name: ChaosTargetListSelector.targets
        /// </param>
        internal ChaosTargetListSelector(ChaosTargetSelectorType selectorType, string id, ChaosTargetFilter filter, IDictionary<string, BinaryData> additionalProperties, IList<ChaosTargetReference> targets) : base(selectorType, id, filter, additionalProperties)
        {
            Targets = targets;
