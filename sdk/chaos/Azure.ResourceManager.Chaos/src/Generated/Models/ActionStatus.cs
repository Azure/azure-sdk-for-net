...
namespace Azure.ResourceManager.Chaos.Models
{
    ...
    public partial class ActionStatus
    {
        ...
        internal ActionStatus(string actionName, string actionId, string status, DateTimeOffset? startOn, DateTimeOffset? endOn, IReadOnlyList<ExperimentExecutionActionTargetDetailsProperties> targets, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
