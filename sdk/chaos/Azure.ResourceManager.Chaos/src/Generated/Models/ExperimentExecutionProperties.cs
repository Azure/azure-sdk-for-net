...
namespace Azure.ResourceManager.Chaos.Models
{
    ...
    public partial class ExperimentExecutionProperties
    {
        ...
        internal ExperimentExecutionProperties(string status, DateTimeOffset? startedOn, DateTimeOffset? stoppedOn, ProvisioningState? provisioningState, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Status = status;
            StartedOn = startedOn;
            StoppedOn = stoppedOn;
