...
namespace Azure.ResourceManager.Chaos.Models
{
    ...
    public partial class ExperimentExecutionProperties
    {
        ...
        internal ExperimentExecutionProperties(string status, DateTimeOffset? startedAt, DateTimeOffset? stoppedAt, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Status = status;
            StartedAt = startedAt;
            StoppedAt = stoppedAt;
