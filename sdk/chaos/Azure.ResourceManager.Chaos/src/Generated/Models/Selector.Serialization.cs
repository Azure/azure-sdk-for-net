...
{
    public partial class Selector : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static Selector DeserializeSelector(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
