...
namespace Azure.ResourceManager.Chaos.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<Selector>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<Selector>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<Selector>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<Selector>)} interface");
            }
        ...
        string IPersistableModel<Selector>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
