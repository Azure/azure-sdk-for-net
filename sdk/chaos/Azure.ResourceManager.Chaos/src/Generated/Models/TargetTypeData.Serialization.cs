...
namespace Azure.ResourceManager.Chaos
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TargetTypeData>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<TargetTypeData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(TargetTypeData)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<TargetTypeData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(TargetTypeData)} does not support '{options.Format}' format.");
            }
        }
