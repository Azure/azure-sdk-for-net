...
{
    public partial class TargetTypeData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static TargetTypeData DeserializeTargetTypeData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
