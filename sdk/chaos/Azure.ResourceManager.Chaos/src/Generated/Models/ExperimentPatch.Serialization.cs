...
namespace Azure.ResourceManager.Chaos.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ExperimentPatch>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ExperimentPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(ExperimentPatch)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ExperimentPatch>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(ExperimentPatch)} does not support '{options.Format}' format.");
            }
        }
