...
namespace Azure.ResourceManager.Chaos.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ExperimentPatch>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<ExperimentPatch>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ExperimentPatch)} does not support writing '{format}' format.");
            }
        ...
        ExperimentPatch IJsonModel<ExperimentPatch>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ExperimentPatch)} does not support reading '{format}' format.");
            }
        ...
        internal static ExperimentPatch DeserializeExperimentPatch(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new ExperimentPatch(tags ?? new ChangeTrackingDictionary<string, string>(), identity, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<ExperimentPatch>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ExperimentPatch)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        ExperimentPatch IPersistableModel<ExperimentPatch>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ExperimentPatch)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<ExperimentPatch>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
