...
namespace Azure.ResourceManager.Chaos.Models
{
    ...
    /// </summary>
    public partial class ChaosScenarioConfigurationExclusions
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="ChaosScenarioConfigurationExclusions"/>. </summary>
        ...
        internal ChaosScenarioConfigurationExclusions(IList<ResourceIdentifier> resources, IList<ChaosKeyValuePair> tags, IList<string> types, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Resources = resources;
            Tags = tags;
            Types = types;
