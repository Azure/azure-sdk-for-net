...
namespace Azure.ResourceManager.Chaos.Models
{
    ...
    /// Serialized Name: ChaosTargetQuerySelector
    /// </summary>
    public partial class ChaosTargetQuerySelector : ChaosTargetSelector
    {
        ...
        /// Serialized Name: ChaosTargetQuerySelector.queryString
        /// </param>
        /// <param name="subscriptionIds">
        /// Subscription id list to scope resource query.
        /// Serialized Name: ChaosTargetQuerySelector.subscriptionIds
        /// </param>
        ...
        public ChaosTargetQuerySelector(string id, string queryString, IEnumerable<string> subscriptionIds) : base(id)
        {
            ...
            SelectorType = ChaosTargetSelectorType.Query;
        }
        ...
        /// Serialized Name: ChaosTargetQuerySelector.subscriptionIds
        /// </param>
        internal ChaosTargetQuerySelector(ChaosTargetSelectorType selectorType, string id, ChaosTargetFilter filter, IDictionary<string, BinaryData> additionalProperties, string queryString, IList<string> subscriptionIds) : base(selectorType, id, filter, additionalProperties)
        {
            QueryString = queryString;
