...
namespace Azure.ResourceManager.Chaos.Models
{
    ...
    public partial class StepStatus
    {
        ...
        internal StepStatus(string stepName, string stepId, string status, IReadOnlyList<BranchStatus> branches, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            StepName = stepName;
            StepId = stepId;
            Status = status;
