...
namespace Azure.ResourceManager.Chaos.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ExperimentExecutionActionTargetDetailsError>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ExperimentExecutionActionTargetDetailsError>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ExperimentExecutionActionTargetDetailsError>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ExperimentExecutionActionTargetDetailsError>)} interface");
            }
        ...
        string IPersistableModel<ExperimentExecutionActionTargetDetailsError>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
