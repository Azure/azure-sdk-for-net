...
{
    public partial class ChaosContinuousAction : IUtf8JsonSerializable, IJsonModel<ChaosContinuousAction>, IPersistableModel<ChaosContinuousAction>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SelectorId))
            {
                builder.Append("  selectorId:");
                builder.AppendLine($" '{SelectorId}'");
            }
