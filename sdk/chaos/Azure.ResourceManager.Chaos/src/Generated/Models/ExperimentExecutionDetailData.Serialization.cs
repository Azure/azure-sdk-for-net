...
namespace Azure.ResourceManager.Chaos
{
    ...
    {
        internal static ExperimentExecutionDetailData DeserializeExperimentExecutionDetailData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
