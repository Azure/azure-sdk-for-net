...
namespace Azure.ResourceManager.Chaos.Models
{
    ...
    public partial class ScenarioConfigurationProperties
    {
        ...
        public ScenarioConfigurationProperties(string scenarioId)
        {
            ...
            Parameters = new ChangeTrackingList<KeyValuePair>();
        }
        ...
        internal ScenarioConfigurationProperties(string scenarioId, IList<KeyValuePair> parameters, ConfigurationExclusions exclusions, ProvisioningState? provisioningState, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ScenarioId = scenarioId;
