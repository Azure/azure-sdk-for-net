...
namespace Azure.ResourceManager.Chaos.Models
{
    ...
    public partial class ChaosTargetSimpleFilter : ChaosTargetFilter, IJsonModel<ChaosTargetSimpleFilter>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ChaosTargetSimpleFilter IJsonModel<ChaosTargetSimpleFilter>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (ChaosTargetSimpleFilter)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static ChaosTargetSimpleFilter DeserializeChaosTargetSimpleFilter(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("parameters"u8))
                {
                    ...
                    parameters = ChaosTargetSimpleFilterParameters.DeserializeChaosTargetSimpleFilterParameters(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
