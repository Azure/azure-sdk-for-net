...
namespace Azure.ResourceManager.Chaos.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CapabilityTypeListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CapabilityTypeListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CapabilityTypeListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CapabilityTypeListResult>)} interface");
            }
        ...
        string IPersistableModel<CapabilityTypeListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
