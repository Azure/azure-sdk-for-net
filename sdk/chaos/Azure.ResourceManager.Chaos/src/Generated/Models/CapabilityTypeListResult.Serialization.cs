...
namespace Azure.ResourceManager.Chaos.Models
{
    ...
    {
        internal static CapabilityTypeListResult DeserializeCapabilityTypeListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
