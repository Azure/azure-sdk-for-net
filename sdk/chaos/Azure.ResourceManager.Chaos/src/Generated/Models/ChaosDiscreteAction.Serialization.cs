...
{
    public partial class ChaosDiscreteAction : IUtf8JsonSerializable, IJsonModel<ChaosDiscreteAction>, IPersistableModel<ChaosDiscreteAction>
    {
        ...
        void IJsonModel<ChaosDiscreteAction>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ChaosDiscreteAction)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ChaosDiscreteAction>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ChaosDiscreteAction)} does not support '{options.Format}' format.");
            }
        }
