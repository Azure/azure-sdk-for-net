...
namespace Azure.ResourceManager.Chaos.Models
{
    ...
    internal partial class UnknownChaosTargetSelector : ChaosTargetSelector
    {
        ...
        internal UnknownChaosTargetSelector(string id, SelectorType type, ChaosTargetFilter filter, IDictionary<string, BinaryData> additionalProperties) : base(id, type, filter, additionalProperties)
        {
            Type = type;
        }
