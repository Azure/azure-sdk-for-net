...
namespace Azure.ResourceManager.Chaos.Models
{
    ...
    public partial class ContinuousAction : ChaosExperimentAction
    {
        ...
        public ContinuousAction(string name, TimeSpan duration, IEnumerable<ChaosKeyValuePair> parameters, string selectorId) : base(name)
        {
        ...
        /// <param name="parameters"> List of key value pairs. </param>
        /// <param name="selectorId"> String that represents a selector. </param>
        internal ContinuousAction(string name, ExperimentActionType type, IDictionary<string, BinaryData> serializedAdditionalRawData, TimeSpan duration, IList<ChaosKeyValuePair> parameters, string selectorId) : base(name, type, serializedAdditionalRawData)
        {
            Duration = duration;
