...
namespace Azure.ResourceManager.Chaos.Models
{
    ...
    public partial class ContinuousAction : Action
    {
        ...
        internal ContinuousAction(string actionType, string name, TimeSpan duration, IList<KeyValuePair> parameters, string selectorId, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(actionType, name, serializedAdditionalRawData)
        {
            Duration = duration;
