...
namespace Azure.ResourceManager.Chaos.Models
{
    ...
    public partial class ContinuousAction : ChaosExperimentAction
    {
        ...
        /// <param name="parameters"> List of key value pairs. </param>
        /// <param name="selectorId"> String that represents a selector. </param>
        internal ContinuousAction(string name, ExperimentActionType type, IDictionary<string, BinaryData> serializedAdditionalRawData, TimeSpan duration, IList<KeyValuePair> parameters, string selectorId) : base(name, type, serializedAdditionalRawData)
        {
            Duration = duration;
