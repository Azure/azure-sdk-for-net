...
{
    public partial class ChaosExperimentExecutionData : IUtf8JsonSerializable, IJsonModel<ChaosExperimentExecutionData>, IPersistableModel<ChaosExperimentExecutionData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  stoppedAt:");
                builder.AppendLine($" '{StoppedOn.Value.ToString()}'");
            }
