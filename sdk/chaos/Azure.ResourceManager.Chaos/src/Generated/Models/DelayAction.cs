...
namespace Azure.ResourceManager.Chaos.Models
{
    ...
    public partial class DelayAction : Action
    {
        ...
        internal DelayAction(string actionType, string name, TimeSpan duration, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(actionType, name, serializedAdditionalRawData)
        {
            Duration = duration;
