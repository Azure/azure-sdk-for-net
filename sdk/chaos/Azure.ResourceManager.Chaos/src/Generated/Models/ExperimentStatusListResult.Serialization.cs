...
namespace Azure.ResourceManager.Chaos.Models
{
    ...
    {
        internal static ExperimentStatusListResult DeserializeExperimentStatusListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
