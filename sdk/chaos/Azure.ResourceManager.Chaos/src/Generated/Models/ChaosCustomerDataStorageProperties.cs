...
namespace Azure.ResourceManager.Chaos.Models
{
    ...
    public partial class ChaosCustomerDataStorageProperties
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="ChaosCustomerDataStorageProperties"/>. </summary>
        ...
        internal ChaosCustomerDataStorageProperties(ResourceIdentifier storageAccountResourceId, string blobContainerName, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
