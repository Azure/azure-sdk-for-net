...
namespace Azure.ResourceManager.Chaos.Models
{
    ...
    public partial class Selector
    {
        ...
        internal Selector(SelectorType selectorType, string id, IList<TargetReference> targets, Filter filter, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            SelectorType = selectorType;
            Id = id;
            Targets = targets;
