...
{
    public partial class ChaosExperimentData : IUtf8JsonSerializable
    {
        ...
        internal static ChaosExperimentData DeserializeChaosExperimentData(JsonElement element)
        {
            ...
            Optional<ExperimentProvisioningState> provisioningState = default;
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        if (property0.NameEquals("provisioningState"u8))
                        {
                            ...
                            provisioningState = new ExperimentProvisioningState(property0.Value.GetString());
                            continue;
                        }
            ...
            return new ChaosExperimentData(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, identity, Optional.ToNullable(provisioningState), steps, selectors);
        }
    }
}
