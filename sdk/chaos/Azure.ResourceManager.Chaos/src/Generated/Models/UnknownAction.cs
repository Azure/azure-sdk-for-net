...
namespace Azure.ResourceManager.Chaos.Models
{
    ...
    internal partial class UnknownAction : Action
    {
        ...
        internal UnknownAction(string actionType, string name, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(actionType, name, serializedAdditionalRawData)
        {
