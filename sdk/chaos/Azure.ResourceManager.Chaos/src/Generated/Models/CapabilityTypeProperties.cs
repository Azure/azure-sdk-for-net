...
namespace Azure.ResourceManager.Chaos.Models
{
    ...
    public partial class CapabilityTypeProperties
    {
        ...
        internal CapabilityTypeProperties(string publisher, string targetType, string displayName, string description, string parametersSchema, string urn, string kind, IReadOnlyList<string> azureRbacActions, IReadOnlyList<string> azureRbacDataActions, IReadOnlyList<string> requiredAzureRoleDefinitionIds, CapabilityTypePropertiesRuntimeProperties runtimeProperties, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Publisher = publisher;
