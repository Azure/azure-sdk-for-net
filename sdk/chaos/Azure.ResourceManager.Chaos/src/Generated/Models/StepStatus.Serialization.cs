...
namespace Azure.ResourceManager.Chaos.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StepStatus>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(StepStatus)} does not support writing '{format}' format.");
            }
        ...
        StepStatus IJsonModel<StepStatus>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(StepStatus)} does not support reading '{format}' format.");
            }
        ...
        internal static StepStatus DeserializeStepStatus(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            IReadOnlyList<BranchStatus> branches = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("branches"u8))
                {
                    ...
                    {
                        array.Add(BranchStatus.DeserializeBranchStatus(item, options));
                    }
                    branches = array;
                    continue;
                }
            ...
            return new StepStatus(stepName, stepId, status, branches ?? new ChangeTrackingList<BranchStatus>(), serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<StepStatus>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(StepStatus)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        StepStatus IPersistableModel<StepStatus>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(StepStatus)} does not support reading '{options.Format}' format.");
            }
        }
