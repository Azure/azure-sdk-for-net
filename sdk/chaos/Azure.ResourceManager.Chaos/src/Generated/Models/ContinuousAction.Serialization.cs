...
namespace Azure.ResourceManager.Chaos.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContinuousAction>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ContinuousAction>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ContinuousAction>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ContinuousAction>)} interface");
            }
        ...
        string IPersistableModel<ContinuousAction>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
