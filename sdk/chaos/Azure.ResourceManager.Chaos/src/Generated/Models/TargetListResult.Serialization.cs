...
{
    internal partial class TargetListResult : IUtf8JsonSerializable, IJsonModel<TargetListResult>, IPersistableModel<TargetListResult>
    {
        ...
        internal static TargetListResult DeserializeTargetListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            Optional<IReadOnlyList<ChaosTargetData>> value = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("value"u8))
                {
                    ...
                    {
                        array.Add(ChaosTargetData.DeserializeChaosTargetData(item));
                    }
                    value = array;
                    continue;
                }
