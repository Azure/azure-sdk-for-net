...
namespace Azure.ResourceManager.Chaos
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CapabilityTypeData>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<CapabilityTypeData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CapabilityTypeData>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
