...
namespace Azure.ResourceManager.Chaos.Models
{
    ...
    /// </summary>
    public partial class ChaosScenarioConfigurationFilters
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="ChaosScenarioConfigurationFilters"/>. </summary>
        ...
        internal ChaosScenarioConfigurationFilters(IList<string> locations, IList<string> zones, IList<string> physicalZones, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Locations = locations;
            Zones = zones;
