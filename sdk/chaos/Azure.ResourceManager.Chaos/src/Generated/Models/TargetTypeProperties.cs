...
namespace Azure.ResourceManager.Chaos.Models
{
    ...
    public partial class TargetTypeProperties
    {
        ...
        internal TargetTypeProperties(string displayName, string description, string propertiesSchema, IReadOnlyList<string> resourceTypes, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
