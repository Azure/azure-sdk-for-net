...
namespace Azure.ResourceManager.Chaos.Models
{
    ...
    public partial class ChaosDiscreteAction : ChaosExperimentAction
    {
        ...
        public ChaosDiscreteAction(string name, IEnumerable<ChaosKeyValuePair> parameters, string selectorId) : base(name)
        {
            ...
            ExperimentActionType = ExperimentActionType.Discrete;
        }
        ...
        /// <param name="parameters"> List of key value pairs. </param>
        /// <param name="selectorId"> String that represents a selector. </param>
        internal ChaosDiscreteAction(string name, ExperimentActionType experimentActionType, IDictionary<string, BinaryData> serializedAdditionalRawData, IList<ChaosKeyValuePair> parameters, string selectorId) : base(name, experimentActionType, serializedAdditionalRawData)
        {
