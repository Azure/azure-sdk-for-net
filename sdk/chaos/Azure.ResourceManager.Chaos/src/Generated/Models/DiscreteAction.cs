...
namespace Azure.ResourceManager.Chaos.Models
{
    ...
    public partial class DiscreteAction : Action
    {
        ...
        internal DiscreteAction(string actionType, string name, IList<KeyValuePair> parameters, string selectorId, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(actionType, name, serializedAdditionalRawData)
        {
