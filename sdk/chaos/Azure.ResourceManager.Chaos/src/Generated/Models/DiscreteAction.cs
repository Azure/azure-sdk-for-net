...
namespace Azure.ResourceManager.Chaos.Models
{
    ...
    public partial class DiscreteAction : ChaosExperimentAction
    {
        ...
        public DiscreteAction(string name, IEnumerable<ChaosKeyValuePair> parameters, string selectorId) : base(name)
        {
        ...
        /// <param name="parameters"> List of key value pairs. </param>
        /// <param name="selectorId"> String that represents a selector. </param>
        internal DiscreteAction(string name, ExperimentActionType type, IDictionary<string, BinaryData> serializedAdditionalRawData, IList<ChaosKeyValuePair> parameters, string selectorId) : base(name, type, serializedAdditionalRawData)
        {
