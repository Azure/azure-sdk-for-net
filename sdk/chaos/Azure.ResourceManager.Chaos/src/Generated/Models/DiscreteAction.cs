...
namespace Azure.ResourceManager.Chaos.Models
{
    ...
    public partial class DiscreteAction : ChaosExperimentAction
    {
        ...
        /// <param name="parameters"> List of key value pairs. </param>
        /// <param name="selectorId"> String that represents a selector. </param>
        internal DiscreteAction(string name, ExperimentActionType type, IDictionary<string, BinaryData> serializedAdditionalRawData, IList<KeyValuePair> parameters, string selectorId) : base(name, type, serializedAdditionalRawData)
        {
