...
namespace Azure.ResourceManager.Chaos.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DelayAction>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DelayAction>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DelayAction>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DelayAction>)} interface");
            }
        ...
        string IPersistableModel<DelayAction>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
