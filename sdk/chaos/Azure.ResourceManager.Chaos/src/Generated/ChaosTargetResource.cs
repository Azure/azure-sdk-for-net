...
namespace Azure.ResourceManager.Chaos
{
    ...
    public partial class ChaosTargetResource : ArmResource
    {
        ...
        /// <summary> Gets a collection of ChaosTargetCapabilityResources in the ChaosTarget. </summary>
        /// <returns> An object representing collection of ChaosTargetCapabilityResources and their operations over a ChaosTargetCapabilityResource. </returns>
        public virtual ChaosTargetCapabilityCollection GetChaosTargetCapabilities()
        {
            return GetCachedClient(client => new ChaosTargetCapabilityCollection(client, Id));
        }
        ...
        [ForwardsClientCalls]
        public virtual async Task<Response<ChaosTargetCapabilityResource>> GetChaosTargetCapabilityAsync(string capabilityName, CancellationToken cancellationToken = default)
        {
            return await GetChaosTargetCapabilities().GetAsync(capabilityName, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <exception cref="ArgumentException"> <paramref name="capabilityName"/> is an empty string, and was expected to be non-empty. </exception>
        [ForwardsClientCalls]
        public virtual Response<ChaosTargetCapabilityResource> GetChaosTargetCapability(string capabilityName, CancellationToken cancellationToken = default)
        {
            return GetChaosTargetCapabilities().Get(capabilityName, cancellationToken);
        }
