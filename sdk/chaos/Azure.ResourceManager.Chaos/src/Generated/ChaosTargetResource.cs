...
namespace Azure.ResourceManager.Chaos
{
    ...
    public partial class ChaosTargetResource : ArmResource
    {
        ...
        public virtual async Task<Response<ChaosTargetResource>> GetAsync(string parentResourceType, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _targetsClientDiagnostics.CreateScope("ChaosTargetResource.GetAsync");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, string parentResourceType, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _targetsClientDiagnostics.CreateScope("ChaosTargetResource.DeleteAsync");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        /// <summary> Gets a collection of ChaosCapabilities in the ChaosTarget. </summary>
        /// <returns> An object representing collection of ChaosCapabilities and their operations over a ChaosTarget. </returns>
