...
namespace Azure.ResourceManager.Chaos
{
    ...
    public partial class TargetTypeResource : ArmResource
    {
        ...
        internal TargetTypeResource(ArmClient client, TargetTypeData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<TargetTypeResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new TargetTypeResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
