...
{
    public partial class Sample_ChaosTargetCapabilityCollection
    {
        ...
        public async Task GetAll_ListAllCapabilitiesThatExtendAVirtualMachineTargetResource()
        {
            ...
            // get the collection of this ChaosTargetCapabilityResource
            ChaosTargetCapabilityCollection collection = chaosTarget.GetChaosTargetCapabilities();

            // invoke the operation and iterate over the result
            await foreach (ChaosTargetCapabilityResource item in collection.GetAllAsync())
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                ChaosTargetCapabilityData resourceData = item.Data;
        ...
        public async Task Get_GetACapabilityThatExtendsAVirtualMachineTargetResource()
        {
            ...
            ChaosTargetCapabilityResource result = await collection.GetAsync(capabilityName);
        ...
        public async Task GetIfExists_GetACapabilityThatExtendsAVirtualMachineTargetResource()
        {
            ...
            // invoke the operation
            string capabilityName = "Shutdown-1.0";
            NullableResponse<ChaosTargetCapabilityResource> response = await collection.GetIfExistsAsync(capabilityName);
            ChaosTargetCapabilityResource result = response.HasValue ? response.Value : null;
        ...
        public async Task CreateOrUpdate_CreateUpdateACapabilityThatExtendsAVirtualMachineTargetResource()
        {
            ...
            ArmOperation<ChaosTargetCapabilityResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, capabilityName, data);
