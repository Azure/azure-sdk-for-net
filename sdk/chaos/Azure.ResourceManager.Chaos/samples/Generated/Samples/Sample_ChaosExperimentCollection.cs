...
{
new ExperimentContinuousAction("urn:csci:microsoft:virtualMachine:shutdown/1.0",XmlConvert.ToTimeSpan("PT10M"),new ContinuousActionKeyValuePair[]
{
new ContinuousActionKeyValuePair("abruptShutdown","false")
},"selector1")
})
})
