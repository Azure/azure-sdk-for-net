...
#pragma warning disable SA1649 // File name should match first type name
    internal class CleanRoomArmOperation : ArmOperation
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        /// <summary> Initializes a new instance of CleanRoomArmOperation for mocking. </summary>
        protected CleanRoomArmOperation()
        {
        }

        internal CleanRoomArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal CleanRoomArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal(nextLinkOperation, clientDiagnostics, response, "CleanRoomArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
        ...
        private string GetOperationId(RehydrationToken? rehydrationToken)
        {
            ...
            var data = ModelReaderWriter.Write(rehydrationToken, ModelReaderWriterOptions.Json, AzureResourceManagerCleanRoomContext.Default);
