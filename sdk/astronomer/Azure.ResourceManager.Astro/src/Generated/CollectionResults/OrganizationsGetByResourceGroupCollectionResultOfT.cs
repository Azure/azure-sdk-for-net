...
{
    internal partial class OrganizationsGetByResourceGroupCollectionResultOfT : Pageable<AstroOrganizationData>
    {
        ...
        public OrganizationsGetByResourceGroupCollectionResultOfT(Organizations client, string subscriptionId, string resourceGroupName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        public override IEnumerable<Page<AstroOrganizationData>> AsPages(string continuationToken, int? pageSizeHint)
        {
