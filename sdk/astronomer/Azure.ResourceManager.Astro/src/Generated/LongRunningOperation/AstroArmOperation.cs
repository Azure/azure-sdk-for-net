...
namespace Azure.ResourceManager.Astro
{
    internal partial class AstroArmOperation : ArmOperation
    {
        ...
        internal AstroArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
