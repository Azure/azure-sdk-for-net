...
#pragma warning disable SA1649 // File name should match first type name
    internal class AstroArmOperation : ArmOperation
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        internal AstroArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal AstroArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal(nextLinkOperation, clientDiagnostics, response, "AstroArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
