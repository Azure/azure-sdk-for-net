...
namespace Azure.ResourceManager.Astro
{
    internal partial class AstroArmOperation<T> : ArmOperation<T>
    {
        ...
        internal AstroArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
