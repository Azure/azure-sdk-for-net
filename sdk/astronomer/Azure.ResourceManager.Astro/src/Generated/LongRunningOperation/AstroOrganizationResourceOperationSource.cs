...
{
    /// <summary></summary>
    internal partial class AstroOrganizationResourceOperationSource : IOperationSource<AstroOrganizationResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal AstroOrganizationResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
