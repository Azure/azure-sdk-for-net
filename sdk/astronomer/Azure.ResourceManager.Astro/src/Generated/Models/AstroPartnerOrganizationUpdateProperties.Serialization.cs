...
namespace Azure.ResourceManager.Astro.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AstroPartnerOrganizationUpdateProperties>)this).Write(writer, new ModelReaderWriterOptions("W"));
