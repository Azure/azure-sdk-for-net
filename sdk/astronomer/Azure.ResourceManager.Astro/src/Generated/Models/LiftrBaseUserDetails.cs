...
namespace Azure.ResourceManager.Astro.Models
{
    ...
    public partial class LiftrBaseUserDetails
    {
        ...
        /// <summary> Initializes a new instance of <see cref="LiftrBaseUserDetails"/>. </summary>
        ...
        internal LiftrBaseUserDetails(string firstName, string lastName, string emailAddress, string upn, string phoneNumber, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            FirstName = firstName;
            LastName = lastName;
            EmailAddress = emailAddress;
        ...
        /// <summary> Initializes a new instance of <see cref="LiftrBaseUserDetails"/> for deserialization. </summary>
        internal LiftrBaseUserDetails()
        {
        }
