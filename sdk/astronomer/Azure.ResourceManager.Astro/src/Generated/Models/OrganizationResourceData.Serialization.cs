...
namespace Azure.ResourceManager.Astro
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<OrganizationResourceData>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<OrganizationResourceData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(OrganizationResourceData)} does not support '{format}' format.");
            }
        ...
        internal static OrganizationResourceData DeserializeOrganizationResourceData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            Optional<LiftrBaseDataOrganizationProperties> properties = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("properties"u8))
                {
                    ...
                    properties = LiftrBaseDataOrganizationProperties.DeserializeLiftrBaseDataOrganizationProperties(property.Value);
                    continue;
                }
            ...
            return new OrganizationResourceData(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, properties.Value, identity, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<OrganizationResourceData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(OrganizationResourceData)} does not support '{options.Format}' format.");
            }
        }
