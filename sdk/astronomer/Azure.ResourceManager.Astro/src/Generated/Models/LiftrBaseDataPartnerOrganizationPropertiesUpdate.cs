...
namespace Azure.ResourceManager.Astro.Models
{
    ...
    public partial class LiftrBaseDataPartnerOrganizationPropertiesUpdate
    {
        ...
        /// <summary> Initializes a new instance of <see cref="LiftrBaseDataPartnerOrganizationPropertiesUpdate"/>. </summary>
        ...
        internal LiftrBaseDataPartnerOrganizationPropertiesUpdate(string organizationId, string workspaceId, string organizationName, string workspaceName, LiftrBaseSingleSignOnProperties singleSignOnProperties, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
