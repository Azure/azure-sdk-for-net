...
namespace Azure.ResourceManager.Astro.Models
{
    ...
    public partial class OrganizationResourcePatch
    {
        ...
        internal OrganizationResourcePatch(ManagedServiceIdentity identity, IDictionary<string, string> tags, OrganizationResourceUpdateProperties properties, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Identity = identity;
            Tags = tags;
