...
namespace Azure.ResourceManager.Astro.Models
{
    ...
    public partial class AstroUserDetails
    {
        ...
        internal AstroUserDetails(string firstName, string lastName, string emailAddress, string upn, string phoneNumber, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            FirstName = firstName;
            LastName = lastName;
            EmailAddress = emailAddress;
