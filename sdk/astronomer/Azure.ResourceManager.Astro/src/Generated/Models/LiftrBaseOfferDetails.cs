...
namespace Azure.ResourceManager.Astro.Models
{
    ...
    public partial class LiftrBaseOfferDetails
    {
        ...
        /// <summary> Initializes a new instance of <see cref="LiftrBaseOfferDetails"/>. </summary>
        ...
        internal LiftrBaseOfferDetails(string publisherId, string offerId, string planId, string planName, string termUnit, string termId, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            PublisherId = publisherId;
            OfferId = offerId;
            PlanId = planId;
        ...
        /// <summary> Initializes a new instance of <see cref="LiftrBaseOfferDetails"/> for deserialization. </summary>
        internal LiftrBaseOfferDetails()
        {
        }
