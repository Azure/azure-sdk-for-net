...
namespace Azure.ResourceManager.Astro.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<OrganizationResourceUpdateProperties>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<OrganizationResourceUpdateProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(OrganizationResourceUpdateProperties)} does not support '{format}' format.");
            }
        ...
        internal static OrganizationResourceUpdateProperties DeserializeOrganizationResourceUpdateProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            Optional<LiftrBaseUserDetailsUpdate> user = default;
            Optional<LiftrBaseDataPartnerOrganizationPropertiesUpdate> partnerOrganizationProperties = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("user"u8))
                {
                    ...
                    user = LiftrBaseUserDetailsUpdate.DeserializeLiftrBaseUserDetailsUpdate(property.Value);
                    continue;
                }
                if (property.NameEquals("partnerOrganizationProperties"u8))
                {
                    ...
                    partnerOrganizationProperties = LiftrBaseDataPartnerOrganizationPropertiesUpdate.DeserializeLiftrBaseDataPartnerOrganizationPropertiesUpdate(property.Value);
                    continue;
                }
                if (options.Format != "W")
                {
            ...
            return new OrganizationResourceUpdateProperties(user.Value, partnerOrganizationProperties.Value, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<OrganizationResourceUpdateProperties>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(OrganizationResourceUpdateProperties)} does not support '{options.Format}' format.");
            }
        }
