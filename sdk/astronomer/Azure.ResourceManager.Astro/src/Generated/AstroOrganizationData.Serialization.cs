...
namespace Azure.ResourceManager.Astro
{
    ...
    public partial class AstroOrganizationData : TrackedResourceData, IJsonModel<AstroOrganizationData>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        AstroOrganizationData IJsonModel<AstroOrganizationData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (AstroOrganizationData)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static AstroOrganizationData DeserializeAstroOrganizationData(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("systemData"u8))
                {
                    ...
                    systemData = ModelReaderWriter.Read<SystemData>(new BinaryData(Encoding.UTF8.GetBytes(prop.Value.GetRawText())), ModelSerializationExtensions.WireOptions, AzureResourceManagerAstroContext.Default);
                    continue;
                }
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = AstroOrganizationProperties.DeserializeAstroOrganizationProperties(prop.Value, options);
                    continue;
                }
        ...
        internal static AstroOrganizationData FromResponse(Response response)
        {
            ...
            return DeserializeAstroOrganizationData(document.RootElement, ModelSerializationExtensions.WireOptions);
        }
    }
}
