...
namespace Azure.ResourceManager.Astro.Samples
{
    public partial class Sample_OrganizationResourceCollection
    {
        ...
        public async Task CreateOrUpdate_OrganizationsCreateOrUpdateGeneratedByMaximumSetRule()
        {
            ...
            OrganizationResourceData data = new OrganizationResourceData(new AzureLocation("mhqthlsatwvqkl"))
            {
                Properties = new LiftrBaseDataOrganizationProperties(new LiftrBaseMarketplaceDetails("ntthclydlpqmasr", new LiftrBaseOfferDetails("gfsqxygpnerxmvols", "krzkefmpxztqyusidzgpchfaswuyce", "kndxzygsanuiqzwbfbbvoipv")
                {
                    PlanName = "pwqjwlq",
                ...
                }, new LiftrBaseUserDetails("nfh", "lazfbstcccykibvcrxpmglqam", ".K_@e7N-g1.xjqnbPs")
                {
                    Upn = "xtutvycpxjrtoftx",
                    PhoneNumber = "inxkscllh",
                })
                {
                    PartnerOrganizationProperties = new LiftrBaseDataPartnerOrganizationProperties("3-")
                    {
