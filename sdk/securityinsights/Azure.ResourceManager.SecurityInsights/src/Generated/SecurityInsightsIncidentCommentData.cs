...
namespace Azure.ResourceManager.SecurityInsights
{
    ...
    public partial class SecurityInsightsIncidentCommentData : ResourceData
    {
        ...
        internal SecurityInsightsIncidentCommentData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string message, DateTimeOffset? createdOn, DateTimeOffset? lastModifiedOn, SecurityInsightsClientInfo author, ETag? etag) : base(id, name, resourceType, systemData)
        {
            Message = message;
            CreatedOn = createdOn;
