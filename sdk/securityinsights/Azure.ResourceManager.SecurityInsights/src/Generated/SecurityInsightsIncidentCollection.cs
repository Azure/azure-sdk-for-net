...
<<<<<<<< HEAD:sdk/securityinsights/Azure.ResourceManager.SecurityInsights/src/Generated/SecurityInsightsIncidentCollection.cs
...
>>>>>>>> upstream/main:sdk/securityinsights/Azure.ResourceManager.SecurityInsights/src/Customized/SecurityInsightsIncidentCollection.cs
    /// </summary>
...
>>>>>>>> upstream/main:sdk/securityinsights/Azure.ResourceManager.SecurityInsights/src/Customized/SecurityInsightsIncidentCollection.cs
        ...
        public virtual async Task<ArmOperation<SecurityInsightsIncidentResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string incidentId, SecurityInsightsIncidentData data, CancellationToken cancellationToken = default)
        {
            ...
            {
<<<<<<<< HEAD:sdk/securityinsights/Azure.ResourceManager.SecurityInsights/src/Generated/SecurityInsightsIncidentCollection.cs
                var response = await _securityInsightsIncidentIncidentsRestClient.CreateOrUpdateAsync(Id.SubscriptionId, Id.ResourceGroupName, _workspaceName, incidentId, data, cancellationToken).ConfigureAwait(false);
========
...
>>>>>>>> upstream/main:sdk/securityinsights/Azure.ResourceManager.SecurityInsights/src/Customized/SecurityInsightsIncidentCollection.cs
        ...
        public virtual ArmOperation<SecurityInsightsIncidentResource> CreateOrUpdate(WaitUntil waitUntil, string incidentId, SecurityInsightsIncidentData data, CancellationToken cancellationToken = default)
        {
            ...
            {
<<<<<<<< HEAD:sdk/securityinsights/Azure.ResourceManager.SecurityInsights/src/Generated/SecurityInsightsIncidentCollection.cs
                var response = _securityInsightsIncidentIncidentsRestClient.CreateOrUpdate(Id.SubscriptionId, Id.ResourceGroupName, _workspaceName, incidentId, data, cancellationToken);
========
...
>>>>>>>> upstream/main:sdk/securityinsights/Azure.ResourceManager.SecurityInsights/src/Customized/SecurityInsightsIncidentCollection.cs
        ...
        public virtual async Task<Response<SecurityInsightsIncidentResource>> GetAsync(string incidentId, CancellationToken cancellationToken = default)
        {
            ...
            {
<<<<<<<< HEAD:sdk/securityinsights/Azure.ResourceManager.SecurityInsights/src/Generated/SecurityInsightsIncidentCollection.cs
                var response = await _securityInsightsIncidentIncidentsRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, _workspaceName, incidentId, cancellationToken).ConfigureAwait(false);
========
...
>>>>>>>> upstream/main:sdk/securityinsights/Azure.ResourceManager.SecurityInsights/src/Customized/SecurityInsightsIncidentCollection.cs
        ...
        public virtual Response<SecurityInsightsIncidentResource> Get(string incidentId, CancellationToken cancellationToken = default)
        {
            ...
            {
<<<<<<<< HEAD:sdk/securityinsights/Azure.ResourceManager.SecurityInsights/src/Generated/SecurityInsightsIncidentCollection.cs
                var response = _securityInsightsIncidentIncidentsRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, _workspaceName, incidentId, cancellationToken);
========
...
>>>>>>>> upstream/main:sdk/securityinsights/Azure.ResourceManager.SecurityInsights/src/Customized/SecurityInsightsIncidentCollection.cs
        ...
        public virtual AsyncPageable<SecurityInsightsIncidentResource> GetAllAsync(string filter = null, string orderBy = null, int? top = null, string skipToken = null, CancellationToken cancellationToken = default)
        {
            async Task<Page<SecurityInsightsIncidentResource>> FirstPageFunc(int? pageSizeHint)
            {
                ...
                {
<<<<<<<< HEAD:sdk/securityinsights/Azure.ResourceManager.SecurityInsights/src/Generated/SecurityInsightsIncidentCollection.cs
                    var response = await _securityInsightsIncidentIncidentsRestClient.ListAsync(Id.SubscriptionId, Id.ResourceGroupName, _workspaceName, filter, orderBy, top, skipToken, cancellationToken: cancellationToken).ConfigureAwait(false);
========
...
>>>>>>>> upstream/main:sdk/securityinsights/Azure.ResourceManager.SecurityInsights/src/Customized/SecurityInsightsIncidentCollection.cs
            ...
            async Task<Page<SecurityInsightsIncidentResource>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                {
<<<<<<<< HEAD:sdk/securityinsights/Azure.ResourceManager.SecurityInsights/src/Generated/SecurityInsightsIncidentCollection.cs
                    var response = await _securityInsightsIncidentIncidentsRestClient.ListNextPageAsync(nextLink, Id.SubscriptionId, Id.ResourceGroupName, _workspaceName, filter, orderBy, top, skipToken, cancellationToken: cancellationToken).ConfigureAwait(false);
========
...
>>>>>>>> upstream/main:sdk/securityinsights/Azure.ResourceManager.SecurityInsights/src/Customized/SecurityInsightsIncidentCollection.cs
        ...
        public virtual Pageable<SecurityInsightsIncidentResource> GetAll(string filter = null, string orderBy = null, int? top = null, string skipToken = null, CancellationToken cancellationToken = default)
        {
            Page<SecurityInsightsIncidentResource> FirstPageFunc(int? pageSizeHint)
            {
                ...
                {
<<<<<<<< HEAD:sdk/securityinsights/Azure.ResourceManager.SecurityInsights/src/Generated/SecurityInsightsIncidentCollection.cs
                    var response = _securityInsightsIncidentIncidentsRestClient.List(Id.SubscriptionId, Id.ResourceGroupName, _workspaceName, filter, orderBy, top, skipToken, cancellationToken: cancellationToken);
========
...
>>>>>>>> upstream/main:sdk/securityinsights/Azure.ResourceManager.SecurityInsights/src/Customized/SecurityInsightsIncidentCollection.cs
            ...
            Page<SecurityInsightsIncidentResource> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                {
<<<<<<<< HEAD:sdk/securityinsights/Azure.ResourceManager.SecurityInsights/src/Generated/SecurityInsightsIncidentCollection.cs
                    var response = _securityInsightsIncidentIncidentsRestClient.ListNextPage(nextLink, Id.SubscriptionId, Id.ResourceGroupName, _workspaceName, filter, orderBy, top, skipToken, cancellationToken: cancellationToken);
========
...
>>>>>>>> upstream/main:sdk/securityinsights/Azure.ResourceManager.SecurityInsights/src/Customized/SecurityInsightsIncidentCollection.cs
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string incidentId, CancellationToken cancellationToken = default)
        {
            ...
            {
<<<<<<<< HEAD:sdk/securityinsights/Azure.ResourceManager.SecurityInsights/src/Generated/SecurityInsightsIncidentCollection.cs
                var response = await _securityInsightsIncidentIncidentsRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, _workspaceName, incidentId, cancellationToken: cancellationToken).ConfigureAwait(false);
========
...
>>>>>>>> upstream/main:sdk/securityinsights/Azure.ResourceManager.SecurityInsights/src/Customized/SecurityInsightsIncidentCollection.cs
        ...
        public virtual Response<bool> Exists(string incidentId, CancellationToken cancellationToken = default)
        {
            ...
            {
<<<<<<<< HEAD:sdk/securityinsights/Azure.ResourceManager.SecurityInsights/src/Generated/SecurityInsightsIncidentCollection.cs
                var response = _securityInsightsIncidentIncidentsRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, _workspaceName, incidentId, cancellationToken: cancellationToken);
========
