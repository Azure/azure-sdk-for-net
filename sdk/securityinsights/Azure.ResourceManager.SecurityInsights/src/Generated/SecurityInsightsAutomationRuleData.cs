...
namespace Azure.ResourceManager.SecurityInsights
{
    ...
    public partial class SecurityInsightsAutomationRuleData : ResourceData
    {
        ...
        internal SecurityInsightsAutomationRuleData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string displayName, int order, SecurityInsightsAutomationRuleTriggeringLogic triggeringLogic, IList<SecurityInsightsAutomationRuleAction> actions, DateTimeOffset? lastModifiedOn, DateTimeOffset? createdOn, SecurityInsightsClientInfo lastModifiedBy, SecurityInsightsClientInfo createdBy, ETag? etag, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData)
        {
            DisplayName = displayName;
            Order = order;
            TriggeringLogic = triggeringLogic;
