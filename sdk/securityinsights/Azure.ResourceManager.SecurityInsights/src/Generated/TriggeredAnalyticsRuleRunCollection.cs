...
namespace Azure.ResourceManager.SecurityInsights
{
    ...
    /// Each <see cref="TriggeredAnalyticsRuleRunResource"/> in the collection will belong to the same instance of <see cref="ArmResource"/>.
    /// To get a <see cref="TriggeredAnalyticsRuleRunCollection"/> instance call the GetTriggeredAnalyticsRuleRuns method from an instance of <see cref="ArmResource"/>.
    /// </summary>
    public partial class TriggeredAnalyticsRuleRunCollection : ArmCollection, IEnumerable<TriggeredAnalyticsRuleRunResource>, IAsyncEnumerable<TriggeredAnalyticsRuleRunResource>
    {
        ...
        public virtual async Task<Response<TriggeredAnalyticsRuleRunResource>> GetAsync(string ruleRunId, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _triggeredAnalyticsRuleRunRestClient.CreateGetRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, ruleRunId, context);
        ...
        public virtual AsyncPageable<TriggeredAnalyticsRuleRunResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<TriggeredAnalyticsRuleRunData, TriggeredAnalyticsRuleRunResource>(new GetTriggeredAnalyticsRuleRunsGetAllAsyncCollectionResultOfT(
                ...
                Id.Name,
                context,
                "TriggeredAnalyticsRuleRunCollection.GetAll"), data => new TriggeredAnalyticsRuleRunResource(Client, data));
        }
