...
namespace Azure.ResourceManager.SecurityInsights
{
    ...
    /// Each <see cref="SecurityInsightsAlertRuleResource"/> in the collection will belong to the same instance of <see cref="ArmResource"/>.
    /// To get a <see cref="SecurityInsightsAlertRuleCollection"/> instance call the GetSecurityInsightsAlertRules method from an instance of <see cref="ArmResource"/>.
    /// </summary>
    public partial class SecurityInsightsAlertRuleCollection : ArmCollection, IEnumerable<SecurityInsightsAlertRuleResource>, IAsyncEnumerable<SecurityInsightsAlertRuleResource>
    {
        ...
        internal SecurityInsightsAlertRuleCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _alertRulesRestClient = new AlertRules(_alertRulesClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, securityInsightsAlertRuleApiVersion ?? "2025-07-01-preview");
        ...
        public virtual async Task<ArmOperation<SecurityInsightsAlertRuleResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string ruleId, SecurityInsightsAlertRuleData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _alertRulesRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, ruleId, SecurityInsightsAlertRuleData.ToRequestContent(data), context);
        ...
        public virtual async Task<Response<SecurityInsightsAlertRuleResource>> GetAsync(string ruleId, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _alertRulesRestClient.CreateGetRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, ruleId, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<SecurityInsightsAlertRuleData> response = Response.FromValue(SecurityInsightsAlertRuleData.FromResponse(result), result);
        ...
        public virtual AsyncPageable<SecurityInsightsAlertRuleResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<SecurityInsightsAlertRuleData, SecurityInsightsAlertRuleResource>(new AlertRulesGetAllAsyncCollectionResultOfT(
                ...
                Id.Name,
                context,
                "SecurityInsightsAlertRuleCollection.GetAll"), data => new SecurityInsightsAlertRuleResource(Client, data));
        }
