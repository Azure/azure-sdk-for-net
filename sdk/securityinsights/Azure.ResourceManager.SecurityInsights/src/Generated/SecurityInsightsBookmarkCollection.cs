...
namespace Azure.ResourceManager.SecurityInsights
{
    ...
    /// Each <see cref="SecurityInsightsBookmarkResource"/> in the collection will belong to the same instance of <see cref="ArmResource"/>.
    /// To get a <see cref="SecurityInsightsBookmarkCollection"/> instance call the GetSecurityInsightsBookmarks method from an instance of <see cref="ArmResource"/>.
    /// </summary>
    public partial class SecurityInsightsBookmarkCollection : ArmCollection, IEnumerable<SecurityInsightsBookmarkResource>, IAsyncEnumerable<SecurityInsightsBookmarkResource>
    {
        ...
        internal SecurityInsightsBookmarkCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _bookmarksRestClient = new Bookmarks(_bookmarksClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, securityInsightsBookmarkApiVersion ?? "2025-10-01-preview");
        ...
        public virtual async Task<ArmOperation<SecurityInsightsBookmarkResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string bookmarkId, SecurityInsightsBookmarkData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _bookmarksRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, bookmarkId, SecurityInsightsBookmarkData.ToRequestContent(data), context);
        ...
        public virtual async Task<Response<SecurityInsightsBookmarkResource>> GetAsync(string bookmarkId, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _bookmarksRestClient.CreateGetRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, bookmarkId, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<SecurityInsightsBookmarkData> response = Response.FromValue(SecurityInsightsBookmarkData.FromResponse(result), result);
        ...
        public virtual AsyncPageable<SecurityInsightsBookmarkResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<SecurityInsightsBookmarkData, SecurityInsightsBookmarkResource>(new BookmarksGetAllAsyncCollectionResultOfT(
                ...
                Id.Name,
                context,
                "SecurityInsightsBookmarkCollection.GetAll"), data => new SecurityInsightsBookmarkResource(Client, data));
        }
