    ...
    internal partial class EntitiesRestOperations
    {
        ...
        internal HttpMessage CreateRunPlaybookRequest(string subscriptionId, string resourceGroupName, string workspaceName, string entityIdentifier, EntityManualTriggerRequestContent content)
        {
            ...
            if (content != null)
            {
                ...
                ((IJsonModel<EntityManualTriggerRequestContent>)content).Write(content0.JsonWriter, ModelSerializationExtensions.WireOptions);
        ...
        internal HttpMessage CreateExpandRequest(string subscriptionId, string resourceGroupName, string workspaceName, string entityId, EntityExpandContent content)
        {
            ...
            request.Headers.Add("Content-Type", "application/json");
            var content0 = new Utf8JsonRequestContent();
            ((IJsonModel<EntityExpandContent>)content).Write(content0.JsonWriter, ModelSerializationExtensions.WireOptions);
            request.Content = content0;
            _userAgent.Apply(message);
            return message;
        }
        ...
        internal HttpMessage CreateGetInsightsRequest(string subscriptionId, string resourceGroupName, string workspaceName, string entityId, EntityGetInsightsContent content)
        {
            ...
            request.Headers.Add("Content-Type", "application/json");
            var content0 = new Utf8JsonRequestContent();
            ((IJsonModel<EntityGetInsightsContent>)content).Write(content0.JsonWriter, ModelSerializationExtensions.WireOptions);
            request.Content = content0;
            _userAgent.Apply(message);
            return message;
        }
