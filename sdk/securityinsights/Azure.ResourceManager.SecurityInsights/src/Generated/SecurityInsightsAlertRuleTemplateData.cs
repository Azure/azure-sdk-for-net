...
namespace Azure.ResourceManager.SecurityInsights
{
    ...
    public partial class SecurityInsightsAlertRuleTemplateData : ResourceData
    {
        ...
        internal SecurityInsightsAlertRuleTemplateData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, AlertRuleKind kind, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
            Kind = kind;
