...
namespace Azure.ResourceManager.SecurityInsights
{
    ...
    /// Each <see cref="SecurityInsightsAutomationRuleResource"/> in the collection will belong to the same instance of <see cref="ArmResource"/>.
    /// To get a <see cref="SecurityInsightsAutomationRuleCollection"/> instance call the GetSecurityInsightsAutomationRules method from an instance of <see cref="ArmResource"/>.
    /// </summary>
    public partial class SecurityInsightsAutomationRuleCollection : ArmCollection, IEnumerable<SecurityInsightsAutomationRuleResource>, IAsyncEnumerable<SecurityInsightsAutomationRuleResource>
    {
        ...
        public virtual async Task<ArmOperation<SecurityInsightsAutomationRuleResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string automationRuleId, SecurityInsightsAutomationRuleData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _automationRulesRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, automationRuleId, SecurityInsightsAutomationRuleData.ToRequestContent(data), context);
        ...
        public virtual async Task<Response<SecurityInsightsAutomationRuleResource>> GetAsync(string automationRuleId, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _automationRulesRestClient.CreateGetRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, automationRuleId, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<SecurityInsightsAutomationRuleData> response = Response.FromValue(SecurityInsightsAutomationRuleData.FromResponse(result), result);
        ...
        public virtual AsyncPageable<SecurityInsightsAutomationRuleResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<SecurityInsightsAutomationRuleData, SecurityInsightsAutomationRuleResource>(new AutomationRulesGetAllAsyncCollectionResultOfT(
                ...
                Id.Name,
                context,
                "SecurityInsightsAutomationRuleCollection.GetAll"), data => new SecurityInsightsAutomationRuleResource(Client, data));
        }
