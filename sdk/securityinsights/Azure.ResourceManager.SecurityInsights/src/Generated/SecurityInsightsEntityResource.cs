...
namespace Azure.ResourceManager.SecurityInsights
{
    ...
    public partial class SecurityInsightsEntityResource : ArmResource
    {
        ...
        public virtual AsyncPageable<EntityQueryItem> QueriesAsync(EntityItemQueryKind kind, CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, null, EntityQueryItem.DeserializeEntityQueryItem, _securityInsightsEntityEntitiesClientDiagnostics, Pipeline, "SecurityInsightsEntityResource.Queries", "value", null, cancellationToken);
        }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _securityInsightsEntityEntitiesRestClient.CreateQueriesRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, kind);
            return PageableHelpers.CreatePageable(FirstPageRequest, null, EntityQueryItem.DeserializeEntityQueryItem, _securityInsightsEntityEntitiesClientDiagnostics, Pipeline, "SecurityInsightsEntityResource.Queries", "value", null, cancellationToken);
        }
        ...
        public virtual AsyncPageable<EntityInsightItem> GetInsightsAsync(EntityGetInsightsContent content, CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, null, EntityInsightItem.DeserializeEntityInsightItem, _securityInsightsEntityEntitiesClientDiagnostics, Pipeline, "SecurityInsightsEntityResource.GetInsights", "value", null, cancellationToken);
        }
        ...
        public virtual Pageable<EntityInsightItem> GetInsights(EntityGetInsightsContent content, CancellationToken cancellationToken = default)
        {
            ...
            HttpMessage FirstPageRequest(int? pageSizeHint) => _securityInsightsEntityEntitiesRestClient.CreateGetInsightsRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, content);
            return PageableHelpers.CreatePageable(FirstPageRequest, null, EntityInsightItem.DeserializeEntityInsightItem, _securityInsightsEntityEntitiesClientDiagnostics, Pipeline, "SecurityInsightsEntityResource.GetInsights", "value", null, cancellationToken);
        }
        ...
        public virtual AsyncPageable<EntityTimelineItem> GetEntitiesGetTimelinesAsync(EntityTimelineContent content, CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, null, EntityTimelineItem.DeserializeEntityTimelineItem, _entitiesGetTimelineClientDiagnostics, Pipeline, "SecurityInsightsEntityResource.GetEntitiesGetTimelines", "value", null, cancellationToken);
        }
        ...
        public virtual Pageable<EntityTimelineItem> GetEntitiesGetTimelines(EntityTimelineContent content, CancellationToken cancellationToken = default)
        {
            ...
            HttpMessage FirstPageRequest(int? pageSizeHint) => _entitiesGetTimelineRestClient.CreateListRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, content);
            return PageableHelpers.CreatePageable(FirstPageRequest, null, EntityTimelineItem.DeserializeEntityTimelineItem, _entitiesGetTimelineClientDiagnostics, Pipeline, "SecurityInsightsEntityResource.GetEntitiesGetTimelines", "value", null, cancellationToken);
        }
    }
}
