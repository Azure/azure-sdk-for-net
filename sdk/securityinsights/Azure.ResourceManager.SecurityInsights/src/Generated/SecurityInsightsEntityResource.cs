...
namespace Azure.ResourceManager.SecurityInsights
{
    ...
    /// Otherwise you can get one from its parent resource <see cref="ArmResource"/> using the GetSecurityInsightsEntities method.
    /// </summary>
    public partial class SecurityInsightsEntityResource : ArmResource
    {
        ...
        internal SecurityInsightsEntityResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _entitiesGetTimelineRestClient = new EntitiesGetTimeline(_entitiesGetTimelineClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, securityInsightsEntityApiVersion ?? "2025-07-01-preview");
        ...
        public virtual AsyncPageable<EntityTimelineItem> GetAllAsync(EntityTimelineContent content, CancellationToken cancellationToken = default)
        {
            ...
            return new EntitiesGetTimelineGetAllAsyncCollectionResultOfT(
                ...
                Id.Parent.Name,
                Id.Name,
                EntityTimelineContent.ToRequestContent(content),
                context,
                "SecurityInsightsEntityResource.GetAll");
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="content"/> is null. </exception>
        /// <returns> A collection of <see cref="EntityTimelineItem"/> that may take multiple service requests to iterate over. </returns>
        public virtual Pageable<EntityTimelineItem> GetAll(EntityTimelineContent content, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(content, nameof(content));
        ...
        public virtual AsyncPageable<EntityInsightItem> GetInsightsAsync(EntityGetInsightsContent content, CancellationToken cancellationToken = default)
        {
            ...
            return new EntitiesGetInsightsAsyncCollectionResultOfT(
                ...
                Id.Parent.Name,
                Id.Name,
                EntityGetInsightsContent.ToRequestContent(content),
                context,
                "SecurityInsightsEntityResource.GetInsights");
        }
        ...
        public virtual AsyncPageable<EntityQueryItem> QueriesAsync(EntityItemQueryKind kind, CancellationToken cancellationToken = default)
        {
            ...
            return new EntitiesQueriesAsyncCollectionResultOfT(
                ...
                kind.ToString(),
                context,
                "SecurityInsightsEntityResource.Queries");
        }
        ...
        /// <summary> Gets a collection of SecurityInsightsEntityRelations in the <see cref="SecurityInsightsEntityResource"/>. </summary>
        /// <returns> An object representing collection of SecurityInsightsEntityRelations and their operations over a SecurityInsightsEntityRelationResource. </returns>
