...
namespace Azure.ResourceManager.SecurityInsights
{
    ...
    /// Each <see cref="SecurityInsightsAlertRuleTemplateResource"/> in the collection will belong to the same instance of <see cref="ArmResource"/>.
    /// To get a <see cref="SecurityInsightsAlertRuleTemplateCollection"/> instance call the GetSecurityInsightsAlertRuleTemplates method from an instance of <see cref="ArmResource"/>.
    /// </summary>
    public partial class SecurityInsightsAlertRuleTemplateCollection : ArmCollection, IEnumerable<SecurityInsightsAlertRuleTemplateResource>, IAsyncEnumerable<SecurityInsightsAlertRuleTemplateResource>
    {
        ...
        internal SecurityInsightsAlertRuleTemplateCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _alertRuleTemplatesRestClient = new AlertRuleTemplates(_alertRuleTemplatesClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, securityInsightsAlertRuleTemplateApiVersion ?? "2025-10-01-preview");
        ...
        public virtual async Task<Response<SecurityInsightsAlertRuleTemplateResource>> GetAsync(string alertRuleTemplateId, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _alertRuleTemplatesRestClient.CreateGetRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, alertRuleTemplateId, context);
        ...
        public virtual AsyncPageable<SecurityInsightsAlertRuleTemplateResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<SecurityInsightsAlertRuleTemplateData, SecurityInsightsAlertRuleTemplateResource>(new AlertRuleTemplatesGetAllAsyncCollectionResultOfT(
                ...
                Id.Name,
                context,
                "SecurityInsightsAlertRuleTemplateCollection.GetAll"), data => new SecurityInsightsAlertRuleTemplateResource(Client, data));
        }
