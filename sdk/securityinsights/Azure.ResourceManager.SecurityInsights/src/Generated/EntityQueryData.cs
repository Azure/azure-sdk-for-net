...
namespace Azure.ResourceManager.SecurityInsights
{
    ...
    /// </summary>
    public abstract partial class EntityQueryData : ResourceData
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="EntityQueryData"/>. </summary>
        protected EntityQueryData()
        {
        }
        ...
        internal EntityQueryData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, EntityQueryKind kind, ETag? etag, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
            Kind = kind;
            ETag = etag;
