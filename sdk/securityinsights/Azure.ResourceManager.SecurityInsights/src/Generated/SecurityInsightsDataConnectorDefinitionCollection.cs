...
namespace Azure.ResourceManager.SecurityInsights
{
    ...
    /// Each <see cref="SecurityInsightsDataConnectorDefinitionResource"/> in the collection will belong to the same instance of <see cref="ArmResource"/>.
    /// To get a <see cref="SecurityInsightsDataConnectorDefinitionCollection"/> instance call the GetSecurityInsightsDataConnectorDefinitions method from an instance of <see cref="ArmResource"/>.
    /// </summary>
    public partial class SecurityInsightsDataConnectorDefinitionCollection : ArmCollection, IEnumerable<SecurityInsightsDataConnectorDefinitionResource>, IAsyncEnumerable<SecurityInsightsDataConnectorDefinitionResource>
    {
        ...
        internal SecurityInsightsDataConnectorDefinitionCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _dataConnectorDefinitionsRestClient = new DataConnectorDefinitions(_dataConnectorDefinitionsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, securityInsightsDataConnectorDefinitionApiVersion ?? "2025-10-01-preview");
        ...
        public virtual async Task<ArmOperation<SecurityInsightsDataConnectorDefinitionResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string dataConnectorDefinitionName, SecurityInsightsDataConnectorDefinitionData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _dataConnectorDefinitionsRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, dataConnectorDefinitionName, SecurityInsightsDataConnectorDefinitionData.ToRequestContent(data), context);
        ...
        public virtual async Task<Response<SecurityInsightsDataConnectorDefinitionResource>> GetAsync(string dataConnectorDefinitionName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _dataConnectorDefinitionsRestClient.CreateGetRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, dataConnectorDefinitionName, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<SecurityInsightsDataConnectorDefinitionData> response = Response.FromValue(SecurityInsightsDataConnectorDefinitionData.FromResponse(result), result);
        ...
        public virtual AsyncPageable<SecurityInsightsDataConnectorDefinitionResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<SecurityInsightsDataConnectorDefinitionData, SecurityInsightsDataConnectorDefinitionResource>(new DataConnectorDefinitionsGetAllAsyncCollectionResultOfT(
                ...
                Id.Name,
                context,
                "SecurityInsightsDataConnectorDefinitionCollection.GetAll"), data => new SecurityInsightsDataConnectorDefinitionResource(Client, data));
        }
