...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    public static partial class ArmSecurityInsightsModelFactory
    {
        ...
        public static SourceControlServicePrincipal SourceControlServicePrincipal(string id = default, string tenantId = default, string appId = default, DateTimeOffset? credentialsExpiresOn = default)
        {
            return new SourceControlServicePrincipal(id, tenantId, appId, credentialsExpiresOn, default);
        }
