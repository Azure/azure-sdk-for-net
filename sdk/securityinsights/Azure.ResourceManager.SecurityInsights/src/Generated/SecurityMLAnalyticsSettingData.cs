...
namespace Azure.ResourceManager.SecurityInsights
{
    ...
    public partial class SecurityMLAnalyticsSettingData : ResourceData
    {
        ...
        internal SecurityMLAnalyticsSettingData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, SecurityMLAnalyticsSettingsKind kind, string eTag) : base(id, name, resourceType, systemData)
        {
