...
namespace Azure.ResourceManager.SecurityInsights
{
    ...
    public partial class SecurityInsightsThreatIntelligenceIndicatorBaseData : ResourceData
    {
        ...
        public SecurityInsightsThreatIntelligenceIndicatorBaseData(ThreatIntelligenceResourceInnerKind kind)
        {
            Kind = kind;
        }
        ...
        internal SecurityInsightsThreatIntelligenceIndicatorBaseData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, ThreatIntelligenceResourceInnerKind kind, string eTag) : base(id, name, resourceType, systemData)
        {
