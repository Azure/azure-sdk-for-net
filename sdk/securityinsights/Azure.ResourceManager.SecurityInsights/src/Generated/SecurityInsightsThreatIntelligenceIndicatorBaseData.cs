...
namespace Azure.ResourceManager.SecurityInsights
{
    ...
    public partial class SecurityInsightsThreatIntelligenceIndicatorBaseData : ResourceData
    {
        ...
        internal SecurityInsightsThreatIntelligenceIndicatorBaseData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, ThreatIntelligenceResourceInnerKind kind, ETag? eTag, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, name, resourceType, systemData)
        {
            Kind = kind;
            ETag = eTag;
