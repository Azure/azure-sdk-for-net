...
{
    public partial class MetadataModelData : IUtf8JsonSerializable, IJsonModel<MetadataModelData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MetadataModelData>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<MetadataModelData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<MetadataModelData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MetadataModelData)} does not support writing '{format}' format.");
            }
        ...
        MetadataModelData IJsonModel<MetadataModelData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<MetadataModelData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MetadataModelData)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeMetadataModelData(document.RootElement, options);
        }

        internal static MetadataModelData DeserializeMetadataModelData(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<MetadataModelData>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<MetadataModelData>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(MetadataModelData)} does not support writing '{options.Format}' format.");
            }
        }

        MetadataModelData IPersistableModel<MetadataModelData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<MetadataModelData>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(MetadataModelData)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<MetadataModelData>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
