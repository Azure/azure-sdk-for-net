...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AnomalySecurityMLAnalyticsSettings>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AnomalySecurityMLAnalyticsSettings>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AnomalySecurityMLAnalyticsSettings>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AnomalySecurityMLAnalyticsSettings>)} interface");
            }
        ...
        string IPersistableModel<AnomalySecurityMLAnalyticsSettings>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
