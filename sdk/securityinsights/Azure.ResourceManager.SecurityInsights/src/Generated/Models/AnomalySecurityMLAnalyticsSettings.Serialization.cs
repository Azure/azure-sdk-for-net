...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    public partial class AnomalySecurityMLAnalyticsSettings : SecurityMLAnalyticsSettingData, IJsonModel<AnomalySecurityMLAnalyticsSettings>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<AnomalySecurityMLAnalyticsSettings>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<AnomalySecurityMLAnalyticsSettings>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        AnomalySecurityMLAnalyticsSettings IPersistableModel<AnomalySecurityMLAnalyticsSettings>.Create(BinaryData data, ModelReaderWriterOptions options) => (AnomalySecurityMLAnalyticsSettings)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        AnomalySecurityMLAnalyticsSettings IJsonModel<AnomalySecurityMLAnalyticsSettings>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (AnomalySecurityMLAnalyticsSettings)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static AnomalySecurityMLAnalyticsSettings DeserializeAnomalySecurityMLAnalyticsSettings(JsonElement element, ModelReaderWriterOptions options)
        {
