...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    public partial class AnomalySecurityMLAnalyticsSettings : IUtf8JsonSerializable, IModelJsonSerializable<AnomalySecurityMLAnalyticsSettings>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<AnomalySecurityMLAnalyticsSettings>(this, options.Format);
            ...
            if (Optional.IsCollectionDefined(RequiredDataConnectors))
            {
                ...
                foreach (var item in RequiredDataConnectors)
                {
                    ...
                    {
                        ((IModelJsonSerializable<SecurityMLAnalyticsSettingsDataSource>)item).Serialize(writer, options);
                    }
                }
        ...
        /// <summary> Converts a <see cref="AnomalySecurityMLAnalyticsSettings"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="AnomalySecurityMLAnalyticsSettings"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="AnomalySecurityMLAnalyticsSettings"/>. </summary>
