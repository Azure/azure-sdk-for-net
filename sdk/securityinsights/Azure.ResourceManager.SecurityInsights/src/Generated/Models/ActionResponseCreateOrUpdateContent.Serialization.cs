...
{
    public partial class ActionResponseCreateOrUpdateContent : IUtf8JsonSerializable
    {
        ...
        internal static ActionResponseCreateOrUpdateContent DeserializeActionResponseCreateOrUpdateContent(JsonElement element)
        {
            ...
            return new ActionResponseCreateOrUpdateContent(id, name, type, systemData.Value, logicAppResourceId.Value, triggerUri.Value, Optional.ToNullable(etag));
        }
    }
}
