...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    {
        internal static SecurityInsightsClientInfo DeserializeSecurityInsightsClientInfo(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
