...
{
    public partial class AutomationRuleRunPlaybookActionProperties : IUtf8JsonSerializable, IJsonModel<AutomationRuleRunPlaybookActionProperties>, IPersistableModel<AutomationRuleRunPlaybookActionProperties>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AutomationRuleRunPlaybookActionProperties>)this).Write(writer, new ModelReaderWriterOptions("W"));
