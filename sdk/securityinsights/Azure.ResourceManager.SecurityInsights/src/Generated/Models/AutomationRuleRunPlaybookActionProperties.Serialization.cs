...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    public partial class AutomationRuleRunPlaybookActionProperties : IUtf8JsonSerializable, IJsonModel<AutomationRuleRunPlaybookActionProperties>
    {
        ...
        void IJsonModel<AutomationRuleRunPlaybookActionProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(AutomationRuleRunPlaybookActionProperties)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<AutomationRuleRunPlaybookActionProperties>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(AutomationRuleRunPlaybookActionProperties)} does not support '{options.Format}' format.");
            }
        }
