...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    public partial class MstiDataConnector : SecurityInsightsDataConnectorData
    {
        ...
        internal MstiDataConnector(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, DataConnectorKind kind, ETag? etag, Guid? tenantId, MstiDataConnectorDataTypesMicrosoftEmergingThreatFeed microsoftEmergingThreatFeed) : base(id, name, resourceType, systemData, kind, etag)
        {
            TenantId = tenantId;
