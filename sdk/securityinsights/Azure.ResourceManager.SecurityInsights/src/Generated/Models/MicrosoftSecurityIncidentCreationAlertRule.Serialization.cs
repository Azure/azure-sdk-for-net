...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    public partial class MicrosoftSecurityIncidentCreationAlertRule : SecurityInsightsAlertRuleData, IJsonModel<MicrosoftSecurityIncidentCreationAlertRule>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<MicrosoftSecurityIncidentCreationAlertRule>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<MicrosoftSecurityIncidentCreationAlertRule>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        MicrosoftSecurityIncidentCreationAlertRule IPersistableModel<MicrosoftSecurityIncidentCreationAlertRule>.Create(BinaryData data, ModelReaderWriterOptions options) => (MicrosoftSecurityIncidentCreationAlertRule)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        MicrosoftSecurityIncidentCreationAlertRule IJsonModel<MicrosoftSecurityIncidentCreationAlertRule>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (MicrosoftSecurityIncidentCreationAlertRule)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static MicrosoftSecurityIncidentCreationAlertRule DeserializeMicrosoftSecurityIncidentCreationAlertRule(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            string eTag = default;
            MicrosoftSecurityIncidentCreationAlertRuleProperties properties = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = MicrosoftSecurityIncidentCreationAlertRuleProperties.DeserializeMicrosoftSecurityIncidentCreationAlertRuleProperties(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
