...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MicrosoftSecurityIncidentCreationAlertRule>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MicrosoftSecurityIncidentCreationAlertRule>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MicrosoftSecurityIncidentCreationAlertRule>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MicrosoftSecurityIncidentCreationAlertRule>)} interface");
            }
        ...
        string IPersistableModel<MicrosoftSecurityIncidentCreationAlertRule>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
