...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MicrosoftSecurityIncidentCreationAlertRule>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        MicrosoftSecurityIncidentCreationAlertRule IJsonModel<MicrosoftSecurityIncidentCreationAlertRule>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        internal static MicrosoftSecurityIncidentCreationAlertRule DeserializeMicrosoftSecurityIncidentCreationAlertRule(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new MicrosoftSecurityIncidentCreationAlertRule(id, name, type, systemData.Value, kind, Optional.ToNullable(etag), serializedAdditionalRawData, Optional.ToList(displayNamesFilter), Optional.ToList(displayNamesExcludeFilter), Optional.ToNullable(productFilter), Optional.ToList(severitiesFilter), alertRuleTemplateName.Value, description.Value, displayName.Value, Optional.ToNullable(enabled), Optional.ToNullable(lastModifiedUtc));
        }

        BinaryData IModel<MicrosoftSecurityIncidentCreationAlertRule>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        MicrosoftSecurityIncidentCreationAlertRule IModel<MicrosoftSecurityIncidentCreationAlertRule>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<MicrosoftSecurityIncidentCreationAlertRule>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
