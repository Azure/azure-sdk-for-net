...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    public partial class ExpansionResultAggregation
    {
        ...
        internal ExpansionResultAggregation(string aggregationType, int count, string displayName, SecurityInsightsEntityKind entityKind, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
