...
{
    internal partial class UnknownSecurityMLAnalyticsSetting : SecurityMLAnalyticsSettingData, IJsonModel<SecurityMLAnalyticsSettingData>
    {
        ...
        {
            return (SecurityMLAnalyticsSettingData)PersistableModelCreateCore(data, options);
        }
        ...
        {
            return (SecurityMLAnalyticsSettingData)JsonModelCreateCore(ref reader, options);
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownSecurityMLAnalyticsSetting DeserializeUnknownSecurityMLAnalyticsSetting(JsonElement element, ModelReaderWriterOptions options)
        {
