...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    internal partial class UnknownSecurityMLAnalyticsSetting : SecurityMLAnalyticsSettingData, IJsonModel<SecurityMLAnalyticsSettingData>
    {
        ...
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        SecurityMLAnalyticsSettingData IPersistableModel<SecurityMLAnalyticsSettingData>.Create(BinaryData data, ModelReaderWriterOptions options) => (UnknownSecurityMLAnalyticsSetting)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        SecurityMLAnalyticsSettingData IJsonModel<SecurityMLAnalyticsSettingData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (UnknownSecurityMLAnalyticsSetting)JsonModelCreateCore(ref reader, options);
