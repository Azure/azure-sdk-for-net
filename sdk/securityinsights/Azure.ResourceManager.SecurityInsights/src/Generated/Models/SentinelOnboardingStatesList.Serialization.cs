...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SentinelOnboardingStatesList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SentinelOnboardingStatesList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SentinelOnboardingStatesList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SentinelOnboardingStatesList>)} interface");
            }
        ...
        string IPersistableModel<SentinelOnboardingStatesList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
