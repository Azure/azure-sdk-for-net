...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    internal partial class AutomationRulesList : IUtf8JsonSerializable, IJsonModel<AutomationRulesList>
    {
        ...
        void IJsonModel<AutomationRulesList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(AutomationRulesList)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<AutomationRulesList>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(AutomationRulesList)} does not support '{options.Format}' format.");
            }
        }
