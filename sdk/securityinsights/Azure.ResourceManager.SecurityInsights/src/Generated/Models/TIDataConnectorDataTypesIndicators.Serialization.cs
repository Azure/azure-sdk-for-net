...
{
    internal partial class TIDataConnectorDataTypesIndicators : Core.IUtf8JsonSerializable
    {
        ...
        internal static TIDataConnectorDataTypesIndicators DeserializeTIDataConnectorDataTypesIndicators(JsonElement element)
        {
            ...
            return new TIDataConnectorDataTypesIndicators(Core.Optional.ToNullable(state));
        }
    }
}
