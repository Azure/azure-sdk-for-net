...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TIDataConnectorDataTypesIndicators>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        TIDataConnectorDataTypesIndicators IJsonModel<TIDataConnectorDataTypesIndicators>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<TIDataConnectorDataTypesIndicators>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        TIDataConnectorDataTypesIndicators IModel<TIDataConnectorDataTypesIndicators>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<TIDataConnectorDataTypesIndicators>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
