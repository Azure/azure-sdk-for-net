...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TIDataConnectorDataTypesIndicators>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<TIDataConnectorDataTypesIndicators>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<TIDataConnectorDataTypesIndicators>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<TIDataConnectorDataTypesIndicators>)} interface");
            }
        ...
        string IPersistableModel<TIDataConnectorDataTypesIndicators>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
