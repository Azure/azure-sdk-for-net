...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    public partial class SourceControlOperationWarningBody
    {
        ...
        internal SourceControlOperationWarningBody(SourceControlOperationWarningCode? code, string message, IReadOnlyList<SourceControlOperationWarningBody> details, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Code = code;
            Message = message;
            Details = details;
