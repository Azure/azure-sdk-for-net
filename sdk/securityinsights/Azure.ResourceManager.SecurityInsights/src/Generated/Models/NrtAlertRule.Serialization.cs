...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    public partial class NrtAlertRule : SecurityInsightsAlertRuleData, IJsonModel<NrtAlertRule>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<NrtAlertRule>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<NrtAlertRule>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        NrtAlertRule IPersistableModel<NrtAlertRule>.Create(BinaryData data, ModelReaderWriterOptions options) => (NrtAlertRule)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        NrtAlertRule IJsonModel<NrtAlertRule>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (NrtAlertRule)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static NrtAlertRule DeserializeNrtAlertRule(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            string eTag = default;
            NrtAlertRuleProperties properties = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = NrtAlertRuleProperties.DeserializeNrtAlertRuleProperties(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
