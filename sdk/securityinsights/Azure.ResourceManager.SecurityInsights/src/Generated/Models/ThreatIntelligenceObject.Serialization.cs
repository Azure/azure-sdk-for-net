...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    public partial class ThreatIntelligenceObject : IUtf8JsonSerializable, IJsonModel<ThreatIntelligenceObject>
    {
        ...
        internal static ThreatIntelligenceObject DeserializeThreatIntelligenceObject(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            if (element.TryGetProperty("kind", out JsonElement discriminator))
            {
                ...
                {
                    case "AttackPattern": return ThreatIntelligenceAttackPattern.DeserializeThreatIntelligenceAttackPattern(element, options);
                    case "Identity": return ThreatIntelligenceIdentity.DeserializeThreatIntelligenceIdentity(element, options);
                    case "Indicator": return ThreatIntelligenceIndicator.DeserializeThreatIntelligenceIndicator(element, options);
                    case "Relationship": return ThreatIntelligenceRelationship.DeserializeThreatIntelligenceRelationship(element, options);
                    case "ThreatActor": return ThreatIntelligenceThreatActor.DeserializeThreatIntelligenceThreatActor(element, options);
                }
            }
