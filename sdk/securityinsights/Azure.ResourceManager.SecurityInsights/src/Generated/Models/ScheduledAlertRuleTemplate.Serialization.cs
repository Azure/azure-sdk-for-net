...
{
    public partial class ScheduledAlertRuleTemplate : IUtf8JsonSerializable, IJsonModel<ScheduledAlertRuleTemplate>, IPersistableModel<ScheduledAlertRuleTemplate>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(CreatedDateUTC))
            {
                ...
                builder.AppendLine($" '{CreatedDateUTC.Value.ToString()}'");
            }

            if (Optional.IsDefined(LastUpdatedDateUTC))
            {
                builder.Append("  lastUpdatedDateUTC:");
                builder.AppendLine($" '{LastUpdatedDateUTC.Value.ToString()}'");
            }
