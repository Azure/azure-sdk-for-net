...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SecurityInsightsPropertyConditionProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SecurityInsightsPropertyConditionProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SecurityInsightsPropertyConditionProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<SecurityInsightsPropertyConditionProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
