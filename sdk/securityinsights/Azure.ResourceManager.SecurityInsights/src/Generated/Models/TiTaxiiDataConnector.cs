...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    public partial class TiTaxiiDataConnector : DataConnectorData
    {
        ...
        internal TiTaxiiDataConnector(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, DataConnectorKind kind, ETag? etag, Guid? tenantId, string workspaceId, string friendlyName, string taxiiServer, string collectionId, string userName, string password, DateTimeOffset? taxiiLookbackPeriod, PollingFrequency? pollingFrequency, TiTaxiiDataConnectorDataTypesTaxiiClient taxiiClient) : base(id, name, resourceType, systemData, kind, etag)
        {
            TenantId = tenantId;
        ...
        public DataTypeState? TaxiiClientState
        {
            get => TaxiiClient is null ? default(DataTypeState?) : TaxiiClient.State;
            set
            {
