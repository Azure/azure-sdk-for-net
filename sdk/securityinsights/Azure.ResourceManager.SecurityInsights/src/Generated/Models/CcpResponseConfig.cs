...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    public partial class CcpResponseConfig
    {
        ...
        /// <param name="convertChildPropertiesToArray"> The a value indicating whether the response isn't an array of events / logs.  By setting this flag to true it means the remote server will response with an object which each property has as a value an array of events / logs. </param>
