...
{
    public partial class TiObjectKindAttackPattern : IUtf8JsonSerializable, IJsonModel<TiObjectKindAttackPattern>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TiObjectKindAttackPattern>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<TiObjectKindAttackPattern>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<TiObjectKindAttackPattern>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(TiObjectKindAttackPattern)} does not support writing '{format}' format.");
            }
        ...
        TiObjectKindAttackPattern IJsonModel<TiObjectKindAttackPattern>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<TiObjectKindAttackPattern>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(TiObjectKindAttackPattern)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeTiObjectKindAttackPattern(document.RootElement, options);
        }

        internal static TiObjectKindAttackPattern DeserializeTiObjectKindAttackPattern(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<TiObjectKindAttackPattern>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<TiObjectKindAttackPattern>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(TiObjectKindAttackPattern)} does not support writing '{options.Format}' format.");
            }
        }

        TiObjectKindAttackPattern IPersistableModel<TiObjectKindAttackPattern>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<TiObjectKindAttackPattern>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(TiObjectKindAttackPattern)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<TiObjectKindAttackPattern>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
