...
{
    public partial class Indicator : IUtf8JsonSerializable, IJsonModel<Indicator>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<Indicator>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<Indicator>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<Indicator>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(Indicator)} does not support writing '{format}' format.");
            }
        ...
        Indicator IJsonModel<Indicator>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<Indicator>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(Indicator)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeIndicator(document.RootElement, options);
        }

        internal static Indicator DeserializeIndicator(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<Indicator>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<Indicator>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(Indicator)} does not support writing '{options.Format}' format.");
            }
        }

        Indicator IPersistableModel<Indicator>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<Indicator>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(Indicator)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<Indicator>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
