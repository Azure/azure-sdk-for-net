...
{
    public partial class TiObjectKindIndicator : IUtf8JsonSerializable, IJsonModel<TiObjectKindIndicator>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TiObjectKindIndicator>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<TiObjectKindIndicator>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<TiObjectKindIndicator>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(TiObjectKindIndicator)} does not support writing '{format}' format.");
            }
        ...
        TiObjectKindIndicator IJsonModel<TiObjectKindIndicator>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<TiObjectKindIndicator>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(TiObjectKindIndicator)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeTiObjectKindIndicator(document.RootElement, options);
        }

        internal static TiObjectKindIndicator DeserializeTiObjectKindIndicator(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<TiObjectKindIndicator>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<TiObjectKindIndicator>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(TiObjectKindIndicator)} does not support writing '{options.Format}' format.");
            }
        }

        TiObjectKindIndicator IPersistableModel<TiObjectKindIndicator>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<TiObjectKindIndicator>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(TiObjectKindIndicator)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<TiObjectKindIndicator>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
