...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    public partial class EntityGetInsightsContent
    {
        ...
        internal EntityGetInsightsContent(DateTimeOffset startOn, DateTimeOffset endOn, bool? addDefaultExtendedTimeRange, IList<Guid> insightQueryIds, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            StartOn = startOn;
            EndOn = endOn;
