...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    internal partial class MDATPDataConnectorProperties
    {
        ...
        /// <summary> Initializes a new instance of <see cref="MDATPDataConnectorProperties"/>. </summary>
        /// <param name="tenantId"> The tenant id to connect to, and get the data from. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="tenantId"/> is null. </exception>
        public MDATPDataConnectorProperties(string tenantId)
        {
        ...
        internal MDATPDataConnectorProperties(string tenantId, SecurityInsightsAlertsDataTypeOfDataConnector dataTypes, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            TenantId = tenantId;
            DataTypes = dataTypes;
