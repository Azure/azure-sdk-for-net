...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AutomationRulePropertyArrayChangedValuesCondition>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<AutomationRulePropertyArrayChangedValuesCondition>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AutomationRulePropertyArrayChangedValuesCondition>)} interface");
            }
        ...
        string IPersistableModel<AutomationRulePropertyArrayChangedValuesCondition>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
