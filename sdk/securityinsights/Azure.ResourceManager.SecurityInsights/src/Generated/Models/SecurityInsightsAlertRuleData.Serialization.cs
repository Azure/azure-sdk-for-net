...
{
    public partial class SecurityInsightsAlertRuleData : Core.IUtf8JsonSerializable
    {
        ...
        internal static SecurityInsightsAlertRuleData DeserializeSecurityInsightsAlertRuleData(JsonElement element)
        {
            ...
            return new SecurityInsightsAlertRuleData(id, name, type, systemData.Value, kind, Core.Optional.ToNullable(etag));
        }
    }
}
