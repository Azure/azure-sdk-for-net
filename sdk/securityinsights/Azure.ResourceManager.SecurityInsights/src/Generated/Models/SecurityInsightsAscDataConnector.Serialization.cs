...
{
    public partial class SecurityInsightsAscDataConnector : IUtf8JsonSerializable, IJsonModel<SecurityInsightsAscDataConnector>, IPersistableModel<SecurityInsightsAscDataConnector>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(DataTypes))
            {
                ...
                AppendChildObject(builder, DataTypes, options, 2);
            }
