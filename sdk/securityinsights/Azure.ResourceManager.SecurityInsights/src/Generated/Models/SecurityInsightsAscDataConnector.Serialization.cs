...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    public partial class SecurityInsightsAscDataConnector : SecurityInsightsDataConnectorData, IJsonModel<SecurityInsightsAscDataConnector>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<SecurityInsightsAscDataConnector>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<SecurityInsightsAscDataConnector>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        SecurityInsightsAscDataConnector IPersistableModel<SecurityInsightsAscDataConnector>.Create(BinaryData data, ModelReaderWriterOptions options) => (SecurityInsightsAscDataConnector)PersistableModelCreateCore(data, options);

        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<SecurityInsightsAscDataConnector>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        SecurityInsightsAscDataConnector IJsonModel<SecurityInsightsAscDataConnector>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (SecurityInsightsAscDataConnector)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static SecurityInsightsAscDataConnector DeserializeSecurityInsightsAscDataConnector(JsonElement element, ModelReaderWriterOptions options)
        {
