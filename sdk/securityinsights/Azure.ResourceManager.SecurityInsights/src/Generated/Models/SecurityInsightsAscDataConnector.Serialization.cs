...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SecurityInsightsAscDataConnector>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SecurityInsightsAscDataConnector>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SecurityInsightsAscDataConnector>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SecurityInsightsAscDataConnector>)} interface");
            }
        ...
        SecurityInsightsAscDataConnector IJsonModel<SecurityInsightsAscDataConnector>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        SecurityInsightsAscDataConnector IPersistableModel<SecurityInsightsAscDataConnector>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == "J" || options.Format == "W";
            if (!isValid)
            {
        ...
        string IPersistableModel<SecurityInsightsAscDataConnector>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
