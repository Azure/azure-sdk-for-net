...
{
    public partial class SecurityInsightsAscDataConnector : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static SecurityInsightsAscDataConnector DeserializeSecurityInsightsAscDataConnector(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
