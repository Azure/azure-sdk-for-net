...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    public partial class EnrichmentDomainWhois
    {
        ...
        internal EnrichmentDomainWhois(string domain, string server, DateTimeOffset? created, DateTimeOffset? updated, DateTimeOffset? expires, EnrichmentDomainWhoisDetails parsedWhois, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Domain = domain;
            Server = server;
            Created = created;
