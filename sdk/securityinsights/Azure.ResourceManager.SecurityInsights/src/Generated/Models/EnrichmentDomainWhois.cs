...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    public partial class EnrichmentDomainWhois
    {
        ...
        internal EnrichmentDomainWhois(string domain, string server, DateTimeOffset? createdOn, DateTimeOffset? updatedOn, DateTimeOffset? expireOn, EnrichmentDomainWhoisDetails parsedWhois, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Domain = domain;
            Server = server;
            CreatedOn = createdOn;
