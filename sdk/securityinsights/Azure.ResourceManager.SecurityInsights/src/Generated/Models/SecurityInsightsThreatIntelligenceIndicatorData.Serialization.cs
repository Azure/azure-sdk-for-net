...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SecurityInsightsThreatIntelligenceIndicatorData>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<SecurityInsightsThreatIntelligenceIndicatorData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SecurityInsightsThreatIntelligenceIndicatorData>)} interface");
            }
        ...
        string IPersistableModel<SecurityInsightsThreatIntelligenceIndicatorData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
