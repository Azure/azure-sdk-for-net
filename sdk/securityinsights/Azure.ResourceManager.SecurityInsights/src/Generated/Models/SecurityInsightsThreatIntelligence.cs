...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    public partial class SecurityInsightsThreatIntelligence
    {
        ...
        internal SecurityInsightsThreatIntelligence(double? confidence, string providerName, string reportLink, string threatDescription, string threatName, string threatType, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
