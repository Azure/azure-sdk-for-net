...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    public partial class MetadataDependencies
    {
        ...
        internal MetadataDependencies(string contentId, SecurityInsightsKind? kind, string version, string name, Operator? @operator, IList<MetadataDependencies> criteria)
        {
            ContentId = contentId;
            Kind = kind;
            Version = version;
