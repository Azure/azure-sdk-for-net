...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    public partial class MetadataDependencies
    {
        ...
        internal MetadataDependencies(string contentId, SecurityInsightsKind? kind, string version, string name, ThreatIntelligenceQueryOperator? @operator, IList<MetadataDependencies> criteria, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            ContentId = contentId;
            Kind = kind;
            Version = version;
