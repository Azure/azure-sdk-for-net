...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    public partial class ThreatIntelligenceFilteringCriteria : IJsonModel<ThreatIntelligenceFilteringCriteria>
    {
        ...
        internal static RequestContent ToRequestContent(ThreatIntelligenceFilteringCriteria threatIntelligenceFilteringCriteria)
        {
            ...
            return RequestContent.Create(threatIntelligenceFilteringCriteria, ModelSerializationExtensions.WireOptions);
        }
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(MinValidUntil))
            {
                ...
                writer.WriteStringValue(MinValidUntil.Value);
            }
            if (Optional.IsDefined(MaxValidUntil))
            {
                writer.WritePropertyName("maxValidUntil"u8);
                writer.WriteStringValue(MaxValidUntil.Value);
            }
        ...
        internal static ThreatIntelligenceFilteringCriteria DeserializeThreatIntelligenceFilteringCriteria(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            bool? isIncludeDisabled = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("minValidUntil"u8))
                {
                    ...
                    minValidUntil = prop.Value.GetDateTimeOffset();
                    continue;
                }
                if (prop.NameEquals("maxValidUntil"u8))
                {
                    ...
                    maxValidUntil = prop.Value.GetDateTimeOffset();
                    continue;
                }
                if (prop.NameEquals("includeDisabled"u8))
                {
                    ...
                    isIncludeDisabled = prop.Value.GetBoolean();
                    continue;
                }
