...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    public partial class InsightQueryItemProperties : EntityQueryItemProperties
    {
        ...
        internal InsightQueryItemProperties(IList<EntityQueryItemPropertiesDataTypesItem> dataTypes, SecurityInsightsEntityType? inputEntityType, IList<IList<string>> requiredInputFieldsSets, BinaryData entitiesFilter, IDictionary<string, BinaryData> additionalBinaryDataProperties, string displayName, string description, string baseQuery, InsightQueryItemPropertiesTableQuery tableQuery, BinaryData chartQuery, InsightQueryItemPropertiesAdditionalQuery additionalQuery, InsightQueryItemPropertiesDefaultTimeRange defaultTimeRange, InsightQueryItemPropertiesReferenceTimeRange referenceTimeRange) : base(dataTypes, inputEntityType, requiredInputFieldsSets, entitiesFilter, additionalBinaryDataProperties)
        {
        ...
        public string BeforeRange
        {
            get
            {
                return ReferenceTimeRange is null ? default : ReferenceTimeRange.BeforeRange;
            }
        }
    }
}
