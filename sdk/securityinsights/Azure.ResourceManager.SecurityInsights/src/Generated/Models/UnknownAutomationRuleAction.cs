...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    internal partial class UnknownAutomationRuleAction : SecurityInsightsAutomationRuleAction
    {
        ...
        internal UnknownAutomationRuleAction(int order, ActionType actionType, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(order, actionType, serializedAdditionalRawData)
        {
