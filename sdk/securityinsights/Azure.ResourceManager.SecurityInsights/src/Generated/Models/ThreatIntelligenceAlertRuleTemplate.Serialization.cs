...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    public partial class ThreatIntelligenceAlertRuleTemplate : SecurityInsightsAlertRuleTemplateData, IJsonModel<ThreatIntelligenceAlertRuleTemplate>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<ThreatIntelligenceAlertRuleTemplate>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ThreatIntelligenceAlertRuleTemplate>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        ThreatIntelligenceAlertRuleTemplate IPersistableModel<ThreatIntelligenceAlertRuleTemplate>.Create(BinaryData data, ModelReaderWriterOptions options) => (ThreatIntelligenceAlertRuleTemplate)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ThreatIntelligenceAlertRuleTemplate IJsonModel<ThreatIntelligenceAlertRuleTemplate>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (ThreatIntelligenceAlertRuleTemplate)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static ThreatIntelligenceAlertRuleTemplate DeserializeThreatIntelligenceAlertRuleTemplate(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            ThreatIntelligenceAlertRuleTemplateProperties properties = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = ThreatIntelligenceAlertRuleTemplateProperties.DeserializeThreatIntelligenceAlertRuleTemplateProperties(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
