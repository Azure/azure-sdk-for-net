...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    public partial class SecurityInsightsFileHashEntity : IUtf8JsonSerializable, IModelJsonSerializable<SecurityInsightsFileHashEntity>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<SecurityInsightsFileHashEntity>(this, options.Format);
        ...
        internal static SecurityInsightsFileHashEntity DeserializeSecurityInsightsFileHashEntity(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new SecurityInsightsFileHashEntity(id, name, type, systemData.Value, kind, Optional.ToDictionary(additionalData), friendlyName.Value, Optional.ToNullable(algorithm), hashValue.Value, serializedAdditionalRawData);
        }
