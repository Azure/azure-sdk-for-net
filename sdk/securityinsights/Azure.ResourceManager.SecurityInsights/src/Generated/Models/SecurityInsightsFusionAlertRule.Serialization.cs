...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    public partial class SecurityInsightsFusionAlertRule : SecurityInsightsAlertRuleData, IJsonModel<SecurityInsightsFusionAlertRule>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<SecurityInsightsFusionAlertRule>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<SecurityInsightsFusionAlertRule>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        SecurityInsightsFusionAlertRule IPersistableModel<SecurityInsightsFusionAlertRule>.Create(BinaryData data, ModelReaderWriterOptions options) => (SecurityInsightsFusionAlertRule)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        SecurityInsightsFusionAlertRule IJsonModel<SecurityInsightsFusionAlertRule>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (SecurityInsightsFusionAlertRule)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static SecurityInsightsFusionAlertRule DeserializeSecurityInsightsFusionAlertRule(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            string eTag = default;
            FusionAlertRuleProperties properties = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = FusionAlertRuleProperties.DeserializeFusionAlertRuleProperties(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
