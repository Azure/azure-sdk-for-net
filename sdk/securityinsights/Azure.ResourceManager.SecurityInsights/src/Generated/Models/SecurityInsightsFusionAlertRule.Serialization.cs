...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SecurityInsightsFusionAlertRule>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SecurityInsightsFusionAlertRule>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SecurityInsightsFusionAlertRule>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SecurityInsightsFusionAlertRule>)} interface");
            }
        ...
        string IPersistableModel<SecurityInsightsFusionAlertRule>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
