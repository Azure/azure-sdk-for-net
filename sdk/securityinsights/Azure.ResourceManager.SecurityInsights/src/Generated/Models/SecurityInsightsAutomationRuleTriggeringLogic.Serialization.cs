...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SecurityInsightsAutomationRuleTriggeringLogic>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<SecurityInsightsAutomationRuleTriggeringLogic>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SecurityInsightsAutomationRuleTriggeringLogic>)} interface");
            }
        ...
        string IPersistableModel<SecurityInsightsAutomationRuleTriggeringLogic>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
