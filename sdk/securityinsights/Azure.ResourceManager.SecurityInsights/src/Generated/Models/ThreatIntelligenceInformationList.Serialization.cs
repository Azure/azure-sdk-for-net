...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    internal partial class ThreatIntelligenceInformationList : IUtf8JsonSerializable, IModelJsonSerializable<ThreatIntelligenceInformationList>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<ThreatIntelligenceInformationList>(this, options.Format);
            ...
            foreach (var item in Value)
            {
                ...
                {
                    ((IModelJsonSerializable<SecurityInsightsThreatIntelligenceIndicatorBaseData>)item).Serialize(writer, options);
                }
            }
        ...
        /// <summary> Converts a <see cref="ThreatIntelligenceInformationList"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="ThreatIntelligenceInformationList"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="ThreatIntelligenceInformationList"/>. </summary>
