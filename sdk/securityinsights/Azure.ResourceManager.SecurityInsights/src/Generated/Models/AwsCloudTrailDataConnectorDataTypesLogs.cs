...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    /// <summary>
    /// Logs data type.
    /// Serialized Name: AwsCloudTrailDataConnectorDataTypesLogs
    /// </summary>
    internal partial class AwsCloudTrailDataConnectorDataTypesLogs : DataConnectorDataTypeCommon
    {
        ...
        internal AwsCloudTrailDataConnectorDataTypesLogs(SecurityInsightsDataTypeConnectionState state, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(state, serializedAdditionalRawData)
        {
        }
