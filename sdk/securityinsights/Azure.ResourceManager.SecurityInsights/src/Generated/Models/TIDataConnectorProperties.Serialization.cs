        ...
        internal static TIDataConnectorProperties DeserializeTIDataConnectorProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("tipLookbackPeriod"u8))
                {
                    ...
                    tipLookbackPeriod = prop.Value.GetDateTimeOffset("O");
                    continue;
                }
            ...
            return new TIDataConnectorProperties(tenantId, additionalBinaryDataProperties, tipLookbackPeriod, dataTypes);
        }
    }
}
