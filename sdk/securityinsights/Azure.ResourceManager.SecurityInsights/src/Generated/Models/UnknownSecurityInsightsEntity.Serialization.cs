...
{
    internal partial class UnknownSecurityInsightsEntity : SecurityInsightsEntityData, IJsonModel<SecurityInsightsEntityData>
    {
        ...
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        SecurityInsightsEntityData IPersistableModel<SecurityInsightsEntityData>.Create(BinaryData data, ModelReaderWriterOptions options) => (UnknownSecurityInsightsEntity)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        SecurityInsightsEntityData IJsonModel<SecurityInsightsEntityData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (UnknownSecurityInsightsEntity)JsonModelCreateCore(ref reader, options);
