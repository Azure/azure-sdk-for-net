...
{
    internal partial class UnknownSecurityInsightsEntity : SecurityInsightsEntity, IJsonModel<SecurityInsightsEntity>
    {
        ...
        {
            return (SecurityInsightsEntity)PersistableModelCreateCore(data, options);
        }
        ...
        {
            return (SecurityInsightsEntity)JsonModelCreateCore(ref reader, options);
        }
