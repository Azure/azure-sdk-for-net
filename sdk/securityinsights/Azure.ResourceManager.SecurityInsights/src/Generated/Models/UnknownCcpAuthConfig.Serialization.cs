...
{
    internal partial class UnknownCcpAuthConfig : CcpAuthConfig, IJsonModel<CcpAuthConfig>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownCcpAuthConfig DeserializeUnknownCcpAuthConfig(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownCcpAuthConfig(@type, additionalBinaryDataProperties);
        }
    }
}
