...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    public partial class SecurityInsightsIncidentOwnerInfo
    {
        ...
        internal SecurityInsightsIncidentOwnerInfo(string email, string assignedTo, Guid? objectId, string userPrincipalName, SecurityInsightsIncidentOwnerType? ownerType, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Email = email;
