...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<WatchlistItemList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<WatchlistItemList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<WatchlistItemList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<WatchlistItemList>)} interface");
            }
        ...
        string IPersistableModel<WatchlistItemList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
