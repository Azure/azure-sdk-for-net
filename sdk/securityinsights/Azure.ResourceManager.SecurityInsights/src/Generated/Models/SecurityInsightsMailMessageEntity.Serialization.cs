...
{
    public partial class SecurityInsightsMailMessageEntity : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static SecurityInsightsMailMessageEntity DeserializeSecurityInsightsMailMessageEntity(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
