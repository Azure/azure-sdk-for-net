...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    public partial class SecurityInsightsMailMessageEntity : SecurityInsights.SecurityInsightsEntity, IJsonModel<SecurityInsightsMailMessageEntity>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<SecurityInsightsMailMessageEntity>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<SecurityInsightsMailMessageEntity>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        SecurityInsightsMailMessageEntity IPersistableModel<SecurityInsightsMailMessageEntity>.Create(BinaryData data, ModelReaderWriterOptions options) => (SecurityInsightsMailMessageEntity)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        SecurityInsightsMailMessageEntity IJsonModel<SecurityInsightsMailMessageEntity>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (SecurityInsightsMailMessageEntity)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static SecurityInsightsMailMessageEntity DeserializeSecurityInsightsMailMessageEntity(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            MailMessageEntityProperties properties = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = MailMessageEntityProperties.DeserializeMailMessageEntityProperties(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
