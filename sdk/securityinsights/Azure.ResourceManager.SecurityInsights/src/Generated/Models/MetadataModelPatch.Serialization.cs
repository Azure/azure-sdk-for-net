...
{
    public partial class MetadataModelPatch : IUtf8JsonSerializable, IJsonModel<MetadataModelPatch>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MetadataModelPatch>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<MetadataModelPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<MetadataModelPatch>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MetadataModelPatch)} does not support writing '{format}' format.");
            }
        ...
        MetadataModelPatch IJsonModel<MetadataModelPatch>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<MetadataModelPatch>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MetadataModelPatch)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeMetadataModelPatch(document.RootElement, options);
        }

        internal static MetadataModelPatch DeserializeMetadataModelPatch(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<MetadataModelPatch>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<MetadataModelPatch>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(MetadataModelPatch)} does not support writing '{options.Format}' format.");
            }
        }

        MetadataModelPatch IPersistableModel<MetadataModelPatch>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<MetadataModelPatch>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(MetadataModelPatch)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<MetadataModelPatch>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
