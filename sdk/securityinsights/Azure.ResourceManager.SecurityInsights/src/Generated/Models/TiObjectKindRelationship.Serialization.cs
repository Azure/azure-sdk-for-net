...
{
    public partial class TiObjectKindRelationship : IUtf8JsonSerializable, IJsonModel<TiObjectKindRelationship>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TiObjectKindRelationship>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<TiObjectKindRelationship>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<TiObjectKindRelationship>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(TiObjectKindRelationship)} does not support writing '{format}' format.");
            }
        ...
        TiObjectKindRelationship IJsonModel<TiObjectKindRelationship>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<TiObjectKindRelationship>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(TiObjectKindRelationship)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeTiObjectKindRelationship(document.RootElement, options);
        }

        internal static TiObjectKindRelationship DeserializeTiObjectKindRelationship(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<TiObjectKindRelationship>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<TiObjectKindRelationship>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(TiObjectKindRelationship)} does not support writing '{options.Format}' format.");
            }
        }

        TiObjectKindRelationship IPersistableModel<TiObjectKindRelationship>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<TiObjectKindRelationship>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(TiObjectKindRelationship)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<TiObjectKindRelationship>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
