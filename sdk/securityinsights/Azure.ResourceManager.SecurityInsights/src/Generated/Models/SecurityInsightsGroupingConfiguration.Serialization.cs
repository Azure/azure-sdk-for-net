...
{
    public partial class SecurityInsightsGroupingConfiguration : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static SecurityInsightsGroupingConfiguration DeserializeSecurityInsightsGroupingConfiguration(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
