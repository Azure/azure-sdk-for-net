...
{
    public partial class MLBehaviorAnalyticsAlertRule : IUtf8JsonSerializable, IJsonModel<MLBehaviorAnalyticsAlertRule>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MLBehaviorAnalyticsAlertRule>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<MLBehaviorAnalyticsAlertRule>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        MLBehaviorAnalyticsAlertRule IJsonModel<MLBehaviorAnalyticsAlertRule>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<MLBehaviorAnalyticsAlertRule>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static MLBehaviorAnalyticsAlertRule DeserializeMLBehaviorAnalyticsAlertRule(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<MLBehaviorAnalyticsAlertRule>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<MLBehaviorAnalyticsAlertRule>)this).GetFormatFromOptions(options) : options.Format;
        ...
        MLBehaviorAnalyticsAlertRule IPersistableModel<MLBehaviorAnalyticsAlertRule>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<MLBehaviorAnalyticsAlertRule>)this).GetFormatFromOptions(options) : options.Format;
