...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    public partial class RegistryKeyEntity : SecurityInsightsEntityData
    {
        ...
        internal RegistryKeyEntity(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, SecurityInsightsEntityKind kind, IReadOnlyDictionary<string, BinaryData> additionalData, string friendlyName, RegistryHive? hive, string key) : base(id, name, resourceType, systemData, kind)
        {
