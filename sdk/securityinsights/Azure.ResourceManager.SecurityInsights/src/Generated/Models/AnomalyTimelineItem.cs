...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    public partial class AnomalyTimelineItem : EntityTimelineItem
    {
        ...
        internal AnomalyTimelineItem(ResourceIdentifier azureResourceId, string displayName, DateTimeOffset endTimeUtc, DateTimeOffset startTimeUtc, DateTimeOffset generatedOn)
        {
        ...
        /// </param>
        internal AnomalyTimelineItem(EntityTimelineKind kind, IDictionary<string, BinaryData> serializedAdditionalRawData, ResourceIdentifier azureResourceId, string productName, string description, string displayName, DateTimeOffset endTimeUtc, DateTimeOffset startTimeUtc, DateTimeOffset generatedOn, string vendor, string intent, IReadOnlyList<string> techniques, IReadOnlyList<string> reasons) : base(kind, serializedAdditionalRawData)
        {
            AzureResourceId = azureResourceId;
