...
{
    public partial class SecurityInsightsIPEntity : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static SecurityInsightsIPEntity DeserializeSecurityInsightsIPEntity(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
