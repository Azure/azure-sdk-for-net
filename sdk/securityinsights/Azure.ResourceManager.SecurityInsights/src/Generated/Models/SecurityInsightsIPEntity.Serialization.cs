...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    public partial class SecurityInsightsIPEntity : SecurityInsights.SecurityInsightsEntity, IJsonModel<SecurityInsightsIPEntity>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<SecurityInsightsIPEntity>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<SecurityInsightsIPEntity>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        SecurityInsightsIPEntity IPersistableModel<SecurityInsightsIPEntity>.Create(BinaryData data, ModelReaderWriterOptions options) => (SecurityInsightsIPEntity)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        SecurityInsightsIPEntity IJsonModel<SecurityInsightsIPEntity>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (SecurityInsightsIPEntity)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static SecurityInsightsIPEntity DeserializeSecurityInsightsIPEntity(JsonElement element, ModelReaderWriterOptions options)
        {
