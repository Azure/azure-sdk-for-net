...
namespace Azure.ResourceManager.SecurityInsights
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SecurityInsightsIncidentRelationData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SecurityInsightsIncidentRelationData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SecurityInsightsIncidentRelationData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SecurityInsightsIncidentRelationData>)} interface");
            }
        ...
        string IPersistableModel<SecurityInsightsIncidentRelationData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
