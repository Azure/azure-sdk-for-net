...
{
    public partial class SecurityInsightsIncidentActionConfiguration : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static SecurityInsightsIncidentActionConfiguration DeserializeSecurityInsightsIncidentActionConfiguration(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
