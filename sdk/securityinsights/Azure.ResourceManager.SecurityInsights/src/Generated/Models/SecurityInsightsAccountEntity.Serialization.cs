...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SecurityInsightsAccountEntity>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SecurityInsightsAccountEntity>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SecurityInsightsAccountEntity>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<SecurityInsightsAccountEntity>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
