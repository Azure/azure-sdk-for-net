...
{
    public partial class SecurityInsightsAccountEntity : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static SecurityInsightsAccountEntity DeserializeSecurityInsightsAccountEntity(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
