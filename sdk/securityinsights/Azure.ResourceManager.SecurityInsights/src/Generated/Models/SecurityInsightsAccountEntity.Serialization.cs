...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    public partial class SecurityInsightsAccountEntity : SecurityInsights.SecurityInsightsEntity, IJsonModel<SecurityInsightsAccountEntity>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<SecurityInsightsAccountEntity>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<SecurityInsightsAccountEntity>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        SecurityInsightsAccountEntity IPersistableModel<SecurityInsightsAccountEntity>.Create(BinaryData data, ModelReaderWriterOptions options) => (SecurityInsightsAccountEntity)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        SecurityInsightsAccountEntity IJsonModel<SecurityInsightsAccountEntity>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (SecurityInsightsAccountEntity)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static SecurityInsightsAccountEntity DeserializeSecurityInsightsAccountEntity(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            AccountEntityProperties properties = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = AccountEntityProperties.DeserializeAccountEntityProperties(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
