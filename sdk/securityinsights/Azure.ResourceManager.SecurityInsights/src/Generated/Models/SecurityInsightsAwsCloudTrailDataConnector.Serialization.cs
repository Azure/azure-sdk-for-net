...
{
    public partial class SecurityInsightsAwsCloudTrailDataConnector : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static SecurityInsightsAwsCloudTrailDataConnector DeserializeSecurityInsightsAwsCloudTrailDataConnector(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
