...
{
    public partial class SecurityInsightsPropertyArrayChangedConditionProperties : IUtf8JsonSerializable, IJsonModel<SecurityInsightsPropertyArrayChangedConditionProperties>, IPersistableModel<SecurityInsightsPropertyArrayChangedConditionProperties>
    {
        ...
        void IJsonModel<SecurityInsightsPropertyArrayChangedConditionProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SecurityInsightsPropertyArrayChangedConditionProperties)} does not support '{format}' format.");
            }
