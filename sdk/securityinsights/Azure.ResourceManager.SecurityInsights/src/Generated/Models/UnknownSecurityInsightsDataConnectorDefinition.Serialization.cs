...
{
    internal partial class UnknownSecurityInsightsDataConnectorDefinition : SecurityInsightsDataConnectorDefinitionData, IJsonModel<SecurityInsightsDataConnectorDefinitionData>
    {
        /// <summary> Initializes a new instance of <see cref="UnknownSecurityInsightsDataConnectorDefinition"/> for deserialization. </summary>
        ...
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        SecurityInsightsDataConnectorDefinitionData IPersistableModel<SecurityInsightsDataConnectorDefinitionData>.Create(BinaryData data, ModelReaderWriterOptions options) => (UnknownSecurityInsightsDataConnectorDefinition)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        SecurityInsightsDataConnectorDefinitionData IJsonModel<SecurityInsightsDataConnectorDefinitionData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (UnknownSecurityInsightsDataConnectorDefinition)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownSecurityInsightsDataConnectorDefinition DeserializeUnknownSecurityInsightsDataConnectorDefinition(JsonElement element, ModelReaderWriterOptions options)
        {
