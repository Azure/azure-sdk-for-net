...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    public partial class NrtAlertRuleTemplate : SecurityInsightsAlertRuleTemplateData, IJsonModel<NrtAlertRuleTemplate>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<NrtAlertRuleTemplate>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<NrtAlertRuleTemplate>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        NrtAlertRuleTemplate IPersistableModel<NrtAlertRuleTemplate>.Create(BinaryData data, ModelReaderWriterOptions options) => (NrtAlertRuleTemplate)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        NrtAlertRuleTemplate IJsonModel<NrtAlertRuleTemplate>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (NrtAlertRuleTemplate)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static NrtAlertRuleTemplate DeserializeNrtAlertRuleTemplate(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            NrtAlertRuleTemplateProperties properties = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = NrtAlertRuleTemplateProperties.DeserializeNrtAlertRuleTemplateProperties(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
