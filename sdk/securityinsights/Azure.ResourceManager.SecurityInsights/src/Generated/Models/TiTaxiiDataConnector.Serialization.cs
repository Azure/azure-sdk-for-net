...
{
    public partial class TiTaxiiDataConnector : IUtf8JsonSerializable, IJsonModel<TiTaxiiDataConnector>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TiTaxiiDataConnector>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<TiTaxiiDataConnector>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<TiTaxiiDataConnector>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(TiTaxiiDataConnector)} does not support writing '{format}' format.");
            }
        ...
        TiTaxiiDataConnector IJsonModel<TiTaxiiDataConnector>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<TiTaxiiDataConnector>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(TiTaxiiDataConnector)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeTiTaxiiDataConnector(document.RootElement, options);
        }

        internal static TiTaxiiDataConnector DeserializeTiTaxiiDataConnector(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<TiTaxiiDataConnector>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<TiTaxiiDataConnector>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(TiTaxiiDataConnector)} does not support writing '{options.Format}' format.");
            }
        }

        TiTaxiiDataConnector IPersistableModel<TiTaxiiDataConnector>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<TiTaxiiDataConnector>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(TiTaxiiDataConnector)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<TiTaxiiDataConnector>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
