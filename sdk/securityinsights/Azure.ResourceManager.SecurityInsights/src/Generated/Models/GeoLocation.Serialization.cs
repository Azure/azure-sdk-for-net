...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    {
        internal static GeoLocation DeserializeGeoLocation(JsonElement element)
        {
            ...
            return new GeoLocation(Optional.ToNullable(asn), city.Value, countryCode.Value, countryName.Value, Optional.ToNullable(latitude), Optional.ToNullable(longitude), state.Value);
        }
    }
}
