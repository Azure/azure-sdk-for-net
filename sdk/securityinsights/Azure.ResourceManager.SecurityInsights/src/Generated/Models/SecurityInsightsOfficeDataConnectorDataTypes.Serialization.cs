...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SecurityInsightsOfficeDataConnectorDataTypes>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<SecurityInsightsOfficeDataConnectorDataTypes>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SecurityInsightsOfficeDataConnectorDataTypes>)} interface");
            }
        ...
        string IPersistableModel<SecurityInsightsOfficeDataConnectorDataTypes>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
