...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    public partial class MtpCheckRequirements : DataConnectorsCheckRequirements, IJsonModel<MtpCheckRequirements>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<MtpCheckRequirements>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<MtpCheckRequirements>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        MtpCheckRequirements IPersistableModel<MtpCheckRequirements>.Create(BinaryData data, ModelReaderWriterOptions options) => (MtpCheckRequirements)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        MtpCheckRequirements IJsonModel<MtpCheckRequirements>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (MtpCheckRequirements)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static MtpCheckRequirements DeserializeMtpCheckRequirements(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new MtpCheckRequirements(kind, additionalBinaryDataProperties, properties);
        }
    }
}
