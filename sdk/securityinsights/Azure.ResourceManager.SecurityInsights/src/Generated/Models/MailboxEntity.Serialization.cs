...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    public partial class MailboxEntity : IUtf8JsonSerializable
    {
        ...
        internal static MailboxEntity DeserializeMailboxEntity(JsonElement element)
        {
            ...
            return new MailboxEntity(id, name, type, systemData.Value, kind, Optional.ToDictionary(additionalData), friendlyName.Value, mailboxPrimaryAddress.Value, displayName.Value, upn.Value, Optional.ToNullable(externalDirectoryObjectId));
        }
    }
}
