...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IncidentAlertList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<IncidentAlertList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<IncidentAlertList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<IncidentAlertList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
