...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    public partial class Error
    {
        ...
        public Error(string memberResourceName, string errorMessage)
        {
        ...
        internal Error(string memberResourceName, string errorMessage, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            MemberResourceName = memberResourceName;
            ErrorMessage = errorMessage;
