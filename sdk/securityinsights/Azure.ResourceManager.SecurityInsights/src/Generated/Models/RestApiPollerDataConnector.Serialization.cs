...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    public partial class RestApiPollerDataConnector : SecurityInsightsDataConnectorData, IJsonModel<RestApiPollerDataConnector>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<RestApiPollerDataConnector>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<RestApiPollerDataConnector>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        RestApiPollerDataConnector IPersistableModel<RestApiPollerDataConnector>.Create(BinaryData data, ModelReaderWriterOptions options) => (RestApiPollerDataConnector)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        RestApiPollerDataConnector IJsonModel<RestApiPollerDataConnector>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (RestApiPollerDataConnector)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static RestApiPollerDataConnector DeserializeRestApiPollerDataConnector(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            string eTag = default;
            RestApiPollerDataConnectorProperties properties = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = RestApiPollerDataConnectorProperties.DeserializeRestApiPollerDataConnectorProperties(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
