...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    public partial class FusionTemplateSubTypeSeverityFilter : IJsonModel<FusionTemplateSubTypeSeverityFilter>
    {
        ...
        protected virtual FusionTemplateSubTypeSeverityFilter PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<FusionTemplateSubTypeSeverityFilter>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<FusionTemplateSubTypeSeverityFilter>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        FusionTemplateSubTypeSeverityFilter IPersistableModel<FusionTemplateSubTypeSeverityFilter>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(SeverityFilters))
            {
                ...
                foreach (SecurityInsightsAlertSeverity item in SeverityFilters)
                {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        FusionTemplateSubTypeSeverityFilter IJsonModel<FusionTemplateSubTypeSeverityFilter>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual FusionTemplateSubTypeSeverityFilter JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<FusionTemplateSubTypeSeverityFilter>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static FusionTemplateSubTypeSeverityFilter DeserializeFusionTemplateSubTypeSeverityFilter(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("severityFilters"u8))
                {
            ...
            return new FusionTemplateSubTypeSeverityFilter(isSupported, severityFilters ?? new ChangeTrackingList<SecurityInsightsAlertSeverity>(), additionalBinaryDataProperties);
        }
    }
}
