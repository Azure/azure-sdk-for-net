...
{
    public partial class SecurityInsightsAzureResourceEntity : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static SecurityInsightsAzureResourceEntity DeserializeSecurityInsightsAzureResourceEntity(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
