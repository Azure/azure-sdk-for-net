...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    public partial class CustomizableConnectorDefinitionData : SecurityInsightsDataConnectorDefinitionData, IJsonModel<CustomizableConnectorDefinitionData>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<CustomizableConnectorDefinitionData>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<CustomizableConnectorDefinitionData>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        CustomizableConnectorDefinitionData IPersistableModel<CustomizableConnectorDefinitionData>.Create(BinaryData data, ModelReaderWriterOptions options) => (CustomizableConnectorDefinitionData)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        CustomizableConnectorDefinitionData IJsonModel<CustomizableConnectorDefinitionData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (CustomizableConnectorDefinitionData)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static CustomizableConnectorDefinitionData DeserializeCustomizableConnectorDefinitionData(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            DataConnectorDefinitionKind kind = default;
            string eTag = default;
            CustomizableConnectorDefinitionProperties properties = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    kind = new DataConnectorDefinitionKind(prop.Value.GetString());
                    continue;
                }
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = CustomizableConnectorDefinitionProperties.DeserializeCustomizableConnectorDefinitionProperties(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
