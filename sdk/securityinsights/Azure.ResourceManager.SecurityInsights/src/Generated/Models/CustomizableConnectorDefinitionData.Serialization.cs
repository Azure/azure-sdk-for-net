    ...
    public partial class CustomizableConnectorDefinitionData : IUtf8JsonSerializable, IJsonModel<CustomizableConnectorDefinitionData>
    {
        ...
        internal static CustomizableConnectorDefinitionData DeserializeCustomizableConnectorDefinitionData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    kind = new DataConnectorDefinitionKind(property.Value.GetString());
                    continue;
                }
...
;
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(ConnectorUiConfig), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("    connectorUiConfig: ");
                builder.AppendLine(propertyOverride);
            }
            else
            {
                ...
                {
                    builder.Append("    connectorUiConfig: ");
                    BicepSerializationHelpers.AppendChildObject(builder, ConnectorUiConfig, options, 4, false, "    connectorUiConfig: ");
                }
            }

            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(ConnectionsConfig), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("    connectionsConfig: ");
                builder.AppendLine(propertyOverride);
            }
            else
            {
                ...
                {
                    builder.Append("    connectionsConfig: ");
                    BicepSerializationHelpers.AppendChildObject(builder, ConnectionsConfig, options, 4, false, "    connectionsConfig: ");
                }
            }
