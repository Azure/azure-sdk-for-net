...
{
    public partial class SecurityInsightsMailboxEntity : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static SecurityInsightsMailboxEntity DeserializeSecurityInsightsMailboxEntity(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
