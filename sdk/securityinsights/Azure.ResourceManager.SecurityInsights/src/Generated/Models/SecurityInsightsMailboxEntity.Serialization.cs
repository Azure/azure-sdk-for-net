...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    public partial class SecurityInsightsMailboxEntity : SecurityInsights.SecurityInsightsEntity, IJsonModel<SecurityInsightsMailboxEntity>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<SecurityInsightsMailboxEntity>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<SecurityInsightsMailboxEntity>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        SecurityInsightsMailboxEntity IPersistableModel<SecurityInsightsMailboxEntity>.Create(BinaryData data, ModelReaderWriterOptions options) => (SecurityInsightsMailboxEntity)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        SecurityInsightsMailboxEntity IJsonModel<SecurityInsightsMailboxEntity>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (SecurityInsightsMailboxEntity)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static SecurityInsightsMailboxEntity DeserializeSecurityInsightsMailboxEntity(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            MailboxEntityProperties properties = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = MailboxEntityProperties.DeserializeMailboxEntityProperties(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
