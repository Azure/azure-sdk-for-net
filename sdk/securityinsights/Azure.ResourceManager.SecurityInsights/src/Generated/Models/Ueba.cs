...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    public partial class Ueba : SettingData
    {
        ...
        internal Ueba(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, SettingKind kind, ETag? etag, IDictionary<string, BinaryData> serializedAdditionalRawData, IList<UebaDataSource> dataSources) : base(id, name, resourceType, systemData, kind, etag, serializedAdditionalRawData)
        {
