...
{
    public partial class SecurityInsightsAlert : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static SecurityInsightsAlert DeserializeSecurityInsightsAlert(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
