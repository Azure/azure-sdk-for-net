...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ThreatIntelligenceGranularMarkingEntity>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ThreatIntelligenceGranularMarkingEntity>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ThreatIntelligenceGranularMarkingEntity>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ThreatIntelligenceGranularMarkingEntity>)} interface");
            }
        ...
        string IPersistableModel<ThreatIntelligenceGranularMarkingEntity>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
