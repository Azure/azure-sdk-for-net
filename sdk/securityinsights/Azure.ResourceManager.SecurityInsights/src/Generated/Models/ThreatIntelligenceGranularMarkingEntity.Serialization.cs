...
{
    public partial class ThreatIntelligenceGranularMarkingEntity : IUtf8JsonSerializable, IJsonModel<ThreatIntelligenceGranularMarkingEntity>, IPersistableModel<ThreatIntelligenceGranularMarkingEntity>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(MarkingRef))
            {
                ...
                builder.AppendLine($" '{MarkingRef.Value.ToString()}'");
            }
