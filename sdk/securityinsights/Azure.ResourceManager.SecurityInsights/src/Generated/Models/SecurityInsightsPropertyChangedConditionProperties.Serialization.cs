...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SecurityInsightsPropertyChangedConditionProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<SecurityInsightsPropertyChangedConditionProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<SecurityInsightsPropertyChangedConditionProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
