...
{
    public partial class SecurityInsightsPropertyChangedConditionProperties : IUtf8JsonSerializable, IJsonModel<SecurityInsightsPropertyChangedConditionProperties>, IPersistableModel<SecurityInsightsPropertyChangedConditionProperties>
    {
        ...
        void IJsonModel<SecurityInsightsPropertyChangedConditionProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SecurityInsightsPropertyChangedConditionProperties)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ConditionProperties))
            {
                ...
                AppendChildObject(builder, ConditionProperties, options, 2);
            }
