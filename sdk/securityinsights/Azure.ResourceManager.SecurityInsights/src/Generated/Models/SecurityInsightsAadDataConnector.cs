...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    public partial class SecurityInsightsAadDataConnector : SecurityInsightsDataConnectorData
    {
        ...
        public SecurityInsightsAadDataConnector() : base(DataConnectorKind.AzureActiveDirectory)
        {
        }
        ...
        /// <param name="properties"> AADIP (Azure Active Directory Identity Protection) data connector properties. </param>
        internal SecurityInsightsAadDataConnector(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, DataConnectorKind kind, string eTag, AADDataConnectorProperties properties) : base(id, name, resourceType, systemData, additionalBinaryDataProperties, kind, eTag)
        {
            Properties = properties;
        }

        /// <summary> AADIP (Azure Active Directory Identity Protection) data connector properties. </summary>
        internal AADDataConnectorProperties Properties { get; set; }
