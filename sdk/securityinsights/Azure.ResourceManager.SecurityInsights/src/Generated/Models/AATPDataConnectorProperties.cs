...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    internal partial class AATPDataConnectorProperties
    {
        ...
        public AATPDataConnectorProperties(Guid tenantId)
        {
            TenantId = tenantId;
        }
        ...
        internal AATPDataConnectorProperties(Guid tenantId, SecurityInsightsAlertsDataTypeOfDataConnector dataTypes, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            TenantId = tenantId;
            DataTypes = dataTypes;
