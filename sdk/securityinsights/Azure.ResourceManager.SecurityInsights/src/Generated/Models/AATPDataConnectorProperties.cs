...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    internal partial class AATPDataConnectorProperties
    {
        ...
        /// <summary> Initializes a new instance of <see cref="AATPDataConnectorProperties"/>. </summary>
        /// <param name="tenantId"> The tenant id to connect to, and get the data from. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="tenantId"/> is null. </exception>
        public AATPDataConnectorProperties(string tenantId)
        {
        ...
        internal AATPDataConnectorProperties(string tenantId, SecurityInsightsAlertsDataTypeOfDataConnector dataTypes, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            TenantId = tenantId;
            DataTypes = dataTypes;
