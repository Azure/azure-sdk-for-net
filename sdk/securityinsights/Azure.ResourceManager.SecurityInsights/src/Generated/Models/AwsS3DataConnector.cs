...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    public partial class AwsS3DataConnector : DataConnectorData
    {
        ...
        internal AwsS3DataConnector(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, DataConnectorKind kind, ETag? etag, string destinationTable, IList<string> sqsUrls, string roleArn, AwsS3DataConnectorDataTypesLogs logs) : base(id, name, resourceType, systemData, kind, etag)
        {
