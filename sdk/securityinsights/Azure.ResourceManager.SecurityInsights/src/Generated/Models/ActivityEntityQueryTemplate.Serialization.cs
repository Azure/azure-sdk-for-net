...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    public partial class ActivityEntityQueryTemplate : SecurityInsightsEntityQueryTemplateData, IJsonModel<ActivityEntityQueryTemplate>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<ActivityEntityQueryTemplate>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ActivityEntityQueryTemplate>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        ActivityEntityQueryTemplate IPersistableModel<ActivityEntityQueryTemplate>.Create(BinaryData data, ModelReaderWriterOptions options) => (ActivityEntityQueryTemplate)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ActivityEntityQueryTemplate IJsonModel<ActivityEntityQueryTemplate>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (ActivityEntityQueryTemplate)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static ActivityEntityQueryTemplate DeserializeActivityEntityQueryTemplate(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            ActivityEntityQueryTemplateProperties properties = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = ActivityEntityQueryTemplateProperties.DeserializeActivityEntityQueryTemplateProperties(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
