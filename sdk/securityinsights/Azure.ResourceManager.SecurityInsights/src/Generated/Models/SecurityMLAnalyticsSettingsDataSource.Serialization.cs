...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SecurityMLAnalyticsSettingsDataSource>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SecurityMLAnalyticsSettingsDataSource>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SecurityMLAnalyticsSettingsDataSource>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SecurityMLAnalyticsSettingsDataSource>)} interface");
            }
        ...
        string IPersistableModel<SecurityMLAnalyticsSettingsDataSource>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
