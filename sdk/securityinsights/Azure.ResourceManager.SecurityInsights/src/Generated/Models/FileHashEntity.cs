...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    public partial class FileHashEntity : SecurityInsightsEntityData
    {
        ...
        internal FileHashEntity(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, SecurityInsightsEntityKind kind, IReadOnlyDictionary<string, BinaryData> additionalData, string friendlyName, FileHashAlgorithm? algorithm, string hashValue) : base(id, name, resourceType, systemData, kind)
        {
