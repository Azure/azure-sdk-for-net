...
{
    internal partial class UnknownDataConnectorsCheckRequirements : DataConnectorsCheckRequirements, IJsonModel<DataConnectorsCheckRequirements>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownDataConnectorsCheckRequirements DeserializeUnknownDataConnectorsCheckRequirements(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownDataConnectorsCheckRequirements(kind, additionalBinaryDataProperties);
        }
    }
}
