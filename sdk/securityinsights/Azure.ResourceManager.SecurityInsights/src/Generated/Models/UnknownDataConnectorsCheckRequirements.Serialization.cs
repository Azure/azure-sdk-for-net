...
{
    internal partial class UnknownDataConnectorsCheckRequirements : IUtf8JsonSerializable, IJsonModel<DataConnectorsCheckRequirements>
    {
        ...
        internal static UnknownDataConnectorsCheckRequirements DeserializeUnknownDataConnectorsCheckRequirements(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new UnknownDataConnectorsCheckRequirements(kind, serializedAdditionalRawData);
        }
