...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    internal partial class UnknownAlertRuleTemplate : SecurityInsightsAlertRuleTemplateData
    {
        ...
        internal UnknownAlertRuleTemplate(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, AlertRuleKind kind) : base(id, name, resourceType, systemData, kind)
        {
            Kind = kind;
        }
    }
