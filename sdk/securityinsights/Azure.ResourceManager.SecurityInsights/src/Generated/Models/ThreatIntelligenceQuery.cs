...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    public partial class ThreatIntelligenceQuery
    {
        ...
        internal ThreatIntelligenceQuery(ThreatIntelligenceQueryCondition condition, ThreatIntelligenceQuerySortBy sortBy, int? maxPageSize, int? minPageSize, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Condition = condition;
            SortBy = sortBy;
