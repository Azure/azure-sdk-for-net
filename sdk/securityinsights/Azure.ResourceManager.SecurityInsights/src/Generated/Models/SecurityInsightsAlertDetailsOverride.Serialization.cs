...
{
    public partial class SecurityInsightsAlertDetailsOverride : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static SecurityInsightsAlertDetailsOverride DeserializeSecurityInsightsAlertDetailsOverride(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
