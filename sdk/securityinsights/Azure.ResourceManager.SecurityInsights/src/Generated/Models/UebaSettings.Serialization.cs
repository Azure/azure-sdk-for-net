...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    public partial class UebaSettings : SecurityInsightsSettingsData, IJsonModel<UebaSettings>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<UebaSettings>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<UebaSettings>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        UebaSettings IPersistableModel<UebaSettings>.Create(BinaryData data, ModelReaderWriterOptions options) => (UebaSettings)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        UebaSettings IJsonModel<UebaSettings>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (UebaSettings)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UebaSettings DeserializeUebaSettings(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            string eTag = default;
            UebaProperties properties = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = UebaProperties.DeserializeUebaProperties(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
