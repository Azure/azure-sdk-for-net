...
{
    public partial class SecurityInsightsWatchlistItemData : IUtf8JsonSerializable, IJsonModel<SecurityInsightsWatchlistItemData>, IPersistableModel<SecurityInsightsWatchlistItemData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ItemsKeyValue))
            {
                ...
                builder.AppendLine($" '{ItemsKeyValue.ToString()}'");
            }

            if (Optional.IsDefined(EntityMapping))
            {
                builder.Append("  entityMapping:");
                builder.AppendLine($" '{EntityMapping.ToString()}'");
            }
