...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    public partial class Dynamics365DataConnector : SecurityInsightsDataConnectorData
    {
        ...
        internal Dynamics365DataConnector(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, DataConnectorKind kind, ETag? eTag, IDictionary<string, BinaryData> additionalBinaryDataProperties, Dynamics365DataConnectorProperties properties) : base(id, name, resourceType, systemData, kind, eTag, additionalBinaryDataProperties)
        {
        ...
        [WirePath("properties.dataTypes.dynamics365CdsActivities.state")]
        public SecurityInsightsDataTypeConnectionState? DataTypesDynamics365CdsActivitiesState
        {
            get
            {
                return Properties is null ? (SecurityInsightsDataTypeConnectionState?)default : Properties.DataTypesDynamics365CdsActivitiesState;
            }
            set
            {
                if (value.HasValue)
