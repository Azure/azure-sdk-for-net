...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    public partial class SecurityInsightsIncidentEntitiesMetadata
    {
        ...
        internal SecurityInsightsIncidentEntitiesMetadata(int count, SecurityInsightsEntityKind entityKind, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Count = count;
            EntityKind = entityKind;
