...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IncidentList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<IncidentList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<IncidentList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<IncidentList>)} interface");
            }
        ...
        string IPersistableModel<IncidentList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
