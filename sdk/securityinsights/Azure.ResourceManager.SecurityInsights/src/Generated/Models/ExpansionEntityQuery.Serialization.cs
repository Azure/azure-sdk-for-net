...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    public partial class ExpansionEntityQuery : SecurityInsightsEntityQueryData, IJsonModel<ExpansionEntityQuery>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<ExpansionEntityQuery>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ExpansionEntityQuery>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        ExpansionEntityQuery IPersistableModel<ExpansionEntityQuery>.Create(BinaryData data, ModelReaderWriterOptions options) => (ExpansionEntityQuery)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ExpansionEntityQuery IJsonModel<ExpansionEntityQuery>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (ExpansionEntityQuery)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static ExpansionEntityQuery DeserializeExpansionEntityQuery(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            string eTag = default;
            ExpansionEntityQueriesProperties properties = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = ExpansionEntityQueriesProperties.DeserializeExpansionEntityQueriesProperties(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
