        ...
        internal static MetadataProperties DeserializeMetadataProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("source"u8))
                {
                    ...
                    source = SecurityInsightsMetadataSource.DeserializeSecurityInsightsMetadataSource(prop.Value, options);
                    continue;
                }
                if (prop.NameEquals("author"u8))
                {
                    ...
                    author = SecurityInsightsMetadataAuthor.DeserializeSecurityInsightsMetadataAuthor(prop.Value, options);
                    continue;
                }
                if (prop.NameEquals("support"u8))
                {
                    ...
                    support = SecurityInsightsMetadataSupport.DeserializeSecurityInsightsMetadataSupport(prop.Value, options);
                    continue;
                }
                if (prop.NameEquals("dependencies"u8))
                {
                    ...
                    dependencies = SecurityInsightsMetadataDependencies.DeserializeSecurityInsightsMetadataDependencies(prop.Value, options);
                    continue;
                }
                if (prop.NameEquals("categories"u8))
                {
                    ...
                    categories = SecurityInsightsMetadataCategories.DeserializeSecurityInsightsMetadataCategories(prop.Value, options);
                    continue;
                }
