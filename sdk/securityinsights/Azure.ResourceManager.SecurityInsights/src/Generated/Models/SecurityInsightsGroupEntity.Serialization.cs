...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    public partial class SecurityInsightsGroupEntity : IUtf8JsonSerializable, IModelJsonSerializable<SecurityInsightsGroupEntity>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<SecurityInsightsGroupEntity>(this, options.Format);
        ...
        internal static SecurityInsightsGroupEntity DeserializeSecurityInsightsGroupEntity(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new SecurityInsightsGroupEntity(id, name, type, systemData.Value, kind, Optional.ToDictionary(additionalData), friendlyName.Value, distinguishedName.Value, Optional.ToNullable(objectGuid), sid.Value, serializedAdditionalRawData);
        }
