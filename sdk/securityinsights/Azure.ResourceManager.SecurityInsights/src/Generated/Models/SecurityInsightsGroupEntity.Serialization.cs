...
{
    public partial class SecurityInsightsGroupEntity : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static SecurityInsightsGroupEntity DeserializeSecurityInsightsGroupEntity(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
