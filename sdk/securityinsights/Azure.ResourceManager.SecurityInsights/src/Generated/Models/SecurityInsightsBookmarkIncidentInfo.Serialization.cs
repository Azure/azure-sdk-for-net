...
{
    public partial class SecurityInsightsBookmarkIncidentInfo : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static SecurityInsightsBookmarkIncidentInfo DeserializeSecurityInsightsBookmarkIncidentInfo(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
