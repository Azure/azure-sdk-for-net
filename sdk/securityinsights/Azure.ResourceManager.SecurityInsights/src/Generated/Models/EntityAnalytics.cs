...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    public partial class EntityAnalytics : SecurityInsightsSettingData
    {
        ...
        internal EntityAnalytics(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, SettingKind kind, ETag? eTag, IDictionary<string, BinaryData> additionalBinaryDataProperties, EntityAnalyticsProperties properties) : base(id, name, resourceType, systemData, kind, eTag, additionalBinaryDataProperties)
        {
        ...
        public IList<EntityProvider> EntityProviders
        {
            get
            {
