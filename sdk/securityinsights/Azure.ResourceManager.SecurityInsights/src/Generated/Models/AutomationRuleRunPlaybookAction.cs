...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    public partial class AutomationRuleRunPlaybookAction : SecurityInsightsAutomationRuleAction
    {
        ...
        internal AutomationRuleRunPlaybookAction(int order, ActionType actionType, AutomationRuleRunPlaybookActionProperties actionConfiguration, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(order, actionType, serializedAdditionalRawData)
        {
