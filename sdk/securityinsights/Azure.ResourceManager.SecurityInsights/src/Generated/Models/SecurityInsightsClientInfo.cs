...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    public partial class SecurityInsightsClientInfo
    {
        ...
        internal SecurityInsightsClientInfo(string email, string name, Guid? objectId, string userPrincipalName, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Email = email;
            Name = name;
            ObjectId = objectId;
