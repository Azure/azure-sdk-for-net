...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AlertRulesList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AlertRulesList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AlertRulesList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AlertRulesList>)} interface");
            }
        ...
        string IPersistableModel<AlertRulesList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
