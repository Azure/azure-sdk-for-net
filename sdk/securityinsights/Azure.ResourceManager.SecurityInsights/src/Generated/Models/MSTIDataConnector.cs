...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    public partial class MSTIDataConnector : SecurityInsightsDataConnectorData
    {
        ...
        internal MSTIDataConnector(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, DataConnectorKind kind, string eTag, MSTIDataConnectorProperties properties) : base(id, name, resourceType, systemData, additionalBinaryDataProperties, kind, eTag)
        {
