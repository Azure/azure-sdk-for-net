...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    public partial class ActivityCustomEntityQuery : CustomEntityQuery
    {
        ...
        internal ActivityCustomEntityQuery(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, ETag? eTag, IDictionary<string, BinaryData> additionalBinaryDataProperties, CustomEntityQueryKind kind, ActivityEntityQueriesProperties properties) : base(id, name, resourceType, systemData, eTag, additionalBinaryDataProperties, kind)
        {
