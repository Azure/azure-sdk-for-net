...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    public partial class AutomationRuleModifyPropertiesAction : SecurityInsightsAutomationRuleAction
    {
        ...
        internal AutomationRuleModifyPropertiesAction(int order, ActionType actionType, SecurityInsightsIncidentActionConfiguration actionConfiguration, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(order, actionType, serializedAdditionalRawData)
        {
