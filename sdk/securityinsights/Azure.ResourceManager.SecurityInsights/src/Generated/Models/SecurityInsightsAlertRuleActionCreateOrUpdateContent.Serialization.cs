...
{
    public partial class SecurityInsightsAlertRuleActionCreateOrUpdateContent : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static SecurityInsightsAlertRuleActionCreateOrUpdateContent DeserializeSecurityInsightsAlertRuleActionCreateOrUpdateContent(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
