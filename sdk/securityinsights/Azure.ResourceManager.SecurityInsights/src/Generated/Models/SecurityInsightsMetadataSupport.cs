...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    public partial class SecurityInsightsMetadataSupport
    {
        ...
        internal SecurityInsightsMetadataSupport(SecurityInsightsSupportTier tier, string name, string email, string link, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Tier = tier;
            Name = name;
            Email = email;
