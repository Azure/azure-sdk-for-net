...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    public partial class ThreatIntelligenceGranularMarkingEntity
    {
        ...
        internal ThreatIntelligenceGranularMarkingEntity(string language, int? markingRef, IList<string> selectors, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Language = language;
