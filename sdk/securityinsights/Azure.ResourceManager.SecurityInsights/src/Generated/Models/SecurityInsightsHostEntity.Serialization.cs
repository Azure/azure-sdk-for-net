...
{
    public partial class SecurityInsightsHostEntity : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static SecurityInsightsHostEntity DeserializeSecurityInsightsHostEntity(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
