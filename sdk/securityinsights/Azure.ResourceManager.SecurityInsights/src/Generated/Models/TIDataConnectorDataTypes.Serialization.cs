...
{
    internal partial class TIDataConnectorDataTypes : IUtf8JsonSerializable, IJsonModel<TIDataConnectorDataTypes>, IPersistableModel<TIDataConnectorDataTypes>
    {
        ...
        void IJsonModel<TIDataConnectorDataTypes>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(TIDataConnectorDataTypes)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Indicators))
            {
                ...
                AppendChildObject(builder, Indicators, options, 2);
            }
