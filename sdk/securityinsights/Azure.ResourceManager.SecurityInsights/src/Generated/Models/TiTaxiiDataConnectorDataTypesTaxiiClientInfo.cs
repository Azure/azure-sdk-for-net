...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    public partial class TiTaxiiDataConnectorDataTypesTaxiiClientInfo : DataConnectorDataTypeCommon
    {
        ...
        public TiTaxiiDataConnectorDataTypesTaxiiClientInfo(SecurityInsightsDataTypeConnectionState state) : base(state)
        {
        }
        ...
        internal TiTaxiiDataConnectorDataTypesTaxiiClientInfo(SecurityInsightsDataTypeConnectionState state, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(state, additionalBinaryDataProperties)
        {
        }
    }
}
