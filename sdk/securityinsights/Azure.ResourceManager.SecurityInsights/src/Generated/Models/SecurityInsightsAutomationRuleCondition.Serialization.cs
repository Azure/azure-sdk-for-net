...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    public partial class SecurityInsightsAutomationRuleCondition : IUtf8JsonSerializable, IJsonModel<SecurityInsightsAutomationRuleCondition>, IPersistableModel<SecurityInsightsAutomationRuleCondition>
    {
        ...
        void IJsonModel<SecurityInsightsAutomationRuleCondition>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SecurityInsightsAutomationRuleCondition)} does not support '{format}' format.");
            }
