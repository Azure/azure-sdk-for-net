...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    public partial class ThreatIntelligenceThreatActor : ThreatIntelligenceObject, IJsonModel<ThreatIntelligenceThreatActor>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<ThreatIntelligenceThreatActor>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ThreatIntelligenceThreatActor>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        ThreatIntelligenceThreatActor IPersistableModel<ThreatIntelligenceThreatActor>.Create(BinaryData data, ModelReaderWriterOptions options) => (ThreatIntelligenceThreatActor)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ThreatIntelligenceThreatActor IJsonModel<ThreatIntelligenceThreatActor>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (ThreatIntelligenceThreatActor)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static ThreatIntelligenceThreatActor DeserializeThreatIntelligenceThreatActor(JsonElement element, ModelReaderWriterOptions options)
        {
