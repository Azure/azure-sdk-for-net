...
{
    internal partial class UnknownSecurityInsightsDataConnector : SecurityInsightsDataConnectorData, IJsonModel<SecurityInsightsDataConnectorData>
    {
        /// <summary> Initializes a new instance of <see cref="UnknownSecurityInsightsDataConnector"/> for deserialization. </summary>
        internal UnknownSecurityInsightsDataConnector()
        {
        }
        ...
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        SecurityInsightsDataConnectorData IPersistableModel<SecurityInsightsDataConnectorData>.Create(BinaryData data, ModelReaderWriterOptions options) => (UnknownSecurityInsightsDataConnector)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        SecurityInsightsDataConnectorData IJsonModel<SecurityInsightsDataConnectorData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (UnknownSecurityInsightsDataConnector)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownSecurityInsightsDataConnector DeserializeUnknownSecurityInsightsDataConnector(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownSecurityInsightsDataConnector(
                id,
                name,
                resourceType,
                systemData,
