...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    public partial class OfficePowerBIDataConnector : SecurityInsightsDataConnectorData
    {
        ...
        public OfficePowerBIDataConnector() : base(DataConnectorKind.OfficePowerBI)
        {
        }
        ...
        internal OfficePowerBIDataConnector(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, DataConnectorKind kind, string eTag, OfficePowerBIDataConnectorProperties properties) : base(id, name, resourceType, systemData, additionalBinaryDataProperties, kind, eTag)
        {
