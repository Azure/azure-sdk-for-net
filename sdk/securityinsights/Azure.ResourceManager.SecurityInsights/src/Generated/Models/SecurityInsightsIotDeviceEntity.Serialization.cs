...
{
    public partial class SecurityInsightsIotDeviceEntity : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static SecurityInsightsIotDeviceEntity DeserializeSecurityInsightsIotDeviceEntity(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
