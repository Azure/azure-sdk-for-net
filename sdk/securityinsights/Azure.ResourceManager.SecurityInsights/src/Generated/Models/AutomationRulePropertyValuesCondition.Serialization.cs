...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AutomationRulePropertyValuesCondition>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AutomationRulePropertyValuesCondition>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AutomationRulePropertyValuesCondition>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<AutomationRulePropertyValuesCondition>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
