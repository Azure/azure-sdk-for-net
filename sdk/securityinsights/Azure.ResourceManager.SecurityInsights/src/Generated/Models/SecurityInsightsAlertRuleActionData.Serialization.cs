...
namespace Azure.ResourceManager.SecurityInsights
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SecurityInsightsAlertRuleActionData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SecurityInsightsAlertRuleActionData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SecurityInsightsAlertRuleActionData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SecurityInsightsAlertRuleActionData>)} interface");
            }
        ...
        string IPersistableModel<SecurityInsightsAlertRuleActionData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
