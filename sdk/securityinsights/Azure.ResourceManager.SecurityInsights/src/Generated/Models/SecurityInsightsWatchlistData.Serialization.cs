...
{
    public partial class SecurityInsightsWatchlistData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static SecurityInsightsWatchlistData DeserializeSecurityInsightsWatchlistData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
