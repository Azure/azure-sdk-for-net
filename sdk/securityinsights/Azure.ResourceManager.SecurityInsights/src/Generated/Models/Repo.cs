...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    public partial class Repo
    {
        ...
        /// <summary> Initializes a new instance of <see cref="Repo"/>. </summary>
        internal Repo()
        {
        ...
        internal Repo(Uri uri, string fullName, long? installationId, IReadOnlyList<string> branches, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Uri = uri;
            FullName = fullName;
