...
{
    public partial class TiObjectKindIdentity : IUtf8JsonSerializable, IJsonModel<TiObjectKindIdentity>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TiObjectKindIdentity>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<TiObjectKindIdentity>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<TiObjectKindIdentity>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(TiObjectKindIdentity)} does not support writing '{format}' format.");
            }
        ...
        TiObjectKindIdentity IJsonModel<TiObjectKindIdentity>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<TiObjectKindIdentity>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(TiObjectKindIdentity)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeTiObjectKindIdentity(document.RootElement, options);
        }

        internal static TiObjectKindIdentity DeserializeTiObjectKindIdentity(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<TiObjectKindIdentity>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<TiObjectKindIdentity>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(TiObjectKindIdentity)} does not support writing '{options.Format}' format.");
            }
        }

        TiObjectKindIdentity IPersistableModel<TiObjectKindIdentity>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<TiObjectKindIdentity>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(TiObjectKindIdentity)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<TiObjectKindIdentity>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
