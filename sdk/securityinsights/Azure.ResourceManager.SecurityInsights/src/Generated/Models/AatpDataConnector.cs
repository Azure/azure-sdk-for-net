...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    public partial class AatpDataConnector : DataConnectorData
    {
        ...
        internal AatpDataConnector(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, DataConnectorKind kind, ETag? etag, Guid? tenantId, DataConnectorDataTypeCommon alerts) : base(id, name, resourceType, systemData, kind, etag)
        {
            TenantId = tenantId;
            Alerts = alerts;
            Kind = kind;
