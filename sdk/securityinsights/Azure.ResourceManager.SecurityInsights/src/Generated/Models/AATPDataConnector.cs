...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    public partial class AATPDataConnector : SecurityInsightsDataConnectorData
    {
        /// <summary> Initializes a new instance of <see cref="AATPDataConnector"/>. </summary>
        public AATPDataConnector() : base(DataConnectorKind.AzureAdvancedThreatProtection)
        {
        }
        ...
        internal AATPDataConnector(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, DataConnectorKind kind, string eTag, AATPDataConnectorProperties properties) : base(id, name, resourceType, systemData, additionalBinaryDataProperties, kind, eTag)
        {
