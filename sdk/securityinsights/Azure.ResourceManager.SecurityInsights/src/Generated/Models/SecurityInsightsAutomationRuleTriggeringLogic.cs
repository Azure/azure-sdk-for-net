...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    public partial class SecurityInsightsAutomationRuleTriggeringLogic
    {
        ...
        internal SecurityInsightsAutomationRuleTriggeringLogic(bool isEnabled, DateTimeOffset? expireOn, TriggersOn triggersOn, TriggersWhen triggersWhen, IList<SecurityInsightsAutomationRuleCondition> conditions, Dictionary<string, BinaryData> rawData)
        {
            IsEnabled = isEnabled;
            ExpireOn = expireOn;
            TriggersOn = triggersOn;
