...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AlertRuleTemplatesList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AlertRuleTemplatesList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AlertRuleTemplatesList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AlertRuleTemplatesList>)} interface");
            }
        ...
        string IPersistableModel<AlertRuleTemplatesList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
