...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ThreatIntelligenceKillChainPhase>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ThreatIntelligenceKillChainPhase>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ThreatIntelligenceKillChainPhase>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ThreatIntelligenceKillChainPhase>)} interface");
            }
        ...
        string IPersistableModel<ThreatIntelligenceKillChainPhase>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
