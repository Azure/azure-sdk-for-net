...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    internal partial class ThreatIntelligenceIndicatorProperties : EntityCommonProperties, IJsonModel<ThreatIntelligenceIndicatorProperties>
    {
        ...
        internal static ThreatIntelligenceIndicatorProperties DeserializeThreatIntelligenceIndicatorProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            bool? isDefanged = default;
            DateTimeOffset? externalLastUpdatedOn = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("defanged"u8))
                {
                    ...
                    isDefanged = prop.Value.GetBoolean();
                    continue;
                }
                if (prop.NameEquals("externalLastUpdatedTimeUtc"u8))
                {
                    ...
                    externalLastUpdatedOn = prop.Value.GetDateTimeOffset("O");
                    continue;
                }
                ...
                if (prop.NameEquals("revoked"u8))
                {
                    ...
                    isRevoked = prop.Value.GetBoolean();
                    continue;
                }
                ...
                if (prop.NameEquals("validFrom"u8))
                {
                    ...
                    validFrom = prop.Value.GetDateTimeOffset("O");
                    continue;
                }
