...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    internal partial class TimelineResultsMetadata : IJsonModel<TimelineResultsMetadata>
    {
        ...
        protected virtual TimelineResultsMetadata PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<TimelineResultsMetadata>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<TimelineResultsMetadata>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        TimelineResultsMetadata IPersistableModel<TimelineResultsMetadata>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            foreach (TimelineAggregation item in Aggregations)
            {
            ...
            if (Optional.IsCollectionDefined(Errors))
            {
                ...
                writer.WriteStartArray();
                foreach (TimelineError item in Errors)
                {
                    writer.WriteObjectValue(item, options);
                }
                writer.WriteEndArray();
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        TimelineResultsMetadata IJsonModel<TimelineResultsMetadata>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual TimelineResultsMetadata JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<TimelineResultsMetadata>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static TimelineResultsMetadata DeserializeTimelineResultsMetadata(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            IList<TimelineAggregation> aggregations = default;
            IList<TimelineError> errors = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("aggregations"u8))
                {
