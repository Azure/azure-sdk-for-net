...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    public partial class InsightQueryItem : EntityQueryItem
    {
        ...
        internal InsightQueryItem(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, EntityQueryKind kind, InsightQueryItemProperties properties) : base(id, name, resourceType, systemData, kind)
        {
