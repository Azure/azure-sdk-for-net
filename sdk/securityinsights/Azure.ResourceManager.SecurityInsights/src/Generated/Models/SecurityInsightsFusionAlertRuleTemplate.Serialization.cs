...
{
    public partial class SecurityInsightsFusionAlertRuleTemplate : IUtf8JsonSerializable, IJsonModel<SecurityInsightsFusionAlertRuleTemplate>, IPersistableModel<SecurityInsightsFusionAlertRuleTemplate>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(AlertRulesCreatedByTemplateCount))
            {
                ...
                builder.AppendLine($" '{AlertRulesCreatedByTemplateCount.Value.ToString()}'");
            }
