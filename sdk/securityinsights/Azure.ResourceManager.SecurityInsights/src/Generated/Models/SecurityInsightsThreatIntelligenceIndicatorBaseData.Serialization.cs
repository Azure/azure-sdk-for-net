...
namespace Azure.ResourceManager.SecurityInsights
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SecurityInsightsThreatIntelligenceIndicatorBaseData>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<SecurityInsightsThreatIntelligenceIndicatorBaseData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SecurityInsightsThreatIntelligenceIndicatorBaseData>)} interface");
            }
        ...
        string IPersistableModel<SecurityInsightsThreatIntelligenceIndicatorBaseData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
