...
{
    public partial class SecurityInsightsThreatIntelligenceIndicatorBaseData : Core.IUtf8JsonSerializable
    {
        ...
        internal static SecurityInsightsThreatIntelligenceIndicatorBaseData DeserializeSecurityInsightsThreatIntelligenceIndicatorBaseData(JsonElement element)
        {
            ...
            return new SecurityInsightsThreatIntelligenceIndicatorBaseData(id, name, type, systemData.Value, kind, Core.Optional.ToNullable(etag));
        }
    }
}
