...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    public partial class ActivityCustomEntityQuery : CustomEntityQuery, IJsonModel<ActivityCustomEntityQuery>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<ActivityCustomEntityQuery>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ActivityCustomEntityQuery>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        ActivityCustomEntityQuery IPersistableModel<ActivityCustomEntityQuery>.Create(BinaryData data, ModelReaderWriterOptions options) => (ActivityCustomEntityQuery)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ActivityCustomEntityQuery IJsonModel<ActivityCustomEntityQuery>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (ActivityCustomEntityQuery)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static ActivityCustomEntityQuery DeserializeActivityCustomEntityQuery(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    kind = new CustomEntityQueryKind(prop.Value.GetString());
                    continue;
                }
