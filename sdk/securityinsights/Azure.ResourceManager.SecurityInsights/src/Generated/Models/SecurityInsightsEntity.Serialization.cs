...
{
    public partial class SecurityInsightsEntity : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static SecurityInsightsEntity DeserializeSecurityInsightsEntity(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
