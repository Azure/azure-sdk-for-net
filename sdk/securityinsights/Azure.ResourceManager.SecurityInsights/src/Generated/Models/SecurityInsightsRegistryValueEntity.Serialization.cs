...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SecurityInsightsRegistryValueEntity>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SecurityInsightsRegistryValueEntity)} does not support writing '{format}' format.");
            }
        ...
        SecurityInsightsRegistryValueEntity IJsonModel<SecurityInsightsRegistryValueEntity>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SecurityInsightsRegistryValueEntity)} does not support reading '{format}' format.");
            }
...
;
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(KeyEntityId), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("    keyEntityId: ");
                builder.AppendLine(propertyOverride);
            }
            else
            {
                ...
                {
                    builder.Append("    keyEntityId: ");
                    if (KeyEntityId.Contains(Environment.NewLine))
                    {
                        builder.AppendLine("'''");
                        builder.AppendLine($"{KeyEntityId}'''");
                    }
                    else
                    {
                        builder.AppendLine($"'{KeyEntityId}'");
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(ValueData), out propertyOverride);
            if (hasPropertyOverride)
            {
            ...
            else
            {
                ...
                {
                    builder.Append("    valueData: ");
                    if (ValueData.Contains(Environment.NewLine))
                    {
                        builder.AppendLine("'''");
                        builder.AppendLine($"{ValueData}'''");
                    }
                    else
                    {
                        builder.AppendLine($"'{ValueData}'");
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(ValueName), out propertyOverride);
            if (hasPropertyOverride)
            {
            ...
            else
            {
                ...
                {
                    builder.Append("    valueName: ");
                    if (ValueName.Contains(Environment.NewLine))
                    {
                        builder.AppendLine("'''");
        ...
        BinaryData IPersistableModel<SecurityInsightsRegistryValueEntity>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SecurityInsightsRegistryValueEntity)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        SecurityInsightsRegistryValueEntity IPersistableModel<SecurityInsightsRegistryValueEntity>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SecurityInsightsRegistryValueEntity)} does not support reading '{options.Format}' format.");
            }
        }
