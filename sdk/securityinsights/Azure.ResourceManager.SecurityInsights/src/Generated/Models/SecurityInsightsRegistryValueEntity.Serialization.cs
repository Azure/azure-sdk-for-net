...
{
    public partial class SecurityInsightsRegistryValueEntity : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static SecurityInsightsRegistryValueEntity DeserializeSecurityInsightsRegistryValueEntity(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
