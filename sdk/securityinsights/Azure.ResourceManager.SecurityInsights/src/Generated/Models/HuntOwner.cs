...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    public partial class HuntOwner
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="HuntOwner"/>. </summary>
        public HuntOwner()
        {
        }
        ...
        internal HuntOwner(string email, string assignedTo, Guid? objectId, string userPrincipalName, SecurityInsightsIncidentOwnerType? ownerType, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Email = email;
