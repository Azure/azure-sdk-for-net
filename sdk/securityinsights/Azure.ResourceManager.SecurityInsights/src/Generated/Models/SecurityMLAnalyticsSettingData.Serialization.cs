...
{
    public partial class SecurityMLAnalyticsSettingData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static SecurityMLAnalyticsSettingData DeserializeSecurityMLAnalyticsSettingData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
