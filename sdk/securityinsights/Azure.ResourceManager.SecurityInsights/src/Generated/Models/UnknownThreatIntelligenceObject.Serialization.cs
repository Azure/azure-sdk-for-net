...
{
    internal partial class UnknownThreatIntelligenceObject : ThreatIntelligenceObject, IJsonModel<ThreatIntelligenceObject>
    {
        /// <summary> Initializes a new instance of <see cref="UnknownThreatIntelligenceObject"/> for deserialization. </summary>
        internal UnknownThreatIntelligenceObject()
        {
        }
        ...
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        ThreatIntelligenceObject IPersistableModel<ThreatIntelligenceObject>.Create(BinaryData data, ModelReaderWriterOptions options) => (UnknownThreatIntelligenceObject)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ThreatIntelligenceObject IJsonModel<ThreatIntelligenceObject>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (UnknownThreatIntelligenceObject)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownThreatIntelligenceObject DeserializeUnknownThreatIntelligenceObject(JsonElement element, ModelReaderWriterOptions options)
        {
