...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    {
        internal static ThreatIntelligenceMetric DeserializeThreatIntelligenceMetric(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
