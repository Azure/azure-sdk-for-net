...
{
    public partial class IoTDataConnector : IUtf8JsonSerializable
    {
        ...
        internal static IoTDataConnector DeserializeIoTDataConnector(JsonElement element)
        {
            ...
            return new IoTDataConnector(id, name, type, systemData.Value, kind, Optional.ToNullable(etag), alerts.Value, subscriptionId.Value);
        }
    }
}
