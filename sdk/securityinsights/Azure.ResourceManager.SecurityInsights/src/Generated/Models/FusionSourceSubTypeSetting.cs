...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    public partial class FusionSourceSubTypeSetting
    {
        ...
        internal FusionSourceSubTypeSetting(bool enabled, string sourceSubTypeName, string sourceSubTypeDisplayName, FusionSubTypeSeverityFilter severityFilters, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Enabled = enabled;
            SourceSubTypeName = sourceSubTypeName;
