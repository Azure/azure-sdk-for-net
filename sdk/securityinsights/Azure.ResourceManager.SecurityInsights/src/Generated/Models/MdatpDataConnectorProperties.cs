...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    internal partial class MdatpDataConnectorProperties
    {
        ...
        public MdatpDataConnectorProperties(Guid tenantId)
        {
            TenantId = tenantId;
        }
        ...
        internal MdatpDataConnectorProperties(Guid tenantId, SecurityInsightsAlertsDataTypeOfDataConnector dataTypes, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            TenantId = tenantId;
            DataTypes = dataTypes;
