...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    public partial class SecurityInsightsIPEntityGeoLocation
    {
        ...
        internal SecurityInsightsIPEntityGeoLocation(int? asn, string city, string countryCode, string countryName, double? latitude, double? longitude, string state, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Asn = asn;
            City = city;
