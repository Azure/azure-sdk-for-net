...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    public partial class ThreatIntelligenceExternalReference
    {
        ...
        internal ThreatIntelligenceExternalReference(string description, string externalId, string sourceName, Uri uri, IDictionary<string, string> hashes, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
