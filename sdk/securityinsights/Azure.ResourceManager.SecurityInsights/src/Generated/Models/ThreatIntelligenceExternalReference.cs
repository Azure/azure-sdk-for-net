...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    public partial class ThreatIntelligenceExternalReference
    {
        ...
        internal ThreatIntelligenceExternalReference(string description, string externalId, string sourceName, string uri, IDictionary<string, string> hashes, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
