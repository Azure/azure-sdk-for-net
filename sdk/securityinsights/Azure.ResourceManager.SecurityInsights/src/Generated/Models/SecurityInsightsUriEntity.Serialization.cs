...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    public partial class SecurityInsightsUriEntity : IUtf8JsonSerializable, IModelJsonSerializable<SecurityInsightsUriEntity>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<SecurityInsightsUriEntity>(this, options.Format);
        ...
        internal static SecurityInsightsUriEntity DeserializeSecurityInsightsUriEntity(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new SecurityInsightsUriEntity(id, name, type, systemData.Value, kind, Optional.ToDictionary(additionalData), friendlyName.Value, url.Value, serializedAdditionalRawData);
        }
        ...
        /// <summary> Converts a <see cref="SecurityInsightsUriEntity"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="SecurityInsightsUriEntity"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="SecurityInsightsUriEntity"/>. </summary>
