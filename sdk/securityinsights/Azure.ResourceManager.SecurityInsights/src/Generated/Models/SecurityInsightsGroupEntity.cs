...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    public partial class SecurityInsightsGroupEntity : SecurityInsightsEntity
    {
        ...
        public SecurityInsightsGroupEntity() : base(SecurityInsightsEntityKind.SecurityGroup)
        {
        }
        ...
        internal SecurityInsightsGroupEntity(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, SecurityInsightsEntityKind kind, IDictionary<string, BinaryData> additionalBinaryDataProperties, SecurityGroupEntityProperties properties) : base(id, name, resourceType, systemData, kind, additionalBinaryDataProperties)
        {
        ...
        [WirePath("properties")]
        internal SecurityGroupEntityProperties Properties { get; set; }
        ...
        public IReadOnlyDictionary<string, BinaryData> AdditionalData
        {
            get
            {
                ...
                {
                    Properties = new SecurityGroupEntityProperties();
                }
