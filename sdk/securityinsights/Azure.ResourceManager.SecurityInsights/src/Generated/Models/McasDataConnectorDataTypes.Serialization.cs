...
{
    public partial class McasDataConnectorDataTypes : IUtf8JsonSerializable, IJsonModel<McasDataConnectorDataTypes>, IPersistableModel<McasDataConnectorDataTypes>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(DiscoveryLogs))
            {
                ...
                AppendChildObject(builder, DiscoveryLogs, options, 2);
            }
