...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    public partial class SecurityInsightsHuntOwner
    {
        ...
        internal SecurityInsightsHuntOwner(string email, string assignedTo, Guid? objectId, string userPrincipalName, SecurityInsightsIncidentOwnerType? ownerType, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Email = email;
