...
{
    public partial class AADDataConnector : IUtf8JsonSerializable
    {
        ...
        internal static AADDataConnector DeserializeAADDataConnector(JsonElement element)
        {
            ...
            return new AADDataConnector(id, name, type, systemData.Value, kind, Optional.ToNullable(etag), Optional.ToNullable(tenantId), dataTypes.Value);
        }
    }
}
