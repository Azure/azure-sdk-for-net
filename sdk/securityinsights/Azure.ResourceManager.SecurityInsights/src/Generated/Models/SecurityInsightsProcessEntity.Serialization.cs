...
{
    public partial class SecurityInsightsProcessEntity : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static SecurityInsightsProcessEntity DeserializeSecurityInsightsProcessEntity(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
