...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    public partial class GcpAuthProperties : IJsonModel<GcpAuthProperties>
    {
        ...
        protected virtual GcpAuthProperties PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<GcpAuthProperties>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<GcpAuthProperties>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        GcpAuthProperties IPersistableModel<GcpAuthProperties>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        GcpAuthProperties IJsonModel<GcpAuthProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual GcpAuthProperties JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<GcpAuthProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static GcpAuthProperties DeserializeGcpAuthProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new GcpAuthProperties(serviceAccountEmail, projectNumber, workloadIdentityProviderId, additionalBinaryDataProperties);
        }
    }
}
