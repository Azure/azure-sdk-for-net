...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    public partial class SecurityInsightsHuntingBookmark : SecurityInsights.SecurityInsightsEntity, IJsonModel<SecurityInsightsHuntingBookmark>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<SecurityInsightsHuntingBookmark>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<SecurityInsightsHuntingBookmark>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        SecurityInsightsHuntingBookmark IPersistableModel<SecurityInsightsHuntingBookmark>.Create(BinaryData data, ModelReaderWriterOptions options) => (SecurityInsightsHuntingBookmark)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        SecurityInsightsHuntingBookmark IJsonModel<SecurityInsightsHuntingBookmark>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (SecurityInsightsHuntingBookmark)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static SecurityInsightsHuntingBookmark DeserializeSecurityInsightsHuntingBookmark(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            HuntingBookmarkProperties properties = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = HuntingBookmarkProperties.DeserializeHuntingBookmarkProperties(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
