...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    public partial class CodelessUiConnectorConfigPropertiesInstructionStepsItem : InstructionSteps
    {
        ...
        internal CodelessUiConnectorConfigPropertiesInstructionStepsItem(string title, string description, IList<InstructionStepsInstructionsItem> instructions, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(title, description, instructions, additionalBinaryDataProperties)
        {
        }
    }
}
