...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="MailMessageEntityProperties"/>. </summary>
        ...
        internal MailMessageEntityProperties(IReadOnlyDictionary<string, BinaryData> additionalData, string friendlyName, IDictionary<string, BinaryData> additionalBinaryDataProperties, IReadOnlyList<string> fileEntityIds, string recipient, IReadOnlyList<Uri> uris, IReadOnlyList<string> threats, string p1Sender, string p1SenderDisplayName, string p1SenderDomain, IPAddress senderIP, string p2Sender, string p2SenderDisplayName, string p2SenderDomain, DateTimeOffset? receiveOn, Guid? networkMessageId, string internetMessageId, string subject, string language, IReadOnlyList<string> threatDetectionMethods, int? bodyFingerprintBin1, int? bodyFingerprintBin2, int? bodyFingerprintBin3, int? bodyFingerprintBin4, int? bodyFingerprintBin5, AntispamMailDirection? antispamDirection, SecurityInsightsMailMessageDeliveryAction? deliveryAction, SecurityInsightsMailMessageDeliveryLocation? deliveryLocation) : base(additionalData, friendlyName, additionalBinaryDataProperties)
        {
        ...
        [WirePath("fileEntityIds")]
        public IReadOnlyList<string> FileEntityIds { get; } = new ChangeTrackingList<string>();
        ...
        [WirePath("urls")]
        public IReadOnlyList<Uri> Uris { get; } = new ChangeTrackingList<Uri>();

        /// <summary> The threats of this mail message. </summary>
        [WirePath("threats")]
        public IReadOnlyList<string> Threats { get; } = new ChangeTrackingList<string>();
