...
{
    public partial class SecurityInsightsScheduledAlertRule : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static SecurityInsightsScheduledAlertRule DeserializeSecurityInsightsScheduledAlertRule(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
