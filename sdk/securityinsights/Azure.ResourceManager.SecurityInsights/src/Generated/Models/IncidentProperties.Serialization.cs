...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    internal partial class IncidentProperties : IJsonModel<IncidentProperties>
    {
        ...
        internal static IncidentProperties DeserializeIncidentProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            SecurityInsightsIncidentAdditionalInfo additionalInfo = default;
            IReadOnlyList<ResourceIdentifier> relatedAnalyticRuleIds = default;
            Uri incidentUri = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("firstActivityTimeUtc"u8))
                {
                    ...
                    firstActivityOn = prop.Value.GetDateTimeOffset("O");
                    continue;
                }
                ...
                if (prop.NameEquals("additionalData"u8))
                {
                    ...
                    additionalInfo = SecurityInsightsIncidentAdditionalInfo.DeserializeSecurityInsightsIncidentAdditionalInfo(prop.Value, options);
                    continue;
                }
                ...
                if (prop.NameEquals("incidentUrl"u8))
                {
                    ...
                    incidentUri = string.IsNullOrEmpty(prop.Value.GetString()) ? null : new Uri(prop.Value.GetString(), UriKind.RelativeOrAbsolute);
                    continue;
                }
