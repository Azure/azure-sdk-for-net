...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    public partial class SecurityInsightsMetadataPatch : ResourceWithEtag
    {
        ...
        internal SecurityInsightsMetadataPatch(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, string eTag, MetadataPropertiesPatch properties) : base(id, name, resourceType, systemData, additionalBinaryDataProperties, eTag)
        {
