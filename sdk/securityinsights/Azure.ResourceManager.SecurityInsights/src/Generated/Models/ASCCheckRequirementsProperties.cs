...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    internal partial class ASCCheckRequirementsProperties
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="ASCCheckRequirementsProperties"/>. </summary>
        ...
        internal ASCCheckRequirementsProperties(string subscriptionId, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
