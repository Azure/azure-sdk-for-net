...
{
    public partial class AutomationRuleModifyPropertiesAction : IUtf8JsonSerializable, IJsonModel<AutomationRuleModifyPropertiesAction>, IPersistableModel<AutomationRuleModifyPropertiesAction>
    {
        ...
        void IJsonModel<AutomationRuleModifyPropertiesAction>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AutomationRuleModifyPropertiesAction)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ActionConfiguration))
            {
                ...
                AppendChildObject(builder, ActionConfiguration, options, 2);
            }
