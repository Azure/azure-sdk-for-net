...
{
    public partial class AutomationRuleModifyPropertiesAction : Core.IUtf8JsonSerializable
    {
        ...
        internal static AutomationRuleModifyPropertiesAction DeserializeAutomationRuleModifyPropertiesAction(JsonElement element)
        {
            ...
            Core.Optional<SecurityInsightsIncidentActionConfiguration> actionConfiguration = default;
            int order = default;
