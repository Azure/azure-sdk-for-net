...
{
    internal partial class UnknownSecurityInsightsAlertRuleTemplate : SecurityInsightsAlertRuleTemplateData, IJsonModel<SecurityInsightsAlertRuleTemplateData>
    {
        /// <summary> Initializes a new instance of <see cref="UnknownSecurityInsightsAlertRuleTemplate"/> for deserialization. </summary>
        internal UnknownSecurityInsightsAlertRuleTemplate()
        {
        }
        ...
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        SecurityInsightsAlertRuleTemplateData IPersistableModel<SecurityInsightsAlertRuleTemplateData>.Create(BinaryData data, ModelReaderWriterOptions options) => (UnknownSecurityInsightsAlertRuleTemplate)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        SecurityInsightsAlertRuleTemplateData IJsonModel<SecurityInsightsAlertRuleTemplateData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (UnknownSecurityInsightsAlertRuleTemplate)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownSecurityInsightsAlertRuleTemplate DeserializeUnknownSecurityInsightsAlertRuleTemplate(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownSecurityInsightsAlertRuleTemplate(
                id,
                name,
                resourceType,
                systemData,
