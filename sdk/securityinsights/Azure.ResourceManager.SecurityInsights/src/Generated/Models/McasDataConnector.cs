...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    public partial class McasDataConnector : SecurityInsightsDataConnectorData
    {
        ...
        internal McasDataConnector(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, DataConnectorKind kind, ETag? etag, Guid? tenantId, McasDataConnectorDataTypes dataTypes, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData, kind, etag, rawData)
        {
            TenantId = tenantId;
            DataTypes = dataTypes;
            Kind = kind;
