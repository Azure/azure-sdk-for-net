...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    public partial class Anomalies : SettingData
    {
        ...
        internal Anomalies(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, SettingKind kind, ETag? etag, bool? isEnabled) : base(id, name, resourceType, systemData, kind, etag)
        {
            IsEnabled = isEnabled;
            Kind = kind;
        }
