...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    internal partial class RelationList
    {
        ...
        internal RelationList(IEnumerable<IncidentRelationData> value)
        {
        ...
        /// <param name="value"> Array of relations. </param>
        internal RelationList(string nextLink, IReadOnlyList<IncidentRelationData> value)
        {
            NextLink = nextLink;
            Value = value;
        }
        ...
        public IReadOnlyList<IncidentRelationData> Value { get; }
    }
}
