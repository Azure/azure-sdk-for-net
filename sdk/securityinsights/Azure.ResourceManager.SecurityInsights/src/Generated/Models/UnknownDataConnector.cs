...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    internal partial class UnknownDataConnector : SecurityInsightsDataConnectorData
    {
        ...
        internal UnknownDataConnector(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, DataConnectorKind kind, ETag? etag) : base(id, name, resourceType, systemData, kind, etag)
        {
            Kind = kind;
        }
    }
