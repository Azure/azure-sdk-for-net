...
{
    public partial class SecurityInsightsSubmissionMailEntity : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static SecurityInsightsSubmissionMailEntity DeserializeSecurityInsightsSubmissionMailEntity(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
