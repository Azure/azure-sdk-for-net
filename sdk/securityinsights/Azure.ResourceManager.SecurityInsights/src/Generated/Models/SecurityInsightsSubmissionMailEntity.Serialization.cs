...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    public partial class SecurityInsightsSubmissionMailEntity : SecurityInsights.SecurityInsightsEntity, IJsonModel<SecurityInsightsSubmissionMailEntity>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<SecurityInsightsSubmissionMailEntity>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<SecurityInsightsSubmissionMailEntity>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        SecurityInsightsSubmissionMailEntity IPersistableModel<SecurityInsightsSubmissionMailEntity>.Create(BinaryData data, ModelReaderWriterOptions options) => (SecurityInsightsSubmissionMailEntity)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        SecurityInsightsSubmissionMailEntity IJsonModel<SecurityInsightsSubmissionMailEntity>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (SecurityInsightsSubmissionMailEntity)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static SecurityInsightsSubmissionMailEntity DeserializeSecurityInsightsSubmissionMailEntity(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            SubmissionMailEntityProperties properties = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = SubmissionMailEntityProperties.DeserializeSubmissionMailEntityProperties(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
