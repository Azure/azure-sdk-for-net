...
{
    public partial class AttackPattern : IUtf8JsonSerializable, IJsonModel<AttackPattern>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AttackPattern>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<AttackPattern>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AttackPattern>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AttackPattern)} does not support writing '{format}' format.");
            }
        ...
        AttackPattern IJsonModel<AttackPattern>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AttackPattern>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AttackPattern)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeAttackPattern(document.RootElement, options);
        }

        internal static AttackPattern DeserializeAttackPattern(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<AttackPattern>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AttackPattern>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AttackPattern)} does not support writing '{options.Format}' format.");
            }
        }

        AttackPattern IPersistableModel<AttackPattern>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AttackPattern>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AttackPattern)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<AttackPattern>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
