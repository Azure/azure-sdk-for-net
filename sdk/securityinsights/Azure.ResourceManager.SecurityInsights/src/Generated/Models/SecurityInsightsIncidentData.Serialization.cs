...
{
    public partial class SecurityInsightsIncidentData : IUtf8JsonSerializable, IJsonModel<SecurityInsightsIncidentData>, IPersistableModel<SecurityInsightsIncidentData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(AdditionalInfo))
            {
                ...
                AppendChildObject(builder, AdditionalInfo, options, 2);
            }
            ...
            if (Optional.IsDefined(FirstActivityOn))
            {
                ...
                builder.AppendLine($" '{FirstActivityOn.Value.ToString()}'");
            }
            ...
            if (Optional.IsDefined(IncidentNumber))
            {
                ...
                builder.AppendLine($" '{IncidentNumber.Value.ToString()}'");
            }
            ...
            if (Optional.IsDefined(LastActivityOn))
            {
                ...
                builder.AppendLine($" '{LastActivityOn.Value.ToString()}'");
            }
