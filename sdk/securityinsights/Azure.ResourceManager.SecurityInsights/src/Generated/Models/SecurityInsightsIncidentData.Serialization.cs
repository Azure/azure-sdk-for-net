...
{
    public partial class SecurityInsightsIncidentData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static SecurityInsightsIncidentData DeserializeSecurityInsightsIncidentData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
