...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    public partial class SecurityInsightsMetadataSource
    {
        ...
        internal SecurityInsightsMetadataSource(SecurityInsightsSourceKind kind, string name, string sourceId, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Kind = kind;
            Name = name;
            SourceId = sourceId;
