...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    public partial class SecurityInsightsIncidentConfiguration : IUtf8JsonSerializable, IModelJsonSerializable<SecurityInsightsIncidentConfiguration>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<SecurityInsightsIncidentConfiguration>(this, options.Format);
            ...
            if (Optional.IsDefined(GroupingConfiguration))
            {
                ...
                {
                    ((IModelJsonSerializable<SecurityInsightsGroupingConfiguration>)GroupingConfiguration).Serialize(writer, options);
                }
            }
        ...
        /// <summary> Converts a <see cref="SecurityInsightsIncidentConfiguration"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="SecurityInsightsIncidentConfiguration"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="SecurityInsightsIncidentConfiguration"/>. </summary>
