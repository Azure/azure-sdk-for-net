...
{
    public partial class SecurityInsightsIncidentConfiguration : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static SecurityInsightsIncidentConfiguration DeserializeSecurityInsightsIncidentConfiguration(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
