...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    public partial class OfficePowerBIDataConnector : SecurityInsightsDataConnectorData, IJsonModel<OfficePowerBIDataConnector>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<OfficePowerBIDataConnector>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<OfficePowerBIDataConnector>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        OfficePowerBIDataConnector IPersistableModel<OfficePowerBIDataConnector>.Create(BinaryData data, ModelReaderWriterOptions options) => (OfficePowerBIDataConnector)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        OfficePowerBIDataConnector IJsonModel<OfficePowerBIDataConnector>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (OfficePowerBIDataConnector)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static OfficePowerBIDataConnector DeserializeOfficePowerBIDataConnector(JsonElement element, ModelReaderWriterOptions options)
        {
