...
{
    public partial class ActivityEntityQuery : IUtf8JsonSerializable, IJsonModel<ActivityEntityQuery>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ActivityEntityQuery>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<ActivityEntityQuery>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        ActivityEntityQuery IJsonModel<ActivityEntityQuery>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ActivityEntityQuery>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static ActivityEntityQuery DeserializeActivityEntityQuery(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<ActivityEntityQuery>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ActivityEntityQuery>)this).GetFormatFromOptions(options) : options.Format;
        ...
        ActivityEntityQuery IPersistableModel<ActivityEntityQuery>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ActivityEntityQuery>)this).GetFormatFromOptions(options) : options.Format;
