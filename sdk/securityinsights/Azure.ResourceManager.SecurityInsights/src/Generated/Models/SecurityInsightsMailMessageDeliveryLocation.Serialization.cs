...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    internal static partial class SecurityInsightsMailMessageDeliveryLocationExtensions
    {
        ...
        public static SecurityInsightsMailMessageDeliveryLocation ToSecurityInsightsMailMessageDeliveryLocation(this string value)
        {
            ...
            {
                return SecurityInsightsMailMessageDeliveryLocation.Unknown;
            }
            if (StringComparer.OrdinalIgnoreCase.Equals(value, "Inbox"))
            {
                return SecurityInsightsMailMessageDeliveryLocation.Inbox;
            }
            if (StringComparer.OrdinalIgnoreCase.Equals(value, "JunkFolder"))
            {
                return SecurityInsightsMailMessageDeliveryLocation.JunkFolder;
            }
            if (StringComparer.OrdinalIgnoreCase.Equals(value, "DeletedFolder"))
            {
                return SecurityInsightsMailMessageDeliveryLocation.DeletedFolder;
            }
            if (StringComparer.OrdinalIgnoreCase.Equals(value, "Quarantine"))
            {
                return SecurityInsightsMailMessageDeliveryLocation.Quarantine;
            }
            if (StringComparer.OrdinalIgnoreCase.Equals(value, "External"))
            {
                return SecurityInsightsMailMessageDeliveryLocation.External;
            }
            if (StringComparer.OrdinalIgnoreCase.Equals(value, "Failed"))
            {
                return SecurityInsightsMailMessageDeliveryLocation.Failed;
            }
            if (StringComparer.OrdinalIgnoreCase.Equals(value, "Dropped"))
            {
                return SecurityInsightsMailMessageDeliveryLocation.Dropped;
            }
            if (StringComparer.OrdinalIgnoreCase.Equals(value, "Forwarded"))
            {
                return SecurityInsightsMailMessageDeliveryLocation.Forwarded;
            }
