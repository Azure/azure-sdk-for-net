...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    public partial class CodelessUiConnectorConfigPropertiesDataTypesItem : LastDataReceivedDataType
    {
        ...
        internal CodelessUiConnectorConfigPropertiesDataTypesItem(string name, string lastDataReceivedQuery, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(name, lastDataReceivedQuery, additionalBinaryDataProperties)
        {
        }
    }
}
