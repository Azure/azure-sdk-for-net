...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    public partial class NicEntity : SecurityInsights.SecurityInsightsEntity, IJsonModel<NicEntity>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<NicEntity>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<NicEntity>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        NicEntity IPersistableModel<NicEntity>.Create(BinaryData data, ModelReaderWriterOptions options) => (NicEntity)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        NicEntity IJsonModel<NicEntity>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (NicEntity)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static NicEntity DeserializeNicEntity(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            NicEntityProperties properties = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = NicEntityProperties.DeserializeNicEntityProperties(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
