...
{
    internal partial class AwsCloudTrailDataConnectorDataTypesLogs : Core.IUtf8JsonSerializable
    {
        ...
        internal static AwsCloudTrailDataConnectorDataTypesLogs DeserializeAwsCloudTrailDataConnectorDataTypesLogs(JsonElement element)
        {
            ...
            return new AwsCloudTrailDataConnectorDataTypesLogs(Core.Optional.ToNullable(state));
        }
    }
}
