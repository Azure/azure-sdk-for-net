...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    public partial class AwsCloudTrailDataConnectorDataTypesLogs : DataConnectorDataTypeCommon, IJsonModel<AwsCloudTrailDataConnectorDataTypesLogs>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<AwsCloudTrailDataConnectorDataTypesLogs>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<AwsCloudTrailDataConnectorDataTypesLogs>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        AwsCloudTrailDataConnectorDataTypesLogs IPersistableModel<AwsCloudTrailDataConnectorDataTypesLogs>.Create(BinaryData data, ModelReaderWriterOptions options) => (AwsCloudTrailDataConnectorDataTypesLogs)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        AwsCloudTrailDataConnectorDataTypesLogs IJsonModel<AwsCloudTrailDataConnectorDataTypesLogs>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (AwsCloudTrailDataConnectorDataTypesLogs)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static AwsCloudTrailDataConnectorDataTypesLogs DeserializeAwsCloudTrailDataConnectorDataTypesLogs(JsonElement element, ModelReaderWriterOptions options)
        {
