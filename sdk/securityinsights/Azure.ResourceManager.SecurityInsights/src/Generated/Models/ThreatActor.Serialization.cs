...
{
    public partial class ThreatActor : IUtf8JsonSerializable, IJsonModel<ThreatActor>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ThreatActor>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<ThreatActor>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ThreatActor>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ThreatActor)} does not support writing '{format}' format.");
            }
        ...
        ThreatActor IJsonModel<ThreatActor>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ThreatActor>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ThreatActor)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeThreatActor(document.RootElement, options);
        }

        internal static ThreatActor DeserializeThreatActor(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<ThreatActor>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ThreatActor>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ThreatActor)} does not support writing '{options.Format}' format.");
            }
        }

        ThreatActor IPersistableModel<ThreatActor>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ThreatActor>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ThreatActor)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<ThreatActor>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
