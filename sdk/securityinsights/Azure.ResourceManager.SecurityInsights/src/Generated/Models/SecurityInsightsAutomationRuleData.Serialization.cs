...
{
    public partial class SecurityInsightsAutomationRuleData : IUtf8JsonSerializable, IJsonModel<SecurityInsightsAutomationRuleData>, IPersistableModel<SecurityInsightsAutomationRuleData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(TriggeringLogic))
            {
                ...
                AppendChildObject(builder, TriggeringLogic, options, 2);
            }
