...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    internal partial class MetadataProperties
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="MetadataProperties"/>. </summary>
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="parentId"/> or <paramref name="kind"/> is null. </exception>
        public MetadataProperties(string parentId, string kind)
        {
            Argument.AssertNotNull(parentId, nameof(parentId));
        ...
        internal MetadataProperties(string contentId, string parentId, string version, string kind, MetadataSource source, MetadataAuthor author, MetadataSupport support, MetadataDependencies dependencies, MetadataCategories categories, IList<string> providers, DateTimeOffset? firstPublishOn, DateTimeOffset? lastPublishOn, string customVersion, string contentSchemaVersion, string icon, IList<string> threatAnalysisTactics, IList<string> threatAnalysisTechniques, IList<string> previewImages, IList<string> previewImagesDark, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            ContentId = contentId;
            ParentId = parentId;
            Version = version;
