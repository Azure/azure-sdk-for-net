...
{
    public partial class SecurityInsightsAadDataConnector : IUtf8JsonSerializable
    {
        ...
        internal static SecurityInsightsAadDataConnector DeserializeSecurityInsightsAadDataConnector(JsonElement element)
        {
            ...
            return new SecurityInsightsAadDataConnector(id, name, type, systemData.Value, kind, Optional.ToNullable(etag), Optional.ToNullable(tenantId), dataTypes.Value);
        }
    }
}
