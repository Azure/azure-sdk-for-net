...
{
    public partial class SecurityInsightsAadDataConnector : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static SecurityInsightsAadDataConnector DeserializeSecurityInsightsAadDataConnector(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
