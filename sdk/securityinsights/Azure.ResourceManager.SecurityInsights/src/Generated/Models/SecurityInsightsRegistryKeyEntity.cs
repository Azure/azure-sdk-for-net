...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    public partial class SecurityInsightsRegistryKeyEntity : SecurityInsights.SecurityInsightsEntity
    {
        /// <summary> Initializes a new instance of <see cref="SecurityInsightsRegistryKeyEntity"/>. </summary>
        internal SecurityInsightsRegistryKeyEntity() : base(SecurityInsightsEntityKind.RegistryKey)
        {
        }
        ...
        internal SecurityInsightsRegistryKeyEntity(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, SecurityInsightsEntityKind kind, RegistryKeyEntityProperties properties) : base(id, name, resourceType, systemData, additionalBinaryDataProperties, kind)
        {
            Properties = properties;
        }

        /// <summary> RegistryKey entity properties. </summary>
        internal RegistryKeyEntityProperties Properties { get; }
        ...
        public SecurityInsightsRegistryHive? Hive
        {
            get
            {
                return Properties.Hive;
            }
        }
