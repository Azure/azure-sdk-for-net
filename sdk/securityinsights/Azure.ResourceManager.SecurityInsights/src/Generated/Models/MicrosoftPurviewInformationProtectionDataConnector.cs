...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    {
        /// <summary> Initializes a new instance of MicrosoftPurviewInformationProtectionDataConnector. </summary>
        ...
        internal MicrosoftPurviewInformationProtectionDataConnector(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, DataConnectorKind kind, ETag? etag, Guid? tenantId, MicrosoftPurviewInformationProtectionConnectorDataTypes dataTypes) : base(id, name, resourceType, systemData, kind, etag)
        {
            TenantId = tenantId;
            DataTypes = dataTypes;
            Kind = kind;
