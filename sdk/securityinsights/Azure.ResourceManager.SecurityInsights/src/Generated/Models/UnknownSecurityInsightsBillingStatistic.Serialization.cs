...
{
    internal partial class UnknownSecurityInsightsBillingStatistic : SecurityInsightsBillingStatisticData, IJsonModel<SecurityInsightsBillingStatisticData>
    {
        /// <summary> Initializes a new instance of <see cref="UnknownSecurityInsightsBillingStatistic"/> for deserialization. </summary>
        internal UnknownSecurityInsightsBillingStatistic()
        {
        }
        ...
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        SecurityInsightsBillingStatisticData IPersistableModel<SecurityInsightsBillingStatisticData>.Create(BinaryData data, ModelReaderWriterOptions options) => (UnknownSecurityInsightsBillingStatistic)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        SecurityInsightsBillingStatisticData IJsonModel<SecurityInsightsBillingStatisticData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (UnknownSecurityInsightsBillingStatistic)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownSecurityInsightsBillingStatistic DeserializeUnknownSecurityInsightsBillingStatistic(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            BillingStatisticKind kind = default;
            string eTag = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    kind = new BillingStatisticKind(prop.Value.GetString());
                    continue;
                }
