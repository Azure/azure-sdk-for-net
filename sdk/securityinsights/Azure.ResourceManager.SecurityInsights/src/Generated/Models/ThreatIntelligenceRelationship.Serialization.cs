...
{
    public partial class ThreatIntelligenceRelationship : IUtf8JsonSerializable, IJsonModel<ThreatIntelligenceRelationship>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ThreatIntelligenceRelationship>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        internal static ThreatIntelligenceRelationship DeserializeThreatIntelligenceRelationship(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<ThreatIntelligenceRelationship>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ThreatIntelligenceRelationship>)this).GetFormatFromOptions(options) : options.Format;
        ...
        ThreatIntelligenceRelationship IPersistableModel<ThreatIntelligenceRelationship>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ThreatIntelligenceRelationship>)this).GetFormatFromOptions(options) : options.Format;
