...
{
    public partial class SecurityInsightsMailClusterEntity : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static SecurityInsightsMailClusterEntity DeserializeSecurityInsightsMailClusterEntity(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
