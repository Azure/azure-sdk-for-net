...
{
    public partial class ThreatIntelligenceAlertRule : IUtf8JsonSerializable, IJsonModel<ThreatIntelligenceAlertRule>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ThreatIntelligenceAlertRule>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<ThreatIntelligenceAlertRule>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        ThreatIntelligenceAlertRule IJsonModel<ThreatIntelligenceAlertRule>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ThreatIntelligenceAlertRule>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static ThreatIntelligenceAlertRule DeserializeThreatIntelligenceAlertRule(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<ThreatIntelligenceAlertRule>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ThreatIntelligenceAlertRule>)this).GetFormatFromOptions(options) : options.Format;
        ...
        ThreatIntelligenceAlertRule IPersistableModel<ThreatIntelligenceAlertRule>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ThreatIntelligenceAlertRule>)this).GetFormatFromOptions(options) : options.Format;
