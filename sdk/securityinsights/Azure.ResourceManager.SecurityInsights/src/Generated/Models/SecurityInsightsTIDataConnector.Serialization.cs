...
{
    public partial class SecurityInsightsTIDataConnector : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static SecurityInsightsTIDataConnector DeserializeSecurityInsightsTIDataConnector(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
