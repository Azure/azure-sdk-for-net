...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    public partial class SecurityInsightsTIDataConnector : IUtf8JsonSerializable, IModelJsonSerializable<SecurityInsightsTIDataConnector>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<SecurityInsightsTIDataConnector>(this, options.Format);
            ...
            if (Optional.IsDefined(DataTypes))
            {
                ...
                {
                    ((IModelJsonSerializable<TIDataConnectorDataTypes>)DataTypes).Serialize(writer, options);
                }
            }
        ...
        internal static SecurityInsightsTIDataConnector DeserializeSecurityInsightsTIDataConnector(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new SecurityInsightsTIDataConnector(id, name, type, systemData.Value, kind, Optional.ToNullable(etag), Optional.ToNullable(tenantId), Optional.ToNullable(tipLookbackPeriod), dataTypes.Value, serializedAdditionalRawData);
        }
        ...
        /// <summary> Converts a <see cref="SecurityInsightsTIDataConnector"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="SecurityInsightsTIDataConnector"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="SecurityInsightsTIDataConnector"/>. </summary>
