...
{
    public partial class SecurityInsightsTIDataConnector : Core.IUtf8JsonSerializable
    {
        void Core.IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            if (Core.Optional.IsDefined(TipLookbackOn))
            {
        ...
        internal static SecurityInsightsTIDataConnector DeserializeSecurityInsightsTIDataConnector(JsonElement element)
        {
            ...
            Core.Optional<DateTimeOffset?> tipLookbackPeriod = default;
            Core.Optional<TIDataConnectorDataTypes> dataTypes = default;
            ...
            return new SecurityInsightsTIDataConnector(id, name, type, systemData.Value, kind, Core.Optional.ToNullable(etag), Core.Optional.ToNullable(tenantId), Core.Optional.ToNullable(tipLookbackPeriod), dataTypes.Value);
        }
    }
}
