...
{
    public partial class SecurityInsightsTIDataConnector : IUtf8JsonSerializable, IJsonModel<SecurityInsightsTIDataConnector>, IPersistableModel<SecurityInsightsTIDataConnector>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(TipLookbackOn))
            {
                ...
                builder.AppendLine($" '{TipLookbackOn.Value.ToString()}'");
            }
