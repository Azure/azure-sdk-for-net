...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    public partial class SecurityInsightsTIDataConnector : SecurityInsightsDataConnectorData, IJsonModel<SecurityInsightsTIDataConnector>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<SecurityInsightsTIDataConnector>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<SecurityInsightsTIDataConnector>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        SecurityInsightsTIDataConnector IPersistableModel<SecurityInsightsTIDataConnector>.Create(BinaryData data, ModelReaderWriterOptions options) => (SecurityInsightsTIDataConnector)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        SecurityInsightsTIDataConnector IJsonModel<SecurityInsightsTIDataConnector>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (SecurityInsightsTIDataConnector)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static SecurityInsightsTIDataConnector DeserializeSecurityInsightsTIDataConnector(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            string eTag = default;
            TIDataConnectorProperties properties = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = TIDataConnectorProperties.DeserializeTIDataConnectorProperties(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
