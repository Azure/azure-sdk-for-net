...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    public partial class ThreatIntelligenceAlertRuleTemplate : SecurityInsightsAlertRuleTemplateData
    {
        ...
        internal ThreatIntelligenceAlertRuleTemplate() : base(AlertRuleKind.ThreatIntelligence)
        {
        }
        ...
        internal ThreatIntelligenceAlertRuleTemplate(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, AlertRuleKind kind, ThreatIntelligenceAlertRuleTemplateProperties properties) : base(id, name, resourceType, systemData, additionalBinaryDataProperties, kind)
        {
            Properties = properties;
        }

        /// <summary> Threat Intelligence alert rule template properties. </summary>
        internal ThreatIntelligenceAlertRuleTemplateProperties Properties { get; }
