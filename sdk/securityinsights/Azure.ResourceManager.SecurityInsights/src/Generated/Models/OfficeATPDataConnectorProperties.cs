...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    internal partial class OfficeATPDataConnectorProperties
    {
        ...
        /// <summary> Initializes a new instance of <see cref="OfficeATPDataConnectorProperties"/>. </summary>
        /// <param name="tenantId"> The tenant id to connect to, and get the data from. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="tenantId"/> is null. </exception>
        public OfficeATPDataConnectorProperties(string tenantId)
        {
        ...
        internal OfficeATPDataConnectorProperties(string tenantId, SecurityInsightsAlertsDataTypeOfDataConnector dataTypes, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            TenantId = tenantId;
            DataTypes = dataTypes;
