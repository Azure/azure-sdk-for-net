...
{
    public partial class MdatpDataConnector : Core.IUtf8JsonSerializable
    {
        ...
        internal static MdatpDataConnector DeserializeMdatpDataConnector(JsonElement element)
        {
            ...
            return new MdatpDataConnector(id, name, type, systemData.Value, kind, Core.Optional.ToNullable(etag), Core.Optional.ToNullable(tenantId), dataTypes.Value);
        }
    }
}
