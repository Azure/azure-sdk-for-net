...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    public partial class AwsCloudTrailCheckRequirements : DataConnectorsCheckRequirements, IJsonModel<AwsCloudTrailCheckRequirements>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<AwsCloudTrailCheckRequirements>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<AwsCloudTrailCheckRequirements>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        AwsCloudTrailCheckRequirements IPersistableModel<AwsCloudTrailCheckRequirements>.Create(BinaryData data, ModelReaderWriterOptions options) => (AwsCloudTrailCheckRequirements)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        AwsCloudTrailCheckRequirements IJsonModel<AwsCloudTrailCheckRequirements>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (AwsCloudTrailCheckRequirements)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static AwsCloudTrailCheckRequirements DeserializeAwsCloudTrailCheckRequirements(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new AwsCloudTrailCheckRequirements(kind, additionalBinaryDataProperties);
        }
    }
}
