...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    public partial class MicrosoftSecurityIncidentCreationAlertRuleTemplate : SecurityInsightsAlertRuleTemplateData, IJsonModel<MicrosoftSecurityIncidentCreationAlertRuleTemplate>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<MicrosoftSecurityIncidentCreationAlertRuleTemplate>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<MicrosoftSecurityIncidentCreationAlertRuleTemplate>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        MicrosoftSecurityIncidentCreationAlertRuleTemplate IPersistableModel<MicrosoftSecurityIncidentCreationAlertRuleTemplate>.Create(BinaryData data, ModelReaderWriterOptions options) => (MicrosoftSecurityIncidentCreationAlertRuleTemplate)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        MicrosoftSecurityIncidentCreationAlertRuleTemplate IJsonModel<MicrosoftSecurityIncidentCreationAlertRuleTemplate>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (MicrosoftSecurityIncidentCreationAlertRuleTemplate)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static MicrosoftSecurityIncidentCreationAlertRuleTemplate DeserializeMicrosoftSecurityIncidentCreationAlertRuleTemplate(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            MicrosoftSecurityIncidentCreationAlertRuleTemplateProperties properties = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = MicrosoftSecurityIncidentCreationAlertRuleTemplateProperties.DeserializeMicrosoftSecurityIncidentCreationAlertRuleTemplateProperties(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
