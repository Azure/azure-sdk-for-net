...
{
    internal partial class UnknownSecurityInsightsAlertRule : SecurityInsightsAlertRuleData, IJsonModel<SecurityInsightsAlertRuleData>
    {
        /// <summary> Initializes a new instance of <see cref="UnknownSecurityInsightsAlertRule"/> for deserialization. </summary>
        internal UnknownSecurityInsightsAlertRule()
        {
        }
        ...
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        SecurityInsightsAlertRuleData IPersistableModel<SecurityInsightsAlertRuleData>.Create(BinaryData data, ModelReaderWriterOptions options) => (UnknownSecurityInsightsAlertRule)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        SecurityInsightsAlertRuleData IJsonModel<SecurityInsightsAlertRuleData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (UnknownSecurityInsightsAlertRule)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownSecurityInsightsAlertRule DeserializeUnknownSecurityInsightsAlertRule(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownSecurityInsightsAlertRule(
                id,
                name,
                resourceType,
                systemData,
