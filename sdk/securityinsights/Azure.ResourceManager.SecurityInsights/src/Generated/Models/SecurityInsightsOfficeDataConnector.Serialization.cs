...
{
    public partial class SecurityInsightsOfficeDataConnector : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static SecurityInsightsOfficeDataConnector DeserializeSecurityInsightsOfficeDataConnector(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
