...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    public partial class MtpDataConnector : SecurityInsightsDataConnectorData
    {
        ...
        public MtpDataConnector() : base(DataConnectorKind.MicrosoftThreatProtection)
        {
        }
        ...
        /// <param name="properties"> MTP (Microsoft Threat Protection) data connector properties. </param>
        internal MtpDataConnector(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, DataConnectorKind kind, string eTag, MTPDataConnectorProperties properties) : base(id, name, resourceType, systemData, additionalBinaryDataProperties, kind, eTag)
        {
            Properties = properties;
        }

        /// <summary> MTP (Microsoft Threat Protection) data connector properties. </summary>
        internal MTPDataConnectorProperties Properties { get; set; }
        ...
        public string TenantId
        {
            ...
            set
            {
                ...
                {
                    Properties = new MTPDataConnectorProperties();
                }
        ...
        public IList<MtpProvider> FilteredProvidersAlerts
        {
            get
            {
                ...
                return Properties.FilteredProvidersAlerts;
            }
        }
    }
}
