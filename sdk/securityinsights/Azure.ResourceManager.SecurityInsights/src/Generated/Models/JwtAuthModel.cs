...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    public partial class JwtAuthModel : CcpAuthConfig
    {
        ...
        public JwtAuthModel(string tokenEndpoint, IDictionary<string, string> userName, IDictionary<string, string> password) : base(CcpAuthType.JwtToken)
        {
