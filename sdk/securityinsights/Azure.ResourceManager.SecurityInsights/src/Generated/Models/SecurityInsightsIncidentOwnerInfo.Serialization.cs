...
{
    public partial class SecurityInsightsIncidentOwnerInfo : IUtf8JsonSerializable, IJsonModel<SecurityInsightsIncidentOwnerInfo>, IPersistableModel<SecurityInsightsIncidentOwnerInfo>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(OwnerType))
            {
                ...
                builder.AppendLine($" '{OwnerType.ToString()}'");
            }
