...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    public partial class GcpDataConnector : SecurityInsightsDataConnectorData, IJsonModel<GcpDataConnector>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<GcpDataConnector>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<GcpDataConnector>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        GcpDataConnector IPersistableModel<GcpDataConnector>.Create(BinaryData data, ModelReaderWriterOptions options) => (GcpDataConnector)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        GcpDataConnector IJsonModel<GcpDataConnector>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (GcpDataConnector)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static GcpDataConnector DeserializeGcpDataConnector(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            string eTag = default;
            GCPDataConnectorProperties properties = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = GCPDataConnectorProperties.DeserializeGCPDataConnectorProperties(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
