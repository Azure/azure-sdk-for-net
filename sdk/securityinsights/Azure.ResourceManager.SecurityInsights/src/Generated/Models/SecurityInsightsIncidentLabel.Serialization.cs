...
{
    public partial class SecurityInsightsIncidentLabel : IUtf8JsonSerializable, IJsonModel<SecurityInsightsIncidentLabel>, IPersistableModel<SecurityInsightsIncidentLabel>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(LabelType))
            {
                ...
                builder.AppendLine($" '{LabelType.ToString()}'");
            }
