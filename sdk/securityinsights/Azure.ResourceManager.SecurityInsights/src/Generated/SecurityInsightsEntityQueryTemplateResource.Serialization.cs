...
namespace Azure.ResourceManager.SecurityInsights
{
    ...
    {
        private static IJsonModel<SecurityInsightsEntityQueryTemplateData> s_dataDeserializationInstance;

        private static IJsonModel<SecurityInsightsEntityQueryTemplateData> DataDeserializationInstance => s_dataDeserializationInstance ??= new SecurityInsights.SecurityInsightsEntityQueryTemplateData();
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        SecurityInsightsEntityQueryTemplateData IJsonModel<SecurityInsightsEntityQueryTemplateData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => DataDeserializationInstance.Create(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<SecurityInsightsEntityQueryTemplateData>.GetFormatFromOptions(ModelReaderWriterOptions options) => DataDeserializationInstance.GetFormatFromOptions(options);
    }
}
