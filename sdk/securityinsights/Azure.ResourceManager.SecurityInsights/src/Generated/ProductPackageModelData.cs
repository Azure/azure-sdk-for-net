...
namespace Azure.ResourceManager.SecurityInsights
{
    ...
    public partial class ProductPackageModelData : ResourceData
    {
        ...
        internal ProductPackageModelData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string contentId, string contentProductId, PackageKind? contentKind, string contentSchemaVersion, Flag? isNew, Flag? isPreview, Flag? isFeatured, Flag? isDeprecated, string version, string displayName, string description, string publisherDisplayName, MetadataSource source, MetadataAuthor author, MetadataSupport support, MetadataDependencies dependencies, IList<string> providers, DateTimeOffset? firstPublishOn, DateTimeOffset? lastPublishOn, MetadataCategories categories, IList<string> threatAnalysisTactics, IList<string> threatAnalysisTechniques, string icon, string installedVersion, ResourceIdentifier metadataResourceId, BinaryData packagedContent, ETag? etag, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
            ContentId = contentId;
        ...
        public Flag? IsDeprecated { get; set; }
