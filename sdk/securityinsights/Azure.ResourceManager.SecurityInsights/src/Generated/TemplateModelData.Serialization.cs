...
{
    public partial class TemplateModelData : IUtf8JsonSerializable, IJsonModel<TemplateModelData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TemplateModelData>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<TemplateModelData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<TemplateModelData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        TemplateModelData IJsonModel<TemplateModelData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<TemplateModelData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static TemplateModelData DeserializeTemplateModelData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("dependantTemplates"u8))
                        {
                            if (property0.Value.ValueKind == JsonValueKind.Null)
                            {
                                continue;
                            ...
                            foreach (var item in property0.Value.EnumerateArray())
                            {
                                array.Add(TemplateProperties.DeserializeTemplateProperties(item, options));
                            }
        ...
        BinaryData IPersistableModel<TemplateModelData>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<TemplateModelData>)this).GetFormatFromOptions(options) : options.Format;
        ...
        TemplateModelData IPersistableModel<TemplateModelData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<TemplateModelData>)this).GetFormatFromOptions(options) : options.Format;
