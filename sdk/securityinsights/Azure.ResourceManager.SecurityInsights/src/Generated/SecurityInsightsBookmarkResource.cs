...
namespace Azure.ResourceManager.SecurityInsights
{
    ...
    /// Otherwise you can get one from its parent resource <see cref="ArmResource"/> using the GetSecurityInsightsBookmarks method.
    /// </summary>
    public partial class SecurityInsightsBookmarkResource : ArmResource
    {
        ...
        internal SecurityInsightsBookmarkResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _bookmarkRestClient = new Bookmark(_bookmarkClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, securityInsightsBookmarkApiVersion ?? "2025-10-01-preview");
        ...
        /// <summary> Gets a collection of SecurityInsightsBookmarkRelations in the <see cref="SecurityInsightsBookmarkResource"/>. </summary>
        /// <returns> An object representing collection of SecurityInsightsBookmarkRelations and their operations over a SecurityInsightsBookmarkRelationResource. </returns>
