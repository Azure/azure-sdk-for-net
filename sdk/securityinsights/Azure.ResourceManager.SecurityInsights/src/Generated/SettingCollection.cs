...
namespace Azure.ResourceManager.SecurityInsights
{
    ...
    public partial class SettingCollection : ArmCollection, IEnumerable<SettingResource>, IAsyncEnumerable<SettingResource>
    {
        ...
        public virtual AsyncPageable<SettingResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, null, e => new SettingResource(Client, SettingData.DeserializeSettingData(e)), _settingProductSettingsClientDiagnostics, Pipeline, "SettingCollection.GetAll", "value", null, cancellationToken);
        }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _settingProductSettingsRestClient.CreateListRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name);
            return PageableHelpers.CreatePageable(FirstPageRequest, null, e => new SettingResource(Client, SettingData.DeserializeSettingData(e)), _settingProductSettingsClientDiagnostics, Pipeline, "SettingCollection.GetAll", "value", null, cancellationToken);
        }
