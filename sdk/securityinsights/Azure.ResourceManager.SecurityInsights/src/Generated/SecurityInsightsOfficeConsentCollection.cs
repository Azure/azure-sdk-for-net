...
namespace Azure.ResourceManager.SecurityInsights
{
    ...
    /// Each <see cref="SecurityInsightsOfficeConsentResource"/> in the collection will belong to the same instance of <see cref="ArmResource"/>.
    /// To get a <see cref="SecurityInsightsOfficeConsentCollection"/> instance call the GetSecurityInsightsOfficeConsents method from an instance of <see cref="ArmResource"/>.
    /// </summary>
    public partial class SecurityInsightsOfficeConsentCollection : ArmCollection, IEnumerable<SecurityInsightsOfficeConsentResource>, IAsyncEnumerable<SecurityInsightsOfficeConsentResource>
    {
        ...
        internal SecurityInsightsOfficeConsentCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _officeConsentsRestClient = new OfficeConsents(_officeConsentsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, securityInsightsOfficeConsentApiVersion ?? "2025-10-01-preview");
        ...
        public virtual async Task<Response<SecurityInsightsOfficeConsentResource>> GetAsync(string consentId, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _officeConsentsRestClient.CreateGetRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, consentId, context);
        ...
        public virtual AsyncPageable<SecurityInsightsOfficeConsentResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<SecurityInsightsOfficeConsentData, SecurityInsightsOfficeConsentResource>(new OfficeConsentsGetAllAsyncCollectionResultOfT(
                ...
                Id.Name,
                context,
                "SecurityInsightsOfficeConsentCollection.GetAll"), data => new SecurityInsightsOfficeConsentResource(Client, data));
        }
