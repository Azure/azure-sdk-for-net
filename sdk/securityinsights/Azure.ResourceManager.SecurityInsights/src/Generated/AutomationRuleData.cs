...
namespace Azure.ResourceManager.SecurityInsights
{
    ...
    public partial class AutomationRuleData : ResourceData
    {
        ...
        internal AutomationRuleData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string displayName, int order, AutomationRuleTriggeringLogic triggeringLogic, IList<AutomationRuleAction> actions, DateTimeOffset? lastModifiedTimeUtc, DateTimeOffset? createdTimeUtc, ClientInfo lastModifiedBy, ClientInfo createdBy, ETag? etag) : base(id, name, resourceType, systemData)
        {
            DisplayName = displayName;
            Order = order;
            TriggeringLogic = triggeringLogic;
