...
namespace Azure.ResourceManager.SecurityInsights
{
    ...
    public partial class SecurityInsightsSentinelOnboardingStateData : ResourceData
    {
        ...
        internal SecurityInsightsSentinelOnboardingStateData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, bool? isCustomerManagedKeySet, ETag? etag, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
