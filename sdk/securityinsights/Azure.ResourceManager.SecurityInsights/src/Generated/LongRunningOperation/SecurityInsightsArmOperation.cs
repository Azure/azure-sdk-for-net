...
#pragma warning disable SA1649 // File name should match first type name
    internal class SecurityInsightsArmOperation : ArmOperation
#pragma warning restore SA1649 // File name should match first type name
    {
        private readonly OperationInternal _operation;

        /// <summary> Initializes a new instance of SecurityInsightsArmOperation for mocking. </summary>
        protected SecurityInsightsArmOperation()
        {
        }
        ...
        internal SecurityInsightsArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal(nextLinkOperation, clientDiagnostics, response, "SecurityInsightsArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
