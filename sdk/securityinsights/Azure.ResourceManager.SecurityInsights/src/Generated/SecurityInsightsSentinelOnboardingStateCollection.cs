...
namespace Azure.ResourceManager.SecurityInsights
{
    ...
    /// Each <see cref="SecurityInsightsSentinelOnboardingStateResource"/> in the collection will belong to the same instance of <see cref="ArmResource"/>.
    /// To get a <see cref="SecurityInsightsSentinelOnboardingStateCollection"/> instance call the GetSecurityInsightsSentinelOnboardingStates method from an instance of <see cref="ArmResource"/>.
    /// </summary>
    public partial class SecurityInsightsSentinelOnboardingStateCollection : ArmCollection, IEnumerable<SecurityInsightsSentinelOnboardingStateResource>, IAsyncEnumerable<SecurityInsightsSentinelOnboardingStateResource>
    {
        ...
        internal SecurityInsightsSentinelOnboardingStateCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _sentinelOnboardingStatesRestClient = new SentinelOnboardingStates(_sentinelOnboardingStatesClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, securityInsightsSentinelOnboardingStateApiVersion ?? "2025-10-01-preview");
        ...
        public virtual async Task<ArmOperation<SecurityInsightsSentinelOnboardingStateResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string sentinelOnboardingStateName, SecurityInsightsSentinelOnboardingStateData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _sentinelOnboardingStatesRestClient.CreateCreateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, sentinelOnboardingStateName, SecurityInsightsSentinelOnboardingStateData.ToRequestContent(data), context);
        ...
        public virtual async Task<Response<SecurityInsightsSentinelOnboardingStateResource>> GetAsync(string sentinelOnboardingStateName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _sentinelOnboardingStatesRestClient.CreateGetRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, sentinelOnboardingStateName, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<SecurityInsightsSentinelOnboardingStateData> response = Response.FromValue(SecurityInsightsSentinelOnboardingStateData.FromResponse(result), result);
        ...
        public virtual AsyncPageable<SecurityInsightsSentinelOnboardingStateResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<SecurityInsightsSentinelOnboardingStateData, SecurityInsightsSentinelOnboardingStateResource>(new SentinelOnboardingStatesGetAllAsyncCollectionResultOfT(
                ...
                Id.Name,
                context,
                "SecurityInsightsSentinelOnboardingStateCollection.GetAll"), data => new SecurityInsightsSentinelOnboardingStateResource(Client, data));
        }
