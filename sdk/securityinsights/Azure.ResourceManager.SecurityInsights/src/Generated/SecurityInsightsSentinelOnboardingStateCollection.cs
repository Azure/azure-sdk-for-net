...
[assembly: CodeGenSuppressType("SecurityInsightsSentinelOnboardingStateCollection")]
...
<<<<<<<< HEAD:sdk/securityinsights/Azure.ResourceManager.SecurityInsights/src/Generated/SecurityInsightsSentinelOnboardingStateCollection.cs
...
>>>>>>>> upstream/main:sdk/securityinsights/Azure.ResourceManager.SecurityInsights/src/Customized/SecurityInsightsSentinelOnboardingStateCollection.cs
    /// </summary>
...
>>>>>>>> upstream/main:sdk/securityinsights/Azure.ResourceManager.SecurityInsights/src/Customized/SecurityInsightsSentinelOnboardingStateCollection.cs
        ...
        {
            async Task<Page<SecurityInsightsSentinelOnboardingStateResource>> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _securityInsightsSentinelOnboardingStateSentinelOnboardingStatesClientDiagnostics.CreateScope("SecurityInsightsSentinelOnboardingStateCollection.GetAll");
                scope.Start();
                try
                {
<<<<<<<< HEAD:sdk/securityinsights/Azure.ResourceManager.SecurityInsights/src/Generated/SecurityInsightsSentinelOnboardingStateCollection.cs
                    var response = await _securityInsightsSentinelOnboardingStateSentinelOnboardingStatesRestClient.ListAsync(Id.SubscriptionId, Id.ResourceGroupName, _workspaceName, cancellationToken: cancellationToken).ConfigureAwait(false);
========
                    var response = await _securityInsightsSentinelOnboardingStateSentinelOnboardingStatesRestClient.ListAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken).ConfigureAwait(false);
>>>>>>>> upstream/main:sdk/securityinsights/Azure.ResourceManager.SecurityInsights/src/Customized/SecurityInsightsSentinelOnboardingStateCollection.cs
                    return Page.FromValues(response.Value.Value.Select(value => new SecurityInsightsSentinelOnboardingStateResource(Client, value)), null, response.GetRawResponse());
                }
                catch (Exception e)
                {
                    scope.Failed(e);
        ...
        {
            Page<SecurityInsightsSentinelOnboardingStateResource> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _securityInsightsSentinelOnboardingStateSentinelOnboardingStatesClientDiagnostics.CreateScope("SecurityInsightsSentinelOnboardingStateCollection.GetAll");
                scope.Start();
                try
                {
<<<<<<<< HEAD:sdk/securityinsights/Azure.ResourceManager.SecurityInsights/src/Generated/SecurityInsightsSentinelOnboardingStateCollection.cs
                    var response = _securityInsightsSentinelOnboardingStateSentinelOnboardingStatesRestClient.List(Id.SubscriptionId, Id.ResourceGroupName, _workspaceName, cancellationToken: cancellationToken);
========
                    var response = _securityInsightsSentinelOnboardingStateSentinelOnboardingStatesRestClient.List(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken);
>>>>>>>> upstream/main:sdk/securityinsights/Azure.ResourceManager.SecurityInsights/src/Customized/SecurityInsightsSentinelOnboardingStateCollection.cs
                    return Page.FromValues(response.Value.Value.Select(value => new SecurityInsightsSentinelOnboardingStateResource(Client, value)), null, response.GetRawResponse());
                }
                catch (Exception e)
