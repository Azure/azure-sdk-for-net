...
namespace Azure.ResourceManager.SecurityInsights
{
    ...
    public partial class SecurityInsightsEntityRelationCollection : ArmCollection, IEnumerable<SecurityInsightsEntityRelationResource>, IAsyncEnumerable<SecurityInsightsEntityRelationResource>
    {
        ...
        internal SecurityInsightsEntityRelationCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _entityRelationsRestClient = new EntityRelations(_entityRelationsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, securityInsightsEntityRelationApiVersion ?? "2025-07-01-preview");
            ...
            _entitiesRelationsRestClient = new EntitiesRelations(_entitiesRelationsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, securityInsightsEntityRelationApiVersion ?? "2025-07-01-preview");
        ...
        internal static void ValidateResourceId(ResourceIdentifier id)
        {
            ...
            {
                throw new ArgumentException(string.Format("Invalid resource type {0} expected {1}", id.ResourceType, SecurityInsightsEntityResource.ResourceType), nameof(id));
            }
        }
