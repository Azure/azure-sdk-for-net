...
namespace Azure.ResourceManager.SecurityInsights
{
    ...
    /// Otherwise you can get one from its parent resource <see cref="OperationalInsightsWorkspaceSecurityInsightsResource"/> using the GetSourceControl method.
    /// </summary>
    public partial class SourceControlResource : ArmResource
    {
        ...
        {
            _sourceControlClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.SecurityInsights", ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<SourceControlResource>> UpdateAsync(WaitUntil waitUntil, SourceControlData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _sourceControlRestClient.CreateAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, data, cancellationToken).ConfigureAwait(false);
                var uri = _sourceControlRestClient.CreateCreateRequestUri(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, data);
        ...
        public virtual ArmOperation<SourceControlResource> Update(WaitUntil waitUntil, SourceControlData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _sourceControlRestClient.Create(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, data, cancellationToken);
                var uri = _sourceControlRestClient.CreateCreateRequestUri(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, data);
                var rehydrationToken = NextLinkOperationImplementation.GetRehydrationToken(RequestMethod.Put, uri.ToUri(), uri.ToString(), "None", null, OperationFinalStateVia.OriginalUri.ToString());
                var operation = new SecurityInsightsArmOperation<SourceControlResource>(Response.FromValue(new SourceControlResource(Client, response), response.GetRawResponse()), rehydrationToken);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<Response<Warning>> DeleteAsync(RepositoryAccessProperties repositoryAccess, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _sourceControlRestClient.DeleteAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, repositoryAccess, cancellationToken).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="repositoryAccess"/> is null. </exception>
        public virtual Response<Warning> Delete(RepositoryAccessProperties repositoryAccess, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(repositoryAccess, nameof(repositoryAccess));
            ...
            try
            {
                var response = _sourceControlRestClient.Delete(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, repositoryAccess, cancellationToken);
                return response;
            }
            catch (Exception e)
            {
