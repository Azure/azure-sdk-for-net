...
namespace Azure.ResourceManager.SecurityInsights
{
    ...
    public partial class SecurityInsightsHuntRelationCollection : ArmCollection, IEnumerable<SecurityInsightsHuntRelationResource>, IAsyncEnumerable<SecurityInsightsHuntRelationResource>
    {
        ...
        internal SecurityInsightsHuntRelationCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _huntRelationsRestClient = new HuntRelations(_huntRelationsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, securityInsightsHuntRelationApiVersion ?? "2025-07-01-preview");
        ...
        public virtual AsyncPageable<SecurityInsightsHuntRelationResource> GetAllAsync(string filter = default, string @orderby = default, int? top = default, string skipToken = default, CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<SecurityInsightsHuntRelationData, SecurityInsightsHuntRelationResource>(new HuntRelationsGetAllAsyncCollectionResultOfT(
                ...
                skipToken,
                context,
                "SecurityInsightsHuntRelationCollection.GetAll"), data => new SecurityInsightsHuntRelationResource(Client, data));
        }
