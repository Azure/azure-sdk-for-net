...
namespace Azure.ResourceManager.SecurityInsights
{
    ...
    /// Please note <see cref="AlertRuleData"/> is the base class. According to the scenario, a derived class of the base class might need to be assigned here, or this property needs to be casted to one of the possible derived classes.
    ...
    public partial class AlertRuleData : ResourceData
    {
        ...
        internal AlertRuleData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, AlertRuleKind kind, ETag? etag) : base(id, name, resourceType, systemData)
        {
            Kind = kind;
            ETag = etag;
        }
