...
namespace Azure.ResourceManager.SecurityInsights
{
    ...
    public abstract partial class SecurityInsightsSettingData : ResourceData
    {
        ...
        private protected SecurityInsightsSettingData(SettingKind kind)
        {
            Kind = kind;
        }
        ...
        internal SecurityInsightsSettingData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, SettingKind kind, ETag? eTag, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, name, resourceType, systemData)
        {
            Kind = kind;
            ETag = eTag;
