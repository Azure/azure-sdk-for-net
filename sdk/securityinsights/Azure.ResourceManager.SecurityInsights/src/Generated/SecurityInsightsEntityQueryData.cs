...
namespace Azure.ResourceManager.SecurityInsights
{
    ...
    public abstract partial class SecurityInsightsEntityQueryData : ResourceData
    {
        ...
        private protected SecurityInsightsEntityQueryData(EntityQueryKind kind)
        {
            Kind = kind;
        }
        ...
        internal SecurityInsightsEntityQueryData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, EntityQueryKind kind, string eTag) : base(id, name, resourceType, systemData)
        {
