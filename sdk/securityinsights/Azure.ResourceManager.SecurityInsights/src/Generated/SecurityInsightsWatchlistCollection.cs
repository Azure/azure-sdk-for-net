...
namespace Azure.ResourceManager.SecurityInsights
{
    ...
    /// Each <see cref="SecurityInsightsWatchlistResource"/> in the collection will belong to the same instance of <see cref="ArmResource"/>.
    /// To get a <see cref="SecurityInsightsWatchlistCollection"/> instance call the GetSecurityInsightsWatchlists method from an instance of <see cref="ArmResource"/>.
    /// </summary>
    public partial class SecurityInsightsWatchlistCollection : ArmCollection, IEnumerable<SecurityInsightsWatchlistResource>, IAsyncEnumerable<SecurityInsightsWatchlistResource>
    {
        ...
        internal SecurityInsightsWatchlistCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _watchlistsRestClient = new Watchlists(_watchlistsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, securityInsightsWatchlistApiVersion ?? "2025-10-01-preview");
        ...
        public virtual async Task<ArmOperation<SecurityInsightsWatchlistResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string watchlistAlias, SecurityInsightsWatchlistData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _watchlistsRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, watchlistAlias, SecurityInsightsWatchlistData.ToRequestContent(data), context);
                ...
                SecurityInsightsArmOperation<SecurityInsightsWatchlistResource> operation = new SecurityInsightsArmOperation<SecurityInsightsWatchlistResource>(
                    new SecurityInsightsWatchlistResourceOperationSource(Client),
        ...
        public virtual async Task<Response<SecurityInsightsWatchlistResource>> GetAsync(string watchlistAlias, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _watchlistsRestClient.CreateGetRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, watchlistAlias, context);
        ...
        public virtual AsyncPageable<SecurityInsightsWatchlistResource> GetAllAsync(string skipToken = default, CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<SecurityInsightsWatchlistData, SecurityInsightsWatchlistResource>(new WatchlistsGetAllAsyncCollectionResultOfT(
                ...
                skipToken,
                context,
                "SecurityInsightsWatchlistCollection.GetAll"), data => new SecurityInsightsWatchlistResource(Client, data));
        }
