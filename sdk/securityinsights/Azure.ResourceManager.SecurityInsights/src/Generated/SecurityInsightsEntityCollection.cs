...
namespace Azure.ResourceManager.SecurityInsights
{
    ...
    /// Each <see cref="SecurityInsightsEntityResource"/> in the collection will belong to the same instance of <see cref="ArmResource"/>.
    /// To get a <see cref="SecurityInsightsEntityCollection"/> instance call the GetSecurityInsightsEntities method from an instance of <see cref="ArmResource"/>.
    /// </summary>
    public partial class SecurityInsightsEntityCollection : ArmCollection, IEnumerable<SecurityInsightsEntityResource>, IAsyncEnumerable<SecurityInsightsEntityResource>
    {
        ...
        internal SecurityInsightsEntityCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _entitiesRestClient = new Entities(_entitiesClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, securityInsightsEntityApiVersion ?? "2025-07-01-preview");
        ...
        public virtual async Task<Response<SecurityInsightsEntityResource>> GetAsync(string entityId, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _entitiesRestClient.CreateGetRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, entityId, context);
        ...
        public virtual AsyncPageable<SecurityInsightsEntityResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<SecurityInsightsEntity, SecurityInsightsEntityResource>(new EntitiesGetAllAsyncCollectionResultOfT(
                ...
                Id.Name,
                context,
                "SecurityInsightsEntityCollection.GetAll"), data => new SecurityInsightsEntityResource(Client, data));
        }
