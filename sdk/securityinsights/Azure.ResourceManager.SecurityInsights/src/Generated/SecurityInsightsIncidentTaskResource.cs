...
namespace Azure.ResourceManager.SecurityInsights
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="SecurityInsightsIncidentTaskResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="SecurityInsightsIncidentResource"/> using the GetSecurityInsightsIncidentTasks method.
    /// </summary>
    public partial class SecurityInsightsIncidentTaskResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of SecurityInsightsIncidentTaskResource for mocking. </summary>
        protected SecurityInsightsIncidentTaskResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="SecurityInsightsIncidentTaskResource"/> class. </summary>
        ...
        {
            TryGetApiVersion(ResourceType, out string securityInsightsIncidentTaskApiVersion);
            _incidentTasksClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.SecurityInsights", ResourceType.Namespace, Diagnostics);
        ...
        {
            string resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OperationalInsights/workspaces/{workspaceName}/providers/Microsoft.SecurityInsights/incidents/{incidentId}/tasks/{incidentTaskId}";
        ...
        {
            using DiagnosticScope scope = _incidentTasksClientDiagnostics.CreateScope("SecurityInsightsIncidentTaskResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _incidentTasksRestClient.CreateGetRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, context);
        ...
        {
            using DiagnosticScope scope = _incidentTasksClientDiagnostics.CreateScope("SecurityInsightsIncidentTaskResource.Delete");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _incidentTasksRestClient.CreateDeleteRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, context);
        ...
        /// <summary>
        /// Update a SecurityInsightsIncidentTask.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OperationalInsights/workspaces/{workspaceName}/providers/Microsoft.SecurityInsights/incidents/{incidentId}/tasks/{incidentTaskId}. </description>
        ...
        public virtual async Task<ArmOperation<SecurityInsightsIncidentTaskResource>> UpdateAsync(WaitUntil waitUntil, SecurityInsightsIncidentTaskData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _incidentTasksClientDiagnostics.CreateScope("SecurityInsightsIncidentTaskResource.Update");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _incidentTasksRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, SecurityInsightsIncidentTaskData.ToRequestContent(data), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<SecurityInsightsIncidentTaskData> response = Response.FromValue(SecurityInsightsIncidentTaskData.FromResponse(result), result);
                RequestUriBuilder uri = message.Request.Uri;
