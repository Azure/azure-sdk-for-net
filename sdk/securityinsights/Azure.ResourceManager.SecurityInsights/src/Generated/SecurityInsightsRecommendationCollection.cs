...
namespace Azure.ResourceManager.SecurityInsights
{
    ...
    /// Each <see cref="SecurityInsightsRecommendationResource"/> in the collection will belong to the same instance of <see cref="ArmResource"/>.
    /// To get a <see cref="SecurityInsightsRecommendationCollection"/> instance call the GetSecurityInsightsRecommendations method from an instance of <see cref="ArmResource"/>.
    /// </summary>
    public partial class SecurityInsightsRecommendationCollection : ArmCollection, IEnumerable<SecurityInsightsRecommendationResource>, IAsyncEnumerable<SecurityInsightsRecommendationResource>
    {
        ...
        public virtual async Task<Response<SecurityInsightsRecommendationResource>> GetAsync(string recommendationId, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _getRestClient.CreateSingleRecommendationRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, recommendationId, context);
        ...
        public virtual AsyncPageable<SecurityInsightsRecommendationResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<SecurityInsightsRecommendationData, SecurityInsightsRecommendationResource>(new GetRecommendationsGetAllAsyncCollectionResultOfT(
                ...
                Id.Name,
                context,
                "SecurityInsightsRecommendationCollection.GetAll"), data => new SecurityInsightsRecommendationResource(Client, data));
        }
