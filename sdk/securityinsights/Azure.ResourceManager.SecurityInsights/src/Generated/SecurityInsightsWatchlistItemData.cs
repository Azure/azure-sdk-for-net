...
namespace Azure.ResourceManager.SecurityInsights
{
    ...
    public partial class SecurityInsightsWatchlistItemData : ResourceData
    {
        ...
        internal SecurityInsightsWatchlistItemData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, WatchlistItemProperties properties, ETag? eTag, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, name, resourceType, systemData)
        {
        ...
        public IDictionary<string, BinaryData> ItemsKeyValueDictionary
        {
            get
            {
                if (Properties is null)
                ...
                return Properties.ItemsKeyValueDictionary;
            }
        }

        /// <summary> key-value pairs for a watchlist item entity mapping. </summary>
        [WirePath("properties.entityMapping")]
        public IDictionary<string, BinaryData> EntityMappingDictionary
        {
            get
            {
                if (Properties is null)
                ...
                return Properties.EntityMappingDictionary;
            }
        }
    }
}
