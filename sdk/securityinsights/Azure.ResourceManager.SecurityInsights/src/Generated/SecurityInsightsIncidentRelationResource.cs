...
namespace Azure.ResourceManager.SecurityInsights
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="SecurityInsightsIncidentRelationResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="SecurityInsightsIncidentResource"/> using the GetSecurityInsightsIncidentRelations method.
    /// </summary>
    public partial class SecurityInsightsIncidentRelationResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of SecurityInsightsIncidentRelationResource for mocking. </summary>
        protected SecurityInsightsIncidentRelationResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="SecurityInsightsIncidentRelationResource"/> class. </summary>
        ...
        internal SecurityInsightsIncidentRelationResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _incidentRelationsRestClient = new IncidentRelations(_incidentRelationsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, securityInsightsIncidentRelationApiVersion ?? "2025-10-01-preview");
        ...
        {
            using DiagnosticScope scope = _incidentRelationsClientDiagnostics.CreateScope("SecurityInsightsIncidentRelationResource.Get");
            scope.Start();
            try
            {
        ...
        {
            using DiagnosticScope scope = _incidentRelationsClientDiagnostics.CreateScope("SecurityInsightsIncidentRelationResource.Delete");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        /// <summary>
        /// Update a SecurityInsightsIncidentRelation.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OperationalInsights/workspaces/{workspaceName}/providers/Microsoft.SecurityInsights/incidents/{incidentId}/relations/{relationName}. </description>
        ...
        public virtual async Task<ArmOperation<SecurityInsightsIncidentRelationResource>> UpdateAsync(WaitUntil waitUntil, SecurityInsightsIncidentRelationData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _incidentRelationsClientDiagnostics.CreateScope("SecurityInsightsIncidentRelationResource.Update");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
