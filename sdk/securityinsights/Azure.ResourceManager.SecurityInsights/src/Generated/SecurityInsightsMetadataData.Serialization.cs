...
{
    public partial class SecurityInsightsMetadataData : IUtf8JsonSerializable, IJsonModel<SecurityInsightsMetadataData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SecurityInsightsMetadataData>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<SecurityInsightsMetadataData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        SecurityInsightsMetadataData IJsonModel<SecurityInsightsMetadataData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<SecurityInsightsMetadataData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static SecurityInsightsMetadataData DeserializeSecurityInsightsMetadataData(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<SecurityInsightsMetadataData>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<SecurityInsightsMetadataData>)this).GetFormatFromOptions(options) : options.Format;
        ...
        SecurityInsightsMetadataData IPersistableModel<SecurityInsightsMetadataData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<SecurityInsightsMetadataData>)this).GetFormatFromOptions(options) : options.Format;
