    ...
    public partial class SecurityInsightsAlertRuleActionCollection : ArmCollection, IEnumerable<SecurityInsightsAlertRuleActionResource>, IAsyncEnumerable<SecurityInsightsAlertRuleActionResource>
    {
        ...
        public virtual async Task<ArmOperation<SecurityInsightsAlertRuleActionResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string actionId, SecurityInsightsAlertRuleActionCreateOrUpdateContent content, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new SecurityInsightsArmOperation<SecurityInsightsAlertRuleActionResource>(Response.FromValue(new SecurityInsightsAlertRuleActionResource(Client, response), response.GetRawResponse()), operationId);
