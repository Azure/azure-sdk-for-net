...
namespace Azure.ResourceManager.SecurityInsights.Mocking
{
    ...
    internal partial class SecurityInsightsArmClientMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="SecurityInsightsArmClientMockingExtension"/> class for mocking. </summary>
        protected SecurityInsightsArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="SecurityInsightsArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal SecurityInsightsArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal SecurityInsightsArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
