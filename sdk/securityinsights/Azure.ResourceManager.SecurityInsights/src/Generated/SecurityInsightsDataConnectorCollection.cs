...
namespace Azure.ResourceManager.SecurityInsights
{
    ...
    /// Each <see cref="SecurityInsightsDataConnectorResource"/> in the collection will belong to the same instance of <see cref="ArmResource"/>.
    /// To get a <see cref="SecurityInsightsDataConnectorCollection"/> instance call the GetSecurityInsightsDataConnectors method from an instance of <see cref="ArmResource"/>.
    /// </summary>
    public partial class SecurityInsightsDataConnectorCollection : ArmCollection, IEnumerable<SecurityInsightsDataConnectorResource>, IAsyncEnumerable<SecurityInsightsDataConnectorResource>
    {
        ...
        internal SecurityInsightsDataConnectorCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _dataConnectorsRestClient = new DataConnectors(_dataConnectorsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, securityInsightsDataConnectorApiVersion ?? "2025-07-01-preview");
        ...
        public virtual async Task<ArmOperation<SecurityInsightsDataConnectorResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string dataConnectorId, SecurityInsightsDataConnectorData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _dataConnectorsRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, dataConnectorId, SecurityInsightsDataConnectorData.ToRequestContent(data), context);
        ...
        public virtual async Task<Response<SecurityInsightsDataConnectorResource>> GetAsync(string dataConnectorId, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _dataConnectorsRestClient.CreateGetRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, dataConnectorId, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<SecurityInsightsDataConnectorData> response = Response.FromValue(SecurityInsightsDataConnectorData.FromResponse(result), result);
        ...
        public virtual AsyncPageable<SecurityInsightsDataConnectorResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<SecurityInsightsDataConnectorData, SecurityInsightsDataConnectorResource>(new DataConnectorsGetAllAsyncCollectionResultOfT(
                ...
                Id.Name,
                context,
                "SecurityInsightsDataConnectorCollection.GetAll"), data => new SecurityInsightsDataConnectorResource(Client, data));
        }
