...
{
    public partial class ProductPackageModelData : IUtf8JsonSerializable, IJsonModel<ProductPackageModelData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ProductPackageModelData>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<ProductPackageModelData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ProductPackageModelData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        ProductPackageModelData IJsonModel<ProductPackageModelData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ProductPackageModelData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static ProductPackageModelData DeserializeProductPackageModelData(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<ProductPackageModelData>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ProductPackageModelData>)this).GetFormatFromOptions(options) : options.Format;
        ...
        ProductPackageModelData IPersistableModel<ProductPackageModelData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ProductPackageModelData>)this).GetFormatFromOptions(options) : options.Format;
