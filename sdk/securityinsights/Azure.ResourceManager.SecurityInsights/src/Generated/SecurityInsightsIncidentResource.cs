...
namespace Azure.ResourceManager.SecurityInsights
{
    ...
    /// Otherwise you can get one from its parent resource <see cref="ArmResource"/> using the GetSecurityInsightsIncidents method.
    /// </summary>
    public partial class SecurityInsightsIncidentResource : ArmResource
    {
        ...
        public virtual AsyncPageable<SecurityInsightsAlert> GetAlertsAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new IncidentsGetAlertsAsyncCollectionResultOfT(
                ...
                Id.Name,
                context,
                "SecurityInsightsIncidentResource.GetAlerts");
        }
        ...
        public virtual AsyncPageable<SecurityInsightsHuntingBookmark> GetBookmarksAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new IncidentsGetBookmarksAsyncCollectionResultOfT(
                ...
                Id.Name,
                context,
                "SecurityInsightsIncidentResource.GetBookmarks");
        }
        ...
        {
            using DiagnosticScope scope = _incidentsClientDiagnostics.CreateScope("SecurityInsightsIncidentResource.GetEntitiesResult");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _incidentsRestClient.CreateGetEntitiesResultRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        /// <summary> Gets a collection of SecurityInsightsIncidentRelations in the <see cref="SecurityInsightsIncidentResource"/>. </summary>
        /// <returns> An object representing collection of SecurityInsightsIncidentRelations and their operations over a SecurityInsightsIncidentRelationResource. </returns>
