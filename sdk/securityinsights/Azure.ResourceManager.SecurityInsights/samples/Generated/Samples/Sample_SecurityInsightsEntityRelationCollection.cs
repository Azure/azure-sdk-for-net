...
{
    public partial class Sample_SecurityInsightsEntityRelationCollection
    {
        // Get all relations of an entity.
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task GetAll_GetAllRelationsOfAnEntity()
        {
        ...
        public async Task Get_GetAnEntityRelation()
        {
            ...
            SecurityInsightsEntityRelationResource result = await collection.GetAsync(relationName);
        ...
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task Exists_GetAnEntityRelation()
        {
            // Generated from example definition: specification/securityinsights/resource-manager/Microsoft.SecurityInsights/preview/2024-01-01-preview/examples/entities/relations/GetEntityRelationByName.json
            // this example is just showing the usage of "EntityRelations_GetRelation" operation, for the dependent resources, they will have to be created separately.
        ...
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task GetIfExists_GetAnEntityRelation()
        {
            // Generated from example definition: specification/securityinsights/resource-manager/Microsoft.SecurityInsights/preview/2024-01-01-preview/examples/entities/relations/GetEntityRelationByName.json
            // this example is just showing the usage of "EntityRelations_GetRelation" operation, for the dependent resources, they will have to be created separately.
            ...
            // invoke the operation
            string relationName = "4bb36b7b-26ff-4d1c-9cbe-0d8ab3da0014";
            NullableResponse<SecurityInsightsEntityRelationResource> response = await collection.GetIfExistsAsync(relationName);
            SecurityInsightsEntityRelationResource result = response.HasValue ? response.Value : null;
