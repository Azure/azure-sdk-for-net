...
namespace Azure.ResourceManager.SecurityInsights.Tests.TestCase
{
    public class DataConnectorResourceTests : SecurityInsightsManagementTestBase
    {
        ...
        #endregion
        private async Task<SecurityInsightsDataConnectorResource> CreateDataConnectorAsync(ResourceIdentifier operationalInsights, string dataName)
        {
            var collection = Client.GetSecurityInsightsDataConnectors(operationalInsights);
