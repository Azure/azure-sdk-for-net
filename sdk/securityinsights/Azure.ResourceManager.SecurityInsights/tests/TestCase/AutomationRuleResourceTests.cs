...
namespace Azure.ResourceManager.SecurityInsights.Tests.TestCase
{
    public class AutomationRuleResourceTests : SecurityInsightsManagementTestBase
    {
        ...
        private async Task<SecurityInsightsAutomationRuleResource> CreateAutomationRuleAsync(ResourceIdentifier operationalInsights, string automationName)
        {
            var collection = Client.GetSecurityInsightsAutomationRules(operationalInsights);
        ...
        public async Task AutomationRuleResourceApiTests()
        {
            ...
            //1.Get
            var automationName = GenerateAssetNameFromRecording("testautomationrule-", "automationRules");
