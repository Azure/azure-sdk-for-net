...
namespace Azure.ResourceManager.SecurityInsights.Tests.TestCase
{
    public class SIAlertRuleCollectionTests : SecurityInsightsManagementTestBase
    {
        ...
        #endregion
        private SecurityInsightsAlertRuleCollection GetSecurityInsightsAlertRuleCollectionAsync(ResourceIdentifier operationalInsights)
        {
            return Client.GetSecurityInsightsAlertRules(operationalInsights);
        }
