...
namespace Azure.ResourceManager.SecurityInsights.Tests.TestCase
{
    public class BookmarkResourceTests : SecurityInsightsManagementTestBase
    {
        ...
        #endregion
        private async Task<SecurityInsightsBookmarkResource> CreateBookmarkAsync(ResourceIdentifier operationalInsights, string bookmarkName)
        {
            var collection = Client.GetSecurityInsightsBookmarks(operationalInsights);
