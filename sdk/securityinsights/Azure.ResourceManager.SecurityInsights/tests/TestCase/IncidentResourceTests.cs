...
namespace Azure.ResourceManager.SecurityInsights.Tests.TestCase
{
    public class IncidentResourceTests : SecurityInsightsManagementTestBase
    {
        ...
        #endregion
        private async Task<SecurityInsightsIncidentResource> CreateIncidentAsync(ResourceIdentifier operationalInsights, string incidentName)
        {
            var collection = Client.GetSecurityInsightsIncidents(operationalInsights);
