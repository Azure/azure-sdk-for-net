...
namespace Azure.ResourceManager.SecurityInsights.Tests.TestCase
{
    public class WatchlistItemResourceTests : SecurityInsightsManagementTestBase
    {
        ...
        #endregion
        private async Task<SecurityInsightsWatchlistItemResource> CreateWatchlistItemAsync(ResourceIdentifier operationalInsights, string itemName)
        {
            var collection = Client.GetSecurityInsightsWatchlists(operationalInsights);
