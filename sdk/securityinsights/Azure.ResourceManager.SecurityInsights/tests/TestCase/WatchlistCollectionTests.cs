...
namespace Azure.ResourceManager.SecurityInsights.Tests.TestCase
{
    public class WatchlistCollectionTests : SecurityInsightsManagementTestBase
    {
        ...
        #endregion
        private WatchlistCollection GetWatchlistCollectionAsync(ResourceGroupResource resourceGroup, string workspaceName)
        {
        ...
        public async Task WatchlistCollectionApiTests()
        {
            ...
            //1.CreateOrUpdate
            var collection = GetWatchlistCollectionAsync(resourceGroup, workspace.Data.Name);
