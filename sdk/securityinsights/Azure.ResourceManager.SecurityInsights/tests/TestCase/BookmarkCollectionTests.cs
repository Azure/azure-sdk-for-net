...
namespace Azure.ResourceManager.SecurityInsights.Tests.TestCase
{
    public class BookmarkCollectionTests : SecurityInsightsManagementTestBase
    {
        ...
        private SecurityInsightsBookmarkCollection GetBookmarkCollectionAsync(ResourceIdentifier operationalInsights)
        {
            return Client.GetSecurityInsightsBookmarks(operationalInsights);
        }
