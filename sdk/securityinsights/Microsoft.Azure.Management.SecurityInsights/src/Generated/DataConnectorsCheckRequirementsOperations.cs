...
namespace Microsoft.Azure.Management.SecurityInsights
{
    ...
    internal partial class DataConnectorsCheckRequirementsOperations : IServiceOperations<SecurityInsights>, IDataConnectorsCheckRequirementsOperations
    {
        ...
        /// </return>
        public async Task<AzureOperationResponse<DataConnectorRequirementsState>> PostWithHttpMessagesAsync(string resourceGroupName, string workspaceName, DataConnectorsCheckRequirements dataConnectorsCheckRequirements, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "dataConnectorsCheckRequirements");
            }
            // Tracing
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OperationalInsights/workspaces/{workspaceName}/providers/Microsoft.SecurityInsights/dataConnectorsCheckRequirements").ToString();
            ...
            if(dataConnectorsCheckRequirements != null)
            {
                _requestContent = Rest.Serialization.SafeJsonConvert.SerializeObject(dataConnectorsCheckRequirements, Client.SerializationSettings);
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<DataConnectorRequirementsState>(_responseContent, Client.DeserializationSettings);
                }
