...
namespace Microsoft.Azure.Management.SecurityInsights
{
    ...
    public static partial class IncidentCommentsOperationsExtensions
    {
            ...
            /// The comment message
            /// </param>
            public static IncidentComment CreateComment(this IIncidentCommentsOperations operations, string resourceGroupName, string operationalInsightsResourceProvider, string workspaceName, string incidentId, string incidentCommentId, string message)
            {
                return operations.CreateCommentAsync(resourceGroupName, operationalInsightsResourceProvider, workspaceName, incidentId, incidentCommentId, message).GetAwaiter().GetResult();
            }
            ...
            {
                using (var _result = await operations.CreateCommentWithHttpMessagesAsync(resourceGroupName, operationalInsightsResourceProvider, workspaceName, incidentId, incidentCommentId, message, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
