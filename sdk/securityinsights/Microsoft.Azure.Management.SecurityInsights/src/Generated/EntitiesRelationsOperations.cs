...
namespace Microsoft.Azure.Management.SecurityInsights
{
    ...
    /// </summary>
    internal partial class EntitiesRelationsOperations : IServiceOperations<SecurityInsightsClient>, IEntitiesRelationsOperations
    {
        /// <summary>
        /// Initializes a new instance of the EntitiesRelationsOperations class.
        /// </summary>
        /// <param name='client'>
        ...
        /// </exception>
        internal EntitiesRelationsOperations(SecurityInsightsClient client)
        {
            if (client == null)
            {
        ...
        public async Task<AzureOperationResponse<IPage<Relation>>> ListWithHttpMessagesAsync(string resourceGroupName, string workspaceName, string entityId, ODataQuery<Relation> odataQuery = default(ODataQuery<Relation>), string skipToken = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Create Result
            var _result = new AzureOperationResponse<IPage<Relation>>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<Page<Relation>>(_responseContent, Client.DeserializationSettings);
                }
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<IPage<Relation>>> ListNextWithHttpMessagesAsync(string nextPageLink, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
