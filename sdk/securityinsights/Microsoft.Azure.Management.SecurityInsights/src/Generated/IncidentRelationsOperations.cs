...
namespace Microsoft.Azure.Management.SecurityInsights
{
    ...
    internal partial class IncidentRelationsOperations : IServiceOperations<SecurityInsightsClient>, IIncidentRelationsOperations
    {
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<Relation>> CreateOrUpdateRelationWithHttpMessagesAsync(string resourceGroupName, string operationalInsightsResourceProvider, string workspaceName, string incidentId, string relationName, Relation relation, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (Client.SubscriptionId == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "this.Client.SubscriptionId");
