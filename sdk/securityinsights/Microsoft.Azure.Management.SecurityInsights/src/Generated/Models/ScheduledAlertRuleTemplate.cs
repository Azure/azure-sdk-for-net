...
namespace Microsoft.Azure.Management.SecurityInsights.Models
{
    ...
    public partial class ScheduledAlertRuleTemplate : AlertRuleTemplate
    {
        ...
        /// template</param>
        public ScheduledAlertRuleTemplate(int alertRulesCreatedByTemplateCount, string description, string displayName, string status, string query, System.TimeSpan queryFrequency, System.TimeSpan queryPeriod, string severity, TriggerOperator triggerOperator, int triggerThreshold, string id = default(string), string name = default(string), string type = default(string), System.DateTime? createdDateUTC = default(System.DateTime?), IList<DataConnectorStatus> requiredDataConnectors = default(IList<DataConnectorStatus>), IList<string> tactics = default(IList<string>))
            : base(id, name, type)
        {
        ...
        public IList<DataConnectorStatus> RequiredDataConnectors { get; set; }
