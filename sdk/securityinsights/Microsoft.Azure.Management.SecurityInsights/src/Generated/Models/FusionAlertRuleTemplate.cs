...
namespace Microsoft.Azure.Management.SecurityInsights.Models
{
    ...
    public partial class FusionAlertRuleTemplate : AlertRuleTemplate
    {
        ...
        /// template</param>
        public FusionAlertRuleTemplate(string severity, string id = default(string), string name = default(string), string type = default(string), int? alertRulesCreatedByTemplateCount = default(int?), System.DateTime? createdDateUTC = default(System.DateTime?), string description = default(string), string displayName = default(string), IList<DataConnectorStatus> requiredDataConnectors = default(IList<DataConnectorStatus>), string status = default(string), IList<string> tactics = default(IList<string>))
            : base(id, name, type)
        {
