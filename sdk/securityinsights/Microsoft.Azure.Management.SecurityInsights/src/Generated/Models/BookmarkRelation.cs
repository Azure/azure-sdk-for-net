...
namespace Microsoft.Azure.Management.SecurityInsights.Models
{
    ...
    public partial class BookmarkRelation : RelationBase
    {
        /// <summary>
        /// Initializes a new instance of the BookmarkRelation class.
        /// </summary>
        public BookmarkRelation()
        {
            CustomInit();
        }
        ...
        /// <param name="caseSeverity">The case severity</param>
        public BookmarkRelation(string relationName, string bookmarkId, string caseIdentifier, string id = default(string), string name = default(string), string type = default(string), string kind = default(string), string etag = default(string), string caseTitle = default(string), string caseSeverity = default(string))
        ...
        /// </summary>
        [JsonProperty(PropertyName = "properties.caseTitle")]
        public string CaseTitle { get; set; }

        /// <summary>
        /// Gets or sets the case severity
        /// </summary>
        [JsonProperty(PropertyName = "properties.caseSeverity")]
