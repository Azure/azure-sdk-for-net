...
namespace Microsoft.Azure.Management.SecurityInsights.Models
{
    ...
    public partial class MicrosoftSecurityIncidentCreationAlertRuleTemplate : AlertRuleTemplate
    {
        ...
        public MicrosoftSecurityIncidentCreationAlertRuleTemplate(int alertRulesCreatedByTemplateCount, System.DateTime createdDateUTC, string description, string displayName, string status, string productFilter, string id = default(string), string name = default(string), string type = default(string), IList<DataConnectorStatus> requiredDataConnectors = default(IList<DataConnectorStatus>), IList<string> tactics = default(IList<string>), IList<string> displayNamesFilter = default(IList<string>), IList<string> severitiesFilter = default(IList<string>))
            : base(id, name, type)
        {
