...
namespace Microsoft.Azure.Management.SecurityInsights.Models
{
    ...
    public partial class OfficePowerBIDataConnector : DataConnector
    {
        /// <summary>
        /// Initializes a new instance of the OfficePowerBIDataConnector class.
        /// </summary>
        ...
        public OfficePowerBIDataConnector(string tenantId, OfficePowerBIConnectorDataTypes dataTypes, string id = default(string), string name = default(string), string type = default(string), SystemData systemData = default(SystemData), string etag = default(string))
        ...
        public OfficePowerBIConnectorDataTypes DataTypes { get; set; }
