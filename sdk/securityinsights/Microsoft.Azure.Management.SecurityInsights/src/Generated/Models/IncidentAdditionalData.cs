...
namespace Microsoft.Azure.Management.SecurityInsights.Models
{
    ...
    public partial class IncidentAdditionalData
    {
        ...
        /// the incident</param>
        public IncidentAdditionalData(int? alertsCount = default(int?), int? bookmarksCount = default(int?), int? commentsCount = default(int?), IList<string> alertProductNames = default(IList<string>))
        {
