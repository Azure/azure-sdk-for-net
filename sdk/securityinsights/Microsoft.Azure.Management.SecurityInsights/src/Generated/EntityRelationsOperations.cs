...
namespace Microsoft.Azure.Management.SecurityInsights
{
    ...
    /// </summary>
    internal partial class EntityRelationsOperations : IServiceOperations<SecurityInsightsClient>, IEntityRelationsOperations
    {
        /// <summary>
        /// Initializes a new instance of the EntityRelationsOperations class.
        /// </summary>
        /// <param name='client'>
        ...
        /// </exception>
        internal EntityRelationsOperations(SecurityInsightsClient client)
        {
            if (client == null)
            {
        ...
        public async Task<AzureOperationResponse<Relation>> GetRelationWithHttpMessagesAsync(string resourceGroupName, string workspaceName, string entityId, string relationName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if (_shouldTrace)
            {
                ...
                ServiceClientTracing.Enter(_invocationId, this, "GetRelation", tracingParameters);
            }
            // Construct URL
            ...
            // Create Result
            var _result = new AzureOperationResponse<Relation>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<Relation>(_responseContent, Client.DeserializationSettings);
                }
