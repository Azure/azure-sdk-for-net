...
namespace Microsoft.Azure.Management.SecurityInsights
{
    ...
    /// </summary>
    internal partial class CasesAggregationsOperations : IServiceOperations<SecurityInsightsClient>, ICasesAggregationsOperations
    {
        /// <summary>
        /// Initializes a new instance of the CasesAggregationsOperations class.
        /// </summary>
        /// <param name='client'>
        ...
        /// </exception>
        internal CasesAggregationsOperations(SecurityInsightsClient client)
        {
            if (client == null)
            {
        ...
        /// </return>
        public async Task<AzureOperationResponse<Aggregations>> GetWithHttpMessagesAsync(string resourceGroupName, string operationalInsightsResourceProvider, string workspaceName, string aggregationsName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if (aggregationsName == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "aggregationsName");
            }
            // Tracing
            ...
            if (_shouldTrace)
            {
                ...
                tracingParameters.Add("aggregationsName", aggregationsName);
                tracingParameters.Add("cancellationToken", cancellationToken);
                ServiceClientTracing.Enter(_invocationId, this, "Get", tracingParameters);
            }
            // Construct URL
            var _baseUrl = Client.BaseUri.AbsoluteUri;
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/{operationalInsightsResourceProvider}/workspaces/{workspaceName}/providers/Microsoft.SecurityInsights/aggregations/{aggregationsName}").ToString();
            ...
            _url = _url.Replace("{aggregationsName}", System.Uri.EscapeDataString(aggregationsName));
            ...
            // Create Result
            var _result = new AzureOperationResponse<Aggregations>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<Aggregations>(_responseContent, Client.DeserializationSettings);
                }
