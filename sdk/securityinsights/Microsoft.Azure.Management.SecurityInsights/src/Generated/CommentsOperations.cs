...
namespace Microsoft.Azure.Management.SecurityInsights
{
    ...
    /// </summary>
    internal partial class CommentsOperations : IServiceOperations<SecurityInsightsClient>, ICommentsOperations
    {
        /// <summary>
        /// Initializes a new instance of the CommentsOperations class.
        /// </summary>
        /// <param name='client'>
        ...
        /// </exception>
        internal CommentsOperations(SecurityInsightsClient client)
        {
            if (client == null)
            {
        ...
        public async Task<AzureOperationResponse<IPage<CaseComment>>> ListByCaseWithHttpMessagesAsync(string resourceGroupName, string operationalInsightsResourceProvider, string workspaceName, string caseId, ODataQuery<CaseComment> odataQuery = default(ODataQuery<CaseComment>), string skipToken = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if (_shouldTrace)
            {
                ...
                ServiceClientTracing.Enter(_invocationId, this, "ListByCase", tracingParameters);
            }
            // Construct URL
            var _baseUrl = Client.BaseUri.AbsoluteUri;
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/{operationalInsightsResourceProvider}/workspaces/{workspaceName}/providers/Microsoft.SecurityInsights/cases/{caseId}/comments").ToString();
            ...
            // Create Result
            var _result = new AzureOperationResponse<IPage<CaseComment>>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<Page<CaseComment>>(_responseContent, Client.DeserializationSettings);
                }
        ...
        /// </return>
        [System.Obsolete("This operation is deprecated. Please do not use it any longer.")]
        public async Task<AzureOperationResponse<IPage<CaseComment>>> ListByCaseNextWithHttpMessagesAsync(string nextPageLink, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if (_shouldTrace)
            {
                ...
                tracingParameters.Add("cancellationToken", cancellationToken);
                ServiceClientTracing.Enter(_invocationId, this, "ListByCaseNext", tracingParameters);
            }
            // Construct URL
