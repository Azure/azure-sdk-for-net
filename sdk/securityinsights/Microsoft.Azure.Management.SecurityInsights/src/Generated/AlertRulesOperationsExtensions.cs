...
namespace Microsoft.Azure.Management.SecurityInsights
{
    ...
    public static partial class AlertRulesOperationsExtensions
    {
            ...
            /// The action
            /// </param>
            public static ActionResponse CreateOrUpdateAction(this IAlertRulesOperations operations, string resourceGroupName, string operationalInsightsResourceProvider, string workspaceName, string ruleId, string actionId, ActionRequest action)
            {
                return operations.CreateOrUpdateActionAsync(resourceGroupName, operationalInsightsResourceProvider, workspaceName, ruleId, actionId, action).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<ActionResponse> CreateOrUpdateActionAsync(this IAlertRulesOperations operations, string resourceGroupName, string operationalInsightsResourceProvider, string workspaceName, string ruleId, string actionId, ActionRequest action, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.CreateOrUpdateActionWithHttpMessagesAsync(resourceGroupName, operationalInsightsResourceProvider, workspaceName, ruleId, actionId, action, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
