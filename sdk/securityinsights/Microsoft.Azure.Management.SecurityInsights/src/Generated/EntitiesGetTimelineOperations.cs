...
namespace Microsoft.Azure.Management.SecurityInsights
{
    ...
    internal partial class EntitiesGetTimelineOperations : IServiceOperations<SecurityInsightsClient>, IEntitiesGetTimelineOperations
    {
        ...
        /// </return>
        public async Task<AzureOperationResponse<EntityTimelineResponse>> ListWithHttpMessagesAsync(string resourceGroupName, string operationalInsightsResourceProvider, string workspaceName, string entityId, EntityTimelineParameters parameters, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/{operationalInsightsResourceProvider}/workspaces/{workspaceName}/providers/Microsoft.SecurityInsights/entities/{entityId}/getTimeline").ToString();
