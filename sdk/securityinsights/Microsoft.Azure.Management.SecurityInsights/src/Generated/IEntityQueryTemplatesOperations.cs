...
namespace Microsoft.Azure.Management.SecurityInsights
{
    ...
    /// </summary>
    public partial interface IEntityQueryTemplatesOperations
    {
        /// <summary>
        ...
        /// </param>
        /// <param name='kind'>
        /// The entity template query kind we want to fetch. Possible values
        /// include: 'Activity'
        /// </param>
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationResponse<IPage<EntityQueryTemplate>>> ListNextWithHttpMessagesAsync(string nextPageLink, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
    }
}
