...
namespace Azure.ResourceManager.ToolchainOrchestrator
{
    ...
    public partial class CatalogResource : ArmResource
    {
        ...
        {
            var resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ToolchainOrchestrator/catalogs/{catalogName}";
        ...
        public static readonly ResourceType ResourceType = "Microsoft.ToolchainOrchestrator/catalogs";
        ...
        {
            _catalogClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.ToolchainOrchestrator", ResourceType.Namespace, Diagnostics);
        ...
        /// <summary> Gets a collection of CatalogVersionResources in the Catalog. </summary>
        /// <returns> An object representing collection of CatalogVersionResources and their operations over a CatalogVersionResource. </returns>
        public virtual CatalogVersionCollection GetCatalogVersions()
        {
            return GetCachedClient(client => new CatalogVersionCollection(client, Id));
        }
        ...
        [ForwardsClientCalls]
        public virtual async Task<Response<CatalogVersionResource>> GetCatalogVersionAsync(string versionName, CancellationToken cancellationToken = default)
        {
            return await GetCatalogVersions().GetAsync(versionName, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <exception cref="ArgumentException"> <paramref name="versionName"/> is an empty string, and was expected to be non-empty. </exception>
        [ForwardsClientCalls]
        public virtual Response<CatalogVersionResource> GetCatalogVersion(string versionName, CancellationToken cancellationToken = default)
        {
            return GetCatalogVersions().Get(versionName, cancellationToken);
        }
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new ToolchainOrchestratorArmOperation(_catalogClientDiagnostics, Pipeline, _catalogRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name).Request, response, OperationFinalStateVia.Location);
        ...
        public virtual async Task<ArmOperation<CatalogResource>> UpdateAsync(WaitUntil waitUntil, CatalogPatch patch, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new ToolchainOrchestratorArmOperation<CatalogResource>(new CatalogOperationSource(Client), _catalogClientDiagnostics, Pipeline, _catalogRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, patch).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
