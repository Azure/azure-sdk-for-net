...
{
    /// <summary> The type used for updating tags in Diagnostic resources. </summary>
    public partial class DiagnosticPatch
    {
        ...
        internal DiagnosticPatch(IDictionary<string, string> tags, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Tags = tags;
