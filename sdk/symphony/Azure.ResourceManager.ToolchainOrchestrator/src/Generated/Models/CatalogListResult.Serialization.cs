...
namespace Azure.ResourceManager.ToolchainOrchestrator.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CatalogListResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CatalogListResult)} does not support writing '{format}' format.");
            }
        ...
        CatalogListResult IJsonModel<CatalogListResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CatalogListResult)} does not support reading '{format}' format.");
            }
        ...
        internal static CatalogListResult DeserializeCatalogListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("value"u8))
                {
                    ...
                    {
                        array.Add(CatalogData.DeserializeCatalogData(item, options));
                    }
                    value = array;
                    continue;
                }
            ...
            return new CatalogListResult(value, nextLink, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<CatalogListResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CatalogListResult)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        CatalogListResult IPersistableModel<CatalogListResult>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CatalogListResult)} does not support reading '{options.Format}' format.");
            }
        }
