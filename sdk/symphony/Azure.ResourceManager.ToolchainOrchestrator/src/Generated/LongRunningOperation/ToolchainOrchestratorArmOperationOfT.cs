...
#pragma warning disable SA1649 // File name should match first type name
    internal class ToolchainOrchestratorArmOperation<T> : ArmOperation<T>
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        /// <summary> Initializes a new instance of ToolchainOrchestratorArmOperation for mocking. </summary>
        protected ToolchainOrchestratorArmOperation()
        {
        }

        internal ToolchainOrchestratorArmOperation(Response<T> response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal ToolchainOrchestratorArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal<T>(NextLinkOperationImplementation.Create(source, nextLinkOperation), clientDiagnostics, response, "ToolchainOrchestratorArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
