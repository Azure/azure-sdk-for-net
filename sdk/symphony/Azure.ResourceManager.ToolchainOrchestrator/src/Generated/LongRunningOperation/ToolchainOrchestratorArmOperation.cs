...
#pragma warning disable SA1649 // File name should match first type name
    internal class ToolchainOrchestratorArmOperation : ArmOperation
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        internal ToolchainOrchestratorArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal ToolchainOrchestratorArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal(nextLinkOperation, clientDiagnostics, response, "ToolchainOrchestratorArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
