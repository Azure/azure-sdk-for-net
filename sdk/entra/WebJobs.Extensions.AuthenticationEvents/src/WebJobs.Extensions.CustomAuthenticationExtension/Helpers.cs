...
namespace Microsoft.Azure.WebJobs.Extensions.AuthenticationEvents
{
    internal static class Helpers
    {
        internal static EventDefinition GetEventDefintionFromPayload(string payload)
        {
            try
            {
                AuthEventJsonElement jPayload = new(payload);
        ...
        internal static ConcurrentDictionary<string, Type> _eventActions = new();
        ...
        internal static AuthEventAction GetEventActionForActionType(string actionType)
        {
            ...
            if (actionType != null && _eventActions.ContainsKey(actionType))
                return (AuthEventAction)Activator.CreateInstance(_eventActions[actionType]);
        ...
        {
            List<ValidationResult> objectValidations = new();
