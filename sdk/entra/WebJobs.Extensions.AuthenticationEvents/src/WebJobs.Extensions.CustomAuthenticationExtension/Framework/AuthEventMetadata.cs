...
namespace Microsoft.Azure.WebJobs.Extensions.AuthenticationEvents.Framework
{
    ...
    internal class AuthEventMetadata
    {
        ...
        internal string RequestSchema { get; set; }

        /// <summary>Gets or sets the response schema content.</summary>
        /// <value>The response schema content.</value>
        internal string ResponseSchema { get; set; }
