...
namespace Microsoft.Azure.WebJobs.Extensions.AuthenticationEvents
{
    ...
    internal static class TokenValidatorHelper
    {
        public static SupportedTokenSchemaVersions ParseSupportedTokenVersion(string version)
        {
            ...
            {
                throw new ArgumentException(string.Format(CultureInfo.CurrentCulture, AuthEventResource.Ex_Token_Version, version, String.Join(",", Enum.GetNames(typeof(SupportedTokenSchemaVersions)))));
            }
        }
    }
}
