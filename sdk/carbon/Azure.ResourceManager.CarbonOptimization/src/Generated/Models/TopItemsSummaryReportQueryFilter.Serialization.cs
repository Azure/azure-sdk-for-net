...
namespace Azure.ResourceManager.CarbonOptimization.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TopItemsSummaryReportQueryFilter>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<TopItemsSummaryReportQueryFilter>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(TopItemsSummaryReportQueryFilter)} does not support '{format}' format.");
            }
        ...
        internal static TopItemsSummaryReportQueryFilter DeserializeTopItemsSummaryReportQueryFilter(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new TopItemsSummaryReportQueryFilter(reportType, dateRange, subscriptionList, resourceGroupUrlList ?? new ChangeTrackingList<string>(), resourceTypeList ?? new ChangeTrackingList<string>(), locationList ?? new ChangeTrackingList<string>(), carbonScopeList, serializedAdditionalRawData, categoryType, topItems);
        }
        ...
        BinaryData IPersistableModel<TopItemsSummaryReportQueryFilter>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(TopItemsSummaryReportQueryFilter)} does not support '{options.Format}' format.");
            }
        }
