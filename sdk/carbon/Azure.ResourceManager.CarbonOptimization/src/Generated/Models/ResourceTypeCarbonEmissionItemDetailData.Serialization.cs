...
{
    public partial class ResourceTypeCarbonEmissionItemDetailData : IUtf8JsonSerializable, IJsonModel<ResourceTypeCarbonEmissionItemDetailData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ResourceTypeCarbonEmissionItemDetailData>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<ResourceTypeCarbonEmissionItemDetailData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ResourceTypeCarbonEmissionItemDetailData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ResourceTypeCarbonEmissionItemDetailData)} does not support writing '{format}' format.");
            }
        ...
        ResourceTypeCarbonEmissionItemDetailData IJsonModel<ResourceTypeCarbonEmissionItemDetailData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ResourceTypeCarbonEmissionItemDetailData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ResourceTypeCarbonEmissionItemDetailData)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeResourceTypeCarbonEmissionItemDetailData(document.RootElement, options);
        }

        internal static ResourceTypeCarbonEmissionItemDetailData DeserializeResourceTypeCarbonEmissionItemDetailData(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<ResourceTypeCarbonEmissionItemDetailData>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ResourceTypeCarbonEmissionItemDetailData>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ResourceTypeCarbonEmissionItemDetailData)} does not support writing '{options.Format}' format.");
            }
        }

        ResourceTypeCarbonEmissionItemDetailData IPersistableModel<ResourceTypeCarbonEmissionItemDetailData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ResourceTypeCarbonEmissionItemDetailData>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ResourceTypeCarbonEmissionItemDetailData)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<ResourceTypeCarbonEmissionItemDetailData>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
