...
namespace Azure.ResourceManager.CarbonOptimization.Models
{
    ...
    /// Please note <see cref="CarbonEmissionQueryContent"/> is the base class. According to the scenario, a derived class of the base class might need to be assigned here, or this property needs to be casted to one of the possible derived classes.
    /// The available derived classes include <see cref="ItemDetailsQueryContent"/>, <see cref="MonthlySummaryReportQueryContent"/>, <see cref="OverallSummaryReportQueryContent"/>, <see cref="TopItemsMonthlySummaryReportQueryContent"/> and <see cref="TopItemsSummaryReportQueryContent"/>.
    /// </summary>
    public abstract partial class CarbonEmissionQueryContent
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="CarbonEmissionQueryContent"/>. </summary>
        ...
        protected CarbonEmissionQueryContent(CarbonEmissionQueryDateRange dateRange, IEnumerable<string> subscriptionList, IEnumerable<CarbonEmissionQueryScope> carbonScopeList)
        {
        ...
        /// <summary> Initializes a new instance of <see cref="CarbonEmissionQueryContent"/> for deserialization. </summary>
        internal CarbonEmissionQueryContent()
        {
        }
        ...
        public IList<CarbonEmissionQueryScope> CarbonScopeList { get; }
    }
}
