...
namespace Azure.ResourceManager.CarbonOptimization.Models
{
    ...
    public partial class ResourceCarbonEmissionTopItemsSummary : CarbonEmission
    {
        ...
        internal ResourceCarbonEmissionTopItemsSummary(double totalCarbonEmission, double totalCarbonEmissionLastMonth, double changeRatioForLastMonth, double totalCarbonEmission12MonthsAgo, double changeRatioFor12Months, string itemName, CarbonEmissionCategoryType categoryType, string subscriptionId, string resourceGroup) : base(totalCarbonEmission, totalCarbonEmissionLastMonth, changeRatioForLastMonth, totalCarbonEmission12MonthsAgo, changeRatioFor12Months)
        {
