...
namespace Azure.ResourceManager.CarbonOptimization.Models
{
    ...
    public partial class CarbonEmissionTopItemMonthlySummary : CarbonEmission
    {
        ...
        internal CarbonEmissionTopItemMonthlySummary(double totalCarbonEmission, double totalCarbonEmissionLastMonth, double changeRatioForLastMonth, double totalCarbonEmission12MonthsAgo, double changeRatioFor12Months, string itemName, CarbonEmissionCategoryType categoryType, string date) : base(totalCarbonEmission, totalCarbonEmissionLastMonth, changeRatioForLastMonth, totalCarbonEmission12MonthsAgo, changeRatioFor12Months)
        {
        ...
        /// <param name="categoryType"> Item category. </param>
        /// <param name="date"> Month date. </param>
        internal CarbonEmissionTopItemMonthlySummary(string dataType, double totalCarbonEmission, double totalCarbonEmissionLastMonth, double changeRatioForLastMonth, double totalCarbonEmission12MonthsAgo, double changeRatioFor12Months, double? changeValueMonthOverMonth, IDictionary<string, BinaryData> serializedAdditionalRawData, string itemName, CarbonEmissionCategoryType categoryType, string date) : base(dataType, totalCarbonEmission, totalCarbonEmissionLastMonth, changeRatioForLastMonth, totalCarbonEmission12MonthsAgo, changeRatioFor12Months, changeValueMonthOverMonth, serializedAdditionalRawData)
        {
            ItemName = itemName;
            CategoryType = categoryType;
            Date = date;
