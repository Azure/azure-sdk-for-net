...
{
    public partial class ResourceGroupCarbonEmissionTopItemsSummaryData : IUtf8JsonSerializable, IJsonModel<ResourceGroupCarbonEmissionTopItemsSummaryData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ResourceGroupCarbonEmissionTopItemsSummaryData>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<ResourceGroupCarbonEmissionTopItemsSummaryData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        ResourceGroupCarbonEmissionTopItemsSummaryData IJsonModel<ResourceGroupCarbonEmissionTopItemsSummaryData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ResourceGroupCarbonEmissionTopItemsSummaryData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static ResourceGroupCarbonEmissionTopItemsSummaryData DeserializeResourceGroupCarbonEmissionTopItemsSummaryData(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        ResourceGroupCarbonEmissionTopItemsSummaryData IPersistableModel<ResourceGroupCarbonEmissionTopItemsSummaryData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ResourceGroupCarbonEmissionTopItemsSummaryData>)this).GetFormatFromOptions(options) : options.Format;
        ...
        string IPersistableModel<ResourceGroupCarbonEmissionTopItemsSummaryData>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
