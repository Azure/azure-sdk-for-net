...
{
    public partial class CarbonEmissionTopItemMonthlySummaryData : IUtf8JsonSerializable, IJsonModel<CarbonEmissionTopItemMonthlySummaryData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CarbonEmissionTopItemMonthlySummaryData>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<CarbonEmissionTopItemMonthlySummaryData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<CarbonEmissionTopItemMonthlySummaryData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CarbonEmissionTopItemMonthlySummaryData)} does not support '{format}' format.");
            }
        ...
        CarbonEmissionTopItemMonthlySummaryData IJsonModel<CarbonEmissionTopItemMonthlySummaryData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<CarbonEmissionTopItemMonthlySummaryData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
            ...
            return DeserializeCarbonEmissionTopItemMonthlySummaryData(document.RootElement, options);
        }

        internal static CarbonEmissionTopItemMonthlySummaryData DeserializeCarbonEmissionTopItemMonthlySummaryData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new CarbonEmissionTopItemMonthlySummaryData(dataType, totalCarbonEmission, totalCarbonEmissionLastMonth, changeRatioForLastMonth, totalCarbonEmission12MonthsAgo, changeRatioFor12Months, Optional.ToNullable(changeValueMonthOverMonth), serializedAdditionalRawData, itemName, categoryType, date);
        }

        BinaryData IPersistableModel<CarbonEmissionTopItemMonthlySummaryData>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<CarbonEmissionTopItemMonthlySummaryData>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CarbonEmissionTopItemMonthlySummaryData)} does not support '{options.Format}' format.");
            }
        }

        CarbonEmissionTopItemMonthlySummaryData IPersistableModel<CarbonEmissionTopItemMonthlySummaryData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<CarbonEmissionTopItemMonthlySummaryData>)this).GetFormatFromOptions(options) : options.Format;
        ...
        string IPersistableModel<CarbonEmissionTopItemMonthlySummaryData>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
