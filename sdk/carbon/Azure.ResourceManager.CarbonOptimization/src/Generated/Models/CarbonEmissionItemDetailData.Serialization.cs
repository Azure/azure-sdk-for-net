...
namespace Azure.ResourceManager.CarbonOptimization.Models
{
    public partial class CarbonEmissionItemDetailData : IUtf8JsonSerializable, IJsonModel<CarbonEmissionItemDetailData>
    {
        ...
        void IJsonModel<CarbonEmissionItemDetailData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CarbonEmissionItemDetailData)} does not support writing '{format}' format.");
            }
        ...
        CarbonEmissionItemDetailData IJsonModel<CarbonEmissionItemDetailData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CarbonEmissionItemDetailData)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<CarbonEmissionItemDetailData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CarbonEmissionItemDetailData)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        CarbonEmissionItemDetailData IPersistableModel<CarbonEmissionItemDetailData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CarbonEmissionItemDetailData)} does not support reading '{options.Format}' format.");
            }
        }
