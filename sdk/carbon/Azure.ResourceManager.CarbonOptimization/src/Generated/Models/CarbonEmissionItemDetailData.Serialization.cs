...
{
    public partial class CarbonEmissionItemDetailData : IUtf8JsonSerializable, IJsonModel<CarbonEmissionItemDetailData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CarbonEmissionItemDetailData>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<CarbonEmissionItemDetailData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<CarbonEmissionItemDetailData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CarbonEmissionItemDetailData)} does not support '{format}' format.");
            }
        ...
        CarbonEmissionItemDetailData IJsonModel<CarbonEmissionItemDetailData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<CarbonEmissionItemDetailData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
            ...
            return DeserializeCarbonEmissionItemDetailData(document.RootElement, options);
        }

        internal static CarbonEmissionItemDetailData DeserializeCarbonEmissionItemDetailData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new CarbonEmissionItemDetailData(dataType, totalCarbonEmission, totalCarbonEmissionLastMonth, changeRatioForLastMonth, totalCarbonEmission12MonthsAgo, changeRatioFor12Months, Optional.ToNullable(changeValueMonthOverMonth), serializedAdditionalRawData, itemName, groupName, categoryType);
        }

        BinaryData IPersistableModel<CarbonEmissionItemDetailData>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<CarbonEmissionItemDetailData>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CarbonEmissionItemDetailData)} does not support '{options.Format}' format.");
            }
        }

        CarbonEmissionItemDetailData IPersistableModel<CarbonEmissionItemDetailData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<CarbonEmissionItemDetailData>)this).GetFormatFromOptions(options) : options.Format;
        ...
        string IPersistableModel<CarbonEmissionItemDetailData>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
