...
{
    internal partial class UnknownCarbonEmissionQueryFilter : CarbonEmissionQueryFilter, IJsonModel<CarbonEmissionQueryFilter>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownCarbonEmissionQueryFilter DeserializeUnknownCarbonEmissionQueryFilter(JsonElement element, ModelReaderWriterOptions options)
        {
