...
{
    public partial class ResourceCarbonEmissionTopItemMonthlySummaryData : IUtf8JsonSerializable, IJsonModel<ResourceCarbonEmissionTopItemMonthlySummaryData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ResourceCarbonEmissionTopItemMonthlySummaryData>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<ResourceCarbonEmissionTopItemMonthlySummaryData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ResourceCarbonEmissionTopItemMonthlySummaryData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ResourceCarbonEmissionTopItemMonthlySummaryData)} does not support writing '{format}' format.");
            }
        ...
        ResourceCarbonEmissionTopItemMonthlySummaryData IJsonModel<ResourceCarbonEmissionTopItemMonthlySummaryData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ResourceCarbonEmissionTopItemMonthlySummaryData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ResourceCarbonEmissionTopItemMonthlySummaryData)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeResourceCarbonEmissionTopItemMonthlySummaryData(document.RootElement, options);
        }

        internal static ResourceCarbonEmissionTopItemMonthlySummaryData DeserializeResourceCarbonEmissionTopItemMonthlySummaryData(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<ResourceCarbonEmissionTopItemMonthlySummaryData>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ResourceCarbonEmissionTopItemMonthlySummaryData>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ResourceCarbonEmissionTopItemMonthlySummaryData)} does not support writing '{options.Format}' format.");
            }
        }

        ResourceCarbonEmissionTopItemMonthlySummaryData IPersistableModel<ResourceCarbonEmissionTopItemMonthlySummaryData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ResourceCarbonEmissionTopItemMonthlySummaryData>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ResourceCarbonEmissionTopItemMonthlySummaryData)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<ResourceCarbonEmissionTopItemMonthlySummaryData>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
