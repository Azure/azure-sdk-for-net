...
namespace Azure.ResourceManager.CarbonOptimization.Models
{
    public partial class ResourceCarbonEmissionTopItemMonthlySummaryData : IUtf8JsonSerializable, IJsonModel<ResourceCarbonEmissionTopItemMonthlySummaryData>
    {
        ...
        void IJsonModel<ResourceCarbonEmissionTopItemMonthlySummaryData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ResourceCarbonEmissionTopItemMonthlySummaryData)} does not support '{format}' format.");
            }
        ...
        internal static ResourceCarbonEmissionTopItemMonthlySummaryData DeserializeResourceCarbonEmissionTopItemMonthlySummaryData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new ResourceCarbonEmissionTopItemMonthlySummaryData(dataType, totalCarbonEmission, totalCarbonEmissionLastMonth, changeRatioForLastMonth, totalCarbonEmission12MonthsAgo, changeRatioFor12Months, Optional.ToNullable(changeValueMonthOverMonth), serializedAdditionalRawData, itemName, categoryType, date, subscriptionId, resourceGroup);
        }
        ...
        BinaryData IPersistableModel<ResourceCarbonEmissionTopItemMonthlySummaryData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ResourceCarbonEmissionTopItemMonthlySummaryData)} does not support '{options.Format}' format.");
            }
        }
