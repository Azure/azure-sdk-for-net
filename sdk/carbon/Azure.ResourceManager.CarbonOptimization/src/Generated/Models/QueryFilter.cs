...
namespace Azure.ResourceManager.CarbonOptimization.Models
{
    ...
    public abstract partial class QueryFilter
    {
        ...
        internal QueryFilter(ReportTypeEnum reportType, DateRange dateRange, IList<string> subscriptionList, IList<string> resourceGroupUrlList, IList<string> resourceTypeList, IList<string> locationList, IList<EmissionScopeEnum> carbonScopeList, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
        ...
        internal ReportTypeEnum ReportType { get; set; }
