...
namespace Azure.ResourceManager.CarbonOptimization.Models
{
    ...
    public abstract partial class CarbonEmission
    {
        ...
        protected CarbonEmission(double totalCarbonEmission, double totalCarbonEmissionLastMonth, double changeRatioForLastMonth, double totalCarbonEmission12MonthsAgo, double changeRatioFor12Months)
        {
        ...
        internal CarbonEmission(string dataType, double totalCarbonEmission, double totalCarbonEmissionLastMonth, double changeRatioForLastMonth, double totalCarbonEmission12MonthsAgo, double changeRatioFor12Months, double? changeValueMonthOverMonth, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            DataType = dataType;
            TotalCarbonEmission = totalCarbonEmission;
            TotalCarbonEmissionLastMonth = totalCarbonEmissionLastMonth;
