...
namespace Azure.ResourceManager.CarbonOptimization.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ResourceCarbonEmissionTopItemsSummaryData>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ResourceCarbonEmissionTopItemsSummaryData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ResourceCarbonEmissionTopItemsSummaryData)} does not support '{format}' format.");
            }
        ...
        internal static ResourceCarbonEmissionTopItemsSummaryData DeserializeResourceCarbonEmissionTopItemsSummaryData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new ResourceCarbonEmissionTopItemsSummaryData(dataType, totalCarbonEmission, totalCarbonEmissionLastMonth, changeRatioForLastMonth, totalCarbonEmission12MonthsAgo, changeRatioFor12Months, Optional.ToNullable(changeValueMonthOverMonth), serializedAdditionalRawData, itemName, categoryType, subscriptionId, resourceGroup);
        }
        ...
        BinaryData IPersistableModel<ResourceCarbonEmissionTopItemsSummaryData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ResourceCarbonEmissionTopItemsSummaryData)} does not support '{options.Format}' format.");
            }
        }
