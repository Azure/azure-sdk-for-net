...
namespace Azure.ResourceManager.CarbonOptimization.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MonthlySummaryReportQueryFilter>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<MonthlySummaryReportQueryFilter>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MonthlySummaryReportQueryFilter)} does not support '{format}' format.");
            }
        ...
        internal static MonthlySummaryReportQueryFilter DeserializeMonthlySummaryReportQueryFilter(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new MonthlySummaryReportQueryFilter(reportType, dateRange, subscriptionList, resourceGroupUrlList ?? new ChangeTrackingList<string>(), resourceTypeList ?? new ChangeTrackingList<string>(), locationList ?? new ChangeTrackingList<string>(), carbonScopeList, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<MonthlySummaryReportQueryFilter>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(MonthlySummaryReportQueryFilter)} does not support '{options.Format}' format.");
            }
        }
