...
namespace Azure.ResourceManager.CarbonOptimization.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CarbonEmissionDataAvailableDateRange>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<CarbonEmissionDataAvailableDateRange>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CarbonEmissionDataAvailableDateRange)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<CarbonEmissionDataAvailableDateRange>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CarbonEmissionDataAvailableDateRange)} does not support '{options.Format}' format.");
            }
        }
