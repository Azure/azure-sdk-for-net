...
namespace Azure.ResourceManager.CarbonOptimization.Models
{
    ...
    public partial class ResourceGroupCarbonEmissionTopItemsSummary : CarbonEmission, IJsonModel<ResourceGroupCarbonEmissionTopItemsSummary>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<ResourceGroupCarbonEmissionTopItemsSummary>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ResourceGroupCarbonEmissionTopItemsSummary IJsonModel<ResourceGroupCarbonEmissionTopItemsSummary>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (ResourceGroupCarbonEmissionTopItemsSummary)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static ResourceGroupCarbonEmissionTopItemsSummary DeserializeResourceGroupCarbonEmissionTopItemsSummary(JsonElement element, ModelReaderWriterOptions options)
        {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ResourceGroupCarbonEmissionTopItemsSummary>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ResourceGroupCarbonEmissionTopItemsSummary IPersistableModel<ResourceGroupCarbonEmissionTopItemsSummary>.Create(BinaryData data, ModelReaderWriterOptions options) => (ResourceGroupCarbonEmissionTopItemsSummary)PersistableModelCreateCore(data, options);
