...
namespace Azure.ResourceManager.CarbonOptimization.Models
{
    ...
    public partial class TopItemsMonthlySummaryReportQueryContent : CarbonEmissionQueryContent
    {
        /// <summary> Initializes a new instance of <see cref="TopItemsMonthlySummaryReportQueryContent"/>. </summary>
        ...
        public TopItemsMonthlySummaryReportQueryContent(CarbonEmissionQueryDateRange dateRange, IEnumerable<string> subscriptionList, IEnumerable<CarbonEmissionQueryScope> carbonScopeList, CarbonEmissionCategoryType categoryType, int topItems) : base(dateRange, subscriptionList, carbonScopeList)
        {
        ...
        /// <summary> Initializes a new instance of <see cref="TopItemsMonthlySummaryReportQueryContent"/> for deserialization. </summary>
        internal TopItemsMonthlySummaryReportQueryContent()
        {
        }
