...
namespace Azure.ResourceManager.CarbonOptimization.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ResourceGroupCarbonEmissionTopItemMonthlySummaryData>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ResourceGroupCarbonEmissionTopItemMonthlySummaryData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ResourceGroupCarbonEmissionTopItemMonthlySummaryData)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ResourceGroupCarbonEmissionTopItemMonthlySummaryData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ResourceGroupCarbonEmissionTopItemMonthlySummaryData)} does not support '{options.Format}' format.");
            }
        }
