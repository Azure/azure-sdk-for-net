...
namespace Azure.ResourceManager.CarbonOptimization.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CarbonEmissionTopItemsSummaryData>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<CarbonEmissionTopItemsSummaryData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CarbonEmissionTopItemsSummaryData)} does not support '{format}' format.");
            }
        ...
        internal static CarbonEmissionTopItemsSummaryData DeserializeCarbonEmissionTopItemsSummaryData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new CarbonEmissionTopItemsSummaryData(dataType, totalCarbonEmission, totalCarbonEmissionLastMonth, changeRatioForLastMonth, totalCarbonEmission12MonthsAgo, changeRatioFor12Months, Optional.ToNullable(changeValueMonthOverMonth), serializedAdditionalRawData, itemName, categoryType);
        }
        ...
        BinaryData IPersistableModel<CarbonEmissionTopItemsSummaryData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CarbonEmissionTopItemsSummaryData)} does not support '{options.Format}' format.");
            }
        }
