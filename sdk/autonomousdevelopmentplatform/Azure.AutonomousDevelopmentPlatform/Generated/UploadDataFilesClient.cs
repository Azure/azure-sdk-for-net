...
{
    // Data plane generated client. The UploadDataFiles service client.
    /// <summary> The UploadDataFiles service client. </summary>
    public partial class UploadDataFilesClient
    {
        ...
        /// <summary> Initializes a new instance of UploadDataFilesClient for mocking. </summary>
        ...
        /// <summary> List data files for the upload. </summary>
        ...
        /// <include file="Docs/UploadDataFilesClient.xml" path="doc/members/member[@name='ListAsync(String,RequestContext)']/*" />
        public virtual AsyncPageable<BinaryData> ListAsync(string uploadId, RequestContext context = null)
        {
            ...
            return ListImplementationAsync("UploadDataFilesClient.List", uploadId, context);
        }
        ...
        /// <include file="Docs/UploadDataFilesClient.xml" path="doc/members/member[@name='List(String,RequestContext)']/*" />
        public virtual Pageable<BinaryData> List(string uploadId, RequestContext context = null)
        {
            Argument.AssertNotNullOrEmpty(uploadId, nameof(uploadId));

            return ListImplementation("UploadDataFilesClient.List", uploadId, context);
        }
        ...
        /// <include file="Docs/UploadDataFilesClient.xml" path="doc/members/member[@name='GenerateAsync(WaitUntil,String,RequestContext)']/*" />
        public virtual async Task<Operation<BinaryData>> GenerateAsync(WaitUntil waitUntil, string uploadId, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("UploadDataFilesClient.Generate");
            scope.Start();
            try
            {
                using HttpMessage message = CreateGenerateRequest(uploadId, context);
                return await ProtocolOperationHelpers.ProcessMessageAsync(_pipeline, message, ClientDiagnostics, "UploadDataFilesClient.Generate", OperationFinalStateVia.Location, context, waitUntil).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The <see cref="Operation{T}"/> from the service that will contain a <see cref="BinaryData"/> object once the asynchronous operation on the service has completed. Details of the body schema for the operation's final value are in the Remarks section below. </returns>
        /// <include file="Docs/UploadDataFilesClient.xml" path="doc/members/member[@name='Generate(WaitUntil,String,RequestContext)']/*" />
        public virtual Operation<BinaryData> Generate(WaitUntil waitUntil, string uploadId, RequestContext context = null)
        {
            ...
            {
                using HttpMessage message = CreateGenerateRequest(uploadId, context);
                return ProtocolOperationHelpers.ProcessMessage(_pipeline, message, ClientDiagnostics, "UploadDataFilesClient.Generate", OperationFinalStateVia.Location, context, waitUntil);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        internal HttpMessage CreateListRequest(string uploadId, RequestContext context)
        {
            ...
            uri.AppendPath("/dataFilesUploadInfo", false);
