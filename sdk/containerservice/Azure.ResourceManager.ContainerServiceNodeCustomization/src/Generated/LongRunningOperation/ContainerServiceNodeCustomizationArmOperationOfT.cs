...
{
    internal partial class ContainerServiceNodeCustomizationArmOperation<T> : ArmOperation<T>
    {
        ...
        internal ContainerServiceNodeCustomizationArmOperation(Response<T> response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal ContainerServiceNodeCustomizationArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal<T>(
                ...
                clientDiagnostics,
                response,
                "ContainerServiceNodeCustomizationArmOperation",
                null,
