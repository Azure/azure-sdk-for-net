...
Install the Azure.ResourceManager.ContainerServiceNodeCustomization management library for .NET with [NuGet](https://www.nuget.org/):

```dotnetcli
dotnet add package Azure.ResourceManager.ContainerServiceNodeCustomization --prerelease
```
