...
namespace Microsoft.Azure.Management.ContainerService.Models
{
    ...
    public partial class ManagedClusterPodIdentityProvisioningErrorBody
    {
        ...
        /// error.</param>
        public ManagedClusterPodIdentityProvisioningErrorBody(string code = default(string), string message = default(string), string target = default(string), IList<ManagedClusterPodIdentityProvisioningErrorBody> details = default(IList<ManagedClusterPodIdentityProvisioningErrorBody>))
        {
            Code = code;
            Message = message;
            Target = target;
        ...
        public IList<ManagedClusterPodIdentityProvisioningErrorBody> Details { get; set; }
