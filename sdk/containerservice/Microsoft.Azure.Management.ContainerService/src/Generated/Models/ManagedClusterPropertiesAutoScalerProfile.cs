...
namespace Microsoft.Azure.Management.ContainerService.Models
{
    ...
    public partial class ManagedClusterPropertiesAutoScalerProfile
    {
        ...
        /// ManagedClusterPropertiesAutoScalerProfile class.
        /// </summary>
        public ManagedClusterPropertiesAutoScalerProfile(string scanInterval = default(string), string scaleDownDelayAfterAdd = default(string), string scaleDownDelayAfterDelete = default(string), string scaleDownDelayAfterFailure = default(string), string scaleDownUnneededTime = default(string), string scaleDownUnreadyTime = default(string), string scaleDownUtilizationThreshold = default(string), string maxGracefulTerminationSec = default(string))
        {
