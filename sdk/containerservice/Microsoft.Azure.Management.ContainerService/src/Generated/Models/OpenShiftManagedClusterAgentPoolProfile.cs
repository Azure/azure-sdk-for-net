...
namespace Microsoft.Azure.Management.ContainerService.Models
{
    ...
    public partial class OpenShiftManagedClusterAgentPoolProfile
    {
        ...
        public OpenShiftManagedClusterAgentPoolProfile(string name, int count, string vmSize, string subnetCidr = default(string), string osType = default(string), string role = default(string))
        {
            Name = name;
            Count = count;
            VmSize = vmSize;
