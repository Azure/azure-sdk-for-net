...
namespace Azure.ResourceManager.ContainerService
{
    ...
    public partial class SafeguardsAvailableVersionResource : ArmResource
    {
        ...
        {
            using DiagnosticScope scope = _managedClustersClientDiagnostics.CreateScope("SafeguardsAvailableVersionResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _managedClustersRestClient.CreateGetSafeguardsVersionsRequest(Guid.Parse(Id.SubscriptionId), Id.Parent.Name, Id.Name, context);
