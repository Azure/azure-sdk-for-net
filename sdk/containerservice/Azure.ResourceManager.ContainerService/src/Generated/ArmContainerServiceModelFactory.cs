...
namespace Azure.ResourceManager.ContainerService.Models
{
    ...
    public static partial class ArmContainerServiceModelFactory
    {
        ...
        public static AgentPoolAvailableVersion AgentPoolAvailableVersion(string id = default, string name = default, string @type = default, IEnumerable<AgentPoolAvailableVersionsPropertiesAgentPoolVersionsItem> agentPoolVersions = default)
        {
            return new AgentPoolAvailableVersion(id, name, @type, agentPoolVersions is null ? default : new AgentPoolAvailableVersionsProperties((agentPoolVersions ?? new ChangeTrackingList<AgentPoolAvailableVersionsPropertiesAgentPoolVersionsItem>()).ToList(), null), additionalBinaryDataProperties: null);
        }
        ...
        /// <returns> A new <see cref="Models.AgentPoolAvailableVersion"/> instance for mocking. </returns>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public static AgentPoolAvailableVersion AgentPoolAvailableVersion(bool? isDefault, string kubernetesVersion, bool? isPreview)
        {
            return new AgentPoolAvailableVersion(default, default, default, default, additionalBinaryDataProperties: null);
        }
