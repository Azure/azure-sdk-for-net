...
namespace Azure.ResourceManager.ContainerService.Models
{
    ...
    public static partial class ArmContainerServiceModelFactory
    {
        ...
        public static OSOptionProfileData OSOptionProfileData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IEnumerable<ContainerServiceOSOptionProperty> osOptionPropertyList = null)
        {
            ...
            return new OSOptionProfileData(id, name, resourceType, systemData, osOptionPropertyList?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ContainerServiceOSOptionProperty(osType, enableFipsImage, new Dictionary<string, BinaryData>());
        }
        ...
        public static ManagedClusterAgentPoolProfile ManagedClusterAgentPoolProfile(int? count = null, string vmSize = null, int? osDiskSizeInGB = null, ContainerServiceOSDiskType? osDiskType = null, KubeletDiskType? kubeletDiskType = null, WorkloadRuntime? workloadRuntime = null, string messageOfTheDay = null, ResourceIdentifier vnetSubnetId = null, ResourceIdentifier podSubnetId = null, int? maxPods = null, ContainerServiceOSType? osType = null, ContainerServiceOSSku? osSku = null, int? maxCount = null, int? minCount = null, bool? enableAutoScaling = null, ScaleDownMode? scaleDownMode = null, AgentPoolType? agentPoolType = null, AgentPoolMode? mode = null, string orchestratorVersion = null, string currentOrchestratorVersion = null, string nodeImageVersion = null, string upgradeMaxSurge = null, string provisioningState = null, ContainerServiceStateCode? powerStateCode = null, IEnumerable<string> availabilityZones = null, bool? enableNodePublicIP = null, bool? enableCustomCATrust = null, ResourceIdentifier nodePublicIPPrefixId = null, ScaleSetPriority? scaleSetPriority = null, ScaleSetEvictionPolicy? scaleSetEvictionPolicy = null, float? spotMaxPrice = null, IDictionary<string, string> tags = null, IDictionary<string, string> nodeLabels = null, IEnumerable<string> nodeTaints = null, ResourceIdentifier proximityPlacementGroupId = null, KubeletConfig kubeletConfig = null, LinuxOSConfig linuxOSConfig = null, bool? enableEncryptionAtHost = null, bool? enableUltraSsd = null, bool? enableFips = null, GpuInstanceProfile? gpuInstanceProfile = null, ResourceIdentifier creationDataSourceResourceId = null, ResourceIdentifier capacityReservationGroupId = null, ResourceIdentifier hostGroupId = null, bool? disableOutboundNat = null, AgentPoolNetworkProfile networkProfile = null, string name = null)
        {
            ...
            return new ManagedClusterAgentPoolProfile(count, vmSize, osDiskSizeInGB, osDiskType, kubeletDiskType, workloadRuntime, messageOfTheDay, vnetSubnetId, podSubnetId, maxPods, osType, osSku, maxCount, minCount, enableAutoScaling, scaleDownMode, agentPoolType, mode, orchestratorVersion, currentOrchestratorVersion, nodeImageVersion, upgradeMaxSurge != null ? new AgentPoolUpgradeSettings(upgradeMaxSurge, new Dictionary<string, BinaryData>()) : null, provisioningState, powerStateCode != null ? new ContainerServicePowerState(powerStateCode, new Dictionary<string, BinaryData>()) : null, availabilityZones?.ToList(), enableNodePublicIP, enableCustomCATrust, nodePublicIPPrefixId, scaleSetPriority, scaleSetEvictionPolicy, spotMaxPrice, tags, nodeLabels, nodeTaints?.ToList(), proximityPlacementGroupId, kubeletConfig, linuxOSConfig, enableEncryptionAtHost, enableUltraSsd, enableFips, gpuInstanceProfile, creationDataSourceResourceId != null ? new ContainerServiceCreationData(creationDataSourceResourceId, new Dictionary<string, BinaryData>()) : null, capacityReservationGroupId, hostGroupId, disableOutboundNat != null ? new AgentPoolWindowsProfile(disableOutboundNat, new Dictionary<string, BinaryData>()) : null, networkProfile, new Dictionary<string, BinaryData>(), name);
        }
        ...
        public static ManagedClusterAddonProfile ManagedClusterAddonProfile(bool isEnabled = default, IDictionary<string, string> config = null, ManagedClusterAddonProfileIdentity identity = null)
        {
            ...
            return new ManagedClusterAddonProfile(isEnabled, config, identity, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ManagedClusterPodIdentity(name, @namespace, bindingSelector, identity, provisioningState, errorDetail != null ? new ManagedClusterPodIdentityProvisioningInfo(new ManagedClusterPodIdentityProvisioningError(errorDetail, new Dictionary<string, BinaryData>()), new Dictionary<string, BinaryData>()) : null, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ManagedClusterOidcIssuerProfile(issuerUriInfo, isEnabled, new Dictionary<string, BinaryData>());
        }
        ...
        public static ContainerServicePrivateLinkResourceData ContainerServicePrivateLinkResourceData(ResourceIdentifier id = null, string name = null, ResourceType? resourceType = null, string groupId = null, IEnumerable<string> requiredMembers = null, ResourceIdentifier privateLinkServiceId = null)
        {
            ...
            return new ContainerServicePrivateLinkResourceData(id, name, resourceType, groupId, requiredMembers?.ToList(), privateLinkServiceId, new Dictionary<string, BinaryData>());
        }

        /// <summary> Initializes a new instance of <see cref="Models.ManagedClusterHttpProxyConfig"/>. </summary>
        ...
        public static ManagedClusterHttpProxyConfig ManagedClusterHttpProxyConfig(string httpProxy = null, string httpsProxy = null, IEnumerable<string> noProxy = null, IEnumerable<string> effectiveNoProxy = null, string trustedCA = null)
        {
            ...
            return new ManagedClusterHttpProxyConfig(httpProxy, httpsProxy, noProxy?.ToList(), effectiveNoProxy?.ToList(), trustedCA, new Dictionary<string, BinaryData>());
        }

        /// <summary> Initializes a new instance of <see cref="Models.ManagedClusterGuardrailsProfile"/>. </summary>
        ...
        public static ManagedClusterGuardrailsProfile ManagedClusterGuardrailsProfile(IEnumerable<string> systemExcludedNamespaces = null, string version = null, ManagedClusterGuardrailsProfileLevel level = default, IEnumerable<string> excludedNamespaces = null)
        {
            ...
            return new ManagedClusterGuardrailsProfile(systemExcludedNamespaces?.ToList(), version, level, excludedNamespaces?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static ManagedClusterUpgradeProfileData ManagedClusterUpgradeProfileData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, ManagedClusterPoolUpgradeProfile controlPlaneProfile = null, IEnumerable<ManagedClusterPoolUpgradeProfile> agentPoolProfiles = null)
        {
            ...
            return new ManagedClusterUpgradeProfileData(id, name, resourceType, systemData, controlPlaneProfile, agentPoolProfiles?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static ManagedClusterPoolUpgradeProfile ManagedClusterPoolUpgradeProfile(string kubernetesVersion = null, string name = null, ContainerServiceOSType osType = default, IEnumerable<ManagedClusterPoolUpgradeProfileUpgradesItem> upgrades = null)
        {
            ...
            return new ManagedClusterPoolUpgradeProfile(kubernetesVersion, name, osType, upgrades?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ManagedClusterPoolUpgradeProfileUpgradesItem(kubernetesVersion, isPreview, new Dictionary<string, BinaryData>());
        }
        ...
        public static ManagedClusterAccessProfile ManagedClusterAccessProfile(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, byte[] kubeConfig = null)
        {
            ...
            return new ManagedClusterAccessProfile(id, name, resourceType, systemData, tags, location, kubeConfig, new Dictionary<string, BinaryData>());
        }
        ...
        public static ManagedClusterCredentials ManagedClusterCredentials(IEnumerable<ManagedClusterCredential> kubeconfigs = null)
        {
            ...
            return new ManagedClusterCredentials(kubeconfigs?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ManagedClusterCredential(name, value, new Dictionary<string, BinaryData>());
        }
        ...
        public static ContainerServiceMaintenanceConfigurationData ContainerServiceMaintenanceConfigurationData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IEnumerable<ContainerServiceTimeInWeek> timesInWeek = null, IEnumerable<ContainerServiceTimeSpan> notAllowedTimes = null, ContainerServiceMaintenanceWindow maintenanceWindow = null)
        {
            ...
            return new ContainerServiceMaintenanceConfigurationData(id, name, resourceType, systemData, timesInWeek?.ToList(), notAllowedTimes?.ToList(), maintenanceWindow, new Dictionary<string, BinaryData>());
        }
        ...
        public static AgentPoolUpgradeProfileData AgentPoolUpgradeProfileData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string kubernetesVersion = null, ContainerServiceOSType osType = default, IEnumerable<AgentPoolUpgradeProfilePropertiesUpgradesItem> upgrades = null, string latestNodeImageVersion = null)
        {
            ...
            return new AgentPoolUpgradeProfileData(id, name, resourceType, systemData, kubernetesVersion, osType, upgrades?.ToList(), latestNodeImageVersion, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AgentPoolUpgradeProfilePropertiesUpgradesItem(kubernetesVersion, isPreview, new Dictionary<string, BinaryData>());
        }
        ...
        public static AgentPoolAvailableVersions AgentPoolAvailableVersions(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IEnumerable<AgentPoolAvailableVersion> agentPoolVersions = null)
        {
            ...
            return new AgentPoolAvailableVersions(id, name, resourceType, systemData, agentPoolVersions?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AgentPoolAvailableVersion(isDefault, kubernetesVersion, isPreview, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ContainerServicePrivateEndpointConnectionData(id, name, resourceType, systemData, provisioningState, privateEndpointId != null ? ResourceManagerModelFactory.WritableSubResource(privateEndpointId) : null, connectionState, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ManagedClusterRunCommandContent(command, context, clusterToken, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ManagedClusterRunCommandResult(id, provisioningState, exitCode, startedOn, finishedOn, logs, reason, new Dictionary<string, BinaryData>());
        }
        ...
        public static ContainerServiceOutboundEnvironmentEndpoint ContainerServiceOutboundEnvironmentEndpoint(string category = null, IEnumerable<ContainerServiceEndpointDependency> endpoints = null)
        {
            ...
            return new ContainerServiceOutboundEnvironmentEndpoint(category, endpoints?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static ContainerServiceEndpointDependency ContainerServiceEndpointDependency(string domainName = null, IEnumerable<ContainerServiceEndpointDetail> endpointDetails = null)
        {
            ...
            return new ContainerServiceEndpointDependency(domainName, endpointDetails?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ContainerServiceEndpointDetail(ipAddress, port, protocol, description, new Dictionary<string, BinaryData>());
        }
        ...
        public static AgentPoolSnapshotData AgentPoolSnapshotData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, ResourceIdentifier creationDataSourceResourceId = null, SnapshotType? snapshotType = null, string kubernetesVersion = null, string nodeImageVersion = null, ContainerServiceOSType? osType = null, ContainerServiceOSSku? osSku = null, string vmSize = null, bool? enableFips = null)
        {
            ...
            return new AgentPoolSnapshotData(id, name, resourceType, systemData, tags, location, creationDataSourceResourceId != null ? new ContainerServiceCreationData(creationDataSourceResourceId, new Dictionary<string, BinaryData>()) : null, snapshotType, kubernetesVersion, nodeImageVersion, osType, osSku, vmSize, enableFips, new Dictionary<string, BinaryData>());
        }

        /// <summary> Initializes a new instance of <see cref="ContainerService.ManagedClusterSnapshotData"/>. </summary>
        /// <param name="id"> The id. </param>
        /// <param name="name"> The name. </param>
        /// <param name="resourceType"> The resourceType. </param>
        /// <param name="systemData"> The systemData. </param>
        ...
        public static ManagedClusterSnapshotData ManagedClusterSnapshotData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, ResourceIdentifier creationDataSourceResourceId = null, SnapshotType? snapshotType = null, ManagedClusterPropertiesForSnapshot managedClusterPropertiesReadOnly = null)
        {
            ...
            return new ManagedClusterSnapshotData(id, name, resourceType, systemData, tags, location, creationDataSourceResourceId != null ? new ContainerServiceCreationData(creationDataSourceResourceId, new Dictionary<string, BinaryData>()) : null, snapshotType, managedClusterPropertiesReadOnly, new Dictionary<string, BinaryData>());
        }

        /// <summary> Initializes a new instance of <see cref="Models.ManagedClusterPropertiesForSnapshot"/>. </summary>
        ...
        {
            return new ManagedClusterPropertiesForSnapshot(kubernetesVersion, sku, enableRbac, networkProfile, new Dictionary<string, BinaryData>());
        }

        /// <summary> Initializes a new instance of <see cref="Models.ContainerServiceNetworkProfileForSnapshot"/>. </summary>
        ...
        {
            return new ContainerServiceNetworkProfileForSnapshot(networkPlugin, networkPluginMode, networkPolicy, networkMode, loadBalancerSku, new Dictionary<string, BinaryData>());
        }
        ...
        public static ContainerServiceTrustedAccessRole ContainerServiceTrustedAccessRole(string sourceResourceType = null, string name = null, IEnumerable<ContainerServiceTrustedAccessRoleRule> rules = null)
        {
            ...
            return new ContainerServiceTrustedAccessRole(sourceResourceType, name, rules?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static ContainerServiceTrustedAccessRoleRule ContainerServiceTrustedAccessRoleRule(IEnumerable<string> verbs = null, IEnumerable<string> apiGroups = null, IEnumerable<string> resources = null, IEnumerable<string> resourceNames = null, IEnumerable<string> nonResourceUrls = null)
        {
            ...
            return new ContainerServiceTrustedAccessRoleRule(verbs?.ToList(), apiGroups?.ToList(), resources?.ToList(), resourceNames?.ToList(), nonResourceUrls?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static ContainerServiceTrustedAccessRoleBindingData ContainerServiceTrustedAccessRoleBindingData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, ContainerServiceTrustedAccessRoleBindingProvisioningState? provisioningState = null, ResourceIdentifier sourceResourceId = null, IEnumerable<string> roles = null)
        {
            ...
            return new ContainerServiceTrustedAccessRoleBindingData(id, name, resourceType, systemData, provisioningState, sourceResourceId, roles?.ToList(), new Dictionary<string, BinaryData>());
        }

        /// <summary> Initializes a new instance of <see cref="ContainerService.ContainerServiceFleetData"/>. </summary>
        /// <param name="id"> The id. </param>
        /// <param name="name"> The name. </param>
        /// <param name="resourceType"> The resourceType. </param>
        /// <param name="systemData"> The systemData. </param>
        ...
        public static ContainerServiceFleetData ContainerServiceFleetData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, ETag? etag = null, ContainerServiceFleetHubProfile hubProfile = null, ContainerServiceFleetProvisioningState? provisioningState = null)
        {
            ...
            return new ContainerServiceFleetData(id, name, resourceType, systemData, tags, location, etag, hubProfile, provisioningState, new Dictionary<string, BinaryData>());
        }

        /// <summary> Initializes a new instance of <see cref="Models.ContainerServiceFleetHubProfile"/>. </summary>
        ...
        {
            return new ContainerServiceFleetHubProfile(dnsPrefix, fqdn, kubernetesVersion, new Dictionary<string, BinaryData>());
        }

        /// <summary> Initializes a new instance of <see cref="Models.ContainerServiceFleetCredentialResults"/>. </summary>
        /// <param name="kubeconfigs"> Base64-encoded Kubernetes configuration file. </param>
        ...
        public static ContainerServiceFleetCredentialResults ContainerServiceFleetCredentialResults(IEnumerable<ContainerServiceFleetCredentialResult> kubeconfigs = null)
        {
            ...
            return new ContainerServiceFleetCredentialResults(kubeconfigs?.ToList(), new Dictionary<string, BinaryData>());
        }

        /// <summary> Initializes a new instance of <see cref="Models.ContainerServiceFleetCredentialResult"/>. </summary>
        /// <param name="name"> The name of the credential. </param>
        /// <param name="value"> Base64-encoded Kubernetes configuration file. </param>
        ...
        {
            return new ContainerServiceFleetCredentialResult(name, value, new Dictionary<string, BinaryData>());
        }

        /// <summary> Initializes a new instance of <see cref="ContainerService.ContainerServiceFleetMemberData"/>. </summary>
        /// <param name="id"> The id. </param>
        /// <param name="name"> The name. </param>
        /// <param name="resourceType"> The resourceType. </param>
        /// <param name="systemData"> The systemData. </param>
        ...
        {
            return new ContainerServiceFleetMemberData(id, name, resourceType, systemData, clusterResourceId, provisioningState, etag, new Dictionary<string, BinaryData>());
        }
    }
}
