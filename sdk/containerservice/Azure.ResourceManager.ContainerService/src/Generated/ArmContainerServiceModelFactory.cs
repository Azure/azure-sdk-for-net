...
namespace Azure.ResourceManager.ContainerService.Models
{
    ...
    public static partial class ArmContainerServiceModelFactory
    {
        ...
        public static OSOptionProfileData OSOptionProfileData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IEnumerable<ContainerServiceOSOptionProperty> osOptionPropertyList = null)
        {
            ...
            return new OSOptionProfileData(id, name, resourceType, systemData, osOptionPropertyList?.ToList(), default);
        }
        ...
        {
            return new ContainerServiceOSOptionProperty(osType, enableFipsImage, default);
        }
        ...
        public static ManagedClusterAddonProfile ManagedClusterAddonProfile(bool isEnabled = default, IDictionary<string, string> config = null, ManagedClusterAddonProfileIdentity identity = null)
        {
            ...
            return new ManagedClusterAddonProfile(isEnabled, config, identity, default);
        }
        ...
        {
            return new ManagedClusterPodIdentity(name, @namespace, bindingSelector, identity, provisioningState, errorDetail != null ? new ManagedClusterPodIdentityProvisioningInfo(new ManagedClusterPodIdentityProvisioningError(errorDetail, new Dictionary<string, BinaryData>()), new Dictionary<string, BinaryData>()) : null, default);
        }
        ...
        public static ContainerServicePrivateLinkResourceData ContainerServicePrivateLinkResourceData(ResourceIdentifier id = null, string name = null, ResourceType? resourceType = null, string groupId = null, IEnumerable<string> requiredMembers = null, ResourceIdentifier privateLinkServiceId = null)
        {
            ...
            return new ContainerServicePrivateLinkResourceData(id, name, resourceType, groupId, requiredMembers?.ToList(), privateLinkServiceId, default);
        }
        ...
        public static ManagedClusterHttpProxyConfig ManagedClusterHttpProxyConfig(string httpProxy = null, string httpsProxy = null, IEnumerable<string> noProxy = null, IEnumerable<string> effectiveNoProxy = null, string trustedCA = null)
        {
            ...
            return new ManagedClusterHttpProxyConfig(httpProxy, httpsProxy, noProxy?.ToList(), effectiveNoProxy?.ToList(), trustedCA, default);
        }
        ...
        public static ManagedClusterGuardrailsProfile ManagedClusterGuardrailsProfile(IEnumerable<string> systemExcludedNamespaces = null, string version = null, ManagedClusterGuardrailsProfileLevel level = default, IEnumerable<string> excludedNamespaces = null)
        {
            ...
            return new ManagedClusterGuardrailsProfile(systemExcludedNamespaces?.ToList(), version, level, excludedNamespaces?.ToList(), default);
        }
        ...
        public static ManagedClusterUpgradeProfileData ManagedClusterUpgradeProfileData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, ManagedClusterPoolUpgradeProfile controlPlaneProfile = null, IEnumerable<ManagedClusterPoolUpgradeProfile> agentPoolProfiles = null)
        {
            ...
            return new ManagedClusterUpgradeProfileData(id, name, resourceType, systemData, controlPlaneProfile, agentPoolProfiles?.ToList(), default);
        }
        ...
        public static ManagedClusterPoolUpgradeProfile ManagedClusterPoolUpgradeProfile(string kubernetesVersion = null, string name = null, ContainerServiceOSType osType = default, IEnumerable<ManagedClusterPoolUpgradeProfileUpgradesItem> upgrades = null)
        {
            ...
            return new ManagedClusterPoolUpgradeProfile(kubernetesVersion, name, osType, upgrades?.ToList(), default);
        }
        ...
        public static ManagedClusterAccessProfile ManagedClusterAccessProfile(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, byte[] kubeConfig = null)
        {
            ...
            return new ManagedClusterAccessProfile(id, name, resourceType, systemData, tags, location, kubeConfig, default);
        }
        ...
        public static ManagedClusterCredentials ManagedClusterCredentials(IEnumerable<ManagedClusterCredential> kubeconfigs = null)
        {
            ...
            return new ManagedClusterCredentials(kubeconfigs?.ToList(), default);
        }
        ...
        public static ContainerServiceMaintenanceConfigurationData ContainerServiceMaintenanceConfigurationData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IEnumerable<ContainerServiceTimeInWeek> timesInWeek = null, IEnumerable<ContainerServiceTimeSpan> notAllowedTimes = null, ContainerServiceMaintenanceWindow maintenanceWindow = null)
        {
            ...
            return new ContainerServiceMaintenanceConfigurationData(id, name, resourceType, systemData, timesInWeek?.ToList(), notAllowedTimes?.ToList(), maintenanceWindow, default);
        }
        ...
        public static AgentPoolUpgradeProfileData AgentPoolUpgradeProfileData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string kubernetesVersion = null, ContainerServiceOSType osType = default, IEnumerable<AgentPoolUpgradeProfilePropertiesUpgradesItem> upgrades = null, string latestNodeImageVersion = null)
        {
            ...
            return new AgentPoolUpgradeProfileData(id, name, resourceType, systemData, kubernetesVersion, osType, upgrades?.ToList(), latestNodeImageVersion, default);
        }
        ...
        public static AgentPoolAvailableVersions AgentPoolAvailableVersions(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IEnumerable<AgentPoolAvailableVersion> agentPoolVersions = null)
        {
            ...
            return new AgentPoolAvailableVersions(id, name, resourceType, systemData, agentPoolVersions?.ToList(), default);
        }
        ...
        {
            return new ContainerServicePrivateEndpointConnectionData(id, name, resourceType, systemData, provisioningState, privateEndpointId != null ? ResourceManagerModelFactory.WritableSubResource(privateEndpointId) : null, connectionState, default);
        }
        ...
        {
            return new ManagedClusterRunCommandResult(id, provisioningState, exitCode, startedOn, finishedOn, logs, reason, default);
        }
        ...
        public static ContainerServiceOutboundEnvironmentEndpoint ContainerServiceOutboundEnvironmentEndpoint(string category = null, IEnumerable<ContainerServiceEndpointDependency> endpoints = null)
        {
            ...
            return new ContainerServiceOutboundEnvironmentEndpoint(category, endpoints?.ToList(), default);
        }
        ...
        public static ContainerServiceEndpointDependency ContainerServiceEndpointDependency(string domainName = null, IEnumerable<ContainerServiceEndpointDetail> endpointDetails = null)
        {
            ...
            return new ContainerServiceEndpointDependency(domainName, endpointDetails?.ToList(), default);
        }
        ...
        public static AgentPoolSnapshotData AgentPoolSnapshotData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, ResourceIdentifier creationDataSourceResourceId = null, SnapshotType? snapshotType = null, string kubernetesVersion = null, string nodeImageVersion = null, ContainerServiceOSType? osType = null, ContainerServiceOSSku? osSku = null, string vmSize = null, bool? enableFips = null)
        {
            ...
            return new AgentPoolSnapshotData(id, name, resourceType, systemData, tags, location, creationDataSourceResourceId != null ? new ContainerServiceCreationData(creationDataSourceResourceId, new Dictionary<string, BinaryData>()) : null, snapshotType, kubernetesVersion, nodeImageVersion, osType, osSku, vmSize, enableFips, default);
        }
        ...
        public static ManagedClusterSnapshotData ManagedClusterSnapshotData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, ResourceIdentifier creationDataSourceResourceId = null, SnapshotType? snapshotType = null, ManagedClusterPropertiesForSnapshot managedClusterPropertiesReadOnly = null)
        {
            ...
            return new ManagedClusterSnapshotData(id, name, resourceType, systemData, tags, location, creationDataSourceResourceId != null ? new ContainerServiceCreationData(creationDataSourceResourceId, new Dictionary<string, BinaryData>()) : null, snapshotType, managedClusterPropertiesReadOnly, default);
        }
        ...
        {
            return new ManagedClusterPropertiesForSnapshot(kubernetesVersion, sku, enableRbac, networkProfile, default);
        }
        ...
        {
            return new ContainerServiceNetworkProfileForSnapshot(networkPlugin, networkPluginMode, networkPolicy, networkMode, loadBalancerSku, default);
        }
        ...
        public static ContainerServiceTrustedAccessRole ContainerServiceTrustedAccessRole(string sourceResourceType = null, string name = null, IEnumerable<ContainerServiceTrustedAccessRoleRule> rules = null)
        {
            ...
            return new ContainerServiceTrustedAccessRole(sourceResourceType, name, rules?.ToList(), default);
        }
        ...
        public static ContainerServiceTrustedAccessRoleRule ContainerServiceTrustedAccessRoleRule(IEnumerable<string> verbs = null, IEnumerable<string> apiGroups = null, IEnumerable<string> resources = null, IEnumerable<string> resourceNames = null, IEnumerable<string> nonResourceUrls = null)
        {
            ...
            return new ContainerServiceTrustedAccessRoleRule(verbs?.ToList(), apiGroups?.ToList(), resources?.ToList(), resourceNames?.ToList(), nonResourceUrls?.ToList(), default);
        }
        ...
        public static ContainerServiceTrustedAccessRoleBindingData ContainerServiceTrustedAccessRoleBindingData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, ContainerServiceTrustedAccessRoleBindingProvisioningState? provisioningState = null, ResourceIdentifier sourceResourceId = null, IEnumerable<string> roles = null)
        {
            ...
            return new ContainerServiceTrustedAccessRoleBindingData(id, name, resourceType, systemData, provisioningState, sourceResourceId, roles?.ToList(), default);
        }
        ...
        public static ContainerServiceFleetData ContainerServiceFleetData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, ETag? etag = null, ContainerServiceFleetHubProfile hubProfile = null, ContainerServiceFleetProvisioningState? provisioningState = null)
        {
            ...
            return new ContainerServiceFleetData(id, name, resourceType, systemData, tags, location, etag, hubProfile, provisioningState, default);
        }
        ...
        {
            return new ContainerServiceFleetHubProfile(dnsPrefix, fqdn, kubernetesVersion, default);
        }
        ...
        public static ContainerServiceFleetCredentialResults ContainerServiceFleetCredentialResults(IEnumerable<ContainerServiceFleetCredentialResult> kubeconfigs = null)
        {
            ...
            return new ContainerServiceFleetCredentialResults(kubeconfigs?.ToList(), default);
        }
        ...
        {
            return new ContainerServiceFleetCredentialResult(name, value, default);
        }
        ...
        {
            return new ContainerServiceFleetMemberData(id, name, resourceType, systemData, clusterResourceId, provisioningState, etag, default);
        }
    }
}
