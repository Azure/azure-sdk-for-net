...
namespace Azure.ResourceManager.ContainerService.Models
{
    ...
    public static partial class ArmContainerServiceModelFactory
    {
        ...
        public static ManagedClusterIdentityBindingProperties ManagedClusterIdentityBindingProperties(IdentityBindingManagedIdentityProfile managedIdentity = default, Uri oidcIssuerUri = default, ManagedClusterIdentityBindingProvisioningState? provisioningState = default, IEnumerable<AllowedSubject> allowedSubjects = default)
        {
            allowedSubjects ??= new ChangeTrackingList<AllowedSubject>();

            return new ManagedClusterIdentityBindingProperties(managedIdentity, oidcIssuerUri is null ? default : new IdentityBindingOidcIssuerProfile(oidcIssuerUri, default), provisioningState, (allowedSubjects ?? new ChangeTrackingList<AllowedSubject>()).ToList(), default);
        }
        ...
        /// </param>
        /// <returns> A new <see cref="Models.AllowedSubject"/> instance for mocking. </returns>
        public static AllowedSubject AllowedSubject(ManagedClusterLoadBalancerLabelSelector namespaceSelector = default, ManagedClusterLoadBalancerLabelSelector serviceAccountSelector = default)
        {
            return new AllowedSubject(namespaceSelector, serviceAccountSelector, default);
        }
