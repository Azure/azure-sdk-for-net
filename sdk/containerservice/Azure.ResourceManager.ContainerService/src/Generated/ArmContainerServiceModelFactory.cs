...
namespace Azure.ResourceManager.ContainerService.Models
{
    ...
    public static partial class ArmContainerServiceModelFactory
    {
        ...
        public static ManagedClusterAadProfile ManagedClusterAadProfile(bool? isManagedAadEnabled = default, bool? isAzureRbacEnabled = default, IEnumerable<string> adminGroupObjectIDs = default, Guid? clientAppID = default, Guid? serverAppID = default, string serverAppSecret = default, string tenantID = default)
        {
        ...
        public static ContainerServicePrivateLinkResourceData ContainerServicePrivateLinkResourceData(string id = default, string name = default, string @type = default, string groupId = default, IEnumerable<string> requiredMembers = default, ResourceIdentifier privateLinkServiceID = default)
        {
        ...
        public static AgentPoolAvailableVersions AgentPoolAvailableVersions(string id = default, string name = default, string @type = default, IEnumerable<AgentPoolAvailableVersionsPropertiesAgentPoolVersionsItem> agentPoolVersions = default)
        {
            return new AgentPoolAvailableVersions(id, name, @type, agentPoolVersions is null ? default : new AgentPoolAvailableVersionsProperties((agentPoolVersions ?? new ChangeTrackingList<AgentPoolAvailableVersionsPropertiesAgentPoolVersionsItem>()).ToList(), null), additionalBinaryDataProperties: null);
        }
        ...
        /// <returns> A new <see cref="Models.AgentPoolAvailableVersionsPropertiesAgentPoolVersionsItem"/> instance for mocking. </returns>
        public static AgentPoolAvailableVersionsPropertiesAgentPoolVersionsItem AgentPoolAvailableVersionsPropertiesAgentPoolVersionsItem(bool? @default = default, string kubernetesVersion = default, bool? isPreview = default)
        {
            return new AgentPoolAvailableVersionsPropertiesAgentPoolVersionsItem(@default, kubernetesVersion, isPreview, additionalBinaryDataProperties: null);
        }

        /// <summary> A list of private link resources. </summary>
        /// <param name="value"> The collection value. </param>
        /// <returns> A new <see cref="Models.ContainerServicePrivateLinkResourcesListResult"/> instance for mocking. </returns>
        public static ContainerServicePrivateLinkResourcesListResult ContainerServicePrivateLinkResourcesListResult(IEnumerable<ContainerServicePrivateLinkResourceData> value = default)
        {
            value ??= new ChangeTrackingList<ContainerServicePrivateLinkResourceData>();

            return new ContainerServicePrivateLinkResourcesListResult(value.ToList(), additionalBinaryDataProperties: null);
        }
        ...
        /// <param name="value"> The collection value. </param>
        /// <returns> A new <see cref="Models.ContainerServicePrivateEndpointConnectionListResult"/> instance for mocking. </returns>
        public static ContainerServicePrivateEndpointConnectionListResult ContainerServicePrivateEndpointConnectionListResult(IEnumerable<ContainerServicePrivateEndpointConnectionData> value = default)
        {
            value ??= new ChangeTrackingList<ContainerServicePrivateEndpointConnectionData>();

            return new ContainerServicePrivateEndpointConnectionListResult(value.ToList(), additionalBinaryDataProperties: null);
        }
        ...
        public static ManagedClusterJwtAuthenticatorProperties ManagedClusterJwtAuthenticatorProperties(JWTAuthenticatorProvisioningState? provisioningState = default, JWTAuthenticatorIssuer issuer = default, IEnumerable<JWTAuthenticatorValidationRule> claimValidationRules = default, JWTAuthenticatorClaimMappings claimMappings = default, IEnumerable<JWTAuthenticatorValidationRule> userValidationRules = default)
        {
        ...
        public static MeshMembershipData MeshMembershipData(ResourceIdentifier id = default, string name = default, ResourceType resourceType = default, SystemData systemData = default, MeshMembershipProperties properties = default, string managedBy = default, ETag? etag = default)
        {
        ...
        /// <returns> A new <see cref="Models.LocalDnsProfile"/> instance for mocking. </returns>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public static LocalDnsProfile LocalDnsProfile(Models.LocalDnsMode? mode, Models.LocalDnsState? state, IDictionary<string, Models.LocalDnsOverride> vnetDnsOverrides, IDictionary<string, Models.LocalDnsOverride> kubeDnsOverrides)
        {
            vnetDnsOverrides ??= new ChangeTrackingDictionary<string, Models.LocalDnsOverride>();
            kubeDnsOverrides ??= new ChangeTrackingDictionary<string, Models.LocalDnsOverride>();

            return new LocalDnsProfile(mode, state, default, default, additionalBinaryDataProperties: null);
        }
        ...
        /// <returns> A new <see cref="Models.AgentPoolAvailableVersions"/> instance for mocking. </returns>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public static AgentPoolAvailableVersions AgentPoolAvailableVersions(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IEnumerable<Models.AgentPoolAvailableVersion> agentPoolVersions)
        {
            agentPoolVersions ??= new ChangeTrackingList<Models.AgentPoolAvailableVersion>();
        ...
        /// <returns> A new <see cref="Models.ContainerServiceMachineProperties"/> instance for mocking. </returns>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public static ContainerServiceMachineProperties ContainerServiceMachineProperties(IEnumerable<Models.ContainerServiceMachineIPAddress> networkIPAddresses, ResourceIdentifier resourceId)
        {
            networkIPAddresses ??= new ChangeTrackingList<Models.ContainerServiceMachineIPAddress>();
        ...
        {
            return ContainerServiceAgentPoolData(id, name, resourceType, systemData, etag: default, count, vmSize, osDiskSizeInGB, osDiskType, kubeletDiskType, workloadRuntime, messageOfTheDay: default, vnetSubnetId, podSubnetId, podIPAllocationMode: default, maxPods, osType, osSku, maxCount, minCount, enableAutoScaling, scaleDownMode, typePropertiesType, mode, orchestratorVersion, currentOrchestratorVersion, nodeImageVersion, upgradeStrategy: default, upgradeSettings, upgradeSettingsBlueGreen: default, provisioningState, availabilityZones, enableNodePublicIP, nodePublicIPPrefixId, scaleSetPriority, scaleSetEvictionPolicy, spotMaxPrice, tags, nodeLabels, nodeTaints, nodeInitializationTaints: default, proximityPlacementGroupId, kubeletConfig, linuxOSConfig, enableEncryptionAtHost, enableUltraSsd, enableFips, gpuInstanceProfile, capacityReservationGroupId, hostGroupId, networkProfile, securityProfile: default, gpuProfile: default, virtualMachineNodesStatus: default, localDnsProfile: default, powerStateCode, creationDataSourceResourceId, isOutboundNatDisabled: default, gatewayPublicIPPrefixSize: default, isArtifactStreamingEnabled: default, virtualMachinesScale: default, statusProvisioningError: default, nodeCustomizationId: default);
        }
    }
}
