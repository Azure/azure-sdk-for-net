...
namespace Azure.ResourceManager.ContainerService
{
    ...
    public partial class MeshUpgradeProfileData : ResourceData
    {
        ...
        internal MeshUpgradeProfileData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, MeshUpgradeProfileProperties properties) : base(id, name, resourceType, systemData)
        {
