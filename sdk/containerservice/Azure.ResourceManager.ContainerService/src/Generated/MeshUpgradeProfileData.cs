...
namespace Azure.ResourceManager.ContainerService
{
    ...
    public partial class MeshUpgradeProfileData : ResourceData
    {
        ...
        internal MeshUpgradeProfileData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, MeshUpgradeProfileProperties properties, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, name, resourceType, systemData)
        {
