    ...
    public partial class ContainerServiceAgentPoolData : IUtf8JsonSerializable, IJsonModel<ContainerServiceAgentPoolData>
    {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("localDNSProfile"u8))
                        {
                            if (property0.Value.ValueKind == JsonValueKind.Null)
                            {
                                continue;
                            }
                            localDnsProfile = LocalDnsProfile.DeserializeLocalDnsProfile(property0.Value, options);
                            continue;
                        }
                    }
                    continue;
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            else
            {
                ...
                {
                    builder.Append("    localDNSProfile: ");
                    BicepSerializationHelpers.AppendChildObject(builder, LocalDnsProfile, options, 4, false, "    localDNSProfile: ");
                }
            }
