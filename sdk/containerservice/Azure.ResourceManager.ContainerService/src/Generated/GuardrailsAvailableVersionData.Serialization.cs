...
{
    public partial class GuardrailsAvailableVersionData : IUtf8JsonSerializable, IJsonModel<GuardrailsAvailableVersionData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GuardrailsAvailableVersionData>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<GuardrailsAvailableVersionData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        GuardrailsAvailableVersionData IJsonModel<GuardrailsAvailableVersionData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<GuardrailsAvailableVersionData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        BinaryData IPersistableModel<GuardrailsAvailableVersionData>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<GuardrailsAvailableVersionData>)this).GetFormatFromOptions(options) : options.Format;
        ...
        GuardrailsAvailableVersionData IPersistableModel<GuardrailsAvailableVersionData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<GuardrailsAvailableVersionData>)this).GetFormatFromOptions(options) : options.Format;
