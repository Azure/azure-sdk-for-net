...
namespace Azure.ResourceManager.ContainerService
{
    ...
    public partial class SafeguardsAvailableVersionCollection : ArmCollection, IEnumerable<SafeguardsAvailableVersionResource>, IAsyncEnumerable<SafeguardsAvailableVersionResource>
    {
        ...
        internal SafeguardsAvailableVersionCollection(ArmClient client, ResourceIdentifier id, AzureLocation location) : base(client, id)
        {
            ...
            _location = location;
            _managedClustersClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.ContainerService", SafeguardsAvailableVersionResource.ResourceType.Namespace, Diagnostics);
            _managedClustersRestClient = new ManagedClusters(_managedClustersClientDiagnostics, Pipeline, Endpoint, safeguardsAvailableVersionApiVersion ?? "2025-10-02-preview");
        ...
        public virtual async Task<Response<SafeguardsAvailableVersionResource>> GetAsync(string version, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _managedClustersClientDiagnostics.CreateScope("SafeguardsAvailableVersionCollection.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _managedClustersRestClient.CreateGetSafeguardsVersionsRequest(Guid.Parse(Id.SubscriptionId), _location, version, context);
        ...
        public virtual AsyncPageable<SafeguardsAvailableVersionResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<SafeguardsAvailableVersionData, SafeguardsAvailableVersionResource>(new ManagedClustersGetSafeguardsVersionsAsyncCollectionResultOfT(_managedClustersRestClient, Guid.Parse(Id.SubscriptionId), _location, context), data => new SafeguardsAvailableVersionResource(Client, data));
        }
        ...
        public virtual Pageable<SafeguardsAvailableVersionResource> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            return new PageableWrapper<SafeguardsAvailableVersionData, SafeguardsAvailableVersionResource>(new ManagedClustersGetSafeguardsVersionsCollectionResultOfT(_managedClustersRestClient, Guid.Parse(Id.SubscriptionId), _location, context), data => new SafeguardsAvailableVersionResource(Client, data));
        }
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string version, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _managedClustersClientDiagnostics.CreateScope("SafeguardsAvailableVersionCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual async Task<NullableResponse<SafeguardsAvailableVersionResource>> GetIfExistsAsync(string version, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _managedClustersClientDiagnostics.CreateScope("SafeguardsAvailableVersionCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
