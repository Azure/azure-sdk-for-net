...
namespace Azure.ResourceManager.ContainerService
{
    ...
    public partial class MeshRevisionProfileResource : ArmResource
    {
        ...
        {
            using DiagnosticScope scope = _managedClustersClientDiagnostics.CreateScope("MeshRevisionProfileResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _managedClustersRestClient.CreateGetMeshRevisionProfileRequest(Guid.Parse(Id.SubscriptionId), Id.Parent.Name, Id.Name, context);
