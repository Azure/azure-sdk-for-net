...
namespace Azure.ResourceManager.ContainerService
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="MeshRevisionProfileResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="SubscriptionResource"/> using the GetMeshRevisionProfiles method.
    /// </summary>
    public partial class MeshRevisionProfileResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of MeshRevisionProfileResource for mocking. </summary>
        protected MeshRevisionProfileResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="MeshRevisionProfileResource"/> class. </summary>
        ...
        {
            TryGetApiVersion(ResourceType, out string meshRevisionProfileApiVersion);
            _meshRevisionProfilesClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.ContainerService", ResourceType.Namespace, Diagnostics);
        ...
        {
            string resourceId = $"/subscriptions/{subscriptionId}/providers/Microsoft.ContainerService/locations/{location}/meshRevisionProfiles/{mode}";
        ...
        {
            using DiagnosticScope scope = _meshRevisionProfilesClientDiagnostics.CreateScope("MeshRevisionProfileResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _meshRevisionProfilesRestClient.CreateGetMeshRevisionProfileRequest(Guid.Parse(Id.SubscriptionId), Id.Parent.Name, Id.Name, context);
