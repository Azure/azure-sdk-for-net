...
namespace Azure.ResourceManager.ContainerService
{
    ...
    {
        internal static AgentPoolUpgradeProfileData DeserializeAgentPoolUpgradeProfileData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
