...
namespace Azure.ResourceManager.ContainerService.Models
{
    ...
    internal partial class TrustedAccessRoleBindingProperties
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="TrustedAccessRoleBindingProperties"/>. </summary>
        ...
        public TrustedAccessRoleBindingProperties(ResourceIdentifier sourceResourceId, IEnumerable<string> roles)
        {
        ...
        internal TrustedAccessRoleBindingProperties(ContainerServiceTrustedAccessRoleBindingProvisioningState? provisioningState, ResourceIdentifier sourceResourceId, IList<string> roles, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
        ...
        [WirePath("roles")]
        public IList<string> Roles { get; } = new ChangeTrackingList<string>();
    }
}
