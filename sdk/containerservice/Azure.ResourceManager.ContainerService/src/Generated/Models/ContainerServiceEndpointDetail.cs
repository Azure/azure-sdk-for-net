...
namespace Azure.ResourceManager.ContainerService.Models
{
    ...
    public partial class ContainerServiceEndpointDetail
    {
        ...
        internal ContainerServiceEndpointDetail(string ipAddress, int? port, string protocol, string description, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            IpAddress = ipAddress;
            Port = port;
            Protocol = protocol;
