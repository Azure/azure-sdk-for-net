...
namespace Azure.ResourceManager.ContainerService.Models
{
    ...
    public partial class ContainerServiceEndpointDetail
    {
        ...
        internal ContainerServiceEndpointDetail(IPAddress ipAddress, int? port, string protocol, string description, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            IPAddress = ipAddress;
            Port = port;
            Protocol = protocol;
