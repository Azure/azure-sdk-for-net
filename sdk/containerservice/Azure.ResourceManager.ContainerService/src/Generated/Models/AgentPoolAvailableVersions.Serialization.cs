...
namespace Azure.ResourceManager.ContainerService.Models
{
    ...
    {
        internal static AgentPoolAvailableVersions DeserializeAgentPoolAvailableVersions(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
