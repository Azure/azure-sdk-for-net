...
{
    public partial class AgentPoolAvailableVersions : IUtf8JsonSerializable, IJsonModel<AgentPoolAvailableVersions>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AgentPoolAvailableVersions>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        AgentPoolAvailableVersions IJsonModel<AgentPoolAvailableVersions>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AgentPoolAvailableVersions>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static AgentPoolAvailableVersions DeserializeAgentPoolAvailableVersions(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            builder.AppendLine(" {");
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(AgentPoolVersions), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("    agentPoolVersions: ");
                builder.AppendLine(propertyOverride);
            }
            else
            {
                if (Optional.IsCollectionDefined(AgentPoolVersions))
                {
                    if (AgentPoolVersions.Any())
                    {
                        builder.Append("    agentPoolVersions: ");
                        builder.AppendLine("[");
                        foreach (var item in AgentPoolVersions)
                        {
                            BicepSerializationHelpers.AppendChildObject(builder, item, options, 6, true, "    agentPoolVersions: ");
                        }
                        builder.AppendLine("    ]");
                    }
                }
        ...
        AgentPoolAvailableVersions IPersistableModel<AgentPoolAvailableVersions>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AgentPoolAvailableVersions>)this).GetFormatFromOptions(options) : options.Format;
