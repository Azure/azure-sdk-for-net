...
{
    public partial class KubernetesPatchVersion : IUtf8JsonSerializable, IJsonModel<KubernetesPatchVersion>, IPersistableModel<KubernetesPatchVersion>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<KubernetesPatchVersion>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<KubernetesPatchVersion>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(KubernetesPatchVersion)} does not support '{format}' format.");
            }
        ...
        internal static KubernetesPatchVersion DeserializeKubernetesPatchVersion(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new KubernetesPatchVersion(Optional.ToList(upgrades), serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<KubernetesPatchVersion>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(KubernetesPatchVersion)} does not support '{options.Format}' format.");
            }
        }
