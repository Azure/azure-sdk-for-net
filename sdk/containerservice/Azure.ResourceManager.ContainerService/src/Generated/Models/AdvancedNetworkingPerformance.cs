...
namespace Azure.ResourceManager.ContainerService.Models
{
    ...
    internal partial class AdvancedNetworkingPerformance
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="AdvancedNetworkingPerformance"/>. </summary>
        ...
        internal AdvancedNetworkingPerformance(AccelerationMode? accelerationMode, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
