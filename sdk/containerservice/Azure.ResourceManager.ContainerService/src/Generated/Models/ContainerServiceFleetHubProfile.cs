...
namespace Azure.ResourceManager.ContainerService.Models
{
    ...
    public partial class ContainerServiceFleetHubProfile
    {
        ...
        internal ContainerServiceFleetHubProfile(string dnsPrefix, string fqdn, string kubernetesVersion, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            DnsPrefix = dnsPrefix;
            Fqdn = fqdn;
