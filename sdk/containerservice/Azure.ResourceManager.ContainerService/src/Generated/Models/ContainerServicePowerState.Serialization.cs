...
{
    internal partial class ContainerServicePowerState : IUtf8JsonSerializable, IJsonModel<ContainerServicePowerState>, IPersistableModel<ContainerServicePowerState>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContainerServicePowerState>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ContainerServicePowerState>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ContainerServicePowerState)} does not support '{format}' format.");
            }
