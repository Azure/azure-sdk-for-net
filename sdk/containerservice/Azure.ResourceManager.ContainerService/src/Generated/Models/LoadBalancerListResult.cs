...
namespace Azure.ResourceManager.ContainerService.Models
{
    ...
    internal partial class LoadBalancerListResult
    {
        ...
        internal LoadBalancerListResult(IEnumerable<ManagedClusterLoadBalancerData> value)
        {
            Value = value.ToList();
        }
        ...
        internal LoadBalancerListResult(IList<ManagedClusterLoadBalancerData> value, Uri nextLink, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            NextLink = nextLink;
        ...
        [WirePath("value")]
        public IList<ManagedClusterLoadBalancerData> Value { get; }
