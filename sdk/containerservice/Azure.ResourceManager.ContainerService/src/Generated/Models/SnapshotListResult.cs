...
namespace Azure.ResourceManager.ContainerService.Models
{
    ...
    internal partial class SnapshotListResult
    {
        ...
        internal SnapshotListResult(IEnumerable<AgentPoolSnapshotData> value)
        {
            Value = value.ToList();
        }
        ...
        internal SnapshotListResult(IList<AgentPoolSnapshotData> value, Uri nextLink, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            NextLink = nextLink;
        ...
        [WirePath("value")]
        public IList<AgentPoolSnapshotData> Value { get; }
