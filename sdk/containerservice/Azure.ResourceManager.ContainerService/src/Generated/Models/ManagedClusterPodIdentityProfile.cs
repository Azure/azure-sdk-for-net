...
namespace Azure.ResourceManager.ContainerService.Models
{
    ...
    public partial class ManagedClusterPodIdentityProfile
    {
        ...
        internal ManagedClusterPodIdentityProfile(bool? isEnabled, bool? allowNetworkPluginKubenet, IList<ManagedClusterPodIdentity> userAssignedIdentities, IList<ManagedClusterPodIdentityException> userAssignedIdentityExceptions, Dictionary<string, BinaryData> rawData)
        {
            IsEnabled = isEnabled;
