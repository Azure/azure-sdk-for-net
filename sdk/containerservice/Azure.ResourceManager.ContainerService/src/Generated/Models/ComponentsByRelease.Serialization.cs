...
namespace Azure.ResourceManager.ContainerService.Models
{
    ...
    public partial class ComponentsByRelease : IJsonModel<ComponentsByRelease>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<ComponentsByRelease>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ComponentsByRelease IJsonModel<ComponentsByRelease>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual ComponentsByRelease JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<ComponentsByRelease>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static ComponentsByRelease DeserializeComponentsByRelease(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            IList<Component> components = default;
            ...
            return new ComponentsByRelease(kubernetesVersion, components ?? new ChangeTrackingList<Component>(), additionalBinaryDataProperties);
        }

        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ComponentsByRelease>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ComponentsByRelease IPersistableModel<ComponentsByRelease>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual ComponentsByRelease PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<ComponentsByRelease>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
