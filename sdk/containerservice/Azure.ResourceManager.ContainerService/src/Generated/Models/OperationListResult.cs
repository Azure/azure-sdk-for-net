...
namespace Azure.ResourceManager.ContainerService.Models
{
    ...
    internal partial class OperationListResult
    {
        ...
        internal OperationListResult(IEnumerable<OperationValue> value)
        {
            Value = value.ToList();
        }
        ...
        internal OperationListResult(IList<OperationValue> value, Uri nextLink, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            NextLink = nextLink;
        ...
        [WirePath("value")]
        public IList<OperationValue> Value { get; }
