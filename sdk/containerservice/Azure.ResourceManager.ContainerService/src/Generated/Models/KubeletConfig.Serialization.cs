...
{
    public partial class KubeletConfig : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static KubeletConfig DeserializeKubeletConfig(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
