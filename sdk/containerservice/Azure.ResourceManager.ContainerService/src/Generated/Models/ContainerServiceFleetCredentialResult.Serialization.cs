...
namespace Azure.ResourceManager.ContainerService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContainerServiceFleetCredentialResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ContainerServiceFleetCredentialResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ContainerServiceFleetCredentialResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ContainerServiceFleetCredentialResult>)} interface");
            }
        ...
        string IPersistableModel<ContainerServiceFleetCredentialResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
