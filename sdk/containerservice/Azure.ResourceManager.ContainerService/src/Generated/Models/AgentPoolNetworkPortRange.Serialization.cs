...
{
    public partial class AgentPoolNetworkPortRange : IUtf8JsonSerializable, IJsonModel<AgentPoolNetworkPortRange>, IPersistableModel<AgentPoolNetworkPortRange>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(PortStart))
            {
                ...
                builder.AppendLine($" '{PortStart.Value.ToString()}'");
            }

            if (Optional.IsDefined(PortEnd))
            {
                builder.Append("  portEnd:");
                builder.AppendLine($" '{PortEnd.Value.ToString()}'");
            }
