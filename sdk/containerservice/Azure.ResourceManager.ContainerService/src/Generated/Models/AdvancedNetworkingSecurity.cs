...
namespace Azure.ResourceManager.ContainerService.Models
{
    ...
    internal partial class AdvancedNetworkingSecurity
    {
        ...
        /// <summary> Initializes a new instance of <see cref="AdvancedNetworkingSecurity"/>. </summary>
        /// <param name="enabled"> This feature allows user to configure network policy based on DNS (FQDN) names. It can be enabled only on cilium based clusters. If not specified, the default is false. </param>
        /// <param name="serializedAdditionalRawData"> Keeps track of any properties unknown to the library. </param>
        internal AdvancedNetworkingSecurity(bool? enabled, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Enabled = enabled;
