...
{
    public partial class IstioServiceMesh : IUtf8JsonSerializable, IJsonModel<IstioServiceMesh>, IPersistableModel<IstioServiceMesh>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Components))
            {
                ...
                AppendChildObject(builder, Components, options, 2);
            }

            if (Optional.IsDefined(CertificateAuthority))
            {
                builder.Append("  certificateAuthority:");
                AppendChildObject(builder, CertificateAuthority, options, 2);
            }
