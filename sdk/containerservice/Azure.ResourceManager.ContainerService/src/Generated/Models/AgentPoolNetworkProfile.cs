...
namespace Azure.ResourceManager.ContainerService.Models
{
    ...
    public partial class AgentPoolNetworkProfile
    {
        ...
        internal AgentPoolNetworkProfile(IList<ContainerServiceIPTag> nodePublicIPTags, IList<AgentPoolNetworkPortRange> allowedHostPorts, IList<ResourceIdentifier> applicationSecurityGroups, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
