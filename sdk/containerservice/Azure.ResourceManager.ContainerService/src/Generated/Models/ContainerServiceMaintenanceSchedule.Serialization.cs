...
namespace Azure.ResourceManager.ContainerService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContainerServiceMaintenanceSchedule>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ContainerServiceMaintenanceSchedule>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ContainerServiceMaintenanceSchedule>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ContainerServiceMaintenanceSchedule>)} interface");
            }
        ...
        string IPersistableModel<ContainerServiceMaintenanceSchedule>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
