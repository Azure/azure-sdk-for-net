...
{
    public partial class ContainerServiceMaintenanceSchedule : IUtf8JsonSerializable, IJsonModel<ContainerServiceMaintenanceSchedule>, IPersistableModel<ContainerServiceMaintenanceSchedule>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Daily))
            {
                ...
                AppendChildObject(builder, Daily, options, 2);
            }

            if (Optional.IsDefined(Weekly))
            {
                builder.Append("  weekly:");
                AppendChildObject(builder, Weekly, options, 2);
            }

            if (Optional.IsDefined(AbsoluteMonthly))
            {
                builder.Append("  absoluteMonthly:");
                AppendChildObject(builder, AbsoluteMonthly, options, 2);
            }

            if (Optional.IsDefined(RelativeMonthly))
            {
                builder.Append("  relativeMonthly:");
                AppendChildObject(builder, RelativeMonthly, options, 2);
            }
