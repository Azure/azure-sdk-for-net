...
namespace Azure.ResourceManager.ContainerService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ManagedClusterSecurityProfileWorkloadIdentity>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<ManagedClusterSecurityProfileWorkloadIdentity>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ManagedClusterSecurityProfileWorkloadIdentity>)} interface");
            }
        ...
        string IPersistableModel<ManagedClusterSecurityProfileWorkloadIdentity>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
