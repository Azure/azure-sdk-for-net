...
namespace Azure.ResourceManager.ContainerService.Models
{
    ...
    {
        internal static AgentPoolAvailableVersion DeserializeAgentPoolAvailableVersion(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
