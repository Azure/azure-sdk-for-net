...
namespace Azure.ResourceManager.ContainerService.Models
{
    ...
    internal partial class ManagedClusterStaticEgressGatewayProfile
    {
        ...
        /// <summary> Initializes a new instance of <see cref="ManagedClusterStaticEgressGatewayProfile"/>. </summary>
        /// <param name="enabled"> Indicates if Static Egress Gateway addon is enabled or not. </param>
        /// <param name="serializedAdditionalRawData"> Keeps track of any properties unknown to the library. </param>
        internal ManagedClusterStaticEgressGatewayProfile(bool? enabled, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Enabled = enabled;
