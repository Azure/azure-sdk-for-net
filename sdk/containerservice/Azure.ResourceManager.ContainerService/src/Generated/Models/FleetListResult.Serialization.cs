...
namespace Azure.ResourceManager.ContainerService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FleetListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<FleetListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<FleetListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<FleetListResult>)} interface");
            }
        ...
        string IPersistableModel<FleetListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
