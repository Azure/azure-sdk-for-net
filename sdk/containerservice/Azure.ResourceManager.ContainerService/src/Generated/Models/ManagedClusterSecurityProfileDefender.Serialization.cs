...
{
    public partial class ManagedClusterSecurityProfileDefender : IUtf8JsonSerializable, IJsonModel<ManagedClusterSecurityProfileDefender>, IPersistableModel<ManagedClusterSecurityProfileDefender>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SecurityMonitoring))
            {
                ...
                AppendChildObject(builder, SecurityMonitoring, options, 2);
            }
