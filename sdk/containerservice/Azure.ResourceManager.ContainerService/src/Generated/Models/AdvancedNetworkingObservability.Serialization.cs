...
namespace Azure.ResourceManager.ContainerService.Models
{
    internal partial class AdvancedNetworkingObservability : IUtf8JsonSerializable, IJsonModel<AdvancedNetworkingObservability>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(IsObservabilityEnabled), out propertyOverride);
            ...
            else
            {
                ...
                {
                    builder.Append("  enabled: ");
                    var boolValue = IsObservabilityEnabled.Value == true ? "true" : "false";
