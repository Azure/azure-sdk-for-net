...
namespace Azure.ResourceManager.ContainerService.Models
{
    ...
    public partial class ContainerServiceMaintenanceAbsoluteMonthlySchedule
    {
        ...
        internal ContainerServiceMaintenanceAbsoluteMonthlySchedule(int intervalMonths, int dayOfMonth, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            IntervalMonths = intervalMonths;
            DayOfMonth = dayOfMonth;
