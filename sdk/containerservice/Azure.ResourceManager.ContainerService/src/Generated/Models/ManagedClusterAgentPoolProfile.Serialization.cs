...
{
    public partial class ManagedClusterAgentPoolProfile : IUtf8JsonSerializable, IModelJsonSerializable<ManagedClusterAgentPoolProfile>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IModelJsonSerializable<ManagedClusterAgentPoolProfile>)this).Serialize(writer, ModelSerializerOptions.DefaultWireOptions);

        void IModelJsonSerializable<ManagedClusterAgentPoolProfile>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<ManagedClusterAgentPoolProfile>(this, options.Format);
            ...
            if (Optional.IsDefined(PowerState))
            {
                ...
                {
                    ((IModelJsonSerializable<ContainerServicePowerState>)PowerState).Serialize(writer, options);
                }
            }
            ...
            if (Optional.IsDefined(KubeletConfig))
            {
                ...
                if (KubeletConfig is null)
                {
                    writer.WriteNullValue();
                }
                else
                {
                    ((IModelJsonSerializable<KubeletConfig>)KubeletConfig).Serialize(writer, options);
                }
            }
            if (Optional.IsDefined(LinuxOSConfig))
            {
                writer.WritePropertyName("linuxOSConfig"u8);
                if (LinuxOSConfig is null)
                {
                    writer.WriteNullValue();
                }
                else
                {
                    ((IModelJsonSerializable<LinuxOSConfig>)LinuxOSConfig).Serialize(writer, options);
                }
            }
            ...
            if (Optional.IsDefined(WindowsProfile))
            {
                ...
                {
                    ((IModelJsonSerializable<AgentPoolWindowsProfile>)WindowsProfile).Serialize(writer, options);
                }
            }
            if (Optional.IsDefined(NetworkProfile))
            {
                ...
                {
                    ((IModelJsonSerializable<AgentPoolNetworkProfile>)NetworkProfile).Serialize(writer, options);
                }
            }
        ...
        internal static ManagedClusterAgentPoolProfile DeserializeManagedClusterAgentPoolProfile(JsonElement element, ModelSerializerOptions options = default)
        {
        ...
        ManagedClusterAgentPoolProfile IModelSerializable<ManagedClusterAgentPoolProfile>.Deserialize(BinaryData data, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<ManagedClusterAgentPoolProfile>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="ManagedClusterAgentPoolProfile"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="ManagedClusterAgentPoolProfile"/> to convert. </param>
        public static implicit operator RequestContent(ManagedClusterAgentPoolProfile model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="ManagedClusterAgentPoolProfile"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator ManagedClusterAgentPoolProfile(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeManagedClusterAgentPoolProfile(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
