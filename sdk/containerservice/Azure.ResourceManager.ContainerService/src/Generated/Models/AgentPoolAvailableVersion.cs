...
namespace Azure.ResourceManager.ContainerService.Models
{
    ...
    public partial class AgentPoolAvailableVersion
    {
        ...
        internal AgentPoolAvailableVersion(AgentPoolAvailableVersionsProperties properties)
        {
        ...
        internal AgentPoolAvailableVersion(string id, string name, string @type, AgentPoolAvailableVersionsProperties properties, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Id = id;
            Name = name;
            Type = @type;
