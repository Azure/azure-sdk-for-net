...
namespace Azure.ResourceManager.ContainerService.Models
{
    ...
    public partial class MachineOSProfileLinuxProfile
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="MachineOSProfileLinuxProfile"/>. </summary>
        ...
        internal MachineOSProfileLinuxProfile(LinuxOSConfig linuxOSConfig, string messageOfTheDay, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
