...
namespace Azure.ResourceManager.ContainerService.Models
{
    internal partial class TrustedAccessRoleBindingListResult
    {
        internal static TrustedAccessRoleBindingListResult DeserializeTrustedAccessRoleBindingListResult(JsonElement element)
        {
            ...
            Core.Optional<IReadOnlyList<ContainerServiceTrustedAccessRoleBindingData>> value = default;
            ...
            return new TrustedAccessRoleBindingListResult(Core.Optional.ToList(value), nextLink.Value);
        }
    }
}
