...
{
    public partial class ContainerServiceUserAssignedIdentity : Core.IUtf8JsonSerializable
    {
        ...
        internal static ContainerServiceUserAssignedIdentity DeserializeContainerServiceUserAssignedIdentity(JsonElement element)
        {
            ...
            return new ContainerServiceUserAssignedIdentity(resourceId.Value, Core.Optional.ToNullable(clientId), Core.Optional.ToNullable(objectId));
        }
    }
}
