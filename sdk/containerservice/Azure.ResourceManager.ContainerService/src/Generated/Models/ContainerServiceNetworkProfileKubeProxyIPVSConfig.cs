...
namespace Azure.ResourceManager.ContainerService.Models
{
    ...
    public partial class ContainerServiceNetworkProfileKubeProxyIPVSConfig
    {
        ...
        internal ContainerServiceNetworkProfileKubeProxyIPVSConfig(ContainerServiceNetworkProfileKubeProxyIPVSScheduler? scheduler, int? tcpTimeoutSeconds, int? tcpFinTimeoutSeconds, int? udpTimeoutSeconds, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Scheduler = scheduler;
