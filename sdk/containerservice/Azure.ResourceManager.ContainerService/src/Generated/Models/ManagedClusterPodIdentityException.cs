...
namespace Azure.ResourceManager.ContainerService.Models
{
    ...
    public partial class ManagedClusterPodIdentityException
    {
        ...
        internal ManagedClusterPodIdentityException(string name, string @namespace, IDictionary<string, string> podLabels, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Namespace = @namespace;
            PodLabels = podLabels;
