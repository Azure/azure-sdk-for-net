...
{
    internal partial class ClusterUpgradeSettings : IUtf8JsonSerializable, IJsonModel<ClusterUpgradeSettings>, IPersistableModel<ClusterUpgradeSettings>
    {
        ...
        internal static ClusterUpgradeSettings DeserializeClusterUpgradeSettings(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            Optional<UpgradeOverrideSettings> overrideSettings = default;
            ...
            return new ClusterUpgradeSettings(overrideSettings.Value, serializedAdditionalRawData);
        }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(OverrideSettings))
            {
                ...
                AppendChildObject(builder, OverrideSettings, options, 2);
            }
