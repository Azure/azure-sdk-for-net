...
namespace Azure.ResourceManager.ContainerService.Models
{
    ...
    public partial class ManagedClusterVerticalPodAutoscaler
    {
        ...
        internal ManagedClusterVerticalPodAutoscaler(bool isEnabled, ManagedClusterWorkloadAutoScalerControlledValue controlledValues, ManagedClusterVerticalPodAutoscalerUpdateMode updateMode, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            IsEnabled = isEnabled;
            ControlledValues = controlledValues;
            UpdateMode = updateMode;
