...
namespace Azure.ResourceManager.ContainerService.Models
{
    ...
    public partial class ContainerServiceMaintenanceWeeklySchedule
    {
        ...
        internal ContainerServiceMaintenanceWeeklySchedule(int intervalWeeks, ContainerServiceWeekDay dayOfWeek, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            IntervalWeeks = intervalWeeks;
            DayOfWeek = dayOfWeek;
