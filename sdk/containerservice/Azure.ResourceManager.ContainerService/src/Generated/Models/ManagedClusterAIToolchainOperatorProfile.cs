...
namespace Azure.ResourceManager.ContainerService.Models
{
    ...
    internal partial class ManagedClusterAIToolchainOperatorProfile
    {
        ...
        /// <summary> Initializes a new instance of <see cref="ManagedClusterAIToolchainOperatorProfile"/>. </summary>
        /// <param name="enabled"> Indicates if AI toolchain operator  enabled or not. </param>
        /// <param name="serializedAdditionalRawData"> Keeps track of any properties unknown to the library. </param>
        internal ManagedClusterAIToolchainOperatorProfile(bool? enabled, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Enabled = enabled;
