...
namespace Azure.ResourceManager.ContainerService.Models
{
    ...
    {
        internal static ManagedClusterCredential DeserializeManagedClusterCredential(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
