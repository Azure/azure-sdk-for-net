...
namespace Azure.ResourceManager.ContainerService.Models
{
    public partial class RunCommandResult
    {
        internal static RunCommandResult DeserializeRunCommandResult(JsonElement element)
        {
            ...
            return new RunCommandResult(id.Value, provisioningState.Value, Optional.ToNullable(exitCode), Optional.ToNullable(startedAt), Optional.ToNullable(finishedAt), logs.Value, reason.Value);
        }
    }
}
