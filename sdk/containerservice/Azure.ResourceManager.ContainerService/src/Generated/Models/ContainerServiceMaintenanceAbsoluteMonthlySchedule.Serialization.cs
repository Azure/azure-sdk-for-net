...
{
    public partial class ContainerServiceMaintenanceAbsoluteMonthlySchedule : IUtf8JsonSerializable, IJsonModel<ContainerServiceMaintenanceAbsoluteMonthlySchedule>, IPersistableModel<ContainerServiceMaintenanceAbsoluteMonthlySchedule>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(DayOfMonth))
            {
                ...
                builder.AppendLine($" '{DayOfMonth.ToString()}'");
            }
