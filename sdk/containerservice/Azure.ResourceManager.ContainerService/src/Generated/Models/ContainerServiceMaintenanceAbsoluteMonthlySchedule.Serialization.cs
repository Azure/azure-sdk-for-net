...
namespace Azure.ResourceManager.ContainerService.Models
{
    ...
    public partial class ContainerServiceMaintenanceAbsoluteMonthlySchedule : IJsonModel<ContainerServiceMaintenanceAbsoluteMonthlySchedule>
    {
        ...
        protected virtual ContainerServiceMaintenanceAbsoluteMonthlySchedule PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<ContainerServiceMaintenanceAbsoluteMonthlySchedule>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ContainerServiceMaintenanceAbsoluteMonthlySchedule>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        ContainerServiceMaintenanceAbsoluteMonthlySchedule IPersistableModel<ContainerServiceMaintenanceAbsoluteMonthlySchedule>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ContainerServiceMaintenanceAbsoluteMonthlySchedule IJsonModel<ContainerServiceMaintenanceAbsoluteMonthlySchedule>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual ContainerServiceMaintenanceAbsoluteMonthlySchedule JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<ContainerServiceMaintenanceAbsoluteMonthlySchedule>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static ContainerServiceMaintenanceAbsoluteMonthlySchedule DeserializeContainerServiceMaintenanceAbsoluteMonthlySchedule(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new ContainerServiceMaintenanceAbsoluteMonthlySchedule(intervalMonths, dayOfMonth, additionalBinaryDataProperties);
        }
    }
}
