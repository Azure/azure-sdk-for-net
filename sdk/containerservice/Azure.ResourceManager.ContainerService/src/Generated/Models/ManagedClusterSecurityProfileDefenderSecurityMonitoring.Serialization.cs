...
{
    internal partial class ManagedClusterSecurityProfileDefenderSecurityMonitoring : IUtf8JsonSerializable, IJsonModel<ManagedClusterSecurityProfileDefenderSecurityMonitoring>, IPersistableModel<ManagedClusterSecurityProfileDefenderSecurityMonitoring>
    {
        ...
        void IJsonModel<ManagedClusterSecurityProfileDefenderSecurityMonitoring>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ManagedClusterSecurityProfileDefenderSecurityMonitoring)} does not support '{format}' format.");
            }
