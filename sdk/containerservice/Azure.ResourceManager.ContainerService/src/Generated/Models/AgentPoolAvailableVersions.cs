...
namespace Azure.ResourceManager.ContainerService.Models
{
    ...
    public partial class AgentPoolAvailableVersions : ResourceData
    {
        ...
        /// <param name="properties"> Properties of agent pool available versions. </param>
        internal AgentPoolAvailableVersions(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, AgentPoolAvailableVersionsProperties properties) : base(id, name, resourceType, systemData)
        {
