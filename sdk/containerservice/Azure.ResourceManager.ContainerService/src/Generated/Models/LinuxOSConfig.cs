...
namespace Azure.ResourceManager.ContainerService.Models
{
    ...
    public partial class LinuxOSConfig
    {
        ...
        internal LinuxOSConfig(SysctlConfig sysctls, string transparentHugePageEnabled, string transparentHugePageDefrag, int? swapFileSizeInMB, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Sysctls = sysctls;
