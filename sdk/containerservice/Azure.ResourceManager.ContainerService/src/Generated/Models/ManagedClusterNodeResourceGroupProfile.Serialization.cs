...
namespace Azure.ResourceManager.ContainerService.Models
{
    internal partial class ManagedClusterNodeResourceGroupProfile : IUtf8JsonSerializable, IJsonModel<ManagedClusterNodeResourceGroupProfile>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<ManagedClusterNodeResourceGroupProfile>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ManagedClusterNodeResourceGroupProfile>)} interface");
            }
