...
namespace Azure.ResourceManager.ContainerService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ManagedClusterNodeResourceGroupProfile>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ManagedClusterNodeResourceGroupProfile>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ManagedClusterNodeResourceGroupProfile>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<ManagedClusterNodeResourceGroupProfile>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
