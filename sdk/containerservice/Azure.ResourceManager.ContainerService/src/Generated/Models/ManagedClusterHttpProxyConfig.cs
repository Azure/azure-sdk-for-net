...
namespace Azure.ResourceManager.ContainerService.Models
{
    ...
    public partial class ManagedClusterHttpProxyConfig
    {
        ...
        internal ManagedClusterHttpProxyConfig(string httpProxy, string httpsProxy, IList<string> noProxy, IReadOnlyList<string> effectiveNoProxy, string trustedCA, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            HttpProxy = httpProxy;
