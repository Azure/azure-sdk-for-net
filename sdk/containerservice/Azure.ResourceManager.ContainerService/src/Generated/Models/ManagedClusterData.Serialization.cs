                ...
                if (property.NameEquals("properties"))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("identityProfile"))
                        {
                            ...
                            Dictionary<string, Models.UserAssignedIdentity> dictionary = new Dictionary<string, Models.UserAssignedIdentity>();
                            foreach (var property1 in property0.Value.EnumerateObject())
                            {
                                dictionary.Add(property1.Name, Models.UserAssignedIdentity.DeserializeUserAssignedIdentity(property1.Value));
                            }
