...
namespace Azure.ResourceManager.ContainerService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContainerServicePrivateLinkResourceData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ContainerServicePrivateLinkResourceData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ContainerServicePrivateLinkResourceData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ContainerServicePrivateLinkResourceData>)} interface");
            }
        ...
        string IPersistableModel<ContainerServicePrivateLinkResourceData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
