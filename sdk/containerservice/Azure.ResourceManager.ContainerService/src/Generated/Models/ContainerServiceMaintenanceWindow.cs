...
namespace Azure.ResourceManager.ContainerService.Models
{
    ...
    public partial class ContainerServiceMaintenanceWindow
    {
        ...
        internal ContainerServiceMaintenanceWindow(ContainerServiceMaintenanceSchedule schedule, int durationHours, string utcOffset, string startDate, string startTime, IList<ContainerServiceDateSpan> notAllowedDates, Dictionary<string, BinaryData> rawData)
        {
            Schedule = schedule;
            DurationHours = durationHours;
            UtcOffset = utcOffset;
