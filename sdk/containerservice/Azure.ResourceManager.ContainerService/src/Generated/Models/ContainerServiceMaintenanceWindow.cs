...
namespace Azure.ResourceManager.ContainerService.Models
{
    ...
    public partial class ContainerServiceMaintenanceWindow
    {
        ...
        internal ContainerServiceMaintenanceWindow(ContainerServiceMaintenanceSchedule schedule, int durationHours, string utcOffset, DateTimeOffset? startOn, string startTime, IList<ContainerServiceDateSpan> notAllowedDates, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Schedule = schedule;
            DurationHours = durationHours;
            UtcOffset = utcOffset;
