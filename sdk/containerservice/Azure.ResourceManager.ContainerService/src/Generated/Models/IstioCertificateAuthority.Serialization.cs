...
{
    internal partial class IstioCertificateAuthority : IUtf8JsonSerializable, IJsonModel<IstioCertificateAuthority>, IPersistableModel<IstioCertificateAuthority>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Plugin))
            {
                ...
                AppendChildObject(builder, Plugin, options, 2);
            }
