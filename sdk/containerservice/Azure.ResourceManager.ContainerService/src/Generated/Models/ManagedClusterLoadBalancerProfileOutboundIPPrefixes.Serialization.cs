...
namespace Azure.ResourceManager.ContainerService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ManagedClusterLoadBalancerProfileOutboundIPPrefixes>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<ManagedClusterLoadBalancerProfileOutboundIPPrefixes>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ManagedClusterLoadBalancerProfileOutboundIPPrefixes>)} interface");
            }
        ...
        string IPersistableModel<ManagedClusterLoadBalancerProfileOutboundIPPrefixes>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
