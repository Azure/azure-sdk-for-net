...
namespace Azure.ResourceManager.ContainerService.Models
{
    ...
    public partial class RunCommandResult
    {
        ...
        internal RunCommandResult(string id, string provisioningState, int? exitCode, DateTimeOffset? startedOn, DateTimeOffset? finishedOn, string logs, string reason)
        {
            Id = id;
