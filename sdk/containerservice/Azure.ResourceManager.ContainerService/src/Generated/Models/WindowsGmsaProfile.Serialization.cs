...
{
    public partial class WindowsGmsaProfile : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static WindowsGmsaProfile DeserializeWindowsGmsaProfile(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
