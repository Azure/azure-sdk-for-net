...
namespace Azure.ResourceManager.ContainerService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ManagedClusterSecurityProfileImageCleaner>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ManagedClusterSecurityProfileImageCleaner>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ManagedClusterSecurityProfileImageCleaner>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ManagedClusterSecurityProfileImageCleaner>)} interface");
            }
        ...
        string IPersistableModel<ManagedClusterSecurityProfileImageCleaner>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
