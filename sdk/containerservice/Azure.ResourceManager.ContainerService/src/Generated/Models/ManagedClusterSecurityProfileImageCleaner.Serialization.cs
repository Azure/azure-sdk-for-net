...
{
    public partial class ManagedClusterSecurityProfileImageCleaner : IUtf8JsonSerializable, IJsonModel<ManagedClusterSecurityProfileImageCleaner>, IPersistableModel<ManagedClusterSecurityProfileImageCleaner>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(IntervalHours))
            {
                ...
                builder.AppendLine($" '{IntervalHours.Value.ToString()}'");
            }
