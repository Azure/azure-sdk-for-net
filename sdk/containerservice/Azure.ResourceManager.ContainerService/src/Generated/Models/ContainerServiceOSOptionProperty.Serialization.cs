...
{
    public partial class ContainerServiceOSOptionProperty : IUtf8JsonSerializable, IJsonModel<ContainerServiceOSOptionProperty>, IPersistableModel<ContainerServiceOSOptionProperty>
    {
        ...
        void IJsonModel<ContainerServiceOSOptionProperty>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ContainerServiceOSOptionProperty)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(EnableFipsImage))
            {
