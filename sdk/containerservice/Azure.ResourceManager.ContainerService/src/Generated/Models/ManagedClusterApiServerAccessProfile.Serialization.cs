...
{
    public partial class ManagedClusterApiServerAccessProfile : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ManagedClusterApiServerAccessProfile DeserializeManagedClusterApiServerAccessProfile(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
