...
{
    public partial class ManagedClusterWorkloadAutoScalerProfile : IUtf8JsonSerializable, IJsonModel<ManagedClusterWorkloadAutoScalerProfile>, IPersistableModel<ManagedClusterWorkloadAutoScalerProfile>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  keda:");
                AppendChildObject(builder, Keda, options, 2);
            }

            if (Optional.IsDefined(VerticalPodAutoscaler))
            {
                builder.Append("  verticalPodAutoscaler:");
                AppendChildObject(builder, VerticalPodAutoscaler, options, 2);
            }
