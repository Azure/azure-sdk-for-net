...
namespace Azure.ResourceManager.ContainerService.Models
{
    ...
    {
        internal static ManagedClusterCredentials DeserializeManagedClusterCredentials(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
