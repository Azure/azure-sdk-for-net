...
{
    public partial class ManagedClusterAgentPoolProfileProperties : IUtf8JsonSerializable, IModelJsonSerializable<ManagedClusterAgentPoolProfileProperties>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IModelJsonSerializable<ManagedClusterAgentPoolProfileProperties>)this).Serialize(writer, ModelSerializerOptions.DefaultWireOptions);

        void IModelJsonSerializable<ManagedClusterAgentPoolProfileProperties>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<ManagedClusterAgentPoolProfileProperties>(this, options.Format);
        ...
        internal static ManagedClusterAgentPoolProfileProperties DeserializeManagedClusterAgentPoolProfileProperties(JsonElement element, ModelSerializerOptions options = default)
        {
        ...
        ManagedClusterAgentPoolProfileProperties IModelSerializable<ManagedClusterAgentPoolProfileProperties>.Deserialize(BinaryData data, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<ManagedClusterAgentPoolProfileProperties>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="ManagedClusterAgentPoolProfileProperties"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="ManagedClusterAgentPoolProfileProperties"/> to convert. </param>
        public static implicit operator RequestContent(ManagedClusterAgentPoolProfileProperties model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="ManagedClusterAgentPoolProfileProperties"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator ManagedClusterAgentPoolProfileProperties(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeManagedClusterAgentPoolProfileProperties(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
