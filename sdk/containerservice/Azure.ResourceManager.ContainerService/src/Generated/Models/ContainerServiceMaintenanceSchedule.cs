...
namespace Azure.ResourceManager.ContainerService.Models
{
    ...
    public partial class ContainerServiceMaintenanceSchedule
    {
        ...
        internal ContainerServiceMaintenanceSchedule(DailySchedule daily, ContainerServiceMaintenanceWeeklySchedule weekly, ContainerServiceMaintenanceAbsoluteMonthlySchedule absoluteMonthly, ContainerServiceMaintenanceRelativeMonthlySchedule relativeMonthly, Dictionary<string, BinaryData> rawData)
        {
            Daily = daily;
            Weekly = weekly;
