...
{
    public partial class ContainerServiceSshConfiguration : IUtf8JsonSerializable, IJsonModel<ContainerServiceSshConfiguration>, IPersistableModel<ContainerServiceSshConfiguration>
    {
        ...
        void IJsonModel<ContainerServiceSshConfiguration>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ContainerServiceSshConfiguration)} does not support '{format}' format.");
            }
