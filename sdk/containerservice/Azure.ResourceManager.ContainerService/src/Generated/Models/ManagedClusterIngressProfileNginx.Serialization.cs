...
namespace Azure.ResourceManager.ContainerService.Models
{
    internal partial class ManagedClusterIngressProfileNginx : IUtf8JsonSerializable, IJsonModel<ManagedClusterIngressProfileNginx>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(DefaultIngressControllerType), out propertyOverride);
            ...
            else
            {
                ...
                {
                    builder.Append("  defaultIngressControllerType: ");
                    builder.AppendLine($"'{DefaultIngressControllerType.Value.ToString()}'");
                }
            }
