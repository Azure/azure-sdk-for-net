...
{
    public partial class ManagedClusterPodIdentityException : IUtf8JsonSerializable, IJsonModel<ManagedClusterPodIdentityException>, IPersistableModel<ManagedClusterPodIdentityException>
    {
        ...
        void IJsonModel<ManagedClusterPodIdentityException>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ManagedClusterPodIdentityException)} does not support '{format}' format.");
            }
