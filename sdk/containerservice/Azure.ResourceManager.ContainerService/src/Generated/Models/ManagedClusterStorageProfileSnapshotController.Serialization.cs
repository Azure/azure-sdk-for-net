...
namespace Azure.ResourceManager.ContainerService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ManagedClusterStorageProfileSnapshotController>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<ManagedClusterStorageProfileSnapshotController>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ManagedClusterStorageProfileSnapshotController>)} interface");
            }
        ...
        string IPersistableModel<ManagedClusterStorageProfileSnapshotController>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
