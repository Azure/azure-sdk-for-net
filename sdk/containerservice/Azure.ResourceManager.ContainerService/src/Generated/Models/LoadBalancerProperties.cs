...
namespace Azure.ResourceManager.ContainerService.Models
{
    ...
    internal partial class LoadBalancerProperties
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="LoadBalancerProperties"/>. </summary>
        ...
        public LoadBalancerProperties(string primaryAgentPoolName)
        {
        ...
        internal LoadBalancerProperties(string primaryAgentPoolName, bool? allowServicePlacement, LabelSelector serviceLabelSelector, LabelSelector serviceNamespaceSelector, LabelSelector nodeSelector, string provisioningState, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            PrimaryAgentPoolName = primaryAgentPoolName;
