...
namespace Azure.ResourceManager.ContainerService.Models
{
    ...
    public partial class ContainerServicePrivateLinkServiceConnectionState
    {
        ...
        internal ContainerServicePrivateLinkServiceConnectionState(ContainerServicePrivateLinkServiceConnectionStatus? status, string description, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Status = status;
