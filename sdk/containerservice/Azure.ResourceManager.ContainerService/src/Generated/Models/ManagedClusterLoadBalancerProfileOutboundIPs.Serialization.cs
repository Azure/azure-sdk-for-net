...
namespace Azure.ResourceManager.ContainerService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ManagedClusterLoadBalancerProfileOutboundIPs>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<ManagedClusterLoadBalancerProfileOutboundIPs>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ManagedClusterLoadBalancerProfileOutboundIPs>)} interface");
            }
        ...
        string IPersistableModel<ManagedClusterLoadBalancerProfileOutboundIPs>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
