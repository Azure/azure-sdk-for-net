...
namespace Azure.ResourceManager.ContainerService.Models
{
    ...
    public partial class ContainerServiceOutboundEnvironmentEndpoint
    {
        ...
        internal ContainerServiceOutboundEnvironmentEndpoint(string category, IReadOnlyList<ContainerServiceEndpointDependency> endpoints, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Category = category;
            Endpoints = endpoints;
