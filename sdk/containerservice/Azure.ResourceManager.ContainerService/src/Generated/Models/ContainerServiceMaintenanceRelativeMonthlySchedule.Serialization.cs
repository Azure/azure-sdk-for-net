...
{
    public partial class ContainerServiceMaintenanceRelativeMonthlySchedule : IUtf8JsonSerializable, IJsonModel<ContainerServiceMaintenanceRelativeMonthlySchedule>, IPersistableModel<ContainerServiceMaintenanceRelativeMonthlySchedule>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContainerServiceMaintenanceRelativeMonthlySchedule>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ContainerServiceMaintenanceRelativeMonthlySchedule>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ContainerServiceMaintenanceRelativeMonthlySchedule)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(IntervalMonths))
            {
                builder.Append("  intervalMonths:");
                builder.AppendLine($" '{IntervalMonths.ToString()}'");
            }

            if (Optional.IsDefined(WeekIndex))
            {
