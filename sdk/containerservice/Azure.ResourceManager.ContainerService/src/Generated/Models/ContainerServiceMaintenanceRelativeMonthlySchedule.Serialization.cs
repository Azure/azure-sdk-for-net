...
namespace Azure.ResourceManager.ContainerService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContainerServiceMaintenanceRelativeMonthlySchedule>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        ContainerServiceMaintenanceRelativeMonthlySchedule IJsonModel<ContainerServiceMaintenanceRelativeMonthlySchedule>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<ContainerServiceMaintenanceRelativeMonthlySchedule>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ContainerServiceMaintenanceRelativeMonthlySchedule IModel<ContainerServiceMaintenanceRelativeMonthlySchedule>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<ContainerServiceMaintenanceRelativeMonthlySchedule>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
