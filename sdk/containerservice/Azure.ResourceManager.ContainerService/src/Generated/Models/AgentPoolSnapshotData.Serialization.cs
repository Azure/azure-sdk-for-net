...
namespace Azure.ResourceManager.ContainerService
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AgentPoolSnapshotData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AgentPoolSnapshotData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AgentPoolSnapshotData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AgentPoolSnapshotData>)} interface");
            }
        ...
        string IPersistableModel<AgentPoolSnapshotData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
