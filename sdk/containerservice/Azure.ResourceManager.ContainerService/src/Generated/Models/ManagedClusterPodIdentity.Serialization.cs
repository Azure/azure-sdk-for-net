...
{
    public partial class ManagedClusterPodIdentity : IUtf8JsonSerializable, IJsonModel<ManagedClusterPodIdentity>, IPersistableModel<ManagedClusterPodIdentity>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ProvisioningInfo))
            {
                ...
                AppendChildObject(builder, ProvisioningInfo, options, 2);
            }
