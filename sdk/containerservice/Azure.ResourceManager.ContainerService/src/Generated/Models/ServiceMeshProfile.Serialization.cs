...
{
    public partial class ServiceMeshProfile : IUtf8JsonSerializable, IJsonModel<ServiceMeshProfile>, IPersistableModel<ServiceMeshProfile>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Istio))
            {
                ...
                AppendChildObject(builder, Istio, options, 2);
            }
