...
{
    internal partial class ContainerServiceMaintenanceConfigurationListResult : IUtf8JsonSerializable, IJsonModel<ContainerServiceMaintenanceConfigurationListResult>, IPersistableModel<ContainerServiceMaintenanceConfigurationListResult>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContainerServiceMaintenanceConfigurationListResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ContainerServiceMaintenanceConfigurationListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ContainerServiceMaintenanceConfigurationListResult)} does not support '{format}' format.");
            }
