...
namespace Azure.ResourceManager.ContainerService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContainerServiceDateSpan>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ContainerServiceDateSpan>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ContainerServiceDateSpan>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ContainerServiceDateSpan>)} interface");
            }
        ...
        string IPersistableModel<ContainerServiceDateSpan>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
