...
namespace Azure.ResourceManager.ContainerService.Models
{
    ...
    {
        /// <summary> Initializes a new instance of AzureKeyVaultKms. </summary>
        public AzureKeyVaultKms()
        {
        }

        /// <summary> Initializes a new instance of AzureKeyVaultKms. </summary>
        /// <param name="enabled"> Whether to enable Azure Key Vault key management service. The default is false. </param>
        ...
        internal AzureKeyVaultKms(bool? enabled, string keyId, KeyVaultNetworkAccessType? keyVaultNetworkAccess, ResourceIdentifier keyVaultResourceId)
        {
            Enabled = enabled;
            KeyId = keyId;
        ...
        public KeyVaultNetworkAccessType? KeyVaultNetworkAccess { get; set; }
