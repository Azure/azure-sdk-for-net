...
{
    public partial class ManagedClusterUpgradeProfileData : IUtf8JsonSerializable, IJsonModel<ManagedClusterUpgradeProfileData>, IPersistableModel<ManagedClusterUpgradeProfileData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ControlPlaneProfile))
            {
                ...
                AppendChildObject(builder, ControlPlaneProfile, options, 2);
            }
