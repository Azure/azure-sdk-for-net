...
namespace Azure.ResourceManager.ContainerService.Models
{
    ...
    public partial class ContainerServicePrivateLinkResourceData
    {
        ...
        internal ContainerServicePrivateLinkResourceData(string id, string name, string @type, string groupId, IList<string> requiredMembers, ResourceIdentifier privateLinkServiceID, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Id = id;
            Name = name;
            Type = @type;
