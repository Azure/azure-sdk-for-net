...
namespace Azure.ResourceManager.ContainerService.Models
{
    ...
    public partial class ContainerServicePrivateLinkResourceData
    {
        ...
        internal ContainerServicePrivateLinkResourceData(ResourceIdentifier id, string name, ResourceType? resourceType, string groupId, IList<string> requiredMembers, ResourceIdentifier privateLinkServiceId, Dictionary<string, BinaryData> rawData)
        {
            Id = id;
            Name = name;
