...
namespace Azure.ResourceManager.ContainerService.Models
{
    ...
    public partial class ManagedClusterRunCommandResult
    {
        ...
        internal ManagedClusterRunCommandResult(string id, string provisioningState, int? exitCode, DateTimeOffset? startedOn, DateTimeOffset? finishedOn, string logs, string reason, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
