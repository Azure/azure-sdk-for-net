...
{
    public partial class LinuxOSConfig : IUtf8JsonSerializable, IJsonModel<LinuxOSConfig>, IPersistableModel<LinuxOSConfig>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Sysctls))
            {
                ...
                AppendChildObject(builder, Sysctls, options, 2);
            }
            ...
            if (Optional.IsDefined(SwapFileSizeInMB))
            {
                ...
                builder.AppendLine($" '{SwapFileSizeInMB.Value.ToString()}'");
            }
