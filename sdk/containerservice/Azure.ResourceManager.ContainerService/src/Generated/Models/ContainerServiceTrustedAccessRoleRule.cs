...
namespace Azure.ResourceManager.ContainerService.Models
{
    ...
    public partial class ContainerServiceTrustedAccessRoleRule
    {
        ...
        internal ContainerServiceTrustedAccessRoleRule(IReadOnlyList<string> verbs, IReadOnlyList<string> apiGroups, IReadOnlyList<string> resources, IReadOnlyList<string> resourceNames, IReadOnlyList<string> nonResourceUrls, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Verbs = verbs;
            ApiGroups = apiGroups;
            Resources = resources;
