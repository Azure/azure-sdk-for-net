...
namespace Azure.ResourceManager.ContainerService.Models
{
    ...
    public partial class KubeReserved
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="KubeReserved"/>. </summary>
        public KubeReserved()
        {
        }
        ...
        internal KubeReserved(int? cpuMillicores, int? memoryMB, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
