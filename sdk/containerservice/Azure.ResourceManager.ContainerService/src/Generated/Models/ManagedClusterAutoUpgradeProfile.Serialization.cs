...
{
    public partial class ManagedClusterAutoUpgradeProfile : IUtf8JsonSerializable, IJsonModel<ManagedClusterAutoUpgradeProfile>, IPersistableModel<ManagedClusterAutoUpgradeProfile>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(UpgradeChannel))
            {
                ...
                builder.AppendLine($" '{UpgradeChannel.ToString()}'");
            }

            if (Optional.IsDefined(NodeOSUpgradeChannel))
            {
                builder.Append("  nodeOSUpgradeChannel:");
                builder.AppendLine($" '{NodeOSUpgradeChannel.ToString()}'");
            }
