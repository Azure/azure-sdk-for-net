...
namespace Azure.ResourceManager.ContainerService
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContainerServiceTrustedAccessRoleBindingData>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<ContainerServiceTrustedAccessRoleBindingData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ContainerServiceTrustedAccessRoleBindingData>)} interface");
            }
        ...
        string IPersistableModel<ContainerServiceTrustedAccessRoleBindingData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
