...
namespace Azure.ResourceManager.ContainerService.Models
{
    public partial class ContainerServiceEndpointDependency : IUtf8JsonSerializable, IModelJsonSerializable<ContainerServiceEndpointDependency>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<ContainerServiceEndpointDependency>(this, options.Format);
            ...
            if (Optional.IsCollectionDefined(EndpointDetails))
            {
                ...
                foreach (var item in EndpointDetails)
                {
                    ...
                    {
                        ((IModelJsonSerializable<ContainerServiceEndpointDetail>)item).Serialize(writer, options);
                    }
                }
        ...
        /// <summary> Converts a <see cref="ContainerServiceEndpointDependency"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="ContainerServiceEndpointDependency"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="ContainerServiceEndpointDependency"/>. </summary>
