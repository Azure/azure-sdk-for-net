...
namespace Azure.ResourceManager.ContainerService.Models
{
    ...
    public partial class AgentPoolNetworkPortRange
    {
        ...
        internal AgentPoolNetworkPortRange(int? portStart, int? portEnd, AgentPoolNetworkPortProtocol? protocol, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            PortStart = portStart;
            PortEnd = portEnd;
            Protocol = protocol;
