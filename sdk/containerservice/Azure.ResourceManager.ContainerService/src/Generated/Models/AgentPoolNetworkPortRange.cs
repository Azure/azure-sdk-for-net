...
namespace Azure.ResourceManager.ContainerService.Models
{
    ...
    public partial class AgentPoolNetworkPortRange
    {
        ...
        internal AgentPoolNetworkPortRange(int? portStart, int? portEnd, AgentPoolNetworkPortProtocol? protocol, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            PortStart = portStart;
            PortEnd = portEnd;
            Protocol = protocol;
