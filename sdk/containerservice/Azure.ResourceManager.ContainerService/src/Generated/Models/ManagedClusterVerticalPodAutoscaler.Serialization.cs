...
{
    public partial class ManagedClusterVerticalPodAutoscaler : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ManagedClusterVerticalPodAutoscaler DeserializeManagedClusterVerticalPodAutoscaler(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
