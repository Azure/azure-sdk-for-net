...
namespace Azure.ResourceManager.ContainerService
{
    ...
    public partial class GuardrailsAvailableVersionResource : ArmResource
    {
        ...
        internal GuardrailsAvailableVersionResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _managedClustersRestClient = new ManagedClusters(_managedClustersClientDiagnostics, Pipeline, Endpoint, guardrailsAvailableVersionApiVersion ?? "2025-10-02-preview");
        ...
        {
            using DiagnosticScope scope = _managedClustersClientDiagnostics.CreateScope("GuardrailsAvailableVersionResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _managedClustersRestClient.CreateGetGuardrailsVersionsRequest(Guid.Parse(Id.SubscriptionId), Id.Parent.Name, Id.Name, context);
