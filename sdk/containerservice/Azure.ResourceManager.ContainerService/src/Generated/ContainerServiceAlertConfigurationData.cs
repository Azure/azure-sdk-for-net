...
namespace Azure.ResourceManager.ContainerService
{
    ...
    /// </summary>
    public partial class ContainerServiceAlertConfigurationData : ResourceData
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="ContainerServiceAlertConfigurationData"/>. </summary>
        public ContainerServiceAlertConfigurationData()
        {
        }
