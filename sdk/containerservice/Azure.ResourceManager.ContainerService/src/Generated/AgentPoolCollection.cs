...
namespace Azure.ResourceManager.ContainerService
{
    ...
    /// Each <see cref="AgentPoolResource" /> in the collection will belong to the same instance of <see cref="ManagedClusterResource" />.
    /// To get an <see cref="AgentPoolCollection" /> instance call the GetAgentPools method from an instance of <see cref="ManagedClusterResource" />.
    /// </summary>
    public partial class AgentPoolCollection : ArmCollection, IEnumerable<AgentPoolResource>, IAsyncEnumerable<AgentPoolResource>
    {
        ...
        {
            _agentPoolClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.ContainerService", AgentPoolResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual AsyncPageable<AgentPoolResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _agentPoolClientDiagnostics.CreateScope("AgentPoolCollection.GetAll");
                scope.Start();
                try
                {
                    var response = await _agentPoolRestClient.ListAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new AgentPoolResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
                    scope.Failed(e);
            ...
            async Task<Page<AgentPoolResource>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                using var scope = _agentPoolClientDiagnostics.CreateScope("AgentPoolCollection.GetAll");
                scope.Start();
                try
                {
                    var response = await _agentPoolRestClient.ListNextPageAsync(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new AgentPoolResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual Pageable<AgentPoolResource> GetAll(CancellationToken cancellationToken = default)
        {
            Page<AgentPoolResource> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _agentPoolRestClient.List(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new AgentPoolResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            Page<AgentPoolResource> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                using var scope = _agentPoolClientDiagnostics.CreateScope("AgentPoolCollection.GetAll");
                scope.Start();
                try
                {
                    var response = _agentPoolRestClient.ListNextPage(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new AgentPoolResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
