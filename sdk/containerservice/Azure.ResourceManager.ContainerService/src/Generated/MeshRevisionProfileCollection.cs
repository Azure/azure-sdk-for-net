...
namespace Azure.ResourceManager.ContainerService
{
    ...
    public partial class MeshRevisionProfileCollection : ArmCollection, IEnumerable<MeshRevisionProfileResource>, IAsyncEnumerable<MeshRevisionProfileResource>
    {
        ...
        internal MeshRevisionProfileCollection(ArmClient client, ResourceIdentifier id, AzureLocation location) : base(client, id)
        {
            ...
            _location = location;
            _managedClustersClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.ContainerService", MeshRevisionProfileResource.ResourceType.Namespace, Diagnostics);
            _managedClustersRestClient = new ManagedClusters(_managedClustersClientDiagnostics, Pipeline, Endpoint, meshRevisionProfileApiVersion ?? "2025-10-02-preview");
        ...
        public virtual async Task<Response<MeshRevisionProfileResource>> GetAsync(string mode, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _managedClustersClientDiagnostics.CreateScope("MeshRevisionProfileCollection.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _managedClustersRestClient.CreateGetMeshRevisionProfileRequest(Guid.Parse(Id.SubscriptionId), _location, mode, context);
        ...
        public virtual AsyncPageable<MeshRevisionProfileResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<MeshRevisionProfileData, MeshRevisionProfileResource>(new ManagedClustersGetMeshRevisionProfilesAsyncCollectionResultOfT(_managedClustersRestClient, Guid.Parse(Id.SubscriptionId), _location, context), data => new MeshRevisionProfileResource(Client, data));
        }
        ...
        public virtual Pageable<MeshRevisionProfileResource> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            return new PageableWrapper<MeshRevisionProfileData, MeshRevisionProfileResource>(new ManagedClustersGetMeshRevisionProfilesCollectionResultOfT(_managedClustersRestClient, Guid.Parse(Id.SubscriptionId), _location, context), data => new MeshRevisionProfileResource(Client, data));
        }
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string mode, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _managedClustersClientDiagnostics.CreateScope("MeshRevisionProfileCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual async Task<NullableResponse<MeshRevisionProfileResource>> GetIfExistsAsync(string mode, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _managedClustersClientDiagnostics.CreateScope("MeshRevisionProfileCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
