...
namespace Azure.ResourceManager.ContainerService
{
    ...
    public partial class MeshUpgradeProfileCollection : ArmCollection, IEnumerable<MeshUpgradeProfileResource>, IAsyncEnumerable<MeshUpgradeProfileResource>
    {
        ...
        internal MeshUpgradeProfileCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _managedClustersClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.ContainerService", MeshUpgradeProfileResource.ResourceType.Namespace, Diagnostics);
            _managedClustersRestClient = new ManagedClusters(_managedClustersClientDiagnostics, Pipeline, Endpoint, meshUpgradeProfileApiVersion ?? "2025-10-02-preview");
        ...
        public virtual async Task<Response<MeshUpgradeProfileResource>> GetAsync(string mode, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _managedClustersClientDiagnostics.CreateScope("MeshUpgradeProfileCollection.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _managedClustersRestClient.CreateGetMeshUpgradeProfileRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, mode, context);
        ...
        public virtual AsyncPageable<MeshUpgradeProfileResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<MeshUpgradeProfileData, MeshUpgradeProfileResource>(new ManagedClustersGetMeshUpgradeProfilesAsyncCollectionResultOfT(_managedClustersRestClient, Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context), data => new MeshUpgradeProfileResource(Client, data));
        }
        ...
        public virtual Pageable<MeshUpgradeProfileResource> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            return new PageableWrapper<MeshUpgradeProfileData, MeshUpgradeProfileResource>(new ManagedClustersGetMeshUpgradeProfilesCollectionResultOfT(_managedClustersRestClient, Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context), data => new MeshUpgradeProfileResource(Client, data));
        }
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string mode, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _managedClustersClientDiagnostics.CreateScope("MeshUpgradeProfileCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual async Task<NullableResponse<MeshUpgradeProfileResource>> GetIfExistsAsync(string mode, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _managedClustersClientDiagnostics.CreateScope("MeshUpgradeProfileCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
