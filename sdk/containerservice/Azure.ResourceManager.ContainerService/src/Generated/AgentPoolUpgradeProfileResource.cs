...
namespace Azure.ResourceManager.ContainerService
{
    ...
    public partial class AgentPoolUpgradeProfileResource : ArmResource
    {
        ...
        internal AgentPoolUpgradeProfileResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _agentPoolsRestClient = new AgentPools(_agentPoolsClientDiagnostics, Pipeline, Endpoint, agentPoolUpgradeProfileApiVersion ?? "2025-10-02-preview");
        ...
        {
            using DiagnosticScope scope = _agentPoolsClientDiagnostics.CreateScope("AgentPoolUpgradeProfileResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _agentPoolsRestClient.CreateGetUpgradeProfileRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, context);
