...
namespace Azure.ResourceManager.ContainerService.Mock
{
    ...
    public partial class AgentPoolSnapshotResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="AgentPoolSnapshotResourceExtension"/> class for mocking. </summary>
        protected AgentPoolSnapshotResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="AgentPoolSnapshotResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal AgentPoolSnapshotResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
