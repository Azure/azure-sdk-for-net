...
namespace Azure.ResourceManager.ContainerService.Mock
{
    ...
    public partial class ContainerServiceFleetResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="ContainerServiceFleetResourceExtension"/> class for mocking. </summary>
        protected ContainerServiceFleetResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ContainerServiceFleetResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ContainerServiceFleetResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<ContainerServiceFleetResource> GetContainerServiceFleetsAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new ContainerServiceFleetResource(Client, ContainerServiceFleetData.DeserializeContainerServiceFleetData(e)), ContainerServiceFleetFleetsClientDiagnostics, Pipeline, "ContainerServiceFleetResourceExtension.GetContainerServiceFleets", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<ContainerServiceFleetResource> GetContainerServiceFleets(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => ContainerServiceFleetFleetsRestClient.CreateListRequest(Id.SubscriptionId);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => ContainerServiceFleetFleetsRestClient.CreateListNextPageRequest(nextLink, Id.SubscriptionId);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new ContainerServiceFleetResource(Client, ContainerServiceFleetData.DeserializeContainerServiceFleetData(e)), ContainerServiceFleetFleetsClientDiagnostics, Pipeline, "ContainerServiceFleetResourceExtension.GetContainerServiceFleets", "value", "nextLink", cancellationToken);
        }
    }
}
