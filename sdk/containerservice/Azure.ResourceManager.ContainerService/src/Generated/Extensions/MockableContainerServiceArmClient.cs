...
namespace Azure.ResourceManager.ContainerService.Mocking
{
    ...
    public partial class MockableContainerServiceArmClient : ArmResource
    {
        ...
        /// <summary> Gets an object representing a <see cref="JWTAuthenticatorResource"/> along with the instance operations that can be performed on it but with no data. </summary>
        /// <param name="id"> The resource ID of the resource to get. </param>
        /// <returns> Returns a <see cref="JWTAuthenticatorResource"/> object. </returns>
        public virtual JWTAuthenticatorResource GetJWTAuthenticatorResource(ResourceIdentifier id)
        {
            JWTAuthenticatorResource.ValidateResourceId(id);
            return new JWTAuthenticatorResource(Client, id);
        }
