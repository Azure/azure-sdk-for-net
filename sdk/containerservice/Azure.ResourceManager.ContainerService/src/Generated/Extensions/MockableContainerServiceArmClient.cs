...
namespace Azure.ResourceManager.ContainerService.Mocking
{
    ...
    public partial class MockableContainerServiceArmClient : ArmResource
    {
        ...
        /// <summary> Gets an object representing a <see cref="ManagedClusterLoadBalancerDataResource"/> along with the instance operations that can be performed on it but with no data. </summary>
        /// <param name="id"> The resource ID of the resource to get. </param>
        /// <returns> Returns a <see cref="ManagedClusterLoadBalancerDataResource"/> object. </returns>
        public virtual ManagedClusterLoadBalancerDataResource GetManagedClusterLoadBalancerDataResource(ResourceIdentifier id)
        {
            ManagedClusterLoadBalancerDataResource.ValidateResourceId(id);
        ...
        /// <summary> Gets an object representing a <see cref="MeshMembershipResource"/> along with the instance operations that can be performed on it but with no data. </summary>
        /// <param name="id"> The resource ID of the resource to get. </param>
        /// <returns> Returns a <see cref="MeshMembershipResource"/> object. </returns>
        public virtual MeshMembershipResource GetMeshMembershipResource(ResourceIdentifier id)
        {
            MeshMembershipResource.ValidateResourceId(id);
            return new MeshMembershipResource(Client, id);
        }
    }
}
