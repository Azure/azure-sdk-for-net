...
namespace Azure.ResourceManager.ContainerService.Mock
{
    ...
    public partial class ManagedClusterSnapshotResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="ManagedClusterSnapshotResourceExtension"/> class for mocking. </summary>
        protected ManagedClusterSnapshotResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ManagedClusterSnapshotResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ManagedClusterSnapshotResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
