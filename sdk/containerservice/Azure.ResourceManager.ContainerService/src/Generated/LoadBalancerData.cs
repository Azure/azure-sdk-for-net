...
namespace Azure.ResourceManager.ContainerService
{
    ...
    public partial class LoadBalancerData : ResourceData
    {
        ...
        internal LoadBalancerData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, LoadBalancerProperties properties) : base(id, name, resourceType, systemData)
        {
        ...
        [WirePath("properties")]
        internal LoadBalancerProperties Properties { get; set; }
