...
namespace Azure.ResourceManager.ContainerService
{
    ...
    public partial class ManagedClusterUpgradeProfileResource : ArmResource
    {
        ...
        internal ManagedClusterUpgradeProfileResource(ArmClient client, ManagedClusterUpgradeProfileData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<ManagedClusterUpgradeProfileResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new ManagedClusterUpgradeProfileResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
