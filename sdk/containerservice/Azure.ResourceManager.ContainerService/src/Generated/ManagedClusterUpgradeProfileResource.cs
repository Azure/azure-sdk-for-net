...
namespace Azure.ResourceManager.ContainerService
{
    ...
    public partial class ManagedClusterUpgradeProfileResource : ArmResource
    {
        ...
        internal ManagedClusterUpgradeProfileResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _managedClustersRestClient = new ManagedClusters(_managedClustersClientDiagnostics, Pipeline, Endpoint, managedClusterUpgradeProfileApiVersion ?? "2025-10-02-preview");
        ...
        {
            using DiagnosticScope scope = _managedClustersClientDiagnostics.CreateScope("ManagedClusterUpgradeProfileResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _managedClustersRestClient.CreateGetUpgradeProfileRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, context);
