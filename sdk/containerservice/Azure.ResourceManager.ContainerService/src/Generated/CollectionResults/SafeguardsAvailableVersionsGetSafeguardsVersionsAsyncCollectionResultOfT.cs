...
{
    internal partial class SafeguardsAvailableVersionsGetSafeguardsVersionsAsyncCollectionResultOfT : AsyncPageable<SafeguardsAvailableVersionData>
    {
        ...
        public SafeguardsAvailableVersionsGetSafeguardsVersionsAsyncCollectionResultOfT(SafeguardsAvailableVersions client, Guid subscriptionId, AzureLocation location, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        public override async IAsyncEnumerable<Page<SafeguardsAvailableVersionData>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                yield return Page<SafeguardsAvailableVersionData>.FromValues((IReadOnlyList<SafeguardsAvailableVersionData>)result.Value, nextPage?.AbsoluteUri, response);
        ...
        private async ValueTask<Response> GetNextResponseAsync(int? pageSizeHint, Uri nextLink)
        {
            ...
            using DiagnosticScope scope = _client.ClientDiagnostics.CreateScope("SafeguardsAvailableVersionCollection.GetAll");
            scope.Start();
            try
            {
