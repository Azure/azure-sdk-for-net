...
namespace Azure.ResourceManager.ContainerService
{
    internal partial class LoadBalancersGetByManagedClusterCollectionResultOfT : Pageable<ManagedClusterLoadBalancerData>
    {
        ...
        public LoadBalancersGetByManagedClusterCollectionResultOfT(LoadBalancers client, Guid subscriptionId, string resourceGroupName, string resourceName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
