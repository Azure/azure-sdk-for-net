...
namespace Azure.ResourceManager.ContainerService
{
    internal partial class ManagedClusterSnapshotsGetByResourceGroupAsyncCollectionResultOfT : AsyncPageable<ManagedClusterSnapshotData>
    {
        ...
        public ManagedClusterSnapshotsGetByResourceGroupAsyncCollectionResultOfT(ManagedClusterSnapshots client, Guid subscriptionId, string resourceGroupName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
