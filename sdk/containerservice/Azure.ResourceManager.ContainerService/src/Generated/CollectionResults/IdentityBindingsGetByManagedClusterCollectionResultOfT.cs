...
namespace Azure.ResourceManager.ContainerService
{
    internal partial class IdentityBindingsGetByManagedClusterCollectionResultOfT : Pageable<ManagedClusterIdentityBindingData>
    {
        ...
        /// <summary> Initializes a new instance of IdentityBindingsGetByManagedClusterCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public IdentityBindingsGetByManagedClusterCollectionResultOfT(IdentityBindings client, Guid subscriptionId, string resourceGroupName, string resourceName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of IdentityBindingsGetByManagedClusterCollectionResultOfT as an enumerable collection. </summary>
