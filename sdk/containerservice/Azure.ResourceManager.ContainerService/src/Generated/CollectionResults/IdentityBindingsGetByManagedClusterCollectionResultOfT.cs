...
namespace Azure.ResourceManager.ContainerService
{
    internal partial class IdentityBindingsGetByManagedClusterCollectionResultOfT : Pageable<ManagedClusterIdentityBindingData>
    {
        ...
        public IdentityBindingsGetByManagedClusterCollectionResultOfT(IdentityBindings client, Guid subscriptionId, string resourceGroupName, string resourceName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
