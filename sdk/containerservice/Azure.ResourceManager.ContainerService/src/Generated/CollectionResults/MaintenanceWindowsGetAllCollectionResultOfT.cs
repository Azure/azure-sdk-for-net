...
namespace Azure.ResourceManager.ContainerService
{
    internal partial class MaintenanceWindowsGetAllCollectionResultOfT : Pageable<MaintenanceWindowData>
    {
        ...
        /// <summary> Initializes a new instance of MaintenanceWindowsGetAllCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public MaintenanceWindowsGetAllCollectionResultOfT(MaintenanceWindows client, Guid subscriptionId, string resourceGroupName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of MaintenanceWindowsGetAllCollectionResultOfT as an enumerable collection. </summary>
