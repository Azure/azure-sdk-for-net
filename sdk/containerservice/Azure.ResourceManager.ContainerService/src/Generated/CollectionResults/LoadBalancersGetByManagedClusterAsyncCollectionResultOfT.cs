...
{
    internal partial class LoadBalancersGetByManagedClusterAsyncCollectionResultOfT : AsyncPageable<LoadBalancerData>
    {
        ...
        public LoadBalancersGetByManagedClusterAsyncCollectionResultOfT(LoadBalancers client, Guid subscriptionId, string resourceGroupName, string resourceName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
