...
namespace Azure.ResourceManager.ContainerService
{
    ...
    public partial class AgentPoolSnapshotData : TrackedResourceData
    {
        ...
        internal AgentPoolSnapshotData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, ContainerServiceCreationData creationData, SnapshotType? snapshotType, string kubernetesVersion, string nodeImageVersion, ContainerServiceOSType? osType, ContainerServiceOSSku? osSku, string vmSize, bool? enableFips, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData, tags, location)
        {
