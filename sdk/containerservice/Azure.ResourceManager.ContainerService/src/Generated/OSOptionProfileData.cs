...
namespace Azure.ResourceManager.ContainerService
{
    ...
    public partial class OSOptionProfileData : ResourceData
    {
        ...
        internal OSOptionProfileData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IReadOnlyList<ContainerServiceOSOptionProperty> osOptionPropertyList, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
