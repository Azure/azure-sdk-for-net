    ...
    public partial class ContainerServiceManagedClusterResource : ArmResource
    {
        ...
        public virtual async Task<Response<ContainerServicePrivateLinkResourceData>> ResolvePrivateLinkServiceIdAsync(ContainerServicePrivateLinkResourceData containerServicePrivateLinkResourceData, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _managedClustersRestClient.CreateResolvePrivateLinkServiceIdRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, ContainerServicePrivateLinkResourceData.ToRequestContent(containerServicePrivateLinkResourceData), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<ContainerServicePrivateLinkResourcesListResult>> GetAllAsync(CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _managedClustersClientDiagnostics.CreateScope("ContainerServiceManagedClusterResource.GetAll");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _managedClustersRestClient.CreateGetAllRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<ContainerServicePrivateLinkResourcesListResult> GetAll(CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _managedClustersClientDiagnostics.CreateScope("ContainerServiceManagedClusterResource.GetAll");
            scope.Start();
            try
        ...
        /// <summary> Gets a collection of ManagedClusterLoadBalancerData in the <see cref="ContainerServiceManagedClusterResource"/>. </summary>
        /// <returns> An object representing collection of ManagedClusterLoadBalancerData and their operations over a ManagedClusterLoadBalancerDataResource. </returns>
        public virtual ManagedClusterLoadBalancerDataCollection GetAllManagedClusterLoadBalancerData()
        {
            return GetCachedClient(client => new ManagedClusterLoadBalancerDataCollection(client, Id));
        }
        ...
        [ForwardsClientCalls]
        public virtual async Task<Response<ManagedClusterLoadBalancerDataResource>> GetManagedClusterLoadBalancerDataAsync(string loadBalancerName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(loadBalancerName, nameof(loadBalancerName));

            return await GetAllManagedClusterLoadBalancerData().GetAsync(loadBalancerName, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <exception cref="ArgumentException"> <paramref name="loadBalancerName"/> is an empty string, and was expected to be non-empty. </exception>
        [ForwardsClientCalls]
        public virtual Response<ManagedClusterLoadBalancerDataResource> GetManagedClusterLoadBalancerData(string loadBalancerName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(loadBalancerName, nameof(loadBalancerName));
