...
namespace Azure.ResourceManager.ContainerService
{
    ...
    public partial class ContainerServiceManagedClusterResource : ArmResource
    {
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<AgentPoolAvailableVersion>> GetAvailableAgentPoolVersionsAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<AgentPoolAvailableVersion> response = Response.FromValue(AgentPoolAvailableVersion.FromResponse(result), result);
                if (response.Value == null)
                {
                    throw new RequestFailedException(response.GetRawResponse());
                }
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<AgentPoolAvailableVersion> GetAvailableAgentPoolVersions(CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _managedClustersClientDiagnostics.CreateScope("ContainerServiceManagedClusterResource.GetAvailableAgentPoolVersions");
            scope.Start();
            try
