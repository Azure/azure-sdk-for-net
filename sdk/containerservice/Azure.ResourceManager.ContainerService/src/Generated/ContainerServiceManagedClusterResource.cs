...
namespace Azure.ResourceManager.ContainerService
{
    ...
    public partial class ContainerServiceManagedClusterResource : ArmResource
    {
        ...
        internal ContainerServiceManagedClusterResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _operationStatusResultClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.ContainerService", ResourceType.Namespace, Diagnostics);
            ...
            _resolvePrivateLinkServiceIdClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.ContainerService", ResourceType.Namespace, Diagnostics);
            ...
            _privateLinkResourcesClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.ContainerService", ResourceType.Namespace, Diagnostics);
        ...
        {
            using DiagnosticScope scope = _agentPoolsClientDiagnostics.CreateScope("ContainerServiceManagedClusterResource.GetAvailableAgentPoolVersions");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _agentPoolsRestClient.CreateGetAvailableAgentPoolVersionsRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        /// <item>
        /// <term> Operation Id. </term>
        /// <description> ManagedClusters_OperationStatusResultList. </description>
        /// </item>
        /// <item>
        /// <term> Default Api Version. </term>
        /// <description> 2025-10-02-preview. </description>
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> A collection of <see cref="ResourceManager.Models.OperationStatusResult"/> that may take multiple service requests to iterate over. </returns>
        public virtual AsyncPageable<ResourceManager.Models.OperationStatusResult> GetOperationStatusResultListAsync(CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
            };
            return new OperationStatusResultGetOperationStatusResultListAsyncCollectionResultOfT(_operationStatusResultRestClient, Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context);
        }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> A collection of <see cref="ResourceManager.Models.OperationStatusResult"/> that may take multiple service requests to iterate over. </returns>
        public virtual Pageable<ResourceManager.Models.OperationStatusResult> GetOperationStatusResultList(CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
            };
            return new OperationStatusResultGetOperationStatusResultListCollectionResultOfT(_operationStatusResultRestClient, Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context);
        }
        ...
        /// </list>
        /// </summary>
        /// <param name="containerServicePrivateLinkResourceData"> Parameters required in order to resolve a private link service ID. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="containerServicePrivateLinkResourceData"/> is null. </exception>
        public virtual async Task<Response<ContainerServicePrivateLinkResourceData>> ResolvePrivateLinkServiceIdAsync(ContainerServicePrivateLinkResourceData containerServicePrivateLinkResourceData, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(containerServicePrivateLinkResourceData, nameof(containerServicePrivateLinkResourceData));

            using DiagnosticScope scope = _resolvePrivateLinkServiceIdClientDiagnostics.CreateScope("ContainerServiceManagedClusterResource.ResolvePrivateLinkServiceId");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _resolvePrivateLinkServiceIdRestClient.CreateResolvePrivateLinkServiceIdRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, ContainerServicePrivateLinkResourceData.ToRequestContent(containerServicePrivateLinkResourceData), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="containerServicePrivateLinkResourceData"/> is null. </exception>
        public virtual Response<ContainerServicePrivateLinkResourceData> ResolvePrivateLinkServiceId(ContainerServicePrivateLinkResourceData containerServicePrivateLinkResourceData, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(containerServicePrivateLinkResourceData, nameof(containerServicePrivateLinkResourceData));
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<PrivateLinkResourcesListResult>> GetPrivateLinkResourcesListAsync(CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _privateLinkResourcesClientDiagnostics.CreateScope("ContainerServiceManagedClusterResource.GetPrivateLinkResourcesList");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _privateLinkResourcesRestClient.CreateGetPrivateLinkResourcesListRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<PrivateLinkResourcesListResult> GetPrivateLinkResourcesList(CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _privateLinkResourcesClientDiagnostics.CreateScope("ContainerServiceManagedClusterResource.GetPrivateLinkResourcesList");
            scope.Start();
            try
        ...
        /// <summary> Gets a collection of LoadBalancers in the <see cref="ContainerServiceManagedClusterResource"/>. </summary>
        ...
        /// <summary> Gets a collection of JWTAuthenticators in the <see cref="ContainerServiceManagedClusterResource"/>. </summary>
        /// <returns> An object representing collection of JWTAuthenticators and their operations over a JWTAuthenticatorResource. </returns>
        public virtual JWTAuthenticatorCollection GetJWTAuthenticators()
        {
            return GetCachedClient(client => new JWTAuthenticatorCollection(client, Id));
        }
        ...
        [ForwardsClientCalls]
        public virtual async Task<Response<JWTAuthenticatorResource>> GetJWTAuthenticatorAsync(string jwtAuthenticatorName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(jwtAuthenticatorName, nameof(jwtAuthenticatorName));

            return await GetJWTAuthenticators().GetAsync(jwtAuthenticatorName, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <exception cref="ArgumentException"> <paramref name="jwtAuthenticatorName"/> is an empty string, and was expected to be non-empty. </exception>
        [ForwardsClientCalls]
        public virtual Response<JWTAuthenticatorResource> GetJWTAuthenticator(string jwtAuthenticatorName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(jwtAuthenticatorName, nameof(jwtAuthenticatorName));

            return GetJWTAuthenticators().Get(jwtAuthenticatorName, cancellationToken);
        }

        /// <summary> Gets a collection of MeshMemberships in the <see cref="ContainerServiceManagedClusterResource"/>. </summary>
        /// <returns> An object representing collection of MeshMemberships and their operations over a MeshMembershipResource. </returns>
        public virtual MeshMembershipCollection GetMeshMemberships()
        {
            return GetCachedClient(client => new MeshMembershipCollection(client, Id));
        }
        ...
        [ForwardsClientCalls]
        public virtual async Task<Response<MeshMembershipResource>> GetMeshMembershipAsync(string meshMembershipName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(meshMembershipName, nameof(meshMembershipName));

            return await GetMeshMemberships().GetAsync(meshMembershipName, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <exception cref="ArgumentException"> <paramref name="meshMembershipName"/> is an empty string, and was expected to be non-empty. </exception>
        [ForwardsClientCalls]
        public virtual Response<MeshMembershipResource> GetMeshMembership(string meshMembershipName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(meshMembershipName, nameof(meshMembershipName));

            return GetMeshMemberships().Get(meshMembershipName, cancellationToken);
        }
    }
}
