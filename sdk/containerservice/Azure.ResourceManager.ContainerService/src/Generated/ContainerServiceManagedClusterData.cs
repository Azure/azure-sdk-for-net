...
namespace Azure.ResourceManager.ContainerService
{
    ...
    public partial class ContainerServiceManagedClusterData : TrackedResourceData
    {
        ...
        internal ContainerServiceManagedClusterData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, IDictionary<string, string> tags, AzureLocation location, ManagedClusterProperties properties, string eTag, ManagedClusterSku sku, ExtendedLocation extendedLocation, ManagedClusterIdentity clusterIdentity, string kind) : base(id, name, resourceType, systemData, tags, location)
        {
        ...
        public bool? HostedSystemProfileEnabled
        {
            get
            {
                return Properties is null ? default : Properties.HostedSystemProfileEnabled;
            }
            set
            {
                if (Properties is null)
                ...
                Properties.HostedSystemProfileEnabled = value.Value;
            }
        }
