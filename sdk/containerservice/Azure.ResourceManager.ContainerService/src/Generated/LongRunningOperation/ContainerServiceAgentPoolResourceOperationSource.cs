...
{
    /// <summary></summary>
    internal partial class ContainerServiceAgentPoolResourceOperationSource : IOperationSource<ContainerServiceAgentPoolResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal ContainerServiceAgentPoolResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
