...
{
    /// <summary></summary>
    internal partial class ManagedClusterIdentityBindingResourceOperationSource : IOperationSource<ManagedClusterIdentityBindingResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal ManagedClusterIdentityBindingResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
