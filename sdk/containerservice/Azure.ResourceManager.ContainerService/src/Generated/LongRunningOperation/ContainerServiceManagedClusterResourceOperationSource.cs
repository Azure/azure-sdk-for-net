...
{
    /// <summary></summary>
    internal partial class ContainerServiceManagedClusterResourceOperationSource : IOperationSource<ContainerServiceManagedClusterResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal ContainerServiceManagedClusterResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
