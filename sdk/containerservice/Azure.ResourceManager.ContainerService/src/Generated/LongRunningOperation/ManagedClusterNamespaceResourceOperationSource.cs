...
{
    /// <summary></summary>
    internal partial class ManagedClusterNamespaceResourceOperationSource : IOperationSource<ManagedClusterNamespaceResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal ManagedClusterNamespaceResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
