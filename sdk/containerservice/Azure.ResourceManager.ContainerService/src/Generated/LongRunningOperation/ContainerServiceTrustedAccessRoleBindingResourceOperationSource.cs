...
{
    /// <summary></summary>
    internal partial class ContainerServiceTrustedAccessRoleBindingResourceOperationSource : IOperationSource<ContainerServiceTrustedAccessRoleBindingResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal ContainerServiceTrustedAccessRoleBindingResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
