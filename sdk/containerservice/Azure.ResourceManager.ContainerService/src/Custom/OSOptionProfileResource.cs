...
namespace Azure.ResourceManager.ContainerService
{
    ...
    public partial class OSOptionProfileResource : ArmResource
    {
        ...
        private readonly ManagedClusters _osOptionProfileManagedClustersRestClient;
        ...
        internal OSOptionProfileResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _osOptionProfileManagedClustersRestClient = new ManagedClusters(_osOptionProfileManagedClustersClientDiagnostics, Pipeline, Endpoint, osOptionProfileManagedClustersApiVersion);
#if DEBUG
