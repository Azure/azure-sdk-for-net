...
namespace Azure.ResourceManager.ContainerService
{
    ...
    public partial class OSOptionProfileData : ResourceData
    {
        ...
        internal OSOptionProfileData(ResourceIdentifier id, string name, ResourceType resourceType, Azure.ResourceManager.Models.SystemData systemData, IReadOnlyList<ContainerServiceOSOptionProperty> osOptionPropertyList, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
