...
namespace Azure.ResourceManager.ContainerService
{
    ...
    /// </summary>
    public class ContainerServiceArmOperationRehydration: ArmOperationRehydration
    {
        ...
        public override async Task<ArmOperation> RehydrateAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var operation = new ContainerServiceArmOperation(clientDiagnostics, Pipeline, Id);
