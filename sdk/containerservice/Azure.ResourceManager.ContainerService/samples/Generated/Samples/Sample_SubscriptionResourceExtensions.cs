...
namespace Azure.ResourceManager.ContainerService.Samples
{
    public partial class Sample_SubscriptionResourceExtensions
    {
        ...
        {
            // Generated from example definition: specification/containerservice/resource-manager/Microsoft.ContainerService/aks/preview/2025-01-02-preview/examples/KubernetesVersions_List.json
        ...
        {
            // Generated from example definition: specification/containerservice/resource-manager/Microsoft.ContainerService/aks/preview/2025-01-02-preview/examples/ManagedClustersList.json
        ...
        {
            // Generated from example definition: specification/containerservice/resource-manager/Microsoft.ContainerService/aks/preview/2025-01-02-preview/examples/NodeImageVersions_List.json
        ...
        {
            // Generated from example definition: specification/containerservice/resource-manager/Microsoft.ContainerService/aks/preview/2025-01-02-preview/examples/SnapshotsList.json
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task GetManagedClusterSnapshots_ListManagedClusterSnapshots()
        {
            // Generated from example definition: specification/containerservice/resource-manager/Microsoft.ContainerService/aks/preview/2025-01-02-preview/examples/ManagedClusterSnapshotsList.json
            // this example is just showing the usage of "ManagedClusterSnapshots_List" operation, for the dependent resources, they will have to be created separately.
            ...
            // invoke the operation and iterate over the result
            await foreach (ManagedClusterSnapshotResource item in subscriptionResource.GetManagedClusterSnapshotsAsync())
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                ManagedClusterSnapshotData resourceData = item.Data;
                // for demo we just print out the id
                Console.WriteLine($"Succeeded on id: {resourceData.Id}");
            }
        ...
        {
            // Generated from example definition: specification/containerservice/resource-manager/Microsoft.ContainerService/aks/preview/2025-01-02-preview/examples/TrustedAccessRoles_List.json
