...
namespace Azure.ResourceManager.ContainerService.Samples
{
    public partial class Sample_ContainerServiceManagedClusterResource
    {
        ...
        public async Task Delete_DeleteManagedCluster()
        {
            ...
            // invoke the operation
            await containerServiceManagedCluster.DeleteAsync(WaitUntil.Completed).ConfigureAwait(false);
...
["tier"] = "testing"
        ...
        public async Task ResetServicePrincipalProfile_ResetServicePrincipalProfile()
        {
            ...
            await containerServiceManagedCluster.ResetServicePrincipalProfileAsync(WaitUntil.Completed, managedClusterServicePrincipalProfile).ConfigureAwait(false);
        ...
        public async Task ResetAadProfile_ResetAADProfile()
        {
            ...
            await containerServiceManagedCluster.ResetAadProfileAsync(WaitUntil.Completed, managedClusterAadProfile).ConfigureAwait(false);
        ...
        public async Task RotateClusterCertificates_RotateClusterCertificates()
        {
            ...
            // invoke the operation
            await containerServiceManagedCluster.RotateClusterCertificatesAsync(WaitUntil.Completed).ConfigureAwait(false);
        ...
        public async Task AbortLatestOperation_AbortOperationOnManagedCluster()
        {
            ...
            // invoke the operation
            await containerServiceManagedCluster.AbortLatestOperationAsync(WaitUntil.Completed).ConfigureAwait(false);
        ...
        public async Task RotateServiceAccountSigningKeys_RotateClusterServiceAccountSigningKeys()
        {
            ...
            // invoke the operation
            await containerServiceManagedCluster.RotateServiceAccountSigningKeysAsync(WaitUntil.Completed).ConfigureAwait(false);
        ...
        public async Task Stop_StopManagedCluster()
        {
            ...
            // invoke the operation
            await containerServiceManagedCluster.StopAsync(WaitUntil.Completed).ConfigureAwait(false);
        ...
        public async Task Start_StartManagedCluster()
        {
            ...
            // invoke the operation
            await containerServiceManagedCluster.StartAsync(WaitUntil.Completed).ConfigureAwait(false);
