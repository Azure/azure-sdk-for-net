...
["tier"] = "production"
        ...
        public async Task CreateOrUpdate_CreateUpdateManagedCluster()
        {
            ...
            ContainerServiceManagedClusterData data = new ContainerServiceManagedClusterData(new AzureLocation("location1"))
            {
                ...
                {
                    ResourceIdentityType = (ManagedServiceIdentityType)default,
                    UserAssignedIdentities =
{
[new ResourceIdentifier("/subscriptions/00000000-0000-0000-0000-000000000000/resourcegroups/rgName1/providers/Microsoft.ManagedIdentity/userAssignedIdentities/identity1")] = (UserAssignedIdentity)null
},
                },
                KubernetesVersion = "",
                DnsPrefix = "dnsprefix1",
