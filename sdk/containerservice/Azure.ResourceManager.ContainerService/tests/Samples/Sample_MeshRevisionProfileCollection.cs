...
namespace Azure.ResourceManager.ContainerService.Samples
{
    public partial class Sample_MeshRevisionProfileCollection
    {
        ...
        {
            // Generated from example definition: specification/containerservice/resource-manager/Microsoft.ContainerService/aks/stable/2025-10-01/examples/ManagedClustersGet_MeshRevisionProfile.json
        ...
        {
            // Generated from example definition: specification/containerservice/resource-manager/Microsoft.ContainerService/aks/stable/2025-10-01/examples/ManagedClustersList_MeshRevisionProfiles.json
        ...
        public async Task GetIfExists_GetAMeshRevisionProfileForAMeshMode()
        {
            ...
            // invoke the operation
            string mode = "istio";
            NullableResponse<MeshRevisionProfileResource> response = await collection.GetIfExistsAsync(mode);
