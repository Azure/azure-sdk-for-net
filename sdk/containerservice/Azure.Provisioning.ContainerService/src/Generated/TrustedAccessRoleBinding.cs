...
namespace Azure.Provisioning.ContainerService
{
    ...
    public partial class TrustedAccessRoleBinding : ProvisionableResource
    {
        ...
        /// <summary> Creates a new TrustedAccessRoleBinding. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public TrustedAccessRoleBinding(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.ContainerService/managedClusters/trustedAccessRoleBindings", resourceVersion ?? "2026-01-01")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for TrustedAccessRoleBinding. </summary>
        ...
        /// <summary> Creates a reference to an existing TrustedAccessRoleBinding. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static TrustedAccessRoleBinding FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            TrustedAccessRoleBinding result = new TrustedAccessRoleBinding(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for TrustedAccessRoleBinding that are not part of the generated code. </summary>
