...
public enum PodIPAllocationMode
{
    ...
    /// <summary>
    /// Each node is statically allocated CIDR block(s) of size /28 = 16 IPs
    /// per block to satisfy the maxPods per node. Number of CIDR blocks &gt;=
    /// (maxPods / 16). The block, rather than a single IP, counts against the
