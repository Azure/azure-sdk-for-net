...
namespace Sql.Tests
{
    public class SqlManagementTestContext : IDisposable
    {
        ...
        public ManagedInstance CreateManagedInstance(ResourceGroup resourceGroup, string location)
        {
			...
			// VirtualNetwork vnet = ManagedInstanceTestFixture.CreateVirtualNetwork(this, resourceGroup, TestEnvironmentUtilities.DefaultLocationId);
			...
			Microsoft.Azure.Management.Sql.Models.Sku sku = new Microsoft.Azure.Management.Sql.Models.Sku(name: "MIGP8G4", tier: "GeneralPurpose");
