...
namespace Azure.Provisioning.Sql
{
    ...
    public partial class SqlServerJobStep : ProvisionableResource
    {
        ...
        /// <summary> Creates a new SqlServerJobStep. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public SqlServerJobStep(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.Sql/servers/jobAgents/jobs/steps", resourceVersion ?? "2025-08-01-preview")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for SqlServerJobStep. </summary>
        ...
        /// <summary> Creates a reference to an existing SqlServerJobStep. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static SqlServerJobStep FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            SqlServerJobStep result = new SqlServerJobStep(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for SqlServerJobStep that are not part of the generated code. </summary>
