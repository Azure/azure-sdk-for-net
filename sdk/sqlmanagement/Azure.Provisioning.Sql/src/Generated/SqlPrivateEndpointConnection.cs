...
namespace Azure.Provisioning.Sql
{
    ...
    public partial class SqlPrivateEndpointConnection : ProvisionableResource
    {
        ...
        /// <summary> Creates a new SqlPrivateEndpointConnection. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public SqlPrivateEndpointConnection(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.Sql/servers/privateEndpointConnections", resourceVersion ?? "2025-08-01-preview")
        {
        }
        ...
        internal ServerPrivateEndpointConnectionProperties Properties
        {
            get
            {
                Initialize();
        ...
        /// <summary> Define all the provisionable properties for SqlPrivateEndpointConnection. </summary>
        protected override void DefineProvisionableProperties()
        {
            ...
            _properties = DefineModelProperty<ServerPrivateEndpointConnectionProperties>(nameof(Properties), new string[] { "properties" });
            _parent = DefineResource<SqlServer>(nameof(Parent), new string[] { "parent" }, isRequired: true);
            DefineAdditionalProperties();
        }

        /// <summary> Creates a reference to an existing SqlPrivateEndpointConnection. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static SqlPrivateEndpointConnection FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            SqlPrivateEndpointConnection result = new SqlPrivateEndpointConnection(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for SqlPrivateEndpointConnection that are not part of the generated code. </summary>
