...
namespace Azure.Provisioning.Sql
{
    ...
    public partial class SqlDatabaseSecurityAlertPolicy : ProvisionableResource
    {
        ...
        private SecurityAlertsPolicyProperties _properties;
        private ResourceReference<SqlDatabase> _parent;

        /// <summary> Creates a new SqlDatabaseSecurityAlertPolicy. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public SqlDatabaseSecurityAlertPolicy(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.Sql/servers/databases/securityAlertPolicies", resourceVersion ?? "2025-08-01-preview")
        {
        }
        ...
        internal SecurityAlertsPolicyProperties Properties
        {
            get
            {
                Initialize();
        ...
        /// <summary> Define all the provisionable properties for SqlDatabaseSecurityAlertPolicy. </summary>
        protected override void DefineProvisionableProperties()
        {
            ...
            _properties = DefineModelProperty<SecurityAlertsPolicyProperties>(nameof(Properties), new string[] { "properties" });
            _parent = DefineResource<SqlDatabase>(nameof(Parent), new string[] { "parent" }, isRequired: true);
            DefineAdditionalProperties();
        }

        /// <summary> Creates a reference to an existing SqlDatabaseSecurityAlertPolicy. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static SqlDatabaseSecurityAlertPolicy FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            SqlDatabaseSecurityAlertPolicy result = new SqlDatabaseSecurityAlertPolicy(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for SqlDatabaseSecurityAlertPolicy that are not part of the generated code. </summary>
