...
namespace Azure.Provisioning.Sql
{
    ...
    public partial class ManagedInstancePrivateLinkProperties : ProvisionableConstruct
    {
        private BicepValue<string> _groupId;
        private BicepList<string> _requiredMembers;
        private BicepList<string> _requiredZoneNames;

        /// <summary> Creates a new ManagedInstancePrivateLinkProperties. </summary>
        ...
        /// <summary> Define all the provisionable properties for ManagedInstancePrivateLinkProperties. </summary>
        ...
        /// <summary> Define additional provisionable properties for ManagedInstancePrivateLinkProperties that are not part of the generated code. </summary>
