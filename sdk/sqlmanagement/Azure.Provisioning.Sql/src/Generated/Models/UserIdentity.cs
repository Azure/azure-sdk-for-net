...
namespace Azure.Provisioning.Sql
{
    ...
    public partial class UserIdentity : ProvisionableConstruct
    {
        private BicepValue<Guid> _principalId;
        private BicepValue<Guid> _clientId;

        /// <summary> Creates a new UserIdentity. </summary>
        public UserIdentity()
        {
        }
        ...
        /// <summary> Define all the provisionable properties for UserIdentity. </summary>
        ...
        /// <summary> Define additional provisionable properties for UserIdentity that are not part of the generated code. </summary>
