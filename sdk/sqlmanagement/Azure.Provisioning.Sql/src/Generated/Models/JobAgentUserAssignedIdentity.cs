...
namespace Azure.Provisioning.Sql
{
    ...
    public partial class JobAgentUserAssignedIdentity : ProvisionableConstruct
    {
        private BicepValue<Guid> _principalId;
        private BicepValue<Guid> _clientId;

        /// <summary> Creates a new JobAgentUserAssignedIdentity. </summary>
        ...
        /// <summary> Define all the provisionable properties for JobAgentUserAssignedIdentity. </summary>
        ...
        /// <summary> Define additional provisionable properties for JobAgentUserAssignedIdentity that are not part of the generated code. </summary>
