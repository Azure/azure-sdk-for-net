...
namespace Azure.Provisioning.Sql
{
    ...
    public partial class SqlPrivateLinkResourceProperties : ProvisionableConstruct
    {
        private BicepValue<string> _groupId;
        private BicepList<string> _requiredMembers;
        private BicepList<string> _requiredZoneNames;

        /// <summary> Creates a new SqlPrivateLinkResourceProperties. </summary>
        ...
        /// <summary> Define all the provisionable properties for SqlPrivateLinkResourceProperties. </summary>
        ...
        /// <summary> Define additional provisionable properties for SqlPrivateLinkResourceProperties that are not part of the generated code. </summary>
