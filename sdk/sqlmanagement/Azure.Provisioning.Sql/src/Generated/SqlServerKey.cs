...
namespace Azure.Provisioning.Sql
{
    ...
    public partial class SqlServerKey : ProvisionableResource
    {
        ...
        private ServerKeyProperties _properties;
        ...
        internal ServerKeyProperties Properties
        {
            get
            {
                Initialize();
        ...
        /// <summary> Define all the provisionable properties for SqlServerKey. </summary>
        protected override void DefineProvisionableProperties()
        {
            ...
            _properties = DefineModelProperty<ServerKeyProperties>(nameof(Properties), new string[] { "properties" });
        ...
        /// <summary> Creates a reference to an existing SqlServerKey. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static SqlServerKey FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            SqlServerKey result = new SqlServerKey(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for SqlServerKey that are not part of the generated code. </summary>
