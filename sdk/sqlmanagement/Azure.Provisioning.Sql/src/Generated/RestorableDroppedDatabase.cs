...
namespace Azure.Provisioning.Sql
{
    ...
    public partial class RestorableDroppedDatabase : ProvisionableResource
    {
        ...
        private RestorableDroppedDatabaseProperties _properties;
        private SqlSku _sku;
        private ResourceReference<SqlServer> _parent;

        /// <summary> Creates a new RestorableDroppedDatabase. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        internal RestorableDroppedDatabase(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.Sql/servers/restorableDroppedDatabases", resourceVersion ?? "2025-08-01-preview")
        {
        }
        ...
        internal RestorableDroppedDatabaseProperties Properties
        {
            get
            {
                Initialize();
        ...
        /// <summary> Define all the provisionable properties for RestorableDroppedDatabase. </summary>
        protected override void DefineProvisionableProperties()
        {
            ...
            _properties = DefineModelProperty<RestorableDroppedDatabaseProperties>(nameof(Properties), new string[] { "properties" });
        ...
        /// <summary> Creates a reference to an existing RestorableDroppedDatabase. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static RestorableDroppedDatabase FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            RestorableDroppedDatabase result = new RestorableDroppedDatabase(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for RestorableDroppedDatabase that are not part of the generated code. </summary>
