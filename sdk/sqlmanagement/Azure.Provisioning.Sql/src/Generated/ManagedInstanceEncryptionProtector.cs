...
namespace Azure.Provisioning.Sql
{
    ...
    public partial class ManagedInstanceEncryptionProtector : ProvisionableResource
    {
        ...
        private ManagedInstanceEncryptionProtectorProperties _properties;
        private BicepValue<string> _kind;
        private ResourceReference<ManagedInstance> _parent;

        /// <summary> Creates a new ManagedInstanceEncryptionProtector. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public ManagedInstanceEncryptionProtector(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.Sql/managedInstances/encryptionProtector", resourceVersion ?? "2025-08-01-preview")
        {
        }
        ...
        internal ManagedInstanceEncryptionProtectorProperties Properties
        {
            get
            {
                Initialize();
        ...
        /// <summary> Define all the provisionable properties for ManagedInstanceEncryptionProtector. </summary>
        protected override void DefineProvisionableProperties()
        {
            ...
            _properties = DefineModelProperty<ManagedInstanceEncryptionProtectorProperties>(nameof(Properties), new string[] { "properties" });
        ...
        /// <summary> Creates a reference to an existing ManagedInstanceEncryptionProtector. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static ManagedInstanceEncryptionProtector FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            ManagedInstanceEncryptionProtector result = new ManagedInstanceEncryptionProtector(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for ManagedInstanceEncryptionProtector that are not part of the generated code. </summary>
