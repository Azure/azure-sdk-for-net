...
namespace Azure.Provisioning.Sql
{
    ...
    public partial class ManagedServerSecurityAlertPolicy : ProvisionableResource
    {
        ...
        /// <summary> Creates a new ManagedServerSecurityAlertPolicy. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public ManagedServerSecurityAlertPolicy(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.Sql/managedInstances/securityAlertPolicies", resourceVersion ?? "2025-08-01-preview")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for ManagedServerSecurityAlertPolicy. </summary>
        ...
        /// <summary> Creates a reference to an existing ManagedServerSecurityAlertPolicy. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static ManagedServerSecurityAlertPolicy FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            ManagedServerSecurityAlertPolicy result = new ManagedServerSecurityAlertPolicy(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for ManagedServerSecurityAlertPolicy that are not part of the generated code. </summary>
