...
namespace Azure.Provisioning.Sql
{
    ...
    public partial class SqlServerSecurityAlertPolicy : ProvisionableResource
    {
        ...
        /// <summary> Creates a new SqlServerSecurityAlertPolicy. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public SqlServerSecurityAlertPolicy(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.Sql/servers/securityAlertPolicies", resourceVersion ?? "2025-08-01-preview")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for SqlServerSecurityAlertPolicy. </summary>
        ...
        /// <summary> Creates a reference to an existing SqlServerSecurityAlertPolicy. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static SqlServerSecurityAlertPolicy FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            SqlServerSecurityAlertPolicy result = new SqlServerSecurityAlertPolicy(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for SqlServerSecurityAlertPolicy that are not part of the generated code. </summary>
