...
// Backward-compat stub: ManagedInstancePropertiesProvisioningState was removed from the TypeSpec generation
// but is still referenced in ArmSqlModelFactory backward-compat overloads.
...
{
    /// <summary> The state of provisioning. </summary>
