...
namespace Azure.ResourceManager.Sql
{
    public partial class SubscriptionLongTermRetentionBackupResource : IJsonModel<LongTermRetentionBackupData>
    {
        ...
        {
            return ModelReaderWriter.Read<LongTermRetentionBackupData>(new BinaryData(reader.ValueSequence), options);
        }
        ...
        {
            return ModelReaderWriter.Read<LongTermRetentionBackupData>(data, options);
        }
