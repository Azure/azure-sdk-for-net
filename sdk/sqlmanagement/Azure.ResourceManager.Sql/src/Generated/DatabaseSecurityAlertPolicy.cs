...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class DatabaseSecurityAlertPolicy : ArmResource
    {
        ...
        internal DatabaseSecurityAlertPolicy(ArmResource options, DatabaseSecurityAlertPolicyData data) : base(options, data.Id)
        {
            HasData = true;
            _data = data;
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("DatabaseSecurityAlertPolicy.GetAvailableLocations");
            scope.Start();
            try
            {
