...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class SqlServerTrustGroupResource : ArmResource
    {
        ...
        internal SqlServerTrustGroupResource(ArmClient client, SqlServerTrustGroupData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<SqlServerTrustGroupResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new SqlServerTrustGroupResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
