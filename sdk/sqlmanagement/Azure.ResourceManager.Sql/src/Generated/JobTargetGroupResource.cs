...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class JobTargetGroupResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="JobTargetGroupResource"/> class for mocking. </summary>
        protected JobTargetGroupResource()
        {
        }

        /// <summary> Initializes a new instance of the <see cref = "JobTargetGroupResource"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="data"> The resource that is the target of operations. </param>
        internal JobTargetGroupResource(ArmClient client, JobTargetGroupData data) : this(client, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal JobTargetGroupResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        ...
        public virtual async Task<Response<JobTargetGroupResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            using var scope = _jobTargetGroupClientDiagnostics.CreateScope("JobTargetGroupResource.Get");
            scope.Start();
            try
            {
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<JobTargetGroupResource> Get(CancellationToken cancellationToken = default)
        {
            using var scope = _jobTargetGroupClientDiagnostics.CreateScope("JobTargetGroupResource.Get");
            scope.Start();
            try
        ...
        {
            using var scope = _jobTargetGroupClientDiagnostics.CreateScope("JobTargetGroupResource.Delete");
            scope.Start();
            try
            {
        ...
        public virtual async Task<ArmOperation<JobTargetGroupResource>> UpdateAsync(WaitUntil waitUntil, JobTargetGroupData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));

            using var scope = _jobTargetGroupClientDiagnostics.CreateScope("JobTargetGroupResource.Update");
            scope.Start();
            try
            {
                var response = await _jobTargetGroupRestClient.CreateOrUpdateAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, data, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        public virtual ArmOperation<JobTargetGroupResource> Update(WaitUntil waitUntil, JobTargetGroupData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
            ...
            try
            {
                var response = _jobTargetGroupRestClient.CreateOrUpdate(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, data, cancellationToken);
                var operation = new SqlArmOperation<JobTargetGroupResource>(Response.FromValue(new JobTargetGroupResource(Client, response), response.GetRawResponse()));
                if (waitUntil == WaitUntil.Completed)
