...
namespace Azure.ResourceManager.Sql
{
    internal partial class ServerDnsAliasesRestOperations
    {
        ...
        public ServerDnsAliasesRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null)
        {
        ...
        public async Task<Response<ServerDnsAlias>> GetAsync(string resourceGroupName, string serverName, string dnsAliasName, CancellationToken cancellationToken = default)
        {
            ...
            switch (message.Response.Status)
            {
                case 200:
                    {
                        ServerDnsAlias value = default;
                        using var document = await JsonDocument.ParseAsync(message.Response.ContentStream, default, cancellationToken).ConfigureAwait(false);
                        value = ServerDnsAlias.DeserializeServerDnsAlias(document.RootElement);
