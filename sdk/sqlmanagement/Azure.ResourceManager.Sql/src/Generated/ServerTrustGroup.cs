...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class ServerTrustGroup : ArmResource
    {
        ...
        internal ServerTrustGroup(ArmClient armClient, ServerTrustGroupData data) : this(armClient, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal ServerTrustGroup(ArmClient armClient, ResourceIdentifier id) : base(armClient, id)
        {
            ...
            ArmClient.TryGetApiVersion(ResourceType, out string serverTrustGroupApiVersion);
        ...
        {
            using var scope = _serverTrustGroupClientDiagnostics.CreateScope("ServerTrustGroup.GetAvailableLocations");
            scope.Start();
            try
            {
