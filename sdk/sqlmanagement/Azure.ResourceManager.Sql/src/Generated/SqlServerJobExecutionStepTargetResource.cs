...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class SqlServerJobExecutionStepTargetResource : ArmResource
    {
        ...
        {
            using DiagnosticScope scope = _sqlServerJobExecutionStepTargetsClientDiagnostics.CreateScope("SqlServerJobExecutionStepTargetResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _sqlServerJobExecutionStepTargetsRestClient.CreateGetRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Parent.Parent.Parent.Name, Id.Parent.Parent.Parent.Parent.Name, Id.Parent.Parent.Parent.Name, Guid.Parse(Id.Parent.Parent.Name), Id.Parent.Name, Guid.Parse(Id.Name), context);
