...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class InstanceFailoverGroup : ArmResource
    {
        ...
        internal InstanceFailoverGroup(ArmClient armClient, InstanceFailoverGroupData data) : this(armClient, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal InstanceFailoverGroup(ArmClient armClient, ResourceIdentifier id) : base(armClient, id)
        {
            ...
            ArmClient.TryGetApiVersion(ResourceType, out string instanceFailoverGroupApiVersion);
        ...
        public async virtual Task<Response<InstanceFailoverGroup>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new InstanceFailoverGroup(ArmClient, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        {
            using var scope = _instanceFailoverGroupClientDiagnostics.CreateScope("InstanceFailoverGroup.GetAvailableLocations");
            scope.Start();
            try
            {
