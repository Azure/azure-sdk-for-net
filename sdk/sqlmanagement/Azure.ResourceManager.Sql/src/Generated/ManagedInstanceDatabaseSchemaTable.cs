...
namespace SqlManagementClient
{
    ...
    public partial class ManagedInstanceDatabaseSchemaTable : ArmResource
    {
        ...
        public async virtual Task<Response<ManagedInstanceDatabaseSchemaTable>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _managedDatabaseTablesRestClient.GetAsync(Id.ResourceGroupName, Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<ManagedInstanceDatabaseSchemaTable> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _managedDatabaseTablesRestClient.Get(Id.ResourceGroupName, Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken);
                if (response.Value == null)
