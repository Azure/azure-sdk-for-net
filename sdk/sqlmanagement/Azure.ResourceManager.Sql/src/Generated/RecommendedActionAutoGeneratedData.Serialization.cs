...
{
    public partial class RecommendedActionAutoGeneratedData : IUtf8JsonSerializable, IJsonModel<RecommendedActionAutoGeneratedData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RecommendedActionAutoGeneratedData>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<RecommendedActionAutoGeneratedData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<RecommendedActionAutoGeneratedData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(RecommendedActionAutoGeneratedData)} does not support writing '{format}' format.");
            }
        ...
        RecommendedActionAutoGeneratedData IJsonModel<RecommendedActionAutoGeneratedData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<RecommendedActionAutoGeneratedData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(RecommendedActionAutoGeneratedData)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeRecommendedActionAutoGeneratedData(document.RootElement, options);
        }

        internal static RecommendedActionAutoGeneratedData DeserializeRecommendedActionAutoGeneratedData(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<RecommendedActionAutoGeneratedData>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<RecommendedActionAutoGeneratedData>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(RecommendedActionAutoGeneratedData)} does not support writing '{options.Format}' format.");
            }
        }

        RecommendedActionAutoGeneratedData IPersistableModel<RecommendedActionAutoGeneratedData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<RecommendedActionAutoGeneratedData>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(RecommendedActionAutoGeneratedData)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<RecommendedActionAutoGeneratedData>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
