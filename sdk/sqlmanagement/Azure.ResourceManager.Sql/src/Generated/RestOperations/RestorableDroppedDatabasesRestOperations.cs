...
namespace Azure.ResourceManager.Sql
{
    internal partial class RestorableDroppedDatabasesRestOperations
    {
        ...
        public RestorableDroppedDatabasesRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ClientOptions options, string subscriptionId, Uri endpoint = null)
        {
        ...
        public async Task<Response<RestorableDroppedDatabaseData>> GetAsync(string resourceGroupName, string serverName, string restorableDroppedDatabaseId, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resourceGroupName"/>, <paramref name="serverName"/>, or <paramref name="restorableDroppedDatabaseId"/> is null. </exception>
        public Response<RestorableDroppedDatabaseData> Get(string resourceGroupName, string serverName, string restorableDroppedDatabaseId, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
