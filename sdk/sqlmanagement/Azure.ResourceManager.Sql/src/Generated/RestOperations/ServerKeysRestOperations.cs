...
namespace Azure.ResourceManager.Sql
{
    internal partial class ServerKeysRestOperations
    {
        ...
        internal RequestUriBuilder CreateCreateOrUpdateRequestUri(string subscriptionId, string resourceGroupName, string serverName, string keyName, SqlServerKeyData data)
        {
            var uri = new RawRequestUriBuilder();
            uri.Reset(_endpoint);
            uri.AppendPath("/subscriptions/", false);
        ...
        internal HttpMessage CreateCreateOrUpdateRequest(string subscriptionId, string resourceGroupName, string serverName, string keyName, SqlServerKeyData data)
        {
            ...
            ((IJsonModel<SqlServerKeyData>)data).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
