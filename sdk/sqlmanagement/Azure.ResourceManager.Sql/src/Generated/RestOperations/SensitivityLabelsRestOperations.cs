...
namespace Azure.ResourceManager.Sql
{
    internal partial class SensitivityLabels
    {
        ...
        internal SensitivityLabels(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string applicationId, Uri endpoint, string apiVersion)
        {
            ClientDiagnostics = clientDiagnostics;
            _endpoint = endpoint;
            Pipeline = pipeline;
            _apiVersion = apiVersion;
            _userAgent = new TelemetryDetails(typeof(SensitivityLabels).Assembly, applicationId);
        }
