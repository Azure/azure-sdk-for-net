...
namespace Azure.ResourceManager.Sql
{
    internal partial class FirewallRulesRestOperations
    {
        ...
        internal RequestUriBuilder CreateCreateOrUpdateRequestUri(string subscriptionId, string resourceGroupName, string serverName, string firewallRuleName, SqlFirewallRuleData data)
        {
            var uri = new RawRequestUriBuilder();
            uri.Reset(_endpoint);
            uri.AppendPath("/subscriptions/", false);
        ...
        internal HttpMessage CreateCreateOrUpdateRequest(string subscriptionId, string resourceGroupName, string serverName, string firewallRuleName, SqlFirewallRuleData data)
        {
            ...
            ((IJsonModel<SqlFirewallRuleData>)data).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
