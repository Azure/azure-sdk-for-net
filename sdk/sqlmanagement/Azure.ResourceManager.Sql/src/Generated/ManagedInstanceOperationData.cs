...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class ManagedInstanceOperationData : ResourceData
    {
        ...
        internal ManagedInstanceOperationData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, ManagedInstanceOperationProperties properties) : base(id, name, resourceType, systemData)
        {
