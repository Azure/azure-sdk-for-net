    ...
    public partial class ResourceGroupLongTermRetentionBackupResource : LongTermRetentionBackupResource
    {
        ...
        protected override async Task<Response<LongTermRetentionBackupResource>> GetCoreAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue((LongTermRetentionBackupResource)new ResourceGroupLongTermRetentionBackupResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public virtual new async Task<Response<ResourceGroupLongTermRetentionBackupResource>> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public virtual new Response<ResourceGroupLongTermRetentionBackupResource> Get(CancellationToken cancellationToken = default)
        {
