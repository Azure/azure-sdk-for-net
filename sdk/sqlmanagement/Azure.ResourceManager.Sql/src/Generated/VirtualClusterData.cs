...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class VirtualClusterData : TrackedResourceData
    {
        ...
        internal VirtualClusterData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, ResourceIdentifier subnetId, string family, IReadOnlyList<string> childResources, string maintenanceConfigurationId) : base(id, name, resourceType, systemData, tags, location)
        {
            SubnetId = subnetId;
            Family = family;
