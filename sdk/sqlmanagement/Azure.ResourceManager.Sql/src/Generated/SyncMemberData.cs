...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class SyncMemberData : ResourceData
    {
        ...
        internal SyncMemberData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, SyncMemberProperties properties, DataSyncParticipantIdentity identity) : base(id, name, resourceType, systemData)
        {
        ...
        /// <summary> Sync member authentication information. </summary>
        [WirePath("identity")]
