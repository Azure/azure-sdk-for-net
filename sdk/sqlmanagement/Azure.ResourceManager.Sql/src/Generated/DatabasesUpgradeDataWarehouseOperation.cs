...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class DatabasesUpgradeDataWarehouseOperation : Operation<Response>, IOperationSource<Response>
    {
        private readonly ArmOperationHelpers<Response> _operation;

        /// <summary> Initializes a new instance of DatabasesUpgradeDataWarehouseOperation for mocking. </summary>
        protected DatabasesUpgradeDataWarehouseOperation()
        {
        }

        internal DatabasesUpgradeDataWarehouseOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<Response>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "DatabasesUpgradeDataWarehouseOperation");
        }
        /// <inheritdoc />
