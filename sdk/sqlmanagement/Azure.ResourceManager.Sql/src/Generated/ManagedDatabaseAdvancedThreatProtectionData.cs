...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class ManagedDatabaseAdvancedThreatProtectionData : ResourceData
    {
        ...
        internal ManagedDatabaseAdvancedThreatProtectionData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, AdvancedThreatProtectionState? state, DateTimeOffset? createdOn, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData)
        {
            State = state;
            CreatedOn = createdOn;
            _rawData = rawData;
