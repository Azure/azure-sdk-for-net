...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class SqlDatabaseTableCollection : ArmCollection, IEnumerable<SqlDatabaseTableResource>, IAsyncEnumerable<SqlDatabaseTableResource>
    {
        ...
        internal SqlDatabaseTableCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _databaseTablesClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Sql", SqlDatabaseTableResource.ResourceType.Namespace, Diagnostics);
            _databaseTablesRestClient = new DatabaseTables(_databaseTablesClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, sqlDatabaseTableApiVersion ?? "2025-02-01-preview");
        ...
        public virtual async Task<Response<SqlDatabaseTableResource>> GetAsync(string tableName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _databaseTablesClientDiagnostics.CreateScope("SqlDatabaseTableCollection.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _databaseTablesRestClient.CreateGetRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, tableName, context);
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string tableName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _databaseTablesClientDiagnostics.CreateScope("SqlDatabaseTableCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual async Task<NullableResponse<SqlDatabaseTableResource>> GetIfExistsAsync(string tableName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _databaseTablesClientDiagnostics.CreateScope("SqlDatabaseTableCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
