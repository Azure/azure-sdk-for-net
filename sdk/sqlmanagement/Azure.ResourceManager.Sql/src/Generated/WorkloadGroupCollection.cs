...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class WorkloadGroupCollection : ArmCollection, IEnumerable<WorkloadGroup>, IAsyncEnumerable<WorkloadGroup>
    {
        ...
        /// <exception cref="ArgumentException"> <paramref name="workloadGroupName"/> is null or empty. </exception>
        ...
        {
            if (string.IsNullOrEmpty(workloadGroupName))
            {
                throw new ArgumentException($"Parameter {nameof(workloadGroupName)} cannot be null or empty", nameof(workloadGroupName));
            }
            if (parameters == null)
            {
