...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class DatabaseBlobAuditingPolicy : ArmResource
    {
        ...
        internal DatabaseBlobAuditingPolicy(ArmClient armClient, DatabaseBlobAuditingPolicyData data) : this(armClient, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal DatabaseBlobAuditingPolicy(ArmClient armClient, ResourceIdentifier id) : base(armClient, id)
        {
            ...
            ArmClient.TryGetApiVersion(ResourceType, out string databaseBlobAuditingPolicyApiVersion);
        ...
        public async virtual Task<Response<DatabaseBlobAuditingPolicy>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new DatabaseBlobAuditingPolicy(ArmClient, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        {
            using var scope = _databaseBlobAuditingPolicyClientDiagnostics.CreateScope("DatabaseBlobAuditingPolicy.GetAvailableLocations");
            scope.Start();
            try
            {
