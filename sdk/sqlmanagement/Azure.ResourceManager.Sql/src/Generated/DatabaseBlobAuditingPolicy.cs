...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class DatabaseBlobAuditingPolicy : ArmResource
    {
        ...
        internal DatabaseBlobAuditingPolicy(ArmResource options, DatabaseBlobAuditingPolicyData resource) : base(options, resource.Id)
        {
            ...
            _databaseBlobAuditingPoliciesRestClient = new DatabaseBlobAuditingPoliciesRestOperations(_clientDiagnostics, Pipeline, ClientOptions, Id.SubscriptionId, BaseUri);
        }
        ...
        public async virtual Task<Response<DatabaseBlobAuditingPolicy>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _databaseBlobAuditingPoliciesRestClient.GetAsync(Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<DatabaseBlobAuditingPolicy> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _databaseBlobAuditingPoliciesRestClient.Get(Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken);
                if (response.Value == null)
