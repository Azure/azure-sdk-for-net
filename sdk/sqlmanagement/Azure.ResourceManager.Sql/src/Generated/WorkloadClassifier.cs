...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class WorkloadClassifier : ArmResource
    {
        ...
        internal WorkloadClassifier(ArmClient armClient, WorkloadClassifierData data) : this(armClient, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal WorkloadClassifier(ArmClient armClient, ResourceIdentifier id) : base(armClient, id)
        {
            ...
            ArmClient.TryGetApiVersion(ResourceType, out string workloadClassifierApiVersion);
        ...
        {
            using var scope = _workloadClassifierClientDiagnostics.CreateScope("WorkloadClassifier.GetAvailableLocations");
            scope.Start();
            try
            {
