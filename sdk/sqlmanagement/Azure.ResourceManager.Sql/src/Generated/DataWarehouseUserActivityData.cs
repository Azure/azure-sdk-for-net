...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class DataWarehouseUserActivityData : ResourceData
    {
        ...
        internal DataWarehouseUserActivityData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, int? activeQueriesCount, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
