...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class SubscriptionUsageData : ResourceData
    {
        ...
        internal SubscriptionUsageData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, SubscriptionUsageProperties properties) : base(id, name, resourceType, systemData)
        {
