...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class SqlDatabaseSchemaResource : ArmResource
    {
        ...
        internal SqlDatabaseSchemaResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _sqlDatabaseSchemasClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Sql", ResourceType.Namespace, Diagnostics);
        ...
        {
            using DiagnosticScope scope = _sqlDatabaseSchemasClientDiagnostics.CreateScope("SqlDatabaseSchemaResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _sqlDatabaseSchemasRestClient.CreateGetRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, context);
