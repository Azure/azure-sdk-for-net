    ...
    public partial class SqlDatabaseSchemaResource : DatabaseSchemaResource
    {
        ...
        protected override async Task<Response<DatabaseSchemaResource>> GetCoreAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue((DatabaseSchemaResource)new SqlDatabaseSchemaResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public virtual new async Task<Response<SqlDatabaseSchemaResource>> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public virtual new Response<SqlDatabaseSchemaResource> Get(CancellationToken cancellationToken = default)
        {
