    ...
    public partial class ManagedInstancePrivateEndpointConnectionData : IUtf8JsonSerializable, IJsonModel<ManagedInstancePrivateEndpointConnectionData>
    {
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ConnectionState))
            {
                ...
                ((IJsonModel<ManagedInstancePrivateLinkServiceConnectionStateProperty>)ConnectionState).Write(writer, options);
            }
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("privateLinkServiceConnectionState"u8))
                        {
                            ...
                            privateLinkServiceConnectionState = ModelSerializationExtensions.JsonDeserialize<ManagedInstancePrivateLinkServiceConnectionStateProperty>(property0.Value);
                            continue;
                        }
