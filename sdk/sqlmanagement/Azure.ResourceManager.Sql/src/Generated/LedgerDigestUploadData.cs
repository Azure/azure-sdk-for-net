...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class LedgerDigestUploadData : ResourceData
    {
        ...
        internal LedgerDigestUploadData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string digestStorageEndpoint, LedgerDigestUploadsState? state, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData)
        {
