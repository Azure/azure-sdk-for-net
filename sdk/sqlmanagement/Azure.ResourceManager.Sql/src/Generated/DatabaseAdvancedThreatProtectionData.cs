...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class DatabaseAdvancedThreatProtectionData : ResourceData
    {
        ...
        internal DatabaseAdvancedThreatProtectionData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, AdvancedThreatProtectionState? state, DateTimeOffset? createdOn, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
            State = state;
            CreatedOn = createdOn;
