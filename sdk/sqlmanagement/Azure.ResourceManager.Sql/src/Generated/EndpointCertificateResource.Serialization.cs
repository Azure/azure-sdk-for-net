...
namespace Azure.ResourceManager.Sql
{
    ...
    {
        private static IJsonModel<EndpointCertificateData> s_dataDeserializationInstance;

        private static IJsonModel<EndpointCertificateData> DataDeserializationInstance => s_dataDeserializationInstance ??= new EndpointCertificateData();
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        EndpointCertificateData IJsonModel<EndpointCertificateData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => DataDeserializationInstance.Create(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<EndpointCertificateData>.GetFormatFromOptions(ModelReaderWriterOptions options) => DataDeserializationInstance.GetFormatFromOptions(options);
    }
}
