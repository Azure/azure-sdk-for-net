...
namespace SqlManagementClient
{
    ...
    public partial class RecommendedAction : ArmResource
    {
        ...
        public async virtual Task<Response<RecommendedAction>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _databaseRecommendedActionsRestClient.GetAsync(Id.ResourceGroupName, Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<RecommendedAction> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _databaseRecommendedActionsRestClient.Get(Id.ResourceGroupName, Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken);
                if (response.Value == null)
        ...
        public async virtual Task<Response<RecommendedAction>> UpdateAsync(RecommendedActionData parameters, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _databaseRecommendedActionsRestClient.UpdateAsync(Id.ResourceGroupName, Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, parameters, cancellationToken).ConfigureAwait(false);
                return Response.FromValue(new RecommendedAction(this, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        public virtual Response<RecommendedAction> Update(RecommendedActionData parameters, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _databaseRecommendedActionsRestClient.Update(Id.ResourceGroupName, Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, parameters, cancellationToken);
                return Response.FromValue(new RecommendedAction(this, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
