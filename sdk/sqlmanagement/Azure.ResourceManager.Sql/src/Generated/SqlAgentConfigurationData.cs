...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class SqlAgentConfigurationData : ResourceData
    {
        ...
        internal SqlAgentConfigurationData(ResourceIdentifier id, string name, ResourceType resourceType, ResourceManager.Models.SystemData systemData, SqlAgentConfigurationPropertiesState? state, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
            State = state;
