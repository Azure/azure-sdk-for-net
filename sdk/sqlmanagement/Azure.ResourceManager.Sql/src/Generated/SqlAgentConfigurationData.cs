...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class SqlAgentConfigurationData : ResourceData
    {
        ...
        internal SqlAgentConfigurationData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, SqlAgentConfigurationPropertiesState? state, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
            State = state;
