...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class SqlPrivateEndpointConnectionData : ResourceData
    {
        ...
        internal SqlPrivateEndpointConnectionData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, ServerPrivateEndpointConnectionProperties properties) : base(id, name, resourceType, systemData)
        {
