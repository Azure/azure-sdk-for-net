...
namespace SqlManagementClient
{
    ...
    public partial class JobCredential : ArmResource
    {
        ...
        internal JobCredential(ArmResource options, JobCredentialData resource) : base(options, resource.Id)
        {
            ...
            _jobCredentialsRestClient = new JobCredentialsRestOperations(_clientDiagnostics, Pipeline, ClientOptions, Id.SubscriptionId, BaseUri);
        }
        ...
        public async virtual Task<Response<JobCredential>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _jobCredentialsRestClient.GetAsync(Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<JobCredential> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _jobCredentialsRestClient.Get(Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken);
                if (response.Value == null)
        ...
        public async virtual Task<JobCredentialDeleteOperation> DeleteAsync(bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _jobCredentialsRestClient.DeleteAsync(Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual JobCredentialDeleteOperation Delete(bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _jobCredentialsRestClient.Delete(Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken);
                var operation = new JobCredentialDeleteOperation(response);
                if (waitForCompletion)
