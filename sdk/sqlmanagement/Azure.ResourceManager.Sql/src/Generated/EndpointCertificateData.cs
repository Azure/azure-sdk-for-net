...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class EndpointCertificateData : ResourceData
    {
        ...
        internal EndpointCertificateData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, EndpointCertificateProperties properties, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, name, resourceType, systemData)
        {
