...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class ServerKey : ArmResource
    {
        ...
        internal ServerKey(ArmResource options, ServerKeyData resource) : base(options, resource.Id)
        {
            ...
            _serverKeysRestClient = new ServerKeysRestOperations(_clientDiagnostics, Pipeline, ClientOptions, Id.SubscriptionId, BaseUri);
        }
        ...
        public async virtual Task<Response<ServerKey>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _serverKeysRestClient.GetAsync(Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<ServerKey> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _serverKeysRestClient.Get(Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                if (response.Value == null)
        ...
        public async virtual Task<ServerKeyDeleteOperation> DeleteAsync(bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _serverKeysRestClient.DeleteAsync(Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
                var operation = new ServerKeyDeleteOperation(_clientDiagnostics, Pipeline, _serverKeysRestClient.CreateDeleteRequest(Id.ResourceGroupName, Id.Parent.Name, Id.Name).Request, response);
        ...
        public virtual ServerKeyDeleteOperation Delete(bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _serverKeysRestClient.Delete(Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                var operation = new ServerKeyDeleteOperation(_clientDiagnostics, Pipeline, _serverKeysRestClient.CreateDeleteRequest(Id.ResourceGroupName, Id.Parent.Name, Id.Name).Request, response);
                if (waitForCompletion)
