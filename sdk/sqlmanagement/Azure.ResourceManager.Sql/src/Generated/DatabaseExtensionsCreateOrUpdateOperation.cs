...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class DatabaseExtensionsCreateOrUpdateOperation : Operation<ImportExportExtensionsOperationResult>, IOperationSource<ImportExportExtensionsOperationResult>
    {
        private readonly ArmOperationHelpers<ImportExportExtensionsOperationResult> _operation;

        /// <summary> Initializes a new instance of DatabaseExtensionsCreateOrUpdateOperation for mocking. </summary>
        ...
        {
            _operation = new ArmOperationHelpers<ImportExportExtensionsOperationResult>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "DatabaseExtensionsCreateOrUpdateOperation");
        }
        /// <inheritdoc />
