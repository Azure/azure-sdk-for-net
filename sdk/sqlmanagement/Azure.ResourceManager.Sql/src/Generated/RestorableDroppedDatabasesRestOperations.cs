...
namespace Azure.ResourceManager.Sql
{
    internal partial class RestorableDroppedDatabasesRestOperations
    {
        ...
        internal HttpMessage CreateGetRequest(string resourceGroupName, string serverName, string restorableDroppededDatabaseId)
        {
            ...
            uri.AppendPath(restorableDroppededDatabaseId, true);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="resourceGroupName"/>, <paramref name="serverName"/>, or <paramref name="restorableDroppededDatabaseId"/> is null. </exception>
        public async Task<Response<RestorableDroppedDatabase>> GetAsync(string resourceGroupName, string serverName, string restorableDroppededDatabaseId, CancellationToken cancellationToken = default)
        {
            ...
            {
                throw new ArgumentNullException(nameof(restorableDroppededDatabaseId));
            }

            using var message = CreateGetRequest(resourceGroupName, serverName, restorableDroppededDatabaseId);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resourceGroupName"/>, <paramref name="serverName"/>, or <paramref name="restorableDroppededDatabaseId"/> is null. </exception>
        public Response<RestorableDroppedDatabase> Get(string resourceGroupName, string serverName, string restorableDroppededDatabaseId, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
