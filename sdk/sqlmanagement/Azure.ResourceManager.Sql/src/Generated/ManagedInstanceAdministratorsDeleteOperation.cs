...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class ManagedInstanceAdministratorsDeleteOperation : Operation<Response>, IOperationSource<Response>
    {
        private readonly ArmOperationHelpers<Response> _operation;

        /// <summary> Initializes a new instance of ManagedInstanceAdministratorsDeleteOperation for mocking. </summary>
        protected ManagedInstanceAdministratorsDeleteOperation()
        {
        }

        internal ManagedInstanceAdministratorsDeleteOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<Response>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "ManagedInstanceAdministratorsDeleteOperation");
        }
        /// <inheritdoc />
