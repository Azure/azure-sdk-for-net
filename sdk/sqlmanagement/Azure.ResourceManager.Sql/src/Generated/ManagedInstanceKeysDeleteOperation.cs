...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class ManagedInstanceKeysDeleteOperation : Operation<Response>, IOperationSource<Response>
    {
        private readonly ArmOperationHelpers<Response> _operation;

        /// <summary> Initializes a new instance of ManagedInstanceKeysDeleteOperation for mocking. </summary>
        protected ManagedInstanceKeysDeleteOperation()
        {
        }

        internal ManagedInstanceKeysDeleteOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<Response>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "ManagedInstanceKeysDeleteOperation");
        }
        /// <inheritdoc />
