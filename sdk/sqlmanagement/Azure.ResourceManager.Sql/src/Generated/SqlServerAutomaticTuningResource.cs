...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class SqlServerAutomaticTuningResource : ArmResource
    {
        ...
        internal SqlServerAutomaticTuningResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _serverAutomaticTuningRestClient = new ServerAutomaticTuning(_serverAutomaticTuningClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, sqlServerAutomaticTuningApiVersion ?? "2025-08-01-preview");
