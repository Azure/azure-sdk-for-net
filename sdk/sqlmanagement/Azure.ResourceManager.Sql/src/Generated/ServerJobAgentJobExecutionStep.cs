...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class ServerJobAgentJobExecutionStep : ArmResource
    {
        ...
        internal ServerJobAgentJobExecutionStep(ArmResource options, JobExecutionData resource) : base(options, resource.Id)
        {
            ...
            _jobStepExecutionsRestClient = new JobStepExecutionsRestOperations(_clientDiagnostics, Pipeline, ClientOptions, Id.SubscriptionId, BaseUri);
        }
        ...
        public async virtual Task<Response<ServerJobAgentJobExecutionStep>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _jobStepExecutionsRestClient.GetAsync(Id.ResourceGroupName, Id.Parent.Parent.Parent.Parent.Name, Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Guid.Parse(Id.Parent.Name), Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<ServerJobAgentJobExecutionStep> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _jobStepExecutionsRestClient.Get(Id.ResourceGroupName, Id.Parent.Parent.Parent.Parent.Name, Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Guid.Parse(Id.Parent.Name), Id.Name, cancellationToken);
                if (response.Value == null)
