...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class ServerJobAgentJobExecutionStep : ArmResource
    {
        ...
        internal ServerJobAgentJobExecutionStep(ArmResource options, JobExecutionData data) : base(options, data.Id)
        {
            HasData = true;
            _data = data;
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("ServerJobAgentJobExecutionStep.GetAvailableLocations");
            scope.Start();
            try
            {
