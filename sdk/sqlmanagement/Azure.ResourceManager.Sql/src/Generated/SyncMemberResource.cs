...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class SyncMemberResource : ArmResource
    {
        ...
        internal SyncMemberResource(ArmClient client, SyncMemberData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<SyncMemberResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new SyncMemberResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
