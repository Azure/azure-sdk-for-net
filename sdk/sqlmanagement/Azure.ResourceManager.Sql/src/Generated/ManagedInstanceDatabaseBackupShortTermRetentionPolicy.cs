...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class ManagedInstanceDatabaseBackupShortTermRetentionPolicy : ArmResource
    {
        ...
        internal ManagedInstanceDatabaseBackupShortTermRetentionPolicy(ArmResource options, ManagedBackupShortTermRetentionPolicyData resource) : base(options, resource.Id)
        {
            HasData = true;
            _data = resource;
        ...
        public async virtual Task<ManagedBackupShortTermRetentionPolicyUpdateOperation> UpdateAsync(ManagedBackupShortTermRetentionPolicyData parameters, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            if (parameters == null)
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="parameters"/> is null. </exception>
        public virtual ManagedBackupShortTermRetentionPolicyUpdateOperation Update(ManagedBackupShortTermRetentionPolicyData parameters, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            if (parameters == null)
            {
                throw new ArgumentNullException(nameof(parameters));
