...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class SqlServerCommunicationLinkData : ResourceData
    {
        ...
        internal SqlServerCommunicationLinkData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, AzureLocation? location, string kind, string state, string partnerServer, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData)
        {
            Location = location;
            Kind = kind;
            State = state;
