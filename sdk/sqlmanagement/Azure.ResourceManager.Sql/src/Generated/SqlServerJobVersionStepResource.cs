...
namespace Azure.ResourceManager.Sql
{
    ...
    /// </summary>
    public partial class SqlServerJobVersionStepResource : BaseSqlServerJobStepResource
    {
        ...
        protected override async Task<Response<BaseSqlServerJobStepResource>> GetCoreAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue((BaseSqlServerJobStepResource)new SqlServerJobVersionStepResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public virtual new async Task<Response<SqlServerJobVersionStepResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            var result = await GetCoreAsync(cancellationToken).ConfigureAwait(false);
            return Response.FromValue((SqlServerJobVersionStepResource)result.Value, result.GetRawResponse());
        }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public virtual new Response<SqlServerJobVersionStepResource> Get(CancellationToken cancellationToken = default)
        {
