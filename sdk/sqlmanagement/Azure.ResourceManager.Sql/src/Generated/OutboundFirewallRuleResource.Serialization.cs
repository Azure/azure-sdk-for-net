...
namespace Azure.ResourceManager.Sql
{
    public partial class OutboundFirewallRuleResource : IJsonModel<OutboundFirewallRuleData>
    {
        ...
        {
            return ModelReaderWriter.Read<OutboundFirewallRuleData>(new BinaryData(reader.ValueSequence), options);
        }
        ...
        {
            return ModelReaderWriter.Read<OutboundFirewallRuleData>(data, options);
        }
