...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class SqlDatabaseBlobAuditingPolicyResource : ArmResource
    {
        ...
        internal SqlDatabaseBlobAuditingPolicyResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _databaseBlobAuditingPoliciesRestClient = new DatabaseBlobAuditingPolicies(_databaseBlobAuditingPoliciesClientDiagnostics, Pipeline, Endpoint, sqlDatabaseBlobAuditingPolicyApiVersion ?? "2025-01-01");
