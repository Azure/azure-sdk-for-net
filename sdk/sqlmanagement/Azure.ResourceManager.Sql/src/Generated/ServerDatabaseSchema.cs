...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class ServerDatabaseSchema : ArmResource
    {
        ...
        public async virtual Task<Response<ServerDatabaseSchema>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _databaseSchemasRestClient.GetAsync(Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<ServerDatabaseSchema> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _databaseSchemasRestClient.Get(Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken);
                if (response.Value == null)
