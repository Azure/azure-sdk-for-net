...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class DatabaseAutomaticTuningResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="DatabaseAutomaticTuningResource"/> class for mocking. </summary>
        protected DatabaseAutomaticTuningResource()
        {
        }

        /// <summary> Initializes a new instance of the <see cref = "DatabaseAutomaticTuningResource"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="data"> The resource that is the target of operations. </param>
        internal DatabaseAutomaticTuningResource(ArmClient client, DatabaseAutomaticTuningData data) : this(client, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal DatabaseAutomaticTuningResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            TryGetApiVersion(ResourceType, out string databaseAutomaticTuningApiVersion);
            _databaseAutomaticTuningRestClient = new DatabaseAutomaticTuningRestOperations(Pipeline, DiagnosticOptions.ApplicationId, BaseUri, databaseAutomaticTuningApiVersion);
#if DEBUG
        ...
        public virtual async Task<Response<DatabaseAutomaticTuningResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            using var scope = _databaseAutomaticTuningClientDiagnostics.CreateScope("DatabaseAutomaticTuningResource.Get");
            scope.Start();
            try
            {
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<DatabaseAutomaticTuningResource> Get(CancellationToken cancellationToken = default)
        {
            using var scope = _databaseAutomaticTuningClientDiagnostics.CreateScope("DatabaseAutomaticTuningResource.Get");
            scope.Start();
            try
