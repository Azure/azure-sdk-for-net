...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class ServerDevOpsAuditingSettingsCollection : ArmCollection, IEnumerable<ServerDevOpsAuditingSettings>, IAsyncEnumerable<ServerDevOpsAuditingSettings>
    {
        ...
        /// <exception cref="ArgumentException"> <paramref name="devOpsAuditingSettingsName"/> is null or empty. </exception>
        ...
        {
            if (string.IsNullOrEmpty(devOpsAuditingSettingsName))
            {
                throw new ArgumentException($"Parameter {nameof(devOpsAuditingSettingsName)} cannot be null or empty", nameof(devOpsAuditingSettingsName));
            }
            if (parameters == null)
            {
