    ...
    public partial class ExtendedServerBlobAuditingPolicyResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<ExtendedServerBlobAuditingPolicyResource>> UpdateAsync(WaitUntil waitUntil, ExtendedServerBlobAuditingPolicyData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new SqlArmOperation<ExtendedServerBlobAuditingPolicyResource>(new ExtendedServerBlobAuditingPolicyOperationSource(Client), _extendedServerBlobAuditingPolicyClientDiagnostics, Pipeline, _extendedServerBlobAuditingPolicyRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, data).Request, response, Core.OperationFinalStateVia.Location);
