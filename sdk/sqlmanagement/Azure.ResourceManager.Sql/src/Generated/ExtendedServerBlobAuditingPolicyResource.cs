...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class ExtendedServerBlobAuditingPolicyResource : ArmResource
    {
        ...
        internal ExtendedServerBlobAuditingPolicyResource(ArmClient client, ExtendedServerBlobAuditingPolicyData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<ExtendedServerBlobAuditingPolicyResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new ExtendedServerBlobAuditingPolicyResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
