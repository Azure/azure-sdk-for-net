...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class ManagedInstanceAzureADOnlyAuthenticationResource : ArmResource
    {
        ...
        internal ManagedInstanceAzureADOnlyAuthenticationResource(ArmClient client, ManagedInstanceAzureADOnlyAuthenticationData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
