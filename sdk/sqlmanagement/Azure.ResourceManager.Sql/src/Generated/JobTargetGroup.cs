...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class JobTargetGroup : ArmResource
    {
        ...
        internal JobTargetGroup(ArmClient armClient, JobTargetGroupData data) : this(armClient, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal JobTargetGroup(ArmClient armClient, ResourceIdentifier id) : base(armClient, id)
        {
            ...
            ArmClient.TryGetApiVersion(ResourceType, out string jobTargetGroupApiVersion);
        ...
        {
            using var scope = _jobTargetGroupClientDiagnostics.CreateScope("JobTargetGroup.GetAvailableLocations");
            scope.Start();
            try
            {
