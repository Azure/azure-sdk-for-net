...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class DatabaseAutomaticTuning : ArmResource
    {
        ...
        internal DatabaseAutomaticTuning(ArmResource options, DatabaseAutomaticTuningData data) : base(options, data.Id)
        {
            HasData = true;
            _data = data;
            Parent = options;
            ...
            _databaseAutomaticTuningRestClient = new DatabaseAutomaticTuningRestOperations(_clientDiagnostics, Pipeline, ClientOptions, BaseUri, apiVersion);
#if DEBUG
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("DatabaseAutomaticTuning.GetAvailableLocations");
            scope.Start();
            try
            {
