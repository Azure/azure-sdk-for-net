...
namespace SqlManagementClient
{
    ...
    public partial class ManagedDatabaseRestoreDetailsResult : ArmResource
    {
        ...
        public async virtual Task<Response<ManagedDatabaseRestoreDetailsResult>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _managedDatabaseRestoreDetailsRestClient.GetAsync(Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<ManagedDatabaseRestoreDetailsResult> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _managedDatabaseRestoreDetailsRestClient.Get(Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken);
                if (response.Value == null)
