...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class LongTermRetentionBackupsCopyByResourceGroupOperation : Operation<LongTermRetentionBackupOperationResult>, IOperationSource<LongTermRetentionBackupOperationResult>
    {
        private readonly ArmOperationHelpers<LongTermRetentionBackupOperationResult> _operation;

        /// <summary> Initializes a new instance of LongTermRetentionBackupsCopyByResourceGroupOperation for mocking. </summary>
        protected LongTermRetentionBackupsCopyByResourceGroupOperation()
        {
        }

        internal LongTermRetentionBackupsCopyByResourceGroupOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<LongTermRetentionBackupOperationResult>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "LongTermRetentionBackupsCopyByResourceGroupOperation");
        }
        /// <inheritdoc />
