...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class LongTermRetentionManagedInstanceBackupsDeleteByResourceGroupOperation : Operation<Response>, IOperationSource<Response>
    {
        private readonly ArmOperationHelpers<Response> _operation;

        /// <summary> Initializes a new instance of LongTermRetentionManagedInstanceBackupsDeleteByResourceGroupOperation for mocking. </summary>
        protected LongTermRetentionManagedInstanceBackupsDeleteByResourceGroupOperation()
        {
        }

        internal LongTermRetentionManagedInstanceBackupsDeleteByResourceGroupOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<Response>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "LongTermRetentionManagedInstanceBackupsDeleteByResourceGroupOperation");
        }
        /// <inheritdoc />
