...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class ManagedDatabaseSecurityAlertPolicyData : ResourceData
    {
        ...
        internal ManagedDatabaseSecurityAlertPolicyData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, SecurityAlertPolicyProperties properties) : base(id, name, resourceType, systemData)
        {
