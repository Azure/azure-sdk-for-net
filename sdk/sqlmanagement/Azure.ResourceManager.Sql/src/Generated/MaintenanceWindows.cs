...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class MaintenanceWindows : ArmResource
    {
        ...
        internal MaintenanceWindows(ArmClient armClient, MaintenanceWindowsData data) : this(armClient, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal MaintenanceWindows(ArmClient armClient, ResourceIdentifier id) : base(armClient, id)
        {
            ...
            ArmClient.TryGetApiVersion(ResourceType, out string maintenanceWindowsMaintenanceWindowsApiVersion);
        ...
        public async virtual Task<Response<MaintenanceWindows>> GetAsync(string maintenanceWindowName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new MaintenanceWindows(ArmClient, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        {
            using var scope = _maintenanceWindowsMaintenanceWindowsClientDiagnostics.CreateScope("MaintenanceWindows.GetAvailableLocations");
            scope.Start();
            try
            {
