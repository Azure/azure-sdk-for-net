...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class SqlDatabaseBlobAuditingPolicyData : ResourceData
    {
        ...
        internal SqlDatabaseBlobAuditingPolicyData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, DatabaseBlobAuditingPolicyProperties properties, string kind) : base(id, name, resourceType, systemData)
        {
