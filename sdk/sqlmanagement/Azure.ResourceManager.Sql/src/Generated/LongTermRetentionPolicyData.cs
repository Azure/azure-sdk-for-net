...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class LongTermRetentionPolicyData : Resource
    {
        ...
        internal LongTermRetentionPolicyData(ResourceIdentifier id, string name, ResourceType type, string weeklyRetention, string monthlyRetention, string yearlyRetention, int? weekOfYear) : base(id, name, type)
        {
