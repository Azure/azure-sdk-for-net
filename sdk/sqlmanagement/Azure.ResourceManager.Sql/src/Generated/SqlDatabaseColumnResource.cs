...
namespace Azure.ResourceManager.Sql
{
    ...
    /// </summary>
    public partial class SqlDatabaseColumnResource : DatabaseColumnResource
    {
        ...
        internal SqlDatabaseColumnResource(ArmClient client, DatabaseColumnData data) : base(client, data)
        {
        ...
        protected override async Task<Response<DatabaseColumnResource>> GetCoreAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue((DatabaseColumnResource)new SqlDatabaseColumnResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public virtual new async Task<Response<SqlDatabaseColumnResource>> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public virtual new Response<SqlDatabaseColumnResource> Get(CancellationToken cancellationToken = default)
        {
        ...
        {
            using var scope = _sensitivityLabelsClientDiagnostics.CreateScope("SqlDatabaseColumnResource.EnableRecommendationSensitivityLabel");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _sensitivityLabelsClientDiagnostics.CreateScope("SqlDatabaseColumnResource.DisableRecommendationSensitivityLabel");
            scope.Start();
            try
            {
