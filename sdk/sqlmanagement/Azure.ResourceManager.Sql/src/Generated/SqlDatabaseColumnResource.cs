...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class SqlDatabaseColumnResource : ArmResource
    {
        ...
        internal SqlDatabaseColumnResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _sensitivityLabelsRestClient = new SensitivityLabels(_sensitivityLabelsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, sqlDatabaseColumnApiVersion ?? "2025-08-01-preview");
