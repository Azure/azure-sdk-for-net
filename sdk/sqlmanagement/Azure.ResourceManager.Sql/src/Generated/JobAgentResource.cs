...
{
    /// <summary> A Class representing a JobAgentResource along with the instance operations that can be performed on it. </summary>
    public partial class JobAgentResource : ArmResource
    {
        ...
        internal JobAgentResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _serverJobAgentJobExecutionJobExecutionsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Sql", ServerJobAgentJobExecutionResource.ResourceType.Namespace, DiagnosticOptions);
