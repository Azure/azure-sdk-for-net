...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class ServerDatabaseSchemaResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="ServerDatabaseSchemaResource"/> class for mocking. </summary>
        protected ServerDatabaseSchemaResource()
        {
        }

        /// <summary> Initializes a new instance of the <see cref = "ServerDatabaseSchemaResource"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="data"> The resource that is the target of operations. </param>
        internal ServerDatabaseSchemaResource(ArmClient client, DatabaseSchemaData data) : this(client, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal ServerDatabaseSchemaResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        ...
        /// <summary> Gets a collection of ServerDatabaseSchemaTableResources in the ServerDatabaseSchemaTableResource. </summary>
        /// <returns> An object representing collection of ServerDatabaseSchemaTableResources and their operations over a ServerDatabaseSchemaTableResource. </returns>
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<ServerDatabaseSchemaResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            using var scope = _serverDatabaseSchemaDatabaseSchemasClientDiagnostics.CreateScope("ServerDatabaseSchemaResource.Get");
            scope.Start();
            try
            {
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<ServerDatabaseSchemaResource> Get(CancellationToken cancellationToken = default)
        {
            using var scope = _serverDatabaseSchemaDatabaseSchemasClientDiagnostics.CreateScope("ServerDatabaseSchemaResource.Get");
            scope.Start();
            try
