...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class LongTermRetentionBackupsDeleteOperation : Operation<Response>, IOperationSource<Response>
    {
        private readonly ArmOperationHelpers<Response> _operation;

        /// <summary> Initializes a new instance of LongTermRetentionBackupsDeleteOperation for mocking. </summary>
        protected LongTermRetentionBackupsDeleteOperation()
        {
        }

        internal LongTermRetentionBackupsDeleteOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<Response>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "LongTermRetentionBackupsDeleteOperation");
        }
        /// <inheritdoc />
