...
namespace SqlManagementClient
{
    ...
    public partial class ServerJobAgentJobVersionStep : ArmResource
    {
        ...
        internal ServerJobAgentJobVersionStep(ArmResource options, JobStepData resource) : base(options, resource.Id)
        {
            HasData = true;
            _data = resource;
        ...
        public async virtual Task<Response<ServerJobAgentJobVersionStep>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _jobStepsRestClient.GetByVersionAsync(Id.ResourceGroupName, Id.Parent.Parent.Parent.Parent.Name, Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, int.Parse(Id.Parent.Name), Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<ServerJobAgentJobVersionStep> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _jobStepsRestClient.GetByVersion(Id.ResourceGroupName, Id.Parent.Parent.Parent.Parent.Name, Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, int.Parse(Id.Parent.Name), Id.Name, cancellationToken);
                if (response.Value == null)
