...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class ServiceObjectiveData : ResourceData
    {
        ...
        internal ServiceObjectiveData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string serviceObjectiveName, bool? isDefault, bool? isSystem, string description, bool? isEnabled, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData)
        {
