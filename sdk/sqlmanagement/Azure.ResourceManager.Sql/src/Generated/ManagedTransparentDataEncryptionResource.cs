...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class ManagedTransparentDataEncryptionResource : ArmResource
    {
        ...
        internal ManagedTransparentDataEncryptionResource(ArmClient client, ManagedTransparentDataEncryptionData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<ManagedTransparentDataEncryptionResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new ManagedTransparentDataEncryptionResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual async Task<ArmOperation<ManagedTransparentDataEncryptionResource>> UpdateAsync(WaitUntil waitUntil, ManagedTransparentDataEncryptionData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new SqlArmOperation<ManagedTransparentDataEncryptionResource>(Response.FromValue(new ManagedTransparentDataEncryptionResource(Client, response.Value, response.Value.Id), response.GetRawResponse()));
