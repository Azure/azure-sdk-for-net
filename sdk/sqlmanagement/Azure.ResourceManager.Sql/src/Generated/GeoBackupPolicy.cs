...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class GeoBackupPolicy : ArmResource
    {
        ...
        internal GeoBackupPolicy(ArmClient armClient, GeoBackupPolicyData data) : this(armClient, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal GeoBackupPolicy(ArmClient armClient, ResourceIdentifier id) : base(armClient, id)
        {
            ...
            ArmClient.TryGetApiVersion(ResourceType, out string geoBackupPolicyApiVersion);
        ...
        public async virtual Task<Response<GeoBackupPolicy>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new GeoBackupPolicy(ArmClient, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        {
            using var scope = _geoBackupPolicyClientDiagnostics.CreateScope("GeoBackupPolicy.GetAvailableLocations");
            scope.Start();
            try
            {
