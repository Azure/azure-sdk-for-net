...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class ManagedInstanceDtcCollection : ArmCollection, IEnumerable<ManagedInstanceDtcResource>, IAsyncEnumerable<ManagedInstanceDtcResource>
    {
        ...
        {
            async Task<Page<ManagedInstanceDtcResource>> FirstPageFunc(int? pageSizeHint)
            {
            ...
            async Task<Page<ManagedInstanceDtcResource>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                using var scope = _managedInstanceDtcClientDiagnostics.CreateScope("ManagedInstanceDtcCollection.GetAll");
                scope.Start();
                try
        ...
        {
            Page<ManagedInstanceDtcResource> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _managedInstanceDtcClientDiagnostics.CreateScope("ManagedInstanceDtcCollection.GetAll");
                scope.Start();
                try
            ...
            Page<ManagedInstanceDtcResource> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                using var scope = _managedInstanceDtcClientDiagnostics.CreateScope("ManagedInstanceDtcCollection.GetAll");
                scope.Start();
                try
