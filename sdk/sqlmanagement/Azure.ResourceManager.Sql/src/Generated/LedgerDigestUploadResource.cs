...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class LedgerDigestUploadResource : ArmResource
    {
        ...
        internal LedgerDigestUploadResource(ArmClient client, LedgerDigestUploadData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<LedgerDigestUploadResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new LedgerDigestUploadResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
