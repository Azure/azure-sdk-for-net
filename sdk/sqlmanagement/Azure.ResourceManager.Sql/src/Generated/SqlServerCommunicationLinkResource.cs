...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class SqlServerCommunicationLinkResource : ArmResource
    {
        ...
        internal SqlServerCommunicationLinkResource(ArmClient client, SqlServerCommunicationLinkData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<SqlServerCommunicationLinkResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new SqlServerCommunicationLinkResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
