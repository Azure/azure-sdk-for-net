...
namespace Azure.ResourceManager.Sql
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="SqlInstancePoolOperationResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="InstancePoolResource"/> using the GetSqlInstancePoolOperations method.
    /// </summary>
    public partial class SqlInstancePoolOperationResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of SqlInstancePoolOperationResource for mocking. </summary>
        protected SqlInstancePoolOperationResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="SqlInstancePoolOperationResource"/> class. </summary>
        ...
        {
            TryGetApiVersion(ResourceType, out string sqlInstancePoolOperationApiVersion);
            _instancePoolOperationsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Sql", ResourceType.Namespace, Diagnostics);
        ...
        {
            using DiagnosticScope scope = _instancePoolOperationsClientDiagnostics.CreateScope("SqlInstancePoolOperationResource.Get");
            scope.Start();
            try
            {
