...
namespace Azure.ResourceManager.Sql
{
    ...
    /// </summary>
    public partial class SqlServerAdvisorResource : SqlAdvisorResource
    {
        ...
        internal SqlServerAdvisorResource(ArmClient client, SqlAdvisorData data) : base(client, data)
        {
        ...
        {
            using var scope = _sqlServerAdvisorServerAdvisorsClientDiagnostics.CreateScope("SqlServerAdvisorResource.GetCore");
            scope.Start();
            try
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public new virtual async Task<Response<SqlServerAdvisorResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            var value = await GetCoreAsync(cancellationToken).ConfigureAwait(false);
            return Response.FromValue((SqlServerAdvisorResource)value.Value, value.GetRawResponse());
        }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public new virtual Response<SqlServerAdvisorResource> Get(CancellationToken cancellationToken = default)
        {
        ...
        protected override async Task<Response<SqlAdvisorResource>> UpdateCoreAsync(SqlAdvisorData data, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _sqlServerAdvisorServerAdvisorsClientDiagnostics.CreateScope("SqlServerAdvisorResource.UpdateCore");
            scope.Start();
            try
            {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [ForwardsClientCalls]
        public new virtual async Task<Response<SqlServerAdvisorResource>> UpdateAsync(SqlAdvisorData data, CancellationToken cancellationToken = default)
        {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [ForwardsClientCalls]
        public new virtual Response<SqlServerAdvisorResource> Update(SqlAdvisorData data, CancellationToken cancellationToken = default)
        {
