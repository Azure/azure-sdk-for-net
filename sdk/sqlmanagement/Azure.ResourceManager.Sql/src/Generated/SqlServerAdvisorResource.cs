...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class SqlServerAdvisorResource : ArmResource
    {
        ...
        private readonly AdvisorAutoGeneratedData _data;
        ...
        internal SqlServerAdvisorResource(ArmClient client, AdvisorAutoGeneratedData data) : this(client, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual AdvisorAutoGeneratedData Data
        {
            get
            {
                if (!HasData)
        ...
        public virtual async Task<Response<SqlServerAdvisorResource>> UpdateAsync(AdvisorAutoGeneratedData data, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        public virtual Response<SqlServerAdvisorResource> Update(AdvisorAutoGeneratedData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
