...
namespace SqlManagementClient
{
    ...
    public partial class OutboundFirewallRule : ArmResource
    {
        ...
        public async virtual Task<Response<OutboundFirewallRule>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _outboundFirewallRulesRestClient.GetAsync(Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<OutboundFirewallRule> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _outboundFirewallRulesRestClient.Get(Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                if (response.Value == null)
        ...
        public async virtual Task<OutboundFirewallRuleDeleteOperation> DeleteAsync(bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _outboundFirewallRulesRestClient.DeleteAsync(Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
                var operation = new OutboundFirewallRuleDeleteOperation(_clientDiagnostics, Pipeline, _outboundFirewallRulesRestClient.CreateDeleteRequest(Id.ResourceGroupName, Id.Parent.Name, Id.Name).Request, response);
        ...
        public virtual OutboundFirewallRuleDeleteOperation Delete(bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _outboundFirewallRulesRestClient.Delete(Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                var operation = new OutboundFirewallRuleDeleteOperation(_clientDiagnostics, Pipeline, _outboundFirewallRulesRestClient.CreateDeleteRequest(Id.ResourceGroupName, Id.Parent.Name, Id.Name).Request, response);
                if (waitForCompletion)
