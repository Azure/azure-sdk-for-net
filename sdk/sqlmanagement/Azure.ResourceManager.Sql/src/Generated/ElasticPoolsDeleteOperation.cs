...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class ElasticPoolsDeleteOperation : Operation<Response>, IOperationSource<Response>
    {
        private readonly ArmOperationHelpers<Response> _operation;

        /// <summary> Initializes a new instance of ElasticPoolsDeleteOperation for mocking. </summary>
        protected ElasticPoolsDeleteOperation()
        {
        }

        internal ElasticPoolsDeleteOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<Response>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "ElasticPoolsDeleteOperation");
        }
        /// <inheritdoc />
