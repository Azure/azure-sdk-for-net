...
namespace Azure.ResourceManager.Sql
{
    ...
    {
        private static IJsonModel<SqlServerDatabaseRestorePointData> s_dataDeserializationInstance;

        private static IJsonModel<SqlServerDatabaseRestorePointData> DataDeserializationInstance => s_dataDeserializationInstance ??= new SqlServerDatabaseRestorePointData();
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        SqlServerDatabaseRestorePointData IJsonModel<SqlServerDatabaseRestorePointData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => DataDeserializationInstance.Create(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<SqlServerDatabaseRestorePointData>.GetFormatFromOptions(ModelReaderWriterOptions options) => DataDeserializationInstance.GetFormatFromOptions(options);
    }
}
