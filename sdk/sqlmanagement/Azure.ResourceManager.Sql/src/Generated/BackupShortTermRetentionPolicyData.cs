...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class BackupShortTermRetentionPolicyData : ResourceData
    {
        ...
        internal BackupShortTermRetentionPolicyData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, int? retentionDays, DiffBackupIntervalInHours? diffBackupIntervalInHours, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData)
        {
