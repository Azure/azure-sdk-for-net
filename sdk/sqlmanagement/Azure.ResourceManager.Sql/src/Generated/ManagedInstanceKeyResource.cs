...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class ManagedInstanceKeyResource : ArmResource
    {
        ...
        internal ManagedInstanceKeyResource(ArmClient client, ManagedInstanceKeyData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<ManagedInstanceKeyResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new ManagedInstanceKeyResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
