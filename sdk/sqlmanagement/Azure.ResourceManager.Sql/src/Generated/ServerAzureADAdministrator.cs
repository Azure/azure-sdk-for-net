...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class ServerAzureADAdministrator : ArmResource
    {
        ...
        internal ServerAzureADAdministrator(ArmResource options, ServerAzureADAdministratorData resource) : base(options, resource.Id)
        {
            ...
            _serverAzureADAdministratorsRestClient = new ServerAzureADAdministratorsRestOperations(_clientDiagnostics, Pipeline, ClientOptions, Id.SubscriptionId, BaseUri);
        }
        ...
        public async virtual Task<Response<ServerAzureADAdministrator>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _serverAzureADAdministratorsRestClient.GetAsync(Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<ServerAzureADAdministrator> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _serverAzureADAdministratorsRestClient.Get(Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                if (response.Value == null)
        ...
        public async virtual Task<ServerAzureADAdministratorDeleteOperation> DeleteAsync(bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _serverAzureADAdministratorsRestClient.DeleteAsync(Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
                var operation = new ServerAzureADAdministratorDeleteOperation(_clientDiagnostics, Pipeline, _serverAzureADAdministratorsRestClient.CreateDeleteRequest(Id.ResourceGroupName, Id.Parent.Name, Id.Name).Request, response);
        ...
        public virtual ServerAzureADAdministratorDeleteOperation Delete(bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _serverAzureADAdministratorsRestClient.Delete(Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                var operation = new ServerAzureADAdministratorDeleteOperation(_clientDiagnostics, Pipeline, _serverAzureADAdministratorsRestClient.CreateDeleteRequest(Id.ResourceGroupName, Id.Parent.Name, Id.Name).Request, response);
                if (waitForCompletion)
