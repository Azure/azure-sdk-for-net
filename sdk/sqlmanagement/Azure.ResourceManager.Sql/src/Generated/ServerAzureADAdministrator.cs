...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class ServerAzureADAdministrator : ArmResource
    {
        ...
        internal ServerAzureADAdministrator(ArmResource options, ServerAzureADAdministratorData data) : base(options, data.Id)
        {
            HasData = true;
            _data = data;
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("ServerAzureADAdministrator.GetAvailableLocations");
            scope.Start();
            try
            {
