...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class ServerAzureADAdministrator : ArmResource
    {
        ...
        internal ServerAzureADAdministrator(ArmClient armClient, ServerAzureADAdministratorData data) : this(armClient, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal ServerAzureADAdministrator(ArmClient armClient, ResourceIdentifier id) : base(armClient, id)
        {
            ...
            ArmClient.TryGetApiVersion(ResourceType, out string serverAzureADAdministratorApiVersion);
        ...
        public async virtual Task<Response<ServerAzureADAdministrator>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new ServerAzureADAdministrator(ArmClient, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        {
            using var scope = _serverAzureADAdministratorClientDiagnostics.CreateScope("ServerAzureADAdministrator.GetAvailableLocations");
            scope.Start();
            try
            {
