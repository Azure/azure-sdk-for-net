...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class RecommendedActionCollection : ArmCollection, IEnumerable<RecommendedAction>, IAsyncEnumerable<RecommendedAction>
    {
        ...
        /// <exception cref="ArgumentException"> <paramref name="recommendedActionName"/> is null or empty. </exception>
        public virtual Response<RecommendedAction> Get(string recommendedActionName, CancellationToken cancellationToken = default)
        {
            if (string.IsNullOrEmpty(recommendedActionName))
            {
                throw new ArgumentException($"Parameter {nameof(recommendedActionName)} cannot be null or empty", nameof(recommendedActionName));
            }
