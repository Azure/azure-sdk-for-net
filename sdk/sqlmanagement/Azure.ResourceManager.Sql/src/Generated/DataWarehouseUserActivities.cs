...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class DataWarehouseUserActivities : ArmResource
    {
        ...
        internal DataWarehouseUserActivities(ArmResource options, DataWarehouseUserActivitiesData data) : base(options, data.Id)
        {
            HasData = true;
            _data = data;
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("DataWarehouseUserActivities.GetAvailableLocations");
            scope.Start();
            try
            {
