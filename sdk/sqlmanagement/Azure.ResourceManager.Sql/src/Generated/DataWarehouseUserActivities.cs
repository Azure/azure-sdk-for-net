...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class DataWarehouseUserActivities : ArmResource
    {
        ...
        internal DataWarehouseUserActivities(ArmResource options, DataWarehouseUserActivitiesData resource) : base(options, resource.Id)
        {
            ...
            _dataWarehouseUserActivitiesRestClient = new DataWarehouseUserActivitiesRestOperations(_clientDiagnostics, Pipeline, ClientOptions, Id.SubscriptionId, BaseUri);
        }
        ...
        public async virtual Task<Response<DataWarehouseUserActivities>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _dataWarehouseUserActivitiesRestClient.GetAsync(Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<DataWarehouseUserActivities> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _dataWarehouseUserActivitiesRestClient.Get(Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken);
                if (response.Value == null)
