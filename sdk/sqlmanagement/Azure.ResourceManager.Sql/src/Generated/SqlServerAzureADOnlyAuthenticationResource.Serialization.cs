...
namespace Azure.ResourceManager.Sql
{
    ...
    {
        private static IJsonModel<SqlServerAzureADOnlyAuthenticationData> s_dataDeserializationInstance;

        private static IJsonModel<SqlServerAzureADOnlyAuthenticationData> DataDeserializationInstance => s_dataDeserializationInstance ??= new SqlServerAzureADOnlyAuthenticationData();
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        SqlServerAzureADOnlyAuthenticationData IJsonModel<SqlServerAzureADOnlyAuthenticationData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => DataDeserializationInstance.Create(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<SqlServerAzureADOnlyAuthenticationData>.GetFormatFromOptions(ModelReaderWriterOptions options) => DataDeserializationInstance.GetFormatFromOptions(options);
    }
}
