...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class ManagedDatabaseResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<ManagedDatabaseResource>> UpdateAsync(WaitUntil waitUntil, ManagedDatabaseData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _managedDatabasesRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, ManagedDatabaseData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                SqlArmOperation<ManagedDatabaseResource> operation = new SqlArmOperation<ManagedDatabaseResource>(
                    new ManagedDatabaseResourceOperationSource(Client),
                    _managedDatabasesClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<ManagedDatabaseResource> Update(WaitUntil waitUntil, ManagedDatabaseData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
