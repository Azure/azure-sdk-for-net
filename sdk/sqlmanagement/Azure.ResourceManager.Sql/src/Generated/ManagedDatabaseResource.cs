...
{
    /// <summary> A Class representing a ManagedDatabaseResource along with the instance operations that can be performed on it. </summary>
    public partial class ManagedDatabaseResource : ArmResource
    {
        ...
        internal ManagedDatabaseResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _managedInstanceDatabaseSchemaTableColumnManagedDatabaseColumnsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Sql", ManagedInstanceDatabaseSchemaTableColumnResource.ResourceType.Namespace, DiagnosticOptions);
            ...
            _managedInstanceDatabaseSchemaTableColumnSensitivityLabelManagedDatabaseSensitivityLabelsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Sql", ManagedInstanceDatabaseSchemaTableColumnSensitivityLabelResource.ResourceType.Namespace, DiagnosticOptions);
        ...
        public virtual async Task<ArmOperation<ManagedDatabaseResource>> UpdateAsync(WaitUntil waitUntil, PatchableManagedDatabaseData data, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        public virtual ArmOperation<ManagedDatabaseResource> Update(WaitUntil waitUntil, PatchableManagedDatabaseData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
