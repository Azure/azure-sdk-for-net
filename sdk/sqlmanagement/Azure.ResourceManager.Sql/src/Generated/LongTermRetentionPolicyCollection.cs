...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class LongTermRetentionPolicyCollection : ArmCollection, IEnumerable<LongTermRetentionPolicyResource>, IAsyncEnumerable<LongTermRetentionPolicyResource>
    {
        ...
        /// <summary> Initializes a new instance of LongTermRetentionPolicyCollection for mocking. </summary>
        protected LongTermRetentionPolicyCollection()
        {
        }

        /// <summary> Initializes a new instance of <see cref="LongTermRetentionPolicyCollection"/> class. </summary>
        ...
        internal LongTermRetentionPolicyCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _longTermRetentionPoliciesClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Sql", LongTermRetentionPolicyResource.ResourceType.Namespace, Diagnostics);
            _longTermRetentionPoliciesRestClient = new LongTermRetentionPolicies(_longTermRetentionPoliciesClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, longTermRetentionPolicyApiVersion ?? "2025-08-01-preview");
        ...
        public virtual async Task<ArmOperation<LongTermRetentionPolicyResource>> CreateOrUpdateAsync(WaitUntil waitUntil, LongTermRetentionPolicyName policyName, LongTermRetentionPolicyData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _longTermRetentionPoliciesClientDiagnostics.CreateScope("LongTermRetentionPolicyCollection.CreateOrUpdate");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _longTermRetentionPoliciesRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, policyName.ToString(), LongTermRetentionPolicyData.ToRequestContent(data), context);
        ...
        {
            using DiagnosticScope scope = _longTermRetentionPoliciesClientDiagnostics.CreateScope("LongTermRetentionPolicyCollection.Get");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _longTermRetentionPoliciesRestClient.CreateGetRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, policyName.ToString(), context);
        ...
        public virtual AsyncPageable<LongTermRetentionPolicyResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<LongTermRetentionPolicyData, LongTermRetentionPolicyResource>(new LongTermRetentionPoliciesGetByDatabaseAsyncCollectionResultOfT(
                ...
                Id.Name,
                context,
                "LongTermRetentionPolicyCollection.GetAll"), data => new LongTermRetentionPolicyResource(Client, data));
        }
        ...
        {
            using DiagnosticScope scope = _longTermRetentionPoliciesClientDiagnostics.CreateScope("LongTermRetentionPolicyCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                Response<LongTermRetentionPolicyData> response = default;
                switch (result.Status)
                {
                    case 200:
                        response = Response.FromValue(LongTermRetentionPolicyData.FromResponse(result), result);
                        break;
                    case 404:
                        response = Response.FromValue((LongTermRetentionPolicyData)null, result);
                        break;
                    default:
        ...
        {
            using DiagnosticScope scope = _longTermRetentionPoliciesClientDiagnostics.CreateScope("LongTermRetentionPolicyCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
