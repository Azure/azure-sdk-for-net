...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class ServerConnectionPolicy : ArmResource
    {
        ...
        internal ServerConnectionPolicy(ArmClient client, ServerConnectionPolicyData data) : this(client, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal ServerConnectionPolicy(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            Client.TryGetApiVersion(ResourceType, out string serverConnectionPolicyApiVersion);
