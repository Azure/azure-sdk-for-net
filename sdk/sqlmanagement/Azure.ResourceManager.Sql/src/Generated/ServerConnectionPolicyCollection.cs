    ...
    public partial class ServerConnectionPolicyCollection : ArmCollection, IEnumerable<ServerConnectionPolicy>, IAsyncEnumerable<ServerConnectionPolicy>
    {
        ...
        public virtual ServerConnectionPolicyCreateOrUpdateOperation CreateOrUpdate(bool waitForCompletion, ConnectionPolicyName connectionPolicyName, ServerConnectionPolicyData parameters, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new ServerConnectionPolicyCreateOrUpdateOperation(this, _clientDiagnostics, Pipeline, _serverConnectionPoliciesRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, connectionPolicyName, parameters).Request, response);
        ...
        public virtual Pageable<ServerConnectionPolicy> GetAll(CancellationToken cancellationToken = default)
        {
            Page<ServerConnectionPolicy> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    ...
                    return Page.FromValues(response.Value.Value.Select(value => new ServerConnectionPolicy(this, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
                    scope.Failed(e);
