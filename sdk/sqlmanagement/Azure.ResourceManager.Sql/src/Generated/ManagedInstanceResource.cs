...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class ManagedInstanceResource : ArmResource
    {
        ...
        public virtual AsyncPageable<SqlServerTrustGroupResource> GetByInstanceAsync(CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
            };
            return new AsyncPageableWrapper<SqlServerTrustGroupData, SqlServerTrustGroupResource>(new ServerTrustGroupsGetByInstanceAsyncCollectionResultOfT(
                _serverTrustGroupsRestClient,
                Guid.Parse(Id.SubscriptionId),
                Id.ResourceGroupName,
                Id.Name,
                context,
                "ManagedInstanceResource.GetByInstance"), data => new SqlServerTrustGroupResource(Client, data));
        }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> A collection of <see cref="SqlServerTrustGroupResource"/> that may take multiple service requests to iterate over. </returns>
        public virtual Pageable<SqlServerTrustGroupResource> GetByInstance(CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
            };
            return new PageableWrapper<SqlServerTrustGroupData, SqlServerTrustGroupResource>(new ServerTrustGroupsGetByInstanceCollectionResultOfT(
                _serverTrustGroupsRestClient,
                Guid.Parse(Id.SubscriptionId),
                Id.ResourceGroupName,
                Id.Name,
        ...
        public virtual AsyncPageable<ManagedDatabaseResource> GetInaccessibleByInstanceAsync(CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
            };
            return new AsyncPageableWrapper<ManagedDatabaseData, ManagedDatabaseResource>(new ManagedDatabasesGetInaccessibleByInstanceAsyncCollectionResultOfT(
                _managedDatabasesRestClient,
                Guid.Parse(Id.SubscriptionId),
                Id.ResourceGroupName,
                Id.Name,
                context,
                "ManagedInstanceResource.GetInaccessibleByInstance"), data => new ManagedDatabaseResource(Client, data));
        }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> A collection of <see cref="ManagedDatabaseResource"/> that may take multiple service requests to iterate over. </returns>
        public virtual Pageable<ManagedDatabaseResource> GetInaccessibleByInstance(CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
            };
            return new PageableWrapper<ManagedDatabaseData, ManagedDatabaseResource>(new ManagedDatabasesGetInaccessibleByInstanceCollectionResultOfT(
                _managedDatabasesRestClient,
                Guid.Parse(Id.SubscriptionId),
                Id.ResourceGroupName,
                Id.Name,
        ...
        public virtual AsyncPageable<TopQueries> GetByManagedInstanceAsync(int? numberOfQueries = default, string databases = default, string startTime = default, string endTime = default, QueryTimeGrainType? interval = default, AggregationFunctionType? aggregationFunction = default, SqlMetricType? observationMetric = default, CancellationToken cancellationToken = default)
        {
            ...
            return new ManagedInstancesGetByManagedInstanceAsyncCollectionResultOfT(
                ...
                context,
                "ManagedInstanceResource.GetByManagedInstance");
        }
        ...
        public virtual Pageable<TopQueries> GetByManagedInstance(int? numberOfQueries = default, string databases = default, string startTime = default, string endTime = default, QueryTimeGrainType? interval = default, AggregationFunctionType? aggregationFunction = default, SqlMetricType? observationMetric = default, CancellationToken cancellationToken = default)
        {
            ...
            return new ManagedInstancesGetByManagedInstanceCollectionResultOfT(
                _managedInstancesRestClient,
                Guid.Parse(Id.SubscriptionId),
                Id.ResourceGroupName,
                Id.Name,
        ...
        public virtual AsyncPageable<SqlOutboundEnvironmentEndpoint> GetOutboundNetworkDependenciesByManagedInstanceAsync(CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
            };
            return new ManagedInstancesGetOutboundNetworkDependenciesByManagedInstanceAsyncCollectionResultOfT(
                _managedInstancesRestClient,
                Guid.Parse(Id.SubscriptionId),
                Id.ResourceGroupName,
                Id.Name,
                context,
                "ManagedInstanceResource.GetOutboundNetworkDependenciesByManagedInstance");
        }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> A collection of <see cref="SqlOutboundEnvironmentEndpoint"/> that may take multiple service requests to iterate over. </returns>
        public virtual Pageable<SqlOutboundEnvironmentEndpoint> GetOutboundNetworkDependenciesByManagedInstance(CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
            };
            return new ManagedInstancesGetOutboundNetworkDependenciesByManagedInstanceCollectionResultOfT(
                _managedInstancesRestClient,
                Guid.Parse(Id.SubscriptionId),
                Id.ResourceGroupName,
                Id.Name,
        ...
        /// <summary> Gets a collection of ServerTrustCertificates in the <see cref="ManagedInstanceResource"/>. </summary>
        /// <returns> An object representing collection of ServerTrustCertificates and their operations over a ServerTrustCertificateResource. </returns>
