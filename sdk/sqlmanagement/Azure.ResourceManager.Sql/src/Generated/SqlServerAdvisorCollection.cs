...
namespace Azure.ResourceManager.Sql
{
    ...
    {
        private readonly ClientDiagnostics _sqlServerAdvisorsClientDiagnostics;
        private readonly SqlServerAdvisors _sqlServerAdvisorsRestClient;
        ...
        internal SqlServerAdvisorCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _sqlServerAdvisorsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Sql", SqlServerAdvisorResource.ResourceType.Namespace, Diagnostics);
            _sqlServerAdvisorsRestClient = new SqlServerAdvisors(_sqlServerAdvisorsClientDiagnostics, Pipeline, Endpoint, sqlServerAdvisorApiVersion ?? "2025-02-01-preview");
        ...
        public virtual async Task<Response<SqlServerAdvisorResource>> GetAsync(string advisorName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _sqlServerAdvisorsClientDiagnostics.CreateScope("SqlServerAdvisorCollection.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _sqlServerAdvisorsRestClient.CreateGetRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, advisorName, context);
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string advisorName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _sqlServerAdvisorsClientDiagnostics.CreateScope("SqlServerAdvisorCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual async Task<NullableResponse<SqlServerAdvisorResource>> GetIfExistsAsync(string advisorName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _sqlServerAdvisorsClientDiagnostics.CreateScope("SqlServerAdvisorCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
