...
namespace Azure.ResourceManager.Sql.Mocking
{
    ...
    public partial class MockableSqlArmClient : ArmResource
    {
        ...
        /// You can use <see cref="DataMaskingPolicyResource.CreateResourceIdentifier(string, string, string, string, Models.DataMaskingPolicyName)" /> to create a <see cref="DataMaskingPolicyResource"/> <see cref="ResourceIdentifier"/> from its components.
        /// </summary>
        /// <param name="id"> The resource ID of the resource to get. </param>
        ...
        public virtual RecommendedActionAutoGeneratedResource GetRecommendedActionAutoGeneratedResource(ResourceIdentifier id)
        {
            RecommendedActionAutoGeneratedResource.ValidateResourceId(id);
            return new RecommendedActionAutoGeneratedResource(Client, id);
        }
        ...
        public virtual InstancePoolOperationResource GetInstancePoolOperationResource(ResourceIdentifier id)
        {
            InstancePoolOperationResource.ValidateResourceId(id);
            return new InstancePoolOperationResource(Client, id);
        }
