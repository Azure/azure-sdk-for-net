...
namespace Azure.ResourceManager.Sql.Mock
{
    ...
    public partial class DeletedServerResourceExtension : ArmResource
    {
        private ClientDiagnostics _deletedServerClientDiagnostics;
        private DeletedServersRestOperations _deletedServerRestClient;

        /// <summary> Initializes a new instance of the <see cref="DeletedServerResourceExtension"/> class for mocking. </summary>
        protected DeletedServerResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="DeletedServerResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal DeletedServerResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<DeletedServerResource> GetDeletedServersAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new DeletedServerResource(Client, DeletedServerData.DeserializeDeletedServerData(e)), DeletedServerClientDiagnostics, Pipeline, "DeletedServerResourceExtension.GetDeletedServers", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<DeletedServerResource> GetDeletedServers(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => DeletedServerRestClient.CreateListRequest(Id.SubscriptionId);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => DeletedServerRestClient.CreateListNextPageRequest(nextLink, Id.SubscriptionId);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new DeletedServerResource(Client, DeletedServerData.DeserializeDeletedServerData(e)), DeletedServerClientDiagnostics, Pipeline, "DeletedServerResourceExtension.GetDeletedServers", "value", "nextLink", cancellationToken);
        }
    }
}
