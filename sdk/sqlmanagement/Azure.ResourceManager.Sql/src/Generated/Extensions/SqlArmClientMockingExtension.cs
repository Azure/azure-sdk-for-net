...
namespace Azure.ResourceManager.Sql.Mocking
{
    ...
    internal partial class SqlArmClientMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="SqlArmClientMockingExtension"/> class for mocking. </summary>
        protected SqlArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="SqlArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal SqlArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal SqlArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
