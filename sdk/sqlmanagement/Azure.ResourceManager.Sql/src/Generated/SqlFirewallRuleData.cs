...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class SqlFirewallRuleData : ProxyResourceWithWritableName
    {
        ...
        internal SqlFirewallRuleData(ResourceIdentifier id, string name, ResourceType? resourceType, string startIPAddress, string endIPAddress, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, serializedAdditionalRawData)
        {
