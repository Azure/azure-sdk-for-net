...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class ServersImportDatabaseOperation : Operation<ImportExportOperationResult>, IOperationSource<ImportExportOperationResult>
    {
        private readonly ArmOperationHelpers<ImportExportOperationResult> _operation;

        /// <summary> Initializes a new instance of ServersImportDatabaseOperation for mocking. </summary>
        protected ServersImportDatabaseOperation()
        {
        }

        internal ServersImportDatabaseOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<ImportExportOperationResult>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "ServersImportDatabaseOperation");
        }
        /// <inheritdoc />
