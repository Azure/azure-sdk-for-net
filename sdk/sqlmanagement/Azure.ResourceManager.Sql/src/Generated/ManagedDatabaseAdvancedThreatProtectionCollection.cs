...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class ManagedDatabaseAdvancedThreatProtectionCollection : ArmCollection, IEnumerable<ManagedDatabaseAdvancedThreatProtectionResource>, IAsyncEnumerable<ManagedDatabaseAdvancedThreatProtectionResource>
    {
        ...
        {
            async Task<Page<ManagedDatabaseAdvancedThreatProtectionResource>> FirstPageFunc(int? pageSizeHint)
            {
            ...
            async Task<Page<ManagedDatabaseAdvancedThreatProtectionResource>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                using var scope = _managedDatabaseAdvancedThreatProtectionManagedDatabaseAdvancedThreatProtectionSettingsClientDiagnostics.CreateScope("ManagedDatabaseAdvancedThreatProtectionCollection.GetAll");
                scope.Start();
                try
        ...
        {
            Page<ManagedDatabaseAdvancedThreatProtectionResource> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _managedDatabaseAdvancedThreatProtectionManagedDatabaseAdvancedThreatProtectionSettingsClientDiagnostics.CreateScope("ManagedDatabaseAdvancedThreatProtectionCollection.GetAll");
                scope.Start();
                try
            ...
            Page<ManagedDatabaseAdvancedThreatProtectionResource> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                using var scope = _managedDatabaseAdvancedThreatProtectionManagedDatabaseAdvancedThreatProtectionSettingsClientDiagnostics.CreateScope("ManagedDatabaseAdvancedThreatProtectionCollection.GetAll");
                scope.Start();
                try
