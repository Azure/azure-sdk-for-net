...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class SqlServerResource : ArmResource
    {
        ...
        /// <item>
        /// <term> Operation Id. </term>
        /// <description> Servers_Replace. </description>
        /// </item>
        /// <item>
        /// <term> Default Api Version. </term>
        /// <description> 2025-02-01-preview. </description>
        ...
        /// </list>
        /// </summary>
        /// <param name="firewallRuleList"></param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="firewallRuleList"/> is null. </exception>
        public virtual async Task<Response<SqlFirewallRuleResource>> ReplaceAsync(FirewallRuleList firewallRuleList, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(firewallRuleList, nameof(firewallRuleList));

            using DiagnosticScope scope = _firewallRulesClientDiagnostics.CreateScope("SqlServerResource.Replace");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _firewallRulesRestClient.CreateReplaceRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, FirewallRuleList.ToRequestContent(firewallRuleList), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="firewallRuleList"/> is null. </exception>
        public virtual Response<SqlFirewallRuleResource> Replace(FirewallRuleList firewallRuleList, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(firewallRuleList, nameof(firewallRuleList));
        ...
        public virtual AsyncPageable<ServerOperationData> GetOperationsByServerAsync(CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
            };
            return new ServerOperationsGetOperationsByServerAsyncCollectionResultOfT(
                _serverOperationsRestClient,
                Guid.Parse(Id.SubscriptionId),
                Id.ResourceGroupName,
                Id.Name,
                context,
                "SqlServerResource.GetOperationsByServer");
        }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> A collection of <see cref="ServerOperationData"/> that may take multiple service requests to iterate over. </returns>
        public virtual Pageable<ServerOperationData> GetOperationsByServer(CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
            };
            return new ServerOperationsGetOperationsByServerCollectionResultOfT(
                _serverOperationsRestClient,
                Guid.Parse(Id.SubscriptionId),
                Id.ResourceGroupName,
                Id.Name,
        ...
        public virtual AsyncPageable<SqlServerUsage> GetUsagesByServerAsync(CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
            };
            return new ServerUsagesGetUsagesByServerAsyncCollectionResultOfT(
                _serverUsagesRestClient,
                Guid.Parse(Id.SubscriptionId),
                Id.ResourceGroupName,
                Id.Name,
                context,
                "SqlServerResource.GetUsagesByServer");
        }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> A collection of <see cref="SqlServerUsage"/> that may take multiple service requests to iterate over. </returns>
        public virtual Pageable<SqlServerUsage> GetUsagesByServer(CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
            };
            return new ServerUsagesGetUsagesByServerCollectionResultOfT(
                _serverUsagesRestClient,
                Guid.Parse(Id.SubscriptionId),
                Id.ResourceGroupName,
                Id.Name,
