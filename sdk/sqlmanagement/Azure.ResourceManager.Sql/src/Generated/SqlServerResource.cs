...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class SqlServerResource : ArmResource
    {
        ...
        /// <summary> Gets a collection of ServerSqlVulnerabilityAssessmentScanScanResultResources in the SqlServer. </summary>
        ...
        /// <returns> An object representing collection of ServerSqlVulnerabilityAssessmentScanScanResultResources and their operations over a ServerSqlVulnerabilityAssessmentScanScanResultResource. </returns>
        public virtual ServerSqlVulnerabilityAssessmentScanScanResultCollection GetServerSqlVulnerabilityAssessmentScanScanResults(SqlVulnerabilityAssessmentName vulnerabilityAssessmentName, string scanId)
        {
            Argument.AssertNotNullOrEmpty(scanId, nameof(scanId));

            return new ServerSqlVulnerabilityAssessmentScanScanResultCollection(Client, Id, vulnerabilityAssessmentName, scanId);
        }

        /// <summary>
        /// Gets a vulnerability assessment scan record of a database.
        /// Request Path: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/sqlVulnerabilityAssessments/{vulnerabilityAssessmentName}/scans/{scanId}/scanResults/{scanResultId}
        /// Operation Id: SqlVulnerabilityAssessmentScanResult_Get
        /// </summary>
        /// <param name="vulnerabilityAssessmentName"> The name of the SQL Vulnerability Assessment. </param>
        /// <param name="scanId"> The scan id of the SQL Vulnerability Assessment scan to retrieve result from. </param>
        ...
        [ForwardsClientCalls]
        public virtual async Task<Response<ServerSqlVulnerabilityAssessmentScanScanResultResource>> GetServerSqlVulnerabilityAssessmentScanScanResultAsync(SqlVulnerabilityAssessmentName vulnerabilityAssessmentName, string scanId, string scanResultId, CancellationToken cancellationToken = default)
        {
            return await GetServerSqlVulnerabilityAssessmentScanScanResults(vulnerabilityAssessmentName, scanId).GetAsync(scanResultId, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="scanId"/> or <paramref name="scanResultId"/> is null. </exception>
        [ForwardsClientCalls]
        public virtual Response<ServerSqlVulnerabilityAssessmentScanScanResultResource> GetServerSqlVulnerabilityAssessmentScanScanResult(SqlVulnerabilityAssessmentName vulnerabilityAssessmentName, string scanId, string scanResultId, CancellationToken cancellationToken = default)
        {
            return GetServerSqlVulnerabilityAssessmentScanScanResults(vulnerabilityAssessmentName, scanId).Get(scanResultId, cancellationToken);
        }
