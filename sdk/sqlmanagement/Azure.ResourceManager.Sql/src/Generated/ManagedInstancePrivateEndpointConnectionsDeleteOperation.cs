...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class ManagedInstancePrivateEndpointConnectionsDeleteOperation : Operation<Response>, IOperationSource<Response>
    {
        private readonly ArmOperationHelpers<Response> _operation;

        /// <summary> Initializes a new instance of ManagedInstancePrivateEndpointConnectionsDeleteOperation for mocking. </summary>
        protected ManagedInstancePrivateEndpointConnectionsDeleteOperation()
        {
        }

        internal ManagedInstancePrivateEndpointConnectionsDeleteOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<Response>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "ManagedInstancePrivateEndpointConnectionsDeleteOperation");
        }
        /// <inheritdoc />
