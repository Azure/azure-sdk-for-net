...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class WorkloadClassifiersDeleteOperation : Operation<Response>, IOperationSource<Response>
    {
        private readonly ArmOperationHelpers<Response> _operation;

        /// <summary> Initializes a new instance of WorkloadClassifiersDeleteOperation for mocking. </summary>
        protected WorkloadClassifiersDeleteOperation()
        {
        }

        internal WorkloadClassifiersDeleteOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<Response>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "WorkloadClassifiersDeleteOperation");
        }
        /// <inheritdoc />
