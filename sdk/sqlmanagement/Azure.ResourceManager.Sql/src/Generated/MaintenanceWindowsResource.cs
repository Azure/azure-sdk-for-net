...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class MaintenanceWindowsResource : ArmResource
    {
        ...
        internal MaintenanceWindowsResource(ArmClient client, MaintenanceWindowsData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<MaintenanceWindowsResource>> GetAsync(string maintenanceWindowName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new MaintenanceWindowsResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
