...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class DatabaseSecurityAlertPolicyData : ResourceData
    {
        ...
        internal DatabaseSecurityAlertPolicyData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, SecurityAlertsPolicyState? state, IList<string> disabledAlerts, IList<string> emailAddresses, bool? emailAccountAdmins, string storageEndpoint, string storageAccountAccessKey, int? retentionDays, DateTimeOffset? creationTime) : base(id, name, resourceType, systemData)
        {
            State = state;
