...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class SqlServerJobCollection : ArmCollection, IEnumerable<SqlServerJobResource>, IAsyncEnumerable<SqlServerJobResource>
    {
        ...
        internal SqlServerJobCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _jobsRestClient = new Jobs(_jobsClientDiagnostics, Pipeline, Endpoint, sqlServerJobApiVersion ?? "2025-02-01-preview");
            _sqlServerJobExecutionsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Sql", SqlServerJobResource.ResourceType.Namespace, Diagnostics);
            _sqlServerJobExecutionsRestClient = new SqlServerJobExecutions(_sqlServerJobExecutionsClientDiagnostics, Pipeline, Endpoint, sqlServerJobApiVersion ?? "2025-02-01-preview");
