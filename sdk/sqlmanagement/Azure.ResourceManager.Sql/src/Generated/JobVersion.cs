...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class JobVersion : ArmResource
    {
        ...
        internal JobVersion(ArmResource options, JobVersionData resource) : base(options, resource.Id)
        {
            ...
            _jobVersionsRestClient = new JobVersionsRestOperations(_clientDiagnostics, Pipeline, ClientOptions, Id.SubscriptionId, BaseUri);
        }
        ...
        public async virtual Task<Response<JobVersion>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _jobVersionsRestClient.GetAsync(Id.ResourceGroupName, Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, int.Parse(Id.Name), cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<JobVersion> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _jobVersionsRestClient.Get(Id.ResourceGroupName, Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, int.Parse(Id.Name), cancellationToken);
                if (response.Value == null)
