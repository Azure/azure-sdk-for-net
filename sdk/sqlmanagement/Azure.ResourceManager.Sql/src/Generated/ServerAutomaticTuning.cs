...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class ServerAutomaticTuning : ArmResource
    {
        ...
        internal ServerAutomaticTuning(ArmResource options, ServerAutomaticTuningData data) : base(options, data.Id)
        {
            ...
            _serverAutomaticTuningRestClient = new ServerAutomaticTuningRestOperations(_clientDiagnostics, Pipeline, ClientOptions, BaseUri, apiVersion);
#if DEBUG
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("ServerAutomaticTuning.GetAvailableLocations");
            scope.Start();
            try
            {
