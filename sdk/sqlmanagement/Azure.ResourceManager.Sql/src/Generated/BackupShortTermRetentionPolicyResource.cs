...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class BackupShortTermRetentionPolicyResource : ArmResource
    {
        ...
        internal BackupShortTermRetentionPolicyResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _backupShortTermRetentionPoliciesRestClient = new BackupShortTermRetentionPolicies(_backupShortTermRetentionPoliciesClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, backupShortTermRetentionPolicyApiVersion ?? "2025-08-01-preview");
