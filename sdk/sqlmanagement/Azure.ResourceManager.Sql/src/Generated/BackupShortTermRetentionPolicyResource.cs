...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class BackupShortTermRetentionPolicyResource : ArmResource
    {
        ...
        internal BackupShortTermRetentionPolicyResource(ArmClient client, BackupShortTermRetentionPolicyData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<BackupShortTermRetentionPolicyResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new BackupShortTermRetentionPolicyResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
