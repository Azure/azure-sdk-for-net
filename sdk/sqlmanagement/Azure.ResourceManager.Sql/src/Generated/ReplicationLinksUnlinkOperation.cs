...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class ReplicationLinksUnlinkOperation : Operation<Response>, IOperationSource<Response>
    {
        private readonly ArmOperationHelpers<Response> _operation;

        /// <summary> Initializes a new instance of ReplicationLinksUnlinkOperation for mocking. </summary>
        protected ReplicationLinksUnlinkOperation()
        {
        }

        internal ReplicationLinksUnlinkOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<Response>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "ReplicationLinksUnlinkOperation");
        }
        /// <inheritdoc />
