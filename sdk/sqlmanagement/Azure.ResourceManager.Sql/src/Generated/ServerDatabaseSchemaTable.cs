...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class ServerDatabaseSchemaTable : ArmResource
    {
        ...
        internal ServerDatabaseSchemaTable(ArmResource options, DatabaseTableData data) : base(options, data.Id)
        {
            HasData = true;
            _data = data;
        ...
        internal ServerDatabaseSchemaTable(ArmResource options, ResourceIdentifier id) : base(options, id)
        {
            _clientDiagnostics = new ClientDiagnostics(ClientOptions);
            ClientOptions.TryGetApiVersion(ResourceType, out string apiVersion);
            _databaseTablesRestClient = new DatabaseTablesRestOperations(_clientDiagnostics, Pipeline, ClientOptions, BaseUri, apiVersion);
        ...
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ServerDatabaseSchemaTable(ArmClientOptions clientOptions, TokenCredential credential, Uri uri, HttpPipeline pipeline, ResourceIdentifier id) : base(clientOptions, credential, uri, pipeline, id)
        {
            _clientDiagnostics = new ClientDiagnostics(ClientOptions);
            ClientOptions.TryGetApiVersion(ResourceType, out string apiVersion);
            _databaseTablesRestClient = new DatabaseTablesRestOperations(_clientDiagnostics, Pipeline, ClientOptions, BaseUri, apiVersion);
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("ServerDatabaseSchemaTable.Get");
            scope.Start();
            try
            {
                var response = await _databaseTablesRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<ServerDatabaseSchemaTable> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _databaseTablesRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken);
                if (response.Value == null)
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("ServerDatabaseSchemaTable.GetAvailableLocations");
            scope.Start();
            try
            {
        ...
        /// <summary> Gets a collection of ServerDatabaseSchemaTableColumns in the ServerDatabaseSchemaTable. </summary>
        /// <returns> An object representing collection of ServerDatabaseSchemaTableColumns and their operations over a ServerDatabaseSchemaTable. </returns>
        public virtual ServerDatabaseSchemaTableColumnCollection GetServerDatabaseSchemaTableColumns()
        {
            return new ServerDatabaseSchemaTableColumnCollection(this);
        }
        #endregion
    }
}
