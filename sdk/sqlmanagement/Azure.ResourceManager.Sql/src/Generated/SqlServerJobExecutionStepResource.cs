...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class SqlServerJobExecutionStepResource : ArmResource
    {
        ...
        internal SqlServerJobExecutionStepResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _sqlServerJobExecutionStepsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Sql", ResourceType.Namespace, Diagnostics);
        ...
        {
            using DiagnosticScope scope = _sqlServerJobExecutionStepsClientDiagnostics.CreateScope("SqlServerJobExecutionStepResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _sqlServerJobExecutionStepsRestClient.CreateGetRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Parent.Parent.Name, Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Guid.Parse(Id.Parent.Name), Id.Name, context);
