...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class SqlServerJobExecutionStepResource : ArmResource
    {
        ...
        internal SqlServerJobExecutionStepResource(ArmClient client, SqlServerJobExecutionData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<SqlServerJobExecutionStepResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new SqlServerJobExecutionStepResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
