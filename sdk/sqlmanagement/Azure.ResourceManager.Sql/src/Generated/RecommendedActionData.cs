...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class RecommendedActionData : Resource
    {
        ...
        /// <param name="executeActionStartTime"> Gets the time when system started applying this recommended action on the user resource. e.g., index creation start time. </param>
        ...
        /// <param name="revertActionStartTime"> Gets the time when system started reverting changes of this recommended action on user resource. e.g., time when index drop is executed. </param>
        ...
        /// <param name="executeActionInitiatedTime"> Gets the time when this recommended action was approved for execution. </param>
        /// <param name="revertActionInitiatedBy"> Gets if approval for reverting this recommended action was given by user/system. </param>
        /// <param name="revertActionInitiatedTime"> Gets the time when this recommended action was approved for revert. </param>
        ...
        public DateTimeOffset? ExecuteActionInitiatedTime { get; }
        ...
        public DateTimeOffset? RevertActionInitiatedTime { get; }
