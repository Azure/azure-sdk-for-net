...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class ElasticPoolsFailoverOperation : Operation<Response>, IOperationSource<Response>
    {
        private readonly ArmOperationHelpers<Response> _operation;

        /// <summary> Initializes a new instance of ElasticPoolsFailoverOperation for mocking. </summary>
        protected ElasticPoolsFailoverOperation()
        {
        }

        internal ElasticPoolsFailoverOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<Response>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "ElasticPoolsFailoverOperation");
        }
        /// <inheritdoc />
