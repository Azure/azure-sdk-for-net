...
namespace Azure.ResourceManager.Sql
{
...

    {
        ...
        public virtual ManagedDatabaseCreateOrUpdateOperation CreateOrUpdate(string databaseName, ManagedDatabaseData parameters, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _managedDatabasesRestClient.CreateOrUpdate(Id.ResourceGroupName, Id.Name, databaseName, parameters, cancellationToken);
                var operation = new ManagedDatabaseCreateOrUpdateOperation(Parent, _clientDiagnostics, Pipeline, _managedDatabasesRestClient.CreateCreateOrUpdateRequest(Id.ResourceGroupName, Id.Name, databaseName, parameters).Request, response);
        ...
        public async virtual Task<ManagedDatabaseCreateOrUpdateOperation> CreateOrUpdateAsync(string databaseName, ManagedDatabaseData parameters, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _managedDatabasesRestClient.CreateOrUpdateAsync(Id.ResourceGroupName, Id.Name, databaseName, parameters, cancellationToken).ConfigureAwait(false);
                var operation = new ManagedDatabaseCreateOrUpdateOperation(Parent, _clientDiagnostics, Pipeline, _managedDatabasesRestClient.CreateCreateOrUpdateRequest(Id.ResourceGroupName, Id.Name, databaseName, parameters).Request, response);
                if (waitForCompletion)
        ...
        public virtual Response<ManagedDatabase> Get(string databaseName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _managedDatabasesRestClient.Get(Id.ResourceGroupName, Id.Name, databaseName, cancellationToken);
        ...
        public async virtual Task<Response<ManagedDatabase>> GetAsync(string databaseName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _managedDatabasesRestClient.GetAsync(Id.ResourceGroupName, Id.Name, databaseName, cancellationToken).ConfigureAwait(false);
                if (response.Value == null)
        ...
        public virtual Response<ManagedDatabase> GetIfExists(string databaseName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _managedDatabasesRestClient.Get(Id.ResourceGroupName, Id.Name, databaseName, cancellationToken: cancellationToken);
        ...
        public async virtual Task<Response<ManagedDatabase>> GetIfExistsAsync(string databaseName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _managedDatabasesRestClient.GetAsync(Id.ResourceGroupName, Id.Name, databaseName, cancellationToken: cancellationToken).ConfigureAwait(false);
                return response.Value == null
                    ? Response.FromValue<ManagedDatabase>(null, response.GetRawResponse())
                    : Response.FromValue(new ManagedDatabase(this, response.Value), response.GetRawResponse());
            }
        ...
        public virtual Pageable<ManagedDatabase> GetAll(CancellationToken cancellationToken = default)
        {
            Page<ManagedDatabase> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _managedDatabasesRestClient.ListByInstance(Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken);
            ...
            Page<ManagedDatabase> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _managedDatabasesRestClient.ListByInstanceNextPage(nextLink, Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new ManagedDatabase(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual AsyncPageable<ManagedDatabase> GetAllAsync(CancellationToken cancellationToken = default)
        {
            async Task<Page<ManagedDatabase>> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _managedDatabasesRestClient.ListByInstanceAsync(Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new ManagedDatabase(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            async Task<Page<ManagedDatabase>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _managedDatabasesRestClient.ListByInstanceNextPageAsync(nextLink, Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new ManagedDatabase(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
