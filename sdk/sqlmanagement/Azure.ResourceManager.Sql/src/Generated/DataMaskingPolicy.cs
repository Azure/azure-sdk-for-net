...
namespace SqlManagementClient
{
    ...
    public partial class DataMaskingPolicy : ArmResource
    {
        ...
        internal DataMaskingPolicy(ArmResource options, DataMaskingPolicyData resource) : base(options, resource.Id)
        {
            ...
            _dataMaskingRulesRestClient = new DataMaskingRulesRestOperations(_clientDiagnostics, Pipeline, ClientOptions, Id.SubscriptionId, BaseUri);
        }
        ...
        public async virtual Task<Response<DataMaskingPolicy>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _dataMaskingPoliciesRestClient.GetAsync(Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<DataMaskingPolicy> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _dataMaskingPoliciesRestClient.Get(Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, cancellationToken);
                if (response.Value == null)
        ...
        public async virtual Task<Response<DataMaskingRule>> CreateOrUpdateDataMaskingRuleAsync(string dataMaskingRuleName, DataMaskingRule parameters, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _dataMaskingRulesRestClient.CreateOrUpdateAsync(Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, dataMaskingRuleName, parameters, cancellationToken).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
            {
        ...
        public virtual Response<DataMaskingRule> CreateOrUpdateDataMaskingRule(string dataMaskingRuleName, DataMaskingRule parameters, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _dataMaskingRulesRestClient.CreateOrUpdate(Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, dataMaskingRuleName, parameters, cancellationToken);
                return response;
            }
            catch (Exception e)
            {
