    ...
    public partial class DataMaskingPolicy : ArmResource
    {
        ...
        public virtual AsyncPageable<DataMaskingRule> GetDataMaskingRulesByDatabaseAsync(CancellationToken cancellationToken = default)
        {
            async Task<Page<DataMaskingRule>> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _dataMaskingRulesRestClient.ListByDatabaseAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        public virtual Pageable<DataMaskingRule> GetDataMaskingRulesByDatabase(CancellationToken cancellationToken = default)
        {
            Page<DataMaskingRule> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _dataMaskingRulesRestClient.ListByDatabase(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value, null, response.GetRawResponse());
                }
                catch (Exception e)
                {
