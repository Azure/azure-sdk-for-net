...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class ManagedInstanceStartStopScheduleResource : ArmResource
    {
        ...
        internal ManagedInstanceStartStopScheduleResource(ArmClient client, ManagedInstanceStartStopScheduleData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<ManagedInstanceStartStopScheduleResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new ManagedInstanceStartStopScheduleResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual async Task<ArmOperation<ManagedInstanceStartStopScheduleResource>> UpdateAsync(WaitUntil waitUntil, ManagedInstanceStartStopScheduleData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new SqlArmOperation<ManagedInstanceStartStopScheduleResource>(Response.FromValue(new ManagedInstanceStartStopScheduleResource(Client, response.Value, response.Value.Id), response.GetRawResponse()));
                if (waitUntil == WaitUntil.Completed)
