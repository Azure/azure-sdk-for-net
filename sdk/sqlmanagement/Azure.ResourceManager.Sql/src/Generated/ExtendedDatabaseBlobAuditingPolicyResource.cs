    ...
    public partial class ExtendedDatabaseBlobAuditingPolicyResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<ExtendedDatabaseBlobAuditingPolicyResource>> UpdateAsync(WaitUntil waitUntil, ExtendedDatabaseBlobAuditingPolicyData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var uri = _extendedDatabaseBlobAuditingPolicyRestClient.CreateCreateOrUpdateRequestUri(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, data);
                var rehydrationToken = NextLinkOperationImplementation.GetRehydrationToken(RequestMethod.Put, uri.ToUri(), uri.ToString(), "None", null, OperationFinalStateVia.OriginalUri.ToString());
                var operation = new SqlArmOperation<ExtendedDatabaseBlobAuditingPolicyResource>(Response.FromValue(new ExtendedDatabaseBlobAuditingPolicyResource(Client, response), response.GetRawResponse()), rehydrationToken);
