...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class SqlServerCollection : ArmCollection, IEnumerable<SqlServerResource>, IAsyncEnumerable<SqlServerResource>
    {
        ...
        internal SqlServerCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _replicationLinksClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Sql", SqlServerResource.ResourceType.Namespace, Diagnostics);
            ...
            _databasesClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Sql", SqlServerResource.ResourceType.Namespace, Diagnostics);
            _databasesRestClient = new Databases(_databasesClientDiagnostics, Pipeline, Endpoint, sqlServerApiVersion ?? "2025-02-01-preview");
            _tdeCertificatesClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Sql", SqlServerResource.ResourceType.Namespace, Diagnostics);
            ...
            _firewallRulesClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Sql", SqlServerResource.ResourceType.Namespace, Diagnostics);
            _firewallRulesRestClient = new FirewallRules(_firewallRulesClientDiagnostics, Pipeline, Endpoint, sqlServerApiVersion ?? "2025-02-01-preview");
            _serverOperationsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Sql", SqlServerResource.ResourceType.Namespace, Diagnostics);
            ...
            _serverUsagesClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Sql", SqlServerResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<SqlServerResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string serverName, SqlServerData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                SqlArmOperation<SqlServerResource> operation = new SqlArmOperation<SqlServerResource>(
                    new SqlServerOperationSource(Client),
