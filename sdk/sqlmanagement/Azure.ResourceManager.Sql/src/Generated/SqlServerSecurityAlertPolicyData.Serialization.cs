...
namespace Azure.ResourceManager.Sql
{
    public partial class SqlServerSecurityAlertPolicyData : IUtf8JsonSerializable, IJsonModel<SqlServerSecurityAlertPolicyData>
    {
        ...
        void IJsonModel<SqlServerSecurityAlertPolicyData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SqlServerSecurityAlertPolicyData)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<SqlServerSecurityAlertPolicyData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SqlServerSecurityAlertPolicyData)} does not support '{options.Format}' format.");
            }
        }
