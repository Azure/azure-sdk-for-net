...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class ManagedServerDnsAliasData : ResourceData
    {
        ...
        internal ManagedServerDnsAliasData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string azureDnsRecord) : base(id, name, resourceType, systemData)
        {
