...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class SyncGroupsUpdateOperation : Operation<SyncGroup>, IOperationSource<SyncGroup>
    {
        private readonly ArmOperationHelpers<SyncGroup> _operation;

        /// <summary> Initializes a new instance of SyncGroupsUpdateOperation for mocking. </summary>
        protected SyncGroupsUpdateOperation()
        {
        }

        internal SyncGroupsUpdateOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<SyncGroup>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "SyncGroupsUpdateOperation");
        }
        /// <inheritdoc />
