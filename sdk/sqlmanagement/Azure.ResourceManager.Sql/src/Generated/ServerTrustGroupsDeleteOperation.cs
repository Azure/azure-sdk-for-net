...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class ServerTrustGroupsDeleteOperation : Operation<Response>, IOperationSource<Response>
    {
        private readonly ArmOperationHelpers<Response> _operation;

        /// <summary> Initializes a new instance of ServerTrustGroupsDeleteOperation for mocking. </summary>
        protected ServerTrustGroupsDeleteOperation()
        {
        }

        internal ServerTrustGroupsDeleteOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<Response>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "ServerTrustGroupsDeleteOperation");
        }
        /// <inheritdoc />
