...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class FailoverGroupCollection : ArmCollection, IEnumerable<FailoverGroup>, IAsyncEnumerable<FailoverGroup>
    {
        ...
        /// <exception cref="ArgumentException"> <paramref name="failoverGroupName"/> is null or empty. </exception>
        ...
        public virtual FailoverGroupCreateOrUpdateOperation CreateOrUpdate(bool waitForCompletion, string failoverGroupName, FailoverGroupData parameters, CancellationToken cancellationToken = default)
        {
            ...
            {
                throw new ArgumentException($"Parameter {nameof(failoverGroupName)} cannot be null or empty", nameof(failoverGroupName));
            }
            if (parameters == null)
            {
            ...
            try
            {
                ...
                var operation = new FailoverGroupCreateOrUpdateOperation(this, _clientDiagnostics, Pipeline, _failoverGroupsRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, failoverGroupName, parameters).Request, response);
        ...
        public virtual Pageable<FailoverGroup> GetAll(CancellationToken cancellationToken = default)
        {
            Page<FailoverGroup> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    ...
                    return Page.FromValues(response.Value.Value.Select(value => new FailoverGroup(this, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
                    scope.Failed(e);
