...
namespace SqlManagementClient
{
    ...
    public partial class EncryptionProtector : ArmResource
    {
        ...
        public async virtual Task<Response<EncryptionProtector>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _encryptionProtectorsRestClient.GetAsync(Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<EncryptionProtector> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _encryptionProtectorsRestClient.Get(Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                if (response.Value == null)
        ...
        public async virtual Task<EncryptionProtectorRevalidateOperation> RevalidateAsync(bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _encryptionProtectorsRestClient.RevalidateAsync(Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
                var operation = new EncryptionProtectorRevalidateOperation(_clientDiagnostics, Pipeline, _encryptionProtectorsRestClient.CreateRevalidateRequest(Id.ResourceGroupName, Id.Parent.Name, Id.Name).Request, response);
        ...
        public virtual EncryptionProtectorRevalidateOperation Revalidate(bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _encryptionProtectorsRestClient.Revalidate(Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                var operation = new EncryptionProtectorRevalidateOperation(_clientDiagnostics, Pipeline, _encryptionProtectorsRestClient.CreateRevalidateRequest(Id.ResourceGroupName, Id.Parent.Name, Id.Name).Request, response);
                if (waitForCompletion)
