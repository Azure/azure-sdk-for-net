...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class VirtualNetworkRule : ArmResource
    {
        ...
        internal VirtualNetworkRule(ArmClient armClient, VirtualNetworkRuleData data) : this(armClient, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal VirtualNetworkRule(ArmClient armClient, ResourceIdentifier id) : base(armClient, id)
        {
            ...
            ArmClient.TryGetApiVersion(ResourceType, out string virtualNetworkRuleApiVersion);
        ...
        public async virtual Task<Response<VirtualNetworkRule>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new VirtualNetworkRule(ArmClient, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        {
            using var scope = _virtualNetworkRuleClientDiagnostics.CreateScope("VirtualNetworkRule.GetAvailableLocations");
            scope.Start();
            try
            {
        ...
        public async virtual Task<VirtualNetworkRuleDeleteOperation> DeleteAsync(bool waitForCompletion, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new VirtualNetworkRuleDeleteOperation(_virtualNetworkRuleClientDiagnostics, Pipeline, _virtualNetworkRuleRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name).Request, response);
