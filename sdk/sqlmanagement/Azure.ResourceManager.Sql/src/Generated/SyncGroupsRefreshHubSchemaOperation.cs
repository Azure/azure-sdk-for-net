...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class SyncGroupsRefreshHubSchemaOperation : Operation<Response>, IOperationSource<Response>
    {
        private readonly ArmOperationHelpers<Response> _operation;

        /// <summary> Initializes a new instance of SyncGroupsRefreshHubSchemaOperation for mocking. </summary>
        protected SyncGroupsRefreshHubSchemaOperation()
        {
        }

        internal SyncGroupsRefreshHubSchemaOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<Response>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "SyncGroupsRefreshHubSchemaOperation");
        }
        /// <inheritdoc />
