...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class SqlServerDnsAliasData : ResourceData
    {
        ...
        internal SqlServerDnsAliasData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string azureDnsRecord, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
