...
namespace Azure.ResourceManager.Sql
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ManagedInstanceAdvancedThreatProtectionData>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static ManagedInstanceAdvancedThreatProtectionData DeserializeManagedInstanceAdvancedThreatProtectionData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new ManagedInstanceAdvancedThreatProtectionData(id, name, type, systemData.Value, Optional.ToNullable(state), Optional.ToNullable(creationTime), serializedAdditionalRawData);
        }
