...
{
    /// <summary>
    /// A Class representing a ServerAutomaticTuning along with the instance operations that can be performed on it.
    /// If you have a <see cref="ResourceIdentifier" /> you can construct a <see cref="ServerAutomaticTuningResource" />
    /// from an instance of <see cref="ArmClient" /> using the GetServerAutomaticTuningResource method.
    /// Otherwise you can get one from its parent resource <see cref="SqlServerResource" /> using the GetServerAutomaticTuning method.
    /// </summary>
    public partial class ServerAutomaticTuningResource : ArmResource
    {
        /// <summary> Generate the resource identifier of a <see cref="ServerAutomaticTuningResource"/> instance. </summary>
        ...
        /// <summary> Initializes a new instance of the <see cref="ServerAutomaticTuningResource"/> class for mocking. </summary>
        protected ServerAutomaticTuningResource()
        {
        }

        /// <summary> Initializes a new instance of the <see cref = "ServerAutomaticTuningResource"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="data"> The resource that is the target of operations. </param>
        internal ServerAutomaticTuningResource(ArmClient client, ServerAutomaticTuningData data) : this(client, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal ServerAutomaticTuningResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        ...
        public virtual async Task<Response<ServerAutomaticTuningResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            using var scope = _serverAutomaticTuningClientDiagnostics.CreateScope("ServerAutomaticTuningResource.Get");
            scope.Start();
            try
            {
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<ServerAutomaticTuningResource> Get(CancellationToken cancellationToken = default)
        {
            using var scope = _serverAutomaticTuningClientDiagnostics.CreateScope("ServerAutomaticTuningResource.Get");
            scope.Start();
            try
