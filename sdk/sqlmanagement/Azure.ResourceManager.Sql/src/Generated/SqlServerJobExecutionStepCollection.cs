...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class SqlServerJobExecutionStepCollection : ArmCollection, IEnumerable<SqlServerJobExecutionStepResource>, IAsyncEnumerable<SqlServerJobExecutionStepResource>
    {
        ...
        public virtual async Task<Response<SqlServerJobExecutionStepResource>> GetAsync(string stepName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _jobStepExecutionsClientDiagnostics.CreateScope("SqlServerJobExecutionStepCollection.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _jobStepExecutionsRestClient.CreateGetRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Guid.Parse(Id.Name), stepName, context);
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string stepName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _jobStepExecutionsClientDiagnostics.CreateScope("SqlServerJobExecutionStepCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual async Task<NullableResponse<SqlServerJobExecutionStepResource>> GetIfExistsAsync(string stepName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _jobStepExecutionsClientDiagnostics.CreateScope("SqlServerJobExecutionStepCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
