...
namespace Azure.ResourceManager.Sql
{
...

    {
        ...
        public virtual Response<ManagedInstancePrivateLink> Get(string groupName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _managedInstancePrivateLinkResourcesRestClient.Get(Id.ResourceGroupName, Id.Name, groupName, cancellationToken);
        ...
        public async virtual Task<Response<ManagedInstancePrivateLink>> GetAsync(string groupName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _managedInstancePrivateLinkResourcesRestClient.GetAsync(Id.ResourceGroupName, Id.Name, groupName, cancellationToken).ConfigureAwait(false);
                if (response.Value == null)
        ...
        public virtual Response<ManagedInstancePrivateLink> GetIfExists(string groupName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _managedInstancePrivateLinkResourcesRestClient.Get(Id.ResourceGroupName, Id.Name, groupName, cancellationToken: cancellationToken);
        ...
        public async virtual Task<Response<ManagedInstancePrivateLink>> GetIfExistsAsync(string groupName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _managedInstancePrivateLinkResourcesRestClient.GetAsync(Id.ResourceGroupName, Id.Name, groupName, cancellationToken: cancellationToken).ConfigureAwait(false);
                return response.Value == null
                    ? Response.FromValue<ManagedInstancePrivateLink>(null, response.GetRawResponse())
                    : Response.FromValue(new ManagedInstancePrivateLink(this, response.Value), response.GetRawResponse());
            }
        ...
        public virtual Pageable<ManagedInstancePrivateLink> GetAll(CancellationToken cancellationToken = default)
        {
            Page<ManagedInstancePrivateLink> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _managedInstancePrivateLinkResourcesRestClient.ListByManagedInstance(Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken);
            ...
            Page<ManagedInstancePrivateLink> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _managedInstancePrivateLinkResourcesRestClient.ListByManagedInstanceNextPage(nextLink, Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new ManagedInstancePrivateLink(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual AsyncPageable<ManagedInstancePrivateLink> GetAllAsync(CancellationToken cancellationToken = default)
        {
            async Task<Page<ManagedInstancePrivateLink>> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _managedInstancePrivateLinkResourcesRestClient.ListByManagedInstanceAsync(Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new ManagedInstancePrivateLink(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            async Task<Page<ManagedInstancePrivateLink>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _managedInstancePrivateLinkResourcesRestClient.ListByManagedInstanceNextPageAsync(nextLink, Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new ManagedInstancePrivateLink(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
