...
namespace SqlManagementClient
{
...

    {
        ...
        internal ExtendedServerBlobAuditingPolicyCollection(ArmResource parent) : base(parent)
        {
            ...
            _extendedServerBlobAuditingPoliciesRestClient = new ExtendedServerBlobAuditingPoliciesRestOperations(_clientDiagnostics, Pipeline, ClientOptions, Id.SubscriptionId, BaseUri);
        }
        ...
        public virtual ExtendedServerBlobAuditingPolicyCreateOrUpdateOperation CreateOrUpdate(Enum5 blobAuditingPolicyName, ExtendedServerBlobAuditingPolicyData parameters, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            if (parameters == null)
            {
            ...
            try
            {
                var response = _extendedServerBlobAuditingPoliciesRestClient.CreateOrUpdate(Id.ResourceGroupName, Id.Name, blobAuditingPolicyName, parameters, cancellationToken);
                var operation = new ExtendedServerBlobAuditingPolicyCreateOrUpdateOperation(Parent, _clientDiagnostics, Pipeline, _extendedServerBlobAuditingPoliciesRestClient.CreateCreateOrUpdateRequest(Id.ResourceGroupName, Id.Name, blobAuditingPolicyName, parameters).Request, response);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="parameters"/> is null. </exception>
        public async virtual Task<ExtendedServerBlobAuditingPolicyCreateOrUpdateOperation> CreateOrUpdateAsync(Enum5 blobAuditingPolicyName, ExtendedServerBlobAuditingPolicyData parameters, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            if (parameters == null)
            {
                throw new ArgumentNullException(nameof(parameters));
            ...
            try
            {
                var response = await _extendedServerBlobAuditingPoliciesRestClient.CreateOrUpdateAsync(Id.ResourceGroupName, Id.Name, blobAuditingPolicyName, parameters, cancellationToken).ConfigureAwait(false);
                var operation = new ExtendedServerBlobAuditingPolicyCreateOrUpdateOperation(Parent, _clientDiagnostics, Pipeline, _extendedServerBlobAuditingPoliciesRestClient.CreateCreateOrUpdateRequest(Id.ResourceGroupName, Id.Name, blobAuditingPolicyName, parameters).Request, response);
                if (waitForCompletion)
        ...
        /// <param name="blobAuditingPolicyName"> The name of the blob auditing policy. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<ExtendedServerBlobAuditingPolicy> Get(Enum5 blobAuditingPolicyName, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("ExtendedServerBlobAuditingPolicyCollection.Get");
            scope.Start();
            try
            {
                var response = _extendedServerBlobAuditingPoliciesRestClient.Get(Id.ResourceGroupName, Id.Name, blobAuditingPolicyName, cancellationToken);
        ...
        /// <param name="blobAuditingPolicyName"> The name of the blob auditing policy. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async virtual Task<Response<ExtendedServerBlobAuditingPolicy>> GetAsync(Enum5 blobAuditingPolicyName, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("ExtendedServerBlobAuditingPolicyCollection.Get");
            scope.Start();
            try
            {
                var response = await _extendedServerBlobAuditingPoliciesRestClient.GetAsync(Id.ResourceGroupName, Id.Name, blobAuditingPolicyName, cancellationToken).ConfigureAwait(false);
                if (response.Value == null)
        ...
        /// <param name="blobAuditingPolicyName"> The name of the blob auditing policy. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<ExtendedServerBlobAuditingPolicy> GetIfExists(Enum5 blobAuditingPolicyName, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("ExtendedServerBlobAuditingPolicyCollection.GetIfExists");
            scope.Start();
            try
            {
                var response = _extendedServerBlobAuditingPoliciesRestClient.Get(Id.ResourceGroupName, Id.Name, blobAuditingPolicyName, cancellationToken: cancellationToken);
        ...
        /// <param name="blobAuditingPolicyName"> The name of the blob auditing policy. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async virtual Task<Response<ExtendedServerBlobAuditingPolicy>> GetIfExistsAsync(Enum5 blobAuditingPolicyName, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("ExtendedServerBlobAuditingPolicyCollection.GetIfExistsAsync");
            scope.Start();
            try
            {
                var response = await _extendedServerBlobAuditingPoliciesRestClient.GetAsync(Id.ResourceGroupName, Id.Name, blobAuditingPolicyName, cancellationToken: cancellationToken).ConfigureAwait(false);
                return response.Value == null
                    ? Response.FromValue<ExtendedServerBlobAuditingPolicy>(null, response.GetRawResponse())
                    : Response.FromValue(new ExtendedServerBlobAuditingPolicy(this, response.Value), response.GetRawResponse());
            }
        ...
        public virtual Pageable<ExtendedServerBlobAuditingPolicy> GetAll(CancellationToken cancellationToken = default)
        {
            Page<ExtendedServerBlobAuditingPolicy> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _extendedServerBlobAuditingPoliciesRestClient.ListByServer(Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken);
            ...
            Page<ExtendedServerBlobAuditingPolicy> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _extendedServerBlobAuditingPoliciesRestClient.ListByServerNextPage(nextLink, Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new ExtendedServerBlobAuditingPolicy(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual AsyncPageable<ExtendedServerBlobAuditingPolicy> GetAllAsync(CancellationToken cancellationToken = default)
        {
            async Task<Page<ExtendedServerBlobAuditingPolicy>> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _extendedServerBlobAuditingPoliciesRestClient.ListByServerAsync(Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new ExtendedServerBlobAuditingPolicy(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            async Task<Page<ExtendedServerBlobAuditingPolicy>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _extendedServerBlobAuditingPoliciesRestClient.ListByServerNextPageAsync(nextLink, Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new ExtendedServerBlobAuditingPolicy(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
