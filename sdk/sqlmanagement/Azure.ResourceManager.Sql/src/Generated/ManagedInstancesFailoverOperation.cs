...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class ManagedInstancesFailoverOperation : Operation<Response>, IOperationSource<Response>
    {
        private readonly ArmOperationHelpers<Response> _operation;

        /// <summary> Initializes a new instance of ManagedInstancesFailoverOperation for mocking. </summary>
        protected ManagedInstancesFailoverOperation()
        {
        }

        internal ManagedInstancesFailoverOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<Response>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "ManagedInstancesFailoverOperation");
        }
        /// <inheritdoc />
