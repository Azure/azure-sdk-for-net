...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class OutboundFirewallRulesDeleteOperation : Operation<Response>, IOperationSource<Response>
    {
        private readonly ArmOperationHelpers<Response> _operation;

        /// <summary> Initializes a new instance of OutboundFirewallRulesDeleteOperation for mocking. </summary>
        protected OutboundFirewallRulesDeleteOperation()
        {
        }

        internal OutboundFirewallRulesDeleteOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<Response>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "OutboundFirewallRulesDeleteOperation");
        }
        /// <inheritdoc />
