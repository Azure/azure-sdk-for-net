...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class SyncMembersDeleteOperation : Operation<Response>, IOperationSource<Response>
    {
        private readonly ArmOperationHelpers<Response> _operation;

        /// <summary> Initializes a new instance of SyncMembersDeleteOperation for mocking. </summary>
        protected SyncMembersDeleteOperation()
        {
        }

        internal SyncMembersDeleteOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<Response>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "SyncMembersDeleteOperation");
        }
        /// <inheritdoc />
