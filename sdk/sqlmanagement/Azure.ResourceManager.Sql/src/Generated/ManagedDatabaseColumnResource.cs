...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class ManagedDatabaseColumnResource : ArmResource
    {
        ...
        internal ManagedDatabaseColumnResource(ArmClient client, DatabaseColumnData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<ManagedDatabaseColumnResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new ManagedDatabaseColumnResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
