...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class ManagedInstancePrivateLinkData : ResourceData
    {
        ...
        internal ManagedInstancePrivateLinkData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, ManagedInstancePrivateLinkProperties properties) : base(id, name, resourceType, systemData)
        {
