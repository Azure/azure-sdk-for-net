...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class SqlServerJobVersionData : ResourceData
    {
        ...
        internal SqlServerJobVersionData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
