...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class ManagedInstanceDatabaseSchemaTableResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="ManagedInstanceDatabaseSchemaTableResource"/> class for mocking. </summary>
        protected ManagedInstanceDatabaseSchemaTableResource()
        {
        }

        /// <summary> Initializes a new instance of the <see cref = "ManagedInstanceDatabaseSchemaTableResource"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="data"> The resource that is the target of operations. </param>
        internal ManagedInstanceDatabaseSchemaTableResource(ArmClient client, DatabaseTableData data) : this(client, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal ManagedInstanceDatabaseSchemaTableResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            _managedInstanceDatabaseSchemaTableManagedDatabaseTablesClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Sql", ResourceType.Namespace, Diagnostics);
        ...
        /// <summary> Gets a collection of ManagedInstanceDatabaseSchemaTableColumnResources in the ManagedInstanceDatabaseSchemaTableColumnResource. </summary>
        /// <returns> An object representing collection of ManagedInstanceDatabaseSchemaTableColumnResources and their operations over a ManagedInstanceDatabaseSchemaTableColumnResource. </returns>
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<ManagedInstanceDatabaseSchemaTableResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            using var scope = _managedInstanceDatabaseSchemaTableManagedDatabaseTablesClientDiagnostics.CreateScope("ManagedInstanceDatabaseSchemaTableResource.Get");
            scope.Start();
            try
            {
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<ManagedInstanceDatabaseSchemaTableResource> Get(CancellationToken cancellationToken = default)
        {
            using var scope = _managedInstanceDatabaseSchemaTableManagedDatabaseTablesClientDiagnostics.CreateScope("ManagedInstanceDatabaseSchemaTableResource.Get");
            scope.Start();
            try
