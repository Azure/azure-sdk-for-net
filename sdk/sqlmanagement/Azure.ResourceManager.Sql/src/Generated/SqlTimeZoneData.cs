...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class SqlTimeZoneData : ResourceData
    {
        ...
        internal SqlTimeZoneData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, TimeZoneProperties properties) : base(id, name, resourceType, systemData)
        {
