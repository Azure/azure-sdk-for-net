...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class InstancePoolsDeleteOperation : Operation<Response>, IOperationSource<Response>
    {
        private readonly ArmOperationHelpers<Response> _operation;

        /// <summary> Initializes a new instance of InstancePoolsDeleteOperation for mocking. </summary>
        protected InstancePoolsDeleteOperation()
        {
        }

        internal InstancePoolsDeleteOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<Response>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "InstancePoolsDeleteOperation");
        }
        /// <inheritdoc />
