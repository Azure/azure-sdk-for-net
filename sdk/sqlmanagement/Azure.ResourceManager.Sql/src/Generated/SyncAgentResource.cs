...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class SyncAgentResource : ArmResource
    {
        ...
        internal SyncAgentResource(ArmClient client, SyncAgentData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<SyncAgentResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new SyncAgentResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
