...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class ServerSecurityAlertPolicy : ArmResource
    {
        ...
        internal ServerSecurityAlertPolicy(ArmClient armClient, ServerSecurityAlertPolicyData data) : this(armClient, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal ServerSecurityAlertPolicy(ArmClient armClient, ResourceIdentifier id) : base(armClient, id)
        {
            ...
            ArmClient.TryGetApiVersion(ResourceType, out string serverSecurityAlertPolicyApiVersion);
        ...
        {
            using var scope = _serverSecurityAlertPolicyClientDiagnostics.CreateScope("ServerSecurityAlertPolicy.Get");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _serverSecurityAlertPolicyClientDiagnostics.CreateScope("ServerSecurityAlertPolicy.GetAvailableLocations");
            scope.Start();
            try
            {
