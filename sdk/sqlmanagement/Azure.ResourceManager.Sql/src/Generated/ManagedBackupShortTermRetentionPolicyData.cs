...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class ManagedBackupShortTermRetentionPolicyData : ResourceData
    {
        ...
        internal ManagedBackupShortTermRetentionPolicyData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, int? retentionDays, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
