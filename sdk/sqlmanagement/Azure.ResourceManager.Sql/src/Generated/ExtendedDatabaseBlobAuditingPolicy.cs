...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class ExtendedDatabaseBlobAuditingPolicy : ArmResource
    {
        ...
        internal ExtendedDatabaseBlobAuditingPolicy(ArmClient armClient, ExtendedDatabaseBlobAuditingPolicyData data) : this(armClient, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal ExtendedDatabaseBlobAuditingPolicy(ArmClient armClient, ResourceIdentifier id) : base(armClient, id)
        {
            ...
            ArmClient.TryGetApiVersion(ResourceType, out string extendedDatabaseBlobAuditingPolicyApiVersion);
        ...
        public async virtual Task<Response<ExtendedDatabaseBlobAuditingPolicy>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new ExtendedDatabaseBlobAuditingPolicy(ArmClient, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        {
            using var scope = _extendedDatabaseBlobAuditingPolicyClientDiagnostics.CreateScope("ExtendedDatabaseBlobAuditingPolicy.GetAvailableLocations");
            scope.Start();
            try
            {
