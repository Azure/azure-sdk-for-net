...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class DatabasesDeleteOperation : Operation<Response>, IOperationSource<Response>
    {
        private readonly ArmOperationHelpers<Response> _operation;

        /// <summary> Initializes a new instance of DatabasesDeleteOperation for mocking. </summary>
        protected DatabasesDeleteOperation()
        {
        }

        internal DatabasesDeleteOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<Response>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "DatabasesDeleteOperation");
        }
        /// <inheritdoc />
