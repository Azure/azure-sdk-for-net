...
namespace Azure.ResourceManager.Sql
{
    ...
    {
        /// <summary> Generate the resource identifier of a <see cref="ManagedInstanceDtcResource"/> instance. </summary>
        ...
        /// <summary> Initializes a new instance of the <see cref="ManagedInstanceDtcResource"/> class for mocking. </summary>
        ...
        public virtual async Task<ArmOperation<ManagedInstanceDtcResource>> UpdateAsync(WaitUntil waitUntil, ManagedInstanceDtcData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new SqlArmOperation<ManagedInstanceDtcResource>(new ManagedInstanceDtcOperationSource(Client), _managedInstanceDtcClientDiagnostics, Pipeline, _managedInstanceDtcRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, data).Request, response, OperationFinalStateVia.Location);
