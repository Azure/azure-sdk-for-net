...
{
    /// <summary></summary>
    internal partial class SyncMemberOperationSource : IOperationSource<SyncMemberResource>
    {
        ...
        SyncMemberResource IOperationSource<SyncMemberResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            SyncMemberData data = SyncMemberData.DeserializeSyncMemberData(document.RootElement, ModelSerializationExtensions.WireOptions);
