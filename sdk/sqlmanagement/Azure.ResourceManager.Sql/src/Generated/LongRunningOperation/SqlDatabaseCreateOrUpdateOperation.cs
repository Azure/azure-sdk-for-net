...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    public partial class SqlDatabaseCreateOrUpdateOperation : Operation<SqlDatabase>, IOperationSource<SqlDatabase>
    {
        private readonly OperationInternals<SqlDatabase> _operation;

        private readonly ArmResource _operationBase;

        /// <summary> Initializes a new instance of SqlDatabaseCreateOrUpdateOperation for mocking. </summary>
        protected SqlDatabaseCreateOrUpdateOperation()
        {
        }

        internal SqlDatabaseCreateOrUpdateOperation(ArmResource operationsBase, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<SqlDatabase>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "SqlDatabaseCreateOrUpdateOperation");
