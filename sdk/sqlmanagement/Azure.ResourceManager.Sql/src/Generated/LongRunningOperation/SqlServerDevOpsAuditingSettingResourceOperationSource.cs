...
{
    /// <summary></summary>
    internal partial class SqlServerDevOpsAuditingSettingResourceOperationSource : IOperationSource<SqlServerDevOpsAuditingSettingResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal SqlServerDevOpsAuditingSettingResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
