...
{
    /// <summary></summary>
    internal partial class BackupShortTermRetentionPolicyResourceOperationSource : IOperationSource<BackupShortTermRetentionPolicyResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal BackupShortTermRetentionPolicyResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
