...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    public partial class LongTermRetentionBackupUpdateOperation : Operation<LongTermRetentionBackupOperationResult>, IOperationSource<LongTermRetentionBackupOperationResult>
    {
        private readonly OperationInternals<LongTermRetentionBackupOperationResult> _operation;

        /// <summary> Initializes a new instance of LongTermRetentionBackupUpdateOperation for mocking. </summary>
        protected LongTermRetentionBackupUpdateOperation()
        {
        }

        internal LongTermRetentionBackupUpdateOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<LongTermRetentionBackupOperationResult>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "LongTermRetentionBackupUpdateOperation");
        }
