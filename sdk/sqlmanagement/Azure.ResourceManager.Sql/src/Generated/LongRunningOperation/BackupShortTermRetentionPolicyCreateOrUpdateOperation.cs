...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    public partial class BackupShortTermRetentionPolicyCreateOrUpdateOperation : Operation<BackupShortTermRetentionPolicy>, IOperationSource<BackupShortTermRetentionPolicy>
    {
        private readonly OperationInternals<BackupShortTermRetentionPolicy> _operation;

        private readonly ArmResource _operationBase;

        /// <summary> Initializes a new instance of BackupShortTermRetentionPolicyCreateOrUpdateOperation for mocking. </summary>
        protected BackupShortTermRetentionPolicyCreateOrUpdateOperation()
        {
        }

        internal BackupShortTermRetentionPolicyCreateOrUpdateOperation(ArmResource operationsBase, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<BackupShortTermRetentionPolicy>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "BackupShortTermRetentionPolicyCreateOrUpdateOperation");
