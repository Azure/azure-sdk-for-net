...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    public partial class FailoverGroupUpdateOperation : Operation<FailoverGroup>, IOperationSource<FailoverGroup>
    {
        private readonly OperationInternals<FailoverGroup> _operation;

        private readonly ArmResource _operationBase;

        /// <summary> Initializes a new instance of FailoverGroupUpdateOperation for mocking. </summary>
        protected FailoverGroupUpdateOperation()
        {
        }

        internal FailoverGroupUpdateOperation(ArmResource operationsBase, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<FailoverGroup>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "FailoverGroupUpdateOperation");
