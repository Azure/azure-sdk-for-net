...
{
    /// <summary></summary>
    internal partial class VirtualClusterResourceOperationSource : IOperationSource<VirtualClusterResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal VirtualClusterResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
