...
{
    /// <summary></summary>
    internal partial class SyncMemberResourceOperationSource : IOperationSource<SyncMemberResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal SyncMemberResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
