...
{
    /// <summary></summary>
    internal partial class DeletedServerResourceOperationSource : IOperationSource<DeletedServerResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal DeletedServerResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
        ...
        DeletedServerResource IOperationSource<DeletedServerResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            DeletedServerData data = DeletedServerData.DeserializeDeletedServerData(document.RootElement, ModelSerializationExtensions.WireOptions);
