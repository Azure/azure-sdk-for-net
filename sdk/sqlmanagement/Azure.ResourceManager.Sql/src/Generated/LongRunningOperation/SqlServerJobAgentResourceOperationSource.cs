...
{
    /// <summary></summary>
    internal partial class SqlServerJobAgentResourceOperationSource : IOperationSource<SqlServerJobAgentResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal SqlServerJobAgentResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
        ...
        SqlServerJobAgentResource IOperationSource<SqlServerJobAgentResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            SqlServerJobAgentData data = SqlServerJobAgentData.DeserializeSqlServerJobAgentData(document.RootElement, ModelSerializationExtensions.WireOptions);
