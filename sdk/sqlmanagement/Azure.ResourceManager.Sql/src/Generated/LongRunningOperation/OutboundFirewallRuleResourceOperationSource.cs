...
{
    /// <summary></summary>
    internal partial class OutboundFirewallRuleResourceOperationSource : IOperationSource<OutboundFirewallRuleResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal OutboundFirewallRuleResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
