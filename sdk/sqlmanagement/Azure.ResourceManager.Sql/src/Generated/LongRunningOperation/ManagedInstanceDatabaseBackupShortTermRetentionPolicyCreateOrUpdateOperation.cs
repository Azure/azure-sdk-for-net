...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    public partial class ManagedInstanceDatabaseBackupShortTermRetentionPolicyCreateOrUpdateOperation : Operation<ManagedInstanceDatabaseBackupShortTermRetentionPolicy>, IOperationSource<ManagedInstanceDatabaseBackupShortTermRetentionPolicy>
    {
        private readonly OperationInternals<ManagedInstanceDatabaseBackupShortTermRetentionPolicy> _operation;

        private readonly ArmClient _armClient;

        /// <summary> Initializes a new instance of ManagedInstanceDatabaseBackupShortTermRetentionPolicyCreateOrUpdateOperation for mocking. </summary>
        protected ManagedInstanceDatabaseBackupShortTermRetentionPolicyCreateOrUpdateOperation()
        {
        }

        internal ManagedInstanceDatabaseBackupShortTermRetentionPolicyCreateOrUpdateOperation(ArmClient armClient, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<ManagedInstanceDatabaseBackupShortTermRetentionPolicy>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "ManagedInstanceDatabaseBackupShortTermRetentionPolicyCreateOrUpdateOperation");
