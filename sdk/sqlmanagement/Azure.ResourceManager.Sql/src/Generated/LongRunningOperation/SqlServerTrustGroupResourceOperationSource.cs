...
{
    /// <summary></summary>
    internal partial class SqlServerTrustGroupResourceOperationSource : IOperationSource<SqlServerTrustGroupResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal SqlServerTrustGroupResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
        ...
        SqlServerTrustGroupResource IOperationSource<SqlServerTrustGroupResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            SqlServerTrustGroupData data = SqlServerTrustGroupData.DeserializeSqlServerTrustGroupData(document.RootElement, ModelSerializationExtensions.WireOptions);
