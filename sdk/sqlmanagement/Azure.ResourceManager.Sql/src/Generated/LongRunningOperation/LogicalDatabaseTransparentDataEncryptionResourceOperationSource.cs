...
{
    /// <summary></summary>
    internal partial class LogicalDatabaseTransparentDataEncryptionResourceOperationSource : IOperationSource<LogicalDatabaseTransparentDataEncryptionResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal LogicalDatabaseTransparentDataEncryptionResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
