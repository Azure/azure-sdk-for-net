...
{
    /// <summary></summary>
    internal partial class SqlServerDatabaseRestorePointResourceOperationSource : IOperationSource<SqlServerDatabaseRestorePointResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal SqlServerDatabaseRestorePointResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
