...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    public partial class ResourceGroupLongTermRetentionBackupUpdateByResourceGroupOperation : Operation<LongTermRetentionBackupOperationResult>, IOperationSource<LongTermRetentionBackupOperationResult>
    {
        private readonly OperationInternals<LongTermRetentionBackupOperationResult> _operation;

        /// <summary> Initializes a new instance of ResourceGroupLongTermRetentionBackupUpdateByResourceGroupOperation for mocking. </summary>
        protected ResourceGroupLongTermRetentionBackupUpdateByResourceGroupOperation()
        {
        }

        internal ResourceGroupLongTermRetentionBackupUpdateByResourceGroupOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<LongTermRetentionBackupOperationResult>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "ResourceGroupLongTermRetentionBackupUpdateByResourceGroupOperation");
        }
