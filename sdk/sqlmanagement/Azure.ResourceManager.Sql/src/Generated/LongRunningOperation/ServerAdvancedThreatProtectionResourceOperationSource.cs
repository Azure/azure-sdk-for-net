...
{
    /// <summary></summary>
    internal partial class ServerAdvancedThreatProtectionResourceOperationSource : IOperationSource<ServerAdvancedThreatProtectionResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal ServerAdvancedThreatProtectionResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
