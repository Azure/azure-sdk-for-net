...
{
    /// <summary></summary>
    internal partial class ResourceGroupLongTermRetentionBackupResourceOperationSource : IOperationSource<ResourceGroupLongTermRetentionBackupResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal ResourceGroupLongTermRetentionBackupResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
