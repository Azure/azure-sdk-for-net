...
{
    /// <summary></summary>
    internal partial class SqlServerDatabaseReplicationLinkResourceOperationSource : IOperationSource<SqlServerDatabaseReplicationLinkResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal SqlServerDatabaseReplicationLinkResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
