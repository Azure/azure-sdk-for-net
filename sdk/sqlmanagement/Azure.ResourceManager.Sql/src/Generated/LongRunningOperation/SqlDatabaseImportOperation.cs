...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    public partial class SqlDatabaseImportOperation : Operation<ImportExportOperationResult>, IOperationSource<ImportExportOperationResult>
    {
        private readonly OperationInternals<ImportExportOperationResult> _operation;

        /// <summary> Initializes a new instance of SqlDatabaseImportOperation for mocking. </summary>
        protected SqlDatabaseImportOperation()
        {
        }

        internal SqlDatabaseImportOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<ImportExportOperationResult>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "SqlDatabaseImportOperation");
        }
