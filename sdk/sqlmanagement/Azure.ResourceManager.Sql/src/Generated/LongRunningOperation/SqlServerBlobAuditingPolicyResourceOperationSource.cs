...
{
    /// <summary></summary>
    internal partial class SqlServerBlobAuditingPolicyResourceOperationSource : IOperationSource<SqlServerBlobAuditingPolicyResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal SqlServerBlobAuditingPolicyResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
        ...
        SqlServerBlobAuditingPolicyResource IOperationSource<SqlServerBlobAuditingPolicyResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            SqlServerBlobAuditingPolicyData data = SqlServerBlobAuditingPolicyData.DeserializeSqlServerBlobAuditingPolicyData(document.RootElement, ModelSerializationExtensions.WireOptions);
