...
{
    /// <summary></summary>
    internal partial class ManagedServerDnsAliasResourceOperationSource : IOperationSource<ManagedServerDnsAliasResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal ManagedServerDnsAliasResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
