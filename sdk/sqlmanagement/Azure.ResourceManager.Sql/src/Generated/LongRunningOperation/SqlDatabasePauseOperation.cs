...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    public partial class SqlDatabasePauseOperation : Operation<SqlDatabaseData>, IOperationSource<SqlDatabaseData>
    {
        private readonly OperationInternals<SqlDatabaseData> _operation;

        /// <summary> Initializes a new instance of SqlDatabasePauseOperation for mocking. </summary>
        protected SqlDatabasePauseOperation()
        {
        }

        internal SqlDatabasePauseOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<SqlDatabaseData>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "SqlDatabasePauseOperation");
        }
