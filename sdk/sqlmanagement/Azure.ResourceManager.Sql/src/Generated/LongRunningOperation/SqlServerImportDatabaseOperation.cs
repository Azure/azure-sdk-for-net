...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    public partial class SqlServerImportDatabaseOperation : Operation<ImportExportOperationResult>, IOperationSource<ImportExportOperationResult>
    {
        private readonly OperationInternals<ImportExportOperationResult> _operation;

        /// <summary> Initializes a new instance of SqlServerImportDatabaseOperation for mocking. </summary>
        protected SqlServerImportDatabaseOperation()
        {
        }

        internal SqlServerImportDatabaseOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<ImportExportOperationResult>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "SqlServerImportDatabaseOperation");
        }
