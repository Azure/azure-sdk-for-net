...
{
    /// <summary></summary>
    internal partial class SqlDistributedAvailabilityGroupResourceOperationSource : IOperationSource<SqlDistributedAvailabilityGroupResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal SqlDistributedAvailabilityGroupResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
