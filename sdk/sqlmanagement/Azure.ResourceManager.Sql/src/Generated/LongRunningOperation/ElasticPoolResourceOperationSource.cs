...
{
    /// <summary></summary>
    internal partial class ElasticPoolResourceOperationSource : IOperationSource<ElasticPoolResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal ElasticPoolResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
