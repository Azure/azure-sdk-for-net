...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    public partial class ManagedInstanceKeyCreateOrUpdateOperation : Operation<ManagedInstanceKey>, IOperationSource<ManagedInstanceKey>
    {
        private readonly OperationInternals<ManagedInstanceKey> _operation;

        private readonly ArmClient _armClient;

        /// <summary> Initializes a new instance of ManagedInstanceKeyCreateOrUpdateOperation for mocking. </summary>
        protected ManagedInstanceKeyCreateOrUpdateOperation()
        {
        }

        internal ManagedInstanceKeyCreateOrUpdateOperation(ArmClient armClient, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<ManagedInstanceKey>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "ManagedInstanceKeyCreateOrUpdateOperation");
        ...
        ManagedInstanceKey IOperationSource<ManagedInstanceKey>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            return new ManagedInstanceKey(_armClient, data);
        }
