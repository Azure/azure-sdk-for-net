...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    public partial class SqlDatabaseResumeOperation : Operation<SqlDatabaseData>, IOperationSource<SqlDatabaseData>
    {
        private readonly OperationInternals<SqlDatabaseData> _operation;

        /// <summary> Initializes a new instance of SqlDatabaseResumeOperation for mocking. </summary>
        protected SqlDatabaseResumeOperation()
        {
        }

        internal SqlDatabaseResumeOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<SqlDatabaseData>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "SqlDatabaseResumeOperation");
        }
