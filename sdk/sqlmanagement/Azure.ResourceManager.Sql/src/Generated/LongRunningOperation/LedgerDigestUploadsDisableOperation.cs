...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    public partial class LedgerDigestUploadsDisableOperation : Operation<LedgerDigestUploadsData>, IOperationSource<LedgerDigestUploadsData>
    {
        private readonly OperationInternals<LedgerDigestUploadsData> _operation;

        /// <summary> Initializes a new instance of LedgerDigestUploadsDisableOperation for mocking. </summary>
        protected LedgerDigestUploadsDisableOperation()
        {
        }

        internal LedgerDigestUploadsDisableOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<LedgerDigestUploadsData>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "LedgerDigestUploadsDisableOperation");
        }
