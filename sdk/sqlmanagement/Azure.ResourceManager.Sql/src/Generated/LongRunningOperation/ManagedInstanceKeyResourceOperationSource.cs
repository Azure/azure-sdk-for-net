...
{
    /// <summary></summary>
    internal partial class ManagedInstanceKeyResourceOperationSource : IOperationSource<ManagedInstanceKeyResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal ManagedInstanceKeyResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
