...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    public partial class SubscriptionLongTermRetentionBackupUpdateOperation : Operation<LongTermRetentionBackupOperationResult>, IOperationSource<LongTermRetentionBackupOperationResult>
    {
        private readonly OperationInternals<LongTermRetentionBackupOperationResult> _operation;

        /// <summary> Initializes a new instance of SubscriptionLongTermRetentionBackupUpdateOperation for mocking. </summary>
        protected SubscriptionLongTermRetentionBackupUpdateOperation()
        {
        }

        internal SubscriptionLongTermRetentionBackupUpdateOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<LongTermRetentionBackupOperationResult>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "SubscriptionLongTermRetentionBackupUpdateOperation");
        }
