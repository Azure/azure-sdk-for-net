...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    public partial class SyncGroupUpdateOperation : Operation<SyncGroup>, IOperationSource<SyncGroup>
    {
        ...
        internal SyncGroupUpdateOperation(ArmClient armClient, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
        ...
        SyncGroup IOperationSource<SyncGroup>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            return new SyncGroup(_armClient, data);
        }
