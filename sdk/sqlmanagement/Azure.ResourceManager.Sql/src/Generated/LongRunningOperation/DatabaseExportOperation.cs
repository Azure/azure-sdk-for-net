...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    public partial class DatabaseExportOperation : Operation<ImportExportOperationResult>, IOperationSource<ImportExportOperationResult>
    {
        ...
        /// <summary> Initializes a new instance of DatabaseExportOperation for mocking. </summary>
        protected DatabaseExportOperation()
        {
        }

        internal DatabaseExportOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<ImportExportOperationResult>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "DatabaseExportOperation");
        }
