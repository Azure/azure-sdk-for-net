...
{
    /// <summary></summary>
    internal partial class SqlServerAzureADOnlyAuthenticationResourceOperationSource : IOperationSource<SqlServerAzureADOnlyAuthenticationResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal SqlServerAzureADOnlyAuthenticationResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
