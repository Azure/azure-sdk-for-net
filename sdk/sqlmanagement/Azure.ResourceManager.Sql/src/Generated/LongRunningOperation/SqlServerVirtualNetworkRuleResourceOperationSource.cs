...
{
    /// <summary></summary>
    internal partial class SqlServerVirtualNetworkRuleResourceOperationSource : IOperationSource<SqlServerVirtualNetworkRuleResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal SqlServerVirtualNetworkRuleResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
