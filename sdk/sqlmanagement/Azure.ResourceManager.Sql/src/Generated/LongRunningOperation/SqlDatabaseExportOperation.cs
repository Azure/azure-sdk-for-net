...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    public partial class SqlDatabaseExportOperation : Operation<ImportExportOperationResult>, IOperationSource<ImportExportOperationResult>
    {
        private readonly OperationInternals<ImportExportOperationResult> _operation;

        /// <summary> Initializes a new instance of SqlDatabaseExportOperation for mocking. </summary>
        protected SqlDatabaseExportOperation()
        {
        }

        internal SqlDatabaseExportOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<ImportExportOperationResult>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "SqlDatabaseExportOperation");
        }
