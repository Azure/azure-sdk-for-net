...
{
    /// <summary></summary>
    internal partial class ManagedInstanceEncryptionProtectorResourceOperationSource : IOperationSource<ManagedInstanceEncryptionProtectorResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal ManagedInstanceEncryptionProtectorResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
