...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    public partial class ManagedInstanceUpdateOperation : Operation<ManagedInstance>, IOperationSource<ManagedInstance>
    {
        private readonly OperationInternals<ManagedInstance> _operation;

        private readonly ArmResource _operationBase;

        /// <summary> Initializes a new instance of ManagedInstanceUpdateOperation for mocking. </summary>
        protected ManagedInstanceUpdateOperation()
        {
        }

        internal ManagedInstanceUpdateOperation(ArmResource operationsBase, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<ManagedInstance>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "ManagedInstanceUpdateOperation");
