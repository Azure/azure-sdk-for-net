...
{
    /// <summary></summary>
    internal partial class SqlServerKeyResourceOperationSource : IOperationSource<SqlServerKeyResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal SqlServerKeyResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
