...
{
    /// <summary></summary>
    internal partial class SqlServerResourceOperationSource : IOperationSource<SqlServerResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal SqlServerResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
        ...
        SqlServerResource IOperationSource<SqlServerResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            SqlServerData data = SqlServerData.DeserializeSqlServerData(document.RootElement, ModelSerializationExtensions.WireOptions);
