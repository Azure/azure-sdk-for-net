...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    public partial class SubscriptionLongTermRetentionBackupCopyOperation : Operation<LongTermRetentionBackupOperationResult>, IOperationSource<LongTermRetentionBackupOperationResult>
    {
        private readonly OperationInternals<LongTermRetentionBackupOperationResult> _operation;

        /// <summary> Initializes a new instance of SubscriptionLongTermRetentionBackupCopyOperation for mocking. </summary>
        protected SubscriptionLongTermRetentionBackupCopyOperation()
        {
        }

        internal SubscriptionLongTermRetentionBackupCopyOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<LongTermRetentionBackupOperationResult>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "SubscriptionLongTermRetentionBackupCopyOperation");
        }
