...
{
    /// <summary></summary>
    internal partial class ManagedInstanceAzureADOnlyAuthenticationResourceOperationSource : IOperationSource<ManagedInstanceAzureADOnlyAuthenticationResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal ManagedInstanceAzureADOnlyAuthenticationResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
        ...
        ManagedInstanceAzureADOnlyAuthenticationResource IOperationSource<ManagedInstanceAzureADOnlyAuthenticationResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            ManagedInstanceAzureADOnlyAuthenticationData data = ManagedInstanceAzureADOnlyAuthenticationData.DeserializeManagedInstanceAzureADOnlyAuthenticationData(document.RootElement, ModelSerializationExtensions.WireOptions);
