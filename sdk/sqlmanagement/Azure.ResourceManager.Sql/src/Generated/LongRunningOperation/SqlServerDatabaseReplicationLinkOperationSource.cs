...
{
    /// <summary></summary>
    internal partial class SqlServerDatabaseReplicationLinkOperationSource : IOperationSource<SqlServerDatabaseReplicationLinkResource>
    {
        ...
        SqlServerDatabaseReplicationLinkResource IOperationSource<SqlServerDatabaseReplicationLinkResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            SqlServerDatabaseReplicationLinkData data = SqlServerDatabaseReplicationLinkData.DeserializeSqlServerDatabaseReplicationLinkData(document.RootElement, ModelSerializationExtensions.WireOptions);
