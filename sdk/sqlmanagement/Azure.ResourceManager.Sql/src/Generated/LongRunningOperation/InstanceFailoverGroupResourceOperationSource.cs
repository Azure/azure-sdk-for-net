...
{
    /// <summary></summary>
    internal partial class InstanceFailoverGroupResourceOperationSource : IOperationSource<InstanceFailoverGroupResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal InstanceFailoverGroupResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
