...
{
    /// <summary></summary>
    internal partial class ManagedLedgerDigestUploadResourceOperationSource : IOperationSource<ManagedLedgerDigestUploadResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal ManagedLedgerDigestUploadResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
