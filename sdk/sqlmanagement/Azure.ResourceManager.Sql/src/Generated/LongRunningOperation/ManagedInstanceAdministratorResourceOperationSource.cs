...
{
    /// <summary></summary>
    internal partial class ManagedInstanceAdministratorResourceOperationSource : IOperationSource<ManagedInstanceAdministratorResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal ManagedInstanceAdministratorResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
