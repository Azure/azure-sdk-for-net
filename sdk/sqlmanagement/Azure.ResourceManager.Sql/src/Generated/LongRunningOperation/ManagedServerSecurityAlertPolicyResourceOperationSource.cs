...
{
    /// <summary></summary>
    internal partial class ManagedServerSecurityAlertPolicyResourceOperationSource : IOperationSource<ManagedServerSecurityAlertPolicyResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal ManagedServerSecurityAlertPolicyResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
