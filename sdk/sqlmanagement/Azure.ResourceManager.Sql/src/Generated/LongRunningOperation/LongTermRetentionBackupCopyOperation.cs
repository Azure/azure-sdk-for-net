...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    public partial class LongTermRetentionBackupCopyOperation : Operation<LongTermRetentionBackupOperationResult>, IOperationSource<LongTermRetentionBackupOperationResult>
    {
        private readonly OperationInternals<LongTermRetentionBackupOperationResult> _operation;

        /// <summary> Initializes a new instance of LongTermRetentionBackupCopyOperation for mocking. </summary>
        protected LongTermRetentionBackupCopyOperation()
        {
        }

        internal LongTermRetentionBackupCopyOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<LongTermRetentionBackupOperationResult>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "LongTermRetentionBackupCopyOperation");
        }
