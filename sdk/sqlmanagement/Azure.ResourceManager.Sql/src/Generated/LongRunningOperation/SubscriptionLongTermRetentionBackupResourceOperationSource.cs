...
{
    /// <summary></summary>
    internal partial class SubscriptionLongTermRetentionBackupResourceOperationSource : IOperationSource<SubscriptionLongTermRetentionBackupResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal SubscriptionLongTermRetentionBackupResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
