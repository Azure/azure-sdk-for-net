...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class SyncMembersRefreshMemberSchemaOperation : Operation<Response>, IOperationSource<Response>
    {
        private readonly ArmOperationHelpers<Response> _operation;

        /// <summary> Initializes a new instance of SyncMembersRefreshMemberSchemaOperation for mocking. </summary>
        protected SyncMembersRefreshMemberSchemaOperation()
        {
        }

        internal SyncMembersRefreshMemberSchemaOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<Response>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "SyncMembersRefreshMemberSchemaOperation");
        }
        /// <inheritdoc />
