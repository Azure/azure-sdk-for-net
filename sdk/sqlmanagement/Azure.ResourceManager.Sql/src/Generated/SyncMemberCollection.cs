...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class SyncMemberCollection : ArmCollection, IEnumerable<SyncMember>, IAsyncEnumerable<SyncMember>
    {
        ...
        /// <exception cref="ArgumentException"> <paramref name="syncMemberName"/> is null or empty. </exception>
        ...
        {
            if (string.IsNullOrEmpty(syncMemberName))
            {
                throw new ArgumentException($"Parameter {nameof(syncMemberName)} cannot be null or empty", nameof(syncMemberName));
            }
            if (parameters == null)
            {
