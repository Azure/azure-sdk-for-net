...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class SqlDatabaseTableResource : ArmResource
    {
        ...
        internal SqlDatabaseTableResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _sqlDatabaseTablesClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Sql", ResourceType.Namespace, Diagnostics);
        ...
        {
            using DiagnosticScope scope = _sqlDatabaseTablesClientDiagnostics.CreateScope("SqlDatabaseTableResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _sqlDatabaseTablesRestClient.CreateGetRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, context);
