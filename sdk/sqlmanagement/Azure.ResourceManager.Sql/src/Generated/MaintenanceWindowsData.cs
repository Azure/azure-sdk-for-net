...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class MaintenanceWindowsData : ResourceData
    {
        ...
        internal MaintenanceWindowsData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IList<MaintenanceWindowTimeRange> timeRanges, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData)
        {
