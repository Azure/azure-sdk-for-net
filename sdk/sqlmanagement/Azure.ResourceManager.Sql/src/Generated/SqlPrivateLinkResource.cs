...
namespace Azure.ResourceManager.Sql
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="SqlPrivateLinkResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="SqlServerResource"/> using the GetSqlPrivateLinkResources method.
    /// </summary>
    public partial class SqlPrivateLinkResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of SqlPrivateLinkResource for mocking. </summary>
        protected SqlPrivateLinkResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="SqlPrivateLinkResource"/> class. </summary>
        ...
        {
            TryGetApiVersion(ResourceType, out string sqlPrivateLinkResourceApiVersion);
            _privateLinkResourcesClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Sql", ResourceType.Namespace, Diagnostics);
        ...
        {
            string resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/privateLinkResources/{groupName}";
        ...
        {
            using DiagnosticScope scope = _privateLinkResourcesClientDiagnostics.CreateScope("SqlPrivateLinkResource.Get");
            scope.Start();
            try
            {
