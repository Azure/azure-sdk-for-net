...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class ManagedLedgerDigestUploadData : ResourceData
    {
        ...
        internal ManagedLedgerDigestUploadData(ResourceIdentifier id, string name, ResourceType resourceType, ResourceManager.Models.SystemData systemData, string digestStorageEndpoint, ManagedLedgerDigestUploadsState? state, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
