...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class ManagedLedgerDigestUploadData : ResourceData
    {
        ...
        internal ManagedLedgerDigestUploadData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string digestStorageEndpoint, ManagedLedgerDigestUploadsState? state, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
