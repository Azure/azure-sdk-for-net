...
namespace Azure.ResourceManager.Sql
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="DataWarehouseUserActivityResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    ...
    public partial class DataWarehouseUserActivityResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of DataWarehouseUserActivityResource for mocking. </summary>
        protected DataWarehouseUserActivityResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="DataWarehouseUserActivityResource"/> class. </summary>
        ...
        internal DataWarehouseUserActivityResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _dataWarehouseUserActivitiesRestClient = new DataWarehouseUserActivities(_dataWarehouseUserActivitiesClientDiagnostics, Pipeline, Endpoint, dataWarehouseUserActivityApiVersion ?? "2025-01-01");
        ...
        {
            string resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/databases/{databaseName}/dataWarehouseUserActivities/{dataWarehouseUserActivityName}";
        ...
        {
            using DiagnosticScope scope = _dataWarehouseUserActivitiesClientDiagnostics.CreateScope("DataWarehouseUserActivityResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _dataWarehouseUserActivitiesRestClient.CreateGetRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, context);
