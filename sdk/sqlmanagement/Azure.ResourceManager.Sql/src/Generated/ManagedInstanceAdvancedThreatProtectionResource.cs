...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class ManagedInstanceAdvancedThreatProtectionResource : ArmResource
    {
        ...
        internal ManagedInstanceAdvancedThreatProtectionResource(ArmClient client, ManagedInstanceAdvancedThreatProtectionData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
