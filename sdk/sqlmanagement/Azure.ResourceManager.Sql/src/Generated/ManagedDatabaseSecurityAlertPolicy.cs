...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class ManagedDatabaseSecurityAlertPolicy : ArmResource
    {
        ...
        internal ManagedDatabaseSecurityAlertPolicy(ArmResource options, ManagedDatabaseSecurityAlertPolicyData data) : base(options, data.Id)
        {
            HasData = true;
            _data = data;
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("ManagedDatabaseSecurityAlertPolicy.GetAvailableLocations");
            scope.Start();
            try
            {
