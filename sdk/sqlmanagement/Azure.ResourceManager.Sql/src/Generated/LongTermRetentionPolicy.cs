...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class LongTermRetentionPolicy : ArmResource
    {
        ...
        internal LongTermRetentionPolicy(ArmClient armClient, LongTermRetentionPolicyData data) : this(armClient, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal LongTermRetentionPolicy(ArmClient armClient, ResourceIdentifier id) : base(armClient, id)
        {
            ...
            ArmClient.TryGetApiVersion(ResourceType, out string longTermRetentionPolicyApiVersion);
