...
namespace SqlManagementClient
{
    ...
    public partial class LongTermRetentionPolicy : ArmResource
    {
        ...
        public async virtual Task<Response<LongTermRetentionPolicy>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _longTermRetentionPoliciesRestClient.GetAsync(Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<LongTermRetentionPolicy> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _longTermRetentionPoliciesRestClient.Get(Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken);
                if (response.Value == null)
