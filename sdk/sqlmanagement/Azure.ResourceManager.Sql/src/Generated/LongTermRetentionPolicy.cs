...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class LongTermRetentionPolicy : ArmResource
    {
        ...
        internal LongTermRetentionPolicy(ArmResource options, LongTermRetentionPolicyData data) : base(options, data.Id)
        {
            HasData = true;
            _data = data;
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("LongTermRetentionPolicy.GetAvailableLocations");
            scope.Start();
            try
            {
