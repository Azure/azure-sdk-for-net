...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class LongTermRetentionBackupsUpdateByResourceGroupOperation : Operation<LongTermRetentionBackupOperationResult>, IOperationSource<LongTermRetentionBackupOperationResult>
    {
        private readonly ArmOperationHelpers<LongTermRetentionBackupOperationResult> _operation;

        /// <summary> Initializes a new instance of LongTermRetentionBackupsUpdateByResourceGroupOperation for mocking. </summary>
        protected LongTermRetentionBackupsUpdateByResourceGroupOperation()
        {
        }

        internal LongTermRetentionBackupsUpdateByResourceGroupOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<LongTermRetentionBackupOperationResult>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "LongTermRetentionBackupsUpdateByResourceGroupOperation");
        }
        /// <inheritdoc />
