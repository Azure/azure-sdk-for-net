...
{
    internal partial class UsagesGetByInstancePoolCollectionResultOfT : Pageable<SqlUsage>
    {
        ...
        public override IEnumerable<Page<SqlUsage>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                yield return Page<SqlUsage>.FromValues((IReadOnlyList<SqlUsage>)result.Value, nextPage?.IsAbsoluteUri == true ? nextPage.AbsoluteUri : nextPage?.OriginalString, response);
