...
{
    internal partial class DatabaseColumnsGetDatabaseColumnsAsyncCollectionResultOfT : AsyncPageable<DatabaseColumnData>
    {
        ...
        /// <summary> Initializes a new instance of DatabaseColumnsGetDatabaseColumnsAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public DatabaseColumnsGetDatabaseColumnsAsyncCollectionResultOfT(DatabaseColumns client, Guid subscriptionId, string resourceGroupName, string serverName, string databaseName, IEnumerable<string> schema, IEnumerable<string> table, IEnumerable<string> column, IEnumerable<string> orderBy, string skiptoken, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of DatabaseColumnsGetDatabaseColumnsAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of DatabaseColumnsGetDatabaseColumnsAsyncCollectionResultOfT as an enumerable collection. </returns>
