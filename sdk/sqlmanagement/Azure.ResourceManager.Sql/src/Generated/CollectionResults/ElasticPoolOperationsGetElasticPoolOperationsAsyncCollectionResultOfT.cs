...
{
    internal partial class ElasticPoolOperationsGetElasticPoolOperationsAsyncCollectionResultOfT : AsyncPageable<ElasticPoolOperationData>
    {
        ...
        /// <summary> Initializes a new instance of ElasticPoolOperationsGetElasticPoolOperationsAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public ElasticPoolOperationsGetElasticPoolOperationsAsyncCollectionResultOfT(ElasticPoolOperations client, Guid subscriptionId, string resourceGroupName, string serverName, string elasticPoolName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of ElasticPoolOperationsGetElasticPoolOperationsAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of ElasticPoolOperationsGetElasticPoolOperationsAsyncCollectionResultOfT as an enumerable collection. </returns>
