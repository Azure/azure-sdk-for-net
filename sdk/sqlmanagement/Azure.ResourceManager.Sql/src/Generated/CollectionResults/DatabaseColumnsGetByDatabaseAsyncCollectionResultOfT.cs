...
{
    internal partial class DatabaseColumnsGetByDatabaseAsyncCollectionResultOfT : AsyncPageable<DatabaseColumnData>
    {
        ...
        /// <summary> Initializes a new instance of DatabaseColumnsGetByDatabaseAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        /// <summary> Gets the pages of DatabaseColumnsGetByDatabaseAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of DatabaseColumnsGetByDatabaseAsyncCollectionResultOfT as an enumerable collection. </returns>
        ...
        {
            HttpMessage message = nextLink != null ? _client.CreateNextGetByDatabaseRequest(nextLink, _subscriptionId, _resourceGroupName, _serverName, _databaseName, _schema, _table, _column, _orderBy, _skiptoken, _context) : _client.CreateGetByDatabaseRequest(_subscriptionId, _resourceGroupName, _serverName, _databaseName, _schema, _table, _column, _orderBy, _skiptoken, _context);
