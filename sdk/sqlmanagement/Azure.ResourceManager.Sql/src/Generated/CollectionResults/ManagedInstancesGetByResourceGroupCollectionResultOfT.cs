...
{
    internal partial class ManagedInstancesGetByResourceGroupCollectionResultOfT : Pageable<ManagedInstanceData>
    {
        ...
        /// <summary> Initializes a new instance of ManagedInstancesGetByResourceGroupCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public ManagedInstancesGetByResourceGroupCollectionResultOfT(ManagedInstances client, Guid subscriptionId, string resourceGroupName, string expand, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of ManagedInstancesGetByResourceGroupCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of ManagedInstancesGetByResourceGroupCollectionResultOfT as an enumerable collection. </returns>
