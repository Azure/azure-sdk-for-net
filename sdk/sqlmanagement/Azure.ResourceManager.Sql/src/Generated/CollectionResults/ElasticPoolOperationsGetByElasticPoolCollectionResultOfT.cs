...
{
    internal partial class ElasticPoolOperationsGetByElasticPoolCollectionResultOfT : Pageable<ElasticPoolOperationData>
    {
        ...
        /// <summary> Initializes a new instance of ElasticPoolOperationsGetByElasticPoolCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public ElasticPoolOperationsGetByElasticPoolCollectionResultOfT(ElasticPoolOperations client, Guid subscriptionId, string resourceGroupName, string serverName, string elasticPoolName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of ElasticPoolOperationsGetByElasticPoolCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of ElasticPoolOperationsGetByElasticPoolCollectionResultOfT as an enumerable collection. </returns>
