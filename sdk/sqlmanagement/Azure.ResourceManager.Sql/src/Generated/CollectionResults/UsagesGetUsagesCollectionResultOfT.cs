...
{
    internal partial class UsagesGetUsagesCollectionResultOfT : Pageable<InstancePoolUsage>
    {
        ...
        public UsagesGetUsagesCollectionResultOfT(Usages client, Guid subscriptionId, string resourceGroupName, string instancePoolName, bool? expandChildren, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
