...
{
    internal partial class LongTermRetentionManagedInstanceBackupsGetByResourceGroupDatabaseAsyncCollectionResultOfT : AsyncPageable<ManagedInstanceLongTermRetentionBackupData>
    {
        ...
        /// <summary> Initializes a new instance of LongTermRetentionManagedInstanceBackupsGetByResourceGroupDatabaseAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        /// <summary> Gets the pages of LongTermRetentionManagedInstanceBackupsGetByResourceGroupDatabaseAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of LongTermRetentionManagedInstanceBackupsGetByResourceGroupDatabaseAsyncCollectionResultOfT as an enumerable collection. </returns>
        ...
        {
            HttpMessage message = nextLink != null ? _client.CreateNextGetByResourceGroupDatabaseRequest(nextLink, _subscriptionId, _resourceGroupName, _locationName, _managedInstanceName, _databaseName, _onlyLatestPerDatabase, _databaseState, _context) : _client.CreateGetByResourceGroupDatabaseRequest(_subscriptionId, _resourceGroupName, _locationName, _managedInstanceName, _databaseName, _onlyLatestPerDatabase, _databaseState, _context);
