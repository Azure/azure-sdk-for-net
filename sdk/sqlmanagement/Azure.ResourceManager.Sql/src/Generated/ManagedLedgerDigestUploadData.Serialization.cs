...
namespace Azure.ResourceManager.Sql
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ManagedLedgerDigestUploadData>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            builder.AppendLine(" {");
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(DigestStorageEndpoint), out propertyOverride);
            if (Optional.IsDefined(DigestStorageEndpoint) || hasPropertyOverride)
            {
                ...
                {
                    if (DigestStorageEndpoint.Contains(Environment.NewLine))
                    {
                        builder.AppendLine("'''");
                        builder.AppendLine($"{DigestStorageEndpoint}'''");
                    }
                    else
                    {
                        builder.AppendLine($"'{DigestStorageEndpoint}'");
