...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class WorkloadClassifierCollection : ArmCollection, IEnumerable<WorkloadClassifier>, IAsyncEnumerable<WorkloadClassifier>
    {
        ...
        /// <exception cref="ArgumentException"> <paramref name="workloadClassifierName"/> is null or empty. </exception>
        ...
        {
            if (string.IsNullOrEmpty(workloadClassifierName))
            {
                throw new ArgumentException($"Parameter {nameof(workloadClassifierName)} cannot be null or empty", nameof(workloadClassifierName));
            }
            if (parameters == null)
            {
