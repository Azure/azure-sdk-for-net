...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class ManagedDatabaseAdvancedThreatProtectionResource : ArmResource
    {
        ...
        internal ManagedDatabaseAdvancedThreatProtectionResource(ArmClient client, ManagedDatabaseAdvancedThreatProtectionData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
