...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class ServerBlobAuditingPolicy : ArmResource
    {
        ...
        internal ServerBlobAuditingPolicy(ArmClient armClient, ServerBlobAuditingPolicyData data) : this(armClient, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal ServerBlobAuditingPolicy(ArmClient armClient, ResourceIdentifier id) : base(armClient, id)
        {
            ...
            ArmClient.TryGetApiVersion(ResourceType, out string serverBlobAuditingPolicyApiVersion);
        ...
        {
            using var scope = _serverBlobAuditingPolicyClientDiagnostics.CreateScope("ServerBlobAuditingPolicy.GetAvailableLocations");
            scope.Start();
            try
            {
