...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class ServerBlobAuditingPolicy : ArmResource
    {
        ...
        public async virtual Task<Response<ServerBlobAuditingPolicy>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _serverBlobAuditingPoliciesRestClient.GetAsync(Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<ServerBlobAuditingPolicy> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _serverBlobAuditingPoliciesRestClient.Get(Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                if (response.Value == null)
