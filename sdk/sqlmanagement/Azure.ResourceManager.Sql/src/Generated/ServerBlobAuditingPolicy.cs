...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class ServerBlobAuditingPolicy : ArmResource
    {
        ...
        internal ServerBlobAuditingPolicy(ArmResource options, ServerBlobAuditingPolicyData data) : base(options, data.Id)
        {
            HasData = true;
            _data = data;
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("ServerBlobAuditingPolicy.GetAvailableLocations");
            scope.Start();
            try
            {
