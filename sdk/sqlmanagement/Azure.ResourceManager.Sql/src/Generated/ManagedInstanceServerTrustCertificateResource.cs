...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class ManagedInstanceServerTrustCertificateResource : ArmResource
    {
        ...
        internal ManagedInstanceServerTrustCertificateResource(ArmClient client, ServerTrustCertificateData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<ManagedInstanceServerTrustCertificateResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new ManagedInstanceServerTrustCertificateResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
