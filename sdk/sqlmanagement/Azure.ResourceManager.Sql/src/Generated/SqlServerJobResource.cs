...
namespace Azure.ResourceManager.Sql
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="SqlServerJobResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="SqlServerJobAgentResource"/> using the GetSqlServerJobs method.
    /// </summary>
    public partial class SqlServerJobResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of SqlServerJobResource for mocking. </summary>
        protected SqlServerJobResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="SqlServerJobResource"/> class. </summary>
        ...
        {
            TryGetApiVersion(ResourceType, out string sqlServerJobApiVersion);
            _jobsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Sql", ResourceType.Namespace, Diagnostics);
            ...
            _jobExecutionsRestClient = new JobExecutions(_jobExecutionsClientDiagnostics, Pipeline, Endpoint, sqlServerJobApiVersion ?? "2025-02-01-preview");
        ...
        {
            string resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/jobAgents/{jobAgentName}/jobs/{jobName}";
        ...
        {
            using DiagnosticScope scope = _jobsClientDiagnostics.CreateScope("SqlServerJobResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _jobsRestClient.CreateGetRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, context);
        ...
        {
            using DiagnosticScope scope = _jobsClientDiagnostics.CreateScope("SqlServerJobResource.Delete");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _jobsRestClient.CreateDeleteRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, context);
        ...
        /// <param name="waitUntil"> <see cref="WaitUntil.Completed"/> if the method should wait to return until the long-running operation has completed on the service; <see cref="WaitUntil.Started"/> if it should return after starting the operation. For more information on long-running operations, please see <see href="https://github.com/Azure/azure-sdk-for-net/blob/main/sdk/core/Azure.Core/samples/LongRunningOperations.md"> Azure.Core Long-Running Operation samples</see>. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<ArmOperation<SqlServerJobExecutionData>> CreateAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _jobExecutionsClientDiagnostics.CreateScope("SqlServerJobResource.Create");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _jobExecutionsRestClient.CreateCreateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                SqlArmOperation<SqlServerJobExecutionData> operation = new SqlArmOperation<SqlServerJobExecutionData>(
                    new SqlServerJobExecutionDataOperationSource(),
        ...
        /// <param name="waitUntil"> <see cref="WaitUntil.Completed"/> if the method should wait to return until the long-running operation has completed on the service; <see cref="WaitUntil.Started"/> if it should return after starting the operation. For more information on long-running operations, please see <see href="https://github.com/Azure/azure-sdk-for-net/blob/main/sdk/core/Azure.Core/samples/LongRunningOperations.md"> Azure.Core Long-Running Operation samples</see>. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual ArmOperation<SqlServerJobExecutionData> Create(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _jobExecutionsClientDiagnostics.CreateScope("SqlServerJobResource.Create");
            scope.Start();
            try
        ...
        public virtual async Task<ArmOperation<SqlServerJobResource>> UpdateAsync(WaitUntil waitUntil, SqlServerJobData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _jobsClientDiagnostics.CreateScope("SqlServerJobResource.Update");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _jobsRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, SqlServerJobData.ToRequestContent(data), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<SqlServerJobData> response = Response.FromValue(SqlServerJobData.FromResponse(result), result);
                RequestUriBuilder uri = message.Request.Uri;
        ...
        /// <summary> Gets a collection of SqlServerJobExecutions in the <see cref="SqlServerJobResource"/>. </summary>
        /// <returns> An object representing collection of SqlServerJobExecutions and their operations over a SqlServerJobExecutionResource. </returns>
        ...
        /// <summary> Gets a collection of SqlServerJobSteps in the <see cref="SqlServerJobResource"/>. </summary>
        ...
        /// <summary> Gets a collection of SqlServerJobVersions in the <see cref="SqlServerJobResource"/>. </summary>
        /// <returns> An object representing collection of SqlServerJobVersions and their operations over a SqlServerJobVersionResource. </returns>
