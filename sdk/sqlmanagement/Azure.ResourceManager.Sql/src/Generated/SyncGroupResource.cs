...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class SyncGroupResource : ArmResource
    {
        ...
        internal SyncGroupResource(ArmClient client, SyncGroupData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<SyncGroupResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new SyncGroupResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
