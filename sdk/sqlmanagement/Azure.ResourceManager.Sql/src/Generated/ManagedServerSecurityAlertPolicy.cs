...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class ManagedServerSecurityAlertPolicy : ArmResource
    {
        ...
        internal ManagedServerSecurityAlertPolicy(ArmResource options, ManagedServerSecurityAlertPolicyData resource) : base(options, resource.Id)
        {
            HasData = true;
            _data = resource;
            _clientDiagnostics = new ClientDiagnostics(ClientOptions);
            _managedServerSecurityAlertPoliciesRestClient = new ManagedServerSecurityAlertPoliciesRestOperations(_clientDiagnostics, Pipeline, ClientOptions, Id.SubscriptionId, BaseUri);
        }
        ...
        public async virtual Task<Response<ManagedServerSecurityAlertPolicy>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _managedServerSecurityAlertPoliciesRestClient.GetAsync(Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<ManagedServerSecurityAlertPolicy> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _managedServerSecurityAlertPoliciesRestClient.Get(Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                if (response.Value == null)
