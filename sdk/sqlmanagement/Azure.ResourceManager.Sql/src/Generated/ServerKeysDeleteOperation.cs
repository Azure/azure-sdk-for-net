...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class ServerKeysDeleteOperation : Operation<Response>, IOperationSource<Response>
    {
        private readonly ArmOperationHelpers<Response> _operation;

        /// <summary> Initializes a new instance of ServerKeysDeleteOperation for mocking. </summary>
        protected ServerKeysDeleteOperation()
        {
        }

        internal ServerKeysDeleteOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<Response>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "ServerKeysDeleteOperation");
        }
        /// <inheritdoc />
