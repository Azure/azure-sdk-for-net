...
namespace Azure.ResourceManager.Sql
{
...

    {
        ...
        internal SyncAgentCollection(ArmResource parent) : base(parent)
        {
            ...
            _syncAgentsRestClient = new SyncAgentsRestOperations(_clientDiagnostics, Pipeline, ClientOptions, Id.SubscriptionId, BaseUri);
        }
        ...
        public virtual SyncAgentCreateOrUpdateOperation CreateOrUpdate(string syncAgentName, SyncAgentData parameters, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _syncAgentsRestClient.CreateOrUpdate(Id.ResourceGroupName, Id.Name, syncAgentName, parameters, cancellationToken);
                var operation = new SyncAgentCreateOrUpdateOperation(Parent, _clientDiagnostics, Pipeline, _syncAgentsRestClient.CreateCreateOrUpdateRequest(Id.ResourceGroupName, Id.Name, syncAgentName, parameters).Request, response);
        ...
        public async virtual Task<SyncAgentCreateOrUpdateOperation> CreateOrUpdateAsync(string syncAgentName, SyncAgentData parameters, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _syncAgentsRestClient.CreateOrUpdateAsync(Id.ResourceGroupName, Id.Name, syncAgentName, parameters, cancellationToken).ConfigureAwait(false);
                var operation = new SyncAgentCreateOrUpdateOperation(Parent, _clientDiagnostics, Pipeline, _syncAgentsRestClient.CreateCreateOrUpdateRequest(Id.ResourceGroupName, Id.Name, syncAgentName, parameters).Request, response);
                if (waitForCompletion)
        ...
        public virtual Response<SyncAgent> Get(string syncAgentName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _syncAgentsRestClient.Get(Id.ResourceGroupName, Id.Name, syncAgentName, cancellationToken);
        ...
        public async virtual Task<Response<SyncAgent>> GetAsync(string syncAgentName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _syncAgentsRestClient.GetAsync(Id.ResourceGroupName, Id.Name, syncAgentName, cancellationToken).ConfigureAwait(false);
                if (response.Value == null)
        ...
        public virtual Response<SyncAgent> GetIfExists(string syncAgentName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _syncAgentsRestClient.Get(Id.ResourceGroupName, Id.Name, syncAgentName, cancellationToken: cancellationToken);
        ...
        public async virtual Task<Response<SyncAgent>> GetIfExistsAsync(string syncAgentName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _syncAgentsRestClient.GetAsync(Id.ResourceGroupName, Id.Name, syncAgentName, cancellationToken: cancellationToken).ConfigureAwait(false);
                return response.Value == null
                    ? Response.FromValue<SyncAgent>(null, response.GetRawResponse())
                    : Response.FromValue(new SyncAgent(this, response.Value), response.GetRawResponse());
            }
        ...
        public virtual Pageable<SyncAgent> GetAll(CancellationToken cancellationToken = default)
        {
            Page<SyncAgent> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _syncAgentsRestClient.ListByServer(Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken);
            ...
            Page<SyncAgent> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _syncAgentsRestClient.ListByServerNextPage(nextLink, Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new SyncAgent(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual AsyncPageable<SyncAgent> GetAllAsync(CancellationToken cancellationToken = default)
        {
            async Task<Page<SyncAgent>> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _syncAgentsRestClient.ListByServerAsync(Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new SyncAgent(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            async Task<Page<SyncAgent>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _syncAgentsRestClient.ListByServerNextPageAsync(nextLink, Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new SyncAgent(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
