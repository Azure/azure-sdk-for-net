...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class SqlServerJobExecutionCollection : ArmCollection, IEnumerable<SqlServerJobExecutionResource>, IAsyncEnumerable<SqlServerJobExecutionResource>
    {
        ...
        internal SqlServerJobExecutionCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _jobExecutionsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Sql", SqlServerJobExecutionResource.ResourceType.Namespace, Diagnostics);
            _jobExecutionsRestClient = new JobExecutions(_jobExecutionsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, sqlServerJobExecutionApiVersion ?? "2025-02-01-preview");
        ...
        {
            using DiagnosticScope scope = _jobExecutionsClientDiagnostics.CreateScope("SqlServerJobExecutionCollection.CreateOrUpdate");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _jobExecutionsRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, jobExecutionId, context);
        ...
        {
            using DiagnosticScope scope = _jobExecutionsClientDiagnostics.CreateScope("SqlServerJobExecutionCollection.Get");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _jobExecutionsRestClient.CreateGetRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, jobExecutionId, context);
        ...
        {
            using DiagnosticScope scope = _jobExecutionsClientDiagnostics.CreateScope("SqlServerJobExecutionCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        {
            using DiagnosticScope scope = _jobExecutionsClientDiagnostics.CreateScope("SqlServerJobExecutionCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
