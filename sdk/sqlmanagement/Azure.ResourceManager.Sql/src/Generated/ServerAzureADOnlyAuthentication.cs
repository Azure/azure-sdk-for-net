...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class ServerAzureADOnlyAuthentication : ArmResource
    {
        ...
        internal ServerAzureADOnlyAuthentication(ArmClient client, ServerAzureADOnlyAuthenticationData data) : this(client, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal ServerAzureADOnlyAuthentication(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            Client.TryGetApiVersion(ResourceType, out string serverAzureADOnlyAuthenticationApiVersion);
