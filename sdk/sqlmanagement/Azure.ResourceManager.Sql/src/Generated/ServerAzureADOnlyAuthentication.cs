...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class ServerAzureADOnlyAuthentication : ArmResource
    {
        ...
        internal ServerAzureADOnlyAuthentication(ArmClient armClient, ServerAzureADOnlyAuthenticationData data) : this(armClient, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal ServerAzureADOnlyAuthentication(ArmClient armClient, ResourceIdentifier id) : base(armClient, id)
        {
            ...
            ArmClient.TryGetApiVersion(ResourceType, out string serverAzureADOnlyAuthenticationApiVersion);
        ...
        {
            using var scope = _serverAzureADOnlyAuthenticationClientDiagnostics.CreateScope("ServerAzureADOnlyAuthentication.GetAvailableLocations");
            scope.Start();
            try
            {
        ...
        public async virtual Task<ServerAzureADOnlyAuthenticationDeleteOperation> DeleteAsync(bool waitForCompletion, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new ServerAzureADOnlyAuthenticationDeleteOperation(_serverAzureADOnlyAuthenticationClientDiagnostics, Pipeline, _serverAzureADOnlyAuthenticationRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name).Request, response);
