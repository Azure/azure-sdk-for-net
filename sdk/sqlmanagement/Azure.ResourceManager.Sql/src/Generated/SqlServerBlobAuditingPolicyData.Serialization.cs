...
namespace Azure.ResourceManager.Sql
{
    public partial class SqlServerBlobAuditingPolicyData : IUtf8JsonSerializable, IJsonModel<SqlServerBlobAuditingPolicyData>
    {
        ...
        void IJsonModel<SqlServerBlobAuditingPolicyData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SqlServerBlobAuditingPolicyData)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<SqlServerBlobAuditingPolicyData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SqlServerBlobAuditingPolicyData)} does not support '{options.Format}' format.");
            }
        }
