...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class ServerJobAgentJobExecution : ArmResource
    {
        ...
        internal ServerJobAgentJobExecution(ArmClient armClient, JobExecutionData data) : this(armClient, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal ServerJobAgentJobExecution(ArmClient armClient, ResourceIdentifier id) : base(armClient, id)
        {
            ...
            ArmClient.TryGetApiVersion(ResourceType, out string serverJobAgentJobExecutionJobExecutionsApiVersion);
