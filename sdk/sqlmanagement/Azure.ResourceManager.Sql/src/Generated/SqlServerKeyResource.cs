...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class SqlServerKeyResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                using var message = _sqlServerKeyServerKeysRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name);
                var response = await _sqlServerKeyServerKeysRestClient.DeleteAsync(message, cancellationToken).ConfigureAwait(false);
                var operation = new SqlArmOperation(_sqlServerKeyServerKeysClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
        ...
        public virtual ArmOperation Delete(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var message = _sqlServerKeyServerKeysRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name);
                var response = _sqlServerKeyServerKeysRestClient.Delete(message, cancellationToken);
                var operation = new SqlArmOperation(_sqlServerKeyServerKeysClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<ArmOperation<SqlServerKeyResource>> UpdateAsync(WaitUntil waitUntil, SqlServerKeyData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                using var message = _sqlServerKeyServerKeysRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, data);
                var response = await _sqlServerKeyServerKeysRestClient.CreateOrUpdateAsync(message, cancellationToken).ConfigureAwait(false);
                var operation = new SqlArmOperation<SqlServerKeyResource>(new SqlServerKeyOperationSource(Client), _sqlServerKeyServerKeysClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual ArmOperation<SqlServerKeyResource> Update(WaitUntil waitUntil, SqlServerKeyData data, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var message = _sqlServerKeyServerKeysRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, data);
                var response = _sqlServerKeyServerKeysRestClient.CreateOrUpdate(message, cancellationToken);
                var operation = new SqlArmOperation<SqlServerKeyResource>(new SqlServerKeyOperationSource(Client), _sqlServerKeyServerKeysClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
