...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class SqlServerKeyResource : ArmResource
    {
        ...
        internal SqlServerKeyResource(ArmClient client, SqlServerKeyData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<SqlServerKeyResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new SqlServerKeyResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
