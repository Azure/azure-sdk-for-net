...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class DeletedServerResource : ArmResource
    {
        ...
        internal DeletedServerResource(ArmClient client, DeletedServerData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<DeletedServerResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new DeletedServerResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
