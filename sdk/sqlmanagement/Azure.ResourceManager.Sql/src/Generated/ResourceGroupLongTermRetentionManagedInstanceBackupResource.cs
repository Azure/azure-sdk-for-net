    ...
    public partial class ResourceGroupLongTermRetentionManagedInstanceBackupResource : ManagedInstanceLongTermRetentionBackupResource
    {
        ...
        protected override async Task<Response<ManagedInstanceLongTermRetentionBackupResource>> GetCoreAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue((ManagedInstanceLongTermRetentionBackupResource)new ResourceGroupLongTermRetentionManagedInstanceBackupResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public virtual new async Task<Response<ResourceGroupLongTermRetentionManagedInstanceBackupResource>> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public virtual new Response<ResourceGroupLongTermRetentionManagedInstanceBackupResource> Get(CancellationToken cancellationToken = default)
        {
