...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class ManagedInstanceKey : ArmResource
    {
        ...
        internal ManagedInstanceKey(ArmClient armClient, ManagedInstanceKeyData data) : this(armClient, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal ManagedInstanceKey(ArmClient armClient, ResourceIdentifier id) : base(armClient, id)
        {
            ...
            ArmClient.TryGetApiVersion(ResourceType, out string managedInstanceKeyApiVersion);
        ...
        public async virtual Task<Response<ManagedInstanceKey>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new ManagedInstanceKey(ArmClient, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        {
            using var scope = _managedInstanceKeyClientDiagnostics.CreateScope("ManagedInstanceKey.GetAvailableLocations");
            scope.Start();
            try
            {
