...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class RestorableDroppedManagedDatabase : ArmResource
    {
        ...
        internal RestorableDroppedManagedDatabase(ArmClient armClient, RestorableDroppedManagedDatabaseData data) : this(armClient, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal RestorableDroppedManagedDatabase(ArmClient armClient, ResourceIdentifier id) : base(armClient, id)
        {
            ...
            ArmClient.TryGetApiVersion(ResourceType, out string restorableDroppedManagedDatabaseApiVersion);
        ...
        public async virtual Task<Response<RestorableDroppedManagedDatabase>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new RestorableDroppedManagedDatabase(ArmClient, originalResponse.Value), originalResponse.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
