...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class WorkloadClassifierResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                using var message = _workloadClassifierRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name);
                var response = await _workloadClassifierRestClient.DeleteAsync(message, cancellationToken).ConfigureAwait(false);
                var operation = new SqlArmOperation(_workloadClassifierClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
        ...
        public virtual ArmOperation Delete(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var message = _workloadClassifierRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name);
                var response = _workloadClassifierRestClient.Delete(message, cancellationToken);
                var operation = new SqlArmOperation(_workloadClassifierClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<ArmOperation<WorkloadClassifierResource>> UpdateAsync(WaitUntil waitUntil, WorkloadClassifierData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                using var message = _workloadClassifierRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, data);
