...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class SqlTimeZone : ArmResource
    {
        ...
        internal SqlTimeZone(ArmClient armClient, SqlTimeZoneData data) : this(armClient, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal SqlTimeZone(ArmClient armClient, ResourceIdentifier id) : base(armClient, id)
        {
            ...
            ArmClient.TryGetApiVersion(ResourceType, out string sqlTimeZoneTimeZonesApiVersion);
        ...
        {
            using var scope = _sqlTimeZoneTimeZonesClientDiagnostics.CreateScope("SqlTimeZone.GetAvailableLocations");
            scope.Start();
            try
            {
