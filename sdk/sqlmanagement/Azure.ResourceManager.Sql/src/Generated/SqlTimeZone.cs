...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class SqlTimeZone : ArmResource
    {
        ...
        internal SqlTimeZone(ArmResource options, SqlTimeZoneData data) : base(options, data.Id)
        {
            HasData = true;
            _data = data;
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("SqlTimeZone.GetAvailableLocations");
            scope.Start();
            try
            {
