...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class SqlTimeZone : ArmResource
    {
        ...
        internal SqlTimeZone(ArmResource options, SqlTimeZoneData resource) : base(options, resource.Id)
        {
            ...
            _timeZonesRestClient = new TimeZonesRestOperations(_clientDiagnostics, Pipeline, ClientOptions, Id.SubscriptionId, BaseUri);
        }
        ...
        public async virtual Task<Response<SqlTimeZone>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _timeZonesRestClient.GetAsync(Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<SqlTimeZone> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _timeZonesRestClient.Get(Id.Parent.Name, Id.Name, cancellationToken);
                if (response.Value == null)
