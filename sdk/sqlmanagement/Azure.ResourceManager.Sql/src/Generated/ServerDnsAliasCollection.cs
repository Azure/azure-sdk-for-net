...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class ServerDnsAliasCollection : ArmCollection, IEnumerable<ServerDnsAlias>, IAsyncEnumerable<ServerDnsAlias>
    {
        ...
        /// <exception cref="ArgumentException"> <paramref name="dnsAliasName"/> is null or empty. </exception>
        ...
        {
            if (string.IsNullOrEmpty(dnsAliasName))
            {
                throw new ArgumentException($"Parameter {nameof(dnsAliasName)} cannot be null or empty", nameof(dnsAliasName));
            }
