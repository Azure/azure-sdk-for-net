...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class GeoBackupPolicyResource : ArmResource
    {
        ...
        internal GeoBackupPolicyResource(ArmClient client, GeoBackupPolicyData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<GeoBackupPolicyResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new GeoBackupPolicyResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual async Task<ArmOperation<GeoBackupPolicyResource>> UpdateAsync(WaitUntil waitUntil, GeoBackupPolicyData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new SqlArmOperation<GeoBackupPolicyResource>(Response.FromValue(new GeoBackupPolicyResource(Client, response.Value, response.Value.Id), response.GetRawResponse()));
