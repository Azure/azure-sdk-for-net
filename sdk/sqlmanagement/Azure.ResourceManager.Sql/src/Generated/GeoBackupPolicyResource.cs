    ...
    public partial class GeoBackupPolicyResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<GeoBackupPolicyResource>> UpdateAsync(WaitUntil waitUntil, GeoBackupPolicyData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var uri = _geoBackupPolicyRestClient.CreateCreateOrUpdateRequestUri(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, data);
                var operationId = NextLinkOperationImplementation.GetOperationId(RequestMethod.Put, uri.ToUri(), uri.ToString(), NextLinkOperationImplementation.HeaderSource.None, false, null, OperationFinalStateVia.OriginalUri);
                var operation = new SqlArmOperation<GeoBackupPolicyResource>(Response.FromValue(new GeoBackupPolicyResource(Client, response), response.GetRawResponse()), operationId);
