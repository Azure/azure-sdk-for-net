...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class FirewallRule : ArmResource
    {
        ...
        internal FirewallRule(ArmClient armClient, FirewallRuleData data) : this(armClient, new ResourceIdentifier(data.Id))
        {
            HasData = true;
            _data = data;
        }
        ...
        internal FirewallRule(ArmClient armClient, ResourceIdentifier id) : base(armClient, id)
        {
            _firewallRuleClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Sql", ResourceType.Namespace, DiagnosticOptions);
            ArmClient.TryGetApiVersion(ResourceType, out string firewallRuleApiVersion);
        ...
        {
            using var scope = _firewallRuleClientDiagnostics.CreateScope("FirewallRule.GetAvailableLocations");
            scope.Start();
            try
            {
