...
{
    /// <summary> A Class representing a ServerSecurityAlertPolicyResource along with the instance operations that can be performed on it. </summary>
    public partial class ServerSecurityAlertPolicyResource : ArmResource
    {
        ...
        {
            _serverSecurityAlertPolicyClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Sql", ResourceType.Namespace, DiagnosticOptions);
