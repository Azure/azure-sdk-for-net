...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class SqlServerJobExecutionResource : ArmResource
    {
        ...
        {
            using DiagnosticScope scope = _sqlServerJobExecutionsClientDiagnostics.CreateScope("SqlServerJobExecutionResource.Update");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _sqlServerJobExecutionsRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Guid.Parse(Id.Name), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
