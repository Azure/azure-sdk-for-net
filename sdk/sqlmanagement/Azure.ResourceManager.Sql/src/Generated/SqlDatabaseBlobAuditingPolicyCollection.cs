...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class SqlDatabaseBlobAuditingPolicyCollection : ArmCollection, IEnumerable<SqlDatabaseBlobAuditingPolicyResource>, IAsyncEnumerable<SqlDatabaseBlobAuditingPolicyResource>
    {
        ...
        /// <summary> Initializes a new instance of SqlDatabaseBlobAuditingPolicyCollection for mocking. </summary>
        protected SqlDatabaseBlobAuditingPolicyCollection()
        {
        }

        /// <summary> Initializes a new instance of <see cref="SqlDatabaseBlobAuditingPolicyCollection"/> class. </summary>
        ...
        public virtual async Task<ArmOperation<SqlDatabaseBlobAuditingPolicyResource>> CreateOrUpdateAsync(WaitUntil waitUntil, BlobAuditingPolicyName blobAuditingPolicyName, SqlDatabaseBlobAuditingPolicyData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _databaseBlobAuditingPoliciesClientDiagnostics.CreateScope("SqlDatabaseBlobAuditingPolicyCollection.CreateOrUpdate");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _databaseBlobAuditingPoliciesRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, blobAuditingPolicyName.ToSerialString(), SqlDatabaseBlobAuditingPolicyData.ToRequestContent(data), context);
        ...
        {
            using DiagnosticScope scope = _databaseBlobAuditingPoliciesClientDiagnostics.CreateScope("SqlDatabaseBlobAuditingPolicyCollection.Get");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _databaseBlobAuditingPoliciesRestClient.CreateGetRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, blobAuditingPolicyName.ToSerialString(), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<SqlDatabaseBlobAuditingPolicyData> response = Response.FromValue(SqlDatabaseBlobAuditingPolicyData.FromResponse(result), result);
        ...
        public virtual AsyncPageable<SqlDatabaseBlobAuditingPolicyResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<SqlDatabaseBlobAuditingPolicyData, SqlDatabaseBlobAuditingPolicyResource>(new DatabaseBlobAuditingPoliciesGetByDatabaseAsyncCollectionResultOfT(
                ...
                Id.Name,
                context,
                "SqlDatabaseBlobAuditingPolicyCollection.GetAll"), data => new SqlDatabaseBlobAuditingPolicyResource(Client, data));
        }
        ...
        {
            using DiagnosticScope scope = _databaseBlobAuditingPoliciesClientDiagnostics.CreateScope("SqlDatabaseBlobAuditingPolicyCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                Response<SqlDatabaseBlobAuditingPolicyData> response = default;
                switch (result.Status)
                {
                    case 200:
                        response = Response.FromValue(SqlDatabaseBlobAuditingPolicyData.FromResponse(result), result);
                        break;
                    case 404:
                        response = Response.FromValue((SqlDatabaseBlobAuditingPolicyData)null, result);
                        break;
                    default:
        ...
        {
            using DiagnosticScope scope = _databaseBlobAuditingPoliciesClientDiagnostics.CreateScope("SqlDatabaseBlobAuditingPolicyCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
