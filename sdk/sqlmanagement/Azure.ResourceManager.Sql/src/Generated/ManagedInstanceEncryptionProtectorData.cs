...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class ManagedInstanceEncryptionProtectorData : ResourceData
    {
        ...
        internal ManagedInstanceEncryptionProtectorData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, ManagedInstanceEncryptionProtectorProperties properties, string kind) : base(id, name, resourceType, systemData)
        {
