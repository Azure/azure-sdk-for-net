...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class WorkloadGroup : ArmResource
    {
        ...
        internal WorkloadGroup(ArmClient armClient, WorkloadGroupData data) : this(armClient, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal WorkloadGroup(ArmClient armClient, ResourceIdentifier id) : base(armClient, id)
        {
            _workloadGroupClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Sql", ResourceType.Namespace, DiagnosticOptions);
            ArmClient.TryGetApiVersion(ResourceType, out string workloadGroupApiVersion);
