...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class JobAgentCollection : ArmCollection, IEnumerable<JobAgent>, IAsyncEnumerable<JobAgent>
    {
        ...
        /// <exception cref="ArgumentException"> <paramref name="jobAgentName"/> is null or empty. </exception>
        ...
        {
            if (string.IsNullOrEmpty(jobAgentName))
            {
                throw new ArgumentException($"Parameter {nameof(jobAgentName)} cannot be null or empty", nameof(jobAgentName));
            }
            if (parameters == null)
            {
