...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class ManagedDatabaseSchemaResource : DatabaseSchemaResource
    {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public new async Task<Response<ManagedDatabaseSchemaResource>> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public new Response<ManagedDatabaseSchemaResource> Get(CancellationToken cancellationToken = default)
        {
