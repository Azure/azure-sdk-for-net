    ...
    public partial class SubscriptionLongTermRetentionBackupResource : LongTermRetentionBackupResource
    {
        ...
        protected override async Task<Response<LongTermRetentionBackupResource>> GetCoreAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue((LongTermRetentionBackupResource)new SubscriptionLongTermRetentionBackupResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
