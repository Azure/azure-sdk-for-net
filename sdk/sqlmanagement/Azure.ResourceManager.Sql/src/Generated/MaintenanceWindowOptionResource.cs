...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class MaintenanceWindowOptionResource : ArmResource
    {
        ...
        internal MaintenanceWindowOptionResource(ArmClient client, MaintenanceWindowOptionData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<MaintenanceWindowOptionResource>> GetAsync(string maintenanceWindowOptionsName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new MaintenanceWindowOptionResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
