...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class MaintenanceWindowOptionResource : ArmResource
    {
        ...
        internal MaintenanceWindowOptionResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _maintenanceWindowOptionsRestClient = new MaintenanceWindowOptions(_maintenanceWindowOptionsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, maintenanceWindowOptionApiVersion ?? "2025-02-01-preview");
