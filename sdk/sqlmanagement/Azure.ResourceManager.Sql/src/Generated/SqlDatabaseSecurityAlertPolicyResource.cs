...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class SqlDatabaseSecurityAlertPolicyResource : ArmResource
    {
        ...
        internal SqlDatabaseSecurityAlertPolicyResource(ArmClient client, SqlDatabaseSecurityAlertPolicyData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<SqlDatabaseSecurityAlertPolicyResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new SqlDatabaseSecurityAlertPolicyResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual async Task<ArmOperation<SqlDatabaseSecurityAlertPolicyResource>> UpdateAsync(WaitUntil waitUntil, SqlDatabaseSecurityAlertPolicyData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new SqlArmOperation<SqlDatabaseSecurityAlertPolicyResource>(Response.FromValue(new SqlDatabaseSecurityAlertPolicyResource(Client, response.Value, response.Value.Id), response.GetRawResponse()));
