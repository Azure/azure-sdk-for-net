...
{
    /// <summary>
    /// A Class representing a DataWarehouseUserActivities along with the instance operations that can be performed on it.
    /// If you have a <see cref="ResourceIdentifier" /> you can construct a <see cref="DataWarehouseUserActivitiesResource" />
    /// from an instance of <see cref="ArmClient" /> using the GetDataWarehouseUserActivitiesResource method.
    /// Otherwise you can get one from its parent resource <see cref="SqlDatabaseResource" /> using the GetDataWarehouseUserActivities method.
    /// </summary>
    public partial class DataWarehouseUserActivitiesResource : ArmResource
    {
        /// <summary> Generate the resource identifier of a <see cref="DataWarehouseUserActivitiesResource"/> instance. </summary>
        ...
        /// <summary> Initializes a new instance of the <see cref="DataWarehouseUserActivitiesResource"/> class for mocking. </summary>
        protected DataWarehouseUserActivitiesResource()
        {
        }

        /// <summary> Initializes a new instance of the <see cref = "DataWarehouseUserActivitiesResource"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="data"> The resource that is the target of operations. </param>
        internal DataWarehouseUserActivitiesResource(ArmClient client, DataWarehouseUserActivitiesData data) : this(client, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal DataWarehouseUserActivitiesResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        ...
        public virtual async Task<Response<DataWarehouseUserActivitiesResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            using var scope = _dataWarehouseUserActivitiesDataWarehouseUserActivitiesClientDiagnostics.CreateScope("DataWarehouseUserActivitiesResource.Get");
            scope.Start();
            try
            {
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<DataWarehouseUserActivitiesResource> Get(CancellationToken cancellationToken = default)
        {
            using var scope = _dataWarehouseUserActivitiesDataWarehouseUserActivitiesClientDiagnostics.CreateScope("DataWarehouseUserActivitiesResource.Get");
            scope.Start();
            try
