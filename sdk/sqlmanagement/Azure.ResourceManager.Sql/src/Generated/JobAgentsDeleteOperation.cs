...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class JobAgentsDeleteOperation : Operation<Response>, IOperationSource<Response>
    {
        private readonly ArmOperationHelpers<Response> _operation;

        /// <summary> Initializes a new instance of JobAgentsDeleteOperation for mocking. </summary>
        protected JobAgentsDeleteOperation()
        {
        }

        internal JobAgentsDeleteOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<Response>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "JobAgentsDeleteOperation");
        }
        /// <inheritdoc />
