...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class FailoverGroup : ArmResource
    {
        ...
        internal FailoverGroup(ArmClient armClient, FailoverGroupData data) : this(armClient, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal FailoverGroup(ArmClient armClient, ResourceIdentifier id) : base(armClient, id)
        {
            _failoverGroupClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Sql", ResourceType.Namespace, DiagnosticOptions);
            ArmClient.TryGetApiVersion(ResourceType, out string failoverGroupApiVersion);
        ...
        public async virtual Task<Response<FailoverGroup>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new FailoverGroup(ArmClient, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        {
            using var scope = _failoverGroupClientDiagnostics.CreateScope("FailoverGroup.GetAvailableLocations");
            scope.Start();
            try
            {
        ...
        public async virtual Task<FailoverGroupUpdateOperation> UpdateAsync(bool waitForCompletion, FailoverGroupUpdate parameters, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new FailoverGroupUpdateOperation(ArmClient, _failoverGroupClientDiagnostics, Pipeline, _failoverGroupRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, parameters).Request, response);
                if (waitForCompletion)
