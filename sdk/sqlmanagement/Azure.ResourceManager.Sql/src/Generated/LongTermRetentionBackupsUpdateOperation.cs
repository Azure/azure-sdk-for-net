...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class LongTermRetentionBackupsUpdateOperation : Operation<LongTermRetentionBackupOperationResult>, IOperationSource<LongTermRetentionBackupOperationResult>
    {
        private readonly ArmOperationHelpers<LongTermRetentionBackupOperationResult> _operation;

        /// <summary> Initializes a new instance of LongTermRetentionBackupsUpdateOperation for mocking. </summary>
        protected LongTermRetentionBackupsUpdateOperation()
        {
        }

        internal LongTermRetentionBackupsUpdateOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<LongTermRetentionBackupOperationResult>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "LongTermRetentionBackupsUpdateOperation");
        }
        /// <inheritdoc />
