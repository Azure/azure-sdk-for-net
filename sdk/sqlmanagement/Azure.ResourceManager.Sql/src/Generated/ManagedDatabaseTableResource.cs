...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class ManagedDatabaseTableResource : ArmResource
    {
        ...
        internal ManagedDatabaseTableResource(ArmClient client, DatabaseTableData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<ManagedDatabaseTableResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new ManagedDatabaseTableResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
