...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class ReplicationLink : ArmResource
    {
        ...
        internal ReplicationLink(ArmClient armClient, ReplicationLinkData data) : this(armClient, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal ReplicationLink(ArmClient armClient, ResourceIdentifier id) : base(armClient, id)
        {
            ...
            ArmClient.TryGetApiVersion(ResourceType, out string replicationLinkApiVersion);
        ...
        {
            using var scope = _replicationLinkClientDiagnostics.CreateScope("ReplicationLink.GetAvailableLocations");
            scope.Start();
            try
            {
