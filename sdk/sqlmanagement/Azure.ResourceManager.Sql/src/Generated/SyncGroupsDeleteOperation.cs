...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class SyncGroupsDeleteOperation : Operation<Response>, IOperationSource<Response>
    {
        private readonly ArmOperationHelpers<Response> _operation;

        /// <summary> Initializes a new instance of SyncGroupsDeleteOperation for mocking. </summary>
        protected SyncGroupsDeleteOperation()
        {
        }

        internal SyncGroupsDeleteOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<Response>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "SyncGroupsDeleteOperation");
        }
        /// <inheritdoc />
