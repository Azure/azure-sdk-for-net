...
{
    public partial class AdvisorAutoGeneratedData : IUtf8JsonSerializable, IJsonModel<AdvisorAutoGeneratedData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AdvisorAutoGeneratedData>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<AdvisorAutoGeneratedData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<AdvisorAutoGeneratedData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AdvisorAutoGeneratedData)} does not support writing '{format}' format.");
            }
        ...
        AdvisorAutoGeneratedData IJsonModel<AdvisorAutoGeneratedData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AdvisorAutoGeneratedData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AdvisorAutoGeneratedData)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeAdvisorAutoGeneratedData(document.RootElement, options);
        }

        internal static AdvisorAutoGeneratedData DeserializeAdvisorAutoGeneratedData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            IReadOnlyList<RecommendedActionAutoGenerated2> recommendedActions = default;
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("recommendedActions"u8))
                        {
                            ...
                            List<RecommendedActionAutoGenerated2> array = new List<RecommendedActionAutoGenerated2>();
                            foreach (var item in property0.Value.EnumerateArray())
                            {
                                array.Add(RecommendedActionAutoGenerated2.DeserializeRecommendedActionAutoGenerated2(item, options));
                            }
            ...
            return new AdvisorAutoGeneratedData(
                ...
                lastChecked,
                recommendedActions ?? new ChangeTrackingList<RecommendedActionAutoGenerated2>(),
        ...
        BinaryData IPersistableModel<AdvisorAutoGeneratedData>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AdvisorAutoGeneratedData>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AdvisorAutoGeneratedData)} does not support writing '{options.Format}' format.");
            }
        }

        AdvisorAutoGeneratedData IPersistableModel<AdvisorAutoGeneratedData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AdvisorAutoGeneratedData>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AdvisorAutoGeneratedData)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<AdvisorAutoGeneratedData>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
