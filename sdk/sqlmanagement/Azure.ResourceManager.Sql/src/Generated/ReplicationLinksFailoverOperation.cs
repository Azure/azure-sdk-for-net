...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class ReplicationLinksFailoverOperation : Operation<Response>, IOperationSource<Response>
    {
        private readonly ArmOperationHelpers<Response> _operation;

        /// <summary> Initializes a new instance of ReplicationLinksFailoverOperation for mocking. </summary>
        protected ReplicationLinksFailoverOperation()
        {
        }

        internal ReplicationLinksFailoverOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<Response>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "ReplicationLinksFailoverOperation");
        }
        /// <inheritdoc />
