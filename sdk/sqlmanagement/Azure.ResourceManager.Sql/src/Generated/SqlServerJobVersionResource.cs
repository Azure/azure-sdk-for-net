...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class SqlServerJobVersionResource : ArmResource
    {
        ...
        internal SqlServerJobVersionResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _jobVersionsRestClient = new JobVersions(_jobVersionsClientDiagnostics, Pipeline, Endpoint, sqlServerJobVersionApiVersion ?? "2025-01-01");
        ...
        /// <summary> Gets a collection of SqlServerJobVersionSteps in the <see cref="SqlServerJobVersionResource"/>. </summary>
        /// <returns> An object representing collection of SqlServerJobVersionSteps and their operations over a SqlServerJobVersionStepResource. </returns>
