...
namespace Azure.ResourceManager.Sql
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RecoverableManagedDatabaseData>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        void IJsonModel<RecoverableManagedDatabaseData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            writer.WriteStartObject();
            if (options.Format != "W" && Optional.IsDefined(LastAvailableBackupDate))
            {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            builder.AppendLine(" {");
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(LastAvailableBackupDate), out propertyOverride);
            if (Optional.IsDefined(LastAvailableBackupDate) || hasPropertyOverride)
            {
                ...
                {
                    if (LastAvailableBackupDate.Contains(Environment.NewLine))
                    {
                        builder.AppendLine("'''");
                        builder.AppendLine($"{LastAvailableBackupDate}'''");
                    }
                    else
                    {
                        builder.AppendLine($"'{LastAvailableBackupDate}'");
