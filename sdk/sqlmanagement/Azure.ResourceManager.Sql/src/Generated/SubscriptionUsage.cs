...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class SubscriptionUsage : ArmResource
    {
        ...
        public async virtual Task<Response<SubscriptionUsage>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _subscriptionUsagesRestClient.GetAsync(Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<SubscriptionUsage> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _subscriptionUsagesRestClient.Get(Id.Parent.Name, Id.Name, cancellationToken);
                if (response.Value == null)
