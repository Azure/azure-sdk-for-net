...
namespace Azure.ResourceManager.Sql
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="ManagedInstanceServerConfigurationOptionResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="ManagedInstanceResource"/> using the GetManagedInstanceServerConfigurationOptions method.
    /// </summary>
    public partial class ManagedInstanceServerConfigurationOptionResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of ManagedInstanceServerConfigurationOptionResource for mocking. </summary>
        protected ManagedInstanceServerConfigurationOptionResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="ManagedInstanceServerConfigurationOptionResource"/> class. </summary>
        ...
        {
            string resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/managedInstances/{managedInstanceName}/serverConfigurationOptions/{serverConfigurationOptionName}";
        ...
        {
            using DiagnosticScope scope = _serverConfigurationOptionsClientDiagnostics.CreateScope("ManagedInstanceServerConfigurationOptionResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _serverConfigurationOptionsRestClient.CreateGetRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, context);
        ...
        /// <summary>
        /// Update a ManagedInstanceServerConfigurationOption.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/managedInstances/{managedInstanceName}/serverConfigurationOptions/{serverConfigurationOptionName}. </description>
        ...
        public virtual async Task<ArmOperation<ManagedInstanceServerConfigurationOptionResource>> UpdateAsync(WaitUntil waitUntil, ManagedInstanceServerConfigurationOptionData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _serverConfigurationOptionsClientDiagnostics.CreateScope("ManagedInstanceServerConfigurationOptionResource.Update");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _serverConfigurationOptionsRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, ManagedInstanceServerConfigurationOptionData.ToRequestContent(data), context);
