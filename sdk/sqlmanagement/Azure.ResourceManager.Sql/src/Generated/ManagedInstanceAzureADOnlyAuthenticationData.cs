...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class ManagedInstanceAzureADOnlyAuthenticationData : ResourceData
    {
        ...
        internal ManagedInstanceAzureADOnlyAuthenticationData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, bool? isAzureADOnlyAuthenticationEnabled, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
