...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class ServerJobAgentJobVersionStepResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="ServerJobAgentJobVersionStepResource"/> class for mocking. </summary>
        protected ServerJobAgentJobVersionStepResource()
        {
        }

        /// <summary> Initializes a new instance of the <see cref = "ServerJobAgentJobVersionStepResource"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="data"> The resource that is the target of operations. </param>
        internal ServerJobAgentJobVersionStepResource(ArmClient client, JobStepData data) : this(client, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal ServerJobAgentJobVersionStepResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            _serverJobAgentJobVersionStepJobStepsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Sql", ResourceType.Namespace, Diagnostics);
            TryGetApiVersion(ResourceType, out string serverJobAgentJobVersionStepJobStepsApiVersion);
        ...
        public virtual async Task<Response<ServerJobAgentJobVersionStepResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            using var scope = _serverJobAgentJobVersionStepJobStepsClientDiagnostics.CreateScope("ServerJobAgentJobVersionStepResource.Get");
            scope.Start();
            try
            {
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<ServerJobAgentJobVersionStepResource> Get(CancellationToken cancellationToken = default)
        {
            using var scope = _serverJobAgentJobVersionStepJobStepsClientDiagnostics.CreateScope("ServerJobAgentJobVersionStepResource.Get");
            scope.Start();
            try
