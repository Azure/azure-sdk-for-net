...
namespace Azure.ResourceManager.Sql
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DatabaseSchemaData>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        internal static DatabaseSchemaData DeserializeDatabaseSchemaData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new DatabaseSchemaData(id, name, type, systemData, serializedAdditionalRawData);
        }
