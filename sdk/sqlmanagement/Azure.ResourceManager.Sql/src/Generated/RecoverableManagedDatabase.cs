...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class RecoverableManagedDatabase : ArmResource
    {
        ...
        internal RecoverableManagedDatabase(ArmResource options, RecoverableManagedDatabaseData data) : base(options, data.Id)
        {
            HasData = true;
            _data = data;
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("RecoverableManagedDatabase.GetAvailableLocations");
            scope.Start();
            try
            {
