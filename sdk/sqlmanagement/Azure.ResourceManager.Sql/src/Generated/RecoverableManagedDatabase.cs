...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class RecoverableManagedDatabase : ArmResource
    {
        ...
        internal RecoverableManagedDatabase(ArmClient armClient, RecoverableManagedDatabaseData data) : this(armClient, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal RecoverableManagedDatabase(ArmClient armClient, ResourceIdentifier id) : base(armClient, id)
        {
            ...
            ArmClient.TryGetApiVersion(ResourceType, out string recoverableManagedDatabaseApiVersion);
        ...
        {
            using var scope = _recoverableManagedDatabaseClientDiagnostics.CreateScope("RecoverableManagedDatabase.GetAvailableLocations");
            scope.Start();
            try
            {
