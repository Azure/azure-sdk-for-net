...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class SqlDatabaseAdvisorResource : ArmResource
    {
        ...
        internal SqlDatabaseAdvisorResource(ArmClient client, SqlAdvisorData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<SqlDatabaseAdvisorResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new SqlDatabaseAdvisorResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
