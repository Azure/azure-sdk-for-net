...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class SqlDatabaseAdvisorResource : ArmResource
    {
        ...
        /// <summary> Gets a collection of RecommendedActionAutoGeneratedResources in the SqlDatabaseAdvisor. </summary>
        /// <returns> An object representing collection of RecommendedActionAutoGeneratedResources and their operations over a RecommendedActionAutoGeneratedResource. </returns>
        public virtual RecommendedActionAutoGeneratedCollection GetRecommendedActionAutoGenerateds()
        {
            return GetCachedClient(client => new RecommendedActionAutoGeneratedCollection(client, Id));
        }
        ...
        [ForwardsClientCalls]
        public virtual async Task<Response<RecommendedActionAutoGeneratedResource>> GetRecommendedActionAutoGeneratedAsync(string recommendedActionName, CancellationToken cancellationToken = default)
        {
            return await GetRecommendedActionAutoGenerateds().GetAsync(recommendedActionName, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <exception cref="ArgumentException"> <paramref name="recommendedActionName"/> is an empty string, and was expected to be non-empty. </exception>
        [ForwardsClientCalls]
        public virtual Response<RecommendedActionAutoGeneratedResource> GetRecommendedActionAutoGenerated(string recommendedActionName, CancellationToken cancellationToken = default)
        {
            return GetRecommendedActionAutoGenerateds().Get(recommendedActionName, cancellationToken);
        }
