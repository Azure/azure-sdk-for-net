...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class SubscriptionLongTermRetentionManagedInstanceBackup : ArmResource
    {
        ...
        internal SubscriptionLongTermRetentionManagedInstanceBackup(ArmClient armClient, ManagedInstanceLongTermRetentionBackupData data) : this(armClient, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal SubscriptionLongTermRetentionManagedInstanceBackup(ArmClient armClient, ResourceIdentifier id) : base(armClient, id)
        {
            ...
            ArmClient.TryGetApiVersion(ResourceType, out string subscriptionLongTermRetentionManagedInstanceBackupLongTermRetentionManagedInstanceBackupsApiVersion);
        ...
        public async virtual Task<Response<SubscriptionLongTermRetentionManagedInstanceBackup>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new SubscriptionLongTermRetentionManagedInstanceBackup(ArmClient, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        {
            using var scope = _subscriptionLongTermRetentionManagedInstanceBackupLongTermRetentionManagedInstanceBackupsClientDiagnostics.CreateScope("SubscriptionLongTermRetentionManagedInstanceBackup.GetAvailableLocations");
            scope.Start();
            try
            {
