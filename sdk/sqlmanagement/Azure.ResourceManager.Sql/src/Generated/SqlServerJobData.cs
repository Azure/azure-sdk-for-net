...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class SqlServerJobData : ResourceData
    {
        ...
        internal SqlServerJobData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string description, int? version, SqlServerJobSchedule schedule, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData)
        {
