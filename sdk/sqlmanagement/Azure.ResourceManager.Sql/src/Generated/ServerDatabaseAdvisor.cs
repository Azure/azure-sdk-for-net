...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class ServerDatabaseAdvisor : ArmResource
    {
        ...
        public async virtual Task<Response<ServerDatabaseAdvisor>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _databaseAdvisorsRestClient.GetAsync(Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<ServerDatabaseAdvisor> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _databaseAdvisorsRestClient.Get(Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken);
                if (response.Value == null)
        ...
        public async virtual Task<Response<ServerDatabaseAdvisor>> UpdateAsync(AdvisorData parameters, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _databaseAdvisorsRestClient.UpdateAsync(Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, parameters, cancellationToken).ConfigureAwait(false);
                return Response.FromValue(new ServerDatabaseAdvisor(this, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        public virtual Response<ServerDatabaseAdvisor> Update(AdvisorData parameters, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _databaseAdvisorsRestClient.Update(Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, parameters, cancellationToken);
                return Response.FromValue(new ServerDatabaseAdvisor(this, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
