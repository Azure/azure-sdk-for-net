...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class SqlTimeZoneResource : ArmResource
    {
        ...
        internal SqlTimeZoneResource(ArmClient client, SqlTimeZoneData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<SqlTimeZoneResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new SqlTimeZoneResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
