...
namespace Azure.ResourceManager.Sql
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="SqlServerDevOpsAuditingSettingResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="SqlServerResource"/> using the GetSqlServerDevOpsAuditingSettings method.
    /// </summary>
    public partial class SqlServerDevOpsAuditingSettingResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of SqlServerDevOpsAuditingSettingResource for mocking. </summary>
        protected SqlServerDevOpsAuditingSettingResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="SqlServerDevOpsAuditingSettingResource"/> class. </summary>
        ...
        {
            string resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/devOpsAuditingSettings/{devOpsAuditingSettingsName}";
        ...
        {
            using DiagnosticScope scope = _serverDevOpsAuditSettingsClientDiagnostics.CreateScope("SqlServerDevOpsAuditingSettingResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _serverDevOpsAuditSettingsRestClient.CreateGetRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, context);
        ...
        /// <summary>
        /// Update a SqlServerDevOpsAuditingSetting.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/devOpsAuditingSettings/{devOpsAuditingSettingsName}. </description>
        ...
        public virtual async Task<ArmOperation<SqlServerDevOpsAuditingSettingResource>> UpdateAsync(WaitUntil waitUntil, SqlServerDevOpsAuditingSettingData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _serverDevOpsAuditSettingsClientDiagnostics.CreateScope("SqlServerDevOpsAuditingSettingResource.Update");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _serverDevOpsAuditSettingsRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, SqlServerDevOpsAuditingSettingData.ToRequestContent(data), context);
