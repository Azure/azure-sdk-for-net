...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class ServerAzureADOnlyAuthenticationsDeleteOperation : Operation<Response>, IOperationSource<Response>
    {
        private readonly ArmOperationHelpers<Response> _operation;

        /// <summary> Initializes a new instance of ServerAzureADOnlyAuthenticationsDeleteOperation for mocking. </summary>
        protected ServerAzureADOnlyAuthenticationsDeleteOperation()
        {
        }

        internal ServerAzureADOnlyAuthenticationsDeleteOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<Response>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "ServerAzureADOnlyAuthenticationsDeleteOperation");
        }
        /// <inheritdoc />
