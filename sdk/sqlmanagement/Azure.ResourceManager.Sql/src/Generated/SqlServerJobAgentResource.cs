...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class SqlServerJobAgentResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<SqlServerJobAgentResource>> UpdateAsync(WaitUntil waitUntil, SqlServerJobAgentData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _jobAgentsRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, SqlServerJobAgentData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                SqlArmOperation<SqlServerJobAgentResource> operation = new SqlArmOperation<SqlServerJobAgentResource>(
                    new SqlServerJobAgentResourceOperationSource(Client),
                    _jobAgentsClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<SqlServerJobAgentResource> Update(WaitUntil waitUntil, SqlServerJobAgentData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
