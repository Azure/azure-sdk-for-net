...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class SqlServerJobTargetGroupData : ResourceData
    {
        ...
        internal SqlServerJobTargetGroupData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IList<JobTarget> members, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData)
        {
            Members = members;
            _rawData = rawData;
        }
