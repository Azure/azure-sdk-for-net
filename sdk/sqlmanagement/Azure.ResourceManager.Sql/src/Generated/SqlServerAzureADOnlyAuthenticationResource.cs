...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class SqlServerAzureADOnlyAuthenticationResource : ArmResource
    {
        ...
        internal SqlServerAzureADOnlyAuthenticationResource(ArmClient client, SqlServerAzureADOnlyAuthenticationData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<SqlServerAzureADOnlyAuthenticationResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new SqlServerAzureADOnlyAuthenticationResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
