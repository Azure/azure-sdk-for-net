...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class SqlServerDatabaseReplicationLinkResource : ArmResource
    {
        ...
        /// <summary>
        /// Updates the SqlServerDatabaseReplicationLink.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/databases/{databaseName}/replicationLinks/{linkId}. </description>
        ...
        public virtual async Task<ArmOperation<SqlServerDatabaseReplicationLinkResource>> UpdateAsync(WaitUntil waitUntil, SqlServerDatabaseReplicationLinkData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _replicationLinksRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, SqlServerDatabaseReplicationLinkData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                SqlArmOperation<SqlServerDatabaseReplicationLinkResource> operation = new SqlArmOperation<SqlServerDatabaseReplicationLinkResource>(
                    new SqlServerDatabaseReplicationLinkResourceOperationSource(Client),
                    _replicationLinksClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<SqlServerDatabaseReplicationLinkResource> Update(WaitUntil waitUntil, SqlServerDatabaseReplicationLinkData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
