...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class SqlServerDatabaseReplicationLinkResource : ArmResource
    {
        ...
        internal SqlServerDatabaseReplicationLinkResource(ArmClient client, SqlServerDatabaseReplicationLinkData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<SqlServerDatabaseReplicationLinkResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new SqlServerDatabaseReplicationLinkResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
