...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class RecoverableDatabase : ArmResource
    {
        ...
        internal RecoverableDatabase(ArmResource options, RecoverableDatabaseData data) : base(options, data.Id)
        {
            HasData = true;
            _data = data;
        ...
        public async virtual Task<Response<RecoverableDatabase>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _recoverableDatabasesRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<RecoverableDatabase> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _recoverableDatabasesRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                if (response.Value == null)
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("RecoverableDatabase.GetAvailableLocations");
            scope.Start();
            try
            {
