...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class RecoverableDatabase : ArmResource
    {
        ...
        internal RecoverableDatabase(ArmClient armClient, RecoverableDatabaseData data) : this(armClient, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal RecoverableDatabase(ArmClient armClient, ResourceIdentifier id) : base(armClient, id)
        {
            ...
            ArmClient.TryGetApiVersion(ResourceType, out string recoverableDatabaseApiVersion);
        ...
        public async virtual Task<Response<RecoverableDatabase>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new RecoverableDatabase(ArmClient, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
