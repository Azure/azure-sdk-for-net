...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class MaintenanceWindowOptionData : ResourceData
    {
        ...
        internal MaintenanceWindowOptionData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, bool? isEnabled, IList<MaintenanceWindowTimeRange> maintenanceWindowCycles, int? minDurationInMinutes, int? defaultDurationInMinutes, int? minCycles, int? timeGranularityInMinutes, bool? allowMultipleMaintenanceWindowsPerCycle, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData)
        {
            IsEnabled = isEnabled;
