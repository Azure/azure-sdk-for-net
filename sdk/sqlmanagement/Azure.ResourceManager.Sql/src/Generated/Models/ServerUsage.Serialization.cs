...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        internal static ServerUsage DeserializeServerUsage(JsonElement element)
        {
            ...
            return new ServerUsage(name.Value, resourceName.Value, displayName.Value, Optional.ToNullable(currentValue), Optional.ToNullable(limit), unit.Value, Optional.ToNullable(nextResetTime));
        }
    }
}
