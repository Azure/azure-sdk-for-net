...
namespace Azure.ResourceManager.Sql
{
    public partial class ServerKeyData : IUtf8JsonSerializable
    {
        ...
        internal static ServerKeyData DeserializeServerKeyData(JsonElement element)
        {
            ...
            return new ServerKeyData(id, name, type, systemData, kind.Value, Optional.ToNullable(location), subregion.Value, Optional.ToNullable(serverKeyType), uri.Value, thumbprint.Value, Optional.ToNullable(creationDate), Optional.ToNullable(autoRotationEnabled));
        }
    }
}
