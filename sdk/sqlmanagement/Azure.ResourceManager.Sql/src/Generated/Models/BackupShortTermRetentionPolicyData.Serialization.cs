...
namespace Azure.ResourceManager.Sql
{
    public partial class BackupShortTermRetentionPolicyData : IUtf8JsonSerializable, IJsonModel<BackupShortTermRetentionPolicyData>
    {
        ...
        void IJsonModel<BackupShortTermRetentionPolicyData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(BackupShortTermRetentionPolicyData)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<BackupShortTermRetentionPolicyData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(BackupShortTermRetentionPolicyData)} does not support '{options.Format}' format.");
            }
        }
