...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ManagedInstanceMaintenanceConfigurationCapability>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<ManagedInstanceMaintenanceConfigurationCapability>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ManagedInstanceMaintenanceConfigurationCapability>)} interface");
            }
        ...
        string IPersistableModel<ManagedInstanceMaintenanceConfigurationCapability>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
