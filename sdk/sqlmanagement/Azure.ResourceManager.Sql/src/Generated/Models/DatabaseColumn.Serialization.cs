...
{
    public partial class DatabaseColumn : IUtf8JsonSerializable
    {
        ...
        internal static DatabaseColumn DeserializeDatabaseColumn(JsonElement element)
        {
            ...
            return new DatabaseColumn(id.Value, name.Value, type.Value, Optional.ToNullable(columnType), Optional.ToNullable(temporalType), Optional.ToNullable(memoryOptimized), Optional.ToNullable(isComputed));
        }
    }
}
