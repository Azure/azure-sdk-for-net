...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<UpdateLongTermRetentionBackupContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<UpdateLongTermRetentionBackupContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<UpdateLongTermRetentionBackupContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<UpdateLongTermRetentionBackupContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
