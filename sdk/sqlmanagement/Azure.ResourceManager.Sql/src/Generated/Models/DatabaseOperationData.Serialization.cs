...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DatabaseOperationData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DatabaseOperationData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DatabaseOperationData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DatabaseOperationData>)} interface");
            }
        ...
        string IPersistableModel<DatabaseOperationData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
