...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        internal static InstancePoolFamilyCapability DeserializeInstancePoolFamilyCapability(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
