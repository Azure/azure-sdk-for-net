...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        internal static InstancePoolUsageListResult DeserializeInstancePoolUsageListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
