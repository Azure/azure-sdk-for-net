...
namespace Azure.ResourceManager.Sql.Models
{
    public partial class EncryptionProtector : IUtf8JsonSerializable
    {
        ...
        internal static EncryptionProtector DeserializeEncryptionProtector(JsonElement element)
        {
            ...
            return new EncryptionProtector(id.Value, name.Value, type.Value, kind.Value, location.Value, subregion.Value, serverKeyName.Value, Optional.ToNullable(serverKeyType), uri.Value, thumbprint.Value, Optional.ToNullable(autoRotationEnabled));
        }
    }
}
