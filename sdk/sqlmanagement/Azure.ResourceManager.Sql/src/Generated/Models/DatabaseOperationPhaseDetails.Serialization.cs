...
namespace Azure.ResourceManager.Sql.Models
{
    public partial class DatabaseOperationPhaseDetails : IUtf8JsonSerializable, IJsonModel<DatabaseOperationPhaseDetails>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(PhaseInformation), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("  phaseInformation: ");
                builder.AppendLine(propertyOverride);
            }
            else
            {
                if (Optional.IsCollectionDefined(PhaseInformation))
                {
                    if (PhaseInformation.Any())
                    {
                        builder.Append("  phaseInformation: ");
                        builder.AppendLine("{");
                        foreach (var item in PhaseInformation)
