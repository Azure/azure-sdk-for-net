...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NetworkIsolationSettings>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NetworkIsolationSettings>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NetworkIsolationSettings>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<NetworkIsolationSettings>)} interface");
            }
        ...
        string IPersistableModel<NetworkIsolationSettings>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
