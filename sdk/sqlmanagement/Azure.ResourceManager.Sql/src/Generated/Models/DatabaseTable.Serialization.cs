...
{
    public partial class DatabaseTable : IUtf8JsonSerializable
    {
        ...
        internal static DatabaseTable DeserializeDatabaseTable(JsonElement element)
        {
            ...
            return new DatabaseTable(id.Value, name.Value, type.Value, Optional.ToNullable(temporalType), Optional.ToNullable(memoryOptimized));
        }
    }
}
