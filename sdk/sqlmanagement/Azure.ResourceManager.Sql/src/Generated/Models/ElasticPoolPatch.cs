...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    public partial class ElasticPoolPatch
    {
        ...
        internal ElasticPoolPatch(SqlSku sku, IDictionary<string, string> tags, long? maxSizeBytes, double? minCapacity, ElasticPoolPerDatabaseSettings perDatabaseSettings, bool? isZoneRedundant, ElasticPoolLicenseType? licenseType, ResourceIdentifier maintenanceConfigurationId, int? highAvailabilityReplicaCount, SqlAlwaysEncryptedEnclaveType? preferredEnclaveType, SqlAvailabilityZoneType? availabilityZone, Dictionary<string, BinaryData> rawData)
        {
            Sku = sku;
            Tags = tags;
