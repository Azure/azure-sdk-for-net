...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    internal partial class OutboundEnvironmentEndpointCollection
    {
        ...
        internal OutboundEnvironmentEndpointCollection(IEnumerable<SqlOutboundEnvironmentEndpoint> value)
        {
            Value = value.ToList();
        }
        ...
        internal OutboundEnvironmentEndpointCollection(IList<SqlOutboundEnvironmentEndpoint> value, Uri nextLink, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            NextLink = nextLink;
