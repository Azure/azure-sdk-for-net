...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    public partial class SqlSynapseLinkWorkspace : ResourceData
    {
        ...
        internal SqlSynapseLinkWorkspace(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, SynapseLinkWorkspaceProperties properties) : base(id, name, resourceType, systemData)
        {
