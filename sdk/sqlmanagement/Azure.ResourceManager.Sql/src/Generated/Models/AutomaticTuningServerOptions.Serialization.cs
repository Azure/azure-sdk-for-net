...
{
    public partial class AutomaticTuningServerOptions : IUtf8JsonSerializable, IJsonModel<AutomaticTuningServerOptions>, IPersistableModel<AutomaticTuningServerOptions>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ReasonDesc))
            {
                ...
                builder.AppendLine($" '{ReasonDesc.ToString()}'");
            }
