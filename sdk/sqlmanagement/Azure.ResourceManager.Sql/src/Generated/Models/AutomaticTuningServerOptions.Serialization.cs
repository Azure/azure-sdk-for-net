...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AutomaticTuningServerOptions>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AutomaticTuningServerOptions>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AutomaticTuningServerOptions>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AutomaticTuningServerOptions>)} interface");
            }
        ...
        string IPersistableModel<AutomaticTuningServerOptions>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
