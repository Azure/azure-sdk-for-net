...
{
    public partial class AutomaticTuningServerOptions : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static AutomaticTuningServerOptions DeserializeAutomaticTuningServerOptions(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
