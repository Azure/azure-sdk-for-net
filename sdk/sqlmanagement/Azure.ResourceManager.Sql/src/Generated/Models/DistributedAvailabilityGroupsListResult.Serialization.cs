...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DistributedAvailabilityGroupsListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DistributedAvailabilityGroupsListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DistributedAvailabilityGroupsListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DistributedAvailabilityGroupsListResult>)} interface");
            }
        ...
        string IPersistableModel<DistributedAvailabilityGroupsListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
