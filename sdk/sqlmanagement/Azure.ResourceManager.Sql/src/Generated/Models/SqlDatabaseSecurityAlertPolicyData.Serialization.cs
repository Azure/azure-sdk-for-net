...
{
    public partial class SqlDatabaseSecurityAlertPolicyData : IUtf8JsonSerializable, IModelJsonSerializable<SqlDatabaseSecurityAlertPolicyData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IModelJsonSerializable<SqlDatabaseSecurityAlertPolicyData>)this).Serialize(writer, ModelSerializerOptions.DefaultWireOptions);

        void IModelJsonSerializable<SqlDatabaseSecurityAlertPolicyData>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<SqlDatabaseSecurityAlertPolicyData>(this, options.Format);
        ...
        internal static SqlDatabaseSecurityAlertPolicyData DeserializeSqlDatabaseSecurityAlertPolicyData(JsonElement element, ModelSerializerOptions options = default)
        {
        ...
        SqlDatabaseSecurityAlertPolicyData IModelJsonSerializable<SqlDatabaseSecurityAlertPolicyData>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<SqlDatabaseSecurityAlertPolicyData>(this, options.Format);

            using var doc = JsonDocument.ParseValue(ref reader);
            return DeserializeSqlDatabaseSecurityAlertPolicyData(doc.RootElement, options);
        }

        BinaryData IModelSerializable<SqlDatabaseSecurityAlertPolicyData>.Serialize(ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<SqlDatabaseSecurityAlertPolicyData>(this, options.Format);
        ...
        SqlDatabaseSecurityAlertPolicyData IModelSerializable<SqlDatabaseSecurityAlertPolicyData>.Deserialize(BinaryData data, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<SqlDatabaseSecurityAlertPolicyData>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="SqlDatabaseSecurityAlertPolicyData"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="SqlDatabaseSecurityAlertPolicyData"/> to convert. </param>
        public static implicit operator RequestContent(SqlDatabaseSecurityAlertPolicyData model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="SqlDatabaseSecurityAlertPolicyData"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator SqlDatabaseSecurityAlertPolicyData(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeSqlDatabaseSecurityAlertPolicyData(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
