...
namespace Azure.ResourceManager.Sql
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SqlDatabaseSecurityAlertPolicyData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SqlDatabaseSecurityAlertPolicyData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SqlDatabaseSecurityAlertPolicyData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SqlDatabaseSecurityAlertPolicyData>)} interface");
            }
        ...
        string IPersistableModel<SqlDatabaseSecurityAlertPolicyData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
