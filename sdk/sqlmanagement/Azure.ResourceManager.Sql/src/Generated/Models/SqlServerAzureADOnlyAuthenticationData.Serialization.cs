...
{
    public partial class SqlServerAzureADOnlyAuthenticationData : Core.IUtf8JsonSerializable
    {
        ...
        internal static SqlServerAzureADOnlyAuthenticationData DeserializeSqlServerAzureADOnlyAuthenticationData(JsonElement element)
        {
            ...
            return new SqlServerAzureADOnlyAuthenticationData(id, name, type, systemData.Value, Core.Optional.ToNullable(azureADOnlyAuthentication));
        }
    }
}
