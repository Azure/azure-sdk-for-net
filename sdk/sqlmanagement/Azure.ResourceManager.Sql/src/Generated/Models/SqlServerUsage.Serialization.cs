...
namespace Azure.ResourceManager.Sql.Models
{
    public partial class SqlServerUsage
    {
        internal static SqlServerUsage DeserializeSqlServerUsage(JsonElement element)
        {
            ...
            return new SqlServerUsage(name.Value, resourceName.Value, displayName.Value, Core.Optional.ToNullable(currentValue), Core.Optional.ToNullable(limit), unit.Value, Core.Optional.ToNullable(nextResetTime));
        }
    }
}
