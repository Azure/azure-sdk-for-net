...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SqlServerUsage>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SqlServerUsage>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SqlServerUsage>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SqlServerUsage>)} interface");
            }
        ...
        string IPersistableModel<SqlServerUsage>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
