...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        internal static EncryptionProtectorListResult DeserializeEncryptionProtectorListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
