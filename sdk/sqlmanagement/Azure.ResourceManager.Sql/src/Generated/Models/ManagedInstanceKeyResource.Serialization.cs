...
namespace Azure.ResourceManager.Sql
{
    public partial class ManagedInstanceKeyResource : IJsonModel<ManagedInstanceKeyData>
    {
        ...
        {
            return ModelReaderWriter.Read<ManagedInstanceKeyData>(new BinaryData(reader.ValueSequence), options);
        }
        ...
        {
            return ModelReaderWriter.Read<ManagedInstanceKeyData>(data, options);
        }
