...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    public partial class JobTarget
    {
        ...
        internal JobTarget(JobTargetGroupMembershipType? membershipType, JobTargetType targetType, string serverName, string databaseName, string elasticPoolName, string shardMapName, string refreshCredential, Dictionary<string, BinaryData> rawData)
        {
