...
namespace Azure.ResourceManager.Sql
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RecoverableManagedDatabaseData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RecoverableManagedDatabaseData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RecoverableManagedDatabaseData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RecoverableManagedDatabaseData>)} interface");
            }
        ...
        string IPersistableModel<RecoverableManagedDatabaseData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
