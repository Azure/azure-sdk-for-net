...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RecommendedSensitivityLabelUpdate>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RecommendedSensitivityLabelUpdate>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RecommendedSensitivityLabelUpdate>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RecommendedSensitivityLabelUpdate>)} interface");
            }
        ...
        string IPersistableModel<RecommendedSensitivityLabelUpdate>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
