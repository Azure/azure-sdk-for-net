...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        internal static SqlNameAvailabilityResponse DeserializeSqlNameAvailabilityResponse(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
