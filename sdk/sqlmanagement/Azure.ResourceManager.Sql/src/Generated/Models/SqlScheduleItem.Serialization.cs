...
{
    public partial class SqlScheduleItem : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static SqlScheduleItem DeserializeSqlScheduleItem(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
