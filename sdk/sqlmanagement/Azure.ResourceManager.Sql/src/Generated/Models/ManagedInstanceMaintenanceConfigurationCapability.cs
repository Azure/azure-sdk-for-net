...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    public partial class ManagedInstanceMaintenanceConfigurationCapability
    {
        ...
        internal ManagedInstanceMaintenanceConfigurationCapability(string name, SqlCapabilityStatus? status, string reason, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Status = status;
            Reason = reason;
