...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        internal static JobTargetGroupListResult DeserializeJobTargetGroupListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
