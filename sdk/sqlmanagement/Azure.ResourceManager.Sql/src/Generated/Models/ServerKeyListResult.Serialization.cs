...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ServerKeyListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ServerKeyListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ServerKeyListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ServerKeyListResult>)} interface");
            }
        ...
        string IPersistableModel<ServerKeyListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
