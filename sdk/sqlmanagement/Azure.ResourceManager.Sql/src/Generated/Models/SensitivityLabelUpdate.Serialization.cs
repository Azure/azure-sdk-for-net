...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SensitivityLabelUpdate>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SensitivityLabelUpdate>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SensitivityLabelUpdate>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SensitivityLabelUpdate>)} interface");
            }
        ...
        string IPersistableModel<SensitivityLabelUpdate>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
