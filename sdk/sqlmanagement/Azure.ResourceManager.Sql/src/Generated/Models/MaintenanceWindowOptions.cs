...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    public partial class MaintenanceWindowOptions : ProxyResource
    {
        ...
        internal MaintenanceWindowOptions(string id, string name, string type, bool? isEnabled, IList<MaintenanceWindowTimeRange> maintenanceWindowCycles, int? minDurationInMinutes, int? defaultDurationInMinutes, int? minCycles, int? timeGranularityInMinutes, bool? allowMultipleMaintenanceWindowsPerCycle) : base(id, name, type)
        {
            IsEnabled = isEnabled;
