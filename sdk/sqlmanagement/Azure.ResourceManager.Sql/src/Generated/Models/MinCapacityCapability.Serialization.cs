...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MinCapacityCapability>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MinCapacityCapability>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MinCapacityCapability>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MinCapacityCapability>)} interface");
            }
        ...
        string IPersistableModel<MinCapacityCapability>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
