...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    public partial class SyncFullSchemaTableColumn
    {
        ...
        internal SyncFullSchemaTableColumn(string dataSize, string dataType, string errorId, bool? hasError, bool? isPrimaryKey, string name, string quotedName, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            DataSize = dataSize;
            DataType = dataType;
            ErrorId = errorId;
