...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    public partial class SyncFullSchemaTableColumn
    {
        ...
        internal SyncFullSchemaTableColumn(string dataSize, string dataType, string errorId, bool? hasError, bool? isPrimaryKey, string name, string quotedName, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            DataSize = dataSize;
            DataType = dataType;
            ErrorId = errorId;
