...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ManagedBackupShortTermRetentionPolicyListResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (options.Format != "W" && Optional.IsCollectionDefined(Value))
            {
                ...
                {
                    ((IJsonModel<ManagedBackupShortTermRetentionPolicyData>)item).Write(writer, options);
                }
        ...
        internal static ManagedBackupShortTermRetentionPolicyListResult DeserializeManagedBackupShortTermRetentionPolicyListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            IReadOnlyList<ManagedBackupShortTermRetentionPolicyData> value = default;
            ...
            return new ManagedBackupShortTermRetentionPolicyListResult(value ?? new ChangeTrackingList<ManagedBackupShortTermRetentionPolicyData>(), nextLink, serializedAdditionalRawData);
        }
