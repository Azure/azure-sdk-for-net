...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ManagedBackupShortTermRetentionPolicyListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<ManagedBackupShortTermRetentionPolicyListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ManagedBackupShortTermRetentionPolicyListResult>)} interface");
            }
        ...
        string IPersistableModel<ManagedBackupShortTermRetentionPolicyListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
