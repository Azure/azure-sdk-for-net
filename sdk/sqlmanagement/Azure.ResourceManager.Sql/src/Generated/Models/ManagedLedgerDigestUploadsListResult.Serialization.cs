...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        internal static ManagedLedgerDigestUploadsListResult DeserializeManagedLedgerDigestUploadsListResult(JsonElement element)
        {
            ...
            return new ManagedLedgerDigestUploadsListResult(Optional.ToList(value), nextLink.Value);
        }
    }
}
