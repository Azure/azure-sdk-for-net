...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    public partial class RecommendedActionImpactRecord
    {
        ...
        internal RecommendedActionImpactRecord(string dimensionName, string unit, double? absoluteValue, double? changeValueAbsolute, double? changeValueRelative, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
