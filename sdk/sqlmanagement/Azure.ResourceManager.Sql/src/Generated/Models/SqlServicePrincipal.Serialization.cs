...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SqlServicePrincipal>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SqlServicePrincipal>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SqlServicePrincipal>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<SqlServicePrincipal>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
