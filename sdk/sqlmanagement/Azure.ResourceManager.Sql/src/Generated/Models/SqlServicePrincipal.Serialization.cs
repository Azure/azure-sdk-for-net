...
{
    public partial class SqlServicePrincipal : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static SqlServicePrincipal DeserializeSqlServicePrincipal(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
