...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    public partial class RecommendedActionMetricInfo
    {
        ...
        internal RecommendedActionMetricInfo(string metricName, string unit, string timeGrain, DateTimeOffset? startOn, double? value, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
