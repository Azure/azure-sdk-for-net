...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataMaskingRuleListResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (options.Format != "W" && Optional.IsCollectionDefined(Value))
            {
                ...
                {
                    ((IJsonModel<DataMaskingRule>)item).Write(writer, options);
                }
        ...
        internal static DataMaskingRuleListResult DeserializeDataMaskingRuleListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new DataMaskingRuleListResult(value ?? new ChangeTrackingList<DataMaskingRule>(), nextLink, serializedAdditionalRawData);
        }
