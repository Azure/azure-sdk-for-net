...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SqlResourceMoveDefinition>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SqlResourceMoveDefinition>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SqlResourceMoveDefinition>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<SqlResourceMoveDefinition>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
