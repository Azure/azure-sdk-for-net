...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    public partial class MaxSizeRangeCapability
    {
        ...
        internal MaxSizeRangeCapability(MaxSizeCapability minValue, MaxSizeCapability maxValue, MaxSizeCapability scaleSize, LogSizeCapability logSize, SqlCapabilityStatus? status, string reason, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            MinValue = minValue;
            MaxValue = maxValue;
            ScaleSize = scaleSize;
