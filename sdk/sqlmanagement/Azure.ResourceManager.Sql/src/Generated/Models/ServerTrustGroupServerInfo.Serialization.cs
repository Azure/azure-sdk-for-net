...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ServerTrustGroupServerInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ServerTrustGroupServerInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ServerTrustGroupServerInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<ServerTrustGroupServerInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
