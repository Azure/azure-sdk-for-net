...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<InstanceFailoverGroupReadWriteEndpoint>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<InstanceFailoverGroupReadWriteEndpoint>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<InstanceFailoverGroupReadWriteEndpoint>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<InstanceFailoverGroupReadWriteEndpoint>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
