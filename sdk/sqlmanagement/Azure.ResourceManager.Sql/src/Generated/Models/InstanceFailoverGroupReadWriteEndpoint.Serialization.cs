...
{
    public partial class InstanceFailoverGroupReadWriteEndpoint : IUtf8JsonSerializable, IJsonModel<InstanceFailoverGroupReadWriteEndpoint>, IPersistableModel<InstanceFailoverGroupReadWriteEndpoint>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(FailoverWithDataLossGracePeriodMinutes))
            {
                ...
                builder.AppendLine($" '{FailoverWithDataLossGracePeriodMinutes.Value.ToString()}'");
            }
