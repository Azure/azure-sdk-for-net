...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    internal partial class SecurityAlertsPolicyProperties
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="SecurityAlertsPolicyProperties"/>. </summary>
        ...
        public SecurityAlertsPolicyProperties(SecurityAlertsPolicyState state)
        {
            State = state;
        ...
        internal SecurityAlertsPolicyProperties(SecurityAlertsPolicyState state, IList<string> disabledAlerts, IList<string> emailAddresses, bool? emailAccountAdmins, string storageEndpoint, string storageAccountAccessKey, int? retentionDays, DateTimeOffset? createdOn, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            State = state;
