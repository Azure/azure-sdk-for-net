...
{
    public partial class RecommendedActionAutoGenerated : IUtf8JsonSerializable, IJsonModel<RecommendedActionAutoGenerated>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RecommendedActionAutoGenerated>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<RecommendedActionAutoGenerated>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<RecommendedActionAutoGenerated>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(RecommendedActionAutoGenerated)} does not support writing '{format}' format.");
            }
        ...
        RecommendedActionAutoGenerated IJsonModel<RecommendedActionAutoGenerated>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<RecommendedActionAutoGenerated>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(RecommendedActionAutoGenerated)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeRecommendedActionAutoGenerated(document.RootElement, options);
        }

        internal static RecommendedActionAutoGenerated DeserializeRecommendedActionAutoGenerated(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<RecommendedActionAutoGenerated>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<RecommendedActionAutoGenerated>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(RecommendedActionAutoGenerated)} does not support writing '{options.Format}' format.");
            }
        }

        RecommendedActionAutoGenerated IPersistableModel<RecommendedActionAutoGenerated>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<RecommendedActionAutoGenerated>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(RecommendedActionAutoGenerated)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<RecommendedActionAutoGenerated>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
