...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        internal static ServerOperationListResult DeserializeServerOperationListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
