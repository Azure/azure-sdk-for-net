...
namespace Azure.ResourceManager.Sql
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RecommendedActionData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RecommendedActionData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RecommendedActionData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RecommendedActionData>)} interface");
            }
        ...
        string IPersistableModel<RecommendedActionData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
