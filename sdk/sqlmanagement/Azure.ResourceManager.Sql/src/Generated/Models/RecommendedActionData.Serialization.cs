        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(State) || hasPropertyOverride)
            {
                ...
                else
                {
                    ...
                    AppendChildObject(builder, State, options, currentIndent, false);
                    if (builder.Length == length + emptyObjectLength)
                    {
                        builder.Length = builder.Length - emptyObjectLength - "    state: ".Length;
                    }
                }
            }
            ...
            if (Optional.IsDefined(ImplementationDetails) || hasPropertyOverride)
            {
                ...
                else
                {
                    ...
                    int emptyObjectLength = 2 + currentIndent + Environment.NewLine.Length + Environment.NewLine.Length;
                    int length = builder.Length;
                    AppendChildObject(builder, ImplementationDetails, options, currentIndent, false);
                    if (builder.Length == length + emptyObjectLength)
                    {
                        builder.Length = builder.Length - emptyObjectLength - "    implementationDetails: ".Length;
                    }
                }
            }
            ...
            if (Optional.IsDefined(ErrorDetails) || hasPropertyOverride)
            {
                ...
                else
                {
                    ...
                    int emptyObjectLength = 2 + currentIndent + Environment.NewLine.Length + Environment.NewLine.Length;
                    int length = builder.Length;
                    AppendChildObject(builder, ErrorDetails, options, currentIndent, false);
                    if (builder.Length == length + emptyObjectLength)
                    {
                        builder.Length = builder.Length - emptyObjectLength - "    errorDetails: ".Length;
                    }
                }
            }
                ...
                if (EstimatedImpact.Any() || hasPropertyOverride)
                {
                    ...
                    else
                    {
                        ...
                        foreach (var item in EstimatedImpact)
                        {
                            ...
                            if (builder.Length == length + emptyObjectLength)
                            {
                                builder.Length = builder.Length - emptyObjectLength - "    estimatedImpact: ".Length;
                            }
                        }
                        builder.AppendLine("    ]");
                    }
                ...
                if (ObservedImpact.Any() || hasPropertyOverride)
                {
                    ...
                    else
                    {
                        ...
                        foreach (var item in ObservedImpact)
                        {
                            ...
                            if (builder.Length == length + emptyObjectLength)
                            {
                                builder.Length = builder.Length - emptyObjectLength - "    observedImpact: ".Length;
                            }
                        }
                        builder.AppendLine("    ]");
                    }
                ...
                if (TimeSeries.Any() || hasPropertyOverride)
                {
                    ...
                    else
                    {
                        ...
                        foreach (var item in TimeSeries)
                        {
                            ...
                            if (builder.Length == length + emptyObjectLength)
                            {
                                builder.Length = builder.Length - emptyObjectLength - "    timeSeries: ".Length;
                            }
                        }
                        builder.AppendLine("    ]");
                    }
