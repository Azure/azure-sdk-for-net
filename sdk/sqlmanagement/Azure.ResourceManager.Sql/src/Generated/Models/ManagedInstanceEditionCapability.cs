...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    public partial class ManagedInstanceEditionCapability
    {
        ...
        internal ManagedInstanceEditionCapability(string name, IReadOnlyList<ManagedInstanceFamilyCapability> supportedFamilies, IReadOnlyList<StorageCapability> supportedStorageCapabilities, bool? isZoneRedundant, SqlCapabilityStatus? status, string reason, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
