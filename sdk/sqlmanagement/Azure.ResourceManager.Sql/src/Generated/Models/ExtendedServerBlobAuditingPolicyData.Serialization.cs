...
namespace Azure.ResourceManager.Sql
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ExtendedServerBlobAuditingPolicyData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ExtendedServerBlobAuditingPolicyData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ExtendedServerBlobAuditingPolicyData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ExtendedServerBlobAuditingPolicyData>)} interface");
            }
        ...
        string IPersistableModel<ExtendedServerBlobAuditingPolicyData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
