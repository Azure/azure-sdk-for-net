...
{
    public partial class SqlServerJobExecutionData : IUtf8JsonSerializable, IJsonModel<SqlServerJobExecutionData>, IPersistableModel<SqlServerJobExecutionData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(JobVersion))
            {
                ...
                builder.AppendLine($" '{JobVersion.Value.ToString()}'");
            }
            ...
            if (Optional.IsDefined(Lifecycle))
            {
                ...
                builder.AppendLine($" '{Lifecycle.ToString()}'");
            }
            ...
            if (Optional.IsDefined(CurrentAttempts))
            {
                ...
                builder.AppendLine($" '{CurrentAttempts.Value.ToString()}'");
            }

            if (Optional.IsDefined(CurrentAttemptStartOn))
            {
                builder.Append("  currentAttemptStartTime:");
                builder.AppendLine($" '{CurrentAttemptStartOn.Value.ToString()}'");
            }
            ...
            if (Optional.IsDefined(Target))
            {
                ...
                AppendChildObject(builder, Target, options, 2);
            }
