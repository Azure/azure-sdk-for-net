...
{
    public partial class RecommendedActionAutoGenerated2 : IUtf8JsonSerializable, IJsonModel<RecommendedActionAutoGenerated2>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RecommendedActionAutoGenerated2>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<RecommendedActionAutoGenerated2>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<RecommendedActionAutoGenerated2>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(RecommendedActionAutoGenerated2)} does not support writing '{format}' format.");
            }
        ...
        RecommendedActionAutoGenerated2 IJsonModel<RecommendedActionAutoGenerated2>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<RecommendedActionAutoGenerated2>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(RecommendedActionAutoGenerated2)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeRecommendedActionAutoGenerated2(document.RootElement, options);
        }

        internal static RecommendedActionAutoGenerated2 DeserializeRecommendedActionAutoGenerated2(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<RecommendedActionAutoGenerated2>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<RecommendedActionAutoGenerated2>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(RecommendedActionAutoGenerated2)} does not support writing '{options.Format}' format.");
            }
        }

        RecommendedActionAutoGenerated2 IPersistableModel<RecommendedActionAutoGenerated2>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<RecommendedActionAutoGenerated2>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(RecommendedActionAutoGenerated2)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<RecommendedActionAutoGenerated2>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
