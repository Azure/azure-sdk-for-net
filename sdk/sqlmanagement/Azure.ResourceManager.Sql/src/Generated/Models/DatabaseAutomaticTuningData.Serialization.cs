...
{
    public partial class DatabaseAutomaticTuningData : IUtf8JsonSerializable
    {
        ...
        internal static DatabaseAutomaticTuningData DeserializeDatabaseAutomaticTuningData(JsonElement element)
        {
            ...
            return new DatabaseAutomaticTuningData(id, name, type, systemData.Value, Optional.ToNullable(desiredState), Optional.ToNullable(actualState), Optional.ToDictionary(options));
        }
    }
}
