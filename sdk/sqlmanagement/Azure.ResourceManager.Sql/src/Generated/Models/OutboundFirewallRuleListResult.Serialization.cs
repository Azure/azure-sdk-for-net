...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        internal static OutboundFirewallRuleListResult DeserializeOutboundFirewallRuleListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
