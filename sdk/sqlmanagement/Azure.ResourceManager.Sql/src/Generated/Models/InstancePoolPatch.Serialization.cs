...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<InstancePoolPatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<InstancePoolPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<InstancePoolPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<InstancePoolPatch>)} interface");
            }
        ...
        string IPersistableModel<InstancePoolPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
