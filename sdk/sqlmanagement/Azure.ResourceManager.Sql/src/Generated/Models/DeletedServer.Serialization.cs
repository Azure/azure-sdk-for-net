...
{
    public partial class DeletedServer : IUtf8JsonSerializable
    {
        ...
        internal static DeletedServer DeserializeDeletedServer(JsonElement element)
        {
            ...
            return new DeletedServer(id.Value, name.Value, type.Value, version.Value, Optional.ToNullable(deletionTime), originalId.Value, fullyQualifiedDomainName.Value);
        }
    }
}
