...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    public partial class ManagedInstanceExternalAdministrator
    {
        ...
        internal ManagedInstanceExternalAdministrator(SqlAdministratorType? administratorType, SqlServerPrincipalType? principalType, string login, Guid? sid, Guid? tenantId, bool? isAzureADOnlyAuthenticationEnabled, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
