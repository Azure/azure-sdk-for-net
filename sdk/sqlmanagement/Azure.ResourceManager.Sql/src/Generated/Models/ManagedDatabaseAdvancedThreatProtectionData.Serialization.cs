...
{
    public partial class ManagedDatabaseAdvancedThreatProtectionData : Core.IUtf8JsonSerializable
    {
        ...
        internal static ManagedDatabaseAdvancedThreatProtectionData DeserializeManagedDatabaseAdvancedThreatProtectionData(JsonElement element)
        {
            ...
            return new ManagedDatabaseAdvancedThreatProtectionData(id, name, type, systemData.Value, Core.Optional.ToNullable(state), Core.Optional.ToNullable(creationTime));
        }
    }
}
