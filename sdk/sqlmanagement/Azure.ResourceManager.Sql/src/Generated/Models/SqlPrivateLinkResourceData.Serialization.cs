...
{
    public partial class SqlPrivateLinkResourceData : IUtf8JsonSerializable
    {
        ...
        internal static SqlPrivateLinkResourceData DeserializeSqlPrivateLinkResourceData(JsonElement element)
        {
            ...
            return new SqlPrivateLinkResourceData(id, name, type, systemData.Value, properties.Value);
        }
    }
}
