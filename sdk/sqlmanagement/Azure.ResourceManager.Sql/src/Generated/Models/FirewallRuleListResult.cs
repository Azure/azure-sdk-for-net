...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    internal partial class FirewallRuleListResult
    {
        ...
        internal FirewallRuleListResult(IEnumerable<SqlFirewallRuleData> value)
        {
            Value = value.ToList();
        }
        ...
        internal FirewallRuleListResult(IList<SqlFirewallRuleData> value, Uri nextLink, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            NextLink = nextLink;
        ...
        [WirePath("value")]
        public IList<SqlFirewallRuleData> Value { get; }
