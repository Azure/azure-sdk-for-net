...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        internal static ElasticPoolActivityListResult DeserializeElasticPoolActivityListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
