...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        internal static SqlServerVersionCapability DeserializeSqlServerVersionCapability(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
