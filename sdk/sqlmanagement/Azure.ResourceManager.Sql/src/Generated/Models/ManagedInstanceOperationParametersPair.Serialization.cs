...
{
    public partial class ManagedInstanceOperationParametersPair : IUtf8JsonSerializable, IJsonModel<ManagedInstanceOperationParametersPair>, IPersistableModel<ManagedInstanceOperationParametersPair>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(CurrentParameters))
            {
                ...
                AppendChildObject(builder, CurrentParameters, options, 2);
            }

            if (Optional.IsDefined(RequestedParameters))
            {
                builder.Append("  requestedParameters:");
                AppendChildObject(builder, RequestedParameters, options, 2);
            }
