...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SyncFullSchemaTable>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SyncFullSchemaTable>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SyncFullSchemaTable>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SyncFullSchemaTable>)} interface");
            }
        ...
        string IPersistableModel<SyncFullSchemaTable>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
