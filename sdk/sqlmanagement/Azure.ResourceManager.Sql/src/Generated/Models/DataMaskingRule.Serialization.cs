...
{
    public partial class DataMaskingRule : IUtf8JsonSerializable, IModelJsonSerializable<DataMaskingRule>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IModelJsonSerializable<DataMaskingRule>)this).Serialize(writer, ModelSerializerOptions.DefaultWireOptions);

        void IModelJsonSerializable<DataMaskingRule>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<DataMaskingRule>(this, options.Format);
        ...
        internal static DataMaskingRule DeserializeDataMaskingRule(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new DataMaskingRule(id, name, type, systemData.Value, Optional.ToNullable(location), kind.Value, aliasName.Value, Optional.ToNullable(ruleState), schemaName.Value, tableName.Value, columnName.Value, Optional.ToNullable(maskingFunction), numberFrom.Value, numberTo.Value, prefixSize.Value, suffixSize.Value, replacementString.Value, rawData);
        }

        DataMaskingRule IModelJsonSerializable<DataMaskingRule>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<DataMaskingRule>(this, options.Format);

            using var doc = JsonDocument.ParseValue(ref reader);
            return DeserializeDataMaskingRule(doc.RootElement, options);
        }

        BinaryData IModelSerializable<DataMaskingRule>.Serialize(ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<DataMaskingRule>(this, options.Format);
        ...
        DataMaskingRule IModelSerializable<DataMaskingRule>.Deserialize(BinaryData data, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<DataMaskingRule>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="DataMaskingRule"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="DataMaskingRule"/> to convert. </param>
        public static implicit operator RequestContent(DataMaskingRule model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="DataMaskingRule"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator DataMaskingRule(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeDataMaskingRule(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
