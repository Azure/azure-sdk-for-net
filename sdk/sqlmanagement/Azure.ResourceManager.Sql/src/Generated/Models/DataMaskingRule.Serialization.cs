...
{
    public partial class DataMaskingRule : IUtf8JsonSerializable, IJsonModel<DataMaskingRule>, IPersistableModel<DataMaskingRule>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(RuleState))
            {
                ...
                builder.AppendLine($" '{RuleState.ToString()}'");
            }
            ...
            if (Optional.IsDefined(MaskingFunction))
            {
                ...
                builder.AppendLine($" '{MaskingFunction.ToString()}'");
            }
