...
{
    public partial class DataMaskingRule : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static DataMaskingRule DeserializeDataMaskingRule(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
