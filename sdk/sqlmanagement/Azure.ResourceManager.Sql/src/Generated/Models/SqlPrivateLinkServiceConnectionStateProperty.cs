...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    public partial class SqlPrivateLinkServiceConnectionStateProperty
    {
        ...
        internal SqlPrivateLinkServiceConnectionStateProperty(SqlPrivateLinkServiceConnectionStatus status, string description, SqlPrivateLinkServiceConnectionActionsRequired? actionsRequired, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Status = status;
            Description = description;
