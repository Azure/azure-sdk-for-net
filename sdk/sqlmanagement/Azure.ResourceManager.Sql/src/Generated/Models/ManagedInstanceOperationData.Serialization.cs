        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(OperationParameters) || hasPropertyOverride)
            {
                ...
                else
                {
                    ...
                    AppendChildObject(builder, OperationParameters, options, currentIndent, false);
                    if (builder.Length == length + emptyObjectLength)
                    {
                        builder.Length = builder.Length - emptyObjectLength - "    operationParameters: ".Length;
                    }
                }
            }
            ...
            if (Optional.IsDefined(OperationSteps) || hasPropertyOverride)
            {
                ...
                else
                {
                    ...
                    int emptyObjectLength = 2 + currentIndent + Environment.NewLine.Length + Environment.NewLine.Length;
                    int length = builder.Length;
                    AppendChildObject(builder, OperationSteps, options, currentIndent, false);
                    if (builder.Length == length + emptyObjectLength)
                    {
                        builder.Length = builder.Length - emptyObjectLength - "    operationSteps: ".Length;
                    }
                }
            }
