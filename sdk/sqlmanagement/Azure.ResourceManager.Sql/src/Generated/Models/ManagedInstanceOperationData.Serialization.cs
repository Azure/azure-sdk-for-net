...
{
    public partial class ManagedInstanceOperationData : IUtf8JsonSerializable, IJsonModel<ManagedInstanceOperationData>, IPersistableModel<ManagedInstanceOperationData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(OperationParameters))
            {
                ...
                AppendChildObject(builder, OperationParameters, options, 2);
            }

            if (Optional.IsDefined(OperationSteps))
            {
                builder.Append("  operationSteps:");
                AppendChildObject(builder, OperationSteps, options, 2);
            }
