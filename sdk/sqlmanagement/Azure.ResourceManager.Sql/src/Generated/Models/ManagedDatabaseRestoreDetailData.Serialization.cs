...
{
    public partial class ManagedDatabaseRestoreDetailData : IUtf8JsonSerializable, IJsonModel<ManagedDatabaseRestoreDetailData>, IPersistableModel<ManagedDatabaseRestoreDetailData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(LastUploadedFileOn))
            {
                ...
                builder.AppendLine($" '{LastUploadedFileOn.Value.ToString()}'");
            }
            ...
            if (Optional.IsDefined(LastRestoredFileOn))
            {
                ...
                builder.AppendLine($" '{LastRestoredFileOn.Value.ToString()}'");
            }
            ...
            if (Optional.IsDefined(CurrentRestoredSizeInMB))
            {
                ...
                builder.AppendLine($" '{CurrentRestoredSizeInMB.Value.ToString()}'");
            }

            if (Optional.IsDefined(CurrentRestorePlanSizeInMB))
            {
                builder.Append("  currentRestorePlanSizeMB:");
                builder.AppendLine($" '{CurrentRestorePlanSizeInMB.Value.ToString()}'");
            }
