                ...
                if (FullBackupSets.Any() || hasPropertyOverride)
                {
                    ...
                    else
                    {
                        ...
                        foreach (var item in FullBackupSets)
                        {
                            ...
                            {
                                builder.Length = builder.Length - emptyObjectLength - "    fullBackupSets: ".Length;
                            }
                        }
                        builder.AppendLine("    ]");
                    }
                ...
                if (DiffBackupSets.Any() || hasPropertyOverride)
                {
                    ...
                    else
                    {
                        ...
                        foreach (var item in DiffBackupSets)
                        {
                            ...
                            if (builder.Length == length + emptyObjectLength)
                            {
                                builder.Length = builder.Length - emptyObjectLength - "    diffBackupSets: ".Length;
                            }
                        }
                        builder.AppendLine("    ]");
                    }
                ...
                if (LogBackupSets.Any() || hasPropertyOverride)
                {
                    ...
                    else
                    {
                        ...
                        foreach (var item in LogBackupSets)
                        {
                            ...
                            if (builder.Length == length + emptyObjectLength)
                            {
                                builder.Length = builder.Length - emptyObjectLength - "    logBackupSets: ".Length;
                            }
                        }
                        builder.AppendLine("    ]");
                    }
                ...
                if (UnrestorableFileList.Any() || hasPropertyOverride)
                {
                    ...
                    else
                    {
                        ...
                        foreach (var item in UnrestorableFileList)
                        {
                            ...
                            if (builder.Length == length + emptyObjectLength)
                            {
                                builder.Length = builder.Length - emptyObjectLength - "    unrestorableFiles: ".Length;
                            }
                        }
                        builder.AppendLine("    ]");
                    }
