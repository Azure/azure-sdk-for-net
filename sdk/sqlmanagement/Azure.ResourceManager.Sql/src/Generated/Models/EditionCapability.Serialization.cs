...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EditionCapability>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<EditionCapability>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<EditionCapability>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<EditionCapability>)} interface");
            }
        ...
        string IPersistableModel<EditionCapability>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
