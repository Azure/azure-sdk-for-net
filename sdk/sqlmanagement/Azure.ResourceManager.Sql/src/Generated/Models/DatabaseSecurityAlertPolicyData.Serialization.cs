...
{
    public partial class DatabaseSecurityAlertPolicyData : IUtf8JsonSerializable
    {
        ...
        internal static DatabaseSecurityAlertPolicyData DeserializeDatabaseSecurityAlertPolicyData(JsonElement element)
        {
            ...
            return new DatabaseSecurityAlertPolicyData(id, name, type, systemData, Optional.ToNullable(state), Optional.ToList(disabledAlerts), Optional.ToList(emailAddresses), Optional.ToNullable(emailAccountAdmins), storageEndpoint.Value, storageAccountAccessKey.Value, Optional.ToNullable(retentionDays), Optional.ToNullable(creationTime));
        }
    }
}
