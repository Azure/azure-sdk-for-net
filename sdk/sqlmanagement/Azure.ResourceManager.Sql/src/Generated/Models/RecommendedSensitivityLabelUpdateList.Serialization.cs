...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RecommendedSensitivityLabelUpdateList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RecommendedSensitivityLabelUpdateList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RecommendedSensitivityLabelUpdateList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RecommendedSensitivityLabelUpdateList>)} interface");
            }
        ...
        string IPersistableModel<RecommendedSensitivityLabelUpdateList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
