...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RecommendedSensitivityLabelUpdateList>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        RecommendedSensitivityLabelUpdateList IJsonModel<RecommendedSensitivityLabelUpdateList>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
                throw new FormatException($"The model {nameof(RecommendedSensitivityLabelUpdateList)} does not support '{options.Format}' format.");
            }
        ...
        BinaryData IModel<RecommendedSensitivityLabelUpdateList>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        RecommendedSensitivityLabelUpdateList IModel<RecommendedSensitivityLabelUpdateList>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<RecommendedSensitivityLabelUpdateList>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
