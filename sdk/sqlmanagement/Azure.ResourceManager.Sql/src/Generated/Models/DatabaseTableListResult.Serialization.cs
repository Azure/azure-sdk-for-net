...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DatabaseTableListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DatabaseTableListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DatabaseTableListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DatabaseTableListResult>)} interface");
            }
        ...
        string IPersistableModel<DatabaseTableListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
