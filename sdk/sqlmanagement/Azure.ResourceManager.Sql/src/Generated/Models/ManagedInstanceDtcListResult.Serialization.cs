...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        internal static ManagedInstanceDtcListResult DeserializeManagedInstanceDtcListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
