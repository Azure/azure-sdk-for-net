...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        internal static GeoBackupPolicyListResult DeserializeGeoBackupPolicyListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
