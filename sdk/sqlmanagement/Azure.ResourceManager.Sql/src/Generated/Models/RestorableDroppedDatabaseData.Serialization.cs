...
namespace Azure.ResourceManager.Sql
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RestorableDroppedDatabaseData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RestorableDroppedDatabaseData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RestorableDroppedDatabaseData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RestorableDroppedDatabaseData>)} interface");
            }
        ...
        string IPersistableModel<RestorableDroppedDatabaseData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
