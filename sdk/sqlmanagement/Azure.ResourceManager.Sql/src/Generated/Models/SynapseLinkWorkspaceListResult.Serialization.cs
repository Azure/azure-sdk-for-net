...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        internal static SynapseLinkWorkspaceListResult DeserializeSynapseLinkWorkspaceListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
