...
namespace Azure.ResourceManager.Sql.Models
{
    public partial class FailoverGroupReadWriteEndpoint : IUtf8JsonSerializable, IJsonModel<FailoverGroupReadWriteEndpoint>
    {
        ...
        void IJsonModel<FailoverGroupReadWriteEndpoint>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(FailoverGroupReadWriteEndpoint)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<FailoverGroupReadWriteEndpoint>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(FailoverGroupReadWriteEndpoint)} does not support '{options.Format}' format.");
            }
        }
