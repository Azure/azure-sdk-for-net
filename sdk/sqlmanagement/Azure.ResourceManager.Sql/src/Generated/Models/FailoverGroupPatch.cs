...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    public partial class FailoverGroupPatch
    {
        ...
        internal FailoverGroupPatch(IDictionary<string, string> tags, FailoverGroupReadWriteEndpoint readWriteEndpoint, FailoverGroupReadOnlyEndpoint readOnlyEndpoint, IList<string> databases, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Tags = tags;
