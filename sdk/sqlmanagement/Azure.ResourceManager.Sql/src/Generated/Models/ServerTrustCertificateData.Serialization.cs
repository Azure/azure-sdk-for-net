...
namespace Azure.ResourceManager.Sql
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ServerTrustCertificateData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ServerTrustCertificateData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ServerTrustCertificateData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ServerTrustCertificateData>)} interface");
            }
        ...
        string IPersistableModel<ServerTrustCertificateData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
