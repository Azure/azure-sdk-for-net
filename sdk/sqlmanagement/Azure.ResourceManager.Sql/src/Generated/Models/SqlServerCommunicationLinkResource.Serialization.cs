...
namespace Azure.ResourceManager.Sql
{
    public partial class SqlServerCommunicationLinkResource : IJsonModel<SqlServerCommunicationLinkData>
    {
        ...
        {
            return ModelReaderWriter.Read<SqlServerCommunicationLinkData>(new BinaryData(reader.ValueSequence), options);
        }
        ...
        {
            return ModelReaderWriter.Read<SqlServerCommunicationLinkData>(data, options);
        }
