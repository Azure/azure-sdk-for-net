...
{
    public partial class InstancePoolVcoresCapability : IUtf8JsonSerializable, IJsonModel<InstancePoolVcoresCapability>, IPersistableModel<InstancePoolVcoresCapability>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(StorageLimit))
            {
                ...
                AppendChildObject(builder, StorageLimit, options, 2);
            }
