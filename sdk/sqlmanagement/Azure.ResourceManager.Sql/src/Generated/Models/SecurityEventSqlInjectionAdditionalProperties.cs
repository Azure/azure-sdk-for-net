...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    public partial class SecurityEventSqlInjectionAdditionalProperties
    {
        ...
        internal SecurityEventSqlInjectionAdditionalProperties(string threatId, string statement, int? statementHighlightOffset, int? statementHighlightLength, int? errorCode, int? errorSeverity, string errorMessage, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ThreatId = threatId;
            Statement = statement;
