...
{
    public partial class ExtendedDatabaseBlobAuditingPolicyData : IUtf8JsonSerializable, IJsonModel<ExtendedDatabaseBlobAuditingPolicyData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ExtendedDatabaseBlobAuditingPolicyData>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        ExtendedDatabaseBlobAuditingPolicyData IJsonModel<ExtendedDatabaseBlobAuditingPolicyData>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        internal static ExtendedDatabaseBlobAuditingPolicyData DeserializeExtendedDatabaseBlobAuditingPolicyData(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IModel<ExtendedDatabaseBlobAuditingPolicyData>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ExtendedDatabaseBlobAuditingPolicyData IModel<ExtendedDatabaseBlobAuditingPolicyData>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<ExtendedDatabaseBlobAuditingPolicyData>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
