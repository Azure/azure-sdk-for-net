...
namespace Azure.ResourceManager.Sql
{
    public partial class ExtendedDatabaseBlobAuditingPolicyData : IUtf8JsonSerializable, IJsonModel<ExtendedDatabaseBlobAuditingPolicyData>
    {
        ...
        void IJsonModel<ExtendedDatabaseBlobAuditingPolicyData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(ExtendedDatabaseBlobAuditingPolicyData)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ExtendedDatabaseBlobAuditingPolicyData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(ExtendedDatabaseBlobAuditingPolicyData)} does not support '{options.Format}' format.");
            }
        }
