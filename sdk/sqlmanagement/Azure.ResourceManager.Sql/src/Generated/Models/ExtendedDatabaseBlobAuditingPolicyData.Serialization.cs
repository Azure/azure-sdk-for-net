...
namespace Azure.ResourceManager.Sql
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ExtendedDatabaseBlobAuditingPolicyData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ExtendedDatabaseBlobAuditingPolicyData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ExtendedDatabaseBlobAuditingPolicyData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ExtendedDatabaseBlobAuditingPolicyData>)} interface");
            }
        ...
        string IPersistableModel<ExtendedDatabaseBlobAuditingPolicyData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
