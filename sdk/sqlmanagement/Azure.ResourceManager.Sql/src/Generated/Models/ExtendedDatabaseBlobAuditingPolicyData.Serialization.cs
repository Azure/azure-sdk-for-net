...
namespace Azure.ResourceManager.Sql
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ExtendedDatabaseBlobAuditingPolicyData>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<ExtendedDatabaseBlobAuditingPolicyData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ExtendedDatabaseBlobAuditingPolicyData>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
