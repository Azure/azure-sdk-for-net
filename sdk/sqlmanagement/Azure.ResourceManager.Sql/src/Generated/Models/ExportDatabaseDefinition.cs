...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="ExportDatabaseDefinition"/>. </summary>
        ...
        public ExportDatabaseDefinition(StorageKeyType storageKeyType, string storageKey, Uri storageUri, string administratorLogin, string administratorLoginPassword)
        {
            if (storageKey == null)
            {
