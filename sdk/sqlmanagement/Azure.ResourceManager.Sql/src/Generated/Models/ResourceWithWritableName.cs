...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    public partial class ResourceWithWritableName
    {
        ...
        internal ResourceWithWritableName(ResourceIdentifier id, string name, ResourceType? resourceType, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Name = name;
