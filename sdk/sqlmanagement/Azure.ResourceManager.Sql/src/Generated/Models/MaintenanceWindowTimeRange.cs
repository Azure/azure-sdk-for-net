...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    public partial class MaintenanceWindowTimeRange
    {
        ...
        internal MaintenanceWindowTimeRange(SqlDayOfWeek? dayOfWeek, string startTime, TimeSpan? duration, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            DayOfWeek = dayOfWeek;
            StartTime = startTime;
            Duration = duration;
