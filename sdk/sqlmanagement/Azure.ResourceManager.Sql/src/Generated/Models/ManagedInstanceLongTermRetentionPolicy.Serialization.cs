...
{
    public partial class ManagedInstanceLongTermRetentionPolicy : IUtf8JsonSerializable
    {
        ...
        internal static ManagedInstanceLongTermRetentionPolicy DeserializeManagedInstanceLongTermRetentionPolicy(JsonElement element)
        {
            ...
            return new ManagedInstanceLongTermRetentionPolicy(id.Value, name.Value, type.Value, weeklyRetention.Value, monthlyRetention.Value, yearlyRetention.Value, Optional.ToNullable(weekOfYear));
        }
    }
}
