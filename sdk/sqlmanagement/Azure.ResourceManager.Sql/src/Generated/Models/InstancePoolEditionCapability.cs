...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    public partial class InstancePoolEditionCapability
    {
        ...
        internal InstancePoolEditionCapability(string name, IReadOnlyList<InstancePoolFamilyCapability> supportedFamilies, SqlCapabilityStatus? status, string reason, Dictionary<string, BinaryData> rawData)
        {
            Name = name;
