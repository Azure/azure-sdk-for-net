...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    public partial class NSPConfigAccessRuleProperties
    {
        ...
        internal NSPConfigAccessRuleProperties(string direction, IList<string> addressPrefixes, IList<string> fullyQualifiedDomainNames, IList<string> subscriptions, IList<NSPConfigNetworkSecurityPerimeterRule> networkSecurityPerimeters, IList<string> serviceTags, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Direction = direction;
