...
{
    /// <summary> A class representing the query and header parameters in GetJobExecutionsByAgent method. </summary>
    public partial class SqlServerJobAgentGetJobExecutionsByAgentOptions
    {
        /// <summary> Initializes a new instance of SqlServerJobAgentGetJobExecutionsByAgentOptions. </summary>
        public SqlServerJobAgentGetJobExecutionsByAgentOptions()
        {
        }
