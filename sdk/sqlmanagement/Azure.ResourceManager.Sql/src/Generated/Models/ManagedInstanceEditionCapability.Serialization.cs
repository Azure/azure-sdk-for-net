...
namespace Azure.ResourceManager.Sql.Models
{
    public partial class ManagedInstanceEditionCapability
    {
        internal static ManagedInstanceEditionCapability DeserializeManagedInstanceEditionCapability(JsonElement element)
        {
            ...
            Core.Optional<IReadOnlyList<ManagedInstanceFamilyCapability>> supportedFamilies = default;
            ...
            return new ManagedInstanceEditionCapability(name.Value, Core.Optional.ToList(supportedFamilies), Core.Optional.ToList(supportedStorageCapabilities), Core.Optional.ToNullable(zoneRedundant), Core.Optional.ToNullable(status), reason.Value);
        }
    }
}
