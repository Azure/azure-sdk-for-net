...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        internal static ManagedInstanceEditionCapability DeserializeManagedInstanceEditionCapability(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
