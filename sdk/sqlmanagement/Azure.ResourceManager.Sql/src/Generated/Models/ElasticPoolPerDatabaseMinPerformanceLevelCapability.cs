...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    public partial class ElasticPoolPerDatabaseMinPerformanceLevelCapability
    {
        ...
        internal ElasticPoolPerDatabaseMinPerformanceLevelCapability(double? limit, PerformanceLevelUnit? unit, SqlCapabilityStatus? status, string reason, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Limit = limit;
            Unit = unit;
            Status = status;
