...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    public partial class LongTermRetentionPolicy : ProxyResource
    {
        ...
        internal LongTermRetentionPolicy(string id, string name, string type, string weeklyRetention, string monthlyRetention, string yearlyRetention, int? weekOfYear) : base(id, name, type)
        {
