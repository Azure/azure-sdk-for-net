...
{
    public partial class MaintenanceWindowTimeRange : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static MaintenanceWindowTimeRange DeserializeMaintenanceWindowTimeRange(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
