...
namespace Azure.ResourceManager.Sql
{
    public partial class ServerDevOpsAuditingSettingsData : IUtf8JsonSerializable
    {
        ...
        internal static ServerDevOpsAuditingSettingsData DeserializeServerDevOpsAuditingSettingsData(JsonElement element)
        {
            ...
            return new ServerDevOpsAuditingSettingsData(id, name, type, systemData.Value, Optional.ToNullable(isAzureMonitorTargetEnabled), Optional.ToNullable(state), storageEndpoint.Value, storageAccountAccessKey.Value, Optional.ToNullable(storageAccountSubscriptionId));
        }
    }
}
