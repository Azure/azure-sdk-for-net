...
namespace Azure.ResourceManager.Sql
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SqlServerAutomaticTuningData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SqlServerAutomaticTuningData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SqlServerAutomaticTuningData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SqlServerAutomaticTuningData>)} interface");
            }
        ...
        string IPersistableModel<SqlServerAutomaticTuningData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
