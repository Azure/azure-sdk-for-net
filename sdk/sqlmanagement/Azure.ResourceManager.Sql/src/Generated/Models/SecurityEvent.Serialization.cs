...
{
    public partial class SecurityEvent : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static SecurityEvent DeserializeSecurityEvent(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
