...
namespace Azure.ResourceManager.Sql.Models
{
    public partial class SqlDatabasePatch : IUtf8JsonSerializable, IJsonModel<SqlDatabasePatch>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<SqlDatabasePatch>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SqlDatabasePatch>)} interface");
            }
