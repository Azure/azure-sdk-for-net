...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        internal static PerformanceLevelCapability DeserializePerformanceLevelCapability(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
