...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        internal static AzureADOnlyAuthListResult DeserializeAzureADOnlyAuthListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
