...
{
    public partial class SyncMemberData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static SyncMemberData DeserializeSyncMemberData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
