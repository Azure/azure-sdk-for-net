...
{
    public partial class AutomaticTuningOptions : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static AutomaticTuningOptions DeserializeAutomaticTuningOptions(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
