...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AutomaticTuningOptions>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AutomaticTuningOptions>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AutomaticTuningOptions>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<AutomaticTuningOptions>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
