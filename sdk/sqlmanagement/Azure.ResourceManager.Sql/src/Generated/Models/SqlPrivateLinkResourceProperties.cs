...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    public partial class SqlPrivateLinkResourceProperties
    {
        ...
        internal SqlPrivateLinkResourceProperties(string groupId, IReadOnlyList<string> requiredMembers, IReadOnlyList<string> requiredZoneNames, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            GroupId = groupId;
