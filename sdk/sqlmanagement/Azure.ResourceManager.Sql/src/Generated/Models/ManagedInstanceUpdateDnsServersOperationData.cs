...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    public partial class ManagedInstanceUpdateDnsServersOperationData : ResourceData
    {
        ...
        internal ManagedInstanceUpdateDnsServersOperationData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, DnsRefreshConfigurationPropertiesStatus? status, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
            Status = status;
