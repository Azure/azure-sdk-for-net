...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        internal static EndpointCertificateListResult DeserializeEndpointCertificateListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
