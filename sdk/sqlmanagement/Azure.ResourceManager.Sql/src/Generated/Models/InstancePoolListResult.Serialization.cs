...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<InstancePoolListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<InstancePoolListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<InstancePoolListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<InstancePoolListResult>)} interface");
            }
        ...
        string IPersistableModel<InstancePoolListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
