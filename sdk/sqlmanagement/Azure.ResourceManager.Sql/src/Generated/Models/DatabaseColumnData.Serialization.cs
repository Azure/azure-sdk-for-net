...
namespace Azure.ResourceManager.Sql
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DatabaseColumnData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DatabaseColumnData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DatabaseColumnData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DatabaseColumnData>)} interface");
            }
        ...
        string IPersistableModel<DatabaseColumnData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
