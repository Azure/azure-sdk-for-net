...
namespace Azure.ResourceManager.Sql
{
    public partial class DatabaseColumnData : IUtf8JsonSerializable, IJsonModel<DatabaseColumnData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(TemporalType) || hasPropertyOverride)
            {
            ...
            if (Optional.IsDefined(IsMemoryOptimized) || hasPropertyOverride)
            {
            ...
            if (Optional.IsDefined(IsComputed) || hasPropertyOverride)
            {
