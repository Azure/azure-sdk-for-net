...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        internal static ReplicationLinkListResult DeserializeReplicationLinkListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
