...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        internal static SqlPrivateLinkResourceListResult DeserializeSqlPrivateLinkResourceListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
