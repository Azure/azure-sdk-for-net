...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        internal static SqlPrivateLinkResourceListResult DeserializeSqlPrivateLinkResourceListResult(JsonElement element)
        {
            ...
            return new SqlPrivateLinkResourceListResult(Optional.ToList(value), nextLink.Value);
        }
    }
}
