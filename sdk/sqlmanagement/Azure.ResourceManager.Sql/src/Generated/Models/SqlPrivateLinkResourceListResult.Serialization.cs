...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SqlPrivateLinkResourceListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SqlPrivateLinkResourceListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SqlPrivateLinkResourceListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SqlPrivateLinkResourceListResult>)} interface");
            }
        ...
        string IPersistableModel<SqlPrivateLinkResourceListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
