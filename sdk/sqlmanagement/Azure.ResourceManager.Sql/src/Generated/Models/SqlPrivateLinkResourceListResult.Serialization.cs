...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SqlPrivateLinkResourceListResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (options.Format != "W" && Optional.IsCollectionDefined(Value))
            {
                ...
                {
                    ((IJsonModel<SqlPrivateLinkResourceData>)item).Write(writer, options);
                }
        ...
        internal static SqlPrivateLinkResourceListResult DeserializeSqlPrivateLinkResourceListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new SqlPrivateLinkResourceListResult(value ?? new ChangeTrackingList<SqlPrivateLinkResourceData>(), nextLink, serializedAdditionalRawData);
        }
