...
{
    public partial class WorkloadGroupData : IUtf8JsonSerializable, IModelJsonSerializable<WorkloadGroupData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IModelJsonSerializable<WorkloadGroupData>)this).Serialize(writer, ModelSerializerOptions.DefaultWireOptions);

        void IModelJsonSerializable<WorkloadGroupData>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<WorkloadGroupData>(this, options.Format);
        ...
        internal static WorkloadGroupData DeserializeWorkloadGroupData(JsonElement element, ModelSerializerOptions options = default)
        {
        ...
        WorkloadGroupData IModelJsonSerializable<WorkloadGroupData>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<WorkloadGroupData>(this, options.Format);

            using var doc = JsonDocument.ParseValue(ref reader);
            return DeserializeWorkloadGroupData(doc.RootElement, options);
        }

        BinaryData IModelSerializable<WorkloadGroupData>.Serialize(ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<WorkloadGroupData>(this, options.Format);
        ...
        WorkloadGroupData IModelSerializable<WorkloadGroupData>.Deserialize(BinaryData data, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<WorkloadGroupData>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="WorkloadGroupData"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="WorkloadGroupData"/> to convert. </param>
        public static implicit operator RequestContent(WorkloadGroupData model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="WorkloadGroupData"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator WorkloadGroupData(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeWorkloadGroupData(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
