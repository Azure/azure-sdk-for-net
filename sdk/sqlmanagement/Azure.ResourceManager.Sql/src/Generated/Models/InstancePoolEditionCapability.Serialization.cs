...
namespace Azure.ResourceManager.Sql.Models
{
    public partial class InstancePoolEditionCapability : IUtf8JsonSerializable, IJsonModel<InstancePoolEditionCapability>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<InstancePoolEditionCapability>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<InstancePoolEditionCapability>)} interface");
            }
