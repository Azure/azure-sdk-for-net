...
namespace Azure.ResourceManager.Sql
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GeoBackupPolicyData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<GeoBackupPolicyData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<GeoBackupPolicyData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<GeoBackupPolicyData>)} interface");
            }
        ...
        string IPersistableModel<GeoBackupPolicyData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
