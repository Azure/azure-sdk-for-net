...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    internal partial class DatabaseExtensionsProperties
    {
        ...
        public DatabaseExtensionsProperties(OperationMode operationMode, StorageKeyType storageKeyType, string storageKey, Uri storageUri)
        {
        ...
        internal DatabaseExtensionsProperties(OperationMode operationMode, StorageKeyType storageKeyType, string storageKey, Uri storageUri, string administratorLogin, string administratorLoginPassword, string authenticationType, string databaseEdition, string serviceObjectiveName, string maxSizeBytes, NetworkIsolationSettings networkIsolation, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            OperationMode = operationMode;
            StorageKeyType = storageKeyType;
            StorageKey = storageKey;
