...
{
    public partial class SqlAdvisorData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static SqlAdvisorData DeserializeSqlAdvisorData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
