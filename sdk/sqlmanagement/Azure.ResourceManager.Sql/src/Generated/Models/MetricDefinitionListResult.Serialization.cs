...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        internal static MetricDefinitionListResult DeserializeMetricDefinitionListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
