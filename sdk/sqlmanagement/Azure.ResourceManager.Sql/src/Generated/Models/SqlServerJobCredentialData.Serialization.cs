...
namespace Azure.ResourceManager.Sql
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SqlServerJobCredentialData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SqlServerJobCredentialData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SqlServerJobCredentialData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SqlServerJobCredentialData>)} interface");
            }
        ...
        string IPersistableModel<SqlServerJobCredentialData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
