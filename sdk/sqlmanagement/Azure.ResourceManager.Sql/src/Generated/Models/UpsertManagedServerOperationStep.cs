...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    public partial class UpsertManagedServerOperationStep
    {
        ...
        internal UpsertManagedServerOperationStep(int? order, string name, UpsertManagedServerOperationStepStatus? status, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Order = order;
            Name = name;
            Status = status;
