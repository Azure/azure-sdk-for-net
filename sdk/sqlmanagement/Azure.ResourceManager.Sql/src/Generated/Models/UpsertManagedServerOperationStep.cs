...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    public partial class UpsertManagedServerOperationStep
    {
        ...
        internal UpsertManagedServerOperationStep(DateTimeOffset? stepStartOn, DateTimeOffset? stepEndOn, string timeElapsed, int? order, string name, UpsertManagedServerOperationStepWithEstimatesAndDurationStatus? status, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
        ...
        [WirePath("status")]
        public UpsertManagedServerOperationStepWithEstimatesAndDurationStatus? Status { get; }
    }
}
