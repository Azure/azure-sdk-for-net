...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        internal static ManagedInstancePecProperty DeserializeManagedInstancePecProperty(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
