...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    public partial class AutoPauseDelayTimeRange
    {
        ...
        internal AutoPauseDelayTimeRange(int? minValue, int? maxValue, int? stepSize, int? @default, PauseDelayTimeUnit? unit, int? doNotPauseValue, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            MinValue = minValue;
            MaxValue = maxValue;
            StepSize = stepSize;
