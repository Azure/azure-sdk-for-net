...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    public partial class TdeCertificate : ResourceData
    {
        ...
        internal TdeCertificate(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string privateBlob, string certPassword, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData)
        {
