...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    public partial class ManagedDatabaseRestoreDetailBackupSetProperties
    {
        ...
        internal ManagedDatabaseRestoreDetailBackupSetProperties(string status, string firstStripeName, int? numberOfStripes, int? backupSizeInMB, DateTimeOffset? restoreStartedOn, DateTimeOffset? restoreFinishedOn, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Status = status;
