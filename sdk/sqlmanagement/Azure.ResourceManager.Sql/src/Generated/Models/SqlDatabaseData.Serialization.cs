...
{
    public partial class SqlDatabaseData : IUtf8JsonSerializable, IJsonModel<SqlDatabaseData>, IPersistableModel<SqlDatabaseData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SampleName))
            {
                ...
                builder.AppendLine($" '{SampleName.ToString()}'");
            }
            ...
            if (Optional.IsDefined(SourceDatabaseDeletedOn))
            {
                ...
                builder.AppendLine($" '{SourceDatabaseDeletedOn.Value.ToString()}'");
            }
            ...
            if (Optional.IsDefined(ReadScale))
            {
                ...
                builder.AppendLine($" '{ReadScale.ToString()}'");
            }
            ...
            if (Optional.IsDefined(CurrentSku))
            {
                ...
                AppendChildObject(builder, CurrentSku, options, 2);
            }

            if (Optional.IsDefined(AutoPauseDelay))
            {
                builder.Append("  autoPauseDelay:");
                builder.AppendLine($" '{AutoPauseDelay.Value.ToString()}'");
            }
            ...
            if (Optional.IsDefined(PausedOn))
            {
                ...
                builder.AppendLine($" '{PausedOn.Value.ToString()}'");
            }

            if (Optional.IsDefined(ResumedOn))
            {
                builder.Append("  resumedDate:");
                builder.AppendLine($" '{ResumedOn.Value.ToString()}'");
            }
            ...
            if (Optional.IsDefined(FreeLimitExhaustionBehavior))
            {
                ...
                builder.AppendLine($" '{FreeLimitExhaustionBehavior.ToString()}'");
            }
