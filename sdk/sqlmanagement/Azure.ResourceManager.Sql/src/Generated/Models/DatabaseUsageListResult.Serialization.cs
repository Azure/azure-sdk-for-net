...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DatabaseUsageListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DatabaseUsageListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DatabaseUsageListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DatabaseUsageListResult>)} interface");
            }
        ...
        string IPersistableModel<DatabaseUsageListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
