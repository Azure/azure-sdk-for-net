...
{
    public partial class SqlServerDatabaseRestorePointData : IUtf8JsonSerializable, IJsonModel<SqlServerDatabaseRestorePointData>, IPersistableModel<SqlServerDatabaseRestorePointData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(RestorePointCreatedOn))
            {
                ...
                builder.AppendLine($" '{RestorePointCreatedOn.Value.ToString()}'");
            }
