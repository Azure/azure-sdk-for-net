...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ManagedInstanceUpdateDnsServersOperationData>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<ManagedInstanceUpdateDnsServersOperationData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ManagedInstanceUpdateDnsServersOperationData>)} interface");
            }
        ...
        string IPersistableModel<ManagedInstanceUpdateDnsServersOperationData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
