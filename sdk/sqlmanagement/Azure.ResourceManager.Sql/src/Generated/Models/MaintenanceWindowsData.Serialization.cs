...
namespace Azure.ResourceManager.Sql
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MaintenanceWindowsData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MaintenanceWindowsData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MaintenanceWindowsData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MaintenanceWindowsData>)} interface");
            }
        ...
        string IPersistableModel<MaintenanceWindowsData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
