...
namespace Azure.ResourceManager.Sql
{
    public partial class MaintenanceWindowsData : IUtf8JsonSerializable, IJsonModel<MaintenanceWindowsData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(TimeRanges) || hasPropertyOverride)
            {
                if (TimeRanges.Any() || hasPropertyOverride)
                {
                    ...
                    else
                    {
                        ...
                        foreach (var item in TimeRanges)
                        {
                            ...
                            {
                                builder.Length = builder.Length - emptyObjectLength - "    timeRanges: ".Length;
                            }
                        }
                        builder.AppendLine("    ]");
                    }
