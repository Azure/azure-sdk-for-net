...
namespace Azure.ResourceManager.Sql
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SqlServerJobAgentData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SqlServerJobAgentData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SqlServerJobAgentData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SqlServerJobAgentData>)} interface");
            }
        ...
        string IPersistableModel<SqlServerJobAgentData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
