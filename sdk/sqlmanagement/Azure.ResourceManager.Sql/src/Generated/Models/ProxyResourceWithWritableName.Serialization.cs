...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ProxyResourceWithWritableName>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ProxyResourceWithWritableName>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ProxyResourceWithWritableName>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<ProxyResourceWithWritableName>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
