...
namespace Azure.ResourceManager.Sql
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SyncAgentData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SyncAgentData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SyncAgentData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SyncAgentData>)} interface");
            }
        ...
        string IPersistableModel<SyncAgentData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
