...
namespace Azure.ResourceManager.Sql.Models
{
    internal partial class AdministratorListResult : IUtf8JsonSerializable, IJsonModel<AdministratorListResult>
    {
        ...
        void IJsonModel<AdministratorListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(AdministratorListResult)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<AdministratorListResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(AdministratorListResult)} does not support '{options.Format}' format.");
            }
        }
