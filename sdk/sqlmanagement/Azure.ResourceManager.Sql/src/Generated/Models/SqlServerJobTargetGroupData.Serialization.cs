...
namespace Azure.ResourceManager.Sql
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SqlServerJobTargetGroupData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SqlServerJobTargetGroupData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SqlServerJobTargetGroupData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SqlServerJobTargetGroupData>)} interface");
            }
        ...
        string IPersistableModel<SqlServerJobTargetGroupData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
