...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        internal static ManagedDatabaseListResult DeserializeManagedDatabaseListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
