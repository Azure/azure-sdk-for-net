...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RecommendedActionStateInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RecommendedActionStateInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RecommendedActionStateInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<RecommendedActionStateInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
