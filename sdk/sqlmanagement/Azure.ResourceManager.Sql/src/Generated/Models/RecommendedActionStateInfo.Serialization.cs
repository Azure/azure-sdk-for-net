...
{
    public partial class RecommendedActionStateInfo : IUtf8JsonSerializable, IJsonModel<RecommendedActionStateInfo>, IPersistableModel<RecommendedActionStateInfo>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ActionInitiatedBy))
            {
                ...
                builder.AppendLine($" '{ActionInitiatedBy.ToString()}'");
            }
