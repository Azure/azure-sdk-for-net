...
namespace Azure.ResourceManager.Sql
{
    public partial class ManagedInstanceAdvancedThreatProtectionData : IUtf8JsonSerializable, IJsonModel<ManagedInstanceAdvancedThreatProtectionData>
    {
        ...
        void IJsonModel<ManagedInstanceAdvancedThreatProtectionData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(ManagedInstanceAdvancedThreatProtectionData)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ManagedInstanceAdvancedThreatProtectionData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(ManagedInstanceAdvancedThreatProtectionData)} does not support '{options.Format}' format.");
            }
        }
