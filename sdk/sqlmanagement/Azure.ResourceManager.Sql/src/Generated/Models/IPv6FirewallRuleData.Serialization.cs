...
{
    public partial class IPv6FirewallRuleData : Core.IUtf8JsonSerializable
    {
        void Core.IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            writer.WriteStartObject();
            if (Core.Optional.IsDefined(StartIPv6Address))
            {
                writer.WritePropertyName("startIPv6Address"u8);
                writer.WriteStringValue(StartIPv6Address);
            }
            if (Core.Optional.IsDefined(EndIPv6Address))
            {
        ...
        internal static IPv6FirewallRuleData DeserializeIPv6FirewallRuleData(JsonElement element)
        {
            ...
            Core.Optional<string> startIPv6Address = default;
            Core.Optional<string> endIPv6Address = default;
            ...
            return new IPv6FirewallRuleData(id.Value, name.Value, Core.Optional.ToNullable(type), startIPv6Address.Value, endIPv6Address.Value);
        }
    }
}
