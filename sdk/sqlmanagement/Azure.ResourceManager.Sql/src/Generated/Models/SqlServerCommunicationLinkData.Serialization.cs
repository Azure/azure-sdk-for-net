...
namespace Azure.ResourceManager.Sql
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SqlServerCommunicationLinkData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SqlServerCommunicationLinkData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SqlServerCommunicationLinkData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SqlServerCommunicationLinkData>)} interface");
            }
        ...
        string IPersistableModel<SqlServerCommunicationLinkData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
