...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ServerCommunicationLinkListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ServerCommunicationLinkListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ServerCommunicationLinkListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<ServerCommunicationLinkListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
