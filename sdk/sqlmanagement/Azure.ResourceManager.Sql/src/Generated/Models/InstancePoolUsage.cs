...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    public partial class InstancePoolUsage
    {
        ...
        /// <param name="usageType"> Resource type. </param>
        ...
        internal InstancePoolUsage(string id, UsageName name, string usageType, string unit, int? currentValue, int? limit, int? requestedLimit)
        {
            Id = id;
            Name = name;
            UsageType = usageType;
