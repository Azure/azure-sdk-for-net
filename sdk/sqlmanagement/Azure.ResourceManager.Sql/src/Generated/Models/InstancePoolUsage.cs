...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    public partial class InstancePoolUsage
    {
        ...
        internal InstancePoolUsage(ResourceIdentifier id, InstancePoolUsageName name, ResourceType? resourceType, string unit, int? currentValue, int? limit, int? requestedLimit, Dictionary<string, BinaryData> rawData)
        {
            Id = id;
            Name = name;
