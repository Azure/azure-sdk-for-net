...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ElasticPoolPerDatabaseMaxPerformanceLevelCapability>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<ElasticPoolPerDatabaseMaxPerformanceLevelCapability>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ElasticPoolPerDatabaseMaxPerformanceLevelCapability>)} interface");
            }
        ...
        string IPersistableModel<ElasticPoolPerDatabaseMaxPerformanceLevelCapability>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
