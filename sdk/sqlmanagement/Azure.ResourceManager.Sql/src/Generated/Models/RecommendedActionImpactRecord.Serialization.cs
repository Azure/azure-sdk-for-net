...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        internal static RecommendedActionImpactRecord DeserializeRecommendedActionImpactRecord(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
