...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RecommendedActionImpactRecord>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RecommendedActionImpactRecord>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RecommendedActionImpactRecord>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<RecommendedActionImpactRecord>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
