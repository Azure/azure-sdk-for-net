...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    public partial class VirtualClusterPatch
    {
        ...
        internal VirtualClusterPatch(IDictionary<string, string> tags, ResourceIdentifier subnetId, string version, IReadOnlyList<string> childResources, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Tags = tags;
            SubnetId = subnetId;
            Version = version;
