...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ManagedInstanceFamilyCapability>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ManagedInstanceFamilyCapability>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ManagedInstanceFamilyCapability>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ManagedInstanceFamilyCapability>)} interface");
            }
        ...
        string IPersistableModel<ManagedInstanceFamilyCapability>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
