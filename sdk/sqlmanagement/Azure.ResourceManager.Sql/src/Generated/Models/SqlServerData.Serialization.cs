...
{
    public partial class SqlServerData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static SqlServerData DeserializeSqlServerData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
