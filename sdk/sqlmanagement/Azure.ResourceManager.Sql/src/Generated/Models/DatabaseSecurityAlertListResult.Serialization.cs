...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        internal static DatabaseSecurityAlertListResult DeserializeDatabaseSecurityAlertListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
