...
{
    public partial class ManagedInstancePrivateLinkProperties : IUtf8JsonSerializable, IJsonModel<ManagedInstancePrivateLinkProperties>, IPersistableModel<ManagedInstancePrivateLinkProperties>
    {
        ...
        void IJsonModel<ManagedInstancePrivateLinkProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ManagedInstancePrivateLinkProperties)} does not support '{format}' format.");
            }
