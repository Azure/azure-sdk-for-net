...
namespace Azure.ResourceManager.Sql
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ManagedInstanceStartStopScheduleData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ManagedInstanceStartStopScheduleData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ManagedInstanceStartStopScheduleData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ManagedInstanceStartStopScheduleData>)} interface");
            }
        ...
        string IPersistableModel<ManagedInstanceStartStopScheduleData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
