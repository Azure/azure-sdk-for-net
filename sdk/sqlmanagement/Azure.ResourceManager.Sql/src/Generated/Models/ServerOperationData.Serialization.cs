...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    public partial class ServerOperationData : ResourceData, IJsonModel<ServerOperationData>
    {
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual ResourceData PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<ServerOperationData>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ServerOperationData>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        ServerOperationData IPersistableModel<ServerOperationData>.Create(BinaryData data, ModelReaderWriterOptions options) => (ServerOperationData)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ServerOperationData IJsonModel<ServerOperationData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (ServerOperationData)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static ServerOperationData DeserializeServerOperationData(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            ServerOperationProperties properties = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = ServerOperationProperties.DeserializeServerOperationProperties(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
