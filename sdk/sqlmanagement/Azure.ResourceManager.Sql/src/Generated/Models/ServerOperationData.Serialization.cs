...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ServerOperationData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ServerOperationData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ServerOperationData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ServerOperationData>)} interface");
            }
        ...
        string IPersistableModel<ServerOperationData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
