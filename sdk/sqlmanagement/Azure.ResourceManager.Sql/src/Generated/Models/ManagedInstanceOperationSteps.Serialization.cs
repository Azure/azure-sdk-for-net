...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        internal static ManagedInstanceOperationSteps DeserializeManagedInstanceOperationSteps(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
