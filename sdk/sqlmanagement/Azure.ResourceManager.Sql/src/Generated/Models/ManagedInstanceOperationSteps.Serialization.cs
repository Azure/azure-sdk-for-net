...
{
    public partial class ManagedInstanceOperationSteps : IUtf8JsonSerializable, IJsonModel<ManagedInstanceOperationSteps>, IPersistableModel<ManagedInstanceOperationSteps>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(CurrentStep))
            {
                ...
                builder.AppendLine($" '{CurrentStep.Value.ToString()}'");
            }
