...
{
    internal partial class LedgerDigestUploadsListResult : IUtf8JsonSerializable, IJsonModel<LedgerDigestUploadsListResult>, IPersistableModel<LedgerDigestUploadsListResult>
    {
        ...
        void IJsonModel<LedgerDigestUploadsListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(LedgerDigestUploadsListResult)} does not support '{format}' format.");
            }
