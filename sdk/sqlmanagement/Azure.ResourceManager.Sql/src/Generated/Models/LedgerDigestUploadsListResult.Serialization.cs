...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        internal static LedgerDigestUploadsListResult DeserializeLedgerDigestUploadsListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
