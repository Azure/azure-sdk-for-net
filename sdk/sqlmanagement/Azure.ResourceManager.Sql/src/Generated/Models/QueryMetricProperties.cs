...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    public partial class QueryMetricProperties
    {
        ...
        internal QueryMetricProperties(string name, string displayName, QueryMetricUnitType? unit, double? value, double? min, double? max, double? avg, double? sum, double? stdev, Dictionary<string, BinaryData> rawData)
        {
            Name = name;
