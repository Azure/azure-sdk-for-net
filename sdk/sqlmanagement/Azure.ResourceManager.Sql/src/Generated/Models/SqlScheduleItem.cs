...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    public partial class SqlScheduleItem
    {
        ...
        internal SqlScheduleItem(SqlDayOfWeek startDay, string startTime, SqlDayOfWeek stopDay, string stopTime, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            StartDay = startDay;
            StartTime = startTime;
            StopDay = stopDay;
