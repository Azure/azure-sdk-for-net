...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    public partial class SqlMetric
    {
        ...
        internal SqlMetric(DateTimeOffset? startOn, DateTimeOffset? endOn, string timeGrain, SqlMetricUnitType? unit, SqlMetricName name, IReadOnlyList<SqlMetricValue> metricValues, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            StartOn = startOn;
            EndOn = endOn;
            TimeGrain = timeGrain;
