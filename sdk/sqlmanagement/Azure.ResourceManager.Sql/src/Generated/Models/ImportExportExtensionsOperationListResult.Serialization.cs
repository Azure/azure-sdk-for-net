...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ImportExportExtensionsOperationListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ImportExportExtensionsOperationListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ImportExportExtensionsOperationListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ImportExportExtensionsOperationListResult>)} interface");
            }
        ...
        string IPersistableModel<ImportExportExtensionsOperationListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
