...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<JobStepAction>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<JobStepAction>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<JobStepAction>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<JobStepAction>)} interface");
            }
        ...
        string IPersistableModel<JobStepAction>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
