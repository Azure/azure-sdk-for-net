...
{
    public partial class JobStepAction : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static JobStepAction DeserializeJobStepAction(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
