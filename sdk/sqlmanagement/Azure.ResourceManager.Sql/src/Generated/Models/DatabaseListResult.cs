...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    internal partial class DatabaseListResult
    {
        ...
        internal DatabaseListResult(IEnumerable<SqlDatabaseData> value)
        {
            Value = value.ToList();
        }
        ...
        internal DatabaseListResult(IList<SqlDatabaseData> value, Uri nextLink, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            NextLink = nextLink;
        ...
        [WirePath("value")]
        public IList<SqlDatabaseData> Value { get; }
