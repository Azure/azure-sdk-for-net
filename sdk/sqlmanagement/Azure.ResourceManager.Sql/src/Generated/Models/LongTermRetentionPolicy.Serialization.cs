...
namespace Azure.ResourceManager.Sql.Models
{
    public partial class LongTermRetentionPolicy : IUtf8JsonSerializable
    {
        ...
        internal static LongTermRetentionPolicy DeserializeLongTermRetentionPolicy(JsonElement element)
        {
            ...
            return new LongTermRetentionPolicy(id.Value, name.Value, type.Value, weeklyRetention.Value, monthlyRetention.Value, yearlyRetention.Value, Optional.ToNullable(weekOfYear));
        }
    }
}
