...
namespace Azure.ResourceManager.Sql
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ManagedLedgerDigestUploadData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ManagedLedgerDigestUploadData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ManagedLedgerDigestUploadData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ManagedLedgerDigestUploadData>)} interface");
            }
        ...
        string IPersistableModel<ManagedLedgerDigestUploadData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
