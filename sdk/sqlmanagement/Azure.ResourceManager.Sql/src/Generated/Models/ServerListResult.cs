...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    internal partial class ServerListResult
    {
        ...
        internal ServerListResult(IEnumerable<SqlServerData> value)
        {
            Value = value.ToList();
        }
        ...
        internal ServerListResult(IList<SqlServerData> value, Uri nextLink, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            NextLink = nextLink;
        ...
        [WirePath("value")]
        public IList<SqlServerData> Value { get; }
