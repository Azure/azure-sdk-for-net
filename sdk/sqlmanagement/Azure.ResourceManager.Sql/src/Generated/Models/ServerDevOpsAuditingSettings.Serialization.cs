...
{
    public partial class ServerDevOpsAuditingSettings : IUtf8JsonSerializable
    {
        ...
        internal static ServerDevOpsAuditingSettings DeserializeServerDevOpsAuditingSettings(JsonElement element)
        {
            ...
            return new ServerDevOpsAuditingSettings(id.Value, name.Value, type.Value, systemData.Value, Optional.ToNullable(isAzureMonitorTargetEnabled), Optional.ToNullable(state), storageEndpoint.Value, storageAccountAccessKey.Value, Optional.ToNullable(storageAccountSubscriptionId));
        }
    }
}
