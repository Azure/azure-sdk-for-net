...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    public partial class ElasticPoolOperationData : ResourceData
    {
        ...
        internal ElasticPoolOperationData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, ElasticPoolOperationProperties properties) : base(id, name, resourceType, systemData)
        {
