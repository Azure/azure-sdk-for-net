...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DeletedServerListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DeletedServerListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DeletedServerListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DeletedServerListResult>)} interface");
            }
        ...
        string IPersistableModel<DeletedServerListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
