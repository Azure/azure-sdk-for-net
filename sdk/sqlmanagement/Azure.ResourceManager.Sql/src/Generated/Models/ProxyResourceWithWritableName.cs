...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    public partial class ProxyResourceWithWritableName : ResourceWithWritableName
    {
        ...
        internal ProxyResourceWithWritableName(ResourceIdentifier id, string name, string @type, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, name, @type, additionalBinaryDataProperties)
        {
        }
    }
}
