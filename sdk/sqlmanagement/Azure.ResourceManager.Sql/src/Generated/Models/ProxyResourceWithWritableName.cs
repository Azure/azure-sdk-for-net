...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    public partial class ProxyResourceWithWritableName : ResourceWithWritableName
    {
        ...
        internal ProxyResourceWithWritableName(ResourceIdentifier id, string name, ResourceType? resourceType, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, serializedAdditionalRawData)
        {
        }
    }
}
