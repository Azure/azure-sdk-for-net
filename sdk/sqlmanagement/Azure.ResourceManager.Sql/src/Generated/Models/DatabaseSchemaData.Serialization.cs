...
namespace Azure.ResourceManager.Sql
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DatabaseSchemaData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DatabaseSchemaData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DatabaseSchemaData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<DatabaseSchemaData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
