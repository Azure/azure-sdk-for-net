...
{
    public partial class DatabaseSchemaData : IUtf8JsonSerializable, IJsonModel<DatabaseSchemaData>, IPersistableModel<DatabaseSchemaData>
    {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<DatabaseSchemaData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DatabaseSchemaData)} does not support '{format}' format.");
            }
