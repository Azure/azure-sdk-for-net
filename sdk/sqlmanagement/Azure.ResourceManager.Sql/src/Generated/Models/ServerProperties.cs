...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    internal partial class ServerProperties
    {
        ...
        internal ServerProperties(string administratorLogin, string administratorLoginPassword, string version, string state, string fullyQualifiedDomainName, IReadOnlyList<SqlServerPrivateEndpointConnection> privateEndpointConnections, SqlMinimalTlsVersion? minimalTlsVersion, ServerPublicNetworkAccessFlag? publicNetworkAccess, ServerWorkspaceFeature? workspaceFeature, ResourceIdentifier primaryUserAssignedIdentityId, Guid? federatedClientId, Uri keyId, ServerExternalAdministrator administrators, ServerNetworkAccessFlag? restrictOutboundNetworkAccess, ServerNetworkAccessFlag? isIPv6Enabled, ExternalGovernanceStatus? externalGovernanceStatus, int? retentionDays, SqlServerCreateMode? createMode, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
        ...
        public IReadOnlyList<SqlServerPrivateEndpointConnection> PrivateEndpointConnections { get; } = new ChangeTrackingList<SqlServerPrivateEndpointConnection>();

        /// <summary> Minimal TLS version. Allowed values: 'None', 1.0', '1.1', '1.2', '1.3'. </summary>
        [WirePath("minimalTlsVersion")]
        public SqlMinimalTlsVersion? MinimalTlsVersion { get; set; }
