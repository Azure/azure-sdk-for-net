...
namespace Azure.ResourceManager.Sql
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RecoverableDatabaseData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RecoverableDatabaseData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RecoverableDatabaseData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RecoverableDatabaseData>)} interface");
            }
        ...
        string IPersistableModel<RecoverableDatabaseData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
