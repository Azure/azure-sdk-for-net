...
{
    public partial class PerDatabaseAutoPauseDelayTimeRange : IUtf8JsonSerializable, IJsonModel<PerDatabaseAutoPauseDelayTimeRange>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PerDatabaseAutoPauseDelayTimeRange>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<PerDatabaseAutoPauseDelayTimeRange>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        PerDatabaseAutoPauseDelayTimeRange IJsonModel<PerDatabaseAutoPauseDelayTimeRange>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<PerDatabaseAutoPauseDelayTimeRange>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static PerDatabaseAutoPauseDelayTimeRange DeserializePerDatabaseAutoPauseDelayTimeRange(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<PerDatabaseAutoPauseDelayTimeRange>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<PerDatabaseAutoPauseDelayTimeRange>)this).GetFormatFromOptions(options) : options.Format;
        ...
        PerDatabaseAutoPauseDelayTimeRange IPersistableModel<PerDatabaseAutoPauseDelayTimeRange>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<PerDatabaseAutoPauseDelayTimeRange>)this).GetFormatFromOptions(options) : options.Format;
