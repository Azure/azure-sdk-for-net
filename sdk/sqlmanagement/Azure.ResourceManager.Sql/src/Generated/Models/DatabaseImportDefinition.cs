...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    public partial class DatabaseImportDefinition
    {
        ...
        internal DatabaseImportDefinition(string databaseName, string edition, string serviceObjectiveName, string maxSizeBytes, StorageKeyType storageKeyType, string storageKey, Uri storageUri, string administratorLogin, string administratorLoginPassword, string authenticationType, NetworkIsolationSettingsAutoGenerated networkIsolation, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
