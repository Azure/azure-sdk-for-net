...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FailoverGroupReadOnlyEndpoint>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<FailoverGroupReadOnlyEndpoint>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<FailoverGroupReadOnlyEndpoint>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<FailoverGroupReadOnlyEndpoint>)} interface");
            }
        ...
        string IPersistableModel<FailoverGroupReadOnlyEndpoint>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
