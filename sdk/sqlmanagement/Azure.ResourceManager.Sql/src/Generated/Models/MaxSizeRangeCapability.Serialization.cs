...
{
    public partial class MaxSizeRangeCapability : IUtf8JsonSerializable, IJsonModel<MaxSizeRangeCapability>, IPersistableModel<MaxSizeRangeCapability>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(MinValue))
            {
                ...
                AppendChildObject(builder, MinValue, options, 2);
            }

            if (Optional.IsDefined(MaxValue))
            {
                builder.Append("  maxValue:");
                AppendChildObject(builder, MaxValue, options, 2);
            }

            if (Optional.IsDefined(ScaleSize))
            {
                builder.Append("  scaleSize:");
                AppendChildObject(builder, ScaleSize, options, 2);
            }

            if (Optional.IsDefined(LogSize))
            {
                builder.Append("  logSize:");
                AppendChildObject(builder, LogSize, options, 2);
            }
