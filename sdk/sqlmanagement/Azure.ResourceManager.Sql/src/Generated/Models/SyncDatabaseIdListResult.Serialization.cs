...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        internal static SyncDatabaseIdListResult DeserializeSyncDatabaseIdListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
