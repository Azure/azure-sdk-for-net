...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SyncDatabaseIdListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SyncDatabaseIdListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SyncDatabaseIdListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SyncDatabaseIdListResult>)} interface");
            }
        ...
        string IPersistableModel<SyncDatabaseIdListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
