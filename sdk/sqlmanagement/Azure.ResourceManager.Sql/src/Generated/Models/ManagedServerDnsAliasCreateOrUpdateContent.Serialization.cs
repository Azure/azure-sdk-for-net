...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ManagedServerDnsAliasCreateOrUpdateContent>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(CreateDnsRecord), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("  createDnsRecord: ");
            ...
            else
            {
                ...
                {
                    builder.Append("  createDnsRecord: ");
                    var boolValue = CreateDnsRecord.Value == true ? "true" : "false";
