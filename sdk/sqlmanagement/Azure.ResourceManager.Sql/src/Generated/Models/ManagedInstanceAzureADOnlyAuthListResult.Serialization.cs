...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ManagedInstanceAzureADOnlyAuthListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ManagedInstanceAzureADOnlyAuthListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ManagedInstanceAzureADOnlyAuthListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ManagedInstanceAzureADOnlyAuthListResult>)} interface");
            }
        ...
        string IPersistableModel<ManagedInstanceAzureADOnlyAuthListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
