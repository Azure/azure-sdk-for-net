...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        internal static UpsertManagedServerOperationStep DeserializeUpsertManagedServerOperationStep(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
