...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    public partial class RecommendedSensitivityLabelUpdate : ResourceData
    {
        ...
        internal RecommendedSensitivityLabelUpdate(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, RecommendedSensitivityLabelUpdateKind? op, string schema, string table, string column, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData)
        {
            Op = op;
            Schema = schema;
            Table = table;
