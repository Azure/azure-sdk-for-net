...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    public partial class RecommendedSensitivityLabelUpdate : ResourceData
    {
        ...
        internal RecommendedSensitivityLabelUpdate(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, RecommendedSensitivityLabelUpdateProperties properties) : base(id, name, resourceType, systemData)
        {
