...
{
    public partial class JobTarget : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static JobTarget DeserializeJobTarget(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
