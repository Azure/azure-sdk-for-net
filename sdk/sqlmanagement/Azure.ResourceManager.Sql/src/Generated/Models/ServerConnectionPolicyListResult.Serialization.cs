...
namespace Azure.ResourceManager.Sql.Models
{
    internal partial class ServerConnectionPolicyListResult
    {
        internal static ServerConnectionPolicyListResult DeserializeServerConnectionPolicyListResult(JsonElement element)
        {
            ...
            Core.Optional<IReadOnlyList<SqlServerConnectionPolicyData>> value = default;
            ...
            return new ServerConnectionPolicyListResult(Core.Optional.ToList(value), nextLink.Value);
        }
    }
}
