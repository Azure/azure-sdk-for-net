...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<JobStepListResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (options.Format != "W" && Optional.IsCollectionDefined(Value))
            {
                ...
                {
                    ((IJsonModel<SqlServerJobStepData>)item).Write(writer, options);
                }
        ...
        internal static JobStepListResult DeserializeJobStepListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            IReadOnlyList<SqlServerJobStepData> value = default;
            ...
            return new JobStepListResult(value ?? new ChangeTrackingList<SqlServerJobStepData>(), nextLink, serializedAdditionalRawData);
        }
