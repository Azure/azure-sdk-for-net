...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    public partial class InstancePoolFamilyCapability
    {
        ...
        internal InstancePoolFamilyCapability(string name, IReadOnlyList<LicenseTypeCapability> supportedLicenseTypes, IReadOnlyList<InstancePoolVcoresCapability> supportedVcoresValues, SqlCapabilityStatus? status, string reason, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
