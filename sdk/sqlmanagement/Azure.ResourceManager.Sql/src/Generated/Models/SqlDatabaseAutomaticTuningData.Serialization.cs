...
namespace Azure.ResourceManager.Sql
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SqlDatabaseAutomaticTuningData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SqlDatabaseAutomaticTuningData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SqlDatabaseAutomaticTuningData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SqlDatabaseAutomaticTuningData>)} interface");
            }
        ...
        string IPersistableModel<SqlDatabaseAutomaticTuningData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
