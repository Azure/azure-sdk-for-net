...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    public partial class MaintenanceConfigurationCapability
    {
        ...
        internal MaintenanceConfigurationCapability(string name, bool? isZoneRedundant, SqlCapabilityStatus? status, string reason, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
