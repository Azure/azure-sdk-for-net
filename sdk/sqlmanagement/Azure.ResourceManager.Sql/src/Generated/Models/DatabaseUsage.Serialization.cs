...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    public partial class DatabaseUsage : ResourceData, IJsonModel<DatabaseUsage>
    {
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual ResourceData PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<DatabaseUsage>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<DatabaseUsage>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        DatabaseUsage IPersistableModel<DatabaseUsage>.Create(BinaryData data, ModelReaderWriterOptions options) => (DatabaseUsage)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        DatabaseUsage IJsonModel<DatabaseUsage>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (DatabaseUsage)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static DatabaseUsage DeserializeDatabaseUsage(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            DatabaseUsageProperties properties = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = DatabaseUsageProperties.DeserializeDatabaseUsageProperties(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
