...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DatabaseUsage>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DatabaseUsage>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DatabaseUsage>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DatabaseUsage>)} interface");
            }
        ...
        string IPersistableModel<DatabaseUsage>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
