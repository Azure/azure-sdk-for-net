...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    public partial class SqlNameAvailabilityResponse
    {
        ...
        internal SqlNameAvailabilityResponse(string name, bool? isAvailable, SqlNameUnavailableReason? reason, string message, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
