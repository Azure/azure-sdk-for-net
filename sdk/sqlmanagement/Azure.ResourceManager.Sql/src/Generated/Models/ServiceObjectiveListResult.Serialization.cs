...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ServiceObjectiveListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ServiceObjectiveListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ServiceObjectiveListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ServiceObjectiveListResult>)} interface");
            }
        ...
        string IPersistableModel<ServiceObjectiveListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
