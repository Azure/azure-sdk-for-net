...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        internal static ServiceObjectiveListResult DeserializeServiceObjectiveListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
