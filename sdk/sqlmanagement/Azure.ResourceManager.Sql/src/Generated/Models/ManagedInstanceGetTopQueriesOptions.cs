...
{
    /// <summary> A class representing the query and header parameters in GetTopQueries method. </summary>
    public partial class ManagedInstanceGetTopQueriesOptions
    {
        /// <summary> Initializes a new instance of ManagedInstanceGetTopQueriesOptions. </summary>
        public ManagedInstanceGetTopQueriesOptions()
        {
        }
