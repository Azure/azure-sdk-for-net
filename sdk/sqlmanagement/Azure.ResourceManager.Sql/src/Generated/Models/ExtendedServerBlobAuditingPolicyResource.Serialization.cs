...
namespace Azure.ResourceManager.Sql
{
    public partial class ExtendedServerBlobAuditingPolicyResource : IJsonModel<ExtendedServerBlobAuditingPolicyData>
    {
        ...
        {
            return ModelReaderWriter.Read<ExtendedServerBlobAuditingPolicyData>(new BinaryData(reader.ValueSequence), options);
        }
        ...
        {
            return ModelReaderWriter.Read<ExtendedServerBlobAuditingPolicyData>(data, options);
        }
