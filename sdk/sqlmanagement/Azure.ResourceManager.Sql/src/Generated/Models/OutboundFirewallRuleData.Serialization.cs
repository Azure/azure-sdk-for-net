...
namespace Azure.ResourceManager.Sql
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<OutboundFirewallRuleData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<OutboundFirewallRuleData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<OutboundFirewallRuleData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<OutboundFirewallRuleData>)} interface");
            }
        ...
        string IPersistableModel<OutboundFirewallRuleData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
