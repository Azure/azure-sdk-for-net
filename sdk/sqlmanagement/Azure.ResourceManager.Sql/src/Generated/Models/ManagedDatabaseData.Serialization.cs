...
{
    public partial class ManagedDatabaseData : IUtf8JsonSerializable, IJsonModel<ManagedDatabaseData>, IPersistableModel<ManagedDatabaseData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(EarliestRestorePoint))
            {
                ...
                builder.AppendLine($" '{EarliestRestorePoint.Value.ToString()}'");
            }
            ...
            if (Optional.IsDefined(CatalogCollation))
            {
                ...
                builder.AppendLine($" '{CatalogCollation.ToString()}'");
            }
