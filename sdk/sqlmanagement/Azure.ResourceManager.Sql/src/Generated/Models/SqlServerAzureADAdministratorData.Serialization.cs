...
namespace Azure.ResourceManager.Sql
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SqlServerAzureADAdministratorData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SqlServerAzureADAdministratorData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SqlServerAzureADAdministratorData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SqlServerAzureADAdministratorData>)} interface");
            }
        ...
        string IPersistableModel<SqlServerAzureADAdministratorData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
