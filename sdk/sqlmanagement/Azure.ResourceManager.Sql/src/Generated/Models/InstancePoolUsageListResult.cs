...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    internal partial class InstancePoolUsageListResult
    {
        ...
        internal InstancePoolUsageListResult(IEnumerable<InstancePoolUsage> value)
        {
            Value = value.ToList();
        }
        ...
        internal InstancePoolUsageListResult(IList<InstancePoolUsage> value, Uri nextLink, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            NextLink = nextLink;
        ...
        [WirePath("value")]
        public IList<InstancePoolUsage> Value { get; }
