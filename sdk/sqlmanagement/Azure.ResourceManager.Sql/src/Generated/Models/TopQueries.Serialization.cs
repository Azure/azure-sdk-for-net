...
{
    public partial class TopQueries : IUtf8JsonSerializable, IJsonModel<TopQueries>, IPersistableModel<TopQueries>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(NumberOfQueries))
            {
                ...
                builder.AppendLine($" '{NumberOfQueries.Value.ToString()}'");
            }
