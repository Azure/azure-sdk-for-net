...
{
    public partial class ElasticPoolOperationData : IUtf8JsonSerializable, IJsonModel<ElasticPoolOperationData>, IPersistableModel<ElasticPoolOperationData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(EstimatedCompleteOn))
            {
                ...
                builder.AppendLine($" '{EstimatedCompleteOn.Value.ToString()}'");
            }
