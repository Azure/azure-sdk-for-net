...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        internal static SensitivityLabelListResult DeserializeSensitivityLabelListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
