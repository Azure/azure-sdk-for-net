...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        /// <summary> Initializes a new instance of ManagedDatabaseSecurityAlertPolicy. </summary>
        ...
        internal ManagedDatabaseSecurityAlertPolicy(string id, string name, string type, SecurityAlertPolicyState? state, IList<string> disabledAlerts, IList<string> emailAddresses, bool? emailAccountAdmins, string storageEndpoint, string storageAccountAccessKey, int? retentionDays, DateTimeOffset? creationTime) : base(id, name, type)
        {
            State = state;
