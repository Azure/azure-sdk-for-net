...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ServerExternalAdministrator>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ServerExternalAdministrator>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ServerExternalAdministrator>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ServerExternalAdministrator>)} interface");
            }
        ...
        string IPersistableModel<ServerExternalAdministrator>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
