...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ChangeLongTermRetentionBackupAccessTierParameters>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ChangeLongTermRetentionBackupAccessTierParameters>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ChangeLongTermRetentionBackupAccessTierParameters)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ChangeLongTermRetentionBackupAccessTierParameters>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ChangeLongTermRetentionBackupAccessTierParameters)} does not support '{options.Format}' format.");
            }
        }
