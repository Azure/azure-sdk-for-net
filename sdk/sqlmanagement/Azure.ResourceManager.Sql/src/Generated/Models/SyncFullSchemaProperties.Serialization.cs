...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        internal static SyncFullSchemaProperties DeserializeSyncFullSchemaProperties(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
