...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ManagedInstancePairInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ManagedInstancePairInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ManagedInstancePairInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ManagedInstancePairInfo>)} interface");
            }
        ...
        string IPersistableModel<ManagedInstancePairInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
