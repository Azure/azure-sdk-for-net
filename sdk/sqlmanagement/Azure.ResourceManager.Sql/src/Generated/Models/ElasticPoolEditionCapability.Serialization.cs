...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        internal static ElasticPoolEditionCapability DeserializeElasticPoolEditionCapability(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
