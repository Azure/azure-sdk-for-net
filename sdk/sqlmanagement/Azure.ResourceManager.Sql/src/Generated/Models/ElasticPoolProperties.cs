...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    internal partial class ElasticPoolProperties
    {
        ...
        internal ElasticPoolProperties(ElasticPoolState? state, DateTimeOffset? createdOn, long? maxSizeBytes, double? minCapacity, ElasticPoolPerDatabaseSettings perDatabaseSettings, bool? zoneRedundant, ElasticPoolLicenseType? licenseType, string maintenanceConfigurationId, int? highAvailabilityReplicaCount, int? autoPauseDelay, SqlAlwaysEncryptedEnclaveType? preferredEnclaveType, SqlAvailabilityZoneType? availabilityZone, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            State = state;
            CreatedOn = createdOn;
