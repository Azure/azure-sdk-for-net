...
namespace Azure.ResourceManager.Sql
{
    public partial class SqlServerDevOpsAuditingSettingData : IUtf8JsonSerializable, IJsonModel<SqlServerDevOpsAuditingSettingData>
    {
        ...
        void IJsonModel<SqlServerDevOpsAuditingSettingData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(SqlServerDevOpsAuditingSettingData)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<SqlServerDevOpsAuditingSettingData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(SqlServerDevOpsAuditingSettingData)} does not support '{options.Format}' format.");
            }
        }
