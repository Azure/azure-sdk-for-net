...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    internal partial class SecurityAlertPolicyProperties
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="SecurityAlertPolicyProperties"/>. </summary>
        ...
        public SecurityAlertPolicyProperties(SecurityAlertPolicyState state)
        {
            State = state;
        ...
        internal SecurityAlertPolicyProperties(SecurityAlertPolicyState state, IList<string> disabledAlerts, IList<string> emailAddresses, bool? emailAccountAdmins, string storageEndpoint, string storageAccountAccessKey, int? retentionDays, DateTimeOffset? createdOn, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            State = state;
        ...
        [WirePath("disabledAlerts")]
        public IList<string> DisabledAlerts { get; } = new ChangeTrackingList<string>();
