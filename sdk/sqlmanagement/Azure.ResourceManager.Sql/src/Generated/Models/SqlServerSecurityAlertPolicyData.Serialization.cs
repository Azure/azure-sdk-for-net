...
{
    public partial class SqlServerSecurityAlertPolicyData : IUtf8JsonSerializable, IModelJsonSerializable<SqlServerSecurityAlertPolicyData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IModelJsonSerializable<SqlServerSecurityAlertPolicyData>)this).Serialize(writer, ModelSerializerOptions.DefaultWireOptions);

        void IModelJsonSerializable<SqlServerSecurityAlertPolicyData>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<SqlServerSecurityAlertPolicyData>(this, options.Format);
        ...
        internal static SqlServerSecurityAlertPolicyData DeserializeSqlServerSecurityAlertPolicyData(JsonElement element, ModelSerializerOptions options = default)
        {
        ...
        SqlServerSecurityAlertPolicyData IModelJsonSerializable<SqlServerSecurityAlertPolicyData>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<SqlServerSecurityAlertPolicyData>(this, options.Format);

            using var doc = JsonDocument.ParseValue(ref reader);
            return DeserializeSqlServerSecurityAlertPolicyData(doc.RootElement, options);
        }

        BinaryData IModelSerializable<SqlServerSecurityAlertPolicyData>.Serialize(ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<SqlServerSecurityAlertPolicyData>(this, options.Format);
        ...
        SqlServerSecurityAlertPolicyData IModelSerializable<SqlServerSecurityAlertPolicyData>.Deserialize(BinaryData data, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<SqlServerSecurityAlertPolicyData>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="SqlServerSecurityAlertPolicyData"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="SqlServerSecurityAlertPolicyData"/> to convert. </param>
        public static implicit operator RequestContent(SqlServerSecurityAlertPolicyData model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="SqlServerSecurityAlertPolicyData"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator SqlServerSecurityAlertPolicyData(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeSqlServerSecurityAlertPolicyData(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
