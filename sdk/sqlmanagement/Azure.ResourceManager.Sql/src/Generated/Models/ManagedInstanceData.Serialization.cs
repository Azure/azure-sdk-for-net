...
{
    public partial class ManagedInstanceData : IUtf8JsonSerializable, IModelJsonSerializable<ManagedInstanceData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IModelJsonSerializable<ManagedInstanceData>)this).Serialize(writer, ModelSerializerOptions.DefaultWireOptions);

        void IModelJsonSerializable<ManagedInstanceData>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<ManagedInstanceData>(this, options.Format);
            ...
            if (Optional.IsDefined(Administrators))
            {
                ...
                {
                    ((IModelJsonSerializable<ManagedInstanceExternalAdministrator>)Administrators).Serialize(writer, options);
                }
            }
            if (Optional.IsDefined(ServicePrincipal))
            {
                ...
                {
                    ((IModelJsonSerializable<SqlServicePrincipal>)ServicePrincipal).Serialize(writer, options);
                }
            }
            writer.WriteEndObject();
        ...
        internal static ManagedInstanceData DeserializeManagedInstanceData(JsonElement element, ModelSerializerOptions options = default)
        {
        ...
        ManagedInstanceData IModelSerializable<ManagedInstanceData>.Deserialize(BinaryData data, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<ManagedInstanceData>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="ManagedInstanceData"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="ManagedInstanceData"/> to convert. </param>
        public static implicit operator RequestContent(ManagedInstanceData model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="ManagedInstanceData"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator ManagedInstanceData(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeManagedInstanceData(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
