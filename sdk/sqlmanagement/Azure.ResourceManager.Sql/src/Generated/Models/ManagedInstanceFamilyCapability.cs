...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    public partial class ManagedInstanceFamilyCapability
    {
        ...
        internal ManagedInstanceFamilyCapability(string name, string sku, IReadOnlyList<LicenseTypeCapability> supportedLicenseTypes, IReadOnlyList<ManagedInstanceVcoresCapability> supportedVcoresValues, SqlCapabilityStatus? status, string reason, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Sku = sku;
