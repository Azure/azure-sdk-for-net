...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    public partial class JobStepOutput
    {
        ...
        internal JobStepOutput(JobStepOutputType? outputType, Guid? subscriptionId, string resourceGroupName, string serverName, string databaseName, string schemaName, string tableName, string credential, Dictionary<string, BinaryData> rawData)
        {
