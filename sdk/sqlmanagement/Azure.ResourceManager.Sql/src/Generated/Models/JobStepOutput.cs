...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    public partial class JobStepOutput
    {
        ...
        /// <summary> Initializes a new instance of JobStepOutput. </summary>
        /// <param name="stepOutputType"> The output destination type. </param>
        ...
        /// <param name="tableName"> The output destination table. </param>
        /// <param name="credential"> The resource ID of the credential to use to connect to the output destination. </param>
        internal JobStepOutput(JobStepOutputType? stepOutputType, Guid? subscriptionId, string resourceGroupName, string serverName, string databaseName, string schemaName, string tableName, string credential)
        {
            StepOutputType = stepOutputType;
        ...
        public JobStepOutputType? StepOutputType { get; set; }
