...
{
    public partial class SqlMetricName : IUtf8JsonSerializable, IJsonModel<SqlMetricName>, IPersistableModel<SqlMetricName>
    {
        ...
        void IJsonModel<SqlMetricName>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SqlMetricName)} does not support '{format}' format.");
            }
