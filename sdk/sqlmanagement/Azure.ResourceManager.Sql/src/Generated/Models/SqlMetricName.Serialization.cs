...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SqlMetricName>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SqlMetricName>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SqlMetricName>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SqlMetricName>)} interface");
            }
        ...
        string IPersistableModel<SqlMetricName>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
