...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        internal static RecommendedActionErrorInfo DeserializeRecommendedActionErrorInfo(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
