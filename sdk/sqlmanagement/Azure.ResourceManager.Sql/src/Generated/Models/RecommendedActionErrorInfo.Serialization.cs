...
{
    public partial class RecommendedActionErrorInfo : IUtf8JsonSerializable, IJsonModel<RecommendedActionErrorInfo>, IPersistableModel<RecommendedActionErrorInfo>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(IsRetryable))
            {
                ...
                builder.AppendLine($" '{IsRetryable.ToString()}'");
            }
