...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<JobVersionListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<JobVersionListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<JobVersionListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<JobVersionListResult>)} interface");
            }
        ...
        string IPersistableModel<JobVersionListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
