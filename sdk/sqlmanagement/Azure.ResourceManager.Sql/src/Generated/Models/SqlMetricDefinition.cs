...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    public partial class SqlMetricDefinition
    {
        ...
        internal SqlMetricDefinition(SqlMetricName name, SqlMetricPrimaryAggregationType? primaryAggregationType, string resourceUriString, SqlMetricDefinitionUnitType? unit, IReadOnlyList<SqlMetricAvailability> metricAvailabilities, Dictionary<string, BinaryData> rawData)
        {
            Name = name;
