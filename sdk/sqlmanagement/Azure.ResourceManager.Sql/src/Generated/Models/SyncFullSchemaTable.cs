...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    public partial class SyncFullSchemaTable
    {
        ...
        internal SyncFullSchemaTable(IReadOnlyList<SyncFullSchemaTableColumn> columns, string errorId, bool? hasError, string name, string quotedName, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Columns = columns;
            ErrorId = errorId;
            HasError = hasError;
