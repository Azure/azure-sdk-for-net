...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StartStopManagedInstanceScheduleListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<StartStopManagedInstanceScheduleListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<StartStopManagedInstanceScheduleListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<StartStopManagedInstanceScheduleListResult>)} interface");
            }
        ...
        string IPersistableModel<StartStopManagedInstanceScheduleListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
