...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LongTermRetentionBackupOperationResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<LongTermRetentionBackupOperationResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<LongTermRetentionBackupOperationResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<LongTermRetentionBackupOperationResult>)} interface");
            }
        ...
        string IPersistableModel<LongTermRetentionBackupOperationResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
