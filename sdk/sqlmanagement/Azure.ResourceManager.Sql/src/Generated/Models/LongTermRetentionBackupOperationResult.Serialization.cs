...
{
    public partial class LongTermRetentionBackupOperationResult : IUtf8JsonSerializable, IJsonModel<LongTermRetentionBackupOperationResult>, IPersistableModel<LongTermRetentionBackupOperationResult>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(TargetBackupStorageRedundancy))
            {
                ...
                builder.AppendLine($" '{TargetBackupStorageRedundancy.ToString()}'");
            }
