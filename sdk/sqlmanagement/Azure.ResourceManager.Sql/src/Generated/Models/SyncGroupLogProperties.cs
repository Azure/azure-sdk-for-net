...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    public partial class SyncGroupLogProperties
    {
        ...
        internal SyncGroupLogProperties(DateTimeOffset? timestamp, SyncGroupLogType? logType, string source, string details, Guid? tracingId, string operationStatus, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Timestamp = timestamp;
            LogType = logType;
            Source = source;
