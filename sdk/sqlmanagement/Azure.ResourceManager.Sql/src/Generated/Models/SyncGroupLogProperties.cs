...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    public partial class SyncGroupLogProperties
    {
        ...
        /// <param name="groupLogType"> Type of the sync group log. </param>
        ...
        internal SyncGroupLogProperties(DateTimeOffset? timestamp, SyncGroupLogType? groupLogType, string source, string details, Guid? tracingId, string operationStatus)
        {
            Timestamp = timestamp;
        ...
        public SyncGroupLogType? GroupLogType { get; }
