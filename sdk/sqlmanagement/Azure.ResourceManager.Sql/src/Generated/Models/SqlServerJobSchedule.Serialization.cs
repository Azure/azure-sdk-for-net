...
{
    public partial class SqlServerJobSchedule : IUtf8JsonSerializable, IJsonModel<SqlServerJobSchedule>, IPersistableModel<SqlServerJobSchedule>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  type:");
                builder.AppendLine($" '{ScheduleType.ToString()}'");
            }
