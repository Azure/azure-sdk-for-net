...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    internal partial class ServerOperationProperties
    {
        ...
        internal ServerOperationProperties(string operation, string operationFriendlyName, int? percentComplete, string serverName, DateTimeOffset? startsOn, ManagementOperationState? state, int? errorCode, string errorDescription, int? errorSeverity, bool? isUserError, DateTimeOffset? estimatedCompleteOn, string description, bool? isCancellable, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Operation = operation;
