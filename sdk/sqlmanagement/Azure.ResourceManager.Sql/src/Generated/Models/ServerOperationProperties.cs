...
{
    /// <summary> The properties of a server operation. </summary>
    internal partial class ServerOperationProperties
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="ServerOperationProperties"/>. </summary>
        internal ServerOperationProperties()
        {
        }
        ...
        internal ServerOperationProperties(string operation, string operationFriendlyName, int? percentComplete, string serverName, DateTimeOffset? startOn, ManagementOperationState? state, int? errorCode, string errorDescription, int? errorSeverity, bool? isUserError, DateTimeOffset? estimatedCompletionOn, string description, bool? isCancellable, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Operation = operation;
