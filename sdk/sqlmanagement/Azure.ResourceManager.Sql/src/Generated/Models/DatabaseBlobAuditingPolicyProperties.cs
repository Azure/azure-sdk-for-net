...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    internal partial class DatabaseBlobAuditingPolicyProperties
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="DatabaseBlobAuditingPolicyProperties"/>. </summary>
        ...
        public DatabaseBlobAuditingPolicyProperties(BlobAuditingPolicyState state)
        {
        ...
        /// For more information, see [Database-Level Audit Actions](https://docs.microsoft.com/en-us/sql/relational-databases/security/auditing/sql-server-audit-action-groups-and-actions#database-level-audit-actions)
        /// </summary>
        [WirePath("auditActionsAndGroups")]
        public IList<string> AuditActionsAndGroups { get; } = new ChangeTrackingList<string>();

        /// <summary> Specifies whether storageAccountAccessKey value is the storage's secondary key. </summary>
        [WirePath("isStorageSecondaryKeyInUse")]
