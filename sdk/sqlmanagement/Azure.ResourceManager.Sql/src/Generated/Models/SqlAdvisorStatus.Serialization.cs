...
namespace Azure.ResourceManager.Sql.Models
{
    internal static partial class SqlAdvisorStatusExtensions
    {
        ...
        {
            if (StringComparer.OrdinalIgnoreCase.Equals(value, "GA"))
            {
                return SqlAdvisorStatus.GA;
            }
            if (StringComparer.OrdinalIgnoreCase.Equals(value, "PublicPreview"))
            {
                return SqlAdvisorStatus.PublicPreview;
            }
            if (StringComparer.OrdinalIgnoreCase.Equals(value, "LimitedPublicPreview"))
            {
                return SqlAdvisorStatus.LimitedPublicPreview;
            }
            if (StringComparer.OrdinalIgnoreCase.Equals(value, "PrivatePreview"))
            {
                return SqlAdvisorStatus.PrivatePreview;
            }
