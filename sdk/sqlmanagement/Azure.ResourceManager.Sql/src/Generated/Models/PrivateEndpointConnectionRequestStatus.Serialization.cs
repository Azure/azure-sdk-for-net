...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PrivateEndpointConnectionRequestStatus>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PrivateEndpointConnectionRequestStatus>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PrivateEndpointConnectionRequestStatus>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PrivateEndpointConnectionRequestStatus>)} interface");
            }
        ...
        string IPersistableModel<PrivateEndpointConnectionRequestStatus>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
