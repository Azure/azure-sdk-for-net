...
namespace Azure.ResourceManager.Sql
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SqlServerTrustGroupData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SqlServerTrustGroupData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SqlServerTrustGroupData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SqlServerTrustGroupData>)} interface");
            }
        ...
        string IPersistableModel<SqlServerTrustGroupData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
