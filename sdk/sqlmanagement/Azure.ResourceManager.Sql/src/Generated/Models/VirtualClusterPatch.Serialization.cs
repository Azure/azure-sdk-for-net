...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VirtualClusterPatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<VirtualClusterPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<VirtualClusterPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<VirtualClusterPatch>)} interface");
            }
        ...
        string IPersistableModel<VirtualClusterPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
