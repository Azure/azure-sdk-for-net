...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ImportExportExtensionsOperationResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ImportExportExtensionsOperationResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ImportExportExtensionsOperationResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ImportExportExtensionsOperationResult>)} interface");
            }
        ...
        string IPersistableModel<ImportExportExtensionsOperationResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
