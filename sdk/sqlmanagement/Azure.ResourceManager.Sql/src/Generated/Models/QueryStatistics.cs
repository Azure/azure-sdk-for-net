...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    public partial class QueryStatistics : ResourceData
    {
        ...
        internal QueryStatistics(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string databaseName, string queryId, string startTime, string endTime, IList<QueryMetricInterval> intervals, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData)
        {
