...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ServerTrustGroupListResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (options.Format != "W" && Optional.IsCollectionDefined(Value))
            {
                ...
                {
                    ((IJsonModel<SqlServerTrustGroupData>)item).Write(writer, options);
                }
        ...
        internal static ServerTrustGroupListResult DeserializeServerTrustGroupListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            IReadOnlyList<SqlServerTrustGroupData> value = default;
            ...
            return new ServerTrustGroupListResult(value ?? new ChangeTrackingList<SqlServerTrustGroupData>(), nextLink, serializedAdditionalRawData);
        }
