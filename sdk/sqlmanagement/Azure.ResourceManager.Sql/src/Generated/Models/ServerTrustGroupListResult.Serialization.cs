...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ServerTrustGroupListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ServerTrustGroupListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ServerTrustGroupListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ServerTrustGroupListResult>)} interface");
            }
        ...
        string IPersistableModel<ServerTrustGroupListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
