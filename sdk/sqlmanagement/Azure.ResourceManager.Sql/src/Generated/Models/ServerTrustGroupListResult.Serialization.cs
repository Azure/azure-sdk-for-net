...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        internal static ServerTrustGroupListResult DeserializeServerTrustGroupListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
