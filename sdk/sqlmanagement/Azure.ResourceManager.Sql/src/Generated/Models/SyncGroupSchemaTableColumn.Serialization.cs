...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SyncGroupSchemaTableColumn>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SyncGroupSchemaTableColumn>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SyncGroupSchemaTableColumn>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SyncGroupSchemaTableColumn>)} interface");
            }
        ...
        string IPersistableModel<SyncGroupSchemaTableColumn>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
