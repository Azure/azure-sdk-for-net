...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    public partial class ImportNewDatabaseDefinition
    {
        ...
        public ImportNewDatabaseDefinition(StorageKeyType storageKeyType, string storageKey, Uri storageUri, string administratorLogin, string administratorLoginPassword)
        {
            if (storageKey == null)
            {
