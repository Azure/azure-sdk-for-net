...
namespace Azure.ResourceManager.Sql.Models
{
    public partial class DatabaseExportDefinition : IUtf8JsonSerializable, IJsonModel<DatabaseExportDefinition>
    {
        ...
        void IJsonModel<DatabaseExportDefinition>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(DatabaseExportDefinition)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<DatabaseExportDefinition>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(DatabaseExportDefinition)} does not support '{options.Format}' format.");
            }
        }
