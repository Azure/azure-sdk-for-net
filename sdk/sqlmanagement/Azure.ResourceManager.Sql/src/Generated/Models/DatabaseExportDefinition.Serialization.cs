...
namespace Azure.ResourceManager.Sql.Models
{
    public partial class DatabaseExportDefinition : IUtf8JsonSerializable, IJsonModel<DatabaseExportDefinition>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<DatabaseExportDefinition>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DatabaseExportDefinition>)} interface");
            }
