...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DatabaseExportDefinition>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DatabaseExportDefinition>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DatabaseExportDefinition>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<DatabaseExportDefinition>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
