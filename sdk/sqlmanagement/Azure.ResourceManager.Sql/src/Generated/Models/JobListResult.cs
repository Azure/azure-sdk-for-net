...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    internal partial class JobListResult
    {
        ...
        internal JobListResult(IEnumerable<SqlServerJobData> value)
        {
            Value = value.ToList();
        }
        ...
        internal JobListResult(IList<SqlServerJobData> value, Uri nextLink, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            NextLink = nextLink;
        ...
        [WirePath("value")]
        public IList<SqlServerJobData> Value { get; }
