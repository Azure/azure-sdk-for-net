...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        internal static VirtualNetworkRuleListResult DeserializeVirtualNetworkRuleListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
