...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    internal partial class LongTermRetentionPolicyListResult
    {
        ...
        {
            Value = new ChangeTrackingList<LongTermRetentionPolicy>();
        }

        /// <summary> Initializes a new instance of LongTermRetentionPolicyListResult. </summary>
        /// <param name="value"> Array of results. </param>
        /// <param name="nextLink"> Link to retrieve next page of results. </param>
        internal LongTermRetentionPolicyListResult(IReadOnlyList<LongTermRetentionPolicy> value, string nextLink)
        {
            Value = value;
            NextLink = nextLink;
        }
        ...
        public IReadOnlyList<LongTermRetentionPolicy> Value { get; }
