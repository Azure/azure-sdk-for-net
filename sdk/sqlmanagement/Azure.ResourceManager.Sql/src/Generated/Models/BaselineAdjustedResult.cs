...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    public partial class BaselineAdjustedResult
    {
        ...
        internal BaselineAdjustedResult(Baseline baseline, RuleStatus? status, IReadOnlyList<IList<string>> resultsNotInBaseline, IReadOnlyList<IList<string>> resultsOnlyInBaseline)
        {
            Baseline = baseline;
            Status = status;
