...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    internal partial class BaselineAdjustedResult
    {
        ...
        internal BaselineAdjustedResult(Baseline baseline, RuleStatus? status, IReadOnlyList<IList<string>> resultsNotInBaseline, IReadOnlyList<IList<string>> resultsOnlyInBaseline, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Baseline = baseline;
            Status = status;
