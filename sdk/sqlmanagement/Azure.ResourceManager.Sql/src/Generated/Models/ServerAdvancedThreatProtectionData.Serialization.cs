...
{
    public partial class ServerAdvancedThreatProtectionData : Core.IUtf8JsonSerializable
    {
        ...
        internal static ServerAdvancedThreatProtectionData DeserializeServerAdvancedThreatProtectionData(JsonElement element)
        {
            ...
            return new ServerAdvancedThreatProtectionData(id, name, type, systemData.Value, Core.Optional.ToNullable(state), Core.Optional.ToNullable(creationTime));
        }
    }
}
