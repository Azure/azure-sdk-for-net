...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LongTermRetentionBackupListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<LongTermRetentionBackupListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<LongTermRetentionBackupListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<LongTermRetentionBackupListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
