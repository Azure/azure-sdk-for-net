...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ImportExistingDatabaseDefinition>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ImportExistingDatabaseDefinition>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ImportExistingDatabaseDefinition>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ImportExistingDatabaseDefinition>)} interface");
            }
        ...
        string IPersistableModel<ImportExistingDatabaseDefinition>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
