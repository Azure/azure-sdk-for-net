...
{
    public partial class InstancePoolUsage : IUtf8JsonSerializable, IJsonModel<InstancePoolUsage>, IPersistableModel<InstancePoolUsage>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(RequestedLimit))
            {
                ...
                builder.AppendLine($" '{RequestedLimit.Value.ToString()}'");
            }
