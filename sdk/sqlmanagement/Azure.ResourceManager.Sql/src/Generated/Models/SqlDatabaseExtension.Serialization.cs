...
{
    public partial class SqlDatabaseExtension : IUtf8JsonSerializable, IJsonModel<SqlDatabaseExtension>, IPersistableModel<SqlDatabaseExtension>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(OperationMode))
            {
                ...
                builder.AppendLine($" '{OperationMode.ToString()}'");
            }
