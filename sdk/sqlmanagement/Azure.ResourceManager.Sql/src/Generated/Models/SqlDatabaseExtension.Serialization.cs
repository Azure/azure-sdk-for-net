...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SqlDatabaseExtension>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SqlDatabaseExtension>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SqlDatabaseExtension>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SqlDatabaseExtension>)} interface");
            }
        ...
        string IPersistableModel<SqlDatabaseExtension>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
