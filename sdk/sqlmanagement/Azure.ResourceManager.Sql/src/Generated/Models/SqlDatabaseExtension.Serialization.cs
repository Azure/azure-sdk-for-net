...
{
    public partial class SqlDatabaseExtension : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static SqlDatabaseExtension DeserializeSqlDatabaseExtension(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
