        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ReadWriteEndpoint) || hasPropertyOverride)
            {
                ...
                else
                {
                    ...
                    AppendChildObject(builder, ReadWriteEndpoint, options, currentIndent, false);
                    if (builder.Length == length + emptyObjectLength)
                    {
                        builder.Length = builder.Length - emptyObjectLength - "    readWriteEndpoint: ".Length;
                    }
                }
            }
            ...
            if (Optional.IsDefined(ReadOnlyEndpoint) || hasPropertyOverride)
            {
                ...
                else
                {
                    ...
                    int emptyObjectLength = 2 + currentIndent + Environment.NewLine.Length + Environment.NewLine.Length;
                    int length = builder.Length;
                    AppendChildObject(builder, ReadOnlyEndpoint, options, currentIndent, false);
                    if (builder.Length == length + emptyObjectLength)
                    {
                        builder.Length = builder.Length - emptyObjectLength - "    readOnlyEndpoint: ".Length;
                    }
                }
            }
                ...
                if (PartnerRegions.Any() || hasPropertyOverride)
                {
                    ...
                    else
                    {
                        ...
                        foreach (var item in PartnerRegions)
                        {
                            ...
                            if (builder.Length == length + emptyObjectLength)
                            {
                                builder.Length = builder.Length - emptyObjectLength - "    partnerRegions: ".Length;
                            }
                        }
                        builder.AppendLine("    ]");
                    }
                ...
                if (ManagedInstancePairs.Any() || hasPropertyOverride)
                {
                    ...
                    else
                    {
                        ...
                        foreach (var item in ManagedInstancePairs)
                        {
                            ...
                            if (builder.Length == length + emptyObjectLength)
                            {
                                builder.Length = builder.Length - emptyObjectLength - "    managedInstancePairs: ".Length;
                            }
                        }
                        builder.AppendLine("    ]");
                    }
