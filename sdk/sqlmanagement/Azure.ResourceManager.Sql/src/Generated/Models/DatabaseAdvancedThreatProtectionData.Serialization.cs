...
namespace Azure.ResourceManager.Sql
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DatabaseAdvancedThreatProtectionData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DatabaseAdvancedThreatProtectionData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DatabaseAdvancedThreatProtectionData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DatabaseAdvancedThreatProtectionData>)} interface");
            }
        ...
        string IPersistableModel<DatabaseAdvancedThreatProtectionData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
