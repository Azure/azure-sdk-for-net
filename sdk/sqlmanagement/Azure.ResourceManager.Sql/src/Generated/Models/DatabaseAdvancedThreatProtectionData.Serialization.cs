...
{
    public partial class DatabaseAdvancedThreatProtectionData : Core.IUtf8JsonSerializable
    {
        ...
        internal static DatabaseAdvancedThreatProtectionData DeserializeDatabaseAdvancedThreatProtectionData(JsonElement element)
        {
            ...
            return new DatabaseAdvancedThreatProtectionData(id, name, type, systemData.Value, Core.Optional.ToNullable(state), Core.Optional.ToNullable(creationTime));
        }
    }
}
