...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DatabaseImportDefinition>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DatabaseImportDefinition>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DatabaseImportDefinition>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DatabaseImportDefinition>)} interface");
            }
        ...
        string IPersistableModel<DatabaseImportDefinition>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
