...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    public partial class ImportExistingDatabaseDefinition
    {
        ...
        internal ImportExistingDatabaseDefinition(StorageKeyType storageKeyType, string storageKey, Uri storageUri, string administratorLogin, string administratorLoginPassword, string authenticationType, NetworkIsolationSettings networkIsolation, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            StorageKeyType = storageKeyType;
            StorageKey = storageKey;
            StorageUri = storageUri;
