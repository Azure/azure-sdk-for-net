...
namespace Azure.ResourceManager.Sql
{
    public partial class SqlPrivateEndpointConnectionData : IUtf8JsonSerializable
    {
        ...
        internal static SqlPrivateEndpointConnectionData DeserializeSqlPrivateEndpointConnectionData(JsonElement element)
        {
            ...
            return new SqlPrivateEndpointConnectionData(id, name, type, systemData, privateEndpoint, privateLinkServiceConnectionState.Value, Optional.ToNullable(provisioningState));
        }
    }
}
