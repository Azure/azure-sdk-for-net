...
{
    public partial class SqlPrivateEndpointConnectionData : Core.IUtf8JsonSerializable
    {
        ...
        internal static SqlPrivateEndpointConnectionData DeserializeSqlPrivateEndpointConnectionData(JsonElement element)
        {
            ...
            return new SqlPrivateEndpointConnectionData(id, name, type, systemData.Value, privateEndpoint, privateLinkServiceConnectionState.Value, Core.Optional.ToNullable(provisioningState));
        }
    }
}
