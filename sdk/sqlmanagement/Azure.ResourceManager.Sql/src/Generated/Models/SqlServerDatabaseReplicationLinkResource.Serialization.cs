...
namespace Azure.ResourceManager.Sql
{
    public partial class SqlServerDatabaseReplicationLinkResource : IJsonModel<SqlServerDatabaseReplicationLinkData>
    {
        ...
        {
            return ModelReaderWriter.Read<SqlServerDatabaseReplicationLinkData>(new BinaryData(reader.ValueSequence), options);
        }
        ...
        {
            return ModelReaderWriter.Read<SqlServerDatabaseReplicationLinkData>(data, options);
        }
