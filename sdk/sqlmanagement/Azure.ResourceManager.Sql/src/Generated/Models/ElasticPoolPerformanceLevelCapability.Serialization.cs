...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ElasticPoolPerformanceLevelCapability>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ElasticPoolPerformanceLevelCapability>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ElasticPoolPerformanceLevelCapability>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ElasticPoolPerformanceLevelCapability>)} interface");
            }
        ...
        string IPersistableModel<ElasticPoolPerformanceLevelCapability>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
