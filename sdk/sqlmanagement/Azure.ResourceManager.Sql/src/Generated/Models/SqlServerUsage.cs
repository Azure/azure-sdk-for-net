...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    public partial class SqlServerUsage
    {
        ...
        internal SqlServerUsage(string name, string resourceName, string displayName, double? currentValue, double? limit, string unit, DateTimeOffset? nextResetOn, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
