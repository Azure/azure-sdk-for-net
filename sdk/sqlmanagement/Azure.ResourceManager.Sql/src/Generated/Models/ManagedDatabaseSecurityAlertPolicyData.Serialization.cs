...
namespace Azure.ResourceManager.Sql
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ManagedDatabaseSecurityAlertPolicyData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ManagedDatabaseSecurityAlertPolicyData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ManagedDatabaseSecurityAlertPolicyData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ManagedDatabaseSecurityAlertPolicyData>)} interface");
            }
        ...
        string IPersistableModel<ManagedDatabaseSecurityAlertPolicyData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
