...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DatabaseAdvancedThreatProtectionListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DatabaseAdvancedThreatProtectionListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DatabaseAdvancedThreatProtectionListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<DatabaseAdvancedThreatProtectionListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
