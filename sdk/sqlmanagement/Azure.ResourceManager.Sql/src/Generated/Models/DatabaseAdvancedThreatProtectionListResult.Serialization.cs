...
namespace Azure.ResourceManager.Sql.Models
{
    internal partial class DatabaseAdvancedThreatProtectionListResult : IUtf8JsonSerializable, IJsonModel<DatabaseAdvancedThreatProtectionListResult>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<DatabaseAdvancedThreatProtectionListResult>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DatabaseAdvancedThreatProtectionListResult>)} interface");
            }
