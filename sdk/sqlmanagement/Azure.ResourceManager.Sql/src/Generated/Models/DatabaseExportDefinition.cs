...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    public partial class DatabaseExportDefinition
    {
        ...
        internal DatabaseExportDefinition(StorageKeyType storageKeyType, string storageKey, Uri storageUri, string administratorLogin, string administratorLoginPassword, string authenticationType, NetworkIsolationSettings networkIsolation, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            StorageKeyType = storageKeyType;
            StorageKey = storageKey;
            StorageUri = storageUri;
