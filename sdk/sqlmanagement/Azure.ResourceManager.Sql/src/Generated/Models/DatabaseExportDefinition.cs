...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    public partial class DatabaseExportDefinition
    {
        ...
        internal DatabaseExportDefinition(StorageKeyType storageKeyType, string storageKey, Uri storageUri, string administratorLogin, string administratorLoginPassword, string authenticationType, NetworkIsolationSettingsAutoGenerated networkIsolation, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            StorageKeyType = storageKeyType;
            StorageKey = storageKey;
            StorageUri = storageUri;
