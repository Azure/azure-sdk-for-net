...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ElasticPoolListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ElasticPoolListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ElasticPoolListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ElasticPoolListResult>)} interface");
            }
        ...
        string IPersistableModel<ElasticPoolListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
