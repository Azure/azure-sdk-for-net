...
{
    public partial class ElasticPoolData : IUtf8JsonSerializable, IJsonModel<ElasticPoolData>, IPersistableModel<ElasticPoolData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(PerDatabaseSettings))
            {
                ...
                AppendChildObject(builder, PerDatabaseSettings, options, 2);
            }
            ...
            if (Optional.IsDefined(HighAvailabilityReplicaCount))
            {
                ...
                builder.AppendLine($" '{HighAvailabilityReplicaCount.Value.ToString()}'");
            }

            if (Optional.IsDefined(PreferredEnclaveType))
            {
                builder.Append("  preferredEnclaveType:");
                builder.AppendLine($" '{PreferredEnclaveType.ToString()}'");
            }

            if (Optional.IsDefined(AvailabilityZone))
            {
                builder.Append("  availabilityZone:");
                builder.AppendLine($" '{AvailabilityZone.ToString()}'");
            }
