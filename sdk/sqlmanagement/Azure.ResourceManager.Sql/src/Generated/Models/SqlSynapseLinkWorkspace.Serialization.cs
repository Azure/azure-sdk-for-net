...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SqlSynapseLinkWorkspace>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SqlSynapseLinkWorkspace>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SqlSynapseLinkWorkspace>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SqlSynapseLinkWorkspace>)} interface");
            }
        ...
        string IPersistableModel<SqlSynapseLinkWorkspace>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
