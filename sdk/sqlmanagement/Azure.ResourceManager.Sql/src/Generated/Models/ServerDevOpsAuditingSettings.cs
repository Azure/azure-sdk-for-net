...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        /// <summary> Initializes a new instance of ServerDevOpsAuditingSettings. </summary>
        ...
        internal ServerDevOpsAuditingSettings(string id, string name, string type, SystemData systemData, bool? isAzureMonitorTargetEnabled, BlobAuditingPolicyState? state, string storageEndpoint, string storageAccountAccessKey, Guid? storageAccountSubscriptionId) : base(id, name, type)
        {
