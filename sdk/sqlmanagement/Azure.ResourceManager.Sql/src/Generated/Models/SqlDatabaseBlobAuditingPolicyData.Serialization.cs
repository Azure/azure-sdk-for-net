...
{
    public partial class SqlDatabaseBlobAuditingPolicyData : IUtf8JsonSerializable, IModelJsonSerializable<SqlDatabaseBlobAuditingPolicyData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IModelJsonSerializable<SqlDatabaseBlobAuditingPolicyData>)this).Serialize(writer, ModelSerializerOptions.DefaultWireOptions);

        void IModelJsonSerializable<SqlDatabaseBlobAuditingPolicyData>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<SqlDatabaseBlobAuditingPolicyData>(this, options.Format);
        ...
        internal static SqlDatabaseBlobAuditingPolicyData DeserializeSqlDatabaseBlobAuditingPolicyData(JsonElement element, ModelSerializerOptions options = default)
        {
        ...
        SqlDatabaseBlobAuditingPolicyData IModelJsonSerializable<SqlDatabaseBlobAuditingPolicyData>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<SqlDatabaseBlobAuditingPolicyData>(this, options.Format);

            using var doc = JsonDocument.ParseValue(ref reader);
            return DeserializeSqlDatabaseBlobAuditingPolicyData(doc.RootElement, options);
        }

        BinaryData IModelSerializable<SqlDatabaseBlobAuditingPolicyData>.Serialize(ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<SqlDatabaseBlobAuditingPolicyData>(this, options.Format);
        ...
        SqlDatabaseBlobAuditingPolicyData IModelSerializable<SqlDatabaseBlobAuditingPolicyData>.Deserialize(BinaryData data, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<SqlDatabaseBlobAuditingPolicyData>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="SqlDatabaseBlobAuditingPolicyData"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="SqlDatabaseBlobAuditingPolicyData"/> to convert. </param>
        public static implicit operator RequestContent(SqlDatabaseBlobAuditingPolicyData model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="SqlDatabaseBlobAuditingPolicyData"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator SqlDatabaseBlobAuditingPolicyData(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeSqlDatabaseBlobAuditingPolicyData(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
