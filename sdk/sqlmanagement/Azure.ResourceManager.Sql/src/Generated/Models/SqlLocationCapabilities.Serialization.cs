                ...
                if (SupportedServerVersions.Any() || hasPropertyOverride)
                {
                    ...
                    else
                    {
                        ...
                        foreach (var item in SupportedServerVersions)
                        {
                            ...
                            {
                                builder.Length = builder.Length - emptyObjectLength - "  supportedServerVersions: ".Length;
                            }
                        }
                        builder.AppendLine("  ]");
                    }
                ...
                if (SupportedManagedInstanceVersions.Any() || hasPropertyOverride)
                {
                    ...
                    else
                    {
                        ...
                        foreach (var item in SupportedManagedInstanceVersions)
                        {
                            ...
                            if (builder.Length == length + emptyObjectLength)
                            {
                                builder.Length = builder.Length - emptyObjectLength - "  supportedManagedInstanceVersions: ".Length;
                            }
                        }
                        builder.AppendLine("  ]");
                    }
