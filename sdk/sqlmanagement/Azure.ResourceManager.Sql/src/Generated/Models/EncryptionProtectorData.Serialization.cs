...
namespace Azure.ResourceManager.Sql
{
    public partial class EncryptionProtectorData : IUtf8JsonSerializable
    {
        ...
        internal static EncryptionProtectorData DeserializeEncryptionProtectorData(JsonElement element)
        {
            ...
            return new EncryptionProtectorData(id, name, type, systemData, kind.Value, Optional.ToNullable(location), subregion.Value, serverKeyName.Value, Optional.ToNullable(serverKeyType), uri.Value, thumbprint.Value, Optional.ToNullable(autoRotationEnabled));
        }
    }
}
