...
{
    public partial class EncryptionProtectorData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static EncryptionProtectorData DeserializeEncryptionProtectorData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
