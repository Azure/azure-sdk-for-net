...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FailoverGroupPatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<FailoverGroupPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<FailoverGroupPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<FailoverGroupPatch>)} interface");
            }
        ...
        string IPersistableModel<FailoverGroupPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
