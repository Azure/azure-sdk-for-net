...
namespace Azure.ResourceManager.Sql
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DatabaseTableData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DatabaseTableData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DatabaseTableData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DatabaseTableData>)} interface");
            }
        ...
        string IPersistableModel<DatabaseTableData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
