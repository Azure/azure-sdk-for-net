...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        internal static DatabaseOperationListResult DeserializeDatabaseOperationListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
