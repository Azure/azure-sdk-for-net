...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DatabaseOperationListResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<DatabaseOperationListResult>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
            ...
            if (options.Format != "W" && Optional.IsCollectionDefined(Value))
            {
                ...
                {
                    ((IJsonModel<DatabaseOperationData>)item).Write(writer, options);
                }
        ...
        internal static DatabaseOperationListResult DeserializeDatabaseOperationListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            IReadOnlyList<DatabaseOperationData> value = default;
            ...
            return new DatabaseOperationListResult(value ?? new ChangeTrackingList<DatabaseOperationData>(), nextLink, serializedAdditionalRawData);
        }
