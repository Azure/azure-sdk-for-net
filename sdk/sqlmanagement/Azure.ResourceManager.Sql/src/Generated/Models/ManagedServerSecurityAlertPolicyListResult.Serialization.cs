...
{
    internal partial class ManagedServerSecurityAlertPolicyListResult : IUtf8JsonSerializable, IJsonModel<ManagedServerSecurityAlertPolicyListResult>, IPersistableModel<ManagedServerSecurityAlertPolicyListResult>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ManagedServerSecurityAlertPolicyListResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ManagedServerSecurityAlertPolicyListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ManagedServerSecurityAlertPolicyListResult)} does not support '{format}' format.");
            }
