...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    {
        internal static ManagedServerDnsAliasListResult DeserializeManagedServerDnsAliasListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
