...
namespace Azure.ResourceManager.Sql
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SqlServerDatabaseReplicationLinkData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SqlServerDatabaseReplicationLinkData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SqlServerDatabaseReplicationLinkData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SqlServerDatabaseReplicationLinkData>)} interface");
            }
        ...
        string IPersistableModel<SqlServerDatabaseReplicationLinkData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
