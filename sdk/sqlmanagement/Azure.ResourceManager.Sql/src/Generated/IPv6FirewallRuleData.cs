...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class IPv6FirewallRuleData : ProxyResourceWithWritableName
    {
        ...
        internal IPv6FirewallRuleData(ResourceIdentifier id, string name, ResourceType? resourceType, string startIPv6Address, string endIPv6Address, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, rawData)
        {
