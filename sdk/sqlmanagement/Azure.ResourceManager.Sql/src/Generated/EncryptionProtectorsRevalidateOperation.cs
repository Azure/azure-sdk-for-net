...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class EncryptionProtectorsRevalidateOperation : Operation<Response>, IOperationSource<Response>
    {
        private readonly ArmOperationHelpers<Response> _operation;

        /// <summary> Initializes a new instance of EncryptionProtectorsRevalidateOperation for mocking. </summary>
        protected EncryptionProtectorsRevalidateOperation()
        {
        }

        internal EncryptionProtectorsRevalidateOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<Response>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "EncryptionProtectorsRevalidateOperation");
        }
        /// <inheritdoc />
