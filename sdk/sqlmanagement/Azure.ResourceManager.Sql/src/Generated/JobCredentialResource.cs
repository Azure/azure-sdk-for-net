...
{
    /// <summary>
    /// A Class representing a JobCredential along with the instance operations that can be performed on it.
    /// If you have a <see cref="ResourceIdentifier" /> you can construct a <see cref="JobCredentialResource" />
    /// from an instance of <see cref="ArmClient" /> using the GetJobCredentialResource method.
    /// Otherwise you can get one from its parent resource <see cref="JobAgentResource" /> using the GetJobCredential method.
    /// </summary>
    public partial class JobCredentialResource : ArmResource
    {
        /// <summary> Generate the resource identifier of a <see cref="JobCredentialResource"/> instance. </summary>
        ...
        /// <summary> Initializes a new instance of the <see cref="JobCredentialResource"/> class for mocking. </summary>
        protected JobCredentialResource()
        {
        }

        /// <summary> Initializes a new instance of the <see cref = "JobCredentialResource"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="data"> The resource that is the target of operations. </param>
        internal JobCredentialResource(ArmClient client, JobCredentialData data) : this(client, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal JobCredentialResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<JobCredentialResource> Get(CancellationToken cancellationToken = default)
        {
            using var scope = _jobCredentialClientDiagnostics.CreateScope("JobCredentialResource.Get");
            scope.Start();
            try
        ...
        {
            using var scope = _jobCredentialClientDiagnostics.CreateScope("JobCredentialResource.Delete");
            scope.Start();
            try
            {
        ...
        public virtual async Task<ArmOperation<JobCredentialResource>> UpdateAsync(WaitUntil waitUntil, JobCredentialData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));

            using var scope = _jobCredentialClientDiagnostics.CreateScope("JobCredentialResource.Update");
            scope.Start();
            try
            {
                var response = await _jobCredentialRestClient.CreateOrUpdateAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, data, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        public virtual ArmOperation<JobCredentialResource> Update(WaitUntil waitUntil, JobCredentialData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
            ...
            try
            {
                var response = _jobCredentialRestClient.CreateOrUpdate(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, data, cancellationToken);
                var operation = new SqlArmOperation<JobCredentialResource>(Response.FromValue(new JobCredentialResource(Client, response), response.GetRawResponse()));
                if (waitUntil == WaitUntil.Completed)
