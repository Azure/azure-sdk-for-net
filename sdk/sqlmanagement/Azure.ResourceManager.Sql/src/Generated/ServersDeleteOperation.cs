...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class ServersDeleteOperation : Operation<Response>, IOperationSource<Response>
    {
        private readonly ArmOperationHelpers<Response> _operation;

        /// <summary> Initializes a new instance of ServersDeleteOperation for mocking. </summary>
        protected ServersDeleteOperation()
        {
        }

        internal ServersDeleteOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<Response>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "ServersDeleteOperation");
        }
        /// <inheritdoc />
