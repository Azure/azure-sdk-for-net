...
namespace Azure.ResourceManager.Sql
{
    ...
    {
        private readonly ClientDiagnostics _managedRestorableDroppedDbBackupShortTermRetentionPoliciesClientDiagnostics;
        private readonly ManagedRestorableDroppedDbBackupShortTermRetentionPolicies _managedRestorableDroppedDbBackupShortTermRetentionPoliciesRestClient;
        ...
        internal ManagedRestorableDroppedDbBackupShortTermRetentionPolicyCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _managedRestorableDroppedDbBackupShortTermRetentionPoliciesClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Sql", ManagedRestorableDroppedDbBackupShortTermRetentionPolicyResource.ResourceType.Namespace, Diagnostics);
            _managedRestorableDroppedDbBackupShortTermRetentionPoliciesRestClient = new ManagedRestorableDroppedDbBackupShortTermRetentionPolicies(_managedRestorableDroppedDbBackupShortTermRetentionPoliciesClientDiagnostics, Pipeline, Endpoint, managedRestorableDroppedDbBackupShortTermRetentionPolicyApiVersion ?? "2025-02-01-preview");
        ...
        public virtual async Task<ArmOperation<ManagedRestorableDroppedDbBackupShortTermRetentionPolicyResource>> CreateOrUpdateAsync(WaitUntil waitUntil, ManagedShortTermRetentionPolicyName policyName, ManagedBackupShortTermRetentionPolicyData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _managedRestorableDroppedDbBackupShortTermRetentionPoliciesClientDiagnostics.CreateScope("ManagedRestorableDroppedDbBackupShortTermRetentionPolicyCollection.CreateOrUpdate");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _managedRestorableDroppedDbBackupShortTermRetentionPoliciesRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, policyName.ToString(), ManagedBackupShortTermRetentionPolicyData.ToRequestContent(data), context);
                ...
                SqlArmOperation<ManagedRestorableDroppedDbBackupShortTermRetentionPolicyResource> operation = new SqlArmOperation<ManagedRestorableDroppedDbBackupShortTermRetentionPolicyResource>(
                    new ManagedRestorableDroppedDbBackupShortTermRetentionPolicyOperationSource(Client),
                    _managedRestorableDroppedDbBackupShortTermRetentionPoliciesClientDiagnostics,
                    Pipeline,
                    message.Request,
                    response,
        ...
        {
            using DiagnosticScope scope = _managedRestorableDroppedDbBackupShortTermRetentionPoliciesClientDiagnostics.CreateScope("ManagedRestorableDroppedDbBackupShortTermRetentionPolicyCollection.Get");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _managedRestorableDroppedDbBackupShortTermRetentionPoliciesRestClient.CreateGetRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, policyName.ToString(), context);
        ...
        public virtual AsyncPageable<ManagedRestorableDroppedDbBackupShortTermRetentionPolicyResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<ManagedBackupShortTermRetentionPolicyData, ManagedRestorableDroppedDbBackupShortTermRetentionPolicyResource>(new ManagedRestorableDroppedDbBackupShortTermRetentionPoliciesGetByRestorableDroppedDatabaseAsyncCollectionResultOfT(
                _managedRestorableDroppedDbBackupShortTermRetentionPoliciesRestClient,
        ...
        public virtual Pageable<ManagedRestorableDroppedDbBackupShortTermRetentionPolicyResource> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            return new PageableWrapper<ManagedBackupShortTermRetentionPolicyData, ManagedRestorableDroppedDbBackupShortTermRetentionPolicyResource>(new ManagedRestorableDroppedDbBackupShortTermRetentionPoliciesGetByRestorableDroppedDatabaseCollectionResultOfT(
                _managedRestorableDroppedDbBackupShortTermRetentionPoliciesRestClient,
                Guid.Parse(Id.SubscriptionId),
                Id.ResourceGroupName,
                Id.Parent.Name,
        ...
        {
            using DiagnosticScope scope = _managedRestorableDroppedDbBackupShortTermRetentionPoliciesClientDiagnostics.CreateScope("ManagedRestorableDroppedDbBackupShortTermRetentionPolicyCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        {
            using DiagnosticScope scope = _managedRestorableDroppedDbBackupShortTermRetentionPoliciesClientDiagnostics.CreateScope("ManagedRestorableDroppedDbBackupShortTermRetentionPolicyCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
