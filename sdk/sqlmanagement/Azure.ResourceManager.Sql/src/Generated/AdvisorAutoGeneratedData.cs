...
{
    /// <summary>
    /// A class representing the AdvisorAutoGenerated data model.
    /// Database, Server or Elastic Pool Advisor.
    /// </summary>
    public partial class AdvisorAutoGeneratedData : ResourceData
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="AdvisorAutoGeneratedData"/>. </summary>
        public AdvisorAutoGeneratedData()
        {
        ...
        internal AdvisorAutoGeneratedData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string kind, AzureLocation? location, SqlAdvisorStatus? advisorStatus, AutoExecuteStatus? autoExecuteStatus, AutoExecuteStatusInheritedFrom? autoExecuteStatusInheritedFrom, string recommendationsStatus, DateTimeOffset? lastCheckedOn, IReadOnlyList<RecommendedActionAutoGenerated2> recommendedActions, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
            Kind = kind;
            Location = location;
        ...
        public IReadOnlyList<RecommendedActionAutoGenerated2> RecommendedActions { get; }
    }
}
