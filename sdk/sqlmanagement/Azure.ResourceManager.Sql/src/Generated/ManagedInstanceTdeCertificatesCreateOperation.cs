...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class ManagedInstanceTdeCertificatesCreateOperation : Operation<Response>, IOperationSource<Response>
    {
        private readonly ArmOperationHelpers<Response> _operation;

        /// <summary> Initializes a new instance of ManagedInstanceTdeCertificatesCreateOperation for mocking. </summary>
        protected ManagedInstanceTdeCertificatesCreateOperation()
        {
        }

        internal ManagedInstanceTdeCertificatesCreateOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<Response>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "ManagedInstanceTdeCertificatesCreateOperation");
        }
        /// <inheritdoc />
