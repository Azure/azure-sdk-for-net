...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    public static partial class ArmSqlModelFactory
    {
        ...
        public static ElasticPoolData ElasticPoolData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, SqlSku sku = null, string kind = null, ElasticPoolState? state = null, DateTimeOffset? createdOn = null, long? maxSizeBytes = null, double? minCapacity = null, ElasticPoolPerDatabaseSettings perDatabaseSettings = null, bool? isZoneRedundant = null, ElasticPoolLicenseType? licenseType = null, ResourceIdentifier maintenanceConfigurationId = null, int? highAvailabilityReplicaCount = null)
        {
            tags ??= new Dictionary<string, string>();
        ...
        public static FailoverGroupData FailoverGroupData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, AzureLocation? location = null, IDictionary<string, string> tags = null, FailoverGroupReadWriteEndpoint readWriteEndpoint = null, ReadOnlyEndpointFailoverPolicy? readOnlyEndpointFailoverPolicy = null, FailoverGroupReplicationRole? replicationRole = null, string replicationState = null, IEnumerable<PartnerServerInfo> partnerServers = null, IEnumerable<ResourceIdentifier> failoverDatabases = null)
        {
            ...
            return new FailoverGroupData(
                ...
                tags,
                readWriteEndpoint,
                readOnlyEndpointFailoverPolicy != null ? new FailoverGroupReadOnlyEndpoint(readOnlyEndpointFailoverPolicy, serializedAdditionalRawData: null) : null,
                replicationRole,
                replicationState,
        ...
        public static ManagedDatabaseRestoreDetailData ManagedDatabaseRestoreDetailData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string status = null, string currentRestoringFileName = null, string lastRestoredFileName = null, DateTimeOffset? lastRestoredFileOn = null, double? completedPercent = null, IEnumerable<string> unrestorableFileList = null, long? numberOfFilesFound = null, string lastUploadedFileName = null, DateTimeOffset? lastUploadedFileOn = null, string blockReason = null)
        {
            unrestorableFileList ??= new List<string>();
        ...
        public static ManagedDatabaseData ManagedDatabaseData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, string collation = null, ManagedDatabaseStatus? status = null, DateTimeOffset? createdOn = null, DateTimeOffset? earliestRestorePoint = null, DateTimeOffset? restorePointInTime = null, AzureLocation? defaultSecondaryLocation = null, CatalogCollationType? catalogCollation = null, ManagedDatabaseCreateMode? createMode = null, Uri storageContainerUri = null, ResourceIdentifier sourceDatabaseId = null, ResourceIdentifier restorableDroppedDatabaseId = null, string storageContainerSasToken = null, ResourceIdentifier failoverGroupId = null, ResourceIdentifier recoverableDatabaseId = null, ResourceIdentifier longTermRetentionBackupResourceId = null, bool? allowAutoCompleteRestore = null, string lastBackupName = null)
        {
            tags ??= new Dictionary<string, string>();
        ...
        /// <summary> Initializes a new instance of <see cref="Sql.DatabaseVulnerabilityAssessmentAutoGeneratedData"/>. </summary>
        /// <param name="id"> The id. </param>
        /// <param name="name"> The name. </param>
        /// <param name="resourceType"> The resourceType. </param>
        /// <param name="systemData"> The systemData. </param>
        ...
        /// <param name="storageAccountAccessKey"> Specifies the identifier key of the storage account for vulnerability assessment scan results. If 'StorageContainerSasKey' isn't specified, storageAccountAccessKey is required. Applies only if the storage account is not behind a Vnet or a firewall. </param>
        /// <param name="recurringScans"> The recurring scans settings. </param>
        /// <returns> A new <see cref="Sql.DatabaseVulnerabilityAssessmentAutoGeneratedData"/> instance for mocking. </returns>
        public static DatabaseVulnerabilityAssessmentAutoGeneratedData DatabaseVulnerabilityAssessmentAutoGeneratedData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string storageContainerPath = null, string storageContainerSasKey = null, string storageAccountAccessKey = null, VulnerabilityAssessmentRecurringScansProperties recurringScans = null)
        {
            return new DatabaseVulnerabilityAssessmentAutoGeneratedData(
                id,
                name,
                resourceType,
                systemData,
        ...
        public static UpsertManagedServerOperationStepWithEstimatesAndDuration UpsertManagedServerOperationStepWithEstimatesAndDuration(DateTimeOffset? stepStartOn = null, DateTimeOffset? stepEndOn = null, string timeElapsed = null, int? order = null, string name = null, Status? status = null)
        {
        ...
        /// <param name="minTlsVersion"> Minimal TLS version. Allowed values: '1.0', '1.1', '1.2'. </param>
        ...
        public static VirtualClusterPatch VirtualClusterPatch(IDictionary<string, string> tags = null, ResourceIdentifier subnetId = null, string family = null, IEnumerable<string> childResources = null, ResourceIdentifier maintenanceConfigurationId = null)
        {
            tags ??= new Dictionary<string, string>();
            childResources ??= new List<string>();
        ...
        /// <summary> Initializes a new instance of <see cref="Models.UpdateManagedInstanceDnsServersOperation"/>. </summary>
        /// <param name="id"> The id. </param>
        /// <param name="name"> The name. </param>
        /// <param name="resourceType"> The resourceType. </param>
        /// <param name="systemData"> The systemData. </param>
        /// <param name="status"> The status of the DNS refresh operation. </param>
        /// <returns> A new <see cref="Models.UpdateManagedInstanceDnsServersOperation"/> instance for mocking. </returns>
        public static UpdateManagedInstanceDnsServersOperation UpdateManagedInstanceDnsServersOperation(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, DnsRefreshConfigurationPropertiesStatus? status = null)
        {
            return new UpdateManagedInstanceDnsServersOperation(
                id,
                name,
                resourceType,
                systemData,
