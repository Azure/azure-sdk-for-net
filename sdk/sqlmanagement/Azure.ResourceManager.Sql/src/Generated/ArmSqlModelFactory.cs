...
namespace Azure.ResourceManager.Sql.Models
{
    ...
    public static partial class ArmSqlModelFactory
    {
        ...
        {
            return new DataMaskingPolicyData(id, name, resourceType, systemData, location, kind, dataMaskingState, exemptPrincipals, applicationPrincipals, maskingLevel, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DataMaskingRule(id, name, resourceType, systemData, location, kind, aliasName, ruleState, schemaName, tableName, columnName, maskingFunction, numberFrom, numberTo, prefixSize, suffixSize, replacementString, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new GeoBackupPolicyData(id, name, resourceType, systemData, kind, location, state, storageType, new Dictionary<string, BinaryData>());
        }
        ...
        public static SqlMetric SqlMetric(DateTimeOffset? startOn = null, DateTimeOffset? endOn = null, string timeGrain = null, SqlMetricUnitType? unit = null, SqlMetricName name = null, IEnumerable<SqlMetricValue> metricValues = null)
        {
            ...
            return new SqlMetric(startOn, endOn, timeGrain, unit, name, metricValues?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SqlMetricName(value, localizedValue, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SqlMetricValue(count, average, maximum, minimum, timestamp, total, new Dictionary<string, BinaryData>());
        }
        ...
        public static SqlMetricDefinition SqlMetricDefinition(SqlMetricName name = null, SqlMetricPrimaryAggregationType? primaryAggregationType = null, string resourceUriString = null, SqlMetricDefinitionUnitType? unit = null, IEnumerable<SqlMetricAvailability> metricAvailabilities = null)
        {
            ...
            return new SqlMetricDefinition(name, primaryAggregationType, resourceUriString, unit, metricAvailabilities?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SqlMetricAvailability(retention, timeGrain, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SqlServerCommunicationLinkData(id, name, resourceType, systemData, location, kind, state, partnerServer, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ServiceObjectiveData(id, name, resourceType, systemData, serviceObjectiveName, isDefault, isSystem, description, isEnabled, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ElasticPoolDatabaseActivity(id, name, resourceType, systemData, location, databaseName, endOn, errorCode, errorMessage, errorSeverity, operation, operationId, percentComplete, requestedElasticPoolName, currentElasticPoolName, currentServiceObjective, requestedServiceObjective, serverName, startOn, state, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SqlServerUsage(name, resourceName, displayName, currentValue, limit, unit, nextResetOn, new Dictionary<string, BinaryData>());
        }
        ...
        public static SqlAdvisorData SqlAdvisorData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string kind = null, AzureLocation? location = null, SqlAdvisorStatus? advisorStatus = null, AutoExecuteStatus? autoExecuteStatus = null, AutoExecuteStatusInheritedFrom? autoExecuteStatusInheritedFrom = null, string recommendationsStatus = null, DateTimeOffset? lastCheckedOn = null, IEnumerable<RecommendedActionData> recommendedActions = null)
        {
            ...
            return new SqlAdvisorData(id, name, resourceType, systemData, kind, location, advisorStatus, autoExecuteStatus, autoExecuteStatusInheritedFrom, recommendationsStatus, lastCheckedOn, recommendedActions?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static RecommendedActionData RecommendedActionData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string kind = null, AzureLocation? location = null, string recommendationReason = null, DateTimeOffset? validSince = null, DateTimeOffset? lastRefresh = null, RecommendedActionStateInfo state = null, bool? isExecutableAction = null, bool? isRevertableAction = null, bool? isArchivedAction = null, DateTimeOffset? executeActionStartOn = null, TimeSpan? executeActionDuration = null, DateTimeOffset? revertActionStartOn = null, TimeSpan? revertActionDuration = null, RecommendedActionInitiatedBy? executeActionInitiatedBy = null, DateTimeOffset? executeActionInitiatedOn = null, RecommendedActionInitiatedBy? revertActionInitiatedBy = null, DateTimeOffset? revertActionInitiatedOn = null, int? score = null, RecommendedActionImplementationInfo implementationDetails = null, RecommendedActionErrorInfo errorDetails = null, IEnumerable<RecommendedActionImpactRecord> estimatedImpact = null, IEnumerable<RecommendedActionImpactRecord> observedImpact = null, IEnumerable<RecommendedActionMetricInfo> timeSeries = null, IEnumerable<string> linkedObjects = null, IReadOnlyDictionary<string, BinaryData> details = null)
        {
            ...
            return new RecommendedActionData(id, name, resourceType, systemData, kind, location, recommendationReason, validSince, lastRefresh, state, isExecutableAction, isRevertableAction, isArchivedAction, executeActionStartOn, executeActionDuration, revertActionStartOn, revertActionDuration, executeActionInitiatedBy, executeActionInitiatedOn, revertActionInitiatedBy, revertActionInitiatedOn, score, implementationDetails, errorDetails, estimatedImpact?.ToList(), observedImpact?.ToList(), timeSeries?.ToList(), linkedObjects?.ToList(), details, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new RecommendedActionStateInfo(currentValue, actionInitiatedBy, lastModified, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new RecommendedActionImplementationInfo(method, script, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new RecommendedActionErrorInfo(errorCode, isRetryable, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new RecommendedActionImpactRecord(dimensionName, unit, absoluteValue, changeValueAbsolute, changeValueRelative, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new RecommendedActionMetricInfo(metricName, unit, timeGrain, startOn, value, new Dictionary<string, BinaryData>());
        }
        ...
        public static SqlDatabaseAutomaticTuningData SqlDatabaseAutomaticTuningData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, AutomaticTuningMode? desiredState = null, AutomaticTuningMode? actualState = null, IDictionary<string, AutomaticTuningOptions> options = null)
        {
            ...
            return new SqlDatabaseAutomaticTuningData(id, name, resourceType, systemData, desiredState, actualState, options, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AutomaticTuningOptions(desiredState, actualState, reasonCode, reasonDesc, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DatabaseColumnData(id, name, resourceType, systemData, columnType, temporalType, isMemoryOptimized, isComputed, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DatabaseSchemaData(id, name, resourceType, systemData, new Dictionary<string, BinaryData>());
        }
        ...
        public static SqlDatabaseSecurityAlertPolicyData SqlDatabaseSecurityAlertPolicyData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, SecurityAlertsPolicyState? state = null, IEnumerable<string> disabledAlerts = null, IEnumerable<string> emailAddresses = null, bool? sendToEmailAccountAdmins = null, string storageEndpoint = null, string storageAccountAccessKey = null, int? retentionDays = null, DateTimeOffset? createdOn = null)
        {
            ...
            return new SqlDatabaseSecurityAlertPolicyData(id, name, resourceType, systemData, state, disabledAlerts?.ToList(), emailAddresses?.ToList(), sendToEmailAccountAdmins, storageEndpoint, storageAccountAccessKey, retentionDays, createdOn, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DatabaseTableData(id, name, resourceType, systemData, temporalType, isMemoryOptimized, new Dictionary<string, BinaryData>());
        }
        ...
        public static DatabaseVulnerabilityAssessmentRuleBaselineData DatabaseVulnerabilityAssessmentRuleBaselineData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IEnumerable<DatabaseVulnerabilityAssessmentRuleBaselineItem> baselineResults = null)
        {
            ...
            return new DatabaseVulnerabilityAssessmentRuleBaselineData(id, name, resourceType, systemData, baselineResults?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DatabaseVulnerabilityAssessmentData(id, name, resourceType, systemData, storageContainerPath, storageContainerSasKey, storageAccountAccessKey, recurringScans, new Dictionary<string, BinaryData>());
        }
        ...
        public static VulnerabilityAssessmentScanRecordData VulnerabilityAssessmentScanRecordData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string scanId = null, VulnerabilityAssessmentScanTriggerType? triggerType = null, VulnerabilityAssessmentScanState? state = null, DateTimeOffset? startOn = null, DateTimeOffset? endOn = null, IEnumerable<VulnerabilityAssessmentScanError> errors = null, string storageContainerPath = null, int? numberOfFailedSecurityChecks = null)
        {
            ...
            return new VulnerabilityAssessmentScanRecordData(id, name, resourceType, systemData, scanId, triggerType, state, startOn, endOn, errors?.ToList(), storageContainerPath, numberOfFailedSecurityChecks, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new VulnerabilityAssessmentScanError(code, message, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DatabaseVulnerabilityAssessmentScansExport(id, name, resourceType, systemData, exportedReportLocation, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DataWarehouseUserActivityData(id, name, resourceType, systemData, activeQueriesCount, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DeletedServerData(id, name, resourceType, systemData, version, deletedOn, originalId, fullyQualifiedDomainName, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ElasticPoolOperationData(id, name, resourceType, systemData, elasticPoolName, operation, operationFriendlyName, percentComplete, serverName, startOn, state, errorCode, errorDescription, errorSeverity, isUserError, estimatedCompleteOn, description, isCancellable, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new EncryptionProtectorData(id, name, resourceType, systemData, kind, location, subregion, serverKeyName, serverKeyType, uri, thumbprint, isAutoRotationEnabled, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SqlFirewallRuleData(id, name, resourceType, new Dictionary<string, BinaryData>(), startIPAddress, endIPAddress);
        }
        ...
        {
            return new ProxyResourceWithWritableName(id, name, resourceType, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ResourceWithWritableName(id, name, resourceType, new Dictionary<string, BinaryData>());
        }
        ...
        public static InstancePoolData InstancePoolData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, SqlSku sku = null, ResourceIdentifier subnetId = null, int? vCores = null, InstancePoolLicenseType? licenseType = null)
        {
            ...
            return new InstancePoolData(id, name, resourceType, systemData, tags, location, sku, subnetId, vCores, licenseType, new Dictionary<string, BinaryData>());
        }
        ...
        public static SqlServerJobAgentData SqlServerJobAgentData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, SqlSku sku = null, ResourceIdentifier databaseId = null, JobAgentState? state = null)
        {
            ...
            return new SqlServerJobAgentData(id, name, resourceType, systemData, tags, location, sku, databaseId, state, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SqlServerJobCredentialData(id, name, resourceType, systemData, username, password, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SqlServerJobExecutionData(id, name, resourceType, systemData, jobVersion, stepName, stepId, jobExecutionId, lifecycle, provisioningState, createOn, startOn, endOn, currentAttempts, currentAttemptStartOn, lastMessage, target, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new JobExecutionTarget(targetType, serverName, databaseName, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SqlServerJobData(id, name, resourceType, systemData, description, version, schedule, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SqlServerJobStepData(id, name, resourceType, systemData, stepId, targetGroup, credential, action, output, executionOptions, new Dictionary<string, BinaryData>());
        }
        ...
        public static SqlServerJobTargetGroupData SqlServerJobTargetGroupData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IEnumerable<JobTarget> members = null)
        {
            ...
            return new SqlServerJobTargetGroupData(id, name, resourceType, systemData, members?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SqlServerJobVersionData(id, name, resourceType, systemData, new Dictionary<string, BinaryData>());
        }
        ...
        public static SqlLocationCapabilities SqlLocationCapabilities(string name = null, IEnumerable<SqlServerVersionCapability> supportedServerVersions = null, IEnumerable<ManagedInstanceVersionCapability> supportedManagedInstanceVersions = null, SqlCapabilityStatus? status = null, string reason = null)
        {
            ...
            return new SqlLocationCapabilities(name, supportedServerVersions?.ToList(), supportedManagedInstanceVersions?.ToList(), status, reason, new Dictionary<string, BinaryData>());
        }
        ...
        public static SqlServerVersionCapability SqlServerVersionCapability(string name = null, IEnumerable<EditionCapability> supportedEditions = null, IEnumerable<ElasticPoolEditionCapability> supportedElasticPoolEditions = null, SqlCapabilityStatus? status = null, string reason = null)
        {
            ...
            return new SqlServerVersionCapability(name, supportedEditions?.ToList(), supportedElasticPoolEditions?.ToList(), status, reason, new Dictionary<string, BinaryData>());
        }
        ...
        public static EditionCapability EditionCapability(string name = null, IEnumerable<ServiceObjectiveCapability> supportedServiceLevelObjectives = null, bool? isZoneRedundant = null, ReadScaleCapability readScale = null, IEnumerable<StorageCapability> supportedStorageCapabilities = null, SqlCapabilityStatus? status = null, string reason = null)
        {
            ...
            return new EditionCapability(name, supportedServiceLevelObjectives?.ToList(), isZoneRedundant, readScale, supportedStorageCapabilities?.ToList(), status, reason, new Dictionary<string, BinaryData>());
        }
        ...
        public static ServiceObjectiveCapability ServiceObjectiveCapability(Guid? id = null, string name = null, IEnumerable<MaxSizeRangeCapability> supportedMaxSizes = null, PerformanceLevelCapability performanceLevel = null, SqlSku sku = null, IEnumerable<LicenseTypeCapability> supportedLicenseTypes = null, MaxSizeCapability includedMaxSize = null, bool? isZoneRedundant = null, AutoPauseDelayTimeRange supportedAutoPauseDelay = null, IEnumerable<MinCapacityCapability> supportedMinCapacities = null, string computeModel = null, IEnumerable<MaintenanceConfigurationCapability> supportedMaintenanceConfigurations = null, SqlCapabilityStatus? status = null, string reason = null)
        {
            ...
            return new ServiceObjectiveCapability(id, name, supportedMaxSizes?.ToList(), performanceLevel, sku, supportedLicenseTypes?.ToList(), includedMaxSize, isZoneRedundant, supportedAutoPauseDelay, supportedMinCapacities?.ToList(), computeModel, supportedMaintenanceConfigurations?.ToList(), status, reason, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MaxSizeRangeCapability(minValue, maxValue, scaleSize, logSize, status, reason, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MaxSizeCapability(limit, unit, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new LogSizeCapability(limit, unit, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new PerformanceLevelCapability(value, unit, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new LicenseTypeCapability(name, status, reason, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AutoPauseDelayTimeRange(minValue, maxValue, stepSize, @default, unit, doNotPauseValue, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MinCapacityCapability(value, status, reason, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MaintenanceConfigurationCapability(name, isZoneRedundant, status, reason, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ReadScaleCapability(maxNumberOfReplicas, status, reason, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new StorageCapability(storageAccountType, status, reason, new Dictionary<string, BinaryData>());
        }
        ...
        public static ElasticPoolEditionCapability ElasticPoolEditionCapability(string name = null, IEnumerable<ElasticPoolPerformanceLevelCapability> supportedElasticPoolPerformanceLevels = null, bool? isZoneRedundant = null, SqlCapabilityStatus? status = null, string reason = null)
        {
            ...
            return new ElasticPoolEditionCapability(name, supportedElasticPoolPerformanceLevels?.ToList(), isZoneRedundant, status, reason, new Dictionary<string, BinaryData>());
        }
        ...
        public static ElasticPoolPerformanceLevelCapability ElasticPoolPerformanceLevelCapability(PerformanceLevelCapability performanceLevel = null, SqlSku sku = null, IEnumerable<LicenseTypeCapability> supportedLicenseTypes = null, int? maxDatabaseCount = null, MaxSizeCapability includedMaxSize = null, IEnumerable<MaxSizeRangeCapability> supportedMaxSizes = null, IEnumerable<MaxSizeRangeCapability> supportedPerDatabaseMaxSizes = null, IEnumerable<ElasticPoolPerDatabaseMaxPerformanceLevelCapability> supportedPerDatabaseMaxPerformanceLevels = null, bool? isZoneRedundant = null, IEnumerable<MaintenanceConfigurationCapability> supportedMaintenanceConfigurations = null, SqlCapabilityStatus? status = null, string reason = null)
        {
            ...
            return new ElasticPoolPerformanceLevelCapability(performanceLevel, sku, supportedLicenseTypes?.ToList(), maxDatabaseCount, includedMaxSize, supportedMaxSizes?.ToList(), supportedPerDatabaseMaxSizes?.ToList(), supportedPerDatabaseMaxPerformanceLevels?.ToList(), isZoneRedundant, supportedMaintenanceConfigurations?.ToList(), status, reason, new Dictionary<string, BinaryData>());
        }
        ...
        public static ElasticPoolPerDatabaseMaxPerformanceLevelCapability ElasticPoolPerDatabaseMaxPerformanceLevelCapability(double? limit = null, PerformanceLevelUnit? unit = null, IEnumerable<ElasticPoolPerDatabaseMinPerformanceLevelCapability> supportedPerDatabaseMinPerformanceLevels = null, SqlCapabilityStatus? status = null, string reason = null)
        {
            ...
            return new ElasticPoolPerDatabaseMaxPerformanceLevelCapability(limit, unit, supportedPerDatabaseMinPerformanceLevels?.ToList(), status, reason, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ElasticPoolPerDatabaseMinPerformanceLevelCapability(limit, unit, status, reason, new Dictionary<string, BinaryData>());
        }
        ...
        public static ManagedInstanceVersionCapability ManagedInstanceVersionCapability(string name = null, IEnumerable<ManagedInstanceEditionCapability> supportedEditions = null, IEnumerable<InstancePoolEditionCapability> supportedInstancePoolEditions = null, SqlCapabilityStatus? status = null, string reason = null)
        {
            ...
            return new ManagedInstanceVersionCapability(name, supportedEditions?.ToList(), supportedInstancePoolEditions?.ToList(), status, reason, new Dictionary<string, BinaryData>());
        }
        ...
        public static ManagedInstanceEditionCapability ManagedInstanceEditionCapability(string name = null, IEnumerable<ManagedInstanceFamilyCapability> supportedFamilies = null, IEnumerable<StorageCapability> supportedStorageCapabilities = null, bool? isZoneRedundant = null, SqlCapabilityStatus? status = null, string reason = null)
        {
            ...
            return new ManagedInstanceEditionCapability(name, supportedFamilies?.ToList(), supportedStorageCapabilities?.ToList(), isZoneRedundant, status, reason, new Dictionary<string, BinaryData>());
        }
        ...
        public static ManagedInstanceFamilyCapability ManagedInstanceFamilyCapability(string name = null, string sku = null, IEnumerable<LicenseTypeCapability> supportedLicenseTypes = null, IEnumerable<ManagedInstanceVcoresCapability> supportedVcoresValues = null, SqlCapabilityStatus? status = null, string reason = null)
        {
            ...
            return new ManagedInstanceFamilyCapability(name, sku, supportedLicenseTypes?.ToList(), supportedVcoresValues?.ToList(), status, reason, new Dictionary<string, BinaryData>());
        }
        ...
        public static ManagedInstanceVcoresCapability ManagedInstanceVcoresCapability(string name = null, int? value = null, MaxSizeCapability includedMaxSize = null, IEnumerable<MaxSizeRangeCapability> supportedStorageSizes = null, bool? isInstancePoolSupported = null, bool? isStandaloneSupported = null, IEnumerable<ManagedInstanceMaintenanceConfigurationCapability> supportedMaintenanceConfigurations = null, SqlCapabilityStatus? status = null, string reason = null)
        {
            ...
            return new ManagedInstanceVcoresCapability(name, value, includedMaxSize, supportedStorageSizes?.ToList(), isInstancePoolSupported, isStandaloneSupported, supportedMaintenanceConfigurations?.ToList(), status, reason, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ManagedInstanceMaintenanceConfigurationCapability(name, status, reason, new Dictionary<string, BinaryData>());
        }
        ...
        public static InstancePoolEditionCapability InstancePoolEditionCapability(string name = null, IEnumerable<InstancePoolFamilyCapability> supportedFamilies = null, SqlCapabilityStatus? status = null, string reason = null)
        {
            ...
            return new InstancePoolEditionCapability(name, supportedFamilies?.ToList(), status, reason, new Dictionary<string, BinaryData>());
        }
        ...
        public static InstancePoolFamilyCapability InstancePoolFamilyCapability(string name = null, IEnumerable<LicenseTypeCapability> supportedLicenseTypes = null, IEnumerable<InstancePoolVcoresCapability> supportedVcoresValues = null, SqlCapabilityStatus? status = null, string reason = null)
        {
            ...
            return new InstancePoolFamilyCapability(name, supportedLicenseTypes?.ToList(), supportedVcoresValues?.ToList(), status, reason, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new InstancePoolVcoresCapability(name, value, storageLimit, status, reason, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new LongTermRetentionPolicyData(id, name, resourceType, systemData, weeklyRetention, monthlyRetention, yearlyRetention, weekOfYear, new Dictionary<string, BinaryData>());
        }
        ...
        public static MaintenanceWindowOptionData MaintenanceWindowOptionData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, bool? isEnabled = null, IEnumerable<MaintenanceWindowTimeRange> maintenanceWindowCycles = null, int? minDurationInMinutes = null, int? defaultDurationInMinutes = null, int? minCycles = null, int? timeGranularityInMinutes = null, bool? allowMultipleMaintenanceWindowsPerCycle = null)
        {
            ...
            return new MaintenanceWindowOptionData(id, name, resourceType, systemData, isEnabled, maintenanceWindowCycles?.ToList(), minDurationInMinutes, defaultDurationInMinutes, minCycles, timeGranularityInMinutes, allowMultipleMaintenanceWindowsPerCycle, new Dictionary<string, BinaryData>());
        }
        ...
        public static MaintenanceWindowsData MaintenanceWindowsData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IEnumerable<MaintenanceWindowTimeRange> timeRanges = null)
        {
            ...
            return new MaintenanceWindowsData(id, name, resourceType, systemData, timeRanges?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ManagedBackupShortTermRetentionPolicyData(id, name, resourceType, systemData, retentionDays, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ManagedInstanceQuery(id, name, resourceType, systemData, queryText, new Dictionary<string, BinaryData>());
        }
        ...
        public static QueryStatistics QueryStatistics(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string databaseName = null, string queryId = null, string startTime = null, string endTime = null, IEnumerable<QueryMetricInterval> intervals = null)
        {
            ...
            return new QueryStatistics(id, name, resourceType, systemData, databaseName, queryId, startTime, endTime, intervals?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static QueryStatisticsProperties QueryStatisticsProperties(string databaseName = null, string queryId = null, string startTime = null, string endTime = null, IEnumerable<QueryMetricInterval> intervals = null)
        {
            ...
            return new QueryStatisticsProperties(databaseName, queryId, startTime, endTime, intervals?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static QueryMetricInterval QueryMetricInterval(string intervalStartTime = null, QueryTimeGrainType? intervalType = null, long? executionCount = null, IEnumerable<QueryMetricProperties> metrics = null)
        {
            ...
            return new QueryMetricInterval(intervalStartTime, intervalType, executionCount, metrics?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new QueryMetricProperties(name, displayName, unit, value, min, max, avg, sum, stdev, new Dictionary<string, BinaryData>());
        }
        ...
        public static ManagedDatabaseSecurityAlertPolicyData ManagedDatabaseSecurityAlertPolicyData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, SecurityAlertPolicyState? state = null, IEnumerable<string> disabledAlerts = null, IEnumerable<string> emailAddresses = null, bool? sendToEmailAccountAdmins = null, string storageEndpoint = null, string storageAccountAccessKey = null, int? retentionDays = null, DateTimeOffset? createdOn = null)
        {
            ...
            return new ManagedDatabaseSecurityAlertPolicyData(id, name, resourceType, systemData, state, disabledAlerts?.ToList(), emailAddresses?.ToList(), sendToEmailAccountAdmins, storageEndpoint, storageAccountAccessKey, retentionDays, createdOn, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SecurityEvent(id, name, resourceType, systemData, eventOn, securityEventType, subscription, server, database, clientIP, applicationName, principalName, securityEventSqlInjectionAdditionalProperties, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SecurityEventSqlInjectionAdditionalProperties(threatId, statement, statementHighlightOffset, statementHighlightLength, errorCode, errorSeverity, errorMessage, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ManagedTransparentDataEncryptionData(id, name, resourceType, systemData, state, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ManagedInstanceAdministratorData(id, name, resourceType, systemData, administratorType, login, sid, tenantId, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ManagedInstanceAzureADOnlyAuthenticationData(id, name, resourceType, systemData, isAzureADOnlyAuthenticationEnabled, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ManagedInstanceEncryptionProtectorData(id, name, resourceType, systemData, kind, serverKeyName, serverKeyType, uri, thumbprint, isAutoRotationEnabled, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ManagedInstanceKeyData(id, name, resourceType, systemData, kind, serverKeyType, uri, thumbprint, createdOn, isAutoRotationEnabled, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ManagedInstanceLongTermRetentionPolicyData(id, name, resourceType, systemData, weeklyRetention, monthlyRetention, yearlyRetention, weekOfYear, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ManagedInstanceOperationData(id, name, resourceType, systemData, managedInstanceName, operation, operationFriendlyName, percentComplete, startOn, state, errorCode, errorDescription, errorSeverity, isUserError, estimatedCompleteOn, description, isCancellable, operationParameters, operationSteps, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ManagedInstanceOperationParametersPair(currentParameters, requestedParameters, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new UpsertManagedServerOperationParameters(family, tier, vCores, storageSizeInGB, new Dictionary<string, BinaryData>());
        }
        ...
        public static ManagedInstanceOperationSteps ManagedInstanceOperationSteps(string totalSteps = null, int? currentStep = null, IEnumerable<UpsertManagedServerOperationStep> stepsList = null)
        {
            ...
            return new ManagedInstanceOperationSteps(totalSteps, currentStep, stepsList?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new UpsertManagedServerOperationStep(order, name, status, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ManagedInstancePrivateEndpointConnectionData(id, name, resourceType, systemData, privateEndpointId != null ? ResourceManagerModelFactory.WritableSubResource(privateEndpointId) : null, connectionState, provisioningState, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ManagedInstancePrivateEndpointConnectionProperties(privateEndpointId != null ? ResourceManagerModelFactory.WritableSubResource(privateEndpointId) : null, privateLinkServiceConnectionState, provisioningState, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ManagedInstancePrivateLinkServiceConnectionStateProperty(status, description, actionsRequired, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ManagedInstancePrivateLinkData(id, name, resourceType, systemData, properties, new Dictionary<string, BinaryData>());
        }
        ...
        public static ManagedInstancePrivateLinkProperties ManagedInstancePrivateLinkProperties(string groupId = null, IEnumerable<string> requiredMembers = null)
        {
            ...
            return new ManagedInstancePrivateLinkProperties(groupId, requiredMembers?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new TdeCertificate(id, name, resourceType, systemData, privateBlob, certPassword, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ManagedInstanceVulnerabilityAssessmentData(id, name, resourceType, systemData, storageContainerPath, storageContainerSasKey, storageAccountAccessKey, recurringScans, new Dictionary<string, BinaryData>());
        }
        ...
        public static ManagedServerSecurityAlertPolicyData ManagedServerSecurityAlertPolicyData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, SecurityAlertsPolicyState? state = null, IEnumerable<string> disabledAlerts = null, IEnumerable<string> emailAddresses = null, bool? sendToEmailAccountAdmins = null, string storageEndpoint = null, string storageAccountAccessKey = null, int? retentionDays = null, DateTimeOffset? createdOn = null)
        {
            ...
            return new ManagedServerSecurityAlertPolicyData(id, name, resourceType, systemData, state, disabledAlerts?.ToList(), emailAddresses?.ToList(), sendToEmailAccountAdmins, storageEndpoint, storageAccountAccessKey, retentionDays, createdOn, new Dictionary<string, BinaryData>());
        }
        ...
        public static SqlPrivateEndpointConnectionData SqlPrivateEndpointConnectionData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, ResourceIdentifier privateEndpointId = null, IEnumerable<string> groupIds = null, SqlPrivateLinkServiceConnectionStateProperty connectionState = null, SqlPrivateEndpointProvisioningState? provisioningState = null)
        {
            ...
            return new SqlPrivateEndpointConnectionData(id, name, resourceType, systemData, privateEndpointId != null ? ResourceManagerModelFactory.WritableSubResource(privateEndpointId) : null, groupIds?.ToList(), connectionState, provisioningState, new Dictionary<string, BinaryData>());
        }
        ...
        public static ServerPrivateEndpointConnectionProperties ServerPrivateEndpointConnectionProperties(ResourceIdentifier privateEndpointId = null, IEnumerable<string> groupIds = null, SqlPrivateLinkServiceConnectionStateProperty connectionState = null, SqlPrivateEndpointProvisioningState? provisioningState = null)
        {
            ...
            return new ServerPrivateEndpointConnectionProperties(privateEndpointId != null ? ResourceManagerModelFactory.WritableSubResource(privateEndpointId) : null, groupIds?.ToList(), connectionState, provisioningState, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SqlPrivateLinkServiceConnectionStateProperty(status, description, actionsRequired, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SqlPrivateLinkResourceData(id, name, resourceType, systemData, properties, new Dictionary<string, BinaryData>());
        }
        ...
        public static SqlPrivateLinkResourceProperties SqlPrivateLinkResourceProperties(string groupId = null, IEnumerable<string> requiredMembers = null, IEnumerable<string> requiredZoneNames = null)
        {
            ...
            return new SqlPrivateLinkResourceProperties(groupId, requiredMembers?.ToList(), requiredZoneNames?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new RecoverableManagedDatabaseData(id, name, resourceType, systemData, lastAvailableBackupDate, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SqlServerDatabaseRestorePointData(id, name, resourceType, systemData, location, restorePointType, earliestRestoreOn, restorePointCreatedOn, restorePointLabel, new Dictionary<string, BinaryData>());
        }
        ...
        public static SqlServerAutomaticTuningData SqlServerAutomaticTuningData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, AutomaticTuningServerMode? desiredState = null, AutomaticTuningServerMode? actualState = null, IDictionary<string, AutomaticTuningServerOptions> options = null)
        {
            ...
            return new SqlServerAutomaticTuningData(id, name, resourceType, systemData, desiredState, actualState, options, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AutomaticTuningServerOptions(desiredState, actualState, reasonCode, reasonDesc, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SqlServerAzureADAdministratorData(id, name, resourceType, systemData, administratorType, login, sid, tenantId, isAzureADOnlyAuthenticationEnabled, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SqlServerAzureADOnlyAuthenticationData(id, name, resourceType, systemData, isAzureADOnlyAuthenticationEnabled, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SqlServerDevOpsAuditingSettingData(id, name, resourceType, systemData, isAzureMonitorTargetEnabled, isManagedIdentityInUse, state, storageEndpoint, storageAccountAccessKey, storageAccountSubscriptionId, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SqlServerDnsAliasData(id, name, resourceType, systemData, azureDnsRecord, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SqlServerKeyData(id, name, resourceType, systemData, kind, location, subregion, serverKeyType, uri, thumbprint, createdOn, isAutoRotationEnabled, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ServerOperationData(id, name, resourceType, systemData, operation, operationFriendlyName, percentComplete, serverName, startOn, state, errorCode, errorDescription, errorSeverity, isUserError, estimatedCompleteOn, description, isCancellable, new Dictionary<string, BinaryData>());
        }
        ...
        public static SqlServerSecurityAlertPolicyData SqlServerSecurityAlertPolicyData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, SecurityAlertsPolicyState? state = null, IEnumerable<string> disabledAlerts = null, IEnumerable<string> emailAddresses = null, bool? sendToEmailAccountAdmins = null, string storageEndpoint = null, string storageAccountAccessKey = null, int? retentionDays = null, DateTimeOffset? createdOn = null)
        {
            ...
            return new SqlServerSecurityAlertPolicyData(id, name, resourceType, systemData, state, disabledAlerts?.ToList(), emailAddresses?.ToList(), sendToEmailAccountAdmins, storageEndpoint, storageAccountAccessKey, retentionDays, createdOn, new Dictionary<string, BinaryData>());
        }
        ...
        public static SqlServerTrustGroupData SqlServerTrustGroupData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IEnumerable<ServerTrustGroupServerInfo> groupMembers = null, IEnumerable<ServerTrustGroupPropertiesTrustScopesItem> trustScopes = null)
        {
            ...
            return new SqlServerTrustGroupData(id, name, resourceType, systemData, groupMembers?.ToList(), trustScopes?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SqlServerVulnerabilityAssessmentData(id, name, resourceType, systemData, storageContainerPath, storageContainerSasKey, storageAccountAccessKey, recurringScans, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SqlAgentConfigurationData(id, name, resourceType, systemData, state, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SubscriptionUsageData(id, name, resourceType, systemData, displayName, currentValue, limit, unit, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SyncAgentData(id, name, resourceType, systemData, syncDatabaseId, lastAliveOn, state, isUpToDate, expireOn, version, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SyncAgentKeyProperties(syncAgentKey, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SyncAgentLinkedDatabase(id, name, resourceType, systemData, databaseType, databaseId, description, serverName, databaseName, userName, new Dictionary<string, BinaryData>());
        }
        ...
        public static SyncFullSchemaProperties SyncFullSchemaProperties(IEnumerable<SyncFullSchemaTable> tables = null, DateTimeOffset? lastUpdateOn = null)
        {
            ...
            return new SyncFullSchemaProperties(tables?.ToList(), lastUpdateOn, new Dictionary<string, BinaryData>());
        }
        ...
        public static SyncFullSchemaTable SyncFullSchemaTable(IEnumerable<SyncFullSchemaTableColumn> columns = null, string errorId = null, bool? hasError = null, string name = null, string quotedName = null)
        {
            ...
            return new SyncFullSchemaTable(columns?.ToList(), errorId, hasError, name, quotedName, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SyncFullSchemaTableColumn(dataSize, dataType, errorId, hasError, isPrimaryKey, name, quotedName, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SyncGroupLogProperties(timestamp, logType, source, details, tracingId, operationStatus, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SyncGroupData(id, name, resourceType, systemData, sku, interval, lastSyncOn, conflictResolutionPolicy, syncDatabaseId, hubDatabaseUserName, hubDatabasePassword, syncState, schema, isConflictLoggingEnabled, conflictLoggingRetentionInDays, usePrivateLinkConnection, privateEndpointName, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SyncMemberData(id, name, resourceType, systemData, databaseType, syncAgentId, sqlServerDatabaseId, syncMemberAzureDatabaseResourceId, usePrivateLinkConnection, privateEndpointName, serverName, databaseName, userName, password, syncDirection, syncState, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SqlTimeZoneData(id, name, resourceType, systemData, timeZoneId, displayName, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SqlServerVirtualNetworkRuleData(id, name, resourceType, systemData, virtualNetworkSubnetId, ignoreMissingVnetServiceEndpoint, state, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new WorkloadClassifierData(id, name, resourceType, systemData, memberName, label, context, startTime, endTime, importance, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new WorkloadGroupData(id, name, resourceType, systemData, minResourcePercent, maxResourcePercent, minResourcePercentPerRequest, maxResourcePercentPerRequest, importance, queryExecutionTimeout, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new BackupShortTermRetentionPolicyData(id, name, resourceType, systemData, retentionDays, diffBackupIntervalInHours, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SqlDatabaseExtension(id, name, resourceType, systemData, operationMode, storageKeyType, storageKey, storageUri, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ImportExportExtensionsOperationResult(id, name, resourceType, systemData, requestId, requestType, lastModifiedTime, serverName, databaseName, status, errorMessage, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DatabaseOperationData(id, name, resourceType, systemData, databaseName, operation, operationFriendlyName, percentComplete, serverName, startOn, state, errorCode, errorDescription, errorSeverity, isUserError, estimatedCompleteOn, description, isCancellable, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DatabaseUsage(id, name, resourceType, systemData, displayName, currentValue, limit, unit, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new LedgerDigestUploadData(id, name, resourceType, systemData, digestStorageEndpoint, state, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new OutboundFirewallRuleData(id, name, resourceType, systemData, provisioningState, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new InstancePoolUsage(id, name, resourceType, unit, currentValue, limit, requestedLimit, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new InstancePoolUsageName(value, localizedValue, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new LongTermRetentionBackupOperationResult(id, name, resourceType, systemData, requestId, operationType, fromBackupResourceId, toBackupResourceId, targetBackupStorageRedundancy, status, message, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new LongTermRetentionBackupData(id, name, resourceType, systemData, serverName, serverCreateOn, databaseName, databaseDeletedOn, backupOn, backupExpireOn, backupStorageRedundancy, requestedBackupStorageRedundancy, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ManagedInstanceLongTermRetentionBackupData(id, name, resourceType, systemData, managedInstanceName, managedInstanceCreateOn, databaseName, databaseDeletedOn, backupOn, backupExpireOn, backupStorageRedundancy, new Dictionary<string, BinaryData>());
        }
        ...
        public static RestorableDroppedManagedDatabaseData RestorableDroppedManagedDatabaseData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, string databaseName = null, DateTimeOffset? createdOn = null, DateTimeOffset? deletedOn = null, DateTimeOffset? earliestRestoreOn = null)
        {
            ...
            return new RestorableDroppedManagedDatabaseData(id, name, resourceType, systemData, tags, location, databaseName, createdOn, deletedOn, earliestRestoreOn, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SqlServerConnectionPolicyData(id, name, resourceType, systemData, location, kind, connectionType, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DistributedAvailabilityGroupData(id, name, resourceType, systemData, targetDatabase, sourceEndpoint, primaryAvailabilityGroupName, secondaryAvailabilityGroupName, replicationMode, distributedAvailabilityGroupId, sourceReplicaId, targetReplicaId, linkState, lastHardenedLsn, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ServerTrustCertificateData(id, name, resourceType, systemData, publicBlob, thumbprint, certificateName, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new EndpointCertificateData(id, name, resourceType, systemData, publicBlob, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SensitivityLabelData(id, name, resourceType, systemData, managedBy, schemaName, tableName, columnName, labelName, labelId, informationType, informationTypeId, isDisabled, rank, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SensitivityLabelUpdate(id, name, resourceType, systemData, op, schema, table, column, sensitivityLabel, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new RecommendedSensitivityLabelUpdate(id, name, resourceType, systemData, op, schema, table, column, new Dictionary<string, BinaryData>());
        }
        ...
        public static SqlDatabaseBlobAuditingPolicyData SqlDatabaseBlobAuditingPolicyData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string kind = null, int? retentionDays = null, IEnumerable<string> auditActionsAndGroups = null, bool? isStorageSecondaryKeyInUse = null, bool? isAzureMonitorTargetEnabled = null, int? queueDelayMs = null, bool? isManagedIdentityInUse = null, BlobAuditingPolicyState? state = null, string storageEndpoint = null, string storageAccountAccessKey = null, Guid? storageAccountSubscriptionId = null)
        {
            ...
            return new SqlDatabaseBlobAuditingPolicyData(id, name, resourceType, systemData, kind, retentionDays, auditActionsAndGroups?.ToList(), isStorageSecondaryKeyInUse, isAzureMonitorTargetEnabled, queueDelayMs, isManagedIdentityInUse, state, storageEndpoint, storageAccountAccessKey, storageAccountSubscriptionId, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DatabaseAdvancedThreatProtectionData(id, name, resourceType, systemData, state, createdOn, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ServerAdvancedThreatProtectionData(id, name, resourceType, systemData, state, createdOn, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ManagedServerDnsAliasData(id, name, resourceType, systemData, azureDnsRecord, publicAzureDnsRecord, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ManagedDatabaseAdvancedThreatProtectionData(id, name, resourceType, systemData, state, createdOn, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ManagedInstanceAdvancedThreatProtectionData(id, name, resourceType, systemData, state, createdOn, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SqlServerDatabaseReplicationLinkData(id, name, resourceType, systemData, partnerServer, partnerDatabase, partnerLocation, role, partnerRole, replicationMode, startOn, percentComplete, replicationState, isTerminationAllowed, linkType, new Dictionary<string, BinaryData>());
        }
        ...
        public static ManagedInstanceDtcData ManagedInstanceDtcData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, bool? dtcEnabled = null, ManagedInstanceDtcSecuritySettings securitySettings = null, IEnumerable<string> externalDnsSuffixSearchList = null, string dtcHostNameDnsSuffix = null, JobExecutionProvisioningState? provisioningState = null)
        {
            ...
            return new ManagedInstanceDtcData(id, name, resourceType, systemData, dtcEnabled, securitySettings, externalDnsSuffixSearchList?.ToList(), dtcHostNameDnsSuffix, provisioningState, new Dictionary<string, BinaryData>());
        }
        ...
        public static SqlSynapseLinkWorkspace SqlSynapseLinkWorkspace(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IEnumerable<SqlSynapseLinkWorkspaceInfo> workspaces = null)
        {
            ...
            return new SqlSynapseLinkWorkspace(id, name, resourceType, systemData, workspaces?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static VirtualClusterData VirtualClusterData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, ResourceIdentifier subnetId = null, string version = null, IEnumerable<string> childResources = null)
        {
            ...
            return new VirtualClusterData(id, name, resourceType, systemData, tags, location, subnetId, version, childResources?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static VirtualClusterPatch VirtualClusterPatch(IDictionary<string, string> tags = null, ResourceIdentifier subnetId = null, string version = null, IEnumerable<string> childResources = null)
        {
            ...
            return new VirtualClusterPatch(tags, subnetId, version, childResources?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ManagedInstanceUpdateDnsServersOperationData(id, name, resourceType, systemData, status, new Dictionary<string, BinaryData>());
        }
        ...
        public static InstanceFailoverGroupData InstanceFailoverGroupData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, GeoSecondaryInstanceType? secondaryType = null, InstanceFailoverGroupReadWriteEndpoint readWriteEndpoint = null, ReadOnlyEndpointFailoverPolicy? readOnlyEndpointFailoverPolicy = null, InstanceFailoverGroupReplicationRole? replicationRole = null, string replicationState = null, IEnumerable<PartnerRegionInfo> partnerRegions = null, IEnumerable<ManagedInstancePairInfo> managedInstancePairs = null)
        {
            ...
            return new InstanceFailoverGroupData(id, name, resourceType, systemData, secondaryType, readWriteEndpoint, readOnlyEndpointFailoverPolicy != null ? new InstanceFailoverGroupReadOnlyEndpoint(readOnlyEndpointFailoverPolicy, new Dictionary<string, BinaryData>()) : null, replicationRole, replicationState, partnerRegions?.ToList(), managedInstancePairs?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new PartnerRegionInfo(location, replicationRole, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ManagedDatabaseRestoreDetailBackupSetProperties(status, firstStripeName, numberOfStripes, backupSizeInMB, restoreStartedOn, restoreFinishedOn, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ManagedDatabaseRestoreDetailUnrestorableFileProperties(name, new Dictionary<string, BinaryData>());
        }
        ...
        public static DatabaseIdentity DatabaseIdentity(DatabaseIdentityType? identityType = null, Guid? tenantId = null, IDictionary<string, UserAssignedIdentity> userAssignedIdentities = null)
        {
            ...
            return new DatabaseIdentity(identityType, tenantId, userAssignedIdentities, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SqlDatabaseKey(keyType, thumbprint, createdOn, subregion, new Dictionary<string, BinaryData>());
        }
        ...
        public static SqlDatabasePatch SqlDatabasePatch(SqlSku sku = null, DatabaseIdentity identity = null, IDictionary<string, string> tags = null, SqlDatabaseCreateMode? createMode = null, string collation = null, long? maxSizeBytes = null, SampleSchemaName? sampleName = null, ResourceIdentifier elasticPoolId = null, ResourceIdentifier sourceDatabaseId = null, SqlDatabaseStatus? status = null, Guid? databaseId = null, DateTimeOffset? createdOn = null, string currentServiceObjectiveName = null, string requestedServiceObjectiveName = null, AzureLocation? defaultSecondaryLocation = null, ResourceIdentifier failoverGroupId = null, DateTimeOffset? restorePointInTime = null, DateTimeOffset? sourceDatabaseDeletedOn = null, ResourceIdentifier recoveryServicesRecoveryPointId = null, ResourceIdentifier longTermRetentionBackupResourceId = null, ResourceIdentifier recoverableDatabaseId = null, ResourceIdentifier restorableDroppedDatabaseId = null, CatalogCollationType? catalogCollation = null, bool? isZoneRedundant = null, DatabaseLicenseType? licenseType = null, long? maxLogSizeBytes = null, DateTimeOffset? earliestRestoreOn = null, DatabaseReadScale? readScale = null, int? highAvailabilityReplicaCount = null, SecondaryType? secondaryType = null, SqlSku currentSku = null, int? autoPauseDelay = null, SqlBackupStorageRedundancy? currentBackupStorageRedundancy = null, SqlBackupStorageRedundancy? requestedBackupStorageRedundancy = null, double? minCapacity = null, DateTimeOffset? pausedOn = null, DateTimeOffset? resumedOn = null, ResourceIdentifier maintenanceConfigurationId = null, bool? isLedgerOn = null, bool? isInfraEncryptionEnabled = null, Guid? federatedClientId = null, IDictionary<string, SqlDatabaseKey> keys = null, string encryptionProtector = null, SqlAlwaysEncryptedEnclaveType? preferredEnclaveType = null, bool? useFreeLimit = null, FreeLimitExhaustionBehavior? freeLimitExhaustionBehavior = null, bool? manualCutover = null, bool? performCutover = null, bool? encryptionProtectorAutoRotation = null)
        {
            ...
            return new SqlDatabasePatch(sku, identity, tags, createMode, collation, maxSizeBytes, sampleName, elasticPoolId, sourceDatabaseId, status, databaseId, createdOn, currentServiceObjectiveName, requestedServiceObjectiveName, defaultSecondaryLocation, failoverGroupId, restorePointInTime, sourceDatabaseDeletedOn, recoveryServicesRecoveryPointId, longTermRetentionBackupResourceId, recoverableDatabaseId, restorableDroppedDatabaseId, catalogCollation, isZoneRedundant, licenseType, maxLogSizeBytes, earliestRestoreOn, readScale, highAvailabilityReplicaCount, secondaryType, currentSku, autoPauseDelay, currentBackupStorageRedundancy, requestedBackupStorageRedundancy, minCapacity, pausedOn, resumedOn, maintenanceConfigurationId, isLedgerOn, isInfraEncryptionEnabled, federatedClientId, keys, encryptionProtector, preferredEnclaveType, useFreeLimit, freeLimitExhaustionBehavior, manualCutover, performCutover, encryptionProtectorAutoRotation, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DatabaseExportDefinition(storageKeyType, storageKey, storageUri, administratorLogin, administratorLoginPassword, authenticationType, networkIsolation, new Dictionary<string, BinaryData>());
        }
        ...
        public static ImportExportOperationResult ImportExportOperationResult(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, Guid? requestId = null, string requestType = null, string queuedTime = null, string lastModifiedTime = null, Uri blobUri = null, string serverName = null, string databaseName = null, string status = null, string errorMessage = null, IEnumerable<PrivateEndpointConnectionRequestStatus> privateEndpointConnections = null)
        {
            ...
            return new ImportExportOperationResult(id, name, resourceType, systemData, requestId, requestType, queuedTime, lastModifiedTime, blobUri, serverName, databaseName, status, errorMessage, privateEndpointConnections?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new PrivateEndpointConnectionRequestStatus(privateLinkServiceId, privateEndpointConnectionName, status, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ImportExistingDatabaseDefinition(storageKeyType, storageKey, storageUri, administratorLogin, administratorLoginPassword, authenticationType, networkIsolation, new Dictionary<string, BinaryData>());
        }
        ...
        public static ElasticPoolData ElasticPoolData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, SqlSku sku = null, string kind = null, ElasticPoolState? state = null, DateTimeOffset? createdOn = null, long? maxSizeBytes = null, double? minCapacity = null, ElasticPoolPerDatabaseSettings perDatabaseSettings = null, bool? isZoneRedundant = null, ElasticPoolLicenseType? licenseType = null, ResourceIdentifier maintenanceConfigurationId = null, int? highAvailabilityReplicaCount = null, SqlAlwaysEncryptedEnclaveType? preferredEnclaveType = null, SqlAvailabilityZoneType? availabilityZone = null)
        {
            ...
            return new ElasticPoolData(id, name, resourceType, systemData, tags, location, sku, kind, state, createdOn, maxSizeBytes, minCapacity, perDatabaseSettings, isZoneRedundant, licenseType, maintenanceConfigurationId, highAvailabilityReplicaCount, preferredEnclaveType, availabilityZone, new Dictionary<string, BinaryData>());
        }
        ...
        public static ManagedDatabasePatch ManagedDatabasePatch(IDictionary<string, string> tags = null, string collation = null, ManagedDatabaseStatus? status = null, DateTimeOffset? createdOn = null, DateTimeOffset? earliestRestorePoint = null, DateTimeOffset? restorePointInTime = null, AzureLocation? defaultSecondaryLocation = null, CatalogCollationType? catalogCollation = null, ManagedDatabaseCreateMode? createMode = null, Uri storageContainerUri = null, ResourceIdentifier sourceDatabaseId = null, ResourceIdentifier crossSubscriptionSourceDatabaseId = null, ResourceIdentifier restorableDroppedDatabaseId = null, ResourceIdentifier crossSubscriptionRestorableDroppedDatabaseId = null, string storageContainerIdentity = null, string storageContainerSasToken = null, ResourceIdentifier failoverGroupId = null, ResourceIdentifier recoverableDatabaseId = null, ResourceIdentifier longTermRetentionBackupResourceId = null, bool? allowAutoCompleteRestore = null, string lastBackupName = null, ResourceIdentifier crossSubscriptionTargetManagedInstanceId = null, bool? isLedgerOn = null)
        {
            ...
            return new ManagedDatabasePatch(tags, collation, status, createdOn, earliestRestorePoint, restorePointInTime, defaultSecondaryLocation, catalogCollation, createMode, storageContainerUri, sourceDatabaseId, crossSubscriptionSourceDatabaseId, restorableDroppedDatabaseId, crossSubscriptionRestorableDroppedDatabaseId, storageContainerIdentity, storageContainerSasToken, failoverGroupId, recoverableDatabaseId, longTermRetentionBackupResourceId, allowAutoCompleteRestore, lastBackupName, crossSubscriptionTargetManagedInstanceId, isLedgerOn, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ManagedDatabaseStartMoveDefinition(destinationManagedDatabaseId, operationMode, new Dictionary<string, BinaryData>());
        }
        ...
        public static ManagedInstanceData ManagedInstanceData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, ManagedServiceIdentity identity = null, SqlSku sku = null, ManagedInstancePropertiesProvisioningState? provisioningState = null, ManagedServerCreateMode? managedInstanceCreateMode = null, string fullyQualifiedDomainName = null, string administratorLogin = null, string administratorLoginPassword = null, ResourceIdentifier subnetId = null, string state = null, ManagedInstanceLicenseType? licenseType = null, int? vCores = null, int? storageSizeInGB = null, string collation = null, string dnsZone = null, ResourceIdentifier managedDnsZonePartner = null, bool? isPublicDataEndpointEnabled = null, ResourceIdentifier sourceManagedInstanceId = null, DateTimeOffset? restorePointInTime = null, ManagedInstanceProxyOverride? proxyOverride = null, string timezoneId = null, ResourceIdentifier instancePoolId = null, ResourceIdentifier maintenanceConfigurationId = null, IEnumerable<ManagedInstancePecProperty> privateEndpointConnections = null, string minimalTlsVersion = null, SqlBackupStorageRedundancy? currentBackupStorageRedundancy = null, SqlBackupStorageRedundancy? requestedBackupStorageRedundancy = null, bool? isZoneRedundant = null, ResourceIdentifier primaryUserAssignedIdentityId = null, Uri keyId = null, ManagedInstanceExternalAdministrator administrators = null, SqlServicePrincipal servicePrincipal = null)
        {
            ...
            return new ManagedInstanceData(id, name, resourceType, systemData, tags, location, identity, sku, provisioningState, managedInstanceCreateMode, fullyQualifiedDomainName, administratorLogin, administratorLoginPassword, subnetId, state, licenseType, vCores, storageSizeInGB, collation, dnsZone, managedDnsZonePartner, isPublicDataEndpointEnabled, sourceManagedInstanceId, restorePointInTime, proxyOverride, timezoneId, instancePoolId, maintenanceConfigurationId, privateEndpointConnections?.ToList(), minimalTlsVersion, currentBackupStorageRedundancy, requestedBackupStorageRedundancy, isZoneRedundant, primaryUserAssignedIdentityId, keyId, administrators, servicePrincipal, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ManagedInstancePecProperty(id, properties, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SqlServicePrincipal(principalId, clientId, tenantId, principalType, new Dictionary<string, BinaryData>());
        }
        ...
        public static SqlOutboundEnvironmentEndpoint SqlOutboundEnvironmentEndpoint(string category = null, IEnumerable<ManagedInstanceEndpointDependency> endpoints = null)
        {
            ...
            return new SqlOutboundEnvironmentEndpoint(category, endpoints?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static ManagedInstanceEndpointDependency ManagedInstanceEndpointDependency(string domainName = null, IEnumerable<ManagedInstanceEndpointDetail> endpointDetails = null)
        {
            ...
            return new ManagedInstanceEndpointDependency(domainName, endpointDetails?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ManagedInstanceEndpointDetail(port, new Dictionary<string, BinaryData>());
        }
        ...
        public static TopQueries TopQueries(int? numberOfQueries = null, string aggregationFunction = null, string observationMetric = null, QueryTimeGrainType? intervalType = null, string startTime = null, string endTime = null, IEnumerable<QueryStatisticsProperties> queries = null)
        {
            ...
            return new TopQueries(numberOfQueries, aggregationFunction, observationMetric, intervalType, startTime, endTime, queries?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ManagedLedgerDigestUploadData(id, name, resourceType, systemData, digestStorageEndpoint, state, new Dictionary<string, BinaryData>());
        }
        ...
        public static RecoverableDatabaseData RecoverableDatabaseData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string edition = null, string serviceLevelObjective = null, string elasticPoolName = null, DateTimeOffset? lastAvailableBackupOn = null, IDictionary<string, SqlDatabaseKey> keys = null)
        {
            ...
            return new RecoverableDatabaseData(id, name, resourceType, systemData, edition, serviceLevelObjective, elasticPoolName, lastAvailableBackupOn, keys, new Dictionary<string, BinaryData>());
        }
        ...
        public static RestorableDroppedDatabaseData RestorableDroppedDatabaseData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, SqlSku sku = null, string databaseName = null, long? maxSizeBytes = null, DateTimeOffset? createdOn = null, DateTimeOffset? deletedOn = null, DateTimeOffset? earliestRestoreOn = null, SqlBackupStorageRedundancy? backupStorageRedundancy = null, IDictionary<string, SqlDatabaseKey> keys = null)
        {
            ...
            return new RestorableDroppedDatabaseData(id, name, resourceType, systemData, tags, location, sku, databaseName, maxSizeBytes, createdOn, deletedOn, earliestRestoreOn, backupStorageRedundancy, keys, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ManagedInstanceServerConfigurationOptionData(id, name, resourceType, systemData, serverConfigurationOptionValue, provisioningState, new Dictionary<string, BinaryData>());
        }
        ...
        public static ManagedInstanceStartStopScheduleData ManagedInstanceStartStopScheduleData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string description = null, string timeZoneId = null, IEnumerable<SqlScheduleItem> scheduleList = null, string nextRunAction = null, string nextExecutionTime = null)
        {
            ...
            return new ManagedInstanceStartStopScheduleData(id, name, resourceType, systemData, description, timeZoneId, scheduleList?.ToList(), nextRunAction, nextExecutionTime, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new LogicalDatabaseTransparentDataEncryptionData(id, name, resourceType, systemData, state, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new IPv6FirewallRuleData(id, name, resourceType, new Dictionary<string, BinaryData>(), startIPv6Address, endIPv6Address);
        }
        ...
        public static SqlVulnerabilityAssessmentBaselineData SqlVulnerabilityAssessmentBaselineData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, IList<IList<string>>> results = null)
        {
            ...
            return new SqlVulnerabilityAssessmentBaselineData(id, name, resourceType, systemData, results, new Dictionary<string, BinaryData>());
        }
        ...
        public static SqlVulnerabilityAssessmentBaselineCreateOrUpdateContent SqlVulnerabilityAssessmentBaselineCreateOrUpdateContent(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, bool? isLatestScan = null, IDictionary<string, IList<IList<string>>> results = null)
        {
            ...
            return new SqlVulnerabilityAssessmentBaselineCreateOrUpdateContent(id, name, resourceType, systemData, isLatestScan, results, new Dictionary<string, BinaryData>());
        }
        ...
        public static SqlVulnerabilityAssessmentBaselineRuleData SqlVulnerabilityAssessmentBaselineRuleData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IEnumerable<IList<string>> results = null)
        {
            ...
            return new SqlVulnerabilityAssessmentBaselineRuleData(id, name, resourceType, systemData, results?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static SqlVulnerabilityAssessmentBaselineRuleCreateOrUpdateContent SqlVulnerabilityAssessmentBaselineRuleCreateOrUpdateContent(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, bool? isLatestScan = null, IEnumerable<IList<string>> results = null)
        {
            ...
            return new SqlVulnerabilityAssessmentBaselineRuleCreateOrUpdateContent(id, name, resourceType, systemData, isLatestScan, results?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static SqlVulnerabilityAssessmentScanResultData SqlVulnerabilityAssessmentScanResultData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string ruleId = null, SqlVulnerabilityAssessmentRuleStatus? status = null, string errorMessage = null, bool? isTrimmed = null, IEnumerable<IList<string>> queryResults = null, SqlVulnerabilityAssessmentRemediation remediation = null, SqlVulnerabilityAssessmentBaselineAdjustedResult baselineAdjustedResult = null, SqlVulnerabilityAssessmentRuleMetadata ruleMetadata = null)
        {
            ...
            return new SqlVulnerabilityAssessmentScanResultData(id, name, resourceType, systemData, ruleId, status, errorMessage, isTrimmed, queryResults?.ToList(), remediation, baselineAdjustedResult, ruleMetadata, new Dictionary<string, BinaryData>());
        }
        ...
        public static SqlVulnerabilityAssessmentRemediation SqlVulnerabilityAssessmentRemediation(string description = null, IEnumerable<string> scripts = null, bool? isAutomated = null, string portalLink = null)
        {
            ...
            return new SqlVulnerabilityAssessmentRemediation(description, scripts?.ToList(), isAutomated, portalLink, new Dictionary<string, BinaryData>());
        }
        ...
        public static SqlVulnerabilityAssessmentBaselineAdjustedResult SqlVulnerabilityAssessmentBaselineAdjustedResult(SqlVulnerabilityAssessmentBaselineDetails baseline = null, SqlVulnerabilityAssessmentRuleStatus? status = null, IEnumerable<IList<string>> resultsNotInBaseline = null, IEnumerable<IList<string>> resultsOnlyInBaseline = null)
        {
            ...
            return new SqlVulnerabilityAssessmentBaselineAdjustedResult(baseline, status, resultsNotInBaseline?.ToList(), resultsOnlyInBaseline?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static SqlVulnerabilityAssessmentBaselineDetails SqlVulnerabilityAssessmentBaselineDetails(IEnumerable<IList<string>> expectedResults = null, DateTimeOffset? updatedOn = null)
        {
            ...
            return new SqlVulnerabilityAssessmentBaselineDetails(expectedResults?.ToList(), updatedOn, new Dictionary<string, BinaryData>());
        }
        ...
        public static SqlVulnerabilityAssessmentRuleMetadata SqlVulnerabilityAssessmentRuleMetadata(string ruleId = null, SqlVulnerabilityAssessmentRuleSeverity? severity = null, string category = null, SqlVulnerabilityAssessmentRuleType? ruleType = null, string title = null, string description = null, string rationale = null, SqlVulnerabilityAssessmentQueryCheck queryCheck = null, IEnumerable<SqlVulnerabilityAssessmentBenchmarkReference> benchmarkReferences = null)
        {
            ...
            return new SqlVulnerabilityAssessmentRuleMetadata(ruleId, severity, category, ruleType, title, description, rationale, queryCheck, benchmarkReferences?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static SqlVulnerabilityAssessmentQueryCheck SqlVulnerabilityAssessmentQueryCheck(string query = null, IEnumerable<IList<string>> expectedResult = null, IEnumerable<string> columnNames = null)
        {
            ...
            return new SqlVulnerabilityAssessmentQueryCheck(query, expectedResult?.ToList(), columnNames?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SqlVulnerabilityAssessmentBenchmarkReference(benchmark, reference, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SqlVulnerabilityAssessmentScanError(code, message, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SqlVulnerabilityAssessmentData(id, name, resourceType, systemData, state, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SqlNameAvailabilityContent(name, resourceType, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SqlNameAvailabilityResponse(name, isAvailable, reason, message, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SqlServerPrivateEndpointConnection(id, properties, new Dictionary<string, BinaryData>());
        }
        ...
        public static SqlServerPatch SqlServerPatch(ManagedServiceIdentity identity = null, IDictionary<string, string> tags = null, string administratorLogin = null, string administratorLoginPassword = null, string version = null, string state = null, string fullyQualifiedDomainName = null, IEnumerable<SqlServerPrivateEndpointConnection> privateEndpointConnections = null, string minimalTlsVersion = null, ServerNetworkAccessFlag? publicNetworkAccess = null, ServerWorkspaceFeature? workspaceFeature = null, ResourceIdentifier primaryUserAssignedIdentityId = null, Guid? federatedClientId = null, Uri keyId = null, ServerExternalAdministrator administrators = null, ServerNetworkAccessFlag? restrictOutboundNetworkAccess = null, ServerNetworkAccessFlag? isIPv6Enabled = null, ExternalGovernanceStatus? externalGovernanceStatus = null)
        {
            ...
            return new SqlServerPatch(identity, tags, administratorLogin, administratorLoginPassword, version, state, fullyQualifiedDomainName, privateEndpointConnections?.ToList(), minimalTlsVersion, publicNetworkAccess, workspaceFeature, primaryUserAssignedIdentityId, federatedClientId, keyId, administrators, restrictOutboundNetworkAccess, isIPv6Enabled, externalGovernanceStatus, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DatabaseImportDefinition(databaseName, edition, serviceObjectiveName, maxSizeBytes, storageKeyType, storageKey, storageUri, administratorLogin, administratorLoginPassword, authenticationType, networkIsolation, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new RefreshExternalGovernanceStatusOperationResult(id, name, resourceType, systemData, requestId, requestType, queuedTime, serverName, status, errorMessage, new Dictionary<string, BinaryData>());
        }
        ...
        public static FailoverGroupData FailoverGroupData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, AzureLocation? location = null, IDictionary<string, string> tags = null, FailoverGroupReadWriteEndpoint readWriteEndpoint = null, FailoverGroupReadOnlyEndpoint readOnlyEndpoint = null, FailoverGroupReplicationRole? replicationRole = null, string replicationState = null, IEnumerable<PartnerServerInfo> partnerServers = null, IEnumerable<ResourceIdentifier> failoverDatabases = null)
        {
            ...
            return new FailoverGroupData(id, name, resourceType, systemData, location, tags, readWriteEndpoint, readOnlyEndpoint, replicationRole, replicationState, partnerServers?.ToList(), failoverDatabases?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new PartnerServerInfo(id, location, replicationRole, new Dictionary<string, BinaryData>());
        }
    }
}
