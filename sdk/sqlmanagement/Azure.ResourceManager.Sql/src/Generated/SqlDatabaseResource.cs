...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class SqlDatabaseResource : ArmResource
    {
        ...
        internal SqlDatabaseResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _databasesRestClient = new Databases(_databasesClientDiagnostics, Pipeline, Endpoint, sqlDatabaseApiVersion ?? "2025-01-01");
            _databaseOperationsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Sql", ResourceType.Namespace, Diagnostics);
            _databaseOperationsRestClient = new DatabaseOperations(_databaseOperationsClientDiagnostics, Pipeline, Endpoint, sqlDatabaseApiVersion ?? "2025-01-01");
            _restorePointsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Sql", ResourceType.Namespace, Diagnostics);
            _restorePointsRestClient = new RestorePoints(_restorePointsClientDiagnostics, Pipeline, Endpoint, sqlDatabaseApiVersion ?? "2025-01-01");
            _databaseUsagesClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Sql", ResourceType.Namespace, Diagnostics);
            _databaseUsagesRestClient = new DatabaseUsages(_databaseUsagesClientDiagnostics, Pipeline, Endpoint, sqlDatabaseApiVersion ?? "2025-01-01");
            _databaseColumnsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Sql", ResourceType.Namespace, Diagnostics);
            _databaseColumnsRestClient = new DatabaseColumns(_databaseColumnsClientDiagnostics, Pipeline, Endpoint, sqlDatabaseApiVersion ?? "2025-01-01");
            _sensitivityLabelsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Sql", ResourceType.Namespace, Diagnostics);
            _sensitivityLabelsRestClient = new SensitivityLabels(_sensitivityLabelsClientDiagnostics, Pipeline, Endpoint, sqlDatabaseApiVersion ?? "2025-01-01");
            ...
            _recommendedSensitivityLabelsRestClient = new RecommendedSensitivityLabels(_recommendedSensitivityLabelsClientDiagnostics, Pipeline, Endpoint, sqlDatabaseApiVersion ?? "2025-01-01");
            ...
            _databaseEncryptionProtectorsRestClient = new DatabaseEncryptionProtectors(_databaseEncryptionProtectorsClientDiagnostics, Pipeline, Endpoint, sqlDatabaseApiVersion ?? "2025-01-01");
            ...
            _synapseLinkWorkspacesRestClient = new SynapseLinkWorkspaces(_synapseLinkWorkspacesClientDiagnostics, Pipeline, Endpoint, sqlDatabaseApiVersion ?? "2025-01-01");
            _databaseExtensionsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Sql", ResourceType.Namespace, Diagnostics);
            _databaseExtensionsRestClient = new DatabaseExtensions(_databaseExtensionsClientDiagnostics, Pipeline, Endpoint, sqlDatabaseApiVersion ?? "2025-01-01");
        ...
        public virtual AsyncPageable<DatabaseUsage> GetDatabaseUsagesAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new DatabaseUsagesGetDatabaseUsagesAsyncCollectionResultOfT(
                ...
                Id.Name,
                context,
                "SqlDatabaseResource.GetDatabaseUsages");
        }
        ...
        public virtual async Task<Response> UpdateRecommendedSensitivityLabelAsync(RecommendedSensitivityLabelUpdateList recommendedSensitivityLabelUpdateList, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _recommendedSensitivityLabelsClientDiagnostics.CreateScope("SqlDatabaseResource.UpdateRecommendedSensitivityLabel");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _recommendedSensitivityLabelsRestClient.CreateUpdateRecommendedSensitivityLabelRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, RecommendedSensitivityLabelUpdateList.ToRequestContent(recommendedSensitivityLabelUpdateList), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
        ...
        public virtual AsyncPageable<ImportExportExtensionsOperationResult> GetDatabaseExtensionsAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new DatabaseExtensionsGetDatabaseExtensionsAsyncCollectionResultOfT(
                ...
                Id.Name,
                context,
                "SqlDatabaseResource.GetDatabaseExtensions");
        }
        ...
        /// <summary> Gets an object representing a <see cref="SqlDatabaseBlobAuditingPolicyResource"/> along with the instance operations that can be performed on it in the <see cref="SqlDatabaseResource"/>. </summary>
        /// <returns> Returns a <see cref="SqlDatabaseBlobAuditingPolicyResource"/> object. </returns>
        public virtual SqlDatabaseBlobAuditingPolicyResource GetSqlDatabaseBlobAuditingPolicy()
        {
            return new SqlDatabaseBlobAuditingPolicyResource(Client, Id.AppendChildResource("auditingSettings", "default"));
        }

        /// <summary> Gets an object representing a <see cref="ExtendedDatabaseBlobAuditingPolicyResource"/> along with the instance operations that can be performed on it in the <see cref="SqlDatabaseResource"/>. </summary>
        /// <returns> Returns a <see cref="ExtendedDatabaseBlobAuditingPolicyResource"/> object. </returns>
        public virtual ExtendedDatabaseBlobAuditingPolicyResource GetExtendedDatabaseBlobAuditingPolicy()
        {
            return new ExtendedDatabaseBlobAuditingPolicyResource(Client, Id.AppendChildResource("extendedAuditingSettings", "default"));
        }
