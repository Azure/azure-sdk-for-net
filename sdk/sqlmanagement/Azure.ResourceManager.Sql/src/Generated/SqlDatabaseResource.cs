...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class SqlDatabaseResource : ArmResource
    {
        ...
        internal SqlDatabaseResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _databaseColumnsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Sql", ProviderConstants.DefaultProviderNamespace, Diagnostics);
            _databaseColumnsRestClient = new DatabaseColumnsRestOperations(Pipeline, Diagnostics.ApplicationId, Endpoint);
        ...
        public virtual AsyncPageable<DatabaseColumnResource> GetColumnsAsync(IEnumerable<string> schema = null, IEnumerable<string> table = null, IEnumerable<string> column = null, IEnumerable<string> orderBy = null, string skiptoken = null, CancellationToken cancellationToken = default)
        {
            async Task<Page<DatabaseColumnResource>> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _databaseColumnsClientDiagnostics.CreateScope("SqlDatabaseResource.GetColumns");
                scope.Start();
                try
                {
        ...
        public virtual Pageable<DatabaseColumnResource> GetColumns(IEnumerable<string> schema = null, IEnumerable<string> table = null, IEnumerable<string> column = null, IEnumerable<string> orderBy = null, string skiptoken = null, CancellationToken cancellationToken = default)
        {
        ...
        public virtual AsyncPageable<SensitivityLabelResource> GetDatabaseCurrentSensitivityLabelsAsync(string skipToken = null, bool? count = null, string filter = null, CancellationToken cancellationToken = default)
        {
            async Task<Page<SensitivityLabelResource>> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _sensitivityLabelsClientDiagnostics.CreateScope("SqlDatabaseResource.GetDatabaseCurrentSensitivityLabels");
                scope.Start();
                try
                {
        ...
        public virtual Pageable<SensitivityLabelResource> GetDatabaseCurrentSensitivityLabels(string skipToken = null, bool? count = null, string filter = null, CancellationToken cancellationToken = default)
        {
        ...
        public virtual async Task<Response> UpdateSensitivityLabelAsync(SensitivityLabelUpdateList sensitivityLabelUpdateList, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _sensitivityLabelsClientDiagnostics.CreateScope("SqlDatabaseResource.UpdateSensitivityLabel");
            scope.Start();
            try
            {
                var response = await _sensitivityLabelsRestClient.UpdateAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, sensitivityLabelUpdateList, cancellationToken).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
            {
        ...
        public virtual Response UpdateSensitivityLabel(SensitivityLabelUpdateList sensitivityLabelUpdateList, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _sensitivityLabelsRestClient.Update(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, sensitivityLabelUpdateList, cancellationToken);
                return response;
            }
            catch (Exception e)
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> An async collection of <see cref="SensitivityLabelResource" /> that may take multiple service requests to iterate over. </returns>
        public virtual AsyncPageable<SensitivityLabelResource> GetDatabaseRecommendedSensitivityLabelsAsync(string skipToken = null, bool? includeDisabledRecommendations = null, string filter = null, CancellationToken cancellationToken = default)
        {
            async Task<Page<SensitivityLabelResource>> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _sensitivityLabelsClientDiagnostics.CreateScope("SqlDatabaseResource.GetDatabaseRecommendedSensitivityLabels");
                scope.Start();
                try
                {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> A collection of <see cref="SensitivityLabelResource" /> that may take multiple service requests to iterate over. </returns>
        public virtual Pageable<SensitivityLabelResource> GetDatabaseRecommendedSensitivityLabels(string skipToken = null, bool? includeDisabledRecommendations = null, string filter = null, CancellationToken cancellationToken = default)
        {
            Page<SensitivityLabelResource> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _sensitivityLabelsClientDiagnostics.CreateScope("SqlDatabaseResource.GetDatabaseRecommendedSensitivityLabels");
        ...
        public virtual async Task<Response> UpdateRecommendedSensitivityLabelAsync(RecommendedSensitivityLabelUpdateList recommendedSensitivityLabelUpdateList, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _sensitivityLabelsClientDiagnostics.CreateScope("SqlDatabaseResource.UpdateRecommendedSensitivityLabel");
            scope.Start();
            try
            {
                var response = await _sensitivityLabelsRestClient.UpdateRecommendedAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, recommendedSensitivityLabelUpdateList, cancellationToken).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
            {
        ...
        public virtual Response UpdateRecommendedSensitivityLabel(RecommendedSensitivityLabelUpdateList recommendedSensitivityLabelUpdateList, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _sensitivityLabelsRestClient.UpdateRecommended(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, recommendedSensitivityLabelUpdateList, cancellationToken);
                return response;
            }
            catch (Exception e)
            {
