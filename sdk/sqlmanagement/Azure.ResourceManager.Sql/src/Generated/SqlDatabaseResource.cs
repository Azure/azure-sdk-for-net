...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class SqlDatabaseResource : ArmResource
    {
        ...
        /// <summary> Gets a collection of ServerDatabaseSqlVulnerabilityAssessmentScanScanResultResources in the SqlDatabase. </summary>
        ...
        /// <returns> An object representing collection of ServerDatabaseSqlVulnerabilityAssessmentScanScanResultResources and their operations over a ServerDatabaseSqlVulnerabilityAssessmentScanScanResultResource. </returns>
        public virtual ServerDatabaseSqlVulnerabilityAssessmentScanScanResultCollection GetServerDatabaseSqlVulnerabilityAssessmentScanScanResults(SqlVulnerabilityAssessmentName vulnerabilityAssessmentName, string scanId)
        {
            Argument.AssertNotNullOrEmpty(scanId, nameof(scanId));

            return new ServerDatabaseSqlVulnerabilityAssessmentScanScanResultCollection(Client, Id, vulnerabilityAssessmentName, scanId);
        }

        /// <summary>
        /// Gets a vulnerability assessment scan record of a database.
        /// Request Path: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/databases/{databaseName}/sqlVulnerabilityAssessments/{vulnerabilityAssessmentName}/scans/{scanId}/scanResults/{scanResultId}
        /// Operation Id: DatabaseSqlVulnerabilityAssessmentScanResult_Get
        /// </summary>
        /// <param name="vulnerabilityAssessmentName"> The name of the SQL Vulnerability Assessment. </param>
        /// <param name="scanId"> The scan id of the SQL Vulnerability Assessment scan to retrieve result from. </param>
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="scanId"/> or <paramref name="scanResultId"/> is null. </exception>
        [ForwardsClientCalls]
        public virtual async Task<Response<ServerDatabaseSqlVulnerabilityAssessmentScanScanResultResource>> GetServerDatabaseSqlVulnerabilityAssessmentScanScanResultAsync(SqlVulnerabilityAssessmentName vulnerabilityAssessmentName, string scanId, string scanResultId, CancellationToken cancellationToken = default)
        {
            return await GetServerDatabaseSqlVulnerabilityAssessmentScanScanResults(vulnerabilityAssessmentName, scanId).GetAsync(scanResultId, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="scanId"/> or <paramref name="scanResultId"/> is null. </exception>
        [ForwardsClientCalls]
        public virtual Response<ServerDatabaseSqlVulnerabilityAssessmentScanScanResultResource> GetServerDatabaseSqlVulnerabilityAssessmentScanScanResult(SqlVulnerabilityAssessmentName vulnerabilityAssessmentName, string scanId, string scanResultId, CancellationToken cancellationToken = default)
        {
            return GetServerDatabaseSqlVulnerabilityAssessmentScanScanResults(vulnerabilityAssessmentName, scanId).Get(scanResultId, cancellationToken);
        }
