...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class ManagedInstanceAdministrator : ArmResource
    {
        ...
        public async virtual Task<Response<ManagedInstanceAdministrator>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _managedInstanceAdministratorsRestClient.GetAsync(Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<ManagedInstanceAdministrator> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _managedInstanceAdministratorsRestClient.Get(Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                if (response.Value == null)
        ...
        public async virtual Task<ManagedInstanceAdministratorDeleteOperation> DeleteAsync(bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _managedInstanceAdministratorsRestClient.DeleteAsync(Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
                var operation = new ManagedInstanceAdministratorDeleteOperation(_clientDiagnostics, Pipeline, _managedInstanceAdministratorsRestClient.CreateDeleteRequest(Id.ResourceGroupName, Id.Parent.Name, Id.Name).Request, response);
        ...
        public virtual ManagedInstanceAdministratorDeleteOperation Delete(bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _managedInstanceAdministratorsRestClient.Delete(Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                var operation = new ManagedInstanceAdministratorDeleteOperation(_clientDiagnostics, Pipeline, _managedInstanceAdministratorsRestClient.CreateDeleteRequest(Id.ResourceGroupName, Id.Parent.Name, Id.Name).Request, response);
                if (waitForCompletion)
