...
{
    /// <summary> A Class representing a ServerDatabaseSchemaTableColumnResource along with the instance operations that can be performed on it. </summary>
    public partial class ServerDatabaseSchemaTableColumnResource : ArmResource
    {
        ...
        internal ServerDatabaseSchemaTableColumnResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _serverDatabaseSchemaTableColumnSensitivityLabelSensitivityLabelsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Sql", ServerDatabaseSchemaTableColumnSensitivityLabelResource.ResourceType.Namespace, DiagnosticOptions);
        ...
        /// <summary> Gets a collection of ServerDatabaseSchemaTableColumnSensitivityLabelResources in the ServerDatabaseSchemaTableColumnSensitivityLabelResource. </summary>
