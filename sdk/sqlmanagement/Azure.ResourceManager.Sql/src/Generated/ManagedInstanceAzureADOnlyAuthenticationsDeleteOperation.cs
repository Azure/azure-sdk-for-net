...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class ManagedInstanceAzureADOnlyAuthenticationsDeleteOperation : Operation<Response>, IOperationSource<Response>
    {
        private readonly ArmOperationHelpers<Response> _operation;

        /// <summary> Initializes a new instance of ManagedInstanceAzureADOnlyAuthenticationsDeleteOperation for mocking. </summary>
        protected ManagedInstanceAzureADOnlyAuthenticationsDeleteOperation()
        {
        }

        internal ManagedInstanceAzureADOnlyAuthenticationsDeleteOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<Response>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "ManagedInstanceAzureADOnlyAuthenticationsDeleteOperation");
        }
        /// <inheritdoc />
