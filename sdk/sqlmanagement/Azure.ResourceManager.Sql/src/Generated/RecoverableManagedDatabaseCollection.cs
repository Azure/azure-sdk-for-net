...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class RecoverableManagedDatabaseCollection : ArmCollection, IEnumerable<RecoverableManagedDatabase>, IAsyncEnumerable<RecoverableManagedDatabase>
    {
        ...
        /// <exception cref="ArgumentException"> <paramref name="recoverableDatabaseName"/> is null or empty. </exception>
        ...
        {
            if (string.IsNullOrEmpty(recoverableDatabaseName))
            {
                throw new ArgumentException($"Parameter {nameof(recoverableDatabaseName)} cannot be null or empty", nameof(recoverableDatabaseName));
            }
