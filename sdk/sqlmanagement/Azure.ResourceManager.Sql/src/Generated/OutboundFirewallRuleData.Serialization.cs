...
namespace Azure.ResourceManager.Sql
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<OutboundFirewallRuleData>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<OutboundFirewallRuleData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(OutboundFirewallRuleData)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<OutboundFirewallRuleData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(OutboundFirewallRuleData)} does not support '{options.Format}' format.");
            }
        }
