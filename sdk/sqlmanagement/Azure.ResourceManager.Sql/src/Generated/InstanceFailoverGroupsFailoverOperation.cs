...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class InstanceFailoverGroupsFailoverOperation : Operation<InstanceFailoverGroup>, IOperationSource<InstanceFailoverGroup>
    {
        private readonly ArmOperationHelpers<InstanceFailoverGroup> _operation;

        /// <summary> Initializes a new instance of InstanceFailoverGroupsFailoverOperation for mocking. </summary>
        protected InstanceFailoverGroupsFailoverOperation()
        {
        }

        internal InstanceFailoverGroupsFailoverOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<InstanceFailoverGroup>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "InstanceFailoverGroupsFailoverOperation");
        }
        /// <inheritdoc />
