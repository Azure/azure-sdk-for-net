...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class SyncGroupData : ResourceData
    {
        ...
        internal SyncGroupData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, SyncGroupProperties properties, SqlSku sku, DataSyncParticipantIdentity identity) : base(id, name, resourceType, systemData)
        {
        ...
        public bool? EnableConflictLogging
        {
            get
            {
                return Properties is null ? default : Properties.EnableConflictLogging;
            }
            set
            {
                if (Properties is null)
                ...
                Properties.EnableConflictLogging = value;
            }
        }
