...
namespace Azure.ResourceManager.Sql
{
    public partial class SqlServerJobExecutionStepCollection
    {
        ...
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual AsyncPageable<SqlServerJobExecutionStepResource> GetAllAsync(DateTimeOffset? createTimeMin, DateTimeOffset? createTimeMax, DateTimeOffset? endTimeMin, DateTimeOffset? endTimeMax, bool? isActive, int? skip, int? top, CancellationToken cancellationToken)
        {
            long? skipLong = skip;
            long? topLong = top;
        ...
        /// <summary> Backward-compatible overload retained from v1.4.0 (skip/top were int?). </summary>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual Pageable<SqlServerJobExecutionStepResource> GetAll(DateTimeOffset? createTimeMin, DateTimeOffset? createTimeMax, DateTimeOffset? endTimeMin, DateTimeOffset? endTimeMax, bool? isActive, int? skip, int? top, CancellationToken cancellationToken)
        {
            long? skipLong = skip;
            long? topLong = top;
