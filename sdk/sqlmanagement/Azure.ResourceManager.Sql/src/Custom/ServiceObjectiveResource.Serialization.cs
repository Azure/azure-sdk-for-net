...
namespace Azure.ResourceManager.Sql
{
    public partial class ServiceObjectiveResource : IJsonModel<ServiceObjectiveData>
    {
        ...
        BinaryData IPersistableModel<ServiceObjectiveData>.Write(ModelReaderWriterOptions options) => ModelReaderWriter.Write(Data, options, AzureResourceManagerSqlContext.Default);
