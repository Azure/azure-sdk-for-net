...
namespace Azure.ResourceManager.Sql.Models
{
    internal partial class ServerCommunicationLinkListResult : IUtf8JsonSerializable, IJsonModel<ServerCommunicationLinkListResult>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ServerCommunicationLinkListResult)} does not support writing '{format}' format.");
            }
        ...
        ServerCommunicationLinkListResult IJsonModel<ServerCommunicationLinkListResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ServerCommunicationLinkListResult)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ServerCommunicationLinkListResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ServerCommunicationLinkListResult)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        ServerCommunicationLinkListResult IPersistableModel<ServerCommunicationLinkListResult>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ServerCommunicationLinkListResult)} does not support reading '{options.Format}' format.");
            }
        }
