...
namespace Azure.ResourceManager.Sql
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SqlServerCommunicationLinkData>)this).Write(writer, ModelSerializationExtensions.WireOptions);
