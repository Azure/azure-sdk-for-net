...
namespace Azure.ResourceManager.Sql
{
    public partial class SqlServerCommunicationLinkResource : IJsonModel<SqlServerCommunicationLinkData>
    {
        ...
        BinaryData IPersistableModel<SqlServerCommunicationLinkData>.Write(ModelReaderWriterOptions options) => ModelReaderWriter.Write(Data, options, AzureResourceManagerSqlContext.Default);
