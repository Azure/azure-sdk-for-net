...
namespace Azure.ResourceManager.Sql.Samples
{
    public partial class Sample_SqlServerJobCollection
    {
        ...
        {
            // Generated from example definition: specification/sql/resource-manager/Microsoft.Sql/stable/2021-11-01/examples/CreateOrUpdateJobMax.json
        ...
        {
            // Generated from example definition: specification/sql/resource-manager/Microsoft.Sql/stable/2021-11-01/examples/CreateOrUpdateJobMin.json
            // this example is just showing the usage of "Jobs_CreateOrUpdate" operation, for the dependent resources, they will have to be created separately.
        ...
        {
            // Generated from example definition: specification/sql/resource-manager/Microsoft.Sql/stable/2021-11-01/examples/GetJob.json
        ...
        {
            // Generated from example definition: specification/sql/resource-manager/Microsoft.Sql/stable/2021-11-01/examples/ListJobsByAgent.json
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task GetIfExists_GetAJob()
        {
            // Generated from example definition: specification/sql/resource-manager/Microsoft.Sql/stable/2021-11-01/examples/GetJob.json
            // this example is just showing the usage of "Jobs_Get" operation, for the dependent resources, they will have to be created separately.
            ...
            // invoke the operation
            string jobName = "job1";
            NullableResponse<SqlServerJobResource> response = await collection.GetIfExistsAsync(jobName);
            SqlServerJobResource result = response.HasValue ? response.Value : null;
