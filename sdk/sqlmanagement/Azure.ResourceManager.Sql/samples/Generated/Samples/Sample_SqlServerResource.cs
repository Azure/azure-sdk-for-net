...
namespace Azure.ResourceManager.Sql.Samples
{
    public partial class Sample_SqlServerResource
    {
        ...
        public async Task Delete_DeleteServer()
        {
            ...
            // invoke the operation
            await sqlServer.DeleteAsync(WaitUntil.Completed).ConfigureAwait(false);
        ...
        public async Task CreateTdeCertificate_UploadATDECertificate()
        {
            ...
            await sqlServer.CreateTdeCertificateAsync(WaitUntil.Completed, tdeCertificate).ConfigureAwait(false);
