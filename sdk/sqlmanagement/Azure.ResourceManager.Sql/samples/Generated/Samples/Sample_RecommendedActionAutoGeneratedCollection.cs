...
{
    public partial class Sample_RecommendedActionAutoGeneratedCollection
    {
        [Test]
        ...
        public async Task Get_GetDatabaseRecommendedAction()
        {
            ...
            // get the collection of this RecommendedActionAutoGeneratedResource
            RecommendedActionAutoGeneratedCollection collection = sqlDatabaseAdvisor.GetRecommendedActionAutoGenerateds();

            // invoke the operation
            string recommendedActionName = "IR_[CRM]_[DataPoints]_4821CD2F9510D98184BB";
            RecommendedActionAutoGeneratedResource result = await collection.GetAsync(recommendedActionName);
        ...
        public async Task GetAll_ListOfDatabaseRecommendedActions()
        {
            ...
            await foreach (RecommendedActionAutoGeneratedResource item in collection.GetAllAsync())
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                RecommendedActionAutoGeneratedData resourceData = item.Data;
                // for demo we just print out the id
                Console.WriteLine($"Succeeded on id: {resourceData.Id}");
            }
        ...
        public async Task GetIfExists_GetDatabaseRecommendedAction()
        {
            ...
            // invoke the operation
            string recommendedActionName = "IR_[CRM]_[DataPoints]_4821CD2F9510D98184BB";
            NullableResponse<RecommendedActionAutoGeneratedResource> response = await collection.GetIfExistsAsync(recommendedActionName);
            RecommendedActionAutoGeneratedResource result = response.HasValue ? response.Value : null;
