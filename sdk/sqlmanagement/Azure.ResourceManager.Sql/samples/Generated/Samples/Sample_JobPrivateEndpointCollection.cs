...
{
    public partial class Sample_JobPrivateEndpointCollection
    {
        // List private endpoints in a job agent
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task GetAll_ListPrivateEndpointsInAJobAgent()
        {
            // Generated from example definition: specification/sql/resource-manager/Microsoft.Sql/preview/2023-05-01-preview/examples/ListJobPrivateEndpointsByAgent.json
            // this example is just showing the usage of "JobPrivateEndpoints_ListByAgent" operation, for the dependent resources, they will have to be created separately.
            ...
            // get the collection of this JobPrivateEndpointResource
            JobPrivateEndpointCollection collection = sqlServerJobAgent.GetJobPrivateEndpoints();

            // invoke the operation and iterate over the result
            await foreach (JobPrivateEndpointResource item in collection.GetAllAsync())
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                JobPrivateEndpointData resourceData = item.Data;
        ...
        public async Task Get_GetAPrivateEndpoint()
        {
            ...
            JobPrivateEndpointResource result = await collection.GetAsync(privateEndpointName);
        ...
        public async Task GetIfExists_GetAPrivateEndpoint()
        {
            ...
            // invoke the operation
            string privateEndpointName = "endpoint1";
            NullableResponse<JobPrivateEndpointResource> response = await collection.GetIfExistsAsync(privateEndpointName);
            JobPrivateEndpointResource result = response.HasValue ? response.Value : null;
        ...
        public async Task CreateOrUpdate_CreateAPrivateEndpoint()
        {
            ...
            ArmOperation<JobPrivateEndpointResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, privateEndpointName, data);
