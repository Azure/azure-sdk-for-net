...
namespace Azure.ResourceManager.Sql.Samples
{
    public partial class Sample_ManagedDatabaseSensitivityLabelCollection
    {
        ...
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task CreateOrUpdate_UpdatesOrCreatesASensitivityLabelOfAGivenColumnWithAllParametersInAManagedDatabase()
        {
            ...
            ArmOperation<ManagedDatabaseSensitivityLabelResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, data);
