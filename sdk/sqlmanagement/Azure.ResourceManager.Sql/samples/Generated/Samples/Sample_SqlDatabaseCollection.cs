...
["/subscriptions/00000000-1111-2222-3333-444444444444/resourcegroups/Default-SQL-SouthEastAsia/providers/Microsoft.Sql/userAssignedIdentities/umiToDelete"] = default
        ...
        public async Task Get_GetsADatabaseWithDatabaseLevelKeysExpanded()
        {
            ...
            string databaseName = "testdb";
            string expand = "keys";
            SqlDatabaseResource result = await collection.GetAsync(databaseName, expand);
        ...
        public async Task GetIfExists_GetsADatabaseWithDatabaseLevelKeysExpanded()
        {
            ...
            string databaseName = "testdb";
            string expand = "keys";
            NullableResponse<SqlDatabaseResource> response = await collection.GetIfExistsAsync(databaseName, expand);
            SqlDatabaseResource result = response.HasValue ? response.Value : null;
