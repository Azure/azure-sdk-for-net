...
{
    public partial class Sample_ManagedDatabaseColumnCollection
    {
        [Test]
        ...
        public async Task Get_GetManagedDatabaseColumn()
        {
            ...
            ManagedDatabaseColumnResource result = await collection.GetAsync(columnName);
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task GetAll_ListManagedDatabaseColumns()
        {
            // Generated from example definition: specification/sql/resource-manager/Microsoft.Sql/SQL/stable/2025-01-01/examples/ManagedDatabaseColumnListByTable.json
            // this example is just showing the usage of "ManagedDatabaseColumns_ListByTable" operation, for the dependent resources, they will have to be created separately.
            ...
            await foreach (ManagedDatabaseColumnResource item in collection.GetAllAsync())
            {
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task Exists_GetManagedDatabaseColumn()
        {
            // Generated from example definition: specification/sql/resource-manager/Microsoft.Sql/SQL/stable/2025-01-01/examples/ManagedDatabaseColumnGet.json
            // this example is just showing the usage of "ManagedDatabaseColumns_Get" operation, for the dependent resources, they will have to be created separately.
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task GetIfExists_GetManagedDatabaseColumn()
        {
            // Generated from example definition: specification/sql/resource-manager/Microsoft.Sql/SQL/stable/2025-01-01/examples/ManagedDatabaseColumnGet.json
            // this example is just showing the usage of "ManagedDatabaseColumns_Get" operation, for the dependent resources, they will have to be created separately.
