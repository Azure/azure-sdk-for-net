...
namespace Azure.ResourceManager.Sql.Tests
{
    ...
    public abstract class SqlManagementClientBase : ManagementRecordedTestBase<SqlManagementTestEnvironment>
    {
        ...
        /// <returns></returns>
        protected async Task<ManagedInstanceResource> CreateDefaultManagedInstance(string managedInstanceName,string networkSecurityGroupName, string routeTableName , string vnetName , AzureLocation location, ResourceGroup resourceGroup)
        {
        ...
        /// <param name=""></param>
        /// <returns></returns>
        protected async Task<PrivateEndpointResource> CreateDefaultPrivateEndpoint(ManagedInstanceResource managedInstance,VirtualNetworkResource vnet, AzureLocation location, ResourceGroup resourceGroup)
        {
            // Add new subnet
