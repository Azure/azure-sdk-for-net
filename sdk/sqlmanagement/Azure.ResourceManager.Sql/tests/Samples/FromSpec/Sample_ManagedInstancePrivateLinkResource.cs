...
{
    public partial class Sample_ManagedInstancePrivateLinkResource
    {
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task Get_GetsAPrivateLinkResourceForSQL()
        {
            // Generated from example definition: specification/sql/resource-manager/Microsoft.Sql/SQL/stable/2025-01-01/examples/ManagedInstancePrivateLinkResourcesGet.json
