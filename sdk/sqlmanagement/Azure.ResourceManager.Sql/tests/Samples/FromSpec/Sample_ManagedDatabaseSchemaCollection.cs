...
{
    public partial class Sample_ManagedDatabaseSchemaCollection
    {
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task Get_GetManagedDatabaseSchema()
        {
            // Generated from example definition: specification/sql/resource-manager/Microsoft.Sql/SQL/stable/2025-01-01/examples/ManagedDatabaseSchemaGet.json
            ...
            ManagedDatabaseSchemaResource result = await collection.GetAsync(schemaName);
        ...
        {
            // Generated from example definition: specification/sql/resource-manager/Microsoft.Sql/SQL/stable/2025-01-01/examples/ManagedDatabaseSchemaListByDatabase.json
            // this example is just showing the usage of "ManagedDatabaseSchemas_ListByDatabase" operation, for the dependent resources, they will have to be created separately.
            ...
            await foreach (ManagedDatabaseSchemaResource item in collection.GetAllAsync())
            {
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task Exists_GetManagedDatabaseSchema()
        {
            // Generated from example definition: specification/sql/resource-manager/Microsoft.Sql/SQL/stable/2025-01-01/examples/ManagedDatabaseSchemaGet.json
            // this example is just showing the usage of "ManagedDatabaseSchemas_Get" operation, for the dependent resources, they will have to be created separately.
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task GetIfExists_GetManagedDatabaseSchema()
        {
            // Generated from example definition: specification/sql/resource-manager/Microsoft.Sql/SQL/stable/2025-01-01/examples/ManagedDatabaseSchemaGet.json
            // this example is just showing the usage of "ManagedDatabaseSchemas_Get" operation, for the dependent resources, they will have to be created separately.
            ...
            // invoke the operation
            string schemaName = "dbo";
            NullableResponse<ManagedDatabaseSchemaResource> response = await collection.GetIfExistsAsync(schemaName);
            ManagedDatabaseSchemaResource result = response.HasValue ? response.Value : null;
