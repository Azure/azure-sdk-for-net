    ...
    internal partial class ManagedDatabaseSecurityAlertPoliciesOperations : IServiceOperations<SqlManagementClient>, IManagedDatabaseSecurityAlertPoliciesOperations
    {
        ...
        public async Task<AzureOperationResponse<IPage<ManagedDatabaseSecurityAlertPolicy>>> ListByDatabaseWithHttpMessagesAsync(string resourceGroupName, string managedInstanceName, string databaseName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<Page<ManagedDatabaseSecurityAlertPolicy>>(_responseContent, Client.DeserializationSettings);
                }
                catch (JsonException ex)
                {
                    _httpRequest.Dispose();
