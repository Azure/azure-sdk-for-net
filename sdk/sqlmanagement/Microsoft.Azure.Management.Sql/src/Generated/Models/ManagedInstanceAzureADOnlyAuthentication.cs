...
namespace Microsoft.Azure.Management.Sql.Models
{
    ...
    public partial class ManagedInstanceAzureADOnlyAuthentication : ProxyResource
    {
        ...
        /// ManagedInstanceAzureADOnlyAuthentication class.
        /// </summary>
        ...
        public ManagedInstanceAzureADOnlyAuthentication(bool azureADOnlyAuthentication, string id = default(string), string name = default(string), string type = default(string))
            : base(id, name, type)
        {
