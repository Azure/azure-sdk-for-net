...
namespace Microsoft.Azure.Management.Sql.Models
{
    ...
    public partial class ManagedInstancePrivateLinkProperties
    {
        ...
        /// zone names.</param>
        public ManagedInstancePrivateLinkProperties(string groupId = default(string), IList<string> requiredMembers = default(IList<string>), IList<string> requiredZoneNames = default(IList<string>))
        {
            GroupId = groupId;
