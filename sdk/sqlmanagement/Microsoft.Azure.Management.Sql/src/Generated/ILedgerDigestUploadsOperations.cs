...
namespace Microsoft.Azure.Management.Sql
{
    ...
    public partial interface ILedgerDigestUploadsOperations
    {
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationResponse<LedgerDigestUploads>> BeginCreateOrUpdateWithHttpMessagesAsync(string resourceGroupName, string serverName, string databaseName, LedgerDigestUploads parameters, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Disables uploading ledger digests to an Azure Storage account or an
        /// Azure Confidential Ledger instance.
        /// </summary>
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationResponse<LedgerDigestUploads>> BeginDisableWithHttpMessagesAsync(string resourceGroupName, string serverName, string databaseName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Gets all ledger digest upload settings on a database.
        /// </summary>
