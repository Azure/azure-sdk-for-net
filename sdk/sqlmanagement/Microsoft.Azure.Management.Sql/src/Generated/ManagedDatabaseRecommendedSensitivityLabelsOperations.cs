...
namespace Microsoft.Azure.Management.Sql
{
    ...
    /// </summary>
    internal partial class ManagedDatabaseRecommendedSensitivityLabelsOperations : IServiceOperations<SqlManagementClient>, IManagedDatabaseRecommendedSensitivityLabelsOperations
    {
        /// <summary>
        /// Initializes a new instance of the ManagedDatabaseRecommendedSensitivityLabelsOperations class.
        /// </summary>
        /// <param name='client'>
        ...
        /// </exception>
        internal ManagedDatabaseRecommendedSensitivityLabelsOperations(SqlManagementClient client)
        {
            if (client == null)
            {
        ...
        /// </return>
        public async Task<AzureOperationResponse> UpdateWithHttpMessagesAsync(string resourceGroupName, string managedInstanceName, string databaseName, RecommendedSensitivityLabelUpdateList parameters, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
