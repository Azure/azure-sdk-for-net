...
namespace Microsoft.Azure.Management.Sql
{
    ...
    internal partial class ManagedDatabaseSensitivityLabelsOperations : IServiceOperations<SqlManagementClient>, IManagedDatabaseSensitivityLabelsOperations
    {
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse> UpdateWithHttpMessagesAsync(string resourceGroupName, string managedInstanceName, string databaseName, SensitivityLabelUpdateList parameters, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (resourceGroupName == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "resourceGroupName");
