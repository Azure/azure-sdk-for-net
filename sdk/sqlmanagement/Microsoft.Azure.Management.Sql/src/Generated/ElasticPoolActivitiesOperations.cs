...
namespace Microsoft.Azure.Management.Sql
{
    ...
    /// </summary>
    internal partial class ElasticPoolActivitiesOperations : IServiceOperations<SqlManagementClient>, IElasticPoolActivitiesOperations
    {
        /// <summary>
        /// Initializes a new instance of the ElasticPoolActivitiesOperations class.
        /// </summary>
        /// <param name='client'>
        ...
        /// </exception>
        internal ElasticPoolActivitiesOperations(SqlManagementClient client)
        {
            if (client == null)
            {
        ...
        /// </return>
        public async Task<AzureOperationResponse<IEnumerable<ElasticPoolActivity>>> ListByElasticPoolWithHttpMessagesAsync(string resourceGroupName, string serverName, string elasticPoolName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Create Result
            var _result = new AzureOperationResponse<IEnumerable<ElasticPoolActivity>>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<Page<ElasticPoolActivity>>(_responseContent, Client.DeserializationSettings);
                }
