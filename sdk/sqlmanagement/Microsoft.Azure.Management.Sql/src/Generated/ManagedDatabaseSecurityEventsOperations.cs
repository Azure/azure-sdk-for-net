...
namespace Microsoft.Azure.Management.Sql
{
    ...
    /// </summary>
    internal partial class ManagedDatabaseSecurityEventsOperations : IServiceOperations<SqlManagementClient>, IManagedDatabaseSecurityEventsOperations
    {
        /// <summary>
        /// Initializes a new instance of the ManagedDatabaseSecurityEventsOperations class.
        /// </summary>
        /// <param name='client'>
        ...
        /// </exception>
        internal ManagedDatabaseSecurityEventsOperations(SqlManagementClient client)
        {
            if (client == null)
            {
        ...
        public async Task<AzureOperationResponse<IPage<SecurityEvent>>> ListByDatabaseWithHttpMessagesAsync(string resourceGroupName, string managedInstanceName, string databaseName, ODataQuery<SecurityEventsFilterParameters> odataQuery = default(ODataQuery<SecurityEventsFilterParameters>), string skiptoken = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<Page<SecurityEvent>>(_responseContent, Client.DeserializationSettings);
                }
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<IPage<SecurityEvent>>> ListByDatabaseNextWithHttpMessagesAsync(string nextPageLink, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
