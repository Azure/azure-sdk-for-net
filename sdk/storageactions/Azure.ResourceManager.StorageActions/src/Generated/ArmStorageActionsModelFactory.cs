...
namespace Azure.ResourceManager.StorageActions.Models
{
    ...
    public static partial class ArmStorageActionsModelFactory
    {
        ...
        public static StorageTaskProperties StorageTaskProperties(long? taskVersion = default, bool isEnabled = default, string description = default, StorageTaskIfCondition actionIf = default, StorageTaskProvisioningState? provisioningState = default, DateTimeOffset? creationTimeInUtc = default)
        {
            return new StorageTaskProperties(
                taskVersion,
                isEnabled,
                description,
                actionIf is null ? default : new StorageTaskAction(actionIf, default, default),
                provisioningState,
                creationTimeInUtc,
                default);
        }
        ...
        public static StorageTaskUpdateProperties StorageTaskUpdateProperties(long? taskVersion = default, bool? enabled = default, string description = default, StorageTaskIfCondition actionIf = default, StorageTaskProvisioningState? provisioningState = default, DateTimeOffset? creationTimeInUtc = default)
        {
        ...
        public static StorageTaskProperties StorageTaskProperties(long? taskVersion = default, bool isEnabled = false, string description = default, StorageTaskAction action = default, StorageTaskProvisioningState? provisioningState = default, DateTimeOffset? creationTimeInUtc = default)
        {
            return new StorageTaskProperties(
                taskVersion,
                isEnabled,
