...
namespace Azure.ResourceManager.StorageActions
{
    ...
    public partial class StorageTaskCollection : ArmCollection, IEnumerable<StorageTaskResource>, IAsyncEnumerable<StorageTaskResource>
    {
        ...
        public virtual async Task<ArmOperation<StorageTaskResource>> CreateAsync(WaitUntil waitUntil, string storageTaskName, StorageTaskData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(storageTaskName, nameof(storageTaskName));
            Argument.AssertNotNull(data, nameof(data));

            using DiagnosticScope scope = _storageTasksClientDiagnostics.CreateScope("StorageTaskCollection.CreateAsync");
            scope.Start();
            try
            {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="storageTaskName"/> or <paramref name="data"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="storageTaskName"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual ArmOperation<StorageTaskResource> Create(WaitUntil waitUntil, string storageTaskName, StorageTaskData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(storageTaskName, nameof(storageTaskName));
            Argument.AssertNotNull(data, nameof(data));

            using DiagnosticScope scope = _storageTasksClientDiagnostics.CreateScope("StorageTaskCollection.Create");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
