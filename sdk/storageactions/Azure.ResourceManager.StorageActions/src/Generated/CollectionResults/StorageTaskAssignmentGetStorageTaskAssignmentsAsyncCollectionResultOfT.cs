...
namespace Azure.ResourceManager.StorageActions
{
    internal partial class StorageTaskAssignmentGetStorageTaskAssignmentsAsyncCollectionResultOfT : AsyncPageable<SubResource>
    {
        ...
        public StorageTaskAssignmentGetStorageTaskAssignmentsAsyncCollectionResultOfT(StorageTaskAssignment client, Guid subscriptionId, string resourceGroupName, string storageTaskName, int? maxpagesize, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
