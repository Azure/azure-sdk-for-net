...
{
    internal partial class StorageTaskAssignmentGetStorageTaskAssignmentsCollectionResultOfT : Pageable<SubResource>
    {
        ...
        /// <summary> Initializes a new instance of StorageTaskAssignmentGetStorageTaskAssignmentsCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public StorageTaskAssignmentGetStorageTaskAssignmentsCollectionResultOfT(StorageTaskAssignment client, Guid subscriptionId, string resourceGroupName, string storageTaskName, int? maxpagesize, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of StorageTaskAssignmentGetStorageTaskAssignmentsCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of StorageTaskAssignmentGetStorageTaskAssignmentsCollectionResultOfT as an enumerable collection. </returns>
