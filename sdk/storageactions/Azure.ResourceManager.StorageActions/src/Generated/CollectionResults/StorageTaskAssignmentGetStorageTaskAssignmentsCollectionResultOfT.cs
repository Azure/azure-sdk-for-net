...
namespace Azure.ResourceManager.StorageActions
{
    internal partial class StorageTaskAssignmentGetStorageTaskAssignmentsCollectionResultOfT : Pageable<SubResource>
    {
        ...
        public StorageTaskAssignmentGetStorageTaskAssignmentsCollectionResultOfT(StorageTaskAssignment client, Guid subscriptionId, string resourceGroupName, string storageTaskName, int? maxpagesize, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
