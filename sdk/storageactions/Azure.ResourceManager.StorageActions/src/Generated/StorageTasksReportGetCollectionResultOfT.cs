...
{
    internal partial class StorageTasksReportGetCollectionResultOfT : Pageable<StorageTaskReportInstance>
    {
        ...
        /// <summary> Initializes a new instance of StorageTasksReportGetCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public StorageTasksReportGetCollectionResultOfT(StorageTasksReport client, Guid subscriptionId, string resourceGroupName, string storageTaskName, int? maxpagesize, string filter, RequestContext context) : base(context?.CancellationToken ?? default)
        {
        ...
        /// <summary> Gets the pages of StorageTasksReportGetCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of StorageTasksReportGetCollectionResultOfT as an enumerable collection. </returns>
