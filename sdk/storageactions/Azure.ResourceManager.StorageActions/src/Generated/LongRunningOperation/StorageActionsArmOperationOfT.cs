...
namespace Azure.ResourceManager.StorageActions
{
    internal partial class StorageActionsArmOperation<T> : ArmOperation<T>
    {
        ...
        internal StorageActionsArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
