...
{
    /// <summary></summary>
    internal partial class StorageTaskResourceOperationSource : IOperationSource<StorageTaskResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal StorageTaskResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
