        ...
        internal static StorageTaskAssignmentsListResult DeserializeStorageTaskAssignmentsListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("value"u8))
                {
                    ...
                    {
                        array.Add(ModelReaderWriter.Read<SubResource>(new BinaryData(Encoding.UTF8.GetBytes(item.GetRawText())), options, AzureResourceManagerStorageActionsContext.Default));
                    }
                    value = array;
                    continue;
                }
