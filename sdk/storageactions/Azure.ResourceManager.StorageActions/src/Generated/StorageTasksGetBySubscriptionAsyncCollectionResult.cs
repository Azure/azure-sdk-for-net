...
{
    internal partial class StorageTasksGetBySubscriptionAsyncCollectionResult : AsyncPageable<BinaryData>
    {
        private readonly StorageTasks _client;
        private readonly Guid _subscriptionId;
        private readonly RequestContext _context;

        /// <summary> Initializes a new instance of StorageTasksGetBySubscriptionAsyncCollectionResult, which is used to iterate over the pages of a collection. </summary>
        /// <param name="client"> The StorageTasks client used to send requests. </param>
        /// <param name="subscriptionId"> The ID of the target subscription. The value must be an UUID. </param>
        /// <param name="context"> The request options, which can override default behaviors of the client pipeline on a per-call basis. </param>
        public StorageTasksGetBySubscriptionAsyncCollectionResult(StorageTasks client, Guid subscriptionId, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of StorageTasksGetBySubscriptionAsyncCollectionResult as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of StorageTasksGetBySubscriptionAsyncCollectionResult as an enumerable collection. </returns>
