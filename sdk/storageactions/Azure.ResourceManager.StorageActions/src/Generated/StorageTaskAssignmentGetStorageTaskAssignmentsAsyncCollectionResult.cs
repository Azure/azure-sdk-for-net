...
{
    internal partial class StorageTaskAssignmentGetStorageTaskAssignmentsAsyncCollectionResult : AsyncPageable<BinaryData>
    {
        ...
        /// <summary> Initializes a new instance of StorageTaskAssignmentGetStorageTaskAssignmentsAsyncCollectionResult, which is used to iterate over the pages of a collection. </summary>
        ...
        public StorageTaskAssignmentGetStorageTaskAssignmentsAsyncCollectionResult(StorageTaskAssignment client, Guid subscriptionId, string resourceGroupName, string storageTaskName, int? maxpagesize, RequestContext context) : base(context?.CancellationToken ?? default)
        {
        ...
        /// <summary> Gets the pages of StorageTaskAssignmentGetStorageTaskAssignmentsAsyncCollectionResult as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of StorageTaskAssignmentGetStorageTaskAssignmentsAsyncCollectionResult as an enumerable collection. </returns>
        public override async IAsyncEnumerable<Page<BinaryData>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            do
            {
                ...
                StorageTaskAssignmentsListResult responseWithType = StorageTaskAssignmentsListResult.FromResponse(response);
