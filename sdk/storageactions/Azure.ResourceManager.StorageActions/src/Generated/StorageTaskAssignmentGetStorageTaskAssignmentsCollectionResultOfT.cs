    ...
    internal partial class StorageTaskAssignmentGetStorageTaskAssignmentsCollectionResultOfT : Pageable<SubResource>
    {
        ...
        public override IEnumerable<Page<SubResource>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                yield return Page<SubResource>.FromValues(StorageTaskAssignmentsListResult.FromResponse(response).Value, nextPage?.AbsoluteUri, response);
                nextPage = StorageTaskAssignmentsListResult.FromResponse(response).NextLink;
                if (nextPage == null)
                {
                    yield break;
                }
