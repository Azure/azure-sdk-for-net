...
{
    internal partial class StorageTaskAssignmentGetStorageTaskAssignmentsCollectionResult : Pageable<BinaryData>
    {
        ...
        /// <summary> Initializes a new instance of StorageTaskAssignmentGetStorageTaskAssignmentsCollectionResult, which is used to iterate over the pages of a collection. </summary>
        ...
        public StorageTaskAssignmentGetStorageTaskAssignmentsCollectionResult(StorageTaskAssignment client, Guid subscriptionId, string resourceGroupName, string storageTaskName, int? maxpagesize, RequestContext context) : base(context?.CancellationToken ?? default)
        {
        ...
        /// <summary> Gets the pages of StorageTaskAssignmentGetStorageTaskAssignmentsCollectionResult as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of StorageTaskAssignmentGetStorageTaskAssignmentsCollectionResult as an enumerable collection. </returns>
