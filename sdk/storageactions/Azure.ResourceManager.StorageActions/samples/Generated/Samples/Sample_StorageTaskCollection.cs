...
namespace Azure.ResourceManager.StorageActions.Samples
{
    public partial class Sample_StorageTaskCollection
    {
        ...
        public async Task CreateOrUpdate_PutStorageTask()
        {
            ...
            StorageTaskData data = new StorageTaskData(new AzureLocation("westus"), new ManagedServiceIdentity(default), new StorageTaskProperties(true, "My Storage task", new StorageTaskAction(new StorageTaskIfCondition("[[equals(AccessTier, 'Cool')]]", new StorageTaskOperationInfo[]
            {
