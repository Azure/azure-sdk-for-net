...
OnFailure = OnFailure.Break,
        ...
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task PreviewActionsStorageTask_PerformStorageTaskActionsPreview()
        {
            ...
            StorageTaskPreviewAction storageTaskPreviewAction = new StorageTaskPreviewAction(new StorageTaskPreviewContainerProperties()
            {
                Name = "firstContainer",
                Metadata =
{
...
Value = "tValue2",
            ...
            StorageTaskPreviewAction result = await subscriptionResource.PreviewActionsStorageTaskAsync(location, storageTaskPreviewAction);
