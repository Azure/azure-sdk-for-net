...
namespace Azure.ResourceManager.Subscription.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EnabledSubscriptionId>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<EnabledSubscriptionId>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<EnabledSubscriptionId>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<EnabledSubscriptionId>)} interface");
            }
        ...
        string IPersistableModel<EnabledSubscriptionId>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
