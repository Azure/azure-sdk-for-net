...
namespace Azure.ResourceManager.Subscription.Models
{
    public partial class Subscription
    {
        internal static Subscription DeserializeSubscription(JsonElement element)
        {
            ...
            return new Subscription(id.Value, subscriptionId.Value, displayName.Value, Optional.ToNullable(state), subscriptionPolicies.Value, authorizationSource.Value);
        }
    }
}
