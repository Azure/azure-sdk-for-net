...
namespace Azure.ResourceManager.Subscription.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SubscriptionAliasAdditionalProperties>)this).Write(writer, ModelSerializationExtensions.WireOptions);
