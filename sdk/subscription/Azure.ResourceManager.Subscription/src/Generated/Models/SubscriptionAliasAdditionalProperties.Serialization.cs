...
namespace Azure.ResourceManager.Subscription.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SubscriptionAliasAdditionalProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SubscriptionAliasAdditionalProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SubscriptionAliasAdditionalProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SubscriptionAliasAdditionalProperties>)} interface");
            }
        ...
        string IPersistableModel<SubscriptionAliasAdditionalProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
