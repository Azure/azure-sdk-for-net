...
namespace Azure.ResourceManager.Subscription.Models
{
    ...
    public partial class AcceptOwnershipRequestProperties
    {
        ...
        internal AcceptOwnershipRequestProperties(string displayName, string managementGroupId, IDictionary<string, string> tags, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            DisplayName = displayName;
