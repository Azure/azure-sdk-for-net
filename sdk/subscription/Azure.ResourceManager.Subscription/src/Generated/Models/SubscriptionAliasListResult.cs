...
namespace Azure.ResourceManager.Subscription.Models
{
    ...
    internal partial class SubscriptionAliasListResult
    {
        ...
        /// <summary> Initializes a new instance of <see cref="SubscriptionAliasListResult"/>. </summary>
        /// <param name="value"> The list of subscription aliases. </param>
        /// <param name="nextLink"> The link (url) to the next page of results. </param>
        /// <param name="additionalBinaryDataProperties"> Keeps track of any properties unknown to the library. </param>
        internal SubscriptionAliasListResult(IReadOnlyList<SubscriptionAliasData> value, string nextLink, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            NextLink = nextLink;
        ...
        /// <summary> The list of subscription aliases. </summary>
