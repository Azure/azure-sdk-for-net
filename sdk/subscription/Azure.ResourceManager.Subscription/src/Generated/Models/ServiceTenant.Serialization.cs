...
namespace Azure.ResourceManager.Subscription.Models
{
    public partial class ServiceTenant : IUtf8JsonSerializable, IJsonModel<ServiceTenant>
    {
        ...
        void IJsonModel<ServiceTenant>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(ServiceTenant)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ServiceTenant>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(ServiceTenant)} does not support '{options.Format}' format.");
            }
        }
