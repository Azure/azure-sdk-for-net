...
namespace Azure.ResourceManager.Subscription.Models
{
    ...
    {
        internal static SubscriptionAliasListResult DeserializeSubscriptionAliasListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
