...
namespace Azure.ResourceManager.Subscription.Models
{
    public partial class AcceptOwnershipContent : IUtf8JsonSerializable, IJsonModel<AcceptOwnershipContent>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<AcceptOwnershipContent>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AcceptOwnershipContent>)} interface");
            }
