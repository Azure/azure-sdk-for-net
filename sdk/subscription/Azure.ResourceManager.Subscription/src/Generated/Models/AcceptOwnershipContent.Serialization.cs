...
namespace Azure.ResourceManager.Subscription.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AcceptOwnershipContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AcceptOwnershipContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AcceptOwnershipContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<AcceptOwnershipContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
