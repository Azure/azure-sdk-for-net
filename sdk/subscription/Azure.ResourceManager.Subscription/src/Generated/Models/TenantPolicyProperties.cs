...
namespace Azure.ResourceManager.Subscription.Models
{
    ...
    public partial class TenantPolicyProperties
    {
        ...
        internal TenantPolicyProperties(string policyId, bool? blockSubscriptionsLeavingTenant, bool? blockSubscriptionsIntoTenant, IReadOnlyList<Guid> exemptedPrincipals, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            PolicyId = policyId;
