...
namespace Azure.ResourceManager.Subscription.Models
{
    ...
    public partial class TenantPolicyProperties
    {
        ...
        internal TenantPolicyProperties(string policyId, bool? blockSubscriptionsLeavingTenant, bool? blockSubscriptionsIntoTenant, IReadOnlyList<Guid> exemptedPrincipals, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            PolicyId = policyId;
