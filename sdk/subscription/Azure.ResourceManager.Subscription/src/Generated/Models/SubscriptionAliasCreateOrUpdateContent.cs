...
namespace Azure.ResourceManager.Subscription.Models
{
    ...
    public partial class SubscriptionAliasCreateOrUpdateContent
    {
        ...
        internal SubscriptionAliasCreateOrUpdateContent(string displayName, SubscriptionWorkload? workload, string billingScope, string subscriptionId, string resellerId, SubscriptionAliasAdditionalProperties additionalProperties, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
