...
namespace Azure.ResourceManager.Subscription.Models
{
    ...
    public partial class SubscriptionAliasAdditionalProperties
    {
        ...
        internal SubscriptionAliasAdditionalProperties(string managementGroupId, Guid? subscriptionTenantId, string subscriptionOwnerId, IDictionary<string, string> tags, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
