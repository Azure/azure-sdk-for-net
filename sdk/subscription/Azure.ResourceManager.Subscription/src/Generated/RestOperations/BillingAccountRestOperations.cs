...
namespace Azure.ResourceManager.Subscription
{
    internal partial class BillingAccountRestOperations
    {
        ...
        public async Task<Response<BillingAccountPoliciesResponseData>> GetPolicyAsync(string billingAccountId, CancellationToken cancellationToken = default)
        {
            ...
            switch (message.Response.Status)
            {
                case 200:
                    {
                        BillingAccountPoliciesResponseData value = default;
                        using var document = await JsonDocument.ParseAsync(message.Response.ContentStream, default, cancellationToken).ConfigureAwait(false);
                        value = BillingAccountPoliciesResponseData.DeserializeBillingAccountPoliciesResponseData(document.RootElement);
                        return Response.FromValue(value, message.Response);
                    }
                case 404:
                    return Response.FromValue((BillingAccountPoliciesResponseData)null, message.Response);
                default:
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="billingAccountId"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="billingAccountId"/> is an empty string, and was expected to be non-empty. </exception>
        public Response<BillingAccountPoliciesResponseData> GetPolicy(string billingAccountId, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(billingAccountId, nameof(billingAccountId));
