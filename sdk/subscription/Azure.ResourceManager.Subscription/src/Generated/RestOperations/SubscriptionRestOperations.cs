...
namespace Azure.ResourceManager.Subscription
{
    internal partial class SubscriptionRestOperations
    {
        ...
        public async Task<Response> AcceptOwnershipAsync(HttpMessage message, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="message"/> is null. </exception>
        public Response AcceptOwnership(HttpMessage message, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(message, nameof(message));
