...
namespace Azure.ResourceManager.Subscription
{
    internal partial class BillingAccountPoliciesResponses
    {
        ...
        internal BillingAccountPoliciesResponses(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string applicationId, Uri endpoint, string apiVersion)
        {
            ClientDiagnostics = clientDiagnostics;
            _endpoint = endpoint;
            Pipeline = pipeline;
            _apiVersion = apiVersion;
            _userAgent = new TelemetryDetails(typeof(BillingAccountPoliciesResponses).Assembly, applicationId);
        }
