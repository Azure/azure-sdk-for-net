...
namespace Azure.ResourceManager.Subscription
{
    ...
    public partial class TenantPolicyData : ResourceData
    {
        ...
        internal TenantPolicyData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, TenantPolicyProperties properties) : base(id, name, resourceType, systemData)
        {
