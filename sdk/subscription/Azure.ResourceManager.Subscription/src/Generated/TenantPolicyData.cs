...
namespace Azure.ResourceManager.Subscription
{
    ...
    public partial class TenantPolicyData : ResourceData
    {
        ...
        internal TenantPolicyData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, TenantPolicyProperties properties, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
