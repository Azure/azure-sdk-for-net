...
namespace Azure.ResourceManager.Subscription
{
    ...
    public partial class BillingAccountPolicyData : ResourceData
    {
        ...
        internal BillingAccountPolicyData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, BillingAccountPolicyProperties properties, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData)
        {
