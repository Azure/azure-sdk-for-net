...
namespace Azure.ResourceManager.Subscription
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="TenantPolicyResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    ...
    public partial class TenantPolicyResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of TenantPolicyResource for mocking. </summary>
        protected TenantPolicyResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="TenantPolicyResource"/> class. </summary>
        ...
        {
            string resourceId = $"/providers/Microsoft.Subscription/policies/default";
        ...
        /// <description> GetTenantPolicyResponses_AddUpdatePolicyForTenant. </description>
        /// </item>
        /// <item>
        ...
        public virtual async Task<ArmOperation<TenantPolicyResource>> CreateOrUpdateAsync(WaitUntil waitUntil, TenantPolicyCreateOrUpdateContent content, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                SubscriptionArmOperation<TenantPolicyResource> operation = new SubscriptionArmOperation<TenantPolicyResource>(Response.FromValue(new TenantPolicyResource(Client, response.Value), response.GetRawResponse()), rehydrationToken);
