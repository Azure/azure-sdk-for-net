...
namespace Azure.ResourceManager.Subscription.Mocking
{
    ...
    internal partial class SubscriptionTenantMockingExtension : ArmResource
    {
        private ClientDiagnostics _subscriptionClientDiagnostics;
        private SubscriptionRestOperations _subscriptionRestClient;

        /// <summary> Initializes a new instance of the <see cref="SubscriptionTenantMockingExtension"/> class for mocking. </summary>
        protected SubscriptionTenantMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="SubscriptionTenantMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal SubscriptionTenantMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        {
            using var scope = SubscriptionClientDiagnostics.CreateScope("SubscriptionTenantMockingExtension.AcceptSubscriptionOwnership");
            scope.Start();
            try
            {
        ...
        {
            using var scope = SubscriptionClientDiagnostics.CreateScope("SubscriptionTenantMockingExtension.GetAcceptOwnershipStatus");
            scope.Start();
            try
            {
