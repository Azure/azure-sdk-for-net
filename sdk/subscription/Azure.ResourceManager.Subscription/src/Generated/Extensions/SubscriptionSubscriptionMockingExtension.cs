...
namespace Azure.ResourceManager.Subscription.Mocking
{
    ...
    internal partial class SubscriptionSubscriptionMockingExtension : ArmResource
    {
        private ClientDiagnostics _subscriptionClientDiagnostics;
        private SubscriptionRestOperations _subscriptionRestClient;

        /// <summary> Initializes a new instance of the <see cref="SubscriptionSubscriptionMockingExtension"/> class for mocking. </summary>
        protected SubscriptionSubscriptionMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="SubscriptionSubscriptionMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal SubscriptionSubscriptionMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        {
            using var scope = SubscriptionClientDiagnostics.CreateScope("SubscriptionSubscriptionMockingExtension.CancelSubscription");
            scope.Start();
            try
            {
        ...
        {
            using var scope = SubscriptionClientDiagnostics.CreateScope("SubscriptionSubscriptionMockingExtension.RenameSubscription");
            scope.Start();
            try
            {
        ...
        {
            using var scope = SubscriptionClientDiagnostics.CreateScope("SubscriptionSubscriptionMockingExtension.EnableSubscription");
            scope.Start();
            try
            {
