...
namespace Azure.ResourceManager.Subscription.Mock
{
    ...
    public partial class SubscriptionResourceExtension : ArmResource
    {
        ...
        {
            using var scope = SubscriptionClientDiagnostics.CreateScope("SubscriptionResourceExtension.CancelSubscription");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response<RenamedSubscriptionId>> RenameSubscriptionAsync(SubscriptionName body, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = SubscriptionClientDiagnostics.CreateScope("SubscriptionResourceExtension.RenameSubscription");
            scope.Start();
            try
            {
        ...
        {
            using var scope = SubscriptionClientDiagnostics.CreateScope("SubscriptionResourceExtension.EnableSubscription");
            scope.Start();
            try
            {
