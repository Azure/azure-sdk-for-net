...
namespace Azure.ResourceManager.Subscription
{
    ...
    public static partial class SubscriptionExtensions
    {
        ...
        {
            return await GetSubscriptionResourceExtension(subscriptionResource).CancelSubscriptionAsync(cancellationToken).ConfigureAwait(false);
        }
        ...
        {
            return GetSubscriptionResourceExtension(subscriptionResource).CancelSubscription(cancellationToken);
        }
        ...
        public static async Task<Response<RenamedSubscriptionId>> RenameSubscriptionAsync(this SubscriptionResource subscriptionResource, SubscriptionName body, CancellationToken cancellationToken = default)
        {
            ...
            return await GetSubscriptionResourceExtension(subscriptionResource).RenameSubscriptionAsync(body, cancellationToken).ConfigureAwait(false);
        }
        ...
        public static Response<RenamedSubscriptionId> RenameSubscription(this SubscriptionResource subscriptionResource, SubscriptionName body, CancellationToken cancellationToken = default)
        {
            ...
            return GetSubscriptionResourceExtension(subscriptionResource).RenameSubscription(body, cancellationToken);
        }
        ...
        {
            return await GetSubscriptionResourceExtension(subscriptionResource).EnableSubscriptionAsync(cancellationToken).ConfigureAwait(false);
        }
        ...
        {
            return GetSubscriptionResourceExtension(subscriptionResource).EnableSubscription(cancellationToken);
        }
        ...
        {
            return GetTenantResourceExtension(tenantResource).GetSubscriptionAliases();
        }
        ...
        {
            return GetTenantResourceExtension(tenantResource).GetTenantPolicy();
        }
        ...
        {
            return GetTenantResourceExtension(tenantResource).GetBillingAccountPolicies();
        }
        ...
        public static async Task<ArmOperation> AcceptSubscriptionOwnershipAsync(this TenantResource tenantResource, WaitUntil waitUntil, string subscriptionId, AcceptOwnershipContent content, CancellationToken cancellationToken = default)
        {
            ...
            return await GetTenantResourceExtension(tenantResource).AcceptSubscriptionOwnershipAsync(waitUntil, subscriptionId, content, cancellationToken).ConfigureAwait(false);
        }
        ...
        public static ArmOperation AcceptSubscriptionOwnership(this TenantResource tenantResource, WaitUntil waitUntil, string subscriptionId, AcceptOwnershipContent content, CancellationToken cancellationToken = default)
        {
            ...
            return GetTenantResourceExtension(tenantResource).AcceptSubscriptionOwnership(waitUntil, subscriptionId, content, cancellationToken);
        }
        ...
        public static async Task<Response<AcceptOwnershipStatus>> GetAcceptOwnershipStatusAsync(this TenantResource tenantResource, string subscriptionId, CancellationToken cancellationToken = default)
        {
            ...
            return await GetTenantResourceExtension(tenantResource).GetAcceptOwnershipStatusAsync(subscriptionId, cancellationToken).ConfigureAwait(false);
        }
        ...
        public static Response<AcceptOwnershipStatus> GetAcceptOwnershipStatus(this TenantResource tenantResource, string subscriptionId, CancellationToken cancellationToken = default)
        {
            ...
            return GetTenantResourceExtension(tenantResource).GetAcceptOwnershipStatus(subscriptionId, cancellationToken);
        }
    }
}
