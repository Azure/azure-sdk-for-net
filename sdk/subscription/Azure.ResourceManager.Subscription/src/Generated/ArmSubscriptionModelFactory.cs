...
namespace Azure.ResourceManager.Subscription.Models
{
    ...
    public static partial class ArmSubscriptionModelFactory
    {
        ...
        {
            return new CanceledSubscriptionId(subscriptionId, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new RenamedSubscriptionId(subscriptionId, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new EnabledSubscriptionId(subscriptionId, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SubscriptionAliasData(id, name, resourceType, systemData, properties, new Dictionary<string, BinaryData>());
        }
        ...
        public static SubscriptionAliasProperties SubscriptionAliasProperties(string subscriptionId = null, string displayName = null, SubscriptionProvisioningState? provisioningState = null, Uri acceptOwnershipUri = null, AcceptOwnershipState? acceptOwnershipState = null, string billingScope = null, SubscriptionWorkload? workload = null, string resellerId = null, string subscriptionOwnerId = null, string managementGroupId = null, DateTimeOffset? createdOn = null, IReadOnlyDictionary<string, string> tags = null)
        {
            ...
            return new SubscriptionAliasProperties(subscriptionId, displayName, provisioningState, acceptOwnershipUri, acceptOwnershipState, billingScope, workload, resellerId, subscriptionOwnerId, managementGroupId, createdOn, tags, new Dictionary<string, BinaryData>());
        }
        ...
        public static AcceptOwnershipRequestProperties AcceptOwnershipRequestProperties(string displayName = null, string managementGroupId = null, IDictionary<string, string> tags = null)
        {
            ...
            return new AcceptOwnershipRequestProperties(displayName, managementGroupId, tags, new Dictionary<string, BinaryData>());
        }
        ...
        public static AcceptOwnershipStatus AcceptOwnershipStatus(string subscriptionId = null, AcceptOwnershipState? acceptOwnershipState = null, AcceptOwnershipProvisioningState? provisioningState = null, string billingOwner = null, Guid? subscriptionTenantId = null, string displayName = null, IReadOnlyDictionary<string, string> tags = null)
        {
            ...
            return new AcceptOwnershipStatus(subscriptionId, acceptOwnershipState, provisioningState, billingOwner, subscriptionTenantId, displayName, tags, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new TenantPolicyData(id, name, resourceType, systemData, properties, new Dictionary<string, BinaryData>());
        }
        ...
        public static TenantPolicyProperties TenantPolicyProperties(string policyId = null, bool? blockSubscriptionsLeavingTenant = null, bool? blockSubscriptionsIntoTenant = null, IEnumerable<Guid> exemptedPrincipals = null)
        {
            ...
            return new TenantPolicyProperties(policyId, blockSubscriptionsLeavingTenant, blockSubscriptionsIntoTenant, exemptedPrincipals?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new BillingAccountPolicyData(id, name, resourceType, systemData, properties, new Dictionary<string, BinaryData>());
        }
        ...
        public static BillingAccountPolicyProperties BillingAccountPolicyProperties(IEnumerable<ServiceTenant> serviceTenants = null, bool? allowTransfers = null)
        {
            ...
            return new BillingAccountPolicyProperties(serviceTenants?.ToList(), allowTransfers, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ServiceTenant(tenantId, tenantName, new Dictionary<string, BinaryData>());
        }
    }
}
