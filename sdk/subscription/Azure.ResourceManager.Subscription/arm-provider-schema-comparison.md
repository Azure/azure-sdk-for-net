...
#### List and action operations differences: `/providers/Microsoft.Subscription/policies/default`
...
#### List and action operations differences: `/subscriptions/{subscriptionId}/providers/Microsoft.Subscription/changeTenantRequest/default`
...
| --- | --- | --- |
| `/providers/microsoft.billing/billingaccounts/{}/providers/microsoft.subscription/policies/default` | `BillingAccountPolicy` | `ExternalResourceBillingAccountPoliciesResponse` |
| `/providers/microsoft.subscription/aliases/{}` | `SubscriptionAlias` | `SubscriptionAliasResponse` |
