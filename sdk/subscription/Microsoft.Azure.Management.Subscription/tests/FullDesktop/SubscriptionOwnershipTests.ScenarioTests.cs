...
namespace FullDesktop.Tests
{
    ...
    /// </summary>
    public class SubscriptionOwnershipTests : TestBase
    {
        ...
        public void AcceptSubscriptionOwnership()
        {
            ...
            {
                const string subscriptionId = "subidprod1";
                var putAliasRequest = new AcceptOwnershipRequest()
                {
                ...
                var subscriptionResult = client.Subscription.AcceptOwnershipWithHttpMessagesAsync(
                    subscriptionId: subscriptionId, body: new AcceptOwnershipRequest()).ConfigureAwait(false).GetAwaiter().GetResult();
