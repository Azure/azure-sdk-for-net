...
namespace SubscriptionClient.Models
{
    ...
    public partial class AcceptOwnershipStatusResponse
    {
        ...
        internal AcceptOwnershipStatusResponse(string subscriptionId, AcceptOwnership? acceptOwnershipState, string billingOwner, string subscriptionTenantId, string displayName, IReadOnlyDictionary<string, string> tags)
        {
