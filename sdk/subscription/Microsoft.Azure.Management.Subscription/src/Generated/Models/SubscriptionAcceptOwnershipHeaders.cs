...
namespace Microsoft.Azure.Management.Subscription.Models
{
    ...
    /// </summary>
    public partial class SubscriptionAcceptOwnershipHeaders
    {
        /// <summary>
        ...
        /// seconds.</param>
        public SubscriptionAcceptOwnershipHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
