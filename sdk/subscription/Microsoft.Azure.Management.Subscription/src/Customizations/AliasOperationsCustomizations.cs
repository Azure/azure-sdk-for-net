namespace Microsoft.Azure.Management.Subscription
{
    ...
    public partial interface IAliasOperations
    {
        ...
        Task<AzureOperationResponse<PutAliasResponse>> GetPutOperationStatus(string linkUrl, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
    }
    ...
    internal partial class AliasOperations : IServiceOperations<SubscriptionClient>, IAliasOperations
    {
        ...
        public async Task<AzureOperationResponse<PutAliasResponse>> GetPutOperationStatus(string linkUrl, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
