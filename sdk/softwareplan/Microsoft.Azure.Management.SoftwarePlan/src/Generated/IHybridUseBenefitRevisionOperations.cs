...
namespace Microsoft.Azure.Management.SoftwarePlan
{
    ...
    /// <summary>
    /// HybridUseBenefitRevisionOperations operations.
    /// </summary>
    public partial interface IHybridUseBenefitRevisionOperations
    {
        /// <summary>
        ...
        /// </exception>
        Task<AzureOperationResponse<IPage<HybridUseBenefitModel>>> ListWithHttpMessagesAsync(string scope, string planId, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Gets the version history of a hybrid use benefit
        /// </summary>
