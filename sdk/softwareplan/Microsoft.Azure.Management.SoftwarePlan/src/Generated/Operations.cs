...
namespace Microsoft.Azure.Management.SoftwarePlan
{
    ...
    /// </summary>
    internal partial class Operations : IServiceOperations<SoftwareplanClient>, IOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal Operations(SoftwareplanClient client)
        {
            if (client == null)
            {
        ...
        /// </return>
        public async Task<AzureOperationResponse<IPage<OperationResponse>>> ListWithHttpMessagesAsync(string scope, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (scope == null)
            {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "{scope}/providers/Microsoft.SoftwarePlan/operations").ToString();
