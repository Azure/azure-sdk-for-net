...
namespace Azure.ResourceManager.HybridData
{
    ...
    /// Each <see cref="JobDefinitionResource" /> in the collection will belong to the same instance of <see cref="DataServiceResource" />.
    /// To get a <see cref="JobDefinitionCollection" /> instance call the GetJobDefinitions method from an instance of <see cref="DataServiceResource" />.
    /// </summary>
    public partial class JobDefinitionCollection : ArmCollection, IEnumerable<JobDefinitionResource>, IAsyncEnumerable<JobDefinitionResource>
    {
        ...
        public virtual async Task<ArmOperation<JobDefinitionResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string jobDefinitionName, JobDefinitionData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new HybridDataArmOperation<JobDefinitionResource>(new JobDefinitionOperationSource(Client), _jobDefinitionClientDiagnostics, Pipeline, _jobDefinitionRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, jobDefinitionName, data).Request, response, OperationFinalStateVia.Location);
        ...
        public virtual AsyncPageable<JobDefinitionResource> GetAllAsync(string filter = null, CancellationToken cancellationToken = default)
        {
            async Task<Page<JobDefinitionResource>> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _jobDefinitionRestClient.ListByDataServiceAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, filter, cancellationToken: cancellationToken).ConfigureAwait(false);
            ...
            async Task<Page<JobDefinitionResource>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _jobDefinitionRestClient.ListByDataServiceNextPageAsync(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, filter, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new JobDefinitionResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual Pageable<JobDefinitionResource> GetAll(string filter = null, CancellationToken cancellationToken = default)
        {
            Page<JobDefinitionResource> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _jobDefinitionRestClient.ListByDataService(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, filter, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new JobDefinitionResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            Page<JobDefinitionResource> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _jobDefinitionRestClient.ListByDataServiceNextPage(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, filter, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new JobDefinitionResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
