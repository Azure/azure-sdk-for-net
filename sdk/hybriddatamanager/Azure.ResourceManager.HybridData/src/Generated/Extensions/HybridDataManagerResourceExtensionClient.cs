...
{
    /// <summary> A class to add extension methods to HybridDataManagerResource. </summary>
    public partial class HybridDataManagerResourceExtensionClient : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="HybridDataManagerResourceExtensionClient"/> class for mocking. </summary>
        protected HybridDataManagerResourceExtensionClient()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="HybridDataManagerResourceExtensionClient"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal HybridDataManagerResourceExtensionClient(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        private ClientDiagnostics HybridDataManagerDataManagersClientDiagnostics => _hybridDataManagerDataManagersClientDiagnostics ??= new ClientDiagnostics("Azure.ResourceManager.HybridData.Mock", HybridDataManagerResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual AsyncPageable<HybridDataManagerResource> GetHybridDataManagersAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, null, e => new HybridDataManagerResource(Client, HybridDataManagerData.DeserializeHybridDataManagerData(e)), HybridDataManagerDataManagersClientDiagnostics, Pipeline, "HybridDataManagerResourceExtensionClient.GetHybridDataManagers", "value", null, cancellationToken);
        }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => HybridDataManagerDataManagersRestClient.CreateListRequest(Id.SubscriptionId);
            return PageableHelpers.CreatePageable(FirstPageRequest, null, e => new HybridDataManagerResource(Client, HybridDataManagerData.DeserializeHybridDataManagerData(e)), HybridDataManagerDataManagersClientDiagnostics, Pipeline, "HybridDataManagerResourceExtensionClient.GetHybridDataManagers", "value", null, cancellationToken);
        }
    }
}
