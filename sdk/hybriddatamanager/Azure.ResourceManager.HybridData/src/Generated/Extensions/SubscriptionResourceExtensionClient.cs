...
namespace Azure.ResourceManager.HybridData
{
    ...
    internal partial class SubscriptionResourceExtensionClient : ArmResource
    {
        ...
        public virtual AsyncPageable<HybridDataManagerResource> GetHybridDataManagersAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, null, e => { var data = HybridDataManagerData.DeserializeHybridDataManagerData(e); return new HybridDataManagerResource(Client, data, data.Id); }, HybridDataManagerDataManagersClientDiagnostics, Pipeline, "SubscriptionResourceExtensionClient.GetHybridDataManagers", "value", null, cancellationToken);
        }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => HybridDataManagerDataManagersRestClient.CreateListRequest(Id.SubscriptionId);
            return PageableHelpers.CreatePageable(FirstPageRequest, null, e => { var data = HybridDataManagerData.DeserializeHybridDataManagerData(e); return new HybridDataManagerResource(Client, data, data.Id); }, HybridDataManagerDataManagersClientDiagnostics, Pipeline, "SubscriptionResourceExtensionClient.GetHybridDataManagers", "value", null, cancellationToken);
        }
    }
}
