...
namespace Azure.ResourceManager.HybridData.Mock
{
    ...
    public partial class HybridDataManagerResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="HybridDataManagerResourceExtension"/> class for mocking. </summary>
        protected HybridDataManagerResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="HybridDataManagerResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal HybridDataManagerResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<HybridDataManagerResource> GetHybridDataManagersAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, null, e => new HybridDataManagerResource(Client, HybridDataManagerData.DeserializeHybridDataManagerData(e)), HybridDataManagerDataManagersClientDiagnostics, Pipeline, "HybridDataManagerResourceExtension.GetHybridDataManagers", "value", null, cancellationToken);
        }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => HybridDataManagerDataManagersRestClient.CreateListRequest(Id.SubscriptionId);
            return PageableHelpers.CreatePageable(FirstPageRequest, null, e => new HybridDataManagerResource(Client, HybridDataManagerData.DeserializeHybridDataManagerData(e)), HybridDataManagerDataManagersClientDiagnostics, Pipeline, "HybridDataManagerResourceExtension.GetHybridDataManagers", "value", null, cancellationToken);
        }
    }
}
