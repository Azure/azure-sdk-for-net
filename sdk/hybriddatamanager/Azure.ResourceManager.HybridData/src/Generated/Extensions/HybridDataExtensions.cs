...
using Azure.ResourceManager.HybridData.Testing;
...
namespace Azure.ResourceManager.HybridData
{
    ...
    public static partial class HybridDataExtensions
    {
        ...
        private static HybridDataSubscriptionResourceExtension GetHybridDataSubscriptionResourceExtension(ArmResource resource)
        {
            return resource.GetCachedClient(client =>
            {
                return new HybridDataSubscriptionResourceExtension(client, resource.Id);
            });
        }

        private static HybridDataSubscriptionResourceExtension GetHybridDataSubscriptionResourceExtension(ArmClient client, ResourceIdentifier scope)
        {
            return client.GetResourceClient(() =>
            {
                return new HybridDataSubscriptionResourceExtension(client, scope);
            });
        }
        ...
        {
            return GetHybridDataSubscriptionResourceExtension(subscriptionResource).GetHybridDataManagersAsync(cancellationToken);
        }
        ...
        {
            return GetHybridDataSubscriptionResourceExtension(subscriptionResource).GetHybridDataManagers(cancellationToken);
        }
    }
}
