...
namespace Azure.ResourceManager.HybridData
{
    ...
    public partial class JobDefinitionData : ResourceData
    {
        ...
        internal JobDefinitionData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string dataSourceId, string dataSinkId, IList<Schedule> schedules, State state, DateTimeOffset? lastModifiedOn, RunLocation? runLocation, UserConfirmation? userConfirmation, BinaryData dataServiceInput, IList<CustomerSecret> customerSecrets) : base(id, name, resourceType, systemData)
        {
            DataSourceId = dataSourceId;
            DataSinkId = dataSinkId;
            Schedules = schedules;
