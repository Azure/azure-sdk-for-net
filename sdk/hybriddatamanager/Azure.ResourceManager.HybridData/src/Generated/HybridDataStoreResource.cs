...
namespace Azure.ResourceManager.HybridData
{
    ...
    public partial class HybridDataStoreResource : ArmResource
    {
        ...
        internal HybridDataStoreResource(ArmClient client, HybridDataStoreData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<HybridDataStoreResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new HybridDataStoreResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
