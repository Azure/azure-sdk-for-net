...
namespace Microsoft.Azure.Management.HybridData
{
    ...
    /// </summary>
    internal partial class Operations : IServiceOperations<HybridDataManagementClient>, IOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal Operations(HybridDataManagementClient client)
        {
            if (client == null)
            {
        ...
        public async Task<AzureOperationResponse<IPage<AvailableProviderOperation>>> ListWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "providers/Microsoft.HybridData/operations").ToString();
