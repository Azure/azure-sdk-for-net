...
namespace Azure.ResourceManager.NotificationHubs
{
    internal partial class NamespacesRestOperations
    {
        ...
        internal HttpMessage CreateCheckAvailabilityRequest(string subscriptionId, NotificationHubNameAvailabilityContent content)
        {
        ...
        public async Task<Response<NotificationHubNameAvailabilityResult>> CheckAvailabilityAsync(string subscriptionId, NotificationHubNameAvailabilityContent content, CancellationToken cancellationToken = default)
        {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="subscriptionId"/> or <paramref name="content"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="subscriptionId"/> is an empty string, and was expected to be non-empty. </exception>
        public Response<NotificationHubNameAvailabilityResult> CheckAvailability(string subscriptionId, NotificationHubNameAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(subscriptionId, nameof(subscriptionId));
            Argument.AssertNotNull(content, nameof(content));
