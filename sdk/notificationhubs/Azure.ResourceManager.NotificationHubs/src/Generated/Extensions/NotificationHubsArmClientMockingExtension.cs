...
namespace Azure.ResourceManager.NotificationHubs.Mocking
{
    ...
    internal partial class NotificationHubsArmClientMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="NotificationHubsArmClientMockingExtension"/> class for mocking. </summary>
        protected NotificationHubsArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="NotificationHubsArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal NotificationHubsArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal NotificationHubsArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
