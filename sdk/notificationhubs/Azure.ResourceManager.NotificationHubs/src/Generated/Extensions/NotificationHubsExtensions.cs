...
using Azure.ResourceManager.NotificationHubs.Testing;
...
namespace Azure.ResourceManager.NotificationHubs
{
    ...
    {
        private static NotificationHubsResourceGroupResourceExtension GetNotificationHubsResourceGroupResourceExtension(ArmResource resource)
        {
            return resource.GetCachedClient(client =>
            {
                return new NotificationHubsResourceGroupResourceExtension(client, resource.Id);
            });
        }

        private static NotificationHubsResourceGroupResourceExtension GetNotificationHubsResourceGroupResourceExtension(ArmClient client, ResourceIdentifier scope)
        {
            return client.GetResourceClient(() =>
            {
                return new NotificationHubsResourceGroupResourceExtension(client, scope);
            });
        }

        private static NotificationHubsSubscriptionResourceExtension GetNotificationHubsSubscriptionResourceExtension(ArmResource resource)
        {
            return resource.GetCachedClient(client =>
            {
                return new NotificationHubsSubscriptionResourceExtension(client, resource.Id);
            });
        }

        private static NotificationHubsSubscriptionResourceExtension GetNotificationHubsSubscriptionResourceExtension(ArmClient client, ResourceIdentifier scope)
        {
            return client.GetResourceClient(() =>
            {
                return new NotificationHubsSubscriptionResourceExtension(client, scope);
            });
        }
        ...
        {
            return GetNotificationHubsResourceGroupResourceExtension(resourceGroupResource).GetNotificationHubNamespaces();
        }
        ...
        public static async Task<Response<NotificationHubAvailabilityResult>> CheckNotificationHubNamespaceAvailabilityAsync(this SubscriptionResource subscriptionResource, NotificationHubAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            ...
            return await GetNotificationHubsSubscriptionResourceExtension(subscriptionResource).CheckNotificationHubNamespaceAvailabilityAsync(content, cancellationToken).ConfigureAwait(false);
        }
        ...
        public static Response<NotificationHubAvailabilityResult> CheckNotificationHubNamespaceAvailability(this SubscriptionResource subscriptionResource, NotificationHubAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            ...
            return GetNotificationHubsSubscriptionResourceExtension(subscriptionResource).CheckNotificationHubNamespaceAvailability(content, cancellationToken);
        }
        ...
        {
            return GetNotificationHubsSubscriptionResourceExtension(subscriptionResource).GetNotificationHubNamespacesAsync(cancellationToken);
        }
        ...
        {
            return GetNotificationHubsSubscriptionResourceExtension(subscriptionResource).GetNotificationHubNamespaces(cancellationToken);
        }
    }
}
