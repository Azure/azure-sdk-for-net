...
{
    /// <summary> A class to add extension methods to NotificationHubNamespaceResource. </summary>
    public partial class NotificationHubNamespaceResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="NotificationHubNamespaceResourceExtension"/> class for mocking. </summary>
        protected NotificationHubNamespaceResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="NotificationHubNamespaceResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal NotificationHubNamespaceResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        private ClientDiagnostics NotificationHubNamespaceNamespacesClientDiagnostics => _notificationHubNamespaceNamespacesClientDiagnostics ??= new ClientDiagnostics("Azure.ResourceManager.NotificationHubs.Mock", NotificationHubNamespaceResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<Response<NotificationHubAvailabilityResult>> CheckNotificationHubNamespaceAvailabilityAsync(NotificationHubAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = NotificationHubNamespaceNamespacesClientDiagnostics.CreateScope("NotificationHubNamespaceResourceExtension.CheckNotificationHubNamespaceAvailability");
            scope.Start();
            try
            {
