...
namespace Azure.ResourceManager.NotificationHubs.Mock
{
    ...
    public partial class NotificationHubNamespaceResourceExtensionClient : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="NotificationHubNamespaceResourceExtensionClient"/> class for mocking. </summary>
        protected NotificationHubNamespaceResourceExtensionClient()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="NotificationHubNamespaceResourceExtensionClient"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal NotificationHubNamespaceResourceExtensionClient(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual async Task<Response<NotificationHubAvailabilityResult>> CheckNotificationHubNamespaceAvailabilityAsync(NotificationHubAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = NotificationHubNamespaceNamespacesClientDiagnostics.CreateScope("NotificationHubNamespaceResourceExtensionClient.CheckNotificationHubNamespaceAvailability");
            scope.Start();
            try
            {
