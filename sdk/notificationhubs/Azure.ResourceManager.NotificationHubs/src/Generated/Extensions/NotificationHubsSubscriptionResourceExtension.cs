...
namespace Azure.ResourceManager.NotificationHubs.Testing
{
    /// <summary> A class to add extension methods to SubscriptionResource. </summary>
    public partial class NotificationHubsSubscriptionResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="NotificationHubsSubscriptionResourceExtension"/> class for mocking. </summary>
        protected NotificationHubsSubscriptionResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="NotificationHubsSubscriptionResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal NotificationHubsSubscriptionResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual async Task<Response<NotificationHubAvailabilityResult>> CheckNotificationHubNamespaceAvailabilityAsync(NotificationHubAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = NotificationHubNamespaceNamespacesClientDiagnostics.CreateScope("NotificationHubsSubscriptionResourceExtension.CheckNotificationHubNamespaceAvailability");
            scope.Start();
            try
            {
